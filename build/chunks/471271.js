...
function b(e) {
    let {
        ...
        onRejectSuccess: l,
        onError: b
    } = e, A = (0, f.A)(), [y, _] = r.useState(!1), [O, j] = r.useState(!1), [v, x] = r.useState(!1), [E, C] = r.useState(!1), [S, I] = r.useState(!1), N = y || O || v, T = r.useCallback(async e => {
        if (!N) {
            _(!0);
            try {
                await (0, p.RK)(e), C(!0), null == n || n()
            } catch (t) {
                let e = new s.LG(t);
                null == b || b(e)
            } finally {
