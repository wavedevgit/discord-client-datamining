...
function p(e) {
    let t = (0, f.JM)(e),
        n = (0, r.bG)([d.A, l.A, c.A], () => {
            ...
            return (null == s || s === (null == n ? void 0 : n.channelId)) && (null == r || (0, a.A)(r, c.A)) ? r : null
        }, [e, t]),
        p = (0, r.bG)([u.A], () => null != t ? u.A.getPrimaryActivity(e.author_id, null == n ? void 0 : n.guild_id) : null, [n, e.author_id, t]),
        _ = (0, r.bG)([o.A], () => t ? o.A.getStreamForUser(e.author_id, null == n ? void 0 : n.guild_id) : null, [n, e.author_id, t]),
        {
            previewUrl: h
        } = (0, s.A)(null == _ ? void 0 : _.guildId, null == _ ? void 0 : _.channelId, null == _ ? void 0 : _.ownerId);
    return {
        channel: n,
        activity: p,
        streamPreviewUrl: h,
