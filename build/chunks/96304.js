...
function eA(e) {
    let {
        ...
        theme: t
    } = (0, b.E)(), a = (0, p.rdh)(p.LU0.colors.INTERACTIVE_TEXT_ACTIVE, t).hex();
...
function eN(e) {
    ...
    return s = l?.premiumType === $.PremiumTypes.TIER_2 ? (0, r.jsxs)(P.A, {
        user: t,
        displayProfile: l,
        forceShowPremium: !0,
        themeType: null,
        ...
        onLearnMore: () => {
            i(), o ? (0, L.openUserProfileModal)({
                userId: t.id
            }) : (0, S.openUserSettings)(w.X.PROFILE_PANEL), O.default.track(q.HAw.PREMIUM_UNCANCEL_WINBACK_CTA_CLICKED, {
...
function e_(e) {
    ...
    } = (0, h.Ay)(_.A.PREMIUM_UNCANCEL_MODAL), l = (0, H.Xb)(), n = (0, G.t)(), o = a?.id ?? $.Ac.PREMIUM_TENURE_1_MONTH, c = (0, B.A)(o);
...
function eh(e) {
    let {
        premiumType: s
    } = e, t = (0, u.bG)([N.A], () => N.A.useReducedMotion), a = (0, C.Fj)(null).filter(e => e.type === I.i.GUILD && (e.animated || null != e.guildId)).slice(0, 3), i = (0, u.yK)([E.A], () => E.A.stickerFrecencyWithoutFetchingLatest.frequently.slice(0, 3 - a.length)), l = ej().emojiStickersVisual, n = s === $.PremiumTypes.TIER_1;
    return (0, r.jsx)(ef, {
        description: n ? Q.intl.format(Q.t.couiKJ, {}) : Q.intl.format(Q.t["0hUHi6"], {}),
        onLearnMore: () => {
            window.open(z.A.getArticleURL(q.MVz.PREMIUM_DETAILS)), O.default.track(q.HAw.PREMIUM_UNCANCEL_WINBACK_CTA_CLICKED, {
...
function eC(e) {
    ...
    let i = (0, u.bG)([N.A], () => N.A.useReducedMotion),
        [n, o] = (0, u.yK)([D.A, V.A], () => {
            ...
            let t = null,
                r = 0;
            return s.size > 0 && ([t, r] = Array.from(s.entries()).reduce((e, s) => s[1] > e[1] ? s : e)), [V.A.getGuild(t), r]
        }),
        c = null != n && o > 0,
    ...
    return (0, r.jsx)(ef, {
        ...
        onLearnMore: () => {
            t(), (0, S.openUserSettings)(w.X.PREMIUM_GUILD_SUBSCRIPTIONS_PANEL), O.default.track(q.HAw.PREMIUM_UNCANCEL_WINBACK_CTA_CLICKED, {
                action: "boosts"
            })
        },
...
let eI = () => {
    ...
    return (0, r.jsx)(ef, {
        ...
        onLearnMore: () => {
            window.open(z.A.getArticleURL(q.MVz.STREAM_QUALITY_SETTINGS)), O.default.track(q.HAw.PREMIUM_UNCANCEL_WINBACK_CTA_CLICKED, {
                action: "screen_share"
            })
        },
...
function eT(e) {
    let {
        premiumType: s
    } = e, t = ej().uploadsMessagesItemVisual;
    return (0, r.jsx)(ef, {
        ...
        switch (t) {
            ...
            case $.PremiumTypes.TIER_1:
                n ? e.push((0, r.jsx)(eN, {
                    ...
                    premiumType: t,
                    onClose: i
                }, "profile-item"), (0, r.jsx)(eI, {}, "screen-share-item"), (0, r.jsx)(eC, {
                    premiumType: t,
                    onClose: i
                }, "boost-item")) : e.push((0, r.jsx)(eN, {
                    currentUser: s,
                    premiumType: t,
                    onClose: i
            ...
            case $.PremiumTypes.TIER_2:
                n ? e.push((0, r.jsx)(eN, {
                    ...
                    premiumType: t,
                    onClose: i
                }, "boost-item"), (0, r.jsx)(eI, {}, "screen-share-item")) : e.push((0, r.jsx)(e_, {
                    currentUser: s,
                    onClose: i
                }, "badge-item"), (0, r.jsx)(eN, {
                    currentUser: s,
                    premiumType: t,
                    onClose: i
                }, "profile-item"), (0, r.jsx)(eh, {
                    premiumType: t
                }, "emoji-stickers-item"), (0, r.jsx)(eC, {
                    premiumType: t,
                    onClose: i
...
let eM = function(e) {
    ...
    let C = null != f && !j;
    return (a.useEffect(() => {
        C && O.default.track(q.HAw.CANCELLATION_FLOW_DISCOUNT_OFFER_PROMPT_VIEWED, {
            location_stack: x,
            discount_id: f?.discount_id
        })
    }, [C, x, f]), j) ? (0, r.jsxs)(r.Fragment, {
