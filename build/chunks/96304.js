...
function ef(e) {
    ...
    return s = n?.premiumType === X.PremiumTypes.TIER_2 ? (0, r.jsxs)(L.A, {
        user: t,
        displayProfile: n,
        forceShowPremium: !0,
        themeType: null,
...
function eA(e) {
    ...
    } = (0, I.Ay)(N.A.PREMIUM_UNCANCEL_MODAL), n = (0, F.Xb)(), l = (0, H.t)(), o = a?.id ?? X.Ac.PREMIUM_TENURE_1_MONTH, c = (0, W.A)(o);
...
function e_(e) {
    let {
        premiumType: s
    } = e, t = (0, u.bG)([_.A], () => _.A.useReducedMotion), a = (0, T.Fj)(null).filter(e => e.type === C.i.GUILD && (e.animated || null != e.guildId)).slice(0, 3), i = (0, u.yK)([E.A], () => E.A.stickerFrecencyWithoutFetchingLatest.frequently.slice(0, 3 - a.length)), n = ex().emojiStickersVisual, l = s === X.PremiumTypes.TIER_1;
    return (0, r.jsx)(ep, {
        description: l ? $.intl.format($.t.couiKJ, {}) : $.intl.format($.t["0hUHi6"], {}),
        onLearnMore: () => {
            window.open(O.A.getArticleURL(Y.MVz.PREMIUM_DETAILS)), D.default.track(Y.HAw.PREMIUM_UNCANCEL_WINBACK_CTA_CLICKED, {
...
let eI = () => {
    ...
    return (0, r.jsx)(ep, {
        ...
        onLearnMore: () => {
            window.open(O.A.getArticleURL(Y.MVz.STREAM_QUALITY_SETTINGS)), D.default.track(Y.HAw.PREMIUM_UNCANCEL_WINBACK_CTA_CLICKED, {
                action: "screen_share"
            })
        },
        ...
        switch (t) {
            ...
            case X.PremiumTypes.TIER_1:
                l ? e.push((0, r.jsx)(ef, {
                    ...
                    premiumType: t,
                    onClose: i
                }, "profile-item"), (0, r.jsx)(eI, {}, "screen-share-item"), (0, r.jsx)(eN, {
                    premiumType: t,
                    onClose: i
            ...
            case X.PremiumTypes.TIER_2:
                l ? e.push((0, r.jsx)(ef, {
                    ...
                    premiumType: t,
                    onClose: i
                }, "boost-item"), (0, r.jsx)(eI, {}, "screen-share-item")) : e.push((0, r.jsx)(eA, {
                    currentUser: s,
                    onClose: i
...
let eg = function(e) {
    ...
    let T = null != f && !j;
    return (a.useEffect(() => {
        T && D.default.track(Y.HAw.CANCELLATION_FLOW_DISCOUNT_OFFER_PROMPT_VIEWED, {
            location_stack: x,
