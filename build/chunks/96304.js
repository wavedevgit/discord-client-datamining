/** chunk id: 96304 params = (module,exports,require) **/
t.d(s, {
    A: () => eg,
    l: () => eE
}), t(321073);
...
function ej(e) {
    let {
        ...
        theme: t
    } = (0, L.E)(), a = (0, p.rdh)(p.LU0.colors.INTERACTIVE_TEXT_ACTIVE, t).hex();
...
function ef(e) {
    ...
    return s = l?.premiumType === Y.PremiumTypes.TIER_2 ? (0, r.jsxs)(R.A, {
        user: t,
        displayProfile: l,
        forceShowPremium: !0,
        themeType: null,
        ...
        onLearnMore: () => {
            i(), (0, b.openUserSettings)(P.X.PROFILE_PANEL), k.default.track(Z.HAw.PREMIUM_UNCANCEL_WINBACK_CTA_CLICKED, {
...
function eA(e) {
    ...
    } = (0, C.Ay)(_.A.PREMIUM_UNCANCEL_MODAL), l = (0, F.Xb)(), n = (0, H.t)(), o = a?.id ?? Y.Ac.PREMIUM_TENURE_1_MONTH, c = (0, W.A)(o);
...
function eN(e) {
    let {
        premiumType: s
    } = e, t = (0, u.bG)([N.A], () => N.A.useReducedMotion), a = (0, h.Fj)(null).filter(e => e.type === T.i.GUILD && (e.animated || null != e.guildId)).slice(0, 3), i = (0, u.yK)([E.A], () => E.A.stickerFrecencyWithoutFetchingLatest.frequently.slice(0, 3 - a.length)), l = ex().emojiStickersVisual, n = s === Y.PremiumTypes.TIER_1;
    return (0, r.jsx)(ep, {
        description: n ? $.intl.format($.t.couiKJ, {}) : $.intl.format($.t["0hUHi6"], {}),
        onLearnMore: () => {
            window.open(O.A.getArticleURL(Z.MVz.PREMIUM_DETAILS)), k.default.track(Z.HAw.PREMIUM_UNCANCEL_WINBACK_CTA_CLICKED, {
                action: "emojis_stickers"
            })
        },
        renderVisual: () => null != a && a.length > 0 || !n && null != i && i.length > 0 ? (0, r.jsxs)("div", {
            className: q.iB,
            children: [a.map(e => null == e.id ? e.url : D.Ay.getEmojiURL({
                id: e.id,
                ...
                alt: "",
                src: e
            }, `emoji-${s}`) : null), n ? null : i.map(e => (0, r.jsx)(g.A, {
                disableAnimation: t,
                sticker: e,
                size: 58,
...
function e_(e) {
    ...
    let i = (0, u.bG)([N.A], () => N.A.useReducedMotion),
        [n, o] = (0, u.yK)([V.A, w.A], () => {
            let e = V.A.boostSlots,
                s = new Map;
            m()(e).map("premiumGuildSubscription").map("guildId").forEach(e => {
            ...
            let t = null,
                r = 0;
            return s.size > 0 && ([t, r] = Array.from(s.entries()).reduce((e, s) => s[1] > e[1] ? s : e)), [w.A.getGuild(t), r]
        }),
        c = null != n && o > 0,
    ...
    return (0, r.jsx)(ep, {
        ...
        onLearnMore: () => {
            t(), (0, b.openUserSettings)(P.X.PREMIUM_GUILD_SUBSCRIPTIONS_PANEL), k.default.track(Z.HAw.PREMIUM_UNCANCEL_WINBACK_CTA_CLICKED, {
                action: "boosts"
            })
        },
...
let eC = () => {
    ...
    return (0, r.jsx)(ep, {
        ...
        onLearnMore: () => {
            window.open(O.A.getArticleURL(Z.MVz.STREAM_QUALITY_SETTINGS)), k.default.track(Z.HAw.PREMIUM_UNCANCEL_WINBACK_CTA_CLICKED, {
                action: "screen_share"
            })
        },
        ...
        switch (t) {
            ...
            case Y.PremiumTypes.TIER_1:
                n ? e.push((0, r.jsx)(ef, {
                    ...
                    premiumType: t,
                    onClose: i
                }, "profile-item"), (0, r.jsx)(eC, {}, "screen-share-item"), (0, r.jsx)(e_, {
                    premiumType: t,
                    onClose: i
                }, "boost-item")) : e.push((0, r.jsx)(ef, {
                    currentUser: s,
                    premiumType: t,
                    onClose: i
                }, "profile-item"), (0, r.jsx)(eN, {
                    premiumType: t
                }, "emoji-stickers-item"), (0, r.jsx)(eC, {}, "screen-share-item"), (0, r.jsx)(eh, {
                    premiumType: t
                }, "uploads-item"), (0, r.jsx)(e_, {
                    premiumType: t,
                    onClose: i
                }, "boost-item"));
                break;
            case Y.PremiumTypes.TIER_2:
                n ? e.push((0, r.jsx)(ef, {
                    ...
                    premiumType: t,
                    onClose: i
                }, "profile-item"), (0, r.jsx)(e_, {
                    premiumType: t,
                    onClose: i
                }, "boost-item"), (0, r.jsx)(eC, {}, "screen-share-item")) : e.push((0, r.jsx)(eA, {
                    currentUser: s,
                    onClose: i
                }, "badge-item"), (0, r.jsx)(ef, {
                    currentUser: s,
                    premiumType: t,
                    onClose: i
                }, "profile-item"), (0, r.jsx)(eN, {
                    premiumType: t
                }, "emoji-stickers-item"), (0, r.jsx)(e_, {
                    premiumType: t,
                    onClose: i
                }, "boost-item"), (0, r.jsx)(eC, {}, "screen-share-item"), (0, r.jsx)(eh, {
                    premiumType: t
                }, "uploads-item"))
        }
        return e
...
let eg = function(e) {
    ...
    let h = null != f && !j;
    return (a.useEffect(() => {
        h && k.default.track(Z.HAw.CANCELLATION_FLOW_DISCOUNT_OFFER_PROMPT_VIEWED, {
            location_stack: x,
            discount_id: f?.discount_id
        })
    }, [h, x, f]), j) ? (0, r.jsxs)(r.Fragment, {
