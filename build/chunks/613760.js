...
function x(e) {
    let {
        code: t,
        message: n
    } = e, [x, f, C] = (0, s.yK)([h.A], () => [h.A.getApplication(t), h.A.isInvalidApplication(t), h.A.getApplicationFetchState(t)], [t]), E = (0, s.bG)([u.A], () => u.A.getGuildId() ?? void 0), [I, b] = r.useState(!1), T = r.useCallback(e => {
        e && b(!0)
    }, []), v = (0, a.K)(T), S = r.useCallback(() => {
