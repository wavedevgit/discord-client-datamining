...
function x(e) {
    let {
        code: t,
        message: n
    } = e, [x, f, C] = (0, r.yK)([h.A], () => [h.A.getApplication(t), h.A.isInvalidApplication(t), h.A.getApplicationFetchState(t)], [t]), E = (0, r.bG)([u.A], () => u.A.getGuildId() ?? void 0), [I, v] = a.useState(!1), b = a.useCallback(e => {
        e && v(!0)
    }, []), T = (0, l.K)(b), y = a.useCallback(() => {
