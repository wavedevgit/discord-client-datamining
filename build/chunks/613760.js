...
function x(e) {
    let {
        code: t,
        message: n
    } = e, [x, f, C] = (0, s.yK)([h.A], () => [h.A.getApplication(t), h.A.isInvalidApplication(t), h.A.getApplicationFetchState(t)], [t]), E = (0, s.bG)([u.A], () => u.A.getGuildId() ?? void 0), [I, v] = a.useState(!1), b = a.useCallback(e => {
        e && v(!0)
