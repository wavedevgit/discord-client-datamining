...
function f(e) {
    let t = (0, s.bG)([u.A], () => u.A.getChannel(e)),
        ...
        i = (0, r.useMemo)(() => null != t && t.isObfuscated() && null != l ? t.merge({
            name: l.name,
            flags: a.VL(t.flags, S.lx.OBFUSCATED)
        }) : null, [t, l]);
...
function I(e, t) {
    ...
    let i = l.listings[0];
    if (n?.name !== i.name || n?.description !== i.description || n?.priceTier !== i.price_tier || n?.image !== i.image || n?.roleColor !== i.role_color || n?.channelBenefits?.length !== i.channels.length || n?.intangibleBenefits?.length !== i.additional_perks.length) return {
