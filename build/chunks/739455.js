...
function C(e, t, n) {
    let i = (0, s.bG)([_.A], () => _.A.getSubscriptionListingsForGuild(e)),
        l = (0, A.y)(t => t.editStateIdsForGroup[e]),
        a = (0, A.y)(e => e.listings);
...
function g(e) {
    let t = A.y.getState().editStateIdsForGroup[e],
        n = A.y.getState().listings,
        i = new Set;
    null != t && t.forEach(e => {
...
async function S(e, t) {
    ...
    t.forEach(t => {
        ...
        if ("fulfilled" === n.status) {
            let t = n.value.body,
                i = A.y.getState().editStateIdsForGroup[e],
                l = A.y.getState().listings;
            null != i && i.forEach(e => {
...
function x(e) {
    return (0, m.X9)(e) && e.features.has(I.GuildFeatures.ROLE_SUBSCRIPTIONS_ENABLED) && (0, u.D3)() && (0, u.TG)(e.id)
}