/** chunk id: 998228, original params: e,t,n (module,exports,require) **/
n.d(t, {
    A: () => p
});
var i = n(64700),
...
function p(e) {
    let {
        fractionalState: t
    } = (0, l.A)(), n = t === A.xc.FP_ONLY, s = (0, c.$F)(), p = (0, c.Xb)(), E = s?.status === c.Wo.UPCOMING || n, C = (0, u.N)(s?.id), T = (0, r.z)(), S = (0, d.t)();
    return (0, i.useMemo)(() => {
        let t, i = null != S && S.days <= 30;
        return null != s ? s.status === c.Wo.UPCOMING ? t = g.intl.formatToPlainString(g.t.a1eKDi, {
            days: S?.days ?? 0
            ...
            primaryAssetClassName: a()(h.pq, {
                [h.n6]: E
            }),
            caption: null != p ? g.intl.formatToPlainString(g.t.Hu4jfi, {
                date: new Date(p)
            }) : void 0,
            description: t,
