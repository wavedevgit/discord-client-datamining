...
function j() {
    let [e, t] = (0, i.useState)(!1), [n, s] = (0, i.useState)(!1), [r, m] = (0, i.useState)(null), {
        node: g
    } = (0, c.Ay)(u.k, ""), v = (0, h.Ay)(e => e.toolsCache), {
        setToolsCache: j,
        removeToolsCache: E
    } = (0, h.DE)(), {
        setImgCache: T
    } = (0, h.TW)(), N = (0, i.useCallback)(e => {
        let t = v[e];
        null != t ? m({
...
function E(e) {
    let {
        nameplate: t
    } = e, n = (0, s.bG)([m.default], () => m.default.getCurrentUser());
    return (0, a.jsx)("div", {
        className: b.VH,
        children: (0, a.jsxs)("div", {
            className: b.H1,
