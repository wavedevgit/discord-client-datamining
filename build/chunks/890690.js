...
function s(e, t) {
    ...
    r.useEffect(() => {
        ...
        return c.forEach(e => {
            ...
            threshold: 1
        }), c.forEach(e => n.current?.observe(e)), null != u && n.current?.observe(u), () => {
            c.forEach(e => n.current?.unobserve(e)), null != u && n.current?.unobserve(u), n.current?.disconnect(), n.current = null
        }
    }, [o, t])
}