...
function p(e) {
    return {
        text: e ?? h.intl.string(h.t.VCsUJu),
        color: "text-feedback-critical",
        icon: (0, l.jsx)(u.EpV, {
            size: "xs",
            color: "currentColor",
            className: a()(A.Kk, A.ik)
        })
    }
}
...
let v = i.memo(function(e) {
    ...
    i.useEffect(() => {
        let e = null;
        if (t.hasFlag(g.pr7.LOADING) && null != u) {
    ...
    if (null == s) A = function(e, t) {
        switch ((0, m.fK)(t, e)) {
            case m.h0.SENDING:
                return f(h.intl.string(h.t.RiLfBY));
            case m.h0.CREATED:
                return f(h.intl.formatToPlainString(h.t["7ePV4t"], {
                    applicationName: t.author.username
                }));
            case m.h0.TIMED_OUT:
                return p(h.intl.string(h.t.h8hzPd));
            case m.h0.FAILED:
