...
class g extends s.A {
    ...
    handleChannelSelect(e) {
        ...
        if (null == E || (t = u.A.getGuild(E), l = !!t?.features.has(h.GuildFeatures.COMMUNITY), s = A.A.can(h.xBc.MANAGE_CHANNELS, t), g = (0, o.k8)(a.M.FORUM_CHANNEL_UPSELL_MODAL), p = c.A.getMemberCount(E) ?? 0, !l || !s || g || !(p >= 200))) return;
        (0, _.zd)(), (0, d.Vh)(a.M.FORUM_CHANNEL_UPSELL_MODAL);
        let I = function() {
