...
function O(e) {
    let {
        channel: t
    } = e, [n, a] = l.useState(!1), r = (0, g.Ay)(t, !0), O = t.guild_id, D = (0, d.bG)([x.A], () => null != O ? x.A.getSortedRoles(O) : void 0), P = (0, d.bG)([T.default, S.A], () => T.default.getUser(S.A.getGuild(O)?.ownerId)), U = l.useMemo(() => null != D ? D.filter(e => !(0, C.Oy)(e)) : [], [D]), k = l.useMemo(() => o()(U).filter(e => {
        if (null == O) return !1;
        let n = v.aH({
            forceRoles: {
                [e.id]: e
    ...
    }).value(), [t, O, U]), w = (0, d.yK)([T.default], () => {
        let e = {};
    ...
    return (0, i.jsxs)(y.Ay, {
        ...
        children: [(0, i.jsx)(y.WK, {
            ...
            className: M.ol,
            children: [function() {
                if (1 !== w.length || k.length > 0) return (0, i.jsx)(u.A, {
                    guildId: t.guild_id,
                    className: M.HD,
                    maxUsers: 5,
                    users: w
