/** chunk id: 937388 params = (module,exports,require) **/
a.d(t, {
    A: () => S
});
var n = a(627968),
...
let A = e => {
    ...
    j = e => {
        ...
        if (l.type === _.geh.YOUTUBE_VIDEO) t = {
            url: (0, _.PE$)(l.youtubeVideoId),
            ...b
        }, a = {
            url: `${(0,_.uJ2)(l.youtubeVideoId)}?${v}`,
            ...C
        }, i = c.mt.YOUTUBE;
        else {
...
class I extends i.PureComponent {
    ...
    componentDidMount() {
        ...
        e.length > 0 && e[0].type === _.geh.IMG && this.setState({
    ...
    handleChangeItem = e => {
        this.setState({
            isVideoPlaying: !1
        }), e.type === _.geh.IMG && this.setState({
    ...
    handleCurrentItemClick(e, t) {
        let {
            onCurrentItemClick: a
        } = this.props;
        null != a && a(e, t), this.setState({
            hasInteracted: !0
        })
    }
    handleOnErrorImg = e => {
