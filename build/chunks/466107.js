...
var r = n(589841),
    ...
    d = function(e, t) {
        ...
        for (m = 0; m < p.length; ++m)
            if (m !== _) {
                var m, g, E, y = p[m],
                    b = y.indexOf("]="),
                    O = -1 === b ? y.indexOf("=") : b + 1; - 1 === O ? (g = t.decoder(y, s.decoder, h, "key"), E = t.strictNullHandling ? null : "") : (g = t.decoder(y.slice(0, O), s.decoder, h, "key"), E = r.maybeMap(l(y.slice(O + 1), t, a(n[g]) ? n[g].length : 0), function(e) {
                    return t.decoder(e, s.decoder, h, "value")
                })), E && t.interpretNumericEntities && "iso-8859-1" === h && (E = o(String(E))), y.indexOf("[]=") > -1 && (E = a(E) ? [E] : E);
                var v = i.call(n, g);
    ...
    f = function(e, t, n, i) {
        ...
        for (var o = i ? t : l(t, n, a), c = e.length - 1; c >= 0; --c) {
            var u, d = e[c];
            if ("[]" === d && n.parseArrays) u = n.allowEmptyArrays && ("" === o || n.strictNullHandling && null === o) ? [] : r.combine([], o);
            else {
                u = n.plainObjects ? {
                    __proto__: null
                } : {};
                var f = "[" === d.charAt(0) && "]" === d.charAt(d.length - 1) ? d.slice(1, -1) : d,
                    ...
                    _ = parseInt(p, 10);
                n.parseArrays || "" !== p ? !isNaN(_) && d !== p && String(_) === p && _ >= 0 && n.parseArrays && _ <= n.arrayLimit ? (u = [])[_] = o : "__proto__" !== p && (u[p] = o) : u = {
                    0: o
                }
            }
            o = u
...
e.exports = function(e, t) {
    ...
    for (var i = "string" == typeof e ? d(e, n) : e, a = n.plainObjects ? {
            __proto__: null
        } : {}, s = Object.keys(i), o = 0; o < s.length; ++o) {
        var l = s[o],
