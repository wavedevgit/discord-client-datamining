/** chunk id: 675654 params = (module,exports,require) **/
"use strict";
n.d(t, {
    E: () => E
});
...
function N(e) {
    ...
    }), b = s.useMemo(() => (0, A.k)(t), [t]), v = s.useMemo(() => (0, A.Z)(t), [t]), [S, y] = s.useState(!1), R = null != d && l.i.VISIBLE.has(d.visibility), O = !E && !R && !C;
    s.useEffect(() => {
        T || (0, x.D)(t)
    }, [T, t]), s.useEffect(() => {
        g()
...
function E(e) {
    ...
    return (0, i.jsx)(o.nVY, {
        ...
        children: n ? (0, i.jsx)(d.A, {}) : (0, i.jsx)(N, {
            guildId: t
        })
    })
}