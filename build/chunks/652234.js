...
let I = s.Ay.connectStores([c.A, h.default, A.A, u.A], () => {
    let e, t, n = c.A.getSyncingWith(),
        ...
        a = [];
    return null != n ? (e = h.default.getUser(n.userId), t = n.partyId) : null != i && null != i.party && null != i.party.id && (e = r, t = i.party.id), null != t && (a = l()(Array.from(u.A.getParty(t) ?? [])).map(e => h.default.getUser(e)).filter(_.Vq).orderBy([t => null == e || e.id === t.id, e => A.A.isFriend(e.id)], ["desc", "desc"]).value()), {
        currentUser: r,
        host: e,
        party: a
    }
