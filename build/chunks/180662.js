...
async function k(e) {
    let {
        ...
        channelId: t,
        messageId: n
    }), r = s().difference(l, i), a = s().difference(i, l), d = C.default.getId(), u = [...r.map(e => ({
...
async function U(e) {
    ...
    try {
        ...
        (0, y.A2)(t, n, e => (l()(null != e, "Must not be able to vote without existing state!"), {
            ...e,
            submitting: !0,
            editing: !1
        })), await k({
            ...
            messageId: n,
            answerIds: e
        }), (0, y.A2)(t, n, () => void 0), d.OR.announce(0 === e.length ? R.intl.string(R.t["xcvy+3"]) : R.intl.string(R.t.o20GSo))
    } catch (e) {
        u.A.show({
