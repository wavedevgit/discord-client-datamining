...
let W = (0, r.animated)(d.fKU),
    z = l.memo(function(e) {
        ...
        let n, s, r, {
            ...
            et = (0, c.bG)([E.A], () => j.A.can(B.xBc.READ_MESSAGE_HISTORY, f) ? null : E.A.getViewingRolesTimestamp(f.getGuildId())),
            {
            ...
            children: [null != ea && ea, (0, i.jsxs)("div", {
                ...
                children: [null == ea && ei, (0, i.jsxs)(W, {
                    ...
                    children: [es, (0, i.jsxs)("ol", {
                        className: a()(K.bv, {
                            [K.FD]: f.isModeratorReportChannel()
                        }),
                        ...
                        children: [(0, i.jsx)("span", {
                            ...
                            className: a()({
                                ...
                                [K.Fb]: 1 === _.length && !_.loadingMore && f.isForumPost() && _.first()?.isFirstMessageInForumPost(f)
                            })
                        })]
                    })]
                }), eu ? null : (0, i.jsx)("div", {
    ...
    Y = l.memo(function(e) {
        let {
            ...
            let t = e.getGuildId(),
                n = (0, c.bG)([v.A], () => null == t || v.A.canChatInGuild(t), [t]),
                {
                    canManageMessages: i,
                    permissionVersion: l
                } = (0, c.cf)([j.A], () => ({
            ...
            var t;
            let n, i = (0, c.bG)([b.A], () => b.A.getMessages(e.id), [e.id]),
