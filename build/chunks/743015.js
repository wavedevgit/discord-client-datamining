...
function G(e) {
    let {
        ...
        channel: i,
        onCategoryClick: s
    } = e, r = (0, S.Rg)(t.id, i.id, i.id), d = (0, S.eK)(t.id, i.id, i.id), c = (0, x.Ay)(i);
    return (0, l.jsxs)("div", {
        className: a()(R.Fv, {
            [R.d0]: "null" === i.id
        }),
...
let B = i.memo(function() {
    ...
    P = i.memo(function(e) {
        let t, {
            ...
            Z = (t = [], y.kvI.GUILD_THREADS_ONLY.has(i.type) && q >= 1 && t.push((0, l.jsx)(_.Text, {
                variant: "text-xs/normal",
                className: R.qy,
                children: L.intl.format(L.t.z0qML2, {
                    count: q
                })
            }, "thread-count")), M.has(i.type) || t.push((0, l.jsx)(_.Text, {
                variant: "text-xs/normal",
                className: R.qy,
                children: (0, I.YC)(i.id)
            }, "active")), null != i.topic && i.topic.length > 0 && t.push((0, l.jsx)(o.A, {
                className: D.PT,
                children: (0, l.jsx)(_.Text, {
                    className: R.At,
                    variant: "text-xs/normal",
                    children: f.A.parseTopic(i.topic, !0, {
                        channelId: i.id
                    })
                })
            }, "topic")), [t.map((e, t) => [e, (0, l.jsx)(k, {
                index: t
            }, `subtitle-separator-${t}`)])].flat(2).slice(0, -1)),
            Y = e => ((e.stopPropagation(), H.has(i.type) || e.shiftKey) ? (0, N.uh)(d.id, i.id) : i.isGuildStageVoice() || i.isGuildVoice() ? (0, v.av)(i) : j.A.openChannelAsSidebar({
                guildId: i.guild_id,
                channelId: i.id,
                baseChannelId: O.VV.CHANNEL_BROWSER
            }), !0),
            z = L.intl.string(L.t.vetGQs);
        i.isGuildStageVoice() || i.isGuildVoice() ? z = L.intl.string(L.t.VJlc0S) : i.isForumLikeChannel() && (z = L.intl.string(L.t["3xjX0U"]));
                    ...
                    children: [(0, l.jsxs)("div", {
                        ...
                        children: [(0, l.jsx)("div", {
                            ...
                            children: (0, l.jsx)(_.Button, {
                                ...
                                text: z,
                                onKeyDown: e => {
                                    (e.key === T.dh.ENTER || e.key === T.dh.SPACE) && (e.preventDefault(), e.stopPropagation(), Y(e))
                                }
                            })
                        }), (0, l.jsx)(_.P7L, {
                            checked: U,
...
function U(e) {
    let {
        ...
        onChannelClick: o
    } = (0, E.A)(n.id), u = (0, m.JZ)(d.M.CHANNEL_BROWSER_NUX) ? 0 : -1, h = i.useCallback(e => {
        let {
            section: i
        } = e;
    ...
    }, [t, n, u, o]), x = i.useCallback(e => {
        let {
            section: i,
            row: s
        } = e;
        if (0 === i && -1 === u) return (0, l.jsx)(w.A, {
            guild: n
        });
    ...
    }, [t, n, u, c, o]), A = (0, w.C)(n.id), g = (0, I.zH)(n.id, t, 64, A);
