...
function P() {
    ...
    i = N.A.getProps().guild, v = !1, S = !1, l = void 0, C.clear(), M.clear(), I = E.XlH.OPEN, R = [...y = null != i ? [...A.A.getSortedRoles(i.id)] : []], w(i?.id, R), O = !1, e && (D.clear(), L.forEach((e, t) => {
        D.set(t, [...e])
    }))
}
...
function w(e, t) {
    t.forEach(t => {
        let n = "solid",
            i = (0, _.aF)(e, t);
        null != t.colors && i && (null != t.colors.tertiary_color ? n = "holographic" : null != t.colors.secondary_color && (n = "gradient"));
        let s = {
            solid: {
                primary_color: E.TGz,
...
let W = new z(m.h, __OVERLAY__ ? {} : {
        ...
        GUILD_SETTINGS_ROLES_UPDATE_PERMISSIONS: function(e) {
            ...
            return F(s, {
                permissions: l = i ? d.WQ(l, n) : d.TF(l, n)
            })
        },
        ...
        GUILD_SETTINGS_ROLES_UPDATE_COLORS: function(e) {
            ...
            let l = (0, h.K3)(n),
                r = M.get(t);
            return null != r && (r.styleColors[i] = n, r.currentStyle = i, M.set(t, {
                ...r
            }), F(s, {
        ...
        GUILD_SETTINGS_PIN_PERMISSION_MIGRATED: function(e) {
            ...
            i = (0, g.hZ)(i, "features", new Set([...i.features, E.GuildFeatures.PIN_PERMISSION_MIGRATION_COMPLETE]))
        },
        GUILD_SETTINGS_SLOWMODE_PERMISSION_MIGRATED: function(e) {
            ...
            if (null == i || t !== i.id) return !1;
            i = (0, g.hZ)(i, "features", new Set([...i.features, E.GuildFeatures.BYPASS_SLOWMODE_PERMISSION_MIGRATION_COMPLETE]))
        }
    }),
    Y = W