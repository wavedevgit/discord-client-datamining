/** chunk id: 33135 params = (module,exports,require) **/
r.d(t, {
    A: () => w
}), r(321073), r(667532);
var n = r(627968),
...
function B(e, t, r, a, i) {
    ...
    if (l.push({
        ...
        Object.keys(m).forEach(s => {
            let l, u = C.default.getUser(s),
                c = A.Ay.getNick(i, s),
                h = (0, F.Xi)(e, s, r);
            null != m[s] && m[s].length > 0 && t.push({
                section: h,
                label: null != u ? (0, n.jsx)(p.A, {
...
function w() {
    let {
        ...
        defaultStats: F.Ay.getAllStats(I.x.DEFAULT),
        streamStats: F.Ay.getAllStats(I.x.STREAM)
    }), [], l.My), r = (0, l.bG)([g.A, f.A], () => f.A.getChannel(g.A.getChannelId())), i = e.concat(t).find(e => null != e.screenshare)?.screenshare, s = t.find(e => null != e.clips)?.clips, p = (0, l.bG)([y.A], () => y.A.theme), A = (0, h.NC)(), b = (0, l.bG)([F.Ay], () => F.Ay.getSection()), E = function(e) {
        let {
            defaultStats: t,
            streamStats: r,
            videoStreams: a,
            ...
            channel: l,
            connectionState: d
        } = e, u = t.flatMap((e, t) => B(I.x.DEFAULT, e, t, a, l?.getGuildId())), p = r.flatMap((e, t) => B(I.x.STREAM, e, t, a, l?.getGuildId())), h = [], y = [], f = {
            section: c.Fq.DIVIDER
        };
        return null != i && (h.push(f), h.push({
