...
let w = s.memo(e => {
    let {
        ...
        sessionId: a,
        nick: o
    } = e, x = s.id, C = (0, r.bG)([v.default], () => v.default.getId() === x, [x]), [S, j, R] = (0, r.yK)([y.Ay], () => C ? [!y.Ay.isSupported() || y.Ay.isSelfMute() || y.Ay.isSelfMutedTemporarily(), y.Ay.isSelfDeaf(), !1] : [!y.Ay.isSupported() || y.Ay.isLocalMute(x), !1, y.Ay.isLocalVideoDisabled(x)], [C, x]), k = (0, r.bG)([L.A], () => L.A.isPrioritySpeaker(x)), w = (0, c.A)({
        userId: x,
        checkSoundSharing: !0
...
let V = [],
    B = function(e) {
        let {
            ...
            children: f,
            isThread: E = !1
        } = e, [I, N] = s.useState(null), T = s.useRef(null), y = (0, b.$n)(l.id, c ?? V), {
            shouldShow: O,
            dismiss: L
        } = (0, C.Z0)(l, {
            collapsed: d
        }), M = s.useRef(new o.J_(50, () => {
            N(T.current), T.current = null
        })), D = s.useRef(new o.J_(175, () => {
            N(null)
        })), P = s.useCallback(e => {
