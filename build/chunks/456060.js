...
function c(e, t, n, l, r) {
    if (e.author.id === l) {
        if (n.isPrivate()) {
            ...
            if (null != e) return r ? a.intl.formatToPlainString(a.t.JddpN2, {
        ...
        return r ? a.intl.formatToPlainString(a.t["2N1kNS"], {
            appName: t
        }) : a.intl.formatToPlainString(a.t.IA6uDV, {
            appName: t
        })
    }
    return r ? a.intl.formatToPlainString(a.t.XE8axA, {
...
function _(e) {
    ...
    return t === r.xL.STREAM_REQUEST ? "" : t === r.xL.LISTEN ? n > 0 ? a.intl.formatToPlainString(a.t.Zogoou, {
        partySize: i,
        maxPartySize: n
