/** chunk id: 886532 params = (module,exports,require) **/
l.d(t, {
    H: () => m
});
var a = l(627968),
    ...
    stories: [{
        ...
        controls: {
            ...
            primaryAsset: {
                label: "Primary Asset",
                type: "text",
                defaultValue: "https://i.imgur.com/xJL1c3t.png"
            },
            backgroundAssetUrl: {
...
function h() {
    let [e, t] = (0, n.useState)("customSounds"), l = `${p.BVt.NITRO_HOME}?perk=${e}`;
    return (0, a.jsxs)("div", {
        style: {
            marginTop: 64,
            display: "flex",
        ...
        children: [(0, a.jsx)(r.k, {
            ...
            children: ["IDs from PerkCardIds.tsx:", (0, a.jsx)("ul", {
                style: {
                    margin: "4px 0 0",
                    paddingLeft: 24,
                    listStyleType: "disc",
                ...
                children: Object.values(d).map(e => (0, a.jsx)("li", {
                    children: e
                }, e))
            })]
        })]
