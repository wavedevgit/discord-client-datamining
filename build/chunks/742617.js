...
function m(e) {
    let {
        activity: t,
        embeddedApp: n
    } = e, l = t?.assets, a = t?.application_id;
    if (null == l || null == l.large_image && null == l.small_image) {
        let e = c.Ay.getApplicationIconURL({
                id: n.application.id,
    ...
    return (0, i.jsx)("div", {
        ...
        children: (0, i.jsxs)("div", {
            ...
            children: [(0, i.jsx)(m, {
                ...
                }), t?.details != null && "" !== t.details && (0, i.jsx)(a.Text, {
                    variant: "text-xs/normal",
                    color: "text-strong",
                    lineClamp: 1,
                    children: t.details
                }), t?.state != null && "" !== t.state && (0, i.jsx)(a.Text, {
                    variant: "text-xs/normal",
                    color: "text-strong",
                    lineClamp: 1,
                    children: t.state
