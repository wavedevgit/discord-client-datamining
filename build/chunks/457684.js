...
function m(e) {
    let {
        ...
        userTeamsLoading: n,
        userTeams: m
    } = e, [A, g] = s.useState(!1), [h, x] = s.useState(!1), [p, E] = s.useState(!1), [C, T] = s.useState(!1), [S, I] = s.useState(null), f = s.useCallback(e => {
        if (e.body.code === u.t02.INVALID_PASSWORD) throw e;
        T(!0), I(e.body.message)
    }, []), N = s.useCallback((e, t) => (0, r.U_)(e, t).then(u.tEg, f), [f]), b = s.useCallback(function() {
        let e = arguments.length > 0 && void 0 !== arguments[0] && arguments[0],
            n = o.A.getGuildsArray().filter(e => e.ownerId === t.id);
        (m?.filter(e => e.owner_user_id === t.id) ?? []).length > 0 ? g(!0) : n.length > 0 ? x(!0) : t.isClaimed() ? (0, a.qfG)(t => (0, i.jsx)(l.default, {
            ...t,
    ...
    return (0, i.jsxs)(i.Fragment, {
        children: [(0, i.jsx)(c.A, {
            ...
            shouldRenderDisableAccountErrorModal: C,
