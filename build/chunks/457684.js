...
function m(e) {
    ...
    }, []), N = s.useCallback((e, t) => (0, l.U_)(e, t).then(u.tEg, f), [f]), b = s.useCallback(function() {
        let e = arguments.length > 0 && void 0 !== arguments[0] && arguments[0],
            n = o.A.getGuildsArray().filter(e => e.ownerId === t.id);
        (m?.filter(e => e.owner_user_id === t.id) ?? []).length > 0 ? g(!0) : n.length > 0 ? x(!0) : t.isClaimed() ? (0, a.qfG)(t => (0, i.jsx)(r.default, {
            ...t,
