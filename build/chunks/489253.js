/** chunk id: 489253, original params: e,t,a (module,exports,require) **/
a.d(t, {
    A: () => A
});
var n = a(627968),
...
function g(e) {
    let {
        ...
        let {
            applicationId: t,
            similarAppIds: a
        } = e, [n, l] = i.useState(), r = (0, s.K)(e => {
            e && l(t)
        });
        return i.useEffect(() => {
            n === t && (0, c.TR)(m.HAw.APP_DIRECTORY_RECOMMENDATIONS_VIEWED, {
                application_id: t,
        ...
        applicationId: t,
        similarAppIds: i.useMemo(() => a.map(e => e.id), [a])
    });
    return (0, n.jsx)("div", {
        className: _.hQ,
        ref: o,
        children: a.map((e, a) => (0, n.jsx)(x, {
            applicationId: t,
...
function x(e) {
    let {
        applicationId: t,
        similarApplication: a,
        onSelectApplication: s,
        position: o,
        similarLoadId: u
    } = e, p = (0, h.A)({
        application: a
    }), g = a.categories?.[0], x = i.useMemo(() => r.Ay.getApplicationIconURL({
        id: a.id,
        icon: a.icon,
        size: 48
    }), [a]), A = i.useCallback(() => {
...
let A = function(e) {
    ...
    return a !== o.e.FETCHING && (null == i || 0 === i.length) ? null : (0, n.jsxs)("div", {
        className: _.hd,
        children: [(0, n.jsx)("div", {
            className: _.yF
        }), (0, n.jsx)(l.Heading, {
