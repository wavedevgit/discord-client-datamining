...
function d(e, t, n, d) {
    ...
    if (!p || n.isDM() || g || l.VW.areStylesDisabled(e) || !(null == (f = e.chatInputType.autocomplete) ? void 0 : f.mentionSuggestions) || !o.ng.getSetting() || null == h || l.ZF.isExpanded(h)) return u;
    let [E, y] = t;
