/** Chunk was on web.js **/
/** chunk id: 158209, original params: e (module,exports,require) **/
let t = e => ({
        IMPORTANT: {
            scope: "meta",
            begin: "!important"
...
e.exports = function(e) {
    ...
    return {
        ...
        case_insensitive: !0,
        illegal: "[=/|']",
        contains: [e.C_LINE_COMMENT_MODE, e.C_BLOCK_COMMENT_MODE, o.CSS_NUMBER_MODE, {
            ...
            contains: [{
                ...
                begin: /[a-z-]+(?=:)/,
                className: "attribute"
            }, f, e.QUOTE_STRING_MODE, e.APOS_STRING_MODE, o.HEXCOLOR, o.CSS_NUMBER_MODE]
        }, o.FUNCTION_DISPATCH]
    }
}