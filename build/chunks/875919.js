/** chunk id: 875919, original params: e,t,n (module,exports,require) **/
"use strict";
n.d(t, {
    A: () => c
});
var r = n(355418),
    i = n(632434),
    a = n(11947);
let o = RegExp("(\\d+|[" + Object.keys(a.uk).join("") + "]+|半|几)(?:\\s*)(?:个)?(秒(?:钟)?|分钟|小时|钟|日|天|星期|礼拜|月|年)(?:(?:之|过)?后|(?:之)?内)", "i"),
    s = 1,
    l = 2;
class c extends r.c {
    innerPattern() {
    ...
    innerExtract(e, t) {
        let n = e.createParsingResult(t.index, t[0]),
            r = parseInt(t[s]);
        if (isNaN(r) && (r = (0, a.CT)(t[s])), isNaN(r)) {
            let e = t[s];
            if ("几" === e) r = 3;
            else {
                if ("半" !== e) return null;
        ...
        let o = {},
            c = t[l][0];
        if (c.match(/[日天星礼月年]/)) {
            "日" == c || "天" == c ? o.day = r : "星" == c || "礼" == c ? o.week = r : "月" == c ? o.month = r : "年" == c && (o.year = r);
            let t = (0, i.Gw)(e.refDate, o);
