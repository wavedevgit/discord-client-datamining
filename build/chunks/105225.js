...
function eb(e) {
    ...
    } = (0, E.Ay)(), m = (0, w.Us)(), p = (0, d.yK)([en.A], () => en.A.getAllActiveStreams()), _ = p.find(e => e.ownerId === n.id), g = s.useRef(null), f = s.useRef(null), x = t.getGuildId(), C = s.useCallback(() => {
        if (l?.(), !a) return (0, e_.A)();
        (0, eg.A)(x, t.id, A)
    }, [x, t.id, a, l, A]), I = (0, k.k0)(), [N, b] = s.useState(!1), S = () => {
        ((0, v.X)(c, v.O.STREAM, !0), a) ? C(): (0, e_.A)()
    }, T = () => {
...
let eT = s.memo(function(e) {
    let {
        ...
        return n !== t?.id
    })), N = (0, G.Qs)(l.id), b = s.useRef(null), S = s.useCallback(() => o?.type === eC.lp.ACTIVITY && o.applicationId === a?.applicationId ? "ACTIVITY" : x ? "STREAM" : null != N ? "EVENT" : "CALL", [o, a?.applicationId, x, N]), [T, y] = s.useState(S()), j = (0, h.zhh)({
        opacity: A ? .2 : 1,
                    ...
                    switch (T) {
                        ...
                        case "EVENT":
                            return (0, i.jsx)(U.A, {
                                channelId: l.id,
                                onClick: () => {
                                    (0, v.X)(r, v.O.DISCONNECT), p.default.disconnect(), n?.()
                                }
                            })
                    }
                })(u, d)
...
function ev(e) {
    let {
        ...
        (0, v.X)(o, v.O.JOIN_VIDEO_CALL), (0, ef.A)(() => p.default.selectVoiceChannel(t.id, !0), r)
...
let ej = function(e) {
    let {
        ...
        exitFullScreen: r,
        idleProps: c
    } = e, u = (0, W.Bx)(), A = s.useRef(null), [p, _] = s.useState(void 0), x = (0, d.bG)([ea.default], () => {
        ...
        autoTrackExposure: !0
    }), ei = (0, H.Ay)(t), eu = s.useRef(null), em = s.useRef(null), e_ = (0, w.Us)(), eg = en ? e => {
