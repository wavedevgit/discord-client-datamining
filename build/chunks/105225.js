...
let eN = l.memo(function(e) {
    let {
        ...
        return n !== t?.id
    })), N = (0, M.Qs)(s.id), T = l.useRef(null), b = l.useCallback(() => o?.type === ep.lp.ACTIVITY && o.applicationId === a?.applicationId ? "ACTIVITY" : x ? "STREAM" : null != N ? "EVENT" : "CALL", [o, a?.applicationId, x, N]), [v, y] = l.useState(b()), j = (0, h.zhh)({
        opacity: A ? .2 : 1,
...
let eb = function(e) {
    let {
        ...
        exitFullScreen: r,
        idleProps: d
    } = e, u = (0, W.Bx)(), A = l.useRef(null), [_, m] = l.useState(void 0), f = (0, c.bG)([ei.default], () => {
                    ...
                    children: [(0, i.jsx)(h.YNO, {
                        ...
                        children: (e, t) => {
                            ...
                            return (0, i.jsx)(X.A, {
                                ...
                                popoutOpen: l,
                                awaitingRemote: P,
                                onClick: () => (0, T.A)(L, v, eg.JJy.VOICE_CONTROL_TRAY)
                            })
                        }
                    }), !k && (0, i.jsx)(h.YNO, {
                        targetElementRef: eu,
