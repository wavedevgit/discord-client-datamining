...
function eb(e) {
    ...
    } = (0, E.Ay)(), m = (0, k.Us)(), p = (0, d.yK)([en.A], () => en.A.getAllActiveStreams()), _ = p.find(e => e.ownerId === n.id), g = s.useRef(null), f = s.useRef(null), x = t.getGuildId(), C = s.useCallback(() => {
        if (l?.(), !r) return (0, e_.A)();
        (0, eg.A)(x, t.id, A)
    }, [x, t.id, r, l, A]), I = (0, w.k0)(), [N, b] = s.useState(!1), S = () => {
        ((0, v.X)(c, v.O.STREAM, !0), r) ? C(): (0, e_.A)()
    }, T = () => {
        (0, v.X)(c, v.O.STREAM, !1), (0, D.A)(_)
    };
    return (0, i.jsxs)(i.Fragment, {
        children: [(() => {
            if (I && 0 === p.length) return (0, i.jsx)(j.Ay, {
...
function eS(e) {
    ...
    return (0, x.A)(r, t.id) ? (0, i.jsx)("div", {
        className: eI.UD,
        children: (0, i.jsx)(eu.K, {
            channel: t,
            idle: n,
            whichPopoutIsOpen: s,
            setWhichPopoutIsOpen: l
...
let eT = s.memo(function(e) {
    let {
        ...
        onDisconnectCall: n,
        channel: l,
        connectedEmbeddedActivity: r
    } = e, {
        parentAnalyticsLocation: a
    } = (0, E.Ay)(), o = (0, d.bG)([I.A], () => I.A.getSelectedParticipant(l.id)), {
        reducedMotion: u
    } = s.useContext(h.CZY), [A, m] = s.useState(!1), g = o?.id, f = (0, d.bG)([en.A], () => null != g ? en.A.getActiveStreamForStreamKey(g) : null, [g]), x = o?.type === eC.lp.STREAM && null != f && f.ownerId !== t?.id, C = (0, d.yK)([en.A], () => en.A.getAllActiveStreamsForChannel(l.id).filter(e => {
        let {
            ownerId: n
        } = e;
        return n !== t?.id
    })), N = (0, G.Qs)(l.id), b = s.useRef(null), S = s.useCallback(() => o?.type === eC.lp.ACTIVITY && o.applicationId === r?.applicationId ? "ACTIVITY" : x ? "STREAM" : null != N ? "EVENT" : "CALL", [o, r?.applicationId, x, N]), [T, y] = s.useState(S()), j = (0, h.zhh)({
        opacity: A ? .2 : 1,
    ...
    let R = s.useCallback(() => {
        if (null != f)(0, _.vN)((0, L._z)(f));
        else
            for (let e of C)(0, _.vN)((0, L._z)(e))
    }, [C, f]);
        ...
        children: (e, s) => {
            ...
            return (0, i.jsx)(c.animated.div, {
                ...
                children: ((e, s) => {
                    ...
                    switch (T) {
                        case "ACTIVITY":
                            if (null == o || null == t || o.type !== eC.lp.ACTIVITY || null == r) return;
                            return (0, i.jsx)(q.A, {
                                ...c,
...
function ev(e) {
    let {
        ...
        reachedLimit: c,
        limit: u
    } = (0, eo.A)(t), h = s.useCallback(() => {
        (0, v.X)(o, v.O.JOIN_VIDEO_CALL), (0, ef.A)(() => p.default.selectVoiceChannel(t.id, !0), a)
    }, [t.id, a, o]), A = s.useCallback(() => {
        n ? (0, ep.A)() : h()
    }, [n, h]), m = (0, d.bG)([ei.A], () => {
...
function ey(e) {
    return (0, y.s)(e, C.A.VOICE_CONTROL_TRAY, {
...
let ej = function(e) {
    let {
        ...
        exitFullScreen: a,
        idleProps: c
    } = e, u = (0, W.Bx)(), A = s.useRef(null), [p, _] = s.useState(void 0), x = (0, d.bG)([er.default], () => {
        ...
        autoTrackExposure: !0
    }), ei = (0, H.Ay)(t), eu = s.useRef(null), em = s.useRef(null), e_ = (0, k.Us)(), eg = en ? e => {
