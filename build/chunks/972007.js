...
let d = e => {
    let {
        ...
        selectedUsers: n,
        limit: l
    } = e, d = (0, r.bG)([c.A], () => c.A.getRecipientStatus()), u = (0, r.bG)([c.A], () => c.A.getReferralsRemaining()), [m, _] = i.useState(0), [A, h] = i.useState([]), [f, E] = i.useState(!1), [g, p] = i.useState(!1), [x, C] = i.useState(new Map);
