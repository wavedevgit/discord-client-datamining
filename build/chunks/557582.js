...
function O(e) {
    let {
        ...
        eventPreview: O,
        recurrenceId: v
    } = e, A = (0, p.A)(i, g.id, v), I = null != g ? g : O, S = (0, s.bG)([c.Ay], () => c.Ay.getNick(i, null == n ? void 0 : n.id), [i, n]);
    v = null == I || null != v ? v : (0, h.G3)(I);
    let {
        startTime: T
    } = (0, f.Ay)(null != g ? g : O, v), C = (0, d.A)(v, g.id), N = (null == I ? void 0 : I.scheduled_start_time) != null ? (0, h.j)(C, T, new Date(I.scheduled_start_time)) : null;
