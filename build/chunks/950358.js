    ...
    return "null" === s.id ? (0, i.jsx)("div", {
        ...
        onContextMenu: e => {
            (0, c.L3)(e, async () => {
                let {
                    default: e
                } = await Promise.all([n.e("21420"), n.e("75149"), n.e("63060")]).then(n.bind(n, 725756));
                return n => (0, i.jsx)(e, {
                    ...n,
                    channel: s,
                    guild: t
        ...
        onClick: e => (e.stopPropagation(), (0, u.S)(t.id, s.id) ? (0, x.bN)(s.id) : (0, d.mMO)(async () => {
            let {
                default: e
...
let N = s.memo(function() {
    ...
    b = s.memo(function(e) {
        ...
        } = e, T = (0, h.Rg)(t.id, s.id), C = (0, h.eK)(t.id, s.id), I = (0, h.v)(t.id, s.id), v = (0, h.fS)(l.id, s.id), S = null != (0, _.A)(l).find(e => e.id === t.id);
        return (0, i.jsxs)(i.Fragment, {
            children: [(0, i.jsx)(o.m, {
                ...
                children: (0, i.jsxs)(d.DUT, {
                    ...
                    onClick: e => {
                        if (!C) return e.stopPropagation(), (0, u.S)(l.id, t.id) ? (0, x.bN)(t.id) : (0, d.mMO)(async () => {
                            let {
                                default: e
                            } = await n.e("54857").then(n.bind(n, 147696));
                            return n => (0, i.jsx)(e, {
                    ...
                    onContextMenu: e => {
                        t.isGuildVocal() ? (0, c.L3)(e, async () => {
                            let {
                                default: e
                            } = await Promise.all([n.e("97262"), n.e("21420"), n.e("57287"), n.e("40394"), n.e("65193")]).then(n.bind(n, 698193));
                            return n => (0, i.jsx)(e, {
                                ...n,
                                channel: t,
                                guild: l
                            ...
                            let {
                                default: e
                            } = await Promise.all([n.e("97262"), n.e("21420"), n.e("57287"), n.e("17091")]).then(n.bind(n, 370372));
                            return n => (0, i.jsx)(e, {
                                ...n,
                                channel: t,
                                guild: l
