...
function A(e) {
    let {
        ...
        autoTrackExposure: !1
    }), h = (0, s.bG)([a.A], () => a.A.getUserAffinitiesMap(), []), A = new Set((0, s.bG)([c.Ay], () => null == t ? [] : c.Ay.getVoiceStatesForChannel(t).map(e => e.user.id), [t])), m = (0, s.yK)([r.Ay, o.default], () => r.Ay.getMembers(n).map(e => o.default.getUser(e.userId)).filter(d.Vq).filter(e => !A.has(e.id)), [n, A]);
