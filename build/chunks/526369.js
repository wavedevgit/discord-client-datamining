...
function S(e) {
    ...
    } = (0, C.P)(), U = (0, r.bG)([h.A], () => h.A.getUserParticipantCount(y.id), [y]), G = (0, p.vp)(y.id, t), P = l.useCallback(() => {
        (0, a.r)(() => {
            C.P.setState({
    ...
    let Y = V && !F;
    null != M && !w && (U >= 2 && Y && !H && !K ? W.push(e => (0, i.jsx)(E.y, {
        channel: y,
        guild: M,
        width: e,
        inPopout: L,
