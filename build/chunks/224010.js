...
let A = t => {
        ...
        return (0, i.jsxs)(c.DUT, {
            ...
            children: [(0, i.jsx)("div", {
                ...
                children: [(0, i.jsx)(c.Heading, {
                    ...
                    color: "text-default",
                    children: "active" === e ? T.intl.formatToPlainString(T.t.IeV2oY, {
                        count: l.toString()
                    }) : T.intl.formatToPlainString(T.t.fZAHBT, {
                        count: l.toString()
                    })
                }), (0, i.jsx)(c.Heading, {
    ...
    _ = () => (0, i.jsxs)("div", {
        ...
        children: [(0, i.jsxs)("div", {
            ...
            className: p.WO,
            children: T.intl.string(T.t.ERdH1o)
        })]
    }),
    I = () => (0, i.jsx)("div", {
        className: p.p$,
    ...
    D = () => (0, i.jsx)(c.Text, {
        ...
        className: p.Ad,
        children: T.intl.string(T.t.QKMRC4)
    }),
    b = t => {
        let {
            classification: e
            ...
            id: l,
            description: r
        } = e, d = x.default.extractTimestamp(l), o = (0, N.e)(e), m = a.useMemo(() => {
            let t = {
                description: r,
            ...
            return (0, g._g)(e) ? e?.guild_metadata?.member_type === h.Z9.OWNER ? T.intl.format(T.t.Lb0HVv, {
                ...t,
        ...
        return (0, i.jsx)(c.DUT, {
            onClick: () => {
                (0, c.mMO)(async () => {
                    let {
                        default: t
                    } = await Promise.all([s.e("57174"), s.e("91652"), s.e("68859"), s.e("92414"), s.e("10026"), s.e("9407"), s.e("55213")]).then(s.bind(s, 956450));
                    return e => (0, i.jsx)(t, {
                        classificationId: l,
            ...
            children: (0, i.jsxs)("div", {
                className: p.iQ,
                children: [o ? (0, i.jsx)(D, {}) : (0, i.jsx)(S, {
                    timestamp: d
                }), (0, i.jsx)(c.Heading, {
    ...
    O = t => {
        let {
            status: e,
            classifications: s
        } = t, [l, n] = a.useState(!1), [d, o] = a.useState(3), x = (0, j.K)(), h = (0, r.bG)([u.A], () => u.A.getIsDsaEligible()), g = a.useMemo(() => s.slice(0, d), [s, d]);
        a.useEffect(() => {
            l && m.default.track(E.HAw.SAFETY_HUB_ACTION, {
            ...
            children: [(0, i.jsx)(A, {
                ...
                children: [(0, i.jsx)(c.VQ0.Separator, {
                    ...
                    children: [(0, i.jsx)(c.VQ0.Separator, {
                        ...
                        className: p.Hr,
                        onClick: () => o(t => t + N),
                        children: T.intl.format(T.t["9Ml56H"], {
                            nextPageSize: N
                        })
                    })]
                }), 0 === g.length && "active" === e && (0, i.jsx)(_, {}), 0 === g.length && "expired" === e && (0, i.jsx)(I, {})]
            })]
        })
    },
    k = () => {
