/** Chunk was on web.js **/
/** chunk id: 576798, original params: e,t,n (module,exports,require) **/
"use strict";
n.d(t, {
    A: () => o
...
function o(e) {
    ...
    return a.A.logGroups.map(r => {
        ...
        let {
            ...
            nativeLogs: p,
            serverTrace: _
        } = r, h = 0 === c ? null != (a = null == (o = i().find(f, e => e.log.indexOf("Logger loaded") >= 0)) ? void 0 : o.timestamp) ? a : e : d, m = l(u(f, p, t, n), h), g = "Trace #".concat(c + 1, " started ").concat((0, s.aK)(d), "\n").concat(m);
...
function u(e, t, n, r) {
    ...
    t.forEach(t => {
        ...
        if (r.startsWith("Finish ") && !r.includes("RUN_JS_BUNDLE") && i.has(r.replace("Finish ", "Start "))) {
            a = a.substring(2);
            let e = s.pop();
            null != e && (o = t.timestamp - e.timestamp, l = l || o > 5 && !d(r), e.shouldKeep = e.shouldKeep || l)
        }
        let u = {
            emoji: "☕",
