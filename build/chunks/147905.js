...
function V(e, t) {
    let [n, i] = l.useState(null != e && e > Date.now() - 1e4), [r, s] = l.useState(!1), [a, o] = l.useState(!0);
    return (0, A.Ay)(() => {
        n && !t && (o(!1), setTimeout(() => {
            s(!0)
        }, 16))
...
let z = l.memo(function(e) {
    ...
    W = l.memo(function(e) {
        let {
            ...
            userId: a.id,
            context: x
        }) || es, eo = (0, o.bG)([N.A], () => N.A.getStreamForUser(a.id, v)), eu = null != eo, ed = l.useCallback(() => {
            (G || null != eu) && P(null)
        }, [P, G, eu]), ec = l.useCallback(() => (0, i.jsx)(_.A, {
            user: a,
            channel: t,
            onWatch: () => {
                null != eo && ((0, g.A9)(eo, {
            ...
            hideTip: !0
        }), [a, t, eo, G, ed, F]), eh = l.useCallback(e => {
            r || E?.(e, a)
    ...
    B = l.memo(function(e) {
        let {
            ...
            voiceState: S,
            connectedOn: T
        } = s, [N, C] = l.useState(null), [y, M] = l.useState(null);
        l.useEffect(() => {
            u && M(null)
        }, [u]), l.useEffect(() => {
            null != N && (0, O.YX)(w.uss.VOICE_V3, {
                type: O.Z5.GO_LIVE,
