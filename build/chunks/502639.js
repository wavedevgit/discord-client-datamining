/** chunk id: 502639, original params: e,t,n (module,exports,require) **/
"use strict";
n.d(t, {
    A: () => b
}), n(896048);
...
let b = function(e) {
    let {
        onCardInfoChange: t,
        error: n
    } = e, a = i.useRef(t), [m, E] = i.useState(!1), [b, O] = i.useState({}), [v, A] = i.useState({
        name: "",
        country: "",
        postalCode: ""
    ...
    i.useEffect(() => {
        let e = b.cardNumber && b.cardExpiry && b.cardCvc && 0 === Object.keys(P(!0)).length;
        a.current({
            name: v.name
        }, !!e)
    }, [b, v, P]);
    ...
    function x(e, t) {
        ...
        I[t] || "" === e || (r[t] = !0), n[t] = e, r[t] && "" === e ? "name" === t && (i.name = p.intl.string(p.t.lIkVsi)) : delete i[t], A(n), S(r), C(i)
    }
