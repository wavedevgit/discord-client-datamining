...
function x(e) {
    let {
        guildId: t,
        scrollToQuestions: n
    } = e, x = (0, s.bG)([a.A], () => a.A.isAdvancedMode(t)), h = (0, s.bG)([d.A], () => d.A.editedDefaultChannelIds), [_, A] = (0, o.tb)(t, h), [p, f] = (0, c.tB)(t, [...h]), j = x ? f.length : A.length, N = x ? p.length : _.length, E = N >= u.Kd, b = f.length - A.length, T = (0, i.jsx)(r.yr3, {
        size: "sm",
