...
let O = (0, m.t_)(p.X.OVERLAY_PANEL, {
        initialize: function() {
            return (0, f.Q)(), g.Ay.addChangeListener(f.Q), c.A.addChangeListener(f.Q), A.default.addChangeListener(f.Q), x.default.addChangeListener(f.Q), h.isPlatformEmbedded && (0, d.a2)(), () => {
                g.Ay.removeChangeListener(f.Q), c.A.removeChangeListener(f.Q), A.default.removeChangeListener(f.Q), x.default.removeChangeListener(f.Q), h.isPlatformEmbedded && (0, d.e0)()
            }
        },
