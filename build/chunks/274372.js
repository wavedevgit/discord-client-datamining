...
function M(e) {
    ...
    L.hardwareClassificationVersion = p.V0, L.hardwareClassification = t, L.hardwareClassification === f.k9.MEETS_AUTO_ENABLE && n !== f.k9.MEETS_AUTO_ENABLE && (L.clipsSettings.clipsEnabled = !0);
    let r = L.hardwareClassificationForDecoupled;
    L.hardwareClassificationForDecoupled = t, L.hardwareClassificationForDecoupled === f.k9.MEETS_AUTO_ENABLE && r !== f.k9.MEETS_AUTO_ENABLE && L.clipsSettings.clipsEnabled && (L.clipsSettings.decoupledClipsEnabled = !0)
}
...
class el extends(r = a.Ay.DeviceSettingsStore) {
    ...
    getMatchingGroupClip(e, t) {
        ...
        for (let s of v) {
            var n, r, i, a;
            if (null != t && s.id === t || null != e && (null == (r = s.decision) || null == (n = r.signal) ? void 0 : n.type) === f.Gy.DISTRIBUTED && (null == (a = s.decision) || null == (i = a.signal) ? void 0 : i.remoteTriggerClipId) === e) return s
        }
        return null
    }
