...
function E(e) {
    let {
        userId: t
    } = e, r = (0, a.bG)([c.default], () => c.default.getId());
    i()(r !== t, "[useSecureFramesPairwiseFingerprint] Should not pass current user id.");
    let [u, E] = n.useState(null), [b, y] = n.useState(!1), A = (0, a.bG)([f.A], () => f.A.getSecureFramesRosterMapEntry(t)), p = (0, a.bG)([f.A], () => f.A.getSecureFramesRosterMapEntry(r)), g = n.useCallback(e => {
        E(l.fromByteArray(e)), y(!1)
        ...
        } else g(await (0, s._x)(0, new Uint8Array(t), e, new Uint8Array(n), r))
    }, [g]), m = n.useRef(null);
    return n.useEffect(() => {
