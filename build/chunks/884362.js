/** chunk id: 884362, original params: e,t,n (module,exports,require) **/
"use strict";
n.d(t, {
    Ay: () => u
}), n(896048);
...
function c(e, t) {
    var n;
    return Array.from((null != (n = t.current) ? n : document).querySelectorAll("[".concat(l.eM, '^="').concat(e, '"]')))
}
...
function u(e) {
    let {
        ...
        useVirtualFocus: E = !1,
        wrap: y = !1,
        orientation: b = s.Gl.VERTICAL,
        disableClickOnSpace: O = !1
    } = e, v = r.useRef(n ? (0, l.t$)(t, n) : null), A = r.useRef(!1), I = r.useRef(null), S = r.useRef(u);
    ...
    let N = r.useCallback((e, t) => {
        ...
        R = r.useCallback(e => {
            if (v.current = e, null == e) return void(0, a.T)(t, null, g);
            let n = (0, l.Mz)(e),
                r = (0, l.HP)(e);
            N(n, r), (0, a.T)(t, r, g)
        }, [t, g, N]),
    ...
    r.useLayoutEffect(() => {
        ...
        function r(e) {
            e.currentTarget.contains(e.relatedTarget) || (L(!1), requestAnimationFrame(() => {
                let e = v.current;
                null !== e && null == T((0, l.Mz)(e)) && w((0, l.Mz)(t, l.KE))
            }))
        }
        async function i() {
            let e = I.current;
            ...
            if (g && null !== n) {
                let t = (0, l.Mz)(n),
                    r = T(t);
                if (null != r) {
                    if (!0 !== A.current) return N(t, (0, l.HP)(n));
                    else if (await (0, o.UN)(e, r)) return N(t, (0, l.HP)(n))
                }
            }
            let r = await (0, o.$b)(e, c(t, I));
            null !== r && R(r)
        }
    ...
    let M = r.useMemo(() => ({
        ...
        j = r.useCallback(async () => {
            let e = await P.getNextFocusableElement(M),
                t = null == e ? void 0 : e.getAttribute(l.eM);
            null != t ? R(t) : null == e && null != _ && _()
        }, [P, M, _, R]),
        k = r.useCallback(async () => {
            let e = await P.getPreviousFocusableElement(M),
                t = null == e ? void 0 : e.getAttribute(l.eM);
            null != t ? R(t) : null == e && null != p && p()
        }, [P, M, p, R]),
        U = r.useCallback(e => {
            if (!S.current || !E && !x.current) return;
            let n = b === s.Gl.HORIZONTAL ? s.D$.RIGHT : s.D$.DOWN,
                r = b === s.Gl.HORIZONTAL ? s.D$.LEFT : s.D$.UP;
            switch (e.key) {
                case n:
                ...
                case s.D$.HOME:
                    e.stopPropagation(), e.preventDefault(), d().then(() => {
                        var e;
                        let n = null == (e = c(t, I)[0]) ? void 0 : e.getAttribute(l.eM);
                        null != n && R(n)
                    });
                    return;
                case s.D$.END:
                ...
                case s.D$.SPACE:
                case s.D$.ENTER: {
                    if (e.key === s.D$.SPACE && O || e.repeat) return;
                    let t = v.current;
                    if (null != t) {
                        var i;
                        let n = T((0, l.Mz)(t)),
        ...
        G = r.useCallback(e => {
            v.current = null != e ? (0, l.t$)(t, e) : null, (0, a.T)(t, e, g)
        }, [t, g]);
    return r.useMemo(() => ({
        id: t,
        containerProps: {
        ...
        async focusLastVisibleItem() {
            var e;
            let n = await (0, o.FT)(null != (e = I.current) ? e : document.body, c(t, I));
            null !== n && R(n)
        },
        async focusFirstVisibleItem() {
            var e;
            let n = await (0, o.$b)(null != (e = I.current) ? e : document.body, c(t, I));
            null !== n && R(n)
        },
        focusPreviousItem: k,
        focusNextItem: j,
