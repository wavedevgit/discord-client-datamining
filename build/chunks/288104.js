/** chunk id: 288104 params = (module,exports,require) **/
e.d(n, {
    A: () => c,
    b: () => S
});
    ...
    switch (t.type) {
        ...
        case d.rbe.GUILD_STAGE_VOICE:
            return [{
                ...
                setting: d.orn.ONLY_MENTIONS,
                label: g.intl.string(g.t["BENn/6"])
            }, {
                setting: d.orn.NO_MESSAGES,
        ...
        default:
            return [{
                ...
                setting: d.orn.ALL_MESSAGES,
                label: g.intl.string(g.t["n/bTaY"])
            }, {
                setting: d.orn.ONLY_MENTIONS,
                label: g.intl.format(g.t.L2hmYy, {})
            }, {
                setting: d.orn.NO_MESSAGES,
                label: g.intl.string(g.t.CtVGyQ)
            }]
...
function S(t) {
    let n = t.getGuildId(),
        ...
        S = (0, r.bG)([a.Ay], () => {
            let e = d.orn.NULL;
            return null != t.parent_id && (e = a.Ay.getChannelMessageNotifications(n, t.parent_id)), e !== d.orn.NULL ? e : a.Ay.getMessageNotifications(n)
        }, [n, t.parent_id]),
    ...
    return null == N ? null : (0, i.jsxs)(i.Fragment, {
        children: [t.isForumLikeChannel() ? (0, i.jsxs)(i.Fragment, {
            ...
            return null != a && (0, i.jsx)(s.iDA, {
                group: "channel-notifications",
                id: `${r}`,
                label: a,
                subtext: r === d.orn.NULL ? function(t) {
                    switch (t) {
                ...
                action: () => {
                    null != n && l.A.updateChannelOverrideSettings(n, e, {
...
function c(t) {
    let n = S(t),
        ...
        o = (null == l ? d.orn.NULL : l.message_notifications) === d.orn.NULL && t.isGuildStageVoice() ? g.intl.format(g.t.L2hmYy, {}) : u(t)?.find(t => {
            let {
                setting: n
            } = t;
            return n === e
        })?.label;
    return null != n ? (0, i.jsx)(s.Drp, {
