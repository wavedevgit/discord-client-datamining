...
function C(e) {
    let {
        ...
        onVolumeChange: Y,
        onMutedChange: z
    } = e, X = (0, o.bG)([p.A], () => p.A.useReducedMotion), V = (0, o.bG)([p.A], () => p.A.keyboardModeEnabled), [W, H] = l.useState(k ? 0 : M), [J, Z] = l.useState(!1), [q, ee] = l.useState(!1), [{
        volumeAnimSpring: et
    }, en] = (0, m.zhh)(() => ({
        from: {
            volumeAnimSpring: 0
    ...
    let ec = 0 === W ? m._RO : W < .5 ? m.S24 : m.HKD,
        {
            icon: ed,
            label: em
        } = h.eC[n];
