...
function C(e) {
    let {
        ...
        onVolumeChange: K,
        onMutedChange: X
    } = e, z = (0, u.bG)([f.A], () => f.A.useReducedMotion), W = (0, u.bG)([f.A], () => f.A.keyboardModeEnabled), [V, H] = l.useState(k ? 0 : M), [J, Z] = l.useState(!1), [q, ee] = l.useState(!1), [{
        volumeAnimSpring: et
    }, en] = (0, m.zhh)(() => ({
        from: {
            volumeAnimSpring: 0
    ...
    let ec = 0 === V ? m._RO : V < .5 ? m.S24 : m.HKD,
        {
            icon: ed,
            label: em
        } = p.eC[n];
