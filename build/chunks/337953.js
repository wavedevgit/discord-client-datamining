...
function S(e) {
    let {
        ...
        onVolumeChange: F,
        onMutedChange: Y
    } = e, z = (0, o.bG)([p.A], () => p.A.useReducedMotion), X = (0, o.bG)([p.A], () => p.A.keyboardModeEnabled), [W, H] = l.useState(L ? 0 : M), [V, J] = l.useState(!1), [Z, q] = l.useState(!1), [{
        volumeAnimSpring: ee
    }, et] = (0, m.zhh)(() => ({
        from: {
            volumeAnimSpring: 0
    ...
    })), en = l.useRef(null), er = l.useCallback(() => {
        if (null == w) return;
        let e = j?.split("/");
    ...
    }, [P]), l.useEffect(() => (null != D && (D.current = eo), () => {
        null != D && (D.current = null)
    }), [eo, D]), l.useEffect(() => (et({
        volumeAnimSpring: Z || V ? 1 : 0,
        immediate: z
    }), () => {
        ee.stop()
    }), [Z, V, et, z, ee]);
    let eu = 0 === W ? m._RO : W < .5 ? m.S24 : m.HKD,
        {
            icon: ec,
            label: ed
        } = f.eC[n];
