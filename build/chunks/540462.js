...
function ek(e) {
    ...
    } = e, d = (0, $.Bx)(), u = (0, c.bG)([L.A], () => l?.type === eL.lp.ACTIVITY ? L.A.getApplication(l.applicationId) : void 0), h = t === eM.DUB.NO_CHAT ? ee.A.Directions.UP : ee.A.Directions.DOWN, A = [eM.DUB.FULL_SCREEN, eM.DUB.NO_CHAT].includes(t);
    return (0, i.jsxs)(i.Fragment, {
        children: [a && d < $.vs.NO_INVITE ? (0, i.jsx)(en.A, {
            channel: n,
            ...
            children: (0, i.jsx)(ee.A, {
                ...
                className: eU.jZ,
                onClick: () => {
                    (0, ej.X)(v.A.VOICE_CONTROL_TRAY, ej.O.CHAT, A), r()
                }
            })
        }) : null]
    })
...
class ew extends l.PureComponent {
    ...
    get viewProperties() {
        let {
            ...
            inCall: i,
            canPopout: l
        } = this.props, s = t === eM._Of.VIDEO && i && !(this.popoutOpen && !this.inPopout), a = t === eM._Of.VIDEO && i && this.popoutSupported && l, r = t !== eM._Of.VOICE && n.isPrivate() && !this.inPopout && i, o = n.type === eM.rbe.GUILD_VOICE, d = {
            renderHeader: !0,
            useTheme: !1,
    ...
    handleFullScreenChange = () => {
        ...
        null != e && ((0, eI._U)(e, this.currentDocument) || this.props.layout !== eM.DUB.FULL_SCREEN || this.handleFullScreen())
    };
    handleFullScreen = () => {
        let e = this.getRootNode();
        null != e && (this.props.layout !== eM.DUB.FULL_SCREEN ? (this._prevLayout = this.props.layout, this.handleChangeLayout(eM.DUB.FULL_SCREEN), (0, eI.tl)(e)) : this.maybeLeaveFullScreen())
    };
    maybeLeaveFullScreen = () => {
        let e = this.getRootNode();
        null == e || this.props.layout === eM.DUB.FULL_SCREEN && (this.handleChangeLayout(this._prevLayout), (0, eI.sP)(e, this.currentDocument))
    };
    handleToggleLayout = () => {
    ...
    handleChangeLayout = e => {
        ...
        i !== e && (m.A.updateLayout(t.id, e, n), e === eM.DUB.FULL_SCREEN && t.isPrivate() && ef._.dispatch(eM.jej.TEXTAREA_BLUR))
    };
    handleDisconnect = () => {
            ...
            case eL.lp.STREAM:
                this.trackCallTileContextMenuImpression(e, eL.qs.STREAM), (0, p.L3)(t, async () => {
                    ...
                    return n => (0, i.jsx)(t, {
                        ...
                        appContext: r,
                        minimal: l,
                        onInteraction: this.getCallTileMenuActionHandler("StreamContextMenu", e, eL.qs.STREAM, s)
                    })
                }, c);
                return;
            case eL.lp.USER:
                ...
                if (null != u) {
                    if (l) return (0, K.r)(t, u, a, c, (e, t) => (0, eO.Y)({
                        menuItemProps: t,
                        menuName: e,
                    ...
                    switch (a.type) {
                        ...
                        case eM.rbe.GROUP_DM:
                            return (0, p.L3)(t, async () => {
                                let {
                                    default: t
                                } = await Promise.all([n.e("97262"), n.e("42128"), n.e("62891"), n.e("39431")]).then(n.bind(n, 228006));
                                return n => (0, i.jsx)(t, {
                                    ...n,
                                    showChannelCallItems: !0,
                                    showMediaItems: !0,
    ...
    handleStayOnTop = e => {
        (0, ej.X)(v.A.VOICE_CONTROL_TRAY, ej.O.STAY_ON_TOP, e), H.setAlwaysOnTop(eM.MLl.CHANNEL_CALL_POPOUT, e)
    };
    handleClosePopout = () => {
    ...
    handleFullscreenParticipant = (e, t) => {
        let {
            layout: n,
            selectedParticipant: i
        } = this.props, l = n === eM.DUB.FULL_SCREEN;
        (!l && i?.id !== e.id || l && i?.id === e.id) && this.handleSelectParticipant(e, t), this.handleFullScreen()
    };
    renderBottomCenter = () => {
        let {
            channel: e,
    ...
    renderBottomRight = () => {
        ...
        return (0, i.jsxs)(i.Fragment, {
            children: [null != l && l.type !== eL.lp.ACTIVITY && l.user.id !== n ? (0, i.jsx)(es.A, {
                ...
                className: eU.iq,
                onOpenPopout: () => {
                    (0, ej.X)(v.A.VOICE_CONTROL_TRAY, ej.O.POPOUT, !0), this.handleOpenPopout()
                },
                onClosePopout: () => {
                    (0, ej.X)(v.A.VOICE_CONTROL_TRAY, ej.O.POPOUT, !1), this.handleClosePopout()
                }
            }) : null, r ? (0, i.jsx)(et.A, {
                themeable: c,
                ...
                className: eU.iq,
                onClick: () => {
                    (0, ej.X)(v.A.VOICE_CONTROL_TRAY, ej.O.FULL_SCREEN, this.props.layout !== eM.DUB.FULL_SCREEN), this.handleFullScreen()
                }
            }) : null]
        })
    };
    ...
    render() {
        let {
            ...
            resizedHeight: u
        } = this.state, h = l === eM._Of.VIDEO, _ = e !== eM.DUB.HAVEN && e !== eM.DUB.NO_CHAT && e !== eM.DUB.FULL_SCREEN && null != d, m = eM.NJ8.MIDNIGHT;
        return (0, i.jsxs)("div", {
            ...
            children: [(0, i.jsx)(A.NPJ, {
                ...
                children: (!c || !this.popoutOpen || this.inPopout) && s && (0, i.jsx)(eb.A, {
                    channel: t,
                    guild: n,
                    maxWidth: o
                })
...
let eB = function(e) {
    let {
        ...
        return e && l !== eM.DUB.FULL_SCREEN && (l = eM.DUB.NO_CHAT), i === eM.DUB.HAVEN && (l = i), {
            mode: n,
            layout: l,
    ...
    }, [f, t.id]), H = (0, c.yK)([er.A], () => er.A.getAllActiveStreams()), {
        selectedStream: W
    } = (0, c.cf)([er.A], () => ({
    ...
    })), J = (0, c.bG)([eh.A], () => eh.A.can(eM.xBc.CONNECT, t)), $ = (0, c.bG)([ed.A], () => ed.A.getToastsEnabled(t.id)), Q = (0, c.bG)([U.default], () => U.default.getAwaitingRemoteSessionInfo()), Z = (0, c.bG)([Y.Ay], () => Y.Ay.callHeaderHeight), ee = l.useCallback(e => {
        E.Ay.updatedUnsyncedSettings({
            callHeaderHeight: e
        })
    }, []), et = (0, c.bG)([T.A], () => T.A.getFetchState(), []), en = (0, C.A)(et);
    l.useEffect(() => {
        et === T.$.ERROR && en !== T.$.ERROR && (0, A.showToast)((0, A.createToast)(eD.intl.string(eD.t["AlJyI+"]), A.ToastType.FAILURE))
    }, [et, en]);
            ...
            children: (0, i.jsx)(eS.qh, {
                children: (0, i.jsxs)(eR.CB, {
                    children: [(0, i.jsx)(ew, {
                        ...
                        popoutType: r,
                        canUseHaven: e_
                    }), !t.isPrivate() && (0, i.jsx)(eR.wQ, {}), (0, i.jsx)(eS.WD, {})]
                })
            })
        })
    })
