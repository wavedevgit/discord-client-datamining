...
class eB extends s.PureComponent {
    ...
    get viewProperties() {
        let {
            ...
            inCall: i,
            canPopout: s
        } = this.props, l = t === eU._Of.VIDEO && i && !(this.popoutOpen && !this.inPopout), a = t === eU._Of.VIDEO && i && this.popoutSupported && s, r = t !== eU._Of.VOICE && n.isPrivate() && !this.inPopout && i, o = n.type === eU.rbe.GUILD_VOICE, c = {
            renderHeader: !0,
            useTheme: !1,
    ...
    handleContextMenu = (e, t, s, l) => {
        ...
        switch (this._lastIdleProps?.onPreventIdle("menu"), this._lastIdleProps?.onActive(), e.type) {
            ...
            case eG.lp.USER:
                ...
                if (null != u) {
                    if (s) return (0, W.r)(t, u, a, d, (e, t) => (0, eD.Y)({
                        menuItemProps: t,
                        menuName: e,
    ...
    handleSelectParticipant = (e, t) => {
        ...
        })), l && a === eU._Of.VIDEO && (i?.id === e.id ? p.A.selectParticipant(n.id, null) : p.A.selectParticipant(n.id, e.id))
    };
    handleOpenPopout = () => {
        let {
            channel: e,
    ...
    renderBottomLeft = () => {
        ...
        return (0, i.jsxs)(i.Fragment, {
            ...
            }) : null, r?.type === eG.lp.STREAM || r?.type === eG.lp.ACTIVITY ? (0, i.jsx)(Q.A, {
    ...
    renderContent(e) {
        ...
        } = this.props, f = A === eU.DUB.MINIMUM, x = f || A === eU.DUB.NORMAL, C = s && a === eU._Of.VIDEO, E = (g?.length ?? 0) > 0 && u.isPrivate();
...
let eH = function(e) {
    ...
    }, [f, t.id]), K = (0, d.yK)([er.A], () => er.A.getAllActiveStreams()), {
        selectedStream: W
    } = (0, d.cf)([er.A], () => ({
    ...
    }, []), ei = z?.id ?? null, es = (0, v.A)(ei, t.id), el = (0, d.bG)([b.A], () => b.A.getFetchState(), []), ea = (0, I.A)(el);
    s.useEffect(() => {
        el === b.$.ERROR && ea !== b.$.ERROR && (0, A.showToast)((0, A.createToast)(eP.intl.string(eP.t["AlJyI+"]), A.ToastType.FAILURE))
    }, [el, ea]);
