...
class ew extends s.PureComponent {
    ...
    handleChangeLayout = e => {
        ...
        i !== e && (_.A.updateLayout(t.id, e, n), e === eM.DUB.FULL_SCREEN && t.isPrivate() && ef._.dispatch(eM.jej.TEXTAREA_BLUR))
    };
    handleDisconnect = () => {
    ...
    handleSelectParticipant = (e, t) => {
        ...
        })), l && r === eM._Of.VIDEO && (i?.id === e.id ? _.A.selectParticipant(n.id, null) : _.A.selectParticipant(n.id, e.id))
    };
    handleOpenPopout = () => {
        let {
            channel: e,
    ...
    renderContent(e) {
        ...
        } = this.props, f = A === eM.DUB.MINIMUM, x = f || A === eM.DUB.NORMAL, C = s && r === eM._Of.VIDEO, E = (p?.length ?? 0) > 0 && u.isPrivate();
    ...
    render() {
        let {
            ...
            resizedHeight: u
        } = this.state, h = s === eM._Of.VIDEO, m = e !== eM.DUB.HAVEN && e !== eM.DUB.NO_CHAT && e !== eM.DUB.FULL_SCREEN && null != c, _ = eM.NJ8.MIDNIGHT;
        return (0, i.jsxs)("div", {
