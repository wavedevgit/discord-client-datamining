...
class eB extends s.PureComponent {
    ...
    componentDidUpdate(e) {
        ...
        null != l && e.mode === eU._Of.VIDEO && i === eU._Of.VOICE && (0, eN._U)(l, this.currentDocument) && (0, eN.sP)(l, this.currentDocument), (e.participantsOpen !== t || s !== e.layout) && this._contentRef.current?.triggerResize(), e.inCall && !n && this.inPopout && p.h.wait(() => this.handleClosePopout())
    }
    ...
    handleChangeLayout = e => {
        ...
        i !== e && (m.A.updateLayout(t.id, e, n), e === eU.DUB.FULL_SCREEN && t.isPrivate() && eC._.dispatch(eU.jej.TEXTAREA_BLUR))
    };
    handleDisconnect = () => {
    ...
    handleSelectParticipant = (e, t) => {
        ...
        })), l && a === eU._Of.VIDEO && (i?.id === e.id ? m.A.selectParticipant(n.id, null) : m.A.selectParticipant(n.id, e.id))
    };
    handleOpenPopout = () => {
        let {
            channel: e,
    ...
    renderBottomLeft = () => {
        ...
        return (0, i.jsxs)(i.Fragment, {
            children: [p ? m : null, h ? (0, i.jsxs)(M.A, {
                className: ew.P0,
...
let eH = function(e) {
    let {
        ...
        ref: _
    } = (0, E.Ay)(), f = (0, B.Us)(), N = (0, U.A)(), b = (0, d.bG)([ep.A], () => (N?.channelId ?? ep.A.getVoiceChannelId()) === t.id), {
        participants: y,
    ...
    }, []), ei = z?.id ?? null, es = (0, v.A)(ei, t.id), el = (0, d.bG)([S.A], () => S.A.getFetchState(), []), ea = (0, I.A)(el);
    s.useEffect(() => {
        el === S.$.ERROR && ea !== S.$.ERROR && (0, A.showToast)((0, A.createToast)(eP.intl.string(eP.t["AlJyI+"]), A.ToastType.FAILURE))
    }, [el, ea]);
    ...
    let em = (0, D.mB)(u.M.CALL_CHAT_BUTTON_TEXT_IN_VOICE_COACH_MARK),
        {
