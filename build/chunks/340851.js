...
function D(e) {
    let {
        numAudience: t,
        collapsed: n
    } = e, s = n ? t : O.intl.formatToPlainString(O.t["+v2pN2"], {
        count: t
    });
    return (0, i.jsxs)("div", {
        className: r()(L.yJ, {
...
let G = (0, A.J)(function(e) {
    let {
        ...
        showHangStatus: ea
    } = e, eo = s.useRef(null), [ec, ed] = s.useState(!1), eu = s.useRef(null), [eh, eA] = s.useState(!1), [em, ep] = s.useState(!1), [e_, eg] = s.useState(!1), ef = eh || e_ || em, ex = () => {
        ed(!ec)
    }, eC = (e, t) => {
    ...
    let eI = () => {
            if (!z || !(0, x.eo)(A, v.A, b.A, S.A, _.default)[0]) return;
            let e = {
