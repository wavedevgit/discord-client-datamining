/** chunk id: 340851 params = (module,exports,require) **/
n.d(t, {
    Ay: () => U,
    LR: () => M,
    aI: () => D
...
function D(e) {
    let {
        numAudience: t,
        collapsed: n
    } = e, l = n ? t : O.intl.formatToPlainString(O.t["+v2pN2"], {
        count: t
    });
    return (0, i.jsxs)("div", {
        className: a()(L.yJ, {
...
let U = (0, A.J)(function(e) {
    let {
        ...
        clearTimeout(eu.current), J?.(s.id)
    };
    l.useEffect(() => () => {
    ...
    let eC = () => {
            ...
            N.default.getId() !== s.id && u.default.selectVoiceChannel(A.id), q ? ((0, E.A)(e), d.A.selectParticipant(e.channelId, (0, f._z)(e))) : (0, h.Nl)(e), J?.(s.id)
        },
        eN = e => {
            (0, c.L3)(e, async () => {
                let {
                ...
                return t => (0, i.jsx)(e, {
                    ...
                    onInteraction: (0, m.s)("GuildChannelUserContextMenu", _.A.VOICE_USER, {
                        targetUserId: s.id
                    })
                })
            })
