...
function U(e) {
    let {
        numAudience: t,
        collapsed: n
    } = e, s = n ? t : M.intl.formatToPlainString(M.t["+v2pN2"], {
        count: t
    });
    return (0, i.jsxs)("div", {
        className: r()(D.yJ, {
...
let P = (0, A.J)(function(e) {
    ...
    let eb = () => {
            ...
            S.default.getId() !== l.id && u.default.selectVoiceChannel(A.id), J ? ((0, C.A)(e), c.A.selectParticipant(e.channelId, (0, f._z)(e))) : (0, h.Nl)(e), ee?.(l.id)
        },
        eS = e => {
            (0, d.L3)(e, async () => {
                let {
