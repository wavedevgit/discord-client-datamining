...
n.d(t, {
    A: () => d
}), n(747238), n(812715), n(896048), n(492834);
var r = n(627968),
    l = n(64700),
    i = n(533925),
    s = n(397927),
...
function d(e) {
    let {
        ...
        isSlideReady: u,
        headerAlignStart: f
    } = e, [h, g] = l.useState(!1), [p, m] = l.useState(null), [b, j] = l.useState(""), y = l.useRef(null), S = o.intl.string(o.t["C/ZAw/"]), x = o.intl.string(o.t.fZSi1D), v = l.useCallback(e => {
        j(e), m(null)
    }, [j, m]);
    return l.useEffect(() => {
        if (u) {
