/** chunk id: 788868, original params: e,t,n (module,exports,require) **/
"use strict";
n.d(t, {
    $3: () => eQ,
    $I: () => c,
...
let b = new Set(["978380692553465866", "1024422698568122368", "511651871736201216", "511651876987469824", "511651880837840896", "642251038925127690", "944037208325619722", "511651885459963904", "1432523012455792640", "511651856145973248", "511651860671627264"]),
    ...
    A = new Set(["642251038925127690", "944037208325619722", "944037355453415424", "944037391444738048"]),
    I = new Set(["978380692553465866", "511651871736201216", "511651880837840896"]),
    S = new Set(["628379151761408000", "944265614527037440", "944265636643602432", "628381571568631808"]),
    T = Object.freeze({
...
let R = Object.freeze({
    ...
    eA = "1397609029626232955",
    eI = "1460778896906522665",
    eS = 8,
    eT = 96,
    eC = Object.freeze({
        [Q]: {
...
let eR = Object.freeze({
    ...
    eU = {
        [i.TVA.NONE]: ek[i.TVA.NONE],
        [i.TVA.TIER_1]: ek[i.TVA.NONE] + ek[i.TVA.TIER_1],
        [i.TVA.TIER_2]: ek[i.TVA.NONE] + ek[i.TVA.TIER_1] + ek[i.TVA.TIER_2],
        [i.TVA.TIER_3]: ek[i.TVA.NONE] + ek[i.TVA.TIER_1] + ek[i.TVA.TIER_2] + ek[i.TVA.TIER_3]
    },
    eG = {
        [i.TVA.NONE]: eS,
        [i.TVA.TIER_1]: 24,
    ...
    eF = Object.freeze({
        [i.TVA.NONE]: {
            ...
            limits: {
                ...
                soundboardSounds: eG[i.TVA.NONE],
                stickers: eU[i.TVA.NONE],
        ...
        [i.TVA.TIER_1]: {
            ...
            limits: {
                ...
                screenShareQualityResolution: "720p",
                soundboardSounds: eG[i.TVA.TIER_1],
                stickers: eU[i.TVA.TIER_1],
                stageVideoUsers: i._i_
            }
        },
        [i.TVA.TIER_2]: {
            features: [i.GuildFeatures.INVITE_SPLASH, i.GuildFeatures.ANIMATED_ICON, i.GuildFeatures.BANNER, i.GuildFeatures.ROLE_ICONS],
            limits: {
                emoji: 150,
                bitrate: 256e3,
                fileSize: ex,
                ...
                soundboardSounds: eG[i.TVA.TIER_2],
                stickers: eU[i.TVA.TIER_2],
                stageVideoUsers: i.nyz
            }
        },
        [i.TVA.TIER_3]: {
            features: [i.GuildFeatures.INVITE_SPLASH, i.GuildFeatures.ANIMATED_ICON, i.GuildFeatures.BANNER, i.GuildFeatures.ANIMATED_BANNER, i.GuildFeatures.VANITY_URL, i.GuildFeatures.ROLE_ICONS],
            limits: {
                emoji: 250,
                bitrate: 384e3,
                fileSize: eM,
                screenShareQualityFramerate: 60,
                screenShareQualityResolution: "1080p",
                soundboardSounds: eG[i.TVA.TIER_3],
                stickers: eU[i.TVA.TIER_3],
...
let te = ["premium_tenure_1_month_v2", "premium_tenure_3_month_v2", "premium_tenure_6_month_v2", "premium_tenure_12_month_v2", "premium_tenure_24_month_v2", "premium_tenure_36_month_v2", "premium_tenure_60_month_v2", "premium_tenure_72_month_v2"],
    tt = {
