...
function I(e) {
    ...
    return (0, n.jsxs)("div", {
        children: [(0, n.jsx)(d.Text, {
            variant: "text-sm/semibold",
            children: h.intl.string(j.default.SQb1dl)
        }), (0, n.jsx)(d.Text, {
...
function v(e) {
    ...
    return (0, n.jsxs)("div", {
        children: [(0, n.jsx)(d.Text, {
            variant: "text-sm/semibold",
            children: h.intl.string(j.default.dDID2M)
        }), (0, n.jsx)(d.Text, {
            variant: "text-xs/normal",
            color: "text-muted",
            className: b.u2,
            ...
            className: b.si,
            children: t.map(e => (0, n.jsx)(d.DUT, {
                onClick: () => s(e),
                children: (0, n.jsx)(m.A, {
                    src: e,
                    className: b.yh
...
function S(e) {
    let {
        ...
        onClose: s,
        channel: l
    } = e, [r, c] = i.useState("HOME"), d = (0, a.bG)([f.A], () => f.A.getRecentImageUrls()), x = i.useCallback(async e => {
        await (0, g._)(l.id, e), s()
    }, [l.id, s]), m = i.useCallback(e => {
        let t = e.src ?? e.url;
        null != t && x(t)
    }, [x]);
    return "GIF_PICKER" === r ? (0, n.jsxs)(o.dWK, {
        transitionState: t,
        onClose: s,
        size: "md",
        children: [(0, n.jsx)(o.rQ0, {
            title: h.intl.string(j.default.HkszWk)
        }), (0, n.jsx)("div", {
            className: b.SD,
