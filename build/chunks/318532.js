...
function N(e) {
    ...
    return (0, l.jsxs)("div", {
        children: [(0, l.jsx)(a.Text, {
            variant: "text-sm/semibold",
            children: _.intl.string(f.default.SQb1dl)
        }), (0, l.jsx)(a.Text, {
...
function y(e) {
    let {
        url: t,
        onSelect: s
    } = e, r = (0, c.S)(t), i = n.useCallback(() => s(t), [t, s]);
    return (0, l.jsx)(a.DUT, {
        className: p.yh,
        style: {
            backgroundColor: r
...
function S(e) {
    ...
    return (0, l.jsxs)("div", {
        children: [(0, l.jsx)(a.Text, {
            variant: "text-sm/semibold",
            children: _.intl.string(f.default.dDID2M)
        }), (0, l.jsx)(a.Text, {
            variant: "text-xs/normal",
            color: "text-muted",
            className: p.u2,
...
function I(e) {
    let {
        ...
        onClose: s,
        channel: a
    } = e, [c, u] = n.useState("HOME"), m = (0, r.bG)([x.A], () => x.A.getRecentImageUrls()), h = n.useCallback(async e => {
        await (0, d._)(a.id, e), s()
    }, [a.id, s]), b = n.useCallback(e => {
        let t = e.src ?? e.url;
        null != t && h(t)
    }, [h]);
    return "RECENT_UPLOADS" === c ? (0, l.jsxs)(i.dWK, {
        transitionState: t,
        onClose: s,
        size: "md",
    ...
    }) : "GIF_PICKER" === c ? (0, l.jsxs)(i.dWK, {
        transitionState: t,
        onClose: s,
        size: "md",
        children: [(0, l.jsx)(i.rQ0, {
            title: _.intl.string(f.default.HkszWk)
        }), (0, l.jsx)("div", {
            className: p.SD,
