...
var r = n(355418),
    i = n(322811),
    a = n(501459);
let s = RegExp("(?:(午前|午後|A.M.|P.M.|AM|PM))?(?:[\\s,，、]*)(?:([0-9０-９]+|[" + Object.keys(a.uk).join("") + "]+)(?:\\s*)(?:時(?!間)|:|：)(?:\\s*)([0-9０-９]+|半|[" + Object.keys(a.uk).join("") + "]+)?(?:\\s*)(?:分|:|：)?(?:\\s*)([0-9０-９]+|[" + Object.keys(a.uk).join("") + "]+)?(?:\\s*)(?:秒)?)(?:\\s*(A.M.|P.M.|AM?|PM?))?", "i"),
    o = RegExp("(?:^\\s*(?:から|\\-|\\–|\\－|\\~|\\〜)\\s*)(?:(午前|午後|A.M.|P.M.|AM|PM))?(?:[\\s,，、]*)(?:([0-9０-９]+|[" + Object.keys(a.uk).join("") + "]+)(?:\\s*)(?:時|:|：)(?:\\s*)([0-9０-９]+|半|[" + Object.keys(a.uk).join("") + "]+)?(?:\\s*)(?:分|:|：)?(?:\\s*)([0-9０-９]+|[" + Object.keys(a.uk).join("") + "]+)?(?:\\s*)(?:秒)?)(?:\\s*(A.M.|P.M.|AM?|PM?))?", "i"),
    l = 1,
    c = 2,
    u = 3,
    d = 4,
...
function _(e, t, n, r, s) {
    ...
    if (s) {
        if (o > 12) return null;
        let e = s;
        "午前" === e || "a" === e[0].toLowerCase() ? (l = i.FF.AM, 12 === o && (o = 0)) : ("午後" === e || "p" === e[0].toLowerCase()) && (l = i.FF.PM, 12 != o && (o += 12))
    }
    return c.assign("hour", o), l >= 0 ? c.assign("meridiem", l) : o < 12 ? c.imply("meridiem", i.FF.AM) : c.imply("meridiem", i.FF.PM), c
}