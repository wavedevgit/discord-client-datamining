/** chunk id: 417454, original params: e,t,l (module,exports,require) **/
l.d(t, {
    Ay: () => W,
    b_: () => V
});
...
function P(e) {
    ...
    return (0, n.jsxs)(S.lGe, {
        ...
        children: [(0, n.jsx)("div", {
            ...
            children: [(0, n.jsx)(S.iFK, {
                size: "xs",
                color: C.A.unsafe_rawColors.PRIMARY_400.css,
                className: M.LP
            }), (0, n.jsx)("div", {
                className: M.VT,
                id: i,
    ...
    let i, {
        ...
        U = r.useCallback(e => {
            (0, h.L3)(e, async () => {
                let {
                    default: e
                } = await l.e("15687").then(l.bind(l, 646938));
                return t => (0, n.jsx)(e, {
                    ...t,
                    id: d.id,
        ...
        P = (0, E.LX)(b);
    null != P && .3 > (0, E.OK)(P) && (w = C.A.unsafe_rawColors.PRIMARY_630.css), i = y ? (0, n.jsx)(g.A, {
        className: M.U4,
        iconClassName: o ? M.gD : void 0,
        color: b,
        size: 14
    }) : "dot" === F ? (0, n.jsx)(S.WYI, {
        className: M.m4,
...
function k(e) {
    let {
        ...
        numRolesHidden: l,
        roleClassName: i
    } = e, o = (0, c.rm)(`overflow-more-roles-${t.id}`), a = r.useRef(null);
...
function H(e) {
    let t = r.useRef(null),
        ...
        A = e => !(0, F.Oy)(e) && !e.managed && U.A.isRoleHigher(l, h, e) && (null == f || -1 === f.roles.indexOf(e.id));
    return (0, n.jsx)(S.YNO, {
        targetElementRef: t,
        renderPopout: e => {
            let {
...
function K(e) {
    let t, {
        ...
        R = r.useCallback(e => {
            ...
            e.tags?.guild_connections === null ? f.A.unassignGuildRoleConnection(i.id, e.id) : D.A.updateMemberRoles(i.id, l.id, t, [], [e.id])
        }, [o, i.id, l.id]),
        m = r.useCallback(e => {
            let t = o;
...
function W(e) {
    return (0, _.bG)([U.A], () => U.A.getGuildVersion(e.guild?.id)), !1 === e.wrap ? (0, n.jsx)(Y, {
        ...e
    }) : (0, n.jsx)(K, {
        ...e
    })
