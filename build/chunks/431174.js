...
function I(e) {
    let {
        ...
        channelId: d,
        messageId: c
    } = (0, f.Tu)(), [A, x] = r.useState(""), [C, I] = r.useState(!1), b = "" !== A && C, T = r.useCallback(() => {
        x((0, g.$m)(c, d, l))
    }, [c, d, l]), v = r.useCallback(() => {
        T(), I(!0)
    }, [T]), S = r.useCallback(() => {
        I(!1)
    }, []), y = r.useCallback(() => {
    ...
    return r.useEffect(() => {
        if (C) return h.A.addReactChangeListener(T), () => {
...
function S(e) {
    ...
    return (0, i.jsx)(x.Fh, {
        ...
        answersInteraction: n,
        canTapAnswers: a,
        renderAnswerContent: e => (0, i.jsx)(v, {
            answer: e,
            isExpired: t,
            answersInteraction: n,
            canShowVoteCounts: r,
