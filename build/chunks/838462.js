...
function v(e) {
    ...
    s()(null != q, "Expected plan to selected"), s()(null != B, "Expected selectedSkuId"), s()(null != Y, "Step should be set");
    let ec = i.useCallback(() => {
        r(), k?.()
    }, [r, k]);
    (0, p.Ay)(() => {
        V && P.default.track(y.HAw.PREMIUM_GROUP_PURCHASE_CONFIRMATION_VIEWED, {
        ...
        function e() {
            if (V)
                if (null != W && W.hasAnyPremiumGroup) {
                    P.default.track(y.HAw.PREMIUM_GROUP_PURCHASE_FRIEND_SELECTOR_OPENED, {
                        subscription_id: W.id
                    });
                    ...
                    (0, c.mMO)(async () => {
                        ...
                        return t => (0, l.jsx)(e, {
                            ...
                            onClose: async () => {
                                T._.dispatch(y.jej.PREMIUM_GROUP_PURCHASE_FLOW_COMPLETED), await t.onClose()
                            }
                        })
                    }, {
                        onCloseRequest: () => {
                ...
                } else P.default.track(y.HAw.PREMIUM_GROUP_PURCHASE_FRIEND_SELECTOR_SKIPPED, {
                    has_updated_subscription: null != W,
                    has_any_premium_group: W?.hasAnyPremiumGroup ?? !1
                }), T._.dispatch(y.jej.PREMIUM_GROUP_PURCHASE_FLOW_COMPLETED)
        }
        return T._.subscribe(y.jej.WOW_MOMENT_CONFIRMATION_MODAL_CLOSED, e), () => {
            T._.unsubscribe(y.jej.WOW_MOMENT_CONFIRMATION_MODAL_CLOSED, e)
        }
    }, [V, W]), i.useEffect(() => {
        !Z || null == X || null == Q || J || $ || (0, A.Ik)(X) || ee({
            onSubscriptionConfirmation: k
        })
    }, [ee, Z, X, Q, J, $, k]), i.useEffect(() => {
        ei && null != eo && null != ea && (0, E.qr)(d.M.GIFTING_PROMOTION_REMINDER, ea, {
            dismissAction: b.i.INDIRECT_ACTION
        })
    }, [eo, ea, ei]);
    let ep = null != D ? x.Rs.DEEPLINK_TO_DESKTOP_APP : void 0;
    if (null != U) t = U(q, ec, W);
    else if (Z) t = (0, l.jsx)(x.fw, {
        planId: q.id,
        onClose: ec
    });
    else {
        let e = K.current === q.id ? {
            postSuccessGuild: w
        } : {
            followupSKUInfo: G,
    ...
    return (0, l.jsxs)(l.Fragment, {
        children: [(0, l.jsxs)(j.dZ, {
            children: [(0, l.jsx)(O.A, {}), t]
        }), null != el && el, ed && null != en && (0, l.jsx)(R.A, {
            rewardSkuId: en,
            onClose: ec
        })]
    })
