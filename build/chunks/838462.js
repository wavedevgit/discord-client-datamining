...
function b(e) {
    ...
    s()(null != B, "Expected plan to selected"), s()(null != W, "Expected selectedSkuId"), s()(null != Y, "Step should be set");
    let ed = l.useCallback(() => {
        r(), k?.()
    }, [r, k]);
    (0, p.Ay)(() => {
        q && T.default.track(y.HAw.PREMIUM_GROUP_PURCHASE_CONFIRMATION_VIEWED, {
        ...
        function e() {
            if (q)
                if (null != K && K.hasAnyPremiumGroup) {
                    T.default.track(y.HAw.PREMIUM_GROUP_PURCHASE_FRIEND_SELECTOR_OPENED, {
                        subscription_id: K.id
                    });
                    ...
                    (0, c.mMO)(async () => {
                        ...
                        return n => (0, i.jsx)(e, {
                            ...
                            onClose: async () => {
                                I._.dispatch(y.jej.PREMIUM_GROUP_PURCHASE_FLOW_COMPLETED), await n.onClose()
                            }
                        })
                    }, {
                        onCloseRequest: () => {
                ...
                } else T.default.track(y.HAw.PREMIUM_GROUP_PURCHASE_FRIEND_SELECTOR_SKIPPED, {
                    has_updated_subscription: null != K,
                    has_any_premium_group: K?.hasAnyPremiumGroup ?? !1
                }), I._.dispatch(y.jej.PREMIUM_GROUP_PURCHASE_FLOW_COMPLETED)
        }
        return I._.subscribe(y.jej.WOW_MOMENT_CONFIRMATION_MODAL_CLOSED, e), () => {
            I._.unsubscribe(y.jej.WOW_MOMENT_CONFIRMATION_MODAL_CLOSED, e)
        }
    }, [q, K]), l.useEffect(() => {
        !Z || null == X || null == Q || J || $ || (0, h.Ik)(X) || ee({
            onSubscriptionConfirmation: k
        })
    }, [ee, Z, X, Q, J, $, k]), l.useEffect(() => {
        el && null != ea && (0, E.$l)(d.M.GIFTING_PROMOTION_REMINDER, (0, S.p)(), {
            dismissAction: v.i.INDIRECT_ACTION
        })
    }, [ea, el]);
    let ec = null != G ? P.Rs.DEEPLINK_TO_DESKTOP_APP : void 0;
    if (null != U) n = U(B, ed, K);
    else if (Z) n = (0, i.jsx)(P.fw, {
        planId: B.id,
        onClose: ed
    });
    else {
        let e = z.current === B.id ? {
            postSuccessGuild: w
        } : {
            followupSKUInfo: D,
    ...
    return (0, i.jsxs)(i.Fragment, {
        children: [(0, i.jsxs)(R.dZ, {
            children: [(0, i.jsx)(O.A, {}), n]
        }), null != ei && ei, eu && null != et && (0, i.jsx)(M.A, {
            rewardSkuId: et,
            onClose: ed
        })]
    })
