...
function v(e) {
    ...
    s()(null != Y, "Expected plan to selected"), s()(null != F, "Expected selectedSkuId"), s()(null != Z, "Step should be set");
    ...
    (0, p.Ay)(() => {
                ...
                if (null != K && K.hasAnyPremiumGroup) {
                    ...
                    (0, c.mMO)(async () => {
                        ...
                        return t => (0, l.jsx)(e, {
                            ...
                            onClose: async () => {
                                A._.dispatch(y.jej.PREMIUM_GROUP_PURCHASE_FLOW_COMPLETED), await t.onClose()
                            }
                        })
                    }, {
                        onCloseRequest: () => {
        ...
        return A._.subscribe(y.jej.WOW_MOMENT_CONFIRMATION_MODAL_CLOSED, e), () => {
            A._.unsubscribe(y.jej.WOW_MOMENT_CONFIRMATION_MODAL_CLOSED, e)
        }
    }, [q, K]), i.useEffect(() => {
        !X || null == Q || null == J || $ || ee || (0, h.Ik)(Q) || et({
            onSubscriptionConfirmation: U
        })
    }, [et, X, Q, J, $, ee, U]), i.useEffect(() => {
        er && null != eu && null != eo && (0, _.qr)(d.M.GIFTING_PROMOTION_REMINDER, eo, {
            dismissAction: b.i.INDIRECT_ACTION
        })
    }, [eu, eo, er]);
    let em = null != L ? x.Rs.DEEPLINK_TO_DESKTOP_APP : void 0;
    if (null != w) t = w(Y, ep, K);
    else if (X) t = (0, l.jsx)(x.fw, {
        planId: Y.id,
        onClose: ep
    });
    else {
    ...
    return (0, l.jsxs)(l.Fragment, {
        children: [(0, l.jsxs)(M.dZ, {
            children: [(0, l.jsx)(k.A, {}), t]
        }), null != ei && ei, ec && null != el && (0, l.jsx)(C.A, {
            rewardSkuId: el,
            onClose: ep
        })]
    })
