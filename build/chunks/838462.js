...
function v(e) {
    ...
    (0, p.Ay)(() => {
        q && P.default.track(y.HAw.PREMIUM_GROUP_PURCHASE_CONFIRMATION_VIEWED, {
                ...
                if (null != K && K.hasAnyPremiumGroup) {
                    ...
                    (0, c.mMO)(async () => {
                        ...
                        return t => (0, l.jsx)(e, {
                            ...
                            onClose: async () => {
                                x._.dispatch(y.jej.PREMIUM_GROUP_PURCHASE_FLOW_COMPLETED), await t.onClose()
                            }
                        })
                    }, {
                        onCloseRequest: () => {
    ...
    return (0, l.jsxs)(l.Fragment, {
        ...
        }), null != ei && ei, ec && null != el && (0, l.jsx)(M.A, {
            rewardSkuId: el,
            onClose: ep
        })]
    })
