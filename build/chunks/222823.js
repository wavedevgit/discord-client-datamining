...
function eL(e, t) {
    var n;
    (null == (n = J.default.getCurrentUser()) ? void 0 : n.hasAnyStaffLevel()) && eo.log("STAFF-ACK-LOG:", t, e.channelId)
}
...
function ej(e) {
    ...
    if (null != _.Ay.getConnectedActivityLocation() && _.Ay.getActivityPanelMode() === et.Gd.PANEL && _.Ay.getFocusedLayout() === et.E8.NO_CHAT) return eL(e, "In activity"), !1;
    ...
    if (!h.A.getChatOpen(e.channelId) && (i === ee.DUB.NO_CHAT || i === ee.DUB.FULL_SCREEN)) return eL(e, "Fullscreen video"), !1;
    if (!eb.isChannelAckable(e.channelId)) return eL(e, "Not ackable"), !1;
    let a = z.A.getMessages(e.channelId);
    return null == a || !a.ready || a.loadingMore ? (eL(e, "Still loading messages"), !1) : (0, N.oE)(e.channelId) ? (eL(e, "Acked"), !0) : (eL(e, "Chat not focused"), !1)
}
class eM {
    static forEach(e) {
    ...
    deserializeForOverlay(e) {
        ...
        this.channelId = t, this.type = null != n ? n : ei.P.CHANNEL, this._guildId = r, this._isThread = null != i && i, null != a ? (this._isActiveThread = a, this._isJoinedThread = a) : (this._isActiveThread = null != s && s, this._isJoinedThread = null != o && o), this._persisted = !1 !== l, this.loadedMessages = null != c && c, this._lastMessageId = u, this._lastMessageTimestamp = d, this._ackMessageId = f, this._ackMessageTimestamp = p, this.ackPinTimestamp = _, this.isManualAck = null != h && h, this.lastPinTimestamp = m, this._oldestUnreadMessageId = g, this.oldestUnreadMessageIdStale = null != E && E, this.estimated = null != y && y, this._unreadCount = null != b ? b : 0, this._mentionCount = O, this.flags = v, this.lastViewed = A, eM._mentionChannels.delete(this.channelId), this._mentionCount > 0 && this.canHaveMentions() && eM._mentionChannels.add(this.channelId)
    }
    ...
    rebuildChannelState(e) {
        ...
        if (this.ackMessageId = null != (t = null != e ? e : this._ackMessageId) ? t : this.guessAckMessageId(), this.isManualAck = null != e, this.oldestUnreadMessageId = null, this.estimated = !1, this.unreadCount = 0, r && (this.mentionCount = 0), this.hasUnread()) {
            ...
            o.forAll(n => {
                ...
                G.default.extractTimestamp(n.id) > t ? (this.unreadCount++, r && ew(n, e) && this.mentionCount++, s = null != s ? s : n.id) : a = !0
    ...
    ackPins() {
        ...
        if (null == e) {
            ...
            this._persisted = !0, ex(() => u.Bo.post({
...
function eY(e) {
    var t, n;
    if ((null == (n = e.guild_scheduled_events) ? void 0 : n.length) === 0 && null == eM.getIfExists(e.id, ei.P.GUILD_EVENT)) return;
...
function e$(e) {
    ...
    eT(), e_ = null, eh || a.partial || eM.clearAll(), eh = !1, a.entries.forEach(e => {
        var t, n;
        ...
        null != a && (0, L.fT)(a.type) && (null == e.last_message_id || 0 === e.last_message_id) ? i.ackMessageId = G.default.fromTimestamp(eK(a.guild_id, a.id)) : i.ackedWhileCached ? -1 === G.default.compare(i.ackMessageId, e.last_message_id) && (i.ackMessageId = e.last_message_id) : i.ackMessageId = e.last_message_id, i.ackedWhileCached = void 0, i.ackPinTimestamp = eC(e.last_pin_timestamp), eM._mentionChannels.delete(i.channelId), i._mentionCount > 0 && i.canHaveMentions() && eM._mentionChannels.add(i.channelId)
...
function e9(e) {
    ...
    } else null == f && (t = X.A.getChannelId(), n = F.Ay.getCurrentSidebarChannelId(t));
    let _ = t === i || n === i;
    ...
    if (null == o.oldestUnreadMessageId || o.oldestUnreadMessageIdStale ? o.oldestUnreadMessageId = a.id : l || (0, N.i$)() === i || (o.oldestUnreadMessageId = a.id), !c && o.unreadCount++, !(Z.A.isBlockedOrIgnoredForMessage(a) || a.type === ee.lAJ.RECIPIENT_REMOVE && (null == d ? void 0 : d.type) === ee.rbe.GROUP_DM)) {
        let {
            shouldMention: e,
...
function ti(e) {
    ...
    if (e.ownerId === (null == n ? void 0 : n.id)) return eM.get(e.id)._persisted = !0, tx({
        channelId: t,
        messageId: e.id,
        manual: !1
    })
...
function tA(e) {
    ...
    tT(ef), tT(ep);
    let a = !1;
    return ef !== t && (a = tC(ef) || a, a = tC(ep) || a), (ef === t || (null == r ? void 0 : r.type) != null && ee.kvI.GUILD_THREADS_ONLY.has(r.type)) && (a = eQ({
        section: ee.JJy.CHANNEL,
...
class t$ extends(i = c.Ay.Store) {
    initialize() {
        H.A, J.default, W.A, Y.A, B.A, X.A, z.A, q.A, h.A, w.A, R.A, F.Ay, b.Ay, y.A, g.A, Q.Ay, $.A, T.A, v.A, x.A, I.A, this.waitFor(w.A, V.default, h.A, F.Ay, B.A, H.A, _.Ay, g.A, Y.A, b.Ay, W.A, K.A, R.A, z.A, T.A, q.A, Z.A, X.A, Q.Ay, x.A, J.default, $.A), this.syncWith([F.Ay], tI)
    }
...
es(t$, "displayName", "ReadStateStore");
let t0 = new t$(p.h, {
