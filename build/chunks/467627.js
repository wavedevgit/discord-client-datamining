...
function er(e) {
    let {
        ...
        return [e, e.version]
    }), o = a.getRoots(), c = (0, h.yK)([L.A], () => L.A.getGeoRestrictedGuilds()).map(e => (0, i.jsx)(K.A, {
        id: e.id,
        name: e.name,
        icon: e.icon
    }, e.id));
...
function ea(e) {
    ...
    let [o] = (0, h.yK)([G.Ay], () => {
        ...
        location: "GuildsBar"
    }), ed = +!!ea + +(ec === y.RK.SERVER_RAIL_TOP), eu = s.useMemo(() => {
        let e, t, n = (e = Q + $, {
            iconSize: Q,
            iconTotalSize: e,
