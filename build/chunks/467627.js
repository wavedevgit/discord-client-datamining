...
class ec {
    ...
    scrollToGuild = (e, t) => {
        ...
        if (null == n || null == e && eo(window.location.pathname) || e === es.sFm.SERVER_DISCOVERY_BADGE || e === es.sFm.E3_SERVER_DISCOVERY_BADGE) return;
...
function ed(e) {
    let {
        ...
        scrollToTop: n,
        lurkingGuildIds: l
    } = e, r = (0, y.A)("TopSection"), {
        isExperimentEnabled: a
    } = (0, T.TW)("TopSection"), o = (0, h.bG)([k.A], () => null != k.A.getVoiceChannelId()), c = (0, b.Ay)(e => e.postConnectionOpen), [d, u] = (0, S.kn)(c && a && !o ? [A.M.FAVORITES_SERVER_ONBOARDING_INTRO] : []), m = d === A.M.FAVORITES_SERVER_ONBOARDING_INTRO, [p] = (0, S.kn)(m ? [A.M.FAVORITES_SERVER_ONBOARDING_MENU_ITEM] : [], void 0, !0), g = p === A.M.FAVORITES_SERVER_ONBOARDING_MENU_ITEM, _ = s.useRef(!1), f = g && r;
    s.useEffect(() => {
    ...
    return (0, i.jsxs)(i.Fragment, {
        children: [(0, i.jsx)(J.C, {}), E === L.RK.SERVER_RAIL_TOP && (0, i.jsx)(M.A, {}), r ? (0, i.jsx)(j.A, {
            shouldShowIntroPopover: g,
            markIntroPopoverAsDismissed: u
        }) : null, !t && (0, i.jsx)(W.A, {}), C.map(e => (0, i.jsx)(ei.A, {
            guildId: e
        }, e)), (0, i.jsx)(en.A, {
            onActivate: n
        })]
...
function eu(e) {
    let {
        ...
        return [e, e.version]
    }), o = a.getRoots(), c = (0, h.yK)([U.A], () => U.A.getGeoRestrictedGuilds()).map(e => (0, i.jsx)(X.A, {
        id: e.id,
        name: e.name,
        icon: e.icon
    }, e.id));
    return (0, i.jsxs)(i.Fragment, {
        ...
        }), c, (0, i.jsx)(Z.A, {}), s ? null : (0, i.jsx)(q.A, {
            disableTooltip: r.length > 0,
            lastTargetNode: o[o.length - 1]
        }), s ? null : t, n ? null : (0, i.jsx)(z.A, {})]
    })
}
...
function eh(e) {
    ...
    let [o] = (0, h.yK)([V.Ay], () => {
        let e = V.Ay.getGuildsTree();
        return [e, e.version]
    }), u = (0, h.bG)([O.A], () => O.A.lurkingGuildIds()), A = s.useMemo(() => n ? [] : u, [u, n]), m = (0, h.bG)([N.A], () => N.A.isFullscreenInContext()), {
        isSorting: f,
        startSorting: C,
        stopSorting: b
    } = (0, H.A)(), S = s.useRef(!1), [T] = s.useState(() => new p.Ep), j = s.useRef(null), R = s.useRef(null), {
        ref: U,
        ...P
    } = (0, d.$y)(), w = (0, _.R7z)(), [k, W] = s.useState(!1), z = (0, _.rdh)(g.A.modules.guildbar.AVATAR_SIZE), q = (0, _.rdh)(g.A.space.SPACE_XS), X = (0, y.A)("GuildsBar"), {
        pathname: J
    } = (0, c.zy)(), {
        entrypoint: Z
    } = (0, L.X8)({
        location: "GuildsBar"
    }), en = +!!X + +(Z === L.RK.SERVER_RAIL_TOP), ei = s.useMemo(() => {
        let e, t, n = (e = z + q, {
            iconSize: z,
            iconTotalSize: e,
    ...
    } = (0, I.Ay)(E.A.GUILDS_LIST), eA = eo(J);
    (0, x.u5)(() => {
