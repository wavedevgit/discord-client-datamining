...
function el(e) {
    let {
        ...
        return [e, e.version]
    }), o = a.getRoots(), c = (0, h.yK)([O.A], () => O.A.getGeoRestrictedGuilds()).map(e => (0, i.jsx)(F.A, {
        id: e.id,
        name: e.name,
        icon: e.icon
    }, e.id));
    return (0, i.jsxs)(i.Fragment, {
        children: [(0, i.jsx)(m.BJc, {
            role: "group",
...
function er(e) {
    let {
        ...
        location: "GuildsBar"
    }), ec = +!!er + +(eo === y.RK.SERVER_RAIL_TOP), ed = s.useMemo(() => {
        let e, t, n = (e = J + Q, {
            iconSize: J,
            iconTotalSize: e,
    ...
    } = (0, E.Ay)(C.A.GUILDS_LIST), eh = en(ea);
    (0, f.u5)(() => {
