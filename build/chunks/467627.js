/** chunk id: 467627 params = (module,exports,require) **/
"use strict";
n.d(t, {
    A: () => eu
});
...
class er {
    ...
    constructor(e, t, n, i, s) {
        this.guildsTree = e, this.setScrolling = t, this.setIsScrolledToBottom = n, this.onScroll = i, this.sizes = s, (0, j.u9)(this.getVisibleGuildIds)
    }
    setResizeObserver = () => {
    ...
    scrollToGuild = (e, t) => {
        ...
        if (null == n || null == e && ea(window.location.pathname) || e === en.sFm.SERVER_DISCOVERY_BADGE || e === en.sFm.E3_SERVER_DISCOVERY_BADGE) return;
        ...
        null != i && (0, u.vq)(i) ? n.scrollIntoViewNode({
            node: i,
            animate: t,
            padding: 24
        }) : n.scrollTo({
    ...
    isItemVisible = (e, t, n) => {
        let {
            iconTotalSize: i,
            badgeVisibleBuffer: s,
            heightBeforeGuilds: l,
            bottomInset: a
        } = this.sizes, r = this.scrollerRef.current;
        if (null == r) return !1;
    ...
    getVisibleGuildIds = () => {
        ...
        return void 0 === n ? [] : this.guildsTree.sortedGuildNodes().filter(e => {
...
function eo(e) {
    ...
    } = (0, S.TW)("TopSection"), [o, c] = (0, b.kn)(r ? [A.M.FAVORITES_SERVER_ONBOARDING_INTRO] : []), d = o === A.M.FAVORITES_SERVER_ONBOARDING_INTRO, [u] = (0, b.kn)(d ? [A.M.FAVORITES_SERVER_ONBOARDING_MENU_ITEM] : [], void 0, !0), m = u === A.M.FAVORITES_SERVER_ONBOARDING_MENU_ITEM, p = s.useRef(!1), g = m && a;
    s.useEffect(() => {
    ...
    return (0, i.jsxs)(i.Fragment, {
        children: [(0, i.jsx)(X.C, {}), x === O.RK.SERVER_RAIL_TOP && (0, i.jsx)(L.A, {}), a ? (0, i.jsx)(y.A, {
            shouldShowIntroPopover: m,
            markIntroPopoverAsDismissed: c
        }) : null, !t && (0, i.jsx)(K.A, {}), f.map(e => (0, i.jsx)(et.A, {
            guildId: e
        }, e)), (0, i.jsx)(ee.A, {
            onActivate: n
        })]
...
function ec(e) {
    let {
        ...
        return [e, e.version]
    }), o = r.getRoots(), c = (0, h.yK)([G.A], () => G.A.getGeoRestrictedGuilds()).map(e => (0, i.jsx)(z.A, {
        id: e.id,
        name: e.name,
        icon: e.icon
    }, e.id));
    return (0, i.jsxs)(i.Fragment, {
        children: [(0, i.jsx)(_.BJc, {
            role: "group",
            "aria-label": ei.intl.string(ei.t["7hB4kg"]),
            gap: "xs",
            children: o.map((e, t) => l(e, t, o.length))
        }), c, (0, i.jsx)(Q.A, {}), s ? null : (0, i.jsx)(Y.A, {
...
function ed(e) {
    ...
    let [o] = (0, h.yK)([w.Ay], () => {
        let e = w.Ay.getGuildsTree();
        return [e, e.version]
    }), u = (0, h.bG)([R.A], () => R.A.lurkingGuildIds()), A = s.useMemo(() => n ? [] : u, [u, n]), m = (0, h.bG)([N.A], () => N.A.isFullscreenInContext()), {
        isSorting: f,
        startSorting: C,
        stopSorting: b
    } = (0, V.A)(), S = s.useRef(!1), [y] = s.useState(() => new p.Ep), j = s.useRef(null), G = s.useRef(null), {
        ref: U,
        ...P
    } = (0, d.$y)(), K = (0, _.R7z)(), [W, Y] = s.useState(!1), z = (0, _.rdh)(g.A.modules.guildbar.AVATAR_SIZE), X = (0, _.rdh)(g.A.space.SPACE_XS), Q = (0, v.A)("GuildsBar"), {
        pathname: ee
    } = (0, c.zy)(), {
        entrypoint: et
    } = (0, O.X8)({
        location: "GuildsBar"
    }), ed = +!!Q + +(et === O.RK.SERVER_RAIL_TOP), eu = s.useMemo(() => {
        let e, t, n = (e = z + X, {
            iconSize: z,
            iconTotalSize: e,
        ...
        return new er(o, Y, en.tEg, () => {
            j.current?.calculateState(), G.current?.calculateState()
        }, n)
    }, [z, X, o, ed]);
    s.useEffect(() => (eu.setResizeObserver(), () => {
        eu.clearResizeObserver()
    }), [eu]);
    let {
        analyticsLocations: eh
    } = (0, I.Ay)(E.A.GUILDS_LIST), eA = ea(ee);
    (0, x.u5)(() => {
        if (!S.current && 0 !== o.size) {
            if (!eA) {
                let {
                    scrollTop: e
                } = D.A.getGuildListDimensions();
                eu.scrollTo({
                    to: e,
                    animate: !1
                })
    ...
    return (0, i.jsx)(I.f5, {
        ...
        children: (0, i.jsx)(_.NPJ, {
            theme: r,
            children: e => (0, i.jsxs)("nav", {
                className: a()(es.iE, l, e, {
                    [es.R]: m
                }),
