...
function L(e) {
    ...
    (0, h.pE)();
    let B = (0, l.bG)([p.default], () => L.isDM() && null != L.recipients && 0 !== L.recipients.length ? p.default.getUser(L.recipients[0]) : null),
        G = (0, l.bG)([C.A], () => null != n ? C.A.getNormalizedSKUEligibility(n) : void 0, [n]),
        {
            primaryIconAsset: F,
            primaryIconLabel: H
        } = a.useMemo(() => (0, x.Cv)(P, w), [P, w]);
    a.useEffect(() => {
        null == t || null == n || A.A.isFetchingForSKU(n) || (0, f.qf)(t, n)
    }, [t, n]);
    let V = a.useCallback(e => {
            e.stopPropagation(), P?.applicationId != null && (0, E.R)({
                skuId: n,
    ...
    }) : null != P && null != k && (0, _.A)(k) && k.guildId === t ? (0, i.jsxs)("div", {
        className: j.kL,
