...
function P(e) {
    let {
        ...
        skuId: n,
        channel: l
    } = e, r = (0, o.bG)([C.A], () => C.A.isFetchingForSKU(n)), P = (0, A.A)({
        skuId: n,
        location: "SocialLayerStorefrontProductDetailsEmbed"
    }), w = P?.applicationId, M = (0, o.bG)([m.A], () => null != w && m.A.isFetchingApplication(w)), D = (0, o.bG)([m.A], () => null != w && m.A.didFetchingApplicationFail(w)), k = (0, p.h)(w), {
        analyticsLocations: O
    } = (0, _.Ay)(u.A.SLAYER_STOREFRONT_PRODUCT_DETAILS_EMBED);
    (0, x.pE)();
    let U = (0, o.bG)([f.default], () => l.isDM() && null != l.recipients && 0 !== l.recipients.length ? f.default.getUser(l.recipients[0]) : null),
        B = (0, o.bG)([v.A], () => null != n ? v.A.getNormalizedSKUEligibility(n) : void 0, [n]),
        {
            primaryIconAsset: G,
            primaryIconLabel: F
        } = a.useMemo(() => (0, E.Cv)(P, w), [P, w]),
        {
            normalPrice: H,
            discountedPrice: V,
            discountPercent: q
    ...
    let W = a.useCallback(e => {
            e.stopPropagation(), P?.applicationId != null && (0, b.R)({
                skuId: n,
    ...
    return (0, i.jsxs)("div", {
        ...
        children: [(0, i.jsx)(N.A, {
            ...
            children: [(0, i.jsxs)("div", {
                className: L.lI,
                children: [(0, i.jsx)(y.V, {}), (0, i.jsxs)("div", {
                    className: L.PB,
                ...
                children: [(0, i.jsx)(d.m, {
                    ...
                    variant: "primary",
                    onClick: z,
                    text: null != K ? j.intl.format(j.t.Xp5WTn, {
                        price: K
