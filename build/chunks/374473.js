...
function P(e, t, n) {
    var r, i, a, s;
    return e ? null != (r = null == (i = I(t)) ? void 0 : i.frameRateEncode) ? r : null : null != (a = null == (s = S(t, n)) ? void 0 : s.frameRateDecode) ? a : null
}
...
function D(e, t) {
    ...
    let x, L = (0, O.B1)(e),
        ...
        eu = null != J ? null == J ? void 0 : J.getVoiceParticipantType() : eo ? "sender" : "receiver",
        ed = null != (n = null == $ ? void 0 : $.getMediaEngineConnectionId()) ? n : null;
    x = null != k && null != Q ? eo ? null == $ || null == (c = $.getOutboundStats()) ? void 0 : c.find(e => e.quality === A.Y4) : null == $ ? void 0 : $.getInboundStats(Q.ownerId) : eo ? null != (h = i().maxBy(null != (D = null == $ ? void 0 : $.getOutboundStats()) ? D : [], e => e.num_frames)) ? h : null : null != ec ? null == $ ? void 0 : $.getInboundStats(ec) : null, (0, g.w)().then(t => {
        var n, r, i, o, l, c, u, d, h, m, g, O, R, D, k, X, ee, ef, ep, e_, eh, em, eg, eE, ey, eb, eO, ev, eA, eI, eS, eT, eC, eN, ew, eR, eP, eD, ex, eL, ej, eM, ek, eU, eG, eV, eF, eB, eH;
        let eY = {
            ...
            parent_media_session_id: null != (o = null == J ? void 0 : J.parentMediaSessionId) ? o : null,
            context: null != U ? U : null,
            voice_backend_version: null != (l = null == (eP = p.A.getRTCConnection()) ? void 0 : eP.getVoiceVersion()) ? l : null,
            rtc_worker_backend_version: null != (c = null == (eD = p.A.getRTCConnection()) ? void 0 : eD.getRtcWorkerVersion()) ? c : null,
            ...
            num_packets_lost: null != (R = null == (ex = T(eo, ed, ec)) ? void 0 : ex.packetsLost) ? R : 0,
            video_codec: null != (D = null != H ? H : (0, a.aV)(null == (eL = T(eo, ed, ec)) ? void 0 : eL.codec.name)) ? D : null,
            video_encoder: null != (k = null != Y ? Y : (0, a.kZ)(null == (ej = I(ed)) ? void 0 : ej.encoderImplementationName)) ? k : null,
            video_decoder: null != (X = null != W ? W : (0, a.s7)(null == (eM = S(ed, ec)) ? void 0 : eM.decoderImplementationName)) ? X : null,
            ...
            target_bitrate: eo && null != (ef = null == (eU = I(ed)) ? void 0 : eU.bitrateTarget) ? ef : null,
            fps: null != (ep = P(eo, el, ec)) ? ep : null,
            target_fps: el === A.x.STREAM && eo ? en : null,
            sender_user_id: null != (e_ = null == Q ? void 0 : Q.ownerId) ? e_ : null,
            stream_region: null != (eh = null == J ? void 0 : J.getRegion()) ? eh : null,
            stream_source_type: eo && null != (em = null == J || null == (eG = J.analyticsContext) ? void 0 : eG.streamSourceType) ? em : null,
            num_stream_viewers: null != (eg = null == J || null == (eV = J.analyticsContext) ? void 0 : eV.numViewers) ? eg : null,
            ...
            audio_input_device_name: null != z ? z : null == (eF = f.A.getInputDevices()[f.A.getInputDeviceId()]) ? void 0 : eF.name,
            audio_output_device_name: null != q ? q : null == (eB = f.A.getOutputDevices()[f.A.getOutputDeviceId()]) ? void 0 : eB.name,
            video_device_name: null != Z ? Z : null == (eH = f.A.getVideoDevices()[f.A.getVideoDeviceId()]) ? void 0 : eH.name,
        ...
        E.default.track(v.HAw.AV_ERROR_REPORTED, eY)
    })
}