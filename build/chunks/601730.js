...
function d() {
    let [e, t] = (0, s.Wl)(r.M.NAGBAR_NOTICE_IGNORE_USER_FEEDBACK, {
        cooldownDurationMs: o.aH
    });
    return e !== r.M.NAGBAR_NOTICE_IGNORE_USER_FEEDBACK ? null : (0, i.jsxs)(l.$Td, {
        color: l.Hv$.BRAND,
        children: [(0, i.jsx)(l.PMB, {
            onClick: () => t(c.i.DISMISS),
            noticeType: E.kqX.IGNORE_USER_FEEDBACK_NAGBAR
        }), _.intl.string(_.t.XkeW9N), (0, i.jsx)(l.Z_L, {
            onClick: () => {
