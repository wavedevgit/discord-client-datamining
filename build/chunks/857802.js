...
let R = e => {
    ...
    }), C = s.useMemo(() => j.filter(e => e.payout_account_status !== I.y.BLOCKED && (0, g.y)(n?.id ?? T.dJq, e)), [j, n]), R = C.length > 0, O = s.useCallback(async () => {
        p.default.track(T.HAw.GUILD_ROLE_SUBSCRIPTION_TEAM_SETUP_CLICKED, {
            is_onboarding_v2: c,
            has_eligible_team: R,
            guild_id: t.id,
            is_owner: r
        });
        let e = await (0, u.a)(T.dSh.DEVELOPER_PORTAL_TEAMS);
        (0, o.A)(e)
