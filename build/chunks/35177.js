...
let g = [{
    ...
    run(e) {
        ...
        if (null == t) return !1;
        let n = !1;
        return null != t.diversitySurrogate && "" !== t.diversitySurrogate && (null == e.textAndImages && (e.textAndImages = a.oJ.create()), null == e.textAndImages.diversitySurrogate && (e.textAndImages.diversitySurrogate = l.hU.create()), e.textAndImages.diversitySurrogate.value = t.diversitySurrogate, n = !0), n
    },
    cleanup() {}
}, {
    version: 4,
    ...
    run(e) {
        ...
        return null != n && (null == e.userContent && (e.userContent = a.YW.create()), null == e.userContent.lastDismissedOutboundPromotionStartDate) && (e.userContent.lastDismissedOutboundPromotionStartDate = l.hU.create({
            value: n
        }), !0)
    },
    cleanup() {}
    ...
    run(e) {
        ...
        return null != n && (null == e.textAndImages && (e.textAndImages = a.oJ.create()), null == e.textAndImages.expressionSuggestionsEnabled) && (e.textAndImages.expressionSuggestionsEnabled = l._t.create({
            value: n
        }), !0)
    },
    cleanup() {
