...
let A = [{
    ...
    run(e) {
        let t = !1;
        return (!0 === s.w.get("HAS_SEEN_HUB_UPSELL") || c.HP.hasHiddenHotspot(c._2.HUB_SECOND_EMAIL_CONNECTION_UPSELL)) && (t = g(e, i.M.HUB_WAITLIST_UPSELL)), t
    },
    cleanup() {
    ...
    run(e) {
        ...
        return !1 === r[h.n5X.INVITE] && g(e, i.M.CHANNEL_NOTICE_INVITE) && (n = !0), !1 === r[h.n5X.QUICKSWITCHER] && g(e, i.M.CHANNEL_NOTICE_QUICKSWITCHER) && (n = !0), !1 === r[h.n5X.GUILD_BOOSTING] && g(e, i.M.CHANNEL_NOTICE_PREMIUM_GUILD_SUBSCRIPTION) && (n = !0), n
    },
    cleanup() {
    ...
    run(e) {
        let t = !1;
        return s.w.get("hideNag") && g(e, i.M.NAGBAR_NOTICE_DOWNLOAD) && (t = !0), s.w.get("hideConnectSpotify") && g(e, i.M.NAGBAR_NOTICE_CONNECT_SPOTIFY) && (t = !0), s.w.get("hideConnectPlayStation") && g(e, i.M.NAGBAR_NOTICE_CONNECT_PLAYSTATION) && (t = !0), t
    },
    cleanup() {
    ...
    run(e) {
        let t = !1;
        return s.w.get("hidePremiumPromo") && g(e, i.M.NAGBAR_NOTICE_PREMIUM_PROMO) && (t = !0), s.w.get("hidePremiumTier2TrialEnding") && g(e, i.M.NAGBAR_NOTICE_PREMIUM_TIER_TWO_TRIAL_ENDING) && (t = !0), s.w.get("hidePremiumReactivateNotice") && g(e, i.M.NAGBAR_NOTICE_PREMIUM_REACTIVATE) && (t = !0), t
    },
    cleanup() {
