...
let g = [{
    ...
    run(e) {
        let t = !1;
        return (!0 === s.w.get("HAS_SEEN_HUB_UPSELL") || d.HP.hasHiddenHotspot(d._2.HUB_SECOND_EMAIL_CONNECTION_UPSELL)) && (t = m(e, a.M.HUB_WAITLIST_UPSELL)), t
    },
    cleanup() {
    ...
    version: 7,
    run: e => p(e, d._2.APPLICATION_COMMAND_TOOLTIP, a.M.APPLICATION_COMMAND_TOOLTIP),
    cleanup() {}
}, {
    version: 8,
    run: e => p(e, d._2.CHANNEL_BANNER_MEMBER_LIST_NOTICE, a.M.CHANNELINFO_CHANNELBANNER_NOTICE),
    cleanup() {}
}, {
    version: 9,
    run: e => (d.HP.hasHiddenHotspot(d._2.MULTI_ACCOUNT_TOOLTIP) && s.w.set(_.JE, "true"), p(e, d._2.MULTI_ACCOUNT_TOOLTIP, a.M.ACCOUNT_MULTIACCOUNT_TOOLTIP)),
    cleanup() {}
}, {
    version: 10,
    run(e) {
        let t = p(e, d._2.HUB_LINK_CHANNEL_NOTICE, a.M.CHANNEL_NOTICE_HUBLINK),
            n = s.w.get("channelNotices") ?? {};
        return !1 === n[h.n5X.INVITE] && m(e, a.M.CHANNEL_NOTICE_INVITE) && (t = !0), !1 === n[h.n5X.QUICKSWITCHER] && m(e, a.M.CHANNEL_NOTICE_QUICKSWITCHER) && (t = !0), !1 === n[h.n5X.GUILD_BOOSTING] && m(e, a.M.CHANNEL_NOTICE_PREMIUM_GUILD_SUBSCRIPTION) && (t = !0), t
    },
    cleanup() {
    ...
    run(e) {
        let t = !1;
        return p(e, d._2.GUILD_EVENT_UPSELL, a.M.GUILD_HEADER_EVENT_UPSELL) && (t = !0), p(e, d._2.ANIMATED_GUILD_BANNER_GUILD_HEADER_TOOLTIP, a.M.GUILD_HEADER_ANIMATED_GUILD_BANNER) && (t = !0), t
    },
    cleanup() {}
}, {
    version: 12,
    run(e) {
        let t = !1;
        return s.w.get("hideNag") && m(e, a.M.NAGBAR_NOTICE_DOWNLOAD) && (t = !0), s.w.get("hideConnectSpotify") && m(e, a.M.NAGBAR_NOTICE_CONNECT_SPOTIFY) && (t = !0), s.w.get("hideConnectPlayStation") && m(e, a.M.NAGBAR_NOTICE_CONNECT_PLAYSTATION) && (t = !0), t
    },
    cleanup() {
    ...
    run(e) {
        let t = !1;
        return s.w.get("hidePremiumPromo") && m(e, a.M.NAGBAR_NOTICE_PREMIUM_PROMO) && (t = !0), s.w.get("hidePremiumTier2TrialEnding") && m(e, a.M.NAGBAR_NOTICE_PREMIUM_TIER_TWO_TRIAL_ENDING) && (t = !0), s.w.get("hidePremiumReactivateNotice") && m(e, a.M.NAGBAR_NOTICE_PREMIUM_REACTIVATE) && (t = !0), t
    },
    cleanup() {
    ...
    version: 14,
    run: e => p(e, d._2.ACTIVITY_BEB_TUTORIAL, a.M.ACTIVITIES_TUTORIAL_COACH_MARK),
    cleanup() {}
}, {
    version: 15,
    run: e => p(e, d._2.NOW_PLAYING_CONSENT_CARD, a.M.NOW_PLAYING_CONSENT_CARD),
    cleanup() {}
}, {
    version: 16,
    run(e) {
    ...
    run(e) {
        let t = !1;
        return p(e, d._2.GUILD_DELETE_FEEDBACK, a.M.GUILD_DELETE_FEEDBACK) && (t = !0), p(e, d._2.GUILD_LEAVE_FEEDBACK, a.M.GUILD_LEAVE_FEEDBACK) && (t = !0), t
    },
    cleanup() {}
}, {
    version: 19,
    run(e) {
        let t = !1;
        return s.w.get("forumHelperCardStorageKey") && (t = m(e, a.M.FORUM_CHANNEL_HELPER_CARD)), t
    },
    cleanup() {
