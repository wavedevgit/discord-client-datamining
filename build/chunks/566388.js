...
let en = "HasBeenInStageChannel",
    ei = e => {
        (0, E.X)(_.A.VOICE_CONTROL_TRAY, E.O.STAY_ON_TOP, e), C.setAlwaysOnTop(Q.MLl.CHANNEL_CALL_POPOUT, e)
    };
...
function el(e) {
    ...
    } = (0, m.Ay)(), h = t.getGuildId(), A = (0, o.bG)([U.A], () => U.A.getMostRecentSelectedTextChannelId(h), [h]), _ = O.default.getId(), f = !(0, o.bG)([p.A], () => p.A.isFullscreenInContext(n)) && (!G.isPlatformEmbedded || P.Ay.supportsFeature(Q.BYE.POPOUT_WINDOWS)), x = null != d && d.type !== Z.lp.ACTIVITY && d.user.id !== _, I = l.useMemo(() => a?.window ?? window, [a]), N = (0, $.A)({
        channel: t,
        appContext: n,
        popoutOpen: s,
        popoutWindow: a,
    ...
    return (0, i.jsxs)(i.Fragment, {
        children: [x ? (0, i.jsx)(R.A, {
            ...
            onClosePopout: () => {
                (0, E.X)(c, E.O.POPOUT, !1), u.h.wait(() => C.close(Q.MLl.CHANNEL_CALL_POPOUT))
            }
        }) : null, N]
    })
}
...
function ea(e) {
    ...
    let P = (0, o.bG)([L.A], () => L.A.getToastsEnabled(n.id)),
        V = (0, J.A)(n) ? null != y ? "84px" : "124px" : null != y ? "0px" : "48px";
...
function er(e) {
    ...
    } = (0, m.Ay)(_.A.STAGE_CHANNEL_CALL), v = (0, I.Us)(), y = (0, o.bG)([p.A], () => p.A.getChatOpen(t.id), [t.id]), j = (0, o.bG)([M.A], () => M.A.getGuild(t.guild_id), [t.guild_id]);
    (0, A.Ay)(() => {
