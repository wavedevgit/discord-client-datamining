...
function E(e) {
    ...
    }, [t, n]), y = (0, s.bG)([_.A], () => _.A.getVoiceChannelId() === t.id, [t.id]);
    l.useEffect(() => {
        S.current = v
    });
    let j = l.useRef(b),
        ...
        G = l.useCallback(e => () => {
            null != O && ((0, u.X)(N, u.O.FULL_SCREEN, e !== x.DUB.FULL_SCREEN), e !== x.DUB.FULL_SCREEN ? (j.current = e, D(e, x.DUB.FULL_SCREEN), (0, f.tl)(O)) : U(e))
        }, [D, U, O, N]);
    l.useEffect(() => {
        let e = () => {
    ...
    return (l.useEffect(() => {
        ...
        !y && T && a.h.wait(() => h.close(x.MLl.CHANNEL_CALL_POPOUT))
    }, [y, T]), M) ? (0, i.jsx)(A.A, {
        themeable: !1,
        node: O,
        guestWindow: I,
