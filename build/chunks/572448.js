...
function D(e) {
    let {
        channel: t,
        gotoChannel: n
    } = e, s = (0, r.bG)([S.default], () => t.isDM() ? S.default.getUser(t.getRecipientId()) : null), l = null == s ? (0, p.Y)(t) : s.getAvatarURL(void 0, 40);
...
function U(e) {
    let {
        ...
        gotoChannel: n,
        mentionCount: s
    } = e, a = (0, r.bG)([I.A], () => I.A.getGuild(t.guild_id)), c = (0, r.bG)([E.A], () => E.A.getChannel(t.parent_id)), u = (0, r.bG)([b.Ay], () => b.Ay.getIsMentionLowImportance(t.id)), h = (0, g.gU)(t, a), A = (0, _.Ay)(t, !1), m = null == c ? a?.name : `${a?.name} › ${c.name}`, p = t.isMultiUserDM() ? y.intl.formatToPlainString(y.t.CxSA5N, {
