...
function G(e) {
    let {
        ...
        gotoChannel: n,
        mentionCount: l
    } = e, a = (0, r.bG)([C.A], () => C.A.getGuild(t.guild_id)), d = (0, r.bG)([I.A], () => I.A.getChannel(t.parent_id)), u = (0, r.bG)([T.Ay], () => T.Ay.getIsMentionLowImportance(t.id)), h = (0, g.gU)(t, a), A = (0, p.Ay)(t, !1), _ = null == d ? a?.name : `${a?.name} › ${d.name}`, m = t.isMultiUserDM() ? v.intl.formatToPlainString(v.t.CxSA5N, {
