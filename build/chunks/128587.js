/** Chunk was on web.js **/
/** chunk id: 128587, original params: e,t,n (module,exports,require) **/
"use strict";
n.d(t, {
    A: () => g,
    w: () => m
...
class g extends a.A {
    ...
    getE2EEStats() {
        let e = i().reduce(this.inboundStats, (e, t) => {
            ...
            return e.passthroughCount += null != (n = t.passthroughCount) ? n : 0, e.decryptSuccessCount += null != (r = t.decryptSuccessCount) ? r : 0, e.decryptFailureCount += null != (i = t.decryptFailureCount) ? i : 0, e.decryptDuration += null != (a = t.decryptDuration) ? a : 0, e.decryptAttempts += null != (s = t.decryptAttempts) ? s : 0, e.decryptMissingKeyCount += null != (o = t.decryptMissingKeyCount) ? o : 0, e.decryptInvalidNonceCount += null != (l = t.decryptInvalidNonceCount) ? l : 0, e.decryptFailureAfterSuccessCount += (null != (c = t.decryptFailureCount) ? c : 0) - (null != (u = t.decryptFailureBeforeSuccessCount) ? u : 0), e
        }, {
            passthroughCount: 0,
            ...
            if (void 0 !== b && y > b) {
                ...
                let v = y - b,
                    A = {
                        ...
                        preemptiveExpanded: null != (d = E.preemptiveExpanded) ? d : 0 - (null != (f = g.preemptiveExpanded) ? f : 0),
    ...
    constructor(e) {
        super(), d(this, "connection", void 0), d(this, "inboundStats", void 0), d(this, "outboundStats", void 0), d(this, "networkQuality", void 0), d(this, "systemResources", void 0), d(this, "duration", void 0), d(this, "decryptionFailures", void 0), d(this, "routingFailures", void 0), d(this, "periodicInboundStats", void 0), d(this, "inputDeviceStats", void 0), d(this, "outputDeviceStats", void 0), d(this, "sampleAudioDevice", void 0), d(this, "appendTargetRates", void 0), d(this, "sampleStats", void 0), this.connection = e, this.sampleAudioDevice = (e, t) => {
            var n, r, i;
            void 0 !== e && (void 0 !== e.restartCount && (t.restartCount = E(e.restartCount, t.restartCount)), void 0 !== e.bufferViolations && (t.bufferViolations = E(e.bufferViolations, t.bufferViolations)), (null != (n = e.timeToFirstCallbackMs) ? n : 0) !== 0 && void 0 === t.timeToFirstCallbackMs && (t.timeToFirstCallbackMs = e.timeToFirstCallbackMs), (null != (r = e.sessionSampleRate) ? r : 0) !== 0 && (t.sessionSampleRate !== e.sessionSampleRate && this.emit("input-device-sample-rate-changed", null != (i = e.sessionSampleRate) ? i : 0), t.sessionSampleRate = e.sessionSampleRate), void 0 !== e.timeFromConnectToFirstCallbackMs && void 0 === t.timeFromConnectToFirstCallbackMs && (t.timeFromConnectToFirstCallbackMs = e.timeFromConnectToFirstCallbackMs))
            ...
            if (null == e) return;
            this.networkQuality.incrementNetworkStats((0, o.tB)()), this.systemResources.takeSample(), this.duration.connected++;
            ...
            i().forEach(e.rtp.outbound, e => {
                if ("audio" === e.type) {
                    ...
                    }), !0 == !!e.audioDetected && null != e.audioLevel && this.outboundStats.speakingAudioLevel.addSample(20 * Math.log(e.audioLevel))
                }
                    ...
                    if ("audio" === t.type) {
                        ...
                        if (null != this.inboundStats[n]) {
                            let e = this.inboundStats[n],
                                ...
                                s = 0,
                                o = e.mosBuckets,
                                l = null != (m = e.decryptFailureBeforeSuccessCount) ? m : j.decryptSuccessCount > 0 ? j.decryptFailureCount : void 0;
            ...
            let a = !1,
                s = !1;
            this.outboundStats.packetsSent > t && (a = !0, this.duration.speaking++), i().reduce(this.inboundStats, (e, t) => (e.packetsReceived += t.packetsReceived, e), {
                packetsReceived: 0
            }).packetsReceived > n.packetsReceived && (s = !0, this.duration.listening++), (a || s) && this.duration.participation++
        }, this.networkQuality = new c.A, this.systemResources = new u.A, this.inboundStats = {}, this.outboundStats = {
            packetsSent: 0,
            bytesSent: 0,
            packetsLost: 0,
            passthroughCount: 0,
