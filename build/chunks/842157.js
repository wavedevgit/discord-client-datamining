/** chunk id: 842157 params = (module,exports,require) **/
n.d(t, {
    A: () => U
}), n(321073);
var i = n(627968),
...
function U(e) {
    let {
    ...
    } = e, ee = V?.timestamps?.start ?? V?.created_at, et = a.useMemo(() => null != ee ? (0, i.jsxs)("div", {
        className: k.Ym,
        children: [(0, i.jsx)(d._xR, {
            ...
            entry: {
                start: ee,
                end: V?.timestamps?.end
            },
            textColor: "currentColor",
            textTabularNumbers: !1,
            textFontCode: !1
        })]
    }) : null, [ee, V?.timestamps?.end]), en = (0, b.v)(t), ei = (0, x.s)(n.id), ea = a.useMemo(() => ei.some(e => (0, g.CZ)(e) === l.m.GLOBAL) ? (0, i.jsxs)(i.Fragment, {
        children: [(0, i.jsx)(d.Y3C, {
            size: "xxs",
            color: "currentColor"
        }), D.intl.string(D.t.TsWCdW)]
    }) : null, [ei]), el = a.useMemo(() => (0, i.jsxs)(d.Text, {
        variant: "text-xs/normal",
        className: k.dS,
        color: "none",
        lineClamp: 2,
        children: [en ? (0, E.YC)(t, r, s, y, !1) : et, en ? null : ea]
    }), [en, t, r, s, y, et, ea]), er = a.useMemo(() => {
        let e = V?.details;
    ...
    }, [V?.details]), es = a.useMemo(() => (0, i.jsxs)("div", {
        className: k.pq,
        children: [er, el, W || en ? null : z]
    }), [el, W, en, z, er]), eo = !!L, ed = (0, A.e)(n), {
        canJoin: ec,
        ...
        isGameLaunchable: eo
    }), e_ = (0, I.M)(V, q, t, n), em = (0, v.E)(V, t, n, y), eh = (0, T.w)(q, V), ep = (0, S.L)(V), eg = (0, o.bG)([f.A], () => null != V && null != V.application_id && f.A.getState(V.application_id, w.xL.JOIN) === w.eAD.LOADING), {
        actions: eA,
        hasAccountLinkButton: ex
    } = a.useMemo(() => {
        let e = null,
            n = !0,
            i = !1;
    ...
    }, [ec, K, e_, em, eh, U, t.author.id, t.id, V, s.id, s.guild_id, Y, eu, y, eg, Q, J, Z, X, ep]), ef = eA.some(e => e.trackingArea === h.kY.CLOUD_PLAY);
    (0, P.A)(ef, Y);
    let eC = a.useMemo(() => eh ? null : (0, i.jsx)(O, {
        presenceActivity: V,
        remoteJoinPlatform: eu,
        isGameLaunchable: eo
    }), [eh, V, eu, eo]);
