...
function m(e) {
    let {
        ...
        userTeamsLoading: n,
        userTeams: m
    } = e, [g, A] = s.useState(!1), [x, h] = s.useState(!1), [p, T] = s.useState(!1), [E, S] = s.useState(!1), [C, f] = s.useState(null), N = s.useCallback(e => {
        if (e.body.code === u.t02.INVALID_PASSWORD) throw e;
        S(!0), f(e.body.message)
    }, []), I = s.useCallback((e, t) => (0, a.U_)(e, t).then(u.tEg, N), [N]), b = s.useCallback(function() {
