...
function _(e) {
    let {
        ...
        userTeamsLoading: n,
        userTeams: _
    } = e, [g, x] = s.useState(!1), [A, h] = s.useState(!1), [p, f] = s.useState(!1), [T, S] = s.useState(!1), [E, b] = s.useState(null), C = s.useCallback(e => {
        ...
        (_?.filter(e => e.owner_user_id === t.id) ?? []).length > 0 ? x(!0) : n.length > 0 ? h(!0) : t.isClaimed() ? (0, l.qfG)(t => (0, i.jsx)(r.default, {
            ...t,
