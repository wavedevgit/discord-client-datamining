/** chunk id: 543198 params = (module,exports,require) **/
n.r(r), n.d(r, {
    default: () => t
}), n(323874), n(14289), n(35956), n(393431), n(532706), n(42231), n(232424), n(949626), n(767709), n(65162), n(321073);
let t = async function() {
    let e = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : {};
    var r, t, a, i, o, s, u, c, f, l, d, b, h, m, p, w, v, g, A, y = "";
    try {
    ...
    function E() {
        var r = g.buffer;
        e.HEAP8 = s = new Int8Array(r), e.HEAP16 = c = new Int16Array(r), e.HEAPU8 = u = new Uint8Array(r), e.HEAPU16 = new Uint16Array(r), e.HEAP32 = f = new Int32Array(r), e.HEAPU32 = l = new Uint32Array(r), e.HEAPF32 = d = new Float32Array(r), e.HEAPF64 = b = new Float64Array(r), h = new BigInt64Array(r), new BigUint64Array(r)
    }
    ...
    var x = r => {
        ...
        $ = function(e) {
            ...
            for (var i = ""; r < a;) {
                ...
                var u = 63 & e[r++];
                if ((o = (240 & o) == 224 ? (15 & o) << 12 | s << 6 | u : (7 & o) << 18 | s << 12 | u << 6 | 63 & e[r++]) < 65536) i += String.fromCharCode(o);
                else {
                    var c = o - 65536;
    ...
    if (e.noExitRuntime && e.noExitRuntime, e.print && (P = e.print), e.printErr && (_ = e.printErr), e.wasmBinary && (a = e.wasmBinary), e.arguments && e.arguments, e.thisProgram && e.thisProgram, e.preInit)
        for ("function" == typeof e.preInit && (e.preInit = [e.preInit]); e.preInit.length > 0;) e.preInit.shift()();
    e.ccall = z, e.cwrap = (e, r, n, t) => {
        var a = !n || n.every(e => "number" === e || "boolean" === e);
        return "string" !== r && a && !t ? j(e) : function() {
    ...
    return x(D), e.setStatus ? (e.setStatus("Running..."), setTimeout(() => {
        setTimeout(() => e.setStatus(""), 1), J()
    }, 1)) : J(), I ? e : new Promise((e, r) => {
        i = e, o = r
    })
}