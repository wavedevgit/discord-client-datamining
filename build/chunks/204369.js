/** Chunk was on web.js **/
/** chunk id: 204369, original params: e,t,n (module,exports,require) **/
"use strict";
n.d(t, {
    A: () => u
}), n(896048);
...
class u {
    ...
    getBadges() {
        var e, t, n;
        return [...null != (e = this._userProfile.badges) ? e : [], ...null != (t = null == (n = this._guildMemberProfile) ? void 0 : n.badges) ? t : []]
    }
    getLegacyUsername() {
    ...
    constructor(e, t) {
        var n, r, i, a;
        l(this, "userId", void 0), l(this, "guildId", void 0), l(this, "banner", void 0), l(this, "bio", void 0), l(this, "pronouns", void 0), l(this, "accentColor", void 0), l(this, "themeColors", void 0), l(this, "profileEffect", void 0), l(this, "popoutAnimationParticleType", void 0), l(this, "fetchStartedAt", void 0), l(this, "fetchEndedAt", void 0), l(this, "_userProfile", void 0), l(this, "_guildMemberProfile", void 0), this.userId = e.userId, this.guildId = null == t ? void 0 : t.guildId, this.banner = null != (n = null == t ? void 0 : t.banner) ? n : e.banner, this.bio = c(e.bio, null == t ? void 0 : t.bio), this.pronouns = c(e.pronouns, null == t ? void 0 : t.pronouns), this.accentColor = e.accentColor, this.themeColors = null != (r = null == t ? void 0 : t.themeColors) ? r : e.themeColors, this.profileEffect = null != (i = null == t ? void 0 : t.profileEffect) ? i : e.profileEffect, this.popoutAnimationParticleType = null != (a = null == t ? void 0 : t.popoutAnimationParticleType) ? a : e.popoutAnimationParticleType, this.fetchStartedAt = e.fetchStartedAt, this.fetchEndedAt = e.fetchEndedAt, this._userProfile = e, this._guildMemberProfile = t
    }
}