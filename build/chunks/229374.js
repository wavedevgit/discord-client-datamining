...
function j(e) {
    ...
    return (0, O.Z_)(t.type) ? (0, l.jsx)(E.DUT, {
...
function v(e) {
    let {
        ...
        jumpToMessage: N,
        listNavigator: h
    } = e, O = G.gs.useSetting(), f = r.useCallback(e => {
        if (e === D.A.getChannelId()) return;
        let t = R.A.getChannel(e);
        null == t || (C.A.can(k.xBc.VIEW_CHANNEL, t) || t.isPrivate()) && (0, m.iN)(t.id)
    }, []), M = null != t ? (0, d.m1)(t, x.default, L.A, !1) : "???", p = t?.parent_id != null ? R.A.getChannel(t.parent_id) : null, b = p?.name ?? null, v = (0, A.gU)(t) ?? E.N$i, P = C.A.can(k.xBc.MANAGE_MESSAGES, t), {
        content: y
    } = (0, I.Ay)({
        content: M,
        embeds: []
        ...
        postProcessor: a
    }), X = r.useRef(null), [B, V] = r.useState(!1);
    r.useEffect(() => {
        let e = X.current;
...
let P = r.memo(function(e) {
    ...
    }, [i, U]), y = r.useRef([]), X = P.reduce((e, t) => e + 1 + t.messages.length, 0), B = r.useCallback((e, t) => {
    ...
    return (0, l.jsxs)(l.Fragment, {
        children: [(0, l.jsx)("div", {
            ...
            children: [(0, l.jsx)("div", {
                ...
                children: U ? o > 0 && d > 0 ? b.intl.formatToPlainString(b.t.OvJs9w, {
                    count: o + d
                }) : o > 0 ? b.intl.formatToPlainString(b.t["n/1QFS"], {
                    count: o
                }) : b.intl.formatToPlainString(b.t.ypezTA, {
                    count: d
                }) : o > 0 && d > 0 ? b.intl.formatToPlainString(b.t.EJHRcV, {
                    count: o + d
                }) : o > 0 ? b.intl.formatToPlainString(b.t.HTE8JP, {
                    count: o
                }) : b.intl.formatToPlainString(b.t.e7f8r9, {
                    count: d
                })
            })]
        }) : null, !x && (0, l.jsx)(p.A, {
