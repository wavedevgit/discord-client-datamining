...
function F(e) {
    ...
    return null != t && (0, O.Z_)(t.type) ? (0, l.jsx)(E.DUT, {
...
function j(e) {
    let {
        ...
        jumpToMessage: N,
        listNavigator: O
    } = e, x = G.gs.useSetting(), M = (0, S.IL)(t), k = r.useCallback(e => {
        if (e === D.A.getChannelId()) return;
        let t = R.A.getChannel(e);
        null == t || (C.A.can(U.xBc.VIEW_CHANNEL, t) || t.isPrivate()) && (0, h.iN)(t.id)
    }, []), j = null != t ? (0, d.m1)(t, f.default, L.A, !1) : "???", v = t?.parent_id != null ? R.A.getChannel(t.parent_id) : null, P = null != v ? (0, d.m1)(v, f.default, L.A) : null, y = (0, A.gU)(t) ?? E.N$i, X = C.A.can(U.xBc.MANAGE_MESSAGES, t), {
        content: B
    } = (0, T.Ay)({
        content: j,
        embeds: []
        ...
        postProcessor: a
    }), V = r.useRef(null), [H, w] = r.useState(!1);
    r.useEffect(() => {
        let e = V.current;
...
let v = r.memo(function(e) {
    let {
        ...
        totalResults: C,
        isSearching: D,
        showBlockedResults: f
    } = t, p = r.useCallback((e, t) => {
        g?.(e, t);
        let n = () => {
    ...
    }, [i, f]), v = r.useRef([]), P = F.reduce((e, t) => e + 1 + t.messages.length, 0), y = r.useCallback((e, t) => {
    ...
    return (0, l.jsxs)(l.Fragment, {
        children: [(0, l.jsx)("div", {
            ...
            children: [(0, l.jsx)("div", {
                ...
                children: f ? o > 0 && d > 0 ? k.intl.formatToPlainString(k.t.OvJs9w, {
                    count: o + d
