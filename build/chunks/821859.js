...
function m(e) {
    let {
        ...
        duration: v,
        onClick: x
    }), M = i.useMemo(() => null == D || null == _ ? null : (0, o.rB)((0, o.hc)(D, _, v)), [D, _, v]), k = i.useMemo(() => {
    ...
    return (0, r.jsxs)("div", {
        ...
        children: [(0, r.jsxs)(u.DUT, {
            ...
            children: [f?.map(e => (0, r.jsx)("div", {
            ...
            }, `${e.start}:${e.size}`)), !m && null != L && L > 0 && (0, r.jsx)("div", {
                ...
                animate: s
            }), j && null != M && t && (0, r.jsx)(u.Text, {
                className: d.Ey,
                variant: "text-xs/normal",
                color: "always-white",
                style: {
                    left: null != D ? `${D}px` : "auto"
                },
                children: M
            }), j && m && null != k && (0, r.jsx)("div", {
                className: d.Ub,
                style: {
                    left: `${k}px`
                }
            })]
        }), E !== a.Q6.ENDED && (0, r.jsx)("div", {
            className: d.pN,
            style: {
                width: `${n}%`
            }
