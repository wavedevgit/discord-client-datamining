/** chunk id: 404108, original params: e,t,n (module,exports,require) **/
"use strict";
n.d(t, {
    p: () => _
});
...
function _(e) {
    ...
    (0, p.useEffect)(() => {
        _ === n.focusedKey && n.isFocused && (y ? (0, f.vX)(g.current) : b ? b() : document.activeElement !== g.current && g.current && (0, c.l)(g.current))
    }, [g, _, n.focusedKey, n.childFocusStrategy, n.isFocused, y]), O = O || n.isDisabled(_);
    let C = {};
    y || O ? O && (C.onMouseDown = e => {
        e.preventDefault()
    }) : C = {
    ...
    if (E ? (B.onPressStart = e => {
            ...
            L || x && "mouse" !== e.pointerType ? ("keyboard" !== e.pointerType || h()) && F(e) : "keyboard" !== e.pointerType && P && T(e)
        }) : (B.onPressStart = e => {
            j.current = e.pointerType, U.current = k, G.current = L, P && ("mouse" === e.pointerType && !L || "keyboard" === e.pointerType && (!D || m())) && T(e)
        }, B.onPress = e => {
            ("touch" === e.pointerType || "pen" === e.pointerType || "virtual" === e.pointerType || "keyboard" === e.pointerType && M && h() || "mouse" === e.pointerType && G.current) && (M ? F(e) : P && T(e))
    ...
    let {
        ...
        "mouse" === j.current && (e.stopPropagation(), e.preventDefault(), F(e))
    } : void 0, {
        longPressProps: K
    } = (0, d.H)({
        isDisabled: !k,
