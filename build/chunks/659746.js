/** Chunk was on web.js **/
/** chunk id: 659746, original params: e,t,n (module,exports,require) **/
"use strict";
n.d(t, {
    Ay: () => S,
    Or: () => A
...
let v = Object.freeze({
    ...
    DELAY: {
        [_.PremiumTypes.TIER_0]: 400,
        [_.PremiumTypes.TIER_1]: 400,
        [_.PremiumTypes.TIER_2]: 2200
    },
...
class I extends(r = a.PureComponent) {
    ...
    getSvgBorderGradientId() {
        ...
        switch (t) {
            case "GUILD_BOOST_APPLIED":
                return f.gi.PREMIUM_GUILD;
            case "PREMIUM_ACTIVATED":
            case "PREMIUM_PAYMENT_STARTED":
            case "PREMIUM_UPGRADED":
            case "PREMIUM_UPDATED":
                if (e === _.PremiumTypes.TIER_0) return f.gi.PREMIUM_TIER_0;
                if (e === _.PremiumTypes.TIER_1) return f.gi.PREMIUM_TIER_1;
                return f.gi.PREMIUM_TIER_2;
            default:
    ...
    render() {
        ...
        return (0, i.jsxs)("div", {
            className: o()(h.kL, e),
            children: [this.renderSvgBorder(), (0, i.jsxs)(l.A.div, {
                className: h.Mp,
                style: this.getContainerStyle(),
                children: [(0, i.jsx)(d.kFQ, {
