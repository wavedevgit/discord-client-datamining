/** chunk id: 659746, original params: a,l,h (module,exports,require) **/
h.d(l, {
    Ay: () => p,
    Or: () => L
});
...
let C = Object.freeze({
    DURATION: {
        ...
        [o.PremiumTypes.TIER_1]: 1e3,
        [o.PremiumTypes.TIER_2]: 1500
    },
    DELAY: {
        [o.PremiumTypes.TIER_0]: 400,
        [o.PremiumTypes.TIER_1]: 400,
        [o.PremiumTypes.TIER_2]: 2200
    },
    FLASH_TIME_PERCENT: .72,
    FLASH_DURATION_PERCENT: .08
});
var L = ((e = {}).PREMIUM_ACTIVATED = "PREMIUM_ACTIVATED", e.PREMIUM_UPDATED = "PREMIUM_UPDATED", e.PREMIUM_UPGRADED = "PREMIUM_UPGRADED", e.GUILD_BOOST_APPLIED = "GUILD_BOOST_APPLIED", e.PREMIUM_PAYMENT_STARTED = "PREMIUM_PAYMENT_STARTED", e);
class H extends s.PureComponent {
    ...
    getContainerStyle() {
        let {
            flashColor: a
        } = this.props, l = C.FLASH_TIME_PERCENT, h = C.FLASH_DURATION_PERCENT, e = (0, M.tp)(a, 0);
        return {
            ...
            case "GUILD_BOOST_APPLIED":
                return (0, t.jsx)("svg", {
                    ...
                    children: (0, t.jsx)("rect", {
                        ...
                        height: "46",
                        rx: "8",
                        stroke: `url(#${this.getSvgBorderGradientId()})`,
                        strokeWidth: "2"
                    })
                });
            case "PREMIUM_PAYMENT_STARTED":
    ...
    render() {
        ...
        return (0, t.jsxs)("div", {
            className: i()(E.kL, a),
            children: [this.renderSvgBorder(), (0, t.jsxs)(c.A.div, {
                className: E.Mp,
                style: this.getContainerStyle(),
                children: [(0, t.jsx)(A.kFQ, {
...
function p(a) {
    let {
        theme: l,
        ...h
    } = a, e = (0, A.rdh)(n.A.unsafe_rawColors.WHITE).hex(), s = (0, A.rdh)(n.A.unsafe_rawColors.BRAND_500).hex(), r = (0, d.Mw)(l) ? e : s;
    return (0, t.jsx)(H, {
        ...h,
        theme: l,
        flashColor: r
