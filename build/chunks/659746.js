/** Chunk was on 62175 **/
/** chunk id: 659746, original params: a,e,l (module,exports,require) **/
l.d(e, {
    Ay: () => L,
    Or: () => P
}), l(65821), l(896048);
...
var P = ((h = {}).PREMIUM_ACTIVATED = "PREMIUM_ACTIVATED", h.PREMIUM_UPDATED = "PREMIUM_UPDATED", h.PREMIUM_UPGRADED = "PREMIUM_UPGRADED", h.GUILD_BOOST_APPLIED = "GUILD_BOOST_APPLIED", h.PREMIUM_PAYMENT_STARTED = "PREMIUM_PAYMENT_STARTED", h);
class g extends(t = s.PureComponent) {
    componentDidMount() {
        this.animate()
    }
    animate() {
    ...
    getContainerStyle() {
        let {
            flashColor: a
        } = this.props, e = C.FLASH_TIME_PERCENT, l = C.FLASH_DURATION_PERCENT, t = (0, A.tp)(a, 0);
        return {
            backgroundColor: this.animation.interpolate({
                inputRange: [0, e, e, e + l, 1],
                outputRange: [t, t, a, a, t]
            })
        }
    }
    getShineStyle() {
    ...
    getSvgBorderGradientId() {
        ...
        switch (e) {
            case "GUILD_BOOST_APPLIED":
                return p.gi.PREMIUM_GUILD;
            case "PREMIUM_ACTIVATED":
            case "PREMIUM_PAYMENT_STARTED":
            case "PREMIUM_UPGRADED":
            case "PREMIUM_UPDATED":
                if (a === u.PremiumTypes.TIER_0) return p.gi.PREMIUM_TIER_0;
                if (a === u.PremiumTypes.TIER_1) return p.gi.PREMIUM_TIER_1;
                return p.gi.PREMIUM_TIER_2;
            default:
    ...
    render() {
        ...
        return (0, r.jsxs)("div", {
            className: c()(M.kL, a),
            children: [this.renderSvgBorder(), (0, r.jsxs)(i.A.div, {
                className: M.Mp,
                style: this.getContainerStyle(),
                children: [(0, r.jsx)(m.kFQ, {
    ...
    constructor(...a) {
        super(...a), E(this, "animation", new i.A.Value(0))
    }
}
...
function L(a) {
    ...
    let {
        ...
        if ("u" > typeof Reflect && Reflect.ownKeys) {
            for (h = 0, l = Reflect.ownKeys(a); h < l.length; h++) t = l[h], !(e.indexOf(t) >= 0) && Object.prototype.propertyIsEnumerable.call(a, t) && (r[t] = a[t]);
            return r
        }
        if (r = function(a, e) {
                if (null == a) return {};
                ...
                for (t = 0; t < r.length; t++) l = r[t], !(e.indexOf(l) >= 0) && Object.prototype.propertyIsEnumerable.call(a, l) && (h[l] = a[l]);
                return h
            }(a, e), Object.getOwnPropertySymbols)
            for (h = 0, l = Object.getOwnPropertySymbols(a); h < l.length; h++) t = l[h], !(e.indexOf(t) >= 0) && Object.prototype.propertyIsEnumerable.call(a, t) && (r[t] = a[t]);
        return r
    }(a, ["theme"]), s = (0, m.rdh)(o.A.unsafe_rawColors.WHITE).hex(), n = (0, m.rdh)(o.A.unsafe_rawColors.BRAND_500).hex(), c = (0, d.Mw)(t) ? s : n;
    return (0, r.jsx)(g, (e = function(a) {
        for (var e = 1; e < arguments.length; e++) {
            var l = null != arguments[e] ? arguments[e] : {},
                t = Object.keys(l);
            "function" == typeof Object.getOwnPropertySymbols && (t = t.concat(Object.getOwnPropertySymbols(l).filter(function(a) {
        ...
        theme: t,
        flashColor: c
    }, Object.getOwnPropertyDescriptors ? Object.defineProperties(e, Object.getOwnPropertyDescriptors(l)) : (function(a, e) {
        var l = Object.keys(a);
