...
let b = t => {
    let {
        ...
        transitionState: E,
        onClose: P
    } = t, w = (0, u.D)("ApplyGuildBoostModal"), G = (0, C.D$)(h.A.boostSlots);
    ...
    let k = [null == e ? "UNUSED_QUANTITY_SELECT" : null, null == l ? "GUILD_SELECT" : null, "CONFIRM", "SUCCESS"].filter(t => null != t),
        ...
        K = () => (P("SUCCESS" === L), g.default.track(A.HAw.MODAL_DISMISSED, {
            type: A.JJy.PREMIUM_GUILD_SUBSCRIBE_MODAL,
            location_section: s
        }), Promise.resolve());
    i.useEffect(() => {
    ...
    let Z = {
        UNUSED_QUANTITY_SELECT: () => (r()(null != e || 0 !== G.length, "Cannot provide no slots if there are no other available slots"), (0, n.jsx)(a.Modal, {
            transitionState: E,
            onClose: K,
            size: "md",
            ...
            let t = B.filter(t => (0, C.I5)(t)).length,
                ...
                s = async () => {
                    if (D(!1), null != R && B?.length !== 0) {
                        r()(!B.some(t => t.isOnCooldown()), "Cannot use a premium guild subscription slot while on cooldown");
                        try {
                            await Promise.all(B.map(t => {
                                let {
                                    premiumGuildSubscription: e
                                } = t;
                                return null != e ? (0, c.jZ)(e.guildId, e.id) : Promise.resolve()
                            })), await (0, c.VA)(R.id, B.map(t => {
                                let {
                                    id: e
                                } = t;
                                return e
                            }), b === y.Pn.PERK), U("SUCCESS")
                        } catch (t) {
                            D(!0)
                        }
                    }
                }, o = V ? N.intl.string(N.t["PR0n//"]) : N.intl.string(N.t["7KP/fI"]);
            return V || "control" === w ? V && "control" !== w ? (0, n.jsx)(S.A, {
                transitionState: E,
                toGuild: R,
                fromGuilds: O,
                slotCount: e,
                ...
                actions: [{
                    ...
                    variant: "primary",
                    text: V ? N.intl.formatToPlainString(N.t.Oh6mxU, {
                        slotCount: e
                ...
                children: V ? (0, n.jsx)(j.A.TransferBody, {
                    fromGuilds: O,
                    toGuild: R,
