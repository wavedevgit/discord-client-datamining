...
let y = t => {
    ...
    let O = {
        UNUSED_QUANTITY_SELECT: () => (r()(null != e || 0 !== E.length, "Cannot provide no slots if there are no other available slots"), (0, n.jsx)(a.Modal, {
            ...
            actions: [{
                variant: "secondary",
                text: f.intl.string(f.t["1BPTsK"]),
                onClick: R
            }, {
                variant: "primary",
                text: f.intl.string(f.t["/uwYda"]),
                onClick: () => P("CONFIRM")
            }],
        ...
        GUILD_SELECT: () => (0, n.jsx)(j.default, {
            onClose: R,
            onSelectGuild: t => {
                _(t), P("CONFIRM")
            },
        ...
        CONFIRM() {
            ...
            let t = D.filter(t => (0, C.I5)(t)).length,
                ...
                s = async () => {
                    if (G(!1), null != M && D?.length !== 0) {
                        r()(!D.some(t => t.isOnCooldown()), "Cannot use a premium guild subscription slot while on cooldown");
                        try {
                            await Promise.all(D.map(t => {
                                let {
                                    premiumGuildSubscription: e
                                } = t;
                                return null != e ? (0, u.jZ)(e.guildId, e.id) : Promise.resolve()
                            })), await (0, u.VA)(M.id, D.map(t => {
                                let {
                                    id: e
                                } = t;
                                return e
            ...
            return (0, n.jsx)(a.Modal, {
                ...
                actions: [{
                    ...
                    variant: "primary",
                    text: F ? f.intl.formatToPlainString(f.t.Oh6mxU, {
                        slotCount: e
                    }) : f.intl.formatToPlainString(f.t.ZU5x5w, {
                        slotCount: e
                    }),
                    onClick: s,
                    loading: w,
                ...
                children: F ? (0, n.jsx)(g.A.TransferBody, {
                    fromGuilds: B,
                    toGuild: M,
                    blurb: f.intl.formatToPlainString(f.t.SSA2lu, {
                        slotCount: e,
                        guildCount: l
                    }),
                    imageClass: A.LA,
                    ...
                    warning: f.intl.formatToPlainString(f.t.KPnDlu, {
                        days: v.FI6,
                        slotCount: e
                    }),
                    imageClass: A.MP,
