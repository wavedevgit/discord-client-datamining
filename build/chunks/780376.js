/** chunk id: 780376 params = (module,exports,require) **/
n.d(t, {
    A: () => Z,
    d: () => $
});
...
function $(e) {
    let t, n, {
        ...
        Q = f.Q_.useSetting(),
        ee = (0, l.yK)([P.Ay], () => null == X || null == $ ? [] : Array.from($ ?? []).map(e => P.Ay.getMember(X.guild_id, e)), [X, $]),
        et = i.useMemo(() => {
            let e = new Map;
            return ee.forEach(t => {
        ...
        en = i.useCallback((e, t) => {
            ...
            return (0, a.jsx)(_.m, {
                ...
                children: (0, a.jsx)("img", {
                    src: e.getAvatarURL(t?.guild_id, H),
                    alt: i,
                    className: Y.my
                }, e.id)
            }, e.id)
        }, [et]),
        ea = (0, l.yK)([j.default], () => Array.from($ ?? []).map(e => j.default.getUser(e)).filter(e => null != e), [$]),
        ei = i.useCallback(() => {
            let e = (0, E.getPID)();
        ...
        eo = (0, z.V)(),
        {
            ...
            handleStayOnTop: ec
        } = (t = (0, l.bG)([x.A], () => x.A.getIsAlwaysOnTop(M.MLl.ACTIVITY_POPOUT)), n = i.useCallback(e => {
        ...
        e_ = (0, K.G)(),
        {
            ...
            let {
                ...
                currentDocument: t,
                rootNode: n
            } = (0, F.A)(), [a, o] = i.useState(!1), r = i.useCallback(() => {
                null == n || a && (o(!1), (0, w.sP)(n, t))
            }, [n, t, a]), l = i.useCallback(() => {
                null != n && (a ? r() : (o(!0), (0, w.tl)(n)))
            }, [n, a, r]), c = i.useCallback(() => {
                null != n && !(0, w._U)(n, t) && a && l()
            }, [n, t, a, l]);
            return i.useEffect(() => (t?.addEventListener(w.Wb, c), () => {
    ...
    return Q && null != D && (em = (0, a.jsx)(_.m, {
        asContainer: !0,
        text: D,
        position: "bottom",
        children: em
        ...
        children: e => (0, a.jsxs)("div", {
            ...
            children: [(0, a.jsxs)("div", {
                ...
                }), ea.length > 0 ? (0, a.jsxs)(a.Fragment, {
                ...
                children: [(0, a.jsx)("div", {
                    ...
                    children: [(0, a.jsx)(y.A, {
                        ...
                        onOpenPopout: () => {},
                        onClosePopout: () => {
                            (0, p.zV)(M.HAw.ACTIVITY_POPOUT_POP_IN_BUTTON_CLICKED), (0, W.A)({
                                onConfirm: J
                            })
                        }
                    }) : null, (0, a.jsx)(g.A, {
...
function Z(e) {
    let {
        applicationId: t,
        channelId: n
    } = e, o = (0, l.bG)([U.Ay], () => U.Ay.getSelfEmbeddedActivities().get(t)), r = i.useCallback(async () => {
