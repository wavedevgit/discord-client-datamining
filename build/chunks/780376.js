...
function M(e) {
    let t, n, {
        ...
        q = I.Q_.useSetting(),
        H = (0, o.yK)([j.Ay], () => null == $ || null == M ? [] : Array.from(M ?? []).map(e => j.Ay.getMember($.guild_id, e)), [$, M]),
        X = l.useMemo(() => {
            let e = new Map;
            return H.forEach(t => {
        ...
        J = (0, o.yK)([P.default], () => Array.from(M ?? []).map(e => P.default.getUser(e)).filter(e => null != e), [M]),
        {
            canStayOnTop: Q,
            popoutWindowAlwaysOnTop: ee,
            handleStayOnTop: et
        } = (t = (0, o.bG)([f.A], () => f.A.getIsAlwaysOnTop(F.MLl.ACTIVITY_POPOUT)), n = l.useCallback(e => {
        ...
        en = (0, D.G)(),
        {
            ...
            let {
                ...
                currentDocument: t,
                rootNode: n
            } = (0, G.A)(), [i, a] = l.useState(!1), r = l.useCallback(() => {
                null == n || i && (a(!1), (0, O.sP)(n, t))
            }, [n, t, i]), o = l.useCallback(() => {
                null != n && (i ? r() : (a(!0), (0, O.tl)(n)))
            }, [n, i, r]), s = l.useCallback(() => {
                null != n && !(0, O._U)(n, t) && i && o()
            }, [n, t, i, o]);
            return l.useEffect(() => (t?.addEventListener(O.Wb, s), () => {
    ...
    return q && null != E && (eo = (0, i.jsx)(c.m, {
        asContainer: !0,
        text: E,
        position: "bottom",
        children: eo
            ...
            children: [(0, i.jsxs)("div", {
                ...
                children: [(0, i.jsx)("div", {
                    ...
                    children: [(0, i.jsx)(y.A, {
                        ...
                        onOpenPopout: () => {},
                        onClosePopout: () => {
                            (0, p.zV)(F.HAw.ACTIVITY_POPOUT_POP_IN_BUTTON_CLICKED), (0, R.A)({
                                onConfirm: z
                            })
                        }
                    }) : null, (0, i.jsx)(_.A, {
...
function B(e) {
    let {
        applicationId: t,
        channelId: n
    } = e, a = (0, o.bG)([w.Ay], () => w.Ay.getSelfEmbeddedActivities().get(t)), r = l.useCallback(async () => {
