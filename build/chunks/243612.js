/** chunk id: 243612, original params: e,t,n (module,exports,require) **/
"use strict";
n.d(t, {
    VC: () => p,
    b4: () => m,
...
function h() {
    ...
    return (null == E || null == E.id || null == E.name) && (null == y || null == y.application_id) ? void 0 : {
        id: null != (e = null == E ? void 0 : E.id) ? e : null == y ? void 0 : y.application_id,
        altId: null == y ? void 0 : y.application_id,
        name: null != (t = null == E ? void 0 : E.name) ? t : null == y ? void 0 : y.name
    }
}
