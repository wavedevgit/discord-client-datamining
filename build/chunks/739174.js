...
function O(e) {
    ...
    return null == m || null == x ? null : (0, i.jsxs)("div", {
        onContextMenu: b,
        className: S.Cv,
        children: [(0, i.jsx)(m, {
            size: "custom",
...
function w(e) {
    let {
        ...
        isLocked: r,
        lockTooltipText: o
    } = e, c = (0, d.bG)([j.A], () => j.A.getRole(t.id, s)), x = (0, A.$7)({
        guildId: t.id,
        roleId: s,
        size: 24
    }), g = l.useCallback(e => {
    ...
    return c?.name == null ? null : (0, i.jsxs)("div", {
        onContextMenu: g,
        className: S.Cv,
        children: [null != x ? (0, i.jsx)(b.A, {
            className: a()(S.__invalid_icon, S.Sl),
            ...x
        }) : (0, i.jsx)(u.iTF, {
            size: "custom",
            width: 23,
...
function k(e) {
    ...
    } = e, r = (0, d.bG)([T.default], () => T.default.getUser(n)), o = (0, d.bG)([_.Ay], () => _.Ay.getMember(t.id, n)?.nick, [t.id, n]), c = (0, d.bG)([v.A], () => v.A.hidePersonalInformation);
