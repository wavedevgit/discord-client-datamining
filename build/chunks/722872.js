/** Chunk was on web.js **/
/** chunk id: 722872, original params: e (module,exports,require) **/
"use strict";
var t = {
    ...
    easeInElastic: function(e, t, n, r) {
        var i, a, s, o = n - t;
        return (s = 1.70158, a = 0, i = o, 0 === e) ? t : 1 == (e /= r) ? t + o : (a || (a = .3 * r), i < Math.abs(o) ? (i = o, s = a / 4) : s = a / (2 * Math.PI) * Math.asin(o / i), -(i * Math.pow(2, 10 * (e -= 1)) * Math.sin(2 * Math.PI * (e * r - s) / a)) + t)
    },
    easeOutElastic: function(e, t, n, r) {
        var i, a, s, o = n - t;
        return (s = 1.70158, a = 0, i = o, 0 === e) ? t : 1 == (e /= r) ? t + o : (a || (a = .3 * r), i < Math.abs(o) ? (i = o, s = a / 4) : s = a / (2 * Math.PI) * Math.asin(o / i), i * Math.pow(2, -10 * e) * Math.sin(2 * Math.PI * (e * r - s) / a) + o + t)
    },
    easeInOutElastic: function(e, t, n, r) {
        var i, a, s, o = n - t;
        return (s = 1.70158, a = 0, i = o, 0 === e) ? t : 2 == (e /= r / 2) ? t + o : (a || (a = .3 * 1.5 * r), i < Math.abs(o) ? (i = o, s = a / 4) : s = a / (2 * Math.PI) * Math.asin(o / i), e < 1) ? -.5 * (i * Math.pow(2, 10 * (e -= 1)) * Math.sin(2 * Math.PI * (e * r - s) / a)) + t : i * Math.pow(2, -10 * (e -= 1)) * Math.sin(2 * Math.PI * (e * r - s) / a) * .5 + o + t
    },
    ...
    easeInOutBounce: function(e, n, r, i) {
        var a, s = r - n;
        return e < i / 2 ? .5 * (a = t.easeInBounce(2 * e, 0, s, i)) + n : .5 * (a = t.easeOutBounce(2 * e - i, 0, s, i)) + .5 * s + n
    }
};
e.exports = t