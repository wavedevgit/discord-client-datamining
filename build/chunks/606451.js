/** chunk id: 606451 params = (module,exports,require) **/
n.d(t, {
    m: () => A
});
var i = n(627968),
...
function A() {
    let e, t, n, A, g, p, {
        ...
        }, [e]), A = (n = Object.values(t.current)).some(e => {
            let {
                downloadedBytes: t
            } = e;
            return (t ?? 0) > 0
    ...
    return (0, o.pnh)(f ? null != E ? "voice-on" : "voice-off" : null, {
        from: {
            opacity: 0,
            translateY: 20
        },
    ...
    }, "respect-motion-settings")((e, t) => null != t ? (0, i.jsx)(a.animated.div, {
        style: e,
        className: m.zh,
