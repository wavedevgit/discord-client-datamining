/** chunk id: 944300 params = (module,exports,require) **/
"use strict";
n.d(t, {
    A: () => x
});
...
function x(e) {
    let {
        ...
        location: j,
        loginSource: y
    } = e, [S, b] = s.useState(() => I), [R, O] = s.useState(() => N), [L, w] = s.useState(""), [k, D] = s.useState(() => {
        let e = null != j ? (0, r.parse)(j.search) : {};
        return e.email ?? e.login ?? ""
    }), [U, P] = s.useState(""), [B, G] = s.useState(!1), [M, F] = s.useState(null), [V, W] = s.useState(!1), [H] = s.useState(() => new AbortController), [K, z] = s.useState({}), Q = s.useRef(null), q = s.useRef(null), Y = s.useRef(null);
    !S || I || N || b(!1);
    let X = s.useMemo(() => {
            if (null != y) return y;
        ...
        $ = s.useCallback(e => {
            ...
            if (delete t.redirect_to, null != C) {
                ...
                let e = window.location.protocol + window.GLOBAL_ENV.API_ENDPOINT + f.Rsh.SSO,
                    n = {
                        ...t,
                        token: _.default.getToken()
                    };
                window.location = `${e}?${(0,r.stringify)(n)}`
            }
        }, [C, T, v]),
        Z = s.useCallback(function(e, t) {
            let n = arguments.length > 2 && void 0 !== arguments[2] && arguments[2];
            e && null != t && (O(!0), n ? d.A.verifySSOToken("login").then(() => $(t)) : $(t))
        }, [$]),
        ee = s.useCallback(e => {
            z({}), h.default.track(f.HAw.LOGIN_SUCCESSFUL, {
        ...
        es = s.useCallback(async function(e) {
            let {
                undelete: n
        ...
        er = s.useCallback(async e => {
            let t = L + k;
            z({});
            try {
                let {
                    token: n
                } = await u.A.verifyPhone(t, e, !1);
                await d.A.authorizeIPAddress(n), es()
            } catch (e) {
                null != e.body && null != e.body.message && F(e.body.message)
            }
        }, [L, k, es]),
        el = s.useCallback(async e => {
            F(null);
            try {
                let {
                    token: t
                } = await u.A.verifyPhone(L + k, e, !1);
                v(f.BVt.RESET, {
        ...
        ea = s.useCallback(async e => {
            ...
            try {
                ...
                if (!1 === e) return;
                e === l.D.ONE_TIME_LOGIN ? (0, c.qfG)(e => {
                    let t = [{
                        variant: "primary",
                    ...
                    subtitle: E.intl.format(E.t["6u5hQ9"], {
                        email: t
                    })
                })
            } catch (e) {
        ...
        eu = s.useCallback(() => {
            let e, i = null != j ? (0, r.parse)(j.search) : {};
            "" !== k && (i.email = k), null != t ? (i.mode = "register", e = f.BVt.INVITE(t.code)) : null != x ? (i.mode = "register", e = f.BVt.GIFT_CODE(x.code)) : null != n ? e = f.BVt.GUILD_TEMPLATE(n.code) : null != C ? (e = f.BVt.REGISTER, i.redirect_to = C) : e = f.BVt.REGISTER, et(), v(e, {
                search: (0, r.stringify)(i)
            }), p._.dispatch(f.jej.WAVE_EMPHASIZE)
        }, [k, t, x, n, C, j, et, v]);
    return {
        checkingHandoff: S,
