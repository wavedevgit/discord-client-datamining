...
function b(e) {
    ...
    C && (N = null != f ? f : h);
    let [w, R] = i.useState(N), P = (0, l.R_)(), D = (0, l.V$)(), [x, L] = i.useState(), [j, M] = i.useState(t && (0, u.lo)(O) === u.tB.CUSTOM_MESSAGE_EMOJI_SOUNDBOARD && null == c ? _.intl.string(_.t.ZkOo1U) : c), [k, U] = i.useState(void 0), [G, V] = i.useState(void 0), F = (0, u.Vt)(b, t), [B, H] = i.useState(!1), [Y, W] = i.useState(!1), [K, z] = i.useState(), q = i.useCallback(e => {
        let {
            onSubscriptionConfirmation: t
        } = e;
        return W(!0), (0, o.UN)(O, F).then(() => {
            W(!1), null == t || t(), H(!0)
        }).catch(e => {
            W(!1), z(e), H(!0)
        })
