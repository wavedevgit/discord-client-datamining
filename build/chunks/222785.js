...
let R = l.memo(function(e) {
    let {
        ...
        onClose: a,
        onSelect: R
    } = e, k = (0, d.bG)([C.default], () => C.default.getCurrentUser());
    r()(null != k, "GuildHeaderPopout: user cannot be undefined"), l.useEffect(() => {
        P.default.track(T.HAw.GUILD_DROPDOWN_MENU_VIEWED, {
            guild_id: i.id
        })
    });
    let F = (0, d.bG)([_.Ay], () => _.Ay.isGuildCollapsed(i.id), [i.id]),
        ...
        q = (0, A.A)({
            ...
            analyticsLocation: {
                ...
                section: T.JJy.GUILD_DROPDOWN_MENU
            },
            icon: s.R2l
        }),
    ...
    return Y || K ? (0, t.jsx)(s.W1t, {
        ...
        children: [(0, t.jsxs)(s.rXV, {
            children: [(0, t.jsx)(s.Drp, {
                ...
                action: () => {
                    (0, h.K)({
                        guildId: i.id,
                        location: {
                            section: T.JJy.GUILD_HEADER_POPOUT
                        }
                    })
                }
            }), es && (0, t.jsx)(s.Drp, {
            ...
            children: [ea, V && i.features.has(T.GuildFeatures.COMMUNITY) ? (0, t.jsx)(s.Drp, {
                id: "report-raid",
