...
let F = l.memo(function(e) {
    let {
        ...
        onClose: a,
        onSelect: F
    } = e, X = (0, d.bG)([T.default], () => T.default.getCurrentUser());
    r()(null != X, "GuildHeaderPopout: user cannot be undefined"), l.useEffect(() => {
        P.default.track(S.HAw.GUILD_DROPDOWN_MENU_VIEWED, {
            guild_id: i.id
        })
    });
    let k = (0, d.bG)([C.Ay], () => C.Ay.isGuildCollapsed(i.id), [i.id]),
        ...
        z = (0, p.A)({
            ...
            userId: X.id,
            analyticsLocation: {
                page: S.liQ.GUILD_CHANNEL,
                section: S.JJy.GUILD_DROPDOWN_MENU
            },
            icon: s.R2l
        }),
    ...
    return K || Z ? (0, t.jsx)(s.W1t, {
        ...
        children: [(0, t.jsxs)(s.rXV, {
            children: [(0, t.jsx)(s.Drp, {
                ...
                action: () => {
                    (0, E.K)({
                        guildId: i.id,
                        location: {
                            section: S.JJy.GUILD_HEADER_POPOUT
                        }
                    })
                }
            }), eo && (0, t.jsx)(s.Drp, {
            ...
            children: [er, J && i.features.has(S.GuildFeatures.COMMUNITY) ? (0, t.jsx)(s.Drp, {
                id: "report-raid",
