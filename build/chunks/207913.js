/** chunk id: 207913, original params: t,e,E (module,exports,require) **/
E.d(e, {
    A: () => O
});
var n = E(784041),
...
let O = new P(A.h, {
    ...
    SAFETY_HUB_AUTOMATED_UNDERAGE_APPEAL_SUBMIT_SUCCESS: function(t) {
        let {} = t;
        for (let t in L = a.qN.LOADING, r) r[t].is_coppa && (r[t].appeal_status = {
            status: l.Wi.REVIEW_PENDING
        })
    },
    ...
    LOGOUT: function() {
        T = !1, r = {}, S = {
            state: l.PN.ALL_GOOD
        }, U = null, F = a.Iv.DIDNT_VIOLATE_POLICY, I = "", C = []
    }
})