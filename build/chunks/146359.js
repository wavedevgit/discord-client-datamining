/** chunk id: 146359, original params: e,n,t (module,exports,require) **/
t.d(n, {
    A: () => x
});
var l = t(627968),
...
function x(e, n, x) {
    ...
    let E = (0, r.bG)([A.A], () => A.A.getChannel(x)),
        ...
        T = (0, c.qi)(E?.id);
    return _?.id === e.id ? [C] : null == h || null == E || null == _ ? [] : [T ? (0, l.jsx)(a.Drp, {
        id: "remove",
        label: E.isForumPost() ? p.intl.formatToPlainString(p.t.v2KNNx, {
            user: e.username
    ...
    }) : null, (0, o.L7)(e, h) ? (0, l.jsx)(a.Drp, {
        id: "kick",
        label: T ? p.intl.formatToPlainString(p.t["1Ie87p"], {
            user: e.username
    ...
    }) : null, (0, o.EZ)(e, h) ? (0, l.jsx)(a.Drp, {
        id: "ban",
        label: T ? p.intl.formatToPlainString(p.t.i62APf, {
            user: e.username
