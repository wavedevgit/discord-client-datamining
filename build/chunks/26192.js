...
function S(e) {
    let {
    ...
    } = l.useContext(h.a), P = (0, f.Kr)(e => e.volume), j = (0, f.Kr)(e => e.setVolume), O = (0, f.Kr)(e => e.muted), U = (0, f.Kr)(e => e.setMuted), B = (0, f.Kr)(e => e.transcriptEnabled), Q = (0, f.Kr)(e => e.captionEnabled), V = (0, o.bG)([m.A], () => m.A.useReducedMotion), K = (0, o.bG)([m.A], () => m.A.keyboardModeEnabled), [F, $] = l.useState(O ? 0 : P), [Y, G] = l.useState(!1), [H, z] = l.useState(!1), [{
        volumeAnimSpring: W
    }, q] = (0, d.zhh)(() => ({
        from: {
            volumeAnimSpring: 0
        ...
        null != t.current && (0 === F ? (U(!1), 0 === P ? (j(p.$J), J(p.$J), M(p.$J)) : (J(P), M(P))) : (j(F), J(0), U(!0), M(0)))
    }, [t, F, J, P, U, j, M]), ee = () => {
        G(!0)
    }, et = () => {
        G(!1)
    ...
    l.useEffect(() => {
        ...
        W.stop()
    }), [H, Y, q, V, W]), l.useEffect(() => (window.addEventListener("keydown", en), () => {
        window.removeEventListener("keydown", en)
    }), [en]);
    let er = 0 === F ? d._RO : F < .5 ? d.S24 : d.HKD,
        {
            icon: el,
            label: ea
        } = E.eC[n];
    return (0, r.jsxs)(r.Fragment, {
        children: [(0, r.jsxs)("div", {
            ...
            }), "portrait" !== C && (0, r.jsxs)(r.Fragment, {
                children: [(0, r.jsx)(E.Ey, {
                    iconComponent: p.qN,
                    animationTime: a,
                    visible: S,
            ...
            children: [(0, r.jsxs)("div", {
                ...
                children: [(0, r.jsx)(E.Ey, {
                    ...
                    children: (0, r.jsx)(c.A, {
                        ...
                        maxValue: 1,
                        onValueChange: e => {
                            J(e), j(e), M(e), H && (z(!1), w(!1)), O && e > 0 ? U(!1) : O || 0 !== e || U(!0)
                        },
                        asValueChanges: e => {
                            J(e), H || (z(!0), w(!0))
                        },
