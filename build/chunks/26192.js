...
function g(e) {
    let {
    ...
    } = i.useContext(f.a), w = (0, _.Kr)(e => e.volume), P = (0, _.Kr)(e => e.setVolume), j = (0, _.Kr)(e => e.muted), V = (0, _.Kr)(e => e.setMuted), U = (0, _.Kr)(e => e.transcriptEnabled), Q = (0, _.Kr)(e => e.captionEnabled), B = (0, o.bG)([m.A], () => m.A.useReducedMotion), F = (0, o.bG)([m.A], () => m.A.keyboardModeEnabled), [K, Y] = i.useState(j ? 0 : w), [$, H] = i.useState(!1), [G, q] = i.useState(!1), [{
        volumeAnimSpring: W
    }, z] = (0, d.zhh)(() => ({
        from: {
            volumeAnimSpring: 0
        ...
        null != t.current && (0 === K ? (V(!1), 0 === w ? (P(E.$J), X(E.$J), M(E.$J)) : (X(w), M(w))) : (P(K), X(0), V(!0), M(0)))
    }, [t, K, X, w, V, P, M]), ee = () => {
        H(!0)
    }, et = () => {
        H(!1)
    ...
    i.useEffect(() => {
        ...
        W.stop()
    }), [G, $, z, B, W]), i.useEffect(() => (window.addEventListener("keydown", en), () => {
    ...
    return (0, r.jsxs)(r.Fragment, {
        children: [(0, r.jsxs)("div", {
            ...
            }), "portrait" !== T && (0, r.jsxs)(r.Fragment, {
                children: [(0, r.jsx)(p.Ey, {
                    iconComponent: E.qN,
                    animationTime: s,
                    visible: g,
            ...
            children: [(0, r.jsxs)("div", {
                ...
                children: [(0, r.jsx)(p.Ey, {
                    ...
                    children: (0, r.jsx)(c.A, {
                        ...
                        maxValue: 1,
                        onValueChange: e => {
                            X(e), P(e), M(e), G && (q(!1), O(!1)), j && e > 0 ? V(!1) : j || 0 !== e || V(!0)
                        },
                        asValueChanges: e => {
                            X(e), G || (q(!0), O(!0))
                        },
