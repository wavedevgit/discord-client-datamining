/** chunk id: 702942 params = (module,exports,require) **/
"use strict";
n.d(t, {
    A: () => d
});
...
function d(e) {
    let {
        rule: t,
        onChangeRule: n
    } = e, [a, d] = s.useState(new Set(t?.triggerMetadata?.presets)), c = s.useMemo(() => e => {
        n({
            ...t,
            triggerMetadata: {
                ...t.triggerMetadata,
        ...
        label: o(r.vY.SLURS).headerText,
        description: o(r.vY.SLURS).subtitleText,
        value: String(r.vY.SLURS)
    }, {
    ...
    return (0, i.jsx)("div", {
        children: (0, i.jsx)(l.$QX, {
            selectedValues: Array.from(a).map(String),
            onChange: u,
            options: m
        })
    })
