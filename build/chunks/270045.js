...
function L(e) {
    let t = (0, r.bG)([_.A], () => _.A.questDeliveryOverride, []),
        ...
        F = e => (0, s.showToast)((0, s.createToast)(new o.A(e, e.status).message, s.ToastType.FAILURE)),
        H = () => (0, m.CV)(e.quest.id).catch(F),
        V = (0, g.nv)(e.quest),
        q = l.useMemo(() => (0, i.jsx)(s.sLh, {
            id: "delivery",
