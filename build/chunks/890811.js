/** chunk id: 890811, original params: e,t,i (module,exports,require) **/
i.d(t, {
    A: () => j
});
var n = i(627968),
...
function j(e) {
    let {
        ...
        onNext: j,
        onBack: u
    } = e, _ = (0, g.y5)(), C = (0, r.bG)([x.A], () => x.A.getFreeTextAppealReason()), [E, I] = a.useState(""), [S, T] = a.useState(!1);
    a.useEffect(() => {
    ...
    return (0, n.jsxs)(n.Fragment, {
        children: [(0, n.jsxs)(d.rQ0, {
            ...
            className: l()(A.j, t),
            paddingFix: !1,
            children: [(0, n.jsx)(d.z6M, {
                value: _,
                options: v,
                onChange: e => {
                    T(e === p.Iv.SOMETHING_ELSE), e !== p.Iv.SOMETHING_ELSE && (I(""), c.h.dispatch({
