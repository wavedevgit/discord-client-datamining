/** chunk id: 338659, original params: e,t,n (module,exports,require) **/
"use strict";
n.d(t, {
    s: () => c
}), n(321073);
...
class c {
    ...
    getStats() {
        ...
        (null == (n = this.cachedCodecInfo) ? void 0 : n.videoWidth) != null && (null == (r = this.cachedCodecInfo) ? void 0 : r.videoHeight) != null ? (u = this.cachedCodecInfo.videoWidth, d = this.cachedCodecInfo.videoHeight, f = "".concat(u, "x").concat(d)) : (u = 0 !== p.videoWidth ? p.videoWidth : 0, d = 0 !== p.videoHeight ? p.videoHeight : 0, f = u > 0 && d > 0 ? "".concat(u, "x").concat(d) : "Unknown");
        ...
        if ("function" == typeof p.getVideoPlaybackQuality) {
            ...
            y = e.droppedVideoFrames, O = (b = e.totalVideoFrames) > 0 ? y / b * 100 : 0
        }
        if ((null == (i = this.cachedCodecInfo) ? void 0 : i.frameRate) != null) v = this.cachedCodecInfo.frameRate;
            ...
            if (null !== this.lockedFrameRate) v = this.lockedFrameRate;
                ...
                } else this.baselineFrames = b, this.baselineTime = p.currentTime, this.recentFrameRates = [], v = this.lastKnownFrameRate;
            else {
        ...
        let A = null != (e = null == (l = p.error) ? void 0 : l.code) ? e : null,
            I = null != (t = null == (c = p.error) ? void 0 : c.message) ? t : null;
