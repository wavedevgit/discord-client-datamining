...
function er(e) {
    ...
    } = e, eh = (0, H.A)(), em = (0, m.H)(), eg = (0, M.A)(), eE = er[0], ey = (0, u.bG)([T.A], () => T.A.get(eE), [eE]), eb = null == ey ? void 0 : ey.eligiblePaymentGateways, {
        paymentSources: eO,
    ...
    } = (0, P.A)(), [e0, e1] = (0, u.yK)([I.A], () => [I.A.purchaseTokenAuthState, I.A.purchaseTokenHash]), [e2, e3, e6, e4] = (0, u.yK)([Y.A], () => [Y.A.browserCheckoutState, Y.A.loadId, Y.A.skuId, Y.A.planId]), [e5, e7] = i.useState(null), [e8, e9] = i.useState(null), [te, tt] = i.useState(null), [tn, tr] = i.useState(null), [ti, ta] = i.useState(null), [to, ts] = i.useState(void 0), [tl, tc] = i.useState([]), [tu, td] = i.useState([]), tf = i.useMemo(() => null == eZ || (0, w.ys)(eZ.id), [eZ]), tp = i.useRef(null != J ? J.planId : null);
    i.useEffect(() => {
    ...
    let tP = (0, c.Lt)(null != (t = null == tN ? void 0 : tN.flags) ? t : 0, z.gfo.EMBEDDED) && (0, c.Lt)(null != (n = null == tN ? void 0 : tN.flags) ? n : 0, z.gfo.EMBEDDED_IAP),
