...
function c(e) {
    ...
    } = (0, r.A)(e), l = (0, d.A)(e), c = s.A.useConfig({
        location: "useVisibleUserProfileConnectionsAndAppIdentities"
    }), u = t.useMemo(() => new Set(c.enabled ? n?.map(e => e.application_id) ?? [] : []), [n, c.enabled]), m = (0, a.A)([...u]).filter(o.Vq);
    return {
        appIdentities: t.useMemo(() => n.map(e => ({
            identity: e,
            application: m.find(n => n.id === e.application_id)
        })).filter(e => {
            let {
                application: n
            } = e;
        ...
        connections: t.useMemo(() => c.enabled ? l.filter(e => {
