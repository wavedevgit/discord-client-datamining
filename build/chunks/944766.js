/** Chunk was on web.js **/
/** chunk id: 944766, original params: e,t,n (module,exports,require) **/
"use strict";
n.d(t, {
    A: () => g
}), n(896048), n(864466), n(443073), n(114821), n(339614);
var r = n(627968),
    i = n(64700),
    a = n(503698),
    o = n.n(a),
...
let h = 13e3,
    ...
    g = e => {
        ...
        } = e, v = i.useRef(null), A = i.useRef(new Set), I = (0, f.A)(a), {
            setAsset: S,
            sampleAsset: T,
            animationState: C,
        ...
        return i.useEffect(() => {
            ...
            style: {
                width: I.width,
                top: I.offset.top,
                left: y ? -I.offset.left : I.offset.left
            },
            onMouseEnter: () => b(!0),
            onMouseLeave: () => b(!1),
            onClick: e => {
