...
function d(t) {
    let {
        user: i,
        numItems: e
    } = t, d = (0, r.GG)("use_unowned_wishlist_items_and_recommendations"), g = (0, l.Ay)(i.id), I = Math.max(e, (0, c.KQ)(d)), {
        defaultWishlistId: _,
        wishlist: f,
        ...
        userIds: E,
        includeWishlists: !0
    }), L = n.useMemo(() => (f?.items ?? []).filter(t => !0 !== t.isOwned && (0, o.$)(t)).length > 0 || h ? C : [], [f?.items, h, C]), {
        displayItems: O,
