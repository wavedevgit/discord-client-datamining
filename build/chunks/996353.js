...
function d(t) {
    let {
        ...
        numItems: n,
        location: d
    } = t, I = (0, c.G)("use_unowned_wishlist_items_and_recommendations"), g = (0, r.Ay)(e.id), {
        defaultWishlistId: A,
        wishlist: u,
        ...
        userIds: m,
        includeWishlists: !0
    }), L = i.useMemo(() => (u?.items ?? []).filter(t => !0 !== t.isOwned && (0, l.$)(t)).length > 0 || f ? G : [], [u?.items, f, G]), {
        displayItems: b,
