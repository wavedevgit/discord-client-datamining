/** Chunk was on web.js **/
/** chunk id: 200458, original params: e,t,n (module,exports,require) **/
"use strict";
n.d(t, {
    A: () => d
}), n(896048);
...
class d {
    ...
    onSpeaking(e) {
        ...
        if (e) this.speaking.start(), this.participation.start(), null == t || t.start(), this.speechEventCount++;
            ...
            this.addSpeechChunk(), this.speaking.stop(), this.listening.isRunning() || this.participation.stop(), null == t || t.stop(), this.computeSpeakingDurationMilestones(e, n, r)
        }
    }
    onListening(e, t) {
    ...
    computeSpeakingDurationMilestones(e, t, n) {
        ...
        c.filter(e => !this.timesUntilSpeakingDurationMilestonesMs.has(e)).filter(e => r >= e).forEach(r => {
            let i = t - e + r - n;
    ...
    getDurationStats() {
        let e = this.speaking.lastStartTime,
            ...
            n = null != e ? t - e : 0;
        return this.computeSpeakingDurationMilestones(this.connected.lastStartTime, this.speaking.lastStartTime, this.speaking.lastElapsed), s({
