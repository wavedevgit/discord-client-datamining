...
function x(e) {
    let {
        ...
        searchQuery: x,
        onSearchChange: j
    } = e, S = m.A.useField("showNavigationMobile"), A = i.useRef(null), N = i.useMemo(() => {
        let e = [];
    ...
    }, [t.layout]), [C, E] = i.useMemo(() => {
        let e = [],
            n = [];
        return t.layout.forEach(t => {
            t.hoisted ? e.push(t) : n.push(t)
        }), [e, n]
    }, [t.layout]), k = (0, h.NC)(), w = (0, c.A)("settings-sidebar", A);
                        ...
                        children: (0, r.jsx)(s.PR, {
                            children: e => {
                                ...
                                return (0, r.jsxs)(u.ChK, {
                                    ref: e => {
                                        A.current = e, g.A.setSidebarScrollerRef(e), t.current = e?.getScrollerNode() ?? null
                                    },
                                    className: y.Mt,
                                    fade: !0,
                                    ...a,
