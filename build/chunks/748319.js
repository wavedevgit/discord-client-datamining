...
var a = n(627968),
    ...
    eR = n(985018),
    eO = n(146664);
let ek = eb.Ay.getEnableHardwareAcceleration() ? h.JsQ : h.euF,
...
class eL extends i.PureComponent {
    ...
    handleToggleSelfMute = () => {
        ...
        (0, O.A)(e, t, eE.JJy.ACCOUNT_PANEL), (0, k.X)(C.A.ACCOUNT, k.O.MIC, n)
    };
...
function eF() {
    let e = (0, c.bG)([eh.default], () => eh.default.getCurrentUser()),
        ...
        k = (0, h.red)(h.DXt) || O || ef.P.isDisallowPopupsSet() || R,
    ...
    k || (H.avatar.push(u.M.DISPLAY_NAME_STYLES_COACHMARK), H.avatar.push(u.M.WIDGETS_RTC_UPSELL_COACHMARK));
    let {
        shouldShowTooltip: K,
        dismissTooltip: q
