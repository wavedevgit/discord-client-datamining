...
function eU(e) {
    let {
        ...
        avatarDecoration: g,
        "data-jump-section": _
    } = e, b = i.useRef(null), v = t ?? b, j = (0, ep.F_)({
        avatarDecoration: g,
        size: (0, y.Te)(h._3J.SIZE_32)
    }), C = (0, M.A)(), {
        ...
        return (0, f.A)(() => l(!0), 750), i.useEffect(() => {
            ...
            return eg._.subscribe(eN.jej.SHOW_ACCOUNT_PROFILE_POPOUT, t), () => {
...
class eB extends i.PureComponent {
    ...
    componentDidUpdate(e) {
        ...
        s !== a && this.handleOccludedChanged(), i !== t && this.handleSpeakingWhileMutedChanged(), l !== n && this.handleSpeakingWhilePTTChanged()
    }
    ...
    handleOpenAccountSettings = () => {
        this.dismissTooltips(), ec.A.isConnected() ? (0, Z.openUserSettings)(J.X.VOICE_AND_VIDEO_PANEL, {
            section: eN.nc_.VOICE
    ...
    handleSpeakingWhileMutedChanged = () => {
        let {
            ...
            hoveringOnMute: r
        } = this.state, o = void 0 === this.lastSpeakingWhileMutedNotificationTime || performance.now() - this.lastSpeakingWhileMutedNotificationTime > eM;
        a ? r || !e || t || n || i || !o || null != l || s || this.setState({
            shouldShowSpeakingWhileMutedTooltip: !0
        }, () => {
            this.lastSpeakingWhileMutedNotificationTime = performance.now(), this.speakingWhileMutedTooltipTimeout.start(eD, () => this.setState({
                shouldShowSpeakingWhileMutedTooltip: !1
            }))
        }) : (this.setState({
            shouldShowSpeakingWhileMutedTooltip: !1
    ...
    handleSpeakingWhilePTTChanged = () => {
        ...
        a ? r || e || t || n || i || !o || null != l || s || this.setState({
            ...
            this.lastSpeakingWhilePTTNotificationTime = performance.now(), this.speakingWhilePTTInactiveBackoff.fail(), this.speakingWhilePTTTooltipTimeout.start(eD, () => this.setState({
                shouldShowSpeakingWhilePTTTooltip: !1
            }))
        }) : (this.setState({
            shouldShowSpeakingWhilePTTTooltip: !1
    ...
    renderStatus() {
        ...
        }) : null != s && s !== eN.clD.UNKNOWN && i.hasUniqueUsername() ? (0, a.jsx)(C.A, {
            hoverText: l,
            forceHover: e,
            children: (0, a.jsx)(j.A, {
                text: ev.Ay.humanizeStatus(s)
            })
        }) : l
    }
    renderNameTag = e => {
    ...
    renderNameZone(e) {
        ...
        return null == t ? null : (0, a.jsx)(eT.A, {
        ...
        return null == e ? null : (0, a.jsxs)(a.Fragment, {
            children: [(0, a.jsx)(h.skg, {
                children: e => (0, a.jsxs)("div", {
                    ...
                    }), this.renderNameZone(e), (0, a.jsx)(eG, {
                        ...this.props,
                        ...this.state,
...
function eV() {
    let e = (0, c.bG)([ex.default], () => ex.default.getCurrentUser()),
        ...
        y = (0, c.bG)([ed.Ay], () => ed.Ay.getSpeakingWhileMuted()),
    ...
    !O && (K.avatar.push(u.M.DISPLAY_NAME_STYLES_COACHMARK), K.avatar.push(u.M.WIDGETS_RTC_UPSELL_COACHMARK), B && K.settings.push(u.M.NITRO_PRIVACY_PERK_BETA_COACHMARK));
    let {
        shouldShowTooltip: Q,
        dismissTooltip: Y
    } = eF(ek.oh.AUDIO_INPUT), {
        shouldShowTooltip: J,
        dismissTooltip: X
    } = eF(ek.oh.AUDIO_OUTPUT), {
        shouldShowTooltip: Z,
        dismissTooltip: ep
