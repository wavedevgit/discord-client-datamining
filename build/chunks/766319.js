...
function I(e) {
    let t, {
        ...
        [h, A] = s.useState(!1),
        [m, g] = s.useState(0),
        _ = (0, r.bG)([p.A], () => p.A.getChannelId() !== l.id);
    async function I() {
        g(1);
        try {
    ...
    if (_ && (t = C.intl.string(x.default.qRXats)), n.type === f.$pd.PLAYING) {
        ...
        return (0, i.jsxs)("div", {
            ...
            children: [(0, i.jsxs)("div", {
                className: E.xi,
                children: [h || null == e ? (0, i.jsx)(o._7Z, {
                    size: "custom",
                    width: 46,
                    height: 46
                }) : (0, i.jsx)("img", {
                ...
                fullWidth: !0,
                size: "sm",
                text: 2 === m ? C.intl.string(x.default["8HU1M2"]) : C.intl.string(x.default.DKHhec),
                onClick: I
...
function N(e) {
    let {
        userId: t,
        channel: n
    } = e, o = (0, r.bG)([m.default], () => m.default.getUser(t)), c = (0, _.Ay)(t, n.guild_id), u = (0, g.A)(t, n.id), p = s.useMemo(() => l.uniqWith(c, (e, t) => {
    ...
    return ((0, d.A)({
        ...
        disableTrack: f
    }), f) ? null : (0, i.jsx)(h.A.Provider, {
        value: n.guild_id,
        children: (0, i.jsx)("div", {
            className: E.zr,
            children: (0, i.jsx)("div", {
                className: E.Ci,
                children: p.map(e => (0, i.jsx)(I, {
                    activity: e,
                    channel: n,
                    userId: t
