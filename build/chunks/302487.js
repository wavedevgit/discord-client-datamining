/** chunk id: 302487 params = (module,exports,require) **/
"use strict";
n.d(t, {
    A: () => w,
    h: () => P
...
function w(e) {
    let {
        ...
        onMouseEnter: r,
        listItemProps: o
    } = e, d = i.useRef(null), c = (0, m.bG)([j.A], () => j.A.getChannel(t), [t]);
    return a()(null != c, "Forum Channel is null"), (0, l.jsxs)(h.DUT, {
        ...o,
        "aria-label": T.intl.string(T.t.nzoF5p),
        className: N.EJ,
        onMouseEnter: r,
        onClick: e => {
            0 === e.detail && d.current?.activateUploadDialogue(), (0, C.ri)({
                isMobile: !1
            }), n?.()
        },
        children: [(0, l.jsx)(x.A, {
            ...
            ref: d,
            onChange: e => {
                s?.(), (0, A.R)(e.currentTarget.files, c, b.C.FirstThreadMessage, {
                    requireConfirm: !0,
                    origin: "file_picker"
...
function k(e) {
    let {
        ...
        reducedMotion: u
    } = i.useContext(h.CZY), x = (0, h.zhh)({
        from: u.enabled ? y : S,
        to: E,
        config: I
    }, "animate-always"), j = (0, m.bG)([g.A], () => g.A.keyboardModeEnabled), b = (0, m.bG)([v.A], () => v.A.getUploads(t, f.oU.CREATE_FORUM_POST.drafts.type)), A = (0, o.Ay)({
...
function P(e) {
    let {
        channelId: t
    } = e, [n, s] = i.useState(!1), a = i.useRef(null), r = (0, m.bG)([v.A], () => v.A.getUploads(t, f.oU.CREATE_FORUM_POST.drafts.type)), o = r.length, d = o > 0;
    i.useEffect(() => {
        n && !d && s(!1)
    }, [n, d]), i.useEffect(() => {
    ...
    return (0, l.jsxs)("div", {
        ...
        ref: a,
        onBlur: e => {
            null == e.relatedTarget || a.current?.contains(e.relatedTarget) || e.relatedTarget?.closest('[role="dialog"]') == null && u()
        },
        children: [d ? !n && (0, l.jsxs)(h.DUT, {
            "aria-label": T.intl.string(T.t.nzoF5p),
            className: N.fY,
            tabIndex: 0,
            onClick: c,
