...
let A = () => n.e("15423").then(n.t.bind(n, 155147, 19)).then(e => {
    ...
    g = l.memo(function(e) {
        let {
            channel: t,
            isLastItem: n
        } = e, l = (0, s.bG)([r.A], () => r.A.useReducedMotion), g = (0, s.bG)([d.A], () => d.A.can(u.xBc.SEND_MESSAGES_IN_THREADS, t)), _ = (0, o.s5)(t), p = (0, s.bG)([c.default], () => c.default.getId());
        return n ? g && !_ && t.ownerId !== p ? (0, i.jsxs)("div", {
            className: m.aP,
