...
function j(t, e, n) {
    let j = t.config.features.some(t => I.Tz.has(t)),
        ...
        k = i.useCallback(async () => {
            ...
            }), await n?.(), (0, u.pX)(b.BVt.NITRO_HOME)) : ((0, x.Y5)({
                questId: t.id,
                questContent: g.uF.REWARD_MODAL,
    ...
    if (t.config.features.includes(s.L.NITRO_2_POINT_0_CTA)) {
        ...
        return _ ? {
            ...
            subtitle: A.intl.format(p.default.gzazAe, {
                helpCenterLink: t
            }),
            ...
            subtitle: A.intl.format(p.default["3JKWU6"], {
                helpCenterLink: t
            }),
            ...
            subtitle: A.intl.format(p.default.SzOYGc, {
                helpCenterLink: t
            }),
