...
function A(e) {
    ...
    return null == t || 0 === t.favorites.length ? [] : t.favorites.map((n, i) => {
        let r = a.tC.create();
        return r.format = "IMAGE" === n.format ? a.TL.IMAGE : "VIDEO" === n.format ? a.TL.VIDEO : a.TL.NONE, r.src = n.src, r.width = n.width, r.height = n.height, r.order = t.favorites.length - i + e, {
            url: n.url,
            favorite: r
        }
    })
...
let h = [{
    ...
    run(e) {
        ...
        if (null == n) return !1;
        let i = !1;
        return n.favorites.length > 0 && (e.favoriteStickers = a.tQ.create(), e.favoriteStickers.stickerIds = r().uniq(n.favorites).slice(0, 250), i = !0), r().size(n.usageHistory) > 0 && (e.stickerFrecency = a.Do.create(), e.stickerFrecency.stickers = (0, d.Mr)(n.usageHistory, 100), i = !0), i
    },
    cleanup() {
    ...
    run(e) {
        ...
        if (null == t) return !1;
        let n = !1;
        return null != t.favorites && t.favorites.length > 0 && (e.favoriteEmojis = a.gW.create(), e.favoriteEmojis.emojis = r().uniq(t.favorites).slice(0, 250), n = !0), r().size(t.usageHistory) > 0 && (e.emojiFrecency = a.Q8.create(), e.emojiFrecency.emojis = (0, d.Mr)(t.usageHistory, 100), n = !0), n
    },
    cleanup() {
    ...
    run(e) {
        ...
        let t = A(1);
        if (0 === t.length) return !1;
        r()(e.favoriteGifs.gifs).values().sortBy("order").forEach((e, n) => e.order = t.length + 1 + n);
        ...
        for (let {
            ...
            let s = a.tC.toBinary(l).length + r.length + 7;
            n + s > 762880 || (n += s, e.favoriteGifs.gifs[r] = l)
        }
    ...
    run(e) {
        ...
        if (null == t) return !1;
        let n = !1;
        return r().size(t.usageHistory) > 0 && (e.applicationCommandFrecency = a.Zc.create(), e.applicationCommandFrecency.applicationCommands = (0, d.Mr)(t.usageHistory, 500), n = !0), n
    },
    cleanup() {
    ...
    run(e) {
        ...
        if (null == t) return !1;
        let n = !1;
        return r().size(t.favoriteSounds) > 0 && (e.favoriteSoundboardSounds = a.Qn.create(), o.default.keys(t.favoriteSounds).forEach(n => {
