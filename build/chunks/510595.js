...
function A(e) {
    ...
    return null == t || 0 === t.favorites.length ? [] : t.favorites.map((n, i) => {
        let a = r.tC.create();
        return a.format = "IMAGE" === n.format ? r.TL.IMAGE : "VIDEO" === n.format ? r.TL.VIDEO : r.TL.NONE, a.src = n.src, a.width = n.width, a.height = n.height, a.order = t.favorites.length - i + e, {
            url: n.url,
            favorite: a
        }
    })
...
let h = [{
    ...
    run(e) {
        ...
        if (null == n) return !1;
        let i = !1;
        return n.favorites.length > 0 && (e.favoriteStickers = r.tQ.create(), e.favoriteStickers.stickerIds = a().uniq(n.favorites).slice(0, 250), i = !0), a().size(n.usageHistory) > 0 && (e.stickerFrecency = r.Do.create(), e.stickerFrecency.stickers = (0, d.Mr)(n.usageHistory, 100), i = !0), i
    },
    cleanup() {
    ...
    run(e) {
        ...
        if (null == t) return !1;
        let n = !1;
        return null != t.favorites && t.favorites.length > 0 && (e.favoriteEmojis = r.gW.create(), e.favoriteEmojis.emojis = a().uniq(t.favorites).slice(0, 250), n = !0), a().size(t.usageHistory) > 0 && (e.emojiFrecency = r.Q8.create(), e.emojiFrecency.emojis = (0, d.Mr)(t.usageHistory, 100), n = !0), n
    },
    cleanup() {
    ...
    run(e) {
        ...
        for (let {
            ...
            of t) {
            if (l.order = t.length - i, i++, a in e.favoriteGifs.gifs) {
                e.favoriteGifs.gifs[a].order = l.order;
                continue
            }
            let s = r.tC.toBinary(l).length + a.length + 7;
            n + s > 762880 || (n += s, e.favoriteGifs.gifs[a] = l)
        }
    ...
    run(e) {
        ...
        if (null == t) return !1;
        let n = !1;
        return a().size(t.usageHistory) > 0 && (e.applicationCommandFrecency = r.Zc.create(), e.applicationCommandFrecency.applicationCommands = (0, d.Mr)(t.usageHistory, 500), n = !0), n
    },
    cleanup() {
    ...
    run(e) {
        ...
        if (null == t) return !1;
        let n = !1;
        return a().size(t.favoriteSounds) > 0 && (e.favoriteSoundboardSounds = r.Qn.create(), o.default.keys(t.favoriteSounds).forEach(n => {
