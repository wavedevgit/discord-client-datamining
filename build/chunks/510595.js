...
function A(e) {
    ...
    return null == t || 0 === t.favorites.length ? [] : t.favorites.map((n, i) => {
        let r = l.tC.create();
        return r.format = "IMAGE" === n.format ? l.TL.IMAGE : "VIDEO" === n.format ? l.TL.VIDEO : l.TL.NONE, r.src = n.src, r.width = n.width, r.height = n.height, r.order = t.favorites.length - i + e, {
            url: n.url,
            favorite: r
        }
    })
...
let h = [{
    ...
    run(e) {
        ...
        if (null == n) return !1;
        let i = !1;
        return n.favorites.length > 0 && (e.favoriteStickers = l.tQ.create(), e.favoriteStickers.stickerIds = r().uniq(n.favorites).slice(0, 250), i = !0), r().size(n.usageHistory) > 0 && (e.stickerFrecency = l.Do.create(), e.stickerFrecency.stickers = (0, d.Mr)(n.usageHistory, 100), i = !0), i
    },
    cleanup() {
    ...
    run(e) {
        ...
        if (null == t) return !1;
        let n = !1;
        return null != t.favorites && t.favorites.length > 0 && (e.favoriteEmojis = l.gW.create(), e.favoriteEmojis.emojis = r().uniq(t.favorites).slice(0, 250), n = !0), r().size(t.usageHistory) > 0 && (e.emojiFrecency = l.Q8.create(), e.emojiFrecency.emojis = (0, d.Mr)(t.usageHistory, 100), n = !0), n
    },
    cleanup() {
    ...
    run(e) {
        ...
        if (null == t) return !1;
        let n = !1;
        return r().size(t.usageHistory) > 0 && (e.applicationCommandFrecency = l.Zc.create(), e.applicationCommandFrecency.applicationCommands = (0, d.Mr)(t.usageHistory, 500), n = !0), n
    },
    cleanup() {
    ...
    run(e) {
        ...
        if (null == t) return !1;
        let n = !1;
        return r().size(t.favoriteSounds) > 0 && (e.favoriteSoundboardSounds = l.Qn.create(), o.default.keys(t.favoriteSounds).forEach(n => {
