...
function j(e) {
    let {
        match: t,
        location: l
    } = e, o = (0, s.parse)(l.search).token, [d, j] = i.useState("loading"), y = i.useRef(!1), b = i.useCallback(async e => {
        try {
            g.default.track(A.HAw.ONE_TIME_LOGIN_ATTEMPTED, {
                source: "web_page"
            }), await c.A.oneTimeLogin(e), j("login_success"), g.default.track(A.HAw.LOGIN_SUCCESSFUL, {
                source: "web_page",
    ...
    if (i.useEffect(() => {
            let e = null != o && "string" == typeof o,
                t = a.Fr ? "mobile" : a.v1 ? "tablet" : (0, m.isDesktop)() ? "desktop_app" : "web";
            ...
            if (a.Fr || a.v1) {
                ...
                return
            }(0, m.isDesktop)() ? b(o): y.current || (y.current = !0, j("rpc_attempting"), I(o))
        }, [o, l, b, I]), a.Fr || a.v1) {
