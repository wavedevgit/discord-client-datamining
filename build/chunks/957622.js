...
let x = e => {
    ...
    E = function(e) {
        let {
            match: t,
            location: a
        } = e, E = (0, r.parse)(a.search).token, [I, v] = s.useState("loading"), N = s.useRef(!1), j = s.useCallback(async e => {
            try {
                h.default.track(m.HAw.ONE_TIME_LOGIN_ATTEMPTED, {
                    source: "web_page"
                }), await o.A.oneTimeLogin(e), v("login_success"), h.default.track(m.HAw.LOGIN_SUCCESSFUL, {
                    source: "web_page",
        ...
        if ("app_launched" === I) return (0, i.jsx)(x, {
        ...
        if ("app_launch_not_supported" === I) return (0, i.jsx)(x, {
