/** chunk id: 411211 params = (module,exports,require) **/
t.d(e, {
    Y: () => g
});
var a = t(842830),
    ...
    y = t(762437);
t(854840);
let m = ["locale", "style", "years", "yearsDisplay", "months", "monthsDisplay", "weeks", "weeksDisplay", "days", "daysDisplay", "hours", "hoursDisplay", "minutes", "minutesDisplay", "seconds", "secondsDisplay", "milliseconds", "millisecondsDisplay", "microseconds", "microsecondsDisplay", "nanoseconds", "nanosecondsDisplay", "numberingSystem", "fractionalDigits"],
    w = [{
        styleSlot: "years",
...
class g {
    constructor(n, e) {
        if (!(this && this instanceof g ? this.constructor : void 0)) throw TypeError("Intl.DurationFormat must be called with 'new'");
        const t = (0, a.N)(n),
        ...
        const {
            localeData: y,
            availableLocales: m
        } = g, p = (0, d.B)(m, t, u, ["nu"], y, g.getDefaultLocale), v = p.locale, b = (0, f.n)(this);
        ...
        w.forEach(n => {
            ...
            b[e] = s.style, b[t] = s.display, ("hours" === a || "minutes" === a || "seconds" === a || "milliseconds" === a || "microseconds" === a) && (M = s.style)
        }), b.fractionalDigits = (0, s.z)(o, "fractionalDigits", 0, 9, void 0)
    }
    resolvedOptions() {
        if ("object" != typeof this || !(0, r.Wt)(g, this)) throw TypeError("Method Intl.DurationFormat.prototype.resolvedOptions called on incompatible receiver");
        let n = (0, f.n)(this),
            e = {};
        for (let t of m) {
            let a = n[t];
            "fractionalDigits" === t ? void 0 !== a && (a = Number(a)) : (0, u.V1)(void 0 !== a, `Missing internal slot ${t}`), e[t] = a
        }
        return e
    }
    formatToParts(n) {
