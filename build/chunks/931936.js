...
function E(e) {
    let {
        guildId: t,
        showVideoCard: n = !1
    } = e, E = (0, u.A)(t), j = (0, o.A)(t), b = (0, a.A)(t), I = n ? [s.M.GUILD_POWERUPS_OVERVIEW_SIDEBAR_VIDEO_CARD] : [], [S, C] = (0, l.kn)(I), w = S === s.M.GUILD_POWERUPS_OVERVIEW_SIDEBAR_VIDEO_CARD, N = (0, _.A)(j.shouldShow || b.shouldShow || w);
    return E.shouldShow || j.shouldShow || b.shouldShow || N.shouldShow || w ? (0, r.jsxs)("div", {
        ...
        children: [(0, r.jsx)(i.EYj, {
            ...
            text: E.text
        }), j.shouldShow && (0, r.jsx)(m.A, {
            guildId: t,
            powerupNames: j.expiringPowerupNames,
            warnings: j.warnings
        }), b.shouldShow && null != b.notificationConfig && (0, r.jsx)(p.A, {
