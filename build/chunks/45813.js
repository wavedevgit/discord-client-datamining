/** chunk id: 45813 params = (module,exports,require) **/
"use strict";
l.d(t, {
    A: () => C
});
...
class A extends s.PureComponent {
    ...
    trackLinkClick = e => {
        this.props.track(f.HAw.CHANGE_LOG_CTA_CLICKED, {
    ...
    renderFooter() {
        return (0, a.jsxs)("div", {
            ...
            children: [(0, a.jsx)(i.MzZ, {
                ...
                target: "blank",
                children: (0, a.jsx)(i.LyU, {
                    size: "xs",
                    color: "currentColor"
                })
            }), (0, a.jsx)(i.Text, {
                variant: "text-xs/normal",
                children: _.intl.string(_.t.EjVVI7)
            })]
        })
    }
    renderVideo() {
        let {
            changeLog: e
        } = this.props, t = e.youtube_video_id, s = e.video, n = e.image;
        if (null != t && "" !== t) return (0, a.jsx)(c.rr, {
            className: x.video,
            allowFullScreen: !1,
            href: `https://youtu.be/${t}`,
            thumbnail: {
                url: `https://i.ytimg.com/vi/${t}/hqdefault.jpg`,
                width: 432,
                height: 240
            },
            video: {
    ...
    render() {
        ...
        return (0, a.jsx)(o.Modal, {
            ...
            children: (0, a.jsxs)("div", {
                ...
                children: [this.renderVideo(), b(e.body, !1, {
                    changeLog: this,
                    interpolations: k,
