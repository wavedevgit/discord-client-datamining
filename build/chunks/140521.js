/** chunk id: 140521, original params: e,i,t (module,exports,require) **/
let s;
t.d(i, {
    default: () => v
}), t(323874), t(14289), t(35956), t(321073);
var r = t(835245),
    a = t(872379),
    n = t(795521);
...
class v {
    ...
    constructor({
        ...
        this.canvasId = (0, r.A)(), this.assetUrl = t, this.assetData = n, this.onInitialDraw = o, this.onError = l, this.observer = new IntersectionObserver(this.handleVisibilityChange), this.observer.observe(e), h ? this.initializationPromise = c().then(() => {
    ...
    async drop() {
        if (await this.initializationPromise, h) {
            this.worker?.removeEventListener("message", this.handleMessage), this.worker?.removeEventListener("error", this.handleError), this.worker?.postMessage({
                canvasId: this.canvasId,
                type: a.l.DROP
            });
            let e = d.get(this.canvasId);
    ...
    setState(e, i) {
        this.shouldAnimate = e, this.isInitialized && (h ? this.worker?.postMessage({
            canvasId: this.canvasId,
