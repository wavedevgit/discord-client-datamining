/** chunk id: 343322, original params: t,n,i (module,exports,require) **/
i.d(n, {
    A: () => h
});
var l = i(627968);
...
function h(t, n) {
    ...
    function p() {
        ...
        c.V(t.id, t.branchId, n), u.default.track(o.HAw.APPLICATION_SETTINGS_UPDATED, {
    ...
    return (0, l.jsx)(d.Drp, {
        ...
        action: function() {
            null != t && null != n && (t.isHidden() || !h ? p() : (0, r.A)({
                title: b.intl.string(b.t.oB7isi),
                subtitle: b.intl.format(b.t.HXfjKt, {
                    name: n.name
                }),
                variant: "primary",
