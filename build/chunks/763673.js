/** Chunk was on web.js **/
/** chunk id: 763673, original params: e,t,n (module,exports,require) **/
"use strict";
n.d(t, {
    r: () => c
});
...
function c(e) {
    ...
    return (0, r.useMemo)(() => {
        var r, i, a;
        let l = (0, o.n)("collectibles/".concat(e.src, "img.png")),
            c = (0, o.n)("collectibles/".concat(e.src, "asset.webm")),
            u = (0, o.n)("collectibles/".concat(e.src, "static.png"));
        if (e.preview) return {
