...
function w(e, t) {
    ...
    (null != n || null != i) && y.default.track(M.HAw.EXTERNAL_DYNAMIC_LINK_RECEIVED, {
        invite_code: null,
        has_auth_token: null,
...
let U = {
    ...
    [M.e$_.GUILD_TEMPLATE_BROWSER]: {
        ...
        async handler(e) {
            ...
            if (null == l) throw new P.A({
                errorCode: M.Lw6.INVALID_GUILD_TEMPLATE
    ...
    [M.e$_.GIFT_CODE_BROWSER]: {
        ...
        handler(e) {
            ...
            return new Promise((e, l) => {
                s.h.wait(() => {
                    u.A.resolveGiftCode(t, !0, !0).then(l => {
                        let {
                            giftCode: a
                        } = l;
                        R.Ay.focus(), y.default.track(M.HAw.OPEN_MODAL, {
                            type: "gift_accept",
                            location: M.$OG
                        }), (0, r.mMO)(async () => {
                            let {
                        ...
                        errorCode: M.Lw6.INVALID_GIFT_CODE
                    }, `Invalid gift code: ${t}`)))
                })
            })
        }
        ...
        handler(e) {
            ...
            switch (R.Ay.focus(), t) {
                case j.XK.USER_SETTINGS:
                    ...
                    break;
                case j.XK.CHANGELOG:
                    null != i && ((0, N.pX)(L.A.formatPathWithQuery(M.BVt.CHANGELOGS(i.date), i.query)), w(i, (0, j.OE)(t)));
                    break;
                case j.XK.LIBRARY:
                    (0, N.pX)(M.BVt.APPLICATION_LIBRARY), null != i && w(i, (0, j.OE)(t));
                    break;
                case j.XK.STORE_HOME:
                    (0, N.pX)(M.BVt.APPLICATION_STORE), null != i && w(i, (0, j.OE)(t));
                    break;
                case j.XK.STORE_LISTING:
                    null != i && ((0, N.pX)(M.BVt.APPLICATION_STORE_LISTING_SKU(i.skuId, i.slug)), w(i, (0, j.OE)(t)));
                    break;
                ...
                case j.XK.CHANNEL:
                    ...
                    break;
                case j.XK.GAME_SHOP:
                    null != i && ((0, N.pX)(M.BVt.CHANNELS_GAME_SHOP(i.guildId, i.pageIndex, i.skuId, i.slug)), w(i, (0, j.OE)(t)));
                    break;
                ...
                case j.XK.DISCOVERY_GAME_RESULTS:
                    ...
                    break;
                case j.XK.OAUTH2:
                    let a = new URL(M.BVt.OAUTH2_AUTHORIZE, window.location.origin);
                    a.search = i.search;
                    let r = (0, f.getOAuth2AuthorizeProps)(a.toString());
                    if (null != r) return (0, f.openOAuth2ModalWithCreateGuildModal)(r), !0;
                    return !1;
                case j.XK.ONE_TIME_LOGIN:
                    if (null != i) return (0, C.N)({
                        token: i.token
                    }), w(i, (0, j.OE)(t)), !0;
                    return !1;
                case j.XK.SHOP:
                    ...
                    break;
                case j.XK.FEATURES:
                    i?.path != null && ((0, N.pX)(i.path), w(i, (0, j.OE)(t)));
                    break;
                    ...
                    if (null != i) {
                        ...
                        return async function(e, t, n) {
                            try {
                                ...
                                if (i?.applicationId === e) return void y.default.track(M.HAw.ACTIVITY_DEEP_LINK_RECEIVED, {
                                    application_id: e,
                                    success: !1,
                                ...
                                let l = await g.Ay.fetchApplication(e),
                                    a = l?.bot?.id;
                                if (null == a) return void y.default.track(M.HAw.ACTIVITY_DEEP_LINK_RECEIVED, {
                                    application_id: e,
                                    success: !1,
                                    failure_reason: "no_bot_user",
                                    attempt_id: n
                                });
                                let r = await d.A.openPrivateChannel({
                                        recipientIds: a
                                    }),
                                    s = new URL(t),
                                    ...
                                    {
                                        customId: c
                                    } = await (0, _.d9)(e, s.searchParams.get("link_id"), s.searchParams.get("custom_id"));
                                await (0, h.A)({
                        ...
                        }(i.applicationId, i.url, e), w(i, (0, j.OE)(t)), !0
                    }
                    return !1;
    ...
    [M.e$_.CONNECTIONS_CALLBACK]: {
        ...
        handler: async e => {
            ...
            try {
                ...
                if (e?.status === 400) throw new P.A({
                    errorCode: M.Lw6.BAD_REQUEST_FOR_PROVIDER
    ...
    [M.e$_.BRAINTREE_POPUP_BRIDGE_CALLBACK]: {
        ...
        handler(e) {
            ...
            return (0, p.re)({
                paymentSourceType: M.hes.PAYPAL,
                state: t,
                path: n,
                query: i
            })
