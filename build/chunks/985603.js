...
function U(e, t) {
    null != e && b.default.track(M.HAw.EXTERNAL_DYNAMIC_LINK_RECEIVED, {
        invite_code: null,
        has_auth_token: null,
            ...
            return new Promise((e, r) => {
                s.h.wait(() => {
                    A.A.resolveGiftCode(t, !0, !0).then(r => {
                        ...
                        R.Ay.focus(), b.default.track(M.HAw.OPEN_MODAL, {
                            type: "gift_accept",
                            location: M.$OG
                        }), (0, a.mMO)(async () => {
                            let {
            ...
            switch (R.Ay.focus(), t) {
                case D.XK.USER_SETTINGS:
                    if (null != i) {
                        ...
                        null != n && (0, x.openUserSettingsFromParsedUrl)({
                            match: n,
                            urlOrigin: "deeplink"
                    ...
                    if (null != i) {
                        ...
                        return async function(e, t, n) {
                            try {
                                ...
                                if (i?.applicationId === e) return void b.default.track(M.HAw.ACTIVITY_DEEP_LINK_RECEIVED, {
                                    application_id: e,
                                    success: !1,
