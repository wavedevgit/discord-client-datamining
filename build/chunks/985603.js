...
function M(e, t) {
    null != e && v.default.track(j.HAw.EXTERNAL_DYNAMIC_LINK_RECEIVED, {
        invite_code: null,
        has_auth_token: null,
...
let w = {
    ...
    [j.e$_.GUILD_TEMPLATE_BROWSER]: {
        ...
        async handler(e) {
            ...
            if (null == r) throw new L.A({
                errorCode: j.Lw6.INVALID_GUILD_TEMPLATE
            }, `Invalid guild template id: ${t}`);
            return O.Ay.focus(), (0, a.mMO)(async () => {
                let {
                    default: e
            ...
            return new Promise((e, r) => {
                s.h.wait(() => {
                    A.A.resolveGiftCode(t, !0, !0).then(r => {
                        ...
                        O.Ay.focus(), v.default.track(j.HAw.OPEN_MODAL, {
                            type: "gift_accept",
                            location: j.$OG
                        }), (0, a.mMO)(async () => {
                            let {
                        ...
                        errorCode: j.Lw6.INVALID_GIFT_CODE
                    }, `Invalid gift code: ${t}`)))
                })
            })
        }
        ...
        handler(e) {
            ...
            switch (O.Ay.focus(), t) {
                case P.XK.USER_SETTINGS:
                    null != i && ((0, N.bG)({
                        pathname: j.BVt.SETTINGS(i.section, i.subsection),
                        search: i.search
                    }), M(i.fingerprint, (0, P.OE)(t)));
                    break;
                case P.XK.CHANGELOG:
                    null != i && ((0, N.bG)(b.A.formatPathWithQuery(j.BVt.CHANGELOGS(i.date), i.query)), M(i.fingerprint, (0, P.OE)(t)));
                    break;
                case P.XK.LIBRARY:
                ...
                case P.XK.STORE_LISTING:
                    null != i && ((0, N.bG)(j.BVt.APPLICATION_STORE_LISTING_SKU(i.skuId, i.slug)), M(i.fingerprint, (0, P.OE)(t)));
                    break;
                case P.XK.PICK_GUILD_SETTINGS:
                    null != i && ((0, N.bG)({
                        pathname: j.BVt.PICK_GUILD_SETTINGS(i.section, i.subsection),
                        search: i.search
                    }), M(i.fingerprint, (0, P.OE)(t)));
                    break;
                case P.XK.CHANNEL:
                    null != i && ((0, N.bG)({
                        pathname: j.BVt.CHANNEL(i.guildId, i.channelId, i.messageId),
                        search: i.search
                    }), M(i.fingerprint, (0, P.OE)(t)));
                    break;
                case P.XK.GAME_SHOP:
                    null != i && ((0, N.bG)({
                        pathname: j.BVt.CHANNELS_GAME_SHOP(i.guildId, i.pageIndex, i.skuId, i.slug)
                    }), M(i.fingerprint, (0, P.OE)(t)));
                    break;
                case P.XK.QUEST_HOME:
                    if (null != i) {
                        let e = new URLSearchParams;
                        null != i.sort && e.set(T.L1.SORT, i.sort), null != i.filter && e.set(T.L1.FILTER, i.filter), null != i.tab && e.set(T.L1.TAB, i.tab), (0, N.bG)({
                            pathname: j.BVt.QUEST_HOME_V2,
                            hash: i.questId,
                            search: `?${e.toString()}`
                        }), M(i.fingerprint, (0, P.OE)(t))
                ...
                case P.XK.QUEST_PREVIEW_TOOL:
                    if ((0, C.U)({
                            location: D.rE.QUEST_PREVIEW_TOOL_2
                        }) && null != i) {
                        let e = new URLSearchParams;
                        e.set(T.L1.TAB, T.NC.PREVIEW_TOOL), null != i.questId && e.set(T.L1.QUEST_ID, i.questId), (0, N.bG)({
                            pathname: j.BVt.QUEST_HOME_V2,
                            search: `?${e.toString()}`
                        }), M(i.fingerprint, (0, P.OE)(t))
                    }
                ...
                case P.XK.DISCOVERY_GAME_RESULTS:
                    null != i && ((0, N.bG)({
                        pathname: j.BVt.GLOBAL_DISCOVERY_SERVERS,
                ...
                case P.XK.ONE_TIME_LOGIN:
                    if (null != i) return (0, f.N)({
                        token: i.token
                    }), M(i.fingerprint, (0, P.OE)(t)), !0;
                    return !1;
                case P.XK.SHOP:
                    null != i && ((0, N.bG)({
                        pathname: j.BVt.COLLECTIBLES_SHOP,
                        search: i.search
                    }), M(i.fingerprint, (0, P.OE)(t)));
                    break;
                case P.XK.FEATURES:
                    ...
                    if (null != i) {
                        ...
                        return async function(e, t, n) {
                            try {
                                ...
                                if (i?.applicationId === e) return void v.default.track(j.HAw.ACTIVITY_DEEP_LINK_RECEIVED, {
                                    application_id: e,
                                    success: !1,
                                ...
                                let r = await g.Ay.fetchApplication(e),
                                    l = r?.bot?.id;
                                if (null == l) return void v.default.track(j.HAw.ACTIVITY_DEEP_LINK_RECEIVED, {
                                    application_id: e,
                                    success: !1,
                                    failure_reason: "no_bot_user",
                                    attempt_id: n
                                });
                                let a = await c.A.openPrivateChannel({
                                        recipientIds: l
                                    }),
                                    s = new URL(t),
                        ...
                        }(i.applicationId, i.url, e), M(i.fingerprint, (0, P.OE)(t)), !0
                    }
                    return !1;
    ...
    [j.e$_.CONNECTIONS_CALLBACK]: {
        ...
        handler: async e => {
            ...
            try {
                ...
                if (e?.status === 400) throw new L.A({
                    errorCode: j.Lw6.BAD_REQUEST_FOR_PROVIDER
    ...
    [j.e$_.BRAINTREE_POPUP_BRIDGE_CALLBACK]: {
        ...
        handler(e) {
            ...
            return (0, o.re)({
                paymentSourceType: j.hes.PAYPAL,
                state: t,
                path: n,
                query: i
            })
