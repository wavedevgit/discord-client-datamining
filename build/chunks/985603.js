/** chunk id: 985603 params = (module,exports,require) **/
n.d(t, {
    A: () => B
...
function V(e, t) {
    ...
    (null != n || null != i) && R.default.track(G.HAw.EXTERNAL_DYNAMIC_LINK_RECEIVED, {
        invite_code: null,
        has_auth_token: null,
...
let B = {
    ...
    [G.e$_.GUILD_TEMPLATE_BROWSER]: {
        ...
        async handler(e) {
            ...
            return M.Ay.focus(), (0, r.mMO)(async () => {
                let {
                    default: e
            ...
            switch (M.Ay.focus(), t) {
                case U.XK.USER_SETTINGS:
                    null != i && (0, E.B)(() => {
                        ...
                        (0, b.trackParseSettingsUrl)(n, "deeplink"), (0, y.openUserSettings)(n.target, {
                            path: n.path,
                    ...
                    break;
                case U.XK.CHANGELOG:
                    null != i && ((0, v.pX)(D.A.formatPathWithQuery(G.BVt.CHANGELOGS(i.date), i.query)), V(i, (0, U.OE)(t)));
                    break;
                case U.XK.LIBRARY:
                ...
                case U.XK.PICK_GUILD_SETTINGS:
                    null != i && ((0, v.pX)(G.BVt.PICK_GUILD_SETTINGS(i.section, i.subsection), {
                        search: i.search
                    }), V(i, (0, U.OE)(t)));
                    break;
                case U.XK.CHANNEL:
                    null != i && ((0, v.pX)(G.BVt.CHANNEL(i.guildId, i.channelId, i.messageId), {
                        search: i.search
                    }), V(i, (0, U.OE)(t)));
                    break;
                case U.XK.GAME_SHOP:
                    null != i && ((0, v.pX)(G.BVt.CHANNELS_GAME_SHOP(i.guildId, i.pageIndex, i.skuId, i.slug)), V(i, (0, U.OE)(t)));
                    break;
                case U.XK.QUEST_HOME:
                    if (null != i) {
                        let e = new URLSearchParams;
                        null != i.sort && e.set(x.L1.SORT, i.sort), null != i.filter && e.set(x.L1.FILTER, i.filter), null != i.tab && e.set(x.L1.TAB, i.tab), (0, v.pX)(G.BVt.QUEST_HOME, {
                            hash: i.questId,
                            search: `?${e.toString()}`
                        }), V(i, (0, U.OE)(t))
                ...
                case U.XK.QUEST_PREVIEW_TOOL:
                    if ((0, S.U)({
                            location: k.rE.QUEST_PREVIEW_TOOL_2
                        }) && null != i) {
                        let e = new URLSearchParams;
                        e.set(x.L1.TAB, x.NC.PREVIEW_TOOL), null != i.questId && e.set(x.L1.QUEST_ID, i.questId), (0, v.pX)(G.BVt.QUEST_HOME, {
                            search: `?${e.toString()}`
                        }), V(i, (0, U.OE)(t))
                    }
                    break;
                case U.XK.DISCOVERY_GAME_RESULTS:
                    null != i && ((0, v.pX)(G.BVt.GLOBAL_DISCOVERY_SERVERS, {
                ...
                case U.XK.ONE_TIME_LOGIN:
                    ...
                    return !1;
                case U.XK.SHOP:
                    null != i && ((0, v.pX)(G.BVt.COLLECTIBLES_SHOP, {
                        search: i.search
                    }), V(i, (0, U.OE)(t)));
                    break;
                case U.XK.FEATURES:
                    ...
                    if (null != i) {
                        ...
                        return async function(e, t, n) {
                            try {
                                ...
                                if (i?.applicationId === e) return void R.default.track(G.HAw.ACTIVITY_DEEP_LINK_RECEIVED, {
                                    application_id: e,
                                    success: !1,
                                ...
                                let a = await g.Ay.fetchApplication(e),
                                    l = a?.bot?.id;
                                if (null == l) return void R.default.track(G.HAw.ACTIVITY_DEEP_LINK_RECEIVED, {
                                    application_id: e,
                                    success: !1,
                        ...
                        }(i.applicationId, i.url, e), V(i, (0, U.OE)(t)), !0
                    }
                    return !1;
                case U.XK.PLAYGROUND:
                    ...
                    break;
                case U.XK.GORILLA:
                    null != i && I.s.getConfig({
                        location: "rpc_deeplink"
                    }).enabled && ((0, f.A)({
                        source: "rpc_deeplink"
                    }), V(i, (0, U.OE)(t)))
            }
        ...
        handler: async e => {
            ...
            try {
                ...
                if (e?.status === 400) throw new j.A({
                    errorCode: G.Lw6.BAD_REQUEST_FOR_PROVIDER
    ...
    [G.e$_.BRAINTREE_POPUP_BRIDGE_CALLBACK]: {
        ...
        handler(e) {
            ...
            return (0, o.re)({
                paymentSourceType: G.hes.PAYPAL,
                state: t,
                path: n,
                query: i
            })
