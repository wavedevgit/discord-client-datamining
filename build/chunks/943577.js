...
function ef(e, t, n) {
    ...
    for (let e of o) {
        ...
        if ((0, u.A)(r)) {
            ...
            if ((0, c.Ay)({
                    ...
                    userId: e.id,
                    application: d,
                    channelId: null == (w = M.A.getVoiceStateForUser(e.id)) ? void 0 : w.channelId,
                    currentUser: i,
        ...
        }), (O = a().orderBy(O, [ed], ["desc"])).length !== o.length && (p = !0), m.add(d.id), h.push({
            game: d,
            activity: r,
            activityUser: e,
    ...
    for (let e of o) {
        let t = el(e.id),
            ...
            s = P.A.getGuild(i);
        if (F.has(i) && V.has(t) || null == n || null == s || n.id === s.afkChannelId) null == n && (r = null, U = !0);
        else {
            ...
            u.filter(e => !d.includes(e.id)).forEach(e => o.push(e)), U ? F.has(i) || (r = null) : (r = s, U = !0), F.add(i), V.add(t), G.push({
                channel: n,
                guild: s,
                members: u,
                voiceStates: e
