    ...
    render() {
        ...
        return (0, i.jsxs)(M.A, {
            ...
            children: [(0, i.jsx)(m.A, {
                ...
                path: ei.BVt.CHANNELS_GAME_SHOP(S.pv.guildId(), ":pageIndex", ":skuId", ":slug?"),
                render: e => (0, i.jsx)(eI, {
                    ...e
                })
            }), (0, i.jsx)(m.A, {
                path: ei.BVt.CHANNEL(S.pv.guildId(), S.pv.channelId({
                    optional: !0
                }), ":messageId?"),
                render: e => (0, i.jsx)(ex, {
                    ...e
...
let ey = c.Ay.connectStores([O.default, w.A, L.A, I.A, N.A], e => {
    let {
        match: t,
        location: n
