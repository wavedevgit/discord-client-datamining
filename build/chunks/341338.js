...
class ec extends r.PureComponent {
    ...
    componentDidMount() {
        ...
        (null == t || t.isSlimDirectoryVersion()) && a(), null != e && (n || r || (0, p.LM)(e.applicationId), i && _.h.wait(() => (0, m.n)(e.applicationId))), this.trackViewed(), this.replaceUrlWithSlug()
    }
    componentDidUpdate(e) {
        ...
        if (s !== e.storeListing && null != s && (0, q.W)(es.XK.STORE_LISTING, {
                skuId: r,
                slug: a
    ...
    trackViewed() {
        ...
        H.default.track(ea.HAw.STORE_LISTING_VIEWED, {
    ...
    trackCarouselScroll = (e, t, n) => {
        ...
        null != i && H.default.track(ea.HAw.STORE_LISTING_MEDIA_SCROLLED, {
            ...(0, b.A)(i),
            card_index: n,
    ...
    copyCurrentUrl = () => {
        ...
        let {
            location: t
        } = this.props, n = (e = t.pathname, `${location.protocol}//${location.host}${e}`);
    ...
    renderInviteLink = () => {
        ...
        return null != e && null != t && (D.A.can(ea.xBc.CREATE_INSTANT_INVITE, t) || null != t.vanityURLCode) ? (0, i.jsx)(A.$n, {
            "aria-label": eo.intl.string(eo.t.zJrgTG),
            look: A.$n.Looks.BLANK,
            size: A.$n.Sizes.NONE,
            onClick: this.handleCreateInstantInvite,
            className: ed.nf,
            children: (0, i.jsx)(h.qYV, {
                size: "md",
                color: "currentColor",
                className: ed.wP
            })
    ...
    renderCopyLink = () => {
        ...
        return this.isChannelType ? this.renderInviteLink() : (0, i.jsx)(c.m, {
    ...
    renderHeaderToolbar = (e, t) => {
        ...
        return (0, i.jsxs)("div", {
            ...
            children: [(0, i.jsx)("div", {
                className: ed.ND,
                children: n && null != t ? (0, i.jsx)(ei.A, {
                    size: ei.J.Sizes.MIN,
                ...
                children: (0, i.jsxs)("div", {
                    ...
                    children: [null != t ? (0, O.A)(t) : null, null != e && null != t ? (0, i.jsx)("div", {
                        children: "deprecated!"
                    }) : null, (0, i.jsx)(J.A, {
    ...
    renderHeader(e, t) {
        ...
        return (0, i.jsx)(L.A, {
            ...
            children: null != n ? (0, i.jsxs)(r.Fragment, {
            ...
            }) : null != t && t.premium ? (0, i.jsxs)(r.Fragment, {
                children: [(0, i.jsx)(L.A.Icon, {
                    icon: h.tvc,
    ...
    renderHeaderAssets(e, t, n) {
        let {
            theme: r
        } = this.props, l = t.headerBackground, a = (0, u.qB)(r) ? t.headerLogoLightTheme : t.headerLogoDarkTheme;
        return null == l || null == a ? (0, i.jsx)("div", {
            className: ed.Zt
        }) : (0, i.jsxs)("div", {
            className: ed.nT,
            children: [(0, i.jsx)("div", {
                className: ed.y2,
                style: {
                    backgroundImage: `url(${(0,W.YE)(e.id,l,1024,"png")})`
                }
            }), (0, i.jsx)("img", {
                className: ed.nu,
                src: (0, W.YE)(e.id, a, 1024, "png"),
                alt: n.name
            })]
        })
    }
    ...
    renderSystemRequirements(e) {
        return null == e.systemRequirements || 0 === Object.keys(e.systemRequirements).length ? null : (0, i.jsx)(en.A, {
            className: ed.wn,
    ...
    renderJsonLD() {
        ...
        null != l && r.push(l), null != t.headerLogoLightTheme && r.unshift((0, W.YE)(n.id, t.headerLogoLightTheme, 1024, "jpg"));
        let a = v.A.Product({
                name: e.name,
    ...
    renderLarge(e, t, n) {
        return (0, i.jsxs)("div", {
            className: ed.RR,
            children: [this.renderHeaderAssets(e, t, n), this.renderCarousel(e, t), (0, i.jsx)("div", {
                className: ed.ko,
                children: (0, i.jsxs)("div", {
                    className: ed.rf,
                    children: [(0, i.jsxs)("div", {
    ...
    renderListing = () => {
        ...
        return null == e || null == n || null == t || t.isSlimDirectoryVersion() ? (0, i.jsx)(x.A, {
            align: x.A.Align.CENTER,
            justify: x.A.Justify.CENTER,
            children: (0, i.jsx)(h.y$y, {})
        }) : r === el.q.SMALL ? this.renderSmall(e, t, n) : this.renderLarge(e, t, n)
    };
    render() {
        let {
            application: e,
        ...
        if (null == e || null == t || null == n || n.isSlimDirectoryVersion()) return (0, i.jsxs)(r.Fragment, {
            children: [this.renderHeader(e, t), (0, i.jsx)(x.A, {
                align: x.A.Align.CENTER,
                justify: x.A.Justify.CENTER,
                children: (0, i.jsx)(h.y$y, {
                    className: ed.u1
        ...
        if (!l && t.showAgeGate) {
            let n = a ? null : (0, i.jsx)("div", {
                className: ed.uR,
                children: this.renderListing()
            });
            return (0, i.jsxs)(r.Fragment, {
                children: [(0, i.jsx)(y.HI, {
                    location: e.name
                }), this.renderJsonLD(), this.renderHeader(e, t), (0, i.jsx)(Z.A, {
                    game: e
                }), n]
            })
        }
...
let eu = (0, f.A)((0, C.A)(o.Ay.connectStores([w.A, P.A, R.default, B.A, k.A, G.A, V.A, T.A, N.A, M.A, j.A, U.A], e => {
    let t, n, i, {
        inputSkuId: r,
        applicationId: l,
        storeListingId: a,
    ...
    if (null == l) {
        ...
        t = r, null != (l = null != (n = G.A.get(r)) ? n.applicationId : null) && (i = N.A.getApplication(l))
    } else if (null == r) {
        if (null == l) throw Error("Needs applicationId or skuId");
        null != (i = N.A.getApplication(l)) && (t = i.destinationSkuId), n = null != t ? G.A.get(t) : null
    }
    n?.flags != null && (0, s.Lt)(n.flags, ea.d68.STICKER) && (n = null);
    let c = null != l && (V.A.inTestModeForApplication(l) || T.A.inDevModeForApplication(l));
    return {
        skuId: t,
        application: null != l ? N.A.getApplication(l) : null,
        isFetchingEntitlements: null != l && U.A.applicationIdsFetching.has(l),
        didFetchEntitlements: null != l && U.A.applicationIdsFetched.has(l),
        shouldFetchStatistics: o && null != l && M.A.shouldFetchStatisticsForApplication(l),
        sku: n,
        ...
        matureAgree: w.A.didMatureAgree,
        theme: P.A.theme,
