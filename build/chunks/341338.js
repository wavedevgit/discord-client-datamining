/** chunk id: 341338 params = (module,exports,require) **/
n.d(t, {
    A: () => ec
...
class ed extends r.PureComponent {
    ...
    componentDidMount() {
        ...
        (null == t || t.isSlimDirectoryVersion()) && a(), null != e && (n || r || (0, m.LM)(e.applicationId), i && h.h.wait(() => (0, _.n)(e.applicationId))), this.trackViewed(), this.replaceUrlWithSlug()
    }
    ...
    componentWillUnmount() {
        ...
        null != t && B.default.track(el.HAw.STORE_LISTING_EXITED, {
            load_id: e,
    ...
    trackCarouselScroll = (e, t, n) => {
        ...
        null != i && B.default.track(el.HAw.STORE_LISTING_MEDIA_SCROLLED, {
            ...(0, y.A)(i),
            card_index: n,
    ...
    renderHeaderToolbar = (e, t) => {
        ...
        return (0, i.jsxs)("div", {
            ...
            children: [(0, i.jsx)("div", {
                className: eo.ND,
                children: n && null != t ? (0, i.jsx)(en.A, {
                    size: en.J.Sizes.MIN,
                ...
                children: (0, i.jsxs)("div", {
                    ...
                    children: [null != t ? (0, b.A)(t) : null, null != e && null != t ? (0, i.jsx)("div", {
                        children: "deprecated!"
                    }) : null, (0, i.jsx)(Z.A, {
                        messageStyle: Z.g.SHORT,
                        className: eo.Mb
                    })]
                })
            }), this.renderCopyLink()]
    ...
    renderHeaderAssets(e, t, n) {
        ...
        return null == l || null == a ? (0, i.jsx)("div", {
            ...
            children: [(0, i.jsx)("div", {
                className: eo.y2,
                style: {
                    backgroundImage: `url(${(0,Y.YE)(e.id,l,1024,"png")})`
                }
            }), (0, i.jsx)("img", {
                className: eo.nu,
                src: (0, Y.YE)(e.id, a, 1024, "png"),
                alt: n.name
            })]
        })
    }
    ...
    renderSystemRequirements(e) {
        return null == e.systemRequirements || 0 === Object.keys(e.systemRequirements).length ? null : (0, i.jsx)(et.A, {
            className: eo.wn,
    ...
    renderJsonLD() {
        ...
        null != l && r.push(l), null != t.headerLogoLightTheme && r.unshift((0, Y.YE)(n.id, t.headerLogoLightTheme, 1024, "jpg"));
        let a = x.A.Product({
                name: e.name,
    ...
    renderListing = () => {
        ...
        return null == e || null == n || null == t || t.isSlimDirectoryVersion() ? (0, i.jsx)(S.A, {
            align: S.A.Align.CENTER,
            justify: S.A.Justify.CENTER,
            children: (0, i.jsx)(A.y$y, {})
        }) : r === er.q.SMALL ? this.renderSmall(e, t, n) : this.renderLarge(e, t, n)
    };
    render() {
        let {
            application: e,
        ...
        if (null == e || null == t || null == n || n.isSlimDirectoryVersion()) return (0, i.jsxs)(r.Fragment, {
            children: [this.renderHeader(e, t), (0, i.jsx)(S.A, {
                align: S.A.Align.CENTER,
                justify: S.A.Justify.CENTER,
                children: (0, i.jsx)(A.y$y, {
                    className: eo.u1
        ...
        if (!l && t.showAgeGate) {
            ...
            return (0, i.jsxs)(r.Fragment, {
                children: [(0, i.jsx)(v.HI, {
                    location: e.name
                }), this.renderJsonLD(), this.renderHeader(e, t), (0, i.jsx)(X.A, {
                    game: e
                }), n]
            })
        }
