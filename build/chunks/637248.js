...
function M(e, t, n, r) {
    r = r.toLowerCase();
    let i = (0, A.d)(e),
        s = l.useCallback((e, t) => !(i && e.channel.hasFlag(C.lx.IS_GUILD_RESOURCE_CHANNEL)) && e.channel.type !== R.rbe.GUILD_DIRECTORY && (0 === t.length || a()(t, (0, _.m1)(e.channel, G.default, S.A).toLowerCase()) || e.channel.topic.toLowerCase().includes(t)), [i]);
    return l.useMemo(() => {
        let e = {
            null: [],
            _categories: []
        };
        return n[R.rbe.GUILD_CATEGORY].forEach(n => {
            let {
                channel: l
            } = n;
            "null" === l.id && (e.null = t.null.filter(e => s(e, r))), e[l.id] = t[l.id].filter(e => s(e, r))
        }), e._categories = t._categories.filter(t => "null" === t.channel.id || 0 === r.length || e[t.channel.id].length > 0), (0, c.A)(e._categories, e).forEach(x), e
    }, [t, n, s, r])
}
...
function U(e, t) {
    ...
    (0, T.y)(e, t), (0, u.Uq)(t.map(e => ({
        channelId: e,
        readStateType: D.P.CHANNEL,
        messageId: m.Ay.lastMessageId(e)
