/** chunk id: 566857, original params: t,e,l (module,exports,require) **/
l.d(e, {
    default: () => L
}), l(321073);
var i = l(627968),
...
function L(t) {
    let {
        ...
        connection: L,
        index: T
    } = t, C = (0, c.Ay)(), N = null != L && null != T, O = A.A.getGuildId(), m = (0, s.bG)([g.A], () => g.A.getAllowedApplicationIds(O) ?? [], [O]);
    n.useEffect(() => {
        null != O && (0, I.$)(O)
    }, [O]), n.useEffect(() => {
        for (let t of m) null != u.A.getApplication(t) || u.A.isFetchingApplication(t) || (0, p.TA)(t).catch(() => {})
    }, [m]);
    let E = (0, s.yK)([u.A], () => {
            let t = [];
            for (let e of m) {
        ...
        P = n.useMemo(() => {
            ...
            for (let e of d.A.filter(t => t.enabled && !x.tb.has(t.type))) {
                ...
                t.push({
                    label: e.name,
                    value: `provider:${e.type}`,
                    icon: l
                })
            }
            for (let e of E) t.push({
                label: e.name,
                value: `app:${e.id}`,
                icon: e.getIconURL(128)
            });
            for (let e of m) null == u.A.getApplication(e) && u.A.isFetchingApplication(e) && t.push({
                label: "Loading...",
                value: `app:${e}`,
                icon: void 0
            });
        ...
        F = n.useCallback(t => (0, i.jsxs)("div", {
            style: {
                display: "flex",
                alignItems: "center",
                gap: "8px"
            },
            children: [t.icon ? "string" == typeof t.icon ? (0, i.jsx)("img", {
                src: t.icon,
                alt: "",
                width: 20,
                height: 20
        ...
        U = n.useCallback(t => {
            ...
            return (0, i.jsxs)("div", {
                ...
                children: [e.icon && "string" == typeof e.icon ? (0, i.jsx)("img", {
                    src: e.icon,
                    alt: "",
                    width: 20,
                    height: 20
    ...
    return (0, i.jsx)(r.Modal, {
        ...
        actions: [{
            ...
            variant: "primary",
            text: N ? f.intl.string(f.t["R3BPH+"]) : f.intl.string(f.t.qMOnJu),
            onClick: R
        }],
        children: (0, i.jsxs)("div", {
            ...
            children: [!N && (0, i.jsxs)(i.Fragment, {
                children: [(0, i.jsx)(a.Text, {
                    ...
                    className: S.sO,
                    children: j.map((t, e) => (0, i.jsxs)("div", {
                        className: S.Ff,
