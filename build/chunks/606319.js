/** chunk id: 606319 params = (module,exports,require) **/
i.d(e, {
    A: () => x
});
var n = i(627968),
...
function G(t) {
    let {
        ingress: e,
        guildId: i
    } = t, R = (0, g.q9)(), G = S.$s.useSetting().includes(i), x = (0, o.K)(), p = (0, A.e)(), h = (0, s.uM)(), U = l.useCallback(t => {
        let n = (0, u.Tb)();
        t ? n.delete(i) : n.add(i), S.$s.updateSetting(Array.from(n)), a.default.track(f.HAw.USER_SERVER_PRIVACY_SETTINGS_ACTION, {
