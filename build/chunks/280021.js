/** chunk id: 280021, original params: e,t,a (module,exports,require) **/
a.d(t, {
    A: () => v
});
var r = a(627968),
...
function v(e) {
    ...
    let L = {
        ...
        q = k.intl.formatToPlainString(b.default["5HQUzD"], {
            boostCount: A.cost
        }),
        z = M && P ? (0, r.jsx)(o.m_, {
            text: q,
    ...
    return (0, r.jsxs)(i.kpP, {
        ...
        title: A.title,
        subtitle: {
            text: (t = A.skuId, a = I.y7[t] ?? f.TVA.NONE, n = f.M2T[a], k.intl.formatToPlainString(k.t["pob/cL"], {
                subscriptions: n
            })),
            leadingIcon: x
        },
