/** chunk id: 299921 params = (module,exports,require) **/
n.d(e, {
    A: () => T
});
var s = n(627968),
...
function g() {
    return (0, s.jsxs)("div", {
        ...
        children: [(0, s.jsx)(r.lmn, {
            color: r.LU0.colors.TEXT_BRAND
        }), (0, s.jsx)(r.Text, {
...
function T(t) {
    let {
        ...
        senderId: i,
        safetyWarning: p
    } = t, T = a.useMemo(() => p?.feedback_type === _.fy.UPVOTE, [p]), h = a.useMemo(() => p?.feedback_type === _.fy.DOWNVOTE, [p]), b = a.useCallback((t, a) => {
        p?.feedback_type !== t && ((0, d.v2)(e, n, t), (0, r.showToast)((0, r.createToast)(x.intl.string(x.t["gd/Yqs"]), r.ToastType.CUSTOM, {
            component: (0, s.jsx)(g, {})
        })), (0, u._$)({
            channelId: e,
            warningId: n,
