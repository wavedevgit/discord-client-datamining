/** chunk id: 930345 params = (module,exports,require) **/
n.d(t, {
    default: () => k
});
var l = n(627968),
...
function k(e) {
    let {
        ...
        ...k
    }), j = (0, o.bG)([g.A], () => g.A.getGuild(s)), I = a.useCallback(e => {
        let t = {};
        return Promise.resolve(c.Ay.getMembers(s).filter(n => {
            ...
            leading: null != t[e.userId] ? (0, l.jsx)(d.JsQ, {
                size: d._3J.SIZE_20,
                src: t[e.userId].getAvatarURL(s, 20),
                "aria-hidden": !0
            }) : void 0
        })))
    }, [s, j]), _ = a.useCallback(e => {
        b(t => ({
            ...t,
            authorIds: null != e ? [e] : []
        }))
        ...
        f(C), n()
    }, [n, f, C]), S = a.useCallback(() => {
        f(null), n()
    }, [f, n]), T = C.authorIds[0] ?? "", A = function(e) {
        if (null == e.message || 0 === e.message.length) return null;
        if (null == e.authorIds || 0 === e.authorIds.length)
            if (e.message.length < u.Fi) return p.intl.formatToPlainString(p.t.Lj831L, {
                minLength: u.Fi
            });
            else return p.intl.string(p.t["4m7gtn"]);
        return e.message.length < u.Fi ? p.intl.formatToPlainString(p.t.TJGHXt, {
            minLength: u.Fi
        }) : null
    }(C), w = a.useMemo(() => [{
