...
let I = ["high", "medium", "low"],
    C = l.memo(function(e) {
        let {
            ...
            var n;
            return e.severity === (n = t.flagged_summary_details.map(e => e.severity), I.find(e => n.includes(e)) ?? null)
        ...
        return (0, i.jsxs)(a.DUT, {
            ...
            children: [(0, i.jsxs)("div", {
                ...
                children: [(0, i.jsx)(a.Text, {
                    ...
                    size: "sm",
                    onClick: e => {
                        e.stopPropagation(), (0, u.C)(JSON.stringify(t, null, 2), () => (0, a.showToast)((0, a.createToast)("Copied conversation JSON", a.ToastType.SUCCESS)))
                    }
                })]
            }), (0, i.jsxs)(a.Text, {
                variant: "text-xs/normal",
