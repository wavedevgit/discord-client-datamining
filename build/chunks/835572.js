...
function L(e) {
    let {
    ...
    } = (0, n.Ay)(...j ?? []), R = s.useRef(null), {
        isHoveringOrFocusing: y
    } = (0, l.A)(R), O = A && (0, I.ki)(i, g.WN[t.skuId]), {
        label: _,
        icon: b
    } = (0, c.h)({
        sku: t.sku,
        ...
        A ? ((0, h.closeUserProfileModal)(), (0, o.x)()) : (v?.(), (0, u.A)({
            isGift: !0,
            giftRecipient: i,
            giftingOrigin: M,
    ...
    }, [A, i, M, t.skuId, p, v]), T = y && !w && f.has(E), P = s.useCallback(() => (0, r.jsx)("div", {
        className: S.MO,
        children: (0, r.jsx)(a.JY, {
            eventTargetRef: R,
            assetClassName: T ? S.iR : void 0
        })
    }), [T]);
    return (0, r.jsx)(m.A, {
        item: t,
