...
function A(e) {
    let {
    ...
    } = (0, n.Ay)(...j ?? []), O = s.useRef(null), {
        isHoveringOrFocusing: y
    } = (0, l.A)(O), _ = E && (0, I.ki)(i, g.WN[t.skuId]), {
        label: b,
        icon: T
    } = (0, c.h)({
        sku: t.sku,
        ...
        E ? ((0, h.closeUserProfileModal)(), (0, o.pX)(S.BVt.APPLICATION_STORE)) : (C?.(), (0, u.A)({
            isGift: !0,
            giftRecipient: i,
            giftingOrigin: v,
    ...
    }, [E, i, v, t.skuId, R, C]), P = y && !p && f.has(x), N = s.useCallback(() => (0, r.jsx)("div", {
        className: L.MO,
        children: (0, r.jsx)(a.JY, {
            eventTargetRef: O,
            assetClassName: P ? L.iR : void 0
        })
    }), [P]);
    return (0, r.jsx)(m.A, {
        item: t,
