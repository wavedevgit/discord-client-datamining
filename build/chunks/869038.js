/** chunk id: 869038, original params: e,t,l (module,exports,require) **/
l.d(t, {
    A: () => _,
    G: () => E
});
...
async function E(e) {
    ...
    try {
        ...
        return n.application_id === c.FYj && await (0, a.Jp)(n.sku_id), r.h.dispatch({
...
let _ = {
    ...
    async revokeGiftCode(e) {
        ...
        try {
            await n.Bo.del({
                url: c.Rsh.USER_GIFT_CODE_REVOKE(e),
                oldFormErrors: !0,
                rejectWithError: !0
            }), r.h.dispatch({
