...
async function U(e, t, n, i, a) {
    let r = s.aW(e, n);
    null !== r && (null == P && w(), t ? await (0, v.pr)() : R?.removeEventListener("end", v.pr), r.addEventListener("end", v.pr), null != i && r.addEventListener("start", i), null != a && r.addEventListener("end", a), R = r, s.wz(r, P))
}
...
function B(e) {
    let {
        message: t,
        channel: n
    } = e, i = t.type === y.lAJ.REPLY ? c.A.getMessageByReference(t.messageReference) : null, a = i?.state === c.a.LOADED ? i?.message?.author : null, r = null != a ? g.Ay.getNick(n.guild_id, a?.id) ?? x.Ay.getName(a) : null, l = n.getGuildId(), s = g.Ay.getNick(l, t.author.id) ?? x.Ay.getName(t.author);
    return G(M(t.content, s, l, r), !0, n.id, t.id), !0
}
...
function H(e) {
    ...
    let r = T.A.getChannelId(),
        l = h.Ay.getCurrentSidebarChannelId(r),
        s = t === r || t === l,
        o = A.on.getSetting() && n.tts && s,
        d = f.A.getTTSType(),
        c = n.author?.id !== _.default.getId() && (d === y.aVn.ALL_CHANNELS || d === y.aVn.SELECTED_CHANNEL && s);
    if ((o || c) && !C.A.isBlockedOrIgnoredForMessage(n)) {
        ...
        G(M(n.content, i, e, l), !1, a.id, n.id, 200)
    }
    return !1
}
