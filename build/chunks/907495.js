...
let ei = l.memo(function(e) {
    let {
        ...
        guildId: t.guild_id
    })), s = (l.length >= 3 ? l : [...(0, _.A)(l.concat(ee)).values()]).slice(0, 3), a = n.reactions.filter(e => e.me);
        ...
        children: s.map(e => {
            let l = a.find(t => (0, N.i6)(t.emoji, (0, N.jq)(e))),
                ...
                o = null != l ? X.intl.formatToPlainString(X.t.vjeruO, {
                    emojiName: r
                }) : X.intl.formatToPlainString(X.t.L1JQwE, {
                    emojiName: r
                });
            return (0, i.jsx)(z.qv, {
...
function el(e) {
    let {
        ...
        let {
            ...
            author: u
        } = n, h = (0, d.bG)([L.A], () => L.A.getGuild(t.guild_id), [t.guild_id]), g = (0, d.bG)([D.default], () => D.default.getId()), p = (0, R.Id)(t), _ = (0, R.s5)(t), {
            firstMessage: x
        } = (0, d.bG)([f.A], () => f.A.getMessage(t.id), [t.id]), C = M.jW.useSetting(), S = M.Q_.useSetting(), T = (0, d.bG)([P.A], () => null == t.guild_id || P.A.canChatInGuild(t.guild_id), [t]), {
            canManageMessages: N,
            canAddNewReactions: v
        } = (0, d.cf)([k.A], () => ({
            canAddNewReactions: T && k.A.can($.xBc.ADD_REACTIONS, t),
            canManageMessages: k.A.can($.xBc.MANAGE_MESSAGES, t)
        }), [t, T]), O = (0, y.u)(t, n), w = (0, R.n)(t, n), G = (0, R.R)(n), F = (0, d.bG)([I.A], () => null != t.guild_id && I.A.isLurking(t.guild_id), [t]), z = u.id === g, q = (N || n.canDeleteOwnMessage(g)) && p && !$.MRS.UNDELETABLE.has(n.type);
        n.type === $.lAJ.AUTO_MODERATION_ACTION && (q = q && N), t.isModeratorReportChannel() && (q = q && n.id !== x?.id && !(0, K.A)(n));
        let Y = (0, B.ul)(n),
            J = (0, V.A)(n, t),
            Z = !t.isSystemDM() && (0, H.A)(n, g) && p && !_,
            {
    ...
    return (0, i.jsxs)(i.Fragment, {
        children: [v ? (0, i.jsxs)(i.Fragment, {
            ...
            }, "copy-id") : null, s ? (0, i.jsx)(z.qv, {
                label: X.intl.string(X.t.WqhZss),
                icon: u.qYV,
                onClick: () => (0, q.S)(t, n)
            }, "copy-link") : null, _ ? (0, i.jsx)(z.qv, {
                label: X.intl.string(X.t.NpHUi1),
                icon: u.cBN,
                onClick: () => (0, q.vc)(t)
            }, "configure") : null, ea ? (0, i.jsx)(z.qv, {
                label: X.intl.string(X.t.RpE9k7),
                icon: u.QTh,
                onClick: () => (0, q.cl)(t, n)
            }, "mark-unread") : null, F ? (0, i.jsx)(z.qv, {
                label: J ? X.intl.string(X.t.LHUP9D) : X.intl.string(X.t["9p3D9p"]),
                icon: J ? u.cFy : u.c$8,
                onClick: () => J ? (0, q.r7)(t, n) : (0, q.wF)(t, n)
            }, "bookmark") : null, a ? (0, i.jsx)(z.qv, {
        ...
        }) : null, C && !h ? (0, i.jsx)(z.qv, {
            label: X.intl.string(X.t["5IEsGx"]),
            icon: u.W4J,
            onClick: e => (0, q.$b)(t, n, e)
        }, "reply-other") : null, h ? (0, i.jsx)(z.qv, {
            ...
            onClick: () => (0, q.Le)(t, n),
            disabled: eo
        }, "publish") : null, r && v ? (0, i.jsx)(z.qv, {
            label: X.intl.string(X.t.oyYWHE),
            icon: u.ucK,
            onClick: e => (0, q.RC)(t, n, e),
            dangerous: !0,
            separator: !v
        }, "delete") : null, v && r ? null : (0, i.jsx)(u.YNO, {
            targetElementRef: et,
            renderPopout: e => {
                let {
                    updatePosition: l,
...
function es(e) {
    let {
        channel: t,
        message: n
    } = e, l = (0, d.bG)([C.A], () => null != C.A.getMessage(n.id), [n.id]), s = null == n.interaction || null != n.interactionData && (0, S.Bl)(n.interactionData);
    return (0, i.jsxs)(i.Fragment, {
        children: [!l && s && (0, i.jsx)(z.qv, {
            label: X.intl.string(X.t["5911Lb"]),
            icon: u.mqY,
            onClick: () => (0, q.Io)(t, n)
        }, "retry"), (0, i.jsx)(z.qv, {
            label: X.intl.string(X.t.oyYWHE),
...
let eo = l.memo(function(e) {
    let {
        ...
        return n.state === $.cmJ.SEND_FAILED ? (0, i.jsx)(es, {
            channel: t,
            message: n
        }) : null
    }(e), c = function(e) {
        ...
        return t.state !== $.cmJ.SEND_FAILED ? (0, i.jsx)(el, {
            ...e
        }) : null
    }(e);
