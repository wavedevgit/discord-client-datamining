...
function ea(e) {
    let {
        ...
        let J = (0, H.ul)(n),
            ...
            ee = t.type === X.rbe.GUILD_ANNOUNCEMENT && null != h && h.features.has(X.GuildFeatures.NEWS) && (B || N) && (0, g.A)(n),
            et = t.getGuildId(),
...
let ed = l.memo(function(e) {
    let {
        ...
        isHeader: l,
        isReply: s
    } = e, r = (0, d.bG)([L.A], () => L.A.isEditing(t.id, n.id), [t.id, n.id]), o = function(e) {
        let {
            channel: t,
            message: n
        } = e;
