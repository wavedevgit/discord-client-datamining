...
function el(e) {
    let {
        ...
        }), [t, N]), O = (0, y.u)(t, n), w = (0, R.n)(t, n), G = (0, R.R)(n), F = (0, d.bG)([T.A], () => null != t.guild_id && T.A.isLurking(t.guild_id), [t]), z = u.id === g, q = (I || n.canDeleteOwnMessage(g)) && p && !$.MRS.UNDELETABLE.has(n.type);
