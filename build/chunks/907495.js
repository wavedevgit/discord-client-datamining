/** chunk id: 907495 params = (module,exports,require) **/
n.d(t, {
    A: () => ed
});
var i = n(627968),
...
let es = l.memo(function(e) {
    let {
        channel: t,
        message: n
    } = e, l = (0, _.QZ)(t.guild_id).filter(e => !F.Ay.isEmojiFilteredOrLocked({
        emoji: e,
        channel: t,
    ...
    return (0, i.jsx)(i.Fragment, {
        children: s.map(e => {
            let l = a.find(t => (0, v.i6)(t.emoji, (0, v.jq)(e))),
                ...
                o = null != l ? ee.intl.formatToPlainString(ee.t.vjeruO, {
                    emojiName: r
                }) : ee.intl.formatToPlainString(ee.t.L1JQwE, {
                    emojiName: r
                });
            return (0, i.jsx)(J.qv, {
...
function ea(e) {
    let {
        ...
        }), [t, I]), y = (0, b.u)(t, n), O = (0, M.n)(t, n), k = (0, M.R)(n), F = (0, d.bG)([T.A], () => null != t.guild_id && T.A.isLurking(t.guild_id), [t]), H = u.id === m, J = (N || n.canDeleteOwnMessage(m)) && _ && !X.MRS.UNDELETABLE.has(n.type);
        n.type === X.lAJ.AUTO_MODERATION_ACTION && (J = J && N), t.isModeratorReportChannel() && (J = J && n.id !== f?.id && !(0, z.A)(n));
        let q = (0, B.ul)(n),
            $ = (0, K.A)(n, t),
            ...
            ee = t.type === X.rbe.GUILD_ANNOUNCEMENT && null != h && h.features.has(X.GuildFeatures.NEWS) && (H || N) && (0, g.A)(n),
            et = t.getGuildId(),
            en = null != et && n.type === X.lAJ.USER_JOIN && U.A.canWithPartialContext(X.xBc.MANAGE_GUILD, {
                guildId: et
            }),
            ei = (0, C.m)(n),
        ...
        H || k.default.track(X.HAw.MESSAGE_POPOUT_MENU_OPENED_DESKTOP, {
            message_id: n.id,
    ...
    return (0, i.jsxs)(i.Fragment, {
        children: [F ? (0, i.jsxs)(i.Fragment, {
        ...
        }) : null, S && !m ? (0, i.jsx)(J.qv, {
            label: ee.intl.string(ee.t["5IEsGx"]),
            icon: u.W4J,
            onClick: e => (0, q.$b)(t, n, e)
        }, "reply-other") : null, m ? (0, i.jsx)(J.qv, {
            label: ee.intl.string(ee.t.bt75uw),
            icon: u.R2l,
            onClick: () => (0, q.u_)(t, n)
        }, "edit") : null, v ? (0, i.jsx)(J.qv, {
            label: ee.intl.string(ee.t.I3ltXO),
            icon: x.A,
            onClick: () => (0, q.Z4)(t, n)
        }, "forward") : null, I && !v ? (0, i.jsx)(J.qv, {
            label: ee.intl.string(ee.t.rBIGBL),
            icon: u.ysw,
            onClick: () => (0, q.Nw)(t, n)
        }, "thread") : null, !I && N ? (0, i.jsx)(J.qv, {
            label: ee.intl.string(ee.t["39d0Wj"]),
            icon: u.ysw,
            onClick: () => (0, q.mF)(t, n)
            ...
            onClick: () => (0, q.Le)(t, n),
            disabled: eh
        }, "publish") : null, r && F ? (0, i.jsx)(J.qv, {
            label: ee.intl.string(ee.t.oyYWHE),
            icon: u.ucK,
            onClick: e => (0, q.RC)(t, n, e),
            dangerous: !0,
            separator: !F
        }, "delete") : null, F && r ? null : (0, i.jsx)(u.YNO, {
            targetElementRef: er,
            renderPopout: e => {
                let {
                    updatePosition: l,
...
function er(e) {
    let {
        channel: t,
        message: n
    } = e, l = (0, d.bG)([S.A], () => null != S.A.getMessage(n.id), [n.id]), s = null == n.interaction || null != n.interactionData && (0, I.Bl)(n.interactionData);
    return (0, i.jsxs)(i.Fragment, {
        children: [!l && s && (0, i.jsx)(J.qv, {
            label: ee.intl.string(ee.t["5911Lb"]),
            icon: u.mqY,
            onClick: () => (0, q.Io)(t, n)
        }, "retry"), (0, i.jsx)(J.qv, {
            label: ee.intl.string(ee.t.oyYWHE),
...
let ed = l.memo(function(e) {
    let {
        ...
        return n.state === X.cmJ.SEND_FAILED ? (0, i.jsx)(er, {
            channel: t,
            message: n
        }) : null
    }(e), c = function(e) {
        ...
        return t.state !== X.cmJ.SEND_FAILED ? (0, i.jsx)(ea, {
            ...e
        }) : null
    }(e);
    return r || null == o && null == c ? null : (0, i.jsx)("div", {
