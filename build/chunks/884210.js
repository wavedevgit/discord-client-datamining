/** chunk id: 884210 params = (module,exports,require) **/
n.d(t, {
    J3: () => I,
    sB: () => L
});
var i = n(627968),
    ...
    N = n(254604);
let I = () => {
    (0, g.Dr)(r.M.CLIENT_THEMES_SPARKLE_PREVIEW, {
        dismissAction: b.i.PRIMARY,
        forceTrack: !0
    }), (0, m.nf)(m.HP.CLIENT_THEMES), (0, f.default)()
};

function j() {
    let e = (0, _.O)(),
        t = (0, A.U9)(e, C.pe.TIER_2) ? v.intl.formatToPlainString(v.t.bkQ4bH, {
...
function O(e) {
    let {
        children: t
    } = e, n = (0, l.bG)([c.A], () => c.A.isPreview), {
        analyticsLocations: r
    } = (0, d.Ay)(o.A.USER_SETTINGS);
    return (s.useEffect(() => {
        n && T.default.track(S.HAw.PREMIUM_UPSELL_VIEWED, {
...
function R() {
    ...
    return e && t ? (0, i.jsxs)("div", {
        children: [(0, i.jsx)("div", {
            ...
            type: C.e.PREMIUM_CLIENT_THEME_SETTINGS_UPSELL,
            subscriptionTier: C.pe.TIER_2
        })]
    }) : null
}
