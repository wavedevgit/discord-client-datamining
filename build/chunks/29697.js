...
let P = e => {
    ...
    D = e => {
        ...
        s.useEffect(() => {
            ...
            null != F && g.default.track(b.HAw.OPEN_MODAL, {
                type: A.mk,
                guild_id: F
            })
        }, [F]);
        ...
        let eh = ec?.verified,
            ...
            eN = (t = k?.brandColorPrimary ?? "", n = (0, a.rdh)(a.LU0.colors.BORDER_SUBTLE).hex(), `linear-gradient(-45deg, ${n}, ${t})`);
