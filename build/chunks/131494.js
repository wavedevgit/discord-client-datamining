...
function b(e) {
    let t = (0, s.bG)([C.Ay], () => C.Ay.isMuted(e)),
        ...
        b = (0, l.Gp)(N),
        {
            ...
            return {
                guildHasVoice: (() => {
                    if (t) return !1;
                    for (let e in l)
                        if (S(m.A.getBasicChannel(l[e].channelId), i ?? void 0, _.A)) return !0;
                    return !1
                })(),
                guildHasVideo: (() => {
                    if (t) return !1;
        ...
        j = p.default.getId();
    return (0, s.cf)([x.A, m.A, a.Ay, u.A, A.A, _.A], () => {
        let s = x.A.getVoiceChannelId(),
            l = m.A.getChannel(s)?.guild_id === e,
            c = !1,
            p = !1,
            g = !1,
            f = !1,
        ...
        return l ? (c = !0, p = n?.channel_id === s, g = S, f = L, C = R, E = D) : (c = T, p = null != n, g = N, f = v, C = O, E = M), {
            audio: c,
            video: f,
            screenshare: C,
            liveStage: g,
