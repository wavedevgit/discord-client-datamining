...
function S(e) {
    let t = (0, s.bG)([C.Ay], () => C.Ay.isMuted(e)),
        ...
        S = (0, l.Gp)(N),
        {
            ...
            return {
                guildHasVoice: (() => {
                    if (t) return !1;
                    for (let e in l)
                        if (b(g.A.getBasicChannel(l[e].channelId), i ?? void 0, _.A)) return !0;
                    return !1
                })(),
                guildHasVideo: (() => {
                    if (t) return !1;
        ...
        j = m.default.getId();
    return (0, s.cf)([x.A, g.A, a.Ay, u.A, A.A, _.A], () => {
        ...
        let N = I.default.keys(u.A.getStageInstancesByGuild(e)).some(e => {
            ...
            b = l && (g.A.getChannel(s)?.isGuildStageVoice() ?? !1),
            ...
            M = (() => {
                ...
                for (let e of i) {
                    let t = g.A.getChannel((0, r.H)(e.location));
                    if (null != t && (0, h.gV)(t.type)) return !0
                }
                return !1
            })(),
            D = a.Ay.getEmbeddedActivitiesForGuild(e).length > 0;
        return l ? (c = !0, m = n?.channel_id === s, p = b, f = L, C = R, E = D) : (c = T, m = null != n, p = N, f = v, C = O, E = M), {
            audio: c,
            video: f,
            screenshare: C,
            liveStage: p,
