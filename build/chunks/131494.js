...
function b(e) {
        ...
        b = (0, l.Gp)(N),
        {
            ...
            return {
                guildHasVoice: (() => {
                    if (t) return !1;
                    for (let e in l)
                        if (S(p.A.getBasicChannel(l[e].channelId), i ?? void 0, _.A)) return !0;
                    return !1
                })(),
                guildHasVideo: (() => {
                    if (t) return !1;
    ...
    return (0, s.cf)([x.A, p.A, r.Ay, u.A, A.A, _.A], () => {
        ...
        let N = I.default.keys(u.A.getStageInstancesByGuild(e)).some(e => {
            ...
            S = l && (p.A.getChannel(s)?.isGuildStageVoice() ?? !1),
        ...
        return l ? (c = !0, m = n?.channel_id === s, g = S, f = L, C = R, E = D) : (c = T, m = null != n, g = N, f = v, C = O, E = M), {
            audio: c,
            video: f,
            screenshare: C,
            liveStage: g,
