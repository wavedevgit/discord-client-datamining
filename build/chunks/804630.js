...
function p(e, t, i) {
    ...
    return null != t && (0, r.A)(t) ? {
        ...
        rawActivity: t,
        userId: e
    } : null != i ? (n = t?.type === m.$pd.WATCHING ? m.$pd.WATCHING : m.$pd.PLAYING, {
        isSpotify: !1,
        isEmbedded: !0,
        isGame: !1,
        ...
        embeddedIconUrl: u.Ay.getApplicationIconURL({
            id: i.application.id,
...
function h(e) {
    let {
        resolvedActivity: t
    } = e, i = (0, a.bG)([o.A], () => null != t.applicationId ? o.A.getApplication(t.applicationId) : null, [t.applicationId]), {
        assets: s,
        isGame: r,
        isEmbedded: u
    } = t;
    if (null == s || null == s.large_image && null == s.small_image) return u && null != t.embeddedIconUrl ? (0, n.jsx)(l.m, {
