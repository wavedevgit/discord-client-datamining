...
function N(e, t, n) {
    ...
    return null != t && (0, c.A)(t) ? {
        ...
        rawActivity: t,
        userId: e
    } : null != n ? (i = t?.type === x.$pd.WATCHING ? x.$pd.WATCHING : x.$pd.PLAYING, {
        isSpotify: !1,
        isEmbedded: !0,
        isGame: !1,
        ...
        embeddedIconUrl: f.Ay.getApplicationIconURL({
            id: n.application.id,
...
function T(e) {
    let {
        ...
        userId: _,
        rawActivity: f
    } = t, x = l?.large_image ?? l?.small_image;
    return (0, i.jsxs)("div", {
        className: I.ec,
...
function b(e) {
    ...
    return n && l?.start != null ? (0, i.jsx)(_.Ay, {
        start: l.start,
