...
function k(e) {
    let {
        ...
        onClose: o,
        transitionState: d
    } = e, c = G.intl.format(G.t.otHdfR, {
        endDate: t.currentPeriodEnd
    });
    t.isPurchasedExternally && null != t.paymentGateway ? c = G.intl.format(G.t.HbpFLg, {
        paymentGatewayName: D.qm[t.paymentGateway],
        subscriptionManagementLink: (0, O.tW)(t.paymentGateway, "SUBSCRIPTION_MANAGEMENT")
    }) : t.isPausedForFractionalPremium ? c = G.intl.format(G.t.Hzqe6y, {
        expirationDate: n.endsAt.toDate()
    }) : s && (c = G.intl.format(G.t.gXSnul, {
        endDate: t.currentPeriodEnd
    }));
...
async function U(e, t, n, i) {
    ...
    let o = (0, O.aE)(e, t);
    await (0, u.HJ)(a), await (0, _.nV)(e, {
        items: o
    }, {
        amount: 0,
        currency: e.currency
    }, (0, O.UC)(o, e.currency, e.paymentSourceId), n)
}
...
function w(e) {
    let {
        ...
        onNext: _,
        onClose: x
    } = e, [S, E] = s.useState(!1), [N, j] = s.useState(null), [y, D] = s.useMemo(() => {
        try {
            return [(0, f.v)(t, -1), !1]
        } catch {
            return [
    ...
    let {
        ...
        return {
            ...
            premiumGuildPlan: null != e ? I.A.getForSkuAndInterval((0, O.mH)(P.pe.GUILD), e.interval, e.intervalCount) : null
        }
    }), {
    ...
    }), H = null != V ? (0, O.Om)(t, y[0]?.quantity ?? 0, V.id) : null, [z] = (0, T.Kq)({
        subscriptionId: t.id,
        items: H,
        renewal: !0,
        analyticsLocations: B,
    ...
    let X = t.items.some(e => {
        ...
        Q = G.intl.format(G.t["0W23cu"], {
            endDate: z.subscriptionPeriodStart
        });
    t.isPausedForFractionalPremium && l.fetched && (Q = G.intl.format(G.t.eb0xgS, {
        ...
        children: [(0, i.jsx)(h.e0, {
            ...
            children: (0, i.jsxs)("div", {
                ...
                children: [null !== N && (0, i.jsx)("div", {
                    ...
                    className: M.S,
                    children: [(0, i.jsx)(b.Xd, {
                        children: G.intl.string(G.t.iqhIp4)
                    }), (0, i.jsx)(b.oR, {
                        label: G.intl.format(G.t["Vg+LRr"], {
                            subscriptionCount: 1
                        }),
                        value: (0, R.CE)((0, R.$g)(W, t.currency), Z, q),
                        className: M.Au
                    }), null != H && H.length > 0 ? (0, i.jsxs)("div", {
                        children: [(0, i.jsx)(b.pK, {}), (0, i.jsx)(v.m0, {
                            premiumSubscription: t,
                            renewalInvoice: z,
                            isUpdate: !0
                        })]
    ...
    return (0, i.jsx)(a.Modal, {
        ...
        children: (0, i.jsxs)("div", {
            ...
            children: [s && (0, i.jsx)("div", {
                ...
                children: G.intl.format(G.t["H+z0ns"], {
                    endDate: o
                })
            })]
        })
