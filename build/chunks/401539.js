/** chunk id: 401539, original params: e,t,i (module,exports,require) **/
i.d(t, {
    default: () => q
}), i(321073);
var n = i(627968),
...
function W(e) {
    ...
    } = e, a = t?.selected_time_window ?? P.Xx.ALWAYS;
    return null == s ? null : (0, n.jsxs)("div", {
        className: Y.bj,
        children: [(0, n.jsxs)(m.BJc, {
            gap: 20,
            children: [(0, n.jsx)(m.dOG, {
                ...
                onSelectionChange: e => {
                    ...
                    A.A.updateGuildNotificationSettings(s.id, {
                        muted: !0,
                        mute_config: {
...
function z(e) {
    let {
        guildId: t
    } = e, i = (0, v._g)(t), s = (0, c.bG)([b.A], () => b.A.getGuildAlertSettings()[t]);
    if (i) return (0, n.jsxs)("div", {
        className: Y.YK,
        children: [(0, n.jsx)(m.lVW, {
            className: Y.bj,
...
function Z(e) {
    ...
    } = e, g = s.useMemo(() => new Set([...t, ...(0, R.ct)(i)]), [i, t]), h = (0, m.rdh)(u.A.unsafe_rawColors.GREEN_360).hex(), A = e => {
        let i = new Set(t);
        i.delete(e), d(i)
    }, j = l.map(e => {
        let {
    ...
    return (0 === g.size || 0 === j.length) && j.push((0, n.jsx)("div", {
        className: Y.uZ,
        children: (0, n.jsx)(m.Text, {
            className: Y.sr,
    ...
    }, "placeholder")), (0, n.jsxs)(n.Fragment, {
...
function Q(e) {
    let {
        ...
        onClose: i,
        transitionState: l
    } = e, a = (0, c.bG)([E.A], () => E.A.getCategories(t)), r = (0, c.bG)([O.A], () => O.A.getGuild(t)), d = (0, c.bG)([C.A], () => C.A.getMemberCount(t)), {
        suppressEveryone: u,
        suppressRoles: g,
        muteEvents: h,
        mobilePush: x,
    ...
    })), [b, f] = s.useState(new Set), [G, M] = s.useState(null), L = s.useMemo(() => (0, j.A)(a._categories, a, e => {
        let {
            channel: {
                type: t
            }
...
function q(e) {
    ...
    return (0, R.os)("NotificationSettingsModal") ? (0, n.jsx)(U.A, {
        ...t
    }) : (0, n.jsx)(Q, {
        ...t
    })
