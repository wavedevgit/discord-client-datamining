...
function U(e) {
    ...
    let Z = (0, h.GV)(),
        ...
        q = $ > 0;
    if (n.useEffect(() => {
            q && M?.code != null && I.default.track(L.HAw.INVITE_FRIEND_MEMBERS_VIEWED, {
                invite_code: M?.code,
                guild_id: M.guild?.id,
                friend_count: $
            })
        }, [q, $, M?.code, M?.guild?.id]), null == M || null == k) return null;
    if (M.state === L.elq.EXPIRED || M.state === L.elq.BANNED || M.state === L.elq.ERROR) return (0, l.jsx)(O, {
        transitionState: G
    });
    ...
    let {
        ...
        channel: ei,
        inviter: el,
        target_application: en
    } = M, ea = null == M.guild && null == M.channel && null != el, es = null != et;
    if (null != en) t = et?.name, i = j.Ay.createFromServer(en).getCoverImageURL(1024);
    else if (null != et) t = et.name, i = f.Ay.getGuildSplashURL({
        id: et.id,
        splash: et.splash
    });
    else if ((null == (t = ei.name) || "" === t) && null != el && (t = el.username), null == t) throw Error("no name for group DM invite");
    let er = (0, A.Sn)();
    if (U = ea ? b.intl.string(b.t["e/6Ogt"]) : b.intl.format(b.t["9sWQNT"], {
            usernameHook: () => (0, l.jsx)("span", {
                children: H
            })
        }), W) return (0, l.jsx)(s.dWK, {
        size: "md",
        "aria-labelledby": Z,
        transitionState: G,
    ...
    if (w && null != et) return (0, l.jsx)(g.f5, {
        value: Q,
    ...
    return null != ed && eo && null != et && (N.SH.getConfig({
                        ...
                        children: [(0, l.jsx)("div", {
                            ...
                            children: [er ? (0, l.jsx)(S.A, {}) : null, (0, l.jsxs)(s.BJc, {
                                ...
                                children: [null == en ? (0, l.jsx)(s.$nd, {
                                    ...
                                    icon: er || null == k ? void 0 : () => (0, l.jsx)(c.A, {
                                        "aria-hidden": !0,
                                        size: d._3J.SIZE_16,
                                        user: k,
                                        className: R.Mp
