/** chunk id: 563038 params = (module,exports,require) **/
i.d(t, {
    default: () => k
});
var l = i(627968),
...
function k(e) {
    ...
    let H = (0, _.uE)(),
        ...
        }),
        {
            ...
            discoveryGuild: Z,
            isLoading: K
        } = (0, D.qE)(V?.guild ?? null, "AcceptInviteModal"),
        {
            enabled: Q
        } = D.SH.useConfig({
    ...
    n.useEffect(() => {
        ...
        f.default.track(R.HAw.OPEN_MODAL, {
            type: "Accept Invite",
            invite_code: V?.code,
            guild_id: V?.guild?.id
        })
    ...
    let q = (0, h.GV)(),
        ...
        et = ee > 0;
    if (n.useEffect(() => {
            et && V?.code != null && f.default.track(R.HAw.INVITE_FRIEND_MEMBERS_VIEWED, {
                invite_code: V?.code,
                guild_id: V.guild?.id,
                friend_count: ee
            })
        }, [et, ee, V?.code, V?.guild?.id]), null == V || null == P) return null;
    if (V.state === R.elq.EXPIRED || V.state === R.elq.BANNED || V.state === R.elq.ERROR) return (0, l.jsx)(G, {
        transitionState: M
    });
    ...
    function el() {
        f.default.track(R.HAw.INVITE_ACCEPT_DISMISSED, {
            invite_code: V?.code,
            guild_id: V?.guild?.id
        }), S.A.close()
    }
    ...
    } = V, ed = null == V.guild && null == V.channel && null != es, eo = W && ($?.length ?? 0) > 0 && null != es, ec = null != en || eo;
    if (null != er) t = en?.name, i = j.Ay.createFromServer(er).getCoverImageURL(1024);
    else if (null != en) t = en.name, i = T.Ay.getGuildSplashURL({
        id: en.id,
        splash: en.splash
    });
    else if ((null == (t = ea.name) || "" === t) && null != es && (t = es.username), null == t) throw Error("no name for group DM invite");
    let eu = (0, A.Sn)();
    if (k = ed ? O.intl.string(O.t["e/6Ogt"]) : O.intl.format(O.t["9sWQNT"], {
            usernameHook: () => (0, l.jsx)("span", {
                children: H
            })
        }), K) return (0, l.jsx)(s.dWK, {
        size: "md",
        "aria-labelledby": q,
        transitionState: M,
    ...
    if (J && null != en) return (0, l.jsx)(g.f5, {
        value: X,
    ...
    return null != em && ex && null != en && (D.SH.getConfig({
                    ...
                    children: [eo && (0, l.jsxs)("div", {
                        ...
                        children: [(0, l.jsx)(c.A, {
                            ...
                            children: O.intl.format(O.t.ri1ubC, {
                                usernameHook: (e, t) => (0, l.jsx)(d.Text, {
                        ...
                        children: [(0, l.jsx)("div", {
                            ...
                            children: [eu ? (0, l.jsx)(L.A, {}) : null, (0, l.jsxs)(s.BJc, {
                                gap: 8,
                                align: "center",
                                children: [null == er ? (0, l.jsx)(s.$nd, {
                                    onClick: ei,
                                    loading: Y,
                                    disabled: eu,
                                    variant: "primary",
                                    ...
                                    icon: eu || null == P ? void 0 : () => (0, l.jsx)(c.A, {
                                        "aria-hidden": !0,
                                        size: d._3J.SIZE_16,
                                        user: P,
                                        className: U.Mp
