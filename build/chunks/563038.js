...
function G(e) {
    ...
    let $ = (0, g.GV)(),
        ...
        ee = X > 0;
    if (n.useEffect(() => {
            ee && P?.code != null && I.default.track(L.HAw.INVITE_FRIEND_MEMBERS_VIEWED, {
                invite_code: P?.code,
                guild_id: P.guild?.id,
                friend_count: X
            })
        }, [ee, X, P?.code, P?.guild?.id]), null == P || null == M) return null;
    if (P.state === L.elq.EXPIRED || P.state === L.elq.BANNED || P.state === L.elq.ERROR) return (0, l.jsx)(O, {
        transitionState: k
    });
    ...
    } = P, er = null == P.guild && null == P.channel && null != ea, ed = B && (Q?.length ?? 0) > 0 && null != ea, eo = null != el || ed;
    if (null != es) t = el?.name, i = A.Ay.createFromServer(es).getCoverImageURL(1024);
    else if (null != el) t = el.name, i = f.Ay.getGuildSplashURL({
        id: el.id,
        splash: el.splash
    });
    else if ((null == (t = en.name) || "" === t) && null != ea && (t = ea.username), null == t) throw Error("no name for group DM invite");
    let ec = (0, p.Sn)();
    if (G = er ? R.intl.string(R.t["e/6Ogt"]) : R.intl.format(R.t["9sWQNT"], {
            usernameHook: () => (0, l.jsx)("span", {
                children: w
            })
        }), Z) return (0, l.jsx)(s.dWK, {
        size: "md",
        "aria-labelledby": $,
        transitionState: k,
    ...
    if (W && null != el) return (0, l.jsx)(x.f5, {
        value: q,
    ...
    return null != eu && em && null != el && (y.SH.getConfig({
                ...
                children: [(0, l.jsxs)("div", {
                    ...
                    children: [ed && (0, l.jsxs)("div", {
                        ...
                        children: [(0, l.jsx)("div", {
                            ...
                            children: [ec ? (0, l.jsx)(b.A, {}) : null, (0, l.jsxs)(s.BJc, {
                                gap: 8,
                                align: "center",
                                children: [null == es ? (0, l.jsx)(s.$nd, {
                                    onClick: et,
                                    loading: F,
                                    disabled: ec,
                                    variant: "primary",
                                    ...
                                    icon: ec || null == M ? void 0 : () => (0, l.jsx)(c.A, {
                                        "aria-hidden": !0,
                                        size: d._3J.SIZE_16,
                                        user: M,
                                        className: U.Mp
