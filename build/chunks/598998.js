...
function w() {
    ...
    return (0, s.useMemo)(() => {
        let s = {
                ...
                caption: null != K ? P.intl.formatToPlainString(P.t.Hu4jfi, {
                    date: new Date(K)
                }) : void 0,
                description: null != W ? W.status === I.Wo.UPCOMING ? P.intl.formatToPlainString(P.t.a1eKDi, {
                    days: W.daysLeft
                }) : (0, S.T)(W.id, W.tenureReqNumMonths) : z ? (0, S.T)(j.Ac.PREMIUM_TENURE_1_MONTH, 1) : void 0,
