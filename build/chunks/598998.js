...
function k() {
    ...
    } = (0, c.Ay)(o.A.PREMIUM_MARKETING_PERK_CARD), t = (0, x.O9)(), a = h.A.useExperiment({
    ...
    }, []), H = (0, T.$F)(), B = (0, T.Xb)(), Y = H?.status === T.Wo.UPCOMING, F = (0, S.N)(H?.id), z = (0, E.z)(), {
        currentDate: W,
        nDaysInMonth: K
    } = (0, s.useMemo)(() => {
        let e = new Date;
    ...
    return (0, s.useMemo)(() => {
        let s = {
                ...
                primaryAssetClassName: l()(R.pq, {
                    [R.n6]: Y
                }),
                caption: null != B ? O.intl.formatToPlainString(O.t.Hu4jfi, {
                    date: new Date(B)
                }) : void 0,
                description: null != H ? H.status === T.Wo.UPCOMING ? O.intl.formatToPlainString(O.t.a1eKDi, {
                    days: H.daysLeft
                }) : (0, C.T)(H.id, H.tenureReqNumMonths) : void 0,
                progress: z ?? void 0,
