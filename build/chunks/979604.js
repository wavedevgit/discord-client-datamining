...
let j = Object.freeze({
    [v.Hf6.PLAY]: "play",
    [v.Hf6.INSTALL]: "install",
    [v.Hf6.UPDATE]: "update",
    [v.Hf6.PAUSE]: "downloading",
...
class L extends r.Component {
    ...
    getText(e) {
        switch ("uninstalling" !== e && (this._uninstallStringIndex = null), e) {
            ...
            case "uninstalling":
                let t = [S.intl.string(S.t.r9wmKn), S.intl.string(S.t["6CpimS"]), S.intl.string(S.t.ysbNDc), S.intl.string(S.t["TLnXx/"]), S.intl.string(S.t.Qi8mne), S.intl.string(S.t.yvMu3S), S.intl.string(S.t["PnNUZ/"]), S.intl.string(S.t.hU2TEJ), S.intl.string(S.t["YyY51/"]), S.intl.string(S.t.PbHJb3)];
    ...
    handleAddToLibrary = async () => {
        try {
            ...
            await u.V(e.id, e.branchId, e.getFlags() & ~v.hM6.HIDDEN), (0, h.pX)(v.BVt.APPLICATION_LIBRARY)
        } catch (e) {
    ...
    getButtonState() {
        ...
        return null != i ? i : null != t && t.type === v.WTw.UNINSTALLING ? "uninstalling" : (0, E.isWeb)() ? "play" : "unsupported_os"
    }
    renderPlayButton() {
        let {
            libraryApplication: e,
    ...
    renderProgressBar() {
        ...
        let i = n.type === v.WTw.UNINSTALLING ? c.iCB.INDETERMINATE : C.uA(Number(n.progress), Number(n.total));
    ...
    render() {
        ...
        if ("preorder_wait" === n) {
            let e;
            return this.renderDisabledButton(n, null != (e = I.zJ(t.sku)) ? S.intl.formatToPlainString(S.t.Aqe2ZC, {
                date: e
            }) : null)
        }
        if ("unsupported_os" === n) return this.renderDisabledButton(n, S.intl.formatToPlainString(S.t.LBm0A4, {
            operatingSystem: S.intl.string(S.t["0/xHFO"])
        }));
...
function R(e) {
    let {
        libraryApplication: t
    } = e, n = (0, _.p)(), [i, r] = (0, s.yK)([x.A, f.A], () => [(0, g.F)(t, x.A, f.A), x.A.getState(t.id, t.branchId)], [t]), a = (0, s.bG)([A.A], () => A.A.isSyncing(t.id, t.branchId), [t]), o = (0, s.bG)([p.A], () => p.A.hasNoBuild(t.id, t.branchId), [t]);
    return (0, l.jsx)(L, {
        ...e,
        analyticsContext: n,
        actionState: i,
