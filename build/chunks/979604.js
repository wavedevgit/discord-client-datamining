...
function R(e) {
    let {
        libraryApplication: t
    } = e, n = (0, _.p)(), [i, s] = (0, r.yK)([x.A, f.A], () => [(0, g.F)(t, x.A, f.A), x.A.getState(t.id, t.branchId)], [t]), a = (0, r.bG)([A.A], () => A.A.isSyncing(t.id, t.branchId), [t]), o = (0, r.bG)([p.A], () => p.A.hasNoBuild(t.id, t.branchId), [t]);
    return (0, l.jsx)(L, {
        ...e,
        analyticsContext: n,
        actionState: i,
