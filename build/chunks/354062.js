/** chunk id: 354062 params = (module,exports,require) **/
s.d(t, {
    A: () => M
});
var r = s(627968),
...
function M(e) {
    ...
    let L = i.useMemo(() => [...s].sort((e, t) => O(t, G?.source.id, y, T) - O(e, G?.source.id, y, T)), [G, s, y, T]);
    if (_) {
        if (!1 === b) {
            let e = !1;
            if ((0, j.isMac)()) {
...
function U() {
    return (0, r.jsxs)("div", {
        ...
        children: [(0, r.jsx)(u.npA, {
            ...
            children: E.intl.format(I.default.xpVzr3, {
