    ...
    return i.useMemo(() => {
        ...
        for (let e of i) {
            let t = function(e, t) {
                ...
                return (null === t.selectedYear || r()(c.default.extractTimestamp(e.id)).year() === t.selectedYear) && !0
            }(e, l);
            if (t && n.push(e), null == e.applicationId) continue;
            let i = s.get(e.applicationId);
            null == i ? s.set(e.applicationId, {
                clips: [e],
                filteredClips: t ? [e] : [],
                mostRecentClipId: e.id,
                name: e.applicationName
            }) : (i.clips.push(e), t && i.filteredClips.push(e), e.id > i.mostRecentClipId && (i.mostRecentClipId = e.id))
        }
        let d = m(n, l.sortOrder),
            o = m(n.filter(e => e.isFavorite), l.sortOrder);
        return {
            clipsByGame: Array.from(s.entries()).map(e => {
                let [t, i] = e;
                return {
                    applicationId: t,
                    name: i.name,
