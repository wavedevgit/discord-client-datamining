...
function eg(e) {
    ...
    return (0, i.jsxs)("div", {
        ...
        children: [(0, i.jsx)(Q.Ae, {}), (0, i.jsx)("div", {
            className: r()(ea.nz, {
                [ea.ZZ]: n
            })
        }), (0, i.jsx)(em, {
...
function ep(e) {
    ...
    return (0, i.jsx)(X.A, {
        ...
        buttons: n ? (0, i.jsxs)(A.ButtonGroup, {
...
function eE(e) {
    ...
    return a ? (0, i.jsx)(Q.Hk, {}) : null != l ? (0, i.jsx)(Q.Ay, {
        hero: l,
        onQuestCtaClick: n
    }) : (0, i.jsx)(ep, {
        onAssetLoad: t
...
let ef = function(e) {
    let {
        topLevelRoute: t
    } = e, n = (0, s.zy)(), a = (0, s.W6)(), _ = l.useMemo(() => (0, O.B)(n.pathname, et.BVt.QUEST_HOME_DEPRECATED)?.isExact === !0, [n.pathname]), C = (0, c.bG)([E.A], () => E.A.getState("quests")), {
        selectedTab: b,
        onSelectTab: v,
        tabs: y
    } = (0, J.J)({
    ...
    l.useLayoutEffect(() => {
        _ && b === B.NC.CLAIMED && k.A.setState({
            tab: B.NC.ALL
        })
    }, [_, b]);
    let {
        onScroll: D
    } = (0, S.G)(), M = V.A.getState().getUtmCurrentContext(), w = (0, z.W)(e => e.registerAssetLoad), W = l.useRef(M);
    l.useEffect(() => {
        W.current = M
    }), l.useEffect(() => {
        let {
    ...
    let X = l.useRef(null),
        Z = l.useRef(null),
        er = l.useCallback(e => {
            Z.current?.resetSortingFiltering(), requestAnimationFrame(() => {
        ...
        children: (0, i.jsx)(eA.Provider, {
            ...
            children: (0, i.jsx)("div", {
                ...
                children: _ ? (0, i.jsx)(eh, {
                    ...
                    banner: b === B.NC.ALL && (0, i.jsx)(eE, {
                        onAssetLoad: w,
                        onQuestCtaClick: er
                    }),
                    children: b === B.NC.CLAIMED ? (0, i.jsx)(q.A, {
                        onSelectTab: ed
                    }) : b === B.NC.PREVIEW_TOOL ? (0, i.jsx)(F.A, {}) : (0, i.jsx)(K.A, {
                        ref: Z
                    })
                })
            })
