        ...
        children: [l, (0, i.jsxs)(L.A, {
            ...
            children: [function() {
                ...
                children: (0, i.jsxs)("div", {
                    className: r()(eo.Qs, {
                        [eo.HR]: g && !m && A !== W.NC.ALL
                    }),
                    children: [n, s ? A === W.NC.CLAIMED ? (0, i.jsx)(X.A, {
                        onSelectTab: c
                    }) : A === W.NC.PREVIEW_TOOL ? (0, i.jsx)(q.A, {}) : (0, i.jsx)(Q.A, {
                        ref: p
                    }) : null]
                })
            })]
...
let eI = function(e) {
    ...
    let {
        onScroll: U,
        scrollPosition: F
    } = (0, S.G)(), q = H.A.getState().getUtmCurrentContext(), $ = (0, Z.W)(e => e.registerAssetLoad), Q = a.useRef(q);
    a.useEffect(() => {
        Q.current = q
    }), a.useEffect(() => {
        let {
    ...
    let eA = (0, Y.U)({
        location: ei.rE.QUEST_PREVIEW_TOOL_2
    });
    a.useEffect(() => {
        if (null != C) return;
        ...
        children: (0, i.jsx)(em.Provider, {
            ...
            children: (0, i.jsx)("div", {
                ...
                children: _ ? (0, i.jsx)(eE, {
                    ...
                    renderBanner: () => v !== W.NC.PREVIEW_TOOL && (0, i.jsxs)(x.A, {
                        title: et,
                        description: ed,
