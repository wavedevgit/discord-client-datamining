/** chunk id: 220995 params = (module,exports,require) **/
n.d(t, {
    p: () => b
});
var i = n(627968),
...
function b(e) {
    ...
    let D = (0, d.bG)([f.A], () => f.A.can(I.xBc.CREATE_INSTANT_INVITE, t), [t]),
        ...
        W = l.useCallback(() => {
            null != U && (0, u.mMO)(async () => {
                ...
                return n => (0, i.jsx)(e, {
                    ...
                    guild: U,
                    channel: t,
                    source: I.PE1.VOICE_INVITE_SUGGESTIONS
                })
            })
        }, [U, t]),
        [K, Y] = (0, u.zhh)(() => ({
        ...
        q = l.useCallback(() => (null != j.current && clearTimeout(j.current), j.current = setTimeout(() => z("timeout"), 1e4), L(e => e + 1), () => {
                ...
                children: (0, i.jsx)(u.DUT, {
                    ...
                    children: (0, i.jsxs)("div", {
                        ...
                        children: [(0, i.jsxs)("div", {
                            ...
                            }, `voice-invite-suggestions-timer-${O}`), (0, i.jsx)(u.Rvf, {
                                size: "custom",
                                width: 14,
                                height: 14,
                                color: "currentColor",
