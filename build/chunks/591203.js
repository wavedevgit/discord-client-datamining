...
let b = (0, u.E2)(p.X.ENTRANCE_SOUNDS_SETTING, {
    ...
    Component: function() {
        ...
        } = (0, o.Ay)(), [t, n] = s.useState("0"), a = (0, A.mz)(t), u = f(a), p = a?.type === A.PP.GLOBAL, T = (0, l.bG)([m.A], () => m.A.hasFetchedAllSounds()) && null != a && null == u;
        s.useEffect(() => {
            T && (0, g.ND)({
                location: e
            })
        ...
        return (0, i.jsxs)(r.nVY, {
            ...
            description: C.intl.format(C.t.u9RWmv, {
                helpdeskArticle: x.A.getArticleURL(E.MVz.SOUNDBOARD)
            }),
            children: [(0, i.jsx)(d.A, {
                guildId: t,
                className: S.Dt,
                globalOption: {
                    label: C.intl.string(C.t["CpEUP/"]),
                    value: "0"
                },
                onChange: e => {
                    n(null == e ? "0" : e.id)
