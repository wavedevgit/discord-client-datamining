/** chunk id: 468831 params = (module,exports,require) **/
n.d(t, {
    L: () => N
});
var i = n(627968),
...
function C(e) {
    let {
        guildId: t
    } = e, n = (0, l.bG)([T.A], () => T.A.settings.guilds?.guilds?.[t]?.joinSound), s = E(n);
...
let N = (0, u.E2)(p.X.ENTRANCE_SOUNDS_SETTING, {
    ...
    Component: function() {
        ...
        } = (0, o.Ay)(), [t, n] = s.useState("0"), r = (0, x.mz)(t), u = E(r), p = r?.type === x.PP.GLOBAL, T = (0, l.bG)([g.A], () => g.A.hasFetchedAllSounds()) && null != r && null == u;
        s.useEffect(() => {
            T && (0, _.ND)({
                location: e
            })
