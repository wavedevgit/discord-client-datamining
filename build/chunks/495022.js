/** chunk id: 495022, original params: e,t,n (module,exports,require) **/
n.d(t, {
    A: () => P
});
var i = n(627968),
...
function P(e) {
    let {
    ...
    } = e, n = (0, c.DP)(), P = (0, E.Lh)(), L = (0, C.N)(P)?.standard ?? null, {
        analyticsLocations: D
    } = (0, u.Ay)(d.A.PREMIUM_MARKETING_PERK_CARD), G = (0, m.A)({
        scrollPosition: S._F.TRY_IT_OUT,
        analyticsLocations: D
    }), M = (0, s.useCallback)(() => {
        (0, x.openUserSettings)(g.X.APPEARANCE_PANEL, {
        ...
        subscriptionRequired: !0,
        primaryAsset: null != L ? (0, i.jsx)("img", {
            src: L,
            alt: "",
            width: 160
        }) : (0, i.jsx)(a.vXC, {
        ...
        categories: ["vip"]
    }], [n, L, G, M, U, k, V, w]), B = null != t ? H.find(e => e?.id === t) : null, [Y, F] = (0, s.useState)(B?.categories[0] ?? "bestof"), z = (0, s.useMemo)(() => H.filter(e => null != e && e.categories.includes(Y)), [H, Y]);
    return (0, i.jsxs)("div", {
        className: f.uW,
        children: [(0, i.jsx)(o.Heading, {
            variant: "display-sm",
            className: f.R_,
            children: I.intl.string(I.t["Uh3+CA"])
        }), (0, i.jsx)(o.VQ0, {
            type: "top-pill",
            look: "custom",
            selectedItem: Y,
            ...
            children: y.map(e => (0, i.jsx)(o.VQ0.Item, {
                id: e.id,
                className: f.IC,
                children: e.label()
            }, e.id))
