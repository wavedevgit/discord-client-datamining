/** chunk id: 813407 params = (module,exports,require) **/
t.d(n, {
    default: () => M
});
var i = t(627968);
...
var r = t(397927),
    ...
    C = t(652215),
    D = t(985018);
let M = (0, d.A)((0, a.A)(function(e) {
    let {
        channel: n,
        guild: t,
        widgetType: a,
        onSelect: d
    } = e, u = (0, A.A)(n), C = (0, o.A)(n), {
        toggleFavoriteItem: M
    } = (0, f.Ay)(p.x.MESSAGES, n, a), T = (0, I.A)({
        kind: "CHANNEL",
        channel: n,
        guildId: t.id
    }, a), b = (0, c.A)(n, t), S = (0, y.A)(n), x = (0, _.A)(n), O = (0, E.A)(n), U = (0, g.A)(n), L = (0, v.A)({
        id: n.id,
        label: D.intl.string(D.t.gFHI3k)
    }), k = (0, s.A)(n), R = (0, N.Ay)(n), j = (0, h.os)("OverlayChannelListTextChannelContextMenu");
