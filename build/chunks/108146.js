/** Chunk was on web.js **/
/** chunk id: 108146, original params: e,t,n (module,exports,require) **/
"use strict";
n.d(t, {
    t: () => l
});
...
function l(e, t) {
    ...
    let {
        direction: f
    } = (0, s.Y)(), p = "rtl" === f && "horizontal" === c, _ = (0, r.C7)(t), h = e => {
        ...
        var n, r;
        m.current && !e.currentTarget.contains(e.relatedTarget) && (null == (n = t.current) ? void 0 : n.contains(e.target)) && (null == (r = m.current) || r.focus(), m.current = null)
    };
    return {
        toolbarProps: {
            ...(0, a.$)(e, {
