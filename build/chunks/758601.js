...
let E = function(t) {
    let {
        onClose: e,
        channelId: n
    } = t, [E, m] = i.useState(!1), O = i.useCallback(() => {
        ...
        (0, o.openUserSettings)(t ? r.X.CONTENT_AND_SOCIAL_DM_SAFETY_ALERTS_SETTING : r.X.CONTENT_AND_SOCIAL_PANEL, {
            section: A.nc_.CONTENT_AND_SOCIAL,
            scrollPosition: t ? void 0 : u.d1.DM_SAFETY_ALERTS_V2
        }), e()
    }, [e]), g = i.useCallback(() => {
        E || (m(!0), (0, c.XR)(n).then(() => {
            e(), (0, d.r)({
    ...
    return (0, s.jsxs)(S.A, {
        ...
        children: [(0, s.jsx)(l.Text, {
            ...
            children: _.intl.format(_.t["njJ/Cg"], {
                learnMoreLink: T.A.getArticleURL(A.MVz.SAFETY_ALERTS)
            })
        }), (0, s.jsxs)("div", {
