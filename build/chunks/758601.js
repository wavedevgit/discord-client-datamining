/** chunk id: 758601 params = (module,exports,require) **/
n.d(e, {
    A: () => _
});
var s = n(627968),
...
let _ = function(t) {
    let {
        onClose: e,
        channelId: n
    } = t, [_, x] = i.useState(!1), E = i.useCallback(() => {
    ...
    return (0, s.jsxs)(d.A, {
        ...
        children: [(0, s.jsx)(l.Text, {
            ...
            color: "text-default",
            children: u.intl.format(u.t["njJ/Cg"], {
                learnMoreLink: T.A.getArticleURL(S.MVz.SAFETY_ALERTS)
            })
        }), (0, s.jsxs)("div", {
            children: [(0, s.jsx)(l.Button, {
                onClick: E,
                fullWidth: !0,
                text: u.intl.string(u.t.qpWnyC)
            }), (0, s.jsx)(l.Text, {
