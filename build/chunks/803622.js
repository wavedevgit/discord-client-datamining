/** chunk id: 803622 params = (module,exports,require) **/
n.d(t, {
    A: () => O
});
var i = n(627968),
...
let R = e => {
    ...
    O = e => {
        let {
            ...
            channelId: s
        } = (0, p.N)(), d = (0, o.bG)([A.A], () => null != s && A.A.isSpam(s), [s]), u = (0, o.bG)([S.A], () => S.A.getRelationshipType(t), [t]), h = n.id === s, m = !r.Fr && !h, g = !!r.Fr || h || d, _ = d || h ? (0, i.jsxs)("div", {
            className: j.mG,
            children: [(0, i.jsx)(D, {
                channelId: n.id,
                otherUserId: t
