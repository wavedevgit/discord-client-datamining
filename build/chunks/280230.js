...
! function(t, n) {
    ...
    var e = /\r\n?/g,
        ...
        a = function(e, t) {
            ...
            var d = function(t, r) {
                    var i = [];
                    for (n = r = r || n; t;) {
                        for (var l = null, c = null, u = null, f = -1e5, p = 1e5, _ = [s.get(t.charCodeAt(0)), o], h = 0; h < _.length; h++) {
                            var m = _[h];
                            if (null != m)
    ...
    var G = 0,
        V = {
            ...
            em: {
                order: G,
                match: s(RegExp((U ? "^\\b_((?:_[_(]|\\\\[\\s\\S]|(?<!_)\\B_\\B|[^\\\\_])+?)_(?![(])\\b" : "^\\b_((?:__|\\\\[\\s\\S]|[^\\\\_])+?)_\\b") + "|^\\*(?=\\S)((?:\\*\\*|\\\\[\\s\\S]|\\s+(?:\\\\[\\s\\S]|[^\\s\\*\\\\]|\\*\\*)|[^\\s\\*\\\\])+?)\\*(?!\\*)")),
                quality: function(e) {
                    return e[0].length + .2
                },
                parse: function(e, t, n) {
