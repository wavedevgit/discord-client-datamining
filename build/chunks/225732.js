...
function el(e) {
    let {
        ...
        application: n,
        entries: a
    } = e, r = l.useMemo(() => t?.genres.map(O.du).join(", "), [t]), [o] = l.useState(() => Math.random()), d = l.useMemo(() => {
        if (null == t) return "";
        let {
            artwork: e,
            screenshots: n
        ...
        return ""
    }, [t, o]), u = (0, R.uJ)(t.iconHash) ? n?.getIconURL(160, G.QB ? "webp" : "png") : G.Ay.getGameAssetURL({
        id: t.applicationId,
        hash: t.iconHash,
        size: 160,
        format: G.QB ? "webp" : "png"
    }), x = L.default.extractTimestamp(n.id), g = 7 >= c()().diff(c()(x), "days"), f = a.some(e => (0, N.CZ)(e) === m.m.GLOBAL), j = t.name ?? n?.name;
                ...
                children: (0, i.jsxs)("div", {
                    children: [(0, i.jsx)(h.Heading, {
                        ...
                        children: [null != u && (0, i.jsx)("img", {
                            ...
                            src: u,
                            height: 16,
                            alt: ee.intl.formatToPlainString(ee.t["nh+jWk"], {
                                game: j
                            })
                        }), (0, i.jsx)(h.Text, {
...
function es(e) {
    let {
        ...
        entries: a,
        isTwoColumn: r
    } = e, o = l.useMemo(() => t?.genres.map(O.du).join(", "), [t]), [d] = l.useState(() => Math.random()), u = l.useMemo(() => {
        if (null == t) return "";
        let {
            artwork: e,
            screenshots: n
        ...
        return ""
    }, [t, d]), x = (0, R.uJ)(t.iconHash) ? n?.getIconURL(160, G.QB ? "webp" : "png") : G.Ay.getGameAssetURL({
        id: t.applicationId,
        hash: t.iconHash,
        size: 160,
        format: G.QB ? "webp" : "png"
    }), g = L.default.extractTimestamp(n.id), f = 7 >= c()().diff(c()(g), "days"), j = a.some(e => (0, N.CZ)(e) === m.m.GLOBAL), p = t.name ?? n?.name;
    return (0, i.jsxs)(i.Fragment, {
        children: [(0, i.jsx)("div", {
            className: et.is,
            style: {
...
function em(e) {
    ...
    return (0, i.jsxs)("div", {
        ...
        children: [(0, i.jsxs)("div", {
            ...
            children: ee.intl.string(ee.t.CI0vSJ)
        }), (0, i.jsxs)("div", {
            className: et.V0,
            children: [(0, i.jsx)(Q.h, {
                ...
                children: ee.intl.format(ee.t.pch2Jw, {
                    igdbLink: q.s8
                })
            })]
        })]
...
function eg(e) {
    ...
    } = (0, A.Ay)(), m = (0, x.bG)([b.default], () => b.default.locale), g = l.useMemo(() => (0, M.u9)(), []), j = (0, x.yK)([k.A], () => (k.A.getSimilarGames(t) ?? []).slice(0, 25)), [p, I] = l.useState(null), v = (0, P.s)(t), [S, C] = l.useState(null), G = (0, E.h)(t), {
        data: O,
        refetch: L
    } = (0, T.k)(t), R = O?.supplementalData ?? null, y = R?.name ?? G?.name, V = (e, i) => {
        (0, M.Tn)({
            gameName: y ?? "",
            applicationId: t,
            action: e,
    ...
    }, [t, R?.summaryLocalized, m, L]), l.useEffect(() => {
        (async () => {
            if (0 === j.length) {
                I(null);
                try {
    ...
    }), null == R || null == G) ? null : (0, i.jsx)(h.dWK, {
        transitionState: r,
        onClose: c,
        size: "xl",
        children: (0, i.jsx)("div", {
...
function eh(e) {
    ...
    } = (0, A.Ay)(), g = (0, x.bG)([b.default], () => b.default.locale), j = l.useMemo(() => (0, M.u9)(), []), p = (0, P.s)(t), [I, v] = l.useState(null), S = (0, E.h)(t), {
        data: C,
        refetch: G
    } = (0, T.k)(t), O = C?.supplementalData ?? null, L = O?.name ?? S?.name, R = (e, i) => {
        (0, M.Tn)({
            gameName: L ?? "",
            applicationId: t,
            action: e,
    ...
    }, [t, O?.summaryLocalized, g, G]), (0, f.Ay)(() => () => {
        let e = Date.now(),
            n = p.map(t => {
    ...
    let [w, k] = l.useState(!0), y = l.useCallback(e => {
        e.contentRect.width < 800 ? k(!1) : k(!0)
    }, []), D = (0, d.w)(y, [], {
        fireOnMount: !0
    });
    return null == O || null == S ? null : (0, i.jsx)(h.dWK, {
        transitionState: r,
        onClose: c,
        size: "xxl",
