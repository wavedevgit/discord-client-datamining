...
function es(e) {
    let {
        ...
        application: n,
        entries: a
    } = e, r = l.useMemo(() => t?.genres.map(O.du).join(", "), [t]), [c] = l.useState(() => Math.random()), d = l.useMemo(() => {
        if (null == t) return "";
        let {
            artwork: e,
            screenshots: n
        ...
        return ""
    }, [t, c]), u = (0, M.uJ)(t.iconHash) ? n?.getIconURL(160, L.QB ? "webp" : "png") : L.Ay.getGameAssetURL({
        id: t.applicationId,
        hash: t.iconHash,
        size: 160,
        format: L.QB ? "webp" : "png"
    }), x = R.default.extractTimestamp(n.id), g = 7 >= o()().diff(o()(x), "days"), f = a.some(e => (0, C.CZ)(e) === m.m.GLOBAL), j = t.name ?? n?.name;
                ...
                children: (0, i.jsxs)("div", {
                    children: [(0, i.jsx)(h.Heading, {
                        ...
                        children: [null != u && (0, i.jsx)("img", {
                            ...
                            src: u,
                            height: 16,
                            alt: en.intl.formatToPlainString(en.t["nh+jWk"], {
                                game: j
                            })
                        }), (0, i.jsx)(h.Text, {
...
function eo(e) {
    let {
        ...
        entries: a,
        isTwoColumn: r
    } = e, c = l.useMemo(() => t?.genres.map(O.du).join(", "), [t]), [d] = l.useState(() => Math.random()), u = l.useMemo(() => {
        if (null == t) return "";
        let {
            artwork: e,
            screenshots: n
        ...
        return ""
    }, [t, d]), x = (0, M.uJ)(t.iconHash) ? n?.getIconURL(160, L.QB ? "webp" : "png") : L.Ay.getGameAssetURL({
        id: t.applicationId,
        hash: t.iconHash,
        size: 160,
        format: L.QB ? "webp" : "png"
    }), g = R.default.extractTimestamp(n.id), f = 7 >= o()().diff(o()(g), "days"), j = a.some(e => (0, C.CZ)(e) === m.m.GLOBAL), p = t.name ?? n?.name;
    return (0, i.jsxs)(i.Fragment, {
        children: [(0, i.jsx)("div", {
            className: ei.is,
            style: {
...
function eu(e) {
    let {
        ...
        onClose: a,
        application: s
    } = e, r = t.steamReleaseStatus !== u.Y.RETIRED_ABANDONED, o = l.useCallback(() => {
...
function eg(e) {
    ...
    return (0, i.jsxs)("div", {
        ...
        children: [(0, i.jsxs)("div", {
            ...
            children: en.intl.string(en.t.CI0vSJ)
        }), (0, i.jsxs)("div", {
            className: ei.V0,
            children: [(0, i.jsx)(ee.h, {
                detectedGame: t,
                trackAction: r
            }), (0, i.jsx)(J.A, {
                detectedGame: t,
                ...
                children: en.intl.format(en.t.pch2Jw, {
                    igdbLink: et.s8
                })
            })]
        })]
...
function ef(e) {
    ...
    } = (0, A.Ay)(), m = (0, x.bG)([G.default], () => G.default.locale), g = l.useMemo(() => (0, w.u9)(), []), j = (0, x.yK)([y.A], () => (y.A.getSimilarGames(t) ?? []).slice(0, 25)), [p, _] = l.useState(null), I = (0, D.s)(t), [v, S] = l.useState(null), b = (0, E.h)(t), {
        data: L,
        refetch: O
    } = (0, T.k)(t), R = L?.supplementalData ?? null, M = R?.name ?? b?.name, P = (e, i) => {
        (0, w.Tn)({
            gameName: M ?? "",
            applicationId: t,
            action: e,
    ...
    }, [t, R?.summaryLocalized, m, O]), l.useEffect(() => {
        (async () => {
            if (0 === j.length) {
                _(null);
                try {
    ...
    }), null == R || null == b) ? null : (0, i.jsx)(h.dWK, {
        transitionState: r,
        onClose: o,
        size: "xl",
        children: (0, i.jsx)("div", {
...
function ej(e) {
    ...
    } = (0, A.Ay)(), g = (0, x.bG)([G.default], () => G.default.locale), j = l.useMemo(() => (0, w.u9)(), []), p = (0, D.s)(t), [_, I] = l.useState(null), S = (0, E.h)(t), {
        data: b,
        refetch: L
    } = (0, T.k)(t), O = b?.supplementalData ?? null, {
        hasAlreadyLinked: R,
        canStartAuthorization: M
    } = (0, v.RD)(S), {
        invite: k,
        isMember: y
    } = (0, V.A)(O, I), P = O?.name ?? S?.name, Y = (e, i) => {
        (0, w.Tn)({
            gameName: P ?? "",
            applicationId: t,
            action: e,
    ...
    }, [t, O?.summaryLocalized, g, L]), (0, f.Ay)(() => () => {
        let e = Date.now(),
            n = p.map(t => {
    ...
    let [W, U] = l.useState(!0), F = l.useCallback(e => {
