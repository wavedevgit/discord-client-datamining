...
function eu(e) {
    let {
        ...
        application: n,
        entries: i
    } = e, s = l.useMemo(() => t?.genres.map(y.du).join(", "), [t]), [c] = l.useState(() => Math.random()), d = l.useMemo(() => {
        if (null == t) return "";
        let {
            artwork: e,
            screenshots: n
        ...
        return ""
    }, [t, c]), u = (0, G.uJ)(t.iconHash) ? n?.getIconURL(160, k.QB ? "webp" : "png") : k.Ay.getGameAssetURL({
        id: t.applicationId,
        hash: t.iconHash,
        size: 160,
        format: k.QB ? "webp" : "png"
    }), x = R.default.extractTimestamp(n.id), f = 7 >= o()().diff(o()(x), "days"), g = i.some(e => (0, N.CZ)(e) === m.m.GLOBAL), p = t.name ?? n?.name;
                ...
                children: (0, a.jsxs)("div", {
                    children: [(0, a.jsx)(h.Heading, {
                        ...
                        children: [null != u && (0, a.jsx)("img", {
                            ...
                            src: u,
                            height: 16,
                            alt: es.intl.formatToPlainString(es.t["nh+jWk"], {
                                game: p
                            })
                        }), (0, a.jsx)(h.Text, {
...
function ef(e) {
    let {
        ...
        onClose: i,
        application: r
    } = e, s = t.supplementalData?.steamReleaseStatus !== u.Y.RETIRED_ABANDONED, o = l.useCallback(() => {
...
function ep(e) {
    ...
    return (0, a.jsxs)("div", {
        ...
        children: [(0, a.jsxs)("div", {
            ...
            children: es.intl.string(es.t.CI0vSJ)
        }), (0, a.jsxs)("div", {
            className: eo.V0,
            children: [(0, a.jsx)(ei.h, {
                detectedGame: t,
                trackAction: s
            }), (0, a.jsx)(q.A, {
                detectedGame: t,
                ...
                children: es.intl.format(es.t.pch2Jw, {
                    igdbLink: er.s8
                })
            })]
        })]
...
function ej(e) {
    ...
    } = (0, I.Ay)(), m = (0, x.bG)([L.default], () => L.default.locale), f = l.useMemo(() => (0, O.u9)(), []), p = (0, x.yK)([w.A], () => (w.A.getSimilarGames(t) ?? []).slice(0, 25)), [v, j] = l.useState(null), _ = (0, P.s)(t), [A, T] = l.useState(null), S = (0, E.h)(t), {
        data: k,
        refetch: y
    } = (0, C.k)(t), R = k?.supplementalData ?? null, G = R?.name ?? S?.name, D = (e, a) => {
        (0, O.Tn)({
            gameName: G ?? "",
            applicationId: t,
            action: e,
    ...
    }, [t, R?.summaryLocalized, m, y]), l.useEffect(() => {
        (async () => {
            if (0 === p.length) {
                j(null);
                try {
    ...
    }), null == k || null == R || null == S) ? null : (0, a.jsx)(h.dWK, {
        transitionState: s,
        onClose: o,
        size: "xl",
        children: (0, a.jsx)("div", {
...
function e_(e) {
    ...
    } = e, [m, f] = l.useState(!0), [p, v] = l.useState(null), {
        clientThemesClassName: j
    } = (0, I.Ay)(), _ = (0, x.bG)([L.default], () => L.default.locale), T = l.useMemo(() => (0, O.u9)(), []), S = (0, E.h)(t), k = (0, P.s)(t), {
        data: y
    } = (0, C.k)(t), R = y?.supplementalData ?? null, G = R?.name ?? y?.name ?? S?.name ?? "", {
        hasAlreadyLinked: M,
    ...
    return null == y || null == R || null == S ? null : (0, a.jsx)(h.dWK, {
        transitionState: s,
        onClose: o,
        size: "xxl",
