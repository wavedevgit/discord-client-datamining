...
function em(e) {
    ...
    }), x = G.default.extractTimestamp(n.id), h = 7 >= c()().diff(c()(x), "days"), g = i.some(e => (0, b.CZ)(e) === m.m.GLOBAL), p = t.name ?? n?.name;
...
function ej(e) {
    ...
    } = (0, E.Ay)(), m = (0, x.bG)([L.default], () => L.default.locale), h = a.useMemo(() => (0, O.u9)(), []), p = (0, x.yK)([w.A], () => (w.A.getSimilarGames(t) ?? []).slice(0, 25)), [_, v] = a.useState(null), j = (0, P.s)(t), [A, T] = a.useState(null), S = (0, I.h)(t), {
        data: k,
        refetch: y
    } = (0, C.k)(t), G = k?.supplementalData ?? null, R = G?.name ?? S?.name, D = (e, l) => {
        (0, O.Tn)({
            gameName: R ?? "",
            applicationId: t,
            action: e,
    ...
    }, [t, G?.summaryLocalized, m, y]), a.useEffect(() => {
        (async () => {
            if (0 === p.length) {
                v(null);
                try {
    ...
    }), null == k || null == G || null == S) ? null : (0, l.jsx)(f.dWK, {
        transitionState: s,
        onClose: c,
        size: "xl",
        children: (0, l.jsx)("div", {
...
function eA(e) {
    ...
    } = (0, E.Ay)(), j = (0, x.bG)([L.default], () => L.default.locale), T = a.useMemo(() => (0, O.u9)(), []), k = (0, I.h)(t), y = (0, P.s)(t), {
        data: G
    } = (0, C.k)(t), R = G?.supplementalData ?? null, M = R?.name ?? G?.name ?? k?.name ?? "", {
        hasAlreadyLinked: w,
    ...
    return null == G || null == R || null == k ? null : (0, l.jsx)(f.dWK, {
        transitionState: s,
        onClose: c,
        size: "xxl",
