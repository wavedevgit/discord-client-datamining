...
function ed(e) {
    let {
        ...
        return ""
    }, [t, o]), u = (0, G.uJ)(t.iconHash) ? n?.getIconURL(160, L.QB ? "webp" : "png") : L.Ay.getGameAssetURL({
        id: t.applicationId,
        hash: t.iconHash,
        size: 160,
...
function em(e) {
    let {
        ...
        isTwoColumn: o
    } = (0, H.c)(), d = l.useMemo(() => t.genres.map(y.du).join(", "), [t]), [u] = l.useState(() => Math.random()), x = l.useMemo(() => {
        if (null == s) return "";
        let {
            artwork: e,
            screenshots: t
        ...
        return ""
    }, [s, u]), h = null == s || (0, G.uJ)(s.iconHash) ? n?.getIconURL(160, L.QB ? "webp" : "png") : L.Ay.getGameAssetURL({
        id: t.id,
        hash: s.iconHash,
        size: 160,
        format: L.QB ? "webp" : "png"
...
function ej(e) {
    ...
    } = (0, E.Ay)(), m = (0, x.bG)([k.default], () => k.default.locale), h = l.useMemo(() => (0, w.u9)(), []), p = (0, x.yK)([M.A], () => (M.A.getSimilarGames(t) ?? []).slice(0, 25)), [_, v] = l.useState(null), j = (0, D.s)(t), [A, S] = l.useState(null), T = (0, I.h)(t), {
        data: L,
        refetch: y
    } = (0, C.k)(t), R = L?.supplementalData ?? null, G = R?.name ?? T?.name, P = (e, a) => {
        (0, w.Tn)({
            gameName: G ?? "",
            applicationId: t,
            action: e,
    ...
    }), null == L || null == R || null == T) ? null : (0, a.jsx)(f.dWK, {
        transitionState: s,
        onClose: c,
        size: "xl",
        children: (0, a.jsx)("div", {
...
function eA(e) {
    ...
    } = (0, E.Ay)(), j = (0, x.bG)([k.default], () => k.default.locale), S = l.useMemo(() => (0, w.u9)(), []), T = (0, I.h)(t), L = (0, D.s)(t), {
        data: y,
        refetch: R
    } = (0, C.k)(t), G = y?.supplementalData ?? null, O = G?.name ?? y?.name ?? T?.name ?? "", {
        hasAlreadyLinked: M,
    ...
    }, [t, G?.summaryLocalized, j, R]), (0, g.Ay)(() => () => {
        let e = Date.now(),
            n = L.map(t => {
    ...
    return null == y || null == G || null == T ? null : (0, a.jsx)(f.dWK, {
        transitionState: s,
        onClose: c,
        size: "xxl",
