...
function ex(e) {
    ...
    }), x = O.default.extractTimestamp(n.id), h = 7 >= o()().diff(o()(x), "days"), g = i.some(e => (0, b.CZ)(e) === m.m.GLOBAL), _ = t.name ?? n?.name;
...
function eE(e) {
    ...
    } = (0, I.Ay)(), A = (0, x.bG)([L.default], () => L.default.locale), T = l.useMemo(() => (0, G.u9)(), []), k = (0, E.h)(t), y = (0, D.s)(t), {
        data: O
