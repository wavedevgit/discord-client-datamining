...
function ex(e) {
    ...
    }), x = O.default.extractTimestamp(n.id), _ = 7 >= o()().diff(o()(x), "days"), f = i.some(e => (0, E.CZ)(e) === m.m.GLOBAL), p = t.name ?? n?.name;
...
function ej(e) {
    ...
    } = (0, b.Ay)(), m = (0, x.bG)([L.default], () => L.default.locale), _ = l.useMemo(() => (0, G.u9)(), []), p = (0, x.yK)([w.A], () => (w.A.getSimilarGames(t) ?? []).slice(0, 25)), [h, v] = l.useState(null), A = (0, D.s)(t), [j, T] = l.useState(null), S = (0, I.h)(t), {
        data: k,
        refetch: y
    } = (0, N.k)(t), O = k?.supplementalData ?? null, R = O?.name ?? S?.name, P = (e, a) => {
        (0, G.Tn)({
            gameName: R ?? "",
            applicationId: t,
            action: e,
    ...
    }), null == k || null == O || null == S) ? null : (0, a.jsx)(g.dWK, {
        transitionState: s,
        onClose: o,
        size: "xl",
        children: (0, a.jsx)("div", {
...
function eI(e) {
    ...
    } = (0, b.Ay)(), A = (0, x.bG)([L.default], () => L.default.locale), T = l.useMemo(() => (0, G.u9)(), []), k = (0, I.h)(t), y = (0, D.s)(t), {
        data: O
    ...
    return null == O || null == R || null == k ? null : (0, a.jsx)(g.dWK, {
        transitionState: s,
        onClose: o,
        size: "xxl",
