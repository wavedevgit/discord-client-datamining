...
function ec(e) {
    let {
        ...
        application: n,
        entries: a
    } = e, s = l.useMemo(() => t?.genres.map(y.du).join(", "), [t]), [o] = l.useState(() => Math.random()), d = l.useMemo(() => {
        if (null == t) return "";
        let {
            artwork: e,
            screenshots: n
        ...
        return ""
    }, [t, o]), u = (0, R.uJ)(t.iconHash) ? n?.getIconURL(160, k.QB ? "webp" : "png") : k.Ay.getGameAssetURL({
        id: t.applicationId,
        hash: t.iconHash,
        size: 160,
        format: k.QB ? "webp" : "png"
    }), x = G.default.extractTimestamp(n.id), h = 7 >= c()().diff(c()(x), "days"), g = a.some(e => (0, N.CZ)(e) === m.m.GLOBAL), _ = t.name ?? n?.name;
                ...
                children: (0, i.jsxs)("div", {
                    children: [(0, i.jsx)(f.Heading, {
                        ...
                        children: [null != u && (0, i.jsx)("img", {
                            ...
                            src: u,
                            height: 16,
                            alt: el.intl.formatToPlainString(el.t["nh+jWk"], {
                                game: _
                            })
                        }), (0, i.jsx)(f.Text, {
...
function ed(e) {
    let {
        ...
        isTwoColumn: s
    } = (0, H.c)(), o = l.useMemo(() => t?.genres.map(y.du).join(", "), [t]), [d] = l.useState(() => Math.random()), u = l.useMemo(() => {
        if (null == t) return "";
        let {
            artwork: e,
            screenshots: n
        ...
        return ""
    }, [t, d]), x = (0, R.uJ)(t.iconHash) ? n?.getIconURL(160, k.QB ? "webp" : "png") : k.Ay.getGameAssetURL({
        id: t.applicationId,
        hash: t.iconHash,
        size: 160,
        format: k.QB ? "webp" : "png"
    }), h = G.default.extractTimestamp(n.id), g = 7 >= c()().diff(c()(h), "days"), _ = a.some(e => (0, N.CZ)(e) === m.m.GLOBAL), p = t.name ?? n?.name;
    return (0, i.jsxs)(i.Fragment, {
        children: [(0, i.jsx)("div", {
            className: er.is,
            style: {
...
function ex(e) {
    let {
        ...
        onClose: a,
        application: r
    } = e, s = t.steamReleaseStatus !== u.Y.RETIRED_ABANDONED, c = l.useCallback(() => {
...
function eg(e) {
    ...
    return (0, i.jsxs)("div", {
        ...
        children: [(0, i.jsxs)("div", {
            ...
            children: el.intl.string(el.t.CI0vSJ)
        }), (0, i.jsxs)("div", {
            className: ea.V0,
            children: [(0, i.jsx)(en.h, {
                detectedGame: t,
                trackAction: s
            }), (0, i.jsx)(K.A, {
                detectedGame: t,
                ...
                children: el.intl.format(el.t.pch2Jw, {
                    igdbLink: ei.s8
                })
            })]
        })]
...
function ep(e) {
    ...
    } = (0, E.Ay)(), m = (0, x.bG)([L.default], () => L.default.locale), h = l.useMemo(() => (0, w.u9)(), []), _ = (0, x.yK)([O.A], () => (O.A.getSimilarGames(t) ?? []).slice(0, 25)), [p, v] = l.useState(null), I = (0, D.s)(t), [j, S] = l.useState(null), T = (0, A.h)(t), {
        data: k,
        refetch: y
    } = (0, C.k)(t), G = k?.supplementalData ?? null, R = G?.name ?? T?.name, P = (e, i) => {
        (0, w.Tn)({
            gameName: R ?? "",
            applicationId: t,
            action: e,
    ...
    }, [t, G?.summaryLocalized, m, y]), l.useEffect(() => {
        (async () => {
            if (0 === _.length) {
                v(null);
                try {
    ...
    }), null == G || null == T) ? null : (0, i.jsx)(f.dWK, {
        transitionState: s,
        onClose: c,
        size: "xl",
        children: (0, i.jsx)("div", {
...
function ev(e) {
    ...
    } = (0, E.Ay)(), I = (0, x.bG)([L.default], () => L.default.locale), S = l.useMemo(() => (0, w.u9)(), []), T = (0, A.h)(t), k = (0, D.s)(t), {
        data: y,
        refetch: G
    } = (0, C.k)(t), R = y?.supplementalData ?? null, M = R?.name ?? T?.name ?? "", {
        hasAlreadyLinked: O,
    ...
    (0, g.Ay)(() => {
        ...
        I.startsWith("en") || R?.summaryLocalized != null || G()
    }, [t, R?.summaryLocalized, I, G]), (0, g.Ay)(() => () => {
        let e = Date.now(),
            n = k.map(t => {
    ...
    return null == R || null == T ? null : (0, i.jsx)(f.dWK, {
        transitionState: s,
        onClose: c,
        size: "xxl",
