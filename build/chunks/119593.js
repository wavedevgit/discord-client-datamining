/** chunk id: 119593 params = (module,exports,require) **/
l.d(n, {
    A: () => p
});
var a = l(627968),
...
let I = s.memo(function(e) {
    ...
    N = e => {
        ...
        return s.useEffect(() => {
            ...
            className: b.Km,
            onClick: e => {
                null != _ && (e.shiftKey ? (0, A.bN)(_.guild_id, _.id) : u.A.openResourceChannelAsSidebar({
                    guildId: _.guild_id,
                    channelId: _.id
                }))
            },
    ...
    C = s.memo(function(e) {
        ...
        return 0 === l.length ? null : (0, a.jsx)(i.ZpM, {
            className: b.u2,
