/** chunk id: 738586, original params: e,t,n (module,exports,require) **/
"use strict";
n.d(t, {
    V: () => _
}), n(321073), n(896048);
...
class _ {
    ...
    startReenableBackoffTimer(e) {
        ...
        let r = n * this.backoffTimeSec * s.A.Millis.SECOND;
    ...
    reenableVideo(e) {
        return e in this.perUserFpsWindow && (this.logger.info("reenableVideo called for user ".concat(e, " - time = ").concat((0, i.tB)())), this.stateCleanupBeforeEnable(e), this.currentVideoAutoToggleState[e] = l.bb8.AUTO_PROBING, this.probingUserId = e, (0, o.A)(e, l.bb8.AUTO_PROBING), !0)
    }
    elapsedSeconds(e, t) {
        return (e - t) / 1e3
    }
    ...
    createUser(e) {
        this.logger.info("VideoHealthManager::createUser ".concat(e)), e in this.perUserFpsWindow || (this.perUserFpsWindow[e] = [], this.prevFramesCodec[e] = -1, this.currentVideoAutoToggleState[e] = l.bb8.NONE, this.retryBackoffCache[e] = {
