/** chunk id: 143154 params = (module,exports,require) **/
l.d(a, {
    default: () => G
}), l(321073);
var i = l(627968),
...
let w = e => {
        let {
            ...
            onClose: l,
            trackOptionClick: n
        } = e, t = (0, s.bG)([N.A], () => N.A.getChannel(a.channel_id)), m = (0, c.Ay)(t), _ = (0, s.bG)([A.A], () => null != t && A.A.can(k.xB.VIEW_CHANNEL, t)), x = (0, s.bG)([u.Ay], () => null != a.emoji_id ? u.Ay.getCustomEmojiById(a.emoji_id) : null, [a.emoji_id]), j = null != a.emoji_name ? h.Ay.getByName(h.Ay.convertSurrogateToName(a.emoji_name, !1)) : null, g = (0, d.gU)(t) ?? o.N$i;
        return null != t && _ ? (0, i.jsxs)(o.DUT, {
            className: T.NV,
            onClick: () => {
                n(), l(), (0, p.uh)(t.guild_id, t.id)
            },
            children: [null != x || null != j ? (0, i.jsx)(r.A, {
    ...
    G = e => {
        ...
        n.useEffect(() => {
            ...
            !0 !== c && C.default.track(I.HAw.OPEN_MODAL, {
                type: y.H,
                guild_id: r
            })
        }, [r, c]);
        ...
        return null == d ? null : null == u ? (0, i.jsx)(t.Modal, {
            transitionState: l,
            ...
            children: (0, i.jsxs)("div", {
                ...
                children: [(0, i.jsx)(m.Ay, {
                ...
                }), null != u.description ? (0, i.jsx)(o.Text, {
                    ...
                    className: T.fF,
                    children: u.welcome_channels?.map((e, l) => (0, i.jsx)(w, {
                        channelData: e,
                        trackOptionClick: () => A(l),
                        onClose: a
                    }, `${e.channel_id}-${l}`))
                })]
            })
