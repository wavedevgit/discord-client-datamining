...
let k = s.memo(function e(t) {
    let n, {
        ...
        Y = (0, r.bG)([p.A], () => l.type === G.lAJ.THREAD_STARTER_MESSAGE && W.state === A.a.LOADED ? p.A.getChannel(W.message.channel_id) : null),
        z = m.X6.useSetting(),
        q = m.hD.useSetting(),
        X = m.rs.useSetting(),
        J = m.kt.useSetting(),
        ...
        ei = (0, I.Ay)(l),
        es = (0, r.bG)([p.A], () => l.hasFlag(G.pr7.HAS_THREAD) && p.A.getChannel(g.default.castMessageIdAsChannelId(l.id))),
