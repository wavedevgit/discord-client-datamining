...
function E(e) {
    ...
    } = a.useContext(g.a), B = (0, a.useRef)(null), U = (0, b.Yh)(R), L = R.userStatus?.completedAt != null, D = a.useMemo(() => R.config.features.includes(T.Li.FULL_EPISODE_VIDEO_QUEST), [R.config.features]), F = (0, p.Kr)(e => e.videoProgress[R.id] ?? p.yc, o.x), M = (0, p.Kr)(e => e.setVideoProgress), j = (0, s.g)(L, F, U.progressSeconds), [W] = a.useState(() => d.A.getEffectiveConnectionSpeed()), N = L ? void 0 : Math.max(F.maxTimestampSec, U.progressSeconds), {
        videoAsset: Q,
        videoAssetType: G
    } = (0, C.A)(B, W, j, I, !1), q = (0, a.useRef)(null), H = a.useCallback(e => {
        q.current = e
    }, []), K = a.useMemo(() => (0, f.L)({
        quest: R,
        location: T.rE.VIDEO_MODAL
    }), [R]), Y = (0, a.useRef)(0), z = (0, a.useRef)(!1), {
    ...
    let eu = (0, y.A)(R),
        ...
        eE = a.useCallback((e, r) => {
            M(R.id, e, r), (0, u.Gn)(R.id, U.taskType, e), n(e);
            let a = D && e >= t && !z.current;
            (e >= Y.current || a) && (a && (z.current = !0), Y.current = e + T.aA + Math.random() * T.A6, L || R.userStatus?.enrolledAt == null || (0, m.zv)(R, e), el())
        ...
        eR = a.useCallback(() => (0, r.jsx)(S.A, {
            videoRef: B,
            onTrackQuestContentClick: es,
            orientation: k
        }), [es, k]);
    return (0, r.jsx)(l.Ft, {
        ref: B,
