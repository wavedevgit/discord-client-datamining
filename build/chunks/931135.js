...
function P(e) {
    ...
    } = a.useContext(S.a), w = (0, a.useRef)(null), B = (0, m.Yh)(U), D = U.userStatus?.completedAt != null, M = a.useMemo(() => U.config.features.includes(E.Li.FULL_EPISODE_VIDEO_QUEST), [U.config.features]), j = (0, p.Kr)(e => e.videoProgress[U.id] ?? p.yc, o.x), F = (0, p.Kr)(e => e.setVideoProgress), Q = (0, s.g)(D, j, B.progressSeconds), [N] = a.useState(() => d.A.getEffectiveConnectionSpeed()), W = D ? void 0 : Math.max(j.maxTimestampSec, B.progressSeconds), {
        videoAsset: G,
        videoAssetType: q
    ...
    let ec = (0, y.A)(U),
        ...
        eI = a.useCallback((e, r) => {
            ...
            let a = M && e >= t && !$.current;
            (e >= z.current || a) && (a && ($.current = !0), z.current = e + E.aA + Math.random() * E.A6, D || U.userStatus?.enrolledAt == null || (0, b.zv)(U, e), ed())
