...
function k(e) {
    let {
        ...
        onClose: F
    } = s.useContext(g.a), Y = (0, s.useRef)(null), H = (0, v.Yh)(Q), K = Q.userStatus?.completedAt != null, G = !K, $ = s.useMemo(() => Q.config.features.includes(y.Li.FULL_EPISODE_VIDEO_QUEST), [Q.config.features]), q = (0, _.Kr)(e => e.videoProgress[Q.id] ?? _.yc, a.x), W = (0, _.Kr)(e => e.setVideoProgress), z = (0, _.Kr)(e => e.volume), Z = (0, _.Kr)(e => e.muted), X = (0, _.Kr)(e => e.setVolume), J = (0, _.Kr)(e => e.setMuted), ee = (0, i.g)(K, q, H.progressSeconds), [et] = s.useState(() => d.A.getEffectiveConnectionSpeed()), en = Math.max(q.maxTimestampSec, H.progressSeconds), er = K ? void 0 : (0, h.vd)(en, q.duration), {
        videoAsset: es,
        videoAssetType: ea
    } = (0, x.A)(Y, et, ee, w, !1), el = s.useCallback(e => {
        let {
            hasVideoAsset: t,
            playerState: n,
            pauseReason: r
        } = e;
        return t || null != ea ? n === l.Q6.PAUSED && r === l.KB.FOCUS ? O.intl.string(O.t.w6PeBF) : (0, c.u)({
            hasVideoAsset: t,
            playerState: n,
            pauseReason: r
        }) : (0, E.isWeb)() ? O.intl.string(O.t["E1du/q"]) : O.intl.string(O.t["rStN/7"])
    }, [ea]), ei = (0, s.useRef)(null), eu = s.useCallback(e => {
        ei.current = e
    }, []), eo = s.useMemo(() => (0, p.L)({
        quest: Q,
        location: y.rE.VIDEO_MODAL
    }), [Q]), ec = (0, s.useRef)(0), ed = (0, s.useRef)(!1), {
    ...
    let eI = (0, I.A)(Q),
        ...
        ey = s.useCallback(() => Y.current?.currentTime ?? null, []),
        {
            ...
            getCurrentVideoTime: ey,
            onAnalytics: eD,
            emitIntervalMs: o.KI,
            minSegmentDurationMs: o._4
        }),
        eN = (0, s.useRef)(null),
        eM = s.useCallback((e, t) => {
            switch (eO(e, t), e) {
                case l.Q6.PLAYING:
        ...
        ej = s.useCallback((e, r) => {
            W(Q.id, e, r), (0, m.Gn)(Q.id, H.taskType, e), n(e);
            let s = $ && e >= t && !ed.current;
            (e >= ec.current || s) && (s && (ed.current = !0), ec.current = e + y.aA + Math.random() * y.A6, K || Q.userStatus?.enrolledAt == null || (0, h.zv)(Q, e), eT())
        }, [Q, H.taskType, t, K, $, eT, W, n]),
        eB = s.useCallback((e, t) => {
        ...
        eY = s.useCallback((e, t) => {
            eA(e, t)
        }, [eA]),
        eH = s.useMemo(() => (0, S.tW)(Q, S.fY.VIDEO_PLAYER_CAPTION, void 0, !1), [Q]),
        eK = s.useCallback(() => (0, r.jsxs)("div", {
            className: L.A,
            children: [(0, r.jsx)(C.A, {}), (0, r.jsx)(u.K0, {
        ...
        eG = s.useCallback(() => (0, r.jsx)(A.A, {
            videoRef: Y,
            onTrackQuestContentClick: ex,
            orientation: V
        }), [ex, V]);
    return (0, r.jsx)(o.Ft, {
        ref: Y,
