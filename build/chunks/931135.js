...
function E(e) {
    ...
    } = a.useContext(g.a), U = (0, a.useRef)(null), B = (0, b.Yh)(R), L = R.userStatus?.completedAt != null, D = a.useMemo(() => R.config.features.includes(T.Li.FULL_EPISODE_VIDEO_QUEST), [R.config.features]), F = (0, p.Kr)(e => e.videoProgress[R.id] ?? p.yc, o.x), M = (0, p.Kr)(e => e.setVideoProgress), j = (0, s.g)(L, F, B.progressSeconds), [W] = a.useState(() => d.A.getEffectiveConnectionSpeed()), N = L ? void 0 : Math.max(F.maxTimestampSec, B.progressSeconds), {
        videoAsset: Q,
        videoAssetType: G
    } = (0, C.A)(U, W, j, I, !1), q = (0, a.useRef)(null), H = a.useCallback(e => {
        q.current = e
    }, []), K = a.useMemo(() => (0, f.L)({
        quest: R,
