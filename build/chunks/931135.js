...
function V(e) {
    ...
    } = a.useContext(v.a), N = (0, a.useRef)(null), Q = (0, S.Yh)(B), W = B.userStatus?.completedAt != null, K = !W && j, q = a.useMemo(() => B.config.features.includes(A.Li.FULL_EPISODE_VIDEO_QUEST), [B.config.features]), G = (0, b.Kr)(e => e.videoProgress[B.id] ?? b.yc, o.x), H = (0, b.Kr)(e => e.setVideoProgress), Y = (0, b.Kr)(e => e.volume), z = (0, b.Kr)(e => e.muted), $ = (0, b.Kr)(e => e.setVolume), X = (0, b.Kr)(e => e.setMuted), Z = (0, l.g)(W, G, Q.progressSeconds), [J] = a.useState(() => d.A.getEffectiveConnectionSpeed()), ee = Math.max(G.maxTimestampSec, Q.progressSeconds), et = W ? void 0 : (0, f.vd)(ee, G.duration), {
        videoAsset: en,
        videoAssetType: er
    } = (0, x.A)(N, J, Z, O, !1), ea = a.useCallback(e => {
        let {
            hasVideoAsset: t,
            playerState: n,
            pauseReason: r
        } = e;
        return t || null != er ? n === i.Q6.PAUSED && r === i.KB.FOCUS ? I.intl.string(I.t.w6PeBF) : (0, c.u)({
            hasVideoAsset: t,
            playerState: n,
            pauseReason: r
        }) : (0, u.isWeb)() ? I.intl.string(I.t["E1du/q"]) : I.intl.string(I.t["rStN/7"])
    }, [er]), eo = (0, a.useRef)(null), ei = a.useCallback(e => {
        eo.current = e
    }, []), el = a.useMemo(() => (0, g.L)({
        quest: B,
        location: A.rE.VIDEO_MODAL
    }), [B]), es = (0, a.useRef)(0), ec = (0, a.useRef)(!1), {
    ...
    let eT = (0, E.A)(B),
        ...
        eN = a.useCallback((e, r) => {
            H(B.id, e, r), (0, p.Gn)(B.id, Q.taskType, e), n(e);
            let a = q && e >= t && !ec.current;
            (e >= es.current || a) && (a && (ec.current = !0), es.current = e + A.aA + Math.random() * A.A6, W || B.userStatus?.enrolledAt == null || (0, f.zv)(B, e), ex())
