/** chunk id: 836731 params = (module,exports,require) **/
n.d(t, {
    GT: () => N,
    L4: () => m,
    Wi: () => I,
...
function I(e, t) {
    ...
    return (0, s.Qd)(r) ? null == n || null == l || null == r ? 1 : (0, a.Lt)(l.flags ?? 0, d.D.BYPASSES_VERIFICATION) || (0, a.Lt)(l.flags ?? 0, d.D.COMPLETED_ONBOARDING) || null != l.isPending && !l.isPending ? 2 : 1 : 0
}
...
function S(e, t) {
    let n = (0, i.bG)([o.default], () => o.default.locale),
        l = (0, i.bG)([E.Ay], () => E.Ay.getMember(t, e), [t, e]),
        a = l?.joinedAt;
    return r.useMemo(() => null == a ? "" : new Date(a).toLocaleDateString(n, A), [a, n])
}