/** chunk id: 606865 params = (module,exports,require) **/
s.d(t, {
    A: () => N
});
var i = s(627968);
...
let w = e => {
        let {
            ...
            userId: t?.id,
            size: c._3J.SIZE_56
        }), C = j.Ay.getName(t), o = t.username !== C && s === m.o.SUCCESS, p = s === m.o.FAIL;
        return (0, i.jsxs)("div", {
            className: S.El,
            children: [(0, i.jsx)(c.euF, {
                ...
                children: [p ? (0, i.jsxs)(i.Fragment, {
                    ...
                    children: (0, i.jsx)(c.DUT, {
                        onClick: () => {
                            var e;
                            return e = t.id, void(f.A.hasLayers() && (0, h.jH)(), x.A.openPrivateChannel({
                                recipientIds: e
                            }), r())
                        },
                        className: S.t0,
    ...
    N = e => {
        ...
        return l > 0 && (h = A.intl.formatToPlainString(A.t.iWtOfC, {
            numReferrals: _
        })), 0 === _ && (h = A.intl.string(A.t["7VBEue"])), (0, i.jsxs)("div", {
            className: S.Jc,
            children: [(0, i.jsx)(c.DUT, {
                onClick: r,
                className: S.cG,
