...
function x(e) {
    let t = (0, l.bG)([d.A], () => d.A.getGuild(e.guild_id)),
        ...
        x = (0, l.bG)([h.A], () => null != t && h.A.can(_.xBc.ADMINISTRATOR, t)),
    ...
    return i.useMemo(() => !(!T || !v || !S || null == C || C <= 17.06 || e.type !== _.rbe.GUILD_TEXT || null == t || A.default.age(t.id) < f || null == t.premiumSubscriberCount || 0 !== t.premiumSubscriberCount || n < 10 || m?.id == null || A.default.age(m.id) > E) && (x || I), [T, v, S, e.type, t, n, C, m?.id, x, I])
}