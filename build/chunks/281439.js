/** chunk id: 281439, original params: t,e,a (module,exports,require) **/
a.d(e, {
...
let R = [k.Dmq.PAST_DUE, k.Dmq.PAUSED, k.Dmq.BILLING_RETRY],
    v = t => {
        let {
            ...
            initialStep: b
        } = t, F = r.useRef(new s.OH), [W, q] = r.useState(null), H = (0, D.EL)(j)?.planId, B = null != H ? D.Ay.getPremiumType(H) : null;
        ...
        let [K, Y, G, Q] = (0, L.U)(b, j, a), X = (0, _.H)(), Z = (0, f.f9)(), {
            churnUserDiscountOffer: $,
            isFetchingChurnDiscountOffer: z
        } = (0, f.g5)(!Z || j.status === k.Dmq.CANCELED && K !== g.g.CONFIRM_DISCOUNT), J = (0, A.tQ)(j, x.gD.PREMIUM_MONTH_TIER_2, $), [tt] = (0, y.Kq)({
            subscriptionId: j.id,
        ...
        }), tn = (0, p.$g)(ta.amount, ta.currency), tr = r.useMemo(() => (0, E.A)(), []);
        r.useEffect(() => {
            S.default.track(k.HAw.CANCELLATION_FLOW_STARTED, {
                location_stack: a,
                load_id: tr,
                ...(0, U.j)(j)
            })
        }, [a, j, tr]);
        let [ts, ti] = r.useState(null), tl = r.useCallback(() => {
            switch (K) {
                case g.g.CONFIRM:
                    return (0, n.jsx)(T.r, {});
        ...
        }, [K]), tu = r.useCallback(async () => {
            if (S.default.track(k.HAw.CANCELLATION_FLOW_COMPLETED, {
                    location_stack: a,
                    load_id: tr,
                    ...(0, U.j)(j)
                }), R.includes(j.status)) await (0, o.M2)(j.id, a, e);
            else {
                ...
                await (0, o.nV)(j, {
                    ...
                    amount: 0,
                    currency: j.currency
                }, (0, D.UC)(n, j.currency, j.paymentSourceId), a, e)
            }
            C.Ay.fireSurveyAction(u.w.NITRO_UNSUBBED)
        }, [j, a, e, tr]), tc = async () => {
            if (null == $) throw Error("Churn user discount offer is null");
            j.status === k.Dmq.CANCELED ? await (0, o._D)(j, $) : await c.Bo.post({
        ...
        return (0, n.jsx)(m.f5, {
            ...
            children: (0, n.jsxs)(N.CancellationContext.Provider, {
                value: {
                    ...
                    premiumType: B,
                    onClose: () => {
                        i(), S.default.track(k.HAw.CANCELLATION_FLOW_STEP, {
                            from_step: g.T[K],
                            to_step: null,
