/** chunk id: 978733 params = (module,exports,require) **/
"use strict";
n.d(t, {
    A: () => Y
}), n(321073);
...
let $ = e => {
        ...
        return (0, l.jsx)("div", {
            className: B.Ei,
            "aria-label": H.intl.formatToPlainString(H.t.PCs0oo, {
                numRoles: n.length
            }),
    ...
    Y = e => {
        let t, {
            ...
            er = (t = f.id, i.useCallback(() => (ei(!1), w.A.hideAdminOnboarding(t, !0)), [t, ei])),
            {
                ...
                let s, a, r, d, {
                    ...
                    C = (s = c?.id, a = (0, m.bG)([N.A], () => null != s ? N.A.getSortedRoles(s) : void 0), i.useMemo(() => {
                        let e, t, i, s, r, o, d, m, _ = new q,
                            j = h?.isMediaChannel() === !0;
                        return null == c || null == h || j || null == a || _.addStep((e = (0, p.A)(h) ? u.kg(z.xBc.VIEW_CHANNEL, z.xBc.SEND_MESSAGES) : z.xBc.SEND_MESSAGES, i = (t = null != c ? (0, k.N)(a, h, e).filter(e => h.permissionOverwrites.hasOwnProperty(e.id) || (0, T.Oy)(e)) : []).length > 0, s = t.some(e => (0, T.Oy)(e)), {
                            ...
                            clickHandler: () => {
                                K(G._G.PERMISSIONS), (0, x.mMO)(async () => {
                                    let {
                                        default: i
                                    } = await n.e("17110").then(n.bind(n, 698325));
                                    return b(!0), n => (0, l.jsx)(i, {
                                        ...n,
                                        channel: h,
                                        guild: c,
                                        permission: e,
                            ...
                            clickHandler: () => {
                                K(G._G.TAGS), g.Ay.open(h.id), (0, x.mMO)(async () => {
                                    let {
                                        default: e
                            ...
                            clickHandler: () => {
                                K(G._G.DEFAULT_REACTION), (0, x.mMO)(async () => {
                                    let {
                                        default: e
                            ...
                            description: j ? H.intl.string(H.t["8hI5vr"]) : H.intl.format(H.t.ysxcAw, {
                                onClick: e => {
                                    null != m && (e.preventDefault(), e.stopPropagation(), (0, D.zd)(), (0, x.mMO)(async () => {
                                        let {
                                            default: e
                    ...
                    S = C.isAllDone(),
                    y = v || A || (t = h.id, r = R.default.extractTimestamp(t), !o()().isBefore(o()(r).add(o().duration(15, "days"))));
                return d = i.useRef(0), i.useEffect(() => (j || !S || y ? clearTimeout(d.current) : d.current = setTimeout(() => {
                    _()
                }, 60 * I.A.Millis.SECOND), () => clearTimeout(d.current)), [S, y, _, j]), {
                    onboardingSteps: C,
                    isHidden: A,
                    isDismissed: v,
                    isAllDone: S
        ...
        return ((0, _.Ay)(() => {
            ...
            let {
                ...
                guildId: s,
                channel: a
            } = e, r = (0, m.bG)([N.A], () => null != s ? N.A.partitionVersion(s) : void 0), o = i.useCallback(() => {
            ...
            s && em || eg(!0)
        }), null == et) ? null : (0, v.Fo)(f) ? r || 0 !== ee.size ? ee.size > 0 ? null : (0, l.jsx)(A.A, {
            guild: et
        }) : (0, l.jsxs)(l.Fragment, {
            children: [(0, l.jsx)(A.A, {
                guild: et
            }), (0, l.jsx)(C.D, {})]
        }) : em && en ? ex ? s ? null : (0, l.jsx)(b.A, {
            channel: f
        }) : (0, l.jsx)(l.Fragment, {
            children: el((e, t) => t ? (0, l.jsx)(d.animated.div, {
                style: e,
                className: B.kL,
                children: (0, l.jsxs)("div", {
                    ...
                    }), es((e, t) => t ? (0, l.jsx)(d.animated.div, {
                        style: e,
                        className: B.qI,
                        children: (0, l.jsx)("ol", {
                            className: B.D4,
                            children: eo.getSteps().map(e => (0, l.jsxs)(x.DUT, {
                                tag: "li",
                                "aria-label": e.name,
                                onClick: () => ea(e),
                                className: a()(B._h, {
                                ...
                                children: [e.shouldWarn ? (0, l.jsx)(x.EpV, {
                                    size: "custom",
                                    width: 20,
                                    height: 20,
                                    color: h.A.colors.ICON_FEEDBACK_CRITICAL,
                                    className: B.FY
                                }) : e.isDone ? (0, l.jsx)(x.fkz, {
