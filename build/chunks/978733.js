    ...
    Q = e => {
                ...
                let s, a, r, d, {
                    ...
                    N = (s = c?.id, a = (0, m.bG)([T.A], () => null != s ? T.A.getSortedRoles(s) : void 0), i.useMemo(() => {
                        ...
                        return null == c || null == h || j || null == a || _.addStep((e = (0, p.A)(h) ? u.kg(G.xBc.VIEW_CHANNEL, G.xBc.SEND_MESSAGES) : G.xBc.SEND_MESSAGES, i = (t = null != c ? (0, w.N)(a, h, e).filter(e => h.permissionOverwrites.hasOwnProperty(e.id) || (0, C.Oy)(e)) : []).length > 0, s = t.some(e => (0, C.Oy)(e)), {
                            ...
                            clickHandler: () => {
                                W(U._G.PERMISSIONS), (0, x.mMO)(async () => {
                                    let {
                                        default: i
                            ...
                            clickHandler: () => {
                                W(U._G.TAGS), g.Ay.open(h.id), (0, x.mMO)(async () => {
                                    let {
                                        default: e
                            ...
                            clickHandler: () => {
                                W(U._G.DEFAULT_REACTION), (0, x.mMO)(async () => {
                                    let {
                                        default: e
                            ...
                            description: j ? z.intl.string(z.t["8hI5vr"]) : z.intl.format(z.t.ysxcAw, {
                                onClick: e => {
                                    null != m && (e.preventDefault(), e.stopPropagation(), (0, P.zd)(), (0, x.mMO)(async () => {
                                        let {
                                            default: e
        ...
        return ((0, _.Ay)(() => {
            ...
            let {
                ...
                guildId: s,
                channel: a
            } = e, r = (0, m.bG)([T.A], () => null != s ? T.A.partitionVersion(s) : void 0), o = i.useCallback(() => {
        ...
        }) : ec && ee ? em ? s ? null : (0, l.jsx)(j.A, {
            channel: f
        }) : (0, l.jsx)(l.Fragment, {
            children: et((e, t) => t ? (0, l.jsx)(d.animated.div, {
                style: e,
                className: H.kL,
                children: (0, l.jsxs)("div", {
                    ...
                    }), el((e, t) => t ? (0, l.jsx)(d.animated.div, {
                        style: e,
                        className: H.qI,
                        children: (0, l.jsx)("ol", {
                            className: H.D4,
                            children: ea.getSteps().map(e => (0, l.jsxs)(x.DUT, {
                                tag: "li",
                                "aria-label": e.name,
                                onClick: () => ei(e),
                                className: a()(H._h, {
