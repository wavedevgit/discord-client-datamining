        ...
        handlePrimaryAction: i.useCallback(e => {
            switch (e.type) {
                ...
                case m.c.DECLINE_FRIEND_REQUEST:
                    if (null == e.userId) return;
                    o.A.removeRelationship(e.userId, {
                        location: "overlay-friends-widget"
                    }), (0, A.YX)(_.uss.FRIENDS, {
                        type: A.Z5.FRIEND_REQUEST,
                ...
                case m.c.CANCEL_FRIEND_REQUEST:
                    if (null == e.userId) return;
                    o.A.cancelFriendRequest(e.userId, {
                        location: "overlay-friends-widget"
                    }), (0, A.YX)(_.uss.FRIENDS, {
                        type: A.Z5.FRIEND_REQUEST,
                    ...
                    (async () => {
                        try {
                            ...
                            let e = await s.A.getOrEnsurePrivateChannel(n),
                                l = I.A.getChannel(e);
                            if (null == l) return;
                            !0 === t.extra.fake_inventory_item ? await (0, c.J)({
                                channel: l,
                                content: T.intl.formatToPlainString(T.t.UVBA9g, {
            ...
            switch (e.type) {
                ...
                case m.K.DM_CHANNEL: {
                    ...
                    (0, A.YX)(_.uss.FRIENDS, {
                        ...
                        let {
                            default: e
                        } = await Promise.all([n.e("97262"), n.e("42128"), n.e("47895")]).then(n.bind(n, 92016));
                        return n => (0, l.jsx)(e, {
                            ...n,
                            user: i,
                            channel: t,
                ...
                case m.K.GUILD_TEXT_CHANNEL: {
                    ...
                    }), t.isModeratorReportChannel?.() ? (0, a.L3)(e.event, async () => {
                        let {
                            default: e
