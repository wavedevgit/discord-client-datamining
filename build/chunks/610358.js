                    ...
                    (async () => {
                        try {
                            await (0, h.D$)({
                                ...
                                widgetType: A.uss.FRIENDS
                            })
                        } catch {}
                    })(), (0, d.YX)(A.uss.FRIENDS, {
        ...
        handleContextMenu: i.useCallback(e => {
            switch (e.type) {
                ...
                case g.K.GUILD_TEXT_CHANNEL: {
                    ...
                    }), t.isModeratorReportChannel?.() ? (0, r.L3)(e.event, async () => {
                        let {
                            default: e
                ...
                case g.K.VOICE_USER: {
                    ...
                    (0, d.YX)(A.uss.FRIENDS, {
                        ...
                        let {
                            default: i
                        } = await Promise.all([n.e("97262"), n.e("87997"), n.e("71001")]).then(n.bind(n, 180812));
                        return n => (0, l.jsx)(i, {
                            ...n,
                            user: t,
                            guildId: a ?? void 0,
                            channelId: e.channelId,
                            mediaEngineContext: f.x.DEFAULT,
                            appContext: A.BRT.OVERLAY
                        })
                    });
                    break
