/** chunk id: 89791 params = (module,exports,require) **/
"use strict";
n.d(t, {
    A: () => c
});
...
function c(e) {
    let {
        ...
        publishedOnly: !1
    }), o = t.currentPeriod, c = s.useMemo(() => a.map(e => {
        let t = o?.ppgs[e.id];
        return {
            ...t ?? {},
            key: e.id,
            listing: e,
            paymentsCount: t?.purchase_count ?? 0
        }
    }).filter(e => e.listing.published || e.paymentsCount > 0), [a, o?.ppgs]);
    return null == a || 0 === a.length ? null : (0, i.jsx)(l.Ay, {
        columns: d,
        data: c,
