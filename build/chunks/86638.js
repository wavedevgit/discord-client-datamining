...
function w(e) {
    let {
        ...
        wishlistId: _,
        isItemOwned: A
    } = e, T = l.useRef(null), b = l.useRef(m);
    l.useEffect(() => {
        b.current = m
    }, [m]), l.useEffect(() => {
        let e = T.current;
...
function L(e) {
    let {
        ...
        ...o
    } = e, d = (0, g.h)(t.sku?.applicationId), u = l.useCallback(() => {
        d?.guildId != null && (0, x.R)({
            skuId: t.sku.id,
    ...
    }, [t.sku.id, t.sku.applicationId, d?.guildId, r]), m = l.useCallback(() => {
        let e = a.id === s.id;
        (0, p.a)(t.sku, {
            isGift: !e,
            giftRecipient: a,
...
function O(e) {
    ...
    }, [t.sku, n, d.id, o]), p = c && t.sku.productLine === N.EZt.COLLECTIBLES && t.sku.tenantMetadata?.collectibles?.type !== r.R.PROFILE_EFFECT && t.sku.tenantMetadata?.collectibles?.type !== r.R.NAMEPLATE;
    return (0, i.jsx)(w, {
        item: t,
        wishlistOwner: n,
        isItemOwned: a,
...
function D(e) {
    let {
        ...
        analyticsLocations: o
    } = (0, u.Ay)(...s ?? [], t.sku?.productLine === N.EZt.SOCIAL_LAYER_GAME_ITEM ? c.A.SLAYER_STOREFRONT_WISHLIST_ITEM_CARD : []), g = (0, d.bG)([_.default], () => _.default.getCurrentUser()), [m, x] = l.useState(!1), p = (0, d.bG)([A.A], () => A.A.hasSentGift(t.skuId, n.id), [n, t.skuId]), f = l.useMemo(() => !0 === t.isOwned || p, [t.isOwned, p]);
