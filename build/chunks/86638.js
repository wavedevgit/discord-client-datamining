...
function w(e) {
    let {
        ...
        wishlistId: f,
        isItemOwned: A
    } = e, j = l.useRef(null), N = l.useRef(m);
    l.useEffect(() => {
        N.current = m
    }, [m]), l.useEffect(() => {
        let e = j.current;
...
function D(e) {
    ...
    }, [t.sku, n, d.id, o]), p = c && t.sku.productLine === y.EZt.COLLECTIBLES && t.sku.tenantMetadata?.collectibles?.type !== r.R.PROFILE_EFFECT && t.sku.tenantMetadata?.collectibles?.type !== r.R.NAMEPLATE;
    return (0, i.jsx)(w, {
        item: t,
        wishlistOwner: n,
        isItemOwned: a,
...
function M(e) {
    let {
        ...
        analyticsLocations: o
    } = (0, u.Ay)(...s ?? [], t.sku?.productLine === y.EZt.SOCIAL_LAYER_GAME_ITEM ? c.A.SLAYER_STOREFRONT_WISHLIST_ITEM_CARD : []), g = (0, d.bG)([A.default], () => A.default.getCurrentUser()), [m, x] = l.useState(!1), p = (0, d.bG)([j.A], () => j.A.hasSentGift(t.skuId, n.id), [n, t.skuId]), f = l.useMemo(() => t.skuProductLine !== y.EZt.PREMIUM && (!0 === t.isOwned || p), [t.isOwned, t.skuProductLine, p]);
