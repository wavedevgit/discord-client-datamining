...
function C(e) {
    let {
        ...
        isItemOwned: b
    } = e, C = l.useRef(null), k = l.useRef(f), [R, O] = l.useState(!1);
    l.useEffect(() => {
        k.current = f
    }, [f]), l.useEffect(() => {
        let e = C.current;
    ...
    let {
        trackUserProfileWishlistAction: w
    } = (0, m.NJ)(), L = l.useCallback(() => {
        null != t.sku && (w({
            wishlistId: E,
    ...
    }, [v, t.sku, E, w]), P = null != d ? (0, i.jsx)("div", {
        ref: C,
        className: S.BU,
        children: d
    }) : null, {
...
function k(e) {
    let {
        ...
        ...o
    } = e, c = (0, g.h)(t.sku?.applicationId), d = l.useMemo(() => () => {
...
function R(e) {
    let {
        ...
        if (null != t.sku && t.sku.productLine === T.EZt.COLLECTIBLES && t.sku.tenantMetadata?.collectibles?.type !== r.R.PROFILE_EFFECT) return S.mn
    }, [t.sku]), g = l.useMemo(() => () => {
        if (null == t.sku) return;
        let e = n.id === o.id;
        (0, v._)({
...
function O(e) {
    ...
    } = (0, u.Ay)(...s ?? [], t.sku?.productLine === T.EZt.SOCIAL_LAYER_GAME_ITEM ? d.A.SLAYER_STOREFRONT_WISHLIST_ITEM_CARD : []), g = (0, o.bG)([x.default], () => x.default.getCurrentUser()), [m, p] = l.useState(!1), h = (0, o.bG)([f.A], () => f.A.hasSentGift(t.skuId, n.id), [n, t.skuId]), _ = l.useMemo(() => !0 === t.isOwned || h, [t.isOwned, h]);
