...
function N(e) {
    let {
        ...
        isItemOwned: N
    } = e, S = l.useRef(null), C = l.useRef(f), [R, k] = l.useState(!1);
    l.useEffect(() => {
        C.current = f
    }, [f]), l.useEffect(() => {
        let e = S.current;
    ...
    }, [v, t.sku, E, L]), w = null != d ? (0, i.jsx)("div", {
        ref: S,
        className: y.BU,
        children: d
    }) : null, P = l.useMemo(() => {
    ...
    return null == t.sku ? null : (0, i.jsxs)("div", {
        ...
        children: [(0, i.jsx)("div", {
            className: R ? y.B8 : void 0,
            children: P
        }), w, n.id === a.id && (0, i.jsx)(A.A, {
            wishlistId: E,
            sku: t.sku,
            analyticsLocations: T,
            isHoveringOrFocusing: x,
...
function C(e) {
    let {
        ...
        if (null != t.sku && t.sku.productLine === E.EZt.COLLECTIBLES && t.sku.tenantMetadata?.collectibles?.type !== r.R.PROFILE_EFFECT) return y.mn
    }, [t.sku]), g = l.useMemo(() => () => {
        if (null == t.sku) return;
        let e = n.id === o.id;
        (0, v._)({
...
function R(e) {
    ...
    } = (0, u.Ay)(...s ?? [], t.sku?.productLine === E.EZt.SOCIAL_LAYER_GAME_ITEM ? d.A.SLAYER_STOREFRONT_WISHLIST_ITEM_CARD : []), g = (0, o.bG)([x.default], () => x.default.getCurrentUser()), [m, p] = l.useState(!1), h = (0, o.bG)([f.A], () => f.A.hasSentGift(t.skuId, n.id), [n, t.skuId]), _ = l.useMemo(() => !0 === t.isOwned || h, [t.isOwned, h]);
