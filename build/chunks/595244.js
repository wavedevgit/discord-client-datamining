...
function k(e) {
    let {
        ...
        (null == t ? void 0 : t.id) != null && ((0, g.u)(null == t ? void 0 : t.id), null == s || s(), O.default.track(T.HAw.OAUTH2_AUTHORIZE_SUCCESS_GO_TO_GUILD_CLICKED, {
            application_id: null == n ? void 0 : n.id,
            guild_id: null == t ? void 0 : t.id
        }))
    }, [s, null == n ? void 0 : n.id, null == t ? void 0 : t.id]), l = h.h.getField("entrypoint"), c = i.useCallback(() => {
        null == s || s(), O.default.track(T.HAw.OAUTH2_AUTHORIZE_SUCCESS_CLOSE_CLICKED, {
            application_id: null == n ? void 0 : n.id
        })
    }, [s, null == n ? void 0 : n.id]), d = window.location.pathname.startsWith(T.BVt.APPLICATION_DIRECTORY), f = i.useCallback(() => {
        (null == n ? void 0 : n.id) != null && (null == s || s(), null != l && (0, m.pX)(""), setImmediate(() => {
    ...
    }, [null == n ? void 0 : n.id, s, l]), p = (0, u.bG)([b.A, E.A], () => E.A.getChannel(b.A.getChannelId())), _ = (0, u.bG)([y.A], () => y.A.can(T.xBc.SEND_MESSAGES, p)), v = null != t, I = null == t && _ && (!d || null != l), N = [];
