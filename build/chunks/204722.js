...
let H = s.memo(function(e) {
        let {
        ...
        } = (0, m.Ay)(), ei = (0, v.A)(z, "rtc-activity-panel"), es = B(z, Y, R), {
            enabled: el
        } = S._.useConfig({
            ...
            (0, f.X)(et, f.O.LEAVE_ACTIVITY), g.A.leaveActivity({
                location: t,
                applicationId: e,
                showFeedback: !0
            })
        }, [et]), eg = s.useCallback(e => () => {
...
function K(e) {
    let {
        ...
        onClick: n,
        renderCoachmark: l
    } = e, r = s.useRef(null), [a, o] = (0, C.kn)([c.M.GAME_DETECTION_CREATE_GAME_SERVER_COACHMARK], void 0, !0), d = s.useCallback(() => {
        o(P.i.TAKE_ACTION), n()
    }, [o, n]);
...
function W(e) {
    ...
    let [r, a] = (0, C.kn)([c.M.GAME_SHOP_RTC_POPOVER], P.m.ACCOUNT_NAME_ZONE, !0), o = s.useCallback(() => {
        (0, j.X)({
            guildId: n
        })
    }, [n]), d = s.useCallback(() => {
    ...
    return (0, i.jsxs)(i.Fragment, {
        children: [(0, i.jsx)(G.A, {
            ...
            icon: u.U1X,
            ref: l
        }), r === c.M.GAME_SHOP_RTC_POPOVER ? (0, i.jsx)(R.A, {
            onActionClick: d,
            onRequestClose: A,
            targetElementRef: l,
            position: "top",
