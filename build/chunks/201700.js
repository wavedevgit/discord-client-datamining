/** chunk id: 201700 params = (module,exports,require) **/
a.d(e, {
    default: () => g
});
var i = a(627968),
...
function g(t) {
    let {
        ...
        onClose: a,
        entry: g
    } = t, [p, b] = n.useState(g.description ?? ""), [h, m] = n.useState(g.primaryCategoryId ?? c.mU.UNCATEGORIZED), [C, x] = n.useState(!1), [_, y] = n.useState(null), I = async () => {
