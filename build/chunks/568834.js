/** chunk id: 568834 params = (module,exports,require) **/
n.d(t, {
    A: () => p
});
var a = n(627968),
...
function p() {
    ...
    })), [p, g] = i.useState(""), [f, v] = i.useState(20), _ = i.useMemo(() => Object.keys(l.M).filter(e => e.toLowerCase().includes(p.toLowerCase())).reverse(), [p]), b = i.useCallback(e => {
        let t = e.currentTarget;
        t.scrollHeight - t.scrollTop <= t.clientHeight + 100 && f < _.length && v(e => e + 100)
    }, [f, _.length]);
