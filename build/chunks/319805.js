/** chunk id: 319805 params = (module,exports,require) **/
"use strict";
n.d(t, {
    A: () => _
});
...
let _ = function(e) {
    let {
        ...
        j || ((0, l.zV)(m.HAw.PREMIUM_GUILD_PROMOTION_OPENED, {
            location: {
                ...e,
                section: m.JJy.CUSTOM_ROLE_ICONS_TOOLTIP
            },
            guild_id: t?.id,
            location_stack: f
        }), (0, d.A)({
    ...
    return (0, i.jsxs)("div", {
        className: h.kL,
        children: [(0, i.jsxs)(s.zEo, {
            className: h.Hc,
            children: [(0, i.jsx)("div", {
                children: x.intl.string(x.t.B9grJw)
            }), E]
        }), (0, i.jsx)(s.ayl, {
            className: h.h_,
            children: x.intl.string(x.t.I3YQeV)
        }), (0, i.jsxs)("div", {
            className: h.Mw,
            children: [(0, i.jsx)("div", {
                className: h.i1,
                ...
                onClick: () => t.features.has(m.GuildFeatures.ROLE_ICONS) ? void(0, s.mMO)(async () => {
                    let {
                        default: e
