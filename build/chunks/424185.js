/** chunk id: 424185, original params: t,i,e (module,exports,require) **/
e.d(i, {
    default: () => h
});
var l = e(627968),
...
function h(t) {
    ...
    } = t, k = (0, r.bG)([p.A], () => p.A.getSKUEligibilityEntry(f)), A = k?.state, j = (0, r.bG)([o.A], () => o.A.get(f)), m = (0, r.bG)([c.A], () => c.A.getApplication(j?.applicationId)), R = n.useRef(0), I = n.useRef(!1);
    (0, s.Ay)(() => {
        R.current = Date.now(), d.default.track(_.HAw.SLAYER_STOREFRONT_PURCHASE_ELIGIBILITY_STARTED, {
            sku_id: f,
            guild_id: x,
    ...
    return n.useEffect(() => {
        ...
        children: "ineligible" === A ? (0, l.jsxs)(l.Fragment, {
            children: [(0, l.jsx)(a.rQ0, {
                title: g.intl.string(g.t.cg0M2H)
            }), (0, l.jsx)(a.cwr, {
                children: (0, l.jsx)(a.EYj, {
                    variant: "text-md/normal",
                    color: "text-subtle",
                    children: g.intl.format(g.t.uLjkVR, {
            ...
            children: (0, l.jsxs)("div", {
                className: E.Q,
                children: [(0, l.jsx)(a.y$y, {}), (0, l.jsx)(a.EYj, {
                    variant: "text-md/normal",
                    color: "text-subtle",
