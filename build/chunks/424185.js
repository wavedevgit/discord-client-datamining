...
function E(t) {
    ...
    } = t, f = (0, a.bG)([u.A], () => u.A.getSKUEligibilityEntry(x)), k = f?.state, j = (0, a.bG)([c.A], () => c.A.get(x)), A = n.useRef(0), I = n.useRef(!1);
    (0, s.Ay)(() => {
    ...
    return n.useEffect(() => {
        ...
        children: "ineligible" === k ? (0, l.jsxs)(l.Fragment, {
