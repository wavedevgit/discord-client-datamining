/** chunk id: 424185 params = (module,exports,require) **/
e.d(i, {
    default: () => x
});
var n = e(627968),
...
function x(t) {
    ...
    } = t, f = (0, a.bG)([d.A], () => d.A.getSKUEligibilityEntry(h)), k = f?.state, j = (0, a.bG)([c.A], () => c.A.get(h)), A = l.useRef(0), I = l.useRef(!1);
    (0, s.Ay)(() => {
        A.current = Date.now(), o.default.track(_.HAw.SLAYER_STOREFRONT_PURCHASE_ELIGIBILITY_STARTED, {
            sku_id: h,
            guild_id: E,
    ...
    return l.useEffect(() => {
        ...
        children: "ineligible" === k ? (0, n.jsxs)(n.Fragment, {
            children: [(0, n.jsx)(r.rQ0, {
                title: p.intl.string(p.t.cg0M2H)
            }), (0, n.jsx)(r.cwr, {
            ...
            children: (0, n.jsxs)("div", {
                className: g.Q,
                children: [(0, n.jsx)(r.y$y, {}), (0, n.jsx)(r.EYj, {
                    variant: "text-md/normal",
                    color: "text-subtle",
