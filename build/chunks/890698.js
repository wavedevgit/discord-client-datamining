...
let y = () => (0, i.jsxs)(s.Fragment, {
    ...
    R = e => {
        ...
        let D = null != r.guild ? I.fh(r.guild) ? r.guild : I.DY(r.guild) : null,
            ...
            G = !(null != r.approximate_member_count && r.approximate_member_count > 100 || null != D && D.features.has(N.GuildFeatures.COMMUNITY)) && null != P,
            F = null,
            M = (0, o.Lt)(r.flags ?? 0, a.Q.IS_GUEST_INVITE),
            V = !1;
        if (null != D) L && (F = null == P ? C.intl.string(C.t["3rE1P8"]) : C.intl.formatToPlainString(C.t["5u47va"], {
            username: v.Ay.getFormattedName(P)
        }), r.target_type === S.yV.STREAM && null != r.target_user && (F = C.intl.formatToPlainString(C.t.x2L32Q, {
            username: v.Ay.getFormattedName(r.target_user)
        })), r.target_type === S.yV.EMBEDDED_APPLICATION && null != r.target_application && (F = null != P ? C.intl.formatToPlainString(C.t.UW1Cav, {
            username: v.Ay.getFormattedName(P)
        }) : C.intl.string(C.t.ENSuN3))), G && null == B && (t = (0, i.jsx)(u.$v, {
            className: T.Kk,
            guild: D,
            size: u.$v.Sizes.SMALL
        })), n = D.name, null != B && (n = B.name, s = (0, i.jsxs)("div", {
            children: [(0, i.jsx)(u.tK, {
                className: T.R9,
            ...
            null != U.name && "" !== U.name ? (F = C.intl.formatToPlainString(C.t["5u47va"], {
                username: e
            }), n = U.name, null != U.icon && (t = (0, i.jsx)(u.F4, {
                channel: U,
                size: c._3J.SIZE_32
            }))) : (F = C.intl.string(C.t.OsdY8B), n = e)
        } else if (null != P) {
            let e = v.Ay.getFormattedName(P, !0);
            n = C.intl.formatToPlainString(C.t["4aF92R"], {
                username: e
        ...
        return (0, i.jsxs)(c.BJc, {
            ...
            children: [(0, i.jsx)(b, {
                ...
                children: [null != F ? (0, i.jsx)(u.tK, {
                    children: F
                }) : null, (0, i.jsxs)(u.hE, {
                    className: T.DD,
                    children: [null != D ? (0, i.jsx)(p.A, {
                        guild: D,
                        className: T.n2,
                ...
                children: [(0, i.jsx)(c.BJc, {
                    direction: "vertical",
                    gap: 4,
                    children: null != B || V || r?.guild?.id === j.TA ? null : (0, i.jsx)(u.R1, {
