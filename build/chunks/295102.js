...
let v = {
    ...
    [I.uss.ACTIVITY]: {
        ...
        renderButtons: () => null,
        predicate: () => !(0, r.NI)("WidgetRenderConfig").hasFriendList
    },
    [I.uss.FRIENDS]: {
        renderWidget(e) {
            let {
    ...
    [I.uss.TEXT_CHAT_V3]: {
        ...
        renderButtons: () => null,
        predicate: () => (0, r.NI)("WidgetRenderConfig").hasChat,
        containerRenderGate: {
            stores: [l.A, S.A],
            shouldRender(e) {
                let {
