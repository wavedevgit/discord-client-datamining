...
function p(e) {
    let {
        ...
        (0, d.xi)(t, [p])
    }, [t, p]), E = (0, a.bG)([c.A], () => c.A.isBlocked(_)), x = l.useMemo(() => ({
        channelId: t,
        warningId: p,
        senderId: _,
    ...
    let C = l.useCallback(e => {
        ...
        S = l.useCallback(() => {
            (0, r.mMO)(async () => {
                let {
                    default: e
                } = await Promise.all([n.e("45033"), n.e("46717"), n.e("29733")]).then(n.bind(n, 788099));
                return n => {
                    let {
                        transitionState: l,
                        onClose: s
        ...
        I = l.useCallback(() => {
            f(), C(h.Wm.USER_BANNER_BLOCK_CONFIRM)
        }, [f, C]),
        T = l.useCallback(() => {
            f(), C(h.Wm.USER_BANNER_BLOCK_AND_REPORT_CONFIRM)
        }, [f, C]),
        N = l.useCallback(() => {
            (0, r.mMO)(async () => {
                let {
