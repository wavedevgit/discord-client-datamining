/** chunk id: 722718, original params: e,i,n (module,exports,require) **/
n.d(i, {
    A: () => v
});
var l = n(627968),
...
function v() {
    let e = (0, t.bG)([a.A], () => (0, s.kK)() ? a.A.getCurrentBuildOverride().overrides?.discord_web : null),
        ...
        [v, g] = r.useState(!1),
        A = async i => {
            if (null == i || i.id !== e?.id) try {
                g(!0), (null != i ? await (0, o.oA)(i.payload) : await (0, o.iD)()).ok && window.location.reload(!0)
            } finally {
                g(!1)
            }
        };
    return (0, l.jsxs)(d.rXV, {
        children: [i && n.length > 0 && (0, l.jsx)(d.Drp, {
            ...
            children: n.map(i => (0, l.jsx)(d.iDA, {
                id: i.id,
                label: i.id,
        ...
        }, "recent-build-overrides"), null != e && (0, l.jsx)(d.Drp, {
