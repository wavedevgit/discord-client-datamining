...
function _(e) {
    ...
    switch (A.status) {
        ...
        case c.Dmq.PAUSED:
            h === d.xc.NONE && (x.transfer.disabled = !0, x.transfer.subtext = u.intl.string(u.t.LiLRRT), x.cancel.subtext = u.intl.string(u.t["1ywaWL"]), x.cancel.disabled = !0, x.uncancel.disabled = !0)
    }
