...
class e9 extends l.PureComponent {
    ...
    handleKeyDown = e => {
        ...
        switch (e.which) {
            ...
            case e$.Ks6.ARROW_UP:
                if (l || s) return;
                if (e.preventDefault(), t) eL.A.getUploadCount(i.id, eN.C.ChannelMessage) > 0 ? eU._.dispatchToLastSubscribed(e$.jej.FOCUS_ATTACHMENT_AREA) : eU._.dispatchToLastSubscribed(e$.jej.FOCUS_MESSAGES, {
                    atEnd: !0
                });
                else {
                    let {
            ...
            case e$.Ks6.ESCAPE:
                ...
                if (eL.A.getUploadCount(i.id, eN.C.ChannelMessage) > 0) return void p.A.clearAll(i.id, eN.C.ChannelMessage)
        }
        n?.(e, s)
    };
    ...
    handleTextareaChange = (e, t, n) => {
        ...
        let s = "" !== t && n !== this.state.richValue,
            a = s && !e1.test(t) && !t.startsWith("/") && (!this.isFirstChange || t !== this.state.textValue);
        this.isFirstChange = !1, a && this.state.textValue.length < t.length && this.handleIncrementCombo(), a ? _.A.startTyping(l) : "" === t && _.A.stopTyping(l), s && i && (0, C.Bm)(), this.setState({
            textValue: t,
            richValue: n
        })
    };
    handleSendMessage = async e => {
        ...
        if (null != l) {
            if (l.inputType === R.y$.BUILT_IN_INTEGRATION) return eU._.dispatch(e$.jej.SHAKE_APP, {
                duration: 200,
                intensity: 2
            }), Promise.resolve({
                shouldClear: !1,
        ...
        return (0, eG.i)({
            ...
            if (!s)
                if (C === e$.X8x.SLOWMODE_COOLDOWN) return eU._.dispatch(e$.jej.SHAKE_APP, {
                    duration: 200,
                    intensity: 2
            ...
            if (null != c && (I.announcementSendOptions = c), null != r && (I.gifMetadata = r), null != o && (I.flags = (0, u.UI)(I.flags ?? 0, e$.pr7.IS_COMPONENTS_V2)), a) return g.A.sendMessage(h.id, S, void 0, I).then(() => {
            ...
            if (null != n && n.length > 0) {
                ...
                I.eagerDispatch = !1, I.attachmentsToUpload = n, I.onAttachmentUploadError = (e, i, l) => {
                    (0, X.k)({
                        ...
                        code: i,
                        reason: l
                    }) && ("" !== t && "" === eN.A.getDraft(h.id, eN.C.ChannelMessage) && A.A.saveDraft(h.id, t, eN.C.ChannelMessage), 0 === eL.A.getUploadCount(h.id, eN.C.ChannelMessage) && p.A.setUploads({
                        channelId: h.id,
                        uploads: n,
                        draftType: eN.C.ChannelMessage
                    }))
                }, p.A.clearAll(h.id, eN.C.ChannelMessage)
            }
            ...
            return this.setState((0, P.N3)()), (0, eh.Jx)(h.id), (0, ef.x5)(h.id, _.drafts.type), eE.B({
                channelId: h.id,
                enabled: !1
            }), {
                shouldClear: !0,
    ...
    renderAttachButton = (e, t) => (0, i.jsx)(k.A, {
        className: t,
    ...
    render() {
        ...
        return (0, i.jsx)(m.YNO, {
            ...
            renderPopout: e => {
                ...
                return o()(null != p, "ChannelTextAreaForm > Popout > renderPopout: contentWarningProps cannot be null"), (0, i.jsx)(ei.A, {
                    onClose: t,
                    ...p
                })
            },
...
class e7 extends l.PureComponent {
    static getDerivedStateFromProps(e, t) {
        ...
        return n.id !== i ? {
            textAreaFocused: null != n && !c.Fr && ej.A.can(e$.xBc.SEND_MESSAGES, n),
    ...
    _handleMoveToPane = e => {
        ...
        if (t) switch (e.which) {
            case e$.Ks6.ARROW_LEFT:
                n === O.oU.SIDEBAR && eU._.dispatch(e$.jej.FOCUS_CHANNEL_TEXT_AREA, {
                    channelId: eM.A.getChannelId()
                });
                return;
            case e$.Ks6.ARROW_RIGHT:
                n === O.oU.NORMAL && eU._.dispatch(e$.jej.FOCUS_CHANNEL_TEXT_AREA, {
    ...
    renderMessageBanner = e => {
        ...
        return t.type === e$.rbe.DM && n ? (0, i.jsx)(eu.A, {}) : t.isModeratorReportChannel() && t.isArchivedThread() ? (0, i.jsx)(eA.A, {
            channelId: t.id
        }) : null != s && (0, z.n)(s) && null != l && !ej.A.can(e$.xBc.ADMINISTRATOR, l) ? (0, i.jsx)(J.j, {
            guild: l,
            disabledUntil: s
        }) : a ? (0, i.jsx)(W.u, {
            guild: l
    ...
    render() {
        let e, {
            ...
            j = c === O.oU.SIDEBAR;
        e = j && t.type === e$.rbe.GUILD_VOICE ? eX.t.pnnyFZ : j && t.type === e$.rbe.GUILD_STAGE_VOICE ? eX.t.YInSkq : d.k.THREADS.has(t.type) ? eX.t["OkzL+Q"] : eX.t.UbNmGc;
        let R = (0, i.jsx)("div", {
                className: eQ.li,
                ...
                children: (0, i.jsx)($.Xq, {
                    children: (0, i.jsxs)(ew.Ah, {
                        ...
                        children: [(0, i.jsx)(ew.EG, {
                            ...
                            isSidebar: j,
                            className: eQ.q2,
                            "aria-label": eX.intl.formatToPlainString(e, {
                                channelName: D
                            }),
                            ...
                            children: [(0, i.jsx)(ez.A, {
                                ...
                                children: [(0, i.jsx)(el.A, {
                                ...
                                }), x ? null : this.renderMessageBanner({
                                    channel: t,
                                    showQuarantinedUserBanner: A,
                                    guild: n,
                                    communicationDisabledUntil: _,
                                    ...
                                    children: [C && (0, i.jsx)(ec.A, {
                                        channelId: t.id
                                    }), t.isPrivate() ? (0, i.jsx)(eJ.A, {
                                        channel: t,
                                        children: L
                                    }) : (0, i.jsx)(eq.A, {
                                        channel: t,
