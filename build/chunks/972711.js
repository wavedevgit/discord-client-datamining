/** Chunk was on web.js **/
/** chunk id: 972711, original params: e,t,n (module,exports,require) **/
"use strict";
n.d(t, {
    YL: () => c,
    gd: () => d,
...
class u {
    ...
    doUpload(e, t) {
        return (null == t ? void 0 : t.fileByteRange) != null && (e.body = this.sliceBody(e.body, t.fileByteRange.start)), r.Bo.put(e)
    }
}
...
class f {
    doUpload(e, t) {
        ...
        if ((null == (n = e.body) ? void 0 : n.uri) !== void 0 && "string" == typeof e.body.uri && (o = e.body.uri.startsWith("file://") ? e.body.uri.slice(7) : e.body.uri), void 0 === o || "" === o) throw Error("No file path found in request body");
        let c = {
                path: o,
        ...
        return new Promise((t, n) => {
            let r = () => {
                ...
                if ((null == d ? void 0 : d.status) === "success") t({
