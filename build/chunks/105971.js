/** chunk id: 105971 params = (module,exports,require) **/
n.d(t, {
    k: () => c
}), n(321073);
var i = n(681154),
...
let o = e => {
        switch (e.data.kind) {
            ...
            case "contentInventory":
                if (e.data.content.content_type === i.ContentInventoryEntryType.CUSTOM_STATUS) return "hotwheels_custom_status";
    ...
    c = {
        trackItemInteraction(e) {
            l.default.track(s.HAw.FEED_ITEM_INTERACTED, {
                load_id: a.A.getLoadId(),
                feed_item_type: e.type,
                feed_item_id: e.id,
                home_session_id: "gravity",
                action_type: e.actionType,
                feed_item_index: a.A.getIndexInHydratedFeed(e.id),
        ...
        trackItemShortImpression(e, t, n) {
            l.default.track(s.HAw.FEED_ITEM_SEEN_BATCH, {
                load_id: a.A.getLoadId(),
                home_session_id: "gravity",
        ...
        trackItemLongImpression(e, t, n) {
            l.default.track(s.HAw.FEED_ITEM_SEEN_LONG, {
                load_id: a.A.getLoadId(),
                home_session_id: "gravity",
                feed_item_ids: e.map(e => e.item.id),
                feed_item_types: e.map(e => o(e.item)),
        ...
        trackFeedLoaded(e) {
            ...
            }), l.default.track(s.HAw.FEED_LOADED, {
                ...e.newTrackingProps,
        ...
        trackFeedShown(e) {
            l.default.track(s.HAw.FEED_SHOWN, {
                load_id: a.A.getLoadId(),
                home_session_id: e.homeSessionId,
                variant: e.variant
            })
        ...
        trackFeedFirstScrollStarted() {
            l.default.track(s.HAw.HOME_FIRST_SCROLL_STARTED, {
                load_id: a.A.getLoadId(),
                home_session_id: "gravity"
            })
        },
        trackFeedFeedbackPromptViewed() {
            l.default.track(s.HAw.HOME_FEEDBACK_PROMPT_VIEWED)
        },
        trackFeedFeedbackSubmitted(e) {
            l.default.track(s.HAw.HOME_FEEDBACK_SUBMITTED, {
                load_id: a.A.getLoadId(),
                home_session_id: "gravity",
                ...e
            })
        ...
        trackFeedOnboardingScreenSkipped(e) {
            l.default.track(s.HAw.ICYMI_ONBOARDING_SCREEN_SKIPPED, {
                location: e.location
            })
        },
        trackFeedOnboardingGuildToggled(e) {
            l.default.track(s.HAw.ICYMI_ONBOARDING_GUILD_TOGGLED, {
                guild_id: e.guildId,
                toggled: e.toggled
            })
        },
        trackFeedOnboardingCategoryToggled(e) {
            l.default.track(s.HAw.ICYMI_ONBOARDING_CATEGORY_TOGGLED, {
                category_id: e.categoryId,
                toggled: e.toggled
            })
        },
        trackFeedEmptyLoadingSeen() {
            l.default.track(s.HAw.ICYMI_FEED_EMPTY_LOADING_SEEN, {
                load_id: a.A.getLoadId(),
                version: a.A.getVersion()
            })
        },
        trackFeedEmptyLoadingComplete(e) {
            l.default.track(s.HAw.ICYMI_FEED_EMPTY_LOADING_COMPLETE, {
                load_id: a.A.getLoadId(),
        ...
        trackFeedEmptyLoadingAbandoned(e) {
            l.default.track(s.HAw.ICYMI_FEED_EMPTY_LOADING_ABANDONED, {
                load_id: a.A.getLoadId(),
                dwell_time_ms: e.dwellTimeMs,
                version: a.A.getVersion()
            })
        ...
        trackFeedSessionStarted(e) {
            l.default.track(s.HAw.FEED_SESSION_STARTED, {
                load_id: a.A.getLoadId(),
                version: a.A.getVersion(),
        ...
        trackFeedSessionCompleted(e) {
            l.default.track(s.HAw.FEED_SESSION_COMPLETED, {
                load_id: a.A.getLoadId(),
                version: a.A.getVersion(),
        ...
        trackFeedItemDwell1s(e) {
            l.default.track(s.HAw.FEED_ITEM_1S_DWELLED, {
                load_id: a.A.getLoadId(),
                version: a.A.getVersion(),
                impression_id: e.impressionId,
                item_id: e.itemId,
        ...
        trackFeedItemDwelled(e) {
            l.default.track(s.HAw.FEED_ITEM_DWELLED, {
                load_id: a.A.getLoadId(),
                version: a.A.getVersion(),
                impression_id: e.impressionId,
                dwell_time_ms: e.dwellTimeMs,
        ...
        trackFeedItemActioned(e) {
            l.default.track(s.HAw.FEED_ITEM_ACTIONED, {
                load_id: a.A.getLoadId(),
                icymi_session_id: e.icymiSessionId,
                ux_variation: e.uxVariation,
                version: a.A.getVersion(),
        ...
        trackFeedFilterActioned(e) {
            l.default.track(s.HAw.FEED_FILTER_ACTIONED, {
                load_id: a.A.getLoadId(),
                icymi_session_id: e.icymiSessionId,
                ux_variation: e.uxVariation,
                version: a.A.getVersion(),
        ...
        trackFeedPageActioned(e) {
            l.default.track(s.HAw.FEED_PAGE_ACTIONED, {
                load_id: a.A.getLoadId(),
                icymi_session_id: e.icymiSessionId,
                ux_variation: e.uxVariation,
                version: a.A.getVersion(),
