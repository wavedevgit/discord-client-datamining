/** chunk id: 977446, original params: e,t,n (module,exports,require) **/
n.d(t, {
    Ay: () => D,
    jW: () => P,
    w1: () => L
...
let L = [{
    ...
    id: "appearance",
    label: () => f.intl.string(f.t.CUnZkZ)
}, {
    id: "upgrades",
    label: () => f.intl.string(f.t.KC5q8v)
}, {
    id: "vip",
...
function D() {
    let e = (0, c.DP)(),
        ...
        M = (0, a.useCallback)(() => {
            ...
            e ? (n = g.X.DISPLAY_IN_APP_ICON_CATEGORY, s = void 0) : t && (n = g.X.APPEARANCE_IN_APP_ICON, s = void 0), (0, x.openUserSettings)(n, {
                section: S.nc_.APPEARANCE,
                scrollPosition: s,
                analyticsLocations: i
            })
        ...
        w = (0, a.useMemo)(() => [{
            ...
            description: f.intl.formatToPlainString(f.t.cWFUoT, {
                boostCount: 2,
                percentageOff: 30
            }),
            ...
            description: f.intl.formatToPlainString(f.t.k8LC1w, {
                maxSizeMb: 500
            }),
            primaryAsset: (0, s.jsx)(l.oYh, {
                alt: "",
                ariaHidden: !0
            }),
            categories: ["bestof", "upgrades"]
