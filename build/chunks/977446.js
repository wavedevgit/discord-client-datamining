...
var i, s = n(627968),
    ...
    v = n(345362),
    O = n(509442),
    R = ((i = {}).BEST_OF_NITRO = "bestof", i.APPEARANCE_STYLE = "appearance", i.UPGRADES = "upgrades", i.VIP_EXTRAS = "vip", i);
let y = [{
    id: "bestof",
...
function P() {
    let e = (0, c.DP)(),
        ...
        L = (0, a.useCallback)(() => {
            ...
            e ? (n = A.X.DISPLAY_IN_APP_ICON_CATEGORY, s = void 0) : t && (n = A.X.APPEARANCE_IN_APP_ICON, s = void 0), (0, h.openUserSettings)(n, {
                section: T.nc_.APPEARANCE,
                scrollPosition: s,
                analyticsLocations: i
            })
