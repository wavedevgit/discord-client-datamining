/** chunk id: 313921 params = (module,exports,require) **/
"use strict";
n.d(e, {
    default: () => S
});
...
let S = (0, d.A)((0, c.A)(function(t) {
    let {
        ...
        } : w.A.getGuildPermissionProps(e), [e]), u = o.useCallback(() => {
            if (e?.id == null) return null;
            (0, s.mMO)(async () => {
                let {
                    default: o
                } = await Promise.all([n.e("8555"), n.e("40556"), n.e("99256")]).then(n.bind(n, 228884));
                return n => (0, r.jsx)(o, {
                    ...n,
                    existingSound: t,
                    guildId: e.id
        ...
        return i ? (0, r.jsx)(s.Drp, {
            id: "edit-soundboard-sound",
            label: m.intl.string(m.t.ponZcG),
            action: u
        ...
        return "0" === t.guildId ? null : (0, r.jsx)(s.Drp, {
            id: "download-soundboard-sound",
            label: m.intl.string(m.t["/fzLLK"]),
            action: n
        }, "download-soundboard-sound")
    }(c), A = (0, v.A)(c, d), O = (0, p.A)({
        id: c.soundId,
        label: m.intl.string(m.t.HJikXp)
    });
