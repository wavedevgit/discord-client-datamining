...
function C(e) {
    let {
        ...
        "aria-labelledby": N,
        onChange: E
    } = e, b = p.intl.string(p.t.d7YJMK), C = (0, a.bG)([g.A], () => g.A.getCategories(l), [l]), I = (0, _.fE)(r ?? A.dJq), v = s.useMemo(() => {
        let e = [{
                value: null,
                label: b
            }],
    ...
    return (0, i.jsx)(o.Pw, {
        ...
        select: function(e) {
            null == e ? (0, d.mMO)(async () => {
                let {
                    default: e
                } = await Promise.all([n.e("93142"), n.e("64233"), n.e("44782")]).then(n.bind(n, 963765));
                return t => (0, i.jsx)(e, {
                    ...t,
                    guildId: l,
                    onSubmit: E
