...
let p = l.memo(function(e) {
    let {
        channel: t,
        participant: n
    } = e, s = (0, r.bG)([c.default], () => c.default.getUser(n.user.id), [n.user.id]), h = l.useMemo(() => u.Ay.getNickname(t.guild_id, t.id, s) ?? s?.globalName ?? n.userNick, [t, s, n.userNick]), A = (0, d.A)({
        userId: n.user.id,
        context: _.x.DEFAULT
    });
