/** chunk id: 980172 params = (module,exports,require) **/
n.d(t, {
    A: () => $
});
var i = n(627968),
...
function X(e) {
    let {
        className: t,
        user: l
    } = e, a = s.useRef(null), u = (0, p.EC)(), _ = u?.nick?.[0] ?? null, [m, g] = s.useState(!1);
    s.useEffect(() => {
...
function W(e) {
    let {
        user: t,
        className: n
    } = e, l = (0, p.EC)(), a = l?.nick?.[0] ?? null, u = P.Ay.getGlobalName(t), _ = s.useRef(null), [m, g] = s.useState(!1);
    return s.useEffect(() => {
        ...
        children: [(0, i.jsx)("div", {
            ...
            children: [d && null != o ? (0, i.jsx)("div", {
                ...
                children: (0, i.jsx)(c.QWc, {
                    ...
                    onClick: function() {
                        (0, c.qfG)(e => (0, i.jsx)(O.default, {
                            ...e,
                            title: B.intl.string(B.t["3CTiKi"]),
                            children: l.hasFlag(V.nhx.MFA_SMS) ? B.intl.string(B.t.jrhJyo) : void 0,
...
function J(e) {
    ...
    }), l = L.Q_.useSetting(), r = s.useRef(null);
...
function Q(e) {
    let {
        className: t
    } = e, l = (0, g.b8)(), a = (0, g.yM)(), o = (0, g.Y2)(), d = !l || a, u = B.intl.string(B.t["9KiIz6"]), A = B.intl.string(B.t.DVywUB), h = B.intl.string(B.t.lKDPGA), x = s.useCallback(() => {
    ...
    }, []), T = s.useMemo(() => l ? a ? B.intl.string(B.t.sK0dmH) : o ? B.intl.format(H.default.WM5adV, {
        handleOnHelpUrlHook: x
    }) : B.intl.string(B.t.XxRj7f) : h, [l, a, o, h, x]), E = l && !a && o;
    return (0, i.jsxs)("div", {
        className: r()(F.ZZ, t),
        children: [(0, i.jsx)("div", {
            className: F.NQ,
...
function $(e) {
    let {
        currentUser: t
    } = e, n = (0, b.Ay)(t.id), s = (0, N.A)(n), l = L.jP.useSetting(), r = (0, a.bG)([f.A], () => f.A.getErrors()), o = r?.avatar?.[0], {
        avatarSrc: d,
