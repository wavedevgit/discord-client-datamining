...
let V = r.memo(function() {
    ...
    let {
        ...
        location: "HeaderBar"
    }), T = (0, s.bG)([R.A], () => R.A.isDeveloper), G = (0, O.Uk)("VoiceDareTitleBarButton"), V = (0, s.bG)([P.A, c.A], () => b.Q_.getSetting() && null != P.A.testModeApplicationId && null != c.A.getApplication(P.A.testModeApplicationId) && (0, u.A)(c.A.getApplication(P.A.testModeApplicationId))), B = null !== e && t === N.RK.TITLE_BAR_LEFT, H = null === e;
    r.useLayoutEffect(() => {
        D.Ay.setMinimumSize(800, 500)
    }, []);
    let F = (0, y.NC)(),
        ...
        W = function(e) {
            ...
            return r.useMemo(() => t ? "BACK_FORWARD_NAVIGATION" : n ? "NOTIFICATIONS_INBOX" : i ? "TITLEBAR_FAST_TRAVEL" : l ? "RECENTS" : "HELP", [t, n, i, l])
        }({
            ...
            children: t => (0, i.jsx)(w.cq, {
                ...
                trailing: (0, i.jsxs)(i.Fragment, {
                    children: [(0, i.jsx)(g.A, {
                        className: U.x
                    }), G ? (0, i.jsx)(L.A, {}) : null, (0, i.jsx)(h.A, {
                        canShowReminder: !0,
                        className: U.x
                    }), H && (0, i.jsx)(v.A, {
                        ..."RECENTS" === W ? e : {},
