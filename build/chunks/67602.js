...
function g(e) {
    let {
        guild: t,
        markAsDismissed: n
    } = e, g = (0, r.bG)([u.A], () => u.A.getUnclaimedGameIdsForGuild(t.id), [t.id]) ?? [], E = g[0], I = (0, s.h)(E);
    if (0 === g.length || null == E || null == I) return null;
    let f = c.Ay.getGameAssetURL({
        id: E,
        hash: I.coverImage,
        keepAspectRatio: !0
    });
    ...
    return (0, i.jsx)(o.A, {
        ...
        title: m.intl.format(m.t.Q11WTQ, {
            gameName: C
        }),
        message: T,
        cta: (0, i.jsxs)("span", {
            className: p.m,
            children: [m.intl.string(m.t["2u6ZlY"]), (0, i.jsx)(l.I9m, {
                size: "xs",
                color: "currentColor"
            })]
        }),
