/** chunk id: 461789 params = (module,exports,require) **/
i.d(o, {
    B5: () => s,
    Lw: () => n
});
let n = async e => window.Meticulous?.isRunningAsTest ? (console.debug("Running as part of a Meticulous test case, so skipping loading the Meticulous recorder."), {
    ...
    return new Promise((p, _) => {
        ...
        R.type = "text/javascript", R.src = new URL(`${null!=a?"record/":""}${null==(E=a??null)?"v1":`v/${E}`}/meticulous-manual-init.js`, r || "https://snippet.meticulous.ai").href;
        let M = window;
        M.METICULOUS_RECORDING_TOKEN = o ?? e, void 0 !== i && (M.METICULOUS_UPLOAD_INTERVAL_MS = i), void 0 !== t && (M.METICULOUS_APP_COMMIT_HASH = t), void 0 !== n && (M.METICULOUS_SNAPSHOT_LINKED_STYLESHEETS = n), void 0 !== d && (M.METICULOUS_FORCE_RECORDING = d), void 0 !== u && (M.METICULOUS_IS_PRODUCTION_ENVIRONMENT = u), null != l && l.length > 0 && (M.METICULOUS_NETWORK_RESPONSE_SANITIZERS = l), null != c && c.length > 0 && (M.METICULOUS_RECORDER_MIDDLEWARE_V1 = c), R.onload = function() {
