...
function h(e) {
    let {
        applicationId: t,
        message: n
    } = e, [l, r, o] = (0, s.yK)([u.A], () => [u.A.getApplication(t), u.A.isFetchingApplication(t), u.A.didFetchingApplicationFail(t)], [t]);
    return (a.useEffect(() => {
        null != l || r || o || c.Ay.fetchApplication(t)
    }, [l, r, o, t]), null != l && (0, m.Ie)({
...
function p(e) {
    ...
    } = (0, o.Ay)(r.A.APP_OAUTH2_LINK_EMBED);
    return (0, i.jsx)(o.f5, {
        value: c,
