/** chunk id: 624600, original params: e,t,n (module,exports,require) **/
n.d(t, {
    A: () => u
});
var r = n(627968),
...
let u = e => {
    ...
    } = t, _ = S - g, b = u.to(e => Math.min(Math.max(0, e - g), _)), T = null != n && null != c && A === n, y = !T && null != n && null != c && C === n, N = T || y, D = y ? (0, s.to)([b, c], (e, t) => `translateX(-${Math.max(0,_-t-e)}px)`) : b.to(e => `translateX(-${_-e}px)`), I = N ? (0, s.to)([b, c], (e, t) => T ? Math.max(0, e - t) : Math.min(e, _ - t)) : b, L = Math.max(0, (p ?? 0) - g), j = f ? o.KR : o.Fv, M = l.useMemo(() => m?.map(e => ({
        startPx: e.start * d,
    ...
    return (0, r.jsxs)(s.animated.div, {
        ...
        children: [(0, r.jsxs)("div", {
            ...
            children: [(0, r.jsxs)(s.animated.div, {
                ...
                }, `${e.startPx}:${e.endPx}`)), !E && L > 0 && (0, r.jsx)("div", {
                    className: a()(o.YK, j),
                    style: {
                        width: `${L}px`,
                        opacity: 1
