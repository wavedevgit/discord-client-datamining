...
let u = e => {
    ...
    } = t, b = S - g, _ = u.to(e => Math.min(Math.max(0, e - g), b)), y = null != n && null != c && A === n, T = !y && null != n && null != c && C === n, N = y || T, D = T ? (0, s.to)([_, c], (e, t) => `translateX(-${Math.max(0,b-t-e)}px)`) : _.to(e => `translateX(-${b-e}px)`), I = N ? (0, s.to)([_, c], (e, t) => y ? Math.max(0, e - t) : Math.min(e, b - t)) : _, L = Math.max(0, (p ?? 0) - g), j = E ? o.KR : o.Fv, M = l.useMemo(() => m?.map(e => ({
        startPx: e.start * d,
