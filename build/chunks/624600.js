...
let u = e => {
    let {
        ...
        rightIndicatorIndex: b
    } = t, _ = S - g, C = u.to(e => Math.min(Math.max(0, e - g), _)), y = null != n && null != c && A === n, T = !y && null != n && null != c && b === n, N = y || T, D = T ? (0, s.to)([C, c], (e, t) => `translateX(-${Math.max(0,_-t-e)}px)`) : C.to(e => `translateX(-${_-e}px)`), I = N ? (0, s.to)([C, c], (e, t) => y ? Math.max(0, e - t) : Math.min(e, _ - t)) : C, R = Math.max(0, (p ?? 0) - g), L = f ? o.KR : o.Fv, w = l.useMemo(() => m?.map(e => ({
        startPx: e.start * d,
    ...
    return (0, r.jsxs)(s.animated.div, {
        ...
        children: [(0, r.jsxs)("div", {
            ...
            children: [(0, r.jsxs)(s.animated.div, {
                ...
                }, `${e.startPx}:${e.endPx}`)), !E && R > 0 && (0, r.jsx)("div", {
                    className: i()(o.YK, L),
                    style: {
                        width: `${R}px`,
                        opacity: 1
