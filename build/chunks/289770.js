/** chunk id: 289770 params = (module,exports,require) **/
n.d(t, {
    S$: () => A,
    YV: () => h,
    iA: () => E,
...
function C(e, t, n) {
    ...
    return null == l ? [] : d.Ay.queryApplicationCommandChannelResults({
        query: e,
        channel: l,
        channelTypes: n,
        limit: 15
        ...
        switch (e.type) {
            case l.i.USER: {
                ...
                return {
                    type: p.iw.USER,
                    value: t.id,
                    label: n ?? t.globalName ?? t.username
                }
            }
            case l.i.ROLE: {
