...
let y = [{
    ...
    I = e => {
        let {
            purchase: t
        } = e, r = (0, o.bG)([u.default], () => u.default.locale), i = (0, h.gA)(t), n = null != t.expiresAt ? (0, x.Tf)(Date.now(), t.expiresAt) : null, l = (0, _.Sw)(t), a = t.purchasedAt.toLocaleDateString(r, {
            month: "long",
            year: "numeric"
        });
        return (0, s.jsxs)("div", {
    ...
    C = e => {
        let {
            ...
            product: C,
            purchase: E
        } = (0, g.A)(n?.skuId), S = A.Ay.canUseCollectibles(t), T = null != E ? (0, h.gA)(E) : (0, h.G0)(C), f = !S && (0, h.gA)(E), k = (0, d.b)(!T || S), N = (0, _.Sw)(E), P = (0, _.VG)(C), O = i.useMemo(() => f ? v.intl.string(v.t["7vkeu5"]) : T && S && !k ? v.intl.string(v.t.hmyYK8) : T && !S && k ? v.intl.string(v.t.q0PlFn) : !T || S || k ? v.intl.string(v.t.fEGjVQ) : v.intl.string(v.t["0xs2sA"]), [f, T, S, k]);
