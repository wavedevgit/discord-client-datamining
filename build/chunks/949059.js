/** chunk id: 949059, original params: e,t,n (module,exports,require) **/
n.d(t, {
    p: () => h
});
var i = n(311907),
...
let h = (0, a.zD)(u.X.EXPERIMENTAL_UNREADS, {
    ...
    setValue: function(e) {
        l.A.setAccountFlag(g.i.USE_NEW_NOTIFICATIONS, e), e || (s.w.set("turnedOffNewNotifications", !0), c.default.track(_.HAw.NOTIFICATION_MIGRATION_OPTOUT, {
            num_guilds_with_new_setting: r.A.getGuildsArray().filter(e => o.Ay.resolveGuildUnreadSetting(e) === m.e.ONLY_MENTIONS).length
        }))
    },
