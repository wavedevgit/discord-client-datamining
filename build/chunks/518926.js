/** chunk id: 518926, original params: t,e,i (module,exports,require) **/
i.d(e, {
    A: () => d
});
var s = i(627968),
...
let o = {
    ...
    d = n.memo(function(t) {
        let {
            ...
            onAnimationEnd: y
        } = t, [R, S] = n.useState(null), {
            confettiCanvas: C
        } = n.useContext(a.x), T = (0, l.f9)(A ?? C, R), [I, b] = n.useState(!1);
        n.useEffect(() => {
            I && y?.()
        });
        let j = n.useMemo(() => {
        ...
        return n.useEffect(() => {
            ...
            return t = t.map((i, s) => setTimeout(() => {
                T.createMultipleConfetti(function(t, e, i, s, n) {
                ...
                }(e.getBoundingClientRect(), p, h, m, g, x, _), f ?? 50), s === t.length - 1 && null != y && b(!0)
            }, 60 * s)), () => {
                for (let e of t) clearTimeout(e)
            }
        }, [T, e, c, f, p, h, m, g, x, _, y]), (0, s.jsx)(l.K_, {
            ref: S,
            sprites: j ?? r.uI,
            colors: i ?? r._t,
            spriteWidth: r.wn,
