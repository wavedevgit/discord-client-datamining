/** chunk id: 348559 params = (module,exports,require) **/
s.d(e, {
    default: () => h
});
var i = s(627968),
...
function T(t) {
    let {
        targetedTraits: e,
        isContextualDisclosure: s
    } = t;
    if (null == e) return null;
    if (s) return (0, i.jsx)("ul", {
        className: m.OK,
        children: (0, i.jsx)(_, {
            icon: a.RR9,
            children: g.intl.string(g.t["2bL0wT"])
        })
    });
    let {
        location: n,
    ...
    return (0, i.jsxs)("ul", {
        ...
        children: [n && (0, i.jsx)(_, {
            icon: a.L_e,
            children: g.intl.string(g.t.xQSdPv)
        }), r && (0, i.jsx)(_, {
            icon: a.nys,
            children: g.intl.string(g.t.mYt7hQ)
        }), l && (0, i.jsx)(_, {
            icon: a._xR,
            children: g.intl.string(g.t.XAsWxQ)
        })]
    })
}
