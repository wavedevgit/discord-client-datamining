...
function R(e) {
    ...
    } = (0, C.A)(), w = (0, a.bG)([d.default], () => d.default.getCurrentUser()), H = (0, a.bG)([g.A], () => g.A.productsWithVariantsAsGroup), [U, G] = l.useState(1), F = (0, c.DP)(), V = (0, i.qB)(F), [K, z, W] = l.useMemo(() => {
        switch (R) {
            case b.G2.AVATAR_DECORATIONS:
                return [S.intl.string(S.t.dRZYNE), V ? k.A : j.A, r.R.AVATAR_DECORATION];
            case b.G2.PROFILE_EFFECTS:
                return [S.intl.string(S.t["1cNjtx"]), V ? N.A : y.A, r.R.PROFILE_EFFECT];
            case b.G2.NAMEPLATES:
                return [S.intl.string(S.t.V68Fqz), V ? T.A : O.A, r.R.NAMEPLATE];
            case b.G2.BUNDLES:
                return [S.intl.string(S.t.FYFpps), V ? L.A : I.A, r.R.BUNDLE]
        }
    }, [R, V]), Y = (0, m.p)(), $ = l.useMemo(() => Y(H.filter(e => (e.type === W || e.type === r.R.VARIANTS_GROUP && e.variants?.some(e => e.type === W) === !0) && !b.MS.some(t => {
        let {
            categorySkuId: s
        } = t;
