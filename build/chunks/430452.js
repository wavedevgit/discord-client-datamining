...
function ne(e) {
    let t = t7(e.context),
        n = !ti || t.mute || t.deaf;
    e.context === eV.x.DEFAULT ? n = n || tf || tp || t_ || !ed.A.didHavePermission(ek.iL.AUDIO) : e.context === eV.x.STREAM && (n = !0), e.setSelfMute(n), e.setSelfDeaf(t.deaf), e.context === eV.x.DEFAULT && C.A.updateNativeMute()
}
...
function nl() {
    td.start(e4, () => {
        ...
        tH = n === J.c.NoSoftwareDecodeWithFallback, n === J.c.NoSoftwareDecode || n === J.c.NoSoftwareDecodeWithFallback ? (e.setExperimentFlag(eV.fd.H265_HARDWARE_ONLY, !0), (0, eA.isWindows)() ? t4().then(t => {
            e.setExperimentFlag(eV.fd.H265_HARDWARE_DECODE_AVAILABLE, t)
        }) : (0, eA.isMac)() && e.setExperimentFlag(eV.fd.H265_HARDWARE_DECODE_AVAILABLE, !0)) : n === J.c.Disabled && (e.setExperimentFlag(eV.fd.H265_HARDWARE_ONLY, !0), e.setExperimentFlag(eV.fd.H265_HARDWARE_DECODE_AVAILABLE, !1)), (0, eA.isWindows)() && (0, X.r)({
            location: "setupMediaEngine"
        ...
        if ((0, eA.isWindows)()) e.setExperimentFlag(eV.fd.SIGNAL_AV1, !0), e.setExperimentFlag(eV.fd.SIGNAL_AV1_HARDWARE_DECODE, !0);
        else if ((0, eA.isMac)()) {
        ...
        if ((0, eA.isWindows)() && (null == tQ ? void 0 : tQ.startsWith("AMD")) && (0, es.F)("MediaEngineStore").enabled && e.setExperimentFlag(eV.fd.WMF_GPU_ENCODE, !0), (0, eA.isWindows)() && (null == tQ ? void 0 : tQ.startsWith("Intel")) && (0, el.J)("MediaEngineStore").enabled && e.setExperimentFlag(eV.fd.WMF_GPU_ENCODE, !0), (0, eA.isWindows)() && (null == tQ ? void 0 : tQ.startsWith("Qualcomm")) && (0, es.F)("MediaEngineStore").enabled && e.setExperimentFlag(eV.fd.WMF_GPU_ENCODE, !0), tt.setHasFullbandPerformance((0, D.A)()), e.setRemoteAudioHistory(1e3), (0, w.A)(r)) {
            let {
        ...
        }), e.context === eV.x.DEFAULT && (tb = !1, tO = !1, e.on(O.yq.SpeakingWhileMuted, () => {
...
function nd() {
    return (0, eA.isMac)() && tt.supports(eV.O5.SCREEN_CAPTURE_KIT) && y().satisfies(null === S.A || void 0 === S.A ? void 0 : S.A.os.release, ej.e)
}
...
function nY(e) {
    ...
    } else v && (g && !p ? (eK.info("disallowing auto-disable for this session because of manual override by user"), tz = !1, null == (s = eP.A.getRTCConnection()) || null == (o = s.getVideoHealthManager()) || o.disable(), (0, eu.A)(c, eV.Al.MANUAL_REENABLE, E)) : (0, eu.A)(c, p ? eV.Al.MANUAL_DISABLE : eV.Al.MANUAL_ENABLE, E));
...
async function rr() {
    ...
    let i = 4098;
    (null == (n = window.DiscordNative) || null == (t = n.processUtils) ? void 0 : t.getSystemInfo) == null || (null != (e = null == (r = (await window.DiscordNative.processUtils.getSystemInfo()).electronGPUInfo) ? void 0 : r.gpuDevice) ? e : []).some(e => e.vendorId === i) && (t1 = !0, t0 = tt.supports(eV.O5.GAMESCOPE_CAPTURE))
}
...
function rI() {
    !rA() || __OVERLAY__ || tw || tR ? (0, eA.isWeb)() && tt.supports(eV.O5.NOISE_CANCELLATION) ? (tR = !0, r.emitChange()) : (0, eA.isWeb)() && ng({
        noiseCancellation: !1
    }) : (tw = !0, rv())
}
...
class r2 extends(p = b.Ay.Store) {
    ...
    supportsExperimentalSoundshare() {
        return tt.supports(eV.O5.EXPERIMENTAL_SOUNDSHARE) && y().satisfies(null === S.A || void 0 === S.A ? void 0 : S.A.os.release, ej.$x)
    }
    supportsHookSoundshare() {
        return (0, eA.isWindows)() && tt.supports(eV.O5.SOUNDSHARE) && y().satisfies(null === S.A || void 0 === S.A ? void 0 : S.A.os.release, ej.ws)
    }
    ...
    supportsScreenSoundshare() {
        return (0, eA.isMac)() ? tt.supports(eV.O5.SOUNDSHARE) && y().satisfies(null === S.A || void 0 === S.A ? void 0 : S.A.os.release, ej.P$) && nd() : (0, eA.isWindows)() ? tt.supports(eV.O5.SCREEN_SOUNDSHARE) && this.getExperimentalSoundshare() : !!(0, eA.isLinux)() && tt.supports(eV.O5.SCREEN_SOUNDSHARE)
    }
