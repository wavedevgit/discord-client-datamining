...
let w = i.memo(function(e) {
    let t, {
        ...
        ed = null != z && null != s && null == eo ? C.Ay.getGuildIconURL({
            id: s.guild_id,
            icon: z.icon,
            size: 32
        }) : null,
    ...
    return (0, l.jsxs)("div", {
        ...
        children: [(0, l.jsxs)("div", {
            ...
            className: G.t$,
            children: [P && null != n && null != L && (0, l.jsx)(v.A, {
                user: n,
                channel: L,
                location: "InviteRow"
            }), ep]
