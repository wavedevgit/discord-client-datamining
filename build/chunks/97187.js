/** chunk id: 97187 params = (module,exports,require) **/
n.d(i, {
    default: () => E
});
var e = n(627968);
...
function E(t) {
    ...
    }), C = (0, l.bG)([u.A], () => u.A.getRequest(E)), b = () => {
    ...
    return (0, e.jsxs)(r.W1t, {
        ...
        onSelect: n,
        children: [C?.applicationStatus === p.B5.REJECTED && (0, e.jsx)(r.Drp, {
            id: "reapply",
            ...
            action: () => {
                (0, a.A)({
                    ...
                    subtitle: C?.applicationStatus === p.B5.STARTED ? m.intl.string(m.t.fJwWVt) : m.intl.format(m.t["9ZezpN"], {
                        name: i.name
                    }),
