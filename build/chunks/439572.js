/** chunk id: 439572 params = (module,exports,require) **/
let r;
...
function l(e, t) {
    let n = function(e, t, n) {
            if (void 0 === n) {
                let n = A.encode(e),
                    r = t(n.length, 1) >>> 0;
                return y().subarray(r, r + n.length).set(n), j = n.length, r
            }
            let r = e.length,
                i = t(r, 1) >>> 0,
                o = y(),
...
function f() {
    return {
        __proto__: null,
        "./arborium_powershell_plugin_bg.js": {
            __proto__: null,
...
function g() {
    return (null === b || !0 === b.buffer.detached || void 0 === b.buffer.detached && b.buffer !== r.memory.buffer) && (b = new DataView(r.memory.buffer)), b
}

function p(e, t) {
    var n, r;
    return n = e >>>= 0, (k += r = t) >= 0x7ff00000 && ((I = new TextDecoder("utf-8", {
        ignoreBOM: !0,
        fatal: !0
    })).decode(), k = r), I.decode(y().subarray(n, n + r))
}
let w = null;
