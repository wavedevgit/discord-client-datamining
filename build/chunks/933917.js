/** chunk id: 933917 params = (module,exports,require) **/
"use strict";
n.d(t, {
    D: () => N
});
...
function C(e) {
    let {
        ...
        isPlaying: r,
        text: c
    } = e, u = n?.emojiId != null || n?.emojiName != null, m = v.intl.formatToPlainString(v.t.tuMUJ2, {
...
function T(e) {
    let {
        containerRef: t,
        text: n
    } = e, s = i.useRef(null), a = (0, r.bG)([x.A], () => x.A.getSoundsForGuild("0")?.find(e => "airhorn" === e.name)), {
