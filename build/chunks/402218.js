/** chunk id: 402218, original params: e,t,l (module,exports,require) **/
l.d(t, {
    A: () => en
});
var n = l(627968),
...
let K = i.memo(function(e) {
        let {
            member: t
        } = e, l = i.useMemo(() => (0, p.n)(t.communicationDisabledUntil), [t.communicationDisabledUntil]), a = i.useMemo(() => null == t.communicationDisabledUntil ? new Date : new Date(t.communicationDisabledUntil), [t.communicationDisabledUntil]);
        return (0, n.jsxs)("div", {
            className: Y.Ak,
    ...
    Q = i.memo(function(e) {
        let {
            member: t,
            highestRole: l
        } = e, a = (0, d.bG)([L.A], () => L.A.getGuild(t.guildId), [t.guildId]), r = t.roles.length - 1, o = i.useMemo(() => new Intl.NumberFormat(z.intl.currentLocale).format(r), [r]), C = (0, F.Cy)(t), c = (0, F.Cy)(t, !0), x = (0, d.bG)([V.A], () => V.A.can(P.xBc.MANAGE_ROLES, a), [a]);
        return null == a ? null : (0, n.jsxs)("div", {
            className: Y.yk,
            children: [null != l && (0, n.jsx)(B.A, {
                className: s()(Y.Zf, Y.Lc),
                role: l,
                guildId: t.guildId
            }), r > 0 && (0, n.jsx)(m.DUT, {
                className: Y.yt,
    ...
    W = i.memo(function(e) {
        let {
            member: t,
            user: l
        } = e, i = (0, A.gn)(t?.guildId, t?.userId, t?.colorStrings ?? null);
...
function J(e) {
    let {
        ...
        showLongDate: l,
        isSortedBy: a
    } = e, [s, r] = i.useState(null);
    i.useEffect(() => {
        r(X(t.joinedAtTimestamp))
    }, [t.joinedAtTimestamp]), (0, h.A)(() => {
        r(X(t.joinedAtTimestamp))
    }, 1e4);
    let o = a ? "text-brand" : "text-default";
    return s?.short == null ? null : l ? (0, n.jsx)("div", {
...
let $ = i.memo(function(e) {
        ...
        }, [t.userId]), o = a ? "text-brand" : "text-default";
    ...
    ee = i.memo(function(e) {
        ...
        } = e, g = (0, d.bG)([V.A, L.A], () => V.A.can(P.xBc.MANAGE_GUILD, L.A.getGuild(t.guildId)), [t.guildId]), {
            selectedUserIds: _,
            addUsers: H,
            removeUser: p
        } = (0, k.A)(t.guildId), f = (0, w.vA)(t.guildId), j = (0, w.O6)(t.guildId, f, t.userId), b = (0, d.bG)([Z.A], () => Z.A.getSearchStateByGuildId(t.guildId).selectedSort ?? T.mF.ORDER_BY_UNSPECIFIED, [t.guildId], C()), v = i.useCallback(e => {
            e.stopPropagation(), e.preventDefault(), null != t && j && (_.has(t.userId) ? p(t.userId) : H([t.userId]))
        }, [H, j, t, p, _]), A = b === T.mF.ORDER_BY_GUILD_JOINED_AT_ASC, N = b === T.mF.ORDER_BY_USER_ID_ASC || b === T.mF.ORDER_BY_USER_ID_DESC;
        return (0, n.jsxs)(n.Fragment, {
            children: [f && (0, n.jsx)("td", {
                children: (0, n.jsx)(u.m, {
                    shouldShow: !j,
                    ariaHidden: j,
    ...
    en = i.memo(function(e) {
        ...
        } = (0, g.Ay)(), h = (0, d.bG)([N.Ay], () => N.Ay.getGuildSidebarState(l), [l]), _ = h?.details.userId === t, H = (0, d.bG)([Z.A], () => Z.A.getEnhancedMember(l, t), [l, t]), p = (0, F.YH)(H), b = (0, d.bG)([R.default], () => R.default.getUser(t), [t]), v = (0, j.q)(l), A = (0, F.UY)(H ?? void 0), L = i.useCallback(e => {
            e.stopPropagation(), e.preventDefault(), A(e)
        }, [A]), V = i.useCallback(e => {
            e.stopPropagation(), e.preventDefault(), null != H && (0, F.Ko)(H, x)
        }, [H, x]), M = i.useCallback(e => {
            e.stopPropagation(), e.preventDefault(), null != H && (v ? (0, f.z)(H.guildId, H.userId, G.VV.MEMBER_SAFETY, {
                modViewPanel: q.g.INFO
            }) : (0, F.Ko)(H, x))
        }, [H, x, v]), D = i.useCallback((e, t) => C()((0, r.omit)(e, el), (0, r.omit)(t, el)), []);
        return null == H ? null : (0, n.jsx)(U.A, {
            role: "row",
            value: H,
            style: a,
            className: s()(Y.yF, Y.iA, o && Y.wH, _ && Y.qb, c && Y.Lq),
            equalityFn: D,
            onClick: V,
            onContextMenu: L,
            children: (0, n.jsx)(ee, {
