/** chunk id: 627261, original params: l,i,n (module,exports,require) **/
n.d(i, {
    default: () => h
});
var r = n(627968);
        ...
        children: [(0, r.jsxs)(s.rQ0, {
            ...
            children: (0, r.jsxs)("div", {
                ...
                children: [(0, r.jsx)("div", {
                    ...
                    className: p.nf,
                    children: (0, r.jsxs)("div", {
                        children: [null != j ? `Game: ${j}
` : null, h?.applicationId != null ? `Game ID: ${h.applicationId}
` : null, h?.branchId != null && h?.applicationId !== h?.branchId ? `Branch ID: ${h?.branchId}
` : null, h?.code != null ? `Error Code: ${h?.code}
` : null, h?.uuid != null ? `Unique Case ID: ${h?.uuid}` : null]
                    })
                })]
            })
        }), (0, r.jsxs)(s.jlY, {
