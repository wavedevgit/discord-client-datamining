...
function F(e) {
    ...
    })), Y = t.userStatus?.enrolledAt != null, J = t.userStatus?.completedAt != null, X = J && t.userStatus?.claimedAt == null, Z = (0, y.if)(t), ee = !(0, y.Ic)(t), et = (0, v.In)(t), en = (0, S.IO)(t), ea = (0, S.K$)(t), ei = (0, S.Cr)(t), es = (0, v.fc)(t), [el, er, eo] = (0, v.Qo)(t, es), ed = ee && et === v.F3.ACCEPTED, ec = ed && el === x.X0.SELECT, eu = ed && !ec && er.length > 1, em = _.t.useConfig({
    ...
    return (Z && X ? eE = (0, a.jsx)("div", {
        ...
        className: D.x6,
        children: em.enabled && (eh === k.UA.UNENROLLED || eh === k.UA.ENROLLED || eh === k.UA.INCOMPLETE) && em.enabledQuestStates.has(eh) ? (0, a.jsxs)(r.e2v, {
            direction: "horizontal",
            fullWidth: !0,
            wrap: !1,
    ...
    }) : em.enabled && (eh === k.UA.ENROLLED || eh === k.UA.INCOMPLETE) && em.enabledQuestStates.has(eh) ? (0, a.jsx)("div", {
        className: D.x6,
