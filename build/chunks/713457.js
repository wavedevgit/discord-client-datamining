...
function F(e) {
    let {
    ...
    } = e, V = (0, s.bG)([c.A], () => c.A.useReducedMotion), W = (0, N.Xf)({
        useReducedMotion: V
    }), H = (0, b.Ut)(), K = (0, _.RR)({
        quest: t
    }), z = (0, _.Vn)(t), $ = (0, _.S5)(t.config.expiresAt, {
        month: "numeric",
        day: "numeric"
    }), {
        isClaiming: q,
    ...
    })), J = t.userStatus?.enrolledAt != null, X = t.userStatus?.completedAt != null, Z = X && t.userStatus?.claimedAt == null, ee = (0, y.if)(t), et = !(0, y.Ic)(t), en = (0, _.In)(t), ea = (0, E.IO)(t), ei = (0, E.K$)(t), es = (0, E.Cr)(t), el = (0, _.fc)(t), [er, eo, ed] = (0, _.Qo)(t, el), ec = et && en === _.F3.ACCEPTED, eu = ec && er === x.X0.SELECT, em = ec && !eu && eo.length > 1, eh = f.t.useConfig({
        location: R.rE.QUEST_HOME_DESKTOP
    }), ex = (0, k.Pd)(t), ep = (0, m.O)(e => e.clearErrorHints), eg = i.useCallback(e => {
        ...
        quest: t,
        sourceQuestContent: F
    }), eT = (0, p.W)(t, R.rE.QUEST_HOME_DESKTOP), eN = eT ? eE : ey, eI = (0, a.jsx)(r.$nd, {
        variant: "secondary",
        text: eS,
        onClick: eN
    }), ek = (0, a.jsx)(r.$nd, {
    ...
    return (eh.enabled && ex === k.UA.EXPIRED_CLAIMABLE && eh.enabledQuestStates.has(ex) ? eR = (0, a.jsx)("div", {
        className: D.x6,
    ...
    }) : eh.enabled && (ex === k.UA.COMPLETED || ex === k.UA.CLAIMED) && eh.enabledQuestStates.has(ex) ? eR = ea ? (0, a.jsx)(B, {
        quest: t,
        questContent: n,
        sourceQuestContent: F,
        onClick: ev,
        ...
        className: D.x6,
        children: eh.enabled && (ex === k.UA.UNENROLLED || ex === k.UA.ENROLLED || ex === k.UA.INCOMPLETE) && eh.enabledQuestStates.has(ex) ? (0, a.jsxs)(r.e2v, {
            direction: "horizontal",
            fullWidth: !0,
            wrap: !1,
            children: [ex === k.UA.UNENROLLED ? eO : eT ? eI : null, (0, a.jsx)(I.A, {
                quest: t,
                surface: k.V3.QUEST_HOME_TILE_FOOTER,
                analyticsCtxQuestContent: n,
                analyticsCtxSourceQuestContent: F,
    ...
    }) : (0, E.g5)(t) && !z && er !== x.X0.DESKTOP ? K ? (0, a.jsx)("div", {
        className: D.x6,
        children: (0, a.jsx)(r.$nd, {
            variant: "secondary",
            onClick: ev ?? void 0,
        ...
        children: (0, a.jsxs)(r.e2v, {
            ...
            fullWidth: !0,
            wrap: !1,
            children: [eO, eh.enabled && ex === k.UA.UNENROLLED && eh.enabledQuestStates.has(k.UA.UNENROLLED) ? (0, a.jsx)(I.A, {
                quest: t,
                surface: k.V3.QUEST_HOME_TILE_FOOTER,
                analyticsCtxQuestContent: n,
                analyticsCtxSourceQuestContent: F,
    ...
    })) : eR = eh.enabled && ex === k.UA.EXPIRED && eh.enabledQuestStates.has(ex) ? (0, a.jsx)("div", {
        className: D.x6,
        children: (0, a.jsx)(I.A, {
            quest: t,
            surface: k.V3.QUEST_HOME_TILE_FOOTER,
