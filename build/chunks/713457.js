...
function G(e) {
    ...
    } = e, G = (0, l.bG)([c.A], () => c.A.useReducedMotion), F = (0, E.Xf)({
        useReducedMotion: G
    }), V = (0, v.Ut)(), W = (0, f.RR)({
        quest: t
    ...
    })), Y = t.userStatus?.enrolledAt != null, Q = t.userStatus?.completedAt != null, J = Q && t.userStatus?.claimedAt == null, X = (0, C.if)(t), Z = !(0, C.Ic)(t), ee = (0, f.In)(t), et = (0, S.IO)(t), en = (0, S.K$)(t), ea = (0, S.Cr)(t), ei = (0, f.fc)(t), [el, es, er] = (0, f.Qo)(t, ei), eo = Z && ee === f.F3.ACCEPTED, ed = eo && el === x.X0.SELECT, ec = eo && !ed && es.length > 1, eu = g.t.useConfig({
    ...
    return (X && J ? eS = (0, a.jsx)("div", {
        ...
        children: eu.enabled && (em === I.UA.UNENROLLED || em === I.UA.ENROLLED || em === I.UA.INCOMPLETE) && eu.enabledQuestStates.has(em) ? (0, a.jsxs)(r.e2v, {
            ...
            fullWidth: !0,
            wrap: !1,
            children: [em === I.UA.UNENROLLED ? ey : null, (0, a.jsx)(N.A, {
                quest: t,
                surface: I.V3.QUEST_HOME_TILE_FOOTER,
                analyticsCtxQuestContent: n,
                analyticsCtxSourceQuestContent: L,
    ...
    }) : eu.enabled && (em === I.UA.ENROLLED || em === I.UA.INCOMPLETE) && eu.enabledQuestStates.has(em) ? (0, a.jsx)("div", {
        className: w.x6,
        children: (0, a.jsx)(N.A, {
            quest: t,
            surface: I.V3.QUEST_HOME_TILE_FOOTER,
    ...
    }) : (0, S.g5)(t) && !H && el !== x.X0.DESKTOP ? W ? (0, a.jsx)("div", {
        className: w.x6,
        children: (0, a.jsx)(r.$nd, {
            variant: "secondary",
            onClick: eg ?? void 0,
        ...
        children: (0, a.jsxs)(r.e2v, {
            ...
            fullWidth: !0,
            wrap: !1,
            children: [ey, eu.enabled && em === I.UA.UNENROLLED && eu.enabledQuestStates.has(I.UA.UNENROLLED) ? (0, a.jsx)(N.A, {
                quest: t,
                surface: I.V3.QUEST_HOME_TILE_FOOTER,
                analyticsCtxQuestContent: n,
                analyticsCtxSourceQuestContent: L,
