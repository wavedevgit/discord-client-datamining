...
function F(e) {
    ...
    })), Q = t.userStatus?.enrolledAt != null, J = t.userStatus?.completedAt != null, X = J && t.userStatus?.claimedAt == null, Z = (0, T.if)(t), ee = !(0, T.Ic)(t), et = (0, v.In)(t), en = (0, S.IO)(t), ea = (0, S.K$)(t), ei = (0, S.Cr)(t), es = (0, v.fc)(t), [el, er, eo] = (0, v.Qo)(t, es), ed = ee && et === v.F3.ACCEPTED, ec = ed && el === x.X0.SELECT, eu = ed && !ec && er.length > 1, em = g.t.useConfig({
        location: k.rE.QUEST_HOME_DESKTOP
    }), eh = (0, O.Pd)(t), ex = (0, m.O)(e => e.clearErrorHints), ep = i.useCallback(e => {
        eo(e), e === k.fO.DESKTOP && (_([]), ex(t.id))
    }, [eo, _, ex, t.id]), {
        text: eg,
        onClick: e_
    } = (0, N._c)({
