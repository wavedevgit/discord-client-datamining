...
function G(e) {
    let {
    ...
    } = e, V = (0, s.bG)([c.A], () => c.A.useReducedMotion), W = (0, T.Xf)({
        useReducedMotion: V
    }), H = (0, _.Ut)(), K = (0, v.RR)({
        quest: t
    }), z = (0, v.Vn)(t), $ = (0, v.S5)(t.config.expiresAt, {
        month: "numeric",
        day: "numeric"
    }), {
        isClaiming: q,
    ...
    })), J = t.userStatus?.enrolledAt != null, X = t.userStatus?.completedAt != null, Z = X && t.userStatus?.claimedAt == null, ee = (0, C.if)(t), et = !(0, C.Ic)(t), en = (0, v.In)(t), ea = (0, S.IO)(t), ei = (0, S.K$)(t), es = (0, S.Cr)(t), el = (0, v.fc)(t), [er, eo, ed] = (0, v.Qo)(t, el), ec = et && en === v.F3.ACCEPTED, eu = ec && er === x.X0.SELECT, em = ec && !eu && eo.length > 1, eh = g.t.useConfig({
        location: O.rE.QUEST_HOME_DESKTOP
    }), ex = (0, I.Pd)(t), ep = (0, m.O)(e => e.clearErrorHints), eg = i.useCallback(e => {
        ...
        handleOpenExternalLink: eE
    } = L({
        quest: t,
        sourceQuestContent: F
    }), eT = (0, p.W)(t, O.rE.QUEST_HOME_DESKTOP), eN = eT ? eE : ey, eI = (0, a.jsx)(r.$nd, {
        variant: "secondary",
        text: eS,
        onClick: eN
    }), ek = (0, a.jsx)(r.$nd, {
    ...
    return (eh.enabled && ex === I.UA.EXPIRED_CLAIMABLE && eh.enabledQuestStates.has(ex) ? eR = (0, a.jsx)("div", {
        className: w.x6,
    ...
    }) : eh.enabled && (ex === I.UA.COMPLETED || ex === I.UA.CLAIMED) && eh.enabledQuestStates.has(ex) ? eR = ea ? (0, a.jsx)(U, {
        quest: t,
        sourceQuestContent: F,
        onClick: ev,
        text: ef,
    ...
    }) : et ? ei ? eR = (0, a.jsx)("div", {
        className: w.x6,
        children: eh.enabled && (ex === I.UA.UNENROLLED || ex === I.UA.ENROLLED || ex === I.UA.INCOMPLETE) && eh.enabledQuestStates.has(ex) ? (0, a.jsxs)(r.e2v, {
            direction: "horizontal",
            fullWidth: !0,
            wrap: !1,
            children: [ex === I.UA.UNENROLLED ? eO : eT ? eI : null, (0, a.jsx)(N.A, {
                quest: t,
                surface: I.V3.QUEST_HOME_TILE_FOOTER,
                analyticsCtxQuestContent: n,
                analyticsCtxSourceQuestContent: F,
    ...
    }) : eh.enabled && (ex === I.UA.ENROLLED || ex === I.UA.INCOMPLETE) && eh.enabledQuestStates.has(ex) ? eT && (0, S.t)({
        quest: t
    }) && !(0, S.g5)(t) ? (0, a.jsx)("div", {
        className: w.x6,
        children: ek
    }) : (0, a.jsx)("div", {
        className: w.x6,
        children: (0, a.jsxs)(r.e2v, {
            ...
            fullWidth: !0,
            wrap: !1,
            children: [eT && (ea || (0, E.vA)(t)) ? eI : null, (0, a.jsx)(N.A, {
                quest: t,
                surface: I.V3.QUEST_HOME_TILE_FOOTER,
                analyticsCtxQuestContent: n,
                analyticsCtxSourceQuestContent: F,
    ...
    }) : (0, S.g5)(t) && !z && er !== x.X0.DESKTOP ? K ? (0, a.jsx)("div", {
        className: w.x6,
        children: (0, a.jsx)(r.$nd, {
            variant: "secondary",
            onClick: ev ?? void 0,
        ...
        className: w.x6,
        children: eT ? ek : (0, a.jsx)(r.$nd, {
            variant: "secondary",
            disabled: !0,
            text: R.intl.string(R.t["9KoPyB"]),
            fullWidth: !0
        })
    }) : J || (eR = Y ? (0, a.jsxs)(r.e2v, {
        direction: "horizontal",
        fullWidth: !0,
        wrap: !1,
        children: [(0, a.jsx)(r.$nd, {
        ...
        children: (0, a.jsxs)(r.e2v, {
            ...
            fullWidth: !0,
            wrap: !1,
            children: [eO, eh.enabled && ex === I.UA.UNENROLLED && eh.enabledQuestStates.has(I.UA.UNENROLLED) ? (0, a.jsx)(N.A, {
                quest: t,
                surface: I.V3.QUEST_HOME_TILE_FOOTER,
                analyticsCtxQuestContent: n,
                analyticsCtxSourceQuestContent: F,
