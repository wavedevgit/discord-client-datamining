...
function B(e) {
    let {
    ...
    } = e, P = (0, s.bG)([c.A], () => c.A.useReducedMotion), B = (0, y.Xf)({
        useReducedMotion: P
    }), G = (0, f.Ut)(), F = (0, _.RR)({
        quest: t
    }), V = (0, _.Vn)(t), W = (0, _.S5)(t.config.expiresAt, {
        month: "numeric",
        day: "numeric"
    }), {
        isClaiming: H,
    ...
    })), $ = t.userStatus?.enrolledAt != null, q = t.userStatus?.completedAt != null, Q = q && t.userStatus?.claimedAt == null, Y = (0, C.if)(t), J = !(0, C.Ic)(t), X = (0, _.In)(t), Z = (0, T.IO)(t), ee = (0, T.BS)(t), et = (0, T.Cr)(t), en = (0, _.fc)(t), [ea, ei, es] = (0, _.Qo)(t, en), el = J && X === _.F3.ACCEPTED, er = el && ea === h.X0.SELECT, eo = el && !er && ei.length > 1, ed = x.t.useConfig({
        location: k.rE.QUEST_HOME_DESKTOP
    }), ec = (0, N.Pd)(t), eu = i.useCallback(e => {
        ...
        startingConsoleQuest: ex,
        startConsoleQuest: ep
    } = (0, _.Wj)({
        questId: t.id,
        beforeRequest: () => {
            B.startAnimation(), G({
        ...
        launchInGameActivity: e_
    } = (0, _.zW)(t), ef = (0, g.NA)({
        quest: t,
        shortText: !0
    }), eb = null;
    return (Y && Q ? eb = (0, a.jsx)("div", {
        className: O.x6,
        children: (0, a.jsx)(r.$nd, {
            variant: "primary",
            loading: H,
    ...
    }) : ee ? eb = ed.enabled && ec === N.UA.UNENROLLED && ed.enabledQuestStates.has(N.UA.UNENROLLED) ? (0, a.jsx)("div", {
        className: O.x6,
    ...
    }) : (0, T.g5)(t) && !V && ea !== h.X0.DESKTOP ? F ? (0, a.jsx)("div", {
        className: O.x6,
        children: (0, a.jsx)(r.$nd, {
            variant: "secondary",
            onClick: eh ?? void 0,
        ...
        className: O.x6,
        children: ed.enabled && ec === N.UA.UNENROLLED && ed.enabledQuestStates.has(N.UA.UNENROLLED) ? (0, a.jsx)(E.A, {
            quest: t,
            surface: N.V3.QUEST_HOME_TILE_FOOTER,
            analyticsCtxQuestContent: n,
            analyticsCtxSourceQuestContent: A,
