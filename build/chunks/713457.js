...
function G(e) {
    ...
    })), Q = t.userStatus?.enrolledAt != null, Y = t.userStatus?.completedAt != null, J = Y && t.userStatus?.claimedAt == null, X = (0, C.if)(t), Z = !(0, C.Ic)(t), ee = (0, f.In)(t), et = (0, T.IO)(t), en = (0, T.K$)(t), ea = (0, T.Cr)(t), ei = (0, f.fc)(t), [es, el, er] = (0, f.Qo)(t, ei), eo = Z && ee === f.F3.ACCEPTED, ed = eo && es === h.X0.SELECT, ec = eo && !ed && el.length > 1, eu = p.t.useConfig({
    ...
    }), eC = eA.enabled && eA.variant === x.dF.NEXT_TO_PRIMARY_CTA, ey = null;
    if (eC) {
        let e = (0, A.wr)(t);
        ey = (0, a.jsx)(r.$nd, {
            variant: "secondary",
    ...
    }) : (0, T.g5)(t) && !H && es !== h.X0.DESKTOP ? W ? (0, a.jsx)("div", {
        className: w.x6,
        children: (0, a.jsx)(r.$nd, {
            variant: "secondary",
            onClick: ep ?? void 0,
