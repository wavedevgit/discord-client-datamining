...
r = "function" == typeof Symbol ? function(e) {
    ...
    return l(this, "lruList").forEach(function(e) {
        ...
        e.maxAge !== o && (l.maxAge = e.maxAge), s !== c && (l.length = e.length), p(this, e) && (l.stale = !0), l = a.inspect(l, t).split("\n").join("\n  "), n += i + " => " + l
    }), (u || r) && (n += "\n"), n += "}"
    ...
    return o.length > l(this, "max") ? (l(this, "dispose") && l(this, "dispose").call(this, e, t), !1) : (l(this, "length", l(this, "length") + o.length), l(this, "lruList").unshift(o), l(this, "cache").set(e, l(this, "lruList").head), _(this), !0)
