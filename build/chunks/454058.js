...
function v(e) {
    ...
    0 !== t.length && (f[e] = new Set(t.filter(t => {
...
class w extends i.Ay.Store {
    ...
    shouldIndicateNewChannel(e, t) {
        ...
        return null != n && !!n.features.has(y.GuildFeatures.COMMUNITY) && (null != e && null == f[e] && v(e), f[e]?.has(t) && null == g.Ay.getTrackedAckMessageId(t))
    }
}
let m = new w(s.h, {
    ...
    CHANNEL_SELECT: function(e) {
        ...
        return null != t && (null == f[t] || S[t] < Date.now() - p.A.Millis.HOUR ? (v(t), !0) : (null != n && E(t, n), !1))
    },
