...
let w = () => {
    ...
    let [Y, X] = s.useState(!1), [K, W] = s.useState(!1), [Z, q] = s.useState(!1), [Q, J] = s.useState(!1), $ = (0, o.bG)([p.A], () => p.A.getPremiumTypeSubscription()), ee = null != $ ? (0, f.EL)($) : null, et = null != ee ? f.Ay.getSkuIdForPlan(ee.planId) : null, en = null !== et && et !== G.pe.TIER_2 ? G.pe.TIER_2 : null, ei = (0, S.cg)(), {
    ...
    let ea = [N.k.HOME, N.k.WHATS_NEW, N.k.BEST_OF_NITRO, N.k.PLANS, N.k.COMPARE],
        ...
        ex = (0, i.jsxs)("div", {
            ...
            children: [(0, i.jsx)(v.A, {
                ...
                innerRef: V,
                onChange: e => {
                    e && !Z && (T.default.track(M.HAw.PREMIUM_MARKETING_SURFACE_REACHED_BOTTOM, {
                        location_stack: es
                    }), q(!0))
                },
                children: (0, i.jsx)("div", {
