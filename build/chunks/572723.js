...
function L(e) {
    let {
        transitionState: t,
        onClose: L
    } = e, P = a.useRef(null), N = a.useRef(null), [T, B] = a.useState(""), [I, R] = a.useState(""), [D, z] = a.useState(), [V, M] = a.useState(""), [W, Y] = a.useState([]), [H, K] = a.useState(), [$, F] = a.useState(), [U, G] = a.useState(!1), [q, Z] = a.useState(""), [J, X] = a.useState(function(e) {
        switch (e) {
            case "windows":
                return "Windows";
            case "macos":
        ...
        return ""
    }((0, w.getOS)())), [Q, ee] = a.useState(""), [et, ei] = a.useState(""), [en, ea] = a.useState(""), [el, er] = a.useState(""), [es, eo] = a.useState(!1), [eu, ed] = a.useState(!1), [ec, em] = a.useState(!1), [eh, ep] = a.useState(null);
    a.useEffect(() => {
        ...
        s.Bo.get({
            ...
            if (null != e.body && "05e637db7e0aa8c4eef0b7dea78f94d8003c7562" !== e.body.hash) {
                let e = new Date("1772662177960"),
                    t = new Date,
                    i = (0, S.Tf)(t, e);
            ...
            children: [(0, n.jsxs)(d.BJc, {
                ...
                children: [null != ef && (0, n.jsxs)(d.wx6, {
                    ...
                    children: [(0, n.jsx)(d.Heading, {
                        ...
                        variant: "text-sm/normal",
                        children: eb.map(e => (0, n.jsxs)("div", {
                ...
                children: [(0, n.jsx)(d.ksK, {
                    ...
                    renderOptionLabel: e => {
                        let t;
                        return t = e.priority, (0, n.jsxs)("div", {
                            className: A.jS,
                            children: [(0, n.jsxs)("div", {
                                className: A.Kt,
                    ...
                    value: $,
                    options: H?.features?.filter(e => "" !== (0, k.wY)(e))?.map(e => ({
                        id: (0, k.wY)(e),
                        label: e.name ?? "",
                        value: (0, k.wY)(e)
                    ...
                    children: (0, n.jsx)(c.A, {
                        ref: P,
                        onChange: e => {
                            e.currentTarget?.files?.[0] != null && Y([...W, ...Array.from(e.currentTarget.files).map(e => new m.Ay({
                                id: (0, l.A)(),
                                file: e,
                                platform: m.xz.WEB,
                                origin: "file_picker"
                                ...
                                children: [(0, n.jsx)(f.J, {
                                    ...
                                    children: (0, n.jsx)(g.Ay, {
                                        children: (0, n.jsx)(p.A, {
                                            ...
                                            onClick: () => {
                                                var t;
                                                return t = e.id, void Y(W.filter(e => e.id !== t))
                                            },
                                            dangerous: !0,
