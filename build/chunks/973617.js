/** Chunk was on web.js **/
/** chunk id: 973617, original params: e,t,n (module,exports,require) **/
"use strict";
n.d(t, {
    A: () => c
});
var r = n(355418),
    i = n(632434),
    a = n(725198);
let s = RegExp("(\\d+|[" + Object.keys(a.uk).join("") + "]+|半|幾)(?:\\s*)(?:個)?(秒(?:鐘)?|分鐘|小時|鐘|日|天|星期|禮拜|月|年)(?:(?:之|過)?後|(?:之)?內)", "i"),
    o = 1,
    l = 2;
class c extends r.c {
    innerPattern() {
    ...
    innerExtract(e, t) {
        ...
        let s = {},
            c = t[l][0];
        if (c.match(/[日天星禮月年]/)) {
            "日" == c || "天" == c ? s.day = r : "星" == c || "禮" == c ? s.week = r : "月" == c ? s.month = r : "年" == c && (s.year = r);
