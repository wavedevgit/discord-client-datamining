...
class $ extends n.PureComponent {
    ...
    componentDidMount() {
        m._.subscribe(w.jej.PERFORM_SEARCH, this.search), m._.subscribe(w.jej.SET_SEARCH_QUERY, this.handleSetSearchQuery), m._.subscribe(w.jej.FOCUS_SEARCH, this.handleFocusSearch)
    }
    handleCutEvent = e => {
    ...
    componentWillUnmount() {
        m._.unsubscribe(w.jej.PERFORM_SEARCH, this.search), m._.unsubscribe(w.jej.SET_SEARCH_QUERY, this.handleSetSearchQuery), m._.unsubscribe(w.jej.FOCUS_SEARCH, this.handleFocusSearch), this._editorRef?.editor?.removeEventListener?.("cut", this.handleCutEvent)
    }
    handleSetSearchQuery = e => {
        ...
        " " !== t.charAt(t.length - 1) && (t += " "), null != r && 0 !== r && " " !== o.charAt(r - 1) && " " !== t.charAt(0) && (t = " " + t), l ? (i = y.t7(t, i), r = 0) : i = y.le(t, i, r, s), i = y.a4(i, P), i = this.tokenize(i);
        let u = Number(r) + t.length;
        i = y.UO(u, i), this.setEditorState(i), n && this.search({
            queryString: y.pe(i),
            searchQuerySource: a
        })
    };
    ...
    search = e => {
        ...
        if (!t) {
            let e = (0, L._o)(r),
                t = (0, L.Zf)(e);
            for (let t = 0; t < e.length; t++)(0, L.Zh)(e[t], e[t + 1]) || (r = r.substring(0, e[t].start) + r.substring(e[t].end));
            if (0 === e.length || 0 === Object.keys(t).length) return !1;
            this.props.onSearch({
                queryString: r,
                query: t,
                searchEverywhere: s ?? !1,
                searchQuerySource: n
    ...
    handleClearSearch = e => {
        ...
        (e.preventDefault(), e.stopPropagation(), "" === y.pe(t)) ? this.focusEditor(): (t = y.a4(t, 0), this.setEditorState(t), (0, j.iK)({
            searchContext: r
    ...
    handleFocusSearch = e => {
        ...
        let l = (0, L.Rt)(s);
        null == l ? this.focusEditor() : ((0, j.Tf)({
            searchContext: n
    ...
    handleBlur = () => {
        ...
        b.A.setFocused(e, !1), this.setState({
            focused: !1
        }, () => {
    ...
    handleKeyBind = e => {
        ...
        if ("Escape" === t) {
            if (e.preventDefault(), y.Im(l)) this.blurEditor();
                ...
                let e = y.Xq(l);
                C.A.updateSearchEditorState(a, e), this.setState({
                    focused: !0
                })
            }
            return !0
        ...
        if ("Home" === t || "ArrowLeft" === t && r) return e.preventDefault(), l = s ? y.mQ(l) : y.aB(l), this.setEditorState(l), !0;
        if ("End" === t || "ArrowRight" === t && r) return e.preventDefault(), l = s ? y.Le(l) : y.Tj(l), this.setEditorState(l), !0;
                    ...
                    children: (0, s.jsx)("div", {
                        ...
                        children: (0, s.jsx)(d.vN3, {
                            ...
                            children: (0, s.jsxs)("div", {
                                ...
                                children: [this.renderInput(u), (0, s.jsx)(d.BT5, {
...
function Q(e) {
    ...
    }, [u, t]), n.useEffect(() => (f.A.setSelectedSearchContext(l), () => {
    ...
    let k = n.useCallback(e => {
            ...
            b.A.refreshQueryId(t), (0, j.fd)({
                searchContext: t,
                query: s,
                queryString: r,
                searchQuerySource: l
            }), C.A.updateSearchMode(t, w.BBH.NEWEST), q({
                searchContext: t,
                searchQueryString: r,
                searchEverywhere: n,
                offset: 0
