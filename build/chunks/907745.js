...
class $ extends s.PureComponent {
    ...
    handleSetSearchQuery = e => {
        ...
        " " !== t.charAt(t.length - 1) && (t += " "), null != r && 0 !== r && " " !== o.charAt(r - 1) && " " !== t.charAt(0) && (t = " " + t), l ? (i = y.t7(t, i), r = 0) : i = y.le(t, i, r, n), i = y.a4(i, P), i = this.tokenize(i);
        let c = Number(r) + t.length;
        i = y.UO(c, i), this.setEditorState(i), s && this.search({
            queryString: y.pe(i),
            searchQuerySource: a
        })
    };
    ...
    handleClearSearch = e => {
        ...
        (e.preventDefault(), e.stopPropagation(), "" === y.pe(t)) ? this.focusEditor(): (t = y.a4(t, 0), this.setEditorState(t), (0, k.iK)({
            searchContext: r
    ...
    handleReturn = e => {
        ...
        return e.preventDefault(), this.handleOption() || ((0, b.Eq)() && t ? this.search({
            searchEverywhere: !0,
            searchQuerySource: M.Q_.SEARCH_TEXT_INPUT
        }) : this.search({
            searchQuerySource: M.Q_.SEARCH_TEXT_INPUT
    ...
    handleBeforeInput = e => {
        ...
        return y.pe(t).length >= P || (t = y.le(e, t), t = y.a4(t, P), t = this.tokenize(t), this.setEditorState(t), r || this.setState({
            focused: !0
        })), "handled"
    };
    handleKeyCommand = e => {
        ...
        switch (e) {
            ...
            case "delete":
            case "delete-word":
                return t = y.vE(e, t), t = this.tokenize(t), this.setEditorState(t), r || this.setState({
                    focused: !0
                }), "handled";
    ...
    handlePastedText = e => {
        ...
        return e = null != e ? e.replace(/\n/g, "") : "", t = y.le(e, t), t = y.a4(t, P), t = this.tokenize(t), r || this.setState({
            focused: !0
    ...
    handleKeyBind = e => {
        ...
        if ("Home" === t || "ArrowLeft" === t && r) return e.preventDefault(), l = n ? y.mQ(l) : y.aB(l), this.setEditorState(l), !0;
        if ("End" === t || "ArrowRight" === t && r) return e.preventDefault(), l = n ? y.Le(l) : y.Tj(l), this.setEditorState(l), !0;
...
function Q(e) {
    ...
    }, [c, t]), s.useEffect(() => (E.A.setSelectedSearchContext(l), () => {
