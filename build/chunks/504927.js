/** Chunk was on web.js **/
/** chunk id: 504927, original params: e,t,n (module,exports,require) **/
"use strict";
n.d(t, {
    A: () => o
});
...
class o extends a.w {
    ...
    innerExtract(e, t) {
        ...
        if (a.match(/следующей\s*ночью/)) {
            ...
            t.setDate(t.getDate() + e), (0, i.Pl)(o, t), o.imply("hour", 0)
        }
        return a.match(/в\s*полночь/) || a.endsWith("ночью") ? r.Bm(e.reference) : o
    }
}