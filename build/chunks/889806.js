/** chunk id: 889806 params = (module,exports,require) **/
n.d(t, {
    A: () => H
});
var i = n(627968),
...
class B extends M.Ay {
    ...
    renderPopout = e => {
        ...
        return t.isModeratorReportChannel() || s ? null : null != l && l.length > 0 && a && !n ? (0, i.jsx)(G.A, {
    ...
    handleContextMenu = e => {
        ...
        if (t.type === P.rbe.GROUP_DM) return void(0, u.L3)(e, async () => {
            let {
                default: e
    ...
    render() {
        ...
        } = this.props, R = y ?? this.channelItemRef, O = !b && o, L = !b && S && null != N && N.length > 0, M = (0, p.M)(E), D = (0, i.jsxs)("li", {
...
function H(e) {
    ...
    })), p = (0, o.bG)([R.Ay], () => R.Ay.resolveUnreadSetting(t)), f = (0, o.cf)([T.A, v.A], () => {
