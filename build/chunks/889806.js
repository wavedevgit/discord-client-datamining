...
class P extends R.Ay {
    ...
    render() {
        let {
            ...
            withGuildIcon: N,
            enableActivities: b
        } = this.props, S = b && null != E && E.length > 0, T = (0, g.M)(x), {
...
function k(e) {
    ...
    return (0, r.bG)([b.A, E.Ay], () => b.A.getChannelId() !== t.id && E.Ay.isCurrentUserGuest(t.getGuildId())) ? null : (0, i.jsx)(w, {
        ...u,
        ...g,
        ...e,
        hasActiveThreads: c,
