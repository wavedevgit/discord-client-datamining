...
class U extends j.Ay {
    ...
    renderPopout = e => {
        ...
        return t.isModeratorReportChannel() || l ? null : null != s && s.length > 0 && r && !n ? (0, i.jsx)(L.A, {
    ...
    handleContextMenu = e => {
        ...
        if (t.type === M.rbe.GROUP_DM) return void(0, d.L3)(e, async () => {
            let {
                default: e
        ...
        if (t.isModeratorReportChannel()) return void(0, d.L3)(e, async () => {
            let {
                default: e
    ...
    render() {
        let {
            ...
            withGuildIcon: N,
            enableActivities: b
        } = this.props, S = b && null != E && E.length > 0, T = (0, g.M)(x), v = (0, i.jsx)("li", {
            className: r()(this.getClassName(), {
                [G.r9]: this.isDisabled(),
                [G.wH]: n
            }),
...
function w(e) {
    ...
    return (0, a.bG)([b.A, E.Ay], () => b.A.getChannelId() !== t.id && E.Ay.isCurrentUserGuest(t.getGuildId())) ? null : (0, i.jsx)(P, {
        ...u,
        ...g,
        ...e,
        hasActiveThreads: c,
