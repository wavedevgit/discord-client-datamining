...
function V(e) {
    let {
        ...
        onClose: f,
        createdEvent: E
    } = e, p = (0, h.GV)(), C = s.useRef(n), T = !(0, a.isEqual)(C.current, n), k = s.useMemo(() => [{
        slideId: 0,
...
function w(e) {
    ...
    return (0, i.jsx)(V, {
        ...
        onChange: e => {
            if (null != e.entityType) {
                let n = (0, C.dy)(e.entityType),
                    [l] = (0, E.kh)(t, n);
                e.channelId = l?.id ?? null, e.entityType !== _.Ps.EXTERNAL && v.entityType === _.Ps.EXTERNAL && (e.entityMetadata = null)
            }
            y(t => ({
                ...t,
                ...e
        ...
        onSave: () => {
            null != v.recurrenceRule && b && (0, T.DS)(u, v) ? (0, d.mMO)(async () => {
                let {
                    ConfirmModal: e
