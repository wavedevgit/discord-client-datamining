...
let ex = new eS(l.h, {
    LOGOUT: function() {
        D = [], U = [], G = [], V = {}, k = {}, B = {}, H = {}, M = null, F = {}, Y = {}, W = 0, q = !1, z = !1, K = !1, Z = [], J = [], ee = 0, w = 0, en = 0, ei = !0, er = !1, el = new Set, Q = null, ea = !1, es = !1, $ = null, eo = 0
    },
    ...
    LOAD_ICYMI_DEHYDRATED: function(e) {
        ...
        let [a, s] = ep(U);
        if (G = eg(a), !K || 0 === W || r) W = 0, !ea && ec(a, U) ? (z = !0, q = !0) : z = !1, em({
            newUnread: a,
            newRead: s
        });
        else {
