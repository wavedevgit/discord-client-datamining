/** chunk id: 313452 params = (module,exports,require) **/
n.d(t, {
    A: () => D
}), n(321073);
var i = n(627968),
...
function D(e) {
    let t, {
        ...
        z = (t = (0, d.yK)([I.A], () => I.A.getNotifyingChannelIds() ?? []), (0, d.bG)([I.A, m.Ay], () => {
    ...
    l.useEffect(() => {
        function e() {
            P.current?.scrollPageUp({
                animate: !0
            })
        }

        function t() {
            P.current?.scrollPageDown({
                animate: !0
            })
        }
    ...
    let q = l.useCallback(() => {
        ...
        X = l.useMemo(() => {
            ...
            return (n.length > 0 || s.length > 0) && (o().each(s, e => {
        ...
        $ = l.useMemo(() => {
            let e = [];
            return Q ? e.push(A()) : J ? e.push((0, i.jsx)(M, {}, "empty-state")) : U ? (e.push(...s.map(e => _([e], !0))), e.push(...n.map(e => _([e], !1)))) : o().each(L, t => {
                ...
                }, t)), W[t] && e.push(...X[t].map(e => _(e, t === S.Ur.UNREAD))))
            }), e
    ...
    ! function(e) {
        ...
        } = e, i = l.useRef(!1), s = n.UNREAD.length > 0, {
