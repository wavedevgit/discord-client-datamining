    ...
    return (0, i.jsx)(u.DUT, {
        ...
        children: (0, i.jsxs)(u.BJc, {
            ...
            children: [(0, i.jsx)(u.Heading, {
                ...
                color: "text-subtle",
                className: j.P7,
                children: (0, a.capitalize)(y.intl.string(b.v7[t]).toLowerCase())
            }), (0, i.jsx)(u.abt, {
                size: "xxs",
                className: j.ai
            })]
...
function D(e) {
    let t, {
        ...
        z = (t = (0, d.yK)([E.A], () => E.A.getNotifyingChannelIds() ?? []), (0, d.bG)([E.A, p.Ay], () => {
            ...
            for (let n of t) {
                let t = e[n];
                if ((null == t || t.loadState === b.Ve.UNLOADED) && p.Ay.hasUnread(n)) return !0
            }
            return !1
        }, [t]));
    s.useEffect(() => {
    ...
    let q = s.useCallback(() => {
            ...
            e.scrollHeight - (e.scrollTop + e.offsetHeight) <= t && a?.(b.VA.USER_SCROLL)
        }, [a]),
        X = s.useMemo(() => {
            let e = {
                    [b.Ur.UNREAD]: [],
    ...
    s.useEffect(() => {
        Q || B || 0 >= ei() || (!ee || z) && a?.(b.VA.FILL_SCROLLER)
    }, [ei, a, Q, B, ee, z]);
    let es = s.useMemo(() => {
