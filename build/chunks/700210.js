/** Chunk was on web.js **/
/** chunk id: 700210, original params: e,t,n (module,exports,require) **/
"use strict";
n.d(t, {
    A: () => E
}), n(321073);
...
function E(e) {
    ...
    let {
        ...
        context: O,
        onItemClick: v
    } = e, A = null != (t = null == y ? void 0 : y.id) ? t : null == E ? void 0 : E.id, I = _.A.getGuild(b), S = (0, a.bG)([h.A], () => null != I ? h.A.can(m.xBc.MANAGE_GUILD, I) : null), T = !0, C = !0, N = (0, l.ON)(b, C), w = (0, l.A4)(T, C), R = (0, a.bG)([p.default], () => null != p.default.getNewestTokenForApplication(A)), {
        isUserApp: P,
        isGuildApp: D
    } = i.useMemo(() => {
        var e, t, n, r;
        ...
        let i = Object.values(null != (e = null == (n = N.result) ? void 0 : n.sections) ? e : {}),
            a = Object.values(null != (t = null == (r = w.result) ? void 0 : r.sections) ? t : {});
        return {
            isGuildApp: i.some(e => {
                var t;
                return (null == (t = e.descriptor.application) ? void 0 : t.id) === A
            }),
            isUserApp: a.some(e => {
                var t;
                return (null == (t = e.descriptor.application) ? void 0 : t.id) === A
