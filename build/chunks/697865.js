...
function L(e) {
    let {
        guildId: t,
        showVideoCard: n = !1
    } = e, i = (0, o.bG)([A.A], () => A.A.getGuild(t)), u = (0, o.bG)([x.A], () => x.A.getSortedRoles(t).find(e => e.tags?.premium_subscriber === null)), E = (0, o.bG)([v.default], () => v.default.getCurrentUser()), L = E?.id, y = (0, o.bG)([g.Ay], () => null != L ? g.Ay.getMember(t, L) : void 0, [L, t]), k = y?.premiumSince != null, R = (0, j.q)("GuildPowerupsBoostInfoContainerMember"), T = (0, o.bG)([c.A], () => c.A.useReducedMotion), {
