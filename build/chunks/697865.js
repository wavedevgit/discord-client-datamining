...
function y(e) {
    let {
        guildId: t
    } = e, n = (0, o.bG)([x.A], () => x.A.getGuild(t)), i = (0, o.bG)([g.A], () => g.A.getSortedRoles(t).find(e => e.tags?.premium_subscriber === null)), d = (0, o.bG)([v.default], () => v.default.getCurrentUser()), E = d?.id, y = (0, o.bG)([A.Ay], () => null != E ? A.Ay.getMember(t, E) : void 0, [E, t]), L = y?.premiumSince != null, k = (0, I.q)("GuildPowerupsBoostInfoContainerMember"), N = (0, o.bG)([c.A], () => c.A.useReducedMotion), {
    ...
    return null == n || null == y || null == d ? null : (0, r.jsxs)("div", {
        className: C.ft,
