...
function y(e) {
    let {
        guildId: t,
        showVideoCard: n = !1
    } = e, i = (0, a.bG)([g.A], () => g.A.getGuild(t)), u = (0, a.bG)([f.A], () => f.A.getSortedRoles(t).find(e => e.tags?.premium_subscriber === null)), b = (0, a.bG)([v.default], () => v.default.getCurrentUser()), y = b?.id, L = (0, a.bG)([A.Ay], () => null != y ? A.Ay.getMember(t, y) : void 0, [y, t]), T = L?.premiumSince != null, k = (0, j.q)("GuildPowerupsBoostInfoContainerMember"), R = (0, a.bG)([c.A], () => c.A.useReducedMotion), {
