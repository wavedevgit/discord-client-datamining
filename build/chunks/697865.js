...
function w(e) {
    let {
        guildId: t
    } = e, n = (0, o.bG)([x.A], () => x.A.getGuild(t)), i = (0, o.bG)([g.A], () => g.A.getSortedRoles(t).find(e => e.tags?.premium_subscriber === null)), d = (0, o.bG)([v.default], () => v.default.getCurrentUser()), E = d?.id, w = (0, o.bG)([f.Ay], () => null != E ? f.Ay.getMember(t, E) : void 0, [E, t]), y = w?.premiumSince != null, L = (0, o.bG)([c.A], () => c.A.useReducedMotion), {
    ...
    return null == n || null == w || null == d ? null : (0, r.jsxs)("div", {
        className: S.ft,
