...
function R(e) {
    let {
        ...
        let e = Date.now();
        return r()(S.A.getSpeakers()).map(e => b.A.getParticipant(t, e)).filter(e => null != e && e.type === v.lp.USER && e.speaking && !(0, _.Ay)(e)).sortBy(t => -S.A.getSpeakingDuration(t.user.id, e)).slice(0, 3).value()
    });
