...
function P(e) {
    let {
        guildId: t,
        instance: n
    } = e, [s, r] = i.useState(!1), l = i.useCallback(() => {
        r(!0), (0, j.as)(t, n.id).finally(() => {
            r(!1)
        })
    }, [t, n.id]);
...
function D(e) {
    return (0, a.jsx)(u.Button, {
        fullWidth: !0,
        text: k.intl.string(R.default["fQCcM/"]),
        variant: "primary",
        ...e
    })
}
...
function U(e) {
    let {
        guildId: t
    } = e, [n, s] = i.useState(!1), r = i.useCallback(() => {
        s(!0), (0, j.cq)(t).finally(() => {
            s(!1)
        })
    }, [t]);
    return (0, a.jsx)(u.Button, {
...
function F(e) {
    let {
        guildId: t,
        instance: n
    } = e, s = (0, E.A)(n), [j, F] = (0, m.kn)([o.M.GAME_SERVER_HOSTING_PORTKEY_TOS]), w = j !== o.M.GAME_SERVER_HOSTING_PORTKEY_TOS, V = (0, d.bG)([g.A], () => g.A.getDetectableGame(n.gameId)), W = (0, b.A)(n.providerType, n.gameServerPanelUrl), q = i.useCallback(() => {
        (0, p.Ai)(t, n.gameId, V?.name ?? "", n.id), w || null == n.providerType ? (0, T.A)(t, n) : (0, y.A)({
        ...
        handleCopyServerIp: H,
        animateCopyIcon: K
    } = (0, N.A)(t, n.id, _.A.GAME_SERVER_GAME, s ?? ""), Z = (0, S.A)(n.gameId, "cover"), $ = (0, h.A)(t), z = i.useCallback(() => {
        (0, p.f7)(t, n.id), (0, v.h)({
            href: n.gameServerPanelUrl ?? ""
        })
    }, [n.gameServerPanelUrl, t, n.id]), Y = i.useMemo(() => {
        switch (n.status) {
            case l.M.SLEEPING:
                ...
                children: (0, a.jsxs)("div", {
                    ...
                    children: [(0, a.jsxs)("div", {
                        ...
                        children: [(0, a.jsx)(u.Text, {
                            ...
                            children: [n.status === l.M.STARTING ? (0, a.jsx)(u.y$y, {
                                type: u.tVU.SPINNING_CIRCLE_SIMPLE,
                                className: G.statusLoading
                            }) : (0, a.jsx)("span", {
                                className: r()(G.statusIndicator, null != n.status && G[n.status])
                            }), (0, a.jsx)(u.Text, {
                                variant: "text-sm/medium",
                                children: function(e) {
                                    switch (e) {
