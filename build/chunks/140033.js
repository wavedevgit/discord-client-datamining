...
function D(e) {
    return (0, a.jsx)(o.Button, {
        fullWidth: !0,
        text: M.intl.string(y.default["fQCcM/"]),
        variant: "primary",
        ...e
    })
}
...
function U(e) {
    let {
        guildId: t,
        instance: n
    } = e, i = (0, b.A)(n), [j, U] = (0, _.kn)([d.M.GAME_SERVER_HOSTING_PORTKEY_TOS]), F = j !== d.M.GAME_SERVER_HOSTING_PORTKEY_TOS, {
        data: V
    } = (0, m.I)(n.gameId), w = (0, E.A)(n.providerType, n.gameServerPanelUrl), W = s.useCallback(() => {
        (0, h.Ai)(t, n.gameId, V?.name ?? "", n.id), F || null == n.providerType ? (0, S.A)(t, n) : (0, T.A)({
        ...
        handleCopyServerIp: q,
        animateCopyIcon: Y
    } = (0, I.A)(t, n.id, u.A.GAME_SERVER_GAME, i ?? ""), H = (0, N.A)(n.gameId, "cover"), K = (0, v.A)(t), Z = s.useCallback(() => {
        (0, h.f7)(t, n.id), (0, g.h)({
                ...
                children: (0, a.jsxs)("div", {
                    ...
                    children: [(0, a.jsxs)("div", {
                        ...
                        children: [(0, a.jsx)(o.Text, {
                            ...
                            children: null == i ? (0, a.jsx)(o.Text, {
                                variant: "text-sm/medium",
                                children: "—"
                        ...
                        children: [(0, a.jsx)(o.Text, {
                            ...
                            children: [n.status === r.M.STARTING ? (0, a.jsx)(o.y$y, {
