/** chunk id: 645105 params = (module,exports,require) **/
"use strict";
n.d(t, {
    A: () => S
}), n(321073);
...
function N(e) {
    let {
        rule: t,
        triggerType: n
    } = e, l = s.useMemo(() => null == t ? (0, g.J6)(n).map(e => (0, i.jsx)(_.A, {
        actionType: e,
        triggerType: n
    }, e)) : (0, g.J6)(n).reduce((e, s) => {
        ...
        return null == l || e.push((0, i.jsx)(_.A, {
            actionType: s,
            action: l,
            triggerType: t?.triggerType ?? n
        }, s)), e
    }, []), [t, n]);
...
function b(e) {
    let {
        ...
        isDefaultRule: n,
        onContextMenu: o
    } = e, d = (0, h.l)(t.triggerType, t), {
        isLoading: c,
        saveRule: g
    } = (0, x.S)(), {
        updateRule: _
    } = (0, m.wP)(t.guildId), [A, p] = s.useState(t.enabled), C = (0, l.throttle)(async () => {
        if (!c) {
            let e = {
                ...t,
                enabled: !A
