/** Chunk was on web.js **/
/** chunk id: 676765, original params: e,t,n (module,exports,require) **/
"use strict";
n.d(t, {
    A: () => f
}), n(896048);
...
function f(e) {
    ...
    let {
        context: n
    } = e, i = "channel" === n.type ? n.channel : void 0, f = (0, l.ON)(null == i ? void 0 : i.guild_id, !0), {
        ...
        var e, t;
        return Object.values(null != (e = null == (t = f.result) ? void 0 : t.sections) ? e : {}).map(e => {
            let {
                descriptor: t
            } = e;
            return t
