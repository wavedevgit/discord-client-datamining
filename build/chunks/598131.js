...
let en = e => {
    let {
    ...
    }), [t, ep, eg, eA, ev, e_, ey, eM]), eG = a.useMemo(() => (0, _.ks)({
        freeTextElements: ep,
        dropdownElements: eg,
        ...
        textInput: eM,
        multiSelect: ey
    }), [ep, eg, eA, e_, ev, eM, ey]), eL = a.useCallback((e, t) => {
        let n = {
            ...ey
        };
        e in ey ? delete n[e] : n[e] = t, eE(n)
    }, [ey]), eD = a.useCallback(function(e, t) {
    ...
    return (0, l.jsxs)("div", {
        ...
        children: [(0, l.jsxs)(r.rQ0, {
            ...
            children: [null != em && (0, l.jsx)(z.A, {
                ...
                element: eb
            }), null != ee(t, "message_preview") && ("message" === n.name || "first_dm" === n.name || "report_to_mod_message" === n.name) && (0, l.jsx)(G.A, {
                message: n.record
                ...
                widget: n.widget,
                userId: n.user_id
            }) : null, null != ee(t, "guild_preview") && "guild" === n.name ? (0, l.jsx)(k.A, {
                guild: n.record
                ...
                children: [eW && (0, l.jsx)(M.A, {
                    ...
                    message: n.record,
                    reportId: ed
                }), null != ee(t, "leave_guild") && "guild" === n.name && (0, l.jsx)(w.A, {
                    guildId: n.record.id,
                    reportId: ed
                }), null != ee(t, "deauthorize_app") && "application" === n.name && (0, l.jsx)(v.A, {
                    application: n.record,
                    reportId: ed
                }), null != ee(t, "deauthorize_app") && "application" === n.name && (0, l.jsx)(B.A, {
                    application: n.record,
                    reportId: ed
                })]
            ...
            }), null != ee(t, "guild_scheduled_event_preview") && "guild_scheduled_event" === n.name && (0, l.jsx)(y.A, {
                event: n.record
                ...
                onChange: eD,
                state: eM
            }), X.includes(n.name) && null != eg && eg.length > 0 && (0, l.jsx)(C.A, {
                elements: eg,
                onChange: eD,
                state: eM
            }), null != eA && (0, l.jsx)(b.A, {
                ...
                onChange: eD,
                state: eM
            }), X.includes(n.name) && null != ep && ep.length > 0 && (0, l.jsx)(j.A, {
                elements: ep,
                onChange: eD,
                state: eM
                ...
                children: [(0, l.jsx)(A.A, {
                    ...
                    onSelectChild: eU,
                    nodeMap: e.nodeMap
                }), null != ex && ex.length > 0 ? (0, l.jsx)(I.A, {
                    elements: ex
                }) : null]
            }), (0, l.jsx)(T.A, {
                errorMessage: eN,
