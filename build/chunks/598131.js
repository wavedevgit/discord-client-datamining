...
let el = e => {
    ...
    a.useEffect(() => {
        t.is_auto_submit && !ey && (eS(!0), es(eO(["", t.id])))
    }, [t.is_auto_submit, ey, es, eO, t.id]);
    let ez = (0, c.fY)(el),
