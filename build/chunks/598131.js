...
let el = e => {
    let {
    ...
    }), [t, eg, eh, eA, ev, eT, em, eM, eO]), eD = a.useMemo(() => (0, _.ks)({
        freeTextElements: eg,
        dropdownElements: eh,
        ...
        textInput: eO,
        multiSelect: eM
    }), [eg, eh, eA, ev, em, eT, eO, eM]), eU = a.useCallback((e, t) => {
        let n = {
            ...eM
        };
        e in eM ? delete n[e] : n[e] = t, eR(n)
    }, [eM]), eB = a.useCallback(function(e, t) {
    ...
    return (0, l.jsxs)("div", {
        ...
        children: [(0, l.jsxs)("div", {
            className: X.U1,
            children: [null != t.header && "" !== t.header ? (0, l.jsx)(r.Heading, {
            ...
            children: [null != ex && (0, l.jsx)(K.A, {
                ...
                onChange: eU,
                state: eM
            }), ee.includes(n.name) && null != eT && (0, l.jsx)(A.A, {
                element: eT,
                onChange: eB,
                state: eO
