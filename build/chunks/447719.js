...
function l(e) {
    ...
    return (0, r.useMemo)(() => {
        switch (c) {
            case "FULL_WISHLIST":
                return {
                    title: s.intl.formatToPlainString(s.t["YcL/Vr"], {
                        username: o
                    }), showIcons: !1
                };
            case "MIXED":
                return {
                    title: s.intl.formatToPlainString(s.t.dIDKgi, {
                        username: o
                    }), showIcons: !0
                };
            default:
                return {
                    title: s.intl.string(s.t.BCi1gT), showIcons: !1
                }
        }
    }, [c, o])
}
