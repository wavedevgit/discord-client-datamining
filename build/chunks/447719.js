...
let a = {
    FULL_WISHLIST: {
        ...
        getSubtitle: e => s.intl.formatToPlainString(s.t.BjEX38, {
            username: e
        }),
        showIcons: !1
    },
    MIXED: {
        ...
        getSubtitle: e => s.intl.formatToPlainString(s.t.dIDKgi, {
            username: e
        }),
        showIcons: !0
    },
    SHOP_ONLY: {
        title: s.intl.string(s.t.SK5rmi),
        getSubtitle: e => s.intl.formatToPlainString(s.t.wyMp1j, {
            username: e
        }),
        showIcons: !1
    },
...
function l(e) {
    ...
    return i >= t ? "FULL_WISHLIST" : i > 0 ? "MIXED" : s.length > 0 && s.every(e => {
        let {
            item: i,
            source: t
        } = e;
