...
function R() {
    return (0, i.jsxs)("div", {
        className: r()(b.aP, N.a, b.dO, b.p2),
...
function P(e) {
    let {
        ...
        sectionTitle: n,
        requests: a
    } = e, r = s.useRef(null), l = `${t}-list`, _ = (0, d.A)(l), m = s.useCallback(e => {
        let {
            row: n,
            listIndex: s
        } = e, r = a[n], l = s === a.length;
        return null == r ? null : (0, i.jsx)(C.A, {
            userId: r.id,
            isLast: l,
