...
function z(e) {
    ...
    } = e, b = (0, O.xR)("VoiceInviteEmbed"), y = a.useRef(null), G = s ?? null;
    ...
    let Q = (0, _.bG)([w.A, L.A], () => {
        ...
        J = (0, _.bG)([M.Ay], () => Q ? M.Ay.getVoiceStatesForChannelAlt(z.id, G.id) : [], [z.id, G.id, Q]),
        {
            ...
            return r ? {
                label: a ? q.intl.format(q.t["2RWMFV"], {
                    othersCount: l
    ...
    let eo = a.useCallback(() => {
            null != el && ($ ? (g.default.selectVoiceChannel(el.channelId), (0, A.Nl)(el)) : E(), (0, p.he)({
                invite: t,
