    ...
    let B = (0, d.bG)([b.A, I.A], () => {
        ...
        F = (0, d.bG)([T.Ay], () => B ? T.Ay.getVoiceStatesForChannelAlt(G.id, U.id) : [], [G.id, U.id, B]),
        {
            ...
            let {
                ...
                author: n,
                voiceStates: i
            } = e, r = n.id === t, l = i.length > 0, a = i.some(e => e.user?.id === n.id), s = i.length - !!a;
            return l ? r ? {
                label: a ? M.intl.format(M.t["2RWMFV"], {
                    othersCount: s
                }) : M.intl.format(M.t.IWXzHV, {
                    othersCount: s
                })
            } : {
                label: a ? M.intl.format(M.t.Da7tZx, {
                    othersCount: s
                }) : M.intl.format(M.t["3VbQvv"], {
                    othersCount: s
                })
            } : {
...
function O(e) {
    let {
        ...
        previewUrl: r,
        isLoading: l
    } = (0, A.A)(n.guildId, n.channelId, n.ownerId), s = null != r && !l;
    return (0, i.jsx)("div", {
        className: a()(t, D.rr, {
            [D.pc]: !s
        }),
