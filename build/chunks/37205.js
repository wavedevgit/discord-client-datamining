...
function V(e) {
    ...
    } = e, I = (0, M.xR)("VoiceInviteEmbed"), v = a.useRef(null), O = s ?? null;
    null == O && null != t.guild && (O = w.DY(t.guild));
    let V = null != t.channel ? (0, S.OY)(t.channel) : null;
    o()(null != O, "Voice Invite Embed must be used in context of a guild."), o()(null != V, "Voice Invite Embed must be able to resolve an invite channel.");
    let W = (0, u.bG)([R.A, N.A], () => {
        ...
        Y = (0, u.bG)([P.Ay], () => W ? P.Ay.getVoiceStatesForChannelAlt(V.id, O.id) : [], [V.id, O.id, W]),
        {
            ...
            return r ? {
                label: a ? F.intl.format(F.t["2RWMFV"], {
                    othersCount: l
                }) : F.intl.format(F.t.Da7tZx, {
                    othersCount: l
                })
            } : {
        ...
        ea = a.useCallback(() => {
            null != en && (J ? (p.default.selectVoiceChannel(en.channelId), (0, g.Nl)(en)) : C(), (0, h.he)({
                invite: t,
