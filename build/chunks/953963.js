...
function y(e) {
    let {
    ...
    } = (0, h.NJ)(), y = (0, o.bG)([u.A], () => u.A.useReducedMotion), [R, k] = a.useState(!1), [O, w] = a.useState(!1), {
        widgetsToSave: L,
        changedWidgets: P,
        removedWidgets: D,
        hasUnsavedWidgets: G,
    ...
    }(), U = (0, o.bG)([A.A], () => A.A.hasUnsavedChanges()), F = G || U, W = !(G && !M), H = (0, d.pnh)(F, {
        from: {
            opacity: 0,
            y: 80 * !y
        },
        ...
        if (G) try {
            for (let e of (await I.A.savePendingWidgets(L), P)) {
                ...
                (0, _.fu)(e) && (t.gameIds = e.games.map(e => e.applicationId), t.tags = e.games.flatMap(e => e.tags ?? []).map(e => e.toString()), t.numCharactersCommentary = e.games.reduce((e, t) => e + (t.comment?.length ?? 0), 0)), l(t)
            }
            for (let e of D) l({
                widgetEdited: e.type,
                isWidgetRemoved: !0
