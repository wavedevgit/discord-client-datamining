...
function v(e) {
    let {
        detectedGame: t,
        trackAction: i
    } = e, [a, x] = l.useState(t?.summaryLocalized != null), [v, p] = l.useState(!0), [A, E] = l.useState(!1), I = l.useRef(null), {
        width: _,
        height: N
    } = (0, u.A)();
    return (l.useEffect(() => {
    ...
    }, [I, _, N, v]), null == t.summary) ? null : (0, n.jsxs)("div", {
...
function p(e) {
    let {
        detectedGame: t,
        trackAction: i
    } = e, [a, g] = l.useState(t?.summaryLocalized != null), [j, v] = l.useState(!0), [p, A] = l.useState(!1), E = l.useRef(null), {
        width: I,
        height: _
    } = (0, u.A)(), {
        isTwoColumn: N
