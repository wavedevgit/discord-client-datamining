...
function j(e) {
    let {
        detectedGame: t,
        trackAction: i
    } = e, [n, j] = a.useState(t?.summaryLocalized != null), [p, v] = a.useState(!0), [A, N] = a.useState(!1), _ = a.useRef(null), {
        width: I,
        height: b
    } = (0, u.A)();
    return (a.useEffect(() => {
