...
function v(e) {
    let {
        detectedGame: t,
        trackAction: n
    } = e, [i, x] = l.useState(t?.summaryLocalized != null), [v, j] = l.useState(!0), [_, A] = l.useState(!1), E = l.useRef(null), {
        width: I,
        height: b
    } = (0, u.A)();
    return (l.useEffect(() => {
    ...
    }, [E, I, b, v]), null == t.summary) ? null : (0, a.jsxs)("div", {
...
function j(e) {
    let {
        detectedGame: t,
        trackAction: n
    } = e, [i, s] = l.useState(!0), [c, f] = l.useState(!1), p = l.useRef(null), {
        width: v,
        height: j
    } = (0, u.A)(), {
        isTwoColumn: _
    ...
    }, [p, v, j, i, _]), null == t.summary) ? null : (0, a.jsxs)("div", {
        className: r()(g.fi, g.mX),
        children: [(0, a.jsx)(o.EYj, {
            ref: p,
