...
class a {
    ...
    _textualScore;
    constructor(e, t) {
        this.signals = e, this.providers = t, this._textualScore = new s(e, t), this.lastActivityAtMs = Date.now()
    }
...
class I {
    ...
    _score = 0;
    constructor(e, t, n) {
        this.candidate = e, this.signals = t, "GUILD_VOICE" === e.kind || "GROUP_DM" === e.kind ? this._activeNowScoreSource = new a(t, n) : this._activeNowScoreSource = new s(t, n), this.recomputeScore(Date.now())
    }
    get score() {
        return this._score
    }
    ...
    updateSignalsAndRescore(e, t) {
        return this.prepareForUpdate(t), this.signals = {
            ...this.signals,
            ...e
        }, this.candidate.kind, this._activeNowScoreSource.updateSignals(this.signals, t), this.recomputeScore(t)
    }
}