...
let f = e => {
    let {
        ...
        className: h,
        "aria-label": g
    } = e, p = l.useId(), v = l.useRef(0), j = l.useRef(0), _ = l.useRef(0), A = l.useRef(!1), E = l.useRef(!1), I = l.useRef(null), b = (0, o.bG)([u.A], () => u.A.keyboardModeEnabled), N = (0, o.bG)([u.A], () => u.A.useReducedMotion), C = l.useMemo(() => l.Children.map(t, e => l.isValidElement(e) ? null != e && "object" == typeof e && e.$$typeof === Symbol.for("react.portal") ? e : l.cloneElement(e, {
        tabIndex: -1
    }) : e), [t]), [T, S] = l.useState(!1), [L, k] = l.useState(!1), [y, R] = l.useState(!0), G = () => {
    ...
    let V = l.useMemo(() => (0, s.throttle)(() => {
            ...
            _.current = n, A.current = !0, e.scrollTo({
                left: n,
            ...
            onKeyDown: e => {
                ...
                if ([...i, ...r].includes(e.key))
                    if (e.preventDefault(), i.includes(e.key) && (a = Math.max(0, a - 1)), r.includes(e.key) && (a = Math.min(t.childElementCount - 1, a + 1)), null != (l = n[a])) {
                        ...
                        _.current = n, n !== t.scrollLeft && (A.current = !0, E.current = !0, t.scrollTo({
                            left: n,
                            behavior: N ? "auto" : "smooth"
