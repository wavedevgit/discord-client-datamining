...
let g = e => {
    ...
    } = e, h = l.useRef(0), v = l.useRef(0), m = l.useRef(0), b = l.useRef(!1), A = l.useRef(null), E = (0, o.bG)([d.A], () => d.A.keyboardModeEnabled), y = l.useMemo(() => l.Children.map(t, e => l.isValidElement(e) ? null != e && "object" == typeof e && e.$$typeof === Symbol.for("react.portal") ? e : l.cloneElement(e, {
        tabIndex: -1
    }) : e), [t]), [x, S] = l.useState(!1), [k, C] = l.useState(!1), [I, N] = l.useState(!0), D = () => {
        S(v.current > h.current)
    }, w = l.useCallback(() => {
        let e = _.current;
        null == e || (A.current = Math.floor((m.current + e.clientWidth / 2) / (e.scrollWidth / e.childElementCount)))
    }, []), M = l.useCallback(() => {
        let e = _.current;
    ...
    let j = l.useMemo(() => (0, s.throttle)(() => {
            let e = _.current;
            if (null == e) return;
            let {
                scrollLeft: t
            } = e, n = Math.max(0, t - h.current);
            m.current = n, b.current = !0, e.scrollTo({
                left: n,
                behavior: "smooth"
    ...
    return (0, r.jsxs)("div", {
        ...
        children: [x && (0, r.jsxs)("div", {
            ...
            onKeyDown: e => {
                ...
                let i = ["ArrowLeft"],
                    a = ["ArrowRight"];
                [...i, ...a].includes(e.key) && (e.preventDefault(), i.includes(e.key) && (r = Math.max(0, r - 1)), a.includes(e.key) && (r = Math.min(t.childElementCount - 1, r + 1)), null != (l = n[r]) ? (l.setAttribute("tabIndex", "0"), t.setAttribute("tabIndex", "-1"), l.focus(), A.current = r, R()) : (t.setAttribute("tabIndex", "0"), w()))
            },
            onScroll: e => {
