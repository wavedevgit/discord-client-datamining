/** chunk id: 720462, original params: e,t,n (module,exports,require) **/
n.d(t, {
    A: () => g
});
var r = n(627968),
...
let g = e => {
    let {
        ...
        className: h
    } = e, v = l.useRef(0), b = l.useRef(0), m = l.useRef(0), A = l.useRef(!1), E = l.useRef(null), y = (0, s.bG)([d.A], () => d.A.keyboardModeEnabled), x = (0, s.bG)([d.A], () => d.A.useReducedMotion), S = l.useMemo(() => l.Children.map(t, e => l.isValidElement(e) ? null != e && "object" == typeof e && e.$$typeof === Symbol.for("react.portal") ? e : l.cloneElement(e, {
        tabIndex: -1
    }) : e), [t]), [k, C] = l.useState(!1), [I, N] = l.useState(!1), [D, M] = l.useState(!0), w = () => {
        C(b.current > v.current)
    }, R = l.useCallback(() => {
        let e = T.current;
        null == e || (E.current = Math.floor((m.current + e.clientWidth / 2) / (e.scrollWidth / e.childElementCount)))
    }, []), L = l.useCallback(() => {
        let e = T.current;
    ...
    let P = l.useMemo(() => (0, o.throttle)(() => {
            let e = T.current;
            if (null == e) return;
            let {
                scrollLeft: t
            } = e, n = Math.max(0, t - v.current);
            m.current = n, A.current = !0, e.scrollTo({
                left: n,
    ...
    return (0, r.jsxs)("div", {
        ...
        children: [k && (0, r.jsxs)("div", {
            ...
            onKeyDown: e => {
                ...
                let i = ["ArrowLeft"],
                    a = ["ArrowRight"];
                [...i, ...a].includes(e.key) && (e.preventDefault(), i.includes(e.key) && (r = Math.max(0, r - 1)), a.includes(e.key) && (r = Math.min(t.childElementCount - 1, r + 1)), null != (l = n[r]) ? (l.setAttribute("tabIndex", "0"), t.setAttribute("tabIndex", "-1"), l.focus(), E.current = r, _()) : (t.setAttribute("tabIndex", "0"), R()))
            },
            onScroll: e => {
