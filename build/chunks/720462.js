...
let h = e => {
    let {
        ...
        tabIndex: -1
    }) : e), [t]), [T, S] = l.useState(!1), [k, L] = l.useState(!1), [y, R] = l.useState(!0), O = () => {
        ...
        let e = P.current;
        null != e && (L(j.current > 0), R(j.current + e.clientWidth < e.scrollWidth), G())
    }, [G]), M = l.useCallback(() => {
        let e = P.current;
        if (null == e) return;
        let t = I.current;
        ...
        _.current = t.width, null != P.current && (j.current = P.current?.scrollLeft), O(), w(), M()
    }), P = l.useRef(null);
    l.useEffect(() => {
        let e = P.current;
        if (null == e) return;
        let t = new ResizeObserver(() => {
            v.current = e.scrollWidth, e.scrollLeft !== j.current && (e.scrollLeft = j.current), O(), w()
        });
        Array.from(e.children).forEach(e => {
            t.observe(e)
        });
