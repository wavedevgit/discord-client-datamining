...
let g = e => {
    ...
    } = e, h = l.useRef(0), v = l.useRef(0), b = l.useRef(0), m = l.useRef(!1), A = l.useRef(null), E = (0, s.bG)([d.A], () => d.A.keyboardModeEnabled), y = (0, s.bG)([d.A], () => d.A.useReducedMotion), x = l.useMemo(() => l.Children.map(t, e => l.isValidElement(e) ? null != e && "object" == typeof e && e.$$typeof === Symbol.for("react.portal") ? e : l.cloneElement(e, {
        tabIndex: -1
    }) : e), [t]), [S, k] = l.useState(!1), [C, I] = l.useState(!1), [N, D] = l.useState(!0), M = () => {
        k(v.current > h.current)
    }, w = l.useCallback(() => {
        let e = j.current;
        null == e || (A.current = Math.floor((b.current + e.clientWidth / 2) / (e.scrollWidth / e.childElementCount)))
    }, []), R = l.useCallback(() => {
        let e = j.current;
    ...
    let T = l.useMemo(() => (0, o.throttle)(() => {
            let e = j.current;
            if (null == e) return;
            let {
                scrollLeft: t
            } = e, n = Math.max(0, t - h.current);
            b.current = n, m.current = !0, e.scrollTo({
                left: n,
    ...
    return (0, r.jsxs)("div", {
        ...
        children: [S && (0, r.jsxs)("div", {
            ...
            onKeyDown: e => {
                ...
                let i = ["ArrowLeft"],
                    a = ["ArrowRight"];
                [...i, ...a].includes(e.key) && (e.preventDefault(), i.includes(e.key) && (r = Math.max(0, r - 1)), a.includes(e.key) && (r = Math.min(t.childElementCount - 1, r + 1)), null != (l = n[r]) ? (l.setAttribute("tabIndex", "0"), t.setAttribute("tabIndex", "-1"), l.focus(), A.current = r, L()) : (t.setAttribute("tabIndex", "0"), w()))
            },
            onScroll: e => {
