/** chunk id: 661652 params = (module,exports,require) **/
n.d(t, {
    A: () => I
});
var a = n(627968),
...
function I() {
    ...
    let t, n, s = i.useRef(null),
        ...
        I = b.TA.useSetting(),
        [O, R] = i.useState(""),
        k = (0, r.bG)([_.Ay, C.A], () => (0, v.A)(_.Ay, C.A)),
        w = (0, f.h)(O),
        D = (0, h.g)(w),
        ...
        }),
        {
            canDeauthorize: G,
            deauthorize: F
        } = (e = w?.id, t = (0, r.bG)([j.default], () => j.default.getNewestTokenForApplication(e)), n = i.useCallback(() => {
