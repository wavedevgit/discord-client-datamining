...
class c extends a.A {
    ...
    _terminate() {
        s.h.unsubscribe("SHOW_KEYBOARD_SHORTCUTS", this.showKeyboardShortcuts), s.h.unsubscribe("HIDE_KEYBOARD_SHORTCUTS", this.hideKeyboardShortcuts)
    }
    showKeyboardShortcuts() {
        (0, l.qfG)(e => (0, i.jsx)(r.A, {
            ...e
        }), {
            modalKey: o.P
        })
