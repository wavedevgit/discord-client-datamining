/** Chunk was on web.js **/
/** chunk id: 904986, original params: e,t,n (module,exports,require) **/
"use strict";
n.d(t, {
    A: () => _,
    y: () => l.y
...
class _ extends s.A {
    destroy() {
        this.destroyed = !0, this.framerateReducer.destroy(), this.setConnectionState(u.$I.DISCONNECTED), this.emit(l.y.Destroy, this), this.removeAllListeners()
    }
    getLocalMute(e) {
    ...
    setHasActiveVideoOutputSink(e, t, n) {
        ...
        this.isActiveOutputSinksEnabled = !0, i !== o && this.emit(l.y.ActiveSinksChange, e, o)
    }
    ...
    getLocalWant(e) {
        ...
        let r = this.videoStreamParameters.some(t => t.ssrc === e && t.quality === u.Y4) || void 0 === e,
            ...
            a = this.remoteVideoSinkWants[null != (t = null != e ? e : null == (n = this.videoStreamParameters[0]) ? void 0 : n.ssrc) ? t : 0];
    ...
    getRemoteVideoSinkPixelCount(e) {
        var t, n;
        return void 0 === e ? 0 : null != (t = null == (n = this.remoteVideoSinkWants.pixelCounts) ? void 0 : n[e]) ? t : 0
    }
    async emitStats() {
