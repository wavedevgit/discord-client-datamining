...
let eh = () => {
    let {
        ...
        (0, v.openUserSettings)(A.X.PROFILE_PANEL, {
            analyticsLocations: e
        }, () => (0, _.L)({
            analyticsLocations: e
        }))
    }, [e]), ep = (0, l.useCallback)(() => {
        (0, p.A)({
        ...
        serverProfiles: {
            thumbnail: F,
            assetUrl: ef ? em.Ay : e_.Ay
        },
        customThemes: {
            thumbnail: ec.A,
            assetUrl: ef ? eo.A : eu.A
        },
        displayNameStyles: {
            thumbnail: Y.A,
            assetUrl: ef ? H.A : W.A
        ...
        referralProgram: {
            thumbnail: Q.A,
            assetUrl: ef ? J.A : ee.A
        },
        showYourStyle: {
            thumbnail: er.A,
            assetUrl: ef ? et.A : en.A
        },
        yourSpace: {
            thumbnail: ei.A,
