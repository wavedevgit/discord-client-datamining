...
function S(e) {
    let {
        ...
        onVolumeChange: U,
        onMutedChange: B
    } = e, Q = (0, o.bG)([p.A], () => p.A.useReducedMotion), V = (0, o.bG)([p.A], () => p.A.keyboardModeEnabled), [K, F] = l.useState(N ? 0 : T), [$, Y] = l.useState(!1), [G, H] = l.useState(!1), [{
        volumeAnimSpring: z
    }, W] = (0, m.zhh)(() => ({
        from: {
            volumeAnimSpring: 0
    ...
    l.useEffect(() => {
        ...
        volumeAnimSpring: G || $ ? 1 : 0,
        immediate: Q
    }), () => {
        z.stop()
    }), [G, $, W, Q, z]), l.useEffect(() => (window.addEventListener("keydown", et), () => {
        window.removeEventListener("keydown", et)
    }), [et]);
    let en = 0 === K ? m._RO : K < .5 ? m.S24 : m.HKD,
        {
            icon: er,
            label: el
        } = E.eC[n];
