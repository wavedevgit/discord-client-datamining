...
function i(e) {
    ...
    }(i, l, r), d = l % 180 != 0, c = n.width * a, u = n.height * a, m = Math.min(c, s.width), g = Math.min(u, s.height), x = (d ? n.height : n.width) / 2, h = (d ? n.width : n.height) / 2, _ = (t.width / 2 - x - o.x) * a, p = (t.height / 2 - h - o.y) * a, A = d ? u : c, f = d ? c : u, {
        x: j,
        y: N
    } = function(e, t, n) {
