...
function v() {
    let {
        ...
        onClose: s
    } = l.useContext(C.VideoQuestModalContext), [v, j] = l.useState(!1), f = (0, i.bG)([r.A], () => r.A.useReducedMotion), S = l.useRef(e.userStatus?.completedAt), [N, O] = l.useState(!1), E = (0, c.mq)(e.config), {
        completedRatio: _,
        completedRatioDisplay: M
    } = (0, d.O9)(e), T = e.userStatus?.completedAt != null, V = e.userStatus?.claimedAt != null, y = A.intl.formatToPlainString(T && !V ? A.t.NRp4K4 : A.t["12IWP2"], {
        rewardName: E
    });
    l.useEffect(() => {
