/** chunk id: 928450 params = (module,exports,require) **/
i.d(t, {
    A: () => P
});
var n = i(627968),
...
let C = e => {
        let {
            ...
            return null == i ? L.intl.format(L.t.HpvELh, e) : i?.member_type === A.Z9.OWNER ? L.intl.format(L.t.X1ngSd, {
                ...e,
                guildName: i?.name
            }) : L.intl.format(L.t.rmpEPD, {
                ...e,
                guildName: i?.name
            })
        }, [t, i]);
        return (0, n.jsx)(d.Heading, {
    ...
    U = e => {
        ...
        } = e, a = (0, c.bG)([h.default], () => h.default.locale);
        ...
        return (0, n.jsxs)(d.MzZ, {
            ...
            children: [(0, n.jsx)("div", {
                ...
                children: (0, n.jsx)(d.Text, {
                    ...
                    children: L.intl.format(L.t.zxUdpj, {
                        classificationDescription: t
                    })
                })
            }), (0, n.jsx)("div", {
                className: N.g_,
                children: (0, n.jsx)(d._BQ, {
                    size: "md",
    ...
    w = () => (0, n.jsx)(d.Text, {
        variant: "text-md/normal",
        color: "text-muted",
        children: L.intl.string(L.t["I2H0/E"])
    }),
    O = e => (0, n.jsx)(d.Text, {
        variant: "text-md/normal",
        color: "text-muted",
        children: L.intl.format(L.t.IFxUaT, {
            letUsKnowHook: (t, i) => (0, n.jsx)(d.MzZ, {
    ...
    k = e => (0, n.jsx)("div", {
        className: N.CC,
        children: e.hasBeenAppealed ? (0, n.jsx)(w, {}) : (0, n.jsx)(O, {
    ...
    M = e => {
        ...
        return (0, n.jsxs)("div", {
            children: [(0, n.jsx)(d.Text, {
                variant: "eyebrow",
                color: "text-muted",
                children: L.intl.string(L.t["977iei"])
            }), (0, n.jsx)(d.Text, {
                className: N.t8,
                variant: "text-sm/normal",
                children: L.intl.format(L.t["1Z/+aA"], {
                    tosLink: t,
                    communityGuidelinesLink: i
                })
            }), (0, n.jsx)(S, {
    ...
    P = e => {
        let {
            ...
            isDsaEligible: I,
            violationType: S
        } = (0, E.LJ)(t), w = (0, c.bG)([x.A], () => x.A.getAppealEligibility()), O = (0, g.K)(), P = null != d && null != d.flagged_content && d.flagged_content.length > 0, D = (0, f.v)(), b = !!d?.is_coppa && w.includes(A.RH.AGE_VERIFY_ELIGIBLE), G = !!d?.is_coppa && w.includes(A.RH.AGE_VERIFY_GLOBAL_ELIGIBLE), H = {
            accountStanding: O,
            classificationId: t,
            hasFlaggedContent: P,
            isDsaEligible: I,
        ...
        return (a.useEffect(() => {
            ...
            D && u.default.track(y.HAw.SAFETY_HUB_ACTION, {
        ...
        }, [D]), null == d && h === A.nU.FAILED) ? (l(), null) : null == d ? null : (0, n.jsxs)("div", {
            className: N.ch,
            children: [(0, n.jsx)("div", {
                className: N.uW,
                children: (0, n.jsx)(C, {
                ...
                children: [(0, n.jsx)(v.U, {
                    flaggedContent: d.flagged_content ?? []
                }), (0, n.jsx)(U, {
                    actions: d.actions,
                    classificationExpiration: (0, _.UI)(d)
                }), (0, n.jsx)(M, {
                    classificationTypeText: d.description,
                    ...
                    appealComponent: (0, n.jsx)(k, {
                        ...
                        onLetUsKnowClick: () => {
                            u.default.track(y.HAw.SAFETY_HUB_ACTION, {
                                ...
                                is_dsa_eligible: I,
                                violation_type: S
                            }), G ? p.A.openV2(t, r) : b ? p.A.open(t, r) : L && (m.A.increment({
