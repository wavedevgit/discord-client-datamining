...
function w(e) {
    let {
        message: t,
        compact: n
    } = e, a = R.default.getUser((0, g.ZD)(t)), r = N.A.getBasicChannel(t.channel_id)?.guild_id, s = null != r && null != a ? S.Ay.getMember(r, a.id) : null, {
        avatarSrc: c,
...
function F(e) {
    let {
        ...
        raidType: c,
        resolvedReason: A
    } = (0, g.Bk)(t), p = (0, u.bG)([N.A], () => N.A.getChannel(t.channel_id), [t.channel_id]), x = p?.guild_id ?? null, {
        shouldShowIncidentActions: C
    } = (0, f.Li)(x), I = (0, M.Am)(t.author.id, t.channel_id), T = l.useCallback(() => {
        let e = p?.guild_id;
        null != e && (0, E.is)(t.id, e)
