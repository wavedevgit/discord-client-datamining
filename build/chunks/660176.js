...
function F(e) {
    ...
    } = (0, m.Li)(f), C = (0, M.Am)(t.author.id, t.channel_id), h = r.useCallback(() => {
        let e = N?.guild_id;
        null != e && (0, g.is)(t.id, e)
    }, [t.id, N]), R = o === u.p.DM_RAID, x = R ? E.EpV : E.EF8;
    return (0, i.jsx)(B, {
        compact: n,
        header: (0, i.jsxs)(r.Fragment, {
            children: [(0, i.jsx)(x, {
        ...
        subheader: (0, i.jsxs)("div", {
            ...
            children: [null != s && (0, i.jsx)(E.Text, {
                ...
                children: [(0, i.jsx)(j, {}), (0, i.jsx)(E.Text, {
                    variant: "text-xs/medium",
                    color: "text-default",
...
function w(e) {
    let {
        ...
        raidDatetime: l,
        decisionId: a,
        suspiciousMentionActivityUntil: o
    } = (0, T.Bk)(t);
    return (0, i.jsx)(B, {
        compact: n,
        header: (0, i.jsxs)(r.Fragment, {
