/** chunk id: 214884 params = (module,exports,require) **/
n.d(t, {
    A: () => w
});
var i = n(627968),
...
function w(e) {
    ...
    } = e, a = (0, E.V)(t.id), u = (0, I.BP)(t.id), b = (0, s.bG)([v.A], () => v.A.getStageInstanceByChannel(a?.id), [a]), {
    ...
    }), [b, u]), k = a?.id, V = (0, s.yK)([S.A], () => [...new Set(S.A.getMutableParticipants(k, x.ip.SPEAKER).map(e => e.user))], [k]), B = (0, s.bG)([S.A], () => null != k ? S.A.getParticipantCount(k, x.ip.AUDIENCE) : 0, [k]), H = (0, s.bG)([O.A], () => O.A.can(P.xBc.CONNECT, a)), F = (0, y.A)(a?.id), Y = u?.creator_id, W = (0, s.bG)([L.default], () => L.default.getUser(Y), [Y]);
    l.useEffect(() => {
        null != Y && (0, c.wz)(Y)
    }, [Y]);
    let {
        ...
        let {
            ...
            isStudyRoomNotice: p
        } = e, E = null != n && null != l && !h, I = null != t ? (0, C.G3)(t) : null;
        if (p && null != l) {
            let e = (0, A.gU)(l);
            return {
                noticeType: 3,
    ...
    return null == K ? null : (0, i.jsxs)("div", {
        ...
        children: [null != ee ? (0, i.jsx)(d.DUT, {
            ...
            children: (0, i.jsx)(d.Button, {
                ...
                text: X,
                onClick: () => {
                    if (Q) null != a && null != a.getGuildId() && ((0, N.av)(a), (0, T.uh)(a.getGuildId(), a.id));
                    else {
                        if (null == u) return;
                        (0, h.uR)({
                            eventId: u.id
