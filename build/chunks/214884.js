...
function w(e) {
    ...
    } = e, r = (0, E.V)(t.id), u = (0, I.BP)(t.id), y = (0, s.bG)([v.A], () => v.A.getStageInstanceByChannel(r?.id), [r]), {
    ...
    }), [y, u]), k = r?.id, V = (0, s.yK)([S.A], () => [...new Set(S.A.getMutableParticipants(k, x.ip.SPEAKER).map(e => e.user))], [k]), B = (0, s.bG)([S.A], () => null != k ? S.A.getParticipantCount(k, x.ip.AUDIENCE) : 0, [k]), H = (0, s.bG)([O.A], () => O.A.can(P.xBc.CONNECT, r)), F = (0, b.A)(r?.id), Y = u?.creator_id, W = (0, s.bG)([L.default], () => L.default.getUser(Y), [Y]);
    a.useEffect(() => {
        null != Y && (0, c.wz)(Y)
    }, [Y]);
    let {
        ...
        let {
            ...
            isStudyRoomNotice: p
        } = e, E = null != n && null != a && !h, I = null != t ? (0, C.G3)(t) : null;
        if (p && null != a) {
            let e = (0, A.gU)(a);
            return {
                noticeType: 3,
