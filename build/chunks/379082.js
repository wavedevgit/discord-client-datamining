...
function g(e) {
    let t = (0, u.M)(e),
        ...
        g = (0, r.bG)([a.A], () => a.A.getGuild(s?.guild_id)),
        [A, h] = i.useState(!1),
        {
    ...
    let p = null == n ? void 0 : function(e) {
        let {
            subscription: t
        } = e, n = l()(t.currentPeriodEnd).format("M/D/YY"), i = null != t.price ? (0, o.$g)(t.price, t.currency) : "", s = l()(t.createdAt).format("M/D/YY"), r = t.status === _.Dmq.CANCELED, a = t.status === _.Dmq.PAST_DUE, d = t.hasActiveTrial;
        return {
            memberSince: s,
            nextRenewalDate: n,
