/** chunk id: 225858 params = (module,exports,require) **/
s.d(t, {
    A: () => M
});
var r = s(627968),
...
function M(e) {
    ...
    n.useEffect(() => {
        !async function() {
            ...
            null != e && i(Z.intl.formatToPlainString(h.defaultName, {
                username: e.username
            }))
        }()
    }, [h.defaultName]), (0, v.A)(e);
    let x = (0, r.jsxs)(r.Fragment, {
            children: [t ? (0, r.jsx)(N.A, {
                guildTemplate: e
            }) : null, (0, r.jsx)("div", {
                className: b.Kk,
                ...
                label: h.nameLabel,
                helperText: Z.intl.format(h.terms, {
                    guidelinesURL: I.X7G.GUIDELINES
                }),
                type: "text",
                value: s,
                maxLength: 100,
    ...
    return {
        ...
        handleSubmit: () => {
            E.A.acceptGuildTemplate(e.code, s, l).then(() => {
                (0, c.s7G)(), (0, C.bz)()
            }).catch(e => m(e))
        }
    }
...
function _(e) {
    let {
        channels: t
    } = e, s = d()(t).sortBy(e => null == e.parent_id ? 1e4 * Number(e.id) : 1e4 * Number(e.parent_id) + e.id).map(e => {
        var t;
        let s = (t = e).type === I.rbe.GUILD_CATEGORY ? f.A : (0, m.gU)((0, x.UE)(t));
        return (0, r.jsxs)("div", {
            className: l()(b.Ix, {
                [b.L1]: e.type === I.rbe.GUILD_CATEGORY
            }),
...
function G(e) {
    let {
        guildId: t,
        roles: s
    } = e, n = s.slice().reverse().map(e => (0, r.jsx)("li", {
        children: (0, r.jsx)(h.g1, {
            role: e,
            guildId: t
        })
    }, e.id));
