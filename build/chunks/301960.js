...
function k(e, t, n, r, s, a) {
    ...
    if (o && null == c.activityInstance || d || E) return (0, i.jsx)("div", {
        className: y.Cz,
        children: (0, i.jsx)(j, {
            className: y.Jx
        })
    });
    let p = R.Ay.getGuildMemberAvatarURL({
...
function H(e) {
    let t, {
        ...
        D = r.useRef(null),
        j = r.useRef(null),
        H = r.useMemo(() => (e, t, r) => (c()(null != t, "ExecutedCommand: user cannot be undefined"), c()(null != R, "ExecutedCommand: currentUser cannot be undefined"), c()(null != s, "ExecutedCommand: channel cannot be undefined"), (0, i.jsx)(C.A, {
            ...e,
            user: t,
            currentUser: R,
            guildId: s.guild_id,
        ...
        F = r.useMemo(() => e => (c()(null != s, "ExecutedCommand: channel cannot be null"), (0, i.jsx)(U.A, {
            ...e,
            channel: s,
            messageId: n.id,
    ...
    if (n?.activityInstance === null || (0, p.V)(n)) t = v.intl.format(v.t["rg7U+C"], {
        userHook: J,
        commandHook: () => {
