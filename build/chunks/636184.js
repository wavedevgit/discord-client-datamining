...
let T = e => {
        ...
        return (0, r.jsxs)("div", {
            ...
            children: [(0, r.jsx)(o.euF, {
                ...
                onClick: () => {
                    var e;
                    return e = t.id, void((0, _.default)(), E.A.openPrivateChannel({
                        recipientIds: e
                    }), i())
                }
            })]
    ...
    m = e => {
        ...
        return null === E ? (0, r.jsx)(o.y$y, {}) : (0, r.jsx)(l.ExpressiveModal, {
            graphic: d.enabled ? {
                src: g.A,
                type: "image"
            } : {
