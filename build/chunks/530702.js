/** Chunk was on web.js **/
/** chunk id: 530702, original params: e,t,n (module,exports,require) **/
"use strict";
n.d(t, {
    G: () => i
});
            ...
            E = {
                ...
                childNodes: a(function*() {
                    ...
                    for (let r of e.childNodes())
                        for (let e of (null != r.key && (r.key = `${E.key}${r.key}`), g.getFullNode({
                                ...r,
                                index: n
                            }, g.getChildState(t, r), E.key, E))) n++, yield e
                })
            };
        yield E
    }
