...
function y(e) {
    let {
        ...
        value: o
    } = n.springs, c = t.features.has(I.GuildFeatures.DISCOVERABLE), h = (0, i.jsx)("div", {
        className: T.WV,
...
function L(e) {
    let {
        ...
        ariaExpanded: A,
        children: g
    } = e, _ = (0, c.bG)([f.A], () => (0, m.K)(f.A, l)), {
        hasAccess: x
    } = (0, h.TW)("GuildHeaderContent"), C = s.useCallback(() => {
        _ ? (0, u.mMO)(async () => {
            let {
                default: e
            ...
            return t => (0, i.jsx)(e, {
                ...t,
                guild: l,
                source: I.PE1.GUILD_HEADER_INVITE_BUTTON
            })
        }) : (0, u.mMO)(async () => {
            let {
                default: e
    ...
    }, [_, l]), v = s.useRef(null), y = s.useCallback(e => {
        let {
            closePopout: t
        } = e;
    ...
    return (0, i.jsxs)(i.Fragment, {
        ...
        }), l.id === N.Vc && x && (0, i.jsx)(u.YNO, {
            targetElementRef: v,
            position: "bottom",
            align: "left",
            spacing: 4,
            renderPopout: y,
            children: e => (0, i.jsx)(u.K0, {
                buttonRef: v,
                variant: "icon-only",
                size: "sm",
                icon: u.pa$,
...
let M = s.lazy(() => n.e("60497").then(n.bind(n, 908424))),
    D = s.memo(function(e) {
        let {
            ...
            hasSubheader: M
        } = e, D = N.features.has(I.GuildFeatures.ANIMATED_BANNER), U = (0, A.A)(N), P = !U && (0, C.A)(N), w = !U && O, k = (0, x.VI)(b) && D && !p, [V, B] = s.useState(!1), H = s.useRef(!1), F = s.useRef(null), K = t ?? F, W = s.useRef(void 0), Y = _.kt.getSetting(), z = (0, c.bG)([g.A], () => g.A.theme);
        s.useEffect(() => {
