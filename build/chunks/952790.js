...
function M(e) {
    let {
        ...
        ariaExpanded: m,
        children: _
    } = e, f = (0, c.bG)([x.A], () => (0, p.K)(x.A, l)), {
        hasAccess: C
    } = (0, A.TW)("GuildHeaderContent"), E = s.useCallback(() => {
        f ? (0, u.mMO)(async () => {
            let {
                default: e
    ...
    }, [f, l]), y = s.useCallback(e => {
        e.preventDefault(), e.stopPropagation(), (0, h.L3)(e, async () => {
            let {
                default: e
    ...
    return (0, i.jsxs)(i.Fragment, {
        ...
        }), l.id === b.Vc && C && (0, i.jsx)(u.K0, {
            variant: "icon-only",
            size: "sm",
            icon: u.pa$,
            "aria-label": S.intl.string(T.default.G9fGlP),
            onClick: y
        }), !L.includes(l.id) && (0, i.jsx)(d.m, {
...
let D = s.memo(function(e) {
    let {
        ...
        hasSubheader: L
    } = e, D = I.features.has(N.GuildFeatures.ANIMATED_BANNER), U = (0, m.A)(I), P = !U && (0, E.A)(I), w = !U && O, k = (0, C.VI)(b) && D && !p, [V, B] = s.useState(!1), H = s.useRef(!1), F = s.useRef(null), K = t ?? F, W = s.useRef(void 0), Y = f.kt.getSetting(), z = (0, c.bG)([_.A], () => _.A.theme);
    s.useEffect(() => {
