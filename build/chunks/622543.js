...
function J(e) {
    ...
    let {
        userProfile: q,
        fetchStartedAt: Z
    } = e, X = null != (t = null == (l = q.guild_member_profile) ? void 0 : l.guild_id) ? t : S;
    ...
    if (null != q.guild_member_profile) {
        let e = q.guild_member_profile.profile_effect,
            t = {
                ...
                popoutAnimationParticleType: null == (V = q.guild_member_profile) ? void 0 : V.popout_animation_particle_type,
...
function et(e) {
    ...
    s.fetchStartedAt = o, s.fetchEndedAt = Date.now(), s.fetchError = a, P.set(r, s), (null == a ? void 0 : a.status) === 404 && (j.set(r, 0), M.set(r, U), k.set(r, G))
}
