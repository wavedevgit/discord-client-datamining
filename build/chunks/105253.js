/** chunk id: 105253 params = (module,exports,require) **/
n.d(t, {
    A: () => _
});
var l = n(627968),
...
let I = e => {
        let {
            ...
            disabled: a,
            entityType: r
        } = e, o = n === T.rbe.GUILD_STAGE_VOICE, x = (0, f.D)(i, r), h = (0, A.pW)(t, n);
    ...
    S = (e, t) => n => {
        ...
        n === C.Ps.EXTERNAL && (l.scheduledEndTime = (a()(t.scheduledStartTime) ?? a()()).add(2, "hour").toISOString()), e(l)
    };
...
function G(e) {
    let {
        ...
        entityType: c,
        channelId: o
    } = n, x = (0, r.bG)([u.A], () => u.A.getChannel(o), [o]), h = i.useRef(null), m = i.useRef(void 0);
    i.useEffect(() => {
        let e = a && !m.current;
    ...
    let g = e => {
        ...
        A = (0, E.dy)(c),
        N = (0, v.Fd)(n);
    return null == c || c === C.Ps.NONE ? null : c === C.Ps.EXTERNAL ? (0, l.jsx)(d.ksK, {
...
function k(e) {
    let {
        ...
        guildEvent: n,
        onChange: s
    } = e, a = (0, r.bG)([x.A], () => x.A.getGuild(t), [t]), c = (0, j.A)(t, void 0), o = (0, j.A)(t, T.rbe.GUILD_VOICE), u = (0, j.A)(t, T.rbe.GUILD_STAGE_VOICE), h = (0, A.pW)(t, T.rbe.GUILD_VOICE), m = (0, N.A)(a), g = a?.features.has(T.GuildFeatures.COMMUNITY), f = (0, v.Fd)(n), E = S(s, n), p = i.useMemo(() => {
        let e = !o || 0 === h.length,
...
function _(e) {
    let {
        ...
        entityType: u
    } = i, m = (0, r.bG)([x.A], () => x.A.getGuild(t), [t]), g = (0, N.A)(m), v = (0, r.bG)([h.A], () => h.A.can(T.xBc.MANAGE_CHANNELS, m)), j = m?.features.has(T.GuildFeatures.COMMUNITY), A = S(a, i), f = j && u !== C.Ps.EXTERNAL && 0 === g.length && v && null != u;
    return (0, l.jsxs)("div", {
        className: b.kL,
        children: [(0, l.jsxs)(d.BJc, {
            ...
            children: [(0, l.jsx)(d.Heading, {
                ...
                children: y.intl.string(y.t["DC+Qm8"])
            }), (0, l.jsx)(d.Text, {
                color: "text-subtle",
            ...
            onClick: () => {
                A(C.Ps.STAGE_INSTANCE), (0, d.mMO)(async () => {
                    let {
                        default: e
                    } = await Promise.all([n.e("11478"), n.e("8018"), n.e("93142"), n.e("64233"), n.e("73652")]).then(n.bind(n, 409200));
                    return n => (0, l.jsx)(e, {
                        ...n,
        ...
        }) : null, C.Tn.has(i.entityType) && (0, l.jsx)(o.A, {})]
    })
}