/** Chunk was on web.js **/
/** chunk id: 647053, original params: e,t,n (module,exports,require) **/
"use strict";
n.d(t, {
    A8: () => l,
    O_: () => a,
...
var r = n(179771),
    i = n(985018);
let a = [() => i.intl.string(i.t["6xfSCq"]), () => i.intl.string(i.t.ymSk0r), () => i.intl.string(i.t.EnN7c5), () => i.intl.string(i.t["4wMpBs"]), () => i.intl.string(i.t.CncpnK), () => i.intl.string(i.t.X9pGvJ), () => i.intl.string(i.t.sGOSG4), () => i.intl.string(i.t.JfibUq)],
    o = [r.F.BOT, r.F.OPENID, r.F.IDENTIFY, r.F.EMAIL, r.F.CONNECTIONS, r.F.MESSAGES_READ, r.F.GUILDS, r.F.GUILDS_JOIN, r.F.GUILDS_MEMBERS_READ, r.F.GUILDS_CHANNELS_READ, r.F.GDM_JOIN, r.F.RPC, r.F.RPC_NOTIFICATIONS_READ, r.F.RPC_VOICE_READ, r.F.RPC_VOICE_WRITE, r.F.RPC_VIDEO_READ, r.F.RPC_VIDEO_WRITE, r.F.RPC_SCREENSHARE_READ, r.F.RPC_SCREENSHARE_WRITE, r.F.RPC_ACTIVITIES_WRITE, r.F.APPLICATION_IDENTITIES_WRITE, r.F.APPLICATIONS_BUILDS_UPLOAD, r.F.APPLICATIONS_BUILDS_READ, r.F.APPLICATIONS_COMMANDS, r.F.APPLICATIONS_COMMANDS_UPDATE, r.F.APPLICATIONS_COMMANDS_PERMISSIONS_UPDATE, r.F.APPLICATIONS_STORE_UPDATE, r.F.APPLICATIONS_ENTITLEMENTS, r.F.ACTIVITIES_INVITES_WRITE, r.F.ACTIVITIES_READ, r.F.ACTIVITIES_WRITE, r.F.RELATIONSHIPS_READ, r.F.RELATIONSHIPS_WRITE, r.F.VOICE, r.F.DM_CHANNELS_READ, r.F.DM_CHANNELS_MESSAGES_READ, r.F.DM_CHANNELS_MESSAGES_WRITE, r.F.ROLE_CONNECTIONS_WRITE, r.F.PRESENCES_READ, r.F.PRESENCES_WRITE, r.F.GATEWAY_CONNECT, r.F.PAYMENT_SOURCES_COUNTRY_CODE, r.F.SDK_SOCIAL_LAYER_PRESENCE, r.F.SDK_SOCIAL_LAYER],
    s = o.concat([r.F.WEBHOOK_INCOMING, r.F.BOT]),
    l = ["rpc.api"];
...
function d(e) {
    return e.includes(r.F.DM_CHANNELS_MESSAGES_WRITE) || e.includes(r.F.SDK_SOCIAL_LAYER) ? i.intl.format(i.t.o0GMBD, {}) : e.includes(r.F.MESSAGES_READ) || e.includes(r.F.DM_CHANNELS_MESSAGES_READ) ? i.intl.format(i.t.Soy7jJ, {}) : i.intl.format(i.t["TeL+Ct"], {})
}