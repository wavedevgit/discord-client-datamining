...
function v(e) {
    ...
    } = e, l = (0, r.bG)([u.Ay], () => u.Ay.getKeybindForAction(h.hCu.SAVE_CLIP)), a = (0, p.Et)(), v = t ? C.HT : C.Kt, g = s.useCallback(() => {
        (0, o.openUserSettings)(c.X.CLIPS_PANEL)
    }, []), j = (() => {
        if (!a) return x.intl.format(x.t["3iveao"], {
            onClick: g
        });
        if (t) return x.intl.string(x.t["xrEs6/"]);
        if (null == l) return x.intl.format(x.t.jpKk7e, {
            onClick: g
        });
        {
