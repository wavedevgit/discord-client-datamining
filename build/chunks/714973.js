...
function g() {
    ...
    return (0, n.jsxs)("div", {
        className: p.kR,
        children: [(0, n.jsx)(x, {
            header: (0, n.jsx)(s._xR, {
                size: "refresh_sm",
                color: s.LU0.colors.ICON_DEFAULT
            }),
            description: h.intl.string(m.default["4K56sP"])
        }), (0, n.jsx)(x, {
            header: null != t ? (0, n.jsx)(s.e7I, {
                shortcut: t
            }) : null,
            description: null != t ? (0, n.jsxs)(n.Fragment, {
                children: [h.intl.format(m.default.BIwQis, {
                    keybind: t
                }), (0, n.jsx)("div", {
                    className: p.JH,
