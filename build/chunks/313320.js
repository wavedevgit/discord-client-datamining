/** chunk id: 313320 params = (module,exports,require) **/
i.d(t, {
    d: () => u
}), i(321073);
var r = i(73153),
...
class u {
    ...
    getTags() {
        ...
        return {
            platform: (0, a.getNativePlatform)(),
    ...
    setupDispatcherSubscription() {
        null != this.mode && (this.interceptorAdded || (r.h.addInterceptor(e => {
            if (null != this.mode && c.has(e.type)) {
                ...
                r.push(t), this.pendingDispatches.set(e.type, r), this.mode.mark(`${d}-${e.type}-${t}`, {
                    detail: {
                        memory: i
                    }
                })
            ...
            return !1
        }), this.interceptorAdded = !0), c.forEach(e => {
    ...
    setupPerformanceObserver() {
        if (null != this.mode) try {
            this.observer = new this.mode.PerformanceObserver(e => {
                for (let t of e.getEntries()) "mark" === t.entryType && -1 !== t.name.indexOf(h) && this.collectEntry(t);
    ...
    collectEntry(e) {
        try {
            ...
            }), performance.clearMarks(r), performance.clearMarks(e.name)
        } catch (e) {
