...
function C(e) {
    let {
        ...
        channelId: i,
        onCardClick: o
    } = e, [u, m] = l.useState(!1), h = null != n.mediaUrl, g = "video" === n.mediaType, f = "main" === t, p = l.useCallback(() => m(!0), []), _ = l.useCallback(e => {
    ...
    return (0, a.jsxs)(c.DUT, {
        ...
        children: [h && (0, a.jsxs)("div", {
            ...
            children: [null != n.title && (0, a.jsx)(c.Heading, {
                ...
                className: r()(A.h_, f ? A.My : A.Gd, j.PT),
                children: E(n.body, i)
            }), (0, a.jsxs)("div", {
                className: A.ov,
                children: [(0, a.jsx)(c.Text, {
                    ...
                    children: [(0, a.jsx)(c.nm2, {
                        ...
                        variant: "text-xs/medium",
                        color: "text-muted",
                        children: new Intl.NumberFormat(v.intl.currentLocale).format(n.reactionCount)
                    })]
                })]
            })]
        })]
...
function I(e) {
    let {
        ...
        let e = r?.guild?.id ?? d;
        null != e && (n(h.Ws.Announcements), s(), (0, f.A)({
            invite: r,
            guildId: e,
            channelId: m,
        ...
        let t = r?.guild?.id ?? d;
        null != t && (n(h.Ws.AnnouncementsItem), s(), (0, f.A)({
            invite: r,
            guildId: t,
            channelId: m,
            messageId: e,
