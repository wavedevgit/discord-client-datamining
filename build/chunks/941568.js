...
function A(e) {
    let {
        ...
        channelId: i,
        onCardClick: c
    } = e, [d, u] = a.useState(!1), m = null != n.mediaUrl, x = "video" === n.mediaType, h = "main" === t, f = a.useCallback(() => u(!0), []), g = a.useCallback(() => c(n.id), [c, n.id]);
    return (0, l.jsxs)(s.DUT, {
        className: h ? _.cG : _.IU,
        onClick: g,
        children: [m && (0, l.jsxs)("div", {
            className: h ? _._v : _.eZ,
            children: [x ? (0, l.jsx)(o.A, {
                src: n.mediaUrl,
                poster: function(e) {
                    try {
                        let t = new URL(e);
...
function I(e) {
    ...
    }, [o, r, j, n]), E = a.useCallback(e => {
        r && null != n ? (o(), (0, m.ci)(n, e)) : j()
    }, [o, r, j, n]);
    if (null == n || 0 === u.length) return v ? (0, l.jsx)(f.A, {
    ...
    return (0, l.jsx)(f.A, {
        ...
        children: (0, l.jsxs)("div", {
            className: _.f3,
            children: [null != b && (0, l.jsx)(A, {
                variant: "main",
                message: b,
                channelId: n,
                onCardClick: E
            }), C.length > 0 && (0, l.jsx)(d.A, {
                gap: "sm",
                className: _.jG,
                children: C.map(e => (0, l.jsx)(A, {
                    variant: "small",
                    message: e,
                    channelId: n,
                    onCardClick: E
