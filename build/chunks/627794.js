...
function h(e, t) {
    if (e.length > t) throw Error(o.intl.formatToPlainString(o.t.mee4qd, {
        limit: t
    }));
    e.forEach(e => {
        if (e.length > E.kS || e.length < E.Ku) throw new a.lH(o.intl.formatToPlainString(o.t.rbRvGe, {
            keyword: e,
            max: E.kS,
            min: E.Ku
        }))
...
function R(e) {
    if (A(e)) {
        ...
        h(t, E.bV);
        if (n.length > E.qm) throw Error(o.intl.formatToPlainString(o.t.tDjhF1, {
            limit: E.qm
        }));
        n.forEach(e => {
            if (e.length > E.$5 || e.length < E.zs) throw new a.Nr(o.intl.formatToPlainString(o.t.WR0m9w, {
                regex: e,
                max: E.$5,
                min: E.zs
            }))
