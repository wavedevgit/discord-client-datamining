/** chunk id: 869388 params = (module,exports,require) **/
"use strict";
s.d(e, {
    A: () => o
});
...
let o = new l(a.h, {
    ...
    CUSTOM_TEXT_TRANSFORM_UPDATE: function(t) {
        ...
        i = {
            ...i,
            transforms: i.transforms.map(t => t.id === e.id ? e : t)
        }
    },
    CUSTOM_TEXT_TRANSFORM_DELETE: function(t) {
        ...
        i = {
            ...i,
            transforms: i.transforms.filter(t => t.id !== e)
        }
    }
})