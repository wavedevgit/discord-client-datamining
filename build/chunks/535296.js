...
function U(e) {
    let {
        user: t,
        isGift: n
    } = e, l = D.intl.string(D.t.kv4lSp), s = D.intl.string(D.t.vzZoSF);
    return n && (l = null != t ? D.intl.format(D.t.YwV901, {
        username: I.Ay.getName(t)
    }) : D.intl.string(D.t.qCmNFr), s = D.intl.string(D.t.SSgrne)), (0, i.jsxs)(r.BJc, {
        direction: "vertical",
        gap: 4,
...
function F(e) {
    let {
        ...
        applicationIds: o,
        numItems: s
    }), h = "loading" === c || 0 === d.length, m = (0, a.A)(h ? k : d, B), A = l.useMemo(() => {
        let {
            hasWishlist: e,
            hasPopular: t
...
function V(e) {
    ...
    let {
    ...
    } = (0, d.Ay)(c.A.SLAYER_STOREFRONT_VC_GIFTING_PANEL), _ = (0, o.bG)([C.default], () => C.default.getUser(t)), S = (0, o.bG)([m.A], () => m.A.getWidgets(t)?.find(e => H(e, n))), I = t === (0, o.bG)([x.default], () => x.default.getId()), T = (0, v.A)(n), {
        status: N,
        recommendations: y,
        ...
        channel: s,
        numItems: 8
    }), O = "loading" === N || 0 === y.length || null == _, D = l.useMemo(() => null == _ || 0 === y.length ? [] : y.map(e => {
        ...
        children: (0, i.jsx)(r.lGe, {
            ...
            children: (0, i.jsxs)("div", {
                ...
                children: [(0, i.jsxs)(r.BJc, {
                    ...
                    direction: "vertical",
                    gap: 12,
                    children: [null != _ && null != S ? (0, i.jsx)("div", {
                        className: L.p,
...
function W(e) {
    ...
    let {
    ...
    } = (0, d.Ay)(c.A.SLAYER_STOREFRONT_VC_GIFTING_PANEL), h = (0, o.bG)([C.default], () => C.default.getUser(t)), m = t === (0, o.bG)([x.default], () => x.default.getId()), A = (0, v.A)(n), {
        status: _,
        recommendations: S,
        ...
        channel: s,
        numItems: 7
    }), N = "loading" === _ || 0 === S.length || null == h, [y, M] = l.useMemo(() => {
