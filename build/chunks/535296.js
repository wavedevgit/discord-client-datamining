...
function H(e) {
    ...
    let {
    ...
    } = (0, d.Ay)(c.A.SLAYER_STOREFRONT_VC_GIFTING_PANEL), m = (0, o.bG)([C.default], () => C.default.getUser(t)), A = t === (0, o.bG)([x.default], () => x.default.getId()), I = (0, v.A)(n), {
        status: N,
        recommendations: y,
        ...
        let {
            ...
            applicationIds: o,
            numItems: s
        }), h = "loading" === c || 0 === d.length, m = (0, a.A)(h ? k : d, F), A = l.useMemo(() => {
            let {
                hasWishlist: e,
                hasPopular: t
        ...
        channel: s,
        numItems: 7
    }), B = "loading" === N || 0 === y.length || null == m, [H, V] = l.useMemo(() => {
