...
function z(e) {
    let {
        user: t,
        isGift: n
    } = e, l = F.intl.string(F.t.kv4lSp), a = F.intl.string(F.t.vzZoSF);
    return n && (l = null != t ? F.intl.format(F.t.YwV901, {
        username: j.Ay.getName(t)
    }) : F.intl.string(F.t.qCmNFr), a = F.intl.string(F.t.SSgrne)), (0, i.jsxs)(r.BJc, {
        direction: "vertical",
        gap: 4,
...
function J(e) {
    let {
        ...
        applicationIds: o,
        numItems: a
    }), h = "loading" === c || 0 === d.length, m = (0, s.A)(h ? V : d, q), A = l.useMemo(() => {
        let {
            hasWishlist: e,
            hasPopular: t
        } = (0, R.wH)(d, u, new Set(r));
        return e && t
    }, [d, u, r]);
    return l.useEffect(() => {
        0 !== d.length && b.default.track(w.HAw.COMMERCE_SHOP_VC_GIFT_BUTTON_VIEWED, {
            guild_id: i.guild_id,
            channel_id: i.id,
...
function Z(e) {
    ...
    let {
        ...
        return m || !S || null == C ? null : !I && T ? (0, i.jsx)("div", {
            className: H.OQ,
