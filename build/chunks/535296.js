...
function L(e) {
    let {
        user: t,
        isGift: n
    } = e, l = j.intl.string(j.t.kv4lSp), s = j.intl.string(j.t.vzZoSF);
    return n && (l = null != t ? j.intl.format(j.t.YwV901, {
        username: E.Ay.getName(t)
    }) : j.intl.string(j.t.qCmNFr), s = j.intl.string(j.t.SSgrne)), (0, i.jsxs)(r.BJc, {
        direction: "vertical",
        gap: 4,
...
function w(e) {
    ...
    let {
    ...
    } = (0, d.Ay)(c.A.SLAYER_STOREFRONT_VC_GIFTING_PANEL), I = (0, o.bG)([_.default], () => _.default.getUser(t)), b = t === (0, o.bG)([p.default], () => p.default.getId()), j = (0, S.A)(n), {
        status: w,
        recommendations: U,
        ...
        let {
            ...
            applicationIds: o,
            numItems: s
        }), h = "loading" === c || 0 === d.length, m = (0, a.A)(h ? D : d, k), g = l.useMemo(() => {
            let {
                hasWishlist: e,
                hasPopular: t
            } = (0, x.wH)(d, u, new Set(r));
            return e && t
        }, [d, u, r]);
        return l.useEffect(() => {
            0 !== d.length && f.default.track(y.HAw.COMMERCE_SHOP_VC_GIFT_BUTTON_VIEWED, {
                guild_id: i.guild_id,
                channel_id: i.id,
        ...
        channel: s,
        numItems: 7
    }), B = "loading" === w || 0 === U.length || null == I, [H, V] = l.useMemo(() => {
