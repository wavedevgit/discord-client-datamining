...
function et(e) {
    ...
    let {
        ...
        applicationId: a
    }), [a]), L = (0, u.bG)([C.A], () => C.A.getWidgets(n)?.find(e => e instanceof E.R && e.applicationId === a)), D = (0, u.bG)([R.default], () => R.default.getId()), O = n === D, P = function(e) {
        let {
            currentUserId: t,
            applicationId: n,
            location: a,
            ...
            profileApplicationWidget: _
        } = (0, p.A)(r ? t : void 0, r ? n : void 0, a), {
            fetched: C,
            hasAlreadyLinked: T,
    ...
    }), [v, B, s.guild_id, s.id, H, n, O, Y, h, r]);
    return (0, i.jsxs)(J, {
        className: t,
        "aria-labelledby": z,
...
function en(e) {
    ...
    let {
    ...
    } = (0, A.Ay)(m.A.SLAYER_STOREFRONT_VC_GIFTING_PANEL), c = (0, u.bG)([M.default], () => M.default.getUser(n)), h = n === (0, u.bG)([R.default], () => R.default.getId()), g = (0, k.A)(a), {
        status: p,
        recommendations: _,
        ...
        channel: s,
        numItems: 8
    }), C = "loading" === p || 0 === _.length || null == c, [x, S] = l.useMemo(() => {
        if (null == c || 0 === _.length) return [null, []];
    ...
    }, [c, _, f, n, h, s.guild_id, s.id, E, o, r]);
    return (0, i.jsxs)(J, {
        className: t,
        "aria-labelledby": z,
        children: [(0, i.jsxs)(d.BJc, {
