/** chunk id: 662166, original params: e,t,s (module,exports,require) **/
"use strict";
s.d(t, {
    A: () => b
});
...
let S = e => {
    ...
    v = e => {
        let {
            ...
            color: "#9B59B6",
            label: C.intl.string(C.t.kqUD4P),
            enum: i.I.PURPLE
        }, {
            color: "#3498DB",
            label: C.intl.string(C.t.qQTRae),
            enum: i.I.BLUE
        }, {
            color: "#2ECC71",
            label: C.intl.string(C.t["f/Ylk6"]),
            enum: i.I.GREEN
        }, {
            color: "#A0522D",
            label: C.intl.string(C.t["Sd/BMa"]),
            enum: i.I.BROWN
        }, {
            color: "#F1C40F",
            label: C.intl.string(C.t["0fevYz"]),
            enum: i.I.YELLOW
        }], []), r = l.useMemo(() => [{
            color: "#E67E22",
            label: C.intl.string(C.t.ZE7weD),
            enum: i.I.ORANGE
        }, {
            color: "#E74C3C",
            label: C.intl.string(C.t.hKJGOM),
            enum: i.I.RED
        }, {
            color: "#EC407A",
            label: C.intl.string(C.t.HvLEGM),
            enum: i.I.PINK
        }, {
            color: "#FFFFFF",
            label: C.intl.string(C.t["CB+lNO"]),
            enum: i.I.WHITE
        }, {
            color: "#262626",
    ...
    j = e => {
        let {
            ...
            themeFilters: s,
            onToggleTheme: r
        } = (0, p.v)(), i = (0, g.Ay)() === E.NJ.DARK, o = l.useCallback(e => {
            if (s.has(e) || i) return "always-white"
        }, [s, i]), d = l.useCallback(e => s.has(e) || i ? u.LU0.colors.WHITE : u.LU0.colors.INTERACTIVE_TEXT_DEFAULT, [s, i]), _ = l.useMemo(() => [{
