/** chunk id: 662166 params = (module,exports,require) **/
"use strict";
s.d(t, {
    A: () => A
});
...
function A() {
    ...
    return (0, n.jsxs)("div", {
        ...
        children: [(0, n.jsxs)("div", {
            className: i()(C.KZ, C.YG),
            children: [(0, n.jsx)(u.Text, {
                variant: "text-md/semibold",
                className: C.hr,
                children: b.intl.string(b.t.Qk6r1a)
            }), f._6.map(e => (0, n.jsx)(S, {
                filter: e,
                trackFilterAction: d
            }, e)), o && (0, n.jsx)(u.Checkbox, {
                checked: t,
                onChange: () => {
...
let S = e => {
    ...
    v = e => {
        let {
            ...
            color: "#9B59B6",
            label: b.intl.string(b.t.kqUD4P),
            enum: a.I.PURPLE
        }, {
            color: "#3498DB",
            label: b.intl.string(b.t.qQTRae),
            enum: a.I.BLUE
        }, {
            color: "#2ECC71",
            label: b.intl.string(b.t["f/Ylk6"]),
            enum: a.I.GREEN
        }, {
            color: "#A0522D",
            label: b.intl.string(b.t["Sd/BMa"]),
            enum: a.I.BROWN
        }, {
            color: "#F1C40F",
            label: b.intl.string(b.t["0fevYz"]),
            enum: a.I.YELLOW
        }], []), l = r.useMemo(() => [{
            color: "#E67E22",
            label: b.intl.string(b.t.ZE7weD),
            enum: a.I.ORANGE
        }, {
            color: "#E74C3C",
            label: b.intl.string(b.t.hKJGOM),
            enum: a.I.RED
        }, {
            color: "#EC407A",
            label: b.intl.string(b.t.HvLEGM),
            enum: a.I.PINK
        }, {
            color: "#FFFFFF",
            label: b.intl.string(b.t["CB+lNO"]),
            enum: a.I.WHITE
        }, {
            color: "#262626",
    ...
    j = e => {
        let {
            ...
            themeFilters: s,
            onToggleTheme: l
        } = (0, p.v)(), a = (0, _.Ay)() === E.NJ.DARK, o = r.useCallback(e => {
            if (s.has(e) || a) return "always-white"
        }, [s, a]), d = r.useCallback(e => s.has(e) || a ? u.LU0.colors.WHITE : u.LU0.colors.INTERACTIVE_TEXT_DEFAULT, [s, a]), g = r.useMemo(() => [{
