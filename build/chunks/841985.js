/** chunk id: 841985, original params: e,t,a (module,exports,require) **/
a.d(t, {
    A: () => f
});
var n = a(627968),
...
function A(e) {
    let {
        ...
        imageUrl: s,
        imageUrlAnimated: r
    }, [m.state, m.url, s, r]), A = null != g, f = null != p;
    return "loading" === m.state ? null : f ? (0, n.jsxs)(n.Fragment, {
        children: [A ? (0, n.jsx)(C, {
            isHovered: a,
            url: g,
            animatedUrl: void 0
        }) : (0, n.jsx)(h.A, {
...
let f = function(e) {
    let {
        ...
        botBannerUrlAnimated: l ? void 0 : (0, m.z)({
            id: f.id,
            banner: f.banner,
            canAnimate: !0,
            size: 600
