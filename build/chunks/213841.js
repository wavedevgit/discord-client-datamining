    ...
    function m() {
        ...
        return g = v.length, i ? v = function(e, t) {
            for (var r = e.length, a = I(t.length, r), n = function(e, t) {
                ...
                var o, s = t[a];
                e[a] = (o = null == (o = r) ? 0x1fffffffffffff : o) && ("number" == typeof s || y.test(s)) && s > -1 && s % 1 == 0 && s < o ? n[s] : void 0
            }
            return e
        }(v, i) : h && g > 1 && v.reverse(), u && c < g && (v.length = c), this && this !== A && this instanceof m && (x = p || L(x)), x.apply(E, v)
    }
    return m
}
...
function $(e, t) {
    ...
    return !(!G(o) || (r = o, _ && _ in r)) && ("[object Function]" == (n = G(a = o) ? N.call(a) : "") || "[object GeneratorFunction]" == n || function(e) {
        var t = !1;
...
var U = T ? function(e, t, r) {
    var a, n, o, s, i, c, u, h = t + "";
    return T(e, "toString", {
        configurable: !0,
        enumerable: !1,
        value: (o = (u = (c = (a = (s = h.match(b)) ? s[1].split(d) : [], n = r, ! function(e, t) {
    ...
    var a = function(e, t, r, a, n, o, s, i) {
        ...
        if (e = b[0], t = b[1], r = b[2], a = b[3], n = b[4], (i = b[9] = null == b[9] ? c ? 0 : e.length : P(b[9] - l, 0)) || !(24 & t) || (t &= -25), t && 1 != t) 8 == t || 16 == t ? x = function(e, t, r) {
            ...
            function n() {
                ...
                return (o -= l.length) < r ? z(e, t, F, n.placeholder, void 0, s, l, void 0, void 0, r - o) : O(this && this !== A && this instanceof n ? a : e, this, s)
            }
            return n
        }(e, t, i) : 32 != t && 33 != t || n.length ? x = F.apply(void 0, b) : (d = e, h = t, p = r, m = a, g = 1 & h, y = L(d), x = function e() {
            for (var t = -1, r = arguments.length, a = -1, n = m.length, o = Array(n + r), s = this && this !== A && this instanceof e ? y : d; ++a < n;) o[a] = m[a];
            for (; r--;) o[a++] = arguments[++t];
            return O(s, g ? p : this, o)
        });
        else var d, h, p, m, g, y, v, w, M, k, E, x = (v = e, w = t, M = r, k = 1 & w, E = L(v), function e() {
...
function H(e) {
    var t, r = (t = e) ? (t = function(e) {
            ...
            if ("symbol" == typeof(t = e) || t && "object" == typeof t && "[object Symbol]" == N.call(t)) return c;
            if (G(e)) {
