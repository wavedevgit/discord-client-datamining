...
function L(e, t, r, a, n, o, s, i, c, l) {
    ...
    function y() {
        ...
        if (a && (m = function(e, t, r, a) {
                ...
                for (; l--;) u[i++] = e[n++];
                return u
            }(m, a, n, d)), o && (m = function(e, t, r, a) {
                for (var n = -1, o = e.length, s = -1, i = r.length, c = -1, l = t.length, u = F(o - i, 0), b = Array(u + l), f = !a; ++n < u;) b[n] = e[n];
        ...
        var j = b ? r : this,
            C = f ? j[e] : e;
        return v = m.length, i ? m = function(e, t) {
            for (var r = e.length, a = N(t.length, r), n = function(e, t) {
                ...
                var o, s = t[a];
                e[a] = (o = null == (o = r) ? 0x1fffffffffffff : o) && ("number" == typeof s || g.test(s)) && s > -1 && s % 1 == 0 && s < o ? n[s] : void 0
            }
            return e
        }(m, i) : h && v > 1 && m.reverse(), u && c < v && (m.length = c), this && this !== O && this instanceof y && (C = p || B(C)), C.apply(j, m)
    }
    return y
}
...
var $ = I ? function(e, t, r) {
    ...
    return I(e, "toString", {
        configurable: !0,
        enumerable: !1,
        value: (o = (u = (c = (a = (s = h.match(f)) ? s[1].split(d) : [], n = r, ! function(e, t) {
...
function W(e, t, r) {
    var a = function(e, t, r, a, n, o, s, i) {
        ...
        var l = a ? a.length : 0;
        if (l || (t &= -97, a = n = void 0), s = void 0 === s ? s : F(V(s), 0), i = void 0 === i ? i : V(i), l -= n ? n.length : 0, 64 & t) {
            var u = a,
                b = n;
            a = n = void 0
        }
        ...
        if (e = f[0], t = f[1], r = f[2], a = f[3], n = f[4], (i = f[9] = null == f[9] ? c ? 0 : e.length : F(f[9] - l, 0)) || !(24 & t) || (t &= -25), t && 1 != t) 8 == t || 16 == t ? C = function(e, t, r) {
            ...
            function n() {
                ...
                return (o -= l.length) < r ? U(e, t, L, n.placeholder, void 0, s, l, void 0, void 0, r - o) : k(this && this !== O && this instanceof n ? a : e, this, s)
            }
            return n
        }(e, t, i) : 32 != t && 33 != t || n.length ? C = L.apply(void 0, f) : (d = e, h = t, p = r, y = a, v = 1 & h, g = B(d), C = function e() {
            for (var t = -1, r = arguments.length, a = -1, n = y.length, o = Array(n + r), s = this && this !== O && this instanceof e ? g : d; ++a < n;) o[a] = y[a];
