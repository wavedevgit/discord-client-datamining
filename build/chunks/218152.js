/** chunk id: 218152 params = (module,exports,require) **/
s.d(t, {
    Cp: () => f,
    ST: () => C,
    kU: () => p
...
class x {
    ...
    constructor(e, t, s) {
        ...
        this.name = l.name ?? "", this.appliedTags = new Set(l.appliedTags) ?? new Set, this.textAreaState = r, this.formOpen = r.textValue !== a
    }
    set = e => {
        (0, o.r)(() => this._set(e))
    };
    ...
    setTextAreaState = e => {
        this.set({
            textAreaState: e
        }), d.A.saveDraft(this.channelId, e.textValue, h.C.FirstThreadMessage)
    };
    setHasClickedForm = e => {
        this.set({
            hasClickedForm: e
...
function f(e) {
    let {
        children: t,
        channel: s
    } = e, a = l.useMemo(() => (0, r.h)((e, t) => new x(s.id, e, t)), [s]);
