/** chunk id: 5558 params = (module,exports,require) **/
"use strict";
n.d(t, {
    N: () => m
});
...
let m = e => {
    let t = [{
        renderComponent: () => (0, i.jsx)(d.A, {
            guild: e
        }, "verification-level"),
        enabled: !0
    }, {
        renderComponent: () => (0, i.jsx)(o.A, {
    ...
    return {
        ...
        [s.C.PERMISSIONS]: [{
            renderComponent: () => (0, i.jsx)(l.A, {
                guild: e
            }, "guild-mfa"),
            enabled: e.mfaLevel === c.EkJ.ELEVATED
        }, {
            renderComponent: () => (0, i.jsx)(r.A, {
                guild: e
            }, "disable-risky-perms"),
