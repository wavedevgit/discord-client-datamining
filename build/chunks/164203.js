...
function X(e) {
    ...
    let {
    ...
    } = e, Z = (0, T.Ut)(), [ee, et] = l.useState(!1), en = l.useCallback(() => et(!0), []), er = l.useCallback(() => et(!1), []), el = (0, o.bG)([g.default], () => g.default.getCurrentUser()), ei = (0, o.bG)([f.A], () => f.A.getState().theme), ea = (0, s.Mw)(ei) ? q.NJ8.DARK : q.NJ8.LIGHT, eo = (0, o.bG)([c.A], () => c.A.getParticipants(e.channelId), [e.channelId]), es = (0, o.bG)([x.A], () => (0, P.t6)(x.A.quests, x.A.questToDeliverForPlacement, h.yW.DESKTOP_ACCOUNT_PANEL_AREA), []), {
        ...
        quest: X
    }), eO = (0, M.vA)(X), ej = (0, O.LS)(X), eT = (null == (n = X.userStatus) ? void 0 : n.enrolledAt) != null, eC = (null == (i = X.userStatus) ? void 0 : i.completedAt) != null, eN = null != X.userStatus && (0, P.gO)(X.userStatus, h.uF.QUEST_LIVE_STREAM), eP = null != X.userStatus && (0, P.gO)(X.userStatus, h.uF.QUEST_BAR), eI = ec && !eP, ew = A.t$.useConfig({
        location: B.rE.QUEST_CHANNEL_CALL_HEADER
    }).enabled;
    eS.info({
