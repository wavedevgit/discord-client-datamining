...
function Y(e) {
    let {
    ...
    } = e, C = (0, I.Ut)(), [D, Y] = s.useState(!1), $ = s.useCallback(() => Y(!0), []), J = s.useCallback(() => Y(!1), []), X = (0, a.bG)([N.default], () => N.default.getCurrentUser()), Z = (0, a.bG)([E.A], () => E.A.getState().theme), ee = (0, o.Mw)(Z) ? z.NJ8.DARK : z.NJ8.LIGHT, et = (0, a.bG)([c.A], () => c.A.getParticipants(e.channelId), [e.channelId]), en = (0, a.bG)([p.A], () => (0, b.t6)(p.A.quests, p.A.questToDeliverForPlacement, g.yW.DESKTOP_ACCOUNT_PANEL_AREA), []), {
        isCurrentUserStreamingQuestApplication: el,
        isQuestInQuestBar: es
    } = (0, a.cf)([_.A], () => {
        var e;
        return {
            isCurrentUserStreamingQuestApplication: null != n && null != X && (e = _.A, et.some(t => {
    ...
    }, [X, n, et, en]), ei = (0, U.pU)(n)?.[0], er = (0, a.bG)([d.Ay, _.A], () => {
        let e = d.Ay.getRunningGames().map(e => e.id);
        if ((0, U.xZ)(n) && null !== ei && e.includes(ei)) return !0;
        let t = null != X ? _.A.findActivity(X.id, e => e.type !== z.$pd.CUSTOM_STATUS) : null;
        return !!(null != t && (0, U.g5)(n) && (0, y.zS)(t, n))
    }, [n, X, ei]), ea = !0 === f || el || er, eo = (0, a.bG)([p.A], () => null != n && p.A.isEnrolling(n.id), [n]), eu = (0, a.bG)([c.A], () => (X?.id == null ? null : c.A.getParticipant(t, X.id)) != null, [t, X]), {
        ...
        quest: n
    }), ep = (0, L.vA)(n), eg = (0, x.LS)(n), eC = n.userStatus?.enrolledAt != null, eh = n.userStatus?.completedAt != null, eS = null != n.userStatus && (0, b.gO)(n.userStatus, g.uF.QUEST_LIVE_STREAM), ex = null != n.userStatus && (0, b.gO)(n.userStatus, g.uF.QUEST_BAR), ev = es && !ex, eI = h.t.useConfig({
        location: q.rE.QUEST_CHANNEL_CALL_HEADER
    }), eR = (0, Q.Pd)(n);
    eN.info({
    ...
    if (!eM && (eS || eg || ev) || !eM && !eu) return null;
    let ej = (0, U.Yh)(n),
        eb = (0, l.jsx)(V.A, {
            className: K.Qq,
            autoplay: D,
            ...
            children: [(0, l.jsxs)("div", {
                ...
                children: [eC && ea ? eb : (0, l.jsx)("img", {
                    ...
                    children: [(0, l.jsxs)("div", {
                        ...
                        children: eh ? W.intl.formatToPlainString(W.t.APddvF, {
                            expirationDate: eA
                ...
                children: [!eC && (0, l.jsxs)(u.BJc, {
                    ...
                    }), eI.enabled && eR === Q.UA.UNENROLLED && eI.enabledQuestStates.has(Q.UA.UNENROLLED) && !eg ? (0, l.jsx)(w.A, {
                        quest: n,
                ...
                }), eC && !eh && ea && (0, l.jsx)(P.A, {
                    color: u.LU0.colors.BACKGROUND_BRAND,
                    quest: n
                }), eC && !eh && !ea && (0, l.jsx)(u.Button, {
                    variant: "primary",
                    size: "sm",
                    fullWidth: !0,
...
function $(e) {
    let t = s.useContext(f.vG),
        ...
        u = s.useMemo(() => (0, L.$e)(r, q.Ls), [r]),
        d = (0, a.bG)([c.A], () => c.A.getParticipants(e.channelId), [e.channelId]),
        A = (0, a.bG)([_.A], () => null != e.previewQuest ? e.previewQuest : function(e, t, n) {
            for (let l of e) {
    ...
    let N = (0, a.bG)([p.A], () => {
        ...
        [h, S] = s.useState(null);
    s.useEffect(() => {
        null != N ? S(N) : null === E && S(null)
    }, [N, E]);
    let v = N ?? (null !== E ? h : null),
...
let J = function(e) {
    ...
    return (0, a.bG)([c.A], () => (t?.id == null ? null : c.A.getParticipant(e.channelId, t.id)) != null, [e.channelId, t]) || null != e.previewQuest ? (0, l.jsx)($, {
        ...e
    }) : null
}