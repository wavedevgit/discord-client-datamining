...
class X extends(r = s.Component) {
    ...
    componentDidUpdate(e) {
        ...
        s && !e.hide ? (this.animateControls(1, o), null == (t = this.volumeButton) || t.blur(), null == (n = (r = this.props).onControlsHide) || n.call(r)) : !s && e.hide && (this.animateControls(0, o), null == (i = (a = this.props).onControlsShow) || i.call(a))
    }
    updateProgress(e) {
...
class et extends(i = s.PureComponent) {
    ...
    renderMetadata() {
        ...
        return null == e || null == t ? null : r === W.AUDIO ? (0, a.jsx)(Q, {
            fileName: e,
            fileSize: t,
            src: n,
            disabled: !i,
    ...
    constructor(e) {
        var t, n;
        super(e), t = this, k(this, "_unmounted", !1), k(this, "_lastMove", 0), k(this, "_analytics", void 0), k(this, "_statsCollector", null), k(this, "_hasStatsListener", !1), k(this, "mediaRef", s.createRef()), k(this, "controlsRef", s.createRef()), k(this, "playPausePopRef", s.createRef()), k(this, "handleFullScreenExit", () => {
            let {
                current: e
            } = this.mediaRef;
            if (null == e) return;
