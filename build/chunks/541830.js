...
function f(e) {
    let t = (0, a.B6)(e, {
        path: o.BVt.APPLICATION_STORE_LISTING_SKU(":skuId", ":slug")
    });
...
function p(e) {
    switch (e) {
        ...
        case o.Kf.TOWER_DEFENSE:
            return s.intl.string(s.t.SULyIO);
        case o.Kf.TURN_BASED_STRATEGY:
