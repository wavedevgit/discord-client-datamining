/** chunk id: 772800 params = (module,exports,require) **/
n.d(t, {
    A: () => B
});
var i = n(627968),
...
function k(e) {
    let {
        ...
        channel: n,
        activity: l,
        activityApplicationId: s,
        withGiftingBreadcrumb: a,
        onAction: r
    } = e, o = (0, i.jsx)(L.A, {
        presenceActivity: l,
        channel: n,
    ...
    return a && null != s ? (0, i.jsxs)(i.Fragment, {
        children: [o, (0, i.jsx)(I.A, {
            className: G.L,
            applicationId: s,
...
function w(e) {
    let {
        user: t,
        guildId: n
    } = e, l = (0, r.bG)([S.Ay], () => S.Ay.getMember(n, t.id)), s = O.Ay.useName(t), a = l?.nick ?? s, {
...
function B(e) {
    ...
    if (l.useEffect(() => {
        ...
        }, [et, s.id, h.id]), !et) return null;
    let en = (0, i.jsxs)(i.Fragment, {
        children: [Z && (0, i.jsx)(g.P, {
            stream: B,
            activeStream: V,
            streamActivity: K,
            user: h,
