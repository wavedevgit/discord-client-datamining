...
let E = (e, t, n, r) => {
    ...
    y = function(e) {
        ...
        if (A) {
            ...
            if (null != l && (null == T ? void 0 : T.subscriptionPeriodEnd) != null) H = m.intl.format(m.t["2VPTay"], {
                subtotalRate: y
            });
            else switch (t) {
                case h.WT.MONTH:
                ...
                v || (e = E(D, t, n, b.id)), H = (null == L ? void 0 : L.isPausedAllowsResumeButNotUpdates) ? m.intl.format(m.t.B6oNwB, {
                    primaryText: r,
                    rate: e,
                    paidURL: p.X7G.PAID_TERMS,
