...
function f(e) {
    let {
    ...
    } = (0, o.Ay)(c.A.CLIPS_GALLERY), [I, b] = s.useState(new Set), {
        clipsByGame: E,
        filteredClips: k,
        favoriteClips: M,
        allClips: w
        ...
        onShareClick: L
    } = (0, m.A)(t), S = (0, a.bG)([u.A], () => u.A.getExportingClipIds().length > 0), H = (0, x.P)(e => e.selectedGameId), T = s.useMemo(() => null == H || "favorites" === H ? null : E.find(e => e.applicationId === H) ?? null, [H, E]), P = s.useMemo(() => "favorites" === H ? M : T?.filteredClips ?? k, [H, T, k, M]), V = s.useMemo(() => "favorites" === H ? v.intl.string(v.t["9rlCk1"]) : T?.name ?? v.intl.string(v.t.dPVrEv), [H, T]), D = s.useCallback(e => {
        b(t => {
            let l = new Set(t);
