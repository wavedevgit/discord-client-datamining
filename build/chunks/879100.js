...
function K(n) {
    let {
        ...
        setInvoicePreview: K
    } = (0, f.P5)(), q = (0, v.A)(), H = e.interval, F = e.intervalCount, Z = (0, u.bG)([R.A], () => R.A.getForSkuAndInterval((0, O.mH)(Y.pe.GUILD), H, F)), $ = (0, u.bG)([U.default], () => U.default.getCurrentUser()), Q = (0, g.A)({
        forceFetch: !1
    });
    ...
    let nr = !ne && null == ni && null == nl,
        ...
        nm = O.Ay.hasBoostDiscount($) && null != x && O.Ay.isPremiumAtLeast(O.Ay.getPremiumType(x.planId), Y.PremiumTypes.TIER_1) ? B.intl.format(B.t.hf6YOY, {
            planName: O.Ay.getTierDisplayNameByPlanId(x.planId)
    ...
    return a(nr), (0, i.jsxs)("div", {
        children: [nx && (0, i.jsx)(E.vi, {
            fractionalPremiumInfo: Q
        }), nd && null != x ? (0, i.jsx)(w.Ak, {
            endDate: x.currentPeriodEnd
        }) : (0, i.jsx)("div", {
            className: s()(J.hA, J.G3),
            children: B.intl.string(B.t.jNY1FO)
            ...
            children: [(0, i.jsx)(m._Jp, {
                ...
                children: [B.intl.format(B.t.F8xlhr, {
                    slotCount: b.length
                }), np > 0 && null != x ? (0, i.jsx)(d.m, {
            ...
            children: [(0, i.jsxs)("div", {
                ...
                children: [(0, i.jsx)(m.lw3, {
                    ...
                    className: J.$0,
                    children: nI ? function(n) {
                        let {
                            intervalType: e,
                            intervalCount: t = 1
                        } = n;
                        return e === Y.WT.YEAR ? B.intl.string(B.t.YDpAzZ) : e === Y.WT.MONTH && 1 === t ? B.intl.string(B.t["6ZR3By"]) : null
                    }({
                        intervalType: H,
                        intervalCount: F
                ...
                children: nr ? (0, i.jsx)(m.y$y, {}) : nI ? (0, k.$g)(nu.amount, nu.currency) : function(n) {
                    let {
                        amount: e,
                        currency: t,
                        intervalType: i,
                    ...
                    return i === Y.WT.YEAR ? B.intl.formatToPlainString(B.t["8M04YJ"], {
                        price: r
                    }) : i === Y.WT.MONTH && 1 === l ? B.intl.formatToPlainString(B.t.VStWCR, {
                        price: r
                    }) : i === Y.WT.MONTH && l > 1 ? B.intl.formatToPlainString(B.t.xJvAFU, {
                        price: r
                    }) : null
                }({
                    intervalType: H,
            ...
            children: [(0, i.jsx)("div", {
                className: J.xp,
                children: B.intl.string(B.t.RtA7nR)
            }), (0, i.jsx)("div", {
                className: s()(J.__invalid_planSelectorSubtotalPrice, {
                    [J.S]: nr
                }),
                children: nr ? (0, i.jsx)(m.y$y, {}) : (0, i.jsx)(T.A, {
                    price: no,
                    currency: nu.currency,
                    intervalType: H,
                    intervalCount: F,
...
function q(n) {
    ...
    return P.isLoading ? P.loadingContent : (0, i.jsxs)("div", {
        children: [P.isLoading ? P.loadingContent : P.isReturningUnifiedCheckoutUI ? (0, i.jsxs)(i.Fragment, {
            children: [P.unifiedSubscriptionDetailsContent, P.unifiedInvoiceSummaryContent]
        }) : P.legacyCheckoutContent, (0, i.jsx)("div", {
            className: J.LC,
...
function H(n) {
    let e, {
        ...
        [x, S] = l.useState(!1),
        f = r?.name ?? d;
    return e = a ? null == f ? B.intl.format(B.t.P52e1r, {}) : B.intl.format(B.t["4UnIk9"], {
        guildName: f
    }) : o ? B.intl.format(B.t.gFaKd1, {
        helpCenterLink: D.A.getArticleURL(G.MVz.FRACTIONAL_PREMIUM_ABOUT)
    }) : null == f ? B.intl.format(B.t.SZ5ohR, {
        guildSubscriptionQuantity: s
    }) : B.intl.format(B.t.GxK3Mv, {
        guildName: f,
        guildSubscriptionQuantity: s
    }), (0, i.jsxs)("div", {
        className: J.RP,
        children: [c ? (0, i.jsx)(j.V1, {
            className: J.ud,
            nextScene: y,
            onScenePlay: n => {
                if (!x) switch (n) {
            ...
            type: W.Nc.has(u ?? W.he.UNKNOWN) ? b.Ay.Types.PREMIUM_PAYMENT_STARTED : b.Ay.Types.GUILD_BOOST_APPLIED
        }), (0, i.jsx)("div", {
            className: J.xR,
            children: e
        }), (0, i.jsx)(m.Button, {
