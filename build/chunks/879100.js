...
function K(n) {
    let {
        ...
        setInvoicePreview: q
    } = (0, A.P5)(), F = (0, f.A)(), $ = e.interval, H = e.intervalCount, J = (0, u.bG)([R.A], () => R.A.getForSkuAndInterval((0, M.mH)(V.pe.GUILD), $, H)), Z = (0, u.bG)([_.default], () => _.default.getCurrentUser()), z = (0, y.A)({
        forceFetch: !1
    });
    ...
    let nl = !ne && null == ni && null == nr,
        ...
        nm = M.Ay.hasBoostDiscount(Z) && null != g && M.Ay.isPremiumAtLeast(M.Ay.getPremiumType(g.planId), V.PremiumTypes.TIER_1) ? W.intl.format(W.t.hf6YOY, {
            planName: M.Ay.getTierDisplayNameByPlanId(g.planId)
    ...
    return a(nl), (0, i.jsxs)("div", {
        children: [nS && (0, i.jsx)(E.vi, {
            fractionalPremiumInfo: z
        }), nd && null != g ? (0, i.jsx)(w.Ak, {
            endDate: g.currentPeriodEnd
        }) : (0, i.jsx)("div", {
            className: s()(B.hA, B.G3),
            ...
            children: [(0, i.jsxs)("div", {
                ...
                children: [(0, i.jsx)(m.lw3, {
                    ...
                    children: nI ? function(n) {
                        ...
                        return e === V.WT.YEAR ? W.intl.string(W.t.YDpAzZ) : e === V.WT.MONTH && 1 === t ? W.intl.string(W.t["6ZR3By"]) : null
                    }({
                        intervalType: $,
                        intervalCount: H
                ...
                children: nl ? (0, i.jsx)(m.y$y, {}) : nI ? (0, O.$g)(nu.amount, nu.currency) : function(n) {
                    let {
                        amount: e,
                        currency: t,
                        intervalType: i,
                    ...
                    return i === V.WT.YEAR ? W.intl.formatToPlainString(W.t["8M04YJ"], {
                        price: l
                    }) : i === V.WT.MONTH && 1 === r ? W.intl.formatToPlainString(W.t.VStWCR, {
                        price: l
                    }) : i === V.WT.MONTH && r > 1 ? W.intl.formatToPlainString(W.t.xJvAFU, {
                        price: l
                    }) : null
                }({
                    intervalType: $,
            ...
            children: [(0, i.jsx)("div", {
                ...
                className: s()(B.__invalid_planSelectorSubtotalPrice, {
                    [B.S]: nl
                }),
                children: nl ? (0, i.jsx)(m.y$y, {}) : (0, i.jsx)(j.A, {
                    price: no,
                    currency: nu.currency,
                    intervalType: $,
                    intervalCount: H,
...
function F(n) {
    ...
    return (0, i.jsxs)("div", {
        children: [null != y && null != S ? (0, i.jsx)(q, {
...
function $(n) {
    let e, {
        ...
        [S, A] = r.useState(!1),
        v = l?.name ?? d;
    return e = a ? null == v ? W.intl.format(W.t.P52e1r, {}) : W.intl.format(W.t["4UnIk9"], {
        guildName: v
    }) : o ? W.intl.format(W.t.gFaKd1, {
        helpCenterLink: L.A.getArticleURL(G.MVz.FRACTIONAL_PREMIUM_ABOUT)
    }) : null == v ? W.intl.format(W.t.SZ5ohR, {
        ...
        children: [c ? (0, i.jsx)(g.V1, {
            ...
            type: Y.Nc.has(u ?? Y.he.UNKNOWN) ? T.Ay.Types.PREMIUM_PAYMENT_STARTED : T.Ay.Types.GUILD_BOOST_APPLIED
        }), (0, i.jsx)("div", {
            className: B.xR,
            children: e
        }), (0, i.jsx)(m.Button, {
