...
function T(e) {
    ...
    return (0, i.jsx)(c.m, {
        asContainer: !0,
        text: E.intl.formatToPlainString(E.t["4Y3O+O"], {
            count: t ?? ""
        }),
...
function v(e) {
    let {
        ...
        variant: "text-md/medium",
        color: "text-strong",
        children: E.intl.format(E.t.ZGVL3g, {
            count: t
        })
    });
...
function j(e) {
    ...
    }, [A, r, t, n]), [m, f] = s.useMemo(() => [A ? E.intl.string(E.t["8lklch"]) : E.intl.string(E.t.ji3jTF), A ? E.intl.string(E.t.RMQZCa) : E.intl.string(E.t["v/PagC"])], [A]), C = s.useMemo(() => ({
        align: "end"
    }), []);
    return (0, i.jsxs)(i.Fragment, {
...
function R(e) {
    let {
        ...
        label: E.intl.string(E.t.OukXZj),
        value: x.BBH.OLDEST
    }, {
