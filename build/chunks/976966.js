...
function b(e) {
    let {
        ...
        return null
    }, [t.type, b]), [y, j] = s.useState(null), L = s.useMemo(() => A ? [] : [a.M.CROSS_DM_SEARCH_SETTING_EDUCATION_POPOVER], [A]), [M, D] = (0, u.kn)(L), G = M === a.M.CROSS_DM_SEARCH_SETTING_EDUCATION_POPOVER, U = s.useCallback(e => {
...
function v(e) {
    ...
    return (0, i.jsx)(c.m, {
        asContainer: !0,
        text: I.intl.formatToPlainString(I.t["4Y3O+O"], {
            count: t ?? ""
        }),
...
function j(e) {
    let {
        ...
        variant: "text-md/medium",
        color: "text-strong",
        children: I.intl.format(I.t.ZGVL3g, {
            count: t
        })
    });
...
function R(e) {
    let {
        ...
        isPopoverVisible: c
    } = e, u = s.useRef(null), h = A.Hu.useSetting(), m = s.useCallback(e => {
        if (h !== e) {
            if ((0, f._k)({
                    searchContext: t,
    ...
    }, [h, r, t, n]), [p, _] = s.useMemo(() => [h ? I.intl.string(I.t["8lklch"]) : I.intl.string(I.t.ji3jTF), h ? I.intl.string(I.t.RMQZCa) : I.intl.string(I.t["v/PagC"])], [h]), x = s.useMemo(() => ({
        align: "end"
    }), []);
    return (0, i.jsxs)(i.Fragment, {
