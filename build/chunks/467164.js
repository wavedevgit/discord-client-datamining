...
function D(e) {
    let {
        ...
        onClose: n,
        transitionState: r
    } = e, a = (0, c.bG)([_.A], () => _.A.getGuild(t.guild_id));
    return (i.useEffect(() => {
        null == a && n()
...
function G(e) {
    let {
        ...
        error: D,
        onSave: G
    } = (0, p.A)(t, r), k = i.useMemo(() => j.A.getStageInstanceByChannel(t.id), [t.id]), [w, P] = i.useState(k?.topic ?? ""), [B, M] = i.useState(""), [U] = i.useState(m), [z, L] = i.useState({
        startDate: (0, g.jd)()
    }), [V, F] = i.useState(!1), W = (0, E.Z)(t), K = (0, E.K)(t), q = null == k && W && !U, [Q, Z] = i.useState(q && K), X = C.dD.GUILD_ONLY, [Y] = i.useState(k?.privacy_level ?? X), [J, H] = i.useState(null), $ = (0, f.D3)(t.id), ee = (0, f.Xk)(t.id), [et, en] = i.useState(!1), el = (0, u.Ay)(t), ei = (0, h.A)(n), er = null != c, ea = ei.length > 1;
    (0, o.Ay)(() => {
    ...
    let es = e => {
            (e.preventDefault(), Y === C.dD.PUBLIC && w.length < 20 && !et) ? en(!0): U || G?.({
                topic: w,
                privacyLevel: Y,
    ...
    let ed = V && null != z.startDate && z.startDate >= a()(),
        eo = (0, l.jsxs)(l.Fragment, {
            children: [(0, l.jsx)("div", {
                className: R.GU,
                children: null == k && ($ > 0 || ee > 0) && (0, l.jsx)(S.Bw, {
                    channelId: t.id
                })
            }), (0, l.jsxs)("form", {
                onSubmit: es,
                ...
                children: [(0, l.jsx)(d.ksK, {
                    ...
                    children: [(0, l.jsx)(x.A, {
                        ...
                        timeSelected: V,
                        onTimeChange: F
                    }), null != z.startDate && z.startDate < a()() ? (0, l.jsx)(d.Text, {
        ...
        eu = {
            ...
            actions: [{
                ...
                variant: "primary",
                text: U ? y.intl.string(y.t["60lJ0C"]) : null == k ? y.intl.string(y.t.s8mM8A) : y.intl.string(y.t.K344S7),
                onClick: es,
    ...
    return null == k ? (0, l.jsx)(s.ExpressiveModal, {
        graphic: {
            type: "image",
            src: I.A
        },
