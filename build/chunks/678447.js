/** chunk id: 678447 params = (module,exports,require) **/
n.d(t, {
    n: () => h
});
var i = n(627968);
...
function x() {
    ...
    return null == e || null == t ? (0, i.jsx)(l.Text, {
        ...
        children: _.intl.string(_.t.I5kDqj)
    }) : (0, i.jsx)(l.BJc, {
...
let h = (0, a.Tf)(c.X.ACCOUNT_INFO_PHONE_SETTING, {
    ...
    useAriaLabel: function() {
        return null == (0, s.bG)([d.default], () => d.default.getCurrentUser()?.phone) ? _.intl.string(_.t["SfUuE+"]) : _.intl.string(_.t.YDabSe)
    },
    ...
    useLabel: function() {
        return null == (0, s.bG)([d.default], () => d.default.getCurrentUser()?.phone) ? _.intl.string(_.t.OYkgVk) : _.intl.string(_.t.bt75uw)
    },
    onClick: function() {
        null == d.default.getCurrentUser()?.phone ? (0, l.mMO)(async () => {
            let {
                default: e
            ...
            let {
                default: e
            } = await n.e("89061").then(n.bind(n, 359012));
            return t => (0, i.jsx)(e, {
                ...t
            })
        })
