...
function c() {
    let e = (0, a.bG)([o.A], () => o.A.getQuestHomeHeroConfig()),
        t = i.useMemo(() => e?.startsAt != null ? s.default.fromTimestamp(new Date(e?.startsAt).valueOf()) : null, [e?.startsAt]),
        [n, c] = (0, l.Cc)(null != t && e?.questHomeEntrypoint != null ? r.M.QUEST_HOME_ENTRYPOINT_TAKEOVER_BADGE : null, t ?? "", d.m.PRIVATE_CHANNELS_LIST, !0),
        u = i.useCallback(function() {
            let e = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : d.i.TAKE_ACTION;
            c(e)
        }, [c]);
    return {
        shouldShowQuestHomeHeroContent: n === r.M.QUEST_HOME_ENTRYPOINT_TAKEOVER_BADGE,
