            ...
            switch (t) {
                case l.M.NAGBAR_NOTICE_DOWNLOAD:
                    return (0, i.jsxs)(s.$Td, {
                        ...
                        children: [(0, i.jsx)(s.PMB, {
                            onClick: () => E(x.i.UNKNOWN),
                            noticeType: b
                        }), T.intl.string(T.t["+xn1o5"]), (0, i.jsx)("i", {
                            className: S.c9
                        }), (0, i.jsx)("i", {
                            className: S.Vz
                        }), (0, i.jsx)("i", {
                ...
                case l.M.NAGBAR_QUEST_APP_UPSELL:
                    return (0, i.jsxs)(s.$Td, {
                        ...
                        children: [(0, i.jsx)(s.PMB, {
                            ...
                            className: S.TN
                        }), T.intl.string(T.t.lgwX26), (0, i.jsx)(s.Z_L, {
                            noticeType: b,
                            onClick: () => {
                                (0, o.A)(I.AMi.META_QUEST), E(x.i.TAKE_ACTION)
                            },
                            children: T.intl.string(T.t["1WjMbC"])
                        })]
                    });
                case l.M.NAGBAR_NOTICE_CONNECT_SPOTIFY:
                    return (0, i.jsxs)(s.$Td, {
                        ...
                        children: [(0, i.jsx)(s.PMB, {
                            ...
                            className: S.tV
                        }), T.intl.string(T.t["5NUVHH"]), (0, i.jsx)(s.Z_L, {
                            onClick: () => (0, c.A)({
                ...
                case l.M.NAGBAR_NOTICE_CONNECT_PLAYSTATION:
                    return (0, i.jsxs)(s.$Td, {
                        ...
                        }), T.intl.string(T.t.WHWgoY), (0, i.jsx)(s.zr9, {
                            onClick: () => (0, c.A)({
                ...
                case l.M.NAGBAR_NOTICE_PASSKEY_BACKUP:
                    return (0, i.jsxs)(s.$Td, {
                        color: s.Hv$.DEFAULT,
                        children: [(0, i.jsx)(s.PMB, {
                            onClick: () => E(x.i.USER_DISMISS),
                            noticeType: b
                        }), T.intl.string(T.t["3qKN/h"]), (0, i.jsx)(s.Z_L, {
                            onClick: async () => {
                                E(x.i.TAKE_ACTION);
                                try {
                                    let {
                                    ...
                                    (0, s.mMO)(async () => {
                                        ...
                                        } = await Promise.all([n.e("44667"), n.e("45917")]).then(n.bind(n, 359990));
                                        return n => (0, i.jsx)(e, {
                                            ...n,
                                            ticket: t,
                                            challenge: l,
                                    ...
                                    (0, s.showToast)((0, s.createToast)(T.intl.string(T.t.xSCvBf), s.ToastType.FAILURE))
                                }
                            },
                            noticeType: b,
                ...
                case l.M.NAGBAR_NOTICE_PREMIUM_PROMO:
                    return (0, i.jsxs)(s.$Td, {
                        ...
                        children: [(0, i.jsx)("span", {
                            ...
                            className: S.$t,
                            children: T.intl.string(T.t["+urf75"])
                        }), (0, i.jsx)(s.Z_L, {
                            className: S.CO,
                            noticeType: b,
                            onClick: () => {
                                ...
                                }), (0, p.openUserSettings)(_.X.NITRO_PANEL)
                            },
                            children: T.intl.string(T.t["8JC5e/"])
                        }), (0, i.jsx)(s.PMB, {
                            onClick: () => {
                                E(x.i.UNKNOWN), (0, a.lA)(I.nhx.PREMIUM_PROMO_DISMISSED, !0)
                            },
                            noticeType: b
                        })]
                    });
                case l.M.NAGBAR_NOTICE_PREMIUM_TIER_TWO_TRIAL_ENDING:
                    return (0, i.jsx)(h.A, {
                        dismissCurrentNotice: () => E(x.i.UNKNOWN),
                ...
                case l.M.NAGBAR_NOTICE_PREMIUM_REACTIVATE:
                    return (0, i.jsxs)(s.$Td, {
                        ...
                        children: [(0, i.jsx)(s.PMB, {
                            noticeType: b,
                            onClick: () => E(x.i.UNKNOWN)
                        }), T.intl.string(T.t["0KFB2B"]), (0, i.jsx)(s.Z_L, {
                            noticeType: b,
                            onClick: () => {
                                E(x.i.UNKNOWN), (0, p.openUserSettings)(_.X.NITRO_PANEL)
                            },
                ...
                case l.M.NAGBAR_BOUNCED_EMAIL_NOTICE:
                    return (0, i.jsxs)(s.$Td, {
                        ...
                        children: [(0, i.jsx)(s.PMB, {
                            onClick: () => E(x.i.UNKNOWN),
                            noticeType: b
                        }), T.intl.string(T.t["7490vQ"]), (0, i.jsx)(s.Z_L, {
                            noticeType: b,
                            onClick: () => {
