/** chunk id: 810669, original params: e,t,a (module,exports,require) **/
"use strict";
a.d(t, {
    e: () => _
});
...
function f(e) {
    ...
    return r.useEffect(() => {
        ...
        className: d.Yp,
        children: (0, s.jsx)(n.y$y, {
            type: n.y$y.Type.WANDERING_CUBES
        })
    })
}
let _ = e => {
    ...
    return null == t || 0 === t.length ? null : (0, s.jsxs)("div", {
        className: d.nd,
        style: {
            zoom: Math.min(a / 1460, r / 1080, 1)
        },
        children: [(0, s.jsx)("div", {
            ...
            children: [(0, s.jsxs)("div", {
                ...
                children: [(0, s.jsx)("div", {
                    className: d.fn,
                    children: (0, s.jsx)(f, {
                        text: `${x}?user_code=${encodeURIComponent(t)}`
                    })
                }), (0, s.jsxs)("div", {
                    className: d.E7,
