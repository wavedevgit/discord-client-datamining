...
function w(e) {
    let {
        ...
        wishlistOwner: g,
        ...m
    } = e, [x, f] = l.useState(!1), p = l.useCallback(async () => {
        if (!x) {
            f(!0);
            try {
...
function O(e) {
    let {
        ...
        analyticsLocations: n,
        ...a
    } = e, s = (0, c.bG)([x.A], () => x.A.getApplication(t.applicationId)), {
...
function G(e) {
    ...
    } = (0, m.Ay)(...s ?? [], g.A.SLAYER_STOREFRONT_WISHLIST_ITEM_CARD, g.A.SLAYER_STOREFRONT_WISHLIST_ITEM_CARD_GIFT_BUTTON), c = l.useCallback(() => {
        (0, h.a)(t, {
            isGift: !0,
            giftRecipient: n,
            giftingOrigin: a
...
function M(e) {
    let {
        sku: t,
        giftingOrigin: n = y.vQ.USER_PROFILE_WISHLIST,
        ...a
    } = e, [s, r] = l.useState(!1);
    switch (t.productLine) {
        case b.EZt.SOCIAL_LAYER_GAME_ITEM:
