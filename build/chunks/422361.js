...
class et extends K.Ay {
    ...
    renderPopout = () => {
        ...
        }) : t || n ? null : "history" === s && this.getVoiceStatesCount() > 0 ? (0, i.jsx)(z.A, {
            channel: e,
...
function ei(e) {
    ...
    }), A = (0, a.bG)([H.A], () => H.A.hasVideo(n.id)), m = (0, _.Ay)(n), p = (0, C.Ay)(n), x = (0, y.Qs)(n.id), E = (0, a.bG)([f.A], () => null != f.A.getStartTime(n), [n]), {
