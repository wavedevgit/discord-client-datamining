...
function el(e) {
    ...
    }), A = (0, r.bG)([F.A], () => F.A.hasVideo(n.id)), _ = (0, m.Ay)(n), g = (0, I.Ay)(n), x = (0, y.Qs)(n.id), E = (0, r.bG)([f.A], () => null != f.A.getStartTime(n), [n]), {
    ...
    } = (0, p.b)(t.id, "VoiceChannel"), k = null != d && d.length > 0, W = U && k, K = G && k, z = (0, Y.A)({
        channel: n,
        isChannelSelected: a,
