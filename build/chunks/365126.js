...
function m(e) {
    let {
        ...
        onClose: f,
        headerAlignStart: x
    } = e, [S, p] = s.useState(!1), [j, b] = s.useState(null), {
        challenge: A
    } = t.methods.find(e => "webauthn" === e.type), y = async () => {
        p(!0), b(null);
        let e = d.isPlatformEmbedded && c.Ay.supportsFeature(h.BYE.WEBAUTHN) ? c.Ay.webAuthnAuthenticate(A) : (0, a.J)(A),
            t = async e => {
                try {
                    await n({
                        mfaType: "webauthn",
        ...
        try {
            ...
            }), b(g.intl.string(g.t.xSCvBf))
        } finally {
            p(!1)
        }
    };
    return (0, l.jsxs)(l.Fragment, {
        children: [(0, l.jsx)(u.A.SlideHeader, {
            onClose: f,
            headerAlignStart: x
        }), null != j && (0, l.jsx)(u.A.SlideContent, {
            children: (0, l.jsx)(u.A.SlideError, {
                error: j
            })
