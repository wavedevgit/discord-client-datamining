/** chunk id: 307560 params = (module,exports,require) **/
n.d(t, {
    A: () => E
});
var r = n(627968),
...
let A = () => 80,
    ...
    _ = e => {
        let {
            ...
            ...o
        } = e, u = (0, m.V)(t.skuId), g = i.useRef(null), {
            accessibilityLabel: A,
            thumbnailPreviewSrc: _,
            title: E
        } = u?.config ?? {}, y = i.useMemo(() => (0, c.Rc)(_), [_]);
        return (0, r.jsxs)(h, {
            innerRef: n ?? g,
            isSelected: l,
            ...o,
    ...
    E = e => {
        let {
            ...
            onSelect: l,
            onOpenShop: c
        } = e, d = (0, p.Ay)(), m = null != i, f = u.Ay.canUseCollectibles(t);
