/** chunk id: 836774 params = (module,exports,require) **/
i.d(t, {
    default: () => f
});
var a = i(627968),
...
let f = function(e) {
    let {
        ...
        onClose: m,
        transitionState: f
    } = e, I = (0, d.GV)(), N = p.Ay.getDefaultChannel(t), [y, _] = n.useState("tab-id-role-icon-file-upload"), [k, v] = n.useState(!1), w = (0, l.A)(C);
    return n.useEffect(() => {
        v(!1)
    }, [y]), (0, a.jsx)(s.EOs, {
        transitionState: f,
        ...
        children: (0, a.jsxs)("div", {
            ...
            children: [(0, a.jsxs)(s.VQ0, {
            ...
            }), "tab-id-role-icon-file-upload" === y ? (0, a.jsx)(s.$mQ, {
                "data-migration-pending": !0,
                children: (0, a.jsxs)("div", {
                    className: g.PO,
                    children: [(0, a.jsxs)("div", {
            ...
            }) : null, "tab-id-role-icon-emoji" === y ? (0, a.jsx)(r.A, {
                hasTabWrapper: !0,
                closePopout: () => m(),
                onSelectEmoji: async e => {
                    ...
                    t?.id != null ? t?.type === o.i.GUILD && i(await b(t)) : t?.surrogates != null && u(t.defaultDiversityChild?.surrogates ?? t.surrogates), m()
                },
