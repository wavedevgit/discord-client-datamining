/** chunk id: 836774, original params: e,t,a (module,exports,require) **/
a.d(t, {
    default: () => f
});
var i = a(627968),
...
let f = function(e) {
    let {
        guildId: t,
        onUploadIcon: a,
        onSelectUnicodeEmoji: u,
        onClose: m,
        transitionState: f
    } = e, I = (0, d.GV)(), N = p.Ay.getDefaultChannel(t), [_, y] = n.useState("tab-id-role-icon-file-upload"), [k, v] = n.useState(!1), w = (0, l.A)(C);
    return n.useEffect(() => {
        v(!1)
    }, [_]), (0, i.jsx)(s.EOs, {
        transitionState: f,
        ...
        children: (0, i.jsxs)("div", {
            ...
            children: [(0, i.jsxs)(s.VQ0, {
            ...
            }), "tab-id-role-icon-file-upload" === _ ? (0, i.jsx)(s.$mQ, {
                "data-migration-pending": !0,
                children: (0, i.jsxs)("div", {
                    className: g.PO,
                    children: [(0, i.jsxs)("div", {
            ...
            }) : null, "tab-id-role-icon-emoji" === _ ? (0, i.jsx)(r.A, {
                hasTabWrapper: !0,
                closePopout: () => m(),
                onSelectEmoji: async e => {
                    ...
                    t?.id != null ? t?.type === o.i.GUILD && a(await b(t)) : t?.surrogates != null && u(t.defaultDiversityChild?.surrogates ?? t.surrogates), m()
                },
