...
function v(e) {
    let {
        ...
        onClick: r,
        onView: s
    } = e, [_, m] = a.useState(!1), [I, v] = a.useState(!1), [b, O] = a.useState(!1), L = a.useRef(null), R = a.useCallback(async () => {
        v(!0);
        try {
            await r(t.id)
        } finally {
    ...
    }, [t.id, r]), P = a.useCallback(e => {
        e && !_ && (m(!0), s?.(t.id))
    }, [t.id, _, s]), D = a.useCallback(e => {
        (0, c.L3)(e, async () => {
            let {
                default: e
    ...
    }, [t]), M = (0, u.Ay)(), j = t.features.has(C.GuildFeatures.HUB), w = a.useMemo(() => {
    ...
    }, [t.discoverySplash, t.id, j, M]), U = a.useMemo(() => E.Ay.getGuildIconURL({
        id: t.id,
        icon: t.icon,
        size: 48
    }), [t.icon, t.id]);
...
function O(e) {
    let {
        ...
        onClick: r,
        onView: l
    } = e, s = a.useRef(null == t), o = a.useCallback((e, t, n, a) => null == t.guildId ? (0, i.jsx)(m.A, {
        state: n,
        cleanUp: a,
    ...
    }, e), [r, l]), c = a.useCallback(e => e.guildId ?? `${e.index}`, []), u = a.useMemo(() => [{
        guildId: t,
        index: n
    }], [t, n]);
    return (0, i.jsx)("div", {
