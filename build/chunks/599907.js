...
function y(e) {
    let {
        ...
        onClick: a,
        onView: s
    } = e, [_, m] = l.useState(!1), [I, y] = l.useState(!1), [b, O] = l.useState(!1), L = l.useRef(null), R = l.useCallback(async () => {
        y(!0);
        try {
            await a(t.id)
        } finally {
    ...
    }, [t]), M = (0, u.Ay)(), j = t.features.has(C.GuildFeatures.HUB), w = l.useMemo(() => {
    ...
    }, [t.discoverySplash, t.id, j, M]), U = l.useMemo(() => E.Ay.getGuildIconURL({
        id: t.id,
        icon: t.icon,
        size: 48
    }), [t.icon, t.id]);
