...
function Y(e) {
    ...
    return (0, n.jsxs)(n.Fragment, {
        children: [(0, n.jsx)(m.AC4, {
            ...
            children: Array.from({
                length: i
            }, t ? (e, i) => (0, n.jsx)(M.O, {}, `placeholder-${i}`) : (e, i) => (0, n.jsx)(T.A, {
                cardSize: L.Y.SMALL
            }, `placeholder-${i}`))
        })]
    })
...
function $(e) {
    let {
        ...
        includedSources: I
    } = e, S = (0, O.GG)("wishlist_banner"), C = r.useMemo(() => [...i, s].filter(e => null != e), [i, s]), x = (0, c.bG)([P.A, E.A], () => E.A.getChannel(P.A.getChannelId()));
    return (0, n.jsx)("ul", {
        className: a()(Q.Md, {
            [Q.e6]: S
        }),
            ...
            children: [i.map((e, i) => {
                ...
                return (0, n.jsx)("li", {
                    ...
                    children: ((e, i) => {
                        ...
                        return s.shouldShow ? (0, R.Qc)(s) ? (0, n.jsx)(u.m, {
                            text: s.title,
                            position: "top",
                            asContainer: !0,
                            delay: N.Zh,
...
function J(e) {
    let {
    ...
    }, [i.id]), v = r.useMemo(() => "loading" === c, [c]), k = G.Ay.getName(i), H = (0, W.l7)({
        totalUnownedWishlistItemCount: l,
        wishlistInDmLength: I,
        displayItems: o,
        recipientName: k
        ...
        canAnimate: !1,
        size: 713
    }), M = l > I, E = r.useMemo(() => M ? o.slice(0, I - 1) : o, [o, M, I]), P = (0, R.bc)(E, i), D = M ? o[I - 1] : null, z = l - I + 1, [K, J] = r.useState(!1), Z = r.useCallback(e => {
        if (e && !v && o.length > 0) {
            let e = o.map(e => {
                let {
                    item: i
    ...
    }, [v, o, i.id, h]), V = (0, d.K)(Z, void 0, !v && !K), q = r.useMemo(() => new Set(o.map(e => {
        let {
            source: i
        } = e;
        return i
