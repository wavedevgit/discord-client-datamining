...
function G(e) {
    ...
    return (0, n.jsxs)(n.Fragment, {
        children: [(0, n.jsx)(c.AC4, {
            ...
            children: Array.from({
                length: t
            }, i ? (e, t) => (0, n.jsx)(M.O, {}, `placeholder-${t}`) : (e, t) => (0, n.jsx)(b.A, {
                cardSize: A.Y.SMALL
            }, `placeholder-${t}`))
        })]
    })
...
function D(e) {
    ...
    } = e, w = (0, T.G)("wishlist_banner"), j = s.useMemo(() => [...t, r].filter(e => null != e), [t, r]);
    return (0, n.jsx)("ul", {
        className: a()(B.Md, {
            [B.e6]: w
        }),
        children: w ? j.map((e, t) => {
            let {
                item: i,
                source: s
            } = e;
            ...
            children: [t.map((e, t) => {
                ...
                return (0, n.jsx)("li", {
                    ...
                    children: ((e, t) => {
                        ...
                        return r.shouldShow ? (0, R.Qc)(r) ? (0, n.jsx)(d.m, {
                            text: r.title,
                            position: "top",
                            asContainer: !0,
                            delay: x.Zh,
...
function z(e) {
    ...
    } = (0, m.Ay)(u.A.WISHLIST_BANNER), S = (0, T.G)("wishlist_banner"), C = (0, x.KQ)(S), {
        theme: A,
        primaryColor: b,
        secondaryColor: w
    } = (0, h.A)({
    ...
    }, [t.id]), k = s.useMemo(() => "loading" === _, [_]), M = s.useMemo(() => (0, y.K)({
        totalUnownedWishlistItemCount: o,
        wishlistInDmLength: C,
        displayItems: d
    }), [o, C, d]), E = v.Ay.getName(t), P = y.a[M], F = r?.getBannerURL({
        canAnimate: !1,
        size: 713
    }), z = o > C, Q = s.useMemo(() => z ? d.slice(0, C - 1) : d, [d, z, C]), Y = (0, R.bc)(Q, t), K = z ? d[C - 1] : null, X = o - C + 1, [q, $] = s.useState(!1), J = s.useCallback(e => {
        if (e && !k && d.length > 0) {
            let e = d.map(e => {
                let {
                    item: t
    ...
    }, [k, d, t.id, g]), Z = (0, l.K)(J, void 0, !k && !q), {
        includedTypes: V,
        includedSources: ee
    } = s.useMemo(() => ({
    ...
    return "error" === _ ? null : (0, n.jsxs)("div", {
        ...
        children: [null != F && (0, n.jsx)("div", {
            ...
            children: e => (0, n.jsxs)(n.Fragment, {
                children: [(0, n.jsx)(U, {
                    title: P.title,
                    subtitle: P.getSubtitle(E),
                    themeClass: e
                }), (0, n.jsx)("div", {
                    className: e,
                    children: k || 0 === d.length ? (0, n.jsx)(G, {
                        wishlistInDmLength: C
                    }) : (0, n.jsx)(D, {
                        items: Q,
                        hasOverflow: z,
...
function Q(e) {
    let {
        giftRecipient: t,
        onWishlistItemClick: i
    } = e, r = (0, T.G)("wishlist_banner_new_recommendations"), a = (0, f.Ay)(t?.id), {
...
let Y = function(e) {
    let {
        giftRecipient: t,
        onWishlistItemClick: i
    } = e, s = (0, T.G)("wishlist_banner"), r = (0, f.Ay)(t?.id), {
        displayItems: a,
