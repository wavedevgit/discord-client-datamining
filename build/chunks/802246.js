...
function z(e) {
    let {
        ...
        (0, g.openUserProfileModal)({
            userId: t.id,
            tabSection: P.RP.WISHLIST
        })
    }, [t.id]), M = s.useMemo(() => "loading" === _, [_]), R = s.useMemo(() => (0, y.K)({
        totalUnownedWishlistItemCount: o,
        wishlistInDmLength: A,
        displayItems: d
    }), [o, A, d]), H = v.Ay.getName(t), B = y.a[R], D = r?.getBannerURL({
        canAnimate: !1,
        size: 713
    }), z = o > A, Q = s.useMemo(() => z ? d.slice(0, A - 1) : d, [d, z, A]), K = (0, N.bc)(Q, t), X = z ? d[A - 1] : null, q = o - A + 1, [$, Z] = s.useState(!1), J = s.useCallback(e => {
        if (e && !M && d.length > 0) {
            let e = d.map(e => {
                let {
                    item: t
    ...
    }), [d]), ei = s.useCallback(() => ee.has(W.EZt.SOCIAL_LAYER_GAME_ITEM) ? (0, n.jsx)("div", {
        ...
        children: [null != D && (0, n.jsx)("div", {
            ...
            children: e => (0, n.jsxs)(n.Fragment, {
                children: [(0, n.jsx)(G, {
                    ...
                    className: e,
                    children: M || 0 === d.length ? (0, n.jsx)(F, {
                        wishlistInDmLength: A
                    }) : (0, n.jsx)(Y, {
                        items: Q,
                        hasOverflow: z,
