...
function Q(e) {
    ...
    } = e, i = (0, w.G)("wishlist_banner_loading_grid");
    return (0, n.jsxs)(n.Fragment, {
        children: [(0, n.jsx)(u.AC4, {
            children: G.intl.string(G.t.pfChQr)
        }), (0, n.jsx)("div", {
            className: a()(F.Md, {
                [F.e6]: i
            }),
            children: Array.from({
                length: t
            }, i ? (e, t) => (0, n.jsx)(M.O, {}, `placeholder-${t}`) : (e, t) => (0, n.jsx)(x.A, {
                cardSize: b.Y.SMALL
            }, `placeholder-${t}`))
        })]
    })
...
function z(e) {
    ...
    } = e, x = (0, w.G)("wishlist_banner"), j = s.useMemo(() => [...t, r].filter(e => null != e), [t, r]), O = (0, o.bG)([E.A, v.A], () => v.A.getChannel(E.A.getChannelId()));
    return (0, n.jsx)("ul", {
        className: a()(F.Md, {
            [F.e6]: x
        }),
        children: x ? j.map((e, t) => {
            let {
                item: i,
                source: s
            } = e;
            ...
            children: [t.map((e, t) => {
                ...
                return (0, n.jsx)("li", {
                    ...
                    children: ((e, t) => {
                        ...
                        return r.shouldShow ? (0, N.Qc)(r) ? (0, n.jsx)(c.m, {
                            text: r.title,
                            position: "top",
                            asContainer: !0,
                            delay: T.Zh,
...
function K(e) {
    ...
    } = (0, _.Ay)(m.A.WISHLIST_BANNER), S = (0, w.G)("wishlist_banner"), C = (0, T.KQ)(S), {
        theme: A,
        primaryColor: b,
        secondaryColor: x
    } = (0, p.A)({
    ...
    }, [t.id]), k = s.useMemo(() => "loading" === c, [c]), R = s.useMemo(() => (0, W.K)({
        totalUnownedWishlistItemCount: o,
        wishlistInDmLength: C,
        displayItems: d
    }), [o, C, d]), M = y.Ay.getName(t), v = W.a[R], E = r?.getBannerURL({
        canAnimate: !1,
        size: 713
    }), P = o > C, G = s.useMemo(() => P ? d.slice(0, C - 1) : d, [d, P, C]), Y = (0, N.bc)(G, t), K = P ? d[C - 1] : null, X = o - C + 1, [q, $] = s.useState(!1), J = s.useCallback(e => {
        if (e && !k && d.length > 0) {
            let e = d.map(e => {
                let {
                    item: t
    ...
    }, [k, d, t.id, h]), Z = (0, l.K)(J, void 0, !k && !q), V = s.useMemo(() => new Set(d.map(e => {
        let {
            source: t
        } = e;
        return t
    ...
    return "error" === c ? null : (0, n.jsxs)("div", {
        ...
        children: [null != E && (0, n.jsx)("div", {
            ...
            children: e => (0, n.jsxs)(n.Fragment, {
                children: [(0, n.jsx)(D, {
                    title: v.title,
                    subtitle: v.getSubtitle(M),
                    themeClass: e
                }), (0, n.jsx)("div", {
                    className: e,
                    children: k || 0 === d.length ? (0, n.jsx)(Q, {
                        wishlistInDmLength: C
                    }) : (0, n.jsx)(z, {
                        items: G,
                        hasOverflow: P,
...
function X(e) {
    let {
        giftRecipient: t,
        onWishlistItemClick: i
    } = e, r = (0, w.G)("wishlist_banner_new_recommendations"), a = (0, h.Ay)(t?.id), {
        ...
        source: null != d[e.id] && d[e.id][t.id] === R.j.WISHLIST ? T.uS.WISHLIST : T.uS.POPULAR
    })).filter(e => {
        let {
            item: t
        } = e;
...
let q = function(e) {
    let {
        giftRecipient: t,
        onWishlistItemClick: i
    } = e, s = (0, w.G)("wishlist_banner"), r = (0, h.Ay)(t?.id), {
        displayItems: a,
