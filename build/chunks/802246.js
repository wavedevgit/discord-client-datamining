...
function D(e) {
    ...
    return (0, r.jsxs)(r.Fragment, {
        children: [(0, r.jsx)(u.AC4, {
            children: W.intl.string(W.t.pfChQr)
        }), (0, r.jsx)("div", {
            className: s()(G.Md, G.e6),
            children: Array.from({
                length: i
            }, (e, i) => (0, r.jsx)(v.O, {}, `placeholder-${i}`))
        })]
    })
}
...
function U(e) {
    let {
        ...
        includedSources: d
    } = e, m = (0, _.bG)([O.A, N.A], () => N.A.getChannel(O.A.getChannelId())), p = n.useCallback(() => {
        o?.(), (0, u.s7G)()
    }, [o]);
    return (0, w.T)({
        ...
        children: i.map((e, i) => {
            ...
            return null == n || null == n.sku ? null : (0, r.jsx)("li", {
                className: G.XI,
...
function F(e) {
    let {
    ...
    } = (0, f.Ay)(p.A.WISHLIST_BANNER), w = (0, m.A)(() => (0, c.A)()), A = (0, T.H)("wishlist_banner"), {
        theme: j,
        primaryColor: L,
        secondaryColor: H
    } = (0, C.A)({
    ...
    }, [i.id]), W = n.useMemo(() => "loading" === _, [_]), F = y.Ay.getName(i), Q = (0, B.l7)({
        totalUnownedWishlistItemCount: l,
        ...
        canAnimate: !1,
        size: 713
    }), J = l > k.pl, K = n.useMemo(() => J ? o.slice(0, k.pl) : o, [o, J]), [Z, $] = n.useState(!1), z = n.useCallback(e => {
        if (e && !W && o.length > 0) {
            let e = o.map(e => {
                let {
                    item: i
    ...
    }, [W, o, i.id, I]), X = (0, d.K)(z, void 0, !W && !Z), Y = n.useMemo(() => new Set(o.map(e => {
        let {
            source: i
        } = e;
        return i
            ...
            children: [null != V && (0, r.jsx)("div", {
                ...
                children: e => (0, r.jsxs)(r.Fragment, {
                    children: [(0, r.jsx)(E, {
                        ...
                        className: e,
                        children: W || 0 === o.length ? (0, r.jsx)(D, {
                            wishlistInDmLength: k.pl
                        }) : (0, r.jsx)(S.dB, {
                            newValue: {
                    ...
                    }), null != g && !W && o.length > 0 ? (0, r.jsx)("div", {
                        className: e,
                        children: g
                    }) : null]
                })
