/** chunk id: 30875, original params: e,t,l (module,exports,require) **/
l.d(t, {
    $t: () => f,
    AX: () => c
...
function c(e) {
    let [t, l] = n.useState(null), [a, i] = n.useState(null);
    return n.useEffect(() => {
        if (null == e) return;
        let t = (0, r.Ux)(e);
...
function f(e, t, l) {
    let [i, o] = n.useState(null), [d, c] = n.useState(null), [f, h] = n.useState(1), {
        setMaxVolume: g
    } = (0, s.L)(), x = n.useCallback((e, t) => {
        var n;
        c(null), (n = t.offsetWidth, new Promise(t => {
            let i = (0, a.A)(),
                s = e => {
                    let {
                        data: {
