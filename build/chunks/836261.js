/** chunk id: 836261, original params: e,t,n (module,exports,require) **/
n.d(t, {
    A: () => E
});
var i = n(627968),
...
function f(e) {
    ...
    } = e, m = (0, c.Ut)(), h = (0, l.bG)([s.A], () => s.A.useReducedMotion), g = (0, p.Xf)({
        useReducedMotion: h
    }), {
    ...
    return (0, i.jsx)(r.$n, {
        ...
        children: (0, i.jsxs)("div", {
            className: x.t,
            children: [g.render(), A.intl.string(A.t.nPThNb)]
        })
    })
}
...
function C(e) {
    let {
        ...
        quest: t
    }), x = (0, _.vU)()?.getId(), C = (0, d.Vn)(t), E = (0, d.fc)(t), [I, b, T] = (0, d.Qo)(t, E);
    return C || I === o.X0.DESKTOP ? (0, i.jsx)(a.Button, {
        variant: "secondary",
        size: h,
        disabled: !0,
        text: A.intl.string(A.t["9KoPyB"]),
        fullWidth: !0
    }) : p && n === g.V3.QUEST_HOME_TILE_FOOTER ? (0, i.jsx)(a.Button, {
        size: h,
        variant: "secondary",
        onClick: () => {
            (0, m.se)({
...
let E = function(e) {
    ...
    return (0, h.g5)(t) && n === g.V3.QUEST_HOME_TILE_FOOTER ? (0, i.jsx)(C, {
        quest: t,
        surface: n,
        size: d,
        analyticsCtxQuestContent: l,
