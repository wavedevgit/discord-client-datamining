/** chunk id: 536664 params = (module,exports,require) **/
n.d(t, {
    A: () => R
});
var i = n(627968),
...
function R() {
    ...
    } = (0, A.A)(), n = e?.pid, l = (0, r.bG)([f.default], () => null == e || null == n ? null : f.default.getTrackedGameByPid(n), [e, n], a()), {
        enabledLegacy: R,
        enabledOOP: P
    ...
    let V = !(0, N.supportsLegacy)(),
        ...
        z = (t, n) => {
            ...
            switch (n) {
                case p.OverlayToggledClientSettingType.LEGACY_GAME:
                    k(t), c.A.toggleOverlay(e, t, D), i = !t && M;
                    break;
            ...
            }(i || s) && (0, E.L)(i ? p.OverlayToggledClientSettingType.LEGACY_GAME : p.OverlayToggledClientSettingType.OOP_GAME, e.id ?? null)
        },
        Y = V && B,
        X = !F && !H,
        K = !D && !F && M && !V,
        ...
        [ei, es] = (() => {
            switch (!0) {
                case q && J:
                    return [y.intl.format(y.t.hFVBIg, {
            ...
            children: (0, i.jsx)(d.dOG, {
                ...
                onChange: t => {
                    ((t, n) => {
                        ...
                        switch (n) {
                            case "game":
                                c.A.toggleOverlay(e, t, t), k(t), G(t), i = !t && M, s = !t && D;
                                break;
                            case "global":
                                u.A.setEnabled(t, t), i = !t && F, s = !t && H;
                                break;
                            case "both":
                                u.A.setEnabled(t, t), c.A.toggleOverlay(e, t, t), k(t), G(t), i = !t && F || !t && M, s = !t && H || !t && D
                        }
                        let l = null;
                        i ? l = "game" === n ? p.OverlayToggledClientSettingType.LEGACY_GAME : p.OverlayToggledClientSettingType.LEGACY : s && (l = "game" === n ? p.OverlayToggledClientSettingType.OOP_GAME : p.OverlayToggledClientSettingType.OOP), null != l && (0, E.L)(l, e.id ?? null)
                    })(t, ((e, t) => {
                        let n = !t && e,
                            i = !H && D,
                            s = !F && M,
        ...
        children: [(0, i.jsx)(I.A, {
            ...
            action: (0, i.jsxs)(i.Fragment, {
                children: [(0, i.jsx)(d.dOG, {
                    ...
                    disabled: B,
                    onChange: e => {
                        e && !H ? z(e, p.OverlayToggledClientSettingType.OOP) : z(e, p.OverlayToggledClientSettingType.OOP_GAME)
                    }
                }), (0, i.jsx)("div", {
                    className: O.Kz
                })]
            ...
            action: (0, i.jsxs)(i.Fragment, {
                children: [(0, i.jsx)(d.dOG, {
                    ...
                    disabled: V,
                    onChange: e => {
                        e && !F ? z(e, p.OverlayToggledClientSettingType.LEGACY) : z(e, p.OverlayToggledClientSettingType.LEGACY_GAME)
                    }
                }), (0, i.jsx)("div", {
                    className: O.Kz
                })]
