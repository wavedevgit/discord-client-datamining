...
function I(e) {
    let {
    ...
    } = (0, l.Ay)(), I = null != t, f = (0, a.bG)([c.Ay], () => null != t ? c.Ay.getMember(t, n.id) : null), x = (0, a.bG)([p.A], () => p.A.getPendingChanges(t ?? void 0).pendingAvatar), b = (0, s.V7)({
        userId: n.id,
        image: x
    }), {
        avatarSrc: v
        ...
        avatarOverride: b,
        size: r._3J.SIZE_56
    }), E = I ? f?.avatar : n.avatar, y = null != n.avatar, j = I && f?.avatar != null, T = null != x, S = null === x, C = (0, o.z5)(x, E), N = I && y, R = () => (0, d.XD)({
        uploadType: h.HL.AVATAR,
        analyticsSource: _,
        guildId: t ?? void 0,
        stackingBehavior: "stack"
    });
    if (!(S ? I && y : T || j || y)) return (0, i.jsx)(g.kL, {
        variant: "square",
        onClick: R,
