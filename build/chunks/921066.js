...
function p(e) {
    let {
        ...
        guild: n,
        usernameHook: i
    } = e, l = h(), r = (0, E.Ay)(t), s = i(r), c = (0, _.A)(t);
    return (0, a.jsxs)("div", {
        className: f.kL,
...
function x(e) {
    let {
        ...
        guild: n,
        usernameHook: i
    } = e, r = h(), s = (0, E.Ay)(t), c = i(s), d = l.useCallback(() => {
    ...
    return (0, a.jsxs)("div", {
        ...
        children: [(0, a.jsx)(m.A, {
            ...
            children: [(0, a.jsx)(o.Text, {
                variant: "text-md/semibold",
                className: f.DD,
                children: T.intl.format(T.t["/1IQGD"], {
                    username: s.nick,
                    usernameHook: c
                })
            }), (0, a.jsx)(o.Text, {
...
function S(e) {
    ...
    return t.hasFlag(I.pr7.IS_FIRST_BOOSTER) ? (0, a.jsx)(x, {
        message: t,
        guild: n,
        usernameHook: i
    }) : (0, a.jsx)(p, {
