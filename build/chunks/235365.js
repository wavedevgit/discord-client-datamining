...
let g = "orbs",
    A = e => {
        ...
        } = (0, o.Ay)(a), A = r.useRef(null), h = r.useRef(!1), {
            passesGeneralUIInvariant: x,
            programReward: R
        } = (0, c.F)({
            location: "PremiumTenureRewardsOrbsSection"
        });
        return x ? (0, n.jsx)(o.f5, {
            value: s,
            children: (0, n.jsx)(d.L, {
                innerRef: A,
                onChange: e => {
                    e && !h.current && (h.current = !0, u.default.track(m.HAw.PREMIUM_TENURE_REWARDS_ORBS_SECTION_IMPRESSION, {
