...
let A = "orbs",
    E = e => {
        ...
        } = (0, u.Ay)(n), f = a.useRef(null), N = a.useRef(!1), {
            passesGeneralUIInvariant: C,
            programReward: g
        } = (0, o.F)({
            location: "PremiumTenureRewardsOrbsSection"
        });
        return C ? (0, r.jsx)(u.f5, {
            value: E,
            children: (0, r.jsx)(i.L, {
                innerRef: f,
                onChange: e => {
                    e && !N.current && (N.current = !0, c.default.track(R.HAw.PREMIUM_TENURE_REWARDS_ORBS_SECTION_IMPRESSION, {
