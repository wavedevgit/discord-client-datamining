...
class f extends r.Ay.Store {
    ...
    async refresh() {
        var e, t;
        let n = await (null == (t = s.A.database()) || null == (e = t.fsInfo()) ? void 0 : e.catch(e => c.warn("couldn't get fs info", e)));
        if (null != n) {
    ...
    constructor() {
        ...
        }), l(this, "isLowDisk", !1), this.refresh(), this.waitFor(s.A), setInterval(() => this.refresh(), d)
    }
}
let p = new f