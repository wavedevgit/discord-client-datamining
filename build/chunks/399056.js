/** chunk id: 399056 params = (module,exports,require) **/
"use strict";
n.d(t, {
    A: () => A
});
...
function _(e) {
    let {
        ...
        if (null != t) return (0, r.mMO)(async () => {
            let {
                default: e
            } = await Promise.all([n.e("54569"), n.e("58203")]).then(n.bind(n, 251632));
            return n => (0, i.jsx)(e, {
                ...n,
                guildId: t,
                onSave: l
    ...
    return (0, i.jsxs)(r.DUT, {
        ...
        children: [(0, i.jsx)(r.U1e, {
            ...
            color: "none",
            children: m.intl.string(m.t.qce3EM)
        })]
    })
}
let A = function(e) {
    ...
    return (0, i.jsxs)("div", {
        ...
        children: [n.map((e, n) => (0, i.jsx)(u.A, {
            ...
            onDragReset: N,
            onDragComplete: E
        }, e.channelId)), (0, i.jsx)(h, {}), n.length < o._7 && (0, i.jsx)(_, {
            guildId: t,
            onAddAction: r
        })]
    })
