...
function b() {
    ...
    let e = f.getGuildId();
    I = E = x(f), null == E[T] && (T = e), l = null != C, i = c.r(f, C), N = null, p = !1, g = h.XlH.CLOSED, m.clear()
}
...
let y = new v(d.h, {
    ...
    CHANNEL_SETTINGS_PERMISSIONS_INIT: b,
    ...
    CHANNEL_SETTINGS_INIT: function() {
        u.A.getSection() === h.p_A.PERMISSIONS && b()
    },
    ...
    CHANNEL_SETTINGS_PERMISSIONS_SAVE_SUCCESS: function(e) {
        ...
        t ? g = h.XlH.OPEN : (g = h.XlH.CLOSED, b())
    },
