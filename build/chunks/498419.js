/** chunk id: 498419, original params: t (module,exports,require) **/ ! function() {
    var e = function(t) {
        "use strict";
        t = t || {};
        var e, o, n, r, i, a, s, c, l, f, u, h, d, y, w, p, g = {
            bgColor: "#d00",
            textColor: "#fff",
        ...
        x.ready = function() {
            ...
            c && (m = [], l = !1, f = !1, a.clearRect(0, 0, r, n), a.drawImage(s, 0, 0, r, n), I.setIcon(i), window.clearTimeout(y), window.clearTimeout(w))
        }, x.start = function() {
            if (c && !f) {
                var t = function() {
        ...
        I.getIcon = function() {
            var t = !1;
            return e.element ? t = e.element : e.elementId ? (t = p.getElementById(e.elementId)).setAttribute("href", t.getAttribute("src")) : !1 === (t = function() {
            ...
            if (e.dataUrl && e.dataUrl(n), e.element) e.element.setAttribute("href", n), e.element.setAttribute("src", n);
                ...
                var r = p.getElementById(e.elementId);
                r.setAttribute("href", n), r.setAttribute("src", n)
            } else if (d.ff || d.opera) {
                var i = o;
                o = p.createElement("link"), d.opera && o.setAttribute("rel", "icon"), o.setAttribute("rel", "icon"), o.setAttribute("type", "image/png"), p.getElementsByTagName("head")[0].appendChild(o), o.setAttribute("href", n), i.parentNode && i.parentNode.removeChild(i)
        ...
        S.duration = 40, S.types = {}, S.types.fade = [{
            ...
            h: .6,
            o: 1
        }], S.run = function(t, o, n, r) {
            var a = S.types[p.hidden || p.msHidden || p.webkitHidden || p.mozHidden ? "none" : e.animation];
            (r = !0 === n ? void 0 !== r ? r : a.length - 1 : void 0 !== r ? r : 0, o = o || function() {}, r < a.length && r >= 0) ? (b[e.type](C(t, a[r])), y = setTimeout(function() {
                n ? r -= 1 : r += 1, S.run(t, o, n, r)
            }, S.duration), I.setIcon(i)) : o()
        }, (e = C(g, t)).bgColor = R(e.bgColor), e.textColor = R(e.textColor), e.position = e.position.toLowerCase(), e.animation = S.types["" + e.animation] ? e.animation : g.animation, p = e.win.document;
        ...
        return e.type = b["" + e.type] ? e.type : g.type, o = I.getIcon(), i = document.createElement("canvas"), s = document.createElement("img"), o.hasAttribute("href") ? (s.setAttribute("crossOrigin", "anonymous"), s.onload = function() {
            n = s.height > 0 ? s.height : 32, r = s.width > 0 ? s.width : 32, i.height = n, i.width = r, a = i.getContext("2d"), x.ready()
        }, s.setAttribute("src", o.getAttribute("href"))) : (s.onload = function() {
            n = 32, r = 32, s.height = n, s.width = r, i.height = n, i.width = r, a = i.getContext("2d"), x.ready()
        }, s.setAttribute("src", "")), {
            badge: function(t, e) {
                e = ("string" == typeof e ? {
                    animation: e
                    ...
                    try {
                        if ("number" == typeof t ? t > 0 : "" !== t) {
                            ...
                            if ("animation" in e && S.types["" + e.animation] && (o.options.animation = "" + e.animation), "type" in e && b["" + e.type] && (o.options.type = "" + e.type), ["bgColor", "textColor"].forEach(function(t) {
                                    t in e && (o.options[t] = R(e[t]))
                ...
                u = function() {
                    try {
                        ...
                        s.setAttribute("crossOrigin", "anonymous"), s.onload = function() {
                            a.clearRect(0, 0, r, n), a.drawImage(s, 0, 0, r, n), I.setIcon(i)
                        }, s.setAttribute("src", t.getAttribute("src")), s.height = o / c, s.width = e / c
                    } catch (t) {
