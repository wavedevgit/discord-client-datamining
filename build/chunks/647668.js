...
function V(e) {
    let t, n, l, a, d, g, m, _, f, x, C, E, I, U, V, B, H, F, K, W, {
        ...
        z = Y.id,
        {
            ...
            return t.id
        }), ...Object.values(T.A.getThreadsForGuild(t)).flatMap(e => Object.keys(e))], [t]), l = (0, S.Ay)(t), a = s.useMemo(() => l.map(e => e.id), [l]), d = (0, c.bG)([D.Ay], () => D.Ay.getVoiceStates(t), [t]), g = (0, c.yK)([O.A], () => O.A.getBlockedOrIgnoredIDs()), m = o().flatMap(n, e => {
