...
class c extends i.Ay.PersistedStore {
    ...
    static migrations = [e => (Object.entries(e).forEach(t => {
        let [n, i] = t;
        e[n] = i
    }), e)];
    getState() {
...
let u = new c(l.h, {
    GUILD_POWERUPS_ACK_NOTIFICATION: function(e) {
        let {
            guildId: t
        } = e, n = s.A.getGuild(t)?.premiumSubscriberCount ?? 0, i = r.A.getStateForGuild(t), l = a.A.getStateForGuild(t), c = (0, o.k)([...Object.values(i?.unlockedPowerups ?? {}), ...Object.values(l?.entitlements ?? {})]);
        d = {
            ...d,
            [t]: {
