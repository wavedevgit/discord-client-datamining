...
function A(e, t, n) {
    let c, h, A = arguments.length > 3 && void 0 !== arguments[3] && arguments[3],
        _ = (c = (0, s.bG)([d.A], () => [e, d.A.getParticipantsVersion(e)], [e], o.D), h = (0, s.bG)([r.A], () => r.A.getSelectedParticipantId(e), [e]), i.useMemo(() => {
            let n = [],
                i = [],
                s = -1,
                a = [];
