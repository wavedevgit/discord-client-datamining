...
function h(e) {
    let {
        ...
        targetElementRef: n,
        dismissPopover: h
    } = e, _ = (0, o.c)(a.C.PREMIUM_TAB_POPOVER), m = null != _ && "premiumTabPopover" === _.properties.properties.oneofKind ? _.properties.properties.premiumTabPopover : null, p = (0, c.T)(m?.asset);
    if (null == m) return t;
