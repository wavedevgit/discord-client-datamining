...
function G(e) {
    let {
        ...
        snapshot: n,
        index: c
    } = e, _ = l.useMemo(() => new u.j(t, n, c), [t, n, c]), h = (0, r.bG)([S.A, M.default, P.A, R.A, L.A, m.A], () => _.getForwardInfo(S.A, M.default, P.A, R.A, L.A, m.A).footerInfo, [_], a.A), p = l.useCallback(() => {
