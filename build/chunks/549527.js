...
function G(e) {
    let {
        ...
        snapshot: n,
        index: c
    } = e, _ = a.useMemo(() => new u.j(t, n, c), [t, n, c]), h = (0, s.bG)([N.A, D.default, P.A, R.A, L.A, m.A], () => _.getForwardInfo(N.A, D.default, P.A, R.A, L.A, m.A).footerInfo, [_], r.A), p = a.useCallback(() => {
