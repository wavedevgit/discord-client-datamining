...
function G(e) {
    let {
        ...
        snapshot: n,
        index: c
    } = e, _ = a.useMemo(() => new u.j(t, n, c), [t, n, c]), h = (0, r.bG)([N.A, M.default, P.A, R.A, L.A, m.A], () => _.getForwardInfo(N.A, M.default, P.A, R.A, L.A, m.A).footerInfo, [_], s.A), p = a.useCallback(() => {
