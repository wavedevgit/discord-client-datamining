...
function B(e) {
    let {
        ...
        snapshot: n,
        index: c
    } = e, _ = r.useMemo(() => new u.j(t, n, c), [t, n, c]), h = (0, a.bG)([N.A, w.default, P.A, R.A, L.A, m.A], () => _.getForwardInfo(N.A, w.default, P.A, R.A, L.A, m.A).footerInfo, [_], s.A), p = r.useCallback(() => {
