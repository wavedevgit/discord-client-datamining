...
function y(e) {
    let {
        ...
        selected: n,
        handleClick: s
    } = e, d = (0, p.w)(t), m = (0, a.bG)([E.A], () => E.A.getGuild(t)), S = m?.features.has(N.GuildFeatures.ROLE_SUBSCRIPTIONS_AVAILABLE_FOR_PURCHASE) === !0, y = "false" === o.w.get(b.bJ, "false"), j = (0, a.bG)([u.A], () => u.A.useReducedMotion);
    return (0, i.jsx)(I.G, {
        id: `shop-${t}`,
        className: l()(v.A2, {
            [v.wH]: n,
