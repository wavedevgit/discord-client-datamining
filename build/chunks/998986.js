...
function y(e) {
    let {
        ...
        selected: n,
        handleClick: s
    } = e, d = (0, p.w)(t), m = (0, a.bG)([E.A], () => E.A.getGuild(t)), b = m?.features.has(N.GuildFeatures.ROLE_SUBSCRIPTIONS_AVAILABLE_FOR_PURCHASE) === !0, y = "false" === o.w.get(S.bJ, "false"), j = (0, a.bG)([u.A], () => u.A.useReducedMotion);
    return (0, i.jsx)(I.G, {
        id: `shop-${t}`,
        className: l()(v.A2, {
            [v.wH]: n,
        ...
        trailing: (0, i.jsxs)("div", {
            ...
            children: [j ? (0, i.jsx)(c.LpS, {
                ...
                className: v.b,
                onClick: e => {
                    e.stopPropagation(), (0, g.Dr)(r.M.SERVER_SHOP_PHANTOM_PREVIEW), C.default.track(N.HAw.GUILD_SHOP_PREVIEW_CLICK, {
                        ...(0, h.H$)(t),
    ...
    return l ? (0, i.jsx)(y, {
        ...
        onContextMenu: e => {
            null != t && (0, d.L3)(e, async () => {
                let {
                    default: e
                } = await n.e("74946").then(n.bind(n, 345332));
                return n => (0, i.jsx)(e, {
                    ...n,
                    guild: t
                })
