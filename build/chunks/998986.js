...
function y(e) {
    let {
        ...
        selected: n,
        handleClick: s
    } = e, d = (0, g.w)(t), m = (0, r.bG)([C.A], () => C.A.getGuild(t)), b = m?.features.has(N.GuildFeatures.ROLE_SUBSCRIPTIONS_AVAILABLE_FOR_PURCHASE) === !0, y = "false" === o.w.get(S.bJ, "false"), j = (0, r.bG)([u.A], () => u.A.useReducedMotion);
    return (0, i.jsx)(I.G, {
        id: `shop-${t}`,
        className: l()(v.A2, {
            [v.wH]: n,
        ...
        trailing: (0, i.jsxs)("div", {
            ...
            children: [j ? (0, i.jsx)(c.LpS, {
                ...
                className: v.b,
                onClick: e => {
                    e.stopPropagation(), (0, p.Dr)(a.M.SERVER_SHOP_PHANTOM_PREVIEW), E.default.track(N.HAw.GUILD_SHOP_PREVIEW_CLICK, {
                        ...(0, h.H$)(t),
