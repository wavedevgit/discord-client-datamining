...
function y(e) {
    let {
        ...
        selected: n,
        handleClick: s
    } = e, d = (0, m.YZ)(t, "guild_shop_channel_row"), p = (0, a.bG)([C.A], () => C.A.getGuild(t)), b = p?.features.has(N.GuildFeatures.ROLE_SUBSCRIPTIONS_AVAILABLE_FOR_PURCHASE) === !0, y = "false" === o.w.get(S.bJ, "false"), j = (0, a.bG)([u.A], () => u.A.useReducedMotion);
    return (0, i.jsx)(I.G, {
        id: `shop-${t}`,
        className: l()(v.A2, {
            [v.wH]: n,
...
function j(e) {
    let {
        guild: t,
        selected: s
    } = e, l = (0, p.P)(t, "guild_shop_channel_row"), a = () => {
