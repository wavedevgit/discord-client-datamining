...
function h(e) {
    let {
        ...
        claimableRewards: f
    } = (0, _.Pv)(), j = (0, a.bG)([E.default], () => E.default.getCurrentUser()), M = (0, a.yK)([p.A], () => p.A.getGiftPromotionRewardSkuIds()), R = (0, c.U)(f, A), [C, y] = l.useState(R), [N, O] = l.useState(!1);
    l.useEffect(() => {
        N || null != A || null == R || (g(R), y(R))
    }, [R, N, A, g]), s()(null != t, "Expected plan to selected"), s()(null != r, "Expected selectedSkuId"), s()(null != h, "Step should be set");
