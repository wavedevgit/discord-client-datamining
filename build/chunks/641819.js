...
function g(e) {
    let {
        handleStepChange: t
    } = e, n = (0, c.t4)(e => e.selectedSkuId), r = (0, d.A)(), g = (0, T.bB)(), {
        setSelectedGiftingPromotionReward: f,
        selectedGiftingPromotionReward: j,
        claimableRewards: R
    } = (0, I.Pv)(), M = (0, a.bG)([_.default], () => _.default.getCurrentUser()), C = (0, a.yK)([E.A], () => E.A.getGiftPromotionRewardSkuIds()), N = (0, m.U)(R, j), [O, k] = i.useState(N), [y, b] = i.useState(!1);
    i.useEffect(() => {
        y || null != j || null == N || (f(N), k(N))
    }, [N, y, j, f]), s()(null != r, "Expected plan to selected"), s()(null != n, "Expected selectedSkuId"), s()(null != g, "Step should be set");
