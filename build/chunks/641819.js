...
function g(e) {
    let {
        handleStepChange: t
    } = e, n = (0, S.t4)(e => e.selectedSkuId), r = (0, x.A)(), g = (0, T.bB)(), {
        setSelectedGiftingPromotionReward: f,
        selectedGiftingPromotionReward: j,
        claimableRewards: R
    } = (0, _.Pv)(), M = (0, a.bG)([E.default], () => E.default.getCurrentUser()), C = (0, a.yK)([p.A], () => p.A.getGiftPromotionRewardSkuIds()), N = (0, c.U)(R, j), [O, k] = i.useState(N), [y, b] = i.useState(!1);
    i.useEffect(() => {
