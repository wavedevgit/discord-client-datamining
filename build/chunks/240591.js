/** Chunk was on web.js **/
/** chunk id: 240591, original params: e,t,n (module,exports,require) **/
"use strict";
n.d(t, {
    Bh: () => m,
    MW: () => g,
...
function m(e, t) {
    var n, r, i, a, s;
    let p, h = null != (p = e instanceof c.YB && e.isThread() && null != (s = d.A.getChannel(e.parent_id)) ? s : e) ? O(p) : void 0,
        m = (0, l.S9)(),
        g = u.default.getId(),
        b = null != (n = null == (i = _.default.getCurrentUser()) ? void 0 : i.nsfwAllowed) && n,
        v = null != h && null != (r = null == (a = f.Ay.getMember(h, g)) ? void 0 : a.roles) ? r : [],
...
function y(e, t) {
    ...
    return i.zy(a, h.xBc.ADMINISTRATOR) ? (n = !0, r = !0) : e instanceof c.YB ? (n = i.zy(a, h.xBc.VIEW_CHANNEL) && i.zy(a, h.xBc.USE_APPLICATION_COMMANDS), r = t ? i.zy(a, h.xBc.SEND_MESSAGES_IN_THREADS) : i.zy(a, h.xBc.SEND_MESSAGES)) : (n = i.zy(a, h.xBc.VIEW_CHANNEL), r = !0), {
...
function b(e, t) {
    return e instanceof c.YB && (null == e ? void 0 : e.guild_id) == null ? (null == e ? void 0 : e.type) === h.rbe.DM && (null == e ? void 0 : e.getRecipientId()) === t ? s.OL.BOT_DM : s.OL.PRIVATE_CHANNEL : s.OL.GUILD
}
