...
var i = n(627968),
    ...
    e_ = n(870236),
    eg = n(487631);
let em = () => [l.M.CLIENT_THEMES_SETTINGS_BADGE, l.M.DEKSTOP_CUSTOM_APP_ICON_BADGE, l.M.CLIENT_THEMES_APPEARANCE_SETTINGS_NEW_BADGE],
    eA = () => {
        let e = em(),
            [t] = (0, x.kn)(e);
    ...
    eE = e => {
        ...
        return Object.freeze({
            ...
            [eo.H.ACCOUNT_AGE_GROUP]: {
                searchableTitles: [ec.intl.string(ec.t["/52UYy"]), ec.intl.string(ec.t.sK0dmH), ec.intl.string(ec.t.XxRj7f), ec.intl.string(ec.t.DVywUB), ec.intl.string(ec.t["9KiIz6"])],
                section: ed.nc_.ACCOUNT,
                parent: eo.H.ACCOUNT_PROFILE,
                predicate: () => eG
            },
