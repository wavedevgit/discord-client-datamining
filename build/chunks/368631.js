...
var i = n(627968),
    ...
    ec = n(842130),
    eu = n(945213);
let e_ = () => [l.M.CLIENT_THEMES_SETTINGS_BADGE, l.M.DEKSTOP_CUSTOM_APP_ICON_BADGE, l.M.CLIENT_THEMES_APPEARANCE_SETTINGS_NEW_BADGE],
    eg = () => {
        let e = e_(),
            [t] = (0, x.kn)(e);
    ...
    ep = e => {
        ...
        return Object.freeze({
            ...
            [ea.H.PRIVACY_SENSITIVE_MEDIA_V2]: {
                section: er.nc_.CONTENT_AND_SOCIAL,
                searchableTitles: [eo.intl.string(eo.t.uEz8JF), eo.intl.string(eo.t["N/oRI+"]), eo.intl.string(eo.t.QVdYsK), eo.intl.string(eo.t["aWD+tu"]), eo.intl.string(eo.t["5mnTa7"])],
                parent: ea.H.PRIVACY_AND_SAFETY_CONTENT_CATEGORY
            },
            [ea.H.SENSITIVE_CONTENT_FILTERS]: {
                section: er.nc_.CONTENT_AND_SOCIAL,
                searchableTitles: [eo.intl.string(eo.t["Hj/But"]), eo.intl.string(eo.t["N/oRI+"]), eo.intl.string(eo.t.QVdYsK), eo.intl.string(eo.t["aWD+tu"]), eo.intl.string(eo.t["5mnTa7"]), eo.intl.string(eo.t["K0OWP+"])],
                parent: ea.H.PRIVACY_AND_SAFETY_CONTENT_CATEGORY
            },
            [ea.H.SEXUALLY_EXPLICIT_MEDIA_REDACTION]: {
                section: er.nc_.CONTENT_AND_SOCIAL,
                searchableTitles: [eo.intl.string(eo.t["Hj/But"]), eo.intl.string(eo.t["N/oRI+"]), eo.intl.string(eo.t.QVdYsK), eo.intl.string(eo.t["aWD+tu"]), eo.intl.string(eo.t["5mnTa7"])],
                parent: ea.H.PRIVACY_AND_SAFETY_CONTENT_CATEGORY
            },
            [ea.H.GORE_MEDIA_REDACTION]: {
                section: er.nc_.CONTENT_AND_SOCIAL,
                searchableTitles: [eo.intl.string(eo.t["Hj/But"]), eo.intl.string(eo.t["N/oRI+"]), eo.intl.string(eo.t.QVdYsK), eo.intl.string(eo.t["aWD+tu"]), eo.intl.string(eo.t["K0OWP+"])],
                parent: ea.H.PRIVACY_AND_SAFETY_CONTENT_CATEGORY
            },
            [ea.H.PRIVACY_DIRECT_MESSAGE_SPAM_FILTER_V2]: {
                section: er.nc_.CONTENT_AND_SOCIAL,
                searchableTitles: [eo.intl.string(eo.t.JzaP4h), eo.intl.string(eo.t.H9XOl3), eo.intl.string(eo.t.k4W40P)],
                parent: ea.H.PRIVACY_AND_SAFETY_CONTENT_CATEGORY
            },
            ...
            [ea.H.LANGUAGE]: {
                ...
                searchableTitles: [eo.intl.string(eo.t.IHMsPn), eo.intl.string(eo.t.dyamEI), eo.intl.string(eo.t.p8NOwi), eo.intl.string(eo.t["+o/sOo"])],
            ...
            [ea.H.MERCHANDISE]: {
                ...
                onClick: () => {
                    ...
                    R.default.track(er.HAw.USER_SETTINGS_MERCH_LINK_CLICKED), (0, P.h)({
                        href: e,
                        shouldConfirm: !0,
                        onConfirm: () => {
