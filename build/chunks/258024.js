...
class I {
    ...
    constructor(e) {
        if (this.props = e, this.loading = e.messages.loadingMore, null != e.messages.jumpTargetId) this.pinned = !1;
        else {
            const t = A.A.isAtBottom(e.channel.id);
            this.pinned = t ?? !0, this.initialScrollTop = t ? null : A.A.getChannelDimensions(e.channel.id)?.scrollTop ?? null
        }
    }
    isReady() {
    ...
    mergePropsAndUpdate_(e) {
        ...
        let {
            offsetHeight: i,
            scrollHeight: l
        } = this.getScrollerState(), a = this.isHeightChange(i, l);
        ...
        if (null != o && n !== o) {
            ...
            if (null != e) return void this.ref.current?.scrollIntoViewNode({
                node: e,
    ...
    getAnchorData(e, t, n) {
        ...
        return null != n && (o = Math.max(-a, Math.min(n, o))), {
            id: e,
            offsetFromTop: o,
            offsetTop: r,
            offsetHeight: a,
    ...
    findAnchor() {
        let {
            ...
            scrollTop: l
        } = i, a = t && l >= this.newMessageBarBuffer() ? this.newMessageBarBuffer() : 0, s = null, r = t => -1 === t ? g.default.castChannelIdAsMessageId(n.id) : e._array[t]?.id, o = -1, c = !1;
        for (;;) {
            let t = r(o);
            if (null == t) break;
    ...
    findFetchAnchor(e) {
        let {
            ...
            scrollTop: n
        } = this.getScrollerState(), i = e ? -1 : 1, l = null, a = t._array.length - 1;
    ...
    fixAnchorScrollPosition() {
        ...
        null != this.focusAnchor ? (this.isPinned() ? this.scrollTo(Number.MAX_SAFE_INTEGER, !1, this.handleScroll) : this.mergeTo(n, this.handleScroll), this.ref.current?.scrollIntoViewNode({
            node: t,
            padding: E.mZ + this.props.additionalMessagePadding,
            callback: this.handleScroll
        })) : this.mergeTo(n, this.handleScroll), this.isActivelyScrolling() ? this.setAutomaticAnchor(null) : this.setAutomaticAnchor(this.findAnchor()), this.isLoading() || (this.messageFetchAnchor = null)
    }
    hasAnchor() {
    ...
    updateAutomaticAnchor(e) {
        ...
        t && null != i && null != this.automaticAnchor && (i.offsetFromTop = this.automaticAnchor.offsetFromTop), this.setAutomaticAnchor(i)
    }
    ...
    handleScroll = e => {
        ...
        if (this.handleFocusAnchorScroll(t.scrollTop, t.offsetHeight), this.updateStoreDimensionsDebounced(), this.isScrollLoadingDisabled()) return this.props.canLoadMore || this.enableAutomaticAck(), this.handleScrollSpeed(t);
    ...
    handleScrollSpeed(e) {
        ...
        let s = this.isInPlaceholderRegion(e),
            r = t - l;
        0 !== s && 0 !== r && (1 === s && t + r <= 0 ? (this.mergeTo(a - n), this.prevScrollTop = a - n) : 2 === s && t + r >= i - n && (this.mergeTo(i - a), this.prevScrollTop = i - a))
    }
    enableAutomaticAck() {
    ...
    fixJumpTarget() {
        ...
        if (null != e.jumpTargetId) {
            ...
            (0, s.vq)(i) ? this.scrollTo(this.getOffsetOrientationFromNode(i, "middle", t ? this.newMessageBarBuffer() : E.mZ), !0): this.scrollToNewMessages(!0, "middle")
    ...
    scrollToNewMessages() {
        ...
        this.pinned = !1, this.jumping = e, null != i ? this.scrollTo(this.getOffsetOrientationFromNode(i, t, this.newMessageBarBuffer()), e, l) : this.scrollTo(this.getOffsetToPreventLoading("top"), e, l)
    }
    getOffsetOrientationFromNode(e, t) {
        ...
        let l = this.getScrollerState(),
            a = (0, f.A)(e, i);
        return "middle" === t ? Math.min(a - .5 * l.offsetHeight + .5 * e.offsetHeight + -8, a - n) : a - n
    }
    restoreScroll() {
        if (this.isInitialized()) return;
        let {
    ...
    loadMore = (() => {
        var e = this;
        return function() {
            let t, n, i = arguments.length > 0 && void 0 !== arguments[0] && arguments[0],
                {
                    messages: l
                } = e.props;
            if (i) {
    ...
    scrollTo(e) {
        ...
        this.ref.current?.scrollTo({
            to: e,
            animate: !d.A.useReducedMotion && t,
            callback: n
    ...
    scrollPageUp() {
        let e = arguments.length > 0 && void 0 !== arguments[0] && arguments[0];
        this.ref.current?.scrollPageUp({
            animate: e
        })
    }
    scrollPageDown() {
        let e = arguments.length > 0 && void 0 !== arguments[0] && arguments[0];
        this.ref.current?.scrollPageDown({
            animate: e
        })
    }
    scrollToMessage(e) {
        ...
        let a = () => {
            this.jumping = !1, (0, s.vq)(l) && (l.tabIndex = -1, l.focus({
                preventScroll: !0
            })), this.scrollCounter = 0, this.handleScroll(), this._scrollCompleteCallbacks.forEach(e => e())
        };
        (0, s.vq)(l) ? this.scrollTo(this.getOffsetOrientationFromNode(l, "middle", this.props.hasUnreads ? this.newMessageBarBuffer() : E.mZ), n, a): this.scrollToNewMessages(n, "middle", a)
    }
...
function T(e) {
    ...
    return A.getSnapshotBeforeUpdate(s), i.useLayoutEffect(() => A.mergePropsAndUpdate({
        messages: t,
        channel: n,
        compact: l,
        hasUnreads: a,
        ...
        handleScrollFromBottom: d,
        additionalMessagePadding: h
    })), i.useLayoutEffect(() => () => A.cleanup(), [A]), A
}