...
function C(e) {
    ...
    if (!l && (null == h || null == (t = h.integration_types) ? void 0 : t.includes(r.b.GUILD_INSTALL)) || u && (null == h ? void 0 : h.inputType) !== c.y$.BUILT_IN_TEXT && (null == h ? void 0 : h.inputType) !== c.y$.BUILT_IN_INTEGRATION) return null != p && w(i, o.id, h, !0), null;
    if (null != p) {
        if (b.VW.isEditorEmpty(i) || null == h) return w(i, o.id, h, !1), null;
        let e = "".concat("/").concat(p.displayName);
        if (null == _ || !_.startsWith(e) || 0 === m.O7(i).length && (_.length < e.length + 1 || " " !== _[e.length])) return w(i, o.id, h, !0), null
    } else {
        if (null != h && d) {
            let e = N(i, o, s),
                t = m.SQ(i, h, o.id);
...
function N(e, t, n) {
    ...
    let d = (null != (r = null == (a = u.options) ? void 0 : a.length) ? r : 0) > 0 ? m.pY(e, u) : null,
        f = (0, E.WO)(b.VW.richValue(e), {
            ...
            range: {
                anchor: b.VW.start(e, []),
                focus: null != (i = null == d || null == (s = d[0]) ? void 0 : s.keyRange.anchor) ? i : b.VW.end(e, [])
            }
        }),
        p = "",
...
function D(e) {
    ...
    for (let e of r.options) {
        var m, g, E;
        let r = _[e.name],
            a = c || e.name === f && f !== i || (null == r || null == (g = r.lastValidationResult) ? void 0 : g.success) === !1 && (null == s ? void 0 : s[e.name]) !== (null == o ? void 0 : o[e.name]),
            l = {
