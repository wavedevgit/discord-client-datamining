...
class v extends s.Component {
    ...
    renderItems() {
        ...
        return null == e ? null : o().map(e, (e, s) => (0, i.jsx)(b, {
            project: s,
            overrideType: e.type,
            overrideId: e.id,
            disabled: t,
    ...
    renderRefreshButton() {
        return !this.state.didSave || this.isDirty() ? null : (0, i.jsx)(u.Button, {
            variant: "secondary",
            text: "Reload App",
    ...
    renderLinkButton() {
        ...
        return null == e || 0 === Object.keys(e).length ? null : (0, i.jsx)(c.m_, {
    ...
    render() {
        ...
        let l = !n && !t && this.getAvailableProjects().length > 0,
            a = I(s ?? {}) && "stable" !== window.GLOBAL_ENV.RELEASE_CHANNEL ? (0, i.jsx)(u.Text, {
                color: "text-feedback-critical",
...
class j extends s.Component {
    ...
    isMobile() {
        return I(this.props.buildOverrides ?? {})
    }
    renderSettingsForm() {
        let {
            ttlSeconds: e,
        ...
        return (0, i.jsxs)(u.BJc, {
            ...
            }) : null, this.isMobile() ? null : (0, i.jsx)(u.fs1, {
