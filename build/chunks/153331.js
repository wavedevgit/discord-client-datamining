...
function $(t) {
    let {
        ...
        return (0, M.A)(e) && (i = w.fg2.SPOTIFY), null != e.platform && [w.yTV.PS4, w.yTV.PS5].includes(e.platform) && (i = w.fg2.PLAYSTATION), i
    }({
        activity: e
    });
...
class z extends r.PureComponent {
    ...
    renderHeader(t) {
        ...
        null == n || this.props.enableUserHoverActivities || (e = (0, u.Lt)(o?.flags ?? 0, w.jUm.EMBEDDED) ? o.type === w.$pd.WATCHING ? F.intl.formatToPlainString(F.t["M/L8ot"], {
            guildName: n.name
        ...
        return p && (h = "text-xs/medium"), (0, l.jsxs)("div", {
            className: B.headerContainer,
            children: [(0, l.jsx)(m.Heading, {
                className: a()(!p && (t ? B.headerTextEmptyBody : B.headerTextNormal)),
    ...
    renderGameImage(t) {
        ...
        return null != t.assets || (0, U.A)(t) || t.type !== w.$pd.PLAYING || "ActivityFeed" === i || e.bot ? null : null == n && null != r ? (0, l.jsx)("div", {
    ...
    renderName(t) {
        ...
        let o = (0, R.A)(t),
            d = t.name,
            u = d;
        return (s === w.$pd.HANG_STATUS ? u = (0, x.Au)(e.id, t) : o && null != i ? u = (0, l.jsx)("span", {
    ...
    renderDetails(t) {
        ...
        return null == s || "" === s ? null : ((0, G.A)(t) && (s = F.intl.formatToPlainString(F.t.gmCZRY, {
            ...
            title: a ?? void 0,
            className: (0, G.A)(t) || (0, M.A)(t) ? B.detailsWrap : B.details,
            children: s
        })
    }
    renderChannelDetails(t) {
        ...
        return i && null != e ? null == n ? (0, l.jsx)("div", {
            ...
            className: a()((0, G.A)(t) || (0, M.A)(t) ? B.detailsWrap : B.details, B.guildDetails),
    ...
    renderTimePlayed(t) {
        ...
        if (!(0, R.A)(t) || (0, M.A)(t)) return null;
        let {
            timestamps: i
        } = t;
    ...
    renderState(t, e) {
        let i, {
            ...
            a = n,
            o = n;
        if (!(0, R.A)(t) && (a = s?.large_text, o = s?.large_text, (0, M.A)(t) && null != a)) {
        ...
        return null != a && "" !== a && t.type !== w.$pd.CUSTOM_STATUS || (0, j.Cy)(t) ? (r?.size == null && [H.I4].includes(t.application_id ?? "") ? i = F.intl.formatToPlainString(F.t["u//9By"], {
            count: "0",
    ...
    render() {
        ...
        let u = "ActivityFeed" === e,
            c = "StreamPreview" === e,
            p = !1;
        (0, b.A)(d) ? (t = this.renderXboxImage(), p = !0) : null == (t = this.renderImage(d)) && (p = null != (t = this.renderGameImage(d)));
        let h = this.renderName(d),
            ...
            v = ![t, h, A, g, f, C, E].some(t => null != t);
        return (0, l.jsxs)("div", {
            className: a()(this.getTypeClass("activity"), n),
            children: [this.renderHeader(v), (0, l.jsx)("div", {
                className: a()(p ? B.bodyAlignCenter : B.bodyNormal, this.props.enableUserHoverActivities && B.activityVoiceChannelUserHover),
                children: (0, l.jsxs)("div", {
                    className: B.activityDetails,
                    children: [t, this.isStreamerOnTypeActivityFeed() ? null : (0, l.jsxs)(T.A.Child, {
                        className: a()((0, P.t)(B, "content", p ? "GameImage" : null != t ? "Images" : "NoImages", e)),
