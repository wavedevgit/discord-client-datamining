...
let p = {
    ...
    T = {
        logitech: {
            ...
            modalSubtitle: {
                ...
                values: {
                    termsUrl: r.A.getArticleURL(_.MVz.LOGITECH_PROMOTION)
                }
            },
    ...
    S = e => {
        let {
            ...
            transitionState: n,
            onClose: a
        } = e, r = T[t], [o, m] = (0, l.yK)([c.A], () => {
            let {
                recurring: e,
                oneTime: n
            } = c.A.getPromotionsByPartner(t);
            return [e, n]
        }), {
            promotionsLoaded: _,
    ...
    b = e => {
        ...
        o.Ay.fetchActivePromotions(), (0, a.mMO)(async () => {
            let {
