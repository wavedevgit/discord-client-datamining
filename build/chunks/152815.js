...
let f = {
    ...
    S = {
        logitech: {
            ...
            modalSubtitle: {
                ...
                values: {
                    termsUrl: d.A.getArticleURL(A.MVz.LOGITECH_PROMOTION)
                }
            },
    ...
    E = e => {
        let {
            ...
            transitionState: n,
            onClose: a
        } = e, o = S[t], [d, c] = (0, l.yK)([m.A], () => {
            let {
                recurring: e,
                oneTime: n
            } = m.A.getPromotionsByPartner(t);
            return [e, n]
        }), {
            promotionsLoaded: _,
        ...
        return (0, i.jsx)(s.Modal, {
            ...
            children: (0, i.jsxs)("div", {
                className: T.kL,
                children: [d.length > 0 && (0, i.jsxs)(i.Fragment, {
    ...
    C = e => {
        ...
        o.default.track(A.HAw.THIRD_PARTY_PROMOTION_MODAL_OPENED, {
            partner_id: t
        }), c.Ay.fetchActivePromotions(), (0, a.mMO)(async () => {
            let {
                ThirdPartyPromotionsModal: e
