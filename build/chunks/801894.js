/** chunk id: 801894 params = (module,exports,require) **/
n.d(t, {
    A: () => s
});
var i = n(87075),
    ...
    return null == e ? {} : {
        ...
        ... function(e) {
            ...
            for (let [e, i] of Object.entries(t))
                if ("string" == typeof i) n[e] = {
                    type: a.o.STRING,
                    value: i
                };
                else if ("number" == typeof i) n[e] = {
                type: a.o.NUMBER,
                value: i
            };
        ...
        ... function(e) {
            ...
            if (null == t) return n;
            for (let e of t)
                if (e.type === i.f.STRING) n[e.name] = {
                    type: a.o.STRING,
                    value: e.value
                };
                else if (e.type === i.f.NUMBER) n[e.name] = {
                type: a.o.NUMBER,
                value: e.value
            };
