...
async function l(e, t) {
    ...
    return i = (n = await navigator.credentials.get(o)).response, s()(i instanceof AuthenticatorAssertionResponse, "WebAuthn: Cannot parse attestation response for assertion"), JSON.stringify({
...
async function a(e, t) {
    ...
    return i = (n = await navigator.credentials.create(o)).response, s()(i instanceof AuthenticatorAttestationResponse, "WebAuthn: Cannot parse assertion response for attestation"), JSON.stringify({
        authenticatorAttachment: n.authenticatorAttachment,
        clientExtensionResults: n.getClientExtensionResults(),
        id: n.id,
        rawId: r(n.rawId),
