...
let K = e => {
        let {
            selected: t
        } = e, n = (0, s.bG)([p.default], () => p.default.getCurrentUser()), i = (0, s.bG)([E.A], () => E.A.getPremiumTypeSubscription()), a = (0, y.V)(), l = (0, b.O)(), r = (0, T.cg)(), o = (0, k.H)(), d = (0, f.Of)(n, i), c = (0, s.bG)([C.A], () => C.A.getCreatedAtOverride()), u = t || null != a || null != l || r || null != o || d, A = null != c ? c : n?.createdAt;
    ...
    q = e => {
        let t, n, {
            ...
            eT = ee && e_ && !eC && null != eh,
            eN = null != ea && null != Z && Z.status === F.Dmq.CANCELED,
            {
                fractionalState: eS,
                startsAt: ex,
                endsAt: ev
            ...
            [eb, ey] = (0, m.Wl)(eS !== H.xc.NONE ? o.M.FRACTIONAL_NITRO_DURATION_LEFT_PILL : null, {
        ...
        let eF = () => {
            eb === o.M.FRACTIONAL_NITRO_DURATION_LEFT_PILL && ey(Y.i.TAKE_ACTION), I.default.track(F.HAw.NITRO_TAB_VISITED, {
                badge_decorator: n,
                has_premium: J
        ...
        let eY = eo && eM === o.M.PREMIUM_GROUP_POPOVER;
        if (eY) t = (0, i.jsx)(c.Exy, {
            ...
            isSelected: C,
            discountOffer: ea
        }), n = 8) : ep && eM === o.M.PREMIUM_ORBS_UPSELL_POPOVER || eT && eM === o.M.PREMIUM_ORBS_REWARDS_INTRO_POPOVER ? (t = (0, i.jsx)(c.Exy, {
            type: "new",
            variant: "expressive"
        ...
        let eW = (0, i.jsx)(u.z9, {
            ...
            eK = V.L.NONE;
        return eN && eM === o.M.CHURN_DISCOUNT_PREMIUM_TAB_COACHMARK && 8 === n ? eK = V.L.CHURN_DISCOUNT : eY ? eK = V.L.PREMIUM_GROUP : ep && eM === o.M.PREMIUM_ORBS_UPSELL_POPOVER ? eK = V.L.ORBS_UPSELL : eT && eM === o.M.PREMIUM_ORBS_REWARDS_INTRO_POPOVER ? eK = V.L.ORBS_INTRO : eC && eV === o.M.PREMIUM_ORBS_REWARDS_DROP_POPOVER ? eK = V.L.ORBS_DROP : eH && (eK = V.L.TOOLTIP), (0, i.jsx)(V.H, {
            popoverType: eK,
            targetElementRef: q,
