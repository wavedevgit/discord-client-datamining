...
let et = new Set([o.M.PREMIUM_WISHLIST_COACHMARK]),
    en = e => {
        let {
            selected: t
        } = e, n = (0, s.bG)([C.default], () => C.default.getCurrentUser()), i = (0, s.bG)([T.A], () => T.A.getPremiumTypeSubscription()), l = (0, U.V)(), a = (0, w.O)(), r = (0, b.cg)(), o = (0, z.H)(), d = (0, S.Of)(n, i), c = (0, s.bG)([x.A], () => x.A.getCreatedAtOverride()), u = t || null != l || null != a || r || null != o || d, A = null != c ? c : n?.createdAt;
        return u || null != n && null != A && Date.now() - A.getTime() > 12096e5
    },
    ei = e => {
        let t, n, x, {
                selected: ei,
                nitroTabButtonRef: el,
                route: ea,
                locationState: er,
                showHoverGradient: es,
                ...eo
            } = e,
            ...
            eC = (0, z.H)(),
            {
                shouldShowBonusOrbsUX: eT,
                dismissOrbMultiplierTabTooltip: eN,
                orbMultiplier: eS
            } = (0, p.p)(),
            ex = (0, Y.Tp)(),
            eb = (0, s.bG)([v.A], () => v.A.getReminderStateId()),
            ev = (0, F.c7)(),
            {
                programReward: ey,
                isEligible: eO
            ...
            e0 = [],
            e1 = [];
        (0, _.Tc)() && (ev && e0.push(o.M.RECURRING_3P_PROMOTION_POPOVER), eE && e0.push(o.M.BOGO_2025_NITRO_TAB_BADGE));
        ...
        if (ex) t = (0, i.jsx)(c.Exy, {
            ...
            t = (0, i.jsx)(H.A, {
                ...
                isDismissed: e
            }), n = 9, es = e3.properties.properties.premiumTab.showHoverGradient, e || (x = e3.properties.properties.premiumTab.deeplinkSection)
            ...
            variant: "expressive"
        }), n = 4) : null != eC ? (t = (0, i.jsx)(Q.A, {
            copy: eC,
            showStars: !1
        }), n = 1) : null != em ? (t = (0, i.jsx)(q.fY, {
            userDiscount: em,
            isTabSelected: ei,
            includesAmountOff: !1
        }), n = 3) : null == e_ || eJ ? eB ? (t = (0, i.jsx)(K.A, {
            isSelected: ei,
            discountOffer: eg
        }), n = 8) : eM && e9 === o.M.PREMIUM_ORBS_UPSELL_POPOVER || eV && e9 === o.M.PREMIUM_ORBS_REWARDS_INTRO_POPOVER || ek && ti === o.M.PREMIUM_ORBS_REWARDS_DROP_POPOVER ? (t = (0, i.jsx)(c.Exy, {
            type: "new",
            variant: "expressive"
        }), n = 2) : tr ? (t = (0, i.jsx)(c.Exy, {
            type: "new",
            variant: "expressive"
        }), n = 11) : ts ? (t = (0, i.jsx)(c.Exy, {
            type: "new",
            variant: "expressive"
        }), n = 12) : eH && e9 === o.M.PREMIUM_WISHLIST_COACHMARK ? (t = (0, i.jsx)(c.Exy, {
            type: "new",
            variant: "expressive"
        }), n = 13) : eT && (t = (0, i.jsx)(c.Exy, {
            type: "new",
            variant: "expressive"
        }), n = 14) : (t = (0, i.jsx)(q.Ag, {
            trialOffer: e_,
        ...
        let tu = $.L.NONE;
        tt === o.M.PREMIUM_MARKETING_MOMENT_REMINDER_UPSELL ? tu = $.L.MARKETING_MOMENT_POPOVER : eB && e9 === o.M.CHURN_DISCOUNT_PREMIUM_TAB_COACHMARK && 8 === n ? tu = $.L.CHURN_DISCOUNT : tc && !eD ? tu = $.L.PREMIUM_GROUP : tc && eD ? (tu = $.L.PREMIUM_GROUP_TOOLTIP, es = !0) : eM && e9 === o.M.PREMIUM_ORBS_UPSELL_POPOVER ? tu = $.L.ORBS_UPSELL : eV && e9 === o.M.PREMIUM_ORBS_REWARDS_INTRO_POPOVER ? tu = $.L.ORBS_INTRO : ek && ti === o.M.PREMIUM_ORBS_REWARDS_DROP_POPOVER ? tu = $.L.ORBS_DROP : ta ? tu = $.L.TOOLTIP : tr ? tu = $.L.L_PREMIUM_SUB_TOOLTIP : ts ? tu = $.L.L_UPSELL : ep || e_?.trial_id === X.Tt ? tu = $.L.REVERSE_TRIAL : eT && (tu = $.L.ORBS_MULTIPLIER);
        let tA = (0, i.jsx)(u.z9, {
            listItemRef: el,
            selected: ei,
            route: ea,
            ...
            text: (0, i.jsx)(d.A, {
                children: eA ? ee.intl.string(ee.t["4gwVVn"]) : ee.intl.string(ee.t.Ipxkog)
            }),
            locationState: er,
            onClick: () => {
                if (tr) {
                    let e = new URL(ea, window.location.origin);
                    e.searchParams.set(j.WU, D.LOGITECH_3PP_CARD_ID), (0, I.pX)(`${e.pathname}?${e.searchParams.toString()}`)
                } else if (null != x && "" !== x) {
                    let e = new URL(ea, window.location.origin);
