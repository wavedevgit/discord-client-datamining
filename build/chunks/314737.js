...
let W = c().throttle(p.dZ, 1e3),
    K = e => {
        ...
        }), o ? "respect-motion-settings" : "animate-never"), [f] = (0, h.zhh)(() => ({
            from: {
                opacity: 0
            },
            to: {
        ...
        }), o ? "respect-motion-settings" : "animate-never"), j = M.Ay.useUserTag(n.user);
        return (0, i.jsxs)("div", {
            ...
            children: [(0, i.jsx)("div", {
                ...
                className: V.AU,
                children: [null == l ? null : (0, i.jsx)(x.m, {
    ...
    Y = e => {
        ...
        return t ? (0, i.jsx)(h.y$y, {
            className: V.u1,
            type: h.y$y.Type.SPINNING_CIRCLE
        }) : 0 === s.length && 0 === l.length ? (0, i.jsxs)(h.ppr, {
            theme: r,
            className: V.Ie,
            children: [(0, i.jsx)(h.G8R, {
                darkSrc: n(223685),
                lightSrc: n(388547),
                width: 272,
                height: 212
    ...
    J = e => {
        ...
        } = e, o = s.useMemo(() => [...t].reverse(), [t]), {
            canManageGuildExpression: d
        } = (0, y.ie)(n), c = (0, g.bG)([R.A], () => R.A.theme);
        return 0 === t.length ? (0, i.jsx)(h.ppr, {
            theme: c,
    ...
    Z = e => {
        let t, n, s, {
            ...
            c = a.premiumTier,
            u = (0, D.ax)(c);
        return null == u || c === B.TVA.TIER_3 || d > 0 ? null : (d > o ? (t = H.intl.formatToPlainString(H.t.j0UH0m, {
            level: u
        }), n = H.intl.formatToPlainString(H.t.VQeyK6, {
            level: u
        }), s = B.ZSU.BOOST_UPSELL_BANNER_LOST_LEVEL) : (t = H.intl.string(H.t.zT9SxY), n = H.intl.formatToPlainString(H.t.dBZ1RU, {
            level: u
        }), s = B.ZSU.BOOST_UPSELL_BANNER_SLOTS_FULL), (0, i.jsx)(v.A, {
            header: t,
            text: n,
            guild: a,
            analyticsLocation: {
    ...
    q = () => {
        ...
        let J = s.useMemo(() => null == K ? new Set : new Set(c().differenceBy(x, K, "id").map(e => e.id)), [x, K]),
        ...
        return (0, i.jsxs)("div", {
            ...
            children: [0 === L ? null : (0, i.jsx)(f.A, {
                ...
                children: [(0, i.jsxs)(h.BJc, {
                    ...
                    guild: l,
                    staticEmojiCount: M,
                    animatedEmojiCount: z
                }), (0, i.jsxs)("div", {
                    className: V.xp,
                    children: [ei && (0, i.jsx)(h.po8, {
                        messageType: h.YCn.INFO,
                        children: H.intl.format(H.t.uMkfTo, {
                            onClick: () => k.A.open(l.id, B.BEX.ROLE_SUBSCRIPTIONS, void 0, B.nd0.ROLE_SUBSCRIPTION_EMOJI)
                        })
                    }), (0, i.jsx)(h.Button, {
