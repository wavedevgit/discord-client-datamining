...
function o(e) {
    let {
        guildIds: t,
        direction: i
    } = e, o = (0, n.useMemo)(() => (0, d.AB)(t), [t]), x = (0, a.bG)([r.A], () => r.A.getGuild(o[0])), h = i === d.AI.RESTRICTING ? u.intl.string(u.t.e6Kpa7) : u.intl.string(u.t.cy4G4y), j = x?.name ?? "", f = null != x && o.length > 1;
    return (0, s.jsxs)("div", {
        className: m.Nr,
