...
function ei(e) {
    ...
    for (let e of ("guild" === i.type && c.size > 0 && u.A.requestMembersById(i.guildId, [...c]), (0, w.Lz)(a.application_commands.map(e => eD(e, s)), !0))) {
...
class e_ extends(r = l.Ay.Store) {
    ...
    query(e, t, n) {
        ...
        n.allowFetch && (u && c && null != r && eN(r) && (v.default.track(x.HAw.APPLICATION_COMMAND_CACHE_FETCH, {
            ...
            type: "user"
        }), d = !0), ew(s) && null != n.applicationId && ((0, T.$)({
            type: "application",
...
function eg(e, t, n) {
    let [r, a] = i.useState(!0), s = (0, l.cf)([eh], () => "channel" === e.type ? eh.getContextState(e) : eh.getUserState());
    return i.useEffect(() => {
        if (r) {
...
function eT(e) {
    ...
    let {
        ...
        commandTypes: T
    } = c, N = null == _ ? void 0 : _.toLowerCase(), w = null == N ? void 0 : N.split(" "), R = h === C.n.ONLY_TEXT, P = h !== C.n.DENY ? (0, A.Ez)(T, !0, R) : [], x = [], L = {
        permissionContext: c,
        query: N,
        splitQuery: w,
        ...
        scoreMethod: O,
        installOnDemand: I
    }, M = null != (t = null == (r = u.result) ? void 0 : r.sections) ? t : {}, U = null != (n = null == (i = d.result) ? void 0 : i.sections) ? n : {}, G = new Set;
    if (g) {
    ...
    if (v.applications.useFrecency && m.bW.loadIfNecessary(), x.sort((e, t) => {
        ...
        let e = eC(A.gZ[D.Ik.BUILT_IN], P, !0, !0, L);
        null != e && x.push(e)
    }
...
function eN(e) {
    var t;
    return (null == e ? void 0 : e.guild_id) != null || e.type === x.rbe.DM && (null == (t = O.default.getUser(e.getRecipientId())) ? void 0 : t.bot) === !0
}
...
function eM(e, t, n, r, i) {
    ...
    for (let t of n) {
        let n;
        (i === C.M.COMMAND_ONLY || i === C.M.COMMAND_OR_APPLICATION) && (n = ek(t, e, c, u)), (void 0 === n || void 0 !== a && a < n) && (n = a), void 0 !== n && s.push(k(j({}, t), {
            score: n
        }))
    }
    return s
