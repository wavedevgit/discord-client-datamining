/** chunk id: 414711, original params: e,t,s (module,exports,require) **/
s.d(t, {
    A: () => m
});
var i = s(627968),
...
class A extends n.PureComponent {
    ...
    componentWillLeave(e) {
        l.A.parallel([l.A.timing(this.state.opacity, {
            toValue: 0,
            duration: 200
    ...
    componentWillEnter(e) {
        this.state.opacity.setValue(0), this.state.height.setValue(0), l.A.parallel([l.A.timing(this.state.opacity, {
            toValue: 1,
            duration: 200
        }), l.A.timing(this.state.height, {
    ...
    handleContextMenu = (e, t) => {
        this.setState({
            ...
            let {
                default: e
            } = await Promise.all([s.e("97262"), s.e("32418"), s.e("93382")]).then(s.bind(s, 668569));
            return s => (0, i.jsx)(e, {
                ...s,
                user: t
            })
