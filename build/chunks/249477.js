...
class eu extends r.PureComponent {
    ...
    componentDidUpdate(e) {
        ...
        if (e.voiceChannelId !== t && null != e.voiceChannelId) {
            ...
            l?.channelId !== e.voiceChannelId && (l = null), en.default.track(ea.HAw.LEAVE_VOICE_CHANNEL, {
        ...
        if (e.runningGame !== o && null != o && !o.isLauncher && (!p || T)) {
            let {
                gameId: e
            } = (0, b.wH)(o), l = void 0 !== e ? H.A.getDetectableGame(e) : null, a = y.Ay.getOverrideForGame(o), s = Y.A.getGuildIds(), u = V.JG.getSetting(), A = s.filter(e => !u.includes(e)).slice(0, 200), h = null;
        ...
        if ((e.videoEnabled !== l || e.isScreenSharing !== a) && null != t) {
            let e = "none",
                n = [a ? "screen" : null, l ? "camera" : null].filter(ei.Vq),
                i = null;
            a ? (e = "screen", i = (0, E.p)()) : l && (e = "camera"), en.default.track(ea.HAw.VIDEO_INPUT_TOGGLED, {
                video_input_type: e,
        ...
        if (m && null != A && (!e.connected || A !== e.selectedChannelId || _ !== e.selectedGuildId)) {
            ...
            if (null != t && null != n && null != i && i.publicUpdatesChannelId === t) {
                let e = K.A.getMessages(t),
                    r = e.toArray().reverse().find(e => (0, s.Lt)(e.flags, ea.pr7.IS_CROSSPOST) && e.messageReference?.guild_id === "667560445975986187");
...
function eA() {
    let [e, t] = (0, o.yK)([z.A], () => [z.A.getVoiceChannelId(), z.A.getChannelId()], []), n = (0, o.bG)([B.A], () => B.A.getChannel(t), [t]), l = (0, o.bG)([f.A], () => n?.id != null && f.A.getChatOpen(n.id), [n]), a = n?.nsfw, s = (0, o.bG)([B.A], () => B.A.getChannel(e), [e]), d = (0, o.bG)([$.A], () => $.A.getGuildId(), []), c = (0, o.bG)([Y.A], () => Y.A.getGuild(d), [d]), u = (0, o.bG)([Z.default], () => Z.default.getCurrentUser(), []), E = (0, o.bG)([F.Ay], () => null != u && null != d && (F.Ay.getMember(d, u.id)?.isPending ?? !1), [u, d]), I = (0, o.bG)([ee.Ay], () => ee.Ay.getState().section, []), C = (0, o.bG)([J.A], () => J.A.getHomeLink(), []), v = (0, o.bG)([O.A], () => O.A.isConnected(), []), [b, R] = (0, o.yK)([W.Ay], () => [W.Ay.isVideoEnabled(), W.Ay.isScreenSharing()], []), j = (0, o.bG)([Q.A], () => Q.A.getPrimaryActivity(), []), {
        currentGame: M,
        currentNonGame: w
    } = (0, o.cf)([y.Ay], () => ({
    ...
    return ! function(e) {
        ...
        r.useEffect(() => {
            ...
            n && null == o && l === ea.BVt.FRIENDS && (0, p.A)({
                tab_opened: i
            })
        }, [n, i, l, o]), r.useEffect(() => {
            if (n && null != o) {
        ...
        let d = r.useRef(!1);
        r.useEffect(() => {
            n && null == o && l === ea.BVt.MESSAGE_REQUESTS && !d.current && (d.current = !0, en.default.track(ea.HAw.MESSAGE_REQUESTS_INITIALIZED, {
