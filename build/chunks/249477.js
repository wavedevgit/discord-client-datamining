...
async function ed(e) {
    ...
    } = e, [h, _] = await Promise.all([(0, U.E1)(t.pid), b.Ay.canCollectExecutableFingerprintsForRunningGames() ? ea.Ay.getExecutableFingerprintForProcess(t.pid) : Promise.resolve(null)]), {
        gameName: m,
        gameId: p,
        exe: g,
        distributor: E,
        rawExePath: I
    } = (0, y.wH)(t), f = r.enabledLegacy || r.enabledOOP, C = M.x.legacyEnabled || M.x.oopEnabled, T = r.source;
...
async function ec(e) {
    ...
    } = e, s = b.Ay.canCollectExecutableFingerprintsForRunningGames() ? await ea.Ay.getExecutableFingerprintForProcess(t.pid) : null;
...
class eu extends r.PureComponent {
    ...
    componentDidUpdate(e) {
        ...
        if (e.voiceChannelId !== t && null != e.voiceChannelId) {
            ...
            a?.channelId !== e.voiceChannelId && (a = null), en.default.track(el.HAw.LEAVE_VOICE_CHANNEL, {
        ...
        if (e.voiceChannelId !== t && null != t) {
            ...
            null != c && w.default.getOverlayMethod(c) !== j.Ue.Disabled && (et.default.isInstanceLocked() ? d = el.Xmn.OVERLAY_LOCKED_ACTIVATED : et.default.isInstanceLocked() || (d = et.default.isPinned(el.uss.TEXT) ? el.Xmn.OVERLAY_UNLOCKED_PINNED : el.Xmn.OVERLAY_UNLOCKED)), en.default.track(el.HAw.JOIN_VOICE_CHANNEL, {
                location: d,
                channel_id: t,
                channel_type: i,
                channel_bitrate: r,
        ...
        if (e.runningGame !== o && null != o && !o.isLauncher && (!g || T)) {
            let {
                gameId: e
            } = (0, y.wH)(o), a = void 0 !== e ? H.A.getDetectableGame(e) : null, l = b.Ay.getOverrideForGame(o), s = Y.A.getGuildIds(), u = V.JG.getSetting(), A = s.filter(e => !u.includes(e)).slice(0, 200), h = null;
        ...
        if ((e.videoEnabled !== a || e.isScreenSharing !== l) && null != t) {
            let e = "none",
                ...
                i = null;
            l ? (e = "screen", i = (0, E.p)()) : a && (e = "camera"), en.default.track(el.HAw.VIDEO_INPUT_TOGGLED, {
                video_input_type: e,
        ...
        if (m && null != A && (!e.connected || A !== e.selectedChannelId || _ !== e.selectedGuildId)) {
            ...
            if (null != t && null != n && null != i && i.publicUpdatesChannelId === t) {
                let e = K.A.getMessages(t),
                    r = e.toArray().reverse().find(e => (0, s.Lt)(e.flags, el.pr7.IS_CROSSPOST) && e.messageReference?.guild_id === "667560445975986187");
...
function eA() {
    let [e, t] = (0, o.yK)([z.A], () => [z.A.getVoiceChannelId(), z.A.getChannelId()], []), n = (0, o.bG)([B.A], () => B.A.getChannel(t), [t]), a = (0, o.bG)([f.A], () => n?.id != null && f.A.getChatOpen(n.id), [n]), l = n?.nsfw, s = (0, o.bG)([B.A], () => B.A.getChannel(e), [e]), d = (0, o.bG)([$.A], () => $.A.getGuildId(), []), c = (0, o.bG)([Y.A], () => Y.A.getGuild(d), [d]), u = (0, o.bG)([Z.default], () => Z.default.getCurrentUser(), []), E = (0, o.bG)([F.Ay], () => null != u && null != d && (F.Ay.getMember(d, u.id)?.isPending ?? !1), [u, d]), I = (0, o.bG)([ee.Ay], () => ee.Ay.getState().section, []), C = (0, o.bG)([J.A], () => J.A.getHomeLink(), []), x = (0, o.bG)([O.A], () => O.A.isConnected(), []), [y, R] = (0, o.yK)([W.Ay], () => [W.Ay.isVideoEnabled(), W.Ay.isScreenSharing()], []), M = (0, o.bG)([Q.A], () => Q.A.getPrimaryActivity(), []), {
        currentGame: j,
        currentNonGame: w
    } = (0, o.cf)([b.Ay], () => ({
    ...
    return ! function(e) {
        ...
        r.useEffect(() => {
            n && null != s && ((0, h.zV)(el.HAw.CHANNEL_OPENED, {
                ...(0, m.p)(s),
                ...(0, h.qL)(s),
                selected_guild_id: o
            }), (0, p.A)({
                channelId: s
            }), t.current.isTextInVoice && (0, h.zV)(el.HAw.TEXT_IN_VOICE_OPENED, {
                channel_is_nsfw: t.current.isNSFWChannel
            }))
        }, [n, s, o]), r.useEffect(() => {
            n && null == o && a === el.BVt.FRIENDS && (0, g.A)({
                tab_opened: i
            })
        }, [n, i, a, o]), r.useEffect(() => {
            if (n && null != o) {
                ...
                if ((0, h.zV)(el.HAw.GUILD_VIEWED, i), (0, _.k)(el.HAw.GUILD_VIEWED_CLICKSTREAM, {
                        guild_id: o
                    }), (0, v.ai)(o)) {
                    let e = S.o.getConfig({
                            location: "ChatAutoAnalytics"
        ...
        let d = r.useRef(!1);
        r.useEffect(() => {
            n && null == o && a === el.BVt.MESSAGE_REQUESTS && !d.current && (d.current = !0, en.default.track(el.HAw.MESSAGE_REQUESTS_INITIALIZED, {
