...
async function ed(e) {
    ...
    } = e, [h, _] = await Promise.all([(0, U.E1)(t.pid), y.Ay.canCollectExecutableFingerprintsForRunningGames() ? el.Ay.getExecutableFingerprintForProcess(t.pid) : Promise.resolve(null)]), {
        gameName: m,
        gameId: g,
        exe: p,
        distributor: E,
    ...
    en.default.track(er.HAw.LAUNCH_GAME, {
        game: m,
        game_id: g,
        ...
        overlay_method: M.Ue[l] ?? (__OVERLAY__ ? M.Ue[M.Ue.Hook] : null),
...
async function ec(e) {
    let {
        ...
        voiceChannelGuildId: r
    } = e, s = y.Ay.canCollectExecutableFingerprintsForRunningGames() ? await el.Ay.getExecutableFingerprintForProcess(t.pid) : null;
    en.default.track(er.HAw.LAUNCH_NON_GAME_APPLICATION, {
        name: n.name,
        application_id: n.id,
...
class eu extends a.PureComponent {
    ...
    componentDidUpdate(e) {
        ...
        if (e.voiceChannelId !== t && null != e.voiceChannelId) {
            ...
            l?.channelId !== e.voiceChannelId && (l = null), en.default.track(er.HAw.LEAVE_VOICE_CHANNEL, {
        ...
        if (e.voiceChannelId !== t && null != t) {
            ...
            null != c && w.default.getOverlayMethod(c) !== M.Ue.Disabled && (et.default.isInstanceLocked() ? d = er.Xmn.OVERLAY_LOCKED_ACTIVATED : et.default.isInstanceLocked() || (d = et.default.isPinned(er.uss.TEXT) ? er.Xmn.OVERLAY_UNLOCKED_PINNED : er.Xmn.OVERLAY_UNLOCKED)), en.default.track(er.HAw.JOIN_VOICE_CHANNEL, {
                location: d,
                channel_id: t,
                channel_type: i,
                channel_bitrate: a,
        ...
        if (e.runningGame !== o && null != o && !o.isLauncher && (!p || T)) {
            let {
                gameId: e
            } = (0, b.wH)(o), l = void 0 !== e ? H.A.getDetectableGame(e) : null, r = y.Ay.getOverrideForGame(o), s = Y.A.getGuildIds(), u = V.JG.getSetting(), A = s.filter(e => !u.includes(e)).slice(0, 200), h = null;
        ...
        if ((e.videoEnabled !== l || e.isScreenSharing !== r) && null != t) {
            let e = "none",
                ...
                i = null;
            r ? (e = "screen", i = (0, E.p)()) : l && (e = "camera"), en.default.track(er.HAw.VIDEO_INPUT_TOGGLED, {
                video_input_type: e,
        ...
        if (m && null != A && (!e.connected || A !== e.selectedChannelId || _ !== e.selectedGuildId)) {
            ...
            if (null != t && null != n && null != i && i.publicUpdatesChannelId === t) {
                let e = K.A.getMessages(t),
                    a = e.toArray().reverse().find(e => (0, s.Lt)(e.flags, er.pr7.IS_CROSSPOST) && e.messageReference?.guild_id === "667560445975986187");
                en.default.track(er.HAw.ACK_COMMUNITY_MESSAGES, {
            ...
            }).collectAnalytics && en.default.track(er.HAw.TEXT_IN_VOICE_CLOSED, {
...
function eA() {
    let [e, t] = (0, o.yK)([z.A], () => [z.A.getVoiceChannelId(), z.A.getChannelId()], []), n = (0, o.bG)([B.A], () => B.A.getChannel(t), [t]), l = (0, o.bG)([f.A], () => n?.id != null && f.A.getChatOpen(n.id), [n]), r = n?.nsfw, s = (0, o.bG)([B.A], () => B.A.getChannel(e), [e]), d = (0, o.bG)([$.A], () => $.A.getGuildId(), []), c = (0, o.bG)([Y.A], () => Y.A.getGuild(d), [d]), u = (0, o.bG)([Z.default], () => Z.default.getCurrentUser(), []), E = (0, o.bG)([F.Ay], () => null != u && null != d && (F.Ay.getMember(d, u.id)?.isPending ?? !1), [u, d]), I = (0, o.bG)([ee.Ay], () => ee.Ay.getState().section, []), C = (0, o.bG)([J.A], () => J.A.getHomeLink(), []), v = (0, o.bG)([O.A], () => O.A.isConnected(), []), [b, R] = (0, o.yK)([W.Ay], () => [W.Ay.isVideoEnabled(), W.Ay.isScreenSharing()], []), j = (0, o.bG)([X.A], () => X.A.getPrimaryActivity(), []), {
        currentGame: M,
        currentNonGame: w
    } = (0, o.cf)([y.Ay], () => ({
    ...
    return ! function(e) {
        ...
        let d = a.useRef(!1);
        a.useEffect(() => {
            n && null == o && l === er.BVt.MESSAGE_REQUESTS && !d.current && (d.current = !0, en.default.track(er.HAw.MESSAGE_REQUESTS_INITIALIZED, {
