...
async function ed(e) {
    let {
        ...
        distributor: E,
        rawExePath: I
    } = (0, b.wH)(t), f = a.enabledLegacy || a.enabledOOP, C = M.x.legacyEnabled || M.x.oopEnabled, T = a.source;
...
class eu extends a.PureComponent {
    ...
    componentDidUpdate(e) {
        ...
        if (e.voiceChannelId !== t && null != t) {
            ...
            null != c && w.default.getOverlayMethod(c) !== j.Ue.Disabled && (et.default.isInstanceLocked() ? d = er.Xmn.OVERLAY_LOCKED_ACTIVATED : et.default.isInstanceLocked() || (d = et.default.isPinned(er.uss.TEXT) ? er.Xmn.OVERLAY_UNLOCKED_PINNED : er.Xmn.OVERLAY_UNLOCKED)), en.default.track(er.HAw.JOIN_VOICE_CHANNEL, {
                location: d,
                channel_id: t,
                channel_type: i,
                channel_bitrate: a,
...
function eA() {
    ...
    return ! function(e) {
        ...
        a.useEffect(() => {
            ...
            n && null == o && l === er.BVt.FRIENDS && (0, g.A)({
                tab_opened: i
            })
        }, [n, i, l, o]), a.useEffect(() => {
            if (n && null != o) {
