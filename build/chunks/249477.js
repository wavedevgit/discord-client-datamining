...
async function ed(e) {
    ...
    } = e, h = await (0, G.E1)(t.pid), {
        gameName: _,
        gameId: m,
        exe: p,
        distributor: g,
        rawExePath: E
    } = (0, b.wH)(t), I = l.enabledLegacy || l.enabledOOP, f = j.x.legacyEnabled || j.x.oopEnabled, C = l.source;
    ei.default.track(er.HAw.LAUNCH_GAME, {
        ...
        overlay_method: w.Ue[a] ?? (__OVERLAY__ ? w.Ue[w.Ue.Hook] : null),
    ...
    componentDidUpdate(e) {
        ...
        if (e.voiceChannelId !== t && null != e.voiceChannelId) {
            let t = y.Ay.getCurrentGameForAnalytics(),
                ...
                l = P.Ay.getActiveEventByChannel(e.voiceChannelId),
                a = z.A.getLastRTCConnectionState();
            a?.channelId !== e.voiceChannelId && (a = null), ei.default.track(er.HAw.LEAVE_VOICE_CHANNEL, {
        ...
        if (e.voiceChannelId !== t && null != t) {
            ...
            null != c && U.default.getOverlayMethod(c) !== w.Ue.Disabled && (en.default.isInstanceLocked() ? d = er.Xmn.OVERLAY_LOCKED_ACTIVATED : en.default.isInstanceLocked() || (d = en.default.isPinned(er.uss.TEXT) ? er.Xmn.OVERLAY_UNLOCKED_PINNED : er.Xmn.OVERLAY_UNLOCKED)), ei.default.track(er.HAw.JOIN_VOICE_CHANNEL, {
                location: d,
                channel_id: t,
                channel_type: i,
                channel_bitrate: l,
        ...
        if (e.runningGame !== o && null != o && !o.isLauncher && (!g || T)) {
            let {
                gameId: e
            } = (0, b.wH)(o), a = void 0 !== e ? F.A.getDetectableGame(e) : null, r = y.Ay.getOverrideForGame(o), s = W.A.getGuildIds(), u = B.JG.getSetting(), A = s.filter(e => !u.includes(e)).slice(0, 200), h = null;
            ...
            let _ = U.default.getTrackedGameByPid(o.pid),
                ...
                g = U.default.getOverlayMethod(o.pid) ?? p.overlayMethod;
            if (setTimeout(() => {
                ...
                }, 1e4), null != o.name && null != c && F.A.shouldReport(o)) {
                let e = o.name;
        ...
        if (e.runningNonGame !== u && u?.id != null && e.runningNonGame?.id !== u.id) {
            ...
            null != e && ei.default.track(er.HAw.LAUNCH_NON_GAME_APPLICATION, {
                name: e.name,
                application_id: e.id,
        ...
        if ((e.videoEnabled !== a || e.isScreenSharing !== r) && null != t) {
            let e = "none",
                n = [r ? "screen" : null, a ? "camera" : null].filter(el.Vq),
                i = null;
            r ? (e = "screen", i = (0, E.p)()) : a && (e = "camera"), ei.default.track(er.HAw.VIDEO_INPUT_TOGGLED, {
                video_input_type: e,
        ...
        if (m && null != A && (!e.connected || A !== e.selectedChannelId || _ !== e.selectedGuildId)) {
            ...
            if (null != t && null != n && null != i && i.publicUpdatesChannelId === t) {
                let e = q.A.getMessages(t),
                    l = e.toArray().reverse().find(e => (0, s.Lt)(e.flags, er.pr7.IS_CROSSPOST) && e.messageReference?.guild_id === "667560445975986187");
            ...
            }).collectAnalytics && ei.default.track(er.HAw.TEXT_IN_VOICE_CLOSED, {
...
function eu() {
    let [e, t] = (0, o.yK)([$.A], () => [$.A.getVoiceChannelId(), $.A.getChannelId()], []), n = (0, o.bG)([H.A], () => H.A.getChannel(t), [t]), a = (0, o.bG)([f.A], () => n?.id != null && f.A.getChatOpen(n.id), [n]), r = n?.nsfw, s = (0, o.bG)([H.A], () => H.A.getChannel(e), [e]), d = (0, o.bG)([Q.A], () => Q.A.getGuildId(), []), c = (0, o.bG)([W.A], () => W.A.getGuild(d), [d]), u = (0, o.bG)([J.default], () => J.default.getCurrentUser(), []), E = (0, o.bG)([Y.Ay], () => null != u && null != d && (Y.Ay.getMember(d, u.id)?.isPending ?? !1), [u, d]), I = (0, o.bG)([et.Ay], () => et.Ay.getState().section, []), C = (0, o.bG)([ee.A], () => ee.A.getHomeLink(), []), v = (0, o.bG)([O.A], () => O.A.isConnected(), []), [b, P] = (0, o.yK)([K.Ay], () => [K.Ay.isVideoEnabled(), K.Ay.isScreenSharing()], []), j = (0, o.bG)([X.A], () => X.A.getPrimaryActivity(), []), {
        currentGame: w,
        currentNonGame: U
    } = (0, o.cf)([y.Ay], () => ({
        currentGame: y.Ay.getCurrentGameForAnalytics(),
        currentNonGame: y.Ay.getCurrentNonGameForAnalytics()
    }), []), G = (0, L.A)(d), k = (0, o.bG)([M.A], () => M.A.getMessageRequestsCount(), []), V = {
        selectedChannelId: t,
        isNSFWChannel: r,
        selectedGuildId: d,
        friendsTabSection: I,
    ...
    return ! function(e) {
        ...
        l.useEffect(() => {
            ...
            n && null == o && a === er.BVt.FRIENDS && (0, g.A)({
                tab_opened: i
            })
        }, [n, i, a, o]), l.useEffect(() => {
            if (n && null != o) {
                let e = r ? {
                    ...
                    i = {
                        ...
                        premium_progress_bar_enabled: null != n && (0, R.$k)(n, {
                            location: "guild-view"
                        }),
                ...
                if ((0, h.zV)(er.HAw.GUILD_VIEWED, i), (0, _.k)(er.HAw.GUILD_VIEWED_CLICKSTREAM, {
                    ...
                    let e = S.o.getConfig({
                        ...
                        t = ea.Ay.isPremiumExactly(J.default.getCurrentUser(), eo.PremiumTypes.TIER_2),
                        n = (0, N.Kg)();
        ...
        let d = l.useRef(!1);
        l.useEffect(() => {
            n && null == o && a === er.BVt.MESSAGE_REQUESTS && !d.current && (d.current = !0, ei.default.track(er.HAw.MESSAGE_REQUESTS_INITIALIZED, {
