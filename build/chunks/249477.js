...
class eu extends a.PureComponent {
    ...
    componentDidUpdate(e) {
        ...
        if (e.runningGame !== o && null != o && !o.isLauncher && (!g || T)) {
            let {
                gameId: e
            } = (0, b.wH)(o), r = void 0 !== e ? H.A.getDetectableGame(e) : null, l = y.Ay.getOverrideForGame(o), s = Y.A.getGuildIds(), u = V.JG.getSetting(), A = s.filter(e => !u.includes(e)).slice(0, 200), h = null;
...
function eA() {
    ...
    return ! function(e) {
        ...
        a.useEffect(() => {
            ...
            n && null == o && r === el.BVt.FRIENDS && (0, g.A)({
                tab_opened: i
            })
        }, [n, i, r, o]), a.useEffect(() => {
            if (n && null != o) {
