...
async function ed(e) {
    ...
    } = e, [h, _] = await Promise.all([(0, U.E1)(t.pid), y.Ay.canCollectExecutableFingerprintsForRunningGames() ? ea.Ay.getExecutableFingerprintForProcess(t.pid) : Promise.resolve(null)]), {
        gameName: m,
        gameId: g,
        exe: p,
        distributor: E,
        rawExePath: I
    } = (0, v.wH)(t), f = l.enabledLegacy || l.enabledOOP, C = j.x.legacyEnabled || j.x.oopEnabled, T = l.source;
    en.default.track(er.HAw.LAUNCH_GAME, {
        game: m,
        game_id: g,
        verified: null != n && (0, v.PQ)(I, n?.executables),
        elevated: t.elevated,
        ...
        overlay_method: M.Ue[a] ?? (__OVERLAY__ ? M.Ue[M.Ue.Hook] : null),
...
async function ec(e) {
    ...
    } = e, s = y.Ay.canCollectExecutableFingerprintsForRunningGames() ? await ea.Ay.getExecutableFingerprintForProcess(t.pid) : null;
    en.default.track(er.HAw.LAUNCH_NON_GAME_APPLICATION, {
        ...
        current_user_status: Q.A.getStatus(),
        executable_path: (0, v.Ic)(t.exePath),
        voice_channel_id: i,
...
class eu extends l.PureComponent {
    ...
    componentDidUpdate(e) {
        ...
        if (e.voiceChannelId !== t && null != e.voiceChannelId) {
            ...
            a?.channelId !== e.voiceChannelId && (a = null), en.default.track(er.HAw.LEAVE_VOICE_CHANNEL, {
        ...
        if (e.runningGame !== o && null != o && !o.isLauncher && (!p || T)) {
            let {
                gameId: e
            } = (0, v.wH)(o), a = void 0 !== e ? H.A.getDetectableGame(e) : null, r = y.Ay.getOverrideForGame(o), s = Y.A.getGuildIds(), u = V.JG.getSetting(), A = s.filter(e => !u.includes(e)).slice(0, 200), h = null;
        ...
        if ((e.videoEnabled !== a || e.isScreenSharing !== r) && null != t) {
            let e = "none",
                ...
                i = null;
            r ? (e = "screen", i = (0, E.p)()) : a && (e = "camera"), en.default.track(er.HAw.VIDEO_INPUT_TOGGLED, {
                video_input_type: e,
...
function eA() {
    ...
    return ! function(e) {
        ...
        l.useEffect(() => {
            ...
            n && null == o && a === er.BVt.FRIENDS && (0, p.A)({
                tab_opened: i
            })
        }, [n, i, a, o]), l.useEffect(() => {
            if (n && null != o) {
        ...
        let d = l.useRef(!1);
        l.useEffect(() => {
            n && null == o && a === er.BVt.MESSAGE_REQUESTS && !d.current && (d.current = !0, en.default.track(er.HAw.MESSAGE_REQUESTS_INITIALIZED, {
