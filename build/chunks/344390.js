/** chunk id: 344390, original params: e,t,s (module,exports,require) **/
s.d(t, {
    V1: () => r
});
...
function r(e) {
    let t = function(e) {
        ...
        let s, r, i, {
            ...
            y = (t, s, r) => {
                let i = [];
                for (let n = 0; n < s; n++)
                    for (let l = +!n; l * s < t * (s - n); l++) i.push(((e[A + (S >> 1)] >> ((1 & S++) << 2) & 15) / 7.5 - 1) * r);
                return i
            },
            C = y(_, g, (d >> 18 & 31) / 31),
            ...
            I = p && y(5, 5, v),
            E = (s = (t = e)[3], r = 128 & t[2], ((i = 128 & t[4]) ? r ? 5 : 7 : 7 & s) / (i ? 7 & s : r ? 5 : 7)),
            N = c(E > 1 ? 32 : 32 * E),
            O = c(E > 1 ? 32 / E : 32),
        ...
        for (let e = 0, t = 0; e < O; e++)
            for (let s = 0; s < N; s++, t += 4) {
                let r = f,
                    ...
                    c = x,
                    d = j;
                for (let e = 0, t = a(_, p ? 5 : 3); e < t; e++) R[e] = o(n / N * (s + .5) * e);
                for (let t = 0, s = a(g, p ? 5 : 3); t < s; t++) M[t] = o(n / O * (e + .5) * t);
                for (let e = 0, t = 0; e < g; e++)
                    for (let s = +!e, i = 2 * M[e]; s * g < _ * (g - e); s++, t++) r += C[t] * R[s] * i;
    ...
    return function(e, t, s) {
        ...
        for (let e = 0, i = 0, l = r - 1; e < t; e++, l += r - 1)
            for (n.push(e + 1 < t ? 0 : 1, 255 & r, r >> 8, 255 & ~r, r >> 8 ^ 255, 0), o = (o + a) % 65521; i < l; i++) {
                let e = 255 & s[i];
