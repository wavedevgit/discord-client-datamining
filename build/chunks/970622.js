/** Chunk was on web.js **/
/** chunk id: 970622, original params: e,t,n (module,exports,require) **/
"use strict";
n.d(t, {
    A: () => m
}), n(896048), n(747238);
...
function p(e, t) {
    return null != t ? "".concat((0, o.M4)(e, t.join(d))) : e
}
...
function m(e) {
    ...
    let {
        focusPath: A
    } = b, [I, S] = r.useState(!1), [T, C] = r.useState(E), [{
        onItemFocusMemoizer: N,
        onItemMouseEnterMemoizer: w
    }] = r.useState(() => ({
        onItemFocusMemoizer: new o.Lp(e => () => {
            S(!0), O({
                type: i.g.SET_FOCUS_PATH,
                path: e.split(d)
            })
        }),
        onItemMouseEnterMemoizer: new o.Lp(e => () => {
            C(!1), O({
                type: i.g.SET_FOCUS_PATH,
                path: e.split(d)
            })
        ...
        switch (n) {
            ...
            case a.X2.NAVIGATE_OUT:
                e.preventDefault(), e.stopPropagation(), C(!0), v({
                    type: n
                });
                return;
            case a.X2.SELECT_FOCUSED_ITEM:
                ...
                if (e.preventDefault(), e.stopPropagation(), C(!1), v({
                        type: n
    ...
    }, []), x = r.useCallback(e => e.every((e, t) => A[t] === e), [A]), M = r.useCallback(() => ({
        role: "menu",
        id: t,
        tabIndex: -1,
        onKeyDown: R,
        ...
        onBlur: D,
        onMouseLeave: L,
        "aria-activedescendant": A.length > 0 ? (0, o.M4)(t, A.join(d)) : void 0
    }), [t, R, P, D, L, A]), j = r.useCallback(e => {
        let {
            path: n
        } = e;
        return {
            role: "menu",
            tabIndex: -1,
            "aria-activedescendant": x(n) ? (0, o.M4)(t, A.join(d)) : void 0,
            focusIndex: b.focusIndex,
            isUsingKeyboardNavigation: T
        }
    }, [t, A, x, b.focusIndex, T]), k = r.useCallback(e => {
        let {
            path: n,
            hasSubmenu: r = !1,
            navigable: i = !0,
