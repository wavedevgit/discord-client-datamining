/** chunk id: 382088 params = (module,exports,require) **/
a.d(t, {
    default: () => B
});
var n = a(627968),
...
function L(e) {
    ...
    return (0, n.jsx)(l.ExpressiveModal, {
        ...
        title: R.intl.formatToPlainString(o ? O.default["0Yxz12"] : O.default.UjA5k8, {
        ...
        actions: [{
            ...
            text: R.intl.string(O.default.odQeh3),
            onClick: T,
            variant: "expressive",
            icon: l.tvc,
            loading: m
...
function G(e) {
    ...
    switch (i) {
        case 1:
            t = R.intl.formatToPlainString(O.default["wMo6/n"], {
            ...
            break;
        case 2:
            t = R.intl.formatToPlainString(O.default["Um4ml+"], {
                premiumGroupProductName: o
            }), a = R.intl.string(O.default.Fm8iss);
            break;
        case 3:
            t = R.intl.string(O.default.yGTLxP), a = R.intl.formatToPlainString(O.default["7/qtoL"], {
                premiumGroupProductName: o
            });
            break;
        case 4:
            t = R.intl.formatToPlainString(O.default["S+UfpQ"], {
                premiumGroupProductName: o
            ...
            break;
        case 5:
            t = R.intl.formatToPlainString(O.default.anKEqI, {
                premiumGroupProductName: o
            }), a = R.intl.formatToPlainString(O.default["67BbUf"], {
                premiumGroupProductName: o
            });
            break;
        case 6:
            t = R.intl.formatToPlainString(O.default.VH7zHG, {
                premiumGroupProductName: o
            }), a = R.intl.string(O.default.s47Jqb);
            break;
        case 7:
            t = R.intl.formatToPlainString(O.default.agSoQJ, {
                premiumGroupProductName: o
            }), a = R.intl.formatToPlainString(O.default.YhJsq4, {
                premiumGroupProductName: o
            });
            break;
        default:
            t = R.intl.formatToPlainString(O.default["Kpg/uU"], {
                premiumGroupProductName: o
            }), a = R.intl.formatToPlainString(O.default.GrEzlX, {
                premiumGroupProductName: o
            })
    }
...
function B(e) {
    let {
        ...
        ...c
    } = e, [_, d] = (0, i.useState)(0), [u, f] = (0, i.useState)(null), S = (0, o.bG)([m.default], () => m.default.getCurrentUser());
