...
function $(e) {
    let {
        ...
        eV(null), ex(e)
    }, []), [eA, eS] = l.useState(!1), [eC, e_] = l.useState(!0), [eb, ey] = l.useState(!1), [eT, eN] = l.useState([]), [eD, eR] = l.useState(v.A.getEffectiveConnectionSpeed()), [eL, eI] = l.useState(0), [eM, ej] = l.useState(0), [ew, ek] = l.useState(!1), [eO, eP] = l.useState(!1), [eQ, eV] = l.useState(null), eU = l.useRef(!0), eB = l.useRef(null), eF = l.useRef(null), eG = (0, S.Kr)(e => e.videoProgress[q.id] ?? S.yc, u.x), e$ = (0, S.Kr)(e => e.setVideoProgress), eY = (0, S.Kr)(e => e.muted), eK = (0, S.Kr)(e => e.volume), eH = (0, c.bG)([f.A], () => f.A.useReducedMotion), eW = (0, l.useRef)(null), eq = (0, l.useRef)(null), ez = l.useRef(!0), eX = q.userStatus?.completedAt != null, eJ = l.useMemo(() => q.config.features.includes(V.Li.FULL_EPISODE_VIDEO_QUEST), [q.config.features]), eZ = l.useRef(!1), [e0, e1] = l.useState(null), [e6, e7] = l.useState(!1), [e2, e4] = l.useState(!1), [e8, e9] = l.useState(!1), [e3, e5] = l.useState(null), te = eX ? eW.current?.duration ?? 0 : Math.max(eG.maxTimestampSec, eh.progressSeconds), tt = l.useMemo(() => (0, C.L)({
        quest: q,
    ...
    let tb = l.useRef(null),
        ty = l.useCallback(() => {
            clearTimeout(tb.current), e9(!0), tb.current = setTimeout(() => {
                e9(!1)
            }, 1e3)
        }, []);
    l.useEffect(() => () => {
    ...
    let tZ = ec === w.Q6.ENDED,
        ...
        t7 = l.useMemo(() => null === (0, b.tW)(q, b.fY.VIDEO_PLAYER_TRANSCRIPT, void 0, !1), [q]),
        t2 = ee ? 20 : 12,
        t4 = 20 * !!ee,
        t8 = eX && eO;
    return (0, r.jsx)(m.DUT, {
        ...
        children: (0, r.jsxs)("div", {
            ...
            children: [tZ && (0, r.jsx)(R.A, {
                ...
                onLoadedMetadata: e => {
                    null != eW.current && (tt.info(`[QV] | handleLoadedMetadata | videoAssetId: ${ta}`), e7(!0), ta !== b.fY.VIDEO_PLAYER_VIDEO_HLS && tU(tn), eY ? eW.current.volume = 0 : eW.current.volume = eK)
                },
                onLoadStart: () => {
                ...
                children: [(0, r.jsx)(o.animated.div, {
                    ...
                    children: (0, r.jsx)(M.A, {
                        ...
                        onClick: e => {
                            t8 && (tU(e), ec === w.Q6.ENDED && tD(w.Q6.PLAYING))
                        },
                        onScrubBack: tQ,
                        onScrubForward: tV,
                        isQuestCompleted: eX,
