...
function K(e) {
    let {
    ...
    } = i.useContext(I.VideoQuestModalContext), et = (0, C.Kr)(e => e.transcriptEnabled), en = (0, C.Kr)(e => e.setTranscriptEnabled), er = (0, C.Kr)(e => e.captionEnabled), ei = (0, C.Kr)(e => e.setCaptionEnabled), {
        focused: es,
        focusedChanged: el
    } = (0, v.A7)(), {
        visible: ea,
        visibleChanged: eo,
        targetRef: eu
    } = (0, v.O7)(), [ec, ed] = i.useState(!0 === s ? w.Q6.PLAYING : w.Q6.PAUSED), [em, ep] = i.useState(!1), [eE, ef] = i.useState(!1), ev = (0, N.Yh)(q), [eh, ex] = i.useState(ev.percentComplete), eg = i.useCallback(e => {
        eQ(null), ex(e)
        ...
        location: U.rE.VIDEO_MODAL
    }), [tn, tr] = i.useState(w.oA.MD), ti = {
        [w.oA.MD]: tt ? 56 : 50,
        [w.oA.LG]: tt ? 64 : 58
    };
    (0, p.u5)(() => {
        eq.current && (eq.current = !1, eL(h.A.getEffectiveConnectionSpeed()), eX && eG.timestampSec >= eG.duration && e$(q.id, 0, eG.duration))
    });
    let {
        videoAsset: ts,
        videoAssetType: tl,
    ...
    let t_ = i.useCallback(() => ez.current?.currentTime ?? null, []),
        ...
        tT = i.useCallback(e => {
            if (e5.info(`[QV] | updatePlayerState | playerState: ${e}`), ed(e), null != ez.current) switch (e) {
                case w.Q6.PLAYING:
    ...
    let ty = i.useCallback(e => {
        eX || q.userStatus?.enrolledAt == null || (e5.info(`[QV] sendServerProgressUpdate: ${e}`), (0, D.zv)(q, e)), td()
    }, [eX, q, e5, td]);
    i.useEffect(() => {
        K !== m.ip4.HIDDEN && K !== m.ip4.EXITING && K !== m.ip4.EXITED && (null == K || !eo || ea || eX) && (!el || es || eX) || null == ez.current || ec !== w.Q6.PLAYING || (e5.info(`[QV] | Pausing video | playerState: ${ec}, parentTransitionState: ${K}, visible: ${ea}, focused: ${es}, isQuestCompleted: ${eX}`), tT(w.Q6.PAUSED), eX || e1(S.Yg.LOST_FOCUS))
    }, [K, es, el, ea, eo, ec, eX, tT, ty, e5]);
    let [tN, tD] = i.useState(!1), tL = i.useRef(null), tj = i.useRef(performance.now()), tI = i.useCallback(() => {
        null != tL.current && clearTimeout(tL.current), ec !== w.Q6.PLAYING || (tL.current = setTimeout(() => {
    ...
    let tk = !tN && (eE || em || ec === w.Q6.ENDED),
        ...
        tw = () => {
            ...
            e5.info(`[QV] | handleSeekBackIncrement | newTime: ${e}`), tP(e), ec === w.Q6.ENDED && tT(w.Q6.PAUSED), tf(S.uF.VIDEO_MODAL, y.Cy.SEEK_BACKWARD)
        },
        tO = () => {
            if (null == ez.current || !tZ) return;
            let e = Math.min(ez.current.currentTime + 10, e3);
            e5.info(`[QV] | handleSeekForwardIncrement | newTime: ${e}`), tP(e), ec !== w.Q6.ENDED && e >= ez.current.duration && tT(w.Q6.ENDED), tf(S.uF.VIDEO_MODAL, y.Cy.SEEK_FORWARD)
        };
    i.useEffect(() => {
        let e = ez.current;
        return () => {
    ...
    let tP = i.useCallback(e => {
        null != ez.current && (e5.info(`[QV] | seekTimeline | timeSec: ${e}`), eQ(e / (ez.current.duration ?? 1) * 100), tb(), eC(!0), e4(!1), ez.current.currentTime = e, e$(q.id, e, ez.current.duration))
    }, [ez, e$, q.id, tb, e5]);
    i.useEffect(() => {
        let e = ez.current;
        if (null == e) return;
    ...
    let tV = () => {
            if (null != ez.current) switch (e5.info(`[QV] | handlePlaybackBtnClick | playerState: ${ec}`), ec) {
                case w.Q6.ENDED:
        ...
        tB = i.useCallback(() => {
            if (null == ez.current || (e5.info(`[QV] | handleTracksLoaded: textTracks.length: ${ez.current.textTracks.length}`), 0 === ez.current.textTracks.length)) return;
    ...
    let tF = i.useCallback(e => {
            e5.info(`[QV] | logVideoError: errorType: ${e}, videoProgress: ${ez.current?.currentTime}, videoAssetId: ${tl}, connectionSpeed: ${eD}`), tC(e)
        }, [eD, tC, ez, tl, e5]),
        tG = i.useRef(!1);
    i.useEffect(() => {
    ...
    let t$ = e => {
        e5.info(`[QV] | handleCanPlay: playerState: ${ec}`), null != ez.current && ec === w.Q6.PLAYING && (e5.info("[QV] | handleCanPlay: did NOT early return"), eA && (e5.info(`[QV] | handleCanPlay: loadingFirstChunk: ${eA}`), e_(!1)), eb && (e5.info(`[QV] | handleCanPlay: waitingForChunk: ${eb}`), th(null != eF.current ? performance.now() - eF.current : null), eT(!1)), e5.info("[QV] | handleCanPlay: updating player state to playing"), tT(w.Q6.PLAYING))
    };
    i.useEffect(() => {
        if (!eS) return;
        let e = setTimeout(() => {
    ...
    i.useEffect(() => (tW({
        captionHeightSpring: er && null != e9 ? tH.current?.clientHeight ?? 0 : 0,
        immediate: eH
    }), () => {
        tz.stop()
    }), [er, tW, eH, e9, tz]), i.useEffect(() => (tY({
        controlBarAnimSpring: tk || eR ? 1 : 0,
        immediate: eH
    }), () => {
        tK.stop()
    }), [tk, tY, eH, eR, tK]);
    ...
    return (0, r.jsx)(m.DUT, {
        ...
        children: (0, r.jsxs)("div", {
            ...
            style: {
                "--custom-footer-bottom": `${tt?4:2}px`
            },
            children: [tq && (0, r.jsx)(j.A, {
                videoRef: ez,
                onExitFullScreen: tR,
                ...
                onTimeUpdate: e => {
                    ...
                    if (ez.current.currentTime >= ej || r) {
                        var i;
                        e5.info(`[QV] | handleTimeUpdate: capturing server time update: currentTime: ${ez.current.currentTime}`), (i = ez.current.currentTime) >= t && (eZ.current = !0), eI(i + 6 + 2 * Math.random()), ty(i)
                    }
                    ez.current.currentTime >= eM && (ek(ez.current.currentTime + 1), (0, g.Gn)(q.id, ev.taskType, ez.current.currentTime), n(ez.current.currentTime)), e$(q.id, ez.current.currentTime, ez.current.duration), eg(ez.current.currentTime / ez.current.duration * 100)
                },
                onEnded: e => {
                    null != ez.current && (ty(ez.current.duration + 1), e5.info(`[QV] | handleEnded: sending progress update: ${ez.current.duration+1}`), e$(q.id, ez.current.duration, ez.current.duration)), tT(w.Q6.ENDED), eT(!1)
                },
                onLoadedData: e => {
                ...
                onWaiting: e => {
                    eF.current = performance.now(), e5.info(`[QV] | handleWaitingForData: bufferingStartTime: ${eF.current}`), tv(), eT(!0)
                },
                onProgress: e => {
                    if (null == ez.current) return;
                ...
                children: [null != tJ && (0, r.jsx)("track", {
                    ...
                    srcLang: "en",
                    default: !0
                }), null != ts && tl !== T.fY.VIDEO_PLAYER_VIDEO_HLS && null != ts.mimetype && (0, r.jsx)("source", {
                    onError: () => tF(w.SB.SOURCE_ERROR),
                    src: ts.url,
                    type: ts.mimetype
                })]
            }), (eA || eb) && ec === w.Q6.PLAYING && null != ts && (0, r.jsx)("span", {
                className: G.S,
                ...
                children: [(0, r.jsx)(M.A, {}), (0, r.jsx)(m.K0, {
                ...
                children: [(0, r.jsx)(m.DUT, {
                    ...
                    style: {
                        marginBottom: (0, o.to)([tK, tz], (e, t) => `${e*ti[tn]+t}px`)
                    },
            ...
            }, ec), er && null != e9 && !tq && (0, r.jsx)(o.animated.div, {
                className: G.o$,
                ref: tH,
                ...
                children: [(0, r.jsx)(o.animated.div, {
                    ...
                    style: {
                        paddingTop: (0, o.to)([tK.to({
                            range: [0, 1],
                            output: [0, 1]
                        })], e => `${e*e*t1}px`),
                        paddingBottom: (0, o.to)([tK.to({
                            range: [0, 1],
                            output: [0, 1]
                        })], e => `${e*e*12}px`),
                        pointerEvents: (0, o.to)([tK.to({
                            range: [0, 1],
                            output: [0, 1]
                        })], e => e < .3 ? "none" : "auto")
                    },
                    ...
                    children: (0, r.jsx)(L.A, {
                        ...
                        handleTranscriptBtnClick: () => {
                            en(!et), tf(S.uF.VIDEO_MODAL, et ? y.Cy.TRANSCRIPT_DISABLE : y.Cy.TRANSCRIPT_ENABLE)
                        },
                        handleCaptionBtnClick: () => {
                            ei(!er), tf(S.uF.VIDEO_MODAL, er ? y.Cy.CLOSED_CAPTIONING_DISABLE : y.Cy.CLOSED_CAPTIONING_ENABLE)
                        },
                        handleFullScreenBtnClick: () => {
                            let e = !Z;
                            e5.info(`[QV] | handleFullScreenButtonClick | shouldBeEnabled: ${e}`);
                            let t = (0, x.qf)(ez.current?.parentNode, ez.current);
                            e && null != t ? ((0, x.tl)(t), t.addEventListener(x.Wb, tR), tS(!0), tr(w.oA.LG)) : e || null == t || (t.removeEventListener(x.Wb, tR), tS(!1), (0, x.sP)(t), tr(w.oA.MD)), ee(e)
                        },
