...
function K(e) {
    ...
    }, a.x), eW = (0, g.Kr)(e => e.setVideoProgress), eq = (0, g.Kr)(e => e.muted), ez = (0, g.Kr)(e => e.volume), eX = (0, c.bG)([p.A], () => p.A.useReducedMotion), eZ = (0, l.useRef)(null), eJ = (0, l.useRef)(null), e$ = l.useRef(!0), e0 = (null == (K = ee.userStatus) ? void 0 : K.completedAt) != null, e1 = l.useMemo(() => ee.config.features.includes(Q.Li.FULL_EPISODE_VIDEO_QUEST), [ee.config.features]), e6 = l.useRef(!1), [e2, e7] = l.useState(null), [e4, e9] = l.useState(!1), [e8, e3] = l.useState(!1), [e5, te] = l.useState(null), tt = e0 ? null != (t = null == (G = eZ.current) ? void 0 : G.duration) ? t : 0 : Math.max(eY.maxTimestampSec, eh.progressSeconds), tn = l.useMemo(() => (0, h.L)({
        quest: ee,
