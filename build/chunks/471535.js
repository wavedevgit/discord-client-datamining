...
function G(e) {
    let {
    ...
    } = l.useContext(R.VideoQuestModalContext), ee = (0, A.Kr)(e => e.transcriptEnabled), et = (0, A.Kr)(e => e.setTranscriptEnabled), en = (0, A.Kr)(e => e.captionEnabled), er = (0, A.Kr)(e => e.setCaptionEnabled), {
        focused: el,
        focusedChanged: ei
    } = (0, h.A7)(), {
        visible: es,
        visibleChanged: ea,
        targetRef: eo
    } = (0, h.O7)(), [eu, ec] = l.useState(!0 === i ? I.Q6.PLAYING : I.Q6.PAUSED), [ed, em] = l.useState(!1), [ep, ef] = l.useState(!1), eE = (0, y.Yh)(z), [eh, ev] = l.useState(eE.percentComplete), ex = l.useCallback(e => {
        eQ(null), ev(e)
    ...
    }), [z]), tt = (0, d.g)(eq, eF, eE.progressSeconds), [tn, tr] = l.useState(I.oA.MD), tl = {
        [I.oA.MD]: Z ? 56 : 50,
        [I.oA.LG]: Z ? 64 : 58
    };
    (0, p.u5)(() => {
    ...
    l.useEffect(() => {
        G !== m.ip4.HIDDEN && G !== m.ip4.EXITING && G !== m.ip4.EXITED && (null == G || !ea || es || eq) && (!ei || el || eq) || null == eH.current || eu !== I.Q6.PLAYING || (te.info(`[QV] | Pausing video | playerState: ${eu}, parentTransitionState: ${G}, visible: ${es}, focused: ${el}, isQuestCompleted: ${eq}`), tN(I.Q6.PAUSED), eq ? eX && e0(S.Yg.ANOTHER_MODAL_OPENED) : e0(S.Yg.LOST_FOCUS))
    }, [G, el, ei, es, ea, eu, eq, tN, tD, te, eX]), l.useEffect(() => {
        eZ === S.Yg.ANOTHER_MODAL_OPENED && G === m.ip4.ENTERED && eu === I.Q6.PAUSED && eX && el && (te.info("[QV] | Resuming full episode video after modal re-entered"), tN(I.Q6.PLAYING))
    }, [G, eu, te, tN, eZ, eX, el]);
    let [tR, tL] = l.useState(!1), tM = l.useRef(null), tj = l.useRef(performance.now()), tI = l.useCallback(() => {
        null != tM.current && clearTimeout(tM.current), eu !== I.Q6.PLAYING || (tM.current = setTimeout(() => {
            eu === I.Q6.PLAYING && tL(!0)
    ...
    let tk = !tR && (ep || ed || eu === I.Q6.ENDED),
        tO = l.useCallback(() => {
            te.info("[QV] | handleFullScreenExit");
            let e = (0, x.qf)(eH.current?.parentNode, eH.current);
            null == e || (0, x._U)(e) || (e.removeEventListener(x.Wb, tO), J(!1), tS(!1), tr(I.oA.MD))
        }, [J, te, tS]),
        tP = () => {
            if (null == eH.current) return;
            let e = Math.max(eH.current.currentTime - 10, 0);
            te.info(`[QV] | handleSeekBackIncrement | newTime: ${e}`), tU(e), eu === I.Q6.ENDED && tN(I.Q6.PAUSED), tE(S.uF.VIDEO_MODAL, b.Cy.SEEK_BACKWARD)
        },
        tQ = () => {
            if (null == eH.current || !t1) return;
            let e = Math.min(eH.current.currentTime + 10, e5);
            te.info(`[QV] | handleSeekForwardIncrement | newTime: ${e}`), tU(e), eu !== I.Q6.ENDED && e >= eH.current.duration && tN(I.Q6.ENDED), tE(S.uF.VIDEO_MODAL, b.Cy.SEEK_FORWARD)
        };
    l.useEffect(() => {
        let e = eH.current;
        return () => {
    ...
    let tV = () => {
            if (null != eH.current) switch (te.info(`[QV] | handlePlaybackBtnClick | playerState: ${eu}`), tb(), eu) {
                case I.Q6.ENDED:
                    tU(0), tN(I.Q6.PLAYING);
                    break;
                case I.Q6.PLAYING:
                    tN(I.Q6.PAUSED), e0(S.Yg.PAUSE_BUTTON);
                    break;
                default:
                    tN(I.Q6.PLAYING)
            }
    ...
    let tK = l.useCallback(e => {
        ...
        t$ = l.useRef(!1);
    l.useEffect(() => {
        null != ti || t$.current || (t$.current = !0, tA(I.SB.NO_VALID_SOURCE))
    }, [ti, tA, t$]);
    let tY = e => {
        te.info(`[QV] | handleCanPlay: playerState: ${eu}`), null != eH.current && eu === I.Q6.PLAYING && (te.info("[QV] | handleCanPlay: did NOT early return"), eA && (te.info(`[QV] | handleCanPlay: loadingFirstChunk: ${eA}`), eC(!1)), e_ && (te.info(`[QV] | handleCanPlay: waitingForChunk: ${e_}`), tv(null != eB.current ? performance.now() - eB.current : null), eb(!1)), te.info("[QV] | handleCanPlay: updating player state to playing"), tN(I.Q6.PLAYING))
    };
    l.useEffect(() => {
        if (!eg) return;
        let e = setTimeout(() => {
    ...
    return (0, r.jsx)(m.DUT, {
        ...
        children: (0, r.jsxs)("div", {
            ...
            children: [tJ && (0, r.jsx)(D.A, {
                ...
                onTimeUpdate: e => {
                    ...
                    if (eH.current.currentTime >= eR || r) {
                        var l;
                        te.info(`[QV] | handleTimeUpdate: capturing server time update: currentTime: ${eH.current.currentTime}`), (l = eH.current.currentTime) >= t && (eJ.current = !0), eL(l + Q.aA + Math.random() * Q.A6), tD(l)
                    }
                    eH.current.currentTime >= eM && (ej(eH.current.currentTime + 1), (0, g.Gn)(z.id, eE.taskType, eH.current.currentTime), n(eH.current.currentTime)), eG(z.id, eH.current.currentTime, eH.current.duration), ex(eH.current.currentTime / eH.current.duration * 100)
                },
                onEnded: e => {
                    null != eH.current && (tD(eH.current.duration + 1), te.info(`[QV] | handleEnded: sending progress update: ${eH.current.duration+1}`), eG(z.id, eH.current.duration, eH.current.duration)), tN(I.Q6.ENDED), eb(!1)
                },
                onLoadedData: e => {
                    te.info(`[QV] | handleLoadedData: loadingFirstChunk: ${eA}`), eA && (tc(null != eV.current ? performance.now() - eV.current : null), eC(!1), to())
                },
                onLoadedMetadata: e => {
                    null != eH.current && (te.info(`[QV] | handleLoadedMetadata | videoAssetId: ${ts}`), e6(!0), ts !== _.fY.VIDEO_PLAYER_VIDEO_HLS && tU(tt), eK ? eH.current.volume = 0 : eH.current.volume = e$)
                },
                onLoadStart: () => {
                ...
                onAbort: () => tK(I.SB.ABORT),
                onError: () => tK(I.SB.ERROR),
                onEmptied: () => tK(I.SB.EMPTIED),
                onStalled: () => tK(I.SB.STALLED),
                onClick: () => {
                ...
                children: [null != t0 && (0, r.jsx)("track", {
                    ...
                    onError: () => tK(I.SB.SOURCE_ERROR),
                    src: ti.url,
                    type: ti.mimetype
                })]
            }), (eA || e_) && eu === I.Q6.PLAYING && null != ti && (0, r.jsx)("span", {
                className: B.S,
            ...
            }), ee && eu !== I.Q6.ENDED && (0, r.jsxs)(r.Fragment, {
                children: [(0, r.jsx)(m.DUT, {
                    onClick: () => {
                        eu === I.Q6.PAUSED && tN(I.Q6.PLAYING), et(!1)
                    },
                    tabIndex: -1,
                ...
                className: s()(B.yf, {
                    [B.ZH]: eu === I.Q6.PLAYING,
                    [B.v7]: eu === I.Q6.PAUSED
                }),
                style: {
                    "--custom-play-pause-pop-ms": "1000ms"
                },
                children: eu === I.Q6.PLAYING ? (0, r.jsx)(m.udU, {
                    className: B.PK
                }) : (0, r.jsx)(m.E$n, {
                    className: B.PK
                })
                ...
                children: [(0, r.jsx)(o.animated.div, {
                    ...
                    children: (0, r.jsx)(M.A, {
                        ...
                        onClick: e => {
                            t4 && (tU(e), eu === I.Q6.ENDED && tN(I.Q6.PLAYING))
                        },
                        onScrubBack: tP,
                        onScrubForward: tQ,
                        isQuestCompleted: eq,
                    ...
                    children: (0, r.jsx)(N.A, {
                        ...
                        handleFullScreenBtnClick: () => {
                            ...
                            e && null != t ? ((0, x.tl)(t), t.addEventListener(x.Wb, tO), tS(!0), tr(I.oA.LG)) : e || null == t || (t.removeEventListener(x.Wb, tO), tS(!1), (0, x.sP)(t), tr(I.oA.MD)), J(e)
                        },
