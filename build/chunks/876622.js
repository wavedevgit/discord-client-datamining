/** chunk id: 876622, original params: e,t,a (module,exports,require) **/
a.d(t, {
    A: () => p
});
var n = a(627968),
...
function m(e) {
    let {
        ...
        return t === s
    }), [s, a]), [c, m] = i.useState(!1), p = function(e) {
        let {
            selected: t,
            isHovered: a
        } = e;
        ...
        selected: r,
        isHovered: c
    }), g = i.useCallback(() => m(!0), []), x = i.useCallback(() => m(!1), []), A = i.useRef(null);
