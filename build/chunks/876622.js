/** chunk id: 876622 params = (module,exports,require) **/
a.d(t, {
    A: () => p
});
var n = a(627968),
...
function h(e) {
    let {
        ...
        tabs: a,
        selectedTab: l
    } = e, r = i.useMemo(() => null != a.find(e => {
        let {
            id: t
        } = e;
        return t === l
    }), [l, a]), [c, h] = i.useState(!1), p = function(e) {
        let {
            selected: t,
            isHovered: a
        } = e;
        ...
        selected: r,
        isHovered: c
    }), g = i.useCallback(() => h(!0), []), x = i.useCallback(() => h(!1), []), A = i.useRef(null);
...
function p(e) {
    ...
    } = e, [p, _] = i.useState(0), g = i.useRef(p), {
        lastVisibleIndex: x,
        onItemLayout: A,
        overflowItemsRef: f,
        itemWidthsRef: b
    ...
    return (0, n.jsxs)("div", {
        ...
        children: [(0, n.jsxs)("div", {
            ...
            onItemSelect: d,
            className: m.vR,
            children: [C.map(e => (0, n.jsx)(o.VQ0.Item, {
                id: e.id,
                look: "brand",
                "aria-label": e.label,
                className: m.Mf,
                children: e.label
            }, e.id)), 0 !== v.length ? (0, n.jsx)(h, {
                tabs: v,
                onTabSelect: d,
                selectedTab: a
            }) : null]
