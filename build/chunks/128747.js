/** Chunk was on web.js **/
/** chunk id: 128747, original params: e,t,n (module,exports,require) **/
"use strict";
n.d(t, {
    A: () => S
}), n(896048), n(747238), n(812715), n(733351), n(492834), n(321073), n(693327), n(554719), n(680155), n(323874), n(14289), n(35956), n(638769);
var r = n(735438),
    i = n.n(r),
    a = n(280230),
    o = n.n(a),
...
class S {
    ...
    _isAsyncSearch() {
        var e, t;
        return this._include(E.rD.USER) && (null == (t = this.options) || null == (e = t.userFilters) ? void 0 : e.thread) != null
    }
    setOptions(e) {
    ...
    queryUsers(e, t, n) {
        ...
        if ((null == a ? void 0 : a.thread) != null) {
            ...
            for (let e in t) {
                ...
                for (let e of n.userIds) {
                    var l, c, u;
                    (null == a || !a.friends || d.A.isFriend(e)) && (null != (l = null == (c = this._userBlacklist) ? void 0 : c.includes(e)) && l || r.push({
                        userId: e,
        ...
        void 0 !== t && _.A.requestMembers(t, e, 100), r.setLimit(n), r.setQuery({
            query: e,
            filters: a,
    ...
    queryGroupDMs(e, t) {
        ...
        let {
            blacklist: n
        } = this.options, r = I(E.rD.GROUP_DM, this.options), i = null != n ? e => !n.has("channel:".concat(e.id)) : void 0;
    ...
    queryApplications(e, t) {
        return this._include(E.rD.APPLICATION) ? p.Ay.queryApplications({
            query: e,
            limit: t,
            fuzzy: !0
        }) : []
    ...
    queryInAppNavigations(e, t) {
        return this._include(E.rD.IN_APP_NAVIGATION) ? p.Ay.queryInAppNavigations({
            query: e,
            limit: t,
            fuzzy: !0
        }) : []
    ...
    constructor(e, t, n = O, r = v, a = 0) {
        y(this, "query", ""), y(this, "options", v), y(this, "results", []), y(this, "_userResults", []), y(this, "_groupDMResults", []), y(this, "_textChannelResults", []), y(this, "_voiceChannelResults", []), y(this, "_guildResults", []), y(this, "_applicationResults", []), y(this, "_linkResults", []), y(this, "_inAppNavigations", []), y(this, "_asyncTimeout", void 0), y(this, "userSearchContext", void 0), y(this, "onResultsChange", void 0), y(this, "resultTypes", void 0), y(this, "_userBlacklist", null), y(this, "_limit", void 0), y(this, "_refetchForSingleCategoryLimit", void 0), y(this, "_refetched", !1), y(this, "parseUserResults", e => {
            let {
                results: t
            } = e;
        ...
        }), this.onResultsChange = e, this.setOptions(r, !0), this._limit = n, this._refetchForSingleCategoryLimit = a, this.createSearchContext(), this.setResultTypes(t)
    }
}