/** chunk id: 717115, original params: e,t,i (module,exports,require) **/
i.d(t, {
    O: () => S
});
var n = i(627968),
...
class S extends s.PureComponent {
    ...
    componentDidMount() {
        this.props.autoFocus && (this.contentDomRef.current?.scrollIntoView({
            behavior: "smooth"
        }), this.highlight())
    }
    ...
    setMessageNotification(e, t, i) {
        ...
        null != s && a.A.updateChannelOverrideSettings(s, n.id, {
    ...
    renderMessageNotificationsRadioOption(e) {
        ...
        return (null == t || t === A.orn.NULL) && e === s && (a = !0), (0, n.jsx)(l.Checkbox, {
            checked: !i && a,
            label: "",
            disabled: i,
    ...
    renderName() {
        ...
        if (i.type === A.rbe.GUILD_CATEGORY && null != i.guild_id && "" !== i.guild_id) {
            ...
            t = N.intl.formatToPlainString(N.t["2KzH89"], {
                num: null != e[i.id] ? e[i.id].length : 0
            })
        } else t = null != e ? N.intl.formatToPlainString(N.t.L1zJgb, {
            categoryName: (0, d.m1)(e, x.default, h.A)
    ...
    render() {
        ...
        return (0, n.jsxs)(l.ZpM, {
            ...
            editable: !0,
            className: e ? j.J$ : j.$Z,
            children: [this.renderName(), this.renderOptions(), (0, n.jsx)(r.A, {
                className: j.ZY,
