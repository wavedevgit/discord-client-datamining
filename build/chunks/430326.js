/** chunk id: 430326, original params: t,e,n (module,exports,require) **/
n.d(e, {
    default: () => k
...
function k(t) {
    let {
        ...
        videoPlacement: g
    } = t, I = (0, s.bG)([p.A], () => p.A.getGuild(e)), R = (0, s.bG)([_.default], () => _.default.locale), h = function(t) {
        ...
        return i.useEffect(() => {
            ...
            let c = `https://${window.GLOBAL_ENV.CDN_HOST}/assets/boosting/marketing/captions/boosting_marketing_video_captions_${t}.vtt`,
                i = !1;
            return fetch(c).then(t => {
                if (t.ok) return t.text()
            }).then(t => {
                i || null == t || n(e = URL.createObjectURL(new Blob([t], {
                    type: "text/vtt"
                })))
            }).catch(() => {}), () => {
    ...
    } = (0, l.Ay)(T, r.A.GUILD_POWERUPS_MARKETING_VIDEO_MODAL), [j, m] = i.useState(!1), y = i.useRef(!1), D = i.useMemo(() => ({
        guild_id: e,
        ...
        video_placement: g
    }), [U.object, U.section, M, e, g]), G = i.useCallback(t => {
        let e = t.currentTarget.duration;
        y.current || (y.current = !0, b.default.track(A.HAw.BOOSTING_MARKETING_VIDEO_PLAYED, {
            ...D,
            ...Number.isFinite(e) ? {
    ...
    return (0, c.jsxs)(a.dWK, {
        ...
        children: [(0, c.jsx)(a.rQ0, {
            title: f.intl.string(f.t["0f1VCH"])
        }), (0, c.jsx)(a.cwr, {
