/** chunk id: 430326 params = (module,exports,require) **/
n.d(e, {
    default: () => y
...
function y(t) {
    let {
        ...
        videoPlacement: R
    } = t, g = (0, s.bG)([p.A], () => null != e ? p.A.getGuild(e) : null), I = (0, s.bG)([_.default], () => _.default.locale), k = function(t) {
        ...
        return c.useEffect(() => {
            ...
            return fetch(i).then(t => {
                ...
                c || null == t || n(e = URL.createObjectURL(new Blob([t], {
                    type: "text/vtt"
                })))
            }).catch(() => {}), () => {
    ...
    } = (0, r.Ay)(T, l.A.GUILD_POWERUPS_MARKETING_VIDEO_MODAL), [D, m] = c.useState(!1), G = c.useRef(!1), h = c.useRef(null), x = c.useMemo(() => ({
        ...null != e ? {
            guild_id: e
        } : {},
        ...
        video_placement: R
    }), [M.object, M.section, j, e, R]), C = c.useCallback(t => {
        let e = t.currentTarget.duration;
        G.current || (G.current = !0, b.default.track(A.HAw.BOOSTING_MARKETING_VIDEO_PLAYED, {
            ...x,
            ...Number.isFinite(e) ? {
    ...
    async function N() {
        h.current?.pause(), await (0, o.mMO)(async () => {
            let {
                default: t
            } = await n.e("18710").then(n.bind(n, 770101));
            return e => (0, i.jsx)(t, {
                ...e,
                onSelectGuild: t => {
                    e.onClose(), E(), (0, d.g)({
    ...
    return (0, i.jsxs)(a.dWK, {
        ...
        children: [(0, i.jsx)(a.rQ0, {
            title: U.intl.string(U.t["0f1VCH"])
        }), (0, i.jsx)(a.cwr, {
