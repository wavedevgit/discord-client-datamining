/** chunk id: 58935 params = (module,exports,require) **/
n.d(t, {
    default: () => m
});
var l = n(627968),
...
let m = e => {
    let {
        ...
        onConfirm: m,
        transitionState: y
    } = e, S = (0, s.Ay)(t, !0), D = t.id, T = t.isForumPost(), v = (0, u.bG)([_.A], () => _.A.getGuild(t.getGuildId())), O = (0, f.ob)(D), {
        isSubscriptionGated: U
    } = (0, c.A)(t.id), p = (0, A.A)(v, t), [w, B] = i.useState(), L = (0, u.bG)([G.default], () => t.isOwner(G.default.getId()), [t]), b = (0, u.bG)([C.A], () => C.A.can(t.isThread() ? I.xBc.MANAGE_THREADS : I.xBc.MANAGE_CHANNELS, t), [t]), x = (0, u.bG)([g.A], () => g.A.getCount(t.id) ?? 0, [t.id]), M = T && (b || L && x < 1), V = O.length > 0 && (t.type === I.rbe.GUILD_VOICE || t.type === I.rbe.GUILD_STAGE_VOICE);
    if (i.useEffect(() => {
            (async () => {
            ...
            null != v && v.features.has(I.GuildFeatures.COMMUNITY) && (v.rulesChannelId === D ? B(o.K5.RULES) : v.publicUpdatesChannelId === D && B(o.K5.UPDATES))
        }, [v, D]), null == v) return null;
    if (null != w) {
        let e, t = async () => {
    ...
    let {
        ...
        deleteBody: M && L && !b ? h.intl.format(h.t["6/pY2+"], {
            postName: S
        }) : M ? h.intl.format(h.t.su3voL, {
            postName: S
