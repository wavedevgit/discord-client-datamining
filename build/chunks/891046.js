...
let z = i.memo(function(e) {
    ...
    } = e, m = (0, o.bG)([C.A], () => C.A.getChannel(n));
    return null == m ? null : (0, l.jsx)(H, {
        id: t,
        channel: m,
        goToThread: i,
        overrideMedia: s,
...
function V(e) {
    let {
        ...
        overrideMedia: s,
        coords: a
    } = e, r = (0, o.bG)([C.A], () => C.A.getChannel(t.parent_id)), {
        firstMedia: d
    } = (0, S.gk)({
        firstMessage: n,
        formatInline: !1,
...
function W(e) {
    let {
        ...
        facepileRef: n,
        firstMessage: i
    } = e, s = (0, m.m)(t.id), a = i?.reactions != null && i.reactions.length > 0;
    return (0, l.jsxs)("div", {
        className: G.GD,
        children: [(0, l.jsxs)("div", {
            className: G.QW,
            ...
            className: G.QW,
            children: [a || null == i ? null : (0, l.jsx)(R.NA, {
                firstMessage: i,
                channel: t
            }), null == i ? null : (0, l.jsx)(R.cn, {
                firstMessage: i,
                channel: t
            })]
        })]
...
function X(e) {
    let {
        ...
        containerWidth: r,
        hasUnreads: o
    } = e, d = v.hH.useSetting(), [u, m] = (0, M.tm)(r - 2 * M.IZ), {
        content: h
    } = (0, S.gk)({
        firstMessage: n,
        formatInline: !1,
