...
function S(t) {
    ...
    if (n && null != e.packName && "" !== e.packName) {
        let t = m.intl.formatToPlainString(f.default.ECl8SQ, {
            packName: e.packName
        });
        return (0, s.jsx)(c.m, {
            delay: 100,
...
function C(t) {
    let {
        ...
        onBadgeClicked: c,
        headingId: u
    } = t, [b, g] = l.useState(!1), C = l.useId(), k = (0, o._u)({
    ...
    return (0, s.jsxs)("div", {
        className: h.zr,
        children: [(0, s.jsx)(d.AC4, {
            id: C,
            children: m.intl.string(m.t["5AQGuZ"])
        }), (0, s.jsx)("div", {
            ...k,
            "aria-describedby": C,
            className: j.p3,
            children: e.unlockedBadges.map(t => (0, s.jsx)(p, {
                badge: t,
                isSelected: t.kind === r,
                onClick: () => c(t.kind)
            }, t.kind))
            ...
            children: e.lockedBadges.map(t => (0, s.jsx)("li", {
                children: (0, s.jsx)(S, {
                    locked: !0,
                    badge: t,
                    onClick: () => n?.()
            ...
            children: [(0, s.jsx)("div", {
                className: j.p3,
                children: e.lockedBadges.slice(0, 5).map(t => (0, s.jsx)(S, {
                    locked: !0,
                    preview: !0,
                    badge: t
                }, t.kind))
