/** Chunk was on web.js **/
/** chunk id: 998275, original params: e,t,n (module,exports,require) **/
"use strict";
n.d(t, {
    A: () => f
});
var r = n(364242),
    ...
    a = n(476858),
    o = n(355418);
let s = RegExp(`(?:on\\s{0,3})?(${i.lT})(?:\\s{0,3}(?:al|\\-|\\–|fino|alle|allo)?\\s{0,3}(${i.lT}))?(?:-|/|\\s{0,3}(?:dal)?\\s{0,3})(${(0,a.uJ)(i.eB)})(?:(?:-|/|,?\\s{0,3})(${i.fp}(?![^\\s]\\d)))?(?=\\W|$)`, "i"),
    l = 1,
    c = 2,
    u = 3,
    d = 4;
