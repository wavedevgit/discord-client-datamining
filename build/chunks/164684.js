...
async function g(e) {
    ...
    if (null == o.A.getSavedMessage(g.channelId, g.messageId) && !(0, d.A)()) return void(0, l.mMO)(async () => {
        let {
            default: e
    ...
    if (null != await (0, s.oN)(g).catch(e => (e?.body?.code === c.t02.TOO_MANY_SAVED_MESSAGES ? a.A.show({
            title: u.intl.string(u.t.mlbiZW),
            body: u.intl.formatToPlainString(u.t["1zVbEG"], {
                max: 200
            }),
            cancelText: u.intl.string(u.t.BddRzS),
            confirmText: u.intl.string(u.t.ZGbTcy),
            onConfirm: () => r._.dispatch(c.jej.TOGGLE_FOR_LATER)
        }) : (0, l.showToast)((0, l.createToast)(e?.body?.message ?? u.intl.string(u.t.R0RpRX), l.ToastType.FAILURE)), null)) && t) {
...
async function A(e) {
    ...
    if (null != await (0, s.cf)(n).catch(e => ((0, l.showToast)((0, l.createToast)(e?.body?.message ?? u.intl.string(u.t.R0RpRX), l.ToastType.FAILURE)), null)) && t) {
