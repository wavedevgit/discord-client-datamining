/** Chunk was on web.js **/
/** chunk id: 67733, original params: e,t,n (module,exports,require) **/
"use strict";
n.d(t, {
    J: () => r
});
    ...
    *[Symbol.iterator]() {
    ...
    constructor(e) {
        ...
        let r = null,
            i = 0,
            a = 0;
        for (let [e, t] of this.keyMap) r ? (r.nextKey = e, t.prevKey = r.key) : (this.firstKey = e, t.prevKey = void 0), "item" === t.type && (t.index = i++), ("section" === t.type || "item" === t.type) && a++, (r = t).nextKey = void 0;
