/** chunk id: 995572 params = (module,exports,require) **/
s.d(t, {
    Ay: () => B
}), s(321073);
var i = s(627968),
    ...
    return (0, i.jsxs)(i.Fragment, {
        children: [(0, i.jsx)("div", {
            ...
            children: (0, i.jsx)(x.Heading, {
                variant: "heading-xl/bold",
                children: v.intl.string(v.t["PFp+aJ"])
            })
        }), (0, i.jsx)(x.Text, {
            className: A.h_,
            variant: "text-md/medium",
...
function k(e) {
    let {
        onShare: t
    } = e, s = (0, c.bG)([m.A], () => m.A.getRecipientStatus()), [a, n] = r.useState([]), [C, d] = r.useState(new Set), [p, _] = r.useState(!1);
    return r.useEffect(() => {
        (async () => {
            let e = [];
            for (let [t, i] of s)
...
function R(e) {
    ...
    return "light" === (0, c.bG)([_.A], () => _.A.theme) ? (0, i.jsx)(x._V3, {
        className: t,
        src: S,
        width: 55,
        height: 38
...
let B = function(e) {
    let {
        onClose: t,
        onShare: s
    } = e, a = (0, c.bG)([m.A], () => m.A.getReferralsRemaining()), [n, h] = r.useState(""), _ = (0, p.A)(n, 400), [f, j] = r.useState(new Map), [L, S] = r.useState(!1), {
        eligibleUsers: w,
        fetchUsers: N,
        hasError: b,
        isFetching: R,
    ...
    return (0, i.jsxs)("div", {
        children: [(0, i.jsxs)("div", {
        ...
        }), D ? (0, i.jsx)(E, {}) : (0, i.jsxs)(o.ArX, {
            className: A.p_,
            children: [w.map(e => (0, i.jsx)(y.A, {
                disabled: [...f.values()].filter(e => !B.has(e.id)).length >= a && !f.has(e.id) && !B.has(e.id),
                checked: f.has(e.id),
                user: e,
                onChange: (e, t) => {
                    j(s => {
            ...
            }, e.id)), R && (0, i.jsx)(x.y$y, {}), (0, i.jsx)("div", {
                ref: G
            })]
        }), (0, i.jsx)("div", {
            className: l()(A.qr, A.h0),
