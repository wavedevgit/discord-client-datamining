/** chunk id: 850735 params = (module,exports,require) **/
"use strict";
s.d(t, {
    A: () => j
});
...
let I = e => {
        let {
            tab: t
        } = e, [s, l, a] = (0, o.yK)([x.A], () => [x.A.getLayout(t), x.A.isFetchingLayout(t), x.A.getLayoutFetchError(t)]), c = (0, o.bG)([u.A], () => u.A.get("shop_include_unpublished")), d = (0, o.bG)([p.A], () => p.A.skipNumCategories), g = r.useMemo(() => ({
            include_unpublished: c ?? !1,
            skip_num_categories: d ?? 0
        }), [c, d]), h = null == s && !l && a?.status !== 404 && a?.status !== 429;
        return (r.useEffect(() => {
            h && (0, m.T2)({
                tab: t
            })
    ...
    j = e => {
        let {
            ...
            tab: s,
            transitionState: l
        } = e, u = (0, h.uM)(), _ = (0, o.bG)([f.A], () => f.A.getShopLayoutUrlOverride()), m = r.useRef(null), {
            handleScroll: p
        } = (0, d.X)(m, s), [x, E] = r.useState(b.md), [j, O] = r.useState(!1);
        return r.useEffect(() => {
            if (null != m.current) {
                let e = () => {
            ...
            children: (0, n.jsxs)("div", {
                ...
                children: [(0, n.jsxs)("div", {
                    ...
                    children: [null != _ && "" !== _ ? (0, n.jsx)(L, {
                        url: _
                    }) : (0, n.jsx)(I, {
                        tab: s
                    }), s !== i.g.CATALOG && x >= 36 && (0, n.jsxs)("div", {
                        className: v.R$,
