/** chunk id: 69090 params = (module,exports,require) **/
"use strict";
n.d(t, {
    A: () => M
});
...
function M(e) {
    ...
    let _ = s.useRef(!1);
    s.useEffect(() => {
        _.current || "" === u.trimStart() || (b.default.track(R.HAw.SEARCH_STARTED, {
            search_type: "Roles"
        }), _.current = !0)
    }, [u]);
...
function U(e) {
    ...
    return (0, i.jsxs)(m.DUT, {
        ...
        "aria-label": O.intl.formatToPlainString(O.t.Vu0Acc, {
            name: t.name,
            count: `${x}`
        }),
        children: [(0, i.jsx)("div", {
            className: r()(L.co, G._M, {
                [L.Y6]: S || b
            }),
            onMouseEnter: () => M(!0),
            onMouseLeave: () => M(!1),
            children: (0, i.jsx)(m.WP0, {
                size: "xs",
                color: "currentColor"
            })
        }), (0, i.jsxs)("div", {
            className: r()(L.Ji, G.N5),
            children: [t.tags?.guild_connections === null ? (0, i.jsx)(h.A, {
                className: L.U4,
                color: t.colorString,
                size: 24
            }) : (0, i.jsx)(P, {
                ...
                children: t.name
            }), t.tags?.subscription_listing_id != null && (0, i.jsx)(f.A, {
                className: L.tU,
                "aria-label": O.intl.string(O.t.a2Ak8b)
            }), t.tags?.is_guild_product_role === !0 && (0, i.jsx)(_.A, {})]
        }), (0, i.jsx)(u.m, {
            text: O.intl.string(O.t.CW75t0),
            "aria-label": O.intl.formatToPlainString(O.t.Fgs8fD, {
                count: `${x}`
            }),
            position: "right",
...
function P(e) {
    ...
    if (null != h) return (0, i.jsx)(N.A, {
        ...h,
        className: a,
        enableTooltip: l
    });
    let _ = n.colorString ?? R.TpD;
    return x && d && (_ = `url(#${g})`), (0, i.jsxs)(i.Fragment, {
        children: [x && d && (0, i.jsx)("svg", {
            width: "0",
            height: "0",
            style: {
                position: "absolute"
