...
function M(e) {
    let t, {
        ...
        f = null != l,
        C = (0, x.A)(n, f);
    f && d ? t = D.intl.format(D.t.pkxVx6, {
        endDate: C,
        onClickDetails: p
    }) : f && !d ? t = D.intl.format(D.t["4sFeob"], {
        endDate: C,
        onClickDetails: p
    }) : !f && d ? t = D.intl.format(D.t["RBnE+l"], {
        endDate: C,
        onClickDetails: p
    }) : f || d || (t = D.intl.format(D.t["57+7Qn"], {
        endDate: C,
        onClickDetails: p
    }));
    let b = f ? D.intl.string(D.t["2cHUti"]) : D.intl.string(D.t.O13yhz),
        N = s.useCallback(() => A(!1), []),
        {
            outboundTitle: I,
...
let G = function(e) {
    let {
        ...
        return null == t
    }), m = (0, d.bG)([C.default], () => I.Ay.isPremiumExactly(C.default.getCurrentUser(), L.PremiumTypes.TIER_2)), g = o().groupBy(l, e => (0, N.Kx)(e.skuId, e.subscriptionPlanId, e.giftStyle)), [x, h] = s.useState(!1);
    s.useEffect(() => {
        u.h.wait(() => {
            (0, _.XJ)().then(() => h(!0))
        })
