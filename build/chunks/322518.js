/** chunk id: 322518, original params: e,a,t (module,exports,require) **/
t.d(a, {
    E: () => d
});
var r = t(955048),
...
function d(e) {
    let {
        ...
        maxValue: g,
        ...v
    } = e, [f, b] = (0, u.P)(a, t || null, o), [A, R] = (0, s.useState)(null), $ = "center";
    if (f && f.start && f.end) {
        let e = (0, r.Hu)((0, i.gw)(f.start), D, y, p, g).add(D).subtract({
            days: 1
        });
    ...
    let w = (0, s.useRef)(null),
        ...
        S = a => {
            a && e.isDateUnavailable && !e.allowsNonContiguousRanges ? (w.current = {
                start: h(a, E, -1),
                end: h(a, E, 1)
            }, C(w.current)) : (w.current = null, C(null))
        },
    ...
    let B = e => {
        ...
        Z = (0, s.useMemo)(() => !!f && !A && (!!(N && (N(f.start) || N(f.end))) || (0, r.If)(f.start, p, g) || (0, r.If)(f.end, p, g)), [N, f, A, p, g]),
    ...
    return {
        ...
        isSelected: e => !!(M && e.compare(M.start) >= 0 && 0 >= e.compare(M.end) && !E.isCellDisabled(e) && !E.isCellUnavailable(e)),
        isInvalid(e) {
            var a, t;
            return E.isInvalid(e) || (0, r.If)(e, null == (a = w.current) ? void 0 : a.start, null == (t = w.current) ? void 0 : t.end)
        },
        isDragging: T,
        setDragging: O
    }
...
function c(e, a) {
    return e && a ? (0 > a.compare(e) && ([e, a] = [a, e]), {
        start: (0, i.gw)(e),
        end: (0, i.gw)(a)
    }) : null
}
...
function h(e, a, t) {
    ...
    for (;
        (t < 0 ? r.compare(a.visibleRange.start) >= 0 : 0 >= r.compare(a.visibleRange.end)) && !a.isCellUnavailable(r);) r = r.add({
        days: t
    });
    if (a.isCellUnavailable(r)) return r.add({
        days: -t
    })
}