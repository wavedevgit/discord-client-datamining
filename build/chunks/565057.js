...
let O = e => {
    let {
        ...
        orbsSupportedOnly: B
    } = e, P = (0, i.bG)([_.default], () => _.default.getCurrentUser()), M = p.Ay.canUseCollectibles(P), D = (0, E.W)("FeedBlock"), w = (0, I.yB)("FeedBlock"), {
        sortType: H,
        setSortType: F,
        sortedItems: G,
        sortOptions: U,
    ...
    return null == P ? null : (0, n.jsxs)("div", {
        ...
        children: [(0, n.jsxs)("div", {
            ...
            children: t ? (0, n.jsx)(n.Fragment, {
                ...
                if (Y)
                    if ($ === S.J.SHUFFLE_OUT) return (0, n.jsx)("div", {
                        className: T.Z2,
                        children: (0, n.jsx)(A.A, {
                            skipPulseAnimation: !0
                        })
                    }, `${e.skuId}-${t}`);
                    else $ === S.J.SORT_OUT ? s = T.MW : $ === S.J.SHUFFLE_IN ? s = T.aS : $ === S.J.SORT_IN && (s = T.F7);
                return (0, n.jsx)(f.R9, {
                    newValue: {
                        tilePosition: t,
