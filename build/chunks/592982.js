...
function T(e) {
    let {
        ...
        id: v,
        type: j
    } = T, R = (0, l.bG)([c.A], () => c.A.getGuild(T.guild_id), [T.guild_id]), O = (0, l.bG)([u.A], () => u.A.getSelectedParticipant(v)), L = O?.type === I.lp.STREAM ? O.stream : null, M = (0, l.bG)([a.A], () => O?.type === I.lp.ACTIVITY ? a.A.getApplication(O.applicationId) : void 0), D = (0, _.A)(v), U = (0, x.A)(v), G = (0, g.A)(T, R, L?.ownerId, M?.id), P = (0, A.A)(v), k = (0, E.A)(), w = (0, d.RQ)(v), B = (0, d.dA)(v), V = (0, f.A)(L, y), H = (0, p.A)(M, v), F = (0, m.A)(), W = (0, r.A)(T), K = (0, h.f)(v);
