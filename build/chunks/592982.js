...
function b(e) {
    let {
        ...
        id: v,
        type: j
    } = b, R = (0, s.bG)([d.A], () => d.A.getGuild(b.guild_id), [b.guild_id]), O = (0, s.bG)([u.A], () => u.A.getSelectedParticipant(v)), L = O?.type === E.lp.STREAM ? O.stream : null, M = (0, s.bG)([a.A], () => O?.type === E.lp.ACTIVITY ? a.A.getApplication(O.applicationId) : void 0), D = (0, p.A)(v), G = (0, x.A)(v), U = (0, g.A)(b, R, L?.ownerId, M?.id), P = (0, A.A)(v), w = (0, C.A)(), k = (0, c.RQ)(v), V = (0, c.dA)(v), B = (0, f.A)(L, y), H = (0, _.A)(M, v), F = (0, m.A)(), K = (0, r.A)(b), W = (0, h.f)(v);
