...
function b(e) {
    let {
        ...
        id: y,
        type: j
    } = b, R = (0, s.bG)([d.A], () => d.A.getGuild(b.guild_id), [b.guild_id]), O = (0, s.bG)([u.A], () => u.A.getSelectedParticipant(y)), L = O?.type === E.lp.STREAM ? O.stream : null, M = (0, s.bG)([a.A], () => O?.type === E.lp.ACTIVITY ? a.A.getApplication(O.applicationId) : void 0), D = (0, m.A)(y), G = (0, x.A)(y), U = (0, g.A)(b, R, L?.ownerId, M?.id), P = (0, A.A)(y), w = (0, C.A)(), k = (0, c.RQ)(y), V = (0, c.dA)(y), B = (0, f.A)(L, v), H = (0, p.A)(M, y), F = (0, _.A)(), K = (0, r.A)(b), W = (0, h.f)(y);
