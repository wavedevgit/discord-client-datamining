/** chunk id: 159719 params = (module,exports,require) **/
"use strict";
n.d(t, {
    A: () => g
});
...
function g(e) {
    let {
        guild: t
    } = e, g = (0, s.bG)([r.A], () => r.A.isUploadingEmoji()), x = (0, u.A)(t.id), h = (0, c.A)(t) - x.length, _ = (0, d.gN)();
    return (0, i.jsxs)(l.D0$, {
        label: m.intl.string(m.t["LDT0Q/"]),
        disabled: _,
        description: m.intl.format(m.t.H9Jxp6, {
            maxSlots: (0, c.A)(t)
        }),
