...
let G = 16 / 9,
    ...
    w = l.memo(function(e) {
        ...
        let {
            user: E
        } = t, C = (0, o.bG)([g.A], () => g.A.getParticipant(l.id, t.id), [l.id, t.id]), T = (0, o.bG)([R.Ay], () => R.Ay.isModerator(E.id, l.id), [l.id, E.id]);
        ...
        let S = e => {
            ...
            y = (e, t, s, a) => {
                switch (e.type) {
                    ...
                    case D.lp.USER:
                    default:
                        if (S(D.qs.USER), s) return (0, N.r)(t, E, l, {
                            context: h
                        }, (e, t) => (0, p.Y)({
                            menuName: e,
                            menuItemProps: t,
        ...
        return C.type !== D.lp.USER || C.voiceState?.selfVideo ? (0, i.jsx)(k, {
            stageParticipant: t,
            rtcParticipant: C,
            channel: l,
            guildId: f,
