/** chunk id: 249522, original params: e,t,n (module,exports,require) **/
"use strict";
...
class a {
    ...
    start() {
        var e, t;
        this.animating = !0, this.vel = 0, this.last = null, this.nodeWindow = this.getNodeWindow(), this.nextTick = null != (e = null == (t = this.nodeWindow) ? void 0 : t.requestAnimationFrame(this.update)) ? e : -1
    }
    getUpdates(e, t) {
