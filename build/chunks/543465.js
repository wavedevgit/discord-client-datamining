...
class e_ extends(r = s.Ay.PersistedStore) {
    initialize(e) {
    ...
    getNewForumThreadsCreated(e) {
        ...
        if (null != t && null != t.flags) {
            if (o.Lt(t.flags, b.vv.NEW_FORUM_THREADS_ON)) return !0;
            if (o.Lt(t.flags, b.vv.NEW_FORUM_THREADS_OFF)) return !1
        }
    ...
    getGuildFavorites(e) {
        ...
        if (null == T[e]) {
            let t = a().filter(this.getChannelOverrides(e), t => {
                var n, r;
                return o.Lt(null != (n = t.flags) ? n : 0, b.vv.FAVORITED) && (null == (r = _.A.getChannel(t.channel_id)) ? void 0 : r.guild_id) === e
            });
