...
let h = () => {
    ...
    return [g.BVt.FRIENDS, (0, s.HF)("navigateToChannel") ? g.BVt.ICYMI : null, _.A.hasLibraryApplication() && !d.l_.getSetting() ? g.BVt.APPLICATION_LIBRARY : null, e ? g.BVt.MESSAGE_REQUESTS : null, g.BVt.APPLICATION_STORE, g.BVt.COLLECTIBLES_SHOP, d.dm.getSetting() ? g.BVt.FAMILY_CENTER : null, g.BVt.QUEST_HOME].filter(A.Vq)
};
