...
function I(e) {
    let {
        ...
        friendMemberIds: r,
        discoveryGuild: d
    } = e, o = null != r && r.length > 0, [u, x] = n.useState(!1), I = n.useCallback(e => {
        x(e), _.default.track(p.HAw.INVITE_ACCEPT_DETAILS_VIEWED, {
            guild_id: i.id,
            invite_code: t.code,
...
function T(e) {
    ...
    }), A = (0, o.A)("(max-width: 600px)"), E = "v1" === g || A, p = n.useMemo(() => E ? I : v, [E]);
