/** chunk id: 828430 params = (module,exports,require) **/
n.d(t, {
    A: () => I
});
var i = n(627968);
...
class E extends r.A {
    ...
    handleAgeGateModalOpen(e) {
        ...
        (0, l.mMO)(async () => {
            let {
                default: e
            } = await Promise.all([n.e("10136"), n.e("10467")]).then(n.bind(n, 776971));
            return n => (0, i.jsx)(e, {
                source: t,
                ...n
            })
            ...
            backdropStyle: (0, s.lU)(t) ? l.F2Z.LIGHTBOX : void 0
        })
    }
    handleAgeGateSuccess() {
        o.A.showSuccessToast(g.OB.EXISTING_USER_AGE_GATE_SUCCESS), (0, l.OoC)(m.Uy)
    }
    handleAgeGateFailure(e) {
        let {
            underageMessage: t
        } = e;
        (0, l.zbz)(m.Uy, e => (0, i.jsx)(_.default, {
            underageMessage: t,
            ...e
        }))
    }
