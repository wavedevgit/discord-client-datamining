/** Chunk was on web.js **/
/** chunk id: 50016, original params: e,t,n (module,exports,require) **/
"use strict";
n.d(t, {
    W: () => s
});
    ...
    read(e, t, n, a) {
        ...
        for (; e.pos < o;) {
            ...
            if (!s) {
                ...
                let s = e.skip(o);
                !1 !== i && (!0 === i ? r.f$.onRead : i)(this.info.typeName, t, a, o, s);
                continue
            }
            let l = t,
                c = s.repeat,
            ...
            switch (s.oneof && (l = l[s.oneof]).oneofKind !== u && (l = t[s.oneof] = {
                ...
                case "scalar":
                case "enum":
                    let d = "enum" == s.kind ? i.LN.INT32 : s.T,
                        f = "scalar" == s.kind ? s.L : void 0;
                    if (c) {
                        let t = l[u];
                        if (o == r.O0.LengthDelimited && d != i.LN.STRING && d != i.LN.BYTES) {
