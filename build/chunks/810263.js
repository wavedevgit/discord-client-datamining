/** chunk id: 810263 params = (module,exports,require) **/
i.d(t, {
    A: () => p
});
var n = i(627968),
...
function p(e) {
    let {
        showIcons: t
    } = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : {}, i = c.Q_.useSetting(), {
        tidaWebformEnabled: s
    } = A.A.useExperiment({
    ...
    return !__OVERLAY__ && i && g.p5 && null != e.id ? s ? (0, n.jsxs)(a.Drp, {
        id: "copy-server-info",
