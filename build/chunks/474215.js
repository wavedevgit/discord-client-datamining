...
function h(e) {
    let {
        ...
        disabled: n,
        handleSelectEmoji: c
    } = e, m = s.useRef(null), g = s.useMemo(() => null == t || null == t.name ? null : function() {
...
function _(e) {
    ...
    }, [t, r, a]), u = s.useCallback(e => {
        a(t, r, {
            label: e
        })
    }, [t, r, a]), m = s.useMemo(() => n.emoji, [n.emoji]), x = null != n.label && n.label.length > 0 || null != n.emoji;
    return (0, i.jsx)("div", {
        className: g.II,
...
function A(e) {
    let {
        profile: t,
        canManageGuild: n
    } = e, r = s.useMemo(() => t.traits, [t]), a = s.useCallback((e, t, n) => {
        let i = [...r];
        i[t] = {
            ...r[t],
            ...n
        }, c.A.updateGuildProfile(e, {
            traits: i
        })
    }, [r]);
    return (0, i.jsx)(l.D0$, {
