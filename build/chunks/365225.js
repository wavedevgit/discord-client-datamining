/** chunk id: 365225, original params: t,e,s (module,exports,require) **/
s.d(e, {
    default: () => N
});
var r = s(627968),
...
class M extends n.PureComponent {
    static defaultProps = {
        ...
        replaceWith: t => s.g.location.replace(t)
    };
    loginRef;
    passwordRef;
    codeRef;
    ...
    componentDidMount() {
        window.addEventListener("keydown", this.handleTabOrEnter), (0, P.a)({
    ...
    componentDidUpdate(t, e) {
        ...
        s && !t.authenticated && (r(F.BVt.APP), this.state.conditionalMediationAbortController.abort()), e.errors !== this.state.errors && (this.hasError("password") ? this.passwordRef?.focus() : this.hasError("email") || this.hasError("login") ? this.loginRef?.focus() : this.hasError("code") && this.codeRef?.focus())
    }
    ...
    handleAuthToken = async t => {
        this.setState({
            errors: {}
        }), await c.A.loginToken(t, !1)
    };
    handleTabOrEnter = t => {
        "Tab" !== t.key || t.shiftKey || t.target !== this.loginRef || (this.passwordRef?.focus(), t.stopPropagation(), t.preventDefault()), "Enter" === t.key && (t.target === this.loginRef || t.target === this.passwordRef) && (this.handleLogin(), t.stopPropagation(), t.preventDefault())
    };
    setLoginRef = t => {
        this.loginRef = t
    };
    ...
    handleForgotPassword = async t => {
        ...
        try {
            ...
            if (!1 === t) return;
            t === i.D.ONE_TIME_LOGIN ? (0, h.qfG)(t => {
                let e = [{
                    variant: "primary",
                ...
                title: I.intl.string(I.t.f5Pi7A),
                subtitle: I.intl.format(I.t["6u5hQ9"], {
                    email: e
                })
            })
        } catch (e) {
                ...
                children: [(0, r.jsx)(w.A, {
                    ...
                    children: [(0, r.jsx)(h.QWc, {
                        ...
                        onClick: () => {
                            var t;
                            let e;
                            return t = this.state.conditionalMediationAbortController, e = S.isPlatformEmbedded && T.Ay.supportsFeature(F.BYE.WEBAUTHN) ? T.Ay.webAuthnAuthenticate : E.J, void c.A.authenticatePasswordless({
                                authenticateFunc: e,
    ...
    renderDefault() {
        ...
        return (0, r.jsxs)(r.Fragment, {
            children: [(0, r.jsx)(a.rQ0, {
                title: I.intl.string(I.t.bPP34Q),
                subtitle: I.intl.string(I.t.rvx0T4)
            }), (0, r.jsx)(a.cwr, {
        ...
        return (0, r.jsxs)(r.Fragment, {
            children: [(0, r.jsx)(a.rQ0, {
                ...
                leading: (0, r.jsx)(h.Text, {
                    variant: "text-md/normal",
                    color: "text-subtle",
                    children: I.intl.format(I.t.js2rr5, {
                        onClick: this.handleCancelAccountDeletion
                    })
                }),
                actions: [{
                    variant: "primary",
                    text: I.intl.string(I.t.JhDw5o),
    ...
    renderPhonePasswordRecovery() {
        ...
        return (0, r.jsx)(a.cwr, {
            children: (0, r.jsx)(_.A, {
                ...
                subtitle: I.intl.format(I.t.ef4uZ7, {
    ...
    handlePasswordReset = async t => {
        ...
        try {
            let {
                token: e
            } = await m.A.verifyPhone(this.getFullLogin(), t, !1, !0);
            this.setState({
    ...
    handleReset = t => {
        t?.preventDefault(), c.A.loginReset(!0), this.setState({
            password: "",
            loginPrefix: "",
            login: "",
            code: "",
...
let N = function(t) {
    let {
        ...
        onBackPressed: i,
        ...d
    } = t, h = (0, l.cf)([y.A, R.default, C.A, b.A], () => ({
    ...
    (0, p.A)({
        ...
        name: o.ImpressionNames.USER_LOGIN
    });
    let c = n.useCallback(() => {
        e(), i()
    }, [e, i]);
