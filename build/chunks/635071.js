...
function U(e) {
    let {
        ...
        displayNameStyles: Q
    }), en = (0, c.bG)([C.A], () => null == t.guildId || null == t.colorRoleId ? null : C.A.getRole(t.guildId, t.colorRoleId)), ei = (0, S.jV)(H ?? W, en), el = (0, y.A)(n), er = r.useContext(d.C), es = er?.animate || M, ea = ei && (0, h.kz)(t), eo = ee && ea, ec = i?.isPrivate() && null != Q;
    (0, x.A)({
