/** chunk id: 589387 params = (module,exports,require) **/
n.d(t, {
    h: () => _
}), n(321073);
var i = n(64700),
...
let g = [],
    _ = (0, o.Hn)(c.X.STREAMER_MODE_HIDE_OVERLAY_WIDGETS, {
        ...
        useOptions: function() {
            return i.useMemo(() => {
                let e = [];
                for (let [t, n] of Object.entries(a.A)) null != n.streamerModeLabel && (null == n.predicate || n.predicate()) && e.push({
                    id: t,
                    value: t,
                    label: n.streamerModeLabel()
                });
                return e
            }, [])
        },
