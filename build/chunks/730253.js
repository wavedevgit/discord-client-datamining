...
function B(e) {
    let t, B, H, F, K, W, Y, z, q, X, J, Q, {
        ...
        eg = (B = null != (t = (0, a.bG)([N.A], () => N.A.getVoiceChannelId())) && null != ed[t], H = (0, a.bG)([E.A], () => {
            if (!B) return !1;
            let e = E.A.getCurrentUserActiveStream();
            return null != e && null != ed[e.channelId]
        }), F = (0, a.bG)([E.A], () => E.A.getAllApplicationStreams().some(e => null != ed[e.channelId])), K = (0, a.bG)([b.A], () => B && null != t && b.A.hasVideo(t), [B, t]), W = (0, a.yK)([d.Ay], () => S.default.keys(ed).reduce((e, t) => (e.push(...d.Ay.getEmbeddedActivitiesForChannel(t)), e), [])), Y = (0, a.bG)([d.Ay], () => Array.from(d.Ay.getSelfEmbeddedActivities().values()).some(e => {
            let {
                location: t
            } = e, n = (0, u.H)(t);
