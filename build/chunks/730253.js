...
function B() {
    let e, t, l, B, H, F, K, W, Y, z, q, X, J = (0, a.Vd)("favorites"),
        ...
        }), B = (0, o.bG)([N.A], () => N.A.getAllApplicationStreams().some(e => null != ei[e.channelId])), H = (0, o.bG)([T.A], () => t && null != e && T.A.hasVideo(e), [t, e]), F = (0, o.yK)([m.Ay], () => v.default.keys(ei).reduce((e, t) => (e.push(...m.Ay.getEmbeddedActivitiesForChannel(t)), e), [])), K = (0, o.bG)([m.Ay], () => Array.from(m.Ay.getSelfEmbeddedActivities().values()).some(e => {
            let {
                location: t
            } = e, n = (0, p.H)(t);
            return null != n && null != ei[n]
        })), W = F.length > 0, Y = !1, z = !1, q = !1, X = !1, t ? (Y = !H, z = H, q = l, X = K) : (q = B, X = W), (0, x.oi)({
            audio: Y,
            video: z,
            screenshare: q,
            liveStage: !1,
