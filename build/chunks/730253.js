...
let B = {
    analyticsSource: {
        ...
        section: M.JJy.CHANNEL_LIST,
        object: M.ZSU.CHANNEL
    }
};

function H(e) {
    let t, H, F, K, W, Y, z, q, X, Q, J, $, {
        ...
        ef = (H = null != (t = (0, r.bG)([N.A], () => N.A.getVoiceChannelId())) && null != eu[t], F = (0, r.bG)([E.A], () => {
            if (!H) return !1;
            let e = E.A.getCurrentUserActiveStream();
            return null != e && null != eu[e.channelId]
        }), K = (0, r.bG)([E.A], () => E.A.getAllApplicationStreams().some(e => null != eu[e.channelId])), W = (0, r.bG)([b.A], () => H && null != t && b.A.hasVideo(t), [H, t]), Y = (0, r.yK)([d.Ay], () => S.default.keys(eu).reduce((e, t) => (e.push(...d.Ay.getEmbeddedActivitiesForChannel(t)), e), [])), z = (0, r.bG)([d.Ay], () => Array.from(d.Ay.getSelfEmbeddedActivities().values()).some(e => {
            let {
                location: t
            } = e, n = (0, u.H)(t);
            return null != n && null != eu[n]
        })), q = Y.length > 0, X = !1, Q = !1, J = !1, $ = !1, H ? (X = !W, Q = W, J = F, $ = z) : (J = K, $ = q), (0, g.oi)({
            audio: X,
            video: Q,
            screenshare: J,
            liveStage: !1,
            isCurrentUserConnected: H,
            activity: $
        })),
        ...
        eI = s.useCallback((e, t) => {
            eC.current = !0, ee(e, t)
        }, [ee]),
        eN = s.useCallback(e => {
            e && (0, C.u)(M.YYv), eE ? (ec || (0, v.tV)(!0), e && (0, o.mMO)(async () => {
                let {
                    default: e
            ...
            children: (0, i.jsx)(o.Qk9, {
                ...
                children: (0, i.jsx)("div", {
                    ...
                    children: (0, i.jsx)(o.jlP, {
                        ...
                        "aria-selected": ep,
                        to: {
                            pathname: M.BVt.CHANNEL(M.YYv, eh),
                            state: B
                        },
                        selected: ep || er,
                        onClick: () => {
