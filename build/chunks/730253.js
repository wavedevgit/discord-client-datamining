...
function V() {
    let e, t, n, l, V, B, H, F, K, W, Y, z, q = (0, r.Vd)("favorites"),
        {
            favoriteAdded: X,
            clearFavoriteAdded: J
        } = (0, j.CJ)(),
        Q = s.useRef(null),
        [$, Z] = s.useState(!1),
        ee = (0, O.$)("FavoritesButton", "favorite-server-context"),
        {
            favoriteGuildMuted: et,
            favoriteChannels: en
        } = (0, o.cf)([v.A], () => ({
        ...
        eo = (t = null != (e = (0, o.bG)([b.A], () => b.A.getVoiceChannelId())) && null != en[e], n = (0, o.bG)([I.A], () => {
            if (!t) return !1;
            let e = I.A.getCurrentUserActiveStream();
            return null != e && null != en[e.channelId]
        }), l = (0, o.bG)([I.A], () => I.A.getAllApplicationStreams().some(e => null != en[e.channelId])), V = (0, o.bG)([S.A], () => t && null != e && S.A.hasVideo(e), [t, e]), B = (0, o.yK)([A.Ay], () => T.default.keys(en).reduce((e, t) => (e.push(...A.Ay.getEmbeddedActivitiesForChannel(t)), e), [])), H = (0, o.bG)([A.Ay], () => Array.from(A.Ay.getSelfEmbeddedActivities().values()).some(e => {
            let {
                location: t
            } = e, n = (0, m.H)(t);
            return null != n && null != en[n]
        })), F = B.length > 0, K = !1, W = !1, Y = !1, z = !1, t ? (K = !V, W = V, Y = n, z = H) : (Y = l, z = F), (0, f.oi)({
            audio: K,
            video: W,
            screenshare: Y,
            liveStage: !1,
            ...
            children: (0, i.jsx)(L.Q, {
                children: (0, i.jsx)(u.Qk9, {
                    ...
                    children: (0, i.jsx)(u.jlP, {
                        ...
                        "aria-selected": el,
                        to: {
                            pathname: D.BVt.CHANNEL(D.YYv, ei),
                            state: k
                        },
                        selected: el || $,
                        onMouseEnter: () => Z(!0),
