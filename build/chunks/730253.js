...
function V() {
    let e, t, l, V, B, H, F, K, W, Y, z, q, X = (0, a.Vd)("favorites"),
        {
            favoriteAdded: J,
            clearFavoriteAdded: Q
        } = (0, R.CJ)(),
        $ = s.useRef(null),
        [Z, ee] = s.useState(!1),
        {
        ...
        eo = (t = null != (e = (0, o.bG)([b.A], () => b.A.getVoiceChannelId())) && null != en[e], l = (0, o.bG)([N.A], () => {
            if (!t) return !1;
            let e = N.A.getCurrentUserActiveStream();
            return null != e && null != en[e.channelId]
        }), V = (0, o.bG)([N.A], () => N.A.getAllApplicationStreams().some(e => null != en[e.channelId])), B = (0, o.bG)([T.A], () => t && null != e && T.A.hasVideo(e), [t, e]), H = (0, o.yK)([m.Ay], () => v.default.keys(en).reduce((e, t) => (e.push(...m.Ay.getEmbeddedActivitiesForChannel(t)), e), [])), F = (0, o.bG)([m.Ay], () => Array.from(m.Ay.getSelfEmbeddedActivities().values()).some(e => {
            let {
                location: t
            } = e, n = (0, p.H)(t);
            return null != n && null != en[n]
        })), K = H.length > 0, W = !1, Y = !1, z = !1, q = !1, t ? (W = !B, Y = B, z = l, q = F) : (z = V, q = K), (0, x.oi)({
            audio: W,
            video: Y,
            screenshare: z,
            liveStage: !1,
