/** chunk id: 842112, original params: e,l,t (module,exports,require) **/
t.d(l, {
    default: () => b
});
var r = t(627968);
...
function b(e) {
    let {
        ...
        unread: h,
        onSelect: x
    } = e, g = (0, d.bG)([o.Ay], () => o.Ay.getGuildFolderById(l), [l]), A = (0, d.bG)([s.A], () => s.A.getExpandedFolders().size > 0);
        ...
        children: [(0, r.jsx)(i.rXV, {
            ...
            children: [(0, r.jsx)(i.Drp, {
                ...
                action: () => (0, i.mMO)(async () => {
                    let {
                        default: e
                    } = await t.e("99116").then(t.bind(t, 672551));
                    return t => (0, r.jsx)(e, {
                        ...t,
                        folderId: l,
                        folderName: b,
