/** Chunk was on web.js **/
/** chunk id: 967158, original params: e,t,n (module,exports,require) **/
"use strict";
n.d(t, {
    M: () => f
});
...
function f(e) {
    let {
        ...
        onHoverEnd: l,
        isDisabled: c
    } = e, [u, f] = (0, s.useState)(!1), p = (0, s.useRef)({
        isHovered: !1,
    ...
    let {
        ...
        let e = (e, s) => {
            ...
            r = (e, t) => {
                let r = p.target;
                p.pointerType = "", p.target = null, "touch" !== t && p.isHovered && r && (p.isHovered = !1, h(), l && l({
                    type: "hoverend",
                    target: r,
                    pointerType: t
                }), n && n(!1), f(!1))
