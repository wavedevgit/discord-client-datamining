        ...
        v = (() => {
            ...
            switch (a) {
                ...
                default:
                    let l, s;
                    return {
                        width: r.width, height: (t = r.width, l = f ? t : t - b, s = (0, _.cP)(l - c, E.verticalRatio), f && (s += b), s + c)
                    }
            }
        })();
    return (0, _.UM)(v, {
...
function C(e) {
    let {
        ...
        width: "number" == typeof s.width ? s.width : p,
        height: "number" == typeof s.height ? s.height : (0, _.uc)(p)
    }, {
        width: h = o,
        height: f = u,
        ref: x
