...
let v = l.memo(function(e) {
    ...
    let v, {
        ...
        F = (t = R, n = b, l = O, o = C.contentType, w = C.originalContentType, t && g.A.isDiscordAssetUrl(n, o, w) ? (0, c.XW)(n, o, w) : (0, m.E)({
            proxyURL: l,
            url: n
        })),
    ...
    if ("VIDEO" === D && W && null != O) {
        ...
        if (null != k && L) return (0, i.jsx)(s.A, {
            attachment: k,
            src: F,
            posterUrl: e,
    ...
    return "IMAGE" === D && (v = W ? (0, i.jsx)(d.Ay, {
        ...V,
        src: F,
        width: M,
        height: P,
