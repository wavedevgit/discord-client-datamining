...
function T(e) {
    let {
        ...
        decoration: "never"
    }), d = (0, r.bG)([P.A], () => P.A.getNickname(t.id)), _ = (0, r.bG)([N.A], () => N.A.getStatus(t.id));
    return (0, i.jsx)(D.A, {
...
function y(e) {
    let {
        ...
        subLabel: s,
        ...a
    } = e, l = (0, r.bG)([E.A], () => E.A.getGuild(t?.guild_id)), u = (0, _.Ay)(t), d = (0, r.bG)([L.A, m.default, P.A], () => {
        let e = L.A.getChannel(t.parent_id);
        return null == e ? null : (0, _.m1)(e, m.default, P.A, !1)
    }), c = (0, r.bG)([C.Ay], () => C.Ay.lastMessageTimestamp(t.id, G.P.CHANNEL)), h = l?.name;
...
function F(e) {
    let {
    ...
    } = e, c = a.useMemo(() => n?.map(I.I) ?? [], [n]), o = a.useCallback(e => {
        let {
            section: a,
            row: n
        } = e;
        ...
        return o === d.rD.USER ? (0, i.jsx)(T, {
            user: h,
            ...P
        }) : o === d.rD.GROUP_DM ? (0, i.jsx)(S, {
            channel: h,
            ...P
        }) : o === d.rD.TEXT_CHANNEL || o === d.rD.VOICE_CHANNEL ? (0, i.jsx)(y, {
            channel: h,
            ...P
        }) : void(0, f.xb)(o)
    }, [A, r, s, l, t, c, u, _]);
