/** chunk id: 544036, original params: t,i,n (module,exports,require) **/
n.d(i, {
    default: () => C
});
var e = n(627968),
...
function C(t) {
    let {
        ...
        amountRedeemed: C,
        currencyCode: g
    } = t, h = (0, c.$g)(C, g), k = null != (0, a.bG)([o.A], () => o.A.getPremiumTypeSubscription()), m = s.useCallback(() => {
    ...
    return (0, e.jsx)("div", {
        ...
        children: (0, e.jsx)(l.kpP, {
            ...
            subtitle: u.intl.format(u.t.f3YCs1, {
                price: h,
