...
function j(e) {
    let t = (0, l.bG)([g.A], () => g.A.getNotificationStateForGuild(e), [e]),
        n = (0, l.bG)([_.A], () => _.A.getStateForGuild(e)),
        {
            indicator: p,
            showUnread: y
        } = function(e, t, n) {
            let s = (0, S.A)(e).available,
                {
                    shouldShow: o
                } = (0, b.A)(e, "useGuildPowerupsNotificationIndicator"),
            ...
            return i.useMemo(() => {
                ...
                let {
                    unlockedPowerups: e
                } = t, i = (0, x.k)([...Object.values(e), ...Object.values(u?.entitlements ?? {})]), l = n?.lastSeenWarningNotification ?? Date.now(), r = new Date(i[i.length - 1]?.ends_at).getTime(), a = n?.lastBoostCount ?? 0, o = i.length > 0 && l < r, c = s - a;
                return o || d ? {
                    indicator: {
                        type: f.cD.WARNING
                    },
        ...
        j = function(e, t) {
            let n, a, [p, g] = (0, C.ty)(null != t),
                _ = p === r.M.GUILD_POWERUP_PERKS_COACHMARK,
                {
                    available: x
                } = (0, S.A)(e),
                b = (0, l.bG)([c.A], () => c.A.getGuild(e)?.features.has(v.GuildFeatures.GAME_SERVERS) ?? !1),
                y = (0, l.bG)([A.A], () => A.A.getLowestGameCostForGuild(e)),
                j = (n = (0, h.C$)(e, "GuildPowerupsChannelRow"), a = (0, l.bG)([c.A], () => c.A.getGuild(e)?.features.has(v.GuildFeatures.GAME_SERVERS)), i.useMemo(() => {
                    let e = t?.allPowerups?.[s.zY] != null,
                        i = t?.unlockedPowerups?.[s.zY] != null;
                    return e && !i ? T.q.FILE_UPLOAD_250_MB : Array.from(T.r9[T.q.GUILD_TAG_BADGE_PACKS_WAVE_TWO]).some(e => t?.unlockedPowerups?.[e] != null) ? n && !a ? T.q.GAME_SERVER_HOSTING : Array.from(T.r9[T.q.GUILD_TAG_BADGE_PACKS_WAVE_ONE]).some(e => t?.unlockedPowerups?.[e] != null) ? 0 : T.q.GUILD_TAG_BADGE_PACKS_WAVE_ONE : T.q.GUILD_TAG_BADGE_PACKS_WAVE_TWO
                }, [t, n, a])),
                [R, O] = (0, C.FC)(null != t && !_, j),
                L = R === r.M.GUILD_POWERUP_NEW_PERK_AVAILABLE_COACHMARK,
                M = (0, E.A)(e),
                [D, G] = (0, C.ww)(null != t && !_ && !L && null != M, e),
                U = D === r.M.BOOST_TO_UNLOCK_COACHMARK,
                P = (0, I.A)(e),
                [k, w] = (0, C.W2)(null != t && !_ && !L && !U && null != P, e),
                V = k === r.M.EXPIRING_POWERUP_COACHMARK,
                B = (0, h.TS)(e, "useGuildPowerupsChannelListPopout"),
                [H, F] = (0, C.rd)(null != t && !_ && !L && !U && !V && B),
                K = H === r.M.GAME_SERVER_HOSTING_BATCH_RELEASE_V2_COACHMARK,
                W = (0, m.S)(e, "useGuildPowerupsChannelListPopout"),
                [Y, z] = (0, C.vn)(null != t && !b && B && W),
                q = Y === r.M.GAME_SERVER_PRICING_CHANGE_COACHMARK,
                X = i.useMemo(() => {
                    if (null == t || _ || L || K || q || U || V) return;
                    let n = function(e, t) {
                        let n = u.fi.find(e => {
                            let n = T.a8[e],
                    ...
                    let i = function(e, t, n) {
                        let i = c.A.getGuild(e)?.premiumTier ?? v.TVA.NONE,
                            s = Array.from(T.oN.values()).flatMap(s => s.length <= 0 || s.some(e => {
                        ...
                        if (0 !== s.length) {
                            ...
                            if (s.length > 1 && !(0, o.zs)(r.V.GUILD_POWERUP_CHOICE_SKU_PURCHASE_COACHMARK, e)) return {
                                type: f.o.PERKS_PURCHASABLE,
                                powerups: s,
                                markAsDismissed: t => {
                    ...
                    let s = function(e, t, n, i) {
                        if ((0, h.TS)(e, "maybeGetGameServerHostingGuildEligiblePopoutDCF") && !t && null != i && n >= i && !(0, o.zs)(r.V.GAME_SERVER_HOSTING_GUILD_ELIGIBLE_COACHMARK, e)) return {
                    ...
                    if (null != s) return s
                }, [e, t, _, L, K, q, U, V, x, b, y]),
                [J, Q] = (0, C.ru)(null != X);
            return i.useMemo(() => {
                if (null != t) {
                    if (_) return {
                        type: f.o.PERKS_AVAILABLE,
                        markAsDismissed: g
                    };
                    if (L) {
                        if (j === T.q.GAME_SERVER_HOSTING) return {
                            type: f.o.GAME_SERVER_HOSTING_AVAILABLE,
                            markAsDismissed: O
                        };
                        let e = T.r9[j],
                    ...
                    if (V && null != P) return {
                        ...
                        featuredExpiringPowerup: P,
                        markAsDismissed: w
                    };
                    if (K) return {
                        type: f.o.GAME_SERVER_NEW_GAMES,
                        markAsDismissed: F
                    };
                    if (q) return {
                    ...
                    if (J === r.M.GUILD_POWERUP_NOTIFICATION && null != X) return {
                        ...X,
                        markAsDismissed: e => {
            ...
            }, [t, _, g, X, J, Q, L, O, j, U, M, G, V, P, w, K, F, q, z])
        }(e, n ?? void 0);
    if (null !== n && (null != p || y || null != j)) return {
        indicator: p,
        showUnread: y,
        popout: j
    }
...
function R(e) {
    let t = (0, l.bG)([_.A], () => _.A.getStateForGuild(e)),
        n = j(e);
    i.useEffect(() => {
        (0, p.Zm)(e)
    }, [e]), i.useEffect(() => {
