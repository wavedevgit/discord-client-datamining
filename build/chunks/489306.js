    ...
    let t = (0, l.bG)([g.A], () => g.A.getNotificationStateForGuild(e), [e]),
        n = (0, l.bG)([p.A], () => p.A.getStateForGuild(e)),
        {
            ...
            return i.useMemo(() => {
                ...
                let {
                    unlockedPowerups: e
                } = t, i = (0, x.k)([...Object.values(e), ...Object.values(u?.entitlements ?? {})]), l = n?.lastSeenWarningNotification ?? Date.now(), a = new Date(i[i.length - 1]?.ends_at).getTime(), r = n?.lastBoostCount ?? 0, o = i.length > 0 && l < a, c = s - r;
                return o || d ? {
                    indicator: {
                        type: f.cD.WARNING
                    },
        ...
        j = function(e, t) {
            let n, r, [_, g] = (0, C.ty)(null != t),
                ...
                j = (n = (0, h.C$)(e, "GuildPowerupsChannelRow"), r = (0, l.bG)([c.A], () => c.A.getGuild(e)?.features.has(v.GuildFeatures.GAME_SERVERS)), i.useMemo(() => {
