    ...
    let t = (0, l.bG)([p.A], () => p.A.getNotificationStateForGuild(e), [e]),
        ...
        R = function(e, t) {
            let n, r, m, p, [g, C] = (0, E.ty)(null != t),
                ...
                L = (n = (0, x.gz)(e, "GuildPowerupsChannelRow"), r = (0, h.C$)(e, "GuildPowerupsChannelRow"), m = (0, f.RA)(e, "GuildPowerupsChannelRow"), p = (0, l.bG)([c.A], () => c.A.getGuild(e)?.features.has(y.GuildFeatures.GAME_SERVERS)), i.useMemo(() => {
                    ...
                    if (r && !p) return v.q.GAME_SERVER_HOSTING;
            ...
            return i.useMemo(() => {
                if (null != t) {
                    ...
                    if (X === a.M.GUILD_POWERUP_NOTIFICATION && null != q) return {
                        ...q,
                        markAsDismissed: e => {
