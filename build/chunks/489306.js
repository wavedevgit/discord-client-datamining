    ...
    let t = (0, l.bG)([p.A], () => p.A.getNotificationStateForGuild(e), [e]),
        n = (0, l.bG)([f.A], () => f.A.getStateForGuild(e)),
        {
            ...
            return i.useMemo(() => {
                ...
                let {
                    unlockedPowerups: e
                } = t, i = (0, E.k)([...Object.values(e), ...Object.values(u?.entitlements ?? {})]), l = n?.lastSeenWarningNotification ?? Date.now(), a = new Date(i[i.length - 1]?.ends_at).getTime(), r = n?.lastBoostCount ?? 0, o = i.length > 0 && l < a, c = s - r;
                return o || d ? {
                    indicator: {
                        type: x.cD.WARNING
                    },
        ...
        R = function(e, t) {
            let n, r, [g, p] = (0, C.ty)(null != t),
                ...
                R = (n = (0, h.C$)(e, "GuildPowerupsChannelRow"), r = (0, l.bG)([c.A], () => c.A.getGuild(e)?.features.has(y.GuildFeatures.GAME_SERVERS)), i.useMemo(() => {
            ...
            return i.useMemo(() => {
                if (null != t) {
                    ...
                    if ($ === a.M.GUILD_POWERUP_NOTIFICATION && null != J) return {
                        ...J,
                        markAsDismissed: e => {
