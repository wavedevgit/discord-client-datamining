    ...
    let t = (0, l.bG)([p.A], () => p.A.getNotificationStateForGuild(e), [e]),
        n = (0, l.bG)([g.A], () => g.A.getStateForGuild(e)),
        {
            ...
            return i.useMemo(() => {
                ...
                let {
                    unlockedPowerups: e
                } = t, i = (0, C.k)([...Object.values(e), ...Object.values(u?.entitlements ?? {})]), l = n?.lastSeenWarningNotification ?? Date.now(), a = new Date(i[i.length - 1]?.ends_at).getTime(), r = n?.lastBoostCount ?? 0, o = i.length > 0 && l < a, c = s - r;
                return o || d ? {
                    indicator: {
                        type: f.cD.WARNING
                    },
        ...
        R = function(e, t) {
            let n, r, _, [p, g] = (0, E.ty)(null != t),
                ...
                O = (n = (0, h.C$)(e, "GuildPowerupsChannelRow"), r = (0, x.RA)(e, "GuildPowerupsChannelRow"), _ = (0, l.bG)([c.A], () => c.A.getGuild(e)?.features.has(y.GuildFeatures.GAME_SERVERS)), i.useMemo(() => {
                    let e = t?.allPowerups?.[s.zY] != null,
                        i = t?.unlockedPowerups?.[s.zY] != null;
                    return e && !i ? v.q.FILE_UPLOAD_250_MB : r && !Array.from(v.r9[v.q.GUILD_TAG_BADGE_PACKS_WAVE_TWO]).some(e => t?.unlockedPowerups?.[e] != null) ? v.q.GUILD_TAG_BADGE_PACKS_WAVE_TWO : n && !_ ? v.q.GAME_SERVER_HOSTING : Array.from(v.r9[v.q.GUILD_TAG_BADGE_PACKS_WAVE_ONE]).some(e => t?.unlockedPowerups?.[e] != null) ? 0 : v.q.GUILD_TAG_BADGE_PACKS_WAVE_ONE
                }, [t, n, _, r])),
                ...
                Q = i.useMemo(() => {
                    ...
                    let i = function(e, t, n) {
                        let i = c.A.getGuild(e)?.premiumTier ?? y.TVA.NONE,
                            s = Array.from(v.oN.values()).flatMap(s => s.length <= 0 || s.some(e => {
                        ...
                        if (0 !== s.length) {
                            if (1 === s.length && !(0, o.zs)(a.V.GUILD_POWERUP_SINGLE_SKU_PURCHASE_COACHMARK, e)) return {
                            ...
                            if (s.length > 1 && !(0, o.zs)(a.V.GUILD_POWERUP_CHOICE_SKU_PURCHASE_COACHMARK, e)) return {
                                type: f.o.PERKS_PURCHASABLE,
                                powerups: s,
                                markAsDismissed: t => {
            ...
            return i.useMemo(() => {
                if (null != t) {
                    ...
                    if (D) {
                        if (O === v.q.GAME_SERVER_HOSTING) return {
                    ...
                    if ($ === a.M.GUILD_POWERUP_NOTIFICATION && null != Q) return {
                        ...Q,
                        markAsDismissed: e => {
