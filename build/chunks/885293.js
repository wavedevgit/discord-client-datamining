/** chunk id: 885293, original params: t,e,a (module,exports,require) **/
a.d(e, {
    default: () => x
});
var n = a(627968);
...
function x(t) {
    ...
    return (0, i.A)({
        ...
        actions: [{
            ...
            onClick: () => {
                D(), o.default.track(d.HAw.MASKED_LINK_MODAL_CLICKED, {
            ...
            onClick: () => {
                v(), o.default.track(d.HAw.MASKED_LINK_MODAL_CLICKED, {
                    is_trust_url_selected: A,
                    action_type: "confirm"
                })
            },
        ...
        children: [(0, n.jsxs)(r.HOs, {
            ...
            children: (0, n.jsx)(r.Checkbox, {
                checked: A,
                onChange: t => L(t),
                label: x ? u.intl.format(u.t["haA+Xw"], {
                    protocol: k.replace(":", "")
