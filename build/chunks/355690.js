/** chunk id: 355690, original params: e,t,i (module,exports,require) **/
i.d(t, {
    default: () => A
});
var n = i(627968),
...
function A(e) {
    let {
        classificationId: t,
        transitionState: i,
        initialSlide: A = g.yN.SPEED_BUMP,
        onClose: h
    } = e, [j, u] = a.useState(A), {
        classification: _,
        isDsaEligible: C
    } = (0, r.LJ)(t ?? p.dJq), E = _?.is_spam || !1, I = _?.is_coppa || !1, S = _?.appeal_ingestion_type;
    a.useEffect(() => {
        u(A)
    }, [u, A]);
    let T = a.useCallback(() => {
