/** chunk id: 779457 params = (module,exports,require) **/
n.d(e, {
    default: () => P
});
var i = n(627968),
...
function T(t) {
    let {
        ...
        guildId: n,
        skuPricePreview: s
    } = t, l = (0, _.z)(e), r = (0, g.$g)(s.amount, s.currency), a = (0, o.bG)([j.A], () => j.A.getGuild(n));
    return c()(null != a, "guild cannot be null"), (0, i.jsxs)("div", {
        className: y.Tp,
...
function C(t) {
    let {
        guildProductListing: e,
        guildId: n
    } = t, s = e.attachments ?? [], l = s.length > 1, a = (0, K.A)({
        guildId: n,
        productId: e.id
    });
    return 0 === s.length ? null : (0, i.jsx)(z.A, {
...
function k(t) {
    ...
    return null == e ? null : (0, i.jsx)(z.A, {
        label: b.intl.string(b.t.gWBNet),
...
function P(t) {
    let {
        ...
        guildId: r,
        skuPricePreview: a
    } = t, u = (0, o.bG)([p.A], () => p.A.getGuildProduct(l));
    ...
    return (0, i.jsx)(d.Modal, {
        ...
        subtitle: b.intl.format(b.t.X6yvvo, {
            productName: u.name,
            emphasisHook: O
        }),
        onClose: e,
        ...
        size: "md",
        actions: [],
        children: h ? (0, i.jsx)(m.y$y, {}) : (0, i.jsxs)(i.Fragment, {
            children: [(0, i.jsxs)(m.Text, {
                variant: "text-md/normal",
                color: "text-default",
                children: [g ? b.intl.string(b.t["A/RnkK"]) + " " : "", null != N ? b.intl.format(b.t.IeJDKs, {
                    roleName: N.name,
                    emphasisHook: O
                }) : ""]
            }), (0, i.jsx)(m.hKd, {
