...
let p = e => {
    ...
    g = e => {
        ...
        if (c < r) return null;
        let m = l()(n).filter(_.Vq).take(a).map(e => (0, i.jsx)(p, {
            member: e,
            guildId: s
        }, e.id)).value();
        for (let e = 0; e < d && m.length < a; e++) m.push((0, i.jsx)(p, {
            guildId: s
        }, `unknown-member-${e}`));
        let g = c - u - d;
        for (let e = 0; e < g && m.length < a; e++) m.push((0, i.jsx)(p, {
            empty: !0,
            guildId: s
        }, `empty-member-${e}`));
