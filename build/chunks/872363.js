/** chunk id: 872363 params = (module,exports,require) **/
n.d(t, {
    A: () => P
});
var i = n(627968),
...
let N = (0, o.xI)(h.A.LIVE_INDICATOR_BORDER_RADIUS),
    ...
    O = e => {
        ...
        let O = t || s,
            ...
            U = o && !E.Ay.isPremium(w, I.PremiumTypes.TIER_1) && !E.Ay.canStreamQuality(E.Ay.StreamQuality.MID, w),
            k = l.useCallback(() => {
                U && O && (0, m.mMO)(async () => {
                    let {
                        default: e
        ...
        if (l.useEffect(() => {
            ...
            }, [t, s, O, y, b, L]), null == M) return null;
        let G = (0, i.jsx)(u.m, {
