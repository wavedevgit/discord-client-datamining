/** chunk id: 897295 params = (module,exports,require) **/
"use strict";
n.d(t, {
    A: () => m,
    B: () => o
...
async function c(e, t) {
    ...
    try {
        ...
        let e, n = new l.LG(s).errors;
        if ("object" != typeof n || n?.trigger_metadata?.regex_patterns == null) return;
        let i = null == (e = n?.trigger_metadata?.regex_patterns) ? [] : function(e) {
            let {
                [o]: t = [], ...n
            } = e, i = Object.entries(n).map(e => {
                let [t, n] = e, i = n[o], {
                    code: s,
                    message: l
                } = i?.[0] ?? {
...
let u = (0, s.throttle)(c, 1e3, {
    leading: !1
});

function m(e, t) {
    let [n, l] = i.useState([]), [r, a] = i.useState(null), [o, d] = i.useState(e?.triggerMetadata?.regexPatterns ?? []), m = i.useCallback(t => {
        t.length < 3 || u({
            ...e,
            triggerMetadata: {
                ...e.triggerMetadata,
    ...
    return {
        ...
        errors: n,
        valueError: r,
        validatePatternsChanged: i.useCallback((n, i) => {
            (0, s.isEqual)(n, i) || (u.cancel(), c({
                ...e,
                triggerMetadata: {
                    ...e.triggerMetadata,
                    regexPatterns: n
