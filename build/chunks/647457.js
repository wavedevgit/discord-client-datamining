/** Chunk was on web.js **/
/** chunk id: 647457, original params: e,t,n (module,exports,require) **/
"use strict";
n.d(t, {
    A: () => _
}), n(65821);
...
class _ extends r.EventEmitter {
    destroy() {
        var e, t, n;
        this.removeAllListeners(), null == (e = (t = this).cleanup) || e.call(t), this.reset(), null != this.stream && (p.release(this.stream), this.stream = void 0), null == (n = this._audioFilter) || n.dispose(), this._audioFilter = void 0, this.destroyed = !0
    }
    reset() {
        this.setSpeaking(!1)
    }
    ...
    updateMode() {
        null != this.cleanup && (this.cleanup(), this.cleanup = void 0), null != this.stream && this.mode === c.TB.VOICE_ACTIVITY && (this.cleanup = this.setupVoiceActivity(this.modeOptions))
    }
    ...
    constructor(e) {
        super(), d(this, "stream", void 0), d(this, "context", void 0), d(this, "sourceId", void 0), d(this, "_mute", !1), d(this, "_echoCancellation", !0), d(this, "_noiseSuppression", !0), d(this, "_automaticGainControl", !0), d(this, "_noiseCancellation", !1), d(this, "_audioFilter", void 0), d(this, "speaking", !1), d(this, "mode", c.TB.VOICE_ACTIVITY), d(this, "modeOptions", {
            delay: 20,
            threshold: -40
