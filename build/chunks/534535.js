/** chunk id: 534535 params = (module,exports,require) **/ ! function(r) {
    "use strict";
    var n = "function",
        i = "undefined",
        o = "object",
        ...
        V = function(t, e) {
            for (var r, i, a, s, u, c, l = 0; l < e.length && !u;) {
                ...
                for (r = i = 0; r < f.length && !u && f[r];)
                    if (u = f[r++].exec(t))
                        for (a = 0; a < p.length; a++) c = u[++i], typeof(s = p[a]) === o && s.length > 0 ? 2 === s.length ? typeof s[1] == n ? this[s[0]] = s[1].call(this, c) : this[s[0]] = s[1] : 3 === s.length ? typeof s[1] !== n || s[1].exec && s[1].test ? this[s[0]] = c ? c.replace(s[1], s[2]) : void 0 : this[s[0]] = c ? s[1].call(this, c, s[2]) : void 0 : 4 === s.length && (this[s[0]] = c ? s[3].call(this, c.replace(s[1], s[2])) : void 0) : this[s] = c || void 0;
                l += 2
            }
        },
        G = function(t, e) {
            for (var r in e)
                if (typeof e[r] === o && e[r].length > 0) {
                    for (var n = 0; n < e[r].length; n++)
                        if (q(e[r][n], t)) return "?" === r ? void 0 : r
        ...
        Y = function(t, e) {
            ...
            return this.getBrowser = function() {
                var t, e = {};
                return e[c] = void 0, e[p] = void 0, V.call(e, v, _.browser), e[s] = typeof(t = e[p]) === a ? t.replace(/[^\d\.]/g, "").split(".")[0] : void 0, b && d && d.brave && typeof d.brave.isBrave == n && (e[c] = "Brave"), e
            }, this.getCPU = function() {
                var t = {};
                return t[h] = void 0, V.call(t, v, _.cpu), t
            }, this.getDevice = function() {
                var t = {};
                return t[f] = void 0, t[u] = void 0, t[l] = void 0, V.call(t, v, _.device), b && !t[l] && m && m.mobile && (t[l] = g), b && "Macintosh" == t[u] && d && typeof d.standalone !== i && d.maxTouchPoints && d.maxTouchPoints > 2 && (t[u] = "iPad", t[l] = y), t
            }, this.getEngine = function() {
                var t = {};
                return t[c] = void 0, t[p] = void 0, V.call(t, v, _.engine), t
            }, this.getOS = function() {
                var t = {};
                return t[c] = void 0, t[p] = void 0, V.call(t, v, _.os), b && !t[c] && m && m.platform && "Unknown" != m.platform && (t[c] = m.platform.replace(/chrome os/i, F).replace(/macos/i, z)), t
    ...
    Y.VERSION = "0.7.40", Y.BROWSER = U([c, p, s]), Y.CPU = U([h]), Y.DEVICE = U([u, f, l, d, g, v, y, m, _]), Y.ENGINE = Y.OS = U([c, p]), typeof e !== i ? (t.exports && (e = t.exports = Y), e.UAParser = Y) : typeof define === n && define.amd ? define(function() {
        return Y
    }) : typeof r !== i && (r.UAParser = Y);
    var $ = typeof r !== i && (r.jQuery || r.Zepto);
    if ($ && !$.ua) {
        var Z = new Y;
        $.ua = Z.getResult(), $.ua.get = function() {
            return Z.getUA()
        }, $.ua.set = function(t) {
            Z.setUA(t);
            var e = Z.getResult();
