...
function M(e) {
    ...
    return (0, l.jsxs)("div", {
        ...
        children: [(0, l.jsx)(S.A, {
            icon: c._Jp,
            iconClassName: x.pl,
            description: f.intl.formatToPlainString(f.t.sQBgs2, {
            ...
            icon: c._Jp,
            iconClassName: x.pl,
            description: f.intl.formatToPlainString(f.t["1A6vXi"], {
                percent: (0, P.l9)(t, y.oX / 100)
            }),
            color: c.LU0.unsafe_rawColors.GUILD_BOOSTING_PINK.css
        }), n ? (0, l.jsx)(S.A, {
            icon: c.nm2,
            iconClassName: x.zO,
            description: f.intl.string(f.t.Z9b2x2)
        }) : null, (0, l.jsx)(S.A, {
            icon: c.Fzq,
            iconClassName: x.Kg,
            description: f.intl.string(f.t["8dqG5E"])
        }), (0, l.jsx)(S.A, {
            icon: c.JMY,
            iconClassName: x.$z,
            description: f.intl.string(f.t.cBorIy)
        })]
    })
}
