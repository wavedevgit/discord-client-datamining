/** chunk id: 908031, original params: e,t,n (module,exports,require) **/
"use strict";
n.d(t, {
    A: () => a
});
    ...
    refine(e, t) {
        return e.option.forwardDate && t.forEach(t => {
            ...
            if (t.start.isOnlyTime() && e.reference.instant > t.start.date()) {
                let n = e.reference.getDateWithAdjustedTimezone(),
                    i = new Date(n);
                i.setDate(i.getDate() + 1), r.Hq(t.start, i), e.debug(() => {
                    console.log(`${this.constructor.name} adjusted ${t} time from the ref date (${n}) to the following day (${i})`)
                }), t.end && t.end.isOnlyTime() && (r.Hq(t.end, i), t.start.date() > t.end.date() && (i.setDate(i.getDate() + 1), r.Hq(t.end, i)))
            }
            if (t.start.isOnlyWeekdayComponent() && n > t.start.date()) {
                let a = t.start.get("weekday") - n.getDay();
                if (a <= 0 && (a += 7), n = (0, i.Gw)(n, {
                        day: a
                    }), (0, r.Hq)(t.start, n), e.debug(() => {
