/** Chunk was on 47914 **/
/** chunk id: 905297, original params: e,r,t (module,exports,require) **/
t.r(r), t.d(r, {
    default: () => a
});
var a = {
    ...
    "creditCard.holderName.invalid": "Entrez le nom tel qu'il appara\xeet sur la carte",
    ...
    "creditCard.cvcField.title": "Code de s\xe9curit\xe9",
    ...
    "sr.wechatpay.timetopay": "Vous disposez de %#\xa0minutes%# et %#\xa0secondes%# pour effectuer le paiement",
    ...
    firstName: "Pr\xe9nom",
    "firstName.invalid": "Entrez votre pr\xe9nom",
    infix: "Pr\xe9fixe",
    lastName: "Nom de famille",
    "lastName.invalid": "Entrez votre nom",
    ...
    gender: "Sexe",
    "gender.notselected": "S\xe9lectionnez un sexe",
    male: "Homme",
    female: "Femme",
    ...
    cityTown: "Ville",
    address: "Adresse",
    "address.placeholder": "Trouvez votre adresse",
    "address.errors.incomplete": "Saisissez une adresse pour continuer",
    "address.enterManually": "Saisissez l'adresse manuellement",
    state: "\xc9tat",
    "field.title.optional": "(facultatif)",
    "creditCard.cvcField.title.optional": "Code de s\xe9curit\xe9 (facultatif)",
    ...
    "error.va.sf-cc-num.01": "Entrez un num\xe9ro de carte valide",
    "error.va.sf-cc-num.02": "Entrez le num\xe9ro de la carte",
    "error.va.sf-cc-num.03": "Entrez un \xe9metteur de carte pris en charge",
    "error.va.sf-cc-num.04": "Entrez le num\xe9ro de carte complet",
    "error.va.sf-cc-dat.01": "Entrez une date d'expiration valide",
    "error.va.sf-cc-dat.02": "Entrez une date d'expiration valide",
    "error.va.sf-cc-dat.03": "La carte de cr\xe9dit arrive \xe0 expiration",
    "error.va.sf-cc-dat.04": "Entrez la date d'expiration",
    "error.va.sf-cc-dat.05": "Entrez la date d'expiration compl\xe8te",
    "error.va.sf-cc-mth.01": "Entrez le mois d'expiration",
    "error.va.sf-cc-yr.01": "Entrez l'ann\xe9e d'expiration",
    "error.va.sf-cc-yr.02": "Entrez l'ann\xe9e d'expiration compl\xe8te",
    "error.va.sf-cc-cvc.01": "Entrez le code de s\xe9curit\xe9",
    "error.va.sf-cc-cvc.02": "Entrez le code de s\xe9curit\xe9 complet",
    ...
    "creditCard.encryptedCardNumber.aria.iframeTitle": "Iframe pour le num\xe9ro de carte",
    "creditCard.encryptedCardNumber.aria.label": "Num\xe9ro de la carte",
    "creditCard.encryptedExpiryDate.aria.iframeTitle": "Iframe pour la date d'expiration",
    "creditCard.encryptedExpiryDate.aria.label": "Date d'expiration",
    "creditCard.encryptedExpiryMonth.aria.iframeTitle": "Iframe pour le mois d'expiration",
    "creditCard.encryptedExpiryMonth.aria.label": "Mois d'expiration",
    "creditCard.encryptedExpiryYear.aria.iframeTitle": "Iframe pour l'ann\xe9e d'expiration",
    "creditCard.encryptedExpiryYear.aria.label": "Ann\xe9e d'expiration",
    "creditCard.encryptedSecurityCode.aria.iframeTitle": "Iframe pour le code de s\xe9curit\xe9",
    "creditCard.encryptedSecurityCode.aria.label": "Code de s\xe9curit\xe9",
    "creditCard.encryptedPassword.aria.iframeTitle": "Iframe pour le mot de passe",
    "creditCard.encryptedPassword.aria.label": "Les deux premiers chiffres du code de votre carte",
    "giftcard.encryptedCardNumber.aria.iframeTitle": "Iframe pour le num\xe9ro de carte",
    "giftcard.encryptedCardNumber.aria.label": "Num\xe9ro de la carte",
    "giftcard.encryptedSecurityCode.aria.iframeTitle": "Iframe pour le code secret",
    ...
    "ach.encryptedBankAccountNumber.aria.iframeTitle": "Iframe pour le num\xe9ro de compte bancaire",
    "ach.encryptedBankAccountNumber.aria.label": "Num\xe9ro du compte",
    "ach.encryptedBankLocationId.aria.iframeTitle": "Iframe pour le num\xe9ro de routage bancaire",
    "ach.encryptedBankLocationId.aria.label": "Code ABA",
    ...
    "onlineBankingPL.termsAndConditions": "En continuant, vous acceptez les %#r\xe9glementations%# et l'%#obligation d'information%# de Przelewy24",
    ...
    "companyDetails.registrationNumber.invalid": "Entrez le num\xe9ro d'identification",
    "consent.checkbox.invalid": "Vous devez accepter les conditions g\xe9n\xe9rales",
    "form.instruction": "Tous les champs sont obligatoires, sauf indication contraire.",
    "trustly.descriptor": "Paiement bancaire instantan\xe9",
    "trustly.description1": "Payez directement \xe0 partir de n'importe lequel de vos comptes bancaires, avec une s\xe9curit\xe9 de niveau bancaire",
    "trustly.description2": "Aucune carte, aucun t\xe9l\xe9chargement d'application, aucune inscription"
}