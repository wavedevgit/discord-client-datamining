...
function _(e) {
    ...
    } = (0, c.Ay)(), n = e.interactionMetadata?.authorizing_integration_owners[a.b.USER_INSTALL], _ = e.interactionMetadata?.authorizing_integration_owners[a.b.GUILD_INSTALL], S = e.interactionMetadata?.user.id, b = (0, r.bG)([y.default], () => y.default.getUser(n)), v = (0, r.bG)([h.A], () => h.A.getGuild(_)), I = f.A.getChannel(e.channel_id), T = I?.getGuildId(), x = (0, r.bG)([y.default], () => y.default.getUser(S));
    if (l.useEffect(() => {
