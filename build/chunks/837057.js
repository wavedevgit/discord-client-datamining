    ...
    transitionToGlobalDiscovery: () => function e(t) {
        ...
        switch (c.A.setState({
            ...
            case u.GlobalDiscoveryTab.SERVERS:
                ...
                return null != p ? a.A.setState({
                    selectedTab: p,
                    entrypoint: t.entrypoint ?? h.J8.UNKNOWN
                }) : a.A.setState({
                    entrypoint: t.entrypoint ?? h.J8.UNKNOWN
                }), (0, s.pX)(_.BVt.GLOBAL_DISCOVERY_SERVERS, t.extra);
            case u.GlobalDiscoveryTab.APPS:
                ...
                if (null != t.applicationId) {
                    if (t.section === m.GlobalDiscoveryAppsSections.STORE)
                        if (null != t.skuId) return (0, s.pX)(_.BVt.GLOBAL_DISCOVERY_APPS_PROFILE_STORE_SKU(t.applicationId, t.skuId));
                        else return (0, s.pX)(_.BVt.GLOBAL_DISCOVERY_APPS_PROFILE_SECTION(t.applicationId, m.GlobalDiscoveryAppsSections.STORE));
                    return (0, s.pX)(_.BVt.GLOBAL_DISCOVERY_APPS_PROFILE(t.applicationId))
                }
                if (null != t.query) {
                    let e = new URLSearchParams;
                    return "" !== t.query && e.set("q", t.query), null != t.categoryId && e.set("category_id", t.categoryId.toString()), null != t.page && e.set("page", t.page.toString()), (0, s.pX)(_.BVt.GLOBAL_DISCOVERY_APPS_SEARCH, {
                        search: e.toString()
                    })
                }
                if (null != t.categoryId) return (0, s.pX)(_.BVt.GLOBAL_DISCOVERY_APPS_CATEGORY(t.categoryId.toString()));
                else return (0, s.pX)(_.BVt.GLOBAL_DISCOVERY_APPS);
