...
function ei(e) {
    ...
    "alt" !== e.key.toLowerCase() || t || ("keyup" === e.type.toLowerCase() ? j._.dispatch(K.jej.OVERLAY_V3_SHOW_WIDGETS, {
            show: !0
        }) : "keydown" === e.type.toLowerCase() && j._.dispatch(K.jej.OVERLAY_V3_SHOW_WIDGETS, {
            show: !1
        })),
        function(e, t) {
...
let es = s.memo(function() {
    ...
    el = s.memo(function() {
        let e = (0, W.A)(),
            ...
            u = (0, a.bG)([T.Ay], () => null != T.Ay.getOverlayKeybind() ? (0, w.dI)(T.Ay.getOverlayKeybind()?.shortcut, !0) : "???", []);
        return s.useEffect(() => {
            if (j._.dispatch(K.jej.OVERLAY_V3_SHOW_WIDGETS, {
                    show: !0
                }), n) return (0, o.closeAllModalsInContext)(d.KX8), e.addEventListener("contextmenu", J, !1), () => {
...
function er(e) {
    ...
    return (0, z.e)(), (0, h.Ay)(() => {
        ...
        c.A.overlayReady(G.A.getTargetPID()), l.addEventListener("keydown", ei, !0), l.addEventListener("keyup", ei)
    }, n = () => {
        ...
        !u && (m.push({
            ...
            type: X.Jr.GO_LIVE_VOICE,
            game: e,
            voiceChannelId: t,
            voiceGuild: i
        }) : r && m.push({
            type: X.Jr.GO_LIVE_NON_VOICE,
            game: e
        })), g || m.push({
            type: X.Jr.CONTENT_INVENTORY,
            entries: []
