...
let b = (0, v.createContext)(null),
    ...
    R = (0, v.forwardRef)(function(e, a) {
        ...
        let {
            ...
            ...e,
            locale: t,
            createCalendar: e.createCalendar || y.d
        }), {
            calendarProps: m,
            prevButtonProps: h,
            nextButtonProps: D,
        ...
        }, v.createElement(d.s, null, v.createElement("h2", null, m["aria-label"])), w.children, v.createElement(d.s, null, v.createElement("button", {
    ...
    k = (0, v.forwardRef)(function(e, a) {
        ...
        }, "function" != typeof e.children ? e.children : v.createElement(v.Fragment, null, v.createElement(x, null, e => v.createElement(C, null, e)), v.createElement(E, null, e.children))))
    }),
    x = (0, v.forwardRef)(function(e, a) {
        ...
        }, v.createElement("tr", null, o.map((e, a) => v.cloneElement(t(e), {
            key: a
        }))))
    }),
    ...
    E = (0, v.forwardRef)(function(e, a) {
        let {
            ...
            style: r,
            className: n
        } = e, i = (0, v.useContext)($), o = (0, v.useContext)(w), u = null != i ? i : o, {
            startDate: l,
            weeksInMonth: s
        } = (0, v.useContext)(P), d = (0, f.$)(e, {
            global: !0
        });
        return v.createElement("tbody", {
            ...
            key: e
        }, u.getDatesInWeek(e, l).map((e, a) => e ? v.cloneElement(t(e), {
            key: a
        }) : v.createElement("td", {
            key: a
        })))))
    }),
    S = (0, v.forwardRef)(function({
        date: e,
        ...a
    }, t) {
        var r;
        let i = (0, v.useContext)($),
            ...
            {
                startDate: l
            } = null != (r = (0, v.useContext)(P)) ? r : {
                startDate: u.visibleRange.start
            },
            d = !(0, p.tF)(l, e),
        ...
        let E = !1,
            S = !1;
        "highlightedRange" in u && u.highlightedRange && (E = (0, p.ro)(e, u.highlightedRange.start), S = (0, p.ro)(e, u.highlightedRange.end));
        let F = (0, n.Sl)({
                ...a,
