/** chunk id: 968172, original params: e,a,t (module,exports,require) **/
t.d(a, {
    Vv: () => C,
    W$: () => V,
    Xq: () => F,
...
let R = (0, A.createContext)(null),
    ...
    C = (0, A.forwardRef)(function(e, a) {
        ...
        let {
            ...
            ...e,
            locale: t,
            createCalendar: e.createCalendar || p.d
        }), {
            calendarProps: m,
            prevButtonProps: h,
            nextButtonProps: y,
        ...
        }, A.createElement(d.s, null, A.createElement("h2", null, m["aria-label"])), f.children, A.createElement(d.s, null, A.createElement("button", {
    ...
    k = (0, A.forwardRef)(function(e, a) {
        ...
        let {
            ...
            errorMessageProps: D,
            title: g
        } = (0, c.p)(e, u, a), v = (0, n.Sl)({
            ...e,
            values: {
                state: u,
                isDisabled: e.isDisabled || !1,
                isInvalid: u.isValueInvalid
            },
        ...
        }, A.createElement(d.s, null, A.createElement("h2", null, m["aria-label"])), v.children, A.createElement(d.s, null, A.createElement("button", {
            "aria-label": y["aria-label"],
            disabled: y.isDisabled,
    ...
    E = (0, A.forwardRef)(function(e, a) {
        ...
        }, "function" != typeof e.children ? e.children : A.createElement(A.Fragment, null, A.createElement(S, null, e => A.createElement(V, null, e)), A.createElement(F, null, e.children))))
    }),
    S = (0, A.forwardRef)(function(e, a) {
        ...
        }, A.createElement("tr", null, l.map((e, a) => A.cloneElement(t(e), {
            key: a
        }))))
    }),
    ...
    F = (0, A.forwardRef)(function(e, a) {
        let {
            ...
            style: r,
            className: n
        } = e, i = (0, A.useContext)(w), l = (0, A.useContext)(P), o = null != i ? i : l, {
            startDate: u,
            weeksInMonth: s
        } = (0, A.useContext)(x), d = (0, b.$)(e, {
            global: !0
        });
        ...
        }, [...Array(s).keys()].map(e => A.createElement("tr", {
            key: e
        }, o.getDatesInWeek(e, u).map((e, a) => e ? A.cloneElement(t(e), {
            key: a
        }) : A.createElement("td", {
            key: a
        })))))
    ...
    B = (0, A.forwardRef)(function({
        ...
        let E = !1,
            S = !1;
        "highlightedRange" in o && o.highlightedRange && (E = (0, g.ro)(e, o.highlightedRange.start), S = (0, g.ro)(e, o.highlightedRange.end));
        let V = (0, n.Sl)({
                ...a,
