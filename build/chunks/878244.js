...
function P(i) {
    let {
        ...
        channelId: O,
        numMoreItems: y
    } = i, [G, M] = n.useState(!1), m = null != y && y > 0, P = n.useCallback(() => {
        if (m) return void l();
    ...
    }, [t, c, u, e.id, e.productLine, l, m]), b = n.useCallback(() => {
        let i = u === k.uS.WISHLIST ? "wishlist" : "shop";
        _.default.track(x.HAw.GIFTING_ITEM_CLICKED, {
            sku_id: e.id,
            item_source: i,
    ...
    return (0, s.jsxs)(E.A, {
        ...
        onClick: P,
        "aria-label": m ? v.intl.formatToPlainString(v.t["8uYD+I"], {
            username: a.username
        }) : v.intl.formatToPlainString(v.t.ZBB4Ty, {
            productName: (0, g.TC)(e)
        }),
        ...
        children: [(0, s.jsx)(S.A, {
            ...
            replacedElement: d && u === k.uS.WISHLIST ? (0, s.jsx)(h.X, {
                spec: C,
                users: [a],
                guildId: A ?? void 0,
                channelId: O ?? void 0
...
function b(i) {
    let {
        ...
        source: d,
        ...p
    } = i, I = (0, a.bG)([u.A], () => u.A.getApplication(e.applicationId)), _ = n.useCallback(() => {
        o?.(), null != I && null != I.guildId && (0, f.R)({
            skuId: e.id,
    ...
    }, [r, I, o, e.applicationId, e.id, t]), g = n.useCallback(() => {
        o?.(), (0, C.a)(e, {
            isGift: !0,
            giftRecipient: t,
            giftingOrigin: M
...
function j(i) {
    ...
    return (0, s.jsx)(P, {
        ...
        skuPreviewHoverStyle: o()({
            [w.m]: null != e.bundledSkus && e.bundledSkus.length > 0 || e.tenantMetadata?.collectibles?.type !== l.R.NAMEPLATE && e.tenantMetadata?.collectibles?.type !== l.R.PROFILE_EFFECT
        }),
        ...p
    })
}
