...
function y(t) {
    ...
    }), []), [M, G] = r.useState(!1), N = I === E - 1 && g > E, P = r.useCallback(() => {
        if (N) return void l();
    ...
    }, [i, c, u, e.id, e.productLine, l, N]), v = r.useCallback(() => {
        let t = u === A.uS.WISHLIST ? "wishlist" : "shop";
        p.default.track(L.HAw.GIFTING_ITEM_CLICKED, {
            sku_id: e.id,
            item_source: t,
    ...
    return (0, n.jsxs)(m.A, {
        ...
        children: [d && u === A.uS.WISHLIST && (0, n.jsx)(T.X, {
            spec: O,
            users: [o],
            guildId: k ?? void 0,
            channelId: R ?? void 0
...
function M(t) {
    let {
        ...
        source: o,
        ...g
    } = t, p = (0, c.bG)([d.A], () => d.A.getApplication(e.applicationId)), A = r.useCallback(() => {
        a?.(), null != p && null != p.guildId && (0, I.R)({
            skuId: e.id,
    ...
    }, [s, p, a, e.applicationId, e.id]), m = r.useCallback(() => {
        a?.(), (0, _.a)(e, {
            isGift: !0,
            giftRecipient: i,
            giftingOrigin: k
...
function G(t) {
    ...
    return (0, n.jsx)(y, {
        ...
        source: d,
        skuPreviewStyle: a()({
            [h.qF]: e.tenantMetadata?.collectibles?.type === l.R.NAMEPLATE
        }),
        skuPreviewHoverStyle: a()({
            [h.mn]: null != e.bundledSkus && e.bundledSkus.length > 0 || e.tenantMetadata?.collectibles?.type !== l.R.NAMEPLATE && e.tenantMetadata?.collectibles?.type !== l.R.PROFILE_EFFECT
        }),
        ...I
    })
}
