...
function N(t) {
    ...
    }, [i, c, u, e.id, e.productLine, s, b]), v = r.useCallback(() => {
        let t = u === A.uS.WISHLIST ? "wishlist" : "shop";
        _.default.track(h.HAw.GIFTING_ITEM_CLICKED, {
            sku_id: e.id,
            item_source: t,
...
function b(t) {
    ...
    }, [a, p, l, e.applicationId, e.id, i]), f = r.useCallback(() => {
        l?.(), (0, I.a)(e, {
            isGift: !0,
            giftRecipient: i,
            giftingOrigin: y
...
function P(t) {
    ...
    return (0, n.jsx)(N, {
        ...
        skuPreviewHoverStyle: l()({
            [G.m]: null != e.bundledSkus && e.bundledSkus.length > 0 || e.tenantMetadata?.collectibles?.type !== s.R.NAMEPLATE && e.tenantMetadata?.collectibles?.type !== s.R.PROFILE_EFFECT
        }),
        ...g
    })
}
