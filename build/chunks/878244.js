...
function F(i) {
    let {
        ...
        channelId: R,
        numMoreItems: H
    } = i, [b, j] = n.useState(!1), D = (0, L.Ar)(), F = (0, d.A)(() => (0, c.A)()), B = null != H && H > 0, {
        handleVisibilityChange: W
    } = (0, g.G)(F), U = (0, l.K)(W, .5, !B);
    (0, T.J)(b && !B, F);
    let Y = n.useCallback(() => {
            if (B) return void u();
    ...
    return (0, s.jsx)("div", {
        ...
        children: (0, s.jsxs)(A.A, {
            ...
            onClick: Y,
            "aria-label": B ? G.intl.formatToPlainString(G.t["8uYD+I"], {
                username: a.username
            }) : G.intl.formatToPlainString(G.t.ZBB4Ty, {
                productName: (0, E.TC)(e)
            }),
            ...
            children: [(0, s.jsx)(m.A, {
                ...
                replacedElement: I && p === w.uS.WISHLIST ? (0, s.jsx)(v.X, {
                    spec: k,
                    users: [a],
                    guildId: x ?? void 0,
                    channelId: R ?? void 0
...
function B(i) {
    let {
        ...
        source: l,
        ...u
    } = i, d = (0, a.bG)([p.A], () => p.A.getApplication(e.applicationId)), I = n.useCallback(() => {
        o?.(), null != d && null != d.guildId && (0, C.R)({
            skuId: e.id,
    ...
    }, [r, d, o, e.applicationId, e.id, t]), f = n.useCallback(() => {
        o?.(), (0, k.a)(e, {
            isGift: !0,
            giftRecipient: t,
            giftingOrigin: j
...
function W(i) {
    ...
    return (0, s.jsx)(F, {
        ...
        skuPreviewHoverStyle: o()({
            [P.m]: null != e.bundledSkus && e.bundledSkus.length > 0 || e.tenantMetadata?.collectibles?.type !== u.R.NAMEPLATE && e.tenantMetadata?.collectibles?.type !== u.R.PROFILE_EFFECT
        }),
        ...d
    })
}
