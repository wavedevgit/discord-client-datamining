...
function b(t) {
    let {
        ...
        channelId: L,
        numMoreItems: k
    } = t, [M, b] = a.useState(!1), N = null != k && k > 0, R = a.useCallback(() => {
        if (N) return void r();
    ...
    }, [e, c, u, i.id, i.productLine, r, N]), y = a.useCallback(() => {
        let t = u === f.uS.WISHLIST ? "wishlist" : "shop";
        _.default.track(C.HAw.GIFTING_ITEM_CLICKED, {
            sku_id: i.id,
            item_source: t,
    ...
    return (0, n.jsxs)(p.A, {
        ...
        children: [d && u === f.uS.WISHLIST && (0, n.jsx)(S.X, {
            spec: h,
            users: [o],
            guildId: E ?? void 0,
            channelId: L ?? void 0
...
function N(t) {
    ...
    }, [s, f, l, i.applicationId, i.id]), A = a.useCallback(() => {
        l?.(), (0, I.a)(i, {
            isGift: !0,
            giftRecipient: e,
            giftingOrigin: k
...
function R(t) {
    ...
    return (0, n.jsx)(b, {
        ...
        skuPreviewHoverStyle: l()({
            [O.m]: null != i.bundledSkus && i.bundledSkus.length > 0 || i.tenantMetadata?.collectibles?.type !== r.R.NAMEPLATE && i.tenantMetadata?.collectibles?.type !== r.R.PROFILE_EFFECT
        }),
        ...g
    })
}
