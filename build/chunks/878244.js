...
function y(t) {
    let {
        ...
        channelId: h,
        numMoreItems: G
    } = t, [R, y] = r.useState(!1), M = null != G && G > 0, N = r.useCallback(() => {
        if (M) return void l();
    ...
    }, [e, c, u, i.id, i.productLine, l, M]), b = r.useCallback(() => {
        let t = u === p.uS.WISHLIST ? "wishlist" : "shop";
        _.default.track(O.HAw.GIFTING_ITEM_CLICKED, {
            sku_id: i.id,
            item_source: t,
...
function N(t) {
    ...
    return (0, n.jsx)(y, {
        ...
        skuPreviewHoverStyle: s()({
            [k.m]: null != i.bundledSkus && i.bundledSkus.length > 0 || i.tenantMetadata?.collectibles?.type !== l.R.NAMEPLATE && i.tenantMetadata?.collectibles?.type !== l.R.PROFILE_EFFECT
        }),
        ...g
    })
}
