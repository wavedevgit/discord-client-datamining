/** chunk id: 969379 params = (module,exports,require) **/
"use strict";
n.d(t, {
    A: () => a
});
...
let a = (e, t) => {
    let {
        groupType: n,
        teamId: s
    } = t, [a, o] = i.useState(!0), [d, c] = i.useState([]), u = i.useCallback(async () => {
    ...
    return i.useEffect(() => {
        ...
        })(null != s ? d.filter(e => e.user_id === s) : d), [d, s]),
        loading: a
    }
}