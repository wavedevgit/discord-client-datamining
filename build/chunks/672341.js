/** chunk id: 672341 params = (module,exports,require) **/
n.d(t, {
    A: () => en
}), n(321073), n(667532);
var i = n(627968),
...
function en(e) {
    let t, n, {
        ...
        eS = function(e, t) {
            if (e.isDM() && null != t)
                ...
                else if (t.type === x._j.LIKELY_ATO) return (0, i.jsx)(h.L, {
                channelId: e.id,
                warningId: t.id,
                senderId: e.getRecipientId()
            });
        ...
        eb = el.map((e, t) => {
            if (e.type === Z.TZK.DIVIDER) {
                ...
                return null != eo ? null : e.isConversationDivider ? (0, i.jsx)(A.A, {
                    ...
                    item: e,
                    channel: l
                }, `conv-divider-${e.contentKey??t}`) : e.isSummaryDivider ? (0, i.jsx)(b.A, {
                    index: t,
                    item: e,
                    channel: l,
            ...
            if (e.type === Z.TZK.MESSAGE_GROUP_BLOCKED || e.type === Z.TZK.MESSAGE_GROUP_IGNORED || e.type === Z.TZK.MESSAGE_GROUP_SPAMMER || e.type === Z.TZK.MESSAGE_GROUP_SUSPENDED_USER) {
                let t, n = !0;
                return e.type === Z.TZK.MESSAGE_GROUP_BLOCKED ? t = Q.t["+FcYM/"] : e.type === Z.TZK.MESSAGE_GROUP_IGNORED ? t = Q.t["VFWjc+"] : e.type === Z.TZK.MESSAGE_GROUP_SUSPENDED_USER ? (t = Q.t.rHRovo, n = !1) : t = Q.t.xfkfTK, (0, i.jsx)(V.A, {
                    unreadId: $.q4,
                    messages: e,
                    channel: l,
                    compact: ei,
    ...
    if (m.hasMoreBefore && null == eo || ey.unshift((0, i.jsx)(g.A, {
        ...
        if (R.Ay.isEstimated(l.id) ? (e = c ? Q.t.wvtbbG : Q.t.tHqbtg, n = Q.t.vaPWFe) : (e = c ? Q.t["BctFH/"] : Q.t["3wXb9P"], n = Q.t["4H8ldG"]), ep && (0, o.Kc)(l) && ex.includes(q.i.SUMMARIES)) {
    ...
    if (null == t && (0, o.pk)(l) && e_ && ex.includes(q.i.SUMMARIES) && (t = (0, i.jsx)(K.UK, {
            channel: l,
            scrollManager: es
        ...
        onClick: () => {
            ...
            return e = l.id, void r.A.fetchMessages({
                channelId: e,
                limit: (0, U.h)("renderStream.reload"),
                truncate: !0
            })
        },
        className: eu
        ...
        n = m.loadingMore && m.jumpedToPresent ? (0, i.jsx)(K.Ab, {
            className: eu
        }) : null != e ? (0, i.jsx)(K.Ab, {
            type: K.ks.REPLY,
            onClick: () => {
            ...
            onClick: () => {
                let e;
                return r.A.jumpToPresent(l.id, (0, U.h)("renderStream.jumpToPresent")), e = M.A.getChannelId(), void(l.id === e && (0, C.iN)(l.id))
            },
            className: eu
        })
    }
