...
function et(e) {
    ...
    let eN = null,
        ...
        eb = ei.map((e, t) => {
            ...
            if (e.type === $.TZK.FORUM_POST_ACTION_BAR) return (0, i.jsx)(g.A, {
    ...
    ev.push(...eb);
    let ey = ei[ei.length - 1];
    if (null != eu && el.forEach((e, t) => {
            let n = 0 === t && (0, k.l)(l, ey, new y.Ay({
                type: $.lAJ.DEFAULT,
                author: eu
            }));
            ev.push((0, i.jsx)(ee, {
        ...
        (e && eh() || !e) && ev.unshift((0, i.jsx)(W.Ay, {
            compact: en,
            ...ea
        }, "has-more"))
    }
    if (m.hasMoreBefore && null == er || ev.unshift((0, i.jsx)(A.A, {
            channel: l,
            showingBanner: eo
        }, "empty-message")), m.hasMoreAfter && ev.push((0, i.jsx)(W.Ay, {
            compact: en,
            ...ea
        }, "has-more-after")), !eo && em && eh() && ev.push((0, i.jsx)(z.A, {
            channel: l
        })), F > 0 && et && eh()) {
        let e, n, s = j.Ay.getOldestUnreadTimestamp(l.id),
            r = 0 !== s ? s : L.default.extractTimestamp(l.id),
            c = (0, D.ro)(new Date, new Date(r));
        if (j.Ay.isEstimated(l.id) ? (e = c ? X.t.wvtbbG : X.t.tHqbtg, n = X.t.vaPWFe) : (e = c ? X.t["BctFH/"] : X.t["3wXb9P"], n = X.t["4H8ldG"]), eg && (0, o.Kc)(l) && ex.includes(q.i.SUMMARIES)) {
            let s = j.Ay.ackMessageId(l.id),
                c = (0, v.L)(l.id, j.Ay.getOldestUnreadMessageId(l.id));
            if ((0, d.zV)($.HAw.SUMMARIES_UNREAD_BAR_VIEWED, {
    ...
    if (null == t && (0, o.pk)(l) && ep && ex.includes(q.i.SUMMARIES) && (t = (0, i.jsx)(K.UK, {
        ...
        onClick: () => {
            ...
            return e = l.id, void r.A.fetchMessages({
                channelId: e,
                limit: (0, P.h)("renderStream.reload"),
                truncate: !0
            })
        },
        className: ed
        ...
        n = m.loadingMore && m.jumpedToPresent ? (0, i.jsx)(K.Ab, {
            ...
            onClick: () => {
                let e;
                return r.A.jumpToPresent(l.id, (0, P.h)("renderStream.jumpToPresent")), e = R.A.getChannelId(), void(l.id === e && (0, E.iN)(l.id))
            },
            className: ed
        })
    }
