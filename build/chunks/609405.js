/** chunk id: 609405 params = (module,exports,require) **/
n.d(t, {
    A: () => j,
    N: () => I
}), n(321073);
...
function C(e) {
    ...
    } = e, x = (0, r.bG)([o.A], () => o.A.useReducedMotion), p = s.useMemo(() => null != n.cooldownEndsAt ? new Date(n.cooldownEndsAt) : null, [n]), T = s.useMemo(() => null != p && p > new Date, [p]), f = (0, g.I5)(n), C = (0, d.A)(), v = s.useRef(null);
    return (0, i.jsxs)("div", {
        className: E.PW,
...
function v(e) {
    let {
        ...
        showAltText: a
    } = e, o = (0, r.bG)([m.A], () => m.A.getGuild(t), [t]);
    return (0, i.jsxs)("div", {
        className: E.ag,
...
function N(e) {
    let {
        ...
        premiumSubscription: s
    } = e, l = (0, r.bG)([m.A], () => m.A.getGuild(t), [t]), a = x.default.fromTimestamp(Date.now());
    if (n.forEach(e => {
...
function I(e) {
    ...
    return null == n || 0 === t.length ? null : (0, i.jsxs)("div", {
        ...
        children: [(0, i.jsx)("div", {
            className: E.kL,
            children: x.default.keys(l).map(e => (0, i.jsx)(N, {
                guildId: e,
                premiumSubscription: n,
...
function j(e) {
    ...
    return (0, i.jsxs)("div", {
        ...
        children: [(0, i.jsx)("div", {
            className: E.kL,
            children: x.default.keys(a).map(e => (0, i.jsx)(v, {
                guildId: e,
