...
function h(t) {
    let e = (0, o.b)(),
        ...
        m = null != h ? (0, g.WO)(d.VW.richValue(t), {
            mode: "plain",
            range: h,
            ...
            let [s, r] = a.useState(!1), i = a.useCallback(async () => {
                if (!s) {
                    ...
                    try {
                        ...
                        s.ok && s.body && (e(s.body.content), (0, l.showToast)((0, l.createToast)(f.intl.string(f.t.mxQpUY), l.ToastType.SUCCESS)))
                    } finally {
                        r(!1)
                    }
                }
        ...
        y = function(t, e) {
            let [r, o] = a.useState(!1), u = (0, i.bG)([p.default], () => p.default.locale), g = a.useCallback(async (s, n) => {
                if (r) return;
                let a = s ?? u;
                o(!0);
                let i = n ?? a;
                (0, l.showToast)((0, l.createToast)(f.intl.formatToPlainString(f.t.Znl8Z8, {
                    targetLanguage: i
                }), l.ToastType.AI));
                try {
                    let s = await c.Bo.post({
                    ...
                    s.ok && s.body && (e(s.body.content), (0, l.showToast)((0, l.createToast)(f.intl.formatToPlainString(f.t.FtVUqm, {
                        targetLanguage: i
                    }), l.ToastType.SUCCESS)))
                } finally {
                    o(!1)
    ...
    return "" !== m.trim() && e ? (0, n.jsxs)(n.Fragment, {
        children: [S, y]
    }) : null
}