...
let E = e => {
    ...
    return (0, a.jsx)(c.m, {
        ...
        children: (0, a.jsx)(d.DUT, {
            className: A.fS,
            onClick: async () => {
                l(f.Ws.ClickSimilarGame, t.applicationId), (0, d.mMO)(() => Promise.resolve(e => (0, a.jsx)(v.default, {
...
function I(e) {
    let {
        ...
        return e || n
    }), f = (0, o.yK)([m.A], () => r.map(e => m.A.getGame(e)).filter(e => null != e).filter(e => (0, g.oS)(e.applicationId)).slice(0, 5));
    return ((0, x.k)(t), (0, x.W)(r), u && null == c) ? (0, a.jsxs)("div", {
        children: [(0, a.jsx)("div", {
            className: i()(A.vM, _.bV)
        }), (0, a.jsx)("div", {
    ...
    }) : (u || 0 !== f.length) && null == c ? (0, a.jsxs)("div", {
