/** chunk id: 365701 params = (module,exports,require) **/
"use strict";
n.d(t, {
    Ay: () => y,
    Jx: () => I,
...
class T extends d.Ay.Store {
    ...
    reset = () => {
        ...
        null != e ? (this.name = e.name ?? this.name, this.description = e.description ?? this.description) : (this.name = "", this.description = ""), this.emitChange()
    };
    setName = e => {
    ...
    save = async () => {
        await p.A.updateGuildTemplate(j.A.getProps().guild.id, this.getTemplate().code, this.name, this.description), this.emitChange()
    };
    showNotice() {
        let e = this.getTemplate();
    ...
    let t = (0, d.bG)([I], () => I.error),
        [n, l] = s.useState(!0),
        {
            ...
            return s.useEffect(() => {
                ...
                loading: t,
                guildTemplate: (0, d.bG)([A.A], () => A.A.getForGuild(e), [e])
            }
        }(e.id);
    if (s.useEffect(() => {
