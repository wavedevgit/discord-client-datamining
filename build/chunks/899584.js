...
function m(e) {
    let {
        channel: t
    } = e, n = (0, c.S4)(t), m = (0, l.bG)([a.A], () => a.A.hasHidden(t.id)), g = (0, u.l)(t.id), {
        sortOrder: p,
        tagFilter: f,
        tagSetting: x
    } = (0, d.R)(t.id), E = (0, l.bG)([o.A, h.A], () => !!(o.A.getThreadIds(t.id, p, f, x).length > 0) || !!(h.A.getThreads(t.id, p, f, x).length > 0), [t.id, p, f, x]), I = t.isMediaChannel();
