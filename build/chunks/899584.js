...
function m(e) {
    let {
        channel: t
    } = e, n = (0, d.S4)(t), m = (0, s.bG)([a.A], () => a.A.hasHidden(t.id)), g = (0, u.l)(t.id), {
        sortOrder: _,
        tagFilter: f,
        tagSetting: x
    ...
    let I = m ? E ? p.intl.string(p.t["WP/IE1"]) : p.intl.string(p.t.zfq9V4) : E ? p.intl.string(p.t.p60yF1) : p.intl.string(p.t.SNOqYC);
    return (0, i.jsx)(A.In, {
        tooltip: I,
        icon: l.mir,
