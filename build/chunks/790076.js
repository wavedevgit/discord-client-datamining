...
function eN(e) {
    let t = er.default.getNotificationPositionMode(),
        n = t !== eA.G6Q.DISABLED,
    ...
    return {
        ...
        text_notifications_mode: w.A.isNotificationDisabled(eh.KS.TextChat) ? "DISABLED" : "ENABLED",
    ...
    return (0, i.jsx)(h.Nt8, {
        ...
        children: e => {
            ...
            return (0, i.jsx)(eb, {
                ...
                action: (0, i.jsxs)("div", {
                    className: ep.rc,
                    children: [l.action, o ? (0, i.jsx)(h.abt, {
                        size: "custom",
                        width: 20,
                        height: 20,
...
let ev = new Set([M.AR.INITIALIZING, M.AR.WAITING_FOR_SCREEN_TYPE_RESOLUTION, M.AR.WAITING_FOR_MODULE_TRACKING, M.AR.WAITING_FOR_OVERLAY_OPEN, M.AR.WAITING_FOR_POPOUT_OPEN, M.AR.WAITING_FOR_MODULE_POPOUT_CAPTURE, M.AR.WAITING_FOR_REACT_INITIALIZATION, M.AR.WAITING_FOR_PID_FOCUS, M.AR.WAITING_FOR_SUCCESSFUL_SHOW]),
    eO = e => {
...
function eR() {
    ...
    } = (0, O.A)(), n = e?.pid, a = (0, m.bG)([k.default], () => null == e || null == n ? null : k.default.getTrackedGameByPid(n), [e, n], o()), {
        enabledLegacy: r,
        enabledOOP: l
    } = (0, m.cf)([ee.A, en.A], () => null == e && null == a ? {
        enabledLegacy: !1,
        enabledOOP: !1
    } : null == e ? {
        enabledLegacy: a?.legacyEnabled ?? !1,
        enabledOOP: a?.oopEnabled ?? !1
    } : (0, v.hw)(e, !1, [ee.A, en.A]), [e, a]), c = (0, m.bG)([v.Ay, ee.A, en.A], () => null == e ? null : (0, v.xU)(e, v.Ay, ee.A, en.A), [e], o()), [d, u] = s.useState(l), [_, A] = s.useState(r), [p, E] = s.useState(!1);
    s.useEffect(() => {
        u(l), A(r)
    }, [l, r]);
    let T = !(0, eu.supportsLegacy)(),
        f = !(0, eu.supportsOutOfProcess)(),
        {
            legacyEnabled: N,
            oopEnabled: b
        } = (0, m.cf)([k.default], () => k.default.getGlobalEnabledStatus()),
        j = (t, n) => {
            if (null == e) return;
            let i = !1,
                s = !1;
            ...
            }(i || s) && (0, B.L)(i ? L.OverlayToggledClientSettingType.LEGACY_GAME : L.OverlayToggledClientSettingType.OOP_GAME, e.id ?? null)
        },
        R = T && f,
        D = !N && !b,
        G = !d && !N && _ && !T,
        ...
        w = a?.state === M.AR.OVERLAY_RENDERING && !V,
        H = a?.state != null && ev.has(a.state) && !V,
        ...
        [Z, q] = (() => {
            switch (!0) {
                case w && Y:
                    return [ex.intl.format(ex.t.hFVBIg, {
    ...
    let [Q, J] = s.useMemo(() => H ? ["text-muted", h.LU0.colors.TEXT_MUTED.css] : w && F ? ["text-feedback-warning", h.LU0.colors.TEXT_FEEDBACK_WARNING.css] : w && Y ? ["text-feedback-positive", h.LU0.colors.TEXT_FEEDBACK_POSITIVE.css] : w && z ? ["text-strong", h.LU0.colors.TEXT_STRONG.css] : ["interactive-text-default", h.LU0.colors.INTERACTIVE_TEXT_DEFAULT.css], [H, w, F, Y, z]);
    return null == e ? null : (0, i.jsxs)(ej, {
        onExpand: E,
        className: p ? ep.tx : void 0,
        title: (0, i.jsxs)(i.Fragment, {
            children: [t?.name ?? c?.name ?? e?.gameName ?? "", null != c && c.verified ? (0, i.jsx)(g.m, {
                    ...
                    ((t, n) => {
                        ...
                        switch (n) {
                            ...
                            case "global":
                                ...
                                break;
                            case "both":
                                C.A.setEnabled(t, t), x.A.toggleOverlay(e, t, t), A(t), u(t), i = !t && N || !t && _, s = !t && b || !t && d
                        }
                        let a = null;
                        i ? a = "game" === n ? L.OverlayToggledClientSettingType.LEGACY_GAME : L.OverlayToggledClientSettingType.LEGACY : s && (a = "game" === n ? L.OverlayToggledClientSettingType.OOP_GAME : L.OverlayToggledClientSettingType.OOP), null != a && (0, B.L)(a, e.id ?? null)
                    })(t, ((e, t) => {
                        let n = !t && e,
                            i = !b && d,
                            s = !N && _,
        ...
        children: [(0, i.jsx)(eb, {
            ...
            action: (0, i.jsxs)(i.Fragment, {
                children: [(0, i.jsx)(h.dOG, {
                    ...
                    disabled: f,
                    onChange: e => {
                        e && !b ? j(e, L.OverlayToggledClientSettingType.OOP) : j(e, L.OverlayToggledClientSettingType.OOP_GAME)
                    }
                }), (0, i.jsx)("div", {
                    className: ep.Kz
                })]
...
function ey(e) {
    let {
        game: t,
        gameApplication: n
    } = e, a = s.useMemo(() => null == t ? null : "pid" in t ? t.pid : null, [t]), r = (0, m.bG)([N.A], () => null != n ? n : N.A.getApplication(t?.id), [n, t]);
    return (0, i.jsx)(y.A, {
        game: r,
        pid: a,
        size: y.M.SMALL
...
function eP(e) {
    let {
        ...
        clientSettingType: o,
        ariaLabel: c
    } = e, d = (0, m.cf)([v.Ay, ee.A, en.A], () => (0, v.xU)(t, v.Ay, ee.A, en.A)), u = (0, m.cf)([ee.A, en.A], () => (0, v.hw)(t, !1, [ee.A, en.A]), [t]), _ = r(u), [A, g] = s.useState(_);
    return s.useEffect(() => {
        g(_)
    }, [_]), (0, i.jsx)(eb, {
        title: t.name,
        ...
        action: (0, i.jsxs)(i.Fragment, {
            children: [(0, i.jsx)(h.dOG, {
                ...
                onChange: e => {
                    let n;
                    return n = !e && A, void(g(e), l(e, d, u), n && (0, B.L)(o, d.id ?? t?.id ?? null))
                }
            }), (0, i.jsx)("div", {
                className: ep.Kz
            })]
...
function eL() {
    let [e, t] = s.useState(!1), {
        legacyEnabled: n,
        oopEnabled: a
    } = (0, m.cf)([k.default], () => k.default.getGlobalEnabledStatus()), r = (0, m.yK)([v.Ay], () => v.Ay.getGamesSeen(!0)).filter(e => !(0, Z.n1)(e)), l = (0, b.A)(r.map(e => e.id)), o = !(0, eu.supportsLegacy)(), c = e => {
        C.A.setEnabled(e, a);
        let t = v.Ay.getCurrentGameForAnalytics()?.id ?? null;
        (0, L.Q3)(e, L.OverlayToggledClientSettingType.LEGACY, t), !e && n && (0, B.L)(L.OverlayToggledClientSettingType.LEGACY, t)
    }, d = (e, t, n) => {
        let {
            enabledOOP: i
        } = n;
        x.A.toggleOverlay(t, e, i)
    }, u = s.useMemo(() => (0, eu.supportsLegacy)() ? o ? ex.intl.string(ex.t.r9jEVw) : ex.intl.string(ex.t.OzInYk) : ex.intl.string(ex.t["8Ox6/E"]), [o]);
    return 0 === r.length ? (0, i.jsx)(eb, {
        title: ex.intl.string(ex.t.BfFpW1),
        description: u,
        "aria-label": ex.intl.string(ex.t.BfFpW1),
        className: ep.dA,
        ...
        children: [(0, i.jsx)("div", {
            ...
            children: r.map((e, t) => (0, i.jsx)(eP, {
                ...
                onChange: d,
                ariaLabel: ex.intl.format(ex.t.hvPYsF, {
                    gameName: e.name
                }).toString()
            }, e.id))
        })]
...
function eD() {
    let [e, t] = s.useState(!1), {
        oopEnabled: n,
        legacyEnabled: a
    } = (0, m.cf)([k.default], () => k.default.getGlobalEnabledStatus()), r = !(0, eu.supportsOutOfProcess)(), l = (0, m.yK)([v.Ay], () => v.Ay.getGamesSeen(!0)).filter(e => !(0, Z.n1)(e)), o = (0, b.A)(l.map(e => e.id)), c = e => {
        let t = !e && n;
        C.A.setEnabled(a, e);
        let i = v.Ay.getCurrentGameForAnalytics()?.id ?? null;
        (0, L.Q3)(e, L.OverlayToggledClientSettingType.OOP, i), t && (0, B.L)(L.OverlayToggledClientSettingType.OOP, i)
    }, d = (e, t, n) => {
        let {
            enabledLegacy: i
        } = n;
        x.A.toggleOverlay(t, e, i)
    }, u = s.useMemo(() => G.O ? r ? ex.intl.string(ex.t.C7bLTQ) : ex.intl.string(ex.t.ndgADE) : ex.intl.string(ex.t.m7X4az), [r]);
    return 0 === l.length ? (0, i.jsx)(eb, {
        title: ex.intl.string(ex.t["7BlVIs"]),
        description: u,
        "aria-label": ex.intl.string(ex.t["7BlVIs"]),
        className: ep.dA,
        ...
        children: [(0, i.jsx)("div", {
            ...
            children: l.map((e, t) => (0, i.jsx)(eP, {
                ...
                onChange: d,
                ariaLabel: ex.intl.format(ex.t.nByTd3, {
                    gameName: e.name
                }).toString()
            }, e.id))
        })]
...
function eG() {
    return (0, U.X4)(f.A.USER_SETTINGS) ? (0, i.jsx)(eb, {
...
function eM(e) {
    ...
    } = e, n = (0, m.bG)([es.Ay], () => es.Ay.getOverlayKeybind()), s = !(0, eu.supportsLegacy)(), a = !(0, eu.supportsOutOfProcess)(), [r, l] = (0, m.yK)([v.Ay], () => [v.Ay.canShowAdminWarning, v.Ay.getVisibleGame()], []), o = (0, q.NP)(), c = null != l && l.elevated && r && !o, u = !(0, es.DV)(n?.shortcut ?? []);
    return (0, i.jsx)("div", {
        className: ep.hc,
        children: (0, i.jsxs)("div", {
            ...
            children: [(0, i.jsxs)("div", {
                ...
                children: (0, i.jsx)(T.A, {
                    ...
                    onChange: function(e) {
                        d()(null != n, "Keybind should never be undefined"), p.A.setKeybind({
                            ...n,
                            shortcut: e
                        })
                    }
...
function eU(e, t) {
    return [{
        ...
        usePredicate: () => {
            ...
            } = (0, U.M8)("OverlayV3NowPlayingDifferentGamesNotificationSetting"), t = (0, m.bG)([w.A], () => w.A.isNotificationDisabledBySetting(D.M.NOW_PLAYING));
            return !!e && !t
        }
    }, e && {
        title: ex.t["5/21FT"],
        ...
        usePredicate: () => {
            let {
                enabled: e
            } = (0, U.QC)("OverlayV3StreamWatchNudge");
            return e
        }
...
function ek() {
    ...
    } = (0, U.M8)("OverlayV3NowPlayingDifferentGamesNotificationSetting"), n = (0, m.bG)([w.A], () => w.A.getDisabledNotifications()), s = eU(e, t && !n.has(D.M.NOW_PLAYING));
    return (0, i.jsxs)("div", {
        className: ep.AO,
...
function ew(e) {
    let t, {
        ...
        [d] = s.useState(() => [eV(ex.intl.string(ex.t.C0ZDvo), !0, !1), eV(ex.intl.string(ex.t.iOtj8E), !1, !1, !0), eV(ex.intl.string(ex.t["0oqNgL"]), !1, !0)]),
        u = (0, m.bG)([H.A, et.A], () => {
            let e = H.A.getWidgetByType(eA.uss.VOICE_V3);
            ...
            children: e => (0, i.jsxs)("div", {
                ...
                children: [(0, i.jsx)("div", {
                    ...
                    children: [(0, i.jsx)(K.Pl, {
                        children: ex.intl.string(ex.t.KNJ6Vq)
...
function eH() {
    ...
    return (0, i.jsxs)("div", {
        className: ep.ri,
        children: [(0, i.jsx)(h.l6P, {
            label: ex.intl.string(ex.t.dnvZSg),
            options: [{
                id: "large",
                label: ex.intl.string(ex.t.YcOxtr),
                value: eA.OSZ.LARGE
            }, {
                id: "small",
                label: ex.intl.string(ex.t.BKIKqx),
                value: eA.OSZ.SMALL
            }],
            ...
            options: [{
                id: "always",
                label: ex.intl.string(ex.t.nBmDrT),
                value: eA.pwA.ALWAYS
            }, {
                ...
                id: "never",
                label: ex.intl.string(ex.t.ekjlPL),
                value: eA.pwA.NEVER
            }],
            ...
            children: (0, i.jsx)(h.Apm, {
                ...
                markers: ef,
                barStyles: {
                    background: h.LU0.colors.BACKGROUND_MOD_STRONG.css
                },
                fillStyles: {
                    background: h.LU0.colors.BACKGROUND_BRAND.css
                },
...
function eB(e) {
    let {
        showDivider: t = !1
    } = e, [n, s] = (0, j.kn)([A.M.OVERLAY_OOP_SETTINGS_NUX], void 0, !0);
    return ((0, I.Ay)(() => () => {
        s(eg.i.AUTO_DISMISS)
    }), n !== A.M.OVERLAY_OOP_SETTINGS_NUX) ? null : (0, i.jsxs)("div", {
        className: ep.xC,
        children: [(0, i.jsx)("div", {
            children: (0, i.jsx)("img", {
                src: eE.A,
                alt: ex.intl.string(ex.t.mdXZh1),
                className: ep.tl
            })
        }), (0, i.jsx)("div", {
            children: (0, i.jsxs)("div", {
...
function eY(e) {
    ...
    } = e, a = n?.id, r = (0, m.bG)([w.A], () => w.A.isLimitedInteractionOverrideEnabled(a), [a]), l = s.useMemo(() => null != t && (0, V.qJ)(t.pid), [t]), o = (0, m.bG)([er.default], () => er.default.disableClickableRegions);
    return (0, i.jsxs)("div", {
        className: ep.U$,
        children: [(0, i.jsx)(eM, {
            isLegacySettings: !0
...
function eF() {
    ...
    return (0, I.Ay)(() => {
    ...
    }), (e = eN(eT), _().isEqual(e, eT) || (el.default.track(eA.HAw.OVERLAY_SETTINGS_UPDATED, e), eT = e), null == s) ? null : (0, i.jsxs)(i.Fragment, {
        children: [(0, i.jsxs)(em.A, {
            ...
            children: [(0, i.jsx)(eB, {
                ...
                className: ep.U$,
                children: [(0, i.jsx)(eR, {}), (0, i.jsx)(eD, {}), (0, i.jsx)(eL, {}), (0, i.jsx)(eG, {})]
            }), (0, i.jsx)("div", {
                className: ep.Ri
            })]
        }), (0, i.jsxs)("div", {
            ...
            children: [(0, i.jsx)(eH, {}), (0, i.jsx)("div", {
                className: ep.Ri
            })]
        }), (0, i.jsx)(ek, {})]
    })
