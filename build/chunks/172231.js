/** chunk id: 172231 params = (module,exports,require) **/
e.d(i, {
    default: () => E
}), e(321073);
var a = e(627968);
...
function E(t) {
    let i, {
        ...
        m = d.A.can(_.QY, e);
    i = A && S?.premiumTier === o.TVA.TIER_3 ? C <= o.p2C ? I.intl.string(I.t.tJmOuw) : I.intl.string(I.t["7FHbPG"]) : L ? I.intl.string(I.t["8/uDSF"]) : I.intl.string(I.t["7FHbPG"]);
    let h = () => {
            T(), l.default.track(o.HAw.BOOSTING_UPSELL_CLICKED, {
                guild_id: e.guild_id,
