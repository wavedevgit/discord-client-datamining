...
function _(e, t) {
    let {
        ...
        location: t
    }), [o, _] = i.useState(null), [u, s] = i.useState(!1), c = n && null != e && e.features.has(d.GuildFeatures.DISCOVERABLE);
    i.useEffect(() => {
        if (!c || null == e) {
            _(null), s(!1);
            return
    ...
    let f = n && null != e && e.features.has(d.GuildFeatures.DISCOVERABLE) && o?.is_published === !0;
    return {
        enabled: f,
