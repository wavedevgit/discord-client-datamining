    ...
    v = i.forwardRef(function(e, t) {
        let {
            ...
            p.current = {
                x: t,
                y: l
            }, y.current.style.transform = `translate3d(${t}px, ${l}px, 0) rotate(${F}deg) scaleX(${k?"-1":"1"})`, C({
                x: t,
                y: l
            })
        }, [y, F, L, k]);
...
function S(e, t, l) {
    let {
        width: n,
        height: i
    } = A(e, t), r = Math.abs(288 - n) / 2, a = Math.abs(288 - i) / 2;
...
let N = (e, t, l) => {
    let {
        height: n,
        width: i
    } = A(t, l), r = (n = Math.min(n, 288)) / (i = Math.min(i, 288)), a = {
        height: n,
        width: i
