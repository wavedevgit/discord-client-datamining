/** chunk id: 582617 params = (module,exports,require) **/
n.d(t, {
    n: () => v
});
var l = n(627968),
...
let b = new m.A("ImageEditor"),
    ...
    v = i.forwardRef(function(e, t) {
        let {
            ...
            left: 0,
            right: 0
        }), [F, H] = i.useState(0), [U, W] = i.useState({
            x: 0,
            y: 0
        }), [z, P] = i.useState(!1), {
            isGIF: J,
        ...
        } = (0, g._)(n), Y = (0, u.q)(n.type) && !J && !B, [q, Q] = i.useState(null), V = (0, d.I)(v ?? j.tE, 500), X = i.useRef(null), Z = i.useRef(0), ee = i.useCallback(function() {
            ...
            p.current = {
                x: t,
                y: n
            }, y.current.style.transform = `translate3d(${t}px, ${n}px, 0) rotate(${F}deg) scaleX(${k?"-1":"1"})`, C({
                x: t,
                y: n
            })
        }, [y, F, L, k]);
...
function S(e, t, n) {
    let {
        width: l,
        height: i
    } = A(e, t), r = Math.abs(288 - l) / 2, a = Math.abs(288 - i) / 2;
...
let N = (e, t, n) => {
    let {
        height: l,
        width: i
    } = A(t, n), r = (l = Math.min(l, 288)) / (i = Math.min(i, 288)), a = {
        height: l,
        width: i
    ...
    return {
        ...e,
        cropDimensions: a,
        resizeHeight: r < 1 ? s : 128,
        resizeWidth: r > 1 ? s : 128
    }
}