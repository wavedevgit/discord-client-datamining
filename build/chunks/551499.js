/** chunk id: 551499 params = (module,exports,require) **/
function n(e) {
    let a = e.toLowerCase();
    return ({
        js: "javascript",
...
let t = {
    ...
    d = new Map,
    l = new Map,
    i = new Set(["ada", "agda", "asciidoc", "asm", "awk", "bash", "batch", "c", "c-sharp", "caddy", "capnp", "cedar", "cedarschema", "clojure", "cmake", "cobol", "commonlisp", "cpp", "css", "d", "dart", "devicetree", "diff", "dockerfile", "dot", "elisp", "elixir", "elm", "erlang", "fish", "fsharp", "gleam", "glsl", "go", "graphql", "groovy", "haskell", "hcl", "hlsl", "html", "idris", "ini", "java", "javascript", "jinja2", "jq", "json", "julia", "kotlin", "lean", "lua", "markdown", "matlab", "meson", "nginx", "ninja", "nix", "objc", "ocaml", "perl", "php", "postscript", "powershell", "prolog", "python", "query", "r", "rego", "rescript", "ron", "ruby", "rust", "scala", "scheme", "scss", "solidity", "sparql", "sql", "ssh-config", "starlark", "styx", "svelte", "swift", "textproto", "thrift", "tlaplus", "toml", "tsx", "typescript", "typst", "uiua", "vb", "verilog", "vhdl", "vim", "vue", "wit", "x86asm", "xml", "yaml", "yuri", "zig", "zsh"]),
    b = null,
    p = null;
async function w(e) {
    if (e.pluginsUrl) return p || (p = (async () => {
        ...
        b = await a.json(), e.logger.debug(`[arborium] Loaded local manifest with ${b?.entries.length} entries`)
    })())
}
...
async function u(e, a) {
    if (await w(a), !i.has(e) && !b?.entries.some(a => a.language === e)) return a.logger.debug(`[arborium] Grammar '${e}' not available`), null;
    try {
        let s = function(e, a) {
                let s;
                if (b) {
                ...
                let n = a.cdn,
                    t = a.version;
                return s = "jsdelivr" === n ? "https://cdn.jsdelivr.net/npm" : "unpkg" === n ? "https://unpkg.com" : n, `${s}/@arborium/${e}@${t}`
            }(e, a),
            n = a.resolveJs === t.resolveJs ? ` from ${s}/grammar.js` : "";
        a.logger.debug(`[arborium] Loading grammar '${e}'${n}`);
        let r = await a.resolveJs({
                language: e,
                baseUrl: s,
                path: "grammar.js"
            }),
            o = await a.resolveWasm({
                language: e,
                baseUrl: s,
            ...
            i = {
                ...
                parseUtf8: e => {
                    ...
                    try {
                        ...
                        return a.logger.error("[arborium] Parse error:", e), {
                            spans: [],
                            injections: []
                        }
                    } finally {
...
async function g(e) {
    return r || o || (o = (async () => {
        ...
        try {
            let s = await e.resolveHostJs({
                    baseUrl: a,
                    path: "arborium_host.js"
                }),
                n = await e.resolveHostWasm({
                    baseUrl: a,
            ...
            }, e.logger.debug("[arborium] Host loaded successfully"), r
        } catch (a) {
            ...
            return {
                ...
                parse: () => {
                    try {
                        ...
                        return s.logger.error("[arborium] Session parse error:", e), {
                            spans: [],
                            injections: []
                        }
                    }
