...
class b extends r.PureComponent {
    ...
    componentDidMount() {
        (0, o.N)(this.props.location), this.stopListeningToHistory = (0, E.JK)().listen(e => {
            e.pathname.startsWith(N.BVt.APPLICATION_STORE) && (0, o.N)(e)
        }), this.props.isAuthenticated && (0, d.$o)(), m.A.disable(), m.A.setLayout(h.E), m.A.enable(), (0, I.d)("application_store")
    }
    componentWillUnmount() {
        null != this.stopListeningToHistory && this.stopListeningToHistory(), m.A.disable(), m.A.setLayout(_.zR), m.A.enable()
    }
    ...
    renderContent = () => (0, i.jsxs)(a.dO, {
        children: [(0, i.jsx)(a.qh, {
            path: N.BVt.APPLICATION_STORE,
            exact: !0,
            render: () => (0, i.jsx)(c.A, {
                page: N.liQ.STORE_DIRECTORY_HOME,
                root: !0,
    ...
    renderCustomErrorMessage() {
        return (0, i.jsxs)("div", {
            children: [(0, i.jsx)("p", {
                children: S.intl.string(S.t["1PZdF7"])
            }), (0, i.jsx)("p", {
