/** chunk id: 565642 params = (module,exports,require) **/
var n;
t.d(e, {
    A: () => o
}), t(393431), t(532706), t(42231), t(232424), t(949626), t(767709), t(65162), t(667532), t(323874), t(14289), t(35956), t(321073), t(938796);
let o = (n = "file:///ci/build/discord/discord/discord_common/js/packages/libdave/package/wasm/libdave.js", function() {
    let r = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : {};
    var e, o, a, i, s, u, l, d, c, f, h, p, m, v, y, g, w, E, b, k, _, $, P, T, C, A, F = new Promise((r, t) => {
            e = r, o = t
        }),
        D = Object.assign({}, r),
        S = "./this.program",
        x = "";
    "u" > typeof document && document.currentScript && (x = document.currentScript.src), n && (x = n), x = x.startsWith("blob:") ? "" : x.substr(0, x.replace(/[?#].*/, "").lastIndexOf("/") + 1), a = async r => {
        var e = await fetch(r, {
    ...
    function N() {
        var e = s.buffer;
        r.HEAP8 = u = new Int8Array(e), r.HEAP16 = d = new Int16Array(e), r.HEAPU8 = l = new Uint8Array(e), r.HEAPU16 = c = new Uint16Array(e), r.HEAP32 = f = new Int32Array(e), r.HEAPU32 = h = new Uint32Array(e), r.HEAPF32 = p = new Float32Array(e), r.HEAPF64 = y = new Float64Array(e), r.HEAP64 = m = new BigInt64Array(e), r.HEAPU64 = v = new BigUint64Array(e)
    }
    var W = [],
        U = [],
        B = [],
    ...
    var Q = 0,
        ...
        rt = {
            ...
            normalize: r => {
                var e = rt.isAbs(r),
                    t = "/" === r.substr(-1);
                return (r = rt.normalizeArray(r.split("/").filter(r => !!r), !e).join("/")) || e || (r = "."), r && t && (r += "/"), (e ? "/" : "") + r
            },
            dirname: r => {
        ...
        ro = {
            resolve: function() {
                ...
                return n = rt.normalizeArray(n.split("/").filter(r => !!r), !o).join("/"), (o ? "/" : "") + n || "."
            },
            relative: (r, e) => {
                function t(r) {
        ...
        ri = function(r) {
            ...
            for (var a = ""; e < o;) {
                ...
                var u = 63 & r[e++];
                if ((i = (240 & i) == 224 ? (15 & i) << 12 | s << 6 | u : (7 & i) << 18 | s << 12 | u << 6 | 63 & r[e++]) < 65536) a += String.fromCharCode(i);
                else {
                    var l = i - 65536;
        ...
        rd = {
            ...
            register(r, e) {
                rd.ttys[r] = {
                    ...
                    output: [],
                    ops: e
                }, ry.registerDevice(r, rd.stream_ops)
            },
            stream_ops: {
                open(r) {
            ...
            default_tty_ops: {
                get_char: r => (() => {
                    if (!rs.length) {
                        ...
                        r = o, e = !0, t = Array(ru(r) + 1), n = rl(r, t, 0, t.length), e && (t.length = n), rs = t
                    }
                    return rs.shift()
                })(),
                put_char(r, e) {
        ...
        rh = {
            ...
            createNode(r, e, t, n) {
                ...
                return ry.isDir(o.mode) ? (o.node_ops = rh.ops_table.dir.node, o.stream_ops = rh.ops_table.dir.stream, o.contents = {}) : ry.isFile(o.mode) ? (o.node_ops = rh.ops_table.file.node, o.stream_ops = rh.ops_table.file.stream, o.usedBytes = 0, o.contents = null) : ry.isLink(o.mode) ? (o.node_ops = rh.ops_table.link.node, o.stream_ops = rh.ops_table.link.stream) : ry.isChrdev(o.mode) && (o.node_ops = rh.ops_table.chrdev.node, o.stream_ops = rh.ops_table.chrdev.stream), o.atime = o.mtime = o.ctime = Date.now(), r && (r.contents[e] = o, r.atime = r.mtime = r.ctime = o.atime), o
            },
            ...
            node_ops: {
                getattr(r) {
                    var e = {};
                    return e.dev = ry.isChrdev(r.mode) ? r.id : 1, e.ino = r.id, e.mode = r.mode, e.nlink = 1, e.uid = 0, e.gid = 0, e.rdev = r.rdev, ry.isDir(r.mode) ? e.size = 4096 : ry.isFile(r.mode) ? e.size = r.usedBytes : ry.isLink(r.mode) ? e.size = r.link.length : e.size = 0, e.atime = new Date(r.atime), e.mtime = new Date(r.mtime), e.ctime = new Date(r.ctime), e.blksize = 4096, e.blocks = Math.ceil(e.size / e.blksize), e
                },
                setattr(r, e) {
                ...
                rename(r, e, t) {
                    ...
                    if (n) {
                        if (ry.isDir(r.mode))
                            for (var o in n.contents) throw new ry.ErrnoError(55);
                        ry.hashRemoveNode(n)
                    }
            ...
            stream_ops: {
                ...
                write(r, e, t, n, o, a) {
                    ...
                    if (rh.expandFileStorage(i, o + n), i.contents.subarray && e.subarray) i.contents.set(e.subarray(t, t + n), o);
                    else
                ...
                llseek(r, e, t) {
                    var n = e;
                    if (1 === t ? n += r.position : 2 === t && ry.isFile(r.node.mode) && (n += r.node.usedBytes), n < 0) throw new ry.ErrnoError(28);
                    return n
                },
                allocate(r, e, t) {
                ...
                mmap(r, e, t, n, o) {
                    ...
                    if (!(2 & o) && s && s.buffer === u.buffer) i = !1, a = s.byteOffset;
                        ...
                        s && ((t > 0 || t + e < s.length) && (s = s.subarray ? s.subarray(t, t + e) : Array.prototype.slice.call(s, t, t + e)), u.set(s, a))
                    }
                    return {
                        ptr: a,
                        allocated: i
        ...
        rp = async r => new Uint8Array(await a(r)), rm = r.preloadPlugins || [], rv = (r, e) => {
            var t = 0;
            ...
            FSNode: class {
                ...
                mounted = null;
                constructor(r, e, t, n) {
                    r || (r = this), this.parent = r, this.mount = r.mount, this.id = ry.nextInode++, this.name = e, this.mode = t, this.rdev = n, this.atime = this.mtime = this.ctime = Date.now()
                }
                get read() {
            ...
            lookupPath(r) {
                ...
                r: for (var t = 0; t < 40; t++) {
                    for (var n = r.split("/").filter(r => !!r && "." !== r), o = ry.root, a = "/", i = 0; i < n.length; i++) {
                        var s = i === n.length - 1;
                        if (s && e.parent) break;
                        if (".." === n[i]) {
                        ...
                        try {
                            ...
                            if (r?.errno === 44 && s && e.noent_okay) return {
                                path: a
                            };
                            throw r
                        }
                        if (ry.isMountpoint(o) && (!s || e.follow_mount) && (o = o.mounted.root), ry.isLink(o.mode) && (!s || e.follow)) {
            ...
            nodePermissions: (r, e) => ry.ignorePermissions ? 0 : e.includes("r") && !(292 & r.mode) || e.includes("w") && !(146 & r.mode) || e.includes("x") && !(73 & r.mode) ? 2 : 0,
            mayLookup(r) {
            ...
            mayDelete(r, e, t) {
                ...
                var n, o = ry.nodePermissions(r, "wx");
                if (o) return o;
                if (t) {
            ...
            mayOpen: (r, e) => r ? ry.isLink(r.mode) ? 32 : ry.isDir(r.mode) && ("r" !== ry.flagsToPermissionString(e) || 512 & e) ? 31 : ry.nodePermissions(r, ry.flagsToPermissionString(e)) : 44,
            MAX_OPEN_FDS: 4096,
            nextfd() {
                for (var r = 0; r <= ry.MAX_OPEN_FDS; r++)
                    if (!ry.streams[r]) return r;
            ...
            createStream(r) {
                ...
                return r = Object.assign(new ry.FSStream, r), -1 == e && (e = ry.nextfd()), r.fd = e, ry.streams[e] = r, r
            },
            closeStream(r) {
                ry.streams[r] = null
            },
            ...
            syncfs(r, e) {
                "function" == typeof r && (e = r, r = !1), ry.syncFSRequests++, ry.syncFSRequests > 1 && O(`warning: ${ry.syncFSRequests} FS.syncfs operations in flight at once, probably just doing extra work`);
            ...
            mount(r, e, t) {
                ...
                var s = {
                    ...
                    u = r.mount(s);
                return u.mount = s, s.root = u, o ? ry.root = u : n && (n.mounted = s, n.mount && n.mount.mounts.push(s)), u
            },
            unmount(r) {
                var e = ry.lookupPath(r, {
                    follow_mount: !1
                });
            ...
            rename(r, e) {
                var t, n, o, a = rt.dirname(r),
                    i = rt.dirname(e),
                    s = rt.basename(r),
                    u = rt.basename(e);
                if (t = ry.lookupPath(r, {
                        parent: !0
                    }).node, n = ry.lookupPath(e, {
                        parent: !0
                    }).node, !t || !n) throw new ry.ErrnoError(44);
            ...
            chmod(r, e, t) {
                var n;
                if (!(n = "string" == typeof r ? ry.lookupPath(r, {
                        follow: !t
                    }).node : r).node_ops.setattr) throw new ry.ErrnoError(63);
            ...
            chown(r, e, t, n) {
                var o;
                if (!(o = "string" == typeof r ? ry.lookupPath(r, {
                        follow: !n
                    }).node : r).node_ops.setattr) throw new ry.ErrnoError(63);
            ...
            open(e, t) {
                ...
                if (ry.isChrdev(o.mode) && (t &= -513), 65536 & t && !ry.isDir(o.mode)) throw new ry.ErrnoError(54);
                if (!i) {
                ...
                return u.stream_ops.open && u.stream_ops.open(u), !r.logReadFiles || 1 & t || e in ry.readFiles || (ry.readFiles[e] = 1), u
            },
            close(r) {
            ...
            mmap(r, e, t, n, o) {
                if ((2 & n) != 0 && (2 & o) == 0 && (2097155 & r.flags) != 2 || (2097155 & r.flags) == 1) throw new ry.ErrnoError(2);
            ...
            readFile(r) {
                let e = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : {};
                if (e.flags = e.flags || 0, e.encoding = e.encoding || "binary", "utf8" !== e.encoding && "binary" !== e.encoding) throw Error(`Invalid encoding type "${e.encoding}"`);
                var t, n = ry.open(r, e.flags),
                    o = ry.stat(r).size,
                    a = new Uint8Array(o);
                return ry.read(n, a, 0, o, 0), "utf8" === e.encoding ? t = ri(a) : "binary" === e.encoding && (t = a), ry.close(n), t
            },
            writeFile(r, e) {
            ...
            createDefaultDevices() {
                ry.mkdir("/dev"), ry.registerDevice(ry.makedev(1, 3), {
                    read: () => 0,
                    write: (r, e, t, n, o) => n,
                    llseek: () => 0
                }), ry.mkdev("/dev/null", ry.makedev(1, 3)), rd.register(ry.makedev(5, 0), rd.default_tty_ops), rd.register(ry.makedev(6, 0), rd.default_tty1_ops), ry.mkdev("/dev/tty", ry.makedev(5, 0)), ry.mkdev("/dev/tty1", ry.makedev(6, 0));
                var r = new Uint8Array(1024),
                    e = 0,
                    t = () => (0 === e && (e = rn(r).byteLength), r[--e]);
                ry.createDevice("/dev", "random", t), ry.createDevice("/dev", "urandom", t), ry.mkdir("/dev/shm"), ry.mkdir("/dev/shm/tmp")
            },
            createSpecialDirectories() {
                ry.mkdir("/proc");
                var r = ry.mkdir("/proc/self");
                ry.mkdir("/proc/self/fd"), ry.mount({
                    mount() {
                        ...
                        return e.stream_ops = {
                            ...
                            readdir: () => Array.from(ry.streams.entries()).filter(r => {
                                let [e, t] = r;
                                return t
                            }).map(r => {
                                let [e, t] = r;
            ...
            createStandardStreams(r, e, t) {
                r ? ry.createDevice("/dev", "stdin", r) : ry.symlink("/dev/tty", "/dev/stdin"), e ? ry.createDevice("/dev", "stdout", null, e) : ry.symlink("/dev/tty", "/dev/stdout"), t ? ry.createDevice("/dev", "stderr", null, t) : ry.symlink("/dev/tty1", "/dev/stderr"), ry.open("/dev/stdin", 0), ry.open("/dev/stdout", 1), ry.open("/dev/stderr", 1)
            },
            staticInit() {
                ry.nameTable = Array(4096), ry.mount(rh, {}, "/"), ry.createDefaultDirectories(), ry.createDefaultDevices(), ry.createSpecialDirectories(), ry.filesystems = {
                    MEMFS: rh
                }
            },
            init(e, t, n) {
                ry.initialized = !0, e ??= r.stdin, t ??= r.stdout, n ??= r.stderr, ry.createStandardStreams(e, t, n)
            },
            quit() {
                ry.initialized = !1;
            ...
            analyzePath(r, e) {
                ...
                try {
                    ...
                    n.parentExists = !0, n.parentPath = t.path, n.parentObject = t.node, n.name = rt.basename(r), t = ry.lookupPath(r, {
                        follow: !e
            ...
            createLazyFile(r, e, t, n, o) {
                ...
                a.contents ? i.contents = a.contents : a.url && (i.contents = null, i.url = a.url), Object.defineProperties(i, {
                    usedBytes: {
                        get: function() {
                ...
                function l(r, e, t, n, o) {
                    ...
                    if (a.slice)
                        ...
                        for (var s = 0; s < i; s++) e[t + s] = a.get(o + s);
                    return i
                }
                return Object.keys(i.stream_ops).forEach(r => {
                    var e = i.stream_ops[r];
                    s[r] = function() {
                        for (var r = arguments.length, t = Array(r), n = 0; n < r; n++) t[n] = arguments[n];
                        return ry.forceLoadFile(i), e(...t)
                    }
                }), s.read = (r, e, t, n, o) => (ry.forceLoadFile(i), l(r, e, t, n, o)), s.mmap = (r, e, t, n, o) => {
                    ry.forceLoadFile(i);
                    var a = rf(e);
            ...
            doStat(r, e, t) {
                var n = r(e);
                f[t >> 2] = n.dev, f[t + 4 >> 2] = n.mode, h[t + 8 >> 2] = n.nlink, f[t + 12 >> 2] = n.uid, f[t + 16 >> 2] = n.gid, f[t + 20 >> 2] = n.rdev, m[t + 24 >> 3] = BigInt(n.size), f[t + 32 >> 2] = 4096, f[t + 36 >> 2] = n.blocks;
                var o = n.atime.getTime(),
                    a = n.mtime.getTime(),
                    i = n.ctime.getTime();
                return m[t + 40 >> 3] = BigInt(Math.floor(o / 1e3)), h[t + 48 >> 2] = o % 1e3 * 1e6, m[t + 56 >> 3] = BigInt(Math.floor(a / 1e3)), h[t + 64 >> 2] = a % 1e3 * 1e6, m[t + 72 >> 3] = BigInt(Math.floor(i / 1e3)), h[t + 80 >> 2] = i % 1e3 * 1e6, m[t + 88 >> 3] = BigInt(n.ino), 0
            },
            doMsync(r, e, t, n, o) {
            ...
            var o = Array(e.length),
                ...
                i = 0;
            e.forEach((r, e) => {
                r$.hasOwnProperty(r) ? o[e] = r$[r] : (a.push(r), r_.hasOwnProperty(r) || (r_[r] = []), r_[r].push(() => {
    ...
    var rD = (r, e, t) => {
        ...
        rR = {},
        rN = {},
        rW = (r, e) => (e.ptrType && e.ptr || rC("makeClassHandle requires ptr and ptrType"), !!e.smartPtrType != !!e.smartPtr && rC("Both smartPtrType and smartPtr must be specified"), e.count = {
            value: 1
        }, rU(Object.create(r, {
            $$: {
                value: e,
        ...
        rV = (r, e, t) => {
            if (void 0 === r[e].overloadTable) {
                ...
                r[e] = function() {
                    ...
                    return r[e].overloadTable.hasOwnProperty(o.length) || rT(`Function '${t}' called with an invalid number of arguments (${o.length}) - expects one of (${r[e].overloadTable})!`), r[e].overloadTable[o.length].apply(this, o)
                }, r[e].overloadTable = [], r[e].overloadTable[n.argCount] = n
            }
        },
        rH = (e, t, n) => {
            r.hasOwnProperty(e) ? ((void 0 === n || void 0 !== r[e].overloadTable && void 0 !== r[e].overloadTable[n]) && rT(`Cannot register public name '${e}' twice`), rV(r, e, e), r[e].overloadTable.hasOwnProperty(n) && rT(`Cannot register multiple overloads of a function with the same number of arguments (${n})!`), r[e].overloadTable[n] = t) : (r[e] = t, r[e].argCount = n)
        };
    ...
    var rG = (r, e, t) => {
        for (; e !== t;) e.upcast || rT(`Expected null or instance of ${t.name}, got an instance of ${e.name}`), r = e.upcast(r), e = e.baseClass;
        return r
    };

    function rX(r, e) {
        if (null === e) return this.isReference && rT(`null is not a valid ${this.name}`), 0;
        e.$$ || rT(`Cannot pass "${rb(e)}" as a ${this.name}`), e.$$.ptr || rT(`Cannot pass deleted object as a pointer of type ${this.name}`);
        var t = e.$$.ptrType.registeredClass;
        return rG(e.$$.ptr, t, this.registeredClass)
    }

    function rY(r, e) {
        if (null === e) return (this.isReference && rT(`null is not a valid ${this.name}`), this.isSmartPointer) ? (t = this.rawConstructor(), null !== r && r.push(this.rawDestructor, t), t) : 0;
        e && e.$$ || rT(`Cannot pass "${rb(e)}" as a ${this.name}`), e.$$.ptr || rT(`Cannot pass deleted object as a pointer of type ${this.name}`), !this.isConst && e.$$.ptrType.isConst && rT(`Cannot convert argument of type ${e.$$.smartPtrType?e.$$.smartPtrType.name:e.$$.ptrType.name} to parameter type ${this.name}`);
        var t, n = e.$$.ptrType.registeredClass;
        if (t = rG(e.$$.ptr, n, this.registeredClass), this.isSmartPointer) switch (void 0 === e.$$.smartPtr && rT("Passing raw pointer to smart pointer is illegal"), this.sharingPolicy) {
            case 0:
                e.$$.smartPtrType === this ? t = e.$$.smartPtr : rT(`Cannot convert argument of type ${e.$$.smartPtrType?e.$$.smartPtrType.name:e.$$.ptrType.name} to parameter type ${this.name}`);
                break;
            case 1:
                t = e.$$.smartPtr;
                break;
            case 2:
                if (e.$$.smartPtrType === this) t = e.$$.smartPtr;
                    ...
                    var o = e.clone();
                    t = this.rawShare(t, en.toHandle(() => o.delete())), null !== r && r.push(this.rawDestructor, t)
                }
                break;
            default:
    ...
    function rK(r, e) {
        if (null === e) return this.isReference && rT(`null is not a valid ${this.name}`), 0;
        e.$$ || rT(`Cannot pass "${rb(e)}" as a ${this.name}`), e.$$.ptr || rT(`Cannot pass deleted object as a pointer of type ${this.name}`), e.$$.ptrType.isConst && rT(`Cannot convert argument of type ${e.$$.ptrType.name} to parameter type ${this.name}`);
        var t = e.$$.ptrType.registeredClass;
        return rG(e.$$.ptr, t, this.registeredClass)
    }
    ...
    function rJ(r, e, t, n, o, a, i, s, u, l, d) {
        this.name = r, this.registeredClass = e, this.isReference = t, this.isConst = n, this.isSmartPointer = o, this.pointeeType = a, this.sharingPolicy = i, this.rawGetPointee = s, this.rawConstructor = u, this.rawShare = l, this.rawDestructor = d, o || void 0 !== e.baseClass ? this.toWireType = rY : (n ? this.toWireType = rX : this.toWireType = rK, this.destructorFunction = null)
    }
    var rQ = (e, t, n) => {
            r.hasOwnProperty(e) || rC("Replacing nonexistent public symbol"), void 0 !== r[e].overloadTable && void 0 !== n ? r[e].overloadTable[n] = t : (r[e] = t, r[e].argCount = n)
        },
        r0 = [],
        r1 = (r, e) => {
            r = rk(r);
            var t, n = ((t = r0[e]) || (e >= r0.length && (r0.length = e + 1), r0[e] = t = _.get(e)), t);
    ...
    function r9(r, e, t, n, o, a) {
        ...
        for (var s = null !== e[1] && null !== t, u = r3(e), l = "void" !== e[0].name, d = [r, rT, n, o, r6, e[0], e[1]], c = 0; c < i - 2; ++c) d.push(e[c + 2]);
        if (!u)
            for (var c = s ? 1 : 2; c < e.length; ++c) null !== e[c].destructorFunction && d.push(e[c].destructorFunction);
...
`;
            ...
            e && (l += `var thisWired = classParam['toWireType'](${d}, this);
`);
            for (var u = 0; u < a; ++u) l += `var arg${u}Wired = argType${u}['toWireType'](${d}, arg${u});
`, c.push(`argType${u}`);
            if (l += (t || n ? "var rv = " : "") + `invoker(${s});
...
`, c.push(`${f}_dtor`))
    ...
    var r7 = r => {
        ...
        ec = (r, e, t) => {
            ...
            for (var n = e, o = n + t - 4, a = 0; a < r.length; ++a) {
                var i = r.charCodeAt(a);
                if (i >= 55296 && i <= 57343 && (i = 65536 + ((1023 & i) << 10) | 1023 & r.charCodeAt(++a)), f[e >> 2] = i, (e += 4) + 4 > o) break
            }
            return f[e >> 2] = 0, e - n
        },
        ef = r => {
    ...
    ry.createPreloadedFile = (r, e, t, n, o, a, i, s, u, l) => {
        ...
        function f(t) {
            ...
            f = () => {
                i?.(), V(c)
            }, "u" > typeof Browser && Browser.init(), h = !1, rm.forEach(r => {
                !h && r.canHandle(d) && (r.handle(t, d, p, f), h = !0)
            }), h || p(t)
        }
        L(c), "string" == typeof t ? rp(t).then(f, i) : f(t)
    }, ry.staticInit(), rh.doesNotExistError = new ry.ErrnoError(44), rh.doesNotExistError.stack = "<generic error, no stack>";
    for (var ek = Array(256), e_ = 0; e_ < 256; ++e_) ek[e_] = String.fromCharCode(e_);
    w = ek, E = r.BindingError = class extends Error {
        constructor(r) {
            super(r), this.name = "BindingError"
        }
    }, b = r.InternalError = class extends Error {
        constructor(r) {
        ...
        clone() {
            if (this.$$.ptr || rS(this), this.$$.preservePointerOnDelete) return this.$$.count.value += 1, this;
            {
                let e;
        ...
        delete() {
            this.$$.ptr || rS(this), this.$$.deleteScheduled && !this.$$.preservePointerOnDelete && rT("Object already scheduled for deletion"), rj(this), rO(this.$$), this.$$.preservePointerOnDelete || (this.$$.smartPtr = void 0, this.$$.ptr = void 0)
        },
        isDeleted() {
            return !this.$$.ptr
        },
        deleteLater() {
            return this.$$.ptr || rS(this), this.$$.deleteScheduled && !this.$$.preservePointerOnDelete && rT("Object already scheduled for deletion"), rB.push(this), 1 === rB.length && k && k(rz), this.$$.deleteScheduled = !0, this
        }
        ...
        fromWireType: function(r) {
            ...
            var n = rN[((r, e) => {
                for (void 0 === e && rT("ptr should not be undefined"); r.baseClass;) e = r.upcast(e), r = r.baseClass;
                return e
            ...
            function a() {
                return this.isSmartPointer ? rW(this.registeredClass.instancePrototype, {
            ...
            return null === s ? a.call(this) : this.isSmartPointer ? rW(e.registeredClass.instancePrototype, {
                ptrType: e,
                ptr: s,
                smartPtrType: this,
                smartPtr: r
    ...
    }), C = Error, (A = rL("UnboundTypeError", function(r) {
        this.name = "UnboundTypeError", this.message = r;
        var e = Error(r).stack;
        void 0 !== e && (this.stack = this.toString() + "\n" + e.replace(/^Error(:[^\n]*)?\n/, ""))
    })).prototype = Object.create(C.prototype), A.prototype.constructor = A, A.prototype.toString = function() {
        return void 0 === this.message ? this.name : `${this.name}: ${this.message}`
    }, $ = r.UnboundTypeError = A, ee.push(0, 1, void 0, 1, null, 1, !0, 1, !1, 1), r.count_emval_handles = () => ee.length / 2 - 5 - er.length;
    var e$ = {
        a: (r, e, t) => {
        ...
        G: function(r, e, t) {
            try {
                ...
                for (var o = 0, a = ry.llseek(n, 0, 1), i = Math.floor(a / 280), s = Math.min(n.getdents.length, i + Math.floor(t / 280)), l = i; l < s; l++) {
                    var c, f, h, p = n.getdents[l];
                    if ("." === p) c = n.node.id, f = 4;
                    else if (".." === p) c = ry.lookupPath(n.path, {
                        parent: !0
                    }).node.id, f = 4;
                    else {
                        try {
                        ...
                        c = h.id, f = ry.isChrdev(h.mode) ? 2 : ry.isDir(h.mode) ? 4 : ry.isLink(h.mode) ? 10 : 8
                    }
                    m[e + o >> 3] = BigInt(c), m[e + o + 8 >> 3] = BigInt((l + 1) * 280), d[e + o + 16 >> 1] = 280, u[e + o + 18] = f, rE(p, e + o + 19, 256), o += 280
                }
                ...
                switch (e) {
                    ...
                    case 21505:
                        ...
                        if (n.tty.ops.ioctl_tcgets) {
                            var o = n.tty.ops.ioctl_tcgets(n),
                                a = re();
                            f[a >> 2] = o.c_iflag || 0, f[a + 4 >> 2] = o.c_oflag || 0, f[a + 8 >> 2] = o.c_cflag || 0, f[a + 12 >> 2] = o.c_lflag || 0;
                    ...
                    case 21508:
                        ...
                        if (n.tty.ops.ioctl_tcsets) {
                            for (var a = re(), s = f[a >> 2], l = f[a + 4 >> 2], c = f[a + 8 >> 2], h = f[a + 12 >> 2], p = [], i = 0; i < 32; i++) p.push(u[a + i + 17]);
        ...
        B: (r, e, t, n, o) => {
            ...
            rF(r, {
                ...
                toWireType: function(r, e) {
                    if ("bigint" != typeof e && "number" != typeof e) throw TypeError(`Cannot convert "${rb(e)}" to ${this.name}`);
        ...
        m: (r, e, t, n, o, a, i, s, u, l, d, c, f) => {
            ...
            var h, p, m = (p = (h = (h = d).replace(/[^a-zA-Z0-9_]/g, "$")).charCodeAt(0)) >= 48 && p <= 57 ? `_${h}` : h;
            rH(m, function() {
                r4(`Cannot construct ${d} due to unbound types`, [n])
            }), rA([r, e, t], n ? [n] : [], e => {
                e = e[0];
                var t, o = n ? (t = e.registeredClass).instancePrototype : rI.prototype,
                    i = rL(d, function() {
                        for (var r = arguments.length, e = Array(r), t = 0; t < r; t++) e[t] = arguments[t];
                        ...
                        if (void 0 === n) throw new E(`Tried to invoke ctor of ${d} with invalid number of parameters (${e.length}) - expected (${Object.keys(c.constructor_body).toString()}) parameters instead!`);
        ...
        q: (r, e, t, n, o, a) => {
            ...
            o = r1(n, o), rA([], [r], r => {
                ...
                if (void 0 === r.registeredClass.constructor_body && (r.registeredClass.constructor_body = []), void 0 !== r.registeredClass.constructor_body[e - 1]) throw new E(`Cannot register multiple constructors with identical number of parameters (${e-1}) for class '${r.name}'! Overload resolution is currently only performed using the parameter count, not actual type info!`);
                return r.registeredClass.constructor_body[e - 1] = () => {
                    r4(`Cannot construct ${r.name} due to unbound types`, i)
                }, rA([], i, n => (n.splice(1, 0, null), r.registeredClass.constructor_body[e - 1] = r9(t, n, null, o, a), [])), []
            })
        },
        c: (r, e, t, n, o, a, i, s, u, l) => {
            var d = r5(t, n);
            e = r7(e = rk(e)), a = r1(o, a), rA([], [r], r => {
                r = r[0];
                var n = `${r.name}.${e}`;
                ...
                var l = r.registeredClass.instancePrototype,
                    c = l[e];
                return void 0 === c || void 0 === c.overloadTable && c.className !== r.name && c.argCount === t - 2 ? (o.argCount = t - 2, o.className = r.name, l[e] = o) : (rV(l, e, n), l[e].overloadTable[t - 2] = o), rA([], d, o => {
                    var s = r9(n, o, r, a, i, u);
                    return void 0 === l[e].overloadTable ? (s.argCount = t - 2, l[e] = s) : l[e].overloadTable[t - 2] = s, []
                }), []
            })
        },
        E: (e, t, n) => {
        ...
        Y: (r, e, t, n, o, a, i, s) => {
            var u = r5(e, t);
            r = r7(r = rk(r)), o = r1(n, o), rH(r, function() {
        ...
        X: (r, e, t, n, o, a, i, s, u, l, d, c) => {
            t = rk(t), a = r1(o, a), s = r1(i, s), l = r1(u, l), c = r1(d, c), rA([r], [e], r => (r = r[0], [new rJ(t, r.registeredClass, !1, !1, !0, r, n, a, s, l, c)]))
        },
        U: (r, e) => {
            rF(r, {
                name: e = rk(e),
                ...
                toWireType(r, e) {
                    ...
                    n || e instanceof Uint8Array || e instanceof Uint8ClampedArray || e instanceof Int8Array || rT("Cannot pass non-string to std::string"), t = n ? ru(e) : e.length;
                    var o = eT(4 + t + 1),
                        a = o + 4;
                    if (h[o >> 2] = t, n) rE(e, a, t + 1);
                        ...
                        for (var i = 0; i < t; ++i) {
                            ...
                            s > 255 && (eC(a), rT("String has UTF-16 code units that do not fit in 8 bits")), l[a + i] = s
                        } else
                            for (var i = 0; i < t; ++i) l[a + i] = e[i];
        ...
        t: (r, e, t) => {
            var n, o, a, i;
            t = rk(t), 2 === e ? (n = es, o = eu, i = el, a = r => c[r >> 1]) : 4 === e && (n = ed, o = ec, i = ef, a = r => h[r >> 2]), rF(r, {
                name: t,
                fromWireType: r => {
...
`,
                ...
                l = [];
            0 === t && l.push("obj");
            for (var d = ["retType"], c = [i], f = 0; f < r; ++f) l.push("arg" + f), d.push("argType" + f), c.push(a[f]), s += `  var arg${f} = argType${f}.readValueFromPointer(args${u?"+"+u:""});
`, u += a[f].argPackAdvance;
            s += `  var rv = ${1===t?"new func":"func.call"}(${l.join(", ")});
`, i.isVoid || (d.push("emval_returnValue"), c.push(eh), s += "  return emval_returnValue(retType, destructorsRef, rv);\n"), s += "};\n", d.push(s);
            var p = r8(Function, d)(...c);
            return n = rL(`methodCaller<(${a.map(r=>r.name).join(", ")}) => ${i.name}>`, p), o = ep.length, ep.push(n), o
        },
        ...
        I: function(r, e) {
            ...
            f[e >> 2] = t.getUTCSeconds(), f[e + 4 >> 2] = t.getUTCMinutes(), f[e + 8 >> 2] = t.getUTCHours(), f[e + 12 >> 2] = t.getUTCDate(), f[e + 16 >> 2] = t.getUTCMonth(), f[e + 20 >> 2] = t.getUTCFullYear() - 1900, f[e + 24 >> 2] = t.getUTCDay();
        ...
        F: r => {
            ...
            for (var t = 1; t <= 4; t *= 2) {
                var n = e * (1 + .2 / t);
                if (n = Math.min(n, r + 0x6000000), ew(Math.min(0x80000000, rc(Math.max(r, n), 65536)))) return !0
            }
            return !1
        },
        K: (r, e) => {
            var t = 0;
            return eb().forEach((n, o) => {
                var a = e + t;
                h[r + 4 * o >> 2] = a;
        ...
        J: function(r, e, t, n) {
            ...
            try {
                ...
                var o = rw.getStreamFromFD(r);
                return ry.llseek(o, e, t), m[n >> 3] = BigInt(o.position), o.getdents && 0 === e && 0 === t && (o.getdents = null), 0
            } catch (r) {
                if (void 0 === ry || "ErrnoError" !== r.name) throw r;
                return r.errno
            }
    ...
    function ex() {
        if (!(z > 0)) {
            ...
            K(W), z > 0 || (r.setStatus ? (r.setStatus("Running..."), setTimeout(() => {
        ...
        function n() {
            if (!T && (T = !0, r.calledRun = !0, !R)) {
                if (r.noFSInit || ry.initialized || ry.init(), ry.ignorePermissions = !1, rd.init(), K(U), e(r), r.onRuntimeInitialized?.(), r.postRun)
