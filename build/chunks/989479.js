/** Chunk was on web.js **/
/** chunk id: 989479, original params: e,t,n (module,exports,require) **/
"use strict";
n.d(t, {
    CV: () => s,
    E9: () => v,
...
function p(e) {
    let t = e.toLowerCase();
    return void 0 !== c[t] ? c[t] : t.match(/несколько/) ? 3 : t.match(/пол/) ? .5 : t.match(/пар/) ? 2 : "" === t ? 1 : parseFloat(t)
}
...
let y = `(${f})\\s{0,3}(${(0,r.uJ)(d)})`,
    b = RegExp(y, "i"),
    O = (0, r.mb)("(?:(?:около|примерно)\\s{0,3})?", y);
