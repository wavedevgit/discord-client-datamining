/** chunk id: 582343, original params: e,t,l (module,exports,require) **/
l.d(t, {
    A: () => g
});
var n = l(627968),
...
let h = {
    ...
    g = a.memo(function(e) {
        let {
            ...
            audio: x
        } = (0, d.L)(), [v, j] = a.useState(!1), [p, N] = a.useState(h), {
            playheadPositionMs: b,
            endPositionMs: y,
            startPositionMs: C
        } = p, A = null != x, w = y - C, S = w > 5 * u.A.Millis.SECOND;
        a.useEffect(() => {
            if (null != x) return N({
                playheadPositionMs: 0,
                endPositionMs: x.duration * u.A.Millis.SECOND,
                startPositionMs: 0
            }), () => {
                x.pause(), j(!1)
            }
