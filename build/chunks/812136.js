/** chunk id: 812136, original params: e,t,i (module,exports,require) **/
i.d(t, {
    F: () => A
});
var s = i(627968);
...
function I(e) {
    ...
    return (0, s.jsxs)(a.sqX, {
        ...
        }), null != c && (0, s.jsx)(a.DUT, {
            className: L.EP,
            onClick: c,
            "aria-label": v.intl.string(v.t.WAI6xu),
            children: (0, s.jsx)(a.aXh, {
                size: "xs",
                color: "currentColor"
            })
        })]
...
function A(e) {
    let {
        ...
        switch (e) {
            ...
            case h.B.GUILD_PRODUCTS_PREVIEW:
                return (0, s.jsx)(I, {
                    icon: N ? (0, s.jsx)("img", {
                        src: T ? (0, c.n)("server_products/storefront/question-mark.png") : (0, c.n)("server_products/storefront/question-mark.gif"),
                        className: L.kz,
                        alt: ""
                    }) : (0, s.jsx)(a.okO, {
                        size: "custom",
    ...
    return (0, s.jsxs)("div", {
        ...
        children: [(0, s.jsx)(a.Heading, {
            ...
            className: L.wx,
            children: v.intl.string(v.t.GF433I)
        }), (0, s.jsx)(a.hKd, {
            size: 12
        }), (0, s.jsxs)("div", {
            className: L.uW,
