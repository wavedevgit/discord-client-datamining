...
function k(e) {
    ...
    } = (0, x.NJ)(), [h, _] = a.useState("idle"), [A, I] = a.useState(t ?? ""), j = a.useRef(null), v = a.useRef(null), E = T.intl.string(T.t.xKSfBT), C = null != t && "" !== t.trim(), N = a.useCallback(() => {
        f({
