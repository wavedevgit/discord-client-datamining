...
function D(e) {
    ...
    } = (0, m.NJ)(), [p, I] = a.useState("idle"), [A, h] = a.useState(t ?? ""), E = a.useRef(null), v = a.useRef(null), T = j.intl.string(j.t.xKSfBT), N = null != t && "" !== t.trim(), C = a.useCallback(() => {
        x({
