...
function b(e) {
    let {
        ...
        id: T.id,
        icon: T.icon
    }), M = (0, a.bG)([_.Ay, p.A], () => _.Ay.getVisibleRunningGames().find(e => {
        let {
            id: t
        } = e;
        if (t === T.id) return !0;
    ...
    })), w = (0, a.bG)([h.A], () => h.A.getCurrentUserActiveStream()), D = (0, a.bG)([g.A], () => g.A.getChannelId()), k = f.default.extractTimestamp(b.id) + C.M < Date.now(), O = (0, i.jsx)(i.Fragment, {
