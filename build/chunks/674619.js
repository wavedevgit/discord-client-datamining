...
function F(e) {
    ...
    return (0, l.jsx)(A.x, {
        ...
        onReturn: () => {
            ...
            c && (l = T.pn.REVIEW), m && e.length < 1 && (l = T.pn.SELECT_FREE_SKU), t(l, {
