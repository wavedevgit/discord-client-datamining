...
function W(e) {
    ...
    return (0, l.jsx)(j.x, {
        ...
        onReturn: () => {
            ...
            m && (l = A.pn.REVIEW), S && e.length < 1 && (l = A.pn.SELECT_FREE_SKU), n(l, {
                trackedFromStep: A.pn.PAYMENT_TYPE
            })
        }
    })
}
let K = function() {
        ...
        return [{
            key: null,
            renderStep: e => (0, l.jsx)(f.I, {
                ...e
            })
        }, {
            key: A.pn.SKU_SELECT,
            renderStep: e => (0, l.jsx)(U.F, {
                ...e
            }),
            options: {
                renderHeader: !1,
            ...
            renderStep: () => (0, l.jsx)(M.A, {})
        }, {
            key: A.pn.AWAITING_AUTHENTICATION,
            renderStep: () => (0, l.jsx)(R.A, {})
        }, {
            key: A.pn.REVIEW,
