...
function B(e) {
    ...
    return (0, i.jsx)(g.x, {
        ...
        onReturn: () => {
            ...
            c && (i = I.pn.REVIEW), m && e.length < 1 && (i = I.pn.SELECT_FREE_SKU), t(i, {
                trackedFromStep: I.pn.PAYMENT_TYPE
            })
        }
    })
}
let W = function() {
        ...
        return [{
            key: null,
            renderStep: e => (0, i.jsx)(A.I, {
                ...e
            })
        }, {
            key: I.pn.SKU_SELECT,
            renderStep: e => (0, i.jsx)(k.F, {
                ...e
            }),
            options: {
                renderHeader: !1,
            ...
            key: I.pn.AWAITING_PURCHASE_TOKEN_AUTH,
            renderStep: () => (0, i.jsx)(j.A, {})
        }, {
            key: I.pn.AWAITING_AUTHENTICATION,
