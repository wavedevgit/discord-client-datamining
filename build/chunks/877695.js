...
function T(e) {
    ...
    } = e, _ = r.useRef(null), [h, g] = r.useState(!0), [T, S] = r.useState(!1), N = t.state === E.elq.ACCEPTING, j = (0, s.bG)([c.A], () => c.A.useReducedMotion);
    r.useLayoutEffect(() => {
    ...
    let L = (0, m.oO)(t),
        ...
        w = r.useMemo(() => T && _.current?.clientHeight != null ? {
