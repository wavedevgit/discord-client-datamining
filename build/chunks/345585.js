/** chunk id: 345585 params = (module,exports,require) **/
i.d(e, {
    default: () => j
});
var l = i(627968),
        ...
        let {
            ...
            if (!i && await (0, f.ih)(t.name)) {
                ...
                try {
                    ...
                    let t = new o.LG(e);
                    (0, d.showToast)((0, d.createToast)(t.getAnyErrorMessage() ?? M.intl.string(M.t.fEptJP), d.ToastType.FAILURE))
                } finally {
                    s(!1)
                }
            }
        }, j = t.triggerType === w.uh.MENTION_SPAM && c?.features != null && c.features.has(x.GuildFeatures.COMMUNITY);
        return (0, l.jsx)(d.Drp, {
