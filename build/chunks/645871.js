...
let c = e => {
    ...
    } = t, C = y - g, N = l.useRef(null), R = l.useRef(null), L = l.useRef(c);
    l.useLayoutEffect(() => {
        let e = L.current;
    ...
    let w = a.to(e => Math.min(Math.max(0, e - g), C)),
        ...
        {
            progressToPlayheadBarTransform: M,
            glowWidth: k
        } = function(e) {
            let {
                segmentWidth: t,
        ...
        })).filter(e => e.endPx >= g && e.startPx <= y), [E, g, y, p]);
    return (0, r.jsxs)(s.animated.div, {
        ...
        children: [(0, r.jsxs)("div", {
            ...
            children: [(0, r.jsxs)(s.animated.div, {
                ...
                }, `${e.startPx}:${e.endPx}`)), null != x && U > 0 && (0, r.jsx)("div", {
                    className: o.YK,
                    style: {
                        width: `${U}px`,
                        opacity: 1,
