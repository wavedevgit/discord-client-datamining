/** chunk id: 382694, original params: e,t,n (module,exports,require) **/
n.d(t, {
    A: () => k
});
var i = n(627968),
...
function k(e) {
    let {
    ...
    } = (0, c.Ay)(o.A.PREMIUM_MARKETING_PERK_CARD), k = (0, p.O9)(), V = h.A.useExperiment({
        location: "PremiumWhatsNewSection"
    }).enabled, w = (0, _.A)({
        scrollPosition: j._F.TRY_IT_OUT,
        analyticsLocations: a
    }), H = (0, s.useCallback)(() => {
    ...
    }, []), Y = (0, S.$F)(), F = (0, S.Xb)(), z = Y?.status === S.Wo.UPCOMING, W = (0, I.N)(Y?.id), K = (0, C.z)(), {
        currentDate: Z,
        nDaysInMonth: q
    } = (0, s.useMemo)(() => {
        let e = new Date;
        ...
        let e = {
                ...
                primaryAssetClassName: r()(R.pq, {
                    [R.n6]: z
                }),
                caption: null != F ? O.intl.formatToPlainString(O.t.Hu4jfi, {
                    date: new Date(F)
                }) : void 0,
                description: null != Y ? Y.status === S.Wo.UPCOMING ? O.intl.formatToPlainString(O.t.a1eKDi, {
                    days: Y.daysLeft
                }) : (0, T.T)(Y.id, Y.tenureReqNumMonths) : void 0,
                progress: K ?? void 0,
            ...
            t = [k ? {
                ...
                description: O.intl.formatToPlainString(O.t.WQazjs, {
                    themeCount: 20
                }),
                primaryAsset: M.A,
                ctaText: O.intl.string(O.t.jVcuVY),
