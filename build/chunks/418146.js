...
function D() {
    ...
    return ((0, s.Ay)(() => () => {
        t(y.i.AUTO_DISMISS)
    }), e !== o.M.OVERLAY_OOP_SETTINGS_NUX) ? null : (0, i.jsxs)(i.Fragment, {
...
let M = (0, _.t_)(S.X.OVERLAY_PANEL, {
        initialize: function() {
            return (0, C.Q)(), A.Ay.addChangeListener(C.Q), m.A.addChangeListener(C.Q), T.default.addChangeListener(C.Q), p.default.addChangeListener(C.Q), f.isPlatformEmbedded && (0, c.a2)(), () => {
                A.Ay.removeChangeListener(C.Q), m.A.removeChangeListener(C.Q), T.default.removeChangeListener(C.Q), p.default.removeChangeListener(C.Q), f.isPlatformEmbedded && (0, c.e0)()
            }
        },
