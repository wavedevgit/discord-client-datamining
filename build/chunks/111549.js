...
function q(e) {
    let {
        invite: t,
        handleAccept: n
    } = e, s = null != t.guild_scheduled_event ? (0, i.jsx)(E.X, {
        channel: t.channel,
    ...
    }), r = null != t.guild_scheduled_event && null != t.guild ? (0, i.jsx)(f.Ay, {
        className: W.QX,
    ...
    return (0, i.jsxs)("div", {
        children: [(0, i.jsxs)(f.Ay, {
            children: [s, (0, i.jsx)(Q, {
                message: V.intl.string(V.t.ohMvm1),
                onClick: n,
                invite: t
            })]
        }), r]
    ...
    return (0, i.jsx)(f.Ay, {
        children: (0, i.jsxs)(h.BJc, {
            ...
            children: [(0, i.jsx)(D.A, {
                invite: t,
                error: n?.message
            }), n?.code === P.t02.INVALID_CANNOT_FRIEND_SELF ? (0, i.jsx)(Q, {
                invite: t,
                message: V.intl.string(V.t.fIv16B),
                onClick: r
            }) : (0, i.jsx)(Q, {
                invite: t,
                message: V.intl.string(V.t.ohMvm1),
...
function $(e) {
    ...
    return (0, i.jsxs)(f.Ay, {
        children: [(0, i.jsx)(f.hE, {
            ...
            children: t ? V.intl.string(V.t["5AkWAd"]) : V.intl.string(V.t["+qUJAj"])
        }), (0, i.jsx)(Q, {
            message: V.intl.string(V.t.fIv16B),
            onClick: n
        }), (0, i.jsx)("div", {
...
class ee extends s.PureComponent {
    ...
    render() {
        ...
        if (this.state.appHasOpened || t === P.fAW.OPEN || e.state === P.elq.APP_OPENED) return (0, i.jsx)(Y, {
            invite: e,
        ...
        switch (e.state) {
            ...
            case P.elq.APP_OPENING:
                return (0, i.jsx)(X, {
                    title: V.intl.string(V.t["Z+hCVU"])
                });
            case P.elq.RESOLVED:
                if (n && (0, o.Lt)(e.flags ?? 0, a.Q.IS_GUEST_INVITE)) return p.Ay.openApp(e.code), u.u.set(N.B, e.code), (0, i.jsx)(Y, {
                    invite: e,
                    onContinue: () => s(P.BVt.APP),
                    handleContinue: this.handleContinue
                });
                if (n || !M.VP) return (0, i.jsx)(q, {
                    invite: e,
                    handleAccept: this.handleAccept
                });
                if (this.getMode() === K) return (0, i.jsx)(B.A, {
                    invite: e,
                    transitionTo: s,
                    location: r
                });
            ...
            case P.elq.ACCEPTING:
                return (0, i.jsx)(X, {
                    title: V.intl.string(V.t["6wsY16"])
                });
            case P.elq.EXPIRED:
                return (0, i.jsx)($, {
                    banned: !1,
