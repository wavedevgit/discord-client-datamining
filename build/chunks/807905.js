...
function j(e) {
    let {
        ...
        useReducedMotion: u,
        fractionalState: m
    } = e, g = s.useMemo(() => null != t.cooldownEndsAt ? new Date(t.cooldownEndsAt) : null, [t]), _ = (0, T.I5)(t), x = r?.isPaused === !0 && m === N.xc.NONE, A = v.intl.string(v.t.mOWsF1);
    return (0, i.jsxs)("li", {
        className: I.Hp,
