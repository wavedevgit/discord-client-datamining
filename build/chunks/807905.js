...
function j(e) {
    let {
        ...
        useReducedMotion: u,
        fractionalState: m
    } = e, _ = s.useMemo(() => null != t.cooldownEndsAt ? new Date(t.cooldownEndsAt) : null, [t]), g = (0, T.I5)(t), x = r?.isPaused === !0 && m === v.xc.NONE, A = N.intl.string(N.t.mOWsF1);
    return (0, i.jsxs)("li", {
        className: I.Hp,
        children: [(0, i.jsxs)("div", {
            ...
            }) : t.isOnCooldown() && null != _ ? (0, i.jsx)(E.A, {
                cooldown: _.getTime()
            }) : (0, i.jsx)(c.Text, {
