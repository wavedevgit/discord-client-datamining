/** Chunk was on web.js **/
/** chunk id: 545533, original params: e (module,exports,require) **/
function t(e) {
    let t = e.regex,
        n = e.COMMENT("//", "$", {
            contains: [{
...
e.exports = function(e) {
    let n = ["boolean", "byte", "word", "String"],
        ...
        s = t(e),
        o = s.keywords;
    return o.type = [...o.type, ...n], o.literal = [...o.literal, ...a], o.built_in = [...o.built_in, ...r], o._hints = i, s.name = "Arduino", s.aliases = ["ino"], s.supersetOf = "cpp", s
}