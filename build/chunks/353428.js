...
function U(e) {
    let {
        channel: t,
        children: n
    } = e, l = (0, u.h)(t.linkedLobby?.application_id), [s, a] = (0, m.kn)([o.M.CHANNEL_LINKED_LOBBY_EDUCATION_TOOLTIP], void 0, !0);
    if (null == l) return null;
    let r = T.Ay.getApplicationIconURL({
            id: l.id,
            icon: l.icon,
            size: 14
        }),
...
let P = e => {
    ...
    }, [n, s]), t.isDM() && n?.isStaff() && null != s) ? s.isStaff() ? (0, i.jsx)(h.A, {
