/** chunk id: 508595 params = (module,exports,require) **/
"use strict";
n.d(t, {
    A: () => c,
    q: () => d
...
function d(e, t) {
    ...
    return (0, s.yK)([r.Ay], () => {
        ...
        return s.forEach(e => {
            ...
            s.isThread() || t.has(s.id) || s.isGuildStageVoice() && !i || !n && (0, l.A)(s) || (null == s.parent_id ? c.push({
                channel: s,
                comparator: r
            }) : (null == u[s.parent_id] && (u[s.parent_id] = []), u[s.parent_id].push({
                channel: s,
                comparator: r
            })))
        }), c.sort((e, t) => {
            ...
            e.push((0, a.eW)(i).row);
            let s = u[i.id];
            return null != s && s.length > 0 && s.forEach(t => {
                let {
                    channel: n
                } = t;
                e.push((0, a.eW)(n).row)
