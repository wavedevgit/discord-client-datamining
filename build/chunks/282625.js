/** chunk id: 282625 params = (module,exports,require) **/
"use strict";
n.d(t, {
    A: () => k
});
...
let L = s.forwardRef((e, t) => {
    ...
    return null == l ? null : (0, i.jsx)(S.A, {
        ref: t,
        ...a,
        guildId: l,
        guild: r,
        ...
        onChannelContextMenu: e => {
            ...
            null != t.options.channel && "string" != typeof t.options.channel && null != s && (0, m.L3)(e, async () => {
                let {
                    default: e
                } = await n.e("23440").then(n.bind(n, 194195));
                return n => null != t.options.channel ? (0, i.jsx)(e, {
                    ...n,
                ...
                case y.GaG.CHANNEL_OVERWRITE:
                    ...
                    return (0, m.L3)(e, async () => {
                        ...
                        return n => (0, i.jsx)(e, {
                            ...n,
                            id: t.targetId,
                            label: R.intl.string(R.t.rCazna)
                        })
                    });
                case y.GaG.USER:
                    let o = N.default.getUser(t.targetId);
                    if (null != o && null != l) return (0, m.L3)(e, async () => {
                        let {
                            default: e
                        } = await n.e("76926").then(n.bind(n, 422189));
                        return t => (0, i.jsx)(e, {
...
class M extends s.PureComponent {
    ...
    formatUserOption = e => {
        ...
        };
        {
            ...
            return {
                ...
                trailing: t.hasUniqueUsername() ? void 0 : (0, i.jsxs)(c.Text, {
    ...
    renderHeaderDropdowns = () => {
        ...
        let l = T.ACTION_FILTER_ITEMS(),
            ...
            a = {
                label: R.intl.string(R.t.ZRFdsL),
        ...
        return (0, i.jsxs)(i.Fragment, {
            children: [(0, i.jsxs)("div", {
                ...
                children: [(0, i.jsx)(c.Heading, {
                    ...
                    children: R.intl.string(R.t.SPWLyT)
