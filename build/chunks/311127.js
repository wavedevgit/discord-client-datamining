...
function p(e) {
    let {
        guildId: t
    } = e, n = (0, s.bG)([A.default], () => A.default.getCurrentUser()), p = (0, s.bG)([m.A], () => m.A.getGuild(t)), x = (0, s.bG)([_.A], () => _.A.getRolesSnapshot(t)), S = (0, s.bG)([_.A], () => _.A.getSortedRoles(t)), {
        impersonateType: O,
        viewingRoles: M
    } = (0, s.cf)([f.A], () => ({
        impersonateType: f.A.getImpersonateType(t),
        viewingRoles: f.A.getViewingRoles(t)
    })), D = O === N._.SERVER_SHOP, P = (0, s.bG)([u.Ay], () => null != n ? u.Ay.getTrueMember(t, n.id) : null), U = null != p ? x[(0, c.af)(p)] : null, [v, L] = a.useState(() => {
    ...
    let y = null != p && null != n && null != P ? S.find(e => P.roles.includes(e.id)) : void 0,
        b = a.useMemo(() => null != p && null != n ? S.filter(e => !(0, d.Oy)(e)).filter(e => !D || e.tags?.subscription_listing_id != null).filter(e => y?.id === e.id || E.wO(p, n.id, y, e)) : [], [p, n, D, y, S]),
        k = a.useMemo(() => {
