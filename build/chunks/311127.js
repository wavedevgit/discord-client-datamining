...
function T(e) {
    ...
    let U = null != T && null != n && null != O ? R.find(e => O.roles.includes(e.id)) : void 0,
        P = l.useMemo(() => null != T && null != n ? R.filter(e => !(0, d.Oy)(e)).filter(e => !j || e.tags?.subscription_listing_id != null).filter(e => U?.id === e.id || h.wO(T, n.id, U, e)) : [], [T, n, j, U, R]),
        k = l.useMemo(() => {
