...
function E() {
    ...
    return r.useMemo(() => e === l.M.RESTRICTED_ACCOUNTS_SETTING_NOTICE, [e]) ? (0, i.jsx)(s.e, {
        label: p.t.zqv4nV,
        labelHook: () => {
            let e = (0, d.WJ)("RestrictedAccountsSettingNotice");
            (0, c.openUserSettings)(e ? o.X.CONTENT_AND_SOCIAL_RESTRICTED_USERS_CATEGORY : o.X.CONTENT_AND_SOCIAL_PANEL, {
