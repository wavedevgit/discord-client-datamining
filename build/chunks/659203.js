...
class y extends l.Component {
    ...
    getTitleText() {
        ...
        return this.recipientHasNitro && void 0 === this.trialOffer.redeemed_at ? j.intl.formatToPlainString(j.t["Mptau/"], {
            username: t
        }) : this.offerExpired ? this.isSender ? j.intl.string(j.t["9SNdf4"]) : j.intl.formatToPlainString(j.t["H0+MxK"], {
            userName: i
        }) : j.intl.formatToPlainString(j.t.IiWKwg, {
            senderUserName: i,
            recipientUserName: t
        })
    }
    getBodyText() {
        return this.recipientHasNitro && !this.isSender && void 0 === this.trialOffer.redeemed_at ? j.intl.format(j.t.LwCwT9, {
            helpdeskArticle: p.A.getArticleURL(M.MVz.REFERRAL_PROGRAM)
        }) : this.offerExpired ? null : j.intl.string(j.t.lQLlOb)
    }
    renderActions() {
        let e = this.currentUser.id !== this.trialOffer.user_id || (0, x.TW)(this.currentUser) || !this.currentUser.verified || (0, R.P)(this.trialOffer),
    ...
    renderExpirationDate() {
        ...
        if (void 0 !== e.redeemed_at && !this.isSender && null !== t) return j.intl.formatToPlainString(j.t.nP0ivR, {
            date: (0, g.i$)(r()(t), "LL")
        });
        if (this.recipientHasNitro || void 0 === e.expires_at) return null;
        let n = r()(e.expires_at);
        return this.offerExpired ? j.intl.formatToPlainString(j.t.PuSHfU, {
            date: (0, g.i$)(r()(n), "LL")
        }) : (0, I.GQ)(n.valueOf())
    }
    renderMedia() {
        ...
        let e = () => {
                ...
                if (this.isSender)
                    if (this.recipientHasNitro && void 0 === this.trialOffer.redeemed_at) return {
                        headerText: j.intl.formatToPlainString(j.t.qABVhL, {
                            recipient: t
                        }),
                        ...
                        bodyText: j.intl.formatToPlainString(j.t["0gnFLC"], {
                            recipient: t
                        })
                    };
                return this.offerExpired ? {
                    headerText: j.intl.string(j.t.nYvpUl),
                    bodyText: j.intl.formatToPlainString(j.t.wJdBEZ, {
                        sender: i
                    })
                } : {
                    headerText: j.intl.string(j.t.HtTvXA),
                    bodyText: j.intl.formatToPlainString(j.t.wOQByA, {
                        sender: i
                    })
                }
            },
            ...
            l = (0, i.jsx)(c.Button, {
                ...
                onClick: () => (e => {
                    ...
                    analyticsLocations: [],
                    startingScreen: this.referralsSent.size === T.Z ? N.SelectFriendsModalScreens.REMINDER : N.SelectFriendsModalScreens.SELECT_FRIENDS
                }),
