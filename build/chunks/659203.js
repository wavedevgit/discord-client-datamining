...
class v extends r.Component {
    ...
    renderActions() {
        let e = this.currentUser.id !== this.trialOffer.user_id || (0, p.TW)(this.currentUser) || !this.currentUser.verified || (0, O.P)(this.trialOffer),
...
function y(e) {
    ...
    }), [n, t]), u = I.default.getCurrentUser(), A = (0, c.bG)([I.default], () => null != s && (0, p.TW)(void 0 !== u && s.user_id === u.id ? u : I.default.getUser(s.user_id))), m = (0, c.bG)([T.A], () => A ? T.A.getPremiumTypeSubscription()?.trialEndsAt : null), {
        analyticsLocations: g
    } = (0, E.Ay)(_.A.SHARE_NITRO_EMBED);
    return l ? (0, i.jsx)(d.Wb, {
        isHorizontal: !a.Fr
