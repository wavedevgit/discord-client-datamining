...
let b = e => {
    ...
    } = e, [R, P] = r.useState(null), [w, M] = r.useState(null), D = (0, _.A)(e => {
        let t = e.target;
        P(t.offsetWidth), M(t.scrollWidth)
    }), k = (0, u.w)(D), O = a === m.uF.QUESTS_EMBED, U = n.userStatus?.completedAt != null, B = (0, h.S5)(n.config.expiresAt), G = (0, h.S5)(n.config.rewardsConfig.rewardsExpireAt), F = r.useMemo(() => null != n.config.cosponsorMetadata, [n]), H = (0, i.jsx)(A.Ay, {
        className: E.Iu,
