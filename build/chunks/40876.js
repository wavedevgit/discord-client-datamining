...
let i = {
    ...
    MessageManager: {
        actions: ["APP_STATE_UPDATE", "OVERLAY_INITIALIZE", "CONNECTION_RESUMED", "CHANNEL_SELECT", "VOICE_CHANNEL_SELECT", "THREAD_CREATE", "THREAD_LIST_SYNC", "CHANNEL_CREATE", "CHANNEL_PRELOAD", "GUILD_CREATE", "MESSAGE_END_EDIT", "LOAD_MESSAGES_SUCCESS", "UPLOAD_FAIL", "CHANNEL_DELETE", "THREAD_DELETE", "CHANNEL_RTC_JUMP_TO_VOICE_CHANNEL_MESSAGE"],
    ...
    OverlayTextChatAutomaticLifecycleManager: {
        actions: ["CHANNEL_SELECT", "MESSAGE_CREATE", "SIDEBAR_VIEW_CHANNEL", "VOICE_CHANNEL_SELECT", "VOICE_STATE_UPDATES", "OVERLAY_TEXT_CHAT_ADD_OR_UPDATE_CHANNEL", "OVERLAY_TEXT_CHAT_SELECT_CHANNEL", "OVERLAY_TEXT_CHAT_REMOVE_CHANNEL", "OVERLAY_TEXT_CHAT_SET_VOICE_CHAT_MINIMIZED"],
