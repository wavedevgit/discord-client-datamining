/** chunk id: 131935, original params: e,t,i (module,exports,require) **/
i.d(t, {
    A: () => l
});
var n = i(559633),
...
async function l(e, t) {
    let {
        ...
        feedback: u,
        analyticsData: d
    } = t, c = o.Ay.getSettings(), m = o.Ay.getInputDeviceId(), b = o.Ay.getInputDevices()[m], p = o.Ay.getOutputDeviceId(), g = o.Ay.getOutputDevices()[p], v = o.Ay.getVideoDeviceId(), f = o.Ay.getVideoDevices()[v], O = o.Ay.getNoiseCancellation(), A = o.Ay.getMediaEngine().getAudioSubsystem(), E = o.Ay.getMediaEngine().getAudioLayer(), y = await n.A.getKrispModel(), {
