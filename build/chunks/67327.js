/** chunk id: 67327 params = (module,exports,require) **/
i.d(e, {
    default: () => Y
});
var s = i(627968),
...
class J extends n.Component {
    ...
    get buttonText() {
        return (0, M.UJ)(this.step, this.props.giftCode, {
    ...
    get firstHeaderText() {
        ...
        if (t && !i)
            if (!e) return $.intl.formatToPlainString($.t.xHzRub, {
                ...
                if (null != l) switch (l) {
                    case r.R.AVATAR_DECORATION:
                        return $.intl.formatToPlainString($.t.SKduyh, {
                            sender: e
                        });
                    case r.R.PROFILE_EFFECT:
                        return $.intl.formatToPlainString($.t["1w42T2"], {
                            sender: e
                        });
                    case r.R.NAMEPLATE:
                        return $.intl.formatToPlainString($.t.vFiQlU, {
                            sender: e
                        });
                    case r.R.PROFILE_FRAME:
                        return $.intl.formatToPlainString($.t["UH/EQL"], {
                            sender: e
                        });
                    default:
                        return $.intl.formatToPlainString($.t.U4Ko2y, {
                            sender: e
                        })
                }
    ...
    get secondHeaderText() {
        ...
        return $.intl.formatToPlainString($.t.DDO4Wz, {
            sender: F.Ay.getName(t)
        })
    }
    get bodyText() {
        let {
    ...
    handleGoToLibrary = () => {
        ...
        (0, T.pX)(V.BVt.APPLICATION_LIBRARY, {
            state: {
    ...
    render() {
        let {
            ...
            emojiName: f,
            soundId: p
        } = this.props, h = N.default.getUser(n.userId), {
            isCustomGift: m,
            isCollectiblesGift: g,
            accepted: A,
            opened: x,
            emojiURL: y
        } = this.state, R = N.default.getCurrentUser(), S = this.step === V.frR.ERROR, T = n?.userId != null && null != R && R?.id != null && n.userId === R.id;
        switch (this.step) {
            case V.frR.ERROR:
                d?.(n, !1);
                break;
        ...
        return (0, s.jsxs)("div", {
            ...
            children: [(0, s.jsxs)(u.EOs, {
                ...
                children: [null != n.giftStyle && !m && !g && (0, s.jsx)(H.A, {
                    ...
                    children: [!g && (null == n.giftStyle || m && A) ? (0, s.jsx)(C.A, {
                        size: C.M.LARGE,
                        game: t,
                        skuId: n.skuId
                    }) : null, (0, s.jsxs)(u.Heading, {
                        id: l,
                        className: a()({
                            [Q.Ry]: m && !A,
                            [Q.wx]: !m || A
                    ...
                    }), m && !g && null != n.giftStyle && !A && !S && (0, s.jsx)(H.A, {
                        defaultAnimationState: this.getDefaultAnimationStatus(),
                        idleAnimationState: this.getIdleAnimationStatus(),
                        className: Q.l$,
                        giftStyle: n.giftStyle
                    }), this.state.opened && !S && g && (0, s.jsx)(_.A, {
                        giftCode: n
                    }), S && (0, s.jsx)(u.Text, {
                        className: Q.rf,
                        variant: "text-md/normal",
                        children: this.errorMessage
                    }), m && this.state.opened && !this.state.accepted && !S && null != c && "" !== c && !T && (0, s.jsxs)(s.Fragment, {
                        children: [(0, s.jsx)(u.Heading, {
                            id: l,
                            variant: "heading-md/semibold",
                            children: $.intl.format($.t.DDO4Wz, {
                                sender: F.Ay.getName(h)
                            })
                        }), (0, s.jsx)(u.Text, {
                            className: Q.$B,
...
let K = o.Ay.connectStores([O.A, w.A, m.A, E.A, P.A, c.A, g.A], t => {
        let {
            giftCode: e
        } = t, i = w.A.get(e.skuId), s = null != i ? m.A.getApplication(i.applicationId) : null, n = c.A.useReducedMotion;
        return {
            sku: i,
            libraryApplication: null != i && e?.entitlementBranches != null ? (0, M.YI)(e.entitlementBranches, i, O.A) : null,
            application: s,
        ...
        }, [e, c, l, a, i, r, o, u, d]), c) ? null : (0, s.jsx)(J, {
            ...t
        })
    }),
    Y = t => {
        let {
            ...
            onClose: r,
            ...u
        } = t, d = (0, S.GV)(), c = (0, o.bG)([E.A], () => E.A.get(i)), {
            analyticsLocations: h
        } = (0, p.Ay)(f.A.GIFT_CODE_MODAL), {
            product: m
        } = (0, x.q)(c?.skuId, !0);
        return null == c ? null : (0, s.jsx)(K, {
            ...u,
            customGiftMessage: n,
            channelContext: e,
            giftCode: c,
