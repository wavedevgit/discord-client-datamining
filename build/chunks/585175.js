...
let C = (0, g.E2)(A.X.VOICE_INPUT_SENSITIVITY_FIELD_SET, {
    ...
    Component: function() {
        ...
        }(), _ = (0, r.bG)([x.Ay], () => x.Ay.isEnabled()), g = s.useMemo(() => !_ && (0, i.jsx)("div", {
            className: f.B4,
        ...
        }), [_]), A = s.useMemo(() => e ? p.intl.string(p.t.JsbzjA) : p.intl.string(p.t.MLmyMY), [e]), T = s.useId(), S = s.useId();
