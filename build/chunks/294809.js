...
function H(e) {
    let {
        ...
        return (0, r.yK)([_.A, S.default, c.A, E.A], () => Object.values(_.A.getVoiceStatesForChannel(t)).map(e => S.default.getUser(e.userId)).filter(N.Vq).sort((e, t) => E.A.isFriend(e.id) && !E.A.isFriend(t.id) ? -1 : !E.A.isFriend(e.id) && E.A.isFriend(t.id) ? 1 : (c.A.getUserAffinity(t.id)?.vcProbability ?? 0) - (c.A.getUserAffinity(e.id)?.vcProbability ?? 0)), [t])
    }({
        channelId: t
    });
...
function Y(e) {
    let t, {
        ...
        [X] = (0, r.bG)([p.Ay], () => null == Y || null == z ? [
            [], 0
        ] : [p.Ay.getVoiceStatesForChannel(Y), p.Ay.getVoiceStateVersion(z)], [Y, z], T.D),
        Z = null != X && X.length > 0,
        Q = (0, r.bG)([_.A, A.A], () => {
    ...
    return (0, l.jsxs)("div", {
        ...
        children: [(0, l.jsx)(x.D, {
            ...
            primaryText: (0, l.jsxs)("div", {
                className: b.QV,
                children: [null == (t = (0, d.gU)(Y, B)) ? null : (0, l.jsx)(t, {
                    color: eg.hex(),
                    size: "xxs",
                    className: b.p
                }), (0, l.jsx)(u.Text, {
            ...
            secondaryText: null != Q ? (0, l.jsxs)("div", {
                className: P.z2,
        ...
        }), S && X.length > 0 ? (0, l.jsx)("div", {
            className: P.Nz,
            children: X.slice(0, 25).map(e => (0, l.jsx)(O.a, {
                channelId: n,
                guildId: z,
                userId: e.user.id,
                onDoubleClick: V,
