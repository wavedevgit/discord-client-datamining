...
function H(e) {
    let {
        ...
        return (0, r.yK)([p.A, S.default, c.A, E.A], () => Object.values(p.A.getVoiceStatesForChannel(t)).map(e => S.default.getUser(e.userId)).filter(T.Vq).sort((e, t) => E.A.isFriend(e.id) && !E.A.isFriend(t.id) ? -1 : !E.A.isFriend(e.id) && E.A.isFriend(t.id) ? 1 : (c.A.getUserAffinity(t.id)?.vcProbability ?? 0) - (c.A.getUserAffinity(e.id)?.vcProbability ?? 0)), [t])
    }({
        channelId: t
    });
...
function Y(e) {
    let t, {
        ...
        [X] = (0, r.bG)([N.Ay], () => null == Y || null == z ? [
            [], 0
        ] : [N.Ay.getVoiceStatesForChannel(Y), N.Ay.getVoiceStateVersion(z)], [Y, z], _.D),
        Z = null != X && X.length > 0,
        Q = (0, r.bG)([p.A, A.A], () => {
    ...
    return (0, l.jsxs)("div", {
        ...
        children: [(0, l.jsx)(x.D, {
            ...
            primaryText: (0, l.jsxs)("div", {
                className: b.QV,
                children: [null == (t = (0, d.gU)(Y, $)) ? null : (0, l.jsx)(t, {
                    color: eg.hex(),
                    size: "xxs",
                    className: b.p
                }), (0, l.jsx)(u.Text, {
            ...
            className: P.Nz,
            children: X.slice(0, 25).map(e => (0, l.jsx)(U.a, {
                channelId: n,
                guildId: z,
                userId: e.user.id,
                onDoubleClick: V,
