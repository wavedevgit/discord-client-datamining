...
function z(e) {
    let {
        ...
        return (0, l.yK)([_.A, p.default, c.A, I.A], () => Object.values(_.A.getVoiceStatesForChannel(t)).map(e => p.default.getUser(e.userId)).filter(x.Vq).sort((e, t) => I.A.isFriend(e.id) && !I.A.isFriend(t.id) ? -1 : !I.A.isFriend(e.id) && I.A.isFriend(t.id) ? 1 : (c.A.getUserAffinity(t.id)?.vcProbability ?? 0) - (c.A.getUserAffinity(e.id)?.vcProbability ?? 0)), [t])
    }({
        channelId: t
    });
...
function H(e) {
    let t, {
        ...
        H = (0, l.bG)([h.A], () => h.A.getChannel(n), [n]),
        Y = (0, u.Ay)(H ?? void 0, !0) ?? "???",
        W = H?.getGuildId?.() ?? null,
        B = (0, l.bG)([g.A], () => null != W ? g.A.getGuild(W) ?? null : null, [W]),
        Z = (0, l.bG)([E.A], () => E.A.getVoiceChannelId() === n, [n]),
        X = (0, l.bG)([m.A], () => null != H && (!!H.isPrivate?.() || m.A.can(k.xBc.READ_MESSAGE_HISTORY, H)), [H]),
        [K] = (0, l.bG)([S.Ay], () => null == H || null == W ? [
            [], 0
    ...
    let en = r.useCallback(e => {
            e.stopPropagation(), y?.({
                type: R.c.CONNECT_VOICE_CHANNEL,
                channelId: n,
                guildId: W
            }), p || x?.(n)
        }, [n, W, p, y, x]),
        ei = r.useCallback(e => {
            e.stopPropagation(), y?.({
                type: R.c.DISCONNECT_VOICE_CHANNEL,
                channelId: n
            })
        }, [n, y]),
        er = r.useCallback(() => {
            X && y?.({
                type: R.c.OPEN_TEXT_CHAT_CHANNEL,
                channelId: n,
                guildId: W
            })
        }, [X, n, W, y]),
        ...
        eI = () => {
            let e = Z ? U.intl.string(U.t["6vrfgt"]) : U.intl.string(U.t.S0W8Z5),
                t = Z ? ed.hex() : eu.hex(),
                n = Z ? em : o._jp;
            return (0, i.jsx)("div", {
                onDoubleClick: V,
    ...
    return (0, i.jsxs)("div", {
        ...
        children: [(0, i.jsx)(v.D, {
            ...
            className: P.Nz,
            children: K.slice(0, 25).map(e => (0, i.jsx)(D.a, {
                channelId: n,
                guildId: W,
                userId: e.user.id,
                onDoubleClick: V,
