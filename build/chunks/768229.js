/** chunk id: 768229, original params: e,t,n (module,exports,require) **/
n.d(t, {
    o: () => s
});
var i = n(64700);
let s = function(e) {
    let {
        ...
        let n = o.current[e];
        null != n && (n.style.scrollMarginTop = `${t}px`, n.scrollIntoView({
            behavior: "smooth",
            block: "start"
        }))
    }, [t]), [s, a] = (0, i.useState)(Object.fromEntries(e.map(e => [e, !1]))), [r, l] = (0, i.useState)(e[0]);
    (0, i.useEffect)(() => {
