...
function D() {
    let e = (0, d.DP)(),
        ...
        G = (0, l.useCallback)(() => {
            let e = (0, h.Ci)("openCustomAppSettings") ? m.X.DISPLAY_IN_APP_ICON_CATEGORY : m.X.APPEARANCE_IN_APP_ICON;
        ...
        M = (0, l.useCallback)(() => {
            (0, A.pX)(C.BVt.COLLECTIBLES_SHOP)
        }, []),
        U = (0, l.useCallback)(() => {
            (0, p.openUserSettings)(m.X.SOUNDBOARD_CATEGORY, {
                section: C.nc_.VOICE,
                subsection: I.MJ,
                analyticsLocations: i
            })
        ...
        k = (0, l.useCallback)(() => {
            (0, p.openUserSettings)(m.X.PROFILE_PANEL, {
