...
function L() {
    let e = (0, c.DP)(),
        ...
        L = (0, a.useCallback)(() => {
            (0, h.openUserSettings)(f.X.APPEARANCE_THEME_CATEGORY, {
                analyticsLocations: P
            })
        }, [P]),
        U = (0, a.useCallback)(() => {
            (0, h.openUserSettings)(f.X.PREMIUM_GUILD_SUBSCRIPTIONS_PANEL, {
                analyticsLocations: P
            })
        }, [P]),
        k = (0, a.useCallback)(() => {
            (0, h.openUserSettings)(f.X.APPEARANCE_IN_APP_ICON_CATEGORY, {
                analyticsLocations: P
            })
        }, [P]),
        B = (0, a.useCallback)(() => {
        ...
        w = (0, a.useCallback)(() => {
            (0, h.openUserSettings)(f.X.SOUNDBOARD_CATEGORY, {
                analyticsLocations: P
            })
        }, [P]),
        G = (0, g.A)({
