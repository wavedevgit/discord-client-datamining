...
let G = [{
    id: "bestof",
    label: () => v.intl.string(v.t.q1u7nQ)
}, {
    id: "appearance",
    label: () => v.intl.string(v.t.CUnZkZ)
}, {
    id: "upgrades",
    label: () => v.intl.string(v.t.KC5q8v)
}, {
    id: "vip",
    label: () => v.intl.string(v.t.DjEAcv)
}];
...
function M() {
    let e = (0, d.DP)(),
        ...
        Y = (0, l.useMemo)(() => [{
            id: S.SERVER_BOOSTS_CARD_ID,
            title: v.intl.formatToPlainString(v.t.pWySes, {
                boostCount: 2,
                percentageOff: 30
            }),
            description: v.intl.formatToPlainString(v.t.cWFUoT, {
                boostCount: 2,
                percentageOff: 30
            }),
            ...
            id: S.DISPLAY_NAME_STYLES_CARD_ID,
            ...
            subscriptionRequired: !0,
            primaryAsset: null != i ? (0, s.jsx)("img", {
                src: i,
                alt: "",
                width: 160,
                draggable: "false"
            ...
            id: S.SPECIAL_MEMBER_PRICING_CARD_ID,
