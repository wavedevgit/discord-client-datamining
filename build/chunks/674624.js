...
function L() {
    let e = (0, c.DP)(),
        ...
        n = (0, h.Lh)(),
        i = (0, b.N)(n)?.standard ?? null,
        {
            analyticsLocations: P
        } = (0, u.Ay)(d.A.PREMIUM_MARKETING_PERK_CARD),
        D = (0, m.A)({
            scrollPosition: v._F.TRY_IT_OUT,
            analyticsLocations: P
        }),
        L = (0, a.useCallback)(() => {
            (0, x.openUserSettings)(f.X.APPEARANCE_THEME_CATEGORY, {
                analyticsLocations: P
            })
        }, [P]),
        U = (0, a.useCallback)(() => {
            (0, x.openUserSettings)(f.X.PREMIUM_GUILD_SUBSCRIPTIONS_PANEL, {
                analyticsLocations: P
            })
        }, [P]),
        k = (0, a.useCallback)(() => {
            (0, x.openUserSettings)(f.X.APPEARANCE_IN_APP_ICON_CATEGORY, {
                analyticsLocations: P
            })
        }, [P]),
        w = (0, a.useCallback)(() => {
        ...
        B = (0, a.useCallback)(() => {
            (0, x.openUserSettings)(f.X.SOUNDBOARD_CATEGORY, {
                analyticsLocations: P
            })
        }, [P]),
        G = (0, g.A)({
        ...
        V = (0, a.useCallback)(() => {
            (0, x.openUserSettings)(f.X.PROFILE_PANEL, {
                analyticsLocations: P
            }, () => (0, _.L)({
                analyticsLocations: P
            }))
        ...
        z = (0, a.useMemo)(() => [{
            ...
            categories: ["vip"]
        }], [e, i, D, L, U, k, w, B, V, G, t]);
    return (0, a.useMemo)(() => z.filter(e => null != e && !F.includes(e.id)), [z, F])
}