/** chunk id: 141711 params = (module,exports,require) **/
a.d(t, {
    A: () => tR
});
var r = Object.create,
    ...
    c = function(e, t, a, r) {
        if (t && "object" == typeof t || "function" == typeof t)
            for (var s, d = o(t), l = 0, c = d.length; l < c; l++) s = d[l], u.call(e, s) || s === a || i(e, s, {
                get: (function(e) {
                    return t[e]
                }).bind(null, s),
    ...
    _ = function(e, t, a) {
        return a = null != e ? r(s(e)) : {}, c(!t && e && e.__esModule ? a : i(a, "default", {
            value: e,
            enumerable: !0
        }), e)
    },
...
var y = d(function() {}),
    ...
    b = l(function(e, t) {
        ...
        f(), t.exports = a, a.prototype.nodeType = 8, a.prototype.nodeName = "#comment", a.prototype.toString = function() {
    ...
    w = l(function(e, t) {
        ...
        f(), t.exports = a, a.prototype.type = "DOMTextNode", a.prototype.nodeType = 3, a.prototype.nodeName = "#text", a.prototype.toString = function() {
            return this.data
        ...
        t.exports = function(e, t) {
            if (this.listeners && this.listeners[e]) {
                var a = this.listeners[e],
                    r = a.indexOf(t); - 1 !== r && a.splice(r, 1)
            }
        }
    }),
    x = l(function(e, t) {
        y(), t.exports = function e(t) {
            switch (t.nodeType) {
                ...
                default:
                    var n, o, s;
                    return o = [], s = (n = t).tagName, "http://www.w3.org/1999/xhtml" === n.namespaceURI && (s = s.toLowerCase()), o.push("<" + s + function(e) {
                        var t = [];
                        for (var a in e)(function(e, t) {
                            var a = v(e[t]);
                            return "style" === t && Object.keys(e.style).length > 0 || e.hasOwnProperty(t) && ("string" === a || "boolean" === a || "number" === a) && "nodeName" !== t && "className" !== t && "tagName" !== t && "textContent" !== t && "innerText" !== t && "namespaceURI" !== t && "innerHTML" !== t
                        })(e, a) && t.push({
                            name: a,
                            value: e[a]
                        });
                        ...
                        return a.length ? r(a) : ""
                    }(n)), a.indexOf(s) > -1 ? o.push(" />") : (o.push(">"), n.childNodes.length ? o.push.apply(o, n.childNodes.map(e)) : n.textContent || n.innerText ? o.push(i(n.textContent || n.innerText)) : n.innerHTML && o.push(n.innerHTML), o.push("</" + s + ">")), o.join("")
            }
        };
    ...
    D = l(function(e, t) {
        ...
        function u(e, t, a) {
            ...
            this.tagName = r === s ? String(e).toUpperCase() : e, this.nodeName = this.tagName, this.className = "", this.dataset = {}, this.childNodes = [], this.parentNode = null, this.style = {}, this.ownerDocument = t || null, this.namespaceURI = r, this._attributes = {}, "INPUT" === this.tagName && (this.type = "text")
        }
        t.exports = u, u.prototype.type = "DOMElement", u.prototype.nodeType = 1, u.prototype.appendChild = function(e) {
            ...
            var r = null,
                i = t,
                n = t.indexOf(":");
            (n > -1 && (r = t.substr(0, n), i = t.substr(n + 1)), "INPUT" === this.tagName && "type" === t) ? this.type = a: (this._attributes[e] || (this._attributes[e] = {}))[i] = {
                value: a,
                prefix: r
            }
        ...
        }, u.prototype.removeEventListener = n, u.prototype.addEventListener = i, u.prototype.dispatchEvent = r, u.prototype.focus = function() {}, u.prototype.toString = function() {
            return o(this)
            ...
            e = e.toLowerCase();
            var t = [];
            return a(this.childNodes, function(a) {
    ...
    q = l(function(e, t) {
        ...
        t.exports = r, r.prototype.type = "DocumentFragment", r.prototype.nodeType = 11, r.prototype.nodeName = "#document-fragment", r.prototype.appendChild = a.prototype.appendChild, r.prototype.replaceChild = a.prototype.replaceChild, r.prototype.removeChild = a.prototype.removeChild, r.prototype.toString = function() {
    ...
    P = l(function(e, t) {
        function a(e) {}
        t.exports = a, a.prototype.initEvent = function(e, t, a) {
    ...
    O = l(function(e, t) {
        ...
        _.createTextNode = function(e) {
            ...
            return e = String(e), a(this.childNodes, function(t) {
                if (String(t.id) === e) return t
            }) || null
        }, _.getElementsByClassName = n.prototype.getElementsByClassName, _.getElementsByTagName = n.prototype.getElementsByTagName, _.contains = n.prototype.contains, _.removeEventListener = l, _.addEventListener = d, _.dispatchEvent = u
    }),
    A = l(function(e, t) {
        t.exports = new(O())
    }),
    S = l(function(e, t) {
        var a, r = "u" > typeof global ? global : "u" > typeof window ? window : {},
            i = A();
        "u" > typeof document ? a = document : (a = r["__GLOBAL_DOCUMENT_CACHE@4"]) || (a = r["__GLOBAL_DOCUMENT_CACHE@4"] = i), t.exports = a
    });
    ...
    return function(e) {
        ...
        if (null != a) {
            var r, i, n = [],
                ...
                s = !1;
            try {
                for (a = a.call(e); !(o = (r = a.next()).done) && (n.push(r.value), !(t && n.length === t)); o = !0);
            } catch (e) {
                s = !0, i = e
            } finally {
                try {
...
var N = _(p()),
    ...
    F = function(e) {
        ...
        var t, a = t && t.nodeName ? t.nodeName.toLowerCase() : "";
        return [t, e, a]
    };
...
var W = function(e) {
        var t, a, r, i, n, o = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : 3,
...
function Z(e, t, a) {
    return (Z = "u" > typeof Reflect && Reflect.get ? Reflect.get : function(e, t, a) {
        var r = function(e, t) {
...
function e_(e) {
    ...
    return (e = e || "").trim().split(/[\r\n]+/).forEach(function(e) {
        if (e) {
            var a = e.split(": "),
                r = a.shift();
            r && (ec.indexOf(r.toLowerCase()) >= 0 || 0 === r.toLowerCase().indexOf("x-litix-")) && (t[r] = a.join(": "))
        }
    }), t
}
...
var eh = function(e) {
        var t = {};
        for (var a in e) {
            var r = e[a]; - 1 !== r["DATA-ID"].search("io.litix.data.") && (t[r["DATA-ID"].replace("io.litix.data.", "")] = r.VALUE)
        }
        return t
    },
    ef = function(e) {
    ...
    ev = function(e, t, a) {
        ...
        var r = arguments.length > 4 ? arguments[4] : void 0,
            ...
            o = function(e) {
                var t, a = parseInt(r.version);
                return 1 === a && null !== e.programDateTime && (t = e.programDateTime), 0 === a && null !== e.pdt && (t = e.pdt), t
            };
        ...
        var c = function(e, t) {
            ...
            "main" === n.type ? (p.request_type = "media", p.request_current_level = n.level, p.request_video_width = (a.levels[n.level] || {}).width, p.request_video_height = (a.levels[n.level] || {}).height, p.request_labeled_bitrate = (a.levels[n.level] || {}).bitrate) : p.request_type = n.type, s("requestcompleted", p)
        };
        ...
        var p = function(e, t) {
            var a, i = t.type,
                ...
                _ = l ? em(l) : void 0;
            (n === r.ErrorDetails.MANIFEST_LOAD_ERROR || n === r.ErrorDetails.MANIFEST_LOAD_TIMEOUT || n === r.ErrorDetails.FRAG_LOAD_ERROR || n === r.ErrorDetails.FRAG_LOAD_TIMEOUT || n === r.ErrorDetails.LEVEL_LOAD_ERROR || n === r.ErrorDetails.LEVEL_LOAD_TIMEOUT || n === r.ErrorDetails.AUDIO_TRACK_LOAD_ERROR || n === r.ErrorDetails.AUDIO_TRACK_LOAD_TIMEOUT || n === r.ErrorDetails.SUBTITLE_LOAD_ERROR || n === r.ErrorDetails.SUBTITLE_LOAD_TIMEOUT || n === r.ErrorDetails.KEY_LOAD_ERROR || n === r.ErrorDetails.KEY_LOAD_TIMEOUT) && s("requestfailed", {
                request_error: n,
                request_url: c,
        ...
        var f = function(e, t) {
            ...
            if (n && n.attrs && n.attrs.BANDWIDTH) {
                var o, u = n.attrs.BANDWIDTH,
                    d = parseFloat(n.attrs["FRAME-RATE"]);
                isNaN(d) || (o = d), u ? s("renditionchange", {
                    video_source_fps: o,
        ...
        a.on(r.Events.LEVEL_SWITCHED, f), a._stopMuxMonitor = function() {
    ...
    eg = function(e, t) {
        ...
        var a, r = et(e.url),
            ...
            l = "function" == typeof t.getMetricsFor ? t.getMetricsFor(e.mediaType).HttpList : t.getDashMetrics().getHttpRequests(e.mediaType);
    ...
    eT = function(e) {
        try {
            var t, a;
            return null == (a = e.getVersion) || null == (t = a.call(e)) ? void 0 : t.split(".").map(function(e) {
                return parseInt(e)
            })[0]
        } catch (e) {
            return !1
    ...
    ek = function(e, t, a) {
        ...
        i >= 4 ? a.on("initFragmentLoaded", d) : a.on("initFragmentLoaded", function(e) {
            var t = e.type,
                a = e.fragmentModel,
                r = e.chunk;
            d({
        ...
        i >= 4 ? a.on("mediaFragmentLoaded", l) : a.on("mediaFragmentLoaded", function(e) {
            var t = e.type,
                a = e.fragmentModel,
                r = e.chunk;
            l({
        ...
        var c = {
            ...
            _ = function() {
                if (c.video && "number" == typeof c.video.bitrate) {
                    if (!(c.video.width && c.video.height)) return void r.warn("have bitrate info for video but missing width/height");
                    var e = c.video.bitrate;
                    if (c.audio && "number" == typeof c.audio.bitrate && (e += c.audio.bitrate), e !== c.totalBitrate) return c.totalBitrate = e, {
            ...
            p = function(e, t, i) {
                ...
                if ("audio" === o || "video" === o) {
                    ...
                    c[o] = ed(eu({}, s), {
                        codec: a.getCurrentTrackFor(o).codec
                    });
                    var u = _();
        ...
        var f = function(e) {
            ...
            (null == r ? void 0 : r.code) === 27 && n("requestfailed", {
        ...
        a.on("error", f), a._stopMuxMonitor = function() {
            a.off("manifestLoaded", o), a.off("initFragmentLoaded", d), a.off("mediaFragmentLoaded", l), a.off("qualityChangeRendered", p), a.off("error", f), a.off("fragmentLoadingAbandoned", h), delete a._stopMuxMonitor
        }
    },
    eE = function(e) {
        e && "function" == typeof e._stopMuxMonitor && e._stopMuxMonitor()
    ...
    eD = function() {
        ...
        return Y(e, [{
            ...
            value: function(e, t, a) {
                return t._eventEmitterGuid = t._eventEmitterGuid || ++ex, this._listeners = this._listeners || {}, this._listeners[e] = this._listeners[e] || [], a && (t = t.bind(a)), this._listeners[e].push(t), t
            }
        }, {
            key: "off",
            value: function(e, t) {
    ...
    eP = function() {
        function e(t) {
            var a = this;
            J(this, e), X(this, "_playbackHeartbeatInterval", void 0), X(this, "_playheadShouldBeProgressing", void 0), X(this, "pm", void 0), this.pm = t, this._playbackHeartbeatInterval = null, this._playheadShouldBeProgressing = !1, t.on("playing", function() {
                ...
                null !== a._playbackHeartbeatInterval && (eq.default.clearInterval(a._playbackHeartbeatInterval), t.emit("playbackheartbeatend", {
        ...
        return Y(e, [{
            ...
            value: function() {
                var e = this;
                null === this._playbackHeartbeatInterval && (this.pm.emit("playbackheartbeat"), this._playbackHeartbeatInterval = eq.default.setInterval(function() {
            ...
            value: function() {
                this._playheadShouldBeProgressing = !1, null !== this._playbackHeartbeatInterval && (eq.default.clearInterval(this._playbackHeartbeatInterval), this.pm.emit("playbackheartbeatend"), this._playbackHeartbeatInterval = null)
            }
        }]), e
    }(),
    eO = function e(t) {
        var a = this;
        J(this, e), X(this, "viewErrored", void 0), t.on("viewinit", function() {
            a.viewErrored = !1
            ...
            try {
                ...
                i && (t.data.player_error_code = i.player_error_code || r.player_error_code, t.data.player_error_message = i.player_error_message || r.player_error_message, t.data.player_error_context = i.player_error_context || r.player_error_context, t.data.player_error_severity = i.player_error_severity || r.player_error_severity, t.data.player_error_business_exception = i.player_error_business_exception || r.player_error_business_exception, a.viewErrored = !0)
            } catch (e) {
                t.mux.log.warn("Exception in error translator callback.", e), a.viewErrored = !0
            }
        }), t.on("aftererror", function() {
            var e, a, r, i, n;
            null == (e = t.data) || delete e.player_error_code, null == (a = t.data) || delete a.player_error_message, null == (r = t.data) || delete r.player_error_context, null == (i = t.data) || delete i.player_error_severity, null == (n = t.data) || delete n.player_error_business_exception
        })
    },
    eA = function() {
        function e(t) {
            J(this, e), X(this, "_watchTimeTrackerLastCheckedTime", void 0), X(this, "pm", void 0), this.pm = t, this._watchTimeTrackerLastCheckedTime = null, t.on("playbackheartbeat", this._updateWatchTime.bind(this)), t.on("playbackheartbeatend", this._clearWatchTimeState.bind(this))
        }
        return Y(e, [{
            key: "_updateWatchTime",
            value: function(e, t) {
                var a = t.viewer_time;
                null === this._watchTimeTrackerLastCheckedTime && (this._watchTimeTrackerLastCheckedTime = a), es(this.pm.data, "view_watch_time", a - this._watchTimeTrackerLastCheckedTime), this._watchTimeTrackerLastCheckedTime = a
            }
        }, {
    ...
    eS = function() {
        function e(t) {
            ...
            t.on("playbackheartbeatend", i), t.on("seeking", i), t.on("rebufferstart", i), t.on("adplaying", function() {
                a._isAdPlaying = !0
                ...
                a._playbackTimeTrackerLastPlayheadPosition = -1, a._lastTime = H(), a._isAdPlaying = !1, a._callbackUpdatePlaybackTime = null
            })
        }
        return Y(e, [{
            key: "_startPlaybackTimeTracking",
            value: function() {
                null === this._callbackUpdatePlaybackTime && (this._callbackUpdatePlaybackTime = this._updatePlaybackTime.bind(this), this._playbackTimeTrackerLastPlayheadPosition = this.pm.data.player_playhead_time, this._lastTime = H(), this.pm.on("playbackheartbeat", this._callbackUpdatePlaybackTime))
            }
        }, {
            ...
            value: function() {
                var e = this.pm.data.player_playhead_time || 0,
                    ...
                    a = t - this._lastTime,
                    r = -1;
                this._playbackTimeTrackerLastPlayheadPosition >= 0 && e > this._playbackTimeTrackerLastPlayheadPosition ? r = e - this._playbackTimeTrackerLastPlayheadPosition : this._isAdPlaying && (r = a), r > 0 && r <= 1e3 && es(this.pm.data, "view_content_playback_time", r), null !== this._callbackUpdatePlaybackTime && a > 0 && a <= 1e3 && (this._isAdPlaying && es(this.pm.data, "ad_playing_time_ms_cumulative", a), es(this.pm.data, "view_playing_time_ms_cumulative", a)), this._playbackTimeTrackerLastPlayheadPosition = e, this._lastTime = t
            }
        }]), e
    }(),
    eR = function() {
        ...
        return Y(e, [{
            ...
            value: function(e, t) {
                ...
                if (t && t.player_playhead_time) this.pm.data.player_playhead_time = t.player_playhead_time, r(), this._updateMaxPlayheadPosition();
                    ...
                    void 0 !== i && (this.pm.data.player_playhead_time = i, r(), this._updateMaxPlayheadPosition())
                }
            }
        }]), e
    }(),
            ...
            var a, r = function(e, t) {
                ...
                i = function(e) {
                    if (a) {
                        ...
                        es(t.data, "view_rebuffer_duration", r), a = e.viewer_time, t.data.view_rebuffer_duration > 3e5 && (t.emit("viewend"), t.send("viewend"), t.mux.log.warn("Ending view after rebuffering for longer than ".concat(3e5, "ms, future events will be ignored unless a programchange or videochange occurs.")))
                    }
    ...
    eI = function() {
        function e(t) {
            var a = this;
            J(this, e), X(this, "_lastCheckedTime", void 0), X(this, "_lastPlayheadTime", void 0), X(this, "_lastPlayheadTimeUpdatedTime", void 0), X(this, "_rebuffering", void 0), X(this, "pm", void 0), this.pm = t, t.disableRebufferTracking || t.disablePlayheadRebufferTracking || (this._lastCheckedTime = null, this._lastPlayheadTime = null, this._lastPlayheadTimeUpdatedTime = null, t.on("playbackheartbeat", this._checkIfRebuffering.bind(this)), t.on("playbackheartbeatend", this._cleanupRebufferTracker.bind(this)), t.on("seeking", function() {
        ...
        return Y(e, [{
            ...
            value: function(e, t) {
                ...
                "number" == typeof this.pm.sustainedRebufferThreshold && a >= this.pm.sustainedRebufferThreshold && (this._rebuffering || (this._rebuffering = !0, this.pm.emit("rebufferstart", {
            ...
            value: function(e, t) {
                ...
                if (this._rebuffering) this._rebuffering = !1, this.pm.emit("rebufferend", {
                    ...
                    "number" == typeof this.pm.minimumRebufferDuration && r > 0 && i - r > this.pm.minimumRebufferDuration && (this._lastCheckedTime = null, this.pm.emit("rebufferstart", {
                        viewer_time: this._lastPlayheadTimeUpdatedTime
    ...
    eN = function() {
        function e(t) {
            var a = this;
            J(this, e), X(this, "pm", void 0), this.pm = t, t.on("viewinit", function() {
                var e = t.data,
                    r = e.view_id;
                if (!e.view_program_changed) {
                    var i = function(e, i) {
                        var n = i.viewer_time;
                        "playing" === e.type && void 0 === t.data.view_time_to_first_frame ? a.calculateTimeToFirstFrame(n || H(), r) : "adplaying" === e.type && (void 0 === t.data.view_time_to_first_frame || a._inPrerollPosition()) && a.calculateTimeToFirstFrame(n || H(), r)
                    };
                    t.one("playing", i), t.one("adplaying", i), t.one("viewend", function() {
    ...
    eC = function e(t) {
        var a = this;
        J(this, e), X(this, "_lastPlayerHeight", void 0), X(this, "_lastPlayerWidth", void 0), X(this, "_lastPlayheadPosition", void 0), X(this, "_lastSourceHeight", void 0), X(this, "_lastSourceWidth", void 0), t.on("viewinit", function() {
            ...
            t.on(e, function() {
                if (a._lastPlayheadPosition >= 0 && t.data.player_playhead_time >= 0 && a._lastPlayerWidth >= 0 && a._lastSourceWidth > 0 && a._lastPlayerHeight >= 0 && a._lastSourceHeight > 0) {
                    ...
                    var r = Math.min(a._lastPlayerWidth / a._lastSourceWidth, a._lastPlayerHeight / a._lastSourceHeight),
                        i = Math.max(0, r - 1),
                        n = Math.max(0, 1 - r);
                    t.data.view_max_upscale_percentage = Math.max(t.data.view_max_upscale_percentage || 0, i), t.data.view_max_downscale_percentage = Math.max(t.data.view_max_downscale_percentage || 0, n), es(t.data, "view_total_content_playback_time", e), es(t.data, "view_total_upscaling", i * e), es(t.data, "view_total_downscaling", n * e)
                }
                a._lastPlayheadPosition = -1
            })
    ...
    ej = function e(t) {
        ...
        var r = -1,
            i = function() {
                ...
                es(t.data, "view_seek_duration", i), t.data.view_max_seek_time = Math.max(t.data.view_max_seek_time || 0, i), a.isSeeking = !1, r = -1
            };
        t.on("seeking", function(e, n) {
            ...
            a.isSeeking && i(), a.isSeeking = !0, r = n.viewer_time, es(t.data, "view_seek_count", 1), t.send("seeking")
    ...
    eB = ["adbreakstart", "adrequest", "adresponse", "adplay", "adplaying", "adpause", "adended", "adbreakend", "aderror", "adclicked", "adskipped"],
    eM = function() {
        function e(t) {
            var a = this;
            J(this, e), X(this, "_adHasPlayed", void 0), X(this, "_adRequests", void 0), X(this, "_adResponses", void 0), X(this, "_currentAdRequestNumber", void 0), X(this, "_currentAdResponseNumber", void 0), X(this, "_prerollPlayTime", void 0), X(this, "_wouldBeNewAdPlay", void 0), X(this, "isAdBreak", void 0), X(this, "pm", void 0), this.pm = t, t.on("viewinit", function() {
            ...
            t.on("adbreakstart", function() {
                ...
                }, r), eH(a._adRequests, r), es(t.data, "view_ad_request_count"), a.inPrerollPosition() && (t.data.view_preroll_requested = !0, a._adHasPlayed || es(t.data, "view_preroll_request_count"))
            }), t.on("adresponse", function(e, r) {
                r = Object.assign({
                    ad_request_id: "generatedAdRequestId" + a._currentAdResponseNumber++
                }, r), eH(a._adResponses, r);
                ...
                a._adHasPlayed = !0, a._wouldBeNewAdPlay && (a._wouldBeNewAdPlay = !1, es(t.data, "view_ad_played_count")), a.inPrerollPosition() && !t.data.view_preroll_played && (t.data.view_preroll_played = !0, a._adRequests.length > 0 && (t.data.view_preroll_request_time = Math.max(0, r.viewer_time - a._adRequests[0].viewer_time)), t.data.view_start && (t.data.view_startup_preroll_request_time = Math.max(0, r.viewer_time - t.data.view_start)), a._prerollPlayTime = r.viewer_time)
            }), t.on("adplaying", function(e, r) {
                a.inPrerollPosition() && void 0 === t.data.view_preroll_load_time && void 0 !== a._prerollPlayTime && (t.data.view_preroll_load_time = r.viewer_time - a._prerollPlayTime, t.data.view_startup_preroll_load_time = r.viewer_time - a._prerollPlayTime)
                ...
                if (this.inPrerollPosition()) {
                    if (!this.pm.data.view_preroll_ad_tag_hostname && t.ad_tag_url) {
                        var a = I(ea(t.ad_tag_url), 2),
                            r = a[0],
                            i = a[1];
                        this.pm.data.view_preroll_ad_tag_domain = i, this.pm.data.view_preroll_ad_tag_hostname = r
                    }
    ...
    eU = function e(t) {
        ...
        var r = function() {
            ...
            i = function(e) {
                ...
                a.lastWallClockTime = r, r - i > 3e4 && (t.emit("devicesleep", {
                    viewer_time: i
    ...
    eQ = (ts = function() {
            ...
            if ("u" > typeof document) {
                ...
                for (var s = document.cookie ? document.cookie.split("; ") : [], u = /(%[0-9A-Z]{2})+/g, d = 0; d < s.length; d++) {
                    ...
                    try {
                        ...
                        if (c = t.read ? t.read(c, _) : t(c, _) || c.replace(u, decodeURIComponent), this.json) try {
                            c = JSON.parse(c)
                        } catch (e) {}
                        if (e === _) {
                            n = c;
        ...
        }, a.defaults = {}, a.remove = function(e, t) {
            a(e, "", ts(t, {
                expires: -1
            }))
        }, a.withConverter = e, a
    ...
    eV = function(e) {
        try {
            eQ.set(eW, Object.entries(e).map(function(e) {
                var t = I(e, 2),
                    a = t[0],
                    r = t[1];
    ...
    ez = function() {
        var e = eG();
        return e.mux_viewer_id = e.mux_viewer_id || B(), e.msn = e.msn || Math.random(), eV(e), {
    ...
    eJ = function() {
        var e = eG(),
            t = H();
        return e.session_start && (e.sst = e.session_start, delete e.session_start), e.session_id && (e.sid = e.session_id, delete e.session_id), e.session_expires && (e.sex = e.session_expires, delete e.session_expires), (!e.sex || e.sex < t) && (e.sid = B(), e.sst = t), e.sex = t + 15e5, eV(e), {
            session_id: e.sid,
            session_start: e.sst,
    ...
    return Object.keys(e).forEach(function(r) {
        ...
        if (e.hasOwnProperty(r) && void 0 !== e[r]) {
            var n = r.split("_"),
                o = n[0],
                s = e$[o];
            s || (W.info("Data key word `" + n[0] + "` not expected in " + r), s = o + "_"), n.splice(1).forEach(function(e) {
                "url" === e && (i = !0), eZ[e] ? s += eZ[e] : Number.isInteger(Number(e)) ? s += e : (W.info("Data key word `" + e + "` not expected in " + r), s += "_" + e + "_")
            }), i ? a[s] = e[r] : t[s] = e[r]
        }
    }), Object.assign(t, a)
}
...
e6.prototype.queueEvent = function(e, t) {
    ...
    return (this._eventQueue.length <= this._options.maxQueueLength || "eventrateexceeded" === e) && (this._eventQueue.push(a), this._sendTimeout || this._startBeaconSending(), this._eventQueue.length <= this._options.maxQueueLength)
    ...
    var e = arguments.length > 0 && void 0 !== arguments[0] && arguments[0];
    this.destroyed = !0, e ? this._clearBeaconQueue() : this.flushEvents(), e3.default.clearTimeout(this._sendTimeout)
    ...
    e9(this._beaconUrl, a, !1, function(a, i) {
        i ? (e._eventQueue = t.concat(e._eventQueue), e._failureCount += 1, W.info("Error sending beacon: " + i)) : e._failureCount = 0, e._roundTripTime = H() - r, e._postInFlight = !1, e._resendAfterPost && (e._resendAfterPost = !1, e._eventQueue.length > 0 && e._sendBeaconQueue())
    })
    ...
    var e = this;
    e3.default.clearTimeout(this._sendTimeout), this.destroyed || (this._sendTimeout = e3.default.setTimeout(function() {
        e._eventQueue.length && e._sendBeaconQueue(), e._startBeaconSending()
    }, this._getNextBeaconTime()))
}, e6.prototype._createPayload = function(e) {
    var t = this,
        a = {
            transmission_timestamp: Math.round(H())
        };
    ...
    return o(), s() || (W.info("Payload size is too big (" + n + " kb). Removing unnecessary events."), i = e.filter(function(e) {
        return -1 === e5.indexOf(e.e)
    }), o()), s() || (W.info("Payload size still too big (" + n + " kb). Cropping fields.."), i.forEach(function(e) {
        for (var t in e) {
            var a = e[t];
...
var e8 = "function" == typeof e2.default.exitPictureInPicture ? function(e) {
    ...
    e9 = function(e, t, a, r) {
        ...
        if (e3.default.fetch) return void e3.default.fetch(e, {
            method: "POST",
            body: t,
            headers: {
    ...
    tr = function() {
        function e(t, a) {
            var r, i, n, o, s, u, d, l, c, _, p, h, f, v, y, g, b, w, T, k = arguments.length > 2 && void 0 !== arguments[2] ? arguments[2] : {};
            J(this, e), X(this, "mux", void 0), X(this, "envKey", void 0), X(this, "options", void 0), X(this, "eventQueue", void 0), X(this, "sampleRate", void 0), X(this, "disableCookies", void 0), X(this, "respectDoNotTrack", void 0), X(this, "previousBeaconData", void 0), X(this, "lastEventTime", void 0), X(this, "rateLimited", void 0), X(this, "pageLevelData", void 0), X(this, "viewerData", void 0), this.mux = t, this.envKey = a, this.options = k, this.previousBeaconData = null, this.lastEventTime = 0, this.rateLimited = !1, this.eventQueue = new e6((r = this.envKey, n = (i = this.options).beaconCollectionDomain, o = i.beaconDomain, n ? "https://" + n : (r = r || "inferred").match(/^[a-z0-9]+$/) ? "https://" + r + "." + (o || "litix.io") : "https://img.litix.io/a.gif")), this.sampleRate = null != (b = this.options.sampleRate) ? b : 1, this.disableCookies = null != (w = this.options.disableCookies) && w, this.respectDoNotTrack = null != (T = this.options.respectDoNotTrack) && T, this.previousBeaconData = null, this.lastEventTime = 0, this.rateLimited = !1, this.pageLevelData = {
                ...
                viewer_os_architecture: null == (f = this.options.platform) || null == (h = f.os) ? void 0 : h.architecture,
                viewer_os_version: null == (y = this.options.platform) || null == (v = y.os) ? void 0 : v.version,
                viewer_connection_type: eY(),
                page_url: null === eF.default || void 0 === eF.default || null == (g = eF.default.location) ? void 0 : g.href
        ...
        return Y(e, [{
            ...
            value: function(e, t) {
                if (!(!e || !(null != t && t.view_id))) {
                    if (this.respectDoNotTrack && V()) return W.info("Not sending `" + e + "` because Do Not Track is enabled");
                    if (!t || "object" != typeof t) return W.error("A data object was expected in send() but was not provided");
                    ...
                    var i, n = (null != (i = r.mux_sample_number) ? i : 0) >= this.sampleRate,
                        o = e1(this._deduplicateBeaconData(e, r));
                    if (this.lastEventTime = this.mux.utils.now(), n) return W.info("Not sending event due to sample rate restriction", e, r, o);
                    if (this.envKey || W.info("Missing environment key (envKey) - beacons will be dropped if the video source is not a valid mux video URL", e, r, o), !this.rateLimited)
                        if (W.info("Sending event", e, r, o), this.rateLimited = !this.eventQueue.queueEvent(e, o), this.mux.WINDOW_UNLOADING && "viewend" === e) this.eventQueue.destroy(!0);
                        else {
                            ...
                            if (this.rateLimited) return r.event = "eventrateexceeded", o = e1(r), this.eventQueue.queueEvent(r.event, o), W.error("Beaconing disabled due to rate limit.")
                        }
                }
            }
        }, {
            ...
            value: function(e, t) {
                var a = this,
                    r = {},
                    i = t.view_id;
                if ("-1" === i || "viewstart" === e || "viewend" === e || !this.previousBeaconData || this.mux.utils.now() - this.lastEventTime >= 6e5) r = eu({}, t), i && (this.previousBeaconData = r), i && "viewend" === e && (this.previousBeaconData = null);
                else {
                    ...
                    Object.entries(t).forEach(function(t) {
                        var i = I(t, 2),
                            o = i[0],
                            s = i[1];
                        a.previousBeaconData && (s !== a.previousBeaconData[o] || e7.indexOf(o) > -1 || a.objectHasChanged(n, o, s, a.previousBeaconData[o]) || a.eventRequiresKey(e, o)) && (r[o] = s, a.previousBeaconData[o] = s)
                    })
                }
                return r
            }
            ...
            value: function(e, t, a, r) {
                return !!e && 0 === t.indexOf("request_") && ("request_response_headers" === t || "object" != typeof a || "object" != typeof r || Object.keys(a || {}).length !== Object.keys(r || {}).length)
            }
        }, {
    ...
    ti = function e(t) {
        ...
        t.on("requestcompleted", function(e, s) {
            var u, d, l = s.request_start,
                c = s.request_response_start,
                _ = s.request_response_end,
                p = s.request_bytes_loaded;
            if (n++, c ? (u = c - (null != l ? l : 0), d = (null != _ ? _ : 0) - c) : d = (null != _ ? _ : 0) - (null != l ? l : 0), d > 0 && p && p > 0) {
                var h = p / d * 8e3;
                o++, r += p, i += d, t.data.view_min_request_throughput = Math.min(t.data.view_min_request_throughput || 1 / 0, h), t.data.view_average_request_throughput = r / i * 8e3, t.data.view_request_count = n, u > 0 && (a += u, t.data.view_max_request_latency = Math.max(t.data.view_max_request_latency || 0, u), t.data.view_average_request_latency = a / o)
            }
    ...
    tn = function e(t) {
        var a = this;
        J(this, e), X(this, "_lastEventTime", void 0), t.on("before*", function(e, r) {
            var i = r.viewer_time,
                n = H(),
                o = a._lastEventTime;
            if (a._lastEventTime = n, o && n - o > 36e5) {
                ...
                t._resetView(Object.assign({
                    viewer_time: i
                }, s)), t.playbackHeartbeat._playheadShouldBeProgressing = u, t.playbackHeartbeat._playheadShouldBeProgressing && "play" !== e.type && "adbreakstart" !== e.type && (t.emit("play", {
                    viewer_time: i
...
var ts, tu, td = function e(t) {
        J(this, e);
        var a = function(e) {
                var a, r, i, s = null != (a = e) && a.request_type && ("media" === a.request_type || "video" === a.request_type) && null != (r = a.request_response_headers) && r["x-cdn"] ? a.request_response_headers["x-cdn"] : null != a && a.video_cdn ? a.video_cdn : null,
                    u = null != (i = e) && i.request_start ? i.request_start : null != i && i.viewer_time ? i.viewer_time : Date.now();
                null != s && !to(s, n) && o <= u && (n = s, o = u, t.emit("cdnchange", {
                    video_cdn: s
                }))
            },
            r = null,
        ...
        t.on("viewinit", function() {
            ...
            a && (void 0 === t.video_previous_cdn || null === t.video_previous_cdn) && (to(a, i) ? t.video_previous_cdn = null != r ? r : void 0 : (t.video_previous_cdn = null != i ? i : void 0, r = i, i = a))
    ...
    tc = function e(t) {
        var a = this;
        J(this, e), X(this, "_emittingAutomaticEvent", !1), X(this, "_hasInitialized", !1), t.on("viewstart", function() {
            a._hasInitialized || (a._hasInitialized = !0, a._emittingAutomaticEvent = !0, t.emit("playbackmodechange", {
    ...
    th = function(e) {
        ...
        function r(e, t, i) {
            ...
            }, i)).data = i.data || {}, i.data.property_key && (i.data.env_key = i.data.property_key, delete i.data.property_key), W.level = i.debug ? 1 : 3, n.getPlayheadTime = i.getPlayheadTime, n.getStateData = i.getStateData || function() {
                return {}
            }, n.getAdData = i.getAdData || function() {}, n.minimumRebufferDuration = i.minimumRebufferDuration, n.sustainedRebufferThreshold = i.sustainedRebufferThreshold, n.playbackHeartbeatTime = i.playbackHeartbeatTime, n.disableRebufferTracking = i.disableRebufferTracking, n.disableRebufferTracking && n.mux.log.warn("Disabling rebuffer tracking. This should only be used in specific circumstances as a last resort when your player is known to unreliably track rebuffering."), n.disablePlayheadRebufferTracking = i.disablePlayheadRebufferTracking, n.errorTranslator = i.errorTranslator, n.emitTranslator = i.emitTranslator, n.stateDataTranslator = i.stateDataTranslator, n.playbackEventDispatcher = new tr(e, i.data.env_key, i), n.data = {
                player_instance_id: B(),
                mux_sample_rate: i.sampleRate,
                beacon_domain: i.beaconCollectionDomain || i.beaconDomain
            }, n.data.view_sequence_number = 1, n.data.player_sequence_number = 1;
            var n, o = (function() {
                void 0 === this.data.view_start && (this.data.view_start = this.mux.utils.now(), this.emit("viewstart"))
            }).bind(z(n));
            if (n.on("viewinit", function(e, t) {
                    ...
                    })), o(), this.emit("play"), this.emit("playing")
                ...
                }), n.on("destroy", n.destroy), "u" > typeof window && "function" == typeof window.addEventListener && "function" == typeof window.removeEventListener) {
                var s = function() {
                ...
                window.addEventListener("pagehide", u, !1), n.on("destroy", function() {
            ...
            return n.on("playerready", function(e, t) {
                ...
                n.on(e, function(t, a) {
                    0 !== e.indexOf("ad") && this._updateStateData(), Object.assign(this.data, a), this._sanitizeData()
            ...
            }), n.longResumeTracker = new tn(z(n)), n.errorTracker = new eO(z(n)), new eU(z(n)), n.seekingTracker = new ej(z(n)), n.playheadTime = new eR(z(n)), n.playbackHeartbeat = new eP(z(n)), new eC(z(n)), n.watchTimeTracker = new eA(z(n)), new eS(z(n)), n.adTracker = new eM(z(n)), new eI(z(n)), new eL(z(n)), new eN(z(n)), new ti(z(n)), new td(z(n)), new tc(z(n)), i.hlsjs && n.addHLSJS(i), i.dashjs && n.addDashJS(i), n.emit("viewinit", i.data), n
        }
        return Y(r, [{
            key: "emit",
            value: function(e, t) {
                ...
                null != n && n.length && (a = Z($(r.prototype), "emit", this)).call.apply(a, [this].concat(Q(n)))
            }
        }, {
            key: "destroy",
            value: function() {
            ...
            value: function(e) {
                if (this.data.view_id) {
                    ...
                    delete t.ad_request_id, this.playbackEventDispatcher.send(e, t), this.data.view_sequence_number++, this.data.player_sequence_number++, tp.has(e) || this._restartHeartBeat(), "viewend" === e && delete this.data.view_id
                }
            }
        }, {
            key: "_resetView",
            ...
            value: function() {
                ...
                null != (e = this.data) && e.video_cdn && null != t && t.video_cdn && (t.video_cdn, t = function(e, t) {
                    ...
                    if (Object.getOwnPropertySymbols) {
                        ...
                        for (r = 0; r < n.length; r++) a = n[r], !(t.indexOf(a) >= 0) && Object.prototype.propertyIsEnumerable.call(e, a) && (i[a] = e[a])
                    }
                    return i
            ...
            key: "addDashJS",
            value: function(e) {
                e.dashjs ? this.dashjs ? this.mux.log.warn("An instance of Dash.js is already being monitored for this player.") : (this.dashjs = e.dashjs, ek(this.mux, this.id, e.dashjs)) : this.mux.log.warn("You must pass a valid dashjs instance in order to track it.")
            }
        }, {
            key: "removeDashJS",
            value: function() {
    ...
    tf = _(S()),
    tm = ["loadstart", "pause", "play", "playing", "seeking", "seeked", "timeupdate", "ratechange", "stalled", "waiting", "error", "ended"],
    tv = {
        1: "MEDIA_ERR_ABORTED",
        2: "MEDIA_ERR_NETWORK",
        3: "MEDIA_ERR_DECODE",
...
tg.prototype.process = function(e) {
    ...
    if ("#" !== r[0]) this.currentUri.uri = r, this.manifest.segments.push(this.currentUri), !this.manifest.targetDuration || "duration" in this.currentUri || (this.currentUri.duration = this.manifest.targetDuration), this.currentUri = {};
        ...
        case "#EXT-X-TARGETDURATION":
            ...
            break;
        case "#EXT-X-PART-INF":
            tb(this.manifest, a), this.manifest.partInf.partTarget && (this.manifest.partTargetDuration = this.manifest.partInf.partTarget), this.setHoldBack();
            break;
        case "#EXT-X-SERVER-CONTROL":
            tb(this.manifest, a), this.setHoldBack();
            break;
        case "#EXTINF":
            0 === i ? this.currentUri.duration = .01 : i > 0 && (this.currentUri.duration = i);
            break;
        case "#EXT-X-PROGRAM-DATE-TIME":
            var n = new Date(i);
            this.manifest.dateTimeString || (this.manifest.dateTimeString = i, this.manifest.dateTimeObject = n), this.currentUri.dateTimeString = i, this.currentUri.dateTimeObject = n;
            break;
        case "#EXT-X-VERSION":
            tb(this.manifest, a);
            break;
    ...
    if (t) {
        var i = "holdBack",
            ...
            o = a && 3 * a,
            s = r && 2 * r;
        a && !t.hasOwnProperty(i) && (t[i] = o), o && t[i] < o && (t[i] = o), r && !t.hasOwnProperty(n) && (t[n] = 3 * r), r && t[n] < s && (t[n] = s)
    }
};
var tb = function(e, t) {
        var a, r = tw(t[0].replace("#EXT-X-", ""));
    ...
    tq = function(e) {
        ...
        if (e) {
            var a = e.search(",");
            return [e.slice(0, a), e.slice(a + 1)].forEach(function(e, a) {
                for (var r = e.replace(/['"]+/g, "").split("="), i = 0; i < r.length; i++) "DATA-ID" === r[i] && (t["DATA-ID"] = r[1 - i]), "VALUE" === r[i] && (t.VALUE = r[1 - i])
            }), {
                data: t
            }
        }
    ...
    tP = {
        ...
        getComputedStyle: function(e, t) {
            var a;
            return e && t && ty.default && "function" == typeof ty.default.getComputedStyle ? (tu && tu.has(e) && (a = tu.get(e)), a || (a = ty.default.getComputedStyle(e, null), tu && tu.set(e, a)), a.getPropertyValue(t)) : ""
        },
    ...
    tA = function(e) {
        var t = arguments;
        "string" == typeof e ? tA.hasOwnProperty(e) ? N.default.setTimeout(function() {
            t = Array.prototype.splice.call(t, 1), tA[e].apply(null, t)
        }, 0) : W.warn("`" + e + "` is an unknown task") : "function" == typeof e ? N.default.setTimeout(function() {
            e(tA)
        }, 0) : W.warn("`" + e + "` is invalid.")
    },
    tS = {
        loaded: H(),
        NAME: "mux-embed",
        ...
        monitor: function(e, t) {
            return function(e, t, a) {
                ...
                if ("video" !== o && "audio" !== o) return s.error("The element of `" + n + "` was not a media element.");
                i.mux && (i.mux.destroy(), delete i.mux, s.warn("Already monitoring this video element, replacing existing event listeners")), (a = Object.assign({
                    ...
                    getStateData: function() {
                        var e, t, a = (null == (e = this.getPlayheadTime) ? void 0 : e.call(this)) || d(i.currentTime),
                            r = this.hlsjs && this.hlsjs.url,
                            n = this.dashjs && "function" == typeof this.dashjs.getSource && this.dashjs.getSource(),
                            o = {
                                ...
                                player_is_fullscreen: tf.default && !!(tf.default.fullscreenElement || tf.default.webkitFullscreenElement || tf.default.mozFullScreenElement || tf.default.msFullscreenElement),
                                ...
                                view_dropped_frame_count: null == i || null == (t = i.getVideoPlaybackQuality) ? void 0 : t.call(i).droppedVideoFrames
                            };
                        if (i.getStartDate && a > 0) {
                            var s = i.getStartDate();
                            if (s && "function" == typeof s.getTime && s.getTime()) {
                                var l = s.getTime();
                                o.player_program_time = l + a, i.seekable.length > 0 && (o.player_live_edge_program_time = l + i.seekable.end(i.seekable.length - 1))
                            }
                        }
                        return o
                    }
                ...
                }, a.data), i.mux = i.mux || {}, i.mux.deleted = !1, i.mux.emit = function(t, a) {
                    e.emit(n, t, a)
                ...
                i.mux.destroy = function() {
                    ...
                    }), delete i.mux.listeners, i.mux.destroy = l, i.mux.swapElement = l, i.mux.emit = l, i.mux.addHLSJS = l, i.mux.addDashJS = l, i.mux.removeHLSJS = l, i.mux.removeDashJS = l, i.mux.updateData = l, i.mux.setEmitTranslator = l, i.mux.setStateDataTranslator = l, i.mux.setGetPlayheadTime = l, i.mux.deleted = !0, e.emit(n, "destroy")
                }, i.mux.swapElement = function(t) {
                    var a = I(F(t), 3),
                        r = a[0],
                        n = a[1],
                        o = a[2];
                    return r ? "video" !== o && "audio" !== o ? e.log.error("The element of `" + n + "` was not a media element.") : void(r.muxId = i.muxId, delete i.muxId, r.mux = r.mux || {}, r.mux.listeners = Object.assign({}, i.mux.listeners), delete i.mux.listeners, Object.keys(r.mux.listeners).forEach(function(e) {
                        i.removeEventListener(e, r.mux.listeners[e], !1), r.addEventListener(e, r.mux.listeners[e], !1)
                    }), r.mux.swapElement = i.mux.swapElement, r.mux.destroy = i.mux.destroy, delete i.mux, i = r) : e.log.error("No element was found with the `" + n + "` query selector.")
                ...
                }, e.init(n, a), e.emit(n, "playerready"), i.paused || (e.emit(n, "play"), i.readyState > 2 && e.emit(n, "playing")), i.mux.listeners = {}, tm.forEach(function(t) {
                    ("error" !== t || a.automaticErrorTracking) && (i.mux.listeners[t] = function() {
                        var a = {};
                        if ("error" === t) {
                            if (!i.error || 1 === i.error.code) return;
                            a.player_error_code = i.error.code, a.player_error_message = tv[i.error.code] || i.error.message
                        }
                        e.emit(n, t, a)
        ...
        destroyMonitor: function(e) {
            var t = I(F(e), 1)[0];
            t && t.mux && "function" == typeof t.mux.destroy ? t.mux.destroy() : W.error("A video element monitor for `" + e + "` has not been initialized via `mux.monitor`.")
        },
        ...
        init: function(e, t) {
            V() && t && t.respectDoNotTrack && W.info("The browser's Do Not Track flag is enabled - Mux beaconing is disabled.");
            var a = U(e);
            tO[a] = new th(tA, a, t)
        },
        emit: function(e, t, a) {
            var r = U(e);
            tO[r] ? (tO[r].emit(t, a), "destroy" === t && delete tO[r]) : W.error("A monitor for `" + r + "` has not been initialized.")
        },
...
Object.assign(tA, tS), void 0 !== N.default && "function" == typeof N.default.addEventListener && N.default.addEventListener("pagehide", function(e) {
