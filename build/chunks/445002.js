/** chunk id: 445002, original params: e,t,i (module,exports,require) **/
i.d(t, {
    default: () => D
});
var l = i(627968),
...
function T(e, t) {
    p.default.track(N.HAw.STICKER_UPLOAD_COMPLETED, {
        successful: e,
        error: t ?? ""
    })
}
let _ = e => {
    ...
    return (0, l.jsxs)("div", {
        ...
        children: [(0, l.jsx)("div", {
            className: C.rA,
            children: t ?? (0, l.jsx)(u.XGR, {
                size: "lg",
                color: "currentColor",
                "aria-label": v.intl.string(v.t.qOsjZh)
            })
        }), (0, l.jsx)("div", {
            className: C.F_,
            children: t ?? (0, l.jsx)(u.XGR, {
                size: "lg",
                color: "currentColor",
                "aria-label": v.intl.string(v.t.YC5NAI)
            })
        })]
    })
};
...
function D(e) {
    let {
        ...
        guildId: s,
        sticker: D
    } = e, R = (0, o.bG)([d.Ay], () => D?.tags != null ? d.Ay.getCustomEmojiById(D.tags) : null), z = f.default.getCurrentUser()?.isStaff() ? S.Ny : 524288, [L, B] = n.useState(null), [O, U] = n.useState(D?.name ?? ""), [F, G] = n.useState({
        file: null,
        filename: (0, b.sL)(D) ?? ""
        ...
        if (i.size > z) {
            J({
                message: v.intl.formatToPlainString(v.t["3eK7Ru"], {
                    maxSize: (0, j.up)(z, {
                        useKibibytes: !0
                    })
                }),
                isBlocking: null == F.file
            }), p.default.track(N.HAw.STICKER_UPLOAD_FILE_SIZE_LIMIT_EXCEEDED, {
                size: i.size,
                filetype: i.type
            });
            return
        ...
        if (l === E.TG.LOTTIE) {
            if (!Q) return void J({
                message: v.intl.format(v.t.RNNjy6, {
                    articleURL: x.A.getArticleURL(N.MVz.STICKERS_UPLOAD)
                }),
                isBlocking: !0
            });
        ...
        try {
            if (H(!0), W) await (0, A.MO)(s, D?.id ?? "", {
                ...
                var l;
                let e = new FormData;
                e.append("name", O), e.append("tags", t), e.append("description", X), F?.file != null && e.append("file", F.file), l = F.file?.type ?? "", p.default.track(N.HAw.STICKER_UPLOAD_STARTED, {
                    filetype: l
                }), await (0, A.p9)({
                    guildId: s,
                    body: e,
                    platform: "web"
                }), T(!0), (0, u.showToast)((0, u.createToast)(v.intl.string(v.t.QR85gd), u.ToastType.SUCCESS))
            }
            i()
        } catch (e) {
            J({
        ...
        onStickerError: n.useCallback(() => {
            J({
                message: v.intl.string(v.t["/WIYNX"]),
                isBlocking: !0
            })
        }, [])
