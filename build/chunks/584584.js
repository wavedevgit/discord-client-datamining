...
function p() {
    ...
    for (let {
        ...
        A.A.applicationIdsFetching.has(i.id) || A.A.isEntitledToSku(E.default.getCurrentUser(), t, i.id, i.id) || !r.available ? null != g[t] && (delete g[t], e = !0) : (g[t] = {
            skuId: t,
            applicationId: n
        }, e = !0)
    }
        ...
        for (let {
            ...
            if (null != t && n !== I.d3x.DISCORD)
                for (let {
                    ...
                    of I.m_i) i !== t || f.includes(n) || null == N[n] && (A.A.applicationIdsFetched.has(i) || A.A.applicationIdsFetching.has(i) || null != A.A.getForSku(n) || c.LM(i), N[n] = {
                    skuId: n,
                    applicationId: i
                }, e = !0);
        return e && p(), e
