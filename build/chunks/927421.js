/** chunk id: 927421 params = (module,exports,require) **/
l.d(t, {
    A: () => I
}), l(321073);
var n = l(627968),
...
function I(e) {
    ...
    }((0, g.Y)(l, !0)), N = (0, p.T)(), O = r.useRef(null), [T, b] = r.useState(void 0), j = (0, s.bG)([d.A], () => d.A.getMediaSessionId()), {
        analyticsLocations: S
    } = (0, u.Ay)(i.A.SOUNDBOARD_WHEEL), k = r.useCallback(e => {
        (0, y.Ak)(e, l.id, S), w()
    }, [S, l.id, w]);
    r.useEffect(() => {
    ...
    let R = r.useCallback(e => {
        ...
        P = r.useMemo(() => D.map(e => (0, n.jsx)(m.Ay, {
            interactive: M,
            className: _.a,
            sound: e,
            focused: T === e.soundId,
    ...
    return 0 === D.length ? null : (0, n.jsx)(u.f5, {
        value: S,
