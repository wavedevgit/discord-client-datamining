/** chunk id: 922975 params = (module,exports,require) **/
n.d(t, {
    $7: () => k,
    $O: () => U,
    A_: () => z,
...
function k(e, t) {
    ...
    return T(e, "roleIcon", i.useMemo(() => ({
        icon: n?.icon ?? void 0,
        unicodeEmoji: n?.unicodeEmoji ?? void 0
    }), [n]))
}
...
function B(e, t) {
    ...
    return i.useMemo(() => {
        ...
        return void 0 !== r && (e.icon = r.icon ?? "", e.unicodeEmoji = r.unicodeEmoji ?? ""), void 0 !== l && (e.color = l, e.colorString = (0, s.Hl)(l)), e
    }, [n, r, l])
}

function O(e, t) {
    let n = (0, h.A)(t, e);
    return T(e, "roleColor", i.useMemo(() => n?.color ?? I.TGz, [n]))
}

function W(e, t) {
    let n = (0, h.A)(t, e);
    return T(e, "channelAccessFormat", i.useMemo(() => null == n ? N.h.SOME_CHANNELS_ACCESS : (0, y.iR)(n) ? N.h.ALL_CHANNELS_ACCESS : N.h.SOME_CHANNELS_ACCESS, [n]))
}
let Y = [];

function D(e) {
    let t = x(e, e => null == e ? Y : e.role_benefits.benefits.filter(A.B1));
    return T(e, "channelBenefits", t)
}
let R = [];

function U(e) {
    let t = x(e, e => null == e ? R : e.role_benefits.benefits.filter(A.b1));
    return T(e, "intangibleBenefits", t)
}
let P = new Set;

function $(e, t) {
    return 0 === e.length ? P : new Set(e.filter(e => e.roles.includes(t)).map(e => {
        let {
            id: t
        } = e;
        return t
...
function F(e, t) {
    ...
    return T(e, "tierEmojiIds", i.useMemo(() => null == n ? P : $(l, n.id), [l, n]))
}
...
async function X(e) {
    let {
        guildId: t,
        editStateId: n
    } = e, i = S.A.getSubscriptionListing(n);
    r()(null != i, "listing doesnt exist");
    let l = i.role_id,
        a = i.id,
        s = N.y.getState().listings[n];
    ...
    (void 0 !== u || void 0 !== c) && await m.A.updateRole(t, l, {
        color: u,
        icon: c?.icon,
        unicodeEmoji: c?.unicodeEmoji
    });
    let v = S.A.getSubscriptionTrial(a);
    if ((null != f || null != p || null != v && null == p) && await _.J1(t, a, {
            trial: p,
            max_num_active_trial_users: f
        }), void 0 !== A) {
        let e = $(g.Ay.getGuildEmoji(t), l),
...
async function q(e) {
    ...
    r()(null != a, "no name provided"), r()(null != s, "no description provided"), r()(null != d, "no priceTier provided"), r()(null != m, "no image provided");
    let g = f === N.h.ALL_CHANNELS_ACCESS,
        p = i;
...
function ee() {
    let [e, t] = i.useState(!1), [n, l] = i.useState();
    return {
        loading: e,
        error: n,
            ...
            try {
                ...
                function(e) {
                    let {
                        ...
                        editStateId: n,
                        groupListingId: i
                    } = e, l = S.A.getSubscriptionListing(n);
                    r()(null != l, "listing doesnt exist");
                    let a = N.y.getState().listings[n];
                    ...
                    if (s !== l.name && (p.name = s), u !== l.description && (p.description = u), m !== l.subscription_plans[0]?.price && (p.priceTier = m), null != f && (p.image = f), null != g && (p.can_access_all_channels = g === N.h.ALL_CHANNELS_ACCESS), null != c || null != d) {
                        let e = l.role_benefits.benefits.filter(A.B1),
                            t = l.role_benefits.benefits.filter(A.b1);
                        p.benefits = [...c ?? e, ...d ?? t]
                    }
                    return (0, o.isEmpty)(p) ? l : _.vW({
                        guildId: t,
                        groupListingId: i,
                        listingId: n,
                        data: p
...
function et(e, t) {
    ...
    return {
        ...
        addNewEditStateFromTemplate: i.useCallback(e => {
            let n = (0, a.A)();
            return o(t, e => [...e ?? [], n]), e.listings.forEach(t => {
                s(n, () => ({
                    name: t.name,
