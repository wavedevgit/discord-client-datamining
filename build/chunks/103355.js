/** chunk id: 103355, original params: e,t,l (module,exports,require) **/
l.d(t, {
    L: () => A
});
var n = l(627968),
...
function A(e) {
    ...
    let w = s.useMemo(() => l === h.XG.CANCELED || k?.is_canceled ? 5 : l === h.XG.ACTIVE ? 3 : h.lV.has(l) ? 4 : b ? 2 : +!!D, [l, k?.is_canceled, b, D]),
        z = function(e, t, l, s, i) {
            switch (e) {
                case 1:
                    return i > 0 ? N.intl.formatToPlainString(N.t.PQlCWk, {
                        minutes: i
                    }) : N.intl.string(N.t.WINqKV);
                case 2:
                    return N.intl.string(N.t.WINqKV);
                case 3:
                    return null != s && "" !== s ? N.intl.format(N.t.vHYgJW, {
                        start: l,
                        startHook: e => (0, n.jsx)(o.Text, {
    ...
    if (null != C) {
        let e = (0, x.X7)(C);
        Y = N.intl.formatToPlainString(N.t.HmKEqW, {
            recurrenceRule: e.toText()
        });
        let l = c()(t);
        Y = function(e, t) {
            let l = t.toDate(),
                n = l.toLocaleString(N.intl.currentLocale, {
                    weekday: "long"
                });
            switch (e) {
                case v.z.WEEKLY:
                    return N.intl.formatToPlainString(N.t.xQM9X0, {
                        weekday: n
                    });
                case v.z.BIWEEKLY:
                    return N.intl.formatToPlainString(N.t.RYscac, {
                        weekday: n
                    });
                case v.z.MONTHLY:
                    let s = Math.ceil(l.getDate() / 7);
                    return N.intl.formatToPlainString(N.t["4ZN9Ap"], {
                        weekday: n,
                        nth: s
                    });
                case v.z.YEARLY:
                    return N.intl.formatToPlainString(N.t["rXUS+j"], {
                        date: l.toLocaleString(N.intl.currentLocale, {
                            month: "short",
                            day: "2-digit"
                        })
                    });
    ...
    return (0, n.jsxs)(j, {
        ...
        tooltipText: M,
        children: [I && l === h.XG.SCHEDULED ? (0, n.jsx)(p, {}) : (0, n.jsx)(U, {
            color: O,
            size: "custom",
            width: 20,
            height: 20
