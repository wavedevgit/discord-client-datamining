...
function h(e) {
    let {
        compact: t = !1
    } = e, n = (0, u.GV)(), s = window.GLOBAL_ENV.RELEASE_CHANNEL, a = "509926", h = "dc8be677ecc4666df4ad9ae33ad8f54b0e488b58".substring(0, 7), p = d.A?.app.getVersion(), x = d.A?.app.getBuildNumber(), E = d.A?.app.getAppArch(), T = c.A.getCurrentBuildOverride().overrides?.discord_web, S = function() {
        let e = r()?.os?.toString();
    ...
    return (null != p && (C.push(`Host ${p}`), null != E && C.push(E.toLowerCase()), null != x && C.push(`(${x})`)), C.push(`Build Override: ${null!=T?T.id:"N/A"}`), null != S && C.push(S), t) ? (0, i.jsxs)(i.Fragment, {
        children: [(0, i.jsx)(_.A, {
            ...
            children: e => (0, i.jsxs)(o.DUT, {
                ...
                children: [(0, i.jsxs)("div", {
                    ...
                    }), null != p && (0, i.jsxs)(o.Text, {
                        tag: "span",
                        variant: "text-xxs/normal",
                        color: "text-muted",
                        children: [p, null != E && (0, i.jsxs)("span", {
                            className: m.GI,
                            children: [" ", E.toLowerCase()]
                        }), null != x && (0, i.jsxs)("span", {
                            children: [" (", x, ")"]
                        })]
                    })]
                ...
                children: (0, i.jsxs)("div", {
                    ...
                    children: [(0, i.jsxs)(o.Text, {
                        ...
                        children: [(0, i.jsxs)(o.Text, {
                            ...
                            variant: "text-xs/normal",
                            color: "text-muted",
                            children: ["Host ", p, " ", null != E ? (0, i.jsxs)("span", {
                                className: m.GI,
                                children: [E.toLowerCase(), " "]
