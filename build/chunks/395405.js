/** chunk id: 395405 params = (module,exports,require) **/
"use strict";
n.d(t, {
    A: () => O
});
...
class R extends s.Component {
    ...
    measure = () => {
        ...
        let {
            top: n
        } = t.getBoundingClientRect(), i = {};
        for (let [t, s] of Object.entries(this.tierRefs)) {
            if (null == s) return;
            let {
                top: l
            } = s.getBoundingClientRect(), r = e > 0 ? y : 0;
            i[t] = l - n + 32 - r
        }
        this.setState({
            tierPositions: i
    ...
    renderSubscriber = (e, t, n) => null == e ? null : (0, i.jsx)(c.m, {
        __unsupportedReactNodeAsText: (0, i.jsx)(x.A, {
            user: e.user,
            nick: e.nick
        }),
    ...
    renderSubscribersPopout = () => (0, i.jsx)(m.HOs, {
        className: S.xM,
        children: this.props.subscribers.map(e => (0, i.jsxs)("div", {
            className: S.c4,
            children: [(0, i.jsx)(m.euF, {
    ...
    renderMoreSubscribers = (e, t, n) => (0, i.jsx)(m.YNO, {
    ...
    renderSubscribers() {
        ...
        return (0, i.jsxs)("div", {
            ...
            children: [(0, i.jsx)(f.A, {
                ...
                className: S.iL,
                children: v.intl.format(v.t["0r7snZ"], {
                    count: t
                })
            })]
        })
    ...
    render() {
        let {
            ...
            uniqueSubscriberCount: s,
            tiers: l
        } = this.props;
        return null == n ? (0, i.jsx)(m.y$y, {
            type: m.y$y.Type.SPINNING_CIRCLE
        }) : null == e ? null : (0, i.jsx)("div", {
            children: (0, i.jsxs)("div", {
                className: S.Qs,
                children: [this.renderProgressBar(l), (0, i.jsxs)("div", {
                    className: S.cK,
                    children: [0 === s ? this.renderTierNone() : this.renderSubscribers(), l.map((i, s, l) => t({
                        tier: i,
                        tiers: l,
                        tierIndex: s,
                        onSetRef: this.setTierRef,
                        isAnimatedTo: b.M2T[this.state.animatedTier] >= b.M2T[i.tier],
                        subscriptionCount: n,
                        guildId: e
                    }))]
                })]
