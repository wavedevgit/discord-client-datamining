...
function h(e) {
    ...
    return A.forEach(e => {
        ...
        (null !== M && ([j, b] = (N = s = b, null == s || s.type !== M ? (v = {
            ...
            content: [],
            key: e.id
        }, x.push(v)) : N = (v = s).content[v.content.length - 1], [v, N])), g === e.id && null != S) ? (null != b && b.type === u.TZK.DIVIDER ? b.unreadId = e.id : null !== j ? (T = j, e.isFirstMessageInForumPost(m) || T.content.push({
            type: u.TZK.DIVIDER,
            unreadId: e.id
        ...
        w && e.id === k && null != P && (L.flashKey = P), A.jumpTargetId === e.id && (L.jumpTarget = !0), null != _ && e.id === _.startId && _.count > 1 && x.push({
            type: u.TZK.DIVIDER,
            content: _.topic,
