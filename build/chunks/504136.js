...
function u(e) {
    ...
    return m.forEach(e => {
        ...
        (null !== j && ([b, y] = (I = l = y, null == l || l.type !== j ? (T = {
            type: j,
            content: [],
            key: e.id
        }, _.push(T)) : I = (T = l).content[T.content.length - 1], [T, I])), A === e.id && null != x) ? (null != y && y.type === d.TZK.DIVIDER ? y.unreadId = e.id : null !== b ? (S = b, e.isFirstMessageInForumPost(h) || S.content.push({
            type: d.TZK.DIVIDER,
            unreadId: e.id
