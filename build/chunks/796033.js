/** chunk id: 796033, original params: e,l,a (module,exports,require) **/
a.d(l, {
    _: () => m
});
var t = a(627968),
...
function m(e) {
    let {
        ...
        i18n: g,
        locale: V
    } = (0, c.G9)(), C = l?.start ?? null, [j, S] = o.useState(C);
    return o.useEffect(() => {
        S(C)
    }, [C]), (0, t.jsx)(s._e, {
        value: l,
            ...
            children: [(0, t.jsxs)("header", {
                ...
                children: [(0, t.jsx)(r.K, {
                    ...
                    children: Array.from({
                        ...
                        let o = e.state.visibleRange.start.add({
                            months: a
                        }).toDate(e.state.timeZone).toLocaleDateString(V, {
                            month: "long",
                            year: "numeric"
                        });
                        return (0, t.jsx)(b.E, {
