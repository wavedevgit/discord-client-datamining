...
let x = function(e) {
    let {
        ...
        rating: void 0,
        ratingCount: void 0
    }, g = t.find(e => e.category === a.V.STEAM), h = (0, o.j)(x.rating, x.ratingCount), f = function(e) {
        switch (e) {
    ...
    }(h), [j, v] = l.useState(!1), p = l.useCallback(() => {
        v(!0)
    }, []), A = l.useCallback(() => {
        v(!1)
    }, []), E = l.useCallback(() => {
                    ...
                    children: (0, n.jsx)("div", {
                        ...
                        children: (0, n.jsxs)("div", {
                            ...
                            children: [(0, n.jsxs)("div", {
                                ...
                                text: h === c.vI.NO_USER_REVIEWS ? u.intl.string(u.t.CLMt8J) : u.intl.format(u.t["lzANJ/"], {
                                    rating: x.rating,
                                ...
                                children: (0, n.jsxs)("div", {
                                    ...
                                    }), null != x.ratingCount && h !== c.vI.NO_USER_REVIEWS && (0, n.jsx)(r.Text, {
                                        variant: "text-xs/medium",
                                        color: "text-subtle",
