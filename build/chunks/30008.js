/** chunk id: 30008 params = (module,exports,require) **/
n.d(t, {
    Q: () => I
}), n(938796);
var l = n(627968),
...
let N = (0, r.UT)([u.A, c.A, m.A], {
    ...
    load: async e => {
        if (null == e) return;
        let t = {
                url: E.Rsh.STOREFRONT_PREMIUM_BUTTON(e),
                rejectWithError: !1
            },
            {
                body: n
...
function I(e) {
    ...
    }, [r?.applicationId, r?.id, r?.flags]), u = a.useCallback(() => {
    ...
    if (null != r && null != s && (null == r || r.type !== E.Puh.SUBSCRIPTION || null != n)) {
        if (null == e || null != r && !r.available) return {
            disabled: !0,
