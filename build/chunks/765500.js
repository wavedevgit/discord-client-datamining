/** chunk id: 765500 params = (module,exports,require) **/
n.d(t, {
    N: () => g,
    x: () => m
});
...
function m(e) {
    ...
    return (0, i.jsxs)(s.BJc, {
        ...
        children: [(0, i.jsx)(a.A, {
            Icon: t,
            color: c ? l.A.colors.ICON_MUTED : "currentColor"
        }), (0, i.jsxs)(s.BJc, {
            direction: "vertical",
            gap: "xxs",
...
function g(e) {
    let {
        ...
        Icon: _,
        lastActive: x
    } = (0, d.T)(t, n), h = [l, x].filter(o.Vq);
    return (0, i.jsx)(m, {
        icon: _,
        label: g,
        subLabel: a,
        description: h.join(" \xb7 "),
        children: !n && (0, i.jsx)(s.DUT, {
            className: u.X,
