...
function A(t) {
    let {
    ...
    } = (0, c.i)(), R = A(e), p = (0, u.i)(n), [h, m] = l.useState(p.blockId), [O, C] = l.useState(p.pageIndex), [g, S] = l.useState(!1), y = (t, n) => {
        I(e, t, n)
        ...
        N(e, M), t.isComplete && o.Ay.submitSurveyResponse(e, R), m(t.blockId), C(t.pageIndex), S(t.isComplete)
    }, [n, h, O, R, e, M, N]);
    l.useEffect(() => {
        0 === M.length && U()
    }, [M, U]);
