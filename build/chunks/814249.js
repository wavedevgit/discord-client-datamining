...
function A(t) {
    let {
    ...
    } = (0, c.i)(), p = A(e), R = (0, d.i)(n), [g, h] = r.useState(R.blockId), [O, m] = r.useState(R.pageIndex), [C, S] = r.useState(!1), y = (t, n) => {
        I(e, t, n)
        ...
        N(e, P), t.isComplete && o.Ay.submitSurveyResponse(e, p), h(t.blockId), m(t.pageIndex), S(t.isComplete)
    }, [n, g, O, p, e, P, N]);
    r.useEffect(() => {
        0 === P.length && U()
    }, [P, U]);
