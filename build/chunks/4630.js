...
async function x(e) {
    ...
    v = v ?? m.A.get(T), s()(null != v && v.applicationId === N, "SKU must belong to application"), v.type !== f.Puh.SUBSCRIPTION || (0, c.B)([v.id]) || await (0, o.ur)(v.id);
    let j = null == (C = null != (I = (0, d.LU)({
        applicationId: N
