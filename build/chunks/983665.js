/** chunk id: 983665 params = (module,exports,require) **/
i.d(n, {
    default: () => u
});
var e = i(627968),
...
function h(t) {
    let {
        name: n,
        value: i
    } = t, [a, l] = s.useState(r.qCr.DEFAULT);
    return (0, e.jsx)("div", {
        className: m.lj,
        children: (0, e.jsx)(r.D0$, {
            ...
            children: (0, e.jsx)(r.e2O, {
                ...
                supportsCopy: o.p5,
                onCopy: () => {
                    (0, o.C)(i, () => l(r.qCr.SUCCESS), () => l(r.qCr.ERROR))
                }
            })
        })
    })
...
function u(t) {
    let {
        onClose: n,
        transitionState: i
    } = t, [o, u] = s.useState(""), [j, g] = s.useState(""), [p, _] = s.useState(null), [N, v] = s.useState(!1), [b, C] = s.useState("DOMAIN"), O = () => {
        v(!0), _(null), a.Bo.post({
            ...
            t.body?.proof && "DOMAIN" === b ? (g(t.body.proof), C("PROOF_DNS")) : _(t.body?.errors?.domain?._errors?.[0]?.message || t.body?.message || t.message)
        }).finally(() => {
            v(!1)
        })
    };
    return (0, e.jsxs)(r.EOs, {
        ...
        children: [(0, e.jsxs)(r.rQ0, {
            ...
            activeSlide: b,
            width: 440,
            children: [(0, e.jsx)(r.q7S, {
                id: "DOMAIN",
                children: (0, e.jsxs)("form", {
                    onSubmit: t => {
                        t.preventDefault(), O()
                    },
                    children: [(0, e.jsxs)(r.$mQ, {
                        "data-migration-pending": !0,
                        className: m.Qs,
