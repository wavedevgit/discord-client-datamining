...
let A = e => {
    let {
        ...
        y: 0
    }), A = i?.path === "sine" ? Math.sin : Math.cos, [g, x] = (0, s.useState)(1), h = (0, c.zhh)(null != n ? {
        from: {
        ...
        blur: 0
    }), R = (0, s.useMemo)(() => Math.round((750 + (200 * Math.random() - 100)) * _), [_]), [C, v] = (0, s.useState)(0), [I, E] = (0, s.useState)(1), j = (0, c.zhh)({
        xOffset: C,
        config: {
            tension: 10,
            friction: 10,
    ...
    return ((0, o.A)(() => {
        v(I * (.5 * Math.random() * 5 + 2.5)), E(e => -1 * e)
