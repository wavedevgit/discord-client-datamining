/** chunk id: 425050, original params: e,a,t (module,exports,require) **/
t.d(a, {
    Z: () => g
});
var r = t(974111),
...
function g(e, a, t) {
    ...
    let P = (0, y.o)((w = n.A) && w.__esModule ? w.default : w, "@react-aria/datepicker"),
        ...
        T = I ? P.format("selectedRangeDescription", {
            startDate: I.start,
            endDate: I.end
        }) : "",
        O = (0, u.I)(T),
        N = {
            "aria-label": P.format("startDate"),
            "aria-labelledby": B
        },
        Z = {
            "aria-label": P.format("endDate"),
            "aria-labelledby": B
        },
        z = (0, s.Bi)(),
        U = (0, s.Bi)(),
        ...
        W = (0, p.useRef)(!1),
        {
            ...
            onBlurWithin: a => {
                ...
                if (!(null == t ? void 0 : t.contains(a.relatedTarget))) {
                    var r, n;
                    W.current = !1, null == (r = e.onBlur) || r.call(e, a), null == (n = e.onFocusChange) || n.call(e, !1)
                }
            },
            onFocusWithin: a => {
                if (!W.current) {
                    var t, r;
                    W.current = !0, null == (t = e.onFocus) || t.call(e, a), null == (r = e.onFocusChange) || r.call(e, !0)
                }
            }
        }),
        H = (0, p.useRef)(o.YD),
