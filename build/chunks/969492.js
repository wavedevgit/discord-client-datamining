...
function f(e) {
    ...
    switch (n) {
        case "churn_discount":
            if (null != I && null != f) return (0, r.jsx)(m.A, {
                targetElementRef: i,
                discountOffer: I,
                premiumSubscription: f,
                dismissCoachmark: S,
