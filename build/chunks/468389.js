...
function K(t, e) {
    ...
    } = (0, c.Ay)(), Q = (0, l.bG)([_.default], () => _.default.getCurrentUser()), X = (0, l.bG)([x.Ay], () => x.Ay.getSelfEmbeddedActivities()), B = (0, l.yK)([S.A], () => S.A.getActivities().filter(t => null == t.application_id || !(null == X ? void 0 : X.has(t.application_id)))), H = (0, l.yK)([g.A], () => null != e ? g.A.getActivities(e.id, null == t ? void 0 : t.getGuildId()) : [], [e, t]), q = (0, l.yK)([x.Ay], () => {
    ...
    }, [e, t]), F = (0, l.bG)([E.A], () => null == t || t.isPrivate() || E.A.can(R.xBc.SEND_MESSAGES, t), [t]), Z = (0, l.yK)([T.A], () => [...H.map(t => null != t.application_id && T.A.getState(t.application_id, R.xL.JOIN) === R.eAD.LOADING), ...q.map(t => T.A.getState(t.applicationId, R.xL.JOIN) === R.eAD.LOADING)], [H, q]), W = (0, u.A)([...H.filter(t => (null == t ? void 0 : t.application_id) != null).map(t => t.application_id), ...q.map(t => t.applicationId)]), z = null == t ? void 0 : t.id, tt = (0, l.yK)([v.A, j.A, O.A, m.A, h.A, N.A, E.A], () => [...H.map(t => (0, U.A)({
        user: null != e ? e : Q,
        activity: t,
    ...
    })], [H, W, z, Q, q, e]), te = (0, l.yK)([s.A, f.default], () => H.map(t => t.type === R.$pd.LISTENING && null != e ? (0, y.A)(s.A, f.default, e, t) : void 0), [e, H]), ti = (0, d.p)();
