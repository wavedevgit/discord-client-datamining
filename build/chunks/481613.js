...
e = n.nmd(e), (function() {
    ...
    function A(e) {
        ...
        if (j && (t = /(?:[ab]|dp|pre|[ab]\d+pre)(?:\d+\+?)?$/i.exec(j) || /(?:alpha|beta)(?: ?\d)?/i.exec(e + ";" + (M && o.appMinorVersion)) || /\bMinefield\b/i.test(e) && "a") && (x = /b/i.test(t) ? "beta" : "alpha", j = j.replace(RegExp(t + "\\+?$"), "") + ("beta" == x ? N : C) + (/\d+\+?/.exec(t) || "")), "Fennec" == U || "Firefox" == U && /\b(?:Android|Firefox OS)\b/.test(F)) U = "Firefox Mobile";
        ...
        }), (t = /\b(?:AMD|IA|Win|WOW|x86_|x)64\b/i.exec(D)) && !/\bi686\b/i.test(D) ? (F && (F.architecture = 64, F.family = F.family.replace(RegExp(" *" + t), "")), U && (/\bWOW64\b/i.test(e) || M && /\w(?:86|32)$/.test(o.cpuClass || o.platform) && !/\bWin64; x64\b/i.test(e)) && L.unshift("32-bit")) : F && /^OS X/.test(F.family) && "Chrome" == U && parseFloat(j) >= 39 && (F.architecture = 64), e || (e = null);
        var Z = {};
        return Z.description = e, Z.layout = k && k[0], Z.manufacturer = V, Z.name = U, Z.prerelease = x, Z.product = G, Z.ua = e, Z.version = U && j, Z.os = F || {
            architecture: null,
            family: null,
            version: null,
            toString: function() {
        ...
        }, Z.parse = A, Z.toString = q, Z.version && L.unshift(j), Z.name && L.unshift(U), F && U && !(F == String(F).split(" ")[0] && (F == U.split(" ")[0] || G)) && L.push(G ? "(" + F + ")" : "on " + F), L.length && (Z.description = L.join(" ")), Z
    }
    var I = A();
