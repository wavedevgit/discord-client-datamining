...
var l = n(311907),
    ...
    a = n(256331),
    o = n(141850);
let u = ["rgba(88, 101, 242, 0.12)", "rgba(87, 242, 135, 0.12)", "rgba(254, 231, 92, 0.12)", "rgba(235, 69, 158, 0.12)", "rgba(237, 66, 69, 0.12)", "rgba(49, 196, 182, 0.12)", "rgba(230, 126, 34, 0.12)", "rgba(149, 165, 166, 0.12)", "rgba(155, 89, 182, 0.12)", "rgba(52, 152, 219, 0.12)"],
    c = new Map,
    d = new Set,
    m = new Map,
    h = null,
...
class E extends l.Ay.Store {
    ...
    getChannelConversations(e) {
        return (c.get(e)?.conversations ?? []).map(e => ({
            conversation: e,
            color: N(e)
        }))
    }
    getVisibleConversationIds(e) {
        ...
        if (null == n) return t;
        for (let e of n) {
            let n = null != f && 0 > s.default.compare(f, e.start_message_id);
            null != A && s.default.compare(A, e.end_message_id) > 0 || n || t.add(e.id)
        }
        return t
    }
    getMessageModerationLabel(e, t) {
        return a.A.isHighlightingEnabled() && (0, r.f)("message_header") ? c.get(e)?.messageToModerationLabel.get(t) ?? null : null
    }
...
let T = new E(i.h, {
    ...
    CONVERSATIONS_FETCH_SUCCESS: function(e) {
        ...
        d.delete(t),
            function(e) {
                let {
                    ...
                    afterShortCircuited: r,
                    anchorTimestamp: a
                } = e, o = m.get(t) ?? [], u = n.length >= 5;
                if (n.length > 0) {
                    let e, t, a = n.map(e => s.default.extractTimestamp(e.start_message_id)),
                        c = Math.min(...a),
                        d = Math.max(...a);
                    "around" === l ? (e = !i && u, t = !r && u) : "before" === l ? (e = !i && u, t = !1) : (e = !1, t = !r && u);
                    let m = {
                        startTime: c,
                        endTime: d,
                        hasMoreBefore: e,
                ...
                m.set(t, function(e) {
                    ...
                    for (let n = 1; n < e.length; n++) {
                        let l = t[t.length - 1],
                            i = e[n];
                        i.startTime <= l.endTime + 1e3 ? (i.endTime > l.endTime ? (l.endTime = i.endTime, l.hasMoreAfter = i.hasMoreAfter) : l.hasMoreAfter = l.hasMoreAfter && i.hasMoreAfter, l.hasMoreBefore = l.hasMoreBefore && i.hasMoreBefore) : t.push(i)
                    }
                    return t
                }(o))
            }({
                ...
                beforeShortCircuited: i,
                afterShortCircuited: r,
                anchorTimestamp: null != a ? s.default.extractTimestamp(a) : void 0
            });
        let o = function(e, t) {
            let n = new Map;
        ...
        return c.set(t, function(e) {
            ...
            for (let s of e) {
                t.set(s.id, s);
                let e = N(s);
                for (let t of s.message_ids) n.set(t, s.id), l.set(t, e);
                if (null != s.moderation) {
                    let e = new Map;
                    for (let t of s.moderation.flagged_message_details) {
                        let n = e.get(t.message_id);
                        null != n ? n.push(t) : e.set(t.message_id, [t])
                    }
                    for (let t of s.moderation.flagged_message_ids) {
                        let n = e.get(t) ?? [],
                            l = n[0],
                            s = n.map(e => e.category ?? e.reason).filter(e => null != e),
                            r = l?.severity ?? null,
                            a = l?.confidence ?? null,
                            o = [null != r ? `${r} severity` : null, null != a ? `${a} confidence` : null].filter(Boolean).join(", "),
                            u = [s.length > 0 ? s.join(", ") : null, o.length > 0 ? o : null].filter(Boolean).join(" \xb7 ");
                        i.set(t, u.length > 0 ? u : "Moderation Failed")
                    }
                }
            }
            return {
    ...
    CHANNEL_SELECT: function(e) {
        ...
        return h = t ?? null, A = null, f = null, null != t && !d.has(t) && !c.has(t) && (0, r.f)("channel_select") && (null != n ? (0, o.WF)({
            channelId: t,
            around: n
        }) : (0, o.WF)({
            channelId: t
    ...
    UPDATE_VISIBLE_MESSAGES: function(e) {
        let {
            topVisibleMessage: t,
            bottomVisibleMessage: n
        } = e;
        if (null == h || !(0, r.f)("visible_messages")) return !1;
        let l = A !== t,
            i = f !== n;
        if (A = t ?? null, f = n ?? null, d.has(h) || null == t) return l || i;
        let a = s.default.extractTimestamp(t);
        if (v(h, a)) {
            if (null != n) {
