    ...
    CONVERSATIONS_FETCH_SUCCESS: function(e) {
        ...
        d.delete(t),
            function(e) {
                ...
                if (n.length > 0) {
                    let e, t, a = n.map(e => i.default.extractTimestamp(e.start_message_id)),
                        c = Math.min(...a),
                        d = Math.max(...a);
                    "around" === l ? (e = !s && u, t = !r && u) : "before" === l ? (e = !s && u, t = !1) : (e = !1, t = !r && u);
                    let m = {
                        startTime: c,
                        endTime: d,
                        hasMoreBefore: e,
                ...
                m.set(t, function(e) {
                    ...
                    for (let n = 1; n < e.length; n++) {
                        let l = t[t.length - 1],
                            s = e[n];
                        s.startTime <= l.endTime + 1e3 ? (s.endTime > l.endTime ? (l.endTime = s.endTime, l.hasMoreAfter = s.hasMoreAfter) : l.hasMoreAfter = l.hasMoreAfter && s.hasMoreAfter, l.hasMoreBefore = l.hasMoreBefore && s.hasMoreBefore) : t.push(s)
                    }
                    return t
                }(o))
            }({
                ...
                if (null != i.moderation) {
                    ...
                    for (let t of i.moderation.flagged_message_ids) {
                        let n = e.get(t) ?? [],
                            ...
                            u = [i.length > 0 ? i.join(", ") : null, o.length > 0 ? o : null].filter(Boolean).join(" \xb7 ");
