/** chunk id: 736339, original params: e,t,n (module,exports,require) **/
n.d(t, {
    A: () => g
});
var i = n(311907),
    ...
    a = n(256331),
    r = n(141850);
let o = ["rgba(88, 101, 242, 0.12)", "rgba(87, 242, 135, 0.12)", "rgba(254, 231, 92, 0.12)", "rgba(235, 69, 158, 0.12)", "rgba(237, 66, 69, 0.12)", "rgba(49, 196, 182, 0.12)", "rgba(230, 126, 34, 0.12)", "rgba(149, 165, 166, 0.12)", "rgba(155, 89, 182, 0.12)", "rgba(52, 152, 219, 0.12)"],
    c = new Map,
    d = new Map,
    u = new Set,
    h = new Map,
...
let g = new A(l.h, {
    ...
    CONVERSATIONS_FETCH_SUCCESS: function(e) {
        ...
        let s = l ? [...d.get(n) ?? [], ...i] : i;
        return d.set(n, s), c.set(n, (t = new Map, s.forEach((e, n) => {
            let i = o[n % o.length];
