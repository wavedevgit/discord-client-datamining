...
var i = n(311907),
    ...
    s = n(256331),
    o = n(141850);
let d = ["rgba(88, 101, 242, 0.12)", "rgba(87, 242, 135, 0.12)", "rgba(254, 231, 92, 0.12)", "rgba(235, 69, 158, 0.12)", "rgba(237, 66, 69, 0.12)", "rgba(49, 196, 182, 0.12)", "rgba(230, 126, 34, 0.12)", "rgba(149, 165, 166, 0.12)", "rgba(155, 89, 182, 0.12)", "rgba(52, 152, 219, 0.12)"],
    c = new Map,
    u = new Map,
    g = new Set,
    A = new Map,
...
class T extends i.Ay.Store {
    ...
    getConversationForMessage(e, t) {
        ...
        for (let e of n)
            if (e.message_ids.includes(t)) return e.id;
        return null
    }
...
let v = new T(l.h, {
    ...
    CONVERSATIONS_FETCH_SUCCESS: function(e) {
        ...
        g.delete(t),
            function(e) {
                let {
                    ...
                    afterShortCircuited: a,
                    anchorTimestamp: s
                } = e, o = A.get(t) ?? [], d = n.length >= 5;
                if (n.length > 0) {
                    let e, t, s = n.map(e => r.default.extractTimestamp(e.start_message_id)),
                        c = Math.min(...s),
                        u = Math.max(...s);
                    "around" === i ? (e = !l && d, t = !a && d) : "before" === i ? (e = !l && d, t = !1) : (e = !1, t = !a && d);
                    let g = {
                        startTime: c,
                        endTime: u,
                        hasMoreBefore: e,
                ...
                A.set(t, function(e) {
                    ...
                    for (let n = 1; n < e.length; n++) {
                        let i = t[t.length - 1],
                            l = e[n];
                        l.startTime <= i.endTime + 1e3 ? (l.endTime > i.endTime ? (i.endTime = l.endTime, i.hasMoreAfter = l.hasMoreAfter) : i.hasMoreAfter = i.hasMoreAfter && l.hasMoreAfter, i.hasMoreBefore = i.hasMoreBefore && l.hasMoreBefore) : t.push(l)
                    }
                    return t
                }(o))
            }({
        ...
        return u.set(t, o), c.set(t, function(e) {
            let t = new Map;
            for (let n of e) {
                let e = _(n);
    ...
    CHANNEL_SELECT: function(e) {
        ...
        return m = t ?? null, p = null, h = null, null != t && !g.has(t) && !u.has(t) && (0, a.f)("channel_select") && (null != n ? (0, o.WF)({
            channelId: t,
            around: n
        }) : (0, o.WF)({
            channelId: t
