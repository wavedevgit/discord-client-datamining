...
class S extends l.Ay.Store {
    ...
    getChannelConversations(e) {
        let t = c.get(e);
        return null == t ? [] : t.conversations.map(e => {
...
let T = new S(i.h, {
    ...
    CONVERSATIONS_FETCH_SUCCESS: function(e) {
        ...
        }(o, n)), i && ("before" === l || "around" === l) && g.set(t, !0), a && ("after" === l || "around" === l) && h.set(t, !0);
        let A = function(e, t) {
            let n = new Map;
        ...
        return c.set(t, function(e, t) {
            ...
            for (let i of e) {
                ...
                for (let e of i.message_ids) {
                    let t = null;
                    null != i.moderation && i.moderation.flagged_message_ids.includes(e) && null != s && (t = function(e) {
                        let t = e[0],
                            n = e.map(e => e.category ?? e.reason).filter(e => null != e),
                            l = t?.severity ?? null,
                            i = t?.confidence ?? null,
                            s = [null != l ? `${l} severity` : null, null != i ? `${i} confidence` : null].filter(Boolean).join(", "),
                            a = [n.length > 0 ? n.join(", ") : null, s.length > 0 ? s : null].filter(Boolean).join(" \xb7 ");
            ...
            return {
                conversations: e,
                conversationMetadataById: n,
                messageMetadataByMessageId: l
            }
        }(A, c.get(t))), !0
    },
    ...
    UPDATE_VISIBLE_MESSAGES: function(e) {
        ...
        let {
            ...
            let i = 0,
                a = 0;
            for (let e of l) null != t && 0 > s.default.compare(e.start_message_id, t) && i++, null != n && s.default.compare(e.start_message_id, n) > 0 && a++;
            return {
                above: i,
                below: a
            }
        }(f, t, n);
        return p < 5 && !g.get(f) ? (0, o.WF)({
            channelId: f,
            before: t,
            limit: 25
        }) : C < 5 && null != n && !h.get(f) ? (0, o.WF)({
            channelId: f,
            after: n,
            limit: 25
        }) : u > 6e4 && (0, o.WF)({
