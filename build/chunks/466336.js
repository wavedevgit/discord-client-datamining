...
let g = e => {
    ...
    return (0, i.jsx)(l.AM, {
        targetElementRef: t,
        title: h.intl.string(h.t.K2DyeS),
        body: h.intl.string(h.t["JICo+3"]),
        graphic: {
            type: "image",
            src: m.A
        },
        ...
        actions: [{
            text: h.intl.string(h.t.t2N81y),
            onClick: () => {
                c.default.track(_.HAw.REFERRAL_PROGRAM_SHARE_MODAL_CTA_CLICKED, {
