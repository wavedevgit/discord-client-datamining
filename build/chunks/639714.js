...
function E(e) {
    let {
        ...
        onInviteResolved: i,
        closeModal: f
    } = e, [p, I] = a.useState(), E = (0, c.bG)([x.A], () => p?.guild?.id != null && x.A.isMember(p?.guild?.id)), N = a.useMemo(() => t.websites?.find(e => {
        let {
            category: t
        } = e;
    ...
    if (a.useEffect(() => {
            ...
            null != N && e(N.url)
        }, [N, i, p]), null == p || null == p.guild || !p.guild.features.includes(_.GuildFeatures.VERIFIED)) return null;
