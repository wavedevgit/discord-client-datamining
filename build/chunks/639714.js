...
function A(e) {
    let {
        ...
        onInviteResolved: a,
        closeModal: h
    } = e, [j, E] = l.useState(), A = (0, o.bG)([x.A], () => j?.guild?.id != null && x.A.isMember(j?.guild?.id)), N = l.useMemo(() => t.websites?.find(e => {
        let {
            category: t
        } = e;
    ...
    if (l.useEffect(() => {
            ...
            null != N && e(N.url)
        }, [N, a, j]), null == j || null == j.guild || !j.guild.features.includes(p.GuildFeatures.VERIFIED)) return null;
    ...
    return (0, i.jsxs)("div", {
        ...
        children: [(0, i.jsx)(c.Heading, {
            ...
            children: [(0, i.jsx)("img", {
                className: v.$f,
                src: C,
                alt: _.intl.formatToPlainString(_.t.xm6W9D, {
                ...
                children: [(0, i.jsxs)("div", {
                    ...
                    children: [(0, i.jsx)(c.Text, {
                        ...
                        children: j.guild.name
                    }), (0, i.jsx)(u.A, {
                        guild: j.guild,
                        size: 16
                    })]
                }), null != j.approximate_member_count && (0, i.jsx)(c.Text, {
            ...
            onClick: () => {
                h(), n(f.Ws.JoinOfficialServer), d.h.dispatch({
...
function N(e) {
    ...
    let o = g.Ay.getGuildIconURL({
            id: s.guild.id,
            icon: s.guild.icon,
            size: 48
        }),
        m = g.Ay.getGuildSplashURL({
            id: s.guild.id,
            ...
            children: [!x && null != m && (0, i.jsx)("img", {
                ...
                children: [(0, i.jsxs)("div", {
                    ...
                    children: [x ? I : (0, i.jsx)("div", {
                        ...
                        children: [(0, i.jsxs)("div", {
                        ...
                        }), !(0, h.uJ)(s.guild?.description) && (0, i.jsx)(c.Text, {
                            variant: "text-sm/medium",
                            color: "text-muted",
                            children: s.guild?.description
                        }), null != s.approximate_member_count || null != s.approximate_presence_count ? (0, i.jsxs)("div", {
                            className: E.iR,
                            children: [null != s.approximate_presence_count && (0, i.jsxs)("div", {
                                className: E.Tb,
                                children: [(0, i.jsx)("i", {
                                    className: E._o
                                }), (0, i.jsx)(c.Text, {
                            ...
                            }), null != s.approximate_member_count && (0, i.jsxs)("div", {
                                className: E.Tb,
                                children: [(0, i.jsx)("i", {
                                    className: E.jk
                                }), (0, i.jsx)(c.Text, {
                    ...
                    onClick: () => {
                        n(), t(f.Ws.JoinOfficialServer), d.h.dispatch({
                            type: "INVITE_MODAL_OPEN",
                            invite: s,
                            code: s.code,
                            context: p.BRT.APP
