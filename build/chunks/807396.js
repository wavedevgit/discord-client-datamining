...
let Z = e => {
    let t, {
        ...
        } = e,
        {
            ...
            joinErrorMessage: "" === L.A.joinErrorMessage(n.id) ? K.intl.string(K.t.j2d6Km) : L.A.joinErrorMessage(n.id),
            showJoinErrorMessage: void 0 !== L.A.joinErrorMessage(n.id)
        }), [n.id]);
    return null != (0, o.bG)([P.A], () => P.A.getGuild(n.guild.id), [n.guild.id]) || (t = (0, i.jsx)(m.Button, {
        size: "sm",
        onClick: function() {
            x.A.joinServer(n.id, () => {})
        },
...
function q(e) {
    let t, n, l, r, o, g, _, {
        ...
        [N, j] = s.useState(h.friendSync),
        [y, O] = s.useState(h.visibility),
        [R, L] = s.useState(h.metadataVisibility),
        [P, D] = s.useState(h.showActivity),
        [G, M] = s.useState(null),
        [k, w] = s.useState(null),
        [V, X] = s.useState(!1),
        [q, Q] = s.useState([]),
        ...
        $ = p.A.get(J);
    s.useEffect(() => {
        j(h.friendSync), O(h.visibility), L(h.metadataVisibility), D(h.showActivity)
    }, [h]);
    let ee = {
    ...
    return s.useEffect(() => {
        ...
        null != e && (O(e), x.A.setVisibility(h.type, h.id, e), M(null)), null != t && (L(t), x.A.setMetadataVisibility(h.type, h.id, t), w(null))
    }, [h]), (0, i.jsxs)("div", {
        className: W.FI,
        children: [(t = p.A.get(h.type), n = p.A.get(J), l = "1" === (h.metadata ?? {})[Y.pK.TWITTER_VERIFIED], r = null, t.type === z.fg2.TWITTER && l && (r = (0, i.jsx)(c.m, {
        ...
        })), h.twoWayLink ? null : h.type === z.fg2.XBOX ? (0, i.jsx)(H._, {}) : h.type === z.fg2.PLAYSTATION ? (0, i.jsx)(F.j, {}) : null, function(e) {
            let t = e.metadata ?? {},
                n = null,
        ...
        }(h), (z.txh.has(h.type) && (o = (0, i.jsx)(m.dOG, {
            label: K.intl.string(K.t["+KCMSi"]),
            checked: N,
            onChange: function(e) {
                j(e), x.A.setFriendSync(h.type, h.id, e)
            }
        })), z.ewM.has(h.type) && (g = (0, i.jsx)(m.dOG, {
            label: K.intl.format(K.t["6u6J0q"], {
                platform: $.name
            }),
            checked: P,
            onChange: function(e) {
                D(e), x.A.setShowActivity(h.type, h.id, e)
            }
        })), p.A.get(h.type)?.hasMetadata === !0 && (_ = (0, i.jsx)(m.dOG, {
            ...
            onChange: function(e) {
                ...
                L(n), x.A.setMetadataVisibility(h.type, h.id, n)
            },
            disabled: 1 !== y || null == h.metadata
        })), (0, i.jsxs)("div", {
            className: W.HZ,
            children: [(0, i.jsx)(m.dOG, {
                ...
                onChange: function(e) {
                    ...
                    O(n), x.A.setVisibility(h.type, h.id, n)
                }
            }), _, g, o]
        })), function() {
            if (h.revoked || h.integrations.length > 0) return (0, i.jsx)(m.cGx, {})
        }(), h.revoked ? (0, i.jsx)(a.po8, {
        ...
        }) : h.integrations.length > 0 ? (0, i.jsx)(m.D0$, {
            label: K.intl.string(K.t.fOe3fZ),
            children: h.integrations.map(e => (0, i.jsx)(Z, {
                integration: e
            }, e.id))
        }) : void 0]
    })
...
function ee() {
    let e = (0, S.gn)(),
        t = T.A.useConfig({
            location: "User Settings Connections"
        }),
        n = (0, f.A)(t.enabled ? X.tX : []);
    return (0, i.jsxs)("div", {
        className: W.lA,
        children: [n.map(e => null != e && (0, i.jsx)(O.A, {
            application: e,
            className: W.__invalid_accountButton,
            innerClassName: W.U$
        }, e.id)), e.slice(0, 10 - n.length).map(e => (0, i.jsx)(A.A, {
            type: e.type,
            className: W.__invalid_accountButton,
            innerClassName: W.U$
        }, e.type)), (0, i.jsx)(c.m, {
...
function et(e) {
    ...
    return t = n ? (0, i.jsx)(m.y$y, {
    ...
    }) : 0 === s.length && 0 === l.length ? (0, i.jsx)(m.ppr, {
        theme: a,
        ...
        children: [l.map((e, t) => (0, i.jsx)(J, {
            appIdentity: e,
            oauth2Token: r.find(t => t.application.id === e.application_id)
        }, `app-${t}`)), s.filter(e => p.A.isSupported(e.type)).map((e, t) => (0, i.jsx)(q, {
            theme: a,
            account: e,
            locale: o,
...
function en() {
    let e = (0, o.bG)([D.A], () => D.A.hidePersonalInformation),
        ...
        {
            isLoading: a,
            filteredAppIdentities: d
        } = (0, y.A)(G.default.getCurrentUser().id, {
            includeHidden: !0
        }),
        c = (0, h.Ay)(),
