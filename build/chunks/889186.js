...
function E(e) {
    let {
        ...
        disabled: n,
        onToggleChannel: r
    } = e, d = (0, i.bG)([A.A], () => A.A.getGuild(t.guild_id), [t.guild_id]), g = (0, c.Ay)(t), m = (0, i.bG)([C.default], () => t.isDM() ? C.default.getUser(t.recipients?.[0]) : null, [t]);
    return (0, s.jsx)(o.A, {
        listItemId: t.id,
        icon: t.isDM() && null != m ? (0, s.jsx)(u.A, {
            "aria-hidden": !0,
            size: a._3J.SIZE_32,
            user: m
