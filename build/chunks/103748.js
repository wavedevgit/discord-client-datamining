...
let T = {
    ...
    N = e => {
        let {
            ...
            showDarkTheme: i,
            onClear: s
        } = e, r = t === _.qH.REDUCED_MOTION, o = r ? i ? C : A : i ? v : j, d = (0, a.jsxs)(a.Fragment, {
            children: [(0, a.jsx)("img", {
                src: o,
                alt: "",
                className: b.XM,
    ...
    I = e => {
        let {
            ...
            upsertConfig: n
        } = (0, g.wu)(), s = (0, o.bG)([p.default], () => p.default.getCurrentUser()), [d, C] = i.useState(!0), A = i.useRef({}), [y, E] = i.useState(!1), [I, k] = i.useState(!1), [R, O] = i.useState(8), [w, D] = i.useState([]), [M, P] = i.useState(T), L = i.useRef([]), [U, B] = i.useState(t.name), G = U.toLowerCase().replace(/\s+/g, "_"), F = i.useMemo(() => ({
            id: S,
            skuId: S,
            title: S,
            description: S,
                    ...
                    children: [(0, a.jsx)("div", {
                        ...
                        children: [(0, a.jsxs)("div", {
                            ...
                            children: [(0, a.jsx)(c.Button, {
                                ...
                                onClick: () => A.current[`randomized-${t}`]?.activateUploadDialogue()
                            }), (0, a.jsx)(c.Button, {
                                variant: "critical-secondary",
                                text: "Remove Layer",
                                onClick: () => {
