...
let b = e => {
    let t, n, {
        ...
        k = (0, g.d)();
    G ? (t = I.intl.string(I.t["+vt7w9"]), n = I.intl.string(I.t.LgHbnL)) : (t = I.intl.string(I.t.LgHbnL), n = I.intl.string(I.t["+vt7w9"]));
    let V = () => {
        b(!1), A.default.track(S.HAw.NITRO_HOME_NAVIGATION, {
        ...
        children: (0, i.jsx)(c.hLv, {
            ...
            children: (0, i.jsxs)(_.f5, {
                ...
                children: [v ? (0, i.jsx)(T.A, {
                    ...
                    innerRef: R,
                    onChange: e => {
                        e && !L && (A.default.track(S.HAw.PREMIUM_MARKETING_SURFACE_REACHED_BOTTOM, {
                            location_stack: P
                        }), D(!0))
                    },
