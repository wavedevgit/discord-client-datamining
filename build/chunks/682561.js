/** Chunk was on web.js **/
/** chunk id: 682561, original params: e,t,n (module,exports,require) **/
"use strict";
n.d(t, {
    A: () => I
}), n(321073), n(65821), n(896048), n(457529), n(667532), n(747238);
var r, i = n(837385),
    a = n.n(i),
    s = n(415955),
    o = n.n(s),
...
class I extends f.A {
    ...
    setCodecs(e, t, n) {
        var r, i, a, s;
        let o;
        (this.audioCodec !== e || this.videoCodec !== t) && (o = this.codecs.find(t => t.name === e), this.audioCodec = e, this.audioPayloadType = null != (r = null == o ? void 0 : o.payloadType) ? r : 0, o = this.codecs.find(e => e.name === t), this.videoCodec = t, this.videoPayloadType = null != (i = null == o ? void 0 : o.payloadType) ? i : 0, this.rtxPayloadType = null != (a = null == o ? void 0 : o.rtxPayloadType) ? a : 0, null == (s = this.daveSessionManager) || s.updateLocalUserCodecs(e, t), this.logger.info("Renegotiating: Codecs changed"), this.handleNegotiationNeeded())
    }
    setStream(e) {
    ...
    createUser(e, t, n) {
        ...
        if (null == o && (o = {}), o.audioSSRC !== t) {
            o.audioSSRC = t, s = !0, this.unassignedStreams.audio.push({
                cname: e,
                ssrc: t
            });
        ...
        if (this.videoSupported && void 0 !== n && (!v || void 0 === o.videoSSRC)) {
            ...
            if (t > 0) {
                if (o.videoSSRC !== t) {
                    o.videoSSRC = t, s = !0, this.unassignedStreams.video.push({
                        cname: e,
                        ssrc: t
                    });
        ...
        return {
            ssrcs: e.map(e => {
                ...
                if (null != o) {
                    ...
                    o.ssrc !== t && (this.logger.info("Deleting inactive stream for user with mid: ".concat(i, ", type: ").concat(a, ", ssrc: ").concat(o.ssrc)), o = void 0, this.assignedStreams.delete(i))
                }
                let l = "audio" === a ? t : n,
                    c = this.inactiveTransceivers[a],
                    u = c.indexOf(i);
                return null == o && l.length > 0 && -1 !== u && (o = l.pop(), c.splice(u, 1), this.assignedStreams.set(i, o)), null == o && (o = {
                    ssrc: -1,
                    cname: ""
                }), {
                    ssrc: o.ssrc,
    ...
    async handleNegotiationNeeded() {
        ...
        this.audioSSRC = f, this.videoSSRC = p, this.videoReady = p > 0 && _ > 0, (this.videoStreamParameters[0].ssrc !== p || this.videoStreamParameters[0].rtxSsrc !== _ || this.videoReady) && (this.videoStreamParameters[0].ssrc = 0 === p ? this.videoStreamParameters[0].ssrc : p, this.videoStreamParameters[0].rtxSsrc = 0 === _ ? this.videoStreamParameters[0].rtxSsrc : _, this.videoStreamParameters[0].active = this.videoReady, this.emit(d.yq.Video, this.userId, this.input.getVideoStreamId(), this.audioSSRC, p, _, this.videoStreamParameters)), null == this.sdp ? this.emit(d.yq.Connected, "webrtc", (0, m.An)(l, this.experimentFlags.has(g.fd.BROWSER_HEVC))) : this.setRemoteAnswer(c, t, n, r)
    }
    constructor(e) {
        var t;
        super(e), y(this, "pc", void 0), y(this, "sdp", null), y(this, "negotiating", !1), y(this, "negotiationNeeded", !1), y(this, "audioTransceiver", void 0), y(this, "videoTransceiver", void 0), y(this, "users", new Map), y(this, "userIdsBySsrc", new Map), y(this, "assignedStreams", new Map), y(this, "unassignedStreams", {
            audio: [],
            video: []
        }), y(this, "inactiveTransceivers", {
            audio: [],
            video: []
        }), y(this, "trackUserIds", {}), y(this, "audioCodec", null), y(this, "audioPayloadType", null), y(this, "videoCodec", null), y(this, "videoPayloadType", null), y(this, "rtxPayloadType", null), y(this, "enableAudioNack", !1), y(this, "extensions", []), y(this, "codecs", []), y(this, "daveSessionManager", null), y(this, "logger", void 0), y(this, "getUserIdBySsrc", e => this.userIdsBySsrc.get(e)), y(this, "handlePeerConnectionStateChange", () => {
            ...
            switch (this.logger.info("peerConnectionState =>", e), e) {
                case "connected":
                    ...
                    break;
                case "connecting":
                    "connected" === this.iceConnectionState ? this.setConnectionState(g.$I.DTLS_CONNECTING) : this.setConnectionState(g.$I.ICE_CHECKING);
                    break;
                case "failed":
            ...
            if (!/^default/.test(n.id)) {
                ...
                if ((null == l || null == (i = l.videoSSRC) || null == (r = i.toString) ? void 0 : r.call(i)) !== o && (null == l || null == (s = l.audioSSRC) || null == (a = s.toString) ? void 0 : a.call(s)) !== o) return void this.logger.info("Got stale ssrc ".concat(o, " for ").concat(n.kind, " track, user ID ").concat(e));
        ...
        let n = e.dave;
        null == n || (0, h.o7)() || (this.logger.warn("DAVE is initialized but encoded transforms are not supported"), n = null), null != n && (this.daveSessionManager = new p.m(n, e.transientKeys, this.userId), this.daveSessionManager.on(d.yq.MLSFailure, (e, t) => {
