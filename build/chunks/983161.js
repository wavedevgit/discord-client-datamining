/** chunk id: 983161 params = (module,exports,require) **/
l.d(n, {
    default: () => I
});
var t = l(627968),
...
function I(e) {
    let {
        ...
        onDelete: H,
        onIconUpload: S
    } = e, [y, M] = a.useState(i?.title ?? ""), [E, K] = a.useState(i?.description ?? ""), [U, w] = a.useState(function(e) {
        if (null == e) return null;
        let n = x.A.getChannel(e.channelId);
        return null == n ? null : n.id
    }(i)), L = (0, c.bG)([k.A], () => k.A.getResourceChannel(i?.channelId)?.icon), R = (0, c.yK)([k.A], () => (k.A.getSettings()?.resourceChannels ?? []).map(e => e.channelId)), G = y.length < h.SM || null == U, J = a.useCallback(() => {
        null == U || y.length <= 0 || (f(_(U, y, E, L)), l())
    }, [f, l, y, U, L, E]), P = a.useCallback(() => {
        H?.(), l()
    }, [H, l]), T = a.useCallback(e => {
        w(e)
    }, [w]), W = a.useCallback(e => {
        let n = g.Ay.getSelectableChannels(I),
            l = p.A.getGuild(I);
        return Promise.resolve(n.filter(n => (0, h.Yt)(n.channel) && !R.includes(n.channel.id) && s()(e, (0, d.m1)(n.channel, C.default, v.A))).map(e => {
    ...
    }, [I, R]), z = a.useCallback(e => {
        null != S && null != U && S(_(U, y, E), e)
    }, [U, y, S, E]), B = a.useCallback(() => null == L || null == U ? null : j.Ay.getResourceChannelIconURL({
        channelId: U,
        icon: L
    }), [U, L]), O = a.useMemo(() => [{
        variant: "secondary",
