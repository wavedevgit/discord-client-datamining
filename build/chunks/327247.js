...
function w(e) {
    ...
    }, [$]), ei = (0, c.bG)([u.A], () => u.A.useReducedMotion), el = l.useCallback(() => {
    ...
    }, [t.id, n, I, b]), es = (0, c.bG)([h.A], () => null != h.A.questEnrollmentBlockedUntil, []), ea = p.t.useConfig({
        ...
        children: [(0, i.jsxs)(r.animated.div, {
            ...
            children: es ? (0, i.jsxs)(d.e2v, {
                ...
                children: [(0, i.jsx)(d.$nd, {
                    ...
                    fullWidth: !0,
                    onClick: el
                }), ea.enabled && (ee === y.UA.UNENROLLED || ee === y.UA.ENROLLED || ee === y.UA.INCOMPLETE) && ea.enabledQuestStates.has(ee) ? (0, i.jsx)(T.A, {
                    quest: t,
...
function k(e) {
    ...
    } = e, r = (0, c.bG)([h.A], () => h.A.isEnrolling(t.id)), o = (0, I.vv)(t), u = (0, I.Cr)(t), _ = (0, C.Ic)(t), m = (0, b._c)({
        progressState: n,
        quest: t,
        questContent: l,
        questContentPosition: s,
