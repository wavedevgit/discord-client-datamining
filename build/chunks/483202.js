...
class er extends l.PureComponent {
    ...
    handleClick = e => {
        ...
        let {
            ...
            isLurking: s,
            isForumToolbar: r
        } = this.props, o = U.A.getChannel(t.getChannelId());
    ...
    updateTooltipText = () => {
        let {
            ...
            emoji: t,
            type: i
        } = this.props, n = (0, J.i)(e, t, i), l = this.isKeyboardNavigation ? n : (0, J.i)(e, t, i, Q.tEg);
    ...
    renderLurkerModeUpsellPopout = e => {
        let {
            ...
            message: i,
            isLurking: l
        } = this.props, a = U.A.getChannel(i.getChannelId()), s = w.A.getGuild(a?.getGuildId());
        return l && null != s ? (0, n.jsx)(S.A, {
            ctaRef: this.ctaRef,
            type: S.w.REACTIONS,
            guild: s,
            closePopout: t
    ...
    trackReactionTooltipViewed = () => {
        let {
            ...
            message: t,
            type: i
        } = this.props, n = D.default.getCurrentUser(), l = U.A.getChannel(t.getChannelId()), a = i === $.v.BURST, s = (0, H.TW)(n), r = a ? q.e.EMOJI_IN_BURST_REACTION_HOVER : q.e.EMOJI_IN_REACTION_HOVER;
