...
function h(e) {
    let {
        ...
        isPreview: !0
    }), v = _.Ay.canUsePremiumProfileCustomization(t), j = null != n ? n : t.getAvatarURL(T, 80), y = (0, d.rdh)(o.A.unsafe_rawColors.PRIMARY_530).hex(), O = (0, c.rh)(j, y, !1);
    ...
    return (0, i.jsx)(A.A, {
        ...
        disabled: !v && !h,
        className: l()(p.__invalid_profileThemesSection, E),
        showPremiumIcon: f,
        forcedDivider: C,
