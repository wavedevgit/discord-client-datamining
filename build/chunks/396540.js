/** Chunk was on web.js **/
/** chunk id: 396540, original params: e,t,n (module,exports,require) **/
"use strict";
n.d(t, {
    A: () => u
});
...
class u {
    ...
    static extractTimeComponent(e, t) {
        ...
        if (n >= 12 && (a = r.FF.PM), null != t[c]) {
            ...
            e.match(/morgen|vormittag/) && (a = r.FF.AM, 12 == n && (n = 0)), e.match(/nachmittag|abend/) && (a = r.FF.PM, 12 != n && (n += 12)), e.match(/nacht/) && (12 == n ? (a = r.FF.AM, n = 0) : n < 6 ? a = r.FF.AM : (a = r.FF.PM, n += 12))
        }
