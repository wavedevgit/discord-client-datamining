...
let l = {
    show: !1,
    entrypoint: o.s4.NONE,
    lastShownEntrypoint: o.s4.NONE,
    activeViewType: null,
...
function c(e) {
    ...
    return l.show = !0, l.entrypoint = t, l.lastShownEntrypoint = t, l.closeReason = o.Se.DISMISSED, l.activeViewType = n, l.activeChannelId = i, l.initialState = r, !0
}
...
function u(e) {
    ...
    return l.show = !1, l.entrypoint = o.s4.NONE, l.closeReason = t, l.initialState = void 0, l.activeChannelId = null, !0
}
