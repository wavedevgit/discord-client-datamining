...
let ey = {
    ...
    eb = {
        [eD.kqX.GIFTING_PROMOTION_REMINDER]: o.M.GIFTING_PROMOTION_REMINDER
    },
    ek = {
    ...
    ej = {
        [eD.kqX.OUTBOUND_PROMOTION]: o.M.THIRD_PARTY_OUTBOUND_PROMO_NAGBAR
    },
    eG = {
    ...
    eF = new Set([eD.kqX.NO_INPUT_DETECTED, eD.kqX.NO_INPUT_DEVICES_DETECTED, eD.kqX.STREAMER_MODE, eD.kqX.VIDEO_UNSUPPORTED_BROWSER, eD.kqX.SPOTIFY_AUTO_PAUSED, eD.kqX.DISPATCH_ERROR, eD.kqX.DISPATCH_ERROR, eD.kqX.DISPATCH_INSTALL_SCRIPT_PROGRESS, eD.kqX.WINDOWS_MEDIA_PACK_REQUIRED]),
    eH = {},
    eB = {},
    ew = Object.freeze({
        id: null,
...
function eq(e, t, n) {
    if (null == e) return;
    let i = eG[e];
    (null == i || t || c.w.set(i, !0), eF.has(e) && (eH[e] = !0), null != n && null != i) ? c.w.set(eX(e), n.format("YYYY-MM-DDTHH:mm:ss.SSSZ")): c.w.remove(eX(e))
}
let eK = null;
...
function eW(e) {
    ...
    let i = eG[e];
    if (null != i) {
        let t, n = null != (t = c.w.get(eX(e))) ? r()(t) : null;
        if (null != n) return n?.isAfter(r()())
    }
    let s = eH[e];
    return !!s || (null != i && "" !== i ? c.w.get(i) : !!eF.has(e) && s)
}
let eJ = [eD.kqX.QUARANTINED, eD.kqX.AUTOMOD_QUARANTINED_USER_PROFILE, eD.kqX.VIEWING_ROLES, eD.kqX.INVITED_TO_SPEAK, eD.kqX.LURKING_GUILD, eD.kqX.VOICE_DISABLED, eD.kqX.NO_INPUT_DEVICES_DETECTED, eD.kqX.NO_INPUT_DETECTED, eD.kqX.PTT_NO_KEYBIND_WARNING, eD.kqX.HARDWARE_MUTE, eD.kqX.DISPATCH_ERROR, eD.kqX.DISPATCH_INSTALL_SCRIPT_PROGRESS, eD.kqX.SPOTIFY_AUTO_PAUSED, eD.kqX.WIN32_DEPRECATED_MESSAGE, eD.kqX.WIN7_8_DEPRECATED_MESSAGE, eD.kqX.WIN_COMPAT_MODE_MESSAGE, eD.kqX.MACOS_19_DEPRECATED_MESSAGE, eD.kqX.E2EE_UPDATE_REQUIRED, eD.kqX.WINDOWS_MEDIA_PACK_REQUIRED, eD.kqX.VOICE_CONNECTED_LAST_SESSION, eD.kqX.SYSTEM_SERVICE_WARNING, eD.kqX.AUTO_MODERATION_MENTION_RAID_DETECTION, eD.kqX.GUILD_RAID_NOTIFICATION, eD.kqX.GIFTING_PROMOTION_REMINDER, eD.kqX.RIOT_MIGRATION, eD.kqX.RIOT_CONNECTION_DEPRECATION_ADMIN, eD.kqX.QUESTS_PROGRESS_INTERRUPTION, eD.kqX.UNCLAIMED_ACCOUNT, eD.kqX.PENDING_MEMBER, eD.kqX.CHECKOUT_RECOVERY_NAGBAR, eD.kqX.PREMIUM_MARKETING_NAGBAR, eD.kqX.OUTBOUND_PROMOTION, eD.kqX.CORRUPT_INSTALLATION, eD.kqX.VIDEO_UNSUPPORTED_BROWSER, eD.kqX.DETECTED_OFF_PLATFORM_PREMIUM_PERK, eD.kqX.DETECTED_OFF_PLATFORM_PREMIUM_PERK_UPSELL, eD.kqX.STREAMER_MODE, eD.kqX.SCHEDULED_MAINTENANCE, eD.kqX.BOUNCED_EMAIL_DETECTED, eD.kqX.UNVERIFIED_ACCOUNT, eD.kqX.PREMIUM_TIER_2_TRIAL_ENDING, eD.kqX.PREMIUM_TIER_2_DISCOUNT_ENDING, eD.kqX.PREMIUM_TIER_0_TRIAL_ENDING, eD.kqX.PREMIUM_UNCANCEL, eD.kqX.PREMIUM_MISSING_PAYMENT, eD.kqX.PREMIUM_PAST_DUE_INVALID_PAYMENT, eD.kqX.PREMIUM_PAST_DUE_MISSING_PAYMENT, eD.kqX.PREMIUM_PAST_DUE_ONE_TIME_PAYMENT, eD.kqX.PREMIUM_REACTIVATE, eD.kqX.PASSKEY_BACKUP, eD.kqX.APPLICATION_TEST_MODE, eD.kqX.QUEST_APP_UPSELL, eD.kqX.DOWNLOAD_NAG, eD.kqX.CONNECT_SPOTIFY, eD.kqX.CONNECT_PLAYSTATION, eD.kqX.SURVEY, eD.kqX.BLOCK_USER_FEEDBACK_NAGBAR, eD.kqX.IGNORE_USER_FEEDBACK_NAGBAR];
eD.kqX.QUARANTINED, eD.kqX.AUTOMOD_QUARANTINED_USER_PROFILE, eD.kqX.VIEWING_ROLES, eD.kqX.INVITED_TO_SPEAK, eD.kqX.LURKING_GUILD, eD.kqX.VOICE_DISABLED, eD.kqX.NO_INPUT_DETECTED, eD.kqX.HARDWARE_MUTE, eD.kqX.DISPATCH_ERROR, eD.kqX.DISPATCH_INSTALL_SCRIPT_PROGRESS, eD.kqX.SPOTIFY_AUTO_PAUSED, eD.kqX.VOICE_CONNECTED_LAST_SESSION, eD.kqX.PENDING_MEMBER, eD.kqX.STREAMER_MODE, eD.kqX.SCHEDULED_MAINTENANCE;
let ez = {
    [eD.kqX.GIFTING_PROMOTION_REMINDER]: {
        predicate: () => (0, y.MD)()
    },
    ...
    [eD.kqX.PTT_NO_KEYBIND_WARNING]: {
        predicate: () => !!eo.A.isConnected() && er.Ay.getMode() === eD.TBI.PUSH_TO_TALK && !(er.Ay.getSettings().modeOptions.shortcut.length > 0) && !!K.A.getConfig({
    ...
    [eD.kqX.PENDING_MEMBER]: {
        predicate: e => {
            ...
            return (null != t && null != n && !ei.A.getGuild(t)?.features.has(eD.GuildFeatures.GUILD_ONBOARDING) && et.Ay.getMember(t, n.id)?.isPending) ?? !1
        }
    },
    ...
    [eD.kqX.VIDEO_UNSUPPORTED_BROWSER]: {
        predicate: e => {
            ...
            return null != t && eI.A.hasVideo(t) && !er.Ay.supports(ev.O5.VIDEO) && !eW(eD.kqX.VIDEO_UNSUPPORTED_BROWSER)
        }
    },
    ...
    [eD.kqX.DETECTED_OFF_PLATFORM_PREMIUM_PERK_UPSELL]: {
        predicate: () => !eW(eD.kqX.DETECTED_OFF_PLATFORM_PREMIUM_PERK_UPSELL) && ee.A.getDetectedOffPlatformPremiumPerks().length > 0,
        metadata: () => ee.A.getDetectedOffPlatformPremiumPerks()[0]
    },
    ...
    [eD.kqX.DOWNLOAD_NAG]: {
        predicate: () => !eh.isPlatformEmbedded && !eW(eD.kqX.DOWNLOAD_NAG)
    },
    [eD.kqX.QUEST_APP_UPSELL]: {
        predicate: () => (0, eh.isOculusWeb)() && !eW(eD.kqX.QUEST_APP_UPSELL) && G.A.getConfig({
            location: "NoticeStore"
        }).enabled
    },
    ...
    [eD.kqX.SURVEY]: {
        predicate: () => null != eE.Ay.getCurrentSurvey(),
        metadata: () => eE.Ay.getCurrentSurvey()
    },
    ...
    [eD.kqX.CONNECT_SPOTIFY]: {
        predicate: () => !B.A.hasConnectedAccount() && h.Ay.isObservedAppRunning(_.A.get(eD.fg2.SPOTIFY).name) && !eW(eD.kqX.CONNECT_SPOTIFY)
    },
    ...
    [eD.kqX.CONNECT_PLAYSTATION]: {
        predicate: () => $.A.isSuggestedAccountType(eD.fg2.PLAYSTATION) && null == $.A.getAccount(null, eD.fg2.PLAYSTATION) && !eW(eD.kqX.CONNECT_PLAYSTATION)
    },
    ...
    [eD.kqX.PREMIUM_TIER_2_TRIAL_ENDING]: {
        predicate: () => eg.A.getAlmostExpiringTrialOffersForReminder([eU.pe.TIER_2]).length > 0 && !eW(eD.kqX.PREMIUM_TIER_2_TRIAL_ENDING)
    },
    [eD.kqX.PREMIUM_TIER_0_TRIAL_ENDING]: {
        predicate: () => eg.A.getAlmostExpiringTrialOffersForReminder([eU.pe.TIER_0]).length > 0 && !eW(eD.kqX.PREMIUM_TIER_0_TRIAL_ENDING)
    },
    [eD.kqX.PREMIUM_TIER_2_DISCOUNT_ENDING]: {
        predicate: () => eg.A.getAlmostExpiringDiscountOffersForReminder([eU.pe.TIER_2]).length > 0 && !eW(eD.kqX.PREMIUM_TIER_2_DISCOUNT_ENDING)
    },
    [eD.kqX.PREMIUM_UNCANCEL]: {
        ...
        metadata: e => {
            let {
                premiumSubscription: t
            } = e, n = null != t ? r()(t.currentPeriodEnd).diff(r()().startOf("day"), "days") : 0, i = null != t ? (0, eS.EL)(t)?.planId : null;
            return {
                daysLeft: n,
                premiumType: null != i ? eS.Ay.getPremiumType(i) : null,
                premiumSubscription: t
            }
        }
    },
    ...
    [eD.kqX.PREMIUM_PAST_DUE_MISSING_PAYMENT]: {
        predicate: e => {
            let {
                premiumSubscription: t,
                currentUser: n
            } = e, i = null != t && r()(t.currentPeriodEnd).isBefore(r()()), s = null != t && t.status === eD.Dmq.PAST_DUE && !i && null === t.paymentSourceId && !n.hasFreePremium() && !t.isPurchasedExternally;
    ...
    [eD.kqX.AUTO_MODERATION_MENTION_RAID_DETECTION]: {
        predicate: e => {
            let {
                selectedGuildId: t
            } = e, n = null != t ? ei.A.getGuild(t) : null;
            return null != t && null != D.A.getMentionRaidDetected(t) && n?.features.has(eD.GuildFeatures.COMMUNITY) && !eW(eD.kqX.AUTO_MODERATION_MENTION_RAID_DETECTION) || !1
        },
        metadata: e => {
            let {
                selectedGuildId: t
    ...
    [eD.kqX.SYSTEM_SERVICE_WARNING]: {
        predicate: e => {
            ...
            if (eW(eD.kqX.SYSTEM_SERVICE_WARNING) || !(0, V.yA)(h.Ay) || null == t || er.Ay.getMode() !== eD.TBI.PUSH_TO_TALK) return !1;
    ...
    [eD.kqX.WINDOWS_MEDIA_PACK_REQUIRED]: {
        predicate: () => !(!eh.isPlatformEmbedded || d.A?.process.platform !== "win32" || eW(eD.kqX.WINDOWS_MEDIA_PACK_REQUIRED) || eR.Ay.getEnableHardwareAcceleration()) && !1 === er.Ay.isH264MfDecodeAvailable()
    },
    [eD.kqX.RIOT_MIGRATION]: {
        predicate: () => {
            ...
            if (eW(eD.kqX.RIOT_MIGRATION) || (0, T.k8)(o.M.RIOT_CONNECTION_DEPRECATION_DISABLE) || !e && !t) return !1;
...
let e0 = new e$(u.h, {
    ...
    VOICE_STATE_UPDATES: function(e) {
        ...
        return (eV?.type === eD.kqX.INVITED_TO_SPEAK || t.some(e => {
            let {
                userId: t
            } = e;
