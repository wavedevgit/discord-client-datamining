...
let ej = {
    ...
    eB = new Set([eP.kqX.NO_INPUT_DETECTED, eP.kqX.NO_INPUT_DEVICES_DETECTED, eP.kqX.STREAMER_MODE, eP.kqX.VIDEO_UNSUPPORTED_BROWSER, eP.kqX.SPOTIFY_AUTO_PAUSED, eP.kqX.DISPATCH_ERROR, eP.kqX.DISPATCH_ERROR, eP.kqX.DISPATCH_INSTALL_SCRIPT_PROGRESS, eP.kqX.WINDOWS_MEDIA_PACK_REQUIRED]),
    eX = {},
    eV = {},
    eq = Object.freeze({
        id: null,
...
function eW(e, t, n) {
    if (null == e) return;
    let i = ew[e];
    (null == i || t || c.w.set(i, !0), eB.has(e) && (eX[e] = !0), null != n && null != i) ? c.w.set(eY(e), n.format("YYYY-MM-DDTHH:mm:ss.SSSZ")): c.w.remove(eY(e))
}
let eJ = null;
...
let e$ = {
    ...
    [eP.kqX.VOICE_DISABLED]: {
        predicate: () => null != eu.A.getRemoteDisconnectVoiceChannelId()
    },
    [eP.kqX.VOICE_CONNECTED_LAST_SESSION]: {
        predicate: () => null != eu.A.getLastSessionVoiceChannelId()
    },
    ...
    [eP.kqX.HARDWARE_MUTE]: {
        predicate: () => eu.A.isConnected() && es.Ay.isHardwareMute() && es.Ay.isHardwareMuteNoticeEnabled() && !K.Ay.disableHardwareMuteSilenceAlert,
        metadata: () => {
    ...
    [eP.kqX.PTT_NO_KEYBIND_WARNING]: {
        predicate: () => !!eu.A.isConnected() && es.Ay.getMode() === eP.TBI.PUSH_TO_TALK && !(es.Ay.getSettings().modeOptions.shortcut.length > 0) && !!W.A.getConfig({
    ...
    [eP.kqX.PENDING_MEMBER]: {
        predicate: e => {
            ...
            return (null != t && null != n && !el.A.getGuild(t)?.features.has(eP.GuildFeatures.GUILD_ONBOARDING) && ei.Ay.getMember(t, n.id)?.isPending) ?? !1
        }
    },
    ...
    [eP.kqX.VIDEO_UNSUPPORTED_BROWSER]: {
        predicate: e => {
            ...
            return null != t && eg.A.hasVideo(t) && !es.Ay.supports(ek.O5.VIDEO) && !eQ(eP.kqX.VIDEO_UNSUPPORTED_BROWSER)
        }
    },
    ...
    [eP.kqX.DETECTED_OFF_PLATFORM_PREMIUM_PERK_UPSELL]: {
        predicate: () => !eQ(eP.kqX.DETECTED_OFF_PLATFORM_PREMIUM_PERK_UPSELL) && en.A.getDetectedOffPlatformPremiumPerks().length > 0,
        metadata: () => en.A.getDetectedOffPlatformPremiumPerks()[0]
    },
    ...
    [eP.kqX.DOWNLOAD_NAG]: {
        predicate: () => !eR.isPlatformEmbedded && !eQ(eP.kqX.DOWNLOAD_NAG)
    },
    [eP.kqX.QUEST_APP_UPSELL]: {
        predicate: () => (0, eR.isOculusWeb)() && !eQ(eP.kqX.QUEST_APP_UPSELL) && H.A.getConfig({
            location: "NoticeStore"
        }).enabled
    },
    ...
    [eP.kqX.SURVEY]: {
        predicate: () => null != em.Ay.getCurrentSurvey(),
        metadata: () => em.Ay.getCurrentSurvey()
    },
    ...
    [eP.kqX.CONNECT_SPOTIFY]: {
        predicate: () => !X.A.hasConnectedAccount() && h.Ay.isObservedAppRunning(_.A.get(eP.fg2.SPOTIFY).name) && !eQ(eP.kqX.CONNECT_SPOTIFY)
    },
    ...
    [eP.kqX.CONNECT_PLAYSTATION]: {
        predicate: () => et.A.isSuggestedAccountType(eP.fg2.PLAYSTATION) && null == et.A.getAccount(null, eP.fg2.PLAYSTATION) && !eQ(eP.kqX.CONNECT_PLAYSTATION)
    },
    ...
    [eP.kqX.PREMIUM_TIER_2_TRIAL_ENDING]: {
        predicate: () => eC.A.getAlmostExpiringTrialOffersForReminder([eL.pe.TIER_2]).length > 0 && !eQ(eP.kqX.PREMIUM_TIER_2_TRIAL_ENDING)
    },
    [eP.kqX.PREMIUM_TIER_0_TRIAL_ENDING]: {
        predicate: () => eC.A.getAlmostExpiringTrialOffersForReminder([eL.pe.TIER_0]).length > 0 && !eQ(eP.kqX.PREMIUM_TIER_0_TRIAL_ENDING)
    },
    [eP.kqX.PREMIUM_TIER_2_DISCOUNT_ENDING]: {
        predicate: () => eC.A.getAlmostExpiringDiscountOffersForReminder([eL.pe.TIER_2]).length > 0 && !eQ(eP.kqX.PREMIUM_TIER_2_DISCOUNT_ENDING)
    },
    [eP.kqX.PREMIUM_UNCANCEL]: {
        predicate: e => {
            let {
                ...
                currentUser: n
            } = e, i = null != t ? r()(t.currentPeriodEnd).diff(r()().startOf("day"), "days") : 0, l = t?.canceledAt != null && t?.status === eP.Dmq.CANCELED && 1 >= r()().diff(r()(t.canceledAt), "days"), s = null != t && r()(t.currentPeriodEnd).isBefore(r()()), a = null != t && t.status === eP.Dmq.CANCELED && !s && i <= 7 && i >= 0 && (0, ex.YE)(n, eL.PremiumTypes.TIER_2) && !l && !n.hasFreePremium() && !t.isPurchasedExternally;
            return !eQ(eP.kqX.PREMIUM_UNCANCEL) && a
        },
        metadata: e => {
            let {
                premiumSubscription: t
            } = e, n = null != t ? r()(t.currentPeriodEnd).diff(r()().startOf("day"), "days") : 0, i = null != t ? (0, ex.EL)(t)?.planId : null;
            return {
                daysLeft: n,
                premiumType: null != i ? ex.Ay.getPremiumType(i) : null,
                premiumSubscription: t
            }
        }
    },
    [eP.kqX.PREMIUM_MISSING_PAYMENT]: {
        predicate: e => {
            let {
                premiumSubscription: t,
                currentUser: n
            } = e, i = null != t ? r()(t.currentPeriodEnd).diff(r()().startOf("day"), "days") : 0, l = null != t ? r()(t.currentPeriodEnd).diff(r()(t.currentPeriodStart).startOf("day"), "days") : 0, s = null != t && r()(t.currentPeriodEnd).isBefore(r()()), a = ep.A.applicationIdsFetched.has(eL.tv), o = ep.A.getForApplication(eL.tv), c = null != t ? (0, ex.EL)(t) : null, u = null != c ? ex.Ay.getSkuIdForPlan(c.planId) : null, d = null != o && null != c && Array.from(o).filter(e => {
                let {
                    skuId: t,
                    consumed: n
                } = e;
                return !n && t === u
            }).length > 0, _ = null != t && i <= (l > 14 ? 7 : 2) && i >= 0 && t.status !== eP.Dmq.PAST_DUE && !s && a && !d && null === t.paymentSourceId && !n.hasFreePremium() && !t.isPurchasedExternally;
    ...
    [eP.kqX.PREMIUM_PAST_DUE_INVALID_PAYMENT]: {
        predicate: e => {
            let {
                premiumSubscription: t,
                currentUser: n
            } = e, i = null != t && null != t.paymentSourceId ? eN.A.getPaymentSource(t.paymentSourceId) : null, l = null != t && r()(t.currentPeriodEnd).isBefore(r()()), s = null != t && t.status === eP.Dmq.PAST_DUE && !l && null != i && i.invalid && !n.hasFreePremium() && !t.isPurchasedExternally;
    ...
    [eP.kqX.PREMIUM_PAST_DUE_MISSING_PAYMENT]: {
        predicate: e => {
            let {
                premiumSubscription: t,
                currentUser: n
            } = e, i = null != t && r()(t.currentPeriodEnd).isBefore(r()()), l = null != t && t.status === eP.Dmq.PAST_DUE && !i && null === t.paymentSourceId && !n.hasFreePremium() && !t.isPurchasedExternally;
    ...
    [eP.kqX.PREMIUM_PAST_DUE_ONE_TIME_PAYMENT]: {
        predicate: e => {
            let {
                premiumSubscription: t,
                currentUser: n
            } = e, i = null != t && r()(t.currentPeriodEnd).isBefore(r()()), l = null != t && null != t.paymentSourceId ? eN.A.getPaymentSource(t.paymentSourceId) : null, s = null != l && ey.AD.has(l.type), a = null != t && t.status === eP.Dmq.PAST_DUE && !i && s && !n.hasFreePremium() && !t.isPurchasedExternally;
    ...
    [eP.kqX.AUTO_MODERATION_MENTION_RAID_DETECTION]: {
        predicate: e => {
            let {
                selectedGuildId: t
            } = e, n = null != t ? el.A.getGuild(t) : null;
            return null != t && null != D.A.getMentionRaidDetected(t) && n?.features.has(eP.GuildFeatures.COMMUNITY) && !eQ(eP.kqX.AUTO_MODERATION_MENTION_RAID_DETECTION) || !1
        },
        metadata: e => {
            let {
                selectedGuildId: t
    ...
    [eP.kqX.QUESTS_PROGRESS_INTERRUPTION]: {
        ...
        metadata: () => {
            let e = z.A.getCurrentUserActiveStream();
            return {
                streamKey: null != e ? (0, R._z)(e) : null
            }
        }
    },
    ...
    [eP.kqX.PREMIUM_GROUP_PRIMARY_REMINDER_NAGBAR]: {
        predicate: e => {
            let {
                currentUser: t
            } = e, n = ef.A.getPremiumGroupSubscription();
            if (null == n) return !1;
        ...
        metadata: () => ({
            premiumSubscription: ef.A.getPremiumGroupSubscription()
        })
    },
    ...
    [eP.kqX.SYSTEM_SERVICE_WARNING]: {
        predicate: e => {
            ...
            if (eQ(eP.kqX.SYSTEM_SERVICE_WARNING) || !(0, q.yA)(h.Ay) || null == t || es.Ay.getMode() !== eP.TBI.PUSH_TO_TALK) return !1;
    ...
    [eP.kqX.WINDOWS_MEDIA_PACK_REQUIRED]: {
        predicate: () => !(!eR.isPlatformEmbedded || d.A?.process.platform !== "win32" || eQ(eP.kqX.WINDOWS_MEDIA_PACK_REQUIRED) || eO.Ay.getEnableHardwareAcceleration()) && !1 === es.Ay.isH264MfDecodeAvailable()
    },
    [eP.kqX.RIOT_MIGRATION]: {
        predicate: () => {
            ...
            if (eQ(eP.kqX.RIOT_MIGRATION) || (0, T.k8)(o.M.RIOT_CONNECTION_DEPRECATION_DISABLE) || !e && !t) return !1;
    ...
    [eP.kqX.RIOT_CONNECTION_DEPRECATION_ADMIN]: {
        predicate: e => {
            ...
            if (!A.A.getConfig({
                    location: "NoticeStore"
                }).enabled || eQ(eP.kqX.RIOT_CONNECTION_DEPRECATION_ADMIN) || (0, T.k8)(o.M.RIOT_CONNECTION_DEPRECATION_ADMIN_DISABLE)) return !1;
            let i = null != n ? el.A.getGuild(n) : null,
                r = (0, eS.$3)({
                    permission: eP.xBc.ADMINISTRATOR,
                    user: t,
                    context: i
                }),
...
function e0() {
    ...
    for (let l of eZ)
        ...
        eK.metadata?.sampleRate != null && null == eV[eK.type] && (eV[eK.type] = Math.random() <= eK.metadata.sampleRate);
        let e = !1 === eV[eK.type];
...
class e7 extends s.Ay.Store {
    ...
    initialize() {
        this.syncWith([C.A, em.Ay, ec.A, en.A, e_.A, G.A, eC.A, Z.default, et.A, Y.A, O.A, w.A, z.A, h.Ay, J.A, C.A, I.A], e0), this.waitFor(C.A, m.A, z.A, Q.default, Z.default, $.A, ee.A, L.A, et.A, en.A, eM.A, eD.A, eU.A, ep.A, p.A, S.A, D.A, O.A, ei.Ay, I.A, er.A, el.A, U.A, P.A, es.Ay, ea.A, eN.A, eo.A, y.A, ec.A, G.A, w.A, eu.A, h.Ay, ed.A, e_.A, X.A, eA.A, eE.A, v.A, ef.A, em.Ay, eh.A, K.Ay, eC.A, eI.A, Y.A, eT.default, eg.A, J.A)
    }
    hasNotice() {
...
let e2 = new e7(u.h, {
    ...
    VOICE_STATE_UPDATES: function(e) {
        ...
        return (eK?.type === eP.kqX.INVITED_TO_SPEAK || t.some(e => {
            let {
                userId: t
            } = e;
