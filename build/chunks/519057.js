...
let eO = {
    ...
    eL = new Set([eC.kqX.NO_INPUT_DETECTED, eC.kqX.NO_INPUT_DEVICES_DETECTED, eC.kqX.STREAMER_MODE, eC.kqX.VIDEO_UNSUPPORTED_BROWSER, eC.kqX.SPOTIFY_AUTO_PAUSED, eC.kqX.DISPATCH_ERROR, eC.kqX.DISPATCH_ERROR, eC.kqX.DISPATCH_INSTALL_SCRIPT_PROGRESS, eC.kqX.WINDOWS_MEDIA_PACK_REQUIRED]),
    ev = {},
    ey = {},
    ej = Object.freeze({
        id: null,
...
function eG(e, t, n) {
    if (null == e) return;
    let i = eP[e];
    (null == i || t || o.w.set(i, !0), eL.has(e) && (ev[e] = !0), null != n && null != i) ? o.w.set(eb(e), n.format("YYYY-MM-DDTHH:mm:ss.SSSZ")): o.w.remove(eb(e))
}
let eH = null;
...
function ew(e) {
    ...
    let n = eP[e];
    if (null != n) {
        let t, n = null != (t = o.w.get(eb(e))) ? r()(t) : null;
        if (null != n) return n?.isAfter(r()())
    }
    let i = ev[e];
    return !!i || (null != n && "" !== n ? o.w.get(n) : !!eL.has(e) && i)
}
let eB = [eC.kqX.QUARANTINED, eC.kqX.AUTOMOD_QUARANTINED_USER_PROFILE, eC.kqX.VIEWING_ROLES, eC.kqX.INVITED_TO_SPEAK, eC.kqX.LURKING_GUILD, eC.kqX.VOICE_DISABLED, eC.kqX.NO_INPUT_DEVICES_DETECTED, eC.kqX.NO_INPUT_DETECTED, eC.kqX.PTT_NO_KEYBIND_WARNING, eC.kqX.HARDWARE_MUTE, eC.kqX.DISPATCH_ERROR, eC.kqX.DISPATCH_INSTALL_SCRIPT_PROGRESS, eC.kqX.SPOTIFY_AUTO_PAUSED, eC.kqX.WIN32_DEPRECATED_MESSAGE, eC.kqX.WIN7_8_DEPRECATED_MESSAGE, eC.kqX.WIN_COMPAT_MODE_MESSAGE, eC.kqX.MACOS_19_DEPRECATED_MESSAGE, eC.kqX.E2EE_UPDATE_REQUIRED, eC.kqX.WINDOWS_MEDIA_PACK_REQUIRED, eC.kqX.VOICE_CONNECTED_LAST_SESSION, eC.kqX.SYSTEM_SERVICE_WARNING, eC.kqX.AUTO_MODERATION_MENTION_RAID_DETECTION, eC.kqX.GUILD_RAID_NOTIFICATION, eC.kqX.GIFTING_PROMOTION_REMINDER, eC.kqX.QUESTS_PROGRESS_INTERRUPTION, eC.kqX.UNCLAIMED_ACCOUNT, eC.kqX.PENDING_MEMBER, eC.kqX.CHECKOUT_RECOVERY_NAGBAR, eC.kqX.PREMIUM_MARKETING_NAGBAR, eC.kqX.OUTBOUND_PROMOTION, eC.kqX.CORRUPT_INSTALLATION, eC.kqX.VIDEO_UNSUPPORTED_BROWSER, eC.kqX.DETECTED_OFF_PLATFORM_PREMIUM_PERK, eC.kqX.DETECTED_OFF_PLATFORM_PREMIUM_PERK_UPSELL, eC.kqX.STREAMER_MODE, eC.kqX.SCHEDULED_MAINTENANCE, eC.kqX.BOUNCED_EMAIL_DETECTED, eC.kqX.UNVERIFIED_ACCOUNT, eC.kqX.PREMIUM_TIER_2_TRIAL_ENDING, eC.kqX.PREMIUM_TIER_2_DISCOUNT_ENDING, eC.kqX.PREMIUM_TIER_0_TRIAL_ENDING, eC.kqX.PREMIUM_UNCANCEL, eC.kqX.PREMIUM_MISSING_PAYMENT, eC.kqX.PREMIUM_PAST_DUE_INVALID_PAYMENT, eC.kqX.PREMIUM_PAST_DUE_MISSING_PAYMENT, eC.kqX.PREMIUM_PAST_DUE_ONE_TIME_PAYMENT, eC.kqX.PREMIUM_REACTIVATE, eC.kqX.PASSKEY_BACKUP, eC.kqX.APPLICATION_TEST_MODE, eC.kqX.QUEST_APP_UPSELL, eC.kqX.DOWNLOAD_NAG, eC.kqX.CONNECT_SPOTIFY, eC.kqX.CONNECT_PLAYSTATION, eC.kqX.SURVEY, eC.kqX.BLOCK_USER_FEEDBACK_NAGBAR, eC.kqX.IGNORE_USER_FEEDBACK_NAGBAR];
eC.kqX.QUARANTINED, eC.kqX.AUTOMOD_QUARANTINED_USER_PROFILE, eC.kqX.VIEWING_ROLES, eC.kqX.INVITED_TO_SPEAK, eC.kqX.LURKING_GUILD, eC.kqX.VOICE_DISABLED, eC.kqX.NO_INPUT_DETECTED, eC.kqX.HARDWARE_MUTE, eC.kqX.DISPATCH_ERROR, eC.kqX.DISPATCH_INSTALL_SCRIPT_PROGRESS, eC.kqX.SPOTIFY_AUTO_PAUSED, eC.kqX.VOICE_CONNECTED_LAST_SESSION, eC.kqX.PENDING_MEMBER, eC.kqX.STREAMER_MODE, eC.kqX.SCHEDULED_MAINTENANCE;
let eV = {
    [eC.kqX.GIFTING_PROMOTION_REMINDER]: {
        predicate: () => (0, D.MD)()
    },
    ...
    [eC.kqX.VOICE_DISABLED]: {
        predicate: () => null != en.A.getRemoteDisconnectVoiceChannelId()
    },
    [eC.kqX.VOICE_CONNECTED_LAST_SESSION]: {
        predicate: () => null != en.A.getLastSessionVoiceChannelId()
    },
    [eC.kqX.NO_INPUT_DETECTED]: {
        predicate: () => I.A.hasActiveErrorOfType(m.iy.NO_AUDIO_INPUT_DETECTED)
    },
    [eC.kqX.NO_INPUT_DEVICES_DETECTED]: {
        predicate: () => I.A.hasActiveErrorOfType(m.iy.NO_INPUT_DEVICES)
    },
    [eC.kqX.HARDWARE_MUTE]: {
        predicate: () => en.A.isConnected() && Z.Ay.isHardwareMute() && Z.Ay.isHardwareMuteNoticeEnabled() && !H.Ay.disableHardwareMuteSilenceAlert,
        metadata: () => {
    ...
    [eC.kqX.PTT_NO_KEYBIND_WARNING]: {
        predicate: () => !!en.A.isConnected() && Z.Ay.getMode() === eC.TBI.PUSH_TO_TALK && !(Z.Ay.getSettings().modeOptions.shortcut.length > 0) && !!w.A.getConfig({
    ...
    [eC.kqX.PENDING_MEMBER]: {
        predicate: e => {
            ...
            return (null != t && null != n && !Q.A.getGuild(t)?.features.has(eC.GuildFeatures.GUILD_ONBOARDING) && z.Ay.getMember(t, n.id)?.isPending) ?? !1
        }
    },
    ...
    [eC.kqX.VIDEO_UNSUPPORTED_BROWSER]: {
        predicate: e => {
            ...
            return null != t && eu.A.hasVideo(t) && !Z.Ay.supports(ex.O5.VIDEO) && !ew(eC.kqX.VIDEO_UNSUPPORTED_BROWSER)
        }
    },
    ...
    [eC.kqX.DETECTED_OFF_PLATFORM_PREMIUM_PERK_UPSELL]: {
        predicate: () => !ew(eC.kqX.DETECTED_OFF_PLATFORM_PREMIUM_PERK_UPSELL) && J.A.getDetectedOffPlatformPremiumPerks().length > 0,
        metadata: () => J.A.getDetectedOffPlatformPremiumPerks()[0]
    },
    [eC.kqX.STREAMER_MODE]: {
        predicate: () => el.A.enabled
    },
    [eC.kqX.DOWNLOAD_NAG]: {
        predicate: () => !eI.isPlatformEmbedded && !ew(eC.kqX.DOWNLOAD_NAG)
    },
    [eC.kqX.QUEST_APP_UPSELL]: {
        predicate: () => (0, eI.isOculusWeb)() && !ew(eC.kqX.QUEST_APP_UPSELL) && v.A.getConfig({
            location: "NoticeStore"
        }).enabled
    },
    ...
    [eC.kqX.SURVEY]: {
        predicate: () => null != ea.Ay.getCurrentSurvey(),
        metadata: () => ea.Ay.getCurrentSurvey()
    },
    ...
    [eC.kqX.CONNECT_SPOTIFY]: {
        predicate: () => !k.A.hasConnectedAccount() && g.Ay.isObservedAppRunning(_.A.get(eC.fg2.SPOTIFY).name) && !ew(eC.kqX.CONNECT_SPOTIFY)
    },
    ...
    [eC.kqX.CONNECT_PLAYSTATION]: {
        predicate: () => W.A.isSuggestedAccountType(eC.fg2.PLAYSTATION) && null == W.A.getAccount(null, eC.fg2.PLAYSTATION) && !ew(eC.kqX.CONNECT_PLAYSTATION)
    },
    ...
    [eC.kqX.PREMIUM_TIER_2_TRIAL_ENDING]: {
        predicate: () => eE.A.getAlmostExpiringTrialOffersForReminder([eh.pe.TIER_2]).length > 0 && !ew(eC.kqX.PREMIUM_TIER_2_TRIAL_ENDING)
    },
    [eC.kqX.PREMIUM_TIER_0_TRIAL_ENDING]: {
        predicate: () => eE.A.getAlmostExpiringTrialOffersForReminder([eh.pe.TIER_0]).length > 0 && !ew(eC.kqX.PREMIUM_TIER_0_TRIAL_ENDING)
    },
    [eC.kqX.PREMIUM_TIER_2_DISCOUNT_ENDING]: {
        predicate: () => eE.A.getAlmostExpiringDiscountOffersForReminder([eh.pe.TIER_2]).length > 0 && !ew(eC.kqX.PREMIUM_TIER_2_DISCOUNT_ENDING)
    },
    [eC.kqX.PREMIUM_UNCANCEL]: {
        predicate: e => {
            let {
                ...
                currentUser: n
            } = e, i = null != t ? r()(t.currentPeriodEnd).diff(r()().startOf("day"), "days") : 0, s = t?.canceledAt != null && t?.status === eC.Dmq.CANCELED && 1 >= r()().diff(r()(t.canceledAt), "days"), l = null != t && r()(t.currentPeriodEnd).isBefore(r()()), a = null != t && t.status === eC.Dmq.CANCELED && !l && i <= 7 && i >= 0 && (0, eT.YE)(n, eh.PremiumTypes.TIER_2) && !s && !n.hasFreePremium() && !t.isPurchasedExternally;
            return !ew(eC.kqX.PREMIUM_UNCANCEL) && a
        },
        metadata: e => {
            let {
                premiumSubscription: t
            } = e, n = null != t ? r()(t.currentPeriodEnd).diff(r()().startOf("day"), "days") : 0, i = null != t ? (0, eT.EL)(t)?.planId : null;
            return {
                daysLeft: n,
                premiumType: null != i ? eT.Ay.getPremiumType(i) : null,
                premiumSubscription: t
            }
        }
    },
    [eC.kqX.PREMIUM_MISSING_PAYMENT]: {
        predicate: e => {
            let {
                premiumSubscription: t,
                currentUser: n
            } = e, i = null != t ? r()(t.currentPeriodEnd).diff(r()().startOf("day"), "days") : 0, s = null != t ? r()(t.currentPeriodEnd).diff(r()(t.currentPeriodStart).startOf("day"), "days") : 0, l = null != t && r()(t.currentPeriodEnd).isBefore(r()()), a = eA.A.applicationIdsFetched.has(eh.tv), c = eA.A.getForApplication(eh.tv), o = null != t ? (0, eT.EL)(t) : null, u = null != o ? eT.Ay.getSkuIdForPlan(o.planId) : null, d = null != c && null != o && Array.from(c).filter(e => {
                let {
                    skuId: t,
                    consumed: n
                } = e;
                return !n && t === u
            }).length > 0, _ = null != t && i <= (s > 14 ? 7 : 2) && i >= 0 && t.status !== eC.Dmq.PAST_DUE && !l && a && !d && null === t.paymentSourceId && !n.hasFreePremium() && !t.isPurchasedExternally;
    ...
    [eC.kqX.PREMIUM_PAST_DUE_INVALID_PAYMENT]: {
        predicate: e => {
            let {
                premiumSubscription: t,
                currentUser: n
            } = e, i = null != t && null != t.paymentSourceId ? ed.A.getPaymentSource(t.paymentSourceId) : null, s = null != t && r()(t.currentPeriodEnd).isBefore(r()()), l = null != t && t.status === eC.Dmq.PAST_DUE && !s && null != i && i.invalid && !n.hasFreePremium() && !t.isPurchasedExternally;
    ...
    [eC.kqX.PREMIUM_PAST_DUE_MISSING_PAYMENT]: {
        predicate: e => {
            let {
                premiumSubscription: t,
                currentUser: n
            } = e, i = null != t && r()(t.currentPeriodEnd).isBefore(r()()), s = null != t && t.status === eC.Dmq.PAST_DUE && !i && null === t.paymentSourceId && !n.hasFreePremium() && !t.isPurchasedExternally;
    ...
    [eC.kqX.PREMIUM_PAST_DUE_ONE_TIME_PAYMENT]: {
        predicate: e => {
            let {
                premiumSubscription: t,
                currentUser: n
            } = e, i = null != t && r()(t.currentPeriodEnd).isBefore(r()()), s = null != t && null != t.paymentSourceId ? ed.A.getPaymentSource(t.paymentSourceId) : null, l = null != s && eR.AD.has(s.type), a = null != t && t.status === eC.Dmq.PAST_DUE && !i && l && !n.hasFreePremium() && !t.isPurchasedExternally;
    ...
    [eC.kqX.AUTO_MODERATION_MENTION_RAID_DETECTION]: {
        predicate: e => {
            let {
                selectedGuildId: t
            } = e, n = null != t ? Q.A.getGuild(t) : null;
            return null != t && null != S.A.getMentionRaidDetected(t) && n?.features.has(eC.GuildFeatures.COMMUNITY) && !ew(eC.kqX.AUTO_MODERATION_MENTION_RAID_DETECTION) || !1
        },
        metadata: e => {
            let {
                selectedGuildId: t
    ...
    [eC.kqX.SYSTEM_SERVICE_WARNING]: {
        predicate: e => {
            ...
            if (ew(eC.kqX.SYSTEM_SERVICE_WARNING) || !(0, G.yA)(g.Ay) || null == t || Z.Ay.getMode() !== eC.TBI.PUSH_TO_TALK) return !1;
    ...
    [eC.kqX.WINDOWS_MEDIA_PACK_REQUIRED]: {
        predicate: () => !(!eI.isPlatformEmbedded || d.A?.process.platform !== "win32" || ew(eC.kqX.WINDOWS_MEDIA_PACK_REQUIRED) || eg.Ay.getEnableHardwareAcceleration()) && !1 === Z.Ay.isH264MfDecodeAvailable()
    }
};
...
class eK extends l.Ay.Store {
    ...
    initialize() {
        this.syncWith([I.A, ea.Ay, et.A, J.A, er.A, P.A, eE.A, q.default, W.A, F.A, C.A, y.A, V.A, g.Ay, B.A, I.A], eX), this.waitFor(I.A, E.A, V.A, X.default, q.default, K.A, Y.A, O.A, W.A, J.A, eN.A, ef.A, ep.A, eA.A, T.A, N.A, S.A, C.A, z.Ay, Q.A, R.A, x.A, Z.Ay, $.A, ed.A, ee.A, et.A, P.A, y.A, en.A, g.Ay, ei.A, er.A, k.A, es.A, el.A, M.A, e_.A, ea.Ay, em.A, H.Ay, eE.A, ec.A, F.A, eo.default, eu.A, B.A)
    }
    hasNotice() {
...
let eY = new eK(u.h, {
    ...
    VOICE_STATE_UPDATES: function(e) {
        ...
        return (ek?.type === eC.kqX.INVITED_TO_SPEAK || t.some(e => {
            let {
                userId: t
            } = e;
