...
let eL = {
    ...
    ev = {
        [eO.kqX.GIFTING_PROMOTION_REMINDER]: o.M.GIFTING_PROMOTION_REMINDER
    },
    ey = {
    ...
    eb = {
        [eO.kqX.OUTBOUND_PROMOTION]: o.M.THIRD_PARTY_OUTBOUND_PROMO_NAGBAR
    },
    ek = {
    ...
    ej = new Set([eO.kqX.NO_INPUT_DETECTED, eO.kqX.NO_INPUT_DEVICES_DETECTED, eO.kqX.STREAMER_MODE, eO.kqX.VIDEO_UNSUPPORTED_BROWSER, eO.kqX.SPOTIFY_AUTO_PAUSED, eO.kqX.DISPATCH_ERROR, eO.kqX.DISPATCH_ERROR, eO.kqX.DISPATCH_INSTALL_SCRIPT_PROGRESS, eO.kqX.WINDOWS_MEDIA_PACK_REQUIRED]),
    eG = {},
    eF = {},
    eH = Object.freeze({
        id: null,
...
function eV(e, t, n) {
    if (null == e) return;
    let i = ek[e];
    (null == i || t || c.w.set(i, !0), ej.has(e) && (eG[e] = !0), null != n && null != i) ? c.w.set(ew(e), n.format("YYYY-MM-DDTHH:mm:ss.SSSZ")): c.w.remove(ew(e))
}
let eX = null;
...
function eK(e) {
    ...
    let n = ek[e];
    if (null != n) {
        let t, n = null != (t = c.w.get(ew(e))) ? r()(t) : null;
        if (null != n) return n?.isAfter(r()())
    }
    let i = eG[e];
    return !!i || (null != n && "" !== n ? c.w.get(n) : !!ej.has(e) && i)
}
let eY = [eO.kqX.QUARANTINED, eO.kqX.AUTOMOD_QUARANTINED_USER_PROFILE, eO.kqX.VIEWING_ROLES, eO.kqX.INVITED_TO_SPEAK, eO.kqX.LURKING_GUILD, eO.kqX.VOICE_DISABLED, eO.kqX.NO_INPUT_DEVICES_DETECTED, eO.kqX.NO_INPUT_DETECTED, eO.kqX.PTT_NO_KEYBIND_WARNING, eO.kqX.HARDWARE_MUTE, eO.kqX.DISPATCH_ERROR, eO.kqX.DISPATCH_INSTALL_SCRIPT_PROGRESS, eO.kqX.SPOTIFY_AUTO_PAUSED, eO.kqX.WIN32_DEPRECATED_MESSAGE, eO.kqX.WIN7_8_DEPRECATED_MESSAGE, eO.kqX.WIN_COMPAT_MODE_MESSAGE, eO.kqX.MACOS_19_DEPRECATED_MESSAGE, eO.kqX.E2EE_UPDATE_REQUIRED, eO.kqX.WINDOWS_MEDIA_PACK_REQUIRED, eO.kqX.VOICE_CONNECTED_LAST_SESSION, eO.kqX.SYSTEM_SERVICE_WARNING, eO.kqX.AUTO_MODERATION_MENTION_RAID_DETECTION, eO.kqX.GUILD_RAID_NOTIFICATION, eO.kqX.GIFTING_PROMOTION_REMINDER, eO.kqX.RIOT_MIGRATION, eO.kqX.RIOT_CONNECTION_DEPRECATION_ADMIN, eO.kqX.QUESTS_PROGRESS_INTERRUPTION, eO.kqX.UNCLAIMED_ACCOUNT, eO.kqX.PENDING_MEMBER, eO.kqX.CHECKOUT_RECOVERY_NAGBAR, eO.kqX.PREMIUM_MARKETING_NAGBAR, eO.kqX.OUTBOUND_PROMOTION, eO.kqX.CORRUPT_INSTALLATION, eO.kqX.VIDEO_UNSUPPORTED_BROWSER, eO.kqX.DETECTED_OFF_PLATFORM_PREMIUM_PERK, eO.kqX.DETECTED_OFF_PLATFORM_PREMIUM_PERK_UPSELL, eO.kqX.STREAMER_MODE, eO.kqX.SCHEDULED_MAINTENANCE, eO.kqX.BOUNCED_EMAIL_DETECTED, eO.kqX.UNVERIFIED_ACCOUNT, eO.kqX.PREMIUM_TIER_2_TRIAL_ENDING, eO.kqX.PREMIUM_TIER_2_DISCOUNT_ENDING, eO.kqX.PREMIUM_TIER_0_TRIAL_ENDING, eO.kqX.PREMIUM_UNCANCEL, eO.kqX.PREMIUM_MISSING_PAYMENT, eO.kqX.PREMIUM_PAST_DUE_INVALID_PAYMENT, eO.kqX.PREMIUM_PAST_DUE_MISSING_PAYMENT, eO.kqX.PREMIUM_PAST_DUE_ONE_TIME_PAYMENT, eO.kqX.PREMIUM_REACTIVATE, eO.kqX.PASSKEY_BACKUP, eO.kqX.APPLICATION_TEST_MODE, eO.kqX.QUEST_APP_UPSELL, eO.kqX.DOWNLOAD_NAG, eO.kqX.CONNECT_SPOTIFY, eO.kqX.CONNECT_PLAYSTATION, eO.kqX.SURVEY, eO.kqX.BLOCK_USER_FEEDBACK_NAGBAR, eO.kqX.IGNORE_USER_FEEDBACK_NAGBAR];
eO.kqX.QUARANTINED, eO.kqX.AUTOMOD_QUARANTINED_USER_PROFILE, eO.kqX.VIEWING_ROLES, eO.kqX.INVITED_TO_SPEAK, eO.kqX.LURKING_GUILD, eO.kqX.VOICE_DISABLED, eO.kqX.NO_INPUT_DETECTED, eO.kqX.HARDWARE_MUTE, eO.kqX.DISPATCH_ERROR, eO.kqX.DISPATCH_INSTALL_SCRIPT_PROGRESS, eO.kqX.SPOTIFY_AUTO_PAUSED, eO.kqX.VOICE_CONNECTED_LAST_SESSION, eO.kqX.PENDING_MEMBER, eO.kqX.STREAMER_MODE, eO.kqX.SCHEDULED_MAINTENANCE;
let eW = {
    [eO.kqX.GIFTING_PROMOTION_REMINDER]: {
        predicate: () => (0, L.MD)()
    },
    ...
    [eO.kqX.HARDWARE_MUTE]: {
        predicate: () => ea.A.isConnected() && en.Ay.isHardwareMute() && en.Ay.isHardwareMuteNoticeEnabled() && !w.Ay.disableHardwareMuteSilenceAlert,
        metadata: () => {
    ...
    [eO.kqX.PTT_NO_KEYBIND_WARNING]: {
        predicate: () => !!ea.A.isConnected() && en.Ay.getMode() === eO.TBI.PUSH_TO_TALK && !(en.Ay.getSettings().modeOptions.shortcut.length > 0) && !!X.A.getConfig({
    ...
    [eO.kqX.PENDING_MEMBER]: {
        predicate: e => {
            ...
            return (null != t && null != n && !et.A.getGuild(t)?.features.has(eO.GuildFeatures.GUILD_ONBOARDING) && $.Ay.getMember(t, n.id)?.isPending) ?? !1
        }
    },
    ...
    [eO.kqX.VIDEO_UNSUPPORTED_BROWSER]: {
        predicate: e => {
            ...
            return null != t && eA.A.hasVideo(t) && !en.Ay.supports(eP.O5.VIDEO) && !eK(eO.kqX.VIDEO_UNSUPPORTED_BROWSER)
        }
    },
    ...
    [eO.kqX.DETECTED_OFF_PLATFORM_PREMIUM_PERK_UPSELL]: {
        predicate: () => !eK(eO.kqX.DETECTED_OFF_PLATFORM_PREMIUM_PERK_UPSELL) && Z.A.getDetectedOffPlatformPremiumPerks().length > 0,
        metadata: () => Z.A.getDetectedOffPlatformPremiumPerks()[0]
    },
    ...
    [eO.kqX.DOWNLOAD_NAG]: {
        predicate: () => !eC.isPlatformEmbedded && !eK(eO.kqX.DOWNLOAD_NAG)
    },
    [eO.kqX.QUEST_APP_UPSELL]: {
        predicate: () => (0, eC.isOculusWeb)() && !eK(eO.kqX.QUEST_APP_UPSELL) && k.A.getConfig({
            location: "NoticeStore"
        }).enabled
    },
    ...
    [eO.kqX.CONNECT_SPOTIFY]: {
        predicate: () => !F.A.hasConnectedAccount() && C.Ay.isObservedAppRunning(_.A.get(eO.fg2.SPOTIFY).name) && !eK(eO.kqX.CONNECT_SPOTIFY)
    },
    ...
    [eO.kqX.CONNECT_PLAYSTATION]: {
        predicate: () => Q.A.isSuggestedAccountType(eO.fg2.PLAYSTATION) && null == Q.A.getAccount(null, eO.fg2.PLAYSTATION) && !eK(eO.kqX.CONNECT_PLAYSTATION)
    },
    ...
    [eO.kqX.PREMIUM_TIER_2_TRIAL_ENDING]: {
        predicate: () => eT.A.getAlmostExpiringTrialOffersForReminder([eM.pe.TIER_2]).length > 0 && !eK(eO.kqX.PREMIUM_TIER_2_TRIAL_ENDING)
    },
    [eO.kqX.PREMIUM_TIER_0_TRIAL_ENDING]: {
        predicate: () => eT.A.getAlmostExpiringTrialOffersForReminder([eM.pe.TIER_0]).length > 0 && !eK(eO.kqX.PREMIUM_TIER_0_TRIAL_ENDING)
    },
    [eO.kqX.PREMIUM_TIER_2_DISCOUNT_ENDING]: {
        predicate: () => eT.A.getAlmostExpiringDiscountOffersForReminder([eM.pe.TIER_2]).length > 0 && !eK(eO.kqX.PREMIUM_TIER_2_DISCOUNT_ENDING)
    },
    [eO.kqX.PREMIUM_UNCANCEL]: {
        predicate: e => {
            let {
                ...
                currentUser: n
            } = e, i = null != t ? r()(t.currentPeriodEnd).diff(r()().startOf("day"), "days") : 0, s = t?.canceledAt != null && t?.status === eO.Dmq.CANCELED && 1 >= r()().diff(r()(t.canceledAt), "days"), a = null != t && r()(t.currentPeriodEnd).isBefore(r()()), l = null != t && t.status === eO.Dmq.CANCELED && !a && i <= 7 && i >= 0 && (0, ef.YE)(n, eM.PremiumTypes.TIER_2) && !s && !n.hasFreePremium() && !t.isPurchasedExternally;
            return !eK(eO.kqX.PREMIUM_UNCANCEL) && l
        },
        metadata: e => {
            let {
                premiumSubscription: t
            } = e, n = null != t ? r()(t.currentPeriodEnd).diff(r()().startOf("day"), "days") : 0, i = null != t ? (0, ef.EL)(t)?.planId : null;
            return {
                daysLeft: n,
    ...
    [eO.kqX.PREMIUM_MISSING_PAYMENT]: {
        predicate: e => {
            let {
                premiumSubscription: t,
                currentUser: n
            } = e, i = null != t ? r()(t.currentPeriodEnd).diff(r()().startOf("day"), "days") : 0, s = null != t ? r()(t.currentPeriodEnd).diff(r()(t.currentPeriodStart).startOf("day"), "days") : 0, a = null != t && r()(t.currentPeriodEnd).isBefore(r()()), l = eN.A.applicationIdsFetched.has(eM.tv), o = eN.A.getForApplication(eM.tv), c = null != t ? (0, ef.EL)(t) : null, u = null != c ? ef.Ay.getSkuIdForPlan(c.planId) : null, d = null != o && null != c && Array.from(o).filter(e => {
                let {
                    skuId: t,
                    consumed: n
                } = e;
                return !n && t === u
            }).length > 0, _ = null != t && i <= (s > 14 ? 7 : 2) && i >= 0 && t.status !== eO.Dmq.PAST_DUE && !a && l && !d && null === t.paymentSourceId && !n.hasFreePremium() && !t.isPurchasedExternally;
    ...
    [eO.kqX.PREMIUM_PAST_DUE_INVALID_PAYMENT]: {
        predicate: e => {
            let {
                premiumSubscription: t,
                currentUser: n
            } = e, i = null != t && null != t.paymentSourceId ? em.A.getPaymentSource(t.paymentSourceId) : null, s = null != t && r()(t.currentPeriodEnd).isBefore(r()()), a = null != t && t.status === eO.Dmq.PAST_DUE && !s && null != i && i.invalid && !n.hasFreePremium() && !t.isPurchasedExternally;
    ...
    [eO.kqX.PREMIUM_PAST_DUE_MISSING_PAYMENT]: {
        predicate: e => {
            let {
                premiumSubscription: t,
                currentUser: n
            } = e, i = null != t && r()(t.currentPeriodEnd).isBefore(r()()), s = null != t && t.status === eO.Dmq.PAST_DUE && !i && null === t.paymentSourceId && !n.hasFreePremium() && !t.isPurchasedExternally;
    ...
    [eO.kqX.PREMIUM_PAST_DUE_ONE_TIME_PAYMENT]: {
        predicate: e => {
            let {
                premiumSubscription: t,
                currentUser: n
            } = e, i = null != t && r()(t.currentPeriodEnd).isBefore(r()()), s = null != t && null != t.paymentSourceId ? em.A.getPaymentSource(t.paymentSourceId) : null, a = null != s && eU.AD.has(s.type), l = null != t && t.status === eO.Dmq.PAST_DUE && !i && a && !n.hasFreePremium() && !t.isPurchasedExternally;
    ...
    [eO.kqX.AUTO_MODERATION_MENTION_RAID_DETECTION]: {
        predicate: e => {
            let {
                selectedGuildId: t
            } = e, n = null != t ? et.A.getGuild(t) : null;
            return null != t && null != O.A.getMentionRaidDetected(t) && n?.features.has(eO.GuildFeatures.COMMUNITY) && !eK(eO.kqX.AUTO_MODERATION_MENTION_RAID_DETECTION) || !1
        },
        metadata: e => {
            let {
                selectedGuildId: t
    ...
    [eO.kqX.SYSTEM_SERVICE_WARNING]: {
        predicate: e => {
            ...
            if (eK(eO.kqX.SYSTEM_SERVICE_WARNING) || !(0, B.yA)(C.Ay) || null == t || en.Ay.getMode() !== eO.TBI.PUSH_TO_TALK) return !1;
    ...
    [eO.kqX.WINDOWS_MEDIA_PACK_REQUIRED]: {
        predicate: () => !(!eC.isPlatformEmbedded || d.A?.process.platform !== "win32" || eK(eO.kqX.WINDOWS_MEDIA_PACK_REQUIRED) || eh.Ay.getEnableHardwareAcceleration()) && !1 === en.Ay.isH264MfDecodeAvailable()
    },
    ...
    [eO.kqX.RIOT_CONNECTION_DEPRECATION_ADMIN]: {
        predicate: e => {
            ...
            if (!E.A.getConfig({
                    location: "NoticeStore"
                }).enabled || eK(eO.kqX.RIOT_CONNECTION_DEPRECATION_ADMIN) || (0, T.k8)(o.M.RIOT_CONNECTION_DEPRECATION_ADMIN_DISABLE)) return !1;
            let i = null != n ? et.A.getGuild(n) : null,
                r = (0, ep.$3)({
                    permission: eO.xBc.ADMINISTRATOR,
                    user: t,
                    context: i
                }),
...
function eJ() {
    ...
    for (let s of eY)
        ...
        eB.metadata?.sampleRate != null && null == eF[eB.type] && (eF[eB.type] = Math.random() <= eB.metadata.sampleRate);
        let e = !1 === eF[eB.type];
...
class eQ extends a.Ay.Store {
    ...
    initialize() {
        this.syncWith([g.A, ed.Ay, es.A, Z.A, eo.A, y.A, eT.A, W.default, Q.A, V.A, R.A, j.A, K.A, C.Ay, q.A, g.A, I.A], eJ), this.waitFor(g.A, m.A, K.A, Y.default, W.default, J.A, z.A, U.A, Q.A, Z.A, eS.A, eR.A, ex.A, eN.A, p.A, f.A, O.A, R.A, $.Ay, I.A, ee.A, et.A, M.A, D.A, en.Ay, ei.A, em.A, er.A, es.A, y.A, j.A, ea.A, C.Ay, el.A, eo.A, F.A, ec.A, eu.A, P.A, eI.A, ed.Ay, eg.A, w.Ay, eT.A, e_.A, V.A, eE.default, eA.A, q.A)
    }
    hasNotice() {
...
let eZ = new eQ(u.h, {
    ...
    VOICE_STATE_UPDATES: function(e) {
        ...
        return (eB?.type === eO.kqX.INVITED_TO_SPEAK || t.some(e => {
            let {
                userId: t
            } = e;
