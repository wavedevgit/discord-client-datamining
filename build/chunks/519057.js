...
let eK = {
    [ex.kqX.GIFTING_PROMOTION_REMINDER]: {
        predicate: () => {
            ...
            }), t = j.A.getMarketingComponentByType(a.C.GIFT_REMINDER_NAGBAR), n = j.A.getGiftPromotion()?.id;
            return e && null != t && null != n && (0, T.u$)(o.M.GIFTING_PROMOTION_DESKTOP_FIRST_TIME_COACHMARK, n).isDismissed && !eX(ex.kqX.GIFTING_PROMOTION_REMINDER)
        }
    },
    ...
    [ex.kqX.PTT_NO_KEYBIND_WARNING]: {
        predicate: () => !!ea.A.isConnected() && et.Ay.getMode() === ex.TBI.PUSH_TO_TALK && !(et.Ay.getSettings().modeOptions.shortcut.length > 0) && !!X.A.getConfig({
            location: "NoticeStore"
    ...
    [ex.kqX.PENDING_MEMBER]: {
        predicate: e => {
            ...
            return (null != t && null != n && !ee.A.getGuild(t)?.features.has(ex.GuildFeatures.GUILD_ONBOARDING) && $.Ay.getMember(t, n.id)?.isPending) ?? !1
        }
    },
    ...
    [ex.kqX.VIDEO_UNSUPPORTED_BROWSER]: {
        predicate: e => {
            ...
            return null != t && eA.A.hasVideo(t) && !et.Ay.supports(eD.O5.VIDEO) && !eX(ex.kqX.VIDEO_UNSUPPORTED_BROWSER)
        }
    },
    ...
    [ex.kqX.DETECTED_OFF_PLATFORM_PREMIUM_PERK_UPSELL]: {
        predicate: () => !eX(ex.kqX.DETECTED_OFF_PLATFORM_PREMIUM_PERK_UPSELL) && Z.A.getDetectedOffPlatformPremiumPerks().length > 0,
        metadata: () => Z.A.getDetectedOffPlatformPremiumPerks()[0]
    },
    ...
    [ex.kqX.CONNECT_SPOTIFY]: {
        predicate: () => !H.A.hasConnectedAccount() && C.Ay.isObservedAppRunning(_.A.get(ex.fg2.SPOTIFY).name) && !eX(ex.kqX.CONNECT_SPOTIFY)
    },
    ...
    [ex.kqX.CONNECT_PLAYSTATION]: {
        predicate: () => Q.A.isSuggestedAccountType(ex.fg2.PLAYSTATION) && null == Q.A.getAccount(null, ex.fg2.PLAYSTATION) && !eX(ex.kqX.CONNECT_PLAYSTATION)
    },
    ...
    [ex.kqX.PREMIUM_TIER_2_TRIAL_ENDING]: {
        predicate: () => eT.A.getAlmostExpiringTrialOffersForReminder([eR.pe.TIER_2]).length > 0 && !eX(ex.kqX.PREMIUM_TIER_2_TRIAL_ENDING)
    },
    [ex.kqX.PREMIUM_TIER_0_TRIAL_ENDING]: {
        predicate: () => eT.A.getAlmostExpiringTrialOffersForReminder([eR.pe.TIER_0]).length > 0 && !eX(ex.kqX.PREMIUM_TIER_0_TRIAL_ENDING)
    },
    [ex.kqX.PREMIUM_TIER_2_DISCOUNT_ENDING]: {
        predicate: () => eT.A.getAlmostExpiringDiscountOffersForReminder([eR.pe.TIER_2]).length > 0 && !eX(ex.kqX.PREMIUM_TIER_2_DISCOUNT_ENDING)
    },
    [ex.kqX.PREMIUM_UNCANCEL]: {
        predicate: e => {
            let {
                ...
                currentUser: n
            } = e, i = null != t ? l()(t.currentPeriodEnd).diff(l()().startOf("day"), "days") : 0, a = t?.canceledAt != null && t?.status === ex.Dmq.CANCELED && 1 >= l()().diff(l()(t.canceledAt), "days"), r = null != t && l()(t.currentPeriodEnd).isBefore(l()()), s = null != t && t.status === ex.Dmq.CANCELED && !r && i <= 7 && i >= 0 && (0, ef.YE)(n, eR.PremiumTypes.TIER_2) && !a && !n.hasFreePremium() && !t.isPurchasedExternally;
    ...
    [ex.kqX.PREMIUM_PAST_DUE_INVALID_PAYMENT]: {
        predicate: e => {
            let {
                premiumSubscription: t,
                currentUser: n
            } = e, i = null != t && null != t.paymentSourceId ? em.A.getPaymentSource(t.paymentSourceId) : null, a = null != t && l()(t.currentPeriodEnd).isBefore(l()()), r = null != t && t.status === ex.Dmq.PAST_DUE && !a && null != i && i.invalid && !n.hasFreePremium() && !t.isPurchasedExternally;
    ...
    [ex.kqX.PREMIUM_PAST_DUE_ONE_TIME_PAYMENT]: {
        predicate: e => {
            let {
                premiumSubscription: t,
                currentUser: n
            } = e, i = null != t && l()(t.currentPeriodEnd).isBefore(l()()), a = null != t && null != t.paymentSourceId ? em.A.getPaymentSource(t.paymentSourceId) : null, r = null != a && eM.AD.has(a.type), s = null != t && t.status === ex.Dmq.PAST_DUE && !i && r && !n.hasFreePremium() && !t.isPurchasedExternally;
    ...
    [ex.kqX.ACTIVATE_SERVER_SUBSCRIPTION]: {
        predicate: () => !eX(ex.kqX.ACTIVATE_SERVER_SUBSCRIPTION) && 0 !== E.A.getEligibleGuildsForNagActivate().length && (0, m.KD)()
    },
    ...
    [ex.kqX.SYSTEM_SERVICE_WARNING]: {
        predicate: e => {
            ...
            if (eX(ex.kqX.SYSTEM_SERVICE_WARNING) || !(0, B.yA)(C.Ay) || null == t || et.Ay.getMode() !== ex.TBI.PUSH_TO_TALK) return !1;
...
function eY() {
    ...
    for (let a of eq)
        ...
        eH.metadata?.sampleRate != null && null == eb[eH.type] && (eb[eH.type] = Math.random() <= eH.metadata.sampleRate);
        let e = !1 === eb[eH.type];
...
let ez = new eJ(d.h, {
    ...
    VOICE_STATE_UPDATES: function(e) {
        ...
        return (eH?.type === ex.kqX.INVITED_TO_SPEAK || t.some(e => {
            let {
                userId: t
            } = e;
