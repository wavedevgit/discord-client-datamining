...
function C(e) {
    ...
    for (let {
        ...
        if (n.type === f.$pd.PLAYING)
            if (S.length > 1 && !(0, l.A)(n) && null != a) L((0, i.jsx)(E.A.GameSection, {
                icon: a.getIconURL(64),
                name: a.name,
                partySize: {
                    knownSize: r.length,
                    unknownSize: 0,
            ...
            getAssetImage: g.uD,
            members: r
        }, `spotify-${n.session_id??t}-${A.id}`)) : (null != n.assets || (0, l.A)(n)) && L((0, i.jsx)(E.A.RichPresenceSection, {
            activity: n,
            getAssetImage: g.uD,
            user: A
        }, `rich-presence-${n.session_id??t}-${A.id}`)));
        y && null != C && null != a && (0, h.zS)(n, C) && (null == C.userStatus || !(0, _.gO)(C.userStatus, u.uF.ACTIVITY_PANEL)) && L((0, i.jsx)(m.A, {
            quest: C
