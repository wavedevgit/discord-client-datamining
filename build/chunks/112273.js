/** chunk id: 112273 params = (module,exports,require) **/
n.d(t, {
    A: () => C
}), n(321073);
var i = n(627968);
...
function C(e) {
    ...
    for (let {
        ...
        } return b.length > 0 && T && b.forEach(e => {
        let {
            stream: t,
            streamUser: n,
            activity: r
        ...
        if (n.type === f.$pd.PLAYING)
            if (S.length > 1 && !(0, r.A)(n) && null != l) L((0, i.jsx)(E.A.GameSection, {
            ...
            getAssetImage: g.uD,
            members: a
        }, `spotify-${n.session_id??t}-${A.id}`)) : (null != n.assets || (0, r.A)(n)) && L((0, i.jsx)(E.A.RichPresenceSection, {
            activity: n,
            getAssetImage: g.uD,
            user: A
        }, `rich-presence-${n.session_id??t}-${A.id}`)));
        y && null != C && null != l && (0, _.zS)(n, C) && (null == C.userStatus || !(0, h.gO)(C.userStatus, u.uF.ACTIVITY_PANEL)) && L((0, i.jsx)(m.A, {
            quest: C
