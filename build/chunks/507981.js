/** chunk id: 507981 params = (module,exports,require) **/
let r, a;
n.d(t, {
    A: () => y
});
...
function y(e) {
    let {
        ...
        onError: v,
        onExpire: C
    } = e, E = c.useRef(null), b = c.useRef(null), A = c.useRef({
        onLoad: y,
        onVerify: m,
        onError: v,
        onExpire: C
    ...
    A.current = {
        ...
        return (function() {
            ...
            if ("unloaded" === d && (d = "loading", Object.assign(window, {
                    [s]() {
                        u()
                    }
                })), null == document.getElementById(o)) {
                let e = document.createElement("script");
                e.src = `https://challenges.cloudflare.com/turnstile/v0/api.js?onload=${s}&render=explicit`, e.id = o, e.async = !0, e.defer = !0, e.onerror = () => {
                    ! function(e) {
                        if ("ready" === d) return;
            ...
            e = !0, null != b.current && null != window.turnstile && (window.turnstile.remove(b.current), b.current = null)
        }
    }, [t, n, r]);
    let w = f[r ?? "normal"];
    return (0, i.jsx)("div", {
