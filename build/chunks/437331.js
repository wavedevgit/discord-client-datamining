...
function v(e) {
    let {
        ...
        mentionCount: i,
        unread: r
    } = e, u = (0, a.Ay)(c.A.getChannel(t) ?? void 0, !0) ?? "???";
    return (0, l.jsx)(E.D, {
        listItemId: n,
...
function M(e) {
    let {
        ...
        onPrimaryAction: I,
        onContextMenu: _
    } = e, T = t.id, v = (0, a.Ay)(t, !1) ?? "???", M = (0, y.X6)(t), D = (0, d.A)(t, !1), {
        user: R,
        status: O,
        isMobile: U
        ...
        let n = t.isMultiUserDM() ? p.K.GROUP_DM_CHANNEL : p.K.DM_CHANNEL;
        _?.({
            type: n,
            event: e,
            channel: t,
    ...
    }, [t, _, R]), w = t.isMultiUserDM() || t.isPrivate() && t.recipients.length >= 2, L = i.useCallback(() => {
        I?.({
            type: p.c.OPEN_TEXT_CHAT_CHANNEL,
            channelId: T,
            guildId: null
        })
    }, [T, I]);
...
function D(e) {
    let t, {
        ...
        L = (0, s.rdh)(s.LU0.colors.TEXT_MUTED),
        F = I || g > 0 ? "text-strong" : "text-muted",
        b = I || g > 0 ? w : L,
        k = i.useCallback(e => {
            T?.({
                type: p.K.GUILD_TEXT_CHANNEL,
                event: e,
                channel: n,
                guild: D
            })
    ...
    return (0, l.jsx)(E.D, {
        ...
        primaryText: (0, l.jsxs)("div", {
            className: C.QV,
            children: [null == (t = (0, u.gU)(n, D)) ? null : (0, l.jsx)(t, {
                color: b.hex(),
                size: "xxs",
                className: C.p
            }), (0, l.jsx)(s.Text, {
        ...
        rightActions: e => (0, l.jsxs)(l.Fragment, {
            children: [g > 0 ? x(g) : null, e ? (0, l.jsx)(S.j, {
                tab: f.x.MESSAGES,
                targetId: v
            }) : null]
        })
...
function R(e) {
    let {
        ...
        onPrimaryAction: s,
        onContextMenu: a
    } = e, u = (0, r.bG)([c.A], () => c.A.getChannel(t), [t]), {
        mentionCount: o,
        unread: d,
    ...
    return null == u ? (0, l.jsx)(v, {
        channelId: t,
        listItemId: n,
        mentionCount: o,
        unread: d
    }) : u.isPrivate() ? (0, l.jsx)(M, {
        channel: u,
        listItemId: n,
        mentionCount: o,
        isMentionLowImportance: h,
