/** chunk id: 15910 params = (module,exports,require) **/
n.d(t, {
    j: () => _
});
var i = n(627968),
...
function m(e) {
    if (null != e) {
        ...
        return {
            ...
            countdownString: u.intl.formatToPlainString(u.t.U0Hhr7, {
                duration: new Date(0, 0, 0, n, i, l)
            })
        }
    }
    return {
...
let A = e => {
        ...
        return (0, i.jsx)("div", {
            className: h.z$,
            children: n((e, t) => (0, i.jsx)(o.animated.div, {
                style: {
                    ...e,
                    position: "absolute",
                    width: "100%",
