...
function P(e, t) {
    ...
    let [r, ...i] = [e, t], {
        ...
        merged_members: s,
        merged_presences: o
    } = r, l = S(r, ["guilds", "merged_members", "merged_presences"]), [c] = i, u = k(R, null == o ? void 0 : o.friends), d = null != (n = null == a ? void 0 : a.map((e, t) => {
        let n = k(R, null == o ? void 0 : o.guilds[t]),
            r = k(R, null == s ? void 0 : s[t]);
        return I(v({}, e), {
...
function G(e) {
    null != o.A.database() && !1 === e.databaseOk && d.A.replaceDisableAllDatabases("ReadyPayloadUtils: database was not ok"), N = {};
...
function B(e, t) {
    ...
    return {
        ...
        channels: {
            op: "update",
            writes: null != (n = null == (s = e.partial_updates.channels) ? void 0 : s.map(t => (0, m.UE)(t, e.id))) ? n : [],
