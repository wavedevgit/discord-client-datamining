/** chunk id: 910885 params = (module,exports,require) **/
n.d(t, {
    Ay: () => b,
    Mm: () => v,
    RA: () => C,
...
function L(e) {
    ...
    } = e, a = (0, o.bG)([m.A], () => m.A.useReducedMotion), c = l.useRef(null), u = j(_), N = g.Ay.getGuildIconURL({
        id: t.id,
        icon: t.icon,
        size: 96
    });
    return l.useEffect(() => {
        let e;
        return null != c.current && null != N ? (0, A.S4)(N).then(t => {
        ...
        }) : null != c.current && (e = d().loadAnimation({
            container: c.current,
            renderer: "svg",
            loop: !0,
            autoplay: !a,
...
function b(e) {
    let {
        ...
        headerId: r,
        disableTracking: a
    } = e, d = (0, o.bG)([E.A], () => E.A.isLoading()), m = l.useRef(!1);
    l.useEffect(() => {
        if (!a) return I.default.track(D.HAw.GUILD_ONBOARDING_STEP_VIEWED, {
            ...(0, N.H$)(t.id),
            step: -1,
            required: !0
        }), () => {
        ...
        children: (0, i.jsxs)("div", {
            ...
            children: [(0, i.jsx)("div", {
                ...
                children: [(0, i.jsx)(c.Text, {
                    ...
                    color: "always-white",
                    id: r,
                    children: O.intl.format(O.t["j59F/c"], {
                        guildName: t?.name
                    })
                }), d ? (0, i.jsx)(c.y$y, {
                    className: G.__invalid_subtitle
                }) : s === S.$o.NOT_APPLICABLE ? (0, i.jsx)(c.Heading, {
                    className: G.__invalid_subtitle,
