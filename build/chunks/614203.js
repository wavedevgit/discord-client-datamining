...
function b(t) {
    let {
        text: e = "",
        target: s
    } = t, b = (0, i.bG)([o.A], () => o.A.isEnabled()), f = (0, i.bG)([o.A], () => o.A.hasLearnedWord(e), [e]), x = a.useRef({
        ...t,
        spellcheckEnabled: b
    });
    x.current = {
    ...
    return (a.useEffect(() => {
        ...
        C()
    }, [e, b, C]), (0, u.TT)()) ? [S.map((t, e) => (0, n.jsx)(c.Drp, {
        id: `correction-${e}`,
        label: t,
        action: () => {
            (0, u.rK)(t), s.focus()
        ...
        children: [m ? (0, n.jsx)(c.Drp, {
            id: "add-to-dictionary",
            label: d.intl.string(d.t.HJmG1G),
            action: () => {
                (0, l.NG)(e), E()
            }
        }) : null, f && (0, n.jsx)(c.Drp, {
