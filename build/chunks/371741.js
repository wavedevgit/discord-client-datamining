/** chunk id: 371741 params = (module,exports,require) **/
n.d(t, {
    Av: () => J,
    Ay: () => X,
    VO: () => $
...
function $(e) {
    ...
    let {
        ...
        popouts: m,
        setPopout: A
    } = (0, L.A)(n.id, W.Fd), g = (0, b.Ay)(n), p = (0, M.fF)(n), _ = (0, M.ZD)(n);
    return n.type === z.lAJ.THREAD_STARTER_MESSAGE && null != h && h.state === f.a.LOADED ? (0, i.jsx)(Z, {
        ...e,
...
function Z(e) {
    let {
        ...
        selected: H,
        setPopout: J
    } = (0, L.A)(n.id, W.Fd), $ = x.hD.useSetting(), Z = x.rs.useSetting(), X = (0, d.bG)([f.A], () => f.A.getMessageByReference(I)), Q = (0, p.S)((n.editedTimestamp ?? n.timestamp).valueOf()), {
        handleMouseEnter: ee,
        handleMouseLeave: et,
        isHovered: en
    } = (0, D.yp)({
        ...
        message: n,
        defaultValue: H
    }), ei = (0, d.bG)([h.A], () => h.A.keyboardModeEnabled), el = H || ei && j, es = el || en, ea = (0, d.bG)([S.A], () => S.A.isDeveloper), {
        content: er,
        hasSpoilerEmbeds: eo,
        hasBailedAst: ec
    } = (0, P.A)(n, {
        ...
        previewLinkTarget: !0,
        viewingChannelId: C
    }), ed = (0, O.A)(s, r, ei), eu = (0, b.Ay)(n), eh = (0, M.fF)(n, _), em = (0, M.ZD)(n), eA = (0, B.A)(e, er, !1), eg = l.useCallback(() => (0, E.uh)(o, r, s), [o, r, s]), ep = (0, g.$7)({
        guildId: o,
    ...
    return (0, i.jsxs)("div", {
        ...
        children: [(0, i.jsx)(u.DUT, {
            ...
            className: a()(A, {
                ...
                [Y.M1]: (0, N.ec)(n),
                [Y.H4]: (0, y.A)(n),
                [Y._A]: n.id === _ || n.type === z.lAJ.REPLY,
                [Y.wH]: el
            }),
            zalgo: !0,
            onKeyDown: ed,
...
let X = l.memo(function(e) {
    ...
    let et = z.sl8.has(r.type) ? r.messageReference : void 0,
        ...
        el = x.hD.useSetting(),
        es = x.rs.useSetting(),
        ea = (0, d.bG)([f.A], () => f.A.getMessageByReference(et)),
        {
            popouts: er,
            selected: eo,
            setPopout: ec
        ...
        eT = eo || eS || eI && ep,
        eN = eT || eg,
        ev = (0, d.bG)([C.A], () => r.hasFlag(z.pr7.HAS_THREAD) && C.A.getChannel(T.default.castMessageIdAsChannelId(r.id))),
        ...
        eO = (0, O.A)(E, J, eI),
        eL = (0, b.Ay)(r),
        eP = (0, d.bG)([_.A], () => _.A.getPendingReply(J)),
        ...
        ez = (0, i.jsx)(u.vN3, {
            ...
            children: (0, i.jsx)("li", {
                ...
                children: (0, i.jsx)(R.A, {
                    ...
                    zalgo: !eS,
                    childrenRepliedMessage: ee || r.type !== z.lAJ.REPLY ? void 0 : (0, V.A)({
                        ...e,
                        setPopout: ec,
                    ...
                    childrenHeader: ee ? void 0 : (0, F.A)({
                        messageProps: e,
                        setPopout: ec,
                        messagePopouts: er,
                        replyReference: et,
