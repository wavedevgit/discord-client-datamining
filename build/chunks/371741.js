...
function $(e) {
    let {
        ...
        selected: q,
        setPopout: J
    } = (0, O.A)(n.id, K.Fd), $ = E.hD.useSetting(), Z = E.rs.useSetting(), X = (0, d.bG)([f.A], () => f.A.getMessageByReference(I)), Q = (0, g.S)((n.editedTimestamp ?? n.timestamp).valueOf()), {
        handleMouseEnter: ee,
        handleMouseLeave: et,
        isHovered: en
    } = (0, M.yp)({
        ...
        message: n,
        defaultValue: q
    }), ei = (0, d.bG)([h.A], () => h.A.keyboardModeEnabled), el = q || ei && P, es = el || en, ea = (0, d.bG)([C.A], () => C.A.isDeveloper), {
        content: er,
        hasSpoilerEmbeds: eo,
        hasBailedAst: ec
    } = (0, L.A)(n, {
        ...
        previewLinkTarget: !0,
        viewingChannelId: S
    }), ed = (0, D.A)(s, r, ei), eu = (0, y.Ay)(n), eh = (0, R.fF)(n, x), em = (0, R.ZD)(n), eA = (0, F.A)(e, er, !1), eg = l.useCallback(() => (0, _.uh)(o, r, s), [o, r, s]), ep = (0, A.$7)({
        guildId: o,
