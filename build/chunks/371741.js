...
function Z(e) {
    let {
        ...
        selected: B,
        setPopout: J
    } = (0, L.A)(n.id, W.Fd), $ = x.hD.useSetting(), Z = x.rs.useSetting(), X = (0, d.bG)([_.A], () => _.A.getMessageByReference(I)), Q = (0, p.S)((n.editedTimestamp ?? n.timestamp).valueOf()), {
        handleMouseEnter: ee,
        handleMouseLeave: et,
        isHovered: en
    } = (0, D.yp)({
        ...
        message: n,
        defaultValue: B
    }), ei = (0, d.bG)([h.A], () => h.A.keyboardModeEnabled), el = B || ei && j, es = el || en, ea = (0, d.bG)([S.A], () => S.A.isDeveloper), {
        content: er,
        hasSpoilerEmbeds: eo,
        hasBailedAst: ec
    } = (0, P.A)(n, {
        ...
        previewLinkTarget: !0,
        viewingChannelId: C
    }), ed = (0, O.A)(s, r, ei), eu = (0, b.Ay)(n), eh = (0, M.fF)(n, f), em = (0, M.ZD)(n), eA = (0, H.A)(e, er, !1), eg = l.useCallback(() => (0, E.uh)(o, r, s), [o, r, s]), ep = (0, g.$7)({
        guildId: o,
...
let X = l.memo(function(e) {
    ...
    let et = z.sl8.has(r.type) ? r.messageReference : void 0,
        ...
        eT = eo || eS || eI && ep,
        ev = eT || eg,
        eN = (0, d.bG)([C.A], () => r.hasFlag(z.pr7.HAS_THREAD) && C.A.getChannel(T.default.castMessageIdAsChannelId(r.id))),
