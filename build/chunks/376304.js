...
let l = "".concat(location.protocol, "//").concat(window.GLOBAL_ENV.CDN_HOST, "/role-icons"),
    ...
    p = (e, t) => {
        ...
        let s = a.QB ? "webp" : "png",
            d = "",
            f = "quality=lossless";
        return (null != t && (d = "size=" + (0, i.kr)(t * (0, i.mZ)()), f = u ? "" : "&" + f), null != window.GLOBAL_ENV.CDN_HOST) ? "".concat(l, "/").concat(n, "/").concat(r, ".").concat(s, "?").concat(d).concat(f) : "".concat(c).concat(o.Rsh.ROLE_ICON(n, r), "?").concat(d)
    },
    _ = e => e.startsWith(l) || e.startsWith("".concat(c, "/roles")) && e.includes("/icons/"),
    h = (e, t) => {
        var n;
        return (null == t || null == (n = t.tags) ? void 0 : n.subscription_listing_id) != null || e.features.has(o.GuildFeatures.ROLE_ICONS)
    }