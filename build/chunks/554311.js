/** chunk id: 554311 params = (module,exports,require) **/
n.d(t, {
    Un: () => v,
    Xm: () => p,
    qo: () => _,
...
function f(e) {
    let [t, n] = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : [l.Ay, o.default], a = g(e, [n]), i = null != e.name ? t.getGameForName(e.name) ?? void 0 : void 0;
    return {
        gameId: e.id,
        gameName: e.name,
...
function p(e) {
    let [t, n] = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : [l.Ay, o.default], a = g(e, [n]);
    return {
        gameId: e.id,
        gameName: e.name,
...
function v() {
    return (0, a.yK)([i.A, l.Ay, o.default], () => {
        ...
        return [...e, ...l.Ay.getGamesSeen(!1).reduce((e, n) => {
            let a = n.id;
...
function y() {
    ...
    return (0, a.bG)([l.Ay, o.default], () => {
        switch (!0) {
            ...
            case null != e:
                return function(e) {
                    let [t, n] = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : [l.Ay, o.default], a = t.getGameForName(e.name), i = a?.pid;
                    return {
                        gameId: e.id,
                        gameName: e.name,
                        gamePid: a?.pid,
