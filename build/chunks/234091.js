/** Chunk was on web.js **/
/** chunk id: 234091, original params: e,t,n (module,exports,require) **/
"use strict";
n.d(t, {
    A: () => S
});
...
function S(e) {
    ...
    return (0, r.jsxs)("div", {
        ...
        children: [P ? (0, r.jsx)(p.Ay, {
            ...
            onClose: T,
            type: O.e.EMPTY_STICKER_PICKER_UPSELL,
            subscriptionTier: null != (t = null == w || null == (a = w.subscription_trial) ? void 0 : a.sku_id) ? t : O.pe.TIER_2,
            ...
            buttonText: P ? D ? v.intl.string(v.t.hz78hE) : v.intl.string(v.t["Gd/XHF"]) : void 0
        })]
    })
}