...
let tc = [{
    ...
    render: function(e) {
        return (0, e6.wR)() || eq.default.getLoginStatus() === e4.aUe.LOGGING_IN || !eq.default.allowLogoutRedirect() ? ta(e) : (0, i.jsx)(N.A, {
...
class th extends r.PureComponent {
    ...
    rewriterUnlisten = () => {};
    componentDidMount() {
        e2.Ay.setZoomFactor(g.A.zoom), eb.A.init(), O.A.initialize(), eg.A.initialize(), W.A.initialize(), eW.A.initialize(), q.A.initialize(), ef.A.initialize(), G.A.initialize(), ea.A.initialize(), E.A.init(), z.A.init(), K.A.init(), eu.A.initialize(), S.A.initialize(), B.A.initialize(), eC.A.initialize(), T.Ay.initialize(), H.Ay.initialize(), eY.A.initialize(), ei.Ay.initialize(), ep.A.initialize(), C.A.initialize(), er.A.init(), P.A.init(), e9.A.init(), f.A.initialize(), ew.A.init(), e1.A.init(), ek.A.init(), eP.A.initialize(), ej.A.initialize(), eG.A.initialize(), eB.A.init(), V.A.initialize(), I.A.initialize(), eR.A.initialize(), e_.A.initialize(), eh.A.initialize(), em.A.initialize(), j.A.initialize(), D.A.initialize(), Y.A.initialize(), el.A.initialize(), es.A.initialize(), eT.A.initialize(), eE.A.initialize(), U.A.initialize(), R.A.initialize(), x.A.initialize(), this.rewriterUnlisten = eN.A.addRouteRewriter(this.ensureChannelMatchesGuild), this.historyUnlisten = eN.A.addRouteChangeListener(this.handleHistoryChange)
    }
