...
let tn = !1;
(0, v.as)(), s.Ay.initialize(), eb.A.loadServer(), e9.isPlatformEmbedded && (e2.Ay.on("USER_SETTINGS_OPEN", (e, t) => {
...
let ti = (0, p.z)(e => {
    ...
    to = [e4.BVt.GUILD_BOOSTING_MARKETING(eS.pv.guildId()), ...Array.from(e8.qW).map(e => e4.BVt.CHANNEL(eS.pv.guildId(), e))];
...
let tc = [{
    ...
    render: function(e) {
        return (0, e5.wR)() || eW.default.getLoginStatus() === e4.aUe.LOGGING_IN || !eW.default.allowLogoutRedirect() ? ta(e) : (0, i.jsx)(N.A, {
    ...
    render: function(e) {
        ...
        return (0, Q.B)(() => (0, eU.openUserProfileModal)({
            userId: n,
    ...
    render: function(e) {
        ...
        return e7.A.whenInitialized(() => {
            ...
            to: e4.BVt.APPLICATION_LIBRARY
        })
    }
}, {
    path: [e4.BVt.GUILD_CREATE],
    render: function() {
        return (0, Q.B)(() => w.A.openCreateGuildModal({
    ...
    render: function(e) {
        ...
        return (0, Q.B)(() => en.w({
            section: (0, et.A)(e4.BEX, n),
            subsection: (0, et.A)(e4.nd0, r),
            feature: s
        })), (0, i.jsx)(a.rd, {
            to: e$.A.defaultRoute
        })
    ...
    path: [e4.BVt.SETTINGS(":section", ":subsection?")],
    render: ti
}, {
    path: [e4.BVt.PLAYGROUND(":collection?", ":story?")],
    render: tr
}, {
    ...
    render: function() {
        return (0, Q.B)(() => (0, eF.openUserSettings)(eV.X.GIFT_PANEL, {
            section: e4.nc_.INVENTORY
        })), (0, i.jsx)(a.rd, {
            to: e$.A.defaultRoute
        })
    }
}, {
    path: [e4.BVt.WELCOME(eS.pv.guildId({
        optional: !0
    }), eS.pv.channelId({
        optional: !0
    }))],
    ...
    path: [e4.BVt.GUILD_EVENT_DETAILS(eS.pv.guildId({
        optional: !0
    }), ":guildEventId")],
    render: function(e) {
        let {
    ...
    path: [e4.BVt.CHANNEL_THREAD_VIEW(eS.pv.guildId(), eS.pv.channelId(), ":threadId", ":messageId?"), e4.BVt.CHANNEL(eS.pv.guildId(), eS.pv.channelId({
        optional: !0
    }), ":messageId?"), e4.BVt.ACTIVITY, e4.BVt.ACTIVITIES, e4.BVt.ACTIVITIES_HAPPENING_NOW, e4.BVt.APPLICATION_LIBRARY, e4.BVt.APPLICATION_STORE, e4.BVt.MESSAGE_REQUESTS, e4.BVt.COLLECTIBLES_SHOP, e4.BVt.COLLECTIBLES_SHOP_PRODUCT_DETAIL(":skuId"), e4.BVt.COLLECTIBLES_SHOP_LAYOUT(":layoutId"), e4.BVt.GUILD_DISCOVERY, e4.BVt.QUEST_HOME_DEPRECATED, e4.BVt.QUEST_HOME_V2, e4.BVt.ICYMI, e4.BVt.GLOBAL_DISCOVERY, e4.BVt.GUILD_MEMBER_VERIFICATION(eS.pv.guildId()), e4.BVt.GUILD_MEMBER_VERIFICATION_FOR_HUB(eS.pv.guildId(), ":inviteCode?"), e4.BVt.GUILD_BOOSTING_MARKETING(eS.pv.guildId()), e4.BVt.GUILD_FEATURE(":feature", eS.pv.guildId()), e4.BVt.FEATURE(":feature"), e4.BVt.FAMILY_CENTER],
    render: ta,
    isChatRoute: !0
}, {
    path: [e4.BVt.APPLICATION_DIRECTORY],
    render: ts
}, {
    ...
    render: function(e) {
        ...
        return (0, i.jsx)(a.rd, {
            to: e4.BVt.CHANNELS_GAME_SHOP(n, 0, r, l)
        })
    }
}];
...
class th extends r.PureComponent {
    ...
    rewriterUnlisten = () => {};
    componentDidMount() {
        e2.Ay.setZoomFactor(g.A.zoom), eb.A.init(), O.A.initialize(), eg.A.initialize(), q.A.initialize(), eq.A.initialize(), W.A.initialize(), ef.A.initialize(), G.A.initialize(), ea.A.initialize(), E.A.init(), K.A.init(), z.A.init(), eu.A.initialize(), S.A.initialize(), B.A.initialize(), eC.A.initialize(), T.Ay.initialize(), H.Ay.initialize(), eY.A.initialize(), ei.Ay.initialize(), ep.A.initialize(), C.A.initialize(), er.A.init(), P.A.init(), e6.A.init(), f.A.initialize(), ew.A.init(), e1.A.init(), ek.A.init(), eP.A.initialize(), ej.A.initialize(), eG.A.initialize(), eB.A.init(), V.A.initialize(), I.A.initialize(), eR.A.initialize(), e_.A.initialize(), eh.A.initialize(), em.A.initialize(), j.A.initialize(), D.A.initialize(), Y.A.initialize(), el.A.initialize(), es.A.initialize(), eT.A.initialize(), eE.A.initialize(), U.A.initialize(), R.A.initialize(), x.A.initialize(), this.rewriterUnlisten = eN.A.addRouteRewriter(this.ensureChannelMatchesGuild), this.historyUnlisten = eN.A.addRouteChangeListener(this.handleHistoryChange)
    }
    ...
    handleHistoryChange(e, t) {
        ...
        function(e, t) {
            ...
            let {
                ...
                messageId: a,
                threadId: s
            } = td(n), o = (0, eS.nn)(i), d = (0, eS.ts)(r), c = (0, eS.ts)(s), u = eJ.A.getGuildId(), _ = u !== i;
                ...
                if (d && o && null != r && null != ez.Ay.getCurrentSidebarChannelId(r) && eO.A.closeChannelSidebar(r), null != s && c) {
                    ...
                    if (null != r && null != s && t)
                        if (d)(0, ev.bG)(e4.BVt.CHANNEL(i, s, a));
                            ...
                            null != a && (e.initialMessageId = a), eO.A.openThreadAsSidebar({
                                guildId: i,
                                baseChannelId: r,
                                channelId: s,
                                details: e
    ...
    ensureChannelMatchesGuild(e) {
        ...
        if (null != r && (0, eS.ts)(r) && !(0, e8.jq)(r) && a) {
            ...
            else if (n.guild_id !== i && i !== e4.gNP) return {
                path: e4.BVt.CHANNEL(i),
                state: e.state
            };
            if (null != l) {
                ...
                else if (n?.parent_id !== r) return eO.A.closeChannelSidebar(r), {
                    path: e4.BVt.CHANNEL(i, r),
                    state: e.state
                }
            }
        }
