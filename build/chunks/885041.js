...
let tc = [{
    ...
    render: function(e) {
        return (0, e5.wR)() || eq.default.getLoginStatus() === e4.aUe.LOGGING_IN || !eq.default.allowLogoutRedirect() ? ta(e) : (0, i.jsx)(N.A, {
    ...
    path: [e4.BVt.CHANNEL_THREAD_VIEW(eS.pv.guildId(), eS.pv.channelId(), ":threadId", ":messageId?"), e4.BVt.CHANNEL(eS.pv.guildId(), eS.pv.channelId({
        optional: !0
    }), ":messageId?"), e4.BVt.ACTIVITY, e4.BVt.ACTIVITIES, e4.BVt.ACTIVITIES_HAPPENING_NOW, e4.BVt.APPLICATION_LIBRARY, e4.BVt.APPLICATION_STORE, e4.BVt.MESSAGE_REQUESTS, e4.BVt.COLLECTIBLES_SHOP, e4.BVt.COLLECTIBLES_SHOP_COLLECTION_DETAIL(":collectionId"), e4.BVt.COLLECTIBLES_SHOP_PRODUCT_DETAIL(":skuId"), e4.BVt.COLLECTIBLES_SHOP_LAYOUT(":layoutId"), e4.BVt.GUILD_DISCOVERY, e4.BVt.QUEST_HOME_DEPRECATED, e4.BVt.QUEST_HOME, e4.BVt.ICYMI, e4.BVt.GLOBAL_DISCOVERY, e4.BVt.GUILD_MEMBER_VERIFICATION(eS.pv.guildId()), e4.BVt.GUILD_MEMBER_VERIFICATION_FOR_HUB(eS.pv.guildId(), ":inviteCode?"), e4.BVt.GUILD_BOOSTING_MARKETING(eS.pv.guildId()), e4.BVt.GUILD_FEATURE(":feature", eS.pv.guildId()), e4.BVt.FEATURE(":feature"), e4.BVt.FAMILY_CENTER],
    render: ta,
    isChatRoute: !0
}, {
