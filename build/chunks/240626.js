...
function j(e) {
    let {
        ...
        useReducedMotion: u,
        fractionalState: _
    } = e, m = s.useMemo(() => null != t.cooldownEndsAt ? new Date(t.cooldownEndsAt) : null, [t]), g = (0, T.I5)(t), A = r?.isPaused === !0 && _ === N.xc.NONE, h = I.intl.string(I.t.mOWsF1);
    return (0, i.jsxs)("li", {
        className: v.Hp,
...
let O = function(e) {
    let t, n, l, {
        ...
        O = (0, r.bG)([x.default], () => x.default.getCurrentUser()),
