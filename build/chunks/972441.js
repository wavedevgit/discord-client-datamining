...
function c(e) {
    let {
        ...
        percent: h,
        onDragStateChange: p
    } = e, [E, x] = r.useState(null), [v, b] = r.useState(null), [g, y] = r.useState(!1), [A, C] = r.useState(!1), [S, N] = r.useState(null), [R, L] = r.useState(!1), {
        i18n: w
    } = (0, a.G98)(), T = r.useMemo(() => {
        let e = {
            role: "progressbar",
    ...
    return r.useEffect(() => () => {
        ...
        handleMouseDown: e => {
            ...
            k.current = !0, C(!0), p?.(!0), N(Math.max(0, Math.min(e.clientX - t.left, t.width))), B(e.clientX, t);
            let r = e => {
                    if (null != M.current) {
                        let t = M.current.getBoundingClientRect(),
                ...
                a = e => {
                    k.current = !1, I.current = null, C(!1), N(null), p?.(!1), L(!1), null != M.current && ((0, l.vq)(e.target, Node) && M.current.contains(e.target) || (y(!1), b(null))), window.removeEventListener("mousemove", r), window.removeEventListener("mouseup", a)
                };
