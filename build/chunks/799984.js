/** chunk id: 799984 params = (module,exports,require) **/
i.d(t, {
    A: () => m
});
var s = i(719129),
...
class h {
    ...
    destroy() {
        this.isInitialized && (o.info("Destroying Steam Game Events Manager"), this.stopPolling(), this.trackedProcesses.clear(), this.isInitialized = !1)
    }
    startPolling() {
    ...
    handleSteamProcessDiscovered(e) {
        this.trackedProcesses.has(e) || (o.info("Steam game events process discovered", {
            pid: e
    ...
    async watchSteamProcess(e) {
        try {
            ...
            o.info("Steam game events watcher attached successfully", {
                pid: e
            }), this.setupGameEventsListener(e)
        } catch (t) {
            o.error("Steam game events watcher error", {
                pid: e,
                error: t
            }), this.trackedProcesses.delete(e)
        }
    ...
    setupGameEventsListener(e) {
        ...
        null == t.startGameEvents ? o.warn("Steam game events native API not available") : t.startGameEvents(e, e => this.handleGameEvent(e), e => this.handleHelloMessage(e))
    }
    handleGameEvent(e) {
        let t;
        try {
            ...
            o.warn("Failed to parse Steam game event", {
                eventJson: e,
                error: t
            });
            return
        }
        "string" != typeof t.type || "object" != typeof t.payload ? o.warn("Invalid Steam game event format", {
            steamGameEvent: t
        }) : "steam_timeline" === t.type ? this.handleSteamTimeline(t.payload) : o.warn(`Unknown Steam game event type: ${t.type}`)
    }
    handleSteamTimeline(e) {
        for (let t of (o.info("Steam timeline event received", {
                timelineEntry: e
            }), this.timelineEventCallbacks)) try {
            t(e)
        } catch (e) {
            o.warn("Steam timeline event callback failed", {
                error: e
            })
        }
    }
