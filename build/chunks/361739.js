...
var g = ((s = {}).MINIMAL = "minimal", s.CUSTOM = "custom", s.DEFAULT = "default", s.WIDE = "wide", s.SCROLLABLE_CUSTOM = "scrollableCustom", s);
let I = Object.freeze({
...
let v = function(e) {
    let {
        ...
        toggleSidebar: g,
        hideSidebar: v = !1
    } = e, x = r.useRef(null), T = r.useRef(null), C = (0, _.A)(l), R = (0, h.pnh)(v, {
        from: {
            position: "absolute",
            opacity: 0
        },
    ...
    }, "animate-always"), j = r.useCallback(e => {
        x.current = e, null != f && (f.current = e)
    }, [f]);
    r.useLayoutEffect(() => {
        null != x.current && C !== l && x.current.scrollTo({
            to: 0
        })
    }, [l, C, x]);
    let O = (0, i.jsx)(b, {
    ...
    function L() {
        return null == s ? null : (0, i.jsx)(h.FQk, {
            className: o()(m.noticeRegion, {
                [m.noticeRegionHiddenSidebar]: v
            }),
            children: s
        }, l)
    }
    return (0, i.jsx)(i.Fragment, {
        children: R((e, s) => (0, i.jsxs)(a.animated.div, {
            style: e,
            className: m.standardSidebarView,
            children: [!s && (null == t ? null : (0, i.jsx)(h.NPJ, {
                theme: p,
                    ...
                    children: (0, i.jsx)(h.ChK, {
                        ...
                        children: (0, i.jsxs)("nav", {
                            className: o()(m.sidebar, {
                                [m.mobileSidebar]: d.Fr
                            }),
                            children: [d.Fr && (0, i.jsx)("div", {
                ...
                if ("custom" === E) return (0, i.jsxs)(u.F, {
                    component: "div",
                    className: m.contentRegion,
                    children: [t, n, !d.Fr && O, L()]
                });
                if ("scrollableCustom" === E) return (0, i.jsxs)(u.F, {
                    component: "div",
                    className: m.contentRegion,
                    children: [t, (0, i.jsxs)(h.GtU, {
                        className: o()(m.contentRegionScroller, v ? m.contentRegionHiddenSidebar : m.contentRegionShownSidebar),
                        ref: j,
