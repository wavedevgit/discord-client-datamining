...
var f = ((i = {}).MINIMAL = "minimal", i.CUSTOM = "custom", i.DEFAULT = "default", i.WIDE = "wide", i.SCROLLABLE_CUSTOM = "scrollableCustom", i);
let v = Object.freeze({
...
let C = function(e) {
    let {
        ...
        toggleSidebar: f,
        hideSidebar: C = !1
    } = e, b = r.useRef(null), j = r.useRef(null), T = (0, m.A)(l), O = (0, h.pnh)(C, {
        from: {
            position: "absolute",
            opacity: 0
        },
