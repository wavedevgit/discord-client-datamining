...
let v = n.forwardRef(function(e, t) {
    let {
        ...
        let t = [];
        for (let a of Object.values(e.currentTarget.audioTracks)) a.label.includes(m.gC.APPLICATION) ? a.enabled = !0 : a.label.includes(m.gC.VOICE) || a.label.includes(m.gC.SOUNDBOARD) ? (a.enabled = !1, t.includes(a.label) || t.push(a.label)) : a.enabled = !1;
        S(t)
    }, []);
    (0, s.A)(() => {
        E.current && w() && T()
