...
let v = n.forwardRef(function(e, t) {
    let {
        ...
        videoURL: k,
        audioURL: y
    } = (0, d.T)(), E = n.useRef({}), A = n.useRef(!1), [S, I] = n.useState([]), w = n.useCallback(() => {
    ...
    let L = n.useCallback(() => {
        ...
        M = n.useCallback(e => {
            for (let t of (E.current.main?.paused && (A.current = !1), Object.values(E.current))) null != t && (t.currentTime = e)
        }, []),
        O = n.useCallback(() => {
