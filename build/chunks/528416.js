/** Chunk was on web.js **/
/** chunk id: 528416, original params:  (module,exports,require) **/
(function() {
    function e(t, n, r) {
        function i(s, o) {
            if (!n[s]) {
        ...
        function u() {
            ...
            switch (u.browser) {
                ...
                case "firefox":
                    ...
                    c("adapter.js shimming firefox."), d.browserShim = s, l.shimAddIceCandidateNullOrEmpty(t, u), s.shimGetUserMedia(t, u), s.shimPeerConnection(t, u), s.shimOnTrack(t, u), s.shimRemoveStream(t, u), s.shimSenderGetStats(t, u), s.shimReceiverGetStats(t, u), s.shimRTCDataChannel(t, u), s.shimAddTransceiver(t, u), s.shimGetParameters(t, u), s.shimCreateOffer(t, u), s.shimCreateAnswer(t, u), l.shimRTCIceCandidate(t, u), l.shimConnectionState(t, u), l.shimMaxMessageSize(t, u), l.shimSendThrowTypeError(t, u);
                    break;
                case "edge":
                ...
                case "safari":
                    ...
                    c("adapter.js shimming safari."), d.browserShim = o, l.shimAddIceCandidateNullOrEmpty(t, u), o.shimRTCIceServerUrls(t, u), o.shimCreateOfferLegacy(t, u), o.shimCallbacksAPI(t, u), o.shimLocalStreamsAPI(t, u), o.shimRemoteStreamsAPI(t, u), o.shimTrackEventTransceiver(t, u), o.shimGetUserMedia(t, u), o.shimAudioContext(t, u), l.shimRTCIceCandidate(t, u), l.shimMaxMessageSize(t, u), l.shimSendThrowTypeError(t, u), l.removeExtmapAllowMixed(t, u);
                    break;
                default:
                ...
                var a = function(e) {
                        ...
                        return Object.keys(e).forEach(function(n) {
                            if ("require" !== n && "advanced" !== n && "mediaSource" !== n) {
                                ...
                                if (void 0 !== i.ideal) {
                                    ...
                                    var s = {};
                                    "number" == typeof i.ideal ? (s[a("min", n)] = i.ideal, t.optional.push(s), (s = {})[a("max", n)] = i.ideal) : s[a("", n)] = i.ideal, t.optional.push(s)
                                }
                    ...
                    s = function(e, s) {
                        ...
                        if (e && "object" === r(e.video)) {
                            ...
                            l = l && ((void 0 === l ? "undefined" : r(l)) === "object" ? l : {
                                ideal: l
                            });
                            var c = t.version < 66;
                            if (l && ("user" === l.exact || "environment" === l.exact || "user" === l.ideal || "environment" === l.ideal) && !(n.mediaDevices.getSupportedConstraints && n.mediaDevices.getSupportedConstraints().facingMode && !c)) {
                                ...
                                var u = void 0;
                                if ("environment" === l.exact || "environment" === l.ideal ? u = ["back", "rear"] : ("user" === l.exact || "user" === l.ideal) && (u = ["front"]), u) return n.mediaDevices.enumerateDevices().then(function(t) {
                                    ...
                                    return !n && t.length && u.includes("back") && (n = t[t.length - 1]), n && (e.video.deviceId = l.exact ? {
                                        exact: n.deviceId
                                    } : {
                                        ideal: n.deviceId
                                    }), e.video = a(e.video), i("chrome: " + JSON.stringify(e)), s(e)
                                })
                            }
                            e.video = a(e.video)
                        }
        ...
        function c(e, t) {
            if (e.RTCPeerConnection) {
                ...
                var n = function(e) {
                    ...
                    a = function(e) {
                        var n = 65536;
                        return "firefox" === t.browser && (n = t.version < 57 ? -1 === e ? 16384 : 0x7ffffff5 : t.version < 60 ? 57 === t.version ? 65535 : 65536 : 0x7ffffff5), n
                    },
                    s = function(e, n) {
                        var r = 65536;
                        "firefox" === t.browser && 57 === t.version && (r = 65535);
                        var a = i.default.matchPrefix(e.sdp, "a=max-message-size:");
                        return a.length > 0 ? r = parseInt(a[0].substr(19), 10) : "firefox" === t.browser && -1 !== n && (r = 0x7ffffff5), r
                    },
            ...
            if ((void 0 === e ? "undefined" : r(e)) === "object" && (e.RTCPeerConnection || e.mozRTCPeerConnection)) {
                ...
                e.RTCPeerConnection.prototype.getStats = function() {
                    var e = Array.prototype.slice.call(arguments),
                        ...
                        a = e[1],
                        s = e[2];
                    return i.apply(this, [r || null]).then(function(e) {
            ...
            if ((void 0 === e ? "undefined" : r(e)) === "object" && e.RTCPeerConnection) {
                ...
                t && (e.RTCPeerConnection.prototype.addTransceiver = function() {
                    ...
                    if (n) {
                        var i = r.sender,
                            a = i.getParameters();
                        "encodings" in a && (1 !== a.encodings.length || 0 !== Object.keys(a.encodings[0]).length) || (a.encodings = e.sendEncodings, i.sendEncodings = e.sendEncodings, this.setParametersPromises.push(i.setParameters(a).then(function() {
        ...
        function s(e, t) {
            ...
            if (n.getUserMedia = function(e, t, r) {
                ...
                if (n.mediaDevices.getUserMedia = function(e) {
                        return (void 0 === e ? "undefined" : r(e)) === "object" && "object" === r(e.audio) && (s((e = JSON.parse(JSON.stringify(e))).audio, "autoGainControl", "mozAutoGainControl"), s(e.audio, "noiseSuppression", "mozNoiseSuppression")), o(e)
                ...
                if (a && a.prototype.applyConstraints) {
                    ...
                    a.prototype.applyConstraints = function(e) {
                        return "audio" === this.kind && (void 0 === e ? "undefined" : r(e)) === "object" && (s(e = JSON.parse(JSON.stringify(e)), "autoGainControl", "mozAutoGainControl"), s(e, "noiseSuppression", "mozNoiseSuppression")), c.apply(this, [e])
                    }
                }
            }
        }
    ...
    10: [function(e, t, n) {
        ...
        n.shimLocalStreamsAPI = s, n.shimRemoteStreamsAPI = o, n.shimCallbacksAPI = l, n.shimGetUserMedia = c, n.shimConstraints = u, n.shimRTCIceServerUrls = d, n.shimTrackEventTransceiver = f, n.shimCreateOfferLegacy = p, n.shimAudioContext = _;
        var i = a(e("../utils"));
        ...
        function l(e) {
            if ((void 0 === e ? "undefined" : r(e)) === "object" && e.RTCPeerConnection) {
                ...
                t.setLocalDescription = l, l = function(e, t, n) {
                    var r = s.apply(this, [e]);
                    return n ? (r.then(t, n), Promise.resolve()) : r
                }, t.setRemoteDescription = l, l = function(e, t, n) {
                ...
                e.RTCPeerConnection = function(e, n) {
                    if (e && e.iceServers) {
                        for (var r = [], a = 0; a < e.iceServers.length; a++) {
                            ...
                            !s.hasOwnProperty("urls") && s.hasOwnProperty("url") ? (i.deprecated("RTCIceServer.url", "RTCIceServer.urls"), (s = JSON.parse(JSON.stringify(s))).urls = s.url, delete s.url, r.push(s)) : r.push(e.iceServers[a])
                        }
                        e.iceServers = r
                    }
                    return new t(e, n)
    ...
    11: [function(e, t, n) {
        ...
        n.extractVersion = o, n.wrapPeerConnectionEvent = l, n.disableLog = c, n.disableWarnings = u, n.log = d, n.deprecated = f, n.detectBrowser = p, n.compactObject = h, n.walkStats = m, n.filterStats = g;
        var a = !0,
            s = !0;
        ...
        function u(e) {
            return "boolean" != typeof e ? Error("Argument type: " + (void 0 === e ? "undefined" : r(e)) + ". Please use a boolean.") : (s = !e, "adapter.js deprecation warnings " + (e ? "disabled" : "enabled"))
        }

        function d() {
            ("u" < typeof window ? "undefined" : r(window)) === "object" && !a && "u" > typeof console && "function" == typeof console.log && console.log.apply(console, arguments)
        }
        ...
        function p(e) {
            ...
            var n = e.navigator;
            return n.mozGetUserMedia ? (t.browser = "firefox", t.version = o(n.userAgent, /Firefox\/(\d+)\./, 1)) : n.webkitGetUserMedia || !1 === e.isSecureContext && e.webkitRTCPeerConnection && !e.RTCIceGatherer ? (t.browser = "chrome", t.version = o(n.userAgent, /Chrom(e|ium)\/(\d+)\./, 2)) : n.mediaDevices && n.userAgent.match(/Edge\/(\d+).(\d+)$/) ? (t.browser = "edge", t.version = o(n.userAgent, /Edge\/(\d+).(\d+)$/, 2)) : e.RTCPeerConnection && n.userAgent.match(/AppleWebKit\/(\d+)\./) ? (t.browser = "safari", t.version = o(n.userAgent, /AppleWebKit\/(\d+)\./, 1), t.supportsUnifiedPlan = e.RTCRtpTransceiver && "currentDirection" in e.RTCRtpTransceiver.prototype) : t.browser = "Not a supported browser.", t
        }
        ...
        r.generateIdentifier = function() {
            ...
            for (var t = {
                ...
                if (s) {
                    ...
                    switch (o.parameters = l.length ? r.parseFmtp(l[0]) : {}, o.rtcpFeedback = r.matchPrefix(e, "a=rtcp-fb:" + a + " ").map(r.parseRtcpFb), t.codecs.push(o), o.name.toUpperCase()) {
                        case "RED":
                        case "ULPFEC":
