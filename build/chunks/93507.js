/** chunk id: 93507, original params: e,t,n (module,exports,require) **/
"use strict";
n.d(t, {
    A: () => N
}), n(492834), n(65821), n(896048), n(122143);
var r = n(284009),
    i = n.n(r),
    a = n(214958),
    o = n.n(a),
...
class N extends s.A {
    destroy() {
        ...
        null != this.voiceActivityInput && (this.voiceActivityInput.destroy(), this.voiceActivityInput = null), this.eachConnection(t => t.destroy(e)), this.emit(f.bg.Destroy), this.removeAllListeners()
    }
    interact() {
        this.interacted || (document.createElement("audio").play(), this.interacted = !0), this.eachConnection(e => e.interact())
    }
    static supported() {
        return !__OVERLAY__ && (S.Hz && null != window.AudioContext && null != window.RTCPeerConnection ? (n(528416), !0) : (C.info("WebRTC is not supported on", o().name, o().version), !1))
    }
    supported() {
        return !0
    }
    ...
    async _enable() {
        ...
        try {
            var t;
            await e.enable(), "Firefox" === o().name && await this.handleDeviceChange(), this.enabled = !0, this.eachConnection(e => e.input.enableAudioInput(), I.x.DEFAULT), null == (t = this.voiceActivityInput) || t.enable()
        } finally {
            e.destroy()
        }
    }
    ...
    constructor() {
        super(), T(this, "Video", A.A), T(this, "Camera", v.A), T(this, "_audioContext", null), T(this, "outputVolume", I.Hz), T(this, "sourceId", I.dx), T(this, "sinkId", I.dx), T(this, "videoInputDeviceId", I.qe), T(this, "enabled", !1), T(this, "connections", new Set), T(this, "interacted", !1), T(this, "loopback", null), T(this, "voiceActivityInput", null), T(this, "desktopInputPool", new O.A), T(this, "enablePromise", null), T(this, "dave", null), T(this, "transientKeys", null), T(this, "maxSupportedProtocolVersion", null), T(this, "handleActiveSinksChange", (e, t) => {
            ...
            switch (e) {
                ...
                case f.bg.VoiceActivity:
                    null == this.voiceActivityInput && (this.voiceActivityInput = new h.A(this.getAudioContext()), this.voiceActivityInput.setSource(this.sourceId), this.voiceActivityInput.on("voiceactivity", this.handleVoiceActivity), this.enabled && this.voiceActivityInput.enable())
            }
        }), T(this, "handleRemoveListener", e => {
            switch (e) {
                case f.bg.DeviceChange:
                    var t;
                    (null == (t = navigator.mediaDevices) ? void 0 : t.ondevicechange) != null && 0 === this.listenerCount(f.bg.DeviceChange) && (navigator.mediaDevices.ondevicechange = null);
                    break;
                case f.bg.VoiceActivity:
                    null != this.voiceActivityInput && 0 === this.listenerCount(f.bg.VoiceActivity) && (this.voiceActivityInput.destroy(), this.voiceActivityInput = null)
            }
        }), T(this, "handleDeviceChange", () => (0, g.oG)().then(e => {
            let [t, n, r] = e;
        ...
        }), this.on("newListener", this.handleNewListener), this.on("removeListener", this.handleRemoveListener), (0, _.EV)(this.handleActiveSinksChange), (0, p.A)(this)
    }
}