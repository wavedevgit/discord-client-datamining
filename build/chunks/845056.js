...
function d(e, t) {
    return (0, i.bG)([a.A, l.A, s.default], () => {
        let n = (e.id === s.default.getId() ? a.A.getActivities() : l.A.getActivities(e.id)).filter(c).filter(e => !(0, r.A)(e) && (null == t || (null == t.application_id || e.application_id !== t.application_id) && (null == t.name || e.name !== t.name))),
            i = new Map;
        for (let e of n) {
