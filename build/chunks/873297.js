...
let S = e => {
    ...
    let P = (0, a.bG)([_.A], () => {
        ...
        M = (t = r.useRef([]), r.useEffect(() => {
            if (null != B)
                for (let e of I)(0, d.qf)(B, e)
        }, [I, B]), s = (0, a.bG)([f.A], () => !I.some(e => f.A.isFetching(e)) && I.some(e => f.A.didFetchingSkuFail(e)), [I]), r.useEffect(() => {
            s && null != B && (0, d.Rw)(B)
        }, [s, B]), S = (0, a.yK)([f.A, _.A], () => {
            ...
            let n = new Set(I);
            return [...e, ...null != s.storefront ? (0, c.jd)(s.storefront).filter(e => !n.has(e) && null != f.A.get(e)) : []].slice(0, I.length)
        }, [I, B]), r.useEffect(() => {
    ...
    let H = (0, C.uM)(),
        ...
        z = r.useCallback(() => {
            null != B && (K("go_to_game_shop"), (0, g.default)({
                guildId: B
            }))
        }, [K, B]),
        V = r.useCallback((e, t) => {
