/** chunk id: 873297 params = (module,exports,require) **/
"use strict";
s.d(t, {
    A: () => A
});
...
let A = e => {
    let t, s, A, {
        ...
        M = (t = r.useRef([]), r.useEffect(() => {
        ...
        }, [v, B]), s = (0, i.bG)([p.A], () => !v.some(e => p.A.isFetching(e)) && v.some(e => p.A.didFetchingSkuFail(e)), [v]), r.useEffect(() => {
            s && null != B && (0, d.Rw)(B)
        }, [s, B]), A = (0, i.yK)([p.A, _.A], () => {
            ...
            let n = new Set(v);
            return [...e, ...null != s.storefront ? (0, c.jd)(s.storefront).filter(e => !n.has(e) && null != p.A.get(e)) : []].slice(0, v.length)
        }, [v, B]), r.useEffect(() => {
        ...
        z = r.useCallback(() => {
            null != B && (V("go_to_game_shop"), (0, g.default)({
                guildId: B
            }))
        }, [V, B]),
        K = r.useCallback((e, t) => {
        ...
        $ = r.useCallback(e => {
            !H.current && (e && null === F.current ? F.current = setTimeout(() => {
                H.current = !0, F.current = null, f.default.track(E.HAw.COLLECTIBLES_TILE_IMPRESSION, {
                    collectibles_shop_session_id: P?.sessionId,
                    page_type: L,
                    page_category: P?.pageCategory,
                    page_section: P?.pageSection,
                ...
                children: [(0, n.jsx)("div", {
                    ...
                    children: [(0, n.jsx)("div", {
                        ...
                        children: (0, n.jsx)(l.Exy, {
                            type: {
                                text: `${b.intl.string(b.t.yYEZGi)} (${U})`
                            },
                            variant: "brand"
                        })
                    }), (0, n.jsxs)("div", {
                    ...
                    children: (0, n.jsx)("div", {
                        className: C.$2,
                        children: M.map((e, t) => (0, n.jsx)(h.A, {
                            skuId: e,
                            positionInSection: t,
                            onClick: K
                        }, e))
