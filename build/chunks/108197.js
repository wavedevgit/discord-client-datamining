...
let j = l.memo(function(e) {
    ...
    })), G = (0, o.bG)([A.A], () => A.A.isMuted(t.id)), P = l.useCallback(e => {
    ...
    }, [t.id]), B = null == O ? 0 : O.length, {
        role: V,
        ...H
    } = (0, r.rm)(t.id), F = l.useRef(null), W = D > 0 ? T.intl.formatToPlainString(T.t["ZL7+I6"], {
        channelName: t.name,
        mentionCount: D
    }) : M ? T.intl.formatToPlainString(T.t.YlVvmc, {
        channelName: t.name
    }) : T.intl.formatToPlainString(T.t["0nZpiF"], {
        channelName: t.name
    });
    return (0, i.jsxs)("li", {
        role: V,
                ...
                children: [!M || G || s ? null : (0, i.jsx)("div", {
                    ...
                    children: (0, i.jsxs)("div", {
                        ...
                        children: [(0, i.jsx)(d.A, {
                            ...
                            className: b.Y_,
                            children: [B > 0 && t.userLimit > 0 ? (0, i.jsx)(x.A, {
                                userCount: B,
                                video: L,
                                channel: t
                            }) : null, (0, E.A)(D) ? (0, i.jsx)(I.A, {
                                mentionsCount: D,
                                isMentionLowImportance: U
                            }) : null]
                        })]
