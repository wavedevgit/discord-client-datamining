/** chunk id: 449000 params = (module,exports,require) **/
n.d(t, {
    A: () => u
});
var i = n(311907),
...
let u = new c(r.h, {
    ...
    LOAD_ICYMI_DEHYDRATED: function(e) {
        ...
        for (let e of t) e.type !== a.Mm.MESSAGE || null != d.readIdToTimestampMap[e.id] || e.data.message_context?.external_content_application_id != null || (0, s.$r)(e.data.channel_id, e.data.message_id) || (d.readIdToTimestampMap[e.id] = 0)
    },
