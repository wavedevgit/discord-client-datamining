...
function u(e) {
    ...
    } = e, h = (0, r.bG)([a.A], () => a.A.isConnected()), p = (0, r.bG)([o.A], () => null != t ? o.A.getSubscriptionGroupListingsForGuildFetchState(t) : o.e.FETCHED), g = l.useRef(c), A = l.useCallback(() => {
    ...
    }, [h, t, u, _, m]), x = l.useMemo(() => p === o.e.FETCHED && !0 !== g.current, [p, g]);
