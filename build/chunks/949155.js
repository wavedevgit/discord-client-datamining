...
function b(e) {
    let {
        invite: t,
        showBigUserIcon: n
    } = e, r = s.useMemo(() => n ? null : I(t) && null != t.target_user ? _.Ay.getUserAvatarURL(t.target_user) : j(t) && null != t.inviter ? _.Ay.getUserAvatarURL(t.inviter) : null, [t, n]), l = A.intl.string(A.t["3rE1P8"]);
...
function R(e) {
    let t, n, s, {
        ...
        g = (0, c.Ay)(d);
    if (null != l) p && null == _ && (t = (0, i.jsx)(o.$v, {
        guild: l,
        ...
        children: [(0, i.jsx)(o.tK, {
            className: f.R9,
            children: A.intl.string(A.t["3gg9fF"])
        }), (0, i.jsxs)("div", {
            className: f.bo,
        ...
        n = A.intl.formatToPlainString(A.t["4aF92R"], {
            ...
            className: f.b$,
            children: A.intl.format(A.t.Quj7HX, {
                username: e
            })
        })
    }
