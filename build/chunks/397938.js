...
function N(e) {
    let {
        ...
        popoutProps: u,
        ref: h
    } = e, p = (0, l.Vd)("notifications-inbox"), [f, E] = s.useState(!1), N = (0, m.lI)(), S = n || N, {
    ...
    }(S), R = T === g.U5.LEGACY ? o.K$s : o.XFE, O = (0, r.bG)([A.A], () => A.A.getChannelId()), L = s.useMemo(() => {
...
function S() {
    let e = s.useRef(null),
        ...
        n = b(),
        l = (0, _.HN)();
    return t === g.U5.SIDEBAR ? (0, i.jsx)(N, {
        onClick: l
    }) : t === g.U5.POPOUT ? (0, i.jsx)(f.A, {
        targetElementRef: e,
        popoutPosition: "right",
        popoutAlign: "bottom",
        children: (t, n, s) => (0, i.jsx)(N, {
            ref: e,
            selectedOverride: n,
            onClick: () => {
                l(), t()
