...
function g(e) {
    let {
        channel: t
    } = e, [n] = t.recipients, g = (0, l.bG)([r.default], () => r.default.getUser(n)), p = (0, l.bG)([r.default], () => r.default.getCurrentUser()), f = (0, d.A)(), [x, E] = (0, c.A)(n);
    if (s.useEffect(() => {
            (0, u.A)(g ?? n, {
                type: "sidebar",
    ...
    let C = `user-profile-sidebar-heading-${g.id}`,
