    ...
    return (0, i.jsxs)(d.nVY, {
        ...
        children: [(0, i.jsx)(d.dOG, {
            ...
            children: [(0, i.jsx)(d.Text, {
                ...
                onMarkerRender: e => e === I[I.length - 1] ? C.intl.string(C.t["4rbMWc"]) : `${100*e}%`
            })]
        }), (0, i.jsx)(O, {
            disabled: u,
            locations: [{
...
function k(e) {
    let {
    ...
    } = e, l = (0, a.cf)([x.A], () => x.A.getState()), [r, o] = s.useState({
        x: 0,
        y: 0
    }), c = (0, T.A)(), u = (e, t) => {
        var i, s, a, o, d, u, g, A;
        if (e.enabled && !1 === l.enabled && (n(!0), (0, _.Ak)("poggermode_enabled"), (0, m.fO)({
                duration: 2e3,
        ...
        let x = (d = l.screenshakeEnabled, u = e.screenshakeEnabled, g = l.enabled, A = e.enabled, (u ?? d) && (A ?? g));
        1 === t && x && (0, m.fO)({
            duration: 1e3,
            intensity: e.shakeIntensity ?? l.shakeIntensity
        })
...
function w() {
    let [e, t] = s.useState(0), [n, l] = s.useState(V(e)), [r, o] = s.useState(!1), _ = (0, a.bG)([c.A], () => c.A.useReducedMotion), g = r && !_;
    return s.useEffect(() => {
        let t = setTimeout(() => {
            l(V(e))
        }, 500);
