...
let E = function(e) {
    let {
        ...
        dismissable: E,
        classificationId: N
    } = e, [I, k] = i.useState(r.M.AGE_VERIFICATION_SURVEY_MODAL_GET_STARTED), R = i.useRef(I), [O, w] = (0, d.kn)([I], void 0, !0), D = i.useMemo(() => (0, s.A)(), []), M = i.useRef(!1), P = (0, m.W$)();
    i.useEffect(() => {
        R.current = O
    }, [O]);
    let {
    ...
    return i.useLayoutEffect(() => () => {
        ...
        title: (0, f.ST)(n),
        subtitle: (0, f.mK)(n, () => {
            p.A.openUrl(x.A.getArticleURL(v.MVz.TIGGER_PAWTECT_LEARN_MORE)), (0, g.St)(D, g.WU.EXPRESSIVE_PRIMARY, g._7.LEARN_MORE)
        }, P),
        actionBarInput: (0, a.jsx)(y, {
            modalSessionId: D,
            entryPoint: n
        }),
