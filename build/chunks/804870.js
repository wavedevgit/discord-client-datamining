...
function R(e) {
    let {
        item: t,
        cardSize: r = j.Y.SMALL,
        remainingCount: l,
        onClick: u,
        renderItemPreview: o
    } = e, c = n.useRef(null), a = n.useRef(null), {
        isHoveringOrFocusing: I
    } = (0, g.A)(a), h = !0 === t.isOwned;
    return (0, i.jsx)("div", {
        ref: c,
        className: y.kL,
...
function T(e) {
    let {
    ...
    }, [H.pathname, b.skuId, P, N, D, t, s, U]), V = w === j.Y.MEDIUM_SQUARE, J = n.useCallback(() => {
        ...
        return l === E.uS.POPULAR ? (0, i.jsx)("div", {
            className: y.Fx,
