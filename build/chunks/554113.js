/** chunk id: 554113 params = (module,exports,require) **/
l.d(t, {
    B: () => _,
    G1: () => x,
    jB: () => m,
...
async function m(e, t) {
    ...
    l.has(u.GuildFeatures.COMMUNITY) ? t ? l.delete(u.GuildFeatures.RAID_ALERTS_DISABLED) : l.add(u.GuildFeatures.RAID_ALERTS_DISABLED) : t ? l.add(u.GuildFeatures.NON_COMMUNITY_RAID_ALERTS) : l.delete(u.GuildFeatures.NON_COMMUNITY_RAID_ALERTS), await r.A.saveGuild(e.id, {
        features: l
    }, {
        throwErr: !0
    })
}
async function h(e, t, l, n) {
    let a = s()().add(n, "hours").toISOString();
    return await i.Bo.put({
        url: u.Rsh.GUILD_INCIDENT_ACTIONS(e),
        body: {
            invites_disabled_until: t ? a : null,
            dms_disabled_until: l ? a : null
        },
        rejectWithError: !1
    })
}
