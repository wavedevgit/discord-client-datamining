/** chunk id: 417628 params = (module,exports,require) **/
n.d(t, {
    c: () => x
});
var i = n(627968),
...
function _(e) {
    ...
    (0, s.A)({
        title: g.intl.string(g.t.LX0nT8),
        subtitle: e.body.message
    })
}
async function x() {
    ...
    n.filter(e => e.owner_user_id === t.id).length > 0 ? (0, s.A)({
        title: g.intl.string(g.t.UNGZDI),
        subtitle: g.intl.string(g.t.alpAUm)
