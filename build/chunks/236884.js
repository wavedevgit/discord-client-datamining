...
function en(e) {
    ...
    let p = d?.discoverable !== !1 ? d : null,
        ...
        y = i.useMemo(() => (0, r.uniqWith)(u?.filter(e => {
            let {
                type: t,
                name: n
            } = e;
            return t !== Q.$pd.CUSTOM_STATUS && t !== Q.$pd.HANG_STATUS && n !== N?.name
        }) ?? [], (e, t) => null != e.application_id && null != t.application_id && e.application_id === t.application_id || null != e.name && null != t.name && e.name === t.name), [u, N?.name]),
        C = y?.[0];
    return (0, l.jsxs)("div", {
        className: q.fE,
        children: [(t = y?.length > 0, (0, l.jsxs)("div", {
            className: q._9,
            children: [!t && !T && null != S && (0, l.jsxs)("div", {
                className: q.j1,
            ...
            return null == e && null == t ? null : (0, l.jsxs)("div", {
                className: q._9,
                children: [null != t ? (0, l.jsx)(A.A, {
                    icon: t,
                    className: q.WT
                }) : void 0, null != e ? (0, l.jsx)(o.Text, {
                    variant: s,
...
function el(e) {
    ...
    }, [E, u, r, m]), v = (0, a.yK)([P.A], () => P.A.getActivities().filter(e => e.type === Q.$pd.PLAYING && null != e.application_id)), {
        voiceChannel: M
    } = (0, g.A)({
        userId: t.id
    }), {
    ...
    }, [t.id, n]), L = v.length > 0, b = i.useCallback(e => {
        f?.(m, e, L)
    }, [f, m, L]), k = (0, s.K)(b), j = i.useMemo(() => n?.find(Z.A), [n]), V = (0, p.A)({
        activity: j,
        user: t
    }), H = (0, S.zD)(V) ? V : void 0, Y = i.useCallback(() => {
        if (null != H) {
            let e = H.traits,
                t = {
                    ...H,
    ...
    return {
        ...
        renderSubtext: Y,
        renderUserContextMenu: i.useCallback(e => {
            A?.({
                type: K.K.FRIEND_ROW,
                event: e,
                user: t,
...
let er = i.memo(e => {
    let {
        ...
        return {
            guildId: null != e ? w.A.getChannel(e)?.guild_id : null,
            channelId: e
        }
    }), j = (0, T.A)({
        userId: t.id,
        guildId: b
    }), J = V.Ay.useName(b, P, t), et = i.useCallback(e => {
        e.preventDefault(), e.stopPropagation(), d?.({
            type: K.c.OPEN_DIRECT_MESSAGE,
            userId: t.id
        }), r?.()
    }, [r, d, t.id]), en = n.some(Z.A), er = (0, W.b4)(), es = i.useMemo(() => {
        let e = er?.altId ?? er?.id;
        return null != e && n.some(t => (0, Z.A)(t) && t.application_id === e)
    }, [n, er]), ea = O !== Q.clD.ONLINE && O !== Q.clD.IDLE && O !== Q.clD.DND, eu = (0, X.A2)(t.id), eo = i.useCallback(e => {
        let i = [],
            r = e || es;
        return e && i.push((0, l.jsx)(z.j, {
            tab: H.x.FRIENDS,
            targetId: t.id
        }, "favorite")), r && i.push((0, l.jsx)(B.r, {
            userId: t.id,
            friendActivities: n,
            currentUserPlayingActivities: U,
            gameProfileEntry: _,
            onPrimaryAction: d
        }, "game-action")), en && i.push((0, l.jsx)("div", {
            className: q.im,
            children: (0, l.jsx)($.B, {
                activities: n,
                gameProfileEntry: _,
        ...
        }, "activity-icon")), i.length > 0 ? i : null
    }, [n, U, _, en, es, d, t.id]);
    return (0, l.jsx)(Y.D, {
        listItemId: p,
        outerRef: N,
        leftIndicator: (0, l.jsx)(R.A, {
            unread: F
        }),
...
let es = i.memo(e => {
    let {
        ...
        userId: t.id,
        guildId: null
    }), G = V.Ay.useName(null, null, t), [w, L] = i.useState(!1), F = i.useRef(null), b = i.useCallback(() => {
        L(!0), null != F.current && clearTimeout(F.current), F.current = setTimeout(() => {
            L(!1), F.current = null
        }, 2e3)
    }, []);
    i.useEffect(() => () => {
    ...
    let k = i.useCallback(e => {
        ...
        P = i.useCallback(e => {
            e.preventDefault(), e.stopPropagation(), w || (b(), c?.({
                type: K.c.ACCEPT_FRIEND_REQUEST,
                userId: t.id
            }))
        }, [t.id, c, w, b]),
        j = i.useCallback(e => {
            e.preventDefault(), e.stopPropagation(), w || (b(), c?.({
                type: K.c.DECLINE_FRIEND_REQUEST,
                userId: t.id
            }))
        }, [t.id, c, w, b]),
        H = i.useCallback(e => {
            e.preventDefault(), e.stopPropagation(), w || (b(), c?.({
                type: K.c.CANCEL_FRIEND_REQUEST,
                userId: t.id
            }))
        }, [t.id, c, w, b]),
        W = i.useCallback(e => {
            e.preventDefault(), e.stopPropagation(), w || (b(), c?.({
                type: K.c.SEND_FRIEND_REQUEST,
                userId: t.id
            }))
        }, [t.id, c, w, b]),
        z = n.some(e => {
    ...
    return (0, l.jsx)(Y.D, {
        ...
        rightActions: () => (0, l.jsxs)(l.Fragment, {
            ...
            }) : null, r === Q.eA$.PENDING_INCOMING ? (0, l.jsxs)(l.Fragment, {
            ...
            }) : r === Q.eA$.PENDING_OUTGOING ? (0, l.jsx)(u.m_, {
...
let ea = i.memo(e => "friend_request" === function(e) {
    let {
        relationshipType: t,
        isSuggestion: n
    } = e;
