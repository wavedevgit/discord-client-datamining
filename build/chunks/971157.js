...
function C(e) {
    ...
    return (0, i.jsx)(a.ConfirmModal, {
        ...s,
        title: T.intl.formatToPlainString(T.t["rL9d/1"], {
            applicationName: t.name
        }),
        subtitle: T.intl.format(T.t.FGE8ya, {
            applicationName: t.name
        }),
        ...
        onConfirm: () => {
            u.A.disableIntegration(n.id, l.id).catch(() => {
                d.A.show({
                    title: T.intl.string(T.t.wYqMmI),
                    body: T.intl.string(T.t.A4Mnst)
                })
            })
        }
    })
...
function I(e) {
    let {
        ...
        let e = [{
            icon: o.O4,
            text: T.intl.formatToPlainString(T.t.gcdJ8J, {
                timestamp: p.default.extractTimestamp(S.id)
            })
        }];
        return null != S.user && e.push({
            icon: o.nys,
            text: T.intl.formatToPlainString(T.t.qE7oqs, {
