...
let m = r.memo(function(e) {
    ...
    } = e, g = t?.isPrivate() ?? !1, A = t?.isMultiUserDM() ?? !1, x = n?.id, I = (0, l.bG)([d.A], () => null != x ? d.A.getStatus(x) : null, [x]), E = (0, l.bG)([d.A], () => null != x && d.A.isMobileOnline(x), [x]);
    if (g || A) return (0, a.jsx)(c.h, {
        channel: t ?? null,
        user: n,
        "aria-hidden": !0,
        size: h(_, "user"),
