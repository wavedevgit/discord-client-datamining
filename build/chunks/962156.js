...
function C(e) {
    ...
    let {
        ...
        previewMessage: L,
        ...T
    } = e, k = i.useMemo(() => null == r ? null : (0, o._5)(r.id), [r]), [D, M] = i.useState(!1), {
        commands: w,
        loading: E
    } = (t = i.useMemo(() => null == r ? {
        type: "contextless"
    ...
    })), P = i.useRef(0), [I, q] = i.useState(j && null != k ? [k] : []), F = I.length, G = F >= 5, [z, R] = i.useState(""), {
        results: H,
        updateSearchText: U
    } = (0, c.R)({
        ...
        R(e), U(e)
    }, [U]), O = i.useCallback(() => (N(!1), C()), [N, C]), [B] = (0, u.A)([n]), J = i.useCallback(() => {
        R("")
    }, [R]), Q = i.useRef(null);
    i.useEffect(() => {
        "" === z && Q.current?.focus()
    ...
    let V = i.useCallback(e => {
        ...
        Z = i.useCallback(async function(e) {
            let {
                closeAfterSend: t
