...
function G(e) {
    ...
    t = s.useMemo(() => null == x || x.length > 50 ? {} : {
        [l.getGuildId()]: x.map(e => {
            let {
                user: t
            } = e;
            return t.id
    ...
    let v = (0, u.Ay)(l),
        ...
        G = (0, a.bG)([E.A, C.A, _.default], () => {
            let e = {};
            return D.forEach(t => {
                let n = t.user.id === _.default.getId() ? E.A.findActivity(d.N, !0) : C.A.findActivity(t.user.id, d.N);
                if (null != n && !(0, A.A)(n)) {
    ...
    return (s.useEffect(() => {
        ...
        children: [(0, i.jsx)(U, {
            channel: l,
            isChannelSelected: I,
            voiceStatesCount: x?.length ?? 0
        }), (0, i.jsx)("div", {
            className: M.zN
        }), j.map((e, t) => (0, i.jsx)(T.A, {
            embeddedApp: e,
            ...
            return P && null != r.application_id && O.sQ.has(r.application_id) ? (0, i.jsxs)(s.Fragment, {
            ...
            }, `${t}-with-gifting-breadcrumb`) : (0, i.jsx)(T.A, {
                presenceActivity: r,
                channel: l,
                members: n,
                onAction: f
                    ...
                    children: L.intl.format(L.t.ePyoY2, {
                        onClick: () => {
                            (0, o.mMO)(async () => {
                                let {
                                    default: e
                                } = await Promise.all([n.e("62175"), n.e("2292"), n.e("67231"), n.e("62733"), n.e("83518"), n.e("94604"), n.e("34749"), n.e("12664"), n.e("44667"), n.e("7803"), n.e("55090"), n.e("84704"), n.e("67646"), n.e("50224"), n.e("7525"), n.e("75049")]).then(n.bind(n, 585265));
                                return t => (0, i.jsx)(e, {
                                    ...t,
                                    guild: p
                                })
...
function U(e) {
    let {
        ...
        isChannelSelected: n,
        voiceStatesCount: s
    } = e, l = (0, a.bG)([x.A], () => !x.A.can(R.xBc.CONNECT, t)), o = (0, a.bG)([I.A], () => I.A.hasVideo(t.id)), c = (0, S.Ay)({
        channel: t,
        locked: l,
        video: o,
        selected: n
