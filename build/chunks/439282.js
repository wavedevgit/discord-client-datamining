...
function P(e) {
    ...
    }, [l, C]), (0, c.Eq)(t, "VoiceChannelActivities");
    let j = (0, u.Ay)(l),
        R = Array.from((0, u.Rz)(j).values()),
        U = (0, g.W)(),
        P = C?.filter(b.Vq) ?? [],
        k = (0, r.bG)([I.A, E.A, f.default], () => {
            let e = {};
            return P.forEach(t => {
                let n = t.user.id === f.default.getId() ? I.A.findActivity(d.N, !0) : E.A.findActivity(t.user.id, d.N);
                if (null != n && !(0, A.A)(n)) {
    ...
    return (s.useEffect(() => {
        B && S.default.track(O.HAw.OPEN_POPOUT, {
            type: "Voice Channel Activities",
            channel_id: l.id
        })
    }, [B, l.id]), B) ? (0, i.jsxs)(o.HOs, {
        className: a()(G.kL, {
            [G.iA]: y
        }),
        children: [(0, i.jsx)(w, {
            ...
            return (null != U && (r = U), V && null != r && L.sQ.has(r)) ? (0, i.jsxs)(s.Fragment, {
...
function w(e) {
    let {
        ...
        isChannelSelected: n,
        voiceStatesCount: s
    } = e, l = (0, r.bG)([C.A], () => !C.A.can(O.xBc.CONNECT, t)), o = (0, r.bG)([N.A], () => N.A.hasVideo(t.id)), c = (0, T.Ay)({
        channel: t,
        locked: l,
        video: o,
        selected: n
