...
function U(e) {
    ...
    return (s.useEffect(() => {
        ...
        children: [(0, i.jsx)(P, {
            ...
            return w && null != a.application_id && L.sQ.has(a.application_id) ? (0, i.jsxs)(s.Fragment, {
...
function P(e) {
    let {
        ...
        isChannelSelected: n,
        voiceStatesCount: s
    } = e, l = (0, a.bG)([C.A], () => !C.A.can(O.xBc.CONNECT, t)), o = (0, a.bG)([N.A], () => N.A.hasVideo(t.id)), c = (0, T.Ay)({
        channel: t,
        locked: l,
        video: o,
        selected: n
