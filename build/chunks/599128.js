/** chunk id: 599128, original params: r,e,t (module,exports,require) **/
t.r(e), t.d(e, {
    default: () => k
});
var a = t(627968);
...
async function m(r, e, t, a) {
    ...
    try {
        let {
            body: r
        } = await u.A.authorize(a, {
            twoWayLinkType: s.I.WEB
        });
        o = r.url
    } catch (r) {
...
function L(r) {
    ...
    let t = (0, w._)(window.location.search),
        ...
        c = async r => {
            ...
            if (null == a && null != o) try {
                c = await m(t, o, n, e)
            } catch (e) {
                f.error("Error Creating Discord link", e?.message);
                let r = I.A.toURLSafe(t);
                if (null == r) return;
                r.searchParams.delete("code"), r.searchParams.set("error", "two_way_link_error"), r.searchParams.set("error_description", e?.message ?? "unknown_error"), t = r.toString()
            }
...
let k = (0, h.C)(function(r) {
    let {
        ...
        client_id: o = ""
    } = l.parse(window.location.search), n = t === y.fg2.PLAYSTATION && o === c.i.PLAYSTATION_APPLICATION_ID, i = t === y.fg2.PLAYSTATION_STAGING && o === c.i.PLAYSTATION_STAGING_APPLICATION_ID;
    return n || i ? (0, a.jsx)(L, {
        platformType: t
    }) : null
})