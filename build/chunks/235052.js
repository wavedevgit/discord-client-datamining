...
function g(t, e, n) {
    let {
        ...
        autoTrackExposure: !1
    }), r = (0, l.bG)([u.default], () => u.default.getId()), m = (0, h.Ay)(t, e.guild_id)[0], p = (0, l.bG)([o.A], () => null != o.A.getStreamForUser(t, e.getGuildId())), g = (0, a.YY)(m?.application_id).data, f = (0, c.A)(t, e.id);
...
function f(t, e) {
    ...
    return null == n ? null : (0, i.jsx)(r.Drp, {
        ...
        label: p.intl.format(m.default["8qq+H7"], {
