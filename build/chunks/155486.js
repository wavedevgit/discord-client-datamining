...
function I(e) {
    let {
        ...
        searchQuery: j
    } = (0, C.v)(), F = l.useRef(null), [P, k] = l.useState(!1);
    (0, i.g)(F, l.useCallback(e => {
    ...
    let $ = l.useMemo(() => [{
            ...
            tab: y.G2.ORBS,
            label: x.intl.string(x.t.EBYkzk)
        }] : [], ...v ? [{
            tab: y.G2.RIVALS,
            label: x.intl.string(x.t["kq/75v"]),
            icon: o.I9m
        }] : []], [N, v]),
        ...
        D = l.useCallback(() => {
            (0, S.Y)({
                ...
                ctaObject: O.ZSU.CTA_TO_QUEST_HOME
            }), (0, u.navigateToQuestHome)({
                fromContent: a.u.ORBS_BALANCE_MENU
            })
        }, [M]),
        w = l.useCallback(() => {
            I?.id != null && (0, p.openUserProfileModal)({
                userId: I.id,
