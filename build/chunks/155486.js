/** chunk id: 155486, original params: e,t,s (module,exports,require) **/
s.d(t, {
    G: () => O
});
var r = s(627968),
...
function O(e) {
    let {
        ...
        searchQuery: x
    } = (0, f.v)(), R = l.useRef(null), [N, v] = l.useState(!1);
    (0, i.g)(R, l.useCallback(e => {
        v(e.contentRect.width < 800)
    }, []));
    let G = l.useMemo(() => [{
            tab: m.G2.HOME,
            label: g.intl.string(g.t["xNiB/O"])
        }, {
            tab: m.G2.CATALOG,
            label: g.intl.string(g.t.Ah5sJo),
            hasSubmenu: !0
        }, ...L ? [{
            tab: m.G2.ORBS,
            label: g.intl.string(g.t.EBYkzk)
        }] : []], [L]),
        ...
        j = l.useCallback(() => {
            O?.id != null && (0, d.openUserProfileModal)({
                userId: O.id,
