...
function G(e) {
    let {
        selectedTab: t,
        handleTransition: s
    } = e, G = (0, a.bG)([h.default], () => h.default.getCurrentUser()), {
        enabled: N
    } = (0, m.Z)({
    ...
    let B = l.useCallback(() => {
        ...
        H = l.useMemo(() => {
            ...
            return e.push({
                id: L.G2.RIVALS,
                label: R.intl.string(R.t["kq/75v"]),
                onSelect: B
            }), e
        }, [F, B]),
        U = H.length > 0,
        q = l.useMemo(() => {
            let e = [{
                tab: L.G2.HOME,
                label: R.intl.string(R.t["xNiB/O"])
            }, {
                tab: L.G2.CATALOG,
            ...
            return N && e.push({
                tab: L.G2.ORBS,
                label: R.intl.string(R.t.EBYkzk)
            }), j ? e.push({
                tab: L.G2.RIVALS,
                label: R.intl.string(R.t["kq/75v"]),
                icon: o.I9m
        ...
        Y = l.useCallback(() => {
            G?.id != null && (0, p.openUserProfileModal)({
                userId: G.id,
                tabSection: I.RP.WISHLIST
            })
        }, [G?.id]),
        K = l.useCallback(e => {
            e === L.G2.RIVALS ? B() : s(e)
