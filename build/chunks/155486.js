/** chunk id: 155486 params = (module,exports,require) **/
s.d(t, {
    G: () => R
});
var r = s(627968),
...
function R(e) {
    let {
        selectedTab: t,
        handleTransition: s
    } = e, R = (0, a.bG)([A.default], () => A.default.getCurrentUser()), {
        enabled: I
    } = (0, E.Z)({
        ...
        searchQuery: v
    } = (0, f.v)(), G = l.useRef(null), [_, j] = l.useState(!1);
    (0, i.g)(G, l.useCallback(e => {
        j(e.contentRect.width < 800)
    }, []));
    let F = l.useMemo(() => [{
            tab: T.G2.HOME,
            label: L.intl.string(L.t["xNiB/O"])
        }, {
            tab: T.G2.CATALOG,
            ...
            tab: T.G2.RIVALS,
            label: L.intl.string(L.t["kq/75v"]),
            icon: o.I9m
        }] : []], [I, N]),
        ...
        $ = l.useCallback(() => {
            R?.id != null && (0, p.openUserProfileModal)({
                userId: R.id,
                tabSection: O.RP.WISHLIST
            })
        }, [R?.id]),
        M = l.useCallback(e => {
            e === T.G2.RIVALS ? (0, b.default)({
                guildId: y.Kf
            }).catch(() => {}) : s(e)
        }, [s]);
    return (0, r.jsx)("div", {
