...
function j(e) {
    ...
    }), [h, p] = s.useState(!1), m = s.useRef(null), f = s.useRef(null), [I, j] = (0, c.kn)([r.M.QUEST_ACTIVITY_HEADER_INTRO], void 0, !0), {
        completedRatio: R,
        completedRatioDisplay: O,
        percentComplete: L
    } = (0, _.O9)(t, !0), M = s.useCallback(() => {
...
function R(e) {
    let {
        ...
        location: S.rE.QUEST_ACTIVITY_HEADER
    }), _ = (0, a.bG)([p.A], () => p.A.getState().autoEnroll), x = d?.id, C = (0, a.bG)([p.A], () => p.A.isDismissed(x), [x]);
    return (s.useEffect(() => {
    ...
    }, [g, d, _, C]), null != d && g) ? (0, i.jsx)(l.NPJ, {
        theme: c,
        children: e => (0, i.jsx)("div", {
            className: e,
