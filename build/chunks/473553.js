...
function O(e) {
    ...
    }), [A, g] = s.useState(!1), p = s.useRef(null), C = s.useRef(null), [b, O] = (0, c.kn)([r.M.QUEST_ACTIVITY_HEADER_INTRO], void 0, !0), {
        completedRatio: L,
...
function L(e) {
    let {
        ...
        location: T.rE.QUEST_ACTIVITY_HEADER
    }), _ = (0, a.bG)([g.A], () => g.A.getState().autoEnroll), f = d?.id, x = (0, a.bG)([g.A], () => g.A.isDismissed(f), [f]);
    return (s.useEffect(() => {
