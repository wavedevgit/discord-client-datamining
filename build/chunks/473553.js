...
function O(e) {
    let {
        quest: t,
        applicationId: n
    } = e, a = (0, f.fc)(t), u = (0, _.mU)({
        quest: t,
        taskDetails: a,
        location: T.rE.QUEST_ACTIVITY_HEADER,
        questContent: m.uF.QUEST_ACTIVITY_HEADER,
        sourceQuestContent: m.uF.RUNNING_ACTIVITY
    }), [A, p] = s.useState(!1), g = s.useRef(null), C = s.useRef(null), [b, O] = (0, c.kn)([r.M.QUEST_ACTIVITY_HEADER_INTRO], void 0, !0), {
        completedRatio: L,
...
function L(e) {
    let {
        ...
        location: T.rE.QUEST_ACTIVITY_HEADER
    }), _ = (0, a.bG)([p.A], () => p.A.getState().autoEnroll), f = d?.id, x = (0, a.bG)([p.A], () => p.A.isDismissed(f), [f]);
    return (s.useEffect(() => {
