...
function O(e) {
    ...
    }), [A, p] = s.useState(!1), _ = s.useRef(null), C = s.useRef(null), [b, O] = (0, c.kn)([r.M.QUEST_ACTIVITY_HEADER_INTRO], void 0, !0), {
        completedRatio: L,
...
function L(e) {
    let {
        ...
        location: T.rE.QUEST_ACTIVITY_HEADER
    }), g = (0, a.bG)([p.A], () => p.A.getState().autoEnroll), f = d?.id, x = (0, a.bG)([p.A], () => p.A.isDismissed(f), [f]);
    return (s.useEffect(() => {
