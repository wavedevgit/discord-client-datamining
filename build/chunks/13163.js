    ...
    (0, r.N)(() => {
        ...
        let l = (0, a.TW)(r ? r[0] : void 0),
            u = t => {
                ...
                s || (a.currentNode = t.shiftKey ? r[r.length - 1].nextElementSibling : r[0].previousElementSibling, s = t.shiftKey ? a.previousNode() : a.nextNode()), t.preventDefault(), s && S(s, !0)
            },
            d = t => {
...
function w(e, t, n) {
    (0, r.N)(() => {
        ...
        return s.addEventListener("focusin", o, !1), null == r || r.forEach(e => e.addEventListener("focusin", o, !1)), () => {
            s.removeEventListener("focusin", o, !1), null == r || r.forEach(e => e.removeEventListener("focusin", o, !1))
        }
    }, [e, t, n])
}
...
function P(e, t, n) {
    ...
    (0, r.N)(() => {
        ...
        if (!t || n) return;
        let o = () => {
            (!_ || I(_, e)) && v((0, i.bq)(s), e.current) && (_ = e)
        };
        return s.addEventListener("focusin", o, !1), null == r || r.forEach(e => e.addEventListener("focusin", o, !1)), () => {
            s.removeEventListener("focusin", o, !1), null == r || r.forEach(e => e.removeEventListener("focusin", o, !1))
        }
        ...
        let i = t => {
            ...
            if (a && a.isConnected && a !== r.body || (a = void 0, i.nodeToRestore = void 0), (!o || !A(o, e)) && a) {
                s.currentNode = a;
                do o = t.shiftKey ? s.previousNode() : s.nextNode(); while (A(o, e));
                t.preventDefault(), t.stopPropagation(), o ? S(o, !0) : O(a) ? S(a, !0) : n.blur()
            }
        };
        ...
        if (o) return o.nodeToRestore = null != (n = s.current) ? n : void 0, () => {
