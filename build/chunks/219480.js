...
function A(e) {
    let {
        ...
        totalClipCount: N,
        onClipClick: I
    } = e, [b, E] = s.useState(!0), [k, M] = s.useState({
        width: 0,
        height: 0
    }), w = (0, n.bG)([u.A], () => u.A.getSettings().storageLocation), L = (0, n.yK)([u.A], () => u.A.getNewClipIds()), S = (0, n.bG)([u.A], () => u.A.getExportingClipIds().length > 0);
    (0, d.A)({
        type: a.ImpressionTypes.MODAL,
        name: a.ImpressionNames.CLIP_GALLERY_VIEWED,
        properties: {
            number_of_clips_loaded: A.length
        }
    }, {
        disableTrack: b
    }, [A.length, b]), s.useEffect(() => ((0, m.jA)(), () => {
        (0, m.jA)(), (0, m.Su)()
    }), []);
    let H = s.useMemo(() => {
            let e = [],
            ...
            if (A.forEach(e => {
                    ...
                    if (a.setHours(0, 0, 0, 0), a.getTime() === s) l.push(e);
                        ...
                        let l = new Date(i).toLocaleDateString("en-US", {
                                month: "long",
                                year: "numeric"
                            }),
                            s = t.get(l) ?? [];
        ...
        } = k,
        {
            ...
            var e;
            let t, l, i, s, a;
            return e = A.length, i = 16 * ((l = Math.max(1, Math.floor(((t = T - f) + 16) / 336))) - 1), s = Math.max(320, (t - i) / l), a = y(l, e), {
                tileWidth: s,
                columns: l,
                rows: a
            }
    ...
    let D = s.useCallback(e => {
            (0, r.mMO)(async () => {
                let {
                    default: s
                } = await Promise.all([l.e("19632"), l.e("94719")]).then(l.bind(l, 723028));
                return l => (0, i.jsx)(s, {
                    ...l,
                    channelId: t,
                    clip: e
        ...
        K = s.useCallback(e => {
            ...
            return null == t ? null : (0, i.jsxs)("div", {
                ...
                children: [(0, i.jsx)(r.Heading, {
                    ...
                    color: "text-default",
                    children: t.title
                }), null != t.description && (0, i.jsx)(r.Text, {
    ...
    return b || 0 !== H.length ? b ? (0, i.jsx)("div", {
        className: v.dc,
