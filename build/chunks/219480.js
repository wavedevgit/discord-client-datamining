...
function b(e) {
    let {
        ...
        onClipClick: b,
        onEdit: C
    } = e, [y, A] = a.useState(!0), [N, E] = a.useState({
        width: 0,
        height: 0
    }), k = (0, s.bG)([c.A], () => c.A.getSettings().storageLocation), I = (0, s.yK)([c.A], () => c.A.getNewClipIds()), S = (0, s.bG)([c.A], () => c.A.getExportingClipIds().length > 0);
    (0, d.A)({
    ...
    let w = a.useMemo(() => {
        ...
        } = N,
        {
            ...
            var e;
            let l, n, a, i, s;
            return e = t.length, a = 16 * ((n = Math.max(1, Math.floor(((l = L - v) + 16) / 336))) - 1), i = Math.max(320, (l - a) / n), s = j(n, e), {
                tileWidth: i,
                columns: n,
                rows: s
            }
    ...
    return y || 0 !== w.length ? y ? (0, n.jsx)("div", {
        className: x.dc,
