...
var i = n(64700),
    ...
    N = n(349828),
    L = n(818348);
let O = 21552 == n.j ? [l.Ay, o.A, c.Ay, u.A, A.A, E.A, g.A, C.A, p.A, S.Ay, f.A, T.Ay] : null;
...
function G(e) {
    ...
    function A(e, i) {
        ...
        return a()(e).map(e => {
            ...
            return d || _ || !a().isEmpty(c) || S.Ay.getMentionCount(e.id) > 0 ? C : n && g || s && (g || o || (0, I.gV)(e.type) || (0, I.ig)(e.type) && !1 === S.Ay.hasUnread(e.id)) ? null : C
