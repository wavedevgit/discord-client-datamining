    ...
    function A(e, i) {
        ...
        return a()(e).map(e => {
            ...
            let d = null != r && (r.id === e.id || l === e.id),
                ...
                _ = (d || c || !s ? u.A.getActiveJoinedRelevantThreadsForParent(e.guild_id, e.id) : u.A.getActiveJoinedUnreadThreadsForParent(e.guild_id, e.id)) ?? {},
                A = (0, b.wF)(e, _, r, l, n),
            ...
            return d || c || !a().isEmpty(_) || f.Ay.getMentionCount(e.id) > 0 ? C : n && I || s && (I || o || (0, E.gV)(e.type) || (0, E.ig)(e.type) && !1 === f.Ay.hasUnread(e.id)) ? null : C
