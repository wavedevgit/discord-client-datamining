...
var i = n(64700),
    ...
    N = n(349828),
    L = n(818348);
let O = 21552 == n.j ? [l.Ay, o.A, c.Ay, u.A, A.A, I.A, g.A, C.A, p.A, f.Ay, m.A, S.Ay] : null;
...
function y(e) {
    ...
    function A(e, i) {
        ...
        return a()(e).map(e => {
            ...
            return d || _ || !a().isEmpty(c) || f.Ay.getMentionCount(e.id) > 0 ? C : n && g || s && (g || o || (0, E.gV)(e.type) || (0, E.ig)(e.type) && !1 === f.Ay.hasUnread(e.id)) ? null : C
