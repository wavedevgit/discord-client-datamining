...
function G() {
    let {
        hasAccess: e
    } = (0, d.TW)("FavoritesGuildChannelList"), [t, n] = i.useState(() => R()), l = i.useMemo(() => R({}), []);
    i.useEffect(() => {
...
function R(e) {
    ...
    function E(e, i) {
        ...
        return r()(e).map(e => {
            ...
            let d = null != l && (l.id === e.id || o === e.id),
                ...
                u = (d || c || !s ? A.A.getActiveJoinedRelevantThreadsForParent(e.guild_id, e.id) : A.A.getActiveJoinedUnreadThreadsForParent(e.guild_id, e.id)) ?? {},
                E = (0, L.wF)(e, u, l, o, n),
            ...
            return d || c || !r().isEmpty(u) || T.Ay.getMentionCount(e.id) > 0 ? h : n && g || s && (g || a || (0, _.gV)(e.type) || (0, _.ig)(e.type) && !1 === T.Ay.hasUnread(e.id)) ? null : h
    ...
    let h = null,
        ...
        G = r()(t).values().filter(e => e.type === s.Ip.CATEGORY).sortBy(e => e.order).map(e => {
            let {
                id: t,
                order: n
            } = e, i = a.A.getCategoryRecord(t);
