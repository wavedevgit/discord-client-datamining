...
var i = n(64700),
    ...
    N = n(349828),
    L = n(818348);
let O = 21552 == n.j ? [l.Ay, o.A, c.Ay, u.A, A.A, g.A, I.A, C.A, p.A, m.Ay, S.A, T.Ay] : null;
    ...
    function C(e, i) {
        ...
        return s()(e).map(e => {
            ...
            let d = null != r && (r.id === e.id || l === e.id),
                ...
                c = (d || _ || !a ? u.A.getActiveJoinedRelevantThreadsForParent(e.guild_id, e.id) : u.A.getActiveJoinedUnreadThreadsForParent(e.guild_id, e.id)) ?? {},
                A = (0, f.wF)(e, c, r, l, n),
            ...
            return d || _ || !s().isEmpty(c) || m.Ay.getMentionCount(e.id) > 0 ? C : n && I || a && (I || o || (0, E.gV)(e.type) || (0, E.ig)(e.type) && !1 === m.Ay.hasUnread(e.id)) ? null : C
