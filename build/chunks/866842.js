/** chunk id: 866842, original params: e,t,n (module,exports,require) **/
n.d(t, {
    D: () => G,
    g: () => U
}), n(321073);
...
function G() {
    let {
        hasAccess: e
    } = (0, d.TW)("FavoritesGuildChannelList"), [t, n] = i.useState(() => U()), r = i.useMemo(() => U({}), []);
    return i.useEffect(() => {
...
function U(e) {
    ...
    function A(e, i) {
        ...
        return a()(e).map(e => {
            ...
            return d || _ || !a().isEmpty(c) || S.Ay.getMentionCount(e.id) > 0 ? C : n && E || s && (E || o || (0, g.gV)(e.type) || (0, g.ig)(e.type) && !1 === S.Ay.hasUnread(e.id)) ? null : C
    ...
    let C = null,
        ...
        G = a()(t).values().filter(e => e.type === s.Ip.CATEGORY).sortBy(e => e.order).map(e => {
            let {
                id: t,
                order: n
