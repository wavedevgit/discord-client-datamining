...
function c(e) {
    let {
        ...
        profileOwner: n,
        currentUser: c
    } = e, u = n.id === c?.id, m = i.useMemo(() => t?.userId != null ? [t.userId] : [], [t]), g = (0, a.bG)([o.A], () => o.A.getStorefrontDetectableGameAndApplicationIds()), x = i.useMemo(() => {
        let e = [];
        ...
        userIds: m
    }), h = (0, d.tR)(m), _ = (0, d.rY)(), A = (0, d.qx)(), I = (0, d.px)();
