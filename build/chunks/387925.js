/** chunk id: 387925, original params: e,a,t (module,exports,require) **/
t.d(a, {
    m: () => d
});
var r = t(22299),
...
function d(e) {
    ...
    let S = (e, a) => {
            ...
            }), k(null), E(null), Z.commitValidation()
        },
        V = a => {
            let t = "function" == typeof P ? P() : P;
            w ? c(a) && (t || (null == x ? void 0 : x.start) && (null == x ? void 0 : x.end)) ? S(a, {
                start: (null == x ? void 0 : x.start) || (0, r.$l)(e.placeholderValue),
                end: (null == x ? void 0 : x.end) || (0, r.$l)(e.placeholderValue)
            }) : k(a) : c(a) ? (b(a), Z.commitValidation()) : k(a), t && h.setOpen(!1)
        },
        F = e => {
            c(C) && c(e) ? S(C, e) : E(e)
        },
        B = (null == f || null == (a = f.start) ? void 0 : a.calendar.identifier) === "gregory" && "BC" === f.start.era || (null == f || null == (t = f.end) ? void 0 : t.calendar.identifier) === "gregory" && "BC" === f.end.era,
        M = (0, s.useMemo)(() => ({
            granularity: R,
            timeZone: $,
    ...
    return {
        ...
        setDate(e, a) {
            ...
            "start" === e ? V({
                start: a,
                end: null != (t = null == C ? void 0 : C.end) ? t : null
            }) : V({
                start: null != (r = null == C ? void 0 : C.start) ? r : null,
                end: a
            })
        },
        setTime(e, a) {
            ...
            "start" === e ? F({
                start: a,
                end: null != (t = null == x ? void 0 : x.end) ? t : null
            }) : F({
                start: null != (r = null == x ? void 0 : x.start) ? r : null,
                end: a
            })
        },
        setDateTime(e, a) {
            ...
            "start" === e ? b({
                start: a,
                end: null != (t = null == f ? void 0 : f.end) ? t : null
            }) : b({
                start: null != (r = null == f ? void 0 : f.start) ? r : null,
                end: a
            })
        },
        setDateRange: V,
        ...
        ...h,
        setOpen(a) {
            !a && !((null == f ? void 0 : f.start) && (null == f ? void 0 : f.end)) && c(C) && w && S(C, {
                start: (null == x ? void 0 : x.start) || (0, r.$l)(e.placeholderValue),
                end: (null == x ? void 0 : x.end) || (0, r.$l)(e.placeholderValue)
            }), h.setOpen(a)
        },
        ...
        formatValue(a, t) {
            ...
            let l = "timeZone" in f.start ? f.start.timeZone : void 0,
                ...
                d = (0, r.id)(t, {
                    ...
                    hideTimeZone: e.hideTimeZone,
                    hourCycle: e.hourCycle,
                    showEra: "gregory" === f.start.calendar.identifier && "BC" === f.start.era || "gregory" === f.end.calendar.identifier && "BC" === f.end.era
                }),
