/** chunk id: 341856 params = (module,exports,require) **/
let s;
a.d(t, {
    w: () => g
});
...
class g extends i.PureComponent {
    ...
    ref = i.createRef();
    constructor(e) {
        super(e), null != e.locale && I.A.setLocale(e.locale), s = t => (0, l.jsx)(_.A, {
            track: e.track,
    ...
    renderAppButton(e) {
        ...
        return e && (_ = A.Sb.ME, N = I.A.Messages.COMMON_OPEN_DISCORD), (0, l.jsx)(s, {
            eventName: h,
    ...
    render() {
        let {
            ...
            routes: [{
                link: A.Tk.DOWNLOAD,
                title: I.A.Messages.NAVIGATION_DOWNLOAD,
                tracking: "download"
            }, {
                link: A.Tk.BRANDING,
                title: I.A.Messages.NAVIGATION_BRANDING,
                tracking: "branding"
            }, {
                link: A.Tk.NITRO,
                title: I.A.Messages.NAVIGATION_NITRO,
                tracking: "nitro",
                external: !0
            }]
        }, {
            ...
            routes: [{
                ...
                link: A.Tk.TERMS,
                title: I.A.Messages.NAVIGATION_TERMS,
                tracking: "terms",
                external: !0
            }, {
                link: A.Tk.PRIVACY,
                ...
                link: A.Tk.SECURITY,
                title: I.A.Messages.NAVIGATION_SECURITY,
                tracking: "security"
            }, {
                link: A.qF.STATUS,
                title: I.A.Messages.NAVIGATION_STATUS,
                tracking: "status",
                external: !0
            }, {
            ...
            routes: [{
                link: A.Tk.COMPANY,
                title: I.A.Messages.NAVIGATION_ABOUT,
                tracking: "about"
            }, {
                link: A.Tk.BLOG,
                title: I.A.Messages.NAVIGATION_BLOG,
                tracking: "blog",
                external: !0
            }, {
                link: A.Tk.JOBS,
                title: I.A.Messages.NAVIGATION_JOBS,
                tracking: "join",
                external: !0
            }]
        }, {
            ...
            routes: [{
                ...
                title: I.A.Messages.NAVIGATION_OPEN_SOURCE,
                tracking: "open_source"
            }]
        }].map(e => {
            let t = e.routes.map((e, t) => e.external ? (0, l.jsx)(s, {
                className: k.route,
                eventName: h,
                data: {
