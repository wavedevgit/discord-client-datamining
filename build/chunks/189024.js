/** chunk id: 189024, original params: e,t,n (module,exports,require) **/
n.d(t, {
    A: () => y
});
var i = n(627968),
...
function y() {
    let {
    ...
    } = (0, o.Ay)(r.A.PREMIUM_MARKETING_PERK_CARD), t = (0, h.O9)(), y = g.A.useExperiment({
        location: "PremiumWhatsNewSection"
    }).enabled, P = (0, s.useCallback)(() => {
        (0, A.openUserSettings)(_.X.PROFILE_PANEL, {
            section: T.nc_.PROFILE_CUSTOMIZATION,
            analyticsLocations: e
        }, () => (0, u.L)({
            analyticsLocations: e
        }))
        ...
        e ? (n = _.X.DISPLAY_IN_APP_ICON_CATEGORY, i = void 0) : t && (n = _.X.APPEARANCE_IN_APP_ICON, i = void 0), (0, A.openUserSettings)(n, {
