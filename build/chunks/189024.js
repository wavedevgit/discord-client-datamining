...
function ei() {
    let {
    ...
    } = (0, g.Ay)(m.A.PREMIUM_MARKETING_PERK_CARD), t = (0, C.X)("useWhatsNewPerkCards"), ei = (0, c.Ay)(), es = (0, D.O9)(), el = (0, P.YS)({
        ...
        null != ec && (ec.userStatus?.enrolledAt == null ? (0, T.Oy)(ec.id, {
            ...
            switch (e.type) {
                ...
                case T.WM.CAPTCHA_FAILED:
                    d.A.show({
                        title: Y.intl.string(Y.t["/CidxO"]),
                        body: Y.intl.string(Y.t.HQdHg6)
                    });
                    break;
                case T.WM.UNKNOWN_ERROR:
                    d.A.show({
                        title: Y.intl.string(Y.t.R0RpRX),
                        body: Y.intl.string(Y.t.OXD41D)
                    })
            }
        }) : em())
    }, [ec, em]), eh = () => {
        ...
        if (ea) {
            if (ed) return void(0, o.mMO)(async () => {
                let {
                    default: e
    ...
    return (0, s.useMemo)(() => {
        ...
        let s = [n, el ? {
                ...
                description: (0, i.jsxs)(i.Fragment, {
                    children: [Y.intl.formatToPlainString(H.default.JlyGQj, {
                        totalSeats: V.aw,
