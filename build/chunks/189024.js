...
function k() {
    let {
    ...
    } = (0, c.Ay)(d.A.PREMIUM_MARKETING_PERK_CARD), t = (0, C.O9)(), k = (0, E.R)({
        location: "PremiumWhatsNewSection"
    }), V = S.A.useExperiment({
        location: "PremiumWhatsNewSection"
    }).enabled, w = (0, a.bG)([T.A], () => T.A.getPremiumTypeSubscription()), B = w?.hasActiveTrial ?? !1, H = (0, s.useCallback)(() => {
        ...
        if (k) {
            if (B) return void(0, r.mMO)(async () => {
                let {
                    default: e
    ...
    return (0, s.useMemo)(() => {
        let n = [t ? {
                ...
                description: (0, i.jsxs)(i.Fragment, {
                    children: [R.intl.formatToPlainString(y.default.JlyGQj, {
                        totalSeats: v.aw,
