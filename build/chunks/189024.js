...
function Y() {
    let {
        ...
        if (K) {
            if (q) return void(0, r.mMO)(async () => {
                let {
                    default: e
    ...
    return (0, s.useMemo)(() => {
        let n = [X ? {
                ...
                description: (0, i.jsxs)(i.Fragment, {
                    children: [G.intl.formatToPlainString(D.default.JlyGQj, {
                        totalSeats: P.aw,
                ...
                description: G.intl.formatToPlainString(G.t.WQazjs, {
                    themeCount: 20
                }),
                primaryAsset: z.A,
                ctaText: G.intl.string(G.t.jVcuVY),
