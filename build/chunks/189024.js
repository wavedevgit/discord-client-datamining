...
function eo() {
    let {
    ...
    } = (0, g.Ay)(m.A.PREMIUM_MARKETING_PERK_CARD), t = (0, v.X)("useWhatsNewPerkCards"), eo = (0, c.Ay)(), ed = (0, U.O9)(), ec = (0, G.YS)({
        location: "useWhatsNewPerkCards"
    }).functionalityEnabled, eu = (0, L.R)({
        location: "PremiumWhatsNewSection"
    }), em = D.A.useConfig({
        location: "PremiumWhatsNewSection"
    }).enabled, eg = (0, a.bG)([R.A], () => R.A.getPremiumTypeSubscription()), e_ = eg?.hasActiveTrial ?? !1, ex = (0, a.bG)([f.A], () => [...f.A.quests.values()].find(e => e.config.features.includes(Y.Li.NITRO_CONTROL_CTA)) ?? null), eA = (0, I.A)({
        analyticsLocations: e
    }), {
        launchInGameActivity: eh
    } = (0, E.zW)(ex), ep = (0, s.useCallback)(() => {
        (0, O.openUserSettings)(j.X.PROFILE_PANEL, {
            analyticsLocations: e
        }, () => (0, A.L)({
            analyticsLocations: e
        }))
    }, [e]), eT = (0, s.useCallback)(() => {
        (0, O.openUserSettings)(j.X.PROFILE_PANEL, {
            analyticsLocations: e
        }, () => (0, _.L)({
            analyticsLocations: e
        }))
    }, [e]), ef = (0, s.useCallback)(() => {
        let e = (0, y.Ci)("openCustomAppSettings") ? j.X.DISPLAY_IN_APP_ICON_CATEGORY : j.X.APPEARANCE_IN_APP_ICON;
        (0, O.openUserSettings)(e)
    }, []), eS = (0, s.useCallback)(() => {
        null != ex && (ex.userStatus?.enrolledAt == null ? (0, T.Oy)(ex.id, {
            ...
            switch (e.type) {
                ...
                case T.WM.CAPTCHA_FAILED:
                    d.A.show({
                        title: Z.intl.string(Z.t["/CidxO"]),
                        body: Z.intl.string(Z.t.HQdHg6)
                    });
                    break;
                case T.WM.UNKNOWN_ERROR:
                    d.A.show({
                        title: Z.intl.string(Z.t.R0RpRX),
                        body: Z.intl.string(Z.t.OXD41D)
                    })
            }
        }) : eh())
    }, [ex, eh]), eb = () => {
        ...
        if (eu) {
            if (e_) return void(0, o.mMO)(async () => {
                let {
                    default: e
        ...
        shouldShowBonusOrbsUX: eN,
        multiplier: ev
    } = (0, b.Dl)(Y.rE.NITRO_HOME_MARKETING), {
        currentDate: eI,
        nDaysInMonth: ej
    } = (0, s.useMemo)(() => {
        let e = new Date;
    ...
    return (0, s.useMemo)(() => {
        ...
        let s = [n, ec ? {
                ...
                description: (0, i.jsxs)(i.Fragment, {
                    children: [Z.intl.formatToPlainString(K.default.JlyGQj, {
                        totalSeats: H.aw,
                ...
                description: Z.intl.format(Z.t.NpUfej, {
                ...
                description: Z.intl.formatToPlainString(Z.t.WQazjs, {
                    themeCount: 20
                }),
                primaryAsset: er.A,
                ctaText: Z.intl.string(Z.t.jVcuVY),
