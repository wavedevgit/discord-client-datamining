...
function es() {
    let {
    ...
    } = (0, m.Ay)(_.A.PREMIUM_MARKETING_PERK_CARD), t = (0, I.X)("useWhatsNewPerkCards"), es = (0, d.Ay)(), el = (0, L.O9)(), eo = (0, O.YS)({
        location: "useWhatsNewPerkCards"
    }).functionalityEnabled, ec = P.A.useConfig({
        location: "PremiumWhatsNewSection"
    }).enabled, ed = (0, s.bG)([M.A], () => M.A.getPremiumTypeSubscription()), eu = ed?.hasActiveTrial ?? !1, e_ = (0, s.bG)([x.A], () => [...x.A.quests.values()].find(e => e.config.features.includes(W.Li.NITRO_CONTROL_CTA)) ?? null), em = (0, T.A)({
        analyticsLocations: e
    }), {
        launchInGameActivity: ep
    } = (0, R.zW)(e_), eg = (0, r.useCallback)(() => {
        (0, S.openUserSettings)(j.X.PROFILE_PANEL, {
            analyticsLocations: e
        }, () => (0, A.L)({
            analyticsLocations: e
        }))
        ...
        multiplier: eR
    } = (0, N.Dl)(W.rE.NITRO_HOME_MARKETING), {
        currentDate: ev,
        nDaysInMonth: eE
    } = (0, r.useMemo)(() => {
        let e = new Date;
    ...
    return (0, r.useMemo)(() => {
        ...
        let r = [n, eo ? {
                ...
                description: (0, i.jsxs)(i.Fragment, {
                    children: [X.intl.formatToPlainString(Y.default.JlyGQj, {
                        totalSeats: V.aw,
                ...
                description: X.intl.format(X.t.NpUfej, {
                    bonusOrbMultiplier: eR
                }),
                pillText: X.intl.string(X.t.oW0eUd),
                primaryAsset: Q.A,
                ...
                description: X.intl.formatToPlainString(X.t.WQazjs, {
                    themeCount: 20
                }),
                primaryAsset: ea.A,
                ctaText: X.intl.string(X.t.jVcuVY),
