...
function es() {
    ...
    } = (0, m.Ay)(_.A.PREMIUM_MARKETING_PERK_CARD), t = (0, T.X)("useWhatsNewPerkCards"), es = (0, d.Ay)(), el = (0, L.O9)(), eo = (0, P.YS)({
        location: "useWhatsNewPerkCards"
    }).functionalityEnabled, ec = O.A.useConfig({
        location: "PremiumWhatsNewSection"
    }).enabled, ed = (0, s.bG)([y.A], () => y.A.getPremiumTypeSubscription()), eu = ed?.hasActiveTrial ?? !1, e_ = (0, s.bG)([x.A], () => [...x.A.quests.values()].find(e => e.config.features.includes(z.Li.NITRO_CONTROL_CTA)) ?? null), em = (0, j.A)({
        analyticsLocations: e
    }), {
        launchInGameActivity: ep
    } = (0, N.zW)(e_), eA = (0, r.useCallback)(() => {
        (0, S.openUserSettings)(I.X.PROFILE_PANEL, {
            analyticsLocations: e
        }, () => (0, g.L)({
            analyticsLocations: e
        }))
    ...
    return (0, r.useMemo)(() => {
        ...
        let r = [n, eo ? {
                ...
                description: (0, i.jsxs)(i.Fragment, {
                    children: [K.intl.formatToPlainString(W.default.JlyGQj, {
                        totalSeats: V.aw,
