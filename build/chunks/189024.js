...
function eA() {
    let {
    ...
    } = (0, p.Ay)(m.A.PREMIUM_MARKETING_PERK_CARD), t = (0, y.X)("useWhatsNewPerkCards"), eA = (0, u.Ay)(), eg = (0, B.O9)(), ef = (0, k.YS)({
        ...
        shouldShowBonusOrbsUX: eM,
        multiplier: eO
    } = (0, E.Dl)(Z.rE.NITRO_HOME_MARKETING), eP = (0, x.l)("useWhatsNewPerkCards"), {
        isEligible: eD,
        programReward: eL
    } = (0, I.F)({
        location: "useWhatsNewPerkCards"
    ...
    return (0, r.useMemo)(() => {
        ...
        let r = [n, eU ? {
                ...
                description: ee.intl.format(J.default["Pz+6Ix"], {
                    orbsCount: eL?.reward_amount ?? 0
                }),
                backgroundElement: (0, i.jsx)(f.A, {
                    src: em.A,
                    className: en.T
                }),
                ...
                description: (0, i.jsxs)(i.Fragment, {
                    children: [ee.intl.formatToPlainString($.default.JlyGQj, {
                        totalSeats: Y.aw,
                ...
                onCtaClick: () => (0, V.u)({
                    analyticsLocations: e,
                    partnerIds: [G.KS, G.Cs]
                }),
                blurTint: "#2E213D"
            } : null, eM ? {
                id: H.QUEST_ORB_MULTIPLIER_CARD_ID,
                title: ee.intl.string(ee.t.F2MShO),
                description: ee.intl.format(ee.t.NpUfej, {
                    bonusOrbMultiplier: eO
                }),
                pillText: ee.intl.string(ee.t.oW0eUd),
                primaryAsset: es.A,
                ...
                description: ee.intl.formatToPlainString(ee.t.WQazjs, {
                    themeCount: 20
                }),
                primaryAsset: ep.A,
                ctaText: ee.intl.string(ee.t.jVcuVY),
