...
function er() {
    let {
    ...
    }).functionalityEnabled, ec = (0, P.R)({
        location: "PremiumWhatsNewSection"
    }), eu = L.A.useConfig({
        location: "PremiumWhatsNewSection"
    }).enabled, em = (0, a.bG)([R.A], () => R.A.getPremiumTypeSubscription()), eg = em?.hasActiveTrial ?? !1, e_ = (0, a.bG)([f.A], () => [...f.A.quests.values()].find(e => e.config.features.includes(z.Li.NITRO_CONTROL_CTA)) ?? null), ex = (0, I.A)({
        analyticsLocations: e
    }), {
        launchInGameActivity: eA
    } = (0, E.zW)(e_), eh = (0, s.useCallback)(() => {
        (0, O.openUserSettings)(j.X.PROFILE_PANEL, {
            analyticsLocations: e
        }, () => (0, A.L)({
            analyticsLocations: e
        }))
    }, [e]), ep = (0, s.useCallback)(() => {
        (0, O.openUserSettings)(j.X.PROFILE_PANEL, {
            analyticsLocations: e
        }, () => (0, _.L)({
            analyticsLocations: e
        ...
        null != e_ && (e_.userStatus?.enrolledAt == null ? (0, T.Oy)(e_.id, {
        ...
        if (ec) {
            if (eg) return void(0, o.mMO)(async () => {
                let {
                    default: e
        ...
        multiplier: eN
    } = (0, b.Dl)(z.rE.NITRO_HOME_MARKETING), {
        currentDate: ev,
        nDaysInMonth: eI
    } = (0, s.useMemo)(() => {
        let e = new Date;
    ...
    return (0, s.useMemo)(() => {
        ...
        let s = [n, ed ? {
                ...
                description: (0, i.jsxs)(i.Fragment, {
                    children: [W.intl.formatToPlainString(X.default.JlyGQj, {
                        totalSeats: F.aw,
                ...
                onCtaClick: () => (0, k.u)({
                    analyticsLocations: e,
                    partnerIds: [U.KS, U.Cs]
                }),
                blurTint: "#2E213D"
            } : null, eC ? {
                id: w.QUEST_ORB_MULTIPLIER_CARD_ID,
                title: W.intl.string(W.t.F2MShO),
                description: W.intl.format(W.t.NpUfej, {
                    bonusOrbMultiplier: eN
                }),
                pillText: W.intl.string(W.t.oW0eUd),
                primaryAsset: $.A,
                ...
                description: W.intl.formatToPlainString(W.t.WQazjs, {
                    themeCount: 20
                }),
                primaryAsset: ea.A,
                ctaText: W.intl.string(W.t.jVcuVY),
