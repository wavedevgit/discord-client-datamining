...
function M(e) {
    ...
    })), U = (0, s.bG)([E.A], () => null != w && M === w && E.A.getChatOpen(w), [M, w]), G = (0, s.bG)([C.Ay], () => C.Ay.callChatSidebarWidth), k = (0, c.rdh)(o.A.modules.chat.RESIZE_HANDLE_WIDTH), V = r.useRef(null), B = r.useRef(null), [H, F] = r.useState({
        width: 0,
        height: 0
    }), Y = r.useCallback(() => {
    ...
    r.useLayoutEffect(() => {
        ...
        let e = new ResizeObserver(() => {
            F({
                width: B.current?.clientWidth ?? 0,
                height: B.current?.clientHeight ?? 0
            })
        });
        ...
        children: e => (0, i.jsxs)("div", {
            ...
            children: [(0, i.jsx)(I.A, {
                ...
                children: [(0, i.jsx)(N.A, {
                    ...
                    popoutOpen: !1,
                    onOpenPopout: () => {
                        (0, p.zV)(L.HAw.ACTIVITY_POPOUT_POP_OUT_BUTTON_CLICKED), (0, _.A)({
                            onConfirm: async () => {
