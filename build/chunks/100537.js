...
function j(e) {
    ...
    })), M = (0, s.bG)([E.A], () => null != D && j === D && E.A.getChatOpen(D), [j, D]), w = (0, s.bG)([I.Ay], () => I.Ay.callChatSidebarWidth), U = (0, c.rdh)(o.A.modules.chat.RESIZE_HANDLE_WIDTH), G = r.useRef(null), k = r.useRef(null), [V, B] = r.useState({
        width: 0,
        height: 0
    }), H = r.useCallback(() => {
        S.A.updateFrameLayoutMode({
            applicationId: t.applicationId,
            layoutMode: y.y.PIP
        })
    }, [t.applicationId]), F = r.useCallback(() => {
        S.A.stopFrame({
            applicationId: t.applicationId
        })
    }, [t.applicationId]);
    r.useLayoutEffect(() => {
        ...
        let e = new ResizeObserver(() => {
            B({
                width: k.current?.clientWidth ?? 0,
                height: k.current?.clientHeight ?? 0
            })
        });
        return e.observe(k.current), () => e.disconnect()
    }, []), r.useEffect(() => {
        let e = e => {
            null == G.current || G.current.contains(e.target) || l || S.A.updateFrameLayoutMode({
                applicationId: t.applicationId,
                layoutMode: y.y.PIP
            })
        };
        ...
        children: e => (0, i.jsxs)("div", {
            ...
            children: [(0, i.jsx)("div", {
                ...
                children: [(0, i.jsx)(C.A, {
                    ...
                    popoutOpen: !1,
                    onOpenPopout: () => {
                        (0, p.zV)(b.HAw.ACTIVITY_POPOUT_POP_OUT_BUTTON_CLICKED), (0, _.A)({
                            onConfirm: async () => {
                                n?.id != null && await S.A.refreshProxyTicket({
                                    applicationId: n.id
                                }), (0, A.jp)()
                            }
                        })
