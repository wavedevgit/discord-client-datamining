...
let eR = Object.freeze({
        ...
        [eI.lAJ.GUILD_STREAM]: function(e) {
            let {
                ...
                messageReference: c
            } = t, d = t.getChannelId(), p = (0, l.bG)([F.A], () => F.A.findActivity(o, e => e.type === eI.$pd.PLAYING), [o]), m = (0, l.bG)([U.A], () => null != c ? U.A.getChannel(c.channel_id) : null, [c]), f = null == c ? void 0 : c.guild_id, g = (0, $.P)({
                user: s,
                channelId: d,
                guildId: a.guild_id,
                messageId: t.id
        ...
        [eI.lAJ.STAGE_RAISE_HAND]: function(e) {
            ...
            let {
                ...
                guildId: s.guild_id,
                messageId: i.id
            }), d = (0, l.bG)([B.A], () => B.A.can(eI.xBc.MUTE_MEMBERS, s)), p = (0, l.bG)([P.A], () => P.A.getParticipant(s.id, i.author.id)), m = new Date(q.default.extractTimestamp(i.id)).toISOString() === new Date(null != (t = null == p || null == (n = p.voiceState) ? void 0 : n.requestToSpeakTimestamp) ? t : 0).toISOString(), f = d && (null == p ? void 0 : p.rtsState) === w.zF.REQUESTED_TO_SPEAK && m;
            return (0, r.jsxs)(r.Fragment, {
