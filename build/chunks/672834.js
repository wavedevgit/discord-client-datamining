...
function eL(e) {
    let {
        ...
        guild_id: c
    } = n, o = t.getChannelId(), u = (0, s.bG)([G.A], () => G.A.getGuild(c), [c]), d = r.useCallback(() => {
        null != u && (0, m.K4)({
            guildId: u.id,
            location: {
...
let ey = Object.freeze({
        ...
        [eD.lAJ.RECIPIENT_ADD]: function(e) {
            let {
                ...
                author: l
            } = t, a = t.getChannelId(), c = (0, s.bG)([B.default], () => B.default.getUser(t.mentions[0]), [t]), o = q.Ay.getName(null, a, c), u = (0, Z.P)({
                user: l,
                channelId: a,
                guildId: n.guild_id,
                messageId: t.id
        ...
        [eD.lAJ.RECIPIENT_REMOVE]: function(e) {
            let {
                ...
                author: l
            } = t, a = t.getChannelId(), c = (0, s.bG)([B.default], () => B.default.getUser(t.mentions[0]), [t]), o = (0, Z.P)({
                user: l,
                channelId: a,
                guildId: n.guild_id,
                messageId: t.id
        ...
        [eD.lAJ.CALL]: function(e) {
            let {
                ...
                id: a,
                author: c
            } = t, u = j.default.getId(), d = t.getChannelId(), _ = (0, s.bG)([k.A], () => k.A.isCallActive(d, a), [d, a]), E = (0, s.bG)([V.A], () => V.A.getVoiceState(eD.ME, u)), A = !_ && null != t.call && !t.call.participants.includes(u), m = _ && (null == E || E.channelId !== d), I = r.useCallback(() => o.default.selectVoiceChannel(d), [d]), T = (0, Z.P)({
                user: c,
                channelId: d,
                guildId: l.guild_id,
                messageId: t.id,
        ...
        [eD.lAJ.CHANNEL_PINNED_MESSAGE]: function(e) {
            let {
                ...
                author: l
            } = t, a = t.getChannelId(), c = r.useCallback(() => {
            ...
            return (0, i.jsx)(es.A, {
                ...
                compact: n,
                usernameHook: o,
                onClickPins: __OVERLAY__ ? null : c
            })
        },
        ...
        [eD.lAJ.GUILD_STREAM]: function(e) {
            let {
                ...
                messageReference: o
            } = t, d = t.getChannelId(), _ = (0, s.bG)([F.A], () => F.A.findActivity(c, e => e.type === eD.$pd.PLAYING), [c]), E = (0, s.bG)([b.A], () => null != o ? b.A.getChannel(o.channel_id) : null, [o]), A = o?.guild_id, m = (0, Z.P)({
                user: a,
                channelId: d,
                guildId: l.guild_id,
                messageId: t.id
            }), I = r.useCallback(() => {
                null != E && null != A && (0, u.Nl)({
            ...
            return null != o && null != E && null != o.guild_id ? (0, i.jsx)(e_.A, {
                message: t,
                compact: n,
                channel: E,
                playingActivity: _,
        ...
        [eD.lAJ.GUILD_DISCOVERY_DISQUALIFIED]: function(e) {
            let {
                message: t,
                compact: n
            } = e, r = t.getChannelId(), l = (0, s.bG)([b.A], () => b.A.getChannel(r), [r]), a = null != l ? l.getGuildId() : null;
        ...
        [eD.lAJ.STAGE_RAISE_HAND]: function(e) {
            let {
                ...
                guildId: n.guild_id,
                messageId: t.id
            }), o = (0, s.bG)([H.A], () => H.A.can(eD.xBc.MUTE_MEMBERS, n)), u = (0, s.bG)([U.A], () => U.A.getParticipant(n.id, t.author.id)), d = new Date(Y.default.extractTimestamp(t.id)).toISOString() === new Date(u?.voiceState?.requestToSpeakTimestamp ?? 0).toISOString(), _ = o && u?.rtsState === P.zF.REQUESTED_TO_SPEAK && d;
            return (0, i.jsxs)(i.Fragment, {
        ...
        [eD.lAJ.GIFTING_PROMPT]: function(e) {
            let {
                message: t,
                channel: n
            } = e, r = t.giftingPrompt, l = (0, s.bG)([B.default], () => B.default.getUser(r?.recipientUserId));
            return null == r || null == l ? null : (0, i.jsx)(J.A, {
        ...
        [eD.lAJ.GUILD_BOOST_UPSELL]: function(e) {
            ...
            return null == t.boostingPrompt ? null : (0, i.jsx)(ec.A, {
    ...
    ej = r.memo(function(e) {
        ...
        if (null == a) {
            var c;
            return c = Error(`unknown message type ${t.type}`), K.A.captureException(c), new _.A("SystemMessage").error("", c), null
        }
        return (0, i.jsx)(z.Ay, {
            message: t,
