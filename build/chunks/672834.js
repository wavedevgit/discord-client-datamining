...
let ej = Object.freeze({
        ...
        [eD.lAJ.RECIPIENT_ADD]: function(e) {
            let {
                ...
                author: r
            } = t, s = t.getChannelId(), o = (0, a.bG)([V.default], () => V.default.getUser(t.mentions[0]), [t]), c = q.Ay.getName(null, s, o), d = (0, Z.P)({
                user: r,
                channelId: s,
                guildId: n.guild_id,
                messageId: t.id
        ...
        [eD.lAJ.RECIPIENT_REMOVE]: function(e) {
            let {
                ...
                author: r
            } = t, s = t.getChannelId(), o = (0, a.bG)([V.default], () => V.default.getUser(t.mentions[0]), [t]), c = (0, Z.P)({
                user: r,
                channelId: s,
                guildId: n.guild_id,
                messageId: t.id
            ...
            return n.isThread() ? (0, i.jsx)(ex.A, {
                message: t,
                channel: n,
                compact: l,
                targetUser: o,
        ...
        [eD.lAJ.GUILD_STREAM]: function(e) {
            let {
                ...
                messageReference: c
            } = t, u = t.getChannelId(), _ = (0, a.bG)([B.A], () => B.A.findActivity(o, e => e.type === eD.$pd.PLAYING), [o]), m = (0, a.bG)([k.A], () => null != c ? k.A.getChannel(c.channel_id) : null, [c]), A = c?.guild_id, E = (0, Z.P)({
                user: s,
                channelId: u,
                guildId: r.guild_id,
                messageId: t.id
                ...
                null != m && null != A && (0, d.Nl)({
                    streamType: eP.U4.GUILD,
                    ownerId: o,
                    channelId: m.id,
                    guildId: A
                })
            }, [o, m, A]);
            return null != c && null != m && null != c.guild_id ? (0, i.jsx)(e_.A, {
                message: t,
                compact: n,
                channel: m,
                playingActivity: _,
        ...
        [eD.lAJ.STAGE_RAISE_HAND]: function(e) {
            let {
                ...
                guildId: n.guild_id,
                messageId: t.id
            }), c = (0, a.bG)([F.A], () => F.A.can(eD.xBc.MUTE_MEMBERS, n)), d = (0, a.bG)([P.A], () => P.A.getParticipant(n.id, t.author.id)), u = new Date(z.default.extractTimestamp(t.id)).toISOString() === new Date(d?.voiceState?.requestToSpeakTimestamp ?? 0).toISOString(), _ = c && d?.rtsState === U.zF.REQUESTED_TO_SPEAK && u;
            return (0, i.jsxs)(i.Fragment, {
