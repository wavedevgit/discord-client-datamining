...
let eL = Object.freeze({
        ...
        [eO.lAJ.RECIPIENT_ADD]: function(e) {
            let {
                ...
                author: r
            } = t, s = t.getChannelId(), o = (0, a.bG)([B.default], () => B.default.getUser(t.mentions[0]), [t]), c = J.Ay.getName(null, s, o), d = (0, q.P)({
                user: r,
                channelId: s,
                guildId: n.guild_id,
                messageId: t.id
            ...
            return n.isThread() ? (0, i.jsx)(eI.A, {
                message: t,
                channel: n,
                compact: l,
                targetUser: o,
        ...
        [eO.lAJ.RECIPIENT_REMOVE]: function(e) {
            let {
                ...
                author: r
            } = t, s = t.getChannelId(), o = (0, a.bG)([B.default], () => B.default.getUser(t.mentions[0]), [t]), c = (0, q.P)({
                user: r,
                channelId: s,
                guildId: n.guild_id,
                messageId: t.id
        ...
        [eO.lAJ.CALL]: function(e) {
            let {
                ...
                id: s,
                author: o
            } = t, d = U.default.getId(), u = t.getChannelId(), m = (0, a.bG)([P.A], () => P.A.isCallActive(u, s), [u, s]), _ = (0, a.bG)([V.A], () => V.A.getVoiceState(eO.ME, d)), A = !m && null != t.call && !t.call.participants.includes(d), E = m && (null == _ || _.channelId !== u), f = l.useCallback(() => c.default.selectVoiceChannel(u), [u]), h = (0, q.P)({
                user: o,
                channelId: u,
                guildId: r.guild_id,
                messageId: t.id,
        ...
        [eO.lAJ.GUILD_STREAM]: function(e) {
            let {
                ...
                messageReference: c
            } = t, u = t.getChannelId(), m = (0, a.bG)([F.A], () => F.A.findActivity(o, e => e.type === eO.$pd.PLAYING), [o]), _ = (0, a.bG)([k.A], () => null != c ? k.A.getChannel(c.channel_id) : null, [c]), A = c?.guild_id, E = (0, q.P)({
                user: s,
                channelId: u,
                guildId: r.guild_id,
                messageId: t.id
                ...
                null != _ && null != A && (0, d.Nl)({
                    streamType: eM.U4.GUILD,
                    ownerId: o,
                    channelId: _.id,
                    guildId: A
                })
            }, [o, _, A]);
            return null != c && null != _ && null != c.guild_id ? (0, i.jsx)(eu.A, {
                message: t,
                compact: n,
                channel: _,
                playingActivity: m,
        ...
        [eO.lAJ.PURCHASE_NOTIFICATION]: function(e) {
            ...
            return t.purchaseNotification?.type === u.hE.GUILD_PRODUCT ? (0, i.jsx)(h.A, {
                message: t,
                channel: n,
                compact: l
            }) : null
        ...
        [eO.lAJ.STAGE_START]: function(e) {
            ...
            return (0, i.jsxs)(i.Fragment, {
                children: [(0, i.jsx)(eg.A, {
                    ...
                    compact: l,
                    usernameHook: r
                }), null != s && s.name === t.content ? (0, i.jsx)(x.A, {
        ...
        [eO.lAJ.STAGE_RAISE_HAND]: function(e) {
            let {
                ...
                guildId: n.guild_id,
                messageId: t.id
            }), c = (0, a.bG)([w.A], () => w.A.can(eO.xBc.MUTE_MEMBERS, n)), d = (0, a.bG)([j.A], () => j.A.getParticipant(n.id, t.author.id)), u = new Date(W.default.extractTimestamp(t.id)).toISOString() === new Date(d?.voiceState?.requestToSpeakTimestamp ?? 0).toISOString(), m = c && d?.rtsState === b.zF.REQUESTED_TO_SPEAK && u;
            return (0, i.jsxs)(i.Fragment, {
        ...
        [eO.lAJ.GIFTING_PROMPT]: function(e) {
            ...
            return null == l || null == r ? null : (0, i.jsx)(Q.A, {
    ...
    eD = l.memo(function(e) {
        ...
        if (null == s) {
            var o;
            return o = Error(`unknown message type ${t.type}`), K.A.captureException(o), new m.A("SystemMessage").error("", o), null
        }
        return (0, i.jsx)(Z.Ay, {
            message: t,
