...
function e7(e) {
    ...
    }), j = (0, H.S)((n.editedTimestamp ?? n.timestamp).valueOf()), L = (0, z.A)(t?.id), R = (0, K.A)(n), P = (0, S.P)(n), D = (0, eb.z)(t), k = (0, eE._f)(n.id, n.channel_id), O = (0, T._R)();
    return (0, i.jsx)(e1, {
        canSuppressEmbeds: I,
...
let e2 = e => {
    let {
        ...
        ...d
    } = e, c = eo.X6.useSetting(), u = eo.hD.useSetting(), _ = eo.rs.useSetting(), m = eo.kt.useSetting(), h = (0, H.S)((t.editedTimestamp ?? t.timestamp).valueOf()), p = (0, z.A)(n?.id), g = (0, S.P)(t), A = (0, eE._f)(t.id, t.channel_id), x = (0, K.A)(t);
    return (0, i.jsx)(e1, {
        ...d,
        message: t,
        channel: n,
