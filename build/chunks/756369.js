...
class e2 extends l.Component {
    ...
    render() {
        ...
        return null == d && null == u && null == m && null == h && null == p && null == c && null == g && null == A && null == x && null == f && null == C && null == I && null == E && null == b && null == T && null != v && null == S && null == j && null == L && null == R ? null : (0, i.jsxs)("div", {
            id: (0, eO.XL)(t),
            className: r()(e, eX.kL),
            children: [L, j, E, S, R, d, c, b, u, _, m, y, h, x, C, I, v, o, p, g, A, s && this.renderSuppressConfirmModal(), a && this.renderRemoveAttachmentConfirmModal(), f, T, N]
        })
    }
}
...
function e7(e) {
    let {
        ...
        isMessageSnapshot: s
    } = e, r = (0, d.bG)([eu.default], () => eu.default.getId()), a = ed.X6.useSetting(), c = ed.hD.useSetting(), u = ed.rs.useSetting() && !(0, ey.A)(e.message), _ = ed.jW.useSetting() && !1 !== e.renderReactions, m = ed.kt.useSetting(), h = (0, d.bG)([em.A], () => null == t.guild_id || em.A.canChatInGuild(t.guild_id), [t]), p = (0, d.bG)([H.A], () => null != t.guild_id && H.A.isLurking(t.guild_id), [t]), g = (0, d.bG)([e_.Ay, ep.default], () => {
    ...
    }), j = (0, V.S)((n.editedTimestamp ?? n.timestamp).valueOf()), L = (0, z.A)(t?.id), R = (0, J.A)(n), P = (0, y.P)(n), w = (0, eT.z)(t), k = (0, eI._f)(n.id, n.channel_id), O = (0, T._R)();
    return (0, i.jsx)(e2, {
        canSuppressEmbeds: I,
