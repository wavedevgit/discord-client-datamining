...
let eK = [eY.Auw.GIFV],
    ...
    eZ = e => () => {
        let {
            ...
            height: r,
            flags: a
        } = e, s = (0, o.Lt)(a, W.e5.IS_ANIMATED);
        return null != l && null != r && (q.bp.test(n) || s && (q.P8.test(n) || q.p4.test(n))) ? (0, i.jsx)(eL.A, {
            width: l,
            height: r,
            src: n,
            url: t,
...
class e$ extends l.Component {
    ...
    renderCodedLinks(e) {
        return 0 === e.codedLinks.length ? null : e.codedLinks.map(t => {
            ...
            if (n === v.I.INVITE) return this.shouldRenderInvite(l) ? (0, i.jsx)(eP.A, {
                code: l,
                message: e,
            ...
            if (n === v.I.CHANNEL_LINK) return (0, i.jsx)(ey.A, {
                code: l,
                message: e
            }, l);
    ...
    renderThreadAccessories(e) {
        if (e.hasFlag(eY.pr7.HAS_THREAD) && !1 !== this.props.renderThreadAccessory) return (0, i.jsx)(ea.A, {
            message: e,
...
function e0(e) {
    ...
    }), j = (0, H.S)((n.editedTimestamp ?? n.timestamp).valueOf()), L = (0, Y.A)(t?.id), R = (0, K.A)(n), P = (0, y.P)(n), w = (0, ev.z)(t), O = (0, eC._f)(n.id, n.channel_id), k = (0, T._R)();
    return (0, i.jsx)(e$, {
        canSuppressEmbeds: E,
...
let e1 = e => {
    let {
        ...
        ...d
    } = e, c = es.X6.useSetting(), u = es.hD.useSetting(), _ = es.rs.useSetting(), m = es.kt.useSetting(), h = (0, H.S)((t.editedTimestamp ?? t.timestamp).valueOf()), p = (0, Y.A)(n?.id), g = (0, y.P)(t), A = (0, eC._f)(t.id, t.channel_id), x = (0, K.A)(t);
    return (0, i.jsx)(e$, {
        ...d,
        message: t,
        channel: n,
