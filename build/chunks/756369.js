...
let eZ = [eK.Auw.GIFV],
    ...
    e1 = e => () => {
        let {
            ...
            height: r,
            flags: l
        } = e, s = (0, o.Lt)(l, W.e5.IS_ANIMATED);
        return null != a && null != r && (z.bp.test(n) || s && (z.P8.test(n) || z.p4.test(n))) ? (0, i.jsx)(ew.A, {
            width: a,
            height: r,
            src: n,
            url: t,
...
class e2 extends a.Component {
    ...
    getAcceptInviteContext = (e, t) => {
        ...
        return {
            ...
            ...null != t ? {
                invite_instance_id: (0, U._U)(t, i.id)
            } : {}
        }
    };
    ...
    shouldComponentUpdate(e, t) {
        ...
        return !(0, u.A)(this.state, t) || !(0, u.A)(this.props, e, ["message", "channel"]) || a.type !== s.type || d !== l || o.codedLinks !== r.codedLinks || o.flags !== r.flags || o.giftCodes !== r.giftCodes || o.attachments !== r.attachments || o.embeds !== r.embeds || o.components !== r.components || o.activity !== r.activity || (n = o.reactions) !== (i = r.reactions) && (n.length !== i.length || !!n.some((e, t) => {
            let {
                emoji: n,
                count: a,
                burst_count: r
    ...
    renderCodedLinks(e) {
        return 0 === e.codedLinks.length ? null : e.codedLinks.map(t => {
            ...
            if (n === b.I.INVITE) return this.shouldRenderInvite(a) ? (0, i.jsx)(eD.A, {
                code: a,
                message: e,
                getAcceptInviteContext: this.getAcceptInviteContext
            }, a) : null;
            if (n === b.I.TEMPLATE) return (0, i.jsx)(O.A, {
                code: a
            }, a);
            if (n === b.I.EVENT) return (0, i.jsx)(k.A, {
                code: a
            }, a);
            if (n === b.I.CHANNEL_LINK) return (0, i.jsx)(ej.A, {
                code: a,
                message: e
            }, a);
            if (n === b.I.APP_DIRECTORY_PROFILE) return (0, i.jsx)(P.A, {
                code: a,
                message: e
            }, a);
            ...
            } else if (n === b.I.GUILD_PRODUCT) return (0, i.jsx)(D.A, {
                code: a
            }, a);
            else if (n === b.I.SERVER_SHOP) return (0, i.jsx)(v.A, {
                guildId: a
            }, a);
            ...
            } else if (n === b.I.QUESTS_EMBED) return (0, i.jsx)(Z.A, {
                questId: a
            }, a);
            else if (n === b.I.APP_DIRECTORY_STOREFRONT) return (0, i.jsx)(A.G, {
                appId: a,
                message: e
            }, a);
            ...
            } else if (n === b.I.APP_OAUTH2_LINK) return (0, i.jsx)(f.A, {
                applicationId: a,
                message: e
            }, a);
    ...
    renderEmbedTitle = (e, t) => e.type !== eK.Auw.RICH ? t : (null != e.url && "" !== e.url ? q.A.parseEmbedTitleWithoutLinks : q.A.parseEmbedTitle)(t, !0, {
        channelId: this.props.channel.id
    });
    renderEmbedDescription = (e, t, n) => e.type === eK.Auw.RICH ? q.A.parse(t, !0, {
        channelId: this.props.channel.id,
        allowLinks: !0,
        allowEmojiLinks: !0,
    ...
    renderEmbeds(e) {
        ...
        return 0 === e.embeds.length || !t || n ? null : e.embeds.map((t, n) => {
            if (eQ.z.has(t.type) || (0, ef.p6)(t) || (0, B.f)(t) && !(0, G.d)(e) || (0, ef.V)(t) || (0, ef.G8)(t)) return null;
            if (t.type === eK.Auw.COMPONENTS && null != t.components && t.components.length > 0) {
                ...
                let {
                    ...
                    canSuppressEmbeds: o,
                    hasSpoilerEmbeds: d
                } = this.props, c = (0, eb.sC)(t, e, d, r), u = function() {
            ...
            if (t.type === eK.Auw.ARTICLE && null != t.url && /^https?:\/\/(?:canary|ptb|www)?\.discord(?:app)?\.com\/store\/skus\/(?:[0-9]+)/.test(t.url) && null != t.provider && "Discord" === t.provider.name) {
                let a = eI.A.safeParseWithQuery(t.url);
                if (null != a && null != a.pathname) {
                    let l = a.pathname.split("/")[3];
                    if (null != l) return (0, i.jsx)(ez.A, {
                        skuId: l,
    ...
    renderPublishBump(e) {
        return this.props.channel.type !== eK.rbe.GUILD_ANNOUNCEMENT || this.props.isMessageSnapshot ? null : (0, i.jsx)(C.A, {
            channelId: e.channel_id,
            messageId: e.id
        })
    }
    renderEphemeralAccessories(e) {
        return (0, ev.ec)(e) ? (0, i.jsx)(eP.A, {
            message: e,
            onDeleteMessage: () => {
    ...
    renderStickersAccessories(e) {
        ...
        return 0 === t.length ? null : t.map(e => (0, i.jsx)(el.A, {
            channel: n,
            isInteracting: a,
            renderableSticker: e
        }, e.id))
    ...
    renderThreadAccessories(e) {
        if (e.hasFlag(eK.pr7.HAS_THREAD) && !1 !== this.props.renderThreadAccessory) return (0, i.jsx)(eo.A, {
            message: e,
            compact: this.props.compact
        })
    }
    renderThreadRoleMentionWarning(e) {
        if (e.hasFlag(eK.pr7.FAILED_TO_MENTION_SOME_ROLES_IN_THREAD) && this.props.isCurrentUser && !(Date.now() - eC.default.extractTimestamp(e.id) >= e$)) return (0, i.jsx)("div", {
            className: eX.xM,
            children: eJ.intl.string(eJ.t.ma8Rs0)
        })
    }
    ...
    renderInteractionPremiumUpsell(e) {
        ...
        return e.type !== s.l.INTERACTION_PREMIUM_UPSELL || null == t ? null : (0, i.jsx)(eF.A, {
            applicationId: t,
    ...
    renderEmbeddedApplicationInstanceEmbed(e) {
        ...
        return null == t || null == n ? null : (0, i.jsx)(eR.A, {
            application: t,
            channelId: this.props.channel.id,
            guildId: this.props.channel.guild_id,
            message: e
    ...
    renderMediaPostEmbeds(e) {
        return e.embeds.flatMap(t => t.type !== eK.Auw.POST_PREVIEW || null == t.url ? [] : (0, i.jsx)(Q.A, {
            embedUrl: t.url,
            message: e,
    ...
    renderSafetyPolicyNotice(e) {
        return 1 === e.embeds.length && e.embeds[0].type === eK.Auw.SAFETY_POLICY_NOTICE ? (0, i.jsx)(en.V, {
            message: e
        }) : null
    }
    renderSafetySystemNotification(e) {
        return 1 === e.embeds.length && e.embeds[0].type === eK.Auw.SAFETY_SYSTEM_NOTIFICATION ? (0, i.jsx)(ei.l, {
            embed: e.embeds[0]
        }) : null
    }
    renderMediaObscureNotice(e) {
        return (0 !== e.attachments.length || 0 !== e.embeds.length) && (0, S.KM)(e) ? (0, i.jsx)(N.A, {
            message: e
        }) : null
    }
    renderPoll(e, t) {
    ...
    renderReportedMessage(e) {
        if (e.messageSnapshots.length > 0 && (0, $.Mn)(e, this.props.channel)) return (0, i.jsx)(ee.A, {
            message: e
        })
    }
    renderForwardedMessage(e) {
        if (e.messageSnapshots.length > 0 && !(0, $.Mn)(e, this.props.channel)) return (0, i.jsx)(L.A, {
            message: e
        })
    }
    renderEditedTag(e, t) {
        return (0, i.jsx)(eW.A, {
            message: e,
            compact: t,
            location: eW.O.AFTER_ACCESSORIES
        })
    }
    render() {
        let {
...
function e7(e) {
    let {
        ...
        isMessageSnapshot: r
    } = e, l = (0, d.bG)([eu.default], () => eu.default.getId()), s = ed.X6.useSetting(), c = ed.hD.useSetting(), u = ed.rs.useSetting() && !(0, ey.A)(e.message), _ = ed.jW.useSetting() && !1 !== e.renderReactions, m = ed.kt.useSetting(), h = (0, d.bG)([em.A], () => null == t.guild_id || em.A.canChatInGuild(t.guild_id), [t]), p = (0, d.bG)([H.A], () => null != t.guild_id && H.A.isLurking(t.guild_id), [t]), g = (0, d.bG)([e_.Ay, ep.default], () => {
    ...
    }), [h, t]), f = (0, w.ix)(t.guild_id), [, C] = (0, M.c)(t.guild_id), I = (0, es.Id)(t), E = (l === n.author.id || x) && n.author.id !== eK.oIV && !1 !== a && !(0, o.Lt)(n.flags, eK.pr7.EPHEMERAL) && I && (0, eS.A)(n) >= 1, b = l === n.author.id && I && !r, v = n.author.id === l, S = n.isFirstMessageInForumPost(t), N = (0, eN.A)({
        channel: t,
        canChat: h,
        renderReactions: _,
        canAddNewReactions: A,
    ...
    }), j = (0, V.S)((n.editedTimestamp ?? n.timestamp).valueOf()), L = (0, Y.A)(t?.id), R = (0, J.A)(n), P = (0, y.P)(n), D = (0, eT.z)(t), k = (0, eE._f)(n.id, n.channel_id), O = (0, T._R)();
    return (0, i.jsx)(e2, {
        canSuppressEmbeds: E,
...
let e9 = e => {
    let {
        ...
        ...d
    } = e, c = ed.X6.useSetting(), u = ed.hD.useSetting(), _ = ed.rs.useSetting(), m = ed.kt.useSetting(), h = (0, V.S)((t.editedTimestamp ?? t.timestamp).valueOf()), p = (0, Y.A)(n?.id), g = (0, y.P)(t), A = (0, eE._f)(t.id, t.channel_id), x = (0, J.A)(t);
    return (0, i.jsx)(e2, {
        ...d,
        message: t,
        channel: n,
