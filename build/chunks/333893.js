...
new A(l.h, {
    CONNECTION_OPEN: function() {
        null != u && a.A.getSocket().requestChannelMemberCount(u.guildId, u.channelId), s.default.keys(c).forEach(e => {
            null == r.A.getChannel(e) && delete c[e]
        })
    },
