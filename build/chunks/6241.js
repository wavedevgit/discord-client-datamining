/** chunk id: 6241 params = (module,exports,require) **/
l.d(t, {
    default: () => k
}), l(321073);
var n = l(627968),
...
function S(e) {
    return t => {
        ...
        return {
            ...
            value: a,
            label: (0, s.fU)(t),
            trailing: (l = r > e ? r - e : 1440 - e + r, (0, n.jsx)("span", {
                className: h.us,
                children: (0, s.a3)(l)
            }))
        }
...
function C(e) {
    let {
        conflictingEntries: t
    } = e;
    return 0 === t.length ? null : (0, n.jsx)(r.po8, {
        className: h.VE,
        ...
        children: (0, n.jsxs)(r.BJc, {
            ...
            children: [(0, n.jsx)(r.EYj, {
                ...
                children: m.intl.string(c.default["26A0Df"])
            }), (0, n.jsx)(r.BJc, {
                gap: 4,
                children: t.map(e => {
                    let {
...
function k(e) {
    let {
        ...
        teenId: x,
        rule: k
    } = e, _ = null != k, E = (0, d.F7)(x), [w, M] = (0, o.A)({
        initial: k?.startTime,
        defaultValue: {
            hours: 22,
            minutes: 0
        }
    }), [T, Y] = a.useState(""), [A, B] = (0, o.A)({
        initial: k?.endTime,
        defaultValue: {
            hours: 7,
            minutes: 0
        }
    }), [J, U] = a.useState(""), [$, I] = a.useState(() => null != k ? new Set(k.days) : new Set), [R, z] = a.useState(!1), [G, H] = a.useState(!1), [O, V] = a.useState(k?.enabled ?? !0), D = a.useMemo(() => (0, s.yK)("short"), []), W = a.useMemo(() => {
        let e = Array.from({
            length: f
        }, (e, t) => {
            let l = p(t),
        ...
        let e, t, l, n, a = (0, s.yN)(w),
            r = (t = Math.floor((e = (0, s.yN)(w)) / 30) + 1, l = S(e), Array.from({
                length: f - 1
            }, (e, n) => l(p((t + n) % f))));
    ...
    }, [_, k, E?.restrictedSchedule?.rules]), K = a.useMemo(() => (0, s.d)($, F, D), [D, F, $]), L = (0, s.yN)(w) > (0, s.yN)(A), Q = (0, s.yN)(w) !== (0, s.yN)(A), q = async () => {
        z(!0);
        try {
            let e = {
                label: "",
        ...
        startTime: (0, s.fU)(w),
        endTime: (0, s.fU)(A),
        timeHook: (e, t) => (0, n.jsx)(r.EYj, {
            variant: "text-sm/medium",
            color: "text-default",
            tag: "span",
            children: e
        }, t)
    }, ee = L ? m.intl.format(c.default.R87Y2K, X) : m.intl.format(c.default.vX7xid, X), et = R || G, el = _ ? [{
        ...
        text: m.intl.string(c.default.TDc9mW),
        onClick: q,
        disabled: 0 === $.size || !Q || et,
        loading: R
    }] : [{
        variant: "secondary",
        ...
        text: m.intl.string(c.default.pvcruO),
        onClick: q,
        disabled: 0 === $.size || !Q || et,
        loading: R
    }];
        ...
        children: (0, n.jsxs)(r.BJc, {
            ...
            children: [_ && (0, n.jsxs)(n.Fragment, {
                ...
                children: [(0, n.jsxs)(r.BJc, {
                    ...
                    conflictingEntries: K.conflictingEntries
                })]
            })]
        })
    })
