...
function g(e) {
    let {
    ...
    }), [C, _] = a.useState(() => null != y ? new Set(y.days) : new Set), [N, w] = a.useState(!1), [E, M] = a.useState(!1), [T, Y] = a.useState(y?.enabled ?? !0), A = a.useMemo(() => (0, r.yK)("short"), []), B = a.useMemo(() => Array.from({
        length: h
    }, (e, t) => {
        let l = j(t),
            n = f(l);
        ...
        for (let e = 1; e < h; e++) {
            ...
            a.push({
                ...
                label: (0, n.jsxs)(n.Fragment, {
                    children: [(0, r.fU)(i), (0, n.jsx)("span", {
                        className: m.us,
        ...
        return a
    })(p), [p]), z = (0, r.yN)(p) > (0, r.yN)(S), H = (0, r.yN)(p) !== (0, r.yN)(S), J = async () => {
        w(!0);
        try {
            let e = {
                label: "",
        ...
        startTime: (0, r.fU)(p),
        endTime: (0, r.fU)(S),
        timeHook: (e, t) => (0, n.jsx)(i.EYj, {
            variant: "text-sm/medium",
            color: "text-default",
            tag: "span",
            children: e
        }, t)
    }, G = z ? c.intl.format(o.default.R87Y2K, $) : c.intl.format(o.default.vX7xid, $), I = N || E, O = b ? [{
        ...
        text: c.intl.string(o.default.TDc9mW),
        onClick: J,
        disabled: 0 === C.size || !H || I,
        loading: N
    }] : [{
        variant: "secondary",
        ...
        text: c.intl.string(o.default.pvcruO),
        onClick: J,
        disabled: 0 === C.size || !H || I,
        loading: N
    }];
