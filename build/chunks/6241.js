...
function g(e) {
    ...
    }), [C, _] = i.useState(() => null != y ? new Set(y.days) : new Set), [N, w] = i.useState(!1), [E, M] = i.useState(!1), [T, Y] = i.useState(y?.enabled ?? !0), A = i.useMemo(r.yK, []), B = i.useMemo(() => Array.from({
        length: h
    }, (e, t) => {
        let n = j(t),
            l = f(n);
        ...
        for (let e = 1; e < h; e++) {
            ...
            i.push({
                ...
                label: (0, l.jsxs)(l.Fragment, {
                    children: [(0, r.fU)(s), (0, l.jsx)("span", {
                        className: m.us,
