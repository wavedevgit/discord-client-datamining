...
function p(e) {
    ...
    return 0 === t.length ? null : (0, n.jsx)(a.po8, {
        className: h.VE,
        ...
        children: (0, n.jsxs)(a.BJc, {
            ...
            children: [(0, n.jsx)(a.EYj, {
                ...
                children: m.intl.string(o.default["26A0Df"])
            }), (0, n.jsx)(a.BJc, {
                gap: 4,
                children: t.map(e => {
                    let {
...
function y(e) {
    let {
        ...
        teenId: y,
        rule: b
    } = e, v = null != b, S = (0, u.F7)(y), [C, N] = (0, c.A)({
        initial: b?.startTime,
        defaultValue: {
            hours: 22,
            minutes: 0
    ...
    }), [w, E] = i.useState(() => null != b ? new Set(b.days) : new Set), [M, Y] = i.useState(!1), [A, B] = i.useState(!1), [T, J] = i.useState(b?.enabled ?? !0), $ = i.useMemo(() => (0, r.yK)("short"), []), I = i.useMemo(() => Array.from({
        length: x
    }, (e, t) => {
        let l = g(t),
            n = j(l);
        ...
        for (let e = 1; e < x; e++) {
            ...
            i.push({
                ...
                label: (0, n.jsxs)(n.Fragment, {
                    children: [(0, r.fU)(a), (0, n.jsx)("span", {
                        className: h.us,
                        children: ` \xb7 ${(0,r.a3)(d)}`
                    })]
                })
            })
        }
    ...
    }, [v, b, S?.restrictedSchedule?.rules]), z = i.useMemo(() => (0, r.d)(w, U, $), [$, U, w]), G = (0, r.yN)(C) > (0, r.yN)(_), H = (0, r.yN)(C) !== (0, r.yN)(_), V = async () => {
        Y(!0);
        try {
            let e = {
                label: "",
        ...
        startTime: (0, r.fU)(C),
        endTime: (0, r.fU)(_),
        timeHook: (e, t) => (0, n.jsx)(a.EYj, {
            variant: "text-sm/medium",
            color: "text-default",
            tag: "span",
            children: e
        }, t)
    }, O = G ? m.intl.format(o.default.R87Y2K, F) : m.intl.format(o.default.vX7xid, F), P = M || A, W = v ? [{
        ...
        text: m.intl.string(o.default.TDc9mW),
        onClick: V,
        disabled: 0 === w.size || !H || P,
        loading: M
    }] : [{
        variant: "secondary",
        ...
        text: m.intl.string(o.default.pvcruO),
        onClick: V,
        disabled: 0 === w.size || !H || P,
        loading: M
    }];
        ...
        children: (0, n.jsxs)(a.BJc, {
            ...
            children: [v && (0, n.jsxs)(n.Fragment, {
                ...
                children: [(0, n.jsxs)(a.BJc, {
                    ...
                    conflictingEntries: z.conflictingEntries
                })]
            })]
        })
    })
