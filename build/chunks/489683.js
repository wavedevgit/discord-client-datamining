...
function eX() {
    ...
    (0, I.tjt)(e), r.useEffect(() => {
        eM.default.track(eH.HAw.OPEN_POPOUT, {
    ...
    let t = (0, c.bG)([eb.Ay], () => eb.Ay.getNoiseCancellation()),
        ...
        s = eK.intl.string(eK.t.uKdWn6),
        o = eK.intl.string(eK.t.uKdWn6);
    return n ? (s = eK.intl.string(eK.t.mXZgC9), o = eK.intl.format(eK.t.F6lrb4, {
        onSettingsClick: () => {
            eb.Ay.getMediaEngine().showSystemCaptureConfigurationUI("microphone_modes")
        }
    })) : a && (s = eK.intl.formatToPlainString(eK.t["/tqmfM"], {
...
function eZ() {
    ...
    } = (0, P.Ay)(), t = (0, c.bG)([eu.A], () => eu.A.isMuted()), n = t ? eK.intl.string(eK.t.ScHlfl) : eK.intl.string(eK.t.zqxfrf);
    return (0, i.jsx)(eG.A, {
        tooltipText: n,
        icon: t ? I.CIB : I.T7G,
        onClick: () => {
...
function eJ(e) {
    ...
    } = (0, P.Ay)(), d = (0, e_.A)(), u = (0, ep.A)(t), A = (0, c.bG)([x.Ay], () => null != x.Ay.getSelfEmbeddedActivityForLocation(x.Ay.getConnectedActivityLocation())), h = (0, er.Ay)(t), {
        reachedLimit: _,
        limit: p
    } = (0, em.A)(t), C = r.useCallback(() => {
        (0, eE.A)()
    ...
    return r.useEffect(() => () => y(), [d.enabled, y]), (0, i.jsx)(eT.r, {
        onChange: N,
                    ...
                    return (0, i.jsx)(g.m_, {
                        ...
                        children: (0, i.jsx)(E.$n, {
                            ...
                            children: S ? u : (0, i.jsxs)(k.A, {
                                ...
                                children: [u, eK.intl.string(eK.t.FlNoSV)]
                            })
                        })
                    })
                }
...
function e0(e) {
    ...
    } = (0, P.Ay)(), o = r === eH.BRT.POPOUT, d = (0, b.et)(t.id), h = (0, b.dL)(d), {
        userInActivity: _
    } = (0, c.cf)([x.Ay], () => ({
                ...
                children: (0, i.jsxs)(E.$n, {
                    ...
                    onClick: () => {
                        C(), (0, j.A)({
                            ...
                            openInPopout: o,
                            analyticsLocation: s
                        }), (0, w.X)(l, w.O.ACTIVITY), n === u.M.ACTIVITIES_VOICE_LAUNCHER_BADGE && r(eY.i.TAKE_ACTION)
                    },
                    onMouseEnter: () => {
                        f.onMouseEnter()
                    },
...
function e1(e) {
    let {
        ...
        o(), _ ? m(!1) : m(!0), (0, w.X)(l, w.O.GIFTING), p === u.M.GAME_SHOP_RTC_GIFTING_NEW_BADGE && f(eY.i.TAKE_ACTION)
    }, [l, o, _, p, f]);
    return (0, i.jsx)(I.YNO, {
        targetElementRef: n,
        shouldShow: _,
...
function e7(e) {
    ...
    let y = null != S || v.length > 0,
        b = p ? eK.intl.string(eK.t.fjBNo1) : eK.intl.string(eK.t.uQn9B8),
        O = C || s || T,
        L = null != S,
        {
            Component: R,
            ...
            return (0, i.jsx)(g.m_, {
                ...
                children: (0, i.jsx)(E.$n, {
                    ...
                    children: O ? M : (0, i.jsxs)(k.A, {
                        align: k.A.Align.CENTER,
                        children: [M, eK.intl.string(eK.t["r0/+v7"])]
                    })
                })
            })
        }
...
class e6 extends r.PureComponent {
    ...
    handleCloseVoicePanelIntroduction = () => {
        K.sF(eW._.VOICE_PANEL_INTRODUCTION)
    };
    ...
    renderNoiseCancellation() {
        ...
        return null != r ? null : l?.isGuildStageVoice() && null == a.find(e => e.user.id === eS.default.getId() && (0, eA.eY)(e.voiceState) === eA.zF.ON_STAGE) && (0, ec.Zl)(l.id) ? (0, i.jsx)(eZ, {}) : !n && t ? (0, i.jsx)(g.m_, {
...
function e9(e) {
    let {
        ...
        Component: d,
        events: c
    } = (0, p.G)(l ? "disable" : "enable");
    return r.useEffect(() => () => o(), [l, o]), (0, i.jsx)(eG.A, {
        ...t,
        ref: a,
        onClick: e => {
...
let e5 = (0, N.A)(function(e) {
    let t = (0, F.A)(),
        ...
        E = (0, c.bG)([eO.A], () => g && !eO.A.can(eH.xBc.VIEW_CHANNEL, o), [g, o]),
        f = eh.vL.useSetting(),
        [C, T, N] = (0, c.yK)([eD.Ay, ea.A], () => o?.isGuildStageVoice() ? [ea.A.getMutableParticipants(o.id, es.ip.SPEAKER), ea.A.getParticipantsVersion(o.id), null] : [null, null, null != o ? eD.Ay.getVoiceStatesForChannel(o) : null], [o]),
        S = r.useMemo(() => C?.map(e => {
            let {
                user: t,
                userNick: n,
