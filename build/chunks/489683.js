...
function eQ(e) {
    ...
    ej.default.track(eH.HAw.NOISE_CANCELLATION_LINK_CLICKED, {
        text: t.text,
        href: t.href,
        location: {
            section: eH.JJy.NOISE_CANCELLATION_POPOUT
        }
    })
}
...
function eX() {
    ...
    (0, I.tjt)(e), a.useEffect(() => {
        ej.default.track(eH.HAw.OPEN_POPOUT, {
            type: eH.JJy.NOISE_CANCELLATION_POPOUT
        })
    }, []);
    let t = (0, c.bG)([ey.Ay], () => ey.Ay.getNoiseCancellation()),
        n = (0, X.c)(),
        l = (0, c.bG)([ey.Ay], () => ey.Ay.getActiveInputProfile()),
        r = null != l && l !== eK.m.CUSTOM,
        s = eq.intl.string(eq.t.uKdWn6),
        o = eq.intl.string(eq.t.uKdWn6);
    return n ? (s = eq.intl.string(eq.t.mXZgC9), o = eq.intl.format(eq.t.F6lrb4, {
        onSettingsClick: () => {
            ey.Ay.getMediaEngine().showSystemCaptureConfigurationUI("microphone_modes")
        }
    })) : r && (s = eq.intl.formatToPlainString(eq.t["/tqmfM"], {
...
function eZ() {
    ...
    } = (0, P.Ay)(), t = (0, c.bG)([eu.A], () => eu.A.isMuted()), n = t ? eq.intl.string(eq.t.ScHlfl) : eq.intl.string(eq.t.zqxfrf);
    return (0, i.jsx)(eG.A, {
        tooltipText: n,
        icon: t ? I.CIB : I.T7G,
        onClick: () => {
...
function eJ(e) {
    ...
    } = (0, P.Ay)(), d = (0, e_.A)(), u = (0, eg.A)(t), A = (0, c.bG)([x.Ay], () => null != x.Ay.getSelfEmbeddedActivityForLocation(x.Ay.getConnectedActivityLocation())), h = (0, ea.Ay)(t), {
        reachedLimit: _,
        limit: g
    } = (0, em.A)(t), C = a.useCallback(() => {
        (0, eE.A)()
    ...
    return a.useEffect(() => () => b(), [d.enabled, b]), (0, i.jsx)(eT.r, {
        onChange: N,
...
function e0(e) {
    ...
    } = (0, P.Ay)(), o = a === eH.BRT.POPOUT, d = (0, y.et)(t.id), h = (0, y.dL)(d), {
        userInActivity: _
    } = (0, c.cf)([x.Ay], () => ({
                ...
                children: (0, i.jsxs)(E.$n, {
                    ...
                    onClick: () => {
                        C(), (0, D.A)({
                            ...
                            openInPopout: o,
                            analyticsLocation: s
                        }), (0, w.X)(l, w.O.ACTIVITY), n === u.M.ACTIVITIES_VOICE_LAUNCHER_BADGE && a(eY.i.TAKE_ACTION)
                    },
                    onMouseEnter: () => {
                        f.onMouseEnter()
                    },
...
function e1(e) {
    let {
    ...
    } = (0, h.T)(), [_, m] = a.useState(!1), [g, f] = (0, V.kn)([u.M.GAME_SHOP_RTC_GIFTING_NEW_BADGE], void 0, !0), C = a.useCallback(() => {
        m(!1)
    }, []), T = a.useCallback(e => {
        let {
            closePopout: n
        ...
        o(), _ ? m(!1) : m(!0), (0, w.X)(l, w.O.GIFTING), g === u.M.GAME_SHOP_RTC_GIFTING_NEW_BADGE && f(eY.i.TAKE_ACTION)
    }, [l, o, _, g, f]);
    return (0, i.jsx)(I.YNO, {
        targetElementRef: n,
        shouldShow: _,
...
function e7(e) {
    let t, {
        ...
        v = (0, ep.T)(n, h, m);
    t = null == S ? l ? N : eI.A : () => (0, K.A)(S);
    let b = null != S || v.length > 0,
        y = g ? eq.intl.string(eq.t.fjBNo1) : eq.intl.string(eq.t.uQn9B8),
        O = C || s || T,
        L = null != S,
        {
            Component: R,
            ...
            return (0, i.jsx)(p.m_, {
                ...
                children: (0, i.jsx)(E.$n, {
                    ...
                    children: O ? j : (0, i.jsxs)(k.A, {
                        align: k.A.Align.CENTER,
                        children: [j, eq.intl.string(eq.t["r0/+v7"])]
                    })
                })
            })
        }
...
class e6 extends a.PureComponent {
    ...
    handleChannelLinkClick = e => {
        ...
        o()(null != n, "Channel is null during navigation click"), e.stopPropagation(), T.A.channelListScrollTo(t?.id ?? eH.ME, n.id), (0, w.X)(R.A.RTC_PANEL, w.O.CHANNEL_LINK)
    };
    ...
    handleCloseVoicePanelIntroduction = () => {
        q.sF(eW._.VOICE_PANEL_INTRODUCTION)
    };
    renderConnectionStatus() {
        ...
        return null != n ? (e = eH.BVt.CHANNEL(n.id, t.id), o = `${o} / ${n.name}`) : e = eH.BVt.CHANNEL(eH.ME, t.id), (0, i.jsx)(ee.A, {
            channelId: t.id,
            quality: a,
            state: l,
            lastPing: r,
    ...
    renderNoiseCancellation() {
        ...
        return null != a ? null : l?.isGuildStageVoice() && null == r.find(e => e.user.id === eS.default.getId() && (0, eA.eY)(e.voiceState) === eA.zF.ON_STAGE) && (0, ec.Zl)(l.id) ? (0, i.jsx)(eZ, {}) : !n && t ? (0, i.jsx)(p.m_, {
    ...
    renderVoiceStates() {
        ...
        return null != e && n && 0 !== t.length ? (0, i.jsx)(eB.A, {
            voiceStates: t,
            channel: e,
            className: ez.Xk
        }) : null
            ...
            children: () => (0, i.jsxs)("div", {
                ...
                children: [(0, i.jsxs)(k.A, {
                    ...
                    children: [(0, i.jsx)("div", {
                        ...
                        shrink: 0,
                        className: ez.nL,
                        children: [t ? this.renderNoiseCancellation() : null, (0, i.jsx)(eV.A, {
                            channel: e
                        })]
                    })]
...
function e9(e) {
    ...
    return a.useEffect(() => () => o(), [l, o]), (0, i.jsx)(eG.A, {
        ...t,
        ref: r,
        onClick: e => {
...
let e5 = (0, N.A)(function(e) {
    let t = (0, F.A)(),
        ...
        o = (0, c.bG)([ex.A], () => ex.A.getChannel(r), [r]),
        d = o?.getGuildId(),
        u = (0, c.bG)([ev.A], () => ev.A.getGuild(d), [d]),
        A = (0, c.cf)([ey.Ay], () => ({
            noiseCancellationSupported: ey.Ay.isNoiseCancellationSupported(),
            noiseCancellationActive: (0, Z.A)(ey.Ay.getNoiseCancellation(), ey.Ay.getSystemMicrophoneMode()),
            noiseCancellationError: ey.Ay.isNoiseCancellationError(),
            canGoLive: (0, W.A)(ey.Ay)
        })),
        h = (0, c.bG)([ey.Ay, z.A], () => z.A.hasHotspot(eW._.VOICE_PANEL_INTRODUCTION) && (0, eU.mv)(l) && !ey.Ay.isInteractionRequired() && !o?.isGuildStageVoice()),
        _ = (0, c.bG)([eD.A], () => null != r && eD.A.hasVideo(r), [r]),
        ...
        f = eh.vL.useSetting(),
        [C, T, N] = (0, c.yK)([eM.Ay, er.A], () => o?.isGuildStageVoice() ? [er.A.getMutableParticipants(o.id, es.ip.SPEAKER), er.A.getParticipantsVersion(o.id), null] : [null, null, null != o ? eM.Ay.getVoiceStatesForChannel(o) : null], [o]),
        S = a.useMemo(() => C?.map(e => {
            let {
                user: t,
                userNick: n,
    ...
    return (0, i.jsx)(P.f5, {
        ...
        children: (0, i.jsxs)("div", {
            ...
            children: [null != t || null != n ? (0, i.jsx)(Y.A, {
                ...
                showSocialLayerStorefrontGiftingButton: M && j,
