...
function eZ() {
    ...
    } = (0, P.Ay)(), t = (0, c.bG)([eu.A], () => eu.A.isMuted()), n = t ? ez.intl.string(ez.t.ScHlfl) : ez.intl.string(ez.t.zqxfrf);
    return (0, i.jsx)(eG.A, {
        tooltipText: n,
        icon: t ? I.CIB : I.T7G,
        onClick: () => {
...
let e5 = (0, N.A)(function(e) {
    let t = (0, F.A)(),
        ...
        h = (0, c.bG)([eb.Ay, K.A], () => K.A.hasHotspot(eW._.VOICE_PANEL_INTRODUCTION) && (0, eU.mv)(l) && !eb.Ay.isInteractionRequired() && !o?.isGuildStageVoice()),
        ...
        f = eh.vL.useSetting(),
        [C, T, N] = (0, c.yK)([ej.Ay, ea.A], () => o?.isGuildStageVoice() ? [ea.A.getMutableParticipants(o.id, es.ip.SPEAKER), ea.A.getParticipantsVersion(o.id), null] : [null, null, null != o ? ej.Ay.getVoiceStatesForChannel(o) : null], [o]),
        S = r.useMemo(() => C?.map(e => {
            let {
                user: t,
                userNick: n,
    ...
    } = (0, P.Ay)(R.A.RTC_PANEL), L = (0, v.A)(d ?? eH.dJq, o?.id), D = (0, O.A)(o?.id), j = (0, et.T)({
