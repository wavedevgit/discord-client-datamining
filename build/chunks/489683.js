...
function eF(e) {
    ...
    eb.default.track(eM.HAw.NOISE_CANCELLATION_LINK_CLICKED, {
        ...
        href: t.href,
        location: {
            section: eM.JJy.NOISE_CANCELLATION_POPOUT
        }
    })
}
...
function eY() {
    let e = r.useRef(null);
    (0, _.tjt)(e), r.useEffect(() => {
        eb.default.track(eM.HAw.OPEN_POPOUT, {
            type: eM.JJy.NOISE_CANCELLATION_POPOUT
        })
    }, []);
    let {
    ...
    }), a = (0, c.bG)([eC.Ay], () => eC.Ay.getActiveInputProfile()), s = null != a && a !== ek.m.CUSTOM, o = eV.intl.string(eV.t.uKdWn6), d = eV.intl.string(eV.t.uKdWn6);
    return l ? (o = eV.intl.string(eV.t.mXZgC9), d = eV.intl.format(eV.t.F6lrb4, {
        onSettingsClick: () => {
            eC.Ay.getMediaEngine().showSystemCaptureConfigurationUI("microphone_modes")
        }
    })) : s && (o = eV.intl.formatToPlainString(eV.t["/tqmfM"], {
        ...
        children: [(0, i.jsx)(A.m_, {
            ...
            children: (0, i.jsx)("div", {
                children: (0, i.jsx)(_.dOG, {
                    ...
                    checked: t && !l,
                    disabled: s || l,
                    onChange: () => m.A.setNoiseCancellation(!t, {
                        section: eM.JJy.NOISE_CANCELLATION_POPOUT
                    })
                })
            })
...
function eW() {
    ...
    } = (0, y.Ay)(), t = (0, c.bG)([er.A], () => er.A.isMuted()), n = t ? eV.intl.string(eV.t.ScHlfl) : eV.intl.string(eV.t.zqxfrf);
    return (0, i.jsx)(eR.A, {
        tooltipText: n,
        icon: t ? _.CIB : _.T7G,
        onClick: () => {
...
function eq(e) {
    ...
    } = (0, y.Ay)(), d = (0, es.A)(), u = (0, ed.A)(t), p = (0, c.bG)([f.Ay], () => null != f.Ay.getSelfEmbeddedActivityForLocation(f.Ay.getConnectedActivityLocation())), g = (0, X.Ay)(t), {
        reachedLimit: E,
        limit: I
    } = (0, eo.A)(t), C = r.useCallback(() => {
        (0, eu.A)()
    }, []), T = (0, Y.Us)(), N = r.useCallback(e => {
            ...
            return (0, i.jsx)(_.YNO, {
                ...
                renderPopout: e => {
                    ...
                    return (0, i.jsx)(L.A, {
                        onClose: t,
                        minimal: !0,
                        onInteraction: (0, P.s)("VideoDeviceMenu", o)
                    })
                },
                position: "top",
                align: "center",
...
function eK(e) {
    ...
    } = (0, y.Ay)(), d = l === eM.BRT.POPOUT, m = (0, N.et)(t.id), p = (0, N.dL)(m), {
        userInActivity: g
    } = (0, c.cf)([f.Ay], () => ({
        userInActivity: null != f.Ay.getSelfEmbeddedActivityForChannel(t.id)
    })), E = (0, T.b)({
        surface: I.YI.VOICE_LAUNCHER,
        skipFetchingShelf: !0
    }), C = m !== N.xy.CAN_LAUNCH, S = r.useRef(null);
    return n ? (0, i.jsx)(M.GY, {
                ...
                children: (0, i.jsxs)(h.$n, {
                    ...
                    onClick: () => {
                        (0, b.A)({
                            ...
                            openInPopout: d,
                            analyticsLocation: o
                        }), (0, R.X)(s, R.O.ACTIVITY), n === u.M.ACTIVITIES_VOICE_LAUNCHER_BADGE && r(eU.i.TAKE_ACTION)
                    },
                    disabled: C,
                    className: a()(eB.x6, eB.Sq, {
                        [eB.rK]: g,
                    ...
                    wrapperClassName: eB.x6,
                    focusProps: eH,
                    children: [n === u.M.ACTIVITIES_VOICE_LAUNCHER_BADGE && (0, i.jsx)(x.a, {
                        top: -1,
                        right: -1
                    }), (0, i.jsx)(_.lmr, {
                        eventTargetRef: S,
...
function ez(e) {
    let {
    ...
    } = (0, y.Ay)(), [s, o] = r.useState(!1), [d, c] = (0, M.kn)([u.M.GAME_SHOP_RTC_GIFTING_NEW_BADGE], void 0, !0), m = r.useCallback(() => {
        o(!1)
    }, []), p = r.useCallback(e => {
        let {
            closePopout: n
        ...
        s ? o(!1) : o(!0), (0, R.X)(l, R.O.GIFTING), d === u.M.GAME_SHOP_RTC_GIFTING_NEW_BADGE && c(eU.i.TAKE_ACTION)
    }, [l, s, d, c]);
    return (0, i.jsx)(_.YNO, {
        targetElementRef: n,
        shouldShow: s,
        ...
        children: () => (0, i.jsx)(A.m_, {
            ...
            children: (0, i.jsxs)(h.$n, {
                ...
                wrapperClassName: eB.x6,
                focusProps: eH,
                children: [d === u.M.GAME_SHOP_RTC_GIFTING_NEW_BADGE && (0, i.jsx)(x.a, {
                    top: -4,
                    right: -4,
                    alert: !0
                }), (0, i.jsx)(_.xBs, {
    ...
    return (0, i.jsx)(_.YNO, {
        ...
        renderPopout: e => {
            ...
            return (0, i.jsx)(ec.A, {
                ...
                onInteraction: (0, P.s)("ManageStreamsMenu", u, {
                    entrypoint: ew.GK.OTHER_BUTTON
                })
            })
        },
        position: "top",
        ...
        children: e => {
            ...
            return (0, i.jsx)(A.m_, {
                ...
                children: (0, i.jsx)(h.$n, {
                    ...
                    wrapperClassName: eB.x6,
                    focusProps: eH,
                    children: O ? j : (0, i.jsxs)(D.A, {
                        align: D.A.Align.CENTER,
                        children: [j, eV.intl.string(eV.t["r0/+v7"])]
                    })
                })
            })
        }
...
class eQ extends r.PureComponent {
    ...
    handleChannelLinkClick = e => {
        ...
        o()(null != n, "Channel is null during navigation click"), e.stopPropagation(), g.A.channelListScrollTo(t?.id ?? eM.ME, n.id), (0, R.X)(v.A.RTC_PANEL, R.O.CHANNEL_LINK)
    };
    ...
    renderConnectionStatus() {
        ...
        return null != n ? (e = eM.BVt.CHANNEL(n.id, t.id), o = `${o} / ${n.name}`) : e = eM.BVt.CHANNEL(eM.ME, t.id), (0, i.jsx)(K.A, {
            channelId: t.id,
            quality: r,
            state: l,
            lastPing: a,
    ...
    renderNoiseCancellation() {
        ...
        return null != r ? null : l?.isGuildStageVoice() && null == a.find(e => e.user.id === eg.default.getId() && (0, el.eY)(e.voiceState) === el.zF.ON_STAGE) && (0, ei.Zl)(l.id) ? (0, i.jsx)(eW, {}) : !n && t ? (0, i.jsx)(A.m_, {
    ...
    renderVoiceStates() {
        ...
        return null != e && n && 0 !== t.length ? (0, i.jsx)(eD.A, {
            voiceStates: t,
            channel: e,
            className: eB.Xk
        }) : null
    ...
    render() {
        ...
        return null == e ? null : (0, i.jsx)(_.YNO, {
            ...
            children: () => (0, i.jsxs)("div", {
                ...
                children: [(0, i.jsxs)(D.A, {
                    ...
                    children: [(0, i.jsx)("div", {
                        ...
                        shrink: 0,
                        className: eB.nL,
                        children: [t ? this.renderNoiseCancellation() : null, (0, i.jsx)(ej.A, {
                            channel: e
                        })]
                    })]
...
let eZ = (0, E.A)(function(e) {
    let t = (0, U.A)(),
        ...
        h = (0, c.bG)([eC.Ay, H.A], () => H.A.hasHotspot(eG._.VOICE_PANEL_INTRODUCTION) && (0, eL.mv)(l) && !eC.Ay.isInteractionRequired() && !o?.isGuildStageVoice()),
        ...
        f = ea.vL.useSetting(),
        [T, N, x] = (0, c.yK)([ey.Ay, J.A], () => o?.isGuildStageVoice() ? [J.A.getMutableParticipants(o.id, ee.ip.SPEAKER), J.A.getParticipantsVersion(o.id), null] : [null, null, null != o ? ey.Ay.getVoiceStatesForChannel(o) : null], [o]),
        b = r.useMemo(() => T?.map(e => {
            let {
                user: t,
                userNick: n,
    ...
    let {
        analyticsLocations: R
    } = (0, y.Ay)(v.A.RTC_PANEL), P = (0, C.A)(d ?? eM.dJq, o?.id), j = (0, S.A)(o?.id), D = (0, z.T)({
        location: "RTCConnection"
    }), M = (0, $.A)({
        channelId: o?.id,
        location: "RTCConnection"
    ...
    return (0, i.jsx)(y.f5, {
        ...
        children: (0, i.jsxs)("div", {
            className: eB.iE,
            children: [null != t || null != n ? (0, i.jsx)(G.A, {
                voiceState: t,
