...
function eW(e) {
    ...
    eL.default.track(eU.HAw.NOISE_CANCELLATION_LINK_CLICKED, {
        ...
        href: t.href,
        location: {
            section: eU.JJy.NOISE_CANCELLATION_POPOUT
        }
    })
}
...
function eK() {
    let e = l.useRef(null);
    (0, E.tjt)(e), l.useEffect(() => {
        eL.default.track(eU.HAw.OPEN_POPOUT, {
            type: eU.JJy.NOISE_CANCELLATION_POPOUT
        })
    }, []);
    ...
    return n ? (s = eH.intl.string(eH.t.mXZgC9), o = eH.intl.format(eH.t.F6lrb4, {
        onSettingsClick: () => {
            eN.Ay.getMediaEngine().showSystemCaptureConfigurationUI("microphone_modes")
        }
    })) : r && (s = eH.intl.formatToPlainString(eH.t["/tqmfM"], {
        ...
        children: [(0, i.jsx)(g.m_, {
            ...
            children: (0, i.jsx)("div", {
                children: (0, i.jsx)(E.dOG, {
                    ...
                    checked: t && !n,
                    disabled: r || n,
                    onChange: () => I.A.setNoiseCancellation(!t, {
                        section: eU.JJy.NOISE_CANCELLATION_POPOUT
                    })
                })
            })
...
function eq() {
    ...
    } = (0, R.Ay)(), t = (0, c.bG)([er.A], () => er.A.isMuted()), n = t ? eH.intl.string(eH.t.ScHlfl) : eH.intl.string(eH.t.zqxfrf);
    return (0, i.jsx)(eD.A, {
        tooltipText: n,
        icon: t ? E.CIB : E.T7G,
        onClick: () => {
...
function ez(e) {
    let {
    ...
    } = (0, R.Ay)(), d = (0, ed.A)(), u = (0, eu.A)(t), A = (0, c.bG)([S.Ay], () => null != S.Ay.getSelfEmbeddedActivityForLocation(S.Ay.getConnectedActivityLocation())), h = (0, J.Ay)(t), {
        reachedLimit: m,
        limit: f
    } = (0, ec.A)(t), C = l.useCallback(() => {
        (0, eh.A)()
    }, []), T = (0, z.Us)(), N = l.useCallback(e => {
        ...
        play: v,
        events: y
    } = (0, _.K)(d.enabled ? "disable" : "enable");
    return l.useEffect(() => () => v(), [d.enabled, v]), (0, i.jsx)(ep.r, {
        onChange: N,
...
function e$(e) {
    ...
    } = (0, R.Ay)(), o = l === eU.BRT.POPOUT, d = (0, v.et)(t.id), h = (0, v.dL)(d), {
        userInActivity: _
    } = (0, c.cf)([S.Ay], () => ({
        userInActivity: null != S.Ay.getSelfEmbeddedActivityForChannel(t.id)
    })), m = (0, b.b)({
        surface: N.YI.VOICE_LAUNCHER,
        skipFetchingShelf: !0
    }), E = d !== v.xy.CAN_LAUNCH, {
        Component: I,
        events: f,
                ...
                children: (0, i.jsxs)(p.$n, {
                    ...
                    onClick: () => {
                        C(), (0, P.A)({
                            ...
                            openInPopout: o,
                            analyticsLocation: s
                        }), (0, M.X)(a, M.O.ACTIVITY), n === u.M.ACTIVITIES_VOICE_LAUNCHER_BADGE && l(ek.i.TAKE_ACTION)
                    },
                    onMouseEnter: () => {
                        f.onMouseEnter()
                    },
                    ...
                    wrapperClassName: eF.x6,
                    focusProps: eY,
                    children: [n === u.M.ACTIVITIES_VOICE_LAUNCHER_BADGE && (0, i.jsx)(O.a, {
                        top: -1,
                        right: -1
                    }), (0, i.jsx)(I, {
                        size: "md",
    ...
    return (0, i.jsx)(E.YNO, {
        ...
        renderPopout: e => {
            ...
            return (0, i.jsx)(eA.A, {
                ...
                onInteraction: (0, w.s)("ManageStreamsMenu", u, {
                    entrypoint: eG.GK.OTHER_BUTTON
                })
            })
        },
        position: "top",
        ...
        children: e => {
            ...
            return (0, i.jsx)(g.m_, {
                ...
                children: (0, i.jsx)(p.$n, {
                    ...
                    wrapperClassName: eF.x6,
                    focusProps: eY,
                    children: O ? U : (0, i.jsxs)(G.A, {
                        align: G.A.Align.CENTER,
                        children: [U, eH.intl.string(eH.t["r0/+v7"])]
                    })
                })
            })
        }
...
class eX extends l.PureComponent {
    ...
    handleChannelLinkClick = e => {
        ...
        o()(null != n, "Channel is null during navigation click"), e.stopPropagation(), C.A.channelListScrollTo(t?.id ?? eU.ME, n.id), (0, M.X)(L.A.RTC_PANEL, M.O.CHANNEL_LINK)
    };
    ...
    renderConnectionStatus() {
        ...
        return null != n ? (e = eU.BVt.CHANNEL(n.id, t.id), o = `${o} / ${n.name}`) : e = eU.BVt.CHANNEL(eU.ME, t.id), (0, i.jsx)(Z.A, {
            channelId: t.id,
            quality: l,
            state: a,
            lastPing: r,
    ...
    renderNoiseCancellation() {
        ...
        return null != l ? null : a?.isGuildStageVoice() && null == r.find(e => e.user.id === eI.default.getId() && (0, es.eY)(e.voiceState) === es.zF.ON_STAGE) && (0, ea.Zl)(a.id) ? (0, i.jsx)(eq, {}) : !n && t ? (0, i.jsx)(g.m_, {
    ...
    renderVoiceStates() {
        ...
        return null != e && n && 0 !== t.length ? (0, i.jsx)(ew.A, {
            voiceStates: t,
            channel: e,
            className: eF.Xk
        }) : null
    ...
    render() {
        ...
        return null == e ? null : (0, i.jsx)(E.YNO, {
            ...
            children: () => (0, i.jsxs)("div", {
                ...
                children: [(0, i.jsxs)(G.A, {
                    ...
                    children: [(0, i.jsx)("div", {
                        ...
                        shrink: 0,
                        className: eF.nL,
                        children: [t ? this.renderNoiseCancellation() : null, (0, i.jsx)(eM.A, {
                            channel: e
                        })]
                    })]
...
function eZ(e) {
    let {
        ...
        Component: d,
        events: c
    } = (0, m.G)(a ? "disable" : "enable");
    return l.useEffect(() => () => o(), [a, o]), (0, i.jsx)(eD.A, {
        ...t,
        ref: r,
        onClick: e => {
...
let eJ = (0, T.A)(function(e) {
    let t = (0, B.A)(),
        ...
        h = (0, c.bG)([eN.Ay, K.A], () => K.A.hasHotspot(eV._.VOICE_PANEL_INTRODUCTION) && (0, eP.mv)(a) && !eN.Ay.isInteractionRequired() && !o?.isGuildStageVoice()),
        ...
        f = eo.vL.useSetting(),
        [C, T, N] = (0, c.yK)([eO.Ay, et.A], () => o?.isGuildStageVoice() ? [et.A.getMutableParticipants(o.id, en.ip.SPEAKER), et.A.getParticipantsVersion(o.id), null] : [null, null, null != o ? eO.Ay.getVoiceStatesForChannel(o) : null], [o]),
        S = l.useMemo(() => C?.map(e => {
            let {
                user: t,
                userNick: n,
    ...
    } = (0, R.Ay)(L.A.RTC_PANEL), P = (0, x.A)(d ?? eU.dJq, o?.id), D = (0, y.A)(o?.id);
    return (0, i.jsx)(R.f5, {
        value: O,
        children: (0, i.jsxs)("div", {
            className: eF.iE,
            children: [null != t || null != n ? (0, i.jsx)(H.A, {
                voiceState: t,
