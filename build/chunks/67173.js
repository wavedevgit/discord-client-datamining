...
let O = Math.ceil(Math.sqrt(115200)),
    ...
    R = function(e) {
        let {
        ...
        }, [B, k, H]), [K, q] = l.useState(-1), z = l.useCallback(e => {
            q(e.contentRect.width)
        }, []), $ = (0, p.w)(z, [], {
            fireOnMount: !0
        }), Q = !M && P, X = !M && R, Z = M && w?.questHomeEntrypoint?.tooltipTitle != null, {
            ...
            let e = {
                ...
                l = w?.questHomeEntrypoint?.radialGradientEnd;
