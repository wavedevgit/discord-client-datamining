...
function B(e) {
    let {
        ...
        isUnread: o,
        groupedMessages: h
    } = e, A = n.type === P.rbe.UNKNOWN ? u.N$i : (0, g.gU)(n, null), p = (0, m.Ay)(n, !1), _ = (0, c.bG)([R.A], () => R.A.getGuild(n.getGuildId())), {
        nick: x,
        colorString: C
    } = (0, f.Ay)(t), {
        avatarSrc: N,
    ...
    let {
        ...
        return (0, s.useMemo)(() => {
            let e, s = "" === t.content,
                ...
                C = null;
            1 === c ? C = u.xfq : c > 1 ? C = u.sYc : d ? C = _.A : A || m ? C = u.YRe : h ? C = u.tEP : g && (C = u.HKD);
            let E = !0,
                I = null;
