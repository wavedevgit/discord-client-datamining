...
let I = e => {
    ...
    y = e => e.promotionType === b.pt.THIRD_PARTY_OUTBOUND_RECURRING ? e.partnerId?.toLowerCase() ?? null : e.outboundTitle.toLowerCase(),
    T = e => {
        let t, n, {
                transitionState: i,
                onClose: d,
            ...
            S = (0, l.yK)([R.A], () => R.A.outboundRecurringPromotions),
