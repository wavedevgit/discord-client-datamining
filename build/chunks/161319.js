...
let I = e => {
    ...
    P = e => {
        ...
        } = e, [r, s] = a.useState(t.length > 1), [l, o] = a.useState([]);
        return a.useEffect(() => {
            o([t.sort((e, t) => t.startDate > e.startDate ? 1 : -1)[0]])
        }, [t]), (0, n.jsxs)("div", {
            children: [l.map(e => (0, n.jsx)(v.wx, {
                recurrence: e,
                showPartnerLogo: !0,
                showPartnerImage: !0,
    ...
    S = e => {
        ...
        return (0, n.jsx)(i.Modal, {
            ...
            subtitle: N.intl.format(N.t.LOYRxB, {
                helpCenterLink: m.A.getArticleURL(j.MVz.RECURRING_PROMOTION)
            }),
            actions: [],
            preview: (() => {
    ...
    w = e => {
        ...
        c.default.track(j.HAw.RECURRING_PROMOTION_MODAL_OPENED, {
            location_stack: t
        }), g.Ay.fetchActivePromotions(), (0, l.mMO)(async () => {
            let {
                Recurring3PModal: e
