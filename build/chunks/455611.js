...
function m(e) {
    ...
    } = e, r = `${t.substr(0,4)}-${t.substr(4)}`, l = s.useRef(null), o = s.useCallback(e => {
        "c" === e.key && e.metaKey && c.p5 && (e.preventDefault(), e.stopPropagation(), (0, c.C)(r), l?.current?.focus())
    }, [r]);
    return (0, i.jsx)("li", {
        className: _.SX,
