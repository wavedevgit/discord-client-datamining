...
function m(e) {
    ...
    } = e, r = `${t.substr(0,4)}-${t.substr(4)}`, a = s.useRef(null), o = s.useCallback(e => {
        "c" === e.key && e.metaKey && d.p5 && (e.preventDefault(), e.stopPropagation(), (0, d.C)(r), a?.current?.focus())
    }, [r]);
    return (0, i.jsx)("li", {
        className: _.SX,
