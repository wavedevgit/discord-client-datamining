...
function N(e) {
    let {
        ...
        return (0, i.jsx)(g.A, {
            pickerIntention: A.b_.GUILD_ROLE_BENEFIT_EMOJI,
            channel: u,
            closePopout: t,
            onNavigateAway: t,
            onSelectEmoji: e => {
    ...
    }, [l, u]), f = s.useMemo(() => null == a && null == n.name ? null : function() {
        return (0, i.jsx)(c.A, {
            className: j.Zg,
            emojiId: n.id,
            emojiName: n.name,
    ...
    return null != a ? N = `:${a.name}:` : null != n.name && (N = h.Ay.convertSurrogateToName(n.name)), (0, i.jsx)(d.YNO, {
        targetElementRef: r,
...
function b(e) {
    let {
        ...
        transitionState: c,
        onClose: m
    } = e, [g, x] = s.useState(l?.ref_id), h = (0, u.GV)(), _ = (0, i.jsxs)(d.BJc, {
        gap: 16,
    ...
    return (0, i.jsx)(E, {
        ...
        canSubmit: null != g,
        onSave: function(e) {
            r()(null != g, "Cannot submit null channel"), a({
                ...e,
                channelId: g
            })
        },
...
function C(e) {
    let {
        ...
        onDelete: o,
        guildId: c
    } = e, [m, g] = s.useState(t?.name ?? ""), x = (0, u.GV)(), h = (0, i.jsx)(d.fs1, {
    ...
    return (0, i.jsx)(E, {
        ...
        canSubmit: "" !== m,
        onSave: function(e) {
            r()("" !== m, "Cannot submit empty name"), n({
                ...e,
                name: m
            })
        },
