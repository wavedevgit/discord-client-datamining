...
function Q(e) {
    ...
    return (0, i.jsx)(ee, {
        ...
        actions: [{
            ...
            variant: "primary",
            onClick: () => {
                n(D.i.TAKE_ACTION), l ? (0, S.A)(t, A.A.GUILD_POWERUPS_COACHMARK_GAME_SERVER_NEW_GAMES, R.W5) : (0, p.K)({
                    guildId: t,
                    location: {
                        section: L.JJy.GUILD_HEADER,
                        object: L.ZSU.BUTTON_CTA
...
function Z(e) {
    let {
        ...
        analyticsLocations: d
    } = (0, m.Ay)(A.A.GUILD_POWERUPS_COACHMARK_EXPIRING_PERK), u = (0, b.A)(t), p = r?.allPowerups[n.skuId], _ = (0, I.A)(p, !0), x = s.useRef(null), E = (0, c.bG)([h.A], () => h.A.useReducedMotion);
