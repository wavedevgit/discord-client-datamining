...
function W(e) {
    ...
    return (0, i.jsx)(en, {
        ...
        body: k.intl.formatToPlainString(P.default["1EGXSK"], {
            perkName: n.title
        }),
        actions: [{
...
function z(e) {
    ...
    let _ = n.length >= 3 ? k.intl.formatToPlainString(P.default["6Sv+3M"], {
            ...
            perk2: n[1].title,
            perk3: n[2].title
        }) : 2 === n.length ? k.intl.formatToPlainString(P.default.wcQOqC, {
            perks: `${n[0].title} & ${n[1].title}`
        }) : k.intl.formatToPlainString(P.default.ZF8NT6, {
            perk: n[0].title
        }),
        m = 1 === n.length;
    return (0, i.jsx)(en, {
        ...
        title: k.intl.formatToPlainString(P.default.LmpChE, {
            guildName: r
        }),
        body: _,
        actions: [{
...
function X(e) {
    ...
    return (0, i.jsx)(en, {
        ...
        body: n === C.o.GAME_SERVER_HOSTING_AVAILABLE ? k.intl.formatToPlainString(G.default["7KXp9J"], {
            gameName: r,
            gameName2: d
        }) : k.intl.format(G.default["IQ1E+d"], {
            boostCount: a
        }),
        actions: [{
            text: k.intl.string(k.t.RzWDqY),
...
function J(e) {
    let {
        ...
        markAsDismissed: n,
        channelRowRef: l
    } = e, s = (0, c.bG)([h.A], () => h.A.useReducedMotion);
    return (0, i.jsx)(en, {
        size: "video",
        targetElementRef: l,
        asset: (0, i.jsx)(o.E_w, {
...
function Q(e) {
    ...
    return (0, i.jsx)(en, {
        ...
        body: k.intl.formatToPlainString(G.default.V9qFAU, {
            gameName: s,
            gameName2: a
        }),
        actions: [{
...
function $(e) {
    ...
    return (0, i.jsx)(en, {
        ...
        actions: [{
            ...
            variant: "primary",
            onClick: () => {
                n(U.i.TAKE_ACTION), a ? (0, b.A)(t, A.A.GUILD_POWERUPS_COACHMARK_GAME_SERVER_NEW_GAMES, O.W5) : (0, m.K4)({
                    guildId: t,
                    location: {
                        section: M.JJy.GUILD_HEADER,
                        object: M.ZSU.BUTTON_CTA
...
function Z(e) {
    let {
        ...
        channelRowRef: l,
        ...s
    } = e, a = (0, S.A)(t), r = (0, c.bG)([h.A], () => h.A.useReducedMotion);
    return (0, i.jsx)(en, {
        size: "video",
        targetElementRef: l,
        ...s,
        ...
        actions: [{
            ...
            variant: "primary",
            onClick: () => {
                a ? (0, b.A)(t, A.A.GUILD_POWERUPS_COACHMARK_GAME_SERVER_PRICING_CHANGE, O.W5) : (n(U.i.TAKE_ACTION), (0, m.K4)({
                    guildId: t,
                    location: {
                        section: M.JJy.GUILD_HEADER,
                        object: M.ZSU.BUTTON_CTA
...
function ee(e) {
    let {
        ...
        available: o
    } = (0, T.A)(t), c = n.cost - o, d = (0, N.A)(n, !0), {
...
function et(e) {
    let {
        ...
        markAsDismissed: a,
        ...r
    } = e, d = (0, c.bG)([I.A], () => I.A.getStateForGuild(t)), {
        analyticsLocations: u
    } = (0, _.Ay)(A.A.GUILD_POWERUPS_COACHMARK_EXPIRING_PERK), m = d?.allPowerups[n.skuId], p = (0, N.A)(m, !0), x = l.useRef(null), E = (0, c.bG)([h.A], () => h.A.useReducedMotion);
    ...
    let C = n.isGameServer ? k.intl.string(P.default["9L0pAN"]) : k.intl.formatToPlainString(P.default.gG8bI8, {
        ...
        S = k.intl.formatToPlainString(T, {
