...
function W(e) {
    ...
    return (0, i.jsx)(en, {
        asset: (0, i.jsx)(T.b, {
            className: r()(w.Sl, w.SV)
        }),
        title: P.intl.formatToPlainString(U.default["Zg/m9K"], {
            perkName: n.title
        }),
        body: P.intl.formatToPlainString(U.default["1EGXSK"], {
            perkName: n.title
        }),
        actions: [{
...
function z(e) {
    let {
        ...
        channelRowRef: s,
        markAsDismissed: l
    } = e, a = (0, c.bG)([f.A], () => f.A.getGuild(t)?.name), {
        onActivate: o,
        isLoading: d,
        error: u
    } = (0, y.A)(t, n[0]), h = (0, I.A)(n[0], !0);
    if ((0, j.A)(u), 0 === n.length) return;
    let m = n.length >= 3 ? P.intl.formatToPlainString(U.default["6Sv+3M"], {
            perk: n[0].title,
            perk2: n[1].title,
            perk3: n[2].title
        }) : 2 === n.length ? P.intl.formatToPlainString(U.default.wcQOqC, {
...
function q(e) {
    let {
        ...
        channelRowRef: s,
        markAsDismissed: l
    } = e, r = n.find(e => e.skuId === a.FB);
    if (null != r) return (0, i.jsx)(en, {
        targetElementRef: s,
...
function Q(e) {
    let {
        ...
        gameName: l,
        gameName2: r
    } = (0, x.A)(), a = (0, c.bG)([h.A], () => h.A.useReducedMotion);
    return (0, i.jsx)(en, {
        size: "video",
        targetElementRef: s,
        position: "bottom",
        ...
        body: P.intl.formatToPlainString(G.default.V9qFAU, {
            gameName: l,
            gameName2: r
        }),
        actions: [{
...
function $(e) {
    ...
    return (0, i.jsx)(en, {
        ...
        actions: [{
            ...
            variant: "primary",
            onClick: () => {
                n(D.i.TAKE_ACTION), a ? (0, S.A)(t, A.A.GUILD_POWERUPS_COACHMARK_GAME_SERVER_NEW_GAMES, R.W5) : (0, _.K4)({
                    guildId: t,
                    location: {
                        section: L.JJy.GUILD_HEADER,
                        object: L.ZSU.BUTTON_CTA
...
function Z(e) {
    let {
        ...
        channelRowRef: s,
        ...l
    } = e, r = (0, b.A)(t), a = (0, c.bG)([h.A], () => h.A.useReducedMotion);
    return (0, i.jsx)(en, {
        size: "video",
        targetElementRef: s,
        ...l,
        ...
        actions: [{
            ...
            variant: "primary",
            onClick: () => {
                r ? (0, S.A)(t, A.A.GUILD_POWERUPS_COACHMARK_GAME_SERVER_PRICING_CHANGE, R.W5) : (n(D.i.TAKE_ACTION), (0, _.K4)({
                    guildId: t,
                    location: {
                        section: L.JJy.GUILD_HEADER,
                        object: L.ZSU.BUTTON_CTA
...
function et(e) {
    ...
    let N = n.isGameServer ? P.intl.string(U.default["9L0pAN"]) : P.intl.formatToPlainString(U.default.gG8bI8, {
        ...
        S = P.intl.formatToPlainString(b, {
