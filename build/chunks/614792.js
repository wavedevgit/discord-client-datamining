/** Chunk was on web.js **/
/** chunk id: 614792, original params: e,t,n (module,exports,require) **/
"use strict";
n.d(t, {
    A: () => g
...
class f {
    ...
    recordEnd() {
        0 === this.end_ && 0 !== this.start_ ? (this.recordEnd_(), r.A.mark(this.emoji, "Finish ".concat(this.name), this.end_ - this.start_)) : r.A.mark(this.emoji, "Finish ".concat(this.name)), c()
    }
    recordEnd_() {
        this.end_ = Date.now(), this.endNumImports = i.Ej(), this.endImportTime = u()
    }
    set(e, t) {
        0 === this.start_ && (this.start_ = e, this.end_ = e + t, this.endNumImports = i.Ej(), this.endImportTime = u()), r.A.mark(this.emoji, this.name, t), c()
    }
    serializeStart(e) {
...
class p {
    ...
    constructor(e, t, n = !1, r = !1) {
        a(this, "emoji", void 0), a(this, "name", void 0), a(this, "onlyOnce", void 0), a(this, "alwaysRecord", void 0), a(this, "time_", void 0), a(this, "numImports", void 0), a(this, "importTime", void 0), this.emoji = e, this.name = t, this.onlyOnce = n, this.alwaysRecord = r, this.time_ = 0, this.numImports = null, this.importTime = 0
    }
}
class _ {
    get time() {
