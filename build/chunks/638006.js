/** chunk id: 638006, original params: t,e,r (module,exports,require) **/
r.d(e, {
    A: () => _
});
var i = r(627968),
...
let k = t => {
    ...
    y = t => {
        let {
            ...
            showDefaultAvatar: l,
            disableAnimation: n
        } = t, a = (0, u.bG)([c.default], () => c.default.getCurrentUser()), m = (0, p.YW)(e), A = (0, f.D)(e), x = r && !n;
        switch (m) {
    ...
    _ = t => {
        let {
            ...
            variant: a
        } = (0, A.w)("ProductPreview"), u = a !== A.L.CONTROL, o = a === A.L.DEFAULT_AVATAR_NO_ANIMATION;
