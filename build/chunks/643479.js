/** Chunk was on web.js **/
/** chunk id: 643479, original params: e,t,n (module,exports,require) **/
"use strict";
n.d(t, {
    Aj: () => m,
    BD: () => o,
...
function f(e, t, n) {
    ...
    Object.defineProperty(e, t, {
        get: () => (r || (r = !0, Object.defineProperty(e, t, {
            configurable: !0,
            enumerable: !0,
            value: n.apply(e),
            writable: !0
...
function p(e) {
    return "u" > typeof btoa ? "string" == typeof e ? btoa(e) : btoa(Array.prototype.reduce.call(new Uint8Array(e), (e, t) => e + String.fromCharCode(t), "")) : void 0 !== i ? void 0 !== i.from ? i.from(e).toString("base64") : new i(e).toString("base64") : void 0
}

function _(e) {
    let t = e.substring(e.indexOf(",") + 1);
    if (-1 !== e.indexOf(";base64")) return "u" > typeof atob ? Uint8Array.from(atob(t), e => e.charCodeAt(0)).buffer : void 0 === i ? void 0 : void 0 !== i.from ? i.from(t, "base64") : new i(t, "base64");
    let n = decodeURIComponent(t);
    return void 0 !== i ? void 0 !== i.from ? i.from(n) : new i(n) : Uint8Array.from(n, e => e.charCodeAt(0)).buffer
}
