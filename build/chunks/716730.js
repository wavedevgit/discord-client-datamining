...
function x(e) {
    let {
        ...
        className: n,
        ...x
    } = e, C = s.useRef(null), E = (0, a.bG)([p.Ay], () => p.Ay.getFocusedLayout() === m.E8.RESIZABLE), I = s.useCallback(() => {
        let e = E ? m.E8.NO_CHAT : m.E8.RESIZABLE;
        (0, A.i5)(e)
    }, [E]), {
        unreadCount: N,
        mentionCount: S
    ...
    let T = E ? _.intl.string(_.t["5MstTl"]) : _.intl.string(_.t.kkKapG),
        v = [T];
    S > 0 && v.push(_.intl.formatToPlainString(_.t["3l1GOx"], {
        mentionCount: S
    })), N > 0 && v.push(_.intl.string(_.t.x5zAGZ));
    let y = (0, a.bG)([p.Ay], () => p.Ay.getFocusedLayout()),
        j = S > 0 ? S : N,
        R = j > 0;
    return (0, i.jsxs)("div", {
        className: f.iE,
