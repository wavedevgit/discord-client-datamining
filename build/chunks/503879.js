/** chunk id: 503879 params = (module,exports,require) **/
a.d(t, {
    s: () => v
});
var n = a(627968),
...
let C = `rel=0&iv_load_policy=3&showinfo=0&modestbranding=1&pageType=${f.NzX}`,
    ...
    N = e => {
        ...
        if (l.type === f.geh.YOUTUBE_VIDEO) t = {
            url: (0, f.PE$)(l.youtubeVideoId),
            ...j
        }, a = {
            url: `${(0,f.uJ2)(l.youtubeVideoId)}?${C}`,
            ...I
        }, i = u.mt.YOUTUBE;
        else {
...
class T extends i.PureComponent {
    ...
    componentWillUnmount() {
        A._.unsubscribe(f.jej.CAROUSEL_PREV, this.manualPrevious), A._.unsubscribe(f.jej.CAROUSEL_NEXT, this.manualNext)
    }
    getItemSize = () => {
        let {
            width: e
        } = this.props, t = v.MEDIUM;
    ...
    setItem = (e, t) => {
        ...
        } = this, l = (0, p.U3)(i, a.length), s = (0, p.U3)(e, a.length), r = 1 === Math.abs(e - l) || e === a.length - 1 && 0 === l || 0 === e && l === a.length - 1;
        this.setState({
            playingVideo: !1,
            currentIndex: s,
            animate: r,
    ...
    renderItem = (e, t, a) => {
        ...
        return (0, n.jsx)(r.A.div, {
            ...
            children: e.type === f.geh.VIDEO || e.type === f.geh.YOUTUBE_VIDEO ? (0, n.jsx)(N, {
                item: e,
    ...
    getPaginationSrc(e) {
        return e.type === f.geh.YOUTUBE_VIDEO ? (0, f.PE$)(e.youtubeVideoId) : e.type === f.geh.IMG ? e.src : e.type === f.geh.VIDEO ? e.thumbnailSrc : null
    }
    renderPaginationItem = (e, t) => {
        ...
        return (0, n.jsxs)("div", {
            ...
            children: [(0, n.jsx)("img", {
                ...
                draggable: !1
            }), e.type === f.geh.YOUTUBE_VIDEO || e.type === f.geh.VIDEO ? (0, n.jsx)(y, {}) : null, i ? (0, n.jsx)("div", {
                className: b.SD
            }) : null]
        }, `page-${t}`)
    };
