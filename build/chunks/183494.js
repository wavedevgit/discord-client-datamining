...
function h(e) {
    let {
        ...
        onClick: R,
        onDragStateChange: T
    }), V = l.useMemo(() => null == G || null == k ? null : (0, u.rB)((0, u.hc)(G, k, v)), [G, k, v]), W = l.useMemo(() => {
            ...
            t = () => {
                ...
                if (null != l) {
                    ...
                    if (null != e && Number.isFinite(e)) {
                        let t = e - l;
                        l = Math.abs(t) > .5 ? e : l + .1 * t
                    }
                } else l = D() ?? null;
                null != l && Number.isFinite(l) && (en.current = l, et.current = l, J({
                    playbackPxSpring: Math.min(Math.max(0, l / v * H), H),
                    immediate: !0
    ...
    l.useEffect(() => {
        ...
        if (!el) {
            ...
            null == e && (e = null == W || Number.isNaN(W) ? 0 : W), J({
                playbackPxSpring: e,
                immediate: !0
            })
        }
    ...
    let ea = v > 1,
        ...
        es = l.useMemo(() => {
            let e;
            return null != ei && null != k && ea ? (e = k.width, ei.map(t => {
        ...
        ec = l.useCallback(e => null != e && null != es && es.some(t => e >= t.leftPx - t.gapPx - (P?.animatingIndex === t.index ? eo : 0) && e <= t.rightPx + t.gapPx + (P?.animatingIndex === t.index ? eo : 0)), [es, P?.animatingIndex, eo]);
    return (0, r.jsx)("div", {
        className: m.jD,
        ref: j,
        "data-testid": M,
        ...
        children: (0, r.jsxs)(o.DUT, {
            ...
            children: [(0, r.jsx)("div", {
                ...
                children: null != k && eu.map((e, t) => (0, r.jsx)(d.A, {
                    segment: e,
                    playbackPxSpring: Z,
                    playerState: E,
                    isDragging: $,
            ...
            }), null != k && es?.map(e => P?.renderIndicator(e, null != W && !Number.isNaN(W) ? W : 0)), O && null != V && t && !ec(G) && (0, r.jsx)(o.Text, {
                className: m.Ey,
                ...
                children: V
            }), (O || N) && h && null != W && !ec($ && null != _ ? _ : W) && (0, r.jsx)(s.animated.div, {
                ref: q,
                "data-testid": "discord-web-video-player-playhead",
                className: m.lG,
                style: {
                    left: $ && null != _ ? `${_}px` : Z.to(e => `${e}px`)
                }
            })]
        })
    })
