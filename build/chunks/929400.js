...
let eU = e => {
        let {
            ...
            product: n,
            user: i
        } = e, s = a.useRef(null), l = (0, W.aw)(n), {
            firstAvatarDecoration: o
        } = (0, Z.f5)(n);
        return t.type === d.R.AVATAR_DECORATION ? (0, r.jsx)("div", {
        ...
        }) : t.type === d.R.PROFILE_EFFECT ? (0, r.jsx)("div", {
        ...
        }) : t.type === d.R.NAMEPLATE ? (0, r.jsx)("div", {
            ref: s,
            className: eM.Dz,
    ...
    eV = e => {
        ...
        return (0, W.aw)(t) ? (0, r.jsx)(eD, {
            product: t,
            user: n,
            activeSlide: a
        }) : (0, ek.pQ)(t.skuId) ? (0, r.jsx)(ej.B, {
            animationState: "on_hover",
            product: t
        }) : t.items.length > 0 ? (0, r.jsx)(eU, {
            item: t.items[0],
            product: t,
            user: n
        }) : null
    ...
    eH = e => {
        let {
            ...
            sessionId: E,
            tilePosition: y
        } = (0, H.uM)() ?? {}, O = D.Ay.canUseCollectibles(n), {
            previewingVariantIndex: k,
            handleEntering: B,
            handleLeaving: M
        } = g, U = (0, eI.q)(t, k), z = (0, et.rb)(t, A);
        ...
        let eQ = a.useCallback(() => (0, R.A)({
            skuId: z.skuId,
            analyticsLocations: b,
            onClose: e => e ? u() : (0, eL.tE)()
        }), [b, u, z.skuId]);
        return a.useEffect(() => {
            if (null != eb) return (0, P.p)({
                avatarDecoration: eb
            }), () => (0, P.p)({
            ...
            children: [(0, r.jsx)("div", {
                ...
                children: [(0, r.jsxs)("div", {
                    ...
                    children: [(0, r.jsx)(ec.A, {
                        ...
                        skuId: z.skuId
                    }), X.isPurchased || X.isPartiallyOwnedBundle ? (0, r.jsx)(ei.c, {
                        className: eM.On,
                        isPartiallyPurchased: ee
                    }) : ev ? (0, r.jsx)(x.Text, {
                        ...
                        children: [(0, r.jsx)(em.A, {
                            ...
                            nitroIconSize: "xs",
                            discountOfferAmount: eF
                        }), O || ez ? null : (0, r.jsx)(eh.A, {
                            product: z
                        })]
                    })]
                }), (0, et.B1)(t) && (0, r.jsx)(x.M1G, {
                    children: (0, r.jsxs)("div", {
                        className: s()(eM.Oj, {
                            [eM.OJ]: eW
                        }),
                        children: [eW && (0, r.jsx)(e_.A, {
                            skuId: t.skuId,
                    ...
                    children: (() => {
                        if (ev && !O && !eN) {
                            let e;
                            return e = eB.intl.string(eB.t.sEAnVH), (0, r.jsx)(T.A, {
                        ...
                        return es ? Q ? eU ? (0, r.jsxs)(x.ButtonGroup, {
                            wrap: !1,
                            fullWidth: !0,
                            ...
                            children: eK.map((e, t) => {
                                ...
                                if (e.currency === eL.Yr.DISCORD_ORB) {
                                    let t, n, i, s;
                                    return t = en ? eB.intl.string(eB.t.cTdr3x) : eB.intl.string(eB.t.zqh7ZM), n = !eZ || en, i = eB.intl.formatToPlainString(eB.t.yi41qQ, {
                                        orbPrice: e.amount
                                    }), s = n ? `${i}, ${t}` : i, (0, r.jsx)(h.m, {
                                        position: "top",
                                        text: t,
                                        shouldShow: n,
                                        "aria-label": !1,
                                        children: (0, r.jsx)(x.Button, {
                                            ...
                                            disabled: n,
                                            "aria-label": s,
                                            text: eB.intl.format(eJ ? eB.t.JC15qj : eB.t.lOtBOI, {
                                                orbPrice: e.amount,
                                ...
                                return n = (0, W.aw)(z) ? eB.intl.string(eB.t.V1AWw0) : z.type === d.R.PROFILE_EFFECT ? eB.intl.string(eB.t.kAeDcK) : z.type === d.R.NAMEPLATE ? eB.intl.string(eB.t.H3vhqU) : eB.intl.string(eB.t.AQ0Veg), ez ? n = eB.intl.formatToPlainString(eB.t["5U5RB5"], {
                                    discountOfferAmount: eF
                                }) : eD && (n = eB.intl.formatToPlainString(eB.t["cNSL/j"], {
    ...
    eW = e => {
        let {
            ...
            activeBundleSlide: a,
            isTransitioning: i
        } = e, l = (0, m.bG)([v.A], () => v.A.useReducedMotion), o = D.Ay.canUsePremiumProfileCustomization(n), {
            pendingAvatar: c,
            ...u
        } = (0, m.cf)([O.A], () => O.A.getPendingChanges()), h = (0, y.V7)({
            userId: n.id,
            image: c
        }), p = t.type === d.R.AVATAR_DECORATION, [x] = t.items, {
            firstAvatarDecoration: f,
            firstProfileEffect: g,
            firstNameplate: _
        } = (0, Z.f5)(t), A = null != g, j = () => (0, r.jsxs)(r.Fragment, {
        ...
        if (t.type === d.R.BUNDLE) {
            if (!(0, en.Wb)(t)) return (0, r.jsx)("div", {
                className: eM.RA,
                children: (0, r.jsx)("div", {
                    className: eM.bo,
                    children: j()
            ...
            });
            {
                let e = a ?? 0,
                    ...
                    c = o?.type !== n?.type && !l;
                return n.type === d.R.NAMEPLATE ? (0, r.jsx)("div", {
                    className: s()(eM.Zj, i && c ? eM.p2 : ""),
                    children: C(n)
                }) : (0, r.jsx)("div", {
                    className: s()(eM.Ak, i && c ? eM.p2 : ""),
                    children: j()
                })
            }
        }
        return null != _ ? (0, r.jsx)("div", {
            ...
            className: x?.type === d.R.AVATAR_DECORATION ? eM.RA : eM.Ak,
            children: j()
        })
    },
    e$ = e => {
        let {
            ...
            return (0, C.rh)({
                ...(0, N.Ay)({
                    author: t,
                    channelId: "1337",
                    content: eB.intl.string(eB.t.d5YwK5)
                }),
                state: eS.cmJ.SENT,
                id: "0"
            })
    ...
    eq = e => {
        let {
            ...
            giftRecipient: C,
            giftingOrigin: N
        } = e, b = (0, m.bG)([B.default], () => B.default.getCurrentUser()), I = (0, ey.f)(i), {
            previewingVariantIndex: R
        } = I, T = (0, z.Q)(i), E = (0, eI.q)(i, R), y = (0, et.rb)(i, T);
        ...
        return null == b ? null : (0, r.jsx)(_.f5, {
            value: P,
            children: (0, r.jsxs)(x.EOs, {
                ...
                children: [(0, r.jsxs)(x.$mQ, {
                    ...
                    children: [(0, r.jsx)(eH, {
                        ...
                        className: s()(eM.i1, y.skuId === u.j.PREMIUM_TIER_2_3_DAY ? eM.bF : y.type === d.R.AVATAR_DECORATION ? eM.Jq : eM.eF),
                        style: {
                            backgroundImage: `url(${O})`
                        },
                        children: [(0, ek.pQ)(i.skuId) ? i.skuId === ek.Dp.ORB_PROFILE_BADGE ? V || F ? null : (0, r.jsx)(ev.z, {
                            user: b
                        }) : i.skuId === u.j.PREMIUM_TIER_2_3_DAY ? (0, r.jsx)(ef.I, {}) : (0, r.jsx)(ej.B, {
                            product: i,
                            className: eM.Ms
                        }) : (0, r.jsx)(eW, {
                            user: b,
