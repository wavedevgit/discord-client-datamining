...
let ek = e => {
    ...
    eB = e => {
        ...
        return t === d.j.PREMIUM_TIER_2_3_DAY ? (0, n.jsx)(_.Text, {
            variant: "text-sm/normal",
            className: eO.CU,
    ...
    eM = e => {
        ...
        } = (0, g.Ay)(), N = D.Ay.canUseCollectibles(a), {
            previewingVariantIndex: b,
            handleEntering: I,
            handleLeaving: E
        } = v, P = (0, eA.q)(t, b), S = (0, Z.rb)(t, A);
        ...
        let O = (0, J.h)(t),
            ...
            eH = r.useCallback(() => (0, T.A)({
                skuId: S.skuId,
                analyticsLocations: j,
                onClose: e => e ? x() : (0, eP.tE)()
            }), [j, x, S.skuId]);
        return r.useEffect(() => {
            ...
            children: [(0, n.jsx)("div", {
                ...
                children: [(0, n.jsxs)("div", {
                    ...
                    children: [(0, n.jsx)(er.A, {
                        ...
                        skuId: S.skuId
                    }), O.isPurchased || O.isPartiallyOwnedBundle ? (0, n.jsx)(ee.c, {
                        className: eO.On,
                        ...
                        children: [(0, n.jsx)(el.A, {
                            ...
                            nitroIconSize: "xs",
                            discountOfferAmount: ek
                        }), N || ew ? null : (0, n.jsx)(ec.A, {
                            product: S
                        })]
                    })]
                }), (0, Z.B1)(t) && (0, n.jsx)(_.M1G, {
                    children: (0, n.jsxs)("div", {
                        className: s()(eO.Oj, {
                            [eO.OJ]: eM
                        }),
                        children: [eM && (0, n.jsx)(e_.A, {
                            skuId: t.skuId,
                    ...
                    children: (() => {
                        if (ea && !N && !eu) {
                            let e;
                            return e = eS.intl.string(eS.t.sEAnVH), (0, n.jsx)(R.A, {
                        ...
                        return H ? k ? ev ? (0, n.jsxs)(_.ButtonGroup, {
                            wrap: !1,
                            fullWidth: !0,
                            ...
                            children: eG.map((e, t) => {
                                ...
                                if (e.currency === eP.Yr.DISCORD_ORB) {
                                    let t, a, i, s;
                                    return t = M ? eS.intl.string(eS.t.cTdr3x) : eS.intl.string(eS.t.zqh7ZM), a = !eF || M, i = eS.intl.formatToPlainString(eS.t.yi41qQ, {
                                        orbPrice: e.amount
                                    }), s = a ? `${i}, ${t}` : i, (0, n.jsx)(m.m, {
                                        position: "top",
                                        text: t,
                                        shouldShow: a,
                                        "aria-label": !1,
                                ...
                                return a = (0, z.aw)(S) ? eS.intl.string(eS.t.V1AWw0) : S.type === o.R.PROFILE_EFFECT ? eS.intl.string(eS.t.kAeDcK) : S.type === o.R.NAMEPLATE ? eS.intl.string(eS.t.H3vhqU) : eS.intl.string(eS.t.AQ0Veg), ew ? a = eS.intl.formatToPlainString(eS.t["5U5RB5"], {
                                    discountOfferAmount: ek
                                }) : ej && (a = eS.intl.formatToPlainString(eS.t["cNSL/j"], {
    ...
    eG = e => {
        let {
            ...
            activeBundleSlide: r,
            isTransitioning: i
        } = e, l = (0, u.bG)([x.A], () => x.A.useReducedMotion), c = D.Ay.canUsePremiumProfileCustomization(a), {
            pendingAvatar: d,
            ...m
        } = (0, u.cf)([O.A], () => O.A.getPendingChanges()), p = (0, S.V7)({
            userId: a.id,
            image: d
            ...
            firstNameplate: v
        } = (0, K.f5)(t), A = null != g, C = () => (0, n.jsxs)(n.Fragment, {
        ...
        if (t.type === o.R.BUNDLE) {
            ...
            });
            {
                ...
                return a.type === o.R.NAMEPLATE ? (0, n.jsx)("div", {
                    className: s()(eO.Zj, i && d ? eO.p2 : ""),
                    children: j(a)
                }) : (0, n.jsx)("div", {
                    className: s()(eO.Ak, i && d ? eO.p2 : ""),
                    children: C()
                })
            }
        }
        return null != v ? (0, n.jsx)("div", {
            ...
            className: h?.type === o.R.AVATAR_DECORATION ? eO.RA : eO.Ak,
            children: C()
        })
    },
    eV = e => {
        let {
            ...
            return (0, A.rh)({
                ...(0, C.Ay)({
                    author: t,
                    channelId: "1337",
                    content: eS.intl.string(eS.t.d5YwK5)
                }),
                state: ey.cmJ.SENT,
                id: "0"
            })
    ...
    eF = e => {
        let {
            ...
            tab: v
        } = e, A = (0, u.bG)([B.default], () => B.default.getCurrentUser()), C = (0, eb.f)(i), {
            previewingVariantIndex: j
        } = C, N = (0, H.Q)(i), b = (0, eA.q)(i, j), I = (0, Z.rb)(i, N);
        c()(null != I, "Selected product should not be null");
        let {
            analyticsLocations: T
        } = (0, g.Ay)([...h, f.A.COLLECTIBLES_SHOP_DETAILS_MODAL]);
        (0, en.Yr)(I.skuId);
        let R = (0, ej.U1)(l);
        r.useEffect(() => {
        ...
        return null == A ? null : (0, n.jsx)(g.f5, {
            value: T,
            children: (0, n.jsxs)(_.EOs, {
                ...
                children: [(0, n.jsxs)(_.$mQ, {
                    ...
                    children: [(0, n.jsx)(eM, {
                        ...
                        className: s()(eO.i1, I.skuId === d.j.PREMIUM_TIER_2_3_DAY ? eO.bF : I.type === o.R.AVATAR_DECORATION ? eO.Jq : eO.eF),
                        style: {
                            backgroundImage: `url(${R})`
                        },
                        children: [(0, eR.pQ)(i.skuId) ? i.skuId === eR.Dp.ORB_PROFILE_BADGE ? E || P ? null : (0, n.jsx)(em.z, {
                            user: A
                        }) : i.skuId === d.j.PREMIUM_TIER_2_3_DAY ? (0, n.jsx)(eu.I, {}) : (0, n.jsx)(ex.B, {
                            product: i,
                            className: eO.Ms
                        }) : (0, n.jsx)(eG, {
                            user: A,
