...
let eD = e => {
    ...
    eV = e => {
        ...
        return (0, W.aw)(t) ? (0, r.jsx)(eH, {
            product: t,
            user: n,
            activeSlide: a
        }) : (0, ey.pQ)(t.skuId) ? (0, r.jsx)(ej.B, {
            ...
            children: [(0, r.jsx)("div", {
                ...
                children: [(0, r.jsxs)("div", {
                    ...
                    children: [(0, r.jsx)(ed.A, {
                        ...
                        skuId: X.skuId
                    }), Q.isPurchased || Q.isPartiallyOwnedBundle ? (0, r.jsx)(es.c, {
                        className: eU.On,
                        ...
                        children: [(0, r.jsx)(eh.A, {
                            ...
                            nitroIconSize: "xs",
                            discountOfferAmount: ez
                        }), P || eW ? null : (0, r.jsx)(ep.A, {
                            product: X,
                            onTrackClick: I
                        })]
                    })]
                }), (0, en.B1)(t) && (0, r.jsx)(x.M1G, {
                    children: (0, r.jsxs)("div", {
                        className: s()(eU.Oj, {
                            [eU.OJ]: e$
                        }),
                        children: [e$ && (0, r.jsx)(eA.A, {
                            skuId: t.skuId,
                    ...
                    children: (() => {
                        if (ev && !P && !eI) {
                            let e;
                            return e = eM.intl.string(eM.t.sEAnVH), (0, r.jsx)(T.A, {
                        ...
                        return el ? ee ? eD ? (0, r.jsxs)(x.ButtonGroup, {
                            wrap: !1,
                            fullWidth: !0,
                            ...
                            onClick: async () => {
                                I(ey.sH.ADD_TO_COLLECTION), await (0, V.iJ)(X.skuId), u(), (0, eP.A)({
                                    product: X,
                                    analyticsLocations: b,
                            ...
                            children: eJ.map((e, t) => {
                                ...
                                if (e.currency === eB.Yr.DISCORD_ORB) {
                                    let t, n, i, s;
                                    return t = er ? eM.intl.string(eM.t.cTdr3x) : eM.intl.string(eM.t.zqh7ZM), n = !eX || er, i = eM.intl.formatToPlainString(eM.t.yi41qQ, {
                                        orbPrice: e.amount
                                        ...
                                        children: (0, r.jsx)(x.Button, {
                                            ...
                                            disabled: n,
                                            "aria-label": s,
                                            text: eM.intl.format(eY ? eM.t.JC15qj : eM.t.lOtBOI, {
                                                orbPrice: e.amount,
                                ...
                                return n = (0, W.aw)(X) ? eM.intl.string(eM.t.V1AWw0) : X.type === d.R.PROFILE_EFFECT ? eM.intl.string(eM.t.kAeDcK) : X.type === d.R.NAMEPLATE ? eM.intl.string(eM.t.H3vhqU) : eM.intl.string(eM.t.AQ0Veg), eW ? n = eM.intl.formatToPlainString(eM.t["5U5RB5"], {
                                    discountOfferAmount: ez
    ...
    e$ = e => {
        let {
            ...
            activeBundleSlide: a,
            isTransitioning: i
        } = e, l = (0, m.bG)([_.A], () => _.A.useReducedMotion), o = D.Ay.canUsePremiumProfileCustomization(n), {
            pendingAvatar: c,
            ...u
        } = (0, m.cf)([S.A], () => S.A.getPendingChanges()), h = (0, E.V7)({
            userId: n.id,
            image: c
            ...
            firstNameplate: g
        } = (0, Z.f5)(t), A = null != v, C = () => (0, r.jsxs)(r.Fragment, {
        ...
        if (t.type === d.R.BUNDLE) {
            if (!(0, er.Wb)(t)) return (0, r.jsx)("div", {
                className: eU.RA,
                children: (0, r.jsx)("div", {
                    className: eU.bo,
                    children: C()
        ...
        return null != g ? (0, r.jsx)("div", {
            ...
            className: x?.type === d.R.AVATAR_DECORATION ? eU.RA : eU.Ak,
            children: C()
        })
    },
    eq = e => {
    ...
    eK = e => {
        let {
            ...
            giftRecipient: j,
            giftingOrigin: N
        } = e, I = (0, m.bG)([B.default], () => B.default.getCurrentUser()), b = (0, eO.f)(i), {
            previewingVariantIndex: R
        } = b, T = (0, z.Q)(i), k = (0, eR.q)(i, R), E = (0, en.rb)(i, T);
        o()(null != E, "Selected product should not be null");
        let {
            analyticsLocations: O
        } = (0, g.Ay)([...f, v.A.COLLECTIBLES_SHOP_DETAILS_MODAL]);
        (0, ec.Yr)(E.skuId);
        let S = (0, ek.U1)(l);
        a.useEffect(() => {
        ...
        let {
            ...
            sessionId: U,
            tilePosition: D
        } = (0, G.uM)() ?? {}, H = a.useMemo(() => (0, en.v8)(i), [i]), F = (0, X.R)({
            skuId: E.skuId,
            productSkuIds: H,
            analyticsLocations: O
        });
            ...
            children: (0, r.jsxs)(x.EOs, {
                ...
                children: [(0, r.jsxs)(x.$mQ, {
                    ...
                    children: [(0, r.jsx)(eF, {
                        ...
                        children: [(0, ey.pQ)(i.skuId) ? i.skuId === ey.Dp.ORB_PROFILE_BADGE ? $ || q ? null : (0, r.jsx)(ev.z, {
                            user: I
                        }) : i.skuId === u.j.PREMIUM_TIER_2_3_DAY ? (0, r.jsx)(e_.I, {}) : (0, r.jsx)(ej.B, {
                            product: i,
                            className: eU.Ms
                        }) : (0, r.jsx)(e$, {
                            user: I,
