...
let ek = e => {
    ...
    eL = e => {
        ...
        return (0, z.aw)(t) ? (0, n.jsx)(ew, {
            product: t,
            user: r,
            activeSlide: i
        }) : (0, eT.pQ)(t.skuId) ? (0, n.jsx)(ex.B, {
            animationState: "on_hover",
            product: t
        }) : t.items.length > 0 ? (0, n.jsx)(ek, {
            item: t.items[0],
            product: t,
            user: r
        }) : null
    ...
    eB = e => {
        ...
        return t === d.j.PREMIUM_TIER_2_3_DAY ? (0, n.jsx)(f.Text, {
            variant: "text-sm/normal",
            className: eS.CU,
    ...
    eU = e => {
        ...
        } = (0, g.Ay)(), R = D.Ay.canUseCollectibles(r), {
            previewingVariantIndex: E,
            handleEntering: P,
            handleLeaving: y
        } = _, S = (0, eA.q)(t, E), k = (0, Z.rb)(t, A);
        ...
        let B = (0, J.h)(t),
            ...
            eH = d === eT.G2.ORBS && l ? ep.Hi.ORBS : eG ? ep.Hi.FIAT : void 0,
            {
                ...
                isPremiumUser: R,
                hasDiscountOffer: eM,
                prioritizedCurrency: eH
            }),
            eW = i.useCallback(() => (0, I.A)({
                skuId: k.skuId,
                analyticsLocations: b,
                onClose: e => e ? x() : (0, ey.tE)()
            }), [b, x, k.skuId]);
        return i.useEffect(() => {
            if (null != eg) return (0, O.p)({
                avatarDecoration: eg
            }), () => (0, O.p)({
            ...
            children: [(0, n.jsx)("div", {
                ...
                children: [(0, n.jsxs)("div", {
                    ...
                    children: [(0, n.jsx)(ei.A, {
                        ...
                        skuId: k.skuId
                    }), B.isPurchased || B.isPartiallyOwnedBundle ? (0, n.jsx)(ee.c, {
                        className: eS.On,
                        ...
                        children: [(0, n.jsx)(el.A, {
                            ...
                            nitroIconSize: "xs",
                            discountOfferAmount: eU
                        }), R || eM ? null : (0, n.jsx)(ec.A, {
                            product: k
                        })]
                    })]
                }), (0, Z.B1)(t) && (0, n.jsx)(f.M1G, {
                    children: (0, n.jsxs)("div", {
                        className: a()(eS.Oj, {
                            [eS.OJ]: eD
                        }),
                        children: [eD && (0, n.jsx)(ef.A, {
                            skuId: t.skuId,
                    ...
                    children: (() => {
                        if (eu && !R && !ex) {
                            let e;
                            return e = eO.intl.string(eO.t.sEAnVH), (0, n.jsx)(T.A, {
                        ...
                        return Q ? U ? eb ? (0, n.jsxs)(f.ButtonGroup, {
                            wrap: !1,
                            fullWidth: !0,
                            ...
                            children: eV.map((e, t) => {
                                ...
                                if (e.currency === ey.Yr.DISCORD_ORB) {
                                    let t, r, s, a;
                                    return t = F ? eO.intl.string(eO.t.cTdr3x) : eO.intl.string(eO.t.zqh7ZM), r = !ez || F, s = eO.intl.formatToPlainString(eO.t.yi41qQ, {
                                        orbPrice: e.amount
                                    }), a = r ? `${s}, ${t}` : s, (0, n.jsx)(m.m, {
                                        position: "top",
                                        text: t,
                                        shouldShow: r,
                                        "aria-label": !1,
                                ...
                                return r = (0, z.aw)(k) ? eO.intl.string(eO.t.V1AWw0) : k.type === o.R.PROFILE_EFFECT ? eO.intl.string(eO.t.kAeDcK) : k.type === o.R.NAMEPLATE ? eO.intl.string(eO.t.H3vhqU) : eO.intl.string(eO.t.AQ0Veg), eM ? r = eO.intl.formatToPlainString(eO.t["5U5RB5"], {
                                    discountOfferAmount: eU
                                }) : ek && (r = eO.intl.formatToPlainString(eO.t["cNSL/j"], {
    ...
    eG = e => {
        let {
            ...
            activeBundleSlide: i,
            isTransitioning: s
        } = e, l = (0, u.bG)([x.A], () => x.A.useReducedMotion), c = D.Ay.canUsePremiumProfileCustomization(r), {
            pendingAvatar: d,
            ...m
        } = (0, u.cf)([S.A], () => S.A.getPendingChanges()), p = (0, y.V7)({
            userId: r.id,
            image: d
        }), f = t.type === o.R.AVATAR_DECORATION, [h] = t.items, {
            firstAvatarDecoration: v,
            firstProfileEffect: g,
            firstNameplate: _
        } = (0, K.f5)(t), A = null != g, j = () => (0, n.jsxs)(n.Fragment, {
        ...
        if (t.type === o.R.BUNDLE) {
            if (!(0, Y.Wb)(t)) return (0, n.jsx)("div", {
                className: eS.RA,
                children: (0, n.jsx)("div", {
                    className: eS.bo,
                    children: j()
            ...
            });
            {
                let e = i ?? 0,
                    ...
                    d = c?.type !== r?.type && !l;
                return r.type === o.R.NAMEPLATE ? (0, n.jsx)("div", {
                    className: a()(eS.Zj, s && d ? eS.p2 : ""),
                    children: N(r)
                }) : (0, n.jsx)("div", {
                    className: a()(eS.Ak, s && d ? eS.p2 : ""),
                    children: j()
                })
            }
        }
        return null != _ ? (0, n.jsx)("div", {
            ...
            className: h?.type === o.R.AVATAR_DECORATION ? eS.RA : eS.Ak,
            children: j()
        })
    },
    eH = e => {
    ...
    eV = e => {
        let {
            ...
            giftRecipient: A,
            giftingOrigin: j
        } = e, N = (0, u.bG)([B.default], () => B.default.getCurrentUser()), C = (0, eb.f)(s), {
            previewingVariantIndex: b
        } = C, R = (0, F.Q)(s), I = (0, eA.q)(s, b), T = (0, Z.rb)(s, R);
        c()(null != T, "Selected product should not be null");
        let {
            analyticsLocations: E
        } = (0, g.Ay)([...h, v.A.COLLECTIBLES_SHOP_DETAILS_MODAL]);
        (0, en.Yr)(T.skuId);
        let P = (0, eN.U1)(l);
        i.useEffect(() => {
        ...
        return null == N ? null : (0, n.jsx)(g.f5, {
            value: E,
            children: (0, n.jsxs)(f.EOs, {
                ...
                children: [(0, n.jsxs)(f.$mQ, {
                    ...
                    children: [(0, n.jsx)(eU, {
                        ...
                        className: a()(eS.i1, T.skuId === d.j.PREMIUM_TIER_2_3_DAY ? eS.bF : T.type === o.R.AVATAR_DECORATION ? eS.Jq : eS.eF),
                        style: {
                            backgroundImage: `url(${P})`
                        },
                        children: [(0, eT.pQ)(s.skuId) ? s.skuId === eT.Dp.ORB_PROFILE_BADGE ? O || S ? null : (0, n.jsx)(em.z, {
                            user: N
                        }) : s.skuId === d.j.PREMIUM_TIER_2_3_DAY ? (0, n.jsx)(eu.I, {}) : (0, n.jsx)(ex.B, {
                            product: s,
                            className: eS.Ms
                        }) : (0, n.jsx)(eG, {
                            user: N,
