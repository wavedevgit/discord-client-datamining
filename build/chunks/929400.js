...
let eB = e => {
    ...
    eM = e => {
        ...
        return (0, W.aw)(t) ? (0, n.jsx)(eU, {
            product: t,
            user: r,
            activeSlide: i
        }) : (0, ey.pQ)(t.skuId) ? (0, n.jsx)(eg.B, {
    ...
    eD = e => {
        ...
        return t === u.j.PREMIUM_TIER_2_3_DAY ? (0, n.jsx)(f.Text, {
            variant: "text-sm/normal",
            className: eL.CU,
    ...
    eG = e => {
        let {
            ...
            sessionId: E,
            tilePosition: P
        } = (0, V.uM)() ?? {}, y = D.Ay.canUseCollectibles(r), {
            previewingVariantIndex: S,
            handleEntering: k,
            handleLeaving: B
        } = _, U = (0, eC.q)(t, S), M = (0, Q.rb)(t, A);
        ...
        let z = (0, K.h)(t),
            ...
            es = (0, m.bG)([F.A], () => F.A.isClaiming === M?.skuId),
            ea = (0, x.Ay)(),
            eh = (0, h.Mw)(ea),
            ef = (0, W.G0)(M),
            eg = (0, W.yt)(M, eO.lid.DEFAULT),
            ej = eg?.amount === 0,
            {
                firstAvatarDecoration: eN
            } = (0, Z.f5)(U ?? M),
            eR = i.useMemo(() => (0, W.fT)(M, y), [M, y]),
            eT = (0, et.VG)(t),
            eB = (0, eb.X)(M),
            {
                enabled: eU
            ...
            ez = (0, $.W)("CollectiblesShopProductDetailsModal"),
            ...
            eK = i.useCallback(() => (0, b.A)({
                skuId: M.skuId,
                analyticsLocations: I,
                onClose: e => e ? u() : (0, ek.tE)()
            }), [I, u, M.skuId]);
        return i.useEffect(() => {
            ...
            children: [(0, n.jsx)("div", {
                ...
                children: [(0, n.jsxs)("div", {
                    ...
                    children: [(0, n.jsx)(el.A, {
                        ...
                        skuId: M.skuId
                    }), z.isPurchased || z.isPartiallyOwnedBundle ? (0, n.jsx)(en.c, {
                        className: eL.On,
                        ...
                        children: [(0, n.jsx)(ed.A, {
                            ...
                            nitroIconSize: "xs",
                            discountOfferAmount: eH
                        }), y || eV ? null : (0, n.jsx)(eu.A, {
                            product: M
                        })]
                    })]
                }), (0, Q.B1)(t) && (0, n.jsx)(f.M1G, {
                    children: (0, n.jsxs)("div", {
                        className: a()(eL.Oj, {
                            [eL.OJ]: eF
                        }),
                    ...
                    children: (() => {
                        ...
                        return ei ? Y ? eB ? (0, n.jsxs)(f.ButtonGroup, {
                            wrap: !1,
                            fullWidth: !0,
                            ...
                            children: e$.map((e, t) => {
                                ...
                                if (e.currency === ek.Yr.DISCORD_ORB) {
                                    let t, r, s, a;
                                    return t = ee ? ew.intl.string(ew.t.cTdr3x) : ew.intl.string(ew.t.zqh7ZM), r = !eJ || ee, s = ew.intl.formatToPlainString(ew.t.yi41qQ, {
                                        orbPrice: e.amount
                                ...
                                return r = (0, W.aw)(M) ? ew.intl.string(ew.t.V1AWw0) : M.type === d.R.PROFILE_EFFECT ? ew.intl.string(ew.t.kAeDcK) : M.type === d.R.NAMEPLATE ? ew.intl.string(ew.t.H3vhqU) : ew.intl.string(ew.t.AQ0Veg), eV ? r = ew.intl.formatToPlainString(ew.t["5U5RB5"], {
                                    discountOfferAmount: eH
                                }) : eU && (r = ew.intl.formatToPlainString(ew.t["cNSL/j"], {
    ...
    eF = e => {
        let {
            ...
            activeBundleSlide: i,
            isTransitioning: s
        } = e, l = (0, m.bG)([v.A], () => v.A.useReducedMotion), c = D.Ay.canUsePremiumProfileCustomization(r), {
            pendingAvatar: o,
            ...u
        } = (0, m.cf)([S.A], () => S.A.getPendingChanges()), p = (0, y.V7)({
            userId: r.id,
            image: o
        }), h = t.type === d.R.AVATAR_DECORATION, [f] = t.items, {
            firstAvatarDecoration: x,
            firstProfileEffect: _,
            firstNameplate: g
        } = (0, Z.f5)(t), A = null != _, j = () => (0, n.jsxs)(n.Fragment, {
        ...
        if (t.type === d.R.BUNDLE) {
            ...
            });
            {
                ...
                return r.type === d.R.NAMEPLATE ? (0, n.jsx)("div", {
                    className: a()(eL.Zj, s && o ? eL.p2 : ""),
                    children: N(r)
                }) : (0, n.jsx)("div", {
                    className: a()(eL.Ak, s && o ? eL.p2 : ""),
                    children: j()
                })
            }
        }
        return null != g ? (0, n.jsx)("div", {
            ...
            className: f?.type === d.R.AVATAR_DECORATION ? eL.RA : eL.Ak,
            children: j()
        })
    },
    ez = e => {
    ...
    eW = e => {
        let {
            ...
            giftRecipient: N,
            giftingOrigin: C
        } = e, I = (0, m.bG)([B.default], () => B.default.getCurrentUser()), R = (0, eT.f)(s), {
            previewingVariantIndex: b
        } = R, T = (0, z.Q)(s), E = (0, eC.q)(s, b), P = (0, Q.rb)(s, T);
        c()(null != P, "Selected product should not be null");
        let {
            analyticsLocations: y
        } = (0, g.Ay)([...x, _.A.COLLECTIBLES_SHOP_DETAILS_MODAL]);
        (0, ea.Yr)(P.skuId);
        let O = (0, eR.U1)(l);
        i.useEffect(() => {
            null != I && (0, k.A)(I.id, I.getAvatarURL(void 0, 80))
        }, [I]);
        let S = i.useMemo(() => (0, W.V6)(s.type, s.skuId), [s.type, s.skuId]);
        i.useEffect(() => {
            U.default.track(eO.HAw.OPEN_MODAL, {
        ...
        let G = (0, L.o6)(),
            ...
            K = i.useMemo(() => (0, W.aw)(P) ? P.items.length : 0, [P]),
            {
                activeSlide: Z,
                isTransitioning: Y
            } = (0, er.X)({
        ...
        return null == I ? null : (0, n.jsx)(g.f5, {
            value: y,
            children: (0, n.jsxs)(f.EOs, {
                ...
                children: [(0, n.jsxs)(f.$mQ, {
                    ...
                    children: [(0, n.jsx)(eG, {
                        ...
                        className: a()(eL.i1, P.skuId === u.j.PREMIUM_TIER_2_3_DAY ? eL.bF : P.type === d.R.AVATAR_DECORATION ? eL.Jq : eL.eF),
                        style: {
                            backgroundImage: `url(${O})`
                        },
                        children: [(0, ey.pQ)(s.skuId) ? s.skuId === ey.Dp.ORB_PROFILE_BADGE ? G || F ? null : (0, n.jsx)(ef.z, {
                            user: I
                        }) : s.skuId === u.j.PREMIUM_TIER_2_3_DAY ? (0, n.jsx)(eh.I, {}) : (0, n.jsx)(eg.B, {
                            product: s,
                            className: eL.Ms
                        }) : (0, n.jsx)(eF, {
                            user: I,
