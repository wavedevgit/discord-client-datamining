...
class q extends l.Component {
    ...
    handleViewLibrary = e => {
        ...
        e.preventDefault(), null != t && t.isHidden() ? (0, E.pX)(G.BVt.APPLICATION_LIBRARY_SETTINGS) : (0, E.pX)(G.BVt.APPLICATION_LIBRARY, {
            state: {
        ...
        e.preventDefault(), e.stopPropagation(), D.default.track(G.HAw.OPEN_MODAL, {
            type: "gift_accept",
            location: {
    ...
    renderButton(e) {
        ...
        }, a = !e.isSubscription && null != t || !e.isSelfRedeemable && l || e.isExistingPremiumSubscriptionDisallowed && (0, w.TW)(n);
        return (e.redeemed || a || e.isClaimed || !n.verified) && (r.color = c.$n.Colors.BRAND, r.disabled = !0), (0, i.jsx)(c.$n, {
            ...r,
...
let Y = (0, h.A)((0, m.A)(q)),
    z = function(e) {
        ...
        })), a = (0, d.bG)([L.default], () => null != l && null != l.userId ? L.default.getUser(l.userId) : null), s = (0, d.bG)([R.A], () => null != l ? R.A.get(l.skuId) : null), o = (0, d.bG)([j.A], () => null != s && l?.entitlementBranches != null ? M.YI(l.entitlementBranches, s, j.A) : null), c = (0, g.h)(s?.applicationId), u = (0, O.zz)(l?.subscriptionPlanId), _ = (0, d.bG)([y.default], () => null != l ? y.default.getId() === l.userId : y.default.getId() === n.id);
        return (0, i.jsx)(Y, {
            ...e,
            skuApplication: c,
            giftCode: l,
