/** chunk id: 768161, original params: t,e,l (module,exports,require) **/
l.d(e, {
    default: () => N
});
var n = l(627968),
    ...
    return (0, n.jsxs)("div", {
        ...
        children: [(0, n.jsx)("span", {
            ...
            children: (0, n.jsx)(c.ksK, {
                ...
                trailing: {
                    type: "emoji",
                    button: null == r ? null : (0, n.jsxs)("div", {
                        className: f.Vl,
                        children: [(0, n.jsx)("img", {
                            alt: "",
                            src: (0, C.t)(r),
                            className: f.vn
                        }), l ? (0, n.jsx)(i.CircleErrorIcon, {
                            size: "sm",
                            color: "var(--status-danger)"
            ...
            let t = null != u ? (0, n.jsx)("div", {
                className: f.Vl,
                children: (0, n.jsx)(i.CircleErrorIcon, {
                    size: "sm",
                    color: "var(--status-danger)"
                })
            }) : o && s.trim().length > 0 ? (0, n.jsx)("div", {
                className: f.Vl,
...
function N(t) {
    let {
        ...
        onClose: l,
        initialCode: a = ""
    } = t, [i, j] = r.useState("ENTER_CODE"), [N, S] = r.useState(a), [I, _] = r.useState(!1), [T, k] = r.useState(null), [O, w] = r.useState(null), [M, U] = r.useState(""), [R, A] = r.useState(null), [z, B] = r.useState(!1), [D, F] = r.useState(null), [L, P] = r.useState(null), [V, Y] = r.useState(null), [G, W] = r.useState(null), X = O?.country ?? null, K = null != X && s.M.EU_COUNTRIES.has(X), {
        savedPostalCode: Z,
        savedCountry: $,
                ...
                if (K || null == X || await tr(M, X)) {
                    ...
                    try {
                        ...
                        try {
                            ...
                            (0, c.showToast)((0, c.createToast)(e, c.ToastType.SUCCESS)), l(), (0, d.$o)().then(t => {
