...
function I(t) {
    let {
        ...
        source: b,
        loadId: I
    } = t, [v, x] = a.useState(r), [k, T] = a.useState(!1), [S, D] = a.useState(""), [j, R] = a.useState(null), [M, N] = a.useState(null), {
        isEU: U,
        displayCountry: w,
        savedPostalCode: O
    } = (0, f.A)(), P = (0, s.bG)([h.A], () => h.A.hasFetchedPaymentSources);
    a.useEffect(() => {
        P || (0, d.$o)()
    }, [P]), a.useEffect(() => {
        g.default.track(m.HAw.GIFT_CARD_REDEMPTION_START, {
            source: b,
            load_id: I
        })
    }, [b, I]);
    ...
    let G = E.intl.string(E.t.ToslbL),
        ...
        H = a.useCallback(async () => {
            ...
            try {
                ...
                let t = e?.body;
                N(t?.errors?.postal_code != null || t?.postal_code != null ? E.intl.string(E.t.e2zhgU) : E.intl.string(E.t.OBnXjv)), g.default.track(m.HAw.GIFT_CARD_REDEMPTION_FAILED, {
                    source: b,
                    load_id: I
                });
                return
