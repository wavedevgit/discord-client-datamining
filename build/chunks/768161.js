...
function E(t) {
    let {
        ...
        onComplete: i,
        initialCode: S = ""
    } = t, [E, v] = a.useState(S), [j, k] = a.useState(!1), [A, U] = a.useState(""), [I, T] = a.useState(null), [_, w] = a.useState(null), [N, M] = a.useState(null), [P, L] = a.useState(!1), {
        savedPostalCode: z,
        savedCountry: D,
    ...
    a.useEffect(() => {
        ...
        null != t ? L(s.M.EU_COUNTRIES.has(t)) : null != D ? L(s.M.EU_COUNTRIES.has(D)) : null != O ? L(s.M.EU_COUNTRIES.has(O)) : L(!1)
    }, [O, D, N]);
    let W = m.intl.string(m.t.ToslbL),
        ...
        Y = a.useCallback(async () => {
            ...
            try {
                ...
                (0, u.showToast)((0, u.createToast)(n, u.ToastType.SUCCESS)), i?.(), l(), (0, c.$o)().then(t => {
                    let e = (t?.body ?? []).find(t => t.type === f.he.TDS_WALLET);
                    null != e && (0, c.YP)(e.id)
                })
            } catch (e) {
                let t = e?.body;
                w(t?.errors?.postal_code != null || t?.postal_code != null ? m.intl.string(m.t.e2zhgU) : m.intl.string(m.t.OBnXjv));
                return
            } finally {
                k(!1)
            }
