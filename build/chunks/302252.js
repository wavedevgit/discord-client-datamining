/** chunk id: 302252 params = (module,exports,require) **/
i.d(t, {
    default: () => v
});
var n = i(627968);
...
function v(e) {
    let {
        ...
        transitionState: v,
        analyticsData: f
    } = e, O = p.intl.string(p.t.Ss6tlb), y = p.intl.string(p.t.tLi4cR), A = {
        ...
        freeformConfig: {
            value: b.bO.FREEFORM,
            label: p.intl.string(p.t.emlT91)
        }
    }, F = {
        value: b.Eq.AUDIO,
    ...
    return (0, n.jsx)(_.A, {
        onMount: () => {
            c.default.track(m.HAw.OPEN_MODAL, {
                type: "voice",
        ...
        onSubmit: function(e) {
            ...
            if (t && (0, r.n3)({
                    feedbackType: b.MW.VOICE,
                    location: "VoiceCallFeedbackModal"
                }), null != o) {
                if ((0, d.A)(m.HAw.CALL_REPORT_PROBLEM, {
                        rating: o,
                        category: c,
                    ...
                    if (g.value === b.X.NO_AUDIO && g.variant === b.UV.SELF && function(e) {
                            let {
                                duration: t,
                                duration_muted_ms: i
                            } = e;
                    ...
                    (0, s.r)(o, c, g) ? (0, a.mMO)(async () => {
                        let {
                            default: e
                        } = await i.e("69791").then(i.bind(i, 72514));
                        return t => (0, n.jsx)(e, {
                            ...t,
