...
let j = [I.Dmq.PAST_DUE, I.Dmq.ACCOUNT_HOLD, I.Dmq.BILLING_RETRY],
    v = e => {
        let {
            ...
            analyticsLocation: r
        } = e, [o, c] = s.useState(!1), [u, A] = s.useState(!1), g = async () => {
            c(!0), A(!1);
            try {
...
function O(e) {
    let t, {
        ...
        } = (0, g.Ay)(A.A.GUILD_BOOSTING_SUBSCRIPTION_HEADER),
        y = (0, T.A)({
    ...
    let {
        status: P
    } = n, L = (0, C.$k)(n), D = y && !L && n.isBoostOnly && j.includes(n.status);
    if (L) t = b.v2;
    else switch (P) {
        case I.Dmq.PAST_DUE:
    ...
    return (0, i.jsxs)(i.Fragment, {
        children: [(0, i.jsxs)("div", {
            ...
            children: [(0, i.jsx)("div", {
                ...
                children: [D && (0, i.jsx)("div", {
                    ...
                    children: (0, i.jsx)(d.QWc, {
                        ...
                        onClick: () => {
                            j.includes(n.status) && (0, _.mMO)(async () => e => (0, i.jsx)(v, {
                                ...e,
                                subscription: n,
                                analyticsLocations: R,
                                analyticsLocation: m
            ...
            children: N.intl.format(c.Fr ? N.t.uxYBEa : N.t.k6haR9, {
