...
function u(e) {
    let {
        isGuildIncluded: t,
        selectedGuildId: i
    } = e, l = (0, s.bG)([d.Ay], () => d.Ay.getFlattenedGuildIds()), u = (0, s.bG)([r.A], () => r.A.getGuilds()), c = (0, s.bG)([o.default], () => o.default.getCurrentUser());
    return {
        options: n.useMemo(() => null == c ? [] : (null == t ? l : l.filter(e => {
            ...
            let t = u[e];
            return a()(null != t, "guild should not be null"), {
                id: e,
                label: t.name,
                value: t.id
            }
