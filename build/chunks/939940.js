/** chunk id: 939940, original params: t,e,i (module,exports,require) **/
i.d(e, {
    default: () => j
});
var n = i(627968),
...
let j = t => {
    let {
        ...
        onClose: i,
        transitionState: j
    } = t, [x, h] = l.useState(e.defaultReactionEmoji ?? null), [N, b] = l.useState(!1), [p, g] = l.useState(!1), v = l.useRef(null), f = (e.defaultReactionEmoji?.emojiId ?? null) !== (x?.emojiId ?? null), E = (e.defaultReactionEmoji?.emojiName ?? null) !== (x?.emojiName ?? null), _ = f || E, k = t => {
        h(null == t ? null : t?.id != null ? {
            emojiId: t.id
        } : {
