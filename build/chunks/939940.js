...
let j = t => {
    let {
        ...
        onClose: i,
        transitionState: j
    } = t, [x, h] = l.useState(e.defaultReactionEmoji ?? null), [N, p] = l.useState(!1), [b, g] = l.useState(!1), v = l.useRef(null), f = (e.defaultReactionEmoji?.emojiId ?? null) !== (x?.emojiId ?? null), E = (e.defaultReactionEmoji?.emojiName ?? null) !== (x?.emojiName ?? null), k = f || E, _ = t => {
