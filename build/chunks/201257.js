...
function I(e) {
    ...
    } = e, j = (0, f.Yh)(i), I = (0, p.LS)(i), Q = (0, S.go)(), {
        progressSec: R,
        trackProgress: q
    } = (0, M.y)({
...
function Q(e) {
    let {
        ...
        ...o
    } = e, r = (0, c.bG)([h.A], () => h.A.getQuest(t)), u = (0, c.bG)([h.A], () => h.A.getQuestConfig(t)), d = s ?? r, m = null != s ? s.config : u, x = l.useMemo(() => null != m ? {
        questConfig: m
    } : null, [m]);
    return null != d && null != m && null != x ? (0, n.jsx)(E.l.Provider, {
        value: x,
