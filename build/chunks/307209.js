...
function C(e) {
    let {
        guildId: t,
        completed: n
    } = e, l = (0, s.bG)([o.A], () => o.A.getEnabled(t)), {
        location: d
    } = (0, r.p)();
...
function b(e) {
    ...
    } = e, r = (0, f.n5)(t), a = (0, s.bG)([o.A], () => o.A.getEnabled(t));
    return (0, i.jsx)("div", {
        className: E.NQ,
...
function v(e) {
    let {
        ...
        handleOnboardingToggle: n,
        handlePreview: r
    } = e, a = (0, f.n5)(t), o = (0, s.bG)([h.A], () => h.A.getSettings()), c = (0, d.Ic)(o);
    return (0, i.jsxs)("div", {
        className: E.cN,
        children: [(0, i.jsxs)("div", {
            className: E.Zj,
...
function S(e) {
    ...
    return null == n || n.verificationLevel < j.PvD.VERY_HIGH ? null : (0, i.jsxs)("div", {
        className: E.et,
