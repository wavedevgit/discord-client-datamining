/** chunk id: 936388 params = (module,exports,require) **/
n.d(t, {
    A: () => A
});
var r = n(73153),
...
let A = {
    ...
    updatePersistentCodesEnabled: async function e(e) {
        let t, n, r = (t = E.A.getVoiceStateForUser(l.default.getId()), n = c.A.getChannel(t?.channelId), l.default.getSessionId() === t?.sessionId && null != n && n.type !== d.rbe.GUILD_STAGE_VOICE ? n.id : null);
        null != r ? u.A.openSecureFramesUpdateConfirmation({
