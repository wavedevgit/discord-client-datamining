...
let h = {
    ...
    updatePersistentCodesEnabled: async function e(e) {
        let t, n, r = (t = c.A.getVoiceStateForUser(o.default.getId()), n = s.A.getChannel(t?.channelId), o.default.getSessionId() === t?.sessionId && null != n && n.type !== E.rbe.GUILD_STAGE_VOICE ? n.id : null);
