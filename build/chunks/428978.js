/** chunk id: 428978 params = (module,exports,require) **/
n.d(e, {
    Zq: () => o,
    jD: () => h
}), n(321073);
...
function o(t) {
    let {
        ...
        isJoined: j = !1,
        channel: y
    } = t, E = void 0 !== g, _ = function(t) {
        let {
            onInviteClick: e,
            canInvite: n,
            isChannelPublic: l,
            channel: c
        } = t, o = new r.Ep, [h, m] = i.useState(!1);
        return ((0, a.Ay)(() => () => {
            o.stop()
        }), null == e) ? null : (0, u.y)(n ?? !1, l ?? !1, c) ? {
            variant: "secondary",
            icon: s.liv,
            onClick: e,
    ...
    if (null != _ && C.push(_), e && m !== c.Ps.EXTERNAL && C.push({
            variant: "active",
            size: "sm",
            onClick: g,
            text: function(t) {
                ...
                return n ? e ? d.intl.string(d.t.aW2YlJ) : l ? d.intl.string(d.t.nxUtoQ) : d.intl.string(d.t.ZYO5OK) : d.intl.string(d.t.TVBCKZ)
            }({
                isJoined: j,
                canJoin: E,
                isVoiceChannel: m === c.Ps.VOICE
            }),
            disabled: !E
        }), n && null != A && C.push({
            variant: "active",
