...
let a = function(e) {
        ...
        if (t) return s.intl.formatToPlainString(s.t["/0Yndu"], {
        ...
        for (let e of r) switch (e.type) {
            case i.R.AVATAR_DECORATION:
                n.push(s.intl.formatToPlainString(s.t.Ntv9Jt, {
                    itemName: e.name
                }));
                break;
            case i.R.PROFILE_EFFECT:
                n.push(s.intl.formatToPlainString(s.t["3Y8q7a"], {
                    itemName: e.name
                }));
                break;
            case i.R.NAMEPLATE:
                n.push(s.intl.formatToPlainString(s.t["2keXky"], {
                    itemName: e.name
                })), a = !0
        }
        if (a) {
            let e = n.join(", ").replace(/, ([^,]*)$/, " & $1");
            return s.intl.formatToPlainString(s.t.Ofrqj6, {
                joinedItems: e
            })
        }
        let l = n.join(" & ");
