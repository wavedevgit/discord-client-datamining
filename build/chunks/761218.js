/** chunk id: 761218 params = (module,exports,require) **/
"use strict";
s.d(t, {
    A: () => L
});
...
let I = {
    ...
    L = e => {
        let t, {
            ...
            k = (r.useEffect(() => {
            ...
            }, [l]), t = (0, o.bG)([x.A], () => !l.some(e => x.A.isFetching(e)) && l.some(e => x.A.didFetchingSkuFail(e)), [l]), r.useEffect(() => {
                t && (0, _.Rw)(A.Kf)
            }, [t]), (0, o.yK)([x.A, m.A], () => {
                ...
                let s = new Set(l);
                return [...e, ...null != t.storefront ? (0, u.jd)(t.storefront).filter(e => !s.has(e) && null != x.A.get(e)) : []].slice(0, l.length)
            }, [l])),
            T = (0, b.uM)(),
            {
            ...
            B = r.useMemo(() => {
                ...
                return S.intl.formatToPlainString(S.t.BXpdIg, {
                    days: t
                })
            }, [L]),
            M = r.useCallback((e, t) => {
            ...
            F = r.useCallback(e => {
                ...
                }, 1e3)) : null !== R.current && (clearTimeout(R.current), R.current = null))
            }, [T?.sessionId, T?.pageCategory, T?.pageSection, j]);
        return (r.useEffect(() => () => {
            null !== R.current && (clearTimeout(R.current), R.current = null)
        }, []), 0 === k.length) ? null : (0, n.jsx)(c.L, {
            innerRef: N,
            onChange: F,
            threshold: 0,
                    ...
                    children: [(0, n.jsx)("div", {
                        ...
                        children: [null != B && (0, n.jsx)("div", {
                            ...
                            children: (0, n.jsx)(i.Exy, {
                                type: {
                                    text: `${S.intl.string(S.t.yYEZGi)} (${B})`
                                },
                                variant: "brand"
                            })
                        }), (0, n.jsxs)("div", {
