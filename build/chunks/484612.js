...
function V(e) {
    ...
    let [$, X] = (0, c.kn)(z), Y = (0, E.MO)(t, V), H = Y.flatMap(e => e.listings).filter(e => "multiPerk" === e.type).map(e => e.group), Q = (0, k.g)(H, t);
    return (i.useEffect(() => {
        if (null != l && !B.current)
            for (let e of Y)
    ...
    }, [t, $, X, J]), M?.powerupCatalog == null) ? null : (0, r.jsxs)("div", {
        className: U.kL,
        children: [(0, r.jsxs)(p.A, {
            ...
            children: [(0, r.jsx)(p.A.Icon, {
                ...
                children: D.intl.string(G.default.yv3DJJ)
            })]
        }), (0, r.jsxs)("div", {
            className: U.hQ,
                ...
                children: Y.map(e => {
                    let {
                        ...
                        switch (e) {
                            case T.o9.LEVEL:
                                return {
                                    title: D.intl.string(G.default["TXY/b0"]), description: D.intl.string(G.default.aJv4PB)
                                };
                            case T.o9.PERK:
                                return {
                                    title: D.intl.string(G.default.TV3Vm8), description: D.intl.string(G.default.STx9hp)
                                }
                        }
