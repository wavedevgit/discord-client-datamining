...
function M(e) {
    ...
    let W = (0, o.bG)([g.A], () => g.A.getStateForGuild(t)),
        ...
        J = i.useRef(!1),
        {
            shouldShow: K,
            modalConfig: Y
        } = (0, R.A)(t, "GuildPowerupsOverview"),
        z = null == l && null != Y,
        $ = [];
    K && z && $.push(a.M.VANITY_URL_POWERUP_ROLLBACK_MODAL);
    let [X, q] = (0, c.kn)($), H = (0, b.MO)(t, M), Q = H.flatMap(e => e.listings).filter(e => "multiPerk" === e.type).map(e => e.group), Z = (0, y.g)(Q, t);
    return (i.useEffect(() => {
        if (null != l && !J.current)
            for (let e of H)
    ...
    }, [t, X, q, Y]), W?.powerupCatalog == null) ? null : (0, r.jsxs)("div", {
        className: V.kL,
