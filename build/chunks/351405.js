...
function y(e) {
    let {
        ...
        hideParty: b,
        onView: y
    } = e, N = (0, a.b)(n), S = (0, s.bG)([c.default], () => c.default.getId()), j = (0, s.bG)([_.A], () => {
        if (null == g.application) return _.A.findActivity(g.author.id, e => e.type === I.$pd.LISTENING);
        {
            let e = g.author.id;
            return (0, A.v)(g) && (e = e === S && r.isPrivate() ? r.getRecipientId() : S), _.A.getApplicationActivity(e, g.application.id)
        }
    }, [g, r, S]), L = (0, s.bG)([m.A, h.A], () => m.A.getApplicationActivity(N.id) ?? h.A.getApplicationActivity(N.id, !0), [N.id]), R = (0, s.yK)([u.A], () => null == j || null == j.party ? [] : Array.from(u.A.getParty(j.party.id) ?? []), [j]), {
        partySize: P,
        maxPartySize: D
