    ...
    em = u.Ay.connectStores([H.A], () => {
        ...
        return {
            ...
            onSave() {
                ...
                e.isThread() && 0 === (t = (0, k.A)(t, !0)).length ? x.h.dispatch({
                    type: "CHANNEL_SETTINGS_SUBMIT_FAILURE",
                    errors: {
                        name: es.intl.string(es.t.uXA573)
                    }
                }) : (0, p.RT)(e.id, {
                    name: t,
                    type: n,
...
function ex(e) {
    let {
        ...
        channel: n,
        guildId: s
    } = e, a = i.useRef(null), r = i.useCallback(e => {
        let {
            closePopout: i
        } = e;
        return (0, l.jsx)(E.A, {
...
class ep extends i.PureComponent {
    ...
    getChannelTopicTextAreaChannel(e) {
        let t = e ?? void 0;
        return (null == this.channelTopicTextAreaChannel || this.channelTopicTextAreaGuildId !== t) && (this.channelTopicTextAreaGuildId = t, this.channelTopicTextAreaChannel = (0, P.createChannelRecord)({
            id: "1",
            type: et.rbe.DM,
            guild_id: t
    ...
    componentDidMount() {
        null == this.props.regions && null != this.props.guild && A.A.fetchRegions(this.props.guild.id)
    }
    ...
    getSlowmodeHelpText() {
        ...
        return e?.isForumLikeChannel() ? es.intl.string(es.t["a+1pdO"]) : e?.isThread() ? es.intl.string(es.t.OMmNCv) : es.intl.string(es.t["HEA/DU"])
    }
    ...
    renderChannelInfo(e, t) {
        let n, i, {
            ...
            I = e.isForumLikeChannel() ? (0, l.jsxs)(l.Fragment, {
                children: [(0, l.jsx)(m.cGx, {}), (0, l.jsx)(m.D0$, {
                    ...
                    children: (0, l.jsxs)("div", {
                        ...
                        children: [(0, l.jsx)("div", {
                            ...
                            children: (0, l.jsxs)(m.ButtonGroup, {
                                ...
                                }), null != e.defaultReactionEmoji ? (0, l.jsx)(m.QWc, {
            ...
            R = e.isForumChannel() ? (0, l.jsxs)(l.Fragment, {
                children: [(0, l.jsx)(m.cGx, {}), (0, l.jsxs)("div", {
                    className: ea.OZ,
                    children: [(0, l.jsx)("div", {
            ...
            H = P.nb.has(e.type) ? j ? (0, l.jsxs)(l.Fragment, {
                children: [(0, l.jsx)(m.cGx, {}), (0, l.jsxs)(m.nVY, {
                    label: es.intl.string(es.t.O1c02q),
                    children: [V, (0, l.jsx)(m.Apm, {
            ...
            F = C && null != e.threadMetadata ? (0, l.jsx)(f.A, {
                page: et.liQ.CHANNEL_SETTINGS,
            ...
            Y = e.type === et.rbe.PRIVATE_THREAD && null != e.threadMetadata ? (0, l.jsx)("div", {
        ...
        let X = [{
                value: "none",
                name: es.intl.string(es.t.OtnNJE),
                desc: es.intl.string(es.t["a5/7hX"])
            }, {
                value: "spoiler",
                name: es.intl.string(es.t.TvUHTb),
                desc: es.intl.string(es.t.ddWXHa)
            }, {
                value: "nsfw",
                name: es.intl.string(es.t.Es25Yf),
                desc: es.intl.string(es.t["9eUgwR"])
            }],
            q = A && P.LE.has(e.type) ? (0, l.jsxs)(m.BJc, {
                gap: 4,
                padding: {
                    top: 8,
                    bottom: 8
                },
                children: [(0, l.jsx)(m.z6M, {
                    label: es.intl.string(es.t.yLB4y2),
                    onChange: e => this.handleChannelRestrictionChange(e),
                    options: X,
                    value: Z,
                    disabled: !s || null != e.linkedLobby || z
                }), null != e.linkedLobby ? (0, l.jsx)(m.po8, {
                    messageType: m.YCn.WARNING,
                    children: es.intl.string(es.t.EvavKG)
                }) : null]
            }) : P.LE.has(e.type) ? (0, l.jsxs)(m.BJc, {
                gap: 4,
                children: [(0, l.jsx)(m.dOG, {
            ...
            el = P.xR.has(e.type) && null != g && g.features.has(et.GuildFeatures.NEWS) && e.id !== g?.rulesChannelId && e.id !== g?.publicUpdatesChannelId ? (0, l.jsxs)(m.BJc, {
                gap: 4,
                children: [(0, l.jsx)(m.dOG, {
                    ...
                    children: es.intl.string(es.t["2Ab4Id"])
                })]
            }) : null,
            er = P.wE.has(e.type) ? (0, l.jsx)(f.A, {
                page: et.liQ.CHANNEL_SETTINGS,
                children: (0, l.jsx)(D.A, {
                    isDisabled: !s,
                    autoArchiveDuration: (0, O.Gl)(e, null),
                    onChange: this.handleChangeDefaultAutoArchiveDuration,
                    helperText: e.isForumLikeChannel() ? es.intl.string(es.t.fyXclY) : es.intl.string(es.t.W3Noi9)
                })
            }) : null,
            eu = this.props.showChannelSummariesSettings ? (0, l.jsx)(m.dOG, {
                ...
                checked: !e.hasFlag(en.lx.SUMMARIES_DISABLED) && g?.features.has(et.GuildFeatures.SUMMARIES_ENABLED_BY_USER),
                disabled: !s || !g?.features.has(et.GuildFeatures.SUMMARIES_ENABLED_BY_USER)
            }) : null,
            eh = e.isMediaChannel() ? (0, l.jsx)(m.dOG, {
        ...
        e.type === et.rbe.GUILD_CATEGORY ? (i = es.intl.string(es.t.OCAkGP), n = "category-name") : e.isForumPost() ? (i = es.intl.string(es.t.uyVrTN), n = "post-title") : C ? (i = es.intl.string(es.t.j3XWjD), n = "thread-name") : (i = es.intl.string(es.t.PVbHDl), n = "channel-name");
        let eg = p ? c : s;
        return (0, l.jsxs)(m.BJc, {
            gap: 24,
            children: [(0, l.jsx)(m.ksK, {
                label: i,
                fullWidth: !0,
    ...
    renderVoiceBitrate(e, t) {
        ...
        return (0, l.jsx)(m.Apm, {
            ...
            helperText: i > et.gp3 ? es.intl.format(es.t.SbQJk5, {
                bitrate: et.gp3 / 1e3
            }) : void 0,
    ...
    showVoiceSettings() {
        ...
        return null != e && null != e.guild_id && P.k.has(e.type) && (e.isGuildVocal() || G.io.getCurrentConfig({
            guildId: e.guild_id,
            location: "9b50bd_1"
        }).enabled)
    }
    renderVideoQualityMode(e) {
        ...
        let n = [{
            value: et.K3c.AUTO,
            name: es.intl.string(es.t.jjKYpu)
        }, {
            value: et.K3c.FULL,
            name: es.intl.string(es.t["7jOoJE"])
        }];
    ...
    onRenderUserLimit(e) {
        return 0 === (e = Math.round(e)) ? es.intl.string(es.t.XX5ciX) : es.intl.formatToPlainString(es.t["3uHFUR"], {
            num: e
        })
    }
    renderUserLimit(e) {
    ...
    renderRegionOverride(e) {
        ...
        let s = [];
        null != t && (s = t.filter(e => !e.deprecated && !e.hidden).map(e => ({
            id: e.id,
            label: e.name,
            value: e.id
        }))).unshift({
    ...
    renderJuiceImage(e) {
        ...
        return t = e.type === et.rbe.GUILD_CATEGORY ? (0, g.Mw)(i) ? n(477777) : n(517649) : (0, g.Mw)(i) ? n(241306) : n(16474), (0, l.jsx)(y.A, {
    ...
    render() {
        ...
        return null == e || null == t || null == n ? null : (0, l.jsxs)(m.nVY, {
            label: es.intl.string(es.t["/dp6yY"]),
            children: [this.renderChannelInfo(e, t), this.showVoiceSettings() ? (0, l.jsx)(m.cGx, {
                gap: 24
    ...
    handleChangeTopic = e => {
        (0, p.fy)({
            topic: M.Ay.translateInlineEmojiToSurrogates(e)
        })
    };
    ...
    handleChangeTemplate = e => {
        (0, p.fy)({
            template: M.Ay.translateInlineEmojiToSurrogates(e)
        })
    };
    handleChangeDefaultReactionEmoji = e => {
        let t = null == e ? null : e?.id != null ? {
            emojiId: e.id,
            emojiName: void 0
        } : {
            emojiId: void 0,
    ...
    handleNewsChange = e => {
        (0, p.fy)({
            type: e ? et.rbe.GUILD_ANNOUNCEMENT : et.rbe.GUILD_TEXT
        })
    };
...
function eA() {
    let {
        ...
        submitting: n,
        subsection: s
    } = (0, u.cf)([H.A], () => H.A.getProps()), a = (0, u.bG)([W.A], () => W.A.getRegions(t?.getGuildId() ?? null)), r = (0, u.bG)([B.A], () => B.A.theme), o = (0, u.bG)([F.A], () => F.A.getGuild(t?.getGuildId())), d = (0, G.NI)(t), c = (0, G.H_)(t), {
        canManageChannels: h,
        canSendMessages: g
    } = (0, u.cf)([Y.A], () => ({
        canManageChannels: Y.A.can(et.xBc.MANAGE_CHANNELS, t),
        canSendMessages: Y.A.can(et.xBc.SEND_MESSAGES, t)
    })), m = (0, j.Ay)(t), x = V.default.getId(), p = (0, R.p)(), A = t?.id, f = (0, C.cI)(t, !1, !0), b = q.A.useExperiment({
        guildId: t?.guild_id,
