    ...
    em = u.Ay.connectStores([H.A], () => {
        ...
        return {
            ...
            onSave() {
                ...
                e.isThread() && 0 === (t = (0, D.A)(t, !0)).length ? x.h.dispatch({
                    type: "CHANNEL_SETTINGS_SUBMIT_FAILURE",
                    errors: {
                        name: ei.intl.string(ei.t.uXA573)
                    }
                }) : (0, A.RT)(e.id, {
                    name: t,
                    type: n,
...
class eA extends i.PureComponent {
    ...
    getSlowmodeHelpText() {
        ...
        return e?.isForumLikeChannel() ? ei.intl.string(ei.t["a+1pdO"]) : e?.isThread() ? ei.intl.string(ei.t.OMmNCv) : ei.intl.string(ei.t["HEA/DU"])
    }
    ...
    renderChannelInfo(e, t) {
        let n, i, {
            ...
            M = e.isForumChannel() ? (0, l.jsxs)(l.Fragment, {
                children: [(0, l.jsx)(m.cGx, {}), (0, l.jsxs)("div", {
                    ...
                    children: [(0, l.jsx)("div", {
                        ...
                        children: (0, l.jsx)(m.l6P, {
                            ...
                            options: [{
                                id: "list",
                                label: ei.intl.string(ei.t["4HXEZG"]),
                                value: r.C.LIST
                            }, {
                                id: "grid",
                                label: ei.intl.string(ei.t["8RswJG"]),
                                value: r.C.GRID
                            }],
                            value: e.defaultForumLayout ?? r.C.LIST,
                            onSelectionChange: this.handleChangeDefaultForumLayout
                        })
                    }), e.defaultForumLayout === r.C.GRID ? (0, l.jsx)($.A, {
                        className: es.Kf
                    }) : (0, l.jsx)(K.A, {
                        className: es.Kf
                    })]
            ...
            R = e.isForumLikeChannel() ? (0, l.jsx)(m.l6P, {
                selectionMode: "single",
                label: ei.intl.string(ei.t.gePre2),
                description: ei.intl.string(ei.t["165cVX"]),
                options: [{
                    id: "activity",
                    label: ei.intl.string(ei.t.ElZtzj),
                    value: d.T.LATEST_ACTIVITY
                }, {
                    id: "creation",
                    label: ei.intl.string(ei.t.w28f3F),
            ...
            G = e.isForumLikeChannel() ? (0, l.jsx)(m.l6P, {
                ...
                options: [{
                    id: "some",
                    label: ei.intl.string(ei.t.rQ0ctQ),
                    value: o.n.MATCH_SOME
                }, {
                    id: "all",
                    label: ei.intl.string(ei.t.FCXUu0),
                    value: o.n.MATCH_ALL
                }],
            ...
            H = p && null != e.threadMetadata ? (0, l.jsx)(f.A, {
                page: ee.liQ.CHANNEL_SETTINGS,
            ...
            F = e.type === ee.rbe.PRIVATE_THREAD && null != e.threadMetadata ? (0, l.jsx)("div", {
            ...
            Y = null != g && (0, U.wh)(g),
            W = P.LE.has(e.type) ? (0, l.jsxs)(m.BJc, {
                gap: 4,
                children: [(0, l.jsx)(m.dOG, {
                    ...
                    children: ei.intl.string(ei.t.l6uSVa)
                }) : null]
            }) : null,
            z = P.xR.has(e.type) && null != g && g.features.has(ee.GuildFeatures.NEWS) && e.id !== g?.rulesChannelId && e.id !== g?.publicUpdatesChannelId ? (0, l.jsxs)(m.BJc, {
                gap: 4,
                children: [(0, l.jsx)(m.dOG, {
                    ...
                    children: ei.intl.string(ei.t["2Ab4Id"])
                })]
            }) : null,
            J = P.wE.has(e.type) ? (0, l.jsx)(f.A, {
                page: ee.liQ.CHANNEL_SETTINGS,
                children: (0, l.jsx)(k.A, {
                    isDisabled: !s,
                    autoArchiveDuration: (0, O.Gl)(e, null),
                    onChange: this.handleChangeDefaultAutoArchiveDuration,
                    helperText: e.isForumLikeChannel() ? ei.intl.string(ei.t.fyXclY) : ei.intl.string(ei.t.W3Noi9)
                })
            }) : null,
            X = this.props.showChannelSummariesSettings ? (0, l.jsx)(m.dOG, {
                ...
                checked: !e.hasFlag(et.lx.SUMMARIES_DISABLED) && g?.features.has(ee.GuildFeatures.SUMMARIES_ENABLED_BY_USER),
                disabled: !s || !g?.features.has(ee.GuildFeatures.SUMMARIES_ENABLED_BY_USER)
            }) : null,
            en = e.isMediaChannel() ? (0, l.jsx)(m.dOG, {
        ...
        e.type === ee.rbe.GUILD_CATEGORY ? (i = ei.intl.string(ei.t.OCAkGP), n = "category-name") : e.isForumPost() ? (i = ei.intl.string(ei.t.uyVrTN), n = "post-title") : p ? (i = ei.intl.string(ei.t.j3XWjD), n = "thread-name") : (i = ei.intl.string(ei.t.PVbHDl), n = "channel-name");
        let ea = A ? c : s;
        return (0, l.jsxs)(m.BJc, {
            ...
            }), y, S, E, T, V, H, M, R, G, F, W, z, X, J, en]
        })
    }
    renderBitrate(e) {
    ...
    renderVoiceBitrate(e, t) {
        ...
        return (0, l.jsx)(m.Apm, {
            ...
            helperText: i > ee.gp3 ? ei.intl.format(ei.t.SbQJk5, {
                bitrate: ee.gp3 / 1e3
            }) : void 0,
    ...
    renderVideoQualityMode(e) {
        ...
        let n = [{
            value: ee.K3c.AUTO,
            name: ei.intl.string(ei.t.jjKYpu)
        }, {
            value: ee.K3c.FULL,
            name: ei.intl.string(ei.t["7jOoJE"])
        }];
    ...
    onRenderUserLimit(e) {
        return 0 === (e = Math.round(e)) ? ei.intl.string(ei.t.XX5ciX) : ei.intl.formatToPlainString(ei.t["3uHFUR"], {
            num: e
        })
    }
    renderUserLimit(e) {
    ...
    renderJuiceImage(e) {
        ...
        return t = e.type === ee.rbe.GUILD_CATEGORY ? (0, g.Mw)(i) ? n(477777) : n(517649) : (0, g.Mw)(i) ? n(241306) : n(16474), (0, l.jsx)(y.A, {
    ...
    handleNewsChange = e => {
        (0, A.fy)({
            type: e ? ee.rbe.GUILD_ANNOUNCEMENT : ee.rbe.GUILD_TEXT
        })
    };
...
function ep() {
    ...
    })), m = (0, C.Ay)(t), x = V.default.getId(), A = (0, R.p)(), p = t?.id, f = (0, b.cI)(t, !1, !0), j = i.useCallback(e => {
