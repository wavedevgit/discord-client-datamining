    ...
    ep = g.Ay.connectStores([W.A], () => {
        ...
        return {
            ...
            onSave() {
                ...
                e.isThread() && (t = (0, B.A)(t, !0)), (0, f.RT)(e.id, {
                    name: t,
                    type: n,
                    topic: l,
                    bitrate: i,
...
class eC extends i.PureComponent {
    ...
    getSlowmodeHelpText(e) {
        ...
        return t?.isForumLikeChannel() ? e ? er.intl.string(er.t["a+1pdO"]) : er.intl.format(er.t.EIQq9v, ef) : t?.isThread() ? e ? er.intl.string(er.t.OMmNCv) : er.intl.format(er.t["8sTC8t"], ef) : e ? er.intl.string(er.t["HEA/DU"]) : er.intl.format(er.t.wW2MWu, ef)
    }
    ...
    renderChannelInfo(e, t) {
        let n, i, {
            ...
            _ = V.IY.has(e.type) ? (0, l.jsx)(A.D0$, {
            ...
            I = e.isForumLikeChannel() ? (0, l.jsx)(A.l6P, {
                selectionMode: "single",
            ...
            L = e.isForumLikeChannel() ? (0, l.jsx)(A.l6P, {
                selectionMode: "single",
            ...
            W = f && null != e.threadMetadata ? (0, l.jsx)(b.A, {
                page: el.liQ.CHANNEL_SETTINGS,
            ...
            Y = e.type === el.rbe.PRIVATE_THREAD && null != e.threadMetadata ? (0, l.jsx)("div", {
            ...
            Z = null != g && (0, H.wh)(g),
            z = V.LE.has(e.type) ? (0, l.jsxs)(A.BJc, {
                gap: 4,
                children: [(0, l.jsx)(A.dOG, {
            ...
            Q = V.xR.has(e.type) && null != g && g.features.has(el.GuildFeatures.NEWS) && e.id !== g?.rulesChannelId && e.id !== g?.publicUpdatesChannelId ? (0, l.jsxs)(A.BJc, {
                gap: 4,
                children: [(0, l.jsx)(A.dOG, {
            ...
            q = this.props.showChannelSummariesSettings ? (0, l.jsx)(A.dOG, {
            ...
            K = e.isMediaChannel() ? (0, l.jsx)(A.dOG, {
    ...
    renderJuiceImage(e) {
        ...
        return t = e.type === el.rbe.GUILD_CATEGORY ? (0, x.Mw)(i) ? n(477777) : n(517649) : (0, x.Mw)(i) ? n(241306) : n(16474), (0, l.jsx)(S.A, {
...
function ej() {
    let {
        ...
        submitting: n,
        subsection: s
    } = (0, g.cf)([W.A], () => W.A.getProps()), a = (0, g.bG)([z.A], () => z.A.getRegions(t?.getGuildId() ?? null)), r = (0, g.bG)([U.A], () => U.A.theme), o = (0, g.bG)([Y.A], () => Y.A.getGuild(t?.getGuildId())), d = (0, k.NI)(t), c = (0, k.H_)(t), {
        canManageChannels: u,
        canSendMessages: h
    } = (0, g.cf)([Z.A], () => ({
        canManageChannels: Z.A.can(el.xBc.MANAGE_CHANNELS, t),
        canSendMessages: Z.A.can(el.xBc.SEND_MESSAGES, t)
    })), m = (0, N.Ay)(t), x = F.default.getId(), A = (0, L.p)(), f = t?.id, p = (0, C.cI)(t, !1, !0), b = i.useCallback(e => {
