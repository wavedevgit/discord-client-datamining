...
function ev(e, t, a, s, o) {
    let [l, c] = i.useState(!1), u = i.useCallback((i, d, f, p, m) => {
        ...
        if (l) return;
        c(!0);
        let b = null != (g = null == (y = M.A.getStickerPreview(o, t.drafts.type)) ? void 0 : y.map(e => e.id)) ? g : [],
        ...
        e({
            ...
            d && (eb(o) ? h.A.saveDraft(o, "", t.drafts.type) : f && (null == (r = a.current) || r.clearValue(), null == (i = s.current) || i.hide())), f && (c(!1), (0, w.v8)(), u && (null == (n = a.current) || n.focus()))
        })
    }, [a, s, e, l, t, o]);
    return {
        submitting: l,
...
function eD(e, t, n, r) {
    let i = e.getGuildId(),
        ...
        s = (0, p.bG)([F.Ay, K.default], () => {
            ...
            return null != (e = null != i && null != n ? null == (t = F.Ay.getMember(i, n.id)) ? void 0 : t.isPending : null) && e
        }),
        o = (0, p.cf)([B.A], () => {
            var i, a;
            let o = e.isPrivate(),
...
function ej(e, t) {
    let [n, r] = i.useState({
        ...
        var e, n, i, a;
        let s, o = null == (i = t.current) ? void 0 : i.getSlateEditor();
        null != o && (s = null == (a = ec.VW.getSelectedParentOfType(o, C.mk)) ? void 0 : a[0]), r({
...
let eM = e => {
        let {
            ...
            autoTrackExposure: !1
        }), [r, a] = i.useState(!0), s = i.useRef(null);
        return i.useLayoutEffect(() => {
            t && !n && (clearTimeout(s.current), a(!1), s.current = setTimeout(() => {
                a(!0)
            }, ey))
        }, [n, t, e]), r
    },
...
function eU(e, t) {
    ...
    } = eD(U, G, e5, x), ti = G.toolbarType === $.O1.STATIC, ta = !V.D_.useSetting() && !(0, X.isAndroidWeb)() && null != window.ResizeObserver, ts = !ta || !(null == (n = G.commands) ? void 0 : n.enabled) || !F || "/" !== f, to = (0, L.A)(), {
        fontSize: tl
    } = (0, p.cf)([g.A], () => ({
