...
function ev(e) {
    let {
        ...
        onChangeGuildId: o,
        children: c
    } = e, u = (0, P.X)("UserProfileModalV2EditingPanelWrapper"), A = i && u, [m, p] = t.useState(!0), {
        theme: g,
        primaryColor: x,
        secondaryColor: h
    } = (0, S.A)({
    ...
    return (0, n.jsxs)("div", {
        className: a()(ef.layoutContainer, {
            [ef.hasEditingPanel]: A && m
        }),
        children: [A && (m ? (0, n.jsx)(ea.A, {
...
function eN(e) {
    ...
    } = e, eS = l.id === i.id, eR = l.getAvatarURL(void 0, eI), eL = l.bot, eG = (0, P.X)("UserProfileModalV2"), [eU, eD] = t.useState(s), [eM, eF] = t.useState(s), ek = t.useRef(eM), ew = t.useCallback(e => {
        eD(e ?? void 0)
    }, []);
    t.useEffect(() => {
        let e = !1;
        return (0, D.A)(l.id, eR, {
            type: "modal",
            guildId: eU,
    ...
    let {
    ...
    } = (0, m.Ay)([...eP, A.A.USER_PROFILE_MODAL_V2]), eB = (0, _.pb)({
        layout: "MODAL_V2",
        userId: l.id,
        sourceSessionId: ey,
        guildId: eM,
        ...
        messageId: ea,
        roleId: eN
    }), eW = t.useRef(null), ez = (0, g.M)(eW), [eK, eH] = t.useState(!1), [e$, eZ] = t.useState(), eY = t.useCallback(e => {
    ...
    let eq = (0, F.fC)(),
        eQ = (0, d.zhh)({
            opacity: +(null != eq.interactionType),
            config: {
                duration: 150
            }
        }),
        e0 = t.useMemo(() => null != eM ? {
            [eM]: [l.id]
        } : {}, [eM, l.id]);
    ...
    let e1 = (0, O.Ay)(l.id, eM),
        ...
        e5 = (0, R.Nx)() ? null : e1?.getBannerURL({
            canAnimate: !1,
            size: 1024
        }),
    ...
    return t.useEffect(() => {
        ...
        return E._.subscribe(eg.jej.SHAKE_PROFILE_MODAL, e), () => {
                            ...
                            children: [(0, n.jsx)(d.AC4, {
                                ...
                                children: (0, n.jsx)(ev, {
                                    ...
                                    children: (0, n.jsxs)(q.A, {
                                        ...
                                        children: [null != e5 && (0, n.jsx)("div", {
                                            className: ef.backgroundImage,
                                            style: {
                                                backgroundImage: `url(${e5})`
                                            }
                                        }), null != eq.interactionType && (0, n.jsx)(r.animated.div, {
                                            style: eQ,
                                            ...
                                            children: [(0, n.jsxs)("div", {
                                                ...
                                                children: [(0, n.jsx)(z.A, {
                                                ...
                                                }), e7 === eg.eA$.PENDING_INCOMING && (0, n.jsx)(q.A.Overlay, {
                                                ...
                                                }), l.isProvisional && (0, n.jsx)(q.A.Overlay, {
                                                    className: ef.profileOverlay,
                                                    ...
                                                    user: l,
                                                    className: ef.profileBanner
                                                }), e1?.private && (0, n.jsx)(q.A.Overlay, {
                                                    className: ef.profileOverlay,
                                                ...
                                                }), e1?.bio != null && e1?.bio !== "" && !e8 && (0, n.jsx)(B.A, {
                                                    userBio: e1.bio,
                                                    setLineClamp: !1
                                                }), e4.length > 0 && (0, n.jsx)(ed.A, {
                                                ...
                                                }), e1?.guildId != null && (0, n.jsx)(el.A, {
                                                    userId: l.id,
                                                    guildId: e1.guildId,
                                                    className: ef.profileRolesSection,
                                                    headingVariant: "text-xs/medium",
                                                    headingColor: "currentColor"
                                                }), ll.length > 0 && (0, n.jsx)(ed.A, {
                                            ...
                                            }), e1?.profileEffect != null && (0, n.jsx)(I.A, {
