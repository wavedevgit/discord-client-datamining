/** chunk id: 950989 params = (module,exports,require) **/
t.d(n, {
    default: () => N
});
var i = t(627968),
...
function N(e) {
    let {
        ...
        guildId: b,
        tag: k
    } = e, v = l.useRef(null), f = null != k, [y, A] = l.useState(k?.name ?? ""), [_, I] = l.useState(null != k ? {
        id: k.emojiId,
        name: k.emojiName
    } : null), [E, S] = l.useState(k?.moderated), T = (0, o.bG)([c.Ay], () => _?.id != null ? c.Ay.getUsableCustomEmojiById(_.id) : null), B = k?.name !== y || k?.emojiId !== _?.id || k?.emojiName !== _?.name || E !== k?.moderated, R = () => {
        if (null != y && B) {
            if (f) {
                j.A.updateForumTag({
                    id: k.id,
    ...
    }, D = l.useCallback(e => A(e), []), F = l.useRef(null);
    return (0, u.Ay)(() => {
        ...
        actionBarInput: f ? (0, i.jsx)(r.Button, {
                        ...
                        children: (0, i.jsx)(r.YNO, {
                            ...
                            children: (e, n) => {
                                ...
                                return (0, i.jsx)(s.A, {
                                    ...
                                    className: x.Z8,
                                    tabIndex: 0,
                                    renderButtonContents: null != _ && (null != _.id || null != _.name) ? () => (0, i.jsx)(d.A, {
                                        className: x.Zg,
                                        emojiId: _.id,
                                        emojiName: _.name,
                                        animated: !!T?.animated
