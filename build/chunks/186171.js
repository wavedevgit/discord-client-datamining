/** chunk id: 186171, original params: t,n,i (module,exports,require) **/
i.d(n, {
    A: () => u
});
var l = i(627968);
...
function u(t) {
    let n = (0, a.bG)([r.Ay], () => r.Ay.getRunningVerifiedApplicationIds().includes(t.id), [t.id]),
        [i, u] = (0, a.yK)([d.A], () => [d.A.isUpToDate(t.id, t.branchId), d.A.shouldPatch(t.id, t.branchId)], [t.branchId, t.id]);
    return i && !n && u ? (0, l.jsx)(e.Drp, {
        id: "repair",
