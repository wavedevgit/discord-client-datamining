...
let Y = e => {
    ...
    (0, U.z)(q ?? "", null != q, Q, J);
    let [$, ee] = s.useState(!1), et = (0, I.p)(), en = s.useRef(null), [ei, es] = s.useState(!1), [ea, el] = s.useState(!1), er = null != et && null != z && z.status === V.Dmq.CANCELED, eo = (0, N.iU)(k.gD.PREMIUM_MONTH_TIER_2, et, z), ec = !ea && er, {
        analyticsLocations: ed
    } = (0, m.Ay)(_.A.PREMIUM_SUBSCRIBER_NITRO_HOME), [eu, e_] = s.useState(!1), em = (0, o.bG)([p.A], () => null != t ? p.A.getUserProfile(t) : null), eA = (0, S.A)({
        location: "PremiumSubscriberHome"
    });
            ...
            children: [(0, i.jsx)(d.hLv, {
                ...
                children: (0, i.jsxs)(m.f5, {
                    ...
                    children: [(0, i.jsx)(c.L, {
                        ...
                        innerRef: F,
                        onChange: e => {
                            e && !eu && (T.default.track(V.HAw.PREMIUM_MARKETING_SURFACE_REACHED_BOTTOM, {
                                location_stack: ed
                            }), e_(!0))
                        },
