...
let G = "perk",
    w = e => {
        ...
        (0, O.z)(z ?? "", null != z, q, Z);
        let [$, Q] = r.useState(!1), J = (0, R.p)(), ee = r.useRef(null), [et, en] = r.useState(!1), ei = null != J && null != H && H.status === L.Dmq.CANCELED, er = (0, E.iU)(D.gD.PREMIUM_MONTH_TIER_2, J, H), ea = !et && ei, {
            analyticsLocations: es
        } = (0, m.Ay)(_.A.PREMIUM_SUBSCRIBER_NITRO_HOME), [el, eo] = r.useState(!1);
        return null != (0, o.bG)([h.A], () => null != t ? h.A.getUserProfile(t) : null) && (W || null != F) ? (0, i.jsxs)(d.GtU, {
            className: k.xW,
            ref: w,
            children: [(0, i.jsx)(d.hLv, {
                ...
                children: (0, i.jsxs)(m.f5, {
                    ...
                    children: [(0, i.jsx)(c.L, {
                        ...
                        innerRef: V,
                        onChange: e => {
                            e && !el && (C.default.track(L.HAw.PREMIUM_MARKETING_SURFACE_REACHED_BOTTOM, {
                                location_stack: es
                            }), eo(!0))
                        },
