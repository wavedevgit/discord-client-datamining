...
let w = "section",
    ...
    V = e => {
        ...
        (0, M.z)(z ?? "", null != z, $, J);
        let [Q, Z] = l.useState(!1), ee = (0, N.p)(), et = l.useRef(null), [en, ei] = l.useState(!1), el = null != ee && null != F && F.status === U.Dmq.CANCELED, es = (0, S.iU)(D.gD.PREMIUM_MONTH_TIER_2, ee, F), ea = !en && el, {
            analyticsLocations: er
        } = (0, A.Ay)(h.A.PREMIUM_SUBSCRIBER_NITRO_HOME), [eo, ed] = l.useState(!1);
        return null != (0, o.bG)([f.A], () => null != t ? f.A.getUserProfile(t) : null) && (W || null != K) ? (0, i.jsxs)(c.GtU, {
            className: P.xW,
            ref: V,
            children: [(0, i.jsx)(c.hLv, {
                ...
                children: (0, i.jsxs)(A.f5, {
                    ...
                    children: [(0, i.jsx)(d.L, {
                        ...
                        innerRef: H,
                        onChange: e => {
                            e && !eo && (I.default.track(U.HAw.PREMIUM_MARKETING_SURFACE_REACHED_BOTTOM, {
                                location_stack: er
                            }), ed(!0))
                        },
