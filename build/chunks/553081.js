...
let B = "section",
    ...
    H = e => {
        let {
            userId: t
        } = e, n = (0, N.ds)(), s = (0, _.l)("PremiumSubscriberHome"), H = (0, r.zy)();
        l.useEffect(() => {
            u.h.wait(async () => {
                let e = [(0, g.Ay)()];
        ...
        (0, D.z)(X ?? "", null != X, Q, Z);
        let [ee, et] = l.useState(!1), en = (0, T.p)(), ei = l.useRef(null), [el, es] = l.useState(!1), ea = null != en && null != K && K.status === G.Dmq.CANCELED, er = (0, b.iU)(U.gD.PREMIUM_MONTH_TIER_2, en, K), eo = !el && ea, {
            analyticsLocations: ed
        } = (0, A.Ay)(h.A.PREMIUM_SUBSCRIBER_NITRO_HOME), [ec, eu] = l.useState(!1);
        return null != (0, o.bG)([E.A], () => null != t ? E.A.getUserProfile(t) : null) && (Y || null != z) ? (0, i.jsxs)(c.GtU, {
            className: k.xW,
            ref: F,
            children: [(0, i.jsx)(c.hLv, {
                ...
                children: (0, i.jsxs)(A.f5, {
                    ...
                    children: [(0, i.jsx)(d.L, {
                        ...
                        innerRef: W,
                        onChange: e => {
                            e && !ec && (C.default.track(G.HAw.PREMIUM_MARKETING_SURFACE_REACHED_BOTTOM, {
                                location_stack: ed
                            }), eu(!0))
                        },
