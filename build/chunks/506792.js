...
let f = (0, c.a)(function(e) {
    ...
    }), T = (0, a.bG)([d.A], () => d.A.getChannel(S?.parent_id)), v = l === S?.id, y = (0, a.bG)([h.A], () => null != T ? h.A.can(p.xBc.MANAGE_CHANNELS, T) : null != t && h.A.can(p.xBc.MANAGE_CHANNELS, t)), j = s.useCallback(e => {
