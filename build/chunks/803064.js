/** chunk id: 803064 params = (module,exports,require) **/
"use strict";
n.d(t, {
    A: () => f
});
...
let f = function(e) {
    let {
        guild: t
    } = e, f = t.features.has(g.GuildFeatures.BANNER), j = s.useCallback((e, s) => {
        null == e || void 0 === s ? m.A.saveGuild(t.id, {
            homeHeader: null
        }) : (0, l.mMO)(async () => {
            let {
                default: l
            } = await Promise.all([n.e("79149"), n.e("35929"), n.e("74571"), n.e("15167")]).then(n.bind(n, 142630));
            return n => (0, i.jsx)(l, {
                imageUri: e,
                file: s,
                onCrop: e => {
    ...
    }, [t.id]), N = s.useCallback(e => {
        e.preventDefault(), e.stopPropagation(), (0, r.zV)(g.HAw.PREMIUM_GUILD_PROMOTION_OPENED, {
            location: {
