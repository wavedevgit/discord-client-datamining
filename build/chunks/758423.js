...
function m(e, t, n, c) {
    let m = !(arguments.length > 4) || void 0 === arguments[4] || arguments[4],
        ...
        g = r.useMemo(() => _.features.includes(l.L.FULL_EPISODE_VIDEO_QUEST), [_.features]),
        h = r.useMemo(() => null != v ? s.Ay.isSupported() && null != v.videoHls ? u.fY.VIDEO_PLAYER_VIDEO_HLS : g ? null : E.has(t) || null == v.videoLowRes ? u.fY.VIDEO_PLAYER_VIDEO : u.fY.VIDEO_PLAYER_VIDEO_LOW_RES : null, [v, t, g]),
        A = r.useMemo(() => null != c ? {
            url: c,
            mimetype: "video/mp4",
            isAnimated: !0
        } : null != h ? (0, u.tW)(f, h, void 0, !1) : null, [f, h, c]),
        C = () => {
    ...
    return r.useEffect(() => {
        if (!m || h !== u.fY.VIDEO_PLAYER_VIDEO_HLS || null == A || null == e.current || S.current) return;
        p.current = new s.Ay({
