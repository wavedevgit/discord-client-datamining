/** chunk id: 401977 params = (module,exports,require) **/
n.d(t, {
    DA: () => e_,
    F1: () => ev,
    G6: () => eu,
...
function eg() {
    var e;
    let t = ex(ec);
    e = ec, m().isEqual(m().omit(t, "old_enabled"), m().omit(e, "old_enabled")) || (et.default.track(ea.HAw.OVERLAY_SETTINGS_UPDATED, {
        ...t
    }), ec = t)
}
...
let ep = new Set([L.AR.INITIALIZING, L.AR.WAITING_FOR_SCREEN_TYPE_RESOLUTION, L.AR.WAITING_FOR_MODULE_TRACKING, L.AR.WAITING_FOR_OVERLAY_OPEN, L.AR.WAITING_FOR_POPOUT_OPEN, L.AR.WAITING_FOR_MODULE_POPOUT_CAPTURE, L.AR.WAITING_FOR_REACT_INITIALIZATION, L.AR.WAITING_FOR_PID_FOCUS, L.AR.WAITING_FOR_SUCCESSFUL_SHOW]),
    ef = e => {
...
function eT() {
    ...
    } = (0, N.A)(), n = e?.pid, l = (0, _.bG)([D.default], () => null == e || null == n ? null : D.default.getTrackedGameByPid(n), [e, n], o()), {
        enabledLegacy: a,
        enabledOOP: r
    } = (0, _.cf)([W.A, q.A], () => null == e && null == l ? {
        enabledLegacy: !1,
        enabledOOP: !1
    } : null == e ? {
        enabledLegacy: l?.legacyEnabled ?? !1,
        enabledOOP: l?.oopEnabled ?? !1
    } : (0, v.hw)(e, !1, [W.A, q.A]), [e, l]), d = (0, _.bG)([v.Ay, W.A, q.A], () => null == e ? null : (0, v.xU)(e, v.Ay, W.A, q.A), [e], o()), [c, u] = s.useState(r), [m, h] = s.useState(a), [f, E] = s.useState(!1);
    s.useEffect(() => {
        u(r), h(a)
    }, [r, a]);
    let b = !(0, es.supportsLegacy)(),
        C = !(0, es.supportsOutOfProcess)(),
        {
            legacyEnabled: O,
            oopEnabled: R
        } = (0, _.cf)([D.default], () => D.default.getGlobalEnabledStatus()),
        P = (t, n) => {
            if (null == e) return;
            let i = !1,
                s = !1;
            ...
            }(i || s) && (0, U.L)(i ? y.OverlayToggledClientSettingType.LEGACY_GAME : y.OverlayToggledClientSettingType.OOP_GAME, e.id ?? null)
        },
        G = b && C,
        M = !O && !R,
        k = !c && !O && m && !b,
        ...
        [Q, J] = (() => {
            switch (!0) {
                case B && H:
                    return [eo.intl.format(eo.t.hFVBIg, {
    ...
    let [$, ee] = s.useMemo(() => F ? ["text-muted", x.LU0.colors.TEXT_MUTED.css] : B && Y ? ["text-feedback-warning", x.LU0.colors.TEXT_FEEDBACK_WARNING.css] : B && H ? ["text-feedback-positive", x.LU0.colors.TEXT_FEEDBACK_POSITIVE.css] : B && X ? ["text-strong", x.LU0.colors.TEXT_STRONG.css] : ["interactive-text-default", x.LU0.colors.INTERACTIVE_TEXT_DEFAULT.css], [F, B, Y, H, X]);
    return null == e ? null : (0, i.jsxs)(eh, {
        onExpand: E,
                    ...
                    ((t, n) => {
                        ...
                        switch (n) {
                            ...
                            case "global":
                                ...
                                break;
                            case "both":
                                p.A.setEnabled(t, t), A.A.toggleOverlay(e, t, t), h(t), u(t), i = !t && O || !t && m, s = !t && R || !t && c
                        }
                        let l = null;
                        i ? l = "game" === n ? y.OverlayToggledClientSettingType.LEGACY_GAME : y.OverlayToggledClientSettingType.LEGACY : s && (l = "game" === n ? y.OverlayToggledClientSettingType.OOP_GAME : y.OverlayToggledClientSettingType.OOP), null != l && (0, U.L)(l, e.id ?? null)
                    })(t, ((e, t) => {
                        let n = !t && e,
                            i = !R && c,
                            s = !O && m,
        ...
        children: [(0, i.jsx)(eA, {
            ...
            action: (0, i.jsxs)(i.Fragment, {
                children: [(0, i.jsx)(x.dOG, {
                    ...
                    disabled: C,
                    onChange: e => {
                        e && !R ? P(e, y.OverlayToggledClientSettingType.OOP) : P(e, y.OverlayToggledClientSettingType.OOP_GAME)
                    }
                }), (0, i.jsx)("div", {
                    className: ed.Kz
                })]
            ...
            action: (0, i.jsxs)(i.Fragment, {
                children: [(0, i.jsx)(x.dOG, {
                    ...
                    disabled: b,
                    onChange: e => {
                        e && !O ? P(e, y.OverlayToggledClientSettingType.LEGACY) : P(e, y.OverlayToggledClientSettingType.LEGACY_GAME)
                    }
                }), (0, i.jsx)("div", {
                    className: ed.Kz
                })]
...
function eS(e) {
    let {
        game: t,
        gameApplication: n
    } = e, l = s.useMemo(() => null == t ? null : "pid" in t ? t.pid : null, [t]), a = (0, _.bG)([b.A], () => null != n ? n : b.A.getApplication(t?.id), [n, t]);
    return (0, i.jsx)(I.A, {
        game: a,
        pid: l,
        size: I.M.SMALL
...
function eE(e) {
    let {
        ...
        clientSettingType: o,
        ariaLabel: d
    } = e, c = (0, _.cf)([v.Ay, W.A, q.A], () => (0, v.xU)(t, v.Ay, W.A, q.A)), u = (0, _.cf)([W.A, q.A], () => (0, v.hw)(t, !1, [W.A, q.A]), [t]), m = a(u), [g, A] = s.useState(m);
    return s.useEffect(() => {
        A(m)
    }, [m]), (0, i.jsx)(eA, {
        title: t.name,
...
function eb() {
    let [e, t] = s.useState(!1), {
        legacyEnabled: n,
        oopEnabled: l
    } = (0, _.cf)([D.default], () => D.default.getGlobalEnabledStatus()), a = (0, _.yK)([v.Ay], () => v.Ay.getGamesSeen(!0)).filter(e => !(0, F.n1)(e)), r = (0, C.A)(a.map(e => e.id)), o = !(0, es.supportsLegacy)(), d = e => {
        p.A.setEnabled(e, l);
        let t = v.Ay.getCurrentGameForAnalytics()?.id ?? null;
        (0, y.Q3)(e, y.OverlayToggledClientSettingType.LEGACY, t), !e && n && (0, U.L)(y.OverlayToggledClientSettingType.LEGACY, t)
    }, c = (e, t, n) => {
        let {
            enabledOOP: i
        } = n;
        A.A.toggleOverlay(t, e, i)
    }, u = s.useMemo(() => (0, es.supportsLegacy)() ? o ? eo.intl.string(eo.t.r9jEVw) : eo.intl.string(eo.t.OzInYk) : eo.intl.string(eo.t["8Ox6/E"]), [o]);
    return 0 === a.length ? (0, i.jsx)(eA, {
        title: eo.intl.string(eo.t.BfFpW1),
        description: u,
        "aria-label": eo.intl.string(eo.t.BfFpW1),
        className: ed.dA,
        ...
        children: [(0, i.jsx)("div", {
            ...
            children: a.map((e, t) => (0, i.jsx)(eE, {
                ...
                onChange: c,
                ariaLabel: eo.intl.format(eo.t.hvPYsF, {
                    gameName: e.name
                }).toString()
            }, e.id))
        })]
...
function eC() {
    let [e, t] = s.useState(!1), {
        oopEnabled: n,
        legacyEnabled: l
    } = (0, _.cf)([D.default], () => D.default.getGlobalEnabledStatus()), a = !(0, es.supportsOutOfProcess)(), r = (0, _.yK)([v.Ay], () => v.Ay.getGamesSeen(!0)).filter(e => !(0, F.n1)(e)), o = (0, C.A)(r.map(e => e.id)), d = e => {
        let t = !e && n;
        p.A.setEnabled(l, e);
        let i = v.Ay.getCurrentGameForAnalytics()?.id ?? null;
        (0, y.Q3)(e, y.OverlayToggledClientSettingType.OOP, i), t && (0, U.L)(y.OverlayToggledClientSettingType.OOP, i)
    }, c = (e, t, n) => {
        let {
            enabledLegacy: i
        } = n;
        A.A.toggleOverlay(t, e, i)
    }, u = s.useMemo(() => R.O ? a ? eo.intl.string(eo.t.C7bLTQ) : eo.intl.string(eo.t.ndgADE) : eo.intl.string(eo.t.m7X4az), [a]);
    return 0 === r.length ? (0, i.jsx)(eA, {
        title: eo.intl.string(eo.t["7BlVIs"]),
        description: u,
        "aria-label": eo.intl.string(eo.t["7BlVIs"]),
        className: ed.dA,
        ...
        children: [(0, i.jsx)("div", {
            ...
            children: r.map((e, t) => (0, i.jsx)(eE, {
                ...
                onChange: c,
                ariaLabel: eo.intl.format(eo.t.nByTd3, {
                    gameName: e.name
                }).toString()
            }, e.id))
        })]
...
function ev() {
    return (0, P.X4)(E.A.USER_SETTINGS) ? (0, i.jsx)(eA, {
        ...
        children: (0, i.jsxs)("div", {
            ...
            children: [(0, i.jsxs)("div", {
                ...
                children: (0, i.jsx)(f.A, {
                    ...
                    onChange: function(t) {
                        c()(null != e, "Keybind should never be undefined"), h.A.setKeybind({
                            ...e,
                            shortcut: t
                        })
                    }
...
function eI(e) {
    return [{
        ...
        usePredicate: () => {
            ...
            } = (0, P.M8)("OverlayV3NowPlayingDifferentGamesNotificationSetting"), t = (0, _.bG)([G.A], () => G.A.isNotificationDisabledBySetting(O.M.NOW_PLAYING));
            return !!e && !t
        }
...
function ey() {
    let e, t = (0, _.bG)([Q.default], () => Q.default.getCurrentUser()),
        {
            avatarSizeMode: n,
            displayNameMode: l,
            displayUserMode: r
        ...
        [o] = s.useState(() => [ej(eo.intl.string(eo.t.C0ZDvo), !0, !1), ej(eo.intl.string(eo.t.iOtj8E), !1, !1, !0), ej(eo.intl.string(eo.t["0oqNgL"]), !1, !0)]),
        d = (0, _.bG)([M.A, Z.A], () => {
        ...
        g = (0, i.jsx)(x.NPJ, {
            ...
            children: e => (0, i.jsxs)("div", {
                ...
                children: [(0, i.jsx)("div", {
                    ...
                    className: ed.R$,
                    children: [(0, i.jsx)(B.Pl, {
                        children: eo.intl.string(eo.t.KNJ6Vq)
                    }), (0, i.jsx)(B.CS, {}), (0, i.jsx)(B.O0, {
                        id: d?.id ?? "voice-widget",
                        pinned: d?.pinned ?? !1
                    })]
                })]
            })
