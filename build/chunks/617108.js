...
let A = function(e) {
    ...
    return null == I || I.discount?.plan_ids.some(e => _.hd[e].skuId !== n) || null == I.expires_at || Object.values(p).every(e => 0 === e) ? null : (0, i.jsxs)(d.T0, {
        onClick: () => {
        ...
        children: [(0, i.jsx)(d.In, {
            children: (0, u.rn)(p, Number(I.discount.amount))
        }), (0, i.jsx)(d.fY, {
            onClick: () => {
                (0, a.A)({
                    subscriptionTier: n,
