...
function x(e) {
    let {
        ...
        emojiId: S,
        emojiName: y
    } = t, v = null != x, [j, R] = l.useState(!1), M = (0, c.bG)([f.Ay], () => null != S ? f.Ay.getUsableCustomEmojiById(S) : null), N = v || null != T, O = (!v || !j) && (null != S || null != y), w = 0 === a, D = l.useRef(null), k = (0, c.bG)([p.A], () => p.A.keyboardModeEnabled), G = (0, i.jsxs)(i.Fragment, {
