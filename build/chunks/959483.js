/** chunk id: 959483 params = (module,exports,require) **/
n.d(t, {
    O: () => C
});
var i = n(627968),
...
function b(e) {
    ...
    return (0, i.jsx)("section", {
        ...
        children: (0, i.jsx)(u.Apm, {
            ...
            onValueChange: e => {
                var t;
                return t = -((100 - e) * 1), void m.A.setMode(_, {
                    threshold: t,
                    autoThreshold: g
                })
            },
            ...
            children: (0, i.jsxs)("div", {
                className: r()(T.NU, T.TL, T.Jx, f.bar),
                children: [(0, i.jsx)("div", {
                    className: r()(T.GS, T.SH),
                    style: {
                        width: o ? 0 : t + 100 + "%"
                    }
                }), (0, i.jsx)("div", {
...
let C = (0, _.E2)(h.X.VOICE_INPUT_SENSITIVITY_FIELD_SET, {
    useSearchTerms: () => [p.intl.string(p.t["sqUm+k"]), p.intl.string(p.t.I1Zuq0), p.intl.string(p.t.nuFtHH)],
    usePredicate: () => (0, a.bG)([x.Ay], () => x.Ay.isInputProfileCustom()),
    Component: function() {
        let {
            autoThreshold: e,
            disabled: t
            ...
            autoThreshold: x.Ay.getModeOptions().autoThreshold,
            disabled: x.Ay.getMode() !== A.TB.VOICE_ACTIVITY
        })), n = s.useCallback(e => {
            let t = x.Ay.getMode(),
                {
                    threshold: n
        ...
        }, []), l = (0, a.bG)([x.Ay], () => x.Ay.supports(A.O5.AUTOMATIC_VAD)), {
            volume: r,
            isSpeaking: c
        } = function() {
        ...
        }(), g = (0, a.bG)([x.Ay], () => x.Ay.isEnabled()), _ = s.useMemo(() => !g && (0, i.jsx)("div", {
            className: T.B4,
        ...
        }), [g]), h = s.useMemo(() => e ? p.intl.string(p.t.JsbzjA) : p.intl.string(p.t.MLmyMY), [e]), f = s.useId(), S = s.useId();
