    ...
    p = {
        ShopProductCard: e => {
            let {
                ...
                closeModal: x,
                trackAction: g
            } = l.useContext(f), p = l.useCallback(() => {
                g(u.Ws.DiscordCollectiblesShop), x(), (0, r.Cz)({
            ...
            let {
                flattenProductVariants: h,
                ...v
            } = m;
            return (0, a.jsx)(c.v3.Provider, {
                value: {
                    flattenProductVariants: h ?? !0,
                    ...v
                },
...
function h(e) {
    let {
        ...
        closeModal: n,
        trackAction: s
    } = e, o = t.shopCollectionIds?.[0], c = l.useCallback(() => {
    ...
    return null == v ? null : (0, a.jsx)(f.Provider, {
        value: h,
