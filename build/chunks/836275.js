...
let x = [{
    ...
    getTier0Value: () => g.intl.formatToPlainString(g.t.zZ6Rdi, {
    ...
    getTier1Value: () => g.intl.formatToPlainString(g.t.zZ6Rdi, {
    ...
    getTier2Value: () => g.intl.formatToPlainString(g.t.zZ6Rdi, {
        resolution: (0, c.eT)("GuildBoostingMarketingTierComparisonTable"),
        framerate: m.TG[u.TVA.TIER_2].limits.screenShareQualityFramerate
    }),
    getTier3Value: () => g.intl.formatToPlainString(g.t.zZ6Rdi, {
        resolution: (0, c.eT)("GuildBoostingMarketingTierComparisonTable"),
    ...
    getTier0Value: () => g.intl.formatToPlainString(g.t.w1gmLt, {
        bitrate: m.TG[u.TVA.NONE].limits.bitrate / 1e3
    }),
    getTier1Value: () => g.intl.formatToPlainString(g.t.w1gmLt, {
        bitrate: m.TG[u.TVA.TIER_1].limits.bitrate / 1e3
    }),
    getTier2Value: () => g.intl.formatToPlainString(g.t.w1gmLt, {
        bitrate: m.TG[u.TVA.TIER_2].limits.bitrate / 1e3
    }),
    getTier3Value: () => g.intl.formatToPlainString(g.t.w1gmLt, {
    ...
    getTier0Value: () => g.intl.formatToPlainString(g.t.pIn7Af, {
        size: m.TG[u.TVA.NONE].limits.fileSize / 1048576
    }),
    getTier1Value: () => g.intl.formatToPlainString(g.t.pIn7Af, {
        size: m.TG[u.TVA.TIER_1].limits.fileSize / 1048576
    }),
    getTier2Value: () => g.intl.formatToPlainString(g.t.pIn7Af, {
        size: m.TG[u.TVA.TIER_2].limits.fileSize / 1048576
    }),
    getTier3Value: () => g.intl.formatToPlainString(g.t.pIn7Af, {
...
function h(e) {
    let {
        ...
        className: n,
        tier: s
    } = e, l = s === u.TVA.NONE ? "text-muted" : "text-strong", a = s === u.TVA.NONE || null == s ? "heading-xl/normal" : "heading-xl/bold";
    return (0, i.jsxs)("th", {
        className: r()(_.PG, n),
        scope: "col",
...
function T(e) {
    ...
    return (0, i.jsxs)("tr", {
        ...
        children: [(0, i.jsx)("th", {
            className: r()(_.xR, _.uB),
            scope: "row",
            children: (0, i.jsx)(o.DUT, {
                className: r()(_.VC, _.xR, _.Rk),
                onFocus: n,
                onBlur: l,
                onMouseEnter: n,
                onMouseLeave: l,
...
let f = function(e) {
    ...
    return (0, i.jsxs)("div", {
        className: r,
        children: [!c && (0, i.jsx)(o.Heading, {
            className: _.R_,
            variant: "heading-xxl/extrabold",
            children: g.intl.string(g.t["9GGb9k"])
        }), (0, i.jsxs)("div", {
            className: _.wY,
            children: [null != a && (0, i.jsx)(p, {
                ...
                children: [(0, i.jsx)("thead", {
                    ...
                    children: x.map((e, s) => {
                        let r = n === s;
                        return void 0 === e.predicate ? (0, i.jsx)(T, {
                            isFocused: r,
