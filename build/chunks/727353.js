...
function S(t) {
    let {
        ...
        return null
    }, [c]), U = null != l && null != l.name ? f.intl.formatToPlainString(f.t["4CQq9Q"], {
        name: l.name
    }) : f.intl.string(f.t["Jpkr/q"]), L = (0, i.jsxs)(i.Fragment, {
        children: [_ && (0, i.jsxs)("div", {
            className: E.WG,
            children: [null != P && (0, i.jsx)(p.A, {
                game: P,
                className: E.lK
            }), (0, i.jsx)(s.Text, {
