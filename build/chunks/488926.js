...
let T = a.iu(0),
    ...
    R = a.kg(A.xBc.VIEW_CHANNEL, A.xBc.SEND_MESSAGES, A.xBc.CONNECT, A.xBc.SPEAK, A.xBc.STREAM, A.xBc.USE_EMBEDDED_ACTIVITIES, A.xBc.USE_EXTERNAL_APPS, A.xBc.USE_EXTERNAL_EMOJIS, A.xBc.USE_EXTERNAL_SOUNDS, A.xBc.USE_EXTERNAL_STICKERS, A.xBc.USE_SOUNDBOARD, A.xBc.USE_VAD, A.xBc.SEND_MESSAGES_IN_THREADS, A.xBc.EMBED_LINKS, A.xBc.ATTACH_FILES, A.xBc.ADD_REACTIONS),
    ...
    L = a.kg(A.xBc.MANAGE_GUILD, A.xBc.MANAGE_ROLES, A.xBc.ADMINISTRATOR, A.xBc.BAN_MEMBERS, A.xBc.MANAGE_NICKNAMES, A.xBc.CREATE_GUILD_EXPRESSIONS, A.xBc.MANAGE_GUILD_EXPRESSIONS, A.xBc.MANAGE_WEBHOOKS, A.xBc.VIEW_AUDIT_LOG);
...
function j(e) {
    ...
    return f = a.zy(f, A.xBc.ADMINISTRATOR) ? C : M(r.id, n, f, i), (u.A.isLurking(r.id) || (null == n ? void 0 : n.isPending)) && (f = a.pb(f, c)), g.Ay.isCurrentUserGuest(r.id) && (f = a.pb(f, R)), x(f, r, t, s)
}
...
function U(e) {
    ...
    if (null == i) return T;
    if (!(h === (null == (t = b.default.getCurrentUser()) ? void 0 : t.id) && c.A.isViewingRoles(i.id)) && (0, p.bM)(i, h)) return x(C, i, h, u);
