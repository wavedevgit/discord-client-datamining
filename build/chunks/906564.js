...
function m(e) {
    ...
    if (l.h.dispatch({
        ...
        (0, p.A)(E, g.JJy.REGISTER), d.default.track(g.HAw.AGE_GATE_ACTION, {
            source: f.w_.REGISTER,
            action: f.AM.AGE_GATE_SUBMITTED
    ...
    return h.A.post({
        ...
        l.h.dispatch({
            ...
            source: f.w_.REGISTER,
            action: f.AM.AGE_GATE_SUCCESS
        })
    }, e => {
        if (e instanceof c.CaptchaCancelError) throw e;
        let t = new a.A(e);
        throw null != t.getFieldErrors("date_of_birth") && o.Xv(f.w_.REGISTER), d.default.track(g.HAw.REGISTER_SUBMIT_ERRORED, {
