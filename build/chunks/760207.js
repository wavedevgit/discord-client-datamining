...
function j(e) {
    let {
        guildId: t
    } = e, [r, d] = i.useState(""), N = (0, s.bG)([_.A], () => _.A.getGuild(t)), j = (0, s.bG)([u.Ay], () => u.Ay.getChannels(t)), v = (0, s.bG)([o.A], () => o.A.getCategories(t)), b = (0, m.vh)(t, v, j, r), I = (0, s.bG)([h.A], () => h.A.canWithPartialContext(A.xBc.MANAGE_CHANNELS, {
        guildId: t
