...
function p(e) {
    let {
        applicationId: t
    } = e.match.params, [p, g] = a.useState(!1), E = a.useRef(!1), [I, f] = a.useState(null), C = !c.isPlatformEmbedded && !l.Fr && !p, T = a.useMemo(() => (0, r.A)(), []);
    return (a.useEffect(() => {
        C && !0 !== E.current && (Promise.resolve().then(n.bind(n, 129014)).then(e => {
            ...
            n.request(A.e$_.DEEP_LINK, {
                ...
                let n = e ?? !1;
                f(n), d.default.track(A.HAw.ACTIVITY_DEEP_LINK_ATTEMPTED, {
                    application_id: t,
                ...
                f(!1), d.default.track(A.HAw.ACTIVITY_DEEP_LINK_ATTEMPTED, {
                    application_id: t,
                    source_url: location.href,
                    attempt_id: T,
                    rpc_success: !1
