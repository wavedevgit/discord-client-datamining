...
class j extends a.Ay.Store {
    ...
    initialize() {
        this.waitFor(c.A, g.default, I.A, E.A, h.A, l.Ay, C.A, d.A, _.Ay, u.A, p.A, m.Ay, S.A, T.Ay, A.A)
    }
    getGuild(e, t) {
...
let W = new j(s.h, {
    ...
    BULK_ACK: function(e) {
        ...
        return r()(t).map(e => E.A.getChannel(e.channelId)?.guild_id).filter(b.Vq).uniq().forEach(e => {
