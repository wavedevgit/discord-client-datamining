...
function V() {
    let e = S.A.getChannelId(),
        t = S.A.getVoiceChannelId(),
        n = f !== e || G !== t;
    return !!n && (l()([f, G, e, t]).uniq().forEach(e => {
...
class F extends r.Ay.Store {
    ...
    initialize() {
        this.waitFor(u.A, _.default, I.A, g.A, C.A, o.Ay, h.A, d.A, c.Ay, A.A, p.A, T.Ay, S.A, N.Ay, E.A)
    }
    getGuild(e, t) {
...
let w = new F(s.h, {
    ...
    BULK_ACK: function(e) {
        ...
        return l()(t).map(e => g.A.getChannel(e.channelId)?.guild_id).filter(b.Vq).uniq().forEach(e => {
    ...
    CHANNEL_UPDATES: function(e) {
        ...
        return l()(t).map(e => e.guild_id).uniq().forEach(e => {
            R.clearGuildId(e) && (n = !0)
        }), n
    },
    ...
    USER_SETTINGS_PROTO_UPDATE: function(e) {
        ...
        let n = t.proto.guilds?.guilds,
            i = !1;
        return null != n && L.default.keys(n).forEach(e => {
    ...
    VOICE_STATE_UPDATES: function(e) {
        ...
        for (let {
            ...
            of t) null == l || i.has(l) || (R.nonPositionalChannelIdUpdate(l) && (n = !0), i.add(l)), null == e || i.has(e) || (R.nonPositionalChannelIdUpdate(e) && (n = !0), i.add(e));
        return n
    },
    WINDOW_FOCUS: function() {
        return null != f && R.nonPositionalChannelIdUpdate(f)
    }
})