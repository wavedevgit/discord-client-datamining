...
function T(e) {
    let {
        ...
        settingsMetadata: T,
        settingsProfile: I
    } = e, b = p.id, [v, S] = s.useState(!1), [y, R] = s.useState(null), O = p.features.has(N.GuildFeatures.MEMBER_VERIFICATION_MANUAL_APPROVAL), G = (0, g.H)({
        guildId: p.id
    }) ?? 0, L = s.useCallback(() => {
        R(null), h.A.init(b, N.BEX.ACCESS)
    }, [b]), D = s.useCallback(async e => {
        try {
            S(!0), await e(), R(null)
        } finally {
            S(!1)
    ...
    }, [b]), k = s.useCallback(async (e, t, n) => {
        try {
            await c.Ay.updateVerificationForm(b, e, t, n)
        } catch (e) {
        ...
        if (t.isAgeRestricted !== (p.ownerConfiguredContentLevel === N.ftr.AGE_RESTRICTED) && D(async () => {
            ...
            D(async () => {
                ...
                l.verificationDirty && await k([...n], !0, e), l.profileDirty && null != I && await (0, x._C)(p.id, {
    ...
    }, [t, D, p, l, M, U, I, k, _, T]), w = s.useCallback(() => (e => {
    ...
    }), [O, P, t, b, G]), B = t.joinType === f.J.DISCOVERABLE && t.settingsView === j.v.ELIGIBLE_DISABLED, F = null != p.description && T.primaryCategoryId !== E.ig && T.keywords.length > 0;
    return (0, i.jsx)(r.A, {
