...
function C(e) {
    ...
    }, [t, D, p, l, M, U, I, k, _, C]), w = s.useCallback(() => (e => {
    ...
    }), [O, P, t, b, G]), B = t.joinType === f.J.DISCOVERABLE && t.settingsView === j.v.ELIGIBLE_DISABLED, F = null != p.description && C.primaryCategoryId !== E.ig && C.keywords.length > 0;
    return (0, i.jsx)(r.A, {
