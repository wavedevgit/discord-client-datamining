...
function T(e) {
    let {
        ...
        settingsMetadata: T,
        settingsProfile: C
    } = e, I = p.id, [v, S] = s.useState(!1), [y, R] = s.useState(null), O = p.features.has(N.GuildFeatures.MEMBER_VERIFICATION_MANUAL_APPROVAL), G = (0, g.H)({
        guildId: p.id
    }) ?? 0, L = s.useCallback(() => {
        ...
        if (t.isAgeRestricted !== (p.ownerConfiguredContentLevel === N.ftr.AGE_RESTRICTED) && D(async () => {
            ...
            D(async () => {
                ...
                l.verificationDirty && await k([...n], !0, e), l.profileDirty && null != C && await (0, x._C)(p.id, {
    ...
    }, [t, D, p, l, M, U, C, k, _, T]), w = s.useCallback(() => (e => {
    ...
    }), [O, P, t, I, G]), B = t.joinType === f.J.DISCOVERABLE && t.settingsView === j.v.ELIGIBLE_DISABLED, F = null != p.description && T.primaryCategoryId !== E.ig && T.keywords.length > 0;
    return (0, i.jsx)(r.A, {
