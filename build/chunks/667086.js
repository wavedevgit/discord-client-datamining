...
function v(e) {
    let {
        ...
        ref: s,
        focusSectionProps: o
    } = e, [_, g] = r.useState(!1), I = (0, p.lI)(), f = n || I, v = n || f, y = (0, i.jsx)(u.XFE, {
        className: T.Kk,
...
function y() {
    ...
    }), l = (0, o.bG)([_.A], () => _.A.getChannelId()), a = r.useMemo(() => f.BVt.CHANNEL(f.gNP, l ?? void 0), [l]), d = (0, E.HN)();
