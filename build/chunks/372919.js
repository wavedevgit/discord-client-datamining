    ...
    [U.e$_.OPEN_INVITE_DIALOG]: {
        ...
        handler(e) {
            ...
            if ((0, O.sP)({}, u?.document), null != d) {
                ...
                let {
                    default: e
                } = await Promise.all([n.e("43600"), n.e("88785")]).then(n.bind(n, 234355));
                return t => (0, i.jsx)(e, {
                    ...t,
                    guild: s,
                    channel: a,
        ...
        handler(e) {
            ...
            return new Promise(e => {
                let n = !1,
                    l = (0, M.d5)(c),
                    a = r.SYi;
                (f.A.getWindowOpen(U.MLl.ACTIVITY_POPOUT) || l.context === U.BRT.POPOUT) && (a = r.KX8), (0, p.m)({
                    applicationId: u,
                    channel: A,
                    command: {
                        name: i,
