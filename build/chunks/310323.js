...
class U extends o.A {
    constructor(...e) {
        super(...e), I(this, "handleStreamWatch", e => {
            ...
            k(t, null == i ? void 0 : i.isGuildStageVoice()), x(t), n || d.A.getAllActiveStreams().forEach(e => {
                let n = (0, O._z)(e);
            ...
            }, (0, c.id)(n))), (0, s.Xi)(n, !1), this.platformShowStreamFull())
