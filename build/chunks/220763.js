...
function p(t) {
    ...
    return (0, s.g1)({
        ...
        glowUp: u,
        analyticsSource: {
            page: e?.getGuildId() != null ? o.liQ.GUILD_CHANNEL : e?.isGroupDM() || e?.isPrivate() ? o.liQ.DM_CHANNEL : null
        },
        analyticsLocation: {
            section: o.JJy.MESSAGE_LENGTH_UPSELL_MODAL,
