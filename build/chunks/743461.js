...
let M = t => {
    let {
        ...
        transitionState: g,
        onClose: N
    } = t, O = (0, I.A)(), f = (0, a.yM)(), P = (0, c._R)(), h = T.intl.string(T.t["9KiIz6"]), S = r.useMemo(() => f && P, [f, P]), D = r.useCallback(t => {
        (0, c.hv)({
            action: t,
            channelId: e,
            messageId: M
        ...
        N(), D(c.rY.EXPLICIT_MEDIA_LEARN_MORE_CLICK_FALSE_POSITIVE), (0, E.mMO)(async () => {
            let {
                default: t
            } = await n(652442);
            return n => (0, i.jsx)(t, {
    ...
    return r.useEffect(() => {
        ...
        subtitle: function() {
            if (S) return T.intl.format(T.t.KEPOlE, {
                handleOnHelpUrlHook: () => {
                    _.A.openUrl(L.A.getArticleURL(R.MVz.TIGGER_PAWTECT_LEARN_MORE)), D(c.rY.EXPLICIT_MEDIA_LEARN_MORE_CLICK_AGE_VERIFY_LEARN_MORE)
                }
            });
        ...
        actions: [function() {
            ...
            text: h,
            onClick: function() {
                N(), D(c.rY.EXPLICIT_MEDIA_LEARN_MORE_CLICK_AGE_VERIFY_REVERIFY), _.A.showAgeVerificationGetStartedModal({
            ...
            onClick: function() {
                ...
                (0, d.openUserSettings)(t ? A.X.CONTENT_AND_SOCIAL_CONTENT_FILTERS_SETTING : A.X.CONTENT_AND_SOCIAL_PANEL, {
