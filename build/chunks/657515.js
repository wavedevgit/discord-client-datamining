...
let A = {
    ...
    h = {
        rewards: [A, f, T],
        rewardAssetIdMap: (0, l.t8)([A, f, T]),
        chatGiftIcon: {
            trinketsAnimation: {
                getAnimationData: () => e.e("51463").then(e.bind(e, 347066)).then(t => {
                    let {
                        default: i
                    } = t;
