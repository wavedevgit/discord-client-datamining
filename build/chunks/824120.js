...
var r = function(e) {
    ...
    function v(e, t, n) {
        var r;
        return (M(e, t) >= 0 ? r = O(e, t) : (r = O(t, e), n = !n), "number" == typeof(r = _(r))) ? (n && (r = -r), new u(r)) : new c(r, n)
    }
    ...
    function P(e, n) {
        ...
        for (E.length <= u && E.push(0), y.push(0), h = y[d - 1], i = u - d; i >= 0; i--) {
            for (r = f - 1, E[i + d] !== h && (r = Math.floor((E[i + d] * f + E[i + d - 1]) / h)), a = 0, o = 0, l = y.length, s = 0; s < l; s++) a += r * y[s], c = Math.floor(a / f), o += E[i + s] - (a - c * f), a = c, o < 0 ? (E[i + s] = o + f, o = -1) : (E[i + s] = o, o = 0);
            for (; 0 !== o;) {
                for (r -= 1, a = 0, s = 0; s < l; s++)(a += E[i + s] - f + y[s]) < 0 ? (E[i + s] = a + f, a = 0) : (E[i + s] = a, a = 1);
                o += a
            }
            p[i] = r
        }
    ...
    c.prototype = Object.create(l.prototype), u.prototype = Object.create(l.prototype), d.prototype = Object.create(l.prototype), c.prototype.add = function(e) {
        ...
        for (var i = this.abs(), a = void 0 === e ? 5 : e, o = [], s = 0; s < a; s++) o.push(r.randBetween(2, i.minus(2), t));
        return k(i, o)
    ...
    c.prototype.toArray = function(e) {
        ...
        for (var n, r = this.value, i = r.length, a = String(r[--i]), o = "0000000"; --i >= 0;) a += o.slice((n = String(r[i])).length) + n;
        return (this.sign ? "-" : "") + a
    ...
    return l.one = l[1], l.zero = l[0], l.minusOne = l[-1], l.max = z, l.min = q, l.gcd = Z, l.lcm = Q, l.isInstance = function(e) {
