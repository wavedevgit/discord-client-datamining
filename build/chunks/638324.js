...
function R(t) {
    let {
        ingress: e,
        guildId: n
    } = t, p = (0, A.q9)(), R = (0, _.K)(), v = T.$s.useSetting().includes(n), h = (0, s.uM)(), D = T.YX.useSetting(), U = T.Zr.useSetting().includes(n), N = l.useCallback(t => {
        let i = (0, g.xo)();
        t ? i.delete(n) : i.add(n), T.Zr.updateSetting(Array.from(i)), o.default.track(I.HAw.USER_SERVER_PRIVACY_SETTINGS_ACTION, {
    ...
    function k(t, e) {
        var n;
        !t && (0, S.w)() ? u.A.showAgeVerificationGetStartedModal({
    ...
    return (0, i.jsx)(E.h, {
        children: "0" === n ? (0, i.jsx)(f.Ay, {
            title: m.intl.string(m.t["3o2ojh"]),
            value: !R && !D,
            onChange: t => k(t, !1),
            disabled: R || h,
            tooltipText: h ? m.intl.string(x.default["6Af/cw"]) : void 0,
            note: m.intl.format(m.t.wkm9a3, {
                helpdeskArticle: c.A.getArticleURL(I.MVz.MESSAGE_REQUESTS)
            })
        }) : (0, i.jsx)(f.Ay, {
            title: m.intl.string(m.t["3o2ojh"]),
            value: !v && !U,
            onChange: t => k(t, !0),
            disabled: v,
            note: p ? m.intl.format(m.t.WpnWLc, {
                helpdeskArticle: c.A.getArticleURL(I.MVz.MESSAGE_REQUESTS)
            }) : m.intl.format(m.t.wkm9a3, {
                helpdeskArticle: c.A.getArticleURL(I.MVz.MESSAGE_REQUESTS)
            })
        })
    })
...
function v(t) {
    let {
        ingress: e = p.bf.USER_SETTINGS_PRIVACY_SAFETY,
        guildId: n
    } = t, l = (0, A.Tx)();
    return (0, i.jsx)(R, {
        ingress: e,
