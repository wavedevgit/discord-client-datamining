...
function L(t) {
    let {
        ingress: _,
        guildId: e
    } = t, D = (0, N.q9)(), L = (0, u.K)(), c = d.$s.useSetting().includes(e), g = (0, n.uM)(), M = d.YX.useSetting(), U = d.Zr.useSetting().includes(e), F = A.useCallback(t => {
        let E = (0, l.xo)();
        t ? E.delete(e) : E.add(e), d.Zr.updateSetting(Array.from(E)), R.default.track(P.HAw.USER_SERVER_PRIVACY_SETTINGS_ACTION, {
    ...
    function x(t, _) {
        var e;
        !t && (0, r.w)() ? T.A.showAgeVerificationGetStartedModal({
            ...
            onConfirm: () => {
                d.YX.updateSetting(e), f(e, !1)
            },
            onCancel: () => {
                d.YX.updateSetting(e), d.Zr.updateSetting(e ? C.A.getGuildIds() : []), f(e, !0)
            }
        }))
    }
    return (0, E.jsx)(s.h, {
        setting: o.H.PRIVACY_SERVER_SPECIFIC_PRIVACY_MESSAGE_REQUESTS_V2,
        children: "0" === e ? (0, E.jsx)(V.Ay, {
