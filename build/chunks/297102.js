/** chunk id: 297102 params = (module,exports,require) **/
i.d(e, {
    default: () => T
}), i(321073);
var n = i(627968),
...
let T = function(t) {
    let {
        ...
        isRetry: !0
    }), h = s.useMemo(() => (0, r.A)(), []), b = (0, g.I)("age_verification_retry_modal"), L = R.intl.string(R.t.JSdbBe), k = R.intl.string(R.t.JNK1ue), M = R.intl.string(R.t.mFvt9M);
    s.useEffect(() => {
        ...
        children: (0, n.jsxs)(o.BJc, {
            ...
            children: [(0, n.jsx)(o.po8, {
                ...
                children: R.intl.format(R.t["L+FgkZ"], {
                    handleOnHelpUrlHook: () => {
                        u.A.openUrl(d.A.getArticleURL(m.MVz.TIGGER_PAWTECT_LEARN_MORE)), (0, c.St)(h, c.WU.RETRY, c._7.LEARN_MORE)
                    }
                })
            })]
        })
