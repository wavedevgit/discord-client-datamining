...
function G(e) {
    ...
    }, [R, v, D]), t = l.useRef(v.firstState), n = l.useRef(null), a = !D, l.useEffect(() => {
        if (!a) return;
...
function j(e) {
    let {
        ...
        iconSize: a = 20,
        locked: r = !1
    } = e, s = l.useId(), o = (a - 18) / 2, u = r ? `url(#${s})` : void 0;
    return (0, i.jsx)("span", {
        className: n,
        style: {
            display: "inline-flex",
...
function O(e) {
    let {
        ...
        locked: s = !1
    } = e, c = (0, o.bG)([u.A], () => u.A.useReducedMotion), h = (0, o.bG)([d.A], () => d.A.isConnected()), [f, E] = l.useState(h);
    return (l.useEffect(() => {
        if (h) {
