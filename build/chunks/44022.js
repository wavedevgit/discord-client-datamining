...
function H(e) {
    ...
    }, {}, [r.length]), 0 === r.length) ? (0, s.jsx)(F.g, {}) : (0, s.jsx)(U, {
        savedMessageKeys: r,
        closePopout: t
    })
}
...
function P(e) {
    ...
    n.useEffect(() => (x._.subscribe(k.jej.TOGGLE_FOR_LATER, h), () => void x._.unsubscribe(k.jej.TOGGLE_FOR_LATER, h)), [h]);
