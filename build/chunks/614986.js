...
function D(e) {
    let {
        inviteKey: t,
        transitionTo: n
    } = e, r = (0, l.bG)([m.A], () => m.A.getInvite(t));
    return s.useEffect(() => {
        ...
        onAcceptInvite: e => {
            ...
            }), n = null != r && r.state !== S.elq.EXPIRED && r.state !== S.elq.BANNED ? t : void 0, s = null != (i = p.default.getFingerprint()) ? i : p.default.getId(), l = null != r && r?.type != null ? Number(r?.type) : void 0, d.Ay.openApp(n, void 0, s, void 0, l)
        },
        transitionTo: n
    })
}