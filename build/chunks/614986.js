...
function D(e) {
    ...
    return t?.state === R.elq.BANNED ? (0, i.jsx)(u.N, {
        text: O.intl.string(O.t["5AkWAd"]),
        buttonCta: O.intl.string(O.t["8osdkn"]),
        onClick: n
    }) : (0, i.jsx)(u.N, {
        text: O.intl.string(O.t["usP+Mb"]),
        buttonCta: O.intl.string(O.t["8osdkn"]),
        onClick: n
    })
}
...
function M(e) {
    ...
    return s.useEffect(() => {
        ...
        onAcceptInvite: e => {
            let n, i, s, l;
            e?.preventDefault(), E.default.track(R.HAw.INVITE_APP_OPENED, {
