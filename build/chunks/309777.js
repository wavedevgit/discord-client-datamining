...
function L(e) {
    let {
        ...
        isTemporary: _,
        setIsTemporary: K
    } = (0, E.T)(), B = (0, o.h)(t.applicationId), F = (0, i.bG)([b.A], () => b.A.isClipExporting(t.id)), {
        onShareClick: X
    } = (0, N.A)(L), Y = (0, i.bG)([x.A], () => x.A.isDeveloper), Q = (0, A.h)(t), q = a.useCallback(async () => {
        await (0, y.w7)(t.id), K(!1)
    }, [t.id, K]), W = (0, i.yK)([f.default], () => t.users.map(f.default.getUser).filter(j.Vq)), Z = (0, i.bG)([g.A], () => t.version >= 3 && null != t.guildId ? g.A.getGuild(t.guildId) : null), J = (0, i.bG)([p.A], () => t.version >= 3 && null != t.channelId ? p.A.getChannel(t.channelId) : null), ee = (0, c.Ay)(J), et = null != J ? (0, u.gU)(J, Z) : null;
    return (0, n.jsxs)("div", {
        className: w.XV,
        children: [(0, n.jsxs)("div", {
            ...
            children: (0, n.jsxs)(r.nVY, {
                ...
                }), t.version >= 3 && null != t.activity && (null != t.activity.state || null != t.activity.details) && (0, n.jsx)(r.D0$, {
