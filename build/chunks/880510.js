/** chunk id: 880510 params = (module,exports,require) **/
n.d(t, {
    default: () => m
});
var l = n(627968),
...
function C(e) {
    ...
    return t = x === A.TBI.PUSH_TO_TALK ? (0, l.jsxs)(o.BJc, {
        gap: 20,
        children: [(0, l.jsx)(o.D0$, {
            label: V.intl.string(V.t.YkDjVM),
            children: (0, l.jsx)(r.A, {
                defaultValue: C,
                onChange: e => d.A.setMode(x, {
                    shortcut: e
                }, n)
            })
        }), (0, l.jsx)(o.Apm, {
        ...
        threshold: m,
        autoThreshold: j,
        onThresholdChange: (e, t) => d.A.setMode(x, {
            threshold: e,
            autoThreshold: t
        }, n)
    }), (0, l.jsxs)(o.BJc, {
...
function m(e) {
    return (0, p.A)(() => {
        ...
        onClose: e.onClose,
        children: (0, l.jsx)(C, {
            mediaEngineContext: e.mediaEngineContext ?? c.x.DEFAULT
        })
    })
}