...
function I(e) {
    ...
    let {
        primaryColor: R,
        secondaryColor: P
    } = (0, h.A)(T ?? I), w = `linear-gradient(45deg, ${R}, ${P})`, D = (0, u.bG)([m.A], () => m.A.useReducedMotion), M = l.useRef(!1), k = (0, d.K)(e => {
    ...
    }, void 0), O = null != I, U = null != v && !1 === D, B = O || U, G = 0 === b ? f.pv : f.$g, F = l.useRef(null), H = l.useCallback(() => {
        let e = F.current;
