...
function I(e) {
    ...
    let {
        primaryColor: R,
        secondaryColor: P
    } = (0, h.A)(T ?? I), M = `linear-gradient(45deg, ${R}, ${P})`, w = (0, u.bG)([m.A], () => m.A.useReducedMotion), D = l.useRef(!1), k = (0, d.K)(e => {
    ...
    }, void 0), O = null != I, U = null != v && !1 === w, B = O || U, G = 0 === b ? f.pv : f.$g, F = l.useRef(null), H = l.useCallback(() => {
        let e = F.current;
