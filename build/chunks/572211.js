...
function E(e) {
    ...
    let {
        primaryColor: R,
        secondaryColor: P
    } = (0, h.A)(T ?? E), w = `linear-gradient(45deg, ${R}, ${P})`, D = (0, u.bG)([m.A], () => m.A.useReducedMotion), M = a.useRef(!1), k = (0, d.K)(e => {
    ...
    }, void 0), O = null != E, U = null != v && !1 === D, B = O || U, G = 0 === b ? f.pv : f.$g, F = a.useRef(null), H = a.useCallback(() => {
        let e = F.current;
