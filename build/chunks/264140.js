...
class ts extends s.PureComponent {
    ...
    renderStreamQualityLiveIndicatorToolbarItem = () => {
        ...
        return e?.type !== e3.lp.STREAM ? null : (0, i.jsx)(K.A, {
    ...
    renderHeaderToolbar = () => {
        ...
        switch (e.type) {
            ...
            case e6.rbe.GROUP_DM:
                if (a.push(this.renderJoinRequestInterviewButtons()), a.push(this.renderClipsEnabledIndicatorToolbarItem()), a.push(this.renderStreamQualityLiveIndicatorToolbarItem()), a.push((0, i.jsx)(ea.A, {
                        channel: e
                    }, "calls")), a.push((0, i.jsx)(en.A, {
                        channel: e
                    }, "pins")), !e.isManaged()) {
                    ...
                    } = this.props, n = tt.intl.string(t ? tt.t.AQAPts : tt.t.Xjlbvs);
                    a.push((0, i.jsx)(eo.Ay, {
                        channel: e,
                        tooltip: n
                    }, "invite"))
                }
            ...
            case e6.rbe.PRIVATE_THREAD:
            case e6.rbe.PUBLIC_THREAD:
                e.isModeratorReportChannel() && a.push((0, i.jsx)(ev.A, {
                    channel: e
                })), null == t || t.isForumLikeChannel() || a.push((0, i.jsx)(ey.A, {
                    channel: t
                }, "browser")), e.isVocalThread() && a.push((0, i.jsx)(ed.A, {
                    channel: e
                }, "thread-call")), a.push((0, i.jsx)(ej.A, {
                    channel: e
    ...
    renderSidebar() {
        ...
        else if (l === e6.YvQ.PROFILE && e.isPrivate() && !r && !a && !c) return (0, i.jsx)(eD.A, {
            channel: e
...
let tl = (0, C.A)(ts),
    tr = s.memo(function(e) {
        let {
            ...
            hasAccess: p
        } = (0, V.TW)("ConnectedChannel"), _ = c && !p ? null : o, f = (0, h.bG)([eV.A], () => eV.A.getChannel(a), [a]), x = _?.parent_id, C = (0, h.bG)([eV.A], () => eV.A.getChannel(x), [x]), b = (0, h.bG)([eF.A], () => eF.A.getGuild(_?.guild_id), [_]), {
        ...
        }, [r]), L = (0, F.A)(), M = (0, h.bG)([eY.A], () => (L?.channelId ?? eY.A.getVoiceChannelId()) === _?.id), D = (0, h.bG)([N.Ay], () => null != _ ? N.Ay.getSelfEmbeddedActivityForChannel(_.id) : null, [_]), G = (0, h.bG)([eW.A], () => eW.A.isConnected()), U = (0, I.A)(G), P = G && !1 === U;
        s.useEffect(() => {
        ...
        let w = (0, h.bG)([N.Ay], () => N.Ay.getCurrentEmbeddedActivity()),
            ...
            ee = (0, h.bG)([R.A, N.Ay], () => null != N.Ay.getConnectedActivityLocation() && N.Ay.getActivityPanelMode() === e2.Gd.PANEL ? N.Ay.getFocusedLayout() === e2.E8.NO_CHAT ? e6.DUB.NO_CHAT : e6.DUB.NORMAL : null != r ? R.A.getLayout(r) : e6.DUB.NORMAL, [r]),
            et = (0, eh.A)(b?.id),
            en = (0, ew.A)(J, b?.id),
            {
                section: ei,
                ...
                section: ek.Ay.getSection(r, _?.isDM()),
