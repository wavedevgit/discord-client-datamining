...
class tt extends s.PureComponent {
    ...
    openUserProfile = () => {
        ...
        o()(e?.isPrivate(), "Missing private channel in Channel.openUserProfile"), (0, eR.openUserProfileModal)({
    ...
    openChannelContextMenu(e, t) {
        ...
        o()(null != t, "Missing channel in Channel.openChannelContextMenu"), o()(null != s, "Missing guild in Channel.openChannelContextMenu"), (0, _.L3)(e, async () => {
            let {
                default: e
    ...
    openThreadContextMenu(e, t) {
        o()(null != t, "Missing channel in Channel.openChannelContextMenu"), (0, _.L3)(e, async () => {
            let {
                default: e
    ...
    renderJoinRequestInterviewButtons = () => {
        ...
        return e?.hasFlag(e0.lx.IS_JOIN_REQUEST_INTERVIEW_CHANNEL) ? (0, i.jsx)(W.A, {
            channelId: e.id,
    ...
    renderHeaderToolbar = () => {
        ...
        switch (e.type) {
            ...
            case e1.rbe.GUILD_VOICE:
                break;
            case e1.rbe.DM:
                r.push(this.renderClipsEnabledIndicatorToolbarItem()), r.push(this.renderStreamQualityLiveIndicatorToolbarItem()), r.push((0, i.jsx)(es.A, {
                    channel: e
                }, "calls")), r.push((0, i.jsx)(Z.A, {
                    channel: e
                }, "pins")), r.push((0, i.jsx)(el.Ay, {
                    channel: e,
                    tooltip: e8.intl.string(e8.t.Xjlbvs)
                }, "invite")), r.push((0, i.jsx)(eo.A, {
                    channel: e,
                    showCallOrActivityPanel: s || l || a
                }, "profile")), r.push((0, i.jsx)(ea.A, {
                    channel: e
                }, "safety_tools"));
                break;
            case e1.rbe.GROUP_DM:
                if (r.push(this.renderJoinRequestInterviewButtons()), r.push(this.renderClipsEnabledIndicatorToolbarItem()), r.push(this.renderStreamQualityLiveIndicatorToolbarItem()), r.push((0, i.jsx)(es.A, {
                        channel: e
                    }, "calls")), r.push((0, i.jsx)(Z.A, {
                        channel: e
                    }, "pins")), !e.isManaged()) {
                    ...
                    } = this.props, n = e8.intl.string(t ? e8.t.AQAPts : e8.t.Xjlbvs);
                    r.push((0, i.jsx)(el.Ay, {
                        channel: e,
                        tooltip: n
                    }, "invite"))
                }
            ...
            case e1.rbe.PRIVATE_THREAD:
            case e1.rbe.PUBLIC_THREAD:
                e.isModeratorReportChannel() && r.push((0, i.jsx)(eb.A, {
                    channel: e
                })), null == t || t.isForumLikeChannel() || r.push((0, i.jsx)(eS.A, {
                    channel: t
                }, "browser")), e.isVocalThread() && r.push((0, i.jsx)(er.A, {
                    channel: e
                }, "thread-call")), r.push((0, i.jsx)(eT.A, {
                    channel: e
                }, "notifications")), r.push((0, i.jsx)(Z.A, {
                    channel: e
                }, "pins")), e.isArchivedThread() || r.push((0, i.jsx)(Q.A, {
                    channelId: e.id
                }, "members")), null != t && (0, E.pk)(e) && r.push((0, i.jsx)(ee.A, {
                    channel: e
                }, "summaries")), r.push((0, i.jsx)(ey.A, {
                    channel: e
                }, "threads-overflow"));
                break;
            case e1.rbe.GUILD_ANNOUNCEMENT:
            case e1.rbe.GUILD_TEXT:
                r.push((0, i.jsx)(eS.A, {
                    channel: e
                }, "browser")), n || r.push((0, i.jsx)($.A, {
                    channel: e
                }, "notifications")), r.push((0, i.jsx)(Z.A, {
                    channel: e
                }, "pins")), r.push((0, i.jsx)(Q.A, {
                    channelId: e.id
                }, "members")), (0, E.pk)(e) && r.push((0, i.jsx)(ee.A, {
                    channel: e
                }, "summaries"));
                break;
            case e1.rbe.GUILD_FORUM:
            case e1.rbe.GUILD_MEDIA:
                n || (r.push((0, i.jsx)(et.A, {
                    channel: e
                }, "forum-onboarding")), r.push((0, i.jsx)($.A, {
                    channel: e
                }, "notifications"))), __OVERLAY__ || r.push((0, i.jsx)(Q.A, {
                    channelId: e.id
                }, "members"));
                break;
    ...
    renderMobileToolbar = () => {
        ...
        switch (e.type) {
            ...
            case e1.rbe.PRIVATE_THREAD:
            case e1.rbe.PUBLIC_THREAD:
                e.isArchivedThread() || t.push((0, i.jsx)(Q.A, {
                    channelId: e.id
                }, "members"));
                break;
            case e1.rbe.GUILD_ANNOUNCEMENT:
    ...
    renderHeaderBar = () => {
        ...
        let p = e.isDM() && !e.isSystemDM() ? this.openUserProfile : h ? () => (0, eg.iN)(e.id) : void 0,
    ...
    renderChat() {
        ...
        if (o()(null != e, "Missing channel in Channel.renderChat"), n) return (o()(null != t, "premium channels must exist within a guild"), e?.isRoleSubscriptionTemplatePreviewChannel()) ? (0, i.jsx)(X.A, {
            guildId: t.id
        }) : (0, i.jsx)(Y.H, {
            guildId: t.id,
        ...
        if (s) return (0, i.jsx)(eL.A, {
            guild: t,
            channelId: e.id
        });
        if (e.isGuildVocal() || l && e.isVocalThread()) return null;
        if (e.isDirectory()) return o()(null != t, "directory channels must exist within a guild"), (0, i.jsx)(P.A, {
            channel: e,
            guild: t
        });
    ...
    renderSidebar() {
        ...
        else if (l === e1.YvQ.PROFILE && e.isPrivate() && !a && !r && !c) return (0, i.jsx)(eO.A, {
            channel: e
        }, `private-channel-profile-${e.id}`);
        else if (l === e1.YvQ.MEMBERS) switch (e.type) {
            case e1.rbe.GROUP_DM:
                return (0, i.jsx)(eA.A, {
                    channel: e
        ...
        } else if (l === e1.YvQ.SEARCH) return (0, i.jsx)(ef.A, {
            guildId: n?.id,
            channelId: e.id
        });
        return null
    ...
    openChannelModal() {
        ...
        return null == e || null == t || r || s || (o && (0, m.mMO)(async () => {
            let {
                default: e
    ...
    renderThreadSidebar() {
        ...
        return c += 375, (0, i.jsx)(eq.A, {
            sidebarType: t?.type != null && e1.kvI.GUILD_THREADS_ONLY.has(t.type) ? eq.X.PostSidebar : eq.X.ThreadSidebar,
            maxWidth: c,
    ...
    render() {
        ...
        if (null == e) return (0, i.jsx)(e$.A, {
            channelId: this.props.channelId
        });
        let p = r === e1.YvQ.SIDEBAR_CHAT,
            m = null != c && !p,
            g = !e.isForumLikeChannel() && !o,
            _ = t?.name;
        return (0, i.jsxs)(i.Fragment, {
            children: [(0, i.jsx)(U.HI, {
                location: _,
                subsection: n ?? void 0
            }), (0, i.jsxs)("div", {
...
let tn = (0, C.A)(tt),
    ti = s.memo(function(e) {
        let {
            providedChannel: t
        } = e, [n, l] = s.useState(null), a = (0, h.bG)([eF.A], () => eF.A.getChannelId()), r = (0, h.bG)([eF.A], () => eF.A.getVoiceChannelId()), o = (0, h.bG)([eP.A], () => t ?? eP.A.getChannel(a), [a, t]), c = (0, h.bG)([eP.A], () => eP.A.getChannel(r), [r]), m = o?.parent_id, _ = (0, h.bG)([eP.A], () => eP.A.getChannel(m), [m]), f = (0, h.bG)([eV.A], () => eV.A.getGuild(o?.guild_id), [o]), {
            needSubscriptionToAccess: x
        } = (0, z.A)(o?.id ?? void 0), C = (0, h.bG)([R.A], () => {
            let e = null != a ? R.A.getParticipants(a) : [],
                t = null != a ? R.A.getActivityParticipants(a) : [];
            return e.length - t.length > 0
        }, [a]), b = (0, B.A)(), v = (0, h.bG)([eF.A], () => (b?.channelId ?? eF.A.getVoiceChannelId()) === o?.id), O = (0, h.bG)([N.Ay], () => null != o ? N.Ay.getSelfEmbeddedActivityForChannel(o.id) : null, [o]), L = (0, h.bG)([eH.A], () => eH.A.isConnected()), M = (0, I.A)(L), D = L && !1 === M;
        s.useEffect(() => {
            v && D && null != O && null != o && g.A.selectParticipant(o.id, (0, j.Qt)({
        ...
        let G = (0, h.bG)([N.Ay], () => N.Ay.getCurrentEmbeddedActivity()),
            ...
            q = (0, h.bG)([R.A, N.Ay], () => null != N.Ay.getConnectedActivityLocation() && N.Ay.getActivityPanelMode() === e9.Gd.PANEL ? N.Ay.getFocusedLayout() === e9.E8.NO_CHAT ? e1.DUB.NO_CHAT : e1.DUB.NORMAL : null != a ? R.A.getLayout(a) : e1.DUB.NORMAL, [a]),
            ...
            ee = (0, eG.A)(W, f?.id),
            {
                ...
                section: eU.Ay.getSection(a, o?.isDM()),
                channelSidebarState: eU.Ay.getSidebarState(a)
            }), [a, o]),
            ei = f?.id,
        ...
        s.useEffect(() => {
            let e = eC && !ex,
                t = eC && ex && o?.id !== eI;
            (e || t) && (0, w.Dr)(A.M.ACTIVITY_GDM_CALL_TOOLTIP, {
        ...
        return (0, i.jsx)(tn, {
            ...
            ...(0, h.cf)([eY.A], () => ({
                hasVideo: null != o && eY.A.hasVideo(o.id)
            }), [o]),
            inCall: eA,
