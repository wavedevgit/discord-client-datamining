...
class tn extends s.PureComponent {
        ...
        switch (e.type) {
            ...
            case e9.rbe.PUBLIC_THREAD:
                e.isModeratorReportChannel() && a.push((0, i.jsx)(eT.A, {
                    ...
                    channelId: e.id
                }, "members")), null != t && (0, C.pk)(e) && a.push((0, i.jsx)(ei.A, {
                    channel: e
            ...
            case e9.rbe.GUILD_TEXT:
                a.push((0, i.jsx)(ev.A, {
                    ...
                    channelId: e.id
                }, "members")), (0, C.pk)(e) && a.push((0, i.jsx)(ei.A, {
                    channel: e
                }, "summaries"));
                break;
            case e9.rbe.GUILD_FORUM:
    ...
    openChannelModal() {
        ...
        return null == e || null == t || a || s || (o && (0, _.mMO)(async () => {
            let {
                default: e
...
let ti = (0, E.A)(tn),
    ts = s.memo(function(e) {
        let {
            providedChannel: t
        } = e, [n, l] = s.useState(null), r = (0, h.bG)([eW.A], () => eW.A.getChannelId()), a = (0, h.bG)([eW.A], () => eW.A.getVoiceChannelId()), o = (0, h.bG)([ek.A], () => t ?? ek.A.getChannel(r), [r, t]), c = (0, B.DZ)(), _ = (0, B.e4)(o, "ConnectedChannel"), g = (0, h.bG)([ek.A], () => ek.A.getChannel(a), [a]), f = _?.parent_id, x = (0, h.bG)([ek.A], () => ek.A.getChannel(f), [f]), E = (0, h.bG)([eH.A], () => eH.A.getGuild(_?.guild_id), [_]), {
            needSubscriptionToAccess: b
        } = (0, J.A)(_?.id ?? void 0), y = (0, h.bG)([R.A], () => {
            let e = null != r ? R.A.getParticipants(r) : [],
                t = null != r ? R.A.getActivityParticipants(r) : [];
            return e.length - t.length > 0
        }, [r]), O = (0, K.A)(), L = (0, h.bG)([eW.A], () => (O?.channelId ?? eW.A.getVoiceChannelId()) === _?.id), M = (0, h.bG)([N.Ay], () => null != _ ? N.Ay.getSelfEmbeddedActivityForChannel(_.id) : null, [_]), D = (0, h.bG)([eK.A], () => eK.A.isConnected()), G = (0, I.A)(D), U = D && !1 === G;
        s.useEffect(() => {
