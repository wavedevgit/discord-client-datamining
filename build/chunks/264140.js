...
class tt extends s.PureComponent {
    ...
    openChannelModal() {
        ...
        return null == e || null == t || a || s || (o && (0, g.mMO)(async () => {
            let {
                default: e
...
let tn = (0, C.A)(tt),
    ti = s.memo(function(e) {
        ...
        let G = (0, h.bG)([b.Ay], () => b.Ay.getCurrentEmbeddedActivity()),
            ...
            q = (0, h.bG)([R.A, b.Ay], () => null != b.Ay.getConnectedActivityLocation() && b.Ay.getActivityPanelMode() === e9.Gd.PANEL ? b.Ay.getFocusedLayout() === e9.E8.NO_CHAT ? e1.DUB.NO_CHAT : e1.DUB.NORMAL : null != r ? R.A.getLayout(r) : e1.DUB.NORMAL, [r]),
