...
class tl extends l.PureComponent {
    ...
    openChannelContextMenu(e, t) {
        ...
        o()(null != t, "Missing channel in Channel.openChannelContextMenu"), o()(null != l, "Missing guild in Channel.openChannelContextMenu"), (0, g.L3)(e, async () => {
            let {
                default: e
    ...
    renderSidebar() {
        ...
        } else if (s === e6.YvQ.SEARCH) return (0, i.jsx)(ex.A, {
            guildId: n?.id,
            channelId: e.id
        });
        return null
