...
function u(e) {
    let t = (0, a.bG)([r.A], () => r.A.getLinkedUsers());
...
let _ = e => {
    let t = u(e);
    return (0, a.yK)([i.default], () => t.map(e => i.default.getUser(e))).filter(e => null != e)
};
...
function g() {
    let e = (0, a.bG)([r.A], () => r.A.getLinkedUsers());
    return l.useMemo(() => Object.values(e).some(e => null != e && e.link_status === c.Ef.ACTIVE && e.link_type === c.QM.PARENT), [e])
}

function h() {
    let e = (0, a.bG)([r.A], () => r.A.getLinkCode()),
        t = (0, a.bG)([i.default], () => i.default.getCurrentUser());
...
function b() {
    let e = (0, a.bG)([i.default], () => i.default.getCurrentUser()),
        t = (0, a.bG)([r.A], () => r.A.getLinkedUsers());
...
function f(e) {
    let t = (0, o.k)(),
        n = (0, a.bG)([r.A], () => null == t ? null : r.A.getRangeStartTimestamp());
    return null == n ? null : (0, s.i6)(new Date(n).getTime(), () => e, 7)
}

function T(e, t) {
    let n = (0, a.bG)([r.A], () => r.A.getLinkTimestamp(e));
