...
let f = {
    ...
    S = s.memo(function(e) {
        ...
        }, [w, y, N]), M = s.useMemo(() => 0 === R.length ? (0, p.uc)(m.Ub) : R.reduce((e, t) => e + t.height, 0) + (N ? y * (R.length - 1) : 0), [R, N, y]), L = s.useMemo(() => 0 === R.length ? m.Ub : R.reduce((e, t) => e + t.width, 0) + (N ? 0 : y * (R.length - 1)), [R, N, y]), z = (0, o.pnh)(R, {
            key: e => e.key,
            from: {
                height: 0,
                opacity: 0
