/** chunk id: 69747 params = (module,exports,require) **/
i.d(t, {
    A: () => s
}), i(321073);
var l = i(837921),
...
class s {
            ...
            if (e.Events?.length > 0) {
                if (this.isFirstPoll) this.isFirstPoll = !1;
                    ...
                    for (let t of e.Events) {
                        ...
                        } else if ("Multikill" === t.EventName) e = {
                            type: "Multikill",
                            timestamp: this.gameTime,
            ...
            switch (e.type) {
                case "ChampionKill":
                    if (e.playerIsKiller) return {
                        ...
                        description: a.intl.formatToPlainString(a.t["2sxvfW"], {
                            name: e.victimName
                        })
                    };
                    if (e.playerIsAssister) return {
                        ...
                        importance: .5,
                        title: a.intl.string(a.t.ky6syM),
                        description: a.intl.formatToPlainString(a.t.NyJvKf, {
                            name: e.victimName
                        })
                    };
                    if (e.victimIsActivePlayer) return {
                        ...
                        importance: .5,
                        title: a.intl.string(a.t.ky6syM),
                        description: a.intl.formatToPlainString(a.t["wZ/IFO"], {
                            name: e.killerName
                        })
                    };
                    return null;
                    ...
                    if (e.killerIsActivePlayer) {
                        let {
                            ...
                            switch (e.killStreak) {
                                case 2:
                                    return {
                                        title: a.intl.string(a.t["+K7bbR"]), description: a.intl.string(a.t["+zq0aZ"])
                                    };
                                case 3:
                                    return {
                                        title: a.intl.string(a.t.fzI1wr), description: a.intl.string(a.t.brXPUX)
                                    };
                                case 4:
                                    return {
                                        title: a.intl.string(a.t.ntn0Eu), description: a.intl.string(a.t.GcWpwl)
                                    };
                                case 5:
                                    return {
                                        title: a.intl.string(a.t.JMxzCr), description: a.intl.string(a.t["9yXGOS"])
                                    };
                                default:
                                    return {
                ...
                case "LevelUp":
                    return {
                        type: r.Gy.GAME_EVENT, eventType: r.rb.LEVEL_UP, importance: 0, title: a.intl.string(a.t["cp+kpc"]), description: a.intl.formatToPlainString(a.t["le5/P1"], {
                            level: e.newLevel
                        })
                    };
                case "ItemPurchase":
                    return {
                        type: r.Gy.GAME_EVENT, eventType: r.rb.ITEM, importance: 0, title: a.intl.string(a.t["89CDAj"]), description: a.intl.formatToPlainString(a.t.cpRNkD, {
                            itemName: e.itemName
                        })
                    };
                case "TurretKill":
                ...
                case "DragonKill":
                    if (e.stolen) return {
                        ...
                        eventType: r.rb.OBJECTIVE_KILL,
                        importance: 1,
                        title: a.intl.formatToPlainString(a.t.DUQK8U, {
                            drakeName: e.drakeName
                        }),
                        description: a.intl.formatToPlainString(a.t["8qsedd"], {
                    ...
                    if (e.playerHelpedKill) return {
                        ...
                        eventType: r.rb.OBJECTIVE_KILL,
                        importance: .5,
                        title: a.intl.formatToPlainString(a.t["AjNN1/"], {
                            drakeName: e.drakeName
                        }),
                        description: a.intl.formatToPlainString(a.t.HlopAO, {
                            killerName: e.killerName
                        })
                    };
                    return null;
                case "BaronKill":
                    if (e.stolen) return {
                        ...
                        description: a.intl.formatToPlainString(a.t.FUBbYu, {
                            killerName: e.killerName
                        })
                    };
                    if (e.playerHelpedKill) return {
                        ...
                        description: a.intl.formatToPlainString(a.t["4yYLUi"], {
                            killerName: e.killerName
                        })
                    };
                    return null;
    ...
    async pollPlayerState() {
        if (null != this.activePlayerRiotId) try {
            let [e, t] = await Promise.all([n("activeplayer"), n("playeritems", {
                riotId: this.activePlayerRiotId
            })]), i = new Map;
            if (Array.isArray(t))
                for (let e of t) i.set(e.itemID, e);
            let l = {
                level: e.level ?? 1,
                currentGold: e.currentGold ?? 0,
                items: i
            };
            this.gameTime += 1, null != this.previousPlayerState && this.detectStateChanges(this.previousPlayerState, l), this.previousPlayerState = l
        } catch (e) {}
    }
    ...
    async fetchActivePlayer() {
        try {
            ...
            if (null != e.riotId) return this.activePlayerRiotId = e.riotId, this.activePlayerName = e.riotIdGameName ?? "", !0;
            return !1
        } catch (e) {
            return !1
        }
