/** chunk id: 612479, original params: e,a,t (module,exports,require) **/
t.d(a, {
    A: () => R
});
var l = t(627968),
...
function R(e) {
    ...
    } = e, P = (0, b.A)(R), [H, k] = n.useState(!1), [B, X] = n.useState(V), [y, Y] = n.useState(null), [K, q] = n.useState(s().shuffle(R)), [w, Q] = n.useState(""), z = (0, c.GV)(), Z = (0, u.A)(B), W = (0, u.A)(H), J = (0, u.A)(y), $ = (0, u.A)(p), ee = (0, u.A)(w), ea = null;
    return null == B ? ea = "RATING" : B !== g.P0.GOOD && null == y ? ea = "PROBLEM" : null != y && j.includes(y.value) && (ea = "FREEFORM"), n.useEffect(() => {
        s().isEqual(P, R) || q((0, U.ed)(R, T))
    }, [R, P, T]), (0, O.Ay)(() => (N.default.track(S.HAw.OPEN_MODAL, {
        type: a,
        ...
        }), ("RATING" === ea || "PROBLEM" === ea && null == I) && (0, l.jsx)("div", {
        ...
        }), ("FREEFORM" === ea || "PROBLEM" === ea && null != I) && (0, l.jsx)(E.jlY, {
            "data-migration-pending": !0,
            className: _.qr,
            direction: v.A.Direction.HORIZONTAL,
