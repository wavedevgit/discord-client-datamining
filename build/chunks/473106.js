        ...
        return (0, a.jsx)(P.dZ, {
            children: (0, a.jsxs)(p.BJc, {
                ...
                children: [(0, a.jsx)(p.Text, {
                    ...
                    children: "PaymentModal Step within PaymentContext loaded. Click below to navigate to a mock error step that will throw — the CheckoutErrorBoundary baked into PaymentContextProvider will catch it."
                }), (0, a.jsx)(p.Button, {
                    variant: "primary",
...
function $(e) {
    let {
        errorType: t = "mock-error"
    } = e;
    if ("mock-error" === t) throw Error("Simulated error thrown inside a payment step");
    return "translation-key-error" === t ? (0, a.jsx)("div", {
        children: V.intl.format(U.default.cRB332, {
            avatar: (0, a.jsx)("div", {
                children: "Sample Avatar"
            }),
            nickname: (0, a.jsx)("div", {
                children: "Sample Nickname"
            }),
            username: (0, a.jsx)("div", {
                children: "Sample Username"
            })
        })
    }) : (0, a.jsx)("div", {
        children: "Unknown error type"
    })
}
let Y = {
    title: "Checkout",
    stories: [{
                        ...
                        children: [(0, a.jsxs)(p.BJc, {
                            ...
                            children: [(0, a.jsxs)(p.BJc, {
                                ...
                                children: [(0, a.jsx)(p.Text, {
                                    ...
                                    className: G.wG,
                                    children: (0, a.jsx)(p.y$y, {
                                        type: p.tVU.SPINNING_CIRCLE
                                    })
                                }) : (0, a.jsxs)("div", {
                                    className: G.dB,
            ...
            return (0, a.jsx)(x.f5, {
                ...
                children: (0, a.jsxs)(p.BJc, {
                    ...
                    children: [(0, a.jsxs)(p.Text, {
                        ...
                        children: ["Opens a ", "<PaymentModal>", " with a step that throws to verify ", "<CheckoutErrorBoundary>", " catches it and logs to Sentry with checkout context."]
                    }), (0, a.jsx)(p.Button, {
                        variant: "primary",
        ...
        controls: {
            errorBoundaryVariant: {
                ...
                type: "select",
                options: [{
                    label: "Crash Client (Default Behavior)",
                    value: "crash-client"
                }, {
                    label: "Show Alert",
                    value: "show-alert"
            ...
            errorType: {
                ...
                options: [{
                    ...
                    label: "Translation Key Error",
                    value: "translation-key-error"
                }],
