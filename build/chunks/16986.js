            ...
            children: [(0, i.jsx)(g.x, {
                ...
                children: (0, i.jsxs)(l.nVY, {
                    ...
                    children: [(0, i.jsx)(g.x, {
                        ...
                        children: (0, i.jsx)(l.dOG, {
                            checked: R,
                            description: f.intl.formatToPlainString(f.t.qjjvqO, {
                                maxSize: 10
                            }),
                        ...
                        children: (0, i.jsx)(l.dOG, {
                            ...
                            onChange: e => {
                                x.default.track(S.HAw.STICKERS_IN_AUTOCOMPLETE_TOGGLED, {
                                    enabled: e,
                                    location: {
                                        section: S.JJy.SETTINGS_TEXT_AND_IMAGES
                                    },
                                    location_stack: V
                ...
                children: [(0, i.jsx)(l.cGx, {}), (0, i.jsx)(l.z6M, {
                    ...
                    options: [{
                        name: f.intl.string(f.t["KFH/me"]),
                        value: S.P6Q.ON_CLICK
                    }, {
                        name: f.intl.string(f.t.K5VTBE),
                        value: S.P6Q.IF_MODERATOR
                    }, {
                        name: f.intl.string(f.t.Pe1RbL),
                        value: S.P6Q.ALWAYS
                    }],
