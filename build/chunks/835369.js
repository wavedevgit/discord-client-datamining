/** chunk id: 835369 params = (module,exports,require) **/
s.d(t, {
    $k: () => eg,
    Ay: () => ed,
    Co: () => er,
    ...
    ed = l.memo(function(e) {
        let {
            ...
            let {
                threadId: t,
                overrideMedia: s
            } = e, n = (0, m.bG)([H.A], () => H.A.getChannel(t));
            ...
            ref: T,
            height: b
        } = (0, p.Ay)(), F = (0, X.kU)(e => e.setCardHeight, u.x);
        l.useEffect(() => {
            null != b && F(t, b)
        }, [b, F, t]), l.useEffect(() => {
            a?.(T.current, t)
        ...
        return (0, n.jsxs)("div", {
            ...
            }), C?.blocked || null == v ? null : (0, n.jsx)(eS, {
                channel: g,
                firstMedia: v
            })]
        })
...
let eh = l.memo(function(e) {
    ...
    })), c = (0, m.bG)([$.A], () => $.A.isLoading(s.id)), u = (0, m.bG)([U.A], () => U.A.can(es.xBc.MANAGE_MESSAGES, s)), h = R.gs.useSetting(), g = null;
    if (o) g = (0, n.jsx)(A.Text, {
        ...
        g = null != s ? (0, n.jsx)(A.Text, {
            variant: "text-sm/semibold",
            color: r ? "text-default" : "text-muted",
            children: s
        }) : a ? null : (0, n.jsx)(A.Text, {
            tag: "span",
            variant: "text-sm/medium",
            color: r ? "text-default" : "text-muted",
            className: ea.BK,
...
function em(e) {
    let {
        ...
        facepileRef: s,
        firstMessage: l
    } = e, a = (0, b.m)(t.id), i = l?.reactions != null && l.reactions.length > 0;
    return (0, n.jsxs)("div", {
        className: ea.qr,
        children: [i || null == l ? null : (0, n.jsx)(ex, {
            firstMessage: l,
            channel: t
        }), null == l ? null : (0, n.jsx)(eA, {
            firstMessage: l,
            channel: t
        }), (0, n.jsx)(eg, {
            channel: t,
...
function eg(e) {
    ...
    return (0, n.jsxs)("div", {
        ...
        children: [(0, n.jsx)("span", {
            className: ea.SZ,
            children: (0, n.jsx)(A.oyn, {
                size: "custom",
                color: "currentColor",
                width: s,
                height: s
            })
        }), "number" == typeof a ? (0, n.jsx)(T.A, {
            value: a,
            digitWidth: 9,
            className: ea.gv
        }) : (0, n.jsx)("div", {
...
function ex(e) {
    let {
        firstMessage: t,
        channel: s
    } = e, l = (0, m.bG)([H.A], () => H.A.getChannel(s.parent_id)), a = (0, q.Ck)(l), {
        disableReactionCreates: i,
        isLurking: r,
        isPendingMember: o
    } = (0, w.A)(s);
    return null == a || i ? null : (0, n.jsx)(O.qT, {
        className: ea.vC,
        message: t,
...
function eA(e) {
    ...
    return null == l ? null : (0, n.jsx)(O.qT, {
        className: ea.vC,
        message: t,
...
function ef(e) {
    let {
        ...
        sortOrder: s
    } = (0, W.R)(t.parent_id), l = (0, q.Mw)(t, s), a = t.threadMetadata?.createTimestamp, i = null == a ? null : el.intl.formatToPlainString(el.t["13euCd"], {
        timestamp: (0, B.i$)(c()(a), "LLLL")
    });
    return (0, n.jsx)(x.m, {
        text: i,
...
function eC(e) {
    ...
    } = e, r = (0, m.bG)([z.A], () => z.A.isFocused()), o = (0, _.ge)(t.src), d = R.kt.useSetting(), c = (0, M.rx)(l), {
        src: u,
        width: h,
        height: g,
        alt: x
    ...
    }) : u.startsWith("data:") ? (0, n.jsx)(A._V3, {
        src: u,
        width: h,
        height: g,
        minWidth: eo,
...
function eS(e) {
    ...
    return (0, n.jsx)(A.M1G, {
        ...
        children: (0, n.jsxs)("div", {
            className: ea.pV,
            onClick: function(e) {
                e.stopPropagation(), i && (e.preventDefault(), e.nativeEvent.stopImmediatePropagation(), v.A.showAgeVerificationGetStartedModal({
                    entryPoint: j.q1.FORUM_POST_MEDIA_PREVIEW
                }))
            },
            children: [(0, n.jsx)(eC, {
                firstMedia: s,
