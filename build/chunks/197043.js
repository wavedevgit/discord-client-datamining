...
function g(e) {
    ...
    return (t = b?.id ?? null, n = a.useRef(new Set), g = (0, r.bG)([u.A], () => null != t ? u.A.getMessages(t) : null, [t]), A = (0, r.bG)([_.A], () => _.A.can(f.xBc.READ_MESSAGE_HISTORY, b), [b]), x = g?.first() ?? null, I = null != b && null == x && null != g && !g.loadingMore && !g.ready && !g.hasFetched && A, a.useEffect(() => {
