...
let g = 21552 == n.j ? () => {
    let t = (0, a.bG)([E.A], () => E.A.getGuildId(), []),
        ...
        g = (0, s.zy)(),
        O = (0, d.B)(g.pathname, R.BVt.CHANNEL(e?.id, p.VV.GUILD_ONBOARDING))?.isExact === !0;
    ...
    switch (S) {
        case A.B5.SUBMITTED:
            y = h.intl.string(h.t["5iLvSx"]), x = h.intl.string(h.t.mqtdmQ), U = () => {
                (0, o.A)({
            ...
            break;
        case A.B5.REJECTED:
            y = h.intl.string(h.t.lk30cY), x = h.intl.string(h.t["8RrsHr"]), U = () => {
                (0, c.mMO)(async () => {
                    let {
                        default: t
            ...
            break;
        default:
            y = h.intl.string(h.t.G5YKXP), x = h.intl.string(h.t["r8/DT+"]), U = () => {
                (0, T.Ze)(e.id)
            }
    }
    return (0, i.jsxs)("div", {
