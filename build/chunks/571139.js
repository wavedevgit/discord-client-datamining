...
let N = () => {
    ...
    switch (S) {
        case m.B5.SUBMITTED:
            b = x.intl.string(x.t["5iLvSx"]), y = x.intl.string(x.t.mqtdmQ), v = () => {
                (0, o.A)({
            ...
            break;
        case m.B5.REJECTED:
            b = x.intl.string(x.t.lk30cY), y = x.intl.string(x.t["8RrsHr"]), v = () => {
                (0, d.mMO)(async () => {
                    let {
                        default: e
            ...
            break;
        default:
            b = x.intl.string(x.t.G5YKXP), y = x.intl.string(x.t["r8/DT+"]), v = () => {
                (0, _.Ze)(t.id)
            }
    }
    return (0, i.jsxs)("div", {
