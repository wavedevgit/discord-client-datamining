...
let A = {
    init() {
        o.A[u.oD.PRELOADED_USER_SETTINGS] = s.A, o.A[u.oD.FRECENCY_AND_FAVORITES_SETTINGS] = l.A, r.h.subscribe("CONNECTION_OPEN", h), r.h.subscribe("USER_SETTINGS_PROTO_ENQUEUE_UPDATE", _), r.h.subscribe("USER_SETTINGS_PROTO_LOAD_IF_NECESSARY", m), r.h.subscribe("APP_STATE_UPDATE", p)
    }
};
