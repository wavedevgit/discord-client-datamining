...
let A = {
    init() {
        o.A[u.oD.PRELOADED_USER_SETTINGS] = s.A, o.A[u.oD.FRECENCY_AND_FAVORITES_SETTINGS] = r.A, l.h.subscribe("CONNECTION_OPEN", h), l.h.subscribe("USER_SETTINGS_PROTO_ENQUEUE_UPDATE", _), l.h.subscribe("USER_SETTINGS_PROTO_LOAD_IF_NECESSARY", m), l.h.subscribe("APP_STATE_UPDATE", p)
    }
};
