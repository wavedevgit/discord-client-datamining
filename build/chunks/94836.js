...
function I(e) {
    let {
        detectedGame: t,
        trackAction: n
    } = e, [i, r] = l.useState(0), [o, m] = l.useState(null), [h, p] = l.useState(t.artwork), [v, A] = l.useState(t.screenshots), E = l.useRef(null), I = l.useRef(null), N = (0, s.bG)([d.A], () => d.A.useReducedMotion);
    ...
    let S = l.useMemo(() => {
        ...
        G = l.useRef(null),
        M = l.useCallback(() => {
            n(L ? g.Ws.ClickTrailer : g.Ws.ClickImage);
            let e = E.current,
                t = G.current,
                a = null != e && !e.paused,
                l = e?.muted ?? !0,
