...
function s() {
    ...
    return e.delete("page"), (0, i.jsxs)(r.dO, {
        children: [null != n && null == t ? (0, i.jsx)(r.rd, {
            ...
            path: a.BVt.APPLICATION_DIRECTORY_PROFILE_SECTION(":applicationId", l.ApplicationDirectoryProfileSections.STORE),
            to: a.BVt.GLOBAL_DISCOVERY_APPS_PROFILE_SECTION(":applicationId", l.GlobalDiscoveryAppsSections.STORE)
        }), (0, i.jsx)(r.rd, {
            path: a.BVt.APPLICATION_DIRECTORY_PROFILE_SECTION(":applicationId", l.ApplicationDirectoryProfileSections.PREMIUM_DEPRECATED),
            to: a.BVt.GLOBAL_DISCOVERY_APPS_PROFILE_SECTION(":applicationId", l.GlobalDiscoveryAppsSections.STORE)
        }), (0, i.jsx)(r.rd, {
