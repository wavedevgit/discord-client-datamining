...
function s() {
    ...
    return e.delete("page"), (0, i.jsxs)(l.dO, {
        children: [null != n && null == t ? (0, i.jsx)(l.rd, {
            ...
            path: r.BVt.APPLICATION_DIRECTORY_PROFILE_SECTION(":applicationId", a.ApplicationDirectoryProfileSections.STORE),
            to: r.BVt.GLOBAL_DISCOVERY_APPS_PROFILE_SECTION(":applicationId", a.GlobalDiscoveryAppsSections.STORE)
        }), (0, i.jsx)(l.rd, {
            path: r.BVt.APPLICATION_DIRECTORY_PROFILE_SECTION(":applicationId", a.ApplicationDirectoryProfileSections.PREMIUM_DEPRECATED),
            to: r.BVt.GLOBAL_DISCOVERY_APPS_PROFILE_SECTION(":applicationId", a.GlobalDiscoveryAppsSections.STORE)
        }), (0, i.jsx)(l.rd, {
