/** Chunk was on web.js **/
/** chunk id: 4382, original params: e,t,n (module,exports,require) **/
"use strict";
n.d(t, {
    PV: () => c,
    ro: () => u,
...
let c = [{
        Icon: r.$yI,
        getText: () => l.intl.formatToPlainString(o.default.eP3Ar7, {
            totalSeats: s.aw
        })
    }, {
        Icon: r.tvc,
    ...
    u = [{
        ...
        Icon: r._Jp,
        getText: () => l.intl.formatToPlainString(o.default.HVCRVf, {
            numBoosts: a.M4
        })
    }, {
        Icon: r.clX,
