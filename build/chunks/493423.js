/** chunk id: 493423 params = (module,exports,require) **/
t.d(a, {
    $: () => h
});
var r = t(457312),
...
function h(e, a) {
    ...
    let [f, b] = (0, m.useState)(!1), A = e.isDisabled || a.isNextVisibleRangeInvalid();
    A && f && (b(!1), a.setFocused(!0));
    let [R, $] = (0, m.useState)(!1), w = e.isDisabled || a.isPreviousVisibleRangeInvalid();
