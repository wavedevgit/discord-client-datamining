/** chunk id: 461715, original params: e,t,n (module,exports,require) **/
"use strict";
n.d(t, {
    $m: () => m,
    CI: () => _,
...
function p(e) {
    ...
    let b = (0, l.et)(c.thumbnail),
        ...
        A = null != g ? s.Ay.getName(c.guild_id, c.channel_id, g) : void 0,
    ...
    let S = h(c.thumbnail) && !O,
        T = (null == (r = c.thumbnail) ? void 0 : r.filename) != null && (null == (a = c.thumbnail) || null == (i = a.filename) ? void 0 : i.startsWith(u._W));
    return {
