/** chunk id: 51444, original params: e,a,t (module,exports,require) **/
t.d(a, {
    default: () => A
});
var l = t(627968),
...
function A(e) {
    ...
    return (0, l.jsxs)(r.W1t, {
        ...
        children: [(0, l.jsx)(r.rXV, {
            ...
            children: [{
                value: g.OSZ.LARGE,
                name: p.intl.string(p.t.YcOxtr)
            }, {
                value: g.OSZ.SMALL,
                name: p.intl.string(p.t.BKIKqx)
            }].map(e => (0, l.jsx)(r.iDA, {
                label: e.name,
                checked: A === e.value,
            ...
            children: [{
                value: g.pwA.ALWAYS,
                name: p.intl.string(p.t.nBmDrT)
            }, {
                value: g.pwA.ONLY_WHILE_SPEAKING,
                name: p.intl.string(p.t["2OvIZY"])
            }, {
                value: g.pwA.NEVER,
                name: p.intl.string(p.t.ekjlPL)
            }].map(e => (0, l.jsx)(r.iDA, {
                label: e.name,
                checked: f === e.value,
