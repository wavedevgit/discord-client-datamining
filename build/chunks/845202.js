/** chunk id: 845202 params = (module,exports,require) **/
n.d(t, {
    A: () => A
});
var l = n(627968),
...
function v(e) {
    ...
    } = r.useContext(E), p = u[s], O = f(p), C = p.disabled || O in b, M = p.disabled || !C && v;
...
let p = e => {
        let {
            ...
            roles: s
        } = r.useContext(E), i = s[t];
        return null == i ? null : (0, l.jsxs)(v, {
            id: `roles-row-${t}`,
            ...
            children: [(0, l.jsx)("div", {
                ...
                children: [(0, l.jsx)(c.Text, {
                    ...
                    children: i.name
                }), i.disabled && null != n ? (0, l.jsx)(c.Text, {
                    color: "text-default",
                    variant: "text-xs/normal",
                    children: n
                }) : null]
    ...
    O = e => {
        let {
            ...
            members: n
        } = r.useContext(E), s = n[t];
        return null == s ? null : (0, l.jsxs)(v, {
            id: `members-row-${t}`,
    ...
    C = e => {
        let {
            ...
            users: s
        } = r.useContext(E), o = s[t];
        return null == o ? null : (0, l.jsxs)(v, {
            id: `users-row-${t}`,
            ...
            children: [(0, l.jsx)(c.euF, {
                ...
                children: [(0, l.jsx)(c.Text, {
                    variant: "text-sm/normal",
                    children: o.name
                }), o.disabled && null != n ? (0, l.jsx)(c.Text, {
                    color: "text-default",
                    variant: "text-xs/normal",
                    children: n
                }) : null]
    ...
    A = {
        ...
        Provider: e => {
            let {
                ...
                getRichTag: h,
                maxPendingRows: m
            } = e, g = r.useRef(null), [R, S] = r.useState({
                section: 0,
                row: -1
            });
            ...
            return (0, l.jsx)(E.Provider, {
                value: {
                    ...
                    onSelectionChange: function(e, t) {
                        ...
                        S(n => n.section === e && n.row === t ? n : {
                            section: e ?? 0,
                            row: t ?? -1
                        }), l && n?.current?.scrollToIndex({
                            section: e ?? 0,
                            row: t ?? 0,
                            padding: 8
                        })
        ...
        renderSection: e => {
            ...
            switch (t) {
                case w.oO.ROLES:
                    return (0, l.jsx)(j, {
                        title: g.intl.string(g.t["LPJmL/"])
                    });
                case w.oO.MEMBERS:
                    return (0, l.jsx)(j, {
                        title: g.intl.string(g.t["9Oq93m"])
                    });
                case w.oO.USERS:
                    return (0, l.jsx)(j, {
                        title: g.intl.string(g.t.nqDUBX)
                    });
                case w.oO.GUILDS:
                    return (0, l.jsx)(j, {
                        title: g.intl.string(g.t["7hB4kg"])
                    });
                default:
                    return null
            }
