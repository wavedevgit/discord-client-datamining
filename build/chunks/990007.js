...
async function v(e, t, n) {
    ...
    if (null != M) a = Number(M);
    else {
        let e = e => (0, _.n)(e, S.gfo.EMBEDDED) && e?.integrationTypesConfig?.[l.b.USER_INSTALL] != null,
            t = A.A.getApplication(c);
        a = e(t) || e(t = E.Ay.createFromServer(await (0, p.TA)(c, U))) ? l.b.USER_INSTALL : l.b.GUILD_INSTALL
    }
    try {
        [s, {
            disclosures: o,
    ...
    if (null != s.integration_type && Object.values(l.b).includes(s.integration_type) && (i = new Map).set(s.integration_type, s), null != b[s.application.id] && (await b[s.application.id].process(), U?.aborted)) throw new T.A({
        errorCode: S.Lw6.UNKNOWN_ERROR
    }, "Request aborted");
    return t({
        clientId: c,
