...
let X = (e, t, n) => {
    ...
    J = async e => {
        ...
        if (L.info("Stripe Elements submit response: ", t), null != t.error) throw L.error("Stripe Elements submit error: ", t.error), Y(t.error, !0);
        return t
    }, $ = async (e, t) => {
        let {
            paymentMethod: n,
...
async function et() {
    ...
    if (o === T.he.CARD || o === T.he.PAYMENT_REQUEST) {
        let t = null != (e = l.current) ? e : void 0,
            n = null != t && o === T.he.PAYMENT_REQUEST ? {
        ...
        let {
            setupIntent: r
        } = X(n.setupIntent, n.error, e => Y(e, !0));
...
async function eo(e, t, n, r) {
    ...
    try {
        return {
            paymentSource: await F(A.kM_.ADYEN, JSON.stringify(o), e, {
...
async function e_() {
    ...
    try {
        ...
        (null == t || o()().diff(t, "hours") >= 1) && (e = I.En.FULL_RESYNC, t = o()());
        let n = await l.Bo.get({
...
async function eT(e) {
    ...
    let {
        ...
        payment_method: c,
        return_url: (0, l.TP)() + A.Rsh.BILLING_POPUP_BRIDGE_CALLBACK_REDIRECT_PREFIX(a.type, null != o ? o : "", "success")
    }, {
        handleActions: !1
    });
    if (null != d) throw W(d);
