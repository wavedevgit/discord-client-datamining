/** Chunk was on web.js **/
/** chunk id: 147426, original params: e,t,n (module,exports,require) **/
"use strict";
n.d(t, {
    CV: () => o,
    E9: () => v,
...
function p(e) {
    let t = e.toLowerCase();
    return void 0 !== c[t] ? c[t] : t.match(/декілька/) ? 2 : t.match(/пів/) ? .5 : t.match(/пар/) ? 2 : "" === t ? 1 : parseFloat(t)
}
...
function E(e) {
    if (/(рік|року|р|р.)/i.test(e) && (e = e.replace(/(рік|року|р|р.)/i, "")), /(до н.е.|до н. е.)/i.test(e)) return -parseInt(e = e.replace(/(до н.е.|до н. е.)/i, ""));
    if (/(н. е.|н.е.)/i.test(e)) return parseInt(e = e.replace(/(н. е.|н.е.)/i, ""));
    let t = parseInt(e);
    return (0, i.D)(t)
}
let y = `(${f})\\s{0,3}(${(0,r.uJ)(d)})`,
    b = RegExp(y, "i"),
    O = (0, r.mb)("(?:(?:близько|приблизно)\\s{0,3})?", y);
