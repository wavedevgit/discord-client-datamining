...
function A(e) {
    let t = (0, a.yK)([c.default], () => e.call?.participants != null ? e.call.participants.map(e => c.default.getUser(e)).filter(e => null != e).filter(t => t.id !== e.author.id) : [], [e.author.id, e.call]),
