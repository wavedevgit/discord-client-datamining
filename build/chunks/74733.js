/** Chunk was on web.js **/
/** chunk id: 74733, original params: e,t,n (module,exports,require) **/
"use strict";
n.d(t, {
    Y: () => a
});
...
class a {
            ...
            t = n => {
                for (; null != n;) {
                    if (this.canSelectItem(n)) {
                        ...
                        (null == s ? void 0 : s.type) === "item" && e.push(n), (null == s ? void 0 : s.hasChildNodes) && (this.allowsCellSelection || "item" !== s.type) && t(null != (a = null == (r = (0, i.ue)((0, i.iQ)(s, this.collection))) ? void 0 : r.key) ? a : null)
                    }
    ...
    constructor(e, t, n) {
        var r;
        this.collection = e, this.state = t, this.allowsCellSelection = null != (r = null == n ? void 0 : n.allowsCellSelection) && r, this._isSelectAll = null, this.layoutDelegate = (null == n ? void 0 : n.layoutDelegate) || null
    }
}