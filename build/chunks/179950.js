/** chunk id: 179950 params = (module,exports,require) **/
r.d(t, {
    default: () => x
});
var n = r(627968),
...
let x = e => {
    let {
        ...
        h()
    }, [h]), j = (0, a.A)(), [m, b] = s.useState(!1), [f, C] = s.useState(!1), p = s.useCallback(() => {
        C(!0), b(!1)
    }, []), {
        disconnectLinkRequest: _,
    ...
    return (0, n.jsxs)(i.dWK, {
        transitionState: x,
        onClose: h,
        children: [f && (0, n.jsx)(i.wx6, {
            type: "critical",
            children: o.intl.string(d.default.krIDdy)
        }), (0, n.jsxs)(i.cwr, {
            children: [(0, n.jsx)(c.A.Header, {
                currentUser: t,
                otherUser: r,
                header: o.intl.formatToPlainString(d.default["NMSTb/"], {
                    isAdult: String(j)
                }),
                icon: (0, n.jsx)(i.PGe, {
                    size: "md",
