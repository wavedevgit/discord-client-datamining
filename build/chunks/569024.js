...
async function H(e, t, n, l) {
    ...
    F(() => {
        ...
        }), N.A.dispatchLazyCache.measure(() => r.h.dispatch(s)), D.verbose(`late lazy cache loaded (ok: true, took: ${performance.now()-i}ms)`), _.addAnalytics({
...
function F(e) {
    ...
    l.Ay.Emitter.batched(() => {
        try {
            ...
            D.warn("Lazy cache has encountered error", e), r.h.dispatch({
                type: "RESET_SOCKET",
                args: {
                    error: e,
                    action: "LazyCache"
...
class Y extends l.Ay.Store {
    ...
    initialize() {
        this.waitFor(S.default, f.A, x.A, b.A), f.A.getSocket().dispatcher.unpauseDispatchQueue()
    }
    hasCache() {
        return !0
    }
    ...
    canWriteCaches(e) {
        return (0, v.wR)() ? j ? (D.log("Not writing cache because caches cleared"), !1) : !!e || (D.log("Not writing cache because never connected"), !1) : (D.log("Not writing cache because not authenticated"), !1)
    }
    async loadCacheAsync(e, t) {
        ...
        try {
            ...
            D.error("clearing cache. exception encountered while loading cache.", e, e.stack), (0, R.A)("cache:exception", e), n(), r.h.dispatch({
                type: "RESET_SOCKET",
                args: {
                    error: e,
