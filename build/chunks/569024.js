...
class q extends s.Ay.Store {
    ...
    canWriteCaches(e) {
        return (0, j.wR)() ? G ? (L.log("Not writing cache because caches cleared"), !1) : !!e || !!H || (L.log("Not writing cache because never connected"), !1) : (L.log("Not writing cache because not authenticated"), !1)
    }
