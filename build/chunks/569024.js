...
async function W(e, t, n) {
    ...
    let d = null != (r = I.A.getGuildId()) ? r : null,
        ...
        m = j.A.fetchGuildCache.measureAsync(() => z(e, n)),
...
async function q(e, t, n, r) {
    ...
    let [i, s, a] = await j.A.fetchLazyCache.measureAsync(() => Promise.all([(0, c.kk)(() => null != e ? l.A.timeAsync("\uD83D\uDCBE", "cache: cache_version", () => p.A.okAsync(e)) : Promise.resolve(!0)), (0, c.kk)(() => null == e || K ? Promise.resolve([]) : l.A.timeAsync("\uD83D\uDCBE", "cache: lazy guilds", () => u.A.getAsync(e))), (0, c.kk)(() => null != e ? l.A.timeAsync("\uD83D\uDCBE", "cache: basic_channels", () => d.A.getAsync(e)) : Promise.resolve({
        all: [],
        stale: [],
        channels: []
