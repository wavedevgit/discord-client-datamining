...
var i, l, s = n(64700),
    ...
    k = n(652215),
    w = n(37411),
    B = ((i = {})[i.Favorite = 0] = "Favorite", i[i.PrivateChannel = 1] = "PrivateChannel", i[i.HighImportanceMentioned = 2] = "HighImportanceMentioned", i[i.LowImportanceMentioned = 3] = "LowImportanceMentioned", i[i.AllMessagesNotifications = 4] = "AllMessagesNotifications", i[i.GuildChannel = 5] = "GuildChannel", i[i.OldChannel = 6] = "OldChannel", i[i.NoNotifications = 7] = "NoNotifications", i[i.ReallyOldChannel = 8] = "ReallyOldChannel", i),
...
class F extends a.EventEmitter {
    ...
    markChannelRead = e => {
        ...
        }), _.A.useReducedMotion && this.deleteChannel(t), this.maybeLoadMore())
    };
    undoMarkChannelRead = () => {
    ...
    toggle = e => {
        ...
        }, T.Sb.FREQUENT_USER_ACTION), this.setState({
...
function K() {
    ...
    let t, n = function() {
        ...
        l = c().uniq(i.map(e => e.guildId)).filter(G.Vq);
    return u.h.dispatch({
        type: "INBOX_OPEN",
        guildIds: l
    }), {
