/** chunk id: 665906 params = (module,exports,require) **/
i.d(n, {
    default: () => x
});
var e = i(627968);
...
function m(t) {
    ...
    return (0, e.jsxs)("div", {
        ...
        children: [(0, e.jsxs)("div", {
            ...
            className: u.cm,
            children: [(0, e.jsx)(s.K0, {
                icon: c.R2l,
                onClick: function() {
                    (0, c.mMO)(async () => {
                        let {
                            default: t
                        } = await i.e("91373").then(i.bind(i, 183036));
                        return i => (0, e.jsx)(t, {
                            ...i,
                            existingTransform: n
                        })
...
function x(t) {
    let {
        transitionState: n,
        onClose: s
    } = t, l = (0, r.bG)([o.A], () => o.A.getTransforms());
    return (0, e.jsx)(a.Modal, {
        ...
        input: (0, e.jsx)("div", {
            className: u.kL,
            children: 0 === l.length ? (0, e.jsx)(c.Text, {
