/** chunk id: 474001 params = (module,exports,require) **/
"use strict";
n.d(t, {
    A: () => _
});
...
let g = Object.freeze({
    ...
    FLYING: {
        DURATION: 500,
        Y_VALUE: -1e3,
        Y_EASING: c.A.Easing.bezier(.46, .01, 1, -.3),
        X_VALUE: 200,
        X_EASING: c.A.Easing.bezier(.65, .05, 1, .25),
        FIRE_COUNT: 10,
...
function x(e, t, n, i) {
    return c.A.sequence(d().times(t, s => c.A.timing(e, {
        toValue: i(s),
        duration: n / t
    })))
}
class h extends l.Component {
    ...
    async hoverAnimate(e) {
        ...
        this.currentAnimation = c.A.parallel([l, s]), await this.currentAnimation?.start(), this.hoverAnimate(e * g.HOVERING.Y_VALUE_MODIFIER)
    }
    createShakeAnimation(e, t, n) {
        return x(this.x, e, t, e => d().random(1, n) * (e % 2 == 0 ? 1 : -1))
    }
    async flyAnimate() {
        let e = c.A.spring(this.y, {
                toValue: g.FALLING.Y_VALUE,
                overshootClamping: !0
            }),
            t = c.A.spring(this.fireScale, {
                toValue: g.FALLING.FIRE_VALUE,
                overshootClamping: !0
            }),
            n = c.A.parallel([e, t]),
            i = c.A.timing(this.y, {
                toValue: g.STAGING.Y_VALUE,
                duration: g.STAGING.DURATION
            }),
            s = this.createShakeAnimation(g.STAGING.SHAKE_COUNT, g.STAGING.DURATION, g.STAGING.SHAKE_INTENSITY),
            l = this.createFireAnimation(g.STAGING.FIRE_COUNT, g.STAGING.DURATION, g.STAGING.FIRE_MIN_INTENSITY, g.STAGING.FIRE_MAX_INTENSITY),
            ...
            u = this.createFireAnimation(g.FLYING.FIRE_COUNT, g.FLYING.DURATION, g.FLYING.FIRE_MIN_INTENSITY, g.FLYING.FIRE_MAX_INTENSITY),
            m = c.A.parallel([a, o, d, u]);
        if (this.currentAnimation = c.A.sequence([n, r, m]), await this.currentAnimation?.start(), !this.isUnmounted) {
            let {
                onFlyingComplete: e
            } = this.props;
            null != e && e()
