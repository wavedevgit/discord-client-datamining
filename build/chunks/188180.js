...
function g(e) {
    ...
    }(E), N = g?.(l), j = i.useMemo(() => null != u ? l ? null : (0, r.jsx)(f.A, {
        badge: u
    }) : null != N ? (0, r.jsx)(p.A, {
        badge: N
    }) : void 0, [l, u, N]);
...
function x(e) {
    ...
    } : t.onClick, E = null != f, A = i.useMemo(() => null != y && E ? (0, r.jsx)(_.A, {
        active: v,
        categories: y,
        visibleContent: n,
        dismissibleBadges: l
    }) : null, [v, y, n, l, E]), S = a ? "li" : "div", b = i.useMemo(() => (0, m.H)(t.key, n, l), [t.key, n, l]);
    return a ? (0, r.jsx)(g, {
        tag: S,
        panelKey: o?.key,
        onClick: x,
