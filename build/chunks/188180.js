...
function g(e) {
    ...
    }(E), N = g?.(l), C = i.useMemo(() => null != c ? l ? null : (0, r.jsx)(m.A, {
        badge: c
    }) : null != N ? (0, r.jsx)(p.A, {
        badge: N
    }) : void 0, [l, c, N]);
...
function x(e) {
    ...
    } : t.onClick, E = null != m, A = i.useMemo(() => null != y && E ? (0, r.jsx)(_.A, {
        active: v,
        categories: y,
        visibleContent: n,
        dismissibleBadges: l
    }) : null, [v, y, n, l, E]), S = a ? "li" : "div", b = i.useMemo(() => (0, f.H)(t.key, n, l), [t.key, n, l]);
    return a ? (0, r.jsx)(g, {
        tag: S,
        panelKey: o?.key,
        onClick: x,
