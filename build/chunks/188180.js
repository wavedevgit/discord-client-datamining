...
function _(e) {
    ...
    }(v), N = _?.(a), S = i.useMemo(() => null != c ? a ? null : (0, r.jsx)(h.A, {
        badge: c
    }) : null != N ? (0, r.jsx)(p.A, {
        badge: N
    }) : void 0, [a, c, N]);
...
function y(e) {
    ...
    } : t.onClick, b = i.useMemo(() => x && null != y ? (0, r.jsx)(g.A, {
        categories: y,
        visibleContent: n,
        dismissibleBadges: a
    }) : null, [x, y, n, a]), A = s ? "li" : "div", j = i.useMemo(() => (0, f.H)(t.key, n, a), [t.key, n, a]);
    return s ? (0, r.jsx)(_, {
        tag: A,
        panelKey: o?.key,
        onClick: v,
