...
function N(e) {
    let {
        ...
        headingColor: b
    } = e, y = (0, o.bG)([m.A], () => m.A.getPremiumTypeSubscription()), M = (0, o.bG)([d.default], () => d.default.getCurrentUser()), U = (0, T.k5)(), L = (0, T.nf)(), G = r === _.PremiumTypes.TIER_0 ? _.pe.TIER_0 : _.pe.TIER_2, C = y?.hasActiveTrial ? M?.premiumType : U ? _.PremiumTypes.TIER_2 : null, O = (0, I.V)(), D = (0, g.O)(), w = O?.subscription_trial;
    if (!j && !t && null != C && r === C && null != y && null != y.planIdFromItems) {
        ...
        return (0, n.jsx)(c.Heading, {
            ...
            color: b,
            className: a()(A.K, P),
            children: s === _.Vk.PREMIUM_TRIAL ? f.intl.format(f.t["2CGBri"], {
                remainingTime: e,
                price: r
            }) : y.planIdFromItems === _.gD.PREMIUM_YEAR_TIER_2 ? f.intl.format(f.t["+qqh6g"], {
                percent: L?.percentage ?? _.Cq,
                regularPrice: r
    ...
    if (!j && !t && i) {
        let e = u.Ay.formatPriceString(u.Ay.getDefaultPrice(r === _.PremiumTypes.TIER_0 ? _.gD.PREMIUM_MONTH_TIER_0 : _.gD.PREMIUM_MONTH_TIER_2), _.WT.MONTH);
        if (s === _.Vk.PREMIUM_TRIAL) return (0, n.jsx)(c.Heading, {
            variant: S,
            color: b,
            className: a()(A.K, P),
        ...
        if (null != D) return (0, n.jsx)(c.Heading, {
            variant: S,
            color: b,
            className: a()(A.K, P),
            children: (0, n.jsx)(h, {
