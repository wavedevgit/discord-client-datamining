...
function v(e) {
    let {
        ...
        headingColor: M
    } = e, b = (0, o.bG)([u.A], () => u.A.getPremiumTypeSubscription()), C = (0, o.bG)([d.default], () => d.default.getCurrentUser()), S = (0, x.k5)(), U = (0, x.nf)(), w = r === h.PremiumTypes.TIER_0 ? h.pe.TIER_0 : h.pe.TIER_2, O = b?.hasActiveTrial ? C?.premiumType : S ? h.PremiumTypes.TIER_2 : null, L = (0, T.V)(), G = (0, g.O)(), D = L?.subscription_trial;
    if (!P && !t && null != O && r === O && null != b && null != b.planIdFromItems) {
        let e = null != b.trialEndsAt ? l()(b?.trialEndsAt).diff(l()(), "d") : 0,
            t = h.hd[b.planIdFromItems],
        ...
        return (0, i.jsx)(c.Heading, {
            ...
            children: s === h.Vk.PREMIUM_TRIAL ? f.intl.format(f.t["2CGBri"], {
                remainingTime: e,
                price: r
            }) : b.planIdFromItems === h.gD.PREMIUM_YEAR_TIER_2 ? f.intl.format(f.t["+qqh6g"], {
                percent: U?.percentage ?? h.Cq,
                regularPrice: r
