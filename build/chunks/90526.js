...
function N(e) {
    let {
        ...
        headingColor: b
    } = e, y = (0, o.bG)([u.A], () => u.A.getPremiumTypeSubscription()), M = (0, o.bG)([d.default], () => d.default.getCurrentUser()), U = (0, T.k5)(), L = (0, T.nf)(), C = r === _.PremiumTypes.TIER_0 ? _.pe.TIER_0 : _.pe.TIER_2, G = y?.hasActiveTrial ? M?.premiumType : U ? _.PremiumTypes.TIER_2 : null, O = (0, x.V)(), D = (0, g.O)(), w = O?.subscription_trial;
    ...
    if (!j && !t && i) {
        let e = m.Ay.formatPriceString(m.Ay.getDefaultPrice(r === _.PremiumTypes.TIER_0 ? _.gD.PREMIUM_MONTH_TIER_0 : _.gD.PREMIUM_MONTH_TIER_2), _.WT.MONTH);
