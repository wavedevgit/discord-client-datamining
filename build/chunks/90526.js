...
function A(e) {
    let {
        ...
        headingColor: M
    } = e, y = (0, o.bG)([m.A], () => m.A.getPremiumTypeSubscription()), L = (0, o.bG)([d.default], () => d.default.getCurrentUser()), b = (0, x.k5)(), w = (0, x.nf)(), S = i === h.PremiumTypes.TIER_0 ? h.pe.TIER_0 : h.pe.TIER_2, H = y?.hasActiveTrial ? L?.premiumType : b ? h.PremiumTypes.TIER_2 : null, U = (0, g.V)(), O = (0, C.O)(), G = U?.subscription_trial;
    if (!R && !t && null != H && i === H && null != y && null != y.planIdFromItems) {
        ...
        return (0, r.jsx)(c.Heading, {
            ...
            color: M,
            className: s()(f.K, P),
            children: a === h.Vk.PREMIUM_TRIAL ? I.intl.format(I.t["2CGBri"], {
                remainingTime: e,
                price: i
            }) : y.planIdFromItems === h.gD.PREMIUM_YEAR_TIER_2 ? I.intl.format(I.t["+qqh6g"], {
    ...
    if (!R && !t && n) {
        let e = u.Ay.formatPriceString(u.Ay.getDefaultPrice(i === h.PremiumTypes.TIER_0 ? h.gD.PREMIUM_MONTH_TIER_0 : h.gD.PREMIUM_MONTH_TIER_2), h.WT.MONTH);
        if (a === h.Vk.PREMIUM_TRIAL) return (0, r.jsx)(c.Heading, {
            variant: E,
            color: M,
            className: s()(f.K, P),
