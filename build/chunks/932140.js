/** chunk id: 932140, original params: e,t,_ (module,exports,require) **/
_.d(t, {
    default: () => u
});
var a = _(627968),
...
function u(e) {
    ...
    return c.useEffect(() => {
        i.default.track(r.HAw.OPEN_MODAL, {
        ...
        problems: [{
            value: "BAD_OUTLINE",
            label: d.intl.string(d.t.pyhS3j)
        }, {
            value: "BACKGROUND_DETECTION_ACCURACY",
            label: d.intl.string(d.t.cymRTb)
        }, {
            value: "FLICKERING",
            label: d.intl.string(d.t.xZ60CB)
        }, {
            value: "BACKGROUND_DETECTION_LAG",
            label: d.intl.string(d.t.DweTcb)
        }, {
            value: "OTHER",
        ...
        onSubmit: function(e) {
            ...
            }), null != n && (c = s?.value ?? null, i.default.track(r.HAw.VIDEO_BACKGROUND_FEEDBACK, {
                ...t,
                reason: c,
                rating: n,
                feedback: m
            }), null != s && (0, o.mMO)(async () => {
                let {
                    default: e
                } = await _.e("37836").then(_.bind(_, 845671));
                return t => (0, a.jsx)(e, {
                    body: d.intl.string(d.t.aHB11f),
                    ...t
                })
            }))
        },
