/** chunk id: 16039 params = (module,exports,require) **/
e.d(n, {
    default: () => o
});
var r = e(627968),
...
let c = t => {
    let {
        duration: n,
        onSelectDuration: e
    } = t, i = (0, s.ny)(), a = i.find(t => t.value === n);
...
function o(t) {
    let {
        ...
        onClose: E,
        transitionState: d
    } = t, [S, _] = i.useState(() => null != n.metadata.durationSeconds && n.metadata.durationSeconds > 0 ? n.metadata.durationSeconds : s.DisableCommunicationDuration.DURATION_60_SEC), N = (0, u.x)(n.type, n, e);
