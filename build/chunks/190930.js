...
var n = a(627968),
    ...
    U = a(985018),
    j = a(584437);
let N = (e, t) => e.type === A.rD.USER ? t || null != f.A.getDMChannelFromUserId(e.record.id) : e.type === A.rD.GROUP_DM || e.record.type !== D.rbe.GUILD_FORUM && e.record.type !== D.rbe.GUILD_MEDIA && x.A.can(D.xBc.VIEW_CHANNEL, e.record) && x.A.can(D.xBc.SEND_MESSAGES, e.record) && x.A.can(D.xBc.ATTACH_FILES, e.record);
...
function H(e) {
    let {
        ...
        transitionState: x,
        ...H
    } = e, O = (0, o.bG)([k.Ay], () => k.Ay.getCurrentEmbeddedActivity());
    (0, h.A)({
    ...
    let [F] = (0, g.A)([t]), G = (0, o.bG)([w.default], () => w.default.getCurrentUser()), [V, W] = i.useState(null), [q, B] = i.useState(null), [Q, Y] = i.useState(!1), [z, J] = i.useState(""), [K, $] = i.useState([]), X = K.length >= 10, {
        results: Z,
        updateSearchText: ee
    } = (0, b.R)({
    ...
    let ea = i.useCallback(async () => {
        ...
        el = i.useCallback(async () => {
            ...
            for (let t of K)
                ...
                u.A.sendMessage(a, null != F ? C.Ay.parse(n, U.intl.formatToPlainString(U.t.jQULqL, {
            ...
            try {
                await Promise.all(K.map(i)), null != F && (0, c.showToast)((0, c.createToast)(U.intl.formatToPlainString(U.t.jQULqL, {
                    applicationName: F.name
                }), c.ToastType.SUCCESS))
            } catch (e) {
        ...
        es = (0, y.s)({
            rowData: Z,
            selectedDestinations: K,
            handleToggleDestination: ei,
            disableSelection: X
        }),
        er = i.useRef(null),
        eo = (0, m.A)("activity-share-moment-modal", er),
        ec = i.useMemo(() => Z.length > 0 ? es : {
            sections: [1],
            sectionHeight: 0,
            renderRow: () => (0, n.jsx)(P, {}),
            rowHeight: 72
        }, [Z, es]);
    return null == q ? (0, n.jsx)(c.y$y, {}) : (0, n.jsx)(s.hD, {
        navigator: eo,
                ...
                return (0, n.jsx)(r.Modal, {
                    ...
                    preview: (0, n.jsxs)(c.BJc, {
                        ...
                        children: [(0, n.jsx)("img", {
                            ...
                            src: q,
                            className: j.o
                        }), K.length >= 10 ? (0, n.jsx)(c.Text, {
                            variant: "text-xs/normal",
                            children: U.intl.format(U.t.mdE9iE, {
                                maxShares: 10
                            })
                        }) : null]
                    }),
                    actions: [...R.Ay.canCopyImage(a) ? [{
