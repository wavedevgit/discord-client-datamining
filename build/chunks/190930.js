/** chunk id: 190930, original params: e,t,i (module,exports,require) **/
i.d(t, {
    default: () => q
});
var n = i(627968),
...
function q(e) {
    let {
        ...
        transitionState: s,
        ...c
    } = e, y = (0, o.bG)([F.Ay], () => F.Ay.getCurrentEmbeddedActivity());
    (0, h.A)({
    ...
    let [S] = (0, f.A)([t]), N = (0, o.bG)([D.default], () => D.default.getCurrentUser()), [v, k] = a.useState(""), [b, R] = a.useState([]), [q, Y] = a.useState(null), [J, Q] = a.useState(null), [W, Z] = a.useState(!1);
    a.useEffect(() => {
        (async () => {
    ...
    let X = (0, o.yK)([x.A, w.A], () => x.A.getInviteSuggestionRows().filter(e => e.type === j.OK.FRIEND || e.type === j.OK.DM || w.A.can(P.xBc.ATTACH_FILES, e.item)));
    a.useEffect(() => {
        (0, A.t)({
            omitUserIds: new Set,
            applicationId: t,
    ...
    }, [t]), a.useEffect(() => (0, A.B)(v), [v]), a.useEffect(() => {
        let e;
        return W && (e = setTimeout(() => {
            Z(!1)
        }, 1e3)), () => {
    ...
    let $ = a.useCallback(async () => {
        ...
        et = a.useCallback(async () => {
            ...
            async function a(a) {
                ...
                g.A.sendMessage(l, null != S ? T.Ay.parse(s, K.intl.formatToPlainString(K.t.jQULqL, {
            ...
            try {
                await Promise.all(l), null != S && (0, u.showToast)((0, u.createToast)(K.intl.formatToPlainString(K.t.jQULqL, {
                    applicationName: S.name
                }), u.ToastType.SUCCESS))
            } catch (e) {
    ...
    return null == J ? (0, n.jsx)(u.y$y, {}) : (0, n.jsx)(d.Modal, {
        transitionState: s,
        onClose: $,
        size: "md",
        ...
        preview: (0, n.jsxs)(u.BJc, {
            ...
            children: [(0, n.jsx)("img", {
                ...
                src: J,
                className: B.oz
            }), b.length >= 10 ? (0, n.jsx)(u.Text, {
                variant: "text-xs/normal",
                children: K.intl.format(K.t.mdE9iE, {
                    maxShares: 10
                })
            }) : null]
        }),
        actions: [...G.Ay.canCopyImage(i) ? [{
            text: W ? K.intl.string(K.t.t5VZ88) : K.intl.string(K.t.tvUqWn),
            onClick: ee,
            variant: "secondary",
            disabled: W
        }] : [], {
            text: K.intl.string(K.t.TXNS7S),
            onClick: et,
            variant: "primary",
            disabled: b.length <= 0
        }],
        ...c,
        children: X.map((e, t) => (0, n.jsxs)(a.Fragment, {
            children: [0 === t ? null : (0, n.jsx)("div", {
                className: B.ek
            }), (0, n.jsx)(z, {
                row: e,
                onClick: () => (() => {
                    if (-1 !== b.findIndex(t => t.id === e.item.id)) R(b.filter(t => t.id !== e.item.id));
                    else {
...
function z(e) {
    ...
    switch (t.type) {
        ...
        case j.OK.FRIEND:
            ...
            }), d = R.Ay.getName(t.item), o = R.Ay.getUserTag(t.item);
            break;
        case j.OK.GROUP_DM: {
            let e = (0, y.Y)(t.item),
