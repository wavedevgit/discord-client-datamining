/** chunk id: 31498, original params: e,t,n (module,exports,require) **/
"use strict";
n.d(t, {
    Ay: () => g,
    Ur: () => m,
...
class g extends r.EventEmitter {
    ...
    onTabOrEnter(e) {
        var t, n;
        if (!this.state.isVisible || (null == (t = this.state.query) ? void 0 : t.typeInfo.selectMode) === c.SB.TAB_ONLY && e) return !1;
    ...
    onMoveSelection(e) {
        ...
        if (e < 0 ? this.props.navigator.focusPreviousItem() : e > 0 && this.props.navigator.focusNextItem(), null != this.state.selectedIndex && (null == (t = this.state.query) ? void 0 : t.type) === c.DB.COMMANDS) {
    ...
    updateResultsDebounced() {
        ...
        this.nextUpdateQueryChanged = this.nextUpdateQueryChanged || e, this.nextUpdateContextChanged = this.nextUpdateContextChanged || t, this.updateTimeout = setTimeout(() => {
            n.updateResults(this.nextUpdateQueryChanged, this.nextUpdateContextChanged), this.nextUpdateQueryChanged = !1, this.nextUpdateContextChanged = !1, this.updateTimeout = void 0
        }, 0)
    }
    updateResults() {
        var e, t, n;
        let r, i, d = arguments.length > 0 && void 0 !== arguments[0] && arguments[0],
        ...
        let {
            ...
            typeInfo: y,
            query: b
        } = m, O = f || d && ((null == (t = this.state.query) ? void 0 : t.queryText) !== b || (null == (n = this.state.query) ? void 0 : n.typeInfo) !== y), v = l.ML.getSetting();
        ...
        N && !this.state.isVisible && (0, a.uA)(E, this.props.channel, S, R), this.setState({
            ...
            selectedIndex: w,
            hadInitialResults: !0,
            isInitialAfterError: !0 !== this.state.hadInitialResults && null != (e = null == r ? void 0 : r[0].error) && e
        })
    }
    shouldShow(e, t, n) {
    ...
    selectResult(e, t, n) {
        ...
        if (e >= d) return !1;
        let p = null == (i = l.onSelect) ? void 0 : i.call(l, {
            results: u,
            index: e,
    ...
    constructor(e) {
        super(), d(this, "props", void 0), d(this, "state", void 0), d(this, "nextUpdateQueryChanged", !1), d(this, "nextUpdateContextChanged", !1), d(this, "updateTimeout", void 0), this.props = e, this.state = m()
    }
}