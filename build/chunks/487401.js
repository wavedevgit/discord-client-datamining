    ...
    constructor(...e) {
        super(...e), ec(this, "_list", null), ec(this, "unreadTopRef", i.createRef()), ec(this, "unreadBottomRef", i.createRef()), ec(this, "state", {
            ...
            let {
                category: b,
                channel: A
            } = m, y = b instanceof L.xu, x = A.record, j = "".concat(t).concat(A.id);
            switch (x.type) {
                ...
                case ei.rbe.GROUP_DM:
                    return (0, l.jsxs)(i.Fragment, {
                        children: [(0, l.jsx)($.A, {
                            ...
                            selectedVoiceChannelId: (null == o ? void 0 : o.parent_id) === x.id ? c : null
                        }) : null]
                    }, j);
...
let eg = e => {
    ...
    } = (0, b.Ay)(m.A.GUILD_CHANNEL_LIST), d = (0, u.bG)([P.A], () => P.A.getChannel(n)), h = (0, u.bG)([P.A], () => P.A.getChannel(r)), p = (0, u.bG)([D.A], () => D.A.getGuildId()), A = (0, j.jN)(t), y = i.useRef(null), O = i.useCallback((e, t) => {
        let n = y.current;
        if (null != n)
