...
let ec = e => {
    ...
    } = (0, g.Ay)(p.A.GUILD_CHANNEL_LIST), u = (0, c.bG)([j.A], () => j.A.getChannel(n)), m = (0, c.bG)([j.A], () => j.A.getChannel(l)), _ = (0, c.bG)([L.A], () => L.A.getGuildId()), f = (0, C.jN)(t), x = s.useRef(null), E = s.useCallback((e, t) => {
        let n = x.current;
