...
class eu extends s.PureComponent {
        ...
        if (null != l && null != s)
            if (null != l.threadOffset) {
                let [e] = s.getScrollPosition(l.section, l.row), {
                    density: r = "default"
                } = this.props, a = l.threadOffset * ed(r);
    ...
    isUnreadVisible() {
        ...
        return null != t && t.getItems().some(n => {
            ...
            return !!(0, O.ig)(r.record.type) && (!a.isCollapsed || !a.isMuted) && !r.isMuted && !!t.isItemVisible(i, s, !0) && (0, v.Y)(r.record)
        })
    }
    ...
    getRowHeight = (e, t) => {
        ...
        if (e === U.PU) {
            ...
            return e.isEmpty() ? 0 : e.getRow(t) === el.n.GUILD_PREMIUM_PROGRESS_BAR ? e.getRows().length > 1 ? 69 : 57 : a
        }
    ...
    renderRow = e => {
        ...
        if (t === U.PU) {
            ...
            switch (t) {
                ...
                case el.n.GUILD_MOD_DASH_MEMBER_SAFETY:
                    return (0, i.jsx)(x.A, {
                        guild: l,
                        selected: a === ea.VV.MEMBER_SAFETY
                    }, el.n.GUILD_MOD_DASH_MEMBER_SAFETY);
                case el.n.GUILD_BOOSTS:
                    return (0, i.jsx)(S.A, {
                        guildId: l.id,
                        selected: a === ea.VV.GUILD_BOOSTS
                    }, el.n.GUILD_BOOSTS);
                case el.n.GAME_SERVERS:
                    return (0, i.jsx)(b.A, {
                        guildId: l.id,
                        selected: a === ea.VV.GAME_SERVERS
                    }, el.n.GAME_SERVERS);
        ...
        let {
            category: _,
            channel: f
        } = g, E = _ instanceof U.xu, I = f.record, v = `${t}${f.id}`;
        switch (I.type) {
...
let eh = e => {
    ...
    } = (0, p.Ay)(m.A.GUILD_CHANNEL_LIST), u = (0, c.bG)([L.A], () => L.A.getChannel(n)), g = (0, c.bG)([L.A], () => L.A.getChannel(l)), _ = (0, c.bG)([G.A], () => G.A.getGuildId()), f = (0, I.jN)(t), x = s.useRef(null), C = s.useCallback((e, t) => {
        let n = x.current;
        null != n && (er.Ut1.test(t) || (0, ea.jq)(t) ? n.scrollToChannel(t, !1, 16, () => {
...
function em(e) {
    let t = (0, V.A)(e.guild),
        n = (0, c.cf)([P.A], () => P.A.getGuild(e.guildId, {
            guildActionRows: t
        })),
        {
            density: s
