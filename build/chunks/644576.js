/** chunk id: 644576, original params: e,t,a (module,exports,require) **/
a.d(t, {
    A: () => S
});
var n = a(627968),
...
class E extends i.PureComponent {
    ...
    componentDidMount() {
        ...
        e.length > 0 && e[0].type === g.geh.IMG && this.setState({
    ...
    handleChangeItem = e => {
        this.setState({
            isVideoPlaying: !1
        }), e.type === g.geh.IMG && this.setState({
                ...
                if ("errored" === this.state.status.get(e.src)) {
                    ...
                    a = (0, n.jsxs)(n.Fragment, {
                        children: [(0, n.jsx)(r.y$y, {
                            className: l()(A.u1, {
                                [A.R]: void 0 !== this.state.status.get(e.src)
                            }),
                            ...
                            className: l()(A.JD, {
                                [A.R]: "loaded" !== this.state.status.get(e.src)
                            }),
                            src: e.src,
                            alt: t
                        })]
