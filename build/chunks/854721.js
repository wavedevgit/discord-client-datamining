/** chunk id: 854721 params = (module,exports,require) **/
t.r(l), t.d(l, {
    default: () => M
});
var n = t(627968),
...
function L(e) {
    let {
        ...
        selectedPageIndex: a,
        selectedSku: i
    } = e, r = (0, j.jM)(), o = s.useRef(r);
    s.useEffect(() => {
        o.current = r
    }, [r]);
    let d = i?.id;
    return s.useEffect(() => {
        if (null != d) return (0, b.R)({
            skuId: d,
            ...
            onClose: () => {
                (0, g.JK)().location.pathname.indexOf(v.BVt.CHANNELS_GAME_SHOP(t, a)) >= 0 && (0, S.A)({
                    guildId: t,
                    pageIndex: a
                })
            }
...
function M(e) {
    ...
    } = (0, _.Ay)(u.A.SOCIAL_LAYER_STOREFRONT), b = (0, k.A)({
        guildId: t
    }), R = (0, o.bG)([A.default], () => A.default.getSessionId(), []), N = (0, o.bG)([h.A], () => h.A.get(g), [g]);
    (0, x.pE)(), (0, p.x)({
        applicationId: b?.storefront?.applicationId,
        location: "SocialLayerStorefront"
    });
    let v = (0, c.A)((0, r.A)()),
    ...
    return (s.useEffect(() => {
        ...
        null == t || null == R || null == I.A.getGuild(t) && (0, m.Z2)(t, {}, {
            shouldNavigate: !1
        })
    }, [t, R]), null == t || b?.storefront == null) ? (0, n.jsx)("div", {
        className: i()(C.u, C.k),
