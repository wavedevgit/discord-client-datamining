...
function Z(e) {
    let {
        ...
        quest: n
    } = i.useContext(W.T), s = (0, d.bG)([x.A], () => x.A.useReducedMotion), [r, o] = i.useState(!1), u = (0, y.tW)(n, y.fY.QUEST_BAR_HERO_VIDEO, void 0, !1), h = (0, y.tW)(n, y.fY.VIDEO_PLAYER_THUMBNAIL, void 0, !1), p = (0, v.Kr)(e => e.getVideoProgressState)(n.id), g = n.userStatus?.completedAt != null && p === v.K2.COMPLETED, _ = !g && (!s || r);
...
function et(e) {
    let {
        ...
        expansionSpring: v
    } = i.useContext(U.PW), I = i.useRef(null), k = (0, d.bG)([f.A], () => f.A.isEnrolling(c.id), [c]), R = i.useMemo(() => (0, y.tW)(c, t ? y.fY.QUEST_BAR_HERO_IMAGE : y.fY.QUEST_BAR_HERO), [c, t]), M = (0, T.NA)({
        quest: c
    }), B = i.useMemo(() => (0, y.tW)(c, y.fY.HERO_IMAGE), [c]), G = i.useMemo(() => null == B ? {} : {
    ...
    return (0, a.jsxs)(a.Fragment, {
        children: [(0, a.jsx)("div", {
            ...
            style: {
                ...
                filter: (0, P.Q)(v.to([0, 1], [.8, 1]).to(e => `brightness(${e})`))
            },
...
function en(e) {
    let {
        ...
        expansionSpring: c
    } = i.useContext(U.PW), u = s.userStatus?.completedAt != null, m = d.percentComplete > 0, h = (0, S.Vn)(s), [x, p, g] = (0, S.Qo)(s, d), _ = i.useRef(null), f = i.useRef(null), v = (0, S.RR)({
        quest: s
    }), j = (0, k.vv)(s), C = (0, S.I3)(s), A = i.useCallback(() => {
        (0, L.d5)({
            quest: s,
            questContent: b.uF.QUEST_BAR_V2,
            sourceQuestContent: b.uF.QUEST_BAR_V2,
    ...
    return (0, a.jsxs)(a.Fragment, {
        children: [(0, a.jsx)(r.animated.div, {
            ...
            children: [(0, a.jsx)(z.A, {}), (0, a.jsx)("div", {
                ...
                children: !u && !(0, I.W1)(s) && (0, o.YW)(x).with(b.X0.SELECT, () => (0, a.jsx)($.A, {
                    onConsole: () => g(q.fO.CONSOLE),
                    onDesktop: () => g(q.fO.DESKTOP)
                })).with(b.X0.DESKTOP, () => (0, a.jsx)(H.A, {
                    quest: s
                })).with(b.X0.CONSOLE, () => (0, a.jsx)(F.A, {
                    quest: s,
                    taskDetails: d
                })).exhaustive()
            }), (0, a.jsxs)(V.T, {
...
let ei = i.forwardRef(function(e, t) {
    ...
    } = (0, S.zW)(h), g = (0, R.vA)(h), _ = i.useCallback(async () => {
