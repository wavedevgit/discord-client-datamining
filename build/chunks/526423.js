...
class h extends d.A {
    ...
    _terminate() {
        s.h.unsubscribe("BROWSER_HANDOFF_END", this.handleEnd), s.h.unsubscribe("BROWSER_HANDOFF_FROM_APP", this.handleHandoff)
    }
    handleHandoff(e) {
        let {
            handoffKey: t,
    ...
    handleEnd = e => {
        ...
        null != i && o.A.isHandoffAvailable() ? this.handleHandoff({
            handoffKey: i,
            handoffToken: t,
            fingerprint: n,
