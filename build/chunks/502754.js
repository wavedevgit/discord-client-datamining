...
function T(e) {
    let {
        ...
        autoTrackExposure: !1
    }), a = m.hH.useSetting(), A = (0, u.iJ)(n), f = !1, N = 0 === t.messages.length || r()(t.messages[0].timestamp).isSame(r()(), "day"), b = p.default.getUser(_.default.getId())?.hasFlag(E.nhx.SPAMMER) ?? !1, T = [];
    if (!t.collapsed) {
        let e = null,
            c = null,
