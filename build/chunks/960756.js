/** chunk id: 960756 params = (module,exports,require) **/
"use strict";
n.d(t, {
    $i: () => E,
    aV: () => C,
...
function N(e) {
    let {
        ...
        onEdit: n,
        disableGoodStatus: d
    } = e, c = (0, l.yK)([a.A], () => a.A.getDefaultChannelIds(t)), u = (0, l.bG)([a.A], () => (0, o.G4)(t, a.A.getDefaultChannelIds(t), a.A.getOnboardingPrompts(t)).length), m = s.useMemo(() => new Set(c), [c]), [, g] = (0, o.tb)(t, m), j = g.length, N = f(t), E = (0, x.Mj)(t), T = (0, l.bG)([a.A], () => a.A.isAdvancedMode(t)), C = T ? _.intl.formatToPlainString(_.t.nHwnLK, {
    ...
    return (0, i.jsx)(p, {
        title: T ? _.intl.string(_.t.YZookV) : _.intl.string(_.t["4GSygh"]),
        description: C,
        icon: (0, i.jsx)(r.N$i, {
            size: "md",
            color: "currentColor",
...
function E(e) {
    ...
    return N && (f >= 85 && !s ? E = "good" : f < 85 && (E = "warning")), (0, i.jsx)(p, {
        ...
        description: _.intl.format(_.t.iuNisr, {
            numChannels: x,
            numTotalChannels: h,
            channelsHook: (e, t) => (0, i.jsx)("span", {
                style: {
                    color: f > 85 ? "var(--text-strong)" : "var(--status-warning)"
                },
                children: e
            }, t)
        }),
...
function T(e) {
    let {
        ...
        onEdit: n,
        disableGoodStatus: o
    } = e, c = (0, l.bG)([m.A], () => m.A.getSettings()), g = (0, l.bG)([a.A], () => a.A.getEnabled(t)), x = (0, d.Ic)(c), h = c.enabled, f = s.useCallback(() => {
        (0, u.UP)(t, !h)
    }, [t, h]), j = !(0, d.jJ)(c), N = "none";
    j && (x && !o ? N = "good" : x || (N = "required"));
    let E = _.intl.string(_.t.GMOwOD);
    x ? j || (E = _.intl.string(_.t.wHOoyE)) : E = _.intl.string(_.t.wXFbgZ);
    let T = null;
    return j && g && (T = (0, i.jsx)("div", {
        className: A.WW,
