...
function N(e) {
    let {
        ...
        onEdit: n,
        disableGoodStatus: d
    } = e, c = (0, l.yK)([a.A], () => a.A.getDefaultChannelIds(t)), u = (0, l.bG)([a.A], () => (0, o.G4)(t, a.A.getDefaultChannelIds(t), a.A.getOnboardingPrompts(t)).length), m = s.useMemo(() => new Set(c), [c]), [, g] = (0, o.tb)(t, m), j = g.length, N = f(t), E = (0, x.Mj)(t), b = (0, l.bG)([a.A], () => a.A.isAdvancedMode(t)), T = b ? _.intl.formatToPlainString(_.t.nHwnLK, {
