...
function b(e) {
    ...
    } = e, i = l.useMemo(() => (0, p.tW)(t, p.fY.VIDEO_PLAYER_THUMBNAIL, void 0, !1), [t]);
...
function j(e) {
    let {
        ...
        sourceQuestContent: L,
        quest: I
    } = l.useContext(g.VideoQuestModalContext), j = (0, d.Ay)(e => e.fullScreenEnabled), R = (0, d.Ay)(e => e.setFullScreenEnabled), k = (0, f.go)(), w = (0, C.H)({
        quest: I,
        onClose: S,
        sourceQuestContent: L,
        impressionId: k
