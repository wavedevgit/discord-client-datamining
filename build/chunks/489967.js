...
function h() {
    let [e, t] = i.useState(null), [n, h] = i.useState(0), [x, p] = i.useState(1e3), [g, f] = i.useState(0), v = (0, s.bG)([d.A], () => null === e ? null : d.A.getFeedbackConfig(c.MW[e]) ?? o.u[c.MW[e]]), _ = Object.entries(c.MW), b = _.slice(_.length / 2).map(e => {
        let [t] = e;
        return {
            id: t,
            label: t,
    ...
    return (0, a.jsx)("div", {
        ...
        children: (0, a.jsxs)(l.BJc, {
            ...
            children: [(0, a.jsx)(l.l6P, {
                ...
                children: [null != v && (0, a.jsxs)(a.Fragment, {
                    children: [(0, a.jsx)(l.Text, {
                        variant: "text-sm/semibold",
                        children: "Current cooldown"
                    }), (0, a.jsx)(l.Text, {
                        variant: "text-sm/normal",
                        children: `${v.cooldown/1e3} second(s) or`
                    }), (0, a.jsx)(l.Text, {
                        variant: "text-sm/normal",
                        children: `${v.cooldown/6e4} minute(s) or`
                    }), (0, a.jsx)(l.Text, {
                        variant: "text-sm/normal",
                        children: `${v.cooldown/36e5} hour(s) or`
                    }), (0, a.jsx)(l.Text, {
                        variant: "text-sm/normal",
                        children: `${v.cooldown/864e5} day(s)`
                    })]
                }), (0, a.jsxs)(l.BJc, {
            ...
            }), (0, a.jsx)(l.cGx, {}), (0, a.jsx)(l.nVY, {
                label: "Override Survey Chance",
                children: (0, a.jsx)(l.ksK, {
                    label: "Override chance",
                    description: null != v ? `Current chance: ${100*v.chance}%` : void 0,
                ...
                children: [(0, a.jsx)(l.Button, {
                    ...
                    text: "Clear Override",
                    onClick: () => void(null != v && r.h.dispatch({
