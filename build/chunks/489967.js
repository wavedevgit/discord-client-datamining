...
function h() {
    let [e, t] = i.useState(null), [n, h] = i.useState(0), [p, x] = i.useState(1e3), [g, _] = i.useState(0), f = (0, s.bG)([d.A], () => null === e ? null : d.A.getFeedbackConfig(c.MW[e]) ?? o.u[c.MW[e]]), v = Object.entries(c.MW), b = v.slice(v.length / 2).map(e => {
        let [t] = e;
        return {
            id: t,
            label: t,
