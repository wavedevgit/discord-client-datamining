...
class S {
    ...
    generateNicknameGuildPairs = (0, x.L_)(e => a()(_.Ay.getNicknameGuildsMapping(e?.id ?? this.userId)).toPairs().map(e => {
        let [t, n] = e;
...
function T(e) {
    let {
        ...
        let {
            ...
            channelId: n,
            analyticsLocations: i
        } = e, l = (0, r.bG)([f.default], () => f.default.getUser(t), [t]), [a] = s.useState(() => new S({
            user: l,
            userId: t,
            channelId: n,
            analyticsLocations: i
