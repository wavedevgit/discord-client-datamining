...
class S {
    ...
    generateNicknameGuildPairs = (0, x.L_)(e => r()(_.Ay.getNicknameGuildsMapping(e?.id ?? this.userId)).toPairs().map(e => {
        let [t, n] = e;
    ...
    renderNicknamePairs(e) {
        return this.getNicknameGuildPairs().map((t, n) => {
            let [l, r] = t, a = (0, i.jsx)(d.DUT, {
                tag: "span",
                onClick: this.handleClick,
                children: l
            });
            return r.length > 0 && (a = (0, i.jsx)(c.m, {
                asContainer: !0,
                tag: "span",
                text: r.join(", "),
                position: "bottom",
...
function T(e) {
    let {
        channel: t
    } = e, n = t.getRecipientId(), l = (0, m.EI)(n), r = Array(l.length).fill(null), {
        analyticsLocations: p
    } = (0, A.Ay)(h.A.AKA), _ = function(e) {
        let {
            userId: t,
            channelId: n,
            analyticsLocations: i
    ...
    return 0 === _.getNicknameGuildPairs().length && 0 === l.length ? (0, i.jsx)("div", {
        className: b.jH
    }) : (0, i.jsxs)(A.f5, {
        value: p,
        children: [(0, i.jsx)(E.cG, {
            ...
            renderUser: (e, t, n) => {
                let s = _.user,
                    r = l[n];
                return null == r || null == s ? null : (0, i.jsx)(c.m, {
                    asContainer: !0,
                    text: g.A.getGuild(r)?.name,
                    position: "bottom",
            ...
            max: 3,
            className: b.HD
        }) : null, _.getNicknameGuildPairs().length > 0 ? (0, i.jsx)(o.A, {
            position: "bottom",
            className: b.wm,
            delay: 0,
            onTooltipShow: I,
            onTooltipHide: T,
            children: _.renderNicknamePairs(!x)
        }) : null]
    })
}