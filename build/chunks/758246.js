...
let S = "https:" + window.GLOBAL_ENV.MARKETING_ENDPOINT + "/servers/",
    ...
    R = () => {
        ...
        let V = e => {
            ...
            K = [{
                title: b.intl.string(b.t["/SWsH3"]),
                items: [{
                    description: b.intl.string(b.t.DU8jF2),
                    completed: null !== t.discoverySplash && "" !== t.discoverySplash
                }, {
                    description: b.intl.string(b.t.SW5OH6),
                    completed: null !== t.description && "" !== t.description
                }, {
                    description: b.intl.string(b.t.m3b3WL),
                    completed: null !== G.about && G.about.length >= 300 && G.about.length <= 2400
                }, {
                    description: b.intl.string(b.t.qpx5MN),
                            ...
                            children: (0, i.jsxs)("div", {
                                ...
                                children: [(0, i.jsxs)("div", {
                                    ...
                                    children: [(0, i.jsxs)(o.Heading, {
                                        ...
                                        children: [b.intl.string(b.t.kGlQGF), (0, i.jsx)(c.A, {
                                            className: v.TN
                                        })]
                                    }), (0, i.jsxs)(o.Text, {
                                        ...
                                        children: [(() => {
                                            ...
                                            return (0, i.jsxs)(o.BJc, {
                                                ...
                                                children: [(0, i.jsx)(o.D0$, {
                                                    label: b.intl.string(b.t.safBZ9),
                                            ...
                                            if (null != t) return (0, i.jsxs)(i.Fragment, {
                                                children: [(0, i.jsx)(N.T, {
                                                    label: b.intl.string(b.t.GjPpSu),
                                                    description: b.intl.string(b.t.MVXonM),
                                                    guildId: t.id,
                                                    guildMetadata: G,
                                                    isDisabled: !R
                                                }), (0, i.jsx)(E.A, {
                                                    label: b.intl.string(b.t.oOPlPA),
                                                    guild: t,
                                                    guildMetadata: G,
                                                    disabled: !R
                                            ...
                                            if (null != t) return (0, i.jsx)(o.D0$, {
                                                label: b.intl.string(b.t["8bT/Cu"]),
                                                description: b.intl.string(b.t.WCWT7A),
                                                ...
                                                children: (0, i.jsxs)(o.BJc, {
                                                    ...
                                                    children: [(0, i.jsx)(h.A, {
                                                        ...
                                                        children: [b.intl.string(b.t.yG2pUi), (0, i.jsx)(x.Ay, {
                                                            disabled: !R,
                                                            onChange: V
                                                        })]
                                                    })]
                                            ...
                                            label: b.intl.string(b.t["RSfm+i"]),
                                            description: b.intl.string(b.t.IBi6hz),
                                            value: null !== t.description ? t.description : "",
                                            placeholder: b.intl.string(b.t.rFa9Ui),
                                            onChange: e => {
                                                f.A.updateGuild({
                                            ...
                                            return (0, i.jsx)(o.D0$, {
                                                label: b.intl.string(b.t.vUmXsR),
                                                description: b.intl.string(b.t.esnBnW),
                                            ...
                                            label: b.intl.string(b.t["lu+BmJ"]),
                                            description: b.intl.string(b.t.ozSi8g),
                                            error: H?.about != null ? H.about : void 0,
                                            showCharacterCount: !0,
                                            rows: 10,
                                            value: G.about,
                                            placeholder: b.intl.string(b.t.TduTbs),
                                            onChange: e => {
                                                (0, m.xN)(t.id, e)
                                            },
                                            minLength: 300,
                                            ...
                                            label: b.intl.string(b.t.V5mNyb),
                                            description: b.intl.string(b.t.d3kA9a),
                                            ...
                                            children: [G.socialLinks.map((e, n) => {
                                                ...
                                                return (0, i.jsxs)("div", {
                                                    ...
                                                    children: [(0, i.jsx)(o.l6P, {
                                                        ...
                                                        label: b.intl.string(b.t.xSALIK),
                                                        hideLabel: !0,
                                                        placeholder: b.intl.string(b.t.xSALIK),
                                                        value: B[n],
                                                        onSelectionChange: e => {
                                                            let i, s, l;
                                                        ...
                                                        placeholder: null != d ? void 0 : b.intl.string(b.t.Q6o4pJ),
                                                        maxLength: 150,
                                                        disabled: !R || null == B[n],
                                                        fullWidth: !0,
                                                        leading: d,
                                            ...
                                            children: [(0, i.jsx)(o.cGx, {}), (0, i.jsx)(o.D0$, {
                                                label: b.intl.string(b.t["5yF7e1"]),
                                                description: b.intl.string(b.t.eOFvqT),
                                                children: (0, i.jsx)(o.Button, {
                                                    variant: "critical-primary",
                                                    size: "sm",
                                                    text: b.intl.string(b.t["DCHd/G"]),
                                                    onClick: () => z(!1),
                                                    disabled: !R
                                                })
                                            })]
                                    ...
                                    children: (0, i.jsx)(u.A, {
                                        title: b.intl.string(b.t["2kCyn/"]),
                                        children: K,
                                        buttonLabel: b.intl.string(b.t.tVK6S9),
                                        buttonCallback: () => z(!0),
                                        disabled: !R || !k
                                    })
                                })]
