...
function f(e) {
    let {
        ...
        guildId: t,
        channelId: n
    }), E = (0, c.uk)(t), x = (0, c.Tq)(t), I = (0, s.bG)([d.A], () => d.A.getGuild(t), [t]), C = I?.name, N = (0, s.bG)([o.A], () => o.A.getChannel(n)), T = (0, r.Ay)(N), S = l.useMemo(() => {
        let e = {};
        for (let t of E)
    ...
    return ((0, h.A)({
        ...
        children: [(0, i.jsx)(a.Heading, {
            ...
            children: f.filter(e => null != S[e.id]).map(e => (0, i.jsx)(_.A, {
                guildId: t,
                listingId: e.id,
