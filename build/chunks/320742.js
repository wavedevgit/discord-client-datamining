/** chunk id: 320742 params = (module,exports,require) **/
"use strict";
r.d(t, {
    default: () => b
});
...
let b = e => {
    let {
        transitionState: t,
        onClose: r
    } = e, o = (0, C.A)(), [i, b] = a.useState(!1), {
        getLinkCode: T,
        isGetLinkCodeLoading: j
    } = (0, f.A)({}), E = (0, x.VE)(), O = (0, x.VT)(), z = a.useRef(O);
    l()(!o, "FamilyCenterQRCodeModal should only be rendered for teens.");
    let N = () => {
        b(e => (p.default.track(h.HAw.FAMILY_CENTER_ACTION, {
            action: i ? _.qb.HideQRCode : _.qb.RevealQRCode
        }), !e)), i || setTimeout(() => {
            r()
        }, _.nz)
    };
    ...
    return (0, s.jsxs)(c.dWK, {
        ...
        children: [(0, s.jsxs)(c.$Td, {
            ...
            children: [(0, s.jsx)(c.mir, {
                size: "sm",
                color: "currentColor"
            }), y.intl.string(m.default.iHYMAz)]
        }), (0, s.jsxs)(c.cwr, {
