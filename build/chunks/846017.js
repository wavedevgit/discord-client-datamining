...
function _(e) {
    ...
    } = e, [A, x] = s.useState(""), [p, h] = s.useState(""), [f, T] = s.useState(""), [E, S] = s.useState(null), [b, C] = s.useState(null), {
        formState: N,
        errors: v
    } = (0, a.cf)([d.A], () => ({
    ...
    async function j(e) {
        ...
        let t = !1;
        if ("" === p ? (S(m.intl.string(m.t["/7/oPU"])), t = !0) : S(null), p !== f ? (C(m.intl.string(m.t["IEKYZ/"])), t = !0) : C(null), t) return;
        let i = await (0, o._L)({
            password: A,
            newPassword: p
        });
