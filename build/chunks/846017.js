...
function g(e) {
    ...
    } = e, [x, h] = s.useState(""), [A, p] = s.useState(""), [T, f] = s.useState(""), [S, E] = s.useState(null), [b, C] = s.useState(null), {
        formState: v,
        errors: N
    } = (0, r.cf)([d.A], () => ({
    ...
    async function j(e) {
        ...
        let t = !1;
        if ("" === A ? (E(m.intl.string(m.t["/7/oPU"])), t = !0) : E(null), A !== T ? (C(m.intl.string(m.t["IEKYZ/"])), t = !0) : C(null), t) return;
        let i = await (0, o._L)({
            password: x,
            newPassword: A
        });
