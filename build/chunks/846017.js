...
function m(e) {
    ...
    } = e, [A, x] = s.useState(""), [h, p] = s.useState(""), [T, E] = s.useState(""), [S, f] = s.useState(null), [C, b] = s.useState(null), {
        formState: N,
        errors: I
    } = (0, a.cf)([d.A], () => ({
    ...
    async function j(e) {
        ...
        let t = !1;
        if ("" === h ? (f(_.intl.string(_.t["/7/oPU"])), t = !0) : f(null), h !== T ? (b(_.intl.string(_.t["IEKYZ/"])), t = !0) : b(null), t) return;
        let i = await (0, o._L)({
            password: A,
            newPassword: h
        });
