/** Chunk was on web.js **/
/** chunk id: 619517, original params: e,t,n (module,exports,require) **/
"use strict";
n.d(t, {
    Ay: () => P,
    P8: () => T,
...
class P extends(r = a.Component) {
    ...
    static async trackLoadingCompleted(e) {
        ...
        let v = await fetch(a.url).catch(() => void 0),
            A = null == v || null == (t = v.headers) ? void 0 : t.get("content-length"),
    ...
    getSrc(e) {
        ...
        return (0, f.AE)({
            ...
            height: i,
            ratio: e,
            maxWidth: s === b.dG.MOSAIC ? a : void 0,
            maxHeight: s === b.dG.MOSAIC ? o : void 0,
            format: l,
            quality: c,
            animated: !t,
...
O(P, "visibilityObserver", new l.j({
    threshold: .6
})), O(P, "defaultProps", {
    shouldLink: !1,
    autoPlay: !1,
