...
function o(n) {
    return (0, r.bG)([d.A, s.A], () => {
        let e = Object.values(s.A.getMutableBasicGuildChannelsForGuild(n.guild_id)).filter(n => n.type === c.rbe.GUILD_CATEGORY);
        return 0 === e.length || e.every(n => d.A.isCollapsed(n.id))
    }) ? null : (0, i.jsx)(l.Drp, {
