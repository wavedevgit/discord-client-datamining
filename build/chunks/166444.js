...
function U(e) {
    let {
        ...
        size: n = d._3J.SIZE_20,
        className: i
    } = e, a = (0, o.bG)([M.default], () => M.default.getUser(t?.recipients[0])), s = (0, o.bG)([C.A], () => !(null == a || null == t || t.isMultiUserDM()) && null != C.A.getTypingUsers(t?.id)[a?.id]), {
        status: r,
        isMobile: u,
        isVR: c
    } = (0, o.cf)([y.A], () => null == a || null == t || t.isMultiUserDM() ? {
        status: null,
        isMobile: !1,
        isVR: !1
    } : {
        status: y.A.getStatus(a.id),
        isMobile: y.A.isMobileOnline(a.id),
        isVR: y.A.isVROnline(a.id)
    });
    return (0, l.jsx)(k, {
        className: i,
        size: n,
...
let B = i.memo(function(e) {
        ...
        } = e, f = (0, o.bG)([D.A], () => D.A.getGuild(i.guild_id), [i.guild_id]), p = i.type === _.rbe.DM || i.type === _.rbe.GROUP_DM, A = (0, v.DZ)(), x = A && p, {
            enableWaveformIcon: T
        } = (0, g.b)(i.guild_id, "ChannelItemIcon"), b = (0, o.bG)([h.A], () => h.A.getAnimationStyle(i.id), [i.id]), S = i.type === _.rbe.GUILD_VOICE, R = null;
        if (T && S && !a && u) R = (0, l.jsx)(E.A, {
            color: "currentColor",
            className: s()(O.Kk, t),
            animationStyle: b,
            locked: (0, m.A)(i)
    ...
    z = 21552 == n.j ? i.forwardRef(function(e, t) {
        let {
            channel: n,
            name: a,
            muted: c,
            ...
            hasActiveEvent: q = !1
        } = e, J = $ === L.e.ALL_MESSAGES || null != W && W > 0, Y = (0, o.bG)([j.A], () => Object.values(j.A.getVoiceStatesForChannel(n.id)).length > 0, [n.id]), {
            role: X,
            ...Q
        } = (0, r.rm)(n.id), ee = i.useRef(null), et = i.useRef(null), en = (0, b.A)(n), el = _.BVt.CHANNEL(en, n.id), ei = (0, p.Ay)(n), ea = n.isGuildVocal(), es = null != N || null != x || null != A || K, er = (0, l.jsx)("div", {
            className: s()({
                [O.ow]: Z
            }),
            ref: et,
            children: (0, l.jsxs)(R.A, {
                ...
                children: [(0, l.jsxs)("div", {
                    ...
                    }), i.Children.count(U) > 0 ? (0, l.jsx)("div", {
                        onClick: P,
                        className: O.Y_,
                        children: U
                    }) : null]
        ...
        return (0, l.jsx)(d.vN3, {
            ...
            children: (0, l.jsxs)("div", {
                ...
                children: [c || !f ? null : (0, l.jsx)("div", {
                    className: s()(O.gy, J ? O.WS : void 0)
                }), v?.(er) ?? er]
            })
        })
    }) : null;
...
function F(e) {
    let {
        channel: t,
        name: n
    } = e, a = t.isPrivate() && 1 === (t.rawRecipients ?? []).length, s = t.rawRecipients?.[0]?.display_name_styles, r = i.useMemo(() => a ? (0, A.mT)(s) : null, [a, s]);
    return null != r ? (0, l.jsx)(T.A, {
        userName: n,
        displayNameStyles: r,
