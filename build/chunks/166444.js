...
function H(e) {
    let {
        channel: t,
        size: n = d._3J.SIZE_20
    } = e, i = (0, o.bG)([D.default], () => D.default.getUser(t?.recipients[0])), a = (0, o.bG)([C.A], () => !(null == i || null == t || t.isMultiUserDM()) && null != C.A.getTypingUsers(t?.id)[i?.id]), {
        status: s,
        isMobile: r,
        isVR: u
    } = (0, o.cf)([y.A], () => null == i || null == t || t.isMultiUserDM() ? {
        status: null,
        isMobile: !1,
        isVR: !1
    } : {
...
let U = i.memo(function(e) {
        let {
            ...
            withGuildIcon: d
        } = e, f = (0, o.bG)([R.A], () => R.A.getGuild(i.guild_id), [i.guild_id]), p = i.type === I.rbe.DM || i.type === I.rbe.GROUP_DM, {
            enableWaveformIcon: E
        } = (0, g.b)(i.guild_id, "ChannelItemIcon"), x = (0, o.bG)([h.A], () => h.A.getAnimationStyle(i.id), [i.id]), T = i.type === I.rbe.GUILD_VOICE, v = E && T && !a && u, S = null;
        if (d && null != f && !p) S = (0, l.jsx)(b.A, {
            size: b.q.SMALL_32,
            className: w.h5,
            iconClassName: w.Is,
            channel: i,
    ...
    B = 21552 == n.j ? i.forwardRef(function(e, t) {
        let {
            channel: n,
            name: a,
            muted: c,
            ...
            withGuildIcon: Z,
            hasActiveEvent: Y = !1
        } = e, J = q === _.e.ALL_MESSAGES || null != W && W > 0, X = (0, o.bG)([M.A], () => Object.values(M.A.getVoiceStatesForChannel(n.id)).length > 0, [n.id]), {
            role: Q,
            ...ee
        } = (0, r.rm)(n.id), et = i.useRef(null), en = i.useRef(null), el = (0, v.A)(n), ei = I.BVt.CHANNEL(el, n.id), ea = (0, p.Ay)(n), es = n.isGuildVocal(), er = null != A || null != x || null != E || K, eo = (0, l.jsx)("div", {
            className: s()({
                [w.ow]: $
            }),
            ref: en,
        ...
        return (0, l.jsx)(d.vN3, {
            ...
            children: (0, l.jsxs)("div", {
                ...
                children: [c || !f ? null : (0, l.jsx)("div", {
                    className: s()(w.gy, J ? w.WS : void 0)
                }), b?.(eo) ?? eo]
            })
        })
    }) : null;
...
function z(e) {
    let {
        channel: t,
        name: n
    } = e, a = t.isPrivate() && 1 === (t.rawRecipients ?? []).length, s = t.rawRecipients?.[0]?.display_name_styles, r = i.useMemo(() => a ? (0, E.mT)(s) : null, [a, s]);
