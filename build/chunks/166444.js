...
function w(e) {
    let {
        ...
        size: n = d._3J.SIZE_20,
        className: l
    } = e, a = (0, u.bG)([D.default], () => D.default.getUser(t?.recipients[0])), s = (0, u.bG)([b.A], () => !(null == a || null == t || t.isMultiUserDM()) && null != b.A.getTypingUsers(t?.id)[a?.id]), {
        status: r,
        isMobile: o,
        isVR: c
    } = (0, u.cf)([S.A], () => null == a || null == t || t.isMultiUserDM() ? {
        status: null,
        isMobile: !1,
        isVR: !1
    } : {
        status: S.A.getStatus(a.id),
        isMobile: S.A.isMobileOnline(a.id),
        isVR: S.A.isVROnline(a.id)
    });
    return (0, i.jsx)(R, {
        className: l,
        size: n,
...
let U = l.memo(function(e) {
        ...
        } = e, d = (0, u.bG)([x.A], () => x.A.getGuild(l.guild_id), [l.guild_id]), {
            enableWaveformIcon: _
        } = (0, h.b)(l.guild_id, "ChannelItemIcon"), f = (0, u.bG)([A.A], () => A.A.getAnimationStyle(l.id), [l.id]), I = l.type === G.rbe.GUILD_VOICE, N = null;
        if (_ && I && !a && o) N = (0, i.jsx)(g.A, {
            color: "currentColor",
            className: s()(P.Kk, t),
            animationStyle: f,
            locked: (0, E.A)(l)
    ...
    W = 21552 == n.j ? l.forwardRef(function(e, t) {
        let {
            channel: n,
            name: a,
            muted: c,
            ...
            hasActiveEvent: J = !1,
            transitionExtras: q
        } = e, Q = Y === j.e.ALL_MESSAGES || null != $ && $ > 0, X = (0, u.bG)([p.A], () => Object.values(p.A.getVoiceStatesForChannel(n.id)).length > 0, [n.id]), {
            role: ee,
            ...et
        } = (0, r.rm)(n.id), en = l.useRef(null), ei = l.useRef(null), el = (0, L.A)(n);
        null != el && v.A.getConfig({
            guildId: el,
            ...
            eo = (0, i.jsx)("div", {
                ...
                children: (0, i.jsxs)(C.A, {
                    ...
                    children: [(0, i.jsxs)("div", {
                        ...
                        }), l.Children.count(H) > 0 ? (0, i.jsx)("div", {
                            onClick: F,
                            onKeyPress: F,
                            className: P.Y_,
                            children: H
        ...
        return (0, i.jsx)(d.vN3, {
            ...
            children: (0, i.jsxs)("div", {
                ...
                onMouseEnter: k,
                onMouseLeave: w,
                children: [c || !E ? null : (0, i.jsx)("div", {
                    className: s()(P.gy, Q ? P.WS : void 0)
                }), x?.(eo) ?? eo]
            })
        })
    }) : null;
...
function B(e) {
    let {
        channel: t,
        name: n
    } = e, a = t.isPrivate() && 1 === (t.rawRecipients ?? []).length, s = t.rawRecipients?.[0]?.display_name_styles, r = l.useMemo(() => a ? (0, f.mT)(s) : null, [a, s]);
    return null != r ? (0, i.jsx)(N.A, {
        userName: n,
        displayNameStyles: r,
        effectDisplayType: I.G.PLAIN,
        boldFontOpacity: .9
    }) : n
}