/** chunk id: 508160, original params: e,t,l (module,exports,require) **/
l.d(t, {
    A: () => w
});
var n = l(627968),
...
let M = {
    ...
    T = i.memo(function(e) {
        ...
        } = e, _ = (0, C.bG)([u.A], () => u.A.useReducedMotion), {
            usePubSub: L
        } = (0, f.r)({
            location: "MembersTable"
        }), T = (0, C.bG)([g.A], () => g.A.hasPendingBulkBan(l.id), [l.id]), w = L && T, Z = (0, d.useHasAnyModalOpen)(), U = (0, h.j)(), [O, k] = i.useState(!1), [F, B] = i.useState(!1), P = !Z && O && F;
        i.useEffect(() => {
            U || (k(!1), B(!1))
        }, [U]), i.useLayoutEffect(() => {
            let e = e => {
        ...
        return (0, n.jsxs)("table", {
            ...
            children: [(0, n.jsx)(v.A, {
                    ...
                    children: (0, n.jsx)("td", {
                        ...
                        children: (0, n.jsxs)("div", {
                            ...
                            children: [(0, n.jsx)("div", {
                                ...
                                type: "info",
                                children: V.intl.string(V.t["UP+9QZ"])
                            })]
                        })
                    })
                })
                ...
                children: r === b.IY.SUCCESS_FULL || r === b.IY.LOADING ? (0, n.jsxs)(n.Fragment, {
    ...
    w = function(e) {
        ...
        } = e, d = (0, C.cf)([H.A], () => H.A.getPaginationStateByGuildId(t.id), [t.id]), [c] = (0, C.bG)([H.A], () => H.A.getPagedMembersByGuildId(t.id), [t.id], x.D);
        i.useEffect(() => {
            (0, p.uO)(t.id)
        }, [t.id]);
