...
let W = function(e) {
    ...
    let Q = (0, O.O)(),
        ...
        en = (0, j.d)(),
        ei = () => {
            (t.status === G.Dmq.ACTIVE || t.status === G.Dmq.PAST_DUE || t.status === G.Dmq.PAUSED) && ea(P.g.PAUSE_SELECT)
        },
        es = () => {
            (t.status === G.Dmq.ACTIVE || t.status === G.Dmq.PAST_DUE || t.status === G.Dmq.PAUSE_PENDING || q) && ea()
        },
        el = () => {
            t.status === G.Dmq.BILLING_RETRY && ea(P.g.CONFIRM)
        },
        ea = e => {
            (0, c.mMO)(async () => {
                let {
                ...
                if (1 === l.length && A?.id === t.paymentSourceId && (0, N.jJ)(e.id, d, A?.id) && (u = !1), u)(0, h.A)({
                    ...
                    r()(null != a, "Expected renewalInvoicePreview"), r()(null != s, "Expected currentInvoicePreview"), e = (0, o.uniqueId)("premium-resubscribe-modal"), l = !1, (0, c.mMO)(async () => {
                        ...
                        return n => (0, i.jsx)(e, {
                            ...
                            renewalInvoicePreview: a,
                            onClose: async () => {
                                l || (l = !0, C._.dispatch(G.jej.WOW_MOMENT_CONFIRMATION_MODAL_CLOSED), y.A.isDisplayingWowMomentConfirmation && y.A.isAnimated ? setTimeout(() => {
                                    n.onClose()
                                }, x.K) : await n.onClose())
                            }
                        })
        ...
        ed = () => {
            t.status === G.Dmq.PAUSED && ea(P.g.PAUSE_SELECT)
        },
        ec = () => {
