...
let X = function(e) {
    let {
            ...
            if (1 === l.length && x?.id === t.paymentSourceId && (0, N.jJ)(e.id, d, x?.id) && (u = !1), u)(0, h.A)({
                ...
                r()(null != a, "Expected renewalInvoicePreview"), r()(null != s, "Expected currentInvoicePreview"), e = (0, o.uniqueId)("premium-resubscribe-modal"), l = !1, (0, c.mMO)(async () => {
                    ...
                    return n => (0, i.jsx)(e, {
                        ...
                        renewalInvoicePreview: a,
                        onClose: async () => {
                            l || (l = !0, E._.dispatch(G.jej.WOW_MOMENT_CONFIRMATION_MODAL_CLOSED), y.A.isDisplayingWowMomentConfirmation && y.A.isAnimated ? setTimeout(() => {
                                n.onClose()
                            }, A.K) : await n.onClose())
                        }
                    })
        ...
        B.includes(t.status) && null != t.pauseEndsAt ? t.status === G.Dmq.PAUSED && t.pauseReason !== M.qf.USER_TEMPORARY_BAN ? (0, h.A)({
            ...
            subscription: t,
            skipConfirm: !0
        }) : u.U(t, X) : (0, b.pM)(Error("Invalid subscription to resume"), {
            extra: {
                subscriptionId: t.id,
                status: t.status,
