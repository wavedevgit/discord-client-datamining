                ...
                if (1 === l.length && A?.id === t.paymentSourceId && (0, b.jJ)(e.id, d, A?.id) && (u = !1), u)(0, p.A)({
                    ...
                    r()(null != a, "Expected renewalInvoicePreview"), r()(null != s, "Expected currentInvoicePreview"), e = (0, o.uniqueId)("premium-resubscribe-modal"), l = !1, (0, c.mMO)(async () => {
                        ...
                        return n => (0, i.jsx)(e, {
                            ...
                            renewalInvoicePreview: a,
                            onClose: async () => {
                                l || (l = !0, f._.dispatch(U.jej.WOW_MOMENT_CONFIRMATION_MODAL_CLOSED), O.A.isDisplayingWowMomentConfirmation && O.A.isAnimated ? setTimeout(() => {
                                    n.onClose()
                                }, h.K) : await n.onClose())
                            }
                        })
    ...
    return (0, i.jsx)(ex, {
        ...
        buttons: (() => {
            ...
            if (!0 === (0, y.g1)({
                ...
                if (I.Ay.isBaseSubscriptionCanceled(t)) return (0, i.jsx)(c.Button, {
                    variant: "expressive",
                    size: "md",
                    icon: c.tvc,
