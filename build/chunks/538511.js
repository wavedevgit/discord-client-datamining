...
let X = function(e) {
    ...
    } = (0, m.Ay)(_.A.SUBSCRIPTION_HEADER), X = (0, A.A)({
        forceFetch: !1
    }), {
        fractionalState: Q
    } = X, J = Q === G.xc.FP_SUB_PAUSED, {
        enabled: $
    } = (0, R.Ay)({
    ...
    let ee = (0, P.O)(),
        ...
        es = (0, v.d)(),
        ea = () => {
            (t.status === U.Dmq.ACTIVE || t.status === U.Dmq.PAST_DUE || t.status === U.Dmq.PAUSED) && eo(M.g.PAUSE_SELECT)
        },
        el = () => {
        ...
        ec = () => {
            if (null != t && null != t.premiumPlanIdFromItems) {
                ...
                let a = (0, N._w)(e, g?.id, !1),
                    ...
                    u = !0;
                if (1 === a.length && g?.id === t.paymentSourceId && (0, N.jJ)(e.id, c, g?.id) && (u = !1), u)(0, x.A)({
        ...
        ed = () => {
            z.includes(t.status) && null != t.pauseEndsAt ? t.status === U.Dmq.PAUSED && t.pauseReason !== k.qf.USER_TEMPORARY_BAN ? (0, x.A)({
                initialPlanId: t.premiumPlanIdFromItems,
                analyticsLocations: q,
                analyticsLocation: B,
                analyticsObject: F,
                subscription: t,
                skipConfirm: !0
            }) : u.U(t, q) : (0, S.pM)(Error("Invalid subscription to resume"), {
                extra: {
                    subscriptionId: t.id,
                    status: t.status,
    ...
    let eA = f.Ay.getStatusFromInvoice(t, s),
        ...
        eh = {
            [H.Vd]: eg === G.PremiumTypes.TIER_0,
            [H.aS]: eg === G.PremiumTypes.TIER_1,
            [H.hA]: eg === G.PremiumTypes.TIER_2,
    ...
    return (0, i.jsx)(ep, {
        ...
        buttons: (() => {
            ...
            if (!0 === (0, y.g1)({
                ...
                if (f.Ay.isBaseSubscriptionCanceled(t)) return (0, i.jsx)(d.Button, {
                    variant: "expressive",
                    size: "md",
                    icon: d.tvc,
