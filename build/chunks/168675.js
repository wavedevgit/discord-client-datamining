...
function z(e) {
    ...
    } = (0, p.Ay)(m.A.CREATE_THREAD);
    return null == s ? null : (0, i.jsx)(p.f5, {
        value: a,
        ...
        }),
        {
            ...
            return {
                ...
                submit: l.useCallback(async (e, l, s) => {
                    ...
                    return (0, b.x5)(t.id, Y.drafts.type), _(!1), {
                        shouldClear: !0,
                        shouldRefocus: !1
                    }
...
function $(e) {
    let {
        ...
        privateThreadMode: s
    } = e, a = (0, P.Iy)(n, s), r = (0, i.jsx)(o.Checkbox, {
    ...
    return t || s === P.jk.Disabled ? null : (0, i.jsx)(o.D0$, {
...
function J(e) {
    let {
        ...
        content: A
    }), m = (0, P.l1)(t, n), p = null != n && !u, g = (0, I.GV)(), f = u ? F.intl.string(F.t["Nb2/RE"]) : "" !== m ? m : F.intl.string(F.t["Nb2/RE"]);
