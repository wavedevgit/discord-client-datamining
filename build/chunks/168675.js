...
function Q(e) {
    let {
        ...
        content: A
    }), p = (0, P.l1)(t, n), g = null != n && !u, _ = (0, E.GV)(), f = u ? F.intl.string(F.t["Nb2/RE"]) : "" !== p ? p : F.intl.string(F.t["Nb2/RE"]);
...
function $(e) {
    let {
        ...
        submit: u,
        error: h
    } = e, [A, m] = s.useState(!0), p = s.useCallback(() => m(!0), []), g = s.useCallback(() => m(!1), []), _ = s.useCallback((e, n, i) => {
