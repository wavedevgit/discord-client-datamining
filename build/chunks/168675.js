    ...
    let t, {
        ...
        }),
        {
            ...
            let {
                ...
                location: r,
                enableAIFeatures: o
            } = e, [c, d] = s.useState(null), [u, h] = s.useState(null), [A, p] = s.useState(!1), m = (0, B.A)({
                parentChannel: t,
                parentMessageId: n,
                threadSettings: i,
                privateThreadMode: l,
...
function Q(e) {
    ...
    } = e, A = s.name ?? "", p = (0, U.vr)(a, {
        content: A
    }), m = (0, P.l1)(t, n), g = null != n && !u, _ = (0, E.GV)(), f = u ? F.intl.string(F.t["Nb2/RE"]) : "" !== m ? m : F.intl.string(F.t["Nb2/RE"]);
...
function $(e) {
    let {
        ...
        submit: u,
        error: h
    } = e, [A, p] = s.useState(!0), m = s.useCallback(() => p(!0), []), g = s.useCallback(() => p(!1), []), _ = s.useCallback((e, n, i) => {
