...
function p(e) {
    var t;
    if (!d(e)) return !1;
    let n = null == (t = o.A.getChannel(e.channel_id)) ? void 0 : t.guild_id;
    return !(null != n && a.A.isChannelOrThreadParentGated(n, e.channel_id))
}

function f(e) {
    let t = (0, l.bG)([s.A, a.A, o.A], () => {
        var t, n, r;
        if (null == e) return !0;
        let i = null == (t = o.A.getChannel(e.channel_id)) ? void 0 : t.guild_id;
        if (null != i && (null == (n = s.A.getGuild(i)) ? void 0 : n.features.has(c.GuildFeatures.FORWARDING_DISABLED))) return !0;
        let l = null != i && a.A.isChannelOrThreadParentGated(i, e.channel_id),
            u = null != e && (null == (r = o.A.getChannel(e.channel_id)) ? void 0 : r.isModeratorReportChannel());
        return l || u
    });
