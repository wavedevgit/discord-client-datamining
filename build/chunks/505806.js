...
class s extends i.Component {
    ...
    calculateInitialDeltaBytes(e) {
        let {
            ...
            updateInterval: n,
            pointsToSmooth: i
        } = this.props, l = Date.now(), s = 0, a = 0, r = [], o = null != e[0] ? e[0].bytes : 0;
        for (; s < t + i; s++) {
            let t, i = l - (s + 1) * n;
            for (; a < e.length;)
    ...
    update = () => {
        let {
            ...
            pointsToSmooth: n,
            updateInterval: i
        } = this.props, l = this.props.getHistoricalTotalBytes(), s = null != l[0] ? l[0].bytes : 0, a = [...this.state.deltaBytes.slice(1, t + n), s - this.state.lastTotalBytes];
        this.setState({
            deltaBytes: a,
