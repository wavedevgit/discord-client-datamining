/** Chunk was on web.js **/
/** chunk id: 415409, original params: e,t,n (module,exports,require) **/
"use strict";
n.d(t, {
    A: () => k
}), n(896048), n(321073), n(693327), n(554719), n(680155), n(323874), n(14289), n(35956);
var r = n(627968),
    i = n(64700),
    a = n(503698),
    s = n.n(a),
...
class k extends i.Component {
    ...
    render() {
        ...
        let {
            ...
            disableEnterToSubmit: null != (t = null == (a = y.submit) ? void 0 : a.disableEnterToSubmit) && t,
    ...
    constructor(e) {
        var t;
        super(e), t = this, P(this, "ref", i.createRef()), P(this, "_focusBlurQueue", Promise.resolve()), P(this, "_unsubscribe", void 0), P(this, "_initTimeoutId", null), P(this, "_cachedEditorWindow", null), P(this, "handleSelectionChange", () => {
            ...
            })), 0 === A.length) ? ((null == S ? void 0 : S.some(e => {
                let {
                    error: t
                } = e;
            ...
            }), !1) : (e.preventDefault(), e.stopPropagation(), this.saveCurrentText(), O(A), this.focus(), !0)
...
function U(e, t) {
    ...
    for (let t of e.items)
        if ("file" === t.kind) {
            let e = null != (n = null != (r = null == (i = t.webkitGetAsEntry) ? void 0 : i.call(t)) ? r : null == (a = t.getAsEntry) ? void 0 : a.call(t)) ? n : null;
