/** chunk id: 306846 params = (module,exports,require) **/
let l;
t.d(i, {
    A: () => P
});
...
function R(e) {
    return e.features.has(f.GuildFeatures.DISCOVERABLE) ? I.J.DISCOVERABLE : e.features.has(f.GuildFeatures.MEMBER_VERIFICATION_GATE_ENABLED) && e.features.has(f.GuildFeatures.MEMBER_VERIFICATION_MANUAL_APPROVAL) ? I.J.APPLY : I.J.INVITE
}
...
function N(e, i) {
    ...
    switch (i) {
        case I.J.INVITE:
            return {
                joinType: I.J.INVITE, requireTerms: t, termRules: g(), isAgeRestricted: l
            };
        case I.J.APPLY:
            return {
                joinType: I.J.APPLY, pendingVerificationFields: C(), isAgeRestricted: l
            };
        case I.J.DISCOVERABLE:
            return {
                joinType: I.J.DISCOVERABLE, settingsView: h(), requireTerms: t, termRules: g(), isAgeRestricted: !1
            }
    }
}
...
function D(e, i) {
    ...
    if (e.features.has(f.GuildFeatures.MEMBER_VERIFICATION_MANUAL_APPROVAL) || e.features.has(f.GuildFeatures.MEMBER_VERIFICATION_GATE_ENABLED) !== t) return !0;
    let n = m() ?? [];
    ...
    switch (l.joinType) {
        ...
        case I.J.APPLY:
            let n, s = m(),
                ...
                u = !e.features.has(f.GuildFeatures.MEMBER_VERIFICATION_GATE_ENABLED) || !e.features.has(f.GuildFeatures.MEMBER_VERIFICATION_MANUAL_APPROVAL);
            n = null == s ? null != a : null != a && !r().isEqual(s, a), T = {
...
function y() {
    ...
    l = l.joinType === I.J.APPLY ? {
        ...l,
        pendingVerificationFields: C()
    } : {
        ...l,
        termRules: g()
    }, L()
...
class F extends s.Ay.Store {
    ...
    initialize() {
        this.waitFor(c.Ay, E.A, o.A, u.A), this.syncWith([o.A, u.A], () => {
            L()
        })
    }
    get pendingState() {
