...
function C(t) {
    let {
        onDismiss: e
    } = t, C = (0, r.bG)([E.A], () => E.A.getGuildId()), m = (0, r.bG)([u.A], () => null != C ? u.A.getChannelId(C) : null, [C]), g = C ?? null, O = (0, r.bG)([d.A], () => null != g ? d.A.getGuild(g) : null, [g]), {
        shouldShowIncidentActions: S,
        incidentData: y,
        isUnderLockdown: x
    } = (0, T.Li)(g), U = (0, o.fw)(O?.id ?? N.dJq), P = l.useCallback(() => null != O && (0, c.aZ)(O.id), [O]);
    if (null == O || null == y || !S) return null;
    let M = t => {
            t && U && m !== R.VV.MEMBER_SAFETY && P() ? _.default.track(N.HAw.APP_NOTICE_PRIMARY_CTA_OPENED, {
