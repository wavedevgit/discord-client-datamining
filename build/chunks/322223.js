...
function S(e) {
    let {
        ...
        incidentData: y,
        isUnderLockdown: x
    } = (0, A.Li)(R), P = (0, o.fw)(g?.id ?? N.dJq), f = l.useCallback(() => null != g && (0, c.aZ)(g.id), [g]);
    if (null == g || null == y || !O) return null;
    let D = e => {
            e && P && C !== p.VV.MEMBER_SAFETY && f() ? E.default.track(N.HAw.APP_NOTICE_PRIMARY_CTA_OPENED, {
