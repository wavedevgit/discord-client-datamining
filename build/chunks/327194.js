/** Chunk was on web.js **/
/** chunk id: 327194, original params: e,t,n (module,exports,require) **/
"use strict";
n.d(t, {
    P: () => I
}), n(65821), n(896048);
...
class I {
    ...
    async createOutOfProcessOverlayHostWindow(e) {
        ...
        try {
            ...
            n = await this.getNativeWindowHandleWithRetry(), c.A.resetWindowState(), (0, d._r)(e, "native_window_handle_retrieved", {
                ...
                hasWindow: null != n,
                popoutInitializationStages: u.A.getPopoutInitializationStages()
            }), await (0, d.pi)(e, n), (null == (i = this.module) ? void 0 : i.setOnWindowHandleInitializedCallback) == null && await (0, d.i0)(!0)
        } catch (t) {
    ...
    destroyOutOfProcessOverlayHostWindow() {
        ...
        try {
            var e, t;
            null === r.A || void 0 === r.A || null == (e = r.A.window) || e.close(m.f), null === r.A || void 0 === r.A || null == (t = r.A.window) || t.setBackgroundThrottling(!0), c.A.resetWindowState(!1)
        } catch (e) {
    ...
    async getNativeWindowHandleWithRetry() {
        ...
        return await this.getWithRetry(async () => {
            var e;
            let t = await (null === r.A || void 0 === r.A || null == (e = r.A.window) ? void 0 : e.getNativeHandle(m.f));
    ...
    constructor() {
        g(this, "module", null), g(this, "modulePromise", null), g(this, "isCrashedDisabled", !1), g(this, "lastAssociatedPID", null), g(this, "trackedGamePids", new Set)
    }
}
g(I, "instance", null)