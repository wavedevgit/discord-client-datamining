/** chunk id: 306327 params = (module,exports,require) **/
"use strict";
let a;
    ...
    if (a) {
        ...
        return a[2].replace(/\/?\s*(none|[-\w.]+(?:%|deg|g?rad|turn)?)/g, (a, n) => {
            ...
            if (o) {
                ...
                "%" === e ? (s = new Number(t / 100)).type = "<percentage>" : ((s = new Number(t * f[e])).type = "<angle>", s.unit = e)
...
function R(e, t, r, a = {}) {
    if (e = x(e), t = x(t), !e || !t) throw TypeError(`Missing white point to convert ${!e?"from":""}${!e&&!t?"/":""}${!t?"to":""}`);
    if (e === t) return r;
    let o = {
        W1: e,
        W2: t,
    ...
    if (k.run("chromatic-adaptation-start", o), o.M || (o.W1 === E.D65 && o.W2 === E.D50 ? o.M = [
        ...
        ])), k.run("chromatic-adaptation-end", o), o.M) return n(o.M, o.XYZ);
    ...
    if (r.parsed = b(r.str), r.parsed) {
        ...
        if ("color" === e) {
            ...
            for (let a of B.all) {
                ...
                if (s && (n.includes(s.id) || s.ids?.filter(e => n.includes(e)).length)) {
                    let n, i = Object.keys(a.coords).map((e, t) => r.parsed.args[t] || 0);
                    return s.coordGrammar && (n = j(a, s, "color", i)), t && Object.assign(t, {
                        formatId: "color",
                        types: n
                    }), s.id.startsWith("--") && !e.startsWith("--") && C.warn(`${a.name} is a non-standard space and not currently supported in the CSS spec. Use prefixed color(${s.id}) instead of color(${e}).`), e.startsWith("--") && !s.id.startsWith("--") && C.warn(`${a.name} is a standard space and supported in the CSS spec. Use color(${s.id}) instead of prefixed color(${e}).`), {
                        spaceId: a.id,
                        coords: i,
                        alpha: o
                    }
        ...
        for (let a of B.all) {
            ...
            if (n && "function" === n.type) {
                ...
                let i = r.parsed.args;
                return n.coordGrammar && (o = j(a, n, e, i)), t && Object.assign(t, {
                    formatId: n.name,
                    types: o
                }), {
                    spaceId: a.id,
...
class B {
    constructor(e) {
        ...
        this.formats.color?.id || (this.formats.color = {
            ...this.formats.color ?? {},
            id: e.cssId || this.id
        }), e.gamutSpace ? this.gamutSpace = "self" === e.gamutSpace ? this : B.get(e.gamutSpace) : this.isPolar ? this.gamutSpace = this.base : this.gamutSpace = this, this.gamutSpace.isUnbounded && (this.inGamut = (e, t) => !0), this.referred = e.referred, Object.defineProperty(this, "path", {
            value: (function(e) {
                let t = [e];
    ...
    getFormat(e) {
        let t;
        return "object" == typeof e ? e = P(e, this) : (t = "default" === e ? Object.values(this.formats)[0] : this.formats[e]) ? t = P(t, this) : null
    }
    equals(e) {
    ...
    static resolveCoord(e, t) {
        let r, a, n = s(e);
        if ("string" === n ? e.includes(".") ? [r, a] = e.split(".") : [r, a] = [, e] : Array.isArray(e) ? [r, a] = e : (r = e.space, a = e.coordId), (r = B.get(r)) || (r = t), !r) throw TypeError(`Cannot resolve coordinate reference ${e}: No color space specified and relative references are not allowed here`);
        ...
        throw TypeError(`No "${a}" coordinate found in ${r.name}. Its coordinates are: ${Object.keys(r.coords).join(", ")}`)
    }
...
function P(e, {
    ...
    if (e.coords && !e.coordGrammar) {
        ...
        e.serializeCoords = (e, t) => e.map((e, a) => {
            let {
                fromRange: n,
                toRange: o,
                suffix: s
            } = r[a];
            return n && o && (e = m(n, o, e)), e = i(e, {
                precision: t,
                unit: s
            })
        })
...
class I extends B {
    constructor(e) {
        ...
        }), e.base || (e.base = D), e.toXYZ_M && e.fromXYZ_M && (e.toBase ??= t => {
            let r = n(e.toXYZ_M, t);
            return this.white !== this.base.white && (r = R(this.white, this.base.white, r)), r
        }, e.fromBase ??= t => (t = R(this.base.white, this.white, t), n(e.fromXYZ_M, t))), e.referred ??= "display", super(e)
    }
}
...
function z(e, t, r) {
    if (e = N(e), 2 == arguments.length && "object" === s(arguments[1])) {
        ...
        let {
            space: a,
            index: n
        } = B.resolveCoord(t, e.space), o = T(e, a);
        o[n] = r, F(e, a, o)
    }
    return e
}
...
var H = new B({
    ...
    toBase(e) {
        let t = [];
        return t[1] = (e[0] + 16) / 116, t[0] = e[1] / 500 + t[1], t[2] = t[1] - e[2] / 200, [t[0] > U ? Math.pow(t[0], 3) : (116 * t[0] - 16) / W, e[0] > 8 ? Math.pow((e[0] + 16) / 116, 3) : e[0] / W, t[2] > U ? Math.pow(t[2], 3) : (116 * t[2] - 16) / W].map((e, t) => e * G[t])
    },
    formats: {
        lab: {
...
var Y = new B({
    ...
    fromBase(e) {
        let t, [r, a, n] = e;
        return t = .02 > Math.abs(a) && .02 > Math.abs(n) ? NaN : 180 * Math.atan2(n, a) / Math.PI, [r, Math.sqrt(a ** 2 + n ** 2), Z(t)]
    },
    toBase(e) {
        let [t, r, a] = e;
...
function Q(e, t, {
    ...
    let o, s;
    [e, t] = N([e, t]);
    let [i, c, l] = H.from(e), u = Y.from(H, [i, c, l])[1], [f, b, d] = H.from(t), h = Y.from(H, [f, b, d])[1];
    u < 0 && (u = 0), h < 0 && (h = 0);
    let p = K((u + h) / 2),
        m = .5 * (1 - Math.sqrt(p / (p + 0x16bcc41e9))),
        g = (1 + m) * c,
        y = (1 + m) * b,
        v = Math.sqrt(g ** 2 + l ** 2),
        w = Math.sqrt(y ** 2 + d ** 2),
    ...
    let O = f - i,
        ...
        x = M + A,
        R = Math.abs(E);
    v * w == 0 ? o = 0 : R <= 180 ? o = E : E > 180 ? o = E - 360 : E < -180 ? o = E + 360 : C.warn("the unthinkable has happened");
    let _ = 2 * Math.sqrt(w * v) * Math.sin(o * V / 2),
        j = (i + f) / 2,
        S = (v + w) / 2,
        B = K(S),
        P = (j - 50) ** 2,
        D = 1 + .015 * P / Math.sqrt(20 + P),
        I = 1 + .045 * S,
        T = 1 + .015 * S * (1 - .17 * Math.cos(((s = v * w == 0 ? x : R <= 180 ? x / 2 : x < 360 ? (x + 360) / 2 : (x - 360) / 2) - 30) * V) + .24 * Math.cos(2 * s * V) + .32 * Math.cos((3 * s + 6) * V) - .2 * Math.cos((4 * s - 63) * V)),
        L = (O / (r * D)) ** 2;
    return Math.sqrt(L += (k / (a * I)) ** 2 + (_ / (n * T)) ** 2 + k / (a * I) * (-1 * Math.sin(2 * (30 * Math.exp(-1 * ((s - 275) / 25) ** 2)) * V) * (2 * Math.sqrt(B / (B + 0x16bcc41e9)))) * (_ / (n * T)))
}
let ee = [
...
function eo(e, t) {
    [e, t] = N([e, t]);
    let [r, a, n] = en.from(e), [o, s, i] = en.from(t);
...
function es(e, t, {
    ...
    let a = e.coords;
    return t !== e.space && (a = t.from(e)), t.inGamut(a, {
        epsilon: r
    })
}
...
function ec(e, t, r = "lab") {
    let a = (r = B.get(r)).from(e),
        n = r.from(t);
    return Math.sqrt(a.reduce((e, t, r) => {
        let a = n[r];
...
var ev = new B({
        ...
        base: eu,
        fromBase(e) {
            let [t, r, a] = e, o = n(ep, [1.15 * t - (1.15 - 1) * a, .66 * r - (.66 - 1) * t, a]).map(function(e) {
                return ((.8359375 + 18.8515625 * (e / 1e4) ** ef) / (1 + 18.6875 * (e / 1e4) ** ef)) ** ed
            }), [s, i, c] = n(eg, o);
            return [.43999999999999995 * s / (1 + -.56 * s) - 16295499532821565e-27, i, c]
        },
        toBase(e) {
            let [t, r, a] = e, o = n(ey, [(t + 16295499532821565e-27) / (.43999999999999995 - -.56 * (t + 16295499532821565e-27)), r, a]).map(function(e) {
                return 1e4 * ((.8359375 - e ** eh) / (18.6875 * e ** eh - 18.8515625)) ** eb
            }), [s, i, c] = n(em, o), l = (s + (1.15 - 1) * c) / 1.15;
            return [l, (i + (.66 - 1) * l) / .66, c]
        },
        formats: {
            color: {
                coords: ["<number> | <percentage>", "<number> | <percentage>[-1,1]", "<number> | <percentage>[-1,1]"]
    ...
    ew = new B({
        ...
        fromBase(e) {
            let t, [r, a, n] = e;
            return t = 2e-4 > Math.abs(a) && 2e-4 > Math.abs(n) ? NaN : 180 * Math.atan2(n, a) / Math.PI, [r, Math.sqrt(a ** 2 + n ** 2), Z(t)]
        },
...
var ej = new B({
    ...
    fromBase: e => {
        var t;
        return t = n(eE, e), n(ex, t.map(function(e) {
            return ((.8359375 + eM * (e / 1e4) ** eA) / (1 + 18.6875 * (e / 1e4) ** eA)) ** eO
        }))
    },
    toBase: e => n(e_, n(eR, e).map(function(e) {
        let t = Math.max(e ** eC - .8359375, 0);
...
function eU(e, t, r, a, o) {
    ...
    s.c = a[1], s.nc = a[2];
    let f = (1 / (5 * s.la + 1)) ** 4;
    s.fl = f * s.la + .1 * (1 - f) * (1 - f) * Math.cbrt(5 * s.la), s.flRoot = s.fl ** .25, s.n = s.yb / c, s.z = 1.48 + Math.sqrt(s.n), s.nbb = .725 * s.n ** -.2, s.ncb = s.nbb;
    let b = o ? 1 : Math.max(Math.min(u * (1 - 1 / 3.6 * Math.exp((-s.la - 42) / 92)), 1), 0);
    s.dRgb = l.map(e => h(1, c / e, b)), s.dRgbInv = s.dRgb.map(e => 1 / e);
    let d = e$(l.map((e, t) => e * s.dRgb[t]), s.fl);
    return s.aW = s.nbb * (2 * d[0] + d[1] + .05 * d[2]), s
}
let eW = eU(eS, 64 / Math.PI * .2, 20, "average", !1);
...
function eG(e, t) {
    ...
    let o = 0,
        s = Math.cos(o = void 0 !== e.h ? Z(e.h) * eq : function(e) {
            let t = (e % 400 + 400) % 400,
                r = Math.floor(.01 * t);
            t %= 100;
            let [a, n] = eT.slice(r, r + 2), [o, s] = eL.slice(r, r + 2);
            return Z((t * (s * a - o * n) - 100 * a * s) / (t * (s - o) - 100 * s))
        }(e.H) * eq),
        i = Math.sin(o),
        c = 0;
    void 0 !== e.J ? c = .1 * w(e.J, .5) : void 0 !== e.Q && (c = .25 * t.c * e.Q / ((t.aW + 4) * t.flRoot));
    let l = 0;
    void 0 !== e.C ? l = e.C / c : void 0 !== e.M ? l = e.M / t.flRoot / c : void 0 !== e.s && (l = 4e-4 * e.s ** 2 * (t.aW + 4) / t.c);
    let u = w(l * Math.pow(1.64 - Math.pow(.29, t.n), -.73), 10 / 9),
        f = .25 * (Math.cos(o + 2) + 3.8),
        b = t.aW * w(c, 2 / t.c / t.z),
        d = 5e4 / 13 * t.nc * t.ncb * f,
        h = b / t.nbb,
        p = 23 * (h + .305) * M(u, 23 * d + u * (11 * s + 108 * i)),
        m = (r = n(eD, [h, p * s, p * i]).map(e => e / 1403), a = 100 / t.fl * 2588.068098016295, r.map(e => {
            let t = Math.abs(e);
            return v(a * w(t / (400 - t), 2.380952380952381), e)
        }));
    return n(eP, m.map((e, r) => e * t.dRgbInv[r])).map(e => e / 100)
}

function eH(e, t) {
    let r = e$(n(eB, e.map(e => 100 * e)).map((e, r) => e * t.dRgb[r]), t.fl),
        a = r[0] + (-12 * r[1] + r[2]) / 11,
        o = (r[0] + r[1] - 2 * r[2]) / 9,
        s = (Math.atan2(o, a) % eN + eN) % eN,
        i = .25 * (Math.cos(s + 2) + 3.8),
        c = w(5e4 / 13 * t.nc * t.ncb * M(i * Math.sqrt(a ** 2 + o ** 2), r[0] + r[1] + 1.05 * r[2] + .305), .9) * Math.pow(1.64 - Math.pow(.29, t.n), .73),
        l = w(t.nbb * (2 * r[0] + r[1] + .05 * r[2]) / t.aW, .5 * t.c * t.z),
        u = 100 * w(l, 2),
...
var eQ = new B({
    ...
    toBase: e => (function(e, t) {
        ...
        if (0 === n) return [0, 0, 0];
        let i = eV(n);
        s = n > 0 ? .00379058511492914 * n ** 2 + .608983189401032 * n + .9155088574762233 : 9514440756550361e-21 * n ** 2 + .08693057439788597 * n - 21.928975842194614;
        let c = 0,
            l = 1 / 0;
        for (; c <= 15;) {
            let e = Math.abs((o = eG({
...
function e1(e) {
    ...
    let t = Math.log(Math.max(1 + .0228 * e[1] * eK.flRoot, 1)) / .0228,
        r = e[0] * e0,
        a = t * Math.cos(r),
        n = t * Math.sin(r);
    return [e[2], a, n]
...
var e2 = {
    ...
    deltaECMC: function(e, t, {
        ...
        [e, t] = N([e, t]);
        let [n, o, s] = H.from(e), [, i, c] = Y.from(H, [n, o, s]), [l, u, f] = H.from(t), b = Y.from(H, [l, u, f])[1];
        i < 0 && (i = 0), b < 0 && (b = 0);
        let d = n - l,
            h = i - b,
            p = o - u,
            m = s - f,
            g = .511;
        n >= 16 && (g = .040975 * n / (1 + .01765 * n));
        let y = .0638 * i / (1 + .0131 * i) + .638;
        Number.isNaN(c) && (c = 0);
        let v = Math.pow(i, 4),
            w = Math.sqrt(v / (v + 1900)),
            M = y * (w * (c >= 164 && c <= 345 ? .56 + Math.abs(.2 * Math.cos((c + 168) * el)) : .36 + Math.abs(.4 * Math.cos((c + 35) * el))) + 1 - w),
            A = (d / (r * g)) ** 2;
    ...
    deltaEJz: function(e, t) {
        [e, t] = N([e, t]);
        let [r, a, n] = ew.from(e), [o, s, i] = ew.from(t);
        Number.isNaN(n) && Number.isNaN(i) ? (n = 0, i = 0) : Number.isNaN(n) ? n = i : Number.isNaN(i) && (i = n);
        let c = 2 * Math.sqrt(a * s) * Math.sin((n - i) / 2 * (Math.PI / 180));
        return Math.sqrt((r - o) ** 2 + (a - s) ** 2 + c ** 2)
    },
    deltaEITP: function(e, t) {
        [e, t] = N([e, t]);
        let [r, a, n] = ej.from(e), [o, s, i] = ej.from(t);
        return 720 * Math.sqrt((r - o) ** 2 + .25 * (a - s) ** 2 + (n - i) ** 2)
    },
    deltaEOK: eo,
    deltaEHCT: function(e, t) {
        [e, t] = N([e, t]);
        let [r, a, n] = e1(eQ.from(e)), [o, s, i] = e1(eQ.from(t));
        return Math.sqrt((r - o) ** 2 + (a - s) ** 2 + (n - i) ** 2)
    }
};
let e5 = {
...
function e3(e, {
    ...
    let i;
    if (e = N(e), o(arguments[1]) ? r = arguments[1] : r || (r = e.space), es(e, r = B.get(r), {
            epsilon: 0
        })) return e;
    if ("css" === t) i = function(e, {
        space: t
    } = {}) {
        e = N(e), t || (t = e.space), t = B.get(t);
        let r = B.get("oklch");
        ...
        for (; i - s > 1e-4;) {
            let e = (s + i) / 2;
            if (l.coords[1] = e, c && es(l, t, {
                    epsilon: 0
                })) s = e;
            else if ((f = eo(u = o(l), l)) < .02)
                if (.02 - f < 1e-4) break;
                else c = !1, s = e;
            else i = e
        }
        ...
        if ("clip" === t || es(e, r)) i = e9(e, r);
            ...
            if (o(e, u) > n) {
                ...
                if (3 === Object.keys(s).length) {
                    ...
                    if (c(r) && (r = 0), r >= s.max) return e9({
                        space: "xyz-d65",
                        coords: E.D65
                    }, e.space);
                    if (r <= s.min) return e9({
                        space: "xyz-d65",
                        coords: [0, 0, 0]
                    }, e.space)
                }
                ...
                let h = (u.range || u.refRange)[0],
                    p = (a = (l = n) ? Math.floor(Math.log10(Math.abs(l))) : 0, Math.max(parseFloat(`1e${a-2}`), 1e-6)),
                    m = h,
                    g = L(d, b);
                for (; g - m > p;) {
                    let e = ei(d);
                    o(d, e = e3(e, {
                        space: r,
                        method: "clip"
                    })) - n < p ? m = L(d, b) : g = L(d, b), z(d, b, (m + g) / 2)
                }
                i = e9(d, r)
            } else i = u
        }
...
function e4(e, {
    ...
    if ((a ||= r.toGamut) && !es(e) && (c = e3(ei(e), !0 === a ? void 0 : a).coords), "custom" === r.type)
        ...
        let a = r.name || "color";
        r.serializeCoords ? c = r.serializeCoords(c, t) : null !== t && (c = c.map(e => i(e, {
            precision: t
        })));
        let n = [...c];
        if ("color" === a) {
...
var e7 = new I({
        ...
        fromXYZ_M: [
            [1.716651187971268, -.355670783776392, -.25336628137366],
            [-.666684351832489, 1.616481236634939, .0157685458139111],
        ...
        formats: {
            ...
            keyword: {
                ...
                parse(e) {
                    ...
                    if ("transparent" === e ? (t.coords = tn.black, t.alpha = 0) : t.coords = tn[e], t.coords) return t
                }
            }
        }
    }),
...
var ty = new B({
        ...
        toBase(e) {
            let t = [];
            return t[1] = (e[0] + 16) / 116, t[0] = e[1] / 500 + t[1], t[2] = t[1] - e[2] / 200, [t[0] > tp ? Math.pow(t[0], 3) : (116 * t[0] - 16) / tm, e[0] > 8 ? Math.pow((e[0] + 16) / 116, 3) : e[0] / tm, t[2] > tp ? Math.pow(t[2], 3) : (116 * t[2] - 16) / tm].map((e, t) => e * tg[t])
        },
        formats: {
            "lab-d65": {
                coords: ["<number> | <percentage>", "<number> | <percentage>[-1,1]", "<number> | <percentage>[-1,1]"]
    ...
    tv = Object.freeze({
        ...
        contrastAPCA: function(e, t) {
            ...
            let s = .2126729 * td(a) + .7151522 * td(n) + .072175 * td(o);
            e = e9(e, "srgb"), [a, n, o] = e.coords;
            let i = .2126729 * td(a) + .7151522 * td(n) + .072175 * td(o),
                c = tb(s),
                l = tb(i);
            return 100 * (.1 > Math.abs(r = 5e-4 > Math.abs(l - c) ? 0 : l > c ? 1.14 * (l ** .56 - c ** .57) : 1.14 * (l ** .65 - c ** .62)) ? 0 : r > 0 ? r - .027 : r + .027)
        },
        contrastDeltaPhi: function(e, t) {
            e = N(e), t = N(t);
            let r = Math.pow(Math.abs(Math.pow(L(e, [ty, "l"]), 1.618033988749895) - Math.pow(L(t, [ty, "l"]), 1.618033988749895)), .6180339887498948) * Math.SQRT2 - 40;
            return r < 7.5 ? 0 : r
        },
...
function tw(e) {
    let [t, r, a] = T(e, D), n = t + 15 * r + 3 * a;
    return [4 * t / n, 9 * r / n]
}

function tM(e) {
    let [t, r, a] = T(e, D), n = t + r + a;
    return [t / n, r / n]
}
...
function tO(e, t, r = {}) {
    ...
    for (let r in e2)
        if ("deltae" + a.toLowerCase() === r.toLowerCase()) return e2[r](e, t, n);
    throw TypeError(`Unknown deltaE method: ${a}`)
}
var tk = Object.freeze({
    __proto__: null,
    darken: function(e, t = .25) {
        return z(e, [B.get("oklch", "lch"), "l"], e => e * (1 - t))
    },
    lighten: function(e, t = .25) {
        return z(e, [B.get("oklch", "lch"), "l"], e => e * (1 + t))
    }
});

function tC(e, t, r = .5, a = {}) {
    return [e, t] = [N(e), N(t)], "object" === s(r) && ([r, a] = [.5, r]), tx(e, t, a)(r)
}
...
function tE(e, t, r = {}) {
    ...
    let l = tO(e, t),
        ...
        f = [];
    if (void 0 !== i && (u = Math.min(u, i)), 1 === u) f = [{
        p: .5,
        color: a(.5)
    }];
    else {
        ...
        for (; e > n;) {
            ...
            for (let t = 1; t < f.length && f.length < i; t++) {
                let r = f[t - 1],
                    ...
                    o = (n.p + r.p) / 2,
                    s = a(o);
                e = Math.max(e, tO(s, r.color), tO(s, n.color)), f.splice(t, 0, {
                    p: o,
                    color: a(o)
                }), t++
            }
...
function tx(e, t, r = {}) {
    ...
    if (a = a ? B.get(a) : B.registry[C.interpolationSpace] || e.space, n = n ? B.get(n) : a, e = e9(e, a), t = e9(t, a), e = e3(e), t = e3(t), a.coords.h && "angle" === a.coords.h.type) {
        let n = r.hue = r.hue || "shorter",
            o = [a, "h"],
            [s, i] = [L(e, o), L(t, o)];
        isNaN(s) && !isNaN(i) ? s = i : isNaN(i) && !isNaN(s) && (i = s), [s, i] = function(e, t) {
            if ("raw" === e) return t;
            let [r, a] = t.map(Z), n = a - r;
            return "increasing" === e ? n < 0 && (a += 360) : "decreasing" === e ? n > 0 && (r += 360) : "longer" === e ? -180 < n && n < 180 && (n > 0 ? r += 360 : a += 360) : "shorter" === e && (n > 180 ? r += 360 : n < -180 && (a += 360)), [r, a]
        }(n, [s, i]), z(e, o, s), z(t, o, i)
    }
    return s && (e.coords = e.coords.map(t => t * e.alpha), t.coords = t.coords.map(e => e * t.alpha)), Object.assign(r => {
        r = o ? o(r) : r;
...
var t_ = Object.freeze({
        ...
        range: tx,
        register: function(e) {
            e.defineFunction("mix", tC, {
                returns: "color"
            }), e.defineFunction("range", tx, {
                returns: "function<color>"
            }), e.defineFunction("steps", tE, {
                returns: "array<color>"
            })
        },
        steps: tE
    ...
    tB = new I({
        ...
        fromXYZ_M: [
            [2.0415879038107465, -.5650069742788596, -.34473135077832956],
            [-.9692436362808795, 1.8759675015077202, .04155505740717557],
            [.013444280632031142, -.11836239223101838, 1.0151749943912054]
        ]
    }),
    tP = new I({
        id: "a98rgb",
...
function t8(e, t) {
    ...
    return Math.min(t3(e.r0s, e.r0i, r), t3(e.r1s, e.r1i, r), t3(e.g0s, e.g0i, r), t3(e.g1s, e.g1i, r), t3(e.b0s, e.b0i, r), t3(e.b1s, e.b1i, r))
}
var t9 = new B({
    id: "hsluv",
    name: "HSLuv",
    ...
    gamutSpace: ti,
    fromBase(e) {
        let t, [r, a, n] = [l(e[0]), l(e[1]), l(e[2])];
        return r > 99.9999999 ? (t = 0, r = 100) : r < 1e-8 ? (t = 0, r = 0) : t = a / t8(t6(r), n) * 100, [n, t, r]
    },
    toBase(e) {
        let t, [r, a, n] = [l(e[0]), l(e[1]), l(e[2])];
        return n > 99.9999999 ? (n = 100, t = 0) : n < 1e-8 ? (n = 0, t = 0) : t = t8(t6(n), r) / 100 * a, [n, t, r]
    },
    formats: {
        color: {
            id: "--hsluv",
...
function t7(e) {
    return Math.min(t4(e.r0s, e.r0i), t4(e.r1s, e.r1i), t4(e.g0s, e.g0i), t4(e.g1s, e.g1i), t4(e.b0s, e.b0i), t4(e.b1s, e.b1i))
}
...
var re = new B({
    ...
    fromBase(e) {
        let t, [r, a, n] = [l(e[0]), l(e[1]), l(e[2])];
        return r > 99.9999999 ? (t = 0, r = 100) : r < 1e-8 ? (t = 0, r = 0) : t = a / t7(t6(r)) * 100, [n, t, r]
    },
    toBase(e) {
        let t, [r, a, n] = [l(e[0]), l(e[1]), l(e[2])];
        return n > 99.9999999 ? (n = 100, t = 0) : n < 1e-8 ? (n = 0, t = 0) : t = t7(t6(n)) / 100 * a, [n, t, r]
    },
    formats: {
        color: {
            id: "--hpluv",
...
var rn = new I({
        ...
        base: e7,
        toBase: e => e.map(function(e) {
            return 1e4 * (Math.max(e ** ra - .8359375, 0) / (18.8515625 - 18.6875 * e ** ra)) ** rr / 203
        }),
        fromBase: e => e.map(function(e) {
            let t = Math.max(203 * e / 1e4, 0);
            return ((.8359375 + 18.8515625 * t ** rt) / (1 + 18.6875 * t ** rt)) ** 78.84375
        })
    }),
    ro = new I({
        id: "rec2100hlg",
...
k.add("chromatic-adaptation-start", e => {
    ...
    fromCone_M: [
        [1.8599363874558397, -1.1293816185800916, .21989740959619328],
        [.3611914362417676, .6388124632850422, -6370596838649899e-21],
    ...
    fromCone_M: [
        [.9869929054667121, -.14705425642099013, .15996265166373122],
        [.4323052697233945, .5183602715367774, .049291228212855594],
        [-.00852866457517732, .04004282165408486, .96848669578755]
    ]
}), ri({
    id: "CAT02",
    toCone_M: [
    ...
    fromCone_M: [
        [1.0961238208355142, -.27886900021828726, .18274517938277307],
        [.4543690419753592, .4735331543074117, .07209780371722911],
        [-.009627608738429355, -.00569803121611342, 1.0153256399545427]
    ]
}), ri({
    id: "CAT16",
    toCone_M: [
    ...
    fromCone_M: [
        [1.862067855087233, -1.0112546305316845, .14918677544445172],
        [.3875265432361372, .6214474419314753, -.008973985167612521],
        [-.01584149884933386, -.03412293802851557, 1.0499644368778496]
    ]
}), Object.assign(E, {
    A: [1.0985, 1, .35585],
    C: [.98074, 1, 1.18232],
    ...
    F7: [.95041, 1, 1.08747],
    F11: [1.00962, 1, .6435]
}), E.ACES = [.32168 / .33767, 1, 1.0088251843515859];
var rl = new I({
    id: "acescg",
    cssId: "--acescg",
    name: "ACEScg",
    ...
    ACEScc: new I({
        ...
        toBase(e) {
            ...
            return e.map(function(e) {
                return e <= t ? (2 ** (17.52 * e - 9.72) - 152587890625e-16) * 2 : e < ru ? 2 ** (17.52 * e - 9.72) : 65504
            })
        },
        fromBase: e => e.map(function(e) {
...
class rb {
    constructor(...e) {
        let t, r, a, n;
        1 === e.length && (t = N(e[0])), t ? (r = t.space || t.spaceId, a = t.coords, n = t.alpha) : [r, a, n] = e, Object.defineProperty(this, "space", {
            value: B.get(r),
            writable: !1,
            enumerable: !0,
            configurable: !0
        }), this.coords = a ? a.slice() : [0, 0, 0], this.alpha = n > 1 || void 0 === n ? 1 : n < 0 ? 0 : n;
    ...
    display(...e) {
        let t = function(e, {
            ...
            if ("u" < typeof CSS || CSS.supports("color", n) || !C.display_space)(n = new String(n)).color = e;
                ...
                let o = e;
                if ((e.coords.some(c) || c(e.alpha)) && !(a ??= CSS.supports("color", "hsl(none 50% 50%)")) && ((o = ei(e)).coords = o.coords.map(l), o.alpha = l(o.alpha), n = e4(o, r), CSS.supports("color", n))) return (n = new String(n)).color = o, n;
    ...
    static defineFunction(e, t, r = t) {
        ...
        e in rb || (rb[e] = o), a && (rb.prototype[e] = function(...e) {
            return o(this, ...e)
        })
    }
    ...
    static extend(e) {
        if (e.register) e.register(rb);
            ...
            for (let t in e) rb.defineFunction(t, e[t])
    }
}
for (let e of (rb.defineFunctions({
        ...
        to: e9,
        equals: function(e, t) {
            return e = N(e), t = N(t), e.space === t.space && e.alpha === t.alpha && e.coords.every((e, r) => e === t.coords[r])
        },
        inGamut: es,
        toGamut: e3,
        distance: ec,
        ...
        parse: S,
        defaults: C
    }), Object.keys(rf))) B.register(rf[e]);
...
function rd(e, t) {
    ...
    Object.defineProperty(rb.prototype, r, {
        get() {
            let r = this.getAll(e);
            return "u" < typeof Proxy ? r : new Proxy(r, {
                has: (e, r) => {
                    try {
...
k.add("colorspace-init-end", e => {
    rd(e.id, e), e.aliases?.forEach(t => {
        rd(t, e)
    })
}), rb.extend(e2), rb.extend({
    deltaE: tO
}), Object.assign(rb, {
    deltaEMethods: e2
}), rb.extend(tk), rb.extend({
    contrast: function(e, t, r = {}) {
        ...
        if (!a) {
            let e = Object.keys(tv).map(e => e.replace(/^contrast/, "")).join(", ");
...
}), rb.extend(tA), rb.extend(tf), rb.extend(t_), rb.extend(tv)