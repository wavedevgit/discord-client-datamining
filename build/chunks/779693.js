/** Chunk was on web.js **/
/** chunk id: 779693, original params: e,t,n (module,exports,require) **/
"use strict";
n.d(t, {
    X: () => s
});
...
class s {
    ...
    write(e, t) {
        ...
        for (let e of this.fields) {
            ...
            (0, o.vA)(void 0 !== s), n[t.useProtoFieldName ? e.name : e.jsonName] = s
        }
        return n
    }
    field(e, t, n) {
            ...
            switch (e.V.kind) {
                case "scalar":
                    for (let [n, r] of Object.entries(t)) {
                        ...
                        (0, o.vA)(void 0 !== t), i[n.toString()] = t
                    }
                    break;
                case "message":
                    let a = e.V.T();
                    for (let [r, s] of Object.entries(t)) {
                        ...
                        (0, o.vA)(void 0 !== t), i[r.toString()] = t
                    }
                    break;
                case "enum":
                    let s = e.V.T();
                    for (let [r, a] of Object.entries(t)) {
                        (0, o.vA)(void 0 === a || "number" == typeof a);
            ...
            switch (e.kind) {
                case "scalar":
                    for (let n = 0; n < t.length; n++) {
                        ...
                        (0, o.vA)(void 0 !== r), i.push(r)
                    }
                    break;
                case "enum":
                    let a = e.T();
                    for (let r = 0; r < t.length; r++) {
                        (0, o.vA)(void 0 === t[r] || "number" == typeof t[r]);
                        let s = this.enum(a, t[r], e.name, e.opt, !0, n.enumAsInteger);
                        (0, o.vA)(void 0 !== s), i.push(s)
                    }
                    break;
                case "message":
                    let s = e.T();
    ...
    enum(e, t, n, r, i, a) {
        return "google.protobuf.NullValue" == e[0] ? null : void 0 === t ? void(0, o.vA)(r) : 0 !== t || i || r ? ((0, o.vA)("number" == typeof t), (0, o.vA)(Number.isInteger(t)), a || !e[1].hasOwnProperty(t)) ? t : e[2] ? e[2] + e[1][t] : e[1][t] : void 0
    }
    message(e, t, n, r) {
        return void 0 === t ? r.emitDefaultValues ? null : void 0 : e.internalJsonWrite(t, r)
    }
    scalar(e, t, n, s, l) {
        if (void 0 === t) return void(0, o.vA)(s);
        let c = l || s;
        switch (e) {
            case a.LN.INT32:
            case a.LN.SFIXED32:
            ...
            case a.LN.SINT64:
                ...
                return d.toString();
            case a.LN.BYTES:
                if ((0, o.vA)(t instanceof Uint8Array), !t.byteLength) return c ? "" : void 0;
                return (0, r.C)(t)
        }
    }
}