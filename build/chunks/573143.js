/** chunk id: 573143, original params: e,t,n (module,exports,require) **/
"use strict";
n.d(t, {
    A: () => S,
    o: () => N
...
let g = new s.J(function(e) {
        let t = [];
        return t.push(e.channelId), (e.eventType === u.i.ACTIVITY_ENDED || e.eventType === u.i.USER_LEFT) && t.push(m(e.channelId)), t
    }, function(e) {
...
let S = new I(l.h, {
    VOICE_STATE_UPDATES: function(e) {
        let t = !1,
            n = new Set;
        return e.voiceStates.forEach(e => {
            let {
                userId: i,
                oldChannelId: s,
                channelId: l
            ...
            if (null != s && null != g.values(s, !0)) {
                ...
                e = p(a.userId, s), l = g.get(e), g.set(e, {
                    ...a,
                    channelId: s,
                    timestamp: Date.now(),
                    ...
                    eventType: u.i.USER_LEFT,
                    key: e
                }), n.add(s), 0 === Object.values(c.A.getVoiceStatesForChannel(s)).map(e => e.userId).length && E(s), t = !0
            }
            null != l && x(l) && (f(l, {
                userId: i,
                timestamp: Date.now(),
    ...
    PRESENCE_UPDATES: function(e) {
        ...
        return e.updates.forEach(e => {
            let {
                user: n,
                activities: i
            } = e, s = n.id, l = c.A.getVoiceStateForUser(s), a = l?.channelId;
            if (null != a && x(a)) {
                for (let e of g.values(a, !0)) e.userId !== s || e.eventType !== u.i.ACTIVITY_STARTED || i.some(t => t.application_id === e.applicationId || t.name === e.applicationName) || (! function(e) {
                    let t = Date.now() - e.timestamp;
                    null != (e.applicationId ?? e.applicationName) && t >= h && g.set(e.key, {
                        ...e,
                        timestamp: Date.now(),
    ...
    VOICE_CHANNEL_HISTORY_START_TRACKING: function(e) {
        ...
        if (!x(t)) return x(t) || (Object.values(c.A.getVoiceStatesForChannel(t)).forEach(e => {
            f(t, {
                userId: e.userId,
                timestamp: Date.now(),
                eventType: u.i.USER_JOINED
