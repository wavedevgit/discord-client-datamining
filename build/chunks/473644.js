...
function v(e) {
    let {
        ...
        discoveryGuild: v,
        showGuildTag: I = !1
    } = e, f = i.approximate_presence_count ?? 0, T = i.approximate_member_count ?? 0, C = (0, a.bG)([g.default], () => g.default.locale), N = (0, u.P)(p.default.extractTimestamp(t.id), C), y = (0, a.bG)([o.A], () => v?.primary_category_id != null ? o.A.getCategoryName(v.primary_category_id) : null), D = t.premiumTier ?? A.TVA.NONE, S = D !== A.TVA.NONE, L = t.preferredLocale ?? v?.preferred_locale ?? null, b = n.useMemo(() => {
