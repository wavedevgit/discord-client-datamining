/** chunk id: 969508 params = (module,exports,require) **/
n.d(t, {
    FG: () => P,
    aV: () => U,
    uD: () => D
...
function D(e, t) {
    let {
        ...
        customId: a,
        components: r
    } = e, i = (0, m.A)(), [c, p] = l.useState(null), [A, h] = l.useState(null), [C, E] = l.useState({}), N = (0, s.bG)([O.A], () => O.A.getModalState(A), [A]), I = (0, u.A)(() => new Set), _ = l.useCallback(async () => {
        let t;
    ...
    l.useEffect(() => {
        N === O.Z.SUCCEEDED && (o.h.dispatch({
            ...
            customId: a
        }), d.A.removeFiles(e.channelId, M(e.channelId, a).map(e => e.id), x.C.InteractionModal), t()), N === O.Z.ERRORED && p(b.intl.string(b.t.uJgdEu))
    }, [A, N, t, a, e.channelId]);
    let {
...
function U(e) {
    ...
    } = L(t), i = E.A.getChannel(e.channelId);
    r()(null != i, "channel should not be null");
    let o = {
        instance_id: `${e.channelId}:${t.id}:${n}`,
        custom_id: n,
    ...
    switch (t.type) {
        ...
        case c.I5.TEXT_INPUT: {
            ...
            return {
                ...
                value: n?.type === t.type ? n.value : null
            }
        }
        ...
        case c.I5.STRING_SELECT: {
            ...
            return {
                type: t.type,
                custom_id: t.customId,
                values: n?.type === t.type ? n.values : null
            }
        }
...
async function w(e, t, n) {
    ...
    (0, h.tU)(n, {
        data: {
            interactionType: c.G4.MODAL_SUBMIT,
            applicationId: e.application.id
        },
        preflight: o
    }), await o;
    let d = s.map((e, t) => (0, v.OW)(e, t)),
        u = k(e.customId, e.components, {
            uploads: s
        }),
        m = () => {
            t?.aborted || i.Bo.post({
