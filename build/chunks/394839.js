...
function f(e) {
    ...
    let l = t.length;
    if (1 === l) return (0, i.jsx)(C, {
        itemsForLayout: t,
        isSingleImage: !0,
        footer: s,
        maxWidth: n
    });
    if (2 === l) return (0, i.jsx)(A, {
        itemsForLayout: t,
        maxWidth: n
    });
    if (3 === l) return (0, i.jsx)(j, {
        itemsForLayout: t,
        maxWidth: n
    });
...
function M(e) {
    let t, n, {
        ...
        } = e,
        {
            ...
            location: "MediaMosaicItemWrapper"
        }),
        f = s.item.type,
        C = {
            ...s,
            ..."IMAGE" === f && (t = s.className, {
                className: a()(t, p.s_),
                imgContainerClassName: p.nh,
                imgClassName: p.g2
            }),
            ...("VIDEO" === f || I && "CLIP" === f) && (n = s.className, {
                className: a()(n, p.g2)
            }),
            displayGridItem: h,
...
let N = function(e) {
    let {
        ...
        let {
            enableClipsNewEmbedUi: t = !1
        } = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : {};
        return s.useMemo(() => {
            let [n, i] = d().partition(e, e => (0, h.Xg)(e.item.type)), [s, l] = d().partition(n, e => (0, h.EF)(e.item.type, {
                enableClipsNewEmbedUi: t
            }));
            return {
        ...
        enableClipsNewEmbedUi: l
    }), c = n ? g.ww : g.k6;
    return (0, i.jsxs)(i.Fragment, {
        children: [r.length > 0 && (0, i.jsx)("div", {
            className: a()(p.XU, {
                [p.dM]: n,
                [p.eO]: l && 1 === r.length && "CLIP" === r[0].item.type
            }),
            children: (0, i.jsx)(f, {
                visualMediaItems: r,
                maxWidth: c
