/** chunk id: 541285 params = (module,exports,require) **/
"use strict";
n.d(t, {
    Ay: () => y
});
...
function v(e) {
    let {
        ...
        role: n,
        locked: l
    } = e, r = (0, o.bG)([g.default], () => g.default.getCurrentUser()), u = s.useMemo(() => _.cc({
        user: r,
        context: t
    }), [r, t]), m = s.useMemo(() => ({
        [n.id]: {
...
function y(e) {
    ...
    } = e, [d, u] = s.useState(o ?? ""), m = s.useMemo(() => h.A.generateGuildPermissionSpec(t), [t]).map(e => ({
        ...e,
