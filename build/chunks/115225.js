...
let g = t => {
    let {
        subscriptionId: i,
        invitedUser: e,
        subscriptionGroupMemberId: g,
        onClose: P,
        ...k
    } = t, [m, A] = (0, l.useState)(!1), [N, S] = (0, l.useState)(!1), [T, f] = (0, l.useState)(!1);
    (0, r.Ay)(() => {
        o.default.track(I.HAw.PREMIUM_GROUP_CANCEL_INVITE_MODAL_VIEWED, {
            subscription_id: i,
            invited_user_id: e.id
        })
    });
    let U = async () => {
        o.default.track(I.HAw.PREMIUM_GROUP_CANCEL_INVITE_CTA_CLICKED, {
            subscription_id: i,
            invited_user_id: e.id
        }), f(!0);
