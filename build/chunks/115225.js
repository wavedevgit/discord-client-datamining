/** chunk id: 115225, original params: t,i,e (module,exports,require) **/
e.d(i, {
    default: () => S
});
var a = e(627968),
...
let S = t => {
    let {
        ...
        onClose: P,
        ...g
    } = t, [N, T] = (0, n.useState)(!1), [k, m] = (0, n.useState)(!1), [A, U] = (0, n.useState)(!1);
    (0, r.Ay)(() => {
        c.default.track(I.HAw.PREMIUM_GROUP_CANCEL_INVITE_MODAL_VIEWED, {
            subscription_id: i,
            invited_user_id: e.id
        })
    });
    let f = async () => {
        c.default.track(I.HAw.PREMIUM_GROUP_CANCEL_INVITE_CTA_CLICKED, {
            subscription_id: i,
            invited_user_id: e.id
        }), U(!0);
    ...
    return N ? (0, a.jsx)(s.Modal, {
        ...
        actions: [{
            ...
            variant: "secondary",
            onClick: () => {
                (0, u.openUserSettings)(d.X.SUBSCRIPTIONS_PANEL, {
                    section: I.nc_.SUBSCRIPTIONS
                }), P()
            }
        }],
        onClose: P,
        ...
        onClose: P,
        actions: [{
            text: p.intl.string(E.default["2blqtw"]),
            variant: "critical-primary",
            onClick: f,
            loading: A
        }],
        ...g,
        children: k && (0, a.jsx)(l.wx6, {
            type: "critical",
