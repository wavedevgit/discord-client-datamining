...
class l extends o.G {
    ...
    internalBinaryWrite(e, t, n) {
        "" !== e.header && t.tag(1, r.O0.LengthDelimited).string(e.header), "" !== e.body && t.tag(2, r.O0.LengthDelimited).string(e.body), "" !== e.assetUrl && t.tag(3, r.O0.LengthDelimited).string(e.assetUrl), e.asset && s.i.internalBinaryWrite(e.asset, t.tag(4, r.O0.LengthDelimited).fork(), n).join();
