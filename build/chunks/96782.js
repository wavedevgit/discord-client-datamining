...
function w(e) {
    let {
        ...
        type: z,
        contentType: B
    } = n, [$, K] = s.useState(!1), Y = t.getChannelId(), Z = f.A.getChannel(Y), J = (0, p.A)(Y), ee = s.useMemo(() => null != B && -1 !== B.indexOf("/") ? B.split("/") : ["unknown", "unknown"], [B]), et = !1;
    if (V) {
        (null == q || null == X) && (et = !0);
        let e = (0, C.U8)({
            width: q ?? 0,
...
let S = function(e) {
    let {
        ...
        height: A,
        type: E
    } = n, N = r(n, (0, x.P)(l)), [L, v] = s.useState(null != N), O = (0, c.qZ)(N), S = u === y.dG.MOSAIC, P = !S && (null != f && f < 200 || null != A && A < 50), W = "IMAGE" === E || "VIDEO" === E, T = (0, j.Xg)(E), _ = d && null != N && (0, c.j8)(f, A), [D, H] = s.useState(!1), b = () => {
        H(!0)
    }, F = () => {
        H(!1)
    }, G = function() {
