...
let O = e => {
    let {
        ...
        showDownload: r,
        isVisualMediaType: h
    } = e, c = s.useRef(null), [x, g] = s.useState(0);
    (0, d.i4)(c, e => {
        let {
            width: t
        } = e;
...
function w(e) {
    let {
        ...
        type: B,
        contentType: Q
    } = n, [$, K] = s.useState(!1), Y = t.getChannelId(), Z = f.A.getChannel(Y), J = (0, p.A)(Y), ee = s.useMemo(() => null != Q && -1 !== Q.indexOf("/") ? Q.split("/") : ["unknown", "unknown"], [Q]), et = !1;
    if (b) {
        (null == q || null == X) && (et = !0);
        let e = (0, j.U8)({
            width: q ?? 0,
...
let S = function(e) {
    let {
        ...
        height: A,
        type: E
    } = n, N = r(n, (0, x.P)(l)), [M, v] = s.useState(null != N), O = (0, h.qZ)(N), S = u === y.dG.MOSAIC, W = !S && (null != f && f < 200 || null != A && A < 50), P = "IMAGE" === E || "VIDEO" === E, T = (0, C.Xg)(E), _ = d && null != N && (0, h.j8)(f, A), [D, H] = s.useState(!1), F = () => {
        H(!0)
    }, G = () => {
        H(!1)
    }, V = function() {
