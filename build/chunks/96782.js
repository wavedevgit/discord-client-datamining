...
function P(e) {
    let {
        ...
        type: B,
        contentType: $
    } = n, [K, Y] = s.useState(!1), Z = t.getChannelId(), J = C.A.getChannel(Z), ee = (0, I.A)(Z), et = s.useMemo(() => null != $ && -1 !== $.indexOf("/") ? $.split("/") : ["unknown", "unknown"], [$]), en = !1;
    if (V) {
        (null == X || null == Q) && (en = !0);
        let e = (0, j.U8)({
            width: X ?? 0,
...
let S = function(e) {
    let {
        ...
        location: "MessageMediaMosaicItem"
    }), v = r(n, (0, g.P)(l)), [O, w] = s.useState(null != v), S = (0, h.qZ)(v), W = u === E.dG.MOSAIC, T = !W && (null != C && C < 200 || null != A && A < 50), _ = function(e) {
        let {
