/** chunk id: 207963, original params: t,e,n (module,exports,require) **/
n.d(e, {
    At: () => U,
    bO: () => D,
    f5: () => R,
...
function O(t, e) {
    let n = i.useContext(P),
        l = i.useCallback(e => {
            ...
            return n.setValidationErrors?.(e => ({
                ...e,
                [t.id]: l
            })), null == l
        }, [t, n]);
    return i.useEffect(() => {
        let t = () => l(e);
        return n.validators?.add(t), () => {
            n.validators?.delete(t)
        }
    }, [n.validators, l, e, t.id]), {
        error: n.validationErrors?.[t.id] ?? null,
        validate: l
    }
}
...
function L(t, e, n, l) {
        ...
        o = (t => {
            let e = p.A.getChannel(t),
                ...
                i = (0, r.bG)([g.Ay, A.default], () => {
                    ...
                    return (e?.guild_id != null && null != t ? g.Ay.getMember(e?.guild_id, t.id)?.isPending : null) ?? !1
                }),
                [, a] = (0, s.c)(e?.guild_id),
                u = (0, T.H_)(e),
                o = (0, T.lK)(e);
    ...
    return {
        state: a,
        executeStateUpdate: i.useCallback(e => {
            if (!C(e)) return !1;
            let l = p.A.getChannel(t.channel_id);
            return null != l && null != n.customId && (0, E.Gv)({
