...
function u() {
    let [e, t] = (0, s.useState)(""), [n, i] = (0, s.useState)("server-order"), c = (0, a.bG)([o.Ay], () => o.Ay.getFlattenedGuildIds()), u = (0, a.bG)([l.A], () => l.A.getGuilds()), _ = c.map(e => u[e]), m = r.Pw.useSetting(), [A, g] = (0, s.useState)(m);
    (0, s.useEffect)(() => {
        g(m)
    }, [m]);
    let h = async e => {
