...
let d = {
    ...
    b = e => {
        let {
            ...
            reset: n,
            setCurrentTab: b
        } = (0, o.v)(), p = r.useMemo(() => e !== c.G2.RIVALS && (e !== c.G2.ORBS || t) ? (0, c.dF)(e) ? c.G2.CATALOG : e : c.G2.HOME, [e, t]), [S, E] = r.useState(p), [h, A] = r.useState(c.Pf.VISIBLE);
        r.useEffect(() => {
            b(S)
        }, [S, b]), r.useEffect(() => {
        ...
        let {
            ...
            if (e !== c.G2.RIVALS) {
                ...
                if (S !== e) {
                    ...
                    E(e === c.G2.HOME || e === c.G2.ORBS ? e : c.G2.CATALOG), t && A(c.Pf.IN), m.push(u.BVt.COLLECTIBLES_SHOP_WITH_TAB(e), {
                        shallow: !0
                    }), A(c.Pf.VISIBLE)
                }
            }
