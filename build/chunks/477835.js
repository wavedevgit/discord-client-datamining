...
function y(e) {
    let {
        ...
        mute: O,
        suppress: L
    } = (0, E.A)(t), R = (0, s.bG)([I.Ay], () => I.Ay.isDeaf()), P = O || L || R, [D, j] = l.useState(!1), M = t.getGuildId(), w = (0, C.VE)({
        isSoundboardButtonDisabled: P
    }), [U, G] = (0, p.DP)(w), {
        analyticsLocations: k,
        parentAnalyticsLocation: V
    } = (0, _.Ay)(h.A.SOUNDBOARD_BUTTON);

    function B(e) {
        null != M && (0, A.L3)(e, async () => {
            let {
                default: e
    ...
    return (0, f.Vo)({
        ...
        children: (0, i.jsx)(d.m, {
            targetElementRef: y,
            text: O ? v.intl.string(v.t["Ox4/zU"]) : L ? v.intl.string(v.t["+YBKYI"]) : R ? v.intl.string(v.t.X1lQli) : v.intl.string(v.t["6EJvHt"]),
            asContainer: !0,
            shouldShow: !D,
            children: (0, i.jsx)(u.YNO, {
                ...
                renderPopout: e => {
                    ...
                    return (0, i.jsx)(N.A, {
                        ...
                        channel: t,
                        onClose: n,
                        gridNotice: U === o.M.CUSTOM_CALL_SOUNDS_PICKER_UPSELL && (0, i.jsx)(T.m, {
                            onClose: n,
                            markAsDismissed: G
                        }),
                ...
                children: e => (0, i.jsx)("div", {
                    ...
                    children: (0, i.jsx)(c.$n, {
                        ...
                        disabled: P,
                        onClick: () => {
                            null != U && U !== o.M.CUSTOM_CALL_SOUNDS_PICKER_UPSELL && G(x.i.UNKNOWN), j(!D), (0, m.X)(V, m.O.SOUNDBOARD)
                        },
                        onContextMenu: B,
                        fullWidth: !0,
