/** chunk id: 7891 params = (module,exports,require) **/
"use strict";
n.d(t, {
    A: () => y
});
...
let C = [0xdb2389, 0xba2be9, 8804082, 6576370, 5335282, 2652110, 2128781, 2196594, 4752414, 0xc75a38, 0xc74138, 12401e3, 0xc5579d, 5659039, 4092591, 5868359, 6586142, 8876063, 8484432, 9979976, 5269106, 3421236],
    ...
    v = e => {
        ...
        } = (0, j.KE)(), [A, f] = s.useState(t.features.has(N.GuildFeatures.CREATOR_STORE_PAGE)), [v, S] = s.useState(l?.store_page_primary_color ?? b), [y, R] = s.useState(l?.store_page_trailer_url), O = null == y || null != y.match(I), [G, L] = s.useState(l?.store_page_show_subscriber_count ?? !1), D = s.useRef(l?.store_page_slug).current, M = A !== t.features.has(N.GuildFeatures.CREATOR_STORE_PAGE) || l?.store_page_primary_color == null && v !== b || l?.store_page_primary_color != null && v !== l?.store_page_primary_color || y !== l?.store_page_trailer_url || null != G && G !== l?.store_page_show_subscriber_count, k = async () => {
            o()(null != l, "Settings must be defined");
            let e = {};
            A !== t.features.has(N.GuildFeatures.CREATOR_STORE_PAGE) && (e.store_page_enabled = A), (l?.store_page_primary_color == null && v !== b || l?.store_page_primary_color != null && v !== l?.store_page_primary_color) && (e.store_page_primary_color = v), y !== l?.store_page_trailer_url && (e.store_page_trailer_url = y), G !== l?.store_page_show_subscriber_count && (e.store_page_show_subscriber_count = G), Object.keys(e).length > 0 && (await d(t.id, e), "store_page_enabled" in e && p.default.track(N.HAw.GUILD_ROLE_SUBSCRIPTION_STORE_PAGE_TOGGLED, {
                enabled: A,
                ...(0, h.H$)(t.id)
            }))
        ...
        return (0, i.jsxs)(m.BJc, {
            ...
            children: [(0, i.jsx)(m.Heading, {
                ...
                children: E.intl.string(E.t.N6Tg9A)
            }), (0, i.jsxs)(m.BJc, {
                gap: 8,
                children: [(0, i.jsx)(m.dOG, {
                    ...
                    children: E.intl.string(E.t.mIgfEu)
                }) : null]
            }), (0, i.jsx)(m.cGx, {}), (0, i.jsxs)(m.D0$, {
                ...
                children: M && (0, i.jsx)(m.FQk, {
                    children: (0, i.jsx)(u.A, {
                        submitting: a,
                        onReset: () => {
                            f(t.features.has(N.GuildFeatures.CREATOR_STORE_PAGE)), S(l?.store_page_primary_color ?? b), R(l?.store_page_trailer_url), L(l?.store_page_show_subscriber_count ?? !1)
                        },
                        onSave: k,
                        disabled: B
                    })
