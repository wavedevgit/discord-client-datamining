...
function c(e, t, n, i) {
    switch (e) {
        case a.pe.TIER_0:
            return t.days > 0 ? E.intl.formatToPlainString(E.t.sP5OqC, {
                days: t.days
        ...
        case a.pe.TIER_2:
            return t.days > 0 ? E.intl.formatToPlainString(E.t.GPqVWT, {
                days: t.days,
                trialPeriod: n,
                termsUrl: i
            }) : t.hours > 0 ? E.intl.formatToPlainString(E.t.WFMtg1, {
                hours: t.hours,
                trialPeriod: n,
                termsUrl: i
...
let _ = e => {
    ...
    return null == t || null == r ? null : c(r, n, (0, s.re)({
...
function d(e, t) {
    ...
    return e.days > 0 ? E.intl.formatToPlainString(E.t["7mw8CZ"], {
        days: e.days,
        discountPercentage: n
    }) : e.hours > 0 ? E.intl.formatToPlainString(E.t["0hYT6o"], {
        hours: e.hours,
        discountPercentage: n
    }) : E.intl.formatToPlainString(E.t["2rh7rw"], {
