...
function M(e) {
    let {
        ...
        data: A
    } = (0, u.YY)(c?.applicationId), x = (0, s.bG)([p.A], () => p.A.getBasicChannel(l.channel_id)?.guild_id, [l]), f = r.useMemo(() => null != A ? (0, I.A)(A, 45) : void 0, [A]), E = (0, T.G)(A?.id ?? ""), {
        openModal: P,
    ...
    return (0, i.jsx)(O, {
        ...
        iconSrc: f,
        onIconClick: () => {
            k(), C.default.track(S.HAw.STOREFRONT_SKU_MESSAGE_EMBED_CLICKED, {
                application_id: A.id,
                sku_id: c.id,
                area: "app_icon"
            })
