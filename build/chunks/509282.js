...
let L = (0, a.UT)([x.A, f.A, g.A], {
        ...
        get: e => {
            ...
            return {
                sku: t,
                storeListing: n,
                subscriptionPlan: null != i ? i[0] : void 0
            }
        },
        load: async e => {
...
function P(e) {
    ...
    let f = _.subscriptions.length,
        ...
        T = l.useMemo(() => f > 0 && E > 0 ? y.intl.formatToPlainString(y.t["jA648+"], {
            subCount: f,
            itemCount: E
        }) : f > 0 ? y.intl.formatToPlainString(y.t.GSfibA, {
            count: f
        }) : E > 0 ? y.intl.formatToPlainString(y.t.j7Go5A, {
            count: E
        }) : y.intl.string(y.t.rMA98g), [E, f]);
    ...
    return (0, i.jsx)(M, {
        appName: c.name,
        title: y.intl.formatToPlainString(y.t.XDRjs5, {
            appName: c.name
        }),
        description: T,
        link: `${location.protocol}//${location.host}${N.BVt.GLOBAL_DISCOVERY_APPS_PROFILE_SECTION(c.id,S.GlobalDiscoveryAppsSections.STORE)}`,
        onLinkCopy: () => {
            (0, v.K)(t, v.C.STORE_EMBED)
        },
        iconSrc: x,
        onIconClick: () => {
            L(), C.default.track(N.HAw.STOREFRONT_STORE_MESSAGE_EMBED_CLICKED, {
                application_id: t,
                area: "app_icon"
            })
        },
...
function D(e) {
    let {
        ...
        data: A
    } = (0, u.YY)(c?.applicationId), x = (0, a.bG)([p.A], () => p.A.getBasicChannel(s.channel_id)?.guild_id, [s]), f = l.useMemo(() => null != A ? (0, I.A)(A, 45) : void 0, [A]), E = (0, b.G)(A?.id ?? ""), {
        openModal: P,
    ...
    let w = c.type === N.Puh.SUBSCRIPTION,
        ...
        B = w ? O ? (0, i.jsxs)(i.Fragment, {
            children: [(0, i.jsx)(o.nys, {
                ...
                width: 12,
                height: 12
            }), " ", y.intl.string(y.t.wnifjC)]
        }) : (0, i.jsxs)(i.Fragment, {
            children: [(0, i.jsx)(o.RR9, {
                size: "custom",
                width: 12,
                height: 12
            }), " ", y.intl.string(y.t.NRC3ar)]
        }) : g?.description?.trim();
    "" === B && (B = void 0);
    let G = () => {
        C.default.track(N.HAw.STOREFRONT_SKU_MESSAGE_EMBED_CLICKED, {
            application_id: A.id,
            sku_id: c.id,
    ...
    return (0, i.jsx)(M, {
        ...
        title: c.name,
        description: B,
        link: `${location.protocol}//${location.host}${N.BVt.GLOBAL_DISCOVERY_APPS_PROFILE_SECTION(A.id,S.GlobalDiscoveryAppsSections.STORE)}`,
        onLinkCopy: () => {
        ...
        children: (0, i.jsxs)("div", {
            ...
            children: [(0, i.jsx)(o.Button, {
                variant: "secondary",
                onClick: () => {
                    U(), C.default.track(N.HAw.STOREFRONT_SKU_MESSAGE_EMBED_CLICKED, {
                        application_id: A.id,
                        sku_id: c.id,
                        area: "view_details"
                    })
    ...
    return (0, i.jsxs)("div", {
        ...
        children: [(0, i.jsxs)("div", {
            ...
            children: [(0, i.jsxs)("div", {
                ...
                onClick: () => {
                    (0, E.C)(r, () => {
                        (0, o.showToast)((0, o.createToast)(y.intl.string(y.t["L/PwZf"]), o.ToastType.SUCCESS)), d()
                    })
                },
                variant: "icon-only"
            })]
