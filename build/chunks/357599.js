...
function c(e) {
    ...
    return l.useMemo(() => {
        ...
        let e = c.filter(e => (e.category !== i.V.EPICGAMES || !!s.has(n)) && (e.category !== i.V.STEAM || d !== a.Y.RETIRED_ABANDONED) && o.includes(e.category));
        return null == t || d === a.Y.RETIRED_ABANDONED || e.some(e => e.category === i.V.STEAM) || e.push({
            category: i.V.STEAM,
            url: t
