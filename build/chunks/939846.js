...
function en(e) {
    let {
        pageWidth: t,
        onSidebarResize: n
    } = e, a = (0, d.bG)([P.Ay], () => P.Ay.getSidebarState(P.fe)), r = (0, d.bG)([D.A], () => D.A.getChannel(a?.channelId));
...
let er = (0, h.A)(function(e) {
    ...
    (0, m.Ay)(() => {
        _.I(Q.BVt.MESSAGE_REQUESTS), (0, y.d)("message-requests"), M.default.track(Q.HAw.MESSAGE_REQUESTS_VIEWED, {
