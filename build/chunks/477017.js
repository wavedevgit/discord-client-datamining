/** chunk id: 477017, original params: e,t,n (module,exports,require) **/
"use strict";
n.d(t, {
    A: () => f
});
var r = n(364242),
    ...
    a = n(476858),
    o = n(355418);
let s = RegExp(`([0-9]{1,2})(?:\xba|\xaa|\xb0)?(?:\\s*(?:desde|de|\\-|\\–|ao?|\\s)\\s*([0-9]{1,2})(?:\xba|\xaa|\xb0)?)?\\s*(?:de)?\\s*(?:-|/|\\s*(?:de|,)?\\s*)(${(0,a.uJ)(i.eB)})(?:\\s*(?:de|,)?\\s*(${i.fp}))?(?=\\W|$)`, "i"),
    l = 1,
    c = 2,
    u = 3,
    d = 4;
