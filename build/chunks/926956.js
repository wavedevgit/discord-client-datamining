/** chunk id: 926956 params = (module,exports,require) **/
t.d(n, {
    default: () => b
});
var i = t(627968),
...
function b(e) {
    let {
        ...
        onClose: a,
        guildId: b
    } = e, T = (0, u.GV)(), P = (0, s.bG)([A.A], () => A.A.getGuild(b)), L = (0, p.A)(P?.id), S = (0, N.Ay)(b), M = l.useRef(h.Ay.ackMessageId(b, G.P.GUILD_EVENT)), w = (0, j.A)();
    return l.useEffect(() => {
        ...
        r()(S).map(e => e.creator_id).filter(x.Vq).uniq().forEach(e => {
        ...
        children: [(0, i.jsxs)(c.rQ0, {
            ...
            children: [(0, i.jsx)(c.CTc, {
                ...
                children: S.length > 0 ? _.intl.formatToPlainString(_.t.IBdqSu, {
                    number: S.length
                ...
                children: [(0, i.jsx)("div", {
                    ...
                    onClick: () => {
                        (0, c.mMO)(async () => {
                            let {
                                default: e
                            } = await Promise.all([t.e("68587"), t.e("28136"), t.e("342"), t.e("70669")]).then(t.bind(t, 21653));
                            return n => (0, i.jsx)(e, {
                                ...n,
                                guildId: b
                            })
            ...
            className: I.Qs,
            "data-migration-pending": !0,
            children: S.length > 0 ? S.map(e => (0, i.jsx)(E.A, {
                guildEvent: e,
                onActionTaken: a,
