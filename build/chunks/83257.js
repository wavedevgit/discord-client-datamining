...
class A extends s.PureComponent {
    ...
    handleSetSection = e => {
        ...
        this.validNavigation() && !i && (r(), h.A.addBreadcrumb({
            category: "settings",
    ...
    renderSettingsSectionTabBarItem = (e, t, n) => {
        ...
        null != e.decoration ? x = (0, i.jsx)(l.Text, {
    ...
    renderSidebar(e) {
        let {
            section: t,
            title: n
        } = this.props, s = e.flatMap(e => e.newIndicatorDismissibleContentTypes).filter(e => null != e), r = t ?? e[0].section;
        return (0, i.jsx)(c.Ay, {
            contentTypes: s,
            children: t => {
                let {
