/** chunk id: 35092 params = (module,exports,require) **/
"use strict";
n.d(t, {
    A: () => w
});
...
let M = S.Z.SIZE_90,
    D = s.forwardRef(function(e, t) {
        let {
            ...
            trackUserProfileWishlistAction: h
        } = (0, C.NJ)(), A = s.useCallback(() => {
            h({
...
function U(e) {
    ...
    } = (0, m.Ay)(...a ?? [], A.A.SLAYER_STOREFRONT_BREADCRUMB_WISHLIST_ITEM_CARD_GIFT_BUTTON), [C, I] = ((0, u.useHasAnyModalOpen)(), (0, c.bG)([E.A], () => E.A.hasLayers()), (0, g.kn)([], v.m.SIDEBAR, !0)), N = s.useRef(null), b = s.useCallback(() => {
        I(v.i.USER_DISMISS), (0, x.a)(t, {
            isGift: !0,
            giftRecipient: n,
    ...
    }, [I, t, n, _]), S = s.useCallback(() => {
        h?.guildId != null && (I(v.i.USER_DISMISS), (0, f.R)({
            skuId: t.id,
    ...
    }, [h?.guildId, I, t.id, t.applicationId, _]), T = s.useCallback(() => {
        I(v.i.USER_DISMISS)
    }, [I]), j = s.useCallback(() => {
    ...
    return (0, i.jsxs)(i.Fragment, {
        children: [(0, i.jsx)(D, {
            ...
            onPurchaseClick: b,
            ...o
        }), C === d.M.GAME_SHOP_WISHLIST_POPOVER && (0, i.jsx)(G, {
            targetElementRef: N,
            onRequestClose: T,
            onActionClick: j
        })]
