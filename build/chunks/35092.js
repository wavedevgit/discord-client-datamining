...
function y(e) {
    ...
    } = (0, d.Ay)(...l ?? [], c.A.SLAYER_STOREFRONT_BREADCRUMB_WISHLIST_ITEM_CARD_GIFT_BUTTON), p = s.useCallback(() => {
        (0, m.a)(t, {
            isGift: !0,
            giftRecipient: n,
    ...
    }, [t, n, h]), g = s.useCallback(() => {
        a?.guildId != null && (0, A.R)({
            skuId: t.id,
    ...
    }, [a?.guildId, t.id, t.applicationId, h]), _ = s.useMemo(() => ({
        title: t.name,
        description: b.intl.format(b.t["CqpEC+"], {
...
function j(e) {
    ...
    }, [t?.tenantMetadata?.collectibles?.type]), A = s.useMemo(() => ({
        title: t.name,
