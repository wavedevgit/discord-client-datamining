...
let D = s.forwardRef(function(e, t) {
    ...
    }, [n, a, p, g]), _ = s.useMemo(() => d ? c : O.intl.string(O.t.pLPjsb), [d, c]), f = s.useMemo(() => d ? O.intl.string(O.t.ilhtIa) : "", [d]);
    return (0, i.jsx)("div", {
        className: L.kL,
        ref: t,
...
function U(e) {
    ...
    }), I = (0, u.useHasAnyModalOpen)(), N = (0, c.bG)([b.A], () => b.A.hasLayers()), [S, T] = (0, f.kn)(!x || 0 !== l || t.applicationId !== j.XR || I || N ? [] : [d.M.GAME_SHOP_WISHLIST_POPOVER], y.m.SIDEBAR, !0), R = s.useRef(null), L = s.useCallback(() => {
        T(y.i.USER_DISMISS), (0, E.a)(t, {
            isGift: !0,
            giftRecipient: n,
    ...
    return (0, i.jsxs)(i.Fragment, {
        children: [(0, i.jsx)(D, {
            ...
            tooltipIcon: (0, i.jsx)(_.mW, {
                application: h
            }),
            ...o
        }), S === d.M.GAME_SHOP_WISHLIST_POPOVER && (0, i.jsx)(G, {
            targetElementRef: R,
            onRequestClose: M,
            onActionClick: U
        })]
