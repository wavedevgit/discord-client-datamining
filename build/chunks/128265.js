/** Chunk was on web.js **/
/** chunk id: 128265, original params: e,t,n (module,exports,require) **/
"use strict";
n.d(t, {
    A: () => O
}), n(896048), n(114821), n(339614), n(775443), n(321073), n(667532), n(747238), n(812715), n(638769), n(264879);
var r = n(735438),
    i = n.n(r),
    a = n(871431),
    s = n(56562),
...
function g(e, t) {
    ...
    return (null != t.edited_timestamp ? +new Date(t.edited_timestamp) : 0) > i || e.embeds.length < (null != (n = null == (r = t.embeds) ? void 0 : r.length) ? n : 0) || e.content !== t.content
}
...
class y {
    clone() {
        let e = new y(this._isCacheBefore);
    ...
    constructor(e) {
        p(this, "_messages", void 0), p(this, "_map", void 0), p(this, "_wasAtEdge", void 0), p(this, "_isCacheBefore", void 0), this._messages = [], this._map = {}, this._wasAtEdge = !1, this._isCacheBefore = e
    }
}
class b {
    static forEach(e) {
        i().forEach(b._channelMessages, e)
    }
    static get(e) {
        return b._channelMessages[e]
    }
    static hasPresent(e) {
        let t = b.get(e);
    ...
    static getOrCreate(e) {
        let t = b._channelMessages[e];
        return null == t && (t = new b(e), b._channelMessages[e] = t), t
    }
    static clear(e) {
        delete b._channelMessages[e]
    }
    static clearCache(e) {
        let t = b._channelMessages[e];
    ...
    hasAnyAfter(e, t) {
        ...
        let i = this._array.indexOf(r);
        if (-1 === i) return !1;
        for (let e = i + 1; e < this.length && (-1 === n || e <= i + n); e++)
            if (t(this._array[e])) return !0;
        return !1
    }
    has(e) {
        let t = !(arguments.length > 1) || void 0 === arguments[1] || arguments[1];
    ...
    replace(e, t) {
        let n = this._map[e];
        return null == n ? this._before.has(e) ? this.mutate(n => n._before.replace(e, t), !0) : this._after.has(e) ? this.mutate(n => n._after.replace(e, t), !0) : this : this.mutate(r => {
    ...
    jumpToMessage(e) {
        ...
        return this.mutate(a => {
            a.jumped = !0, a.jumpedToPresent = !1, a.jumpType = null != i ? i : s.US.ANIMATED, a.jumpTargetId = e, a.jumpTargetOffset = null != e && null != n ? n : 0, a.jumpSequenceId = a.jumpSequenceId + 1, a.jumpFlash = t, a.jumpReturnTargetId = r, a.ready = !0, a.loadingMore = !1
        }, !1)
    }
    focusOnMessage(e) {
        return this.mutate(t => {
    ...
    loadComplete(e) {
        ...
        let b = [...e.newMessages],
            ...
            C = null != (d = e.cached) && d,
            N = i()(b).reverse().map(a.A.getCurrentConfig({
                location: "2ecb25_2"
            }, {
                autoTrackExposure: !1
        ...
        if ((O || v) && null == A && this.ready) w = this.merge(N, O, !0);
            ...
            w = this.reset(N), !n || O || v || (null == A ? void 0 : A.messageId) != null || (null == A ? void 0 : A.offset) != null ? h.info("loadComplete: resetting state for channelId=".concat(this.channelId, ", sending.length=").concat(e.length)) : (t.length > 0 && (h.info("loadComplete: merging with SEND_FAILED messages for channelId=".concat(this.channelId)), w = w.merge(t)), e.length > 0 && (h.info("loadComplete: merging with SENDING messages for channelId=".concat(this.channelId)), w = w.merge(e)))
        }
        let R = !C && w.cached && !T;
        return w.mutate({
            ready: !0,
            loadingMore: !1,
            jumpType: null != (p = null == A ? void 0 : A.jumpType) ? p : s.US.ANIMATED,
            jumpFlash: null != (_ = null == A ? void 0 : A.flash) && _,
            jumped: null != A,
            jumpedToPresent: null != (m = null == A ? void 0 : A.present) && m,
            ...
            jumpReturnTargetId: null != (y = null == A ? void 0 : A.returnMessageId) ? y : null,
    ...
    constructor(e) {
        p(this, "channelId", void 0), p(this, "ready", !1), p(this, "cached", !1), p(this, "jumpType", s.US.ANIMATED), p(this, "jumpTargetId", null), p(this, "jumpTargetOffset", 0), p(this, "jumpSequenceId", 1), p(this, "jumped", !1), p(this, "jumpedToPresent", !1), p(this, "jumpFlash", !0), p(this, "jumpReturnTargetId", null), p(this, "focusTargetId", null), p(this, "focusSequenceId", 1), p(this, "initialScrollSequenceId", 0), p(this, "hasMoreBefore", !0), p(this, "hasMoreAfter", !1), p(this, "loadingMore", !1), p(this, "revealedMessageId", null), p(this, "hasFetched", !1), p(this, "error", !1), p(this, "_array", []), p(this, "_before", new y(!0)), p(this, "_after", new y(!1)), p(this, "_map", {}), this.channelId = e
    }
}
