...
function b(e) {
    let {
        ...
        visibleChanged: q,
        targetRef: X
    } = (0, S.O7)(), [J, Z] = l.useState(b ? u.Q6.PLAYING : u.Q6.PAUSED), [ee, et] = l.useState(!1), [en, er] = l.useState(!1), [el, ei] = l.useState(0), [es, ea] = l.useState(null), eo = l.useCallback(e => {
        ea(null), ei(e)
    }, []), [eu, ec] = l.useState(!1), [ed, em] = l.useState(!0), [ep, eE] = l.useState(!1), [ef, ev] = l.useState([]), [eh, eg] = l.useState(!1), [eS, eC] = l.useState(!1), eA = l.useRef(!0), ex = l.useRef(null), e_ = l.useRef(null), eb = l.useRef(0);
    l.useLayoutEffect(() => {
        eb.current = performance.now()
    }, []);
    let [eT, ey] = l.useState(.3), [eN, eD] = l.useState(!1), [eL, eI] = l.useState(!1), [ej, eR] = l.useState(!1), [ek, ew] = l.useState(!1), eM = (0, o.bG)([m.A], () => m.A.useReducedMotion), eO = (0, l.useRef)(null), eP = (0, l.useRef)(null), eV = l.useRef(!0), [eQ, eU] = l.useState(null), [eB, eF] = l.useState(!1), [eG, e$] = l.useState(null), eY = w ?? eO.current?.duration ?? 0, [eK, eH] = l.useState(u.oA.MD), ez = {
        [u.oA.MD]: 50,
        [u.oA.LG]: 58
    };
    (0, d.u5)(() => {
    ...
    let eW = l.useCallback(e => {
        if (Z(e), Q?.(e), null != eO.current) switch (e) {
            case u.Q6.PLAYING:
    ...
    l.useEffect(() => {
        let e = null != n && (n === c.ip4.HIDDEN || n === c.ip4.EXITING || n === c.ip4.EXITED),
            t = null != n && q && !W,
            r = z && !H;
        (e || t || r) && null != eO.current && J === u.Q6.PLAYING && (eU(e || t ? "visibility" : "focus"), eW(u.Q6.PAUSED))
    }, [n, H, z, W, q, J, eW]);
    let [eq, eX] = l.useState(!1), eJ = l.useRef(null), eZ = l.useRef(0);
    l.useLayoutEffect(() => {
    ...
    let e6 = !eq && (en || ee || J === u.Q6.ENDED),
        e7 = l.useCallback(() => {
            ...
            null == e || (0, E._U)(e) || (e.removeEventListener(E.Wb, e7), ew(!1), U?.(!1), eH(u.oA.MD))
        }, [U]),
        e2 = () => {
    ...
    return (0, r.jsx)(c.DUT, {
        ...
        children: (0, r.jsxs)("div", {
            ...
            children: [to && V?.(), (0, r.jsxs)(p.A, {
                ...
                onTimeUpdate: e => {
                    null != eO.current && (j?.(eO.current.currentTime, eO.current.duration), eo(eO.current.currentTime / eO.current.duration * 100))
                },
                onEnded: e => {
                ...
                playerState: J,
                pauseReason: eQ
            }), eL && J !== u.Q6.ENDED && null != P && (0, r.jsxs)(r.Fragment, {
                children: [(0, r.jsx)(c.DUT, {
                    ...
                    style: {
                        marginBottom: (0, a.to)([tr, ts], (e, t) => `${e*ez[eK]+t}px`)
                    },
            ...
            }, J), ej && null != eG && !to && (0, r.jsx)(a.animated.div, {
                className: x.o$,
                ref: ti,
                ...
                children: [(0, r.jsx)(v.A, {
                    ...
                    children: (0, r.jsx)(f.A, {
                        ...
                        handleFullScreenBtnClick: () => {
                            ...
                            e && null != t ? ((0, E.tl)(t), t.addEventListener(E.Wb, e7), U?.(!0), eH(u.oA.LG)) : e || null == t || (t.removeEventListener(E.Wb, e7), U?.(!1), (0, E.sP)(t), eH(u.oA.MD)), ew(e)
                        },
