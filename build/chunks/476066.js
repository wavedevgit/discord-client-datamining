...
let w = {
    ...
    R = l.forwardRef(function(e, t) {
        let {
            ...
            eS(null), eb(e)
        }, []), [eA, eN] = l.useState(!1), [eT, ew] = l.useState(!0), [eR, ej] = l.useState(!1), [eD, eP] = l.useState([]), [eL, eM] = l.useState(!1), [ek, eI] = l.useState(!1), eB = l.useRef(!0), eU = l.useRef(null), eK = l.useRef(null), eO = l.useRef(0);
        l.useLayoutEffect(() => {
        ...
        let tl = l.useCallback(function(e) {
            ...
            if (eh(e), G?.(e, t), null != eJ.current) switch (e) {
                case u.Q6.PLAYING:
        ...
        let tf = l.useCallback(function(e) {
                ...
                eS(e / (eJ.current.duration ?? 1) * 100), eN(!0), e8(!1), eJ.current.currentTime = e, t && J?.(n, e)
            }, [J]),
            tx = () => {
        ...
        l.useEffect(() => (tN({
            ...
            controlBarAnimSpring: td || eL ? 1 : 0,
            immediate: eH
        }), () => {
            ty.stop()
        }), [td, tS, eH, eL, ty]);
        ...
        return (0, r.jsx)(d.DUT, {
            ...
            children: (0, r.jsxs)("div", {
                ...
                children: [tT && _?.({
                ...
                }), (eT || eR) && ep === u.Q6.PLAYING && null != es && (0, r.jsx)("span", {
                    className: T.S,
                    ...
                    children: Z()
                }), e$ && ep !== u.Q6.ENDED && null != O && (0, r.jsxs)(r.Fragment, {
