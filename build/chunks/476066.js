/** chunk id: 476066, original params: e,t,n (module,exports,require) **/
n.d(t, {
    A: () => _
}), n(321073);
var r = n(627968),
...
let b = {
    ...
    _ = l.forwardRef(function(e, t) {
        let {
            ...
            visibleChanged: en,
            targetRef: er
        } = (0, g.O7)(), [el, ei] = l.useState(y ? u.Q6.PLAYING : u.Q6.PAUSED), [ea, es] = l.useState(!1), [eo, eu] = l.useState(!1), [ec, ed] = l.useState(0), [em, ep] = l.useState(null), ef = l.useCallback(e => {
            ep(null), ed(e)
        }, []), [eE, eh] = l.useState(!1), [ev, ex] = l.useState(!0), [eg, eS] = l.useState(!1), [eA, eC] = l.useState([]), [eb, e_] = l.useState(!1), [ey, eT] = l.useState(!1), eN = l.useRef(!0), eD = l.useRef(null), eI = l.useRef(null), eL = l.useRef(0);
        l.useLayoutEffect(() => {
            eL.current = performance.now()
        }, []);
        let [ej, eM] = l.useState(.3), [ew, ek] = l.useState(!1), [eR, eP] = l.useState(!1), [eO, eQ] = l.useState(!1), [eV, eU] = l.useState(!1), eB = (0, o.bG)([m.A], () => m.A.useReducedMotion), eF = (0, l.useRef)(null), eG = (0, l.useRef)(null), e$ = l.useRef(!0), [eY, eK] = l.useState(null), [eH, eq] = l.useState(!1), [eW, ez] = l.useState(null), eX = R ?? eF.current?.duration ?? 0, [eJ, eZ] = l.useState(u.oA.MD), e0 = {
            [u.oA.MD]: 50,
            [u.oA.LG]: 58
        };
        (0, d.u5)(() => {
        ...
        let e1 = l.useCallback(function(e) {
            let t = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : null;
            if (ei(e), U?.(e, t), null != eF.current) switch (e) {
                case u.Q6.PLAYING:
        ...
        }, [i, Z, ee, et, en, el, e1]), l.useEffect(() => {
            ee && q?.(Z, el)
        ...
        let e3 = !e2 && (eo || ea || el === u.Q6.ENDED),
            ...
            te = () => {
                null == eF.current || (tn(Math.max(eF.current.currentTime - 10, 0)), el === u.Q6.ENDED && e1(u.Q6.PAUSED, "seek"))
            },
            tt = () => {
        ...
        let tn = l.useCallback(function(e) {
                let t = !(arguments.length > 1) || void 0 === arguments[1] || arguments[1];
                if (null == eF.current) return;
                let n = eF.current.currentTime;
                ep(e / (eF.current.duration ?? 1) * 100), eh(!0), eq(!1), eF.current.currentTime = e, t && z?.(n, e)
            }, [z]),
            tr = () => {
                if (null != eF.current) switch (el) {
                    case u.Q6.ENDED:
        ...
        l.useEffect(() => (tp({
            captionHeightSpring: eO && null != eW ? td.current?.clientHeight ?? 0 : 0,
            immediate: eB
        }), () => {
            tm.stop()
        }), [eO, tp, eB, eW, tm]), l.useEffect(() => (tc({
            controlBarAnimSpring: e3 || eb ? 1 : 0,
            immediate: eB
        }), () => {
            tu.stop()
        }), [e3, tc, eB, eb, tu]);
        ...
        return (0, r.jsx)(c.DUT, {
            ...
            children: (0, r.jsxs)("div", {
                ...
                children: [tf && V?.(), (0, r.jsxs)(p.A, {
                    ref: e => {
                        eF.current = e, er.current = e, "function" == typeof t ? t(e) : null != t && (t.current = e)
                    },
                    autoPlay: y,
                    playsInline: !0,
                    ...
                    onTimeUpdate: e => {
                        null != eF.current && (M?.(eF.current.currentTime, eF.current.duration), ef(eF.current.currentTime / eF.current.duration * 100))
                    },
                    onEnded: e => {
                    ...
                    onLoadedMetadata: e => {
                        null != eF.current && (j > 0 && tn(j, !1), ew ? eF.current.volume = 0 : eF.current.volume = ej)
                    },
                    onLoadStart: () => {
                    ...
                    children: [null != O && (0, r.jsx)("track", {
                        ...
                        onError: () => ts(u.SB.SOURCE_ERROR),
                        src: J,
                        type: "video/mp4"
                    })]
                }), (ev || eg) && el === u.Q6.PLAYING && null != J && (0, r.jsx)("span", {
                    className: C.S,
                    ...
                    hasVideoAsset: null != J,
                    playerState: el,
                    pauseReason: eY
                }), null != X && (0, r.jsx)(s.animated.div, {
                    className: C.R4,
                    style: {
                    ...
                    children: X()
                }), eR && el !== u.Q6.ENDED && null != Q && (0, r.jsxs)(r.Fragment, {
                    children: [(0, r.jsx)(c.DUT, {
                        ...
                        style: {
                            marginBottom: (0, s.to)([tu, tm], (e, t) => `${e*e0[eJ]+t}px`)
                        },
                    ...
                    className: a()(C.yf, {
                        [C.ZH]: el === u.Q6.PLAYING,
                        [C.v7]: el === u.Q6.PAUSED
                    }),
                    style: {
                        "--custom-play-pause-pop-ms": "1000ms"
                    },
                    children: el === u.Q6.PLAYING ? (0, r.jsx)(c.udU, {
                        className: C.PK
                    }) : (0, r.jsx)(c.E$n, {
                        className: C.PK
                    })
                }, el), eO && null != eW && !tf && (0, r.jsx)(s.animated.div, {
                    className: C.o$,
                    ref: td,
                    ...
                    children: [(0, r.jsx)(s.animated.div, {
                        ...
                        children: (0, r.jsx)(E.A, {
                            ...
                            handleFullScreenBtnClick: () => {
                                ...
                                e && null != t ? ((0, f.tl)(t), t.addEventListener(f.Wb, e5), B?.(!0), eZ(u.oA.LG)) : e || null == t || (t.removeEventListener(f.Wb, e5), B?.(!1), (0, f.sP)(t), eZ(u.oA.MD)), eU(e)
                            },
