...
function b(e) {
    let {
        ...
        visibleChanged: q,
        targetRef: X
    } = (0, g.O7)(), [J, Z] = i.useState(b ? u.Q6.PLAYING : u.Q6.PAUSED), [ee, et] = i.useState(!1), [en, er] = i.useState(!1), [ei, es] = i.useState(0), [el, ea] = i.useState(null), eo = i.useCallback(e => {
        ea(null), es(e)
    }, []), [eu, ec] = i.useState(!1), [ed, em] = i.useState(!0), [ep, eE] = i.useState(!1), [ef, ev] = i.useState([]), [eh, ex] = i.useState(!1), [eg, eS] = i.useState(!1), eC = i.useRef(!0), eA = i.useRef(null), e_ = i.useRef(null), eb = i.useRef(0);
    i.useLayoutEffect(() => {
        eb.current = performance.now()
    }, []);
    let [eT, ey] = i.useState(.3), [eN, eD] = i.useState(!1), [eL, ej] = i.useState(!1), [eI, eM] = i.useState(!1), [ek, eR] = i.useState(!1), ew = (0, o.bG)([m.A], () => m.A.useReducedMotion), eO = (0, i.useRef)(null), eP = (0, i.useRef)(null), eV = i.useRef(!0), [eQ, eU] = i.useState(null), [eB, eF] = i.useState(!1), [eG, e$] = i.useState(null), eK = R ?? eO.current?.duration ?? 0, [eY, eH] = i.useState(u.oA.MD), ez = {
        [u.oA.MD]: 50,
        [u.oA.LG]: 58
    };
    (0, d.u5)(() => {
    ...
    let [eq, eX] = i.useState(!1), eJ = i.useRef(null), eZ = i.useRef(0);
    i.useLayoutEffect(() => {
    ...
    let e6 = !eq && (en || ee || J === u.Q6.ENDED),
        ...
        e4 = () => {
            ...
            e9(e), J !== u.Q6.ENDED && e >= eO.current.duration && eW(u.Q6.ENDED)
        };
    i.useEffect(() => {
        let e = eO.current;
        return () => {
    ...
    i.useEffect(() => (ta({
        captionHeightSpring: eI && null != eG ? ts.current?.clientHeight ?? 0 : 0,
        immediate: ew
    }), () => {
        tl.stop()
    ...
    return (0, r.jsx)(c.DUT, {
        ...
        children: (0, r.jsxs)("div", {
            ...
            children: [to && V?.(), (0, r.jsxs)(p.A, {
                ...
                onTimeUpdate: e => {
                    null != eO.current && (I?.(eO.current.currentTime, eO.current.duration), eo(eO.current.currentTime / eO.current.duration * 100))
                },
                onEnded: e => {
                ...
                onLoadedMetadata: e => {
                    null != eO.current && (j > 0 && e9(j), eN ? eO.current.volume = 0 : eO.current.volume = eT)
                },
                onLoadStart: () => {
            ...
            }), (ed || ep) && J === u.Q6.PLAYING && null != Y && (0, r.jsx)("span", {
                className: A.S,
                ...
                children: [(0, r.jsx)(c.DUT, {
                    ...
                    style: {
                        marginBottom: (0, a.to)([tr, tl], (e, t) => `${e*ez[eY]+t}px`)
                    },
            ...
            }, J), eI && null != eG && !to && (0, r.jsx)(a.animated.div, {
                className: A.o$,
                ref: ts,
