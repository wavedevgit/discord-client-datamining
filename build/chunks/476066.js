...
let y = {
    ...
    T = l.forwardRef(function(e, t) {
        let {
            ...
            visibleChanged: ei,
            targetRef: es
        } = (0, g.O7)(), [eo, eu] = l.useState(T ? u.Q6.PLAYING : u.Q6.PAUSED), [ec, ed] = l.useState(!1), [em, ep] = l.useState(!1), [eE, ef] = l.useState(0), [eh, ev] = l.useState(null), ex = l.useCallback(e => {
            ev(null), ef(e)
        }, []), [eg, eS] = l.useState(!1), [eA, eb] = l.useState(!0), [e_, eC] = l.useState(!1), [ey, eT] = l.useState([]), [eN, eD] = l.useState(!1), [eI, eR] = l.useState(!1), eL = l.useRef(!0), ew = l.useRef(null), eM = l.useRef(null), ek = l.useRef(0);
        l.useLayoutEffect(() => {
            ek.current = performance.now()
        }, []);
        let [eP, ej] = l.useState(.3), [eO, eU] = l.useState(!1), [eB, eQ] = l.useState(!1), [eV, eK] = l.useState(!1), [eF, e$] = l.useState(!1), eY = (0, o.bG)([m.A], () => m.A.useReducedMotion), eG = (0, l.useRef)(null), eH = (0, l.useRef)(null), ez = l.useRef(!0), [eW, eq] = l.useState(null), eX = l.useCallback((e, t) => {
            P?.(e, t)
        }, [P]), {
            isHlsActive: eJ
        } = (0, A.Ay)(eG, {
        ...
        let e5 = l.useCallback(function(e) {
            let t = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : null;
            if (eu(e), V?.(e, t), null != eG.current) switch (e) {
                case u.Q6.PLAYING:
        ...
        }, [a, er, el, ea, ei, eo, e5]), l.useEffect(() => {
            el && W?.(er, eo)
        }, [er, el, eo, W]), l.useEffect(() => {
            ei && q?.(ea, eo)
        }, [ea, ei, eo, q]);
        let [te, tt] = l.useState(!1), tn = l.useRef(null), tr = l.useRef(0);
        l.useLayoutEffect(() => {
            tr.current = performance.now()
        }, []);
        let tl = l.useCallback(() => {
                null != tn.current && clearTimeout(tn.current), eo !== u.Q6.PLAYING || (tn.current = setTimeout(() => {
        ...
        let tc = l.useCallback(function(e) {
                ...
                ev(e / (eG.current.duration ?? 1) * 100), eS(!0), e0(!1), eG.current.currentTime = e, t && X?.(n, e)
            }, [X]),
            td = () => {
                if (null != eG.current) switch (eo) {
                    case u.Q6.ENDED:
        ...
        l.useEffect(() => (tS({
            captionHeightSpring: eV && null != e1 ? tx.current?.clientHeight ?? 0 : 0,
            immediate: eY
        }), () => {
            tg.stop()
        }), [eV, tS, eY, e1, tg]), l.useEffect(() => (tv({
            controlBarAnimSpring: ti || eN ? 1 : 0,
            immediate: eY
        }), () => {
            th.stop()
        }), [ti, tv, eY, eN, th]);
        let tA = eo === u.Q6.ENDED,
            tb = l.useCallback(function() {
        ...
        return (0, r.jsx)(c.DUT, {
            ...
            children: (0, r.jsxs)("div", {
                ...
                children: [tA && Q?.({
                    ...
                    ref: e => {
                        eG.current = e, es.current = e, "function" == typeof t ? t(e) : null != t && (t.current = e)
                    },
                    autoPlay: T,
                    playsInline: !0,
                    ...
                    onTimeUpdate: e => {
                        null != eG.current && (M?.(eG.current.currentTime, eG.current.duration), ex(eG.current.currentTime / eG.current.duration * 100))
                    },
                    onEnded: e => {
                    ...
                    onProgress: e => {
                        ...
                        for (let e = 0; e < eG.current.buffered.length; e++) {
                            ...
                            r - n < 1 || t.push({
                                start: n / eG.current.duration,
                                size: (r - n) / eG.current.duration
                            })
                        }
                        eT(t)
                    },
                ...
                }), (eA || e_) && eo === u.Q6.PLAYING && null != en && (0, r.jsx)("span", {
                    className: C.S,
                    ...
                    className: C.R4,
                    style: {
                        opacity: (0, s.to)([th.to({
                            range: [0, 1],
                            output: [0, 1]
                        })], e => `${e}`),
                        visibility: (0, s.to)([th.to({
                            range: [0, 1],
                            output: [0, 1]
                        })], e => e < .1 ? "hidden" : "visible"),
                        pointerEvents: (0, s.to)([th.to({
                            range: [0, 1],
                            output: [0, 1]
                        })], e => e < .3 ? "none" : "auto")
                    },
                    children: J()
                }), eB && eo !== u.Q6.ENDED && null != B && (0, r.jsxs)(r.Fragment, {
                    ...
                    className: i()(C.yf, {
                        [C.ZH]: eo === u.Q6.PLAYING,
                        [C.v7]: eo === u.Q6.PAUSED
                    }),
                    style: {
                        "--custom-play-pause-pop-ms": "1000ms"
                    },
                    children: eo === u.Q6.PLAYING ? (0, r.jsx)(c.udU, {
                        className: C.PK
                    }) : (0, r.jsx)(c.E$n, {
                        className: C.PK
                    })
                }, eo), eV && null != e1 && !tA && (0, r.jsx)(s.animated.div, {
                    className: C.o$,
                    ref: tx,
                    ...
                    children: [(0, r.jsx)(s.animated.div, {
                        ...
                        style: {
                            paddingTop: (0, s.to)([th.to({
                                range: [0, 1],
                                output: [0, 1]
                            })], e => `${e*e*12}px`),
                            paddingBottom: (0, s.to)([th.to({
                                range: [0, 1],
                                output: [0, 1]
                            })], e => `${e*e*12}px`),
                            pointerEvents: (0, s.to)([th.to({
    ...
    N = l.forwardRef(function(e, t) {
        ...
        } = a, [d, m] = l.useState(!1), p = l.useCallback(() => {
            m(!0)
        }, []), E = l.useRef(null);
        return n || d ? (0, r.jsx)(T, {
            ...a,
            autoplay: s || d,
            ref: t
        }) : (0, r.jsx)(c.DUT, {
