...
function b(e) {
    let {
        ...
        visibleChanged: z,
        targetRef: X
    } = (0, g.O7)(), [J, Z] = l.useState(b ? u.Q6.PLAYING : u.Q6.PAUSED), [ee, et] = l.useState(!1), [en, er] = l.useState(!1), [el, ei] = l.useState(0), [ea, es] = l.useState(null), eo = l.useCallback(e => {
        es(null), ei(e)
    }, []), [eu, ec] = l.useState(!1), [ed, em] = l.useState(!0), [ep, eE] = l.useState(!1), [ef, eh] = l.useState([]), [ev, ex] = l.useState(!1), [eg, eS] = l.useState(!1), eA = l.useRef(!0), eC = l.useRef(null), e_ = l.useRef(null), eb = l.useRef(0);
    l.useLayoutEffect(() => {
        eb.current = performance.now()
    }, []);
    let [eT, ey] = l.useState(.3), [eN, eD] = l.useState(!1), [eI, eL] = l.useState(!1), [ej, eM] = l.useState(!1), [ew, ek] = l.useState(!1), eR = (0, o.bG)([m.A], () => m.A.useReducedMotion), eP = (0, l.useRef)(null), eO = (0, l.useRef)(null), eQ = l.useRef(!0), [eV, eU] = l.useState(null), [eB, eF] = l.useState(!1), [eG, e$] = l.useState(null), eY = k ?? eP.current?.duration ?? 0, [eK, eH] = l.useState(u.oA.MD), eW = {
        [u.oA.MD]: 50,
        [u.oA.LG]: 58
    };
    (0, d.u5)(() => {
    ...
    let eq = l.useCallback(e => {
        if (Z(e), V?.(e), null != eP.current) switch (e) {
            case u.Q6.PLAYING:
    ...
    l.useEffect(() => {
        let e = null != n && (n === c.ip4.HIDDEN || n === c.ip4.EXITING || n === c.ip4.EXITED),
            t = null != n && z && !q,
            r = W && !H;
        (e || t || r) && null != eP.current && J === u.Q6.PLAYING && (eU(e || t ? "visibility" : "focus"), eq(u.Q6.PAUSED))
    }, [n, H, W, q, z, J, eq]);
    let [ez, eX] = l.useState(!1), eJ = l.useRef(null), eZ = l.useRef(0);
    l.useLayoutEffect(() => {
        eZ.current = performance.now()
    }, []);
    let e0 = l.useCallback(() => {
            null != eJ.current && clearTimeout(eJ.current), J !== u.Q6.PLAYING || (eJ.current = setTimeout(() => {
                J === u.Q6.PLAYING && eX(!0)
    ...
    let e9 = l.useCallback(e => {
            null != eP.current && (es(e / (eP.current.duration ?? 1) * 100), ec(!0), eF(!1), eP.current.currentTime = e)
        }, []),
        e8 = () => {
            if (null != eP.current) switch (J) {
                case u.Q6.ENDED:
    ...
    l.useEffect(() => {
        ...
        let e = eO.current;
        return e.addEventListener("load", te), () => {
    ...
    l.useEffect(() => (ts({
        captionHeightSpring: ej && null != eG ? ti.current?.clientHeight ?? 0 : 0,
        immediate: eR
    }), () => {
        ta.stop()
    }), [ej, ts, eR, eG, ta]), l.useEffect(() => (tl({
        controlBarAnimSpring: e2 || ev ? 1 : 0,
        immediate: eR
    }), () => {
        tr.stop()
    }), [e2, tl, eR, ev, tr]);
    ...
    return (0, r.jsx)(c.DUT, {
        ...
        children: (0, r.jsxs)("div", {
            ...
            children: [to && Q?.(), (0, r.jsxs)(p.A, {
                ...
                onTimeUpdate: e => {
                    null != eP.current && (j?.(eP.current.currentTime, eP.current.duration), eo(eP.current.currentTime / eP.current.duration * 100))
                },
                onEnded: e => {
                ...
                children: [null != P && (0, r.jsx)("track", {
                    ...
                    onError: () => tt(u.SB.SOURCE_ERROR),
                    src: K,
                    type: "video/mp4"
                })]
            }), (ed || ep) && J === u.Q6.PLAYING && null != K && (0, r.jsx)("span", {
                className: C.S,
                ...
                hasVideoAsset: null != K,
                playerState: J,
                pauseReason: eV
            }), eI && J !== u.Q6.ENDED && null != O && (0, r.jsxs)(r.Fragment, {
                children: [(0, r.jsx)(c.DUT, {
                    ...
                    style: {
                        marginBottom: (0, s.to)([tr, ta], (e, t) => `${e*eW[eK]+t}px`)
                    },
                ...
                children: J === u.Q6.PLAYING ? (0, r.jsx)(c.udU, {
                    className: C.PK
                }) : (0, r.jsx)(c.E$n, {
                    className: C.PK
                })
            }, J), ej && null != eG && !to && (0, r.jsx)(s.animated.div, {
                className: C.o$,
                ref: ti,
                "data-testid": "discord-web-video-player-captions",
                style: {
                    translateY: (0, s.to)([tr.to({
                        range: [0, 1],
                        output: [-20, -eW[eK]]
                    })], e => `${e}px`)
                },
                ...
                children: [(0, r.jsx)(s.animated.div, {
                    ...
                    style: {
                        paddingTop: (0, s.to)([tr.to({
                            range: [0, 1],
                            output: [0, 1]
                        })], e => `${e*e*12}px`),
                        paddingBottom: (0, s.to)([tr.to({
                            range: [0, 1],
                            output: [0, 1]
                        })], e => `${e*e*12}px`),
                        pointerEvents: (0, s.to)([tr.to({
                            range: [0, 1],
                            output: [0, 1]
                        })], e => e < .3 ? "none" : "auto")
                    },
                    ...
                    children: (0, r.jsx)(f.A, {
                        ...
                        handleFullScreenBtnClick: () => {
                            ...
                            e && null != t ? ((0, E.tl)(t), t.addEventListener(E.Wb, e6), U?.(!0), eH(u.oA.LG)) : e || null == t || (t.removeEventListener(E.Wb, e6), U?.(!1), (0, E.sP)(t), eH(u.oA.MD)), ek(e)
                        },
