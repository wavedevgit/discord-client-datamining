...
let y = {
    ...
    T = l.forwardRef(function(e, t) {
        let {
            ...
            visibleChanged: es,
            targetRef: ei
        } = (0, g.O7)(), [ea, eo] = l.useState(T ? u.Q6.PLAYING : u.Q6.PAUSED), [eu, ec] = l.useState(!1), [ed, em] = l.useState(!1), [ep, ef] = l.useState(0), [eE, eh] = l.useState(null), ev = l.useCallback(e => {
            eh(null), ef(e)
        }, []), [ex, eg] = l.useState(!1), [eS, eA] = l.useState(!0), [eC, e_] = l.useState(!1), [eb, ey] = l.useState([]), [eT, eN] = l.useState(!1), [eD, eR] = l.useState(!1), ej = l.useRef(!0), eL = l.useRef(null), eM = l.useRef(null), eI = l.useRef(0);
        l.useLayoutEffect(() => {
            eI.current = performance.now()
        }, []);
        let [ew, ek] = l.useState(.3), [eO, eP] = l.useState(!1), [eQ, eU] = l.useState(!1), [eV, eB] = l.useState(!1), [eF, eG] = l.useState(!1), eK = (0, o.bG)([m.A], () => m.A.useReducedMotion), e$ = (0, l.useRef)(null), eY = (0, l.useRef)(null), eH = l.useRef(!0), [ez, eW] = l.useState(null), eq = l.useCallback((e, t) => {
            k?.(e, t)
        }, [k]), {
            isHlsActive: eX
        } = (0, A.Ay)(e$, {
            ...
            onError: eq,
            onHlsInstance: Z
        }), [eJ, eZ] = l.useState(!1), [e0, e1] = l.useState(null), e6 = O ?? e$.current?.duration ?? 0, [e2, e7] = l.useState(u.oA.MD), e9 = {
            [u.oA.MD]: 50,
            [u.oA.LG]: 58
        };
        (0, d.u5)(() => {
        ...
        let [e8, e3] = l.useState(!1), e5 = l.useRef(null), te = l.useRef(0);
        l.useLayoutEffect(() => {
            te.current = performance.now()
        }, []);
        let tt = l.useCallback(() => {
                null != e5.current && clearTimeout(e5.current), ea !== u.Q6.PLAYING || (e5.current = setTimeout(() => {
        ...
        let ta = l.useCallback(function(e) {
                ...
                eh(e / (e$.current.duration ?? 1) * 100), eg(!0), eZ(!1), e$.current.currentTime = e, t && X?.(n, e)
            }, [X]),
            to = () => {
        ...
        l.useEffect(() => (tv({
            captionHeightSpring: eV && null != e0 ? tE.current?.clientHeight ?? 0 : 0,
            immediate: eK
        }), () => {
            th.stop()
        }), [eV, tv, eK, e0, th]), l.useEffect(() => (tf({
            controlBarAnimSpring: tr || eT ? 1 : 0,
            immediate: eK
        }), () => {
            tp.stop()
        }), [tr, tf, eK, eT, tp]);
        ...
        return (0, r.jsx)(c.DUT, {
            ...
            children: (0, r.jsxs)("div", {
                ...
                children: [tx && V?.({
                    ...
                    ref: e => {
                        e$.current = e, ei.current = e, "function" == typeof t ? t(e) : null != t && (t.current = e)
                    },
                    autoPlay: T,
                    playsInline: !0,
                    ...
                    onLoadedMetadata: e => {
                        null != e$.current && (M > 0 && ta(M, !1), eO ? e$.current.volume = 0 : e$.current.volume = ew)
                    },
                    onLoadStart: () => {
                ...
                }), (eS || eC) && ea === u.Q6.PLAYING && null != et && (0, r.jsx)("span", {
                    className: b.S,
                    ...
                    children: [(0, r.jsx)(c.DUT, {
                        ...
                        style: {
                            marginBottom: (0, a.to)([tp, th], (e, t) => `${e*e9[e2]+t}px`)
                        },
                    ...
                    className: i()(b.yf, {
                        [b.ZH]: ea === u.Q6.PLAYING,
                        [b.v7]: ea === u.Q6.PAUSED
                    }),
                    style: {
                        "--custom-play-pause-pop-ms": "1000ms"
                    },
                    children: ea === u.Q6.PLAYING ? (0, r.jsx)(c.udU, {
                        className: b.PK
                    }) : (0, r.jsx)(c.E$n, {
                        className: b.PK
                    })
                }, ea), eV && null != e0 && !tx && (0, r.jsx)(a.animated.div, {
                    className: b.o$,
                    ref: tE,
    ...
    N = l.forwardRef(function(e, t) {
        ...
        } = s, [d, m] = l.useState(!1), p = l.useCallback(() => {
            m(!0)
        }, []), f = l.useRef(null);
