/** chunk id: 514041, original params: t,n,i (module,exports,require) **/
i.d(n, {
    A: () => a
});
var l = i(502075),
...
function a(t) {
    ...
    return [{
        ...
        id: "blurry",
        value: l.pj.BLURRY,
        label: n ? e.intl.string(e.t.VVPQyy) : e.intl.string(e.t.E8jTMN)
    }, {
        id: "lagging",
        value: l.pj.LAGGING,
        label: n ? e.intl.string(e.t.ObEHd4) : e.intl.string(e.t.VoSJEQ)
    }, {
        id: "out-of-sync",
        ...
        id: "stream-stopped",
        value: l.pj.STREAM_STOPPED,
        label: e.intl.string(e.t.uEoqQp)
    }, {
        id: "vibes-off",
        value: l.pj.VIBES_OFF,
        label: e.intl.string(e.t["++JLL0"])
    }, {
        id: "other",
        value: l.pj.OTHER,
        label: e.intl.string(e.t.emlT91)
    }]
}