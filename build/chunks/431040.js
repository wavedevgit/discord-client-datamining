...
let _ = function(e) {
    let {
        ...
        detectedGame: n,
        trackAction: _
    } = e, p = i.useMemo(() => n.genres.map(r.du).join(", "), [n]), v = n.publishers.join(", "), A = n.developers.join(", "), j = n.firstReleaseDate, C = (0, o.A)(n), E = (0, c.Y)(n), I = !(0, s.uJ)(p), b = !(0, s.uJ)(v), N = !(0, s.uJ)(A), S = !(0, s.uJ)(j), T = C.length > 0, k = E.length > 0 && !E.every(e => (0, s.uJ)(e.url));
    return (0, a.jsxs)("div", {
        className: f.uW,
