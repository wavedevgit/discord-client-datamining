...
let _ = function(e) {
    let {
        ...
        detectedGame: n,
        trackAction: _
    } = e, p = l.useMemo(() => n.genres.map(r.du).join(", "), [n]), v = n.publishers.join(", "), A = n.developers.join(", "), j = n.firstReleaseDate, E = (0, o.A)(n), C = (0, c.Y)(n), I = !(0, s.uJ)(p), N = !(0, s.uJ)(v), b = !(0, s.uJ)(A), S = !(0, s.uJ)(j), T = E.length > 0, k = C.length > 0 && !C.every(e => (0, s.uJ)(e.url));
    return (0, a.jsxs)("div", {
        className: f.uW,
