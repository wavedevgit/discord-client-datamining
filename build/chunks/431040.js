...
let p = function(e) {
    let {
        ...
        detectedGame: n,
        trackAction: p
    } = e, h = l.useMemo(() => n.genres.map(r.du).join(", "), [n]), v = n.publishers.join(", "), A = n.developers.join(", "), j = n.firstReleaseDate, I = (0, c.A)(n), b = (0, o.Y)(n), C = !(0, s.uJ)(h), E = !(0, s.uJ)(v), N = !(0, s.uJ)(A), T = !(0, s.uJ)(j), S = I.length > 0, k = b.length > 0 && !b.every(e => (0, s.uJ)(e.url));
    return (0, a.jsxs)("div", {
        className: g.uW,
