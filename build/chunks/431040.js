...
let v = function(e) {
    let {
        ...
        game: n,
        trackAction: v
    } = e, A = i.useMemo(() => n.genres.map(o.du).join(", "), [n]), j = n.getCompanyByRole(r.wk.PUBLISHER), E = n.getCompanyByRole(r.wk.DEVELOPER), b = j.map(e => e.name).join(", "), C = E.map(e => e.name).join(", "), I = n.firstReleaseDate, N = (0, u.A)(n), S = (0, d.Y)(n), T = !(0, c.uJ)(A), y = !(0, c.uJ)(b), L = !(0, c.uJ)(C), k = !(0, c.uJ)(I), R = N.length > 0, O = S.length > 0 && !S.every(e => (0, c.uJ)(e.url));
    return (0, a.jsxs)("div", {
        className: p.uW,
