...
let v = function(e) {
    let {
        ...
        game: n,
        trackAction: v
    } = e, A = l.useMemo(() => n.genres.map(o.du).join(", "), [n]), b = n.getCompanyByRole(r.wk.PUBLISHER), E = n.getCompanyByRole(r.wk.DEVELOPER), j = b.map(e => e.name).join(", "), I = E.map(e => e.name).join(", "), C = n.firstReleaseDate, N = (0, u.A)(n), S = (0, d.Y)(n), y = !(0, c.uJ)(A), T = !(0, c.uJ)(j), L = !(0, c.uJ)(I), k = !(0, c.uJ)(C), R = N.length > 0, O = S.length > 0 && !S.every(e => (0, c.uJ)(e.url));
    return (0, a.jsxs)("div", {
        className: p.uW,
