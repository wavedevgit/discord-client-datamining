...
function M(e) {
    let {
        onShare: t
    } = e, s = (0, c.bG)([j.A], () => j.A.getRecipientStatus()), [r, n] = a.useState([]), [C, d] = a.useState(new Set), [p, f] = a.useState(!1);
    return a.useEffect(() => {
        (async () => {
            let e = [];
            for (let [t, i] of s)
...
let k = function(e) {
    let {
        onClose: t,
        onShare: s
    } = e, r = (0, c.bG)([j.A], () => j.A.getReferralsRemaining()), [n, h] = a.useState(""), f = (0, p.A)(n, 400), [u, g] = a.useState(new Map), [A, S] = a.useState(!1), {
        eligibleUsers: w,
        fetchUsers: N,
        hasError: R,
        isFetching: k,
    ...
    return (0, i.jsxs)("div", {
        ...
        }), D ? (0, i.jsx)(b, {}) : (0, i.jsxs)(o.ArX, {
            className: v.p_,
            children: [w.map(e => (0, i.jsx)(L.A, {
                disabled: [...u.values()].filter(e => !B.has(e.id)).length >= r && !u.has(e.id) && !B.has(e.id),
                checked: u.has(e.id),
                user: e,
                onChange: (e, t) => {
                    g(s => {
