/** chunk id: 484217 params = (module,exports,require) **/
s.d(t, {
    Ay: () => B
}), s(321073);
var i = s(627968),
...
function k(e) {
    let {
        onShare: t
    } = e, s = (0, c.bG)([m.A], () => m.A.getRecipientStatus()), [r, n] = a.useState([]), [C, d] = a.useState(new Set), [p, f] = a.useState(!1);
    return a.useEffect(() => {
        (async () => {
            let e = [];
            for (let [t, i] of s)
    ...
    return (0, i.jsxs)("div", {
        children: [(0, i.jsxs)("div", {
            ...
            children: [w.map(e => (0, i.jsx)(y.A, {
                disabled: [..._.values()].filter(e => !B.has(e.id)).length >= r && !_.has(e.id) && !B.has(e.id),
                checked: _.has(e.id),
                user: e,
                onChange: (e, t) => {
                    j(s => {
