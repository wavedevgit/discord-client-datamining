...
c.Ay.initialize();
let ee = /\.$/,
    et = e => Array.isArray(e) ? e.map(e => e.replace(ee, "")).join(". ").trim() : e;
class en extends s.PureComponent {
    ...
    componentDidMount() {
        ...
        M.default.track(q.HAw.REGISTER_VIEWED, {
            location: null != t ? "Invite Register Page" : "Non-Invite Register Page",
            registration_source: this.registrationSource,
            ...null != e ? (0, y.A)(e, !1, !1) : {}
        }, {
            flush: !0
        }), null == this.props.consentRequired && _.A.getLocationMetadata(), (0, k.d)("register")
    }
    ...
    componentDidUpdate(e, t) {
        ...
        let a = Y.ju.FULL;
        i || this.hasError("date_of_birth") ? a = Y.ju.AGE_GATE : this.inGuildOrChannelInviteFlow() && (a = Y.ju.INVITE), s(a)
    }
    ...
    async handleRegister() {
        ...
        } = this.props, u = null != l ? l.code : null, h = null != o ? o.skuId : null, _ = E.mZ.getState(), g = (0, H.uJ)(d) ? null : t === d;
        V._.dispatch(q.jej.WAVE_EMPHASIZE), this.setState({
            registering: !0,
            apiErrors: {}
        });
        try {
            this.inGuildOrChannelInviteFlow() ? await (0, I.Ay)({
                consent: s,
                invite: u,
                giftCodeSKUId: h,
    ...
    handleGotoLogin = e => {
        ...
        null != r ? t = q.BVt.INVITE_LOGIN(r.code) : null != i ? t = q.BVt.GIFT_CODE_LOGIN(i.code) : null != s ? t = q.BVt.GUILD_TEMPLATE_LOGIN(s.code) : null != c ? (t = q.BVt.LOGIN, u.redirect_to = c) : (t = q.BVt.LOGIN, "" !== n && (u = {
            email: n
        })), _.A.loginReset(), d(t, {
            search: (0, a.stringify)(u),
            source: "register"
        }), o?.(e), V._.dispatch(q.jej.WAVE_EMPHASIZE)
    };
    handleSubmit = e => {
        e?.preventDefault();
        let {
        ...
        a ? 0 === r.length && (this.setState({
            globalNameClientError: J.intl.string(J.t.EkokLy)
        }), o = !0) : (0 === t.length && (this.setState({
            emailClientError: J.intl.string(J.t.EkokLy)
        }), o = !0), 0 === n.length && (this.setState({
            usernameClientError: J.intl.string(J.t.EkokLy)
        }), o = !0), 0 === i.length && (this.setState({
            passwordClientError: J.intl.string(J.t.EkokLy)
        }), o = !0)), null == s && (this.setState({
            dateOfBirthClientError: J.intl.string(J.t.EkokLy)
    ...
    trackInputFocus = e => {
        M.default.track(q.HAw.REGISTER_INPUT_FOCUS, {
            field: e
        })
    };
    trackInputBlur = e => {
        M.default.track(q.HAw.REGISTER_INPUT_BLUR, {
            field: e
        })
    };
    renderErrorMessage() {
    ...
    renderFull(e, t) {
        let {
        ...
        } = this.props, O = this.renderErrorMessage(), L = (0, i.jsx)(u.m, {
            ...
            this.setState({
                usernameFocused: !0
            }), a.length > 0 && !B.A.wasRegistrationSuggestionFetched(a) && await D.A.fetchSuggestionsRegistration(a)
        }, k = e => {
            this.setState({
            ...
            children: J.intl.string(J.t.wC4TlR)
        }, "title"), G = (0, i.jsxs)(j.eB, {
            className: Z.QX,
    ...
    render() {
        ...
        if (null != s && t)
            if (s.state === q.elq.RESOLVING) return (0, i.jsx)(v.A, {
                authBoxClassName: l,
                name: o,
        ...
        return null != r ? this.renderFull(() => (0, i.jsx)(b.A, {
            guildTemplate: r
        }), !0) : null != n ? this.renderFull(() => (0, i.jsx)(K.A, {
            giftCode: n
        })) : null != s && g && s.state === q.elq.RESOLVED ? this.renderFull(() => (0, i.jsx)("div", {
            className: Z.S3,
