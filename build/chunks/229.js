/** chunk id: 229 params = (module,exports,require) **/
"use strict";
n.d(t, {
    A: () => X
});
...
class Y extends s.PureComponent {
    ...
    componentDidMount() {
        ...
        D.default.track(W.HAw.REGISTER_VIEWED, {
            location: null != t ? "Invite Register Page" : "Non-Invite Register Page",
            registration_source: this.registrationSource,
            ...null != e ? (0, C.A)(e, !1, !1) : {}
        }, {
            flush: !0
        }), null == this.props.consentRequired && h.A.getLocationMetadata(), (0, R.d)("register")
    }
    ...
    componentDidUpdate(e, t) {
        ...
        (t.apiErrors !== r || t.parsedDateOfBirth !== l) && (this.hasError("email") || this.hasError("phone") ? null != this.emailRef && this.emailRef.focus() : this.hasError("username") ? null != this.usernameRef && this.usernameRef.focus() : this.hasError("global_name") ? null != this.globalNameRef && this.globalNameRef.focus() : this.hasError("password") ? null != this.passwordRef && this.passwordRef.focus() : null == this.state.parsedDateOfBirth ? null != this.dateOfBirthRef.current && this.dateOfBirthRef.current.focus() : this.hasError("retry_after") && "number" == typeof r.retry_after && (this.setState({
            isRateLimited: !0
        ...
        let a = H.ju.FULL;
        i || this.hasError("date_of_birth") ? a = H.ju.AGE_GATE : this.inGuildOrChannelInviteFlow() && (a = H.ju.INVITE), s(a)
    }
    ...
    async handleRegister() {
        ...
        } = this.props, u = null != l ? l.code : null, h = null != o ? o.skuId : null, p = A.mZ.getState(), m = (0, G.uJ)(d) ? null : t === d;
        P._.dispatch(W.jej.WAVE_EMPHASIZE), this.setState({
            registering: !0,
            apiErrors: {}
        });
        try {
            this.inGuildOrChannelInviteFlow() ? await (0, E.Ay)({
                consent: s,
                invite: u,
                giftCodeSKUId: h,
    ...
    handleGotoLogin = e => {
        ...
        null != r ? t = W.BVt.INVITE_LOGIN(r.code) : null != i ? t = W.BVt.GIFT_CODE_LOGIN(i.code) : null != s ? t = W.BVt.GUILD_TEMPLATE_LOGIN(s.code) : null != c ? (t = W.BVt.LOGIN, u.redirect_to = c) : (t = W.BVt.LOGIN, "" !== n && (u = {
            email: n
        })), h.A.loginReset(), d(t, {
            search: (0, a.stringify)(u),
            source: "register"
        }), o?.(e), P._.dispatch(W.jej.WAVE_EMPHASIZE)
    };
    handleSubmit = e => {
        e?.preventDefault();
        let {
        ...
        let a = this.inGuildOrChannelInviteFlow(),
            o = !1;
        a ? 0 === r.length && (this.setState({
            globalNameClientError: z.intl.string(z.t.EkokLy)
        }), o = !0) : (0 === t.length && (this.setState({
            emailClientError: z.intl.string(z.t.EkokLy)
        }), o = !0), 0 === n.length && (this.setState({
            usernameClientError: z.intl.string(z.t.EkokLy)
        }), o = !0), 0 === i.length && (this.setState({
            passwordClientError: z.intl.string(z.t.EkokLy)
        }), o = !0)), null == s && (this.setState({
            dateOfBirthClientError: z.intl.string(z.t.EkokLy)
    ...
    trackInputFocus = e => {
        D.default.track(W.HAw.REGISTER_INPUT_FOCUS, {
            field: e
        })
    };
    trackInputBlur = e => {
        D.default.track(W.HAw.REGISTER_INPUT_BLUR, {
            field: e
        })
    };
    ...
    renderFull(e, t) {
        let {
            ...
            this.setState({
                usernameFocused: !0
            }), a.length > 0 && !L.A.wasRegistrationSuggestionFetched(a) && await O.A.fetchSuggestionsRegistration(a)
        }, y = e => {
            this.setState({
            ...
            children: z.intl.string(z.t.wC4TlR)
        }, "title"), R = (0, i.jsx)(x.A, {
            email: n,
            globalName: a,
            username: r,
            ...
            onEmailChange: e => this.setState({
                email: e,
                emailClientError: 0 === e.length ? z.intl.string(z.t.EkokLy) : null
            }),
            setEmailRef: e => {
                this.emailRef = e
            },
            ...
            onGlobalNameChange: e => this.setState({
                globalName: e
            }),
            setGlobalNameRef: e => {
            ...
            onUsernameSuggestionClick: () => {
                null != this.usernameRef && this.usernameRef.focus(), null != j && j.length > 0 && this.setState({
                    username: j
                })
            },
            onBirthdayChange: this.handleBirthdayChange,
            onConsentChange: e => this.setState({
                consent: e
            }),
    ...
    render() {
        ...
        let {
            ...
            consent: _,
            registering: p
        } = this.state, g = null != s && null == s.guild && null == s.channel && null != s.inviter;
        if (null != s && t)
            if (s.state === W.elq.RESOLVING) return (0, i.jsx)(I.A, {
                authBoxClassName: l,
                name: o,
        ...
        return null != r ? this.renderFull(() => (0, i.jsx)(T.A, {
            guildTemplate: r
        }), !0) : null != n ? this.renderFull(() => (0, i.jsx)(F.A, {
            giftCode: n
        })) : null != s && g && s.state === W.elq.RESOLVED ? this.renderFull(() => (0, i.jsx)("div", {
            className: q.S3,
...
function X(e) {
    ...
    return (0, g.A)({
        ...
        properties: {
            impression_group: o.ImpressionGroups.USER_REGISTRATION_FLOW,
            step: r
        }
    }, {}, [r]), (0, i.jsx)(Y, {
        onChangeStep: e => l(e),
