...
class M extends s.PureComponent {
    ...
    componentDidMount() {
        ...
        b.default.track(k.HAw.REGISTER_VIEWED, {
            location: null != t ? "Invite Register Page" : "Non-Invite Register Page",
            registration_source: this.registrationSource,
            ...null != e ? (0, E.A)(e, !1, !1) : {}
        }, {
            flush: !0
        }), null == this.props.consentRequired && h.A.getLocationMetadata(), (0, T.d)("register")
    }
    ...
    componentDidUpdate(e) {
        ...
        let r = D.ju.FULL;
        n || null != s.date_of_birth ? r = D.ju.AGE_GATE : this.inGuildOrChannelInviteFlow() && (r = D.ju.INVITE), i(r)
    }
    ...
    handleGotoLogin = e => {
        ...
        null != r ? t = k.BVt.INVITE_LOGIN(r.code) : null != i ? t = k.BVt.GIFT_CODE_LOGIN(i.code) : null != s ? t = k.BVt.GUILD_TEMPLATE_LOGIN(s.code) : null != c ? (t = k.BVt.LOGIN, u.redirect_to = c) : (t = k.BVt.LOGIN, "" !== n && (u = {
            email: n
        })), h.A.loginReset(), d(t, {
            search: (0, a.stringify)(u),
            source: "register"
        }), o?.(e), R._.dispatch(k.jej.WAVE_EMPHASIZE)
    };
    renderFull(e, t) {
        let {
            authBoxClassName: n,
            ...
            guildTemplate: c,
            invite: d
        } = this.props, h = null != e ? (0, i.jsx)(s.Fragment, {
            children: e()
        }, "custom-header") : (0, i.jsx)(f.hE, {
            children: P.intl.string(P.t.wC4TlR)
        }, "title"), _ = null != this.props.location ? (0, a.parse)(this.props.location.search) : {}, p = (0, i.jsx)(m.A, {
            initialEmail: _.email ?? "",
            invite: d,
            giftCode: o,
            guildTemplate: c,
            onApiErrors: e => this.setState({
                apiErrors: e
            }),
    ...
    render() {
        ...
        return null != r && n ? (0, i.jsx)(A.A, {
            ...
            onGotoLogin: this.handleGotoLogin,
            onRegister: this.props.onRegister
        }) : null != l ? this.renderFull(() => (0, i.jsx)(x.A, {
            guildTemplate: l
        }), !0) : null != s ? this.renderFull(() => (0, i.jsx)(O.A, {
            giftCode: s
        })) : null != r && o && r.state === k.elq.RESOLVED ? this.renderFull(() => (0, i.jsx)("div", {
            className: G.S3,
