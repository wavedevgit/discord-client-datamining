...
class ei extends s.PureComponent {
    ...
    async handleRegister() {
        ...
        try {
            this.inGuildOrChannelInviteFlow() ? await (0, N.Ay)({
                consent: s,
                invite: u,
                giftCodeSKUId: h,
    ...
    renderInviteResolving() {
        ...
        return (0, i.jsxs)(v.Ay, {
            className: e,
            children: [(0, i.jsx)(Q.M, {}), (0, i.jsxs)(v.eB, {
                className: Z.y0,
    ...
    renderInviteHeader() {
        ...
        return e?.guild_scheduled_event != null ? (0, i.jsx)(T.X, {
            channel: e.channel,
    ...
    renderErrorMessage() {
        ...
        return "string" != typeof e ? null : (0, i.jsx)(v.ME, {
    ...
    renderFull(e, t) {
        let {
            ...
            text: !d && S ? $.intl.string($.t.AY4IVA) : null,
            children: (0, i.jsx)("div", {
                className: ee.QX,
                children: (0, i.jsx)(_.Button, {
                    text: $.intl.string($.t["825cFy"]),
            ...
            this.setState({
                usernameFocused: !0
            }), a.length > 0 && !B.A.wasRegistrationSuggestionFetched(a) && await k.A.fetchSuggestionsRegistration(a)
        }, w = e => {
            this.setState({
