...
class q extends s.PureComponent {
    ...
    componentDidMount() {
        ...
        k.default.track(V.HAw.REGISTER_VIEWED, {
    ...
    componentDidUpdate(e, t) {
        ...
        t.apiErrors !== r && this.hasError("retry_after") && "number" == typeof r.retry_after && (this.setState({
            isRateLimited: !0
        ...
        let l = W.ju.FULL;
        i || this.hasError("date_of_birth") ? l = W.ju.AGE_GATE : this.inGuildOrChannelInviteFlow() && (l = W.ju.INVITE), s(l)
    }
    ...
    async handleRegister() {
        ...
        } = this.props, u = null != l ? l.code : null, h = null != o ? o.skuId : null, p = A.mZ.getState(), g = (0, B.uJ)(d) ? null : t === d;
        U._.dispatch(V.jej.WAVE_EMPHASIZE), this.setState({
            registering: !0,
            apiErrors: {}
        });
        try {
    ...
    handleGotoLogin = e => {
        ...
        null != r ? t = V.BVt.INVITE_LOGIN(r.code) : null != i ? t = V.BVt.GIFT_CODE_LOGIN(i.code) : null != s ? t = V.BVt.GUILD_TEMPLATE_LOGIN(s.code) : null != c ? (t = V.BVt.LOGIN, u.redirect_to = c) : (t = V.BVt.LOGIN, "" !== n && (u = {
            email: n
        })), h.A.loginReset(), d(t, {
            search: (0, a.stringify)(u),
            source: "register"
        }), o?.(e), U._.dispatch(V.jej.WAVE_EMPHASIZE)
    };
    handleSubmit = e => {
        e?.preventDefault();
        let {
        ...
        a ? 0 === r.length && (this.setState({
            globalNameClientError: K.intl.string(K.t.EkokLy)
        }), o = !0) : (0 === t.length && (this.setState({
            emailClientError: K.intl.string(K.t.EkokLy)
        }), o = !0), 0 === n.length && (this.setState({
            usernameClientError: K.intl.string(K.t.EkokLy)
        }), o = !0), 0 === i.length && (this.setState({
            passwordClientError: K.intl.string(K.t.EkokLy)
        }), o = !0)), null == s && (this.setState({
            dateOfBirthClientError: K.intl.string(K.t.EkokLy)
    ...
    renderFull(e, t) {
        let {
        ...
        }, T = null != e ? (0, i.jsx)(s.Fragment, {
            children: e()
        }, "custom-header") : (0, i.jsx)(v.hE, {
            children: K.intl.string(K.t.wC4TlR)
        }, "title"), j = (0, i.jsx)(x.A, {
            email: n,
            globalName: a,
            username: r,
            ...
            onEmailChange: e => this.setState({
                email: e,
                emailClientError: 0 === e.length ? K.intl.string(K.t.EkokLy) : null
            }),
            ...
            onUsernameSuggestionClick: () => {
                null != N && N.length > 0 && this.setState({
                    username: N
                })
            },
    ...
    render() {
        ...
        let {
            ...
            consent: h,
            registering: _
        } = this.state, p = null != s && null == s.guild && null == s.channel && null != s.inviter;
        if (null != s && t)
            if (s.state === V.elq.RESOLVING) return (0, i.jsx)(I.A, {
                authBoxClassName: l,
                name: a,
        ...
        return null != r ? this.renderFull(() => (0, i.jsx)(T.A, {
            guildTemplate: r
        }), !0) : null != n ? this.renderFull(() => (0, i.jsx)(G.A, {
            giftCode: n
        })) : null != s && p && s.state === V.elq.RESOLVED ? this.renderFull(() => (0, i.jsx)("div", {
            className: Q.S3,
