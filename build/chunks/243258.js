/** chunk id: 243258 params = (module,exports,require) **/
i.d(t, {
    default: () => L
}), i(321073);
var a = i(627968),
...
function E(e) {
    let {
        clips: t
    } = e, i = t[0], n = i.thumbnail, l = null;
    return "" !== n && (l = (0, a.jsx)("div", {
        ...
        children: [(0, a.jsx)("div", {
            ...
            children: (0, a.jsxs)("div", {
                ...
                children: [(0, a.jsx)(c.SfG, {
                    ...
                    color: "text-muted",
                    children: 1 === t.length ? i.name ?? R.intl.string(R.t.Cyxddp) : R.intl.formatToPlainString(R.t.SJ6pPX, {
                        count: t.length
                    })
                })]
            })
...
function L(e) {
            ...
            for (let e of (d && l(), f)) {
                ...
                if (null != n) {
                    for (let e of ((0, y.R)(a, n, g.C.ChannelMessage, {
                            ...
                            requireConfirm: !1
                        }), t)) w.default.track(C.HAw.CLIP_SHARED, {
                        location_stack: i,
                        guild_id: n.guild_id,
                        channel_id: n.id,
                        channel_type: n.type,
                    ...
                    null != s && "" !== s.trim() && await r.A.sendMessage(n.id, h.Ay.parse(n, s), !1, {
    ...
    }, [t, i, l]), p = n.useCallback(e => {
        if (e instanceof f.YB && !(0, I.t)(e.id)) return {
            label: R.intl.string(R.t.iufib1)
        }
    }, []);
