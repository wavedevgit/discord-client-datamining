...
function y() {
    ...
    l.useEffect(() => {
        ...
        !async function() {
            ...
            function l(r) {
                ...
                if (null != n) {
                    ...
                    a?.code != null && t.append("error-code", a.code), e.replace(`${m.BVt.CONNECTIONS_ERROR(n)}?${t.toString()}`)
                }
            }
            if (await h({
                    platformType: n,
            ...
            0 === a ? v(!0) : 1 === a ? e.replace(`${m.BVt.CONNECTIONS_ERROR(n)}?${t.toString()}`) : 3 === a ? i.Fr ? b(!0) : e.replace(`${m.BVt.CONNECTIONS_ERROR(n)}?${t.toString()}`) : w({
                platformType: n,
                state: o,
                handleCallbackResponse: l,
                handleCallbackError: r => {
                    r?.body?.code != null && t.append("error-code", r.body.code), e.replace(`${m.BVt.CONNECTIONS_ERROR(n)}?${t.toString()}`)
                },
                openidParams: r,
                code: D,
                iss: S
        ...
        async function n() {
            ...
            let {
                handoff_status: l,
                success_redirect: a
            } = (await u.A.getHandoffStatus(y, o)).body;
    ...
    return null != y && N.A.isSupported(y) ? x ? (0, n.jsx)(g, {
        platformType: y,
        deeplink: I,
        onClick: () => {
            b(!1), v(!0)
...
async function h(e) {
    ...
    if (i.Fr || E) return !1;
    try {
        let e = await p.default.request(m.e$_.CONNECTIONS_CALLBACK, {
            code: r,
            openid_params: l,
            iss: a,
            state: n,
