...
function U(e) {
    ...
    return (0, l.jsx)(d.B8B, {
        ...
        renderRow: function(e) {
            ...
            switch (b) {
                case G.oO.ROLES:
                    f = (p = n[j]).rowType === G.T6.ROLE && p.tags?.guild_connections === null ? (0, l.jsx)(A.A, {
                        className: P.a,
                        color: p.colorString,
                        size: 20
                    }) : (0, l.jsx)(d.iTF, {
            ...
            return (0, l.jsxs)("div", {
                ...
                children: [(0, l.jsx)("div", {
                    ...
                    }), p.rowType !== G.T6.EMPTY_STATE && (0, l.jsx)(o.m, {
                        asContainer: !0,
                        text: s ?? r(p.rowType, p.disabled),
                        children: (0, l.jsx)(d.DUT, {
                            onClick: () => {
                                var e, n, l;
                                return v && null != p && (e = p.id, n = p.name, l = p.rowType, void c.A.show({
                                    ...
                                    onConfirm: () => (function(e, n) {
                                        if (t.isGuildStageVoice()) {
                                            let l = (0, C.$b)(e, n === G.T6.ROLE ? m.r2.ROLE : m.r2.MEMBER, t);
                                            (0, C.pF)(l) ? u.A.clearPermissionOverwrite(t.id, l.id): (0, g.R$)(t.id, [l])
...
function V(e) {
    let {
        ...
        channel: i,
        permissionUpdates: s
    } = e, c = (0, r.bG)([S.A], () => S.A.getSortedRoles(t.id)), u = R.C$(t, c, i, j.QY, s), h = (0, r.bG)([_.Ay], () => R.Wi(_.Ay.getMemberIds(t.id), i, t, j.QY, s)), g = (0, C.qd)(i.id);
    return (0, l.jsxs)("div", {
...
function H(e) {
    let {
        ...
        roles: o,
        members: c
    } = e, u = (0, r.bG)([E.A], () => E.A.can(D.xB.ADMINISTRATOR, t)), h = I.MJ(D.xB.VIEW_CHANNEL, t), g = I.MJ(D.xB.ADMINISTRATOR, t);
    async function m() {
        let e = i.accessPermissions,
            a = T.default.getCurrentUser();
        s || null == await (0, f.D)(t.id, i.id) ? (R.uB(i, e, s), s || null == a || u || R.tP(i, e)) : (0, d.mMO)(async () => {
            let {
                Modal: e
    ...
    return i.isCategory() ? (x.title = B.intl.string(B.t.lEPAZ5), x.subtitle = B.intl.string(B.t.RQUk61), x.formLabel = B.intl.string(B.t["8VIxJu"])) : i.type === k.rbe.GUILD_VOICE && (x.subtitle = B.intl.string(B.t.cLjvKg)), (0, l.jsxs)("div", {
        className: a()(P.j1, {
            [P.vu]: s
        }),
        children: [(0, l.jsx)(w.A, {
...
let W = r.Ay.connectStores([v.A, E.A, _.Ay, y.A, S.A], () => {
    ...
    if (null != t) {
        ...
        if (null != e) {
            ...
            }, {}), l = R.uX(e, r, t, t.accessPermissions, s), i = R.Wi(n, t, e, t.accessPermissions, s), a = R.Ae(t, s)
        }
    }
    return {
    ...
    let {
        ...
        locked: g,
        permissionUpdates: m
    } = e, [x, A] = i.useState(!I.MJ(D.xB.SEND_MESSAGES, a));
    if (null == a || null == c) return null;
    let f = {
        title: B.intl.string(B.t.BAZMBn),
        subtitle: B.intl.string(B.t.XLrZyp)
    };
    return a.isCategory() && (f.title = B.intl.string(B.t["/uELTj"]), f.subtitle = B.intl.string(B.t["8iAg3Q"])), (0, l.jsxs)(l.Fragment, {
        children: [(0, l.jsx)(d.Heading, {
                ...
                null != s && (0, d.mMO)(async () => {
                    ...
                    return t => (0, l.jsx)(e, {
                        ...
                        onConfirm: async () => {
                            ...
                            null != e && null == t[e] && (t[e] = I.xT(e)), await (0, p.n)(a, t[e].deny, t[e].allow) && (0, h.RT)(a.id, {
        ...
        }) : null, a.isGuildStageVoice() ? (0, l.jsx)(V, {
            guild: c,
            channel: a,
            permissionUpdates: m
        }) : null, (0, l.jsx)(H, {
