...
function S(e) {
    ...
    if (_._Z.updateSetting(e), !(0, l.r)("UserSettingsActivityPrivacy")) return;
    let s = (0, o.g8)(t, e);
    if (null == s) return;
    let a = T[e]?.() ?? "";
    (0, r.mMO)(async () => {
...
function I() {
    let e = _._Z.useSetting(),
        t = (0, l.m)("UserSettingsActivityPrivacy"),
        n = s.useMemo(() => t ? [{
