...
function m() {
    let [e, t] = l.useState(null), [n, r] = l.useState(null), [s, o] = l.useState(null), [c, u] = l.useState([]), m = l.useRef(null), [x, g] = l.useState(400), [f, b] = l.useState(400), v = l.useCallback(() => {
        setTimeout(() => {
            var e, t, n, a;
            o(null != (e = null == (n = m.current) ? void 0 : n.getProperties()) ? e : {}), u(null != (t = null == (a = m.current) ? void 0 : a.getArtboards()) ? t : []), r({})
        }, 1e3)
    }, []), j = l.useCallback((e, t) => {
        null != n && r(n => {
            var a, l, r;
...
function h(e) {
    ...
    let {
        riveName: n,
        onRiveLoad: s
    } = e, o = null == (t = r[n]) ? void 0 : t.riveSrc, u = null == o, m = l.useRef(null), p = (0, d.GyQ)(o);
    return (0, a.jsxs)(i.BJc, {
        gap: 8,
