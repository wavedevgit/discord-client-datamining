/** chunk id: 272207, original params: e,t,n (module,exports,require) **/
"use strict";
n.d(t, {
    A: () => b,
    h: () => y
...
class y extends a.A {
    ...
    get endedAt() {
        var e;
        return this.status !== d.Dmq.ENDED ? null : (null == (e = this.metadata) ? void 0 : e.ended_at) != null ? new Date(this.metadata.ended_at) : this.currentPeriodEnd
    }
    get isActive() {
