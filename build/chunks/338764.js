/** chunk id: 338764 params = (module,exports,require) **/
i.d(e, {
    A: () => I
});
var s = i(627968),
...
class x extends n.Component {
    ...
    _pauseTimeout;
    constructor(t) {
        super(t), this.wave = new m.A(this.updateWaveState), this.children = [new u.A, new p.A, this.wave]
    }
    static defaultProps = {
        embedded: !1
    };
    ...
    bindEvents() {
        window.addEventListener("resize", this.resizeCanvas, !1), window.addEventListener("blur", this.delayedPause, !1), window.addEventListener("focus", this.play, !1), document.addEventListener("visibilitychange", this.handleVisibilityChange, !1), d._.subscribe(g.jej.WAVE_EMPHASIZE, this.handleWaveEmphasize)
    }
    unbindEvents() {
        window.removeEventListener("resize", this.resizeCanvas, !1), window.removeEventListener("blur", this.delayedPause, !1), window.removeEventListener("focus", this.play, !1), document.removeEventListener("visibilitychange", this.handleVisibilityChange, !1), d._.unsubscribe(g.jej.WAVE_EMPHASIZE, this.handleWaveEmphasize)
    }
