...
function T(e) {
    let t, n, l, o, u, A, m, I, T, v, y, j, R, {
        ...
        L = O.id,
        {
            ...
            streamUsers: D,
            voiceUsers: G
        } = (t = O.id, n = (0, a.yK)([f.A], () => f.A.getBlockedOrIgnoredIDs()), l = (0, a.bG)([p.A], () => p.A.getUserAffinitiesMap(), []), o = (0, a.yK)([d.Ay, C.default], () => d.Ay.getEmbeddedActivitiesForChannel(t).flatMap(e => Array.from(e.userIds)).map(e => C.default.getUser(e)), [t]), u = s.useMemo(() => (0, h.aw)(o, n), [o, n]), A = s.useMemo(() => (0, g.L)(u, l, "DirectMessageTooltip - activityUsers"), [u, l]), m = (0, a.yK)([_.A, C.default], () => {
            let e = _.A.getAllApplicationStreamsForChannel(t).map(e => e.ownerId).map(e => C.default.getUser(e));
            return (0, h.aw)(e, n)
        }, [t, n]), I = s.useMemo(() => (0, h.aw)(m, n), [m, n]), T = s.useMemo(() => (0, g.L)(I, l, "DirectMessageTooltip - activityUsers"), [I, l]), v = s.useMemo(() => T.filter(e => !A.some(t => t.id === e.id)), [T, A]), y = (0, a.yK)([E.Ay], () => {
