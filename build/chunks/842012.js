...
let h = e => {
    let {
        ...
        channelId: n,
        reportId: h
    } = e, x = c.A.getDMFromUserId(t.id), A = (0, r.bG)([c.A], () => c.A.getChannel(n), [n]), v = a.useMemo(() => _.Ay.getName(A?.guild_id, A?.id, t), [A, t]), b = (0, r.bG)([u.Ay], () => null == x ? null : u.Ay.isChannelMuted(null, x)), [f, T] = a.useState(b ?? !1), S = a.useCallback(() => {
