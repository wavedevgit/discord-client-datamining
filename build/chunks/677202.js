/** chunk id: 677202, original params: e,t,l (module,exports,require) **/
l.d(t, {
    A: () => h
});
var n = l(627968),
...
let h = a.memo(function(e) {
    ...
    }, [y, S, h, j, A]), a.useEffect(() => {
        let e;
        if (null != v) return t && (e = setInterval(() => {
            v.currentTime < (0, d.fP)(S) ? v.currentTime >= (0, d.fP)(A) && w(v.currentTime * u.A.Millis.SECOND) : (l((0, d.fP)(y)), w(y))
        }, 16)), () => {
            clearInterval(e)
        }
