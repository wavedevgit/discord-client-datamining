...
function _() {
    ...
    })), [_, A] = s.useState(!1), x = s.useMemo(() => n?.guild_tag !== void 0 && n.guild_tag.length > 0 ? n.guild_tag[0] : Object.keys(n ?? {}).length > 0 ? g.intl.string(g.t.s35OuK) : null, [n]), h = s.useCallback(async () => {
        A(!0);
