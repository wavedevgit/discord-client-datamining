...
let _ = e => {
        let t = (0, l.bG)([c.A], () => null != e ? c.A.getGuildProductsForGuildFetchState(e) : c.e.FETCHED, [e]),
            ...
            [a, r] = i.useState(!0);
        return i.useEffect(() => {
            a && (t === c.e.NOT_FETCHED || t === c.e.FETCHED && c.A.isGuildProductsCacheExpired(e)) && n && d.GI(e), r(!n)
        }, [e, n, t, a]), {
    ...
    m = function(e, t) {
        ...
        }, a = (0, l.bG)([s.A], () => s.A.isConnected()), r = (0, l.bG)([o.A], () => o.A.getGuildId());
        return i.useEffect(() => {
            let i = c.A.getGuildProductFetchState(t);
            if ((!n || r === e) && a && i === c.e.NOT_FETCHED) try {
                d.py(e, t)
            } catch (e) {}
        }, [e, t, a, r, n]), (0, l.bG)([c.A], () => c.A.getGuildProduct(t))
    },
    h = function(e) {
        let {
            publishedOnly: t
        } = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : {};
        return (0, l.bG)([c.A, a.A], () => c.A.getGuildProductsForGuild(e, {
