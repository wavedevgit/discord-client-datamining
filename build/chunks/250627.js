...
let _ = e => {
        let t = (0, a.bG)([c.A], () => null != e ? c.A.getGuildProductsForGuildFetchState(e) : c.e.FETCHED, [e]),
            ...
            [r, s] = i.useState(!0);
        return i.useEffect(() => {
            r && (t === c.e.NOT_FETCHED || t === c.e.FETCHED && c.A.isGuildProductsCacheExpired(e)) && n && d.GI(e), s(!n)
        }, [e, n, t, r]), {
    ...
    m = function(e, t) {
        ...
        }, r = (0, a.bG)([l.A], () => l.A.isConnected()), s = (0, a.bG)([o.A], () => o.A.getGuildId());
        return i.useEffect(() => {
            let i = c.A.getGuildProductFetchState(t);
            if ((!n || s === e) && r && i === c.e.NOT_FETCHED) try {
                d.py(e, t)
            } catch (e) {}
        }, [e, t, r, s, n]), (0, a.bG)([c.A], () => c.A.getGuildProduct(t))
    },
    h = function(e) {
        let {
            publishedOnly: t
        } = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : {};
        return (0, a.bG)([c.A, r.A], () => c.A.getGuildProductsForGuild(e, {
