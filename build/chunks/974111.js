...
function v(e, a, t) {
    ...
    let b, {
        ...
        x = (0, d.useRef)(null),
        {
            ...
            onBlurWithin: t => {
                var r;
                a.confirmPlaceholder(), a.value !== x.current && a.commitValidation(), null == (r = e.onBlur) || r.call(e, t)
            },
    ...
    }, [O]), (0, u.F)(e.inputRef, a.defaultValue, a.setValue), (0, h.X)({
        ...e,
        focus() {
            O.focusFirst()
        }
    ...
    "native" === e.validationBehavior && (z.type = "text", z.hidden = !0, z.required = e.isRequired, z.onChange = () => {});
    let U = (0, s.$)(e);
    return {
        labelProps: {
            ...w,
