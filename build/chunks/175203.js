...
function em(e) {
    ...
    if (t === ea.lp.STREAM) return n === ea.J7.XBOX ? (0, i.jsx)(X.A, {
        className: s
    }) : (0, i.jsx)(h.kN9, {
        size: "md",
        color: "currentColor",
...
function ep(e) {
    ...
    return J.isPlatformEmbedded && Q.Ay.supportsFeature(er.BYE.POPOUT_WINDOWS) ? (0, i.jsx)(e_, {
        onClick: d,
...
let eg = s.memo(e => {
    let {
        ...
        controlsBottom: K,
        streamId: W
    } = e, Y = (0, c.bG)([F.Ay], () => null != T && F.Ay.isLocalVideoAutoDisabled(T, (0, f.A)(C)), [T, C]), q = (0, b.A)({
        userId: T,
    ...
    let ee = !k && C === ea.lp.STREAM && w && (!Q || G),
        ...
        ei = [];
    return A && C === ea.lp.STREAM && ei.push((0, i.jsx)(j.A, {
        streamId: W,
        paused: H
    }, "zoom-controls")), A ? B === E.N.CALL_TILE && (ei.push((0, i.jsx)(ep, {
        channelId: v.id,
        participantId: x,
        hideWhenInactive: !1,
        idle: t
        ...
        children: [(0, i.jsx)("div", {
            ...
            children: [(0, i.jsxs)(h.Text, {
                ...
                children: [null != et && C === ea.lp.USER && (0, i.jsx)(et, {
                    className: eu.gr,
                    size: "xs",
                    color: "currentColor"
                }), p ? (0, i.jsx)("div", {
