...
let eh = [er.lp.ACTIVITY],
    eA = l.memo(e => {
        ...
        let r, o, c, {
            ...
            eU = (0, d.bG)([F.Ay], () => null != eL ? F.Ay.getVideoToggleState(eL, (0, f.A)(u.type)) : ea.bb8.NONE, [eL, u.type]),
            ...
            eV = (t = eR, n = u, s = z.getGuildId(), r = n.type !== er.lp.ACTIVITY ? n.user.id : n.applicationId, o = (0, d.cf)([Y.A], () => {
            ...
            eY = (0, d.bG)([K.A], () => eW && null != eL ? K.A.findActivity(eL, e => null != e.application_id && e.type === ea.$pd.PLAYING) : null, [eW, eL]),
            ez = (0, d.bG)([V.A], () => eY?.application_id != null ? V.A.getDetectableGame(eY.application_id) : null),
            eq = (0, d.bG)([g.A], () => null != ez && eY?.application_id != null ? g.A.getApplication(eY?.application_id) : void 0),
            eX = (0, D.UF)({
                userId: eL,
                channelId: z.id
            }),
            ...
            eQ = l.useMemo(() => u.type === er.lp.STREAM ? eJ ?? !1 : u.type === er.lp.USER && (eX ?? !1), [eJ, eX, u.type]);
        l.useEffect(() => {
            eS(e_)
        }, [e_]);
        let e$ = l.useCallback(() => {
        ...
        switch (u.type) {
            case er.lp.STREAM:
                e9 = (0, i.jsx)(en.A, {
                    ...
                    idle: eN,
                    premiumIndicator: !1
                }), e6 = ec.intl.formatToPlainString(ec.t.gHPz3Q, {
            ...
            case er.lp.USER:
                e9 = (0, i.jsx)(ei.A, {
                    ...
                    participant: u,
                    channelId: z.id
                }), e6 = ec.intl.formatToPlainString(ec.t["iC/x/Q"], {
            ...
            case er.lp.ACTIVITY:
                e9 = (0, i.jsx)(ee.Ay, {
                    ...
                    channel: z,
                    width: q
                }), e6 = ec.intl.formatToPlainString(ec.t.YCvOsO, {
        ...
        let e2 = l.useRef(null),
            e5 = (0, d.bG)([W.A], () => u.type === er.lp.USER ? W.A.getVoiceVolume(u.id) : -1 / 0),
            e3 = (0, N.v)({
                isSpeaking: eP,
                voiceDb: e5,
...
function e_(e) {
    ...
    if (t === er.lp.STREAM) return n === er.J7.XBOX ? (0, i.jsx)(X.A, {
        className: l
    }) : (0, i.jsx)(h.kN9, {
        size: "md",
        color: "currentColor",
...
function eg(e) {
    let {
        ...
        hideWhenInactive: s,
        idle: a
    } = e, r = l.useMemo(() => (0, I.A)(t, n), [t, n]), o = (0, d.bG)([L.A], () => L.A.getIsAlwaysOnTop(r)), c = l.useCallback(() => {
...
let ep = l.memo(e => {
    let {
        ...
        controlsBottom: K,
        streamId: W
    } = e, Y = (0, d.bG)([F.Ay], () => null != b && F.Ay.isLocalVideoAutoDisabled(b, (0, f.A)(N)), [b, N]), q = (0, T.A)({
        userId: b,
        guildId: y.getGuildId()
    }), X = (0, S.a)({
        displayNameStyles: q
    }), J = (0, el.Y)(s), Q = (0, el.V)(s), [$, Z] = l.useState(!1);
    l.useEffect(() => {
        let e = !1,
            t = () => {
    ...
    let ee = !w && N === er.lp.STREAM && k && (!Q || U),
        ...
        ei = [];
    return A && N === er.lp.STREAM && ei.push((0, i.jsx)(j.A, {
        streamId: W,
        paused: H
    }, "zoom-controls")), A ? V === x.N.CALL_TILE && (ei.push((0, i.jsx)(eg, {
        channelId: y.id,
        participantId: E,
        hideWhenInactive: !1,
        idle: t
        ...
        children: [(0, i.jsx)("div", {
            ...
            children: Y || _ === ea.bb8.AUTO_PROBING ? t ? (0, i.jsx)("div", {
                className: eu.h5,
            ...
            children: [(0, i.jsxs)(h.Text, {
                ...
                children: [null != et && N === er.lp.USER && (0, i.jsx)(et, {
                    className: eu.gr,
                    size: "xs",
                    color: "currentColor"
                }), g ? (0, i.jsx)("div", {
