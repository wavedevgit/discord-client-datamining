...
let eh = [er.lp.ACTIVITY],
    eA = l.memo(e => {
        ...
        let r, o, d, {
            ...
            eU = (0, c.bG)([F.Ay], () => null != eL ? F.Ay.getVideoToggleState(eL, (0, f.A)(u.type)) : ea.bb8.NONE, [eL, u.type]),
            ...
            eV = (t = eR, n = u, s = z.getGuildId(), r = n.type !== er.lp.ACTIVITY ? n.user.id : n.applicationId, o = (0, c.cf)([Y.A], () => {
...
function eg(e) {
    let {
        ...
        hideWhenInactive: s,
        idle: a
    } = e, r = l.useMemo(() => (0, I.A)(t, n), [t, n]), o = (0, c.bG)([L.A], () => L.A.getIsAlwaysOnTop(r)), d = l.useCallback(() => {
...
let ep = l.memo(e => {
    let {
        ...
        controlsBottom: K,
        streamId: W
    } = e, Y = (0, c.bG)([F.Ay], () => null != b && F.Ay.isLocalVideoAutoDisabled(b, (0, f.A)(N)), [b, N]), q = (0, T.A)({
        userId: b,
