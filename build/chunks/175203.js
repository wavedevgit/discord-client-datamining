...
let eo = [ei.lp.ACTIVITY],
    ed = l.memo(e => {
        ...
        let r, o, c, {
            ...
            eO = (0, d.bG)([B.Ay], () => null != ev ? B.Ay.getVideoToggleState(ev, (0, p.A)(u.type)) : en.bb8.NONE, [ev, u.type]),
        ...
        switch (u.type) {
            case ei.lp.STREAM:
                eq = (0, i.jsx)($.A, {
                    ...
                    idle: ex,
                    premiumIndicator: !1
                }), eJ = ea.intl.formatToPlainString(ea.t.gHPz3Q, {
            ...
            case ei.lp.USER:
                eq = (0, i.jsx)(Z.A, {
                    ...
                    participant: u,
                    channelId: F.id
                }), eJ = ea.intl.formatToPlainString(ea.t["iC/x/Q"], {
            ...
            case ei.lp.ACTIVITY:
                eq = (0, i.jsx)(J.Ay, {
                    ...
                    channel: F,
                    width: K
                }), eJ = ea.intl.formatToPlainString(ea.t.YCvOsO, {
...
function ec(e) {
    ...
    if (t === ei.lp.STREAM) return n === ei.J7.XBOX ? (0, i.jsx)(W.A, {
        className: l
    }) : (0, i.jsx)(h.kN9, {
        size: "md",
        color: "currentColor",
...
let eA = l.memo(e => {
    let {
        ...
        displayNameStyles: q
    }), J = (0, ee.Y)(s), Q = (0, ee.V)(s), [$, Z] = l.useState(!1);
    l.useEffect(() => {
        let e = !1,
            t = () => {
