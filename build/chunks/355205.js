...
function eR(e) {
    let {
        ...
        location: ey.rE.CONFLICT_CHECKS
    }), S = e_.A.useConfig({
        location: "ActivityPanelGameCard"
    }), T = !b || !N, y = (0, eC.W)(t, n, s), v = [], j = !1;
    T || (a && r ? y && null == s ? v.push(u.M.ACCOUNT_LINK_INVITE_FRIENDS) : v.push(u.M.POST_ACCOUNT_CONNECTION_RTC_POPOVER) : !a && c && null != t && (j = !0), null != f && l?.id != null && l?.name != null && v.push(u.M.JOIN_GAME_COMMUNITY_RTC_CTA));
    let {
        shouldShow: R,
        markAsDismissed: O,
        ...
        children: e => {
            ...
            return s === u.M.ACCOUNT_LINK_INVITE_FRIENDS ? (0, i.jsx)(A.AM, {
                ...
                actions: [{
                    ...
                    onClick: () => {
                        a(eb.i.TAKE_ACTION), o()(null != n, "Received null activity"), ep.default.track(eI.HAw.ACTIVITY_PANEL_BUTTON_CLICKED, {
                ...
                actions: [{
                    ...
                    onClick: () => {
                        a(eb.i.TAKE_ACTION), window.open(em.A.getArticleURL(eI.MVz.IN_GAME_FEATURES), "_blank")
                    }
                }],
                shouldShow: !0,
                onRequestClose: () => a(eb.i.USER_DISMISS)
