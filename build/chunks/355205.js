...
class eR extends s.PureComponent {
    ...
    renderDismissiblePopovers() {
        ...
        return e && x ? E && null == r ? I.push(u.M.ACCOUNT_LINK_INVITE_FRIENDS) : I.push(u.M.POST_ACCOUNT_CONNECTION_RTC_POPOVER) : g && null != s && I.push(u.M.ACCOUNT_LINK_PROMPT), null != C && c?.id != null && c?.name != null && I.push(u.M.JOIN_GAME_COMMUNITY_RTC_CTA), (0, i.jsx)(P.Ay, {
            ...
            children: e => {
                ...
                return n === u.M.ACCOUNT_LINK_INVITE_FRIENDS ? (0, i.jsx)(A.AM, {
                    ...
                    actions: [{
                        ...
                        onClick: () => {
                            r(eN.i.TAKE_ACTION), o()(null != l, "Received null activity"), eA.default.track(eE.HAw.ACTIVITY_PANEL_BUTTON_CLICKED, {
                                action_type: "invite_to_game",
                                game_id: c?.id ?? null,
                                application_id: l.application_id
                            }), (0, L.X)(d, L.O.INVITE), eA.default.track(eE.HAw.OPEN_MODAL, {
                ...
                }) : n === u.M.POST_ACCOUNT_CONNECTION_RTC_POPOVER ? (0, i.jsx)(A.AM, {
                    ...
                    actions: [{
                        ...
                        onClick: () => {
                            r(eN.i.TAKE_ACTION), window.open(ep.A.getArticleURL(eE.MVz.IN_GAME_FEATURES), "_blank")
                        }
                    }],
                    shouldShow: !0,
                    onRequestClose: () => r(eN.i.USER_DISMISS)
                }) : n === u.M.ACCOUNT_LINK_PROMPT ? (0, i.jsx)(A.AM, {
                    graphic: {
                        type: "dynamic",
                    ...
                    actions: [{
                        ...
                        onClick: () => {
                            r(eN.i.TAKE_ACTION), f({
                                analyticsLocations: p
                            })
                        }
                    }]
                }) : n === u.M.JOIN_GAME_COMMUNITY_RTC_CTA && null != C && c?.id != null && c?.name != null ? (0, i.jsx)(B.A, {
    ...
    handleChannelLinkClick = () => {
        ...
        o()(null != t, "Activity cannot be null during navigation click"), o()(null != e, "Channel cannot be null during navigation click"), f.A.channelListScrollTo(e.guild_id ?? eE.ME, e.id), !n && ((0, ee.gV)(e.type) && _.A.selectParticipant(e.id, (0, O.Qt)({
    ...
    renderEmbeddedActivity() {
        ...
        let c = {
            ...
            d = l;
        null != r && null != s ? (e = eE.BVt.CHANNEL(r.id, s.id), d = `${d} / ${r.name}`) : null != s && (e = eE.BVt.CHANNEL(eE.ME, s.id));
        let u = (0, i.jsx)(q.A, {
                href: e,
            ...
            A = (0, i.jsxs)(i.Fragment, {
                children: [(0, i.jsx)(F.A, {
                    ...
                    children: (0, i.jsxs)("div", {
                        className: ev.pq,
                        children: [h, null != s && (0, ee.pQ)(s.type) ? u : (0, i.jsx)(ej, {
                            timestamps: c
                        })]
                    })
                })]
...
let eO = (0, C.A)(function(e) {
    let {
        guildId: t,
        ...n
    } = e, l = (0, d.bG)([en.default], () => en.default.getId()), r = (0, d.bG)([H.Ay, eh.A], () => (0, X.A)(H.Ay, eh.A)), a = (0, d.bG)([ed.A, ei.A], () => ei.A.getChannel(ed.A.getVoiceChannelId())), o = (0, d.bG)([S.Ay], () => S.Ay.getConnectedActivityChannelId()), u = (0, d.bG)([ei.A], () => ei.A.getChannel(o)), h = (0, d.bG)([el.A], () => el.A.getGuild(u?.guild_id)), [A, p] = (0, d.yK)([et.A], () => [et.A.getCurrentUserActiveStream(), et.A.getStreamerActiveStreamMetadata()]), g = (0, d.bG)([I.A], () => I.A.useReducedMotion), m = (0, d.bG)([S.Ay], () => S.Ay.getCurrentEmbeddedActivity()), _ = (0, d.bG)([k.A], () => k.A.getConnectedFrame()), f = (0, d.bG)([el.A, ea.A], () => null == a || K.vz(a, el.A, ea.A, !1)), [x] = (0, R.A)([(null != p && null != p.id ? p.id : null != r && null != r.id ? r.id : null != m ? m.applicationId : null != _ ? _.applicationId : void 0) ?? ""]), C = (0, d.bG)([G.A], () => G.A.getFakeGameData()), b = (0, d.bG)([S.Ay], () => S.Ay.getCurrentEmbeddedActivity()), y = (0, T.u)() && null != b && (0, N.f)(), O = (0, d.bG)([er.Ay], () => (0, W.A)(er.Ay) && (0, eg.isWindows)()), L = (0, d.bG)([eo.A], () => null != l ? eo.A.findActivity(l, e => e.type === eE.$pd.PLAYING) : null), D = null != A && A.ownerId === l && A.state !== eE.XYD.ENDED, U = (0, d.bG)([eu.default, ec.A], () => null != u ? (0, M.m1)(u, eu.default, ec.A) : void 0), P = (0, Q.A)(), [w, B] = s.useState(!1), F = (0, d.bG)([J.A], () => J.A.getWindowOpen(eE.MLl.ACTIVITY_POPOUT)), {
        hasAlreadyLinked: Y,
    ...
    }), [ee, ep] = s.useState(!1), e_ = (0, E.A)(x?.id);
    s.useEffect(() => {
        e_ !== x?.id && ep(!1)
    }, [x, e_]);
    let {
        isQuestBarEmpty: ef,
        hasLoadedQuestBar: ex
    } = (0, Z.c9)({
        location: eT.rE.CONFLICT_CHECKS
    }), {
        parentAnalyticsLocation: eC,
        analyticsLocations: eI
    } = (0, v.Ay)(), eN = em.A.useConfig({
        location: "ActivityPanelGameCard"
    }), eb = (0, c.K)(e => {
        e && null != q && eA.default.track(eE.HAw.ACTIVITY_PANEL_SDK_LINK_VIEWED, {
            game_id: r?.id ?? null,
            application_id: q.id
        })
    }), {
        ...
        location: "ActivityPanelGameCard"
    }), ev = s.useMemo(() => r?.id != null ? eS.g[r.id] : void 0, [r?.id]), ej = (0, d.bG)([es.A], () => null != ev && es.A.isMember(ev), [ev]), eO = ey && null != ev && !ej ? ev : void 0;
    return (0, i.jsx)(eR, {
        ...n,
        guildId: t,
