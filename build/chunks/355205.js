...
function eP(e) {
    ...
    return a && (t = "beta", E = eL.intl.formatToPlainString(eM.default.dPuaZE, {
        ...
        graphic: {
            ...
            props: {
                application: g,
                isIncentivizedAccountLinking: a
            }
        },
        badge: t,
        title: E,
...
function ew(e) {
    let {
        ...
        isQuestBarEmpty: N,
        hasLoadedQuestBar: T
    } = (0, el.c9)(), S = !T || !N, b = (0, eT.W)(t, s, a), y = [], {
        isEligible: v,
        displayedApp: j
    } = function(e) {
        let {
            ...
            data: i
        } = (0, M.YY)(t?.parentId ?? t?.id);
        return {
            isEligible: n && null != t && ev.Y.has(t.id),
            displayedApp: i
        }
    }({
        connectionApp: n
    ...
    return S ? null : (0, i.jsx)(B.Ay, {
        ...
        children: e => {
            ...
            return l === h.M.ACCOUNT_LINK_INVITE_FRIENDS ? (0, i.jsx)(_.AM, {
                ...
                actions: [{
                    ...
                    onClick: () => {
                        a(ej.i.TAKE_ACTION), o()(null != s, "Received null activity"), ef.default.track(eb.HAw.ACTIVITY_PANEL_BUTTON_CLICKED, {
            ...
            }) : l === h.M.POST_ACCOUNT_CONNECTION_RTC_POPOVER ? (0, i.jsx)(ek, {
                ...
                application: t,
                connectionApp: n,
                isEligibleForIncentivizedAccountLinking: v,
...
class eV extends l.PureComponent {
    ...
    renderScreenshare() {
        ...
        return (0, i.jsxs)("div", {
            ...
            children: [e ? (0, i.jsx)(J.A, {
                ...
                look: k.Ay.Looks.GRAY,
                size: k.Ay.Sizes.SMALL,
                className: eD.Ok
            }), (0, i.jsxs)("div", {
                className: eD.pq,
    ...
    renderEmbeddedActivity() {
        ...
        let d = {
            ...
            c = s;
        null != a && null != l ? (e = eb.BVt.CHANNEL(a.id, l.id), c = `${c} / ${a.name}`) : null != l && (e = eb.BVt.CHANNEL(eb.ME, l.id));
        let u = (0, i.jsx)(Z.A, {
                href: e,
            ...
            A = (0, i.jsxs)(i.Fragment, {
                children: [(0, i.jsx)(Y.A, {
                    ...
                    children: (0, i.jsxs)("div", {
                        className: eD.pq,
                        children: [h, null != l && (0, es.pQ)(l.type) ? u : (0, i.jsx)(eB, {
                            timestamps: d
                        })]
                    })
                })]
