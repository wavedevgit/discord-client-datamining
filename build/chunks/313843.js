...
function g(e) {
    let {
        ...
        if (null != t.bannerHash) return o.Ay.getGameAssetURL({
            id: t.id,
            hash: t.bannerHash,
            size: 2048,
            keepAspectRatio: !0
...
let A = function(e) {
    let {
        ...
        isTwoColumn: d
    } = (0, x.c)(), h = l.useRef(null), v = l.useRef(null), [A, j] = l.useState(!1);
    l.useEffect(() => {
        let e = h.current;
        if (null == e) return;
