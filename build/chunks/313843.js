...
function p(e) {
    let {
        ...
        onClose: i,
        trackAction: o
    } = e, c = t.supplementalData?.name ?? t.name ?? n?.name, d = n.getIconURL(80);
    return (0, a.jsxs)("div", {
        className: f.y5,
...
let _ = l.forwardRef(function(e, t) {
    let {
        game: n
    } = e, i = n.supplementalData, [r] = l.useState(() => Math.random()), s = l.useMemo(() => {
    ...
    return (0, d.uJ)(s) ? null : (0, a.jsxs)("div", {
        ref: t,
        children: [(0, a.jsx)("div", {
            className: f.y1,
            style: {
...
function v(e) {
    ...
    return (0, d.uJ)(l) ? null : (0, a.jsx)(s.EYj, {
