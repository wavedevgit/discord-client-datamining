/** chunk id: 785825 params = (module,exports,require) **/
n.d(t, {
    A: () => i,
    D: () => a
});
...
function i(e, t) {
    switch (t.type) {
        case r.X2.NAVIGATE_UP:
            return {
                ...e, focusedIndex: Math.max(0, e.focusedIndex - 1)
            };
        case r.X2.NAVIGATE_DOWN:
            return {
                ...e, focusedIndex: Math.min(e.focusedIndex + 1, e.itemCount - 1)
            };
