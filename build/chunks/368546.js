...
function i(e) {
    ...
    a.useEffect(() => {
        ...
        if (l) {
            ...
            return e.addEventListener("play", x), e.addEventListener("pause", f), e.addEventListener("ended", f), e.addEventListener("seeked", o), e.addEventListener("loadeddata", o), e.paused ? e.readyState >= 2 && o() : t = requestAnimationFrame(m), () => {
                s = !0, cancelAnimationFrame(t), e.removeEventListener("play", x), e.removeEventListener("pause", f), e.removeEventListener("ended", f), e.removeEventListener("seeked", o), e.removeEventListener("loadeddata", o)
            }
        }
    }, [t, n, i])
}