...
let z = {
    [H.IWg.SERVER_NEXT]: N.yx,
    [H.IWg.SERVER_PREV]: N.yv,
    ...
    [H.IWg.MARK_SERVER_READ]: E.P,
    [H.IWg.TOGGLE_CHANNEL_PINS]: G.O,
    [H.IWg.TOGGLE_FOR_LATER]: U.K,
    [H.IWg.TOGGLE_INBOX]: P.q,
    [H.IWg.MARK_TOP_INBOX_CHANNEL_READ]: P.O,
    [H.IWg.TOGGLE_USERS]: M.U,
    [H.IWg.TOGGLE_HELP]: v.x,
    [H.IWg.VIBE_WITH_WUMPUS]: w.y,
    [H.IWg.TOGGLE_MUTE]: R.VT,
    [H.IWg.TOGGLE_DEAFEN]: R.rR,
    [H.IWg.TOGGLE_CATEGORY_COLLAPSED]: y.y,
    [H.IWg.SEARCH_SOUNDBOARD]: T.A,
    [H.IWg.SCROLL_UP]: f.U5,
    [H.IWg.SCROLL_DOWN]: f.fz,
    [H.IWg.QUICKSWITCHER_SHOW]: C.R,
    [H.IWg.CREATE_DM_GROUP]: l.X,
    [H.IWg.SEARCH_EMOJIS]: m.L,
    [H.IWg.SEARCH_GIFS]: S.T,
    [H.IWg.SEARCH_STICKERS]: b.w,
    [H.IWg.TOGGLE_HOTKEYS]: D.z,
    [H.IWg.JUMP_TO_FIRST_UNREAD]: I.s,
    [H.IWg.CREATE_GUILD]: o.$,
    [H.IWg.UPLOAD_FILE]: V.T,
    [H.IWg.RETURN_TO_AUDIO_CHANNEL]: p.u,
    ...
    [H.IWg.ZOOM_IN]: F.Ur,
    [H.IWg.ZOOM_OUT]: F.hU,
    [H.IWg.ZOOM_RESET]: F.O$,
    [H.IWg.OPEN_APP_DIRECTORY]: g.N,
