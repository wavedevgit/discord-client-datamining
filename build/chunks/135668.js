/** chunk id: 135668 params = (module,exports,require) **/
i.d(t, {
    default: () => $
}), i(321073);
var s = i(627968),
...
let V = e => {
        let {
            ...
            headerId: r,
            theme: o
        } = e, c = (0, d.bG)([S.A], () => S.A.getGuild(t.id), [t.id]), x = null != c && c.verificationLevel > y.PvD.NONE, u = c?.explicitContentFilter === y.gh6.ALL_MEMBERS, p = (0, m.Mw)(o) ? H : Y;
        return (0, s.jsxs)("div", {
            className: D.kL,
...
function z(e) {
    let {
        ...
        name: i,
        color: l
    } = (0, d.bG)([A.A], () => A.A.getEveryoneRole(t));
    return (0, s.jsx)("div", {
        className: D.__invalid_role,
        children: (0, s.jsxs)("span", {
            className: D.xf,
            children: [(0, s.jsx)(h.WYI, {
                className: D.m4,
                color: l.toString(),
                background: !1,
                tooltip: !1
...
function J(e) {
    let {
        ...
        onGetPermisisonName: i
    } = e, l = P.intl.string(P.t.Yo5qlq);
    return t.length === G.dR.length && (l = P.intl.string(P.t.FgMS6i)), (0, s.jsxs)("div", {
        className: D.CZ,
        children: [(0, s.jsx)(h.Text, {
            className: D.qd,
            variant: "text-xs/semibold",
...
let Q = e => {
    ...
    $ = e => {
        ...
        let {
            guild: n
        } = (0, d.cf)([v.A], () => v.A.getProps()), a = (0, d.bG)([f.A], () => f.A.theme), [o, c] = l.useState(!1), [x, m] = l.useState(!G.dR.some(e => w.Ib(e, n))), [u, h] = l.useState(G.SP), [_, S] = l.useState(G.SP), [L] = l.useState(n?.defaultMessageNotifications), [k] = l.useState(n?.verificationLevel), [R] = l.useState(n?.explicitContentFilter), [O] = l.useState(x), F = (0, d.bG)([A.A], () => null != n ? A.A.getEveryoneRole(n) : void 0), U = (0, d.bG)([C.Ay], () => null != n ? C.Ay.getChannels(n.id) : null), H = (0, b.GV)(), {
            enabled: Y
        } = (0, p.zi)(n?.id ?? y.dJq);
        if (null == n) return null;
        let z = [{
            value: G.SP,
            label: P.intl.string(P.t.Cla0re)
        }];
        U[C.I6].forEach(e => {
            let {
                channel: t
            } = e;
            t.type === y.rbe.GUILD_TEXT && z.push({
                value: t.id,
                label: (0, g.m1)(t, I.default, E.A, !0)
            })
        });
        let Z = k !== y.PvD.NONE,
            ...
            $ = async () => {
                ...
                t !== F.permissions && await (0, j.JY)(n.id, [s]), N.A.updateGuild({
                    features: e,
                    rulesChannelId: u,
                ...
                onAcceptContentFilter: e => {
                    e ? N.A.updateGuild({
                        explicitContentFilter: y.gh6.ALL_MEMBERS
                    }) : N.A.updateGuild({
                ...
                onAcceptPolicy: e => {
                    if (e) {
                        c(!0), K || N.A.updateGuild({
                            defaultMessageNotifications: y.orn.ONLY_MENTIONS
                        }), x || null == F || m(!0);
                        return
                    }
                    c(!1), K && N.A.updateGuild({
                        defaultMessageNotifications: L
                    }), x && null != F && m(!1)
                },
                headerId: H,
                theme: a
                ...
                modalContent: X,
                disableNextStep: n.explicitContentFilter !== y.gh6.ALL_MEMBERS || n.verificationLevel === y.PvD.NONE,
                ...
                modalContent: et,
                disableNextStep: !o,
                overviewTitle: P.intl.string(P.t.Pj9P8E)
            }];
        return (0, s.jsx)(T.A, {
            stepData: es,
            ...
            transitionState: t,
            onClose: () => {
                i(), M.default.track(y.HAw.MODAL_DISMISSED, {
                    type: G.bK
                })
            },
