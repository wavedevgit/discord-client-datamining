...
function C(e) {
    let {
        ...
        message: s,
        compact: A
    } = e, T = (0, o.Ay)(s), N = function(e) {
        let {
            author: t,
            channel: n,
            message: i
        } = e, s = n.guild_id, o = (0, c.P)({
            user: i.author,
            channelId: n.id,
            guildId: s,
            messageId: i.id
        ...
        message: s,
        author: T
    }), g = s.roleSubscriptionData?.total_months_subscribed != null && s.roleSubscriptionData?.total_months_subscribed <= 1;
