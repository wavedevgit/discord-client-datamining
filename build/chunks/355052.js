...
class w extends s.PureComponent {
    ...
    componentDidMount() {
        this.notificationTimer = setTimeout(this.hideNotification, j), _.A.track(T.HAw.NOTIFICATION_VIEWED, {
    ...
    handleReload = e => {
        this.setState({
            busy: !0
        }), L(), _.A.track(T.HAw.NOTIFICATION_CLICKED, {
            notif_type: N.KS.OverlayCrashed,
            action_type: "reload"
