...
function R(e) {
    ...
    } = e, B = t[0], k = t.length > 1, {
        analyticsLocations: N
    } = (0, s.Ay)(), H = (0, a.bG)([g.Ay, p.A, h.default, f.A], () => g.Ay.getFlattenedGuildIds().some(e => {
    ...
    async function G() {
        ...
        try {
            ...
            (0, r.mMO)(async () => {
                let {
                    default: a
                } = await Promise.all([n.e("40556"), n.e("45893")]).then(n.bind(n, 6503)), r = e?.guild_id != null ? f.A.getGuild(e.guild_id) : null, l = null != r && (0, c.ie)(r, p.A, h.default).canCreateExpressions, o = null == B.name || "" === B.name ? (0, C.cM)(b.default.extractTimestamp(B.id)) : B.name, s = o.slice(0, 32);
                return n => (0, i.jsx)(a, {
                    ...n,
                    showGuildPicker: !0,
    ...
    return (0, i.jsxs)(r.W1t, {
        ...
        children: [t.some(e => !0 === e.isTemporary) && (0, i.jsx)(r.Drp, {
            ...
            children: [null != o.A.clipboard.copyFile && (0, i.jsx)(r.Drp, {
                ...
                action: function() {
                    (0, l.Z_)(), o.A.clipboard.copyFile(B.filepath), (0, r.showToast)((0, r.createToast)(D.intl.string(D.t.mGZ66D), r.ToastType.SUCCESS))
                }
            }), H && B.type !== A.nQ.SCREENSHOT ? (0, i.jsx)(r.Drp, {
                icon: r.JMI,
                leadingAccessory: {
                    type: "icon",
                    icon: r.JMI
                ...
                action: q
            }), B.type !== A.nQ.SCREENSHOT && (0, i.jsx)(r.Drp, {
                icon: r.s3U,
                leadingAccessory: {
                    type: "icon",
                    icon: r.s3U
