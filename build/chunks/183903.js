/** chunk id: 183903 params = (module,exports,require) **/
n.d(t, {
    default: () => R
});
var i = n(627968);
...
function R(e) {
    ...
    } = e, O = t[0], H = t.length > 1, {
        analyticsLocations: U
    } = (0, s.Ay)(), k = (0, a.bG)([g.Ay, p.A, h.default, f.A], () => g.Ay.getFlattenedGuildIds().some(e => {
    ...
    async function Z() {
        ...
        try {
            ...
            (0, r.mMO)(async () => {
                let {
                    default: a
                } = await Promise.all([n.e("40556"), n.e("34681")]).then(n.bind(n, 6503)), r = e?.guild_id != null ? f.A.getGuild(e.guild_id) : null, l = null != r && (0, c.ie)(r, p.A, h.default).canCreateExpressions, o = null == O.name || "" === O.name ? (0, v.cM)(O.createdAt) : O.name, s = o.slice(0, 32);
                return n => (0, i.jsx)(a, {
                    ...n,
                    showGuildPicker: !0,
                    guildId: l ? e?.guild_id : void 0,
                    sourceFile: {
                        file: new File([t], `${o}.mp4`, {
                            type: "video/mp4"
                        }),
                        name: s
                    }
    ...
    return (0, i.jsxs)(r.W1t, {
        ...
        children: [t.some(e => !0 === e.isTemporary) && (0, i.jsx)(r.Drp, {
            ...
            disabled: T,
            action: L
        }), !H && k && O.type !== w.nQ.SCREENSHOT ? (0, i.jsx)(r.Drp, {
            leadingAccessory: {
                type: "icon",
                icon: r.JMI
            },
            ...
            action: Z
        }) : null, !H && null != o.A.clipboard.copyFile && (0, i.jsx)(r.Drp, {
            leadingAccessory: {
                type: "icon",
                icon: r.TdU
            },
            ...
            action: function() {
                (0, l.Z_)(), o.A.clipboard.copyFile(O.filepath), (0, r.showToast)((0, r.createToast)(S.intl.string(S.t.mGZ66D), r.ToastType.SUCCESS))
            }
        }), !H && (0, i.jsxs)(r.Drp, {
            ...
            children: [(0, i.jsx)(r.Drp, {
                ...
                action: G
            }), O.type !== w.nQ.SCREENSHOT && (0, i.jsx)(r.Drp, {
                leadingAccessory: {
                    type: "icon",
                    icon: r.s3U
                },
        ...
        }), (0, i.jsx)(r.bXX, {}), !0 === O.isFavorite && (0, i.jsx)(r.Drp, {
            leadingAccessory: {
                type: "icon",
                icon: r.UlM
            },
