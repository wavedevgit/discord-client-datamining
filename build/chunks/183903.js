...
function R(e) {
    ...
    } = e, T = t[0], U = t.length > 1, {
        analyticsLocations: k
    } = (0, s.Ay)(), N = (0, a.bG)([g.Ay, p.A, h.default, f.A], () => g.Ay.getFlattenedGuildIds().some(e => {
    ...
    async function Z() {
        ...
        try {
            ...
            (0, r.mMO)(async () => {
                let {
                    default: a
                } = await Promise.all([n.e("40556"), n.e("34681")]).then(n.bind(n, 6503)), r = e?.guild_id != null ? f.A.getGuild(e.guild_id) : null, l = null != r && (0, c.ie)(r, p.A, h.default).canCreateExpressions, o = null == T.name || "" === T.name ? (0, C.cM)(T.createdAt) : T.name, s = o.slice(0, 32);
                return n => (0, i.jsx)(a, {
                    ...n,
                    showGuildPicker: !0,
    ...
    return (0, i.jsxs)(r.W1t, {
        ...
        children: [t.some(e => !0 === e.isTemporary) && (0, i.jsx)(r.Drp, {
            ...
            children: [null != o.A.clipboard.copyFile && (0, i.jsx)(r.Drp, {
                ...
                action: function() {
                    (0, l.Z_)(), o.A.clipboard.copyFile(T.filepath), (0, r.showToast)((0, r.createToast)(S.intl.string(S.t.mGZ66D), r.ToastType.SUCCESS))
                }
            }), N && T.type !== w.nQ.SCREENSHOT ? (0, i.jsx)(r.Drp, {
                leadingAccessory: {
                    type: "icon",
                    icon: r.JMI
                },
                ...
                action: G
            }), T.type !== w.nQ.SCREENSHOT && (0, i.jsx)(r.Drp, {
                leadingAccessory: {
                    type: "icon",
                    icon: r.s3U
                },
