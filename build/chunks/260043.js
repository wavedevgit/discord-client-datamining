/** chunk id: 260043, original params: e,a,t (module,exports,require) **/
t.d(a, {
    u: () => c
});
var r = t(99478),
...
function s(e) {
    let a = i.findIndex(([a, t, r]) => !!(e.year < a) || e.year === a && !!(e.month < t) || e.year === a && e.month === t && !!(e.day < r));
...
class c extends n.FG {
    ...
    constrainDate(e) {
        ...
        if (null != t) {
            let [r, n, i] = t, l = r - o[a];
            e.year = Math.max(1, Math.min(l, e.year)), e.year === l && (e.month = Math.min(n, e.month), e.month === n && (e.day = Math.min(i, e.day)))
        }
        if (1 === e.year && a >= 0) {
            let [, t, r] = i[a];
