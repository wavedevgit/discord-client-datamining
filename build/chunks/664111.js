...
let w = {
    ...
    P = l.forwardRef(function(e, t) {
        let {
            ...
            visibleChanged: eN,
            targetRef: eR
        } = (0, y.O7)(), [eL, ew] = l.useState(a ? o.Q6.PLAYING : o.Q6.PAUSED), [eT, eP] = l.useState(!1), [eD, ej] = l.useState(!1), [eM, ek] = l.useState(0), [eI, eB] = l.useState(null), eU = l.useCallback(e => {
            eB(null), ek(e)
        }, []), [eF, eG] = l.useState(!1), eQ = l.useRef(null), [e$, eO] = l.useState(o.h$.LOADING), e_ = l.useRef(!1), eK = l.useRef(null), [eY, eX] = l.useState([]), [ez, eV] = l.useState(!1), eW = l.useRef(!1), eH = l.useRef(!1), eZ = l.useRef(!1), eJ = l.useRef(!1), [eq, e0] = l.useState(!0), e1 = l.useRef(!0), e6 = l.useRef(null), e2 = l.useRef(null), e9 = l.useRef(0);
        l.useLayoutEffect(() => {
            e9.current = performance.now()
        }, []);
        let [e4, e8] = l.useState(K), [e7, e3] = l.useState(Y), [e5, te] = l.useState(!1), [tt, tn] = l.useState(!1), [tr, tl] = l.useState(!1), ta = (0, u.bG)([f.A], () => f.A.useReducedMotion), ti = (0, l.useRef)(null), ts = (0, l.useRef)(null), tu = (0, l.useRef)(null), to = l.useRef(!0), [tc, td] = l.useState(null);
        (0, A.A)({
            videoRef: ti,
            canvasRef: ts,
            enabled: ev && !ta,
        ...
        let tC = l.useCallback(function(e) {
            ...
            if (eJ.current = !0, ew(e), Q?.(e, t), null != ti.current) switch (e) {
                case o.Q6.PLAYING:
        ...
        }, [ec, n, eS, eA, eC, eN, eL, tC]), l.useEffect(() => {
            eA && Z?.(eS, eL)
        }, [eS, eA, eL, Z]), l.useEffect(() => {
            eN && J?.(eC, eL)
        }, [eC, eN, eL, J]);
        let [tN, tR] = l.useState(!1), tL = l.useRef(null), tw = l.useRef(0);
        l.useLayoutEffect(() => {
            tw.current = performance.now()
        }, []);
        let tT = l.useCallback(() => {
                null != tL.current && clearTimeout(tL.current), eL !== o.Q6.PLAYING || (tL.current = setTimeout(() => {
        ...
        let tM = l.useCallback(() => {
            ...
            tk = () => {
                null == ti.current || (tB(Math.max((eK.current ?? ti.current.currentTime) - 10, 0)), eL === o.Q6.ENDED && tC(o.Q6.PAUSED, o.KB.SEEK))
            },
            tI = () => {
        ...
        let tB = l.useCallback(function(e) {
                let t = !(arguments.length > 1) || void 0 === arguments[1] || arguments[1];
                if (null == ti.current) return;
                let n = ti.current.currentTime;
                eK.current = e, eB(e / (ti.current.duration ?? 1) * 100), eG(!0), null != eQ.current && clearTimeout(eQ.current), eQ.current = setTimeout(() => {
                    eG(!1), eQ.current = null
                }, 100), e_.current = !0, ti.current.currentTime = e, t && q?.(n, e)
            }, [q]),
            tU = () => {
                if (null != ti.current) switch (eL) {
                    case o.Q6.ENDED:
        ...
        l.useEffect(() => (tX({
            captionHeightSpring: tt && null != th ? tK.current?.clientHeight ?? 0 : 0,
            immediate: ta
        }), () => {
            tY.stop()
        }), [tt, tX, ta, th, tY]), l.useEffect(() => (t_({
            controlBarAnimSpring: tD || ez ? 1 : 0,
            immediate: ta
        }), () => {
            tO.stop()
        }), [tD, t_, ta, ez, tO]);
        let tz = eL === o.Q6.ENDED && null != G,
            tV = l.useCallback(function() {
        ...
        return (0, r.jsx)(d.DUT, {
            ...
            children: (0, r.jsxs)("div", {
                ...
                children: [ev && !ta && (0, r.jsx)("canvas", {
                    ...
                    ref: e => {
                        ti.current = e, eR.current = e, "function" == typeof t ? t(e) : null != t && (t.current = e)
                    },
                    autoPlay: a,
                    playsInline: !0,
                    ...
                    onTimeUpdate: e => {
                        null != ti.current && (M?.(ti.current.currentTime, ti.current.duration), e_.current || eU(ti.current.currentTime / ti.current.duration * 100))
                    },
                    onEnded: e => {
                    ...
                    onProgress: e => {
                        ...
                        for (let e = 0; e < ti.current.buffered.length; e++) {
                            ...
                            r - n < 1 || t.push({
                                start: n / ti.current.duration,
                                size: (r - n) / ti.current.duration
                            })
                        }
                        eX(t)
                    },
                    ...
                    onCanPlayThrough: t$,
                    onSeeked: () => {
                        e_.current = !1, eK.current = null, null != ti.current && eU(ti.current.currentTime / ti.current.duration * 100)
                    },
                ...
                }), e$ !== o.h$.READY && eL === o.Q6.PLAYING && null != eg && (0, r.jsx)("span", {
                    className: i()(L.S, {
                        [L.F]: "center" === eE
                    }),
                    ...
                    message: ey({
                        hasVideoAsset: null != eg,
                        playerState: eL,
                        pauseReason: tc
                    }),
                    showOverlay: null == eg
                }), null != ee && (0, r.jsx)(s.animated.div, {
                    className: L.MU,
                    style: {
                    ...
                    children: et({
                        playerState: eL,
                        isControlBarExpanded: tD
                    })
                }), e5 && eL !== o.Q6.ENDED && null != F && (0, r.jsxs)(r.Fragment, {
                    children: [(0, r.jsx)(d.DUT, {
                        ...
                        style: {
                            marginBottom: (0, s.to)([tO, tY], (e, t) => `${e*tA[ty]+t}px`)
                        },
                    ...
                    children: eL === o.Q6.PLAYING ? (0, r.jsx)(d.udU, {
                        className: L.PK
                    }) : (0, r.jsx)(d.E$n, {
                        className: L.PK
                    })
                }, eL), tt && null != th && !tz && (0, r.jsx)(s.animated.div, {
                    className: L.o$,
                    ref: tK,
                    ...
                    children: [(0, r.jsx)(s.animated.div, {
                        ...
                        children: (0, r.jsx)("div", {
                            ...
                            children: (0, r.jsx)(v.Ay, {
                                ...
                                onScrubForward: tI,
                                onDragStateChange: e => {
                                    if (eH.current = e, eV(e), e) eW.current = eL === o.Q6.PLAYING, eZ.current = eL === o.Q6.ENDED, eW.current ? ti.current?.pause() : eZ.current && tC(o.Q6.PAUSED, o.KB.SEEK);
                                    else {
                                        let e = ti.current,
                                            t = null != e && !Number.isNaN(e.duration) && e.currentTime >= e.duration;
                                        eW.current ? (eW.current = !1, t ? tC(o.Q6.ENDED, o.KB.PLAYBACK_COMPLETE) : e?.play()) : eZ.current ? (eZ.current = !1, t ? tC(o.Q6.ENDED, o.KB.PLAYBACK_COMPLETE) : tC(o.Q6.PLAYING, o.KB.USER)) : t && tC(o.Q6.ENDED, o.KB.PLAYBACK_COMPLETE)
                                    }
                                },
                                indicatorConfig: ep,
                        ...
                        children: (0, r.jsx)(x.A, {
                            ...
                            handleFullScreenBtnClick: () => {
                                ...
                                e && null != t ? ((0, p.tl)(t), t.addEventListener(p.Wb, tM), $?.(!0), tS(o.oA.LG)) : e || null == t || (t.removeEventListener(p.Wb, tM), $?.(!1), (0, p.sP)(t), tS(o.oA.MD)), tl(e)
                            },
