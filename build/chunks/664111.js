...
let w = {
    ...
    L = l.forwardRef(function(e, t) {
        let {
            ...
            visibleChanged: eA,
            targetRef: eN
        } = (0, y.O7)(), [eR, ew] = l.useState(C ? o.Q6.PLAYING : o.Q6.PAUSED), [eT, eL] = l.useState(!1), [eP, ej] = l.useState(!1), [eD, eM] = l.useState(0), [ek, eI] = l.useState(null), eB = l.useCallback(e => {
            eI(null), eM(e)
        ...
        let [e1, e6] = l.useState(K), [e2, e4] = l.useState(X), [e9, e8] = l.useState(!1), [e7, e3] = l.useState(!1), [e5, te] = l.useState(!1), tt = (0, s.bG)([f.A], () => f.A.useReducedMotion), tn = (0, l.useRef)(null), tr = (0, l.useRef)(null), tl = l.useRef(!0), [ta, ti] = l.useState(null), tu = l.useCallback((e, t) => {
            ...
            onError: tu,
            onHlsInstance: er
        }), [to, tc] = l.useState(null), [td, tm] = l.useState(0), [tf, th] = l.useState(!1), tp = U ?? tn.current?.duration ?? 0, [tx, tE] = l.useState(o.oA.MD), tb = {
            [o.oA.MD]: 56,
            [o.oA.LG]: 64
        };
        (0, m.u5)(() => {
        ...
        let tv = l.useCallback(function(e) {
        ...
        }, [ec, a, ey, eS, eC, eA, eR, tv]), l.useEffect(() => {
            eS && Z?.(ey, eR)
        }, [ey, eS, eR, Z]), l.useEffect(() => {
            eA && q?.(eC, eR)
        }, [eC, eA, eR, q]);
        let [tg, ty] = l.useState(!1), tS = l.useRef(null), tC = l.useRef(0);
        l.useLayoutEffect(() => {
            tC.current = performance.now()
        }, []);
        let tA = l.useCallback(() => {
                null != tS.current && clearTimeout(tS.current), eR !== o.Q6.PLAYING || (tS.current = setTimeout(() => {
        ...
        let tT = l.useCallback(() => {
            ...
            tL = () => {
                null == tn.current || (tj(Math.max((e_.current ?? tn.current.currentTime) - 10, 0)), eR === o.Q6.ENDED && tv(o.Q6.PAUSED, o.KB.SEEK))
            },
            tP = () => {
        ...
        let tj = l.useCallback(function(e) {
        ...
        l.useEffect(() => {
            ...
            let e = tr.current;
            return e.addEventListener("load", tI), () => {
        ...
        l.useEffect(() => (tQ({
            captionHeightSpring: e7 && null != to ? t$.current?.clientHeight ?? 0 : 0,
            immediate: tt
        }), () => {
            tO.stop()
        }), [e7, tQ, tt, to, tO]), l.useEffect(() => (tG({
            controlBarAnimSpring: tR || eX ? 1 : 0,
            immediate: tt
        }), () => {
            tU.stop()
        }), [tR, tG, tt, eX, tU]);
        let tF = eR === o.Q6.ENDED && null != O,
            t_ = l.useCallback(function() {
        ...
        return (0, r.jsx)(d.DUT, {
            ...
            children: (0, r.jsxs)("div", {
                ...
                children: [tF && O?.({
                    ...
                    showOverlay: null == ev
                }), null != et && (0, r.jsx)(u.animated.div, {
                    className: R.MU,
                    style: {
                        opacity: (0, u.to)([tU.to({
                            range: [0, 1],
                            output: [0, 1]
                        })], e => `${e}`),
                        visibility: (0, u.to)([tU.to({
                            range: [0, 1],
                            output: [0, 1]
                        })], e => e < .1 ? "hidden" : "visible"),
                        pointerEvents: (0, u.to)([tU.to({
                            range: [0, 1],
                            output: [0, 1]
                        })], e => e < .3 ? "none" : "auto")
                    },
                    ...
                    children: [(0, r.jsx)(d.DUT, {
                        ...
                        style: {
                            marginBottom: (0, u.to)([tU, tO], (e, t) => `${e*tb[tx]+t}px`)
                        },
                ...
                }, eR), e7 && null != to && !tF && (0, r.jsx)(u.animated.div, {
                    className: R.o$,
                    ref: t$,
                    "data-testid": "discord-web-video-player-captions",
                    style: {
                        translateY: (0, u.to)([tU.to({
                            range: [0, 1],
                            output: [-20, -tb[tx]]
                        })], e => `${e}px`)
                    },
                    ...
                    children: [(0, r.jsx)(u.animated.div, {
                        ...
                        children: (0, r.jsx)("div", {
                            ...
                            children: (0, r.jsx)(b.Ay, {
                                ...
                                onScrubForward: tP,
                                onDragStateChange: e => {
                                    if (ez(e), e) eV.current = eR === o.Q6.PLAYING, eV.current && tn.current?.pause();
                                    else if (eV.current) {
                                        eV.current = !1;
                                        let e = tn.current;
                                        null != e && !Number.isNaN(e.duration) && e.currentTime >= e.duration ? tv(o.Q6.ENDED, o.KB.PLAYBACK_COMPLETE) : e?.play()
                                    }
                                },
                                indicatorConfig: ep,
                        ...
                        style: {
                            paddingTop: (0, u.to)([tU.to({
                                range: [0, 1],
                                output: [0, 1]
                            })], e => `${e*e*20}px`),
                            paddingBottom: (0, u.to)([tU.to({
                                range: [0, 1],
                                output: [0, 1]
                            })], e => `${e*e*12}px`),
                            pointerEvents: (0, u.to)([tU.to({
                        ...
                        children: (0, r.jsx)(E.A, {
                            ...
                            handleFullScreenBtnClick: () => {
                                ...
                                e && null != t ? ((0, p.tl)(t), t.addEventListener(p.Wb, tT), F?.(!0), tE(o.oA.LG)) : e || null == t || (t.removeEventListener(p.Wb, tT), F?.(!1), (0, p.sP)(t), tE(o.oA.MD)), te(e)
                            },
...
function P(e) {
    let {
        ...
        orientation: i,
        objectFit: u = "contain"
    } = e, [s, o] = l.useState(!1), d = l.useCallback(() => o(!0), []);
...
let j = l.forwardRef(function(e, t) {
    let {
        ...
        objectFit: E
    } = u, [b, v] = l.useState(!1), g = l.useCallback(e => {
        null != a ? a(e) : v(!0)
    }, [a]), y = l.useRef(null);
