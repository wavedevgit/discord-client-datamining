...
let w = {
    ...
    j = l.forwardRef(function(e, t) {
        let {
            ...
            visibleChanged: eR,
            targetRef: eL
        } = (0, y.O7)(), [ew, eT] = l.useState(A ? o.Q6.PLAYING : o.Q6.PAUSED), [ej, eP] = l.useState(!1), [ek, eD] = l.useState(!1), [eM, eI] = l.useState(0), [eB, eU] = l.useState(null), eF = l.useCallback(e => {
            eU(null), eI(e)
        }, []), [eG, e$] = l.useState(!1), eO = l.useRef(null), [eQ, e_] = l.useState(o.h$.LOADING), eY = l.useRef(!1), eK = l.useRef(null), [eX, ez] = l.useState([]), [eV, eW] = l.useState(!1), eH = l.useRef(!1), [eJ, eZ] = l.useState(!1), eq = l.useRef(!0), e0 = l.useRef(null), e1 = l.useRef(null), e6 = l.useRef(0);
        l.useLayoutEffect(() => {
            e6.current = performance.now()
        }, []);
        let [e2, e9] = l.useState(X), [e4, e8] = l.useState(z), [e7, e3] = l.useState(!1), [e5, te] = l.useState(!1), [tt, tn] = l.useState(!1), tr = (0, u.bG)([f.A], () => f.A.useReducedMotion), tl = (0, l.useRef)(null), ta = (0, l.useRef)(null), ti = (0, l.useRef)(null), ts = l.useRef(!0), [tu, to] = l.useState(null);
        (0, C.A)({
            videoRef: tl,
            canvasRef: ta,
            enabled: eb && !tr,
        ...
        let tS = l.useCallback(function(e) {
            let t = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : null;
            if (eT(e), Q?.(e, t), null != tl.current) switch (e) {
                case o.Q6.PLAYING:
        ...
        }, [ed, a, eC, eA, eN, eR, ew, tS]), l.useEffect(() => {
            eA && q?.(eC, ew)
        }, [eC, eA, ew, q]), l.useEffect(() => {
            eR && ee?.(eN, ew)
        }, [eN, eR, ew, ee]);
        let [tC, tA] = l.useState(!1), tN = l.useRef(null), tR = l.useRef(0);
        l.useLayoutEffect(() => {
            tR.current = performance.now()
        }, []);
        let tL = l.useCallback(() => {
                null != tN.current && clearTimeout(tN.current), ew !== o.Q6.PLAYING || (tN.current = setTimeout(() => {
        ...
        let tP = l.useCallback(() => {
            ...
            tk = () => {
                null == tl.current || (tM(Math.max((eK.current ?? tl.current.currentTime) - 10, 0)), ew === o.Q6.ENDED && tS(o.Q6.PAUSED, o.KB.SEEK))
            },
            tD = () => {
        ...
        let tM = l.useCallback(function(e) {
                let t = !(arguments.length > 1) || void 0 === arguments[1] || arguments[1];
                if (null == tl.current) return;
                let n = tl.current.currentTime;
                eK.current = e, eU(e / (tl.current.duration ?? 1) * 100), e$(!0), null != eO.current && clearTimeout(eO.current), eO.current = setTimeout(() => {
                    e$(!1), eO.current = null
                }, 100), eY.current = !0, tl.current.currentTime = e, t && et?.(n, e)
            }, [et]),
            tI = () => {
                if (null != tl.current) switch (ew) {
                    case o.Q6.ENDED:
        ...
        l.useEffect(() => (tY({
            captionHeightSpring: e5 && null != tm ? tQ.current?.clientHeight ?? 0 : 0,
            immediate: tr
        }), () => {
            t_.stop()
        }), [e5, tY, tr, tm, t_]), l.useEffect(() => (tO({
            controlBarAnimSpring: tT || eV ? 1 : 0,
            immediate: tr
        }), () => {
            t$.stop()
        }), [tT, tO, tr, eV, t$]);
        ...
        return (0, r.jsx)(d.DUT, {
            ...
            children: (0, r.jsxs)("div", {
                ...
                children: [eb && !tr && (0, r.jsx)("canvas", {
                    ...
                    ref: e => {
                        tl.current = e, eL.current = e, "function" == typeof t ? t(e) : null != t && (t.current = e)
                    },
                    autoPlay: A,
                    playsInline: !0,
                    ...
                    onTimeUpdate: e => {
                        null != tl.current && (I?.(tl.current.currentTime, tl.current.duration), eY.current || eF(tl.current.currentTime / tl.current.duration * 100))
                    },
                    onEnded: e => {
                    ...
                    onCanPlayThrough: tG,
                    onSeeked: () => {
                        eY.current = !1, eK.current = null, null != tl.current && eF(tl.current.currentTime / tl.current.duration * 100)
                    },
                ...
                }), eQ !== o.h$.READY && ew === o.Q6.PLAYING && null != ey && (0, r.jsx)("span", {
                    className: i()(L.S, {
                        [L.F]: "center" === ev
                    }),
                    ...
                    message: eS({
                        hasVideoAsset: null != ey,
                        playerState: ew,
                        pauseReason: tu
                    }),
                    showOverlay: null == ey
                }), null != en && (0, r.jsx)(s.animated.div, {
                    className: L.MU,
                    style: {
                        opacity: (0, s.to)([t$.to({
                            range: [0, 1],
                        ...
                        visibility: (0, s.to)([t$.to({
                            range: [0, 1],
                            output: [0, 1]
                        })], e => e < .1 ? "hidden" : "visible"),
                        pointerEvents: (0, s.to)([t$.to({
                            range: [0, 1],
                            output: [0, 1]
                        })], e => e < .3 ? "none" : "auto")
                    },
                    ...
                    children: er({
                        playerState: ew,
                        isControlBarExpanded: tT
                    })
                }), e7 && ew !== o.Q6.ENDED && null != $ && (0, r.jsxs)(r.Fragment, {
                    children: [(0, r.jsx)(d.DUT, {
                        ...
                        style: {
                            marginBottom: (0, s.to)([t$, t_], (e, t) => `${e*ty[tb]+t}px`)
                        },
                    ...
                    className: i()(L.yf, {
                        [L.ZH]: ew === o.Q6.PLAYING,
                        [L.v7]: ew === o.Q6.PAUSED
                    }),
                    style: {
                        "--custom-play-pause-pop-ms": "1000ms"
                    },
                    children: ew === o.Q6.PLAYING ? (0, r.jsx)(d.udU, {
                        className: L.PK
                    }) : (0, r.jsx)(d.E$n, {
                        className: L.PK
                    })
                }, ew), e5 && null != tm && !tK && (0, r.jsx)(s.animated.div, {
                    className: L.o$,
                    ref: tQ,
                    "data-testid": "discord-web-video-player-captions",
                    style: {
                        translateY: (0, s.to)([t$.to({
                            range: [0, 1],
                            output: [-20, -ty[tb]]
                        })], e => `${e}px`)
                    },
                    ...
                    children: [(0, r.jsx)(s.animated.div, {
                        ...
                        children: (0, r.jsx)("div", {
                            ...
                            children: (0, r.jsx)(E.Ay, {
                                ...
                                onScrubForward: tD,
                                onDragStateChange: e => {
                                    if (eW(e), e) eH.current = ew === o.Q6.PLAYING, eH.current && tl.current?.pause();
                                    else if (eH.current) {
                                        eH.current = !1;
                                        let e = tl.current;
                                        null != e && !Number.isNaN(e.duration) && e.currentTime >= e.duration ? tS(o.Q6.ENDED, o.KB.PLAYBACK_COMPLETE) : e?.play()
                                    }
                                },
                                indicatorConfig: ex,
                        ...
                        style: {
                            paddingTop: (0, s.to)([t$.to({
                                range: [0, 1],
                                output: [0, 1]
                            })], e => `${e*e*20}px`),
                            paddingBottom: (0, s.to)([t$.to({
                                range: [0, 1],
                                output: [0, 1]
                            })], e => `${e*e*12}px`),
                            pointerEvents: (0, s.to)([t$.to({
                        ...
                        children: (0, r.jsx)(v.A, {
                            ...
                            handleFullScreenBtnClick: () => {
                                ...
                                e && null != t ? ((0, h.tl)(t), t.addEventListener(h.Wb, tP), _?.(!0), tg(o.oA.LG)) : e || null == t || (t.removeEventListener(h.Wb, tP), _?.(!1), (0, h.sP)(t), tg(o.oA.MD)), tn(e)
                            },
...
let k = l.forwardRef(function(e, t) {
    let {
        ...
        objectFit: v
    } = s, [E, b] = l.useState(!1), g = l.useCallback(e => {
        null != a ? a(e) : b(!0)
    }, [a]), y = l.useRef(null);
    return n || E ? (0, r.jsx)(j, {
        ...s,
        onClick: a,
        autoplay: u || E,
        ref: t
