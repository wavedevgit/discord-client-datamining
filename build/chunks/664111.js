...
let w = {
    ...
    L = l.forwardRef(function(e, t) {
        let {
            ...
            ek(null), eD(e)
        }, []), [eB, eU] = l.useState(!1), eG = l.useRef(null), [e$, eO] = l.useState(o.h$.LOADING), eQ = l.useRef(!1), e_ = l.useRef(null), [eF, eY] = l.useState([]), [eK, eX] = l.useState(!1), ez = l.useRef(!1), [eV, eW] = l.useState(!1), eH = l.useRef(!0), eJ = l.useRef(null), eZ = l.useRef(null), eq = l.useRef(0);
        l.useLayoutEffect(() => {
        ...
        }, [ec, a, eg, ey, eS, eC, eN, tx]), l.useEffect(() => {
            ey && Z?.(eg, eN)
        ...
        let tN = l.useCallback(() => {
            ...
            tR = () => {
                null == tt.current || (tT(Math.max((e_.current ?? tt.current.currentTime) - 10, 0)), eN === o.Q6.ENDED && tx(o.Q6.PAUSED, o.KB.SEEK))
            },
            tw = () => {
        ...
        let tT = l.useCallback(function(e) {
                ...
                e_.current = e, ek(e / (tt.current.duration ?? 1) * 100), eU(!0), null != eG.current && clearTimeout(eG.current), eG.current = setTimeout(() => {
        ...
        return (0, r.jsx)(d.DUT, {
            ...
            children: (0, r.jsxs)("div", {
                ...
                children: [t$ && O?.({
                    ...
                    onCanPlayThrough: tM,
                    onSeeked: () => {
                        eQ.current = !1, e_.current = null, null != tt.current && eI(tt.current.currentTime / tt.current.duration * 100)
                    },
                    ...
                    children: [(0, r.jsx)(s.animated.div, {
                        ...
                        children: (0, r.jsx)(E.A, {
                            ...
                            handleFullScreenBtnClick: () => {
                                ...
                                e && null != t ? ((0, p.tl)(t), t.addEventListener(p.Wb, tN), _?.(!0), th(o.oA.LG)) : e || null == t || (t.removeEventListener(p.Wb, tN), _?.(!1), (0, p.sP)(t), th(o.oA.MD)), e5(e)
                            },
