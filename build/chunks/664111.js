...
let w = {
    ...
    L = l.forwardRef(function(e, t) {
        let {
            ...
            visibleChanged: eA,
            targetRef: eN
        } = (0, y.O7)(), [eR, ew] = l.useState(C ? o.Q6.PLAYING : o.Q6.PAUSED), [eT, eL] = l.useState(!1), [ej, eP] = l.useState(!1), [eD, eM] = l.useState(0), [ek, eI] = l.useState(null), eB = l.useCallback(e => {
            eI(null), eM(e)
        }, []), [eU, eG] = l.useState(!1), e$ = l.useRef(null), [eO, eQ] = l.useState(o.h$.LOADING), eF = l.useRef(!1), e_ = l.useRef(null), [eY, eK] = l.useState([]), [eX, ez] = l.useState(!1), eV = l.useRef(!1), [eW, eH] = l.useState(!1), eJ = l.useRef(!0), eZ = l.useRef(null), eq = l.useRef(null), e0 = l.useRef(0);
        l.useLayoutEffect(() => {
            e0.current = performance.now()
        }, []);
        let [e1, e6] = l.useState(K), [e2, e9] = l.useState(X), [e4, e7] = l.useState(!1), [e8, e3] = l.useState(!1), [e5, te] = l.useState(!1), tt = (0, u.bG)([f.A], () => f.A.useReducedMotion), tn = (0, l.useRef)(null), tr = (0, l.useRef)(null), tl = l.useRef(!0), [ta, ti] = l.useState(null), ts = l.useCallback((e, t) => {
            B?.(e, t)
        }, [B]), {
            isHlsActive: tu
        } = (0, x.Ay)(tn, {
            ...
            onError: ts,
            onHlsInstance: er
        }), [to, tc] = l.useState(null), [td, tm] = l.useState(0), tf = U ?? tn.current?.duration ?? 0, [th, tp] = l.useState(o.oA.MD), tx = {
            [o.oA.MD]: 56,
            [o.oA.LG]: 64
        };
        (0, m.u5)(() => {
        ...
        let tE = l.useCallback(function(e) {
            let t = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : null;
            if (ew(e), Q?.(e, t), null != tn.current) switch (e) {
                case o.Q6.PLAYING:
        ...
        }, [ec, a, ey, eS, eC, eA, eR, tE]), l.useEffect(() => {
            eS && Z?.(ey, eR)
        }, [ey, eS, eR, Z]), l.useEffect(() => {
            eA && q?.(eC, eR)
        }, [eC, eA, eR, q]);
        let [tb, tv] = l.useState(!1), tg = l.useRef(null), ty = l.useRef(0);
        l.useLayoutEffect(() => {
            ty.current = performance.now()
        }, []);
        let tS = l.useCallback(() => {
                null != tg.current && clearTimeout(tg.current), eR !== o.Q6.PLAYING || (tg.current = setTimeout(() => {
        ...
        let tR = l.useCallback(() => {
            ...
            tw = () => {
                null == tn.current || (tL(Math.max((e_.current ?? tn.current.currentTime) - 10, 0)), eR === o.Q6.ENDED && tE(o.Q6.PAUSED, o.KB.SEEK))
            },
            tT = () => {
        ...
        let tL = l.useCallback(function(e) {
                ...
                e_.current = e, eI(e / (tn.current.duration ?? 1) * 100), eG(!0), null != e$.current && clearTimeout(e$.current), e$.current = setTimeout(() => {
                    eG(!1), e$.current = null
                }, 100), eF.current = !0, tn.current.currentTime = e, t && ee?.(n, e)
            }, [ee]),
            tj = () => {
                if (null != tn.current) switch (eR) {
                    case o.Q6.ENDED:
        ...
        l.useEffect(() => {
            ...
            let e = tr.current;
            return e.addEventListener("load", tM), () => {
        ...
        let tk = e => {
                if (null != tn.current) {
                    ...
                    eQ(o.h$.READY), eR === o.Q6.PLAYING && (eV.current || tE(o.Q6.PLAYING, o.KB.BUFFERING_RECOVERY))
                }
            },
            [{
                controlBarAnimSpring: tI
            }, tB] = (0, d.zhh)(() => ({
                from: {
        ...
        l.useEffect(() => (t$({
            captionHeightSpring: e8 && null != to ? tU.current?.clientHeight ?? 0 : 0,
            immediate: tt
        }), () => {
            tG.stop()
        }), [e8, t$, tt, to, tG]), l.useEffect(() => (tB({
            controlBarAnimSpring: tA || eX ? 1 : 0,
            immediate: tt
        }), () => {
            tI.stop()
        }), [tA, tB, tt, eX, tI]);
        let tO = eR === o.Q6.ENDED && null != O,
            tQ = l.useCallback(function() {
        ...
        return (0, r.jsx)(d.DUT, {
            ...
            children: (0, r.jsxs)("div", {
                ...
                children: [tO && O?.({
                    ...
                    ref: e => {
                        tn.current = e, eN.current = e, "function" == typeof t ? t(e) : null != t && (t.current = e)
                    },
                    autoPlay: C,
                    playsInline: !0,
                    ...
                    onTimeUpdate: e => {
                        null != tn.current && (k?.(tn.current.currentTime, tn.current.duration), eF.current || eB(tn.current.currentTime / tn.current.duration * 100))
                    },
                    onEnded: e => {
                    ...
                    onLoadedMetadata: e => {
                        if (null == tn.current) return;
                        M > 0 && !tu && tL(M, !1), e2 ? tn.current.volume = 0 : tn.current.volume = e1;
                    ...
                    onCanPlayThrough: tk,
                    onSeeked: () => {
                        eF.current = !1, e_.current = null, null != tn.current && eB(tn.current.currentTime / tn.current.duration * 100)
                    },
                ...
                }), eO !== o.h$.READY && eR === o.Q6.PLAYING && null != ev && (0, r.jsx)("span", {
                    className: i()(R.S, {
                        [R.F]: "center" === ex
                    }),
                    ...
                    className: R.MU,
                    style: {
                        opacity: (0, s.to)([tI.to({
                            range: [0, 1],
                            output: [0, 1]
                        })], e => `${e}`),
                        visibility: (0, s.to)([tI.to({
                            range: [0, 1],
                            output: [0, 1]
                        })], e => e < .1 ? "hidden" : "visible"),
                        pointerEvents: (0, s.to)([tI.to({
                            range: [0, 1],
                            output: [0, 1]
                        })], e => e < .3 ? "none" : "auto")
                    },
                    ...
                    children: en({
                        playerState: eR,
                        isControlBarExpanded: tA
                    })
                }), e4 && eR !== o.Q6.ENDED && null != $ && (0, r.jsxs)(r.Fragment, {
                    children: [(0, r.jsx)(d.DUT, {
                        onClick: () => {
                            eR === o.Q6.PAUSED && tE(o.Q6.PLAYING, o.KB.USER), e7(!1)
                        },
                        tabIndex: -1,
                        ...
                        style: {
                            marginBottom: (0, s.to)([tI, tG], (e, t) => `${e*tx[th]+t}px`)
                        },
                ...
                }, eR), e8 && null != to && !tO && (0, r.jsx)(s.animated.div, {
                    className: R.o$,
                    ref: tU,
                    "data-testid": "discord-web-video-player-captions",
                    style: {
                        translateY: (0, s.to)([tI.to({
                            range: [0, 1],
                            output: [-20, -tx[th]]
                        })], e => `${e}px`)
                    },
                    ...
                    children: [(0, r.jsx)(s.animated.div, {
                        ...
                        children: (0, r.jsx)("div", {
                            ...
                            children: (0, r.jsx)(b.Ay, {
                                ...
                                onScrubForward: tT,
                                onDragStateChange: e => {
                                    ez(e), e ? (eV.current = eR === o.Q6.PLAYING, eV.current && tn.current?.pause()) : eV.current && (tn.current?.play(), eV.current = !1)
                                },
                                indicatorConfig: ep,
                        ...
                        style: {
                            paddingTop: (0, s.to)([tI.to({
                                range: [0, 1],
                                output: [0, 1]
                            })], e => `${e*e*20}px`),
                            paddingBottom: (0, s.to)([tI.to({
                                range: [0, 1],
                                output: [0, 1]
                            })], e => `${e*e*12}px`),
                            pointerEvents: (0, s.to)([tI.to({
                        ...
                        children: (0, r.jsx)(E.A, {
                            ...
                            handleFullScreenBtnClick: () => {
                                ...
                                e && null != t ? ((0, p.tl)(t), t.addEventListener(p.Wb, tR), F?.(!0), tp(o.oA.LG)) : e || null == t || (t.removeEventListener(p.Wb, tR), F?.(!1), (0, p.sP)(t), tp(o.oA.MD)), te(e)
                            },
...
let P = l.forwardRef(function(e, t) {
    let {
        ...
        objectFit: E
    } = s, [b, v] = l.useState(!1), g = l.useCallback(e => {
        null != a ? a(e) : v(!0)
    }, [a]), y = l.useRef(null);
    return n || b ? (0, r.jsx)(L, {
        ...s,
        onClick: a,
        autoplay: u || b,
        ref: t
