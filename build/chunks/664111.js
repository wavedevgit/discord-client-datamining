...
let w = {
    ...
    L = l.forwardRef(function(e, t) {
        let {
            ...
            visibleChanged: eS,
            targetRef: eC
        } = (0, y.O7)(), [eA, eN] = l.useState(C ? o.Q6.PLAYING : o.Q6.PAUSED), [eR, ew] = l.useState(!1), [eT, eL] = l.useState(!1), [ej, eP] = l.useState(0), [eD, eM] = l.useState(null), ek = l.useCallback(e => {
            eM(null), eP(e)
        }, []), [eI, eB] = l.useState(!1), eU = l.useRef(null), [eG, e$] = l.useState(o.h$.LOADING), eO = l.useRef(!1), eQ = l.useRef(null), [eF, e_] = l.useState([]), [eY, eK] = l.useState(!1), eX = l.useRef(!1), [ez, eW] = l.useState(!1), eV = l.useRef(!0), eH = l.useRef(null), eJ = l.useRef(null), eZ = l.useRef(0);
        l.useLayoutEffect(() => {
            eZ.current = performance.now()
        }, []);
        let [eq, e0] = l.useState(K), [e1, e6] = l.useState(X), [e2, e9] = l.useState(!1), [e4, e8] = l.useState(!1), [e7, e3] = l.useState(!1), e5 = (0, u.bG)([f.A], () => f.A.useReducedMotion), te = (0, l.useRef)(null), tt = (0, l.useRef)(null), tn = l.useRef(!0), [tr, tl] = l.useState(null), ta = l.useCallback((e, t) => {
            B?.(e, t)
        }, [B]), {
            isHlsActive: ti
        } = (0, x.Ay)(te, {
            ...
            onError: ta,
            onHlsInstance: er
        }), [ts, tu] = l.useState(null), [to, tc] = l.useState(0), td = U ?? te.current?.duration ?? 0, [tm, tf] = l.useState(o.oA.MD), th = {
            [o.oA.MD]: 50,
            [o.oA.LG]: 58
        };
        (0, m.u5)(() => {
        ...
        let tp = l.useCallback(function(e) {
            let t = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : null;
            if (eN(e), Q?.(e, t), null != te.current) switch (e) {
                case o.Q6.PLAYING:
        ...
        }, [ed, a, eg, ev, ey, eS, eA, tp]), l.useEffect(() => {
            ev && Z?.(eg, eA)
        }, [eg, ev, eA, Z]), l.useEffect(() => {
            eS && q?.(ey, eA)
        }, [ey, eS, eA, q]);
        let [tx, tE] = l.useState(!1), tb = l.useRef(null), tg = l.useRef(0);
        l.useLayoutEffect(() => {
            tg.current = performance.now()
        }, []);
        let tv = l.useCallback(() => {
                null != tb.current && clearTimeout(tb.current), eA !== o.Q6.PLAYING || (tb.current = setTimeout(() => {
        ...
        let tS = !tx && (eT || eR || eA === o.Q6.ENDED),
            tC = l.useCallback(() => {
                ...
                null == e || (0, p._U)(e) || (e.removeEventListener(p.Wb, tC), e3(!1), F?.(!1), tf(o.oA.MD))
            }, [F]),
            tA = () => {
                null == te.current || (tR(Math.max((eQ.current ?? te.current.currentTime) - 10, 0)), eA === o.Q6.ENDED && tp(o.Q6.PAUSED, o.KB.SEEK))
            },
            tN = () => {
                if (null == te.current) return;
                let e = Math.min((eQ.current ?? te.current.currentTime) + 10, td);
                tR(e), eA !== o.Q6.ENDED && e >= te.current.duration && tp(o.Q6.ENDED, o.KB.SEEK)
            };
        l.useEffect(() => {
            let e = te.current;
            return () => {
                let t = (0, p.qf)(e?.parentNode, e);
                null != t && t.removeEventListener(p.Wb, tC)
            }
        }, [tC]);
        let tR = l.useCallback(function(e) {
                let t = !(arguments.length > 1) || void 0 === arguments[1] || arguments[1];
                if (null == te.current) return;
                let n = te.current.currentTime;
                eQ.current = e, eM(e / (te.current.duration ?? 1) * 100), eB(!0), null != eU.current && clearTimeout(eU.current), eU.current = setTimeout(() => {
                    eB(!1), eU.current = null
                }, 100), eO.current = !0, te.current.currentTime = e, t && ee?.(n, e)
            }, [ee]),
            tw = () => {
                if (null != te.current) switch (eA) {
                    case o.Q6.ENDED:
                        tR(0), tp(o.Q6.PLAYING, o.KB.USER);
                        break;
                    case o.Q6.PLAYING:
            ...
            tj = l.useCallback(() => {
                ...
                if (e.mode = "hidden", null != e.cues)
                    for (let t = 0; t < e.cues.length; t++) {
                        let n = e.cues[t];
                        (0, v.C)(n) && (n.id = `cue-${t}`, n.onenter = () => tT(n), n.onexit = () => tL(n))
                    }
            }, []);
        l.useEffect(() => {
        ...
        l.useEffect(() => (tB({
            captionHeightSpring: e4 && null != ts ? tk.current?.clientHeight ?? 0 : 0,
            immediate: e5
        }), () => {
            tI.stop()
        }), [e4, tB, e5, ts, tI]), l.useEffect(() => (tM({
            controlBarAnimSpring: tS || eY ? 1 : 0,
            immediate: e5
        }), () => {
            tD.stop()
        }), [tS, tM, e5, eY, tD]);
        let tU = eA === o.Q6.ENDED && null != O,
            tG = l.useCallback(function() {
                let e = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : o.KB.USER;
                null != te.current && (tR(0), tp(o.Q6.PLAYING, e))
            }, [tR, tp]),
            t$ = l.useRef(null),
            tO = l.useCallback(e => {
                ty(), t$.current?.(e.nativeEvent)
            }, [ty]);
        return (0, r.jsx)(d.DUT, {
            ...
            children: (0, r.jsxs)("div", {
                ...
                children: [tU && O?.({
                    ...
                    ref: e => {
                        te.current = e, eC.current = e, "function" == typeof t ? t(e) : null != t && (t.current = e)
                    },
                    autoPlay: C,
                    playsInline: !0,
                    ...
                    onTimeUpdate: e => {
                        null != te.current && (k?.(te.current.currentTime, te.current.duration), eO.current || ek(te.current.currentTime / te.current.duration * 100))
                    },
                    onEnded: e => {
                    ...
                    onLoadedMetadata: e => {
                        if (null == te.current) return;
                        M > 0 && tR(M, !1), e1 ? te.current.volume = 0 : te.current.volume = eq;
                    ...
                    onCanPlayThrough: tP,
                    onSeeked: () => {
                        eO.current = !1, eQ.current = null, null != te.current && ek(te.current.currentTime / te.current.duration * 100)
                    },
                ...
                }), eG !== o.h$.READY && eA === o.Q6.PLAYING && null != eE && (0, r.jsx)("span", {
                    className: i()(R.S, {
                        [R.F]: "center" === ex
                    }),
                    ...
                    message: eb({
                        hasVideoAsset: null != eE,
                        playerState: eA,
                        pauseReason: tr
                    }),
                    showOverlay: null == eE
                }), null != et && (0, r.jsx)(s.animated.div, {
                    className: R.MU,
                    style: {
                    ...
                    children: en({
                        playerState: eA,
                        isControlBarExpanded: tS
                    })
                }), e2 && eA !== o.Q6.ENDED && null != $ && (0, r.jsxs)(r.Fragment, {
                    children: [(0, r.jsx)(d.DUT, {
                        ...
                        style: {
                            marginBottom: (0, s.to)([tD, tI], (e, t) => `${e*th[tm]+t}px`)
                        },
                    ...
                    className: i()(R.yf, {
                        [R.ZH]: eA === o.Q6.PLAYING,
                        [R.v7]: eA === o.Q6.PAUSED
                    }),
                    style: {
                        "--custom-play-pause-pop-ms": "1000ms"
                    },
                    children: eA === o.Q6.PLAYING ? (0, r.jsx)(d.udU, {
                        className: R.PK
                    }) : (0, r.jsx)(d.E$n, {
                        className: R.PK
                    })
                }, eA), e4 && null != ts && !tU && (0, r.jsx)(s.animated.div, {
                    className: R.o$,
                    ref: tk,
                    ...
                    children: [(0, r.jsx)(s.animated.div, {
                        ...
                        children: (0, r.jsx)("div", {
                            ...
                            children: (0, r.jsx)(b.Ay, {
                                ...
                                persistGrabber: ef,
                                onClick: e => {
                                    tR(e), eA === o.Q6.ENDED && tp(o.Q6.PLAYING, o.KB.USER)
                                },
                                onScrubBack: tA,
                                onScrubForward: tN,
                                onDragStateChange: e => {
                                    eK(e), e ? (eX.current = eA === o.Q6.PLAYING, eX.current && te.current?.pause()) : eX.current && (te.current?.play(), eX.current = !1)
                                },
                                indicatorConfig: ep,
                        ...
                        children: (0, r.jsx)(E.A, {
                            ...
                            handleFullScreenBtnClick: () => {
                                ...
                                e && null != t ? ((0, p.tl)(t), t.addEventListener(p.Wb, tC), F?.(!0), tf(o.oA.LG)) : e || null == t || (t.removeEventListener(p.Wb, tC), F?.(!1), (0, p.sP)(t), tf(o.oA.MD)), e3(e)
                            },
...
function j(e) {
    let {
        ...
        orientation: i
    } = e, [s, u] = l.useState(!1), o = l.useCallback(() => u(!0), []);
...
let P = l.forwardRef(function(e, t) {
    ...
    } = a, [x, E] = l.useState(!1), b = l.useCallback(() => {
        E(!0)
    }, []), g = l.useRef(null);
    return n || x ? (0, r.jsx)(L, {
        ...a,
        autoplay: s || x,
        ref: t
    }) : (0, r.jsx)(d.DUT, {
