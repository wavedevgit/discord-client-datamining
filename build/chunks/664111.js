...
let w = {
    ...
    L = l.forwardRef(function(e, t) {
        let {
            ...
            eI(null), eM(e)
        }, []), [eU, eG] = l.useState(!1), e$ = l.useRef(null), [eO, eQ] = l.useState(o.h$.LOADING), eF = l.useRef(!1), e_ = l.useRef(null), [eY, eK] = l.useState([]), [eX, ez] = l.useState(!1), eW = l.useRef(!1), [eV, eH] = l.useState(!1), eJ = l.useRef(!0), eZ = l.useRef(null), eq = l.useRef(null), e0 = l.useRef(0);
        l.useLayoutEffect(() => {
            e0.current = performance.now()
        }, []);
        let [e1, e6] = l.useState(K), [e2, e9] = l.useState(X), [e4, e8] = l.useState(!1), [e7, e3] = l.useState(!1), [e5, te] = l.useState(!1), tt = (0, u.bG)([f.A], () => f.A.useReducedMotion), tn = (0, l.useRef)(null), tr = (0, l.useRef)(null), tl = l.useRef(!0), [ta, ti] = l.useState(null), ts = l.useCallback((e, t) => {
            B?.(e, t)
        }, [B]), {
            isHlsActive: tu
        } = (0, x.Ay)(tn, {
        ...
        }, [em, a, ey, eS, eC, eA, eR, tE]), l.useEffect(() => {
            eS && Z?.(ey, eR)
        ...
        l.useEffect(() => (t$({
            captionHeightSpring: e7 && null != to ? tU.current?.clientHeight ?? 0 : 0,
            immediate: tt
        }), () => {
            tG.stop()
        }), [e7, t$, tt, to, tG]), l.useEffect(() => (tB({
        ...
        return (0, r.jsx)(d.DUT, {
            ...
            children: (0, r.jsxs)("div", {
                ...
                }, eR), e7 && null != to && !tO && (0, r.jsx)(s.animated.div, {
                    className: R.o$,
                    ref: tU,
                    ...
                    children: [(0, r.jsx)(s.animated.div, {
                        ...
                        children: (0, r.jsx)("div", {
                            ...
                            children: (0, r.jsx)(b.Ay, {
                                ...
                                onScrubForward: tT,
                                onDragStateChange: e => {
                                    ez(e), e ? (eW.current = eR === o.Q6.PLAYING, eW.current && tn.current?.pause()) : eW.current && (tn.current?.play(), eW.current = !1)
                                },
                                indicatorConfig: ex,
...
let P = l.forwardRef(function(e, t) {
    ...
    } = s, [E, b] = l.useState(!1), v = l.useCallback(e => {
        null != a ? a(e) : b(!0)
    }, [a]), g = l.useRef(null);
    return n || E ? (0, r.jsx)(L, {
        ...s,
        onClick: a,
        autoplay: u || E,
        ref: t
