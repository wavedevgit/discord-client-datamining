...
let w = {
    ...
    L = l.forwardRef(function(e, t) {
        let {
            ...
            visibleChanged: eC,
            targetRef: eA
        } = (0, y.O7)(), [eN, eR] = l.useState(C ? o.Q6.PLAYING : o.Q6.PAUSED), [ew, eT] = l.useState(!1), [eL, ej] = l.useState(!1), [eP, eD] = l.useState(0), [eM, ek] = l.useState(null), eI = l.useCallback(e => {
            ek(null), eD(e)
        }, []), [eB, eU] = l.useState(!1), eG = l.useRef(null), [e$, eO] = l.useState(o.h$.LOADING), eQ = l.useRef(!1), eF = l.useRef(null), [e_, eY] = l.useState([]), [eK, eX] = l.useState(!1), ez = l.useRef(!1), [eW, eV] = l.useState(!1), eH = l.useRef(!0), eJ = l.useRef(null), eZ = l.useRef(null), eq = l.useRef(0);
        l.useLayoutEffect(() => {
        ...
        let [e0, e1] = l.useState(K), [e6, e2] = l.useState(X), [e9, e4] = l.useState(!1), [e8, e7] = l.useState(!1), [e3, e5] = l.useState(!1), te = (0, u.bG)([f.A], () => f.A.useReducedMotion), tt = (0, l.useRef)(null), tn = (0, l.useRef)(null), tr = l.useRef(!0), [tl, ta] = l.useState(null), ti = l.useCallback((e, t) => {
            ...
            onError: ti,
            onHlsInstance: er
        }), [tu, to] = l.useState(null), [tc, td] = l.useState(0), tm = U ?? tt.current?.duration ?? 0, [tf, th] = l.useState(o.oA.MD), tp = {
            [o.oA.MD]: 50,
            [o.oA.LG]: 58
        };
        (0, m.u5)(() => {
        ...
        let tx = l.useCallback(function(e) {
            let t = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : null;
            if (eR(e), Q?.(e, t), null != tt.current) switch (e) {
                case o.Q6.PLAYING:
        ...
        }, [ed, a, eg, ey, eS, eC, eN, tx]), l.useEffect(() => {
            ey && Z?.(eg, eN)
        }, [eg, ey, eN, Z]), l.useEffect(() => {
            eC && q?.(eS, eN)
        }, [eS, eC, eN, q]);
        let [tE, tb] = l.useState(!1), tv = l.useRef(null), tg = l.useRef(0);
        l.useLayoutEffect(() => {
            tg.current = performance.now()
        }, []);
        let ty = l.useCallback(() => {
                null != tv.current && clearTimeout(tv.current), eN !== o.Q6.PLAYING || (tv.current = setTimeout(() => {
        ...
        let tN = l.useCallback(() => {
            ...
            tR = () => {
                null == tt.current || (tT(Math.max((eF.current ?? tt.current.currentTime) - 10, 0)), eN === o.Q6.ENDED && tx(o.Q6.PAUSED, o.KB.SEEK))
            },
            tw = () => {
                if (null == tt.current) return;
                let e = Math.min((eF.current ?? tt.current.currentTime) + 10, tm);
        ...
        let tT = l.useCallback(function(e) {
                let t = !(arguments.length > 1) || void 0 === arguments[1] || arguments[1];
                if (null == tt.current) return;
                let n = tt.current.currentTime;
                eF.current = e, ek(e / (tt.current.duration ?? 1) * 100), eU(!0), null != eG.current && clearTimeout(eG.current), eG.current = setTimeout(() => {
                    eU(!1), eG.current = null
                }, 100), eQ.current = !0, tt.current.currentTime = e, t && ee?.(n, e)
            }, [ee]),
            tL = () => {
                if (null != tt.current) switch (eN) {
                    case o.Q6.ENDED:
        ...
        l.useEffect(() => {
            ...
            let e = tn.current;
            return e.addEventListener("load", tD), () => {
        ...
        return (0, r.jsx)(d.DUT, {
            ...
            children: (0, r.jsxs)("div", {
                ...
                children: [t$ && O?.({
                    ...
                    ref: e => {
                        tt.current = e, eA.current = e, "function" == typeof t ? t(e) : null != t && (t.current = e)
                    },
                    autoPlay: C,
                    playsInline: !0,
                    ...
                    onTimeUpdate: e => {
                        null != tt.current && (k?.(tt.current.currentTime, tt.current.duration), eQ.current || eI(tt.current.currentTime / tt.current.duration * 100))
                    },
                    onEnded: e => {
                    ...
                    onLoadedMetadata: e => {
                        if (null == tt.current) return;
                        M > 0 && tT(M, !1), e6 ? tt.current.volume = 0 : tt.current.volume = e0;
                    ...
                    onCanPlayThrough: tM,
                    onSeeked: () => {
                        eQ.current = !1, eF.current = null, null != tt.current && eI(tt.current.currentTime / tt.current.duration * 100)
                    },
                ...
                }), e$ !== o.h$.READY && eN === o.Q6.PLAYING && null != eb && (0, r.jsx)("span", {
                    className: i()(R.S, {
                        [R.F]: "center" === ex
                    }),
                    ...
                    className: R.MU,
                    style: {
                        opacity: (0, s.to)([tk.to({
                            range: [0, 1],
                            output: [0, 1]
                        })], e => `${e}`),
                        visibility: (0, s.to)([tk.to({
                            range: [0, 1],
                            output: [0, 1]
                        })], e => e < .1 ? "hidden" : "visible"),
                        pointerEvents: (0, s.to)([tk.to({
                            range: [0, 1],
                            output: [0, 1]
                        })], e => e < .3 ? "none" : "auto")
                    },
                ...
                }), e9 && eN !== o.Q6.ENDED && null != $ && (0, r.jsxs)(r.Fragment, {
                    children: [(0, r.jsx)(d.DUT, {
                        ...
                        style: {
                            marginBottom: (0, s.to)([tk, tU], (e, t) => `${e*tp[tf]+t}px`)
                        },
                    ...
                    className: i()(R.yf, {
                        [R.ZH]: eN === o.Q6.PLAYING,
                        [R.v7]: eN === o.Q6.PAUSED
                    }),
                    style: {
                        "--custom-play-pause-pop-ms": "1000ms"
                    },
                    children: eN === o.Q6.PLAYING ? (0, r.jsx)(d.udU, {
                        className: R.PK
                    }) : (0, r.jsx)(d.E$n, {
                        className: R.PK
                    })
                    ...
                    children: [(0, r.jsx)(s.animated.div, {
                        ...
                        children: (0, r.jsx)("div", {
                            ...
                            children: (0, r.jsx)(b.Ay, {
                                ...
                                onScrubForward: tw,
                                onDragStateChange: e => {
                                    eX(e), e ? (ez.current = eN === o.Q6.PLAYING, ez.current && tt.current?.pause()) : ez.current && (tt.current?.play(), ez.current = !1)
                                },
                                indicatorConfig: ep,
                        ...
                        style: {
                            paddingTop: (0, s.to)([tk.to({
                                range: [0, 1],
                                output: [0, 1]
                            })], e => `${e*e*12}px`),
                            paddingBottom: (0, s.to)([tk.to({
                                range: [0, 1],
                                output: [0, 1]
                            })], e => `${e*e*12}px`),
                            pointerEvents: (0, s.to)([tk.to({
                        ...
                        children: (0, r.jsx)(E.A, {
                            ...
                            handleFullScreenBtnClick: () => {
                                ...
                                e && null != t ? ((0, p.tl)(t), t.addEventListener(p.Wb, tN), F?.(!0), th(o.oA.LG)) : e || null == t || (t.removeEventListener(p.Wb, tN), F?.(!1), (0, p.sP)(t), th(o.oA.MD)), e5(e)
                            },
