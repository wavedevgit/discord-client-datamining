...
let w = {
    ...
    P = l.forwardRef(function(e, t) {
        let {
            ...
            visibleChanged: eS,
            targetRef: eN
        } = (0, y.O7)(), [eR, eL] = l.useState(a ? o.Q6.PLAYING : o.Q6.PAUSED), [ew, eT] = l.useState(!1), [eP, eD] = l.useState(!1), [eM, ej] = l.useState(0), [ek, eI] = l.useState(null), eB = l.useCallback(e => {
            eI(null), ej(e)
        }, []), [eU, eF] = l.useState(!1), eG = l.useRef(null), [eQ, eO] = l.useState(o.h$.LOADING), e$ = l.useRef(!1), e_ = l.useRef(null), [eK, eY] = l.useState([]), [eX, ez] = l.useState(!1), eV = l.useRef(!1), eW = l.useRef(!1), eH = l.useRef(!1), eZ = l.useRef(!1), [eJ, eq] = l.useState(!0), e0 = l.useRef(!0), e1 = l.useRef(null), e6 = l.useRef(null), [e2, e9] = l.useState(_), [e4, e8] = l.useState(K), [e7, e3] = l.useState(!1), [e5, te] = l.useState(!1), [tt, tn] = l.useState(!1), tr = (0, u.bG)([f.A], () => f.A.useReducedMotion), tl = (0, l.useRef)(null), ta = (0, l.useRef)(null), ti = (0, l.useRef)(null), ts = l.useRef(!0), [tu, to] = l.useState(null), tc = l.useCallback(() => tl.current?.currentTime ?? null, []);
        (0, C.A)({
            videoRef: tl,
            canvasRef: ta,
            enabled: ex && !tr,
        ...
        let tC = l.useCallback(function(e) {
            let t = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : null;
            if (eZ.current = !0, eL(e), G?.(e, t), null != tl.current) switch (e) {
                case o.Q6.PLAYING:
        ...
        }, [eo, n, ey, eA, eC, eS, eR, tC]), l.useEffect(() => {
            eA && H?.(ey, eR)
        }, [ey, eA, eR, H]), l.useEffect(() => {
            eS && Z?.(eC, eR)
        }, [eC, eS, eR, Z]);
        let [tS, tN] = l.useState(!1), tR = l.useRef(null), tL = l.useRef(0);
        l.useLayoutEffect(() => {
            tL.current = performance.now()
        }, []);
        let tw = l.useCallback(() => {
                null != tR.current && clearTimeout(tR.current), eR !== o.Q6.PLAYING || (tR.current = setTimeout(() => {
        ...
        let tM = l.useCallback(() => {
            ...
            tj = () => {
                null == tl.current || (tI(Math.max((e_.current ?? tl.current.currentTime) - 10, 0)), eR === o.Q6.ENDED && tC(o.Q6.PAUSED, o.KB.SEEK))
            },
            tk = () => {
        ...
        let tI = l.useCallback(function(e) {
                let t = !(arguments.length > 1) || void 0 === arguments[1] || arguments[1];
                if (null == tl.current) return;
                let n = tl.current.currentTime;
                e_.current = e, eI(e / (tl.current.duration ?? 1) * 100), eF(!0), null != eG.current && clearTimeout(eG.current), eG.current = setTimeout(() => {
                    eF(!1), eG.current = null
                }, 100), e$.current = !0, tl.current.currentTime = e, t && J?.(n, e)
            }, [J]),
            tB = () => {
                if (null != tl.current) switch (eR) {
                    case o.Q6.ENDED:
        ...
        l.useEffect(() => (tY({
            captionHeightSpring: e5 && null != tf ? t_.current?.clientHeight ?? 0 : 0,
            immediate: tr
        }), () => {
            tK.stop()
        }), [e5, tY, tr, tf, tK]), l.useEffect(() => (t$({
            controlBarAnimSpring: tP || eX ? 1 : 0,
            immediate: tr
        }), () => {
            tO.stop()
        }), [tP, t$, tr, eX, tO]);
        let tX = eR === o.Q6.ENDED && null != F,
            tz = l.useCallback(function() {
        ...
        return (0, r.jsx)(d.DUT, {
            ...
            children: (0, r.jsxs)("div", {
                ...
                children: [ex && !tr && (0, r.jsx)("canvas", {
                    ...
                    ref: e => {
                        tl.current = e, eN.current = e, "function" == typeof t ? t(e) : null != t && (t.current = e)
                    },
                    autoPlay: a,
                    playsInline: !0,
                    ...
                    onTimeUpdate: e => {
                        null != tl.current && (M?.(tl.current.currentTime, tl.current.duration), e$.current || eB(tl.current.currentTime / tl.current.duration * 100))
                    },
                    onEnded: e => {
                    ...
                    onProgress: e => {
                        ...
                        for (let e = 0; e < tl.current.buffered.length; e++) {
                            ...
                            r - n < 1 || t.push({
                                start: n / tl.current.duration,
                                size: (r - n) / tl.current.duration
                            })
                        }
                        eY(t)
                    },
                    ...
                    onCanPlayThrough: tQ,
                    onSeeked: () => {
                        e$.current = !1, e_.current = null, null != tl.current && eB(tl.current.currentTime / tl.current.duration * 100)
                    },
                ...
                }), eQ !== o.h$.READY && eR === o.Q6.PLAYING && null != eb && (0, r.jsx)("span", {
                    className: i()(L.S, {
                        [L.F]: "center" === ep
                    }),
                    "data-testid": "discord-web-video-player-loading-spinner",
                    children: (0, r.jsx)(d.y$y, {
                        type: d.y$y.Type.WANDERING_CUBES
                    })
                }), (0, r.jsx)(A.A, {
                    message: eg({
                        hasVideoAsset: null != eb,
                        playerState: eR,
                        pauseReason: tu
                    }),
                    showOverlay: null == eb
                }), null != q && (0, r.jsx)(s.animated.div, {
                    className: L.MU,
                    style: {
                        opacity: (0, s.to)([tO.to({
                            range: [0, 1],
                            output: [0, 1]
                        })], e => `${e}`),
                        visibility: (0, s.to)([tO.to({
                            range: [0, 1],
                            output: [0, 1]
                        })], e => e < .1 ? "hidden" : "visible"),
                        pointerEvents: (0, s.to)([tO.to({
                            range: [0, 1],
                            output: [0, 1]
                        })], e => e < .3 ? "none" : "auto")
                    },
                    ...
                    children: ee({
                        playerState: eR,
                        isControlBarExpanded: tP
                    })
                }), e7 && eR !== o.Q6.ENDED && null != U && (0, r.jsxs)(r.Fragment, {
                    children: [(0, r.jsx)(d.DUT, {
                        ...
                        style: {
                            marginBottom: (0, s.to)([tO, tK], (e, t) => `${e*tA[tg]+t}px`)
                        },
                    ...
                    children: eR === o.Q6.PLAYING ? (0, r.jsx)(d.udU, {
                        className: L.PK
                    }) : (0, r.jsx)(d.E$n, {
                        className: L.PK
                    })
                }, eR), e5 && null != tf && !tX && (0, r.jsx)(s.animated.div, {
                    className: L.o$,
                    ref: t_,
                    "data-testid": "discord-web-video-player-captions",
                    style: {
                        translateY: (0, s.to)([tO.to({
                            range: [0, 1],
                            output: [-20, -tA[tg]]
                        })], e => `${e}px`)
                    },
                    ...
                    children: [(0, r.jsx)(s.animated.div, {
                        ...
                        children: (0, r.jsx)("div", {
                            ...
                            children: (0, r.jsx)(v.Ay, {
                                ...
                                animate: !0 !== ts.current && !eU && eR === o.Q6.PLAYING && tx && eQ === o.h$.READY,
                                ...
                                onScrubForward: tk,
                                onDragStateChange: e => {
                                    if (eW.current = e, ez(e), e) eV.current = eR === o.Q6.PLAYING, eH.current = eR === o.Q6.ENDED, eV.current ? tl.current?.pause() : eH.current && tC(o.Q6.PAUSED, o.KB.SEEK);
                                    else {
                                        let e = tl.current,
                                            t = null != e && !Number.isNaN(e.duration) && e.currentTime >= e.duration;
                                        eV.current ? (eV.current = !1, t ? tC(o.Q6.ENDED, o.KB.PLAYBACK_COMPLETE) : e?.play()) : eH.current ? (eH.current = !1, t ? tC(o.Q6.ENDED, o.KB.PLAYBACK_COMPLETE) : tC(o.Q6.PLAYING, o.KB.USER)) : t && tC(o.Q6.ENDED, o.KB.PLAYBACK_COMPLETE)
                                    }
                                },
                                indicatorConfig: eh,
                        ...
                        style: {
                            paddingTop: (0, s.to)([tO.to({
                                range: [0, 1],
                                output: [0, 1]
                            })], e => `${e*e*20}px`),
                            paddingBottom: (0, s.to)([tO.to({
                                range: [0, 1],
                                output: [0, 1]
                            })], e => `${e*e*12}px`),
                            pointerEvents: (0, s.to)([tO.to({
                        ...
                        children: (0, r.jsx)(x.A, {
                            ...
                            handleFullScreenBtnClick: () => {
                                ...
                                e && null != t ? ((0, p.tl)(t), t.addEventListener(p.Wb, tM), Q?.(!0), ty(o.oA.LG)) : e || null == t || (t.removeEventListener(p.Wb, tM), Q?.(!1), (0, p.sP)(t), ty(o.oA.MD)), tn(e)
                            },
...
function D(e) {
    let {
        ...
        orientation: i,
        objectFit: s = "contain"
    } = e, [u, o] = l.useState(!1), d = l.useCallback(() => o(!0), []);
    return null == t ? null : (0, r.jsx)(c.y, {
...
let M = l.forwardRef(function(e, t) {
    let {
        ...
        objectFit: x
    } = s, [v, b] = l.useState(!1), g = l.useCallback(e => {
        null != a ? a(e) : b(!0)
    }, [a]), y = l.useRef(null);
    return n || v ? (0, r.jsx)(P, {
        ...s,
        onClick: a,
        autoplay: u || v,
        ref: t
        ...
        children: (0, r.jsxs)("div", {
            ...
            children: [(0, r.jsx)(D, {
                ...
                className: L.MU,
                children: E({
                    playerState: o.Q6.PAUSED,
                    isControlBarExpanded: !0
                })
            }), (0, r.jsx)("div", {
                className: L.mF,
                ref: y,
                children: (0, r.jsx)(d.udU, {
                    size: "xs",
                    color: "currentColor",
                    className: L.z_
                })
