...
function ea(e, t) {
    ...
    let f = null;
    return null != a.holdoutName && null != a.holdoutControlBucket && a.holdoutName !== t && (null == (f = ea(e, a.holdoutName)) ? void 0 : f.bucket) != null && (!0 !== f.override && Q({
...
function eo(e) {
    ...
    if (!U && Y(n) && (U = !0), C = t.hasLoadedExperiments, N = t.trackedExposureExperiments, D = t.loadedUserExperiments, j = t.userExperimentOverrides, M = t.guildExperimentOverrides, P = b(E({}, P), {
...
function ep() {
    ...
    for (let e of r)
        for (let t in e) {
            let n = e[t];
            null == n || n.type !== h.Vh.USER && n.type !== h.Vh.GUILD || null == n.bucket || !0 !== n.override || n.fromCookie ? (delete e[t], a = !0) : n.type === h.Vh.USER ? j[t] = n : M[t] = n
        }(a = ef() || a) && e_()
}
...
function eg(e) {
    ...
    let {
        ...
        experimentType: i,
        skipCleanup: a
    } = e, s = null != i ? i : null == (t = R[n]) ? void 0 : t.type;
    if (null == s) return !1;
...
class ey extends f.A {
    ...
    loadCache() {
        ...
        null != e && ("loadedUserExperiments" in e ? (D = e.loadedUserExperiments, x = es(e.loadedGuildExperiments), Object.values(D).forEach(e => e.loadedFromCache = !0), Object.values(x).forEach(e => e.loadedFromCache = !0)) : en(e, !0))
    }
    takeSnapshot() {
        return {
