...
function J(t) {
    return H.intl.format(H.t.IeaYqg, {
        endDate: t
    })
}
...
function Z(t) {
    ...
    return "reverseTrial" === e.type ? (0, i.jsx)($, {
        text: e.text,
        className: q.jk
    }) : (0, i.jsx)(w.wP, {
        proratedInvoice: e.proratedInvoicePreview,
        renewalInvoice: e.renewalInvoicePreview
    })
}
...
function z(t) {
    ...
    if (0 !== l && m.push({
            ...
            label: H.intl.formatToPlainString(H.t.ZSVged, {
                planName: (0, k.RH)(a[0].subscriptionPlanId)
            }),
            ...
            id: "tax",
            label: H.intl.string(H.t.jiRvC7),
            amount: u.tax,
            lineItemType: "tax"
        }), o) {
        let {
    ...
    return (0, i.jsxs)(U.Yx, {
        children: [(0, i.jsx)(U.Xd, {
            children: H.intl.string(H.t.CWIwms)
        }), (0, i.jsx)(U.f0, {
            ...d
        }), m.map(t => (0, i.jsx)(U.oR, {
            label: (0, i.jsx)(w.sw, {
                label: t.label,
                tooltipText: t.tooltip ?? void 0
            }),
            value: (0, B.$g)(t.amount, u.currency)
        }, t.id)), (0, i.jsx)(U.pK, {}), (0, i.jsx)(U.Sd, {
    ...
    let tx = (0, i.jsx)(Q, {
        ...
        tf = function(t) {
            let {
                ...
                isPrepaid: o,
                isReverseTrial: c
            } = s, d = n.interval, p = n.intervalCount, x = t => (0, _.Z)(i.invoiceItems).find(e => Y.pW.has(e.subscriptionPlanId) && t(e)), I = x(t => t.amount >= 0);
        ...
        tS = (0, i.jsx)(z, {
            ...tf,
            shouldUseUnifiedCheckoutUI: $,
            subscriptionInvoiceDetailsContent: tx
        }),
        tg = function(t) {
            let {
                isPrepaid: e,
