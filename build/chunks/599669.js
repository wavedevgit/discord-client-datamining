...
function G(e) {
    return U.intl.format(U.t.IeaYqg, {
        endDate: e
    })
}
...
function W(e) {
    ...
    0 !== t && o.push({
        ...
        label: U.intl.formatToPlainString(U.t.ZSVged, {
            planName: (0, M.RH)(l[0].subscriptionPlanId)
        }),
        ...
        id: "tax",
        label: U.intl.string(U.t.jiRvC7),
        amount: s.tax,
        lineItemType: "tax"
    });
    let {
    ...
    return (0, i.jsx)(S.Vm, {
        defaultExpanded: !0,
        label: U.intl.string(k.default.eoXh7B),
        lineItems: d,
        currency: u
    })
}
    ...
    let el = (0, i.jsx)(F, {
        ...
        eo = function(e) {
            let {
                ...
                isPrepaid: u,
                isReverseTrial: d
            } = a, p = t.interval, m = t.intervalCount, _ = e => (0, A.Z)(i.invoiceItems).find(n => R.pW.has(n.subscriptionPlanId) && e(n)), f = _(e => e.amount >= 0);
