...
function q(e) {
    return V.intl.format(V.t.IeaYqg, {
        endDate: e
    })
}
...
function $(e) {
    ...
    return "reverseTrial" === n.type ? (0, i.jsx)(J, {
        text: n.text,
        className: K.jk
    }) : (0, i.jsx)(D.wP, {
        proratedInvoice: n.proratedInvoicePreview,
        renewalInvoice: n.renewalInvoicePreview
    })
}
...
function Q(e) {
    ...
    if (0 !== r && p.push({
            ...
            label: V.intl.formatToPlainString(V.t.ZSVged, {
                planName: (0, G.RH)(s[0].subscriptionPlanId)
            }),
            ...
            id: "tax",
            label: V.intl.string(V.t.jiRvC7),
            amount: o.tax,
            lineItemType: "tax"
        }), c) {
        let {
    ...
    return (0, i.jsxs)(L.Yx, {
        children: [(0, i.jsx)(L.Xd, {
            children: V.intl.string(V.t.CWIwms)
        }), (0, i.jsx)(L.f0, {
            ...d
        }), p.map(e => (0, i.jsx)(L.oR, {
            label: (0, i.jsx)(D.sw, {
                label: e.label,
                tooltipText: e.tooltip ?? void 0
            }),
            value: (0, B.$g)(e.amount, o.currency)
        }, e.id)), (0, i.jsx)(L.pK, {}), (0, i.jsx)(L.Sd, {
    ...
    let e_ = (0, i.jsx)(X, {
        ...
        eS = function(e) {
            let {
                ...
                isPrepaid: c,
                isReverseTrial: u
            } = a, d = t.interval, m = t.intervalCount, _ = e => (0, T.Z)(i.invoiceItems).find(n => F.pW.has(n.subscriptionPlanId) && e(n)), x = _(e => e.amount >= 0);
        ...
        eg = (0, i.jsx)(Q, {
            ...eS,
            shouldUseUnifiedCheckoutUI: J,
            subscriptionInvoiceDetailsContent: e_
        }),
        eb = function(e) {
            let {
                isPrepaid: n,
