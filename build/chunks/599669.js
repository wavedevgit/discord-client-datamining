...
function Y(n) {
    let e = (0, c.bG)([N.A], () => null != n.premiumSubscriptionPaymentSourceId ? N.A.getPaymentSource(n.premiumSubscriptionPaymentSourceId) : null);
    return {
        ...n,
        premiumSubscriptionPaymentSource: e
    }
}
...
function W(n) {
    ...
    return null != l ? null != r ? (0, i.jsx)(u.m, {
        asContainer: !0,
...
function B(n) {
    ...
    return (0, i.jsxs)("div", {
        ...
        children: [(0, i.jsx)("div", {
            ...
            className: k.b7,
            children: O.intl.format(O.t.IeaYqg, {
                endDate: e
            })
        }), (0, i.jsx)("div", {
            className: k.bU
...
function J(n) {
    ...
    return e ? null : t && null != s ? (0, i.jsx)(B, {
...
function K(n, e) {
    let {
        ...
        let {
            ...
            priceOptions: r
        } = n, a = t.interval, u = t.intervalCount, o = (0, c.bG)([C.A], () => C.A.getForSkuAndInterval((0, R.mH)(D.pe.GUILD), a, u)), d = (0, c.bG)([U.A], () => U.A.inReverseTrial());
        if (s()(null != o, "Missing guildBoostingSubscriptionPlan"), null == i || null == l) return {
            isLoading: !0
        };
    ...
    if (null != r && null != a && (E = null != t ? (0, i.jsx)(T.m0, {
            premiumSubscription: t,
            proratedInvoice: r,
            renewalInvoice: a,
            isUpdate: !0,
        ...
        legacyCheckoutContent: (0, i.jsxs)(i.Fragment, {
            children: [(0, i.jsx)(J, {
                ...
                ...m,
                initialLineItemComponent: (0, i.jsx)(v.f0, {
                    ...b
                }),
    ...
    };
    {
        ...
        return null != r && (0 !== g && n.push({
            id: "base-plan-adjustment",
            label: O.intl.formatToPlainString(O.t.ZSVged, {
                planName: (0, R.RH)(x[0].subscriptionPlanId)
            }),
            ...
            unifiedInvoiceSummaryContent: (0, i.jsx)(S.ID, {
                lineItems: n,
                ...e
            })
        }
...
function q(n) {
    ...
    return (0, i.jsxs)(v.Yx, {
        children: [(0, i.jsx)(v.Xd, {
            children: O.intl.string(O.t.CWIwms)
        }), c, 0 !== t ? (0, i.jsx)(v.oR, {
            label: (0, i.jsx)(T.sw, {
                label: O.intl.formatToPlainString(O.t.ZSVged, {
        ...
        }) : null, 0 !== r ? (0, i.jsx)(v.oR, {
            label: (0, i.jsx)(T.sw, {
                label: O.intl.string(O.t["+as5ZZ"]),
                tooltipText: O.intl.string(O.t.JmwQJM)
            }),
            value: (0, _.$g)(r, a.currency)
        }) : null, (0, i.jsx)(v.pK, {}), (0, i.jsx)(v.Sd, {
