/** chunk id: 184119, original params: A,e,t (module,exports,require) **/
t.d(e, {
    A: () => p
});
var n = t(627968),
...
function p(A) {
    let {
        ...
        disabled: C = !1
    } = A, v = r === g, [U, V] = a.useState(v ? t : null), [x, b] = a.useState(null), j = a.useRef(null), K = a.useRef(null);
    a.useEffect(() => {
        p !== g && (V(null), b(null))
    }, [p]);
    let N = null != x ? u.intl.formatToPlainString(u.t["Kw+5YX"], {
            filename: x
