...
function U(e) {
    ...
    } = e, u = (0, _.Ay)(t), h = (0, a.bG)([y.A], () => y.A.getStageInstanceByChannel(t.id)), A = (0, b.uy)(t.id), m = (0, b.zy)(t.id, S.ip.AUDIENCE), p = (0, a.bG)([E.A], () => E.A.getGuild(t.guild_id), [t.guild_id]), C = p?.maxStageVideoChannelUsers ?? 0, T = null != p && p.features.has(O.GuildFeatures.COMMUNITY) ? C < O.p2C : p?.premiumTier !== O.TVA.TIER_3 && C <= O.nyz, j = (0, R.A)(t), U = (0, a.bG)([I.A], () => I.A.can(v.QY, t)), k = () => {
