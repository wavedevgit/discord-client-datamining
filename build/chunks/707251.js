...
function U(e) {
    ...
    } = (0, h.Ay)(u.A.VOICE_CHANNEL_HEADER), d = (0, r.bG)([A.A], () => A.A.getChatOpen(t.id), [t.id]), m = (0, b.Ni)(t.id), p = (0, T.zy)(t.id, S.ip.REQUESTED_TO_SPEAK_ONLY);
