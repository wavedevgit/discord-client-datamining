...
function G(e) {
    ...
    } = (0, h.Ay)(u.A.VOICE_CHANNEL_HEADER), c = (0, a.bG)([A.A], () => A.A.getChatOpen(t.id), [t.id]), p = (0, T.Ni)(t.id), _ = (0, S.zy)(t.id, b.ip.REQUESTED_TO_SPEAK_ONLY);
