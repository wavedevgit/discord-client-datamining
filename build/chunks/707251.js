...
function G(e) {
    ...
    } = (0, h.Ay)(u.A.VOICE_CHANNEL_HEADER), c = (0, r.bG)([A.A], () => A.A.getChatOpen(t.id), [t.id]), g = (0, T.Ni)(t.id), _ = (0, b.zy)(t.id, S.ip.REQUESTED_TO_SPEAK_ONLY);
    return (0, i.jsxs)(h.f5, {
        value: l,
        children: [(0, i.jsx)(p.A, {
            channelId: t.id
        }, "clips-enabled-indicator"), !s && g ? (0, i.jsx)("div", {
            className: a()(D.x6, {
                [D.vc]: c
            }),
