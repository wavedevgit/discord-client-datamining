/** chunk id: 142922, original params: e,a,t (module,exports,require) **/
t.d(a, {
    FG: () => d,
    LA: () => o,
    U_: () => l,
...
function i(e, a, t, r) {
    let n = (a = o(e, a)) - 1,
        i = -2;
    return t <= 2 ? i = 0 : l(a) && (i = -1), 1721425 + 365 * n + Math.floor(n / 4) - Math.floor(n / 100) + Math.floor(n / 400) + Math.floor((367 * t - 362) / 12 + i + r)
}
...
class d {
    fromJulianDay(e) {
        let a = e - 1721426,
            ...
            D = e - i(h, y, 1, 1),
            p = 2;
        e < i(h, y, 3, 1) ? p = 0 : l(y) && (p = 1);
        let g = Math.floor(((D + p) * 12 + 373) / 367),
            v = e - i(h, y, g, 1) + 1;
        return new(0, r.ng)(h, y, g, v)
    }
    toJulianDay(e) {
