...
let P = () => (0, n.jsx)("div", {
    ...
    D = e => {
        ...
        } = (0, b.A)(), [_, m] = l.useState(!1), C = (0, h.uM)(), O = C?.sessionId ?? "";
        l.useEffect(() => {
            (0, x.z)({
                sessionId: O,
        ...
        }, [P, R, D.length, u, d, O, c]), null != P) ? (0, n.jsx)(E.h, {
            onRetry: H,
            errorOrigin: E.A.SHOP_PAGE,
            errorMessage: P.message
        }) : R || 0 === D.length ? (0, n.jsxs)("div", {
            ...
            children: D.map((e, l) => ((e, l, d) => {
                ...
                switch (e.type) {
                    ...
                    case i.g.WIDE_BANNER:
                        if (e.isDismissible) {
                            let t = e.dismissibleContentVersion ?? 0,
                                {
                                    isDismissed: s
                                } = (0, g.En)(o.M.COLLECTIBLES_SHOP_WIDE_BANNER, t);
                            if (s) return null
                        }
                        u = (0, n.jsx)(N.A, {
                            wideBannerBlock: e,
                    ...
                    case i.g.MARVEL_RIVALS_PROMOTIONAL_BANNER: {
                        let {
                            isDismissed: t
                        } = (0, g.En)(o.M.COLLECTIBLES_SHOP_MARVEL_RIVALS_ORBS_REWARD);
                        if (t) return null;
                        return (0, n.jsx)(p.rW, {
                            blockType: e.type,
    ...
    w = e => {
        let {
            ...
            handleScroll: i
        } = (0, d.X)(a, s), o = (0, C.U)(), _ = (0, u.f)("Shop Home"), g = (0, h.uM)(), [p, f] = l.useState(y.md), [x, E] = l.useState(!1);
        return l.useEffect(() => {
            if (null != a.current) {
                let e = () => {
            ...
            children: (0, n.jsxs)("div", {
                ...
                children: [(0, n.jsxs)("div", {
                    className: M.rb,
                    children: [_ ? (0, n.jsx)(P, {}) : (0, n.jsx)(D, {
                        handleTransition: t,
                        numVisibleItems: p,
                        isFetchingCategories: o,
                        tab: s
                    }), s !== y.G2.CATALOG && p >= 36 && (0, n.jsxs)("div", {
                        className: M.R$,
