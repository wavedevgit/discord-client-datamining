/** chunk id: 231209, original params: e,t,s (module,exports,require) **/
"use strict";
s.d(t, {
    A: () => U
});
...
let w = () => {
        let e = (0, o.bG)([x.A], () => x.A.getShopLayoutUrlOverride()),
            [t, s] = l.useState(null);
        return l.useEffect(() => {
            null != e && "" !== e && fetch(e).then(e => e.json()).then(e => s(e)).catch(() => s(null))
        }, [e]), (0, n.jsx)("div", {
            className: a()(D.YB, D.GS),
            children: null != e && "" !== e && null != t ? (0, n.jsx)(g.Ay, {
                layout: t
            }) : (0, n.jsx)(g.Qs, {
                tenantId: M.FYj,
                layoutId: "1465939725649973269"
            })
        })
    },
    H = e => {
        ...
        } = (0, S.A)(), [_, g] = l.useState(!1), h = (0, p.uM)(), x = h?.sessionId ?? "";
        l.useEffect(() => {
            (0, C.z)({
                sessionId: x,
        ...
        }, [y, A, M.length, u, d, x, o]), null != y) ? (0, n.jsx)(b.h, {
            onRetry: H,
            errorOrigin: b.A.SHOP_PAGE,
            errorMessage: y.message
        }) : A || 0 === M.length ? (0, n.jsxs)("div", {
            ...
            children: M.map((e, l) => ((e, l, d) => {
                ...
                switch (e.type) {
                    ...
                    case i.g.WIDE_BANNER:
                        if (e.isDismissible) {
                            let t = e.dismissibleContentVersion ?? 0,
                                {
                                    isDismissed: s
                                } = (0, m.En)(c.M.COLLECTIBLES_SHOP_WIDE_BANNER, t);
                            if (s) return null
                        }
                        u = (0, n.jsx)(R.A, {
                            wideBannerBlock: e,
                    ...
                    case i.g.MARVEL_RIVALS_PROMOTIONAL_BANNER: {
                        let {
                            isDismissed: t
                        } = (0, m.En)(c.M.COLLECTIBLES_SHOP_MARVEL_RIVALS_ORBS_REWARD);
                        if (t) return null;
                        return (0, n.jsx)(f.rW, {
                            blockType: e.type,
    ...
    U = e => {
        let {
            ...
            handleScroll: i
        } = (0, u.X)(a, s), o = (0, A.U)(), c = (0, _.f)("Shop Home"), g = (0, p.uM)(), [m, f] = l.useState(B.md), [x, E] = l.useState(!1);
        return l.useEffect(() => {
            if (null != a.current) {
                let e = () => {
            ...
            children: (0, n.jsxs)("div", {
                ...
                children: [(0, n.jsxs)("div", {
                    className: D.rb,
                    children: [c ? (0, n.jsx)(w, {}) : (0, n.jsx)(H, {
                        handleTransition: t,
                        numVisibleItems: m,
                        isFetchingCategories: o,
                        tab: s
                    }), s !== B.G2.CATALOG && m >= 36 && (0, n.jsxs)("div", {
                        className: D.R$,
