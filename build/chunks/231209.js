...
let B = e => {
        ...
        } = (0, E.A)(), [x, k] = l.useState(!1), N = (0, _.uM)(), B = N?.sessionId ?? "";
        l.useEffect(() => {
            (0, p.z)({
                sessionId: B,
        ...
        }, [P, M, D.length, g, d, B, c]), null != P) ? (0, s.jsx)(f.h, {
            onRetry: w,
            errorOrigin: f.A.SHOP_PAGE,
            errorMessage: P.message
        }) : M || 0 === D.length ? (0, s.jsxs)("div", {
            ...
            children: D.map((e, l) => ((e, l, d) => {
                ...
                switch (e.type) {
                    ...
                    case i.g.WIDE_BANNER:
                        if (e.isDismissible) {
                            let t = e.dismissibleContentVersion ?? 0,
                                {
                                    isDismissed: n
                                } = (0, u.En)(o.M.COLLECTIBLES_SHOP_WIDE_BANNER, t);
                            if (n) return null
                        }
                        g = (0, s.jsx)(T.A, {
                            wideBannerBlock: e,
                    ...
                    case i.g.MARVEL_RIVALS_PROMOTIONAL_BANNER: {
                        let {
                            isDismissed: t
                        } = (0, u.En)(o.M.COLLECTIBLES_SHOP_MARVEL_RIVALS_ORBS_REWARD);
                        if (t) return null;
                        return (0, s.jsx)(m.rW, {
                            blockType: e.type,
    ...
    M = e => {
        let {
            ...
            handleScroll: i
        } = (0, d.X)(a, n), o = (0, x.U)(), u = (0, _.uM)(), [m, h] = l.useState(O.md), [p, f] = l.useState(!1);
        return l.useEffect(() => {
            if (null != a.current) {
                let e = () => {
            ...
            children: (0, s.jsxs)("div", {
                ...
                children: [(0, s.jsxs)("div", {
                    ...
                    children: [(0, s.jsx)(B, {
                        ...
                        tab: n
                    }), n !== O.G2.CATALOG && m >= 36 && (0, s.jsxs)("div", {
                        className: R.R$,
                        children: [(0, s.jsx)(c.Heading, {
                            ...
                            onClick: () => {
                                t({
                                    ...
                                    page_type: n,
                                    page_category: n === O.G2.HOME ? void 0 : u?.pageCategory,
