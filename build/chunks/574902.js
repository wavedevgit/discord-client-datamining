...
let f = class {
    ...
    update(t) {
        0 !== this.points.length && (this.points.forEach(e => e.update(Math.min(t, u))), !this.hasEntered && this.points[0].x > d && (this.hasEntered = !0, this.updateWaveState(o.go.ENTERED)), this.isFilling && this.points[0].x > this.points[0].targetX && (this.isFilling = !1, this.updateWaveState(o.go.FILLED)))
    }
    render(t) {
    ...
    fill() {
        let t = Math.sqrt(window.innerWidth * window.innerWidth + window.innerHeight * window.innerHeight) + 100,
            e = p() - 140,
            i = (t, e, i, s) => {
                t.targetX = -40 + e * Math.cos(o.JM * (i / 15 * .25 + 0)), t.targetY = -40 + e * Math.sin(o.JM * (i / 15 * .25 + 0)), s && (t.targetX += (0, l.R)(0, 30) - 15, t.targetY += (0, l.R)(0, 30) - 15, t.speedUp = 3, t.spring.tension = 150 * Math.random() * .5 + 150)
            };
    ...
    constructor(t) {
        ...
        }), c(this, "resizeWave", n()(this._resizeWave, 200)), this.updateWaveState = t, this.hasEntered = !1;
