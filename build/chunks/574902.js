/** chunk id: 574902 params = (module,exports,require) **/
i.d(e, {
    A: () => m
}), i(321073);
var s = i(111956),
...
class p {
    ...
    constructor(t) {
        ...
        for (let t = 0; t <= 15; t++) this.points.push(new l.A(function(t) {
    ...
    _resizeWave = () => {
        ...
        this.points.forEach((e, i) => {
            let s = -40 + t * Math.cos(o.JM * (i / 15 * .25 + 0)),
                n = -40 + t * Math.sin(o.JM * (i / 15 * .25 + 0));
            0 !== i ? n += (0, r.R)(0, 30) - 15 : s += (0, r.R)(0, 30) - 15, e.targetX = s, e.targetY = n, e.angle = Math.atan2(n, s)
        })
    };
    ...
    update(t) {
        0 !== this.points.length && (this.points.forEach(e => e.update(Math.min(t, c))), !this.hasEntered && this.points[0].x > d && (this.hasEntered = !0, this.updateWaveState(o.go.ENTERED)), this.isFilling && this.points[0].x > this.points[0].targetX && (this.isFilling = !1, this.updateWaveState(o.go.FILLED)))
    }
    render(t) {
    ...
    fill() {
        let t = Math.sqrt(window.innerWidth * window.innerWidth + window.innerHeight * window.innerHeight) + 100,
            e = u() - 140,
            i = (t, e, i, s) => {
                t.targetX = -40 + e * Math.cos(o.JM * (i / 15 * .25 + 0)), t.targetY = -40 + e * Math.sin(o.JM * (i / 15 * .25 + 0)), s && (t.targetX += (0, r.R)(0, 30) - 15, t.targetY += (0, r.R)(0, 30) - 15, t.speedUp = 3, t.spring.tension = 150 * Math.random() * .5 + 150)
            };
        this.points.forEach((t, s) => i(t, e, s, !0)), setTimeout(() => {
            ...
            }), this.isFilling = !0, this.updateWaveState(o.go.FILLING)
        }, 250)
    }
}
let m = p