...
let v = o().defaultRules.link,
    ...
    N = e => {
        let {
            ...
            children: n,
            className: l
        } = e, i = (0, u.$Il)(), r = parseInt(t, 10), a = isNaN(r) ? 1 : r;
        return s.createElement(`h${i+a-1}`, {
            className: l
        }, n)
    },
    ...
    T = {
            ...
            parse(e, t, n) {
                ...
                return l = i ? e => {
                    A.default.track(f.HAw.PREMIUM_PROMOTION_OPENED, {
                        location: C
                    }), (0, g.openUserSettings)(h.X.NITRO_PANEL), n.changeLog.track(f.HAw.CHANGE_LOG_CTA_CLICKED, {
                        cta_type: "nitro"
                    }), (0, u.OoC)(p.lb), e.preventDefault()
                } : r ? e => {
                    (0, m.pX)(s), n.changeLog.track(f.HAw.CHANGE_LOG_CTA_CLICKED, {
                        ...A.default.getCampaignParams(s)
                    }), (0, c.bz)(), (0, u.OoC)(p.lb), e.preventDefault()
                } : () => {
                    n && "function" == typeof n.onLinkClick && n.onLinkClick(s), n.changeLog.track(f.HAw.CHANGE_LOG_CTA_CLICKED, {
                        target: s,
        ...
        lheading: e => ({
            react: (t, n, s) => {
                ...
                return (0, l.jsx)(N, {
                    level: t.level,
                    className: r()(x["heading-md/bold"], ...null == (i = t.className) ? [] : i.split(" ").map(t => e[t])),
