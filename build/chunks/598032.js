/** chunk id: 598032 params = (module,exports,require) **/
s.d(t, {
    A: () => w
});
var r = s(627968);
...
function w() {
    let [{
        ...
        sourceType: d,
        audioSourceId: _
    }] = (0, x.tS)(), w = (0, u.tR)(v.oh.AUDIO_INPUT), [I, E] = (0, g.A)(e) ?? [t, s], N = (0, p.K)(e), O = (0, m.b)(I), T = d === l.fS.CAMERA, R = null != c, M = null != c ? c?.id?.startsWith(l.fS.CAMERA) : T, U = e === j.jQ.PRESET_AUTO, G = R ? void 0 : e === j.jQ.PRESET_VIDEO ? y.intl.string(A.default.MuHUFe) : e === j.jQ.PRESET_DOCUMENTS ? y.intl.string(A.default.y0JuYR) : e === j.jQ.PRESET_AUTO ? y.intl.string(A.default.m4jtlc) : void 0, L = (0, a.bG)([f.Ay], () => f.Ay.getUseSystemScreensharePicker() && (0, h.isLinux)());
    return (0, r.jsxs)("div", {
        className: S.zr,
