...
function Z(t) {
    ...
    } = t, C = i.useRef(null), B = i.useRef(null), P = (0, _.bG)([h.A], () => h.A.get(r)), {
        guildId: J
    } = (0, M.nG)(P?.applicationId), Z = (0, D.b)({
        location: "storefront_card"
    }), tt = (0, _.bG)([S.A], () => (0, A.Mwr)(S.A.theme)), te = (0, _.bG)([R.A], () => R.A.useReducedMotion), tn = N.Q_.useSetting(), {
        isHoveringOrFocusing: tr
    } = (0, I.A)(C), ts = (0, b.jM)(), {
        analyticsLocations: ti
    } = (0, H.Ay)(o ?? []), ta = i.useRef({
        positionInSection: e,
        analyticsLocations: ti
    }), [tl, tu] = i.useState(!1), tc = (0, _.bG)([L.A], () => null != r ? L.A.getNormalizedSKUEligibility(r) : void 0, [r]), to = (0, k.A)(r, tl), td = i.useCallback(t => {
        tu(t)
    }, []), tA = i.useMemo(() => c()(q.Nr, {
        [q.ax]: 0 === a,
        [q.GW]: 1 === a,
    ...
    let tT = i.useCallback(t => {
        ...
        }, [r, ts]),
        {
            primaryIconAsset: tf,
            primaryIconLabel: tR
        } = i.useMemo(() => (0, M.Cv)(P, P?.applicationId), [P]),
        ...
        tS = i.useCallback(() => {
            t_(), null != J && (B.current = setTimeout(() => {
                (0, p.iR)(J, r)
            }, 1e3))
        }, [J, r, t_]),
        tN = i.useCallback(() => {
    ...
    let th = i.useCallback(() => {
        ...
        tx = i.useCallback(t => {
            (tT(V.bB.CARD), null != l && P?.applicationId != null) ? l(t, {
                skuId: r,
                ...
                children: [null != tH && (0, s.jsx)(T.LpS, {
                    ...
                    children: [(0, s.jsx)("div", {
                        ...
                        children: [(0, s.jsxs)("div", {
                            ...
                            children: [tD && (0, s.jsx)("div", {
                                className: q.S1,
                                children: (0, s.jsx)(y.V, {
                                    textColor: "always-white"
                                })
                            }), to ? (0, s.jsxs)(s.Fragment, {
                        ...
                        children: (0, s.jsxs)(A.e2v, {
                            ...
                            children: [tc ? (0, s.jsx)(A.$nd, {
                                ...
                                onMouseDown: tO,
                                onClick: t => {
                                    t.stopPropagation(), tT(V.bB.BUY_BUTTON), (0, j.a)(P, {
                                        isGift: !1
                                    }, {
                                        analyticsLocations: [...ti, E.A.SLAYER_STOREFRONT_CARD_PURCHASE_BUTTON],
                                        guildId: J
                                    })
                                },
                                ...
                                onGift: t => {
                                    t.stopPropagation(), tT(V.bB.GIFT_BUTTON), (0, j.a)(P, {
                                        isGift: !0
                                    }, {
                                        analyticsLocations: [...ti, E.A.SLAYER_STOREFRONT_CARD_GIFT_BUTTON]
                                    })
                                }
                            })]
                        })
