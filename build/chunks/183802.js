...
let z = [
    ...
    X = l()("#000000").darken(1.5).alpha(.9).hex(),
...
function J(t) {
    let {
        ...
        t.stopPropagation(), null != n && null != e && (a(Y.bB.FORWARD_BUTTON), (0, U.d)({
            sku: n,
            guildId: e,
            analyticsContext: o,
            analyticsLocations: u,
...
function Z(t) {
    let {
    ...
    } = t, O = i.useRef(null), U = i.useRef(null), j = (0, _.bG)([N.A], () => N.A.get(r)), $ = (0, _.bG)([b.A], () => b.A.getGuildIdFromApplicationId(j?.applicationId)), Z = (0, _.bG)([f.A], () => (0, A.Mwr)(f.A.theme)), tt = (0, _.bG)([m.A], () => m.A.useReducedMotion), te = C.Q_.useSetting(), {
        isHoveringOrFocusing: tn
    } = (0, S.A)(O), tr = (0, x.jM)(), {
        analyticsLocations: ts
    } = (0, H.Ay)(o ?? []), ti = i.useRef({
        positionInSection: e,
        analyticsLocations: ts
    }), [ta, tl] = i.useState(!1), tu = (0, _.bG)([b.A], () => null != r ? b.A.getNormalizedSKUEligibility(r) : void 0, [r]), tc = (0, k.A)(r, ta), to = i.useCallback(t => {
        tl(t)
    }, []), td = i.useMemo(() => c()(q.Nr, {
        [q.ax]: 0 === a,
        [q.GW]: 1 === a,
        ...
        handleCardHover: tA,
        handleCardUnhover: t_
    } = (0, P.Z)(r, tr, e, ts), {
        handleCardVisibilityChange: tg
    } = (0, F.a)(r, tr, e, ts);
    i.useEffect(() => {
        tg(ta)
    }, [ta]);
    let tT = i.useCallback(t => {
            let {
        ...
        }, [r, tr]),
        {
            primaryIconAsset: tR,
            primaryIconLabel: tE
        } = i.useMemo(() => (0, h.Cv)(j, j?.applicationId), [j]),
        ...
        tI = i.useMemo(() => {
            ...
            return e <= 3 ? K.intl.format(K.t.PWw4Vp, {
                days: e
            }) : null
    ...
    let tM = i.useCallback(() => {
        ...
        tL = i.useCallback(t => {
            (tT(Y.bB.CARD), null != l && null != $ && j?.applicationId != null) ? l(t, {
                skuId: r,
    ...
    return (0, s.jsx)(g.L, {
        ...
        children: (0, s.jsx)(A.vN3, {
            children: (0, s.jsxs)(R.sqX, {
                ...
                ref: O,
                "aria-label": j.name,
                children: [null != tI && (0, s.jsx)(R.LpS, {
                    text: tI,
                    disableColor: !0,
                    className: q.qS
                }), (0, s.jsx)(J, {
                    ...
                    children: [(0, s.jsx)("div", {
                        ...
                        children: [(0, s.jsx)("div", {
                            ...
                            children: tc ? (0, s.jsxs)(s.Fragment, {
                            ...
                            className: q.iQ,
                            children: tc ? (0, s.jsxs)(s.Fragment, {
                                children: [null != j.price && (0, s.jsx)(R.Text, {
                                    variant: "text-md/bold",
                                    color: "always-white",
                                    lineClamp: 1,
                                    children: (0, L.$g)(j.price?.amount ?? 0, j.price?.currency ?? W.Yr.USD)
                                }), null != j.orbsReward && j.orbsReward > 0 && (0, s.jsx)("div", {
                                    className: q.pt,
                        ...
                        children: (0, s.jsxs)(A.e2v, {
                            wrap: !1,
                            fullWidth: !0,
                            children: [tu ? (0, s.jsx)(A.$nd, {
                                variant: "primary",
                                onMouseDown: tf,
                                onClick: t => {
                                    t.stopPropagation(), tT(Y.bB.BUY_BUTTON), (0, y.a)(j, {
                                        isGift: !1
                                    }, {
                                        analyticsLocations: [...ts, I.A.SLAYER_STOREFRONT_CARD_PURCHASE_BUTTON],
                                        guildId: $
                                    })
                                },
                                text: null != j.price ? K.intl.format(K.t.Xp5WTn, {
                                    price: (0, L.$g)(j.price?.amount ?? 0, j.price?.currency ?? W.Yr.USD)
                                ...
                                onGift: t => {
                                    t.stopPropagation(), tT(Y.bB.GIFT_BUTTON), (0, y.a)(j, {
                                        isGift: !0
                                    }, {
                                        analyticsLocations: [...ts, I.A.SLAYER_STOREFRONT_CARD_GIFT_BUTTON]
                                    })
                                }
                            })]
                        })
