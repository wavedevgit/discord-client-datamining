...
function J(t) {
    let {
        ...
        t.stopPropagation(), null != n && null != e && (i(Y.bB.FORWARD_BUTTON), (0, U.d)({
            sku: n,
            guildId: e,
            analyticsContext: o,
            analyticsLocations: u,
...
function Z(t) {
    ...
    } = t, O = a.useRef(null), U = a.useRef(null), j = (0, _.bG)([N.A], () => N.A.get(r)), $ = (0, _.bG)([D.A], () => D.A.getGuildIdFromApplicationId(j?.applicationId)), Z = (0, _.bG)([f.A], () => (0, A.Mwr)(f.A.theme)), tt = (0, _.bG)([m.A], () => m.A.useReducedMotion), te = C.Q_.useSetting(), {
        isHoveringOrFocusing: tn
    } = (0, S.A)(O), tr = (0, x.jM)(), {
        analyticsLocations: ts
    } = (0, H.Ay)(o ?? []), ta = a.useRef({
        positionInSection: e,
        analyticsLocations: ts
    }), [ti, tl] = a.useState(!1), tu = (0, _.bG)([D.A], () => null != r ? D.A.getNormalizedSKUEligibility(r) : void 0, [r]), tc = (0, k.A)(r, ti), to = a.useCallback(t => {
        tl(t)
    }, []), td = a.useMemo(() => c()(z.Nr, {
        [z.ax]: 0 === i,
        [z.GW]: 1 === i,
    ...
    let tT = a.useCallback(t => {
        ...
        }, [r, tr]),
        {
            primaryIconAsset: tR,
            primaryIconLabel: tE
        } = a.useMemo(() => (0, h.Cv)(j, j?.applicationId), [j]),
