...
function J(t) {
    let {
        ...
        t.stopPropagation(), null != n && null != e && (i(F.bB.FORWARD_BUTTON), (0, U.d)({
            sku: n,
            guildId: e,
            analyticsContext: o,
            analyticsLocations: u,
...
function Z(t) {
    let {
        ...
        className: f,
        analyticsLocations: U
    } = t, j = a.useRef(null), $ = a.useRef(null), Z = (0, _.bG)([N.A], () => N.A.get(i)), tt = (0, _.bG)([C.A], () => (0, A.Mwr)(C.A.theme)), te = (0, _.bG)([m.A], () => m.A.useReducedMotion), tn = I.Q_.useSetting(), {
        isHoveringOrFocusing: tr
    } = (0, O.A)(j), ts = (0, D.jM)(), {
        analyticsLocations: ta
    } = (0, S.Ay)(U ?? []), ti = a.useRef({
        positionInSection: e,
        analyticsLocations: ta
    }), [tl, tu] = a.useState(!1), tc = (0, _.bG)([b.A], () => null != i ? b.A.getNormalizedSKUEligibility(i) : void 0, [i]), to = (0, k.A)(i, tl), td = a.useCallback(t => {
        tu(t)
    }, []), tA = a.useMemo(() => c()(z.Nr, {
        [z.ax]: 0 === l,
        [z.GW]: 1 === l,
        ...
        handleCardHover: t_,
        handleCardUnhover: tg
    } = (0, P.Z)(i, ts, e, ta), {
        handleCardVisibilityChange: tT
    } = (0, Y.a)(i, ts, e, ta);
    a.useEffect(() => {
        tT(tl)
    }, [tl]);
    let tR = a.useCallback(t => {
            let {
    ...
    return (0, s.jsx)(g.L, {
        ...
        children: (0, s.jsx)(A.vN3, {
            children: (0, s.jsxs)(R.sqX, {
                ...
                ref: j,
                "aria-label": Z.name,
                children: [null != tS && (0, s.jsx)(R.LpS, {
                    text: tS,
                    disableColor: !0,
                    className: z.qS
                }), (0, s.jsx)(J, {
                    ...
                    children: [(0, s.jsx)("div", {
                        ...
                        children: [(0, s.jsx)("div", {
                            className: z.gn,
                            children: to ? (0, s.jsxs)(s.Fragment, {
                                children: [null != tE && (0, s.jsx)("img", {
                                    src: tE.toString(),
                                    alt: tm,
                                    className: z.ye
                                }), (0, s.jsx)(R.Text, {
                            ...
                            children: to ? (0, s.jsxs)(s.Fragment, {
                                children: [(0, s.jsx)(R.Text, {
                                    ...
                                    color: "always-white",
                                    lineClamp: 1,
                                    children: (0, L.$g)(Z.price?.amount ?? 0, Z.price?.currency ?? W.Yr.USD)
                                }), null != Z.orbsReward && Z.orbsReward > 0 && (0, s.jsx)("div", {
                                    className: z.pt,
                                    children: (0, s.jsx)(R.Text, {
                        ...
                        children: (0, s.jsxs)(A.e2v, {
                            wrap: !1,
                            fullWidth: !0,
                            children: [tc ? (0, s.jsx)(A.$nd, {
                                variant: "primary",
                                onMouseDown: tI,
                                onClick: t => {
                                    t.stopPropagation(), tR(F.bB.BUY_BUTTON), (0, y.a)(Z, {
                                        isGift: !1
                                    }, {
                                        analyticsLocations: [...ta, H.A.SLAYER_STOREFRONT_CARD_PURCHASE_BUTTON],
                                        guildId: u
                                    })
                                },
                                text: K.intl.format(K.t.Xp5WTn, {
                                    price: (0, L.$g)(Z.price?.amount ?? 0, Z.price?.currency ?? W.Yr.USD)
                                }),
                                fullWidth: !0
                            }) : (0, s.jsx)(T.m, {
                                ...
                                onGift: t => {
                                    t.stopPropagation(), tR(F.bB.GIFT_BUTTON), (0, y.a)(Z, {
                                        isGift: !0
                                    }, {
                                        analyticsLocations: [...ta, H.A.SLAYER_STOREFRONT_CARD_GIFT_BUTTON]
                                    })
                                }
                            })]
                        })
