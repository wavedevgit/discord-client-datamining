...
function tt(t) {
    ...
    } = t, C = i.useRef(null), B = i.useRef(null), P = (0, _.bG)([x.A], () => x.A.get(r)), {
        guildId: $
    } = (0, M.nG)(P?.applicationId), tt = (0, D.b)({
        location: "storefront_card"
    }), te = (0, _.bG)([N.A], () => (0, A.Mwr)(N.A.theme)), tn = (0, _.bG)([R.A], () => R.A.useReducedMotion), tr = S.Q_.useSetting(), {
    ...
    let th = i.useCallback(() => {
        ...
        tM = i.useCallback(t => {
            (tf(W.bB.CARD), null != l && P?.applicationId != null) ? l(t, {
                skuId: r,
    ...
    return (0, s.jsx)(g.L, {
        ...
        children: (0, s.jsx)(A.vN3, {
            children: (0, s.jsxs)(T.sqX, {
                ...
                ref: C,
                "aria-label": P.name,
                children: [P.exclusive ? (0, s.jsx)("div", {
                    className: z.fC,
                    children: (0, s.jsx)(y.I, {})
                }) : null != tI && (0, s.jsx)(T.LpS, {
                    text: tI,
                    disableColor: !0,
                    className: z.qS
                }), (0, s.jsx)(Z, {
                    ...
                    children: [(0, s.jsx)("div", {
                        ...
                        children: (0, s.jsxs)(A.e2v, {
                            wrap: !1,
                            fullWidth: !0,
                            children: [to ? (0, s.jsx)(A.$nd, {
                                variant: "primary",
                                onMouseDown: tN,
                                onClick: t => {
                                    t.stopPropagation(), tf(W.bB.BUY_BUTTON), (0, j.a)(P, {
                                        isGift: !1
                                    }, {
                                ...
                                onGift: t => {
                                    t.stopPropagation(), tf(W.bB.GIFT_BUTTON), (0, j.a)(P, {
                                        isGift: !0
                                    }, {
