...
function Z(e) {
    ...
    } = (0, f.Ay)(C ?? []), en = r.useRef({
        positionInSection: t,
        analyticsLocations: et
    }), [ei, el] = r.useState(!1), er = (0, m.bG)([L.A], () => null != i ? L.A.getNormalizedSKUEligibility(i) : void 0, [i]), ea = (0, P.A)(i, ei), es = r.useCallback(e => {
        el(e)
    }, []), eo = r.useMemo(() => d()(Y.Nr, {
        [Y.ax]: 0 === a,
        [Y.GW]: 1 === a,
