...
function Q(t) {
    let {
        ...
        t.stopPropagation(), null != n && null != e && (a(P.bB.FORWARD_BUTTON), (0, B.d)({
            sku: n,
            guildId: e,
            analyticsContext: o,
            analyticsLocations: u,
...
function J(t) {
    let {
        ...
        handleCardHover: to,
        handleCardUnhover: td
    } = (0, w.Z)(r, te, e, tn), {
        handleCardVisibilityChange: tA
    } = (0, F.a)(r, te, e, tn);
    i.useEffect(() => {
        tA(ts)
    }, [ts]);
    let t_ = i.useCallback(t => {
            let {
        ...
        }, [r, te]),
        {
            primaryIconAsset: tg,
            primaryIconLabel: tT
        } = i.useMemo(() => (0, L.Cv)(j, j?.applicationId), [j]),
        ...
        tR = i.useMemo(() => {
            ...
            return e <= 3 ? W.intl.format(W.t.PWw4Vp, {
                days: e
            }) : null
        ...
        tO = i.useCallback(() => {
            to(), null != X && (B.current = setTimeout(() => {
    ...
    return (0, s.jsx)(g.L, {
        ...
        children: (0, s.jsx)(A.vN3, {
            children: (0, s.jsxs)(E.sqX, {
                ...
                ref: O,
                "aria-label": j.name,
                children: [null != tR && (0, s.jsx)(E.LpS, {
                    text: tR,
                    disableColor: !0,
                    className: V.qS
                }), (0, s.jsx)(Q, {
                    ...
                    children: [(0, s.jsx)("div", {
                        ...
                        children: [(0, s.jsx)("div", {
                            ...
                            children: tl ? (0, s.jsxs)(s.Fragment, {
                                children: [null != tg && (0, s.jsx)("img", {
                                    src: tg.toString(),
                                    alt: tT,
                                    className: V.ye
                                }), (0, s.jsx)(E.Text, {
                            ...
                            className: V.iQ,
                            children: tl ? (0, s.jsxs)(s.Fragment, {
                                children: [(0, L.mC)(j) && (0, s.jsx)(E.Text, {
                        ...
                        children: (0, s.jsxs)(A.e2v, {
                            ...
                            children: [ta ? (0, s.jsx)(A.$nd, {
                                ...
                                text: (0, L.mC)(j) ? W.intl.format(W.t.Xp5WTn, {
