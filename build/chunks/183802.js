...
function $(t) {
    let {
        ...
        t.stopPropagation(), null != n && null != e && (a(V.bB.FORWARD_BUTTON), (0, B.d)({
            sku: n,
            guildId: e,
            analyticsContext: o,
            analyticsLocations: u,
...
function Z(t) {
    let {
    ...
    } = t, C = i.useRef(null), B = i.useRef(null), F = (0, _.bG)([x.A], () => x.A.get(r)), {
        guildId: J
    } = (0, M.nG)(F?.applicationId), Z = (0, _.bG)([N.A], () => (0, A.Mwr)(N.A.theme)), tt = (0, _.bG)([E.A], () => E.A.useReducedMotion), te = S.Q_.useSetting(), {
        ...
        positionInSection: e,
        analyticsLocations: ts
    }), [ta, tl] = i.useState(!1), tu = (0, _.bG)([b.A], () => null != r ? b.A.getNormalizedSKUEligibility(r) : void 0, [r]), tc = (0, D.A)(r, ta), to = i.useCallback(t => {
        tl(t)
    }, []), td = i.useMemo(() => c()(q.Nr, {
        [q.ax]: 0 === a,
        [q.GW]: 1 === a,
    ...
    let tT = i.useCallback(t => {
        ...
        tf = i.useMemo(() => {
            ...
            return n <= 3 ? K.intl.format(K.t.PWw4Vp, {
                days: n
            }) : null
        ...
        tO = i.useCallback(() => {
            tA(), null != J && (B.current = setTimeout(() => {
                (0, p.iR)(J, r)
            }, 1e3))
        }, [J, r, tA]),
        tN = i.useCallback(() => {
    ...
    let tS = i.useCallback(() => {
        ...
        tx = i.useCallback(t => {
            (tT(V.bB.CARD), null != l && F?.applicationId != null) ? l(t, {
                skuId: r,
        ...
        }, [te, r]),
        {
            ...
            return null != e && (0, M.mC)(e) ? null != a && null != r ? {
                priceComponent: (0, s.jsxs)("div", {
                    children: [(0, s.jsxs)("div", {
                        className: q.p6,
                        children: [null != n && (0, s.jsx)(m.Text, {
                            className: q.of,
    ...
    return (0, s.jsx)(g.L, {
        ...
        children: (0, s.jsx)(A.vN3, {
            children: (0, s.jsxs)(m.sqX, {
                ...
                ref: C,
                "aria-label": F.name,
                children: [F.exclusive ? (0, s.jsx)("div", {
                    className: q.fC,
                    children: (0, s.jsx)(j.I, {})
                }) : null != tf && (0, s.jsx)(m.LpS, {
                    text: tf,
                    disableColor: !0,
                    className: q.qS
                }), (0, s.jsx)($, {
                    ...
                    children: [(0, s.jsx)("div", {
                        ...
                        children: [(0, s.jsxs)("div", {
                            ...
                            children: [tc && (0, s.jsx)("div", {
                                className: q.S1,
                                children: (0, s.jsx)(y.V, {
                                    textColor: "always-white"
                                })
                            }), tc ? (0, s.jsxs)(s.Fragment, {
                                children: [null != tm && (0, s.jsx)("img", {
                                    src: tm.toString(),
                                    alt: tR,
                                    className: q.ye
                                }), (0, s.jsx)(m.Text, {
                        ...
                        children: (0, s.jsxs)(A.e2v, {
                            ...
                            children: [tu ? (0, s.jsx)(A.$nd, {
                                ...
                                onMouseDown: tC,
                                onClick: t => {
                                    t.stopPropagation(), tT(V.bB.BUY_BUTTON), (0, k.a)(F, {
                                        isGift: !1
                                    }, {
                                        analyticsLocations: [...ts, f.A.SLAYER_STOREFRONT_CARD_PURCHASE_BUTTON],
                                        guildId: J
                                    })
                                },
                                text: null != tL ? K.intl.format(K.t.Xp5WTn, {
                                    price: tL
                                ...
                                onGift: t => {
                                    t.stopPropagation(), tT(V.bB.GIFT_BUTTON), (0, k.a)(F, {
                                        isGift: !0
                                    }, {
                                        analyticsLocations: [...ts, f.A.SLAYER_STOREFRONT_CARD_GIFT_BUTTON]
                                    })
                                }
                            })]
                        })
