...
function J(t) {
    let {
        ...
        t.stopPropagation(), null != n && null != e && (a(Y.bB.FORWARD_BUTTON), (0, y.d)({
            sku: n,
            guildId: e,
            analyticsContext: o,
            analyticsLocations: u,
...
function Z(t) {
    ...
    } = t, S = i.useRef(null), y = i.useRef(null), w = (0, _.bG)([N.A], () => N.A.get(r)), $ = (0, _.bG)([b.A], () => b.A.getGuildIdFromApplicationId(w?.applicationId)), Z = (0, _.bG)([O.A], () => (0, A.Mwr)(O.A.theme)), tt = (0, _.bG)([m.A], () => m.A.useReducedMotion), te = C.Q_.useSetting(), {
        isHoveringOrFocusing: tn
    } = (0, H.A)(S), tr = (0, x.jM)(), {
        analyticsLocations: ts
    } = (0, f.Ay)(o ?? []), ti = i.useRef({
        positionInSection: e,
        analyticsLocations: ts
    ...
    let tT = i.useCallback(t => {
        ...
        }, [r, tr]),
        {
            primaryIconAsset: tR,
            primaryIconLabel: tE
        } = i.useMemo(() => (0, h.Cv)(w, w?.applicationId), [w]),
    ...
    let tM = i.useCallback(() => {
        ...
        tL = i.useCallback(t => {
            (tT(Y.bB.CARD), null != l && null != $ && w?.applicationId != null) ? l(t, {
                skuId: r,
                ...
                children: [null != tI && (0, s.jsx)(R.LpS, {
                    ...
                    children: [(0, s.jsx)("div", {
                        ...
                        children: [(0, s.jsx)("div", {
                            ...
                            className: q.iQ,
                            children: tc ? (0, s.jsxs)(s.Fragment, {
                                children: [null != w.price && (0, s.jsx)(R.Text, {
                                    variant: "text-md/bold",
                                    color: "always-white",
                                    lineClamp: 1,
                                    children: (0, L.$g)(w.price?.amount ?? 0, w.price?.currency ?? V.Yr.USD)
                                }), null != w.orbsReward && w.orbsReward > 0 && (0, s.jsx)("div", {
                                    className: q.pt,
                        ...
                        children: (0, s.jsxs)(A.e2v, {
                            ...
                            children: [tu ? (0, s.jsx)(A.$nd, {
                                ...
                                onMouseDown: tO,
                                onClick: t => {
                                    t.stopPropagation(), tT(Y.bB.BUY_BUTTON), (0, U.a)(w, {
                                        isGift: !1
                                    }, {
                                ...
                                text: null != w.price ? K.intl.format(K.t.Xp5WTn, {
                                    price: (0, L.$g)(w.price?.amount ?? 0, w.price?.currency ?? V.Yr.USD)
                                ...
                                onGift: t => {
                                    t.stopPropagation(), tT(Y.bB.GIFT_BUTTON), (0, U.a)(w, {
                                        isGift: !0
                                    }, {
