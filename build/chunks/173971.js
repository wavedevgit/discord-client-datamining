/** chunk id: 173971 params = (module,exports,require) **/
i.d(e, {
    default: () => w
});
var n = i(627968),
...
function w(t) {
    let {
        ...
        state: "LINK"
    }), [k, N] = a.useState(!1), E = (0, l.bG)([p.A], () => p.A.getApplication(i.applicationId)), I = (0, m.RD)(E), {
        analyticsLocations: L
    } = (0, x.Ay)(A ?? [], _.A.SOCIAL_LAYER_GIFT_CODE_CLAIM_MODAL);
    a.useEffect(() => {
        c.redeemed && "LINK" === S.state && h({
            state: "ERROR",
            error: new r.Wl(v.intl.string(v.t.Iw2TUW), b.t02.INVALID_GIFT_REDEMPTION_EXHAUSTED)
        })
    }, [c, S.state]);
    let y = a.useRef({
        analyticsLocations: L,
    ...
    (0, d.Ay)(() => {
        ...
        C.default.track(b.HAw.OPEN_MODAL, {
            location_stack: t,
            type: R.Nu,
            sku_id: e,
            application_id: E?.id
...
let D = t => {
    ...
    return r.code === b.t02.INVALID_GIFT_REDEMPTION_OWNED ? (e = v.intl.string(v.t.uXnSGo), i = o ? v.intl.formatToPlainString(v.t["TNRN/e"], {
        applicationName: c.name
    }) : v.intl.formatToPlainString(v.t.VkR30M, {
        applicationName: c.name
    })) : (e = v.intl.string(v.t.dMYg1c), i = (0, k.eN)(r, d)), (0, n.jsxs)(s.dWK, {
        transitionState: a,
        onClose: l,
...
function M(t) {
    ...
    return (0, n.jsx)(L.m, {
        ...
        bodyText: v.intl.formatToPlainString(h, {
...
function G(t) {
    let {
        ...
        emojiName: x,
        soundId: m
    } = t, p = (0, I.j)(o), f = (0, E.J)(o), [g, j] = a.useState(null), S = (0, l.bG)([A.default], () => A.default.getUser(d.userId)), k = N.Ay.getName(S), T = a.useRef({
        analyticsLocations: _,
        skuId: r.id,
        applicationId: o.id,
        isLaunchable: p,
    ...
    return (0, n.jsxs)(s.dWK, {
        ...
        children: [(0, n.jsx)("div", {
            ...
            children: [(0, n.jsx)(s.EYj, {
                ...
                color: "text-subtle",
                className: O.j7,
                children: v.intl.formatToPlainString(v.t["6yrIzU"], {
                    sender: k
                })
...
let P = t => {
    ...
    U = t => {
        let {
            confettiTarget: e,
            emojiName: i
        } = t, s = (0, l.bG)([u.A], () => u.A.useReducedMotion), r = a.useRef(e), [c, o] = a.useState(!0), d = a.useCallback(() => {
            o(!1)
        }, []);
        if (s || !c) return null;
