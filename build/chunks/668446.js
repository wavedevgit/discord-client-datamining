...
function C(e) {
    ...
    let n, l, r, p, E, C;
    return {
        guildPopulated: (n = (0, s.bG)([d.A], () => d.A.getChannel(e?.systemChannelId)), l = (0, s.yK)([g.A], () => null != n ? g.A.getMessages(n.id).toArray() : []), (0, s.bG)([h.A], () => {
            let t = h.A.getMemberCount(e?.id) ?? 0,
                n = l.some(e => e.type === f.lAJ.USER_JOIN);
            return t > 1 || n
        }, [e, l])),
        guildMessaged: (r = (0, s.bG)([d.A], () => null != e ? d.A.getMutableBasicGuildChannelsForGuild(e.id) : null), t = i.useMemo(() => null == r ? [] : a().values(r), [r]), p = (0, s.bG)([c.default], () => c.default.getId()), (0, s.bG)([g.A], () => a().some(t, e => {
            let t = g.A.getMessages(e.id).toArray();
            return a().some(t, e => e.author.id === p && !(0, o.A)(e))
        }))),
        guildPersonalized: (E = (0, s.bG)([A.A], () => A.A.hasLayers()), C = (0, s.bG)([m.A], () => m.A.getGuild(e?.id)), C?.icon != null && !E),
