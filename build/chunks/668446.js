...
function C(e) {
    ...
    return {
        ...
        guildMessaged: (r = (0, s.bG)([d.A], () => null != e ? d.A.getMutableBasicGuildChannelsForGuild(e.id) : null), t = i.useMemo(() => null == r ? [] : a().values(r), [r]), _ = (0, s.bG)([c.default], () => c.default.getId()), (0, s.bG)([g.A], () => a().some(t, e => {
