...
function C(e) {
    ...
    return {
        ...
        guildMessaged: (r = (0, a.bG)([d.A], () => null != e ? d.A.getMutableBasicGuildChannelsForGuild(e.id) : null), t = i.useMemo(() => null == r ? [] : s().values(r), [r]), _ = (0, a.bG)([c.default], () => c.default.getId()), (0, a.bG)([g.A], () => s().some(t, e => {
            let t = g.A.getMessages(e.id).toArray();
            return s().some(t, e => e.author.id === _ && !(0, o.A)(e))
        }))),
