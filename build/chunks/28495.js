/** chunk id: 28495 params = (module,exports,require) **/
"use strict";
n.d(t, {
    Ay: () => ee
});
...
function X(e) {
    let {
        role: t,
        disabled: n
    } = e, [l, r] = s.useState(t.name);
    return s.useEffect(() => {
        r(t.name)
    }, [t.name]), (0, i.jsx)(g.ksK, {
    ...
    return (0, i.jsx)("div", {
        ...
        children: (0, i.jsx)(g.D0$, {
            ...
            children: (0, i.jsx)(K, {
                ...
                onChange: e => {
                    var n;
                    return n = e, void(t.color !== n && (n !== P.TGz || 0 !== t.color) && (n === P.TGz && (n = 0), (0, S.ZH)(t.id, n)))
                },
                secondaryValue: s === y.y.GRADIENT && l && t.colors?.secondary_color != null ? t.colors?.secondary_color : void 0,
...
function Q(e) {
    let {
    ...
    } = e, a = (0, R.$)(B.intl.string(B.t.Mi9Kbe)), o = {
        ...
        src: W,
        name: t.name
    }, u = (0, j.qE)(n, t), x = [P.NJ8.DARK, P.NJ8.DARKER, P.NJ8.MIDNIGHT, P.NJ8.LIGHT];
    return (0, i.jsx)(g.M1G, {
        children: (0, i.jsx)("div", {
            ...
            "aria-hidden": !0,
            children: x.map(e => (0, i.jsx)(g.NPJ, {
                theme: e,
                ...
                children: t => (0, i.jsxs)("div", {
                    ...
                    }), e === P.NJ8.LIGHT && s !== y.y.SOLID && (0, i.jsx)(g.Text, {
                        variant: "text-xs/medium",
                        color: "text-subtle",
                        className: H.W_,
