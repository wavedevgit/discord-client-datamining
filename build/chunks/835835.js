...
class _ extends s.PureComponent {
    ...
    renderCloseButton() {
        ...
        return null != e && (t || n || null != s && s.isPrivate()) ? (0, l.jsx)("div", {
            className: L.UD,
...
let I = d.Ay.connectStores([j.A], e => {
    ...
    return {
        canManageMessages: null != t && j.A.can(w.xBc.MANAGE_MESSAGES, t)
    }
})(_);
...
function P(e) {
    let {
        ...
        className: y,
        listName: R
    } = e, E = s.useRef(null), _ = (0, m.A)(R, E), I = (0, d.bG)([f.Ay], () => f.Ay.hasNotice()), P = (0, d.bG)([N.A], () => N.A.windowSize());
    s.useEffect(() => {
        A.default.track(w.HAw.OPEN_POPOUT, {
            type: t
        })
    }, [t]), s.useEffect(() => {
        function e() {
            E.current?.scrollPageUp({
                animate: !0
            })
        }

        function t() {
            E.current?.scrollPageDown({
                animate: !0
            })
        }
        return C._.subscribe(w.jej.SCROLL_PAGE_DOWN, t), C._.subscribe(w.jej.SCROLL_PAGE_UP, e), () => {
    ...
    let S = s.useCallback(() => {
        ...
        k = [],
        G = !0;
    null == n || i && 0 === n.length ? k = [(0, l.jsx)("div", {
        className: r()(L.zC, L.k$),
        children: (0, l.jsx)(u.y$y, {})
    }, "spinner")] : 0 === n.length ? k.push((0, l.jsx)(s.Fragment, {
        children: p()
    }, "empty-state")) : (G = !1, k = [], o().each(n, e => {
        k.push(...v(e))
    }));
    let M = null;
    null != n && n.length > 0 && null != h && (M = i ? (0, l.jsx)("div", {
        className: L.sw,
        children: (0, l.jsx)(u.y$y, {})
    }, "loading-more-after") : a ? (0, l.jsx)("div", {
        className: L.u9,
        children: (0, l.jsx)(u.Button, {
            variant: "secondary",
            size: "sm",
...
function S(e) {
    ...
    return (0, l.jsx)(P, {
        ...
        renderItem: function(e) {
            ...
            let s = [];
            return null == n ? [] : (s.push((0, l.jsxs)("div", {
                className: L.Uc,
