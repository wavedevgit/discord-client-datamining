/** Chunk was on web.js **/
/** chunk id: 133684, original params: e,t,n (module,exports,require) **/
"use strict";
n.d(t, {
    A: () => A
}), n(733351), n(747238), n(896048), n(812715);
var r = n(627968),
    i = n(64700),
    a = n(503698),
    o = n.n(a),
...
class v extends i.PureComponent {
    ...
    handleTabOrEnterDown(e) {
        e.which === h.Ks6.TAB && this.props.onTab() || e.which === h.Ks6.ENTER && this.props.onEnter(e) ? (e.preventDefault(), e.stopPropagation()) : e.which === h.Ks6.ESCAPE ? (e.preventDefault(), e.stopPropagation(), this.props.hideAutocomplete()) : e.which === h.Ks6.TAB && this.hasOpenCodeBlock() && (e.preventDefault(), e.stopPropagation(), this.insertText("	", void 0, !1))
    }
    insertEmoji(e) {
        let {
            emoji: t,
        ...
        this.insertText("".concat(b).concat(t.name).concat(b), void 0, n)
    }
    getFirstText() {
