/** chunk id: 949004 params = (module,exports,require) **/
r.d(t, {
    default: () => E
});
var n = r(627968),
...
function E(e) {
    ...
    let S = o.useCallback(e => {
        let {
            ...
            problem: o,
            feedback: a
        } = e, _ = null == t, l = (0, c.JO)(g);
        (0, c.dN)(t, "" !== a ? a : null, o?.value ?? null, _, l), _ || (0, i.mMO)(async () => {
            let {
                default: e
            } = await r.e("37836").then(r.bind(r, 845671));
            return t => (0, n.jsx)(e, {
                body: m.intl.string(b.default["4djgO/"]),
                ...t
            })
        })
    }, [g]);
    return (0, n.jsx)(l.A, {
        ...
        freeformDescription: e => null == e ? null : e.value === u.VY.SOMETHING_ELSE ? m.intl.string(b.default.Q5cQ46) : m.intl.string(b.default.zApKaR)
    })
}