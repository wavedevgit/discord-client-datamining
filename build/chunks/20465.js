...
function j(e) {
    ...
    }), [t]), r = (0, g.X4)(t), o = s.useContext(p.A), [u, C] = s.useState(!1), N = s.useCallback(e => {
        "A" !== e.target.nodeName && (h.A.updateChatOpen(t.channel_id, !0), A.A.jumpToMessage({
            channelId: t.channel_id,
            messageId: t.id,
            flash: !0
        }))
    }, [t.channel_id, t.id]), S = null != t.content && "" !== t.content ? (0, m.Ay)(t, {
        isInteracting: u
    }).content : null, {
...
function R(e) {
    let {
        ...
        let {
            ...
            count: i,
            lingerMs: l
        } = e, [a, r] = s.useState([]), [o, d] = s.useState(!1), h = s.useRef(null), A = s.useRef(void 0), p = s.useCallback(() => {
            r([]), d(!0)
        }, []);
        s.useEffect(() => {
            function e(e) {
                ...
                n !== t || i.type === b.lAJ.STAGE_START || i.type === b.lAJ.STAGE_END || i.type === b.lAJ.STAGE_TOPIC || i.type === b.lAJ.STAGE_SPEAKER || i.type === b.lAJ.STAGE_RAISE_HAND || s || (clearTimeout(A.current), A.current = setTimeout(p, l), r(e => [...e, i.id]))
            }
        ...
        return {
            toastsHidden: o,
            toastMessages: (0, c.yK)([C.A], () => m.map(e => C.A.getMessage(t, e)), [t, m]).filter(S.Vq)
        }
    }({
        channelId: t,
        isFrozen: l,
        count: 3,
        lingerMs: y
    }), m = s.useRef({}), [g, _] = s.useState({}), f = s.useCallback((e, t) => {
