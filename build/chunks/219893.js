/** chunk id: 219893 params = (module,exports,require) **/
n.d(t, {
    I2: () => A,
    a3: () => x,
    fU: () => o,
...
function g(e) {
    ...
    let n = new Intl.DateTimeFormat(l.intl.currentLocale, {
        weekday: "short"
    });
    return r.map((e, i) => t.has(e) ? n.format(new Date(2025, 0, 5 + i)) : null).filter(e => null !== e).join(", ")
}
...
function x(e) {
    let t = e / 60;
    return Number.isInteger(t) ? l.intl.formatToPlainString(s.default.hFDcmZ, {
        hours: t
    }) : l.intl.formatToPlainString(s.default.wcrXLM, {
        hours: Math.floor(t)
    })
}
