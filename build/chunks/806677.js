...
function V(e) {
    ...
    return n.shouldShow ? (0, y.Qc)(n) ? (0, r.jsx)(_.m, {
        text: n.title,
        position: "top",
        asContainer: !0,
        delay: A.Zh,
...
function J(e) {
    ...
    } = e, m = a.useMemo(() => new Set(i.map(e => {
        let {
            source: t
        } = e;
        return t
    })), [i]), p = (0, d.bG)([M.A, H.A], () => H.A.getChannel(M.A.getChannelId())), h = _ > i.length ? _ - i.length + 1 : void 0, I = a.useCallback(() => {
        c?.(), (0, u.s7G)()
    }, [c]);
    return ((0, j.T)({
...
function $(e) {
    let {
        ...
        totalUnownedWishlistItems: _,
        analyticsLocations: f
    } = e, h = (0, L.GG)("gift_selection_modal_wishlist_section"), I = (0, W.tx)(t), C = 0 === _ ? U.intl.string(U.t.BCi1gT) : _ >= 12 ? U.intl.formatToPlainString(U.t.Y2RFOQ, {
        username: I
    }) : U.intl.formatToPlainString(U.t.dIDKgi, {
        username: I
    }), {
        analyticsLocations: x
    } = (0, p.Ay)(...f ?? [], m.A.GIFT_SELECTION_MODAL_WISHLIST), k = (0, y.bc)(n, t), [T, E] = a.useState(!1), j = a.useCallback(e => {
        e && !c && n.length > 0 && (G.default.track(F.HAw.IMPRESSION_GIFT_SELECTION_WISHLIST_SECTION_VIEWED, {
    ...
    }, [c, n, t.id, x]), A = (0, l.K)(j, void 0, !c && !T), b = a.useMemo(() => n.some(e => {
        let {
            item: t
        } = e;
        return (0, g.bF)(t.sku)
...
function q(e) {
    let {
        ...
        isGift: !0,
        giftRecipient: t
    }), h = (m ? c : 0) > 0 ? U.intl.string(U.t["7lZ31J"]) : U.intl.string(U.t.BCi1gT), [I, C] = a.useState("Nitro"), g = a.useRef(null), S = a.useRef(null), k = (0, d.bG)([f.A], () => f.A.useReducedMotion), T = a.useRef(!1), E = a.useCallback(e => {
        C(e), T.current = !0;
        let i = g.current;
...
function ee(e) {
    let {
        ...
        claimableRewards: m
    } = (0, h.Pv)(), p = null != m && m.length > 0, g = a.useCallback(e => {
        (0, C.A)({
            isGift: !0,
            giftRecipient: t,
            giftingOrigin: _,
    ...
    }, [t, _, n, l, d, c, i]), S = a.useRef(!1);
    a.useEffect(() => {
        S.current || (S.current = !0, G.default.track(F.HAw.GIFT_SELECTION_MODAL_OPENED, {
            gift_recipient_id: t?.id,
            location_stack: n
        }))
    }, [t, n]);
