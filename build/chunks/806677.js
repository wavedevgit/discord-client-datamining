...
function $(e) {
    ...
    return a.shouldShow ? (0, W.Qc)(a) ? (0, s.jsx)(_.m, {
        text: a.title,
        position: "top",
        asContainer: !0,
        delay: w.Zh,
...
function Y(e) {
    ...
    } = e, h = (0, T.GG)("gift_selection_modal_wishlist_section"), I = (0, P.tx)(t), C = K.intl.formatToPlainString(_ >= 12 ? K.t.Y2RFOQ : K.t.dIDKgi, {
        username: I
    }), {
        analyticsLocations: x
    } = (0, p.Ay)(...f ?? [], m.A.GIFT_SELECTION_MODAL_WISHLIST), k = (0, W.bc)(a, t), [L, j] = n.useState(!1), E = n.useCallback(e => {
        e && !c && a.length > 0 && (R.default.track(U.HAw.IMPRESSION_GIFT_SELECTION_WISHLIST_SECTION_VIEWED, {
            ...
            product_lines: Array.from(new Set(a.map(e => {
                let {
                    item: t
                } = e;
    ...
    }, [c, a, t.id, x]), A = (0, o.K)(E, void 0, !c && !L), w = n.useMemo(() => a.some(e => {
        let {
            item: t
        } = e;
        return (0, g.bF)(t.sku)
...
function ee(e) {
    let {
        ...
        defaultWishlistId: _,
        isWishlistLoaded: m
    } = e, p = null != (0, d.bG)([x.A], () => x.A.getFirstWishlistId(t.id)) && (!m || c > 0), h = K.intl.string(K.t["7lZ31J"]), [I, C] = n.useState("Nitro"), g = n.useRef(null), S = n.useRef(null), L = (0, d.bG)([f.A], () => f.A.useReducedMotion), j = n.useRef(!1), E = n.useCallback(e => {
        C(e), j.current = !0;
        let i = g.current;
...
function es(e) {
    ...
    return (0, A.T)("gift_selection_modal_wishlist_section") ? (0, s.jsx)(ei, {
        giftRecipient: t,
        onClose: i,
        nitroSection: n,
        analyticsLocations: r
...
function en(e) {
    let {
        ...
        claimableRewards: m
    } = (0, h.Pv)(), p = null != m && m.length > 0, g = n.useCallback(e => {
        (0, C.A)({
            isGift: !0,
            giftRecipient: t,
            giftingOrigin: _,
    ...
    }, [t, _, a, o, d, c, i]), S = n.useRef(!1);
    n.useEffect(() => {
        S.current || (S.current = !0, R.default.track(U.HAw.GIFT_SELECTION_MODAL_OPENED, {
            gift_recipient_id: t?.id,
            location_stack: a
        }))
    }, [t, a]);
