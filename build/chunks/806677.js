...
function J(e) {
    let {
        ...
        return t
    })), [i]), m = (0, d.bG)([M.A, H.A], () => H.A.getChannel(M.A.getChannelId())), p = _ > i.length ? _ - i.length + 1 : void 0;
...
function $(e) {
    ...
    } = e, h = (0, A.GG)("gift_selection_modal_wishlist_section"), I = (0, W.tx)(t), C = B.intl.formatToPlainString(_ >= 12 ? B.t.Y2RFOQ : B.t.dIDKgi, {
        username: I
    }), {
        analyticsLocations: x
    } = (0, p.Ay)(...f ?? [], m.A.GIFT_SELECTION_MODAL_WISHLIST), k = (0, y.bc)(n, t), [E, L] = a.useState(!1), j = a.useCallback(e => {
    ...
    }, [c, n, t.id, x]), T = (0, l.K)(j, void 0, !c && !E), b = a.useMemo(() => n.some(e => {
        let {
            item: t
        } = e;
        return (0, g.bF)(t.sku)
...
function q(e) {
    let {
        ...
        defaultWishlistId: _,
        isWishlistLoaded: m
    } = e, p = null != (0, d.bG)([x.A], () => x.A.getFirstWishlistId(t.id)) && (!m || c > 0), h = B.intl.string(B.t["7lZ31J"]), [I, C] = a.useState("Nitro"), g = a.useRef(null), S = a.useRef(null), E = (0, d.bG)([f.A], () => f.A.useReducedMotion), L = a.useRef(!1), j = a.useCallback(e => {
        C(e), L.current = !0;
        let i = g.current;
