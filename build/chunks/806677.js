...
function V(e) {
    ...
    return r.shouldShow ? (0, v.Qc)(r) ? (0, a.jsx)(_.m, {
        text: r.title,
        position: "top",
        asContainer: !0,
        delay: T.Zh,
...
function q(e) {
    let {
        ...
        return t
    })), [i]), m = (0, d.bG)([W.A, M.A], () => M.A.getChannel(W.A.getChannelId()));
...
function J(e) {
    ...
    } = e, h = (0, w.G)("gift_selection_modal_wishlist_section"), I = (0, G.tx)(t), g = B.intl.formatToPlainString(_ >= 12 ? B.t.Y2RFOQ : B.t.dIDKgi, {
        username: I
    }), {
        analyticsLocations: C
    } = (0, p.Ay)(...f ?? [], m.A.GIFT_SELECTION_MODAL_WISHLIST), S = (0, v.bc)(r, t), [x, L] = s.useState(!1), E = s.useCallback(e => {
        e && !c && r.length > 0 && (H.default.track(F.HAw.IMPRESSION_GIFT_SELECTION_WISHLIST_SECTION_VIEWED, {
    ...
    }, [c, r, t.id, C]), k = (0, o.K)(E, void 0, !c && !x);
    return (0, a.jsxs)("div", {
        ref: k,
        className: K.jf,
...
function Y(e) {
    let {
        ...
        claimableRewards: w
    } = (0, h.Pv)(), T = null != w && w.length > 0, A = null != (0, d.bG)([C.A], () => C.A.getFirstWishlistId(t.id)) && (!E || x > 0), b = B.intl.string(B.t["7lZ31J"]), [j, O] = s.useState("Nitro"), y = s.useRef(null), N = s.useRef(null), v = (0, d.bG)([f.A], () => f.A.useReducedMotion), M = s.useRef(!1), W = s.useRef(!1);
    s.useEffect(() => {
        E && !W.current && (W.current = !0, H.default.track(F.HAw.GIFT_SELECTION_MODAL_OPENED, {
            gift_recipient_id: t.id,
...
function et(e) {
    let {
        ...
        giftMessage: l,
        giftingOrigin: d = D.vQ.DM_CHANNEL
    } = e, c = (0, k.T)("gift_selection_modal_wishlist_section");
