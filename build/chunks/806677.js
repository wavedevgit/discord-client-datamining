...
function O(e) {
    ...
    } = e, p = (0, b.tx)(i), u = k.intl.formatToPlainString(k.t.Y2RFOQ, {
        username: p
    }), {
        analyticsLocations: m
    } = (0, f.Ay)(...c ?? [], _.A.GIFT_SELECTION_MODAL_WISHLIST), C = (0, S.bc)(n, i);
    return (0, a.jsxs)("div", {
        className: y.jf,
        children: [(0, a.jsxs)("div", {
            ...
            children: n.map((e, t) => {
                ...
                return c.shouldShow ? (0, S.Qc)(c) ? (0, a.jsx)(d.m, {
                    text: c.title,
                    position: "top",
                    asContainer: !0,
                    delay: g.Zh,
...
function M(e) {
    ...
    }), L = "loading" !== M.status && j > 0, G = k.intl.formatToPlainString(k.t.cu96mS, {
        count: j
    }), [E, P] = r.useState("Nitro"), R = r.useRef(null), Q = r.useRef(null), B = (0, n.bG)([c.A], () => c.A.useReducedMotion), W = r.useCallback(() => {
