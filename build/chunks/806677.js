...
function L(e) {
    let {
        ...
        isLoading: p
    } = e, u = (0, A.tx)(i), m = y.intl.formatToPlainString(y.t.Y2RFOQ, {
        username: u
    }), {
        analyticsLocations: C
    } = (0, f.Ay)(..._ ?? [], c.A.GIFT_SELECTION_MODAL_WISHLIST), h = (0, j.bc)(n, i);
    return (0, a.jsxs)("div", {
        className: H.jf,
        children: [(0, a.jsxs)("div", {
            ...
            children: p ? Array.from({
            ...
            }, `placeholder-${i}`)) : n.map((e, t) => {
                let {
                    item: s,
                    source: n
                } = e, _ = h[t], c = (0, a.jsx)(x.A, {
                    item: s,
                    profileOwner: i,
                    wishlistId: l,
                    isOwner: !1,
                ...
                return _.shouldShow ? (0, j.Qc)(_) ? (0, a.jsx)(d.m, {
                    text: _.title,
                    position: "top",
                    asContainer: !0,
                    delay: b.Zh,
...
function G(e) {
    ...
    }), G = null != (0, n.bG)([C.A], () => C.A.getFirstWishlistId(i.id)), E = "loading" !== M.status, P = G && (!E || A > 0), R = y.intl.string(y.t["7lZ31J"]), [Q, W] = r.useState("Nitro"), B = r.useRef(null), D = r.useRef(null), U = (0, n.bG)([_.A], () => _.A.useReducedMotion), F = r.useCallback(() => {
        t(), (0, h.openUserProfileModal)({
            userId: i.id,
            tabSection: k.RP.WISHLIST
        })
    }, [i.id, t]);
    r.useEffect(() => {
        "Nitro" === Q ? B.current?.scrollTo({
            top: 0,
    ...
    return (0, a.jsx)(s.dWK, {
        ...
        children: (0, a.jsxs)("div", {
            ...
            children: [(0, a.jsx)(s.rQ0, {
                title: y.intl.string(y.t["wg/30i"])
            }), P && (0, a.jsx)("div", {
                className: H.CE,
