...
function Z(e) {
    ...
    } = e, u = a.useMemo(() => new Set(i.map(e => {
        let {
            source: i
        } = e;
        return i
    })), [i]), m = (0, _.bG)([H.A, N.A], () => N.A.getChannel(H.A.getChannelId())), p = l > i.length ? l - i.length + 1 : void 0, f = a.useCallback(() => {
        s?.(), (0, d.s7G)()
    }, [s]);
    return (0, b.T)({
        ...
        children: i.map((e, a) => {
            ...
            return null != s.sku && (0, r.jsx)(T.dB, {
                newValue: {
                    positionInSection: a,
                    skuId: s.skuId,
...
function K(e) {
    ...
    } = e, I = (0, O.tx)(i), C = 0 === m ? B.intl.string(B.t.BCi1gT) : m >= 12 ? B.intl.formatToPlainString(B.t.Y2RFOQ, {
        username: I
    }) : B.intl.formatToPlainString(B.t.dIDKgi, {
        username: I
    }), {
        analyticsLocations: S
    } = (0, f.Ay)(...h ?? [], p.A.GIFT_SELECTION_MODAL_WISHLIST), b = (0, u.A)(() => (0, s.A)()), [k, L] = a.useState(!1), w = a.useCallback(e => {
        e && !d && o.length > 0 && (v.default.track(y.HAw.IMPRESSION_GIFT_SELECTION_WISHLIST_SECTION_VIEWED, {
    ...
    }, [d, o, i.id, S]), A = (0, l.K)(w, void 0, !d && !k), j = a.useMemo(() => o.some(e => {
        let {
            item: i
        } = e;
        return (0, g.bF)(i.sku)
    ...
    return (0, r.jsxs)("div", {
        ...
        children: [(0, r.jsx)("div", {
            ...
            className: F.KN,
            children: d ? (0, r.jsx)(U, {}) : (0, r.jsx)(T.dB, {
                newValue: {
...
function V(e) {
    let {
        ...
        isGift: !0,
        giftRecipient: i
    }), h = (p ? l : 0) > 0 ? B.intl.string(B.t["7lZ31J"]) : B.intl.string(B.t.BCi1gT), [I, C] = a.useState("Nitro"), g = a.useRef(null), x = a.useRef(null), T = (0, _.bG)([m.A], () => m.A.useReducedMotion), b = a.useRef(!1), L = a.useCallback(e => {
        C(e), b.current = !0;
        let t = g.current;
...
function J(e) {
    ...
    }, [i, u, o, s, l, _, t]), x = a.useRef(!1);
    a.useEffect(() => {
        x.current || (x.current = !0, v.default.track(y.HAw.GIFT_SELECTION_MODAL_OPENED, {
            gift_recipient_id: i?.id,
            location_stack: o
        }))
    }, [i, o]);
    ...
    return (0, r.jsx)(c.dWK, {
        ...
        children: (0, r.jsxs)("div", {
            className: F.jE,
            children: [(0, r.jsx)(c.rQ0, {
                title: B.intl.string(B.t["wg/30i"])
            }), null != i ? (0, r.jsx)(X, {
                giftRecipient: i,
                onClose: t,
                nitroSection: S,
