...
function J(e) {
    ...
    return n.shouldShow ? (0, H.Qc)(n) ? (0, r.jsx)(_.m, {
        text: n.title,
        position: "top",
        asContainer: !0,
        delay: b.Zh,
...
function q(e) {
    ...
    } = e, h = (0, A.GG)("gift_selection_modal_wishlist_section"), I = (0, P.tx)(t), C = Z.intl.formatToPlainString(_ >= 12 ? Z.t.Y2RFOQ : Z.t.dIDKgi, {
        username: I
    }), {
        analyticsLocations: x
    } = (0, p.Ay)(...f ?? [], m.A.GIFT_SELECTION_MODAL_WISHLIST), k = (0, H.bc)(n, t), [E, L] = s.useState(!1), j = s.useCallback(e => {
        e && !c && n.length > 0 && (W.default.track(Q.HAw.IMPRESSION_GIFT_SELECTION_WISHLIST_SECTION_VIEWED, {
    ...
    }, [c, n, t.id, x]), T = (0, l.K)(j, void 0, !c && !E), b = s.useMemo(() => n.some(e => {
        let {
            item: t
        } = e;
        return (0, g.bF)(t.sku)
...
function Y(e) {
    let {
        ...
        defaultWishlistId: _,
        isWishlistLoaded: m
    } = e, p = null != (0, d.bG)([x.A], () => x.A.getFirstWishlistId(t.id)) && (!m || c > 0), h = Z.intl.string(Z.t["7lZ31J"]), [I, C] = s.useState("Nitro"), g = s.useRef(null), S = s.useRef(null), E = (0, d.bG)([f.A], () => f.A.useReducedMotion), L = s.useRef(!1), j = s.useCallback(e => {
        C(e), L.current = !0;
        let i = g.current;
...
function et(e) {
    let {
        ...
        claimableRewards: m
    } = (0, h.Pv)(), p = null != m && m.length > 0, g = s.useCallback(e => {
        (0, C.A)({
            isGift: !0,
            giftRecipient: t,
            giftingOrigin: _,
    ...
    }, [t, _, n, l, d, c, i]), S = s.useRef(!1);
    s.useEffect(() => {
        S.current || (S.current = !0, W.default.track(Q.HAw.GIFT_SELECTION_MODAL_OPENED, {
            gift_recipient_id: t?.id,
            location_stack: n
        }))
    }, [t, n]);
    ...
    return (0, r.jsx)(o.dWK, {
        ...
        children: (0, r.jsxs)("div", {
            ...
            children: [(0, r.jsx)(o.rQ0, {
                title: Z.intl.string(Z.t["wg/30i"])
            }), null != t ? (0, r.jsx)(ee, {
                giftRecipient: t,
                onClose: i,
                nitroSection: x,
