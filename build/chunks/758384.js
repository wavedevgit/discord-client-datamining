...
var i = a(627968),
    ...
    E = a(985018),
    A = a(22061);
let N = (n = window.GLOBAL_ENV.INVITE_HOST, s = "", null == n && (n = location.host, s = f.BVt.INVITE("")), `${location.protocol}//${n}${s}/`);
...
function h(e) {
    let {
        ...
        onConnect: n,
        isSlideReady: s
    } = e, [f, h] = l.useState(""), [b, x] = l.useState(!1), [T, C] = l.useState(null), j = l.useRef(null);
    l.useEffect(() => {
        s && j.current?.focus()
    }, [s]);
