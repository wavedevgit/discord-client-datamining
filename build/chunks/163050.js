/** chunk id: 163050, original params: e,t,s (module,exports,require) **/
s.d(t, {
    A: () => k
});
var r = s(627968),
...
class j extends n.PureComponent {
    ...
    constructor(e) {
        super(e);
        const t = this.props.location?.search != null && "" !== this.props.location.search ? (0, l.parse)(this.props.location.search) : null;
        this.state = {
            method: "",
            password: "",
            code: "",
    ...
    handleTokenSubmitMFAv2 = async (e, t) => {
        ...
        if (0 === l.length) return d.h.dispatch({
            type: "LOGIN_RESET"
        }), Promise.reject();
        let o = a;
        if (null != s && (o = (0, p.A)(s)), null == o) return d.h.dispatch({
            type: "LOGIN_RESET"
        }), Promise.reject();
        this.setState({
            working: !0
        ...
        try {
            let s = await u.A.resetPasswordMFAv2({
                method: e,
                code: t,
                ticket: r,
                password: l,
    ...
    renderPasswordReset() {
        let {
            ...
            theme: i,
            authBoxClassName: l
        } = this.props, o = t ?? this.renderError("password");
        return (0, r.jsxs)(C.Ay, {
            ...
            children: [(0, r.jsx)("img", {
                alt: "",
                src: null == o ? s(79418) : s(579656),
                className: N.SX
            }), (0, r.jsx)(C.hE, {
                children: y.intl.string(y.t["1LV6Kq"])
            }), (0, r.jsxs)(C.eB, {
                className: N.QX,
                children: [(0, r.jsx)(C.pd, {
                    label: y.intl.string(y.t["8dM4FO"]),
                    className: N.SX,
                    name: "password",
                    value: e,
