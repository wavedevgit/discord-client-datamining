...
function E(e) {
    let {
        ...
        duration: x,
        onClick: S
    }), w = i.useMemo(() => null == I || null == y ? null : (0, a.rB)((0, a.hc)(I, y, x)), [I, y, x]), O = i.useMemo(() => {
    ...
    return (0, r.jsxs)("div", {
        ...
        children: [(0, r.jsxs)(o.DUT, {
            ...
            }, `${e.start}:${e.size}`)), !E && null != M && M > 0 && (0, r.jsx)("div", {
                className: l()(p.YK, P),
                style: {
                    width: null != M ? `${M}px` : "auto",
                    opacity: +(null != M)
                }
            }), (0, r.jsx)(o.iCB, {
                className: l()(p.qB, P),
