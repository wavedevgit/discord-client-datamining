/** chunk id: 997098, original params: e,t,l (module,exports,require) **/
l.d(t, {
    A: () => h
});
var n = l(627968),
...
let h = a.memo(function(e) {
    let {
        ...
        width: 0,
        height: 0
    }), v = a.useRef(null), j = a.useMemo(() => {
        let e = l?.duration ?? 1;
        return {
            fineTuning: -1,
            fineTuningResolution: e / m.Jh.fineTuningScale,
            duration: e,
            ...h ?? {}
        }
    }, [l, h]), p = (0, c.AX)(t), N = (0, c.$t)(p, v.current, j), b = (0, d.Ay)(), y = (0, o.rdh)(u.A.colors.ICON_STRONG).hex(), C = null == p || null == N, A = (0 === g.width || 0 === g.height || C) && null != t, w = a.useCallback(() => {
        null != v.current && x({
