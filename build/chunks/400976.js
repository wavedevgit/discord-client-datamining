...
function I(e) {
    ...
    switch (n) {
        ...
        case "video":
            ...
            o === p.UK.H264 ? I += ";level-asymmetry-allowed=1;packetization-mode=1;profile-level-id=42e01f" : o === p.UK.H265 && (I += ";level-id=180;profile-id=1;tier-flag=0;tx-mode=SRST"), v.fmtp.push({
                config: I,
                payload: l
            }), v.rtcpFb = [{
                type: "ccm",
        ...
        switch (e.outboundStreams.push({
            ...
            case "video":
                (t ? [p.UK.H265, p.UK.H264, p.UK.VP8, p.UK.VP9] : [p.UK.H264, p.UK.VP8, p.UK.VP9]).forEach((t, n) => {
                    let r = C(a, o, i, t, n);
                    null != r && e.codecs.push(r)
                }), "sendrecv" === l && (null != (r = null == s ? void 0 : s.find(e => "cname" === e.attribute)) && (e.videoSSRC = r.id), null != (r = null == s ? void 0 : s.findLast(e => "cname" === e.attribute)) && (r.id === e.videoSSRC && E.warn("Unable to find a unique rtx SSRC!"), e.rtxSSRC = r.id))
        }
        return e
    }, {
        outboundStreams: [],
