...
let y = l.memo(function(e) {
    ...
    return null == l && "VIDEO" === t.type ? (0, i.jsx)(d.A, {
        src: `${t.url}#t=1`,
        preload: "metadata",
        muted: !0,
        style: {
...
function w(e) {
    ...
    return l.useLayoutEffect(() => {
        ...
        null != c.current && null != e && c.current.scrollIntoViewNode({
            node: e,
            animate: !o.A.useReducedMotion,
            padding: 20
        })
    }, [n]), (0, i.jsx)("div", {
        className: a()(f.IL, d),
        children: (0, i.jsx)(s.ChK, {
            ...
            children: t.map((e, l) => {
                ...
                return (0, i.jsx)(s.DUT, {
                    ...
                    "aria-label": x.intl.formatToPlainString(d, {
                        pageNumber: l + 1,
                        totalPages: t.length
                    }),
                    onClick: () => r(l),
