/** chunk id: 787570 params = (module,exports,require) **/
i.d(e, {
    default: () => h
});
var n = i(284009),
...
class h {
    ...
    constructor({
        ...
        r()(null != c, "couldn't get canvas 2d context."), this.canvas = t, this.canvasContext = c, this.animation = null, this.dropped = !1, this.currentFrame = 0, this.currentFrameTime = 0, this.frameDuration = 1e3, this.animate = h, this.visible = s, this.requestAnimationFrameId = null, this.hasInitialFrame = !1, this.onInitialDraw = o, this.onError = l, this.key = `${e}:${t.width}:${t.height}`, a.A.create(this.key, t.width, t.height, i, n).then(t => {
    ...
    onInitialAnimationTick = t => {
        this.requestAnimationFrameId = null, (performance.now() - t < 30 || s) && this.draw(0) && (this.resumeAnimation(), this.onInitialDraw?.(), this.hasInitialFrame = !0), this.scheduleOrCancelTick()
    };
    onAnimationTick = t => {
        this.requestAnimationFrameId = null;
        let e = performance.now(),
            i = Math.floor(((s ? e : t) - this.currentFrameTime) / this.frameDuration);
        i > 0 && ((e - t < 12 || s) && (this.draw(this.currentFrame), this.currentFrame += i), this.currentFrameTime += i * this.frameDuration), this.scheduleOrCancelTick()
    };
    clear() {
