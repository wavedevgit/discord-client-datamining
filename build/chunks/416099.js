/** chunk id: 416099 params = (module,exports,require) **/
let _;
n.r(t), n.d(t, {
    HighlightConfig: () => r,
    default: () => H,
    ...
    return {
        ...
        "./arborium_host_bg.js": {
            ...
            __wbg_new_typed_aaaeaf29cf802876: function(e, t) {
                try {
                    ...
                    return new Promise((e, t) => {
                        ...
                        try {
                            var i, o, a, l;
                            return i = r, o = n.b, a = e, l = t, void _.wasm_bindgen__convert__closures_____invoke__hd4680ea21377bdcc(i, o, a, l)
                        } finally {
                            n.a = r
                        }
                    })
            ...
            __wbindgen_cast_0000000000000001: function(e, t) {
                var n, r, i, o;
                let a, l;
                return n = e, r = t, i = _.wasm_bindgen__closure__destroy__hf4b5e92d38978907, o = s, a = {
                    a: n,
                    b: r,
                    cnt: 1,
                    dtor: i
...
function g() {
    return (null === b || !0 === b.buffer.detached || void 0 === b.buffer.detached && b.buffer !== _.memory.buffer) && (b = new DataView(_.memory.buffer)), b
}

function d(e, t) {
    var n, _;
    return n = e >>>= 0, (x += _ = t) >= 0x7ff00000 && ((v = new TextDecoder("utf-8", {
        ignoreBOM: !0,
        fatal: !0
    })).decode(), x = _), v.decode(h().subarray(n, n + _))
}
let w = null;
...
function y(e, t, n) {
    if (void 0 === n) {
        let n = A.encode(e),
            _ = t(n.length, 1) >>> 0;
        return h().subarray(_, _ + n.length).set(n), W = n.length, _
    }
    let _ = e.length,
        r = t(_, 1) >>> 0,
        i = h(),
    ...
    if ("function" == typeof Response && e instanceof Response) {
        if ("function" == typeof WebAssembly.instantiateStreaming) try {
            ...
            if (e.ok && function(e) {
                    ...
                    return !1
                }(e.type) && "application/wasm" !== e.headers.get("Content-Type")) console.warn("`WebAssembly.instantiateStreaming` failed because your server does not serve Wasm with `application/wasm` MIME type. Falling back to `WebAssembly.instantiate` which is slower. Original error:\n", t);
            else throw t
        }
...
async function H(e) {
    ...
    void 0 !== e && (Object.getPrototypeOf(e) === Object.prototype ? {
        module_or_path: e
    } = e : console.warn("using deprecated parameters for the initialization function; pass a single object instead")), void 0 === e && (e = void 0);
    let t = l();
