/** chunk id: 142630, original params: e,i,t (module,exports,require) **/
t.d(i, {
    default: () => S
});
var n = t(627968),
...
function L(e) {
    switch (e) {
        ...
        case T.HL.GUILD_ICON:
            return {
                height: x.XAf, width: x.XAf
            };
        case T.HL.GUILD_BANNER:
            return {
                height: T.cN, width: T.Xb
            };
        case T.HL.SCHEDULED_EVENT_IMAGE:
            return {
                height: T.Wz, width: T.PU
            };
        case T.HL.HOME_HEADER:
            return {
                height: T.PS, width: T.CK
            };
        default:
            return (0, D.xb)(e)
    }
...
function G(e, i) {
    switch (i.type) {
        case "SET_DIMENSIONS":
            return {
                ...e, imageDimensions: i.imageDimensions, cropDimensions: i.cropDimensions, dragBoundaries: i.dragBoundaries
            };
        case "START_DRAGGING_IMAGE":
            return {
                ...e, startingCoordinates: i.startingCoordinates, isDragging: !0
            };
        case "STOP_DRAGGING_IMAGE":
            return {
                ...e, isDragging: !1, hasImageEdits: N({
        ...
        case "ROTATE_IMAGE":
            return {
                ...e, imageRotation: i.imageRotation, imageTransformCoordinates: i.imageTransformCoordinates, imageDimensions: i.imageDimensions ?? e.imageDimensions, cropDimensions: i.cropDimensions ?? e.cropDimensions, dragBoundaries: i.dragBoundaries ?? e.dragBoundaries, hasImageEdits: N({
                    zoomRatio: e.zoomRatio,
        ...
        case "SET_IMAGE_ZOOM_RATIO":
            return {
                ...e, imageTransformCoordinates: i.imageTransformCoordinates, zoomRatio: i.zoomRatio, dragBoundaries: i.dragBoundaries, hasImageEdits: N({
        ...
        case "RESET":
            return {
                ...e, zoomRatio: 1, imageRotation: 0, imageDimensions: i.imageDimensions ?? e.imageDimensions, cropDimensions: i.cropDimensions ?? e.cropDimensions, dragBoundaries: i.dragBoundaries ?? e.dragBoundaries, hasImageEdits: !1
            };
        default:
            return (0, D.xb)(i)
    }
...
function S(e) {
    let {
        ...
        analyticsPage: H
    } = e, B = r.useRef(y), v = r.useRef(null), M = r.useRef(null), [k, j] = r.useReducer(G, O), {
        cropDimensions: z,
        dragBoundaries: V,
        imageDimensions: U,
        imageRotation: $,
        ...
        isDragging: Q,
        hasImageEdits: X
    } = k, [K, W] = r.useState(!1), [Z, Y] = r.useState(!1), [J, q] = r.useState(0), {
        analyticsLocations: ee,
        newestAnalyticsLocation: ei
    } = (0, g.Ay)(m.A.IMAGE_CROPPING_MODAL), {
        isGIF: et,
        isCheckingAnimation: en,
        isEditableAnimatedImage: er
    } = (0, p._)(i), ea = Z || K || en;
    r.useEffect(() => {
        et && b && C.default.track(x.HAw.OPEN_MODAL, {
    ...
    let es = r.useCallback((e, i, t, n) => {
            B.current = (0, f.F3)(e, i, t), null != v.current && (v.current.style.transform = `translate3d(${B.current.x}px, ${B.current.y}px, 0) rotate(${n}deg)`)
        }, [v]),
        eo = r.useCallback(() => {
            ...
            let {
                ...
                width: t,
                height: n
            } = (0, f.Qx)(S, e, i), r = (0, f.Qp)(S, t, n, i), a = (0, f.l$)(t, n, r);
            j({
                type: "SET_DIMENSIONS",
                imageDimensions: {
                    width: t,
        ...
        ed = r.useCallback(e => {
            ...
            (0, o.inRange)(r, n.right, n.left) && (0, o.inRange)(a, n.top, n.bottom) || es(r, a, n, $), j({
        ...
        em = r.useCallback((e, i) => {
            let {
                ...
                width: r,
                height: a
            } = (0, f.Qx)(S, n, t), s = (0, f.Qp)(S, r, a, t), o = (0, f.l$)(r * i, a * i, s);
            return {
                newImageDimensions: {
                    width: r,
                    height: a
        ...
        eR = r.useCallback(async () => {
            ...
            if (er) try {
                ...
                throw M.current?.(), M.current = null, Error(`Error cropping animated image: ${e instanceof Error?e.toString():String(e)}`)
            } else e = (0, l.iL)({
                image: t,
                cropDimensions: z,
                cropOriginCoordinates: B.current,
    ...
    r.useEffect(() => (window.addEventListener("mouseup", eu), window.addEventListener("resize", eo), () => {
    ...
    return (0, n.jsx)(g.f5, {
        ...
        children: (0, n.jsxs)(c.Modal, {
            ...
            actions: [{
                text: I.intl.string(I.t["9TG40l"]),
                onClick: eC,
                variant: "secondary"
            }, {
                text: I.intl.string(I.t.ZSHmKD),
                onClick: eR,
                variant: "primary",
                loading: Z,
                disabled: ea
