...
function v() {
    let e = (0, c.yK)([I.A, g.A], () => C.default.keys(I.A.getFavoriteChannels()).map(e => g.A.getChannel(e)).filter(E.Vq)),
        t = e.map(e => e.id),
        ...
        r = (0, c.yK)([m.A], () => o().flatMap(s, e => m.A.getMutableParticipants(e, _.ip.SPEAKER).filter(e => e.type === _.wY.VOICE).map(e => {
            let {
                user: t
            } = e;
            return t
        ...
        O = T(u.Fzq, y.filter(e => null != e && !b.includes(e.id))),
        L = T(u.k9F, v);
