/** chunk id: 602461, original params: e,t,i (module,exports,require) **/
i.d(t, {
    A: () => c
}), i(321073);
var l = i(64700),
...
function c(e) {
    ...
    return l.useMemo(() => {
        let e = [];
        return !0 === t && e.push(r.intl.string(r.t.EhdV2x)), 0 !== d && e.push(r.intl.formatToPlainString(r.t["p/l+BI"], {
            channelCount: d
