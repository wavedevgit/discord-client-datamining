...
let a = () => (0, i.jsxs)(s.BJc, {
    ...
    children: [(0, i.jsx)(s.Text, {
        ...
        color: "text-subtle",
        children: r.intl.string(r.t["3zG2Y9"])
    }), (0, i.jsxs)(s.BJc, {
        gap: 16,
        children: [(0, i.jsxs)(s.BJc, {
            ...
            children: [(0, i.jsx)(s.Text, {
                ...
                children: r.intl.string(r.t.CfBo0z)
            }), (0, i.jsxs)("ul", {
                className: l.T,
                children: [(0, i.jsx)("li", {
                    children: (0, i.jsx)(s.Text, {
                        variant: "text-md/normal",
                        color: "text-subtle",
                        children: r.intl.string(r.t.ofQnNQ)
                    })
                }), (0, i.jsx)("li", {
                    children: (0, i.jsx)(s.Text, {
                        variant: "text-md/normal",
                        color: "text-subtle",
                        children: r.intl.string(r.t.dFaQGn)
                    })
                }), (0, i.jsx)("li", {
                    children: (0, i.jsx)(s.Text, {
                        variant: "text-md/normal",
                        color: "text-subtle",
                        children: r.intl.string(r.t.RVNwXh)
                    })
                })]
            })]
        }), (0, i.jsx)(s.Text, {
            variant: "text-md/normal",
            color: "text-subtle",
            children: r.intl.string(r.t.o5azXJ)
        }), (0, i.jsx)(s.Text, {
            variant: "text-md/normal",
            color: "text-subtle",
            children: r.intl.format(r.t.YETtaY, {
        ...
        children: [(0, i.jsx)(s.Text, {
            variant: "text-md/semibold",
            children: r.intl.string(r.t.FJh2zi)
        }), (0, i.jsx)(s.Text, {
            variant: "text-md/normal",
            color: "text-subtle",
            children: r.intl.format(r.t.R2Q57u, {
