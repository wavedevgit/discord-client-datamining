/** chunk id: 709808 params = (module,exports,require) **/
a.d(t, {
    B: () => N
});
var s = a(627968),
    ...
    render() {
        ...
        return null != t && (d = t.sort((e, t) => e.code < t.code ? -1 : +(e.code > t.code)).map(e => {
            ...
            return null == t ? null : (0, s.jsxs)("li", {
                className: (0, o.t)(_, "locale", null != l && e.code === l.code ? "Current" : null),
                onClick: i,
                children: [(0, s.jsx)("img", {
                    className: _.localeImage,
                    src: t,
                    alt: e.name
                }), e.name]
            }, e.code)
            ...
            children: [(0, s.jsxs)(n.s, {
                ...
                className: (0, o.t)(_, "localeList", e ? "Open" : "Closed"),
                children: d
            })]
        })
    }
