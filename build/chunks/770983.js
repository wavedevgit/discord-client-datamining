...
function R(e) {
    let {
        ...
        isLoading: u,
        recommendations: g
    } = e, x = (0, m.h)(b.XR), p = (0, o.bG)([_.default], () => _.default.getUser(t?.userId)), h = (0, j.G)("add_to_wishlist_grid"), A = l.useMemo(() => new Set(t?.items.map(e => e.skuId) ?? []), [t]), I = g.filter(e => !A.has(e.id)).slice(0, d);
