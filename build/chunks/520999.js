/** chunk id: 520999 params = (module,exports,require) **/
s.d(t, {
    A: () => _
});
var n = s(627968),
...
function _(e) {
    let {
        ...
        currentDeviceId: O,
        className: E
    } = e, v = (0, i.bG)([r.default], () => r.default.getCurrentUser()), [I, T] = l.useState(null), C = (0, p.A)(), S = c.Ay.canUseCustomBackgrounds(v);
    l.useEffect(() => {
        (0, d.HR)()
    }, []);
    ...
    let B = e => {
        h(e), (0, x.S1)(e, O, {
            ...
            T(N.intl.string(N.t.ejrSLe)), (0, x.S1)(null, O, {
                location: y.location
            })
        })
    };
            ...
            children: (0, n.jsx)(A.A, {
                ...
                onUpsellClick: () => {
                    (0, a.mMO)(async () => {
                        let {
                            default: e
                        } = await Promise.all([s.e("14138"), s.e("49924"), s.e("35817")]).then(s.bind(s, 210402));
                        return s => (0, n.jsx)(e, {
                            ...s,
                            onLearnMore: t,
                            analyticsSource: {
