...
function h(e) {
    let {
        ...
        currentDeviceId: O,
        className: _
    } = e, D = (0, l.bG)([r.default], () => r.default.getCurrentUser()), [I, C] = i.useState(null), T = (0, p.A)(), E = c.Ay.canUseCustomBackgrounds(D);
    i.useEffect(() => {
        (0, d.HR)()
    }, []);
    ...
    let P = e => {
        j(e), (0, x.S1)(e, O, {
            ...
            C(N.intl.string(N.t.ejrSLe)), (0, x.S1)(null, O, {
                location: U.location
            })
        })
    };
            ...
            children: (0, n.jsx)(g.A, {
                ...
                onUpsellClick: () => {
                    (0, a.mMO)(async () => {
                        let {
                            default: e
                        } = await Promise.all([s.e("14138"), s.e("49924"), s.e("42127")]).then(s.bind(s, 210402));
                        return s => (0, n.jsx)(e, {
                            ...s,
                            onLearnMore: t,
                            analyticsSource: {
