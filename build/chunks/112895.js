/** chunk id: 112895 params = (module,exports,require) **/
a.d(t, {
    A: () => A
});
var s = a(627968),
...
function A(e) {
    let {
        ...
        history: (0, i.W6)()
    }), g = l.useId(), T = () => u(), O = () => I(a), C = () => k ? u() : I(a), v = h && k ? (0, s.jsx)("ul", {
        className: _.Er,
        id: g,
        children: A.map(e => e.external ? (0, s.jsx)("li", {
            ...
            children: (0, s.jsx)(t, {
                ...
                className: _.qz,
                data: {
                    linkClicked: `mobile-${e.linkClicked}`
                },
                rel: "me",
                href: e.route,
                children: e.title
