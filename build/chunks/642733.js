/** Chunk was on web.js **/
/** chunk id: 642733, original params: e,t,n (module,exports,require) **/
"use strict";
n.d(t, {
    f: () => l
}), n(896048);
...
function l(e) {
    let {
        ...
        overflowOnly: f = !1,
        hideOnClick: p = !0
    } = e, _ = r.useRef(null), h = null != t ? t : _, [m, g] = r.useState(!1), E = r.useRef(null), y = r.useRef(!1);
    r.useEffect(() => (E.current = new a.Ep, () => {
        let e = E.current;
        null != e && e.stop()
    }), []);
    let b = null != h.current,
        O = !1 !== n && (m || d) && b && !y.current,
        v = r.useCallback(() => {
    ...
    return r.useEffect(() => {
        ...
        let n = null != (e = null == (t = h.current) ? void 0 : t.ownerDocument) ? e : document,
            r = e => {
                ("Escape" === e.key || "Esc" === e.key) && (y.current = !0, A())
            };
