...
function _(e) {
    ...
    return (0, i.jsxs)("div", {
        className: r()(x.vK, t.backgroundClass, {
            [x.lK]: !n
        }),
        children: [(0, i.jsx)("div", {
            className: x.Ot,
            children: t.roles.map((e, t) => (0, i.jsx)("div", {
                className: x.UK,
                children: e.map(e => (0, i.jsx)(h, {
                    color: e.color,
                    children: e.name
                }, e.name))
            }, t))
