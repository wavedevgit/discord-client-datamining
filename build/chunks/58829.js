/** chunk id: 58829 params = (module,exports,require) **/
t.d(e, {
    default: () => C
});
var l = t(627968);
...
function j(n) {
    ...
    }), o = (0, d.A)(a && s.enabled ? x.tX.filter(n => !t?.has(n) && (null == i || i.has(n))) : []), c = (0, m.gn)();
    return (0, l.jsxs)("div", {
        className: _.lA,
        children: [o.map(n => null != n && (0, l.jsx)(u.A, {
            application: n,
            className: _.W2,
            innerClassName: _.Uz
        }, n.id)), c.filter(n => !t?.has(n.type) && (null == i || i.has(n.type))).map(n => (0, l.jsx)(r.A, {
            type: n.type,
            className: _.W2,
            innerClassName: _.Uz,
            onConnect: () => e(n.type)
    ...
    return 0 === i.length ? null : (0, l.jsxs)(l.Fragment, {
        children: [(0, l.jsx)(o.Text, {
            ...
            children: i.map(n => {
                ...
                let i = e?.bot;
                return a()(null != i, "bot is null"), (0, l.jsxs)(o.DUT, {
                    onClick: () => t(e.id),
                    className: _.pW,
                    children: [(0, l.jsx)(c.A, {
                        ...
                        children: [(0, l.jsx)(o.Heading, {
                            ...
                            className: _.p4,
                            children: e.name
                        }), null != e.description && e.description.length > 0 ? (0, l.jsx)(o.Text, {
