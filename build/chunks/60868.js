/** chunk id: 60868 params = (module,exports,require) **/
n.d(t, {
    F: () => A,
    n: () => N
}), n(321073);
...
async function f(e, t, n) {
    ...
    if (null == l || !(null != l && l.features?.has(E.GuildFeatures.GUILD_ONBOARDING)) || (s.A.shouldFetchPrompts(e) && await (0, a.jx)(e), !(function(e) {
...
async function N(e, t, n) {
    ...
    let a = e.permissionOverwrites[u],
        ...
        o = {
            removingView: l.zy(t, E.xBc.VIEW_CHANNEL) && !l.zy(d, E.xBc.VIEW_CHANNEL),
            removingChat: !1
        };
    if (e.isForumLikeChannel() ? o.removingChat = l.zy(t, E.xBc.SEND_MESSAGES_IN_THREADS) && !l.zy(d, E.xBc.SEND_MESSAGES_IN_THREADS) : o.removingChat = l.zy(t, E.xBc.SEND_MESSAGES) && !l.zy(d, E.xBc.SEND_MESSAGES), !o.removingChat && !o.removingView) return !0;
    let A = s.A.isAdvancedMode(u);
    return !!await f(u, e.id, o) || (i.A.show({
        title: c.intl.string(c.t.ut7sq0),
        body: A ? c.intl.format(c.t.r0UjOO, {
            onClick: () => {
