...
let E = e => {
    let t, n, E, {
        ...
        {
            products: I
        } = (t = (0, u.A)(), n = l.useMemo(() => C ? [] : t(A.rankedSkuIds).filter(e => e.skuId !== A.rewardSkuId || null != L), [C, t, A.rankedSkuIds, L, A.rewardSkuId]), E = (0, d.p)()(n), {
            products: (0, g.X)(E)
        }),
