...
function j(e) {
    ...
    } = (0, l.Ay)([...E, L ? r.A.BLOCKED_PROFILE_MODAL : r.A.IGNORED_PROFILE_MODAL]), O = (0, u.pb)({
        layout: "MODAL_V2",
        userId: n.id,
        guildId: T,
        channelId: j,
    ...
    }], R = (0, p.Ay)(n.id, T), k = c.Ay.getName(R?.guildId, j, n), M = h.intl.formatToPlainString(h.t.KRe1Fk, {
        name: k
    });
    return (0, i.jsx)(l.f5, {
        value: P,
