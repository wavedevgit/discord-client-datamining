...
var s = n(627968),
    ...
    P = n(909340),
    y = n(455482);
let w = f.A.getArticleURL(v.MVz.ORBS_REWARDS_FAQ);

function T(e) {
    (0, j.o8)(e), window.open(w, "_blank")
}
let S = e => {
    let {
        className: t
    ...
    }), f = (0, u.A)("(min-width: 720px)"), w = (0, h.DP)(), S = a.useMemo(() => ({
        hueRotate: 25,
        glowAmount: (0, o.M)(w) ? 2 : 8,
        blurAmount: 10
    }), [w]);
    ...
    let O = function(e, t) {
        ...
        switch (n) {
            case x.L.ACTIVE:
                ...
                return {
                    displayTotalLifetimeRewards: null != l, displayProgressBar: !0, actionButton: (0, s.jsx)(d.$nd, {
                        text: D.intl.string(A.default.BxjHiu),
                        variant: t ? "overlay-primary" : "secondary",
                        onClick: () => {
                            (0, j.WD)(n), (0, _.pX)(E.BV.COLLECTIBLES_SHOP_WITH_TAB(N.G2.ORBS))
                        }
            ...
            case x.L.PAYMENT_PROCESSING:
                return {
                    displayTotalLifetimeRewards: !1, displayProgressBar: !1, actionButton: (0, s.jsx)(d.$nd, {
                        ...
                        variant: t ? "overlay-primary" : "secondary",
                        onClick: () => {
                            (0, j.CC)(n), (0, g.openUserSettings)(p.X.BILLING_PANEL)
                        }
            ...
            case x.L.PAYMENT_ERROR:
                return {
                    displayTotalLifetimeRewards: null != l, displayProgressBar: !1, actionButton: (0, s.jsx)(d.NPJ, {
                        ...
                        children: e => (0, s.jsx)("span", {
                            ...
                            children: (0, s.jsx)(d.$nd, {
                                ...
                                onClick: () => {
                                    (0, j.ue)(n), (0, g.openUserSettings)(p.X.BILLING_PANEL)
                                }
                            })
                        })
            ...
            case x.L.PROGRAM_ROLLBACK:
                return {
                    displayTotalLifetimeRewards: null != l, displayProgressBar: null != a, actionButton: (0, s.jsx)(d.$nd, {
            ...
            case x.L.PREMIUM_CHURNING:
                return {
                    displayTotalLifetimeRewards: null != l, displayProgressBar: null != a, actionButton: (0, s.jsx)(d.$nd, {
                        ...
                        icon: d.tvc,
                        onClick: () => {
                            (0, j.Jv)(n), (0, g.openUserSettings)(p.X.SUBSCRIPTIONS_PANEL)
                        }
        ...
        children: (0, s.jsxs)(R.A, {
            ...
            children: [(0, s.jsx)(m.A, {
                ...
                children: [(0, s.jsx)(d.NPJ, {
                    ...
                    className: I.L$
                }), M && l.total_rewarded_from_program > 0 && (0, s.jsxs)("div", {
                    className: I.fB,
