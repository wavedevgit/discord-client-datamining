    ...
    let w = function(e, t) {
        ...
        switch (a) {
            case f.L.ACTIVE:
                ...
                return {
                    displayTotalLifetimeRewards: null != s, displayProgressBar: !0, actionButton: (0, n.jsx)(d.$nd, {
                    ...
                    }), headerText: T.intl.format(S.default.BxLJQL, {
                        days: Math.max(1, r),
                        orbsCount: e.reward_amount
                    }), subheaderText: T.intl.format(S.default.tUV1vV, {
                        helpdeskArticle: () => j(a)
                    })
                };
            case f.L.PAYMENT_PROCESSING:
                return {
                    ...
                    }), headerText: T.intl.string(S.default.uuZJXR), subheaderText: T.intl.format(S.default.dkeEV7, {
                        helpdeskArticle: () => j(a)
                    })
                };
            case f.L.PAYMENT_ERROR:
                return {
                    displayTotalLifetimeRewards: null != s, displayProgressBar: !1, actionButton: (0, n.jsx)(d.NPJ, {
                    ...
                    }), headerText: T.intl.string(S.default["+O9Asn"]), subheaderText: T.intl.format(S.default.nWKEBZ, {
                        helpdeskArticle: () => j(a)
                    })
                };
            case f.L.PROGRAM_ROLLBACK:
                return {
                    displayTotalLifetimeRewards: null != s, displayProgressBar: null != r, actionButton: (0, n.jsx)(d.$nd, {
                        text: T.intl.string(S.default["wLAd/+"]),
                        variant: t ? "overlay-primary" : "secondary",
                        onClick: () => {
                            (0, x.WD)(a), (0, A.pX)(I.BV.COLLECTIBLES_SHOP_WITH_TAB(N.G2.ORBS))
                        }
                    }), headerText: T.intl.string(S.default.zF0HnJ), subheaderText: T.intl.format(S.default["5tzNTa"], {
                        helpdeskArticle: () => j(a)
                    })
                };
            case f.L.PREMIUM_CHURNING:
                return {
                    ...
                    }), headerText: T.intl.string(S.default.ISnOet), subheaderText: T.intl.format(S.default["vjaRZ/"], {
                        helpdeskArticle: () => j(a)
                    })
                };
            default:
        ...
        children: (0, n.jsxs)(R.A, {
            ...
            children: [(0, n.jsx)(p.A, {
                ...
                children: [(0, n.jsx)(d.NPJ, {
                    ...
                    className: P.L$
                }), L && s.total_rewarded_from_program > 0 && (0, n.jsxs)("div", {
                    className: P.fB,
