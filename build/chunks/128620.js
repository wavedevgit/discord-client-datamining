...
let O = e => {
    ...
    }), x = (0, u.A)("(min-width: 720px)"), T = (0, m.DP)(), O = n.useMemo(() => ({
        hueRotate: 25,
    ...
    let D = function(e, t) {
        ...
        switch (r) {
            case p.L.ACTIVE:
                ...
                return {
                    displayTotalLifetimeRewards: null != i, displayProgressBar: !0, actionButton: (0, a.jsx)(o.$nd, {
                        text: I.intl.string(j.default.BxjHiu),
                        variant: t ? "overlay-primary" : "secondary",
                        onClick: () => {
                            (0, A.WD)(r), (0, b.pX)(N.BV.COLLECTIBLES_SHOP_WITH_TAB(E.G2.ORBS))
                        }
                    }), headerText: I.intl.format(j.default.BxLJQL, {
                        days: Math.max(1, n),
                        orbsCount: e.reward_amount
                    }), subheaderText: I.intl.format(j.default.tUV1vV, {
                        helpdeskArticle: () => w(r)
                    })
                };
            case p.L.PAYMENT_PROCESSING:
                return {
                    ...
                    }), headerText: I.intl.string(j.default.uuZJXR), subheaderText: I.intl.format(j.default.dkeEV7, {
                        helpdeskArticle: () => w(r)
                    })
                };
            case p.L.PAYMENT_ERROR:
                return {
                    displayTotalLifetimeRewards: null != i, displayProgressBar: !1, actionButton: (0, a.jsx)(o.NPJ, {
                    ...
                    }), headerText: I.intl.string(j.default["+O9Asn"]), subheaderText: I.intl.format(j.default.nWKEBZ, {
                        helpdeskArticle: () => w(r)
                    })
                };
            case p.L.PROGRAM_ROLLBACK:
                return {
                    displayTotalLifetimeRewards: null != i, displayProgressBar: null != n, actionButton: (0, a.jsx)(o.$nd, {
                        text: I.intl.string(j.default["wLAd/+"]),
                        variant: t ? "overlay-primary" : "secondary",
                        onClick: () => {
                            (0, A.WD)(r), (0, b.pX)(N.BV.COLLECTIBLES_SHOP_WITH_TAB(E.G2.ORBS))
                        }
                    }), headerText: I.intl.string(j.default.zF0HnJ), subheaderText: I.intl.format(j.default["5tzNTa"], {
                        helpdeskArticle: () => w(r)
                    })
                };
            case p.L.PREMIUM_CHURNING:
                return {
                    ...
                    }), headerText: I.intl.string(j.default.ISnOet), subheaderText: I.intl.format(j.default["vjaRZ/"], {
                        helpdeskArticle: () => w(r)
                    })
                };
            default:
        ...
        children: (0, a.jsxs)(C.A, {
            ...
            children: [(0, a.jsx)(_.A, {
                ...
                children: [(0, a.jsx)(o.NPJ, {
                    ...
                    className: y.L$
                }), M && i.total_rewarded_from_program > 0 && (0, a.jsxs)("div", {
                    className: y.fB,
