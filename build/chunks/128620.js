...
let O = e => {
    ...
    }), x = (0, u.A)("(min-width: 720px)"), S = (0, m.DP)(), O = a.useMemo(() => ({
        hueRotate: 25,
        glowAmount: (0, o.M)(S) ? 2 : 8,
        blurAmount: 10
    }), [S]);
    ...
    let M = function(e, t) {
        ...
        switch (r) {
            case p.L.ACTIVE:
                ...
                return {
                    displayTotalLifetimeRewards: null != i, displayProgressBar: !0, actionButton: (0, n.jsx)(d.$nd, {
            ...
            case p.L.PAYMENT_ERROR:
                return {
                    displayTotalLifetimeRewards: null != i, displayProgressBar: !1, actionButton: (0, n.jsx)(d.NPJ, {
            ...
            case p.L.PROGRAM_ROLLBACK:
                return {
                    displayTotalLifetimeRewards: null != i, displayProgressBar: null != a, actionButton: (0, n.jsx)(d.$nd, {
