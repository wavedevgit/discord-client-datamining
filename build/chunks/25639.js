...
var l, i = n(311907),
    ...
    s = n(967198),
    r = n(977997),
    o = ((l = {}).GENTLE_AMBIENT = "GENTLE_AMBIENT", l.GENTLE_AMBIENT_WITH_INTRO = "GENTLE_AMBIENT_WITH_INTRO", l.HIGH_CONTRAST = "HIGH_CONTRAST", l);
let u = {},
    c = {},
    d = null;
...
let N = new p(a.h, {
        VOICE_STATE_UPDATES: function(e) {
            ...
            n !== d && null != n && (d = n);
            let l = {};
            for (let e of t) e.guildId === n && (null != e.oldChannelId && (l[e.oldChannelId] = (l[e.oldChannelId] ?? 0) - 1), null != e.channelId && (l[e.channelId] = (l[e.channelId] ?? 0) + 1));
            let i = !1;
            for (let [e, t] of Object.entries(l))(function(e, t) {
                ...
                return 0 === l && i > 0 ? (u[e] = {
                    ...
                    style: "HIGH_CONTRAST",
                    userCount: i
                }, g(e), !0) : 0 === i ? (h(e), delete u[e], !0) : null != n && i !== l && (u[e] = {
                    ...n,
                    userCount: i
                }, !0)
            })(e, t) && (i = !0);
        ...
        CHANNEL_SELECT: function(e) {
            ...
            for (let [e, t] of Object.entries(l)) t > 0 && (u[e] = {
                style: "GENTLE_AMBIENT",
                userCount: t
            });
            return !0
