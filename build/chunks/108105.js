...
function $(e) {
    ...
    return null == n ? null : null != s && null != l ? (0, a.jsxs)("div", {
        className: V.TS,
...
function z(e) {
    ...
    return (l.useEffect(() => {
        let [e, a] = function(e, t, n) {
            ...
            for (let s of e) {
                ...
                null != e && (a.push(s), e.mime_type.startsWith("video/") ? l.push({
                    ...
                    thumbnailSrc: null != s.thumbnailAssetId ? (0, S.YE)(t, s.thumbnailAssetId, 112, "webp") : void 0,
                    backgroundSrc: null != s.backgroundAssetId ? (0, S.YE)(t, s.backgroundAssetId, F.B, I.pV) : void 0
                }) : l.push({
                    type: "image",
        ...
        d(e), _(a)
    }, [t, s, n]), 0 === u.length) ? null : (0, a.jsx)(F.A, {
        className: V.Dk,
        items: u,
        onItemChange: m,
        isMuted: r,
...
function Z(e) {
    let {
        ...
        guildId: O
    } = (0, I.nG)(r), U = (0, c.bG)([E.default], () => E.default.getId());
    l.useEffect(() => {
    ...
    (0, v.pE)(), (0, _.Ay)(() => {
        N.default.track(q.HAw.OPEN_MODAL, {
            location_stack: R,
            type: Y.Nh,
            sku_id: s,
            application_id: r
    ...
    let es = w?.logoAssetId != null ? (0, S.YE)(r, w.logoAssetId, 75) : null,
        ...
        er = null;
    return er = D ? es ?? ei : ei ?? es, (0, a.jsx)(d.EOs, {
        transitionState: t,
        "hide-shadow": !0,
