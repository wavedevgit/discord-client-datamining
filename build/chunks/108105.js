...
function F(e) {
    ...
    } = e, _ = t?.id, m = (0, d.bG)([y.A], () => null != _ ? y.A.getNormalizedSKUEligibility(_) : void 0, [_]), b = (0, N.A)(), p = l.useCallback(() => {
    ...
    }, [t, i, n, o]), g = l.useCallback(() => {
        (0, S.X)({
            guildId: n
        })
    }, [n]), f = l.useCallback(() => {
        i(w.Jq.VISIT_SHOP), (0, S.default)({
            guildId: n
        }), s()
    }, [n, s, i]), C = l.useCallback(() => {
    ...
    return (0, a.jsxs)("div", {
        ...
        children: [(0, a.jsxs)("div", {
            ...
            children: [(0, a.jsx)(c.Heading, {
                ...
                color: "text-strong",
                children: x
            }), null != t.orbsReward && t.orbsReward > 0 && (0, a.jsx)(u.A, {
                variant: "standard",
...
function G(e) {
    ...
    return (l.useEffect(() => {
        let [e, a] = function(e, t, n) {
            ...
            for (let r of e) {
                ...
                null != e && (a.push(r), e.mime_type.startsWith("video/") ? l.push({
                    ...
                    thumbnailSrc: null != r.thumbnailAssetId ? (0, j.YE)(t, r.thumbnailAssetId, 112, "webp") : void 0,
                    backgroundSrc: null != r.backgroundAssetId ? (0, j.YE)(t, r.backgroundAssetId, U.B, k.pV) : void 0
                }) : l.push({
                    type: "image",
        ...
        c(e), _(a)
    }, [t, r.assets, n]), 0 === u.length) ? null : (0, a.jsx)(U.A, {
        className: M.Dk,
        items: u,
        onItemChange: m,
        isMuted: i,
...
function Y(e) {
    ...
    } = (0, b.Ay)(v ?? []), R = (0, d.bG)([y.A], () => y.A.getStorefrontData(u), [u]), U = (0, d.bG)([A.A], () => A.A.isFetchingForSKU(r)), D = (0, c.Mwr)((0, m.Ay)()), [Y, X] = l.useState(!0), q = (0, d.bG)([x.A], () => x.A.get(r)), [W, $] = l.useState(null), z = function(e, t) {
    ...
    let Q = l.useCallback(() => {
            null != q && (J(w.Jq.FORWARD_BUTTON), (0, P.d)({
                sku: q,
                guildId: u,
    ...
    let ee = null != R.storefront.logoAssetId ? (0, j.YE)(R.storefront.applicationId, R.storefront.logoAssetId, 75) : null,
        et = null != R.storefront.lightThemeLogoAssetId ? (0, j.YE)(R.storefront.applicationId, R.storefront.lightThemeLogoAssetId, 75) : null,
        en = null;
    return en = D ? ee ?? et : et ?? ee, (0, a.jsx)(c.EOs, {
        transitionState: t,
        "hide-shadow": !0,
