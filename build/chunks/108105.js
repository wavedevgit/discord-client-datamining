...
function F(e) {
    ...
    } = e, u = t?.id, _ = (0, c.bG)([E.A], () => null != u ? E.A.getNormalizedSKUEligibility(u) : void 0, [u]), m = (0, y.B)(), b = a.useCallback(() => {
        null != t && (i(U.Jq.BUY_BUTTON), (0, R.a)(t, {
            isGift: !1
        }, {
            analyticsLocations: [...o, h.A.SLAYER_STOREFRONT_PRODUCT_DETAILS_MODAL_PURCHASE_BUTTON],
            guildId: n
        }))
    }, [t, i, n, o]), p = a.useCallback(() => {
        (0, S.X)({
            guildId: n
        })
    }, [n]), g = a.useCallback(() => {
        i(U.Jq.VISIT_SHOP), (0, S.default)({
            guildId: n
        }), s()
    }, [n, s, i]), f = a.useCallback(() => {
        null != t && (i(U.Jq.GIFT_BUTTON), (0, R.a)(t, {
            isGift: !0
        }, {
    ...
    return (0, l.jsxs)("div", {
        ...
        children: [(0, l.jsxs)("div", {
            ...
            children: [(0, l.jsx)(d.Heading, {
                ...
                color: "text-strong",
                children: x
            }), null != t.orbsReward && t.orbsReward > 0 && (0, l.jsx)(q, {
...
function G(e) {
    ...
    return (a.useEffect(() => {
        let [e, l] = function(e, t, n) {
            ...
            for (let r of e) {
                ...
                null != e && (l.push(r), e.mime_type.startsWith("video/") ? a.push({
                    ...
                    backgroundSrc: null != r.backgroundAssetId ? (0, j.YE)(t, r.backgroundAssetId, w.B, k.pV) : void 0
                }) : a.push({
                    type: "image",
        ...
        d(e), _(l)
    }, [t, r.assets, n]), 0 === u.length) ? null : (0, l.jsx)(w.A, {
        className: M.Dk,
        items: u,
        onItemChange: m,
        isMuted: i,
...
function V(e) {
    ...
    } = (0, b.Ay)(v ?? []), R = (0, c.bG)([E.A], () => E.A.getStorefrontData(u), [u]), w = (0, c.bG)([A.A], () => A.A.isFetchingForSKU(r)), D = (0, d.Mwr)((0, m.Ay)()), [V, q] = a.useState(!0), X = (0, c.bG)([C.A], () => C.A.get(r)), [W, $] = a.useState(null), z = function(e, t) {
    ...
    let Q = a.useCallback(() => {
            null != X && (J(U.Jq.FORWARD_BUTTON), (0, P.d)({
                sku: X,
                guildId: u,
    ...
    let ee = null != R.storefront.logoAssetId ? (0, j.YE)(R.storefront.applicationId, R.storefront.logoAssetId, 75) : null,
        ...
        en = null;
    return en = D ? ee ?? et : et ?? ee, (0, l.jsx)(d.EOs, {
        transitionState: t,
        "hide-shadow": !0,
