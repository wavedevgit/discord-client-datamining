...
function K(e, t, n) {
    ...
    for (let s of e) {
        ...
        null != e && (l.push(s), e.mime_type.startsWith("video/") ? a.push({
            type: "video",
            ...
            backgroundSrc: null != s.backgroundAssetId ? (0, k.YE)(t, s.backgroundAssetId, G.B, I.pV) : void 0
        }) : a.push({
            type: "image",
...
function Q(e) {
    let {
        ...
        sku: t,
        priceSetAssignmentPurchaseType: J.lid.DEFAULT
    });
    return null == n ? null : null != s && null != a ? (0, l.jsxs)("div", {
        className: z.TS,
...
function Z(e) {
    ...
    }), x = (0, c.bG)([y.A], () => null != _ ? y.A.getNormalizedSKUEligibility(_) : void 0, [_]), p = (0, L.B)(), g = (0, O.R)({
        location: "product_details_modal"
    }), C = (0, b.JL)({
        sku: t,
        priceSetAssignmentPurchaseType: J.lid.DEFAULT
    ...
    let A = (0, f.h)(t?.applicationId),
        v = a.useCallback(() => {
            null != t && null != n && (o(q.Jq.BUY_BUTTON), (0, H.a)(t, {
                isGift: !1
            }, {
        ...
        S = a.useCallback(() => {
            null != n && (o(q.Jq.VISIT_SHOP), (0, d.s7G)(), (0, P.default)({
                guildId: n
            }))
        }, [n, o]),
        k = a.useCallback(() => {
            null != t && (o(q.Jq.GIFT_BUTTON), (0, H.a)(t, {
                isGift: !0,
                giftRecipient: i,
                giftingOrigin: r
            }, {
    ...
    return null == t ? null : (0, l.jsxs)("div", {
        className: z.wt,
        children: [t.exclusive && (0, l.jsx)("div", {
            className: z.K3,
            ...
            className: z.sj,
            children: [m && (0, l.jsx)(Y.V, {}), (0, l.jsx)(Q, {
                sku: t
            }), null != t.orbsReward && t.orbsReward > 0 && (0, l.jsx)(es, {
            ...
            children: [!x && (0, l.jsx)(d.Text, {
                ...
                fullWidth: !0
            }), g && x && null != C && (0, l.jsx)(d.Button, {
                icon: d.Cp8,
                variant: "secondary",
                onClick: I,
                text: V.intl.format(V.t.lOtBOI, {
                    orbPrice: C.amount,
                    orbIconHook: () => (0, l.jsx)(d.Cp8, {
                        size: "xs",
                        color: "currentColor"
                    }, "orbs-icon")
                }),
...
function ee(e) {
    ...
    return (a.useEffect(() => {
        ...
        d(e), _(l)
    }, [t, s, n]), 0 === u.length) ? null : (0, l.jsx)(G.A, {
        className: z.Dk,
        items: u,
        onItemChange: m,
        isMuted: r,
...
function ea(e) {
    let {
        ...
        guildId: T
    } = (0, I.nG)(i), R = (0, c.bG)([v.default], () => v.default.getId());
    a.useEffect(() => {
    ...
    let O = (0, c.bG)([y.A], () => y.A.getStorefrontMetadata(i), [i]),
        ...
        Y = $(i, H);
    (0, A.pE)(), (0, _.Ay)(() => {
        S.default.track(J.HAw.OPEN_MODAL, {
            location_stack: j,
            type: X.Nh,
            sku_id: s,
            application_id: i
    ...
    let K = a.useCallback(() => {
            null != M && null != T && (G(q.Jq.FORWARD_BUTTON), (0, B.d)({
                sku: M,
                guildId: T,
    ...
    let ea = O?.logoAssetId != null ? (0, k.YE)(i, O.logoAssetId, 75) : null,
        ...
        ei = null;
    return ei = P ? ea ?? es : es ?? ea, (0, l.jsx)(d.EOs, {
        transitionState: t,
        "hide-shadow": !0,
