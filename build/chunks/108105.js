...
function M(e) {
    ...
    return (l.useEffect(() => {
        ...
        c(e), _(a)
    }, [t, s, n]), 0 === u.length) ? null : (0, a.jsx)(R.A, {
        className: D.Dk,
        items: u,
        onItemChange: m,
        isMuted: r,
...
function G(e) {
    ...
    let et = l.useCallback(() => {
            null != J && null != W && (ee(O.Jq.FORWARD_BUTTON), (0, k.d)({
                sku: J,
                guildId: W,
    ...
    let el = Y?.storefront,
        ...
        er = null;
    return er = V ? es ?? ei : ei ?? es, (0, a.jsx)(c.EOs, {
        transitionState: t,
        "hide-shadow": !0,
