...
function F(e) {
    ...
    } = e, u = t?.id, _ = (0, d.bG)([N.A], () => null != u ? N.A.getNormalizedSKUEligibility(u) : void 0, [u]), m = (0, S.B)(), p = l.useCallback(() => {
        null != t && (i(w.Jq.BUY_BUTTON), (0, R.a)(t, {
            isGift: !1
        }, {
            analyticsLocations: [...o, h.A.SLAYER_STOREFRONT_PRODUCT_DETAILS_MODAL_PURCHASE_BUTTON],
            guildId: n
        }))
    }, [t, i, n, o]), b = l.useCallback(() => {
        (0, k.X)({
            guildId: n
        })
    }, [n]), f = l.useCallback(() => {
        i(w.Jq.VISIT_SHOP), (0, k.default)({
            guildId: n
        }), r()
    }, [n, r, i]), g = l.useCallback(() => {
        null != t && (i(w.Jq.GIFT_BUTTON), (0, R.a)(t, {
            isGift: !0
        }, {
    ...
    return (0, a.jsxs)("div", {
        ...
        children: [(0, a.jsxs)("div", {
            ...
            children: [(0, a.jsx)(c.Heading, {
                ...
                color: "text-strong",
                children: C
            }), null != t.orbsReward && t.orbsReward > 0 && (0, a.jsx)(q, {
                timeRemaining: m ?? void 0,
                text: B.intl.format(B.t.d3njXi, {
...
function H(e) {
    let {
        ...
        isMuted: i,
        trackPDPClick: o
    } = e, [d, c] = l.useState([]), [u, _] = l.useState([]), m = l.useCallback(e => {
    ...
    return (l.useEffect(() => {
        let [e, a] = function(e, t, n) {
            ...
            for (let s of e) {
                ...
                null != e && (a.push(s), e.mime_type.startsWith("video/") ? l.push({
                    type: "video",
                    src: (0, E.YE)(t, e, U.B, "mp4"),
                    videoThumbnailSrc: (0, E.YE)(t, e, U.B, "webp"),
                    thumbnailSrc: null != s.thumbnailAssetId ? (0, E.YE)(t, s.thumbnailAssetId, 112, "webp") : void 0,
                    backgroundSrc: null != s.backgroundAssetId ? (0, E.YE)(t, s.backgroundAssetId, U.B, I.pV) : void 0
                }) : l.push({
                    type: "image",
        ...
        c(e), _(a)
    }, [t, s.assets, n]), 0 === u.length) ? null : (0, a.jsx)(U.A, {
        className: M.Dk,
        items: u,
        onItemChange: m,
        isMuted: i,
...
function Y(e) {
    let {
        ...
        guildId: u
    }), R = (0, d.bG)([x.A], () => x.A.isFetchingForSKU(s)), U = (0, c.Mwr)((0, m.Ay)()), [D, Y] = l.useState(!0), q = (0, d.bG)([C.A], () => C.A.get(s)), [X, V] = l.useState(null), $ = function(e, t) {
    ...
    let J = l.useCallback(() => {
            null != q && (z(w.Jq.FORWARD_BUTTON), (0, y.d)({
                sku: q,
                guildId: u,
    ...
    let Z = null != k.storefront.logoAssetId ? (0, E.YE)(k.storefront.applicationId, k.storefront.logoAssetId, 75) : null,
        ee = null != k.storefront.lightThemeLogoAssetId ? (0, E.YE)(k.storefront.applicationId, k.storefront.lightThemeLogoAssetId, 75) : null,
        et = null;
    return et = U ? Z ?? ee : ee ?? Z, (0, a.jsx)(c.EOs, {
        transitionState: t,
        "hide-shadow": !0,
