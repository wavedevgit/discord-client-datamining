...
function Y(e) {
    ...
    return (l.useEffect(() => {
        let [e, a] = function(e, t, n) {
            ...
            for (let i of e) {
                ...
                null != e && (a.push(i), e.mime_type.startsWith("video/") ? l.push({
                    ...
                    backgroundSrc: null != i.backgroundAssetId ? (0, j.YE)(t, i.backgroundAssetId, w.B, E.pV) : void 0
                }) : l.push({
                    type: "image",
        ...
        c(e), _(a)
    }, [t, i, n]), 0 === u.length) ? null : (0, a.jsx)(w.A, {
        className: H.Dk,
        items: u,
        onItemChange: m,
        isMuted: r,
...
function X(e) {
    let {
        ...
        guildId: P,
        application: w
    } = (0, E.nG)(r), G = (0, d.bG)([A.default], () => A.default.getId());
    l.useEffect(() => {
    ...
    let el = l.useCallback(() => {
            null != Z && null != P && (ea(D.Jq.FORWARD_BUTTON), (0, U.d)({
                sku: Z,
                guildId: P,
