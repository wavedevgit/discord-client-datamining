...
let U = () => {
    ...
    V = e => {
        let t, {
            ...
            a = (0, u.Ay)();
        if (s)
            if (n === R.PremiumTypes.TIER_0) return (0, i.jsx)(d.Heading, {
                variant: "display-md",
                className: P.dW,
                children: y.intl.string(y.t.tUbSDK)
            });
            else return (0, i.jsx)(d.Heading, {
                variant: "display-md",
                className: P.dW,
    ...
    B = e => {
        let t, {
            ...
            F = (0, u.Ay)(),
            z = (0, o.qB)(F),
            W = (0, r.bG)([h.default], () => h.default.getCurrentUser()),
        ...
        a ? ea.push({
            ...
            column1: (0, i.jsxs)(i.Fragment, {
                children: [X === R.pe.TIER_2 || el ? (0, i.jsx)(N.A, {
                    className: P.x6,
                    ...
                    subscriptionTier: R.pe.TIER_0,
                    showIcon: !1
                }), Q === R.PremiumTypes.TIER_2 || null != X ? null : (0, i.jsx)(f.A, {
                    className: P.x6,
                    subscriptionTier: R.pe.TIER_0
                })]
            }),
            column2: (0, i.jsxs)(i.Fragment, {
                children: [X === R.pe.TIER_0 ? (0, i.jsx)(N.A, {
                    className: P.x6,
                ...
                }), Q === R.PremiumTypes.TIER_0 || null != X ? null : (0, i.jsx)(f.A, {
                    className: P.x6,
                    subscriptionTier: R.pe.TIER_2
                })]
            }),
            ...
            withBottomBorderRadius: !0,
            buttonsRow: null == X
        }), t = L ? null : null != X || null != Q ? (0, i.jsx)(v.ir, {
        ...
        return (0, i.jsx)(m.f5, {
            ...
            children: (0, i.jsxs)("div", {
                ...
                children: [(0, i.jsx)(d.Heading, {
                    className: l()(P.Qw, P.__invalid_textColor),
                    variant: "heading-xxl/extrabold",
                    children: j ?? y.intl.string(y.t.FIbMh9)
                }), K && (0, i.jsx)(I.A, {
                    premiumGroupRole: W.premiumGroupRole,
                    className: P.vg
                }), (0, i.jsxs)("div", {
                    className: P.wY,
