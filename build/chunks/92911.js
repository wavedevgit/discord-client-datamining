/** chunk id: 92911 params = (module,exports,require) **/
"use strict";
n.d(t, {
    A: () => P
}), n(321073);
...
let k = "WELCOME_CHANNEL",
    ...
    P = e => {
        ...
        } = (0, u.bG)([C.A], () => C.A.getSettingsProps()), a = (0, u.bG)([_.A], () => _.A.useReducedMotion), [d, c] = s.useState(null), [g, x] = s.useState(!1), [A, p] = s.useState(!1), {
            description: f,
            channels: I,
            enabled: S
        } = l, G = e => {
