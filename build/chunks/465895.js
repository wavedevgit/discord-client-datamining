...
function k() {
    let [e, t] = i.useState([]), [n, s] = i.useState([]), [l, r] = i.useState(), [c, x] = i.useState(), [p, g] = i.useState([]), [b, S] = i.useState([]), [k, R] = i.useState(!0), [w, D] = i.useState(10080), [P, M] = i.useState([]), {
        entitlements: L,
    ...
    i.useEffect(() => {
        ...
        k && (R(!1), h.A.forceReset(), (0, u._D)(), T().then(e => {
