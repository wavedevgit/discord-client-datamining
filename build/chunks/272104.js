...
let h = e => {
    ...
    _ = e => {
        ...
        return (0, s.jsx)(a.d_W, {
            className: A.pf,
            children: p.map(e => (0, s.jsxs)(a.BJc, {
                gap: 4,
                children: [(0, s.jsx)(a.Text, {
                    variant: "text-md/medium",
                    children: e.header
                }), e.section === m.wn.PURCHASE && (0, s.jsxs)("div", {
                    className: A.VQ,
                    children: [(0, s.jsxs)(a.DUT, {
                        ...
                        children: [(0, s.jsx)(a.KTN, {
                            ...
                            children: null != n ? x.intl.string(x.t.CHf9iJ) : x.intl.string(x.t.PoWNfe)
                        })]
                    }), (0, s.jsxs)(a.DUT, {
                        className: A.H5,
                        onClick: o,
                    ...
                    className: A.p_,
                    children: e.items.filter(c.F).map(n => (0, s.jsx)(h, {
                        currentUser: t,
                        nameplate: n,
                        section: e.section,
                        canUsePremiumCollectibles: u,
                        isSelected: l?.skuId === n.skuId,
                        onClick: () => i(n)
                    }, n.skuId))
                })]
            }, e.section))
