...
function ej(e) {
    ...
    n.append("build_id", "8aa46c3955959773334aabea332dbd728c428de8"), n.append("rpc", String(t)), n.append("rpc_auth_token", ee), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
