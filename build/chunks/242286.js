...
function ej(e) {
    ...
    n.append("build_id", "0b7e4ce6b54b76b9818e14a5046a5cdfbd01661b"), n.append("rpc", String(t)), n.append("rpc_auth_token", ee), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
