...
function ej(e) {
    ...
    n.append("build_id", "03078e98a2b7ce66185a0d634bc586eae7a5f30b"), n.append("rpc", String(t)), n.append("rpc_auth_token", ee), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
