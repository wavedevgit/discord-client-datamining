...
function ej(e) {
    ...
    n.append("build_id", "2ef21e9b6d19187f8ca2a56d27729be6f54fa541"), n.append("rpc", String(t)), n.append("rpc_auth_token", ee), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
