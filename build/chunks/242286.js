...
function ej(e) {
    ...
    n.append("build_id", "184fedb27d29de3b2d1b914994df4527755a1777"), n.append("rpc", String(t)), n.append("rpc_auth_token", ee), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
