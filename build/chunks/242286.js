...
function ej(e) {
    ...
    n.append("build_id", "de692bed5dd48ef64e9421df9836014c809fa218"), n.append("rpc", String(t)), n.append("rpc_auth_token", ee), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
