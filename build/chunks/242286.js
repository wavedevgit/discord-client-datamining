...
function ej(e) {
    ...
    n.append("build_id", "25ca1a8a308213f9d04c27029a11d918387def9e"), n.append("rpc", String(t)), n.append("rpc_auth_token", ee), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
