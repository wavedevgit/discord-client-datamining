...
function ej(e) {
    ...
    n.append("build_id", "0ccfc592112c2864b59ff8628d994642f16ec3f1"), n.append("rpc", String(t)), n.append("rpc_auth_token", ee), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
