...
function ej(e) {
    ...
    n.append("build_id", "2cfdddd3312a85ab898a432de3ba3597ab28b7fe"), n.append("rpc", String(t)), n.append("rpc_auth_token", ee), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
