...
function eM(e) {
    ...
    n.append("build_id", "ce98d9412f411efcf5d8ea93bd131ab392999f8f"), n.append("rpc", String(t)), n.append("rpc_auth_token", ee), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
