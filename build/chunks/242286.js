...
function ej(e) {
    ...
    n.append("build_id", "b7f5c25039d16c9ecbfaa5d9f7413304396c0b19"), n.append("rpc", String(t)), n.append("rpc_auth_token", ee), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
