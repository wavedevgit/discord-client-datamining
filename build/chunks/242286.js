...
function ej(e) {
    ...
    n.append("build_id", "b9eb52206008a94760fd406fda23c9d8cbfe7f19"), n.append("rpc", String(t)), n.append("rpc_auth_token", ee), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
