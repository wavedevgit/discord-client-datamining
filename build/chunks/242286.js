...
function ej(e) {
    ...
    n.append("build_id", "0050a3e2bea56f360f5c7e9b57f58a0fa63c0017"), n.append("rpc", String(t)), n.append("rpc_auth_token", ee), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
