...
function ej(e) {
    ...
    n.append("build_id", "36e74132acc9068d9ee63eecd21807141f92d90f"), n.append("rpc", String(t)), n.append("rpc_auth_token", ee), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
