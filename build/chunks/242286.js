...
function ej(e) {
    ...
    n.append("build_id", "da45d08f5a4a146eded9c8870b2df07d94998c05"), n.append("rpc", String(t)), n.append("rpc_auth_token", ee), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
