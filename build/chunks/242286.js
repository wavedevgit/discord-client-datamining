...
function ej(e) {
    ...
    n.append("build_id", "5cf9334419b44565a4489791af58fd8fcdb000eb"), n.append("rpc", String(t)), n.append("rpc_auth_token", ee), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
