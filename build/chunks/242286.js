...
function ej(e) {
    ...
    n.append("build_id", "fa9b51eb358c8e5fc897833d3d4f3ecbf98c7f57"), n.append("rpc", String(t)), n.append("rpc_auth_token", ee), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
