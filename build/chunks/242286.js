...
function ej(e) {
    ...
    n.append("build_id", "50838473cda526e15c20b82a2f3608b360cd3081"), n.append("rpc", String(t)), n.append("rpc_auth_token", ee), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
