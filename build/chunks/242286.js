...
function ej(e) {
    ...
    n.append("build_id", "67343db9ac13d0762c50b8a3d7738dd043db84a6"), n.append("rpc", String(t)), n.append("rpc_auth_token", ee), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
