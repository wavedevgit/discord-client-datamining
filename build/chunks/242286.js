...
function ej(e) {
    ...
    n.append("build_id", "ac3bf990070deb1ee39a98cd3843dc9e32e134e1"), n.append("rpc", String(t)), n.append("rpc_auth_token", ee), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
