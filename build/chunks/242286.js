...
function ej(e) {
    ...
    n.append("build_id", "20b0c3b5f3543dc4526239c4ade996532a2c5a7b"), n.append("rpc", String(t)), n.append("rpc_auth_token", ee), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
