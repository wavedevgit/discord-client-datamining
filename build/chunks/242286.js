...
function ej(e) {
    ...
    n.append("build_id", "fc7879e5a74138964017813162726bdcc6a5ff9d"), n.append("rpc", String(t)), n.append("rpc_auth_token", ee), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
