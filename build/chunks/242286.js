...
function ej(e) {
    ...
    n.append("build_id", "c8e9dc30fffd17d8930ebe8acb0273ace7bd8a71"), n.append("rpc", String(t)), n.append("rpc_auth_token", ee), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
