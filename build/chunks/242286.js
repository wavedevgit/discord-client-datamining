...
function ej(e) {
    ...
    n.append("build_id", "b69529cc365353a2c4ee8779912bab6181134ae8"), n.append("rpc", String(t)), n.append("rpc_auth_token", ee), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
