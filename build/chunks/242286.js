...
function ej(e) {
    ...
    n.append("build_id", "aa9ac54174279aa526eeb45b6aa0954bf32965e4"), n.append("rpc", String(t)), n.append("rpc_auth_token", ee), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
