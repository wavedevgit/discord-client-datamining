...
function ej(e) {
    ...
    n.append("build_id", "02448cbf3a5b4a36c9464fb18ceddc273a0babce"), n.append("rpc", String(t)), n.append("rpc_auth_token", ee), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
