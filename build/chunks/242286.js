...
function ej(e) {
    ...
    n.append("build_id", "bd2df162914446006251ea18724213bd1906e2e2"), n.append("rpc", String(t)), n.append("rpc_auth_token", ee), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
