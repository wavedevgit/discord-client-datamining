...
function ej(e) {
    ...
    n.append("build_id", "ab0f42684b7ec1a1fde0066c55d8099e96b3fc6a"), n.append("rpc", String(t)), n.append("rpc_auth_token", ee), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
