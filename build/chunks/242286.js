...
function ej(e) {
    ...
    n.append("build_id", "9b4a4d9c942692c220666bd0ce8328e01cc3bd65"), n.append("rpc", String(t)), n.append("rpc_auth_token", ee), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
