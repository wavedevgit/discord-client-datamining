...
function ej(e) {
    ...
    n.append("build_id", "27cb660b69f7900e3509c6ad574449558aec241b"), n.append("rpc", String(t)), n.append("rpc_auth_token", ee), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
