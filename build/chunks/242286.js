...
function ej(e) {
    ...
    n.append("build_id", "d6b2797d3d11efee68dcc7624b354d0cb58bcad5"), n.append("rpc", String(t)), n.append("rpc_auth_token", ee), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
