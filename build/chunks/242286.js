...
function ej(e) {
    ...
    n.append("build_id", "20dc4253fa384fc4a478cd93db773b3392865b7c"), n.append("rpc", String(t)), n.append("rpc_auth_token", ee), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
