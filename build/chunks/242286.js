...
function ej(e) {
    ...
    n.append("build_id", "e81f4fbb043cb49d06339b7af0db15c7f22f9176"), n.append("rpc", String(t)), n.append("rpc_auth_token", ee), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
