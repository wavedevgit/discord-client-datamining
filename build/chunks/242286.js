...
function ej(e) {
    ...
    n.append("build_id", "c9722507610ae32188973169bad08dbffa354341"), n.append("rpc", String(t)), n.append("rpc_auth_token", ee), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
