...
function ej(e) {
    ...
    n.append("build_id", "c1455a4e0b6f4755b1e9e192494b032eadf704ab"), n.append("rpc", String(t)), n.append("rpc_auth_token", ee), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
