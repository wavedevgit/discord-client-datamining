...
function ej(e) {
    ...
    n.append("build_id", "bdad26403a31b6989bba31faed09f350f457379e"), n.append("rpc", String(t)), n.append("rpc_auth_token", ee), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
