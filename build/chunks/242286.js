...
function ej(e) {
    ...
    n.append("build_id", "cd1c9dba89740787bd4e9f9bb34cc4f12ba18657"), n.append("rpc", String(t)), n.append("rpc_auth_token", ee), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
