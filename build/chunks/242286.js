...
function ej(e) {
    ...
    n.append("build_id", "60f40b6d7c7510dc7888d747201a20a95174005a"), n.append("rpc", String(t)), n.append("rpc_auth_token", ee), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
