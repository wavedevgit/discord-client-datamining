...
function ej(e) {
    ...
    n.append("build_id", "dc9dc3dae02638e8ce104d309eabdd246966ccc2"), n.append("rpc", String(t)), n.append("rpc_auth_token", ee), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
