...
function ej(e) {
    ...
    n.append("build_id", "8ac0476ced30eb8a569cbdc0b4e833ab74b87045"), n.append("rpc", String(t)), n.append("rpc_auth_token", ee), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
