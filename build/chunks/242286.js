...
function ej(e) {
    ...
    n.append("build_id", "dfbe04ad89b485e8c5f2ad99ab82f02ba8049a1b"), n.append("rpc", String(t)), n.append("rpc_auth_token", ee), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
