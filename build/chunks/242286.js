...
function ej(e) {
    ...
    n.append("build_id", "b8003e8d7899a6e89554804e7f096c620978c652"), n.append("rpc", String(t)), n.append("rpc_auth_token", ee), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
