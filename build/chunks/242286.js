...
function ej(e) {
    ...
    n.append("build_id", "2861dc0b91bc84b1124f62a6a7d73d145a510f0f"), n.append("rpc", String(t)), n.append("rpc_auth_token", ee), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
