...
function ej(e) {
    ...
    n.append("build_id", "1983491cabdd7cbce94a49fa8bcde0c94da0aa8d"), n.append("rpc", String(t)), n.append("rpc_auth_token", ee), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
