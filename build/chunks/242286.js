...
function ej(e) {
    ...
    n.append("build_id", "7886312915a0de687d1818033d1ee44bce742eb9"), n.append("rpc", String(t)), n.append("rpc_auth_token", ee), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
