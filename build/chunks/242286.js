...
function ej(e) {
    ...
    n.append("build_id", "6eff3fdf0ae393bbff154a13ddeaa41501577b91"), n.append("rpc", String(t)), n.append("rpc_auth_token", ee), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
