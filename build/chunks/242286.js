...
function ej(e) {
    ...
    n.append("build_id", "10631f00eb2db7d9d3ea950e6f09d94343924dac"), n.append("rpc", String(t)), n.append("rpc_auth_token", ee), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
