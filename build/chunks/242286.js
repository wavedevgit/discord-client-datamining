...
function ej(e) {
    ...
    n.append("build_id", "a4ef34bc30ae01db22deb38ababf75df2e34ad26"), n.append("rpc", String(t)), n.append("rpc_auth_token", ee), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
