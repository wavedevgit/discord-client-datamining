...
function ej(e) {
    ...
    n.append("build_id", "d77950aa9cb5c275e4f235065a5cdcbe46de188f"), n.append("rpc", String(t)), n.append("rpc_auth_token", ee), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
