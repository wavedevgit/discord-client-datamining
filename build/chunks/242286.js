...
function ej(e) {
    ...
    n.append("build_id", "25be87f93717b0ef4a066548fd0a4966a047bff7"), n.append("rpc", String(t)), n.append("rpc_auth_token", ee), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
