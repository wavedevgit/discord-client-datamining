...
function ej(e) {
    ...
    n.append("build_id", "d569a39f7d581266625adc27e8fbc1bcc63156b5"), n.append("rpc", String(t)), n.append("rpc_auth_token", ee), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
