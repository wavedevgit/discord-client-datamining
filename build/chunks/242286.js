...
function ej(e) {
    ...
    n.append("build_id", "1e6bdc7e1ce123b2bb3661c34c8d144a0a45554a"), n.append("rpc", String(t)), n.append("rpc_auth_token", ee), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
