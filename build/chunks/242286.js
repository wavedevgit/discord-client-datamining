...
function ej(e) {
    ...
    n.append("build_id", "ae02a6eb9d7da4c08e92f77e0f991717aa02fd91"), n.append("rpc", String(t)), n.append("rpc_auth_token", ee), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
