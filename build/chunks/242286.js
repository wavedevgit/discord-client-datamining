...
function ej(e) {
    ...
    n.append("build_id", "072509de9f37103421d8c59fd60f24590dd271f2"), n.append("rpc", String(t)), n.append("rpc_auth_token", ee), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
