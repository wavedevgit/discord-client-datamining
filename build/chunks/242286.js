...
function ej(e) {
    ...
    n.append("build_id", "d5a337c99584e200426b57c959659ddc3c69d55d"), n.append("rpc", String(t)), n.append("rpc_auth_token", ee), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
