...
function ej(e) {
    ...
    n.append("build_id", "9f21d7ccb9b0a3ba1b1a8915a25ea21ca6f91335"), n.append("rpc", String(t)), n.append("rpc_auth_token", ee), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
