...
class en {
    ...
    constructor() {
        V(this, "isDispatching", !1), V(this, "timeout", void 0), V(this, "requestIdleCallback", void 0), V(this, "actionsToFlush", new Set), V(this, "waitingActionsToFlush", new Set), V(this, "flush", () => {
...
function ej(e) {
    ...
    n.append("build_id", "e0a023301e05f98bc1677a0693432db03452da1c"), n.append("rpc", String(t)), n.append("rpc_auth_token", ee), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
