...
function ej(e) {
    ...
    n.append("build_id", "b5b3dc980c0a6d94253e8af4a82f70d3b7bbbb66"), n.append("rpc", String(t)), n.append("rpc_auth_token", ee), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
