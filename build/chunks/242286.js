...
function ej(e) {
    ...
    n.append("build_id", "4c0bbfd408066f1833bad9628142e6fc8962210e"), n.append("rpc", String(t)), n.append("rpc_auth_token", ee), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
