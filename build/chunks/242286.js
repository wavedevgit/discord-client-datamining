...
function ej(e) {
    ...
    n.append("build_id", "bdc6a4fa0dc2cc42536a1df1eda7a47c3550fa27"), n.append("rpc", String(t)), n.append("rpc_auth_token", ee), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
