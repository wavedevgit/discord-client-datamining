...
function ej(e) {
    ...
    n.append("build_id", "fc125080a9922cf7c46352110ef059740309eded"), n.append("rpc", String(t)), n.append("rpc_auth_token", ee), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
