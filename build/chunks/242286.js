...
function ej(e) {
    ...
    n.append("build_id", "0885c8d9a66c113fe3e1a242fc7684454125c640"), n.append("rpc", String(t)), n.append("rpc_auth_token", ee), r = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
}
