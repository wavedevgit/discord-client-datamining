...
let C = e => {
    ...
    v = e => {
        let {
            teenId: t,
            readOnly: a = !1
        } = e, o = (0, h.y3)(), d = o?.restrictedSchedule?.rules ?? [], c = (0, g.I2)(d), [u, m] = s.useState(c.length > 0);
        s.useEffect(() => {
            c.length > 0 && m(!0)
        }, [c.length]);
        let _ = () => {
        ...
        return 0 === c.length ? (0, i.jsx)(C, {
            ...
            children: [(0, i.jsxs)(r.DUT, {
                ...
                children: [c.map(e => (0, i.jsx)(T.A, {
                    rule: e,
                    teenId: t,
                    readOnly: a
                }, e.ruleId)), (0, i.jsx)(l.BJc, {
    ...
    N = () => {
        ...
        return (0, i.jsxs)(l.BJc, {
                ...
                children: [(0, i.jsxs)(l.BJc, {
                    ...
                    children: [(0, i.jsx)(l.EYj, {
                        ...
                        children: E.intl.format(S.default.X9rW0j, {
                            openSettingsHook: (e, t) => (0, i.jsx)(r.MzZ, {
                                onClick: s,
                                children: e
                            }, t)
                        })
                    ...
                    text: E.intl.formatToPlainString(S.default.ggcjPR, {
                        count: e.length
                    }),
                    onClick: () => {
            ...
            }), n && t?.id != null && (0, i.jsxs)(i.Fragment, {
