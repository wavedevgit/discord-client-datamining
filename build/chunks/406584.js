/** chunk id: 406584 params = (module,exports,require) **/
n.d(t, {
    b: () => m
});
var i = n(64700),
...
let m = (0, a.Qx)(c.X.HIGH_DYNAMIC_RANGE, {
    ...
    useOptions: function() {
        return i.useMemo(() => [{
            name: u.intl.string(u.t.D5Fma9),
            desc: u.intl.string(u.t.Qj75ck),
            value: "no-limit"
        }, {
            name: u.intl.string(u.t.ldcGIH),
            desc: u.intl.string(u.t["+V/bDk"]),
            value: "standard"
        }], [])
    },
