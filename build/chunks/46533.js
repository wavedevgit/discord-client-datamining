...
class eh extends a.PureComponent {
    ...
    componentDidMount() {
        this.setAnimatedValue(0), A.h.subscribe("LAYER_PUSH", this.closeAllHeaderNotices), this.historyUnlisten = k.A.addRouteChangeListener(this.handleHistoryChange);
        let {
            location: e
        } = k.A.getHistory();
    ...
    handleContextMenu = e => {
        ...
        null != t && t.id !== eo.Vc && (0, h.L3)(e, async () => {
            let {
                default: e
    ...
    renderGuildHeaderUpsellPopout = e => {
        ...
        return null == t || null == n ? this.renderGuildHeaderDropdownButton(e) : (0, i.jsx)(en.A, {
            contentDescriptor: n,
            guild: t,
    ...
    setAnimatedValue(e) {
        let {
            guild: t
        } = this.props, n = null != this.getGuildBannerHash(), i = null != t && (0, J.A)(t);
    ...
    renderChannelList() {
        ...
        if (e || null == t) return (0, i.jsx)(ea.A, {
            withBannerPadding: null != t && null != this.getGuildBannerHash()
        });
        {
            if (t.features.has(el.GuildFeatures.HUB) && !a) return (0, i.jsx)("div", {
                className: ec.r0,
                children: (0, i.jsx)(R.A, {
                    guild: t,
                    channel: n ?? W.Ay.getDefaultChannel(t.id)
                })
            });
            ...
            return (0, i.jsx)(e, {
                ...
                onScroll: null != t && (null != this.getGuildBannerHash() || (0, J.A)(t)) ? this.pinBannerOrGuildInfo : null
            })
        }
    }
    render() {
        ...
        return (0, i.jsxs)("nav", {
            ...
            "aria-label": ed.intl.formatToPlainString(ed.t.nj5gAZ, {
                guildName: t ?? ""
            }),
            children: [null != e && this.renderGuildHeader(this.state.hasGuildSubheader), null != e && (0, i.jsx)(ei.A, {
                guild: e,
...
function e_(e) {
    let {
        ...
        selectedChannelId: l
    } = e, d = (0, N.$)("favorite-guild-header-context"), c = (0, s.bG)([K.A], () => K.A.getGuild(t)), A = (0, T.A)(t), h = (0, s.bG)([F.A], () => F.A.getGuildDimensions(t).scrollTo), C = (0, s.bG)([Q.A], () => Q.A.getChannelId()), b = (0, s.bG)([z.A], () => z.A.can(el.xBc.MANAGE_GUILD, c)), R = (0, s.bG)([Y.A], () => Y.A.isUnavailable(t)), k = (0, s.bG)([X.default], () => X.default.getCurrentUser()), {
        enableStudyGroup: V
    } = (0, L.y)(c), W = (0, E.Ay)(e => e.currentlyShown.has(o.M.NAGBAR_NOTICE_CONNECT_PLAYSTATION)), [J, ee] = a.useState(!W), et = (0, _.A)(t), {
        analyticsLocations: en
    } = (0, g.Ay)(m.A.GUILD_HEADER);
    a.useEffect(() => {
        t !== et && ee(!W)
    }, [t, et, W]);
    let [ei, ea] = (0, E.Ay)(e => [er.cA.some(t => e.currentlyShown.has(t.dismissibleContentType)), e.currentlyShownGroup.has(es.m.GUILD_HEADER_TOOLTIPS)], r.x), eo = (0, p.A)(c), ed = (0, u.red)(u.DXt), ec = (0, s.bG)([q.A], () => q.A.hasLayers()), eA = (0, P.xr)(e => e.fullScreenLayers.length > 0), e_ = (0, s.bG)([B.A], () => B.A.shouldShow(eu)), em = (0, y.A)(t), eg = c?.features.has(el.GuildFeatures.HUB) === !0, ep = b && c?.features.has(el.GuildFeatures.DISCOVERABLE) === !0, eE = (0, s.bG)([O.A, q.A], () => null != c && null != k && b && !q.A.hasLayers() && O.A.shouldShowGuildTemplateDirtyTooltip(t)), eI = (0, s.bG)([H.A], () => H.A.getChannel(l)), {
        isPopoutOpen: ef
    } = (0, S.S)(), eC = c?.features.has(el.GuildFeatures.COMMUNITY) ?? !1, eT = Z.Ay.isNewUser(k), eN = J && !eT;
    (0, x.A)(c);
    let eS = (0, I.JZ)(o.M.PREMIUM_TUTORIAL_SERVER_MENU_TOOLTIP),
        ...
        eL = (0, s.bG)([K.A], () => K.A.getGuild(t)?.features.has(el.GuildFeatures.GAME_SERVERS) ?? !1, [t]),
        eR = (0, G.A)(),
        eP = (0, j.A)(t),
        eD = !1 === eb && eR && null != eP,
        eM = (0, w.A)(t),
    ...
    let [eU, eG] = (0, f.kn)(ew, es.m.GUILD_HEADER_TOOLTIPS), ek = null == eU, [eV, eB] = (0, f.D8)(ek && eD ? o.M.BOOST_TO_UNLOCK_COACHMARK : null, t, {
        cooldownDurationMs: M.bW,
        numTimesToRecur: 5
    }, es.m.GUILD_HEADER_TOOLTIPS), [eH, eF] = (0, f.D8)(ek && eV !== o.M.BOOST_TO_UNLOCK_COACHMARK && ej ? o.M.EXPIRING_POWERUP_COACHMARK : null, t, {
        cooldownDurationMs: M.mD
    }, es.m.GUILD_HEADER_TOOLTIPS), eY = a.useMemo(() => null != eU ? {
        contentType: eU,
        data: null,
        markAsDismissed: eG
        ...
        markAsDismissed: eB
    } : eH === o.M.EXPIRING_POWERUP_COACHMARK && null != eM ? {
        contentType: eH,
        data: {
            featuredExpiringPowerup: eM
        },
        markAsDismissed: eF
    } : null, [eU, eV, eH, eP, eM, eG, eB, eF]);
    return (0, i.jsx)(eh, {
        guildId: t,
        hideSelectedChannel: n,
        guild: c,
