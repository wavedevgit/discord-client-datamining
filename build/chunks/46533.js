...
class em extends r.PureComponent {
    ...
    renderGuildHeaderNotices(e) {
        ...
        return n ? (0, i.jsx)("div", {
            ...
            children: [this.renderGuildHeaderDropdownButton(e), !e && !r && (0, i.jsx)(c.AM, {
        ...
        }) : r || e ? this.renderGuildHeaderDropdownButton(e) : a ? (0, i.jsxs)(i.Fragment, {
    ...
    setAnimatedValueForBanner = e => {
        ...
        (e >= 88 && i || e < 88 && !i) && (i = !i), (e >= 88 && !t || e < 88 && t) && (t = !t), r = Math.max(88 - e, 0), n = i, (t !== this.state.renderBanner || i !== this.state.bannerVisible || r !== this.state.bannerVisibleHeight || n !== this.state.communityInfoVisible) && this.setState({
            renderBanner: t,
            bannerVisible: i,
            bannerVisibleHeight: r,
            communityInfoVisible: n
    ...
    renderChannelList() {
        ...
        {
            if (t.features.has(eo.GuildFeatures.HUB) && !r) return (0, i.jsx)("div", {
                className: eA.r0,
...
function ep(e) {
    let {
        ...
        enableStudyGroup: H
    } = (0, L.y)(c), q = (0, E.Ay)(e => e.currentlyShown.has(o.M.NAGBAR_NOTICE_CONNECT_PLAYSTATION)), [et, en] = r.useState(!q), ei = (0, _.A)(t), {
        analyticsLocations: er
    } = (0, p.Ay)(m.A.GUILD_HEADER);
    r.useEffect(() => {
        t !== ei && en(!q)
    }, [t, ei, q]);
    let [ea, es] = (0, E.Ay)(e => [ed.cA.some(t => e.currentlyShown.has(t.dismissibleContentType)), e.currentlyShownGroup.has(ec.m.GUILD_HEADER_TOOLTIPS)], l.x), eu = (0, g.A)(c), eA = (0, u.red)(u.DXt), e_ = (0, s.bG)([$.A], () => $.A.hasLayers()), ep = (0, P.xr)(e => e.fullScreenLayers.length > 0), eg = (0, s.bG)([F.A], () => F.A.shouldShow(eh)), eE = (0, b.A)(t), eI = c?.features.has(eo.GuildFeatures.HUB) === !0, ef = y && c?.features.has(eo.GuildFeatures.DISCOVERABLE) === !0, eC = (0, s.bG)([O.A, $.A], () => null != c && null != B && y && !$.A.hasLayers() && O.A.shouldShowGuildTemplateDirtyTooltip(t)), eT = (0, s.bG)([Y.A], () => Y.A.getChannel(a)), {
        isPopoutOpen: eN
    ...
    }, ec.m.GUILD_HEADER_TOOLTIPS), e$ = r.useMemo(() => null != eH ? {
        contentType: eH,
        data: null,
        markAsDismissed: eF
