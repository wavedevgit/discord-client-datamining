...
let p = new Map,
    f = n.memo(function(e) {
        let {
            ...
            width: b,
            height: j
        } = (0, u.Ay)(), [C, N] = n.useState(null), k = (0, o.rdh)(r.A.colors.BACKGROUND_MOD_STRONG).hex();
        return (n.useEffect(() => (v.current = new Worker(new URL("/assets/" + l.u("33197"), l.b)), () => {
            v.current?.terminate()
        }), []), n.useEffect(() => {
            ...
            let a = v.current,
                ...
                i = t => {
                    ...
                    null != a ? d.nx.error("Failed to load waveform:", a) : (p.set(e, {
                        waveform: l
                    }), N(l))
                };
            return a.addEventListener("message", i), (async () => {
                try {
                    let e = (0, c.v)();
            ...
            let {
                width: l,
                height: a
            } = e, n = l / C.length, s = -(n * (m.Jh.waveformBarWidth - 1));
        ...
        }, [k, b, x, j, C]), 0 === s.length) ? null : (0, a.jsx)("div", {
            className: i()(h.k, g),
