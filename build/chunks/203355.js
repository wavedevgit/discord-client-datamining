...
function W(e) {
    let {
        ...
        user: Y,
        streamId: J
    } = t, q = (0, r.bG)([N.A], () => N.A.getChannel(z.channelId)), $ = (0, r.bG)([T.A], () => T.A.getActiveStreamForUser(Y.id, z.guildId), [Y.id, z.guildId]), Z = (0, r.bG)([T.A], () => T.A.getAllActiveStreams().length > 0), X = (0, r.bG)([b.A], () => b.A.isFocused()), Q = $?.ownerId === W, ee = Q && !X && p === A.N.NO_POPOUT, et = null != $ ? (0, E.A)($, Y, Y.id === W, ee) : null, en = x < 195;
    (0, h.Ay)(() => {
    ...
    if (t.type === w.lp.HIDDEN_STREAM) return (0, i.jsx)(O.A, {
        selected: n,
        participant: t,
        width: x
    });
    if (null != $ && !n && null != V && y.Ay.supports(G.O5.VIDEO)) return (0, i.jsxs)(i.Fragment, {
        children: [(0, i.jsx)(S.A, {
            ...
            videoComponent: V,
            fit: g,
            paused: k || $?.state === U.XYD.PAUSED || ee,
