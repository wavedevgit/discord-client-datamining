...
function K(e) {
    let {
        ...
        wrapperClassName: P,
        paused: w = !1
    } = e, V = y.Ay.getVideoComponent(), K = (0, r.bG)([v.default], () => v.default.getId()), W = (0, _.A)(), {
        stream: z,
        user: Y,
        streamId: q
    } = t, J = (0, r.bG)([N.A], () => N.A.getChannel(z.channelId)), $ = (0, r.bG)([T.A], () => T.A.getActiveStreamForUser(Y.id, z.guildId), [Y.id, z.guildId]), Z = (0, r.bG)([T.A], () => T.A.getAllActiveStreams().length > 0), X = (0, r.bG)([b.A], () => b.A.isFocused()), Q = $?.ownerId === K, ee = Q && !X && g === A.N.NO_POPOUT, et = null != $ ? (0, E.A)($, Y, Y.id === K, ee) : null, en = C < 195;
    (0, h.Ay)(() => {
