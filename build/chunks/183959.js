/** chunk id: 183959, original params: t,e,i (module,exports,require) **/
i.d(e, {
    A: () => n
});
var s = i(364298);
...
let n = class {
    ...
    constructor(t) {
        this.index = t, this.spring.tension = 150 * Math.max(.1, t / 7) + 150, this.count = -2.15 * t
    }
    updateStatic() {
    ...
    update(t) {
        ...
        if (this.speedUp > 0 ? (this.speedUp = Math.max(0, this.speedUp - t), this.count += t * (10 * Math.min(this.speedUp, 1) + .4)) : this.count += .4 * t, e = (0, s.J)(this.targetX, this.x, this.velX, this.spring), i = (0, s.J)(this.targetY, this.y, this.velY, this.spring), this.velX += e * t, this.velY += i * t, this.oscillate) {
            ...
            e = (0, s.J)(n, this.x, this.velX, this.spring), i = (0, s.J)(a, this.y, this.velY, this.spring), this.velX += e * t, this.velY += i * t
        }
