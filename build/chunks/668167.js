/** chunk id: 668167, original params: e,a,t (module,exports,require) **/
t.d(a, {
    Q: () => g
});
var r = t(908909),
...
function g(e, a, t) {
    ...
    let v = (0, o.Bi)(),
        ...
        B = F ? A.format("selectedDateDescription", {
            date: F
        }) : "",
        M = (0, u.I)(B),
        ...
        N = (0, p.useRef)(!1),
        {
            ...
            onBlurWithin: a => {
                ...
                if (!(null == t ? void 0 : t.contains(a.relatedTarget))) {
                    var r, n;
                    N.current = !1, null == (r = e.onBlur) || r.call(e, a), null == (n = e.onFocusChange) || n.call(e, !1)
                }
            },
            onFocusWithin: a => {
                if (!N.current) {
                    var t, r;
                    N.current = !0, null == (t = e.onFocus) || t.call(e, a), null == (r = e.onFocusChange) || r.call(e, !0)
                }
            }
        });
    return {
