...
let y = s.memo(s.forwardRef((e, t) => {
    ...
    } = (0, C.U)(!L), M = (0, o.bG)([g.A], () => g.A.affinities), U = !P && M.length > 0, k = (0, A.c)(r.C.MARKETING_PAGE_BANNER), w = null != k && "marketingPageBanner" === k.properties.properties.oneofKind, V = (0, _.ar)() && !w;
    return (0, i.jsx)(m.f5, {
        value: y,
