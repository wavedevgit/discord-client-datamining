...
let y = s.memo(s.forwardRef((e, t) => {
    ...
    } = (0, C.U)(!P), M = (0, o.bG)([_.A], () => _.A.affinities), U = !L && M.length > 0, k = (0, x.c)(r.C.MARKETING_PAGE_BANNER), w = null != k && "marketingPageBanner" === k.properties.properties.oneofKind, V = (0, g.ar)() && !w;
    return (0, i.jsx)(m.f5, {
        value: y,
