...
let O = s.memo(s.forwardRef((e, t) => {
    ...
    } = (0, N.U)(!D), M = (0, o.bG)([g.A], () => g.A.affinities), U = !P && M.length > 0, k = (0, h.c)(r.C.MARKETING_PAGE_BANNER), V = null != k && "marketingPageBanner" === k.properties.properties.oneofKind, w = (0, m.ar)() && !V;
    return (0, i.jsx)(_.f5, {
        value: O,
