...
let ey = e => {
        let {
            error: t,
            allowClick: n = !1
        } = e, r = (0, q.B1)(t)?.errorCode, l = em.intl.formatToPlainString(em.t.ejOT95, {
            errorCode: r
        }), s = (0, i.jsx)(_.Text, {
...
function eL(e) {
    let t, n, {
        ...
        {
            windowsMuteAndZeroVolumeDetectionEnabled: l
        } = (0, z.I)({
    ...
    return A && !0 === o ? (t = em.intl.string(em.t.ppW3ri), n = (0, i.jsx)(_.eCN, {
    ...
    })) : A && 0 === d ? (t = em.intl.string(em.t.j4gGA4), n = (0, i.jsx)(_.eCN, {
        href: ek(a),
        noticeType: r,
        children: em.intl.string(em.t.QghSIq)
    })) : eA.Ay.supports(eM.O5.LOOPBACK) ? (t = em.intl.string(em.t.dNAJ18), u = !0, n = (0, i.jsx)(_.zr9, {
        onClick: () => {
        ...
        children: [(0, i.jsx)(_.PMB, {
            ...
            allowClick: u,
            error: q.iy.NO_AUDIO_INPUT_DETECTED
        }), n]
    })
}
...
let eG = 21552 == n.j ? r.memo(function() {
    ...
    if (r.useEffect(() => {
            if (l?.type != null) {
                let e;
                if (null == E && (l.type === eP.kqX.PREMIUM_TIER_2_TRIAL_ENDING || l.type === eP.kqX.PREMIUM_TIER_0_TRIAL_ENDING)) return;
                let n = {};
                null != t && (n.guild_id = t), E?.trial_id != null && (n.trial_id = E.trial_id), e = {
                    notice_type: l.type,
                    ...n
                }, eO.default.track(eP.HAw.APP_NOTICE_VIEWED, e)
            }
        }, [l?.type, t, E]), r.useEffect(() => {
            if (null != l && l.type === eP.kqX.SURVEY && null != l.metadata) {
                let {
                    metadata: e
                } = l, t = X.A.getUserExperimentDescriptor(e.id);
    ...
    switch (l.type) {
        ...
        case eP.kqX.GENERIC:
            return (0, i.jsxs)(_.$Td, {
                ...
                children: [(0, i.jsx)(_.PMB, {
                    onClick: () => ex(),
                    noticeType: l.type
                }), l.message, null != l.buttonText ? (0, i.jsx)(_.Z_L, {
                    onClick: l.callback,
                    noticeType: l.type,
        ...
        case eP.kqX.VOICE_DISABLED:
            return (0, i.jsxs)(_.$Td, {
                ...
                children: [(0, i.jsx)(_.PMB, {
                    ...
                    noticeType: l.type
                }), em.intl.string(em.t.bOQ3jV), (0, i.jsx)(_.Z_L, {
                    onClick: () => {
        ...
        case eP.kqX.VOICE_CONNECTED_LAST_SESSION:
            return (0, i.jsxs)(_.$Td, {
                ...
                children: [(0, i.jsx)(_.PMB, {
                    ...
                    noticeType: l.type
                }), em.intl.string(em.t.jY2lUA), (0, i.jsx)(_.Z_L, {
                    onClick: () => {
        ...
        case eP.kqX.SPOTIFY_AUTO_PAUSED:
            ...
            return (0, i.jsxs)(_.$Td, {
                ...
                }), em.intl.string(em.t.D8Cp76), (0, i.jsx)(_.Z_L, {
                    onClick: () => (0, eE.openUserSettings)(eo.X.VOICE_AND_VIDEO_PANEL, {
                        section: eP.nc_.VOICE
                    }),
                    noticeType: l.type,
        ...
        case eP.kqX.UNCLAIMED_ACCOUNT:
            return (0, i.jsxs)(_.$Td, {
                color: _.Hv$.DEFAULT,
                children: [em.intl.string(em.t["f+Zaol"]), (0, i.jsx)(_.Z_L, {
                    noticeType: l.type,
        ...
        case eP.kqX.UNVERIFIED_ACCOUNT:
            return (0, i.jsxs)(_.$Td, {
                color: _.Hv$.DEFAULT,
                children: [em.intl.string(em.t["3sWbf3"]), (0, i.jsx)(_.Z_L, {
                    noticeType: l.type,
                    onClick: () => {
                        u.A.verifyResend(), d.A.show({
        ...
        case eP.kqX.SCHEDULED_MAINTENANCE:
            ...
            return (0, i.jsxs)(_.$Td, {
                color: _.Hv$.DEFAULT,
                children: [(0, i.jsx)(_.PMB, {
                    onClick: () => S.A.ackScheduledMaintenance(),
                    noticeType: l.type
                }), em.intl.format(em.t["yb96S+"], l.metadata), (0, i.jsx)(_.eCN, {
        ...
        case eP.kqX.HARDWARE_MUTE:
            ...
            if (Q.A.getConfig({
                ...
                color: _.Hv$.INFO,
                children: [em.intl.format(em.t.QMw8Fd, {}), (0, i.jsx)(_.PMB, {
                    noticeType: l.type,
                    onClick: () => {
                        A.A.setEnableHardwareMuteNotice(!1), ex()
                    }
        ...
        case eP.kqX.DETECTED_OFF_PLATFORM_PREMIUM_PERK:
            if (null == l.metadata) return null;
            let {
                skuId: ek, applicationId: eG
            } = l.metadata, ej = eN.A.get(ek), eq = y.A.getApplication(eG);
            if (null == ej || null == eq) return null;
            let eB = {
                page: eP.liQ.IN_APP
            };
            return (0, i.jsxs)(_.$Td, {
        ...
        case eP.kqX.DETECTED_OFF_PLATFORM_PREMIUM_PERK_UPSELL: {
            ...
            let {
                skuId: e,
                applicationId: t
            } = l.metadata, n = eN.A.get(e), r = y.A.getApplication(t);
        ...
        case eP.kqX.VIDEO_UNSUPPORTED_BROWSER:
            return (0, i.jsxs)(_.$Td, {
                ...
                }), em.intl.string(em.t.wVjKGi), (0, i.jsx)(_.Z_L, {
                    noticeType: eP.kqX.VIDEO_UNSUPPORTED_BROWSER,
                    onClick: () => {
                        (0, _.mMO)(async () => {
                            let {
        ...
        case eP.kqX.DISPATCH_ERROR:
            ...
            return (0, i.jsxs)(_.$Td, {
                ...
                }), eX?.displayMessage, (0, i.jsx)(_.Z_L, {
                    noticeType: eP.kqX.DISPATCH_ERROR,
        ...
        case eP.kqX.DISPATCH_INSTALL_SCRIPT_PROGRESS:
            ...
            return (0, i.jsxs)(_.$Td, {
                ...
                children: [(0, i.jsx)(_.PMB, {
                    ...
                    children: [null != eV ? em.intl.formatToPlainString(em.t["pHj+z4"], {
                        name: `${eV}`,
                        progress: eb,
                        total: ev
        ...
        case eP.kqX.APPLICATION_TEST_MODE:
            if (null == l.metadata) return null;
            if (null != eR.A.testModeEmbeddedApplicationId) return (0, i.jsx)(_.$Td, {
                color: _.Hv$.WARNING,
        ...
        case eP.kqX.PREMIUM_UNCANCEL:
            return (0, i.jsxs)(_.$Td, {
                color: z === eU.PremiumTypes.TIER_1 ? _.Hv$.PREMIUM_TIER_1 : z === eU.PremiumTypes.TIER_0 ? _.Hv$.PREMIUM_TIER_0 : _.Hv$.PREMIUM_TIER_2,
                children: [(0, i.jsx)(_.PMB, {
                    ...
                    color: "currentColor",
                    className: eh.PC
                }), z === eU.PremiumTypes.TIER_1 ? em.intl.formatToPlainString(em.t.fXv4wm, {
                    daysLeft: l.metadata.daysLeft
                }) : z === eU.PremiumTypes.TIER_0 ? em.intl.formatToPlainString(em.t.ZOHZMr, {
                    daysLeft: l.metadata.daysLeft
                    ...
                    children: z === eU.PremiumTypes.TIER_1 ? em.intl.string(em.t.BkbUPM) : z === eU.PremiumTypes.TIER_0 ? em.intl.string(em.t.Px978X) : em.intl.string(em.t.LW5tCE)
                })]
            });
        case eP.kqX.PREMIUM_PAST_DUE_ONE_TIME_PAYMENT:
            ...
            return (0, i.jsxs)(_.$Td, {
                ...
                children: [(0, i.jsx)(_.PMB, {
                    ...
                    onClick: () => {
                        ex(ew), (0, eE.openUserSettings)(eo.X.SUBSCRIPTIONS_PANEL, {
        ...
        case eP.kqX.PREMIUM_PAST_DUE_INVALID_PAYMENT:
            return (0, i.jsxs)(_.$Td, {
                ...
                }), em.intl.string(em.t.LlZaoX), (0, i.jsx)(_.Z_L, {
                    noticeType: eP.kqX.PREMIUM_PAST_DUE_INVALID_PAYMENT,
                    onClick: () => {
                        ex(l.metadata?.premiumSubscription?.currentPeriodEnd), (0, eE.openUserSettings)(eo.X.SUBSCRIPTIONS_PANEL, {
                            section: eP.nc_.SUBSCRIPTIONS
                        })
                    },
        ...
        case eP.kqX.PREMIUM_PAST_DUE_MISSING_PAYMENT:
            return (0, i.jsxs)(_.$Td, {
                ...
                }), em.intl.string(em.t["30YfCr"]), (0, i.jsx)(_.Z_L, {
                    noticeType: eP.kqX.PREMIUM_PAST_DUE_MISSING_PAYMENT,
                    onClick: () => {
                        ex(l.metadata?.premiumSubscription?.currentPeriodEnd), (0, eE.openUserSettings)(eo.X.SUBSCRIPTIONS_PANEL, {
                            section: eP.nc_.SUBSCRIPTIONS
        ...
        case eP.kqX.PREMIUM_MISSING_PAYMENT:
            return (0, i.jsxs)(_.$Td, {
                ...
                children: [(0, i.jsx)(_.PMB, {
                ...
                }), z === eU.PremiumTypes.TIER_1 ? em.intl.formatToPlainString(em.t.b6QUvf, {
                    daysLeft: l.metadata.daysLeft
                }) : z === eU.PremiumTypes.TIER_0 ? em.intl.formatToPlainString(em.t["tURZ/M"], {
                    daysLeft: l.metadata.daysLeft
                    ...
                    children: z === eU.PremiumTypes.TIER_1 ? em.intl.string(em.t.lboF5O) : z === eU.PremiumTypes.TIER_0 ? em.intl.string(em.t["4UPwOq"]) : em.intl.string(em.t["P/VvGb"])
                })]
            });
        ...
        case eP.kqX.AUTO_MODERATION_MENTION_RAID_DETECTION:
            ...
            return (0, i.jsxs)(_.$Td, {
                ...
                children: [(0, i.jsx)(_.PMB, {
                    ...
                    onClick: () => {
                        null != t && (0, v.wu)(t), ex(eH)
                    }
                }), em.intl.string(em.t.B8ruyY), (0, i.jsx)(_.zr9, {
                    onClick: () => {
                        null != t && (0, v.W5)(t, eW, () => {
                            ex(eH), (0, v.wu)(t)
                        })
        ...
        case eP.kqX.SAFETY_USER_SENTIMENT_NAGBAR:
            return (0, i.jsxs)(_.$Td, {
                ...
                }), em.intl.string(em.t.I1nKfO), (0, i.jsx)(_.Z_L, {
                    noticeType: eP.kqX.SAFETY_USER_SENTIMENT_NAGBAR,
                    onClick: () => {
                        (0, _.mMO)(async () => {
                            let {
        ...
        case eP.kqX.BLOCK_USER_FEEDBACK_NAGBAR:
            return (0, i.jsxs)(_.$Td, {
                ...
                }), em.intl.string(em.t["0klLS7"]), (0, i.jsx)(_.Z_L, {
                    onClick: () => {
