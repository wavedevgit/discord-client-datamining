...
function tP(t) {
    return (0, tp.isWindows)() && c().satisfies(m.A?.os.release, tg.PH) ? `ms-settings:sound-properties?endpointId=${t}` : "ms-settings:sound"
}
...
function tU(t) {
    ...
    return !0 === a ? (e = tC.intl.string(tC.t.ppW3ri), n = (0, i.jsx)(d.eCN, {
        ...
        noticeType: r,
        children: tC.intl.string(tC.t.QghSIq)
    })) : tc.Ay.supports(tm.O5.LOOPBACK) ? (e = tC.intl.string(tC.t.dNAJ18), c = !0, n = (0, i.jsx)(d.zr9, {
        onClick: () => {
...
let tf = 21552 == n.j ? r.memo(function() {
    ...
    let I = null != s.type ? tA.Re[s.type] : null,
        m = null != s.type ? tA.k3[s.type] : null,
