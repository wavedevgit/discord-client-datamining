...
function tD(t) {
    let e, n, {
        ...
        c = !1;
    return !0 === a ? (e = tx.intl.string(tx.t.ppW3ri), n = (0, i.jsx)(E.eCN, {
        href: tj(s),
        noticeType: l,
        children: tx.intl.string(tx.t.QghSIq)
    })) : 0 === o ? (e = tx.intl.string(tx.t.j4gGA4), n = (0, i.jsx)(E.eCN, {
        href: tj(s),
        noticeType: l,
        children: tx.intl.string(tx.t.QghSIq)
    })) : tE.Ay.supports(ty.O5.LOOPBACK) ? (e = tx.intl.string(tx.t.dNAJ18), c = !0, n = (0, i.jsx)(E.zr9, {
        onClick: () => {
            (0, to.openUserSettings)(ta.X.VOICE_AND_VIDEO_PANEL)
        },
        children: tx.intl.string(tx.t.I6YlB4)
    })) : (e = tx.intl.string(tx.t.nCO9bI), n = (0, i.jsx)(E.eCN, {
        href: th.A.getArticleURL(tg.MVz.NO_INPUT_DETECTED),
        noticeType: l,
        children: tx.intl.string(tx.t.RYKKox)
    })), (0, i.jsxs)(E.$Td, {
    ...
    switch (r.type) {
        ...
        case tg.kqX.WINDOWS_MEDIA_PACK_REQUIRED:
            return (0, i.jsxs)(E.$Td, {
                ...
                children: [(0, i.jsx)(E.PMB, {
                    onClick: () => tf(),
                    noticeType: r.type
                }), tx.intl.string(tx.t.iW0fcQ), (0, i.jsx)(E.eCN, {
        ...
        case tg.kqX.VOICE_DISABLED:
            return (0, i.jsxs)(E.$Td, {
                ...
                children: [(0, i.jsx)(E.PMB, {
                    ...
                    noticeType: r.type
                }), tx.intl.string(tx.t.bOQ3jV), (0, i.jsx)(E.Z_L, {
                    onClick: () => {
        ...
        case tg.kqX.VOICE_CONNECTED_LAST_SESSION:
            return (0, i.jsxs)(E.$Td, {
                ...
                children: [(0, i.jsx)(E.PMB, {
                    ...
                    noticeType: r.type
                }), tx.intl.string(tx.t.jY2lUA), (0, i.jsx)(E.Z_L, {
                    onClick: () => {
        ...
        case tg.kqX.SPOTIFY_AUTO_PAUSED:
            ...
            return (0, i.jsxs)(E.$Td, {
                ...
                }), tx.intl.string(tx.t.D8Cp76), (0, i.jsx)(E.Z_L, {
        ...
        case tg.kqX.UNCLAIMED_ACCOUNT:
            return (0, i.jsxs)(E.$Td, {
                color: E.Hv$.DEFAULT,
                children: [tx.intl.string(tx.t["f+Zaol"]), (0, i.jsx)(E.Z_L, {
                    noticeType: r.type,
        ...
        case tg.kqX.UNVERIFIED_ACCOUNT:
            return (0, i.jsxs)(E.$Td, {
                color: E.Hv$.DEFAULT,
                children: [tx.intl.string(tx.t["3sWbf3"]), (0, i.jsx)(E.Z_L, {
                    noticeType: r.type,
                    onClick: () => {
        ...
        case tg.kqX.SCHEDULED_MAINTENANCE:
            ...
            return (0, i.jsxs)(E.$Td, {
                ...
                children: [(0, i.jsx)(E.PMB, {
                    ...
                    noticeType: r.type
                }), tx.intl.format(tx.t["yb96S+"], r.metadata), (0, i.jsx)(E.eCN, {
        ...
        case tg.kqX.HARDWARE_MUTE:
            ...
            if (J.A.getConfig({
                ...
                color: E.Hv$.INFO,
                children: [tx.intl.format(tx.t.QMw8Fd, {}), (0, i.jsx)(E.PMB, {
                    noticeType: r.type,
                    onClick: () => {
                        T.A.setEnableHardwareMuteNotice(!1), tf()
                    }
        ...
        case tg.kqX.STREAMER_MODE:
            return (0, i.jsxs)(E.$Td, {
                ...
                }), tx.intl.string(tx.t.iEgBXp), (0, i.jsx)(E.Z_L, {
        ...
        case tg.kqX.CORRUPT_INSTALLATION:
            return (0, i.jsxs)(E.$Td, {
                color: E.Hv$.DANGER,
                children: [tx.intl.string(tx.t["ugxmk/"]), (0, i.jsx)(E.eCN, {
        ...
        case tg.kqX.VIDEO_UNSUPPORTED_BROWSER:
            return (0, i.jsxs)(E.$Td, {
                ...
                }), tx.intl.string(tx.t.wVjKGi), (0, i.jsx)(E.Z_L, {
                    noticeType: tg.kqX.VIDEO_UNSUPPORTED_BROWSER,
                    onClick: () => {
                        (0, E.mMO)(async () => {
                            let {
        ...
        case tg.kqX.PREMIUM_UNCANCEL:
            return (0, i.jsxs)(E.$Td, {
                color: td === tO.PremiumTypes.TIER_1 ? E.Hv$.PREMIUM_TIER_1 : td === tO.PremiumTypes.TIER_0 ? E.Hv$.PREMIUM_TIER_0 : E.Hv$.PREMIUM_TIER_2,
                children: [(0, i.jsx)(E.PMB, {
                    ...
                    noticeType: tg.kqX.PREMIUM_UNCANCEL,
                    onClick: () => {
                        tf(r.metadata?.premiumSubscription?.currentPeriodEnd), (0, E.mMO)(async () => {
                            let {
                                default: t
        ...
        case tg.kqX.PREMIUM_PAST_DUE_INVALID_PAYMENT:
            return (0, i.jsxs)(E.$Td, {
                ...
                }), tx.intl.string(tx.t.LlZaoX), (0, i.jsx)(E.Z_L, {
                    noticeType: tg.kqX.PREMIUM_PAST_DUE_INVALID_PAYMENT,
                    onClick: () => {
        ...
        case tg.kqX.PREMIUM_PAST_DUE_MISSING_PAYMENT:
            return (0, i.jsxs)(E.$Td, {
                ...
                }), tx.intl.string(tx.t["30YfCr"]), (0, i.jsx)(E.Z_L, {
                    noticeType: tg.kqX.PREMIUM_PAST_DUE_MISSING_PAYMENT,
                    onClick: () => {
                        tf(r.metadata?.premiumSubscription?.currentPeriodEnd), (0, to.openUserSettings)(ta.X.SUBSCRIPTIONS_PANEL)
                    },
        ...
        case tg.kqX.QUARANTINED:
            return (0, i.jsxs)(E.$Td, {
                color: E.Hv$.DANGER,
                children: [tx.intl.string(tx.t.DVFJYf), (0, i.jsx)(E.eCN, {
                    href: tS.q,
                    target: "_blank",
                    noticeType: r.type,
        ...
        case tg.kqX.AUTO_MODERATION_MENTION_RAID_DETECTION:
            ...
            return (0, i.jsxs)(E.$Td, {
                ...
                }), tx.intl.string(tx.t.B8ruyY), (0, i.jsx)(E.zr9, {
                    onClick: () => {
                        null != e && (0, w.W5)(e, tK, () => {
                            tf(tF), (0, w.wu)(e)
                        })
        ...
        case tg.kqX.BLOCK_USER_FEEDBACK_NAGBAR:
            return (0, i.jsxs)(E.$Td, {
                ...
                }), tx.intl.string(tx.t["0klLS7"]), (0, i.jsx)(E.Z_L, {
                    onClick: () => {
