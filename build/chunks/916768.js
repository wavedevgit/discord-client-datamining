...
let ej = e => {
        let {
            error: t,
            allowClick: n = !1
        } = e, l = (0, G.B1)(t)?.errorCode, s = ev.intl.formatToPlainString(ev.t.ejOT95, {
            errorCode: l
        }), a = (0, i.jsx)(h.Text, {
    ...
    eO = e => {
        ...
        return (0, i.jsxs)(h.$Td, {
            ...
            }), ev.intl.string(ev.t.o3zuYz), (0, i.jsx)(ej, {
...
function eL(e) {
    return (0, eC.isWindows)() && d().satisfies(S.A?.os.release, eT.PH) ? `ms-settings:sound-properties?endpointId=${e}` : "ms-settings:sound"
}
...
function eM(e) {
    let t, n, {
        ...
        d = !1;
    return !0 === r ? (t = ev.intl.string(ev.t.ppW3ri), n = (0, i.jsx)(h.eCN, {
        href: eL(a),
        noticeType: l,
        children: ev.intl.string(ev.t.QghSIq)
    })) : 0 === o ? (t = ev.intl.string(ev.t.j4gGA4), n = (0, i.jsx)(h.eCN, {
        href: eL(a),
        noticeType: l,
        children: ev.intl.string(ev.t.QghSIq)
    })) : eA.Ay.supports(ey.O5.LOOPBACK) ? (t = ev.intl.string(ev.t.dNAJ18), d = !0, n = (0, i.jsx)(h.zr9, {
        onClick: () => {
            (0, ed.openUserSettings)(eo.X.VOICE_AND_VIDEO_PANEL)
        },
        children: ev.intl.string(ev.t.I6YlB4)
    })) : (t = ev.intl.string(ev.t.nCO9bI), n = (0, i.jsx)(h.eCN, {
        href: eI.A.getArticleURL(eN.MVz.NO_INPUT_DETECTED),
        noticeType: l,
        children: ev.intl.string(ev.t.RYKKox)
    })), (0, i.jsxs)(h.$Td, {
...
let eU = l.memo(function() {
    ...
    if (l.useEffect(() => {
            if (s?.type != null) {
                let e;
                if (null == g && (s.type === eN.kqX.PREMIUM_TIER_2_TRIAL_ENDING || s.type === eN.kqX.PREMIUM_TIER_0_TRIAL_ENDING)) return;
                let n = {};
            ...
            if (null != s && s.type === eN.kqX.SURVEY && null != s.metadata) {
                let {
                    metadata: e
                } = s, t = k.A.getUserExperimentDescriptor(e.id);
                null != t && (0, P.LQ)(e.id, t), (async () => {
    ...
    switch (s.type) {
        ...
        case eN.kqX.WIN32_DEPRECATED_MESSAGE:
            ...
            return (0, i.jsxs)(h.$Td, {
                ...
                children: [(0, i.jsx)(h.PMB, {
                    ...
                    helpCenterLink: eI.A.getArticleURL(eN.MVz.WIN32_DEPRECATE)
                })]
            });
        case eN.kqX.WIN7_8_DEPRECATED_MESSAGE:
            ...
            return (0, i.jsxs)(h.$Td, {
                ...
                children: [(0, i.jsx)(h.PMB, {
                    ...
                    helpCenterLink: eI.A.getArticleURL(eN.MVz.WIN7_8_DEPRECATE)
                })]
            });
        ...
        case eN.kqX.MACOS_19_DEPRECATED_MESSAGE:
            ...
            return (0, i.jsxs)(h.$Td, {
                ...
                children: [(0, i.jsx)(h.PMB, {
                    ...
                    helpCenterLink: eI.A.getArticleURL(eN.MVz.MACOS_19_DEPRECATE)
                })]
            });
        ...
        case eN.kqX.WINDOWS_MEDIA_PACK_REQUIRED:
            return (0, i.jsxs)(h.$Td, {
                ...
                children: [(0, i.jsx)(h.PMB, {
                    onClick: () => eD(),
                    noticeType: s.type
                }), ev.intl.string(ev.t.iW0fcQ), (0, i.jsx)(h.eCN, {
        ...
        case eN.kqX.GENERIC:
            return (0, i.jsxs)(h.$Td, {
                ...
                children: [(0, i.jsx)(h.PMB, {
                    onClick: () => eD(),
                    noticeType: s.type
                }), s.message, null != s.buttonText ? (0, i.jsx)(h.Z_L, {
                    onClick: s.callback,
                    noticeType: s.type,
        ...
        case eN.kqX.VOICE_DISABLED:
            return (0, i.jsxs)(h.$Td, {
                ...
                children: [(0, i.jsx)(h.PMB, {
                    ...
                    noticeType: s.type
                }), ev.intl.string(ev.t.bOQ3jV), (0, i.jsx)(h.Z_L, {
                    onClick: () => {
        ...
        case eN.kqX.VOICE_CONNECTED_LAST_SESSION:
            return (0, i.jsxs)(h.$Td, {
                ...
                children: [(0, i.jsx)(h.PMB, {
                    ...
                    noticeType: s.type
                }), ev.intl.string(ev.t.jY2lUA), (0, i.jsx)(h.Z_L, {
                    onClick: () => {
        ...
        case eN.kqX.SPOTIFY_AUTO_PAUSED:
            ...
            return (0, i.jsxs)(h.$Td, {
                ...
                }), ev.intl.string(ev.t.D8Cp76), (0, i.jsx)(h.Z_L, {
        ...
        case eN.kqX.UNCLAIMED_ACCOUNT:
            return (0, i.jsxs)(h.$Td, {
                color: h.Hv$.DEFAULT,
                children: [ev.intl.string(ev.t["f+Zaol"]), (0, i.jsx)(h.Z_L, {
                    noticeType: s.type,
        ...
        case eN.kqX.UNVERIFIED_ACCOUNT:
            return (0, i.jsxs)(h.$Td, {
                color: h.Hv$.DEFAULT,
                children: [ev.intl.string(ev.t["3sWbf3"]), (0, i.jsx)(h.Z_L, {
                    noticeType: s.type,
                    onClick: () => {
                        m.A.verifyResend(), A.A.show({
                            title: ev.intl.string(ev.t.LykQYk),
                            body: ev.intl.format(ev.t.azKEPy, {
                                email: e?.email
                            }),
        ...
        case eN.kqX.SCHEDULED_MAINTENANCE:
            ...
            return (0, i.jsxs)(h.$Td, {
                color: h.Hv$.DEFAULT,
                children: [(0, i.jsx)(h.PMB, {
                    onClick: () => x.A.ackScheduledMaintenance(),
                    noticeType: s.type
                }), ev.intl.format(ev.t["yb96S+"], s.metadata), (0, i.jsx)(h.eCN, {
        ...
        case eN.kqX.HARDWARE_MUTE:
            if (null != s.metadata) {
                ...
                return (0, i.jsxs)(h.$Td, {
                    color: h.Hv$.DANGER,
                    children: [ev.intl.format(ev.t.qoDex7, {
                        vendorName: e.name,
                        modelName: t.name
                    }), (0, i.jsx)(h.PMB, {
                        noticeType: s.type,
            ...
            if (X.A.getConfig({
                ...
                }).enableHardwareSilenceWarning) return (0, i.jsxs)(h.$Td, {
                color: h.Hv$.INFO,
                children: [ev.intl.format(ev.t.QMw8Fd, {}), (0, i.jsx)(h.PMB, {
                    noticeType: s.type,
                    onClick: () => {
                        _.A.setEnableHardwareMuteNotice(!1), eD()
                    }
        ...
        case eN.kqX.STREAMER_MODE:
            return (0, i.jsxs)(h.$Td, {
                ...
                }), ev.intl.string(ev.t.iEgBXp), (0, i.jsx)(h.Z_L, {
        ...
        case eN.kqX.DETECTED_OFF_PLATFORM_PREMIUM_PERK:
            if (null == s.metadata) return null;
            let {
                skuId: eP, applicationId: ek
            } = s.metadata, ew = eg.A.get(eP), eB = R.A.getApplication(ek);
        ...
        case eN.kqX.DETECTED_OFF_PLATFORM_PREMIUM_PERK_UPSELL: {
            ...
            let {
                skuId: e,
                applicationId: t
            } = s.metadata, n = eg.A.get(e), l = R.A.getApplication(t);
        ...
        case eN.kqX.CORRUPT_INSTALLATION:
            return (0, i.jsxs)(h.$Td, {
                color: h.Hv$.DANGER,
                children: [ev.intl.string(ev.t["ugxmk/"]), (0, i.jsx)(h.eCN, {
        ...
        case eN.kqX.VIDEO_UNSUPPORTED_BROWSER:
            return (0, i.jsxs)(h.$Td, {
                ...
                }), ev.intl.string(ev.t.wVjKGi), (0, i.jsx)(h.Z_L, {
                    noticeType: eN.kqX.VIDEO_UNSUPPORTED_BROWSER,
                    onClick: () => {
                        (0, h.mMO)(async () => {
                            let {
        ...
        case eN.kqX.DISPATCH_ERROR:
            ...
            return (0, i.jsxs)(h.$Td, {
                ...
                }), eH?.displayMessage, (0, i.jsx)(h.Z_L, {
                    noticeType: eN.kqX.DISPATCH_ERROR,
                    onClick: () => (0, h.mMO)(async () => {
                        let {
                            default: e
        ...
        case eN.kqX.DISPATCH_INSTALL_SCRIPT_PROGRESS:
            ...
            return (0, i.jsxs)(h.$Td, {
                ...
                children: [(0, i.jsx)(h.PMB, {
                    ...
                    children: [null != eK ? ev.intl.formatToPlainString(ev.t["pHj+z4"], {
                        name: `${eK}`,
                        progress: eF,
                        total: eW
                    }) : ev.intl.formatToPlainString(ev.t["lHZn+A"], {
                        progress: eF,
                        total: eW
                    }), (0, i.jsx)(h.y$y, {
                        type: h.y$y.Type.PULSING_ELLIPSIS,
                        className: eR.gO
                    })]
                })]
            });
        case eN.kqX.APPLICATION_TEST_MODE:
            if (null == s.metadata) return null;
            if (null != ef.A.testModeEmbeddedApplicationId) return (0, i.jsx)(h.$Td, {
                color: h.Hv$.WARNING,
                children: (0, i.jsxs)(O.A, {
                    ...
                    children: [(0, i.jsx)("div", {
                        ...
                        onClick: N.cL,
                        noticeType: eN.kqX.APPLICATION_TEST_MODE
                    })]
                })
            });
            return (0, i.jsx)(h.$Td, {
        ...
        case eN.kqX.PREMIUM_UNCANCEL:
            return (0, i.jsxs)(h.$Td, {
                color: eu === eS.PremiumTypes.TIER_1 ? h.Hv$.PREMIUM_TIER_1 : eu === eS.PremiumTypes.TIER_0 ? h.Hv$.PREMIUM_TIER_0 : h.Hv$.PREMIUM_TIER_2,
                children: [(0, i.jsx)(h.PMB, {
                    ...
                    color: "currentColor",
                    className: eR.PC
                }), eu === eS.PremiumTypes.TIER_1 ? ev.intl.formatToPlainString(ev.t.fXv4wm, {
                    daysLeft: s.metadata.daysLeft
                }) : eu === eS.PremiumTypes.TIER_0 ? ev.intl.formatToPlainString(ev.t.ZOHZMr, {
                    daysLeft: s.metadata.daysLeft
                    ...
                    noticeType: eN.kqX.PREMIUM_UNCANCEL,
                    onClick: () => {
                        eD(s.metadata?.premiumSubscription?.currentPeriodEnd), (0, h.mMO)(async () => {
                            let {
                                default: e
                            } = await Promise.all([n.e("41353"), n.e("62175"), n.e("14704"), n.e("55787")]).then(n.bind(n, 174705));
                            return t => (0, i.jsx)(e, {
                                ...t,
                                daysLeft: s.metadata.daysLeft,
                                premiumType: eu,
                    ...
                    children: eu === eS.PremiumTypes.TIER_1 ? ev.intl.string(ev.t.BkbUPM) : eu === eS.PremiumTypes.TIER_0 ? ev.intl.string(ev.t.Px978X) : ev.intl.string(ev.t.LW5tCE)
                })]
            });
        case eN.kqX.PREMIUM_PAST_DUE_ONE_TIME_PAYMENT:
            let {
                daysPastDue: eY, dismissUntil: ez
            } = s.metadata;
            return (0, i.jsxs)(h.$Td, {
                color: h.Hv$.WARNING,
                children: [(0, i.jsx)(h.PMB, {
        ...
        case eN.kqX.PREMIUM_PAST_DUE_INVALID_PAYMENT:
            return (0, i.jsxs)(h.$Td, {
                ...
                }), ev.intl.string(ev.t.LlZaoX), (0, i.jsx)(h.Z_L, {
                    noticeType: eN.kqX.PREMIUM_PAST_DUE_INVALID_PAYMENT,
                    onClick: () => {
                        eD(s.metadata?.premiumSubscription?.currentPeriodEnd), (0, ed.openUserSettings)(eo.X.SUBSCRIPTIONS_PANEL)
                    },
        ...
        case eN.kqX.PREMIUM_PAST_DUE_MISSING_PAYMENT:
            return (0, i.jsxs)(h.$Td, {
                ...
                }), ev.intl.string(ev.t["30YfCr"]), (0, i.jsx)(h.Z_L, {
                    noticeType: eN.kqX.PREMIUM_PAST_DUE_MISSING_PAYMENT,
                    onClick: () => {
                        eD(s.metadata?.premiumSubscription?.currentPeriodEnd), (0, ed.openUserSettings)(eo.X.SUBSCRIPTIONS_PANEL)
                    },
        ...
        case eN.kqX.PREMIUM_MISSING_PAYMENT:
            return (0, i.jsxs)(h.$Td, {
                ...
                children: [(0, i.jsx)(h.PMB, {
                ...
                }), eu === eS.PremiumTypes.TIER_1 ? ev.intl.formatToPlainString(ev.t.b6QUvf, {
                    daysLeft: s.metadata.daysLeft
                }) : eu === eS.PremiumTypes.TIER_0 ? ev.intl.formatToPlainString(ev.t["tURZ/M"], {
                    daysLeft: s.metadata.daysLeft
                }) : ev.intl.formatToPlainString(ev.t.AyC74I, {
                    daysLeft: s.metadata.daysLeft
                }), (0, i.jsx)(h.Z_L, {
                    noticeType: eN.kqX.PREMIUM_MISSING_PAYMENT,
                    onClick: () => {
                    ...
                    children: eu === eS.PremiumTypes.TIER_1 ? ev.intl.string(ev.t.lboF5O) : eu === eS.PremiumTypes.TIER_0 ? ev.intl.string(ev.t["4UPwOq"]) : ev.intl.string(ev.t["P/VvGb"])
                })]
            });
        ...
        case eN.kqX.QUARANTINED:
            return (0, i.jsxs)(h.$Td, {
                color: h.Hv$.DANGER,
                children: [ev.intl.string(ev.t.DVFJYf), (0, i.jsx)(h.eCN, {
                    href: eb.q,
                    target: "_blank",
                    noticeType: s.type,
        ...
        case eN.kqX.AUTO_MODERATION_MENTION_RAID_DETECTION:
            ...
            return (0, i.jsxs)(h.$Td, {
                ...
                }), ev.intl.string(ev.t.B8ruyY), (0, i.jsx)(h.zr9, {
                    onClick: () => {
                        null != t && (0, B.W5)(t, eX, () => {
                            eD(eq), (0, B.wu)(t)
                        })
        ...
        case eN.kqX.BLOCK_USER_FEEDBACK_NAGBAR:
            return (0, i.jsxs)(h.$Td, {
                ...
                }), ev.intl.string(ev.t["0klLS7"]), (0, i.jsx)(h.Z_L, {
                    onClick: () => {
