...
let ef = e => {
        let {
            error: t,
            allowClick: n = !1
        } = e, l = (0, v.B1)(t)?.errorCode, r = ey.intl.formatToPlainString(ey.t.ejOT95, {
            errorCode: l
        }), s = (0, i.jsx)(_.Text, {
...
function eD(e) {
    return (0, eR.isWindows)() && c().satisfies(O.A?.os.release, eS.PH) ? `ms-settings:sound-properties?endpointId=${e}` : "ms-settings:sound"
}
...
function eU(e) {
    ...
    return !0 === a ? (t = ey.intl.string(ey.t.ppW3ri), n = (0, i.jsx)(_.eCN, {
        ...
        children: [(0, i.jsx)(_.PMB, {
            ...
            allowClick: c,
            error: v.iy.NO_AUDIO_INPUT_DETECTED
        }), n]
    })
}
...
let eL = l.memo(function() {
    ...
    if (l.useEffect(() => {
            if (r?.type != null) {
                let e;
                if (null == p && (r.type === eh.kqX.PREMIUM_TIER_2_TRIAL_ENDING || r.type === eh.kqX.PREMIUM_TIER_0_TRIAL_ENDING)) return;
                let n = {};
    ...
    if (null != x) return (0, i.jsx)(b._, {
        dismissibleContent: x,
        noticeType: r.type
    });
    if (null != v) return (0, i.jsx)(L.T, {
        dismissibleContent: v
    });
    if (null != J) return (0, i.jsx)(M.r, {
    ...
    switch (r.type) {
        ...
        case eh.kqX.WIN32_DEPRECATED_MESSAGE:
            ...
            return (0, i.jsxs)(_.$Td, {
                ...
                children: [(0, i.jsx)(_.PMB, {
                    ...
                    helpCenterLink: em.A.getArticleURL(eh.MVz.WIN32_DEPRECATE)
                })]
            });
        case eh.kqX.WIN7_8_DEPRECATED_MESSAGE:
            ...
            return (0, i.jsxs)(_.$Td, {
                ...
                children: [(0, i.jsx)(_.PMB, {
                    ...
                    helpCenterLink: em.A.getArticleURL(eh.MVz.WIN7_8_DEPRECATE)
                })]
            });
        ...
        case eh.kqX.MACOS_19_DEPRECATED_MESSAGE:
            ...
            return (0, i.jsxs)(_.$Td, {
                ...
                children: [(0, i.jsx)(_.PMB, {
                    ...
                    helpCenterLink: em.A.getArticleURL(eh.MVz.MACOS_19_DEPRECATE)
                })]
            });
        ...
        case eh.kqX.DETECTED_OFF_PLATFORM_PREMIUM_PERK:
            ...
            } = r.metadata, ek = eA.A.get(eb), eG = P.A.getApplication(ev);
        ...
        case eh.kqX.DETECTED_OFF_PLATFORM_PREMIUM_PERK_UPSELL: {
            ...
            let {
                skuId: e,
                applicationId: t
            } = r.metadata, n = eA.A.get(e), l = P.A.getApplication(t);
        ...
        case eh.kqX.PREMIUM_UNCANCEL:
            return (0, i.jsxs)(_.$Td, {
                color: ec === eg.PremiumTypes.TIER_1 ? _.Hv$.PREMIUM_TIER_1 : ec === eg.PremiumTypes.TIER_0 ? _.Hv$.PREMIUM_TIER_0 : _.Hv$.PREMIUM_TIER_2,
                children: [(0, i.jsx)(_.PMB, {
                    ...
                    color: "currentColor",
                    className: ex.PC
                }), ec === eg.PremiumTypes.TIER_1 ? ey.intl.formatToPlainString(ey.t.fXv4wm, {
                    daysLeft: r.metadata.daysLeft
                }) : ec === eg.PremiumTypes.TIER_0 ? ey.intl.formatToPlainString(ey.t.ZOHZMr, {
                    daysLeft: r.metadata.daysLeft
                    ...
                    noticeType: eh.kqX.PREMIUM_UNCANCEL,
                    onClick: () => {
                        eM(r.metadata?.premiumSubscription?.currentPeriodEnd), (0, _.mMO)(async () => {
                            let {
                                default: e
                    ...
                    children: ec === eg.PremiumTypes.TIER_1 ? ey.intl.string(ey.t.BkbUPM) : ec === eg.PremiumTypes.TIER_0 ? ey.intl.string(ey.t.Px978X) : ey.intl.string(ey.t.LW5tCE)
                })]
            });
        case eh.kqX.PREMIUM_PAST_DUE_ONE_TIME_PAYMENT:
            let {
                daysPastDue: e$, dismissUntil: eW
            } = r.metadata;
            return (0, i.jsxs)(_.$Td, {
                color: _.Hv$.WARNING,
                children: [(0, i.jsx)(_.PMB, {
        ...
        case eh.kqX.PREMIUM_MISSING_PAYMENT:
            return (0, i.jsxs)(_.$Td, {
                ...
                children: [(0, i.jsx)(_.PMB, {
                ...
                }), ec === eg.PremiumTypes.TIER_1 ? ey.intl.formatToPlainString(ey.t.b6QUvf, {
                    daysLeft: r.metadata.daysLeft
                }) : ec === eg.PremiumTypes.TIER_0 ? ey.intl.formatToPlainString(ey.t["tURZ/M"], {
                    daysLeft: r.metadata.daysLeft
                    ...
                    children: ec === eg.PremiumTypes.TIER_1 ? ey.intl.string(ey.t.lboF5O) : ec === eg.PremiumTypes.TIER_0 ? ey.intl.string(ey.t["4UPwOq"]) : ey.intl.string(ey.t["P/VvGb"])
                })]
            });
