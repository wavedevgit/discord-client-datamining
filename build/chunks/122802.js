/** chunk id: 122802, original params: e,t,i (module,exports,require) **/
i.d(t, {
    A: () => y
});
var n = i(627968),
...
let y = s.forwardRef(function(e, t) {
    let {
        guildId: i
    } = e, [l, a] = s.useState(null), o = (0, r.yK)([m.A, j.Ay], () => (0, b.ct)(j.Ay.getChannelOverrides(i), {
        ignoreMute: !0,
        ignoreUnreadSetting: !1,
        ignoreNotificationSetting: !1
    }).map(e => m.A.getChannel(e)).filter(p.Vq)), u = (0, r.bG)([A.A], () => A.A.getCategories(i)), g = o.map((e, t) => (0, n.jsxs)("div", {
        className: M.WG,
        children: [(0, n.jsx)(L, {
            channel: e,
            categories: u,
            autoFocus: l === e.id
        }, e.id), t < o.length - 1 && (0, n.jsx)("div", {
            className: M.me
        })]
    }, e.id));
    return (0, n.jsxs)("div", {
        ...
        children: [(0, n.jsx)(E.A, {
            ...
            onSelected: e => {
                ...
                null != t && (c.A.updateChannelOverrideSettings(i, e, {
                    muted: !1,
                    message_notifications: j.Ay.resolvedMessageNotifications(t),
                    flags: (0, _.mD)(j.Ay.getChannelIdFlags(t.guild_id, t.id), j.Ay.resolveUnreadSetting(t))
                }, v.fd.OverrideCreated), a(e))
            }
...
function L(e) {
    let {
        ...
        categories: i,
        autoFocus: l
    } = e, c = (0, r.bG)([m.A], () => m.A.getChannel(t?.parent_id)), A = (0, f.bH)(t), j = s.useRef(null), p = s.useRef(null), [v, b] = s.useState(!1);
    if (s.useEffect(() => {
            l && j.current?.scrollIntoView({
                behavior: "smooth"
            })
        }, []), null == t) return null;
    let _ = O.intl.string(O.t.uIzfCE),
        E = (0, x.gU)(t);
    t.type === C.rbe.GUILD_CATEGORY && null != t.guild_id && "" !== t.guild_id ? _ = O.intl.formatToPlainString(O.t["2KzH89"], {
        num: null != i[t.id] ? i[t.id].length : 0
    }) : null != c && (_ = O.intl.formatToPlainString(O.t.L1zJgb, {
        categoryName: (0, g.m1)(c, S.default, N.A)
    }));
    ...
    return (0, n.jsx)("div", {
        ...
        children: (0, n.jsxs)("div", {
            ...
            children: [(0, n.jsxs)("div", {
                ...
                onClick: () => (0, f.Au)(t.guild_id, t.id),
                className: M.DT
            })]
        })
    })
