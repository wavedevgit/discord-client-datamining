/** chunk id: 839006 params = (module,exports,require) **/
let a;
t.d(e, {
    B4: () => h,
    KB: () => u,
...
let _ = (0, r.B)(function(n, e) {
        let t = new Intl.Locale(n).maximize(),
            ...
            d = function() {
                if (!a) {
                    let n = i.p.supplemental.languageMatching["written-new"]["0"]?.paradigmLocales?._locales.split(" "),
                    ...
                    a = {
                        ...
                        paradigmLocales: [...n, ...n.map(n => new Intl.Locale(n.replace(/_/g, "-")).maximize().toString())]
                    }
                }
                return a
            }();
        return s.language !== u.language && (o += c({
            language: t.language,
            script: "",
            region: ""
        }, {
            ...
            script: u.script,
            region: ""
        }, d)), s.region !== u.region && (o += c(s, u, d)), o
    }, {
...
function h(n, e, t = 838) {
    ...
    for (let e = 0; e < n.length; e++) {
        ...
        if (s.has(t)) {
            ...
            if (r.distances[t] = {
                    [t]: n
                }, n < a && (a = n, r.matchedDesiredLocale = t, r.matchedSupportedLocale = t), 0 === e) return r
        }
    }
    for (let e = 0; e < n.length; e++) {
        let t = n[e];
            ...
            if (n !== t) {
                ...
                for (let u = 0; u < i.length; u++) {
                    ...
                    if (o !== t && s.has(o)) {
                        ...
                        r.distances[t] || (r.distances[t] = {}), r.distances[t][o] = i, i < a && (a = i, r.matchedDesiredLocale = t, r.matchedSupportedLocale = o);
                        break
                    }
                }
            }
    ...
    return r.matchedSupportedLocale && 0 === a || (n.forEach((n, t) => {
        r.distances[n] || (r.distances[n] = {}), i.forEach((i, s) => {
            let u = e[s],
                o = _(n, i) + 0 + 40 * t;
            r.distances[n][u] = o, o < a && (a = o, r.matchedDesiredLocale = n, r.matchedSupportedLocale = u)
        })
    }), a >= t && (r.matchedDesiredLocale = void 0, r.matchedSupportedLocale = void 0)), r
}