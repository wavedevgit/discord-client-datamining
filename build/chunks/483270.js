...
let W = k.Ay.getEnableHardwareAcceleration(),
    ...
    z = s.memo(function(e) {
        let {
            ...
            userId: a,
            guildOwnerId: r
        } = e, o = s.useRef(null), d = (0, h.bG)([L.A], () => L.A.isTyping(t.id, a)), A = (0, h.bG)([y.Ay], () => y.Ay.getMember(t.guild_id, a)), _ = (0, h.bG)([j.A], () => A?.colorRoleId != null ? j.A.getRole(t.guild_id, A.colorRoleId)?.name : void 0, [t.guild_id, A]), g = (0, h.bG)([M.default], () => M.default.getUser(a)), f = (0, h.bG)([M.default], () => M.default.getCurrentUser()), x = g?.id === f?.id, E = (0, h.bG)([R.A, O.A], () => x ? O.A.getStatus() : R.A.getStatus(a, t.guild_id)), N = (0, h.bG)([R.A], () => R.A.isMobileOnline(a)), b = (0, h.bG)([R.A, O.A], () => x ? O.A.getActivities() : R.A.getActivities(a, t.guild_id)), D = (0, h.bG)([v.A], () => v.A.getAnyStreamForUser(a)), G = (0, c.rm)(a), P = (0, h.bG)([S.A], () => S.A.canUserViewChannel(t.id, l, a)), k = g?.id != null && g.id === r, F = s.useCallback(e => {
...
function J(e) {
    ...
    let l, r, u, m, p, {
        ...
        S = N.filter(e => e.userIds.length > 0).reverse()[0],
        {
            navigator: T,
            listRef: v
        } = (t = E, n = Y, l = (0, h.bG)([_.A], () => _.A.keyboardModeEnabled), r = s.useRef(null), u = s.useCallback((e, t) => {
            let i = r.current;
            if (null == i) return;
            let s = parseInt(t, 10),
