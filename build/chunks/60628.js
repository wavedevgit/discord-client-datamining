...
let $ = (0, A.createContext)(null),
    ...
    P = (0, A.forwardRef)(function(e, a) {
        ...
        let {
        ...
        } = (0, i.CC)(s.c) || {}, x = null != (P = null != (t = e.validationBehavior) ? t : k) ? P : "native", C = (0, g.j)({
            ...e,
            validationBehavior: x
        }), E = (0, A.useRef)(null), [S, F] = (0, i._E)(!e["aria-label"] && !e["aria-labelledby"]), {
            groupProps: B,
            labelProps: V,
            fieldProps: M,
            buttonProps: I,
            ...
            label: F,
            validationBehavior: x
        }, C, E), [Z, U] = (0, A.useState)(null), K = (0, A.useCallback)(() => {
        ...
        return delete G.id, A.createElement(i.Kq, {
            values: [
                [w, C],
                [d.t, {
                    ...B,
