...
class P extends s.PureComponent {
    componentDidMount() {
        ...
        e && !t ? (0, d.ST)() : t && this.props.loginOrSSO(t, s, !0), R.default.track(L.HAw.LOGIN_VIEWED, {
        ...
        }), c.A.getLocationMetadata(), (0, j.d)("login")
    }
    componentDidUpdate(e) {
        ...
        !t || e.authenticated || s && (i || r) || (this.props.conditionalMediationAbortController.abort("Transitioning to authenticated state"), this.props.loginOrSSO(t, n)), e.errors !== this.props.errors && (this.hasError("password") ? this.props.passwordRef.current?.focus() : this.hasError("email") || this.hasError("login") ? this.props.loginRef.current?.focus() : this.hasError("code") && this.props.codeRef.current?.focus())
    }
    hasError(e) {
    ...
    render() {
        ...
        if (d || c) return (0, i.jsx)(m.Ay, {
            children: (0, i.jsx)(o.y$y, {})
        });
        if (s) return (0, i.jsxs)(m.Ay, {
            className: r,
            children: [(0, i.jsx)(m.CK, {}), (0, i.jsx)(m.hE, {
                className: U.QB,
                children: k.intl.string(k.t.S6RMNA)
            }), (0, i.jsx)(m.tK, {
                children: k.intl.string(k.t.YZiJbh)
            })]
        });
        switch (n) {
            ...
            case L.aUe.PHONE_IP_AUTHORIZATION:
                return (0, i.jsx)(m.Ay, {
                    ...
                    children: (0, i.jsx)(A.A, {
                        ...
                        subtitle: k.intl.format(k.t.CfRZBj, {
                            onResendClick: this.props.handleResendCode
                        }),
                        error: _,
            ...
            case L.aUe.PASSWORD_RECOVERY_PHONE_VERIFICATION:
                return (0, i.jsx)(m.Ay, {
                    ...
                    children: (0, i.jsx)(A.A, {
                        ...
                        subtitle: k.intl.format(k.t.ef4uZ7, {
                            onResendClick: this.props.handleResendCode
                        }),
                        error: _,
            ...
            default:
                ...
                if (this.props.hasLoggedInAccounts && !this.props.dismissedChooseAccount) return (0, i.jsx)(N.A, {
                    onDismiss: () => this.props.setDismissedChooseAccount(!0)
                });
                return (0, i.jsxs)("div", {
