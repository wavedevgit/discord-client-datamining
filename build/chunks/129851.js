...
class X extends s.PureComponent {
    ...
    handleLogin = async e => {
        ...
        e?.preventDefault(), i.abort("Starting password login"), G._.dispatch(K.jej.WAVE_EMPHASIZE), this.setState({
            errors: {}
        });
        try {
            await p.A.login({
    ...
    handleTokenSubmitMFA = e => {
        ...
        return G._.dispatch(K.jej.WAVE_EMPHASIZE), p.A.loginMFAv2({
            code: n,
            ticket: i,
            mfaType: t,
            source: this.loginSource,
    ...
    handleForgotPassword = async e => {
        ...
        try {
            ...
            if (!1 === e) return;
            e === o.D.ONE_TIME_LOGIN ? (0, h.qfG)(e => {
                let t = [{
                    variant: "primary",
