/** chunk id: 129851 params = (module,exports,require) **/
"use strict";
n.d(t, {
    A: () => Q
});
...
class z extends s.PureComponent {
    ...
    componentDidMount() {
        ...
        e && !t ? (0, g.ST)() : t && this.loginOrSSO(t, s, !0), B.default.track(F.HAw.LOGIN_VIEWED, {
        ...
        }), h.A.getLocationMetadata(), (0, w.d)("login")
    }
    componentDidUpdate(e, t) {
        ...
        !n || e.authenticated || r && (s || l) || (this.state.conditionalMediationAbortController.abort("Transitioning to authenticated state"), this.loginOrSSO(n, i)), t.errors !== this.state.errors && (this.hasError("password") ? this.passwordRef?.focus() : this.hasError("email") || this.hasError("login") ? this.loginRef?.focus() : this.hasError("code") && this.codeRef?.focus())
    }
    get loginSource() {
        let {
            giftCode: e,
    ...
    renderResolving() {
        ...
        return (0, i.jsx)(x.A, {
            ...
            onLoginChange: (e, t) => this.setState({
                login: e,
                loginPrefix: t
            }),
    ...
    render() {
        ...
        if (c || o) return (0, i.jsx)(N.Ay, {
            children: (0, i.jsx)(_.y$y, {})
        });
        if (s) return (0, i.jsxs)(N.Ay, {
            className: r,
            children: [(0, i.jsx)(N.CK, {}), (0, i.jsx)(N.hE, {
                className: K.QB,
                children: W.intl.string(W.t.S6RMNA)
            }), (0, i.jsx)(N.tK, {
                children: W.intl.string(W.t.YZiJbh)
            })]
        });
        switch (n) {
            ...
            case F.aUe.PHONE_IP_AUTHORIZATION:
                return (0, i.jsx)(N.Ay, {
                    ...
                    children: (0, i.jsx)(v.A, {
                        ...
                        subtitle: W.intl.format(W.t.CfRZBj, {
            ...
            case F.aUe.PASSWORD_RECOVERY_PHONE_VERIFICATION:
                return (0, i.jsx)(N.Ay, {
                    ...
                    children: (0, i.jsx)(v.A, {
                        ...
                        subtitle: W.intl.format(W.t.ef4uZ7, {
                            onResendClick: this.handleResendCode
                        }),
                        error: d,
            ...
            default:
                ...
                if (this.props.hasLoggedInAccounts && !this.state.dismissedChooseAccount) return (0, i.jsx)(y.A, {
                    onDismiss: () => this.setState(e => ({
                        ...e,
    ...
    handleLogin = async e => {
        ...
        e?.preventDefault(), i.abort("Starting password login"), G._.dispatch(F.jej.WAVE_EMPHASIZE), this.setState({
            errors: {}
        });
        try {
            await h.A.login({
    ...
    handlePasswordReset = async e => {
        ...
        try {
            let {
                token: n
            } = await b.A.verifyPhone(this.getFullLogin(), e, !1);
            t(F.BVt.RESET, {
    ...
    handleForgotPassword = async e => {
        ...
        try {
            ...
            if (!1 === e) return;
            e === o.D.ONE_TIME_LOGIN ? (0, _.qfG)(e => {
                let t = [{
                    variant: "primary",
                ...
                title: W.intl.string(W.t.f5Pi7A),
                subtitle: W.intl.format(W.t["6u5hQ9"], {
                    email: t
                })
            })
        } catch (t) {
    ...
    handleReset = e => {
        null != e && e.preventDefault(), h.A.loginReset(), this.setState({
            password: "",
            loginPrefix: "",
            login: "",
            code: "",
    ...
    handleGotoRegister = () => {
        ...
        "" !== t && (c.email = t), null != n ? (c.mode = "register", e = F.BVt.INVITE(n.code)) : null != i ? (c.mode = "register", e = F.BVt.GIFT_CODE(i.code)) : null != s ? e = F.BVt.GUILD_TEMPLATE(s.code) : null != o ? (e = F.BVt.REGISTER, c.redirect_to = o) : e = F.BVt.REGISTER, this.loginReset(), l(e, {
