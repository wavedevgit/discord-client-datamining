/** chunk id: 288677, original params: t,n,i (module,exports,require) **/
i.d(n, {
    A: () => h
});
var l = i(627968);
...
function h(t, n) {
    let i = (0, a.bG)([r.Ay], () => r.Ay.getRunningVerifiedApplicationIds().includes(t.id), [t.id]),
        h = (0, a.bG)([c.A, o.A, A.A, d.A], () => (0, s.A)({
    ...
    return i || !h ? null : (0, l.jsx)(e.Drp, {
        id: "launch",
        label: b.intl.string(b.t.XKUw8m),
        action: () => u.playApplication(t.id, t, {
            analyticsParams: {
                location: n
            }
        })
