/** chunk id: 941321 params = (module,exports,require) **/
let _;
...
function b(e, t, n, r, a, i, d, b, c) {
    let o, s = (o = (0, _.__wbindgen_malloc)(+e.length, 1) >>> 0, f().set(e, o / 1), l = e.length, o),
        u = l,
    ...
    var w, p, x, h = (p = g[0], x = g[1], p >>>= 0, f().subarray(p / 1, p / 1 + x)).slice();
    return _.__wbindgen_free(g[0], +g[1], 1), h
}

function c(e, t) {
    var n, _;
    return n = e >>> 0, (d += _ = t) >= 0x7ff00000 && ((i = new TextDecoder("utf-8", {
        ignoreBOM: !0,
        fatal: !0
    })).decode(), d = _), i.decode(f().subarray(n, n + _))
}
