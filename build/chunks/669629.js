...
function C(e) {
    let t, {
        ...
        L = s.useRef(null);
    t = n?.guild_scheduled_event != null ? (0, i.jsx)(m.X, {
        channel: n.channel,
    ...
    let [w, k] = s.useState(""), [D, U] = s.useState(null), [P, B] = (0, f.S9)(R), [G, M] = s.useState(!1), [F, V] = s.useState({}), {
        username: W,
        global_name: H,
        date_of_birth: K
    } = F, [z, Q] = (0, f.ic)();
            ...
            children: (0, i.jsxs)("form", {
                ...
                children: [t, O ? (0, i.jsx)("div", {
                    ...
                    children: [(0, i.jsx)(l.ksK, {
                        ...
                        onChange: k,
                        onFocus: () => {
                            u.default.track(N.HAw.REGISTER_INPUT_FOCUS, {
                                field: "global_name"
                            })
                        },
                        onBlur: () => {
                            u.default.track(N.HAw.REGISTER_INPUT_BLUR, {
                                field: "global_name"
                            })
                        }
                    }), (0, i.jsx)(c.A, {
