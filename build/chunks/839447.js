/** chunk id: 839447 params = (module,exports,require) **/
n.d(t, {
    A: () => m
}), n(321073);
var l = n(627968),
...
function m(e) {
    let {
        ...
        if (null == e) return;
        let t = x.get(e.value);
        if (null != t && u(t.emoji)) return (0, l.jsx)(s.A, {
            emojiId: t.emoji?.id,
            emojiName: t.emoji?.name,
            animated: t.emoji?.animated ?? !1
        })
    }, [x]), f = i.useCallback((e, t) => {
        ...
        return (0, l.jsxs)("div", {
            className: d.ei,
            children: [h && n.isUnseen && (0, l.jsx)(o.LpS, {
