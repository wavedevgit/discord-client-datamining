...
let et = (0, v.Ld)(),
    en = e => {
        let {
            channel: t,
            onClose: n
        } = e, l = (0, N.Ay)(t) ?? "", s = (0, c.bG)([U.Ay], () => U.Ay.lastMessageId(t.id) ?? t.id);
        return (0, i.jsx)(u.DUT, {
            ...
            children: (0, i.jsxs)("div", {
                ...
                children: [(0, i.jsx)(u.euF, {
                    ...
                    className: ee.Pd,
                    children: r()(z.default.extractTimestamp(s)).fromNow()
                })]
            })
        })
    },
...
class el extends l.PureComponent {
    ...
    componentDidMount() {
        ...
        }), K._.subscribe(Z.jej.SCROLL_PAGE_UP, this.scrollPageUp), K._.subscribe(Z.jej.SCROLL_PAGE_DOWN, this.scrollPageDown), setTimeout(() => {
            this.forceFocus()
        }, 0)
    }
    ...
    getCreateGroupButtonAction() {
        let {
            channel: e,
            selectedUsers: t
        } = this.props, n = this.getRemaining(), i = null != e && 0 === t.size || n < 0, l = t.size > 1 || null != e ? Q.intl.string(Q.t["h1/FMu"]) : Q.intl.string(Q.t.bA875g);
        return {
            variant: "primary",
            disabled: i,
    ...
    getSubtitle() {
        ...
        let n = this.getRemaining();
        return n <= 0 ? Q.intl.formatToPlainString(Q.t.xYr004, {
            number: this.getMaxParticipants()
        }) : Q.intl.formatToPlainString(Q.t.HrSDPF, {
            number: n
        })
    }
    handleKeyDown(e) {
    ...
    renderBody() {
        ...
        return this.isNotFriends() || !e ? null : this.isPartyFull() ? (0, i.jsx)("div", {
            children: Q.intl.format(Q.t.xYr004, {
                number: this.getMaxParticipants()
            })
        }) : null
    }
    getListProps() {
        ...
        if (!(!e || this.isNotFriends() || this.isPartyFull())) return 0 === t.length ? {
            sections: [1],
            sectionHeight: 0,
            rowHeight: 32,
    ...
    renderRow = e => {
        ...
        let {
            user: c,
            comparator: d
        } = o, u = s.has(c.id), h = !u && 0 >= this.getRemaining();
        return (0, i.jsx)($.A, {
            row: n,
            user: c,
            hideDiscriminator: r,
    ...
    getInviteLinkFooter() {
        ...
        return (0, i.jsx)(u.D0$, {
            ...
            helperText: s.length > 0 ? Q.intl.format(Q.t.ZVdJMy, {
                numHours: "24"
            }) : void 0,
    ...
    getFooterProps() {
        ...
        if (this.isPartyFull()) return {};
        if (null == t) return {
            actionBarInput: n.size > 1 ? (0, i.jsx)(es, {
    ...
    createNewDM = e => {
        ...
        1 === e.length && (l = null == A.A._openCachedDMChannel(e[0])), H.default.track(Z.HAw.CREATE_DM_USER_LIST_CLICKED, {
            ...
            let t = {};
            "" !== this.state.newChannelName && (t.name = this.state.newChannelName), null != this.state.previewIcon && (t.icon = this.state.previewIcon), (null != t.name || null != t.icon) && A.A.updateChannel(e, t, C.A.NEW_GROUP_DM_INVITE_MODAL), H.default.track(Z.HAw.GDM_EDIT_INTERACTED, {
                channel_id: e,
    ...
    handleInviteUsers = () => {
        ...
        if (null != e) {
            ...
            let e = eu(l);
            l.length > 1 && e.size > 0 ? (0, u.qfG)(t => (0, i.jsx)(ei, {
                ...t,
    ...
    handleCopyInvite = e => {
        ...
        null != n && (0, V.C)(e), null != this.copyTimeout && clearTimeout(this.copyTimeout), this.setState({
            copied: !0
...
function es(e) {
    ...
    } = (0, I.Ay)(C.A.NEW_GROUP_DM_INVITE_MODAL), c = (0, N.Jo)(Array.from(t), B.default, G.A);
    return (0, i.jsxs)("div", {
        className: ee.zj,
...
function er(e) {
    ...
    } = e, s = `channel-invite-modal-${t?.id}`, a = (0, u.Ry6)(s), r = l.useCallback(() => (0, u.mMO)(() => Promise.resolve(e => (0, i.jsx)(ea, {
        ...e,
        channel: t
    })), {
        modalKey: s
    }), [t, s]), o = l.useCallback(() => a ? (0, u.OoC)(s) : r(), [a, s, r]);
    return l.useEffect(() => (n && K._.subscribe(Z.jej.TOGGLE_DM_CREATE, o), () => {
...
function eo(e) {
    ...
    (0, u.mMO)(() => Promise.resolve(e => (0, i.jsx)(ea, {
        ...e,
        channel: t,
        onComplete: n
    })), {
