    ...
    constructor(...e) {
        super(...e), el(this, "state", {
            ...
            return (0, l.jsx)($.A, {
                ...
                staffOverride: null != (t = (h || null == f) && A.isStaff() && (null == g ? void 0 : g.isStaff())) && t
            }, A.id)
            ...
            n && Y.A.requestMembers(null, e), A.A.search(e, null == t ? void 0 : t.id), null != this._existingTimeout && clearTimeout(this._existingTimeout), this._existingTimeout = setTimeout(() => {
...
function ef(e) {
    ...
    } = e, r = "channel-invite-modal-".concat(null == t ? void 0 : t.id), s = (0, p.Ry6)(r), a = i.useCallback(() => (0, p.mMO)(() => Promise.resolve(e => (0, l.jsx)(eh, es(ei({}, e), {
        channel: t
    }))), {
        modalKey: r
