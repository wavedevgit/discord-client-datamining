...
let et = (0, N.Ld)(),
    en = e => {
        let {
            channel: t,
            onClose: n
        } = e, l = (0, v.Ay)(t) ?? "", a = (0, c.bG)([w.Ay], () => w.Ay.lastMessageId(t.id) ?? t.id);
        return (0, i.jsx)(u.DUT, {
            ...
            children: (0, i.jsxs)("div", {
                ...
                children: [(0, i.jsx)(u.euF, {
                    ...
                    className: ee.Pd,
                    children: r()(z.default.extractTimestamp(a)).fromNow()
                })]
            })
        })
    },
    ei = e => {
        ...
        return (0, i.jsx)(o.Modal, {
            ...
            ...l,
            children: a.filter(K.Vq).sort((e, t) => {
...
class el extends l.PureComponent {
    ...
    componentDidMount() {
        ...
        }), W._.subscribe(Z.jej.SCROLL_PAGE_UP, this.scrollPageUp), W._.subscribe(Z.jej.SCROLL_PAGE_DOWN, this.scrollPageDown), setTimeout(() => {
            this.forceFocus()
        }, 0)
    }
    ...
    renderRow = e => {
        ...
        let {
            user: c,
            comparator: d
        } = o, u = a.has(c.id), h = !u && 0 >= this.getRemaining();
        return (0, i.jsx)($.A, {
            row: n,
            user: c,
            hideDiscriminator: r,
    ...
    getInviteLinkFooter() {
        ...
        return (0, i.jsx)(u.D0$, {
            ...
            helperText: a.length > 0 ? Q.intl.format(Q.t.ZVdJMy, {
                numHours: "24"
            }) : void 0,
    ...
    getFooterProps() {
        ...
        if (this.isPartyFull()) return {};
        if (null == t) return {
            actionBarInput: n.size > 1 ? (0, i.jsx)(ea, {
...
function es(e) {
    ...
    }), s = (0, c.bG)([H.default], () => !!H.default.getCurrentUser()?.isStaff() && null != t && !!t.isDM() && t.recipients.every(e => H.default.getUser(e)?.isStaff()), [t]);
    return (0, i.jsx)(el, {
        channel: t,
        isStaffOnlyDM: s,
        onComplete: n,
...
function er(e) {
    ...
    } = e, a = `channel-invite-modal-${t?.id}`, s = (0, u.Ry6)(a), r = l.useCallback(() => (0, u.mMO)(() => Promise.resolve(e => (0, i.jsx)(es, {
        ...e,
        channel: t
    })), {
        modalKey: a
    }), [t, a]), o = l.useCallback(() => s ? (0, u.OoC)(a) : r(), [s, a, r]);
    return l.useEffect(() => (n && W._.subscribe(Z.jej.TOGGLE_DM_CREATE, o), () => {
...
function eo(e) {
    ...
    (0, u.mMO)(() => Promise.resolve(e => (0, i.jsx)(es, {
        ...e,
        channel: t,
        onComplete: n
    })), {
...
function ec(e) {
    ...
    } = e, h = l.useRef(null), m = s ?? (null == t ? u.ggM : u.DpX), {
        showModal: A
    } = er({
        channel: t,
