...
function F(e) {
    ...
    switch (t.type) {
        case "HERO":
            ...
            return (0, r.jsx)(W, L(G({}, l), {
                body: X(n)
            }));
        case "GRID":
            return (0, r.jsx)(H, {
                children: X(t.children)
            });
        case "FIELD":
            return (0, r.jsx)(K, {
                value: B(t.value),
...
let $ = Object.assign(function(e) {
    ...
    let i, o, d, b, x, {
        ...
        X = null == B ? void 0 : B.getIconURL(16),
        ...
        }),
        {
            ...
            hasData: ei,
            components: ea
        } = (t = v.id, n = _.applicationId, i = (0, m.A)(), o = (0, c.bG)([P.A], () => P.A.getUserIdentityByApplication(t, n)), d = (0, c.bG)([C.A], () => C.A.getApplicationWidgetConfig(n)), b = (0, c.bG)([P.A, C.A], () => null == P.A.getUserIdentities(t) || null == C.A.applicationWidgetConfigs), x = l.useMemo(() => {
            ...
            return p.map(function e(t) {
                switch (t.type) {
                    case "HERO":
                        var n;
                        return {
                            type: "HERO", body: t.body.map(e), title: q(t.title, g), image: J(t.image, g), imagePlaceholder: null == (n = g.config) ? void 0 : n.heroPlaceholderImage
                        };
                    case "GRID":
                        return {
    ...
    return null == ea ? null : (0, r.jsxs)(D.A, L(G({}, e), {
        userId: v.id,
        widget: _,
        className: a()(k.Y5, w && k.aK),
        headerTitle: er,
