...
function Z(e) {
    return (0, i.jsxs)(u.BJc, {
        ...
        children: [(0, i.jsxs)(u.BJc, {
            gap: 4,
            children: [e.showSuggestedForYou && (0, i.jsx)(u.Text, {
...
let Q = Object.assign(function(e) {
    ...
    let a, r, m, h, j, {
        ...
        et = null == b && X && !z && V,
        en = null == b && X && z && V && null != Q && !Q.scopes.includes(o.F.APPLICATION_IDENTITIES_WRITE) && !Q.scopes.includes(o.F.SDK_SOCIAL_LAYER) && !Q.scopes.includes(o.F.SDK_SOCIAL_LAYER_PRESENCE),
        ...
        el = null == H ? (0, i.jsx)("div", {
            className: D.qd,
            children: ei
        }) : (0, i.jsx)(u.DUT, {
            className: s()(D.qd, D.vk),
            onClick: B,
            children: ei
        }),
        {
            ...
            hasData: es,
            components: er
        } = (t = E.id, n = T.applicationId, a = (0, f.A)(), r = (0, c.bG)([y.A], () => y.A.getUserIdentityByApplication(t, n)), m = (0, c.bG)([w.A], () => w.A.getApplicationWidgetConfig(n)), h = (0, c.bG)([y.A, w.A], () => null == y.A.getUserIdentities(t) || null == w.A.applicationWidgetConfigs), j = l.useMemo(() => {
            var e, t;
            ...
            return n.map(function e(t) {
                switch (t.type) {
                    case "HERO":
                        return {
                            type: "HERO", body: t.body.map(e), title: K(t.title, i), image: q(t.image, i), imagePlaceholder: i.config?.heroPlaceholderImage
                        };
                    case "GRID":
                        return {
                    ...
                    case "TEXT":
                        return {
                            type: "TEXT", content: K(t.content, i)
                        };
                    case "TEXT_WITH_IMAGE":
                        return {
                            type: "TEXT_WITH_IMAGE", content: K(t.content, i), image: q(t.image, i), imagePosition: t.imagePosition
                        };
                    case "SEPARATOR":
                        return t
                }
    ...
    return null == er ? null : (0, i.jsxs)(O.A, {
        ...
        children: [(0, i.jsx)(J, {
            ...
            className: D.qr,
            children: [ea || es || et || en ? null : (0, i.jsxs)("div", {
                className: D.o8,
                children: [(0, i.jsx)(u.Qfk, {
                    size: "xxs"
                }), (0, i.jsx)(u.Text, {
                    variant: "text-sm/medium",
                    color: "text-subtle",
