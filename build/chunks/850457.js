...
function y(e) {
    let {
        ...
        guildId: n,
        channelId: l
    } = e, a = (0, s.bG)([I.default], () => I.default.getUser(t.userId)), c = (0, o.O)(t.applicationId ?? null), d = N.Ay.useName(n, l, a), h = (0, m.A)({
...
function v(e) {
    let {
        ...
        guildId: n,
        channelId: l
    } = e, a = (0, s.bG)([I.default], () => I.default.getUser(t.userId)), o = N.Ay.useName(n, l, a);
    return null == a ? null : (0, i.jsxs)("li", {
        className: b.NG,
        children: [(0, i.jsx)("div", {
            className: b.Wz
...
function O(e) {
    ...
    let c = (0, s.bG)([x.A], () => x.A.getHistory(t.id), [t.id]),
        d = c.length > 0;
    return (l.useEffect(() => {
        d && C.default.track(T.HAw.OPEN_POPOUT, {
