...
async function z(e, t, n) {
    ...
    if ("string" == typeof n)
        if (e.transport === y.z4.POST_MESSAGE) {
            let e = (0, o.Ay)(t);
            if (null == e || !U(n, [e])) throw new b.A({
                closeCode: O.YI$.INVALID_ORIGIN
            }, "Invalid Origin")
        } else {
            let e = await q(t);
            if (i = A.Ay.createFromServer(e), !U(n, e.rpc_origins)) throw new b.A({
                closeCode: O.YI$.INVALID_ORIGIN
            }, "Invalid Origin")
