...
function H(e, t) {
    return null == t ? e : {
        ...
        presence: {
            ...e.presence,
            activity: I.A.getApplicationActivity(e.user.id, t) ?? null
        }
    }
}
...
function F(e) {
    ...
    return window.location.hostname === t && "localhost" === t || null == e.match("staging") && !!(P.test(e) && P.test(n))
}
...
async function z(e, t, n) {
    ...
    if ("string" == typeof n)
        if (e.transport === b.z4.POST_MESSAGE) {
            let e = (0, o.Ay)(t);
            if (null == e || !U(n, [e])) throw new y.A({
                closeCode: O.YI$.INVALID_ORIGIN
            }, "Invalid Origin")
        } else {
            let e = await q(t);
            if (i = A.Ay.createFromServer(e), !U(n, e.rpc_origins)) throw new y.A({
                closeCode: O.YI$.INVALID_ORIGIN
            }, "Invalid Origin")
