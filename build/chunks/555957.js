...
let V = function(e) {
    let {
        ...
        onEdit: d,
        onClick: m
    } = e, g = (0, c.yK)([y.default], () => t.users.map(e => y.default.getUser(e)).filter(k.Vq)), j = (0, c.bG)([b.A], () => null != t.channelId ? b.A.getChannel(t.channelId) : null), N = (0, c.bG)([C.A], () => null != t.guildId ? C.A.getGuild(t.guildId) : null), {
    ...
    }, [F, t.editMetadata?.start]), ee = a.useCallback(e => {
        e.relatedTarget?.parentElement?.parentElement !== e.currentTarget.parentElement && J()
    }, [J]), et = a.useCallback(() => {
        V(!1)
    }, []), el = a.useCallback(e => {
        V(!0), $.current?.pause();
        let a = R && M.size > 0 ? Array.from(M).map(e => S.A.getClipById(e)).filter(k.Vq) : [t];
        (0, p.L3)(e, async () => {
            let {
                default: e
            ...
            return l => (0, n.jsx)(e, {
                ...
                showShareAndEdit: !0,
                onShare: () => {
                    A.default.track(O.HAw.CLIP_GALLERY_CARD_BUTTON_CLICKED, {
                        type: "share"
                    })
                },
                onEdit: () => {
                    d(t), A.default.track(O.HAw.CLIP_GALLERY_CARD_BUTTON_CLICKED, {
                        type: "edit"
                    })
                },
                onBeforeDelete: W,
    ...
    }, [t, R, M, i, W, et, d]), en = a.useCallback(e => {
        i || (e.preventDefault(), e.stopPropagation(), el(e))
    }, [i, el]), ea = a.useCallback(e => {
        i || (e.shiftKey ? (e.preventDefault(), T(t.id)) : R ? T(t.id) : null != m && m(t), A.default.track(O.HAw.CLIP_GALLERY_CARD_CLICKED))
    }, [i, R, T, t, m]);
    return (0, n.jsx)(f.f5, {
        value: L,
                ...
                children: [(0, n.jsx)(_, {
                    ...
                    children: (0, n.jsx)(u.A, {
                        ...
                        onFocusOverflow: e => {
                            ...
                            t?.parentElement === l || t?.parentElement?.parentElement?.parentElement !== l && Z()
                        },
...
function $(e) {
    let {
        clip: t,
        videoRef: l
    } = e, a = (0, T.j)(t), i = t.type === w.nQ.SCREENSHOT;
    return t.type === w.nQ.VOICE_CLIP ? (0, n.jsx)(M.A, {
        className: G.fT
    }) : i ? (0, n.jsx)("img", {
        alt: "",
        src: t.thumbnail,
...
function _(e) {
    ...
    return (0, n.jsx)("div", {
        ...
        children: null != a ? (0, n.jsx)("img", {
            ...
            alt: "",
            className: G.NH
        }) : t.type === w.nQ.VOICE_CLIP ? (0, n.jsx)(h.HKD, {
            size: "sm",
            color: "currentColor"
        }) : (0, n.jsx)(h.kN9, {
            size: "sm",
