/** chunk id: 380111 params = (module,exports,require) **/
i.d(e, {
    A: () => l
});
var s = i(364298),
...
class h {
    ...
    render(t, e) {
        t.beginPath(), t.globalAlpha = e * this.depth / 4, t.arc(this.x, this.y, this.size, 0, n.JM, !0), t.fillStyle = this.color, t.fill(), t.globalAlpha = 1
    }
}
let l = h