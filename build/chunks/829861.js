...
function W(e) {
    ...
    } = e, W = (0, L.A)(), Y = (0, a.yK)([v.Ay], () => v.Ay.getEmbeddedActivitiesForLocation(n), [n]), z = (0, O.H)(n), X = (0, a.bG)([E.A], () => E.A.getChannel(z)), q = (0, j.IQ)(Y), J = (0, j.Rz)(q), Q = s.useCallback(() => {
        (0, y.gk)(k.Gd.PIP)
    }, []), $ = s.useRef(null), Z = (0, a.bG)([v.Ay], () => v.Ay.getFocusedLayout()), ee = Z !== k.E8.NO_CHAT, [et, en] = s.useState(_.Ay.activityPanelHeight ?? t ?? null), ei = s.useCallback(e => {
