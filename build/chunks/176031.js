...
let em = e => {
        let {
            selected: t,
            ...n
        } = e, r = (0, P.c)("PrivateChannels.ICYMIButton"), l = (0, d.rm)("icymi");
        return r ? (0, i.jsx)("div", {
            ...
            children: (0, i.jsx)(C.z9, {
                ...
                text: (0, i.jsxs)(i.Fragment, {
                    children: [eA.intl.string(eA.t["jnXV/V"]), (0, i.jsx)("span", {
                        className: e_.HH,
                        children: eA.intl.string(eA.t.Ac2OZA)
                    })]
                }),
                ...n,
                ...l
    ...
    ep = e => {
        let {
            selected: t,
            ...n
        } = e, l = (0, d.rm)("friends"), a = (0, G.kX)(), s = (0, u.bG)([H.Ay], () => H.Ay.canShowFriendsTabBadge()), c = (0, u.bG)([S.A], () => S.A.useReducedMotion), {
            enabled: h
        } = V.u.useConfig({
            location: "Friends Tab"
        }), [m, p] = (0, O.Wl)(s && h ? A.M.GIFTING_INTENT_FRIENDS_TAB_BADGE : null, {
            cooldownDurationMs: H.hb
        ...
        let T = () => {
                let e;
                I ? (ea.default.track(eo.HAw.GIFT_INTENT_BADGE_CLICKED, {
                    gift_intent_type: eu.np.FRIEND_ANNIVERSARY
                }), e = eo.m3P.ALL, f.A.setSection(eo.m3P.ALL), p(ec.i.TAKE_ACTION)) : e = el.Ay.getState().section, (0, x.A)({
                    tab_opened: e
                })
            },
            [N, y] = r.useState(!1),
    ...
    ef = e => {
        let {
            selected: t
        } = e, n = eA.intl.string(eh.default.Rkdixs), l = (0, d.rm)("family-center"), [a, s] = r.useState(!0);
        return (0, i.jsx)(C.z9, {
            selected: t,
...
function eN(e) {
    ...
    return e.startsWith(eo.BVt.APPLICATION_STORE) ? e === eo.BVt.APPLICATION_STORE ? eo.liQ.STORE_DIRECTORY_HOME : e.startsWith(eo.BVt.APPLICATION_STORE) ? eo.liQ.STORE_DIRECTORY_BROWSE : eo.liQ.STORE_LISTING : eo.liQ.DM_CHANNEL
}
let eS = r.memo(function(e) {
    ...
    return d ? S = (0, i.jsx)(W.V, {
        ...
        children: [(0, i.jsx)(Z.A, {
            ...
            }, "friends"), N ? (0, i.jsx)(em, {
                selected: null != m ? m === eo.BVt.ICYMI : l === eo.BVt.ICYMI
            }, "icymi") : null, n && t ? (0, i.jsx)(eg, {
                selected: null == m ? null != l && l.startsWith(eo.BVt.APPLICATION_LIBRARY) : m.startsWith(eo.BVt.APPLICATION_LIBRARY),
...
function ev() {
    let e, t, n = (0, u.bG)([er.A], () => er.A.getHomeLink()),
        r = (0, u.bG)([ei.A], () => {
    ...
    let [f] = (0, O.Cc)(m && I ? A.M.REFERRAL_PROGRAM_POPOVER_V2 : null, p ?? "", void 0, !0), [C, T] = (0, O.kn)(E, void 0, !0), N = null == f && C === A.M.RECURRING_3P_PROMOTION_POPOVER, S = I ? f === A.M.REFERRAL_PROGRAM_POPOVER_V2 : C === A.M.REFERRAL_PROGRAM_POPOVER, x = (0, M.H)(), v = (e = ee.dm.useSetting(), t = (0, w.A)(), !0 === e && !0 === t);
    return (0, i.jsx)(eS, {
        theme: a,
        showLibrary: l,
