/** chunk id: 978914 params = (module,exports,require) **/
n.d(t, {
    I: () => A
});
var i = n(735438),
...
function A(e) {
    ...
    let {
        ...
        return t
    }, [n]), u = (0, a.bG)([d.A], () => d.A.shouldLoadMessageRequestPreview(n), [n]);
    return i && !l && null == s && u && (t = n, h.add(t), null == m && (m = setTimeout(g, 0))), {
        loaded: l,
        error: r,
        message: s
    }
