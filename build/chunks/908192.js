/** chunk id: 908192 params = (module,exports,require) **/
"use strict";
n.d(t, {
    A: () => j
});
...
function j(e) {
    let {
        ...
        password: Y,
        date_of_birth: X
    } = O, J = (0, a.bG)([g.A], () => g.A.getAuthenticationConsentRequired()), $ = null != J && y, [Z, ee] = s.useState(!1), [et, en] = s.useState(!1), ei = async () => {
        n.length > 0 && !_.A.wasRegistrationSuggestionFetched(n) && await h.A.fetchSuggestionsRegistration(n)
    }, es = e => {
        m.default.track(N.HAw.REGISTER_INPUT_FOCUS, {
            field: e
        })
    }, er = e => {
        m.default.track(N.HAw.REGISTER_INPUT_BLUR, {
            field: e
        })
    }, el = s.useRef(null), ea = s.useRef(null), eo = s.useRef(null), ec = s.useRef(null);
    ! function(e) {
        let {
            apiErrors: t,
            emailRef: n,
    ...
    let ed = null;
    return "string" == typeof K && (ed = (0, i.jsx)(A.ME, {
        className: l()(T.QX, C.gJ),
        children: K
    })), (0, i.jsxs)(A.eB, {
        className: T.QX,
        children: [(0, i.jsx)(A.pd, {
            autoFocus: !0,
            className: T.SX,
