/** chunk id: 356481 params = (module,exports,require) **/
t.d(e, {
    B: () => d
});
var a = t(653938),
...
function d(n, e, t, d, l, c) {
    let _, f;
    null == (_ = "lookup" === t.localeMatcher ? (0, s.V)(Array.from(n), e, c) : (0, a.k)(Array.from(n), e, c)) && (_ = {
        locale: c(),
        extension: ""
    });
    let h = _.locale,
    ...
    for (let n of d) {
        ...
        let u = t[n];
        if ((0, o.V1)(null == u || "string" == typeof u, "optionsValue must be a string or undefined"), "string" == typeof u) {
            let e = n.toLowerCase();
            "" === (u = (0, r.t)(e, u)) && (u = "true")
        }
