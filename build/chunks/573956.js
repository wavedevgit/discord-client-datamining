...
function N(e) {
    let {
        guild: t,
        selected: N
    } = e, S = (0, h.A)(t), b = (0, d.JZ)(a.M.CHANNEL_BROWSER_NEW_BADGE_NUX), T = (0, l.yK)([A.A], () => Array.from(A.A.getNewChannelIds(t.id)).filter(e => A.A.shouldIndicateNewChannel(t.id, e))), v = (0, l.bG)([m.Ay], () => m.Ay.hasUnread(t.id, E.P.GUILD_ONBOARDING_QUESTION)), y = T.length > _.rR, j = (0, l.bG)([u.A, m.Ay], () => {
        ...
        (0, p.pX)(x.BVt.CHANNEL(t.id, S ? C.VV.CUSTOMIZE_COMMUNITY : C.VV.CHANNEL_BROWSER))
