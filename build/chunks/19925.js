...
function h(e) {
    let {
        loadId: t
    } = e, n = d.A.useField("fetchedQuery"), l = d.A.useField("categoryId"), a = d.A.useField("languageCode"), c = i.useMemo(() => ({
        categoryId: l,
        query: n,
        languageCode: a
...
function _(e) {
    ...
    return {
        ...
        onClearSearch: i.useCallback(() => {
            l.gp(t), a.A.clearSearchResults(), a.A.resetSearchLayout(), d.A.setState({
                query: "",
                fetchedQuery: "",
                resultsQuery: "",
                categoryId: A.Iq,
