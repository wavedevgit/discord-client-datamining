/** chunk id: 353174 params = (module,exports,require) **/
s.d(t, {
    A: () => N
});
var i = s(627968);
...
let w = e => {
            ...
            children: [(0, i.jsx)(c.euF, {
                ...
                children: [p ? (0, i.jsxs)(i.Fragment, {
                    ...
                    children: (0, i.jsx)(c.DUT, {
                        onClick: () => {
                            var e;
                            return e = t.id, void(_.A.hasLayers() && (0, h.jH)(), x.A.openPrivateChannel({
                                recipientIds: e
                            }), a())
                        },
                        className: S.t0,
    ...
    N = e => {
        ...
        return l > 0 && (h = A.intl.formatToPlainString(A.t.iWtOfC, {
            numReferrals: f
        })), 0 === f && (h = A.intl.string(A.t["7VBEue"])), (0, i.jsxs)("div", {
            className: S.Jc,
            children: [(0, i.jsx)(c.DUT, {
                onClick: a,
                className: S.cG,
