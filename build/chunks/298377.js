/** chunk id: 298377, original params: e,t,n (module,exports,require) **/
"use strict";
n.d(t, {
    A: () => f
});
...
function f(e, t, n) {
    ...
    if ((0, l.D5)() && "expandedKeys" in t) {
        ...
        if (null != e) {
            ...
            let n = (null == (E = e.props) ? void 0 : E.UNSTABLE_childItems) || (null == (b = e.props) || null == (y = b.children) ? void 0 : y.length) > t.userColumnCount;
            g = {
                onKeyDown: r => {
                ...
                "aria-setsize": e.level > 1 ? (null != (T = null == (O = (0, i.W)(null != (S = null == (v = t.keyMap.get(e.parentKey)) ? void 0 : v.childNodes) ? S : [])) ? void 0 : O.indexOfType) ? T : 0) + 1 : (null != (C = null == (A = (0, i.W)(t.collection.body.childNodes)) ? void 0 : A.indexOfType) ? C : 0) + 1
            }
        }
    }
