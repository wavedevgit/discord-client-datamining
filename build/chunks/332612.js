...
function x(e) {
    ...
    } = (0, c.Ay)(), x = (0, a.bG)([m.default], () => m.default.getUser(t)), p = A.Ay.getFormattedName(x), E = s.useCallback(() => {
        (0, d.kj)(t)
    }, [t]), C = s.useCallback(() => (0, _.openUserProfileModal)({
        userId: t,
...
function p(e) {
    let {
        ...
        verification: a,
        index: r
    } = e, o = (0, d.tC)(a.timestamp), c = s.useCallback(() => {
...
function E(e) {
    ...
    return (0, i.jsxs)(i.Fragment, {
        children: [(0, i.jsx)(x, {
            userId: t,
            count: n.length
        }), n.map((e, a) => (0, i.jsxs)(s.Fragment, {
            children: [(0, i.jsx)(p, {
                className: h.nM,
                userId: t,
                index: a,
                verification: e
            }), a !== n.length - 1 && (0, i.jsx)("div", {
                className: h.yF
            })]
        }, `${a}-${e.timestamp}`))]
    })
