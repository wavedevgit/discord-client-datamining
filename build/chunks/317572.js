/** Chunk was on web.js **/
/** chunk id: 317572, original params: e,t,n (module,exports,require) **/
"use strict";
n.d(t, {
    A: () => l
});
...
function l(e) {
    ...
    return e.type === o.$pd.PLAYING && (null == t ? void 0 : t.type) === o.fg2.XBOX ? {
        text: s.intl.formatToPlainString(s.t.A17aM8, {
            platform: s.intl.string(s.t.Nfvo72)
        }),
        platformIcon: n
    } : e.type === o.$pd.PLAYING && (null == t ? void 0 : t.type) === o.fg2.PLAYSTATION ? {
        text: s.intl.formatToPlainString(s.t.A17aM8, {
            platform: s.intl.string(s.t.fFl4jo)
        }),
        platformIcon: n
    } : e.type === o.$pd.PLAYING && (null == t ? void 0 : t.type) === o.fg2.META_QUEST_OR_HORIZON ? {
        text: s.intl.formatToPlainString(s.t.A17aM8, {
            platform: (0, r.A)(e) ? s.intl.string(s.t.BrHQaq) : s.intl.string(s.t.p6vL0e)
        }),
        platformIcon: n
    } : e.type === o.$pd.WATCHING && (null == t ? void 0 : t.type) === o.fg2.META_QUEST_OR_HORIZON ? {
        text: s.intl.formatToPlainString(s.t.ENbTKQ, {
            platform: (0, r.A)(e) ? s.intl.string(s.t.BrHQaq) : s.intl.string(s.t.p6vL0e)
        }),
        platformIcon: n
    } : e.type === o.$pd.STREAMING && (null == t ? void 0 : t.type) === o.fg2.TWITCH ? {
        text: s.intl.formatToPlainString(s.t["4CQq9Q"], {
            name: s.intl.string(s.t.q4pBG3)
        }),
        platformIcon: n
    } : e.type === o.$pd.STREAMING && (null == t ? void 0 : t.type) === o.fg2.YOUTUBE ? {
        text: s.intl.formatToPlainString(s.t["4CQq9Q"], {
