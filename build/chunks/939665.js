...
function L(e) {
    let {
        ...
        giftMessage: $,
        claimableRewards: ee
    } = (0, j.Pv)(), en = (0, S.Mq)(W), et = (0, d.bG)([P.A], () => {
        let e = P.A.getMarketingComponentByType(u.C.GIFT_CUSTOMIZATION_BANNER);
        return null != e && "giftCustomizationBanner" === e.properties.properties.oneofKind
    }), ei = Q && en && null != ee && ee.length > 0 && et, el = (Y || Z) ?? !1, er = l.useMemo(() => (0, f.Tm)({
        skuId: B,
        isPremium: q,
        defaultPlanId: z
    }), [B, q, z]), es = Z && er.includes(w.gD.PREMIUM_MONTH_TIER_2) ? w.gD.PREMIUM_MONTH_TIER_2 : er[0], ea = (0, d.bG)([h.A], () => h.A.get(es)), eo = [{
        planId: ea?.id,
        quantity: 1
    }], [eu, ed] = l.useState(el), [ec, ep] = (0, _.Kq)({
        items: eo,
        renewal: !1,
        preventFetch: !el,
        applyEntitlements: !0,
    ...
    }, [ec, el]), (0, p.A)("Payment Modal Plan Select Step", eu, 5, {
    ...
    return (0, i.jsxs)(i.Fragment, {
        children: [(0, i.jsx)(v.Z, {
            giftMessage: $
        }), !(Q && (0, g.Ik)(J)) && (0, i.jsx)(M.A, {
            isEligibleForTrial: Y
        }), (0, i.jsxs)(O.dZ, {
            children: [!ex && eE && (0, i.jsx)("hr", {
                className: G.T4
            }), (0, i.jsx)(k.P, {
                className: G.ZB,
                planSkuId: ea?.skuId,
                referralTrialOfferId: X
            }), (0, i.jsx)(b.A, {}), e_ ? (0, i.jsx)(c.wx6, {
                type: "critical",
                children: em
            }) : eT, eE && (0, i.jsxs)(i.Fragment, {
                children: [(0, i.jsx)("hr", {
                    className: s()(G.IM, {
                        [G.Go]: ex
                    })
            ...
            children: [ei && (0, i.jsx)(x._, {}), (0, i.jsx)(T.Z, {
                onStepChange: n,
