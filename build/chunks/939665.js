...
function W(e) {
    ...
    } = (0, M.P5)(), $ = (0, y.A)(), ee = (0, b.bB)(), {
        isGift: et,
        giftRecipient: en,
        giftMessage: el,
        claimableRewards: ei
    } = (0, R.Pv)(), er = (0, _.Mq)($), es = (0, d.bG)([P.A], () => {
        let e = P.A.getMarketingComponentByType(u.C.GIFT_CUSTOMIZATION_BANNER);
        return null != e && "giftCustomizationBanner" === e.properties.properties.oneofKind
    }), ea = et && er && null != ei && ei.length > 0 && es, eo = (X || Q) ?? !1, eu = i.useMemo(() => (0, f.Tm)({
        skuId: z,
        isPremium: Z,
        defaultPlanId: q
    }), [z, Z, q]), ed = Q && eu.includes(F.gD.PREMIUM_MONTH_TIER_2) ? F.gD.PREMIUM_MONTH_TIER_2 : eu[0], ec = (0, d.bG)([A.A], () => A.A.get(ed)), ep = [{
        planId: ec?.id,
        quantity: 1
    }], [em, eE] = i.useState(eo), [eS, e_] = (0, S.Kq)({
        items: ep,
        renewal: !1,
        preventFetch: !eo,
        applyEntitlements: !0,
    ...
    return (0, l.jsxs)(l.Fragment, {
        children: [(0, l.jsx)(w.Z, {
            ...
            children: [ea && (0, l.jsx)(I._, {}), (0, l.jsx)(x.Z, {
                onStepChange: t,
