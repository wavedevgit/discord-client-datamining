...
class D extends p.A {
    ...
    initialize(e) {
        ...
        let n = (0, E.lE)(),
            r = (r, i) => {
                ...
                this.logger.info("Connected with local address ".concat(s, ":").concat(o, " and protocol: ").concat(a)), this.onConnectCallbackAt = performance.now(), n.getCodecCapabilities(r => {
        ...
        if (null != n.createOwnStreamConnectionWithOptions) s = this.context === O.x.STREAM && this.streamUserId === this.userId ? n.createOwnStreamConnectionWithOptions : n.createVoiceConnectionWithOptions;
        else if (null != n.createOwnStreamConnection) {
            var i, a, s, o = this.context === O.x.STREAM && this.streamUserId === this.userId ? n.createOwnStreamConnection : n.createVoiceConnection;
        ...
        null == (i = (t = this.conn = s(this.userId, e, r)).setSecureFramesStateUpdateCallback) || i.call(t, e => {
    ...
    createUser(e, t, n) {
        ...
        if (this.remoteAudioSSRCs[e] = t, this.remoteVideoSSRCs[e] = null != n ? n : [], this.userId !== e && (a || s)) {
            ...
            if (this.connectionState === O.$I.CONNECTED) {
                var o;
                this.logger.info("Creating user: ".concat(e, " with audio SSRC: ").concat(t, " and video SSRCs: ").concat(null != (o = null == n ? void 0 : n.join(",")) ? o : 0)), this.mergeUsers([i])
            }
    ...
    setGoLiveSource(e) {
        ...
        if (this.goLiveSourceIdentifier = a, null != this.conn.setDesktopSource) {
            if (null != e.desktopDescription) {
                ...
                null != t ? this.logger.info("capturing desktop (type: ".concat(_, ", handle: ").concat(h, ", use-video-hook: ").concat(i.toString(), ", use-graphics-capture: ").concat(null == o ? void 0 : o.toString(), ", use-graphics-capture-api-level: ").concat(null == a ? void 0 : a.toString(), ", use-capture-device-for-encode: ").concat(null == s ? void 0 : s.toString(), ").")) : this.logger.info("capturing desktop (type: <stop>)."), null != this.conn.setDesktopSourceWithOptions ? null != t ? this.conn.setDesktopSourceWithOptions({
                    type: _,
                    sourceId: h,
                    useVideoHook: i,
                    useGraphicsCapture: o,
                    ...
                    hdrCaptureMode: f,
                    enableGlobalFramePoolLock: p
                }) : this.conn.clearDesktopSource() : this.conn.setDesktopSource("wumpus-".concat(h), i, _)
    ...
    setDesktopEncodingOptions(e, t, n) {
        ...
        let r = 0 === t && n >= 10 || t > 720 || n > 30 ? b.oL : b.lo,
            ...
            o = this.videoStreamParameters.findIndex(e => e.quality === b.Y4); - 1 === o && (o = 0), s && (this.videoQualityManager.setGoliveQuality({
            capture: i,
            encode: i,
            bitrateMax: r
        }), this.videoStreamParameters.length > o && (this.videoStreamParameters[o].maxResolution = {
            type: 0 === e && 0 === t ? O.ei.SOURCE : O.ei.FIXED,
            width: e,
            height: t
        }, this.videoStreamParameters[o].maxFrameRate = n, this.videoStreamParameters[o].maxBitrate = r));
    ...
    setLocalVideoSinkWants(e) {
        ...
        for (let [e, o] of Object.entries(this.remoteVideoSSRCs)) {
            ...
            0 === l && 0 !== c && (null == (r = (i = this.conn).setDisableLocalVideo) || r.call(i, e, !1)), 0 !== l && 0 === c && (null == (a = (s = this.conn).setDisableLocalVideo) || a.call(s, e, !0))
        }
            ...
            if (e === b.U9.REMB && this.context === O.x.STREAM) {
                ...
                e.ssrcs.forEach(t => {
                    ...
                    if (void 0 !== o && (null != (n = o.quality) ? n : 0) < 100 && "video" === o.type) {
                        ...
                        (Math.abs(n - l) / ((n + l) / 2) > N || void 0 === o.targetBitrate) && (this.logger.info("Updating target bitrate for SSRC ".concat(t, " from ").concat(o.targetBitrate, " to ").concat(n)), this.videoQualityManager.setGoLiveSimulcastLQTargetBitrate(n), this.updateVideoQuality())
                    }
                })
            }
            ...
            if (null != e) {
                if (null != this.stats) {
                    ...
                    if (null != s && null != o && null != s.framesCaptured && null != o.framesCaptured) {
                        ...
                        if (this.noiseCancellation && t > T && null != s.noiseCancellerProcessTime && null != o.noiseCancellerProcessTime) {
                        ...
                        this.inputMode === O.TB.VOICE_ACTIVITY && this.vadAutoThreshold && this.vadUseKrisp && e > T && null != s.voiceActivityDetectorProcessTime && null != o.voiceActivityDetectorProcessTime && (s.voiceActivityDetectorProcessTime - o.voiceActivityDetectorProcessTime) / e > 4 && this.emit(h.yq.VoiceActivityDetectorError, O.CO.VAD_CPU_OVERUSE)
                    }
                }
                this.stats = e
            }
