/** Chunk was on web.js **/
/** chunk id: 317681, original params: e,t,n (module,exports,require) **/
"use strict";
n.d(t, {
    FV: () => E,
    M3: () => h,
    ...
    n$: () => _,
    pY: () => O
}), n(591487), n(727858), n(747238), n(321073), n(896048), n(446912), n(733351);
var r = n(155718),
    i = n(721768),
    a = n(861382),
    s = n(978561),
...
function h(e) {
    ...
    let r = null != (t = d.VW.above(e, {
        at: e.selection.focus,
        match: e => d.AS.isType(e, "applicationCommandOption")
    })) ? t : null;
    return null != r || d.ZF.isCollapsed(e.selection) ? r : null != (n = d.VW.above(e, {
...
function m(e) {
    ...
    if (null != r)
        for (let e of r) d.AS.isType(e, "applicationCommandOption") && n.push(e.optionName);
    return n
}
