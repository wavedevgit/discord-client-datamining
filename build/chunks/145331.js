...
function p(e) {
    ...
    u.A.initialize(t), n.Ay.trackWithMetadata(c.HAw.SEARCH_OPENED, {
        search_id: _(t),
        search_session_id: u.A.getSessionId(t),
        search_type: t.type
    })
...
function y(e) {
    ...
    n.Ay.trackWithMetadata(c.HAw.MESSAGES_SEARCH_STARTED, {
        ...
        filter_has_count: A,
        filter_before_count: p,
        filter_during_count: R,
...
function v(e) {
    ...
    c.x2k.HISTORY;
    let p = b.get(o) ?? N.get(o),
        R = null != i ? b.get(i) : null;
