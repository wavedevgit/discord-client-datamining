...
function D(e) {
    ...
    return (y && !j && T.push(a.M.ACTIVITY_GDM_CALL_TOOLTIP), n || x?.bot) ? null : (0, i.jsx)(M, {
        channel: t,
        mode: s,
        inCall: r,
        callActive: c,
