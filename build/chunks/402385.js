...
class M extends s.PureComponent {
        ...
        return (0, i.jsxs)(i.Fragment, {
            children: [m, (0, i.jsx)(p.Ay, {
                ...
                children: e => {
                    ...
                    return t === r.M.ACTIVITY_GDM_CALL_TOOLTIP ? (0, i.jsx)(a.AM, {
    ...
    handleStartCall = (e, t) => {
        let {
            ...
            notFriend: i,
            appContext: s
        } = this.props, l = i ? n.getRecipientId() : null, r = () => c.A.call(n.id, t, !i && !n.isManaged() && !e?.shiftKey, l);
        t ? (0, x.A)(r, s) : r()
    };
    handleJoinCall = e => {
    ...
    handleVoiceClick = e => {
        ...
        if (i.includes(r.M.ACTIVITY_GDM_CALL_TOOLTIP) && (0, m.Dr)(r.M.ACTIVITY_GDM_CALL_TOOLTIP, {
...
function D(e) {
    let {
        channel: t
    } = e, n = (0, g.A)(), s = (0, l.bG)([A.A], () => A.A.getMode(t.id)), a = (0, l.bG)([b.A], () => b.A.isInChannel(t.id)), o = (0, l.bG)([u.A], () => u.A.useReducedMotion), {
        callActive: c,
        callUnavailable: d
    } = (0, l.cf)([C.A], () => ({
    ...
    })), x = (0, l.bG)([S.default], () => S.default.getUser(m)), I = (0, _.Us)(), T = [], v = (0, h.A)(t.id), j = (0, l.bG)([E.A], () => E.A.hasLayers());
    return (v && !j && T.push(r.M.ACTIVITY_GDM_CALL_TOOLTIP), n || x?.bot) ? null : (0, i.jsx)(M, {
        channel: t,
        mode: s,
        inCall: a,
        callActive: c,
