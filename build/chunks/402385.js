...
function D(e) {
    ...
    })), x = (0, s.bG)([T.default], () => T.default.getUser(_)), C = (0, g.Us)(), b = [], y = (0, h.A)(t.id), j = (0, s.bG)([I.A], () => I.A.hasLayers());
    return (y && !j && b.push(a.M.ACTIVITY_GDM_CALL_TOOLTIP), n || x?.bot) ? null : (0, i.jsx)(M, {
        channel: t,
        mode: l,
        inCall: r,
        callActive: d,
