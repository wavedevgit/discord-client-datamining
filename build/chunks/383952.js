/** chunk id: 383952, original params: e,t,n (module,exports,require) **/
n.d(t, {
    A: () => w
});
var a = n(627968),
...
function w(e) {
    let t, {
        ...
        {
            name: J
        } = (0, v.x5)(E.oh.AUDIO_INPUT),
        {
            enabledInputProfiles: X
        } = (0, j.d)({
            location: "MicrophoneButton"
        }),
        Z = i.useRef(null),
    ...
    t = G ? {
        ...
        tooltipText: N.intl.string(N.t["29gnR4"]),
        tooltipForceOpen: !0
    } : W || F ? {
        tooltipType: "green_void_do_not_use",
        tooltipText: N.intl.format(N.t.c1qUOQ, {
            ...
            children: (e, n) => {
                ...
                return (0, a.jsxs)("div", {
                    ...
                    children: [(0, a.jsx)(y.A, {
                        ...
                        role: "switch",
                        ...t,
                        children: ea ? (0, a.jsx)("div", {
                            className: l()(R.U, {
                                [R.z]: K
                            })
                        }) : null
                    }), (0, a.jsx)(y.A, {
                        "aria-label": V ? N.intl.formatToPlainString(N.t["18wnuD"], {
                            inputDeviceName: J
                        ...
                        tooltipForceOpen: V,
                        tooltipPositionKey: V ? N.intl.formatToPlainString(N.t["18wnuD"], {
                            inputDeviceName: J
                        }) : void 0,
                        tooltipShouldShow: !o,
                        tooltipText: V ? N.intl.format(N.t["18wnuD"], {
                            inputDeviceName: J
                        }) : N.intl.string(N.t.fRzCbB)
                    })]
                })
