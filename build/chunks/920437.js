...
class K extends l.PureComponent {
    ...
    render() {
        ...
        } else if (n) I.message = H.intl.string(H.t["Eg3/c9"]), I.buttonText = H.intl.string(H.t.fiNVin), I.onButtonClick = p ? this.handleShowMemberVerification : this.handleClaimAccount;
        else if (p) switch (x?.applicationStatus) {
            case E.B5.SUBMITTED:
