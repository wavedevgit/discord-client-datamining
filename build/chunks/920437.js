...
class K extends l.PureComponent {
    ...
    render() {
        ...
        } else if (n) v.message = B.intl.string(B.t["Eg3/c9"]), v.buttonText = B.intl.string(B.t.fiNVin), v.onButtonClick = p ? this.handleShowMemberVerification : this.handleClaimAccount;
