...
class K extends l.PureComponent {
    ...
    renderSuccessPopout = e => {
        ...
        return a()(null != n, "This guildID cannot be null"), (0, i.jsx)(I.A, {
            onClose: t,
            guild: n
        })
    };
    ...
    render() {
        ...
        if (e && !m) {
            if (I.message = H.intl.string(H.t.Hl0Mqh), null != A && A >= 1e3) {
                ...
                I.subtitle = H.intl.formatToPlainString(H.t.C5bgrC, {
                    count: e.toLocaleString()
                })
            }
            I.buttonText = H.intl.string(H.t["3aOv+h"]), I.onButtonClick = this.handleFollowAnnouncement, t && (I.onSecondaryButtonClick = this.handleJoinServer, I.secondaryButtonText = H.intl.string(H.t.RLch70))
        } else if (n) I.message = H.intl.string(H.t["Eg3/c9"]), I.buttonText = H.intl.string(H.t.fiNVin), I.onButtonClick = g ? this.handleShowMemberVerification : this.handleClaimAccount;
        else if (g) switch (x?.applicationStatus) {
            case E.B5.SUBMITTED:
                I.message = H.intl.string(H.t["5iLvSx"]), I.subtitle = H.intl.string(H.t.FdsK4h), I.buttonText = H.intl.string(H.t.mqtdmQ), I.onButtonClick = this.handleCancelApplication;
                break;
            case E.B5.REJECTED:
                I.message = H.intl.string(H.t.lk30cY), I.buttonText = H.intl.string(H.t["8RrsHr"]), I.onButtonClick = this.handleViewApplicationRejection;
                break;
            default:
                I.message = H.intl.string(H.t.rEBKvg), I.buttonText = H.intl.string(H.t["r8/DT+"]), I.buttonVariant = "primary", I.onButtonClick = this.handleShowMemberVerification
        } else C || null == S ? l && !_ ? (I.message = H.intl.string(H.t["2dThMM"]), I.buttonText = H.intl.string(H.t["50gfOv"]), I.onButtonClick = this.handleVerifyPhone) : s ? (I.message = H.intl.string(H.t.FkGPS5), I.buttonText = H.intl.string(H.t.lm1UKt), I.onButtonClick = this.handleResendVerification) : a ? (I.message = H.intl.formatToPlainString(H.t.IH7RMF, {
            min: G.$8o.MEMBER_AGE
        }), I.countdown = r) : o && (I.message = H.intl.formatToPlainString(H.t["2JA2GH"], {
            min: G.$8o.ACCOUNT_AGE
        }), I.countdown = c) : (I.imageSrc = S.getIconURL(F.iu.SMALL) ?? void 0, I.message = H.intl.format(H.t.EvDn1D, {
            name: S.name
        }), null != S.connectionEntrypointUrl && (I.buttonText = H.intl.string(H.t.S0W8Z5), I.onButtonClick = () => {
        ...
        return (0, i.jsx)(d.YNO, {
            ...
            children: e => (0, i.jsx)(U.A, {
                ...I,
                children: (0, i.jsxs)("div", {
                    ref: this.textAreaContainerRef,
                    children: [this.renderMemberVerificationSuccessModal(), p ? (0, i.jsx)(d.YNO, {
...
function W(e) {
    let {
        channel: t,
        children: n
    } = e, l = t.getGuildId(), s = (0, r.bG)([D.A], () => D.A.getGuild(l)), a = (0, r.bG)([O.A], () => O.A.getCheck(l)), o = t.type === G.rbe.GUILD_ANNOUNCEMENT && null != s && s.features.has(G.GuildFeatures.NEWS), c = (0, r.bG)([R.A], () => o ? R.A.getFollowerStatsForChannel(t.id) : null), d = (0, r.bG)([N.A], () => N.A.isLurking(l)), u = (0, r.bG)([P.default], () => P.default.getCurrentUser()), h = u?.isStaff() ?? !1, m = (0, r.bG)([M.Ay], () => null != u && (M.Ay.getMember(l, u.id)?.isPending ?? !1)), p = !!(0, x.Qd)(s), g = (0, r.bG)([T.A], () => T.A.shouldShowPopout(l)), f = (0, r.bG)([L.A], () => L.A.can(G.xBc.SEND_MESSAGES, t)), _ = (0, r.bG)([C.A], () => C.A.getRequest(l)), {
        showLinkedLobbyApplicationLoadingIndicator: S,
        requiredLinkedLobbyApplication: I
    } = (0, w.A)(t.linkedLobby), v = {
        ...a,
        guild: s,
        isLurking: d,
        isFollowable: o,
