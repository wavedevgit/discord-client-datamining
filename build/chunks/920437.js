...
class K extends l.PureComponent {
    ...
    render() {
        ...
        } else C || null == S ? l && !_ ? (N.message = B.intl.string(B.t["2dThMM"]), N.buttonText = B.intl.string(B.t["50gfOv"]), N.onButtonClick = this.handleVerifyPhone) : s ? (N.message = B.intl.string(B.t.FkGPS5), N.buttonText = B.intl.string(B.t.lm1UKt), N.onButtonClick = this.handleResendVerification) : a ? (N.message = B.intl.formatToPlainString(B.t.IH7RMF, {
            min: G.$8o.MEMBER_AGE
