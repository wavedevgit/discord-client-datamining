/** chunk id: 8088 params = (module,exports,require) **/
"use strict";
let n;
i.d(t, {
    A: () => ep
...
function ec(e) {
    (0, m.L3)(e, async () => {
        let {
            default: e
        } = await i.e("92843").then(i.bind(i, 254790));
        return t => (0, s.jsx)(e, {
            ...t,
            version: 0
        })
...
class e_ extends a.Component {
    ...
    componentDidUpdate(e) {
        ...
        if (t) {
            ...
            if (!e.locked && this.props.locked) {
                ...
                v.A.disable(), this.activeKeyEventShapes = [], H.default.isPinned(ea.uss.TEXT) && (v.A.setLayout(x.dY), v.A.enable())
            } else e.locked && !this.props.locked && (window.removeEventListener("contextmenu", ed, !1), null == eo && (eo = Date.now(), g.A.track(ea.HAw.OVERLAY_UNLOCKED)), v.A.disable(), this.activeKeyEventShapes = [], v.A.setLayout(x.CJ), v.A.enable());
    ...
    initialSetup() {
        ...
        if (h || (e = {
            ...
            }, 128), window.addEventListener("resize", this.handleWindowResize), n && window.addEventListener("contextmenu", ed, !1), F.isPlatformEmbedded) {
            let e = (0, z.m)();
            if (null == e) return;
            void 0 !== e.setPerfInfoCallback && (e.setPerfInfoCallback(e => {
                ...
                H.default.getDisableExternalLinkAlert() || t === M.A.getLastURL() ? K.Ay.send("OPEN_EXTERNAL_URL", t) : (0, f.mMO)(async () => {
                    let {
                        default: e
                    } = await i.e("30582").then(i.bind(i, 613429));
                    return i => (0, s.jsx)(e, {
                        ...i,
                        url: t
                    })
    ...
    componentWillUnmount() {
        window.removeEventListener("resize", this.handleWindowResize), window.removeEventListener("keydown", this.onKeyDownGlobal, !0), window.removeEventListener("keyup", this.onKeyUpGlobal, !0), this.props.locked && window.removeEventListener("contextmenu", ed, !1), T.A.terminate(), y.A.terminate(), O.A.terminate()
    }
    ...
    onKeyDownGlobal = e => {
        ...
        i || n || this.activeKeyEventShapes.push(t), this.activeKeyEventShapes.length === this.lockEventShape.length && this.lockEventShape.every(e => this.activeKeyEventShapes.some(t => _()(e, t))) && (e.preventDefault(), e.stopPropagation());
        let {
            locked: s,
            activeRegions: a
        } = this.props;
    ...
    render() {
        ...
        return (0, s.jsxs)("div", {
            ...
            }), n, (!e || o.has(ea.ajI.TEXT_WIDGET)) && (0, s.jsx)(eu, {
                locked: e,
                keybind: t,
            ...
            }) : e ? null : this.renderInvalidSizeMessage(), (0, s.jsx)(ei.A, {}), (0, s.jsx)($.A, {
                locked: h,
                keybind: t
