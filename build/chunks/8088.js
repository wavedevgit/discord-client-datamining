    ...
    initialSetup() {
        ...
        if (h || (e = {
            ...
            void 0 !== e.setPerfInfoCallback && (e.setPerfInfoCallback(e => {
                ...
                H.default.getDisableExternalLinkAlert() || t === M.A.getLastURL() ? F.Ay.send("OPEN_EXTERNAL_URL", t) : (0, _.mMO)(async () => {
                    let {
                        default: e
...
function ef() {
    ...
    })), r = (0, f.bG)([W.A], () => W.A.windowSize()), o = (0, f.bG)([V.Ay], () => V.Ay.getOverlayKeybind()), d = (0, f.bG)([k.A], () => k.A.getVoiceChannelId()), c = (0, f.bG)([D.A], () => D.A.getChannel(d)), u = (0, f.bG)([R.A], () => null != c ? R.A.getGuild(c.guild_id) : null), h = (0, f.bG)([I.Ay, P.A], () => (0, T.A)(I.Ay, P.A)), p = (0, f.bG)([w.Ay], () => (0, N.A)(w.Ay)), _ = (0, f.bG)([j.A], () => null != j.A.getCurrentUserActiveStream()), {
