...
let k = t => null != t ? g.intl.format(g.t["4kp0AB"], {
    ...
    v = t => {
        ...
        if (b.Dp.FRACTIONAL_PREMIUM === e.skuId) {
            ...
            return l ? g.intl.format(g.t.bhLChO, {
    ...
    P = t => {
        ...
        if (b.Dp.ORB_PROFILE_BADGE === e.skuId) _.push({
        ...
        else if (b.Dp.FRACTIONAL_PREMIUM === e.skuId) R ? _.push({
            ...
            _.push({
                ...
                onClick: () => {
                    if (n(), (0, d.jH)(), A?.(), e.type === s.R.AVATAR_DECORATION) {
                        l()(t.type === s.R.AVATAR_DECORATION, "product type and item type are the same"), (0, I.L)({
                    ...
                    if (e.type === s.R.PROFILE_EFFECT) {
                        l()(t.type === s.R.PROFILE_EFFECT, "product type and item type are the same"), (0, L.W)({
                    ...
                    if (e.type === s.R.NAMEPLATE) {
                        l()(t.type === s.R.NAMEPLATE, "product type and item type are the same"), (0, y.p)({
                    ...
                    if (e.type === s.R.PROFILE_FRAME) {
                        l()(t.type === s.R.PROFILE_FRAME, "product type and item type are the same"), (0, m.w)({
