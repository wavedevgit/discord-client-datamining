...
var i = n(64700),
    ...
    b = n(625265),
    k = n(985018);
let S = t => null != t ? k.intl.format(k.t["4kp0AB"], {
        itemName: t
    }) : null,
    g = t => {
        let {
        ...
        return k.intl.formatToPlainString(k.t.YNaxMp, {
            itemName: a
        })
    },
    v = t => {
        ...
        if (m.Dp.FRACTIONAL_PREMIUM === e.skuId) {
            let t = k.intl.formatToPlainString(k.t.Cz1G97, {
                days: 3
            });
            return l ? k.intl.format(k.t.bhLChO, {
                helpCenterLink: A.A.getArticleURL(T.MVz.FRACTIONAL_PREMIUM_ABOUT),
                duration: t,
                expirationDate: u
            }) : d ? k.intl.string(k.t.fBmhE9) : k.intl.format(k.t["1ZBX4E"], {
                helpCenterLink: A.A.getArticleURL(T.MVz.FRACTIONAL_PREMIUM_ABOUT),
                duration: t
            })
        }
        if (e.type === s.R.BUNDLE) {
            ...
            return k.intl.format(k.t.fXw44U, {
                itemOneName: t,
                itemTwoName: n
            })
        }
    ...
    M = t => {
        ...
        if (m.Dp.ORB_PROFILE_BADGE === e.skuId) L.push({
            ...
            onClick: () => {
                n(), (0, E.Y)({
                    ...
                    fromContent: o.uF.REWARD_MODAL
                })
            }
        });
        else if (m.Dp.FRACTIONAL_PREMIUM === e.skuId) I ? L.push({
            ...
            L.push({
                ...
                onClick: () => {
                    if (n(), (0, d.jH)(), A?.(), e.type === s.R.AVATAR_DECORATION) {
                        l()(t.type === s.R.AVATAR_DECORATION, "product type and item type are the same"), (0, _.L)({
                    ...
                    if (e.type === s.R.PROFILE_EFFECT) {
                        l()(t.type === s.R.PROFILE_EFFECT, "product type and item type are the same"), (0, y.W)({
                    ...
                    if (e.type === s.R.NAMEPLATE) {
                        l()(t.type === s.R.NAMEPLATE, "product type and item type are the same"), (0, R.p)({
