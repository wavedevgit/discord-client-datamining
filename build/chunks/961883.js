...
var i = n(64700),
    ...
    m = n(839358),
    v = n(985018);
let C = t => null != t ? v.intl.format(v.t["4kp0AB"], {
        itemName: t
    }) : null,
    L = t => {
        let {
    ...
    U = t => {
        ...
        if (O.Dp.ORB_PROFILE_BADGE === e.skuId) y.push({
            ...
            onClick: () => {
                n(), (0, A.Y)({
                    ...
                    fromContent: u.uF.REWARD_MODAL
                })
            }
        });
        else if (O.Dp.FRACTIONAL_PREMIUM === e.skuId) f ? y.push({
