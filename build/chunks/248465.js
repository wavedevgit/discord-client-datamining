...
let eZ = [F.I6, F.vM, ec.rbe.GUILD_CATEGORY];
...
function e0(e) {
    ...
    for (; m < h;) {
        ...
        let e, r, f = n[m];
        f instanceof M.A ? (r = f, e = null == (y = B.Ay.getNick(c, r.id)) ? void 0 : y.toLocaleLowerCase()) : (e = null == (b = f.nick) ? void 0 : b.toLocaleLowerCase(), r = l[f.userId]);
        ...
        if (null != r && (null == i || i(r))) {
            let n = r.username.toLocaleLowerCase(),
                ...
                [c, f] = e$(e),
                [m, E] = e$(h);
            s && t === r.id || n.substring(0, u.length) === u || i.substring(0, u.length) === u || (null == e ? void 0 : e.substring(0, u.length)) === u || (null == c ? void 0 : c.substring(0, u.length)) === u || (null == h ? void 0 : h.substring(0, u.length)) === u || (null == m ? void 0 : m.substring(0, u.length)) === u ? p.push({
                type: eu.rD.USER,
                record: r,
...
let te = (0, ee.L_)((e, t, n) => {
    ...
    tt = {
        ...
        queryStaticRouteChannels(e) {
            ...
            for (let e of l)(e.id !== ed.T4.SERVER_GUIDE || a) && (e.id !== ed.T4.CHANNEL_BROWSER || s) && (e.id !== ed.T4.CUSTOMIZE_COMMUNITY || o) && eQ(e.name.toLocaleLowerCase(), i, !1) > 0 && c.push(new L.jb({
                id: e.id,
                name: e.name,
                type: ec.rbe.UNKNOWN,
                guild_id: n.id
        ...
        queryStickers(e) {
            ...
            return 0 === (s = o()(s).sortBy(e => -1 * e.score).value()).length && (s = eF), s
        },
        querySoundmoji(e, t) {
        ...
        queryMentionSuggestionResults(e) {
            ...
            c: for (let e of s) {
                ...
                let t, s;
                if (p.length >= r) break;
                if (e instanceof M.A ? (s = e, t = null == (m = B.Ay.getNick(c, s.id)) ? void 0 : m.toLocaleLowerCase()) : (t = null == (g = e.nick) ? void 0 : g.toLocaleLowerCase(), s = l[e.userId]), null == s || s.id === o || s.bot) continue;
