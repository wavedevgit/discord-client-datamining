/** chunk id: 319543, original params: A,e,t (module,exports,require) **/
t.d(e, {
    Ay: () => C,
    Jn: () => p,
    id: () => m
...
function f(A) {
    ...
    return null != a ? (0, n.jsx)(o.CR_, {
        items: [{
            id: a.id,
            label: a.name,
            icon: {
                type: "role",
                color: (0, i.Hl)(a.color)
            }
        }],
        onRemove: t
    }) : (e = (0, n.jsx)(o.y$y, {
...
function C(A) {
    let {
        ...
        listingRoleId: q,
        error: p
    } = A, m = (0, l.bG)([d.A], () => null != q ? d.A.getRole(i, q) : void 0);
    return null === e ? (0, n.jsx)(o.D0$, {
        ...
        children: (0, n.jsx)(f, {
            role: m,
            onRemove: () => {
                r()(null != c, "productId cannot be null"), r()(null != m, "no role attached"),
                    function(A) {
                        let {
                            onConfirm: e,
                            roleName: a
    ...
    }) : (r()(null != e, "newRoleParams cannot be null at this point"), (0, n.jsx)(o.D0$, {
        required: !0,
