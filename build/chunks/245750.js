...
function g(e) {
    ...
    (0, s.Ay)(() => {
        let e = () => T(!0);
        return u._.subscribe(h.jej.PREMIUM_GROUP_PURCHASE_FLOW_COMPLETED, e), () => {
    ...
    return t = null != r ? p.intl.formatToPlainString(p.t.Gzh6ZP, {
        webBuildOverride: r.id
    }) : p.intl.string(p.t.cduTBL), (0, a.jsxs)(a.Fragment, {
        children: [(0, a.jsx)(m.A, {
            ...
            children: e => {
                ...
                if (t === l.M.NITRO_PRIVACY_PERK_BETA_COACHMARK) return (0, a.jsx)(c.y, {
                    targetElementRef: C,
                    markAsDismissed: n
                })
            }
