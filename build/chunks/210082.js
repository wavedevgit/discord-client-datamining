...
function h(e) {
    return (0, i.cf)([s.A, a.A, r.default, l.A, o.A, c.Ay, d.Ay], () => u.default.keys(e).reduce((e, t) => {
        let n = a.A.getChannel(t),
            i = n?.getGuildId(),
            l = c.Ay.getMentionCount(t);
        if (e.badge = e.badge + l, e.unread = e.unread || c.Ay.hasUnread(t) && r.default.shouldCountChannelUnread(n, l), null != i) {
