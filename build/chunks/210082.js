...
function h(e) {
    return (0, i.cf)([l.A, a.A, r.default, s.A, o.A, c.Ay, d.Ay], () => u.default.keys(e).reduce((e, t) => {
        let n = a.A.getChannel(t),
            i = n?.getGuildId(),
            s = c.Ay.getMentionCount(t);
        if (e.badge = e.badge + s, e.unread = e.unread || c.Ay.hasUnread(t) && r.default.shouldCountChannelUnread(n, s), null != i) {
