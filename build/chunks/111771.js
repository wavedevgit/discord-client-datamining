/** chunk id: 111771 params = (module,exports,require) **/
"use strict";
n.d(t, {
    A: () => h
});
...
function h(e) {
    let {
        ...
        className: h,
        onChange: _
    } = e, [A, p] = s.useState(n), [f, j] = s.useState(!1), [N, E] = s.useState(!1), T = s.useRef(null);
    s.useEffect(() => {
        p(n)
    }, [n]), s.useEffect(() => () => {
        clearTimeout(T.current)
    }, []);
    let C = l.find(e => e.value === A);
    return (0, i.jsx)(u.A, {
        title: f ? t : C?.title ?? t,
        ...
        children: l.map((e, t) => (0, i.jsx)(m.A, {
            ...
            onClick: () => {
                e.disabled || e.value === A || (E(!0), _?.(e), p(e.value), T.current = setTimeout(() => {
                    E(!1), j(!1)
                }, 1e3))
            },
            disabled: e.disabled
