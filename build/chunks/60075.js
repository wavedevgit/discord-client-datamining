/** chunk id: 60075, original params: e,t,l (module,exports,require) **/
l.d(t, {
    D5: () => y,
    Ec: () => b,
    KF: () => A,
...
function p() {
    let e = n.useCallback(() => {
        (0, i.mMO)(async () => {
            let {
                default: e
            } = await Promise.resolve().then(l.bind(l, 32605));
            return t => (0, a.jsx)(e, {
                analyticsSource: {},
                ...t
            })
...
function x() {
    let e = n.useCallback(() => {
        (0, i.mMO)(async () => {
            let {
                default: e
            } = await l.e("66920").then(l.bind(l, 220763));
            return t => (0, a.jsx)(e, {
                channel: null,
                ...t
            })
...
function b() {
    let [e] = n.useState("This is a sample long message that exceeds the character limit."), t = n.useCallback(() => {
        (0, i.mMO)(async () => {
            let {
                default: t
            } = await l.e("76725").then(l.bind(l, 798612));
            return l => (0, a.jsx)(t, {
                channel: null,
                content: e,
                ...l
...
let g = [{
        ...
        value: d.e.PROFILE_EFFECT_MODAL_UPSELL
    }, {
        id: "nameplate",
        label: "Nameplate",
...
function j() {
    let [e, t] = n.useState(c.HL.AVATAR), u = (0, r.bG)([o.default], () => o.default.getCurrentUser()), d = n.useCallback(() => {
    ...
    let e = (0, r.bG)([o.default], () => o.default.getCurrentUser()),
        t = n.useCallback(() => {
            null != e && (0, i.mMO)(async () => {
                let {
                    default: t
                } = await l.e("97674").then(l.bind(l, 407217));
                return l => (0, a.jsx)(t, {
                    user: e,
                    analyticsSource: {},
                    analyticsLocation: {},
...
function P() {
    let e = n.useCallback(() => {
        (0, i.mMO)(async () => {
            let {
                default: e
            } = await l.e("90617").then(l.bind(l, 663072));
            return t => (0, a.jsx)(e, {
                analyticsSource: {},
                analyticsLocation: {},
                ...t
