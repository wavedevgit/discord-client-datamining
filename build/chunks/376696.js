...
function U(e) {
    ...
    let H = (0, u.Ay)(t),
        ...
        W = (0, C.W)(),
        [Y, z] = (0, a.yK)([b.A], () => [b.A.getStreamForUser(n.id, t.getGuildId()), b.A.getActiveStreamForUser(n.id, t.getGuildId())], [t, n.id]),
        ...
        $ = (0, d.m)(n, U ?? Q),
        Z = (0, a.bG)([j.Ay], () => j.Ay.getVoiceStatesForChannel(t).find(e => e.user.id === n.id) ?? null, [t, n.id]),
    ...
    return (0, i.jsxs)(o.HOs, {
        ...
        children: [eo && en && null != w ? (0, i.jsx)(f.Z, {
            ...
            iconClassName: G.W9,
            textClassName: G.YJ
        }) : null, null == Y || null == P || el ? null : (0, i.jsx)(m.P, {
            stream: Y,
            activeStream: z,
            streamActivity: Q,
            user: n,
            ...
            onAction: l,
            enableUserHoverActivities: et
        }, e.application.id)), $.map(e => {
            let r = e.application_id;
            return (null != W && (r = W), es && null != r && D.sQ.has(r)) ? (0, i.jsxs)(s.Fragment, {
