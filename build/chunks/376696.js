...
function w(e) {
    ...
    let W = (0, u.Ay)(t),
        ...
        [J, Q] = (0, a.yK)([S.A], () => [S.A.getStreamForUser(n.id, t.getGuildId()), S.A.getActiveStreamForUser(n.id, t.getGuildId())], [t, n.id]),
        ...
        en = (0, d.m)(n, w ?? et),
        ei = (0, a.bG)([O.Ay], () => O.Ay.getVoiceStatesForChannel(t).find(e => e.user.id === n.id) ?? null, [t, n.id]),
        ...
        eA = ed || eu || eh && el;
    return (s.useEffect(() => {
        eo && el || eA && L.default.track(D.HAw.OPEN_POPOUT, {
            type: "Voice User Activities",
            channel_id: t.id,
            other_user_id: n.id
        })
    }, [eo, el, eA, t.id, n.id]), eo && el) ? (0, i.jsx)(x.h, {
        channel: t,
        setIsHangStatusInputFocused: H,
        setIsEmojiPickerOpen: F
    }) : eA ? (0, i.jsxs)(o.HOs, {
        className: r()(k.popover, P.kL),
        children: [eh && el && null != B ? (0, i.jsxs)("div", {
            className: P.Sz,
        ...
        }) : null, null == J || null == V || ec ? null : (0, i.jsx)(g.P, {
            stream: J,
            activeStream: Q,
            streamActivity: et,
            user: n,
        ...
        }, e.application.id)), en.map(e => {
            let r = e.application_id;
            return (null != q && (r = q), er && null != r && null != ea[r]) ? (0, i.jsxs)(s.Fragment, {
            ...
            }, `${e.application_id}-with-gifting-breadcrumb`) : (0, i.jsx)(M.A, {
                presenceActivity: e,
                channel: t,
                members: es,
                onAction: l,
