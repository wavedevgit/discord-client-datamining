...
function k(e) {
    ...
    let W = (0, u.Ay)(t),
        ...
        ec = er || eo || ed && en;
    return (l.useEffect(() => {
        es && en || ec && O.default.track(M.HAw.OPEN_POPOUT, {
        ...
        children: [ed && en && null != B ? (0, i.jsxs)("div", {
            className: G.Sz,
            ...
            channel: t,
            onAction: s
        }, e.application.id)), et.map(e => {
            let a = e.application_id;
            return (null != z && (a = z), ei && null != a && null != el[a]) ? (0, i.jsxs)(l.Fragment, {
