...
function U(e) {
    ...
    let H = (0, u.Ay)(t),
        ...
        [z, X] = (0, r.yK)([N.A], () => [N.A.getStreamForUser(n.id, t.getGuildId()), N.A.getActiveStreamForUser(n.id, t.getGuildId())], [t, n.id]),
        [q, J] = (0, r.yK)([v.A, S.A, T.A, A.default], () => (0, p.eo)(t, v.A, S.A, T.A, A.default)),
