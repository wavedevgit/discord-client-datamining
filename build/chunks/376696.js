...
function G(e) {
    ...
    let B = (0, u.Ay)(t),
        ...
        K = (0, x.W)(),
        [W, Y] = (0, a.yK)([I.A], () => [I.A.getStreamForUser(n.id, t.getGuildId()), I.A.getActiveStreamForUser(n.id, t.getGuildId())], [t, n.id]),
        ...
        Q = (0, d.m)(n, G ?? J),
        $ = (0, a.bG)([v.Ay], () => v.Ay.getVoiceStatesForChannel(t).find(e => e.user.id === n.id) ?? null, [t, n.id]),
        Z = s.useMemo(() => null != $ ? [$] : [], [$]),
        {
        ...
        eo = es || el || er && et;
    if (s.useEffect(() => {
            eo && j.default.track(L.HAw.OPEN_POPOUT, {
                type: "Voice User Activities",
                channel_id: t.id,
                other_user_id: n.id
            })
        }, [eo, t.id, n.id]), !eo && !ea) return null;
    if (ea) {
        if (et) return w({
            position: "right",
            nudge: 0,
    ...
    return (0, i.jsxs)(o.HOs, {
        ...
        children: [er && et && null != P ? (0, i.jsx)(_.Z, {
            hangStatusActivity: P,
            channel: t,
            userId: n.id,
            isSelf: ea,
            ...
            iconClassName: D.W9,
            textClassName: D.YJ
        }) : null, null == W || null == U ? null : (0, i.jsx)(g.P, {
            stream: W,
            activeStream: Y,
            streamActivity: J,
            user: n,
            ...
            onAction: l,
            enableUserHoverActivities: ee
        }, e.application.id)), Q.map(e => {
            let r = e.application_id;
            return (null != K && (r = K), ei && null != r && M.sQ.has(r)) ? (0, i.jsxs)(s.Fragment, {
            ...
            }, `${e.application_id}-with-gifting-breadcrumb`) : (0, i.jsx)(O.A, {
                presenceActivity: e,
                channel: t,
                members: Z,
                onAction: l,
