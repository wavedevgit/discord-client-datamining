/** chunk id: 567987 params = (module,exports,require) **/
n.d(t, {
    E: () => I
});
var r = n(627968),
...
function I(e) {
    ...
    return i.useCallback((e, i, l, I) => {
        if (null == t) return;
        let p = {
            context: A.BRT.CALL_TILE_POPOUT
        };
        switch (e.type) {
                ...
                if (null != w) {
                    ...
                    switch (t.type) {
                        ...
                        case A.rbe.GROUP_DM:
                            return (0, a.L3)(i, async () => {
                                ...
                                return n => (0, r.jsx)(e, {
                                    ...
                                    channel: t,
                                    showModalItems: !0,
                                    onInteraction: (0, c.s)("GroupDMUserContextMenu", o.A.CALL_TILE_POPOUT, {
                                        entrypoint: I,
                                        tileType: h.qs.USER,
                                        targetUserId: w.id
                                    })
                        ...
                        case A.rbe.PRIVATE_THREAD:
                            let e = t.getGuildId();
                            return s()(null != e, "GuildID null for guild voice channel"), (0, a.L3)(i, async () => {
                                let {
                                    default: i
                                ...
                                return n => (0, r.jsx)(i, {
                                    ...
                                    guildId: e,
                                    showModalItems: !0,
                                    onInteraction: (0, c.s)("GuildChannelUserContextMenu", o.A.CALL_TILE_POPOUT, {
                                        entrypoint: I,
                                        tileType: h.qs.USER,
                                        targetUserId: w.id
                                    })
