...
let C = s().throttle(function(e, t) {
    ...
    let s, l, u, {
        ...
        f = (r = T, l = (s = [g.ME, ...c.Ay.getFlattenedGuildIds()]).indexOf(r), e > 0 ? s.slice(l).concat(s.slice(0, l), r) : (s.splice(l, 0, r), s.slice(l + 1).concat(s.slice(0, l + 1)))),
        N = e > 0 ? 0 : f.length - 1,
        L = h(T, S),
        O = L.indexOf(b) + e;
    for (; null != T && "" !== T;) {
        if (u = L[O], C(T))
            for (; null != u && "" !== u;) {
                ...
                } else if ("object" == typeof u && p(u.resourceId, u.type)) return T !== _.A.getGuildId() && (0, E.i)(T, d.Ay.getDefaultChannel(T)?.id), (0, a.mMO)(async () => {
                    let {
                        default: e
                    } = await Promise.all([n.e("51354"), n.e("7453"), n.e("42480")]).then(n.bind(n, 926956));
                    return t => (0, i.jsx)(e, {
                        ...t,
                        guildId: T
                    })
