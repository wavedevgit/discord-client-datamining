...
let m = [{
    ...
    h = [{
        id: "meta_quest",
        value: u.uH.META_QUEST_WEB_REDIRECT_CHECKOUT,
        label: "Meta Quest Web Redirect Checkout"
    }];
...
let f = {
    ...
    component: function() {
        let [e, t] = n.useState(!1), [l, r] = n.useState(u.uH.META_QUEST_WEB_REDIRECT_CHECKOUT), s = n.useCallback(e => {
            t(e)
        }, []), c = e ? l : void 0;
        return (0, a.jsxs)(d.wn, {
            ...
            }), (0, a.jsx)(d.nB, {}), (0, a.jsxs)(o.BJc, {
                direction: "horizontal",
                gap: 8,
                align: "end",
                children: [(0, a.jsx)(o.Checkbox, {
                    label: "Enable Flow Type",
                    checked: e,
                    onChange: s
                }), (0, a.jsx)(o.l6P, {
                    label: "Flow Type",
