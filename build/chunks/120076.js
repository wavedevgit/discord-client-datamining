/** chunk id: 120076 params = (module,exports,require) **/
n.d(t, {
    e: () => c
});
var i = n(627968),
...
function o(e) {
    let {
        ...
        profilePic: s,
        adminTitle: o,
        emphasisColor: c = "interactive-text-default"
    } = t;
    return (0, i.jsxs)("div", {
        className: n,
        children: [(0, i.jsx)(r.Text, {
            ...
            children: a.intl.format(l, {
                testimonialHook: (e, t) => (0, i.jsx)(r.Text, {
                    tag: "span",
...
function c(e) {
    let {
        ...
        [n, s], o
    ] = l.useState([0, "right"]), c = l.useCallback(() => {
        o(e => {
            let [n] = e;
            return 0 === n ? [t.length - 1, "left"] : [n - 1, "left"]
        })
    }, [o, t.length]), m = l.useCallback(() => {
        o(e => {
            let [n] = e;
            return [(n + 1) % t.length, "right"]
        })
    }, [o, t.length]), N = t[n], h = l.useCallback((e, t, n, l) => (0, i.jsx)(u, {
        item: t,
        state: n,
        cleanup: l,
        direction: s
