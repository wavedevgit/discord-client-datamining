...
function et(e) {
    let {
        prompt: t,
        guild: n
    } = e, [s, c] = i.useState(null), [u, _] = i.useState(new Set), h = t?.options?.filter(e => u.has(e.id)), x = (0, M.a)(h), m = (0, M.vV)(h), A = (0, r.yK)([H.A], () => H.A.getOnboardingResponsesForPrompt(n.id, t.id)), {
        helpText: g,
        ...
        children: [t.isNew && (0, l.jsx)(o.LpS, {
            ...
            onChange: e => {
                ...
                if (null != n) f(t, n, !0), t.singleSelect && t.options.forEach(e => u.delete(e.id)), u.add(n.id);
                    ...
                    if (A.length <= n.length && t.required) return void c({
                        type: $
                    });
                    n.forEach(e => {
...
function ei(e) {
    let {
        guildId: t,
        onBrowseChannels: n
    } = e, s = (0, c.Mw)((0, x.Ay)()), h = (0, r.bG)([S.A], () => S.A.getGuild(t)), m = (0, r.bG)([y.default], () => y.default.getCurrentUser()), A = (0, _.A)("(min-width: 1344px)") && null != m, g = i.useCallback(() => {
