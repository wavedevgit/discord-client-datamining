...
function j(e) {
    ...
    if (s.useEffect(() => {
            ...
            null != n && n.forEach(e => {
                (0, u.Dr)(e, {
                    dismissAction: p.i.AUTO,
                    forceTrack: !0
                })
            })
        }, [t]), a && t.hideInStreamerMode) return (0, i.jsx)(d.A, {});
    if (null != t.StronglyDiscouragedCustomComponent) return (0, i.jsx)(b, {
        component: t.StronglyDiscouragedCustomComponent,
        panelKey: t.key,
        notice: t.notice
    });
    if ((0, A.zY)(n)) return (0, i.jsx)(f, {
        panelKey: t.key,
        notice: t.notice,
        decoration: t.decoration,
        layout: n
    });
    if ((0, A.Iu)(n)) return (0, i.jsx)(N, {
        panelKey: t.key,
        notice: t.notice,
        decoration: t.decoration,
        layout: n
