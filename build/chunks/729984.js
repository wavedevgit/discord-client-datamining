    ...
    return (0, i.jsxs)(i.Fragment, {
        children: [(0, i.jsxs)("div", {
            ...
            children: [(0, i.jsxs)("div", {
                ...
                }), null != t.topic && t.topic.length > 0 ? (0, i.jsx)(a.A, {
                    className: O.PT,
                    children: (0, i.jsx)(o.Text, {
                        className: R.At,
                        variant: "text-xs/normal",
                        children: g.A.parseTopic(t.topic, !0, {
                            channelId: t.id
                        })
                    })
                }, "topic") : null]
            }), (0, c.S)(n.id, t.id) ? (0, i.jsx)(o.Button, {
                size: "sm",
                variant: "primary",
...
function L(e) {
    ...
    return g || 0 === m.length ? null : (0, i.jsxs)("div", {
        className: R.Jl,
        children: [(0, i.jsx)(o.Text, {
            variant: "text-md/medium",
            color: "text-strong",
...
function D(e) {
    let {
        saveOnClose: t = !1
    } = e, n = (0, l.bG)([f.A], () => f.A.getGuild()), r = (0, l.bG)([u.A], () => u.A.isLoading()), a = (0, l.bG)([A.Ay], () => A.Ay.getChannels(n?.id)), d = (0, l.bG)([_.A], () => _.A.getCategories(n?.id)), c = (0, l.bG)([C.A], () => C.A.advancedMode), m = s.useRef(null), [g, x] = s.useState(!1), h = s.useRef(n);
    return (s.useEffect(() => {
        h.current = n
    }), s.useEffect(() => {
        if (t) {
    ...
    }, [t, c]), null == n) ? null : r ? (0, i.jsx)(o.y$y, {}) : (0, i.jsxs)("div", {
        className: R.YB,
        children: [(0, i.jsxs)("div", {
            className: R.U5,
