/** chunk id: 484740 params = (module,exports,require) **/
n.d(t, {
    A: () => g
}), n(321073);
var i = n(627968);
...
function g(e, t) {
    ...
    let A = (0, d.A)({
        id: t.id,
        label: x.intl.string(x.t.sMsaLg)
    });
    null != A && h.push(A);
    ...
    if (!g && !_ && !j) {
        let l = async () => {
            ...
            (0, a.mMO)(async () => {
                let {
                    default: e
                } = await n.e("54915").then(n.bind(n, 360494));
                return n => (0, i.jsx)(e, {
                    ...n,
                    roleName: t.name,
                    onConfirmDelete: l
            ...
            (0, s.A)({
                ...
                subtitle: x.intl.format(x.t["9+nrUS"], {
                    name: t.name
                }),
