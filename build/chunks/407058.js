/** chunk id: 407058 params = (module,exports,require) **/
n.d(e, {
    A: () => I
});
var s = n(627968),
...
let I = function(t) {
    let {
        ...
        warningType: o,
        transitionToSlide: L
    } = t, I = (0, u.N)(), U = (0, u.z)(), F = (0, _.W)(l), v = null != (0, E.e)(l), y = (0, a.bG)([x.A], () => x.A.isIgnored(e), [e]), Y = (0, a.bG)([x.A], () => x.A.isBlocked(e), [e]), k = i.useCallback(t => {
        (0, g._$)({
            channelId: l,
            warningId: r,
            senderId: e,
        ...
        variant: "primary",
        onPress: () => {
            Y ? (W(), A.A.showUnblockSuccessToast(e, l)) : (0, T.mMO)(async () => {
                let {
                    default: t
