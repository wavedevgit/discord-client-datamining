...
let h = () => {
    let {
        ...
        channel: t,
        updateMessageText: a
    } = (0, u.Vw)(), h = (0, l.bG)([o.A], () => o.A.getDraft(e.channel_id, o.C.ChannelMessage)), [I, E] = n.useState(() => (0, _.ur)(h)), {
        textValue: C,
        richValue: L
    } = I;
    (0, n.useEffect)(() => {
    ...
    let N = n.useCallback((t, a, s) => {
            E({
                textValue: a,
                richValue: s
            }), r.A.saveDraft(e.channel_id, a, o.C.ChannelMessage)
        }, [e]),
        [b, f] = n.useState(!1),
        g = n.useCallback(() => f(!0), []),
        P = n.useCallback(() => f(!1), []);
