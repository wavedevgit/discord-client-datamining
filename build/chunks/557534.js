...
function v(e) {
    let {
        ...
        forceShowButtons: m,
        hasChannelInfo: C = !1
    } = e, E = (0, a.bG)([f.A], () => f.A.getGuild(t.getGuildId())), S = (0, a.bG)([p.A], () => p.A.getStageInstanceByChannel(t.id), [t.id]), T = (0, a.bG)([u.Ay], () => u.Ay.getActiveEventByChannel(t.id), [t.id]), y = (0, a.bG)([x.A], () => (0, h.K)(x.A, E, t, S)), v = (0, a.bG)([], () => t?.type === I.rbe.GUILD_VOICE ? b.intl.string(b.t["EE+P0H"]) : b.intl.string(b.t["0jeAXt"])), j = s.useRef(null);
