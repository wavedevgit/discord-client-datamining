...
function y(e) {
    ...
    return (0, a.bG)([C.A, E.A], () => n || (0, u.ai)(E.A.getGuildId()) || !C.A.can(N.xBc.MANAGE_CHANNELS, t) && !C.A.can(N.xBc.MANAGE_ROLES, t) && !C.A.can(N.xBc.MANAGE_WEBHOOKS, t) || (0, _.tr)(t.type) && !C.A.can(N.xBc.VIEW_CHANNEL, t) || t.isGuildVocal() && !C.A.can(N.xBc.CONNECT, t) || !_.bk.has(t.type) || t.isModeratorReportChannel()) ? null : (0, i.jsx)(o.m, {
        asContainer: !0,
...
function j(e) {
    let {
        ...
        forceShowButtons: m,
        hasChannelInfo: _ = !1
    } = e, E = (0, a.bG)([x.A], () => x.A.getGuild(t.getGuildId())), I = (0, a.bG)([p.A], () => p.A.getStageInstanceByChannel(t.id), [t.id]), T = (0, a.bG)([h.Ay], () => h.Ay.getActiveEventByChannel(t.id), [t.id]), v = (0, a.bG)([C.A], () => (0, A.K)(C.A, E, t, I)), y = (0, a.bG)([], () => t?.type === N.rbe.GUILD_VOICE ? b.intl.string(b.t["EE+P0H"]) : b.intl.string(b.t["0jeAXt"])), j = s.useRef(null);
