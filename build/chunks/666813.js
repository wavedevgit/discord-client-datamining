/** chunk id: 666813 params = (module,exports,require) **/
n.d(t, {
    A: () => N
});
var l = n(627968),
...
function N(e) {
    let {
        member: t
    } = e, n = (0, a.bG)([c.A], () => c.A.getGuild(t.guildId), [t.guildId]), N = (0, E.GT)(t.userId, t.guildId), h = (0, E.Wi)(t.userId, t.guildId), m = (0, E.t)(t.userId), S = (0, E.ff)(t.userId, t.guildId);
    return (r.useEffect(() => {
        (0, o.uO)(t.guildId)
        ...
        children: (0, l.jsxs)(A.SQ, {
            children: [(0, l.jsx)(A.RU, {
                ...
                description: h === E.bM.AGREED ? (0, l.jsx)(i.rOg, {
                    size: "custom",
                    width: A.mb,
                    height: A.mb,
                    color: i.LU0.colors.STATUS_POSITIVE
