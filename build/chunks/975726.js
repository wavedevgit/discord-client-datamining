...
function D(e) {
    let {
        ...
        className: l,
        inputClassName: c
    } = e, u = (0, o.bG)([_.A], () => _.A.hidePersonalInformation), C = (0, E.Ut)();
    return null == t ? null : (0, a.jsx)(d.A, {
        className: l,
        inputClassName: c,
        ...
        onCopy: () => {
            u && (0, h.C)(t.code), C({
                questId: r,
                questContent: n,
                questContentCTA: w.Cy.COPY_REWARD_CODE,
                sourceQuestContent: s
            })
        }
    })
    ...
    return (0, a.jsxs)("div", {
        ...
        children: [(0, a.jsx)("div", {
            ...
            children: [(0, a.jsx)(l.Heading, {
                ...
                variant: "text-sm/medium",
                color: "text-subtle",
                children: k.intl.format(k.t["ESmp2+"], {
                    onClaimInstructions: o
                })
            })]
        }), (0, a.jsx)(D, {
...
function b(e) {
    ...
    t = (0, u.A)(() => {
        L(!0)
    }), n = C.default.useIsCaptchaModalOpen(), s = (0, c.A)(n), i = !!(!n && s), r.useEffect(() => {
        i && t()
    }, [i, t]);
    let D = null == E && (w || j),
        b = k && !j && !w;
    return (0, a.jsx)(S.A, {
        ...
        rewardContent: b ? null : (0, a.jsx)(v.A, {
            ...
            children: (0, a.jsx)(M, {
                ...
                sourceQuestContent: h,
                onClaimInstructions: () => {
                    (0, l.mMO)(() => Promise.resolve(e => (0, a.jsx)(O.R, {
                        questOrQuests: m,
                        questContent: y,
                        sourceQuestContent: h,
