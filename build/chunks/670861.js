...
function A(e) {
    ...
    }, [t]), _ = (0, r.bG)([a.A], () => null != n ? a.A.getChannel(n) : null, [n]), m = (0, r.bG)([s.A], () => _?.guild_id != null ? s.A.getGuild(_.guild_id) : null, [_]), g = (0, r.yK)([d.A, o.A], () => null == n ? [] : A.map(e => d.A.getMessage(e) ?? o.A.getMessage(n, e)).filter(e => null != e), [n, A]);
