...
n.r(t), n.d(t, {
    VideoQuestConfigContext: () => R,
    VideoQuestModalContext: () => k,
    default: () => O
});
var r = n(627968),
    i = n(64700),
...
function w(e) {
    ...
    } = e, A = (0, S.Yh)(s), R = (0, x.LS)(s), w = (0, g.go)(), [O, P] = i.useState(A.progressSeconds), [V, Q] = i.useState(142), [U, B] = i.useState(!1), F = s.config.taskConfigV2?.tasks?.[u.n.WATCH_VIDEO];
    ...
    return (0, r.jsx)(k.Provider, {
        ...
        children: (0, r.jsx)("div", {
            style: $ ? {
                "--custom-portrait-footer-height": `${V}px`
            } : void 0,
            children: (0, r.jsxs)(d.EOs, {
                ...
                children: [!H && (0, r.jsx)("div", {
                    ...
                    children: (0, r.jsx)("div", {
                        className: M.S3,
                        style: {
                            "--custom-footer-horizontal-padding": `${H?20:16}px`
                        },
...
function O(e) {
    let {
        ...
        ...a
    } = e, o = (0, c.bG)([f.A], () => f.A.getQuest(t)), u = (0, c.bG)([f.A], () => f.A.getQuestConfig(t)), d = n ?? o, m = null != n ? n.config : u, p = i.useMemo(() => null != m ? {
        questConfig: m
    } : null, [m]);
    return null != d && null != m && null != p ? (0, r.jsx)(R.Provider, {
        value: p,
