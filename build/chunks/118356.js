...
class d {
    ...
    constructor(e = "default") {
        ...
        i(this, "name", void 0), i(this, "nativeLoggerEnabled", void 0), i(this, "logDangerously", function(e) {
            ...
            (0, r.G)(e, ...i), o(t.name, "log", e, ...i), t.nativeLoggerEnabled && (null == l || l(t.name, "log", e, ...i))
            ...
            for (var n = arguments.length, i = Array(n > 1 ? n - 1 : 0), a = 1; a < n; a++) i[a - 1] = arguments[a];
            (0, r.G)(e, ...i), o(t.name, "debug", e, ...i), t.nativeLoggerEnabled && (null == l || l(t.name, "debug", e, ...i))
        }), i(this, "info", function(e) {
            for (var n = arguments.length, i = Array(n > 1 ? n - 1 : 0), a = 1; a < n; a++) i[a - 1] = arguments[a];
            (0, r.G)(e, ...i), o(t.name, "info", e, ...i), t.nativeLoggerEnabled && (null == l || l(t.name, "info", e, ...i))
        }), i(this, "warn", function(e) {
            for (var n = arguments.length, i = Array(n > 1 ? n - 1 : 0), a = 1; a < n; a++) i[a - 1] = arguments[a];
            (0, r.G)(e, ...i), o(t.name, "warn", e, ...i), t.nativeLoggerEnabled && (null == l || l(t.name, "warn", e, ...i))
        }), i(this, "error", function(e) {
            for (var n = arguments.length, i = Array(n > 1 ? n - 1 : 0), a = 1; a < n; a++) i[a - 1] = arguments[a];
            (0, r.G)(e, ...i), o(t.name, "error", e, ...i), t.nativeLoggerEnabled && (null == l || l(t.name, "error", e, ...i))
