/** Chunk was on web.js **/
/** chunk id: 118356, original params: e,t,n (module,exports,require) **/
"use strict";
n.d(t, {
    $o: () => o,
    Vy: () => d,
...
class d {
    ...
    constructor(e = "default") {
        ...
        i(this, "name", void 0), i(this, "nativeLoggerEnabled", void 0), i(this, "logDangerously", function(e) {
            ...
            (0, r.G)(e, ...i), s(t.name, "log", e, ...i), t.nativeLoggerEnabled && (null == l || l(t.name, "log", e, ...i))
            ...
            for (var n = arguments.length, i = Array(n > 1 ? n - 1 : 0), a = 1; a < n; a++) i[a - 1] = arguments[a];
            (0, r.G)(e, ...i), s(t.name, "debug", e, ...i), t.nativeLoggerEnabled && (null == l || l(t.name, "debug", e, ...i))
        }), i(this, "info", function(e) {
            for (var n = arguments.length, i = Array(n > 1 ? n - 1 : 0), a = 1; a < n; a++) i[a - 1] = arguments[a];
            (0, r.G)(e, ...i), s(t.name, "info", e, ...i), t.nativeLoggerEnabled && (null == l || l(t.name, "info", e, ...i))
        }), i(this, "warn", function(e) {
            for (var n = arguments.length, i = Array(n > 1 ? n - 1 : 0), a = 1; a < n; a++) i[a - 1] = arguments[a];
            (0, r.G)(e, ...i), s(t.name, "warn", e, ...i), t.nativeLoggerEnabled && (null == l || l(t.name, "warn", e, ...i))
        }), i(this, "error", function(e) {
            for (var n = arguments.length, i = Array(n > 1 ? n - 1 : 0), a = 1; a < n; a++) i[a - 1] = arguments[a];
            (0, r.G)(e, ...i), s(t.name, "error", e, ...i), t.nativeLoggerEnabled && (null == l || l(t.name, "error", e, ...i))
            ...
            for (var n = arguments.length, r = Array(n > 1 ? n - 1 : 0), i = 1; i < n; i++) r[i - 1] = arguments[i];
            s(t.name, "file-only", e, ...r), t.nativeLoggerEnabled && (null == l || l(t.name, "file-only", e, ...r))
