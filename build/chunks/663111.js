...
function S() {
    ...
    return (null != O && L ? (e = O.name, P = (0, i.jsx)("img", {
        ...
        "aria-hidden": !0,
        draggable: !1
    })) : y ? (e = f.intl.string(f.t.HcoRu0), P = (0, i.jsx)(a.XFE, {
        size: "sm"
    })) : null != v ? (e = (0, d.YC)(v), P = b ? (0, i.jsx)(a.Gg5, {
        size: "sm"
    }) : (0, i.jsx)(u.Ay, {
        guild: v,
        ...
        size: "sm"
    })) : t.pathname.startsWith(E.BVt.GLOBAL_DISCOVERY) ? (e = f.intl.string(f.t["4nEZLk"]), P = (0, i.jsx)(a.QGJ, {
        size: "sm"
    })) : t.pathname.startsWith(E.BVt.NITRO_HOME) ? (e = f.intl.string(f.t.Ipxkog), P = (0, i.jsx)(a.tvc, {
        size: "sm"
    })) : t.pathname.startsWith(E.BVt.COLLECTIBLES_SHOP) ? (e = f.intl.string(f.t.pWG4ze), P = (0, i.jsx)(a.U1X, {
        size: "sm"
    })) : t.pathname.startsWith(E.BVt.FRIENDS) ? (e = f.intl.string(f.t.TdEu5X), P = (0, i.jsx)(a.$yI, {
        size: "sm"
    })) : t.pathname.startsWith(E.BVt.FAMILY_CENTER) ? (e = f.intl.string(C.default.RZqaJn), P = (0, i.jsx)(a.nFg, {
        size: "sm"
    })) : t.pathname.startsWith(E.BVt.QUEST_HOME) && (e = f.intl.string(f.t.JALI2K), P = (0, i.jsx)(a.r2v, {
        size: "sm"
