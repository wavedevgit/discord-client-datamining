...
class en extends s.Component {
    ...
    handleTextareaKeyDown = e => {
        if (e.which === q.Ks6.ARROW_UP && !e.shiftKey && !e.altKey && !e.ctrlKey && !e.metaKey && 0 === this.state.textValue.length) {
            ...
            let {
                channel: t
            } = this.props, i = G.A.getLastEditableMessage(t.id);
    ...
    handleTextareaChange = (e, t, i) => {
        ...
        h.A.changeDraft(n, this.state.textValue, k.C.ChannelMessage), "" !== t ? f.A.startTyping(n) : f.A.stopTyping(n), this.setState({
            textValue: t,
            richValue: i
        })
    };
    handleSendMessage = e => {
        ...
        return 0 === t.length ? Promise.resolve({
            ...
            return (_.A.sendMessage(i.id, T.Ay.parse(i, t), !0, {
                ...r,
                location: $.Hx.OVERLAY
            }), this.setState((0, I.N3)()), (0, j.Jx)(i.id), s) ? (p.A.deactivateAllRegions(), {
                shouldClear: !1,
                shouldRefocus: !1
            }) : {
                shouldClear: !0,
    ...
    renderAttachButton = (e, t) => (0, n.jsx)(S.A, {
        className: t,
    ...
    render() {
        let {
            ...
            richValue: r
        } = this.state, d = (0, n.jsx)(c.YNO, {
            targetElementRef: this.textAreaRef,
            position: "top",
            onRequestClose: () => {
                l?.onCancel?.(), this.setState({
                    contentWarningProps: null
                })
            },
            shouldShow: null != l,
            renderPopout: e => {
                ...
                return o()(null != l, "ConnectedChannelTextArea.render - renderPopout: contentWarningProps cannot be null"), (0, n.jsx)(O.A, {
                    onClose: t,
                    ...l
                })
            },
        ...
        return e.isPrivate() ? (0, n.jsx)(v.A, {
            channel: e,
            children: d
        }, e.id) : (0, n.jsx)(y.A, {
            channel: e,
...
class es extends s.PureComponent {
    componentDidUpdate(e) {
        ...
        (0, Z.Mw)(e, this.props, this.shouldDisplay), null != t && i && !e.activated && p.A.track(q.HAw.OVERLAY_UNLOCKED, {
            channel_id: t.id,
            channel_type: t.type,
            guild_id: t.guild_id
        })
        ...
        return e = g && null != r ? (0, n.jsx)(D.A, {
            ...
            children: (0, n.jsxs)(s.Fragment, {
                children: [!o && !h && (0, n.jsx)(x.A, {
                    ...
                    children: A ? (0, n.jsx)(J.Ay.Background, {
                        opacityOverride: o || h ? null : ei,
                        ...
                        children: (0, n.jsx)(J.Ay.Background, {
                            ...
                            children: (0, n.jsx)("div", {
                                ...
                                children: null != t.name && t.name.length > 0 ? ee.intl.formatToPlainString(ee.t["9TkYMO"], {
                                    keybind: c,
                                    channelName: t.isMultiUserDM() ? t.name : `#${t.name}`
    ...
    handleContextMenu = e => {
        ...
        null != t && null != s && (0, u.L3)(e, async () => {
            let {
                default: e
            } = await Promise.all([i.e("97262"), i.e("42128"), i.e("39778"), i.e("38389")]).then(i.bind(i, 385913));
            return i => (0, n.jsx)(e, {
                ...i,
                user: s,
                channelSelected: !0,
    ...
    render() {
        ...
        let r = (0, n.jsxs)(s.Fragment, {
            ...
            }), this.renderContent(), e || a ? null : (0, n.jsx)("div", {
                className: et.cB,
...
function ea(e) {
    let {
        contained: t = !1,
        ...i
    } = e, s = (0, d.bG)([U.A], () => U.A.getGuildId()), a = (0, d.bG)([V.A], () => V.A.getChannelId(s)), l = (0, d.bG)([R.A], () => R.A.getChannel(a)), r = (0, d.bG)([H.Ay], () => H.Ay.getOverlayChatKeybind()), o = null != r ? (0, K.dI)(r.shortcut, !0) : "]", [c, u, h] = (0, d.yK)([W.default], () => [W.default.getTextWidgetOpacity(), W.default.getActiveRegions(), !t && W.default.isPreviewingInGame()]), _ = (0, d.bG)([P.A], () => P.A.getGuild(s)), p = (0, d.bG)([M.A], () => null != s && M.A.didAgree(s)), f = null != l && l.isPrivate() ? l.getRecipientId() : null, m = (0, d.bG)([w.A], () => null != a ? w.A.getPendingReply(a) : void 0), x = (0, d.bG)([z.default], () => null != f ? z.default.getUser(f) : null), {
        placeholder: v
    } = (0, g.A)({
        channel: l
    });
    return null != l && null != _ && q.kvI.GUILD_THREADS_ONLY.has(l.type) ? (0, n.jsx)(A.A, {}) : (0, n.jsx)(es, {
        guild: _,
        channel: l,
        user: x,
        opacity: c,
