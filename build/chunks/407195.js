...
class el extends s.Component {
    ...
    constructor(e) {
        ...
        }, F._.subscribe(ee.jej.TEXTAREA_FOCUS, this.focusInput), F._.subscribe(ee.jej.TEXTAREA_BLUR, this.blurInput)
    }
    ...
    componentWillUnmount() {
        M.A.removeChangeListener(this.draftDidChange), F._.unsubscribe(ee.jej.TEXTAREA_FOCUS, this.focusInput), F._.unsubscribe(ee.jej.TEXTAREA_BLUR, this.blurInput)
    }
    draftDidChange = (() => {
        var e = this;
        return function() {
    ...
    handleTextareaChange = (e, t, n) => {
        ...
        h.A.changeDraft(i, this.state.textValue, M.C.ChannelMessage), "" !== t ? A.A.startTyping(i) : A.A.stopTyping(i), this.setState({
            textValue: t,
            richValue: n
        })
    };
    handleSendMessage = e => {
        ...
        return 0 === t.length ? Promise.resolve({
            ...
            if (!l) return a === ee.X8x.SLOWMODE_COOLDOWN ? (F._.dispatch(ee.jej.EMPHASIZE_SLOWMODE_COOLDOWN), {
                shouldClear: !1,
                shouldRefocus: !0
            }) : {
                shouldClear: !1,
            ...
            }), this.setState((0, C.N3)()), (0, R.Jx)(n.id), s) ? (f.A.deactivateAllRegions(), {
                shouldClear: !1,
                shouldRefocus: !1
            }) : {
                shouldClear: !0,
    ...
    renderAttachButton = (e, t) => (0, i.jsx)(I.A, {
        className: t,
    ...
    render() {
        ...
        return e.isPrivate() ? (0, i.jsx)(y.A, {
            channel: e,
            children: d
        }, e.id) : (0, i.jsx)(v.A, {
            channel: e,
...
class ea extends s.PureComponent {
    componentDidUpdate(e) {
        ...
        (0, J.Mw)(e, this.props, this.shouldDisplay), null != t && n && !e.activated && f.A.track(ee.HAw.OVERLAY_UNLOCKED, {
            channel_id: t.id,
            channel_type: t.type,
            guild_id: t.guild_id
        })
