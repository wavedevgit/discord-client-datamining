/** chunk id: 625846 params = (module,exports,require) **/
"use strict";
n.r(t), n.d(t, {
    default: () => ej
});
...
function eC(e) {
    let {
        ...
        coords: n,
        key: i,
        isShowingSearchResult: s,
        hasActiveThreads: a
    } = e;
    return () => 2 === t && !s && a ? (0, l.jsx)(eA, {
        section: t,
...
function eS(e) {
    ...
    }(t), V = g.length > 0, W = V || f.length > 0, K = (0, y.A)(t), {
        tagFilter: J,
        tagSetting: en
    } = (0, X.R)(t.id);
    (0, Q.o7)(t, J, en, u), (0, b.Ay)(() => {
    ...
    let el = (0, Q.O3)(t),
        ...
        eo = i.useRef(null),
        {
            ...
            Y.A.useForumChannelSeenManager({
                guildId: t,
                channelId: n
            });
            let s = i.useRef(null),
                a = i.useCallback((e, t) => {
                    for (let n of t) {
                        ...
                        if (null == t) return;
                        let l = Date.now();
                        n.intersectionRatio >= .5 ? (0, Z.xx)(e, t, l) : (0, Z.O_)(e, t, l)
                    }
                }, []);
            return i.useEffect(() => {
                let e = l.current?.getScrollerNode();
                if (null != e) return s.current = new IntersectionObserver(e => a(n, e), {
                    root: e,
                ...
                observePostVisibilityAnalytics: i.useCallback((e, t) => {
    ...
    let {
        columns: ek
    } = i.useMemo(() => eu ? eb.getRenderOptions(ew) : ec.CV, [eu, ew]), eL = i.useMemo(() => M ? Math.round((window.innerHeight - 200) / 118) : 0, [M]), {
        showResolvedFlags: eP
    } = (0, I.T)(t.id), eD = t.isModeratorReportChannel(), eO = i.useMemo(() => {
        let e = Math.ceil(window.innerHeight / (0, ec.iX)(eb.getWidth(ew))) * ek;
        return T ? e : 0
    }, [ew, ek, T]), eF = i.useMemo(() => {
        let e = Math.ceil(window.innerHeight / (0, ec.iX)(eb.getWidth(ew))) * ek;
        return N ? e : 0
    }, [ew, ek, N]), eU = i.useMemo(() => {
        let e = Math.ceil(window.innerHeight / (0, ec.iX)(eb.getWidth(ew))) * ek;
        return O && eA ? e : 0
    }, [ew, ek, O, eA]), eG = i.useMemo(() => {
        if (eu)
            if (!el && eA) return [1, 0];
    ...
    }, [eu, eA, g.length, f.length, el, ea, eL, j, eO, eF, eU, eP, eD]), ez = i.useMemo(() => !el && eA ? [
        [],
        []
    ] : ea ? eA ? [
        [], j, [],
        ...
        [], g, []
    ], [eA, el, ea, j, g, f, eP, eD]), eH = i.useCallback((e, n) => {
        (0, ee.Ml)({
            guildId: t.guild_id,
            channelId: t.id,
            postId: e.id,
        ...
        }) : (eS.current = e.id, (0, F.JA)(e))
    }, [t.guild_id, t.id, eS]), [eB, eV] = i.useState(s + r - 24), eW = i.useCallback((e, n, i) => 0 === e ? (0, l.jsx)(eM, {
        channel: t,
        isEmpty: !V,
        isSearchLoading: O,
        numResults: j?.length,
        coords: n,
        onHeightChange: eV,
        children: !M && (0, l.jsx)(et.A, {
            channel: t,
            hasAnyThread: W,
            hasActiveThreads: V
        }, t.id)
    }, "forum-channel-header") : 2 !== e || ea ? 1 === e && eA && !el ? (0, l.jsx)(eE, {
        channel: t,
        coords: n
    }, "archive-or-search-result") : i() : (0, l.jsx)(ey, {
        channel: t,
        coords: n
    }, "archived-missing-reading-history-perm"), [eA, ea, j, el, t, V, O, M, W]), eK = (0, x.bG)([q.A], () => q.A.hasHidden(t.id)), eq = {
        editorHeight: s,
        isGridLayout: eu
    }, e$ = i.useRef(eq);
    i.useEffect(() => {
        ...
        let {
            editorHeight: e,
            isGridLayout: t
        } = e$.current, n = t ? e0 : eo, l = n.current?.getScrollerState();
        null != l && !eK && l.scrollTop > e && n.current?.scrollTo({
            to: 0
        })
    }, [eK]);
    let {
        ...
        } = e, g = (0, x.bG)([B.A], () => B.A.getChannelId()), f = i.useCallback(e => n => {
            t.current = n, e.current = n?.getScrollerNode() ?? null
        }, [t]), p = i.useCallback(e => eC({
            section: e.section,
            isShowingSearchResult: h,
            hasActiveThreads: n
        })(), [n, h]), j = i.useCallback(e => c(e.section, void 0, () => {
        ...
        }, [t, h]), p = i.useCallback(e => {
            let t = eN(e);
            if (null == t) return;
            let n = G.A.getChannel(t);
            null != n && s(n, !0)
        }, [s]), j = i.useCallback(function(e) {
        ...
        }, [n]), b = i.useCallback((e, t, n) => r(e, t, eC({
            section: e,
            coords: t,
            key: n,
            isShowingSearchResult: d,
            hasActiveThreads: o
        })), [r, o, d]), v = i.useCallback(e => 0 === e ? {} : {
            role: "grid",
            "aria-labelledby": `#${ev(e)}`
        }, []);
        return {
            ...
            getItemKey: j,
            renderGridSection: b,
            renderGridItem: i.useCallback((e, t, i, r, o) => {
                if (0 === e) return null;
                let d = n[e][t];
                return null != d ? (0, l.jsx)(er.A, {
                    id: `${r}`,
                    threadId: d,
                ...
                }, r) : __OVERLAY__ ? null : (0, l.jsx)("div", {
                    style: {
                        ...i
                    },
                    "data-item-role": "item",
            ...
            getSectionProps: v,
            getGridSectionHeight: i.useCallback(e => 0 === e ? x - 8 - 24 : 2 === e ? o || !u ? 40 : 0 : 1 === e && d && !c ? 40 : 0, [x, d, c, o, u])
        }
    }({
    ...
    return (0, l.jsx)("div", {
        ...
        children: (0, l.jsx)(_.skg, {
            children: e => (0, l.jsxs)(l.Fragment, {
                children: [u && (0, l.jsx)(p.A, {
                    channel: t,
                    draftType: z.C.FirstThreadMessage,
                    className: ep.uploadArea,
                    style: {
                        right: tr && n?.isThreadSidebarFloating ? n.threadSidebarWidth : 0
                    }
                }), (0, l.jsx)(eI, {
                    channel: t
                }), (0, l.jsx)(_.AC4, {
                    children: (0, l.jsx)(_.H, {
                        children: e_.intl.string(e_.t.B2panI)
                    })
                }), K ? (0, l.jsx)("div", {
...
function ey(e) {
    ...
    return (0, l.jsx)("div", {
        ...
        children: (0, l.jsx)(_.Text, {
            ...
            children: e_.intl.format(e_.t.TycmzM, {
                channelName: i
            })
        })
    })
...
function eE(e) {
    ...
    return (0, l.jsx)("div", {
        ...
        children: (0, l.jsx)(_.Text, {
            color: "text-muted",
            variant: "text-md/normal",
            children: e_.intl.format(e_.t.OWZJdS, {
                channelName: i
            })
        })
    })
...
function eI(e) {
    let {
        ...
        $.A.resort(t.id)
    }, [t]), s = (0, x.bG)([J.A], () => J.A.getNewThreadCount());
    return 0 === s ? null : (0, l.jsx)(_.DUT, {
        className: ep.newPostsButton,
        onClick: n,
        children: (0, l.jsx)(_.Text, {
            color: "text-brand",
            variant: "text-md/medium",
            children: e_.intl.format(e_.t.ue1qfM, {
                count: s
            })
        })
    })
...
function eM(e) {
    ...
    i.useLayoutEffect(ef, [ef, p, ec, D]), (0, K.Vo)({
    ...
    i.useLayoutEffect(() => {
        ...
        if (null != ev.current && null != t && null != t.children) {
            let {
                left: e,
                top: n
            } = ev.current.getBoundingClientRect(), l = 0;
    ...
    let eI = I.length > 0 && !w && (b || null != A),
        eM = !__OVERLAY__ && !L && !w && k && (0 === P.textValue.trim().length || P.textValue.trim() === eb) && 0 === ej.length && !eo;
    i.useLayoutEffect(() => {
        if (!(eI || eM)) return F(0);
    ...
    let ek = (0, u.Ay)({
        ...
        }),
        {
            ...
            onFocus: eP,
            ...eD
        } = (0, c.rm)("forum-channel-header"),
        eO = i.useRef(null),
        eF = (t = i.useRef(!1), n = (0, x.bG)([v.A], () => v.A.keyboardModeEnabled), s = i.useCallback(e => {
            t.current = e.shiftKey
        }, [t]), i.useLayoutEffect(() => (n ? window.addEventListener("keydown", s) : window.removeEventListener("keydown", s), () => window.removeEventListener("keydown", s)), [n, s]), t),
        eU = i.useCallback(e => {
    ...
    return (0, l.jsx)("div", {
        ...
        style: {
            ...y,
            position: G === h.C.GRID ? "absolute" : "static",
            height: "auto"
        },
        children: (0, l.jsxs)(K.Ah, {
            children: [null != r.guild_id ? (0, l.jsx)(N.A, {
                className: a()(ep.newMemberBanner, {
                    [ep.gridViewBanner]: G === h.C.GRID
                }),
                guildId: r.guild_id,
                channel: r
            }) : null, (0, l.jsx)("div", {
                className: a()(ep.mainCard, ep.header, {
                    [ep.headerWithMatchingPosts]: eI || eM
                }),
                ...
                children: [eI && (0, l.jsxs)("div", {
                    ...
                    children: [(0, l.jsx)(_.Heading, {
                        ...
                        color: "text-default",
                        children: b ? e_.intl.string(e_.t["/9i3qq"]) : 0 === A ? e_.intl.string(e_.t.DbgHxi) : e_.intl.formatToPlainString(e_.t["tBz/8b"], {
                            numPosts: A ?? "",
                            query: I
                        })
                    }), !b && (0, l.jsx)(_.DUT, {
                        onClick: () => {
                            (0, ee.hT)({
                                guildId: r.guild_id,
                                channelId: r.id
                            }), $.A.clearForumSearch(r.id), B.getState().setName("")
                        },
                        children: (0, l.jsx)(_.Text, {
                ...
                children: [(0, l.jsx)(ew, {
                    channel: r
                }), eG.length > 0 ? (0, l.jsxs)(l.Fragment, {
                    children: [(0, l.jsx)("div", {
                            ...
                            children: (0, l.jsx)(c.PR, {
                                children: e => {
                                    ...
                                    return (0, l.jsx)("div", {
                                        ...
                                        ref: t,
                                        ...n,
                                        children: eG.map(e => (0, l.jsx)(ed.A, {
                                            tag: e,
                                            onClick: () => {
                                                var t;
                                                return t = e.id, void((0, ee.UA)({
                                                    ...
                                                    location: {
                                                        page: eg.liQ.GUILD_CHANNEL,
                                                        section: eg.JJy.FORUM_CHANNEL_HEADER,
                        ...
                        children: (e, t) => {
                            ...
                            return (0, l.jsxs)(f.$n, {
                                ...
                                "aria-label": U.size > 0 ? e_.intl.string(e_.t.IkpM1T) : e_.intl.string(e_.t["9vKK/N"]),
                                children: [U.size > 0 ? (0, l.jsx)("div", {
                                ...
                                }) : e_.intl.string(e_.t.fZ8hzm), n ? (0, l.jsx)(_.tN5, {
                                    size: "custom",
                                    color: "currentColor",
                                    width: 20
                                }) : (0, l.jsx)(_.abt, {
                ...
                children: e => {
                    ...
                    return t === g.M.FORUM_CHANNEL_HELPER_CARD ? (0, l.jsx)(el.A, {
                        onDismiss: n
                    }) : null
                }
            })]
...
function ew(e) {
    let {
        channel: t
    } = e, n = t.isMediaChannel(), s = i.useRef(null);
