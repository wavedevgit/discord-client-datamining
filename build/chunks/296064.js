...
function E(e) {
    let {
        ...
        gameProfileEntry: I,
        onPrimaryAction: E
    } = e, [m, S] = i.useState(!1), _ = i.useRef(null);
    i.useEffect(() => () => {
    ...
    let p = function(e, t, n, l) {
            ...
            if (null != o) {
                ...
                return {
                    kind: "send_game_invite_message",
                    gameEntry: (t = o.timestamps?.start ?? Date.now(), {
        ...
        N = i.useCallback(e => {
            e.preventDefault(), e.stopPropagation(), m || null == p || (S(!0), null != _.current && clearTimeout(_.current), _.current = setTimeout(() => {
                S(!1), _.current = null
            }, 2e3), E?.({
                type: function(e) {
                    switch (e) {
