/** chunk id: 334310, original params: e,t,n (module,exports,require) **/
n.d(t, {
    A: () => u
});
var l = n(405269),
...
let o = e => {
    let t = Date.now() + e;
    return (0, l.ro)(new Date, new Date(t)) ? s.intl.data.formatTime(t, {
        format: "short"
    }) : s.intl.formatToPlainString(s.t.DN91Jz, {
