...
let _ = {
    ...
    ExistingUserAgeGatePrompt: async () => {
        let {
            default: e
        } = await Promise.all([n.e("10136"), n.e("53333")]).then(n.bind(n, 776971));
        return t => (0, a.jsx)(e, {
            ...t,
    ...
    VoiceSettingsModal: async () => {
        ...
        return t => (0, a.jsx)(e, {
            ...t,
            mediaEngineContext: l.x.DEFAULT,
    ...
    PremiumSubscriptionPauseModal: async () => {
        let {
            ...
            PremiumTypes: s
        } = await Promise.resolve().then(n.bind(n, 788868)), l = {
    ...
    NewMemberActionModal: async () => {
        let {
            default: e
        } = await Promise.all([n.e("54569"), n.e("33342")]).then(n.bind(n, 251632)), {
    ...
    PlayStationModal: async () => {
        ...
        } = await Promise.resolve().then(n.bind(n, 95701)), s = i({
            id: "123456789",
    ...
    AppealIngestionModal: async () => {
        let {
            default: e
        } = await Promise.all([n.e("74327"), n.e("36316")]).then(n.bind(n, 355690));
        return t => (0, a.jsx)(e, {
            ...t,
    ...
    GuildDisableCommunicationModal: async () => {
        ...
        function u(n) {
            let [u, m] = d.useState(r.DURATION_60_SEC), [h, x] = d.useState(""), [p, g] = d.useState(!1), [f, v] = d.useState(!1), _ = [{
    ...
    EnableCommunityModal: async () => {
        let {
            default: e
        } = await Promise.all([n.e("20115"), n.e("70941")]).then(n.bind(n, 939006));
        return t => (0, a.jsx)(e, {
            ...t,
            onClose: async () => {
    ...
    ActivityShareMomentModal: async () => {
        let {
            default: e
        } = await Promise.all([n.e("28136"), n.e("21743"), n.e("22230")]).then(n.bind(n, 190930));
        return t => (0, a.jsx)(e, {
            ...t,
    ...
    ConsentCheckBoxModal: async () => {
        let {
            ...
            Text: t,
            Heading: i
        } = await Promise.resolve().then(n.bind(n, 397927)), s = await Promise.resolve().then(n.t.bind(n, 64700, 19));

        function l(n) {
            let [l, o] = s.useState(!1), [d, c] = s.useState(!1);
            return (0, a.jsx)(e, {
                ...n,
        ...
        return l.displayName = "ConsentCheckBoxModalContent", e => (0, a.jsx)(l, {
            ...e
        })
    },
    ...
    GuildVerificationLevelModalCommunity: async () => {
        let {
            ...
            GuildFeatures: i
        } = await Promise.resolve().then(n.bind(n, 652215)), s = t({
            id: "123456789",
    ...
    FamilyCenterQRCodeModal: async () => {
        let {
            default: e
        } = await Promise.all([n.e("14946"), n.e("72875")]).then(n.bind(n, 320742));
        return t => (0, a.jsx)(e, {
            ...t
        })
    },
    ...
    OtherFriendRequestsModal: async () => {
        let {
            default: e
        } = await Promise.all([n.e("25281"), n.e("74788")]).then(n.bind(n, 516259));
        return t => (0, a.jsx)(e, {
            ...t
        })
    },
    AcceptInviteModal: async () => {
        let {
            default: e
        } = await Promise.all([n.e("64161"), n.e("83155"), n.e("4366")]).then(n.bind(n, 563038));
        return t => (0, a.jsx)(e, {
            ...t
        })
    },
...
function b() {
    let e = i.useMemo(() => Object.keys(_).map(e => ({
            label: e,
            value: e,
            id: e
