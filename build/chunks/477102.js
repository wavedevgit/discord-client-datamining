/** chunk id: 477102 params = (module,exports,require) **/
n.d(t, {
    A: () => b
});
var a = n(627968),
...
let v = {
    ...
    ExistingUserAgeGatePrompt: async () => {
        let {
            default: e
        } = await Promise.all([n.e("10136"), n.e("28560")]).then(n.bind(n, 776971));
        return t => (0, a.jsx)(e, {
            ...t,
    ...
    VoiceSettingsModal: async () => {
        ...
        return t => (0, a.jsx)(e, {
            ...t,
            mediaEngineContext: s.x.DEFAULT,
    ...
    PremiumSubscriptionPauseModal: async () => {
        let {
            ...
            PremiumTypes: l
        } = await Promise.resolve().then(n.bind(n, 788868)), s = {
        ...
        return r.displayName = "PremiumSubscriptionPauseModalWrapper", e => (0, a.jsx)(r, {
            ...e
        })
    },
    NewMemberActionModal: async () => {
        let {
            default: e
        } = await Promise.all([n.e("54569"), n.e("25400")]).then(n.bind(n, 251632)), {
    ...
    PlayStationModal: async () => {
        let {
        ...
        } = await Promise.resolve().then(n.bind(n, 95701)), l = i({
            id: "123456789",
            ...
            t.default.getDevicesForPlatform = e => e === x.fg2.PLAYSTATION ? s : i.call(t.default, e), t.default.getFetchingDevices = e => e !== x.fg2.PLAYSTATION && r.call(t.default, e), t.default.getLastSelectedDeviceByPlatform = e => e === x.fg2.PLAYSTATION ? "device-1" : o.call(t.default, e), t.default.getAwaitingRemoteSessionInfo = () => null;
            let c = n.onClose;
    ...
    AppealIngestionModal: async () => {
        let {
            default: e
        } = await Promise.all([n.e("74327"), n.e("27856")]).then(n.bind(n, 355690));
        return t => (0, a.jsx)(e, {
            ...t,
    ...
    GuildDisableCommunicationModal: async () => {
        let {
            ...
            DisableCommunicationDuration: r,
        ...
        function u(n) {
            let [u, m] = d.useState(r.DURATION_60_SEC), [h, x] = d.useState(""), [p, g] = d.useState(!1), [_, f] = d.useState(!1), v = [{
                ...
                value: r.DURATION_5_MIN,
                label: o(r.DURATION_5_MIN)
            }, {
                value: r.DURATION_10_MIN,
                label: o(r.DURATION_10_MIN)
            }, {
                value: r.DURATION_1_HOUR,
                label: o(r.DURATION_1_HOUR)
            }, {
                value: r.DURATION_1_DAY,
                label: o(r.DURATION_1_DAY)
            }, {
    ...
    GuildPowerupDeactivateModal: async () => {
        let {
            ...
            Heading: i,
            Checkbox: l
        } = await Promise.resolve().then(n.bind(n, 397927)), s = await Promise.resolve().then(n.t.bind(n, 64700, 19)), r = "Level 3 Server Boost", o = 200, d = 60, c = 8;

        function u(n) {
            let [u, m] = s.useState(!1), [h, x] = s.useState(!1), p = s.useCallback(async () => {
            ...
            return (0, a.jsxs)("div", {
                ...
                children: [(0, a.jsxs)(i, {
                    variant: "heading-lg/semibold",
                    className: "mb-2",
                    children: ["Deactivate ", r]
                }), (0, a.jsxs)(t, {
                    variant: "text-sm/normal",
                    className: "mb-4",
                    color: "text-subtle",
                    children: ["This will remove the ", r, " from your server and disable all associated features."]
                }), (0, a.jsxs)("div", {
                    className: "mb-4",
                    style: {
    ...
    EnableCommunityModal: async () => {
        let {
            default: e
        } = await Promise.all([n.e("20115"), n.e("93900")]).then(n.bind(n, 939006));
        return t => (0, a.jsx)(e, {
            ...t,
            onClose: async () => {
    ...
    ActivityShareMomentModal: async () => {
        let {
            default: e
        } = await Promise.all([n.e("28136"), n.e("21743"), n.e("16839")]).then(n.bind(n, 190930));
        return t => (0, a.jsx)(e, {
            ...t,
    ...
    ConsentCheckBoxModal: async () => {
        let {
            ...
            Text: t,
            Heading: i
        } = await Promise.resolve().then(n.bind(n, 397927)), l = await Promise.resolve().then(n.t.bind(n, 64700, 19));

        function s(n) {
            let [s, o] = l.useState(!1), [d, c] = l.useState(!1);
            return (0, a.jsx)(e, {
                ...n,
        ...
        return s.displayName = "ConsentCheckBoxModalContent", e => (0, a.jsx)(s, {
            ...e
        })
    },
    ...
    GuildVerificationLevelModalCommunity: async () => {
        let {
            ...
            GuildFeatures: i
        } = await Promise.resolve().then(n.bind(n, 652215)), l = t({
            id: "123456789",
    ...
    FamilyCenterQRCodeModal: async () => {
        let {
            default: e
        } = await Promise.all([n.e("88592"), n.e("72875")]).then(n.bind(n, 320742));
        return t => (0, a.jsx)(e, {
            ...t
        })
    },
    ...
    LinkNotDiscordModal: async () => {
        let {
            default: e
        } = await n.e("98597").then(n.bind(n, 696452));
        return t => (0, a.jsx)(e, {
            ...t,
    ...
    DisableRiskyPermsModal: async () => {
        let {
            default: e
        } = await n.e("71905").then(n.bind(n, 868952)), t = Object.values(c.A.getGuilds())[0];
        return null == t ? () => null : n => (0, a.jsx)(e, {
            ...n,
            guild: t
        })
    ...
    OtherFriendRequestsModal: async () => {
        let {
            default: e
        } = await Promise.all([n.e("71853"), n.e("60722")]).then(n.bind(n, 516259));
        return t => (0, a.jsx)(e, {
            ...t
        })
    },
