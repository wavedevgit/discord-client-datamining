...
function k(e) {
    let {
        ...
        analyticsLocations: A,
        guildId: E?.id
    }), [b, w] = i.useState(() => null != j ? j : void 0 !== P ? P : null == N ? null : (0, p.ps)(o, r).find(e => {
        let {
            skuId: t
        } = e;
        return t === N.skuId
        ...
        product: R,
        purchase: L
    } = (0, v.A)(b?.skuId), M = null != L ? (0, p.gA)(L) : (0, p.G0)(R), U = g.Ay.canUseCollectibles(t), G = i.useRef(null), z = (0, y.A)(A), H = void 0 === P ? b?.skuId === N?.skuId : b?.skuId === P?.skuId, B = i.useCallback(e => {
        h(), (0, _.Cz)({
            analyticsLocations: A,
    ...
    return (0, s.jsxs)(s.Fragment, {
        children: [(0, s.jsxs)(l.rQ0, {
            ...
            "data-migration-pending": !0,
            className: f.Hx,
            children: [null != L && (U || !M) || null === b ? (0, s.jsx)(l.Button, {
                variant: "primary",
