...
e.exports = function(e, r) {
    ...
    return a = 2 === f ? function(e, t) {
        ...
        return a
    }(e.getChannelData(0), e.getChannelData(1)) : e.getChannelData(0), n = h, o = d, l = (s = f) * (c = (i = 3 === h ? 32 : 16) / 8), t(b = new DataView(u = new ArrayBuffer(44 + a.length * c)), 0, "RIFF"), b.setUint32(4, 36 + a.length * c, !0), t(b, 8, "WAVE"), t(b, 12, "fmt "), b.setUint32(16, 16, !0), b.setUint16(20, n, !0), b.setUint16(22, s, !0), b.setUint32(24, o, !0), b.setUint32(28, o * l, !0), b.setUint16(32, l, !0), b.setUint16(34, i, !0), t(b, 36, "data"), b.setUint32(40, a.length * c, !0), 1 === n ? function(e, t, r) {
