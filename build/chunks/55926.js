/** chunk id: 55926, original params: n,i,e (module,exports,require) **/
e.d(i, {
    B4: () => C,
    B8: () => D,
    Mp: () => O
...
function C(n) {
    let {
        ...
        icon: (0, v.N)(i, n.icon)
    })), [i, r.benefits]), z = l.useMemo(() => null != r.thumbnail ? (0, y.t)(i, r.thumbnail, 256) : void 0, [i, r.thumbnail]), Y = l.useCallback(n => (0, t.jsx)(M.rc, {
        ...n,
        appId: i,
        subscriptionType: o,
        skuId: r.skuId,
    ...
    return (0, t.jsx)(a.OP, {
        ...
        benefitItems: null != w ? w.map(n => (0, t.jsx)(a.FY, {
            description: n.title,
            icon: n.icon
        }, n.id)) : void 0,
        onDetails: null != c ? c : null != w ? () => {
            (0, u.mMO)(async () => {
                let {
...
function D(n) {
    ...
    } = (0, m.Ay)(c.A.APP_STOREFRONT), o = (0, d.bG)([A.A], () => A.A.getForSKU(i), [i]), p = (0, d.bG)([k.A], () => k.A.get(i), [i]), x = (0, R.L)(i);
    ...
    return null == f ? null : (0, t.jsx)(r.A, {
        title: h,
        description: g,
        headerImage: v,
        availabilityLabel: I,
        PurchaseButton: n => (0, t.jsx)(M.$P, {
            ...n,
            appId: l,
            sku: p
        }),
        ...
        onDetails: null != s ? s : (0, S.uJ)(g) ? void 0 : () => {
            (0, u.mMO)(async () => {
                let {
                    ItemDetailsModal: n
