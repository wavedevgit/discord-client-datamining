...
function G(e) {
    let {
        ...
        return null != n && null != (e = S.A.toURLSafe(n)) ? e : void 0
    }, [m]), v = (0, u.bG)([c.A], () => c.A.useReducedMotion), g = l.useMemo(() => [...s.map(e => e.skuId), ...o.map(e => e.skuId)], [s, o]), {
...
function C(e) {
    ...
    let {
    ...
    }, [s, d.benefits]), H = l.useMemo(() => null != d.thumbnail ? (0, N.t)(s, d.thumbnail, 256) : void 0, [s, d.thumbnail]), V = l.useCallback(e => (0, r.jsx)(T.rc, U(L({}, e), {
        appId: s,
        subscriptionType: p,
        skuId: d.skuId,
        subscriptionPlan: P,
        state: Y
    })), [s, p, d.skuId, P, Y]), Z = l.useMemo(() => {
        ...
        if (K) return (0, r.jsxs)(r.Fragment, {
            children: [null != I && (0, r.jsx)(m.A, {
                guild: I,
                size: m.A.Sizes.MINI
            }), M.intl.string(M.t.l8ufqL)]
        })
    }, [null == E ? void 0 : E.currentPeriodEnd, I, G, C, K, B]), J = null != Z ? (0, r.jsx)(a.Text, {
        color: "text-default",
    ...
    return (0, r.jsx)(o.OP, {
        title: d.summary,
        subtitle: J,
        maxBenefits: null != J ? o.GS - 1 : o.GS,
        description: null != (n = d.description) ? n : void 0,
        imgSrc: H,
        onPurchase: z,
        renderPurchaseButton: V,
        benefitItems: null != q ? q.map(e => (0, r.jsx)(o.FY, {
            description: e.title,
            icon: e.icon
        }, e.id)) : void 0,
        onDetails: null != g ? g : null != q ? () => {
            (0, a.mMO)(async () => {
                ...
                } = await Promise.resolve().then(t.bind(t, 168393));
...
function z(e) {
    ...
    } = (0, p.Ay)(d.A.APP_STOREFRONT), v = (0, u.bG)([O.A], () => O.A.getForSKU(c), [c]), f = (0, u.bG)([y.A], () => y.A.get(c), [c]), h = (0, w.L)(c);
    if (null == f) return null;
    let x = null != (n = f.name) ? n : "",
        P = null != (l = null == v || null == (o = v.description) ? void 0 : o.trim()) ? l : void 0,
    ...
    return null == R ? null : (0, r.jsx)(s.A, {
        title: x,
        description: P,
        headerImage: k,
        availabilityLabel: N,
        PurchaseButton: e => (0, r.jsx)(T.$P, U(L({}, e), {
            appId: m,
            sku: f
        })),
        onPurchase: () => {
        ...
        onDetails: null != b ? b : (0, A.uJ)(P) ? void 0 : () => {
            (0, a.mMO)(async () => {
                let {
                    ItemDetailsModal: e
                } = await Promise.resolve().then(t.bind(t, 963179));
                return n => (0, r.jsx)(e, L({
                    appId: m,
                    skuId: c
                }, n))
