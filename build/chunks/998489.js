/** chunk id: 998489 params = (module,exports,require) **/
n.d(t, {
    A: () => f
...
function f(e, t, n, f) {
    let b = e.id,
        [p, h] = l.useState(() => f?.initialAnswers?.map(e => ({
            ...(0, u.YP)(),
            ...e
        })) ?? [(0, u.YP)(), (0, u.YP)()]),
        ...
        Y = l.useCallback((e, t, n) => {
            ...
            null != a && a.mediaURL !== n && s.k7(e, l.localCreationAnswerId, (0, r.$P)(l.localCreationAnswerId, a.mediaURL))
        }, [p]),
        B = l.useCallback(async (e, t, n) => {
            let l = p[t].localCreationAnswerId;
            (Y(e, t), K(g(n, o.k.PREPARING), t), null == await s.Sw(e, l, n)) ? K(g(n, o.k.ERROR), t): K(g(n, o.k.READY_TO_UPLOAD), t)
        }, [p, K, Y]),
    ...
    let G = l.useCallback(() => {
            let e = !0,
                t = {};
            return 0 === A.trim().length && (e = !1, t.question = d.intl.string(d.t.gPX3oI)), p.filter(e => (0, u.ND)(e)).length < m.FW && (e = !1, t[`answer-${p[0].localCreationAnswerId}`] = d.intl.string(d.t.fYvzEX)), p.forEach(n => {
