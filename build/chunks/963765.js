...
function k(e) {
    let {
        ...
        canCreateMediaChannel: B
    }), [U, B]), M = (0, o.bG)([b.A], () => b.A.getCategories(t)._categories, [t]), V = r.useMemo(() => M.map(e => {
        let {
            channel: t
        } = e;
        return {
    ...
    }), [M]), W = O.find(e => e.value === D)?.channelIcon ?? E.FX, X = "" !== L;
    return (0, i.jsx)("form", {
        onSubmit: function(e) {
