/** chunk id: 963765 params = (module,exports,require) **/
n.d(t, {
    default: () => y
}), n(321073);
var i = n(627968),
...
function y(e) {
    let {
        ...
        onSubmit: y,
        onClose: D
    } = e, [G, L] = r.useState(I._Ee), [N, T] = r.useState(I.rbe.GUILD_TEXT), [H, R] = r.useState(""), [U, B] = r.useState(!1), O = (0, o.bG)([m.A], () => m.A.getGuild(t), [t]), M = (0, x.R)(t), V = (0, g.V)(O), W = r.useMemo(() => (function(e) {
        let {
    ...
    }), [M, V]), X = (0, o.bG)([f.A], () => f.A.getCategories(t)._categories, [t]), F = r.useMemo(() => X.map(e => {
        let {
            channel: t
        } = e;
        return {
            id: t.id,
            value: t.id,
            label: (0, p.m1)(t, A.default, v.A)
        }
    }), [X]), K = W.find(e => e.value === N)?.channelIcon ?? k.FX, Z = "" !== H;
    return (0, i.jsx)("form", {
        onSubmit: function(e) {
