/** Chunk was on web.js **/
/** chunk id: 274794, original params: e,t,n (module,exports,require) **/
"use strict";
n.d(t, {
    A: () => y
}), n(667532), n(457529), n(321073), n(65821), n(896048);
var r = n(284009),
    i = n.n(r),
    a = n(735438),
    s = n.n(a),
...
class y {
    ...
    handleRequest(e, t) {
        new Promise(n => {
            if (null == t.nonce || "" === t.nonce) throw new c.A({
                errorCode: p.Lw6.INVALID_PAYLOAD
            }, "Payload requires a nonce");
            let r = t.cmd,
                i = this.commands[r];
            if (null == i) throw new c.A({
    ...
    dispatchToSubscriptions(e, t, n, r) {
        null != r && "" !== r && E(r) || this.subscriptions.forEach(r => {
            var i;
            r.evt !== e || ("function" != typeof t || t(r)) && ("object" != typeof t || g(t, null != (i = r.args) ? i : {})) && ("function" == typeof n && (n = n(r)), this.dispatch(r.socket, null, p.e$_.DISPATCH, r.evt, n))
        })
    }
    updateSubscriptions() {
    ...
    constructor(e) {
        _(this, "getCurrentUser", () => null), _(this, "onConnect", () => {}), _(this, "onDisconnect", () => {}), _(this, "getJoi", void 0), _(this, "events", {}), _(this, "commands", {}), _(this, "sockets", new Set), _(this, "subscriptions", []), _(this, "isSubscribedListeners", new Set), this.getJoi = e
    }
}