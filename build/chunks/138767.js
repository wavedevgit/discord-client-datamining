...
function l(e) {
    ...
    return e.has(a.fd.SIGNAL_AV1_DECODE) ? c.push({
        ...
        name: "H265",
        encode: "u" < typeof window || (null == (n = window) || null == (t = n.DiscordNative) ? void 0 : t.process.platform) !== "darwin" || (null == (s = window) || null == (r = s.DiscordNative) ? void 0 : r.os.arch) === "arm64" && i().satisfies(null == (l = window) || null == (o = l.DiscordNative) ? void 0 : o.os.release, a.Dk),
        decode: !(null == e ? void 0 : e.has(a.fd.H265_HARDWARE_ONLY)) || (null == e ? void 0 : e.has(a.fd.H265_HARDWARE_DECODE_AVAILABLE))
    }), c
}

function c(e, t) {
    return o(JSON.parse(e).map(e => ({
        name: u(e.codec),
        encode: e.encode,
        decode: e.decode
    })), t)
