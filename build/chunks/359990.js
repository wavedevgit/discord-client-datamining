...
function T(t) {
    ...
    } = t, T = (0, o.GV)(), [I, O] = i.useState(y.intl.string(y.t["I/sJtJ"])), [_, k] = i.useState(!1), [R, w] = i.useState(v), [U, J] = i.useState(""), [D, K] = i.useState(null), B = i.useCallback(async () => {
        w(N.C.REGISTER);
        let t = S.isPlatformEmbedded && C.Ay.supportsFeature(E.BYE.WEBAUTHN) ? C.Ay.webAuthnRegister(d) : (0, A.v)(d);
        try {
            let e = await t;
            J(e), w(N.C.NAME)
        } catch (t) {
    ...
    return (0, s.jsxs)(l.EOs, {
        ...
        children: [(0, s.jsxs)(l.rQ0, {
            ...
            children: [(0, s.jsxs)(l.Heading, {
                ...
                children: [R === N.C.INIT && y.intl.string(y.t.vrOCCk), R === N.C.REGISTER && y.intl.string(y.t.wePEBF), R === N.C.NAME && y.intl.string(y.t["cY/IOu"]), R === N.C.SUCCESS && u.A.parse(y.intl.string(y.t.FXC7ZC))]
            }), (0, s.jsx)(l.s_y, {
                onClick: a,
                className: b.iT
            })]
            ...
            children: [(0, s.jsxs)(l.q7S, {
                ...
                children: [(0, s.jsxs)(l.$mQ, {
                    ...
                    children: [(0, s.jsx)("div", {
                        ...
                        children: null != D && (0, s.jsx)(l.Text, {
                ...
                children: (0, s.jsxs)("form", {
                    onSubmit: t => {
                        t.preventDefault(), f.AF(I, c, U).then(async () => {
                            ...
                            t instanceof r.oh && t.status >= 400 && t.status < 500 && j.A.signalUnknownCredential(U), K(y.intl.string(y.t.fEptJP)), w(N.C.INIT)
                        })
                    },
                    children: [(0, s.jsxs)(l.$mQ, {
                        className: b.Qs,
