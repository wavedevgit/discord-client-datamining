...
function T(t) {
    ...
    } = (0, d.Ay)(v ?? [], o.A.SOCIAL_LAYER_CLAIM_PURCHASED_ITEM_MODAL), w = (0, p.n)({
        location: "SocialLayerStorefrontItemClaimedSuccessfullyModal"
    }), D = !g || null == N, M = e.useRef({
        analyticsLocations: O,
        skuId: T.id,
        applicationId: b.id,
        isLaunchable: N,
    ...
    if (E) {
        ...
        return (0, n.jsxs)(l.dWK, {
            ...
            children: [(0, n.jsx)(C.z, {
                ...
                }), null != L && L > 0 && (0, n.jsx)("div", {
                    className: S.I,
                    children: (0, n.jsx)(s.J, {
                        Icon: l.Cp8,
                        text: k.intl.format(k.t["0StwHe"], {
                            orbCount: L
                        })
                    })
                })]
        ...
        return (0, n.jsx)(f.m, {
            ...
            bodyText: k.intl.formatToPlainString(e, {
                applicationName: b.name
            }),
