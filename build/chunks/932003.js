/** chunk id: 932003, original params: e,t,i (module,exports,require) **/
i.d(t, {
    b: () => x
});
var r = i(627968);
...
function x() {
    ...
    }), i = (0, o.T)(t?.bannerAsset), x = (0, o.T)(t?.avatarAsset);
    if (null == t || null == e || 0 === e.length) return null;
    let C = (0, d.gc)(i),
        g = t?.gradient,
        p = null != g && null != g.colors && g.colors.length >= 2 ? (0, d.K5)({
            gradient: g.colors,
            angle: g.angle ?? void 0
        }) : void 0,
        T = (0, d.x)(C, p);
    return (0, r.jsxs)("div", {
        className: u.kL,
        ...
        children: [(0, r.jsxs)("div", {
            ...
            children: [(0, r.jsx)(a.Text, {
                ...
                color: "always-white",
                children: m.intl.formatToPlainString(m.t["2h5M+X"], {
