/** chunk id: 932003 params = (module,exports,require) **/
r.d(t, {
    b: () => T
});
var n = r(627968);
...
function T() {
    ...
    }), r = (0, o.T)(t?.bannerAsset), T = (0, o.T)(t?.avatarAsset);
    if (null == t || null == e || 0 === e.length) return null;
    let g = (0, d.gc)(r),
        x = t?.gradient,
        p = null != x && null != x.colors && x.colors.length >= 2 ? (0, d.K5)({
            gradient: x.colors,
            angle: x.angle ?? void 0
        }) : void 0,
        I = (0, d.x)(g, p);
    return (0, n.jsxs)("div", {
        className: m.kL,
        ...
        children: [(0, n.jsxs)("div", {
            ...
            children: [(0, n.jsx)(s.Text, {
                ...
                color: "always-white",
                children: u.intl.formatToPlainString(u.t["2h5M+X"], {
