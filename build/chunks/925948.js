/** chunk id: 925948 params = (module,exports,require) **/
n.d(t, {
    A: () => u
});
var i = n(735438),
    ...
    u = new class {
        ...
        handleWriteCaches(e, t) {
            ...
            if (t) {
                ...
                let t = "0",
                    i = "0",
                    l = Object.keys(r.A.getMutablePrivateChannels()),
                    s = new Set(l);
                for (let e of (i = a()(l).sort(o.default.compare).reverse().value()[0] ?? "0", n)) null != e._lastMessageId && (1 === o.default.compare(e._lastMessageId, t) && (t = e._lastMessageId), s.has(e.channelId) && 1 === o.default.compare(e._lastMessageId, i) && (i = e._lastMessageId));
