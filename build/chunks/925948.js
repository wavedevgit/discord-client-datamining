    ...
    u = new class {
        ...
        handleWriteCaches(e, t) {
            ...
            if (t) {
                ...
                let t = "0",
                    i = "0",
                    a = Object.keys(r.A.getMutablePrivateChannels()),
                    s = new Set(a);
                for (let e of (i = l()(a).sort(o.default.compare).reverse().value()[0] ?? "0", n)) null != e._lastMessageId && (1 === o.default.compare(e._lastMessageId, t) && (t = e._lastMessageId), s.has(e.channelId) && 1 === o.default.compare(e._lastMessageId, i) && (i = e._lastMessageId));
