...
class W extends U.Ay {
    ...
    handleClick = () => {
        ...
        }), t || n || e.isRoleSubscriptionTemplatePreviewChannel() || (0, C.av)(e), __OVERLAY__ || (0, E.iN)(e.id)
    };
    handleClickChat = () => {
        let {
            channel: e,
    ...
    handleContextMenu = e => {
        let {
            channel: t
        } = this.props, s = j.A.getGuild(t.getGuildId());
...
function z(e) {
    let {
        ...
        unread: L.Ay.hasUnread(n.id),
        mentionCount: L.Ay.getMentionCount(n.id)
    })), d = (0, a.bG)([M.Ay], () => M.Ay.resolveUnreadSetting(n)), u = (0, a.cf)([y.A, R.A, O.A], () => {
    ...
    }), h = (0, a.bG)([v.A], () => v.A.isCollapsed(n.parent_id)), A = (0, T.Ay)(n.id), m = (0, a.bG)([b.A], () => b.A.getStageInstanceByChannel(n.id), [n.id]), _ = (0, I.zy)(n.id, N.ip.AUDIENCE), {
        isSubscriptionGated: p,
        needSubscriptionToAccess: g
    } = (0, f.A)(n.id), x = (0, a.bG)([M.Ay], () => M.Ay.isFavorite(t.id, n.id)), E = (0, S.xn)(n.id), C = (0, P.A)({
        channel: n,
        isChannelSelected: !1,
