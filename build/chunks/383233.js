/** chunk id: 383233, original params: e,t,n (module,exports,require) **/
"use strict";
n.d(t, {
    Ay: () => E,
    _c: () => g,
...
class h extends a.A {
    constructor(e) {
        var t;
        super(), u(this, "message", void 0), u(this, "moderatorReport", void 0), this.message = new _(e.message), this.moderatorReport = null != (t = e.moderator_report) ? t : null
    }
}
class m extends _ {
    isEdited() {
    ...
    removeReactionsForEmoji(e) {
        return this.set("reactions", this.reactions.filter(t => !(0, l.i6)(t.emoji, e)))
    }
    isSystemDM() {
    ...
    canDeleteOwnMessage(e) {
        ...
        let a = null != (t = null == (n = this.interactionMetadata) ? void 0 : n.authorizing_integration_owners) ? t : {};
        return (null == (i = this.interactionMetadata) ? void 0 : i.user.id) === e && 1 === Object.keys(a).length && r.b.USER_INSTALL in a
    }
    toJS() {
        return p(d({}, this), {
