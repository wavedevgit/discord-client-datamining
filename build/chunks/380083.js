...
function U(e) {
    ...
    if (r()(null != a && null != d, "Missing startingPlan or newPlan"), f.LE.indexOf(n) < f.LE.indexOf(s)) switch (s) {
            ...
            case f.gD.PREMIUM_YEAR_TIER_2:
                t = x.intl.formatToPlainString(x.t["M/Lknl"], {
                    numFreeGuildSubscriptions: f.M4
                }), T.NcF.has(i ?? T.hes.UNKNOWN) && (t = x.intl.format(x.t.mULxLW, {
                    numFreeGuildSubscriptions: f.M4
                }));
                break;
...
function v(e) {
    ...
    let B = e => D ? x.intl.formatToPlainString(R.default.pDiwHe, {
        premiumGroupProductName: (0, A.DP)(),
        totalSeats: A.LM
    }) : e.skuId === f.pe.TIER_0 ? T.NcF.has(k ?? T.hes.UNKNOWN) ? x.intl.format(x.t.o6hBiR, {}) : x.intl.string(x.t["AGf/ye"]) : e.skuId === f.pe.TIER_1 ? T.NcF.has(k ?? T.hes.UNKNOWN) ? x.intl.format(x.t.o6hBiR, {}) : x.intl.string(x.t.knvOVz) : T.NcF.has(k ?? T.hes.UNKNOWN) ? x.intl.format(x.t.A4THYt, {}) : x.intl.string(x.t.aTUr3Z);
    if ("deeplink_to_desktop_app" === w || O === I.uH.META_QUEST_WEB_REDIRECT_CHECKOUT) t = (0, l.jsx)("div", {
        className: P.Qq,
        children: (0, l.jsxs)("p", {
            children: [x.intl.string(x.t.bIVRSQ), " ", x.intl.string(x.t["0UJqOy"])]
        })
    });
    else if (null != y) t = (0, l.jsx)("div", {
        className: P.Qq,
        children: x.intl.format(x.t["tsQOs+"], {
            skuName: y.name
        })
    });
    else if (F && !u) {
        ...
        r()(null != e, "Missing plan"), e.skuId === f.pe.TIER_0 ? t = (0, l.jsxs)("div", {
            className: P.Qq,
            children: [(0, l.jsx)("p", {
                children: x.intl.string(x.t["L9lcG/"])
            }), (0, l.jsx)("p", {
            ...
            className: P.Qq,
            children: [(0, l.jsx)("p", {
                children: x.intl.string(x.t.UPpbP3)
            }), (0, l.jsx)("p", {
                children: x.intl.format(x.t.EoDFuN, {
                    helpCenterLink: h.A.getArticleURL(T.MVz.FRACTIONAL_PREMIUM_ABOUT)
                })
        ...
        r()(null != e, "Missing plan"), t = (0, l.jsxs)(l.Fragment, {
            children: [(0, l.jsx)("div", {
                ...
                className: P.Qq,
                children: x.intl.format(x.t["6aZ0NR"], {
                    guildName: v.name
                })
            })]
        })
    ...
    let [Q, q] = i.useState(!1), G = i.useCallback(() => {
        null != L && (L(), O === I.uH.MOBILE_WEB_REDIRECT_CHECKOUT && q(!0))
    }, [L, O]);
    s = D ? x.intl.string(R.default.clIveA) : "deeplink_to_desktop_app" === w || O === I.uH.MOBILE_WEB_REDIRECT_CHECKOUT ? x.intl.string(x.t.sRApon) : null != y ? x.intl.formatToPlainString(x.t["1qGgm4"], {
        skuName: y.name
    }) : u ? x.intl.string(x.t.QJ9EyM) : null != v ? x.intl.string(x.t.ta3cXY) : x.intl.string(x.t.TkTvBz);
    let z = () => T.NcF.has(k ?? T.hes.UNKNOWN) ? N.Ay.Types.PREMIUM_PAYMENT_STARTED : null != a ? N.Ay.Types.PREMIUM_UPDATED : N.Ay.Types.PREMIUM_ACTIVATED;
    return b ? (0, l.jsx)(_.A, {
        type: z(),
        text: t,
        buttonText: s,
        hideClose: Z || W,
