...
function Z(e) {
    ...
    if (r()(null != a && null != d, "Missing startingPlan or newPlan"), _.LE.indexOf(n) < _.LE.indexOf(s)) switch (s) {
            ...
            case _.gD.PREMIUM_YEAR_TIER_2:
                t = R.intl.formatToPlainString(R.t["M/Lknl"], {
                    numFreeGuildSubscriptions: _.M4
                }), I.NcF.has(i ?? I.hes.UNKNOWN) && (t = R.intl.format(R.t.mULxLW, {
                    numFreeGuildSubscriptions: _.M4
                }));
                break;
...
function k(e) {
    ...
    let W = e => D ? R.intl.formatToPlainString(x.default.pDiwHe, {
        premiumGroupProductName: (0, A.DP)(),
        totalSeats: A.LM
    }) : e.skuId === _.pe.TIER_0 ? I.NcF.has(U ?? I.hes.UNKNOWN) ? R.intl.format(R.t.o6hBiR, {}) : R.intl.string(R.t["AGf/ye"]) : e.skuId === _.pe.TIER_1 ? I.NcF.has(U ?? I.hes.UNKNOWN) ? R.intl.format(R.t.o6hBiR, {}) : R.intl.string(R.t.knvOVz) : I.NcF.has(U ?? I.hes.UNKNOWN) ? R.intl.format(R.t.A4THYt, {}) : R.intl.string(R.t.aTUr3Z);
    if ("deeplink_to_desktop_app" === w) t = (0, l.jsx)("div", {
        className: P.Qq,
        children: (0, l.jsxs)("p", {
            children: [R.intl.string(R.t.bIVRSQ), " ", R.intl.string(R.t["0UJqOy"])]
        })
    });
    else if (null != y) t = (0, l.jsx)("div", {
        className: P.Qq,
        children: R.intl.format(R.t["tsQOs+"], {
            skuName: y.name
        })
    });
    else if (F && !M) {
        let e = u.A.get(n);
        r()(null != e, "Missing plan"), e.skuId === _.pe.TIER_0 ? t = (0, l.jsxs)("div", {
            className: P.Qq,
            children: [(0, l.jsx)("p", {
                children: R.intl.string(R.t["L9lcG/"])
            }), (0, l.jsx)("p", {
                children: R.intl.format(R.t.EoDFuN, {
                    helpCenterLink: h.A.getArticleURL(I.MVz.FRACTIONAL_PREMIUM_ABOUT)
                })
            })]
        }) : (e.skuId === _.pe.TIER_1 || e.skuId === _.pe.TIER_2) && (t = (0, l.jsxs)("div", {
            className: P.Qq,
            children: [(0, l.jsx)("p", {
                children: R.intl.string(R.t.UPpbP3)
            }), (0, l.jsx)("p", {
                children: R.intl.format(R.t.EoDFuN, {
                    helpCenterLink: h.A.getArticleURL(I.MVz.FRACTIONAL_PREMIUM_ABOUT)
                })
        ...
        r()(null != e, "Missing plan"), t = (0, l.jsxs)(l.Fragment, {
            children: [(0, l.jsx)("div", {
                ...
                className: P.Qq,
                children: R.intl.format(R.t["6aZ0NR"], {
                    guildName: k.name
                })
            })]
        })
    ...
    let [B, G] = i.useState(!1), K = i.useCallback(() => {
        null != L && (L(), O === T.uH.MOBILE_WEB_REDIRECT_CHECKOUT && G(!0))
    }, [L, O]);
    s = D ? R.intl.string(x.default.clIveA) : "deeplink_to_desktop_app" === w || O === T.uH.MOBILE_WEB_REDIRECT_CHECKOUT ? R.intl.string(R.t.sRApon) : null != y ? R.intl.formatToPlainString(R.t["1qGgm4"], {
        skuName: y.name
    }) : M ? R.intl.string(R.t.QJ9EyM) : null != k ? R.intl.string(R.t.ta3cXY) : R.intl.string(R.t.TkTvBz);
    let Q = () => I.NcF.has(U ?? I.hes.UNKNOWN) ? N.Ay.Types.PREMIUM_PAYMENT_STARTED : null != a ? N.Ay.Types.PREMIUM_UPDATED : N.Ay.Types.PREMIUM_ACTIVATED;
    return b ? (0, l.jsx)(f.A, {
        type: Q(),
        text: t,
        buttonText: s,
        hideClose: v,
