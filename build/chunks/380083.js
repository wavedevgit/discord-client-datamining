...
function Z(e) {
    ...
    if (r()(null != a && null != c, "Missing startingPlan or newPlan"), f.LE.indexOf(n) < f.LE.indexOf(s)) switch (s) {
            ...
            case f.gD.PREMIUM_YEAR_TIER_2:
                ...
                }), x.NcF.has(i ?? x.hes.UNKNOWN) && (t = P.intl.format(P.t.mULxLW, {
                    numFreeGuildSubscriptions: f.M4
                }));
                break;
...
function v(e) {
    ...
    let q = e => D ? P.intl.formatToPlainString(T.default.pDiwHe, {
        premiumGroupProductName: (0, _.DP)(),
        totalSeats: _.LM
    }) : e.skuId === f.pe.TIER_0 ? x.NcF.has(j ?? x.hes.UNKNOWN) ? P.intl.format(P.t.o6hBiR, {}) : P.intl.string(P.t["AGf/ye"]) : e.skuId === f.pe.TIER_1 ? x.NcF.has(j ?? x.hes.UNKNOWN) ? P.intl.format(P.t.o6hBiR, {}) : P.intl.string(P.t.knvOVz) : x.NcF.has(j ?? x.hes.UNKNOWN) ? P.intl.format(P.t.A4THYt, {}) : P.intl.string(P.t.aTUr3Z);
    ...
    s = D ? P.intl.string(T.default.clIveA) : "deeplink_to_desktop_app" === U || O === I.uH.APPLE_PAYMENT_LINK ? P.intl.string(P.t.qXV2XU) : null != S ? P.intl.formatToPlainString(P.t["1qGgm4"], {
        skuName: S.name
    }) : u ? P.intl.string(P.t.QJ9EyM) : null != v ? P.intl.string(P.t.ta3cXY) : P.intl.string(P.t.TkTvBz);
    let Y = () => x.NcF.has(j ?? x.hes.UNKNOWN) ? A.Ay.Types.PREMIUM_PAYMENT_STARTED : null != a ? A.Ay.Types.PREMIUM_UPDATED : A.Ay.Types.PREMIUM_ACTIVATED;
