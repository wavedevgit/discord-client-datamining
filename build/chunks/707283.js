/** chunk id: 707283, original params: e,l,a (module,exports,require) **/
a.d(l, {
    t: () => c
});
var t = a(627968),
...
let c = {
    ...
    stories: [{
        ...
        component: function(e) {
            ...
            }, []), g = (0, n.Ec)((0, n.Xj)()), V = m ? g.subtract({
                weeks: 1
            }) : void 0, C = m ? g.add({
                weeks: 2
            }) : void 0;
            return (0, u.i)("DateRangePickerStory") ? (0, t.jsxs)(r.BJc, {
                direction: "vertical",
                gap: "md",
                children: [(0, t.jsx)(s.Ur, {
                    label: l,
        ...
        controls: {
            ...
            description: {
                type: "text",
                label: "Description",
                defaultValue: "Choose your preferred date range"
            },
            errorMessage: {
                type: "text",
                label: "Error Message",
