/** Chunk was on web.js **/
/** chunk id: 619718, original params: e,t,n (module,exports,require) **/
"use strict";
n.d(t, {
    A: () => u
});
...
let o = 1e3 / 24,
    ...
    u = function(e) {
        ...
        } = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : {}, f = r.useRef(t), p = r.useRef(0), _ = r.useRef(void 0), h = r.useRef(void 0), m = r.useRef(!0), g = r.useRef(0), E = r.useRef(void 0), y = r.useCallback(() => {
