...
let R = e => {
        let {
            onClose: t,
            onShare: n
        } = e, i = (0, c.bG)([p.A], () => p.A.getReferralsRemaining()), r = (0, c.bG)([p.A], () => p.A.getHasEligibleFriends()), [u, _] = a.useState(new Map), [A, h] = a.useState(""), g = (0, m.A)(A, 400), {
            eligibleUsers: I,
            fetchUsers: R,
            hasError: v,
            isFetching: M,
        ...
        return null === i ? (0, l.jsx)(d.y$y, {}) : v ? (0, l.jsx)(o.Modal, {
            ...
            subtitle: N.intl.format(N.t.OOCbz8, {
                helpdeskArticle: f.A.getArticleURL(T.MVz.REFERRAL_PROGRAM)
            }),
            onClose: t,
            actions: []
        }) : (0, l.jsx)(o.Modal, {
...
let j = e => {
    ...
    } = (0, A.Ay)([_.A.PREMIUM_MARKETING_REFERALL_PROGRAM_SHARE_MODAL]), f = async e => {
        h.default.track(T.HAw.REFERRAL_PROGRAM_SHARE_CTA_CLICKED, {
            location_stack: m
        });
