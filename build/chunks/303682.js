...
let v = e => {
        let {
            ...
            onClose: n,
            onShare: i
        } = e, r = (0, c.bG)([x.A], () => x.A.getReferralsRemaining()), u = (0, c.bG)([x.A], () => x.A.getHasEligibleFriends()), [_, A] = a.useState(new Map), [f, h] = a.useState(""), p = (0, m.A)(f, 400), {
            eligibleUsers: T,
            fetchUsers: v,
            hasError: M,
            isFetching: j,
    ...
    M = e => {
        ...
        return a.useEffect(() => {
            ...
            onClose: i,
            actions: [],
            actionBarInput: (t = h.size <= 1 ? S.intl.string(S.t.ItpQxk) : S.intl.format(S.t.iW2stn, {
                nTrials: h.size
            }), (0, l.jsx)("div", {
                className: s()(R.qr, R.h0),
                children: (0, l.jsx)(d.Button, {
...
var j = ((i = {})[i.SELECT_FRIENDS = 1] = "SELECT_FRIENDS", i[i.CONFIRMATION = 2] = "CONFIRMATION", i[i.REMINDER = 3] = "REMINDER", i);
let O = e => {
    let {
        transitionState: t,
        onClose: n,
        ...
        h.default.track(N.HAw.REFERRAL_PROGRAM_SHARE_CTA_CLICKED, {
            location_stack: f
        });
