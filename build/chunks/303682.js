...
let R = e => {
        let {
            ...
            onClose: n,
            onShare: i
        } = e, r = (0, c.bG)([p.A], () => p.A.getReferralsRemaining()), u = (0, c.bG)([p.A], () => p.A.getHasEligibleFriends()), [_, A] = a.useState(new Map), [f, E] = a.useState(""), I = (0, m.A)(f, 400), {
            eligibleUsers: R,
            fetchUsers: v,
            hasError: M,
            isFetching: j,
            ...
            searchQuery: I,
            selectedUsers: _
        }), [b, y] = a.useState(!1), L = R.reduce((e, t) => (e.has(t.id) || e.set(t.id, t), e), new Map);
        return null === r ? (0, l.jsx)(d.y$y, {}) : M ? (0, l.jsx)(o.Modal, {
            ...
            actionBarInput: (e => {
                ...
                return t = !0 === r ? N.intl.string(N.t.wpSqAW) : _.size <= 1 ? N.intl.string(N.t.ItpQxk) : N.intl.format(N.t.iW2stn, {
                    nTrials: _.size
                }), (0, l.jsx)("div", {
            ...
            children: (e => {
                ...
                return (0, l.jsx)(x.A, {
                    ...
                    isFetching: j,
                    onFetchMore: v,
                    isUserDisabled: e => null !== r && 0 !== r && [..._.values()].filter(e => !O.has(e.id)).length >= r && !_.has(e.id) && !O.has(e.id),
                    searchQuery: I,
                    emptySearchContent: {
    ...
    v = e => {
        ...
        return a.useEffect(() => {
            ...
            onClose: i,
            actions: [],
            actionBarInput: (t = f.size <= 1 ? N.intl.string(N.t.ItpQxk) : N.intl.format(N.t.iW2stn, {
                nTrials: f.size
            }), (0, l.jsx)("div", {
                className: s()(S.qr, S.h0),
                children: (0, l.jsx)(d.Button, {
...
let j = e => {
    let {
        ...
        onClose: n,
        startingScreen: i = 1
    } = e, r = (0, c.bG)([p.A], () => p.A.getReferralsRemaining()), [s, o] = a.useState(i), [u, m] = a.useState([]), {
        analyticsLocations: h
    } = (0, A.Ay)([_.A.PREMIUM_MARKETING_REFERALL_PROGRAM_SHARE_MODAL]), g = async e => {
    ...
    return null === r ? (0, l.jsx)(d.y$y, {}) : 2 === s ? (0, l.jsx)(I.h, {
        transitionState: t,
