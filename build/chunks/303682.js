...
let O = e => {
        let {
            ...
            onClose: n,
            onShare: i
        } = e, r = (0, c.bG)([C.A], () => C.A.getReferralsRemaining()), u = (0, c.bG)([C.A], () => C.A.getHasEligibleFriends()), [m, A] = l.useState(new Map), [E, I] = l.useState(""), N = (0, _.A)(E, 400), {
            eligibleUsers: p,
            fetchUsers: O,
            hasError: M,
            isFetching: D,
        ...
        return null === r ? (0, a.jsx)(d.y$y, {}) : M ? (0, a.jsx)(o.Modal, {
            ...
            input: (0, a.jsx)(d.iS7, {
                ...
                children: (0, a.jsx)("div", {
                    ...
                    children: (0, a.jsx)(d.a32, {
                        placeholder: 0 === m.size ? x.intl.string(x.t.Kd5RaI) : "",
                        onQueryChange: e => {
                            I(e.target.value)
                        }
                    })
            ...
            actionBarInput: (e => {
                ...
                return t = !0 === r ? x.intl.string(x.t.wpSqAW) : m.size <= 1 ? x.intl.string(x.t.ItpQxk) : x.intl.format(x.t.iW2stn, {
                    nTrials: m.size
                }), (0, a.jsx)("div", {
...
let P = e => {
    let {
        ...
        onClose: n,
        startingScreen: i = 1
    } = e, r = (0, c.bG)([C.A], () => C.A.getReferralsRemaining()), [s, o] = l.useState(i), [u, _] = l.useState([]), {
