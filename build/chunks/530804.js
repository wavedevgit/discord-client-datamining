...
function p(e, t) {
    ...
    return i.useMemo(() => (function(e, t, n) {
        ...
        return e?.forEach(e => {
            ...
            a.has(e.user.id) || i.splice((0, l.sortedIndexBy)(i, e, e => {
                let {
                    comparator: t
                } = e;
                return t
...
function f(e, t) {
    ...
    return i.useMemo(() => (function(e, t) {
        ...
        let n = [...t];
        return e.forEach(e => {
            n.splice((0, l.sortedIndexBy)(n, e, e => (0, s.KU)(e)), 0, e)
        }), n
    })(n, t), [n, t])
}
...
function E(e, t) {
    let n = (0, a.bG)([c.default], () => c.default.getId() === t),
        ...
        [r, o] = i.useState(!1),
        [d, u] = i.useState(!1),
        h = (0, a.bG)([m.A, g.A], () => null != t && null != e && m.A.getChannelId() === e && null != g.A.isInChannel(e, t) && m.A.isUserConnected(t)),
        A = (0, a.bG)([m.A, g.A], () => null != t && null != e && m.A.getChannelId() === e && null != g.A.isInChannel(e, t) && !m.A.isUserConnected(t));
    return i.useEffect(() => {
        h && u(!0)
    }, [h]), i.useEffect(() => {
        l !== e && u(!1)
    }, [e, l]), i.useEffect(() => (A && null == s.current ? s.current = setTimeout(() => {
        s.current = null, o(!0)
