/** chunk id: 526710, original params: t,i,e (module,exports,require) **/
e.d(i, {
    default: () => f
});
var r = e(627968),
...
function M(t) {
    return (0, r.jsx)(a.Modal, {
        ...t,
        size: "md",
        title: b.intl.formatToPlainString(g.default.BcZLdW, {
...
let f = t => {
    let {
        ...
        disabled: e,
        ...f
    } = i, A = (0, n.bG)([s.A], () => s.A.getPremiumTypeSubscription()), _ = A?.hasActiveTrial ?? !1, h = e && !_;
    return (0, r.jsx)(d.A, {
        subscriptionTier: p.pe.TIER_2,
        ...
        children: i => {
            ...
            return (0, r.jsx)(a.ExpressiveModal, {
                ...
                title: b.intl.formatToPlainString(g.default.tJbHtN, {
                    premiumGroupProductName: (0, P.DP)()
                }),
                badge: {
                    type: "beta",
