...
function H(e) {
    let {
        ...
        confettiCanvas: T
    } = s.useContext(E.x), [g, N] = s.useState(null), f = (0, c.f9)(T, g), p = function(e, t) {
    ...
    }, [C, f, m, d]), (0, r.jsxs)(r.Fragment, {
        children: [(0, r.jsx)(c.K_, {
            ref: N,
            sprites: b,
            colors: y,
            spriteWidth: 45,
...
function F(e) {
    let t, {
        ...
        P = U.nick,
        L = a(U);
    t = null == o || null == l ? u > 1 ? R.intl.format(R.t.yfC9ds, {
        username: P,
        usernameHook: L,
        numSubscriptions: u
