...
function F(e) {
    let {
        ...
        position: i,
        size: r
    } = e, d = l.useRef(null), [u, A] = l.useState(null), [E] = l.useState(i ?? function() {
        ...
        confettiCanvas: T
    } = l.useContext(m.x), [f, N] = l.useState(null), g = (0, o.f9)(T, f), C = function(e, t) {
    ...
    }(u, E), h = D.includes(E), p = h && "exit" === u, x = l.useCallback(e => {
        A(e)
    }, []), R = l.useCallback(() => {
        "exit" === u && t?.()
