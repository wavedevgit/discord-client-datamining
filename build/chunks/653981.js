/** chunk id: 653981, original params: t,e,i (module,exports,require) **/
i.d(e, {
    default: () => y
}), i(321073);
var n = i(627968),
...
function x(t) {
    let {
        guild: e
    } = t, i = (0, o.bG)([S.A], () => S.A.getEveryoneRole(e));
...
function L(t) {
    ...
    return 0 === e.length && 2 !== i ? null : (2 === i && (e = f.dR), (0, n.jsxs)("div", {
        className: O.CZ,
        children: [(0, n.jsx)(_.Text, {
            className: O.qd,
            variant: "text-xs/semibold",
...
function U(t) {
    ...
    return 0 === a.length && 2 !== i ? null : (0, n.jsxs)("div", {
        className: O.tp,
        children: [2 !== i ? (0, n.jsx)(R, {
            permissions: a,
            step: i
        }) : null, (0, n.jsx)(L, {
            permissions: s,
...
function y(t) {
    let {
        ...
        transitionState: c,
        onClose: r
    } = t, [_, u] = a.useState(0), O = a.useMemo(() => {
        let t = [],
            i = [];
        return f.dR.map(n => {
    ...
    let x = () => {
            let t, n;
            i && (t = S.A.getEveryoneRole(e), n = s.TF(t.permissions, f.e$), (0, E.JY)(e.id, [{
                ...t,
                permissions: n
            }])), o && (p.A.updateGuild({
                defaultMessageNotifications: h.orn.ONLY_MENTIONS
            }), p.A.saveGuild(e.id, {
                defaultMessageNotifications: h.orn.ONLY_MENTIONS
            }))
        },
        C = [...0 === _ ? [{
            ...
            onClick: () => {
                i || (x(), r(), (0, N._$)(l.V.DISABLE_UNSAFE_COMMUNITY_PERMISSIONS_NOTICE, e?.id ?? "", !0, T.i.PRIMARY)), 0 === _ ? (u(1), setTimeout(() => u(2), 3e3)) : 2 === _ && (x(), r(), (0, N._$)(l.V.DISABLE_UNSAFE_COMMUNITY_PERMISSIONS_NOTICE, e?.id ?? "", !0, T.i.PRIMARY))
            },
            loading: 1 === _
        }];
