        ...
        children: e => {
            ...
            return a === s.M.BOOST_PROGRESS_BAR_ADMIN_COACHMARK ? (0, i.jsx)(r.A, {
                ...
                actions: [{
                    ...
                    variant: "primary",
                    onClick: () => {
                        c(m.i.TAKE_ACTION), u.A.open(t.id, g.BEX.BOOST_PERKS, o.A.GUILD_BOOSTING_PROGRESS_BAR_ADMIN_COACHMARK)
                    }
                }]
                ...
                actions: [{
                    ...
                    variant: "primary",
                    onClick: () => {
                        c(m.i.TAKE_ACTION), (0, p.A)(t.id, o.A.GUILD_BOOSTING_PROGRESS_BAR_MEMBER_COACHMARK)
                    }
                }]
            }) : null
        }
