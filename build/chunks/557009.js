/** chunk id: 557009, original params: e,t,n (module,exports,require) **/
"use strict";
n.d(t, {
    A: () => u
});
...
class u extends i.A {
    ...
    constructor(e) {
        super(), c(this, "id", void 0), c(this, "skuId", void 0), c(this, "applicationId", void 0), c(this, "user", void 0), c(this, "userId", void 0), c(this, "gifterId", void 0), c(this, "type", void 0), c(this, "branches", void 0), c(this, "startsAt", void 0), c(this, "endsAt", void 0), c(this, "subscriptionId", void 0), c(this, "subscriptionPlanId", void 0), c(this, "parentId", void 0), c(this, "consumed", void 0), c(this, "giftCodeBatchId", void 0), c(this, "giftStyle", void 0), c(this, "guildId", void 0), c(this, "deleted", void 0), c(this, "sourceType", void 0), c(this, "fulfillmentStatus", void 0), this.id = e.id, this.skuId = e.skuId, this.applicationId = e.applicationId, this.user = e.user, this.userId = e.userId, this.gifterId = e.gifterId, this.type = e.type, this.branches = e.branches, this.startsAt = e.startsAt, this.endsAt = e.endsAt, this.subscriptionId = e.subscriptionId, this.subscriptionPlanId = e.subscriptionPlanId, this.parentId = e.parentId, this.consumed = e.consumed, this.giftCodeBatchId = e.giftCodeBatchId, this.giftStyle = e.giftStyle, this.guildId = e.guildId, this.deleted = e.deleted, this.sourceType = e.sourceType, this.fulfillmentStatus = e.fulfillmentStatus
    }
}