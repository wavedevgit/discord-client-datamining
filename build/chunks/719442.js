...
var y = function(e) {
        ...
        for (var u of i) {
            ...
            if (!d) break;
            var f = U(u, d);
            if ([a, o] = n ? [o, f] : [f, a], G(a, r.ZWJ) && G(o, r.ExtPict) && !(l = n ? H(e.substring(0, s)) : H(e.substring(0, e.length - s))) || G(a, r.RI) && G(o, r.RI) && !(c = null !== c ? !c : !!n || W(e.substring(0, e.length - s))) || a !== r.None && o !== r.None && F(a, o)) break;
            s += u.length
        }
        return s || 1
    },
                    ...
                    for (var [k, U] of eg.points(t)) {
                        ...
                        if (null != t && null != G) t[U] = G;
                            ...
                            for (var [B, H] of ei.texts(e))
                                if (-1 === el.compare(H, M)) V = [B, H];
                                else {
                                    F = [B, H];
                                    break
                                } var Y = !1;
                            V && F && (Y = el.equals(F[1], M) ? !el.hasPrevious(F[1]) : el.common(V[1], M).length < el.common(F[1], M).length), V && !Y ? (k.path = V[1], k.offset = V[0].text.length) : F ? (k.path = F[1], k.offset = 0) : t = null
                        }
                    }
                break;
            case "remove_text":
...
var eF = {
        ...
        setPoint(e, t) {
            ...
            if (r) {
                ...
                eW.setSelection(e, {
                    ["anchor" === i ? "anchor" : "focus"]: eV(eV({}, s), t)
                })
            }
        },
        setSelection(e, t) {
...
var eW = eY(eY(eY(eY({}, eR), eM), eF), eB)