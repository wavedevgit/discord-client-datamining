...
function j(e, t, n) {
    let [r, a] = i.useState(e), [s, o] = i.useState(e), l = i.useRef(s);
...
function U(e) {
    let {
        ...
        ref: g,
        width: E
    } = (0, c.Ay)(), y = i.useMemo(() => w(o), [o]), b = i.useRef(void 0), O = L(n, E), A = i.useRef(l), S = i.useRef(d), C = i.useRef(null), N = window.devicePixelRatio, {
