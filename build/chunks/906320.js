...
function F(e, t, n, i, l) {
    let a = H[t],
        r = null != a ? Object.keys(a) : [],
        {
            unit: s,
            time: o
        } = (0, x.$l)(null != e ? e / 60 : null, r);
    if (null != a && null != s) {
        let e = a[s];
...
class W extends l.PureComponent {
    ...
    renderQueued() {
        ...
        if (null != n) {
            ...
            if (null != i && null != l) {
                ...
                e = a === j.OQC.PAUSING ? w.intl.formatToPlainString(w.t.vjxhWo, {
                    percent: s,
                    progress: r,
                    total: n
    ...
    renderPaused() {
        ...
        let l = P.uA(n, i),
            a = Math.floor(l),
            r = 0 === n && 1 === i ? w.intl.string(w.t["+pfsFX"]) : w.intl.formatToPlainString(w.t["+feX8S"], {
                percent: a,
                progress: (0, R.Xq)(n),
                total: (0, R.Xq)(i)
            });
...
function Z(e, t, n, i) {
    return e.reduce((e, l, a) => {
        let {
            applicationId: r,
            branchId: s
        } = l, o = n.getApplication(r), d = i.getState(r, s);
