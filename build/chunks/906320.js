...
class W extends a.PureComponent {
    ...
    renderQueued() {
        ...
        if (null != n) {
            ...
            if (null != i && null != a) {
                ...
                e = r === j.OQC.PAUSING ? w.intl.formatToPlainString(w.t.vjxhWo, {
                    percent: s,
                    progress: l,
                    total: n
    ...
    render() {
        ...
        if (null != e.state && (e.state.type === j.WTw.UPDATING || e.state.type === j.WTw.REPAIRING || e.state.type === j.WTw.INSTALLING))
...
let K = () => (0, i.jsx)(V, {
    ...
    Q = [{
        ...
        render(e, t) {
            ...
            }) : null : null != e.state ? e.state.type !== j.WTw.UP_TO_DATE && (n = e.index > 0 ? (0, i.jsx)(z, {
                item: e
...
function Z(e, t, n, i) {
    return e.reduce((e, a, r) => {
        ...
        return null != o && e.push({
            ...
            state: d,
            application: o,
            libraryApplication: v.A.getLibraryApplication(l, s),
            finished: t,
            index: r
        }), e
    }, [])
}
let J = (0, f.A)(c.Ay.connectStores([C.A, b.A, O.A, y.A, L.A], () => ({
