/** chunk id: 282592, original params: t,n,i (module,exports,require) **/
i.d(n, {
    A: () => s
});
var l = i(627968);
...
function s(t) {
    return null == t ? null : (0, l.jsx)(e.sLh, {
        id: "on-overlay",
        label: A.intl.string(A.t.rgZKg2),
        action: function() {
            if (null == t) return;
            let n = (0, a.PQ)(t.getFlags(), c.hM6.OVERLAY_DISABLED);
            r.V(t.id, t.branchId, n), d.default.track(c.HAw.APPLICATION_SETTINGS_UPDATED, {
