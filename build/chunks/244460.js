...
let N = function(e) {
    ...
    } = e, R = i.useRef(null), P = (0, l.bG)([u.A], () => u.A.getApplication(t)), L = (0, l.bG)([u.A], () => u.A.getApplicationFetchState(t));
    i.useEffect(() => {
        if (null != t && null == P) {
    ...
    let M = (0, g.Bn)(),
        U = (0, l.bG)([m.A], () => m.A.getFetchState({
            applicationId: P?.id
        })),
        w = (0, l.bG)([m.A], () => m.A.getSimilarApplications({
            applicationId: P?.id
        })),
    ...
    i.useEffect(() => {
        ...
        P?.id != null && U !== m.e.FETCHING && (0, h.TR)(I.HAw.APP_DIRECTORY_PAGE_VIEWED, {
    ...
    let F = i.useMemo(() => [{
        ...
        z = i.useCallback(e => {
            (0, h.TR)(I.HAw.APP_DIRECTORY_PROFILE_TAB_CLICKED, {
                application_id: t,
                tab_name: e
    ...
    return (0, n.jsx)(c.A, {
        ...
        children: (0, n.jsx)(r.A, {
            children: null == P ? null == L || L === u.e.FETCHING ? (0, n.jsx)("div", {
                className: E.Dg,
