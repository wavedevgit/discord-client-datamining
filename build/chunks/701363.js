    ...
    eu = e => {
        ...
        return a ? (0, l.jsx)("div", {
            ...
            children: (0, l.jsx)(N.m_, {
                text: es.intl.formatToPlainString(es.t.m0zYbV, {
                    username: n
                }),
...
function eA(e) {
    let {
        ...
        "aria-posinset": et,
        "aria-setsize": en
    } = e, [em, eA] = s.useState(!1), [ep, eh] = s.useState(!1), [ex, eE] = s.useState(!1), ef = s.useRef(null), [eN, eg] = s.useState(!1), eS = (0, m.K)(s.useCallback(e => {
        eg(e)
    }, [])), ev = s.useRef(null), eT = ee ?? ev, eC = (0, A.A)(eT, eS), {
        ...
        userId: r?.id,
        size: g._3J.SIZE_32,
        animateOnHover: !(a || em || ep || ex)
    }), [eR, eL] = s.useState({
        maskImage: "none"
    }), ew = s.useRef(null), eU = t.isMultiUserDM(), eD = t.isSystemDM(), eO = !eU && !eD && t.type === el.rbe.DM, eG = eO && r?.primaryGuild != null, eQ = (0, E.bG)([Z.Ay], () => Z.Ay.isChannelMuted(t.getGuildId(), t.id)), {
        ignored: ek,
        blocked: eP
    } = (0, E.cf)([J.A], () => ({
        ignored: J.A.isIgnored(t.getRecipientId()),
        blocked: J.A.isBlocked(t.getRecipientId())
    })), eF = eO && ek, eV = eO && eP, eq = (eQ || eF || eV) && !(a || em), eB = (0, E.bG)([Y.Ay], () => Y.Ay.getMentionCount(t.id) > 0), ez = (0, w.Ay)(t), eH = s.useRef(null), eW = null != X && (a || em || ex), eK = () => {
        eA(!0)
    }, e$ = () => {
        eA(!1)
    }, eY = () => {
        ...
        eE(!0), t.isMultiUserDM() ? (0, v.L3)(e, async () => {
            ...
            let {
                default: e
            } = await Promise.all([n.e("97262"), n.e("42128"), n.e("39778"), n.e("22128")]).then(n.bind(n, 385913));
            return n => (0, l.jsx)(e, {
                ...n,
                user: r,
                channel: t,
        ...
        let s = es.intl.formatToPlainString(es.t.hJ5Ap4, {
                name: ez
            }),
            a = es.intl.format(es.t.SSIVOu, {
                name: ez
            });
        t.isManaged() && (s = es.intl.formatToPlainString(es.t.hVGjEW, {
            name: ez
        }), a = es.intl.format(es.t.IK1Qvs, {
            name: ez
        })), (0, g.mMO)(async () => {
            let {
                default: e
        ...
        loop: em,
        boldFontOpacity: .9
    }), e7 = eG ? (0, l.jsxs)(l.Fragment, {
        children: [e6, (0, l.jsx)(V.Ay, {
    ...
    }) : e6, e3 = s.useRef(null), e4 = (0, O.W)({
        location: "PrivateChannel"
    }) && r?.displayNameStyles != null, e8 = [(0, R.Ay)({
        channel: t,
        unread: eB
    }), (0, R.r2)({
        channel: t,
        muted: eQ,
        userStatus: B
    })].filter(Boolean).join(", "), e5 = (0, E.bG)([Y.Ay], () => Y.Ay.lastMessageId(t.id)), {
        waveShouldShow: te,
        wavePressed: tt
    } = (0, U.A)(t, e5), {
        showClose: tn
    ...
    return s.useLayoutEffect(tl, [em, tl]), (0, p.g)(eT, tl), (0, l.jsx)(d.tG, {
        id: t.id,
        children: e => {
            let {
                role: n,
                    ...
                    children: [(0, l.jsx)(H.A, {
                        ...
                        children: (0, l.jsx)(M.A, {
                            ...
                            avatar: (() => {
                                let e = g._3J.SIZE_32;
                                if (t.isMultiUserDM())
                                    if (t.recipients.length >= 2 && null == t.icon) return (0, l.jsx)(F.A, {
                                        "aria-hidden": !0,
                                ...
                                let n = null;
                                return r.isSystemUser() || (n = (0, T.A)(x) ? el.clD.STREAMING : B), (0, l.jsx)(ei, {
                                    ...eb,
                                    size: g._3J.SIZE_32,
                                    src: eM,
                                    avatarDecoration: eI,
                            ...
                            subText: t.isSystemDM() ? (0, l.jsx)("div", {
                                className: ea.W$,
                                children: (0, I.A)(t.id) ? es.intl.string(es.t.FL5T01) : es.intl.string(es.t.NnY5lc)
                        ...
                        children: [eF ? (0, l.jsx)(ec, {}) : null, eV ? (0, l.jsx)(ed, {}) : null, te && null != ez ? (0, l.jsx)(eu, {
                            channelName: ez,
                            onClick: tt,
                            showNameplate: eW
                        }) : null, tn || !te ? (0, l.jsx)(eo, {
                            icon: g.PGe,
...
let ep = 21552 == n.j ? e => {
    let {
        ...
        selected: n,
        ...s
    } = e, a = (0, E.bG)([ee.default], () => ee.default.getUser(t.getRecipientId())), i = a?.id, r = (0, E.cf)([$.A, K.A], () => {
        let e;
        if (t.isMultiUserDM()) {
        ...
        user: a
    }), c = (0, E.bG)([ee.default, X.A], () => t.isMultiUserDM() ? et.default.keys(X.A.getTypingUsers(t.id)).some(e => e !== ee.default.getCurrentUser()?.id) : null != a && X.A.isTyping(t.id, t.getRecipientId()), [t, a]);
