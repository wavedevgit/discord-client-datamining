...
function eA(e) {
    let {
        ...
        "aria-posinset": et,
        "aria-setsize": en
    } = e, [em, eA] = s.useState(!1), [ep, ef] = s.useState(!1), [ex, eh] = s.useState(!1), eE = s.useRef(null), [eN, eg] = s.useState(!1), eS = (0, m.K)(s.useCallback(e => {
        eg(e)
        ...
        maskImage: "none"
    }), ew = s.useRef(null), eU = t.isMultiUserDM(), eD = t.isSystemDM(), eO = !eU && !eD && t.type === el.rbe.DM, eG = eO && r?.primaryGuild != null, eQ = (0, h.bG)([X.Ay], () => X.Ay.isChannelMuted(t.getGuildId(), t.id)), {
        ignored: ek,
        blocked: eP
    } = (0, h.cf)([J.A], () => ({
        ignored: J.A.isIgnored(t.getRecipientId()),
        blocked: J.A.isBlocked(t.getRecipientId())
    })), eF = eO && ek, eV = eO && eP, eq = (eQ || eF || eV) && !(a || em), eB = (0, h.bG)([$.Ay], () => $.Ay.getMentionCount(t.id) > 0), ez = (0, w.Ay)(t), eH = s.useRef(null), eW = null != Z && (a || em || ex), eK = () => {
        eA(!0)
    }, eY = () => {
        eA(!1)
    }, e$ = () => {
        ...
        eh(!0), t.isMultiUserDM() ? (0, v.L3)(e, async () => {
            let {
                default: e
