    ...
    ec = e => {
        ...
        return i ? (0, l.jsx)("div", {
            ...
            children: (0, l.jsx)(p.m_, {
                text: ei.intl.formatToPlainString(ei.t.m0zYbV, {
                    username: n
                }),
...
function em(e) {
    let {
        ...
        hoverGradientEnd: o
    } = e, u = s.useMemo(() => null != a && null != r && null != o ? {
...
function e_(e) {
    let {
        ...
        "aria-posinset": et,
        "aria-setsize": en
    } = e, [el, em] = s.useState(!1), [eE, e_] = s.useState(!1), [eN, ef] = s.useState(!1), eT = s.useRef(null), [ep, eh] = s.useState(!1), eS = (0, A.K)(s.useCallback(e => {
        eh(e)
    }, [])), eC = s.useRef(null), ex = Z ?? eC, eg = (0, m.A)(ex, eS), {
        ...
        userId: r?.id,
        size: h._3J.SIZE_32,
        animateOnHover: !(i || el || eE || eN)
    }), [eb, ey] = s.useState({
        maskImage: "none"
    }), eL = s.useRef(null), eU = t.isMultiUserDM(), eD = t.isSystemDM(), eO = !eU && !eD && t.type === es.rbe.DM, eG = eO && r?.primaryGuild != null, ew = (0, f.bG)([ee.Ay], () => ee.Ay.isChannelMuted(t.getGuildId(), t.id)), {
        ignored: eQ,
        blocked: eP
    } = (0, f.cf)([X.A], () => ({
        ignored: X.A.isIgnored(t.getRecipientId()),
        blocked: X.A.isBlocked(t.getRecipientId())
    })), eF = eO && eQ, eV = eO && eP, ek = (ew || eF || eV) && !(i || el), eB = (0, f.bG)([J.Ay], () => J.Ay.getMentionCount(t.id) > 0), eq = (0, D.Ay)(t), eH = s.useRef(null), ez = null != $ && (i || el || eN), eW = () => {
        em(!0)
    }, eK = () => {
        em(!1)
    }, eY = () => {
        ...
        ef(!0), t.isMultiUserDM() ? (0, C.L3)(e, async () => {
            let {
                default: e
        ...
        let s = ei.intl.formatToPlainString(ei.t.hJ5Ap4, {
                name: eq
            }),
            i = ei.intl.format(ei.t.SSIVOu, {
                name: eq
            });
        t.isManaged() && (s = ei.intl.formatToPlainString(ei.t.hVGjEW, {
            name: eq
        }), i = ei.intl.format(ei.t.IK1Qvs, {
            name: eq
        })), (0, h.mMO)(async () => {
            let {
                default: e
        ...
        loop: el,
        boldFontOpacity: .9
    }), e9 = eG ? (0, l.jsxs)(l.Fragment, {
        children: [e3, (0, l.jsx)(W.Ay, {
    ...
    }) : e3, e6 = s.useRef(null), e8 = (0, V.W)({
        location: "PrivateChannel"
    }) && r?.displayNameStyles != null, e7 = [(0, L.Ay)({
        channel: t,
        unread: eB
    }), (0, L.r2)({
        channel: t,
        muted: ew,
        userStatus: G
    })].filter(Boolean).join(", "), e4 = (0, f.bG)([J.Ay], () => J.Ay.lastMessageId(t.id)), {
        waveShouldShow: e5,
        wavePressed: te
    } = (0, O.A)(t, e4), {
        showClose: tt
    ...
    return s.useLayoutEffect(tn, [el, tn]), (0, E.g)(ex, tn), (0, l.jsx)(d.tG, {
        id: t.id,
        children: e => {
            let {
                role: n,
                    ...
                    children: [(0, l.jsx)(P.A, {
                        ...
                        children: (0, l.jsx)(j.A, {
                            ...
                            avatar: (() => {
                                let e = h._3J.SIZE_32;
                                if (t.isMultiUserDM())
                                    if (t.recipients.length >= 2 && null == t.icon) return (0, l.jsx)(z.A, {
                                        "aria-hidden": !0,
                                ...
                                let n = null;
                                return r.isSystemUser() || (n = (0, g.A)(N) ? es.clD.STREAMING : G), (0, l.jsx)(er, {
                                    ...ej,
                                    size: h._3J.SIZE_32,
                                    src: eR,
                                    avatarDecoration: eM,
                            ...
                            subText: t.isSystemDM() ? (0, l.jsx)("div", {
                                className: ea.W$,
                                children: (0, b.A)(t.id) ? ei.intl.string(ei.t.FL5T01) : ei.intl.string(ei.t.NnY5lc)
                        ...
                        children: [eF ? (0, l.jsx)(ed, {}) : null, eV ? (0, l.jsx)(eA, {}) : null, e5 && null != eq ? (0, l.jsx)(ec, {
                            channelName: eq,
                            onClick: te,
                            showNameplate: ez
                        }) : null, tt || !e5 ? (0, l.jsx)(eu, {
                            icon: h.PGe,
                            "aria-label": eU ? ei.intl.string(ei.t["26C4oi"]) : ei.intl.string(ei.t.jsvgc3),
                            onClick: eU ? e2 : eJ,
                            onMouseDown: eZ,
                            nameplate: $,
...
let eN = 21552 == n.j ? e => {
    let {
        ...
        selected: n,
        ...s
    } = e, i = (0, f.bG)([et.default], () => et.default.getUser(t.getRecipientId())), a = i?.id, r = (0, f.cf)([$.A, Y.A], () => {
        let e;
        if (t.isMultiUserDM()) {
        ...
        user: i
    }), c = (0, f.bG)([et.default, Z.A], () => t.isMultiUserDM() ? en.default.keys(Z.A.getTypingUsers(t.id)).some(e => e !== et.default.getCurrentUser()?.id) : null != i && Z.A.isTyping(t.id, t.getRecipientId()), [t, i]);
    return t.isMultiUserDM() ? (0, l.jsx)(e_, {
        channel: t,
        selected: n,
        isTyping: c,
