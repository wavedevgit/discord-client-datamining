...
var l = n(627968),
    ...
    es = n(985018),
    ei = n(107852);
let ea = en.Ay.getEnableHardwareAcceleration() ? T.JsQ : T.euF,
    er = {
        offset: {
            top: 2,
            bottom: 2,
    ...
    em = e => {
        ...
        return (0, l.jsx)(P.A, {
            ...
            "aria-setsize": S,
            ref: h,
            children: (0, l.jsx)(T.HG8, {
                as: "div",
                selected: n,
                className: a()(r, ei.bG, ei.$J, {
                    [ei.Q2]: n
                }),
...
function eA(e) {
    let {
        ...
        "aria-posinset": et,
        "aria-setsize": en
    } = e, [em, eA] = s.useState(!1), [eE, ep] = s.useState(!1), [ef, eS] = s.useState(!1), eh = s.useRef(null), [ex, eT] = s.useState(!1), e_ = (0, m.K)(s.useCallback(e => {
        eT(e)
        ...
        let s = es.intl.formatToPlainString(es.t.hJ5Ap4, {
            ...
            i = es.intl.format(es.t.SSIVOu, {
                name: eB
            });
        t.isManaged() && (s = es.intl.formatToPlainString(es.t.hVGjEW, {
            name: eB
        }), i = es.intl.format(es.t.IK1Qvs, {
            name: eB
        })), (0, T.mMO)(async () => {
            let {
                default: e
    ...
    return s.useLayoutEffect(tn, [em, tn]), (0, E.g)(eg, tn), (0, l.jsx)(d.tG, {
        id: t.id,
        children: e => {
            let {
                role: n,
                    ...
                    children: [(0, l.jsx)(Q.A, {
                        ...
                        children: (0, l.jsx)(b.A, {
                            ...
                            subText: t.isSystemDM() ? (0, l.jsx)("div", {
                                className: ei.W$,
                                children: (0, j.A)(t.id) ? es.intl.string(es.t.FL5T01) : es.intl.string(es.t.NnY5lc)
