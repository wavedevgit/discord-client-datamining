/** chunk id: 35052, original params: e,n,t (module,exports,require) **/
t.d(n, {
    default: () => v
});
var r = t(627968);
...
let C = [{
    key: null,
    renderStep: e => (0, r.jsx)(_.B, {
        ...e
    })
}, {
    key: u.pn.ADD_PAYMENT_STEPS,
    renderStep: e => (0, r.jsx)(d.x, {
        ...e,
        onReturn: () => {
            0 === Object.keys(P.A.paymentSources).length ? e.handleClose() : e.handleStepChange(u.pn.REVIEW, {
