/** Chunk was on web.js **/
/** chunk id: 910463, original params: e,t,n (module,exports,require) **/
"use strict";
n.d(t, {
    X: () => c
}), n(228524), n(457529);
...
function c(e) {
    ...
    let g = (null == _ ? void 0 : _.banner) !== null && (null == _ ? void 0 : _.banner) !== void 0 && null != (t = s.Ay.getGuildBannerURL({
        id: _.id,
        banner: _.banner
    }, !0)) ? t : null;
    return null !== g && (m.selected_guild_banner_url = g), m.guilds.length > 100 && (m.guilds = m.guilds.slice(0, 100), m.truncated = !0), m.channels.length > 100 && (m.channels = m.channels.slice(0, 100), m.truncated = !0), {
