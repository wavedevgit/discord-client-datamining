/** chunk id: 52933 params = (module,exports,require) **/
s.d(t, {
    Ay: () => f,
    BA: () => A
});
...
function A(e) {
    let {
        channel: t,
        isNew: s
    } = e, n = (0, c.kt)(t), l = n.slice(void 0, 3), a = n.slice(3), i = n.length > 3 ? n.length - 3 : 0, r = t.hasFlag(h.lx.PINNED), o = l.length > 0 || r || s;
    return {
        shownTags: l,
        remainingTags: a,
        moreTagsCount: i,
