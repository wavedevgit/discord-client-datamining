/** chunk id: 113266 params = (module,exports,require) **/
"use strict";
n.d(t, {
    A: () => F
});
...
function V(e) {
    let {
        ...
        availableSounds: n,
        guildId: s
    } = e, l = v.A.getGuild(s), r = null != l ? (0, O.fA)(l) : 0;
    return 0 === t ? (0, i.jsx)(i.Fragment, {
        children: P.intl.format(P.t["7E9Hdz"], {
            slots: n,
            totalSlots: r
        })
    }) : (0, i.jsxs)(i.Fragment, {
        children: [(0, i.jsx)(m.m, {
            text: P.intl.formatToPlainString(P.t.tuuJJT, {
                currentBoostLevel: t
            }),
...
let z = e => {
        let {
            ...
            popoutTargetRef: l,
            ...r
        } = e, [a, o] = s.useState(!1), d = s.useMemo(() => new c.Ep, []), u = s.useCallback(() => {
            d.stop(), o(!0)
        }, [d]), m = s.useCallback(() => {
            d.start(200, () => o(!1))
        }, [d]), x = {
    ...
    W = () => {
        let e = s.useRef(null);
        return (0, i.jsx)(z, {
            renderPopoutBody: () => (0, i.jsx)(g.Text, {
                variant: "text-sm/normal",
                color: "text-default",
                children: P.intl.format(P.t.bGXPVt, {})
            }),
            renderPopoutChildren: (t, n) => (0, i.jsx)("div", {
                ref: e,
                ...n,
...
function K(e) {
    ...
    } = (0, j.nr)(t), o = s.useRef(null), c = (0, _.Ay)(), u = t.premiumTier, m = (0, O.tO)(t, l, u);
    s.useEffect(() => {
        (0, N.E7)()
    }, []);
    ...
    let p = B ? (0, i.jsx)(g.Button, {
        ...
        onClick: function() {
            (0, g.mMO)(async () => {
                let {
                    default: e
                } = await Promise.all([n.e("40556"), n.e("96017")]).then(n.bind(n, 6503));
                return n => (0, i.jsx)(e, {
                    ...n,
                    guildId: t.id
                })
        ...
        children: [(0, i.jsxs)("div", {
            ...
            children: [(0, i.jsx)(g.cGx, {
                ...
                children: [(0, i.jsxs)("div", {
                    className: w.ZF,
                    children: [(0, i.jsx)(H, {
                        children: P.intl.string(P.t.sMOuuS)
                    }), (0, i.jsx)(H, {
                        children: P.intl.string(P.t.lLFvlT)
                    }), (0, i.jsx)(H, {
...
function Y(e) {
    ...
    } = (0, p.Ay)(), T = (0, d.bG)([S.default], () => _ ?? S.default.getUser(A), [A, _]), {
            ...
            children: [(0, i.jsx)(g.DUT, {
                ...
                onClick: function(e) {
                    e.stopPropagation(), (0, u.A)({
                        title: P.intl.formatToPlainString(P.t["PR/VbI"], {
                            soundName: m
                        }),
                        subtitle: P.intl.format(P.t["u6+CmN"], {
                            soundName: m
                        }),
