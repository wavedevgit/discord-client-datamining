...
function f(e) {
    let {
        ...
        guildId: f,
        onClose: x
    } = e, h = (0, a.bG)([d.A], () => d.A.getUserProfile(n.id)?.application), v = (0, a.bG)([r.A, s.A], () => r.A.getChannel(s.A.getChannelId()));
    return (0, i.jsxs)(l.IpV, {
        ...
        children: [(0, i.jsx)(c.E, {
            userBio: t?.bio,
            setLineClamp: !1
        }), h?.popularApplicationCommandIds != null && null != v && (0, i.jsx)(o.A, {
            applicationId: h.id,
