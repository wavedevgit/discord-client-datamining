...
function U(e) {
    let {
        section: t,
        showSpamCta: n
    } = e, a = r.useMemo(() => n ? w : t !== L.m3P.PENDING ? j : void 0, [n, t]);
    return (0, i.jsx)("div", {
        className: D.y7,
...
let G = function(e) {
    ...
    let en = r.useMemo(() => d === L.m3P.ALL && K && J.some(e => e.giftIntentType === R.np.FRIEND_ANNIVERSARY) ? J.filter(e => e.giftIntentType === R.np.FRIEND_ANNIVERSARY).length : 0, [J, d, K]),
            ...
            switch (d) {
                ...
                case L.m3P.ALL:
                    if (!(K && J.some(e => e.giftIntentType === R.np.FRIEND_ANNIVERSARY))) return [J];
                    {
                        ...
                        }), e.sort((e, t) => E.A.compareByDmProbability(e.userId, t.userId)), [q ? e : e.slice(0, g.ZD), J]
                    }
                default:
                    return [J]
            }
        ...
        ed = r.useCallback(e => d === L.m3P.ALL && 0 === e && K && en > g.ZD ? (0, i.jsx)("div", {
            className: D.Nf,
