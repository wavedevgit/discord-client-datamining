/** chunk id: 265990 params = (module,exports,require) **/
n.d(t, {
    A: () => G
}), n(321073);
var i = n(627968),
...
function M() {
    d.A.transitionToSection(L.m3P.ADD_FRIEND, {
        explicit: !0
    })
}
...
function U(e) {
    let {
        section: t,
        showSpamCta: n
    } = e, a = r.useMemo(() => n ? w : t !== L.m3P.PENDING ? M : void 0, [n, t]);
    return (0, i.jsx)("div", {
        className: D.y7,
...
let G = function(e) {
    ...
    let [Y, W] = r.useState(() => {
        ...
        return e
    }), K = (0, m.p)(A.A.FRIENDS_LIST), [q, z] = r.useState(!1), $ = r.useCallback((e, t) => {
        let {
            key: r,
            ...a
        } = e;
    ...
    }, [Y, d]), Z = r.useMemo(() => d === L.m3P.PENDING && (a.filter(L.m3P.SPAM).length > 0 || a.filter(L.m3P.PENDING_IGNORED).length > 0), [a, d]), J = r.useMemo(() => {
        let e = a.filter(d, Y[d]);
        return V && d === L.m3P.PENDING && "" === Y[d] && (e = l()([...e, ...B]).uniqBy("key").sortBy(e => e.nickname?.toLowerCase() ?? e.user?.globalName?.toLowerCase() ?? e.usernameLower).value()), e
    }, [B, V, a, Y, d]), ee = d === L.m3P.PENDING, et = r.useMemo(() => {
        if (!ee) return j;
        let e = [];
        return J.forEach(t => {
            let {
    ...
    (0, _.A)(et, ee);
    let en = r.useMemo(() => d === L.m3P.ALL && K && J.some(e => e.giftIntentType === R.np.FRIEND_ANNIVERSARY) ? J.filter(e => e.giftIntentType === R.np.FRIEND_ANNIVERSARY).length : 0, [J, d, K]),
        ei = r.useMemo(() => {
            switch (d) {
                case L.m3P.PENDING:
                    let e = [],
                        t = [];
                    return J.forEach(n => {
                        n.type === L.eA$.PENDING_INCOMING ? e.push(n) : n.type === L.eA$.PENDING_OUTGOING && t.push(n)
                    }), [e, t];
                case L.m3P.ALL:
                    if (!(K && J.some(e => e.giftIntentType === R.np.FRIEND_ANNIVERSARY))) return [J];
                    {
                        ...
                        }), e.sort((e, t) => E.A.compareByDmProbability(e.userId, t.userId)), [q ? e : e.slice(0, p.ZD), J]
                    }
                default:
                    return [J]
            }
            ...
            let n = ei[e],
                r = function(e, t, n, i) {
                    switch (e) {
                        ...
                        case L.m3P.PENDING:
                            if (0 === n) return P.intl.formatToPlainString(P.t["g+3FIa"], {
                                count: t.toString()
                            });
                            if (1 === n) return P.intl.formatToPlainString(P.t.npJsRl, {
                                count: t.toString()
                            });
                            throw Error(`Unexpected pending friend requests section index: ${n}`);
                        case L.m3P.SUGGESTIONS:
                            return P.intl.formatToPlainString(P.t["DYMZ/p"], {
                                count: t.toString()
                            });
                        default:
                            if ((0, m.p)(A.A.FRIENDS_LIST) && i)
                                if (0 === n) return P.intl.formatToPlainString(P.t.rrZTqK, {
                                    count: t.toString()
                                });
                                else if (1 === n);
                            else throw Error(`Unexpected friends all section index: ${n}`);
                            return P.intl.formatToPlainString(P.t.rHRrhC, {
                                count: t.toString()
                            })
                    }
        ...
        ed = r.useCallback(e => d === L.m3P.ALL && 0 === e && K && en > p.ZD ? (0, i.jsx)("div", {
            className: D.Nf,
