...
let C = {
    ...
    T = e => {
        let {
            guild: t
        } = e, n = (0, o.bG)([x.A], () => x.A.can(f.xBc.MANAGE_GUILD, t));
...
function N(e) {
    ...
    return (i.useEffect(() => {
        s && x(!1)
    }, [s, x]), s) ? null : h((e, t) => t ? (0, l.jsxs)(r.animated.div, {
        style: e,
        onClick: () => m(!u),
        ...
        }), g((e, t) => t ? (0, l.jsxs)(r.animated.div, {
            style: e,
            children: [(0, l.jsx)("hr", {
                className: j.me
            }), (0, l.jsx)(T, {
