...
function N(e) {
    ...
    } = (0, o.Ay)(), y = null != l, C = (0, A.Ay)(n, l), b = (0, s.bG)([x.A], () => x.A.getPendingChanges(l ?? void 0).pendingBanner), E = (0, s.bG)([m.default], () => m.default.getCurrentUser()?.banner != null), T = null === b, P = void 0 !== b, _ = y && (C?.isUsingGuildMemberBanner() ?? !1), R = T && y ? E : (0, c.Ac)(b, C?.banner), O = y ? _ : C?.banner != null, S = P ? null != b : O, L = C?.getPreviewBanner(b, !1, 296) ?? void 0, k = (0, r.rdh)(a.A.unsafe_rawColors.PRIMARY_800).hex(), D = C?.primaryColor ?? (0, t.LX)(k), {
        hex: U
    } = (0, d.A)(D), G = () => (0, u.XD)({
