/** chunk id: 628759 params = (module,exports,require) **/
function o(r, e) {
...
function l(r, e, t, o) {
    var a, n, i, s, l, p, d, v;
    return "text" === e ? (n = t, a = o.escapeXML ? c.encodeXML(n) : n) : "display" === e ? (i = r, s = t, l = o, s = parseInt(s, 10), (d = {
        "-1": function() {
            return "<br/>"
        },
        0: function() {
    ...
    })[s] ? p = d[s]() : 4 < s && s < 7 ? p = f(i, "blink") : 29 < s && s < 38 ? p = b(i, l.colors[s - 30]) : 39 < s && s < 48 ? p = m(i, l.colors[s - 40]) : 89 < s && s < 98 ? p = b(i, l.colors[8 + (s - 90)]) : 99 < s && s < 108 && (p = m(i, l.colors[8 + (s - 100)])), a = p) : "xterm256Foreground" === e ? a = b(r, o.colors[t]) : "xterm256Background" === e ? a = m(r, o.colors[t]) : "rgb" === e && (a = g(r, (38 == +(v = (v = t).substring(2).slice(0, -1)).substr(0, 2) ? "color:#" : "background-color:#") + v.substring(5).split(";").map(function(r) {
...
function u(r) {
    var e = r.slice(0);
    return r.length = 0, e.reverse().map(function(r) {
        return "</" + r + ">"
    }).join("")
}
...
function d(r) {
    r = parseInt(r, 10);
    var e = null;
    return 0 === r ? e = "all" : 1 === r ? e = "bold" : 2 < r && r < 5 ? e = "underline" : 4 < r && r < 7 ? e = "blink" : 8 === r ? e = "hide" : 9 === r ? e = "strike" : 29 < r && r < 38 || 39 === r || 89 < r && r < 98 ? e = "foreground-color" : (39 < r && r < 48 || 49 === r || 99 < r && r < 108) && (e = "background-color"), e
}
...
r.exports = function() {
    ...
    function e(r) {
        ...
        (r = r || {}).colors && (r.colors = Object.assign({}, i.colors, r.colors)), this.options = Object.assign({}, i, r), this.stack = [], this.stickyStack = []
    }
    return r = [{
            key: "toHtml",
            value: function(r) {
                ...
                var t = this.stack,
                    a = this.options,
                    n = [];
                return this.stickyStack.forEach(function(r) {
                    ...
                    r: for (; l > 0;) {
                        for (var u, p = 0, d = 0, f = i.length; d < f; p = ++d)
                            if (u = i[p], p > 3 && a || (a = !1, r = r.replace(u.pattern, u.sub)), r.length !== l) {
                                l = r.length;
                                continue r
                            } if (r.length === l) break;
                        s.push(0), l = r.length
                    ...
                    var c = l(t, r, o, a);
                    c && n.push(c), a.stream && (e.stickyStack = function(r, e, t) {
                        if ("text" !== e) {
                            var o;
                            (r = r.filter((o = d(t), function(r) {
