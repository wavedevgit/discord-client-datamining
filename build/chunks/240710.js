...
function j(e) {
    let {
        ...
        onLoadComplete: j
    } = e, y = (0, o.Ay)(), E = (0, s.Mwr)(y) ? A.NJ.DARK : A.NJ.LIGHT, D = (0, g.wr)(t), I = (0, m.go)(), k = (0, f.E0)(t.config), L = a.useMemo(() => {
        let e = t.config.ctaConfig?.subtitle;
        return null != e ? e : (0, f.pv)(t.config) !== r.Z.GAMEPLAY || t.config.features.includes(h.Li.NON_GAMING_PLAY_QUEST) || (0, f.ui)(t) ? N.intl.string(N.t.y8Xf3k) : N.intl.string(N.t["wirwN+"])
    }, [t]), {
        isLoading: S
    } = (0, v.Gk)();
    a.useEffect(() => {
