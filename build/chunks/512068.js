/** chunk id: 512068, original params: e,t,l (module,exports,require) **/
l.d(t, {
    A: () => H
});
var n = l(627968),
...
let H = e => {
    let {
        ...
        transitionState: l,
        onClose: a
    } = e, [H, p] = i.useState(7), [f, j] = i.useState([]), b = (0, h._k)(t.id, H, f) ?? -1;
    i.useEffect(() => {
        let e = e => {
    ...
    let v = i.useCallback(() => {
        ...
        A = (0, r.yK)([x.A, m.A], () => {
            ...
            return s()(m.A.getSortedRoles(t.id)).filter(l => !(0, u.Oy)(l) && x.A.isRoleHigher(t, e, l)).map(e => {
                let {
                    id: t,
                    name: l
                } = e;
