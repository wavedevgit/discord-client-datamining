/** chunk id: 839256, original params: e,a,t (module,exports,require) **/
t.d(a, {
    V: () => A
});
var r = t(974111),
...
function A(e, a, t) {
    ...
    let {
    ...
    }), M = (0, p.useMemo)(() => new(0, D.d)(R, {
        maximumFractionDigits: 0
    }), [R]), I = () => {
        if (e.text === e.placeholder && x.focusPrevious(), !M.isValidPartialNumber(e.text) || a.isReadOnly || e.isPlaceholder) "dayPeriod" === e.type && a.clearSegment(e.type);
        else {
            let t = e.text.slice(0, -1),
                r = M.parse(t);
            0 === (t = 0 === r ? "" : t).length || 0 === r ? a.clearSegment(e.type) : a.setSegment(e.type, r), A.current = t
        }
    }, {
        startsWith: T
    } = (0, f.U)({
        ...
        let t = (0, i.yP)(new(0, l.ng)(1, 1, 1), a.calendar),
            r = a.calendar.getEras().map(e => {
                ...
                return {
                    era: e,
                    formatted: z.formatToParts(a).find(e => "era" === e.type).value
                }
            }),
            n = function(e) {
                e.sort();
        ...
        if (n)
            for (let e of r) e.formatted = e.formatted.slice(n);
        return r
    }, [z, a.calendar, e.type]), j = t => {
        ...
        switch (e.type) {
            ...
            case "year": {
                ...
                if (isNaN(n)) return;
                let o = 0 !== i || l;
                o && a.setSegment(e.type, i), void 0 !== e.maxValue && (Number(n + "0") > e.maxValue || r.length >= String(e.maxValue).length) ? (A.current = "", o && x.focusNext()) : A.current = r
            }
        }
    ...
    (0, d._)(K, "selectionchange", () => {
        ...
        (null == a ? void 0 : a.anchorNode) && (null == (e = t.current) ? void 0 : e.contains(null == a ? void 0 : a.anchorNode)) && a.collapse(t.current)
    });
    let L = (0, p.useRef)("");
    (0, d._)(t, "beforeinput", r => {
        if (t.current) switch (r.preventDefault(), r.inputType) {
        ...
        "insertCompositionText" === a && (t.current && (t.current.textContent = L.current), null != r && (T(N, r) || T(Z, r)) && j(r))
    }), (0, c.N)(() => {
        let e = t.current;
        return () => {
    ...
    let J = (0, o.un)() || "timeZoneName" === e.type ? {
        role: "textbox",
        "aria-valuemax": null,
        "aria-valuemin": null,
        "aria-valuetext": null,
    ...
    return {
        segmentProps: (0, y.v)(B, H, {
            ...
            onKeyDown: e => {
                if ("a" === e.key && ((0, o.cX)() ? e.metaKey : e.ctrlKey) && e.preventDefault(), !e.ctrlKey && !e.metaKey && !e.shiftKey && !e.altKey) switch (e.key) {
                    case "Backspace":
                    case "Delete":
            ...
            onFocus: () => {
                A.current = "", t.current && (0, u.o)(t.current, {
                    containingElement: (0, s.m)(t.current)
                });
