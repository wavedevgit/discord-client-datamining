...
function f(e) {
    let {
        ...
        className: o,
        iconClassName: f
    } = e, [p, x] = (0, r.yK)([c.A], () => [c.A.desaturateUserColors, c.A.saturation]), v = (0, u.rdh)(g).hex(), C = t ?? v, N = (0, a.$k)((0, a.LX)(C), !1, p ? x : null), E = (0, u.rdh)(h).hex(), I = (0, u.rdh)(A).hex(), _ = null != i ? i : (0, d.j)({
        backgroundColor: C,
        colors: [E, I]
    }), b = n / 8;
    return (0, l.jsx)("div", {
