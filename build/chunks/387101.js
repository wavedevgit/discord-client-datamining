/** chunk id: 387101 params = (module,exports,require) **/
a.d(e, {
    default: () => b
});
var n = a(627968),
...
function b(t) {
    let {
        ...
        clientSettingType: b,
        gameId: v
    } = t, [k, f] = i.useState("unreported"), [w, C] = i.useState(""), [A, S] = i.useState(!1), [j, M] = i.useState(!1), [H, N] = i.useState(!1), [P, R] = i.useState(!1), z = (0, s.bG)([m.A, u.Ay], () => {
        ...
        S(!0), await _.default.track(g.HAw.OVERLAY_DISABLED_SURVEY, {
            reason: k,
            comment: w,
        ...
        }), await (0, l.yy)(1e3), S(!1), M(!0), await (0, l.yy)(1500), e()
