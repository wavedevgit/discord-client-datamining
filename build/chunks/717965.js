...
function eu(e) {
    ...
    } = (0, A.Ay)(), l = (0, ei.A)(t.id), [o, h] = (0, er.A)(t), m = (0, en.L)(t), _ = (0, es.Vv)(), p = (0, es.tp)(), g = s.useRef(null), [x, E] = (0, c.V)("age-verification-stage-popover-dismissed", !1), C = s.useContext(D.vG);
    if (l) return null;
    let I = p && !x;
...
function em(e) {
    let {
        ...
        suppress: m
    } = (0, R.A)(t), _ = V.default.getId(), [p] = (0, er.A)(t), g = X.Ay.isModerator(_, t.id), E = (0, z.Ni)(t.id), C = c(u), {
        parentAnalyticsLocation: N
    ...
    return (g || C) && null != d ? (0, i.jsx)(a.YNO, {
        targetElementRef: b,
        renderPopout: e => {
            let {
                closePopout: s
            ...
            children: [(0, i.jsx)(a.YNO, {
                ...
                children: (e, t) => {
                    ...
                    return (0, i.jsx)(w.A, {
                        ...
                        suppress: r,
                        popoutOpen: s,
                        onClick: () => (0, g.A)(c, r, "Stage Channel Controls"),
                        awaitingRemote: u
                    })
                }
            }), V && X]
