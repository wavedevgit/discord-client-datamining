...
function eu(e) {
    ...
    } = (0, A.Ay)(), l = (0, ei.A)(t.id), [o, h] = (0, er.A)(t), p = (0, en.L)(t), g = (0, es.Vv)(), m = (0, es.tp)(), _ = s.useRef(null), [x, C] = (0, c.V)("age-verification-stage-popover-dismissed", !1), E = s.useContext(D.vG);
    if (l) return null;
    let I = m && !x;
    return (0, i.jsxs)(i.Fragment, {
        children: [(0, i.jsx)(U.l, {
            ...
            onClick: () => {
                (0, f.X)(n, f.O.REQUEST_TO_SPEAK, !o), C(!0), g ? d.A.showAgeVerificationGetStartedModal({
...
function ep(e) {
    let {
        ...
        suppress: p
    } = (0, R.A)(t), g = B.default.getId(), [m] = (0, er.A)(t), _ = q.Ay.isModerator(g, t.id), C = (0, z.Ni)(t.id), E = c(u), {
        parentAnalyticsLocation: N
...
let ex = s.memo(function(e) {
    ...
    } = e, s = (0, ei.A)(t.id), r = (0, z.Ni)(t.id), a = (0, l.bG)([H.A], () => H.A.can(X.QY, t), [t]), o = (0, es.zU)(), c = (0, el.A)(t.id), d = (0, l.bG)([p.A], () => null != t ? p.A.getSelectedParticipant(t.id) : null), u = !c && null == d;
    return n ? (0, i.jsx)(ef, {
        channel: t
    }) : s || r ? (0, i.jsxs)("div", {
        className: ec.My,
