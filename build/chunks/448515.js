...
q(["INITIAL_GUILD"], e => "full" === e.data_mode ? null : A.D.loadGuildIds([e.id]), e => {
    ...
    e.user.bot ? Q({
        ...
        a.Ay.Emitter.batched(() => {
            ...
            let s = null == e.user_settings_proto ? void 0 : (0, y.Gd)(e.user_settings_proto);
