...
function g(t) {
    return C.get(t) ?? A.ACTIVITY_STATUS_OFF
}
...
function E(t, e) {
    ...
    let r = i < n ? "restricting" : "expanding",
        ...
        u = t === A.ACTIVITY_STATUS_OFF && e === A.ACTIVITY_STATUS_ON_FOR_LARGE_GUILDS || t === A.ACTIVITY_STATUS_ON_FOR_LARGE_GUILDS && e === A.ACTIVITY_STATUS_OFF ? "large_only" : t === A.ACTIVITY_STATUS_ON && e === A.ACTIVITY_STATUS_ON_FOR_LARGE_GUILDS || t === A.ACTIVITY_STATUS_ON_FOR_LARGE_GUILDS && e === A.ACTIVITY_STATUS_ON ? "small_only" : "all",
        h = s.filter(t => {
...
function O(t, e) {
    let n = g(e),
        i = l._Z.getSetting();
    if (i === n || _(g(t)) > _(n) != _(i) > _(n)) return null;
    let s = E(i, n);
