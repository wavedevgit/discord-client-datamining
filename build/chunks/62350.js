...
function U(e) {
    ...
    let x = r.useCallback(() => {
        ...
        C = (0, I.A)([A.id])[0],
        E = (0, d.bG)([m.Ay], () => l?.channel != null && m.Ay.getSelfEmbeddedActivityForChannel(l.channel.id)?.applicationId === A.id),
    ...
    let V = H && !w || H && E;
    return (w || (n = D.intl.string(D.t.hHGrWz)), null == l.code || "" === l.code || null == C) ? null : (0, i.jsx)(p.f5, {
        value: O,
        children: (0, i.jsx)(G, {
            app: C,
            activityUsers: U,
