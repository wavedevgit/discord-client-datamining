...
function B(e) {
    ...
    t = V ? E ? D.intl.string(D.t.DPfdsq) : j ? D.intl.string(D.t.sqe0hj) : D.intl.string(D.t.RscU7I) : D.intl.string(D.t["2BP08E"]);
    let q = V && !k || V && E;
    return (k || (n = D.intl.string(D.t.hHGrWz)), null == r.code || "" === r.code || null == C) ? null : (0, i.jsx)(p.f5, {
        value: O,
        children: (0, i.jsx)(G, {
            app: C,
            activityUsers: B,
