...
let C = r.A.Types,
    N = function(e) {
        let {
            ...
            ...N
        } = e, T = (0, s.bG)([g.A, _.A], () => _.A.getChannel(g.A.getVoiceStateForUser(n.id)?.channelId)), S = (0, u.v)("UserActivityContainer", T), b = (0, s.bG)([A.A], () => o ? A.A.getAnyStreamForUser(n.id) : null), v = t?.type === x.$pd.HANG_STATUS && S ? T : null, y = (0, s.bG)([m.A, g.A, _.A], () => (0, a.A)(t, x.jUm.EMBEDDED) ? m.A.getGuild(_.A.getChannel(g.A.getVoiceStateForSession(n.id, t?.session_id)?.channelId)?.getGuildId()) : null != v ? m.A.getGuild(v.getGuildId()) : null), j = (0, s.bG)([m.A], () => null != b ? m.A.getGuild(b.guildId) : null), R = (0, s.bG)([d.A], () => {
            if (null != t)
        ...
        }, [t?.type, S, v, n.id]), t?.type !== x.$pd.HANG_STATUS || S) ? (0, i.jsx)(r.A, {
            ...N,
            activity: t,
            user: n,
            application: R,
