...
function o(e) {
    return {
        [s.AH.BLOCK_MESSAGE]: (e, t) => new Promise(e => {
            (0, l.mMO)(async () => {
                let {
                    default: r
        ...
        [s.AH.FLAG_TO_CHANNEL]: (t, r) => new Promise(a => {
            (0, l.mMO)(async () => {
                let {
                    default: l
                } = await n.e("65341").then(n.bind(n, 158956)), o = t.actions.find(e => e.type === s.AH.FLAG_TO_CHANNEL);
                return n => (0, i.jsx)(l, {
                    action: r,
                    isEdit: null != o,
        ...
        [s.AH.USER_COMMUNICATION_DISABLED]: (e, t) => new Promise(r => {
            (0, l.mMO)(async () => {
                let {
                    default: l
                } = await n.e("21932").then(n.bind(n, 16039)), a = e.actions.find(e => e.type === s.AH.USER_COMMUNICATION_DISABLED);
                return n => (0, i.jsx)(l, {
                    action: t,
                    isEdit: null != a,
