...
function f(e, t) {
    u.A.isFavorite(e) || o.wc.updateAsync("favorites", n => {
        ...
        n.favoriteChannels[e] = a.wL.create({
            ...
            position: I(),
            parentId: t ?? A.O8
        }), h(n.favoriteChannels), C(n.favoriteChannels, e)
...
function L(e) {
    o.wc.updateAsync("favorites", t => {
        for (let n of e) {
            let e = n.id;
            null != n.position && (t.favoriteChannels[e].position = n.position), void 0 !== n.parent_id && (t.favoriteChannels[e].parentId = n.parent_id ?? A.O8, C(t.favoriteChannels, e))
        }
    }, o.Sb.FREQUENT_USER_ACTION)
}
