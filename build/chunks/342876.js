/** Chunk was on web.js **/
/** chunk id: 342876, original params: e,t,n (module,exports,require) **/
"use strict";
n.d(t, {
    b: () => o
});
...
function o(e) {
    let {
        collection: t,
        focusMode: n
    } = e, o = e.UNSAFE_selectionState || (0, i.R)(e), l = (0, s.useMemo)(() => e.disabledKeys ? new Set(e.disabledKeys) : new Set, [e.disabledKeys]), c = o.setFocusedKey;
    o.setFocusedKey = (e, i) => {
        if ("cell" === n && null != e) {
            let n = t.getItem(e);
            if ((null == n ? void 0 : n.type) === "item") {
                var a, s, o, l;
                let c = (0, r.iQ)(n, t);
                e = "last" === i ? null != (o = null == (a = (0, r.W)(c)) ? void 0 : a.key) ? o : null : null != (l = null == (s = (0, r.ue)(c)) ? void 0 : s.key) ? l : null
            }
        }
        c(e, i)
    };
    ...
    return (0, s.useEffect)(() => {
        if (null != o.focusedKey && d.current && !t.getItem(o.focusedKey)) {
            let e = d.current.getItem(o.focusedKey),
                n = (null == e ? void 0 : e.parentKey) != null && ("cell" === e.type || "rowheader" === e.type || "column" === e.type) ? d.current.getItem(e.parentKey) : e;
