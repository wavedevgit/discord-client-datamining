...
function T(e) {
    ...
    let m = {};
    return null != o && (m.size = (0, l.kr)(o * (0, l.mZ)())), null != d && (m.keep_aspect_ratio = d), c && (m.quality = "lossless"), "webp" === _ && u && X(a) && (m.animated = !0), t + "?".concat(s.stringify(m))
}
...
function C(e) {
    let {
        ...
        size: i,
        forcePNG: a = !1
    } = e, s = O ? "webp" : "png", o = O ? "webp" : "gif", c = a ? "png" : r ? o : s, u = O && r ? "&animated=true" : "", d = "size=".concat((0, l.kr)(i * (0, l.mZ)(), S)), p = !1;
    try {
        let {
...
function w(e) {
    let {
        ...
        discriminator: i,
        bot: a
    } = e, s = arguments.length > 1 && void 0 !== arguments[1] && arguments[1], o = arguments.length > 2 && void 0 !== arguments[2] ? arguments[2] : f.eQT, l = arguments.length > 3 && void 0 !== arguments[3] ? arguments[3] : null, c = arguments.length > 4 && void 0 !== arguments[4] ? arguments[4] : O;
    if (a) {
...
function P(e) {
    ...
    return "webp" === u && a && X(i) && (p.animated = !0), t += "?".concat(s.stringify(p))
}
...
function L(e) {
    ...
    let o = window.GLOBAL_ENV.CDN_HOST,
        c = i && X(r) ? er(O) : "png";
    t = null != o ? "https://".concat(o, "/banners/").concat(n, "/").concat(r, ".").concat(c) : location.protocol + window.GLOBAL_ENV.API_ENDPOINT + f.Rsh.USER_BANNER(n, r, c);
    let u = {
        size: (0, l.kr)(a * (0, l.mZ)())
    };
    return "webp" === c && i && X(r) && (u.animated = !0), t += "?".concat(s.stringify(u))
}
...
function G(e) {
    ...
    return "jpg" === c && (d.quality = "lossless"), "webp" === c && i && X(r) && (d.animated = !0), t += "?".concat(s.stringify(d))
}
