    ...
    try {
        ...
        let i, r, a = (await s.Bo.post({
            ...
            o = (n = {
                ...
                handoffKey: t,
                handoffToken: a
            }, i = new URL(n.urlString), r = `handoff_key=${encodeURIComponent(n.handoffKey)}&handoff_token=${encodeURIComponent(n.handoffToken)}`, "" !== i.hash ? i.hash += `&${r}` : i.hash = `#${r}`, i.href);
