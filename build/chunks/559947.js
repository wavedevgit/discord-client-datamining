...
function J(e) {
    ...
    let {
        ...
        publishedOnly: !0
    }).length, [eA]), es = (null == ei ? void 0 : ei.published) === !0, {
        application: ed
    } = (0, m.A)(eA, D.S7.GUILD_ROLE_SUBSCRIPTIONS), eu = N.D["0"], ec = j.kt.useSetting(), eg = (0, x.j)(), ep = n.useCallback(() => {
        var e;
        return (null == ei || null == (e = ei.image_asset) ? void 0 : e.application_id) == null ? eu.data : (0, O.YE)(ei.image_asset.application_id, ei.image_asset, 600, eg && ec ? void 0 : "webp")
    }, [eu, ei, eg, ec]), {
    ...
    let [em, ev] = n.useState(null != (A = null == ei ? void 0 : ei.name) ? A : ""), [eh, eq] = n.useState(null != (t = null == ei ? void 0 : ei.description) ? t : ""), [eb, eC] = n.useState(null != (l = null == ei ? void 0 : ei.price_tier) ? l : void 0), [ej, eU] = n.useState(ep), [eV, eO] = n.useState(null != (a = null == ei || null == ($ = ei.image_asset) ? void 0 : $.filename) ? a : eu.name), [ex, ey] = n.useState(!1), [eP, eK] = n.useState(), eN = n.useMemo(() => null != eb ? (0, V.$g)(eb, w.Yri.USD) : void 0, [eb]), [eI, eF] = n.useState(!0), {
        changesSaving: eT,
        saveError: eX,
        saveProductWithAttachments: eW,
        hasUnsavedAttachmentChanges: eQ,
        cancelUnusedUploads: eS
    } = (0, y.Z)(), eZ = (null == ei ? void 0 : ei.attachments) != null && (null == ei ? void 0 : ei.attachments.length) > 0, ez = null != eX ? eX : eP, ew = null != eT && "published" in eT, eD = null != eT && !ew, eR = null != (i = null == ei ? void 0 : ei.role_id) ? i : null, [eL, eG] = n.useState(), ek = null != eL || null != eR, eE = (0, s.bG)([U.A], () => null != eR && null !== eL ? U.A.getRole(eA, eR) : null != eL ? eL : void 0, [eL, eR, eA]), eB = "";
                    ...
                    children: [(0, r.jsx)(p.ksK, {
                        ...
                        children: (0, r.jsx)(Q.A, {
                            ...
                            onChange: (e, A) => {
                                if (null != e) {
                                    var t;
                                    eU(e), eO(A), ey(e.startsWith("data:") || A !== (null == ei || null == (t = ei.image_asset) ? void 0 : t.filename))
                                }
                            }
                        })
                    }), eI ? (0, r.jsx)(p.D0$, {
