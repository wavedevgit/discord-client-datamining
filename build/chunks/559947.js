/** chunk id: 559947, original params: A,e,t (module,exports,require) **/
t.d(e, {
    default: () => J
});
var n = t(627968),
...
function Y(A) {
    let {
        ...
        disabled: r,
        warning: l
    } = A, s = (0, m.GV)(), o = r ? "text-muted" : "text-default";
    return (0, n.jsxs)("label", {
        className: i()(k.$4, {
            [k.r9]: r
        }),
        htmlFor: s,
        children: [(0, n.jsx)(q.Text, {
            variant: "text-sm/medium",
            color: o,
            children: e
        }), null != l && (0, n.jsxs)(n.Fragment, {
            children: [(0, n.jsx)(q.hKd, {
                size: 4,
                horizontal: !0
            }), l]
        }), (0, n.jsx)(q.dOG, {
...
function H(A) {
    let {
        ...
        priceTiers: s
    } = (0, h._)(e, R.L_o.GUILD_PRODUCTS), o = a.useMemo(() => (s ?? (null != t ? [t] : [])).map(A => ({
        id: A.toString(),
        value: A,
...
function M(A) {
    let {
        ...
        transitionState: r,
        onClose: i
    } = A, [l, m] = a.useState(t), h = (0, o.bG)([F.A], () => null == l ? null : F.A.getGuildProduct(l), [l]), U = (0, o.bG)([F.A], () => F.A.getGuildProductsForGuild(e, {
        publishedOnly: !0
    }).length, [e]), w = h?.published === !0, {
        application: M
    } = (0, f.A)(e, G.S7.GUILD_ROLE_SUBSCRIPTIONS), _ = I.D["0"], $ = V.kt.useSetting(), AA = (0, K.j)(), Ae = a.useCallback(() => h?.image_asset?.application_id == null ? _.data : (0, j.YE)(h.image_asset.application_id, h.image_asset, 600, AA && $ ? void 0 : "webp"), [_, h, AA, $]), {
        shouldRestrictUpdatingCreatorMonetizationSettings: At
    } = (0, v.nq)(e);
    a.useEffect(() => {
        At && (i(), (0, Q.p)(y.intl.string(y.t.OLf3xn), y.t["90LBVr"]))
    }, [At, i]);
    let [An, Aa] = a.useState(h?.name ?? ""), [Ar, Ai] = a.useState(h?.description ?? ""), [Al, As] = a.useState(h?.price_tier ?? void 0), [Ao, Ad] = a.useState(Ae), [Au, Ac] = a.useState(h?.image_asset?.filename ?? _.name), [Ag, Aq] = a.useState(!1), [Ap, Af] = a.useState(), Am = a.useMemo(() => null != Al ? (0, b.$g)(Al, R.Yri.USD) : void 0, [Al]), [Ah, AC] = a.useState(!0), {
        changesSaving: Av,
        saveError: AU,
        saveProductWithAttachments: AV,
        hasUnsavedAttachmentChanges: Ax,
        cancelUnusedUploads: Ab
    } = (0, N.Z)(), Aj = h?.attachments != null && h?.attachments.length > 0, AK = AU ?? Ap, AN = null != Av && "published" in Av, AF = null != Av && !AN, AT = h?.role_id ?? null, [AI, AX] = a.useState(), AW = null != AI || null != AT, AP = (0, o.bG)([x.A], () => null != AT && null !== AI ? x.A.getRole(e, AT) : AI ?? void 0, [AI, AT, e]), AQ = "";
    AW && Ah ? AQ = y.intl.string(y.t.ih4QMU) : AW ? AQ = y.intl.string(y.t.o9xphc) : Ah && (AQ = y.intl.string(y.t.DWYJua));
    let AZ = () => {
            AC(!1), Ab()
        },
        [Az, AO] = a.useState(),
        ...
        Ak = a.useMemo(() => AS || null == Az || "publish" === Az || null != AK ? null : (0, n.jsx)(q.FQk, {
            className: k.Er,
            children: (0, n.jsx)(c.A, {
                message: (0, n.jsxs)("div", {
                    className: k.Lk,
                    children: [(0, n.jsx)(q.yr3, {
                        size: "md",
                        color: d.A.colors.CONTROL_CONNECTED_BACKGROUND_DEFAULT.css,
                        secondaryColor: d.A.colors.WHITE.css
                    }), (0, n.jsx)(q.Text, {
                        variant: "text-md/medium",
                        children: "draft" === Az ? y.intl.string(y.t["3Rv4MB"]) : "update_publish" === Az ? y.intl.string(y.t["8fPiB3"]) : y.intl.string(y.t["3LUFnI"])
                    })]
                }),
                onReset: () => AO(void 0),
    ...
    return (0, n.jsxs)(q.EOs, {
        ...
        children: [(0, n.jsxs)(q.rQ0, {
            className: k.Hc,
            separator: !1,
            "data-migration-pending": !0,
            children: [(0, n.jsxs)("div", {
                className: k.TK,
                children: [(0, n.jsx)(q.Heading, {
                    id: D,
            ...
            scrollbarType: "none",
            "data-migration-pending": !0,
            children: [(0, n.jsx)(q.IpV, {
                children: (0, n.jsxs)("div", {
                    className: k.sj,
                    ref: AE,
                    children: [(0, n.jsx)(q.ksK, {
                        ...
                        children: (0, n.jsx)(z.A, {
                            ...
                            onChange: (A, e) => {
                                null != A && (Ad(A), Ac(e), Aq(A.startsWith("data:") || e !== h?.image_asset?.filename))
                            }
                        })
                    }), Ah ? (0, n.jsx)(q.D0$, {
                ...
                children: (0, n.jsxs)("div", {
                    ...
                    children: [(0, n.jsx)(O.A, {
                        disabled: !Ay || !w && U >= 50,
                        disabledTooltip: w ? y.intl.string(y.t["0NQ00t"]) : U >= 50 ? y.intl.format(y.t.IqWPVt, {
                            maxProducts: 50
                        }) : y.intl.string(y.t["Ax89/c"]),
                        published: w,
                        onClick: () => {
                            s()(Ay, "Attempting to publish/unpublish when not allowed"), AO(w ? "unpublish" : "publish"), AB({
                                ...AL,
                                published: !w
                            })
                        },
                        ...
                        role: AP,
                        productType: AQ,
                        ctaComponent: (0, n.jsx)(q.Button, {
                            text: y.intl.string(y.t.xUi3BL)
                        }),
                        cardWidth: 340,
                        thumbnailHeight: 190
                    })]
            ...
            children: (0, n.jsxs)("div", {
                ...
                children: [(0, n.jsxs)("div", {
                    ...
                    className: k.TM,
                    children: w ? (0, n.jsx)(q.Button, {
                        variant: "secondary",
                        text: y.intl.string(y.t.XYBEaV),
                        disabled: !AG,
                        loading: AF,
                        onClick: () => {
                            s()(AG, "cannot save changes for published product without adding all fields"), AO("update_publish"), AB(AL)
                        }
                    }) : (0, n.jsx)(q.Button, {
                        variant: "secondary",
                        ...
                        loading: AF,
                        onClick: () => {
                            s()(AR, "cannot save changes without name or price tier"), AO("draft"), AB(AL)
                        }
                    })
                })]
            })
