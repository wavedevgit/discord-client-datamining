/** chunk id: 107795 params = (module,exports,require) **/
n.d(t, {
    ME: () => A,
    NF: () => g,
    P3: () => I,
...
function g(e, t, n) {
    E(e, u.A.editedOnboardingPrompts.map(e => e.id === t ? {
        ...e,
        ...n
    } : e))
}
...
function A(e, t) {
    E(e, u.A.editedOnboardingPrompts.filter(e => e.id !== t))
}
...
function S(e, t) {
    ...
    let i = (n = u.A.getChangedPrompts(), null != t && t.ignoreDefaultPrompt && 1 === n.length && (0, N.Km)(n[0]) && (n = []), n),
        ...
        m = r.map(t => {
            ...
            let n = t.options.map(t => {
                ...
                return {
                    ...
                    channelIds: i,
                    emoji: function(e) {
                        if (null != e && (e.emoji?.id == null || null != a.Ay.getCustomEmojiById(e.emoji.id))) return e.emoji
                    }(t)
                }
            });
            return {
                ...t,
                options: n,
                type: n.length >= N.Bu ? N.ME.DROPDOWN : N.ME.MULTIPLE_CHOICE
            }
        });
...
async function x(e, t) {
    ...
    try {
        ...
        let {
            fieldName: e,
            error: t
        } = new r.LG(n).getAnyErrorMessageAndField() ?? {};
        throw s.A.show({
            title: h.intl.string(h.t.iLdiqY),
...
function f(e, t, n) {
    let i = {
        ...
        l = !1;
    return n.title.length <= 0 && (i.title = h.intl.string(h.t.h8Hg1T), l = !0), n.options.length <= 0 && (i.options = h.intl.string(h.t["64tF+W"]), l = !0), n.inOnboarding && t.filter(e => e.inOnboarding).length > N.D1 && (i.config = h.intl.formatToPlainString(h.t["cTb/rg"], {
        numQuestions: N.D1
    }), l = !0), i.optionErrors = n.options.map(i => p(e, t, n, i)), (l = l || i.optionErrors.some(e => null != e)) ? i : null
}
