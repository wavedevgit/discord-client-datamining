...
function c(e) {
    let {
        targetElementRef: t,
        isPremium: n,
        markMenuItemPopoverAsDismissed: c
    } = e, [d, m] = s.useState("top"), A = s.useRef(null), p = s.useRef(null);
    return s.useLayoutEffect(() => {
        if (null == t.current) return;
        let e = () => {
            null == p.current && (p.current = window.requestAnimationFrame(() => {
                p.current = null, (() => {
        ...
        return e(), window.addEventListener("resize", e), window.addEventListener("scroll", e, !0), () => {
            null != p.current && (window.cancelAnimationFrame(p.current), p.current = null), window.removeEventListener("resize", e), window.removeEventListener("scroll", e, !0)
        }
    }, [t]), (0, l.jsx)(a.AM, {
        targetElementRef: t,
        position: "right",
