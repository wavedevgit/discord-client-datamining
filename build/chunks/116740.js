...
t.exports = function() {
    ...
    j.prototype.toString = function() {
    ...
    }, f(X, J), X.prototype.toKeyedSeq = function() {
        return this
    }, f(Y, J), Y.of = function() {
        return Y(arguments)
        ...
        return this
    }, J.isSeq = tn, J.Keyed = X, J.Set = $, J.Indexed = Y;
    ...
    function tl(t, e) {
        return e ? function t(e, r, n, i) {
            return Array.isArray(r) ? e.call(i, n, Y(r).map(function(n, i) {
                return t(e, n, i, r)
    ...
    function tb() {}
    J.prototype[Z] = !0, f(Q, Y), Q.prototype.get = function(t, e) {
    ...
    }, f(tt, X), tt.prototype.get = function(t, e) {
    ...
    }, tt.prototype[x] = !0, f(te, Y), te.prototype.__iterateUncached = function(t, e) {
        if (e) return this.cacheResult().__iterate(t, e);
        var r, n = W(this._iterable),
            i = 0;
        if (H(n))
    ...
    }, f(tr, Y), tr.prototype.__iterateUncached = function(t, e) {
        if (e) return this.cacheResult().__iterate(t, e);
    ...
    }, f(td, Y), td.prototype.toString = function() {
    ...
    }, f(ty, Y), ty.prototype.toString = function() {
    ...
    }, f(tv, p), f(tm, tv), f(t_, tv), f(tb, tv), tv.Keyed = tm, tv.Indexed = t_, tv.Set = tb;
    ...
    function tk(t) {
        ...
        if ("string" === e) {
            return t.length > tT ? (void 0 === (o = tI[i = t]) && (o = tx(i), tA === tM && (tA = 0, tI = {}), tA++, tI[i] = o), o) : tx(t)
        }
        if ("function" == typeof t.hashCode) return t.hashCode();
        if ("object" === e) {
            var i, o, a, s = t;
            if (tO && void 0 !== (a = n.get(s)) || void 0 !== (a = s[tK]) || !tE && (void 0 !== (a = s.propertyIsEnumerable && s.propertyIsEnumerable[tK]) || void 0 !== (a = function(t) {
            ...
            else if (tE) Object.defineProperty(s, tK, {
                enumerable: !1,
                configurable: !1,
                writable: !1,
                value: a
    ...
    function tL(t) {
        return null == t ? tJ() : tR(t) && !b(t) ? t : tJ().withMutations(function(e) {
            var r = h(t);
            tB(r.size), r.forEach(function(t, r) {
                return e.set(r, t)
            })
        })
    }
    ...
    f(tL, tm), tL.prototype.toString = function() {
    ...
    function tZ(t, e, r, n, i) {
        ...
        var o, a = (0 === r ? t.keyHash : t.keyHash >>> r) & 31,
            s = (0 === r ? n : n >>> r) & 31,
    ...
    tF[tN] = !0, tF[C] = tF.remove, tF.removeIn = tF.deleteIn, tz.prototype.get = function(t, e, r, n) {
        ...
        if (T(a), (s || !f) && T(o), !s || 1 !== u.length) {
            ...
            var _ = t && t === this.ownerID,
                b = _ ? u : A(u);
            return (f ? s ? c === l - 1 ? b.pop() : b[c] = b.pop() : b[c] = [n, i] : b.push([n, i]), _) ? (this.entries = b, this) : new tz(t, b)
        }
        ...
        if (d === h) return this;
        if (!l && d && p.length >= t9) {
            for (var g = t, y = p, v = c, m = s, _ = d, b = 0, S = Array(32), w = 0; 0 !== v; w++, v >>>= 1) S[w] = 1 & v ? y[b++] : void 0;
        ...
        var k = t && t === this.ownerID,
            x = l ? d ? c : c ^ u : c | u,
            C = l ? d ? t7(p, f, d, k) : function(t, e, r) {
                var n = t.length - 1;
                if (r && e === n) return t.pop(), t;
                for (var i = Array(n), o = 0, a = 0; a < n; a++) a === e && (o = 1), i[a] = t[a + o];
                return i
            }(p, f, k) : function(t, e, r, n) {
                var i = t.length + 1;
                if (n && e + 1 === i) return t[e] = r, t;
                for (var o = Array(i), a = 0, s = 0; s < i; s++) s === e ? (o[s] = r, a = -1) : o[s] = t[s + a];
                return o
            }(p, f, d, k);
        ...
        var p = this.count;
        if (l) {
            if (!f && --p < t2) return function(t, e, r, n) {
        ...
        var s = i === E,
            u = tp(n, this.entry[0]);
        return (u ? i === this.entry[1] : s) ? this : (T(a), s) ? void T(o) : u ? t && t === this.ownerID ? (this.entry[1] = i, this) : new tq(t, this.keyHash, [n, i]) : (T(o), tZ(this, t, e, tk(n), [n, i]))
    }, tz.prototype.iterate = tU.prototype.iterate = function(t, e) {
        for (var r = this.entries, n = 0, i = r.length - 1; n <= i; n++)
            if (!1 === t(r[e ? i - n : n])) return !1
    }, tP.prototype.iterate = tj.prototype.iterate = function(t, e) {
        ...
        return t(this.entry)
    }, f(tH, j), tH.prototype.next = function() {
    ...
    ee[et] = !0, ee[C] = ee.remove, ee.setIn = tF.setIn, ee.deleteIn = ee.removeIn = tF.removeIn, ee.update = tF.update, ee.updateIn = tF.updateIn, ee.mergeIn = tF.mergeIn, ee.mergeDeepIn = tF.mergeDeepIn, ee.withMutations = tF.withMutations, ee.asMutable = tF.asMutable, ee.asImmutable = tF.asImmutable, ee.wasAltered = tF.wasAltered, er.prototype.removeBefore = function(t, e, r) {
        ...
        var s = eu(this, t);
        if (!o)
            for (var u = 0; u < i; u++) s.array[u] = void 0;
    ...
    function ei(t, e) {
        ...
        return function t(a, s, u) {
            ...
            return 0 === s ? (c = a, f = (l = u) === i ? o && o.array : c && c.array, p = l > r ? 0 : r - l, (h = n - l) > 32 && (h = 32), function() {
                if (p === h) return en;
                var t = e ? --h : p++;
                return f && f[t]
            }) : (d = a, g = s, y = u, m = d && d.array, _ = y > r ? 0 : r - y >> g, (b = (n - y >> g) + 1) > 32 && (b = 32), function() {
                for (;;) {
                    if (v) {
                        var r = v();
                        if (r !== en) return r;
    ...
    function el(t, e, r) {
        ...
        for (var u = t._level, c = t._root, l = 0; a + l < 0;) c = new er(c && c.array.length ? [void 0, c] : [], n), u += 5, l += 1 << u;
        l && (a += l, i += l, s += l, o += l);
        ...
        if (s < o && (d = d && d.removeAfter(n, 0, s)), a >= p) a -= p, s -= p, u = 5, c = null, d = d && d.removeBefore(n, 0, a);
        else if (a > i || p < f) {
            for (l = 0; c;) {
                var m = a >>> u & 31;
                if (m !== p >>> u & 31) break;
            ...
            c && a > i && (c = c.removeBefore(n, u, a - l)), c && p < f && (c = c.removeAfter(n, u, p - l)), l && (a -= l, s -= l)
        }
    ...
    function ef(t, e, r) {
        for (var n = [], i = 0, o = 0; o < r.length; o++) {
            var a = r[o],
                s = d(a);
            s.size > i && (i = s.size), y(a) || (s = s.map(function(t) {
                return tl(t)
            })), n.push(s)
        }
    ...
    function ew(t) {
        ...
        return e._iter = t, e.size = t.size, e.flip = function() {
            ...
            return t.has(e)
        }, e.cacheResult = eF, e.__iterateUncached = function(e, r) {
            var n = this;
    ...
    function ex(t, e) {
        ...
        return r._iter = t, r.size = t.size, r.reverse = function() {
            ...
            return t.includes(e)
        }, r.cacheResult = eF, r.__iterate = function(e, r) {
            var n = this;
            return t.__iterate(function(t, r) {
                return e(t, r, n)
            }, !r)
    ...
    function eE(t, e, r, n) {
        ...
        u == u && (i = u < 0 ? 0 : u);
        var c = eN(t);
        return c.size = 0 === i ? i : t.size && i || void 0, !n && tn(t) && i >= 0 && (c.get = function(e, r) {
    ...
    function eT(t, e, r) {
        if (e || (e = ez), !r) return t.reduce(function(t, r) {
            return eM(e, t, r) ? r : t
        });
    ...
    function eA(t, e, r) {
        var n = eN(t);
        return n.size = new Q(r).map(function(t) {
            return t.size
    ...
    }, eh.isOrderedMap = ed, eh.prototype[x] = !0, eh.prototype[C] = eh.prototype.remove, f(em, X), em.prototype.get = function(t, e) {
    ...
    }, em.prototype[x] = !0, f(e_, Y), e_.prototype.includes = function(t) {
    ...
    }, f(eb, $), eb.prototype.has = function(t) {
        return this._iter.includes(t)
    ...
    }, f(eS, X), eS.prototype.entrySeq = function() {
    ...
    }, e_.prototype.cacheResult = em.prototype.cacheResult = eb.prototype.cacheResult = eS.prototype.cacheResult = eF, f(ej, tm), ej.prototype.toString = function() {
    ...
    function eV(t) {
        return null == t ? eZ() : eG(t) && !b(t) ? t : eZ().withMutations(function(e) {
            var r = g(t);
            tB(r.size), r.forEach(function(t) {
                return e.add(t)
            })
        })
    }
    ...
    eU[C] = eU.remove, eU.deleteIn = eU.removeIn = tF.removeIn, eU.merge = tF.merge, eU.mergeWith = tF.mergeWith, eU.mergeIn = tF.mergeIn, eU.mergeDeep = tF.mergeDeep, eU.mergeDeepWith = tF.mergeDeepWith, eU.mergeDeepIn = tF.mergeDeepIn, eU.setIn = tF.setIn, eU.update = tF.update, eU.updateIn = tF.updateIn, eU.withMutations = tF.withMutations, eU.asMutable = tF.asMutable, eU.asImmutable = tF.asImmutable, f(eV, tb), eV.of = function() {
        return this(arguments)
    ...
    eX[eJ] = !0, eX[C] = eX.remove, eX.mergeDeep = eX.merge, eX.mergeDeepWith = eX.mergeWith, eX.withMutations = tF.withMutations, eX.asMutable = tF.asMutable, eX.asImmutable = tF.asImmutable, eX.__empty = eZ, eX.__make = e$, f(eQ, eV), eQ.of = function() {
        return this(arguments)
    ...
    e1[x] = !0, e1.__empty = e5, e1.__make = e6, f(e7, t_), e7.of = function() {
        return this(arguments)
        ...
        return this.__ownerID ? (this.size = t, this._head = e, this.__hash = void 0, this.__altered = !0, this) : e4(t, e)
        ...
        }), this.__ownerID) ? (this.size = e, this._head = r, this.__hash = void 0, this.__altered = !0, this) : e4(e, r)
        ...
        return 0 === this.size ? this : this.__ownerID ? (this.size = 0, this._head = void 0, this.__hash = void 0, this.__altered = !0, this) : e8()
    }, e7.prototype.slice = function(t, e) {
        if (R(t, e, this.size)) return this;
        var r, n = N(t, this.size, 0);
        if (N(e, r = this.size, r) !== this.size) return t_.prototype.slice.call(this, t, e);
        for (var i = this.size - n, o = this._head; n--;) o = o.next;
        return this.__ownerID ? (this.size = i, this._head = o, this.__hash = void 0, this.__altered = !0, this) : e4(i, o)
    }, e7.prototype.__ensureOwner = function(t) {
        return t === this.__ownerID ? this : t ? e4(this.size, this._head, t, this.__hash) : (this.__ownerID = t, this.__altered = !1, this)
    ...
    e2[e9] = !0, e2.withMutations = tF.withMutations, e2.asMutable = tF.asMutable, e2.asImmutable = tF.asImmutable, e2.wasAltered = tF.wasAltered, p.Iterator = j, rt(p, {
        toArray: function() {
            tB(this.size);
        ...
        reduce: function(t, e, r) {
            var n, i;
            return tB(this.size), arguments.length < 2 ? i = !0 : n = e, this.__iterate(function(e, o, a) {
        ...
        countBy: function(t, e) {
            var r, n;
            return r = this, n = tL().asMutable(), r.__iterate(function(i, o) {
        ...
        groupBy: function(t, e) {
            var r, n, i, o;
            return r = this, n = v(r), i = (b(r) ? eh() : tL()).asMutable(), r.__iterate(function(o, a) {
                i.update(t.call(e, o, a, r), function(t) {
                    return (t = t || []).push(n ? [a, o] : o), t
                })
            }), o = eR(r), i.map(function(t) {
                return eI(r, o(t))
            })
        },
        has: function(t) {
        ...
        takeWhile: function(t, e) {
            var r, n;
            return eI(this, (r = this, (n = eN(r)).__iterateUncached = function(n, i) {
                var o = this;
                if (i) return this.cacheResult().__iterate(n, i);
                var a = 0;
                return r.__iterate(function(r, i, s) {
        ...
        hashCode: function() {
            return this.__hash || (this.__hash = function(t) {
                ...
                var e, r, n = b(t),
                    i = v(t),
                    o = +!!n;
                return e = t.__iterate(i ? n ? function(t, e) {
                    ...
                    o = o + tk(t) | 0
                }), r = tS(r = o, 0xcc9e2d51), r = tS(r << 15 | r >>> -15, 0x1b873593), r = (r = tS(r << 13 | r >>> -13, 5)) + 0xe6546b64 ^ e, r = tS(r ^ r >>> 16, 0x85ebca6b), r = tw((r = tS(r ^ r >>> 13, 0xc2b2ae35)) ^ r >>> 16)
            }(this))
        }
    });
    var re = p.prototype;
    re[S] = !0, re[P] = re.values, re.__toJS = re.toArray, re.__toStringMapper = rs, re.inspect = re.toSource = function() {
        return this.toString()
    }, re.chain = re.flatMap, re.contains = re.includes;
    try {
    ...
    return rr[w] = !0, rr[P] = re.entries, rr.__toJS = re.toObject, rr.__toStringMapper = function(t, e) {
        ...
        interpose: function(t) {
            var e, r;
            return eI(this, (e = this, (r = eN(e)).size = e.size && 2 * e.size - 1, r.__iterateUncached = function(r, n) {
                var i = this,
                    o = 0;
    ...
    }), d.prototype[k] = !0, d.prototype[x] = !0, rt(g, {
        get: function(t, e) {
    ...
    }), g.prototype.has = re.includes, rt(X, h.prototype), rt(Y, d.prototype), rt($, g.prototype), rt(tm, h.prototype), rt(t_, d.prototype), rt(tb, g.prototype), {
        Iterable: p,
        Seq: J,
        Collection: tv,
        Map: tL,
