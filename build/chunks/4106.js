...
let c = {
    ...
    fetchForStatusNotification(e) {
        (0, o.Lg)("fetchInitialStatus") && r.h.dispatch({
            type: "LOAD_ICYMI_FROM_NOTIFICATION",
            customStatusItem: e
        })
    },
    async fetchHydrated(e, t, n) {
        ...
        if (0 === c.length && 0 === u.length && 0 === A.length) return void r.h.dispatch({
    ...
    ackGravityItems: (e, t) => r.h.dispatch({
        type: "ICYMI_ACK_ITEMS",
        items: e,
        override: t
    }),
    gravityScrollEvent: e => r.h.dispatch({
        type: "ICYMI_SCROLL_EVENT",
        timestamp: e
    }),
    setFilters: e => r.h.dispatch({
        type: "SET_ICYMI_FILTERS",
        filters: e
    }),
    giveFeedback: () => r.h.dispatch({
        type: "ICYMI_FEEDBACK_GIVEN"
    }),
    clearReadStates: () => r.h.dispatch({
        type: "CLEAR_ICYMI_READ_STATES"
    }),
    addedRecommendedGuild: () => r.h.dispatch({
