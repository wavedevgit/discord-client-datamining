/** chunk id: 569495, original params: e,t,a (module,exports,require) **/
a.d(t, {
    A: () => P
...
let P = i.forwardRef(function(e, t) {
    let {
        ...
        let p = i.useCallback(async () => {
            if (null != n) {
                if ((0, f.TR)(I.HAw.APP_DIRECTORY_LAUNCH_CLICKED, {
                        application_id: a
                    }), !c) return void(0, f.jL)({
                    [y]: "true"
                });
                await m()
            }
        ...
        return {
            onClickLaunchActivity: s ? p : void 0,
            isSubmitting: l
        }
