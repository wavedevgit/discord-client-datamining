    ...
    let a, l, {
        ...
        } = e,
        {
            ...
            onClickInstallApplication: i.useCallback(() => {
                if ((0, I.TR)(E.HAw.APP_DIRECTORY_INSTALL_CLICKED, {
                        application_id: t.id
...
let O = i.forwardRef(function(e, t) {
    let {
    ...
    } = (0, u.Ay)(), p = i.useCallback(() => {
        let e;
        (0, I.TR)(E.HAw.APP_DIRECTORY_APPLICATION_LINK_COPIED, {
            application_id: a.id
        }), (0, v.C)((e = a.id, `${location.protocol}//${location.host}${E.BVt.GLOBAL_DISCOVERY_APPS_PROFILE(e)}`), () => (0, c.showToast)((0, c.createToast)(N.intl.string(N.t["L/PwZf"]), c.ToastType.SUCCESS)))
    ...
    }), S = i.useCallback((e, t) => (0, n.jsxs)(c.W1t, {
        ...
        }), null != j ? (0, n.jsx)(c.rXV, {
            children: j
        }) : null]
    }), [j, C, p]), {
        onClickLaunchActivity: T,
        isSubmitting: O
    } = function(e, t) {
        let a = e.id,
            n = e?.bot?.id,
        ...
        let f = i.useCallback(async () => {
            if (null != n) {
                if ((0, I.TR)(E.HAw.APP_DIRECTORY_LAUNCH_CLICKED, {
                        application_id: a
                    }), !p) return void(0, I.jL)({
                    [R]: "true"
                });
                await x()
            }
        ...
        return {
            onClickLaunchActivity: r ? f : void 0,
            isSubmitting: c
        }
    }(a, r), k = null != T, G = k ? "secondary" : "primary";
    return (0, n.jsxs)("div", {
        ref: t,
        children: [(0, n.jsxs)("div", {
            className: s()(y.Ik, y.U),
            children: [k && (0, n.jsx)(D, {
                size: l,
                contentWidth: "normal",
                onClick: T,
                isSubmitting: O
