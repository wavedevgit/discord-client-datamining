/** chunk id: 16667, original params: e,l,t (module,exports,require) **/
t.d(l, {
    A: () => u
});
var r = t(311907),
...
let u = new c(o.h, {
    ...
    COLLECTIBLES_COLLECTION_FETCH_SUCCESS: e => {
        ...
        l.products?.forEach(e => {
            e.skus.forEach(e => {
                i[e.id] = e, delete s[e.id], d.delete(e.id)
            }), a[e.id] = e, delete s[e.id], d.delete(e.id)
        }), n[l.id] = l, delete s[l.id], d.delete(l.id)
    },
    ...
    COLLECTIBLES_PRODUCT_WITH_SKUS_FETCH_SUCCESS: e => {
        ...
        l.skus.forEach(e => {
            i[e.id] = e, delete s[e.id], d.delete(e.id)
        }), a[l.id] = l, d.delete(l.id), delete s[l.id]
    },
    ...
    COLLECTIBLES_PRODUCT_FOR_SKU_FETCH_SUCCESS: e => {
        ...
        l.skus.forEach(e => {
            i[e.id] = e, delete s[e.id], d.delete(e.id)
        }), a[l.id] = l, delete s[l.id], d.delete(l.id)
    },
