...
let ee = e => {
    ...
    et = l.memo(function(e) {
        ...
        }, [t]), g = o === S.v.BURST, A = g ? Z.t.VmiNjd : Z.t["cNfs1/"], f = Z.intl.formatToPlainString(A, {
            name: h,
            n: i
        }), T = l.useMemo(() => {
            let e = {};
...
function ei(e) {
    ...
    } = (0, x.Ay)(E.A.MESSAGE_REACTIONS), g = (0, d.bG)([L.default], () => L.default.getId()), T = (0, d.bG)([V.default], () => V.default.getUser(i.id), [i]), N = (0, y.Id)(a), v = (0, d.bG)([k.A], () => k.A.can(J.xBc.MANAGE_MESSAGES, a) && N) || g === i.id, j = (0, d.bG)([w.Ay, P.A, D.A], () => z.Ay.getName(r, a.id, i));
    async function R() {
...
class en extends l.PureComponent {
    ...
    render() {
        ...
        return 0 === t.length && this.state.loadingMore ? s.push(1) : (s.push(t.length), e && s.push(1)), (0, n.jsxs)("div", {
            className: Q.Ro,
            children: [a === S.v.BURST && (0, n.jsx)(ee, {
                emoji: i.emoji,
...
let el = d.Ay.connectStores([U.A], e => {
    let {
        message: t,
        reaction: i,
        reactionType: n
    } = e, l = U.A.getReactions(t.getChannelId(), t.id, i.emoji, J.WxW, n);
    if (null == l) return {
        reactors: [],
        hasMore: !1
    };
...
function ea(e) {
    let {
        ...
        let e = G.A.getMessage(t.getChannelId(), t.id) ?? j.A.getMessage($.default.castMessageIdAsChannelId(t.id))?.firstMessage;
        ...
        emoji: f.emoji,
        reactionType: f.burst_count > 0 ? S.v.BURST : S.v.NORMAL
    } : null, A), I = l.useMemo(() => null == E ? null : g.find(e => (0, F.i6)(e.emoji, E.emoji)) ?? null, [g, E]), N = (0, d.bG)([T.A], () => T.A.saturation), C = (0, d.bG)([M.A], () => (0, m.Mw)(M.A.theme));
    if (l.useEffect(() => {
