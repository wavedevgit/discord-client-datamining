...
let S = __OVERLAY__ ? () => (0, o.bG)([_.default], () => _.default.isInstanceFocused()) : g.j;
...
function T(e) {
    ...
    let {
        ...
        surrogate: L
    } = e, j = A(e, ["src", "alt", "className", "emojiId", "emojiName", "channelId", "messageId", "animated", "size", "isInteracting", "shouldAnimate", "onMouseEnter", "onMouseLeave", "canSelect", "autoplay", "registerInnerRef", "registerAnimatedElementRef", "surrogate"]), [M, k] = i.useState(!1), [U, G] = i.useState(void 0), V = i.useRef(void 0), {
        triggerAnimation: F,
