/** chunk id: 574905, original params: t,e,s (module,exports,require) **/
s.d(e, {
    TQ: () => o,
    ol: () => a,
    r9: () => n
...
class a extends r.Vw {
    constructor(t, e, s, i) {
        super(), this.blockLen = t, this.outputLen = e, this.padOffset = s, this.isLE = i, this.finished = !1, this.length = 0, this.pos = 0, this.destroyed = !1, this.buffer = new Uint8Array(t), this.view = (0, r.O8)(this.buffer)
    }
    update(t) {
        (0, i.t2)(this);
        let {
        ...
        for (let i = 0; i < o;) {
            ...
            s.set(t.subarray(i, i + a), this.pos), this.pos += a, i += a, this.pos === n && (this.process(e, 0), this.pos = 0)
        }
    ...
    digestInto(t) {
        ...
        }(s, n - 8, BigInt(8 * this.length), o), this.process(s, 0);
        let h = (0, r.O8)(t),
            f = this.outputLen;
