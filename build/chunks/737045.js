...
function D(t, e, i) {
    ...
    return {
        ...
        [_.xBc.SEND_MESSAGES.toString()]: {
            title: _.kvI.GUILD_THREADS_ONLY.has(n) ? A.intl.string(A.t.nJwAHX) : n === _.rbe.GUILD_CATEGORY ? A.intl.string(A.t.S1VOwd) : A.intl.string(A.t.T32rkC),
            description: (() => {
                switch (n) {
                    case _.rbe.GUILD_CATEGORY:
                        return A.t.IjeLuu;
                    case _.rbe.GUILD_FORUM:
                        return i?.createPostsDisabled && !t.isMediaChannel() ? E.A.getForumChannelPermissionText() : A.t.LG9VAi;
        ...
        [_.xBc.MENTION_EVERYONE.toString()]: {
            title: n === _.rbe.GUILD_STAGE_VOICE ? A.intl.string(A.t.VDUAHO) : i?.inGameMentionsExperiment ? A.intl.string(A.t.lEO7Wr) : A.intl.string(A.t.Y78KGC),
            description: n === _.rbe.GUILD_CATEGORY ? A.t["HOhg/B"] : n === _.rbe.GUILD_STAGE_VOICE ? A.t.rZn1oO : i?.inGameMentionsExperiment ? A.t.wdHpIC : A.t["6IUSdt"],
        ...
        [_.xBc.USE_SOUNDBOARD.toString()]: {
            ...
            description: (() => {
                switch (n) {
                    case _.rbe.GUILD_CATEGORY:
                        return A.intl.format(A.t["0kBp/0"], {
                            helpCenterArticle: S.A.getArticleURL(_.MVz.SOUNDBOARD)
                        });
                    case _.rbe.GUILD_TEXT:
                    case _.rbe.GUILD_FORUM:
                    case _.rbe.GUILD_MEDIA:
                        return A.intl.format(A.t["6eYqU1"], {
                            helpCenterArticle: S.A.getArticleURL(_.MVz.SOUNDBOARD)
                        });
                    default:
                        return A.intl.format(A.t.GEi6Ym, {
                            helpCenterArticle: S.A.getArticleURL(_.MVz.SOUNDBOARD)
                        })
                }
            })(),
        ...
        [_.xBc.MANAGE_THREADS.toString()]: {
            title: _.kvI.GUILD_THREADS_ONLY.has(n) ? A.intl.string(A.t.ossiZD) : n === _.rbe.GUILD_CATEGORY ? A.intl.string(A.t.QKe7Q3) : A.intl.string(A.t.kEqgr7),
            description: (() => {
                switch (n) {
                    case _.rbe.GUILD_CATEGORY:
                        return A.t.S31soU;
        ...
        [_.xBc.SEND_MESSAGES_IN_THREADS.toString()]: {
            title: _.kvI.GUILD_THREADS_ONLY.has(n) ? A.intl.string(A.t.fqhqWm) : n === _.rbe.GUILD_CATEGORY ? A.intl.string(A.t["5QlVGy"]) : A.intl.string(A.t.fTE74g),
            description: (() => {
                switch (n) {
                    case _.rbe.GUILD_CATEGORY:
                        return A.t.DlIVcN;
