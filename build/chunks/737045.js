...
function D(t, e, i) {
    ...
    return {
        [A.xBc.VIEW_CHANNEL.toString()]: {
            title: n === A.rbe.GUILD_CATEGORY ? _.intl.string(_.t.uV83yi) : _.intl.string(_.t["W/A4Qp"]),
            description: (() => {
                if (e) switch (n) {
                ...
                return n === A.rbe.GUILD_CATEGORY ? _.t.SzosGs : _.t.M2iEy3
            })(),
            flag: A.xBc.VIEW_CHANNEL
        },
        [A.xBc.MANAGE_CHANNELS.toString()]: {
            title: n === A.rbe.GUILD_CATEGORY ? _.intl.string(_.t["9qLtWs"]) : _.intl.string(_.t.nAw15L),
            description: (() => {
                switch (n) {
                    case A.rbe.GUILD_CATEGORY:
                        return _.t.KJ2JnG;
        ...
        [A.xBc.MANAGE_WEBHOOKS.toString()]: {
            ...
            description: n === A.rbe.GUILD_CATEGORY ? _.t["K5+ZZ7"] : _.t.CYBZry,
        ...
        [A.xBc.SEND_MESSAGES.toString()]: {
            title: A.kvI.GUILD_THREADS_ONLY.has(n) ? _.intl.string(_.t.nJwAHX) : n === A.rbe.GUILD_CATEGORY ? _.intl.string(_.t.S1VOwd) : _.intl.string(_.t.T32rkC),
            description: (() => {
                switch (n) {
                    case A.rbe.GUILD_CATEGORY:
                        return _.t.IjeLuu;
                    case A.rbe.GUILD_FORUM:
                        return i?.createPostsDisabled && !t.isMediaChannel() ? E.A.getForumChannelPermissionText() : _.t.LG9VAi;
        ...
        [A.xBc.EMBED_LINKS.toString()]: {
            ...
            description: n === A.rbe.GUILD_CATEGORY ? _.t["7zlUay"] : _.t.XFFhA0,
            flag: A.xBc.EMBED_LINKS
        },
        [A.xBc.ATTACH_FILES.toString()]: {
            title: _.intl.string(_.t["3AS4UM"]),
            description: n === A.rbe.GUILD_CATEGORY ? _.t.XREf9l : _.t.WK9r7F,
        ...
        [A.xBc.USE_EXTERNAL_EMOJIS.toString()]: {
            ...
            description: n === A.rbe.GUILD_CATEGORY ? _.t.mWAbK4 : _.t.Qc5vOr,
            flag: A.xBc.USE_EXTERNAL_EMOJIS
        },
        [A.xBc.USE_EXTERNAL_STICKERS.toString()]: {
            title: _.intl.string(_.t.ERNhYf),
            description: n === A.rbe.GUILD_CATEGORY ? _.t["39whJ4"] : _.t.VF4fZZ,
            flag: A.xBc.USE_EXTERNAL_STICKERS
        },
        [A.xBc.MENTION_EVERYONE.toString()]: {
            title: n === A.rbe.GUILD_STAGE_VOICE ? _.intl.string(_.t.VDUAHO) : _.intl.string(_.t.Y78KGC),
            description: n === A.rbe.GUILD_CATEGORY ? _.t["HOhg/B"] : n === A.rbe.GUILD_STAGE_VOICE ? _.t.rZn1oO : _.t["6IUSdt"],
        ...
        [A.xBc.PIN_MESSAGES.toString()]: {
            ...
            description: n === A.rbe.GUILD_CATEGORY ? _.t.gmbD87 : _.t["0l2EjL"],
            flag: A.xBc.PIN_MESSAGES
        },
        [A.xBc.BYPASS_SLOWMODE.toString()]: {
            title: _.intl.string(_.t.kqcjeV),
            description: n === A.rbe.GUILD_CATEGORY ? _.t.C4t1Xu : _.t.Ha1xbw,
            flag: A.xBc.BYPASS_SLOWMODE
        },
        [A.xBc.MANAGE_OFFICIAL_MESSAGES.toString()]: {
            title: _.intl.string(_.t.Aj9ruN),
            description: n === A.rbe.GUILD_CATEGORY ? _.t["Pf0e/Q"] : _.t.qEbw4W,
            flag: A.xBc.MANAGE_OFFICIAL_MESSAGES
        },
        [A.xBc.READ_MESSAGE_HISTORY.toString()]: {
            title: A.kvI.GUILD_THREADS_ONLY.has(n) ? _.intl.string(_.t["0RQwtn"]) : _.intl.string(_.t.l9ufaR),
            description: (() => {
                switch (n) {
                    case A.rbe.GUILD_CATEGORY:
                        return _.t["cJRv/g"];
                ...
                switch (n) {
                    case A.rbe.GUILD_CATEGORY:
                        return _.intl.format(_.t["0kBp/0"], {
                            helpCenterArticle: S.A.getArticleURL(A.MVz.SOUNDBOARD)
                        });
                    case A.rbe.GUILD_TEXT:
                    case A.rbe.GUILD_FORUM:
                    case A.rbe.GUILD_MEDIA:
        ...
        [A.xBc.REQUEST_TO_SPEAK.toString()]: {
            ...
            description: n === A.rbe.GUILD_CATEGORY ? _.t.T1lMSl : _.t.uzlYFE,
            flag: A.xBc.REQUEST_TO_SPEAK
        },
        [A.xBc.MANAGE_THREADS.toString()]: {
            title: A.kvI.GUILD_THREADS_ONLY.has(n) ? _.intl.string(_.t.ossiZD) : n === A.rbe.GUILD_CATEGORY ? _.intl.string(_.t.QKe7Q3) : _.intl.string(_.t.kEqgr7),
            description: (() => {
                switch (n) {
                    case A.rbe.GUILD_CATEGORY:
                        return _.t.S31soU;
        ...
        [A.xBc.CREATE_PUBLIC_THREADS.toString()]: {
            ...
            description: n === A.rbe.GUILD_CATEGORY ? _.t["+M1yLj"] : _.t["5SDtGB"],
            flag: A.xBc.CREATE_PUBLIC_THREADS
        },
        [A.xBc.CREATE_PRIVATE_THREADS.toString()]: {
            title: _.intl.string(_.t.QwbTSa),
            description: n === A.rbe.GUILD_CATEGORY ? _.t["hBS/zn"] : _.t.Chg2zd,
            flag: A.xBc.CREATE_PRIVATE_THREADS
        },
        [A.xBc.SEND_MESSAGES_IN_THREADS.toString()]: {
            title: A.kvI.GUILD_THREADS_ONLY.has(n) ? _.intl.string(_.t.fqhqWm) : n === A.rbe.GUILD_CATEGORY ? _.intl.string(_.t["5QlVGy"]) : _.intl.string(_.t.fTE74g),
            description: (() => {
                switch (n) {
                    case A.rbe.GUILD_CATEGORY:
                        return _.t.DlIVcN;
        ...
        [A.xBc.MANAGE_EVENTS.toString()]: {
            ...
            description: n === A.rbe.GUILD_CATEGORY ? _.t.CP2sz4 : _.t["4pO/TY"],
            flag: A.xBc.MANAGE_EVENTS
        },
        [A.xBc.CREATE_EVENTS.toString()]: {
            title: _.intl.string(_.t.qyjZua),
            description: n === A.rbe.GUILD_CATEGORY ? _.t.XpibmC : _.t.sPoBLa,
