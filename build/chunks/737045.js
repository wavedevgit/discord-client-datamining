...
function D(t, e, i) {
    ...
    return {
        ...
        [A.xBc.SEND_MESSAGES.toString()]: {
            title: A.kvI.GUILD_THREADS_ONLY.has(E) ? _.intl.string(_.t.nJwAHX) : E === A.rbe.GUILD_CATEGORY ? _.intl.string(_.t.S1VOwd) : _.intl.string(_.t.T32rkC),
            description: (() => {
                switch (E) {
                    case A.rbe.GUILD_CATEGORY:
                        return _.t.IjeLuu;
                    case A.rbe.GUILD_FORUM:
                        return i?.createPostsDisabled && !t.isMediaChannel() ? n.A.getForumChannelPermissionText() : _.t.LG9VAi;
        ...
        [A.xBc.MENTION_EVERYONE.toString()]: {
            ...
            description: E === A.rbe.GUILD_CATEGORY ? _.t["HOhg/B"] : E === A.rbe.GUILD_STAGE_VOICE ? _.t.rZn1oO : _.t["6IUSdt"],
        ...
        [A.xBc.MANAGE_THREADS.toString()]: {
            title: A.kvI.GUILD_THREADS_ONLY.has(E) ? _.intl.string(_.t.ossiZD) : E === A.rbe.GUILD_CATEGORY ? _.intl.string(_.t.QKe7Q3) : _.intl.string(_.t.kEqgr7),
            description: (() => {
                switch (E) {
                    case A.rbe.GUILD_CATEGORY:
                        return _.t.S31soU;
        ...
        [A.xBc.SEND_MESSAGES_IN_THREADS.toString()]: {
            title: A.kvI.GUILD_THREADS_ONLY.has(E) ? _.intl.string(_.t.fqhqWm) : E === A.rbe.GUILD_CATEGORY ? _.intl.string(_.t["5QlVGy"]) : _.intl.string(_.t.fTE74g),
            description: (() => {
                switch (E) {
                    case A.rbe.GUILD_CATEGORY:
                        return _.t.DlIVcN;
