/** chunk id: 348788, original params: e,a,t (module,exports,require) **/
t.d(a, {
    E: () => g
});
var r = t(457312),
...
function g(e, a, t) {
    ...
    let k = a.isCellUnavailable(f),
        x = !b && !k,
        E = a.isValueInvalid && !!("highlightedRange" in a ? !a.anchorDate && a.highlightedRange && f.compare(a.highlightedRange.start) >= 0 && 0 >= f.compare(a.highlightedRange.end) : a.value && (0, i.ro)(a.value, f));
    E && (P = !0), f = (0, l.k)(f, i.NV);
    let S = (0, p.useMemo)(() => f.toDate(a.timeZone), [f, a.timeZone]),
        V = (0, i.cK)(f, a.timeZone),
        F = (0, p.useMemo)(() => {
            let e = "";
            return "highlightedRange" in a && a.value && !a.anchorDate && ((0, i.ro)(f, a.value.start) || (0, i.ro)(f, a.value.end)) && (e = R + ", "), e += w.format(S), V ? e = $.format(P ? "todayDateSelected" : "todayDate", {
                date: e
            }) : P && (e = $.format("dateSelected", {
                date: e
            })), a.minValue && (0, i.ro)(f, a.minValue) ? e += ", " + $.format("minimumDate") : a.maxValue && (0, i.ro)(f, a.maxValue) && (e += ", " + $.format("maximumDate")), e
        }, [w, S, $, P, V, f, a, R]),
        B = "";
    "anchorDate" in a && C && !a.isReadOnly && x && (B = a.anchorDate ? $.format("finishRangeSelectionPrompt") : $.format("startRangeSelectionPrompt"));
    let M = (0, o.I)(B),
        I = (0, p.useRef)(!1),
        T = (0, p.useRef)(!1),
        O = (0, p.useRef)(void 0),
        {
                ...
                if ("highlightedRange" in a && !a.anchorDate && ("mouse" === e.pointerType || "touch" === e.pointerType)) {
                    if (a.highlightedRange && !E) {
                        if ((0, i.ro)(f, a.highlightedRange.start)) {
                            a.setAnchorDate(a.highlightedRange.end), a.setFocusedDate(f), a.setDragging(!0), T.current = !0;
                            return
                        } else if ((0, i.ro)(f, a.highlightedRange.end)) {
                            a.setAnchorDate(a.highlightedRange.start), a.setFocusedDate(f), a.setDragging(!0), T.current = !0;
                            return
                        }
                    }
                    let t = () => {
            ...
            onPressUp(e) {
                if (!a.isReadOnly && ("anchorDate" in a && O.current && (a.selectDate(f), a.setFocusedDate(f)), "anchorDate" in a))
                    if (T.current) a.setAnchorDate(f);
                    else if (a.anchorDate && !I.current) a.selectDate(f), a.setFocusedDate(f);
                else if ("keyboard" !== e.pointerType || a.anchorDate) "virtual" === e.pointerType && (a.selectDate(f), a.setFocusedDate(f));
                else {
                    a.selectDate(f);
                    let e = f.add({
                        days: 1
                    });
                    a.isInvalid(e) && (e = f.subtract({
                        days: 1
                    })), a.isInvalid(e) || a.setFocusedDate(e)
                }
            }
        });
    b || (v = (0, i.ro)(f, a.focusedDate) ? 0 : -1), (0, p.useEffect)(() => {
        C && t.current && ((0, u.e)(t.current), "pointer" !== (0, h.ME)() && document.activeElement === t.current && (0, s.o)(t.current, {
            containingElement: (0, d.m)(t.current)
        }))
    }, [C, t]);
    let z = (0, D.i)({
            day: "numeric",
