...
function g(e, a, t) {
    ...
    let x = a.isCellUnavailable(v),
        C = !b && !x,
        E = a.isValueInvalid && !!("highlightedRange" in a ? !a.anchorDate && a.highlightedRange && v.compare(a.highlightedRange.start) >= 0 && 0 >= v.compare(a.highlightedRange.end) : a.value && (0, i.ro)(a.value, v));
    E && (P = !0), v = (0, o.k)(v, i.NV);
    let S = (0, p.useMemo)(() => v.toDate(a.timeZone), [v, a.timeZone]),
        F = (0, i.cK)(v, a.timeZone),
        B = (0, p.useMemo)(() => {
            let e = "";
            return "highlightedRange" in a && a.value && !a.anchorDate && ((0, i.ro)(v, a.value.start) || (0, i.ro)(v, a.value.end)) && (e = $ + ", "), e += R.format(S), F ? e = w.format(P ? "todayDateSelected" : "todayDate", {
                date: e
            }) : P && (e = w.format("dateSelected", {
                date: e
            })), a.minValue && (0, i.ro)(v, a.minValue) ? e += ", " + w.format("minimumDate") : a.maxValue && (0, i.ro)(v, a.maxValue) && (e += ", " + w.format("maximumDate")), e
        }, [R, S, w, P, F, v, a, $]),
        V = "";
    "anchorDate" in a && k && !a.isReadOnly && C && (V = a.anchorDate ? w.format("finishRangeSelectionPrompt") : w.format("startRangeSelectionPrompt"));
    let M = (0, u.I)(V),
        I = (0, p.useRef)(!1),
        T = (0, p.useRef)(!1),
        O = (0, p.useRef)(void 0),
        {
                ...
                if ("highlightedRange" in a && !a.anchorDate && ("mouse" === e.pointerType || "touch" === e.pointerType)) {
                    if (a.highlightedRange && !E) {
                        if ((0, i.ro)(v, a.highlightedRange.start)) {
                            a.setAnchorDate(a.highlightedRange.end), a.setFocusedDate(v), a.setDragging(!0), T.current = !0;
                            return
                        } else if ((0, i.ro)(v, a.highlightedRange.end)) {
                            a.setAnchorDate(a.highlightedRange.start), a.setFocusedDate(v), a.setDragging(!0), T.current = !0;
                            return
                        }
                    }
                    let t = () => {
            ...
            onPressUp(e) {
                if (!a.isReadOnly && ("anchorDate" in a && O.current && (a.selectDate(v), a.setFocusedDate(v)), "anchorDate" in a))
    ...
    b || (f = (0, i.ro)(v, a.focusedDate) ? 0 : -1), (0, p.useEffect)(() => {
        k && t.current && ((0, l.e)(t.current), "pointer" !== (0, h.ME)() && document.activeElement === t.current && (0, s.o)(t.current, {
