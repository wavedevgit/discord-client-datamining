...
function m(e) {
    ...
    } = e, _ = (0, a.ZP)(n), h = (0, r.rdh)(l.A.colors.EXPRESSIVE_GRADIENT_NITRO_PINK_START, d.NJ8.DARK).hex(), p = (0, r.rdh)(l.A.colors.EXPRESSIVE_GRADIENT_TENURE_BADGE_DIAMOND_END, d.NJ8.DARK).hex(), g = (0, r.rdh)(l.A.colors.BACKGROUND_BASE_LOWEST, d.NJ8.DARK).hex(), A = (0, s.cb)(h, .5), x = (0, s.cb)(p, .5);
