/** chunk id: 629802 params = (module,exports,require) **/
...
let f = (0, i(795521).u)(async () => {
    let t = await i.e("45082").then(i.bind(i, 145025)),
        e = await t.default();
    a = e.cwrap("lottie_create", "number", ["string"]), s = e._lottie_destroy, h = e._lottie_draw_into_bgra, o = e._lottie_draw_into_rgba, l = e._lottie_frame_count, c = e._lottie_frame_rate, m = e._memory_create, n = e, r = m(409600)
});
