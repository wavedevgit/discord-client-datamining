    ...
    l.useEffect(() => {
        let l = t(),
            r = new a.ru(e, () => {
                let e = t(),
                    a = n(l, e);
                null == a || I.A.isSoundDisabled(a) || (0, u.Ak)(a, i ?? .4), l = e
            });
...
function y() {
    return v([E.Ay, C.A], () => ({
        ...
        if (a && (n || e.audioPermissionReady) && e.selfMute !== i) return r ? void E.Ay.notifyMuteUnmuteSoundWasSkipped() : i ? "mute" : "unmute"
    }), null
}

function O() {
    return v([E.Ay, C.A], () => ({
        videoEnabled: E.Ay.isVideoEnabled(),
        inVoiceChannel: null != C.A.getVoiceChannelId()
    }), (e, t) => {
        let {
            videoEnabled: n,
...
function L() {
    return v([g.A, f.A, C.A, d.default], () => {
        ...
        return {
            channelType: t,
            guildId: n,
            connected: l === b.S7L.RTC_CONNECTED,
            connectHasStarted: !i && l !== b.S7L.DISCONNECTED || l === b.S7L.RTC_CONNECTED,
        ...
        if (d && !i) {
            if (a || r || null != s && h.Do.has(s)) return;
            return "disconnect"
        }
    }), null
}
...
function R() {
    return v([T.A], () => T.A.isCurrentUserPTTActive(), (e, t) => {
        if (e !== t) {
            let e = E.Ay.isSelfMute();
            if (E.Ay.getMode() === b.TBI.PUSH_TO_TALK && !e) return t ? "ptt_start" : "ptt_stop"
        }
    }), null
}

function P() {
    return v([E.Ay], () => E.Ay.isSelfMutedTemporarily(), (e, t) => {
        if (e !== t) {
            let e = E.Ay.isSelfMute();
            if (E.Ay.getMode() === b.TBI.VOICE_ACTIVITY && !e) return t ? "ptt_stop" : "ptt_start"
        }
    }), null
}

function D() {
    return v([T.A], () => T.A.isCurrentUserPrioritySpeaker(), (e, t) => {
        if (e !== t) {
            let e = E.Ay.isSelfMute();
            if (E.Ay.getMode() === b.TBI.VOICE_ACTIVITY && !e) return t ? "ptt_start" : "ptt_stop"
        }
    }), null
}

function j() {
    return v([N.A], () => N.A.userHasBeenMovedVersion, (e, t) => {
...
function w() {
    return v([C.A, _.A, m.default, N.A, g.A], () => {
        let e, t, n = C.A.getVoiceChannelId(),
            i = m.default.getId(),
            l = [],
            a = null,
            r = 0,
        ...
        if (null != n) {
            ...
            null != i && (e = i.type, t = S.Ay.countVoiceStatesForChannel(i.id) - !!N.A.isInChannel(i.id), l = _.A.getAllApplicationStreamsForChannel(i.id).map(e => e.ownerId))
        }
        let o = null;
        return o = 1 === s.length ? s[0] : _.A.getCurrentUserActiveStream(), o?.state === b.XYD.CONNECTING && (o = null), null != o && (a = (0, c._z)(o), r = _.A.getViewerIds(a).filter(e => e !== i).length), {
            channelType: e,
            voiceChannelId: n,
...
function U() {
    return v([C.A, r.Ay, o.A, m.default], () => {
        let e = C.A.getVoiceChannelId(),
            t = C.A.getChannelId(),
            n = r.Ay.getConnectedActivityLocation(),
            i = (0, s.H)(n),
            l = m.default.getId(),
            a = (0, x.Vq)(t) ? r.Ay.getEmbeddedActivitiesForChannel(t) : r.Am,
            d = (0, x.Vq)(e) ? r.Ay.getEmbeddedActivitiesForChannel(e) : r.Am,
            c = (0, x.Vq)(i) ? r.Ay.getEmbeddedActivitiesForChannel(i) : r.Am,
            u = (0, x.Vq)(n) ? r.Ay.getSelfEmbeddedActivityForLocation(n) : null;
        return {
        ...
        if ((0, x.Vq)(l)) {
            ...
            e.voiceChannelActivities.length < d.length && (0, x.Vq)(e.voiceChannelId) && (n = "activity_launch"), void 0 === i && (0, x.Vq)(t) && (n = "activity_end"), void 0 === t && (0, x.Vq)(i) && i.userIds.size > 1 && (n = "activity_user_join"), (0, x.Vq)(i) && (0, x.Vq)(t) && (i.userIds.size > t.userIds.size && (n = "activity_user_join"), i.userIds.size < t.userIds.size && (n = "activity_user_left"))
        }
        if (!u) {
            ...
            null == o && (0, x.Vq)(t) && (n = "activity_end"), (0, x.Vq)(o) && (0, x.Vq)(t) && (o.userIds.size > t.userIds.size && (n = "activity_user_join"), o.userIds.size < t.userIds.size && (n = "activity_user_left"))
        }
...
function G() {
    return (0, i.jsxs)(i.Fragment, {
        children: [(0, i.jsx)(y, {}), (0, i.jsx)(O, {}), (0, i.jsx)(L, {}), (0, i.jsx)(R, {}), (0, i.jsx)(P, {}), (0, i.jsx)(j, {}), (0, i.jsx)(w, {}), (0, i.jsx)(M, {}), (0, i.jsx)(U, {}), (0, i.jsx)(D, {})]
    })
}