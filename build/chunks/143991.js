    ...
    r.useEffect(() => {
        let r = t(),
            a = new l.ru(e, () => {
                let e = t(),
                    a = n(r, e);
                null == a || T.A.isSoundDisabled(a) || (0, h.Ak)(a, i ?? .4), r = e
            });
...
function R() {
    return L([C.Ay, S.A], () => ({
        ...
        if (a && (n || e.audioPermissionReady) && e.selfMute !== i) return l ? void C.Ay.notifyMuteUnmuteSoundWasSkipped() : i ? "mute" : "unmute"
    }), null
}
...
function M() {
    return L([v.A], () => v.A.isCurrentUserPTTActive(), (e, t) => {
        if (e !== t) {
...
function w() {
    return L([v.A], () => v.A.isCurrentUserPrioritySpeaker(), (e, t) => {
        if (e !== t) {
            let e = C.Ay.isSelfMute();
...
function U() {
    return L([x.A], () => x.A.userHasBeenMovedVersion, (e, t) => {
...
function k() {
    return L([S.A, g.A, E.default, x.A, I.A], () => {
        ...
        if (null != n) {
            ...
            null != i && (e = i.type, t = y.Ay.countVoiceStatesForChannel(i.id) - !!x.A.isInChannel(i.id), r = g.A.getAllApplicationStreamsForChannel(i.id).map(e => e.ownerId))
        }
        let o = null;
        return o = 1 === s.length ? s[0] : g.A.getCurrentUserActiveStream(), o?.state === O.XYD.CONNECTING && (o = null), null != o && (a = (0, u._z)(o), l = g.A.getViewerIds(a).filter(e => e !== i).length), {
            channelType: e,
            voiceChannelId: n,
        ...
        if (null != e.voiceChannelUserCount && null != r && e.voiceChannelUserCount <= 25 && r > e.voiceChannelUserCount) return "user_join";
        if (null != e.voiceChannelUserCount && null != r && e.voiceChannelUserCount <= 25 && r < e.voiceChannelUserCount) return "user_leave";
...
function V() {
    return L([S.A, s.Ay, d.A, E.default], () => {
        let e = S.A.getVoiceChannelId(),
            ...
            i = (0, o.H)(n),
            r = E.default.getId(),
            a = (0, b.Vq)(t) ? s.Ay.getEmbeddedActivitiesForChannel(t) : s.Am,
...
function B() {
    return L([A.A, S.A], () => ({
        ...
        let {
            hangStatus: n,
            customHangStatus: i,
            gameActivityHangStatus: r
        } = t;
        if (e.inVoice && (null != n && n !== e.hangStatus || null != i && (i.status !== e.customHangStatus?.status || !(0, a.isEqual)(i.emoji, e.customHangStatus?.emoji)) || null != r && e.gameActivityHangStatus !== r)) return "hang_status_select"
    }, .15), null
}
