    ...
    l.useEffect(() => {
        let l = t(),
            r = new a.ru(e, () => {
                let e = t(),
                    r = n(l, e);
                null == r || C.A.isSoundDisabled(r) || (0, h.Ak)(r, i ?? .4), l = e
            });
...
function L() {
    return O([f.Ay, S.A], () => ({
        ...
        if (r && (n || e.audioPermissionReady) && e.selfMute !== i) return a ? void f.Ay.notifyMuteUnmuteSoundWasSkipped() : i ? "mute" : "unmute"
    }), null
}
...
function P() {
    return O([E.A, T.A, S.A, c.default], () => {
...
function D() {
    return O([N.A], () => N.A.isCurrentUserPTTActive(), (e, t) => {
        if (e !== t) {
...
function j() {
    return O([f.Ay], () => f.Ay.isSelfMutedTemporarily(), (e, t) => {
        if (e !== t) {
            let e = f.Ay.isSelfMute();
...
function M() {
    return O([N.A], () => N.A.isCurrentUserPrioritySpeaker(), (e, t) => {
        if (e !== t) {
            let e = f.Ay.isSelfMute();
...
function w() {
    return O([x.A], () => x.A.userHasBeenMovedVersion, (e, t) => {
...
function G() {
    return O([S.A, g.A, p.default, x.A, E.A], () => {
        ...
        if (null != n) {
            ...
            null != i && (e = i.type, t = v.Ay.countVoiceStatesForChannel(i.id) - !!x.A.isInChannel(i.id), l = g.A.getAllApplicationStreamsForChannel(i.id).map(e => e.ownerId))
        }
        let o = null;
        return o = 1 === s.length ? s[0] : g.A.getCurrentUserActiveStream(), o?.state === y.XYD.CONNECTING && (o = null), null != o && (r = (0, u._z)(o), a = g.A.getViewerIds(r).filter(e => e !== i).length), {
            channelType: e,
            voiceChannelId: n,
...
function k() {
    return O([S.A, s.Ay, d.A, p.default], () => {
        let e = S.A.getVoiceChannelId(),
            t = S.A.getChannelId(),
...
function B() {
    return (0, i.jsxs)(i.Fragment, {
        children: [(0, i.jsx)(L, {}), (0, i.jsx)(R, {}), (0, i.jsx)(P, {}), (0, i.jsx)(D, {}), (0, i.jsx)(j, {}), (0, i.jsx)(w, {}), (0, i.jsx)(G, {}), (0, i.jsx)(U, {}), (0, i.jsx)(k, {}), (0, i.jsx)(M, {}), (0, i.jsx)(V, {})]
    })
}