...
function D() {
    return L([I.A, N.A, S.A, c.default], () => {
        ...
        if (d && !i) {
            if (a || l || null != s && g.Do.has(s)) return;
            return "disconnect"
        }
    }), null
}
...
function k() {
    return L([S.A, p.A, E.default, v.A, I.A], () => {
        ...
        if (null != n) {
            ...
            null != i && (e = i.type, t = b.Ay.countVoiceStatesForChannel(i.id) - !!v.A.isInChannel(i.id), r = p.A.getAllApplicationStreamsForChannel(i.id).map(e => e.ownerId))
        }
        let o = null;
        return o = 1 === s.length ? s[0] : p.A.getCurrentUserActiveStream(), o?.state === O.XYD.CONNECTING && (o = null), null != o && (a = (0, u._z)(o), l = p.A.getViewerIds(a).filter(e => e !== i).length), {
            channelType: e,
            voiceChannelId: n,
