...
let X = l.memo(l.forwardRef(function(e, t) {
    ...
    } = (0, V.Sk)(y, b, ey, _), eD = !L.D_.useSetting() && !(0, w.isAndroidWeb)() && null != window.ResizeObserver, eO = !eD || !b.commands?.enabled || !j || "/" !== a, eP = (0, R.A)(), {
        fontSize: ek
    } = (0, u.cf)([f.A], () => ({
    ...
    } = (0, V.uW)(b, y.id), e3 = (0, V.NO)(eT), e7 = (0, V.Vu)(eH, b, eT), e9 = (0, V.HG)(eT), e5 = (0, V.C)({
        editorRef: eT,
        disabled: eR,
        textValue: a,
        channelId: y.id,
