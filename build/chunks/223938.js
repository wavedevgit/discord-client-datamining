...
let X = l.memo(l.forwardRef(function(e, t) {
    ...
    let {
        ...
        activeCommand: b.commands?.enabled ? C.A.getActiveCommand(v.id) : null,
        activeCommandSection: b.commands?.enabled ? C.A.getActiveCommandSection(v.id) : null
    })), {
        isLurking: eb,
        isPendingMember: ej,
        disabled: eR,
    ...
    }, [ei, ef, e_, v.id, ex, eE, eU]), {
        submit: eB,
        handleSubmit: eV
    } = (0, V.Zx)(eH, b, eT, ey, v.id), {
        autocompleteRef: eK,
        handleMaybeShowAutocomplete: eW,
        handleHideAutocomplete: ez
    } = (0, V.v7)(), eY = l.useCallback(() => ey?.current?.hide(), []), {
        editorHeight: eq,
        handleResize: eJ
    } = (0, V.ck)(U), {
        handleTab: e$,
