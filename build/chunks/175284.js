/** chunk id: 175284 params = (module,exports,require) **/
"use strict";
n.d(t, {
    A: () => _
});
...
function p(e) {
    ...
    return (0, i.jsxs)(i.Fragment, {
        children: [(0, i.jsx)(c.A, {
            ...
            color: "text-default",
            variant: "text-sm/normal",
            children: x.intl.format(x.t.xkC3Yf, {
                articleURL: d.A.getArticleURL(g.MVz.PERMISSIONS_TUTORIAL)
            })
        }), (0, i.jsx)("div", {
            className: h.kA,
            children: (0, i.jsxs)("div", {
                ...
                children: [(0, i.jsx)("div", {
                    ...
                    variant: "text-sm/normal",
                    children: x.intl.format(x.t["38N3Vz"], {
                        numRoles: String(s.length)
                    })
                }), (0, i.jsx)(a.Text, {
...
function A(e) {
    let {
        ...
        query: n,
        setQuery: l
    } = e, [r, d] = s.useState(!1), c = s.useCallback(e => {
        l(e)
    }, [l]), u = s.useCallback(() => {
        l("")
    }, [l]), m = async () => {
