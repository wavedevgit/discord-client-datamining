/** chunk id: 151080, original params: t,e,i (module,exports,require) **/
i.d(e, {
    default: () => k
});
var n = i(627968),
...
function k(t) {
    let {
        ...
        k(), d.A.showAgeVerificationGetStartedModal({
            entryPoint: u.q1.ACCOUNT_AGE_GROUP
        })
    }, [k]), b = a.useCallback(() => {
        k(), (0, r.mMO)(async () => {
            let {
                default: t
            } = await i.e("956").then(i.bind(i, 253463));
            return e => (0, n.jsx)(t, {
                ...e
            })
        })
    ...
    return (0, n.jsx)(s.Modal, {
        ...
        subtitle: f.intl.format(A.default["1DN29p"], {
            handleOnHelpUrlHook: h
        }),
        actions: [],
        trackingProps: {
            impression: {
                impressionName: l.ImpressionNames.USER_AGE_VERIFICATION_RESET_OPTIONS
            }
        },
        children: (0, n.jsxs)(s.BJc, {
            direction: "vertical",
            gap: 8,
            children: [(0, n.jsx)(c.PQ, {
                variant: "clickable",
