...
function G(e) {
    let {
        ...
        eQ(null), ev(e)
    }, []), [eg, eS] = l.useState(!1), [eA, eC] = l.useState(!0), [e_, eb] = l.useState(!1), [ey, eT] = l.useState([]), [eN, eD] = l.useState(v.A.getEffectiveConnectionSpeed()), [eR, ej] = l.useState(0), [eL, eM] = l.useState(0), [eI, ew] = l.useState(!1), [ek, eO] = l.useState(!1), [eP, eQ] = l.useState(null), eU = l.useRef(!0), eV = l.useRef(null), eB = l.useRef(null), eF = (0, A.Kr)(e => e.videoProgress[z.id] ?? A.yc, u.x), eG = (0, A.Kr)(e => e.setVideoProgress), eK = (0, A.Kr)(e => e.muted), e$ = (0, A.Kr)(e => e.volume), eY = (0, c.bG)([f.A], () => f.A.useReducedMotion), eH = (0, l.useRef)(null), ez = (0, l.useRef)(null), eW = l.useRef(!0), eq = z.userStatus?.completedAt != null, eX = l.useMemo(() => z.config.features.includes(Q.Li.FULL_EPISODE_VIDEO_QUEST), [z.config.features]), eJ = l.useRef(!1), [eZ, e0] = l.useState(null), [e1, e6] = l.useState(!1), [e7, e2] = l.useState(!1), [e9, e4] = l.useState(!1), [e8, e3] = l.useState(null), e5 = eq ? eH.current?.duration ?? 0 : Math.max(eF.maxTimestampSec, eE.progressSeconds), te = l.useMemo(() => (0, C.L)({
        quest: z,
    ...
    let tk = !tR && (ep || ed || eu === R.Q6.ENDED),
        ...
        tP = () => {
            ...
            te.info(`[QV] | handleSeekBackIncrement | newTime: ${e}`), tU(e), eu === R.Q6.ENDED && tN(R.Q6.PAUSED), tE(S.uF.VIDEO_MODAL, b.Cy.SEEK_BACKWARD)
        },
        tQ = () => {
            if (null == eH.current || !t1) return;
            let e = Math.min(eH.current.currentTime + 10, e5);
            te.info(`[QV] | handleSeekForwardIncrement | newTime: ${e}`), tU(e), eu !== R.Q6.ENDED && e >= eH.current.duration && tN(R.Q6.ENDED), tE(S.uF.VIDEO_MODAL, b.Cy.SEEK_FORWARD)
        };
    l.useEffect(() => {
        let e = eH.current;
        return () => {
    ...
    return (0, r.jsx)(m.DUT, {
        ...
        children: (0, r.jsxs)("div", {
            ...
            children: [tJ && (0, r.jsx)(N.A, {
                ...
                onLoadedMetadata: e => {
                    null != eH.current && (te.info(`[QV] | handleLoadedMetadata | videoAssetId: ${ti}`), e6(!0), ti !== _.fY.VIDEO_PLAYER_VIDEO_HLS && tU(tt), eK ? eH.current.volume = 0 : eH.current.volume = e$)
                },
                onLoadStart: () => {
                ...
                children: [null != t0 && (0, r.jsx)("track", {
                    ...
                    srcLang: "en",
                    default: !0
                }), null != ts && ti !== _.fY.VIDEO_PLAYER_VIDEO_HLS && null != ts.mimetype && (0, r.jsx)("source", {
                ...
                children: [(0, r.jsx)(o.animated.div, {
                    ...
                    children: (0, r.jsx)(I.A, {
                        ...
                        handleTranscriptBtnClick: () => {
                            et(!ee), tE(S.uF.VIDEO_MODAL, ee ? b.Cy.TRANSCRIPT_DISABLE : b.Cy.TRANSCRIPT_ENABLE)
                        },
                        handleCaptionBtnClick: () => {
                            er(!en), tE(S.uF.VIDEO_MODAL, en ? b.Cy.CLOSED_CAPTIONING_DISABLE : b.Cy.CLOSED_CAPTIONING_ENABLE)
                        },
