...
function Y(e) {
    let {
    ...
    } = s.useContext(b.a), et = (0, x.Kr)(e => e.transcriptEnabled), en = (0, x.Kr)(e => e.setTranscriptEnabled), er = (0, x.Kr)(e => e.captionEnabled), es = (0, x.Kr)(e => e.setCaptionEnabled), {
        focused: ei,
        focusedChanged: ea
    } = (0, S.A7)(), {
        visible: el,
        ...
        ej(null), ev(e)
    }, []), [eg, eA] = s.useState(!1), [eC, ex] = s.useState(!0), [eD, eT] = s.useState(!1), [eI, ey] = s.useState([]), [eR, eb] = s.useState(v.A.getEffectiveConnectionSpeed()), [eN, eO] = s.useState(0), [eL, ek] = s.useState(0), [eM, eP] = s.useState(!1), [ew, eV] = s.useState(!1), [eQ, ej] = s.useState(null), eU = s.useRef(!0), eB = s.useRef(null), eF = s.useRef(null), eY = (0, x.Kr)(e => e.videoProgress[W.id] ?? x.yc, o.x), eH = (0, x.Kr)(e => e.setVideoProgress), e$ = (0, x.Kr)(e => e.muted), eG = (0, x.Kr)(e => e.setMuted), eK = (0, x.Kr)(e => e.volume), eq = (0, x.Kr)(e => e.setVolume), eW = (0, c.bG)([f.A], () => f.A.useReducedMotion), ez = (0, s.useRef)(null), eZ = (0, s.useRef)(null), eX = (0, s.useRef)(null), eJ = s.useRef(!0), e0 = W.userStatus?.completedAt != null, e1 = s.useMemo(() => W.config.features.includes(Q.Li.FULL_EPISODE_VIDEO_QUEST), [W.config.features]), e6 = s.useRef(!1), [e7, e4] = s.useState(null), [e9, e5] = s.useState(!1), [e8, e3] = s.useState(null), e2 = Math.max(eY.maxTimestampSec, ep.progressSeconds), te = e0 ? ez.current?.duration ?? 0 : (0, R.vd)(e2, eY.duration), tt = s.useMemo(() => (0, I.L)({
        quest: W,
    ...
    (0, _.u5)(() => {
        eJ.current && (eJ.current = !1, eb(v.A.getEffectiveConnectionSpeed()), e0 && eY.timestampSec >= eY.duration && eH(W.id, 0, eY.duration))
    });
    let {
        videoAsset: ta,
        videoAssetType: tl,
    ...
    let tD = s.useRef(null),
        tT = s.useCallback(() => {
            clearTimeout(tD.current), e5(!0), tD.current = setTimeout(() => {
                e5(!1)
            }, 1e3)
        }, []);
    s.useEffect(() => () => {
    ...
    let tL = s.useCallback(e => {
        if (tt.info(`[QV] | updatePlayerState | playerState: ${e}`), ty(e, null), ed(e), null != ez.current) switch (e) {
            case L.Q6.PLAYING:
    ...
    let tk = s.useCallback(e => {
        e0 || W.userStatus?.enrolledAt == null || (tt.info(`[QV] sendServerProgressUpdate: ${e}`), (0, R.zv)(W, e)), tE()
    }, [e0, W, tt, tE]);
    s.useEffect(() => {
        H !== m.ip4.HIDDEN && H !== m.ip4.EXITING && H !== m.ip4.EXITED && (null == H || !eu || el || e0) && (!ea || ei || e0) || null == ez.current || ec !== L.Q6.PLAYING || (tt.info(`[QV] | Pausing video | playerState: ${ec}, parentTransitionState: ${H}, visible: ${el}, focused: ${ei}, isQuestCompleted: ${e0}`), tL(L.Q6.PAUSED), e0 ? e1 && e4(C.Yg.ANOTHER_MODAL_OPENED) : e4(C.Yg.LOST_FOCUS))
    }, [H, ei, ea, el, eu, ec, e0, tL, tk, tt, e1]), s.useEffect(() => {
        e7 === C.Yg.ANOTHER_MODAL_OPENED && H === m.ip4.ENTERED && ec === L.Q6.PAUSED && e1 && ei && (tt.info("[QV] | Resuming full episode video after modal re-entered"), tL(L.Q6.PLAYING))
    }, [H, ec, tt, tL, e7, e1, ei]);
    let [tM, tP] = s.useState(!1), tw = s.useRef(null), tV = s.useRef(performance.now()), tQ = s.useCallback(() => {
    ...
    s.useEffect(() => {
        ...
        if (null == e) return;
        let t = () => {
            null != tu.current && tu.current.mainForwardBufferInfo?.len === 0 && tu.current.trigger(l.sV.BUFFER_FLUSHING, {
    ...
    let tX = s.useCallback(e => {
            tt.info(`[QV] | logVideoError: errorType: ${e}, videoProgress: ${ez.current?.currentTime}, videoAssetId: ${tl}, connectionSpeed: ${eR}`), tC(e)
        }, [eR, tC, ez, tl, tt]),
        tJ = s.useRef(!1);
    s.useEffect(() => {
    ...
    let t0 = e => {
        tt.info(`[QV] | handleCanPlay: playerState: ${ec}`), null != ez.current && ec === L.Q6.PLAYING && (tt.info("[QV] | handleCanPlay: did NOT early return"), eC && (tt.info(`[QV] | handleCanPlay: loadingFirstChunk: ${eC}`), ex(!1)), eD && (tt.info(`[QV] | handleCanPlay: waitingForChunk: ${eD}`), tv(null != eF.current ? performance.now() - eF.current : null), eT(!1)), tt.info("[QV] | handleCanPlay: updating player state to playing"), tL(L.Q6.PLAYING))
    };
    s.useEffect(() => {
        if (!eg) return;
        let e = setTimeout(() => {
    ...
    s.useEffect(() => (t9({
        ...
        controlBarAnimSpring: tU || eM ? 1 : 0,
        immediate: eW
    }), () => {
        t1.stop()
    }), [tU, t6, eW, eM, t1]);
            ...
            children: [t5 && (0, r.jsx)(N.A, {
                ...
                onTimeUpdate: e => {
                    ...
                    if (ez.current.currentTime >= eN || r) {
                        var s;
                        tt.info(`[QV] | handleTimeUpdate: capturing server time update: currentTime: ${ez.current.currentTime}`), (s = ez.current.currentTime) >= t && (e6.current = !0), eO(s + Q.aA + Math.random() * Q.A6), tk(s)
                    }
                    ez.current.currentTime >= eL && (ek(ez.current.currentTime + 1), (0, A.Gn)(W.id, ep.taskType, ez.current.currentTime), n(ez.current.currentTime)), eH(W.id, ez.current.currentTime, ez.current.duration), eh(ez.current.currentTime / ez.current.duration * 100)
                },
                onEnded: e => {
                    null != ez.current && (tk(ez.current.duration + 1), tt.info(`[QV] | handleEnded: sending progress update: ${ez.current.duration+1}`), eH(W.id, ez.current.duration, ez.current.duration)), tL(L.Q6.ENDED), eT(!1)
                },
                onLoadedData: e => {
                ...
                onWaiting: e => {
                    eF.current = performance.now(), tt.info(`[QV] | handleWaitingForData: bufferingStartTime: ${eF.current}`), tS(), eT(!0)
                },
                onProgress: e => {
                    if (null == ez.current) return;
                ...
                children: [null != t3 && (0, r.jsx)("track", {
                    ...
                    srcLang: "en",
                    default: !0
                }), null != ta && tl !== D.fY.VIDEO_PLAYER_VIDEO_HLS && null != ta.mimetype && (0, r.jsx)("source", {
                    onError: () => tX(L.SB.SOURCE_ERROR),
                    src: ta.url,
                    type: ta.mimetype
                })]
            }), (eC || eD) && ec === L.Q6.PLAYING && null != ta && (0, r.jsx)("span", {
                className: B.S,
                ...
                children: [(0, r.jsx)(O.A, {}), (0, r.jsx)(m.K0, {
                ...
                children: [(0, r.jsx)(m.DUT, {
                    ...
                    style: {
                        marginBottom: (0, u.to)([t1, t4], (e, t) => `${e*ti[tr]+t}px`)
                    },
                ...
                children: ec === L.Q6.PLAYING ? (0, r.jsx)(m.udU, {
                    className: B.PK
                }) : (0, r.jsx)(m.E$n, {
                    className: B.PK
                })
                ...
                children: [(0, r.jsx)(u.animated.div, {
                    ...
                    children: (0, r.jsx)(S.zZ, {
                        ...
                        handleTranscriptBtnClick: () => {
                            en(!et), tp(C.uF.VIDEO_MODAL, et ? T.Cy.TRANSCRIPT_DISABLE : T.Cy.TRANSCRIPT_ENABLE)
                        },
                        handleCaptionBtnClick: () => {
                            es(!er), tp(C.uF.VIDEO_MODAL, er ? T.Cy.CLOSED_CAPTIONING_DISABLE : T.Cy.CLOSED_CAPTIONING_ENABLE)
                        },
                        handleFullScreenBtnClick: () => {
                            let e = !X;
                            tt.info(`[QV] | handleFullScreenButtonClick | shouldBeEnabled: ${e}`);
                            let t = (0, g.qf)(ez.current?.parentNode, ez.current);
                            e && null != t ? ((0, g.tl)(t), t.addEventListener(g.Wb, tB), tA(!0), ts(L.oA.LG)) : e || null == t || (t.removeEventListener(g.Wb, tB), tA(!1), (0, g.sP)(t), ts(L.oA.MD)), J(e)
                        },
