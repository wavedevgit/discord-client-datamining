...
function U(e) {
    ...
    let P = (0, d.bG)([N.A], () => N.A.getDetectableIdsToApplicationIds()),
        k = (0, S.W)(),
        [w] = (0, d.bG)([h.A], () => null != U.id ? [h.A.getParticipants(U.id), h.A.getParticipantsVersion(U.id)] : [
            [], 0
        ], [U.id], u.hS),
        [B, V] = (0, d.bG)([E.A], () => {
            let e = new Set,
        ...
        $ = l.useMemo(() => {
            let e = new Set(F),
                ...
                l = t && n;
            return X.map(t => {
                let n = Object.entries(z[t.id] ?? {}).filter(t => {
                        let [n, i] = t;
    ...
    return l.useEffect(() => {
        0 !== Y.length && x.default.track(v.HAw.COMMERCE_SHOP_VC_GIFT_BUTTON_VIEWED, {
            guild_id: U.guild_id,
            channel_id: U.id,
            sku_ids: Y.map(e => e.id)
        })
    }, [U.id, U.guild_id, Y]), (0, i.jsx)(A.A, {
