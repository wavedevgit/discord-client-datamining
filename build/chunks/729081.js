...
function V(e) {
    ...
    let H = (0, u.bG)([v.A], () => v.A.getDetectableIdsToApplicationIds()),
        F = (0, j.W)(),
        [K] = (0, u.bG)([m.A], () => null != h.id ? [m.A.getParticipants(h.id), m.A.getParticipantsVersion(h.id)] : [
            [], 0
        ], [h.id], A.hS),
        [W, Y] = (0, u.bG)([N.A], () => {
            let e = new Set,
                    ...
                    children: (0, i.jsxs)("div", {
                        children: [(0, i.jsx)(d.DZT, {
                            ...
                            children: G.intl.format(G.t["+SqhBF"], {
                                applicationName: Object.values(X).length > 0 ? Object.values(X)[0]?.name ?? G.intl.string(G.t["/1hhto"]) : G.intl.string(G.t["/1hhto"])
                            })
                        })]
                    })
                }), (0, i.jsx)("div", {
