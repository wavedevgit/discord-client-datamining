...
function B(e) {
    ...
    let B = (0, h.bG)([y.A], () => y.A.getStorefrontDetectableGameAndApplicationIds()),
        ...
        ei = s.useMemo(() => {
            let e = new Set(q),
                ...
                s = t && n;
            return en.map(t => {
                let n = Object.entries(Z[t.skuId] ?? {}).filter(t => {
                        let [n, i] = t;
    ...
    return s.useEffect(() => {
        0 !== $.length && S.default.track(D.HAw.COMMERCE_SHOP_VC_GIFT_BUTTON_VIEWED, {
            guild_id: d.guild_id,
            channel_id: d.id,
            sku_ids: $.map(e => e.id)
        })
        ...
        children: (0, i.jsx)(u.lGe, {
            ...
            children: (0, i.jsxs)("div", {
                ...
                children: [(0, i.jsx)("div", {
                    ...
                    children: (0, i.jsxs)("div", {
                        children: [(0, i.jsx)(u.DZT, {
                            ...
                            children: U.intl.format(U.t["+SqhBF"], {
                                applicationName: Object.values(J).length > 0 ? Object.values(J)[0]?.name ?? U.intl.string(U.t["/1hhto"]) : U.intl.string(U.t["/1hhto"])
                            })
                        })]
                    })
                }), (0, i.jsx)("div", {
                    ...
                    children: ee ? (0, i.jsx)(u.y$y, {
                        className: A ? P.Dv : P.Lq
                    }) : ei
                }), (0, i.jsx)(M.A, {
