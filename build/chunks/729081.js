...
function M(e) {
    ...
    let G = (0, d.bG)([u.A], () => u.A.getApplication(v.XR)),
        [U] = (0, d.bG)([A.A], () => null != M.id ? [A.A.getParticipants(M.id), A.A.getParticipantsVersion(M.id)] : [
            [], 0
        ], [M.id], h.hS),
        P = (0, d.yK)([f.A], () => {
            let e = new Set;
            for (let t of U)
                if ((0, j.Xw)(t) || (0, j.Ay)(t)) {
                    for (let n of f.A.getActivities(t.user.id))
                        if (n.application_id === G?.id || G?.linkedGames?.some(e => e.id === n.application_id) === !0) {
                            e.add(t.user.id);
                            break
                        }
        ...
        H = s.useMemo(() => {
            let e = new Set(w),
                ...
                s = t && n;
            return V.map(t => {
                let n = B[t.skuId]?.filter(t => t.reason === I.G.WISHLIST && e.has(t.userId)).map(e => e.userId).filter(C.Vq) ?? [];
                return D ? (0, i.jsx)(b.A, {
                    sku: t.sku,
    ...
    return s.useEffect(() => {
        0 !== V.length && x.default.track(y.HAw.COMMERCE_SHOP_VC_GIFT_BUTTON_VIEWED, {
            guild_id: M.guild_id,
            channel_id: M.id,
            sku_ids: V.map(e => e.skuId)
        })
    }, [M.id, M.guild_id, V]), (0, i.jsx)(m.A, {
        children: (0, i.jsx)(c.lGe, {
            ...
            children: (0, i.jsxs)("div", {
                ...
                children: [(0, i.jsx)("div", {
                    ...
                    children: "loading" === k || 0 === V.length ? (0, i.jsx)(c.y$y, {
                        className: O.Lq
                    }) : H
                }), (0, i.jsx)(T.A, {
