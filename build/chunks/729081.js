...
function w(e) {
    ...
    let w = (0, u.bG)([T.A], () => T.A.getStorefrontDetectableGameAndApplicationIds()),
        k = (0, y.W)(),
        [V] = (0, u.bG)([m.A], () => null != c.id ? [m.A.getParticipants(c.id), m.A.getParticipantsVersion(c.id)] : [
            [], 0
        ], [c.id], A.hS),
        [B, H] = (0, u.bG)([I.A], () => {
            let e = new Set,
    ...
    return s.useEffect(() => {
        0 !== z.length && N.default.track(L.HAw.COMMERCE_SHOP_VC_GIFT_BUTTON_VIEWED, {
            guild_id: c.guild_id,
            channel_id: c.id,
            sku_ids: z.map(e => e.id)
        })
    }, [c.id, c.guild_id, z]), (0, i.jsx)(g.A, {
        children: (0, i.jsx)(d.lGe, {
            ...
            children: (0, i.jsxs)("div", {
                ...
                children: [(0, i.jsx)("div", {
                    ...
                    children: (0, i.jsxs)("div", {
                        children: [(0, i.jsx)(d.DZT, {
                            ...
                            children: D.intl.format(D.t["+SqhBF"], {
                                applicationName: Object.values(W).length > 0 ? Object.values(W)[0]?.name ?? D.intl.string(D.t["/1hhto"]) : D.intl.string(D.t["/1hhto"])
                            })
                        })]
                    })
                }), (0, i.jsx)("div", {
                    ...
                    children: "loading" === Y || 0 === z.length ? (0, i.jsx)(d.y$y, {
                        className: G.Lq
                    }) : J
                }), (0, i.jsx)(O.A, {
