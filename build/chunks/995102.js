...
function C(e, t) {
    ...
    function v(t) {
        t && e.type === f.rbe.GUILD_CATEGORY && (0, s.Gv)(e.id), d.A.updateChannelOverrideSettings(e.guild_id, e.id, {
            muted: t
        }, A.G_.muted(t))
    }
    ...
    return r ? (0, i.jsx)(o.Drp, {
        ...
        children: _().map(n => {
            ...
            return (0, i.jsx)(o.Drp, {
                ...
                action: () => {
                    let n;
                    return e.type === f.rbe.GUILD_CATEGORY && (0, s.Gv)(e.id), n = g(r), void d.A.updateChannelOverrideSettings(e.guild_id, e.id, n, A.fd.Muted, t)
                }
            }, r)
        })
    })
