/** chunk id: 491032 params = (module,exports,require) **/
n.d(t, {
    P: () => f,
...
let A = {
        Logitech30P: {
            title: _.default.jkdhZq,
            titleParams: {
                discountPercent: u.aW
            },
            body: _.default.Yl5ww1
        },
        Logitech5PNI: {
    ...
    f = e => {
        ...
        r.Ay.fetchActivePromotions(), (0, a.mMO)(async () => {
            ...
            } = await Promise.resolve().then(n.bind(n, 491032));
            return n => (0, i.jsx)(e, {
                ...n,
                partnerId: t
            })
