...
function w(e) {
    ...
    let _, h, {
        ...
        A = N(e),
        S = null != (t = null == (s = e.mentions) ? void 0 : s.map(e => e.id)) ? t : [],
...
function P(e, t) {
    ...
    return null != t.poll && (n = n.set("poll", (0, o.A)(t.poll))), null != t.mentions && (n = n.set("mentions", t.mentions.map(e => e.id)), r = !0), null != t.mention_games && (n = n.set("mentionGames", t.mention_games), r = !0), null != t.mention_everyone && (n = n.set("mentionEveryone", t.mention_everyone), r = !0), null != t.mention_roles && (n = n.set("mentionRoles", t.mention_roles), r = !0), r && (n = n.set("mentioned", (0, E.Ay)({
        message: n,
        userId: f.default.getId()
    }))), n
}
