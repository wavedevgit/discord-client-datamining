...
function e_(e) {
    ...
    return n === j.pn.CONFIRM ? null : n === j.pn.REVIEW ? (s()(null != a, "Missing primaryButtonProps for review step"), (0, i.jsx)(P.lo, {
        onBackClick: null != l ? () => r(l) : void 0,
        primaryButtonProps: a
    })) : (0, i.jsx)(c.jlY, {
...
function eS(e) {
    let n, {
        ...
        e0 = (0, g.Y)(),
        e9 = l.useMemo(() => null != eA && eD && e0 ? (0, U.v)(eA, eQ) : [{
        ...
        } = (0, f.Ay)(eS, S.A.GUILD_BOOST_PURCHASE_MODAL),
    ...
    let [e2, ne] = l.useState(j.pn.PLAN_SELECT), nn = l.useMemo(() => Date.now(), [e2]), nt = l.useCallback((e, n) => {
        ne(e), eW(null);
        let t = Date.now();
    ...
    l.useEffect(() => {
        ...
        (async () => {
            if (!0 === eZ) try {
                ...
                await (0, x.tn)(F.A.redirectedPaymentId), i(j.pn.CONFIRM), no(M.h.COMPLETED), null != t && await em(t, null != eP), l?.()
            } catch (t) {
                no(M.h.FAIL), a(t), z.default.track(er.HAw.PAYMENT_FLOW_FAILED, {
                    ...e,
        ...
        H.A.hasFetchedSubscriptions() || (0, x.hP)(), null == eg || null != B.A.getGuild(eg) || null != v.A.getGuild(eg) || v.A.isGuildFetching(eg) || (0, C.y)(eg), (0, N.b)({
            ...e7,
            guild_id: eg,
            application_id: eE,
            custom_checkout_flow: ev
        }), null != eA && null != eA.renewalMutations && z.default.track(er.HAw.PREMIUM_GUILD_PENDING_MODAL, {
            location: ef,
            guild_id: eg
        })
    });
    let [nr, ns] = l.useState(ed), [na, no] = l.useState(M.h.WAITING), [nc, nu] = l.useState(!0), nd = () => {
        r(na === M.h.COMPLETED)
    ...
    let nm = (0, k.n)("GuildBoostPurchaseModal"),
        ...
        nS = (0, ee.A)(n_),
        [nf, nx] = l.useState(null),
        [ng, nb] = l.useState([]),
        [nh, nI] = l.useState(!1),
        ny = l.useMemo(() => JSON.stringify(ng), [ng]);
    l.useEffect(() => {
        let e;
    ...
    if (eN) n = (0, i.jsx)(b.oO, {});
    else if (eM && eD && e0 && null != nf && "" !== nf)
        if (eA?.isPausedOrPausePending && !eA.isPausedAllowsUpdatesButNotResume) n = (0, i.jsx)(c.cwr, {
            children: (0, i.jsx)("p", {
                className: ec.C,
                children: eo.intl.string(eo.t.mOWsF1)
            })
        });
        else if (null != eA && null != eA.renewalMutations) n = (0, i.jsx)(c.cwr, {
        children: (0, i.jsx)("p", {
            className: ec.C,
            children: eo.intl.string(eo.t.npfhh0)
        })
    });
    else if (e2 === j.pn.PREMIUM_UPSELL) {
        s()(null != eU, "Missing nextPremiumSubscriptionPlan"), s()(nf, "Currency not defined");
        let e = null != eF ? {
            paymentSourceId: eF,
            currency: nf
        } : {
        ...
        switch (e2) {
            case j.pn.PLAN_SELECT:
                s()(null != eg, "Missing guildId"), s()(null != eU, "Missing nextPremiumSubscriptionPlan"), e = (0, i.jsx)(en.As, {
                    premiumSubscriptionPlan: eU,
                    numGuildBoosts: eQ,
                    ...
                    priceOptions: a,
                    isRefreshEnabled: nm,
                    refreshNextStepLabel: (0, j.Ir)(nr.find(e => e !== j.pn.PLAN_SELECT && e !== j.pn.CONFIRM) ?? j.pn.REVIEW)
                }), np && null != eA && null != eA.paymentGateway ? e = (0, i.jsxs)("div", {
                    className: ec.xK,
                    ...
                    onClick: () => {
                        eI || null != eR && eR.premiumSubscriptionType === es.PremiumTypes.TIER_2 ? nt(null != eL || e$ ? j.pn.REVIEW : j.pn.ADD_PAYMENT_STEPS) : nt(j.pn.PREMIUM_UPSELL)
                    }
                });
                break;
            ...
            case j.pn.AWAITING_AUTHENTICATION:
                e = (0, i.jsx)(p.N, {
                    className: ec.__invalid_body
                });
                break;
            case j.pn.REVIEW:
                s()(null != eU, "Missing nextPremiumSubscriptionPlan"), s()(null != eg, "Missing guildId"), e = (0, i.jsx)(ei.pc, {
                    guildId: eg,
                    paymentSources: eB,
                    priceOptions: a,
                ...
                let _ = async () => {
                    ...
                    try {
                        ...
                        if (z.default.track(er.HAw.PAYMENT_FLOW_COMPLETED, {
                                ...e7,
                        ...
                        if (null == eA || null == eR) {
                            ...
                            l.currency = eA.currency ?? t, l.paymentSource = null != eL ? eB[eL] : void 0, null == l.paymentSource && (s()(null != e, "Missing paymentSource"), l.paymentSource = e, l.currency = t);
                            let r = await (0, x.nV)(eA, l, n, i, e5);
                            if (r.redirectConfirmation) return void nI(null != r.redirectURL)
                        }
                        null == eP && nt(j.pn.CONFIRM), no(M.h.COMPLETED), null != eg && await em(eg, null != eP), null != eP && nd(), eb?.()
                    } catch (n) {
                        no(M.h.FAIL), eW(n), z.default.track(er.HAw.PAYMENT_FLOW_FAILED, {
                            ...e7,
                            payment_error_code: n?.code,
                            payment_gateway: null != e ? e.type === er.hes.CARD ? er.kM_.STRIPE : er.kM_.BRAINTREE : null,
        ...
        n = e2 === j.pn.ADD_PAYMENT_STEPS ? nE : (0, i.jsx)(O.A, {
            shouldUseManaModal: !0,
            hideBreadcrumbs: function(e) {
                let {
                    currentStep: n,
                    isBoostingPreCheckoutModalRefreshEnabled: t
                } = e;
                return n === j.pn.REVIEW || n === j.pn.CONFIRM || t && n === j.pn.PLAN_SELECT
            }({
                currentStep: e2,
                isBoostingPreCheckoutModalRefreshEnabled: nm
            }),
            steps: nr,
            currentStep: e2,
            paymentError: b,
    ...
    let nP = (0, E.u)({
        ...
        nA = null;
    return (eN || (nm && e2 !== j.pn.PREMIUM_UPSELL ? nA = e2 === j.pn.REVIEW ? (0, i.jsx)(P.s3, {
        ...nP
    }) : (0, i.jsx)(P.s3, {
        title: nP.title
    }) : e2 === j.pn.REVIEW ? nA = (0, i.jsx)(P.s3, {
        ...nP
    }) : e2 !== j.pn.PREMIUM_UPSELL && (nA = (0, i.jsx)(Q.A, {
        onClose: nd,
        currentStep: e2,
        purchaseState: na
    }))), nm && e2 === j.pn.CONFIRM) ? (0, i.jsx)(Z.A, {
        mediaUrls: nS.mediaUrls,
        isSuccess: nS.isSuccess,
        transitionState: t,
        onClose: () => (nd(), Promise.resolve()),
        children: (e, n) => (0, i.jsx)(X.A, {
            transitionState: t,
...
function ef(e) {
    let n = (0, o.bG)([H.A], () => H.A.getPremiumTypeSubscription()),
        ...
        } = (0, f.Ay)(S.A.GUILD_BOOST_PURCHASE_MODAL);
    return (0, i.jsx)(f.f5, {
        value: t,
