...
function ec(e) {
    ...
    return n === L.pn.CONFIRM ? null : t && n === L.pn.REVIEW ? (s()(null != a, "Missing primaryButtonProps for review step"), (0, l.jsx)(M.lo, {
...
function eu(e) {
    let n, {
        ...
        eT = null != eb ? eb.paymentSourceId : null,
        eh = (0, o.bG)([Y.A], () => null != eb ? (0, K.c9)(eb.planId) : null),
        eN = (0, o.bG)([Y.A], () => null == eb || null != Y.A.get(eb.planId)),
        ...
        eQ = (0, I.Y)(),
        e$ = i.useMemo(() => null != eb && eN && eQ ? (0, v.v)(eb, eH) : [{
    ...
    i.useEffect(() => {
        ...
        (async () => {
            if (!0 === eK) try {
                ...
                await (0, p.tn)(B.A.redirectedPaymentId), l(L.pn.CONFIRM), ni(R.h.COMPLETED), null != t && await eo(t, null != eI), i?.()
            } catch (t) {
                ni(R.h.FAIL), a(t), H.default.track(ee.HAw.PAYMENT_FLOW_FAILED, {
                    ...e,
        ...
        }), null != eb && null != eb.renewalMutations && H.default.track(ee.HAw.PREMIUM_GUILD_PENDING_MODAL, {
            location: ep,
            guild_id: e_
        })
    });
    let [nn, nt] = i.useState(es), [nl, ni] = i.useState(R.h.WAITING), [nr, ns] = i.useState(!0), na = () => {
        r(nl === R.h.COMPLETED)
    }, no = null != eb && eb.isPurchasedExternally;
    i.useEffect(() => {
    ...
    }, [e4, e2, no, eO, eb, eT, nn]), (0, w.b)(e4, eO, e2, ni), (0, L.zT)(e4, nl, ni);
    ...
    i.useEffect(() => {
        let e;
        eQ && (null != Y.A.get(en.gD.PREMIUM_MONTH_GUILD) && nE(e = (0, J._w)(en.gD.PREMIUM_MONTH_GUILD, ew, !1)), null == ew && null != eb && null != eb.paymentSourceId ? nm(eb.currency) : null != e && nm(e[0]))
    }, [ew, eb, eQ, nI]);
    let nb = (0, U.Y)({
        paymentModalArgs: eD,
    ...
    if (eg) n = (0, l.jsx)(b.oO, {
        ...
        switch (e4) {
            case L.pn.PLAN_SELECT:
                s()(null != e_, "Missing guildId"), s()(null != eC, "Missing nextPremiumSubscriptionPlan"), e = (0, l.jsx)($.A, {
                    ...
                    priceOptions: a
                }), no && null != eb && null != eb.paymentGateway ? e = (0, l.jsxs)("div", {
                    className: ei.xK,
                    children: [(0, l.jsx)(u.wx6, {
                        type: "critical",
                        children: el.intl.format(el.t["/m3Y3s"], {
                            paymentGatewayName: et.qm[eb.paymentGateway]
                        })
                    }), e]
            ...
            case L.pn.AWAITING_AUTHENTICATION:
                ...
                break;
            case L.pn.REVIEW:
                s()(null != eC, "Missing nextPremiumSubscriptionPlan"), s()(null != e_, "Missing guildId"), e = (0, l.jsx)(X.pc, {
                    guildId: e_,
                    paymentSources: ek,
                    priceOptions: a,
                ...
                let S = async () => {
                    ...
                    ev(null);
                    try {
                        ni(R.h.PURCHASING), eU(!0), s()(null != ew, "Missing paymentSourceId"), s()(null != ef, "Missing invoicePreview");
                        let n = {
                                amount: ef.total,
                                currency: ef.currency
                            },
                            t = (0, q.U8)(eb, e$, a.currency.toLowerCase(), a.paymentSourceId);
                        ...
                        if (null == eb || null == eh) {
                            ...
                            l.currency = eb.currency, null == l.currency && (l.currency = a.currency), l.paymentSource = null != eT ? ek[eT] : void 0, null == l.paymentSource && (s()(null != e, "Missing paymentSource"), l.paymentSource = e, l.currency = a.currency);
                            let i = await (0, p.nV)(eb, l, n, t, e5);
        ...
        n = e4 === L.pn.ADD_PAYMENT_STEPS ? nb : (0, l.jsx)(O.A, {
    ...
    let ng = (0, x.u)({
        ...
        ny = null;
    return eg || (nd && e4 === L.pn.REVIEW ? ny = (0, l.jsx)(M.s3, {
        ...ng
