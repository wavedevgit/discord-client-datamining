...
function ef(e) {
    ...
    return n === L.pn.CONFIRM ? null : t && n === L.pn.REVIEW ? (s()(null != o, "Missing primaryButtonProps for review step"), (0, i.jsx)(v.lo, {
        onBackClick: null != r ? () => a(r) : void 0,
        primaryButtonProps: o
    })) : (0, i.jsx)(c.jlY, {
...
function eh(e) {
    let n, {
        ...
        eO = (0, o.bG)([j.A], () => null != eb ? j.A.getGuild(eb) : void 0, [eb]),
        ...
        {
            hasAcceptedTerms: e0,
            setHasAcceptedTerms: e8
        } = (0, M.P5)(),
        e9 = (0, o.bG)([V.A], () => V.A.popupCallbackCalled),
        e6 = (0, g.Y)(),
        e7 = l.useMemo(() => null != eC && eU && e6 ? (0, k.v)(eC, eX) : [{
            planId: eo.gD.PREMIUM_MONTH_GUILD,
            quantity: eX
        }], [eC, eU, eX, e6]),
        e4 = l.useMemo(() => (0, U.A)(), []),
        [e5, e1] = (0, m.A)(() => [e4 ?? (0, a.A)(), Date.now()]),
        {
            analyticsLocations: e3
        } = (0, h.Ay)(eh, f.A.GUILD_BOOST_PURCHASE_MODAL),
        e2 = l.useMemo(() => e7.find(e => {
            let {
                planId: n
            } = e;
            return eo.pW.has(n)
        })?.planId ?? eo.gD.PREMIUM_MONTH_GUILD, [e7]),
    ...
    let [nt, ni] = l.useState(L.pn.PLAN_SELECT), nl = l.useMemo(() => Date.now(), [nt]), nr = l.useCallback((e, n) => {
        ni(e), eF(null);
        let t = Date.now();
    ...
    l.useEffect(() => {
        ...
        (async () => {
            if (!0 === e9) try {
                ...
                await (0, S.tn)(V.A.redirectedPaymentId), i(L.pn.CONFIRM), nd(R.h.COMPLETED), null != t && await ex(t, null != ev), l?.()
            } catch (t) {
                nd(R.h.FAIL), a(t), q.default.track(ea.HAw.PAYMENT_FLOW_FAILED, {
                    ...e,
        ...
        z.A.hasFetchedSubscriptions() || (0, S.hP)(), null == eb || null != F.A.getGuild(eb) || null != j.A.getGuild(eb) || j.A.isGuildFetching(eb) || (0, N.y)(eb), (0, C.b)({
            ...nn,
            guild_id: eb,
            application_id: eE,
            custom_checkout_flow: eT
        }), null != eC && null != eC.renewalMutations && q.default.track(ea.HAw.PREMIUM_GUILD_PENDING_MODAL, {
            location: eS,
            guild_id: eb
        })
    });
    let [no, nc] = l.useState(em), [nu, nd] = l.useState(R.h.WAITING), [np, nm] = l.useState(!0), n_ = () => {
        r(nu === R.h.COMPLETED)
    }, nx = null != eC && eC.isPurchasedExternally;
    l.useEffect(() => {
        eH !== G.oc.PENDING && nt !== L.pn.CONFIRM && null != eR && (no !== em && nc(em), em.includes(nt) || nt === L.pn.PREMIUM_UPSELL || nr(L.pn.REVIEW)), nt === L.pn.ADD_PAYMENT_STEPS && no !== e_ && nc(e_), nx && nt !== L.pn.PLAN_SELECT && ni(L.pn.PLAN_SELECT)
    }, [nt, nr, nx, eH, eC, eR, no]), (0, G.b)(nt, eH, nr, nd), (0, L.zT)(nt, nu, nd);
    ...
    l.useEffect(() => {
        let e;
        e6 && (null != K.A.get(eo.gD.PREMIUM_MONTH_GUILD) && nv(e = (0, Q._w)(eo.gD.PREMIUM_MONTH_GUILD, eY, !1)), null == eY && null != eC && null != eC.paymentSourceId ? nA(eC.currency) : null != e && nA(e[0]))
    }, [eY, eC, e6, nj]);
    let nT = (0, W.Y)({
        paymentModalArgs: eB,
    ...
    if (eN) n = (0, i.jsx)(b.oO, {});
        ...
        if (eC?.isPausedOrPausePending && !eC.isPausedAllowsUpdatesButNotResume) n = (0, i.jsx)(c.cwr, {
            children: (0, i.jsx)("p", {
                className: ed.C,
                children: eu.intl.string(eu.t.mOWsF1)
            })
        });
        else if (null != eC && null != eC.renewalMutations) n = (0, i.jsx)(c.cwr, {
        children: (0, i.jsx)("p", {
            className: ed.C,
            children: eu.intl.string(eu.t.npfhh0)
        })
    });
        ...
        switch (nt) {
            case L.pn.PLAN_SELECT:
                s()(null != eb, "Missing guildId"), s()(null != ew, "Missing nextPremiumSubscriptionPlan"), e = (0, i.jsx)(ei.As, {
                    premiumSubscriptionPlan: ew,
                    numGuildBoosts: eX,
                    ...
                    priceOptions: a,
                    isRefreshEnabled: nb,
                    refreshNextStepLabel: (0, L.Ir)(no.find(e => e !== L.pn.PLAN_SELECT && e !== L.pn.CONFIRM) ?? L.pn.REVIEW)
                }), nx && null != eC && null != eC.paymentGateway ? e = (0, i.jsxs)("div", {
                    className: ed.xK,
                ...
                }) : !j.A.isGuildFetching(eb) && c && (e = (0, i.jsxs)(i.Fragment, {
                    children: [(0, i.jsx)(u.po8, {
                        messageType: u.YCn.ERROR,
                        className: ed.MR,
                        children: eu.intl.string(eu.t.eAn6z2)
                    }), e]
                })), l = nb ? (0, i.jsx)(u.Button, {
                    variant: "secondary",
                    ...
                    onClick: () => {
                        ey || null != eD && eD.premiumSubscriptionType === eo.PremiumTypes.TIER_2 ? nr(null != eR || eQ ? L.pn.REVIEW : L.pn.ADD_PAYMENT_STEPS) : nr(L.pn.PREMIUM_UPSELL)
                    }
                });
                break;
            ...
            case L.pn.AWAITING_AUTHENTICATION:
                e = (0, i.jsx)(p.N, {
                    className: ed.__invalid_body
                });
                break;
            case L.pn.REVIEW:
                s()(null != ew, "Missing nextPremiumSubscriptionPlan"), s()(null != eb, "Missing guildId"), e = (0, i.jsx)(er.pc, {
                    guildId: eb,
                    paymentSources: eW,
                    priceOptions: a,
                    ...
                    premiumSubscriptionPlan: ew,
                    newAdditionalPlans: e7,
                    onPurchaseTermsChange: e8,
                ...
                let _ = async () => {
                    s()(null != e7, "Missing newAdditionalPlans");
                    let e = (0, D.W)(eW, eY);
                    eF(null);
                    try {
                        nd(R.h.PURCHASING), eV(!0), s()(null != eY, "Missing paymentSourceId"), s()(null != eM, "Missing invoicePreview");
                        let n = {
                                amount: eM.total,
                                currency: eM.currency
                            },
                            t = a.currency ?? eM.currency,
                            i = (0, $.U8)(eC, e7, t.toLowerCase(), a.paymentSourceId);
                        if (q.default.track(ea.HAw.PAYMENT_FLOW_COMPLETED, {
                                ...nn,
                        ...
                        if (null == eC || null == eD) {
                            ...
                            l.currency = eC.currency ?? t, l.paymentSource = null != eR ? eW[eR] : void 0, null == l.paymentSource && (s()(null != e, "Missing paymentSource"), l.paymentSource = e, l.currency = t);
                            let r = await (0, S.nV)(eC, l, n, i, e3);
                            if (r.redirectConfirmation) return void nN(null != r.redirectURL)
                        }
                        null == ev && nr(L.pn.CONFIRM), nd(R.h.COMPLETED), null != eb && await ex(eb, null != ev), null != ev && n_(), eI?.()
                    } catch (n) {
                        nd(R.h.FAIL), eF(n), q.default.track(ea.HAw.PAYMENT_FLOW_FAILED, {
                            ...nn,
                            payment_error_code: n?.code,
                            payment_gateway: null != e ? e.type === ea.hes.CARD ? ea.kM_.STRIPE : ea.kM_.BRAINTREE : null,
                ...
                m = {
                    ...
                    onClick: e0 ? _ : () => {
                        null != nf.current && (nf.current.scrollIntoView({
                            behavior: "smooth"
                        }), nS(!0))
                    },
                    variant: "active"
        ...
        n = nt === L.pn.ADD_PAYMENT_STEPS ? nT : (0, i.jsx)(B.A, {
            shouldUseManaModal: !0,
    ...
    if (!eN)
        if (nb && nt !== L.pn.PREMIUM_UPSELL)
            if (ng && nt === L.pn.REVIEW) nL = (0, i.jsx)(v.s3, {
                ...nM
            });
            else {
                let e = (0, i.jsx)(v.s3, {
                ...
                nL = ng ? e : (0, i.jsx)(y.e0, {
                    children: e
                })
            }
    else ng && nt === L.pn.REVIEW ? nL = (0, i.jsx)(v.s3, {
        ...nM
    }) : nt !== L.pn.PREMIUM_UPSELL && (nL = (0, i.jsx)(Z.A, {
        onClose: n_,
        currentStep: nt,
        purchaseState: nu
    }));
    return nb && nt === L.pn.CONFIRM ? (0, i.jsx)(en.A, {
        mediaUrls: nP.mediaUrls,
        isSuccess: nP.isSuccess,
        transitionState: t,
        onClose: () => (n_(), Promise.resolve()),
        children: (e, n) => (0, i.jsx)(ee.A, {
            transitionState: t,
...
function eS(e) {
    let n = (0, o.bG)([z.A], () => z.A.getPremiumTypeSubscription()),
        ...
        } = (0, h.Ay)(f.A.GUILD_BOOST_PURCHASE_MODAL);
    return (0, i.jsx)(h.f5, {
        value: t,
