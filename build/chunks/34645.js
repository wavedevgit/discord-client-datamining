...
function ex(e) {
    ...
    return n === M.pn.CONFIRM ? null : t && n === M.pn.REVIEW ? (s()(null != o, "Missing primaryButtonProps for review step"), (0, i.jsx)(v.lo, {
...
function ef(e) {
    let n, {
        ...
        {
            hasAcceptedTerms: eZ,
            setHasAcceptedTerms: e0
        } = (0, T.P5)(),
        e8 = (0, o.bG)([Y.A], () => Y.A.popupCallbackCalled),
        e9 = (0, g.Y)(),
        e6 = l.useMemo(() => null != ev && eD && e9 ? (0, w.v)(ev, eQ) : [{
        ...
        } = (0, h.Ay)(ef, f.A.GUILD_BOOST_PURCHASE_MODAL),
        e3 = l.useMemo(() => e6.find(e => {
            let {
                planId: n
            } = e;
            return ea.pW.has(n)
        })?.planId ?? ea.gD.PREMIUM_MONTH_GUILD, [e6]),
    ...
    let [nn, nt] = l.useState(M.pn.PLAN_SELECT), ni = l.useMemo(() => Date.now(), [nn]), nl = l.useCallback((e, n) => {
        nt(e), eW(null);
        let t = Date.now();
    ...
    l.useEffect(() => {
        ...
        (async () => {
            if (!0 === e8) try {
                ...
                await (0, S.tn)(Y.A.redirectedPaymentId), i(M.pn.CONFIRM), nu(L.h.COMPLETED), null != t && await e_(t, null != eA), l?.()
            } catch (t) {
                nu(L.h.FAIL), a(t), z.default.track(es.HAw.PAYMENT_FLOW_FAILED, {
                    ...e,
        ...
        K.A.hasFetchedSubscriptions() || (0, S.hP)(), null == eg || null != W.A.getGuild(eg) || null != j.A.getGuild(eg) || j.A.isGuildFetching(eg) || (0, N.y)(eg), (0, C.b)({
            ...ne,
            guild_id: eg,
            application_id: ey,
            custom_checkout_flow: eT
        }), null != ev && null != ev.renewalMutations && z.default.track(es.HAw.PREMIUM_GUILD_PENDING_MODAL, {
            location: eh,
            guild_id: eg
        })
    });
    let [na, no] = l.useState(ep), [nc, nu] = l.useState(L.h.WAITING), [nd, np] = l.useState(!0), nm = () => {
        r(nc === L.h.COMPLETED)
    }, n_ = null != ev && ev.isPurchasedExternally;
    l.useEffect(() => {
        eV !== O.oc.PENDING && nn !== M.pn.CONFIRM && null != eL && (na !== ep && no(ep), ep.includes(nn) || nn === M.pn.PREMIUM_UPSELL || nl(M.pn.REVIEW)), nn === M.pn.ADD_PAYMENT_STEPS && na !== em && no(em), n_ && nn !== M.pn.PLAN_SELECT && nt(M.pn.PLAN_SELECT)
    }, [nn, nl, n_, eV, ev, eL, na]), (0, O.b)(nn, eV, nl, nu), (0, M.zT)(nn, nc, nu);
    ...
    l.useEffect(() => {
        let e;
        e9 && (null != H.A.get(ea.gD.PREMIUM_MONTH_GUILD) && nA(e = (0, $._w)(ea.gD.PREMIUM_MONTH_GUILD, eF, !1)), null == eF && null != ev && null != ev.paymentSourceId ? nE(ev.currency) : null != e && nE(e[0]))
    }, [eF, ev, e9, nN]);
    let nj = (0, B.Y)({
        paymentModalArgs: eG,
    ...
    if (eC) n = (0, i.jsx)(b.oO, {});
        ...
        if (ev?.isPausedOrPausePending && !ev.isPausedAllowsUpdatesButNotResume) n = (0, i.jsx)(c.cwr, {
            children: (0, i.jsx)("p", {
                className: eu.C,
                children: ec.intl.string(ec.t.mOWsF1)
            })
        });
        else if (null != ev && null != ev.renewalMutations) n = (0, i.jsx)(c.cwr, {
        children: (0, i.jsx)("p", {
            className: eu.C,
            children: ec.intl.string(ec.t.npfhh0)
        })
    });
        ...
        switch (nn) {
            case M.pn.PLAN_SELECT:
                s()(null != eg, "Missing guildId"), s()(null != eU, "Missing nextPremiumSubscriptionPlan"), e = (0, i.jsx)(et.As, {
                    premiumSubscriptionPlan: eU,
                    numGuildBoosts: eQ,
                    ...
                    priceOptions: a,
                    isRefreshEnabled: ng,
                    refreshNextStepLabel: (0, M.Ir)(na.find(e => e !== M.pn.PLAN_SELECT && e !== M.pn.CONFIRM) ?? M.pn.REVIEW)
                }), n_ && null != ev && null != ev.paymentGateway ? e = (0, i.jsxs)("div", {
                    className: eu.xK,
                    ...
                    onClick: () => {
                        eP || null != eR && eR.premiumSubscriptionType === ea.PremiumTypes.TIER_2 ? nl(null != eL || e$ ? M.pn.REVIEW : M.pn.ADD_PAYMENT_STEPS) : nl(M.pn.PREMIUM_UPSELL)
                    }
                });
                break;
            ...
            case M.pn.AWAITING_AUTHENTICATION:
                e = (0, i.jsx)(p.N, {
                    className: eu.__invalid_body
                });
                break;
            case M.pn.REVIEW:
                s()(null != eU, "Missing nextPremiumSubscriptionPlan"), s()(null != eg, "Missing guildId"), e = (0, i.jsx)(el.pc, {
                    guildId: eg,
                    paymentSources: eB,
                    priceOptions: a,
                ...
                let _ = async () => {
                    ...
                    eW(null);
                    try {
                        nu(L.h.PURCHASING), eY(!0), s()(null != eF, "Missing paymentSourceId"), s()(null != ej, "Missing invoicePreview");
                        let n = {
                                amount: ej.total,
                        ...
                        if (z.default.track(es.HAw.PAYMENT_FLOW_COMPLETED, {
                                ...ne,
                        ...
                        if (null == ev || null == eR) {
                            ...
                            l.currency = ev.currency ?? t, l.paymentSource = null != eL ? eB[eL] : void 0, null == l.paymentSource && (s()(null != e, "Missing paymentSource"), l.paymentSource = e, l.currency = t);
                            let r = await (0, S.nV)(ev, l, n, i, e4);
                            if (r.redirectConfirmation) return void nC(null != r.redirectURL)
                        }
                        null == eA && nl(M.pn.CONFIRM), nu(L.h.COMPLETED), null != eg && await e_(eg, null != eA), null != eA && nm(), eb?.()
                    } catch (n) {
                        nu(L.h.FAIL), eW(n), z.default.track(es.HAw.PAYMENT_FLOW_FAILED, {
                            ...ne,
                            payment_error_code: n?.code,
                            payment_gateway: null != e ? e.type === es.hes.CARD ? es.kM_.STRIPE : es.kM_.BRAINTREE : null,
                ...
                m = {
                    ...
                    onClick: eZ ? _ : () => {
                        null != nx.current && (nx.current.scrollIntoView({
                            behavior: "smooth"
                        }), nh(!0))
                    },
                    variant: "active"
        ...
        n = nn === M.pn.ADD_PAYMENT_STEPS ? nj : (0, i.jsx)(G.A, {
            shouldUseManaModal: !0,
    ...
    if (!eC)
        if (ng && nn !== M.pn.PREMIUM_UPSELL)
            if (nS && nn === M.pn.REVIEW) nM = (0, i.jsx)(v.s3, {
                ...nT
            });
            else {
                let e = (0, i.jsx)(v.s3, {
                ...
                nM = nS ? e : (0, i.jsx)(E.e0, {
                    children: e
                })
            }
    else nS && nn === M.pn.REVIEW ? nM = (0, i.jsx)(v.s3, {
        ...nT
    }) : nn !== M.pn.PREMIUM_UPSELL && (nM = (0, i.jsx)(X.A, {
        onClose: nm,
        currentStep: nn,
        purchaseState: nc
    }));
    return ng && nn === M.pn.CONFIRM ? (0, i.jsx)(ee.A, {
        mediaUrls: nI.mediaUrls,
        isSuccess: nI.isSuccess,
        transitionState: t,
        onClose: () => (nm(), Promise.resolve()),
        children: (e, n) => (0, i.jsx)(Z.A, {
            transitionState: t,
