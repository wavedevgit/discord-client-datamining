...
function eu(e) {
    let n, {
        ...
        eQ = (0, I.Y)(),
        e$ = i.useMemo(() => null != eg && eN && eQ ? (0, v.v)(eg, eH) : [{
    ...
    i.useEffect(() => {
        ...
        }), null != eg && null != eg.renewalMutations && H.default.track(ee.HAw.PREMIUM_GUILD_PENDING_MODAL, {
            location: ep,
            guild_id: e_
        })
    });
    ...
    i.useEffect(() => {
        let e;
        eQ && (null != Y.A.get(en.gD.PREMIUM_MONTH_GUILD) && nE(e = (0, J._w)(en.gD.PREMIUM_MONTH_GUILD, ew, !1)), null == ew && null != eg && null != eg.paymentSourceId ? nm(eg.currency) : null != e && nm(e[0]))
    }, [ew, eg, eQ, nI]);
    let ng = (0, U.Y)({
        paymentModalArgs: eD,
