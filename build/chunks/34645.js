...
function ep(e) {
    let n, {
        ...
        } = (0, P.Ay)(y, A.A.GUILD_BOOST_PURCHASE_MODAL),
    ...
    let [e4, e7] = i.useState(R.pn.PLAN_SELECT), e6 = i.useMemo(() => Date.now(), [e4]), e2 = i.useCallback((e, n) => {
        e7(e), ev(null);
        let t = Date.now();
    ...
    i.useEffect(() => {
        eU !== O.oc.PENDING && e4 !== R.pn.CONFIRM && null != eT && (nn !== ea && nt(ea), ea.includes(e4) || e4 === R.pn.PREMIUM_UPSELL || e2(R.pn.REVIEW)), e4 === R.pn.ADD_PAYMENT_STEPS && nn !== eo && nt(eo), no && e4 !== R.pn.PLAN_SELECT && e7(R.pn.PLAN_SELECT)
    }, [e4, e2, no, eU, eg, eT, nn]), (0, O.b)(e4, eU, e2, ni), (0, R.zT)(e4, nl, ni);
    ...
    if (eb) n = (0, l.jsx)(g.oO, {});
        ...
        switch (e4) {
            ...
            case R.pn.REVIEW:
                ...
                let S = async () => {
                    ...
                    ev(null);
                    try {
                        ni(j.h.PURCHASING), eO(!0), s()(null != ew, "Missing paymentSourceId"), s()(null != ef, "Missing invoicePreview");
                        let n = {
                                amount: ef.total,
        ...
        n = e4 === R.pn.ADD_PAYMENT_STEPS ? ng : (0, l.jsx)(G.A, {
            shouldUseManaModal: !0,
            hideBreadcrumbs: nd && e4 === R.pn.REVIEW || e4 === R.pn.CONFIRM,
            steps: nn,
            currentStep: e4,
            paymentError: I,
            purchaseErrorBlockRef: eY,
    ...
    let nb = (0, M.u)({
        ...
        ny = null;
    return eb || (nd && e4 === R.pn.REVIEW ? ny = (0, l.jsx)(T.s3, {
        ...nb
