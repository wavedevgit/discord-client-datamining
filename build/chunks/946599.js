...
function x(e) {
    ...
    } = (0, d.NJ)(), j = (0, a.useRef)(new Map), T = (0, a.useRef)(null), b = (0, a.useRef)(null), [N, C] = (0, a.useState)(0), [S, k] = (0, a.useState)(!1), O = E(T, b, x, j, C);
    if ((0, a.useEffect)(() => (O(), window.addEventListener("resize", O), () => {
            window.removeEventListener("resize", O)
        }), [O, x?.join("")]), !I && !A) return null;
    let D = S ? x : x.slice(0, x.length - N);
    return (0, i.jsxs)("div", {
        className: s()(f.I4, o),
