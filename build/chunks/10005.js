...
function o(e) {
    let {
        onError: t,
        onSuccess: n
    } = e ?? {}, [o, d] = i.useState(!1), [c, u] = i.useState(!1), [m, g] = i.useState(!1), [_, x] = i.useState(!1), [A, h] = i.useState(!1), [p, f] = i.useState(!1), [T, E] = i.useState(!1), [S, b] = i.useState(!1), C = o || c || m || _ || p || S, N = i.useCallback(async e => {
        if (!C) {
            d(!0);
            try {
