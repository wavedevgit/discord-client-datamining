...
let eB = (0, c.Fe)({
    ...
    eZ = e => {
        ...
        let h = (0, A.bG)([eb.A], () => eb.A.getGuild(a)),
            _ = (0, A.bG)([ev.Ay], () => null == a ? null : ev.Ay.getSelfMember(a)),
            g = (0, ec.C$)(a, "ChannelRenderer"),
        ...
        let x = (0, K.$)(a);
        if (null != a && null != u && (0, eM.jq)(u)) switch (u) {
            ...
            case eM.VV.MEMBER_APPLICATIONS:
                return (0, i.jsx)(o.rd, {
                    to: ej.BVt.CHANNEL(a, eM.VV.MEMBER_SAFETY)
                });
        ...
        if ((0, Y.$Y)(h, _)) return (0, i.jsx)(W.A, {
            guildId: a,
            channelId: u
        });
    ...
    eJ = l.memo(function() {
        let {
            ...
            location: "Sidebar"
        }), l = (0, A.bG)([ey.A], () => t ?? ey.A.getChannelId(e));
        ...
        })) : window.location.pathname.startsWith(ej.BVt.GLOBAL_DISCOVERY) || window.location.pathname.startsWith(ej.BVt.GUILD_DISCOVERY) || (0, eh.r$)() ? (0, i.jsx)(B.A, {}) : null != e ? (0, i.jsx)(z.A, {
            selectedChannelId: l,
            guildId: e
        }, e) : (0, i.jsx)(eA.A, {})
    }),
...
function ts(e) {
    ...
    let g = l.useRef(null),
        ...
        f = l.useCallback(e => {
            document.body.classList.remove(eV.cB), document.body.classList.remove(eV._A), document.body.classList.remove(eV.uN), document.body.classList.remove(eV.l4), g.current?.style.setProperty("--custom-overdrag", "0px"), h.w.set(E.o, e), eL.default.track(ej.HAw.CHANNEL_SIDEBAR_RESIZED, {
                width: e
            })
        }, []),
        C = (0, T.A)({
...
function to() {
    let e, t = (0, A.bG)([eO.Ay], () => eO.Ay.hasNotice()),
        n = (0, eT.NC)(),
        r = function() {
            let [e, t] = l.useState(() => window.location.pathname.startsWith(ej.BVt.GUILD_MEMBER_VERIFICATION("")));
            return l.useEffect(() => eE.A.addRouteChangeListener(e => {
                t(e.pathname.startsWith(ej.BVt.GUILD_MEMBER_VERIFICATION("")))
            }), []), e
        }(),
        a = (e = (0, o.zy)(), (0, ef.B)(e.pathname, ej.BVt.GUILD_BOOSTING_MARKETING(eI.pv.guildId()))?.isExact === !0),
        ...
        h = (0, w.f)("AppView"),
        _ = (0, o.W5)([ej.BVt.CHANNEL(ej.ME, eI.pv.channelId()), ej.BVt.CHANNEL(eI.pv.guildId(), eI.pv.channelId({
            optional: !0
        }), ":messageId?")]),
    ...
    return (0, i.jsx)("div", {
        ...
        children: (0, i.jsx)(H.A.Provider, {
            value: _?.params.guildId === ej.ME ? void 0 : _?.params.guildId,
            children: (0, i.jsxs)("div", {
                className: eV.E3,
                "data-fullscreen": I,
                children: [!I && (0, i.jsx)(eB, {}), u.Fr ? null : (0, i.jsx)(el.A, {}), (0, i.jsxs)("div", {
                    className: eV.Qs,
                    children: [(0, i.jsx)(O.A, {}), (0, i.jsx)(ts, {
                        isSidebarOpen: s,
                        hasNotice: t,
                        sidebarTheme: n,
                        hideChannelList: r || a || m,
                        hideSidebar: !s
                    }), (0, i.jsx)("div", {
                        className: eV.MY,
                        "data-collapsed": !!p && E,
