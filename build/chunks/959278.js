...
let ek = (0, c.Fe)({
    ...
    eQ = e => {
        ...
        if (null != r && null != u && (0, eM.jq)(u)) switch (u) {
            ...
            case eM.VV.MEMBER_APPLICATIONS:
                return (0, i.jsx)(o.rd, {
                    to: eD.BVt.CHANNEL(r, eM.VV.MEMBER_SAFETY)
                });
            ...
            case eM.VV.CUSTOMIZE_COMMUNITY:
                return (0, i.jsx)(eK, {
                    guildId: r,
                    selectedSection: ew.qC.CUSTOMIZE
                });
    ...
    e2 = () => function(e) {
        ...
        return Object.values(ej.G2).includes(t) ? (0, i.jsx)(R.A, {
            tab: t,
            ...e
        }) : (0, i.jsx)(R.A, {
            ...e
        ...
        return (0, i.jsx)(C.A, {
            ...
            children: (e => {
                ...
                switch (t.params.feature) {
                    case "friends":
                        return (0, i.jsx)(ed.A, {
                            initialSection: eD.m3P.ONLINE
                        });
                    case "addFriends":
                        return (0, i.jsx)(ed.A, {
                            initialSection: eD.m3P.ADD_FRIEND
                        });
                    case "pendingFriends":
                        return (0, i.jsx)(ed.A, {
                            initialSection: eD.m3P.PENDING
                        });
                    case "sessionManagement":
                        return (0, i.jsx)(o.rd, {
                            to: eD.BVt.SETTINGS("sessions")
                        });
                    case "connections":
                        return (0, i.jsx)(o.rd, {
                            to: {
                                pathname: eD.BVt.SETTINGS("connections"),
                                search: e.location.search
                            }
                        });
                    case "family-center":
                        return (0, i.jsx)(o.rd, {
                            to: eD.BVt.FAMILY_CENTER
                        });
                    case "account-standing":
                        return (0, i.jsx)(o.rd, {
                            to: eD.BVt.SETTINGS("account", "account-standing")
                        });
                    case "authorized-apps":
                        return (0, i.jsx)(o.rd, {
                            to: eD.BVt.SETTINGS("authorized-apps")
                        });
                    case "open-shop":
                        let {
                            tab: n
                        ...
                        if (Object.values(ej.G2).includes(n)) return (0, i.jsx)(o.rd, {
                            to: eD.BVt.COLLECTIBLES_SHOP_WITH_TAB(n)
                        });
                        return (0, i.jsx)(o.rd, {
                            to: eD.BVt.COLLECTIBLES_SHOP
                        });
                    case "editProfile":
                        return (0, i.jsx)(o.rd, {
                            to: {
                                pathname: eD.BVt.SETTINGS("profile-customization")
                            }
                        });
                    case "gift":
                    case "store":
                    ...
                    case "boost-settings":
                        return (0, i.jsx)(o.rd, {
                            to: eD.BVt.SETTINGS("guild-boosting")
                        });
                    default:
                        return (0, i.jsx)(o.rd, {
                            to: eD.BVt.ME
...
function tr() {
    let e, t = (0, A.bG)([ey.Ay], () => ey.Ay.hasNotice()),
        ...
        r = (e = (0, o.zy)(), (0, ef.B)(e.pathname, eD.BVt.GUILD_BOOSTING_MARKETING(eI.pv.guildId()))?.isExact === !0),
        ...
        h = (0, w.f)("AppView"),
        _ = (0, o.W5)([eD.BVt.CHANNEL(eD.ME, eI.pv.channelId()), eD.BVt.CHANNEL(eI.pv.guildId(), eI.pv.channelId({
            optional: !0
        }), ":messageId?")]),
                        ...
                        children: (0, i.jsxs)(S.A.Provider, {
                            ...
                            children: [(0, i.jsxs)(o.dO, {
                                children: [(0, i.jsx)(v.A, {
                                    ...
                                    path: eD.BVt.COLLECTIBLES_SHOP_COLLECTION_DETAIL(":collectionId"),
                                    render: function(e) {
                                        let {
                                            match: t,
                                            ...n
                                    ...
                                    path: [eD.BVt.CHANNEL_THREAD_VIEW(eI.pv.guildId(), eI.pv.channelId(), ":threadId", ":messageId?"), eD.BVt.CHANNELS_GAME_SHOP(eI.pv.guildId(), ":gameShopPageIndex", ":gameShopSkuId?", ":gameShopSlug?"), eD.BVt.CHANNEL(eD.ME, eI.pv.channelId()), eD.BVt.CHANNEL(eI.pv.guildId(), eI.pv.channelId({
                                        optional: !0
                                    }), ":messageId?")],
                                    render: eZ,
