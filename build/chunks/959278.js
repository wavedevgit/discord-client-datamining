...
function to() {
    let e, t = (0, A.bG)([eO.Ay], () => eO.Ay.hasNotice()),
        n = (0, eT.NC)(),
        l = function() {
            let [e, t] = r.useState(() => window.location.pathname.startsWith(ej.BVt.GUILD_MEMBER_VERIFICATION("")));
        ...
        g = r.useCallback(() => en.A.openSidebar(), []),
        p = (0, M.D)("AppView"),
