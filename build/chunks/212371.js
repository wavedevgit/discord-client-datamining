...
class h extends r.A {
    ...
    handleVoiceStateUpdates = e => {
        ...
        t.forEach(e => {
            e.userId === n && c.A.getChannel(e.channelId)?.isGuildStageVoice() && (0, A.eY)(e) !== A.zF.ON_STAGE && (this.handleStopStream(e), this.handleStopUserVideo())
        })
    };
    handleStopStream = e => {
    ...
    handleStopUserVideo = () => {
        u.Ay.isVideoEnabled() && l.A.setVideoEnabled(!1)
    }
}
let _ = new h