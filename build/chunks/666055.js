...
function _() {
    let [e, t] = i.useState(!1), n = (0, s.bG)([u.default], () => u.default.getCurrentUser()), _ = (0, c.Lh)(), f = (0, s.bG)([m.A], () => m.A.getPremiumTypeSubscription()), b = null != _ ? x.VD[_]?.tenureReqNumMonths ?? 0 : 0, v = i.useCallback(async e => {
        let a = new Date;
