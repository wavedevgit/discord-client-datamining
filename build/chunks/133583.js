...
function W(e) {
    ...
    return (0, n.jsxs)("div", {
        className: F.$s,
        children: [t.length > 0 || null != a ? (0, n.jsx)(M.A, {
...
function H(e) {
    ...
    return (0, n.jsx)(c.Button, {
        ...
        size: "sm",
        icon: c.U1X,
        text: G.intl.formatToPlainString(G.t["HDT/rg"], {
...
function B(e) {
    ...
    } = e, d = (0, m.A)(i), o = l.useMemo(() => {
        if (0 === i.length) return null;
        let e = d.reduce((e, t) => (null == t || (e[t.id] = t), e), {});
        if (1 === i.length) {
            let t = e[i[0]];
            return null == t ? null : (0, n.jsx)(H, {
                application: t,
                handleOpenGameShop: a,
                handleOpenGameShopMouseDown: r
            })
...
function V(e) {
    ...
    } = e, m = s.id, h = (0, d.bG)([C.A], () => C.A.getWishlistSettings(i.id, m)), {
        trackUserProfileWishlistAction: x
    } = (0, y.NJ)(), A = !1 === i.nsfwAllowed, [p, f] = l.useState(!0);
    l.useEffect(() => {
    ...
    let I = l.useCallback(e => {
        ...
        j = (0, w.A)({
            wishlistId: m,
            onAction: I,
            productLines: s?.getProductLines() ?? null
        }),
        S = l.useCallback(() => {
            if (null == m) return;
            let e = p ? r.a.PRIVATE : r.a.PUBLIC;
            f(!p), v.A.updateWishlistVisibility(m, e), x({
                wishlistId: m,
    ...
    return (0, n.jsxs)(n.Fragment, {
        children: [!p && (0, n.jsxs)("div", {
            ...
            children: [(0, n.jsx)(c.Text, {
                ...
                color: "text-subtle",
                children: G.intl.format(G.t.r6Y1Lg, {
...
function z(e) {
    ...
    let M = (0, I.A)({
        ...
        D = l.useCallback(e => {
            let t = f.A.getGuildIdFromApplicationId(e);
            null != t && ((0, o.closeAllModals)(), (0, j.default)({
                guildId: t
            }))
        }, []),
        {
