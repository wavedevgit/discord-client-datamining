...
function W(e) {
    ...
    } = e, x = a.id, p = (0, o.bG)([T.A], () => T.A.getWishlistSettings(n.id, x)), {
        trackUserProfileWishlistAction: f
    } = (0, E.NJ)(), h = !1 === n.nsfwAllowed, [A, I] = l.useState(!0);
    l.useEffect(() => {
    ...
    let j = l.useCallback(e => {
        ...
        b = l.useCallback(() => {
            ...
            I(!A), _.A.updateWishlistVisibility(x, e), f({
                wishlistId: x,
...
function H(e) {
    ...
    }), B = (0, A.GG)("user-profile-modal-v2-wishlist"), X = (0, I.Gh)("user-profile-modal-v2-wishlist"), z = N && (H && U || B), V = l.useCallback(() => {
