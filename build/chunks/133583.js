...
function H(e) {
    ...
    return (0, n.jsxs)("div", {
        className: D.$s,
        children: [t.length > 0 || null != a ? (0, n.jsx)(_.A, {
...
function z(e) {
    ...
    } = e, m = s.id, h = (0, d.bG)([N.A], () => N.A.getWishlistSettings(i.id, m)), {
        trackUserProfileWishlistAction: x
    } = (0, C.NJ)(), A = !1 === i.nsfwAllowed, [p, f] = l.useState(!0);
    l.useEffect(() => {
    ...
    let I = l.useCallback(e => {
        ...
        j = (0, R.A)({
            wishlistId: m,
            onAction: I,
            productLines: null != s ? (0, T.y9)(s) : null
        }),
        S = l.useCallback(() => {
            if (null == m) return;
