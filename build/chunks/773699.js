...
let T = e => {
    let t, {
        ...
        I = (0, o.bG)([f.A], () => f.A.getGuild(y ?? T.guild_id)),
        ...
        G = "" !== D,
        {
            ...
            options: {
                limit: _.YC,
                includeFrecency: !G,
                scoreMethod: G ? d.M.COMMAND_OR_APPLICATION : void 0
            },
            allowFetch: !0
        }),
        {
    ...
    if (U) t = (0, l.jsx)(s.Drp, {
        ...
        if (0 === N.length) t = (0, l.jsxs)(l.Fragment, {
        ...
        else if (G) t = (0, l.jsxs)(l.Fragment, {
            children: [F, (0, l.jsx)(s.bXX, {}), N.map(e => L(e, {
                showAppIcon: !0
            }))]
        });
        else {
