...
let S = new I(a.h, {
    ...
    LOAD_PINNED_MESSAGES_SUCCESS: function(e) {
        ...
        s.items = [...s.items, ...r], s.state = i ? "LOADED_HAS_MORE" : "LOADING_FINISHED"
    },
    ...
    GUILD_DELETE: function(e) {
        ...
        D = r()(D).filter(e => e.guildId !== t.id).keyBy("id").value()
    },
    MESSAGE_DELETE: function(e) {
        ...
        if (null == i || 0 === r().remove(i.items, e => {
                let {
                    message: n
                } = e;
                return n.id === t
    ...
    MESSAGE_UPDATE: function(e) {
        ...
        if (null == e.message.author) {
            ...
            let {
                pinnedAt: l,
                message: a
            } = i.items[s], c = (0, o.IU)(a, e.message);
            if (c !== a) {
                let e = i.items.slice();
                e[s] = {
                    pinnedAt: l,
