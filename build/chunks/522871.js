...
function u(e) {
    ...
    }, [I, n.id, n.guild_id, T, f]), N = o.A.useExperiment({
        location: "836a4b_1"
    }, {
        disable: !E || !u,
        autoTrackExposure: !0
    }).enabled, g = (0, l.K)(C, 0, N);
    return i.useEffect(() => () => {
        c.A.handleMessageLostVisibility(I, c.K.ANNOUNCEMENT)
    }, [I]), g
}