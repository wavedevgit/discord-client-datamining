...
function b(e) {
    let {
        ...
        initialTab: n,
        guildId: s
    } = e, a = (0, r.bG)([g.A], () => g.A.getGuild(s)), S = (0, r.bG)([_.A], () => _.A.isViewingServerShop(s)), b = (0, x.P)(a), y = (0, u.w)(s), v = a?.features.has(N.GuildFeatures.PRODUCTS_AVAILABLE_FOR_PURCHASE) === !0, j = (0, A.Oh)(a?.id), R = (0, h.Tq)(s)?.server_shop_tab_order, O = [], L = E.B.GUILD_SHOP_FULL_PREVIEW;
