...
function y(e) {
    let {
        ...
        initialTab: n,
        guildId: r
    } = e, s = (0, a.bG)([p.A], () => p.A.getGuild(r)), O = (0, a.bG)([T.A], () => T.A.isViewingServerShop(r)), y = (0, m.P)(s), x = (0, d.w)(r), f = s?.features.has(g.GuildFeatures.PRODUCTS_AVAILABLE_FOR_PURCHASE) === !0, P = (0, E.Oh)(s?.id), D = (0, _.Tq)(r)?.server_shop_tab_order, U = [], M = R.B.GUILD_SHOP_FULL_PREVIEW;
    ...
    return l.useEffect(() => {
        ...
        value: {
            ...
            handlePreviewDismiss: e => {
                ...
                L === R.B.GUILD_PRODUCTS_PREVIEW ? (e.stopPropagation(), j(R.B.GUILD_ROLE_SUBSCRIPTIONS), t.action_taken = S.hN.DISMISS_TAB_PREVIEW) : ((0, A.bG)(g.BVt.CHANNEL(r, I.Ay.getDefaultChannel(r)?.id)), t.action_taken = S.hN.DISMISS_FULL_PREVIEW), N.default.track(g.HAw.GUILD_SHOP_PREVIEW_CLICK, t)
            }
        },
        children: t
    })
