...
function v(e) {
    let {
        ...
        initialTab: a,
        guildId: r
    } = e, i = (0, s.bG)([h.A], () => h.A.getGuild(r)), f = (0, s.bG)([p.A], () => p.A.isViewingServerShop(r)), v = (0, g.P)(i), b = (0, _.w)(r, "guild_shop_page"), y = i?.features.has(R.GuildFeatures.PRODUCTS_AVAILABLE_FOR_PURCHASE) === !0, L = (0, S.Oh)(i?.id), P = (0, d.Tq)(r)?.server_shop_tab_order, N = [], G = C.B.GUILD_SHOP_FULL_PREVIEW;
    ...
    return l.useEffect(() => {
        ...
        value: {
            ...
            handlePreviewDismiss: e => {
                ...
                U === C.B.GUILD_PRODUCTS_PREVIEW ? (e.stopPropagation(), O(C.B.GUILD_ROLE_SUBSCRIPTIONS), t.action_taken = E.hN.DISMISS_TAB_PREVIEW) : ((0, A.bG)(R.BVt.CHANNEL(r, m.Ay.getDefaultChannel(r)?.id)), t.action_taken = E.hN.DISMISS_FULL_PREVIEW), I.default.track(R.HAw.GUILD_SHOP_PREVIEW_CLICK, t)
            }
        },
        children: t
    })
