/** chunk id: 954540 params = (module,exports,require) **/
"use strict";
n.d(t, {
    Ay: () => ed
});
...
let ed = i.memo(function(e) {
    let {
        ...
        let s = (0, h.bG)([q.Ay], () => q.Ay.getCurrentSidebarChannelId(l.parent_id) === l.id),
            ...
            r = function(e) {
                let {
                ...
                } = e, s = i.useMemo(() => null != t ? (0, P.A)(t, t?.messageSnapshots[0]) : null, [t]), {
                    hasSpoilerEmbeds: a,
                    content: r
                } = i.useMemo(() => s?.content != null && "" !== s.content ? (0, G.Ay)(s, {
                    formatInline: n,
                    ...
                    hasSpoilerEmbeds: !1,
                    content: null
                }, [n, s, l]), o = (0, E.Ky)(t, a), d = (0, E.L_)(t, a);
                return null == t ? null : {
                    hasSpoilerEmbeds: a,
                    content: r,
                    firstMedia: o,
    ...
    return (0, l.jsxs)("div", {
        ...
        onClick: w,
        onContextMenu: D,
        className: a()(er.kL, ea.kL, d, {
            [er.nT]: x
        }),
        children: [(0, l.jsx)(g.DUT, {
            onClick: w,
            focusProps: {
                ringTarget: T
            },
...
let eu = i.memo(function(e) {
    let {
        ...
        hasUnreads: r,
        originalAuthor: o
    } = e, d = (0, h.bG)([I.A], () => I.A.isLoading(n.id)), c = (0, h.bG)([X.A], () => X.A.can(el.xBc.MANAGE_MESSAGES, n)), u = K.gs.useSetting(), m = (0, h.bG)([Q.A], () => Q.A.getGuildId()), {
...
function em(e) {
    let {
        ...
        isNew: s
    } = (0, S.X5)(t), a = (0, A.Ay)(t), r = (0, C.m)(t.id), o = i?.reactions != null && i.reactions.length > 0;
    return (0, l.jsxs)("div", {
        className: ea.qr,
        children: [(0, l.jsxs)("div", {
            className: ea.JS,
            ...
            className: ea.PQ,
            children: [o || null == i ? null : (0, l.jsx)(ex, {
                firstMessage: i,
                channel: t
            }), (0, l.jsx)(eh, {
                channel: t,
...
function ex(e) {
    let {
        firstMessage: t,
        channel: n
    } = e, i = (0, h.bG)([$.A], () => $.A.getChannel(n.parent_id)), s = (0, S.Ck)(i), {
        disableReactionCreates: a,
        isLurking: r,
        isPendingMember: o
    } = (0, z.A)(n);
    return null == s || a ? null : (0, l.jsx)(B.qT, {
        className: er.vC,
        message: t,
...
function eg(e) {
    let {
        ...
        sortOrder: n
    } = (0, N.R)(t.parent_id), i = (0, S.Mw)(t, n), s = t.threadMetadata?.createTimestamp, a = null == s ? null : es.intl.formatToPlainString(es.t["13euCd"], {
        timestamp: (0, ee.i$)(c()(s), "LLLL")
    });
    return (0, l.jsx)(x.m, {
        text: a,
...
function ep(e) {
    ...
    return (0, l.jsx)(g.M1G, {
        ...
        children: (0, l.jsxs)("div", {
            ...
            onClick: function(e) {
                e.stopPropagation(), r && (e.preventDefault(), e.nativeEvent.stopImmediatePropagation(), j.A.showAgeVerificationGetStartedModal({
                    entryPoint: b.q1.FORUM_POST_MEDIA_PREVIEW
                }))
            },
            children: [(0, l.jsx)(e_, {
                firstMedia: n,
