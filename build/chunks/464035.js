/** chunk id: 464035 params = (module,exports,require) **/
l.d(t, {
    default: () => E
});
var n = l(627968),
...
class w extends a.PureComponent {
    constructor(e) {
        ...
        const {
            guilds: t,
            lastChannelFollowingDestination: l
        } = e, {
            guildId: n,
            channelId: a
        } = l;
    ...
    handleFollow = () => {
        ...
        null != a && (this.setState({
            ...
            o.h.dispatch({
                ...
                let {
                    default: e
                } = await l.e("9795").then(l.bind(l, 993390));
                return t => (0, n.jsx)(e, {
                    ...t
                })
            })
        }).catch(e => {
            e.body.code === N.t02.TOO_MANY_WEBHOOKS ? this.setState({
                errorMessage: S.intl.string(S.t["1eZ4aB"]),
                submitting: !1
            }) : this.setState({
                errorMessage: S.intl.string(S.t.LgwhuN),
                submitting: !1
            })
        }))
    };
    ...
    renderForm() {
        let {
            ...
            selectedChannelId: a,
            errorMessage: s
        } = this.state, i = y.default.keys(e).map(t => {
            let {
                guild: l
            } = e[t];
            return {
                ...
                value: t,
                label: l.name,
                leading: null == l ? null : (0, n.jsx)(m.Ay, {
                    guild: l,
        ...
        }), o = 0 === i.length, c = o ? S.intl.string(S.t["6b6QoF"]) : S.intl.string(S.t.Z0quyN);
    ...
    render() {
        ...
        return (0, n.jsxs)(d.EOs, {
            ...
            children: [this.renderHeader(), (0, n.jsxs)(d.$mQ, {
                className: v.Qs,
...
let E = r.Ay.connectStores([_.A, b.A, j.default, C.A, x.Ay, A.A, p.A], e => {
    let {
        channel: t
    } = e, l = _.A.getGuild(t.guild_id), n = _.A.getGuildsArray().reduce((e, t) => {
        let l = x.Ay.getChannels(t.id).SELECTABLE.map(e => e.channel).filter(e => e.type === N.rbe.GUILD_TEXT && A.A.can(N.xBc.MANAGE_WEBHOOKS, e)).map(e => {
            let t = p.A.getChannel(e.parent_id);
            return {
                channel: e,
                category: null != t ? (0, h.m1)(t, j.default, C.A) : null
            }
        });
