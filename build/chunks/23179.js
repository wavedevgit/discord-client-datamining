/** chunk id: 23179 params = (module,exports,require) **/
"use strict";
n.d(t, {
    A: () => F
});
    ...
    autoAnalytics = (() => {
        ...
        return function() {
            ...
            e.props.messages.forEach(e => {
                null != e.content && "" !== e.content && (n++, /https?:\/\/[^\s]+/.test(e.content) && l++), null != e.embeds && e.embeds.length > 0 && s++, null != e.attachments && e.attachments.length > 0 && i++
            });
...
function k(e) {
    ...
    if (C) return (0, i.jsxs)(P, {
        children: [(0, i.jsx)("div", {
            className: G.M6
        }), (0, i.jsx)("div", {
            className: a()(G.pZ, G.gJ),
...
let V = [],
    B = s.memo(function(e) {
        let {
            ...
            selectedChannelId: O
        } = e, M = s.useRef(null), U = s.useCallback(() => {
            I.A.cleanUpSearchState(t)
        }, [t]);
        s.useEffect(() => (g._.subscribe(L.jej.SEARCH_RESULTS_CLOSE, U), () => {
            g._.unsubscribe(L.jej.SEARCH_RESULTS_CLOSE, U)
        }), [U]);
...
function H(e) {
    let {
        ...
        let [e, t] = s.useState(!1), n = (0, x.H)({
            location: "SearchResults"
        });
        return (0, u.Ay)(() => {
            n && A.A.possiblyShowFeedbackModal(M.MW.SEARCH_RESULTS, () => t(!0), () => t(!1))
        }), {
        ...
        searchContext: t
    }), E = (0, r.bG)([T.A], () => T.A.getSearchMode(o) ?? L.BBH.NEWEST), N = s.useCallback(e => {
    ...
    }, [c.isSearching, t]), v = (0, r.bG)([T.A], () => {
        let e = (0, f.bS)(t);
        return T.A.getSearchResultsQuery(e)
    }), y = s.useCallback(e => C.A.setShowBlockedResults(t, e), [t]), j = s.useDeferredValue(h), R = s.useDeferredValue(c), O = s.useDeferredValue(d);
