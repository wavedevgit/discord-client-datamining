...
let V = [],
    B = s.memo(function(e) {
        ...
        s.useEffect(() => (_._.subscribe(L.jej.SEARCH_RESULTS_CLOSE, U), () => {
            _._.unsubscribe(L.jej.SEARCH_RESULTS_CLOSE, U)
        }), [U]);
...
function H(e) {
    ...
    }), y = s.useCallback(e => E.A.setShowBlockedResults(t, e), [t]), j = s.useDeferredValue(h), R = s.useDeferredValue(c), O = s.useDeferredValue(d);
