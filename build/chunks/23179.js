...
let V = [],
    B = s.memo(function(e) {
        ...
        s.useEffect(() => (p._.subscribe(L.jej.SEARCH_RESULTS_CLOSE, U), () => {
...
function H(e) {
    ...
    })), d = (0, a.bG)([g.A], () => g.A.getAnalyticsId(o)), {
        renderedMessages: h,
        ignoreCount: _,
        blockCount: p
    } = (0, b.A)({
        searchContext: t
    }), E = (0, a.bG)([T.A], () => T.A.getSearchMode(o) ?? L.BBH.NEWEST), N = s.useCallback(e => {
