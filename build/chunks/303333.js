...
function I(e) {
    let {
        ...
        imageUrl: n,
        isConnected: s
    } = e, r = (0, h.S)(n), c = l.useCallback(() => {
        (0, p.A)({
            channel: t
        })
    }, [t]), _ = l.useCallback(() => {
        (0, A.e)(t.id)
    }, [t.id]), m = l.useCallback(() => {
...
function N(e) {
    ...
    }), a = (0, r.bG)([c.A], () => c.A.getChannelStatus(t), [t]), o = l.useMemo(() => (0, m.TP)(a), [a]), d = l.useMemo(() => null == a ? null : (0, m.K7)(a), [a]);
    return s ? null != a && o && null != d ? (0, i.jsx)(I, {
        channel: t,
        imageUrl: d,
        isConnected: n
    }) : n ? (0, i.jsx)(C, {
