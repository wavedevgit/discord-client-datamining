...
let u = new Set(["PageDown", "PageUp", "Home", "End", "ArrowUp", "ArrowDown", "ArrowLeft", "ArrowRight"]),
    ...
    I = {
        ...
        keydown(e, t) {
            ...
            if ((0, i.Cw)(n) || r.rxt.isActive() || A.has(t) || E.has(t) || g.has(t)) return !1;
            let I = null != n && "BODY" === n.tagName;
            return !(s.A.keyboardModeEnabled && !I && !/^[a-zA-Z0-9]$/.test(t) || d._.hasSubscribers(_.jej.MODAL_CLOSE) || a.A.hasLayers()) && ("Tab" === t && d._.hasSubscribers(_.jej.TEXTAREA_FOCUS) && null != document.querySelector('[data-can-focus="true"]') ? (e.preventDefault(), d._.dispatch(_.jej.TEXTAREA_FOCUS), !1) : !(o.A.isConnected() && l.Ay.getMode() === _.TBI.PUSH_TO_TALK && !l.Ay.isSelfMute() && Object.values(l.Ay.getShortcuts()).map(c.pi).some(t => t.map(e => e.keyCode).includes(e.keyCode))) && void(!e.metaKey && !e.ctrlKey && !u.has(t) && d._.dispatchToLastSubscribed(_.jej.TEXTAREA_FOCUS)))
        }
    }