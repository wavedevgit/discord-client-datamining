/** chunk id: 354096 params = (module,exports,require) **/
n.d(e, {
    default: () => d
});
var a = n(627968),
...
function d(t) {
    let {
        transitionState: e,
        onClose: n
    } = t, d = (0, i.bG)([l.default], () => l.default.getCurrentUser());
    ...
    switch (h) {
        ...
        case g.ko.CHANGE_EMAIL_REASONS:
            return (0, a.jsx)(c.A, {
                onNext: () => (o.default.track(N.HAw.USER_ACCOUNT_EMAIL_CHANGE_REASON_CONTINUE, {
        ...
        case g.ko.CHANGE_EMAIL_WARNING:
            return (0, a.jsx)(C.A, {
                onNext: () => {
                    o.default.track(N.HAw.USER_ACCOUNT_EMAIL_CHANGE_WARNING_CONTINUE, {
                        change_email_reason_enum: M
        ...
        case g.ko.EMAIL_AND_PASSWORD:
            return (0, a.jsx)(_.A, {
                emailToken: p,
                onBack: k ? () => x(null != M && S.qr.has(M) ? g.ko.CHANGE_EMAIL_WARNING : g.ko.CHANGE_EMAIL_REASONS) : null,
                onNext: t => {
                    o.default.track(N.HAw.USER_ACCOUNT_EMAIL_CHANGE_SAVE_NEW_EMAIL, {
                        change_email_reason_enum: M
                    }), v(t), x(g.ko.COMPLETE)
                },
                onClose: n,
