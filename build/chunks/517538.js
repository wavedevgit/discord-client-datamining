...
function j() {
    let {
        name: e
    } = (0, x.x5)(g.oh.AUDIO_INPUT), [t, n] = i.useState(!1), [s, l] = i.useState([]), b = (0, r.bG)([p.Ay], () => p.Ay.getKrispSuppressionLevel()), [j, C] = i.useState(null), A = i.useRef(null), T = i.useRef(null), [S, y] = i.useState(.5), {
        krispModels: E,
    ...
    function H(e) {
        ...
        n.buffer = e.audioBuffer, T.current = F.createGain(), T.current.gain.value = S, n.connect(T.current), T.current.connect(F.destination), n.loop = !0, n.start(), A.current = n, C(e)
    }
    i.useEffect(() => {
        V()
    }, [V]), (0, u.l0)(() => {
        c.A.setMode(p.Ay.getMode(), {
        ...
        children: (0, a.jsxs)("div", {
            ...
            children: [(0, a.jsx)(d.Text, {
                ...
                asValueChanges: function(e) {
                    null != T.current && (T.current.gain.value = e, y(e))
                },
                minValue: 0,
                maxValue: 1
            }), (0, a.jsxs)(d.BJc, {
