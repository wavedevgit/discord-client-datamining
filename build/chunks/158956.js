/** chunk id: 158956, original params: t,e,n (module,exports,require) **/
n.d(e, {
    default: () => S
});
var r = n(627968),
...
let h = t => {
    let {
        ...
        channel: n,
        onSelectChannel: i
    } = t, l = (0, a.yK)([c.Ay], () => c.Ay.getChannels(e)[c.I6].filter(t => {
        let {
            channel: e
        } = t;
    ...
    return (0, r.jsx)(s.ZiE, {
        ...
        options: l.map(t => ({
            id: t.id,
            value: t.id,
            label: (0, A.m1)(t, E.default, d.A, !0)
        })),
        onSelectionChange: t => {
...
function S(t) {
    let {
        ...
        onClose: E,
        transitionState: S
    } = t, [_, C] = i.useState(e.metadata.channelId), [g, H] = i.useState(null), I = (0, a.bG)([u.A], () => u.A.getChannel(_), [_]), L = (0, o.x)(e.type, e, n);
