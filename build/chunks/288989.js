...
function j(e) {
    ...
    if (c || o)
        for (let e = A.length - 1; e >= 0; e--) {
            let t = A[e];
            (T(t.id) || l().some(t.threadIds, T)) && (null == s && (s = t.id), f = !0), (v(t.id) || l().some(t.threadIds, v)) && (null == i && (i = t.id), _ += m.Ay.getMentionCount(t.id), _ += l().sumBy(t.threadIds, m.Ay.getMentionCount))
        }
    if (c || o)
