/** chunk id: 323737 params = (module,exports,require) **/
"use strict";
n.d(t, {
    A: () => o
...
let o = new class {
    ...
    async publicKeyFingerprint(e) {
        return s()(null != e.publicKey, "public key cannot be null"), l(await window.crypto.subtle.exportKey("spki", e.publicKey))
    }
