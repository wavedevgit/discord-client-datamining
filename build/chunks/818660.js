...
class M extends s.PureComponent {
    get keybindActionTypes() {
        let {
            ...
            label: O.intl.string(O.t["0Uh579"])
        }, {
            id: "push-to-talk",
            value: j.hCu.PUSH_TO_TALK,
            label: O.intl.string(O.t.Y5lgTP)
        }, {
            id: "push-to-talk-priority",
            value: j.hCu.PUSH_TO_TALK_PRIORITY,
            label: O.intl.string(O.t.DkSwJ2)
        }, {
            id: "push-to-mute",
            value: j.hCu.PUSH_TO_MUTE,
            label: O.intl.string(O.t.hSCRqd)
        }, {
            id: "vad-priority",
            value: j.hCu.VAD_PRIORITY,
            label: O.intl.string(O.t["49d6Nd"])
        }, {
            id: "toggle-mute",
            value: j.hCu.TOGGLE_MUTE,
            label: O.intl.string(O.t.PlkYKD)
        }, {
            id: "toggle-deafen",
            value: j.hCu.TOGGLE_DEAFEN,
            label: O.intl.string(O.t.NvGq1K)
        }, {
            id: "toggle-voice-mode",
            value: j.hCu.TOGGLE_VOICE_MODE,
            label: O.intl.string(O.t.Wa5H9S)
        }, {
        ...
        return (0, h.L)() && l.push({
            ...
            label: O.intl.string(O.t.gRSaOa)
        }, {
            id: "navigate-forward",
            value: j.hCu.NAVIGATE_FORWARD,
            label: O.intl.string(O.t.zOXpjU)
        }, {
            ...
            label: O.intl.string(O.t.yPH4xm)
        }, {
            id: "soundboard-hold",
            value: j.hCu.SOUNDBOARD_HOLD,
            label: O.intl.string(O.t["1xFbP/"])
        }), i && (l.push({
            id: "save-clip",
            value: j.hCu.SAVE_CLIP,
            label: O.intl.string(O.t.U4URzP)
        }), s && l.push({
            id: "save-screenshot",
    ...
    get keybindDescriptions() {
        ...
        return (0, h.L)() && (s[j.hCu.TOGGLE_CAMERA] = O.intl.string(O.t.v1JBtL)), e && (s[j.hCu.TOGGLE_OVERLAY_INPUT_LOCK] = O.intl.string(O.t.IoP5vc)), t && (0, b.isWindows)() && (s[j.hCu.TOGGLE_GO_LIVE_STREAMING] = O.intl.string(O.t.s4C238)), (0, b.isDesktop)() && (s[j.hCu.NAVIGATE_BACK] = O.intl.string(O.t.nKDlEt), s[j.hCu.NAVIGATE_FORWARD] = O.intl.string(O.t.DK0FFk), s[j.hCu.SOUNDBOARD] = (0, b.isWindows)() ? O.intl.string(O.t["5wJefL"]) : O.intl.string(O.t.gzjsSP), s[j.hCu.SOUNDBOARD_HOLD] = (0, b.isWindows)() ? O.intl.string(O.t.RRkZc9) : O.intl.string(O.t.laNlTl), n && (s[j.hCu.SAVE_CLIP] = O.intl.string(O.t.z3Wbam), i && (s[j.hCu.SAVE_SCREENSHOT] = O.intl.string(O.t.m0zd57)))), s
    }
    handleAddKeybind = () => {
        u.A.addKeybind()
    };renderKeybinds(e) {
        ...
        return (0, i.jsxs)(i.Fragment, {
            children: [(0, i.jsx)(I.A, {
                ...
                children: b.isPlatformEmbedded ? (0, i.jsxs)(i.Fragment, {
                    ...
                    className: R.Ly,
                    children: O.intl.format(O.t.mPi3F3, {
