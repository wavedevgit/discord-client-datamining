...
class G extends s.PureComponent {
    ...
    get keybindDescriptions() {
        ...
        return (0, p.L)() && (s[j.hCu.TOGGLE_CAMERA] = O.intl.string(O.t.v1JBtL)), e && (s[j.hCu.TOGGLE_OVERLAY_INPUT_LOCK] = O.intl.string(O.t.IoP5vc)), t && (0, N.isWindows)() && (s[j.hCu.TOGGLE_GO_LIVE_STREAMING] = O.intl.string(O.t.s4C238)), (0, N.isDesktop)() && (s[j.hCu.NAVIGATE_BACK] = O.intl.string(O.t.nKDlEt), s[j.hCu.NAVIGATE_FORWARD] = O.intl.string(O.t.DK0FFk), s[j.hCu.SOUNDBOARD] = (0, N.isWindows)() ? O.intl.string(O.t["5wJefL"]) : O.intl.string(O.t.gzjsSP), s[j.hCu.SOUNDBOARD_HOLD] = (0, N.isWindows)() ? O.intl.string(O.t.RRkZc9) : O.intl.string(O.t.laNlTl), n && (s[j.hCu.SAVE_CLIP] = O.intl.string(O.t.z3Wbam), i && (s[j.hCu.SAVE_SCREENSHOT] = O.intl.string(O.t.m0zd57)))), s
    }
    handleAddKeybind = () => {
        u.A.addKeybind()
    };renderKeybinds(e) {
