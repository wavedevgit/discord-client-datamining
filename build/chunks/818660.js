...
class P extends s.PureComponent {
    ...
    renderExtraSettings() {
        ...
        return e === I.hCu.SWITCH_TO_VOICE_CHANNEL ? (0, i.jsx)(v.A, {
...
class D extends s.PureComponent {
    get keybindActionTypes() {
        ...
        })), t && ((0, b.isWindows)() || f.Ay.getUseSystemScreensharePicker()) && l.push({
            id: "toggle-go-live-streaming",
            value: I.hCu.TOGGLE_GO_LIVE_STREAMING,
            label: y.intl.string(y.t.ybdjJD)
        }), (0, b.isDesktop)() && (l.push({
            id: "navigate-back",
    ...
    get keybindDescriptions() {
        ...
        return e && (s[I.hCu.TOGGLE_OVERLAY_INPUT_LOCK] = y.intl.string(y.t.IoP5vc)), t && (0, b.isWindows)() && (s[I.hCu.TOGGLE_GO_LIVE_STREAMING] = y.intl.string(y.t.s4C238)), (0, b.isDesktop)() && (s[I.hCu.NAVIGATE_BACK] = y.intl.string(y.t.nKDlEt), s[I.hCu.NAVIGATE_FORWARD] = y.intl.string(y.t.DK0FFk), s[I.hCu.SOUNDBOARD] = (0, b.isWindows)() ? y.intl.string(y.t["5wJefL"]) : y.intl.string(y.t.gzjsSP), s[I.hCu.SOUNDBOARD_HOLD] = (0, b.isWindows)() ? y.intl.string(y.t.RRkZc9) : y.intl.string(y.t.laNlTl), n && (s[I.hCu.SAVE_CLIP] = y.intl.string(y.t.z3Wbam), i && (s[I.hCu.SAVE_SCREENSHOT] = y.intl.string(y.t.m0zd57)))), s
    }
    handleAddKeybind = () => {
        u.A.addKeybind()
    };renderKeybinds(e) {
    ...
    render() {
        ...
        } = this.props, n = r()(this.props.keybinds).reject(e => e.managed && ![I.hCu.OVERLAY_ACTIVATE_REGION_TEXT_WIDGET, I.hCu.SAVE_CLIP, I.hCu.SAVE_SCREENSHOT].includes(e.action)).reject(t => !e && (t.action === I.hCu.SAVE_CLIP || t.action === I.hCu.SAVE_SCREENSHOT)).reject(e => !t && e.action === I.hCu.SAVE_SCREENSHOT).reject(e => !this.props.allowSoundboard && (e.action === I.hCu.SOUNDBOARD || e.action === I.hCu.SOUNDBOARD_HOLD)).sortBy(e => e.id).sortBy(e => !0 === e.managed ? -1 : 0).value(), l = r()((0, _.Bx)()).filter(e => e.description !== y.intl.string(y.t.HnNtEI)).groupBy(e => e.group).value();
