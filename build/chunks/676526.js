...
function I(e) {
    ...
    return (0, i.jsx)(u.mG, {
        ...
        itemPreviewProps: {
            imageSrc: s,
            gameName: r,
            getWidth: () => g.current?.offsetWidth
        },
...
function v(e) {
    ...
    } = (0, m.r)(), S = (0, f.A)(t.applicationId).length > 0, y = c.default.getCurrentUser(), R = y?.id === n, O = !_ && R, {
        isDragging: w
    } = (0, r.V)(e => ({
