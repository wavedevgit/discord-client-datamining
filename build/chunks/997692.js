...
function u(e) {
    let {
        ...
        onClick: h,
        onClose: A
    } = e, _ = (0, l.bG)([r.A], () => null != d && r.A.getGlobalCatalogGame(d)?.can_market === !0, [d]);
    return (0, i.jsx)(a.AM, {
        size: "lg",
        title: t,
        body: n,
...
function h(e) {
    ...
    return (0, i.jsx)(u, {
        title: d.intl.formatToPlainString(o.default.lKzVNu, {
            gameName: t
        }),
...
function A(e) {
    ...
    return (0, i.jsx)(u, {
        title: d.intl.formatToPlainString(o.default.lwwiHE, {
            gameName: t
        }),
