...
function H(e) {
    let {
        guildEvent: t,
        noticeType: n
    } = e, i = (0, j.G3)(t), l = (0, o.bG)([x.Ay], () => x.Ay.isInterestedInEventRecurrence(t.id, i), [t.id, i]), r = (0, o.bG)([y.A], () => y.A.getUpcomingNoticeSeenTime(t.id), [t.id]);
    return l || null != r || (0, v.pE)(t.id), (0, a.jsx)(d.Button, {
        onClick: function() {
...
function q(e) {
    let {
        stageInstance: t,
        channel: n
    } = e, i = (0, u.Ay)(n), l = (0, o.yK)([m.A], () => [...new Set(m.A.getMutableParticipants(n.id, g.ip.SPEAKER).map(e => e.user))], [n.id]), r = (0, o.bG)([m.A], () => m.A.getParticipantCount(n.id, g.ip.AUDIENCE), [n.id]), s = G.intl.formatToPlainString(G.t["+v2pN2"], {
        count: `${r}`
    });
    return (0, a.jsx)(V, {
        onClickCloseIcon: () => (0, v.iF)({
...
function $(e) {
    let {
        ...
        speakers: n,
        voiceType: i
    } = e, r = t.getGuildId(), u = l.useMemo(() => n.slice(0, 3), [n]), A = (0, o.bG)([f.A], () => f.A.can(U.xBc.CONNECT, t)), h = (0, I.A)(t.id), _ = G.intl.string(G.t.VJlc0S);
    switch (i) {
        case 1:
...
let X = l.memo(function(e) {
    let {
        guild: t
    } = e, n = (0, L.V)(t.id), i = (0, P.BP)(t.id), l = (0, P.WG)(t.id), r = (0, o.bG)([E.A], () => E.A.getStageInstanceByChannel(n?.id), [n]), {
