...
function F(e) {
    ...
    return r || null != l || (0, b.pE)(t.id), (0, a.jsx)(d.Button, {
        onClick: function() {
...
function z(e) {
    let {
        stageInstance: t,
        channel: n
    } = e, i = (0, o.yK)([p.A], () => [...new Set(p.A.getMutableParticipants(n.id, g.ip.SPEAKER).map(e => e.user))], [n.id]), r = (0, o.bG)([p.A], () => p.A.getParticipantCount(n.id, g.ip.AUDIENCE), [n.id]), l = k.intl.formatToPlainString(k.t["+v2pN2"], {
        count: `${r}`
    });
    return (0, a.jsx)(B, {
        onClickCloseIcon: () => (0, b.iF)({
