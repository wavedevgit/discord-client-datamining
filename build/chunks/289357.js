...
function B(e) {
    let {
        guildEvent: t,
        channel: n
    } = e, i = (0, u.Ay)(n), a = (0, o.yK)([C.Ay], () => C.Ay.getVoiceStatesForChannel(n).map(e => {
        let {
            user: t
        } = e;
        return t
...
function H(e) {
    let {
        guildEvent: t,
        noticeType: n
    } = e, i = (0, j.G3)(t), a = (0, o.bG)([x.Ay], () => x.Ay.isInterestedInEventRecurrence(t.id, i), [t.id, i]), r = (0, o.bG)([y.A], () => y.A.getUpcomingNoticeSeenTime(t.id), [t.id]);
    return a || null != r || (0, b.pE)(t.id), (0, l.jsx)(d.Button, {
        onClick: function() {
            (0, M.A)(t.id, null, t.guild_id, () => setTimeout(() => (0, b.Lx)(t.id), 1e3)), T.default.track(U.HAw.CHANNEL_NOTICE_CTA_CLICKED, {
                guild_id: t.guild_id,
                notice_type: n
            })
        },
...
function F(e) {
    let {
        guildEvent: t,
        noticeType: n
    } = e, i = (0, D.oF)(t), r = null != i ? (0, O.l)(i, !0) : null, o = (0, D.WN)(t), c = (0, u.Ay)(o), h = (0, A.gU)(o), {
        startTime: _,
        endTime: m
    } = (0, R.Ay)(t), {
        ...
        upcomingEvent: p,
        diffMinutes: E
    } = (0, j.CC)(_.toISOString(), m?.toISOString()), I = p ? E > 0 ? G.intl.formatToPlainString(G.t.PQlCWk, {
        minutes: E
...
function q(e) {
    let {
        stageInstance: t,
        channel: n
    } = e, i = (0, u.Ay)(n), a = (0, o.yK)([m.A], () => [...new Set(m.A.getMutableParticipants(n.id, g.ip.SPEAKER).map(e => e.user))], [n.id]), r = (0, o.bG)([m.A], () => m.A.getParticipantCount(n.id, g.ip.AUDIENCE), [n.id]), s = G.intl.formatToPlainString(G.t["+v2pN2"], {
        count: `${r}`
    });
    return (0, l.jsx)(V, {
        onClickCloseIcon: () => (0, b.iF)({
...
function $(e) {
    let {
        ...
        speakers: n,
        voiceType: i
    } = e, r = t.getGuildId(), u = a.useMemo(() => n.slice(0, 3), [n]), A = (0, o.bG)([f.A], () => f.A.can(U.xBc.CONNECT, t)), h = (0, I.A)(t.id), _ = G.intl.string(G.t.VJlc0S);
    switch (i) {
        case 1:
            _ = G.intl.string(G.t.VJlc0S);
            break;
        case 2:
            _ = G.intl.string(G.t.ZYO5OK), h?.speaker ? _ = G.intl.string(G.t["/cnSFc"]) : null != h && (_ = G.intl.string(G.t.btSGOj));
            break;
        case 3:
...
let Q = a.memo(function(e) {
    let {
        guild: t
    } = e, n = (0, L.V)(t.id), i = (0, P.BP)(t.id), a = (0, P.WG)(t.id), r = (0, o.bG)([E.A], () => E.A.getStageInstanceByChannel(n?.id), [n]), {
    ...
    null == i || d ? u && (c = (0, l.jsx)(q, {
        stageInstance: r,
        channel: n
    })) : i.entity_type === w.Ps.STAGE_INSTANCE && u ? c = (0, l.jsx)(q, {
        stageInstance: r,
        channel: n
    }) : i.entity_type === w.Ps.EXTERNAL ? c = (0, l.jsx)(Y, {
        guildEvent: i
    }) : i.entity_type === w.Ps.VOICE && null != n && (c = (0, l.jsx)(B, {
        guildEvent: i,
        channel: n
    }));
