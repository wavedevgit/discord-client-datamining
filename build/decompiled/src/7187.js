...
module.exports = (function(global, require, metroImportDefault, metroImportAll, module, exports, dependencyMap) {
    ...
    var3 = function() {
        _fun58406: for (var _fun58406_ip = 0;;) switch (_fun58406_ip) {
            case 0:
                var0 = undefined;
                var3 = undefined;
    ...
    var3 = function arg0() {
        _fun58410: for (var _fun58410_ip = 0;;) switch (_fun58410_ip) {
            case 0:
                var0 = arg0;
                var0 = var0.skus;
            ...
            case 56:
                ...
                var3 = function*() { // Environment: var1
                    var0 = function*() { // Original name: ?anon_0_, environment: var0
                        _fun58412: for (var _fun58412_ip = 0;;) switch (_fun58412_ip) {
                            case 0:
                                StartGenerator();
    ...
    var3 = function arg0() {
        _fun58414: for (var _fun58414_ip = 0;;) switch (_fun58414_ip) {
            case 0:
                var0 = arg0;
                var0 = var0.skus;
                var _closure2_slot1 = var0;
            ...
            case 56:
                ...
                var3 = function*() { // Environment: var1
                    var0 = function*() { // Original name: ?anon_0_, environment: var0
                        _fun58416: for (var _fun58416_ip = 0;;) switch (_fun58416_ip) {
                            case 0:
                                StartGenerator();
                                ResumeGenerator(result_out_reg = 0, return_bool_out_reg = 1);
                                if (var1) {
    ...
    var3 = function() {
        _fun58418: for (var _fun58418_ip = 0;;) switch (_fun58418_ip) {
            case 0:
                var1 = undefined;
                var4 = undefined;
            ...
            case 31:
                ...
                var2 = function*() { // Environment: var0
                    var0 = function*() { // Original name: ?anon_0_, environment: var0
                        _fun58420: for (var _fun58420_ip = 0;;) switch (_fun58420_ip) {
                            case 0:
                                StartGenerator();
                                ResumeGenerator(result_out_reg = 0, return_bool_out_reg = 1);
                                if (var1) {
    ...
    var3 = function() {
        _fun58422: for (var _fun58422_ip = 0;;) switch (_fun58422_ip) {
            case 0:
                var1 = undefined;
                var4 = undefined;
                var2 = arguments.length;
    ...
    var3 = function arg0() {
        ...
        var2 = function*() { // Environment: var0
            var0 = function*() { // Original name: ?anon_0_, environment: var0
                _fun58432: for (var _fun58432_ip = 0;;) switch (_fun58432_ip) {
                    case 0:
                        StartGenerator();
                        ResumeGenerator(result_out_reg = 0, return_bool_out_reg = 1);
                        if (var1) {
    ...
    var3 = function arg0() {
        ...
        var2 = function*() { // Environment: var0
            var0 = function*() { // Original name: ?anon_0_, environment: var0
                _fun58438: for (var _fun58438_ip = 0;;) switch (_fun58438_ip) {
                    case 0:
                        StartGenerator();
                        ResumeGenerator(result_out_reg = 0, return_bool_out_reg = 1);
                        if (var1) {
    ...
    var3 = function arg0() {
        _fun58440: for (var _fun58440_ip = 0;;) switch (_fun58440_ip) {
            case 0:
                var1 = arg0;
                var2 = var1.sku;
                var _closure2_slot1 = var2;
    ...
    return var0;
})(undefined, undefined, undefined, undefined, undefined, undefined, [5, 27, 7188, 7189, 7194, 7195, 7196, 7197, 7198]);