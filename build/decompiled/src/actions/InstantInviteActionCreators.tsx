...
export default (function(global, require, metroImportDefault, metroImportAll, module, exports, dependencyMap) {
    ...
    var9 = function arg0() {
        ...
        var0 = function*() { // Environment: var0
            var0 = function*() { // Original name: ?anon_0_, environment: var0
                _fun52274: for (var _fun52274_ip = 0;;) switch (_fun52274_ip) {
                    case 0:
                        StartGenerator();
                        ResumeGenerator(result_out_reg = 0, return_bool_out_reg = 1);
                        if (var1) {
            ...
            var0 = function*() { // Original name: ?anon_0_, environment: var0
                _fun52286: for (var _fun52286_ip = 0;;) switch (_fun52286_ip) {
                    ...
                    case 10: // try_start_0
                        ...
                        var7.event = var8;
                        var8 = function arg0() {
                            _fun52287: for (var _fun52287_ip = 0;;) switch (_fun52287_ip) {
                                case 0:
                                    var5 = arg0;
                                    var1 = _closure1_slot0;
                                    var2 = _closure1_slot3;
    ...
    return var0;
})(undefined, undefined, undefined, undefined, undefined, undefined, [5, 3473, 3335, 1376, 1216, 1372, 1673, 1683, 1410, 5950, 3093, 3214, 1621, 660, 1219, 1379, 3507, 3336, 4235, 1384, 5961, 4580, 1232, 1220, 4231, 1307, 5962, 8280, 3634, 8084, 12189, 4547, 4826, 7514, 6893, 8257, 806, 12190, 4551, 4679, 795, 507, 3353, 667, 4525, 481, 1385, 3325, 4680, 4683, 4556, 3352, 12191, 12192, 12193, 6937, 3443, 12194, 12195, 490, 12197, 2]);