...
export default (function(global, require, metroImportDefault, metroImportAll, module, exports, dependencyMap) {
    ...
    var0 = function() {
        ...
        var2 = function*(arg0) { // Environment: var2
            var0 = function*(arg0) { // Original name: ?anon_0_, environment: var0
                _fun58232: for (var _fun58232_ip = 0;;) switch (_fun58232_ip) {
                    case 0:
                        StartGenerator();
                        var5 = arg0;
                        ResumeGenerator(result_out_reg = 0, return_bool_out_reg = 1);
    ...
    var0 = function() {
        ...
        var2 = function*(arg0, arg1, arg2) { // Environment: var2
            var0 = function*(arg0, arg1, arg2) { // Original name: ?anon_0_, environment: var0
                _fun58237: for (var _fun58237_ip = 0;;) switch (_fun58237_ip) {
                    case 0:
                        StartGenerator();
                        ResumeGenerator(result_out_reg = 0, return_bool_out_reg = 1);
                        if (var1) {
    ...
    var0 = function() {
        ...
        var2 = function*(arg0, arg1) { // Environment: var2
            var0 = function*(arg0, arg1) { // Original name: ?anon_0_, environment: var0
                _fun58248: for (var _fun58248_ip = 0;;) switch (_fun58248_ip) {
                    case 0:
                        StartGenerator();
                        ResumeGenerator(result_out_reg = 0, return_bool_out_reg = 1);
                        if (var1) {
                ...
                _fun58266: for (var _fun58266_ip = 0;;) switch (_fun58266_ip) {
                    ...
                    case 325:
                        ...
                        var7 = function(arg0) { // Environment: var7
                            _fun58269: for (var _fun58269_ip = 0;;) switch (_fun58269_ip) {
                                case 0:
                                    var0 = arg0;
    ...
    var10 = function() {
        ...
        var0 = function*() { // Environment: var0
            var0 = function*() { // Original name: ?anon_0_, environment: var0
                _fun58273: for (var _fun58273_ip = 0;;) switch (_fun58273_ip) {
                    case 0:
                        StartGenerator();
                        ResumeGenerator(result_out_reg = 0, return_bool_out_reg = 1);
                        if (var1) {
    ...
    var10 = function arg0() {
        ...
        var0 = function*() { // Environment: var0
            var0 = function*() { // Original name: ?anon_0_, environment: var0
                _fun58276: for (var _fun58276_ip = 0;;) switch (_fun58276_ip) {
                    case 0:
                        StartGenerator();
                        ResumeGenerator(result_out_reg = 0, return_bool_out_reg = 1);
                        if (var1) {
    ...
    var10 = function() {
        _fun58283: for (var _fun58283_ip = 0;;) switch (_fun58283_ip) {
            ...
            case 13:
                ...
                var0 = function*() { // Environment: var0
                    var0 = function*() { // Original name: ?anon_0_, environment: var0
                        _fun58285: for (var _fun58285_ip = 0;;) switch (_fun58285_ip) {
                            case 0:
                                StartGenerator();
                                ResumeGenerator(result_out_reg = 0, return_bool_out_reg = 1);
                                if (var1) {
    ...
    return var0;
})(undefined, undefined, undefined, undefined, undefined, undefined, [29, 5, 31, 4613, 7131, 7132, 1621, 3119, 4617, 660, 483, 33, 3, 1215, 587, 795, 507, 3127, 3440, 5687, 7223, 806, 4614, 22, 7242, 6950, 6954, 1234, 7184, 3933, 7190, 1307, 4567, 7127, 7245, 4531, 481, 7299, 7300, 1385, 7301, 7185, 3347, 3350, 7302, 491, 2]);