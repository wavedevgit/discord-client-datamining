...
export default (function(global, require, metroImportDefault, metroImportAll, module, exports, dependencyMap) {
        ...
        _fun58142: for (var _fun58142_ip = 0;;) switch (_fun58142_ip) {
            ...
            case 330:
                ...
                var0 = function() { // Environment: var0
                    _fun58143: for (var _fun58143_ip = 0;;) switch (_fun58143_ip) {
                        case 0:
    ...
    var0 = function() {
        ...
        var2 = function*(arg0) { // Environment: var2
            var0 = function*(arg0) { // Original name: ?anon_0_, environment: var0
                _fun58165: for (var _fun58165_ip = 0;;) switch (_fun58165_ip) {
                    case 0:
                        StartGenerator();
                        var5 = arg0;
                        ResumeGenerator(result_out_reg = 0, return_bool_out_reg = 1);
                    ...
                    case 15:
                        ...
                        var5.event = var7;
                        var6 = function arg0() {
                            _fun58166: for (var _fun58166_ip = 0;;) switch (_fun58166_ip) {
                                case 0:
                                    var6 = arg0;
                                    var3 = {};
    ...
    var0 = function() {
        ...
        var2 = function*(arg0, arg1, arg2) { // Environment: var2
            var0 = function*(arg0, arg1, arg2) { // Original name: ?anon_0_, environment: var0
                _fun58170: for (var _fun58170_ip = 0;;) switch (_fun58170_ip) {
                    case 0:
                        StartGenerator();
                        ResumeGenerator(result_out_reg = 0, return_bool_out_reg = 1);
                        if (var1) {
    ...
    var10 = function() {
        ...
        var0 = function*() { // Environment: var0
            var0 = function*() { // Original name: ?anon_0_, environment: var0
                _fun58193: for (var _fun58193_ip = 0;;) switch (_fun58193_ip) {
                    case 0:
                        StartGenerator();
                        ResumeGenerator(result_out_reg = 0, return_bool_out_reg = 1);
                        if (var1) {
    ...
    var10 = function() {
        ...
        var0 = function*() { // Environment: var0
            var0 = function*() { // Original name: ?anon_0_, environment: var0
                _fun58196: for (var _fun58196_ip = 0;;) switch (_fun58196_ip) {
                    case 0:
                        StartGenerator();
                        ResumeGenerator(result_out_reg = 0, return_bool_out_reg = 1);
                        if (var1) {
                ...
                _fun58199: for (var _fun58199_ip = 0;;) switch (_fun58199_ip) {
                    ...
                    case 325:
                        ...
                        var7 = function(arg0) { // Environment: var7
                            _fun58202: for (var _fun58202_ip = 0;;) switch (_fun58202_ip) {
                                case 0:
                                    var0 = arg0;
    ...
    var10 = function arg0() {
        ...
        var0 = function*() { // Environment: var0
            var0 = function*() { // Original name: ?anon_0_, environment: var0
                _fun58209: for (var _fun58209_ip = 0;;) switch (_fun58209_ip) {
                    case 0:
                        StartGenerator();
                        ResumeGenerator(result_out_reg = 0, return_bool_out_reg = 1);
                        if (var1) {
    ...
    var10 = function() {
        _fun58216: for (var _fun58216_ip = 0;;) switch (_fun58216_ip) {
            case 0:
                var2 = arguments[0];
                var1 = undefined;
                if (!(var2 === var1)) {
