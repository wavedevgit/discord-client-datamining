...
export default (function(global, require, metroImportDefault, metroImportAll, module, exports, dependencyMap) {
        ...
        _fun57457: for (var _fun57457_ip = 0;;) switch (_fun57457_ip) {
            ...
            case 330:
                ...
                var0 = function() { // Environment: var0
                    _fun57458: for (var _fun57458_ip = 0;;) switch (_fun57458_ip) {
                        case 0:
    ...
    var0 = function() {
        ...
        var2 = function*(arg0) { // Environment: var2
            var0 = function*(arg0) { // Original name: ?anon_0_, environment: var0
                _fun57475: for (var _fun57475_ip = 0;;) switch (_fun57475_ip) {
                    case 0:
                        StartGenerator();
                        var4 = arg0;
                        ResumeGenerator(result_out_reg = 0, return_bool_out_reg = 1);
    ...
    var0 = function arg0, arg1() {
        _fun57482: for (var _fun57482_ip = 0;;) switch (_fun57482_ip) {
            case 0:
                var3 = arg0;
                var4 = _closure1_slot0;
    ...
    var0 = function() {
        ...
        var2 = function*(arg0, arg1) { // Environment: var2
            var0 = function*(arg0, arg1) { // Original name: ?anon_0_, environment: var0
                _fun57493: for (var _fun57493_ip = 0;;) switch (_fun57493_ip) {
                    case 0:
                        StartGenerator();
                        var1 = arg0;
                        ResumeGenerator(result_out_reg = 0, return_bool_out_reg = 2);
    ...
    var10 = function arg0() {
        ...
        var0 = function*() { // Environment: var0
            var0 = function*() { // Original name: ?anon_0_, environment: var0
                _fun57524: for (var _fun57524_ip = 0;;) switch (_fun57524_ip) {
                    case 0:
                        StartGenerator();
                        ResumeGenerator(result_out_reg = 0, return_bool_out_reg = 1);
                        if (var1) {
                            ...
                            case 201:
                                ...
                                var17 = function*(arg0) { // Original name: _loop, environment: var8
                                    var0 = function*(arg0) { // Original name: ?anon_0__loop, environment: var0
                                        _fun57536: for (var _fun57536_ip = 0;;) switch (_fun57536_ip) {
                                            case 0:
                                                StartGenerator();
                                                var4 = arg0;
                                                ResumeGenerator(result_out_reg = 0, return_bool_out_reg = 1);
    ...
    return var0;
})(undefined, undefined, undefined, undefined, undefined, undefined, [29, 5, 31, 4573, 7012, 7013, 1613, 3078, 4577, 660, 483, 33, 3, 1215, 587, 795, 507, 3086, 3404, 5590, 7105, 806, 4574, 22, 7124, 6829, 6833, 1234, 7066, 3897, 7072, 1307, 4527, 7008, 7127, 4491, 481, 7181, 7182, 1385, 7183, 7067, 3311, 3314, 7184, 491, 2]);