...
export default (function(global, require, metroImportDefault, metroImportAll, module, exports, dependencyMap) {
    ...
    var10 = function arg0() {
        _fun58206: for (var _fun58206_ip = 0;;) switch (_fun58206_ip) {
            case 0:
                var0 = arg0;
    ...
    var0 = function arg0, arg1() {
        _fun58212: for (var _fun58212_ip = 0;;) switch (_fun58212_ip) {
            case 0:
                var0 = arg0;
    ...
    var0 = function() {
        _fun58213: for (var _fun58213_ip = 0;;) switch (_fun58213_ip) {
            case 0:
    ...
    var0 = function() {
        ...
        var2 = function*(arg0) { // Environment: var2
            var0 = function*(arg0) { // Original name: ?anon_0_, environment: var0
                _fun58226: for (var _fun58226_ip = 0;;) switch (_fun58226_ip) {
                    case 0:
                        StartGenerator();
                        var5 = arg0;
                        ResumeGenerator(result_out_reg = 0, return_bool_out_reg = 1);
    ...
    var0 = function() {
        ...
        var2 = function*(arg0, arg1) { // Environment: var2
            var0 = function*(arg0, arg1) { // Original name: ?anon_0_, environment: var0
                _fun58239: for (var _fun58239_ip = 0;;) switch (_fun58239_ip) {
                    case 0:
                        StartGenerator();
                        var1 = arg0;
                        ResumeGenerator(result_out_reg = 0, return_bool_out_reg = 2);
    ...
    var0 = function() {
        ...
        var2 = function*(arg0, arg1) { // Environment: var2
            var0 = function*(arg0, arg1) { // Original name: ?anon_0_, environment: var0
                _fun58242: for (var _fun58242_ip = 0;;) switch (_fun58242_ip) {
                    case 0:
                        StartGenerator();
                        ResumeGenerator(result_out_reg = 0, return_bool_out_reg = 1);
                        if (var1) {
    ...
    var10 = function() {
        ...
        var0 = function*() { // Environment: var0
            var0 = function*() { // Original name: ?anon_0_, environment: var0
                _fun58254: for (var _fun58254_ip = 0;;) switch (_fun58254_ip) {
                    case 0:
                        StartGenerator();
                        ResumeGenerator(result_out_reg = 0, return_bool_out_reg = 1);
                        if (var1) {
    ...
    var10 = function arg0() {
        ...
        var0 = function*() { // Environment: var0
            var0 = function*() { // Original name: ?anon_0_, environment: var0
                _fun58270: for (var _fun58270_ip = 0;;) switch (_fun58270_ip) {
                    case 0:
                        StartGenerator();
                        ResumeGenerator(result_out_reg = 0, return_bool_out_reg = 1);
                        if (var1) {
    ...
    var10 = function() {
        _fun58277: for (var _fun58277_ip = 0;;) switch (_fun58277_ip) {
            case 0:
                var2 = arguments[0];
                var1 = undefined;
                if (!(var2 === var1)) {
            ...
            case 13:
                ...
                var0 = function*() { // Environment: var0
                    var0 = function*() { // Original name: ?anon_0_, environment: var0
                        _fun58279: for (var _fun58279_ip = 0;;) switch (_fun58279_ip) {
                            case 0:
                                StartGenerator();
                                ResumeGenerator(result_out_reg = 0, return_bool_out_reg = 1);
                                if (var1) {
                            ...
                            case 201:
                                ...
                                var6 = function(arg0) { // Environment: var8
                                    _fun58280: for (var _fun58280_ip = 0;;) switch (_fun58280_ip) {
                                        case 0:
                                            var1 = arg0;
                                    ...
                                    var0 = function*(arg0) { // Original name: ?anon_0__loop, environment: var0
                                        _fun58282: for (var _fun58282_ip = 0;;) switch (_fun58282_ip) {
                                            ...
                                            case 295:
                                                ...
                                                var5 = var6.then;
                                                var2 = function(arg0) { // Environment: var2
                                                    _fun58283: for (var _fun58283_ip = 0;;) switch (_fun58283_ip) {
                                                        case 0:
                                                            var2 = arg0;
                                                            var1 = _closure1_slot0;
                                                            var4 = _closure1_slot3;
    ...
    return var0;
})(undefined, undefined, undefined, undefined, undefined, undefined, [29, 5, 31, 4617, 7131, 7132, 1621, 3119, 4621, 660, 483, 33, 3, 1215, 587, 795, 507, 3127, 3444, 5688, 7223, 806, 4618, 22, 7242, 6950, 6954, 1234, 7184, 3937, 7190, 1307, 4571, 7127, 7245, 4535, 481, 7299, 7300, 1385, 7301, 7185, 3351, 3354, 7302, 491, 2]);