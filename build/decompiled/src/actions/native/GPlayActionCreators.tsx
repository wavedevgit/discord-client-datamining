...
export default (function(global, require, metroImportDefault, metroImportAll, module, exports, dependencyMap) {
    ...
    var1 = function*() { // Environment: var3
        var0 = function*() { // Original name: ?anon_0_, environment: var0
            _fun58927: for (var _fun58927_ip = 0;;) switch (_fun58927_ip) {
                case 0:
                    StartGenerator();
                    var1 = arguments[0];
    ...
    var1 = function*() { // Environment: var3
        var0 = function*() { // Original name: ?anon_0_, environment: var0
            _fun58931: for (var _fun58931_ip = 0;;) switch (_fun58931_ip) {
                case 0:
                    StartGenerator();
                    ResumeGenerator(result_out_reg = 0, return_bool_out_reg = 1);
                    if (var1) {
    ...
    return var0;
})(undefined, undefined, undefined, undefined, undefined, undefined, [5, 27, 7162, 1217, 4617, 660, 4618, 483, 3, 4614, 807, 3132, 4000, 1235, 796, 507, 2]);