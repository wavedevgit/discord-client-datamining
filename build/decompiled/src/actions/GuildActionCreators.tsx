...
export default (function(global, require, metroImportDefault, metroImportAll, module, exports, dependencyMap) {
    ...
    var7 = function arg0, arg1, arg2, arg3() {
        ...
        var0 = function*() { // Environment: var0
            var0 = function*() { // Original name: ?anon_0_, environment: var0
                _fun43226: for (var _fun43226_ip = 0;;) switch (_fun43226_ip) {
                    case 0:
                        StartGenerator();
                        ResumeGenerator(result_out_reg = 0, return_bool_out_reg = 1);
                        if (var1) {
    ...
    var7 = function arg0, arg1() {
        ...
        var0 = function*() { // Environment: var0
            var0 = function*() { // Original name: ?anon_0_, environment: var0
                _fun43235: for (var _fun43235_ip = 0;;) switch (_fun43235_ip) {
                    case 0:
                        StartGenerator();
                        ResumeGenerator(result_out_reg = 0, return_bool_out_reg = 1);
                        if (var1) {
    ...
    var7 = function arg0, arg1() {
        ...
        var0 = function*() { // Environment: var0
            var0 = function*() { // Original name: ?anon_0_, environment: var0
                _fun43238: for (var _fun43238_ip = 0;;) switch (_fun43238_ip) {
                    case 0:
                        StartGenerator();
                        ResumeGenerator(result_out_reg = 0, return_bool_out_reg = 1);
                        if (var1) {
    ...
    var7 = function arg0, arg1() {
        _fun43241: for (var _fun43241_ip = 0;;) switch (_fun43241_ip) {
            case 0:
                var8 = arg0;
                var6 = arg1;
                var3 = arguments[2];
    ...
    var7 = function arg0() {
        _fun43252: for (var _fun43252_ip = 0;;) switch (_fun43252_ip) {
            case 0:
                var5 = arg0;
    ...
    var7 = function arg0() {
        _fun43256: for (var _fun43256_ip = 0;;) switch (_fun43256_ip) {
            ...
            case 37:
                ...
                var0 = function*() { // Environment: var0
                    var0 = function*() { // Original name: ?anon_0_, environment: var0
                        _fun43258: for (var _fun43258_ip = 0;;) switch (_fun43258_ip) {
                            case 0:
                                StartGenerator();
                                ResumeGenerator(result_out_reg = 0, return_bool_out_reg = 1);
                                if (var1) {
    ...
    return var0;
})(undefined, undefined, undefined, undefined, undefined, undefined, [29, 5, 1216, 4377, 1671, 1410, 1670, 3213, 1621, 660, 1219, 4003, 1234, 806, 4680, 507, 1220, 4683, 1307, 4556, 3109, 5616, 5617, 12115, 4525, 481, 3096, 484, 6487, 3351, 795, 4551, 2]);