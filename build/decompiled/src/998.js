    ...
    _fun10207: for (var _fun10207_ip = 0;;) switch (_fun10207_ip) {
        ...
        case 151:
            ...
            var6 = function(arg0) { // Original name: initNativeSdk, environment: var1
                ...
                var4 = function*() { // Environment: var0
                    var0 = function*() { // Original name: ?anon_0_, environment: var0
                        _fun10225: for (var _fun10225_ip = 0;;) switch (_fun10225_ip) {
                            case 0:
                                StartGenerator();
                                var3 = this;
                                ResumeGenerator(result_out_reg = 0, return_bool_out_reg = 1);
            ...
            var6 = function() { // Original name: fetchNativeLogAttributes, environment: var1
                ...
                var4 = function*() { // Environment: var0
                    var0 = function*() { // Original name: ?anon_0_, environment: var0
                        _fun10231: for (var _fun10231_ip = 0;;) switch (_fun10231_ip) {
                            case 0:
                                StartGenerator();
                                var2 = this;
                                ResumeGenerator(result_out_reg = 0, return_bool_out_reg = 1);
            ...
            var6 = function() { // Original name: fetchNativeRelease, environment: var1
                ...
                var4 = function*() { // Environment: var0
                    var0 = function*() { // Original name: ?anon_0_, environment: var0
                        _fun10234: for (var _fun10234_ip = 0;;) switch (_fun10234_ip) {
                            case 0:
                                StartGenerator();
                                var2 = this;
                                ResumeGenerator(result_out_reg = 0, return_bool_out_reg = 1);
            ...
            var6 = function() { // Original name: fetchNativeSdkInfo, environment: var1
                ...
                var4 = function*() { // Environment: var0
                    var0 = function*() { // Original name: ?anon_0_, environment: var0
                        _fun10237: for (var _fun10237_ip = 0;;) switch (_fun10237_ip) {
                            case 0:
                                StartGenerator();
                                var2 = this;
                                ResumeGenerator(result_out_reg = 0, return_bool_out_reg = 1);
            ...
            var6 = function() { // Original name: fetchNativeDeviceContexts, environment: var1
                ...
                var4 = function*() { // Environment: var0
                    var0 = function*() { // Original name: ?anon_0_, environment: var0
                        _fun10240: for (var _fun10240_ip = 0;;) switch (_fun10240_ip) {
                            case 0:
                                StartGenerator();
                                var2 = this;
                                ResumeGenerator(result_out_reg = 0, return_bool_out_reg = 1);
            ...
            var6 = function() { // Original name: fetchNativeAppStart, environment: var1
                ...
                var4 = function*() { // Environment: var0
                    var0 = function*() { // Original name: ?anon_0_, environment: var0
                        _fun10243: for (var _fun10243_ip = 0;;) switch (_fun10243_ip) {
                            case 0:
                                StartGenerator();
                                var2 = this;
                                ResumeGenerator(result_out_reg = 0, return_bool_out_reg = 1);
            ...
            var6 = function() { // Original name: fetchNativeFrames, environment: var1
                ...
                var4 = function*() { // Environment: var0
                    var0 = function*() { // Original name: ?anon_0_, environment: var0
                        _fun10246: for (var _fun10246_ip = 0;;) switch (_fun10246_ip) {
                            case 0:
                                StartGenerator();
                                var2 = this;
                                ResumeGenerator(result_out_reg = 0, return_bool_out_reg = 1);
            ...
            var6 = function(arg0) { // Original name: startProfiling, environment: var1
                _fun10268: for (var _fun10268_ip = 0;;) switch (_fun10268_ip) {
                    case 0:
                        var0 = this;
