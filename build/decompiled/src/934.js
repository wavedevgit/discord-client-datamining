...
module.exports = (function(global, require, metroImportDefault, metroImportAll, module, exports, dependencyMap) {
    ...
    var3 = function(arg0) { // Original name: wrapTransportOnClose, environment: var1
        _fun9729: for (var _fun9729_ip = 0;;) switch (_fun9729_ip) {
            case 0:
                var4 = arg0;
                var0 = var4.onclose;
                if (!var0) {
    ...
    var3 = function(arg0) { // Original name: wrapTransportOnMessage, environment: var1
        _fun9732: for (var _fun9732_ip = 0;;) switch (_fun9732_ip) {
            case 0:
                var4 = arg0;
                var0 = var4.onmessage;
                if (!var0) {
    ...
    var1 = function(arg0) { // Original name: wrapTransportSend, environment: var1
        _fun9738: for (var _fun9738_ip = 0;;) switch (_fun9738_ip) {
            case 0:
                var4 = arg0;
                var0 = var4.send;
                if (!var0) {
                ...
                var0 = function(arg0) { // Environment: var0
                    ...
                    var0 = function*() { // Environment: var0
                        var0 = function*() { // Original name: ?anon_0_, environment: var0
                            _fun9741: for (var _fun9741_ip = 0;;) switch (_fun9741_ip) {
                                case 0:
                                    StartGenerator();
                                    var5 = this;
