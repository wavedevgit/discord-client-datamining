...
export default (function(global, require, metroImportDefault, metroImportAll, module, exports, dependencyMap) {
    ...
    var0 = function(arg0) { // Original name: serializePurchaseResponse, environment: var1
        _fun58435: for (var _fun58435_ip = 0;;) switch (_fun58435_ip) {
            case 0:
                var1 = arg0;
    ...
    var0 = function() { // Original name: _restorePurchases, environment: var1
        ...
        var2 = function*(arg0) { // Environment: var2
            var0 = function*(arg0) { // Original name: ?anon_0_, environment: var0
                _fun58439: for (var _fun58439_ip = 0;;) switch (_fun58439_ip) {
                    case 0:
                        StartGenerator();
    ...
    var4 = function() { // Original name: isStorekit2Available, environment: var1
        _fun58444: for (var _fun58444_ip = 0;;) switch (_fun58444_ip) {
            case 0:
                var3 = _closure1_slot0;
                var2 = _closure1_slot2;
                var0 = 8;
    ...
    var0 = function() { // Original name: _fetchStoreFront, environment: var1
        ...
        var2 = function*() { // Environment: var2
            var0 = function*() { // Original name: ?anon_0_, environment: var0
                _fun58448: for (var _fun58448_ip = 0;;) switch (_fun58448_ip) {
                    case 0:
                        StartGenerator();
                        ResumeGenerator(result_out_reg = 0, return_bool_out_reg = 1);
                        if (var1) {
    ...
    var7 = function() { // Original name: loadProducts, environment: var1
        _fun58449: for (var _fun58449_ip = 0;;) switch (_fun58449_ip) {
            case 0:
                var2 = _closure1_slot0;
                var3 = _closure1_slot2;
                var0 = 8;
            ...
            case 66:
                ...
                var1 = function(arg0) { // Environment: var1
                    _fun58450: for (var _fun58450_ip = 0;;) switch (_fun58450_ip) {
                        case 0:
                            var4 = arg0;
        ...
        var1 = function() { // Environment: var0
            ...
            var1 = function*(arg0, arg1) { // Environment: var0
                var0 = function*(arg0, arg1) { // Original name: ?anon_0_, environment: var0
                    _fun58455: for (var _fun58455_ip = 0;;) switch (_fun58455_ip) {
                        case 0:
                            StartGenerator();
                            ResumeGenerator(result_out_reg = 0, return_bool_out_reg = 1);
                            if (var1) {
    ...
    var5 = function(arg0) { // Original name: useCanPurchaseIAP, environment: var1
        ...
        var1[0] = var4;
        var0 = function() { // Environment: var0
            _fun58470: for (var _fun58470_ip = 0;;) switch (_fun58470_ip) {
                case 0:
    ...
    return var0;
})(undefined, undefined, undefined, undefined, undefined, undefined, [5, 27, 3925, 1613, 4574, 1615, 7104, 44, 478, 7124, 4571, 22, 491, 3084, 566, 7125, 2]);