...
export default (function(global, require, metroImportDefault, metroImportAll, module, exports, dependencyMap) {
    ...
    var8 = function(arg0) { // Original name: openChannelCallModal, environment: var1
        _fun62465: for (var _fun62465_ip = 0;;) switch (_fun62465_ip) {
            case 0:
                var5 = arg0;
            ...
            case 94:
                ...
                var0 = function*() { // Environment: var0
                    var0 = function*() { // Original name: ?anon_0_, environment: var0
                        _fun62473: for (var _fun62473_ip = 0;;) switch (_fun62473_ip) {
                            case 0:
                                StartGenerator();
    ...
    var4 = function(arg0) { // Environment: var1
        _fun62479: for (var _fun62479_ip = 0;;) switch (_fun62479_ip) {
            case 0:
                var3 = arg0;
                var2 = arguments[1];
                var _closure2_slot0 = var3;
        ...
        _fun62484: for (var _fun62484_ip = 0;;) switch (_fun62484_ip) {
            ...
            case 37:
                var1 = function() { // Environment: var1
                    ...
                    var1 = function*() { // Environment: var0
                        var0 = function*() { // Original name: ?anon_0_, environment: var0
                            _fun62489: for (var _fun62489_ip = 0;;) switch (_fun62489_ip) {
                                case 0:
                                    StartGenerator();
                                    ResumeGenerator(result_out_reg = 0, return_bool_out_reg = 1);
                                    if (var1) {
    ...
    var4 = function(arg0) { // Environment: var1
        _fun62492: for (var _fun62492_ip = 0;;) switch (_fun62492_ip) {
            case 0:
                var3 = arg0;
                var2 = arguments[1];
                var _closure2_slot0 = var3;
    ...
    return var0;
})(undefined, undefined, undefined, undefined, undefined, undefined, [5, 31, 3099, 7837, 1372, 3059, 1661, 1613, 660, 1219, 3967, 33, 4508, 7838, 7840, 1229, 4518, 7841, 1307, 5809, 4513, 3237, 11893, 4189, 3890, 1234, 3968, 3675, 11917, 3982, 7978, 3872, 5870, 2]);