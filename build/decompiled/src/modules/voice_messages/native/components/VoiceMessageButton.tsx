...
export default (function(global, require, metroImportDefault, metroImportAll, module, exports, dependencyMap) {
    ...
    var1 = function(arg0) { // Environment: var1
        ...
        var10[2] = var17;
        var9 = function() { // Environment: var1
            _fun90865: for (var _fun90865_ip = 0;;) switch (_fun90865_ip) {
                case 0:
                    ...
                    var2 = function() { // Original name: _cancel, environment: var0
                        ...
                        var1 = function*() { // Environment: var1
                            var0 = function*() { // Original name: ?anon_0_, environment: var0
                                _fun90869: for (var _fun90869_ip = 0;;) switch (_fun90869_ip) {
                                    case 0:
                                        StartGenerator();
                    ...
                    var4 = function() { // Original name: handleNavigationChange, environment: var0
                        _fun90871: for (var _fun90871_ip = 0;;) switch (_fun90871_ip) {
                            case 0:
                                var2 = _closure1_slot0;
                                var1 = _closure1_slot2;
                                var0 = 28;
                ...
                case 122:
                    var0 = function() { // Environment: var0
                        _fun90872: for (var _fun90872_ip = 0;;) switch (_fun90872_ip) {
                            case 0:
        ...
        var9 = function*() { // Environment: var1
            var0 = function*() { // Original name: ?anon_0_, environment: var0
                _fun90875: for (var _fun90875_ip = 0;;) switch (_fun90875_ip) {
                    case 0:
                        StartGenerator();
                        ResumeGenerator(result_out_reg = 0, return_bool_out_reg = 1);
                        if (var1) {
        ...
        var10 = function(arg0) { // Original name: Y, environment: var1
            _fun90876: for (var _fun90876_ip = 0;;) switch (_fun90876_ip) {
                case 0:
                    var3 = arg0;
        ...
        var4 = function() { // Environment: var1
            _fun90877: for (var _fun90877_ip = 0;;) switch (_fun90877_ip) {
                case 0:
                    var1 = _closure2_slot4;
                    var1 = var1.current;
                    if (var1) {
        ...
        var4 = function*() { // Environment: var1
            var0 = function*() { // Original name: ?anon_0_, environment: var0
                _fun90879: for (var _fun90879_ip = 0;;) switch (_fun90879_ip) {
                    case 0:
                        StartGenerator();
                        ResumeGenerator(result_out_reg = 0, return_bool_out_reg = 1);
                        if (var1) {
    ...
    var2.default = var1;
    return var0;
})(undefined, undefined, undefined, undefined, undefined, undefined, [5, 57, 31, 3099, 6490, 1372, 11600, 11601, 660, 1346, 3967, 33, 1297, 671, 3872, 7836, 11753, 3677, 8853, 9761, 1464, 10035, 3957, 3959, 6484, 7568, 9204, 1229, 8682, 3873, 3968, 3106, 8104, 1234, 4917, 11755, 11722, 10737, 2]);