...
export default (function(global, require, metroImportDefault, metroImportAll, module, exports, dependencyMap) {
        ...
        _fun82378: for (var _fun82378_ip = 0;;) switch (_fun82378_ip) {
            ...
            case 301:
                ...
                var1 = function() { // Environment: var12
                    _fun82385: for (var _fun82385_ip = 0;;) switch (_fun82385_ip) {
                        case 0:
                ...
                var0 = function*() { // Environment: var12
                    var0 = function*() { // Original name: ?anon_0_, environment: var0
                        _fun82388: for (var _fun82388_ip = 0;;) switch (_fun82388_ip) {
                            case 0:
                                StartGenerator();
                                ResumeGenerator(result_out_reg = 0, return_bool_out_reg = 1);
                                if (var1) {
    ...
    var0 = function arg0() {
        _fun82399: for (var _fun82399_ip = 0;;) switch (_fun82399_ip) {
            case 0:
                var0 = arg0;
        ...
        _fun82405: for (var _fun82405_ip = 0;;) switch (_fun82405_ip) {
            case 0:
                ...
                var2 = function() { // Environment: var0
                    _fun82407: for (var _fun82407_ip = 0;;) switch (_fun82407_ip) {
                        case 0:
                            var2 = _closure2_slot0;
                            var0 = null;
                            if (!(var0 == var2)) {
    ...
    return var0;
})(undefined, undefined, undefined, undefined, undefined, undefined, [5, 57, 31, 27, 1621, 5347, 10369, 10370, 660, 4013, 33, 1297, 671, 4713, 10500, 3942, 1234, 10378, 10503, 1568, 1469, 566, 10377, 478, 670, 795, 3279, 10504, 1307, 4014, 8784, 10505, 10506, 10509, 10511, 10512, 10384, 10513, 10515, 481, 4715, 10517, 10518, 5848, 2]);