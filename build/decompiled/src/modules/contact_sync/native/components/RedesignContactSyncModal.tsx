...
export default (function(global, require, metroImportDefault, metroImportAll, module, exports, dependencyMap) {
    ...
    var0 = function arg0() {
        _fun82019: for (var _fun82019_ip = 0;;) switch (_fun82019_ip) {
            case 0:
                var1 = arg0;
            ...
            case 301:
                ...
                var2 = function() { // Environment: var12
                    ...
                    var1 = function*() { // Environment: var1
                        var0 = function*() { // Original name: ?anon_0_, environment: var0
                            _fun82023: for (var _fun82023_ip = 0;;) switch (_fun82023_ip) {
                                case 0:
                                    StartGenerator();
                ...
                var1 = function() { // Environment: var12
                    _fun82026: for (var _fun82026_ip = 0;;) switch (_fun82026_ip) {
                        case 0:
    ...
    var0 = function arg0() {
        _fun82031: for (var _fun82031_ip = 0;;) switch (_fun82031_ip) {
            case 0:
                var1 = arg0;
                ...
                var1 = function() { // Environment: var0
                    ...
                    var1 = function*(arg0) { // Environment: var0
                        var0 = function*(arg0) { // Original name: ?anon_0_, environment: var0
                            _fun82034: for (var _fun82034_ip = 0;;) switch (_fun82034_ip) {
                                case 0:
                                    StartGenerator();
                                    ResumeGenerator(result_out_reg = 0, return_bool_out_reg = 1);
                                    if (var1) {
        ...
        _fun82046: for (var _fun82046_ip = 0;;) switch (_fun82046_ip) {
            case 0:
                ...
                var6 = function() { // Environment: var0
                    _fun82047: for (var _fun82047_ip = 0;;) switch (_fun82047_ip) {
                        case 0:
                ...
                var1 = function() { // Environment: var0
                    ...
                    var1 = function arg0() {
                        _fun82051: for (var _fun82051_ip = 0;;) switch (_fun82051_ip) {
                            case 0:
                                var0 = arg0;
                ...
                var0 = function() { // Environment: var0
                    var0 = function() { // Environment: var0
                        _fun82063: for (var _fun82063_ip = 0;;) switch (_fun82063_ip) {
                            case 0:
                                var0 = _closure2_slot4;
                                var0 = !var0;
                                if (!var0) {
    ...
    return var0;
})(undefined, undefined, undefined, undefined, undefined, undefined, [5, 57, 31, 27, 1621, 5288, 10333, 10334, 660, 4013, 33, 1297, 671, 4703, 10472, 3941, 1234, 10342, 10475, 1568, 1469, 566, 10341, 478, 670, 795, 3278, 10476, 1307, 4014, 8745, 10477, 10478, 10481, 10483, 10484, 10348, 10485, 10487, 481, 4705, 10489, 10490, 5790, 2]);