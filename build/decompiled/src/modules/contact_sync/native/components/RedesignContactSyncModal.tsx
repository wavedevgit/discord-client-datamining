...
export default (function(global, require, metroImportDefault, metroImportAll, module, exports, dependencyMap) {
    ...
    var0 = function arg0() {
        _fun82279: for (var _fun82279_ip = 0;;) switch (_fun82279_ip) {
            case 0:
                var1 = arg0;
                ...
                var1 = function() { // Environment: var0
                    ...
                    var1 = function*(arg0) { // Environment: var0
                        var0 = function*(arg0) { // Original name: ?anon_0_, environment: var0
                            _fun82282: for (var _fun82282_ip = 0;;) switch (_fun82282_ip) {
                                case 0:
                                    StartGenerator();
                                    ResumeGenerator(result_out_reg = 0, return_bool_out_reg = 1);
                                    if (var1) {
    ...
    var3 = function arg0() {
        _fun82294: for (var _fun82294_ip = 0;;) switch (_fun82294_ip) {
            case 0:
                ...
                var0 = function() { // Environment: var0
                    var0 = function() { // Environment: var0
                        _fun82311: for (var _fun82311_ip = 0;;) switch (_fun82311_ip) {
                            case 0:
                                var0 = _closure2_slot4;
                                var0 = !var0;
                                if (!var0) {
    ...
    return var0;
})(undefined, undefined, undefined, undefined, undefined, undefined, [5, 57, 31, 27, 1621, 5347, 10346, 10347, 660, 4011, 33, 1297, 671, 4710, 10457, 3940, 1235, 10355, 10460, 1568, 1469, 566, 10354, 478, 670, 796, 3284, 10461, 1307, 4012, 8758, 10462, 10463, 10466, 10468, 10469, 10361, 10470, 10472, 481, 4712, 10474, 10475, 5848, 2]);