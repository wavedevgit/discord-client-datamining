...
export default (function(global, require, metroImportDefault, metroImportAll, module, exports, dependencyMap) {
        ...
        _fun91201: for (var _fun91201_ip = 0;;) switch (_fun91201_ip) {
            ...
            case 254:
                ...
                var6 = function() { // Environment: var0
                    ...
                    var1 = function*(arg0) { // Environment: var0
                        var0 = function*(arg0) { // Original name: ?anon_0_, environment: var0
                            _fun91208: for (var _fun91208_ip = 0;;) switch (_fun91208_ip) {
                                case 0:
                                    StartGenerator();
                                    ResumeGenerator(result_out_reg = 0, return_bool_out_reg = 1);
                                    if (var1) {
                ...
                var6 = function() { // Environment: var0
                    ...
                    var1 = function*(arg0) { // Environment: var0
                        var0 = function*(arg0) { // Original name: ?anon_0_, environment: var0
                            _fun91212: for (var _fun91212_ip = 0;;) switch (_fun91212_ip) {
                                case 0:
                                    StartGenerator();
                                    ResumeGenerator(result_out_reg = 0, return_bool_out_reg = 1);
                                    if (var1) {
                ...
                var6 = function() { // Environment: var0
                    ...
                    var1 = function*(arg0) { // Environment: var0
                        var0 = function*(arg0) { // Original name: ?anon_0_, environment: var0
                            _fun91216: for (var _fun91216_ip = 0;;) switch (_fun91216_ip) {
                                case 0:
                                    StartGenerator();
                                    var8 = arg0;
                                    ResumeGenerator(result_out_reg = 0, return_bool_out_reg = 1);
                                    ...
                                    var1 = function() { // Environment: var6
                                        ...
                                        var1 = function*() { // Environment: var0
                                            var0 = function*() { // Original name: ?anon_0_, environment: var0
                                                _fun91219: for (var _fun91219_ip = 0;;) switch (_fun91219_ip) {
                                                    case 0:
                                                        StartGenerator();
                                                        ResumeGenerator(result_out_reg = 0, return_bool_out_reg = 1);
                                                        if (var1) {
                    ...
                    _fun91225: for (var _fun91225_ip = 0;;) switch (_fun91225_ip) {
                        case 0:
                            ...
                            var5 = function arg0, arg1() {
                                _fun91226: for (var _fun91226_ip = 0;;) switch (_fun91226_ip) {
                                    case 0:
                                        var6 = arg0;
                                        var7 = arg1;
                                        if (!var7) {
    ...
    return var0;
})(undefined, undefined, undefined, undefined, undefined, undefined, [5, 57, 31, 4670, 11840, 660, 11841, 9122, 3351, 8624, 7037, 795, 11843, 1348, 6571, 2]);