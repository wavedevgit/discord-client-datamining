...
export default (function(global, require, metroImportDefault, metroImportAll, module, exports, dependencyMap) {
    ...
    var0 = function() { // Original name: stopAnalyticsHeartbeat, environment: var1
        _fun39631: for (var _fun39631_ip = 0;;) switch (_fun39631_ip) {
            case 0:
    ...
    var0 = function() { // Original name: scheduleHeartbeatSkippedTracking, environment: var1
        _fun39642: for (var _fun39642_ip = 0;;) switch (_fun39642_ip) {
            ...
            case 13:
                ...
                var3 = undefined;
                var2 = function() { // Environment: var2
                    _fun39643: for (var _fun39643_ip = 0;;) switch (_fun39643_ip) {
                        case 0:
    ...
    var0 = function() { // Original name: _forceDispatchSessionIdUpdate, environment: var1
        ...
        var2 = function*() { // Environment: var2
            var0 = function*() { // Original name: ?anon_0_, environment: var0
                _fun39648: for (var _fun39648_ip = 0;;) switch (_fun39648_ip) {
                    case 0:
                        StartGenerator();
                        ResumeGenerator(result_out_reg = 0, return_bool_out_reg = 1);
                        if (var1) {
    ...
    var0 = function() { // Original name: handleAuthenticationChange, environment: var1
        _fun39649: for (var _fun39649_ip = 0;;) switch (_fun39649_ip) {
            case 0:
    ...
    var0 = function(arg0) { // Original name: handleWindowFocus, environment: var1
        _fun39651: for (var _fun39651_ip = 0;;) switch (_fun39651_ip) {
            case 0:
                var0 = arg0;
                var1 = var0.focused;
                var2 = _closure1_slot22;
    ...
    var0 = function(arg0) { // Original name: handleAppStateUpdate, environment: var1
        _fun39652: for (var _fun39652_ip = 0;;) switch (_fun39652_ip) {
            case 0:
                var0 = arg0;
                var2 = var0.state;
    ...
    var1 = function() { // Original name: getActiveSessionUnsafe, environment: var1
        _fun39660: for (var _fun39660_ip = 0;;) switch (_fun39660_ip) {
            case 0:
    ...
    return var0;
})(undefined, undefined, undefined, undefined, undefined, undefined, [5, 3433, 1216, 4193, 3477, 660, 667, 3, 4278, 1207, 4279, 4283, 795, 4324, 587, 4325, 653, 806, 566, 491, 2]);