...
export default (function(global, require, metroImportDefault, metroImportAll, module, exports, dependencyMap) {
            ...
            case 444:
                ...
                var0 = function*() { // Environment: var27
                    var0 = function*() { // Original name: ?anon_0_, environment: var0
                        _fun104266: for (var _fun104266_ip = 0;;) switch (_fun104266_ip) {
                            case 0:
                                StartGenerator();
                ...
                var0 = function() { // Environment: var27
                    ...
                    var1 = function*(arg0) { // Environment: var0
                        var0 = function*(arg0) { // Original name: ?anon_0_, environment: var0
                            _fun104269: for (var _fun104269_ip = 0;;) switch (_fun104269_ip) {
                                case 0:
                                    StartGenerator();
                                    ResumeGenerator(result_out_reg = 0, return_bool_out_reg = 1);
                                    if (var1) {
    ...
    return var0;
})(undefined, undefined, undefined, undefined, undefined, undefined, [5, 57, 31, 27, 4895, 1616, 33, 1234, 1297, 671, 6951, 6516, 4865, 7638, 6797, 8832, 6954, 3201, 8857, 1464, 5171, 3900, 13548, 8671, 3154, 3118, 13537, 4667, 1417, 5363, 3195, 7470, 3215, 10712, 13489, 2]);