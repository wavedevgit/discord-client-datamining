...
export default (function(global, require, metroImportDefault, metroImportAll, module, exports, dependencyMap) {
        ...
        _fun88028: for (var _fun88028_ip = 0;;) switch (_fun88028_ip) {
            case 0:
                ...
                var10 = function() { // Environment: var3
                    _fun88030: for (var _fun88030_ip = 0;;) switch (_fun88030_ip) {
                        case 0:
                            var1 = _closure2_slot2;
                            if (!var1) {
                                _fun88030_ip = 25;
                ...
                var3 = function*() { // Environment: var3
                    var0 = function*() { // Original name: ?anon_0_, environment: var0
                        _fun88033: for (var _fun88033_ip = 0;;) switch (_fun88033_ip) {
                            case 0:
                                StartGenerator();
    ...
    return var0;
})(undefined, undefined, undefined, undefined, undefined, undefined, [5, 57, 31, 27, 1621, 483, 33, 3721, 4088, 1297, 671, 3209, 5457, 3161, 3207, 3167, 4097, 4081, 4087, 11373, 9136, 566, 11355, 1234, 3150, 11360, 11375, 11354, 2]);