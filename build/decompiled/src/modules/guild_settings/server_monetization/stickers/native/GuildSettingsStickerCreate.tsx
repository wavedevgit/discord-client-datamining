...
export default (function(global, require, metroImportDefault, metroImportAll, module, exports, dependencyMap) {
    ...
    var1 = function(arg0, arg1) { // Environment: var1
        _fun116009: for (var _fun116009_ip = 0;;) switch (_fun116009_ip) {
            case 0:
                var0 = arg0;
            ...
            case 425:
                ...
                var13 = function() {
                    _fun116011: for (var _fun116011_ip = 0;;) switch (_fun116011_ip) {
                        case 0:
                            var0 = arguments[0];
                            var3 = undefined;
                            if (!(var0 === var3)) {
                ...
                var1 = function() { // Environment: var12
                    ...
                    var1 = function*() { // Environment: var0
                        var0 = function*() { // Original name: ?anon_0_, environment: var0
                            _fun116018: for (var _fun116018_ip = 0;;) switch (_fun116018_ip) {
                                case 0:
                                    StartGenerator();
                                    ResumeGenerator(result_out_reg = 0, return_bool_out_reg = 1);
                                    if (var1) {
    ...
    var2.default = var1;
    return var0;
})(undefined, undefined, undefined, undefined, undefined, undefined, [5, 57, 31, 27, 4739, 5646, 660, 1624, 1352, 33, 1297, 671, 4895, 9663, 4930, 3106, 4012, 14810, 9423, 3942, 1234, 3358, 1686, 4084, 4080, 4904, 9435, 14811, 7062, 5821, 1417, 7721, 5454, 5441, 2]);