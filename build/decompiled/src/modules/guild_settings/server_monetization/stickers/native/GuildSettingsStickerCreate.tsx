...
export default (function(global, require, metroImportDefault, metroImportAll, module, exports, dependencyMap) {
        ...
        _fun115529: for (var _fun115529_ip = 0;;) switch (_fun115529_ip) {
            ...
            case 425:
                ...
                var1 = function() { // Environment: var12
                    ...
                    var1 = function*() { // Environment: var0
                        var0 = function*() { // Original name: ?anon_0_, environment: var0
                            _fun115538: for (var _fun115538_ip = 0;;) switch (_fun115538_ip) {
                                case 0:
                                    StartGenerator();
                                    ResumeGenerator(result_out_reg = 0, return_bool_out_reg = 1);
                                    if (var1) {
    ...
    var2.default = var1;
    return var0;
})(undefined, undefined, undefined, undefined, undefined, undefined, [5, 57, 31, 27, 4739, 5598, 660, 1624, 1352, 33, 1297, 671, 4895, 9633, 4930, 3104, 4012, 14776, 9393, 3941, 1234, 3357, 1684, 4084, 4080, 4904, 9405, 14777, 7012, 5773, 1417, 7698, 5405, 5392, 2]);