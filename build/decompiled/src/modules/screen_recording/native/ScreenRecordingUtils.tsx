...
export default (function(global, require, metroImportDefault, metroImportAll, module, exports, dependencyMap) {
    ...
    var0 = function() {
        ...
        var2 = function*(arg0) { // Environment: var2
            var0 = function*(arg0) { // Original name: ?anon_0_, environment: var0
                _fun100622: for (var _fun100622_ip = 0;;) switch (_fun100622_ip) {
                    case 0:
                        StartGenerator();
                        ResumeGenerator(result_out_reg = 0, return_bool_out_reg = 1);
                        if (var1) {
    ...
    var0 = function() {
        ...
        var2 = function*() { // Environment: var2
            var0 = function*() { // Original name: ?anon_0_, environment: var0
                _fun100625: for (var _fun100625_ip = 0;;) switch (_fun100625_ip) {
                    case 0:
                        StartGenerator();
                        ResumeGenerator(result_out_reg = 0, return_bool_out_reg = 1);
                        if (var1) {
                ...
                _fun100635: for (var _fun100635_ip = 0;;) switch (_fun100635_ip) {
                    ...
                    case 9:
                        ...
                        var4 = function(arg0) { // Environment: var1
                            _fun100636: for (var _fun100636_ip = 0;;) switch (_fun100636_ip) {
                                case 0:
                                    var5 = arg0;
                                ...
                                case 116:
                                    ...
                                    var0 = function*() { // Environment: var0
                                        var0 = function*() { // Original name: ?anon_0_, environment: var0
                                            _fun100638: for (var _fun100638_ip = 0;;) switch (_fun100638_ip) {
                                                case 0:
                                                    StartGenerator();
                                                    ResumeGenerator(result_out_reg = 0, return_bool_out_reg = 1);
                                                    if (var1) {
    ...
    var0 = function() {
        ...
        var2 = function*(arg0) { // Environment: var2
            var0 = function*(arg0) { // Original name: ?anon_0_, environment: var0
                _fun100643: for (var _fun100643_ip = 0;;) switch (_fun100643_ip) {
                    case 0:
                        StartGenerator();
                        ResumeGenerator(result_out_reg = 0, return_bool_out_reg = 1);
                        if (var1) {
    ...
    return var0;
})(undefined, undefined, undefined, undefined, undefined, undefined, [5, 27, 13075, 3998, 13077, 13078, 3279, 13079, 1307, 9177, 4001, 13080, 9176, 1464, 2]);