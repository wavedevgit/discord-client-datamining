...
export default (function(global, require, metroImportDefault, metroImportAll, module, exports, dependencyMap) {
    ...
    var0 = function() {
        ...
        var2 = function*() { // Environment: var2
            var0 = function*() { // Original name: ?anon_0_, environment: var0
                _fun100108: for (var _fun100108_ip = 0;;) switch (_fun100108_ip) {
                    case 0:
                        StartGenerator();
    ...
    var0 = function() {
        ...
        var2 = function*() { // Environment: var2
            var0 = function*() { // Original name: ?anon_0_, environment: var0
                _fun100111: for (var _fun100111_ip = 0;;) switch (_fun100111_ip) {
                    case 0:
                        StartGenerator();
                        ResumeGenerator(result_out_reg = 0, return_bool_out_reg = 1);
                        if (var1) {
                ...
                _fun100120: for (var _fun100120_ip = 0;;) switch (_fun100120_ip) {
                    ...
                    case 181:
                        ...
                        var4 = function(arg0) { // Environment: var5
                            _fun100121: for (var _fun100121_ip = 0;;) switch (_fun100121_ip) {
                                case 0:
                                    var3 = arg0;
                                    var5 = var3.name;
                                    var2 = null;
                            ...
                            _fun100128: for (var _fun100128_ip = 0;;) switch (_fun100128_ip) {
                                ...
                                case 116:
                                    ...
                                    var0 = function*() { // Environment: var0
                                        var0 = function*() { // Original name: ?anon_0_, environment: var0
                                            _fun100130: for (var _fun100130_ip = 0;;) switch (_fun100130_ip) {
                                                case 0:
                                                    StartGenerator();
                                                    ResumeGenerator(result_out_reg = 0, return_bool_out_reg = 1);
                                                    if (var1) {
    ...
    var0 = function() {
        ...
        var2 = function*(arg0) { // Environment: var2
            var0 = function*(arg0) { // Original name: ?anon_0_, environment: var0
                _fun100135: for (var _fun100135_ip = 0;;) switch (_fun100135_ip) {
                    case 0:
                        StartGenerator();
                        ResumeGenerator(result_out_reg = 0, return_bool_out_reg = 1);
                        if (var1) {
    ...
    return var0;
})(undefined, undefined, undefined, undefined, undefined, undefined, [5, 27, 13053, 4002, 13055, 13056, 3278, 13057, 1307, 8846, 4005, 13058, 8845, 1464, 2]);