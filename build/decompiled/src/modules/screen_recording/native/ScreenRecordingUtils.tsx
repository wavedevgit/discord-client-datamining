...
export default (function(global, require, metroImportDefault, metroImportAll, module, exports, dependencyMap) {
    ...
    var0 = function() {
        ...
        var2 = function*() { // Environment: var2
            var0 = function*() { // Original name: ?anon_0_, environment: var0
                _fun100617: for (var _fun100617_ip = 0;;) switch (_fun100617_ip) {
                    case 0:
                        StartGenerator();
                        ResumeGenerator(result_out_reg = 0, return_bool_out_reg = 1);
                        if (var1) {
                ...
                _fun100620: for (var _fun100620_ip = 0;;) switch (_fun100620_ip) {
                    ...
                    case 181:
                        ...
                        var4 = function(arg0) { // Environment: var5
                            _fun100621: for (var _fun100621_ip = 0;;) switch (_fun100621_ip) {
                                case 0:
                                    var3 = arg0;
                                    var5 = var3.name;
                                    var2 = null;
    ...
    return var0;
})(undefined, undefined, undefined, undefined, undefined, undefined, [5, 27, 13076, 3998, 13078, 13079, 3279, 13080, 1307, 8885, 4001, 13081, 8884, 1464, 2]);