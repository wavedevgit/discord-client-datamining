...
export default (function(global, require, metroImportDefault, metroImportAll, module, exports, dependencyMap) {
    ...
    var0 = function() {
        ...
        var2 = function*() { // Environment: var2
            var0 = function*() { // Original name: ?anon_0_, environment: var0
                _fun100715: for (var _fun100715_ip = 0;;) switch (_fun100715_ip) {
                    case 0:
                        StartGenerator();
    ...
    var0 = function() {
        ...
        var2 = function*(arg0) { // Environment: var2
            var0 = function*(arg0) { // Original name: ?anon_0_, environment: var0
                _fun100721: for (var _fun100721_ip = 0;;) switch (_fun100721_ip) {
                    case 0:
                        StartGenerator();
                        ResumeGenerator(result_out_reg = 0, return_bool_out_reg = 1);
                        if (var1) {
                ...
                _fun100734: for (var _fun100734_ip = 0;;) switch (_fun100734_ip) {
                    ...
                    case 9:
                        ...
                        var4 = function(arg0) { // Environment: var1
                            _fun100735: for (var _fun100735_ip = 0;;) switch (_fun100735_ip) {
                                case 0:
                                    var5 = arg0;
                                ...
                                case 116:
                                    ...
                                    var0 = function*() { // Environment: var0
                                        var0 = function*() { // Original name: ?anon_0_, environment: var0
                                            _fun100737: for (var _fun100737_ip = 0;;) switch (_fun100737_ip) {
                                                case 0:
                                                    StartGenerator();
                                                    ResumeGenerator(result_out_reg = 0, return_bool_out_reg = 1);
                                                    if (var1) {
    ...
    return var0;
})(undefined, undefined, undefined, undefined, undefined, undefined, [5, 27, 13083, 3998, 13085, 13086, 3282, 13087, 1307, 8886, 4001, 13088, 8885, 1464, 2]);