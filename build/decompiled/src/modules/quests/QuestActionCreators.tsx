...
export default (function(global, require, metroImportDefault, metroImportAll, module, exports, dependencyMap) {
    ...
    var0 = function() { // Original name: _manualStopConsoleQuest, environment: var1
        ...
        var2 = function*(arg0) { // Environment: var2
            var0 = function*(arg0) { // Original name: ?anon_0_, environment: var0
                _fun46735: for (var _fun46735_ip = 0;;) switch (_fun46735_ip) {
                    case 0:
                        StartGenerator();
    ...
    var0 = function() { // Original name: _resetRecentQuestCompletions, environment: var1
        ...
        var2 = function*() { // Environment: var2
            var0 = function*() { // Original name: ?anon_0_, environment: var0
                _fun46738: for (var _fun46738_ip = 0;;) switch (_fun46738_ip) {
                    case 0:
                        StartGenerator();
                        ResumeGenerator(result_out_reg = 0, return_bool_out_reg = 1);
                        if (var1) {
    ...
    var0 = function() { // Original name: _sendHeartbeat, environment: var1
        ...
        var2 = function*(arg0) { // Environment: var2
            var0 = function*(arg0) { // Original name: ?anon_0_, environment: var0
                _fun46748: for (var _fun46748_ip = 0;;) switch (_fun46748_ip) {
                    case 0:
                        StartGenerator();
                        var1 = arg0;
    ...
    var0 = function() { // Original name: _enrollInQuest, environment: var1
        ...
        var2 = function*(arg0, arg1) { // Environment: var2
            var0 = function*(arg0, arg1) { // Original name: ?anon_0_, environment: var0
                _fun46751: for (var _fun46751_ip = 0;;) switch (_fun46751_ip) {
                    case 0:
                        StartGenerator();
                        var1 = arg1;
                        ResumeGenerator(result_out_reg = 0, return_bool_out_reg = 2);
    ...
    var0 = function() { // Original name: _fetchVideoTranscript, environment: var1
        ...
        var2 = function*(arg0) { // Environment: var2
            var0 = function*(arg0) { // Original name: ?anon_0_, environment: var0
                _fun46785: for (var _fun46785_ip = 0;;) switch (_fun46785_ip) {
                    case 0:
                        StartGenerator();
                        var10 = arguments[1];
                        ResumeGenerator(result_out_reg = 0, return_bool_out_reg = 1);
    ...
    var0 = function() { // Original name: _fetchQuestPreview, environment: var1
        ...
        var2 = function*(arg0) { // Environment: var2
            var0 = function*(arg0) { // Original name: ?anon_0_, environment: var0
                _fun46791: for (var _fun46791_ip = 0;;) switch (_fun46791_ip) {
                    case 0:
                        StartGenerator();
                        var4 = arg0;
                        ResumeGenerator(result_out_reg = 0, return_bool_out_reg = 1);
    ...
    return var0;
})(undefined, undefined, undefined, undefined, undefined, undefined, [57, 5, 3172, 5188, 5189, 5190, 660, 507, 806, 3311, 5192, 1234, 5203, 4488, 481, 5221, 5223, 5240, 5200, 5241, 4277, 5226, 5242, 1348, 5243, 795, 5239, 5246, 5247, 667, 2]);