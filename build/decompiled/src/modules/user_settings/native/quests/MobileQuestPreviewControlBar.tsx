...
export default (function(global, require, metroImportDefault, metroImportAll, module, exports, dependencyMap) {
    ...
    var1 = function arg0() {
        _fun84608: for (var _fun84608_ip = 0;;) switch (_fun84608_ip) {
            case 0:
                ...
                var1 = function*() { // Environment: var0
                    var0 = function*() { // Original name: ?anon_0_, environment: var0
                        _fun84618: for (var _fun84618_ip = 0;;) switch (_fun84618_ip) {
                            case 0:
                                StartGenerator();
                                ResumeGenerator(result_out_reg = 0, return_bool_out_reg = 1);
                                if (var1) {
    ...
    return var0;
})(undefined, undefined, undefined, undefined, undefined, undefined, [5, 57, 31, 27, 5284, 483, 33, 1297, 671, 5372, 566, 5317, 7791, 1235, 5351, 10802, 10806, 7570, 10785, 9279, 3938, 2]);