...
export default (function(global, require, metroImportDefault, metroImportAll, module, exports, dependencyMap) {
    ...
    var1 = function arg0() {
        _fun84214: for (var _fun84214_ip = 0;;) switch (_fun84214_ip) {
            case 0:
                    ...
                    _fun84217: for (var _fun84217_ip = 0;;) switch (_fun84217_ip) {
                        case 0:
                            ...
                            var0 = function(arg0) { // Environment: var2
                                _fun84218: for (var _fun84218_ip = 0;;) switch (_fun84218_ip) {
                                    case 0:
                                        var1 = arg0;
                                        var0 = {};
                                        var3 = var1.config;
                ...
                var1 = function*() { // Environment: var0
                    var0 = function*() { // Original name: ?anon_0_, environment: var0
                        _fun84224: for (var _fun84224_ip = 0;;) switch (_fun84224_ip) {
                            case 0:
                                StartGenerator();
                                ResumeGenerator(result_out_reg = 0, return_bool_out_reg = 1);
                                if (var1) {
    ...
    return var0;
})(undefined, undefined, undefined, undefined, undefined, undefined, [5, 57, 31, 27, 5226, 483, 33, 1297, 671, 5313, 566, 5258, 7733, 1234, 5291, 10780, 10784, 7511, 10765, 9218, 3941, 2]);