...
export default (function(global, require, metroImportDefault, metroImportAll, module, exports, dependencyMap) {
    ...
    var1.applyButtonContainer = var10;
    var10 = {
        'flexDirection': 'row',
        'width': '100%',
    ...
    var1.avatarDisplayContainer = var10;
    var10 = {
        'textAlign': 'center',
        'marginTop': 16
    };
    ...
    var1.descriptionContainer = var10;
    var10 = {
        'textAlign': 'center',
        'marginTop': 2
    };
    ...
    var10.color = var11;
    var1.purchasedAt = var10;
    var1 = var7.bind(var9)(var1);
    var _closure1_slot19 = var1;
    var1 = {};
    var7 = 'function EditAvatarDecorationActionSheetTsx1(){const{shouldShowApplyButton,APPLY_BUTTON_BOUNCE_DISTANCE,APPLY_BUTTON_SCALE_TRANSITION,reducedMotion,withSpring,MEDIA_PICKER_SEND_BUTTON_SPRING}=this.__closure;const targetTranslateY=shouldShowApplyButton.get()?0:APPLY_BUTTON_BOUNCE_DISTANCE;const targetScale=shouldShowApplyButton.get()?1:APPLY_BUTTON_SCALE_TRANSITION;return{transform:[{translateY:reducedMotion?targetTranslateY:withSpring(targetTranslateY,MEDIA_PICKER_SEND_BUTTON_SPRING)},{scale:reducedMotion?targetScale:withSpring(targetScale,MEDIA_PICKER_SEND_BUTTON_SPRING)}]};}';
    var1.code = var7;
    var _closure1_slot20 = var1;
    var1 = {};
    var7 = "function EditAvatarDecorationActionSheetTsx2(){const{shouldShowApplyButton}=this.__closure;return{pointerEvents:shouldShowApplyButton.get()?'box-none':'none'};}";
    var1.code = var7;
    var _closure1_slot21 = var1;
    var1 = {};
    var7 = 'function EditAvatarDecorationActionSheetTsx3(){const{shouldShowApplyButton,reducedMotion,withSpring,MEDIA_PICKER_SEND_BUTTON_SPRING}=this.__closure;const targetOpacity=shouldShowApplyButton.get()?1:0;return{opacity:reducedMotion?targetOpacity:withSpring(targetOpacity,{...MEDIA_PICKER_SEND_BUTTON_SPRING,overshootClamping:true})};}';
    var1.code = var7;
        ...
        _fun49129: for (var _fun49129_ip = 0;;) switch (_fun49129_ip) {
            ...
            case 643:
                ...
                var1 = function() { // Environment: var0
                    _fun49135: for (var _fun49135_ip = 0;;) switch (_fun49135_ip) {
                        case 0:
                ...
                var0 = function() { // Environment: var0
                    _fun49136: for (var _fun49136_ip = 0;;) switch (_fun49136_ip) {
                        case 0:
    ...
    return var0;
})(undefined, undefined, undefined, undefined, undefined, undefined, [57, 31, 27, 1298, 4616, 1685, 1681, 1621, 660, 3283, 1566, 1623, 33, 1297, 671, 1568, 566, 5578, 3720, 4081, 3109, 4599, 1234, 3279, 4597, 5579, 5580, 3278, 4873, 5581, 5723, 5725, 5726, 795, 3159, 4931, 4933, 3941, 5202, 5202, 5727, 5733, 3132, 5585, 5734, 5454, 5741, 5742, 2]);