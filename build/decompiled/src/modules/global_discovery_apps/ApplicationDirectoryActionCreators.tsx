...
export default (function(global, require, metroImportDefault, metroImportAll, module, exports, dependencyMap) {
                ...
                _fun107446: for (var _fun107446_ip = 0;;) switch (_fun107446_ip) {
                    ...
                    case 159:
                        ...
                        var3 = function(arg0, arg1) { // Original name: interceptResponse, environment: var6
                            _fun107447: for (var _fun107447_ip = 0;;) switch (_fun107447_ip) {
                                case 0:
                                    var0 = arg1;
    ...
    var0 = function() { // Original name: _fetchIntegrationApplicationIdsForMyGuilds, environment: var1
        ...
        var2 = function*() { // Environment: var2
            var0 = function*() { // Original name: ?anon_0_, environment: var0
                _fun107466: for (var _fun107466_ip = 0;;) switch (_fun107466_ip) {
                    case 0:
                        StartGenerator();
                        ResumeGenerator(result_out_reg = 0, return_bool_out_reg = 1);
                        if (var1) {
    ...
    return var0;
})(undefined, undefined, undefined, undefined, undefined, undefined, [5, 3964, 1676, 803, 5307, 13835, 13836, 13831, 13837, 13838, 660, 806, 561, 507, 13832, 478, 13839, 13840, 13841, 2]);