...
export default (function(global, require, metroImportDefault, metroImportAll, module, exports, dependencyMap) {
                ...
                case 13:
                    ...
                    var9 = function*() { // Environment: var9
                        var0 = function*() { // Original name: ?anon_0_, environment: var0
                            _fun118248: for (var _fun118248_ip = 0;;) switch (_fun118248_ip) {
                                case 0:
                                    StartGenerator();
    ...
    var1 = function() { // Environment: var1
        ...
        var1 = function*(arg0) { // Environment: var0
            var0 = function*(arg0) { // Original name: ?anon_0_, environment: var0
                _fun118252: for (var _fun118252_ip = 0;;) switch (_fun118252_ip) {
                    case 0:
                        StartGenerator();
                        ResumeGenerator(result_out_reg = 0, return_bool_out_reg = 1);
                        if (var1) {
    ...
    var1 = var2.bind(var3)(var1);
    return var0;
})(undefined, undefined, undefined, undefined, undefined, undefined, [5, 27, 14385, 1590, 3472, 1216, 1372, 1410, 3, 8834, 14563, 806, 12224, 1594, 795, 4557, 5898, 3943, 11108, 1313, 2]);