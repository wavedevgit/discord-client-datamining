...
export default (function(global, require, metroImportDefault, metroImportAll, module, exports, dependencyMap) {
    ...
    var6 = function(arg0, arg1, arg2) { // Original name: fetchGuildEventUserCounts, environment: var3
        ...
        var0 = function*() { // Environment: var0
            var0 = function*() { // Original name: ?anon_0_, environment: var0
                _fun65278: for (var _fun65278_ip = 0;;) switch (_fun65278_ip) {
                    case 0:
                        StartGenerator();
                        ResumeGenerator(result_out_reg = 0, return_bool_out_reg = 1);
                        if (var1) {
    ...
    var6 = function(arg0, arg1, arg2, arg3, arg4) { // Original name: updateRsvp, environment: var3
        ...
        var0 = function*() { // Environment: var0
            var0 = function*() { // Original name: ?anon_0_, environment: var0
                _fun65292: for (var _fun65292_ip = 0;;) switch (_fun65292_ip) {
                    case 0:
                        StartGenerator();
                        ResumeGenerator(result_out_reg = 0, return_bool_out_reg = 1);
                        if (var1) {
    ...
    var2.default = var1;
    return var0;
})(undefined, undefined, undefined, undefined, undefined, undefined, [5, 1216, 3293, 1378, 660, 507, 4195, 1220, 8063, 3320, 806, 8065, 21, 2]);