...
export default (function(global, require, metroImportDefault, metroImportAll, module, exports, dependencyMap) {
    ...
    var6 = function arg0() {
        ...
        var0 = function*() { // Environment: var0
            var0 = function*() { // Original name: ?anon_0_, environment: var0
                _fun65971: for (var _fun65971_ip = 0;;) switch (_fun65971_ip) {
                    case 0:
                        StartGenerator();
                        ResumeGenerator(result_out_reg = 0, return_bool_out_reg = 1);
                        if (var1) {
    ...
    var6 = function arg0, arg1, arg2() {
        ...
        var0 = function*() { // Environment: var0
            var0 = function*() { // Original name: ?anon_0_, environment: var0
                _fun65977: for (var _fun65977_ip = 0;;) switch (_fun65977_ip) {
                    case 0:
                        StartGenerator();
                        ResumeGenerator(result_out_reg = 0, return_bool_out_reg = 1);
                        if (var1) {
    ...
    var6 = function arg0, arg1, arg2() {
        _fun65981: for (var _fun65981_ip = 0;;) switch (_fun65981_ip) {
            ...
            case 39:
                ...
                var0 = function*() { // Environment: var0
                    var0 = function*() { // Original name: ?anon_0_, environment: var0
                        _fun65983: for (var _fun65983_ip = 0;;) switch (_fun65983_ip) {
                            case 0:
                                StartGenerator();
                                ResumeGenerator(result_out_reg = 0, return_bool_out_reg = 1);
                                if (var1) {
    ...
    var3 = function arg0, arg1, arg2, arg3() {
        _fun65987: for (var _fun65987_ip = 0;;) switch (_fun65987_ip) {
            case 0:
                var5 = arg0;
                var4 = arg1;
                var3 = arg2;
    ...
    var2.default = var1;
    return var0;
})(undefined, undefined, undefined, undefined, undefined, undefined, [5, 1216, 3335, 1378, 660, 507, 4231, 1220, 8173, 3362, 806, 8175, 21, 2]);