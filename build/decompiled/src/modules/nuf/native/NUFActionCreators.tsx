...
export default (function(global, require, metroImportDefault, metroImportAll, module, exports, dependencyMap) {
    ...
    var0 = function() {
        ...
        var2 = function*(arg0) { // Environment: var2
            var0 = function*(arg0) { // Original name: ?anon_0_, environment: var0
                _fun81339: for (var _fun81339_ip = 0;;) switch (_fun81339_ip) {
                    case 0:
                        StartGenerator();
                        var7 = arg0;
    ...
    var3 = function() {
        ...
        var2 = function*() { // Environment: var2
            var0 = function*() { // Original name: ?anon_0_, environment: var0
                _fun81350: for (var _fun81350_ip = 0;;) switch (_fun81350_ip) {
                    case 0:
                        StartGenerator();
                        ResumeGenerator(result_out_reg = 0, return_bool_out_reg = 1);
                        if (var1) {
    ...
    return var0;
})(undefined, undefined, undefined, undefined, undefined, undefined, [5, 10358, 4519, 1621, 10360, 660, 7590, 806, 4561, 10361, 1307, 10356, 10364, 10365, 670, 10367, 10366, 2]);