...
export default (function(global, require, metroImportDefault, metroImportAll, module, exports, dependencyMap) {
    ...
    var0 = function() { // Original name: _handleOneRecipientInDM, environment: var1
        ...
        var2 = function*(arg0, arg1) { // Environment: var2
            var0 = function*(arg0, arg1) { // Original name: ?anon_0_, environment: var0
                _fun108504: for (var _fun108504_ip = 0;;) switch (_fun108504_ip) {
                    case 0:
                        StartGenerator();
    ...
    var0 = function() { // Original name: _handleInviteUsers, environment: var1
        ...
        var2 = function*(arg0) { // Environment: var2
            var0 = function*(arg0) { // Original name: ?anon_0_, environment: var0
                _fun108507: for (var _fun108507_ip = 0;;) switch (_fun108507_ip) {
                    case 0:
                        StartGenerator();
                        var4 = arg0;
                        var6 = arguments[1];
                    ...
                    case 379:
                        ...
                        var8 = function*() { // Environment: var3
                            var0 = function*() { // Original name: ?anon_0_, environment: var0
                                _fun108509: for (var _fun108509_ip = 0;;) switch (_fun108509_ip) {
                                    case 0:
                                        StartGenerator();
                                        ResumeGenerator(result_out_reg = 0, return_bool_out_reg = 1);
                                        if (var1) {
    ...
    var1 = function(arg0) { // Original name: NewGroupDMScreen, environment: var1
        _fun108510: for (var _fun108510_ip = 0;;) switch (_fun108510_ip) {
            ...
            case 400:
                ...
                var0 = function*() { // Environment: var23
                    var0 = function*() { // Original name: ?anon_0_, environment: var0
                        _fun108516: for (var _fun108516_ip = 0;;) switch (_fun108516_ip) {
                            case 0:
                                StartGenerator();
                                ResumeGenerator(result_out_reg = 0, return_bool_out_reg = 1);
                                if (var1) {
                            ...
                            case 30: // try_start_0
                                ...
                                var2 = function() { // Environment: var2
                                    _fun108518: for (var _fun108518_ip = 0;;) switch (_fun108518_ip) {
                                        case 0:
                ...
                var14[8] = var21;
                var0 = function() { // Environment: var23
                    _fun108519: for (var _fun108519_ip = 0;;) switch (_fun108519_ip) {
                        case 0:
                            var0 = _closure2_slot4;
                            var2 = null;
                            if (!(var2 != var0)) {
            ...
            case 796:
                ...
                var23 = function() { // Environment: var23
                    ...
                    var1 = function*(arg0) { // Environment: var0
                        var0 = function*(arg0) { // Original name: ?anon_0_, environment: var0
                            _fun108530: for (var _fun108530_ip = 0;;) switch (_fun108530_ip) {
                                case 0:
                                    StartGenerator();
                                    ResumeGenerator(result_out_reg = 0, return_bool_out_reg = 1);
                                    if (var1) {
    ...
    var2.default = var1;
    return var0;
})(undefined, undefined, undefined, undefined, undefined, undefined, [57, 5, 31, 27, 1372, 12469, 3477, 1613, 8842, 660, 33, 1297, 671, 3904, 7838, 7980, 7928, 3237, 566, 13807, 795, 3107, 1234, 8848, 8857, 8671, 8318, 5860, 6511, 4841, 11250, 2]);