...
export default (function(global, require, metroImportDefault, metroImportAll, module, exports, dependencyMap) {
    _fun85293: for (var _fun85293_ip = 0;;) switch (_fun85293_ip) {
        case 0:
            var6 = require;
            ...
            var0 = function() { // Original name: _fetchCurrentAppIcon, environment: var1
                ...
                var2 = function*() { // Environment: var2
                    var0 = function*() { // Original name: ?anon_0_, environment: var0
                        _fun85297: for (var _fun85297_ip = 0;;) switch (_fun85297_ip) {
                            case 0:
                                StartGenerator();
            ...
            var3 = function() { // Original name: useCurrentAppIcon, environment: var1
                ...
                var4 = function*() { // Environment: var1
                    var0 = function*() { // Original name: ?anon_0_, environment: var0
                        _fun85300: for (var _fun85300_ip = 0;;) switch (_fun85300_ip) {
                            case 0:
                                StartGenerator();
                                ResumeGenerator(result_out_reg = 0, return_bool_out_reg = 1);
                                if (var1) {
...
})(undefined, undefined, undefined, undefined, undefined, undefined, [57, 5, 31, 27, 7596, 660, 1615, 3, 478, 10958, 7597, 4062, 806, 795, 3107, 1234, 5883, 4065, 2]);