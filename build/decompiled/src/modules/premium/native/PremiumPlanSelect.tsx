...
export default (function(global, require, metroImportDefault, metroImportAll, module, exports, dependencyMap) {
    ...
    var0 = function arg0() {
        _fun83297: for (var _fun83297_ip = 0;;) switch (_fun83297_ip) {
            ...
            case 766:
                var0.disabled = var5;
                var4 = function() {
                    _fun83300: for (var _fun83300_ip = 0;;) switch (_fun83300_ip) {
                        case 0:
                            ...
                            var7 = function() {
                                ...
                                var0 = function(arg0) { // Environment: var0
                                    ...
                                    var0 = function(arg0) { // Environment: var0
                                        ...
                                        var6 = function*() { // Environment: var4
                                            var0 = function*() { // Original name: ?anon_0_, environment: var0
                                                _fun83318: for (var _fun83318_ip = 0;;) switch (_fun83318_ip) {
                                                    case 0:
                                                        StartGenerator();
                                                        ResumeGenerator(result_out_reg = 0, return_bool_out_reg = 1);
                                                        if (var1) {
                                        ...
                                        var4 = function*() { // Environment: var4
                                            var0 = function*() { // Original name: ?anon_0_, environment: var0
                                                _fun83320: for (var _fun83320_ip = 0;;) switch (_fun83320_ip) {
                                                    case 0:
                                                        StartGenerator();
                                                        ResumeGenerator(result_out_reg = 0, return_bool_out_reg = 1);
                                                        if (var1) {
    ...
    var1 = function arg0, arg1() {
        _fun83331: for (var _fun83331_ip = 0;;) switch (_fun83331_ip) {
            case 0:
                var0 = arg0;
                var8 = arg1;
            ...
            case 28:
                ...
                var14[0] = var3;
                var2 = function() { // Environment: var13
                    _fun83334: for (var _fun83334_ip = 0;;) switch (_fun83334_ip) {
                        case 0:
                            var0 = _closure2_slot1;
                            if (var0) {
                                _fun83334_ip = 45;
                ...
                var13 = function() { // Environment: var13
                    ...
                    var1 = function*(arg0, arg1) { // Environment: var0
                        var0 = function*(arg0, arg1) { // Original name: ?anon_0_, environment: var0
                            _fun83342: for (var _fun83342_ip = 0;;) switch (_fun83342_ip) {
                                case 0:
                                    StartGenerator();
                                    ResumeGenerator(result_out_reg = 0, return_bool_out_reg = 1);
                                    if (var1) {
    ...
    var2.default = var1;
    return var0;
})(undefined, undefined, undefined, undefined, undefined, undefined, [5, 57, 31, 27, 3123, 3124, 4617, 10647, 1623, 660, 33, 1297, 4689, 4881, 671, 1235, 3116, 10648, 10649, 10650, 10651, 10652, 10653, 566, 3252, 4885, 4970, 3212, 7340, 7341, 7221, 7192, 3935, 10654, 1307, 4106, 5788, 5688, 3445, 4937, 4111, 7193, 7161, 6952, 7353, 5642, 6958, 3940, 7316, 7358, 796, 7163, 2]);