...
export default (function(global, require, metroImportDefault, metroImportAll, module, exports, dependencyMap) {
    ...
    var1 = function arg0() {
        _fun80704: for (var _fun80704_ip = 0;;) switch (_fun80704_ip) {
            case 0:
                var3 = arg0;
                var11 = var3.code;
                ...
                var5 = function() { // Environment: var1
                    _fun80705: for (var _fun80705_ip = 0;;) switch (_fun80705_ip) {
                        case 0:
            ...
            case 260:
                ...
                var1 = function*() { // Environment: var1
                    var0 = function*() { // Original name: ?anon_0_, environment: var0
                        _fun80712: for (var _fun80712_ip = 0;;) switch (_fun80712_ip) {
                            case 0:
                                StartGenerator();
                                ResumeGenerator(result_out_reg = 0, return_bool_out_reg = 1);
                                if (var1) {
    ...
    var2.default = var1;
    return var0;
})(undefined, undefined, undefined, undefined, undefined, undefined, [5, 31, 1681, 1410, 3323, 660, 3079, 33, 1297, 671, 1469, 566, 10272, 5898, 4705, 1384, 4683, 1307, 3333, 8095, 5680, 9045, 10273, 4734, 3159, 2]);