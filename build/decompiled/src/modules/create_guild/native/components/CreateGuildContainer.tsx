...
export default (function(global, require, metroImportDefault, metroImportAll, module, exports, dependencyMap) {
        ...
        _fun72115: for (var _fun72115_ip = 0;;) switch (_fun72115_ip) {
            ...
            case 39:
                ...
                var1 = function*() { // Environment: var1
                    var0 = function*() { // Original name: ?anon_0_, environment: var0
                        _fun72120: for (var _fun72120_ip = 0;;) switch (_fun72120_ip) {
                            case 0:
                                StartGenerator();
                                ResumeGenerator(result_out_reg = 0, return_bool_out_reg = 1);
                                if (var1) {
    ...
    var2.default = var1;
    return var0;
})(undefined, undefined, undefined, undefined, undefined, undefined, [5, 57, 31, 1673, 1621, 660, 33, 1297, 4711, 5665, 4008, 9009, 4687, 1598, 8404, 4744, 9023, 2]);