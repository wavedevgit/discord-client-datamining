...
export default (function(global, require, metroImportDefault, metroImportAll, module, exports, dependencyMap) {
        ...
        _fun71970: for (var _fun71970_ip = 0;;) switch (_fun71970_ip) {
            ...
            case 39:
                ...
                var1 = function*() { // Environment: var1
                    var0 = function*() { // Original name: ?anon_0_, environment: var0
                        _fun71975: for (var _fun71975_ip = 0;;) switch (_fun71975_ip) {
                            case 0:
                                StartGenerator();
                                ResumeGenerator(result_out_reg = 0, return_bool_out_reg = 1);
                                if (var1) {
    ...
    var2.default = var1;
    return var0;
})(undefined, undefined, undefined, undefined, undefined, undefined, [5, 57, 31, 1676, 1621, 660, 33, 1297, 4710, 5666, 4010, 8985, 4685, 1598, 8380, 4743, 8999, 2]);