...
public final class i0 implements dn.c0 {
    ...
    private final /* synthetic */ dn.f f30369a;

    /* renamed from: b  reason: collision with root package name */
    private final un.f0 f30370b;

    /* renamed from: c  reason: collision with root package name */
    private final un.t f30371c;
    ...
    public static final class b implements un.y {
        ...
        /* renamed from: a  reason: collision with root package name */
        final /* synthetic */ no.b f30372a;

        /* renamed from: b  reason: collision with root package name */
        final /* synthetic */ f5.b f30373b;

        /* renamed from: c  reason: collision with root package name */
        final /* synthetic */ un.t f30374c;

        /* renamed from: d  reason: collision with root package name */
        final /* synthetic */ un.f0 f30375d;
        ...
        @Override // un.y
        public void a() {
            PreviewView previewView = this.f30372a.f41026y;
            Intrinsics.checkNotNullExpressionValue(previewView, "previewView");
            this.f30374c.f(previewView, t.a.f51852e, this.f30375d, true, this.f30373b.x());
        }
    }
    ...
    public i0(final un.f0 governmentIdFeed, final un.t cameraPreview) {
        ...
        this.f30369a = new dn.f(Reflection.getOrCreateKotlinClass(f5.b.class), new Function4() { // from class: jo.h0
        ...
        this.f30370b = governmentIdFeed;
        this.f30371c = cameraPreview;
    }
    ...
    public static final View c(un.f0 f0Var, un.t tVar, f5.b initialRendering, dn.a0 initialViewEnvironment, Context context, ViewGroup viewGroup) {
        ...
        if (initialRendering.G() != ao.a.f6227e && initialRendering.G() != ao.a.f6226d) {
            ...
            PreviewView previewView = c10.f41026y;
            Intrinsics.checkNotNullExpressionValue(previewView, "previewView");
            ...
            wn.m b10 = wn.j.b(applicationContext, wn.n.f54063e);
            if (b10 == null) {
                initialRendering.x().invoke(new un.s0());
                Camera2PreviewView camera2Preview = c10.f41004c;
                ...
                Camera2PreviewView camera2Preview2 = c10.f41004c;
    ...
    public View a(f5.b initialRendering, dn.a0 initialViewEnvironment, Context contextForNewView, ViewGroup viewGroup) {
        ...
        return this.f30369a.a(initialRendering, initialViewEnvironment, contextForNewView, viewGroup);
    }

    @Override // dn.c0
    public KClass getType() {
        return this.f30369a.getType();
    }
}
