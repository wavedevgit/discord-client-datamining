...
public final class b implements Parcelable {
    ...
    private final e f31843d;

    /* renamed from: e  reason: collision with root package name */
    private final String f31844e;

    /* renamed from: i  reason: collision with root package name */
    private final Map f31845i;
    ...
    public b(e idType, String minAge, Map elementToStoreLength) {
        ...
        this.f31843d = idType;
        this.f31844e = minAge;
        this.f31845i = elementToStoreLength;
    }
    ...
    public final void writeToParcel(Parcel dest, int i10) {
        ...
        dest.writeString(this.f31843d.name());
        dest.writeString(this.f31844e);
        Map map = this.f31845i;
