...
public final class g1 implements dn.k {
    ...
    public static final a f30208f = new a(null);

    /* renamed from: b  reason: collision with root package name */
    private final no.g f30209b;

    /* renamed from: c  reason: collision with root package name */
    private final ConstraintSet f30210c;
    ...
    public static final class a implements dn.c0 {
        ...
        private final /* synthetic */ dn.c0 f30213a;
        ...
        /* synthetic */ class C0427a extends FunctionReferenceImpl implements Function3 {
            ...
            /* renamed from: d  reason: collision with root package name */
            public static final C0427a f30214d = new C0427a();
        ...
        public View a(f5.e initialRendering, dn.a0 initialViewEnvironment, Context contextForNewView, ViewGroup viewGroup) {
            ...
            return this.f30213a.a(initialRendering, initialViewEnvironment, contextForNewView, viewGroup);
        }

        @Override // dn.c0
        public KClass getType() {
            return this.f30213a.getType();
        }

        private a() {
            k.a aVar = dn.k.f20913a;
            this.f30213a = new dn.z(Reflection.getOrCreateKotlinClass(f5.e.class), C0427a.f30214d, b.f30215d);
        }
    }

    public g1(no.g binding) {
        Intrinsics.checkNotNullParameter(binding, "binding");
        this.f30209b = binding;
        this.f30210c = new ConstraintSet();
        CoordinatorLayout cameraScreenContent = binding.f41022d;
        ...
        ThemeableLottieAnimationView themeableLottieAnimationView = binding.f41033o;
    ...
    private final Unit k(StepStyles.GovernmentIdStepStyle governmentIdStepStyle) {
        ...
        if (governmentIdCaptureHintTextStyle != null) {
            TextView overlayText = this.f30209b.f41035q;
        ...
        if (governmentIdReviewImageBoxBorderColorValue != null) {
            ...
            gVar.f41037s.setIndeterminateTintList(new ColorStateList(new int[][]{new int[0]}, new int[]{i10}));
        } else {
            i10 = -1;
        }
        TextView disclaimer = this.f30209b.f41024f;
        ...
        gVar.f41040v.setRadius(a11 + a10);
        View view = gVar.f41030l;
        GradientDrawable gradientDrawable = new GradientDrawable();
        gradientDrawable.setCornerRadius(a10);
        gradientDrawable.setStroke(a11, i10);
        view.setBackground(gradientDrawable);
        ConstraintLayout constraintLayout = gVar.f41032n;
        ...
        if (submitPhotoButtonStyleValue != null) {
            Button acceptButton = gVar.f41020b;
        ...
        if (retakePhotoButtonStyleValue != null) {
            Button retryButton = gVar.f41038t;
        ...
        if (captureHintIconStrokeColor != null) {
            this.f30209b.f41033o.I(Color.parseColor("#000000"), captureHintIconStrokeColor.intValue());
        }
        Integer captureHintIconFillColor = governmentIdStepStyle.getCaptureHintIconFillColor();
        if (captureHintIconFillColor != null) {
            this.f30209b.f41033o.I(Color.parseColor("#43957D"), captureHintIconFillColor.intValue());
        }
        ...
        this.f30209b.f41029k.setControlsColor(capturePageHeaderIconColorValue.intValue());
        return Unit.f32008a;
    }

    private final void l() {
        no.g gVar = this.f30209b;
        if (gVar.f41020b.getTop() < gVar.f41026h.getBottom() + gVar.getRoot().getContext().getResources().getDimensionPixelOffset(k4.f30347a)) {
            this.f30210c.e(gVar.getRoot().getContext(), n4.f30552h);
            androidx.transition.x.a(this.f30209b.f41022d, new androidx.transition.a());
            this.f30210c.c(this.f30209b.f41023e);
        }
    }

    private final void m(final StyleElements.Axis axis, final long j10) {
        final no.g gVar = this.f30209b;
        Button acceptButton = gVar.f41020b;
        Intrinsics.checkNotNullExpressionValue(acceptButton, "acceptButton");
    ...
    public static final Unit o(no.g gVar, long j10, final g1 g1Var, StyleElements.Axis axis) {
        boolean z10;
        boolean z11 = false;
        if (gVar.f41020b.getLineCount() != 0 && gVar.f41038t.getLineCount() != 0) {
            z10 = true;
        } else {
            z10 = false;
        }
        ...
        if (z10 && (gVar.f41020b.getLineCount() > 1 || gVar.f41038t.getLineCount() > 1 || axis == StyleElements.Axis.VERTICAL)) {
            Button acceptButton = gVar.f41020b;
            Intrinsics.checkNotNullExpressionValue(acceptButton, "acceptButton");
            ViewGroup.LayoutParams layoutParams = acceptButton.getLayoutParams();
            if (layoutParams != null) {
                layoutParams.width = gVar.f41028j.getWidth();
                acceptButton.setLayoutParams(layoutParams);
                Button retryButton = gVar.f41038t;
                Intrinsics.checkNotNullExpressionValue(retryButton, "retryButton");
                ViewGroup.LayoutParams layoutParams2 = retryButton.getLayoutParams();
                if (layoutParams2 != null) {
                    layoutParams2.width = gVar.f41028j.getWidth();
                    retryButton.setLayoutParams(layoutParams2);
                    gVar.f41028j.setReferencedIds(new int[]{gVar.f41020b.getId(), gVar.f41038t.getId()});
                    g1Var.f30209b.f41029k.setAccessibilityTraversalAfter(m4.f30410r0);
                } else {
        ...
        androidx.core.view.y.a(gVar.f41020b, new Runnable() { // from class: jo.f1
    ...
    private final void q(boolean z10) {
        ...
        if (z10) {
            gVar.f41036r.setVisibility(0);
            gVar.f41026h.setVisibility(4);
            gVar.f41020b.setVisibility(4);
            gVar.f41038t.setVisibility(4);
            gVar.f41032n.setVisibility(4);
            return;
        }
        gVar.f41036r.setVisibility(4);
        gVar.f41026h.setVisibility(0);
        gVar.f41020b.setVisibility(0);
        gVar.f41038t.setVisibility(0);
        gVar.f41032n.setVisibility(0);
    }

    /* JADX INFO: Access modifiers changed from: private */
    public static final void s(no.g gVar) {
        ObjectAnimator duration = ObjectAnimator.ofFloat(gVar.f41027i, "alpha", 0.9f, 0.0f).setDuration(500L);
    ...
    public static final void t(no.g gVar, l5.i iVar) {
        gVar.f41033o.setProgress(1.0f);
    }

    /* JADX INFO: Access modifiers changed from: private */
    public static final Unit u(no.g gVar, f5.e eVar) {
        int i10 = kotlin.ranges.d.i(gVar.f41039u.getMeasuredWidth(), 2000);
        if (i10 > 0) {
            gVar.f41039u.setTag(m4.f30388g0, eVar.k());
            ImageView reviewImage = gVar.f41039u;
    ...
    public void a(final f5.e rendering, dn.a0 viewEnvironment) {
        ...
        final no.g gVar = this.f30209b;
        if (!gVar.f41021c.isChecked()) {
            gVar.f41021c.setChecked(true);
            ...
            gVar.f41033o.j(new l5.z() { // from class: jo.y0
                @Override // l5.z
        ...
        Object tag = gVar.f41039u.getTag(m4.f30388g0);
        ...
        gVar.f41035q.setText(rendering.l());
        ImageView imageView = gVar.f41025g;
        ...
        TextView textView = gVar.f41024f;
        if (StringsKt.k0(rendering.g())) {
            i11 = 8;
        } else {
            i11 = 0;
        ...
        gVar.f41024f.setText(rendering.g());
        gVar.f41020b.setText(rendering.b());
        gVar.f41038t.setText(rendering.q());
        gVar.f41042x.setText(rendering.f());
        TextView textView2 = gVar.f41042x;
        ...
        view.setBackground(f4.a(context, jp.a.f30771k));
        if (rp.s.b(context, jp.a.f30768h, null, false, false, 14, null)) {
            gVar.f41035q.setGravity(17);
            TextView overlayText = gVar.f41035q;
            Intrinsics.checkNotNullExpressionValue(overlayText, "overlayText");
        ...
        if (f10 != null) {
            gVar.f41025g.setImageResource(f10.intValue());
        }
        i4 b10 = f4.b(context, rendering.o());
        gVar.f41031m.setImageResource(b10.a());
        ...
        if (remoteImage != null) {
            if (this.f30211d == null) {
                ConstraintLayout overlayIconContainer = gVar.f41034p;
                Intrinsics.checkNotNullExpressionValue(overlayIconContainer, "overlayIconContainer");
                this.f30211d = mq.b.c(remoteImage, overlayIconContainer, false, 2, null);
                gVar.f41033o.setVisibility(8);
            }
        } else {
            gVar.f41033o.setAnimation(b10.b());
        }
        ...
        Pi2NavigationBar navigationBar = gVar.f41029k;
        Intrinsics.checkNotNullExpressionValue(navigationBar, "navigationBar");
        FrameLayout root = gVar.getRoot();
        Intrinsics.checkNotNullExpressionValue(root, "getRoot(...)");
        zp.e.b(m10, function0, function02, navigationBar, root);
        gVar.f41020b.setOnClickListener(new View.OnClickListener() { // from class: jo.c1
            @Override // android.view.View.OnClickListener
            public final void onClick(View view2) {
                g1.x(f5.e.this, view2);
            }
        });
        gVar.f41038t.setOnClickListener(new View.OnClickListener() { // from class: jo.d1
            @Override // android.view.View.OnClickListener
            public final void onClick(View view2) {
                g1.y(f5.e.this, view2);
            }
        });
        gVar.f41020b.setEnabled(rendering.u());
        gVar.f41038t.setEnabled(rendering.u());
        if (rendering.t()) {
            q(true);
        } else {
            q(false);
        ...
        if (s10 != null) {
            k(s10);
            aq.c.a(viewEnvironment, androidx.core.content.a.c(this.f30209b.getRoot().getContext(), rp.j.f49063a));
        }
        n(this, rendering.r(), 0L, 2, null);
        CoordinatorLayout cameraScreenContent = this.f30209b.f41022d;
        Intrinsics.checkNotNullExpressionValue(cameraScreenContent, "cameraScreenContent");
