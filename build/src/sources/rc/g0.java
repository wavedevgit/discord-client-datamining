...
public final class g0 implements b0 {
    ...
    public static final b0.c f48371d = new b0.c() { // from class: rc.d0
        @Override // rc.b0.c
    ...
    private final UUID f48372a;

    /* renamed from: b  reason: collision with root package name */
    private final MediaDrm f48373b;
    ...
    private g0(UUID uuid) {
        ...
        this.f48373b = mediaDrm;
        this.f48374c = 1;
        if (lc.d.f37186d.equals(uuid) && z()) {
            w(mediaDrm);
        }
    }
    ...
    private static String q(String str) {
        ...
        if (w0.f40158a == 33 && "https://default.url".equals(str)) {
            return "";
        }
        return str;
    }
    ...
    */
    private static byte[] s(java.util.UUID r3, byte[] r4) {
        /*
            java.util.UUID r0 = lc.d.f37187e
        ...
        L18:
            int r1 = ne.w0.f40158a
            r2 = 23
            if (r1 >= r2) goto L26
            java.util.UUID r1 = lc.d.f37186d
        ...
        L26:
            ...
            java.lang.String r1 = ne.w0.f40160c
            boolean r0 = r0.equals(r1)
            if (r0 == 0) goto L5f
            java.lang.String r0 = ne.w0.f40161d
    ...
    private static String t(UUID uuid, String str) {
        if (w0.f40158a < 26 && lc.d.f37185c.equals(uuid) && ("video/mp4".equals(str) || "audio/mp4".equals(str))) {
            return "cenc";
        }
        return str;
    }
    ...
    private static UUID u(UUID uuid) {
        if (w0.f40158a < 27 && lc.d.f37185c.equals(uuid)) {
            return lc.d.f37184b;
        }
        return uuid;
    }
    ...
    private static m.b y(UUID uuid, List list) {
        if (!lc.d.f37186d.equals(uuid)) {
            return (m.b) list.get(0);
        }
        if (w0.f40158a >= 28 && list.size() > 1) {
            m.b bVar = (m.b) list.get(0);
            int i10 = 0;
            for (int i11 = 0; i11 < list.size(); i11++) {
                m.b bVar2 = (m.b) list.get(i11);
                byte[] bArr = (byte[]) ne.a.e(bVar2.f48443p);
                if (w0.c(bVar2.f48442o, bVar.f48442o) && w0.c(bVar2.f48441i, bVar.f48441i) && bd.l.c(bArr)) {
                    i10 += bArr.length;
                }
            }
            ...
            for (int i13 = 0; i13 < list.size(); i13++) {
                byte[] bArr3 = (byte[]) ne.a.e(((m.b) list.get(i13)).f48443p);
        ...
        for (int i14 = 0; i14 < list.size(); i14++) {
            ...
            int g10 = bd.l.g((byte[]) ne.a.e(bVar3.f48443p));
            int i15 = w0.f40158a;
    ...
    private static boolean z() {
        return "ASUS_Z00AD".equals(w0.f40161d);
    }

    @Override // rc.b0
    public Map a(byte[] bArr) {
        return this.f48373b.queryKeyStatus(bArr);
    }

    @Override // rc.b0
    public b0.d b() {
        MediaDrm.ProvisionRequest provisionRequest = this.f48373b.getProvisionRequest();
        return new b0.d(provisionRequest.getData(), provisionRequest.getDefaultUrl());
    }

    @Override // rc.b0
    public byte[] c() {
        return this.f48373b.openSession();
    }

    @Override // rc.b0
    public void d(byte[] bArr, byte[] bArr2) {
        this.f48373b.restoreKeys(bArr, bArr2);
    }

    @Override // rc.b0
    public void e(byte[] bArr) {
        this.f48373b.provideProvisionResponse(bArr);
    }

    @Override // rc.b0
    public void f(final b0.b bVar) {
        MediaDrm.OnEventListener onEventListener;
        MediaDrm mediaDrm = this.f48373b;
        if (bVar == null) {
    ...
    public boolean i(byte[] bArr, String str) {
        if (w0.f40158a >= 31) {
            return a.a(this.f48373b, str);
        }
        try {
            MediaCrypto mediaCrypto = new MediaCrypto(this.f48372a, bArr);
            try {
    ...
    public void j(byte[] bArr) {
        this.f48373b.closeSession(bArr);
    }

    @Override // rc.b0
    public byte[] k(byte[] bArr, byte[] bArr2) {
        if (lc.d.f37185c.equals(this.f48372a)) {
            bArr2 = rc.a.b(bArr2);
        }
        return this.f48373b.provideKeyResponse(bArr, bArr2);
    }
    ...
    public b0.a l(byte[] bArr, List list, int i10, HashMap hashMap) {
        ...
        int i11;
        if (list != null) {
            bVar = y(this.f48372a, list);
            bArr2 = s(this.f48372a, (byte[]) ne.a.e(bVar.f48443p));
            str = t(this.f48372a, bVar.f48442o);
        } else {
            bVar = null;
            bArr2 = null;
            str = null;
        }
        MediaDrm.KeyRequest keyRequest = this.f48373b.getKeyRequest(bArr, bArr2, str, i10, hashMap);
        byte[] r10 = r(this.f48372a, keyRequest.getData());
        String q10 = q(keyRequest.getDefaultUrl());
        if (TextUtils.isEmpty(q10) && bVar != null && !TextUtils.isEmpty(bVar.f48441i)) {
            q10 = bVar.f48441i;
        }
        if (w0.f40158a >= 23) {
    ...
    public synchronized void release() {
        int i10 = this.f48374c - 1;
        this.f48374c = i10;
        if (i10 == 0) {
            this.f48373b.release();
        }
    }
    ...
    public c0 h(byte[] bArr) {
        boolean z10;
        if (w0.f40158a < 21 && lc.d.f37186d.equals(this.f48372a) && "L3".equals(x("securityLevel"))) {
            z10 = true;
        } else {
            z10 = false;
        }
        return new c0(u(this.f48372a), bArr, z10);
    }

    public String x(String str) {
        return this.f48373b.getPropertyString(str);
    }
}
