...
public final class m implements h {
    ...
    private final char f51979d;

    /* renamed from: e  reason: collision with root package name */
    private final char f51980e;

    /* renamed from: i  reason: collision with root package name */
    private final String f51981i;

    /* renamed from: o  reason: collision with root package name */
    private final st.c f51982o;

    /* renamed from: p  reason: collision with root package name */
    private final boolean f51983p;

    /* renamed from: q  reason: collision with root package name */
    private final boolean f51984q;

    /* renamed from: r  reason: collision with root package name */
    private final boolean f51985r;
    ...
    public m(String str) {
        if (!str.isEmpty()) {
            ...
            if (charAt >= ' ') {
                boolean z10 = true;
                this.f51983p = true;
                this.f51984q = (str.length() == 1 && i(charAt)) ? z10 : false;
                this.f51985r = false;
                return;
            }
    ...
    private void j(CharSequence charSequence, s sVar) {
        int f10 = sVar.f();
        sVar.k(f10, "Cannot parse: \"" + charSequence + "\" (expected: [" + this.f51981i + "], found: [" + charSequence.subSequence(f10, Math.min(this.f51981i.length() + f10, charSequence.length())) + "])");
    }
    ...
    */
    private void k(java.lang.CharSequence r9, ut.s r10, st.d r11, boolean r12) {
        /*
            r8 = this;
            int r0 = r10.f()
            char r1 = r8.f51979d
        ...
        L67:
            if (r6 == 0) goto L8b
            if (r12 == 0) goto L6e
            boolean r11 = r8.f51983p
            goto L7c
        L6e:
            st.c r12 = tt.a.f51010i
        ...
        Lba:
            ...
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: ut.m.k(java.lang.CharSequence, ut.s, st.d, boolean):void");
    }

    private void l(CharSequence charSequence, s sVar, st.d dVar, boolean z10) {
        boolean booleanValue;
        boolean q10;
        int f10 = sVar.f();
        if (z10) {
            booleanValue = this.f51983p;
        } else {
        ...
        if (z10) {
            ...
            q10 = tt.b.q((Locale) dVar.b(tt.a.f51004c, Locale.ROOT));
        }
        int m10 = m(charSequence, f10, this.f51981i, booleanValue, q10);
        if (m10 == -1) {
            j(charSequence, sVar);
        } else {
            sVar.l(f10 + m10);
    ...
    public void a(CharSequence charSequence, s sVar, st.d dVar, t tVar, boolean z10) {
        if (z10 && this.f51984q) {
            int f10 = sVar.f();
            if (f10 < charSequence.length() && charSequence.charAt(f10) == this.f51979d) {
                sVar.l(f10 + 1);
            } else if (this.f51979d == '.' && ((Boolean) dVar.b(tt.a.f51012k, Boolean.TRUE)).booleanValue()) {
            } else {
                j(charSequence, sVar);
            }
        } else if (this.f51981i == null) {
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    public int c() {
        String str = this.f51981i;
        if (str == null) {
            return 0;
        }
        int length = str.length();
        int i10 = 0;
        for (int i11 = 0; i11 < length && Character.isDigit(this.f51981i.charAt(i11)); i11++) {
            i10++;
        }
        return i10;
    }
    ...
    public h d(c cVar, st.d dVar, int i10) {
        boolean z10;
        boolean q10 = tt.b.q((Locale) dVar.b(tt.a.f51004c, Locale.ROOT));
        char c10 = this.f51979d;
        char c11 = this.f51980e;
        String str = this.f51981i;
        st.c cVar2 = this.f51982o;
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof m) {
            m mVar = (m) obj;
            st.c cVar = this.f51982o;
            if (cVar != null) {
                return cVar.equals(mVar.f51982o);
            }
            String str = this.f51981i;
            if (str == null) {
                if (mVar.f51981i == null && this.f51979d == mVar.f51979d && this.f51980e == mVar.f51980e) {
                    return true;
                }
                return false;
            } else if (str.equals(mVar.f51981i) && this.f51984q == mVar.f51984q) {
                return true;
            }
        }
        return false;
    ...
    public int f(st.o oVar, Appendable appendable, st.d dVar, Set set, boolean z10) {
        ...
        String str = this.f51981i;
        if (str == null) {
            appendable.append(this.f51979d);
            return 1;
        }
        appendable.append(str);
        return this.f51981i.length();
    }

    @Override // ut.h
    public boolean g() {
        if (this.f51981i == null || c() != this.f51981i.length()) {
            return false;
        }
        return true;
    }
    ...
    public int hashCode() {
        ...
        return name.hashCode() ^ this.f51979d;
    }
    ...
    private m(char c10, char c11, String str, st.c cVar, boolean z10, boolean z11, boolean z12) {
        this.f51979d = c10;
        this.f51980e = c11;
        this.f51981i = str;
        this.f51982o = cVar;
