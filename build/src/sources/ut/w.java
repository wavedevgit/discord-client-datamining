...
public enum w {
    ...
    public static /* synthetic */ class a {
        ...
        static {
            ...
            try {
                f52051a[w.SIMPLE_DATE_FORMAT.ordinal()] = 2;
            } catch (NoSuchFieldError unused2) {
            }
            try {
                f52051a[w.CLDR_24.ordinal()] = 3;
            } catch (NoSuchFieldError unused3) {
            }
            try {
                f52051a[w.CLDR_DATE.ordinal()] = 4;
            } catch (NoSuchFieldError unused4) {
            }
            try {
                f52051a[w.DYNAMIC.ordinal()] = 5;
    ...
    private static boolean B(st.x xVar) {
        return w(xVar).equals("iso8601");
    }

    private Map D(c.d dVar, st.x xVar, Locale locale, char c10, int i10) {
    ...
    private static void a(c.d dVar, st.p pVar, int i10) {
        dVar.u(pVar, i10, 9);
    }

    private static void d(c.d dVar, st.p pVar) {
        dVar.z(pVar);
    }
        ...
        if (i10 != 1) {
            if (i10 != 2) {
                if (i10 != 3) {
                    if (i10 != 4) {
                        if (i10 == 5) {
                            dVar.b0(tt.a.f51008g, tt.v.NARROW);
                    ...
                    dVar.b0(tt.a.f51008g, tt.v.WIDE);
                    dVar.z(net.time4j.f0.D);
                    dVar.L();
                    return;
                }
                dVar.b0(tt.a.f51008g, tt.v.ABBREVIATED);
                dVar.z(net.time4j.f0.D);
                dVar.L();
                return;
            }
    ...
    private static void f(c.d dVar, int i10, tt.t tVar) {
        if (i10 != 1 && i10 != 2) {
            if (i10 != 3) {
                if (i10 != 4) {
                    if (i10 == 5) {
            ...
            dVar.a0(vt.a.f52995m, i10);
            dVar.A(tVar);
            dVar.L();
        }
    }

    private static void g(st.p pVar, char c10, c.d dVar, int i10, boolean z10) {
        if (i10 == 1) {
            dVar.j(pVar, 1, 2);
        } else if (i10 != 2 && !z10) {
    ...
    private Map o(c.d dVar, st.x xVar, Locale locale, char c10, int i10, boolean z10) {
        tt.v vVar;
        tt.v vVar2;
        tt.v z11;
        int i11 = 4;
        switch (c10) {
            ...
            case 'G':
                ...
                dVar.b0(tt.a.f51008g, vVar2);
                net.time4j.history.d D = net.time4j.history.d.D(locale);
                dVar.A((tt.t) tt.t.class.cast(D.i()));
                dVar.L();
            ...
            case 'K':
                ...
                break;
            case 'L':
                dVar.b0(tt.a.f51009h, tt.m.STANDALONE);
                if (!z10) {
                    i11 = i10;
                }
            ...
            case 'Z':
                if (i10 < 4) {
                    dVar.C(tt.e.LONG, false, Collections.singletonList("+0000"));
                    break;
                } else if (i10 == 4) {
                    dVar.p();
                    break;
                } else if (i10 == 5) {
                    dVar.C(tt.e.LONG, true, Collections.singletonList("Z"));
                    break;
                } else {
            ...
            case 'a':
                if (z10) {
                    z11 = tt.v.ABBREVIATED;
                } else {
                    z11 = z(i10);
                }
                dVar.b0(tt.a.f51008g, z11);
            ...
            case 'g':
                dVar.q(st.a0.MODIFIED_JULIAN_DATE, i10, 18, x.SHOW_WHEN_NEGATIVE);
                break;
            case 'h':
    ...
    private Map q(c.d dVar, char c10, int i10, Locale locale) {
        ...
        st.p s10 = s(x(dVar), locale, c10);
        if (s10 != null) {
            if (z10 && (((z11 = s10 instanceof tt.t)) || Enum.class.isAssignableFrom(s10.getType()))) {
                if (i10 != 1) {
                    if (i10 != 2) {
                        if (i10 != 3) {
                            if (i10 == 4) {
                        ...
                        dVar.b0(tt.a.f51008g, tt.v.SHORT);
                    }
                } else {
                    dVar.b0(tt.a.f51008g, tt.v.NARROW);
                }
    ...
    private static st.p r(Set set, char c10, String str) {
        char c11;
        if (c10 == 'L') {
            c11 = 'M';
        } else if (c10 == 'c') {
    ...
    private static st.p s(st.x xVar, Locale locale, int i10) {
        st.p t10 = t(xVar, locale, i10, false);
        if (t10 == null) {
    ...
    private static st.p t(st.x xVar, Locale locale, int i10, boolean z10) {
        if (z10) {
            i10 = k(i10);
        }
        for (st.p pVar : xVar.z()) {
            int d10 = pVar.d();
            if (z10) {
                d10 = k(d10);
                continue;
        ...
        for (st.s sVar : xVar.s()) {
            for (st.p pVar2 : sVar.b(locale, tt.a.f())) {
                int d11 = pVar2.d();
                if (z10) {
                    d11 = k(d11);
                    continue;
    ...
    private static st.p u(st.x xVar) {
        for (st.s sVar : xVar.s()) {
            for (st.p pVar : sVar.b(Locale.ROOT, tt.a.f())) {
    ...
    private Map v(c.d dVar, st.x xVar, char c10, int i10, Locale locale) {
        st.p pVar;
        tt.v vVar;
        tt.v vVar2;
        tt.v vVar3;
        if (c10 == 'g') {
            ...
            st.p r10 = r(y10, c10, name);
            tt.t tVar = null;
            if (Integer.class.isAssignableFrom(r10.getType())) {
                if (r10 instanceof vt.a) {
                    tVar = (tt.t) l(r10);
                }
                pVar = (st.p) l(r10);
            } else if (r10 instanceof tt.t) {
                tVar = (tt.t) l(r10);
                pVar = null;
            } else {
                                ...
                                if (c10 != 'w') {
                                    if (c10 != 'y') {
                                        ...
                                        if (locale.getLanguage().equals("am") && w(xVar).equals("ethiopic")) {
                                            dVar.b0(tt.a.f51013l, tt.j.f51068r);
                                        } else {
                                            z10 = false;
                                        }
                                        if (i10 == 2) {
    ...
    private static String w(st.x xVar) {
    ...
    private static st.x x(c.d dVar) {
        return dVar.P();
    }

    private static Set y(st.x xVar, char c10, Locale locale) {
        if (c10 != 'w' && c10 != 'W' && c10 != 'e' && c10 != 'c') {
            return xVar.z();
        }
        for (st.s sVar : xVar.s()) {
            for (st.p pVar : sVar.b(locale, tt.a.f())) {
    ...
    private static tt.v z(int i10) {
        if (i10 <= 3) {
            return tt.v.ABBREVIATED;
        }
        if (i10 == 4) {
            return tt.v.WIDE;
        }
        ...
        if (i11 != 1) {
            if (i11 != 2) {
                if (i11 != 3) {
                    ...
                    Class n10 = x10.n();
                    if (!st.m.class.isAssignableFrom(n10) && !st.l.class.isAssignableFrom(n10)) {
