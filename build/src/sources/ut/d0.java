...
public final class d0 implements h {
    ...
    private static final ConcurrentMap f51897r = new ConcurrentHashMap();

    /* renamed from: s  reason: collision with root package name */
    private static final ConcurrentMap f51898s = new ConcurrentHashMap();

    /* renamed from: d  reason: collision with root package name */
    private final boolean f51899d;

    /* renamed from: e  reason: collision with root package name */
    private final h f51900e;

    /* renamed from: i  reason: collision with root package name */
    private final Set f51901i;

    /* renamed from: o  reason: collision with root package name */
    private final tt.g f51902o;

    /* renamed from: p  reason: collision with root package name */
    private final Locale f51903p;

    /* renamed from: q  reason: collision with root package name */
    private final int f51904q;

    /* loaded from: /home/runner/work/discord-client-datamining/discord-client-datamining/build/classes5.dex */
    private static class a {

        /* renamed from: a  reason: collision with root package name */
        private final g0 f51905a;

        /* renamed from: b  reason: collision with root package name */
        private final g0 f51906b;
        ...
        void a(CharSequence charSequence, int i10, List list, List list2, int[] iArr) {
            String f10 = this.f51905a.f(charSequence, i10);
            int length = f10.length();
            iArr[0] = i10 + length;
            String f11 = this.f51906b.f(charSequence, i10);
            int length2 = f11.length();
            iArr[1] = i10 + length2;
            if (length2 > length) {
                list2.addAll(this.f51906b.b(f11));
            } else if (length2 < length) {
                list.addAll(this.f51905a.b(f10));
            } else if (length > 0) {
                list.addAll(this.f51905a.b(f10));
                list2.addAll(this.f51906b.b(f11));
            }
    ...
    public d0(boolean z10) {
        this.f51899d = z10;
        this.f51900e = new n(z10);
        this.f51901i = null;
        this.f51902o = tt.g.SMART;
        this.f51903p = Locale.ROOT;
        this.f51904q = 0;
    }
    ...
    private String h(CharSequence charSequence, int i10, int i11) {
        ...
        for (int i12 = i10; i12 < i11; i12++) {
            ...
            if (!Character.isLetter(charAt) && (this.f51899d || i12 <= i10 || Character.isDigit(charAt))) {
                break;
            }
            sb2.append(charAt);
        }
    ...
    private List j(List list, Locale locale, tt.g gVar) {
        boolean z10;
        String str;
    ...
    */
    public void a(java.lang.CharSequence r18, ut.s r19, st.d r20, ut.t r21, boolean r22) {
        /*
            Method dump skipped, instructions count: 635
            To view this dump add '--comments-level debug' option
        */
        throw new UnsupportedOperationException("Method not decompiled: ut.d0.a(java.lang.CharSequence, ut.s, st.d, ut.t, boolean):void");
    }

    @Override // ut.h
    public h d(c cVar, st.d dVar, int i10) {
        return new d0(this.f51899d, this.f51900e, this.f51901i, (tt.g) dVar.b(tt.a.f51007f, tt.g.SMART), (Locale) dVar.b(tt.a.f51004c, Locale.ROOT), ((Integer) dVar.b(tt.a.f51020s, 0)).intValue());
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof d0) {
            d0 d0Var = (d0) obj;
            if (this.f51899d == d0Var.f51899d) {
                Set set = this.f51901i;
                Set set2 = d0Var.f51901i;
    ...
    public int f(st.o oVar, Appendable appendable, st.d dVar, Set set, boolean z10) {
        ...
        if (oVar.k()) {
            ...
            if (u10 instanceof net.time4j.tz.p) {
                return this.f51900e.f(oVar, appendable, dVar, set, z10);
            }
            if (oVar instanceof qt.f) {
                net.time4j.tz.l N = net.time4j.tz.l.N(u10);
                net.time4j.tz.d i11 = i(N.I((qt.f) qt.f.class.cast(oVar)));
                if (z10) {
                    locale = this.f51903p;
                } else {
    ...
    public int hashCode() {
        ...
        return hashCode + (this.f51899d ? 1 : 0);
    }
    ...
    private d0(boolean z10, h hVar, Set set, tt.g gVar, Locale locale, int i10) {
        this.f51899d = z10;
        this.f51900e = hVar;
        this.f51901i = set;
        this.f51902o = gVar;
