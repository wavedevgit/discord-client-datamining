...
public final class n implements h {
    ...
    private static final net.time4j.tz.p f51986t = net.time4j.tz.p.t(64800);

    /* renamed from: u  reason: collision with root package name */
    private static final ConcurrentMap f51987u = new ConcurrentHashMap();

    /* renamed from: v  reason: collision with root package name */
    private static final ConcurrentMap f51988v = new ConcurrentHashMap();

    /* renamed from: d  reason: collision with root package name */
    private final boolean f51989d;

    /* renamed from: e  reason: collision with root package name */
    private final boolean f51990e;

    /* renamed from: i  reason: collision with root package name */
    private final boolean f51991i;

    /* renamed from: o  reason: collision with root package name */
    private final Locale f51992o;

    /* renamed from: p  reason: collision with root package name */
    private final String f51993p;

    /* renamed from: q  reason: collision with root package name */
    private final String f51994q;

    /* renamed from: r  reason: collision with root package name */
    private final char f51995r;

    /* renamed from: s  reason: collision with root package name */
    private final tt.g f51996s;
    ...
    public n(boolean z10) {
        this(z10, true, false, Locale.ROOT, "+", "-", '0', tt.g.SMART);
    }
    ...
    private static String c(Locale locale) {
        ConcurrentMap concurrentMap = f51987u;
        String str = (String) concurrentMap.get(locale);
        if (str == null) {
            str = net.time4j.tz.p.f38781v.q(locale);
    ...
    private static net.time4j.tz.p h(st.o oVar, st.d dVar) {
    ...
    private static a i(Locale locale) {
        a aVar = (a) f51988v.get(locale);
        if (aVar == null) {
            String q10 = f51986t.q(locale);
            ...
            for (int i10 = 0; i10 < length; i10++) {
                if (q10.charAt(i10) == 177) {
                    ...
                    a aVar3 = (a) f51988v.putIfAbsent(locale, aVar2);
                    if (aVar3 == null) {
                        return aVar2;
                    }
                    return aVar3;
    ...
    public void a(CharSequence charSequence, s sVar, st.d dVar, t tVar, boolean z10) {
        ...
        if (z10) {
            ...
            locale = (Locale) dVar2.b(tt.a.f51004c, Locale.ROOT);
        }
        boolean q10 = tt.b.q(locale);
        if (z10) {
            booleanValue = nVar.f51991i;
        } else {
            booleanValue = ((Boolean) dVar2.b(tt.a.f51015n, Boolean.FALSE)).booleanValue();
        }
        if (z10) {
            booleanValue2 = nVar.f51990e;
        } else {
            booleanValue2 = ((Boolean) dVar2.b(tt.a.f51010i, Boolean.TRUE)).booleanValue();
        }
        if (z10) {
            charValue = nVar.f51995r;
        } else {
        ...
        if (z10) {
            ...
            str = (String) dVar2.b(b.f51833g, "+");
        }
        if (z10) {
            str2 = nVar.f51994q;
        } else {
            str2 = (String) dVar2.b(b.f51834h, "-");
        }
        a i13 = i(locale);
        int length2 = i13.f51997a.length();
        int i14 = 0;
        ...
        while (i16 < length2) {
            int i17 = length2;
            char charAt = i13.f51997a.charAt(i16);
            if (i13.f51999c > i16 || i13.f52000d <= i16) {
                str3 = str;
                str4 = str2;
                if (z11) {
                    continue;
                    ...
                    if ((!booleanValue2 && charAt == c10) || (booleanValue2 && b(charAt, c10))) {
                        ...
                        if (l10 > 0) {
                            tVar.I(b0.TIMEZONE_OFFSET, net.time4j.tz.p.f38781v);
                            sVar.l(f10 + l10);
                            return;
                        }
                ...
                if (z10) {
                    ...
                    str4 = str2;
                    gVar = (tt.g) dVar2.b(tt.a.f51007f, tt.g.SMART);
                }
                int m12 = m.m(charSequence, i10, i13.f51998b, booleanValue2, q10);
                if (m12 != -1) {
                    i10 += m12;
                } else if (nVar.f51989d) {
                    tVar.I(b0.TIMEZONE_OFFSET, net.time4j.tz.p.r(fVar2, j10));
                    sVar.l(i10);
                    return;
                } else if (gVar.e()) {
                ...
                i15 = i10 + 2;
                if (i15 < length && (m10 = m.m(charSequence, i15, i13.f51998b, booleanValue2, q10)) != -1) {
                    int i19 = i15 + m10;
    ...
    public h d(c cVar, st.d dVar, int i10) {
        return new n(this.f51989d, ((Boolean) dVar.b(tt.a.f51010i, Boolean.TRUE)).booleanValue(), ((Boolean) dVar.b(tt.a.f51015n, Boolean.FALSE)).booleanValue(), (Locale) dVar.b(tt.a.f51004c, Locale.ROOT), (String) dVar.b(b.f51833g, "+"), (String) dVar.b(b.f51834h, "-"), ((Character) dVar.b(tt.a.f51014m, '0')).charValue(), (tt.g) dVar.b(tt.a.f51007f, tt.g.SMART));
    }
    ...
    public boolean equals(Object obj) {
        ...
        if ((obj instanceof n) && this.f51989d == ((n) obj).f51989d) {
            return true;
        }
        return false;
    }
    ...
    public int f(st.o oVar, Appendable appendable, st.d dVar, Set set, boolean z10) {
        ...
        if (z10) {
            ...
            locale = (Locale) dVar.b(tt.a.f51004c, Locale.ROOT);
        }
        char c10 = '0';
        if (z10) {
            charValue = this.f51995r;
        } else {
        ...
        if (z10) {
            ...
            str = (String) dVar.b(b.f51833g, "+");
        }
        if (z10) {
            str2 = this.f51994q;
        } else {
            str2 = (String) dVar.b(b.f51834h, "-");
        }
        if (z10) {
            booleanValue = this.f51991i;
        } else {
            booleanValue = ((Boolean) dVar.b(tt.a.f51015n, Boolean.FALSE)).booleanValue();
        }
        int m10 = B.m();
        int l10 = B.l();
        if (!booleanValue && m10 == 0 && l10 == 0) {
            ...
            a i12 = i(locale);
            int length2 = i12.f51997a.length();
            int i13 = 0;
            int i14 = 0;
            while (i14 < length2) {
                char c12 = c10;
                char charAt = i12.f51997a.charAt(i14);
                if (i12.f51999c > i14 || i12.f52000d <= i14) {
                    pVar = B;
                    if (!booleanValue) {
                    ...
                    if (i15 != 0 || k10 != 0 || !this.f51989d) {
                        appendable.append(i12.f51998b);
                        i13 += i12.f51998b.length();
                        if (i15 < 10) {
                            appendable.append(charValue);
                            i13++;
                        }
    ...
    private n(boolean z10, boolean z11, boolean z12, Locale locale, String str, String str2, char c10, tt.g gVar) {
        this.f51989d = z10;
        this.f51990e = z11;
        this.f51991i = z12;
        this.f51992o = locale;
