...
public final class p0 {
    ...
    public static final a f46299p = new a(null);

    /* renamed from: q  reason: collision with root package name */
    private static final Regex f46300q = new Regex("([ACI][A-Z0-9<]{1})([A-Z]{3})([A-Z0-9<]{9})([0-9]{1})([A-Z0-9<]{15})");

    /* renamed from: r  reason: collision with root package name */
    private static final Regex f46301r = new Regex("([0-9]{6})([0-9]{1})([MFX<]{1})([0-9]{6})([0-9]{1})([A-Z]{3})([A-Z0-9<]{11})([0-9]{1})");

    /* renamed from: s  reason: collision with root package name */
    private static final Regex f46302s = new Regex("([A-Z0-9<]{30})");

    /* renamed from: t  reason: collision with root package name */
    private static final Regex f46303t = new Regex("([ACI][A-Z0-9<]{1})([A-Z]{3})([A-Z0-9<]{31})");

    /* renamed from: u  reason: collision with root package name */
    private static final Regex f46304u = new Regex("([A-Z0-9<]{9})([0-9]{1})([A-Z]{3})([0-9]{6})([0-9]{1})([MFX<]{1})([0-9]{6})([0-9]{1})([A-Z0-9<]{7})([0-9]{1})");

    /* renamed from: v  reason: collision with root package name */
    private static final Regex f46305v = new Regex("(P[A-Z0-9<]{1})([A-Z]{3})([A-Z0-9<]+?<<+)");

    /* renamed from: w  reason: collision with root package name */
    private static final Regex f46306w = new Regex("(P[A-Z0-9<]{1})([A-Z]{3})([A-Z0-9<]+?)<<([A-Z0-9<]+<<+)");

    /* renamed from: x  reason: collision with root package name */
    private static final Regex f46307x = new Regex("([A-Z0-9<]{9})([0-9]{1})([A-Z]{3})([0-9]{6})([0-9]{1})([MFX<]{1})([0-9]{6})([0-9]{1})?([A-Z0-9<]{14})?([0-9]{1})?([0-9]{1})?");
    ...
    private final String f46317j;

    /* renamed from: k  reason: collision with root package name */
    private final String f46318k;

    /* renamed from: l  reason: collision with root package name */
    private final Date f46319l;

    /* renamed from: m  reason: collision with root package name */
    private final Date f46320m;

    /* renamed from: n  reason: collision with root package name */
    private final Date f46321n;

    /* renamed from: o  reason: collision with root package name */
    private final String f46322o;
    ...
    public static final class a {
        ...
        private final p0 f(String str) {
            ...
            int i10;
            boolean z10;
            MatchResult d12 = Regex.d(p0.f46300q, str, 0, 2, null);
            if (d12 == null || (d10 = Regex.d(p0.f46301r, str, 0, 2, null)) == null || (d11 = Regex.d(p0.f46302s, StringsKt.J(StringsKt.J(str, d12.getValue(), "", false, 4, null), d10.getValue(), "", false, 4, null), 0, 2, null)) == null) {
                return null;
            }
            ...
            return new p0(CollectionsKt.x0(CollectionsKt.o(d12, d10, d11), ReactEditTextInputConnectionWrapper.NEWLINE_RAW_VALUE, null, null, 0, null, new Function1() { // from class: pn.o0
        ...
        private final p0 h(String str) {
            MatchResult d10;
            MatchResult d11 = Regex.d(p0.f46306w, str, 0, 2, null);
            if (d11 == null || (d10 = Regex.d(p0.f46307x, str, 0, 2, null)) == null) {
                return null;
            }
            return new p0(CollectionsKt.x0(CollectionsKt.o(d11, d10), ReactEditTextInputConnectionWrapper.NEWLINE_RAW_VALUE, null, null, 0, null, new Function1() { // from class: pn.n0
                @Override // kotlin.jvm.functions.Function1
    ...
    public boolean equals(Object obj) {
        ...
        p0 p0Var = (p0) obj;
        if (Intrinsics.areEqual(this.f46308a, p0Var.f46308a) && Intrinsics.areEqual(this.f46309b, p0Var.f46309b) && Intrinsics.areEqual(this.f46310c, p0Var.f46310c) && Intrinsics.areEqual(this.f46311d, p0Var.f46311d) && Intrinsics.areEqual(this.f46312e, p0Var.f46312e) && Intrinsics.areEqual(this.f46313f, p0Var.f46313f) && Intrinsics.areEqual(this.f46314g, p0Var.f46314g) && Intrinsics.areEqual(this.f46315h, p0Var.f46315h) && Intrinsics.areEqual(this.f46316i, p0Var.f46316i) && Intrinsics.areEqual(this.f46317j, p0Var.f46317j) && Intrinsics.areEqual(this.f46318k, p0Var.f46318k) && Intrinsics.areEqual(this.f46319l, p0Var.f46319l) && Intrinsics.areEqual(this.f46320m, p0Var.f46320m) && Intrinsics.areEqual(this.f46321n, p0Var.f46321n) && Intrinsics.areEqual(this.f46322o, p0Var.f46322o)) {
            return true;
        }
        return false;
    }
    ...
    public int hashCode() {
        ...
        int hashCode12;
        int hashCode13;
        int hashCode14 = this.f46308a.hashCode() * 31;
    ...
    public String toString() {
        ...
        String str2 = this.f46309b;
        String str3 = this.f46310c;
        String str4 = this.f46311d;
        String str5 = this.f46312e;
        String str6 = this.f46313f;
        String str7 = this.f46314g;
        String str8 = this.f46315h;
        String str9 = this.f46316i;
        String str10 = this.f46317j;
        String str11 = this.f46318k;
        Date date = this.f46319l;
        Date date2 = this.f46320m;
        Date date3 = this.f46321n;
        String str12 = this.f46322o;
