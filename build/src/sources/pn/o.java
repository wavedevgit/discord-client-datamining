...
public final class o implements androidx.lifecycle.m, w {
    ...
    /* renamed from: w */
    public static final a f42823w = new a(null);

    /* renamed from: d */
    private final Screen f42824d;

    /* renamed from: e */
    private boolean f42825e;

    /* renamed from: i */
    private com.swmansion.rnscreens.n f42826i;
    ...
    /* renamed from: t */
    private final d f42832t;

    /* renamed from: u */
    private final b f42833u;

    /* renamed from: v */
    private View f42834v;
    ...
    public static final class c {
        ...
        /* renamed from: a */
        private final r0 f42836a;

        /* renamed from: b */
        private final Screen f42837b;

        /* renamed from: c */
        private final CoordinatorLayout f42838c;
        ...
        public c(r0 fragment, Screen screen, CoordinatorLayout coordinatorLayout, g dimmingDelegate) {
            ...
            this.f42837b = screen;
            this.f42838c = coordinatorLayout;
            this.f42839d = dimmingDelegate;
        }
        ...
        public boolean equals(Object obj) {
            ...
            c cVar = (c) obj;
            if (Intrinsics.areEqual(this.f42836a, cVar.f42836a) && Intrinsics.areEqual(this.f42837b, cVar.f42837b) && Intrinsics.areEqual(this.f42838c, cVar.f42838c) && Intrinsics.areEqual(this.f42839d, cVar.f42839d)) {
                return true;
            }
            return false;
        }
        ...
        public String toString() {
            r0 r0Var = this.f42836a;
            Screen screen = this.f42837b;
            CoordinatorLayout coordinatorLayout = this.f42838c;
            g gVar = this.f42839d;
    ...
    public o(Screen screen) {
        Intrinsics.checkNotNullParameter(screen, "screen");
        this.f42824d = screen;
        this.f42826i = com.swmansion.rnscreens.m.f19298a;
        this.f42830r = screen.getSheetInitialDetentIndex();
        this.f42831s = screen.getSheetDetents().k(screen.getSheetInitialDetentIndex());
        d dVar = new d();
        this.f42832t = dVar;
        this.f42833u = new b();
        screen.getFragment();
    ...
    public final InputMethodManager B() {
        Object systemService = this.f42824d.getReactContext().getSystemService("input_method");
    ...
    private final BottomSheetBehavior D() {
        return this.f42824d.getSheetBehavior();
    }

    private final r0 E() {
        Fragment fragment = this.f42824d.getFragment();
    ...
    private final void H() {
        com.swmansion.rnscreens.k.f19290d.g(this);
    }

    private final void I() {
        com.swmansion.rnscreens.k.f19290d.b(this);
    }

    private final void J() {
        com.swmansion.rnscreens.k.f19290d.e(N());
    }

    public final void L(int i10) {
        boolean b10 = p.f42843a.b(i10);
        if (b10) {
            this.f42831s = i10;
            this.f42830r = this.f42824d.getSheetDetents().h(i10);
        }
        this.f42824d.onSheetDetentChanged$react_native_screens_release(this.f42830r, b10);
        if (P(i10)) {
            E().a0();
        }
    }
    ...
    private final void M() {
        View currentFocus;
        View decorView;
        Activity currentActivity = this.f42824d.getReactContext().getCurrentActivity();
        if (currentActivity != null && (currentFocus = currentActivity.getCurrentFocus()) != null) {
            ...
            if (window != null && (decorView = window.getDecorView()) != null && Intrinsics.areEqual(co.a.c(decorView), Boolean.TRUE)) {
                this.f42834v = currentFocus;
            }
            this.f42824d.setDescendantFocusability(262144);
            this.f42824d.requestFocus();
    ...
    private final Integer Q() {
        ...
        ScreenContainer container = this.f42824d.getContainer();
        if (container != null) {
            return Integer.valueOf(container.getHeight());
        }
        ThemedReactContext reactContext = this.f42824d.getReactContext();
    ...
    private final Integer S() {
        Integer Q = Q();
        if (Q != null) {
            return Integer.valueOf(Q.intValue() - this.f42828p);
        }
        return null;
    }

    private final void U(float f10) {
        this.f42824d.setTranslationY(f10 - n(this.f42829q));
    }

    private final void l(AnimatorSet animatorSet, boolean z10, r0 r0Var) {
        e.a aVar;
        qn.i iVar = new qn.i(this.f42824d);
        if (z10) {
            aVar = e.a.f45475d;
        } else {
            aVar = e.a.f45476e;
    ...
    public static /* synthetic */ BottomSheetBehavior q(o oVar, BottomSheetBehavior bottomSheetBehavior, com.swmansion.rnscreens.n nVar, int i10, int i11, Object obj) {
        if ((i11 & 2) != 0) {
            nVar = com.swmansion.rnscreens.m.f19298a;
        }
        if ((i11 & 4) != 0) {
            i10 = oVar.f42830r;
        }
    ...
    private final ValueAnimator v() {
        ...
        }), Float.valueOf(this.f42824d.getHeight()), Float.valueOf(0.0f));
    ...
    private final ValueAnimator z(CoordinatorLayout coordinatorLayout) {
        ValueAnimator ofFloat = ValueAnimator.ofFloat(0.0f, (coordinatorLayout.getBottom() - this.f42824d.getTop()) - this.f42824d.getTranslationY());
    ...
    public final void K(WindowInsetsCompat insets) {
        ...
        this.f42829q = insets.f(WindowInsetsCompat.p.c()).f3307d;
        if (!this.f42827o) {
            U(0.0f);
        }
    }
    ...
    public final Integer R() {
        if (this.f42824d.getSheetShouldOverflowTopInset()) {
            return Q();
        }
        return S();
    }
    ...
    */
    public final void T(com.google.android.material.bottomsheet.BottomSheetBehavior r7) {
        /*
            ...
            if (r0 == 0) goto L70
            com.swmansion.rnscreens.Screen r1 = r6.f42824d
    ...
    public WindowInsetsCompat a(View v10, WindowInsetsCompat insets) {
        ...
        this.f42828p = Math.max(f11.f3305b, f12.f3305b);
        int i10 = 0;
        if (u10) {
            this.f42825e = true;
            this.f42826i = new com.swmansion.rnscreens.o(f10.f3307d);
            BottomSheetBehavior D = D();
            if (D != null) {
                q(this, D, this.f42826i, 0, 4, null);
            }
        } else {
            BottomSheetBehavior D2 = D();
            if (D2 != null) {
                if (this.f42825e) {
                    q(this, D2, com.swmansion.rnscreens.l.f19297a, 0, 4, null);
                } else {
                    com.swmansion.rnscreens.n nVar = this.f42826i;
                    com.swmansion.rnscreens.m mVar = com.swmansion.rnscreens.m.f19298a;
    ...
    public void i(LifecycleOwner source, Lifecycle.a event) {
        ...
        int i10 = e.f42841a[event.ordinal()];
        if (i10 != 1) {
            if (i10 != 2) {
                if (i10 != 3) {
                    if (i10 != 4) {
    ...
    public final int n(int i10) {
        ...
        if (R != null) {
            if (q.b(this.f42824d)) {
                ScreenContentWrapper contentWrapper = this.f42824d.getContentWrapper();
            ...
            return Math.min(R.intValue() - ((int) (kotlin.ranges.d.k(this.f42824d.getSheetDetents().g(), 0.0d, 1.0d) * R.intValue())), i10);
        }
    ...
    public final BottomSheetBehavior o(BottomSheetBehavior behavior, com.swmansion.rnscreens.n keyboardState, int i10) {
        ...
        if (R != null) {
            behavior.U0(true);
            behavior.O0(true);
            behavior.c0(this.f42832t);
            ScreenFooter footer = this.f42824d.getFooter();
            if (footer != null) {
                footer.r(behavior);
            }
            boolean z10 = false;
            if (keyboardState instanceof com.swmansion.rnscreens.m) {
                int d10 = this.f42824d.getSheetDetents().d();
                if (d10 != 1) {
                    if (d10 != 2) {
                        if (d10 == 3) {
                            return pn.a.f(behavior, Integer.valueOf(this.f42824d.getSheetDetents().k(i10)), Integer.valueOf(this.f42824d.getSheetDetents().c(R.intValue())), Integer.valueOf(this.f42824d.getSheetDetents().i(R.intValue())), Float.valueOf(this.f42824d.getSheetDetents().e()), Integer.valueOf(this.f42824d.getSheetDetents().b(R.intValue(), this.f42828p)));
                        }
                        throw new IllegalStateException("[RNScreens] Invalid detent count " + this.f42824d.getSheetDetents().d() + ". Expected at most 3.");
                    }
                    return pn.a.h(behavior, Integer.valueOf(this.f42824d.getSheetDetents().k(i10)), Integer.valueOf(this.f42824d.getSheetDetents().c(R.intValue())), Integer.valueOf(this.f42824d.getSheetDetents().i(R.intValue())));
                }
                if (q.b(this.f42824d)) {
                    i12 = this.f42824d.getSheetDetents().j(this.f42824d);
                } else {
                    i12 = this.f42824d.getSheetDetents().i(R.intValue());
                }
                ...
                int d11 = this.f42824d.getSheetDetents().d();
                if (d11 != 1) {
                    if (d11 != 2) {
                        if (d11 == 3) {
                            if (z10) {
                            ...
                            bottomSheetBehavior2.c0(this.f42833u);
                    ...
                    bottomSheetBehavior.c0(this.f42833u);
                    return bottomSheetBehavior;
                }
                behavior.c0(this.f42833u);
                return behavior;
            } else if (keyboardState instanceof com.swmansion.rnscreens.l) {
                behavior.J0(this.f42833u);
                int d12 = this.f42824d.getSheetDetents().d();
                if (d12 != 1) {
                    if (d12 != 2) {
                        if (d12 == 3) {
                            return pn.a.g(behavior, null, Integer.valueOf(this.f42824d.getSheetDetents().c(R.intValue())), Integer.valueOf(this.f42824d.getSheetDetents().i(R.intValue())), Float.valueOf(this.f42824d.getSheetDetents().e()), Integer.valueOf(this.f42824d.getSheetDetents().b(R.intValue(), this.f42828p)), 1, null);
                        }
                        throw new IllegalStateException("[RNScreens] Invalid detent count " + this.f42824d.getSheetDetents().d() + ". Expected at most 3.");
                    }
                    return pn.a.i(behavior, null, Integer.valueOf(this.f42824d.getSheetDetents().c(R.intValue())), Integer.valueOf(this.f42824d.getSheetDetents().i(R.intValue())), 1, null);
                }
                if (q.b(this.f42824d)) {
                    i11 = this.f42824d.getSheetDetents().j(this.f42824d);
                } else {
                    i11 = this.f42824d.getSheetDetents().i(R.intValue());
                }
