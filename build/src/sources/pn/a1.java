...
public final class a1 {
    ...
    private sn.c f46200b;

    /* renamed from: a  reason: collision with root package name */
    private double f46199a = 0.35d;

    /* renamed from: c  reason: collision with root package name */
    private c f46201c = c.f46213o;

    /* renamed from: d  reason: collision with root package name */
    private Rect f46202d = new Rect();

    /* renamed from: e  reason: collision with root package name */
    private final byte[] f46203e = new byte[PeerConnection.PORTALLOCATOR_ENABLE_ANY_ADDRESS_PORTS];

    /* renamed from: f  reason: collision with root package name */
    private final Lazy f46204f = lr.l.a(new Function0() { // from class: pn.z0
    ...
    public static final class b {
        ...
        /* renamed from: d  reason: collision with root package name */
        public static final b f46205d = new b("Center", 0);

        /* renamed from: e  reason: collision with root package name */
        public static final b f46206e = new b("Left", 1);

        /* renamed from: i  reason: collision with root package name */
        public static final b f46207i = new b("Right", 2);

        /* renamed from: o  reason: collision with root package name */
        private static final /* synthetic */ b[] f46208o;

        /* renamed from: p  reason: collision with root package name */
        private static final /* synthetic */ EnumEntries f46209p;
        ...
        private static final /* synthetic */ b[] a() {
            return new b[]{f46205d, f46206e, f46207i};
        }
    ...
    public static final class c {
        ...
        /* renamed from: d  reason: collision with root package name */
        public static final c f46210d = new c("Center", 0);

        /* renamed from: e  reason: collision with root package name */
        public static final c f46211e = new c("Left", 1);

        /* renamed from: i  reason: collision with root package name */
        public static final c f46212i = new c("Right", 2);

        /* renamed from: o  reason: collision with root package name */
        public static final c f46213o = new c("All", 3);

        /* renamed from: p  reason: collision with root package name */
        public static final c f46214p = new c("None", 4);

        /* renamed from: q  reason: collision with root package name */
        private static final /* synthetic */ c[] f46215q;

        /* renamed from: r  reason: collision with root package name */
        private static final /* synthetic */ EnumEntries f46216r;
        ...
        private static final /* synthetic */ c[] a() {
            return new c[]{f46210d, f46211e, f46212i, f46213o, f46214p};
        }
    ...
    public /* synthetic */ class d {
        ...
        static {
            ...
            try {
                iArr[b.f46205d.ordinal()] = 1;
            } catch (NoSuchFieldError unused) {
            }
            try {
                iArr[b.f46206e.ordinal()] = 2;
            } catch (NoSuchFieldError unused2) {
            }
            try {
                iArr[b.f46207i.ordinal()] = 3;
    ...
    private final tn.a k(j0 j0Var, Rect rect) {
        Image.Plane plane;
        ...
        for (int i13 = 0; i13 < 3; i13++) {
            for (int i14 = 0; i14 < 3; i14++) {
                ...
                fArr[b10] = Float.valueOf(n(buffer, width, height, this.f46202d));
                Rect rect3 = this.f46202d;
                rect3.left += width2;
                rect3.right += width2;
            }
            Rect rect4 = this.f46202d;
        ...
        buffer.rewind();
        return new tn.a(fArr);
    }

    private final xj.d l() {
        return (xj.d) this.f46204f.getValue();
    }

    private final y0 m(b bVar, Bitmap bitmap) {
        int i10 = d.f46217a[bVar.ordinal()];
        if (i10 != 1) {
            if (i10 != 2) {
                if (i10 == 3) {
    ...
    private final float n(ByteBuffer byteBuffer, int i10, int i11, Rect rect) {
        ...
        if ((f10 > 0 && d10 <= e10) || (f10 < 0 && e10 <= d10)) {
            while (true) {
                ...
                byteBuffer.get(this.f46203e, 0, width);
                for (int i12 = 0; i12 < width; i12++) {
                    j10 += this.f46203e[i12] & 255;
                }
                if (d10 == e10) {
                    break;
                }
    ...
    private final boolean r(Rect rect, Rect rect2) {
        int width = rect2.width();
        int height = rect2.height();
        if (Math.max(rect.width(), rect.height()) < Math.min(width, height) * this.f46199a) {
            return true;
        }
        return false;
    }

    public final tn.c d(Image image, int i10) {
        Intrinsics.checkNotNullParameter(image, "image");
        return f(m0.d(image, i10));
    }

    public final tn.c e(androidx.camera.core.n image) {
        Intrinsics.checkNotNullParameter(image, "image");
        j0 e10 = m0.e(image);
        if (e10 == null) {
    ...
    public final tn.c f(j0 imageToAnalyze) {
        Rect rect;
        tn.b bVar;
        y0 c10;
        y0 y0Var;
        ...
        sn.c cVar = this.f46200b;
        if (cVar != null) {
            rect = sn.d.a(cVar, imageToAnalyze);
        } else {
            rect = null;
        }
        vj.a f10 = imageToAnalyze.f();
        Rect j10 = j(f10);
        tn.a k10 = k(imageToAnalyze, rect);
        Task g10 = l().g(f10);
    ...
    public final void u(Rect rect, Rect previewRect) {
        ...
        this.f46200b = new sn.c(rect, previewRect);
    }
}
