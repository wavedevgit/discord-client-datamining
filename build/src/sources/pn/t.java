...
public final class t {
    ...
    public static final class a {
        ...
        public static final a f46341d = new a("FRONT", 0);

        /* renamed from: e  reason: collision with root package name */
        public static final a f46342e = new a("BACK", 1);

        /* renamed from: i  reason: collision with root package name */
        public static final a f46343i = new a("EXTERNAL", 2);

        /* renamed from: o  reason: collision with root package name */
        private static final /* synthetic */ a[] f46344o;

        /* renamed from: p  reason: collision with root package name */
        private static final /* synthetic */ EnumEntries f46345p;
        ...
        private static final /* synthetic */ a[] a() {
            return new a[]{f46341d, f46342e, f46343i};
        }
    ...
    public static final class b implements DefaultLifecycleObserver {
        ...
        /* renamed from: d  reason: collision with root package name */
        final /* synthetic */ ExecutorService f46346d;
    ...
    public static final class c extends kotlin.coroutines.jvm.internal.d {
        ...
        public final Object invokeSuspend(Object obj) {
            this.f46349i = obj;
            this.f46351p |= Integer.MIN_VALUE;
    ...
    public static final class d implements n0.f {
        ...
        /* renamed from: a  reason: collision with root package name */
        final /* synthetic */ Continuation f46352a;

        /* renamed from: b  reason: collision with root package name */
        final /* synthetic */ File f46353b;

        d(Continuation continuation, File file) {
            this.f46352a = continuation;
            this.f46353b = file;
        }
        ...
        public void d(n0.h outputFileResults) {
            ...
            Continuation continuation = this.f46352a;
            Result.a aVar = Result.f32461e;
            continuation.resumeWith(Result.b(Result.a(Result.b(this.f46353b))));
        }
    ...
    public static final void h(ListenableFuture listenableFuture, int i10, boolean z10, f.a aVar, ExecutorService executorService, PreviewView previewView, x.p pVar, t tVar, Function1 function1) {
        ...
        try {
            ...
            tVar.f46340a = new w(n10, n0Var, tVar.i(n10));
            Context context2 = previewView.getContext();
            Intrinsics.checkNotNullExpressionValue(context2, "getContext(...)");
            mp.f.i(context2).getLifecycle().a(new b(executorService));
    ...
    */
    private final pn.v i(x.i r12) {
        ...
        L42:
            ...
            r4 = 1
            if (r3 != r4) goto L4c
            pn.v$b r1 = pn.v.b.f46371e     // Catch: java.lang.IllegalArgumentException -> L90
            goto L5a
        L4c:
            if (r1 != 0) goto L4f
            goto L58
        L4f:
            ...
            if (r1 != 0) goto L58
            pn.v$b r1 = pn.v.b.f46370d     // Catch: java.lang.IllegalArgumentException -> L90
            goto L5a
        L58:
            pn.v$b r1 = pn.v.b.f46372i     // Catch: java.lang.IllegalArgumentException -> L90
        L5a:
        ...
        L6d:
            ...
            goto L6d
        L8a:
            pn.v r12 = new pn.v     // Catch: java.lang.IllegalArgumentException -> L90
        ...
        L90:
            ...
            return r4
        */
        throw new UnsupportedOperationException("Method not decompiled: pn.t.i(x.i):pn.v");
    }
    ...
    public final void f(final PreviewView previewView, a cameraDirection, final f.a aVar, final boolean z10, final Function1 onCameraError) {
        ...
        previewView.post(new Runnable() { // from class: pn.r
            @Override // java.lang.Runnable
            public final void run() {
    ...
    /*
        ...
        To view partially-correct add '--show-bad-code' argument
    */
    public final java.lang.Object j(rp.c r7, kotlin.coroutines.Continuation r8) {
        /*
            r6 = this;
            boolean r0 = r8 instanceof pn.t.c
            if (r0 == 0) goto L13
            r0 = r8
            pn.t$c r0 = (pn.t.c) r0
            int r1 = r0.f46351p
            ...
            goto L18
        L13:
            pn.t$c r0 = new pn.t$c
            r0.<init>(r8)
        L18:
            java.lang.Object r8 = r0.f46349i
            java.lang.Object r1 = rr.b.f()
            int r2 = r0.f46351p
            r3 = 1
            if (r2 == 0) goto L39
            if (r2 != r3) goto L31
            java.lang.Object r7 = r0.f46348e
            rp.c r7 = (rp.c) r7
            java.lang.Object r7 = r0.f46347d
            pn.t r7 = (pn.t) r7
            kotlin.c.b(r8)
            goto L8d
        L31:
        ...
        L39:
            ...
            js.c1 r4 = js.m0.c()
            js.c1 r4 = r4.f2()
            java.util.concurrent.Executor r4 = js.u0.a(r4)
            pn.t$d r5 = new pn.t$d
            r5.<init>(r8, r7)
            r3.x0(r2, r4, r5)
        L7d:
            java.lang.Object r8 = r8.b()
            java.lang.Object r7 = rr.b.f()
            if (r8 != r7) goto L8a
        ...
        L8d:
            ...
            return r7
        */
        throw new UnsupportedOperationException("Method not decompiled: pn.t.j(rp.c, kotlin.coroutines.Continuation):java.lang.Object");
    }
}
