...
public interface a extends IInterface {
    ...
    /* loaded from: /home/runner/work/discord-client-datamining/discord-client-datamining/build/classes3.dex */
    public static abstract class AbstractBinderC0133a extends fg.c implements a {
        ...
        protected boolean e(int i10, Parcel parcel, Parcel parcel2, int i11) {
            if (i10 == 1) {
                f(parcel);
                t0((Status) fg.d.a(parcel, Status.CREATOR), (bf.c) fg.d.a(parcel, bf.c.CREATOR));
                return true;
            }
            return false;
        }
    ...
    void t0(Status status, bf.c cVar);
}
