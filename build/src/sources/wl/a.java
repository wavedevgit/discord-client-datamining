...
public final class a {
    ...
    public static final b f53153c = new b(null);

    /* renamed from: d  reason: collision with root package name */
    private static final String f53154d;

    /* renamed from: e  reason: collision with root package name */
    private static final ZoomLogger f53155e;

    /* renamed from: a  reason: collision with root package name */
    private final InterfaceC0701a f53156a;
    ...
    public a(InterfaceC0701a callback) {
        Intrinsics.checkNotNullParameter(callback, "callback");
        this.f53156a = callback;
    }
    ...
    private final boolean o(int i10) {
        ...
        if (!this.f53156a.h(i10)) {
            return false;
        }
        if (i10 == this.f53157b && !g(i10)) {
            return true;
        }
