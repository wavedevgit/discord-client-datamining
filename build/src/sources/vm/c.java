...
public final class c extends ReactViewGroup {
    ...
    private final ThemedReactContext f52738d;

    /* renamed from: e  reason: collision with root package name */
    private final int f52739e;

    /* renamed from: i  reason: collision with root package name */
    private boolean f52740i;

    /* renamed from: o  reason: collision with root package name */
    private boolean f52741o;

    /* renamed from: p  reason: collision with root package name */
    private boolean f52742p;
    ...
    private ReactViewGroup f52745s;

    /* renamed from: t  reason: collision with root package name */
    private int f52746t;

    /* renamed from: u  reason: collision with root package name */
    private boolean f52747u;

    /* renamed from: v  reason: collision with root package name */
    private k f52748v;

    /* renamed from: w  reason: collision with root package name */
    private final l f52749w;

    /* renamed from: x  reason: collision with root package name */
    private final rm.b f52750x;
    ...
    public c(ThemedReactContext reactContext) {
        ...
        this.f52738d = reactContext;
        int identityHashCode = System.identityHashCode(this);
        this.f52739e = identityHashCode;
        l lVar = new l(WindowInsetsCompat.p.h(), WindowInsetsCompat.p.c(), 1, this.f52741o);
        this.f52749w = lVar;
        this.f52750x = new rm.b(this, reactContext, lVar, new a(this));
    ...
    private final void g() {
        boolean z10;
        ReactViewGroup reactViewGroup = this.f52745s;
        k kVar = this.f52748v;
        if (reactViewGroup != null && kVar != null) {
            ...
            boolean z11 = true;
            if (identityHashCode != this.f52746t) {
                z10 = true;
            } else {
                z10 = false;
            }
            ...
            pm.a aVar = pm.a.f45061a;
            String a10 = d.a();
            int i10 = this.f52739e;
            int i11 = this.f52746t;
            if (windowToken == null) {
                z11 = false;
            }
    ...
    private final void m() {
        ...
        final ReactViewGroup reactViewGroup = this.f52745s;
    ...
    private final void p() {
        String str;
        Activity currentActivity = this.f52738d.getCurrentActivity();
        pm.a aVar = pm.a.f45061a;
        String a10 = d.a();
        int i10 = this.f52739e;
        if (currentActivity != null) {
        ...
        this.f52745s = new ReactViewGroup(getContext());
        ViewGroup a11 = lm.f.a(this.f52738d);
        if (a11 == null) {
            pm.a.f(aVar, d.a(), "setupKeyboardCallbacks: content is null", null, 4, null);
            return;
        }
        a11.addView(this.f52745s);
        this.f52746t = System.identityHashCode(a11);
        String a12 = d.a();
        int i11 = this.f52746t;
        pm.a.c(aVar, a12, "setupKeyboardCallbacks: eventView added to root (rootId=" + i11 + ")", null, 4, null);
        k kVar = new k(this, this, this.f52738d, this.f52749w);
        this.f52748v = kVar;
        ReactViewGroup reactViewGroup = this.f52745s;
        if (reactViewGroup != null) {
            h0.L0(reactViewGroup, kVar);
            h0.D0(reactViewGroup, this.f52748v);
            i.d(reactViewGroup);
        }
    ...
    public static final WindowInsetsCompat r(c cVar, View v10, WindowInsetsCompat insets) {
        ...
        cVar.g();
        ViewGroup a10 = lm.f.a(cVar.f52738d);
        FrameLayout.LayoutParams layoutParams = new FrameLayout.LayoutParams(-1, -1);
        boolean z11 = cVar.f52744r;
        boolean z12 = true;
        int i11 = 0;
        if (z11 && !cVar.f52740i) {
            z10 = false;
        ...
        return i.c(v10, insets, cVar.f52740i, cVar.f52744r);
    }
    ...
    public final void k(boolean z10) {
        if (this.f52744r && this.f52740i != z10) {
            this.f52740i = z10;
            l();
        }
    }
    ...
    public final void o() {
        ...
        if (this.f52743q != z10) {
            ...
            Activity currentActivity = this.f52738d.getCurrentActivity();
            if (currentActivity != null) {
                w0.c(currentActivity.getWindow(), true ^ this.f52743q);
            }
            Activity currentActivity2 = this.f52738d.getCurrentActivity();
