...
public final class f {
    ...
    private final ReactApplicationContext f51643a;

    /* renamed from: b  reason: collision with root package name */
    private final pm.f f51644b;
    ...
    public f(ReactApplicationContext mReactContext) {
        ...
        this.f51643a = mReactContext;
        this.f51644b = new pm.f();
        this.f51645c = k();
    }
    ...
    public static final void g(boolean z10, f fVar, final View view, Activity activity, final boolean z11) {
        ...
        if (Build.VERSION.SDK_INT >= 30 && !z10) {
            fVar.f51644b.x(view, new Function1() { // from class: vm.d
    ...
    private final int k() {
        ...
        Activity currentActivity = this.f51643a.getCurrentActivity();
    ...
    public static final void r(f fVar, int i10) {
        ...
        Window window;
        if (fVar.k() != i10 && (currentActivity = fVar.f51643a.getCurrentActivity()) != null && (window = currentActivity.getWindow()) != null) {
            window.setSoftInputMode(i10);
        }
    }

    public final void f(final boolean z10, final boolean z11) {
        final Activity currentActivity = this.f51643a.getCurrentActivity();
        final EditText b10 = xm.a.f54932a.b();
        if (b10 != null) {
