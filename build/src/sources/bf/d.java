...
public final class d extends ef.d implements f {
    ...
    public static final b f6607k = new b(null);

    /* renamed from: l  reason: collision with root package name */
    private static final a.g f6608l;

    /* renamed from: m  reason: collision with root package name */
    private static final a f6609m;

    /* renamed from: n  reason: collision with root package name */
    private static final ef.a f6610n;
    ...
    public static final class a extends a.AbstractC0279a {
        ...
        /* renamed from: c */
        public e b(Context context, Looper looper, gf.d commonSettings, a.d.C0280a apiOptions, ff.d connectedListener, k connectionFailedListener) {
    ...
    /* loaded from: /home/runner/work/discord-client-datamining/discord-client-datamining/build/classes3.dex */
    public static final class c extends a.AbstractBinderC0103a {

        /* renamed from: c  reason: collision with root package name */
        final /* synthetic */ wg.k f6611c;
        ...
        public void W(Status status, af.c response) {
            ...
            r.a(status, response, this.f6611c);
        }
    }
    ...
    static {
        ...
        a aVar = new a();
        f6609m = aVar;
        f6610n = new ef.a("RestoreCredential.API", aVar, gVar);
    }

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public d(Context context) {
        super(context, f6610n, a.d.f21485c, d.a.f21497c);
        Intrinsics.checkNotNullParameter(context, "context");
    }
    ...
    public Task l(final af.a request) {
        Intrinsics.checkNotNullParameter(request, "request");
        Task p10 = p(q.a().d(eg.b.f21518k).b(new m() { // from class: bf.c
            @Override // ff.m
