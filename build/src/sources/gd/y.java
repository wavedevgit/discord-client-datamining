...
public abstract class y {
    ...
    private static final Pattern f25547a = Pattern.compile("^\\D?(\\d+)$");

    /* renamed from: b  reason: collision with root package name */
    private static final HashMap f25548b = new HashMap();

    /* renamed from: c  reason: collision with root package name */
    private static int f25549c = -1;
    ...
    public static final class b {
        ...
        public boolean equals(Object obj) {
            ...
            if (obj != null && obj.getClass() == b.class) {
                b bVar = (b) obj;
                if (TextUtils.equals(this.f25550a, bVar.f25550a) && this.f25551b == bVar.f25551b && this.f25552c == bVar.f25552c) {
                    return true;
                }
            }
            return false;
        ...
        public int hashCode() {
            int i10;
            int hashCode = (this.f25550a.hashCode() + 31) * 31;
            int i11 = 1237;
            if (this.f25551b) {
                i10 = 1231;
            } else {
    ...
    public static final class f implements d {
        ...
        /* renamed from: b  reason: collision with root package name */
        private MediaCodecInfo[] f25554b;
        ...
        private void f() {
            if (this.f25554b == null) {
                this.f25554b = new MediaCodecList(this.f25553a).getCodecInfos();
            }
        }
    ...
    private static Pair A(String str, String[] strArr) {
        if (strArr.length < 3) {
            oe.y.i("MediaCodecUtil", "Ignoring malformed VP9 codec string: " + str);
            return null;
        }
        try {
            ...
            int P = P(parseInt);
            if (P == -1) {
                oe.y.i("MediaCodecUtil", "Unknown VP9 profile: " + parseInt);
                return null;
            }
            int O = O(parseInt2);
            if (O == -1) {
                oe.y.i("MediaCodecUtil", "Unknown VP9 level: " + parseInt2);
                return null;
            }
    ...
    private static boolean C(MediaCodecInfo mediaCodecInfo) {
        if (w0.f39037a >= 29 && D(mediaCodecInfo)) {
            return true;
        }
        return false;
    }
    ...
    private static boolean E(MediaCodecInfo mediaCodecInfo, String str, boolean z10, String str2) {
        ...
        if (i10 < 18 && "OMX.MTK.AUDIO.DECODER.AAC".equals(str)) {
            ...
            if ("a70".equals(str3) || ("Xiaomi".equals(w0.f39039c) && str3.startsWith("HM"))) {
                return false;
            }
        }
        if (i10 == 16 && "OMX.qcom.audio.decoder.mp3".equals(str)) {
            String str4 = w0.f39038b;
            if ("dlxu".equals(str4) || "protou".equals(str4) || "ville".equals(str4) || "villeplus".equals(str4) || "villec2".equals(str4) || str4.startsWith("gee") || "C6602".equals(str4) || "C6603".equals(str4) || "C6606".equals(str4) || "C6616".equals(str4) || "L36h".equals(str4) || "SO-02E".equals(str4)) {
                return false;
            }
        }
        if (i10 == 16 && "OMX.qcom.audio.decoder.aac".equals(str)) {
            String str5 = w0.f39038b;
            if ("C1504".equals(str5) || "C1505".equals(str5) || "C1604".equals(str5) || "C1605".equals(str5)) {
                return false;
            }
        }
        if (i10 < 24 && (("OMX.SEC.aac.dec".equals(str) || "OMX.Exynos.AAC.Decoder".equals(str)) && "samsung".equals(w0.f39039c))) {
            String str6 = w0.f39038b;
            if (str6.startsWith("zeroflte") || str6.startsWith("zerolte") || str6.startsWith("zenlte") || "SC-05G".equals(str6) || "marinelteatt".equals(str6) || "404SC".equals(str6) || "SC-04G".equals(str6) || "SCV31".equals(str6)) {
                return false;
            }
        }
        if (i10 <= 19 && "OMX.SEC.vp8.dec".equals(str) && "samsung".equals(w0.f39039c)) {
            String str7 = w0.f39038b;
            if (str7.startsWith("d2") || str7.startsWith("serrano") || str7.startsWith("jflte") || str7.startsWith("santos") || str7.startsWith("t0")) {
                return false;
            }
        }
        if (i10 <= 19 && w0.f39038b.startsWith("jflte") && "OMX.qcom.video.decoder.vp8".equals(str)) {
            return false;
        }
    ...
    private static boolean H(MediaCodecInfo mediaCodecInfo, String str) {
        ...
        String e10 = pi.b.e(mediaCodecInfo.getName());
    ...
    private static void N(List list, final g gVar) {
        Collections.sort(list, new Comparator() { // from class: gd.x
    ...
    public static /* synthetic */ int b(q qVar) {
        ...
        if (!str.startsWith("OMX.google") && !str.startsWith("c2.android")) {
            if (w0.f39037a < 26 && str.equals("OMX.MTK.AUDIO.DECODER.RAW")) {
                return -1;
            }
            return 0;
        }
    ...
    public static /* synthetic */ int c(q qVar) {
        return qVar.f25497a.startsWith("OMX.google") ? 1 : 0;
    }
    ...
    private static void e(String str, List list) {
        if ("audio/raw".equals(str)) {
            if (w0.f39037a < 26 && w0.f39038b.equals("R9") && list.size() == 1 && ((q) list.get(0)).f25497a.equals("OMX.MTK.AUDIO.DECODER.RAW")) {
                list.add(q.F("OMX.google.raw.decoder", "audio/raw", "audio/raw", null, false, true, false, false, false));
            }
            N(list, new g() { // from class: gd.u
                @Override // gd.y.g
        ...
        if (i10 < 21 && list.size() > 1) {
            String str2 = ((q) list.get(0)).f25497a;
            if ("OMX.SEC.mp3.dec".equals(str2) || "OMX.SEC.MP3.Decoder".equals(str2) || "OMX.brcm.audio.mp3.decoder".equals(str2)) {
                N(list, new g() { // from class: gd.v
                    @Override // gd.y.g
                    public final int a(Object obj) {
                        return y.c((q) obj);
                    }
        ...
        if (i10 < 32 && list.size() > 1 && "OMX.qti.audio.decoder.flac".equals(((q) list.get(0)).f25497a)) {
    ...
    private static Pair l(String str, String[] strArr) {
        int M;
        if (strArr.length != 3) {
            oe.y.i("MediaCodecUtil", "Ignoring malformed MP4A codec string: " + str);
            return null;
        }
        try {
    ...
    public static String m(Format format) {
        Pair r10;
        if ("audio/eac3-joc".equals(format.f12304w)) {
            return "audio/eac3";
        }
        if ("video/dolby-vision".equals(format.f12304w) && (r10 = r(format)) != null) {
    ...
    private static Pair o(String str, String[] strArr, pe.c cVar) {
        int i10;
        if (strArr.length < 4) {
            oe.y.i("MediaCodecUtil", "Ignoring malformed AV1 codec string: " + str);
            return null;
        }
        int i11 = 1;
        try {
            ...
            if (parseInt != 0) {
                oe.y.i("MediaCodecUtil", "Unknown AV1 profile: " + parseInt);
                return null;
            } else if (parseInt3 != 8 && parseInt3 != 10) {
                oe.y.i("MediaCodecUtil", "Unknown AV1 bit depth: " + parseInt3);
                return null;
            } else {
                if (parseInt3 != 8) {
                    if (cVar != null && (cVar.f41567o != null || (i10 = cVar.f41566i) == 7 || i10 == 6)) {
                ...
                int f10 = f(parseInt2);
                if (f10 == -1) {
                    oe.y.i("MediaCodecUtil", "Unknown AV1 level: " + parseInt2);
                    return null;
                }
    ...
    private static Pair p(String str, String[] strArr) {
        ...
        int i10;
        if (strArr.length < 2) {
            oe.y.i("MediaCodecUtil", "Ignoring malformed AVC codec string: " + str);
            return null;
        }
        try {
            ...
            int i11 = i(i10);
            if (i11 == -1) {
                oe.y.i("MediaCodecUtil", "Unknown AVC profile: " + i10);
                return null;
            }
            int g10 = g(parseInt);
            if (g10 == -1) {
                oe.y.i("MediaCodecUtil", "Unknown AVC level: " + parseInt);
                return null;
            }
    ...
    */
    public static android.util.Pair r(com.google.android.exoplayer2.Format r6) {
        /*
            java.lang.String r0 = r6.f12301t
            r1 = 0
            if (r0 != 0) goto L6
            return r1
        L6:
            ...
            java.lang.String r3 = r6.f12304w
            boolean r2 = r2.equals(r3)
            if (r2 == 0) goto L1d
            java.lang.String r6 = r6.f12301t
        ...
        L83:
            ...
            return r6
        L8a:
            java.lang.String r1 = r6.f12301t
            pe.c r6 = r6.I
        ...
        L9a:
            ...
            return r6
        */
        throw new UnsupportedOperationException("Method not decompiled: gd.y.r(com.google.android.exoplayer2.Format):android.util.Pair");
    }
        ...
        synchronized (y.class) {
            try {
                ...
                if (z10 && u10.isEmpty() && 21 <= i10 && i10 <= 23) {
                    u10 = u(bVar, new e());
                    if (!u10.isEmpty()) {
                        oe.y.i("MediaCodecUtil", "MediaCodecList API didn't list secure decoder for: " + str + ". Assuming: " + ((q) u10.get(0)).f25497a);
                    }
                }
                e(str, u10);
                qi.s o10 = qi.s.o(u10);
    ...
    /* JADX WARN: Code restructure failed: missing block: B:33:0x0088, code lost:
        if (r1.f25551b != r12) goto L61;
     */
    /* JADX WARN: Code restructure failed: missing block: B:41:0x009b, code lost:
        if (r1.f25551b == false) goto L40;
     */
    ...
    /* JADX WARN: Code restructure failed: missing block: B:44:0x00a8, code lost:
        r5.add(gd.q.F(r9, r7, r8, r9, r10, r11, r18, false, false));
     */
    ...
    /*
        ...
        To view partially-correct add '--show-bad-code' argument
    */
    private static java.util.ArrayList u(gd.y.b r19, gd.y.d r20) {
        /*
            Method dump skipped, instructions count: 332
            To view this dump add '--comments-level debug' option
        */
        throw new UnsupportedOperationException("Method not decompiled: gd.y.u(gd.y$b, gd.y$d):java.util.ArrayList");
    }

    public static List v(t tVar, Format format, boolean z10, boolean z11) {
        List a10 = tVar.a(format.f12304w, z10, z11);
        return qi.s.k().j(a10).j(n(tVar, format, z10, z11)).k();
    }

    public static List w(List list, final Format format) {
        ArrayList arrayList = new ArrayList(list);
        N(arrayList, new g() { // from class: gd.w
            @Override // gd.y.g
            public final int a(Object obj) {
    ...
    private static Pair y(String str, String[] strArr) {
        if (strArr.length < 3) {
            oe.y.i("MediaCodecUtil", "Ignoring malformed Dolby Vision codec string: " + str);
            return null;
        }
        Matcher matcher = f25547a.matcher(strArr[1]);
        if (!matcher.matches()) {
            oe.y.i("MediaCodecUtil", "Ignoring malformed Dolby Vision codec string: " + str);
            return null;
        }
        ...
        Integer k10 = k(group);
        if (k10 == null) {
            oe.y.i("MediaCodecUtil", "Unknown Dolby Vision profile string: " + group);
            return null;
        }
        String str2 = strArr[2];
        Integer j10 = j(str2);
        if (j10 == null) {
            oe.y.i("MediaCodecUtil", "Unknown Dolby Vision level string: " + str2);
            return null;
        }
        return new Pair(k10, j10);
    }

    private static Pair z(String str, String[] strArr, pe.c cVar) {
        if (strArr.length < 4) {
            oe.y.i("MediaCodecUtil", "Ignoring malformed HEVC codec string: " + str);
            return null;
        }
        int i10 = 1;
        Matcher matcher = f25547a.matcher(strArr[1]);
        ...
        if (!"1".equals(group)) {
            if ("2".equals(group)) {
                if (cVar != null && cVar.f41566i == 6) {
                    i10 = RecyclerView.ItemAnimator.FLAG_APPEARED_IN_PRE_LAYOUT;
                } else {
                    i10 = 2;
                }
            } else {
                oe.y.i("MediaCodecUtil", "Unknown HEVC profile string: " + group);
                return null;
            }
        }
        ...
        Integer B = B(str2);
        if (B == null) {
            oe.y.i("MediaCodecUtil", "Unknown HEVC level string: " + str2);
            return null;
        }
