...
public final class j implements h {
    ...
    public static final a f50624o = new a(null);

    /* renamed from: a  reason: collision with root package name */
    private final Context f50625a;

    /* renamed from: b  reason: collision with root package name */
    private final g5.c f50626b;

    /* renamed from: c  reason: collision with root package name */
    private final Lazy f50627c;

    /* renamed from: d  reason: collision with root package name */
    private final Lazy f50628d;

    /* renamed from: e  reason: collision with root package name */
    private final Lazy f50629e;

    /* renamed from: f  reason: collision with root package name */
    private final c.InterfaceC0668c f50630f;

    /* renamed from: g  reason: collision with root package name */
    private final v4.b f50631g;

    /* renamed from: h  reason: collision with root package name */
    private final q f50632h;

    /* renamed from: i  reason: collision with root package name */
    private final CoroutineScope f50633i = kotlinx.coroutines.i.a(j1.b(null, 1, null).U0(m0.c().f2()).U0(new e(z.f27197f, this)));

    /* renamed from: j  reason: collision with root package name */
    private final v f50634j;

    /* renamed from: k  reason: collision with root package name */
    private final p f50635k;

    /* renamed from: l  reason: collision with root package name */
    private final v4.b f50636l;

    /* renamed from: m  reason: collision with root package name */
    private final List f50637m;

    /* renamed from: n  reason: collision with root package name */
    private final AtomicBoolean f50638n;
    ...
    static final class b extends k implements Function2 {
        ...
        public final Continuation create(Object obj, Continuation continuation) {
            return new b(this.f50641i, continuation);
        }
    ...
    public static final class c extends kotlin.coroutines.jvm.internal.d {
        ...
        public final Object invokeSuspend(Object obj) {
            this.f50647q = obj;
            this.f50649s |= Integer.MIN_VALUE;
    ...
    public static final class d extends k implements Function2 {
        ...
        /* renamed from: e  reason: collision with root package name */
        final /* synthetic */ g5.h f50651e;

        /* renamed from: i  reason: collision with root package name */
        final /* synthetic */ j f50652i;

        /* renamed from: o  reason: collision with root package name */
        final /* synthetic */ h5.i f50653o;

        /* renamed from: p  reason: collision with root package name */
        final /* synthetic */ v4.c f50654p;

        /* renamed from: q  reason: collision with root package name */
        final /* synthetic */ Bitmap f50655q;
        ...
        @Override // kotlin.coroutines.jvm.internal.a
        public final Continuation create(Object obj, Continuation continuation) {
            return new d(this.f50651e, this.f50652i, this.f50653o, this.f50654p, this.f50655q, continuation);
        }
        ...
        public final Object invokeSuspend(Object obj) {
            ...
            kotlin.c.b(obj);
            g5.h hVar = this.f50651e;
            List list = this.f50652i.f50637m;
            g5.h hVar2 = this.f50651e;
            h5.i iVar = this.f50653o;
            v4.c cVar = this.f50654p;
            if (this.f50655q != null) {
                z10 = true;
            } else {
                z10 = false;
            }
            b5.c cVar2 = new b5.c(hVar, list, 0, hVar2, iVar, cVar, z10);
            g5.h hVar3 = this.f50651e;
            this.f50650d = 1;
    ...
    public j(Context context, g5.c cVar, Lazy lazy, Lazy lazy2, Lazy lazy3, c.InterfaceC0668c interfaceC0668c, v4.b bVar, q qVar, t tVar) {
        ...
        this.f50635k = pVar;
        this.f50636l = bVar.h().c(new d5.c(), HttpUrl.class).c(new d5.g(), String.class).c(new d5.b(), Uri.class).c(new d5.f(), Uri.class).c(new d5.e(), Integer.class).c(new d5.a(), byte[].class).b(new c5.c(), Uri.class).b(new c5.a(qVar.a()), File.class).a(new j.b(lazy3, lazy2, qVar.e()), Uri.class).a(new i.a(), File.class).a(new a.C0003a(), Uri.class).a(new d.a(), Uri.class).a(new k.b(), Uri.class).a(new e.a(), Drawable.class).a(new b.a(), Bitmap.class).a(new c.a(), ByteBuffer.class).d(new f.c(qVar.c(), qVar.b())).e();
        this.f50637m = CollectionsKt.M0(getComponents().c(), new b5.a(this, vVar, pVar, null));
        this.f50638n = new AtomicBoolean(false);
    }
    ...
    */
    ...
    public g5.e a(g5.h hVar) {
        g0 b10;
        b10 = gs.i.b(this.f50633i, null, null, new b(hVar, null), 3, null);
    ...
    @Override // v4.h
    public e5.c b() {
        return (e5.c) this.f50627c.getValue();
    }
    ...
    public void shutdown() {
        if (!this.f50638n.getAndSet(true)) {
            kotlinx.coroutines.i.f(this.f50633i, null, 1, null);
            this.f50634j.e();
            e5.c b10 = b();
            if (b10 != null) {
                b10.clear();
