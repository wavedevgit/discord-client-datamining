...
public final class i0 extends ByteString {
    ...
    private final transient byte[][] f6279q;

    /* renamed from: r  reason: collision with root package name */
    private final transient int[] f6280r;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public i0(byte[][] segments, int[] directory) {
        super(ByteString.f41161p.l());
        Intrinsics.checkNotNullParameter(segments, "segments");
        Intrinsics.checkNotNullParameter(directory, "directory");
        this.f6279q = segments;
        this.f6280r = directory;
    }
