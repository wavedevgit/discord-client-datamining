...
public final class l0 extends h {
    ...
    private static final a f6284i = new a(null);

    /* renamed from: j  reason: collision with root package name */
    private static final c0 f6285j = c0.a.e(c0.f6226e, "/", false, 1, null);

    /* renamed from: e  reason: collision with root package name */
    private final c0 f6286e;

    /* renamed from: f  reason: collision with root package name */
    private final h f6287f;

    /* renamed from: g  reason: collision with root package name */
    private final Map f6288g;
    ...
    public l0(c0 zipPath, h fileSystem, Map entries, String str) {
        ...
        this.f6286e = zipPath;
        this.f6287f = fileSystem;
        this.f6288g = entries;
        this.f6289h = str;
    }

    private final c0 r(c0 c0Var) {
        return f6285j.l(c0Var, true);
    }

    private final List s(c0 c0Var, boolean z10) {
        bv.i iVar = (bv.i) this.f6288g.get(r(c0Var));
        if (iVar == null) {
            if (!z10) {
                return null;
            }
    ...
    public g m(c0 path) {
        Throwable th2;
        Intrinsics.checkNotNullParameter(path, "path");
        bv.i iVar = (bv.i) this.f6288g.get(r(path));
        Long l10 = null;
        if (iVar == null) {
            return null;
        }
        if (iVar.i() != -1) {
            f n10 = this.f6287f.n(this.f6286e);
            try {
                BufferedSource d10 = x.d(n10.C(iVar.i()));
                iVar = bv.j.j(d10, iVar);
                if (d10 != null) {
                    try {
                        d10.close();
                    } catch (Throwable th3) {
    ...
    public Source q(c0 file) {
        Intrinsics.checkNotNullParameter(file, "file");
        bv.i iVar = (bv.i) this.f6288g.get(r(file));
        if (iVar != null) {
            f n10 = this.f6287f.n(this.f6286e);
            ...
            if (th == 0) {
                bv.j.m(th2);
                if (iVar.e() == 0) {
                    return new bv.g(th2, iVar.j(), true);
                }
                return new bv.g(new o(new bv.g(th2, iVar.d(), true), new Inflater(true)), iVar.j(), false);
            }
            throw th;
        }
