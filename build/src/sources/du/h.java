...
public class h {
    ...
    private static volatile h f22445b;

    /* renamed from: c  reason: collision with root package name */
    private static final Logger f22446c;
    ...
    public static final class a {
        ...
        private final h e() {
            ...
            c a11;
            d b10;
            if (j() && (b10 = d.f22426e.b()) != null) {
                return b10;
            }
            if (i() && (a11 = c.f22423e.a()) != null) {
                return a11;
            }
            if (k() && (a10 = g.f22441e.a()) != null) {
                return a10;
            }
            f a12 = f.f22439d.a();
            if (a12 != null) {
    ...
    static {
        ...
        f22444a = aVar;
        f22445b = aVar.f();
        f22446c = Logger.getLogger(OkHttpClient.class.getName());
    }
    ...
    public gu.c c(X509TrustManager trustManager) {
        ...
        return new gu.a(d(trustManager));
    }
    ...
    public gu.e d(X509TrustManager trustManager) {
        ...
        return new gu.b((X509Certificate[]) Arrays.copyOf(acceptedIssuers, acceptedIssuers.length));
    }
    ...
    public Object i(String closer) {
        ...
        if (f22446c.isLoggable(Level.FINE)) {
