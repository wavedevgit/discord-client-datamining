...
public final class n implements h {
    ...
    private static final net.time4j.tz.p f22088t = net.time4j.tz.p.t(64800);

    /* renamed from: u  reason: collision with root package name */
    private static final ConcurrentMap f22089u = new ConcurrentHashMap();

    /* renamed from: v  reason: collision with root package name */
    private static final ConcurrentMap f22090v = new ConcurrentHashMap();
    ...
    private final Locale f22094o;

    /* renamed from: p  reason: collision with root package name */
    private final String f22095p;

    /* renamed from: q  reason: collision with root package name */
    private final String f22096q;

    /* renamed from: r  reason: collision with root package name */
    private final char f22097r;

    /* renamed from: s  reason: collision with root package name */
    private final cu.g f22098s;
    ...
    private static String c(Locale locale) {
        ConcurrentMap concurrentMap = f22089u;
        String str = (String) concurrentMap.get(locale);
        if (str == null) {
            str = net.time4j.tz.p.f37785v.q(locale);
    ...
    private static a i(Locale locale) {
        a aVar = (a) f22090v.get(locale);
        if (aVar == null) {
            String q10 = f22088t.q(locale);
            ...
            for (int i10 = 0; i10 < length; i10++) {
                if (q10.charAt(i10) == 177) {
                    ...
                    a aVar3 = (a) f22090v.putIfAbsent(locale, aVar2);
                    if (aVar3 == null) {
                        return aVar2;
                    }
                    return aVar3;
    ...
    public h a(c cVar, bu.d dVar, int i10) {
        return new n(this.f22091d, ((Boolean) dVar.b(cu.a.f21116i, Boolean.TRUE)).booleanValue(), ((Boolean) dVar.b(cu.a.f21121n, Boolean.FALSE)).booleanValue(), (Locale) dVar.b(cu.a.f21110c, Locale.ROOT), (String) dVar.b(b.f21935g, "+"), (String) dVar.b(b.f21936h, "-"), ((Character) dVar.b(cu.a.f21120m, '0')).charValue(), (cu.g) dVar.b(cu.a.f21113f, cu.g.SMART));
    }
    ...
    public void d(CharSequence charSequence, s sVar, bu.d dVar, t tVar, boolean z10) {
        ...
        if (z10) {
            ...
            locale = (Locale) dVar2.b(cu.a.f21110c, Locale.ROOT);
        }
        boolean q10 = cu.b.q(locale);
        if (z10) {
            booleanValue = nVar.f22093i;
        } else {
            booleanValue = ((Boolean) dVar2.b(cu.a.f21121n, Boolean.FALSE)).booleanValue();
        }
        if (z10) {
            booleanValue2 = nVar.f22092e;
        } else {
            booleanValue2 = ((Boolean) dVar2.b(cu.a.f21116i, Boolean.TRUE)).booleanValue();
        }
        if (z10) {
            charValue = nVar.f22097r;
        } else {
        ...
        if (z10) {
            ...
            str = (String) dVar2.b(b.f21935g, "+");
        }
        if (z10) {
            str2 = nVar.f22096q;
        } else {
            str2 = (String) dVar2.b(b.f21936h, "-");
        }
        a i13 = i(locale);
        int length2 = i13.f22099a.length();
        int i14 = 0;
        ...
        while (i16 < length2) {
            int i17 = length2;
            char charAt = i13.f22099a.charAt(i16);
            if (i13.f22101c > i16 || i13.f22102d <= i16) {
                str3 = str;
                str4 = str2;
                if (z11) {
                    continue;
                ...
                if (z10) {
                    ...
                    str4 = str2;
                    gVar = (cu.g) dVar2.b(cu.a.f21113f, cu.g.SMART);
                }
                int m12 = m.m(charSequence, i10, i13.f22100b, booleanValue2, q10);
                if (m12 != -1) {
                    i10 += m12;
                } else if (nVar.f22091d) {
                    tVar.I(b0.TIMEZONE_OFFSET, net.time4j.tz.p.r(fVar2, j10));
                    sVar.l(i10);
                    return;
                } else if (gVar.e()) {
                ...
                i15 = i10 + 2;
                if (i15 < length && (m10 = m.m(charSequence, i15, i13.f22100b, booleanValue2, q10)) != -1) {
                    int i19 = i15 + m10;
    ...
    public boolean equals(Object obj) {
        ...
        if ((obj instanceof n) && this.f22091d == ((n) obj).f22091d) {
            return true;
        }
        return false;
    }
    ...
    public int g(bu.o oVar, Appendable appendable, bu.d dVar, Set set, boolean z10) {
        ...
        if (z10) {
            ...
            str = (String) dVar.b(b.f21935g, "+");
        }
        if (z10) {
            str2 = this.f22096q;
        } else {
            str2 = (String) dVar.b(b.f21936h, "-");
        }
        if (z10) {
            booleanValue = this.f22093i;
        } else {
            booleanValue = ((Boolean) dVar.b(cu.a.f21121n, Boolean.FALSE)).booleanValue();
        }
        int m10 = B.m();
        int l10 = B.l();
        if (!booleanValue && m10 == 0 && l10 == 0) {
            ...
            a i12 = i(locale);
            int length2 = i12.f22099a.length();
            int i13 = 0;
            int i14 = 0;
            while (i14 < length2) {
                char c12 = c10;
                char charAt = i12.f22099a.charAt(i14);
                if (i12.f22101c > i14 || i12.f22102d <= i14) {
                    pVar = B;
                    if (!booleanValue) {
                    ...
                    if (i15 != 0 || k10 != 0 || !this.f22091d) {
                        appendable.append(i12.f22100b);
                        i13 += i12.f22100b.length();
                        if (i15 < 10) {
                            appendable.append(charValue);
                            i13++;
                        }
