...
public final class f0 implements h {
    ...
    private final bu.p f22023d;

    /* renamed from: e  reason: collision with root package name */
    private final int f22024e;

    /* renamed from: i  reason: collision with root package name */
    private final char f22025i;

    /* renamed from: o  reason: collision with root package name */
    private final cu.g f22026o;
    ...
    private int b(boolean z10, bu.d dVar) {
        int intValue;
        if (z10) {
            intValue = this.f22028q;
        } else {
            intValue = ((Integer) dVar.b(cu.a.f21124q, Integer.valueOf(this.f22028q))).intValue();
        }
        if (intValue >= 100) {
            return intValue;
        }
    ...
    public h a(c cVar, bu.d dVar, int i10) {
        return new f0(this.f22023d, i10, ((Character) dVar.b(cu.a.f21120m, '0')).charValue(), (cu.g) dVar.b(cu.a.f21113f, cu.g.SMART), ((Integer) dVar.b(cu.a.f21126s, 0)).intValue(), ((Integer) dVar.b(cu.a.f21124q, Integer.valueOf(cVar.q().c()))).intValue());
    }
    ...
    */
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof f0) {
            return this.f22023d.equals(((f0) obj).f22023d);
        }
        return false;
    }
    ...
    public int g(bu.o oVar, Appendable appendable, bu.d dVar, Set set, boolean z10) {
        ...
        if (z10) {
            charValue = this.f22025i;
        } else {
            charValue = ((Character) dVar.b(cu.a.f21120m, '0')).charValue();
        }
        int i11 = 0;
        if (charValue != '0') {
            int i12 = charValue - '0';
        ...
        if (i10 != -1 && length > 0 && set != null) {
            set.add(new g(this.f22023d, i10, i10 + length));
        }
        return length;
    }
