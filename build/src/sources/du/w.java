...
public enum w {
    ...
    public static /* synthetic */ class a {
        ...
        static {
            ...
            try {
                f22153a[w.SIMPLE_DATE_FORMAT.ordinal()] = 2;
            } catch (NoSuchFieldError unused2) {
            }
            try {
                f22153a[w.CLDR_24.ordinal()] = 3;
            } catch (NoSuchFieldError unused3) {
            }
            try {
                f22153a[w.CLDR_DATE.ordinal()] = 4;
            } catch (NoSuchFieldError unused4) {
            }
            try {
                f22153a[w.DYNAMIC.ordinal()] = 5;
        ...
        if (i10 != 1) {
            if (i10 != 2) {
                if (i10 != 3) {
                    if (i10 != 4) {
                        if (i10 == 5) {
                            dVar.b0(cu.a.f21114g, cu.v.NARROW);
                    ...
                    dVar.b0(cu.a.f21114g, cu.v.WIDE);
                    dVar.z(net.time4j.f0.D);
                    dVar.L();
                    return;
                }
                dVar.b0(cu.a.f21114g, cu.v.ABBREVIATED);
                dVar.z(net.time4j.f0.D);
                dVar.L();
                return;
            }
    ...
    private Map o(c.d dVar, bu.x xVar, Locale locale, char c10, int i10, boolean z10) {
        ...
        switch (c10) {
            ...
            case 'K':
                ...
                break;
            case 'L':
                dVar.b0(cu.a.f21115h, cu.m.STANDALONE);
                if (!z10) {
                    i11 = i10;
                }
            ...
            if (z10 && (((z11 = s10 instanceof cu.t)) || Enum.class.isAssignableFrom(s10.getType()))) {
                if (i10 != 1) {
                    if (i10 != 2) {
                        ...
                        dVar.b0(cu.a.f21114g, cu.v.SHORT);
                    }
                } else {
                    dVar.b0(cu.a.f21114g, cu.v.NARROW);
                }
                                ...
                                if (c10 != 'w') {
                                    if (c10 != 'y') {
                                        ...
                                        if (locale.getLanguage().equals("am") && w(xVar).equals("ethiopic")) {
                                            dVar.b0(cu.a.f21119l, cu.j.f21174r);
                                        } else {
                                            z10 = false;
                                        }
                                        if (i10 == 2) {
