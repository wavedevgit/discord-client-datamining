...
public final class f {
    ...
    private final Object f50713a;

    /* renamed from: b  reason: collision with root package name */
    private final c f50714b;

    /* loaded from: /home/runner/work/discord-client-datamining/discord-client-datamining/build/classes4.dex */
    private static class b implements c {

        /* renamed from: a  reason: collision with root package name */
        private final Class f50715a;
        ...
        private Bundle b(Context context) {
            try {
                ...
                ServiceInfo serviceInfo = packageManager.getServiceInfo(new ComponentName(context, this.f50715a), IntBufferBatchMountItem.INSTRUCTION_UPDATE_LAYOUT);
                if (serviceInfo == null) {
                    Log.w("ComponentDiscovery", this.f50715a + " has no service info.");
                    return null;
                }
    ...
    public List b() {
        ArrayList arrayList = new ArrayList();
        for (final String str : this.f50714b.a(this.f50713a)) {
            arrayList.add(new ej.b() { // from class: ti.e
                @Override // ej.b
