...
public class i extends t5.b {
    ...
    public static /* synthetic */ class c {
        ...
        static {
            ...
            try {
                f49586a[b.a.RIGHT_ALIGN.ordinal()] = 2;
            } catch (NoSuchFieldError unused2) {
            }
            try {
                f49586a[b.a.CENTER.ordinal()] = 3;
    ...
    public i(n nVar, e eVar) {
        ...
        i(a10);
        k u10 = eVar.u();
        if (u10 != null && (aVar2 = u10.f48253a) != null) {
            o5.a a11 = aVar2.a();
            this.O = a11;
            a11.a(this);
            i(this.O);
        }
        if (u10 != null && (aVar = u10.f48254b) != null) {
            o5.a a12 = aVar.a();
            this.Q = a12;
            a12.a(this);
            i(this.Q);
        }
        if (u10 != null && (bVar2 = u10.f48255c) != null) {
            o5.a a13 = bVar2.a();
            this.S = a13;
            a13.a(this);
            i(this.S);
        }
        if (u10 != null && (bVar = u10.f48256d) != null) {
            o5.a a14 = bVar.a();
            this.U = a14;
            a14.a(this);
            i(this.U);
    ...
    private void Q(q5.b bVar, int i10) {
        ...
        if (aVar3 != null) {
            ...
            if (aVar4 != null) {
                ...
                this.H.setColor(bVar.f47255i);
            }
        }
        if (this.f49538x.h() == null) {
            intValue = 100;
        } else {
            intValue = ((Integer) this.f49538x.h().h()).intValue();
        }
        ...
        if (aVar6 != null) {
            ...
            this.H.setStrokeWidth(bVar.f47256j * x5.j.e());
        }
    }
    ...
    private void S(q5.d dVar, float f10, q5.b bVar, Canvas canvas) {
        ...
        for (int i10 = 0; i10 < a02.size(); i10++) {
            ...
            this.F.reset();
            this.F.preTranslate(0.0f, (-bVar.f47253g) * x5.j.e());
    ...
    */
    private void X(q5.b r13, q5.c r14, android.graphics.Canvas r15) {
        ...
        L6:
            ...
            goto Ld4
        L9:
            java.lang.String r1 = r13.f47247a
        ...
        L8c:
            ...
            android.graphics.PointF r3 = r13.f47259m
            if (r3 != 0) goto L9c
            r3 = 0
        L9a:
            r5 = r3
    ...
    */
    private void Y(q5.b r17, android.graphics.Matrix r18, q5.c r19, android.graphics.Canvas r20) {
        ...
        L15:
            ...
            float r4 = r1 / r2
            float r8 = x5.j.g(r18)
            java.lang.String r1 = r7.f47247a
        ...
        L51:
            ...
            android.graphics.PointF r2 = r7.f47259m
            if (r2 != 0) goto L5f
            r2 = 0
            goto L61
        L5f:
    ...
    private boolean e0(Canvas canvas, q5.b bVar, int i10, float f10) {
        float f11;
        float f12;
        PointF pointF = bVar.f47258l;
        PointF pointF2 = bVar.f47259m;
        float e10 = x5.j.e();
        float f13 = 0.0f;
        if (pointF == null) {
            f11 = 0.0f;
        } else {
            f11 = (bVar.f47252f * e10) + pointF.y;
        }
        float f14 = (i10 * bVar.f47252f * e10) + f11;
        if (this.M.I() && pointF2 != null && pointF != null && f14 >= pointF.y + pointF2.y + bVar.f47249c) {
            return false;
        }
        if (pointF == null) {
            f12 = 0.0f;
        ...
        int i11 = c.f49586a[bVar.f47250d.ordinal()];
        if (i11 != 1) {
            if (i11 != 2) {
                if (i11 == 3) {
    ...
    void u(Canvas canvas, Matrix matrix, int i10) {
        ...
        q5.c cVar = (q5.c) this.N.g().get(bVar.f47248b);
        if (cVar == null) {
            return;
        }
        canvas.save();
