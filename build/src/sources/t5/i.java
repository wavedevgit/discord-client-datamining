...
public class i extends t5.b {
    ...
    private void Q(q5.b bVar, int i10) {
        ...
        if (aVar6 != null) {
            ...
            this.H.setStrokeWidth(bVar.f47406j * x5.j.e());
        }
    }
    ...
    private void S(q5.d dVar, float f10, q5.b bVar, Canvas canvas) {
        ...
        for (int i10 = 0; i10 < a02.size(); i10++) {
            ...
            this.F.reset();
            this.F.preTranslate(0.0f, (-bVar.f47403g) * x5.j.e());
    ...
    */
    private void X(q5.b r13, q5.c r14, android.graphics.Canvas r15) {
        ...
        L6:
            ...
            goto Ld4
        L9:
            java.lang.String r1 = r13.f47397a
        ...
        L8c:
            ...
            android.graphics.PointF r3 = r13.f47409m
            if (r3 != 0) goto L9c
            r3 = 0
        L9a:
            r5 = r3
    ...
    */
    private void Y(q5.b r17, android.graphics.Matrix r18, q5.c r19, android.graphics.Canvas r20) {
        ...
        L15:
            ...
            float r4 = r1 / r2
            float r8 = x5.j.g(r18)
            java.lang.String r1 = r7.f47397a
        ...
        L51:
            ...
            android.graphics.PointF r2 = r7.f47409m
            if (r2 != 0) goto L5f
            r2 = 0
            goto L61
        L5f:
    ...
    private boolean e0(Canvas canvas, q5.b bVar, int i10, float f10) {
        float f11;
        float f12;
        PointF pointF = bVar.f47408l;
        PointF pointF2 = bVar.f47409m;
        float e10 = x5.j.e();
        float f13 = 0.0f;
        if (pointF == null) {
            f11 = 0.0f;
        } else {
            f11 = (bVar.f47402f * e10) + pointF.y;
        }
        float f14 = (i10 * bVar.f47402f * e10) + f11;
        if (this.M.I() && pointF2 != null && pointF != null && f14 >= pointF.y + pointF2.y + bVar.f47399c) {
            return false;
        }
        if (pointF == null) {
            f12 = 0.0f;
    ...
    void u(Canvas canvas, Matrix matrix, int i10) {
        ...
        q5.c cVar = (q5.c) this.N.g().get(bVar.f47398b);
        if (cVar == null) {
            return;
        }
        canvas.save();
