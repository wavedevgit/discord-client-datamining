...
public abstract class j {
    ...
    public /* synthetic */ class a {
        ...
        static {
            ...
            try {
                iArr[n.f55225d.ordinal()] = 1;
            } catch (NoSuchFieldError unused) {
            }
            try {
                iArr[n.f55226e.ordinal()] = 2;
            } catch (NoSuchFieldError unused2) {
            }
            try {
                iArr[n.f55227i.ordinal()] = 3;
    ...
    public static final class b implements Comparator {
        ...
        public final int compare(Object obj, Object obj2) {
            l lVar = (l) obj2;
            l lVar2 = (l) obj;
            return ur.a.d(Integer.valueOf(lVar.f().getWidth() * lVar.f().getHeight()), Integer.valueOf(lVar2.f().getWidth() * lVar2.f().getHeight()));
        }
    }
    ...
    private static final v.b d(n nVar) {
        int i10 = a.f55192a[nVar.ordinal()];
        if (i10 != 1) {
            if (i10 != 2) {
                if (i10 == 3) {
                    return v.b.f52742i;
