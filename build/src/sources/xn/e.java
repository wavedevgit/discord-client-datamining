...
public abstract class e {
    ...
    public static final class a extends z8.b {
        ...
        final /* synthetic */ Context f55512a;

        /* renamed from: b  reason: collision with root package name */
        final /* synthetic */ Function1 f55513b;

        /* renamed from: c  reason: collision with root package name */
        final /* synthetic */ Uri f55514c;
        ...
        protected void onNewResultImpl(DataSource dataSource) {
            ...
            if (eVar instanceof f) {
                ...
                Resources resources = this.f55512a.getResources();
                Intrinsics.checkNotNullExpressionValue(resources, "getResources(...)");
                this.f55513b.invoke(new BitmapDrawable(resources, Q1));
            }
