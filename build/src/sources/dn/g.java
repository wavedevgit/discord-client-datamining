...
public final class g implements Parcelable {
    ...
    private final SparseArray f20917e;
    ...
    public boolean equals(Object obj) {
        ...
        g gVar = (g) obj;
        if (Intrinsics.areEqual(this.f20916d, gVar.f20916d) && Intrinsics.areEqual(this.f20917e, gVar.f20917e)) {
            return true;
        }
        return false;
    }
    ...
    public int hashCode() {
        return (this.f20916d.hashCode() * 31) + this.f20917e.hashCode();
    }

    public String toString() {
        return "ViewStateFrame(key=" + this.f20916d + ", viewState=" + this.f20917e + ')';
    }
    ...
    public void writeToParcel(Parcel parcel, int i10) {
        ...
        parcel.writeSparseArray(this.f20917e);
    }
}
