...
public abstract class d {
    ...
    private final int[] f21885a = new int[12];
    ...
    private WritableArray f21896l;

    /* renamed from: m  reason: collision with root package name */
    private WritableArray f21897m;
    ...
    private final C0288d[] f21900p;

    /* renamed from: q  reason: collision with root package name */
    private boolean f21901q;

    /* renamed from: r  reason: collision with root package name */
    private float[] f21902r;

    /* renamed from: s  reason: collision with root package name */
    private short f21903s;

    /* renamed from: t  reason: collision with root package name */
    private float f21904t;

    /* renamed from: u  reason: collision with root package name */
    private float f21905u;
    ...
    public static final class a extends Exception {
        ...
        */
        public a(dn.d r21, android.view.MotionEvent r22, java.lang.IllegalArgumentException r23) {
            /*
                r20 = this;
                r0 = r22
                r1 = r23
                ...
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: dn.d.a.<init>(dn.d, android.view.MotionEvent, java.lang.IllegalArgumentException):void");
        }
    }
    ...
    public static final class C0288d {
        ...
        public C0288d(int i10, float f10, float f11, float f12, float f13) {
            this.f21912a = i10;
            this.f21913b = f10;
            this.f21914c = f11;
            this.f21915d = f12;
        ...
        public boolean equals(Object obj) {
            ...
            if (this.f21912a == c0288d.f21912a && Float.compare(this.f21913b, c0288d.f21913b) == 0 && Float.compare(this.f21914c, c0288d.f21914c) == 0 && Float.compare(this.f21915d, c0288d.f21915d) == 0 && Float.compare(this.f21916e, c0288d.f21916e) == 0) {
                return true;
            }
            return false;
        }
        ...
        public int hashCode() {
            return (((((((Integer.hashCode(this.f21912a) * 31) + Float.hashCode(this.f21913b)) * 31) + Float.hashCode(this.f21914c)) * 31) + Float.hashCode(this.f21915d)) * 31) + Float.hashCode(this.f21916e);
        }
        ...
        public String toString() {
            ...
            float f10 = this.f21913b;
            float f11 = this.f21914c;
            float f12 = this.f21915d;
            float f13 = this.f21916e;
    ...
    public d() {
        ...
        this.f21887c = iArr;
        this.f21894j = true;
        C0288d[] c0288dArr = new C0288d[12];
        for (int i11 = 0; i11 < 12; i11++) {
            c0288dArr[i11] = null;
        }
        this.f21900p = c0288dArr;
        this.D = 3;
    }
    ...
    private final void A(MotionEvent motionEvent, MotionEvent motionEvent2) {
        ...
        this.f21900p[pointerId] = new C0288d(pointerId, motionEvent.getX(motionEvent.getActionIndex()), motionEvent.getY(motionEvent.getActionIndex()), (motionEvent2.getX(motionEvent.getActionIndex()) + (motionEvent2.getRawX() - motionEvent2.getX())) - this.f21887c[0], (motionEvent2.getY(motionEvent.getActionIndex()) + (motionEvent2.getRawY() - motionEvent2.getY())) - this.f21887c[1]);
        C0288d c0288d = this.f21900p[pointerId];
        Intrinsics.checkNotNull(c0288d);
        n(c0288d);
        this.f21900p[pointerId] = null;
        this.f21899o--;
        y();
    }
    ...
    private final void C() {
        C0288d[] c0288dArr;
        this.f21897m = null;
        for (C0288d c0288d : this.f21900p) {
            if (c0288d != null) {
                o(c0288d);
            }
        }
    ...
    private final void h0(int i10) {
        ...
        if (this.f21899o > 0 && (i10 == 5 || i10 == 3 || i10 == 1)) {
            r();
        }
        int i11 = this.f21890f;
        this.f21890f = i10;
        if (i10 == 4) {
            short s10 = N;
            N = (short) (s10 + 1);
    ...
    private final boolean i0(MotionEvent motionEvent) {
        if (motionEvent.getPointerCount() != this.f21886b) {
            return true;
        }
        int length = this.f21885a.length;
        for (int i10 = 0; i10 < length; i10++) {
            int i11 = this.f21885a[i10];
            if (i11 != -1 && i11 != i10) {
                return true;
            }
        }
    ...
    */
    private final android.view.MotionEvent m(android.view.MotionEvent r26) {
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: dn.d.m(android.view.MotionEvent):android.view.MotionEvent");
    }

    private final void n(C0288d c0288d) {
        if (this.f21896l == null) {
            this.f21896l = Arguments.createArray();
        }
        WritableArray writableArray = this.f21896l;
        Intrinsics.checkNotNull(writableArray);
        writableArray.pushMap(u(c0288d));
    }

    private final void o(C0288d c0288d) {
        if (this.f21897m == null) {
            this.f21897m = Arguments.createArray();
        }
        WritableArray writableArray = this.f21897m;
        Intrinsics.checkNotNull(writableArray);
        writableArray.pushMap(u(c0288d));
    }
    ...
    private final void r() {
        ...
        this.f21899o = 0;
        kotlin.collections.i.z(this.f21900p, null, 0, 0, 6, null);
        y();
    }

    private final WritableMap u(C0288d c0288d) {
        WritableMap createMap = Arguments.createMap();
        createMap.putInt(StackTraceHelper.ID_KEY, c0288d.c());
        createMap.putDouble("x", PixelUtil.toDIPFromPixel(c0288d.d()));
        createMap.putDouble("y", PixelUtil.toDIPFromPixel(c0288d.e()));
        createMap.putDouble("absoluteX", PixelUtil.toDIPFromPixel(c0288d.a()));
        createMap.putDouble("absoluteY", PixelUtil.toDIPFromPixel(c0288d.b()));
    ...
    public final void y0(boolean z10) {
        if (this.f21889e != null && this.f21894j != z10) {
            UiThreadUtil.runOnUiThread(new Runnable() { // from class: dn.c
    ...
    private final void z(MotionEvent motionEvent, MotionEvent motionEvent2) {
        ...
        for (int i11 = 0; i11 < pointerCount; i11++) {
            C0288d c0288d = this.f21900p[motionEvent.getPointerId(i11)];
            if (c0288d != null && (c0288d.d() != motionEvent.getX(i11) || c0288d.e() != motionEvent.getY(i11))) {
                c0288d.h(motionEvent.getX(i11));
                c0288d.i(motionEvent.getY(i11));
                c0288d.f((motionEvent2.getX(i11) + rawX) - this.f21887c[0]);
                c0288d.g((motionEvent2.getY(i11) + rawY) - this.f21887c[1]);
                n(c0288d);
                i10++;
            }
        }
    ...
    public final float J() {
        return (this.f21904t + this.f21907w) - this.f21887c[0];
    }
    ...
    public final float K() {
        return (this.f21905u + this.f21908x) - this.f21887c[1];
    }
    ...
    public final PointF Q0(PointF point) {
        ...
        i iVar = this.A;
        if (iVar != null && (L2 = iVar.L(this.f21889e, point)) != null) {
            return L2;
        }
        point.x = Float.NaN;
        point.y = Float.NaN;
    ...
    public final boolean S0(MotionEvent event) {
        int i10;
        Intrinsics.checkNotNullParameter(event, "event");
        if (this.f21894j && (i10 = this.f21890f) != 1 && i10 != 3 && i10 != 5 && e0(event.getPointerId(event.getActionIndex()))) {
            return true;
        }
        return false;
    }
    ...
    public final void X(MotionEvent transformedEvent, MotionEvent sourceEvent) {
        ...
        Intrinsics.checkNotNullParameter(sourceEvent, "sourceEvent");
        if (this.f21894j && (i10 = this.f21890f) != 3 && i10 != 1 && i10 != 5 && this.f21886b >= 1) {
            try {
                ...
                this.f21891g = motionEvent.getX();
                this.f21892h = motionEvent.getY();
                this.f21909y = motionEvent.getPointerCount();
                boolean g02 = g0(this.f21889e, this.f21891g, this.f21892h);
                this.f21893i = g02;
                if (this.f21910z && !g02) {
                    int i11 = this.f21890f;
                    if (i11 == 4) {
                ...
                k kVar = k.f21938a;
                this.f21904t = kVar.b(motionEvent, true);
                this.f21905u = kVar.c(motionEvent, true);
                this.f21907w = motionEvent.getRawX() - motionEvent.getX();
                this.f21908x = motionEvent.getRawY() - motionEvent.getY();
    ...
    public final boolean Y(d other) {
        ...
        int length = this.f21885a.length;
        for (int i10 = 0; i10 < length; i10++) {
            if (this.f21885a[i10] != -1 && other.f21885a[i10] != -1) {
                return true;
            }
        }
        return false;
    ...
    /*
        ...
        To view partially-correct add '--show-bad-code' argument
    */
    public final boolean c0(dn.d r4) {
        /*
            r3 = this;
            java.lang.String r0 = "of"
            kotlin.jvm.internal.Intrinsics.checkNotNullParameter(r4, r0)
            android.view.View r0 = r3.f21889e
            r1 = 0
            if (r0 == 0) goto Lf
        ...
        L18:
            if (r0 == 0) goto L2f
            android.view.View r2 = r4.f21889e
        ...
        L2f:
            ...
            return r4
        */
        throw new UnsupportedOperationException("Method not decompiled: dn.d.c0(dn.d):boolean");
    }
    ...
    public final void q0(View view, i iVar) {
        Context context;
        if (this.f21889e == null && this.A == null) {
            Arrays.fill(this.f21885a, -1);
            this.f21886b = 0;
            this.f21890f = 0;
            this.f21889e = view;
            this.A = iVar;
            ...
            if (view2 != null) {
                view2.getLocationOnScreen(this.f21887c);
            } else {
    ...
    public void y() {
        r rVar;
        if (this.f21896l != null && (rVar = this.B) != null) {
            rVar.c(this);
        }
    }
    ...
    public final void z0(float f10, float f11, float f12, float f13, float f14, float f15) {
        if (this.f21902r == null) {
            this.f21902r = new float[6];
        }
        float[] fArr = this.f21902r;
        Intrinsics.checkNotNull(fArr);
        fArr[0] = f10;
        float[] fArr2 = this.f21902r;
        Intrinsics.checkNotNull(fArr2);
        fArr2[1] = f11;
        float[] fArr3 = this.f21902r;
        Intrinsics.checkNotNull(fArr3);
        fArr3[2] = f12;
        float[] fArr4 = this.f21902r;
        Intrinsics.checkNotNull(fArr4);
        fArr4[3] = f13;
        float[] fArr5 = this.f21902r;
        Intrinsics.checkNotNull(fArr5);
        fArr5[4] = f14;
        float[] fArr6 = this.f21902r;
