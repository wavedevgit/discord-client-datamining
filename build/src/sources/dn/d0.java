...
public abstract class d0 {
    ...
    public static final class a extends Lambda implements Function0 {
        ...
        final /* synthetic */ c f20864d;

        /* renamed from: e  reason: collision with root package name */
        final /* synthetic */ CoroutineContext f20865e;

        /* renamed from: i  reason: collision with root package name */
        final /* synthetic */ Function2 f20866i;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        a(c cVar, CoroutineContext coroutineContext, Function2 function2) {
            super(0);
            this.f20864d = cVar;
            this.f20865e = coroutineContext;
            this.f20866i = function2;
        }
    ...
    private static final c a(View view) {
        c cVar;
        Object tag = view.getTag(q.f20927b);
        c cVar2 = null;
        if (tag instanceof c) {
            cVar = (c) tag;
        } else {
        ...
        if (cVar2 == null) {
            LifecycleOwner a10 = en.c.f21674a.a(view);
            if (a10 != null) {
                ...
                c cVar3 = new c(kotlinx.coroutines.i.j(a11, new os.b0(sb4)));
                view.setTag(q.f20927b, cVar3);
