...
public final class m extends d {
    ...
    private Handler O;
    private Runnable P = new Runnable() { // from class: dn.l
    ...
    public static final class b extends d.c {
        ...
        private final Class f21940b = m.class;

        /* renamed from: c  reason: collision with root package name */
        private final String f21941c = "HoverGestureHandler";
        ...
        @Override // dn.d.c
        /* renamed from: h */
        public en.c c(m handler) {
            Intrinsics.checkNotNullParameter(handler, "handler");
            return new en.c(handler);
        }
    }
