...
public final class i {
    ...
    public static final a f21918n = new a(null);

    /* renamed from: o  reason: collision with root package name */
    private static final PointF f21919o = new PointF();

    /* renamed from: p  reason: collision with root package name */
    private static final float[] f21920p = new float[2];

    /* renamed from: q  reason: collision with root package name */
    private static final Matrix f21921q = new Matrix();

    /* renamed from: r  reason: collision with root package name */
    private static final float[] f21922r = new float[2];

    /* renamed from: s  reason: collision with root package name */
    private static final Comparator f21923s = new Comparator() { // from class: dn.f
    ...
    private final d0 f21926c;

    /* renamed from: d  reason: collision with root package name */
    private final ViewGroup f21927d;

    /* renamed from: e  reason: collision with root package name */
    private float f21928e;

    /* renamed from: f  reason: collision with root package name */
    private final ArrayList f21929f;

    /* renamed from: g  reason: collision with root package name */
    private final ArrayList f21930g;

    /* renamed from: h  reason: collision with root package name */
    private final ArrayList f21931h;

    /* renamed from: i  reason: collision with root package name */
    private final HashSet f21932i;
    ...
    public static final class a {
        ...
        public final void n(float f10, float f11, ViewGroup viewGroup, View view, PointF pointF) {
            ...
            if (!matrix.isIdentity()) {
                float[] fArr = i.f21920p;
                fArr[0] = scrollX;
                fArr[1] = scrollY;
                matrix.invert(i.f21921q);
                i.f21921q.mapPoints(fArr);
                float f12 = fArr[0];
                scrollY = fArr[1];
                scrollX = f12;
            }
    ...
    public /* synthetic */ class b {
        ...
        static {
            ...
            try {
                iArr[v.f21983d.ordinal()] = 1;
            } catch (NoSuchFieldError unused) {
            }
            try {
                iArr[v.f21985i.ordinal()] = 2;
            } catch (NoSuchFieldError unused2) {
            }
            try {
                iArr[v.f21984e.ordinal()] = 3;
            } catch (NoSuchFieldError unused3) {
            }
            try {
                iArr[v.f21986o.ordinal()] = 4;
    ...
    public i(ViewGroup wrapperView, j handlerRegistry, d0 viewConfigHelper, ViewGroup rootView) {
        ...
        this.f21924a = wrapperView;
        this.f21925b = handlerRegistry;
        this.f21926c = viewConfigHelper;
        this.f21927d = rootView;
        this.f21929f = new ArrayList();
        this.f21930g = new ArrayList();
        this.f21931h = new ArrayList();
        this.f21932i = new HashSet();
    }

    private final void C(d dVar, View view) {
        if (this.f21929f.contains(dVar)) {
            return;
        }
        this.f21929f.add(dVar);
        dVar.w0(false);
        dVar.x0(false);
    ...
    private final boolean D(View view, float[] fArr, int i10, MotionEvent motionEvent) {
        boolean z10;
        ArrayList a10 = this.f21925b.a(view);
        if (a10 != null) {
            synchronized (a10) {
                try {
    ...
    private final void E() {
        if (!this.f21933j && this.f21934k == 0) {
            l();
        } else {
            this.f21935l = true;
        }
    ...
    private final boolean G(d dVar) {
        ArrayList<d> arrayList = this.f21929f;
        if (arrayList != null && arrayList.isEmpty()) {
            return false;
        }
        for (d dVar2 : arrayList) {
            if (dVar.Y(dVar2) && dVar2.S() == 4 && !f21918n.h(dVar, dVar2) && dVar.c0(dVar2)) {
                return true;
            }
        }
        return false;
    ...
    private final boolean H(d dVar) {
        ...
        for (d dVar2 : arrayList) {
            if (f21918n.l(dVar, dVar2) && dVar2.S() == 5) {
                return true;
            }
        }
        return false;
    ...
    private final boolean J(View view) {
        if ((view instanceof RNGestureHandlerRootView) && !Intrinsics.areEqual(view, this.f21924a) && ((RNGestureHandlerRootView) view).isRootViewEnabled()) {
            return true;
        }
        return false;
    }
    ...
    private final boolean M(View view, float[] fArr, int i10, MotionEvent motionEvent) {
        ...
        int i11 = b.f21937a[this.f21926c.a(view).ordinal()];
        if (i11 == 1) {
            return false;
        }
        if (i11 != 2) {
            if (i11 != 3) {
                if (i11 == 4) {
                    ...
                    if (!D(view, fArr, i10, motionEvent) && !z10 && !f21918n.m(view, fArr)) {
                        return false;
                    }
                    return true;
                }
        ...
        } else if (!D(view, fArr, i10, motionEvent) && !f21918n.m(view, fArr)) {
            return false;
        } else {
            return true;
        }
    ...
    private final void h(d dVar) {
        if (this.f21930g.contains(dVar)) {
            return;
        }
        this.f21930g.add(dVar);
        this.f21932i.add(Integer.valueOf(dVar.T()));
        dVar.x0(true);
        int i10 = this.f21936m;
        this.f21936m = i10 + 1;
        dVar.v0(i10);
    }

    private final boolean i(View view) {
        if (view.getVisibility() == 0 && view.getAlpha() >= this.f21928e) {
            return true;
        }
        return false;
    }
    ...
    private final void j() {
        for (d dVar : CollectionsKt.h1(CollectionsKt.T(this.f21930g))) {
            dVar.q();
        }
        for (d dVar2 : CollectionsKt.T(this.f21929f)) {
            dVar2.q();
        }
    }

    private final void k() {
        for (d dVar : CollectionsKt.h1(this.f21930g)) {
            if (!dVar.a0()) {
                this.f21930g.remove(dVar);
                this.f21932i.remove(Integer.valueOf(dVar.T()));
            }
        }
    }

    private final void l() {
        for (d dVar : CollectionsKt.T(this.f21929f)) {
            if (f21918n.i(dVar.S()) && !dVar.a0()) {
                dVar.r0();
                dVar.w0(false);
                dVar.x0(false);
                dVar.v0(Integer.MAX_VALUE);
        ...
        CollectionsKt.J(this.f21929f, new Function1() { // from class: dn.g
    ...
    private final void o(MotionEvent motionEvent) {
        List<d> j12 = CollectionsKt.j1(this.f21929f);
        CollectionsKt.A(j12, f21923s);
        for (d dVar : j12) {
            n(dVar, motionEvent);
        }
    }
    ...
    private final boolean p(View view, float[] fArr, int i10) {
        ...
        for (ViewParent parent = view.getParent(); parent != null; parent = parent.getParent()) {
            if (parent instanceof ViewGroup) {
                ...
                ArrayList a10 = this.f21925b.a((View) parent);
                if (a10 != null) {
                    synchronized (a10) {
                        try {
                            Iterator it = a10.iterator();
    ...
    private final void q(MotionEvent motionEvent) {
        ...
        M(this.f21924a, fArr, pointerId, motionEvent);
        r(this.f21924a, fArr, pointerId, motionEvent);
    }
    ...
    private final boolean r(ViewGroup viewGroup, float[] fArr, int i10, MotionEvent motionEvent) {
        ...
        while (-1 < childCount) {
            View c10 = this.f21926c.c(viewGroup, childCount);
            if (i(c10)) {
                PointF pointF = f21919o;
                a aVar = f21918n;
    ...
    private final boolean w(View view) {
        if ((view instanceof ViewGroup) && !this.f21926c.b((ViewGroup) view)) {
            return false;
        }
        return true;
    }
    ...
    private final boolean x(View view) {
        ...
        if (view == this.f21924a) {
            return true;
        }
        ViewParent parent = view.getParent();
        while (parent != null && parent != this.f21924a) {
            parent = parent.getParent();
        }
        if (parent != this.f21924a) {
            return false;
        }
        return true;
    }
    ...
    private final void z(d dVar) {
        ...
        dVar.v0(i10);
        for (d dVar2 : CollectionsKt.T(this.f21929f)) {
            if (f21918n.k(dVar2, dVar)) {
                dVar2.q();
            }
        }
        for (d dVar3 : CollectionsKt.T(this.f21930g)) {
            if (f21918n.k(dVar3, dVar)) {
                dVar3.x0(false);
            }
        }
        k();
    ...
    public final void A(d handler, int i10, int i11) {
        ...
        if (f21918n.i(i10)) {
            for (d dVar : CollectionsKt.h1(this.f21930g)) {
                if (f21918n.l(dVar, handler) && this.f21932i.contains(Integer.valueOf(dVar.T()))) {
                    if (i10 == 5) {
                        dVar.q();
                        if (dVar.S() == 5) {
                            dVar.w(3, 2);
    ...
    */
    public final boolean B(android.view.MotionEvent r5) {
        ...
        L30:
            ...
            goto L4d
        L39:
            java.util.ArrayList r1 = r4.f21929f
            boolean r1 = r1.isEmpty()
            if (r1 == 0) goto L4d
            android.view.ViewGroup r1 = r4.f21927d
        ...
        L4d:
            return r0
        */
        throw new UnsupportedOperationException("Method not decompiled: dn.i.B(android.view.MotionEvent):boolean");
    }
    ...
    public final MotionEvent K(View view, MotionEvent event) {
        ...
        if (view != null) {
            ...
            if (!Intrinsics.areEqual(viewGroup, this.f21924a)) {
                K(viewGroup, event);
            }
            if (viewGroup != null) {
    ...
    public final void f(View view) {
        ...
        ArrayList<d> a10 = this.f21925b.a(view);
        if (a10 != null) {
            for (final d dVar : a10) {
                if (dVar instanceof q) {
                    C(dVar, view);
                    dVar.T0(new Function0() { // from class: dn.h
