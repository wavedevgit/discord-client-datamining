...
public final class a implements Closeable, Parcelable {
    ...
    public boolean equals(Object obj) {
        ...
        if ((obj instanceof a) && Intrinsics.areEqual(this.f44433d, ((a) obj).f44433d)) {
            return true;
        }
        return false;
    }
    ...
    public int hashCode() {
        return this.f44433d.hashCode();
    }

    public String toString() {
        List list = this.f44433d;
    ...
    public final void writeToParcel(Parcel dest, int i10) {
        ...
        List<Parcelable> list = this.f44433d;
