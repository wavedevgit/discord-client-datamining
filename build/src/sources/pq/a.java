...
import ps.g;
import zm.o;
@Metadata(d1 = {"\u0000,\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\u0010\u000e\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0002\b\u0003\n\u0002\u0018\u0002\n\u0002\b\u0003\n\u0002\u0010\u000b\n\u0002\b\b\u0018\u00002\b\u0012\u0004\u0012\u00020\u00020\u0001:\u0002\u0011\u000fB!\b\u0002\u0012\u0006\u0010\u0004\u001a\u00020\u0003\u0012\u0006\u0010\u0005\u001a\u00020\u0003\u0012\u0006\u0010\u0007\u001a\u00020\u0006¢\u0006\u0004\b\b\u0010\tJ\u0015\u0010\u000b\u001a\b\u0012\u0004\u0012\u00020\u00020\nH\u0016¢\u0006\u0004\b\u000b\u0010\fJ\u001b\u0010\u000f\u001a\u00020\u000e2\n\u0010\r\u001a\u0006\u0012\u0002\b\u00030\u0001H\u0016¢\u0006\u0004\b\u000f\u0010\u0010R\u0014\u0010\u0004\u001a\u00020\u00038\u0002X\u0082\u0004¢\u0006\u0006\n\u0004\b\u0011\u0010\u0012R\u0014\u0010\u0005\u001a\u00020\u00038\u0002X\u0082\u0004¢\u0006\u0006\n\u0004\b\u0013\u0010\u0012R\u0014\u0010\u0007\u001a\u00020\u00068\u0002X\u0082\u0004¢\u0006\u0006\n\u0004\b\u0014\u0010\u0015¨\u0006\u0016"}, d2 = {"Lpq/a;", "Lzm/o;", "Lpq/a$b;", "", "sessionToken", "addressId", "Lpq/b;", "uiService", "<init>", "(Ljava/lang/String;Ljava/lang/String;Lpq/b;)V", "Lkotlinx/coroutines/flow/Flow;", "run", "()Lkotlinx/coroutines/flow/Flow;", "otherWorker", "", "a", "(Lzm/o;)Z", "b", "Ljava/lang/String;", "c", "d", "Lpq/b;", "ui_release"}, k = 1, mv = {2, 0, 0}, xi = 48)
...
public final class a implements o<b> {
    ...
    public static final class C0568a {
        ...
        private final pq.b f46257a;

        public C0568a(pq.b uiService) {
            Intrinsics.checkNotNullParameter(uiService, "uiService");
            this.f46257a = uiService;
        }

        public final a a(String sessionToken, String addressId) {
            Intrinsics.checkNotNullParameter(sessionToken, "sessionToken");
            Intrinsics.checkNotNullParameter(addressId, "addressId");
            return new a(sessionToken, addressId, this.f46257a, null);
        }
    }
    ...
    public static abstract class b {
        ...
        public static final class C0569a extends b {
            ...
            /* renamed from: a  reason: collision with root package name */
            private final InternalErrorInfo f46258a;

            /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
            public C0569a(InternalErrorInfo cause) {
                super(null);
        ...
        public static final class C0570b extends b {
            ...
            /* renamed from: a  reason: collision with root package name */
            private final LocationData f46259a;

            /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
            public C0570b(LocationData result) {
                super(null);
    ...
    static final class c extends k implements Function2 {
        ...
        private /* synthetic */ Object f46262i;

        /* JADX INFO: Access modifiers changed from: package-private */
        /* renamed from: pq.a$c$a  reason: collision with other inner class name */
        /* loaded from: /home/runner/work/discord-client-datamining/discord-client-datamining/build/classes4.dex */
        public static final class C0571a extends k implements Function1 {

            /* renamed from: d  reason: collision with root package name */
            int f46264d;

            /* renamed from: e  reason: collision with root package name */
            final /* synthetic */ a f46265e;
            ...
            public final Continuation create(Continuation continuation) {
                return new C0571a(this.f46265e, continuation);
            }
            ...
            public final Object invokeSuspend(Object obj) {
                ...
                kotlin.c.b(obj);
                pq.b bVar = this.f46265e.f46256d;
                String str = this.f46265e.f46254b;
                String str2 = this.f46265e.f46255c;
                this.f46264d = 1;
            ...
            public final Object invoke(Continuation continuation) {
                return ((C0571a) create(continuation)).invokeSuspend(Unit.f31988a);
            }
        }
        ...
        */
        public final java.lang.Object invokeSuspend(java.lang.Object r15) {
            /*
                ...
                if (r1 == r3) goto L26
                if (r1 != r2) goto L1e
                java.lang.Object r0 = r14.f46262i
            ...
            L1e:
                ...
                throw r0
            L26:
                java.lang.Object r1 = r14.f46260d
                ...
                java.lang.Object r3 = r14.f46262i
                kotlinx.coroutines.flow.FlowCollector r3 = (kotlinx.coroutines.flow.FlowCollector) r3
                kotlin.c.b(r15)
                goto L82
            L32:
                java.lang.Object r1 = r14.f46262i
    ...
    public /* synthetic */ a(String str, String str2, pq.b bVar, DefaultConstructorMarker defaultConstructorMarker) {
        this(str, str2, bVar);
    }
    ...
    public boolean a(o otherWorker) {
        ...
        if ((otherWorker instanceof a) && Intrinsics.areEqual(this.f46255c, ((a) otherWorker).f46255c)) {
            return true;
        }
        return false;
    }
    ...
    private a(String str, String str2, pq.b bVar) {
        this.f46254b = str;
        this.f46255c = str2;
        this.f46256d = bVar;
    }
