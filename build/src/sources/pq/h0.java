...
public abstract class h0 {
    public static final ConstraintLayout b(f0 f0Var, m5 uiComponentHelper, List componentViews, List children, HorizontalStack config) {
        ...
        final sq.h c10 = sq.h.c(uiComponentHelper.b());
        ...
        if (styles != null) {
            uiComponentHelper.d(new Function0() { // from class: pq.g0
                @Override // kotlin.jvm.functions.Function0
                public final Object invoke() {
                    Unit c11;
                    c11 = h0.c(sq.h.this, styles);
                    return c11;
                }
            });
        }
    ...
    public static final Unit c(sq.h hVar, HorizontalStack.HorizontalStackComponentStyle horizontalStackComponentStyle) {
        ConstraintLayout root = hVar.getRoot();
        Intrinsics.checkNotNullExpressionValue(root, "getRoot(...)");
        uq.q.c(root, horizontalStackComponentStyle);
        return Unit.f31988a;
    }
}
