...
public abstract class a1 {
    ...
    public static final ConstraintLayout f(InputConfirmationCodeComponent inputConfirmationCodeComponent, m5 uiComponentHelper, final InputConfirmationCode config) {
        ...
        final List o10 = CollectionsKt.o(c10.f48201b.getEditText(), c10.f48204e.getEditText(), c10.f48206g.getEditText(), c10.f48203d.getEditText());
        for (IndexedValue indexedValue : CollectionsKt.n1(o10)) {
            ...
            if (editText != null) {
                ...
                bq.a0.b(editText, new Function1() { // from class: pq.v0
                    @Override // kotlin.jvm.functions.Function1
            ...
            if (editText2 != null) {
                l(editText, new Function0() { // from class: pq.w0
        ...
        uiComponentHelper.d(new Function0() { // from class: pq.x0
            @Override // kotlin.jvm.functions.Function0
            public final Object invoke() {
                Unit i10;
                i10 = a1.i(sq.c.this, config);
                return i10;
            }
        });
    ...
    public static final Unit g(InputConfirmationCodeComponent inputConfirmationCodeComponent, sq.c cVar, List list, EditText editText, EditText editText2, EditText editText3, String newText) {
        Context context;
        Intrinsics.checkNotNullParameter(newText, "newText");
        gn.t b10 = inputConfirmationCodeComponent.b();
        rq.a aVar = rq.a.f47735a;
        ...
        if (newText.length() >= list.size()) {
            ...
            EditText editText4 = cVar.f48203d.getEditText();
            if (editText4 != null && (context = editText4.getContext()) != null) {
                bq.f.d(context);
            }
            EditText editText5 = cVar.f48203d.getEditText();
            if (editText5 != null) {
    ...
    public static final Unit i(sq.c cVar, InputConfirmationCode inputConfirmationCode) {
        ConstraintLayout root = cVar.getRoot();
        Intrinsics.checkNotNullExpressionValue(root, "getRoot(...)");
        Sequence<TextInputLayout> F = kotlin.sequences.k.F(androidx.core.view.o0.a(root), a.f42882d);
    ...
    private static final void l(final EditText editText, final Function0 function0) {
        if (editText != null) {
            editText.setOnKeyListener(new View.OnKeyListener() { // from class: pq.z0
    ...
    private static final void n(final EditText editText) {
        if (editText != null) {
            editText.setOnFocusChangeListener(new View.OnFocusChangeListener() { // from class: pq.y0
