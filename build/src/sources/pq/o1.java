...
public abstract class o1 {
    public static final void d(final TextInputLayout textInputLayout, y3 newState) {
        ...
        Object tag = textInputLayout.getTag(nq.e.f38820b0);
        ...
        textInputLayout.setTag(nq.e.f38820b0, newState);
        ...
        if (c10 != null) {
            ...
            lq.o.a(textInputLayout);
        }
        if (Intrinsics.areEqual(newState.e(), Boolean.TRUE) && (b10 = newState.b()) != null) {
            textInputLayout.setEndIconMode(-1);
            textInputLayout.setEndIconDrawable(androidx.core.content.a.e(textInputLayout.getContext(), nq.d.f38815d));
            textInputLayout.setEndIconContentDescription(textInputLayout.getContext().getString(tp.e.R));
            EditText editText3 = textInputLayout.getEditText();
            if (editText3 != null) {
                editText3.setTransformationMethod(new s4(b10));
            }
            textInputLayout.setEndIconOnClickListener(new View.OnClickListener() { // from class: pq.n1
        ...
        Object tag2 = textInputLayout.getTag(nq.e.f38834i0);
        ...
        if (b11 != null && !StringsKt.k0(b11)) {
            ...
            textInputLayout.setTag(nq.e.f38834i0, z3Var);
        }
    }
    ...
    public static final TextInputLayout g(InputMaskedTextComponent inputMaskedTextComponent, m5 uiComponentHelper, final InputMaskedText config) {
        ...
        final sq.u c10 = sq.u.c(uiComponentHelper.b());
        ...
        if (editText != null) {
            gn.u.b(inputMaskedTextComponent.b(), editText);
        }
        uiComponentHelper.d(new Function0() { // from class: pq.m1
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public static final Unit h(InputMaskedText inputMaskedText, sq.u uVar) {
