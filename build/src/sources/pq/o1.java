...
public final class o1 {
    ...
    private final ViewGroup f45419a;

    /* renamed from: b  reason: collision with root package name */
    private final Lazy f45420b;

    /* renamed from: c  reason: collision with root package name */
    private boolean f45421c;

    /* renamed from: d  reason: collision with root package name */
    private Function2 f45422d;

    public o1(ViewGroup contentView) {
        Intrinsics.checkNotNullParameter(contentView, "contentView");
        this.f45419a = contentView;
        this.f45420b = qr.l.a(new Function0() { // from class: pq.i1
    ...
    private final void g(ESignature.ESignatureComponentStyle eSignatureComponentStyle) {
        ...
        if (dialogTitleStyle != null) {
            TextView signatureLabel = i().f48058j;
        ...
        if (dialogTextStyle != null) {
            TextView signatureDescription = i().f48057i;
    ...
    private final qq.b i() {
        return (qq.b) this.f45420b.getValue();
    }

    /* JADX INFO: Access modifiers changed from: private */
    public static final qq.b j(o1 o1Var) {
        return qq.b.c(LayoutInflater.from(o1Var.f45419a.getContext()), o1Var.f45419a, true);
    }
    ...
    private final void k(StepStyles.UiStepStyle uiStepStyle, dn.a0 a0Var) {
        ...
        this.f45421c = true;
        final BottomSheetBehavior q02 = BottomSheetBehavior.q0(i().f48050b);
        ...
        FrameLayout bottomSheet = i().f48050b;
        Intrinsics.checkNotNullExpressionValue(bottomSheet, "bottomSheet");
        bq.b.b(q02, function0, bottomSheet, i().f48059k, i().f48055g);
        q02.L0(false);
        i().f48052d.setOnClickListener(new View.OnClickListener() { // from class: pq.l1
            @Override // android.view.View.OnClickListener
            public final void onClick(View view) {
                o1.m(BottomSheetBehavior.this, view);
            }
        });
        i().f48051c.setOnClickListener(new View.OnClickListener() { // from class: pq.m1
            @Override // android.view.View.OnClickListener
            public final void onClick(View view) {
                o1.n(o1.this, view);
            }
        });
        i().f48054f.setOnClickListener(new View.OnClickListener() { // from class: pq.n1
            @Override // android.view.View.OnClickListener
            public final void onClick(View view) {
                o1.o(o1.this, q02, view);
            }
        });
        ConstraintLayout signatureSheet = i().f48059k;
    ...
    public static final Unit l(o1 o1Var) {
        Function2 function2 = o1Var.f45422d;
        if (function2 != null) {
    ...
    public static final void o(o1 o1Var, BottomSheetBehavior bottomSheetBehavior, View view) {
        Function2 function2 = o1Var.f45422d;
        if (function2 != null) {
            function2.invoke(Boolean.FALSE, o1Var.i().f48056h.i());
        }
        o1Var.f45422d = null;
        bottomSheetBehavior.Y0(5);
    }
    ...
    public static final void q(o1 o1Var) {
        BottomSheetBehavior q02 = BottomSheetBehavior.q0(o1Var.i().f48050b);
        Intrinsics.checkNotNullExpressionValue(q02, "from(...)");
        q02.Y0(3);
    }

    public final boolean h() {
        if (!this.f45420b.isInitialized()) {
            return false;
        }
        BottomSheetBehavior q02 = BottomSheetBehavior.q0(i().f48050b);
        Intrinsics.checkNotNullExpressionValue(q02, "from(...)");
        if (q02.w0() == 5) {
            return false;
        }
    ...
    public final void p(ESignatureComponent component, ESignature config, StepStyles.UiStepStyle uiStepStyle, dn.a0 viewEnvironment, Function2 onComplete) {
        ...
        this.f45422d = onComplete;
        i().f48056h.f();
        TextView textView = i().f48058j;
