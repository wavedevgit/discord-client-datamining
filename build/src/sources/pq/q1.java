...
public abstract class q1 {
    public static final TextInputLayout b(com.withpersona.sdk2.inquiry.steps.ui.components.d dVar, m5 uiComponentHelper, final InputMultiSelect config) {
        ...
        final sq.r c10 = sq.r.c(uiComponentHelper.b());
        ...
        uiComponentHelper.d(new Function0() { // from class: pq.p1
    ...
    public static final Unit c(InputMultiSelect inputMultiSelect, sq.r rVar) {
        InputSelectComponentStyle styles = inputMultiSelect.getStyles();
        if (styles != null) {
            TextInputLayout listSelector = rVar.f48283b;
