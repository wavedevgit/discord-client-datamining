...
public abstract class r0 {
    public static final ConstraintLayout d(InputCheckboxComponent inputCheckboxComponent, m5 uiComponentHelper, InputCheckbox config) {
        ...
        sq.i c10 = sq.i.c(uiComponentHelper.b());
        Intrinsics.checkNotNullExpressionValue(c10, "inflate(...)");
        return e(inputCheckboxComponent, uiComponentHelper, c10, config);
    }

    public static final ConstraintLayout e(final InputCheckboxComponent inputCheckboxComponent, m5 uiComponentHelper, final sq.i binding, final InputCheckbox config) {
        String str;
        ...
        binding.f48246b.setChecked(inputCheckboxComponent.a().b());
        binding.f48246b.setClickable(false);
        binding.f48246b.setFocusable(false);
        ...
        if (str != null && !StringsKt.k0(str)) {
            binding.f48249e.setVisibility(0);
            TextView checkboxLabel = binding.f48249e;
            Intrinsics.checkNotNullExpressionValue(checkboxLabel, "checkboxLabel");
            qq.f.d(checkboxLabel, str);
        } else {
            binding.f48249e.setVisibility(8);
        }
        ...
        if (str2 != null && !StringsKt.k0(str2)) {
            binding.f48247c.setVisibility(0);
            TextView checkboxDescription = binding.f48247c;
            Intrinsics.checkNotNullExpressionValue(checkboxDescription, "checkboxDescription");
            qq.f.d(checkboxDescription, str2);
        } else {
            binding.f48247c.setVisibility(8);
        }
        binding.f48246b.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() { // from class: pq.o0
            @Override // android.widget.CompoundButton.OnCheckedChangeListener
            public final void onCheckedChanged(CompoundButton compoundButton, boolean z10) {
                r0.f(InputCheckboxComponent.this, compoundButton, z10);
            }
        });
        binding.getRoot().setOnClickListener(new View.OnClickListener() { // from class: pq.p0
        ...
        if (styles != null && (textColorHighlight = styles.getTextColorHighlight()) != null && (base = textColorHighlight.getBase()) != null && (base2 = base.getBase()) != null && (value = base2.getValue()) != null) {
            binding.f48246b.setButtonTintList(new ColorStateList(new int[][]{new int[]{-16842910}, new int[]{-16842912}, new int[]{16842912}}, new int[]{r1.c.l(bq.s.d(a10, bh.b.f6741j, null, false, 6, null), (int) (q1.j.h(a10.getResources(), bh.d.L) * ((float) SetSpanOperation.SPAN_MAX_PRIORITY))), bq.s.d(a10, bh.b.f6741j, null, false, 6, null), value.intValue()}));
        }
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public static final Unit h(InputCheckbox inputCheckbox, sq.i iVar) {
        ...
        if (styles != null && (textBasedStyle = styles.getTextBasedStyle()) != null) {
            TextView checkboxLabel = iVar.f48249e;
            Intrinsics.checkNotNullExpressionValue(checkboxLabel, "checkboxLabel");
        ...
        if (styles2 != null && (descriptionTextStyle = styles2.getDescriptionTextStyle()) != null) {
            TextView checkboxDescription = iVar.f48247c;
            Intrinsics.checkNotNullExpressionValue(checkboxDescription, "checkboxDescription");
        ...
        if (layoutParams != null) {
            ...
            TextView checkboxLabel3 = iVar.f48249e;
            Intrinsics.checkNotNullExpressionValue(checkboxLabel3, "checkboxLabel");
            int a10 = lq.p.a(checkboxLabel3);
            TextView checkboxDescription2 = iVar.f48247c;
            Intrinsics.checkNotNullExpressionValue(checkboxDescription2, "checkboxDescription");
            int a11 = a10 + lq.p.a(checkboxDescription2);
            if (a11 != 0) {
                if (a11 != 1) {
                    ((ViewGroup.MarginLayoutParams) layoutParams2).topMargin = (int) bq.h.a(4.0d);
                } else {
                    ((ViewGroup.MarginLayoutParams) layoutParams2).topMargin = (int) bq.h.a(0.0d);
                }
            }
