...
public abstract class r4 {
    ...
    private static final String i(String str, RemoteImage.RemoteImageComponentStyle remoteImageComponentStyle) {
        ...
        if (remoteImageComponentStyle != null && (originalFillColorValue2 = remoteImageComponentStyle.getOriginalFillColorValue()) != null) {
            ...
            if (newFillColorValue != null && bq.h.g(newFillColorValue.intValue()) != null) {
                str3 = StringsKt.J(str, bq.h.g(intValue), "{{ fill_color }}", false, 4, null);
            } else {
                str3 = str;
            }
            str2 = str3;
        ...
        if (remoteImageComponentStyle != null && (originalHighlightColorValue2 = remoteImageComponentStyle.getOriginalHighlightColorValue()) != null) {
            ...
            if (newHighlightColorValue != null && bq.h.g(newHighlightColorValue.intValue()) != null) {
                str2 = StringsKt.J(str2, bq.h.g(intValue2), "{{ highlight_color }}", false, 4, null);
            }
        }
        String str4 = str2;
        if (remoteImageComponentStyle != null && (originalBackgroundColorValue2 = remoteImageComponentStyle.getOriginalBackgroundColorValue()) != null) {
            ...
            if (newBackgroundColorValue != null && bq.h.g(newBackgroundColorValue.intValue()) != null) {
                str4 = StringsKt.J(str4, bq.h.g(intValue3), "{{ background_color }}", false, 4, null);
            }
        }
        String str5 = str4;
        if (remoteImageComponentStyle != null && (originalStrokeColorValue2 = remoteImageComponentStyle.getOriginalStrokeColorValue()) != null) {
            ...
            if (newStrokeColorValue != null && bq.h.g(newStrokeColorValue.intValue()) != null) {
                str5 = StringsKt.J(str5, bq.h.g(intValue4), "{{ stroke_color }}", false, 4, null);
            }
        }
        if (remoteImageComponentStyle != null && (originalFillColorValue = remoteImageComponentStyle.getOriginalFillColorValue()) != null) {
            ...
            if (newFillColorValue2 != null && (g13 = bq.h.g(newFillColorValue2.intValue())) != null) {
                str5 = w(str5, "{{ fill_color }}", g13, bq.h.g(intValue5));
            }
        }
        if (remoteImageComponentStyle != null && (originalHighlightColorValue = remoteImageComponentStyle.getOriginalHighlightColorValue()) != null) {
            ...
            if (newHighlightColorValue2 != null && (g12 = bq.h.g(newHighlightColorValue2.intValue())) != null) {
                str5 = w(str5, "{{ highlight_color }}", g12, bq.h.g(intValue6));
            }
        }
        if (remoteImageComponentStyle != null && (originalBackgroundColorValue = remoteImageComponentStyle.getOriginalBackgroundColorValue()) != null) {
            ...
            if (newBackgroundColorValue2 != null && (g11 = bq.h.g(newBackgroundColorValue2.intValue())) != null) {
                str5 = w(str5, "{{ background_color }}", g11, bq.h.g(intValue7));
            }
        }
        if (remoteImageComponentStyle != null && (originalStrokeColorValue = remoteImageComponentStyle.getOriginalStrokeColorValue()) != null) {
            ...
            if (newStrokeColorValue2 != null && (g10 = bq.h.g(newStrokeColorValue2.intValue())) != null) {
                return w(str5, "{{ stroke_color }}", g10, bq.h.g(intValue8));
            }
        }
        return str5;
    }
    ...
    private static final void k(final ImageView imageView, String str, final RemoteImage.RemoteImageComponentStyle remoteImageComponentStyle) {
        ...
        r10.e(new k.a() { // from class: pq.p4
            @Override // x4.k.a
    ...
    public static final x4.k l(RemoteImage.RemoteImageComponentStyle remoteImageComponentStyle, ImageView imageView, a5.l result, g5.m options, v4.h hVar) {
        ...
        byte[] o12 = result.c().h().o1();
        Charset charset = Charsets.UTF_8;
        byte[] bytes = i(new String(o12, charset), remoteImageComponentStyle).getBytes(charset);
    ...
    private static final View n(i4 i4Var, m5 m5Var, final RemoteImage remoteImage) {
        ...
        if (str != null && contentType != null) {
            ...
            if (i10 != 1) {
                if (i10 != 2) {
                    if (i10 == 3) {
                        g10 = bq.s.g(a10, str, bq.t.f7440i);
                        if (g10 != null) {
                            booleanRef.element = true;
                        } else {
                            g10 = bq.s.g(a10, str, bq.t.f7439e);
                        }
                    } else {
                        throw new as.p();
                    }
            ...
            if (g10 != null) {
                ...
                if (i11 != 1) {
                    if (i11 != 2) {
                        if (i11 == 3) {
                            final dq.f c10 = dq.f.c(m5Var.b());
                            m5Var.d(new Function0() { // from class: pq.o4
                                @Override // kotlin.jvm.functions.Function0
                                public final Object invoke() {
                                    Unit q10;
                                    q10 = r4.q(dq.f.this, remoteImage, booleanRef, a10, intValue);
                                    return q10;
                                }
                            });
                            eVar = c10;
                        ...
                        final dq.f c11 = dq.f.c(m5Var.b());
                        m5Var.d(new Function0() { // from class: pq.n4
                            @Override // kotlin.jvm.functions.Function0
                            public final Object invoke() {
                                Unit p10;
                                p10 = r4.p(dq.f.this, remoteImage, intValue);
                                return p10;
                            }
                        });
                        eVar = c11;
                    ...
                    final dq.e c12 = dq.e.c(m5Var.b());
                    m5Var.d(new Function0() { // from class: pq.m4
                        @Override // kotlin.jvm.functions.Function0
                        public final Object invoke() {
                            Unit o10;
                            o10 = r4.o(dq.e.this, remoteImage);
                            return o10;
                        }
                    });
                    c12.f21859b.setAnimation(intValue);
                    eVar = c12;
                }
                return eVar.getRoot();
            }
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public static final Unit o(dq.e eVar, RemoteImage remoteImage) {
        ThemeableLottieAnimationView lottieView = eVar.f21859b;
        Intrinsics.checkNotNullExpressionValue(lottieView, "lottieView");
        uq.g.f(lottieView, remoteImage);
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public static final Unit p(dq.f fVar, RemoteImage remoteImage, int i10) {
        ImageView imageView = fVar.f21861b;
        Intrinsics.checkNotNullExpressionValue(imageView, "imageView");
        uq.g.f(imageView, remoteImage);
        fVar.f21861b.setImageResource(i10);
        fVar.f21861b.setScaleType(ImageView.ScaleType.FIT_XY);
        fVar.f21861b.setAdjustViewBounds(true);
        return Unit.f31987a;
    }

    /* JADX INFO: Access modifiers changed from: private */
    public static final Unit q(final dq.f fVar, final RemoteImage remoteImage, Ref.BooleanRef booleanRef, Context context, int i10) {
        ImageView imageView = fVar.f21861b;
        Intrinsics.checkNotNullExpressionValue(imageView, "imageView");
        uq.g.f(imageView, remoteImage);
        if (booleanRef.element) {
            Context context2 = fVar.f21861b.getContext();
            Intrinsics.checkNotNullExpressionValue(context2, "getContext(...)");
            v4.h d10 = new h.a(context2).d();
            String resourcePackageName = context.getResources().getResourcePackageName(i10);
            String lowerCase = bq.t.f7440i.toString().toLowerCase(Locale.ROOT);
            Intrinsics.checkNotNullExpressionValue(lowerCase, "toLowerCase(...)");
            String resourceEntryName = context.getResources().getResourceEntryName(i10);
            Uri parse = Uri.parse("android.resource://" + resourcePackageName + "/" + lowerCase + "/" + resourceEntryName);
            ImageView imageView2 = fVar.f21861b;
            Intrinsics.checkNotNullExpressionValue(imageView2, "imageView");
            h.a r10 = new h.a(imageView2.getContext()).d(parse).r(imageView2);
            r10.e(new k.a() { // from class: pq.q4
                @Override // x4.k.a
                public final x4.k a(a5.l lVar, g5.m mVar, v4.h hVar) {
                    x4.k r11;
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public static final x4.k r(RemoteImage remoteImage, dq.f fVar, a5.l result, g5.m options, v4.h hVar) {
        Intrinsics.checkNotNullParameter(result, "result");
        Intrinsics.checkNotNullParameter(options, "options");
        Intrinsics.checkNotNullParameter(hVar, "<unused var>");
        byte[] o12 = result.c().h().o1();
        Charset charset = Charsets.UTF_8;
        byte[] bytes = i(new String(o12, charset), remoteImage.getStyles()).getBytes(charset);
        Intrinsics.checkNotNullExpressionValue(bytes, "getBytes(...)");
        Buffer write = new Buffer().write(bytes);
        Context context = fVar.f21861b.getContext();
        Intrinsics.checkNotNullExpressionValue(context, "getContext(...)");
        return new x4.z(x4.u.f(write, context), options, false, 4, null);
    }
    ...
    private static final View s(i4 i4Var, m5 m5Var, final RemoteImage remoteImage) {
        ...
        if (contentType == null) {
            ...
            i10 = a.f43089a[contentType.ordinal()];
        }
        if (i10 != 1) {
            if (i10 != 3) {
                final dq.f c10 = dq.f.c(m5Var.b());
                m5Var.d(new Function0() { // from class: pq.l4
                    @Override // kotlin.jvm.functions.Function0
                    public final Object invoke() {
                        Unit v10;
                        v10 = r4.v(dq.f.this, remoteImage, attributes);
                        return v10;
                    }
                });
                eVar = c10;
                ...
                final dq.f c11 = dq.f.c(m5Var.b());
                m5Var.d(new Function0() { // from class: pq.j4
                    @Override // kotlin.jvm.functions.Function0
                    public final Object invoke() {
                        Unit t10;
                        t10 = r4.t(dq.f.this, remoteImage, attributes);
                        return t10;
                    }
                });
                eVar = c11;
            ...
            final dq.e c12 = dq.e.c(m5Var.b());
            m5Var.d(new Function0() { // from class: pq.k4
                @Override // kotlin.jvm.functions.Function0
                public final Object invoke() {
                    Unit u10;
                    u10 = r4.u(dq.e.this, remoteImage);
                    return u10;
                }
            });
            c12.f21859b.J(attributes.getUrl());
            eVar = c12;
        }
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public static final Unit t(dq.f fVar, RemoteImage remoteImage, RemoteImage.Attributes attributes) {
        ImageView imageView = fVar.f21861b;
        Intrinsics.checkNotNullExpressionValue(imageView, "imageView");
        uq.g.f(imageView, remoteImage);
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public static final Unit u(dq.e eVar, RemoteImage remoteImage) {
        ThemeableLottieAnimationView lottieView = eVar.f21859b;
        Intrinsics.checkNotNullExpressionValue(lottieView, "lottieView");
        uq.g.f(lottieView, remoteImage);
        eVar.f21859b.setRepeatMode(1);
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public static final Unit v(dq.f fVar, RemoteImage remoteImage, RemoteImage.Attributes attributes) {
        String str;
        ImageView imageView = fVar.f21861b;
        Intrinsics.checkNotNullExpressionValue(imageView, "imageView");
        uq.g.f(imageView, remoteImage);
