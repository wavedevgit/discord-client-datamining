...
public final class o implements h {
    ...
    private final JsonLogicBoolean f43039e;

    /* renamed from: i  reason: collision with root package name */
    private final JsonLogicBoolean f43040i;

    /* renamed from: o  reason: collision with root package name */
    private final String f43041o;

    /* renamed from: p  reason: collision with root package name */
    private final Integer f43042p;

    /* renamed from: q  reason: collision with root package name */
    private final List f43043q;
    ...
    public o(String name, JsonLogicBoolean jsonLogicBoolean, JsonLogicBoolean jsonLogicBoolean2, String str, Integer num) {
        ...
        this.f43038d = name;
        this.f43039e = jsonLogicBoolean;
        this.f43040i = jsonLogicBoolean2;
        this.f43041o = str;
        this.f43042p = num;
        this.f43043q = new ArrayList();
    }
    ...
    public boolean equals(Object obj) {
        ...
        o oVar = (o) obj;
        if (Intrinsics.areEqual(this.f43038d, oVar.f43038d) && Intrinsics.areEqual(this.f43039e, oVar.f43039e) && Intrinsics.areEqual(this.f43040i, oVar.f43040i) && Intrinsics.areEqual(this.f43041o, oVar.f43041o) && Intrinsics.areEqual(this.f43042p, oVar.f43042p)) {
            return true;
        }
        return false;
    }
    ...
    public int hashCode() {
        ...
        int hashCode2;
        int hashCode3;
        int hashCode4 = this.f43038d.hashCode() * 31;
        JsonLogicBoolean jsonLogicBoolean = this.f43039e;
        int i10 = 0;
        ...
        JsonLogicBoolean jsonLogicBoolean2 = this.f43040i;
    ...
    public final void writeToParcel(Parcel dest, int i10) {
        ...
        dest.writeString(this.f43038d);
        dest.writeParcelable(this.f43039e, i10);
        dest.writeParcelable(this.f43040i, i10);
        dest.writeString(this.f43041o);
        Integer num = this.f43042p;
        if (num == null) {
            dest.writeInt(0);
            return;
