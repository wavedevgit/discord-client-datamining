...
public abstract class l {
    public static final ConstraintLayout b(ClickableStackComponent clickableStackComponent, m5 uiComponentHelper, List componentViews, List children, ClickableStack config) {
        ...
        final sq.e c10 = sq.e.c(uiComponentHelper.b());
        ...
        if (styles != null) {
            uiComponentHelper.d(new Function0() { // from class: pq.k
                @Override // kotlin.jvm.functions.Function0
                public final Object invoke() {
                    Unit c11;
                    c11 = l.c(sq.e.this, styles);
                    return c11;
                }
            });
        }
    ...
    public static final Unit c(sq.e eVar, ClickableStack.ClickableStackComponentStyle clickableStackComponentStyle) {
        ConstraintLayout root = eVar.getRoot();
        Intrinsics.checkNotNullExpressionValue(root, "getRoot(...)");
        uq.q.b(root, clickableStackComponentStyle);
        return Unit.f31988a;
    }
}
