...
public final class b4 implements Parcelable {
    ...
    public boolean equals(Object obj) {
        ...
        b4 b4Var = (b4) obj;
        if (Intrinsics.areEqual(this.f42893d, b4Var.f42893d) && Intrinsics.areEqual(this.f42894e, b4Var.f42894e)) {
            return true;
        }
        return false;
    }
    ...
    public int hashCode() {
        return (this.f42893d.hashCode() * 31) + this.f42894e.hashCode();
    }
    ...
    public final void writeToParcel(Parcel dest, int i10) {
        ...
        dest.writeString(this.f42893d);
        dest.writeString(this.f42894e);
    }
}
