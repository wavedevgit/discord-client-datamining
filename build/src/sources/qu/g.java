...
public final class g {
    ...
    private final boolean f48263a;

    /* renamed from: b  reason: collision with root package name */
    private final boolean f48264b;

    /* renamed from: c  reason: collision with root package name */
    private final c0 f48265c;

    /* renamed from: d  reason: collision with root package name */
    private final Long f48266d;

    /* renamed from: e  reason: collision with root package name */
    private final Long f48267e;

    /* renamed from: f  reason: collision with root package name */
    private final Long f48268f;

    /* renamed from: g  reason: collision with root package name */
    private final Long f48269g;

    /* renamed from: h  reason: collision with root package name */
    private final Map f48270h;
    ...
    public String toString() {
        ...
        if (this.f48266d != null) {
            arrayList.add("byteCount=" + this.f48266d);
        }
        if (this.f48267e != null) {
            arrayList.add("createdAt=" + this.f48267e);
        }
        if (this.f48268f != null) {
            arrayList.add("lastModifiedAt=" + this.f48268f);
        }
        if (this.f48269g != null) {
            arrayList.add("lastAccessedAt=" + this.f48269g);
        }
        if (!this.f48270h.isEmpty()) {
            arrayList.add("extras=" + this.f48270h);
        }
