...
public class c {
    ...
    private File a() {
        if (this.f24970a == null) {
            synchronized (this) {
                try {
                    if (this.f24970a == null) {
                        File filesDir = this.f24971b.j().getFilesDir();
                        this.f24970a = new File(filesDir, "PersistedInstallation." + this.f24971b.n() + ".json");
                    }
                } finally {
                }
            }
    ...
    public d b(d dVar) {
        ...
        try {
            ...
            createTempFile = File.createTempFile("PersistedInstallation", "tmp", this.f24971b.j().getFilesDir());
