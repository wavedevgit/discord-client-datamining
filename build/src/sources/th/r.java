...
public class r {
    ...
    public static class b {
        ...
        public int a(int i10) {
            c cVar = this.f48930a;
            if (cVar == c.PERCENT) {
                return (int) (this.f48931b * i10);
            }
            if (cVar == c.PIXELS) {
                return (int) this.f48931b;
            }
            return 0;
        }
    }
    ...
    private void a(int[] iArr, a aVar) {
        ...
        if (i10 >= this.f48927c.length) {
            f(i10, i10 + 10);
        }
        int[][] iArr2 = this.f48927c;
        int i11 = this.f48925a;
        iArr2[i11] = iArr;
        this.f48928d[i11] = aVar;
        this.f48925a = i11 + 1;
    }
    ...
    private void f(int i10, int i11) {
        ...
        System.arraycopy(this.f48927c, 0, iArr, 0, i10);
        this.f48927c = iArr;
        a[] aVarArr = new a[i11];
        System.arraycopy(this.f48928d, 0, aVarArr, 0, i10);
        this.f48928d = aVarArr;
    }

    private int g(int[] iArr) {
        int[][] iArr2 = this.f48927c;
        for (int i10 = 0; i10 < this.f48925a; i10++) {
    ...
    public int c(int i10) {
        float max;
        int i11 = -i10;
        for (int i12 = 0; i12 < this.f48925a; i12++) {
            b bVar = this.f48928d[i12].f48929a;
            c cVar = bVar.f48930a;
            if (cVar == c.PIXELS) {
                max = Math.max(i11, bVar.f48931b);
            } else if (cVar == c.PERCENT) {
                max = Math.max(i11, i10 * bVar.f48931b);
            }
            i11 = (int) max;
        }
        return i11;
