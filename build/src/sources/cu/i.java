...
public final class i implements CookieJar {
    ...
    private final CookieHandler f20274c;

    public i(CookieHandler cookieHandler) {
        Intrinsics.checkNotNullParameter(cookieHandler, "cookieHandler");
        this.f20274c = cookieHandler;
    }
    ...
    private final List a(HttpUrl httpUrl, String str) {
        ...
        int i10 = 0;
        while (i10 < length) {
            int q10 = du.e.q(str, ";,", i10, length);
            int p10 = du.e.p(str, '=', i10, q10);
            String Z = du.e.Z(str, i10, p10);
            if (!StringsKt.P(Z, "$", false, 2, null)) {
                if (p10 < q10) {
                    str2 = du.e.Z(str, p10 + 1, q10);
                } else {
                    str2 = "";
                }
    ...
    public List loadForRequest(HttpUrl url) {
        ...
        try {
            Map<String, List<String>> cookieHeaders = this.f20274c.get(url.t(), o0.i());
    ...
    public void saveFromResponse(HttpUrl url, List cookies) {
        ...
        while (it.hasNext()) {
            arrayList.add(du.b.a((Cookie) it.next(), true));
        }
        try {
            this.f20274c.put(url.t(), o0.f(v.a("Set-Cookie", arrayList)));
        } catch (IOException e10) {
            mu.h g10 = mu.h.f37655a.g();
            StringBuilder sb2 = new StringBuilder();
