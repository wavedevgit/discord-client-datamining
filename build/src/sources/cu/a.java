...
public final class a implements Interceptor {
    ...
    private final CookieJar f19857a;

    public a(CookieJar cookieJar) {
        Intrinsics.checkNotNullParameter(cookieJar, "cookieJar");
        this.f19857a = cookieJar;
    }
    ...
    public Response intercept(Interceptor.Chain chain) {
        ...
        boolean z10 = false;
        if (h10.f("Host") == null) {
            k10.e("Host", xt.e.U(h10.n(), false, 1, null));
        }
        ...
        List loadForRequest = this.f19857a.loadForRequest(h10.n());
