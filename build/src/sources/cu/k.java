...
public final class k {
    ...
    static {
        ...
        for (int i10 = 0; i10 < length; i10++) {
            f21010a.a(i10, f21011b[i10], f21012c[i10]);
        }
    }
    ...
    public final void b(BufferedSource source, long j10, BufferedSink sink) {
        ...
        for (long j11 = 0; j11 < j10; j11++) {
            i10 = (i10 << 8) | vt.e.d(source.readByte(), SetSpanOperation.SPAN_MAX_PRIORITY);
            i11 += 8;
            while (i11 >= 8) {
    ...
    public final void c(ByteString source, BufferedSink sink) {
        ...
        for (int i11 = 0; i11 < G; i11++) {
            int d10 = vt.e.d(source.k(i11), SetSpanOperation.SPAN_MAX_PRIORITY);
            int i12 = f21011b[d10];
            byte b10 = f21012c[d10];
            j10 = (j10 << b10) | i12;
            i10 += b10;
            while (i10 >= 8) {
                i10 = (i10 == true ? 1 : 0) - 8;
    ...
    public final int d(ByteString bytes) {
        ...
        for (int i10 = 0; i10 < G; i10++) {
            j10 += f21012c[vt.e.d(bytes.k(i10), SetSpanOperation.SPAN_MAX_PRIORITY)];
        }
        return (int) ((j10 + 7) >> 3);
    }
    ...
    public static final class a {
        ...
        public a() {
            this.f21014a = new a[IntBufferBatchMountItem.INSTRUCTION_UPDATE_EVENT_EMITTER];
            this.f21015b = 0;
            this.f21016c = 0;
        }
