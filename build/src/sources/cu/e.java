...
public abstract class e {
    ...
    private static final ByteString f19862a;

    /* renamed from: b  reason: collision with root package name */
    private static final ByteString f19863b;
        ...
        for (int i10 = 0; i10 < size; i10++) {
            if (StringsKt.A(headerName, headers.e(i10), true)) {
                try {
                    ...
                    gu.h.f26650a.g().k("Unable to parse challenge", 5, e10);
                }
            }
        }
        return arrayList;
    ...
    public static final boolean b(Response response) {
        ...
        int L = response.L();
        if (((L >= 100 && L < 200) || L == 204 || L == 304) && xt.e.v(response) == -1 && !StringsKt.A("chunked", Response.D0(response, "Transfer-Encoding", null, 2, null), true)) {
            return false;
        }
        return true;
    }
    ...
    */
    private static final void c(okio.Buffer r7, java.util.List r8) {
        ...
        Lbc:
            ...
            goto L2
        */
        throw new UnsupportedOperationException("Method not decompiled: cu.e.c(okio.Buffer, java.util.List):void");
    }
    ...
    private static final String e(Buffer buffer) {
        long c02 = buffer.c0(f19863b);
        if (c02 == -1) {
            c02 = buffer.size();
        }
        if (c02 != 0) {
            return buffer.c1(c02);
        }
        return null;
    }
    ...
    public static final void f(CookieJar cookieJar, HttpUrl url, Headers headers) {
        ...
        if (cookieJar != CookieJar.f43980b) {
            List e10 = Cookie.f43956j.e(url, headers);
            if (e10.isEmpty()) {
                return;
            }
