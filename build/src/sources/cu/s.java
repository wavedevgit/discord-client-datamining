...
public final class s {
    ...
    public s(String[] strArr) {
        this.f21209a = Collections.unmodifiableList(Arrays.asList(strArr));
    }
        ...
        while (i12 < enumArr.length) {
            ...
            if (isEmpty) {
                if (i12 >= size) {
                    ...
                    str3 = (String) this.f21209a.get(i12);
                }
            }
    ...
    public Enum c(CharSequence charSequence, ParsePosition parsePosition, Class cls, bu.d dVar) {
        bu.c cVar = a.f21117i;
        Boolean bool = Boolean.TRUE;
        return e(charSequence, parsePosition, cls, ((Boolean) dVar.b(cVar, bool)).booleanValue(), ((Boolean) dVar.b(a.f21118j, Boolean.FALSE)).booleanValue(), ((Boolean) dVar.b(a.f21119k, bool)).booleanValue());
    }
    ...
    public String f(Enum r32) {
        ...
        if (this.f21209a.size() <= ordinal) {
            return r32.name();
        }
        return (String) this.f21209a.get(ordinal);
    }
    ...
    public String toString() {
        ...
        for (int i10 = 0; i10 < size; i10++) {
            ...
            sb2.append((String) this.f21209a.get(i10));
        }
        sb2.append('}');
        return sb2.toString();
    }
