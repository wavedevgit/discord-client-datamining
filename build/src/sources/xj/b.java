...
public abstract class b {
    ...
    private static final SparseArray f53877a;

    /* renamed from: b  reason: collision with root package name */
    private static final SparseArray f53878b;

    /* renamed from: c  reason: collision with root package name */
    static final AtomicReference f53879c;

    /* renamed from: d  reason: collision with root package name */
    private static final Map f53880d;

    static {
        SparseArray sparseArray = new SparseArray();
        f53877a = sparseArray;
        SparseArray sparseArray2 = new SparseArray();
        f53878b = sparseArray2;
        f53879c = new AtomicReference();
    ...
    public static wj c(uj.b bVar) {
        int a10 = bVar.a();
        f1 f1Var = new f1();
        if (a10 == 0) {
            f1Var.f(f53880d.values());
        } else {
            for (Map.Entry entry : f53880d.entrySet()) {
    ...
    public static void e(nk nkVar, final xe xeVar) {
        nkVar.f(new mk() { // from class: xj.a
            @Override // mg.mk
            public final ck zza() {
                we weVar;
                ze zeVar = new ze();
    ...
    public static boolean f() {
        AtomicReference atomicReference = f53879c;
        if (atomicReference.get() != null) {
            return ((Boolean) atomicReference.get()).booleanValue();
        }
        boolean b10 = n.b(sj.i.c().b());
