...
public final class e {
    ...
    public static final class a extends k implements Function2 {
        ...
        final /* synthetic */ Context f30270e;

        /* renamed from: i  reason: collision with root package name */
        final /* synthetic */ Uri f30271i;

        /* renamed from: o  reason: collision with root package name */
        final /* synthetic */ f f30272o;

        /* renamed from: p  reason: collision with root package name */
        final /* synthetic */ e f30273p;
        ...
        public final Continuation create(Object obj, Continuation continuation) {
            return new a(this.f30270e, this.f30271i, this.f30272o, this.f30273p, continuation);
        }
        ...
        public final Object invokeSuspend(Object obj) {
            ...
            if (this.f30269d == 0) {
                kotlin.c.b(obj);
                ContentResolver contentResolver = this.f30270e.getContentResolver();
                jm.a aVar = new jm.a(this.f30271i);
                aVar.h(contentResolver.getType(this.f30271i));
                if (this.f30272o.b()) {
                    aVar.j(contentResolver.getStreamTypes(this.f30271i, "*/*"));
                }
                if (this.f30272o.h()) {
                    try {
                        this.f30270e.getContentResolver().takePersistableUriPermission(this.f30271i, 3);
                        aVar.a(this.f30271i);
                    } catch (Exception e10) {
                ...
                if (this.f30272o.b() && DocumentsContract.isDocumentUri(this.f30270e, this.f30271i)) {
                    z10 = true;
                } else {
                    z10 = false;
                }
    ...
    static final class b extends k implements Function2 {
        ...
        /* renamed from: p  reason: collision with root package name */
        final /* synthetic */ List f30278p;

        /* renamed from: q  reason: collision with root package name */
        final /* synthetic */ e f30279q;

        /* renamed from: r  reason: collision with root package name */
        final /* synthetic */ Context f30280r;

        /* renamed from: s  reason: collision with root package name */
        final /* synthetic */ f f30281s;
        ...
        b(List list, e eVar, Context context, f fVar, Continuation continuation) {
            ...
            this.f30278p = list;
            this.f30279q = eVar;
            this.f30280r = context;
            this.f30281s = fVar;
        }

        @Override // kotlin.coroutines.jvm.internal.a
        public final Continuation create(Object obj, Continuation continuation) {
            return new b(this.f30278p, this.f30279q, this.f30280r, this.f30281s, continuation);
        }
        ...
        */
        public final java.lang.Object invokeSuspend(java.lang.Object r8) {
            /*
                ...
                if (r1 == 0) goto L23
                if (r1 != r2) goto L1b
                java.lang.Object r1 = r7.f30276i
                android.net.Uri r1 = (android.net.Uri) r1
                java.lang.Object r3 = r7.f30275e
                java.util.Iterator r3 = (java.util.Iterator) r3
                java.lang.Object r4 = r7.f30274d
            ...
            L37:
                ...
                android.net.Uri r1 = (android.net.Uri) r1
                jm.e r8 = r7.f30279q
                android.content.Context r5 = r7.f30280r
                jm.f r6 = r7.f30281s
                r7.f30274d = r4
                r7.f30275e = r3
                r7.f30276i = r1
                r7.f30277o = r2
                java.lang.Object r8 = jm.e.a(r8, r5, r1, r6, r7)
                if (r8 != r0) goto L59
                return r0
            L59:
                jm.a r8 = (jm.a) r8
                jm.e r5 = r7.f30279q
                java.util.Map r5 = jm.e.b(r5)
            ...
            L70:
                return r4
            */
            throw new UnsupportedOperationException("Method not decompiled: jm.e.b.invokeSuspend(java.lang.Object):java.lang.Object");
        }
    ...
    public final Object d(Context context, Uri uri, f fVar, Continuation continuation) {
        return ps.g.g(m0.b(), new a(context, uri, fVar, this, null), continuation);
    }

    public final Object e(Context context, List list, f fVar, Continuation continuation) {
        return ps.g.g(m0.b(), new b(list, this, context, fVar, null), continuation);
    }

    public final void f(ContentResolver contentResolver, jm.a metadataBuilder, boolean z10) {
        int i10;
