...
public abstract class i {
    ...
    private static final int[] f31039a = new int[2];
    ...
    public static final void a(View view, Rect rect) {
        ...
        nm.a.f(nm.a.f41373a, "View.copyBoundsInWindow", "Can not copy bounds as view is not attached to window", null, 4, null);
    }
