...
public abstract class f {
    ...
    static final class a extends kotlin.coroutines.jvm.internal.k implements Function2 {
        ...
        final /* synthetic */ dn.m f7733i;

        /* renamed from: o  reason: collision with root package name */
        final /* synthetic */ MutableStateFlow f7734o;

        /* renamed from: p  reason: collision with root package name */
        final /* synthetic */ Function2 f7735p;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        a(dn.m mVar, MutableStateFlow mutableStateFlow, Function2 function2, Continuation continuation) {
            super(2, continuation);
            this.f7733i = mVar;
            this.f7734o = mutableStateFlow;
            this.f7735p = function2;
        }

        @Override // kotlin.coroutines.jvm.internal.a
        public final Continuation create(Object obj, Continuation continuation) {
            a aVar = new a(this.f7733i, this.f7734o, this.f7735p, continuation);
            aVar.f7732e = obj;
            return aVar;
        }
        ...
        */
        public final java.lang.Object invokeSuspend(java.lang.Object r8) {
            ...
            L43:
                ...
                return r8
            L4e:
                kotlinx.coroutines.flow.MutableStateFlow r4 = r7.f7734o
                dn.m r5 = r7.f7733i
                cn.g r5 = r5.g()
                r4.setValue(r5)
                if (r8 != 0) goto L5d
            L5b:
                ...
                goto L2d
            L5d:
                kotlin.jvm.functions.Function2 r4 = r7.f7735p
    ...
    public static final j0 a(q workflow, CoroutineScope scope, j0 props, m mVar, List interceptors, Function2 onOutput) {
        ...
        dn.m mVar2 = new dn.m(scope, workflow, props, mVar, dn.c.a(interceptors));
        CancellationException cancellationException = null;
        try {
            MutableStateFlow a10 = l0.a(mVar2.g());
            ps.i.d(scope, null, null, new a(mVar2, a10, onOutput, null), 3, null);
            return a10;
        } catch (Throwable th2) {
