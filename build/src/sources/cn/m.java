...
public final class m extends d {
    ...
    private Handler O;
    private Runnable P = new Runnable() { // from class: cn.l
    ...
    public static final class b extends d.c {
        ...
        private final Class f8611b = m.class;

        /* renamed from: c  reason: collision with root package name */
        private final String f8612c = "HoverGestureHandler";
        ...
        @Override // cn.d.c
        /* renamed from: h */
        public dn.c c(m handler) {
            Intrinsics.checkNotNullParameter(handler, "handler");
            return new dn.c(handler);
        }
    }
