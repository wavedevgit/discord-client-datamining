...
public final class d extends BaseReactPackage implements ViewManagerOnDemandReactPackage {
    ...
    private final Lazy f8350a = l.b(new Function0() { // from class: cn.a
    ...
    private final Map d() {
        return (Map) this.f8350a.getValue();
    }

    /* JADX INFO: Access modifiers changed from: private */
    public static final Map e() {
        return o0.f(v.a(RNGestureHandlerButtonViewManager.REACT_CLASS, ModuleSpec.Companion.viewManagerSpec(new Provider() { // from class: cn.c
    ...
    public ReactModuleInfoProvider getReactModuleInfoProvider() {
        try {
            ...
            return new ReactModuleInfoProvider() { // from class: cn.b
