...
public abstract class g extends FrameLayout {
    ...
    private final WorkflowViewStub f7360d;

    /* renamed from: e  reason: collision with root package name */
    private List f7361e;

    /* renamed from: i  reason: collision with root package name */
    private final Lazy f7362i;

    /* renamed from: o  reason: collision with root package name */
    private final zm.f f7363o;
    ...
    public static final class b implements Parcelable {
        ...
        public boolean equals(Object obj) {
            ...
            b bVar = (b) obj;
            if (Intrinsics.areEqual(this.f7369d, bVar.f7369d) && Intrinsics.areEqual(this.f7370e, bVar.f7370e)) {
                return true;
            }
            return false;
        }
        ...
        public int hashCode() {
            return (this.f7369d.hashCode() * 31) + this.f7370e.hashCode();
        }

        public String toString() {
            return "KeyAndBundle(compatibilityKey=" + this.f7369d + ", bundle=" + this.f7370e + ')';
        }
        ...
        public void writeToParcel(Parcel parcel, int i10) {
            ...
            parcel.writeBundle(this.f7370e);
        }
    }
    ...
    public static final class f implements View.OnAttachStateChangeListener {
        ...
        /* renamed from: d  reason: collision with root package name */
        private final a f7374d;

        /* renamed from: e  reason: collision with root package name */
        private Lifecycle f7375e;

        /* renamed from: i  reason: collision with root package name */
        final /* synthetic */ a f7376i;

        /* renamed from: o  reason: collision with root package name */
        final /* synthetic */ g f7377o;
        ...
        public void onViewAttachedToWindow(View v10) {
            ...
            Lifecycle lifecycle = this.f7377o.getParentLifecycleOwner().getLifecycle();
            lifecycle.a(a());
            this.f7375e = lifecycle;
        }

        @Override // android.view.View.OnAttachStateChangeListener
        public void onViewDetachedFromWindow(View v10) {
            Intrinsics.checkNotNullParameter(v10, "v");
            Lifecycle lifecycle = this.f7375e;
            if (lifecycle != null) {
                lifecycle.d(this.f7374d);
            }
            this.f7375e = null;
        }
    }
    ...
    public g(Context context, AttributeSet attributeSet, int i10, int i11) {
        ...
        this.f7360d = workflowViewStub;
        this.f7361e = CollectionsKt.l();
        this.f7362i = l.b(o.f37121i, new d());
        this.f7363o = new zm.f();
    }

    /* JADX INFO: Access modifiers changed from: private */
    public final zm.d getParentLifecycleOwner() {
        return (zm.d) this.f7362i.getValue();
    }

    protected abstract a b(Object obj, a0 a0Var);

    /* JADX INFO: Access modifiers changed from: protected */
    public final void c(cn.f newScreen, a0 viewEnvironment) {
        a0 a0Var;
        a b10;
        View b11;
        Intrinsics.checkNotNullParameter(newScreen, "newScreen");
        Intrinsics.checkNotNullParameter(viewEnvironment, "viewEnvironment");
        this.f7360d.c(newScreen.b(), viewEnvironment);
        ArrayList<a> arrayList = new ArrayList();
        int i10 = 0;
        for (Object obj : newScreen.a()) {
            int i11 = i10 + 1;
            if (i10 < this.f7361e.size() && ym.h.a(((a) this.f7361e.get(i10)).f(), obj)) {
                a0Var = viewEnvironment;
                b10 = a.b((a) this.f7361e.get(i10), obj, a0Var, null, null, 12, null);
                d(b10);
            } else {
                a0Var = viewEnvironment;
                b10 = b(obj, a0Var);
        ...
        for (a aVar : CollectionsKt.H0(this.f7361e, arrayList)) {
            aVar.c();
        }
        zm.f fVar = this.f7363o;
    ...
    protected void onAttachedToWindow() {
        ...
        this.f7363o.f(g.a.b(aVar, c10, null, 2, null), c11);
    }
    ...
    protected void onRestoreInstanceState(Parcelable state) {
        ...
        if (cVar != null) {
            if (cVar.a().size() == this.f7361e.size()) {
                List a10 = cVar.a();
                List list = this.f7361e;
    ...
    public static final class c extends View.BaseSavedState {
        ...
        public void writeToParcel(Parcel out, int i10) {
            ...
            out.writeTypedList(this.f7371d);
        }
    ...
    public static final class a {
        ...
        private final a0 f7365b;

        /* renamed from: c  reason: collision with root package name */
        private final Dialog f7366c;
        ...
        public a(Object modalRendering, a0 viewEnvironment, Dialog dialog, Object obj) {
            ...
            this.f7364a = modalRendering;
            this.f7365b = viewEnvironment;
            this.f7366c = dialog;
            this.f7367d = obj;
        }
        ...
        public boolean equals(Object obj) {
            ...
            if (obj != null) {
                if (Intrinsics.areEqual(this.f7366c, ((a) obj).f7366c)) {
                    return true;
                }
                return false;
            }
