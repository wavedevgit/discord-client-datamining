...
public final class p extends k implements c {
    ...
    private final KType f7761a;

    /* renamed from: b  reason: collision with root package name */
    private final String f7762b;

    /* renamed from: c  reason: collision with root package name */
    private final s f7763c;
    ...
    public static final class a extends kotlin.coroutines.jvm.internal.k implements Function2 {
        ...
        final /* synthetic */ o f7765e;

        /* renamed from: i  reason: collision with root package name */
        final /* synthetic */ p f7766i;

        /* renamed from: o  reason: collision with root package name */
        final /* synthetic */ k.a f7767o;
        ...
        public final Continuation create(Object obj, Continuation continuation) {
            return new a(this.f7765e, this.f7766i, this.f7767o, continuation);
        }
    ...
    public p(KType workerType, String key) {
        ...
        this.f7761a = workerType;
        this.f7762b = key;
        this.f7763c = w.n(workerType);
    }

    @Override // cn.c
    public String a() {
        return Intrinsics.stringPlus("worker ", this.f7761a);
    }
