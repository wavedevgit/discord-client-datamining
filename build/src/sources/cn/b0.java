...
public abstract /* synthetic */ class b0 {
    ...
    public static final class b extends r {
        ...
        final /* synthetic */ Function1 f7718c;

        /* renamed from: d  reason: collision with root package name */
        final /* synthetic */ Function0 f7719d;

        b(Function1 function1, Function0 function0) {
            this.f7718c = function1;
            this.f7719d = function0;
        }

        @Override // cn.r
        public void a(r.c cVar) {
            Intrinsics.checkNotNullParameter(cVar, "<this>");
            this.f7718c.invoke(cVar);
        }

        public String toString() {
            return "WorkflowAction(" + ((String) this.f7719d.invoke()) + ")@" + hashCode();
        }
    }
