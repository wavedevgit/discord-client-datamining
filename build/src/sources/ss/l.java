...
public abstract class l {
    ...
    public static final class a extends kotlin.coroutines.jvm.internal.k implements Function2 {
        ...
        private /* synthetic */ Object f50074q;

        /* renamed from: r  reason: collision with root package name */
        final /* synthetic */ Flow[] f50075r;

        /* renamed from: s  reason: collision with root package name */
        final /* synthetic */ Function0 f50076s;

        /* renamed from: t  reason: collision with root package name */
        final /* synthetic */ Function3 f50077t;

        /* renamed from: u  reason: collision with root package name */
        final /* synthetic */ FlowCollector f50078u;
        ...
        public static final class C0654a extends kotlin.coroutines.jvm.internal.k implements Function2 {
            ...
            /* renamed from: e  reason: collision with root package name */
            final /* synthetic */ Flow[] f50080e;

            /* renamed from: i  reason: collision with root package name */
            final /* synthetic */ int f50081i;

            /* renamed from: o  reason: collision with root package name */
            final /* synthetic */ AtomicInteger f50082o;

            /* renamed from: p  reason: collision with root package name */
            final /* synthetic */ qs.g f50083p;
            ...
            public static final class C0655a implements FlowCollector {
                ...
                /* renamed from: d  reason: collision with root package name */
                final /* synthetic */ qs.g f50084d;

                /* renamed from: e  reason: collision with root package name */
                final /* synthetic */ int f50085e;
                ...
                */
                public final java.lang.Object emit(java.lang.Object r7, kotlin.coroutines.Continuation r8) {
                    ...
                    L13:
                        ...
                        r0.<init>(r8)
                    L18:
                        java.lang.Object r8 = r0.f50086d
            ...
            C0654a(Flow[] flowArr, int i10, AtomicInteger atomicInteger, qs.g gVar, Continuation continuation) {
                ...
                this.f50080e = flowArr;
                this.f50081i = i10;
                this.f50082o = atomicInteger;
                this.f50083p = gVar;
            }

            @Override // kotlin.coroutines.jvm.internal.a
            public final Continuation create(Object obj, Continuation continuation) {
                return new C0654a(this.f50080e, this.f50081i, this.f50082o, this.f50083p, continuation);
            }
            ...
            public final Object invokeSuspend(Object obj) {
                ...
                try {
                    if (i10 != 0) {
                        ...
                        kotlin.c.b(obj);
                        Flow[] flowArr = this.f50080e;
                        int i11 = this.f50081i;
                        Flow flow = flowArr[i11];
                        C0655a c0655a = new C0655a(this.f50083p, i11);
                        this.f50079d = 1;
                    ...
                    if (atomicInteger.decrementAndGet() == 0) {
                        w.a.a(this.f50083p, null, 1, null);
                    }
                    return Unit.f32008a;
                } finally {
                    if (this.f50082o.decrementAndGet() == 0) {
                        w.a.a(this.f50083p, null, 1, null);
                    }
                }
            }
            ...
            public final Object invoke(CoroutineScope coroutineScope, Continuation continuation) {
                return ((C0654a) create(coroutineScope, continuation)).invokeSuspend(Unit.f32008a);
            }
        }
        ...
        a(Flow[] flowArr, Function0 function0, Function3 function3, FlowCollector flowCollector, Continuation continuation) {
            super(2, continuation);
            this.f50075r = flowArr;
            this.f50076s = function0;
            this.f50077t = function3;
            this.f50078u = flowCollector;
        }

        @Override // kotlin.coroutines.jvm.internal.a
        public final Continuation create(Object obj, Continuation continuation) {
            a aVar = new a(this.f50075r, this.f50076s, this.f50077t, this.f50078u, continuation);
            aVar.f50074q = obj;
            return aVar;
        }
