...
public final class d {
    ...
    public static final d f26469a;

    /* renamed from: b  reason: collision with root package name */
    private static final Lazy f26470b;

    /* renamed from: c  reason: collision with root package name */
    private static final b f26471c;

    /* renamed from: d  reason: collision with root package name */
    private static final Map f26472d;

    /* renamed from: e  reason: collision with root package name */
    private static final b4 f26473e;

    /* loaded from: /home/runner/work/discord-client-datamining/discord-client-datamining/build/classes4.dex */
    public static final class a implements Comparator {
        @Override // java.util.Comparator
        public final int compare(Object obj, Object obj2) {
            return ur.a.d(((b4) obj).getText(), ((b4) obj2).getText());
        }
    }
    ...
    static {
        d dVar = new d();
        f26469a = dVar;
        f26470b = rr.l.a(new Function0() { // from class: hq.c
    ...
    private final List d() {
        ...
        for (Map.Entry entry2 : linkedHashMap.entrySet()) {
            arrayList.add(f26469a.m((b) entry2.getValue()));
        }
    ...
    public final b4 g(String str) {
        ...
        if (str != null && str.length() == 2) {
            ...
            Intrinsics.checkNotNullExpressionValue(upperCase, "toUpperCase(...)");
            b bVar = (b) f26472d.get(upperCase);
    ...
    */
    public final java.lang.String i(gq.b4 r8) {
        /*
            r7 = this;
        ...
        L3e:
            ...
            return r8
        */
        throw new UnsupportedOperationException("Method not decompiled: hq.d.i(gq.b4):java.lang.String");
    }
