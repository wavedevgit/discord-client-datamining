...
public final class a implements Closeable, Parcelable {
    ...
    public boolean equals(Object obj) {
        ...
        if ((obj instanceof a) && Intrinsics.areEqual(this.f27844d, ((a) obj).f27844d)) {
            return true;
        }
        return false;
    }
    ...
    public int hashCode() {
        return this.f27844d.hashCode();
    }

    public String toString() {
        List list = this.f27844d;
    ...
    public final void writeToParcel(Parcel dest, int i10) {
        ...
        List<Parcelable> list = this.f27844d;
