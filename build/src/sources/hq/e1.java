...
public final class e1 {
    ...
    private final ViewGroup f27703a;

    /* renamed from: b  reason: collision with root package name */
    private vp.j f27704b;

    /* renamed from: c  reason: collision with root package name */
    private xp.t4 f27705c;

    public e1(ViewGroup contentView) {
        Intrinsics.checkNotNullParameter(contentView, "contentView");
        this.f27703a = contentView;
    }
    ...
    public final void g(final xp.t4 sheetComponent, vm.a0 viewEnvironment) {
        ...
        final View a11 = a10.a(jVar, viewEnvironment, context, this.f27703a);
        this.f27703a.addView(a11);
        vm.g0.h(a11);
