...
public abstract class f {
    ...
    public static final Drawable b(Context context, int i10, int i11) {
        ...
        int c10 = androidx.core.content.a.c(context, kp.b.f34921a);
        int c11 = androidx.core.content.a.c(context, kp.b.f34922b);
        ...
        gradientDrawable.setSize(i11 + ((int) sp.h.a(24.0d)), gradientDrawable.getMinimumHeight());
        return new InsetDrawable((Drawable) gradientDrawable, (int) sp.h.a(4.0d));
    }

    private static final jr.e c(Context context) {
        jr.e eVar = f26484a;
        if (eVar == null) {
            jr.e b10 = jr.e.b(context);
            f26484a = b10;
    ...
    public static final void d(TextView textView, String text) {
        ...
        c10.d(textView, e10);
        if (e10.getSpans(0, e10.length(), mr.g.class).length == 0 && e10.getSpans(0, e10.length(), URLSpan.class).length == 0) {
