...
public abstract class j {
    ...
    public final Format f51415b;

    /* renamed from: c  reason: collision with root package name */
    public final s f51416c;

    /* renamed from: d  reason: collision with root package name */
    public final long f51417d;

    /* renamed from: e  reason: collision with root package name */
    public final List f51418e;

    /* renamed from: f  reason: collision with root package name */
    public final List f51419f;

    /* renamed from: g  reason: collision with root package name */
    public final List f51420g;

    /* renamed from: h  reason: collision with root package name */
    private final i f51421h;

    /* loaded from: /home/runner/work/discord-client-datamining/discord-client-datamining/build/classes3.dex */
    public static class c extends j {

        /* renamed from: i  reason: collision with root package name */
        public final Uri f51423i;

        /* renamed from: j  reason: collision with root package name */
        public final long f51424j;

        /* renamed from: k  reason: collision with root package name */
        private final String f51425k;

        /* renamed from: l  reason: collision with root package name */
        private final i f51426l;

        /* renamed from: m  reason: collision with root package name */
        private final m f51427m;
        ...
        public c(long j10, Format format, List list, k.e eVar, List list2, List list3, List list4, String str, long j11) {
            ...
            m mVar;
            this.f51423i = Uri.parse(((ud.b) list.get(0)).f51361a);
            i c10 = eVar.c();
            this.f51426l = c10;
            this.f51425k = str;
            this.f51424j = j11;
    ...
    private j(long j10, Format format, List list, k kVar, List list2, List list3, List list4) {
        ...
        this.f51414a = j10;
        this.f51415b = format;
        this.f51416c = s.o(list);
        if (list2 == null) {
            unmodifiableList = Collections.EMPTY_LIST;
        } else {
            unmodifiableList = Collections.unmodifiableList(list2);
        }
        this.f51418e = unmodifiableList;
        this.f51419f = list3;
        this.f51420g = list4;
        this.f51421h = kVar.a(this);
        this.f51417d = kVar.b();
    }
    ...
    public static class b extends j implements td.f {
        ...
        public long a(long j10, long j11) {
            return this.f51422i.h(j10, j11);
        }

        @Override // td.f
        public long b(long j10) {
            return this.f51422i.j(j10);
        }

        @Override // td.f
        public long c(long j10, long j11) {
            return this.f51422i.d(j10, j11);
        }

        @Override // td.f
        public long d(long j10, long j11) {
            return this.f51422i.f(j10, j11);
        }

        @Override // td.f
        public i e(long j10) {
            return this.f51422i.k(this, j10);
        }

        @Override // td.f
        public long f(long j10, long j11) {
            return this.f51422i.i(j10, j11);
        }

        @Override // td.f
        public long g(long j10) {
            return this.f51422i.g(j10);
        }

        @Override // td.f
        public boolean h() {
            return this.f51422i.l();
        }

        @Override // td.f
        public long i() {
            return this.f51422i.e();
        }

        @Override // td.f
        public long j(long j10, long j11) {
            return this.f51422i.c(j10, j11);
        }
