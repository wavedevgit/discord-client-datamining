...
public class d extends DefaultHandler implements j.a {
    ...
    private static final Pattern f50233b = Pattern.compile("(\\d+)(?:/(\\d+))?");

    /* renamed from: c  reason: collision with root package name */
    private static final Pattern f50234c = Pattern.compile("CC([1-4])=.*");

    /* renamed from: d  reason: collision with root package name */
    private static final Pattern f50235d = Pattern.compile("([1-9]|[1-5][0-9]|6[0-3])=.*");

    /* renamed from: e  reason: collision with root package name */
    private static final int[] f50236e = {-1, 1, 2, 3, 4, 5, 6, 8, 2, 3, 4, 7, 8, 24, 8, 12, 10, 12, 14, 12, 14};

    /* renamed from: a  reason: collision with root package name */
    private final XmlPullParserFactory f50237a;
    ...
    public static final class a {
        ...
        /* renamed from: a  reason: collision with root package name */
        public final Format f50238a;

        /* renamed from: b  reason: collision with root package name */
        public final s f50239b;

        /* renamed from: c  reason: collision with root package name */
        public final k f50240c;
        ...
        public final long f50244g;

        /* renamed from: h  reason: collision with root package name */
        public final List f50245h;

        /* renamed from: i  reason: collision with root package name */
        public final List f50246i;
        ...
        public a(Format format, List list, k kVar, String str, ArrayList arrayList, ArrayList arrayList2, List list2, List list3, long j10) {
            this.f50238a = format;
            this.f50239b = s.m(list);
            this.f50240c = kVar;
            this.f50241d = str;
            this.f50242e = arrayList;
            this.f50243f = arrayList2;
            this.f50245h = list2;
            this.f50246i = list3;
            this.f50244g = j10;
        }
    ...
    public d() {
        try {
            this.f50237a = XmlPullParserFactory.newInstance();
    ...
    protected static int D(List list) {
        ...
        for (int i10 = 0; i10 < list.size(); i10++) {
            ...
            if ("urn:scte:dash:cc:cea-608:2015".equals(eVar.f50247a) && (str = eVar.f50248b) != null) {
                Matcher matcher = f50234c.matcher(str);
                if (matcher.matches()) {
                    return Integer.parseInt(matcher.group(1));
                }
                y.i("MpdParser", "Unable to parse CEA-608 channel number from: " + eVar.f50248b);
            }
        }
        return -1;
    }
    ...
    protected static int E(List list) {
        ...
        for (int i10 = 0; i10 < list.size(); i10++) {
            e eVar = (e) list.get(i10);
            if ("urn:scte:dash:cc:cea-708:2015".equals(eVar.f50247a) && (str = eVar.f50248b) != null) {
                Matcher matcher = f50235d.matcher(str);
                if (matcher.matches()) {
                    return Integer.parseInt(matcher.group(1));
                }
                y.i("MpdParser", "Unable to parse CEA-708 service block number from: " + eVar.f50248b);
            }
        }
        return -1;
    }
    ...
    protected static String N(List list) {
        for (int i10 = 0; i10 < list.size(); i10++) {
            e eVar = (e) list.get(i10);
            String str = eVar.f50247a;
            if (!"tag:dolby.com,2018:dash:EC3_ExtensionType:2018".equals(str) || !"JOC".equals(eVar.f50248b)) {
                if ("tag:dolby.com,2014:dash:DolbyDigitalPlusExtensionType:2014".equals(str) && "ec+3".equals(eVar.f50248b)) {
    ...
    protected static float S(XmlPullParser xmlPullParser, float f10) {
        ...
        if (attributeValue != null) {
            Matcher matcher = f50233b.matcher(attributeValue);
            if (matcher.matches()) {
    ...
    protected static long W(List list) {
        for (int i10 = 0; i10 < list.size(); i10++) {
            e eVar = (e) list.get(i10);
            if (ii.b.a("http://dashif.org/guidelines/last-segment-number", eVar.f50247a)) {
                return Long.parseLong(eVar.f50248b);
            }
        }
        return -1L;
    }
    ...
    private static void r(ArrayList arrayList) {
        ...
        while (true) {
            if (i10 < arrayList.size()) {
                ...
                if (lc.d.f37185c.equals(bVar.f48440e) && (str = bVar.f48441i) != null) {
        ...
        if (str != null) {
            for (int i11 = 0; i11 < arrayList.size(); i11++) {
                ...
                if (lc.d.f37184b.equals(bVar2.f48440e) && bVar2.f48441i == null) {
                    arrayList.set(i11, new m.b(lc.d.f37185c, str, bVar2.f48442o, bVar2.f48443p));
                }
            }
        }
    }
    ...
    protected List C(XmlPullParser xmlPullParser, List list, boolean z10) {
        ...
        for (int i12 = 0; i12 < list.size(); i12++) {
            ...
            String d10 = u0.d(bVar.f50216a, s02);
            if (attributeValue3 == null) {
                str = d10;
            } else {
                str = attributeValue3;
    ...
    */
    ...
    protected byte[] P(XmlPullParser xmlPullParser, ByteArrayOutputStream byteArrayOutputStream) {
        ...
        newSerializer.setOutput(byteArrayOutputStream, ii.d.f28184c.name());
    ...
    */
    ...
    protected int f0(List list) {
        ...
        for (int i11 = 0; i11 < list.size(); i11++) {
            ...
            if (ii.b.a("urn:mpeg:dash:role:2011", eVar.f50247a)) {
                u02 = g0(eVar.f50248b);
            } else if (ii.b.a("urn:tva:metadata:cs:AudioPurposeCS:2007", eVar.f50247a)) {
                u02 = u0(eVar.f50248b);
            }
            i10 |= u02;
        }
    ...
    protected int h0(List list) {
        int i10 = 0;
        for (int i11 = 0; i11 < list.size(); i11++) {
            if (ii.b.a("http://dashif.org/guidelines/trickmode", ((e) list.get(i11)).f50247a)) {
                i10 = 16384;
            }
        }
        return i10;
    ...
    protected j j(a aVar, String str, String str2, ArrayList arrayList, ArrayList arrayList2) {
        Format.b b10 = aVar.f50238a.b();
        if (str != null) {
            b10.W(str);
        }
        String str3 = aVar.f50241d;
        if (str3 != null) {
            str2 = str3;
        }
        ArrayList arrayList3 = aVar.f50242e;
        ...
        ArrayList arrayList4 = aVar.f50243f;
        arrayList4.addAll(arrayList2);
        return j.o(aVar.f50244g, b10.G(), aVar.f50239b, aVar.f50240c, arrayList4, aVar.f50245h, aVar.f50246i, null);
    }
    ...
    protected Pair t0(List list) {
        ...
        for (int i10 = 0; i10 < list.size(); i10++) {
            e eVar = (e) list.get(i10);
            if ((ii.b.a("http://dashif.org/thumbnail_tile", eVar.f50247a) || ii.b.a("http://dashif.org/guidelines/thumbnail_tile", eVar.f50247a)) && (str = eVar.f50248b) != null) {
    ...
    public c a(Uri uri, InputStream inputStream) {
        try {
            XmlPullParser newPullParser = this.f50237a.newPullParser();
                    ...
                    if (y0.f(xmlPullParser3, "ContentComponent")) {
                        ...
                        if (y0.f(xmlPullParser3, "Role")) {
                            ...
                            if (y0.f(xmlPullParser3, "Representation")) {
                                ...
                                j15 = j21;
                                i11 = i18;
                                i10 = p(i19, c0.k(e02.f50238a.f12335w));
