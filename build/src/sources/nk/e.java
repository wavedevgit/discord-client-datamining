...
public final class e {
    ...
    private static final e[] f41358h = a();
    ...
    private final c f41364f;

    /* renamed from: g  reason: collision with root package name */
    private final int f41365g;
    ...
    public static e h(int i10, int i11) {
        ...
        if ((i10 & 1) == 0 && (i11 & 1) == 0) {
            for (e eVar : f41358h) {
                if (eVar.f41360b == i10 && eVar.f41361c == i11) {
                    return eVar;
                }
            }
            throw g.a();
    ...
    public String toString() {
        return String.valueOf(this.f41359a);
    }
    ...
    public static final class c {
        ...
        private c(int i10, b bVar) {
            this.f41368a = i10;
            this.f41369b = new b[]{bVar};
        }

        private c(int i10, b bVar, b bVar2) {
            this.f41368a = i10;
            this.f41369b = new b[]{bVar, bVar2};
        }
    }
}
