...
public class b0 extends ks.b implements MutableSharedFlow, js.c, ks.q {
    ...
    private final int f32464p;

    /* renamed from: q  reason: collision with root package name */
    private final int f32465q;

    /* renamed from: r  reason: collision with root package name */
    private final is.a f32466r;

    /* renamed from: s  reason: collision with root package name */
    private Object[] f32467s;

    /* renamed from: t  reason: collision with root package name */
    private long f32468t;
    ...
    public static final class a implements gs.n0 {
        ...
        public final b0 f32472d;

        /* renamed from: e  reason: collision with root package name */
        public long f32473e;

        /* renamed from: i  reason: collision with root package name */
        public final Object f32474i;

        /* renamed from: o  reason: collision with root package name */
        public final Continuation f32475o;

        public a(b0 b0Var, long j10, Object obj, Continuation continuation) {
            this.f32472d = b0Var;
            this.f32473e = j10;
            this.f32474i = obj;
            this.f32475o = continuation;
        }
    ...
    public /* synthetic */ class b {
        ...
        static {
            ...
            try {
                iArr[is.a.f31125d.ordinal()] = 1;
            } catch (NoSuchFieldError unused) {
            }
            try {
                iArr[is.a.f31127i.ordinal()] = 2;
            } catch (NoSuchFieldError unused2) {
            }
            try {
                iArr[is.a.f31126e.ordinal()] = 3;
    ...
    public static final class c extends kotlin.coroutines.jvm.internal.d {
        ...
        public final Object invokeSuspend(Object obj) {
            this.f32481p = obj;
            this.f32483r |= Integer.MIN_VALUE;
    ...
    */
    ...
    private final Object G(Object obj, Continuation continuation) {
        ...
        eVar.H();
        Continuation[] continuationArr = ks.c.f36443a;
        synchronized (this) {
            try {
                if (R(obj)) {
                    try {
                        Result.a aVar2 = Result.f33279e;
                        eVar.resumeWith(Result.b(Unit.f33282a));
                        I = I(continuationArr);
                        aVar = null;
                    } catch (Throwable th3) {
                        th2 = th3;
                ...
                for (Continuation continuation2 : I) {
                    if (continuation2 != null) {
                        ...
                        continuation2.resumeWith(Result.b(Unit.f33282a));
                    }
                }
                Object B = eVar.B();
                if (B == or.b.f()) {
    ...
    public final Continuation[] I(Continuation[] continuationArr) {
        ...
        if (ks.b.c(this) != 0 && (d10 = ks.b.d(this)) != null) {
            ...
            while (i10 < length2) {
                ks.d dVar = d10[i10];
                if (dVar != null && (continuation = (d0Var = (d0) dVar).f32491b) != null && T(d0Var) >= 0) {
    ...
    private final long J() {
        return K() + this.f32470v;
    }

    /* JADX INFO: Access modifiers changed from: private */
    public final long K() {
        return Math.min(this.f32469u, this.f32468t);
    }
    ...
    private final Object M(long j10) {
        ...
        f10 = c0.f(objArr, j10);
        if (f10 instanceof a) {
            return ((a) f10).f32474i;
        }
        return f10;
    }

    private final long N() {
        return K() + this.f32470v + this.f32471w;
    }

    private final int O() {
        return (int) ((K() + this.f32470v) - this.f32468t);
    }

    /* JADX INFO: Access modifiers changed from: private */
    public final int P() {
        return this.f32470v + this.f32471w;
    }
    ...
    public final boolean R(Object obj) {
        ...
        if (this.f32470v >= this.f32465q && this.f32469u <= this.f32468t) {
            int i10 = b.f32476a[this.f32466r.ordinal()];
            if (i10 != 1) {
                if (i10 == 2) {
                    return true;
                }
        ...
        H(obj);
        int i11 = this.f32470v + 1;
        this.f32470v = i11;
        if (i11 > this.f32465q) {
            E();
        }
        if (O() > this.f32464p) {
            V(this.f32468t + 1, this.f32469u, J(), N());
        }
        return true;
    }
    ...
    private final boolean S(Object obj) {
        ...
        H(obj);
        int i10 = this.f32470v + 1;
        this.f32470v = i10;
        if (i10 > this.f32464p) {
            E();
        }
        this.f32469u = K() + this.f32470v;
        return true;
    }

    /* JADX INFO: Access modifiers changed from: private */
    public final long T(d0 d0Var) {
        long j10 = d0Var.f32490a;
        if (j10 >= J() && (this.f32465q > 0 || j10 > K() || this.f32471w == 0)) {
            return -1L;
        }
        return j10;
    }
    ...
    private final void V(long j10, long j11, long j12, long j13) {
        ...
        this.f32468t = j10;
        this.f32469u = j11;
        this.f32470v = (int) (j12 - min);
        this.f32471w = (int) (j13 - j12);
    }
    ...
    public final void y(a aVar) {
        ...
        synchronized (this) {
            ...
            Object[] objArr = this.f32467s;
            Intrinsics.checkNotNull(objArr);
            f10 = c0.f(objArr, aVar.f32473e);
            if (f10 == aVar) {
                c0.g(objArr, aVar.f32473e, c0.f32484a);
                z();
                Unit unit = Unit.f33282a;
            }
        }
    ...
    private final void z() {
        Object f10;
        if (this.f32465q != 0 || this.f32471w > 1) {
            Object[] objArr = this.f32467s;
            Intrinsics.checkNotNull(objArr);
            while (this.f32471w > 0) {
    ...
    public final Object L() {
        ...
        Object[] objArr = this.f32467s;
        Intrinsics.checkNotNull(objArr);
        f10 = c0.f(objArr, (this.f32468t + O()) - 1);
        return f10;
    }
    ...
    public final Continuation[] W(long j10) {
        ...
        long K = K();
        long j15 = this.f32470v + K;
        if (this.f32465q == 0 && this.f32471w > 0) {
            j15++;
        }
        if (ks.b.c(this) != 0 && (d10 = ks.b.d(this)) != null) {
            for (ks.d dVar : d10) {
                if (dVar != null) {
                    long j16 = ((d0) dVar).f32490a;
                    if (j16 >= 0 && j16 < j15) {
                        j15 = j16;
                    }
                }
        ...
        long J = J();
        if (l() > 0) {
            i10 = Math.min(this.f32471w, this.f32465q - ((int) (J - j15)));
        } else {
            i10 = this.f32471w;
        }
        Continuation[] continuationArr = ks.c.f36443a;
        long j17 = this.f32471w + J;
        if (i10 > 0) {
        ...
        long max = Math.max(this.f32468t, J - Math.min(this.f32464p, i13));
        if (this.f32465q == 0 && max < j17) {
            Object[] objArr2 = this.f32467s;
            Intrinsics.checkNotNull(objArr2);
            f10 = c0.f(objArr2, max);
            if (Intrinsics.areEqual(f10, c0.f32484a)) {
                J += j13;
                max += j13;
            }
        }
