...
public final class e extends kotlinx.coroutines.a {
    ...
    private final Thread f31954o;

    /* renamed from: p  reason: collision with root package name */
    private final p0 f31955p;
    ...
    public void C(Object obj) {
        if (!Intrinsics.areEqual(Thread.currentThread(), this.f31954o)) {
            Thread thread = this.f31954o;
            b.a();
    ...
    public final Object W0() {
        ...
        b.a();
        try {
            p0 p0Var = this.f31955p;
            r rVar = null;
            if (p0Var != null) {
                p0.q2(p0Var, false, 1, null);
            }
            while (true) {
                p0 p0Var2 = this.f31955p;
                if (p0Var2 != null) {
                    j10 = p0Var2.t2();
                } else {
