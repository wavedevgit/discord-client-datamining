...
public abstract class p0 extends CoroutineDispatcher {
    ...
    public final void f2(boolean z10) {
        long i22 = this.f31974i - i2(z10);
        this.f31974i = i22;
        if (i22 <= 0 && this.f31975o) {
            shutdown();
        }
    }

    public final void j2(kotlinx.coroutines.m mVar) {
        ArrayDeque arrayDeque = this.f31976p;
        if (arrayDeque == null) {
            arrayDeque = new ArrayDeque();
            this.f31976p = arrayDeque;
        }
