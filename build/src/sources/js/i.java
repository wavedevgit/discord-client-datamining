...
public abstract /* synthetic */ class i {
    ...
    /* JADX WARN: Type inference failed for: r2v3, types: [js.g0, java.lang.Object, kotlinx.coroutines.a] */
    ...
    public static final Object e(CoroutineContext coroutineContext, Function2 function2, Continuation continuation) {
        ...
        if (j10 == context) {
            os.a0 a0Var = new os.a0(j10, continuation);
            X0 = ps.b.d(a0Var, a0Var, function2);
        } else {
            ...
            if (Intrinsics.areEqual(j10.l(bVar), context.l(bVar))) {
                ...
                Object i10 = os.l0.i(context2, null);
                try {
                    Object d10 = ps.b.d(u1Var, u1Var, function2);
                    os.l0.f(context2, i10);
                    X0 = d10;
                } catch (Throwable th2) {
                    os.l0.f(context2, i10);
                    throw th2;
