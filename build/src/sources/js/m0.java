...
public final class m0 extends ks.d {
    ...
    private final AtomicReference f32549a = new AtomicReference(null);

    @Override // ks.d
    /* renamed from: d */
    public boolean a(k0 k0Var) {
        ls.e0 e0Var;
        if (ls.d.a(this.f32549a) != null) {
            return false;
        }
        AtomicReference atomicReference = this.f32549a;
        e0Var = l0.f32546a;
        ...
        while (true) {
            ...
            if (a10 != null) {
                ...
                if (a10 != e0Var) {
                    e0Var2 = l0.f32546a;
                    if (a10 == e0Var2) {
                        AtomicReference atomicReference2 = this.f32549a;
                        e0Var3 = l0.f32547b;
                        if (p0.d.a(atomicReference2, a10, e0Var3)) {
                            return;
                        }
                    } else {
                        AtomicReference atomicReference3 = this.f32549a;
                        e0Var4 = l0.f32546a;
                        if (p0.d.a(atomicReference3, a10, e0Var4)) {
                            Result.a aVar = Result.f33279e;
                            ((kotlinx.coroutines.e) a10).resumeWith(Result.b(Unit.f33282a));
                            return;
                        }
                    }
                } else {
