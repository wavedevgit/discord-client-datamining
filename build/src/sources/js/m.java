...
public final class m extends b0 {
    ...
    private final e f32272p;

    /* renamed from: q  reason: collision with root package name */
    private final /* synthetic */ AtomicReferenceArray f32273q;

    public m(long j10, m mVar, e eVar, int i10) {
        super(j10, mVar, i10);
        this.f32272p = eVar;
        this.f32273q = new AtomicReferenceArray(f.f32245b * 2);
    }
    ...
    public final void C(int i10, boolean z10) {
        if (z10) {
            y().w1((this.f39148i * f.f32245b) + i10);
        }
        t();
    }
    ...
    */
    public void s(int r4, java.lang.Throwable r5, kotlin.coroutines.CoroutineContext r6) {
        ...
        Le:
            ...
            boolean r2 = r1 instanceof hs.w1
            if (r2 != 0) goto L73
            boolean r2 = r1 instanceof js.x
            if (r2 == 0) goto L1b
            goto L73
        L1b:
            ms.e0 r2 = js.f.j()
        ...
        L62:
            ...
            if (r0 == 0) goto L99
            js.e r4 = r3.y()
            kotlin.jvm.functions.Function1 r4 = r4.f32225e
            if (r4 == 0) goto L99
            ms.x.a(r4, r5, r6)
            return
        L73:
        ...
        L99:
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: js.m.s(int, java.lang.Throwable, kotlin.coroutines.CoroutineContext):void");
    }
