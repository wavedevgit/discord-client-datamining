    ...
    */
    public static int a(byte[] r7) {
        ...
        L64:
            return r7
        */
        throw new UnsupportedOperationException("Method not decompiled: oc.t.a(byte[]):int");
    }
    ...
    public static Format g(byte[] bArr, String str, String str2, sc.m mVar) {
        int i10;
        int i11;
        g0 b10 = b(bArr);
        b10.r(60);
        int i12 = f38822a[b10.h(6)];
        int i13 = f38823b[b10.h(4)];
        int h10 = b10.h(5);
        int[] iArr = f38824c;
        if (h10 >= iArr.length) {
            i10 = -1;
