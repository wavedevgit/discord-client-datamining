...
public abstract class t {
    ...
    */
    ...
    public static Format g(byte[] bArr, String str, String str2, sc.m mVar) {
        ...
        g0 b10 = b(bArr);
        b10.r(60);
        int i12 = f40495a[b10.h(6)];
        int i13 = f40496b[b10.h(4)];
        int h10 = b10.h(5);
        int[] iArr = f40497c;
        if (h10 >= iArr.length) {
            i10 = -1;
