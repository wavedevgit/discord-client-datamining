...
public abstract class c {
    ...
    public static final TextWatcher d(EditText editText, Function1 action) {
        ...
        try {
            ...
            sm.a.f(sm.a.f48740a, editText.getClass().getSimpleName(), "Can not attach listener because `fieldValue` does not belong to `ArrayList<TextWatcher>`", null, 4, null);
            return aVar;
        } catch (ClassCastException e10) {
            sm.a aVar2 = sm.a.f48740a;
    ...
    public static final class a implements TextWatcher {
        ...
        final /* synthetic */ Ref.ObjectRef f41188d;

        /* renamed from: e  reason: collision with root package name */
        final /* synthetic */ Function1 f41189e;

        a(Ref.ObjectRef objectRef, Function1 function1) {
            this.f41188d = objectRef;
            this.f41189e = function1;
        }
        ...
        public void onTextChanged(CharSequence charSequence, int i10, int i11, int i12) {
            ...
            if (!Intrinsics.areEqual((Object) valueOf, this.f41188d.element)) {
                this.f41188d.element = valueOf;
                this.f41189e.invoke(valueOf);
            }
        }
