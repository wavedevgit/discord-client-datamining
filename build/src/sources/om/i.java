...
public abstract class i {
    ...
    private static final int[] f40628a = new int[2];
    ...
    public static final void a(View view, Rect rect) {
        ...
        sm.a.f(sm.a.f48171a, "View.copyBoundsInWindow", "Can not copy bounds as view is not attached to window", null, 4, null);
    }
    ...
    public static final WindowInsetsCompat c(View view, WindowInsetsCompat insets, boolean z10, boolean z11) {
        ...
        if (Build.VERSION.SDK_INT >= 30) {
            ...
            WindowInsetsCompat W = i0.W(view, a10);
            Intrinsics.checkNotNullExpressionValue(W, "onApplyWindowInsets(...)");
            return W;
        }
        WindowInsetsCompat W2 = i0.W(view, insets);
        Intrinsics.checkNotNullExpressionValue(W2, "onApplyWindowInsets(...)");
        int o10 = W2.o();
        if (!z10) {
            i10 = W2.q();
        }
        WindowInsetsCompat v10 = W2.v(o10, i10, W2.p(), W2.n());
