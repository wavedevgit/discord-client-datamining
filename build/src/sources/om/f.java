...
public final class f {
    ...
    public static final a f44356e = new a(null);

    /* renamed from: a  reason: collision with root package name */
    private final ReactApplicationContext f44357a;

    /* renamed from: b  reason: collision with root package name */
    private h f44358b;

    /* renamed from: c  reason: collision with root package name */
    private WindowInsetsControllerCompat f44359c;

    /* renamed from: d  reason: collision with root package name */
    private WeakReference f44360d;
    ...
    public f(ReactApplicationContext mReactContext) {
        ...
        this.f44357a = mReactContext;
        this.f44358b = new h(mReactContext);
        this.f44360d = new WeakReference(null);
    }

    private final WindowInsetsControllerCompat g() {
        String str;
        Activity currentActivity = this.f44357a.getCurrentActivity();
        if (this.f44359c == null || !Intrinsics.areEqual(currentActivity, this.f44360d.get())) {
            ...
            this.f44360d = new WeakReference(currentActivity);
            this.f44359c = new WindowInsetsControllerCompat(window, window.getDecorView());
        }
        return this.f44359c;
    }
    ...
    public static final void j(Activity activity, boolean z10, int i10) {
        ...
        if (z10) {
            ...
            ofObject.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() { // from class: om.e
    ...
    public final void i(final int i10, final boolean z10) {
        String str;
        if (!h()) {
            this.f44358b.b(i10, z10);
            return;
        }
        final Activity currentActivity = this.f44357a.getCurrentActivity();
        if (currentActivity == null) {
            km.a aVar = km.a.f32427a;
            str = g.f44361a;
        ...
        UiThreadUtil.runOnUiThread(new Runnable() { // from class: om.d
    ...
    public final void l(final boolean z10) {
        UiThreadUtil.runOnUiThread(new Runnable() { // from class: om.a
            @Override // java.lang.Runnable
            public final void run() {
                f.m(z10, this);
            }
    ...
    public final void p(final boolean z10) {
        if (!h()) {
            ...
            UiThreadUtil.runOnUiThread(new Runnable() { // from class: om.c
                @Override // java.lang.Runnable
                public final void run() {
                    f.q(f.this, z10);
                }
