...
public final class w extends f {
    ...
    private final Resources f37382e;
    ...
    private AssetFileDescriptor f37385h;

    /* renamed from: i  reason: collision with root package name */
    private InputStream f37386i;
    ...
    public w(Context context) {
        super(false);
        this.f37382e = context.getResources();
    ...
    public long b(com.google.android.exoplayer2.upstream.a aVar) {
        ...
        if (!TextUtils.equals("rawresource", normalizeScheme.getScheme()) && (!TextUtils.equals("android.resource", normalizeScheme.getScheme()) || normalizeScheme.getPathSegments().size() != 1 || !((String) ne.a.e(normalizeScheme.getLastPathSegment())).matches("\\d+"))) {
            if (TextUtils.equals("android.resource", normalizeScheme.getScheme())) {
                ...
                sb2.append(str);
                sb2.append(str2);
                parseInt = this.f37382e.getIdentifier(sb2.toString(), "raw", this.f37383f);
                if (parseInt == 0) {
        ...
        q(aVar);
        try {
            AssetFileDescriptor openRawResourceFd = this.f37382e.openRawResourceFd(parseInt);
            this.f37385h = openRawResourceFd;
            if (openRawResourceFd != null) {
                long length = openRawResourceFd.getLength();
                FileInputStream fileInputStream = new FileInputStream(openRawResourceFd.getFileDescriptor());
                this.f37386i = fileInputStream;
                int i10 = (length > (-1L) ? 1 : (length == (-1L) ? 0 : -1));
                if (i10 != 0) {
                    try {
                        if (aVar.f13981g > length) {
    ...
    public void close() {
        ...
        try {
            try {
                InputStream inputStream = this.f37386i;
                if (inputStream != null) {
                    inputStream.close();
                }
                this.f37386i = null;
                try {
                    try {
                        AssetFileDescriptor assetFileDescriptor = this.f37385h;
            ...
            try {
                try {
                    AssetFileDescriptor assetFileDescriptor2 = this.f37385h;
    ...
    public int read(byte[] bArr, int i10, int i11) {
        ...
        int read = ((InputStream) w0.j(this.f37386i)).read(bArr, i10, i11);
        if (read == -1) {
            if (this.f37387j == -1) {
                return -1;
            }
        ...
        long j11 = this.f37387j;
        if (j11 != -1) {
            this.f37387j = j11 - read;
        }
        o(read);
        return read;
    }
