...
public abstract class t {
    ...
    private static final Pattern f37250a = Pattern.compile("bytes (\\d+)-(\\d+)/(?:\\d+|\\*)");

    /* renamed from: b  reason: collision with root package name */
    private static final Pattern f37251b = Pattern.compile("bytes (?:(?:\\d+-\\d+)|\\*)/(\\d+)");
    ...
    */
    public static long b(java.lang.String r9, java.lang.String r10) {
        ...
        L28:
            ...
            if (r0 != 0) goto La3
            java.util.regex.Pattern r0 = le.t.f37250a
    ...
    public static long c(String str) {
        ...
        Matcher matcher = f37251b.matcher(str);
        if (!matcher.matches()) {
            return -1L;
        }
