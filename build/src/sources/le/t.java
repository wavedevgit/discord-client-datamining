...
public abstract class t {
    ...
    private static final Pattern f36776a = Pattern.compile("bytes (\\d+)-(\\d+)/(?:\\d+|\\*)");

    /* renamed from: b  reason: collision with root package name */
    private static final Pattern f36777b = Pattern.compile("bytes (?:(?:\\d+-\\d+)|\\*)/(\\d+)");
    ...
    */
    public static long b(java.lang.String r9, java.lang.String r10) {
        ...
        L28:
            ...
            if (r0 != 0) goto La3
            java.util.regex.Pattern r0 = le.t.f36776a
            java.util.regex.Matcher r0 = r0.matcher(r10)
            boolean r5 = r0.matches()
            if (r5 == 0) goto La3
            r5 = 2
            java.lang.String r5 = r0.group(r5)     // Catch: java.lang.NumberFormatException -> L8c
            java.lang.Object r5 = ne.a.e(r5)     // Catch: java.lang.NumberFormatException -> L8c
            ...
            java.lang.Object r0 = ne.a.e(r0)     // Catch: java.lang.NumberFormatException -> L8c
        ...
        L64:
            ...
            ne.y.i(r2, r9)     // Catch: java.lang.NumberFormatException -> L8c
        ...
        La3:
            return r3
        */
        throw new UnsupportedOperationException("Method not decompiled: le.t.b(java.lang.String, java.lang.String):long");
    }
    ...
    public static long c(String str) {
        ...
        Matcher matcher = f36777b.matcher(str);
        if (!matcher.matches()) {
            return -1L;
        }
