...
public final class k extends f {
    ...
    private com.google.android.exoplayer2.upstream.a f36799e;

    /* renamed from: f  reason: collision with root package name */
    private byte[] f36800f;
    ...
    public long b(com.google.android.exoplayer2.upstream.a aVar) {
        ...
        if (d12.length == 2) {
            ...
            if (d12[0].contains(";base64")) {
                try {
                    this.f36800f = Base64.decode(str, 0);
                } catch (IllegalArgumentException e10) {
                    throw l0.b("Error while parsing Base64 encoded string: " + str, e10);
                }
            } else {
                this.f36800f = w0.s0(URLDecoder.decode(str, ii.d.f28405a.name()));
            }
            ...
            if (j10 <= bArr.length) {
                ...
                if (j11 != -1) {
                    this.f36802h = (int) Math.min(length, j11);
                }
                r(aVar);
    ...
    @Override // com.google.android.exoplayer2.upstream.DataSource
    public Uri m() {
        com.google.android.exoplayer2.upstream.a aVar = this.f36799e;
        if (aVar != null) {
            return aVar.f12943a;
        }
        return null;
    ...
    public int read(byte[] bArr, int i10, int i11) {
        ...
        int i12 = this.f36802h;
        if (i12 == 0) {
            return -1;
        }
        int min = Math.min(i11, i12);
        System.arraycopy(w0.j(this.f36800f), this.f36801g, bArr, i10, min);
        this.f36801g += min;
        this.f36802h -= min;
        o(min);
        return min;
