...
public final class b extends j {
    ...
    public static final a f23168q = new a(null);

    /* loaded from: /home/runner/work/discord-client-datamining/discord-client-datamining/build/classes4.dex */
    public static final class a implements c0 {

        /* renamed from: a  reason: collision with root package name */
        private final /* synthetic */ en.f f23169a;

        /* JADX INFO: Access modifiers changed from: package-private */
        /* renamed from: fp.b$a$a  reason: collision with other inner class name */
        /* loaded from: /home/runner/work/discord-client-datamining/discord-client-datamining/build/classes4.dex */
        public /* synthetic */ class C0352a extends FunctionReferenceImpl implements Function2 {
            C0352a(Object obj) {
            ...
            public final void a(in.f p02, a0 p12) {
        ...
        public static final View c(c initialRendering, a0 initialEnv, Context contextForNewView, ViewGroup viewGroup) {
            ...
            bVar.setId(g.f23177b);
            bVar.setLayoutParams(new ViewGroup.LayoutParams(-1, -1));
            g0.a(bVar, initialRendering, initialEnv, new C0352a(bVar));
            return bVar;
        }
        ...
        public View a(c initialRendering, a0 initialViewEnvironment, Context contextForNewView, ViewGroup viewGroup) {
            ...
            Intrinsics.checkNotNullParameter(contextForNewView, "contextForNewView");
            return this.f23169a.a(initialRendering, initialViewEnvironment, contextForNewView, viewGroup);
        }

        @Override // en.c0
        public KClass getType() {
            return this.f23169a.getType();
        }

        private a() {
            this.f23169a = new en.f(Reflection.getOrCreateKotlinClass(c.class), new Function4() { // from class: fp.a
    ...
    public Dialog g(View view) {
        ...
        Dialog dialog = new Dialog(getContext(), kp.f.f34958a);
        Iterator it = s.d(view).iterator();
        while (true) {
            if (it.hasNext()) {
                obj = it.next();
                if (((View) obj).getTag(g.f23176a) instanceof Integer) {
                    break;
                }
            } else {
                obj = null;
