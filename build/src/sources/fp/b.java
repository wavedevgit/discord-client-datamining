...
public final class b implements ViewBinding {
    ...
    private final View f25429a;

    /* renamed from: b  reason: collision with root package name */
    public final View f25430b;

    /* renamed from: c  reason: collision with root package name */
    public final Pi2CircleMaskView f25431c;

    /* renamed from: d  reason: collision with root package name */
    public final ThemeableLottieAnimationView f25432d;

    /* renamed from: e  reason: collision with root package name */
    public final ImageView f25433e;

    /* renamed from: f  reason: collision with root package name */
    public final View f25434f;

    /* renamed from: g  reason: collision with root package name */
    public final View f25435g;

    /* renamed from: h  reason: collision with root package name */
    public final Pi2ProgressArcView f25436h;
    ...
    private b(View view, View view2, Pi2CircleMaskView pi2CircleMaskView, ThemeableLottieAnimationView themeableLottieAnimationView, ImageView imageView, View view3, View view4, Pi2ProgressArcView pi2ProgressArcView) {
        this.f25429a = view;
        this.f25430b = view2;
        this.f25431c = pi2CircleMaskView;
        this.f25432d = themeableLottieAnimationView;
        this.f25433e = imageView;
        this.f25434f = view3;
        this.f25435g = view4;
        this.f25436h = pi2ProgressArcView;
    }
        ...
        if (a12 != null) {
            ...
            if (pi2CircleMaskView != null) {
                ...
                if (themeableLottieAnimationView != null) {
                    ...
                    if (imageView != null && (a10 = e4.a.a(view, (i10 = w0.f23538w))) != null && (a11 = e4.a.a(view, (i10 = w0.f23540y))) != null) {
                        i10 = w0.L;
    ...
    public static b b(LayoutInflater layoutInflater, ViewGroup viewGroup) {
        if (viewGroup != null) {
            layoutInflater.inflate(x0.f23555b, viewGroup);
            return a(viewGroup);
        }
