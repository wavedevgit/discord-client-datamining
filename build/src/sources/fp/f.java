...
public final class f implements ViewBinding {
    ...
    public final ConstraintLayout f25479c;

    /* renamed from: d  reason: collision with root package name */
    public final Pi2NavigationBar f25480d;

    /* renamed from: e  reason: collision with root package name */
    public final RecyclerView f25481e;

    /* renamed from: f  reason: collision with root package name */
    public final Button f25482f;

    /* renamed from: g  reason: collision with root package name */
    public final TextView f25483g;

    /* renamed from: h  reason: collision with root package name */
    public final Button f25484h;
    ...
    private f(ConstraintLayout constraintLayout, TextView textView, ConstraintLayout constraintLayout2, Pi2NavigationBar pi2NavigationBar, RecyclerView recyclerView, Button button, TextView textView2, Button button2) {
        ...
        this.f25479c = constraintLayout2;
        this.f25480d = pi2NavigationBar;
        this.f25481e = recyclerView;
        this.f25482f = button;
        this.f25483g = textView2;
        this.f25484h = button2;
    }
    ...
    public static f c(LayoutInflater layoutInflater, ViewGroup viewGroup, boolean z10) {
        View inflate = layoutInflater.inflate(x0.f23559f, viewGroup, false);
        if (z10) {
