...
public abstract class m1 {
    ...
    public /* synthetic */ class a {
        ...
        public static final /* synthetic */ int[] f24799b;
    ...
    public static final String a(a1.b bVar) {
        ...
        int i10 = a.f24798a[bVar.ordinal()];
        if (i10 != 1) {
            if (i10 != 2) {
                if (i10 == 3) {
    ...
    public static final Object b(nn.y0 y0Var, pp.c sdkFilesManager) {
        ...
        try {
            ...
            return Result.b(new a1.c(absolutePath, a1.a.f24538e, d(y0Var), currentTimeMillis));
    ...
    public static final a1.b c(NextStep.Selfie.SelfiePose selfiePose) {
        ...
        int i10 = a.f24799b[selfiePose.ordinal()];
        if (i10 != 1) {
            if (i10 != 2) {
                if (i10 == 3) {
                    return a1.b.f24545i;
    ...
    public static final a1.b d(nn.y0 y0Var) {
        Intrinsics.checkNotNullParameter(y0Var, "<this>");
