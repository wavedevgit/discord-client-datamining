...
public abstract class w0 {
    ...
    private static final Uri f26114a = new Uri.Builder().scheme("content").authority("com.google.android.gms.chimera").build();
    ...
    */
    public static android.content.Intent a(android.content.Context r5, hf.h1 r6) {
        /*
        ...
        L16:
            ...
            android.net.Uri r4 = hf.w0.f26114a     // Catch: java.lang.IllegalArgumentException -> L3d android.os.RemoteException -> L3f
        ...
        Lbd:
            return r3
        */
        throw new UnsupportedOperationException("Method not decompiled: hf.w0.a(android.content.Context, hf.h1):android.content.Intent");
    }
}
