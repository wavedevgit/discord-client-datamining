...
public abstract class b0 {
    ...
    private static final SimpleArrayMap f25963a = new SimpleArrayMap();

    /* renamed from: b  reason: collision with root package name */
    private static Locale f25964b;
    ...
    public static String b(Context context, int i10) {
        ...
        if (i10 != 1) {
            if (i10 != 2) {
                ...
                return resources.getString(df.b.f20698a);
            }
            return resources.getString(df.b.f20707j);
        }
        return resources.getString(df.b.f20701d);
    }
    ...
    public static String c(Context context, int i10) {
        ...
        if (i10 != 1) {
            if (i10 != 2) {
                                ...
                                if (i10 != 20) {
                                    switch (i10) {
                                        ...
                                        case ChatViewRecyclerTypes.EPHEMERAL_INDICATION /* 18 */:
                                            return resources.getString(df.b.f20710m, a10);
                                        default:
                                            return resources.getString(com.google.android.gms.common.m.f13927a, a10);
                                    }
                                }
                                return g(context, "common_google_play_services_restricted_profile_text", a10);
                            }
                            return resources.getString(df.b.f20706i, a10);
                        }
                ...
                return resources.getString(df.b.f20699b, a10);
            } else if (com.google.android.gms.common.util.g.d(context)) {
                return resources.getString(df.b.f20711n);
            } else {
                return resources.getString(df.b.f20708k, a10);
            }
        }
        return resources.getString(df.b.f20702e, a10);
    }
    ...
    public static String e(Context context, int i10) {
        ...
        if (f10 == null) {
            return context.getResources().getString(df.b.f20705h);
        }
        return f10;
    }
    ...
    public static String f(Context context, int i10) {
        ...
        switch (i10) {
            case 1:
                return resources.getString(df.b.f20703f);
            case 2:
                return resources.getString(df.b.f20709l);
            case 3:
                return resources.getString(df.b.f20700c);
            case 4:
            case 6:
            case ChatViewRecyclerTypes.EPHEMERAL_INDICATION /* 18 */:
                return null;
