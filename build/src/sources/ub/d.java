...
public class d {
    ...
    protected final Set f51145a;

    /* renamed from: b  reason: collision with root package name */
    protected final c.b f51146b;

    /* renamed from: c  reason: collision with root package name */
    protected final c.a f51147c;

    /* renamed from: d  reason: collision with root package name */
    protected boolean f51148d;

    /* renamed from: e  reason: collision with root package name */
    protected boolean f51149e;
    ...
    public class a implements Runnable {
        ...
        public void run() {
            try {
                d.this.g(this.f51150d, this.f51151e, this.f51152i);
                throw null;
    ...
    public class b implements FilenameFilter {
        ...
        public boolean accept(File file, String str) {
            return str.startsWith(this.f51154a);
        }
    }
    ...
    public void g(Context context, String str, String str2) {
        ...
        Context context2;
        i iVar;
        if (this.f51145a.contains(str) && !this.f51148d) {
            i("%s already loaded previously!", str);
            return;
        }
        try {
            this.f51146b.a(str);
            this.f51145a.add(str);
            ...
            if (d10.exists() && !this.f51148d) {
                ...
                dVar = this;
                context2 = context;
                this.f51147c.a(context2, this.f51146b.d(), this.f51146b.b(str), d10, dVar);
            }
            try {
                if (dVar.f51149e) {
                    try {
                        ...
                        try {
                            ...
                            iVar.close();
                            for (String str3 : i10) {
                                e(context2, dVar.f51146b.c(str3));
                            }
                        } catch (Throwable th2) {
                            th = th2;
                            Throwable th3 = th;
            ...
            dVar.f51146b.e(d10.getAbsolutePath());
            dVar.f51145a.add(str);
    ...
    protected void b(Context context, String str, String str2) {
        File c10 = c(context);
        File d10 = d(context, str, str2);
        File[] listFiles = c10.listFiles(new b(this.f51146b.b(str)));
        if (listFiles != null) {
            for (File file : listFiles) {
                if (this.f51148d || !file.getAbsolutePath().equals(d10.getAbsolutePath())) {
                    file.delete();
                }
            }
        }
