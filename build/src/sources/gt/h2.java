...
public abstract class h2 {
    ...
    private static final Map f25268a = t1.i();

    public static final SerialDescriptor a(String serialName, ft.e kind) {
    ...
    public static final KSerializer b(KClass kClass) {
        ...
        return (KSerializer) f25268a.get(kClass);
    }

    private static final void c(String str) {
        for (KSerializer kSerializer : f25268a.values()) {
