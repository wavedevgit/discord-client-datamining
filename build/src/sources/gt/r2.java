...
public abstract class r2 implements Encoder, CompositeEncoder {
    ...
    private final ArrayList f25332a = new ArrayList();
    ...
    public void A(SerialDescriptor descriptor, int i10, dt.o serializer, Object obj) {
    ...
    public void H(dt.o oVar, Object obj) {
    ...
    @Override // kotlinx.serialization.encoding.CompositeEncoder
    public void l(SerialDescriptor descriptor, int i10, dt.o serializer, Object obj) {
        Intrinsics.checkNotNullParameter(descriptor, "descriptor");
        Intrinsics.checkNotNullParameter(serializer, "serializer");
        if (G(descriptor, i10)) {
            y(serializer, obj);
    ...
    @Override // kotlinx.serialization.encoding.Encoder
    public abstract void y(dt.o oVar, Object obj);
