...
public abstract class w {
    ...
    public static final KSerializer c(nt.b bVar, Type type) {
        return x.e(bVar, type);
    }

    public static final KSerializer d(nt.b bVar, KType kType) {
    ...
    public static final KSerializer f(nt.b bVar, Type type) {
        return x.h(bVar, type);
    }

    public static final KSerializer g(nt.b bVar, KType kType) {
        return z.j(bVar, kType);
    }

    public static final List h(nt.b bVar, List list, boolean z10) {
