...
final class v implements s1 {
    ...
    private final Function2 f25346a;

    /* renamed from: b  reason: collision with root package name */
    private final ConcurrentHashMap f25347b;

    public v(Function2 compute) {
        Intrinsics.checkNotNullParameter(compute, "compute");
        this.f25346a = compute;
        this.f25347b = new ConcurrentHashMap();
    }
    ...
    public Object a(KClass key, List types) {
        ...
        ConcurrentHashMap concurrentHashMap2 = this.f25347b;
        Class b11 = bs.a.b(key);
        ...
        concurrentHashMap = r1Var.f25331a;
        Object obj2 = concurrentHashMap.get(arrayList);
        if (obj2 == null) {
            try {
                Result.a aVar = Result.f31985e;
                b10 = Result.b((KSerializer) this.f25346a.invoke(key, types));
            } catch (Throwable th2) {
