...
public abstract class x0 implements SerialDescriptor {
    ...
    private final SerialDescriptor f25358a;
    ...
    public boolean equals(Object obj) {
        ...
        x0 x0Var = (x0) obj;
        if (Intrinsics.areEqual(this.f25358a, x0Var.f25358a) && Intrinsics.areEqual(h(), x0Var.h())) {
            return true;
        }
        return false;
    }
    ...
    public int hashCode() {
        return (this.f25358a.hashCode() * 31) + h().hashCode();
    }
    ...
    public String toString() {
        return h() + '(' + this.f25358a + ')';
    }

    private x0(SerialDescriptor serialDescriptor) {
        this.f25358a = serialDescriptor;
        this.f25359b = 1;
    }
}
