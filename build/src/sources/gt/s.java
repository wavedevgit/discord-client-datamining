...
public abstract class s extends a {
    ...
    private final KSerializer f25333a;
    ...
    protected void h(kotlinx.serialization.encoding.c decoder, int i10, Object obj, boolean z10) {
        Intrinsics.checkNotNullParameter(decoder, "decoder");
        n(obj, i10, c.a.c(decoder, getDescriptor(), i10, this.f25333a, null, 8, null));
    }
    ...
    public void serialize(Encoder encoder, Object obj) {
        ...
        for (int i10 = 0; i10 < e10; i10++) {
            h10.l(getDescriptor(), i10, this.f25333a, d10.next());
        }
        h10.c(descriptor);
    }
