...
final class q implements s1 {
    ...
    private final Function2 f25325a;

    /* renamed from: b  reason: collision with root package name */
    private final r f25326b;
    ...
    public Object a(KClass key, List types) {
        ...
        Object obj = this.f25326b.get(bs.a.b(key));
        ...
        if (obj3 == null) {
            try {
                ...
                b10 = Result.b((KSerializer) this.f25325a.invoke(key, types));
            } catch (Throwable th2) {
