...
public abstract class a {
    ...
    private static final AtomicBoolean f27394a = new AtomicBoolean(false);

    /* renamed from: b  reason: collision with root package name */
    private static final AtomicBoolean f27395b = new AtomicBoolean(false);
    ...
    public static class b implements Runnable {
        ...
        public void run() {
            ...
            try {
                ...
                e eVar = e.FULL;
                Log.i("TIME4A", mt.c.B(eVar, eVar, locale, t10).l(b10));
    ...
    public static void c(Context context, gt.b bVar) {
        if (!f27394a.getAndSet(true)) {
    ...
    public static void d(Context context) {
        if (context != null && !f27395b.getAndSet(true)) {
