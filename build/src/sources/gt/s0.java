...
public abstract class s0 implements KSerializer {
    ...
    private final KSerializer f25334a;

    /* renamed from: b  reason: collision with root package name */
    private final KSerializer f25335b;
                ...
                if (o10 == -1) {
                    ...
                    if (obj != obj3) {
                        ...
                        if (obj5 != obj4) {
                            ...
                            throw new dt.n("Element 'value' is missing");
                        }
                    } else {
                        throw new dt.n("Element 'key' is missing");
                    }
                } else if (o10 != 0) {
                    if (o10 == 1) {
                        obj5 = c.a.c(b10, getDescriptor(), 1, d(), null, 8, null);
                    } else {
                        throw new dt.n("Invalid index: " + o10);
                    }
                } else {
    ...
    public void serialize(Encoder encoder, Object obj) {
        ...
        b10.l(getDescriptor(), 0, this.f25334a, a(obj));
        b10.l(getDescriptor(), 1, this.f25335b, c(obj));
        b10.c(getDescriptor());
    }

    private s0(KSerializer kSerializer, KSerializer kSerializer2) {
        this.f25334a = kSerializer;
        this.f25335b = kSerializer2;
    }
}
