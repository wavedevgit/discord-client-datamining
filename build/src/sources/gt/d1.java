...
public abstract class d1 extends a {
    ...
    private final KSerializer f25248a;

    /* renamed from: b  reason: collision with root package name */
    private final KSerializer f25249b;
    ...
    public final void h(kotlinx.serialization.encoding.c decoder, int i10, Map builder, boolean z10) {
        ...
        Intrinsics.checkNotNullParameter(decoder, "decoder");
        Intrinsics.checkNotNullParameter(builder, "builder");
        Object c11 = c.a.c(decoder, getDescriptor(), i10, this.f25248a, null, 8, null);
        if (z10) {
        ...
        int i12 = i11;
        if (builder.containsKey(c11) && !(this.f25249b.getDescriptor().getKind() instanceof ft.e)) {
            c10 = decoder.y(getDescriptor(), i12, this.f25249b, kotlin.collections.o0.j(builder, c11));
        } else {
            c10 = c.a.c(decoder, getDescriptor(), i12, this.f25249b, null, 8, null);
        }
        builder.put(c11, c10);
    }
    ...
    public void serialize(Encoder encoder, Object obj) {
        ...
        while (d10.hasNext()) {
            ...
            int i11 = i10 + 1;
            h10.l(getDescriptor(), i10, m(), key);
            i10 += 2;
            h10.l(getDescriptor(), i11, n(), value);
        }
        h10.c(descriptor);
    }
    ...
    private d1(KSerializer kSerializer, KSerializer kSerializer2) {
        super(null);
        this.f25248a = kSerializer;
        this.f25249b = kSerializer2;
    }
}
