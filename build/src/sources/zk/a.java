...
public class a implements m {
    ...
    private static final p[] f56008b = new p[0];

    /* renamed from: a  reason: collision with root package name */
    private final e f56009a = new e();

    private static jk.b b(jk.b bVar) {
        int[] k10 = bVar.k();
        int[] f10 = bVar.f();
            ...
            if (i12 < i13 && i10 < i11) {
                ...
                if (round > 0 && round2 > 0) {
                    if (round2 == round) {
                        ...
                        jk.b bVar2 = new jk.b(round, round2);
    ...
    private static float c(int[] iArr, jk.b bVar) {
        int i10 = bVar.i();
        int l10 = bVar.l();
        int i11 = iArr[0];
        boolean z10 = true;
    ...
    public final Result a(c cVar, Map map) {
        ...
        if (map != null && map.containsKey(fk.e.PURE_BARCODE)) {
            eVar = this.f56009a.c(b(cVar.a()), map);
            b10 = f56008b;
        } else {
            g e10 = new bl.c(cVar.a()).e(map);
            jk.e c10 = this.f56009a.c(e10.a(), map);
            b10 = e10.b();
            eVar = c10;
        }
        ...
        Result result = new Result(eVar.k(), eVar.g(), b10, fk.a.QR_CODE);
        List a10 = eVar.a();
        if (a10 != null) {
