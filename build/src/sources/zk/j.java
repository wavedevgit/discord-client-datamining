...
public abstract class j {
    ...
    private static final al.a f56540a = new al.a();
    ...
    */
    private static int c(mk.b r5, int r6, int r7, boolean r8, int r9, int r10) {
        /*
            if (r8 == 0) goto L4
            r0 = -1
            goto L5
        ...
        L28:
            return r2
        */
        throw new UnsupportedOperationException("Method not decompiled: zk.j.c(mk.b, int, int, boolean, int, int):int");
    }
    ...
    private static int e(int[] iArr, int[] iArr2, int i10) {
        if ((iArr2 == null || iArr2.length <= (i10 / 2) + 3) && i10 >= 0 && i10 <= 512) {
            return f56540a.a(iArr, i10, iArr2);
        }
        throw ik.d.a();
    }
    ...
    private static mk.e g(f fVar) {
        ...
        return h(fVar.k(), iArr, yk.a.b(arrayList), yk.a.b(arrayList3), iArr2);
    }

    private static mk.e h(int i10, int[] iArr, int[] iArr2, int[] iArr3, int[][] iArr4) {
    ...
    /*
        ...
        To view partially-correct add '--show-bad-code' argument
    */
    public static mk.e i(mk.b r17, ik.p r18, ik.p r19, ik.p r20, ik.p r21, int r22, int r23) {
        /*
            Method dump skipped, instructions count: 265
            To view this dump add '--comments-level debug' option
        */
        throw new UnsupportedOperationException("Method not decompiled: zk.j.i(mk.b, ik.p, ik.p, ik.p, ik.p, int, int):mk.e");
    }

    private static mk.e j(int[] iArr, int i10, int[] iArr2) {
        if (iArr.length != 0) {
            int i11 = 1 << (i10 + 1);
            int e10 = e(iArr, iArr2, i11);
            w(iArr, i11);
            mk.e b10 = e.b(iArr, String.valueOf(i10));
    ...
    private static d k(mk.b bVar, int i10, int i11, boolean z10, int i12, int i13, int i14, int i15) {
        int i16;
        int d10;
        int a10;
        ...
        if (!d(d11, i14, i15) || (a10 = yk.a.a((d10 = i.d(q10)))) == -1) {
            return null;
        }
    ...
    /*
        ...
        To view partially-correct add '--show-bad-code' argument
    */
    private static int[] q(mk.b r7, int r8, int r9, boolean r10, int r11, int r12) {
        /*
            r0 = 8
            int[] r1 = new int[r0]
            r2 = 1
        ...
        L34:
            return r1
        */
        throw new UnsupportedOperationException("Method not decompiled: zk.j.q(mk.b, int, int, boolean, int, int):int[]");
    }
    ...
    private static h s(mk.b bVar, c cVar, p pVar, boolean z10, int i10, int i11) {
        int i12;
        int b10;
