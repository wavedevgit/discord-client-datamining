...
public interface b {
    ...
    @hw.b("/api/internal/verify/v1/document-files/{fileId}")
    ...
    Object e(@i("Authorization") @NotNull String str, @s("inquiryId") @NotNull String str2, @hw.a @NotNull SubmitDocumentRequest submitDocumentRequest, @NotNull Continuation<? super z<?>> continuation);
}
