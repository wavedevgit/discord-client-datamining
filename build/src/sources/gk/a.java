...
public class a {
    ...
    public static class c extends d {
        ...
        public c(bl blVar, Matrix matrix) {
            ...
            this.f25749e = blVar.c();
            this.f25750f = blVar.b();
        }
    }
    ...
    public static class d {
        ...
        /* renamed from: b  reason: collision with root package name */
        private final Rect f25752b;

        /* renamed from: c  reason: collision with root package name */
        private final Point[] f25753c;
    ...
    public List b() {
        return Collections.unmodifiableList(this.f25741a);
    }
    ...
    public static class b extends d {
        ...
        /* renamed from: e  reason: collision with root package name */
        private final List f25746e;

        /* renamed from: f  reason: collision with root package name */
        private final float f25747f;

        /* renamed from: g  reason: collision with root package name */
        private final float f25748g;

        /* JADX INFO: Access modifiers changed from: package-private */
        public b(vk vkVar, final Matrix matrix, float f10, float f11) {
            super(vkVar.f(), vkVar.d(), vkVar.g(), vkVar.e(), matrix);
            this.f25746e = w0.a(vkVar.i(), new uj() { // from class: gk.g
                @Override // rg.uj
                public final Object a(Object obj) {
    ...
    public static class C0346a extends d {
        ...
        /* renamed from: f  reason: collision with root package name */
        private final float f25744f;

        /* renamed from: g  reason: collision with root package name */
        private final float f25745g;

        /* JADX INFO: Access modifiers changed from: package-private */
        public C0346a(tk tkVar, final Matrix matrix) {
            super(tkVar.f(), tkVar.d(), tkVar.g(), tkVar.e(), matrix);
            this.f25744f = tkVar.c();
            this.f25745g = tkVar.b();
            List i10 = tkVar.i();
            this.f25743e = w0.a(i10 == null ? new ArrayList() : i10, new uj() { // from class: gk.f
                @Override // rg.uj
                public final Object a(Object obj) {
