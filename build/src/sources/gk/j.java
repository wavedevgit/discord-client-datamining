...
public abstract class j extends ck.b {
    ...
    private static final byte[] f27003d = new byte[0];

    /* renamed from: b  reason: collision with root package name */
    private byte[] f27004b;
    ...
    public j(ck.i iVar) {
        super(iVar);
        this.f27004b = f27003d;
        this.f27005c = new int[32];
    }
    ...
    private void h(int i10) {
        if (this.f27004b.length < i10) {
            this.f27004b = new byte[i10];
        }
    ...
    public b b() {
        ...
        h(d10);
        int[] iArr = this.f27005c;
        for (int i10 = 1; i10 < 5; i10++) {
            byte[] c10 = e10.c((a10 * i10) / 5, this.f27004b);
            int i11 = (d10 * 4) / 5;
    ...
    public a c(int i10, a aVar) {
        ...
        h(d10);
        byte[] c10 = e10.c(i10, this.f27004b);
        int[] iArr = this.f27005c;
