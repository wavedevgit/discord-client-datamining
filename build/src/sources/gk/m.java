...
public final class m {
    ...
    m a() {
        ...
        float f11 = this.f27016i;
        float f12 = this.f27013f;
        float f13 = this.f27015h;
        float f14 = (f10 * f11) - (f12 * f13);
        float f15 = this.f27014g;
        float f16 = this.f27011d;
        float f17 = (f12 * f15) - (f16 * f11);
        float f18 = (f16 * f13) - (f10 * f15);
        float f19 = this.f27010c;
        float f20 = this.f27009b;
        float f21 = (f19 * f13) - (f20 * f11);
        float f22 = this.f27008a;
        return new m(f14, f17, f18, f21, (f11 * f22) - (f19 * f15), (f15 * f20) - (f13 * f22), (f20 * f12) - (f19 * f10), (f19 * f16) - (f12 * f22), (f22 * f10) - (f20 * f16));
    }

    m e(m mVar) {
        float f10 = this.f27008a;
        float f11 = mVar.f27008a;
        float f12 = this.f27011d;
        float f13 = mVar.f27009b;
        float f14 = this.f27014g;
        float f15 = mVar.f27010c;
        float f16 = (f10 * f11) + (f12 * f13) + (f14 * f15);
        float f17 = mVar.f27011d;
        float f18 = mVar.f27012e;
        float f19 = mVar.f27013f;
        float f20 = (f10 * f17) + (f12 * f18) + (f14 * f19);
        float f21 = mVar.f27014g;
        float f22 = mVar.f27015h;
        float f23 = mVar.f27016i;
        float f24 = this.f27009b;
        float f25 = this.f27012e;
        float f26 = this.f27015h;
        float f27 = (f24 * f21) + (f25 * f22) + (f26 * f23);
        float f28 = this.f27010c;
        float f29 = f11 * f28;
        float f30 = this.f27013f;
        float f31 = f29 + (f13 * f30);
        float f32 = this.f27016i;
    ...
    public void f(float[] fArr) {
        float f10 = this.f27008a;
        float f11 = this.f27009b;
        float f12 = this.f27010c;
        float f13 = this.f27011d;
        float f14 = this.f27012e;
        float f15 = this.f27013f;
        float f16 = this.f27014g;
        float f17 = this.f27015h;
        float f18 = this.f27016i;
