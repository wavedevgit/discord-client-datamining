...
public final class a implements ViewBinding {
    ...
    private final ConstraintLayout f26479a;

    /* renamed from: b  reason: collision with root package name */
    public final MaterialSwitch f26480b;

    /* renamed from: c  reason: collision with root package name */
    public final MaterialToolbar f26481c;
    ...
    private a(ConstraintLayout constraintLayout, MaterialSwitch materialSwitch, MaterialToolbar materialToolbar) {
        ...
        this.f26480b = materialSwitch;
        this.f26481c = materialToolbar;
    }

    public static a a(View view) {
        int i10 = fp.a.f24323c;
    ...
    public static a d(LayoutInflater layoutInflater, ViewGroup viewGroup, boolean z10) {
        View inflate = layoutInflater.inflate(fp.b.f24325a, viewGroup, false);
        if (z10) {
