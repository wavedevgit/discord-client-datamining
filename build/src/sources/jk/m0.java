...
final class m0 implements x0 {
    ...
    private final i0 f31131a;

    /* renamed from: b  reason: collision with root package name */
    private final d1 f31132b;

    /* renamed from: c  reason: collision with root package name */
    private final boolean f31133c;

    /* renamed from: d  reason: collision with root package name */
    private final m f31134d;

    private m0(d1 d1Var, m mVar, i0 i0Var) {
        this.f31132b = d1Var;
        this.f31133c = mVar.d(i0Var);
        this.f31134d = mVar;
        this.f31131a = i0Var;
    }
    ...
    private boolean j(w0 w0Var, l lVar, m mVar, p pVar, d1 d1Var, Object obj) {
        ...
        if (tag != j1.f31074a) {
            if (j1.b(tag) == 2) {
                Object a10 = mVar.a(lVar, this.f31131a, j1.a(tag));
                if (a10 != null) {
        ...
        while (w0Var.z() != Integer.MAX_VALUE) {
            ...
            if (tag2 == j1.f31076c) {
                i10 = w0Var.g();
                obj2 = mVar.a(lVar, this.f31131a, i10);
            } else if (tag2 == j1.f31077d) {
                if (obj2 != null) {
    ...
    public void a(Object obj, Object obj2) {
        z0.g(this.f31132b, obj, obj2);
        if (this.f31133c) {
            z0.e(this.f31134d, obj, obj2);
        }
    }
    ...
    public final boolean c(Object obj) {
        return this.f31134d.b(obj).b();
    }

    @Override // jk.x0
    public Object d() {
        i0 i0Var = this.f31131a;
    ...
    public int e(Object obj) {
        int hashCode = this.f31132b.g(obj).hashCode();
        if (this.f31133c) {
            return (hashCode * 53) + this.f31134d.b(obj).hashCode();
        }
        return hashCode;
    }
    ...
    public boolean f(Object obj, Object obj2) {
        if (!this.f31132b.g(obj).equals(this.f31132b.g(obj2))) {
            return false;
        }
        if (this.f31133c) {
            return this.f31134d.b(obj).equals(this.f31134d.b(obj2));
        }
        return true;
    }
    ...
    public void g(Object obj, w0 w0Var, l lVar) {
        h(this.f31132b, this.f31134d, obj, w0Var, lVar);
    }
}
