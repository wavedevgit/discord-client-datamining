...
public abstract class f implements Iterable, Serializable {
    ...
    public static final f f31003e = new i(u.f31163d);

    /* renamed from: i  reason: collision with root package name */
    private static final InterfaceC0422f f31004i;

    /* renamed from: o  reason: collision with root package name */
    private static final Comparator f31005o;
    ...
    public class a extends c {
        ...
        a() {
            this.f31008e = f.this.size();
        }

        @Override // java.util.Iterator
        public boolean hasNext() {
            if (this.f31007d < this.f31008e) {
                return true;
            }
            return false;
        }
    ...
    /* loaded from: /home/runner/work/discord-client-datamining/discord-client-datamining/build/classes4.dex */
    private static final class d implements InterfaceC0422f {
        private d() {
        }

        @Override // jk.f.InterfaceC0422f
    ...
    public static final class e extends i {
        ...
        private final int f31010q;

        /* renamed from: r  reason: collision with root package name */
        private final int f31011r;
        ...
        public byte c(int i10) {
            f.d(i10, size());
            return this.f31012p[this.f31010q + i10];
        }
    ...
    public static class i extends h {
            ...
            if (i11 <= fVar.size()) {
                ...
                if (i12 <= fVar.size()) {
                    if (fVar instanceof i) {
                        i iVar = (i) fVar;
                        byte[] bArr = this.f31012p;
                        byte[] bArr2 = iVar.f31012p;
                        int B = B() + i11;
                        int B2 = B();
                        int B3 = iVar.B() + i10;
                        while (B2 < B) {
        ...
        public final boolean k() {
            int B = B();
            return i1.k(this.f31012p, B, size() + B);
        }

        @Override // jk.f
        protected final int o(int i10, int i11, int i12) {
            return u.h(i10, this.f31012p, B() + i11, i12);
        }
        ...
        public final f q(int i10, int i11) {
            ...
            return new e(this.f31012p, B() + i10, e10);
        }

        @Override // jk.f
        public int size() {
            return this.f31012p.length;
        }

        @Override // jk.f
        protected final String t(Charset charset) {
            return new String(this.f31012p, B(), size(), charset);
        }
    }

    /* loaded from: /home/runner/work/discord-client-datamining/discord-client-datamining/build/classes4.dex */
    private static final class j implements InterfaceC0422f {
        private j() {
        }
    ...
    public static f g(byte[] bArr, int i10, int i11) {
        ...
        return new i(f31004i.a(bArr, i10, i11));
    }

    public static f i(String str) {
        return new i(str.getBytes(u.f31161b));
    }
