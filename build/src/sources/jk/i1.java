...
public abstract class i1 {
    ...
    private static final b f31073a;
    ...
    static final class d extends b {
        ...
        */
        ...
        private static int f(byte[] bArr, long j10, int i10) {
            ...
            while (true) {
                int i13 = i11 + 8;
                if (i13 > i10 || (h1.y(bArr, h1.f31056h + j10) & (-9187201950435737472L)) != 0) {
                    break;
                }
                j10 += 8;
                i11 = i13;
    ...
    public static boolean j(byte[] bArr) {
        return f31073a.b(bArr, 0, bArr.length);
    }

    /* JADX INFO: Access modifiers changed from: package-private */
    public static boolean k(byte[] bArr, int i10, int i11) {
        return f31073a.b(bArr, i10, i11);
    }
}
