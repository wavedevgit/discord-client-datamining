...
public final class m {
    ...
    private final float f31019e;

    /* renamed from: f  reason: collision with root package name */
    private final float f31020f;

    /* renamed from: g  reason: collision with root package name */
    private final float f31021g;

    /* renamed from: h  reason: collision with root package name */
    private final float f31022h;

    /* renamed from: i  reason: collision with root package name */
    private final float f31023i;
    ...
    m a() {
        ...
        float f11 = this.f31023i;
        float f12 = this.f31020f;
        float f13 = this.f31022h;
        float f14 = (f10 * f11) - (f12 * f13);
        float f15 = this.f31021g;
        float f16 = this.f31018d;
        float f17 = (f12 * f15) - (f16 * f11);
        float f18 = (f16 * f13) - (f10 * f15);
        float f19 = this.f31017c;
        float f20 = this.f31016b;
        float f21 = (f19 * f13) - (f20 * f11);
        float f22 = this.f31015a;
    ...
    m e(m mVar) {
        ...
        float f11 = mVar.f31015a;
        float f12 = this.f31018d;
        float f13 = mVar.f31016b;
        float f14 = this.f31021g;
        float f15 = mVar.f31017c;
        float f16 = (f10 * f11) + (f12 * f13) + (f14 * f15);
        float f17 = mVar.f31018d;
        float f18 = mVar.f31019e;
        float f19 = mVar.f31020f;
        float f20 = (f10 * f17) + (f12 * f18) + (f14 * f19);
        float f21 = mVar.f31021g;
        float f22 = mVar.f31022h;
        float f23 = mVar.f31023i;
        float f24 = this.f31016b;
        float f25 = this.f31019e;
        float f26 = this.f31022h;
        float f27 = (f24 * f21) + (f25 * f22) + (f26 * f23);
        float f28 = this.f31017c;
        float f29 = f11 * f28;
        float f30 = this.f31020f;
        float f31 = f29 + (f13 * f30);
        float f32 = this.f31023i;
