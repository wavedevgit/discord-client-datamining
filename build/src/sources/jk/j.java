...
public abstract class j extends fk.b {

    /* renamed from: d  reason: collision with root package name */
    private static final byte[] f31010d = new byte[0];
    ...
    public j(fk.i iVar) {
        super(iVar);
        this.f31011b = f31010d;
        this.f31012c = new int[32];
    }
    ...
    private void h(int i10) {
        if (this.f31011b.length < i10) {
            this.f31011b = new byte[i10];
        }
    ...
    public b b() {
        ...
        for (int i10 = 1; i10 < 5; i10++) {
            byte[] c10 = e10.c((a10 * i10) / 5, this.f31011b);
            int i11 = (d10 * 4) / 5;
    ...
    public a c(int i10, a aVar) {
        ...
        h(d10);
        byte[] c10 = e10.c(i10, this.f31011b);
        int[] iArr = this.f31012c;
