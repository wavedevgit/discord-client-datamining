...
public abstract class p extends k {
    ...
    public static int i(lk.a aVar, int[] iArr, int i10, int[][] iArr2) {
        k.e(aVar, i10, iArr);
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    public static int[] m(lk.a aVar, int i10, boolean z10, int[] iArr) {
        return n(aVar, i10, z10, iArr, new int[iArr.length]);
    }

    private static int[] n(lk.a aVar, int i10, boolean z10, int[] iArr, int[] iArr2) {
        int j10;
        int l10 = aVar.l();
        if (z10) {
            j10 = aVar.k(i10);
    ...
    public abstract int k(lk.a aVar, int[] iArr, StringBuilder sb2);
        ...
        if (i14 < aVar.l() && aVar.n(i13, i14, false)) {
            ...
            if (sb3.length() >= 8) {
                if (g(sb3)) {
                    ...
                    if (map != null) {
                        iArr2 = (int[]) map.get(hk.e.ALLOWED_EAN_EXTENSIONS);
                    }
                    if (iArr2 != null) {
                        for (int i15 : iArr2) {
                            if (i11 != i15) {
                    ...
                    result.h(hk.o.SYMBOLOGY_IDENTIFIER, "]E" + i12);
                    return result;
                }
                throw hk.d.a();
            }
