...
public final class a {
    ...
    private final b f48938a;

    /* renamed from: b  reason: collision with root package name */
    private final pk.b f48939b;

    public a(b bVar) {
        this.f48938a = bVar;
        this.f48939b = new pk.b(bVar);
    }
    ...
    private boolean e(p pVar) {
        if (pVar.c() >= 0.0f && pVar.c() <= this.f48938a.l() - 1 && pVar.d() > 0.0f && pVar.d() <= this.f48938a.h() - 1) {
            return true;
        }
        return false;
    }
    ...
    private int j(p pVar, p pVar2) {
        ...
        int c11 = (int) pVar2.c();
        int i15 = 1;
        int min = Math.min(this.f48938a.h() - 1, (int) pVar2.d());
        int i16 = 0;
    ...
    public g b() {
        ...
        if (a10 != null) {
            ...
            return new g(g(this.f48938a, pVar, pVar2, pVar3, pVar4, i10, i13), new p[]{pVar, pVar2, pVar3, pVar4});
        }
        throw kk.k.a();
    }
}
