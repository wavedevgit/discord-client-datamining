...
public class b implements com.android.volley.h {
    ...
    protected final g f21456a;

    /* renamed from: b  reason: collision with root package name */
    private final a f21457b;

    /* renamed from: c  reason: collision with root package name */
    protected final c f21458c;
    ...
    public com.android.volley.k a(n nVar) {
        ...
        while (true) {
            try {
                f a10 = this.f21457b.a(nVar, e.c(nVar.getCacheEntry()));
                try {
                    int d10 = a10.d();
                    List c10 = a10.c();
                    if (d10 == 304) {
                    ...
                    if (a11 != null) {
                        bArr2 = i.c(a11, a10.b(), this.f21458c);
                    } else {
                        bArr2 = new byte[0];
                    }
                    byte[] bArr3 = bArr2;
