...
public class h extends d6.a {
    ...
    private final SSLSocketFactory f21483a;
    ...
    public static class a extends FilterInputStream {
        ...
        private final HttpURLConnection f21484d;

        a(HttpURLConnection httpURLConnection) {
            super(h.j(httpURLConnection));
            this.f21484d = httpURLConnection;
        }

        @Override // java.io.FilterInputStream, java.io.InputStream, java.io.Closeable, java.lang.AutoCloseable
        public void close() {
            super.close();
            this.f21484d.disconnect();
        }
    }
    ...
    private HttpURLConnection k(URL url, n nVar) {
        ...
        f10.setDoInput(true);
        if ("https".equals(url.getProtocol()) && (sSLSocketFactory = this.f21483a) != null) {
