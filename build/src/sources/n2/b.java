...
public final class b extends m2.b {
    ...
    private final Context f39667g;

    /* renamed from: h  reason: collision with root package name */
    public j f39668h;

    /* renamed from: i  reason: collision with root package name */
    public Executor f39669i;

    /* renamed from: j  reason: collision with root package name */
    private CancellationSignal f39670j;
    ...
    public static final class C0505b extends Lambda implements Function2 {
        ...
        public static final C0505b f39672d = new C0505b();
    ...
    public static final class e extends Lambda implements Function0 {
        ...
        /* renamed from: e  reason: collision with root package name */
        final /* synthetic */ Ref.ObjectRef f39677e;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        e(Ref.ObjectRef objectRef) {
            super(0);
            this.f39677e = objectRef;
        }
        ...
        public final void m1207invoke() {
            Executor p10 = b.this.p();
            final b bVar = b.this;
            final Ref.ObjectRef objectRef = this.f39677e;
    ...
    public static final class i extends ResultReceiver {
        ...
        public void onReceiveResult(int i10, Bundle resultData) {
            ...
            if (b.this.f(resultData, new a(m2.a.f37787b), b.this.p(), b.this.o(), b.this.f39670j)) {
                return;
            }
    ...
    public b(Context context) {
        ...
        this.f39667g = context;
        this.f39671k = new i(new Handler(Looper.getMainLooper()));
    }
    ...
    public ve.a l(c0 request) {
        ...
        return n2.a.f39665a.a(request, this.f39667g);
    }
    ...
    public d0 m(ve.i response) {
        ...
        if (response.g() != null) {
            ...
            hVar = new h0(k.f42349a.N(response));
        } else {
    ...
    public final Executor p() {
        Executor executor = this.f39669i;
        if (executor != null) {
            return executor;
        }
    ...
    public final void q(int i10, int i11, Intent intent) {
        ...
        } else if (!m2.b.h(i11, C0505b.f39672d, new c(), this.f39670j)) {
            try {
                ve.i e10 = ve.e.c(this.f39667g).e(intent);
                Intrinsics.checkNotNullExpressionValue(e10, "getSignInCredentialFromIntent(...)");
                m2.b.e(this.f39670j, new d(m(e10)));
            } catch (ef.b e11) {
                ...
                m2.b.e(this.f39670j, new e(objectRef));
            } catch (m e12) {
                m2.b.e(this.f39670j, new f(e12));
            } catch (Throwable th2) {
                m2.b.e(this.f39670j, new g(new p(th2.getMessage())));
            }
        }
    }
    ...
    public void r(c0 request, j callback, Executor executor, CancellationSignal cancellationSignal) {
        ...
        this.f39670j = cancellationSignal;
        s(callback);
        t(executor);
        ...
        ve.a l10 = l(request);
        Intent intent = new Intent(this.f39667g, HiddenActivity.class);
        intent.putExtra("REQUEST_TYPE", l10);
        c(this.f39671k, intent, "BEGIN_SIGN_IN");
        try {
            this.f39667g.startActivity(intent);
