...
public final class b extends m2.b {
    ...
    public static final a f38399l = new a(null);

    /* renamed from: g  reason: collision with root package name */
    private final Context f38400g;

    /* renamed from: h  reason: collision with root package name */
    public j f38401h;

    /* renamed from: i  reason: collision with root package name */
    public Executor f38402i;

    /* renamed from: j  reason: collision with root package name */
    private CancellationSignal f38403j;

    /* renamed from: k  reason: collision with root package name */
    private final i f38404k;
    ...
    public static final class C0527b extends Lambda implements Function2 {
        ...
        public static final C0527b f38405d = new C0527b();
    ...
    public static final class e extends Lambda implements Function0 {
        ...
        /* renamed from: e  reason: collision with root package name */
        final /* synthetic */ Ref.ObjectRef f38410e;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        e(Ref.ObjectRef objectRef) {
            super(0);
            this.f38410e = objectRef;
        }
        ...
        public final void m1208invoke() {
            Executor p10 = b.this.p();
            final b bVar = b.this;
            final Ref.ObjectRef objectRef = this.f38410e;
    ...
    public static final class i extends ResultReceiver {
        ...
        public void onReceiveResult(int i10, Bundle resultData) {
            ...
            if (b.this.f(resultData, new a(m2.a.f36824b), b.this.p(), b.this.o(), b.this.f38403j)) {
                return;
            }
    ...
    public b(Context context) {
        ...
        this.f38404k = new i(new Handler(Looper.getMainLooper()));
    }
    ...
    public ve.a l(c0 request) {
        ...
        return n2.a.f38398a.a(request, this.f38400g);
    }
    ...
    public d0 m(ve.i response) {
        ...
        if (response.h() != null) {
            ...
            hVar = new h0(k.f41422a.N(response));
        } else {
    ...
    public final Executor p() {
        Executor executor = this.f38402i;
        if (executor != null) {
            return executor;
        }
    ...
    public final void q(int i10, int i11, Intent intent) {
        ...
        } else if (!m2.b.h(i11, C0527b.f38405d, new c(), this.f38403j)) {
            try {
                ve.i e10 = ve.e.c(this.f38400g).e(intent);
                Intrinsics.checkNotNullExpressionValue(e10, "getSignInCredentialFromIntent(...)");
                m2.b.e(this.f38403j, new d(m(e10)));
            } catch (ef.b e11) {
                ...
                m2.b.e(this.f38403j, new e(objectRef));
            } catch (m e12) {
                m2.b.e(this.f38403j, new f(e12));
            } catch (Throwable th2) {
                m2.b.e(this.f38403j, new g(new p(th2.getMessage())));
            }
        }
    }
    ...
    public void r(c0 request, j callback, Executor executor, CancellationSignal cancellationSignal) {
        ...
        this.f38403j = cancellationSignal;
        s(callback);
        t(executor);
        ...
        ve.a l10 = l(request);
        Intent intent = new Intent(this.f38400g, HiddenActivity.class);
        intent.putExtra("REQUEST_TYPE", l10);
        c(this.f38404k, intent, "BEGIN_SIGN_IN");
        try {
            this.f38400g.startActivity(intent);
