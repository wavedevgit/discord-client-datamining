...
public final class b extends m2.b {
    ...
    public static final a f36748l = new a(null);

    /* renamed from: g  reason: collision with root package name */
    private final Context f36749g;

    /* renamed from: h  reason: collision with root package name */
    public j f36750h;

    /* renamed from: i  reason: collision with root package name */
    public Executor f36751i;

    /* renamed from: j  reason: collision with root package name */
    private CancellationSignal f36752j;

    /* renamed from: k  reason: collision with root package name */
    private final i f36753k;
    ...
    public static final class C0522b extends Lambda implements Function2 {
        ...
        public static final C0522b f36754d = new C0522b();
    ...
    public static final class e extends Lambda implements Function0 {
        ...
        /* renamed from: e  reason: collision with root package name */
        final /* synthetic */ Ref.ObjectRef f36759e;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        e(Ref.ObjectRef objectRef) {
            super(0);
            this.f36759e = objectRef;
        }
        ...
        public final void m1211invoke() {
            Executor p10 = b.this.p();
            final b bVar = b.this;
            final Ref.ObjectRef objectRef = this.f36759e;
    ...
    public static final class i extends ResultReceiver {
        ...
        public void onReceiveResult(int i10, Bundle resultData) {
            ...
            if (b.this.f(resultData, new a(m2.a.f36106b), b.this.p(), b.this.o(), b.this.f36752j)) {
                return;
            }
    ...
    public b(Context context) {
        ...
        this.f36749g = context;
        this.f36753k = new i(new Handler(Looper.getMainLooper()));
    }
    ...
    public we.a l(c0 request) {
        ...
        return n2.a.f36747a.a(request, this.f36749g);
    }
    ...
    public d0 m(we.i response) {
        ...
        if (response.g() != null) {
            ...
            hVar = new h0(k.f38526a.N(response));
        } else {
    ...
    public final Executor p() {
        Executor executor = this.f36751i;
        if (executor != null) {
            return executor;
        }
    ...
    public final void q(int i10, int i11, Intent intent) {
        ...
        } else if (!m2.b.h(i11, C0522b.f36754d, new c(), this.f36752j)) {
            try {
                we.i c10 = we.e.c(this.f36749g).c(intent);
                Intrinsics.checkNotNullExpressionValue(c10, "getSignInCredentialFromIntent(...)");
                m2.b.e(this.f36752j, new d(m(c10)));
            } catch (ff.b e10) {
                ...
                m2.b.e(this.f36752j, new e(objectRef));
            } catch (m e11) {
                m2.b.e(this.f36752j, new f(e11));
            } catch (Throwable th2) {
                m2.b.e(this.f36752j, new g(new p(th2.getMessage())));
            }
        }
    }
    ...
    public void r(c0 request, j callback, Executor executor, CancellationSignal cancellationSignal) {
        ...
        this.f36752j = cancellationSignal;
        s(callback);
        t(executor);
        ...
        we.a l10 = l(request);
        Intent intent = new Intent(this.f36749g, HiddenActivity.class);
        intent.putExtra("REQUEST_TYPE", l10);
        c(this.f36753k, intent, "BEGIN_SIGN_IN");
        try {
            this.f36749g.startActivity(intent);
