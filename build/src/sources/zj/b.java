...
public abstract class b {
    ...
    private static final SparseArray f56454a;

    /* renamed from: b  reason: collision with root package name */
    private static final SparseArray f56455b;

    /* renamed from: c  reason: collision with root package name */
    static final AtomicReference f56456c;

    /* renamed from: d  reason: collision with root package name */
    private static final Map f56457d;

    static {
        SparseArray sparseArray = new SparseArray();
        f56454a = sparseArray;
        SparseArray sparseArray2 = new SparseArray();
        f56455b = sparseArray2;
        f56456c = new AtomicReference();
    ...
    public static wj c(wj.b bVar) {
        int a10 = bVar.a();
        f1 f1Var = new f1();
        if (a10 == 0) {
            f1Var.f(f56457d.values());
        } else {
            for (Map.Entry entry : f56457d.entrySet()) {
    ...
    public static void e(nk nkVar, final xe xeVar) {
        nkVar.f(new mk() { // from class: zj.a
            @Override // og.mk
            public final ck zza() {
                we weVar;
                ze zeVar = new ze();
    ...
    public static boolean f() {
        AtomicReference atomicReference = f56456c;
        if (atomicReference.get() != null) {
            return ((Boolean) atomicReference.get()).booleanValue();
        }
        boolean b10 = n.b(uj.i.c().b());
