...
public abstract class b {
    ...
    private static final int[] f40013a = {1, 2, 3, 6};

    /* renamed from: b  reason: collision with root package name */
    private static final int[] f40014b = {48000, 44100, 32000};

    /* renamed from: c  reason: collision with root package name */
    private static final int[] f40015c = {24000, 22050, 16000};

    /* renamed from: d  reason: collision with root package name */
    private static final int[] f40016d = {2, 1, 2, 3, 3, 4, 4, 5};

    /* renamed from: e  reason: collision with root package name */
    private static final int[] f40017e = {32, 40, 48, 56, 64, 80, 96, 112, IntBufferBatchMountItem.INSTRUCTION_UPDATE_LAYOUT, 160, 192, 224, IntBufferBatchMountItem.INSTRUCTION_UPDATE_EVENT_EMITTER, 320, 384, 448, IntBufferBatchMountItem.INSTRUCTION_UPDATE_PADDING, 576, DiscordVideoMediaSource.DEFAULT_WIDTH};

    /* renamed from: f  reason: collision with root package name */
    private static final int[] f40018f = {69, 87, 104, 121, 139, 174, 208, 243, 278, 348, 417, 487, 557, 696, 835, 975, 1114, 1253, 1393};
    ...
    public static final class C0513b {
        ...
        private C0513b(String str, int i10, int i11, int i12, int i13, int i14, int i15) {
            this.f40019a = str;
            this.f40020b = i10;
            this.f40022d = i11;
            this.f40021c = i12;
    ...
    public static Format d(h0 h0Var, String str, String str2, rc.m mVar) {
        g0 g0Var = new g0();
        g0Var.m(h0Var);
        int i10 = f40014b[g0Var.h(2)];
        g0Var.r(8);
        int i11 = f40016d[g0Var.h(3)];
        if (g0Var.h(1) != 0) {
            i11++;
        }
        int i12 = f40017e[g0Var.h(5)] * 1000;
        g0Var.c();
        h0Var.U(g0Var.d());
    ...
    public static int e(ByteBuffer byteBuffer) {
        ...
        if (((byteBuffer.get(byteBuffer.position() + 5) & 248) >> 3) > 10) {
            ...
            return f40013a[i10] * IntBufferBatchMountItem.INSTRUCTION_UPDATE_EVENT_EMITTER;
        }
        return 1536;
    }

    public static C0513b f(g0 g0Var) {
        boolean z10;
        String str;
        int c10;
        int i10;
        ...
        if (z10) {
            ...
            i11 = f40016d[h18] + (g0Var.g() ? 1 : 0);
            i12 = 1536;
            str2 = str;
            i13 = i22;
        }
        return new C0513b(str2, i19, i11, i10, c10, i12, i13);
    }
