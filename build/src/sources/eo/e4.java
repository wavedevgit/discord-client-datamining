...
public final class e4 implements Parcelable {
    ...
    private final String f21775d;

    /* renamed from: e  reason: collision with root package name */
    private final String f21776e;

    /* renamed from: i  reason: collision with root package name */
    private final List f21777i;
    ...
    public e4(String countryName, String countryCode, List ids) {
        ...
        this.f21775d = countryName;
        this.f21776e = countryCode;
        this.f21777i = ids;
    }
    ...
    public boolean equals(Object obj) {
        ...
        e4 e4Var = (e4) obj;
        if (Intrinsics.areEqual(this.f21775d, e4Var.f21775d) && Intrinsics.areEqual(this.f21776e, e4Var.f21776e) && Intrinsics.areEqual(this.f21777i, e4Var.f21777i)) {
            return true;
        }
        return false;
    }
    ...
    public int hashCode() {
        return (((this.f21775d.hashCode() * 31) + this.f21776e.hashCode()) * 31) + this.f21777i.hashCode();
    }

    public String toString() {
        String str = this.f21775d;
        String str2 = this.f21776e;
        List list = this.f21777i;
    ...
    public final void writeToParcel(Parcel dest, int i10) {
        ...
        dest.writeString(this.f21775d);
        dest.writeString(this.f21776e);
        List<c4> list = this.f21777i;
