...
public final class b3 implements dq.b {

    /* renamed from: d  reason: collision with root package name */
    private final List f21702d;

    /* renamed from: e  reason: collision with root package name */
    private final List f21703e;

    /* renamed from: i  reason: collision with root package name */
    private final StepStyles.UiStepStyle f21704i;

    /* renamed from: o  reason: collision with root package name */
    private final String f21705o;

    /* renamed from: p  reason: collision with root package name */
    private final String f21706p;
    ...
    public static final a f21701s = new a(null);
    @NotNull
    ...
    public static final class a {
        ...
        public final b3 a(String str, String str2, String str3, StepStyles.DocumentStepStyle documentStepStyle) {
            ...
            if (documentStepStyle != null && (buttonPrimaryStyleValue = documentStepStyle.getButtonPrimaryStyleValue()) != null) {
                buttonCombinedStepComponentStyle = eo.b.b(buttonPrimaryStyleValue);
            } else {
            ...
            if (documentStepStyle != null && (buttonSecondaryStyleValue = documentStepStyle.getButtonSecondaryStyleValue()) != null) {
                buttonCombinedStepComponentStyle2 = eo.b.a(buttonSecondaryStyleValue);
            }
    ...
    public b3(List list, List componentConfigs, StepStyles.UiStepStyle uiStepStyle, String str, String str2, String str3, String str4) {
        ...
        this.f21702d = list;
        this.f21703e = componentConfigs;
        this.f21704i = uiStepStyle;
        this.f21705o = str;
        this.f21706p = str2;
        this.f21707q = str3;
        this.f21708r = str4;
    ...
    public final void writeToParcel(Parcel dest, int i10) {
        ...
        List<Parcelable> list = this.f21702d;
        if (list == null) {
            dest.writeInt(0);
        } else {
            dest.writeInt(1);
        ...
        List<Parcelable> list2 = this.f21703e;
        dest.writeInt(list2.size());
        for (Parcelable parcelable2 : list2) {
            dest.writeParcelable(parcelable2, i10);
        }
        dest.writeParcelable(this.f21704i, i10);
        dest.writeString(this.f21705o);
        dest.writeString(this.f21706p);
        dest.writeString(this.f21707q);
        dest.writeString(this.f21708r);
    }
}
