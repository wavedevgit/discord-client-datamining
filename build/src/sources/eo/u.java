...
public final class u implements dq.b {

    /* renamed from: d  reason: collision with root package name */
    private final List f21999d;

    /* renamed from: e  reason: collision with root package name */
    private final List f22000e;

    /* renamed from: i  reason: collision with root package name */
    private final StepStyles.UiStepStyle f22001i;

    /* renamed from: o  reason: collision with root package name */
    private final String f22002o;

    /* renamed from: p  reason: collision with root package name */
    private final String f22003p;

    /* renamed from: q  reason: collision with root package name */
    private final String f22004q;

    /* renamed from: r  reason: collision with root package name */
    private final String f22005r;

    /* renamed from: s  reason: collision with root package name */
    public static final a f21998s = new a(null);
    @NotNull
    ...
    public u(List list, List componentConfigs, StepStyles.UiStepStyle uiStepStyle, String str, String str2, String str3, String str4) {
        ...
        this.f21999d = list;
        this.f22000e = componentConfigs;
        this.f22001i = uiStepStyle;
        this.f22002o = str;
        this.f22003p = str2;
        this.f22004q = str3;
        this.f22005r = str4;
    ...
    public final void writeToParcel(Parcel dest, int i10) {
        ...
        List<Parcelable> list = this.f21999d;
        if (list == null) {
            dest.writeInt(0);
        } else {
            dest.writeInt(1);
        ...
        List<Parcelable> list2 = this.f22000e;
        dest.writeInt(list2.size());
        for (Parcelable parcelable2 : list2) {
            dest.writeParcelable(parcelable2, i10);
        }
        dest.writeParcelable(this.f22001i, i10);
        dest.writeString(this.f22002o);
        dest.writeString(this.f22003p);
        dest.writeString(this.f22004q);
        dest.writeString(this.f22005r);
    }
}
