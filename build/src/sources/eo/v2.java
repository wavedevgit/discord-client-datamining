...
@Metadata(d1 = {"\u0000J\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\u0010\u000e\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\u0010\u0002\n\u0002\b\u0003\n\u0002\u0018\u0002\n\u0002\u0010 \n\u0002\u0018\u0002\n\u0002\b\u0004\n\u0002\u0010\u000b\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0002\b\n\u0018\u00002\b\u0012\u0004\u0012\u00020\u00020\u0001:\u0003\u001d\u0016\u001bB/\b\u0007\u0012\u0006\u0010\u0004\u001a\u00020\u0003\u0012\u0006\u0010\u0006\u001a\u00020\u0005\u0012\u0006\u0010\b\u001a\u00020\u0007\u0012\f\u0010\u000b\u001a\b\u0012\u0004\u0012\u00020\n0\t¢\u0006\u0004\b\f\u0010\rJ(\u0010\u0012\u001a\u00020\n*\b\u0012\u0004\u0012\u00020\u00020\u000e2\f\u0010\u0011\u001a\b\u0012\u0004\u0012\u00020\u00100\u000fH\u0082@¢\u0006\u0004\b\u0012\u0010\u0013J\u001b\u0010\u0016\u001a\u00020\u00152\n\u0010\u0014\u001a\u0006\u0012\u0002\b\u00030\u0001H\u0016¢\u0006\u0004\b\u0016\u0010\u0017J\u0015\u0010\u0019\u001a\b\u0012\u0004\u0012\u00020\u00020\u0018H\u0016¢\u0006\u0004\b\u0019\u0010\u001aR\u0014\u0010\u0004\u001a\u00020\u00038\u0002X\u0082\u0004¢\u0006\u0006\n\u0004\b\u001b\u0010\u001cR\u0014\u0010\u0006\u001a\u00020\u00058\u0002X\u0082\u0004¢\u0006\u0006\n\u0004\b\u001d\u0010\u001eR\u0014\u0010\b\u001a\u00020\u00078\u0002X\u0082\u0004¢\u0006\u0006\n\u0004\b\u0012\u0010\u001fR\u001a\u0010\u000b\u001a\b\u0012\u0004\u0012\u00020\n0\t8\u0002X\u0082\u0004¢\u0006\u0006\n\u0004\b \u0010!¨\u0006\""}, d2 = {"Leo/v2;", "Lbn/o;", "Leo/v2$c;", "", "key", "Landroid/content/Context;", "context", "Lwp/c;", "sdkFilesManager", "Lkotlin/Function0;", "", "launchPicker", "<init>", "(Ljava/lang/String;Landroid/content/Context;Lwp/c;Lkotlin/jvm/functions/Function0;)V", "Lkotlinx/coroutines/flow/FlowCollector;", "", "Landroid/net/Uri;", "documentSelectResult", "d", "(Lkotlinx/coroutines/flow/FlowCollector;Ljava/util/List;Lkotlin/coroutines/Continuation;)Ljava/lang/Object;", "otherWorker", "", "a", "(Lbn/o;)Z", "Lkotlinx/coroutines/flow/Flow;", "run", "()Lkotlinx/coroutines/flow/Flow;", "b", "Ljava/lang/String;", "c", "Landroid/content/Context;", "Lwp/c;", "e", "Lkotlin/jvm/functions/Function0;", "document_release"}, k = 1, mv = {2, 0, 0}, xi = 48)
...
public final class v2 implements bn.o<c> {
    ...
    private final wp.c f22013d;

    /* renamed from: e  reason: collision with root package name */
    private final Function0 f22014e;
    ...
    public static final class a {
        ...
        /* renamed from: d  reason: collision with root package name */
        public static final a f22015d = new a("FileNotFound", 0);

        /* renamed from: e  reason: collision with root package name */
        public static final a f22016e = new a("PermissionDenied", 1);

        /* renamed from: i  reason: collision with root package name */
        private static final /* synthetic */ a[] f22017i;

        /* renamed from: o  reason: collision with root package name */
        private static final /* synthetic */ EnumEntries f22018o;
    ...
    public static final class b {
        ...
        private final ActivityResultLauncher f22019a;

        /* renamed from: b  reason: collision with root package name */
        private final ActivityResultLauncher f22020b;

        /* renamed from: c  reason: collision with root package name */
        private final Context f22021c;

        /* renamed from: d  reason: collision with root package name */
        private final wp.c f22022d;

        public b(ActivityResultLauncher openDocumentLauncher, ActivityResultLauncher selectFromPhotoLibraryLauncher, Context context, wp.c sdkFilesManager) {
            ...
            this.f22019a = openDocumentLauncher;
            this.f22020b = selectFromPhotoLibraryLauncher;
            this.f22021c = context;
            this.f22022d = sdkFilesManager;
        }
        ...
        public final v2 c() {
            return new v2("DocumentPicker", this.f22021c, this.f22022d, new Function0() { // from class: eo.w2
        ...
        public final v2 e() {
            return new v2("PhotoLibraryPicker", this.f22021c, this.f22022d, new Function0() { // from class: eo.x2
                @Override // kotlin.jvm.functions.Function0
                public final Object invoke() {
                    Unit f10;
    ...
    public static abstract class c {
        ...
        public static final class b extends c {
            ...
            public b(List absoluteFilePaths, a reason) {
                ...
                this.f22024a = absoluteFilePaths;
                this.f22025b = reason;
            }
            ...
            public boolean equals(Object obj) {
                ...
                b bVar = (b) obj;
                if (Intrinsics.areEqual(this.f22024a, bVar.f22024a) && this.f22025b == bVar.f22025b) {
                    return true;
                }
                return false;
            }
        ...
        /* renamed from: eo.v2$c$c  reason: collision with other inner class name */
        /* loaded from: /home/runner/work/discord-client-datamining/discord-client-datamining/build/classes4.dex */
        public static final class C0303c extends c {

            /* renamed from: a  reason: collision with root package name */
            private final List f22026a;

            /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
            public C0303c(List absoluteFilePaths) {
                super(null);
                Intrinsics.checkNotNullParameter(absoluteFilePaths, "absoluteFilePaths");
                this.f22026a = absoluteFilePaths;
            }
            ...
            public boolean equals(Object obj) {
                ...
                if ((obj instanceof C0303c) && Intrinsics.areEqual(this.f22026a, ((C0303c) obj).f22026a)) {
                    return true;
                }
                return false;
            }
    ...
    static final class d extends kotlin.coroutines.jvm.internal.k implements Function2 {
        ...
        /* renamed from: e  reason: collision with root package name */
        private /* synthetic */ Object f22028e;
        ...
        public static final class a extends kotlin.coroutines.jvm.internal.k implements Function2 {
            ...
            public final Continuation create(Object obj, Continuation continuation) {
                return new a(this.f22031e, continuation);
            }
        ...
        public static final class b implements FlowCollector {
            ...
            /* renamed from: d  reason: collision with root package name */
            final /* synthetic */ v2 f22032d;

            /* renamed from: e  reason: collision with root package name */
            final /* synthetic */ FlowCollector f22033e;

            b(v2 v2Var, FlowCollector flowCollector) {
                this.f22032d = v2Var;
                this.f22033e = flowCollector;
            }

            @Override // kotlinx.coroutines.flow.FlowCollector
            /* renamed from: a */
            public final Object emit(List list, Continuation continuation) {
                Object d10 = this.f22032d.d(this.f22033e, list, continuation);
                if (d10 == wr.b.f()) {
                    return d10;
                }
                return Unit.f32008a;
        ...
        */
        public final java.lang.Object invokeSuspend(java.lang.Object r11) {
            ...
            L1d:
                ...
                goto L93
            L22:
                java.lang.Object r1 = r10.f22028e
            ...
            L36:
                kotlin.c.b(r11)
                java.lang.Object r11 = r10.f22028e
                kotlinx.coroutines.flow.FlowCollector r11 = (kotlinx.coroutines.flow.FlowCollector) r11
                eo.v2$d$c r1 = new eo.v2$d$c
                r1.<init>(r6)
                r10.f22028e = r11
                r10.f22027d = r5
                r7 = 100
                java.lang.Object r1 = os.t1.d(r7, r1, r10)
                if (r1 != r0) goto L4f
                goto L92
            L4f:
                r9 = r1
            ...
            L52:
                ...
                r10.f22028e = r6
                r10.f22027d = r4
                java.lang.Object r11 = eo.v2.c(r2, r1, r11, r10)
                if (r11 != r0) goto L63
                goto L92
            L63:
            ...
            L66:
                os.c1 r11 = os.m0.c()
                eo.v2$d$a r4 = new eo.v2$d$a
                eo.v2 r5 = eo.v2.this
                r4.<init>(r5, r6)
                r10.f22028e = r1
                r10.f22027d = r3
                java.lang.Object r11 = os.g.g(r11, r4, r10)
                if (r11 != r0) goto L7c
                goto L92
            L7c:
                cp.t r11 = new cp.t
                r11.<init>()
                eo.v2$d$b r3 = new eo.v2$d$b
                eo.v2 r4 = eo.v2.this
                r3.<init>(r4, r1)
                r10.f22028e = r6
                r10.f22027d = r2
            ...
            L93:
                ...
                throw r11
            */
            throw new UnsupportedOperationException("Method not decompiled: eo.v2.d.invokeSuspend(java.lang.Object):java.lang.Object");
        }
    ...
    public v2(String key, Context context, wp.c sdkFilesManager, Function0 launchPicker) {
        ...
        this.f22013d = sdkFilesManager;
        this.f22014e = launchPicker;
    }
    ...
    */
    public final java.lang.Object d(kotlinx.coroutines.flow.FlowCollector r11, java.util.List r12, kotlin.coroutines.Continuation r13) {
        /*
            ...
            android.content.Context r1 = r10.f22012c
            android.content.ContentResolver r1 = r1.getContentResolver()
            boolean r2 = r12.isEmpty()
            if (r2 == 0) goto L20
            eo.v2$c$a r12 = eo.v2.c.a.f22023a
            java.lang.Object r11 = r11.emit(r12, r13)
            java.lang.Object r12 = wr.b.f()
            if (r11 != r12) goto L1d
            return r11
        L1d:
            kotlin.Unit r11 = kotlin.Unit.f32008a
        ...
        L2d:
            ...
            wp.c r7 = r10.f22013d     // Catch: java.lang.SecurityException -> L7b java.io.FileNotFoundException -> L7f
            if (r6 != 0) goto L47
        ...
        L47:
            ...
            r8 = 0
            r9 = 2
            bs.b.b(r5, r7, r8, r9, r3)     // Catch: java.lang.Throwable -> L68
            bs.c.a(r5, r3)     // Catch: java.lang.Throwable -> L66
            bs.c.a(r7, r3)     // Catch: java.lang.SecurityException -> L7b java.io.FileNotFoundException -> L7f
        ...
        L6a:
            r6 = move-exception
            bs.c.a(r5, r4)     // Catch: java.lang.Throwable -> L66
            throw r6     // Catch: java.lang.Throwable -> L66
        L6f:
            throw r4     // Catch: java.lang.Throwable -> L70
        L70:
            r5 = move-exception
            bs.c.a(r7, r4)     // Catch: java.lang.SecurityException -> L7b java.io.FileNotFoundException -> L7f
        ...
        L7b:
            eo.v2$a r4 = eo.v2.a.f22016e
        L7d:
            r5 = r3
            goto L82
        L7f:
            eo.v2$a r4 = eo.v2.a.f22015d
            goto L7d
        L82:
            if (r5 == 0) goto L2d
            r2.add(r5)
    ...
    public boolean a(bn.o otherWorker) {
        ...
        if ((otherWorker instanceof v2) && Intrinsics.areEqual(this.f22011b, ((v2) otherWorker).f22011b)) {
            return true;
        }
        return false;
    }
    ...
    @Override // bn.o
    public Flow run() {
        return rs.g.x(rs.g.v(new d(null)), os.m0.b());
    }
}
