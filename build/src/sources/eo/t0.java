...
public final class t0 extends RecyclerView.Adapter {
    ...
    private final StepStyles.GovernmentIdStepStyle f22355b;

    /* renamed from: c  reason: collision with root package name */
    private final NextStep.GovernmentId.AssetConfig.SelectPage f22356c;

    /* renamed from: d  reason: collision with root package name */
    private final Function1 f22357d;

    /* renamed from: e  reason: collision with root package name */
    private final HashMap f22358e;
    ...
    public /* synthetic */ class a {
        ...
        static {
            ...
            try {
                iArr[g4.f21997d.ordinal()] = 1;
            } catch (NoSuchFieldError unused) {
            }
            try {
                iArr[g4.f21998e.ordinal()] = 2;
            } catch (NoSuchFieldError unused2) {
            }
            try {
                iArr[g4.f21999i.ordinal()] = 3;
            } catch (NoSuchFieldError unused3) {
            }
            try {
                iArr[g4.f22000o.ordinal()] = 4;
    ...
    public t0(Context context, List data, StepStyles.GovernmentIdStepStyle governmentIdStepStyle, NextStep.GovernmentId.AssetConfig.SelectPage selectPage, Function1 onClick) {
        ...
        this.f22354a = data;
        this.f22355b = governmentIdStepStyle;
        this.f22356c = selectPage;
        this.f22357d = onClick;
        this.f22358e = new HashMap();
        this.f22359f = !mp.s.b(context, ep.a.f22456d, null, false, false, 14, null);
        this.f22360g = true;
    }

    private final void b(io.e eVar) {
        ...
        StepStyles.GovernmentIdStepStyle governmentIdStepStyle = this.f22355b;
        if (governmentIdStepStyle != null && (governmentIdVerticalOptionTextStyle = governmentIdStepStyle.getGovernmentIdVerticalOptionTextStyle()) != null) {
            TextView label = eVar.f28575e;
            Intrinsics.checkNotNullExpressionValue(label, "label");
            fq.f0.n(label, governmentIdVerticalOptionTextStyle, null, 2, null);
        }
        StepStyles.GovernmentIdStepStyle governmentIdStepStyle2 = this.f22355b;
        if (governmentIdStepStyle2 != null && (chevronColor = governmentIdStepStyle2.getChevronColor()) != null) {
            eVar.f28572b.setColorFilter(chevronColor.intValue());
        }
        StepStyles.GovernmentIdStepStyle governmentIdStepStyle3 = this.f22355b;
        if (governmentIdStepStyle3 != null && (backgroundColorValue = governmentIdStepStyle3.getBackgroundColorValue()) != null) {
            int intValue = backgroundColorValue.intValue();
            Integer activeOptionBackgroundColorValue = this.f22355b.getActiveOptionBackgroundColorValue();
        ...
        StepStyles.GovernmentIdStepStyle governmentIdStepStyle4 = this.f22355b;
        if (governmentIdStepStyle4 != null && (governmentIdSelectOptionMinRowHeight = governmentIdStepStyle4.getGovernmentIdSelectOptionMinRowHeight()) != null) {
            eVar.f28576f.setMinHeight((int) mp.h.a(governmentIdSelectOptionMinRowHeight.doubleValue()));
        }
    }
    ...
    private final Drawable d(Context context, Integer num, Integer num2, Drawable drawable) {
        ...
        Drawable b10 = g.a.b(context, l4.f22051e);
    ...
    public static final void e(t0 t0Var, b0 b0Var, View view) {
        t0Var.f22357d.invoke(b0Var.b());
    }

    private final void h(io.e eVar, Drawable drawable) {
        Integer num;
        ...
        eVar.f28573c.setImageDrawable(mutate);
    }

    @Override // androidx.recyclerview.widget.RecyclerView.Adapter
    /* renamed from: f */
    public mp.b0 onCreateViewHolder(ViewGroup parent, int i10) {
        Intrinsics.checkNotNullParameter(parent, "parent");
        io.e c10 = io.e.c(LayoutInflater.from(parent.getContext()), parent, false);
        Intrinsics.checkNotNullExpressionValue(c10, "inflate(...)");
        mp.b0 b0Var = new mp.b0(c10);
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder holder, int i10) {
        ...
        final b0 b0Var = (b0) this.f22354a.get(i10);
        io.e eVar = (io.e) mp.c0.a(holder);
        eVar.f28575e.setText(b0Var.getName());
        g4 a10 = b0Var.a();
        int[] iArr = a.f22361a;
        ...
        if (i12 != 1) {
            if (i12 != 2) {
                if (i12 != 3) {
                    if (i12 == 4) {
                        NextStep.GovernmentId.AssetConfig.SelectPage selectPage = this.f22356c;
                        if (selectPage == null || (iconPassport = selectPage.getIconNationalId()) == null) {
                            NextStep.GovernmentId.AssetConfig.SelectPage selectPage2 = this.f22356c;
                            if (selectPage2 != null) {
                    ...
                    NextStep.GovernmentId.AssetConfig.SelectPage selectPage3 = this.f22356c;
                    if (selectPage3 != null) {
                ...
                NextStep.GovernmentId.AssetConfig.SelectPage selectPage4 = this.f22356c;
                if (selectPage4 != null) {
            ...
            NextStep.GovernmentId.AssetConfig.SelectPage selectPage5 = this.f22356c;
            if (selectPage5 != null) {
                iconPassport = selectPage5.getIconPassport();
            }
            iconPassport = null;
        }
        Object tag = eVar.f28574d.getTag(m4.f22082h0);
        if (tag instanceof View) {
            view = (View) tag;
        }
        if (view != null) {
            eVar.f28574d.removeView(view);
        }
        if (!this.f22359f) {
            eVar.f28574d.setVisibility(8);
            TextView label = eVar.f28575e;
            Intrinsics.checkNotNullExpressionValue(label, "label");
            label.setPaddingRelative(0, label.getPaddingTop(), label.getPaddingEnd(), label.getPaddingBottom());
        } else if (iconPassport != null) {
            ConstraintLayout iconContainer = eVar.f28574d;
            Intrinsics.checkNotNullExpressionValue(iconContainer, "iconContainer");
            eVar.f28574d.setTag(m4.f22082h0, hq.b.b(iconPassport, iconContainer, true));
            eVar.f28573c.setVisibility(8);
            TextView label2 = eVar.f28575e;
            Intrinsics.checkNotNullExpressionValue(label2, "label");
            label2.setPaddingRelative((int) mp.h.a(8.0d), label2.getPaddingTop(), label2.getPaddingEnd(), label2.getPaddingBottom());
        } else {
            eVar.f28573c.setVisibility(0);
            if (this.f22358e.get(Integer.valueOf(i10)) != null) {
                eVar.f28573c.setImageDrawable((Drawable) this.f22358e.get(Integer.valueOf(i10)));
            } else {
                ...
                if (b10 != null) {
                    h(eVar, b10);
                    this.f22358e.put(Integer.valueOf(i10), eVar.f28573c.getDrawable());
                }
            }
            TextView label3 = eVar.f28575e;
            Intrinsics.checkNotNullExpressionValue(label3, "label");
            label3.setPaddingRelative((int) mp.h.a(8.0d), label3.getPaddingTop(), label3.getPaddingEnd(), label3.getPaddingBottom());
        }
        eVar.getRoot().setOnClickListener(new View.OnClickListener() { // from class: eo.s0
            @Override // android.view.View.OnClickListener
            public final void onClick(View view2) {
                t0.e(t0.this, b0Var, view2);
            }
        });
        eVar.getRoot().setEnabled(this.f22360g);
    }
}
