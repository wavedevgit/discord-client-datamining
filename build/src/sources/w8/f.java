...
public abstract class f {
    ...
    private static final Uri f52264a = Uri.withAppendedPath((Uri) db.a.e(ContactsContract.AUTHORITY_URI), "display_photo");
    ...
    public static boolean l(Uri uri) {
        if (uri.getPath() == null || !m(uri) || !"com.android.contacts".equals(uri.getAuthority()) || uri.getPath().startsWith((String) db.a.e(f52264a.getPath()))) {
            return false;
        }
        return true;
    }
