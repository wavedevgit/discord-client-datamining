...
public final class d {
    ...
    public d(a aVar) {
        ...
        this.f28591b = arrayList;
        arrayList.add(new b(aVar, new int[]{1}));
    }

    private b a(int i10) {
        if (i10 >= this.f28591b.size()) {
            List list = this.f28591b;
            b bVar = (b) list.get(list.size() - 1);
            for (int size = this.f28591b.size(); size <= i10; size++) {
                a aVar = this.f28590a;
                bVar = bVar.i(new b(aVar, new int[]{1, aVar.c((size - 1) + aVar.d())}));
                this.f28591b.add(bVar);
            }
        }
        return (b) this.f28591b.get(i10);
    }
    ...
    public void b(int[] iArr, int i10) {
        if (i10 != 0) {
            ...
            if (length > 0) {
                ...
                int[] e10 = new b(this.f28590a, iArr2).j(i10, 1).b(a10)[1].e();
