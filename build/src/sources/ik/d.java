...
public final class d {
    ...
    private b a(int i10) {
        if (i10 >= this.f28575b.size()) {
            List list = this.f28575b;
            b bVar = (b) list.get(list.size() - 1);
            for (int size = this.f28575b.size(); size <= i10; size++) {
                a aVar = this.f28574a;
                bVar = bVar.i(new b(aVar, new int[]{1, aVar.c((size - 1) + aVar.d())}));
                this.f28575b.add(bVar);
            }
        }
        return (b) this.f28575b.get(i10);
    }
    ...
    public void b(int[] iArr, int i10) {
        if (i10 != 0) {
            ...
            if (length > 0) {
                ...
                int[] e10 = new b(this.f28574a, iArr2).j(i10, 1).b(a10)[1].e();
