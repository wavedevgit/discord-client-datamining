...
public final class e extends kotlinx.coroutines.a {
    ...
    private final Thread f43546o;

    /* renamed from: p  reason: collision with root package name */
    private final p0 f43547p;
    ...
    public void F(Object obj) {
        if (!Intrinsics.areEqual(Thread.currentThread(), this.f43546o)) {
            Thread thread = this.f43546o;
            b.a();
    ...
    public final Object X0() {
        ...
        b.a();
        try {
            p0 p0Var = this.f43547p;
            r rVar = null;
            if (p0Var != null) {
                p0.q2(p0Var, false, 1, null);
            }
            while (true) {
                p0 p0Var2 = this.f43547p;
                if (p0Var2 != null) {
                    j10 = p0Var2.t2();
                } else {
