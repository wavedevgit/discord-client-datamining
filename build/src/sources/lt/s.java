...
public final class s {
    ...
    private final List f37726a;

    /* JADX INFO: Access modifiers changed from: package-private */
    public s(String[] strArr) {
        this.f37726a = Collections.unmodifiableList(Arrays.asList(strArr));
    }
        ...
        while (i12 < enumArr.length) {
            ...
            if (isEmpty) {
                if (i12 >= size) {
                    ...
                    str3 = (String) this.f37726a.get(i12);
                }
            }
    ...
    public Enum c(CharSequence charSequence, ParsePosition parsePosition, Class cls, kt.d dVar) {
        kt.c cVar = a.f37634i;
        Boolean bool = Boolean.TRUE;
        return e(charSequence, parsePosition, cls, ((Boolean) dVar.a(cVar, bool)).booleanValue(), ((Boolean) dVar.a(a.f37635j, Boolean.FALSE)).booleanValue(), ((Boolean) dVar.a(a.f37636k, bool)).booleanValue());
    }
    ...
    public String f(Enum r32) {
        ...
        if (this.f37726a.size() <= ordinal) {
            return r32.name();
        }
        return (String) this.f37726a.get(ordinal);
    }
    ...
    public String toString() {
        ...
        for (int i10 = 0; i10 < size; i10++) {
            ...
            sb2.append((String) this.f37726a.get(i10));
        }
        sb2.append('}');
        return sb2.toString();
    }
