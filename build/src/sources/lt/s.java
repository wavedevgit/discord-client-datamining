...
public final class s implements KSerializer {
    ...
    public static final s f36651a = new s();

    /* renamed from: b  reason: collision with root package name */
    private static final SerialDescriptor f36652b = jt.j.b("kotlinx.serialization.json.JsonLiteral", e.i.f30484a);
    ...
    public void serialize(Encoder encoder, r value) {
        ...
        if (value.c()) {
            ...
            rr.b0 h10 = e0.h(value.b());
            if (h10 != null) {
                encoder.l(ht.a.J(rr.b0.f49182e).getDescriptor()).m(h10.h());
                return;
            }
