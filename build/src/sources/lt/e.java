...
public abstract class e {
    ...
    public static final e f37246d;

    /* renamed from: e  reason: collision with root package name */
    public static final e f37247e;

    /* renamed from: i  reason: collision with root package name */
    public static final e f37248i;

    /* renamed from: o  reason: collision with root package name */
    public static final e f37249o;

    /* renamed from: p  reason: collision with root package name */
    private static final int[] f37250p;

    /* renamed from: q  reason: collision with root package name */
    private static final double[] f37251q;

    /* renamed from: r  reason: collision with root package name */
    private static final double[] f37252r;

    /* renamed from: s  reason: collision with root package name */
    private static final double[][] f37253s;

    /* renamed from: t  reason: collision with root package name */
    private static final /* synthetic */ e[] f37254t;
    ...
    enum a extends e {
        ...
        private double o(double d10) {
            i0 t02 = lt.c.f(d10).h().t0(p.f40826v);
            return t02.V().B0() + (((Integer) t02.X().o(g0.K)).intValue() / 86400.0d);
        }

        private double p(double d10) {
            double d11 = (d10 * 0.9856d) - 3.289d;
            return lt.a.b((Math.sin(Math.toRadians(d11)) * 1.916d) + d11 + (Math.sin(Math.toRadians(d11) * 2.0d) * 0.02d) + 282.634d);
        }
        ...
        public double k(double d10) {
            double p10 = p(o(d10));
            double b10 = lt.a.b(Math.toDegrees(Math.atan(Math.tan(Math.toRadians(p10)) * 0.91764d)));
    ...
    static {
        ...
        f37246d = aVar;
        e eVar = new e("NOAA", 1) { // from class: lt.e.b
            private double o(double d10) {
            ...
            public double k(double d10) {
                ...
                return lt.a.b(Math.toDegrees(Math.atan2(Math.cos(Math.toRadians(s(l10))) * Math.sin(radians), Math.cos(radians))));
            }
        };
        f37247e = eVar;
        e eVar2 = new e("CC", 2) { // from class: lt.e.c
            private double o(double d10) {
            ...
            public double h(double d10, String str) {
                ...
                if (str.equals("right-ascension")) {
                    ...
                    return lt.a.b(Math.toDegrees(Math.atan2(Math.cos(Math.toRadians(r(l10))) * Math.sin(radians), Math.cos(radians))));
        ...
        f37248i = eVar2;
        e eVar3 = new e("TIME4J", 3) { // from class: lt.e.d
            private double o(double d10) {
            ...
            public double h(double d10, String str) {
                ...
                if (str.equals("right-ascension")) {
                    ...
                    return lt.a.b(Math.toDegrees(Math.atan2(Math.cos(Math.toRadians(e.i(l10) + dArr[1])) * Math.sin(radians), Math.cos(radians))));
                } else if (str.equals("nutation")) {
    ...
    public static double f(double d10, double d11) {
        double d12 = 0.0d;
        for (int length = f37250p.length - 1; length >= 0; length--) {
            d12 += f37250p[length] * Math.sin(Math.toRadians(f37251q[length] + (f37252r[length] * d10)));
        }
    ...
    static void j(double d10, double[] dArr) {
        ...
        double d11 = 0.0d;
        double d12 = 0.0d;
        for (int length = f37253s.length - 1; length >= 0; length--) {
            double[] dArr2 = f37253s[length];
