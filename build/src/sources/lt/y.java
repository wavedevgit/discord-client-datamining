...
public final class y implements h {
    ...
    public void e(CharSequence charSequence, s sVar, jt.d dVar, t tVar, boolean z10) {
        ...
        if (this.f37738e == null) {
            i10 = length - this.f37737d;
        } else {
            int i12 = f10;
            for (int i13 = 0; i13 < this.f37737d && (i11 = i13 + f10) < length && this.f37738e.test(Character.valueOf(charSequence.charAt(i11))); i13++) {
                i12++;
            }
            i10 = i12;
        }
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof y) {
            y yVar = (y) obj;
            if (this.f37737d == yVar.f37737d) {
                jt.n nVar = this.f37738e;
                jt.n nVar2 = yVar.f37738e;
    ...
    public int hashCode() {
        ...
        return nVar.hashCode() ^ (~this.f37737d);
    }
