...
public final class c implements Serializable {
    ...
    public static /* synthetic */ class a {
        ...
        static final /* synthetic */ int[] f37230a;
        ...
        static {
            ...
            try {
                f37230a[f.TT.ordinal()] = 2;
            } catch (NoSuchFieldError unused2) {
            }
            try {
                f37230a[f.POSIX.ordinal()] = 3;
    ...
    private static void a(double d10, f fVar) {
        if (!Double.isNaN(d10) && !Double.isInfinite(d10)) {
            int i10 = a.f37230a[fVar.ordinal()];
    ...
    static double d(a0 a0Var, f fVar) {
        return ((a0Var.r(fVar) + e(fVar)) + (a0Var.k(fVar) / 1.0E9d)) / 86400.0d;
    }
    ...
    public a0 h() {
        ...
        f fVar2 = this.scale;
        if (!tt.d.r().D() && fVar2 != (fVar = f.POSIX)) {
            if (fVar2 == f.TT) {
                f0 M0 = f0.M0((long) Math.floor(b()), mt.a0.MODIFIED_JULIAN_DATE);
                d10 -= f.d(M0.f(), M0.s());
            }
            d10 += 6.3072E7d;
            fVar2 = fVar;
        }
        return a0.l0(kt.c.m((long) d10, e(fVar2)), (int) ((d10 - Math.floor(d10)) * 1.0E9d), fVar2);
    }

    public int hashCode() {
        return lt.a.a(this.value) ^ this.scale.hashCode();
    }
