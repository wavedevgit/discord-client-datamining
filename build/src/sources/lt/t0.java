...
public class t0 extends a {
    ...
    private final y f36717e;

    /* renamed from: f  reason: collision with root package name */
    private final char[] f36718f;

    /* renamed from: g  reason: collision with root package name */
    protected int f36719g;

    /* renamed from: h  reason: collision with root package name */
    private final d f36720h;
    ...
    public t0(y reader, char[] buffer) {
        ...
        this.f36717e = reader;
        this.f36718f = buffer;
        this.f36719g = IntBufferBatchMountItem.INSTRUCTION_UPDATE_LAYOUT;
        this.f36720h = new d(buffer);
        U(0);
    }
    ...
    private final void U(int i10) {
        ...
        while (true) {
            ...
            int a10 = this.f36717e.a(b10, i10, length - i10);
            if (a10 == -1) {
                D().f(i10);
                this.f36719g = -1;
                break;
    ...
    @Override // lt.a
    public void u() {
        int length = D().length() - this.f36632a;
        if (length > this.f36719g) {
            return;
        }
        U(length);
    }
