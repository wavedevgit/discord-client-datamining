...
public final class n {
    ...
    private static final int[] f48857c = {24, 20, 18, 17, 12, 6, 3, 10, 9, 5};

    /* renamed from: a  reason: collision with root package name */
    private final int[] f48858a = new int[4];

    /* renamed from: b  reason: collision with root package name */
    private final StringBuilder f48859b = new StringBuilder();

    private int a(jk.a aVar, int[] iArr, StringBuilder sb2) {
        int[] iArr2 = this.f48858a;
        iArr2[0] = 0;
        iArr2[1] = 0;
        iArr2[2] = 0;
        iArr2[3] = 0;
    ...
    */
    private static java.lang.String e(java.lang.String r5) {
        ...
        L79:
            ...
            return r5
        */
        throw new UnsupportedOperationException("Method not decompiled: rk.n.e(java.lang.String):java.lang.String");
    }
    ...
    private static Map f(String str) {
        ...
        enumMap.put((EnumMap) fk.o.SUGGESTED_PRICE, (fk.o) e10);
        return enumMap;
    }
    ...
    public Result b(int i10, jk.a aVar, int[] iArr) {
        ...
        Map f10 = f(sb3);
        float f11 = i10;
        Result result = new Result(sb3, null, new fk.p[]{new fk.p((iArr[0] + iArr[1]) / 2.0f, f11), new fk.p(a10, f11)}, fk.a.UPC_EAN_EXTENSION);
        if (f10 != null) {
            result.g(f10);
        }
        return result;
