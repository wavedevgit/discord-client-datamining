...
public final class d extends k {
    ...
    private static final char[] f48835c = "0123456789ABCDEFGHIJKLMNOPQRSTUVWXYZ-. $/+%abcd*".toCharArray();

    /* renamed from: d  reason: collision with root package name */
    static final int[] f48836d;

    /* renamed from: e  reason: collision with root package name */
    static final int f48837e;

    /* renamed from: a  reason: collision with root package name */
    private final StringBuilder f48838a = new StringBuilder(20);

    /* renamed from: b  reason: collision with root package name */
    private final int[] f48839b = new int[6];
    ...
    private static void h(CharSequence charSequence, int i10, int i11) {
        ...
        if (charSequence.charAt(i10) == f48835c[i12 % 47]) {
            return;
        }
        throw fk.d.a();
    }
    ...
    public Result b(int i10, jk.a aVar, Map map) {
        ...
        int[] iArr = this.f48839b;
        Arrays.fill(iArr, 0);
        StringBuilder sb2 = this.f48838a;
        sb2.setLength(0);
        while (true) {
            k.e(aVar, j11, iArr);
            int l11 = l(iArr);
            if (l11 >= 0) {
                ...
                if (k10 == '*') {
                    ...
                    if (j12 != l10 && aVar.g(j12)) {
                        if (sb2.length() >= 2) {
                            g(sb2);
                            sb2.setLength(sb2.length() - 2);
                            float f10 = i10;
                            Result result = new Result(i(sb2), null, new fk.p[]{new fk.p((j10[1] + j10[0]) / 2.0f, f10), new fk.p(j11 + (i13 / 2.0f), f10)}, fk.a.CODE_93);
                            result.h(fk.o.SYMBOLOGY_IDENTIFIER, "]G0");
                            return result;
                        }
                        throw fk.k.a();
                    }
