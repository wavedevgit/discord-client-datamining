...
final class g {
    ...
    private final List f48843a = new ArrayList();

    /* renamed from: b  reason: collision with root package name */
    private final List f48844b = new ArrayList();

    private void a(int[] iArr, String str) {
        this.f48843a.add(iArr);
        this.f48844b.add(str);
    }
    ...
    public String c(String str) {
        ...
        for (int i11 = 0; i11 < size && parseInt >= (i10 = (iArr = (int[]) this.f48843a.get(i11))[0]); i11++) {
            if (iArr.length != 1) {
                i10 = iArr[1];
            }
            if (parseInt <= i10) {
                return (String) this.f48844b.get(i11);
            }
        }
        return null;
    }
