...
final class q implements s1 {
    ...
    private final Function2 f21001a;
    ...
    public Object a(KClass key, List types) {
        ...
        Object obj = this.f21002b.get(yr.a.b(key));
        ...
        concurrentHashMap = r1Var.f21007a;
        Object obj3 = concurrentHashMap.get(arrayList);
        if (obj3 == null) {
            try {
                Result.a aVar = Result.f32461e;
                b10 = Result.b((KSerializer) this.f21001a.invoke(key, types));
            } catch (Throwable th2) {
