...
public abstract class h2 {
    ...
    private static final Map f20944a = t1.i();

    public static final SerialDescriptor a(String serialName, ct.e kind) {
    ...
    public static final KSerializer b(KClass kClass) {
        ...
        return (KSerializer) f20944a.get(kClass);
    }

    private static final void c(String str) {
        for (KSerializer kSerializer : f20944a.values()) {
