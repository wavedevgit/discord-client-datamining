...
final class v implements s1 {
    ...
    private final Function2 f21022a;

    /* renamed from: b  reason: collision with root package name */
    private final ConcurrentHashMap f21023b;

    public v(Function2 compute) {
        Intrinsics.checkNotNullParameter(compute, "compute");
        this.f21022a = compute;
        this.f21023b = new ConcurrentHashMap();
    }
    ...
    public Object a(KClass key, List types) {
        ...
        ConcurrentHashMap concurrentHashMap2 = this.f21023b;
        Class b11 = yr.a.b(key);
        ...
        if (obj2 == null) {
            try {
                ...
                b10 = Result.b((KSerializer) this.f21022a.invoke(key, types));
            } catch (Throwable th2) {
