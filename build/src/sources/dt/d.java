...
public final class d extends e {
    ...
    */
    public d(int r3, int r4, dt.a r5, java.lang.String r6) {
        /*
            r2 = this;
        ...
        L5c:
            ...
            throw r4
        */
        throw new UnsupportedOperationException("Method not decompiled: dt.d.<init>(int, int, dt.a, java.lang.String):void");
    }
    ...
    public g a(Object obj, CharSequence input, int i10, int i11) {
        ...
        int i12 = i11 - i10;
        int i13 = this.f21135c;
        if (i12 < i13) {
            return new g.c(i13);
        }
        int i14 = this.f21136d;
        if (i12 > i14) {
            return new g.d(i14);
        }
        a aVar = this.f21137e;
        d10 = f.d(input, i10, i11);
        f10 = f.f(aVar, obj, new at.a(d10, i12));
        return f10;
    }
}
