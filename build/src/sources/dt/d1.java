...
public abstract class d1 extends a {
    ...
    private final KSerializer f20924a;

    /* renamed from: b  reason: collision with root package name */
    private final KSerializer f20925b;
    ...
    public final void h(kotlinx.serialization.encoding.c decoder, int i10, Map builder, boolean z10) {
        ...
        Intrinsics.checkNotNullParameter(decoder, "decoder");
        Intrinsics.checkNotNullParameter(builder, "builder");
        Object c11 = c.a.c(decoder, getDescriptor(), i10, this.f20924a, null, 8, null);
        if (z10) {
        ...
        int i12 = i11;
        if (builder.containsKey(c11) && !(this.f20925b.getDescriptor().getKind() instanceof ct.e)) {
            c10 = decoder.y(getDescriptor(), i12, this.f20925b, kotlin.collections.o0.j(builder, c11));
        } else {
            c10 = c.a.c(decoder, getDescriptor(), i12, this.f20925b, null, 8, null);
        }
        builder.put(c11, c10);
    }
    ...
    public void serialize(Encoder encoder, Object obj) {
        ...
        while (d10.hasNext()) {
            ...
            int i12 = i11 + 1;
            i10.D(getDescriptor(), i11, m(), key);
            i11 += 2;
            i10.D(getDescriptor(), i12, n(), value);
        }
        i10.c(descriptor);
    }
    ...
    private d1(KSerializer kSerializer, KSerializer kSerializer2) {
        super(null);
        this.f20924a = kSerializer;
        this.f20925b = kSerializer2;
    }
}
