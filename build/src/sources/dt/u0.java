...
public final class u0 extends d1 {
    ...
    private final SerialDescriptor f21019c;
    ...
    public u0(KSerializer kSerializer, KSerializer vSerializer) {
        ...
        this.f21019c = new t0(kSerializer.getDescriptor(), vSerializer.getDescriptor());
    }

    @Override // dt.d1, kotlinx.serialization.KSerializer, at.o, kotlinx.serialization.DeserializationStrategy
