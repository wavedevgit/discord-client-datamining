...
public class a2 implements SerialDescriptor, l {
    ...
    /* renamed from: j */
    private final Lazy f20900j;

    /* renamed from: k */
    private final Lazy f20901k;

    /* renamed from: l */
    private final Lazy f20902l;

    public a2(String serialName, h0 h0Var, int i10) {
        Intrinsics.checkNotNullParameter(serialName, "serialName");
        this.f20891a = serialName;
        this.f20892b = h0Var;
        this.f20893c = i10;
        this.f20894d = -1;
        ...
        this.f20896f = new List[i12];
        this.f20898h = new boolean[i12];
        this.f20899i = kotlin.collections.o0.i();
        lr.o oVar = lr.o.f37120e;
        this.f20900j = lr.l.b(oVar, new Function0() { // from class: dt.x1
        ...
        this.f20901k = lr.l.b(oVar, new Function0() { // from class: dt.y1
            @Override // kotlin.jvm.functions.Function0
            public final Object invoke() {
        ...
        this.f20902l = lr.l.b(oVar, new Function0() { // from class: dt.z1
            @Override // kotlin.jvm.functions.Function0
            public final Object invoke() {
                int n10;
                n10 = a2.n(a2.this);
    ...
    private final Map q() {
        ...
        for (int i10 = 0; i10 < length; i10++) {
            hashMap.put(this.f20895e[i10], Integer.valueOf(i10));
        }
        return hashMap;
    }
    ...
    private final KSerializer[] s() {
        return (KSerializer[]) this.f20900j.getValue();
    }

    private final int u() {
        return ((Number) this.f20902l.getValue()).intValue();
    }
    ...
    public int c(String name) {
        ...
        Integer num = (Integer) this.f20899i.get(name);
        if (num != null) {
            return num.intValue();
        }
        return -3;
    ...
    public final void o(String name, boolean z10) {
        Intrinsics.checkNotNullParameter(name, "name");
        String[] strArr = this.f20895e;
        int i10 = this.f20894d + 1;
        this.f20894d = i10;
        strArr[i10] = name;
        this.f20898h[i10] = z10;
        this.f20896f[i10] = null;
        if (i10 == this.f20893c - 1) {
            this.f20899i = q();
        }
    }

    public final SerialDescriptor[] t() {
        return (SerialDescriptor[]) this.f20901k.getValue();
    }

    public String toString() {
        IntRange u10 = kotlin.ranges.d.u(0, this.f20893c);
        return CollectionsKt.x0(u10, ", ", h() + '(', ")", 0, null, new Function1() { // from class: dt.w1
    ...
    public final void v(Annotation annotation) {
        ...
        List list = this.f20896f[this.f20894d];
        if (list == null) {
            list = new ArrayList(1);
            this.f20896f[this.f20894d] = list;
        }
        list.add(annotation);
    }
