...
public final class h extends hd.e {
    ...
    public static final a f36934b = new a() { // from class: md.g
        @Override // md.h.a
    ...
    */
    private static boolean B(oe.h0 r18, int r19, int r20, boolean r21) {
        /*
            r1 = r18
            r0 = r19
            int r2 = r1.f()
        ...
        Lb2:
            ...
            throw r0
        */
        throw new UnsupportedOperationException("Method not decompiled: md.h.B(oe.h0, int, int, boolean):boolean");
    }
    ...
    private static md.a f(h0 h0Var, int i10, int i11) {
        int z10;
        String str;
        int H = h0Var.H();
        Charset w10 = w(H);
        ...
        h0Var.l(bArr, 0, i12);
        if (i11 == 2) {
            str = "image/" + ni.b.e(new String(bArr, 0, 3, ni.d.f38903b));
            ...
            z10 = z(bArr, 0);
            String e10 = ni.b.e(new String(bArr, 0, z10, ni.d.f38903b));
            if (e10.indexOf(47) == -1) {
                str = "image/" + e10;
            } else {
                str = e10;
        ...
        return new md.a(str, new String(bArr, i13, y10 - i13, w10), bArr[z10 + 1] & 255, d(bArr, y10 + v(H), i12));
    }

    private static md.b g(h0 h0Var, int i10, String str) {
        byte[] bArr = new byte[i10];
        h0Var.l(bArr, 0, i10);
        return new md.b(str, bArr);
    }
    ...
    private static c h(h0 h0Var, int i10, int i11, boolean z10, int i12, a aVar) {
        ...
        String str = new String(h0Var.e(), f10, z11 - f10, ni.d.f38903b);
        h0Var.U(z11 + 1);
        int q10 = h0Var.q();
        int q11 = h0Var.q();
        long J = h0Var.J();
    ...
    private static d i(h0 h0Var, int i10, int i11, boolean z10, int i12, a aVar) {
        ...
        String str = new String(h0Var.e(), f10, z13 - f10, ni.d.f38903b);
        h0Var.U(z13 + 1);
        int H = h0Var.H();
        if ((H & 2) != 0) {
            z11 = true;
        ...
        for (int i13 = 0; i13 < H2; i13++) {
            ...
            strArr[i13] = new String(h0Var.e(), f11, z14 - f11, ni.d.f38903b);
            h0Var.U(z14 + 1);
        }
        ArrayList arrayList = new ArrayList();
        int i14 = f10 + i10;
    ...
    /* JADX WARN: Type inference failed for: r1v16, types: [oe.h0] */
    ...
    /*
        ...
        To view partially-correct add '--show-bad-code' argument
    */
    private static md.i k(int r18, oe.h0 r19, boolean r20, int r21, md.h.a r22) {
        /*
            Method dump skipped, instructions count: 560
            To view this dump add '--comments-level debug' option
        */
        throw new UnsupportedOperationException("Method not decompiled: md.h.k(int, oe.h0, boolean, int, md.h$a):md.i");
    }
    ...
    private static f l(h0 h0Var, int i10) {
        ...
        h0Var.l(bArr, 0, i11);
        int z10 = z(bArr, 0);
        String str = new String(bArr, 0, z10, ni.d.f38903b);
        int i12 = z10 + 1;
    ...
    private static l o(h0 h0Var, int i10) {
        ...
        h0Var.l(bArr, 0, i10);
        int z10 = z(bArr, 0);
        return new l(new String(bArr, 0, z10, ni.d.f38903b), d(bArr, z10 + 1, i10));
    }
    ...
    private static n t(h0 h0Var, int i10, String str) {
        byte[] bArr = new byte[i10];
        h0Var.l(bArr, 0, i10);
        return new n(str, null, new String(bArr, 0, z(bArr, 0), ni.d.f38903b));
    }
    ...
    private static n u(h0 h0Var, int i10) {
        ...
        int v10 = y10 + v(H);
        return new n("WXXX", str, p(bArr, v10, z(bArr, v10), ni.d.f38903b));
    }
    ...
    public Metadata e(byte[] bArr, int i10) {
        ...
        int i12 = m10.f36938c;
        if (m10.f36937b) {
            i12 = A(h0Var, m10.f36938c);
        }
        h0Var.T(f10 + i12);
        boolean z10 = false;
        if (!B(h0Var, m10.f36936a, i11, false)) {
            if (m10.f36936a == 4 && B(h0Var, 4, i11, true)) {
                z10 = true;
            } else {
                y.i("Id3Decoder", "Failed to validate ID3 tag with majorVersion=" + m10.f36936a);
                return null;
            }
        }
        while (h0Var.a() >= i11) {
            i k10 = k(m10.f36936a, h0Var, z10, i11, this.f36935a);
            if (k10 != null) {
                arrayList.add(k10);
            }
        }
