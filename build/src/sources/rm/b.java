...
public final class b implements EventDispatcherListener {
    ...
    public static final a f49038h = new a(null);

    /* renamed from: a  reason: collision with root package name */
    private final ReactViewGroup f49039a;

    /* renamed from: b  reason: collision with root package name */
    private final ThemedReactContext f49040b;

    /* renamed from: c  reason: collision with root package name */
    private final l f49041c;

    /* renamed from: d  reason: collision with root package name */
    private Function0 f49042d;

    /* renamed from: e  reason: collision with root package name */
    private final int f49043e;

    /* renamed from: f  reason: collision with root package name */
    private final UIManager f49044f;

    /* renamed from: g  reason: collision with root package name */
    private final EventDispatcher f49045g;
    ...
    public b(ReactViewGroup view, ThemedReactContext reactContext, l config, Function0 callback) {
        ...
        this.f49039a = view;
        this.f49040b = reactContext;
        this.f49041c = config;
        this.f49042d = callback;
        this.f49043e = 2;
        this.f49044f = UIManagerHelper.getUIManager(reactContext.getReactApplicationContext(), 2);
        this.f49045g = UIManagerHelper.getEventDispatcher(reactContext.getReactApplicationContext(), 2);
    }
    ...
    public final void b() {
        EventDispatcher eventDispatcher = this.f49045g;
    ...
    */
    public void onEventDispatch(com.facebook.react.uimanager.events.Event r8) {
        ...
        L13:
            r0 = 0
            com.facebook.react.bridge.UIManager r1 = r7.f49044f     // Catch: java.lang.Exception -> L21
            if (r1 == 0) goto L23
        ...
        L65:
            ...
            com.facebook.react.uimanager.ThemedReactContext r3 = r7.f49040b
            r2.<init>(r3)
            android.view.ViewGroup$LayoutParams r3 = new android.view.ViewGroup$LayoutParams
            r4 = 0
            r3.<init>(r4, r4)
            r2.setLayoutParams(r3)
            com.facebook.react.views.view.ReactViewGroup r3 = r7.f49039a
            com.facebook.react.uimanager.ThemedReactContext r4 = r7.f49040b
            om.l r5 = r7.f49041c
            om.k r6 = new om.k
            r6.<init>(r3, r0, r4, r5)
            r0.addView(r2)
            boolean r3 = rm.c.a()
            if (r3 == 0) goto Lac
            kotlin.jvm.functions.Function0 r3 = r7.f49042d
