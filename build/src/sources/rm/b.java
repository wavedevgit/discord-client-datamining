...
public final class b implements EventDispatcherListener {
    ...
    public static final a f48990h = new a(null);

    /* renamed from: a  reason: collision with root package name */
    private final ReactViewGroup f48991a;

    /* renamed from: b  reason: collision with root package name */
    private final ThemedReactContext f48992b;

    /* renamed from: c  reason: collision with root package name */
    private final l f48993c;

    /* renamed from: d  reason: collision with root package name */
    private Function0 f48994d;

    /* renamed from: e  reason: collision with root package name */
    private final int f48995e;

    /* renamed from: f  reason: collision with root package name */
    private final UIManager f48996f;

    /* renamed from: g  reason: collision with root package name */
    private final EventDispatcher f48997g;
    ...
    public b(ReactViewGroup view, ThemedReactContext reactContext, l config, Function0 callback) {
        ...
        this.f48991a = view;
        this.f48992b = reactContext;
        this.f48993c = config;
        this.f48994d = callback;
        this.f48995e = 2;
        this.f48996f = UIManagerHelper.getUIManager(reactContext.getReactApplicationContext(), 2);
        this.f48997g = UIManagerHelper.getEventDispatcher(reactContext.getReactApplicationContext(), 2);
    }
    ...
    public final void b() {
        EventDispatcher eventDispatcher = this.f48997g;
    ...
    */
    public void onEventDispatch(com.facebook.react.uimanager.events.Event r8) {
        ...
        L13:
            r0 = 0
            com.facebook.react.bridge.UIManager r1 = r7.f48996f     // Catch: java.lang.Exception -> L21
            if (r1 == 0) goto L23
        ...
        L24:
            ...
            goto L4a
        L2b:
            pm.a r2 = pm.a.f45061a
            java.lang.String r3 = rm.c.b()
        ...
        L65:
            ...
            com.facebook.react.uimanager.ThemedReactContext r3 = r7.f48992b
            r2.<init>(r3)
            android.view.ViewGroup$LayoutParams r3 = new android.view.ViewGroup$LayoutParams
            r4 = 0
            r3.<init>(r4, r4)
            r2.setLayoutParams(r3)
            com.facebook.react.views.view.ReactViewGroup r3 = r7.f48991a
            com.facebook.react.uimanager.ThemedReactContext r4 = r7.f48992b
            om.l r5 = r7.f48993c
            om.k r6 = new om.k
            r6.<init>(r3, r0, r4, r5)
            r0.addView(r2)
            boolean r3 = rm.c.a()
            if (r3 == 0) goto Lac
            kotlin.jvm.functions.Function0 r3 = r7.f48994d
        ...
        Lbd:
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: rm.b.onEventDispatch(com.facebook.react.uimanager.events.Event):void");
    }
}
