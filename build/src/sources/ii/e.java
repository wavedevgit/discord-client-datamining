...
public final class e implements hi.f {
    ...
    private final gi.f f27394b;

    /* renamed from: c  reason: collision with root package name */
    private final g f27395c;

    /* renamed from: d  reason: collision with root package name */
    private final Executor f27396d;

    /* renamed from: e  reason: collision with root package name */
    private final gi.t f27397e;

    public e(Context context, Executor executor, g gVar, gi.f fVar, gi.t tVar) {
        this.f27393a = context;
        this.f27394b = fVar;
        this.f27395c = gVar;
        this.f27396d = executor;
        this.f27397e = tVar;
    }

    /* JADX INFO: Access modifiers changed from: package-private */
    public static /* bridge */ /* synthetic */ void c(e eVar, List list, hi.d dVar) {
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    public static /* bridge */ /* synthetic */ void d(e eVar, hi.d dVar) {
        try {
            if (!gi.a.e(f0.a(eVar.f27393a))) {
    ...
    */
    private final java.lang.Integer e(java.util.List r13) {
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: ii.e.e(java.util.List):java.lang.Integer");
    }

    @Override // hi.f
    public final void a(List list, hi.d dVar) {
        if (gi.a.f()) {
            this.f27396d.execute(new d(this, list, dVar));
            return;
        }
