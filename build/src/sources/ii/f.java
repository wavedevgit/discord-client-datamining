...
public final class f {
    ...
    private final Context f26865b;

    /* renamed from: c  reason: collision with root package name */
    private File f26866c;

    public f(Context context) {
        this.f26865b = context;
        this.f26864a = context.getPackageManager().getPackageInfo(context.getPackageName(), 0).versionCode;
    }
    ...
    private final File v() {
        if (this.f26866c == null) {
            ...
            if (context != null) {
                this.f26866c = context.getFilesDir();
            } else {
                throw new IllegalStateException("context must be non-null to populate null filesDir");
            }
        }
        File file = new File(this.f26866c, "splitcompat");
        u(file);
        return file;
    }

    private final File w() {
        File file = new File(v(), Long.toString(this.f26864a));
        u(file);
        return file;
    }
    ...
    public final void k() {
        ...
        if (list != null) {
            for (String str : list) {
                if (!str.equals(Long.toString(this.f26864a))) {
                    File file = new File(v10, str);
                    Log.d("SplitCompat", "FileStorage: removing directory for different version code (directory = " + file.toString() + ", current version code = " + this.f26864a + ")");
                    l(file);
                }
            }
        }
