...
public final class g {
    ...
    private final gi.f f27400a;

    /* renamed from: b  reason: collision with root package name */
    private final b f27401b;

    /* renamed from: c  reason: collision with root package name */
    private final Context f27402c;

    /* renamed from: d  reason: collision with root package name */
    private final f f27403d;

    /* renamed from: e  reason: collision with root package name */
    private PackageInfo f27404e;

    public g(Context context, gi.f fVar, b bVar) {
        f fVar2 = new f(new gi.b(fVar));
        this.f27400a = fVar;
        this.f27401b = bVar;
    ...
    private final PackageInfo d() {
        if (this.f27404e == null) {
            try {
                this.f27404e = this.f27402c.getPackageManager().getPackageInfo(this.f27402c.getPackageName(), 64);
    ...
    public final boolean a(File[] fileArr) {
        ...
        do {
            length--;
            if (length >= 0) {
                this.f27403d.b(assetManager, fileArr[length]);
            } else {
                return true;
            }
        } while (j10 == this.f27403d.a());
        return false;
    }
    ...
    public final boolean b(List list) {
        ...
        while (it.hasNext()) {
            if (!this.f27400a.g(((Intent) it.next()).getStringExtra("split_id")).exists()) {
                return false;
            }
        }
        return true;
