...
public abstract class o {
    ...
    /* JADX WARN: Type inference failed for: r0v46, types: [uq.h, T] */
    public static final void i(final TextInputLayout textInputLayout, InputSelectComponentStyle styles) {
        ...
        if (baseBackgroundColorValue != null) {
            ...
            objectRef.element = new Function1() { // from class: uq.h
            ...
            textInputLayout.addOnLayoutChangeListener(new View.OnLayoutChangeListener() { // from class: uq.i
        ...
        if (topBorderWidthValue != null) {
            ...
            textInputLayout.setBoxStrokeWidth((int) Math.ceil(bq.h.a(doubleValue)));
            textInputLayout.setBoxStrokeWidthFocused((int) Math.ceil(bq.h.a(doubleValue)));
        }
        if (textInputLayout.getBoxStrokeWidth() == 0) {
            ...
            if (d10 > 0.0d) {
                ...
                if (bottomBorderWidthValue2 != null) {
                    d11 = bq.h.a(bottomBorderWidthValue2.doubleValue());
                }
        ...
        if (borderRadiusValue != null) {
            ...
            textInputLayout.b0((float) bq.h.a(doubleValue2), (float) bq.h.a(doubleValue2), (float) bq.h.a(doubleValue2), (float) bq.h.a(doubleValue2));
        }
        StyleElements.SizeSet inputSelectBoxMargins = styles.getInputSelectBoxMargins();
        if (inputSelectBoxMargins != null) {
            xq.d.c(textInputLayout, inputSelectBoxMargins);
        }
        ...
        if (editText2 != null) {
            xq.d.c(editText2, new StyleElements.SizeSet(new StyleElements.DPSize(valueOf), new StyleElements.DPSize(valueOf), new StyleElements.DPSize(valueOf), new StyleElements.DPSize(valueOf)));
        }
        ...
        if (baseTextColor != null) {
            ...
            textInputLayout.addOnLayoutChangeListener(new View.OnLayoutChangeListener() { // from class: uq.j
                @Override // android.view.View.OnLayoutChangeListener
                public final void onLayoutChange(View view, int i27, int i28, int i29, int i30, int i31, int i32, int i33, int i34) {
        ...
        if (labelBaseTextColor != null) {
            ...
            textInputLayout.addOnLayoutChangeListener(new View.OnLayoutChangeListener() { // from class: uq.k
                @Override // android.view.View.OnLayoutChangeListener
                public final void onLayoutChange(View view, int i27, int i28, int i29, int i30, int i31, int i32, int i33, int i34) {
        ...
        if (placeholderBaseTextColor != null) {
            ...
            textInputLayout.addOnLayoutChangeListener(new View.OnLayoutChangeListener() { // from class: uq.l
                @Override // android.view.View.OnLayoutChangeListener
                public final void onLayoutChange(View view, int i27, int i28, int i29, int i30, int i31, int i32, int i33, int i34) {
        ...
        if (editText4 != null) {
            editText4.setOnFocusChangeListener(new View.OnFocusChangeListener() { // from class: uq.m
    ...
    public static final void l(TextInputLayout textInputLayout, final Ref.ObjectRef objectRef, View view, final boolean z10) {
        textInputLayout.post(new Runnable() { // from class: uq.n
