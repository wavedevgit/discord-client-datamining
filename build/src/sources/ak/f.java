    ...
    public final void zzb() {
        ...
        try {
            if (this.f664b.d()) {
                ...
                B = ok.e(DynamiteModule.d(this.f663a, DynamiteModule.f13468c, this.f664b.f()).c("com.google.mlkit.vision.text.bundled.common.BundledTextRecognizerCreator")).B(sf.b.S0(this.f663a), b(this.f664b, null));
            } else {
                Log.d("DecoupledTextDelegate", "Start loading thin OCR module.");
                pk e10 = ok.e(DynamiteModule.d(this.f663a, DynamiteModule.f13467b, this.f664b.f()).c("com.google.android.gms.vision.text.mlkit.TextRecognizerCreator"));
                if (this.f664b.h() == 1) {
