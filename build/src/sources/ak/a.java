...
public class a implements h {
    ...
    private volatile Bitmap f792a;

    /* renamed from: b  reason: collision with root package name */
    private volatile ByteBuffer f793b;

    /* renamed from: c  reason: collision with root package name */
    private volatile b f794c;
    ...
    private final Matrix f799h;

    private a(Bitmap bitmap, int i10) {
        this.f792a = (Bitmap) q.l(bitmap);
        this.f795d = bitmap.getWidth();
        this.f796e = bitmap.getHeight();
        m(i10);
        this.f797f = i10;
        this.f798g = -1;
        this.f799h = null;
    ...
    */
    private a(java.nio.ByteBuffer r5, int r6, int r7, int r8, int r9) {
        ...
        L26:
            ...
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: ak.a.<init>(java.nio.ByteBuffer, int, int, int, int):void");
    }
}
