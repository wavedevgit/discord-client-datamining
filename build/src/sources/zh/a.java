...
public abstract class a {
    ...
    private static final Map f56447a;

    /* renamed from: b  reason: collision with root package name */
    private static final Map f56448b;
    ...
    public static String a(int i10) {
        ...
        return ((String) map.get(valueOf)) + " (https://developer.android.com/reference/com/google/android/play/core/assetpacks/model/AssetPackErrorCode.html#" + ((String) f56448b.get(valueOf)) + ")";
    }
}
