...
public final class i extends ai.j {
    ...
    final /* synthetic */ wg.k f55968e;

    /* renamed from: i  reason: collision with root package name */
    final /* synthetic */ l f55969i;
    ...
    protected final void a() {
        ...
        String str3;
        try {
            ?? e10 = this.f55969i.f55975a.e();
            str2 = this.f55969i.f55976b;
            Bundle a10 = m.a();
            l lVar = this.f55969i;
            wg.k kVar = this.f55968e;
            str3 = lVar.f55976b;
            e10.O0(str2, a10, new k(lVar, kVar, str3));
        } catch (RemoteException e11) {
            iVar = l.f55974c;
            str = this.f55969i.f55976b;
            iVar.c(e11, "error requesting in-app review for %s", str);
            this.f55968e.d(new RuntimeException(e11));
        }
    }
}
