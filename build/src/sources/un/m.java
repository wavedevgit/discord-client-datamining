...
public final class m {
    ...
    public static final m f51744a = new m();
    ...
    public static final class b extends kotlin.coroutines.jvm.internal.k implements Function2 {
        ...
        public final Continuation create(Object obj, Continuation continuation) {
            return new b(this.f51749e, continuation);
        }
    ...
    public static final class c extends kotlin.coroutines.jvm.internal.k implements Function2 {
        ...
        /* renamed from: e  reason: collision with root package name */
        final /* synthetic */ Context f51751e;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        c(Context context, Continuation continuation) {
            super(2, continuation);
            this.f51751e = context;
        }

        @Override // kotlin.coroutines.jvm.internal.a
        public final Continuation create(Object obj, Continuation continuation) {
            return new c(this.f51751e, continuation);
        }
        ...
        public final Object invokeSuspend(Object obj) {
            ...
            if (this.f51750d == 0) {
                kotlin.c.b(obj);
                return o0.g.f41301i.b(this.f51751e);
            }
            throw new IllegalStateException("call to 'resume' before 'invoke' with coroutine");
        }
