...
public final class b implements LifecycleEventListener {
    ...
    public static final a f53449o = new a(null);

    /* renamed from: d  reason: collision with root package name */
    private final ReactContext f53450d;

    /* renamed from: e  reason: collision with root package name */
    private final Function0 f53451e;

    /* renamed from: i  reason: collision with root package name */
    private final C0740b f53452i;
    ...
    /* loaded from: /home/runner/work/discord-client-datamining/discord-client-datamining/build/classes3.dex */
    public static final class C0740b extends BroadcastReceiver {
        C0740b() {
        }
        ...
        public void onReceive(Context context, Intent intent) {
            ...
            b.f53449o.b(((Configuration) parcelableExtra).orientation, b.this.f53450d);
        }
    }
    ...
    public b(ReactContext reactContext, Function0 onGetCurrentActivity) {
        ...
        this.f53450d = reactContext;
        this.f53451e = onGetCurrentActivity;
        this.f53452i = new C0740b();
    }

    @Override // com.facebook.react.bridge.LifecycleEventListener
    public void onHostPause() {
        Activity activity = (Activity) this.f53451e.invoke();
        if (activity != null) {
            try {
                activity.unregisterReceiver(this.f53452i);
                return;
    ...
    public void onHostResume() {
        Activity activity = (Activity) this.f53451e.invoke();
        if (activity != null) {
            androidx.core.content.a.l(activity, this.f53452i, new IntentFilter("onConfigurationChanged"), 2);
        } else {
            q8.a.m(ReactConstants.TAG, "no activity to register receiver");
        }
        f53449o.b(this.f53450d.getResources().getConfiguration().orientation, this.f53450d);
    }
