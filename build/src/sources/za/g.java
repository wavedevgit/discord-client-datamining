...
public final class g implements c {
    ...
    public static final a f55433d = new a(null);
    ...
    private final String f55436c = "SimpleImageTranscoder";
    ...
    private final int e(k kVar, RotationOptions rotationOptions, ResizeOptions resizeOptions) {
        ...
        return za.a.b(rotationOptions, resizeOptions, kVar, this.f55435b);
    }
    ...
    public boolean b(k encodedImage, RotationOptions rotationOptions, ResizeOptions resizeOptions) {
        ...
        if (rotationOptions == null) {
            rotationOptions = RotationOptions.f11469c.a();
        }
        if (this.f55434a && za.a.b(rotationOptions, resizeOptions, encodedImage, this.f55435b) > 1) {
            return true;
        }
        return false;
    }
    ...
    public b c(k encodedImage, OutputStream outputStream, RotationOptions rotationOptions, ResizeOptions resizeOptions, fa.c cVar, Integer num, ColorSpace colorSpace) {
        ...
        if (rotationOptions == null) {
            rotationOptions2 = RotationOptions.f11469c.a();
        } else {
        ...
        try {
            ...
            try {
                try {
                    bitmap.compress(f55433d.b(cVar), num2.intValue(), outputStream);
                    int i10 = 1;
                    if (e10 > 1) {
                        i10 = 0;
                    }
    ...
    public boolean d(fa.c imageFormat) {
        ...
        if (imageFormat != fa.b.f24878l && imageFormat != fa.b.f24868b) {
            return false;
        }
        return true;
    }
