...
public final class a {
    ...
    public static final float a(RotationOptions rotationOptions, ResizeOptions resizeOptions, k encodedImage) {
        ...
        if (k.J0(encodedImage)) {
            if (resizeOptions != null && resizeOptions.f11466b > 0 && resizeOptions.f11465a > 0 && encodedImage.getWidth() != 0 && encodedImage.getHeight() != 0) {
                int d10 = f55408a.d(rotationOptions, encodedImage);
                if (d10 != 90 && d10 != 270) {
                    z10 = false;
                } else {
                    z10 = true;
                ...
                float f10 = resizeOptions.f11465a / width;
                float f11 = resizeOptions.f11466b / height;
                float c10 = kotlin.ranges.d.c(f10, f11);
                p8.a.E("DownsampleUtil", "Downsample - Specified size: %dx%d, image size: %dx%d ratio: %.1f x %.1f, ratio: %.3f", Integer.valueOf(resizeOptions.f11465a), Integer.valueOf(resizeOptions.f11466b), Integer.valueOf(width), Integer.valueOf(height), Float.valueOf(f10), Float.valueOf(f11), Float.valueOf(c10));
                return c10;
            }
            return 1.0f;
        }
    ...
    public static final int b(RotationOptions rotationOptions, ResizeOptions resizeOptions, k encodedImage, int i10) {
        ...
        if (encodedImage.L() == fa.b.f24868b) {
            e10 = f(a10);
        } else {
            e10 = e(a10);
        }
