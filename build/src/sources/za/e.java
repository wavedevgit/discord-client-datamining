...
public final class e {
    ...
    public static final e f55696a = new e();

    /* renamed from: b  reason: collision with root package name */
    public static final o8.e f55697b;
    ...
    public static final float b(ResizeOptions resizeOptions, int i10, int i11) {
        ...
        float f10 = i10;
        float f11 = i11;
        float max = Math.max(resizeOptions.f10062a / f10, resizeOptions.f10063b / f11);
        float f12 = resizeOptions.f10064c;
        if (f10 * max > f12) {
            max = f12 / f10;
        }
        if (f11 * max > f12) {
    ...
    public static final int d(RotationOptions rotationOptions, k encodedImage) {
        ...
        int b12 = encodedImage.b1();
        o8.e eVar = f55697b;
        int indexOf = eVar.indexOf(Integer.valueOf(b12));
        if (indexOf >= 0) {
    ...
    public static final int e(RotationOptions rotationOptions, k encodedImage) {
        ...
        int c10 = f55696a.c(encodedImage);
        if (rotationOptions.j()) {
            return c10;
        }
    ...
    public static final int f(RotationOptions rotationOptions, ResizeOptions resizeOptions, k encodedImage, boolean z10) {
        ...
        boolean z11 = false;
        if (f55697b.contains(Integer.valueOf(encodedImage.b1()))) {
        ...
        int k10 = k(b(resizeOptions, width, height), resizeOptions.f10065d);
        if (k10 > 8) {
            return 8;
        }
        if (k10 < 1) {
    ...
    public static final Matrix g(k encodedImage, RotationOptions rotationOptions) {
        ...
        Intrinsics.checkNotNullParameter(rotationOptions, "rotationOptions");
        if (f55697b.contains(Integer.valueOf(encodedImage.b1()))) {
            return f55696a.h(d(rotationOptions, encodedImage));
        }
        int e10 = e(rotationOptions, encodedImage);
        if (e10 != 0) {
