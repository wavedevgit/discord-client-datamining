...
public final class e {
    ...
    public static final e f56013a = new e();

    /* renamed from: b  reason: collision with root package name */
    public static final o8.e f56014b;
    ...
    public static final float b(ResizeOptions resizeOptions, int i10, int i11) {
        ...
        float f10 = i10;
        float f11 = i11;
        float max = Math.max(resizeOptions.f10346a / f10, resizeOptions.f10347b / f11);
        float f12 = resizeOptions.f10348c;
        if (f10 * max > f12) {
            max = f12 / f10;
        }
        if (f11 * max > f12) {
    ...
    public static final int e(RotationOptions rotationOptions, k encodedImage) {
        ...
        int c10 = f56013a.c(encodedImage);
        if (rotationOptions.j()) {
            return c10;
        }
    ...
    public static final int f(RotationOptions rotationOptions, ResizeOptions resizeOptions, k encodedImage, boolean z10) {
        ...
        boolean z11 = false;
        if (f56014b.contains(Integer.valueOf(encodedImage.a1()))) {
        ...
        int k10 = k(b(resizeOptions, width, height), resizeOptions.f10349d);
        if (k10 > 8) {
            return 8;
        }
        if (k10 < 1) {
    ...
    public static final Matrix g(k encodedImage, RotationOptions rotationOptions) {
        ...
        Intrinsics.checkNotNullParameter(rotationOptions, "rotationOptions");
        if (f56014b.contains(Integer.valueOf(encodedImage.a1()))) {
            return f56013a.h(d(rotationOptions, encodedImage));
        }
        int e10 = e(rotationOptions, encodedImage);
        if (e10 != 0) {
