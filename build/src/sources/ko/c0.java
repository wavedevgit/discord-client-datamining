...
public final class c0 implements Parcelable {
    ...
    public c0(String absoluteFilePath, String mimeType) {
        ...
        this.f30998d = absoluteFilePath;
        this.f30999e = mimeType;
    }
    ...
    public boolean equals(Object obj) {
        ...
        c0 c0Var = (c0) obj;
        if (Intrinsics.areEqual(this.f30998d, c0Var.f30998d) && Intrinsics.areEqual(this.f30999e, c0Var.f30999e)) {
            return true;
        }
        return false;
    }
    ...
    public int hashCode() {
        return (this.f30998d.hashCode() * 31) + this.f30999e.hashCode();
    }
    ...
    public final void writeToParcel(Parcel dest, int i10) {
        ...
        dest.writeString(this.f30998d);
        dest.writeString(this.f30999e);
    }
    ...
    */
    public /* synthetic */ c0(java.lang.String r1, java.lang.String r2, int r3, kotlin.jvm.internal.DefaultConstructorMarker r4) {
        ...
        L17:
            ...
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: ko.c0.<init>(java.lang.String, java.lang.String, int, kotlin.jvm.internal.DefaultConstructorMarker):void");
    }
}
