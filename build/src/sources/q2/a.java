...
public final class a extends m2.b {
    ...
    public static final C0568a f47276l = new C0568a(null);

    /* renamed from: g  reason: collision with root package name */
    private final Context f47277g;

    /* renamed from: h  reason: collision with root package name */
    public g2.j f47278h;

    /* renamed from: i  reason: collision with root package name */
    public Executor f47279i;

    /* renamed from: j  reason: collision with root package name */
    private CancellationSignal f47280j;

    /* renamed from: k  reason: collision with root package name */
    private final j f47281k;
    ...
    public static final class b extends Lambda implements Function2 {
        ...
        public static final b f47282d = new b();
    ...
    public static final class e extends Lambda implements Function0 {
        ...
        /* renamed from: e  reason: collision with root package name */
        final /* synthetic */ Ref.ObjectRef f47287e;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        e(Ref.ObjectRef objectRef) {
            super(0);
            this.f47287e = objectRef;
        }
        ...
        public final void m1228invoke() {
            Executor p10 = a.this.p();
            final a aVar = a.this;
            final Ref.ObjectRef objectRef = this.f47287e;
    ...
    static final class h extends Lambda implements Function0 {
        ...
        /* renamed from: e  reason: collision with root package name */
        final /* synthetic */ Exception f47293e;
        ...
        public final void m1231invoke() {
            Executor p10 = a.this.p();
            final a aVar = a.this;
            final Exception exc = this.f47293e;
    ...
    public static final class j extends ResultReceiver {
        ...
        /* loaded from: /home/runner/work/discord-client-datamining/discord-client-datamining/build/classes.dex */
        /* synthetic */ class C0569a extends FunctionReferenceImpl implements Function2 {
            C0569a(Object obj) {
        ...
        public void onReceiveResult(int i10, Bundle resultData) {
            ...
            if (a.this.f(resultData, new C0569a(m2.a.f37580b), a.this.p(), a.this.o(), a.this.f47280j)) {
                return;
            }
    ...
    public a(Context context) {
        ...
        this.f47281k = new j(new Handler(Looper.getMainLooper()));
    }
    ...
    public final Executor p() {
        Executor executor = this.f47279i;
        if (executor != null) {
            return executor;
        }
    ...
    public final void q(int i10, int i11, Intent intent) {
        ...
        if (i10 != c0477a.b()) {
            Log.w("GetSignInIntent", "Returned request code " + c0477a.b() + " which  does not match what was given " + i10);
        } else if (!m2.b.h(i11, b.f47282d, new c(), this.f47280j)) {
            try {
                ve.i e10 = ve.e.c(this.f47277g).e(intent);
                Intrinsics.checkNotNullExpressionValue(e10, "getSignInCredentialFromIntent(...)");
                m2.b.e(this.f47280j, new d(m(e10)));
            } catch (ef.b e11) {
                Ref.ObjectRef objectRef = new Ref.ObjectRef();
                objectRef.element = new p(e11.getMessage());
                if (e11.b() == 16) {
                    objectRef.element = new k(e11.getMessage());
                } else if (m2.a.f37580b.d().contains(Integer.valueOf(e11.b()))) {
                    objectRef.element = new n(e11.getMessage());
                }
                m2.b.e(this.f47280j, new e(objectRef));
            } catch (m e12) {
                m2.b.e(this.f47280j, new f(e12));
            } catch (Throwable th2) {
                m2.b.e(this.f47280j, new g(new p(th2.getMessage())));
            }
        }
    }
    ...
    public void r(c0 request, g2.j callback, Executor executor, CancellationSignal cancellationSignal) {
        ...
        this.f47280j = cancellationSignal;
        s(callback);
        t(executor);
        if (!CredentialProviderPlayServicesImpl.Companion.a(cancellationSignal)) {
            try {
                ve.d l10 = l(request);
                Intent intent = new Intent(this.f47277g, HiddenActivity.class);
                intent.putExtra("REQUEST_TYPE", l10);
                c(this.f47281k, intent, "SIGN_IN_INTENT");
                this.f47277g.startActivity(intent);
            } catch (Exception e10) {
                if (e10 instanceof q) {
