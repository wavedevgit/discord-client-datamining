...
public final class x1 implements kotlin.reflect.i {
    ...
    static final /* synthetic */ KProperty[] f35520q = {Reflection.property1(new PropertyReference1Impl(x1.class, "descriptor", "getDescriptor()Lorg/jetbrains/kotlin/descriptors/ParameterDescriptor;", 0)), Reflection.property1(new PropertyReference1Impl(x1.class, "annotations", "getAnnotations()Ljava/util/List;", 0))};

    /* renamed from: d  reason: collision with root package name */
    private final a0 f35521d;

    /* renamed from: e  reason: collision with root package name */
    private final int f35522e;

    /* renamed from: i  reason: collision with root package name */
    private final i.a f35523i;

    /* renamed from: o  reason: collision with root package name */
    private final z2.a f35524o;

    /* renamed from: p  reason: collision with root package name */
    private final z2.a f35525p;
    ...
    public static final class a implements Type {
        ...
        public a(Type[] types) {
            ...
            this.f35526d = types;
            this.f35527e = Arrays.hashCode(types);
        }

        public boolean equals(Object obj) {
            if ((obj instanceof a) && Arrays.equals(this.f35526d, ((a) obj).f35526d)) {
                return true;
            }
            return false;
        }
        ...
        public String getTypeName() {
            return kotlin.collections.i.v0(this.f35526d, ", ", "[", "]", 0, null, null, 56, null);
        }
    ...
    public x1(a0 callable, int i10, i.a kind, Function0 computeDescriptor) {
        ...
        this.f35521d = callable;
        this.f35522e = i10;
        this.f35523i = kind;
        this.f35524o = z2.c(computeDescriptor);
        this.f35525p = z2.c(new v1(this));
    }
    ...
    public static final Type a(x1 x1Var) {
        ...
        if ((h10 instanceof ReceiverParameterDescriptor) && Intrinsics.areEqual(j3.i(x1Var.f35521d.D()), h10) && x1Var.f35521d.D().getKind() == CallableMemberDescriptor.Kind.FAKE_OVERRIDE) {
            DeclarationDescriptor containingDeclaration = x1Var.f35521d.D().getContainingDeclaration();
    ...
    private final ParameterDescriptor h() {
        Object b10 = this.f35524o.b(this, f35520q[0]);
    ...
    public boolean equals(Object obj) {
        if (obj instanceof x1) {
            x1 x1Var = (x1) obj;
            if (Intrinsics.areEqual(this.f35521d, x1Var.f35521d) && getIndex() == x1Var.getIndex()) {
                return true;
            }
            return false;
        }
    ...
    public List getAnnotations() {
        Object b10 = this.f35525p.b(this, f35520q[1]);
        Intrinsics.checkNotNullExpressionValue(b10, "getValue(...)");
        return (List) b10;
    }
    ...
    public int hashCode() {
        return (this.f35521d.hashCode() * 31) + Integer.hashCode(getIndex());
    }
