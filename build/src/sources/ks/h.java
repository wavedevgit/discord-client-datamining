...
public final class h extends g {
    public /* synthetic */ h(Flow flow, CoroutineContext coroutineContext, int i10, is.a aVar, int i11, DefaultConstructorMarker defaultConstructorMarker) {
        this(flow, (i11 & 2) != 0 ? kotlin.coroutines.e.f33372d : coroutineContext, (i11 & 4) != 0 ? -3 : i10, (i11 & 8) != 0 ? is.a.f31141d : aVar);
    }

    @Override // ks.e
    protected e g(CoroutineContext coroutineContext, int i10, is.a aVar) {
        return new h(this.f36476o, coroutineContext, i10, aVar);
    }
    ...
    protected Object q(FlowCollector flowCollector, Continuation continuation) {
        Object collect = this.f36476o.collect(flowCollector, continuation);
        if (collect == or.b.f()) {
            return collect;
        }
        return Unit.f33298a;
