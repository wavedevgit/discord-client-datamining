...
public abstract class j3 {
    ...
    private static final FqName f35396a = new FqName("kotlin.jvm.JvmStatic");
    ...
    private static final Object a(ArrayValue arrayValue, ClassLoader classLoader) {
        ...
        int i10 = 0;
        switch (primitiveArrayElementType == null ? -1 : a.f35397a[primitiveArrayElementType.ordinal()]) {
            case -1:
    ...
    private static final Annotation p(AnnotationDescriptor annotationDescriptor) {
        ...
        return (Annotation) ls.f.h(cls, kotlin.collections.o0.u(arrayList), null, 4, null);
    }
    ...
    private static final List t(List list) {
        ...
        while (true) {
            if (!it.hasNext()) {
                break;
            } else if (Intrinsics.areEqual(ds.a.b(ds.a.a((Annotation) it.next())).getSimpleName(), "Container")) {
                list = new ArrayList();
