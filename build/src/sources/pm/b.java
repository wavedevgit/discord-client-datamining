...
public final class b implements EventDispatcherListener {
    ...
    private final ReactViewGroup f46090a;

    /* renamed from: b  reason: collision with root package name */
    private final ThemedReactContext f46091b;

    /* renamed from: c  reason: collision with root package name */
    private final l f46092c;

    /* renamed from: d  reason: collision with root package name */
    private Function0 f46093d;

    /* renamed from: e  reason: collision with root package name */
    private final int f46094e;

    /* renamed from: f  reason: collision with root package name */
    private final UIManager f46095f;

    /* renamed from: g  reason: collision with root package name */
    private final EventDispatcher f46096g;
    ...
    public b(ReactViewGroup view, ThemedReactContext reactContext, l config, Function0 callback) {
        ...
        this.f46090a = view;
        this.f46091b = reactContext;
        this.f46092c = config;
        this.f46093d = callback;
        this.f46094e = 2;
        this.f46095f = UIManagerHelper.getUIManager(reactContext.getReactApplicationContext(), 2);
        this.f46096g = UIManagerHelper.getEventDispatcher(reactContext.getReactApplicationContext(), 2);
    }
    ...
    public final void b() {
        EventDispatcher eventDispatcher = this.f46096g;
    ...
    */
    public void onEventDispatch(com.facebook.react.uimanager.events.Event r8) {
        ...
        L13:
            r0 = 0
            com.facebook.react.bridge.UIManager r1 = r7.f46095f     // Catch: java.lang.Exception -> L21
            if (r1 == 0) goto L23
        ...
        L24:
            ...
            goto L4a
        L2b:
            nm.a r2 = nm.a.f41373a
            java.lang.String r3 = pm.c.b()
        ...
        L65:
            ...
            com.facebook.react.uimanager.ThemedReactContext r3 = r7.f46091b
            r2.<init>(r3)
            android.view.ViewGroup$LayoutParams r3 = new android.view.ViewGroup$LayoutParams
            r4 = 0
            r3.<init>(r4, r4)
            r2.setLayoutParams(r3)
            com.facebook.react.views.view.ReactViewGroup r3 = r7.f46090a
            com.facebook.react.uimanager.ThemedReactContext r4 = r7.f46091b
            mm.l r5 = r7.f46092c
            mm.k r6 = new mm.k
            r6.<init>(r3, r0, r4, r5)
            r0.addView(r2)
            boolean r3 = pm.c.a()
            if (r3 == 0) goto Lac
            kotlin.jvm.functions.Function0 r3 = r7.f46093d
        ...
        Lbd:
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: pm.b.onEventDispatch(com.facebook.react.uimanager.events.Event):void");
    }
}
