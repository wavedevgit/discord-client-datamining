...
public final class f {
    ...
    private CancellationSignal f42792b;

    /* renamed from: c  reason: collision with root package name */
    private Function1 f42793c;

    /* renamed from: d  reason: collision with root package name */
    private final Lazy f42794d = l.b(new Function0() { // from class: pm.e
    ...
    private SpringAnimation f42796f;
    ...
    public static final void k(f fVar, androidx.dynamicanimation.animation.c cVar, boolean z10, float f10, float f11) {
        if (Intrinsics.areEqual(cVar, fVar.f42796f)) {
            fVar.f42796f = null;
        }
        fVar.o();
    }
    ...
    private final a p() {
        return (a) this.f42794d.getValue();
    }
    ...
    public final void v(e1 e1Var) {
        this.f42792b = null;
        this.f42791a = e1Var;
        Function1 function1 = this.f42793c;
        if (function1 != null) {
    ...
    public final void w() {
        ...
        this.f42792b = null;
        this.f42795e = false;
        SpringAnimation springAnimation = this.f42796f;
    ...
    public final void l(Float f10) {
        e1 e1Var = this.f42791a;
        if (e1Var == null) {
            CancellationSignal cancellationSignal = this.f42792b;
        ...
        if (f10 != null) {
            ...
            h(this, !this.f42795e, null, 2, null);
        } else {
            h(this, this.f42795e, null, 2, null);
        }
    }
    ...
    public final void x(View view, Function1 function1) {
        ...
        if (!t()) {
            ...
            this.f42795e = z10;
            this.f42792b = new CancellationSignal();
            this.f42793c = function1;
            pm.a.f42785a.b(true);
            WindowInsetsControllerCompat J = i0.J(view);
            if (J != null) {
                int c10 = WindowInsetsCompat.p.c();
                linearInterpolator = g.f42798a;
                J.a(c10, -1L, linearInterpolator, this.f42792b, p());
                return;
            }
            return;
        }
