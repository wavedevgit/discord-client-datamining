...
public final class f extends ReactViewGroup implements g {
    ...
    private final ThemedReactContext f46124d;

    /* renamed from: e  reason: collision with root package name */
    private final JSTouchDispatcher f46125e;

    /* renamed from: i  reason: collision with root package name */
    private c f46126i;

    /* renamed from: o  reason: collision with root package name */
    private EventDispatcher f46127o;
    ...
    public f(ThemedReactContext reactContext) {
        ...
        this.f46124d = reactContext;
        this.f46125e = new JSTouchDispatcher(this);
        if (ReactFeatureFlags.dispatchPointerEvents) {
            this.f46126i = new c(this);
        }
    }
    ...
    public void handleException(Throwable t10) {
        ...
        this.f46124d.getReactApplicationContext().handleException(new RuntimeException(t10));
    }
    ...
    public void onChildEndedNativeGesture(View childView, MotionEvent ev2) {
        ...
        EventDispatcher eventDispatcher = this.f46127o;
        if (eventDispatcher != null) {
            this.f46125e.onChildEndedNativeGesture(ev2, eventDispatcher);
        }
        c cVar = this.f46126i;
        if (cVar != null) {
    ...
    public boolean onHoverEvent(MotionEvent event) {
        ...
        EventDispatcher eventDispatcher = this.f46127o;
        if (eventDispatcher != null && (cVar = this.f46126i) != null) {
    ...
    public boolean onInterceptTouchEvent(MotionEvent event) {
        ...
        EventDispatcher eventDispatcher = this.f46127o;
        if (eventDispatcher != null) {
            this.f46125e.handleTouchEvent(event, eventDispatcher);
            c cVar = this.f46126i;
            if (cVar != null) {
                cVar.f(event, eventDispatcher, true);
            }
    ...
    public void onChildStartedNativeGesture(View view, MotionEvent ev2) {
        ...
        EventDispatcher eventDispatcher = this.f46127o;
        if (eventDispatcher != null) {
            this.f46125e.onChildStartedNativeGesture(ev2, eventDispatcher);
            c cVar = this.f46126i;
            if (cVar != null) {
