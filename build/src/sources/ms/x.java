...
public abstract class x {
    ...
    private static final CoroutineContext d(CoroutineContext coroutineContext, CoroutineContext coroutineContext2, final boolean z10) {
        ...
        CoroutineContext coroutineContext3 = (CoroutineContext) coroutineContext.A1(eVar, new Function2() { // from class: ms.v
        ...
        if (h11) {
            objectRef.element = ((CoroutineContext) objectRef.element).A1(eVar, new Function2() { // from class: ms.w
                @Override // kotlin.jvm.functions.Function2
                public final Object invoke(Object obj, Object obj2) {
    ...
    private static final boolean h(CoroutineContext coroutineContext) {
        return ((Boolean) coroutineContext.A1(Boolean.FALSE, new Function2() { // from class: ms.u
            @Override // kotlin.jvm.functions.Function2
            public final Object invoke(Object obj, Object obj2) {
                boolean i10;
    ...
    public static final CoroutineContext k(CoroutineScope coroutineScope, CoroutineContext coroutineContext) {
        ...
        if (d10 != m0.a() && d10.k(kotlin.coroutines.d.f32060g) == null) {
            return d10.V0(m0.a());
        }
        return d10;
    }
    ...
    public static final u1 m(Continuation continuation, CoroutineContext coroutineContext, Object obj) {
        if (!(continuation instanceof CoroutineStackFrame) || coroutineContext.k(v1.f38957d) == null) {
            return null;
        }
