...
public abstract class g {
    ...
    public static final ls.v E(Flow flow, CoroutineScope coroutineScope) {
    ...
    public static final Flow b(Flow flow, int i10, ls.a aVar) {
    ...
    public static final Object p(FlowCollector flowCollector, ls.v vVar, Continuation continuation) {
