...
public final class e extends h {
    ...
    public static final b f26636i = new b(null);

    /* renamed from: d  reason: collision with root package name */
    private final Method f26637d;

    /* renamed from: e  reason: collision with root package name */
    private final Method f26638e;

    /* renamed from: f  reason: collision with root package name */
    private final Method f26639f;

    /* renamed from: g  reason: collision with root package name */
    private final Class f26640g;

    /* renamed from: h  reason: collision with root package name */
    private final Class f26641h;
            ...
            if (Intrinsics.areEqual(name, "unsupported") && Intrinsics.areEqual(Void.TYPE, returnType)) {
                ...
                if ((Intrinsics.areEqual(name, "selectProtocol") || Intrinsics.areEqual(name, "select")) && Intrinsics.areEqual(String.class, returnType) && objArr.length == 1) {
                    ...
                    if (obj instanceof List) {
                        ...
                        String str2 = (String) this.f26642a.get(0);
                        this.f26644c = str2;
                        return str2;
                    }
                }
    ...
    public e(Method putMethod, Method getMethod, Method removeMethod, Class clientProviderClass, Class serverProviderClass) {
        ...
        this.f26637d = putMethod;
        this.f26638e = getMethod;
        this.f26639f = removeMethod;
        this.f26640g = clientProviderClass;
        this.f26641h = serverProviderClass;
    }
    ...
    public void b(SSLSocket sslSocket) {
        ...
        try {
            this.f26639f.invoke(null, sslSocket);
    ...
    public void e(SSLSocket sslSocket, String str, List protocols) {
        ...
        Intrinsics.checkNotNullParameter(protocols, "protocols");
        try {
            this.f26637d.invoke(null, sslSocket, Proxy.newProxyInstance(h.class.getClassLoader(), new Class[]{this.f26640g, this.f26641h}, new a(h.f26650a.b(protocols))));
        } catch (IllegalAccessException e10) {
    ...
    public String h(SSLSocket sslSocket) {
        Intrinsics.checkNotNullParameter(sslSocket, "sslSocket");
        try {
            InvocationHandler invocationHandler = Proxy.getInvocationHandler(this.f26638e.invoke(null, sslSocket));
