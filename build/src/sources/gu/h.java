...
public class h {
    ...
    private static volatile h f26651b;

    /* renamed from: c  reason: collision with root package name */
    private static final Logger f26652c;
    ...
    public static final class a {
        ...
        private final h e() {
            ...
            c a11;
            d b10;
            if (j() && (b10 = d.f26632e.b()) != null) {
                return b10;
            }
            if (i() && (a11 = c.f26629e.a()) != null) {
                return a11;
            }
            if (k() && (a10 = g.f26647e.a()) != null) {
                return a10;
            }
            f a12 = f.f26645d.a();
            if (a12 != null) {
    ...
    static {
        ...
        f26650a = aVar;
        f26651b = aVar.f();
        f26652c = Logger.getLogger(OkHttpClient.class.getName());
    }
    ...
    public ju.c c(X509TrustManager trustManager) {
        ...
        return new ju.a(d(trustManager));
    }
    ...
    public ju.e d(X509TrustManager trustManager) {
        ...
        return new ju.b((X509Certificate[]) Arrays.copyOf(acceptedIssuers, acceptedIssuers.length));
    }
    ...
    public Object i(String closer) {
        ...
        if (f26652c.isLoggable(Level.FINE)) {
