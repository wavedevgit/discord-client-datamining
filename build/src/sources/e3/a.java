...
public class a {
    ...
    private static final e[] f22234a0;

    /* renamed from: b0  reason: collision with root package name */
    private static final e[] f22235b0;

    /* renamed from: c0  reason: collision with root package name */
    private static final e[] f22236c0;

    /* renamed from: d0  reason: collision with root package name */
    private static final e[] f22237d0;

    /* renamed from: e0  reason: collision with root package name */
    private static final e[] f22238e0;

    /* renamed from: f0  reason: collision with root package name */
    private static final e f22239f0;

    /* renamed from: g0  reason: collision with root package name */
    private static final e[] f22240g0;

    /* renamed from: h0  reason: collision with root package name */
    private static final e[] f22241h0;

    /* renamed from: i0  reason: collision with root package name */
    private static final e[] f22242i0;

    /* renamed from: j0  reason: collision with root package name */
    private static final e[] f22243j0;

    /* renamed from: k0  reason: collision with root package name */
    static final e[][] f22244k0;

    /* renamed from: l0  reason: collision with root package name */
    private static final e[] f22245l0;

    /* renamed from: m0  reason: collision with root package name */
    private static final HashMap[] f22246m0;

    /* renamed from: n0  reason: collision with root package name */
    private static final HashMap[] f22247n0;

    /* renamed from: o0  reason: collision with root package name */
    private static final Set f22248o0;

    /* renamed from: p0  reason: collision with root package name */
    private static final HashMap f22249p0;

    /* renamed from: q0  reason: collision with root package name */
    private static final Charset f22250q0;

    /* renamed from: r0  reason: collision with root package name */
    static final byte[] f22251r0;

    /* renamed from: s0  reason: collision with root package name */
    private static final byte[] f22252s0;

    /* renamed from: t0  reason: collision with root package name */
    private static final Pattern f22253t0;

    /* renamed from: u0  reason: collision with root package name */
    private static final Pattern f22254u0;

    /* renamed from: v0  reason: collision with root package name */
    private static final Pattern f22255v0;

    /* renamed from: w0  reason: collision with root package name */
    private static final Pattern f22257w0;

    /* renamed from: a  reason: collision with root package name */
    private String f22261a;

    /* renamed from: b  reason: collision with root package name */
    private FileDescriptor f22262b;

    /* renamed from: c  reason: collision with root package name */
    private AssetManager.AssetInputStream f22263c;
    ...
    private final HashMap[] f22266f;

    /* renamed from: g  reason: collision with root package name */
    private Set f22267g;

    /* renamed from: h  reason: collision with root package name */
    private ByteOrder f22268h;
    ...
    private static final boolean f22256w = Log.isLoggable("ExifInterface", 3);

    /* renamed from: x  reason: collision with root package name */
    private static final List f22258x = Arrays.asList(1, 6, 3, 8);

    /* renamed from: y  reason: collision with root package name */
    private static final List f22259y = Arrays.asList(2, 7, 4, 5);

    /* renamed from: z  reason: collision with root package name */
    public static final int[] f22260z = {8, 8, 8};
    ...
    public static class c extends FilterOutputStream {
        ...
        /* renamed from: d  reason: collision with root package name */
        final DataOutputStream f22291d;

        /* renamed from: e  reason: collision with root package name */
        private ByteOrder f22292e;

        public c(OutputStream outputStream, ByteOrder byteOrder) {
            super(outputStream);
            this.f22291d = new DataOutputStream(outputStream);
            this.f22292e = byteOrder;
        }
        ...
        public void h(int i10) {
            this.f22291d.write(i10);
        }

        public void i(int i10) {
            ByteOrder byteOrder = this.f22292e;
            if (byteOrder == ByteOrder.LITTLE_ENDIAN) {
                this.f22291d.write(i10 & SetSpanOperation.SPAN_MAX_PRIORITY);
                this.f22291d.write((i10 >>> 8) & SetSpanOperation.SPAN_MAX_PRIORITY);
                this.f22291d.write((i10 >>> 16) & SetSpanOperation.SPAN_MAX_PRIORITY);
                this.f22291d.write((i10 >>> 24) & SetSpanOperation.SPAN_MAX_PRIORITY);
        ...
        public void m(short s10) {
            ByteOrder byteOrder = this.f22292e;
            if (byteOrder == ByteOrder.LITTLE_ENDIAN) {
                this.f22291d.write(s10 & 255);
                this.f22291d.write((s10 >>> 8) & SetSpanOperation.SPAN_MAX_PRIORITY);
            } else if (byteOrder == ByteOrder.BIG_ENDIAN) {
                this.f22291d.write((s10 >>> 8) & SetSpanOperation.SPAN_MAX_PRIORITY);
                this.f22291d.write(s10 & 255);
            }
        ...
        public void write(byte[] bArr) {
            this.f22291d.write(bArr);
        }

        @Override // java.io.FilterOutputStream, java.io.OutputStream
        public void write(byte[] bArr, int i10, int i11) {
            this.f22291d.write(bArr, i10, i11);
        }
    }
    ...
    public static class d {
        ...
        public static d a(String str) {
            ...
            byte[] bytes = str.getBytes(a.f22250q0);
        ...
        public static d d(f[] fVarArr, ByteOrder byteOrder) {
            ...
            wrap.order(byteOrder);
            for (f fVar : fVarArr) {
                wrap.putInt((int) fVar.f22301a);
                wrap.putInt((int) fVar.f22302b);
            }
            return new d(10, fVarArr.length, wrap.array());
        }

        public static d e(String str) {
            byte[] bytes = (str + (char) 0).getBytes(a.f22250q0);
        ...
        public String n(ByteOrder byteOrder) {
            ...
            if (o10 instanceof long[]) {
                ...
                while (i10 < fVarArr.length) {
                    sb2.append(fVarArr[i10].f22301a);
                    sb2.append('/');
                    sb2.append(fVarArr[i10].f22302b);
                    i10++;
        ...
        */
        ...
        public int p() {
            return a.Y[this.f22293a] * this.f22294b;
        }

        public String toString() {
            return "(" + a.X[this.f22293a] + ", data length:" + this.f22296d.length + ")";
        }
    ...
    public static class f {
        ...
        /* synthetic */ f(long j10, long j11, C0300a c0300a) {
            this(j10, j11);
        }
    ...
    static {
        ...
        f22238e0 = eVarArr6;
        f22239f0 = new e("StripOffsets", 273, 3);
        ...
        f22244k0 = eVarArr11;
        f22245l0 = new e[]{new e("SubIFDPointer", 330, 4), new e("ExifIFDPointer", 34665, 4), new e("GPSInfoIFDPointer", 34853, 4), new e("InteroperabilityIFDPointer", 40965, 4), new e("CameraSettingsIFDPointer", 8224, 1), new e("ImageProcessingIFDPointer", 8256, 1)};
        f22246m0 = new HashMap[eVarArr11.length];
        f22247n0 = new HashMap[eVarArr11.length];
        f22248o0 = Collections.unmodifiableSet(new HashSet(Arrays.asList("FNumber", "DigitalZoomRatio", "ExposureTime", "SubjectDistance")));
        f22249p0 = new HashMap();
        Charset forName = Charset.forName("US-ASCII");
        f22250q0 = forName;
        f22251r0 = "Exif\u0000\u0000".getBytes(forName);
        f22252s0 = "http://ns.adobe.com/xap/1.0/\u0000".getBytes(forName);
        ...
        int i10 = 0;
        while (true) {
            e[][] eVarArr12 = f22244k0;
            if (i10 < eVarArr12.length) {
                f22246m0[i10] = new HashMap();
                f22247n0[i10] = new HashMap();
                for (e eVar : eVarArr12[i10]) {
                    f22246m0[i10].put(Integer.valueOf(eVar.f22297a), eVar);
                    f22247n0[i10].put(eVar.f22298b, eVar);
                }
                i10++;
            } else {
                HashMap hashMap = f22249p0;
                e[] eVarArr13 = f22245l0;
                hashMap.put(Integer.valueOf(eVarArr13[0].f22297a), 5);
                hashMap.put(Integer.valueOf(eVarArr13[1].f22297a), 1);
                hashMap.put(Integer.valueOf(eVarArr13[2].f22297a), 2);
                hashMap.put(Integer.valueOf(eVarArr13[3].f22297a), 3);
                hashMap.put(Integer.valueOf(eVarArr13[4].f22297a), 7);
                hashMap.put(Integer.valueOf(eVarArr13[5].f22297a), 8);
                f22253t0 = Pattern.compile(".*[1-9].*");
                f22254u0 = Pattern.compile("^(\\d{2}):(\\d{2}):(\\d{2})$");
                f22255v0 = Pattern.compile("^(\\d{4}):(\\d{2}):(\\d{2})\\s(\\d{2}):(\\d{2}):(\\d{2})$");
                f22257w0 = Pattern.compile("^(\\d{4})-(\\d{2})-(\\d{2})\\s(\\d{2}):(\\d{2}):(\\d{2})$");
                return;
            }
        }
    }
    ...
    public a(File file) {
        e[][] eVarArr = f22244k0;
        this.f22266f = new HashMap[eVarArr.length];
        this.f22267g = new HashSet(eVarArr.length);
        this.f22268h = ByteOrder.BIG_ENDIAN;
        if (file != null) {
    ...
    private void E(b bVar, HashMap hashMap) {
        ...
        if (dVar != null && dVar2 != null) {
            int m10 = dVar.m(this.f22268h);
            int m11 = dVar2.m(this.f22268h);
            if (this.f22264d == 7) {
                m10 += this.f22277q;
            }
            if (m10 > 0 && m11 > 0) {
                this.f22269i = true;
                if (this.f22261a == null && this.f22263c == null && this.f22262b == null) {
    ...
    private void F(b bVar, HashMap hashMap) {
        ...
        if (dVar != null && dVar2 != null) {
            long[] c10 = e3.b.c(dVar.o(this.f22268h));
            long[] c11 = e3.b.c(dVar2.o(this.f22268h));
        ...
        if (str != null) {
            ...
            try {
                if (O(fileInputStream.getFD())) {
                    this.f22262b = fileInputStream.getFD();
                } else {
                    this.f22262b = null;
                }
                T(fileInputStream);
    ...
    private boolean P(HashMap hashMap) {
        ...
        if (dVar2 != null) {
            int[] iArr = (int[]) dVar2.o(this.f22268h);
            int[] iArr2 = f22260z;
            if (Arrays.equals(iArr2, iArr)) {
                return true;
            }
            if (this.f22264d == 3 && (dVar = (d) hashMap.get("PhotometricInterpretation")) != null && (((m10 = dVar.m(this.f22268h)) == 1 && Arrays.equals(iArr, B)) || (m10 == 6 && Arrays.equals(iArr, iArr2)))) {
                return true;
            }
        }
        if (f22256w) {
    ...
    */
    private void T(java.io.InputStream r5) {
        /*
            ...
            r1 = r0
        L2:
            e3.a$e[][] r2 = e3.a.f22244k0     // Catch: java.lang.Throwable -> L13 java.lang.UnsupportedOperationException -> L16 java.io.IOException -> L19
            int r2 = r2.length     // Catch: java.lang.Throwable -> L13 java.lang.UnsupportedOperationException -> L16 java.io.IOException -> L19
            if (r1 >= r2) goto L1c
            java.util.HashMap[] r2 = r4.f22266f     // Catch: java.lang.Throwable -> L13 java.lang.UnsupportedOperationException -> L16 java.io.IOException -> L19
        ...
        L19:
            ...
            goto Lab
        L1c:
            boolean r1 = r4.f22265e     // Catch: java.lang.Throwable -> L13 java.lang.UnsupportedOperationException -> L16 java.io.IOException -> L19
            if (r1 != 0) goto L2e
            ...
            r4.f22264d = r5     // Catch: java.lang.Throwable -> L13 java.lang.UnsupportedOperationException -> L16 java.io.IOException -> L19
            r5 = r1
        L2e:
            int r1 = r4.f22264d     // Catch: java.lang.Throwable -> L13 java.lang.UnsupportedOperationException -> L16 java.io.IOException -> L19
            ...
            boolean r5 = r4.f22265e     // Catch: java.lang.Throwable -> L13 java.lang.UnsupportedOperationException -> L16 java.io.IOException -> L19
            if (r5 == 0) goto L50
            boolean r5 = r4.y(r0)     // Catch: java.lang.Throwable -> L13 java.lang.UnsupportedOperationException -> L16 java.io.IOException -> L19
            if (r5 != 0) goto L71
            r4.e()
            boolean r5 = e3.a.f22256w
            if (r5 == 0) goto Lbe
            r4.V()
            return
        L50:
            int r5 = r4.f22264d     // Catch: java.lang.Throwable -> L13 java.lang.UnsupportedOperationException -> L16 java.io.IOException -> L19
            r1 = 12
            if (r5 == r1) goto L6e
            r1 = 15
            if (r5 != r1) goto L5b
        ...
        L71:
            int r5 = r4.f22276p     // Catch: java.lang.Throwable -> L13 java.lang.UnsupportedOperationException -> L16 java.io.IOException -> L19
        ...
        La0:
            ...
            return
        Lab:
            boolean r0 = e3.a.f22256w     // Catch: java.lang.Throwable -> L13
            if (r0 == 0) goto Lb6
    ...
    private void V() {
        for (int i10 = 0; i10 < this.f22266f.length; i10++) {
            Log.d("ExifInterface", "The size of tag group[" + i10 + "]: " + this.f22266f[i10].size());
            for (Map.Entry entry : this.f22266f[i10].entrySet()) {
                d dVar = (d) entry.getValue();
                Log.d("ExifInterface", "tagName: " + ((String) entry.getKey()) + ", tagType: " + dVar.toString() + ", tagValue: '" + dVar.n(this.f22268h) + "'");
            }
        }
    }
    ...
    */
    ...
    private void Z(String str) {
        for (int i10 = 0; i10 < f22244k0.length; i10++) {
            this.f22266f[i10].remove(str);
        }
    }

    private void a0(int i10, String str, String str2) {
        if (!this.f22266f[i10].isEmpty() && this.f22266f[i10].get(str) != null) {
            HashMap hashMap = this.f22266f[i10];
    ...
    private void b0(g gVar, int i10) {
        d dVar = (d) this.f22266f[i10].get("ImageLength");
        d dVar2 = (d) this.f22266f[i10].get("ImageWidth");
        if (dVar == null || dVar2 == null) {
            d dVar3 = (d) this.f22266f[i10].get("JPEGInterchangeFormat");
            d dVar4 = (d) this.f22266f[i10].get("JPEGInterchangeFormatLength");
            if (dVar3 != null && dVar4 != null) {
                int m10 = dVar3.m(this.f22268h);
                int m11 = dVar3.m(this.f22268h);
                gVar.s(m10);
                byte[] bArr = new byte[m11];
                gVar.readFully(bArr);
    ...
    private void d0(InputStream inputStream, OutputStream outputStream) {
        ...
        if (bVar.readByte() == -1) {
            ...
            if (bVar.readByte() == -40) {
                ...
                cVar.h(-1);
                cVar.h(-31);
                this.f22276p = q0(cVar);
                if (this.f22281u != null) {
                    cVar.write(-1);
                    cVar.h(-31);
                    byte[] bArr2 = f22252s0;
                    cVar.p(bArr2.length + 2 + this.f22281u.f22296d.length);
                    cVar.write(bArr2);
                    cVar.write(this.f22281u.f22296d);
                    this.f22282v = true;
                }
                    ...
                    if (readByte != -39 && readByte != -38) {
                        if (readByte != -31) {
                            ...
                            if (i11 >= 0) {
                                ...
                                if (bArr != null) {
                                    bVar.readFully(bArr);
                                    if (e3.b.f(bArr, f22251r0) || e3.b.f(bArr, bArr4)) {
    ...
    private void e() {
        ...
        if (k10 != null && k("DateTime") == null) {
            this.f22266f[0].put("DateTime", d.e(k10));
        }
        if (k("ImageWidth") == null) {
            this.f22266f[0].put("ImageWidth", d.f(0L, this.f22268h));
        }
        if (k("ImageLength") == null) {
            this.f22266f[0].put("ImageLength", d.f(0L, this.f22268h));
        }
        if (k("Orientation") == null) {
            this.f22266f[0].put("Orientation", d.f(0L, this.f22268h));
        }
        if (k("LightSource") == null) {
            this.f22266f[1].put("LightSource", d.f(0L, this.f22268h));
        }
    }
    ...
    */
    private void e0(java.io.InputStream r9, java.io.OutputStream r10) {
        ...
        L27:
            ...
            int r10 = r10.length
            e3.b.e(r0, r9, r10)
            e3.a$d r10 = r8.f22281u
            r1 = 1
            r2 = 0
            if (r10 != 0) goto L43
            boolean r10 = r8.f22282v
            if (r10 == 0) goto L78
        L43:
            r10 = r1
        L44:
        ...
        L4d:
            ...
            r1 = r2
        L6d:
            e3.a$d r3 = r8.f22281u
            if (r3 == 0) goto L44
            boolean r3 = r8.f22282v
            if (r3 != 0) goto L44
            r8.s0(r9)
        L78:
            r10 = r2
    ...
    */
    ...
    private void k0(b bVar) {
        HashMap hashMap = this.f22266f[4];
    ...
    private void m0(int i10, int i11) {
        if (!this.f22266f[i10].isEmpty() && !this.f22266f[i11].isEmpty()) {
            d dVar = (d) this.f22266f[i10].get("ImageLength");
            d dVar2 = (d) this.f22266f[i10].get("ImageWidth");
            d dVar3 = (d) this.f22266f[i11].get("ImageLength");
            d dVar4 = (d) this.f22266f[i11].get("ImageWidth");
            if (dVar != null && dVar2 != null) {
                if (dVar3 != null && dVar4 != null) {
                    int m10 = dVar.m(this.f22268h);
                    int m11 = dVar2.m(this.f22268h);
                    int m12 = dVar3.m(this.f22268h);
                    int m13 = dVar4.m(this.f22268h);
                    if (m10 < m12 && m11 < m13) {
                        HashMap[] hashMapArr = this.f22266f;
    ...
    private d n(String str) {
        ...
        if (str != null) {
            ...
            if ("Xmp".equals(str) && C(this.f22264d) == 2 && (dVar2 = this.f22281u) != null) {
                return dVar2;
            }
            for (int i10 = 0; i10 < f22244k0.length; i10++) {
                d dVar3 = (d) this.f22266f[i10].get(str);
                if (dVar3 != null) {
                    return dVar3;
                }
            }
            if ("Xmp".equals(str) && (dVar = this.f22281u) != null) {
                return dVar;
            }
            return null;
        }
    ...
    private void o(g gVar, int i10) {
        ...
        if (i12 >= 28) {
            ...
            try {
                try {
                    b.a.a(mediaMetadataRetriever, new C0300a(gVar));
                    ...
                    if (str != null) {
                        this.f22266f[0].put("ImageWidth", d.j(Integer.parseInt(str), this.f22268h));
                    }
                    if (str3 != null) {
                        this.f22266f[0].put("ImageLength", d.j(Integer.parseInt(str3), this.f22268h));
                    }
                    if (str2 != null) {
                        ...
                        this.f22266f[0].put("Orientation", d.j(i11, this.f22268h));
                    }
                    if (extractMetadata != null && extractMetadata2 != null) {
                        ...
                        if (parseInt3 > 6) {
                            ...
                            int i13 = parseInt2 + 6;
                            int i14 = parseInt3 - 6;
                            if (Arrays.equals(bArr, f22251r0)) {
                    ...
                    if (extractMetadata5 != null && extractMetadata6 != null) {
                        ...
                        this.f22281u = new d(1, parseInt5, j10, bArr3);
                        this.f22282v = true;
                    }
                    if (f22256w) {
    ...
    private void o0(g gVar, int i10) {
        d j10;
        d j11;
        d dVar = (d) this.f22266f[i10].get("DefaultCropSize");
        d dVar2 = (d) this.f22266f[i10].get("SensorTopBorder");
        d dVar3 = (d) this.f22266f[i10].get("SensorLeftBorder");
        d dVar4 = (d) this.f22266f[i10].get("SensorBottomBorder");
        d dVar5 = (d) this.f22266f[i10].get("SensorRightBorder");
        if (dVar != null) {
            if (dVar.f22293a == 5) {
                f[] fVarArr = (f[]) dVar.o(this.f22268h);
                if (fVarArr != null && fVarArr.length == 2) {
                    j10 = d.h(fVarArr[0], this.f22268h);
                    j11 = d.h(fVarArr[1], this.f22268h);
                } else {
                    Log.w("ExifInterface", "Invalid crop size values. cropSize=" + Arrays.toString(fVarArr));
                    return;
                }
            } else {
                int[] iArr = (int[]) dVar.o(this.f22268h);
                if (iArr != null && iArr.length == 2) {
                    j10 = d.j(iArr[0], this.f22268h);
                    j11 = d.j(iArr[1], this.f22268h);
                } else {
                    Log.w("ExifInterface", "Invalid crop size values. cropSize=" + Arrays.toString(iArr));
                    return;
                }
            }
            this.f22266f[i10].put("ImageWidth", j10);
            this.f22266f[i10].put("ImageLength", j11);
        } else if (dVar2 != null && dVar3 != null && dVar4 != null && dVar5 != null) {
            int m10 = dVar2.m(this.f22268h);
            int m11 = dVar4.m(this.f22268h);
            int m12 = dVar5.m(this.f22268h);
            int m13 = dVar3.m(this.f22268h);
            if (m11 > m10 && m12 > m13) {
                d j12 = d.j(m11 - m10, this.f22268h);
                d j13 = d.j(m12 - m13, this.f22268h);
                this.f22266f[i10].put("ImageLength", j12);
                this.f22266f[i10].put("ImageWidth", j13);
            }
        } else {
            b0(gVar, i10);
        }
    ...
    */
    ...
    private void p0() {
        ...
        m0(0, 4);
        m0(5, 4);
        d dVar = (d) this.f22266f[1].get("PixelXDimension");
        d dVar2 = (d) this.f22266f[1].get("PixelYDimension");
        if (dVar != null && dVar2 != null) {
            this.f22266f[0].put("ImageWidth", dVar);
            this.f22266f[0].put("ImageLength", dVar2);
        }
        if (this.f22266f[4].isEmpty() && R(this.f22266f[5])) {
            HashMap[] hashMapArr = this.f22266f;
    ...
    */
    ...
    private void r0(c cVar) {
        ...
        this.f22276p = cVar.f22291d.size() + q0(new c(byteArrayOutputStream, ByteOrder.BIG_ENDIAN));
    ...
    private void s(g gVar) {
        ...
        int i11;
        v(gVar);
        d dVar = (d) this.f22266f[1].get("MakerNote");
        if (dVar != null) {
            g gVar2 = new g(dVar.f22296d);
            gVar2.n(this.f22268h);
            byte[] bArr = I;
            ...
            Y(gVar2, 6);
            d dVar2 = (d) this.f22266f[7].get("PreviewImageStart");
            d dVar3 = (d) this.f22266f[7].get("PreviewImageLength");
            if (dVar2 != null && dVar3 != null) {
                this.f22266f[5].put("JPEGInterchangeFormat", dVar2);
                this.f22266f[5].put("JPEGInterchangeFormatLength", dVar3);
            }
            d dVar4 = (d) this.f22266f[8].get("AspectFrame");
            if (dVar4 != null) {
                int[] iArr = (int[]) dVar4.o(this.f22268h);
                if (iArr != null && iArr.length == 4) {
                    ...
                    if (i12 > i13 && (i10 = iArr[3]) > (i11 = iArr[1])) {
                        ...
                        d j10 = d.j(i14, this.f22268h);
                        d j11 = d.j(i15, this.f22268h);
                        this.f22266f[0].put("ImageWidth", j10);
                        this.f22266f[0].put("ImageLength", j11);
                        return;
                    }
                    return;
                }
    ...
    private void s0(c cVar) {
        cVar.i(this.f22281u.f22296d.length + 22);
        CRC32 crc32 = new CRC32();
        cVar.i(1767135348);
        n0(crc32, 1767135348);
        byte[] bArr = L;
        ...
        crc32.update(bArr);
        cVar.write(this.f22281u.f22296d);
        crc32.update(this.f22281u.f22296d);
        cVar.i((int) crc32.getValue());
        this.f22282v = true;
    }
                ...
                if (readInt2 == 1700284774 && !z10) {
                    ...
                    if (readInt >= bArr2.length) {
                        ...
                        if (Arrays.equals(bArr3, bArr2)) {
                            ...
                            this.f22281u = new d(1, i10, bVar.h() - h10, bArr4);
                            z11 = true;
                        }
                    }
                }
    ...
    private void u(b bVar) {
        ...
        for (int i13 = 0; i13 < readInt; i13++) {
            int readUnsignedShort = bVar.readUnsignedShort();
            int readUnsignedShort2 = bVar.readUnsignedShort();
            if (readUnsignedShort == f22239f0.f22297a) {
                short readShort = bVar.readShort();
                short readShort2 = bVar.readShort();
                d j10 = d.j(readShort, this.f22268h);
                d j11 = d.j(readShort2, this.f22268h);
                this.f22266f[0].put("ImageLength", j10);
                this.f22266f[0].put("ImageWidth", j11);
                if (f22256w) {
    ...
    private void v(g gVar) {
        ...
        o0(gVar, 4);
        p0();
        if (this.f22264d == 8 && (dVar = (d) this.f22266f[1].get("MakerNote")) != null) {
            g gVar2 = new g(dVar.f22296d);
            gVar2.n(this.f22268h);
            gVar2.p(6);
            Y(gVar2, 9);
            d dVar2 = (d) this.f22266f[9].get("ColorSpace");
            if (dVar2 != null) {
                this.f22266f[1].put("ColorSpace", dVar2);
            }
        }
    }
    ...
    private void x(g gVar) {
        ...
        v(gVar);
        d dVar = (d) this.f22266f[0].get("JpgFromRaw");
        if (dVar != null) {
            p(new b(dVar.f22296d), (int) dVar.f22295c, 5);
        }
        d dVar2 = (d) this.f22266f[0].get("ISO");
        d dVar3 = (d) this.f22266f[1].get("PhotographicSensitivity");
        if (dVar2 != null && dVar3 == null) {
            this.f22266f[1].put("PhotographicSensitivity", dVar2);
        }
    }
    ...
    */
    public byte[] A() {
        ...
        L8:
            ...
            return r1
        Ld:
            android.content.res.AssetManager$AssetInputStream r1 = r8.f22263c     // Catch: java.lang.Throwable -> L3b java.lang.Exception -> L3e
            if (r1 == 0) goto L2f
        ...
        L26:
            ...
            return r2
        L2f:
            java.lang.String r1 = r8.f22261a     // Catch: java.lang.Throwable -> L3b java.lang.Exception -> L3e
            if (r1 == 0) goto L43
            java.io.FileInputStream r1 = new java.io.FileInputStream     // Catch: java.lang.Throwable -> L3b java.lang.Exception -> L3e
            java.lang.String r3 = r8.f22261a     // Catch: java.lang.Throwable -> L3b java.lang.Exception -> L3e
        ...
        L3e:
            ...
            goto L82
        L43:
            java.io.FileDescriptor r1 = r8.f22262b     // Catch: java.lang.Throwable -> L3b java.lang.Exception -> L3e
        ...
        L58:
            ...
            int r5 = r8.f22272l     // Catch: java.lang.Throwable -> L77 java.lang.Exception -> L79
            int r6 = r8.f22276p     // Catch: java.lang.Throwable -> L77 java.lang.Exception -> L79
            int r5 = r5 + r6
            r4.p(r5)     // Catch: java.lang.Throwable -> L77 java.lang.Exception -> L79
            int r5 = r8.f22273m     // Catch: java.lang.Throwable -> L77 java.lang.Exception -> L79
            ...
            r8.f22274n = r5     // Catch: java.lang.Throwable -> L77 java.lang.Exception -> L79
            e3.b.b(r1)
            if (r3 == 0) goto L76
            e3.b.a(r3)
        L76:
    ...
    */
    ...
    public void h0(String str, String str2) {
        ...
        if (str5 != null) {
            ...
            int i14 = 1;
            if (str6 != null) {
                if (f22248o0.contains(str5) && !str6.contains("/")) {
                    try {
                    ...
                    boolean find = f22255v0.matcher(str6).find();
                    boolean find2 = f22257w0.matcher(str6).find();
            ...
            int i15 = 0;
            if ("Xmp".equals(str5)) {
                if (!this.f22266f[0].containsKey("Xmp") && !this.f22266f[5].containsKey("Xmp")) {
                    z10 = false;
                } else {
                    z10 = true;
                }
                int C2 = C(this.f22264d);
                if ((C2 == 2 && (this.f22281u != null || !z10)) || (C2 == 3 && !z10)) {
                    if (str6 != null) {
                        dVar = d.a(str6);
                    } else {
                        dVar = null;
            ...
            int i16 = 0;
            while (i16 < f22244k0.length) {
                if ((i16 != 4 || this.f22269i) && (eVar = (e) f22247n0[i16].get(str5)) != null) {
                    if (str6 == null) {
                        this.f22266f[i16].remove(str5);
                    } else {
                        Pair D2 = D(str6);
                        if (eVar.f22299c != ((Integer) D2.first).intValue() && eVar.f22299c != ((Integer) D2.second).intValue()) {
                            int i17 = eVar.f22300d;
                            if (i17 != -1 && (i17 == ((Integer) D2.first).intValue() || eVar.f22300d == ((Integer) D2.second).intValue())) {
                                i10 = eVar.f22300d;
                            } else {
                                int i18 = eVar.f22299c;
                                if (i18 != i14 && i18 != 7 && i18 != i13) {
                                    if (f22256w) {
                                        ...
                                        String[] strArr = X;
                                        sb2.append(strArr[eVar.f22299c]);
                                        String str8 = "";
                                        if (eVar.f22300d == -1) {
                                            str4 = "";
                                        } else {
                                            str4 = ", " + strArr[eVar.f22300d];
                                        }
                                        sb2.append(str4);
                                        sb2.append(" (guess: ");
                        ...
                        switch (i10) {
                            case 1:
                                ...
                                i11 = i14;
                                i12 = i15;
                                this.f22266f[i16].put(str5, d.a(str6));
                                break;
                            case 2:
                            case 7:
                                str3 = str7;
                                i11 = i14;
                                i12 = i15;
                                this.f22266f[i16].put(str5, d.e(str6));
                                break;
                            case 3:
                                str3 = str7;
                                i11 = i14;
                                ...
                                this.f22266f[i16].put(str5, d.k(iArr, this.f22268h));
                                break;
                            case 4:
                                str3 = str7;
                                i11 = i14;
                                ...
                                this.f22266f[i16].put(str5, d.g(jArr, this.f22268h));
                                break;
                            case 5:
                                i11 = i14;
                                i12 = i15;
                                ...
                                str3 = str7;
                                this.f22266f[i16].put(str5, d.i(fVarArr, this.f22268h));
                                break;
                            case 6:
                            case 8:
                            case 11:
                            ...
                            case 9:
                                ...
                                this.f22266f[i16].put(str5, d.c(iArr2, this.f22268h));
                                str3 = str7;
                                break;
                            case 10:
                                ...
                                i11 = i14;
                                i12 = i15;
                                this.f22266f[i16].put(str5, d.d(fVarArr2, this.f22268h));
                                str3 = str7;
                                break;
                            case 12:
                                ...
                                this.f22266f[i16].put(str5, d.b(dArr, this.f22268h));
                                break;
                        }
                        i16++;
                        i14 = i11;
    ...
    public String k(String str) {
        if (str != null) {
            ...
            if (str.equals("GPSTimeStamp")) {
                int i10 = n10.f22293a;
                if (i10 != 5 && i10 != 10) {
                    Log.w("ExifInterface", "GPS Timestamp format is not rational. format=" + n10.f22293a);
                    return null;
                }
                f[] fVarArr = (f[]) n10.o(this.f22268h);
                if (fVarArr != null && fVarArr.length == 3) {
                    f fVar = fVarArr[0];
                    Integer valueOf = Integer.valueOf((int) (((float) fVar.f22301a) / ((float) fVar.f22302b)));
                    f fVar2 = fVarArr[1];
                    Integer valueOf2 = Integer.valueOf((int) (((float) fVar2.f22301a) / ((float) fVar2.f22302b)));
                    f fVar3 = fVarArr[2];
                    return String.format("%02d:%02d:%02d", valueOf, valueOf2, Integer.valueOf((int) (((float) fVar3.f22301a) / ((float) fVar3.f22302b))));
                }
                Log.w("ExifInterface", "Invalid GPS Timestamp array. array=" + Arrays.toString(fVarArr));
                return null;
            } else if (f22248o0.contains(str)) {
                try {
                    return Double.toString(n10.l(this.f22268h));
                } catch (NumberFormatException unused) {
                    return null;
                }
            } else {
                return n10.n(this.f22268h);
            }
        }
        throw new NullPointerException("tag shouldn't be null");
    }
    ...
    public static class b extends InputStream implements DataInput {
        ...
        /* renamed from: d  reason: collision with root package name */
        protected final DataInputStream f22286d;

        /* renamed from: e  reason: collision with root package name */
        protected int f22287e;

        /* renamed from: i  reason: collision with root package name */
        private ByteOrder f22288i;

        /* renamed from: o  reason: collision with root package name */
        private byte[] f22289o;
        ...
        public byte[] i() {
            ...
            while (true) {
                ...
                int read = this.f22286d.read(bArr, i10, bArr.length - i10);
                if (read != -1) {
                    i10 += read;
                    this.f22287e += read;
                } else {
        ...
        public void p(int i10) {
            ...
            while (i11 < i10) {
                int i12 = i10 - i11;
                int skip = (int) this.f22286d.skip(i12);
                if (skip <= 0) {
                    if (this.f22289o == null) {
                        this.f22289o = new byte[8192];
                    }
                    skip = this.f22286d.read(this.f22289o, 0, Math.min(8192, i12));
                    if (skip == -1) {
        ...
        public int read() {
            this.f22287e++;
            return this.f22286d.read();
        }

        @Override // java.io.DataInput
        public boolean readBoolean() {
            this.f22287e++;
            return this.f22286d.readBoolean();
        }

        @Override // java.io.DataInput
        public byte readByte() {
            this.f22287e++;
            int read = this.f22286d.read();
            if (read >= 0) {
                return (byte) read;
            }
        ...
        public void readFully(byte[] bArr, int i10, int i11) {
            this.f22287e += i11;
            this.f22286d.readFully(bArr, i10, i11);
        }
        ...
        public int readInt() {
            this.f22287e += 4;
            int read = this.f22286d.read();
            int read2 = this.f22286d.read();
            int read3 = this.f22286d.read();
            int read4 = this.f22286d.read();
            if ((read | read2 | read3 | read4) >= 0) {
                ByteOrder byteOrder = this.f22288i;
                if (byteOrder == ByteOrder.LITTLE_ENDIAN) {
                ...
                throw new IOException("Invalid byte order: " + this.f22288i);
            }
            throw new EOFException();
        }
        ...
        public long readLong() {
            ...
            int read3 = this.f22286d.read();
            int read4 = this.f22286d.read();
            int read5 = this.f22286d.read();
            int read6 = this.f22286d.read();
            int read7 = this.f22286d.read();
            int read8 = this.f22286d.read();
        ...
        public String readUTF() {
            this.f22287e += 2;
            return this.f22286d.readUTF();
        }

        @Override // java.io.DataInput
        public int readUnsignedByte() {
            this.f22287e++;
            return this.f22286d.readUnsignedByte();
        }
        ...
        public int read(byte[] bArr, int i10, int i11) {
            int read = this.f22286d.read(bArr, i10, i11);
            this.f22287e += read;
            return read;
        }
        ...
        public void readFully(byte[] bArr) {
            this.f22287e += bArr.length;
            this.f22286d.readFully(bArr);
        }

        b(InputStream inputStream, ByteOrder byteOrder) {
            DataInputStream dataInputStream = new DataInputStream(inputStream);
            this.f22286d = dataInputStream;
            dataInputStream.mark(0);
            this.f22287e = 0;
            this.f22288i = byteOrder;
            this.f22290p = inputStream instanceof b ? ((b) inputStream).a() : -1;
        }
    }
    ...
    public static class g extends b {
        g(byte[] bArr) {
            super(bArr);
            this.f22286d.mark(Integer.MAX_VALUE);
        }
    ...
    public static class e {
        ...
        boolean a(int i10) {
            int i11;
            int i12 = this.f22299c;
            if (i12 == 7 || i10 == 7 || i12 == i10 || (i11 = this.f22300d) == i10) {
                return true;
            }
    ...
    public a(InputStream inputStream, int i10) {
        ...
        if (inputStream != null) {
            ...
            if (z10) {
                ...
                this.f22263c = (AssetManager.AssetInputStream) inputStream;
                this.f22262b = null;
            } else {
    ...
    /* loaded from: /home/runner/work/discord-client-datamining/discord-client-datamining/build/classes.dex */
    public class C0300a extends MediaDataSource {

        /* renamed from: d  reason: collision with root package name */
        long f22283d;

        /* renamed from: e  reason: collision with root package name */
        final /* synthetic */ g f22284e;
        ...
        public int readAt(long j10, byte[] bArr, int i10, int i11) {
            ...
            try {
                long j11 = this.f22283d;
                if (j11 != j10) {
                    if (j11 >= 0 && j10 >= j11 + this.f22284e.available()) {
                        return -1;
                    }
                    this.f22284e.s(j10);
                    this.f22283d = j10;
                }
                if (i11 > this.f22284e.available()) {
                    i11 = this.f22284e.available();
                }
                int read = this.f22284e.read(bArr, i10, i11);
                if (read >= 0) {
                    this.f22283d += read;
                    return read;
                }
