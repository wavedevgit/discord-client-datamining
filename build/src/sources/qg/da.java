...
public enum da implements u1 {
    ...
    AGGREGATED_AUTO_ML_IMAGE_LABELING_INFERENCE(androidx.recyclerview.widget.h.DEFAULT_DRAG_ANIMATION_DURATION),
    ...
    AGGREGATED_ON_DEVICE_SELFIE_FACE_DETECTION(MediaImageViewKt.OBSCURED_IMAGE_MIN_HEIGHT),
    ...
    ON_DEVICE_SELFIE_FACE_LOAD(IntBufferBatchMountItem.INSTRUCTION_UPDATE_PADDING),
