...
public final class yd implements pd {
    ...
    private ij.b f45207a;

    /* renamed from: b  reason: collision with root package name */
    private final ij.b f45208b;

    /* renamed from: c  reason: collision with root package name */
    private final gd f45209c;
    ...
    public yd(Context context, gd gdVar) {
        ...
        if (aVar.a().contains(yb.c.b("json"))) {
            this.f45207a = new xi.w(new ij.b() { // from class: qg.vd
                @Override // ij.b
        ...
        this.f45208b = new xi.w(new ij.b() { // from class: qg.wd
            @Override // ij.b
            public final Object get() {
    ...
    public final void a(ed edVar) {
        if (this.f45209c.a() == 0) {
            ij.b bVar = this.f45207a;
            if (bVar != null) {
                ((yb.h) bVar.get()).a(b(this.f45209c, edVar));
                return;
            }
            return;
        }
        ((yb.h) this.f45208b.get()).a(b(this.f45209c, edVar));
    }
}
