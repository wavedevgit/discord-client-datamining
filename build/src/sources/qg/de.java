...
public final class de extends jf.a {
    ...
    public final void writeToParcel(Parcel parcel, int i10) {
        ...
        jf.c.l(parcel, 1, this.f44939d);
        jf.c.l(parcel, 2, this.f44940e);
        jf.c.l(parcel, 3, this.f44941i);
        jf.c.l(parcel, 4, this.f44942o);
        jf.c.o(parcel, 5, this.f44943p);
        jf.c.b(parcel, a10);
    }
}
