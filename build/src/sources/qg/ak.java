...
public final class ak implements lj {
    ...
    private final ke f46943a;

    /* renamed from: b  reason: collision with root package name */
    private ki f46944b = new ki();
    ...
    public final byte[] a(int i10, boolean z10) {
        ...
        this.f46944b.e(Boolean.FALSE);
        this.f46943a.i(this.f46944b.m());
        try {
            jk.a();
            if (i10 == 0) {
                return new aj.d().j(cc.f46994a).k(true).i().b(this.f46943a.j()).getBytes("utf-8");
            }
            me j10 = this.f46943a.j();
            e2 e2Var = new e2();
            cc.f46994a.a(e2Var);
