...
public final class c0 implements Collection, KMappedMarker {
    ...
    public static final class a implements Iterator, KMappedMarker {
        ...
        public long a() {
            ...
            long[] jArr = this.f32157d;
            if (i10 < jArr.length) {
                this.f32158e = i10 + 1;
                return b0.d(jArr[i10]);
            }
            throw new NoSuchElementException(String.valueOf(this.f32158e));
        }

        @Override // java.util.Iterator
        public boolean hasNext() {
            if (this.f32158e < this.f32157d.length) {
                return true;
            }
            return false;
        }
    ...
    */
    public static boolean g(long[] r4, java.util.Collection r5) {
        ...
        L16:
            ...
            boolean r2 = r0 instanceof jr.b0
            if (r2 == 0) goto L31
            jr.b0 r0 = (jr.b0) r0
            long r2 = r0.h()
        ...
        L33:
            return r1
        */
        throw new UnsupportedOperationException("Method not decompiled: jr.c0.g(long[], java.util.Collection):boolean");
    }
    ...
    public boolean containsAll(Collection elements) {
        ...
        return g(this.f32156d, elements);
    }

    public boolean e(long j10) {
        return f(this.f32156d, j10);
    }

    @Override // java.util.Collection
    public boolean equals(Object obj) {
        return h(this.f32156d, obj);
    }

    @Override // java.util.Collection
    public int hashCode() {
        return m(this.f32156d);
    }

    @Override // java.util.Collection
    public boolean isEmpty() {
        return n(this.f32156d);
    }

    @Override // java.util.Collection, java.lang.Iterable
    public Iterator iterator() {
        return o(this.f32156d);
    }

    @Override // java.util.Collection
    /* renamed from: j */
    public int size() {
        return k(this.f32156d);
    }
