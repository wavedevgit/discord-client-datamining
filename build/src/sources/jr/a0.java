...
public final class a0 implements Collection, KMappedMarker {
    ...
    public static final class a implements Iterator, KMappedMarker {
        ...
        public int a() {
            ...
            int[] iArr = this.f32152d;
            if (i10 < iArr.length) {
                this.f32153e = i10 + 1;
                return z.d(iArr[i10]);
            }
            throw new NoSuchElementException(String.valueOf(this.f32153e));
        }

        @Override // java.util.Iterator
        public boolean hasNext() {
            if (this.f32153e < this.f32152d.length) {
                return true;
            }
            return false;
        }
    ...
    */
    public static boolean g(int[] r3, java.util.Collection r4) {
        ...
        L33:
            return r1
        */
        throw new UnsupportedOperationException("Method not decompiled: jr.a0.g(int[], java.util.Collection):boolean");
    }
    ...
    public boolean containsAll(Collection elements) {
        ...
        return g(this.f32151d, elements);
    }

    public boolean e(int i10) {
        return f(this.f32151d, i10);
    }

    @Override // java.util.Collection
    public boolean equals(Object obj) {
        return h(this.f32151d, obj);
    }

    @Override // java.util.Collection
    public int hashCode() {
        return m(this.f32151d);
    }

    @Override // java.util.Collection
    public boolean isEmpty() {
        return n(this.f32151d);
    }

    @Override // java.util.Collection, java.lang.Iterable
    public Iterator iterator() {
        return o(this.f32151d);
    }

    @Override // java.util.Collection
    /* renamed from: j */
    public int size() {
        return k(this.f32151d);
    }
