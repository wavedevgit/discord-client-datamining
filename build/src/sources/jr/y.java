...
public final class y implements Collection, KMappedMarker {
    ...
    public static final class a implements Iterator, KMappedMarker {
        ...
        public byte a() {
            ...
            throw new NoSuchElementException(String.valueOf(this.f32201e));
        }

        @Override // java.util.Iterator
        public boolean hasNext() {
            if (this.f32201e < this.f32200d.length) {
                return true;
            }
            return false;
        }
    ...
    */
    public static boolean g(byte[] r3, java.util.Collection r4) {
        ...
        L33:
            return r1
        */
        throw new UnsupportedOperationException("Method not decompiled: jr.y.g(byte[], java.util.Collection):boolean");
    }
    ...
    public boolean containsAll(Collection elements) {
        ...
        return g(this.f32199d, elements);
    }

    public boolean e(byte b10) {
        return f(this.f32199d, b10);
    }

    @Override // java.util.Collection
    public boolean equals(Object obj) {
        return h(this.f32199d, obj);
    }

    @Override // java.util.Collection
    public int hashCode() {
        return m(this.f32199d);
    }

    @Override // java.util.Collection
    public boolean isEmpty() {
        return n(this.f32199d);
    }

    @Override // java.util.Collection, java.lang.Iterable
    public Iterator iterator() {
        return o(this.f32199d);
    }

    @Override // java.util.Collection
    /* renamed from: j */
    public int size() {
        return k(this.f32199d);
    }
