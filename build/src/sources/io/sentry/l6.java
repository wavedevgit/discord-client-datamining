...
public final class l6 {
    ...
    private static final Charset f30032d = Charset.forName("UTF-8");

    /* renamed from: a  reason: collision with root package name */
    private final m6 f30033a;

    /* renamed from: b  reason: collision with root package name */
    private final Callable f30034b;

    /* renamed from: c  reason: collision with root package name */
    private byte[] f30035c;
    ...
    public static class a {
        ...
        /* renamed from: a  reason: collision with root package name */
        private byte[] f30036a;

        /* renamed from: b  reason: collision with root package name */
        private final Callable f30037b;
        ...
        public byte[] a() {
            Callable callable;
            if (this.f30036a == null && (callable = this.f30037b) != null) {
                this.f30036a = (byte[]) callable.call();
            }
            return b(this.f30036a);
        }
    }

    /* JADX INFO: Access modifiers changed from: package-private */
    public l6(m6 m6Var, byte[] bArr) {
        this.f30033a = (m6) io.sentry.util.y.c(m6Var, "SentryEnvelopeItemHeader is required.");
        this.f30035c = bArr;
        this.f30034b = null;
    }
    ...
    private static byte[] N(Map map) {
        ...
        try {
            ...
            for (Map.Entry entry : map.entrySet()) {
                byte[] bytes = ((String) entry.getKey()).getBytes(f30032d);
    ...
    public static /* synthetic */ byte[] c(b1 b1Var, l7 l7Var, v3 v3Var, File file, ILogger iLogger, boolean z10) {
        try {
            ByteArrayOutputStream byteArrayOutputStream = new ByteArrayOutputStream();
            BufferedWriter bufferedWriter = new BufferedWriter(new OutputStreamWriter(byteArrayOutputStream, f30032d));
            try {
    ...
    public io.sentry.clientreport.c H(b1 b1Var) {
        m6 m6Var = this.f30033a;
        if (m6Var != null && m6Var.b() == v6.ClientReport) {
            BufferedReader bufferedReader = new BufferedReader(new InputStreamReader(new ByteArrayInputStream(I()), f30032d));
            try {
    ...
    public byte[] I() {
        Callable callable;
        if (this.f30035c == null && (callable = this.f30034b) != null) {
            this.f30035c = (byte[]) callable.call();
        }
        return this.f30035c;
    }
    ...
    l6(m6 m6Var, Callable callable) {
        this.f30033a = (m6) io.sentry.util.y.c(m6Var, "SentryEnvelopeItemHeader is required.");
        this.f30034b = (Callable) io.sentry.util.y.c(callable, "DataFactory is required.");
        this.f30035c = null;
    }
}
