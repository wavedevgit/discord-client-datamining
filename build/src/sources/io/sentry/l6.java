...
public final class l6 {
    ...
    private static final Charset f29464d = Charset.forName("UTF-8");

    /* renamed from: a  reason: collision with root package name */
    private final m6 f29465a;

    /* renamed from: b  reason: collision with root package name */
    private final Callable f29466b;

    /* renamed from: c  reason: collision with root package name */
    private byte[] f29467c;
    ...
    public static class a {
        ...
        /* renamed from: a  reason: collision with root package name */
        private byte[] f29468a;

        /* renamed from: b  reason: collision with root package name */
        private final Callable f29469b;

        public a(Callable callable) {
            this.f29469b = callable;
        }
        ...
        public byte[] a() {
            Callable callable;
            if (this.f29468a == null && (callable = this.f29469b) != null) {
                this.f29468a = (byte[]) callable.call();
            }
            return b(this.f29468a);
        }
    }

    /* JADX INFO: Access modifiers changed from: package-private */
    public l6(m6 m6Var, byte[] bArr) {
        this.f29465a = (m6) io.sentry.util.y.c(m6Var, "SentryEnvelopeItemHeader is required.");
        this.f29467c = bArr;
        this.f29466b = null;
    }
    ...
    private static byte[] N(Map map) {
        ...
        try {
            ...
            for (Map.Entry entry : map.entrySet()) {
                byte[] bytes = ((String) entry.getKey()).getBytes(f29464d);
    ...
    public static /* synthetic */ byte[] c(b1 b1Var, l7 l7Var, v3 v3Var, File file, ILogger iLogger, boolean z10) {
        try {
            ByteArrayOutputStream byteArrayOutputStream = new ByteArrayOutputStream();
            BufferedWriter bufferedWriter = new BufferedWriter(new OutputStreamWriter(byteArrayOutputStream, f29464d));
            try {
    ...
    public io.sentry.clientreport.c H(b1 b1Var) {
        m6 m6Var = this.f29465a;
        if (m6Var != null && m6Var.b() == v6.ClientReport) {
            BufferedReader bufferedReader = new BufferedReader(new InputStreamReader(new ByteArrayInputStream(I()), f29464d));
            try {
    ...
    public byte[] I() {
        Callable callable;
        if (this.f29467c == null && (callable = this.f29466b) != null) {
            this.f29467c = (byte[]) callable.call();
        }
        return this.f29467c;
    }
    ...
    l6(m6 m6Var, Callable callable) {
        this.f29465a = (m6) io.sentry.util.y.c(m6Var, "SentryEnvelopeItemHeader is required.");
        this.f29466b = (Callable) io.sentry.util.y.c(callable, "DataFactory is required.");
        this.f29467c = null;
    }
}
