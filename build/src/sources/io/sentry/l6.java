...
public final class l6 {
    ...
    private static final Charset f29463d = Charset.forName("UTF-8");

    /* renamed from: a  reason: collision with root package name */
    private final m6 f29464a;

    /* renamed from: b  reason: collision with root package name */
    private final Callable f29465b;

    /* renamed from: c  reason: collision with root package name */
    private byte[] f29466c;
    ...
    public static class a {
        ...
        /* renamed from: a  reason: collision with root package name */
        private byte[] f29467a;

        /* renamed from: b  reason: collision with root package name */
        private final Callable f29468b;

        public a(Callable callable) {
            this.f29468b = callable;
        }
        ...
        public byte[] a() {
            Callable callable;
            if (this.f29467a == null && (callable = this.f29468b) != null) {
                this.f29467a = (byte[]) callable.call();
            }
            return b(this.f29467a);
        }
    }

    /* JADX INFO: Access modifiers changed from: package-private */
    public l6(m6 m6Var, byte[] bArr) {
        this.f29464a = (m6) io.sentry.util.y.c(m6Var, "SentryEnvelopeItemHeader is required.");
        this.f29466c = bArr;
        this.f29465b = null;
    }
    ...
    private static byte[] N(Map map) {
        ...
        try {
            ...
            for (Map.Entry entry : map.entrySet()) {
                byte[] bytes = ((String) entry.getKey()).getBytes(f29463d);
    ...
    public static /* synthetic */ byte[] c(b1 b1Var, l7 l7Var, v3 v3Var, File file, ILogger iLogger, boolean z10) {
        try {
            ByteArrayOutputStream byteArrayOutputStream = new ByteArrayOutputStream();
            BufferedWriter bufferedWriter = new BufferedWriter(new OutputStreamWriter(byteArrayOutputStream, f29463d));
            try {
    ...
    public io.sentry.clientreport.c H(b1 b1Var) {
        m6 m6Var = this.f29464a;
        if (m6Var != null && m6Var.b() == v6.ClientReport) {
            BufferedReader bufferedReader = new BufferedReader(new InputStreamReader(new ByteArrayInputStream(I()), f29463d));
            try {
    ...
    public byte[] I() {
        Callable callable;
        if (this.f29466c == null && (callable = this.f29465b) != null) {
            this.f29466c = (byte[]) callable.call();
        }
        return this.f29466c;
    }
    ...
    l6(m6 m6Var, Callable callable) {
        this.f29464a = (m6) io.sentry.util.y.c(m6Var, "SentryEnvelopeItemHeader is required.");
        this.f29465b = (Callable) io.sentry.util.y.c(callable, "DataFactory is required.");
        this.f29466c = null;
    }
}
