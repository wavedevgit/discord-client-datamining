...
public final class l6 {
    ...
    private static final Charset f29717d = Charset.forName("UTF-8");

    /* renamed from: a  reason: collision with root package name */
    private final m6 f29718a;

    /* renamed from: b  reason: collision with root package name */
    private final Callable f29719b;

    /* renamed from: c  reason: collision with root package name */
    private byte[] f29720c;
    ...
    public static class a {
        ...
        /* renamed from: a  reason: collision with root package name */
        private byte[] f29721a;

        /* renamed from: b  reason: collision with root package name */
        private final Callable f29722b;

        public a(Callable callable) {
            this.f29722b = callable;
        }
        ...
        public byte[] a() {
            Callable callable;
            if (this.f29721a == null && (callable = this.f29722b) != null) {
                this.f29721a = (byte[]) callable.call();
            }
            return b(this.f29721a);
        }
    }

    /* JADX INFO: Access modifiers changed from: package-private */
    public l6(m6 m6Var, byte[] bArr) {
        this.f29718a = (m6) io.sentry.util.y.c(m6Var, "SentryEnvelopeItemHeader is required.");
        this.f29720c = bArr;
        this.f29719b = null;
    }
    ...
    private static byte[] N(Map map) {
        ...
        try {
            ...
            for (Map.Entry entry : map.entrySet()) {
                byte[] bytes = ((String) entry.getKey()).getBytes(f29717d);
    ...
    public static /* synthetic */ byte[] c(b1 b1Var, l7 l7Var, v3 v3Var, File file, ILogger iLogger, boolean z10) {
        try {
            ByteArrayOutputStream byteArrayOutputStream = new ByteArrayOutputStream();
            BufferedWriter bufferedWriter = new BufferedWriter(new OutputStreamWriter(byteArrayOutputStream, f29717d));
            try {
    ...
    public io.sentry.clientreport.c H(b1 b1Var) {
        m6 m6Var = this.f29718a;
        if (m6Var != null && m6Var.b() == v6.ClientReport) {
            BufferedReader bufferedReader = new BufferedReader(new InputStreamReader(new ByteArrayInputStream(I()), f29717d));
            try {
    ...
    public byte[] I() {
        Callable callable;
        if (this.f29720c == null && (callable = this.f29719b) != null) {
            this.f29720c = (byte[]) callable.call();
        }
        return this.f29720c;
    }
    ...
    l6(m6 m6Var, Callable callable) {
        this.f29718a = (m6) io.sentry.util.y.c(m6Var, "SentryEnvelopeItemHeader is required.");
        this.f29719b = (Callable) io.sentry.util.y.c(callable, "DataFactory is required.");
        this.f29720c = null;
    }
}
