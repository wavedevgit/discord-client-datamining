...
public final class l6 {
    ...
    private static final Charset f28280d = Charset.forName("UTF-8");

    /* renamed from: a  reason: collision with root package name */
    private final m6 f28281a;

    /* renamed from: b  reason: collision with root package name */
    private final Callable f28282b;

    /* renamed from: c  reason: collision with root package name */
    private byte[] f28283c;
    ...
    public static class a {
        ...
        /* renamed from: a  reason: collision with root package name */
        private byte[] f28284a;

        /* renamed from: b  reason: collision with root package name */
        private final Callable f28285b;

        public a(Callable callable) {
            this.f28285b = callable;
        }
        ...
        public byte[] a() {
            Callable callable;
            if (this.f28284a == null && (callable = this.f28285b) != null) {
                this.f28284a = (byte[]) callable.call();
            }
            return b(this.f28284a);
        }
    }

    /* JADX INFO: Access modifiers changed from: package-private */
    public l6(m6 m6Var, byte[] bArr) {
        this.f28281a = (m6) io.sentry.util.y.c(m6Var, "SentryEnvelopeItemHeader is required.");
        this.f28283c = bArr;
        this.f28282b = null;
    }
    ...
    private static byte[] N(Map map) {
        ...
        try {
            ...
            for (Map.Entry entry : map.entrySet()) {
                byte[] bytes = ((String) entry.getKey()).getBytes(f28280d);
    ...
    public static /* synthetic */ byte[] c(b1 b1Var, l7 l7Var, v3 v3Var, File file, ILogger iLogger, boolean z10) {
        try {
            ByteArrayOutputStream byteArrayOutputStream = new ByteArrayOutputStream();
            BufferedWriter bufferedWriter = new BufferedWriter(new OutputStreamWriter(byteArrayOutputStream, f28280d));
            try {
    ...
    public io.sentry.clientreport.c H(b1 b1Var) {
        m6 m6Var = this.f28281a;
        if (m6Var != null && m6Var.b() == v6.ClientReport) {
            BufferedReader bufferedReader = new BufferedReader(new InputStreamReader(new ByteArrayInputStream(I()), f28280d));
            try {
    ...
    public byte[] I() {
        Callable callable;
        if (this.f28283c == null && (callable = this.f28282b) != null) {
            this.f28283c = (byte[]) callable.call();
        }
        return this.f28283c;
    }
    ...
    l6(m6 m6Var, Callable callable) {
        this.f28281a = (m6) io.sentry.util.y.c(m6Var, "SentryEnvelopeItemHeader is required.");
        this.f28282b = (Callable) io.sentry.util.y.c(callable, "DataFactory is required.");
        this.f28283c = null;
    }
}
