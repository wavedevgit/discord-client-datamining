...
public final class e2 implements io.sentry.b0 {
    ...
    private final i f27083e;

    /* renamed from: i  reason: collision with root package name */
    private final SentryAndroidOptions f27084i;

    /* renamed from: d  reason: collision with root package name */
    private boolean f27082d = false;

    /* renamed from: o  reason: collision with root package name */
    private final io.sentry.util.a f27085o = new io.sentry.util.a();

    /* JADX INFO: Access modifiers changed from: package-private */
    public e2(SentryAndroidOptions sentryAndroidOptions, i iVar) {
        this.f27084i = (SentryAndroidOptions) io.sentry.util.y.c(sentryAndroidOptions, "SentryAndroidOptions is required");
        this.f27083e = (i) io.sentry.util.y.c(iVar, "ActivityFramesTracker is required");
    }
    ...
    */
    ...
    private static io.sentry.protocol.a0 f(io.sentry.android.core.performance.i iVar, j8 j8Var, io.sentry.protocol.x xVar, String str) {
        ...
        hashMap.put("thread.id", Long.valueOf(io.sentry.android.core.internal.util.j.f27239b));
    ...
    public io.sentry.protocol.d0 k(io.sentry.protocol.d0 d0Var, Hint hint) {
        ...
        String str;
        String str2;
        io.sentry.a1 a10 = this.f27085o.a();
        try {
            if (!this.f27084i.isTracingEnabled()) {
                if (a10 != null) {
                    a10.close();
                }
                return d0Var;
            ...
            e8 j10 = d0Var.C().j();
            if (G != null && j10 != null && j10.f().contentEquals("ui.load") && (n10 = this.f27083e.n(G)) != null) {
                d0Var.o0().putAll(n10);
            }
            if (a10 != null) {
                a10.close();
