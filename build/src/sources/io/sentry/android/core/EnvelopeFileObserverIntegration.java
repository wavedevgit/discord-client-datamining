...
public abstract class EnvelopeFileObserverIntegration implements io.sentry.k1, Closeable {
    ...
    private ILogger f28370e;

    /* renamed from: i  reason: collision with root package name */
    private boolean f28371i = false;

    /* renamed from: o  reason: collision with root package name */
    protected final io.sentry.util.a f28372o = new io.sentry.util.a();
    ...
    public static /* synthetic */ void a(EnvelopeFileObserverIntegration envelopeFileObserverIntegration, io.sentry.w0 w0Var, k7 k7Var, String str) {
        io.sentry.a1 a10 = envelopeFileObserverIntegration.f28372o.a();
        try {
            if (!envelopeFileObserverIntegration.f28371i) {
    ...
    public void close() {
        io.sentry.a1 a10 = this.f28372o.a();
        try {
            this.f28371i = true;
            if (a10 != null) {
                a10.close();
            }
            o1 o1Var = this.f28369d;
            if (o1Var != null) {
                o1Var.stopWatching();
                ILogger iLogger = this.f28370e;
                if (iLogger != null) {
    ...
    public final void h(final io.sentry.w0 w0Var, final k7 k7Var) {
        ...
        this.f28370e = k7Var.getLogger();
        final String n10 = n(k7Var);
        if (n10 == null) {
            this.f28370e.c(SentryLevel.WARNING, "Null given as a path to EnvelopeFileObserverIntegration. Nothing will be registered.", new Object[0]);
            return;
        }
        this.f28370e.c(SentryLevel.DEBUG, "Registering EnvelopeFileObserverIntegration for path: %s", n10);
        try {
            ...
            this.f28370e.b(SentryLevel.DEBUG, "Failed to start EnvelopeFileObserverIntegration on executor thread.", th2);
        }
    }
