...
public abstract class EnvelopeFileObserverIntegration implements io.sentry.k1, Closeable {
    ...
    private ILogger f28116e;

    /* renamed from: i  reason: collision with root package name */
    private boolean f28117i = false;

    /* renamed from: o  reason: collision with root package name */
    protected final io.sentry.util.a f28118o = new io.sentry.util.a();
    ...
    public static /* synthetic */ void a(EnvelopeFileObserverIntegration envelopeFileObserverIntegration, io.sentry.w0 w0Var, k7 k7Var, String str) {
        io.sentry.a1 a10 = envelopeFileObserverIntegration.f28118o.a();
        try {
            if (!envelopeFileObserverIntegration.f28117i) {
    ...
    public void close() {
        io.sentry.a1 a10 = this.f28118o.a();
        try {
            this.f28117i = true;
            if (a10 != null) {
                a10.close();
            }
            o1 o1Var = this.f28115d;
            if (o1Var != null) {
                o1Var.stopWatching();
                ILogger iLogger = this.f28116e;
                if (iLogger != null) {
    ...
    public final void h(final io.sentry.w0 w0Var, final k7 k7Var) {
        ...
        this.f28116e = k7Var.getLogger();
        final String m10 = m(k7Var);
        if (m10 == null) {
            this.f28116e.c(SentryLevel.WARNING, "Null given as a path to EnvelopeFileObserverIntegration. Nothing will be registered.", new Object[0]);
            return;
        }
        this.f28116e.c(SentryLevel.DEBUG, "Registering EnvelopeFileObserverIntegration for path: %s", m10);
        try {
            ...
            this.f28116e.b(SentryLevel.DEBUG, "Failed to start EnvelopeFileObserverIntegration on executor thread.", th2);
        }
    }
