...
public final class AnrIntegration implements io.sentry.k1, Closeable {
    ...
    private static c f28653p;

    /* renamed from: q  reason: collision with root package name */
    protected static final io.sentry.util.a f28654q = new io.sentry.util.a();

    /* renamed from: d  reason: collision with root package name */
    private final Context f28655d;

    /* renamed from: e  reason: collision with root package name */
    private boolean f28656e = false;

    /* renamed from: i  reason: collision with root package name */
    private final io.sentry.util.a f28657i = new io.sentry.util.a();
    ...
    public static /* synthetic */ void a(AnrIntegration anrIntegration, io.sentry.w0 w0Var, SentryAndroidOptions sentryAndroidOptions) {
        io.sentry.a1 a10 = anrIntegration.f28657i.a();
        try {
            if (!anrIntegration.f28656e) {
    ...
    private void s(final io.sentry.w0 w0Var, final SentryAndroidOptions sentryAndroidOptions) {
        ...
        try {
            if (f28653p == null) {
                ...
                }, sentryAndroidOptions.getLogger(), this.f28655d);
                f28653p = cVar;
                cVar.start();
    ...
    public void close() {
        io.sentry.a1 a10 = this.f28657i.a();
        try {
            this.f28656e = true;
            if (a10 != null) {
                a10.close();
    ...
    public final void h(io.sentry.w0 w0Var, k7 k7Var) {
        this.f28658o = (k7) io.sentry.util.y.c(k7Var, "SentryOptions is required");
