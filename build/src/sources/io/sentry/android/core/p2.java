...
public class p2 implements io.sentry.s0, c0.b {
    ...
    private static final long f27562h = TimeUnit.SECONDS.toNanos(1);

    /* renamed from: i  reason: collision with root package name */
    private static final c7 f27563i = new c7(new Date(0), 0);

    /* renamed from: a  reason: collision with root package name */
    private final boolean f27564a;

    /* renamed from: c  reason: collision with root package name */
    private final io.sentry.android.core.internal.util.c0 f27566c;

    /* renamed from: d  reason: collision with root package name */
    private volatile String f27567d;

    /* renamed from: b  reason: collision with root package name */
    protected final io.sentry.util.a f27565b = new io.sentry.util.a();

    /* renamed from: e  reason: collision with root package name */
    private final SortedSet f27568e = new TreeSet(new Comparator() { // from class: io.sentry.android.core.o2
    ...
    private final ConcurrentSkipListSet f27569f = new ConcurrentSkipListSet();

    /* renamed from: g  reason: collision with root package name */
    private long f27570g = 16666666;
    ...
    public static class a implements Comparable {
        ...
        /* renamed from: e  reason: collision with root package name */
        private final long f27572e;

        /* renamed from: i  reason: collision with root package name */
        private final long f27573i;

        /* renamed from: o  reason: collision with root package name */
        private final long f27574o;

        /* renamed from: p  reason: collision with root package name */
        private final boolean f27575p;

        /* renamed from: q  reason: collision with root package name */
        private final boolean f27576q;

        /* renamed from: r  reason: collision with root package name */
        private final long f27577r;
        ...
        public int compareTo(a aVar) {
            return Long.compare(this.f27572e, aVar.f27572e);
        }
    ...
    private void h(ISpan iSpan) {
        io.sentry.a1 a10 = this.f27565b.a();
        try {
            if (!this.f27568e.remove(iSpan)) {
                if (a10 != null) {
                    a10.close();
                    return;
                }
            ...
            m2 m2Var = new m2();
            long j14 = this.f27570g;
            if (!this.f27569f.isEmpty()) {
                for (a aVar : this.f27569f.tailSet((ConcurrentSkipListSet) new a(j10))) {
                    if (aVar.f27571d > j11) {
                        break;
                    }
                    if (aVar.f27571d >= j10 && aVar.f27572e <= j11) {
                        m2Var.a(aVar.f27573i, aVar.f27574o, aVar.f27575p, aVar.f27576q);
                    } else if ((j10 > aVar.f27571d && j10 < aVar.f27572e) || (j11 > aVar.f27571d && j11 < aVar.f27572e)) {
                        long min = Math.min(aVar.f27574o - Math.max(j13, Math.max(j13, j10 - aVar.f27571d) - aVar.f27577r), j12);
                        long min2 = Math.min(j11, aVar.f27572e) - Math.max(j10, aVar.f27571d);
                        m2Var.a(min2, min, io.sentry.android.core.internal.util.c0.j(min2, aVar.f27577r), io.sentry.android.core.internal.util.c0.i(min2));
                    }
                    j14 = aVar.f27577r;
                    j13 = 0;
                }
    ...
    public void a(ISpan iSpan) {
        if (!this.f27564a || (iSpan instanceof y2) || (iSpan instanceof a3)) {
            return;
        }
        io.sentry.a1 a10 = this.f27565b.a();
        try {
            if (!this.f27568e.contains(iSpan)) {
                if (a10 != null) {
                    a10.close();
                    return;
                }
            ...
            try {
                if (this.f27568e.isEmpty()) {
                    ...
                    this.f27569f.headSet((ConcurrentSkipListSet) new a(j(((ISpan) this.f27568e.first()).t()))).clear();
                }
                if (a10 != null) {
                    a10.close();
                }
    ...
    public void b(ISpan iSpan) {
        ...
        io.sentry.a1 a10 = this.f27565b.a();
        try {
            this.f27568e.add(iSpan);
            if (this.f27567d == null) {
                this.f27567d = this.f27566c.l(this);
            }
            if (a10 != null) {
                a10.close();
            }
    ...
    public void e(long j10, long j11, long j12, long j13, boolean z10, boolean z11, float f10) {
        if (this.f27569f.size() <= 3600) {
            long j14 = (long) (f27562h / f10);
            this.f27570g = j14;
            if (!z10 && !z11) {
                return;
            }
            this.f27569f.add(new a(j10, j11, j12, j13, z10, z11, j14));
        }
    }
}
