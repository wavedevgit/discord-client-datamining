...
public class p2 implements io.sentry.s0, c0.b {
    ...
    private static final long f28498h = TimeUnit.SECONDS.toNanos(1);

    /* renamed from: i  reason: collision with root package name */
    private static final c7 f28499i = new c7(new Date(0), 0);

    /* renamed from: a  reason: collision with root package name */
    private final boolean f28500a;

    /* renamed from: c  reason: collision with root package name */
    private final io.sentry.android.core.internal.util.c0 f28502c;

    /* renamed from: d  reason: collision with root package name */
    private volatile String f28503d;

    /* renamed from: b  reason: collision with root package name */
    protected final io.sentry.util.a f28501b = new io.sentry.util.a();

    /* renamed from: e  reason: collision with root package name */
    private final SortedSet f28504e = new TreeSet(new Comparator() { // from class: io.sentry.android.core.o2
    ...
    private final ConcurrentSkipListSet f28505f = new ConcurrentSkipListSet();

    /* renamed from: g  reason: collision with root package name */
    private long f28506g = 16666666;
    ...
    public static class a implements Comparable {
        ...
        /* renamed from: i  reason: collision with root package name */
        private final long f28509i;

        /* renamed from: o  reason: collision with root package name */
        private final long f28510o;
        ...
        public int compareTo(a aVar) {
            return Long.compare(this.f28508e, aVar.f28508e);
        }
    ...
    private void h(ISpan iSpan) {
        io.sentry.a1 a10 = this.f28501b.a();
        try {
            if (!this.f28504e.remove(iSpan)) {
                if (a10 != null) {
                    a10.close();
                    return;
                }
            ...
            m2 m2Var = new m2();
            long j14 = this.f28506g;
            if (!this.f28505f.isEmpty()) {
                for (a aVar : this.f28505f.tailSet((ConcurrentSkipListSet) new a(j10))) {
                    if (aVar.f28507d > j11) {
                        break;
                    }
                    if (aVar.f28507d >= j10 && aVar.f28508e <= j11) {
                        m2Var.a(aVar.f28509i, aVar.f28510o, aVar.f28511p, aVar.f28512q);
                    } else if ((j10 > aVar.f28507d && j10 < aVar.f28508e) || (j11 > aVar.f28507d && j11 < aVar.f28508e)) {
                        long min = Math.min(aVar.f28510o - Math.max(j13, Math.max(j13, j10 - aVar.f28507d) - aVar.f28513r), j12);
                        long min2 = Math.min(j11, aVar.f28508e) - Math.max(j10, aVar.f28507d);
                        m2Var.a(min2, min, io.sentry.android.core.internal.util.c0.j(min2, aVar.f28513r), io.sentry.android.core.internal.util.c0.i(min2));
                    }
                    j14 = aVar.f28513r;
                    j13 = 0;
                }
    ...
    public void a(ISpan iSpan) {
        if (!this.f28500a || (iSpan instanceof y2) || (iSpan instanceof a3)) {
            return;
        }
        io.sentry.a1 a10 = this.f28501b.a();
        try {
            if (!this.f28504e.contains(iSpan)) {
                if (a10 != null) {
                    a10.close();
                    return;
                }
            ...
            try {
                if (this.f28504e.isEmpty()) {
                    ...
                    this.f28505f.headSet((ConcurrentSkipListSet) new a(j(((ISpan) this.f28504e.first()).t()))).clear();
                }
                if (a10 != null) {
                    a10.close();
                }
    ...
    public void b(ISpan iSpan) {
        ...
        io.sentry.a1 a10 = this.f28501b.a();
        try {
            this.f28504e.add(iSpan);
            if (this.f28503d == null) {
                this.f28503d = this.f28502c.l(this);
            }
            if (a10 != null) {
                a10.close();
            }
    ...
    public void e(long j10, long j11, long j12, long j13, boolean z10, boolean z11, float f10) {
        if (this.f28505f.size() <= 3600) {
            long j14 = (long) (f28498h / f10);
            this.f28506g = j14;
            if (!z10 && !z11) {
                return;
            }
            this.f28505f.add(new a(j10, j11, j12, j13, z10, z11, j14));
        }
    }
}
