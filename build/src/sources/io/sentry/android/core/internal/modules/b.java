...
public final class b extends d {
    ...
    protected Map b() {
        ...
        try {
            InputStream open = this.f28562e.getAssets().open("sentry-external-modules.txt");
            try {
                Map c10 = c(open);
                if (open != null) {
                    open.close();
            ...
            this.f29651a.b(SentryLevel.ERROR, "Error extracting modules.", e10);
            return treeMap;
        }
    }
}
