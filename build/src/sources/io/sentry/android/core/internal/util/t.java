...
public final class t {
    ...
    private static final Charset f28395g = Charset.forName("UTF-8");

    /* renamed from: a  reason: collision with root package name */
    private final Context f28396a;

    /* renamed from: b  reason: collision with root package name */
    private final x0 f28397b;

    /* renamed from: c  reason: collision with root package name */
    private final ILogger f28398c;
    ...
    private boolean b() {
        String[] strArr;
        for (String str : this.f28399d) {
            try {
            } catch (RuntimeException e10) {
                this.f28398c.a(SentryLevel.ERROR, e10, "Error when trying to check if root file %s exists.", str);
            }
    ...
    */
    private boolean c() {
        /*
            ...
            r1 = 0
            r2 = 0
            java.lang.Runtime r3 = r6.f28401f     // Catch: java.lang.Throwable -> L30 java.io.IOException -> L4d
            ...
            java.nio.charset.Charset r5 = io.sentry.android.core.internal.util.t.f28395g     // Catch: java.lang.Throwable -> L30 java.io.IOException -> L4d
        ...
        L3c:
            io.sentry.ILogger r3 = r6.f28398c     // Catch: java.lang.Throwable -> L4b
        ...
        L4b:
            ...
            goto L5c
        L4d:
            io.sentry.ILogger r0 = r6.f28398c     // Catch: java.lang.Throwable -> L4b
    ...
    t(Context context, x0 x0Var, ILogger iLogger, String[] strArr, String[] strArr2, Runtime runtime) {
        this.f28396a = (Context) io.sentry.util.y.c(context, "The application context is required.");
        this.f28397b = (x0) io.sentry.util.y.c(x0Var, "The BuildInfoProvider is required.");
        this.f28398c = (ILogger) io.sentry.util.y.c(iLogger, "The Logger is required.");
        this.f28399d = (String[]) io.sentry.util.y.c(strArr, "The root Files are required.");
        this.f28400e = (String[]) io.sentry.util.y.c(strArr2, "The root packages are required.");
        this.f28401f = (Runtime) io.sentry.util.y.c(runtime, "The Runtime is required.");
    }
}
