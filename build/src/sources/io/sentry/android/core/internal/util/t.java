...
public final class t {
    ...
    private static final Charset f28963g = Charset.forName("UTF-8");
    ...
    private boolean b() {
        String[] strArr;
        for (String str : this.f28967d) {
            try {
            } catch (RuntimeException e10) {
                this.f28966c.a(SentryLevel.ERROR, e10, "Error when trying to check if root file %s exists.", str);
            }
    ...
    */
    private boolean c() {
        /*
            ...
            r1 = 0
            r2 = 0
            java.lang.Runtime r3 = r6.f28969f     // Catch: java.lang.Throwable -> L30 java.io.IOException -> L4d
            ...
            java.nio.charset.Charset r5 = io.sentry.android.core.internal.util.t.f28963g     // Catch: java.lang.Throwable -> L30 java.io.IOException -> L4d
        ...
        L3c:
            io.sentry.ILogger r3 = r6.f28966c     // Catch: java.lang.Throwable -> L4b
        ...
        L4b:
            ...
            goto L5c
        L4d:
            io.sentry.ILogger r0 = r6.f28966c     // Catch: java.lang.Throwable -> L4b
    ...
    private boolean d(ILogger iLogger) {
        ...
        PackageManager packageManager = this.f28964a.getPackageManager();
        if (packageManager != null) {
            for (String str : this.f28968e) {
                try {
                    if (x0Var.d() >= 33) {
    ...
    t(Context context, x0 x0Var, ILogger iLogger, String[] strArr, String[] strArr2, Runtime runtime) {
        this.f28964a = (Context) io.sentry.util.y.c(context, "The application context is required.");
        this.f28965b = (x0) io.sentry.util.y.c(x0Var, "The BuildInfoProvider is required.");
        this.f28966c = (ILogger) io.sentry.util.y.c(iLogger, "The Logger is required.");
        this.f28967d = (String[]) io.sentry.util.y.c(strArr, "The root Files are required.");
        this.f28968e = (String[]) io.sentry.util.y.c(strArr2, "The root packages are required.");
        this.f28969f = (Runtime) io.sentry.util.y.c(runtime, "The Runtime is required.");
    }
}
