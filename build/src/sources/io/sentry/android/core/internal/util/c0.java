...
public final class c0 implements Application.ActivityLifecycleCallbacks {
    ...
    private static final long f28954y = TimeUnit.SECONDS.toNanos(1);

    /* renamed from: z  reason: collision with root package name */
    private static final long f28955z = TimeUnit.MILLISECONDS.toNanos(700);

    /* renamed from: d  reason: collision with root package name */
    private final x0 f28956d;

    /* renamed from: e  reason: collision with root package name */
    private final Set f28957e;

    /* renamed from: i  reason: collision with root package name */
    private final ILogger f28958i;

    /* renamed from: o  reason: collision with root package name */
    private Handler f28959o;

    /* renamed from: p  reason: collision with root package name */
    private WeakReference f28960p;

    /* renamed from: q  reason: collision with root package name */
    private final Map f28961q;

    /* renamed from: r  reason: collision with root package name */
    private boolean f28962r;

    /* renamed from: s  reason: collision with root package name */
    private final c f28963s;

    /* renamed from: t  reason: collision with root package name */
    private Window.OnFrameMetricsAvailableListener f28964t;

    /* renamed from: u  reason: collision with root package name */
    private Choreographer f28965u;

    /* renamed from: v  reason: collision with root package name */
    private Field f28966v;

    /* renamed from: w  reason: collision with root package name */
    private long f28967w;

    /* renamed from: x  reason: collision with root package name */
    private long f28968x;
    ...
    public static /* synthetic */ void a(c0 c0Var, ILogger iLogger) {
        c0Var.getClass();
        try {
            c0Var.f28965u = Choreographer.getInstance();
        } catch (Throwable th2) {
    ...
    public static /* synthetic */ void b(c0 c0Var, Window window) {
        if (c0Var.f28957e.add(window)) {
            try {
                c0Var.f28963s.a(window, c0Var.f28964t, c0Var.f28959o);
            } catch (Throwable th2) {
                c0Var.f28958i.b(SentryLevel.ERROR, "Failed to add frameMetricsAvailableListener", th2);
            }
        }
    }
    ...
    public static /* synthetic */ void c(c0 c0Var, Window window) {
        c0Var.getClass();
        try {
            if (c0Var.f28957e.remove(window)) {
                c0Var.f28963s.b(window, c0Var.f28964t);
            }
        } catch (Throwable th2) {
            c0Var.f28958i.b(SentryLevel.ERROR, "Failed to remove frameMetricsAvailableListener", th2);
        }
    }
    ...
    public static /* synthetic */ void e(c0 c0Var, x0 x0Var, Window window, FrameMetrics frameMetrics, int i10) {
        ...
        long max2 = Math.max(g10, c0Var.f28968x);
        if (max2 != c0Var.f28967w) {
            c0Var.f28967w = max2;
            c0Var.f28968x = max2 + f12;
            ...
            boolean z11 = z10;
            for (b bVar : c0Var.f28961q.values()) {
                bVar.e(max2, c0Var.f28968x, f12, max, j10, z11, f10);
            }
        }
    }
    ...
    private void k(Window window) {
        WeakReference weakReference = this.f28960p;
        if (weakReference != null && weakReference.get() == window) {
            return;
        }
        this.f28960p = new WeakReference(window);
        o();
    }
    ...
    private void o() {
        ...
        if (window != null && this.f28962r && !this.f28961q.isEmpty() && this.f28959o != null) {
    ...
    public long h() {
        Field field;
        Choreographer choreographer = this.f28965u;
        if (choreographer != null && (field = this.f28966v) != null) {
            try {
    ...
    public void m(String str) {
        ...
        if (this.f28962r) {
            ...
            if (window != null && this.f28961q.isEmpty()) {
                n(window);
            }
        }
    }
    ...
    public c0(Context context, final ILogger iLogger, final x0 x0Var, c cVar) {
        this.f28957e = new CopyOnWriteArraySet();
        this.f28961q = new ConcurrentHashMap();
        this.f28962r = false;
        this.f28967w = 0L;
        this.f28968x = 0L;
        Context context2 = (Context) io.sentry.util.y.c(e1.g(context), "The context is required");
        this.f28958i = (ILogger) io.sentry.util.y.c(iLogger, "Logger is required");
        this.f28956d = (x0) io.sentry.util.y.c(x0Var, "BuildInfoProvider is required");
        this.f28963s = (c) io.sentry.util.y.c(cVar, "WindowFrameMetricsManager is required");
        if ((context2 instanceof Application) && x0Var.d() >= 24) {
            ...
            handlerThread.start();
            this.f28959o = new Handler(handlerThread.getLooper());
            ...
            try {
                ...
                this.f28966v = declaredField;
                declaredField.setAccessible(true);
            } catch (NoSuchFieldException e10) {
                iLogger.b(SentryLevel.ERROR, "Unable to get the frame timestamp from the choreographer: ", e10);
            }
            this.f28964t = new Window.OnFrameMetricsAvailableListener() { // from class: io.sentry.android.core.internal.util.b0
