...
public final class c0 implements Application.ActivityLifecycleCallbacks {
    ...
    private static final long f28340y = TimeUnit.SECONDS.toNanos(1);

    /* renamed from: z  reason: collision with root package name */
    private static final long f28341z = TimeUnit.MILLISECONDS.toNanos(700);

    /* renamed from: d  reason: collision with root package name */
    private final x0 f28342d;

    /* renamed from: e  reason: collision with root package name */
    private final Set f28343e;

    /* renamed from: i  reason: collision with root package name */
    private final ILogger f28344i;

    /* renamed from: o  reason: collision with root package name */
    private Handler f28345o;

    /* renamed from: p  reason: collision with root package name */
    private WeakReference f28346p;

    /* renamed from: q  reason: collision with root package name */
    private final Map f28347q;

    /* renamed from: r  reason: collision with root package name */
    private boolean f28348r;

    /* renamed from: s  reason: collision with root package name */
    private final c f28349s;

    /* renamed from: t  reason: collision with root package name */
    private Window.OnFrameMetricsAvailableListener f28350t;

    /* renamed from: u  reason: collision with root package name */
    private Choreographer f28351u;

    /* renamed from: v  reason: collision with root package name */
    private Field f28352v;

    /* renamed from: w  reason: collision with root package name */
    private long f28353w;

    /* renamed from: x  reason: collision with root package name */
    private long f28354x;
    ...
    public static /* synthetic */ void a(c0 c0Var, ILogger iLogger) {
        c0Var.getClass();
        try {
            c0Var.f28351u = Choreographer.getInstance();
        } catch (Throwable th2) {
    ...
    public static /* synthetic */ void b(c0 c0Var, Window window) {
        if (c0Var.f28343e.add(window)) {
            try {
                c0Var.f28349s.a(window, c0Var.f28350t, c0Var.f28345o);
            } catch (Throwable th2) {
                c0Var.f28344i.b(SentryLevel.ERROR, "Failed to add frameMetricsAvailableListener", th2);
            }
        }
    }
    ...
    public static /* synthetic */ void c(c0 c0Var, Window window) {
        c0Var.getClass();
        try {
            if (c0Var.f28343e.remove(window)) {
                c0Var.f28349s.b(window, c0Var.f28350t);
            }
        } catch (Throwable th2) {
            c0Var.f28344i.b(SentryLevel.ERROR, "Failed to remove frameMetricsAvailableListener", th2);
        }
    }
    ...
    public static /* synthetic */ void e(c0 c0Var, x0 x0Var, Window window, FrameMetrics frameMetrics, int i10) {
        ...
        long max2 = Math.max(g10, c0Var.f28354x);
        if (max2 != c0Var.f28353w) {
            c0Var.f28353w = max2;
            c0Var.f28354x = max2 + f12;
            ...
            boolean z11 = z10;
            for (b bVar : c0Var.f28347q.values()) {
                bVar.e(max2, c0Var.f28354x, f12, max, j10, z11, f10);
            }
        }
    }
    ...
    private void k(Window window) {
        WeakReference weakReference = this.f28346p;
        if (weakReference != null && weakReference.get() == window) {
            return;
        }
        this.f28346p = new WeakReference(window);
        o();
    }
    ...
    private void o() {
        ...
        if (window != null && this.f28348r && !this.f28347q.isEmpty() && this.f28345o != null) {
    ...
    public long h() {
        Field field;
        Choreographer choreographer = this.f28351u;
        if (choreographer != null && (field = this.f28352v) != null) {
            try {
    ...
    public void m(String str) {
        ...
        if (this.f28348r) {
            ...
            if (window != null && this.f28347q.isEmpty()) {
                n(window);
            }
        }
    }
    ...
    public c0(Context context, final ILogger iLogger, final x0 x0Var, c cVar) {
        this.f28343e = new CopyOnWriteArraySet();
        this.f28347q = new ConcurrentHashMap();
        this.f28348r = false;
        this.f28353w = 0L;
        this.f28354x = 0L;
        Context context2 = (Context) io.sentry.util.y.c(e1.g(context), "The context is required");
        this.f28344i = (ILogger) io.sentry.util.y.c(iLogger, "Logger is required");
        this.f28342d = (x0) io.sentry.util.y.c(x0Var, "BuildInfoProvider is required");
        this.f28349s = (c) io.sentry.util.y.c(cVar, "WindowFrameMetricsManager is required");
        if ((context2 instanceof Application) && x0Var.d() >= 24) {
            ...
            handlerThread.start();
            this.f28345o = new Handler(handlerThread.getLooper());
            ...
            try {
                ...
                this.f28352v = declaredField;
                declaredField.setAccessible(true);
            } catch (NoSuchFieldException e10) {
                iLogger.b(SentryLevel.ERROR, "Unable to get the frame timestamp from the choreographer: ", e10);
            }
            this.f28350t = new Window.OnFrameMetricsAvailableListener() { // from class: io.sentry.android.core.internal.util.b0
