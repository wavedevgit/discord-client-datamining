...
public class r implements ViewTreeObserver.OnDrawListener {
    ...
    private final AtomicReference f27456e;

    /* renamed from: i  reason: collision with root package name */
    private final Runnable f27457i;
    ...
    private r(View view, Runnable runnable) {
        this.f27456e = new AtomicReference(view);
        this.f27457i = runnable;
    }
    ...
    public void onDraw() {
        final View view = (View) this.f27456e.getAndSet(null);
        if (view == null) {
            return;
        }
        ...
        this.f27455d.postAtFrontOfQueue(this.f27457i);
    }
}
