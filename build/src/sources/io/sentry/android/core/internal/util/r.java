...
public class r implements ViewTreeObserver.OnDrawListener {
    ...
    private final Handler f28959d = new Handler(Looper.getMainLooper());

    /* renamed from: e  reason: collision with root package name */
    private final AtomicReference f28960e;

    /* renamed from: i  reason: collision with root package name */
    private final Runnable f28961i;
    ...
    private r(View view, Runnable runnable) {
        this.f28960e = new AtomicReference(view);
        this.f28961i = runnable;
    }
    ...
    public void onDraw() {
        final View view = (View) this.f28960e.getAndSet(null);
        if (view == null) {
            return;
        }
        ...
        this.f28959d.postAtFrontOfQueue(this.f28961i);
    }
}
