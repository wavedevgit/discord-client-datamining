...
public class r implements ViewTreeObserver.OnDrawListener {
    ...
    private final Handler f28390d = new Handler(Looper.getMainLooper());

    /* renamed from: e  reason: collision with root package name */
    private final AtomicReference f28391e;

    /* renamed from: i  reason: collision with root package name */
    private final Runnable f28392i;
    ...
    private r(View view, Runnable runnable) {
        this.f28391e = new AtomicReference(view);
        this.f28392i = runnable;
    }
    ...
    public void onDraw() {
        final View view = (View) this.f28391e.getAndSet(null);
        if (view == null) {
            return;
        }
        ...
        this.f28390d.postAtFrontOfQueue(this.f28392i);
    }
}
