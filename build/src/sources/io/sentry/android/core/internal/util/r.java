...
public class r implements ViewTreeObserver.OnDrawListener {
    ...
    private final Handler f28391d = new Handler(Looper.getMainLooper());

    /* renamed from: e  reason: collision with root package name */
    private final AtomicReference f28392e;

    /* renamed from: i  reason: collision with root package name */
    private final Runnable f28393i;
    ...
    private r(View view, Runnable runnable) {
        this.f28392e = new AtomicReference(view);
        this.f28393i = runnable;
    }
    ...
    public void onDraw() {
        final View view = (View) this.f28392e.getAndSet(null);
        if (view == null) {
            return;
        }
        ...
        this.f28391d.postAtFrontOfQueue(this.f28393i);
    }
}
