...
public class c {
    ...
    private static final Pattern f28316f = Pattern.compile("\"(.*)\" (.*) ?prio=(\\d+)\\s+tid=(\\d+)\\s*(.*)");

    /* renamed from: g  reason: collision with root package name */
    private static final Pattern f28317g = Pattern.compile("\"(.*)\" (.*) ?sysTid=(\\d+)");

    /* renamed from: h  reason: collision with root package name */
    private static final Pattern f28318h = Pattern.compile(" *(?:native: )?#(\\d+) \\S+ ([0-9a-fA-F]+)\\s+((.*?)(?:\\s+\\(deleted\\))?(?:\\s+\\(offset (.*?)\\))?)(?:\\s+\\((?:\\?\\?\\?|(.*?)(?:\\+(\\d+))?)\\))?(?:\\s+\\(BuildId: (.*?)\\))?");

    /* renamed from: i  reason: collision with root package name */
    private static final Pattern f28319i = Pattern.compile(" *at (?:(.+)\\.)?([^.]+)\\.([^.]+)\\((.*):([\\d-]+)\\)");

    /* renamed from: j  reason: collision with root package name */
    private static final Pattern f28320j = Pattern.compile(" *at (?:(.+)\\.)?([^.]+)\\.([^.]+)\\(Native method\\)");

    /* renamed from: k  reason: collision with root package name */
    private static final Pattern f28321k = Pattern.compile(" *- locked \\<([0x0-9a-fA-F]{1,16})\\> \\(a (?:(.+)\\.)?([^.]+)\\)");

    /* renamed from: l  reason: collision with root package name */
    private static final Pattern f28322l = Pattern.compile(" *- sleeping on \\<([0x0-9a-fA-F]{1,16})\\> \\(a (?:(.+)\\.)?([^.]+)\\)");

    /* renamed from: m  reason: collision with root package name */
    private static final Pattern f28323m = Pattern.compile(" *- waiting on \\<([0x0-9a-fA-F]{1,16})\\> \\(a (?:(.+)\\.)?([^.]+)\\)");

    /* renamed from: n  reason: collision with root package name */
    private static final Pattern f28324n = Pattern.compile(" *- waiting to lock \\<([0x0-9a-fA-F]{1,16})\\> \\(a (?:(.+)\\.)?([^.]+)\\)");

    /* renamed from: o  reason: collision with root package name */
    private static final Pattern f28325o = Pattern.compile(" *- waiting to lock \\<([0x0-9a-fA-F]{1,16})\\> \\(a (?:(.+)\\.)?([^.]+)\\)(?: held by thread (\\d+))");

    /* renamed from: p  reason: collision with root package name */
    private static final Pattern f28326p = Pattern.compile(" *- waiting to lock an unknown object");

    /* renamed from: q  reason: collision with root package name */
    private static final Pattern f28327q = Pattern.compile("\\s+");

    /* renamed from: a  reason: collision with root package name */
    private final k7 f28328a;

    /* renamed from: b  reason: collision with root package name */
    private final boolean f28329b;

    /* renamed from: c  reason: collision with root package name */
    private final o7 f28330c;

    /* renamed from: d  reason: collision with root package name */
    private final Map f28331d = new HashMap();

    /* renamed from: e  reason: collision with root package name */
    private final List f28332e = new ArrayList();

    public c(k7 k7Var, boolean z10) {
        this.f28328a = k7Var;
        this.f28329b = z10;
        this.f28330c = new o7(k7Var);
    }
    ...
    private b0 j(b bVar, c0 c0Var) {
        ...
        Matcher matcher2 = f28318h.matcher("");
        Matcher matcher3 = f28319i.matcher("");
        Matcher matcher4 = f28320j.matcher("");
        Matcher matcher5 = f28321k.matcher("");
        Matcher matcher6 = f28323m.matcher("");
        Matcher matcher7 = f28322l.matcher("");
        Matcher matcher8 = f28325o.matcher("");
        Matcher matcher9 = f28324n.matcher("");
        Matcher matcher10 = f28326p.matcher("");
        Matcher matcher11 = f28327q.matcher("");
        ...
        while (true) {
            ...
            a b10 = bVar.b();
            if (b10 == null) {
                this.f28328a.getLogger().c(SentryLevel.WARNING, "Internal error while parsing thread dump.", new Object[0]);
                break;
            }
            String str = b10.f28311b;
            ...
            if (h(matcher3, str)) {
                ...
                sentryStackFrame.D(this.f28330c.b(format));
                ...
                if (a10 != null) {
                    if (!this.f28331d.containsKey(a10)) {
                        ...
                        this.f28331d.put(a10, debugImage);
                    } else {
                        matcher = matcher3;
                    }
                ...
                if (h(matcher4, str)) {
                    ...
                    sentryStackFrame.D(this.f28330c.b(format2));
    ...
    private c0 k(b bVar) {
        c0 c0Var = new c0();
        Matcher matcher = f28316f.matcher("");
        Matcher matcher2 = f28317g.matcher("");
        if (!bVar.a()) {
            return null;
        }
        a b10 = bVar.b();
        ...
        if (h(matcher, b10.f28311b)) {
            Long e10 = e(matcher, 4, null);
            if (e10 == null) {
                this.f28328a.getLogger().c(SentryLevel.DEBUG, "No thread id in the dump, skipping thread.", new Object[0]);
                return null;
            }
            c0Var.u(e10);
        ...
        } else if (h(matcher2, b10.f28311b)) {
    ...
    public List c() {
        return new ArrayList(this.f28331d.values());
    }
