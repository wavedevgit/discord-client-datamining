...
public class c {
    ...
    private static final Pattern f28315f = Pattern.compile("\"(.*)\" (.*) ?prio=(\\d+)\\s+tid=(\\d+)\\s*(.*)");

    /* renamed from: g  reason: collision with root package name */
    private static final Pattern f28316g = Pattern.compile("\"(.*)\" (.*) ?sysTid=(\\d+)");

    /* renamed from: h  reason: collision with root package name */
    private static final Pattern f28317h = Pattern.compile(" *(?:native: )?#(\\d+) \\S+ ([0-9a-fA-F]+)\\s+((.*?)(?:\\s+\\(deleted\\))?(?:\\s+\\(offset (.*?)\\))?)(?:\\s+\\((?:\\?\\?\\?|(.*?)(?:\\+(\\d+))?)\\))?(?:\\s+\\(BuildId: (.*?)\\))?");

    /* renamed from: i  reason: collision with root package name */
    private static final Pattern f28318i = Pattern.compile(" *at (?:(.+)\\.)?([^.]+)\\.([^.]+)\\((.*):([\\d-]+)\\)");

    /* renamed from: j  reason: collision with root package name */
    private static final Pattern f28319j = Pattern.compile(" *at (?:(.+)\\.)?([^.]+)\\.([^.]+)\\(Native method\\)");

    /* renamed from: k  reason: collision with root package name */
    private static final Pattern f28320k = Pattern.compile(" *- locked \\<([0x0-9a-fA-F]{1,16})\\> \\(a (?:(.+)\\.)?([^.]+)\\)");

    /* renamed from: l  reason: collision with root package name */
    private static final Pattern f28321l = Pattern.compile(" *- sleeping on \\<([0x0-9a-fA-F]{1,16})\\> \\(a (?:(.+)\\.)?([^.]+)\\)");

    /* renamed from: m  reason: collision with root package name */
    private static final Pattern f28322m = Pattern.compile(" *- waiting on \\<([0x0-9a-fA-F]{1,16})\\> \\(a (?:(.+)\\.)?([^.]+)\\)");

    /* renamed from: n  reason: collision with root package name */
    private static final Pattern f28323n = Pattern.compile(" *- waiting to lock \\<([0x0-9a-fA-F]{1,16})\\> \\(a (?:(.+)\\.)?([^.]+)\\)");

    /* renamed from: o  reason: collision with root package name */
    private static final Pattern f28324o = Pattern.compile(" *- waiting to lock \\<([0x0-9a-fA-F]{1,16})\\> \\(a (?:(.+)\\.)?([^.]+)\\)(?: held by thread (\\d+))");

    /* renamed from: p  reason: collision with root package name */
    private static final Pattern f28325p = Pattern.compile(" *- waiting to lock an unknown object");

    /* renamed from: q  reason: collision with root package name */
    private static final Pattern f28326q = Pattern.compile("\\s+");

    /* renamed from: a  reason: collision with root package name */
    private final k7 f28327a;

    /* renamed from: b  reason: collision with root package name */
    private final boolean f28328b;

    /* renamed from: c  reason: collision with root package name */
    private final o7 f28329c;

    /* renamed from: d  reason: collision with root package name */
    private final Map f28330d = new HashMap();

    /* renamed from: e  reason: collision with root package name */
    private final List f28331e = new ArrayList();

    public c(k7 k7Var, boolean z10) {
        this.f28327a = k7Var;
        this.f28328b = z10;
        this.f28329c = new o7(k7Var);
    }
    ...
    private b0 j(b bVar, c0 c0Var) {
        ...
        Matcher matcher2 = f28317h.matcher("");
        Matcher matcher3 = f28318i.matcher("");
        Matcher matcher4 = f28319j.matcher("");
        Matcher matcher5 = f28320k.matcher("");
        Matcher matcher6 = f28322m.matcher("");
        Matcher matcher7 = f28321l.matcher("");
        Matcher matcher8 = f28324o.matcher("");
        Matcher matcher9 = f28323n.matcher("");
        Matcher matcher10 = f28325p.matcher("");
        Matcher matcher11 = f28326q.matcher("");
        ...
        while (true) {
            ...
            a b10 = bVar.b();
            if (b10 == null) {
                this.f28327a.getLogger().c(SentryLevel.WARNING, "Internal error while parsing thread dump.", new Object[0]);
                break;
            }
            String str = b10.f28310b;
            ...
            if (h(matcher3, str)) {
                ...
                sentryStackFrame.D(this.f28329c.b(format));
                ...
                if (a10 != null) {
                    if (!this.f28330d.containsKey(a10)) {
                        ...
                        this.f28330d.put(a10, debugImage);
                    } else {
                        matcher = matcher3;
                    }
                ...
                if (h(matcher4, str)) {
                    ...
                    sentryStackFrame.D(this.f28329c.b(format2));
    ...
    private c0 k(b bVar) {
        c0 c0Var = new c0();
        Matcher matcher = f28315f.matcher("");
        Matcher matcher2 = f28316g.matcher("");
        if (!bVar.a()) {
            return null;
        }
        a b10 = bVar.b();
        ...
        if (h(matcher, b10.f28310b)) {
            Long e10 = e(matcher, 4, null);
            if (e10 == null) {
                this.f28327a.getLogger().c(SentryLevel.DEBUG, "No thread id in the dump, skipping thread.", new Object[0]);
                return null;
            }
            c0Var.u(e10);
        ...
        } else if (h(matcher2, b10.f28310b)) {
    ...
    public List c() {
        return new ArrayList(this.f28330d.values());
    }
