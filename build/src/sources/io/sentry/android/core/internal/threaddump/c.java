...
public class c {
    ...
    private static final Pattern f27380f = Pattern.compile("\"(.*)\" (.*) ?prio=(\\d+)\\s+tid=(\\d+)\\s*(.*)");

    /* renamed from: g  reason: collision with root package name */
    private static final Pattern f27381g = Pattern.compile("\"(.*)\" (.*) ?sysTid=(\\d+)");

    /* renamed from: h  reason: collision with root package name */
    private static final Pattern f27382h = Pattern.compile(" *(?:native: )?#(\\d+) \\S+ ([0-9a-fA-F]+)\\s+((.*?)(?:\\s+\\(deleted\\))?(?:\\s+\\(offset (.*?)\\))?)(?:\\s+\\((?:\\?\\?\\?|(.*?)(?:\\+(\\d+))?)\\))?(?:\\s+\\(BuildId: (.*?)\\))?");

    /* renamed from: i  reason: collision with root package name */
    private static final Pattern f27383i = Pattern.compile(" *at (?:(.+)\\.)?([^.]+)\\.([^.]+)\\((.*):([\\d-]+)\\)");

    /* renamed from: j  reason: collision with root package name */
    private static final Pattern f27384j = Pattern.compile(" *at (?:(.+)\\.)?([^.]+)\\.([^.]+)\\(Native method\\)");

    /* renamed from: k  reason: collision with root package name */
    private static final Pattern f27385k = Pattern.compile(" *- locked \\<([0x0-9a-fA-F]{1,16})\\> \\(a (?:(.+)\\.)?([^.]+)\\)");

    /* renamed from: l  reason: collision with root package name */
    private static final Pattern f27386l = Pattern.compile(" *- sleeping on \\<([0x0-9a-fA-F]{1,16})\\> \\(a (?:(.+)\\.)?([^.]+)\\)");

    /* renamed from: m  reason: collision with root package name */
    private static final Pattern f27387m = Pattern.compile(" *- waiting on \\<([0x0-9a-fA-F]{1,16})\\> \\(a (?:(.+)\\.)?([^.]+)\\)");

    /* renamed from: n  reason: collision with root package name */
    private static final Pattern f27388n = Pattern.compile(" *- waiting to lock \\<([0x0-9a-fA-F]{1,16})\\> \\(a (?:(.+)\\.)?([^.]+)\\)");

    /* renamed from: o  reason: collision with root package name */
    private static final Pattern f27389o = Pattern.compile(" *- waiting to lock \\<([0x0-9a-fA-F]{1,16})\\> \\(a (?:(.+)\\.)?([^.]+)\\)(?: held by thread (\\d+))");

    /* renamed from: p  reason: collision with root package name */
    private static final Pattern f27390p = Pattern.compile(" *- waiting to lock an unknown object");

    /* renamed from: q  reason: collision with root package name */
    private static final Pattern f27391q = Pattern.compile("\\s+");

    /* renamed from: a  reason: collision with root package name */
    private final k7 f27392a;

    /* renamed from: b  reason: collision with root package name */
    private final boolean f27393b;

    /* renamed from: c  reason: collision with root package name */
    private final o7 f27394c;

    /* renamed from: d  reason: collision with root package name */
    private final Map f27395d = new HashMap();

    /* renamed from: e  reason: collision with root package name */
    private final List f27396e = new ArrayList();

    public c(k7 k7Var, boolean z10) {
        this.f27392a = k7Var;
        this.f27393b = z10;
        this.f27394c = new o7(k7Var);
    }
    ...
    private b0 j(b bVar, c0 c0Var) {
        ...
        Matcher matcher2 = f27382h.matcher("");
        Matcher matcher3 = f27383i.matcher("");
        Matcher matcher4 = f27384j.matcher("");
        Matcher matcher5 = f27385k.matcher("");
        Matcher matcher6 = f27387m.matcher("");
        Matcher matcher7 = f27386l.matcher("");
        Matcher matcher8 = f27389o.matcher("");
        Matcher matcher9 = f27388n.matcher("");
        Matcher matcher10 = f27390p.matcher("");
        Matcher matcher11 = f27391q.matcher("");
        ...
        while (true) {
            ...
            a b10 = bVar.b();
            if (b10 == null) {
                this.f27392a.getLogger().c(SentryLevel.WARNING, "Internal error while parsing thread dump.", new Object[0]);
                break;
            }
            String str = b10.f27375b;
            ...
            if (h(matcher3, str)) {
                ...
                sentryStackFrame.D(this.f27394c.b(format));
                ...
                if (a10 != null) {
                    if (!this.f27395d.containsKey(a10)) {
                        ...
                        this.f27395d.put(a10, debugImage);
                    } else {
                        matcher = matcher3;
                    }
                ...
                if (h(matcher4, str)) {
                    ...
                    sentryStackFrame.D(this.f27394c.b(format2));
    ...
    private c0 k(b bVar) {
        c0 c0Var = new c0();
        Matcher matcher = f27380f.matcher("");
        Matcher matcher2 = f27381g.matcher("");
        if (!bVar.a()) {
            return null;
        }
        a b10 = bVar.b();
        ...
        if (h(matcher, b10.f27375b)) {
            Long e10 = e(matcher, 4, null);
            if (e10 == null) {
                this.f27392a.getLogger().c(SentryLevel.DEBUG, "No thread id in the dump, skipping thread.", new Object[0]);
                return null;
            }
            c0Var.u(e10);
        ...
        } else if (h(matcher2, b10.f27375b)) {
    ...
    public List c() {
        return new ArrayList(this.f27395d.values());
    }
