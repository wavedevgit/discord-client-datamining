...
public class c {
    ...
    private static final Pattern f28884f = Pattern.compile("\"(.*)\" (.*) ?prio=(\\d+)\\s+tid=(\\d+)\\s*(.*)");

    /* renamed from: g  reason: collision with root package name */
    private static final Pattern f28885g = Pattern.compile("\"(.*)\" (.*) ?sysTid=(\\d+)");

    /* renamed from: h  reason: collision with root package name */
    private static final Pattern f28886h = Pattern.compile(" *(?:native: )?#(\\d+) \\S+ ([0-9a-fA-F]+)\\s+((.*?)(?:\\s+\\(deleted\\))?(?:\\s+\\(offset (.*?)\\))?)(?:\\s+\\((?:\\?\\?\\?|(.*?)(?:\\+(\\d+))?)\\))?(?:\\s+\\(BuildId: (.*?)\\))?");

    /* renamed from: i  reason: collision with root package name */
    private static final Pattern f28887i = Pattern.compile(" *at (?:(.+)\\.)?([^.]+)\\.([^.]+)\\((.*):([\\d-]+)\\)");

    /* renamed from: j  reason: collision with root package name */
    private static final Pattern f28888j = Pattern.compile(" *at (?:(.+)\\.)?([^.]+)\\.([^.]+)\\(Native method\\)");

    /* renamed from: k  reason: collision with root package name */
    private static final Pattern f28889k = Pattern.compile(" *- locked \\<([0x0-9a-fA-F]{1,16})\\> \\(a (?:(.+)\\.)?([^.]+)\\)");

    /* renamed from: l  reason: collision with root package name */
    private static final Pattern f28890l = Pattern.compile(" *- sleeping on \\<([0x0-9a-fA-F]{1,16})\\> \\(a (?:(.+)\\.)?([^.]+)\\)");

    /* renamed from: m  reason: collision with root package name */
    private static final Pattern f28891m = Pattern.compile(" *- waiting on \\<([0x0-9a-fA-F]{1,16})\\> \\(a (?:(.+)\\.)?([^.]+)\\)");

    /* renamed from: n  reason: collision with root package name */
    private static final Pattern f28892n = Pattern.compile(" *- waiting to lock \\<([0x0-9a-fA-F]{1,16})\\> \\(a (?:(.+)\\.)?([^.]+)\\)");

    /* renamed from: o  reason: collision with root package name */
    private static final Pattern f28893o = Pattern.compile(" *- waiting to lock \\<([0x0-9a-fA-F]{1,16})\\> \\(a (?:(.+)\\.)?([^.]+)\\)(?: held by thread (\\d+))");

    /* renamed from: p  reason: collision with root package name */
    private static final Pattern f28894p = Pattern.compile(" *- waiting to lock an unknown object");

    /* renamed from: q  reason: collision with root package name */
    private static final Pattern f28895q = Pattern.compile("\\s+");

    /* renamed from: a  reason: collision with root package name */
    private final k7 f28896a;

    /* renamed from: b  reason: collision with root package name */
    private final boolean f28897b;

    /* renamed from: c  reason: collision with root package name */
    private final o7 f28898c;

    /* renamed from: d  reason: collision with root package name */
    private final Map f28899d = new HashMap();

    /* renamed from: e  reason: collision with root package name */
    private final List f28900e = new ArrayList();

    public c(k7 k7Var, boolean z10) {
        this.f28896a = k7Var;
        this.f28897b = z10;
        this.f28898c = new o7(k7Var);
    }
    ...
    private b0 j(b bVar, c0 c0Var) {
        ...
        Matcher matcher2 = f28886h.matcher("");
        Matcher matcher3 = f28887i.matcher("");
        Matcher matcher4 = f28888j.matcher("");
        Matcher matcher5 = f28889k.matcher("");
        Matcher matcher6 = f28891m.matcher("");
        Matcher matcher7 = f28890l.matcher("");
        Matcher matcher8 = f28893o.matcher("");
        Matcher matcher9 = f28892n.matcher("");
        Matcher matcher10 = f28894p.matcher("");
        Matcher matcher11 = f28895q.matcher("");
        ...
        while (true) {
            ...
            a b10 = bVar.b();
            if (b10 == null) {
                this.f28896a.getLogger().c(SentryLevel.WARNING, "Internal error while parsing thread dump.", new Object[0]);
                break;
            }
            String str = b10.f28879b;
            ...
            if (h(matcher3, str)) {
                ...
                sentryStackFrame.D(this.f28898c.b(format));
                ...
                if (a10 != null) {
                    if (!this.f28899d.containsKey(a10)) {
                        ...
                        this.f28899d.put(a10, debugImage);
                    } else {
                        matcher = matcher3;
                    }
                ...
                if (h(matcher4, str)) {
                    ...
                    sentryStackFrame.D(this.f28898c.b(format2));
    ...
    private c0 k(b bVar) {
        c0 c0Var = new c0();
        Matcher matcher = f28884f.matcher("");
        Matcher matcher2 = f28885g.matcher("");
        if (!bVar.a()) {
            return null;
        }
        a b10 = bVar.b();
        ...
        if (h(matcher, b10.f28879b)) {
            Long e10 = e(matcher, 4, null);
            if (e10 == null) {
                this.f28896a.getLogger().c(SentryLevel.DEBUG, "No thread id in the dump, skipping thread.", new Object[0]);
                return null;
            }
            c0Var.u(e10);
        ...
        } else if (h(matcher2, b10.f28879b)) {
    ...
    public List c() {
        return new ArrayList(this.f28899d.values());
    }
