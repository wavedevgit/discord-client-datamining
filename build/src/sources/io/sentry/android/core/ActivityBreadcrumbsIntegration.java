...
public final class ActivityBreadcrumbsIntegration implements io.sentry.k1, Closeable, Application.ActivityLifecycleCallbacks {
    ...
    private final Application f27130d;

    /* renamed from: e  reason: collision with root package name */
    private io.sentry.w0 f27131e;

    /* renamed from: i  reason: collision with root package name */
    private boolean f27132i;

    /* renamed from: o  reason: collision with root package name */
    private final io.sentry.util.a f27133o = new io.sentry.util.a();

    public ActivityBreadcrumbsIntegration(Application application) {
        this.f27130d = (Application) io.sentry.util.y.c(application, "Application is required");
    }
    ...
    private void a(Activity activity, String str) {
        ...
        this.f27131e.h(breadcrumb, hint);
    }
    ...
    public void close() {
        if (this.f27132i) {
            this.f27130d.unregisterActivityLifecycleCallbacks(this);
            io.sentry.w0 w0Var = this.f27131e;
            if (w0Var != null) {
    ...
    public void g(io.sentry.w0 w0Var, k7 k7Var) {
        ...
        this.f27131e = (io.sentry.w0) io.sentry.util.y.c(w0Var, "Scopes are required");
        this.f27132i = ((SentryAndroidOptions) io.sentry.util.y.c(sentryAndroidOptions, "SentryAndroidOptions is required")).isEnableActivityLifecycleBreadcrumbs();
        ILogger logger = k7Var.getLogger();
        SentryLevel sentryLevel = SentryLevel.DEBUG;
        logger.c(sentryLevel, "ActivityBreadcrumbsIntegration enabled: %s", Boolean.valueOf(this.f27132i));
        if (this.f27132i) {
            this.f27130d.registerActivityLifecycleCallbacks(this);
    ...
    public void onActivityCreated(Activity activity, Bundle bundle) {
        io.sentry.a1 a10 = this.f27133o.a();
        try {
            a(activity, "created");
            if (a10 != null) {
                a10.close();
