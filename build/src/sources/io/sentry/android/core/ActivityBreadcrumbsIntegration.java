...
public final class ActivityBreadcrumbsIntegration implements io.sentry.k1, Closeable, Application.ActivityLifecycleCallbacks {
    ...
    private final Application f28737d;

    /* renamed from: e  reason: collision with root package name */
    private io.sentry.w0 f28738e;

    /* renamed from: i  reason: collision with root package name */
    private boolean f28739i;

    /* renamed from: o  reason: collision with root package name */
    private final io.sentry.util.a f28740o = new io.sentry.util.a();

    public ActivityBreadcrumbsIntegration(Application application) {
        this.f28737d = (Application) io.sentry.util.y.c(application, "Application is required");
    }
    ...
    private void a(Activity activity, String str) {
        ...
        this.f28738e.g(breadcrumb, hint);
    }
    ...
    public void close() {
        if (this.f28739i) {
            this.f28737d.unregisterActivityLifecycleCallbacks(this);
            io.sentry.w0 w0Var = this.f28738e;
            if (w0Var != null) {
    ...
    public void h(io.sentry.w0 w0Var, k7 k7Var) {
        ...
        this.f28738e = (io.sentry.w0) io.sentry.util.y.c(w0Var, "Scopes are required");
        this.f28739i = ((SentryAndroidOptions) io.sentry.util.y.c(sentryAndroidOptions, "SentryAndroidOptions is required")).isEnableActivityLifecycleBreadcrumbs();
        ILogger logger = k7Var.getLogger();
        SentryLevel sentryLevel = SentryLevel.DEBUG;
        logger.c(sentryLevel, "ActivityBreadcrumbsIntegration enabled: %s", Boolean.valueOf(this.f28739i));
        if (this.f28739i) {
            this.f28737d.registerActivityLifecycleCallbacks(this);
    ...
    public void onActivityCreated(Activity activity, Bundle bundle) {
        io.sentry.a1 a10 = this.f28740o.a();
        try {
            a(activity, "created");
            if (a10 != null) {
                a10.close();
