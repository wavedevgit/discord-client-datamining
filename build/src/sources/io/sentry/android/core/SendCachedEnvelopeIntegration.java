...
public final class SendCachedEnvelopeIntegration implements io.sentry.k1, k0.b, Closeable {
    ...
    private final r4 f28812d;

    /* renamed from: e  reason: collision with root package name */
    private final io.sentry.util.r f28813e;

    /* renamed from: o  reason: collision with root package name */
    private io.sentry.k0 f28815o;

    /* renamed from: p  reason: collision with root package name */
    private io.sentry.w0 f28816p;

    /* renamed from: q  reason: collision with root package name */
    private SentryAndroidOptions f28817q;

    /* renamed from: r  reason: collision with root package name */
    private o4 f28818r;

    /* renamed from: i  reason: collision with root package name */
    private final AtomicBoolean f28814i = new AtomicBoolean(false);

    /* renamed from: s  reason: collision with root package name */
    private final AtomicBoolean f28819s = new AtomicBoolean(false);

    /* renamed from: t  reason: collision with root package name */
    private final AtomicBoolean f28820t = new AtomicBoolean(false);

    /* renamed from: u  reason: collision with root package name */
    private final io.sentry.util.a f28821u = new io.sentry.util.a();

    public SendCachedEnvelopeIntegration(r4 r4Var, io.sentry.util.r rVar) {
        this.f28812d = (r4) io.sentry.util.y.c(r4Var, "SendFireAndForgetFactory is required");
        this.f28813e = rVar;
    }
    ...
    public static /* synthetic */ void l(SendCachedEnvelopeIntegration sendCachedEnvelopeIntegration, SentryAndroidOptions sentryAndroidOptions, io.sentry.w0 w0Var) {
        ...
        try {
            if (sendCachedEnvelopeIntegration.f28820t.get()) {
            ...
            if (!sendCachedEnvelopeIntegration.f28819s.getAndSet(true)) {
                io.sentry.k0 connectionStatusProvider = sentryAndroidOptions.getConnectionStatusProvider();
                sendCachedEnvelopeIntegration.f28815o = connectionStatusProvider;
                connectionStatusProvider.M1(sendCachedEnvelopeIntegration);
                sendCachedEnvelopeIntegration.f28818r = sendCachedEnvelopeIntegration.f28812d.c(w0Var, sentryAndroidOptions);
            }
            io.sentry.k0 k0Var = sendCachedEnvelopeIntegration.f28815o;
            ...
            o4 o4Var = sendCachedEnvelopeIntegration.f28818r;
            if (o4Var == null) {
    ...
    private void n(final io.sentry.w0 w0Var, final SentryAndroidOptions sentryAndroidOptions) {
        try {
            io.sentry.a1 a10 = this.f28821u.a();
            ...
            if (((Boolean) this.f28813e.a()).booleanValue() && this.f28814i.compareAndSet(false, true)) {
    ...
    public void a(k0.a aVar) {
        ...
        io.sentry.w0 w0Var = this.f28816p;
        if (w0Var != null && (sentryAndroidOptions = this.f28817q) != null && aVar != k0.a.DISCONNECTED) {
    ...
    public void close() {
        this.f28820t.set(true);
        io.sentry.k0 k0Var = this.f28815o;
        if (k0Var != null) {
            k0Var.Z1(this);
        }
    }
    ...
    public void h(io.sentry.w0 w0Var, k7 k7Var) {
        SentryAndroidOptions sentryAndroidOptions;
        this.f28816p = (io.sentry.w0) io.sentry.util.y.c(w0Var, "Scopes are required");
        if (k7Var instanceof SentryAndroidOptions) {
            sentryAndroidOptions = (SentryAndroidOptions) k7Var;
        } else {
            sentryAndroidOptions = null;
        }
        this.f28817q = (SentryAndroidOptions) io.sentry.util.y.c(sentryAndroidOptions, "SentryAndroidOptions is required");
        if (!this.f28812d.d(k7Var.getCacheDirPath(), k7Var.getLogger())) {
