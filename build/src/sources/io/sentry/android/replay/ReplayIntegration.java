...
public final class ReplayIntegration implements k1, Closeable, r, io.sentry.android.replay.gestures.c, u3, k0.b, a0.b, t {
    ...
    private final Context f29279d;

    /* renamed from: e  reason: collision with root package name */
    private final io.sentry.transport.p f29280e;

    /* renamed from: i  reason: collision with root package name */
    private final Function0 f29281i;

    /* renamed from: o  reason: collision with root package name */
    private final Function1 f29282o;

    /* renamed from: p  reason: collision with root package name */
    private volatile k0.a f29283p;
    ...
    private io.sentry.android.replay.g f29287t;

    /* renamed from: u  reason: collision with root package name */
    private io.sentry.android.replay.gestures.a f29288u;

    /* renamed from: v  reason: collision with root package name */
    private final Lazy f29289v;

    /* renamed from: w  reason: collision with root package name */
    private final Lazy f29290w;

    /* renamed from: x  reason: collision with root package name */
    private final Lazy f29291x;

    /* renamed from: y  reason: collision with root package name */
    private final AtomicBoolean f29292y;

    /* renamed from: z  reason: collision with root package name */
    private final AtomicBoolean f29293z;
    ...
    static final class e extends Lambda implements Function2 {
        ...
        /* renamed from: d  reason: collision with root package name */
        final /* synthetic */ Bitmap f29296d;

        /* renamed from: e  reason: collision with root package name */
        final /* synthetic */ Ref.ObjectRef f29297e;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        e(Bitmap bitmap, Ref.ObjectRef objectRef) {
            super(2);
            this.f29296d = bitmap;
            this.f29297e = objectRef;
        }

        public final void a(i onScreenshotRecorded, long j10) {
            Intrinsics.checkNotNullParameter(onScreenshotRecorded, "$this$onScreenshotRecorded");
            onScreenshotRecorded.B(this.f29296d, j10, (String) this.f29297e.element);
        }
    ...
    static final class f extends Lambda implements Function0 {
        ...
        /* renamed from: d  reason: collision with root package name */
        public static final f f29298d = new f();
    ...
    static final class g extends Lambda implements Function0 {
        ...
        public final io.sentry.android.replay.util.i invoke() {
            ...
            k7 k7Var = ReplayIntegration.this.f29285r;
            if (k7Var == null) {
    ...
    static final class h extends Lambda implements Function0 {
        ...
        /* renamed from: d  reason: collision with root package name */
        public static final h f29300d = new h();
    ...
    public ReplayIntegration(Context context, io.sentry.transport.p dateProvider, Function0 function0, Function1 function1) {
        ...
        this.f29280e = dateProvider;
        this.f29281i = function0;
        this.f29282o = function1;
        this.f29283p = k0.a.UNKNOWN;
        this.f29289v = lr.l.a(f.f29298d);
        this.f29290w = lr.l.a(h.f29300d);
        this.f29291x = lr.l.a(new g());
        this.f29292y = new AtomicBoolean(false);
        this.f29293z = new AtomicBoolean(false);
        k2 b10 = k2.b();
    ...
    private final void A1() {
        ...
        try {
            if (this.f29292y.get()) {
                ...
                n nVar = n.RESUMED;
                if (mVar.b(nVar)) {
                    if (!this.f29293z.get() && this.f29283p != k0.a.DISCONNECTED && (((w0Var = this.f29286s) == null || (j11 = w0Var.j()) == null || !j11.L(io.sentry.j.All)) && ((w0Var2 = this.f29286s) == null || (j10 = w0Var2.j()) == null || !j10.L(io.sentry.j.Replay)))) {
                        this.G.d(nVar);
                        io.sentry.android.replay.capture.h hVar = this.A;
                        if (hVar != null) {
                            hVar.i();
                        }
                        io.sentry.android.replay.g gVar = this.f29287t;
                        if (gVar != null) {
                            gVar.i();
    ...
    private final void B1() {
        if (this.f29287t instanceof io.sentry.android.replay.e) {
    ...
    private final void D0() {
        ...
        if (this.A instanceof io.sentry.android.replay.capture.m) {
            if (this.f29283p != k0.a.DISCONNECTED && (((w0Var = this.f29286s) == null || (j11 = w0Var.j()) == null || !j11.L(io.sentry.j.All)) && ((w0Var2 = this.f29286s) == null || (j10 = w0Var2.j()) == null || !j10.L(io.sentry.j.Replay)))) {
                return;
            }
            x1();
        }
    ...
    public static final void J0(ReplayIntegration replayIntegration) {
        List list;
        k7 k7Var;
        k7 k7Var2 = replayIntegration.f29285r;
        if (k7Var2 == null) {
            Intrinsics.throwUninitializedPropertyAccessException("options");
            k7Var2 = null;
        }
        ...
        if (findPersistingScopeObserver != null) {
            k7 k7Var3 = replayIntegration.f29285r;
            if (k7Var3 == null) {
                Intrinsics.throwUninitializedPropertyAccessException("options");
                k7Var3 = null;
            }
            ...
            if (str != null) {
                ...
                if (Intrinsics.areEqual(xVar, io.sentry.protocol.x.f30413e)) {
                    F0(replayIntegration, null, 1, null);
                    return;
                }
                i.a aVar = i.f29474w;
                k7 k7Var4 = replayIntegration.f29285r;
                if (k7Var4 == null) {
                    Intrinsics.throwUninitializedPropertyAccessException("options");
                    k7Var4 = null;
                }
                io.sentry.android.replay.d c10 = aVar.c(k7Var4, xVar, replayIntegration.f29282o);
                if (c10 == null) {
                    F0(replayIntegration, null, 1, null);
                    return;
                }
                k7 k7Var5 = replayIntegration.f29285r;
                if (k7Var5 == null) {
                    Intrinsics.throwUninitializedPropertyAccessException("options");
                    k7Var5 = null;
                }
                ...
                h.a aVar2 = io.sentry.android.replay.capture.h.f29424a;
                w0 w0Var = replayIntegration.f29286s;
                k7 k7Var6 = replayIntegration.f29285r;
                if (k7Var6 == null) {
                    Intrinsics.throwUninitializedPropertyAccessException("options");
                    k7Var = null;
                } else {
                ...
                if (c11 instanceof h.c.a) {
                    ...
                    w0 w0Var2 = replayIntegration.f29286s;
    ...
    private final b0 M0() {
        return (b0) this.f29289v.getValue();
    }

    private final io.sentry.android.replay.util.i R0() {
        return (io.sentry.android.replay.util.i) this.f29291x.getValue();
    }
    ...
    public io.sentry.protocol.x V0() {
        ...
        io.sentry.protocol.x EMPTY_ID = io.sentry.protocol.x.f30413e;
        Intrinsics.checkNotNullExpressionValue(EMPTY_ID, "EMPTY_ID");
        return EMPTY_ID;
    }

    public final p Y0() {
        return (p) this.f29290w.getValue();
    }
    ...
    public void h(w0 scopes, k7 options) {
        ...
        if (Build.VERSION.SDK_INT < 26) {
            ...
            this.f29286s = scopes;
            Function0 function0 = this.f29281i;
            ...
            replayIntegration.f29287t = vVar;
            ...
            replayIntegration.f29288u = aVar;
            replayIntegration.f29292y.set(true);
    ...
    public final void m(s config) {
        ...
        if (this.f29292y.get() && Z0()) {
            ...
            io.sentry.android.replay.g gVar2 = this.f29287t;
            if (gVar2 != null) {
                gVar2.m(config);
            }
            if (this.G.a() == n.PAUSED && (gVar = this.f29287t) != null) {
                gVar.b();
            }
        }
    }
    ...
    public void onTouchEvent(MotionEvent event) {
        ...
        if (this.f29292y.get() && this.G.c() && (hVar = this.A) != null) {
    ...
    public void start() {
        ...
        try {
            ...
            if (!a11) {
                k7 k7Var5 = this.f29285r;
                if (k7Var5 == null) {
                    Intrinsics.throwUninitializedPropertyAccessException("options");
                    k7Var5 = null;
                }
                if (!k7Var5.getSessionReplay().x()) {
                    k7 k7Var6 = this.f29285r;
                    if (k7Var6 == null) {
                        Intrinsics.throwUninitializedPropertyAccessException("options");
                        k7Var6 = null;
                    }
            ...
            if (function1 == null || (fVar = (io.sentry.android.replay.capture.h) function1.invoke(Boolean.valueOf(a11))) == null) {
                if (a11) {
                    ...
                    fVar = new io.sentry.android.replay.capture.m(k7Var2, this.f29286s, this.f29280e, R0(), this.f29282o);
                } else {
                    k7 k7Var8 = this.f29285r;
                    if (k7Var8 == null) {
                        Intrinsics.throwUninitializedPropertyAccessException("options");
                        k7Var = null;
                    } else {
                    ...
                    fVar = new io.sentry.android.replay.capture.f(k7Var, this.f29286s, this.f29280e, M0(), R0(), this.f29282o);
                }
            }
            this.A = fVar;
            io.sentry.android.replay.g gVar = this.f29287t;
        ...
        try {
            if (this.f29292y.get()) {
                ...
                if (mVar.b(nVar)) {
                    ...
                    io.sentry.android.replay.gestures.a aVar = this.f29288u;
                    if (aVar != null) {
                        aVar.b();
                    }
                    io.sentry.android.replay.capture.h hVar = this.A;
