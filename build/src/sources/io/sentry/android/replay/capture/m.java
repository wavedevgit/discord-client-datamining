...
public final class m extends io.sentry.android.replay.capture.a {
    ...
    public static final a f28827y = new a(null);

    /* renamed from: z  reason: collision with root package name */
    public static final int f28828z = 8;

    /* renamed from: v  reason: collision with root package name */
    private final k7 f28829v;

    /* renamed from: w  reason: collision with root package name */
    private final w0 f28830w;

    /* renamed from: x  reason: collision with root package name */
    private final p f28831x;
    ...
    static final class b extends Lambda implements Function1 {
        ...
        public final void a(h.c segment) {
            ...
            if (segment instanceof h.c.a) {
                ...
                h.c.a.b(aVar, m.this.f28830w, null, 2, null);
                m mVar = m.this;
                mVar.c(mVar.d() + 1);
                m.this.i(aVar.c().i0());
            }
    ...
    static final class c extends Lambda implements Function1 {
        ...
        public final void a(h.c segment) {
            Intrinsics.checkNotNullParameter(segment, "segment");
            if (segment instanceof h.c.a) {
                h.c.a.b((h.c.a) segment, m.this.f28830w, null, 2, null);
                m mVar = m.this;
                mVar.c(mVar.d() + 1);
            }
        }
    ...
    static final class d extends Lambda implements Function1 {
        ...
        public final void a(h.c segment) {
            ...
            m.this.c(-1);
            io.sentry.util.i.a(this.f28835e);
        }
    ...
    public static final void K(m mVar, Function2 function2, long j10, s sVar) {
        ...
        Date x10 = mVar.x();
        if (x10 == null) {
            mVar.f28829v.getLogger().c(SentryLevel.DEBUG, "Segment timestamp is not set, not recording frame", new Object[0]);
        } else if (mVar.y().get()) {
            mVar.f28829v.getLogger().c(SentryLevel.DEBUG, "Not capturing segment, because the app is terminating, will be captured on next launch", new Object[0]);
        } else if (sVar == null) {
            mVar.f28829v.getLogger().c(SentryLevel.DEBUG, "Recorder config is not set, not capturing a segment", new Object[0]);
        } else {
            long a10 = mVar.f28831x.a();
            if (a10 - x10.getTime() >= mVar.f28829v.getSessionReplay().r()) {
                h.c n10 = io.sentry.android.replay.capture.a.n(mVar, mVar.f28829v.getSessionReplay().r(), x10, mVar.a(), mVar.d(), sVar.c(), sVar.d(), sVar.b(), sVar.a(), null, null, null, null, null, 7936, null);
                if (n10 instanceof h.c.a) {
                    h.c.a aVar = (h.c.a) n10;
                    h.c.a.b(aVar, mVar.f28830w, null, 2, null);
                    mVar.c(mVar.d() + 1);
                    mVar.i(aVar.c().i0());
                }
            }
            if (a10 - mVar.u().get() >= mVar.f28829v.getSessionReplay().p()) {
                mVar.f28829v.getReplayController().stop();
                mVar.f28829v.getLogger().c(SentryLevel.INFO, "Session replay deadline exceeded (1h), stopping recording", new Object[0]);
            }
        }
    }
    ...
    public void e(boolean z10, Function1 onSegmentSent) {
        ...
        if (this.f28829v.getSessionReplay().u()) {
            this.f28829v.getLogger().c(SentryLevel.DEBUG, "Replay is already running in 'session' mode, not capturing for event", new Object[0]);
        }
        y().set(z10);
    }
    ...
    public m(k7 options, w0 w0Var, p dateProvider, ScheduledExecutorService executor, Function1 function1) {
        ...
        this.f28829v = options;
        this.f28830w = w0Var;
        this.f28831x = dateProvider;
    }
}
