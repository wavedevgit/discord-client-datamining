...
public final class f extends io.sentry.android.replay.capture.a {
    ...
    private final k7 f29365v;

    /* renamed from: w  reason: collision with root package name */
    private final w0 f29366w;

    /* renamed from: x  reason: collision with root package name */
    private final p f29367x;

    /* renamed from: y  reason: collision with root package name */
    private final b0 f29368y;

    /* renamed from: z  reason: collision with root package name */
    private final List f29369z;
    ...
    static final class b extends Lambda implements Function1 {
        ...
        final /* synthetic */ Function1 f29371e;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        b(Function1 function1) {
            super(1);
            this.f29371e = function1;
        }
        ...
        public final void a(h.c segment) {
            ...
            if (segment instanceof h.c.a) {
                ...
                h.c.a.b(aVar, f.this.f29366w, null, 2, null);
                Function1 function1 = this.f29371e;
                Date i02 = aVar.c().i0();
    ...
    public static final class e extends Lambda implements Function1 {
        ...
        final /* synthetic */ long f29374d;

        /* renamed from: e  reason: collision with root package name */
        final /* synthetic */ f f29375e;

        /* renamed from: i  reason: collision with root package name */
        final /* synthetic */ Ref.BooleanRef f29376i;
        ...
        public final Boolean invoke(h.c.a it) {
            ...
            if (it.c().i0().getTime() < this.f29374d) {
                f fVar = this.f29375e;
                fVar.c(fVar.d() - 1);
                this.f29375e.P(it.c().j0());
                this.f29376i.element = true;
                return Boolean.TRUE;
            }
    ...
    public f(k7 options, w0 w0Var, p dateProvider, b0 random, ScheduledExecutorService executor, Function1 function1) {
        ...
        this.f29365v = options;
        this.f29366w = w0Var;
        this.f29367x = dateProvider;
        this.f29368y = random;
        this.f29369z = new ArrayList();
    }
    ...
    public final void L(List list) {
        ...
        while (aVar != null) {
            h.c.a.b(aVar, this.f29366w, null, 2, null);
    ...
    public final void P(File file) {
        if (file != null) {
            try {
                if (!file.delete()) {
                    this.f29365v.getLogger().c(SentryLevel.ERROR, "Failed to delete replay segment: %s", file.getAbsolutePath());
                }
            } catch (Throwable th2) {
                this.f29365v.getLogger().a(SentryLevel.ERROR, th2, "Failed to delete replay segment: %s", file.getAbsolutePath());
            }
        }
    }
    ...
    public static final void Q(f fVar, Function2 function2, long j10) {
        ...
        long a10 = fVar.f29367x.a() - fVar.f29365v.getSessionReplay().c();
    ...
    public void e(boolean z10, Function1 onSegmentSent) {
        ...
        if (!io.sentry.android.replay.util.k.a(this.f29368y, this.f29365v.getSessionReplay().l())) {
            this.f29365v.getLogger().c(SentryLevel.INFO, "Replay wasn't sampled by onErrorSampleRate, not capturing for event", new Object[0]);
            return;
        }
        w0 w0Var = this.f29366w;
        if (w0Var != null) {
        ...
        if (z10) {
            y().set(true);
            this.f29365v.getLogger().c(SentryLevel.DEBUG, "Not capturing replay for crashed event, will be captured on next launch", new Object[0]);
            return;
        }
    ...
    public h g() {
        if (y().get()) {
            this.f29365v.getLogger().c(SentryLevel.DEBUG, "Not converting to session mode, because the process is about to terminate", new Object[0]);
            return this;
        }
        m mVar = new m(this.f29365v, this.f29366w, this.f29367x, t(), null, 16, null);
        mVar.A(s());
    ...
    public void onTouchEvent(MotionEvent event) {
        ...
        h.a.h(h.f29378a, q(), this.f29367x.a() - this.f29365v.getSessionReplay().c(), null, 4, null);
    }
