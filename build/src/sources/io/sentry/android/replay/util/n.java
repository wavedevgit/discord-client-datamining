...
public abstract class n {
    ...
    public static final void k(View view, io.sentry.android.replay.viewhierarchy.b parentNode, k7 options) {
        ...
        if ((view instanceof ViewGroup) && !io.sentry.android.replay.viewhierarchy.a.f27907a.a(view, parentNode, options)) {
            ...
            for (int i10 = 0; i10 < childCount; i10++) {
                ...
                if (childAt != null) {
                    io.sentry.android.replay.viewhierarchy.b a10 = io.sentry.android.replay.viewhierarchy.b.f27911m.a(childAt, parentNode, viewGroup.indexOfChild(childAt), options);
                    arrayList.add(a10);
