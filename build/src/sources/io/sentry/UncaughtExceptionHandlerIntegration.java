...
public final class UncaughtExceptionHandlerIntegration implements k1, Thread.UncaughtExceptionHandler, Closeable {
    ...
    private static final io.sentry.util.a f26863q = new io.sentry.util.a();

    /* renamed from: d  reason: collision with root package name */
    private Thread.UncaughtExceptionHandler f26864d;
    ...
    private final w8 f26868p;

    /* loaded from: /home/runner/work/discord-client-datamining/discord-client-datamining/build/classes4.dex */
    public static class a extends io.sentry.hints.d implements io.sentry.hints.l, io.sentry.hints.q {

        /* renamed from: d  reason: collision with root package name */
        private final AtomicReference f26869d;

        public a(long j10, ILogger iLogger) {
            super(j10, iLogger);
            this.f26869d = new AtomicReference();
        }

        @Override // io.sentry.hints.f
        public boolean b(io.sentry.protocol.x xVar) {
            io.sentry.protocol.x xVar2 = (io.sentry.protocol.x) this.f26869d.get();
    ...
    private void m(Thread.UncaughtExceptionHandler uncaughtExceptionHandler, Set set) {
        if (uncaughtExceptionHandler == null) {
            ...
            Thread.UncaughtExceptionHandler uncaughtExceptionHandler2 = uncaughtExceptionHandlerIntegration.f26864d;
            if (this == uncaughtExceptionHandler2) {
                uncaughtExceptionHandlerIntegration.f26864d = this.f26864d;
                k7 k7Var3 = this.f26866i;
                if (k7Var3 != null) {
    ...
    public void close() {
        a1 a10 = f26863q.a();
        try {
            if (this == this.f26868p.b()) {
                this.f26868p.a(this.f26864d);
                k7 k7Var = this.f26866i;
                if (k7Var != null) {
    ...
    public final void g(w0 w0Var, k7 k7Var) {
        ...
        this.f26867o = true;
        this.f26865e = (w0) io.sentry.util.y.c(w0Var, "Scopes are required");
        k7 k7Var2 = (k7) io.sentry.util.y.c(k7Var, "SentryOptions is required");
        this.f26866i = k7Var2;
        ILogger logger = k7Var2.getLogger();
        SentryLevel sentryLevel = SentryLevel.DEBUG;
        logger.c(sentryLevel, "UncaughtExceptionHandlerIntegration enabled: %s", Boolean.valueOf(this.f26866i.isEnableUncaughtExceptionHandler()));
        if (this.f26866i.isEnableUncaughtExceptionHandler()) {
            a1 a10 = f26863q.a();
            try {
                Thread.UncaughtExceptionHandler b10 = this.f26868p.b();
                if (b10 != null) {
                    ILogger logger2 = this.f26866i.getLogger();
                    ...
                    if (b10 instanceof UncaughtExceptionHandlerIntegration) {
                        ...
                        if (uncaughtExceptionHandlerIntegration.f26865e != null && w0Var.t() == uncaughtExceptionHandlerIntegration.f26865e.t()) {
                            this.f26864d = uncaughtExceptionHandlerIntegration.f26864d;
                        } else {
                            this.f26864d = b10;
                        }
                    } else {
                ...
                this.f26866i.getLogger().c(sentryLevel, "UncaughtExceptionHandlerIntegration installed.", new Object[0]);
    ...
    public void uncaughtException(Thread thread, Throwable th2) {
        k7 k7Var = this.f26866i;
        if (k7Var != null && this.f26865e != null) {
            k7Var.getLogger().c(SentryLevel.INFO, "Uncaught exception received.", new Object[0]);
            try {
                a aVar = new a(this.f26866i.getFlushTimeoutMillis(), this.f26866i.getLogger());
                SentryEvent sentryEvent = new SentryEvent(a(thread, th2));
                sentryEvent.E0(SentryLevel.FATAL);
                if (this.f26865e.l() == null && sentryEvent.G() != null) {
                    aVar.c(sentryEvent.G());
                }
                Hint e10 = io.sentry.util.n.e(aVar);
                boolean equals = this.f26865e.x(sentryEvent, e10).equals(io.sentry.protocol.x.f28615e);
                io.sentry.hints.h f10 = io.sentry.util.n.f(e10);
                if ((!equals || io.sentry.hints.h.MULTITHREADED_DEDUPLICATION.equals(f10)) && !aVar.g()) {
                    this.f26866i.getLogger().c(SentryLevel.WARNING, "Timed out waiting to flush event to disk before crashing. Event: %s", sentryEvent.G());
                }
            } catch (Throwable th3) {
                this.f26866i.getLogger().b(SentryLevel.ERROR, "Error sending uncaught exception to Sentry.", th3);
            }
            if (this.f26864d != null) {
                this.f26866i.getLogger().c(SentryLevel.INFO, "Invoking inner uncaught exception handler.", new Object[0]);
                this.f26864d.uncaughtException(thread, th2);
            } else if (this.f26866i.isPrintUncaughtStackTrace()) {
                th2.printStackTrace();
            }
        }
    }
    ...
    UncaughtExceptionHandlerIntegration(w8 w8Var) {
        this.f26867o = false;
        this.f26868p = (w8) io.sentry.util.y.c(w8Var, "threadAdapter is required.");
    }
}
