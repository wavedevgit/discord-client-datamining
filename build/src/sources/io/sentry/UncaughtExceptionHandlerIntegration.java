...
public final class UncaughtExceptionHandlerIntegration implements k1, Thread.UncaughtExceptionHandler, Closeable {
    ...
    private static final io.sentry.util.a f28047q = new io.sentry.util.a();

    /* renamed from: d  reason: collision with root package name */
    private Thread.UncaughtExceptionHandler f28048d;
    ...
    private final w8 f28052p;

    /* loaded from: /home/runner/work/discord-client-datamining/discord-client-datamining/build/classes4.dex */
    public static class a extends io.sentry.hints.d implements io.sentry.hints.l, io.sentry.hints.q {

        /* renamed from: d  reason: collision with root package name */
        private final AtomicReference f28053d;

        public a(long j10, ILogger iLogger) {
            super(j10, iLogger);
            this.f28053d = new AtomicReference();
        }

        @Override // io.sentry.hints.f
        public boolean b(io.sentry.protocol.x xVar) {
            io.sentry.protocol.x xVar2 = (io.sentry.protocol.x) this.f28053d.get();
    ...
    private void m(Thread.UncaughtExceptionHandler uncaughtExceptionHandler, Set set) {
        if (uncaughtExceptionHandler == null) {
            ...
            Thread.UncaughtExceptionHandler uncaughtExceptionHandler2 = uncaughtExceptionHandlerIntegration.f28048d;
            if (this == uncaughtExceptionHandler2) {
                uncaughtExceptionHandlerIntegration.f28048d = this.f28048d;
                k7 k7Var3 = this.f28050i;
                if (k7Var3 != null) {
    ...
    public void close() {
        a1 a10 = f28047q.a();
        try {
            if (this == this.f28052p.b()) {
                this.f28052p.a(this.f28048d);
                k7 k7Var = this.f28050i;
                if (k7Var != null) {
    ...
    public final void h(w0 w0Var, k7 k7Var) {
        ...
        this.f28051o = true;
        this.f28049e = (w0) io.sentry.util.y.c(w0Var, "Scopes are required");
        k7 k7Var2 = (k7) io.sentry.util.y.c(k7Var, "SentryOptions is required");
        this.f28050i = k7Var2;
        ILogger logger = k7Var2.getLogger();
        SentryLevel sentryLevel = SentryLevel.DEBUG;
        logger.c(sentryLevel, "UncaughtExceptionHandlerIntegration enabled: %s", Boolean.valueOf(this.f28050i.isEnableUncaughtExceptionHandler()));
        if (this.f28050i.isEnableUncaughtExceptionHandler()) {
            a1 a10 = f28047q.a();
            try {
                Thread.UncaughtExceptionHandler b10 = this.f28052p.b();
                if (b10 != null) {
                    ILogger logger2 = this.f28050i.getLogger();
                    ...
                    if (b10 instanceof UncaughtExceptionHandlerIntegration) {
                        ...
                        if (uncaughtExceptionHandlerIntegration.f28049e != null && w0Var.u() == uncaughtExceptionHandlerIntegration.f28049e.u()) {
                            this.f28048d = uncaughtExceptionHandlerIntegration.f28048d;
                        } else {
                            this.f28048d = b10;
                        }
                    } else {
                ...
                this.f28050i.getLogger().c(sentryLevel, "UncaughtExceptionHandlerIntegration installed.", new Object[0]);
    ...
    public void uncaughtException(Thread thread, Throwable th2) {
        k7 k7Var = this.f28050i;
        if (k7Var != null && this.f28049e != null) {
            k7Var.getLogger().c(SentryLevel.INFO, "Uncaught exception received.", new Object[0]);
            try {
                a aVar = new a(this.f28050i.getFlushTimeoutMillis(), this.f28050i.getLogger());
                SentryEvent sentryEvent = new SentryEvent(a(thread, th2));
                sentryEvent.E0(SentryLevel.FATAL);
                if (this.f28049e.l() == null && sentryEvent.G() != null) {
                    aVar.c(sentryEvent.G());
                }
                Hint e10 = io.sentry.util.n.e(aVar);
                boolean equals = this.f28049e.y(sentryEvent, e10).equals(io.sentry.protocol.x.f29799e);
                io.sentry.hints.h f10 = io.sentry.util.n.f(e10);
                if ((!equals || io.sentry.hints.h.MULTITHREADED_DEDUPLICATION.equals(f10)) && !aVar.g()) {
                    this.f28050i.getLogger().c(SentryLevel.WARNING, "Timed out waiting to flush event to disk before crashing. Event: %s", sentryEvent.G());
                }
            } catch (Throwable th3) {
                this.f28050i.getLogger().b(SentryLevel.ERROR, "Error sending uncaught exception to Sentry.", th3);
            }
            if (this.f28048d != null) {
                this.f28050i.getLogger().c(SentryLevel.INFO, "Invoking inner uncaught exception handler.", new Object[0]);
                this.f28048d.uncaughtException(thread, th2);
            } else if (this.f28050i.isPrintUncaughtStackTrace()) {
                th2.printStackTrace();
            }
        }
    }
    ...
    UncaughtExceptionHandlerIntegration(w8 w8Var) {
        this.f28051o = false;
        this.f28052p = (w8) io.sentry.util.y.c(w8Var, "threadAdapter is required.");
    }
}
