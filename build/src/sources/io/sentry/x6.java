...
public final class x6 implements w1 {
    ...
    private io.sentry.protocol.x f30941d;

    /* renamed from: e  reason: collision with root package name */
    private Double f30942e;
    ...
    public void serialize(f3 f3Var, ILogger iLogger) {
        f3Var.r();
        f3Var.e("timestamp").j(iLogger, k.c(this.f30942e));
        f3Var.e("trace_id").j(iLogger, this.f30941d);
        f3Var.e("body").f(this.f30943i);
        f3Var.e("level").j(iLogger, this.f30944o);
        if (this.f30945p != null) {
            f3Var.e("severity_number").j(iLogger, this.f30945p);
        }
        if (this.f30946q != null) {
            f3Var.e("attributes").j(iLogger, this.f30946q);
        }
        Map map = this.f30947r;
        if (map != null) {
            for (String str : map.keySet()) {
                f3Var.e(str).j(iLogger, this.f30947r.get(str));
            }
        }
        f3Var.y();
    }
