...
public abstract class d {
    ...
    private static final Charset f29795a = Charset.forName("UTF-8");
    ...
    public static Object c(k7 k7Var, String str, String str2, Class cls, m1 m1Var) {
        ...
        if (file.exists()) {
            try {
                BufferedReader bufferedReader = new BufferedReader(new InputStreamReader(new FileInputStream(file), f29795a));
                if (m1Var == null) {
    ...
    public static void d(k7 k7Var, Object obj, String str, String str2) {
        ...
        try {
            ...
            BufferedWriter bufferedWriter = new BufferedWriter(new OutputStreamWriter(fileOutputStream, f29795a));
            try {
