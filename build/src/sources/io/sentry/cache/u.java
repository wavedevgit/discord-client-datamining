...
public final class u extends c4 {
    ...
    private static final Charset f29749c = Charset.forName("UTF-8");

    /* renamed from: a  reason: collision with root package name */
    private k7 f29750a;

    /* renamed from: b  reason: collision with root package name */
    private final io.sentry.util.r f29751b = new io.sentry.util.r(new r.a() { // from class: io.sentry.cache.l
    ...
    public class a implements c.a {
        ...
        public Breadcrumb b(byte[] bArr) {
            try {
                BufferedReader bufferedReader = new BufferedReader(new InputStreamReader(new ByteArrayInputStream(bArr), u.f29749c));
                Breadcrumb breadcrumb = (Breadcrumb) u.this.f29750a.getSerializer().c(bufferedReader, Breadcrumb.class);
                bufferedReader.close();
                return breadcrumb;
            } catch (Throwable th2) {
                u.this.f29750a.getLogger().a(SentryLevel.ERROR, th2, "Error reading entity from scope cache", new Object[0]);
                return null;
            }
        }
        ...
        public void a(Breadcrumb breadcrumb, OutputStream outputStream) {
            BufferedWriter bufferedWriter = new BufferedWriter(new OutputStreamWriter(outputStream, u.f29749c));
            try {
                u.this.f29750a.getSerializer().a(breadcrumb, bufferedWriter);
    ...
    private void C(String str) {
        d.a(this.f29750a, ".scope-cache", str);
    }

    private void F(final Runnable runnable) {
        if (!this.f29750a.isEnableScopePersistence()) {
            return;
        }
        if (Thread.currentThread().getName().contains("SentryExecutor")) {
            try {
                ...
                this.f29750a.getLogger().b(SentryLevel.ERROR, "Serialization task failed", th2);
                return;
            }
        }
        try {
            this.f29750a.getExecutorService().submit(new Runnable() { // from class: io.sentry.cache.s
            ...
            this.f29750a.getLogger().b(SentryLevel.ERROR, "Serialization task could not be scheduled", th3);
        }
    }
    ...
    public static /* synthetic */ void u(u uVar) {
        uVar.getClass();
        try {
            ((io.sentry.cache.tape.c) uVar.f29751b.a()).clear();
        } catch (IOException e10) {
            uVar.f29750a.getLogger().b(SentryLevel.ERROR, "Failed to clear breadcrumbs from file queue", e10);
        }
    }
    ...
    public static /* synthetic */ io.sentry.cache.tape.c w(u uVar) {
        ...
        File b10 = d.b(uVar.f29750a, ".scope-cache");
        if (b10 == null) {
            uVar.f29750a.getLogger().c(SentryLevel.INFO, "Cache dir is not set, cannot store in scope cache", new Object[0]);
            return io.sentry.cache.tape.c.C();
        }
        File file = new File(b10, "breadcrumbs.json");
        try {
            try {
                a10 = new d.a(file).b(uVar.f29750a.getMaxBreadcrumbs()).a();
            } catch (IOException e10) {
                uVar.f29750a.getLogger().b(SentryLevel.ERROR, "Failed to create breadcrumbs queue", e10);
                return io.sentry.cache.tape.c.C();
            }
    ...
    public static /* synthetic */ void x(u uVar, Runnable runnable) {
        ...
        try {
            ...
            uVar.f29750a.getLogger().b(SentryLevel.ERROR, "Serialization task failed", th2);
        }
    }
    ...
    public static /* synthetic */ void z(u uVar, Breadcrumb breadcrumb) {
        uVar.getClass();
        try {
            ((io.sentry.cache.tape.c) uVar.f29751b.a()).i(breadcrumb);
        } catch (IOException e10) {
            uVar.f29750a.getLogger().b(SentryLevel.ERROR, "Failed to add breadcrumb to file queue", e10);
        }
    }
    ...
    public Object D(k7 k7Var, String str, Class cls) {
        if (str.equals("breadcrumbs.json")) {
            try {
                return cls.cast(((io.sentry.cache.tape.c) this.f29751b.a()).p());
            } catch (IOException unused) {
    ...
    public void E() {
        try {
            ((io.sentry.cache.tape.c) this.f29751b.a()).clear();
        } catch (IOException e10) {
            this.f29750a.getLogger().b(SentryLevel.ERROR, "Failed to clear breadcrumbs from file queue", e10);
        }
        C("user.json");
        C("level.json");
        C("request.json");
