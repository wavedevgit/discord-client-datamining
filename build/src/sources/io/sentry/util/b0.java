...
public final class b0 implements Serializable {
    ...
    static final AtomicLong f30126i = new AtomicLong(System.nanoTime());
    ...
    public void b(byte[] bArr) {
        for (int i10 = 0; i10 < bArr.length; i10++) {
            long j10 = (this.f30127d * 6364136223846793005L) + this.f30128e;
            this.f30127d = j10;
    ...
    public double c() {
        ...
        long j11 = (this.f30127d * 6364136223846793005L) + j10;
