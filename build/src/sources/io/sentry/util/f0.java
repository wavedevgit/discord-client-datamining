...
public abstract class f0 {
    ...
    private static final Charset f28997a = Charset.forName("UTF-8");

    /* renamed from: b  reason: collision with root package name */
    private static final Pattern f28998b = Pattern.compile("[\\W_]+");

    public static String a(String str, ILogger iLogger) {
        if (str != null && !str.isEmpty()) {
            try {
                return new StringBuilder(new BigInteger(1, MessageDigest.getInstance("SHA-1").digest(str.getBytes(f28997a))).toString(16)).toString();
    ...
    public static String b(String str) {
        if (str != null && !str.isEmpty()) {
            String[] split = f28998b.split(str, -1);
