...
public abstract class q {
    ...
    private static final Charset f30710a = Charset.forName("UTF-8");

    /* loaded from: /home/runner/work/discord-client-datamining/discord-client-datamining/build/classes4.dex */
    private static final class b extends Writer {

        /* renamed from: d  reason: collision with root package name */
        private long f30711d;
        ...
        public void write(char[] cArr, int i10, int i11) {
            for (int i12 = i10; i12 < i10 + i11; i12++) {
                this.f30711d += h(cArr[i12]);
            }
        }

        @Override // java.io.Writer
        public void write(int i10) {
            this.f30711d += h((char) i10);
        }

        @Override // java.io.Writer
        public void write(String str, int i10, int i11) {
            for (int i12 = i10; i12 < i10 + i11; i12++) {
                this.f30711d += h(str.charAt(i12));
            }
        }
    }
    ...
    public static byte[] c(b1 b1Var, ILogger iLogger, w1 w1Var) {
        try {
            ...
            BufferedWriter bufferedWriter = new BufferedWriter(new OutputStreamWriter(byteArrayOutputStream, f30710a));
