...
public final class a implements b {
    ...
    private volatile CopyOnWriteArrayList f29887a;

    /* renamed from: b  reason: collision with root package name */
    private final io.sentry.util.a f29888b;

    /* renamed from: c  reason: collision with root package name */
    private int f29889c;

    private a(int i10) {
        this.f29888b = new io.sentry.util.a();
        this.f29889c = i10;
        this.f29887a = new CopyOnWriteArrayList();
    }
    ...
    private static b b(int i10, a aVar, a aVar2, a aVar3) {
        ...
        if (aVar == null) {
            ...
            copyOnWriteArrayList = aVar.f29887a;
        }
        if (aVar2 == null) {
            copyOnWriteArrayList2 = null;
        } else {
            copyOnWriteArrayList2 = aVar2.f29887a;
        }
        if (aVar3 != null) {
            copyOnWriteArrayList3 = aVar3.f29887a;
        }
        int i11 = 0;
    ...
    private a(int i10, CopyOnWriteArrayList copyOnWriteArrayList) {
        this.f29888b = new io.sentry.util.a();
        this.f29889c = i10;
        this.f29887a = copyOnWriteArrayList;
    }

    private a(a aVar) {
        this.f29888b = new io.sentry.util.a();
        this.f29889c = aVar.f29889c;
        this.f29887a = new CopyOnWriteArrayList(aVar.f29887a);
    }
}
