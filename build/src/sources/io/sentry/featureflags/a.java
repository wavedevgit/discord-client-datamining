...
public final class a implements b {
    ...
    private volatile CopyOnWriteArrayList f29990a;

    /* renamed from: b  reason: collision with root package name */
    private final io.sentry.util.a f29991b;

    /* renamed from: c  reason: collision with root package name */
    private int f29992c;

    private a(int i10) {
        this.f29991b = new io.sentry.util.a();
        this.f29992c = i10;
        this.f29990a = new CopyOnWriteArrayList();
    }
    ...
    private static b b(int i10, a aVar, a aVar2, a aVar3) {
        ...
        if (aVar == null) {
            ...
            copyOnWriteArrayList = aVar.f29990a;
        }
        if (aVar2 == null) {
            copyOnWriteArrayList2 = null;
        } else {
            copyOnWriteArrayList2 = aVar2.f29990a;
        }
        if (aVar3 != null) {
            copyOnWriteArrayList3 = aVar3.f29990a;
        }
        int i11 = 0;
    ...
    public g n() {
        ...
        Iterator it = this.f29990a.iterator();
        if (!it.hasNext()) {
    ...
    private a(int i10, CopyOnWriteArrayList copyOnWriteArrayList) {
        this.f29991b = new io.sentry.util.a();
        this.f29992c = i10;
        this.f29990a = copyOnWriteArrayList;
    }

    private a(a aVar) {
        this.f29991b = new io.sentry.util.a();
        this.f29992c = aVar.f29992c;
        this.f29990a = new CopyOnWriteArrayList(aVar.f29990a);
    }
}
