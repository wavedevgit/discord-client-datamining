...
public final class x1 implements b1 {
    ...
    private static final Charset f29078c = Charset.forName("UTF-8");

    /* renamed from: a  reason: collision with root package name */
    private final k7 f29079a;

    /* renamed from: b  reason: collision with root package name */
    private final Map f29080b;

    public x1(k7 k7Var) {
        this.f29079a = k7Var;
        HashMap hashMap = new HashMap();
        this.f29080b = hashMap;
    ...
    private String h(Object obj, boolean z10) {
        ...
        u1 u1Var = new u1(stringWriter, this.f29079a.getMaxDepth());
        if (z10) {
            u1Var.h("\t");
        }
        u1Var.j(this.f29079a.getLogger(), obj);
    ...
    public void a(Object obj, Writer writer) {
        ...
        ILogger logger = this.f29079a.getLogger();
        SentryLevel sentryLevel = SentryLevel.DEBUG;
        if (logger.d(sentryLevel)) {
            this.f29079a.getLogger().c(sentryLevel, "Serializing object: %s", h(obj, this.f29079a.isEnablePrettySerializationOutput()));
        }
        new u1(writer, this.f29079a.getMaxDepth()).j(this.f29079a.getLogger(), obj);
        writer.flush();
    }
    ...
    public void b(l5 l5Var, OutputStream outputStream) {
        ...
        BufferedWriter bufferedWriter = new BufferedWriter(new OutputStreamWriter(new BufferedOutputStream(outputStream), f29078c));
        try {
            l5Var.b().serialize(new u1(bufferedWriter, this.f29079a.getMaxDepth()), this.f29079a.getLogger());
            bufferedWriter.write(ReactEditTextInputConnectionWrapper.NEWLINE_RAW_VALUE);
            for (l6 l6Var : l5Var.c()) {
                try {
                    byte[] I = l6Var.I();
                    l6Var.K().serialize(new u1(bufferedWriter, this.f29079a.getMaxDepth()), this.f29079a.getLogger());
                    bufferedWriter.write(ReactEditTextInputConnectionWrapper.NEWLINE_RAW_VALUE);
                    bufferedWriter.flush();
                    outputStream.write(I);
                    bufferedWriter.write(ReactEditTextInputConnectionWrapper.NEWLINE_RAW_VALUE);
                } catch (Exception e10) {
                    this.f29079a.getLogger().b(SentryLevel.ERROR, "Failed to create envelope item. Dropping it.", e10);
                }
            }
        } finally {
            bufferedWriter.flush();
    ...
    public Object c(Reader reader, Class cls) {
        ...
        try {
            ...
            m1 m1Var = (m1) this.f29080b.get(cls);
            if (m1Var != null) {
                U1 = cls.cast(m1Var.a(s1Var, this.f29079a.getLogger()));
            } else if (g(cls)) {
                U1 = s1Var.U1();
            } else {
                s1Var.close();
            ...
            this.f29079a.getLogger().b(SentryLevel.ERROR, "Error when deserializing", e10);
            return null;
        }
    }
    ...
    public l5 d(InputStream inputStream) {
        ...
        try {
            return this.f29079a.getEnvelopeReader().a(inputStream);
        } catch (IOException e10) {
            this.f29079a.getLogger().b(SentryLevel.ERROR, "Error deserializing envelope.", e10);
            return null;
        }
    }
        ...
        try {
            ...
            if (Collection.class.isAssignableFrom(cls)) {
                if (m1Var == null) {
                    ...
                    U1 = s1Var.g2(this.f29079a.getLogger(), m1Var);
                }
            } else {
                U1 = s1Var.U1();
            }
            ...
            this.f29079a.getLogger().b(SentryLevel.ERROR, "Error when deserializing", th2);
            return null;
        }
    }
