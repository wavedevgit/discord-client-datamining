...
public final class w implements n0 {
    ...
    private static final Charset f30222b = Charset.forName("UTF-8");

    /* renamed from: a  reason: collision with root package name */
    private final b1 f30223a;
    ...
    private m5 b(byte[] bArr, int i10, int i11) {
        StringReader stringReader = new StringReader(new String(bArr, i10, i11, f30222b));
        try {
            m5 m5Var = (m5) this.f30223a.c(stringReader, m5.class);
            stringReader.close();
            return m5Var;
        } catch (Throwable th2) {
            try {
    ...
    private m6 c(byte[] bArr, int i10, int i11) {
        StringReader stringReader = new StringReader(new String(bArr, i10, i11, f30222b));
        try {
            m6 m6Var = (m6) this.f30223a.c(stringReader, m6.class);
            stringReader.close();
            return m6Var;
        } catch (Throwable th2) {
            try {
