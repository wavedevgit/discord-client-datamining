...
public final class l5 {
    ...
    private final m5 f28526a;

    /* renamed from: b  reason: collision with root package name */
    private final Iterable f28527b;

    public l5(m5 m5Var, Iterable iterable) {
        this.f28526a = (m5) io.sentry.util.y.c(m5Var, "SentryEnvelopeHeader is required.");
        this.f28527b = (Iterable) io.sentry.util.y.c(iterable, "SentryEnvelope items are required.");
    }
    ...
    public l5(io.sentry.protocol.x xVar, io.sentry.protocol.r rVar, l6 l6Var) {
        ...
        this.f28526a = new m5(xVar, rVar);
        ArrayList arrayList = new ArrayList(1);
        arrayList.add(l6Var);
        this.f28527b = arrayList;
    }
}
