...
public final class l5 {
    ...
    private final m5 f30133a;

    /* renamed from: b  reason: collision with root package name */
    private final Iterable f30134b;

    public l5(m5 m5Var, Iterable iterable) {
        this.f30133a = (m5) io.sentry.util.y.c(m5Var, "SentryEnvelopeHeader is required.");
        this.f30134b = (Iterable) io.sentry.util.y.c(iterable, "SentryEnvelope items are required.");
    }
