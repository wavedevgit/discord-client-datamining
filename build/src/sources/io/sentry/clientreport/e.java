...
public final class e implements h {
    ...
    private final i f29190a = new b();

    /* renamed from: b  reason: collision with root package name */
    private final k7 f29191b;
    ...
    private void g(f fVar, io.sentry.j jVar, Long l10) {
        this.f29191b.getOnDiscard();
    }

    private void h(String str, String str2, Long l10) {
        this.f29190a.a(new d(str, str2), l10);
    }
    ...
    public void b(f fVar, l5 l5Var) {
        if (l5Var != null) {
            try {
                ...
                this.f29191b.getLogger().a(SentryLevel.ERROR, th2, "Unable to record lost envelope.", new Object[0]);
            }
        }
    }
    ...
    public void c(f fVar, io.sentry.j jVar, long j10) {
        try {
            ...
            this.f29191b.getLogger().a(SentryLevel.ERROR, th2, "Unable to record lost event.", new Object[0]);
        }
    }
        ...
        if (l6Var != null) {
            try {
                ...
                if (v6.ClientReport.equals(b10)) {
                    try {
                        j(l6Var.H(this.f29191b.getSerializer()));
                        return;
                    } catch (Exception unused) {
                        this.f29191b.getLogger().c(SentryLevel.ERROR, "Unable to restore counts from previous client report.", new Object[0]);
                        return;
                    }
                }
                io.sentry.j f10 = f(b10);
                if (f10.equals(io.sentry.j.Transaction)) {
                    d0 M = l6Var.M(this.f29191b.getSerializer());
                    if (M != null) {
                        List q02 = M.q0();
                    ...
                    z6 L = l6Var.L(this.f29191b.getSerializer());
                    if (L != null) {
                        long size = L.a().size();
                    ...
                    this.f29191b.getLogger().c(SentryLevel.ERROR, "Unable to parse lost logs envelope item.", new Object[0]);
                } else {
                    h(fVar.getReason(), f10.getCategory(), 1L);
                    g(fVar, f10, 1L);
                }
            } catch (Throwable th2) {
                this.f29191b.getLogger().a(SentryLevel.ERROR, th2, "Unable to record lost envelope item.", new Object[0]);
            }
        }
    }
    ...
    public l5 e(l5 l5Var) {
        ...
        try {
            this.f29191b.getLogger().c(SentryLevel.DEBUG, "Attaching client report to envelope.", new Object[0]);
            ArrayList arrayList = new ArrayList();
            for (l6 l6Var : l5Var.c()) {
                arrayList.add(l6Var);
            }
            arrayList.add(l6.A(this.f29191b.getSerializer(), i10));
            return new l5(l5Var.b(), arrayList);
        } catch (Throwable th2) {
            this.f29191b.getLogger().a(SentryLevel.ERROR, th2, "Unable to attach client report to envelope.", new Object[0]);
            return l5Var;
        }
    }
