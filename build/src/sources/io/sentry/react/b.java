...
public abstract class b {
    ...
    private static final ILogger f30464a = new z("RNSentry.MapConverter");
        ...
        if (obj instanceof List) {
            ...
            for (Map.Entry entry : ((Map) obj).entrySet()) {
                ...
                if (key instanceof String) {
                    ...
                    f30464a.c(SentryLevel.ERROR, "Only String keys are supported in Map.", key);
                }
            }
            return createMap;
        } else if (obj instanceof Byte) {
