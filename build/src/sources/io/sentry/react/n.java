...
public class n {
    ...
    private static final ILogger f30484o;

    /* renamed from: p  reason: collision with root package name */
    private static final x0 f30485p;

    /* renamed from: q  reason: collision with root package name */
    private static final Charset f30486q;

    /* renamed from: r  reason: collision with root package name */
    static long f30487r;

    /* renamed from: a  reason: collision with root package name */
    private final ReactApplicationContext f30488a;

    /* renamed from: b  reason: collision with root package name */
    private final PackageInfo f30489b;

    /* renamed from: d  reason: collision with root package name */
    private boolean f30491d;

    /* renamed from: c  reason: collision with root package name */
    private FrameMetricsAggregator f30490c = null;

    /* renamed from: e  reason: collision with root package name */
    private int f30492e = 101;

    /* renamed from: f  reason: collision with root package name */
    private i0 f30493f = null;

    /* renamed from: g  reason: collision with root package name */
    private boolean f30494g = false;

    /* renamed from: h  reason: collision with root package name */
    private String f30495h = null;

    /* renamed from: i  reason: collision with root package name */
    private String f30496i = null;

    /* renamed from: j  reason: collision with root package name */
    private z0 f30497j = null;

    /* renamed from: l  reason: collision with root package name */
    private long f30499l = 5242880;

    /* renamed from: k  reason: collision with root package name */
    private final Runnable f30498k = w();

    /* renamed from: m  reason: collision with root package name */
    private final k5 f30500m = new l2();

    /* renamed from: n  reason: collision with root package name */
    private final io.sentry.util.u f30501n = new io.sentry.util.u();

    static {
        z zVar = new z(NativeRNSentrySpec.NAME);
        f30484o = zVar;
        f30485p = new x0(zVar);
        f30486q = Charset.forName("UTF-8");
        f30487r = -1L;
    }

    public n(ReactApplicationContext reactApplicationContext) {
        this.f30489b = R(reactApplicationContext);
        this.f30488a = reactApplicationContext;
    }

    private Activity N() {
        return this.f30488a.getCurrentActivity();
    }
    ...
    private static PackageInfo R(Context context) {
        try {
            ...
            f30484o.c(SentryLevel.WARNING, "Error getting package info.", new Object[0]);
            return null;
        }
    }
    ...
    private String S() {
        if (this.f30496i == null) {
            this.f30496i = new File(U().getCacheDir(), "sentry/react").getAbsolutePath();
        }
        File file = new File(this.f30496i, "profiling_trace");
        file.mkdirs();
    ...
    private String T() {
        ...
        this.f30494g = true;
        List<Properties> a10 = new io.sentry.android.core.internal.debugmeta.a(U(), f30484o).a();
        if (a10 == null) {
            return null;
        }
        for (Properties properties : a10) {
            ...
            this.f30495h = m10;
            if (m10 != null) {
                ILogger iLogger = f30484o;
                SentryLevel sentryLevel = SentryLevel.INFO;
                iLogger.c(sentryLevel, "Proguard uuid found: " + this.f30495h, new Object[0]);
                return this.f30495h;
            }
        }
        f30484o.c(SentryLevel.WARNING, "No proguard uuid found in debug meta properties file!", new Object[0]);
        return null;
    }
    ...
    private void Y() {
        ...
        s sVar = new s(f30485p, this.f30498k, f30484o);
    ...
    private void Z() {
        FragmentManager supportFragmentManager;
        io.sentry.react.replay.a aVar = new io.sentry.react.replay.a(f30484o);
        Activity N = N();
    ...
    private void c0() {
        ...
        String S = S();
        int micros = ((int) TimeUnit.SECONDS.toMicros(1L)) / this.f30492e;
        ReactApplicationContext reactApplicationContext = this.f30488a;
        ILogger iLogger = f30484o;
        this.f30493f = new i0(S, micros, new c0(reactApplicationContext, iLogger, f30485p), this.f30497j, iLogger);
    }
    ...
    private boolean d0() {
        if (this.f30491d && this.f30490c != null) {
            return true;
        }
        return false;
    }
    ...
    public /* synthetic */ void f0() {
        w.f(Double.valueOf(this.f30500m.now().h() / 1.0E9d));
    }
    ...
    public static /* synthetic */ void h(byte[][] bArr, Activity activity, CountDownLatch countDownLatch) {
        bArr[0] = io.sentry.android.core.internal.util.w.f(activity, f30484o, f30485p);
        countDownLatch.countDown();
    }

    /* JADX INFO: Access modifiers changed from: private */
    public /* synthetic */ void h0(ReadableMap readableMap, SentryAndroidOptions sentryAndroidOptions) {
        W(sentryAndroidOptions, readableMap, f30484o);
    }
    ...
    private static byte[] w0(final Activity activity) {
        ...
        try {
            ...
            f30484o.c(SentryLevel.ERROR, "Screenshot process was interrupted.", new Object[0]);
            return new byte[0];
        }
    }
    ...
    public void A(Promise promise) {
        try {
            ...
            try {
                ...
                promise.resolve(new String(bArr, f30486q));
                bufferedInputStream.close();
            } catch (Throwable th2) {
                try {
                    bufferedInputStream.close();
            ...
            f30484o.c(SentryLevel.WARNING, "Fetching JS Modules failed.", new Object[0]);
            promise.resolve(null);
        }
    }

    public void B(Promise promise) {
        C(promise, io.sentry.android.core.performance.h.q(), w1.i(), f30484o);
    }
    ...
    public void F(Promise promise) {
        ...
        try {
            SparseIntArray[] b10 = this.f30490c.b();
            ...
            f30484o.c(SentryLevel.WARNING, "Error fetching native frames.", new Object[0]);
            promise.resolve(null);
        }
    }
    ...
    public String I() {
        return this.f30489b.packageName;
    }

    public void J(Promise promise) {
        WritableMap createMap = Arguments.createMap();
        createMap.putString(StackTraceHelper.ID_KEY, this.f30489b.packageName);
        createMap.putString("version", this.f30489b.versionName);
        createMap.putString("build", String.valueOf(this.f30489b.versionCode));
        promise.resolve(createMap);
    }
    ...
    protected Context M() {
        ...
        if (applicationContext == null) {
            f30484o.c(SentryLevel.ERROR, "ApplicationContext is null, using ReactApplicationContext fallback.", new Object[0]);
            return U();
        }
    ...
    public void P(String str, Promise promise) {
        try {
            ...
            if (openInputStream == null) {
                ...
                f30484o.c(SentryLevel.ERROR, str2, new Object[0]);
            ...
            f30484o.c(SentryLevel.ERROR, str3, new Object[0]);
            promise.reject(new Exception(str3));
        }
    }

    public void Q(Promise promise) {
        w.c(promise, this.f30500m);
    }
    ...
    protected void W(final SentryAndroidOptions sentryAndroidOptions, ReadableMap readableMap, ILogger iLogger) {
        ...
        boolean c10 = this.f30501n.c("io.sentry.android.replay.ReplayIntegration", iLogger);
        if (e0(V) && c10) {
    ...
    public void m(String str) {
        f30484o.c(SentryLevel.ERROR, "addListener of NativeEventEmitter can't be used on Android!", new Object[0]);
    }

    public void m0(double d10) {
        f30484o.c(SentryLevel.ERROR, "removeListeners of NativeEventEmitter can't be used on Android!", new Object[0]);
    }
    ...
    public void o(String str, ReadableMap readableMap, Promise promise) {
        ...
        try {
            ...
            f30484o.c(SentryLevel.ERROR, "Error while capturing envelope", new Object[0]);
    ...
    public void o0(final String str, final ReadableMap readableMap) {
        if (str == null) {
            f30484o.c(SentryLevel.ERROR, "RNSentry.setContext called with null key, can't change context.", new Object[0]);
        } else {
    ...
    public void q(Promise promise) {
        Activity N = N();
        if (N == null) {
            f30484o.c(SentryLevel.WARNING, "CurrentActivity is null, can't capture screenshot.", new Object[0]);
            promise.resolve(null);
            return;
        }
        byte[] w02 = w0(N);
        ...
        f30484o.c(SentryLevel.WARNING, "Screenshot is null, screen was not captured.", new Object[0]);
        promise.resolve(null);
    }
    ...
    public void r0(final String str, final String str2) {
        if (str != null && str2 != null) {
            ...
            f30484o.c(SentryLevel.ERROR, "RNSentry.setExtra called with null key or value, can't change extra.", new Object[0]);
        }
    }
    ...
    public WritableMap v0() {
        ...
        try {
            ...
            file = File.createTempFile("sampling-profiler-trace", ".cpuprofile", this.f30488a.getCacheDir());
            if (isDebug) {
                f30484o.c(SentryLevel.INFO, "Profile saved to: " + file.getAbsolutePath(), new Object[0]);
            }
            HermesSamplingProfiler.dumpSampledTraceToFile(file.getPath());
            writableNativeMap.putString("profile", l0(file));
            if (bVar != null) {
                WritableNativeMap writableNativeMap2 = new WritableNativeMap();
                writableNativeMap2.putString("sampled_profile", io.sentry.vendor.a.f(io.sentry.util.i.b(bVar.f28836c.getPath(), this.f30499l), 3));
                writableNativeMap2.putInt("android_api_level", f30485p.d());
                writableNativeMap2.putString("build_id", T());
                writableNativeMap.putMap("androidProfile", writableNativeMap2);
            }
            try {
                if (!file.delete()) {
                    f30484o.c(SentryLevel.WARNING, "Profile not deleted from:" + file.getAbsolutePath(), new Object[0]);
                    return writableNativeMap;
                }
            } catch (Throwable unused) {
                f30484o.c(SentryLevel.WARNING, "Profile not deleted from:" + file.getAbsolutePath(), new Object[0]);
    ...
    public void y() {
        ...
        this.f30491d = r10;
        if (r10) {
            this.f30490c = new FrameMetricsAggregator();
            Activity N = N();
            FrameMetricsAggregator frameMetricsAggregator = this.f30490c;
            if (frameMetricsAggregator != null && N != null) {
                try {
                    frameMetricsAggregator.a(N);
                    f30484o.c(SentryLevel.INFO, "FrameMetricsAggregator installed.", new Object[0]);
                    return;
                } catch (Throwable unused) {
                    f30484o.c(SentryLevel.ERROR, "Error adding Activity to frameMetricsAggregator.", new Object[0]);
                    return;
                }
            }
            f30484o.c(SentryLevel.INFO, "currentActivity isn't available.", new Object[0]);
            return;
        }
        f30484o.c(SentryLevel.WARNING, "androidx.core' isn't available as a dependency.", new Object[0]);
    }
