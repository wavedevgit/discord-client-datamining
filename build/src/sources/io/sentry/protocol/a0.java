...
public final class a0 implements w1 {
    ...
    private final x f30233i;

    /* renamed from: o  reason: collision with root package name */
    private final j8 f30234o;

    /* renamed from: p  reason: collision with root package name */
    private final j8 f30235p;

    /* renamed from: q  reason: collision with root package name */
    private final String f30236q;

    /* renamed from: r  reason: collision with root package name */
    private final String f30237r;

    /* renamed from: s  reason: collision with root package name */
    private final l8 f30238s;

    /* renamed from: t  reason: collision with root package name */
    private final String f30239t;

    /* renamed from: u  reason: collision with root package name */
    private final Map f30240u;

    /* renamed from: v  reason: collision with root package name */
    private Map f30241v;

    /* renamed from: w  reason: collision with root package name */
    private final Map f30242w;
    ...
    public void serialize(f3 f3Var, ILogger iLogger) {
        f3Var.r();
        f3Var.e("start_timestamp").j(iLogger, a(this.f30231d));
        if (this.f30232e != null) {
            f3Var.e("timestamp").j(iLogger, a(this.f30232e));
        }
        f3Var.e("trace_id").j(iLogger, this.f30233i);
        f3Var.e("span_id").j(iLogger, this.f30234o);
        if (this.f30235p != null) {
            f3Var.e("parent_span_id").j(iLogger, this.f30235p);
        }
        f3Var.e("op").f(this.f30236q);
        if (this.f30237r != null) {
            f3Var.e("description").f(this.f30237r);
        }
        if (this.f30238s != null) {
            f3Var.e("status").j(iLogger, this.f30238s);
        }
        if (this.f30239t != null) {
            f3Var.e("origin").j(iLogger, this.f30239t);
        }
        if (!this.f30240u.isEmpty()) {
            f3Var.e("tags").j(iLogger, this.f30240u);
        }
        if (this.f30241v != null) {
            f3Var.e("data").j(iLogger, this.f30241v);
        }
        if (!this.f30242w.isEmpty()) {
            f3Var.e("measurements").j(iLogger, this.f30242w);
        }
        Map map = this.f30243x;
        if (map != null) {
            for (String str : map.keySet()) {
                Object obj = this.f30243x.get(str);
                f3Var.e(str);
                f3Var.j(iLogger, obj);
            }
        }
    ...
    public a0(d8 d8Var, Map map) {
        ...
        this.f30237r = d8Var.getDescription();
        this.f30236q = d8Var.x();
        this.f30234o = d8Var.C();
        this.f30235p = d8Var.z();
        this.f30233i = d8Var.E();
        this.f30238s = d8Var.a();
        this.f30239t = d8Var.q().g();
        Map b10 = io.sentry.util.c.b(d8Var.D());
        this.f30240u = b10 == null ? new ConcurrentHashMap() : b10;
        Map b11 = io.sentry.util.c.b(d8Var.w());
        this.f30242w = b11 == null ? new ConcurrentHashMap() : b11;
        this.f30232e = d8Var.r() == null ? null : Double.valueOf(io.sentry.k.m(d8Var.t().g(d8Var.r())));
        this.f30231d = Double.valueOf(io.sentry.k.m(d8Var.t().h()));
        this.f30241v = map;
        g n10 = d8Var.q().d().n();
        if (n10 != null) {
            if (this.f30241v == null) {
                this.f30241v = new HashMap();
            }
            for (f fVar : n10.a()) {
                Map map2 = this.f30241v;
