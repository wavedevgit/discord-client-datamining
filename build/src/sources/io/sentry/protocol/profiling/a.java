...
public final class a implements w1 {
    ...
    private List f30452d = new ArrayList();

    /* renamed from: e  reason: collision with root package name */
    private List f30453e = new ArrayList();

    /* renamed from: i  reason: collision with root package name */
    private List f30454i = new ArrayList();

    /* renamed from: o  reason: collision with root package name */
    private Map f30455o = new HashMap();
    ...
    public void serialize(f3 f3Var, ILogger iLogger) {
        f3Var.r();
        f3Var.e("samples").j(iLogger, this.f30452d);
        f3Var.e("stacks").j(iLogger, this.f30453e);
        f3Var.e("frames").j(iLogger, this.f30454i);
        f3Var.e("thread_metadata").j(iLogger, this.f30455o);
        Map map = this.f30456p;
        if (map != null) {
            for (String str : map.keySet()) {
                f3Var.e(str).j(iLogger, this.f30456p.get(str));
            }
        }
        f3Var.y();
    }
