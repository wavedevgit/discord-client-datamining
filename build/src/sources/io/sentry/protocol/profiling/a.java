...
public final class a implements w1 {
    ...
    private List f30436d = new ArrayList();

    /* renamed from: e  reason: collision with root package name */
    private List f30437e = new ArrayList();

    /* renamed from: i  reason: collision with root package name */
    private List f30438i = new ArrayList();

    /* renamed from: o  reason: collision with root package name */
    private Map f30439o = new HashMap();
    ...
    public void serialize(f3 f3Var, ILogger iLogger) {
        f3Var.r();
        f3Var.e("samples").j(iLogger, this.f30436d);
        f3Var.e("stacks").j(iLogger, this.f30437e);
        f3Var.e("frames").j(iLogger, this.f30438i);
        f3Var.e("thread_metadata").j(iLogger, this.f30439o);
        Map map = this.f30440p;
        if (map != null) {
            for (String str : map.keySet()) {
                f3Var.e(str).j(iLogger, this.f30440p.get(str));
            }
        }
        f3Var.y();
    }
