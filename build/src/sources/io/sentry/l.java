...
public final class l implements b0 {
    ...
    private final Map f29707d = Collections.synchronizedMap(new HashMap());

    /* renamed from: e  reason: collision with root package name */
    private final k7 f29708e;
    ...
    public SentryEvent h(SentryEvent sentryEvent, Hint hint) {
        ...
        Long l10 = (Long) this.f29707d.get(k10);
        if (l10 != null && !l10.equals(j10)) {
            this.f29708e.getLogger().c(SentryLevel.INFO, "Event %s has been dropped due to multi-threaded deduplication", sentryEvent.G());
            io.sentry.util.n.n(hint, io.sentry.hints.h.MULTITHREADED_DEDUPLICATION);
            return null;
        }
        this.f29707d.put(k10, j10);
        return sentryEvent;
    }
}
