...
public final class r8 {
    ...
    private final k7 f30455a;

    public r8(k7 k7Var) {
        this.f30455a = (k7) io.sentry.util.y.c(k7Var, "options are required");
    }
    ...
    public s8 a(y3 y3Var) {
        ...
        this.f30455a.getProfilesSampler();
        Double profilesSampleRate = this.f30455a.getProfilesSampleRate();
        ...
        this.f30455a.getTracesSampler();
        s8 z11 = y3Var.b().z();
        if (z11 != null) {
            return io.sentry.util.c0.a(z11);
        }
        Double tracesSampleRate = this.f30455a.getTracesSampleRate();
        double pow = Math.pow(2.0d, this.f30455a.getBackpressureMonitor().a());
    ...
    public boolean c(double d10) {
        Double profileSessionSampleRate = this.f30455a.getProfileSessionSampleRate();
