...
public final class r8 {
    ...
    private final k7 f28951a;

    public r8(k7 k7Var) {
        this.f28951a = (k7) io.sentry.util.y.c(k7Var, "options are required");
    }
    ...
    public s8 a(y3 y3Var) {
        ...
        this.f28951a.getProfilesSampler();
        Double profilesSampleRate = this.f28951a.getProfilesSampleRate();
        ...
        this.f28951a.getTracesSampler();
        s8 z11 = y3Var.b().z();
        if (z11 != null) {
            return io.sentry.util.c0.a(z11);
        }
        Double tracesSampleRate = this.f28951a.getTracesSampleRate();
        double pow = Math.pow(2.0d, this.f28951a.getBackpressureMonitor().a());
    ...
    public boolean c(double d10) {
        Double profileSessionSampleRate = this.f28951a.getProfileSessionSampleRate();
