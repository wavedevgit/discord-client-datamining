...
public final class e extends d implements w1 {
    ...
    public static final class a implements m1 {
        private void c(e eVar, e3 e3Var, ILogger iLogger) {
            ...
            while (e3Var.peek() == io.sentry.vendor.gson.stream.b.NAME) {
                ...
                switch (c10) {
                    case 0:
                        eVar.f30585q = e3Var.nextFloat();
                        break;
                    case 1:
                        eVar.f30586r = e3Var.nextFloat();
                        break;
                    case 2:
                        eVar.f30584p = e3Var.nextInt();
                        break;
                    case 3:
                        eVar.f30583o = (b) e3Var.G0(iLogger, new b.a());
                        break;
                    case 4:
                        eVar.f30587s = e3Var.nextInt();
                        break;
                    case 5:
                        eVar.f30588t = e3Var.nextInt();
                        break;
                    default:
    ...
    private void o(f3 f3Var, ILogger iLogger) {
        ...
        f3Var.e("type").j(iLogger, this.f30583o);
        f3Var.e(StackTraceHelper.ID_KEY).b(this.f30584p);
        f3Var.e("x").c(this.f30585q);
        f3Var.e("y").c(this.f30586r);
        f3Var.e("pointerType").b(this.f30587s);
        f3Var.e("pointerId").b(this.f30588t);
        Map map = this.f30590v;
        if (map != null) {
            for (String str : map.keySet()) {
                Object obj = this.f30590v.get(str);
                f3Var.e(str);
                f3Var.j(iLogger, obj);
            }
        }
    ...
    public void serialize(f3 f3Var, ILogger iLogger) {
        ...
        f3Var.e("data");
        o(f3Var, iLogger);
        Map map = this.f30589u;
        if (map != null) {
            for (String str : map.keySet()) {
                Object obj = this.f30589u.get(str);
                f3Var.e(str);
                f3Var.j(iLogger, obj);
            }
        }
