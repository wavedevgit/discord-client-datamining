...
public final class e implements io.sentry.logger.b {
    ...
    private static final io.sentry.util.a f30143h = new io.sentry.util.a();

    /* renamed from: a  reason: collision with root package name */
    private final k7 f30144a;

    /* renamed from: b  reason: collision with root package name */
    private final y0 f30145b;

    /* renamed from: d  reason: collision with root package name */
    private final z0 f30147d;

    /* renamed from: e  reason: collision with root package name */
    private volatile Future f30148e;

    /* renamed from: f  reason: collision with root package name */
    private volatile boolean f30149f = false;

    /* renamed from: g  reason: collision with root package name */
    private final b0 f30150g = new b0();

    /* renamed from: c  reason: collision with root package name */
    private final Queue f30146c = new ConcurrentLinkedQueue();
    ...
    private void f() {
        ...
        if (!arrayList.isEmpty()) {
            this.f30145b.h(new z6(arrayList));
    ...
    /* JADX WARN: Code restructure failed: missing block: B:25:0x003d, code lost:
        r5.f30149f = false;
        r5.f30144a.getLogger().b(io.sentry.SentryLevel.WARNING, "Logs batch processor flush task rejected", r7);
     */
    ...
    */
    private void h(boolean r6, boolean r7) {
        /*
            r5 = this;
            boolean r0 = r5.f30149f
            if (r0 == 0) goto L7
            if (r6 != 0) goto L7
            goto L51
        L7:
            io.sentry.util.a r0 = io.sentry.logger.e.f30143h
            io.sentry.a1 r0 = r0.a()
            java.util.concurrent.Future r1 = r5.f30148e     // Catch: java.lang.Throwable -> L20
            if (r6 != 0) goto L22
            if (r1 == 0) goto L22
        ...
        L22:
            r6 = 1
            r5.f30149f = r6     // Catch: java.lang.Throwable -> L20
            r6 = 0
            if (r7 == 0) goto L2a
            r7 = r6
            goto L2c
        ...
        L2c:
            io.sentry.z0 r1 = r5.f30147d     // Catch: java.lang.Throwable -> L20 java.util.concurrent.RejectedExecutionException -> L3c
            ...
            r5.f30148e = r7     // Catch: java.lang.Throwable -> L20 java.util.concurrent.RejectedExecutionException -> L3c
            goto L4c
        L3c:
            r7 = move-exception
            r5.f30149f = r6     // Catch: java.lang.Throwable -> L20
            io.sentry.k7 r6 = r5.f30144a     // Catch: java.lang.Throwable -> L20
    ...
    public void c(boolean z10) {
        if (z10) {
            h(true, true);
            this.f30147d.submit(new Runnable() { // from class: io.sentry.logger.d
                @Override // java.lang.Runnable
                public final void run() {
                    r0.f30147d.a(e.this.f30144a.getShutdownTimeoutMillis());
                }
            });
            return;
        }
        this.f30147d.a(this.f30144a.getShutdownTimeoutMillis());
    ...
    public void d(long j10) {
        h(true, true);
        try {
            this.f30150g.d(j10, TimeUnit.MILLISECONDS);
        } catch (InterruptedException e10) {
            this.f30144a.getLogger().b(SentryLevel.ERROR, "Failed to flush log events", e10);
