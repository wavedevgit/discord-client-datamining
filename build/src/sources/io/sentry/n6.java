...
public final class n6 {
    ...
    private final o7 f29564a;

    public n6(o7 o7Var) {
        this.f29564a = (o7) io.sentry.util.y.c(o7Var, "The SentryStackTraceFactory is required.");
    }
    ...
    Deque b(Throwable th2, AtomicInteger atomicInteger, HashSet hashSet, Deque deque, String str) {
        ...
        while (th4 != null) {
            ...
            deque2.addFirst(c(th3, lVar2, Long.valueOf(currentThread.getId()), this.f29564a.a(th3.getStackTrace(), Boolean.FALSE.equals(lVar2.l())), z10));
            if (lVar2.k() == null) {
                lVar2.p(str2);
            }
