...
public abstract class b5 {
    ...
    private static volatile x0 f29080a = r2.c();

    /* renamed from: b  reason: collision with root package name */
    private static volatile w0 f29081b = p2.h();

    /* renamed from: c  reason: collision with root package name */
    private static final IScope f29082c = new z3(k7.empty());

    /* renamed from: d  reason: collision with root package name */
    private static volatile boolean f29083d = false;

    /* renamed from: e  reason: collision with root package name */
    private static final Charset f29084e = Charset.forName("UTF-8");

    /* renamed from: f  reason: collision with root package name */
    private static final long f29085f = System.currentTimeMillis();

    /* renamed from: g  reason: collision with root package name */
    private static final io.sentry.util.a f29086g = new io.sentry.util.a();
    ...
    private static void A(final k7 k7Var, boolean z10) {
        ...
        try {
            ...
            if (io.sentry.util.o.d(iScope.b(), k7Var, I())) {
                ...
                v().c(true);
                iScope.r(k7Var);
                f29081b = new k4(new z3(k7Var), new z3(k7Var), iScope, "Sentry.init");
                F(k7Var);
                D(k7Var);
                x().b(f29081b);
                B(k7Var);
                iScope.H(new h5(k7Var));
                ...
                k7Var.getLogger().c(sentryLevel, "Using scopes storage %s", f29080a.getClass().getName());
            } else {
    ...
    private static void B(k7 k7Var) {
        ...
        if (outboxPath != null) {
            ...
            k7Var.getRuntimeManager().a(new a.InterfaceC0409a() { // from class: io.sentry.w4
        ...
        if (cacheDirPath != null) {
            ...
            k7Var.getRuntimeManager().a(new a.InterfaceC0409a() { // from class: io.sentry.x4
                @Override // io.sentry.util.runtime.a.InterfaceC0409a
                public final Object run() {
                    Boolean valueOf;
            ...
            if (k7Var.getEnvelopeDiskCache() instanceof io.sentry.transport.s) {
                k7Var.setEnvelopeDiskCache(io.sentry.cache.f.u(k7Var));
            }
        }
        ...
        if ((k7Var.isProfilingEnabled() || k7Var.isContinuousProfilingEnabled()) && profilingTracesDirPath != null) {
            ...
            k7Var.getRuntimeManager().a(new a.InterfaceC0409a() { // from class: io.sentry.y4
                @Override // io.sentry.util.runtime.a.InterfaceC0409a
                public final Object run() {
                    Boolean valueOf;
    ...
    private static void G(k7 k7Var) {
        ...
        if (e7.OFF == k7Var.getOpenTelemetryMode()) {
            ...
            f29080a = m4.a(new io.sentry.util.u(), i2.e());
        }
    }
            ...
            try {
                ...
                if (k7Var.isEnableAppStartProfiling() || k7Var.isStartProfilerOnAppStart()) {
                    if (!k7Var.isStartProfilerOnAppStart() && !k7Var.isTracingEnabled()) {
                        ...
                        BufferedWriter bufferedWriter = new BufferedWriter(new OutputStreamWriter(fileOutputStream, f29084e));
    ...
    public static /* synthetic */ void f(File file) {
        ...
        if (listFiles != null) {
            for (File file2 : listFiles) {
                if (file2.lastModified() < f29085f - TimeUnit.MINUTES.toMillis(5L)) {
    ...
    public static w0 v() {
        ...
        w0 I = f29081b.I("getCurrentScopes");
        x().b(I);
        return I;
    }
