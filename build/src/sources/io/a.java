...
public final class a implements Parcelable {
    ...
    public a(List previousFramesMetadata) {
        ...
        this.f28657d = previousFramesMetadata;
    }
    ...
    public boolean equals(Object obj) {
        ...
        if ((obj instanceof a) && Intrinsics.areEqual(this.f28657d, ((a) obj).f28657d)) {
            return true;
        }
        return false;
    }
    ...
    public int hashCode() {
        return this.f28657d.hashCode();
    }

    public String toString() {
        List list = this.f28657d;
    ...
    public final void writeToParcel(Parcel dest, int i10) {
        ...
        List<Parcelable> list = this.f28657d;
