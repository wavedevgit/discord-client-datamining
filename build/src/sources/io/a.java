...
public final class a {
    ...
    public static final C0408a f27085b = new C0408a(null);

    /* renamed from: c  reason: collision with root package name */
    private static final Charset f27086c = Charset.forName("UTF-8");
    ...
    public a(Context context) {
        ...
        this.f27087a = new File(new File(context.getFilesDir(), ".com.withpersona.sdk2.inquiry"), "errors");
    }
    ...
    private final File d() {
        return new File(this.f27087a, "last_error.txt");
    }
    ...
    private final void j(File file, String str) {
        OutputStreamWriter outputStreamWriter = new OutputStreamWriter(new FileOutputStream(file), f27086c);
        try {
