...
public abstract class c {
    ...
    private static final Map f48349a;

    /* renamed from: b  reason: collision with root package name */
    private static final Map f48350b;
    ...
    static {
        ...
        for (Long l10 : asList) {
            f48349a.put(l10, z.f54848i);
        }
        f48350b.put(z.f54848i, asList);
        List<Long> asList2 = Arrays.asList(1024L, 2048L, 256L, 512L);
        for (Long l11 : asList2) {
            f48349a.put(l11, z.f54849j);
        }
        f48350b.put(z.f54849j, asList2);
    }

    public static Long a(z zVar, DynamicRangeProfiles dynamicRangeProfiles) {
        List<Long> list = (List) f48350b.get(zVar);
        if (list != null) {
    ...
    public static z b(long j10) {
        return (z) f48349a.get(Long.valueOf(j10));
    }
}
