...
public final class j {
    ...
    public j(int i10, Surface surface) {
        ...
        if (i11 >= 33) {
            this.f48357a = new n(i10, surface);
        } else if (i11 >= 28) {
            this.f48357a = new m(i10, surface);
        } else if (i11 >= 26) {
            this.f48357a = new l(i10, surface);
        } else {
            this.f48357a = new k(i10, surface);
        }
    }
    ...
    public Surface d() {
        return this.f48357a.getSurface();
    }
    ...
    public boolean equals(Object obj) {
        ...
        return this.f48357a.equals(((j) obj).f48357a);
    }
    ...
    public j(OutputConfiguration outputConfiguration) {
        this.f48357a = n.m(outputConfiguration);
    }
