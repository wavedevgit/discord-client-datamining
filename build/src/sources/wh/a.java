...
public abstract class a {
    ...
    private static final int[] f53340a = {16842752, f.a.M};

    /* renamed from: b  reason: collision with root package name */
    private static final int[] f53341b = {b.H};

    private static int a(Context context, AttributeSet attributeSet) {
        TypedArray obtainStyledAttributes = context.obtainStyledAttributes(attributeSet, f53340a);
    ...
    private static int c(Context context, AttributeSet attributeSet, int i10, int i11) {
        return b(context, attributeSet, f53341b, i10, i11)[0];
    }
