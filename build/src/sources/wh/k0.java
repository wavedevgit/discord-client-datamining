...
public final class k0 {
    ...
    public k0(String str) {
        ...
        this.f53078a = ("UID: [" + myUid + "]  PID: [" + myPid + "] ").concat(str);
    }
    ...
    public final int a(String str, Object... objArr) {
        if (Log.isLoggable("PlayCore", 3)) {
            return Log.d("PlayCore", f(this.f53078a, str, objArr));
        }
        return 0;
    }
    ...
    public final int b(String str, Object... objArr) {
        if (Log.isLoggable("PlayCore", 6)) {
            return Log.e("PlayCore", f(this.f53078a, str, objArr));
        }
        return 0;
    }
    ...
    public final int c(Throwable th2, String str, Object... objArr) {
        if (Log.isLoggable("PlayCore", 6)) {
            return Log.e("PlayCore", f(this.f53078a, str, objArr), th2);
        }
        return 0;
    }
    ...
    public final int d(String str, Object... objArr) {
        if (Log.isLoggable("PlayCore", 4)) {
            return Log.i("PlayCore", f(this.f53078a, str, objArr));
        }
        return 0;
    }
    ...
    public final int e(String str, Object... objArr) {
        if (Log.isLoggable("PlayCore", 5)) {
            return Log.w("PlayCore", f(this.f53078a, str, objArr));
        }
        return 0;
    }
}
