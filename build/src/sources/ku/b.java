...
public final class b extends mu.c {
    ...
    private final X509TrustManager f36144b;

    /* renamed from: c  reason: collision with root package name */
    private final X509TrustManagerExtensions f36145c;
    ...
    public b(X509TrustManager trustManager, X509TrustManagerExtensions x509TrustManagerExtensions) {
        ...
        this.f36144b = trustManager;
        this.f36145c = x509TrustManagerExtensions;
    }
    ...
    public List a(List chain, String hostname) {
        ...
        try {
            List<X509Certificate> checkServerTrusted = this.f36145c.checkServerTrusted((X509Certificate[]) chain.toArray(new X509Certificate[0]), "RSA", hostname);
    ...
    public boolean equals(Object obj) {
        if ((obj instanceof b) && ((b) obj).f36144b == this.f36144b) {
            return true;
        }
        return false;
    }
    ...
    public int hashCode() {
        return System.identityHashCode(this.f36144b);
    }
}
