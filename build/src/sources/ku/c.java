...
public final class c {
    ...
    private static final CopyOnWriteArraySet f36147b = new CopyOnWriteArraySet();

    /* renamed from: c  reason: collision with root package name */
    private static final Map f36148c;
    ...
    private final void c(String str, String str2) {
        ...
        if (f36147b.add(logger)) {
            ...
            logger.addHandler(d.f36149a);
        }
    }

    private final String d(String str) {
        String str2 = (String) f36148c.get(str);
        if (str2 == null) {
    ...
    public final void b() {
        for (Map.Entry entry : f36148c.entrySet()) {
