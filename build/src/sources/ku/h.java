...
public final class h {
    ...
    private final Method f36162b;

    /* renamed from: c  reason: collision with root package name */
    private final Method f36163c;
    ...
    public h(Method method, Method method2, Method method3) {
        this.f36161a = method;
        this.f36162b = method2;
        this.f36163c = method3;
    }

    public final Object a(String closer) {
        Intrinsics.checkNotNullParameter(closer, "closer");
        Method method = this.f36161a;
        if (method != null) {
            try {
                Object invoke = method.invoke(null, null);
                Method method2 = this.f36162b;
