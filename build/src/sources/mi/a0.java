...
public abstract class a0 {
    ...
    /* loaded from: /home/runner/work/discord-client-datamining/discord-client-datamining/build/classes4.dex */
    public static abstract class b implements li.f {

        /* renamed from: d  reason: collision with root package name */
        public static final b f38546d = new a("KEY", 0);

        /* renamed from: e  reason: collision with root package name */
        public static final b f38547e = new C0499b("VALUE", 1);

        /* renamed from: i  reason: collision with root package name */
        private static final /* synthetic */ b[] f38548i = a();
        ...
        /* loaded from: /home/runner/work/discord-client-datamining/discord-client-datamining/build/classes4.dex */
        enum C0499b extends b {
            C0499b(String str, int i10) {
                super(str, i10, null);
            }
    ...
    public static abstract class c extends q0.d {
        ...
        @Override // mi.q0.d, java.util.AbstractSet, java.util.AbstractCollection, java.util.Collection, java.util.Set
        public boolean removeAll(Collection collection) {
            try {
                return super.removeAll((Collection) li.m.j(collection));
            } catch (UnsupportedOperationException unused) {
                return q0.j(this, collection.iterator());
            }
        }

        @Override // mi.q0.d, java.util.AbstractCollection, java.util.Collection, java.util.Set
    ...
    public static abstract class f extends AbstractMap {
        ...
        /* renamed from: d  reason: collision with root package name */
        private transient Set f38551d;

        /* renamed from: e  reason: collision with root package name */
        private transient Collection f38552e;
        ...
        public Collection values() {
            Collection collection = this.f38552e;
            if (collection == null) {
                Collection b10 = b();
                this.f38552e = b10;
                return b10;
