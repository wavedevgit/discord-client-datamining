...
public final class f {
    ...
    private final ki.b f36496a;

    /* renamed from: b  reason: collision with root package name */
    private XmlPullParser f36497b;
    ...
    public final long a() {
        if (this.f36497b != null) {
            while (true) {
                int next = this.f36497b.next();
                if (next != 2) {
                    if (next == 1) {
                        break;
                    }
                } else if (this.f36497b.getName().equals("manifest")) {
                    String attributeValue = this.f36497b.getAttributeValue("http://schemas.android.com/apk/res/android", "versionCode");
                    String attributeValue2 = this.f36497b.getAttributeValue("http://schemas.android.com/apk/res/android", "versionCodeMajor");
    ...
    public final void b(AssetManager assetManager, File file) {
        this.f36497b = assetManager.openXmlResourceParser(ki.b.c(assetManager, file), "AndroidManifest.xml");
    }
}
