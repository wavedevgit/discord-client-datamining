...
public abstract class v {
    public static boolean a(Iterable iterable, li.n nVar) {
    ...
    public static boolean f(Iterable iterable, li.n nVar) {
        if ((iterable instanceof RandomAccess) && (iterable instanceof List)) {
            return g((List) iterable, (li.n) li.m.j(nVar));
        }
        return w.o(iterable.iterator(), nVar);
    }

    private static boolean g(List list, li.n nVar) {
        int i10 = 0;
        int i11 = 0;
        while (i10 < list.size()) {
    ...
    private static void h(List list, li.n nVar, int i10, int i11) {
