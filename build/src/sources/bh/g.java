...
public class g {
    ...
    private final SimpleArrayMap f6765a = new SimpleArrayMap();

    /* renamed from: b  reason: collision with root package name */
    private final SimpleArrayMap f6766b = new SimpleArrayMap();
    ...
    public boolean equals(Object obj) {
        ...
        return this.f6765a.equals(((g) obj).f6765a);
    }

    public boolean f(String str) {
        if (this.f6765a.get(str) != null) {
            return true;
        }
        return false;
    }
    ...
    public void g(String str, PropertyValuesHolder[] propertyValuesHolderArr) {
        this.f6766b.put(str, propertyValuesHolderArr);
    }

    public void h(String str, h hVar) {
        this.f6765a.put(str, hVar);
    }
    ...
    public String toString() {
        return '\n' + getClass().getName() + '{' + Integer.toHexString(System.identityHashCode(this)) + " timings: " + this.f6765a + "}\n";
    }
}
