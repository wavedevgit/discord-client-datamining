...
public final class i extends sj.f {

    /* renamed from: j  reason: collision with root package name */
    static final AtomicBoolean f6481j = new AtomicBoolean(true);

    /* renamed from: k  reason: collision with root package name */
    private static final zj.d f6482k = zj.d.b();

    /* renamed from: d  reason: collision with root package name */
    private final ak.e f6483d;

    /* renamed from: e  reason: collision with root package name */
    private final qd f6484e;

    /* renamed from: f  reason: collision with root package name */
    private final sd f6485f;
    ...
    private final zj.a f6488i = new zj.a();

    public i(qd qdVar, ak.e eVar, c cVar) {
        q.m(eVar, "FaceDetectorOptions can not be null");
        this.f6483d = eVar;
        this.f6484e = qdVar;
        this.f6486g = cVar;
        this.f6485f = sd.a(sj.i.c().b());
    }
    ...
    private final synchronized void n(final ca caVar, long j10, final yj.a aVar, final int i10, final int i11) {
        int i12;
        final long elapsedRealtime = SystemClock.elapsedRealtime() - j10;
        this.f6484e.f(new od() { // from class: bk.g
            @Override // og.od
            public final ed zza() {
        ...
        o2 o2Var = new o2();
        o2Var.c(caVar);
        o2Var.d(Boolean.valueOf(f6481j.get()));
        o2Var.a(Integer.valueOf(i10));
        o2Var.e(Integer.valueOf(i11));
        o2Var.b(k.a(this.f6483d));
        final q2 f10 = o2Var.f();
        final h hVar = new h(this);
        final qd qdVar = this.f6484e;
        final da daVar = da.AGGREGATED_ON_DEVICE_FACE_DETECTION;
        sj.g.d().execute(new Runnable(daVar, f10, elapsedRealtime, hVar, null) { // from class: og.ld

            /* renamed from: e  reason: collision with root package name */
            public final /* synthetic */ da f43106e;

            /* renamed from: i  reason: collision with root package name */
            public final /* synthetic */ Object f43107i;

            /* renamed from: o  reason: collision with root package name */
            public final /* synthetic */ long f43108o;

            /* renamed from: p  reason: collision with root package name */
            public final /* synthetic */ bk.h f43109p;

            @Override // java.lang.Runnable
            public final void run() {
                qd.this.h(this.f43106e, this.f43107i, this.f43108o, this.f43109p);
            }
        });
        long currentTimeMillis = System.currentTimeMillis();
        boolean z10 = this.f6487h;
        long j11 = currentTimeMillis - elapsedRealtime;
        sd sdVar = this.f6485f;
        if (true != z10) {
            i12 = 24303;
        } else {
            i12 = 24304;
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    public final /* synthetic */ ed j(long j10, ca caVar, int i10, int i11, yj.a aVar) {
        p9 p9Var;
        ba baVar;
        ua uaVar = new ua();
        t9 t9Var = new t9();
        ...
        t9Var.d(caVar);
        t9Var.e(Boolean.valueOf(f6481j.get()));
        Boolean bool = Boolean.TRUE;
        t9Var.a(bool);
        t9Var.b(bool);
        uaVar.g(t9Var.f());
        uaVar.e(k.a(this.f6483d));
    ...
    */
    public final synchronized java.util.List i(yj.a r20) {
        /*
            Method dump skipped, instructions count: 318
            To view this dump add '--comments-level debug' option
        */
        throw new UnsupportedOperationException("Method not decompiled: bk.i.i(yj.a):java.util.List");
    }
}
