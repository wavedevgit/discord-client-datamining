...
public abstract class k {
    ...
    static final AtomicReference f6491a = new AtomicReference();

    public static n9 a(ak.e eVar) {
        k9 k9Var;
        h9 h9Var;
        l9 l9Var;
        i9 i9Var;
    ...
    public static void c(qd qdVar, final boolean z10, final ca caVar) {
        qdVar.f(new od() { // from class: bk.j
            @Override // og.od
            public final ed zza() {
                ba baVar;
                boolean z11 = z10;
    ...
    public static boolean d() {
        AtomicReference atomicReference = f6491a;
        if (atomicReference.get() != null) {
            return ((Boolean) atomicReference.get()).booleanValue();
        }
        boolean a10 = b.a(sj.i.c().b());
