...
public abstract class b {
    ...
    private static final SparseArray f7208a;

    /* renamed from: b  reason: collision with root package name */
    private static final SparseArray f7209b;

    /* renamed from: c  reason: collision with root package name */
    static final AtomicReference f7210c;

    /* renamed from: d  reason: collision with root package name */
    private static final Map f7211d;
    ...
    public static wj c(yj.b bVar) {
        int a10 = bVar.a();
        f1 f1Var = new f1();
        if (a10 == 0) {
            f1Var.f(f7211d.values());
        } else {
            for (Map.Entry entry : f7211d.entrySet()) {
    ...
    public static void e(nk nkVar, final xe xeVar) {
        nkVar.f(new mk() { // from class: bk.a
            @Override // og.mk
            public final ck zza() {
                we weVar;
                ze zeVar = new ze();
    ...
    public static boolean f() {
        AtomicReference atomicReference = f7210c;
        if (atomicReference.get() != null) {
            return ((Boolean) atomicReference.get()).booleanValue();
        }
        boolean b10 = n.b(wj.i.c().b());
