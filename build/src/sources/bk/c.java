...
public class c {
    ...
    private static final c f7077a = new c();
    ...
    private static byte[] l(byte[] bArr, int i10, int i11) {
        ...
        try {
            ...
            throw new qj.a("Image conversion error from NV21 format", 13, e10);
        }
    }
    ...
    public ByteBuffer d(ak.a aVar, boolean z10) {
        ByteBuffer allocateDirect;
        ...
        if (g10 != -1) {
            if (g10 != 17) {
                if (g10 != 35) {
                    ...
                    throw new qj.a("Unsupported image format", 13);
                }
