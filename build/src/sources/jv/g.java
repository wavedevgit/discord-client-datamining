...
final class g extends e.a {
    ...
    private static final class a implements e {
        ...
        public class C0438a implements f {
            ...
            /* renamed from: a  reason: collision with root package name */
            private final CompletableFuture f32441a;

            public C0438a(CompletableFuture completableFuture) {
                this.f32441a = completableFuture;
            }

            @Override // jv.f
            public void a(d dVar, z zVar) {
                if (zVar.g()) {
                    this.f32441a.complete(zVar.a());
                } else {
                    this.f32441a.completeExceptionally(new o(zVar));
                }
            }

            @Override // jv.f
            public void b(d dVar, Throwable th2) {
                this.f32441a.completeExceptionally(th2);
            }
        }
    ...
    private static final class c implements e {
        ...
        public class a implements f {
            ...
            /* renamed from: a  reason: collision with root package name */
            private final CompletableFuture f32445a;

            public a(CompletableFuture completableFuture) {
                this.f32445a = completableFuture;
            }

            @Override // jv.f
            public void a(d dVar, z zVar) {
                this.f32445a.complete(zVar);
            }

            @Override // jv.f
            public void b(d dVar, Throwable th2) {
                this.f32445a.completeExceptionally(th2);
            }
        }
