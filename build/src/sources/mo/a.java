...
public final class a implements Parcelable {
    ...
    private final String f38803i;

    /* renamed from: o  reason: collision with root package name */
    private final List f38804o;
    ...
    public a(String merchantId, String nonce, String fieldKeyMobileDriversLicense, List digitalIdRequests) {
        ...
        this.f38801d = merchantId;
        this.f38802e = nonce;
        this.f38803i = fieldKeyMobileDriversLicense;
        this.f38804o = digitalIdRequests;
    }
    ...
    public final void writeToParcel(Parcel dest, int i10) {
        ...
        dest.writeString(this.f38801d);
        dest.writeString(this.f38802e);
        dest.writeString(this.f38803i);
        List<b> list = this.f38804o;
