...
public final class b extends m2.b {
    ...
    public static final a f41385l = new a(null);

    /* renamed from: g  reason: collision with root package name */
    private final Context f41386g;

    /* renamed from: h  reason: collision with root package name */
    private g2.j f41387h;

    /* renamed from: i  reason: collision with root package name */
    private Executor f41388i;

    /* renamed from: j  reason: collision with root package name */
    private CancellationSignal f41389j;

    /* renamed from: k  reason: collision with root package name */
    private final k f41390k;
    ...
    public static final class C0554b extends Lambda implements Function2 {
        ...
        public static final C0554b f41391d = new C0554b();
    ...
    public static final class c extends Lambda implements Function1 {
        ...
        public final void b(final h2.e e10) {
            ...
            Executor executor = b.this.f41388i;
            if (executor == null) {
    ...
    public static final class f extends Lambda implements Function0 {
        ...
        /* renamed from: e  reason: collision with root package name */
        final /* synthetic */ JSONException f41398e;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        f(JSONException jSONException) {
            super(0);
            this.f41398e = jSONException;
        }
        ...
        public final void m1215invoke() {
            ...
            final b bVar = b.this;
            final JSONException jSONException = this.f41398e;
    ...
    public static final class g extends Lambda implements Function0 {
        ...
        /* renamed from: e  reason: collision with root package name */
        final /* synthetic */ Throwable f41400e;
        ...
        public final void m1216invoke() {
            ...
            final b bVar = b.this;
            final Throwable th2 = this.f41400e;
    ...
    static final class h extends Lambda implements Function0 {
        ...
        /* renamed from: e  reason: collision with root package name */
        final /* synthetic */ JSONException f41402e;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        h(JSONException jSONException) {
            super(0);
            this.f41402e = jSONException;
        }
        ...
        public final void m1217invoke() {
            ...
            final b bVar = b.this;
            final JSONException jSONException = this.f41402e;
    ...
    static final class i extends Lambda implements Function0 {
        ...
        /* renamed from: e  reason: collision with root package name */
        final /* synthetic */ Throwable f41404e;
        ...
        public final void m1218invoke() {
            ...
            final b bVar = b.this;
            final Throwable th2 = this.f41404e;
    ...
    public static final class k extends ResultReceiver {
        ...
        public void onReceiveResult(int i10, Bundle resultData) {
            ...
            b bVar = b.this;
            a aVar = new a(m2.a.f36824b);
            Executor executor2 = b.this.f41388i;
            if (executor2 == null) {
                Intrinsics.throwUninitializedPropertyAccessException("executor");
                executor = null;
            } else {
            ...
            if (bVar.f(resultData, aVar, executor, jVar, b.this.f41389j)) {
                return;
            }
    ...
    public b(Context context) {
        ...
        this.f41390k = new k(new Handler(Looper.getMainLooper()));
    }
    ...
    public r q(g2.f request) {
        ...
        return o2.k.f41422a.d(request, this.f41386g);
    }
    ...
    public final void s(int i10, int i11, Intent intent) {
        ...
        if (i10 != m2.a.f36824b.b()) {
            ...
            if (bArr == null) {
                if (!CredentialProviderPlayServicesImpl.Companion.a(this.f41389j)) {
                    Executor executor2 = this.f41388i;
                    if (executor2 == null) {
                        Intrinsics.throwUninitializedPropertyAccessException("executor");
                    } else {
                        executor = executor2;
            ...
            h2.e M = o2.k.f41422a.M(b10);
            if (M != null) {
                m2.b.e(this.f41389j, new d(M));
                return;
            }
            try {
                m2.b.e(this.f41389j, new e(r(b10)));
            } catch (JSONException e10) {
                m2.b.e(this.f41389j, new f(e10));
            } catch (Throwable th2) {
                m2.b.e(this.f41389j, new g(th2));
            }
        }
    }
    ...
    public void u(g2.f request, g2.j callback, Executor executor, CancellationSignal cancellationSignal) {
        ...
        this.f41389j = cancellationSignal;
        this.f41387h = callback;
        this.f41388i = executor;
        try {
            r q10 = q(request);
            if (CredentialProviderPlayServicesImpl.Companion.a(cancellationSignal)) {
                return;
            }
            Intent intent = new Intent(this.f41386g, HiddenActivity.class);
            intent.putExtra("REQUEST_TYPE", q10);
            c(this.f41390k, intent, "CREATE_PUBLIC_KEY_CREDENTIAL");
            try {
                this.f41386g.startActivity(intent);
