...
public final class b extends m2.b {
    ...
    public static final a f42256l = new a(null);

    /* renamed from: g  reason: collision with root package name */
    private final Context f42257g;

    /* renamed from: h  reason: collision with root package name */
    private g2.j f42258h;

    /* renamed from: i  reason: collision with root package name */
    private Executor f42259i;

    /* renamed from: j  reason: collision with root package name */
    private CancellationSignal f42260j;

    /* renamed from: k  reason: collision with root package name */
    private final k f42261k;
    ...
    public static final class C0537b extends Lambda implements Function2 {
        ...
        public static final C0537b f42262d = new C0537b();
    ...
    public static final class c extends Lambda implements Function1 {
        ...
        public final void b(final h2.e e10) {
            ...
            Executor executor = b.this.f42259i;
            if (executor == null) {
    ...
    public static final class f extends Lambda implements Function0 {
        ...
        /* renamed from: e  reason: collision with root package name */
        final /* synthetic */ JSONException f42269e;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        f(JSONException jSONException) {
            super(0);
            this.f42269e = jSONException;
        }
        ...
        public final void m1215invoke() {
            ...
            final b bVar = b.this;
            final JSONException jSONException = this.f42269e;
    ...
    public static final class g extends Lambda implements Function0 {
        ...
        /* renamed from: e  reason: collision with root package name */
        final /* synthetic */ Throwable f42271e;
        ...
        public final void m1216invoke() {
            ...
            final b bVar = b.this;
            final Throwable th2 = this.f42271e;
    ...
    static final class h extends Lambda implements Function0 {
        ...
        /* renamed from: e  reason: collision with root package name */
        final /* synthetic */ JSONException f42273e;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        h(JSONException jSONException) {
            super(0);
            this.f42273e = jSONException;
        }
        ...
        public final void m1217invoke() {
            ...
            final b bVar = b.this;
            final JSONException jSONException = this.f42273e;
    ...
    static final class i extends Lambda implements Function0 {
        ...
        /* renamed from: e  reason: collision with root package name */
        final /* synthetic */ Throwable f42275e;
        ...
        public final void m1218invoke() {
            ...
            final b bVar = b.this;
            final Throwable th2 = this.f42275e;
    ...
    public static final class k extends ResultReceiver {
        ...
        /* synthetic */ class a extends FunctionReferenceImpl implements Function2 {
            a(Object obj) {
                super(2, obj, a.C0477a.class, "createCredentialExceptionTypeToException", "createCredentialExceptionTypeToException$credentials_play_services_auth_release(Ljava/lang/String;Ljava/lang/String;)Landroidx/credentials/exceptions/CreateCredentialException;", 0);
            }

            @Override // kotlin.jvm.functions.Function2
            /* renamed from: a */
            public final h2.e invoke(String str, String str2) {
                return ((a.C0477a) this.receiver).a(str, str2);
            }
        }
        ...
        public void onReceiveResult(int i10, Bundle resultData) {
            ...
            b bVar = b.this;
            a aVar = new a(m2.a.f37580b);
            Executor executor2 = b.this.f42259i;
            if (executor2 == null) {
                Intrinsics.throwUninitializedPropertyAccessException("executor");
                executor = null;
            } else {
            ...
            if (bVar.f(resultData, aVar, executor, jVar, b.this.f42260j)) {
                return;
            }
    ...
    public b(Context context) {
        super(context);
        Intrinsics.checkNotNullParameter(context, "context");
        this.f42257g = context;
        this.f42261k = new k(new Handler(Looper.getMainLooper()));
    }
    ...
    public r q(g2.f request) {
        ...
        return o2.k.f42293a.d(request, this.f42257g);
    }
    ...
    public final void s(int i10, int i11, Intent intent) {
        a.C0477a c0477a;
        byte[] bArr;
        if (i10 != m2.a.f37580b.b()) {
            Log.w("CreatePublicKey", "Returned request code " + c0477a.b() + " does not match what was given " + i10);
        } else if (!m2.b.g(i11, C0537b.f42262d, new c(), this.f42260j)) {
            ...
            if (bArr == null) {
                if (!CredentialProviderPlayServicesImpl.Companion.a(this.f42260j)) {
                    Executor executor2 = this.f42259i;
                    if (executor2 == null) {
                        Intrinsics.throwUninitializedPropertyAccessException("executor");
                    } else {
                        executor = executor2;
            ...
            h2.e M = o2.k.f42293a.M(b10);
            if (M != null) {
                m2.b.e(this.f42260j, new d(M));
                return;
            }
            try {
                m2.b.e(this.f42260j, new e(r(b10)));
            } catch (JSONException e10) {
                m2.b.e(this.f42260j, new f(e10));
            } catch (Throwable th2) {
                m2.b.e(this.f42260j, new g(th2));
            }
        }
    }
    ...
    public void u(g2.f request, g2.j callback, Executor executor, CancellationSignal cancellationSignal) {
        ...
        this.f42260j = cancellationSignal;
        this.f42258h = callback;
        this.f42259i = executor;
        try {
            r q10 = q(request);
            if (CredentialProviderPlayServicesImpl.Companion.a(cancellationSignal)) {
                return;
            }
            Intent intent = new Intent(this.f42257g, HiddenActivity.class);
            intent.putExtra("REQUEST_TYPE", q10);
            c(this.f42261k, intent, "CREATE_PUBLIC_KEY_CREDENTIAL");
            try {
                this.f42257g.startActivity(intent);
