...
public final class z {
    ...
    public static final a f38742f = new a(null);

    /* renamed from: a  reason: collision with root package name */
    private final double f38743a;

    /* renamed from: b  reason: collision with root package name */
    private final double f38744b;

    /* renamed from: c  reason: collision with root package name */
    private final double f38745c;

    /* renamed from: d  reason: collision with root package name */
    private final double f38746d;

    /* renamed from: e  reason: collision with root package name */
    private final double f38747e;
    ...
    public final ReadableMap b() {
        ...
        createMap.putDouble("tiltX", this.f38743a);
        createMap.putDouble("tiltY", this.f38744b);
        createMap.putDouble("altitudeAngle", this.f38745c);
        createMap.putDouble("azimuthAngle", this.f38746d);
        createMap.putDouble("pressure", this.f38747e);
    ...
    public boolean equals(Object obj) {
        ...
        z zVar = (z) obj;
        if (Double.compare(this.f38743a, zVar.f38743a) == 0 && Double.compare(this.f38744b, zVar.f38744b) == 0 && Double.compare(this.f38745c, zVar.f38745c) == 0 && Double.compare(this.f38746d, zVar.f38746d) == 0 && Double.compare(this.f38747e, zVar.f38747e) == 0) {
            return true;
        }
        return false;
    }
    ...
    public int hashCode() {
        return (((((((Double.hashCode(this.f38743a) * 31) + Double.hashCode(this.f38744b)) * 31) + Double.hashCode(this.f38745c)) * 31) + Double.hashCode(this.f38746d)) * 31) + Double.hashCode(this.f38747e);
    }

    public String toString() {
        double d10 = this.f38743a;
        double d11 = this.f38744b;
        double d12 = this.f38745c;
        double d13 = this.f38746d;
        double d14 = this.f38747e;
