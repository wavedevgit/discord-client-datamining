...
public final class t {
    ...
    public static final class a {
        ...
        public static final a f42049d = new a("FRONT", 0);

        /* renamed from: e  reason: collision with root package name */
        public static final a f42050e = new a("BACK", 1);

        /* renamed from: i  reason: collision with root package name */
        public static final a f42051i = new a("EXTERNAL", 2);

        /* renamed from: o  reason: collision with root package name */
        private static final /* synthetic */ a[] f42052o;

        /* renamed from: p  reason: collision with root package name */
        private static final /* synthetic */ EnumEntries f42053p;
        ...
        private static final /* synthetic */ a[] a() {
            return new a[]{f42049d, f42050e, f42051i};
        }
    ...
    public static final class b implements DefaultLifecycleObserver {
        ...
        /* renamed from: d  reason: collision with root package name */
        final /* synthetic */ ExecutorService f42054d;

        b(ExecutorService executorService) {
            this.f42054d = executorService;
        }

        @Override // androidx.lifecycle.DefaultLifecycleObserver
        public void onDestroy(LifecycleOwner owner) {
            Intrinsics.checkNotNullParameter(owner, "owner");
            this.f42054d.shutdown();
        }
    }
    ...
    public static final class c extends kotlin.coroutines.jvm.internal.d {
        ...
        public final Object invokeSuspend(Object obj) {
            this.f42057i = obj;
            this.f42059p |= Integer.MIN_VALUE;
    ...
    public static final class d implements n0.f {
        ...
        public void d(n0.h outputFileResults) {
            ...
            Continuation continuation = this.f42060a;
            Result.a aVar = Result.f33071e;
            continuation.resumeWith(Result.b(Result.a(Result.b(this.f42061b))));
        }
    ...
    public static final void h(ListenableFuture listenableFuture, int i10, boolean z10, f.a aVar, ExecutorService executorService, PreviewView previewView, x.p pVar, t tVar, Function1 function1) {
        ...
        try {
            ...
            tVar.f42048a = new w(n10, n0Var, tVar.i(n10));
            Context context2 = previewView.getContext();
            Intrinsics.checkNotNullExpressionValue(context2, "getContext(...)");
            kp.f.i(context2).getLifecycle().a(new b(executorService));
    ...
    */
    private final nn.v i(x.i r12) {
        ...
        L42:
            ...
            r4 = 1
            if (r3 != r4) goto L4c
            nn.v$b r1 = nn.v.b.f42079e     // Catch: java.lang.IllegalArgumentException -> L90
            goto L5a
        L4c:
            if (r1 != 0) goto L4f
            goto L58
        L4f:
            ...
            if (r1 != 0) goto L58
            nn.v$b r1 = nn.v.b.f42078d     // Catch: java.lang.IllegalArgumentException -> L90
            goto L5a
        L58:
            nn.v$b r1 = nn.v.b.f42080i     // Catch: java.lang.IllegalArgumentException -> L90
        L5a:
        ...
        L6d:
            ...
            goto L6d
        L8a:
            nn.v r12 = new nn.v     // Catch: java.lang.IllegalArgumentException -> L90
        ...
        L90:
            ...
            return r4
        */
        throw new UnsupportedOperationException("Method not decompiled: nn.t.i(x.i):nn.v");
    }
    ...
    public final void f(final PreviewView previewView, a cameraDirection, final f.a aVar, final boolean z10, final Function1 onCameraError) {
        ...
        previewView.post(new Runnable() { // from class: nn.r
            @Override // java.lang.Runnable
            public final void run() {
    ...
    /*
        ...
        To view partially-correct add '--show-bad-code' argument
    */
    public final java.lang.Object j(pp.c r7, kotlin.coroutines.Continuation r8) {
        /*
            r6 = this;
            boolean r0 = r8 instanceof nn.t.c
            if (r0 == 0) goto L13
            r0 = r8
            nn.t$c r0 = (nn.t.c) r0
            int r1 = r0.f42059p
            ...
            goto L18
        L13:
            nn.t$c r0 = new nn.t$c
            r0.<init>(r8)
        L18:
            java.lang.Object r8 = r0.f42057i
            java.lang.Object r1 = pr.b.f()
            int r2 = r0.f42059p
            r3 = 1
            if (r2 == 0) goto L39
            if (r2 != r3) goto L31
            java.lang.Object r7 = r0.f42056e
            pp.c r7 = (pp.c) r7
            java.lang.Object r7 = r0.f42055d
            nn.t r7 = (nn.t) r7
            kotlin.c.b(r8)
            goto L8d
        L31:
        ...
        L39:
            ...
            hs.c1 r4 = hs.m0.c()
            hs.c1 r4 = r4.f2()
            java.util.concurrent.Executor r4 = hs.u0.a(r4)
            nn.t$d r5 = new nn.t$d
            r5.<init>(r8, r7)
            r3.x0(r2, r4, r5)
        L7d:
            java.lang.Object r8 = r8.b()
            java.lang.Object r7 = pr.b.f()
            if (r8 != r7) goto L8a
        ...
        L8d:
            ...
            return r7
        */
        throw new UnsupportedOperationException("Method not decompiled: nn.t.j(pp.c, kotlin.coroutines.Continuation):java.lang.Object");
    }
}
