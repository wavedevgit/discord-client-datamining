...
public final class b0 extends d {
    ...
    public static final a f38007f0 = new a(null);
    private float W;
    private float X;
    private float Y;
    private float Z;
    ...
    private float f38008a0;

    /* renamed from: b0  reason: collision with root package name */
    private float f38009b0;

    /* renamed from: c0  reason: collision with root package name */
    private Handler f38010c0;

    /* renamed from: d0  reason: collision with root package name */
    private int f38011d0;
    ...
    private final Runnable f38012e0 = new Runnable() { // from class: nn.a0
    ...
    public static final class b extends d.c {
        ...
        private final Class f38014b = b0.class;

        /* renamed from: c  reason: collision with root package name */
        private final String f38015c = "TapGestureHandler";
    ...
    private final void c1() {
        Handler handler = this.f38010c0;
        if (handler == null) {
            this.f38010c0 = new Handler(Looper.getMainLooper());
        } else {
            Intrinsics.checkNotNull(handler);
            handler.removeCallbacksAndMessages(null);
        }
        int i10 = this.f38011d0 + 1;
        this.f38011d0 = i10;
        if (i10 == this.T && this.V >= this.U) {
            k();
            return;
        }
        Handler handler2 = this.f38010c0;
        Intrinsics.checkNotNull(handler2);
        handler2.postDelayed(this.f38012e0, this.S);
    }
    ...
    private final boolean e1() {
        float f10 = (this.f38008a0 - this.W) + this.Y;
        if (this.O != Float.MIN_VALUE && Math.abs(f10) > this.O) {
            return true;
        }
        float f11 = (this.f38009b0 - this.X) + this.Z;
    ...
    private final void f1() {
        ...
        Handler handler2 = this.f38010c0;
        Intrinsics.checkNotNull(handler2);
        handler2.postDelayed(this.f38012e0, this.R);
    }
    ...
    protected void l0(MotionEvent event, MotionEvent sourceEvent) {
        ...
        if (J0(sourceEvent)) {
            ...
            if (actionMasked != 5 && actionMasked != 6) {
                k kVar2 = k.f38085a;
                this.f38008a0 = kVar2.b(sourceEvent, true);
                this.f38009b0 = kVar2.c(sourceEvent, true);
            } else {
                this.Y += this.f38008a0 - this.W;
                this.Z += this.f38009b0 - this.X;
                k kVar3 = k.f38085a;
                this.f38008a0 = kVar3.b(sourceEvent, true);
                float c10 = kVar3.c(sourceEvent, true);
                this.f38009b0 = c10;
                this.W = this.f38008a0;
                this.X = c10;
            }
