...
public final class p0 {
    ...
    public static final a f42007p = new a(null);

    /* renamed from: q  reason: collision with root package name */
    private static final Regex f42008q = new Regex("([ACI][A-Z0-9<]{1})([A-Z]{3})([A-Z0-9<]{9})([0-9]{1})([A-Z0-9<]{15})");

    /* renamed from: r  reason: collision with root package name */
    private static final Regex f42009r = new Regex("([0-9]{6})([0-9]{1})([MFX<]{1})([0-9]{6})([0-9]{1})([A-Z]{3})([A-Z0-9<]{11})([0-9]{1})");

    /* renamed from: s  reason: collision with root package name */
    private static final Regex f42010s = new Regex("([A-Z0-9<]{30})");

    /* renamed from: t  reason: collision with root package name */
    private static final Regex f42011t = new Regex("([ACI][A-Z0-9<]{1})([A-Z]{3})([A-Z0-9<]{31})");

    /* renamed from: u  reason: collision with root package name */
    private static final Regex f42012u = new Regex("([A-Z0-9<]{9})([0-9]{1})([A-Z]{3})([0-9]{6})([0-9]{1})([MFX<]{1})([0-9]{6})([0-9]{1})([A-Z0-9<]{7})([0-9]{1})");

    /* renamed from: v  reason: collision with root package name */
    private static final Regex f42013v = new Regex("(P[A-Z0-9<]{1})([A-Z]{3})([A-Z0-9<]+?<<+)");

    /* renamed from: w  reason: collision with root package name */
    private static final Regex f42014w = new Regex("(P[A-Z0-9<]{1})([A-Z]{3})([A-Z0-9<]+?)<<([A-Z0-9<]+<<+)");

    /* renamed from: x  reason: collision with root package name */
    private static final Regex f42015x = new Regex("([A-Z0-9<]{9})([0-9]{1})([A-Z]{3})([0-9]{6})([0-9]{1})([MFX<]{1})([0-9]{6})([0-9]{1})?([A-Z0-9<]{14})?([0-9]{1})?([0-9]{1})?");
    ...
    private final Date f42027l;

    /* renamed from: m  reason: collision with root package name */
    private final Date f42028m;

    /* renamed from: n  reason: collision with root package name */
    private final Date f42029n;
    ...
    public static final class a {
        ...
        private final p0 f(String str) {
            ...
            int i10;
            boolean z10;
            MatchResult d12 = Regex.d(p0.f42008q, str, 0, 2, null);
            if (d12 == null || (d10 = Regex.d(p0.f42009r, str, 0, 2, null)) == null || (d11 = Regex.d(p0.f42010s, StringsKt.J(StringsKt.J(str, d12.getValue(), "", false, 4, null), d10.getValue(), "", false, 4, null), 0, 2, null)) == null) {
                return null;
            }
            ...
            return new p0(CollectionsKt.x0(CollectionsKt.o(d12, d10, d11), ReactEditTextInputConnectionWrapper.NEWLINE_RAW_VALUE, null, null, 0, null, new Function1() { // from class: nn.o0
        ...
        private final p0 h(String str) {
            MatchResult d10;
            MatchResult d11 = Regex.d(p0.f42014w, str, 0, 2, null);
            if (d11 == null || (d10 = Regex.d(p0.f42015x, str, 0, 2, null)) == null) {
                return null;
            }
            return new p0(CollectionsKt.x0(CollectionsKt.o(d11, d10), ReactEditTextInputConnectionWrapper.NEWLINE_RAW_VALUE, null, null, 0, null, new Function1() { // from class: nn.n0
                @Override // kotlin.jvm.functions.Function1
    ...
    public boolean equals(Object obj) {
        ...
        p0 p0Var = (p0) obj;
        if (Intrinsics.areEqual(this.f42016a, p0Var.f42016a) && Intrinsics.areEqual(this.f42017b, p0Var.f42017b) && Intrinsics.areEqual(this.f42018c, p0Var.f42018c) && Intrinsics.areEqual(this.f42019d, p0Var.f42019d) && Intrinsics.areEqual(this.f42020e, p0Var.f42020e) && Intrinsics.areEqual(this.f42021f, p0Var.f42021f) && Intrinsics.areEqual(this.f42022g, p0Var.f42022g) && Intrinsics.areEqual(this.f42023h, p0Var.f42023h) && Intrinsics.areEqual(this.f42024i, p0Var.f42024i) && Intrinsics.areEqual(this.f42025j, p0Var.f42025j) && Intrinsics.areEqual(this.f42026k, p0Var.f42026k) && Intrinsics.areEqual(this.f42027l, p0Var.f42027l) && Intrinsics.areEqual(this.f42028m, p0Var.f42028m) && Intrinsics.areEqual(this.f42029n, p0Var.f42029n) && Intrinsics.areEqual(this.f42030o, p0Var.f42030o)) {
            return true;
        }
        return false;
    }
    ...
    public int hashCode() {
        ...
        int hashCode12;
        int hashCode13;
        int hashCode14 = this.f42016a.hashCode() * 31;
    ...
    public String toString() {
        ...
        String str5 = this.f42020e;
        String str6 = this.f42021f;
        String str7 = this.f42022g;
        String str8 = this.f42023h;
        String str9 = this.f42024i;
        String str10 = this.f42025j;
        String str11 = this.f42026k;
        Date date = this.f42027l;
        Date date2 = this.f42028m;
        Date date3 = this.f42029n;
        String str12 = this.f42030o;
