...
public abstract class d {
    ...
    private final int[] f38600a = new int[12];
    ...
    private WritableArray f38611l;

    /* renamed from: m  reason: collision with root package name */
    private WritableArray f38612m;
    ...
    private final C0537d[] f38615p;

    /* renamed from: q  reason: collision with root package name */
    private boolean f38616q;

    /* renamed from: r  reason: collision with root package name */
    private float[] f38617r;

    /* renamed from: s  reason: collision with root package name */
    private short f38618s;

    /* renamed from: t  reason: collision with root package name */
    private float f38619t;

    /* renamed from: u  reason: collision with root package name */
    private float f38620u;

    /* renamed from: v  reason: collision with root package name */
    private boolean f38621v;

    /* renamed from: w  reason: collision with root package name */
    private float f38622w;

    /* renamed from: x  reason: collision with root package name */
    private float f38623x;

    /* renamed from: y  reason: collision with root package name */
    private int f38624y;

    /* renamed from: z  reason: collision with root package name */
    private boolean f38625z;
    ...
    public static final class C0537d {
        ...
        public boolean equals(Object obj) {
            ...
            if (this.f38627a == c0537d.f38627a && Float.compare(this.f38628b, c0537d.f38628b) == 0 && Float.compare(this.f38629c, c0537d.f38629c) == 0 && Float.compare(this.f38630d, c0537d.f38630d) == 0 && Float.compare(this.f38631e, c0537d.f38631e) == 0) {
                return true;
            }
            return false;
        }
        ...
        public int hashCode() {
            return (((((((Integer.hashCode(this.f38627a) * 31) + Float.hashCode(this.f38628b)) * 31) + Float.hashCode(this.f38629c)) * 31) + Float.hashCode(this.f38630d)) * 31) + Float.hashCode(this.f38631e);
        }
        ...
        public String toString() {
            ...
            float f10 = this.f38628b;
            float f11 = this.f38629c;
            float f12 = this.f38630d;
            float f13 = this.f38631e;
    ...
    private final void A(MotionEvent motionEvent, MotionEvent motionEvent2) {
        ...
        this.f38615p[pointerId] = new C0537d(pointerId, motionEvent.getX(motionEvent.getActionIndex()), motionEvent.getY(motionEvent.getActionIndex()), (motionEvent2.getX(motionEvent.getActionIndex()) + (motionEvent2.getRawX() - motionEvent2.getX())) - this.f38602c[0], (motionEvent2.getY(motionEvent.getActionIndex()) + (motionEvent2.getRawY() - motionEvent2.getY())) - this.f38602c[1]);
        C0537d c0537d = this.f38615p[pointerId];
        Intrinsics.checkNotNull(c0537d);
        n(c0537d);
        this.f38615p[pointerId] = null;
        this.f38614o--;
        y();
    }
    ...
    private final void C() {
        C0537d[] c0537dArr;
        this.f38612m = null;
        for (C0537d c0537d : this.f38615p) {
            if (c0537d != null) {
                o(c0537d);
            }
        }
    ...
    private final void h0(int i10) {
        ...
        if (this.f38614o > 0 && (i10 == 5 || i10 == 3 || i10 == 1)) {
            r();
        }
    ...
    private final boolean i0(MotionEvent motionEvent) {
        if (motionEvent.getPointerCount() != this.f38601b) {
            return true;
        }
        int length = this.f38600a.length;
        for (int i10 = 0; i10 < length; i10++) {
            int i11 = this.f38600a[i10];
            if (i11 != -1 && i11 != i10) {
                return true;
            }
        }
    ...
    */
    ...
    private final void n(C0537d c0537d) {
        if (this.f38611l == null) {
            this.f38611l = Arguments.createArray();
        }
        WritableArray writableArray = this.f38611l;
    ...
    private final void o(C0537d c0537d) {
        if (this.f38612m == null) {
            this.f38612m = Arguments.createArray();
        }
        WritableArray writableArray = this.f38612m;
        Intrinsics.checkNotNull(writableArray);
        writableArray.pushMap(u(c0537d));
    }
    ...
    private final void r() {
        ...
        this.f38614o = 0;
        kotlin.collections.i.z(this.f38615p, null, 0, 0, 6, null);
        y();
    }
    ...
    public final void y0(boolean z10) {
        if (this.f38604e != null && this.f38609j != z10) {
    ...
    private final void z(MotionEvent motionEvent, MotionEvent motionEvent2) {
        ...
        for (int i11 = 0; i11 < pointerCount; i11++) {
            C0537d c0537d = this.f38615p[motionEvent.getPointerId(i11)];
            if (c0537d != null && (c0537d.d() != motionEvent.getX(i11) || c0537d.e() != motionEvent.getY(i11))) {
                ...
                c0537d.f((motionEvent2.getX(i11) + rawX) - this.f38602c[0]);
                c0537d.g((motionEvent2.getY(i11) + rawY) - this.f38602c[1]);
                n(c0537d);
                i10++;
            }
        }
    ...
    public final float J() {
        return (this.f38619t + this.f38622w) - this.f38602c[0];
    }
    ...
    public final float K() {
        return (this.f38620u + this.f38623x) - this.f38602c[1];
    }
    ...
    public final PointF Q0(PointF point) {
        ...
        i iVar = this.A;
        if (iVar != null && (L2 = iVar.L(this.f38604e, point)) != null) {
            return L2;
        }
        point.x = Float.NaN;
        point.y = Float.NaN;
    ...
    public final boolean S0(MotionEvent event) {
        int i10;
        Intrinsics.checkNotNullParameter(event, "event");
        if (this.f38609j && (i10 = this.f38605f) != 1 && i10 != 3 && i10 != 5 && e0(event.getPointerId(event.getActionIndex()))) {
            return true;
        }
        return false;
    }
    ...
    public final void X(MotionEvent transformedEvent, MotionEvent sourceEvent) {
        ...
        Intrinsics.checkNotNullParameter(sourceEvent, "sourceEvent");
        if (this.f38609j && (i10 = this.f38605f) != 3 && i10 != 1 && i10 != 5 && this.f38601b >= 1) {
            try {
                ...
                this.f38606g = motionEvent.getX();
                this.f38607h = motionEvent.getY();
                this.f38624y = motionEvent.getPointerCount();
                boolean g02 = g0(this.f38604e, this.f38606g, this.f38607h);
                this.f38608i = g02;
                if (this.f38625z && !g02) {
                    int i11 = this.f38605f;
                    if (i11 == 4) {
                ...
                k kVar = k.f38653a;
                this.f38619t = kVar.b(motionEvent, true);
                this.f38620u = kVar.c(motionEvent, true);
                this.f38622w = motionEvent.getRawX() - motionEvent.getX();
                this.f38623x = motionEvent.getRawY() - motionEvent.getY();
    ...
    public final boolean Y(d other) {
        ...
        int length = this.f38600a.length;
        for (int i10 = 0; i10 < length; i10++) {
            if (this.f38600a[i10] != -1 && other.f38600a[i10] != -1) {
                return true;
            }
        }
        return false;
    ...
    */
    public final boolean c0(nn.d r4) {
        /*
            ...
            android.view.View r0 = r3.f38604e
            r1 = 0
            if (r0 == 0) goto Lf
        ...
        L18:
            if (r0 == 0) goto L2f
            android.view.View r2 = r4.f38604e
    ...
    public final void q0(View view, i iVar) {
        Context context;
        if (this.f38604e == null && this.A == null) {
            Arrays.fill(this.f38600a, -1);
            this.f38601b = 0;
            this.f38605f = 0;
            this.f38604e = view;
            this.A = iVar;
            ...
            if (view2 != null) {
                view2.getLocationOnScreen(this.f38602c);
            } else {
                int[] iArr = this.f38602c;
                iArr[0] = 0;
                iArr[1] = 0;
            }
            n0();
    ...
    public void y() {
        r rVar;
        if (this.f38611l != null && (rVar = this.B) != null) {
            rVar.b(this);
        }
    }
    ...
    public final void z0(float f10, float f11, float f12, float f13, float f14, float f15) {
        if (this.f38617r == null) {
            this.f38617r = new float[6];
        }
        float[] fArr = this.f38617r;
        Intrinsics.checkNotNull(fArr);
        fArr[0] = f10;
        float[] fArr2 = this.f38617r;
        Intrinsics.checkNotNull(fArr2);
        fArr2[1] = f11;
        float[] fArr3 = this.f38617r;
        Intrinsics.checkNotNull(fArr3);
        fArr3[2] = f12;
        float[] fArr4 = this.f38617r;
        Intrinsics.checkNotNull(fArr4);
        fArr4[3] = f13;
        float[] fArr5 = this.f38617r;
        Intrinsics.checkNotNull(fArr5);
        fArr5[4] = f14;
        float[] fArr6 = this.f38617r;
