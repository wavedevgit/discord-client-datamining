...
public final class d implements a {
    ...
    private static final String f28357c;

    /* renamed from: d  reason: collision with root package name */
    private static final ArrayList f28358d;

    static {
        String simpleName = d.class.getSimpleName();
        Intrinsics.checkNotNullExpressionValue(simpleName, "WindowMetricsCalculatorC…at::class.java.simpleName");
        f28357c = simpleName;
        f28358d = CollectionsKt.g(Integer.valueOf(WindowInsetsCompat.p.g()), Integer.valueOf(WindowInsetsCompat.p.f()), Integer.valueOf(WindowInsetsCompat.p.a()), Integer.valueOf(WindowInsetsCompat.p.c()), Integer.valueOf(WindowInsetsCompat.p.i()), Integer.valueOf(WindowInsetsCompat.p.e()), Integer.valueOf(WindowInsetsCompat.p.j()), Integer.valueOf(WindowInsetsCompat.p.b()));
    }
