...
public final class d implements a {
    ...
    private static final String f26669c;

    /* renamed from: d  reason: collision with root package name */
    private static final ArrayList f26670d;

    static {
        String simpleName = d.class.getSimpleName();
        Intrinsics.checkNotNullExpressionValue(simpleName, "WindowMetricsCalculatorC…at::class.java.simpleName");
        f26669c = simpleName;
        f26670d = CollectionsKt.g(Integer.valueOf(WindowInsetsCompat.p.g()), Integer.valueOf(WindowInsetsCompat.p.f()), Integer.valueOf(WindowInsetsCompat.p.a()), Integer.valueOf(WindowInsetsCompat.p.c()), Integer.valueOf(WindowInsetsCompat.p.i()), Integer.valueOf(WindowInsetsCompat.p.e()), Integer.valueOf(WindowInsetsCompat.p.j()), Integer.valueOf(WindowInsetsCompat.p.b()));
    }
