...
public final class d implements a {
    ...
    public static final d f27787b = new d();

    /* renamed from: c  reason: collision with root package name */
    private static final String f27788c;

    /* renamed from: d  reason: collision with root package name */
    private static final ArrayList f27789d;

    static {
        String simpleName = d.class.getSimpleName();
        Intrinsics.checkNotNullExpressionValue(simpleName, "WindowMetricsCalculatorC…at::class.java.simpleName");
        f27788c = simpleName;
        f27789d = CollectionsKt.g(Integer.valueOf(WindowInsetsCompat.p.g()), Integer.valueOf(WindowInsetsCompat.p.f()), Integer.valueOf(WindowInsetsCompat.p.a()), Integer.valueOf(WindowInsetsCompat.p.c()), Integer.valueOf(WindowInsetsCompat.p.i()), Integer.valueOf(WindowInsetsCompat.p.e()), Integer.valueOf(WindowInsetsCompat.p.j()), Integer.valueOf(WindowInsetsCompat.p.b()));
    }
