...
public abstract class d {
    ...
    private static final ByteString f50423a;

    /* renamed from: b  reason: collision with root package name */
    private static final ByteString f50424b;

    /* renamed from: c  reason: collision with root package name */
    private static final ByteString f50425c;

    /* renamed from: d  reason: collision with root package name */
    private static final ByteString f50426d;

    /* renamed from: e  reason: collision with root package name */
    private static final ByteString f50427e;
    ...
    public static final int l(c0 c0Var) {
        int y10 = ByteString.y(c0Var.d(), f50423a, 0, 2, null);
        if (y10 != -1) {
            return y10;
        }
        return ByteString.y(c0Var.d(), f50424b, 0, 2, null);
    }

    /* JADX INFO: Access modifiers changed from: private */
    public static final ByteString m(c0 c0Var) {
        ByteString d10 = c0Var.d();
        ByteString byteString = f50423a;
        if (ByteString.t(d10, byteString, 0, 2, null) != -1) {
            return byteString;
        }
        ByteString d11 = c0Var.d();
        ByteString byteString2 = f50424b;
    ...
    public static final boolean n(c0 c0Var) {
        if (!c0Var.d().i(f50427e) || (c0Var.d().G() != 2 && !c0Var.d().A(c0Var.d().G() - 3, f50423a, 0, 1) && !c0Var.d().A(c0Var.d().G() - 3, f50424b, 0, 1))) {
            return false;
        }
        return true;
    }
    ...
    private static final boolean p(Buffer buffer, ByteString byteString) {
        if (!Intrinsics.areEqual(byteString, f50424b) || buffer.size() < 2 || buffer.Z(1L) != 58) {
            return false;
        }
    ...
    public static final c0 q(Buffer buffer, boolean z10) {
        ...
        if (z11) {
            ...
            long g02 = buffer.g0(f50425c);
            if (byteString2 == null) {
                if (g02 == -1) {
                    byteString2 = s(c0.f49355i);
                } else {
        ...
        while (!buffer.k1()) {
            ...
            ByteString byteString3 = f50427e;
            if (Intrinsics.areEqual(c12, byteString3)) {
            ...
            } else if (!Intrinsics.areEqual(c12, f50426d) && !Intrinsics.areEqual(c12, ByteString.f42342p)) {
                arrayList.add(c12);
            }
        }
