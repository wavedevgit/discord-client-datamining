...
public class ComponentDialog extends Dialog implements LifecycleOwner, z, u3.f {
    ...
    private LifecycleRegistry f943d;

    /* renamed from: e  reason: collision with root package name */
    private final SavedStateRegistryController f944e;

    /* renamed from: i  reason: collision with root package name */
    private final OnBackPressedDispatcher f945i;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public ComponentDialog(Context context, int i10) {
        super(context, i10);
        Intrinsics.checkNotNullParameter(context, "context");
        this.f944e = SavedStateRegistryController.f5208c.b(this);
        this.f945i = new OnBackPressedDispatcher(new Runnable() { // from class: androidx.activity.m
    ...
    private final LifecycleRegistry b() {
        LifecycleRegistry lifecycleRegistry = this.f943d;
        if (lifecycleRegistry == null) {
            LifecycleRegistry lifecycleRegistry2 = new LifecycleRegistry(this);
            this.f943d = lifecycleRegistry2;
    ...
    public void onCreate(Bundle bundle) {
        ...
        if (Build.VERSION.SDK_INT >= 33) {
            OnBackPressedDispatcher onBackPressedDispatcher = this.f945i;
    ...
    public Bundle onSaveInstanceState() {
        ...
        this.f944e.e(onSaveInstanceState);
