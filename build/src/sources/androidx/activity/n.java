...
public abstract class n {
    ...
    private static final int f858a = Color.argb(230, (int) SetSpanOperation.SPAN_MAX_PRIORITY, (int) SetSpanOperation.SPAN_MAX_PRIORITY, (int) SetSpanOperation.SPAN_MAX_PRIORITY);

    /* renamed from: b  reason: collision with root package name */
    private static final int f859b = Color.argb((int) IntBufferBatchMountItem.INSTRUCTION_UPDATE_LAYOUT, 27, 27, 27);

    /* renamed from: c  reason: collision with root package name */
    private static v f860c;
    ...
    public static /* synthetic */ void b(ComponentActivity componentActivity, b0 b0Var, b0 b0Var2, int i10, Object obj) {
        if ((i10 & 1) != 0) {
            b0Var = b0.a.b(b0.f831e, 0, 0, null, 4, null);
        }
        if ((i10 & 2) != 0) {
            b0Var2 = b0.a.b(b0.f831e, f858a, f859b, null, 4, null);
        }
