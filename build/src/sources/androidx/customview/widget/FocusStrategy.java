...
abstract class FocusStrategy {
    ...
    private static class a implements Comparator {
        ...
        private final Rect f3677d = new Rect();

        /* renamed from: e  reason: collision with root package name */
        private final Rect f3678e = new Rect();

        /* renamed from: i  reason: collision with root package name */
        private final boolean f3679i;

        /* renamed from: o  reason: collision with root package name */
        private final BoundsAdapter f3680o;

        a(boolean z10, BoundsAdapter boundsAdapter) {
            this.f3679i = z10;
            this.f3680o = boundsAdapter;
        }

        @Override // java.util.Comparator
        public int compare(Object obj, Object obj2) {
            Rect rect = this.f3677d;
            Rect rect2 = this.f3678e;
            this.f3680o.a(obj, rect);
            this.f3680o.a(obj2, rect2);
            int i10 = rect.top;
            int i11 = rect2.top;
            if (i10 < i11) {
                return -1;
