...
abstract class FocusStrategy {
    ...
    private static class a implements Comparator {
        ...
        private final Rect f3683d = new Rect();

        /* renamed from: e  reason: collision with root package name */
        private final Rect f3684e = new Rect();

        /* renamed from: i  reason: collision with root package name */
        private final boolean f3685i;

        /* renamed from: o  reason: collision with root package name */
        private final BoundsAdapter f3686o;

        a(boolean z10, BoundsAdapter boundsAdapter) {
            this.f3685i = z10;
            this.f3686o = boundsAdapter;
        }

        @Override // java.util.Comparator
        public int compare(Object obj, Object obj2) {
            Rect rect = this.f3683d;
            Rect rect2 = this.f3684e;
            this.f3686o.a(obj, rect);
            this.f3686o.a(obj2, rect2);
            int i10 = rect.top;
            int i11 = rect2.top;
            if (i10 < i11) {
                return -1;
