...
public class l extends ComponentDialog implements b {
    ...
    private AppCompatDelegate f1210o;

    /* renamed from: p  reason: collision with root package name */
    private final k.a f1211p;

    public l(Context context, int i10) {
        super(context, g(context, i10));
        this.f1211p = new k.a() { // from class: androidx.appcompat.app.k
    ...
    private static int g(Context context, int i10) {
        if (i10 == 0) {
            ...
            context.getTheme().resolveAttribute(f.a.f22176x, typedValue, true);
    ...
    public boolean dispatchKeyEvent(KeyEvent keyEvent) {
        return androidx.core.view.k.e(this.f1211p, getWindow().getDecorView(), this, keyEvent);
    }

    public AppCompatDelegate f() {
        if (this.f1210o == null) {
            this.f1210o = AppCompatDelegate.k(this, this);
        }
        return this.f1210o;
    }
