...
public class g extends CheckedTextView {
    ...
    private final AppCompatBackgroundHelper f1655e;

    /* renamed from: i  reason: collision with root package name */
    private final AppCompatTextHelper f1656i;

    /* renamed from: o  reason: collision with root package name */
    private AppCompatEmojiTextHelper f1657o;

    public g(Context context, AttributeSet attributeSet) {
        this(context, attributeSet, f.a.f24084p);
    }

    @NonNull
    private AppCompatEmojiTextHelper getEmojiTextViewHelper() {
        if (this.f1657o == null) {
            this.f1657o = new AppCompatEmojiTextHelper(this);
        }
        return this.f1657o;
    }
    ...
    protected void drawableStateChanged() {
        ...
        AppCompatTextHelper appCompatTextHelper = this.f1656i;
        if (appCompatTextHelper != null) {
            appCompatTextHelper.b();
        }
        AppCompatBackgroundHelper appCompatBackgroundHelper = this.f1655e;
    ...
    public ColorStateList getSupportCompoundDrawablesTintList() {
        return this.f1656i.j();
    }

    public PorterDuff.Mode getSupportCompoundDrawablesTintMode() {
        return this.f1656i.k();
    }
    ...
    public g(Context context, AttributeSet attributeSet, int i10) {
        ...
        this.f1656i = appCompatTextHelper;
        appCompatTextHelper.m(attributeSet, i10);
        appCompatTextHelper.b();
        AppCompatBackgroundHelper appCompatBackgroundHelper = new AppCompatBackgroundHelper(this);
        this.f1655e = appCompatBackgroundHelper;
