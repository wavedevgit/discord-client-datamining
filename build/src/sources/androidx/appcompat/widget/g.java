...
public class g extends CheckedTextView {
    ...
    private final AppCompatBackgroundHelper f1806e;

    /* renamed from: i  reason: collision with root package name */
    private final AppCompatTextHelper f1807i;

    /* renamed from: o  reason: collision with root package name */
    private AppCompatEmojiTextHelper f1808o;

    public g(Context context, AttributeSet attributeSet) {
        this(context, attributeSet, f.a.f22168p);
    }

    @NonNull
    private AppCompatEmojiTextHelper getEmojiTextViewHelper() {
        if (this.f1808o == null) {
            this.f1808o = new AppCompatEmojiTextHelper(this);
        }
        return this.f1808o;
    }
    ...
    protected void drawableStateChanged() {
        ...
        AppCompatTextHelper appCompatTextHelper = this.f1807i;
        if (appCompatTextHelper != null) {
            appCompatTextHelper.b();
        }
        AppCompatBackgroundHelper appCompatBackgroundHelper = this.f1806e;
    ...
    public g(Context context, AttributeSet attributeSet, int i10) {
        ...
        this.f1807i = appCompatTextHelper;
        appCompatTextHelper.m(attributeSet, i10);
        appCompatTextHelper.b();
        AppCompatBackgroundHelper appCompatBackgroundHelper = new AppCompatBackgroundHelper(this);
        this.f1806e = appCompatBackgroundHelper;
