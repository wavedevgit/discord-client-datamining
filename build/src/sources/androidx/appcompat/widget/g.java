...
public class g extends CheckedTextView {
    ...
    private final AppCompatBackgroundHelper f1809e;

    /* renamed from: i  reason: collision with root package name */
    private final AppCompatTextHelper f1810i;
    ...
    private AppCompatEmojiTextHelper getEmojiTextViewHelper() {
        if (this.f1811o == null) {
            this.f1811o = new AppCompatEmojiTextHelper(this);
        }
        return this.f1811o;
    }
    ...
    protected void drawableStateChanged() {
        ...
        AppCompatTextHelper appCompatTextHelper = this.f1810i;
        if (appCompatTextHelper != null) {
            appCompatTextHelper.b();
        }
        AppCompatBackgroundHelper appCompatBackgroundHelper = this.f1809e;
    ...
    public ColorStateList getSupportCompoundDrawablesTintList() {
        return this.f1810i.j();
    }

    public PorterDuff.Mode getSupportCompoundDrawablesTintMode() {
        return this.f1810i.k();
    }
    ...
    public g(Context context, AttributeSet attributeSet, int i10) {
        ...
        this.f1810i = appCompatTextHelper;
        appCompatTextHelper.m(attributeSet, i10);
        appCompatTextHelper.b();
        AppCompatBackgroundHelper appCompatBackgroundHelper = new AppCompatBackgroundHelper(this);
        this.f1809e = appCompatBackgroundHelper;
