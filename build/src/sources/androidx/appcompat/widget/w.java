...
public class w {
    ...
    private static final RectF f1984l = new RectF();

    /* renamed from: m  reason: collision with root package name */
    private static ConcurrentHashMap f1985m = new ConcurrentHashMap();
    ...
    private float f1988c = -1.0f;

    /* renamed from: d  reason: collision with root package name */
    private float f1989d = -1.0f;

    /* renamed from: e  reason: collision with root package name */
    private float f1990e = -1.0f;

    /* renamed from: f  reason: collision with root package name */
    private int[] f1991f = new int[0];
    ...
    private final TextView f1994i;

    /* renamed from: j  reason: collision with root package name */
    private final Context f1995j;

    /* renamed from: k  reason: collision with root package name */
    private final d f1996k;
    ...
    public w(TextView textView) {
        this.f1994i = textView;
        this.f1995j = textView.getContext();
    ...
    private void c() {
        ...
        this.f1990e = -1.0f;
        this.f1988c = -1.0f;
        this.f1991f = new int[0];
        this.f1987b = false;
    }

    private int e(RectF rectF) {
        int length = this.f1991f.length;
        if (length != 0) {
            int i10 = 1;
            int i11 = length - 1;
            int i12 = 0;
    ...
    private static Method k(String str) {
        try {
            Method method = (Method) f1985m.get(str);
            if (method == null && (method = TextView.class.getDeclaredMethod(str, null)) != null) {
                method.setAccessible(true);
                f1985m.put(str, method);
                return method;
            }
            return method;
        } catch (Exception e10) {
    ...
    private void s(float f10) {
        if (f10 != this.f1994i.getPaint().getTextSize()) {
            this.f1994i.getPaint().setTextSize(f10);
            boolean isInLayout = this.f1994i.isInLayout();
            if (this.f1994i.getLayout() != null) {
                this.f1987b = false;
                try {
                    Method k10 = k("nullLayouts");
                    if (k10 != null) {
                        k10.invoke(this.f1994i, null);
                    }
                } catch (Exception e10) {
                    Log.w("ACTVAutoSizeHelper", "Failed to invoke TextView#nullLayouts() method", e10);
                }
                if (!isInLayout) {
                    this.f1994i.requestLayout();
                } else {
                    this.f1994i.forceLayout();
                }
                this.f1994i.invalidate();
            }
        }
    }
    ...
    private boolean u() {
        if (y() && this.f1986a == 1) {
            if (!this.f1992g || this.f1991f.length == 0) {
                int floor = ((int) Math.floor((this.f1990e - this.f1989d) / this.f1988c)) + 1;
                int[] iArr = new int[floor];
                for (int i10 = 0; i10 < floor; i10++) {
                    iArr[i10] = Math.round(this.f1989d + (i10 * this.f1988c));
                }
                this.f1991f = b(iArr);
            }
            this.f1987b = true;
    ...
    private boolean x(int i10, RectF rectF) {
        ...
        CharSequence text = this.f1994i.getText();
        TransformationMethod transformationMethod = this.f1994i.getTransformationMethod();
        if (transformationMethod != null && (transformation = transformationMethod.getTransformation(text, this.f1994i)) != null) {
            text = transformation;
        }
        int maxLines = this.f1994i.getMaxLines();
        l(i10);
        StaticLayout d10 = d(text, (Layout.Alignment) m(this.f1994i, "getLayoutAlignment", Layout.Alignment.ALIGN_NORMAL), Math.round(rectF.right), maxLines);
    ...
    private boolean y() {
        return !(this.f1994i instanceof AppCompatEditText);
    }
    ...
    public void a() {
        ...
        if (n()) {
            if (this.f1987b) {
                if (this.f1994i.getMeasuredHeight() > 0 && this.f1994i.getMeasuredWidth() > 0) {
                    if (this.f1996k.b(this.f1994i)) {
                        measuredWidth = 1048576;
                    } else {
                        measuredWidth = (this.f1994i.getMeasuredWidth() - this.f1994i.getTotalPaddingLeft()) - this.f1994i.getTotalPaddingRight();
                    }
                    int height = (this.f1994i.getHeight() - this.f1994i.getCompoundPaddingBottom()) - this.f1994i.getCompoundPaddingTop();
                    if (measuredWidth > 0 && height > 0) {
                        ...
                        synchronized (rectF) {
                            try {
                                ...
                                rectF.bottom = height;
                                float e10 = e(rectF);
                                if (e10 != this.f1994i.getTextSize()) {
                                    t(0, e10);
                                }
                            } finally {
                            }
    ...
    StaticLayout d(CharSequence charSequence, Layout.Alignment alignment, int i10, int i11) {
        return a.a(charSequence, alignment, i10, i11, this.f1994i, this.f1993h, this.f1996k);
    }

    /* JADX INFO: Access modifiers changed from: package-private */
    public int f() {
        return Math.round(this.f1990e);
    }

    /* JADX INFO: Access modifiers changed from: package-private */
    public int g() {
        return Math.round(this.f1989d);
    }

    /* JADX INFO: Access modifiers changed from: package-private */
    public int h() {
        return Math.round(this.f1988c);
    }
    ...
    void l(int i10) {
        TextPaint textPaint = this.f1993h;
        if (textPaint == null) {
            this.f1993h = new TextPaint();
        } else {
            textPaint.reset();
        }
        this.f1993h.set(this.f1994i.getPaint());
        this.f1993h.setTextSize(i10);
    }
    ...
    public void o(AttributeSet attributeSet, int i10) {
        ...
        if (y()) {
            if (this.f1986a == 1) {
                if (!this.f1992g) {
                    DisplayMetrics displayMetrics = this.f1995j.getResources().getDisplayMetrics();
                    if (f11 == -1.0f) {
