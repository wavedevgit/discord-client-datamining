...
public class n extends MultiAutoCompleteTextView {
    ...
    private static final int[] f1899o = {16843126};

    /* renamed from: d  reason: collision with root package name */
    private final AppCompatBackgroundHelper f1900d;

    /* renamed from: e  reason: collision with root package name */
    private final AppCompatTextHelper f1901e;
    ...
    protected void drawableStateChanged() {
        ...
        AppCompatBackgroundHelper appCompatBackgroundHelper = this.f1900d;
        if (appCompatBackgroundHelper != null) {
            appCompatBackgroundHelper.b();
        }
        AppCompatTextHelper appCompatTextHelper = this.f1901e;
    ...
    public ColorStateList getSupportCompoundDrawablesTintList() {
        return this.f1901e.j();
    }

    public PorterDuff.Mode getSupportCompoundDrawablesTintMode() {
        return this.f1901e.k();
    }

    @Override // android.widget.TextView, android.view.View
    public InputConnection onCreateInputConnection(EditorInfo editorInfo) {
        return this.f1902i.e(k.a(super.onCreateInputConnection(editorInfo), editorInfo, this), editorInfo);
    }
    ...
    public void setKeyListener(KeyListener keyListener) {
        super.setKeyListener(this.f1902i.a(keyListener));
    }
    ...
    public n(Context context, AttributeSet attributeSet, int i10) {
        ...
        v0 v10 = v0.v(getContext(), attributeSet, f1899o, i10, 0);
        if (v10.s(0)) {
            setDropDownBackgroundDrawable(v10.g(0));
        }
        v10.x();
        AppCompatBackgroundHelper appCompatBackgroundHelper = new AppCompatBackgroundHelper(this);
        this.f1900d = appCompatBackgroundHelper;
        appCompatBackgroundHelper.e(attributeSet, i10);
        AppCompatTextHelper appCompatTextHelper = new AppCompatTextHelper(this);
        this.f1901e = appCompatTextHelper;
        appCompatTextHelper.m(attributeSet, i10);
        appCompatTextHelper.b();
        AppCompatEmojiEditTextHelper appCompatEmojiEditTextHelper = new AppCompatEmojiEditTextHelper(this);
        this.f1902i = appCompatEmojiEditTextHelper;
