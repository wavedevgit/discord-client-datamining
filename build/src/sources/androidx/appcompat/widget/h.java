...
class h {
    ...
    private final CheckedTextView f2115a;
    ...
    public h(CheckedTextView checkedTextView) {
        this.f2115a = checkedTextView;
    }

    /* JADX INFO: Access modifiers changed from: package-private */
    public void a() {
        Drawable a10 = androidx.core.widget.c.a(this.f2115a);
        if (a10 != null) {
            if (this.f2118d || this.f2119e) {
                Drawable mutate = s1.a.r(a10).mutate();
                if (this.f2118d) {
                    s1.a.o(mutate, this.f2116b);
                }
                if (this.f2119e) {
                    s1.a.p(mutate, this.f2117c);
                }
                if (mutate.isStateful()) {
                    mutate.setState(this.f2115a.getDrawableState());
                }
                this.f2115a.setCheckMarkDrawable(mutate);
            }
        }
    }
    ...
    */
    public void d(android.util.AttributeSet r11, int r12) {
        /*
            r10 = this;
            android.widget.CheckedTextView r0 = r10.f2115a
            android.content.Context r0 = r0.getContext()
            int[] r1 = f.j.P0
            r2 = 0
            androidx.appcompat.widget.v0 r1 = androidx.appcompat.widget.v0.v(r0, r11, r1, r12, r2)
            android.widget.CheckedTextView r3 = r10.f2115a
            ...
            if (r11 == 0) goto L40
            android.widget.CheckedTextView r12 = r10.f2115a     // Catch: java.lang.Throwable -> L3d android.content.res.Resources.NotFoundException -> L40
        ...
        L40:
            ...
            int r11 = r1.n(r11, r2)     // Catch: java.lang.Throwable -> L3d
            if (r11 == 0) goto L5d
            android.widget.CheckedTextView r12 = r10.f2115a     // Catch: java.lang.Throwable -> L3d
        ...
        L5d:
            ...
            boolean r11 = r1.s(r11)     // Catch: java.lang.Throwable -> L3d
            if (r11 == 0) goto L70
            android.widget.CheckedTextView r11 = r10.f2115a     // Catch: java.lang.Throwable -> L3d
