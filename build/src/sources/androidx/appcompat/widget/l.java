...
public class l extends ImageButton {
    ...
    private final AppCompatBackgroundHelper f1730d;

    /* renamed from: e  reason: collision with root package name */
    private final AppCompatImageHelper f1731e;
    ...
    protected void drawableStateChanged() {
        ...
        AppCompatBackgroundHelper appCompatBackgroundHelper = this.f1730d;
        if (appCompatBackgroundHelper != null) {
            appCompatBackgroundHelper.b();
        }
        AppCompatImageHelper appCompatImageHelper = this.f1731e;
    ...
    public boolean hasOverlappingRendering() {
        if (this.f1731e.f() && super.hasOverlappingRendering()) {
            return true;
        }
        return false;
    }
    ...
    public void setImageDrawable(Drawable drawable) {
        AppCompatImageHelper appCompatImageHelper = this.f1731e;
        if (appCompatImageHelper != null && drawable != null && !this.f1732i) {
            appCompatImageHelper.h(drawable);
        }
        super.setImageDrawable(drawable);
        AppCompatImageHelper appCompatImageHelper2 = this.f1731e;
    ...
    public l(Context context, AttributeSet attributeSet, int i10) {
        ...
        this.f1730d = appCompatBackgroundHelper;
        appCompatBackgroundHelper.e(attributeSet, i10);
        AppCompatImageHelper appCompatImageHelper = new AppCompatImageHelper(this);
        this.f1731e = appCompatImageHelper;
