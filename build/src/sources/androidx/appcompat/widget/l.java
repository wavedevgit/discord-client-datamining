...
public class l extends ImageButton {
    ...
    private final AppCompatBackgroundHelper f1884d;

    /* renamed from: e  reason: collision with root package name */
    private final AppCompatImageHelper f1885e;
    ...
    protected void drawableStateChanged() {
        ...
        AppCompatBackgroundHelper appCompatBackgroundHelper = this.f1884d;
        if (appCompatBackgroundHelper != null) {
            appCompatBackgroundHelper.b();
        }
        AppCompatImageHelper appCompatImageHelper = this.f1885e;
    ...
    public boolean hasOverlappingRendering() {
        if (this.f1885e.f() && super.hasOverlappingRendering()) {
            return true;
        }
        return false;
    }
    ...
    public void setImageDrawable(Drawable drawable) {
        AppCompatImageHelper appCompatImageHelper = this.f1885e;
        if (appCompatImageHelper != null && drawable != null && !this.f1886i) {
            appCompatImageHelper.h(drawable);
        }
        super.setImageDrawable(drawable);
        AppCompatImageHelper appCompatImageHelper2 = this.f1885e;
    ...
    public l(Context context, AttributeSet attributeSet, int i10) {
        ...
        this.f1884d = appCompatBackgroundHelper;
        appCompatBackgroundHelper.e(attributeSet, i10);
        AppCompatImageHelper appCompatImageHelper = new AppCompatImageHelper(this);
        this.f1885e = appCompatImageHelper;
