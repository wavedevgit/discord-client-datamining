...
public abstract class h0 implements View.OnTouchListener, View.OnAttachStateChangeListener {
    ...
    private final int[] f1829t = new int[2];
    ...
    public class a implements Runnable {
        ...
        public void run() {
            ViewParent parent = h0.this.f1824o.getParent();
            if (parent != null) {
    ...
    public h0(View view) {
        ...
        this.f1821d = ViewConfiguration.get(view.getContext()).getScaledTouchSlop();
        int tapTimeout = ViewConfiguration.getTapTimeout();
        this.f1822e = tapTimeout;
        this.f1823i = (tapTimeout + ViewConfiguration.getLongPressTimeout()) / 2;
    }

    private void a() {
        Runnable runnable = this.f1826q;
        if (runnable != null) {
            this.f1824o.removeCallbacks(runnable);
        }
        Runnable runnable2 = this.f1825p;
        if (runnable2 != null) {
            this.f1824o.removeCallbacks(runnable2);
        }
    }
    ...
    */
    private boolean g(android.view.MotionEvent r6) {
        /*
            r5 = this;
            android.view.View r0 = r5.f1824o
        ...
        L41:
            ...
            r5.f1828s = r6
            java.lang.Runnable r6 = r5.f1825p
            if (r6 != 0) goto L52
        ...
        L52:
            ...
            java.lang.Runnable r6 = r5.f1826q
            if (r6 != 0) goto L65
    ...
    public boolean onTouch(View view, MotionEvent motionEvent) {
        ...
        if (z11) {
            ...
            if (z10) {
                long uptimeMillis = SystemClock.uptimeMillis();
                MotionEvent obtain = MotionEvent.obtain(uptimeMillis, uptimeMillis, 3, 0.0f, 0.0f, 0);
                this.f1824o.onTouchEvent(obtain);
                obtain.recycle();
            }
        }
        this.f1827r = z10;
