...
public abstract class h0 implements View.OnTouchListener, View.OnAttachStateChangeListener {
    ...
    private Runnable f1822p;

    /* renamed from: q  reason: collision with root package name */
    private Runnable f1823q;
    ...
    private final int[] f1826t = new int[2];
    ...
    public class a implements Runnable {
        ...
        public void run() {
            ViewParent parent = h0.this.f1821o.getParent();
            if (parent != null) {
    ...
    public h0(View view) {
        ...
        this.f1818d = ViewConfiguration.get(view.getContext()).getScaledTouchSlop();
        int tapTimeout = ViewConfiguration.getTapTimeout();
        this.f1819e = tapTimeout;
        this.f1820i = (tapTimeout + ViewConfiguration.getLongPressTimeout()) / 2;
    }

    private void a() {
        Runnable runnable = this.f1823q;
        if (runnable != null) {
            this.f1821o.removeCallbacks(runnable);
        }
        Runnable runnable2 = this.f1822p;
        if (runnable2 != null) {
            this.f1821o.removeCallbacks(runnable2);
        }
    }
    ...
    private boolean f(MotionEvent motionEvent) {
        ...
        if (b10 != null && b10.isShowing() && (f0Var = (f0) b10.n()) != null && f0Var.isShown()) {
            ...
            boolean e10 = f0Var.e(obtainNoHistory, this.f1825s);
    ...
    */
    private boolean g(android.view.MotionEvent r6) {
        /*
            r5 = this;
            android.view.View r0 = r5.f1821o
        ...
        L41:
            ...
            r5.f1825s = r6
            java.lang.Runnable r6 = r5.f1822p
            if (r6 != 0) goto L52
        ...
        L52:
            ...
            java.lang.Runnable r6 = r5.f1823q
            if (r6 != 0) goto L65
    ...
    public boolean onTouch(View view, MotionEvent motionEvent) {
        ...
        if (z11) {
            ...
            if (z10) {
                long uptimeMillis = SystemClock.uptimeMillis();
                MotionEvent obtain = MotionEvent.obtain(uptimeMillis, uptimeMillis, 3, 0.0f, 0.0f, 0);
                this.f1821o.onTouchEvent(obtain);
                obtain.recycle();
            }
        }
        this.f1824r = z10;
