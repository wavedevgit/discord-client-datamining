...
public abstract class h0 implements View.OnTouchListener, View.OnAttachStateChangeListener {
    ...
    private Runnable f1671p;

    /* renamed from: q  reason: collision with root package name */
    private Runnable f1672q;
    ...
    private final int[] f1675t = new int[2];
    ...
    public class a implements Runnable {
        ...
        public void run() {
            ViewParent parent = h0.this.f1670o.getParent();
            if (parent != null) {
    ...
    public h0(View view) {
        ...
        this.f1667d = ViewConfiguration.get(view.getContext()).getScaledTouchSlop();
        int tapTimeout = ViewConfiguration.getTapTimeout();
        this.f1668e = tapTimeout;
        this.f1669i = (tapTimeout + ViewConfiguration.getLongPressTimeout()) / 2;
    }

    private void a() {
        Runnable runnable = this.f1672q;
        if (runnable != null) {
            this.f1670o.removeCallbacks(runnable);
        }
        Runnable runnable2 = this.f1671p;
        if (runnable2 != null) {
            this.f1670o.removeCallbacks(runnable2);
        }
    }
    ...
    */
    private boolean g(android.view.MotionEvent r6) {
        /*
            r5 = this;
            android.view.View r0 = r5.f1670o
        ...
        L41:
            ...
            r5.f1674s = r6
            java.lang.Runnable r6 = r5.f1671p
            if (r6 != 0) goto L52
        ...
        L52:
            ...
            java.lang.Runnable r6 = r5.f1672q
            if (r6 != 0) goto L65
    ...
    public boolean onTouch(View view, MotionEvent motionEvent) {
        ...
        if (z11) {
            ...
            if (z10) {
                long uptimeMillis = SystemClock.uptimeMillis();
                MotionEvent obtain = MotionEvent.obtain(uptimeMillis, uptimeMillis, 3, 0.0f, 0.0f, 0);
                this.f1670o.onTouchEvent(obtain);
                obtain.recycle();
            }
        }
        this.f1673r = z10;
