...
public class d extends AutoCompleteTextView {
    ...
    private static final int[] f1744o = {16843126};

    /* renamed from: d  reason: collision with root package name */
    private final AppCompatBackgroundHelper f1745d;

    /* renamed from: e  reason: collision with root package name */
    private final AppCompatTextHelper f1746e;

    /* renamed from: i  reason: collision with root package name */
    private final AppCompatEmojiEditTextHelper f1747i;
    ...
    protected void drawableStateChanged() {
        ...
        AppCompatBackgroundHelper appCompatBackgroundHelper = this.f1745d;
        if (appCompatBackgroundHelper != null) {
            appCompatBackgroundHelper.b();
        }
        AppCompatTextHelper appCompatTextHelper = this.f1746e;
    ...
    public InputConnection onCreateInputConnection(EditorInfo editorInfo) {
        return this.f1747i.e(k.a(super.onCreateInputConnection(editorInfo), editorInfo, this), editorInfo);
    }
    ...
    public void setKeyListener(KeyListener keyListener) {
        super.setKeyListener(this.f1747i.a(keyListener));
    }
    ...
    public d(Context context, AttributeSet attributeSet, int i10) {
        ...
        v0 v10 = v0.v(getContext(), attributeSet, f1744o, i10, 0);
        if (v10.s(0)) {
            setDropDownBackgroundDrawable(v10.g(0));
        }
        v10.x();
        AppCompatBackgroundHelper appCompatBackgroundHelper = new AppCompatBackgroundHelper(this);
        this.f1745d = appCompatBackgroundHelper;
        appCompatBackgroundHelper.e(attributeSet, i10);
        AppCompatTextHelper appCompatTextHelper = new AppCompatTextHelper(this);
        this.f1746e = appCompatTextHelper;
        appCompatTextHelper.m(attributeSet, i10);
        appCompatTextHelper.b();
        AppCompatEmojiEditTextHelper appCompatEmojiEditTextHelper = new AppCompatEmojiEditTextHelper(this);
        this.f1747i = appCompatEmojiEditTextHelper;
