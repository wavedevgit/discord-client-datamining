...
public class c extends androidx.appcompat.view.menu.a implements b.a {
    ...
    public class a extends androidx.appcompat.view.menu.i {
        public a(Context context, androidx.appcompat.view.menu.m mVar, View view) {
            super(context, mVar, view, false, f.a.f24077i);
            if (!((androidx.appcompat.view.menu.g) mVar.getItem()).l()) {
                View view2 = c.this.f1578v;
                f(view2 == null ? (View) ((androidx.appcompat.view.menu.a) c.this).f1246t : view2);
            }
            j(c.this.N);
        }
    ...
    public class RunnableC0019c implements Runnable {
        ...
        public void run() {
            if (((androidx.appcompat.view.menu.a) c.this).f1240i != null) {
                ((androidx.appcompat.view.menu.a) c.this).f1240i.d();
            }
            View view = (View) ((androidx.appcompat.view.menu.a) c.this).f1246t;
            if (view != null && view.getWindowToken() != null && this.f1585d.m()) {
                c.this.J = this.f1585d;
            }
            c.this.L = null;
        }
    }
    ...
    public class d extends m implements ActionMenuView.a {
        ...
        public d(Context context) {
            super(context, null, f.a.f24076h);
            setClickable(true);
            setFocusable(true);
            setVisibility(0);
            setEnabled(true);
    ...
    public class e extends androidx.appcompat.view.menu.i {
        public e(Context context, androidx.appcompat.view.menu.e eVar, View view, boolean z10) {
            super(context, eVar, view, z10, f.a.f24077i);
            h(8388613);
            j(c.this.N);
        }
        ...
        protected void e() {
            if (((androidx.appcompat.view.menu.a) c.this).f1240i != null) {
                ((androidx.appcompat.view.menu.a) c.this).f1240i.close();
            }
            c.this.J = null;
            super.e();
        }
    ...
    private class f implements j.a {
        ...
        public boolean b(androidx.appcompat.view.menu.e eVar) {
            if (eVar == ((androidx.appcompat.view.menu.a) c.this).f1240i) {
                return false;
            }
    ...
    public c(Context context) {
        super(context, f.g.f24171c, f.g.f24170b);
    ...
    public boolean B() {
        ...
        if (runnableC0019c != null && (kVar = this.f1246t) != null) {
    ...
    public void F(Configuration configuration) {
        if (!this.D) {
            this.C = androidx.appcompat.view.a.b(this.f1239e).d();
        }
        androidx.appcompat.view.menu.e eVar = this.f1240i;
        if (eVar != null) {
            eVar.L(true);
        }
    }
    ...
    public void H(ActionMenuView actionMenuView) {
        this.f1246t = actionMenuView;
        actionMenuView.a(this.f1240i);
    }
    ...
    public boolean K() {
        ...
        if (this.f1581y && !E() && (eVar = this.f1240i) != null && this.f1246t != null && this.L == null && !eVar.z().isEmpty()) {
            RunnableC0019c runnableC0019c = new RunnableC0019c(new e(this.f1239e, this.f1240i, this.f1578v, true));
            this.L = runnableC0019c;
            ((View) this.f1246t).post(runnableC0019c);
            return true;
        }
        return false;
    }
    ...
    public boolean d(androidx.appcompat.view.menu.m mVar) {
        ...
        a aVar = new a(this.f1239e, mVar, z11);
        this.K = aVar;
        aVar.g(z10);
        this.K.k();
        super.d(mVar);
    ...
    public void e(boolean z10) {
        ArrayList arrayList;
        super.e(z10);
        ((View) this.f1246t).requestLayout();
        androidx.appcompat.view.menu.e eVar = this.f1240i;
        boolean z11 = false;
        if (eVar != null) {
        ...
        androidx.appcompat.view.menu.e eVar2 = this.f1240i;
        if (eVar2 != null) {
            arrayList = eVar2.z();
        } else {
            arrayList = null;
        }
        if (this.f1581y && arrayList != null) {
        ...
        if (z11) {
            if (this.f1578v == null) {
                this.f1578v = new d(this.f1238d);
            }
            ViewGroup viewGroup = (ViewGroup) this.f1578v.getParent();
            if (viewGroup != this.f1246t) {
                if (viewGroup != null) {
                    viewGroup.removeView(this.f1578v);
                }
                ActionMenuView actionMenuView = (ActionMenuView) this.f1246t;
                actionMenuView.addView(this.f1578v, actionMenuView.D());
            }
        } else {
            d dVar = this.f1578v;
            if (dVar != null) {
                ViewParent parent = dVar.getParent();
                androidx.appcompat.view.menu.k kVar = this.f1246t;
                if (parent == kVar) {
                    ((ViewGroup) kVar).removeView(this.f1578v);
                }
            }
        }
        ((ActionMenuView) this.f1246t).setOverflowReserved(this.f1581y);
    }
    ...
    public boolean f() {
        ...
        boolean z12;
        c cVar = this;
        androidx.appcompat.view.menu.e eVar = cVar.f1240i;
        View view = null;
        ?? r32 = 0;
        if (eVar != null) {
            arrayList = eVar.E();
        ...
        ViewGroup viewGroup = (ViewGroup) cVar.f1246t;
        boolean z13 = false;
        int i16 = 0;
        int i17 = 0;
        ...
        if (cVar.f1581y && (z13 || i17 + i16 > i14)) {
            i14--;
        }
        int i19 = i14 - i16;
    ...
    public void h(Context context, androidx.appcompat.view.menu.e eVar) {
        ...
        if (this.f1581y) {
            if (this.f1578v == null) {
                d dVar = new d(this.f1238d);
                this.f1578v = dVar;
                if (this.f1580x) {
                    dVar.setImageDrawable(this.f1579w);
                    this.f1579w = null;
                    this.f1580x = false;
                }
                int makeMeasureSpec = View.MeasureSpec.makeMeasureSpec(0, 0);
                this.f1578v.measure(makeMeasureSpec, makeMeasureSpec);
            }
            i10 -= this.f1578v.getMeasuredWidth();
        } else {
            this.f1578v = null;
        }
        this.B = i10;
    ...
    public void j(androidx.appcompat.view.menu.g gVar, k.a aVar) {
        ...
        actionMenuItemView.setItemInvoker((ActionMenuView) this.f1246t);
        if (this.M == null) {
            this.M = new b();
        }
    ...
    public boolean l(ViewGroup viewGroup, int i10) {
        if (viewGroup.getChildAt(i10) == this.f1578v) {
            return false;
        }
