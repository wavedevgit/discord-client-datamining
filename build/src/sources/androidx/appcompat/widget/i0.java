...
public abstract class i0 extends ViewGroup {
        ...
        for (int i11 = 0; i11 < virtualChildCount; i11++) {
            ...
            if (q10 != null && q10.getVisibility() != 8 && r(i11)) {
                ...
                if (b10) {
                    ...
                    left2 = (q10.getLeft() - ((LinearLayout.LayoutParams) aVar).leftMargin) - this.f1849w;
                }
                h(canvas, left2);
            }
        }
    ...
    void f(Canvas canvas) {
        ...
        for (int i10 = 0; i10 < virtualChildCount; i10++) {
            ...
            if (q10 != null && q10.getVisibility() != 8 && r(i10)) {
                g(canvas, (q10.getTop() - ((LinearLayout.LayoutParams) ((a) q10.getLayoutParams())).topMargin) - this.f1850x);
            }
        }
        if (r(virtualChildCount)) {
            View q11 = q(virtualChildCount - 1);
            if (q11 == null) {
                bottom = (getHeight() - getPaddingBottom()) - this.f1850x;
            } else {
    ...
    void g(Canvas canvas, int i10) {
        this.f1848v.setBounds(getPaddingLeft() + this.f1852z, i10, (getWidth() - getPaddingRight()) - this.f1852z, this.f1850x + i10);
        this.f1848v.draw(canvas);
    }
    ...
    public int getBaseline() {
        ...
        if (childCount > i11) {
            ...
            int i12 = this.f1840i;
            if (this.f1841o == 1 && (i10 = this.f1842p & 112) != 48) {
                if (i10 != 16) {
                    if (i10 == 80) {
                        i12 = ((getBottom() - getTop()) - getPaddingBottom()) - this.f1843q;
                    }
                } else {
                    i12 += ((((getBottom() - getTop()) - getPaddingTop()) - getPaddingBottom()) - this.f1843q) / 2;
                }
            }
    ...
    void h(Canvas canvas, int i10) {
        this.f1848v.setBounds(i10, getPaddingTop() + this.f1852z, this.f1849w + i10, (getHeight() - getPaddingBottom()) - this.f1852z);
        this.f1848v.draw(canvas);
    }
    ...
    */
    ...
    public void setDividerDrawable(Drawable drawable) {
        if (drawable == this.f1848v) {
            return;
        }
        this.f1848v = drawable;
        boolean z10 = false;
        if (drawable != null) {
            this.f1849w = drawable.getIntrinsicWidth();
            this.f1850x = drawable.getIntrinsicHeight();
        } else {
            this.f1849w = 0;
            this.f1850x = 0;
        }
    ...
    public void setVerticalGravity(int i10) {
        ...
        int i12 = this.f1842p;
        if ((i12 & 112) != i11) {
            this.f1842p = i11 | (i12 & (-113));
            requestLayout();
        }
    }

    public void setWeightSum(float f10) {
        this.f1844r = Math.max(0.0f, f10);
    }
