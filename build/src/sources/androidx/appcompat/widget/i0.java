...
public abstract class i0 extends ViewGroup {
        ...
        for (int i11 = 0; i11 < virtualChildCount; i11++) {
            ...
            if (q10 != null && q10.getVisibility() != 8 && r(i11)) {
                ...
                if (b10) {
                    ...
                    left2 = (q10.getLeft() - ((LinearLayout.LayoutParams) aVar).leftMargin) - this.f1695w;
                }
                h(canvas, left2);
            }
        }
    ...
    void f(Canvas canvas) {
        ...
        for (int i10 = 0; i10 < virtualChildCount; i10++) {
            ...
            if (q10 != null && q10.getVisibility() != 8 && r(i10)) {
                g(canvas, (q10.getTop() - ((LinearLayout.LayoutParams) ((a) q10.getLayoutParams())).topMargin) - this.f1696x);
            }
        }
        if (r(virtualChildCount)) {
            View q11 = q(virtualChildCount - 1);
            if (q11 == null) {
                bottom = (getHeight() - getPaddingBottom()) - this.f1696x;
            } else {
    ...
    void g(Canvas canvas, int i10) {
        this.f1694v.setBounds(getPaddingLeft() + this.f1698z, i10, (getWidth() - getPaddingRight()) - this.f1698z, this.f1696x + i10);
        this.f1694v.draw(canvas);
    }
    ...
    public int getBaseline() {
        ...
        if (childCount > i11) {
            ...
            int i12 = this.f1686i;
            if (this.f1687o == 1 && (i10 = this.f1688p & 112) != 48) {
                if (i10 != 16) {
                    if (i10 == 80) {
                        i12 = ((getBottom() - getTop()) - getPaddingBottom()) - this.f1689q;
                    }
                } else {
                    i12 += ((((getBottom() - getTop()) - getPaddingTop()) - getPaddingBottom()) - this.f1689q) / 2;
                }
            }
    ...
    void h(Canvas canvas, int i10) {
        this.f1694v.setBounds(i10, getPaddingTop() + this.f1698z, this.f1695w + i10, (getHeight() - getPaddingBottom()) - this.f1698z);
        this.f1694v.draw(canvas);
    }
    ...
    */
    ...
    public void setDividerDrawable(Drawable drawable) {
        if (drawable == this.f1694v) {
            return;
        }
        this.f1694v = drawable;
        boolean z10 = false;
        if (drawable != null) {
            this.f1695w = drawable.getIntrinsicWidth();
            this.f1696x = drawable.getIntrinsicHeight();
        } else {
            this.f1695w = 0;
            this.f1696x = 0;
        }
    ...
    public void setVerticalGravity(int i10) {
        ...
        int i12 = this.f1688p;
        if ((i12 & 112) != i11) {
            this.f1688p = i11 | (i12 & (-113));
            requestLayout();
        }
    }

    public void setWeightSum(float f10) {
        this.f1690r = Math.max(0.0f, f10);
    }
    ...
    */
    ...
    public i0(Context context, AttributeSet attributeSet, int i10) {
        ...
        this.f1686i = 0;
        this.f1688p = 8388659;
        v0 v10 = v0.v(context, attributeSet, f.j.f24209a1, i10, 0);
        androidx.core.view.h0.l0(this, context, f.j.f24209a1, attributeSet, v10.r(), i10, 0);
        int k10 = v10.k(f.j.f24219c1, -1);
        if (k10 >= 0) {
            setOrientation(k10);
        }
        int k11 = v10.k(f.j.f24214b1, -1);
        if (k11 >= 0) {
            setGravity(k11);
        }
        boolean a10 = v10.a(f.j.f24224d1, true);
        if (!a10) {
            setBaselineAligned(a10);
        }
        this.f1690r = v10.i(f.j.f24234f1, -1.0f);
        this.f1685e = v10.k(f.j.f24229e1, -1);
        this.f1691s = v10.a(f.j.f24249i1, false);
        setDividerDrawable(v10.g(f.j.f24239g1));
        this.f1697y = v10.k(f.j.f24254j1, 0);
        this.f1698z = v10.f(f.j.f24244h1, 0);
        v10.x();
    }
}
