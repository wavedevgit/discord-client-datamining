...
public abstract class SwitchCompat extends CompoundButton {
    ...
    public static class EmojiCompatInitCallback extends e.f {
        ...
        private final Reference f1527a;

        EmojiCompatInitCallback(SwitchCompat switchCompat) {
            this.f1527a = new WeakReference(switchCompat);
        }

        @Override // androidx.emoji2.text.e.f
        public void a(Throwable th2) {
            SwitchCompat switchCompat = (SwitchCompat) this.f1527a.get();
    ...
    private void j() {
        if (Build.VERSION.SDK_INT >= 30) {
            ...
            if (charSequence == null) {
                charSequence = getResources().getString(f.h.f24190b);
            }
    ...
    private void k() {
        if (Build.VERSION.SDK_INT >= 30) {
            ...
            if (charSequence == null) {
                charSequence = getResources().getString(f.h.f24191c);
            }
            androidx.core.view.h0.I0(this, charSequence);
        }
    }
