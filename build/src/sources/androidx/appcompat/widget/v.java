...
public class v extends Spinner {
    ...
    private static final int[] f1803t = {16843505};

    /* renamed from: d  reason: collision with root package name */
    private final AppCompatBackgroundHelper f1804d;

    /* renamed from: e  reason: collision with root package name */
    private final Context f1805e;

    /* renamed from: i  reason: collision with root package name */
    private h0 f1806i;

    /* renamed from: o  reason: collision with root package name */
    private SpinnerAdapter f1807o;

    /* renamed from: p  reason: collision with root package name */
    private final boolean f1808p;
    ...
    class d implements h, DialogInterface.OnClickListener {
        ...
        /* renamed from: d  reason: collision with root package name */
        androidx.appcompat.app.a f1815d;

        /* renamed from: e  reason: collision with root package name */
        private ListAdapter f1816e;
        ...
        @Override // androidx.appcompat.widget.v.h
        public void dismiss() {
            androidx.appcompat.app.a aVar = this.f1815d;
            if (aVar != null) {
                aVar.dismiss();
                this.f1815d = null;
            }
        ...
        public void j(int i10, int i11) {
            ...
            CharSequence charSequence = this.f1817i;
            if (charSequence != null) {
                c0015a.setTitle(charSequence);
            }
            androidx.appcompat.app.a create = c0015a.j(this.f1816e, v.this.getSelectedItemPosition(), this).create();
            this.f1815d = create;
        ...
        public void onClick(DialogInterface dialogInterface, int i10) {
            ...
            if (v.this.getOnItemClickListener() != null) {
                v.this.performItemClick(null, i10, this.f1816e.getItemId(i10));
            }
            dismiss();
        }
    }
    ...
    public static class e implements ListAdapter, SpinnerAdapter {
        ...
        /* renamed from: d  reason: collision with root package name */
        private SpinnerAdapter f1819d;

        /* renamed from: e  reason: collision with root package name */
        private ListAdapter f1820e;

        public e(SpinnerAdapter spinnerAdapter, Resources.Theme theme) {
            this.f1819d = spinnerAdapter;
            if (spinnerAdapter instanceof ListAdapter) {
                this.f1820e = (ListAdapter) spinnerAdapter;
            }
        ...
        public boolean areAllItemsEnabled() {
            ListAdapter listAdapter = this.f1820e;
            if (listAdapter != null) {
        ...
        public int getCount() {
            SpinnerAdapter spinnerAdapter = this.f1819d;
    ...
    class f extends j0 implements h {
        ...
        class c implements PopupWindow.OnDismissListener {
            ...
            /* renamed from: d  reason: collision with root package name */
            final /* synthetic */ ViewTreeObserver.OnGlobalLayoutListener f1824d;

            c(ViewTreeObserver.OnGlobalLayoutListener onGlobalLayoutListener) {
                this.f1824d = onGlobalLayoutListener;
            }
            ...
            public void onDismiss() {
                ViewTreeObserver viewTreeObserver = v.this.getViewTreeObserver();
                if (viewTreeObserver != null) {
                    viewTreeObserver.removeGlobalOnLayoutListener(this.f1824d);
                }
            }
        }
        ...
        void R() {
            ...
            Drawable f10 = f();
            if (f10 != null) {
                f10.getPadding(v.this.f1811s);
                if (g1.b(v.this)) {
                    i10 = v.this.f1811s.right;
                } else {
                    i10 = -v.this.f1811s.left;
                }
            } else {
                Rect rect = v.this.f1811s;
                rect.right = 0;
                rect.left = 0;
                i10 = 0;
            }
    ...
    public static class g extends View.BaseSavedState {
        ...
        public void writeToParcel(Parcel parcel, int i10) {
            ...
            parcel.writeByte(this.f1826d ? (byte) 1 : (byte) 0);
        }

        g(Parcel parcel) {
            super(parcel);
            this.f1826d = parcel.readByte() != 0;
        }
    }
    ...
    int a(SpinnerAdapter spinnerAdapter, Drawable drawable) {
        ...
        if (drawable != null) {
            drawable.getPadding(this.f1811s);
            Rect rect = this.f1811s;
    ...
    void b() {
        this.f1809q.j(getTextDirection(), getTextAlignment());
    }

    @Override // android.view.ViewGroup, android.view.View
    protected void drawableStateChanged() {
        super.drawableStateChanged();
        AppCompatBackgroundHelper appCompatBackgroundHelper = this.f1804d;
    ...
    protected void onMeasure(int i10, int i11) {
        ...
        if (this.f1809q != null && View.MeasureSpec.getMode(i10) == Integer.MIN_VALUE) {
    ...
    public void onRestoreInstanceState(Parcelable parcelable) {
        ...
        if (gVar.f1826d && (viewTreeObserver = getViewTreeObserver()) != null) {
    ...
    public void setAdapter(SpinnerAdapter spinnerAdapter) {
        ...
        if (this.f1809q != null) {
            ...
            this.f1809q.l(new e(spinnerAdapter, context.getTheme()));
        }
    }
