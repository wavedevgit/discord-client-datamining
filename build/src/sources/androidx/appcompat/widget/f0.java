...
public class f0 extends ListView {
    ...
    private androidx.core.view.s0 f1796v;

    /* renamed from: w  reason: collision with root package name */
    private androidx.core.widget.g f1797w;
    ...
    static class b {
        ...
        private static Method f1799a;

        /* renamed from: b  reason: collision with root package name */
        private static Method f1800b;

        /* renamed from: c  reason: collision with root package name */
        private static Method f1801c;

        /* renamed from: d  reason: collision with root package name */
        private static boolean f1802d;
        ...
        static {
            try {
                ...
                f1799a = declaredMethod;
                declaredMethod.setAccessible(true);
                Method declaredMethod2 = AdapterView.class.getDeclaredMethod("setSelectedPositionInt", cls);
                f1800b = declaredMethod2;
                declaredMethod2.setAccessible(true);
                Method declaredMethod3 = AdapterView.class.getDeclaredMethod("setNextSelectedPositionInt", cls);
                f1801c = declaredMethod3;
        ...
        static void b(f0 f0Var, int i10, View view) {
            try {
                f1799a.invoke(f0Var, Integer.valueOf(i10), view, Boolean.FALSE, -1, -1);
                f1800b.invoke(f0Var, Integer.valueOf(i10));
                f1801c.invoke(f0Var, Integer.valueOf(i10));
    ...
    public static class e {
        ...
        /* renamed from: a  reason: collision with root package name */
        private static final Field f1804a;
    ...
    private void a() {
        ...
        View childAt = getChildAt(this.f1791q - getFirstVisiblePosition());
        if (childAt != null) {
            childAt.setPressed(false);
        }
        androidx.core.view.s0 s0Var = this.f1796v;
        if (s0Var != null) {
            s0Var.c();
            this.f1796v = null;
        }
    ...
    private void c(Canvas canvas) {
        Drawable selector;
        if (!this.f1786d.isEmpty() && (selector = getSelector()) != null) {
            selector.setBounds(this.f1786d);
            selector.draw(canvas);
        }
    }

    private void f(int i10, View view) {
        Rect rect = this.f1786d;
        rect.set(view.getLeft(), view.getTop(), view.getRight(), view.getBottom());
        rect.left -= this.f1787e;
        rect.top -= this.f1788i;
        rect.right += this.f1789o;
        rect.bottom += this.f1790p;
        boolean k10 = k();
    ...
    */
    public boolean e(android.view.MotionEvent r8, int r9) {
        ...
        L4d:
            if (r3 == 0) goto L65
            androidx.core.widget.g r9 = r7.f1797w
            if (r9 != 0) goto L5a
        ...
        L5a:
            ...
            return r3
        L65:
            androidx.core.widget.g r8 = r7.f1797w
            if (r8 == 0) goto L6c
            r8.m(r2)
        L6c:
            return r3
    ...
    public boolean hasWindowFocus() {
        if (!this.f1794t && !super.hasWindowFocus()) {
            return false;
        }
        return true;
    }
    ...
    public boolean isFocused() {
        if (!this.f1794t && !super.isFocused()) {
            return false;
        }
        return true;
    }
    ...
    public boolean isInTouchMode() {
        if ((this.f1794t && this.f1793s) || super.isInTouchMode()) {
            return true;
        }
        return false;
    }
    ...
    public boolean onHoverEvent(MotionEvent motionEvent) {
        ...
        if (actionMasked == 10 && this.f1798x == null) {
            f fVar = new f();
            this.f1798x = fVar;
            fVar.b();
        }
    ...
    public boolean onTouchEvent(MotionEvent motionEvent) {
        if (motionEvent.getAction() == 0) {
            this.f1791q = pointToPosition((int) motionEvent.getX(), (int) motionEvent.getY());
        }
        f fVar = this.f1798x;
        if (fVar != null) {
            fVar.a();
    ...
    public void setSelector(Drawable drawable) {
        ...
        this.f1787e = rect.left;
        this.f1788i = rect.top;
        this.f1789o = rect.right;
        this.f1790p = rect.bottom;
    }
}
