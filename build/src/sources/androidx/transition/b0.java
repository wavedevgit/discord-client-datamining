...
abstract class b0 {
    ...
    static class b implements TypeEvaluator {
        ...
        /* renamed from: a  reason: collision with root package name */
        final float[] f5367a = new float[9];

        /* renamed from: b  reason: collision with root package name */
        final float[] f5368b = new float[9];

        /* renamed from: c  reason: collision with root package name */
        final Matrix f5369c = new Matrix();

        @Override // android.animation.TypeEvaluator
        /* renamed from: a */
        public Matrix evaluate(float f10, Matrix matrix, Matrix matrix2) {
            matrix.getValues(this.f5367a);
            matrix2.getValues(this.f5368b);
            for (int i10 = 0; i10 < 9; i10++) {
                float[] fArr = this.f5368b;
                float f11 = fArr[i10];
                float f12 = this.f5367a[i10];
                fArr[i10] = f12 + ((f11 - f12) * f10);
            }
            this.f5369c.setValues(this.f5368b);
            return this.f5369c;
        }
    }
