...
abstract class b0 {
    ...
    private static final boolean f5205a;
    ...
    static class b implements TypeEvaluator {
        ...
        /* renamed from: a  reason: collision with root package name */
        final float[] f5206a = new float[9];

        /* renamed from: b  reason: collision with root package name */
        final float[] f5207b = new float[9];

        /* renamed from: c  reason: collision with root package name */
        final Matrix f5208c = new Matrix();

        @Override // android.animation.TypeEvaluator
        /* renamed from: a */
        public Matrix evaluate(float f10, Matrix matrix, Matrix matrix2) {
            matrix.getValues(this.f5206a);
            matrix2.getValues(this.f5207b);
            for (int i10 = 0; i10 < 9; i10++) {
                float[] fArr = this.f5207b;
                float f11 = fArr[i10];
                float f12 = this.f5206a[i10];
                fArr[i10] = f12 + ((f11 - f12) * f10);
            }
            this.f5208c.setValues(this.f5207b);
            return this.f5208c;
        }
    }
