...
abstract class b0 {
    ...
    private static final boolean f5249a;
    ...
    static class b implements TypeEvaluator {
        ...
        /* renamed from: a  reason: collision with root package name */
        final float[] f5250a = new float[9];

        /* renamed from: b  reason: collision with root package name */
        final float[] f5251b = new float[9];

        /* renamed from: c  reason: collision with root package name */
        final Matrix f5252c = new Matrix();

        @Override // android.animation.TypeEvaluator
        /* renamed from: a */
        public Matrix evaluate(float f10, Matrix matrix, Matrix matrix2) {
            matrix.getValues(this.f5250a);
            matrix2.getValues(this.f5251b);
            for (int i10 = 0; i10 < 9; i10++) {
                float[] fArr = this.f5251b;
                float f11 = fArr[i10];
                float f12 = this.f5250a[i10];
                fArr[i10] = f12 + ((f11 - f12) * f10);
            }
            this.f5252c.setValues(this.f5251b);
            return this.f5252c;
        }
    }
