...
abstract class b0 {
    ...
    static class b implements TypeEvaluator {
        ...
        /* renamed from: a  reason: collision with root package name */
        final float[] f5357a = new float[9];

        /* renamed from: b  reason: collision with root package name */
        final float[] f5358b = new float[9];

        /* renamed from: c  reason: collision with root package name */
        final Matrix f5359c = new Matrix();

        @Override // android.animation.TypeEvaluator
        /* renamed from: a */
        public Matrix evaluate(float f10, Matrix matrix, Matrix matrix2) {
            matrix.getValues(this.f5357a);
            matrix2.getValues(this.f5358b);
            for (int i10 = 0; i10 < 9; i10++) {
                float[] fArr = this.f5358b;
                float f11 = fArr[i10];
                float f12 = this.f5357a[i10];
                fArr[i10] = f12 + ((f11 - f12) * f10);
            }
            this.f5359c.setValues(this.f5358b);
            return this.f5359c;
        }
    }
