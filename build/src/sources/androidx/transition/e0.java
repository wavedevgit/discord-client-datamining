...
abstract class e0 {
    ...
    public static Animator a(View view, c0 c0Var, int i10, int i11, float f10, float f11, float f12, float f13, TimeInterpolator timeInterpolator, Transition transition) {
        ...
        int[] iArr = (int[]) c0Var.f5340b.getTag(l.f5403f);
        if (iArr != null) {
        ...
        a aVar = new a(view, c0Var.f5340b, translationX, translationY);
        transition.c(aVar);
    ...
    private static class a extends AnimatorListenerAdapter implements Transition.h {
        ...
        a(View view, View view2, float f10, float f11) {
            ...
            this.f5361f = f10;
            this.f5362g = f11;
            int[] iArr = (int[]) view2.getTag(l.f5403f);
            this.f5358c = iArr;
            if (iArr != null) {
                view2.setTag(l.f5403f, null);
            }
        }

        private void a() {
            if (this.f5358c == null) {
                this.f5358c = new int[2];
            }
            this.f5357b.getLocationOnScreen(this.f5358c);
            this.f5356a.setTag(l.f5403f, this.f5358c);
        }

        @Override // android.animation.AnimatorListenerAdapter, android.animation.Animator.AnimatorListener
        public void onAnimationCancel(Animator animator) {
            this.f5363h = true;
            this.f5357b.setTranslationX(this.f5361f);
            this.f5357b.setTranslationY(this.f5362g);
        }
        ...
        public void onTransitionEnd(Transition transition, boolean z10) {
            ...
            this.f5356a.setTag(l.f5403f, null);
        }

        @Override // androidx.transition.Transition.h
        public void onTransitionPause(Transition transition) {
            a();
            this.f5359d = this.f5357b.getTranslationX();
            this.f5360e = this.f5357b.getTranslationY();
            this.f5357b.setTranslationX(this.f5361f);
            this.f5357b.setTranslationY(this.f5362g);
        }
        ...
        public void onTransitionResume(Transition transition) {
            this.f5357b.setTranslationX(this.f5359d);
            this.f5357b.setTranslationY(this.f5360e);
        }
