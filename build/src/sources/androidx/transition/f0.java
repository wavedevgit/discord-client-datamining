...
class f0 {
    ...
    private float[] f5404b = new float[20];
    ...
    public float b() {
        float c10;
        int i10 = this.f5405c;
        if (i10 == 0 && this.f5403a[i10] == Long.MIN_VALUE) {
            return 0.0f;
        }
        long j10 = this.f5403a[i10];
        int i11 = 0;
        long j11 = j10;
        while (true) {
            long j12 = this.f5403a[i10];
        ...
        if (i11 == 2) {
            ...
            int i16 = (i14 + 21) % 20;
            long j13 = this.f5403a[i15];
            float f11 = this.f5404b[i15];
            int i17 = i15 + 1;
            float f12 = 0.0f;
            for (int i18 = i17 % 20; i18 != i16; i18 = (i18 + 1) % 20) {
                long j14 = this.f5403a[i18];
                float f13 = (float) (j14 - j13);
                if (f13 != 0.0f) {
                    float f14 = this.f5404b[i18];
