...
public class n {
    ...
    private int a(List list) {
        ...
        for (int size = list.size() - 1; size >= 0; size--) {
            if (((AdapterHelper.b) list.get(size)).f5153a == 8) {
                if (z10) {
                    return size;
                }
            } else {
    ...
    private void c(List list, int i10, AdapterHelper.b bVar, int i11, AdapterHelper.b bVar2) {
        ...
        if (i14 <= i15) {
            bVar.f5154b = i15 + bVar2.f5156d;
        }
        int i16 = bVar2.f5154b;
        if (i16 <= i13) {
            bVar.f5156d = i13 + bVar2.f5156d;
        }
        bVar2.f5154b = i16 + i12;
        list.set(i10, bVar2);
        list.set(i11, bVar);
    }
    ...
    void e(List list, int i10, AdapterHelper.b bVar, int i11, AdapterHelper.b bVar2) {
        ...
        boolean z11 = false;
        if (i12 < i13) {
            if (bVar2.f5154b == i12 && bVar2.f5156d == i13 - i12) {
                z10 = false;
                z11 = true;
            } else {
                z10 = false;
            }
        } else if (bVar2.f5154b == i13 + 1 && bVar2.f5156d == i12 - i13) {
            z10 = true;
            z11 = true;
        } else {
            z10 = true;
        ...
        if (i16 <= i17) {
            ...
            if (i16 < i17 + i18) {
                bVar3 = this.f5484a.a(2, i16 + 1, (i17 + i18) - i16, null);
                bVar2.f5156d = bVar.f5154b - bVar2.f5154b;
            }
        }
        if (z11) {
            list.set(i10, bVar2);
        ...
        if (z10) {
            if (bVar3 != null) {
                int i19 = bVar.f5154b;
                if (i19 > bVar3.f5154b) {
                    bVar.f5154b = i19 - bVar3.f5156d;
                }
                int i20 = bVar.f5156d;
                if (i20 > bVar3.f5154b) {
                    bVar.f5156d = i20 - bVar3.f5156d;
                }
            }
            int i21 = bVar.f5154b;
            if (i21 > bVar2.f5154b) {
                bVar.f5154b = i21 - bVar2.f5156d;
            }
            int i22 = bVar.f5156d;
            if (i22 > bVar2.f5154b) {
                bVar.f5156d = i22 - bVar2.f5156d;
            }
        } else {
            if (bVar3 != null) {
                int i23 = bVar.f5154b;
                if (i23 >= bVar3.f5154b) {
                    bVar.f5154b = i23 - bVar3.f5156d;
                }
                int i24 = bVar.f5156d;
                if (i24 >= bVar3.f5154b) {
                    bVar.f5156d = i24 - bVar3.f5156d;
                }
            }
            int i25 = bVar.f5154b;
            if (i25 >= bVar2.f5154b) {
                bVar.f5154b = i25 - bVar2.f5156d;
            }
            int i26 = bVar.f5156d;
            if (i26 >= bVar2.f5154b) {
                bVar.f5156d = i26 - bVar2.f5156d;
            }
        }
        list.set(i10, bVar2);
        if (bVar.f5154b != bVar.f5156d) {
            list.set(i11, bVar);
        } else {
            list.remove(i11);
        }
    ...
    */
    void f(java.util.List r9, int r10, androidx.recyclerview.widget.AdapterHelper.b r11, int r12, androidx.recyclerview.widget.AdapterHelper.b r13) {
        ...
        Ld:
            ...
            int r5 = r5 - r3
            r13.f5156d = r5
            androidx.recyclerview.widget.n$a r0 = r8.f5484a
            int r1 = r11.f5154b
            java.lang.Object r5 = r13.f5155c
        ...
        L2b:
            ...
            int r5 = r5 + r6
            int r5 = r5 - r1
            androidx.recyclerview.widget.n$a r4 = r8.f5484a
            int r1 = r1 + r3
            java.lang.Object r3 = r13.f5155c
        ...
        L4c:
            r9.remove(r10)
            androidx.recyclerview.widget.n$a r11 = r8.f5484a
            r11.b(r13)
        L54:
            if (r0 == 0) goto L59
            r9.add(r10, r0)
