...
public abstract class h {
    ...
    private int a(RecyclerView recyclerView) {
        if (this.mCachedMaxScrollSpeed == -1) {
            this.mCachedMaxScrollSpeed = recyclerView.getResources().getDimensionPixelSize(q3.b.f45228d);
        }
    ...
    public void clearView(@NonNull RecyclerView recyclerView, @NonNull RecyclerView.ViewHolder viewHolder) {
        j.f5171a.a(viewHolder.itemView);
    }
    ...
    public void onChildDraw(@NonNull Canvas canvas, @NonNull RecyclerView recyclerView, @NonNull RecyclerView.ViewHolder viewHolder, float f10, float f11, int i10, boolean z10) {
        j.f5171a.c(canvas, recyclerView, viewHolder.itemView, f10, f11, i10, z10);
    }
    ...
    public void onChildDrawOver(@NonNull Canvas canvas, @NonNull RecyclerView recyclerView, @SuppressLint({"UnknownNullness"}) RecyclerView.ViewHolder viewHolder, float f10, float f11, int i10, boolean z10) {
        j.f5171a.d(canvas, recyclerView, viewHolder.itemView, f10, f11, i10, z10);
    }
    ...
    public void onSelectedChanged(RecyclerView.ViewHolder viewHolder, int i10) {
        if (viewHolder != null) {
            j.f5171a.b(viewHolder.itemView);
        }
    }
