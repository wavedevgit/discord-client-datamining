...
public class GridLayoutManager extends LinearLayoutManager {
    ...
    public GridLayoutManager(Context context, AttributeSet attributeSet, int i10, int i11) {
        ...
        setSpanCount(RecyclerView.LayoutManager.getProperties(context, attributeSet, i10, i11).f4816b);
    }
    ...
    private void Q(RecyclerView.Recycler recycler, RecyclerView.State state, LinearLayoutManager.AnchorInfo anchorInfo, int i10) {
        ...
        int d02 = d0(recycler, state, anchorInfo.f4780b);
        if (z10) {
            while (d02 > 0) {
                int i11 = anchorInfo.f4780b;
                if (i11 > 0) {
                    int i12 = i11 - 1;
                    anchorInfo.f4780b = i12;
    ...
    private void h0(View view, int i10, boolean z10) {
        ...
        int spaceForSpanRange = getSpaceForSpanRange(cVar.f4777p, cVar.f4778q);
        if (this.mOrientation == 1) {
    ...
    void collectPrefetchPositionsForLayoutState(RecyclerView.State state, LinearLayoutManager.LayoutState layoutState, RecyclerView.LayoutManager.LayoutPrefetchRegistry layoutPrefetchRegistry) {
        ...
        for (int i11 = 0; i11 < this.mSpanCount && layoutState.c(state) && i10 > 0; i11++) {
            int i12 = layoutState.f4791d;
            layoutPrefetchRegistry.a(i12, Math.max(0, layoutState.f4794g));
            i10 -= this.mSpanSizeLookup.getSpanSize(i12);
            layoutState.f4791d += layoutState.f4792e;
        }
    }
