...
public class LinearLayoutManager extends RecyclerView.LayoutManager implements i, RecyclerView.SmoothScroller.a {
    ...
    public static class AnchorInfo {
        ...
        public void b(View view, int i10) {
            if (this.f4813d) {
                this.f4812c = this.f4810a.d(view) + this.f4810a.o();
            } else {
        ...
        public void c(View view, int i10) {
            ...
            this.f4811b = i10;
            if (this.f4813d) {
                int i11 = (this.f4810a.i() - o10) - this.f4810a.d(view);
                this.f4812c = this.f4810a.i() - i11;
                if (i11 > 0) {
                    int e10 = this.f4812c - this.f4810a.e(view);
                    int m10 = this.f4810a.m();
                    int min = e10 - (m10 + Math.min(this.f4810a.g(view) - m10, 0));
                    if (min < 0) {
                        this.f4812c += Math.min(i11, -min);
                        return;
                    }
                    return;
                }
            ...
            int g10 = this.f4810a.g(view);
            int m11 = g10 - this.f4810a.m();
            this.f4812c = g10;
            if (m11 > 0) {
                int i12 = (this.f4810a.i() - Math.min(0, (this.f4810a.i() - o10) - this.f4810a.d(view))) - (g10 + this.f4810a.e(view));
                if (i12 < 0) {
                    this.f4812c -= Math.min(m11, -i12);
                }
            }
        }
    ...
    public static class LayoutState {
        ...
        private View e() {
            int size = this.f4830l.size();
            for (int i10 = 0; i10 < size; i10++) {
                View view = ((RecyclerView.ViewHolder) this.f4830l.get(i10)).itemView;
                RecyclerView.LayoutParams layoutParams = (RecyclerView.LayoutParams) view.getLayoutParams();
                if (!layoutParams.c() && this.f4822d == layoutParams.a()) {
                    b(view);
                    return view;
                }
            }
        ...
        public void b(View view) {
            ...
            if (f10 == null) {
                ...
                this.f4822d = ((RecyclerView.LayoutParams) f10.getLayoutParams()).a();
            }
        }
        ...
        public View d(RecyclerView.Recycler recycler) {
            ...
            View o10 = recycler.o(this.f4822d);
            this.f4822d += this.f4823e;
            return o10;
        }
        ...
        public View f(View view) {
            ...
            for (int i11 = 0; i11 < size; i11++) {
                View view3 = ((RecyclerView.ViewHolder) this.f4830l.get(i11)).itemView;
                RecyclerView.LayoutParams layoutParams = (RecyclerView.LayoutParams) view3.getLayoutParams();
                if (view3 != view && !layoutParams.c() && (a10 = (layoutParams.a() - this.f4822d) * this.f4823e) >= 0 && a10 < i10) {
                    if (a10 == 0) {
                        return view3;
                    }
                    view2 = view3;
    ...
    public static class SavedState implements Parcelable {
        ...
        public void writeToParcel(Parcel parcel, int i10) {
            ...
            parcel.writeInt(this.f4834i ? 1 : 0);
        }

        SavedState(Parcel parcel) {
            this.f4832d = parcel.readInt();
            this.f4833e = parcel.readInt();
            this.f4834i = parcel.readInt() == 1;
        }

        public SavedState(SavedState savedState) {
            this.f4832d = savedState.f4832d;
            this.f4833e = savedState.f4833e;
            this.f4834i = savedState.f4834i;
        }
    }
    ...
    private boolean C(RecyclerView.Recycler recycler, RecyclerView.State state, AnchorInfo anchorInfo) {
        ...
        if (z12 != z13 || (findReferenceChild = findReferenceChild(recycler, state, anchorInfo.f4813d, z13)) == null) {
            return false;
        }
        ...
        if (!state.e() && supportsPredictiveItemAnimations()) {
            ...
            if (z10 || z11) {
                if (anchorInfo.f4813d) {
                    m10 = i10;
                }
                anchorInfo.f4812c = m10;
            }
        }
        return true;
    }
    ...
    private boolean D(RecyclerView.State state, AnchorInfo anchorInfo) {
        ...
        if (!state.e() && (i10 = this.mPendingScrollPosition) != -1) {
            if (i10 >= 0 && i10 < state.b()) {
                anchorInfo.f4811b = this.mPendingScrollPosition;
                SavedState savedState = this.mPendingSavedState;
                if (savedState != null && savedState.a()) {
                    boolean z12 = this.mPendingSavedState.f4834i;
                    anchorInfo.f4813d = z12;
                    if (z12) {
                        anchorInfo.f4812c = this.mOrientationHelper.i() - this.mPendingSavedState.f4833e;
                    } else {
                        anchorInfo.f4812c = this.mOrientationHelper.m() + this.mPendingSavedState.f4833e;
                    }
                    return true;
                    ...
                    if (findViewByPosition != null) {
                        if (this.mOrientationHelper.e(findViewByPosition) > this.mOrientationHelper.n()) {
                            ...
                            anchorInfo.f4812c = this.mOrientationHelper.m();
                            anchorInfo.f4813d = false;
                            return true;
                        } else if (this.mOrientationHelper.i() - this.mOrientationHelper.d(findViewByPosition) < 0) {
                            anchorInfo.f4812c = this.mOrientationHelper.i();
                            anchorInfo.f4813d = true;
                            return true;
                        } else {
                            if (anchorInfo.f4813d) {
                    ...
                    anchorInfo.f4813d = z13;
                    if (z13) {
                        anchorInfo.f4812c = this.mOrientationHelper.i() - this.mPendingScrollPositionOffset;
                    } else {
                        anchorInfo.f4812c = this.mOrientationHelper.m() + this.mPendingScrollPositionOffset;
                    }
                    return true;
                }
            }
    ...
    private void E(RecyclerView.Recycler recycler, RecyclerView.State state, AnchorInfo anchorInfo) {
        ...
        anchorInfo.f4811b = i10;
    }

    private void F(int i10, int i11, boolean z10, RecyclerView.State state) {
        int i12;
        int m10;
        this.mLayoutState.f4831m = resolveIsInfinite();
        this.mLayoutState.f4824f = i10;
        ...
        layoutState.f4826h = i12;
        if (!z11) {
            max = max2;
        }
        layoutState.f4827i = max;
        if (z11) {
            layoutState.f4826h = i12 + this.mOrientationHelper.j();
            View t10 = t();
            LayoutState layoutState2 = this.mLayoutState;
            if (this.mShouldReverseLayout) {
                i13 = -1;
            }
            layoutState2.f4823e = i13;
            int position = getPosition(t10);
            LayoutState layoutState3 = this.mLayoutState;
            layoutState2.f4822d = position + layoutState3.f4823e;
            layoutState3.f4820b = this.mOrientationHelper.d(t10);
            m10 = this.mOrientationHelper.d(t10) - this.mOrientationHelper.i();
        } else {
            View u10 = u();
            this.mLayoutState.f4826h += this.mOrientationHelper.m();
            LayoutState layoutState4 = this.mLayoutState;
            if (!this.mShouldReverseLayout) {
                i13 = -1;
            }
            layoutState4.f4823e = i13;
            int position2 = getPosition(u10);
            LayoutState layoutState5 = this.mLayoutState;
            layoutState4.f4822d = position2 + layoutState5.f4823e;
            layoutState5.f4820b = this.mOrientationHelper.g(u10);
            m10 = (-this.mOrientationHelper.g(u10)) + this.mOrientationHelper.m();
        }
        LayoutState layoutState6 = this.mLayoutState;
        layoutState6.f4821c = i11;
        if (z10) {
            layoutState6.f4821c = i11 - m10;
        }
        layoutState6.f4825g = m10;
    }

    private void G(int i10, int i11) {
        int i12;
        this.mLayoutState.f4821c = this.mOrientationHelper.i() - i11;
        LayoutState layoutState = this.mLayoutState;
        if (this.mShouldReverseLayout) {
            i12 = -1;
        } else {
        ...
        layoutState.f4823e = i12;
        layoutState.f4822d = i10;
        layoutState.f4824f = 1;
        layoutState.f4820b = i11;
        layoutState.f4825g = Integer.MIN_VALUE;
    }

    private void H(AnchorInfo anchorInfo) {
        G(anchorInfo.f4811b, anchorInfo.f4812c);
    }

    private void I(int i10, int i11) {
        int i12;
        this.mLayoutState.f4821c = i11 - this.mOrientationHelper.m();
        LayoutState layoutState = this.mLayoutState;
        layoutState.f4822d = i10;
        if (this.mShouldReverseLayout) {
            i12 = 1;
    ...
    private void J(AnchorInfo anchorInfo) {
        I(anchorInfo.f4811b, anchorInfo.f4812c);
    }
    ...
    private void v(RecyclerView.Recycler recycler, RecyclerView.State state, int i10, int i11) {
        ...
        if (state.g() && getChildCount() != 0 && !state.e() && supportsPredictiveItemAnimations()) {
            ...
            this.mLayoutState.f4830l = k10;
            if (i12 > 0) {
                I(getPosition(u()), i10);
                LayoutState layoutState = this.mLayoutState;
                layoutState.f4826h = i12;
                layoutState.f4821c = 0;
                layoutState.a();
            ...
            if (i13 > 0) {
                G(getPosition(t()), i11);
                LayoutState layoutState2 = this.mLayoutState;
                layoutState2.f4826h = i13;
                layoutState2.f4821c = 0;
                layoutState2.a();
                fill(recycler, this.mLayoutState, state, false);
            }
            this.mLayoutState.f4830l = null;
        }
    }
    ...
    private void x(RecyclerView.Recycler recycler, LayoutState layoutState) {
        if (layoutState.f4819a && !layoutState.f4831m) {
            int i10 = layoutState.f4825g;
            int i11 = layoutState.f4827i;
            if (layoutState.f4824f == -1) {
                z(recycler, i10, i11);
            } else {
                A(recycler, i10, i11);
            }
    ...
    public void collectInitialPrefetchPositions(int i10, RecyclerView.LayoutManager.LayoutPrefetchRegistry layoutPrefetchRegistry) {
        ...
        if (savedState != null && savedState.a()) {
            ...
            z10 = savedState2.f4834i;
            i11 = savedState2.f4832d;
        } else {
            B();
    ...
    void collectPrefetchPositionsForLayoutState(RecyclerView.State state, LayoutState layoutState, RecyclerView.LayoutManager.LayoutPrefetchRegistry layoutPrefetchRegistry) {
        int i10 = layoutState.f4822d;
        if (i10 >= 0 && i10 < state.b()) {
            layoutPrefetchRegistry.a(i10, Math.max(0, layoutState.f4825g));
        }
    }
    ...
    int fill(RecyclerView.Recycler recycler, LayoutState layoutState, RecyclerView.State state, boolean z10) {
        int i10 = layoutState.f4821c;
        int i11 = layoutState.f4825g;
        if (i11 != Integer.MIN_VALUE) {
            if (i10 < 0) {
                layoutState.f4825g = i11 + i10;
            }
            x(recycler, layoutState);
        }
        int i12 = layoutState.f4821c + layoutState.f4826h;
        LayoutChunkResult layoutChunkResult = this.mLayoutChunkResult;
        while (true) {
            if ((!layoutState.f4831m && i12 <= 0) || !layoutState.c(state)) {
                break;
            }
            layoutChunkResult.a();
            layoutChunk(recycler, state, layoutState, layoutChunkResult);
            if (!layoutChunkResult.f4816b) {
                layoutState.f4820b += layoutChunkResult.f4815a * layoutState.f4824f;
                if (!layoutChunkResult.f4817c || layoutState.f4830l != null || !state.e()) {
                    int i13 = layoutState.f4821c;
                    int i14 = layoutChunkResult.f4815a;
                    layoutState.f4821c = i13 - i14;
                    i12 -= i14;
                }
                int i15 = layoutState.f4825g;
                if (i15 != Integer.MIN_VALUE) {
                    int i16 = i15 + layoutChunkResult.f4815a;
                    layoutState.f4825g = i16;
                    int i17 = layoutState.f4821c;
                    if (i17 < 0) {
                        layoutState.f4825g = i16 + i17;
                    }
                    x(recycler, layoutState);
                }
                if (z10 && layoutChunkResult.f4818d) {
                    break;
                }
            } else {
                break;
    ...
    void layoutChunk(RecyclerView.Recycler recycler, RecyclerView.State state, LayoutState layoutState, LayoutChunkResult layoutChunkResult) {
        ...
        if (d10 == null) {
            layoutChunkResult.f4816b = true;
            return;
        }
        RecyclerView.LayoutParams layoutParams = (RecyclerView.LayoutParams) d10.getLayoutParams();
        if (layoutState.f4830l == null) {
        ...
        layoutChunkResult.f4815a = this.mOrientationHelper.e(d10);
        if (this.mOrientation == 1) {
            if (isLayoutRTL()) {
            ...
            if (layoutState.f4824f == -1) {
                i15 = layoutState.f4820b;
                i14 = i15 - layoutChunkResult.f4815a;
            } else {
                i14 = layoutState.f4820b;
                i15 = layoutChunkResult.f4815a + i14;
            }
            int i16 = paddingLeft;
            i13 = i14;
            i12 = i16;
            ...
            if (layoutState.f4824f == -1) {
                int i17 = layoutState.f4820b;
                i12 = i17 - layoutChunkResult.f4815a;
                i10 = i17;
                i11 = f11;
            } else {
                int i18 = layoutState.f4820b;
                i10 = layoutChunkResult.f4815a + i18;
                i11 = f11;
                i12 = i18;
            }
            i13 = paddingTop;
        ...
        if (layoutParams.c() || layoutParams.b()) {
            layoutChunkResult.f4817c = true;
        }
        layoutChunkResult.f4818d = d10.hasFocusable();
    }
    ...
    public void onLayoutChildren(RecyclerView.Recycler recycler, RecyclerView.State state) {
        ...
        SavedState savedState = this.mPendingSavedState;
        if (savedState != null && savedState.a()) {
            this.mPendingScrollPosition = this.mPendingSavedState.f4832d;
        }
        ensureLayoutState();
        this.mLayoutState.f4819a = false;
        B();
        View focusedChild = getFocusedChild();
        AnchorInfo anchorInfo = this.mAnchorInfo;
        if (anchorInfo.f4814e && this.mPendingScrollPosition == -1 && this.mPendingSavedState == null) {
            ...
            anchorInfo2.f4813d = this.mShouldReverseLayout ^ this.mStackFromEnd;
            E(recycler, state, anchorInfo2);
            this.mAnchorInfo.f4814e = true;
        }
        LayoutState layoutState = this.mLayoutState;
        if (layoutState.f4829k >= 0) {
            i10 = 1;
        } else {
            i10 = -1;
        }
        layoutState.f4824f = i10;
        int[] iArr = this.mReusableIntPair;
        iArr[0] = 0;
        iArr[1] = 0;
        calculateExtraLayoutSpace(state, iArr);
        ...
        if (!anchorInfo3.f4813d ? !this.mShouldReverseLayout : this.mShouldReverseLayout) {
            i17 = 1;
        }
        onAnchorReady(recycler, state, anchorInfo3, i17);
        detachAndScrapAttachedViews(recycler);
        this.mLayoutState.f4831m = resolveIsInfinite();
        this.mLayoutState.f4828j = state.e();
        this.mLayoutState.f4827i = 0;
        AnchorInfo anchorInfo4 = this.mAnchorInfo;
        if (anchorInfo4.f4813d) {
            J(anchorInfo4);
            LayoutState layoutState2 = this.mLayoutState;
            layoutState2.f4826h = max;
            fill(recycler, layoutState2, state, false);
            LayoutState layoutState3 = this.mLayoutState;
            i12 = layoutState3.f4820b;
            int i19 = layoutState3.f4822d;
            int i20 = layoutState3.f4821c;
            if (i20 > 0) {
                max2 += i20;
            }
            H(this.mAnchorInfo);
            LayoutState layoutState4 = this.mLayoutState;
            layoutState4.f4826h = max2;
            layoutState4.f4822d += layoutState4.f4823e;
            fill(recycler, layoutState4, state, false);
            LayoutState layoutState5 = this.mLayoutState;
            i11 = layoutState5.f4820b;
            int i21 = layoutState5.f4821c;
            if (i21 > 0) {
                I(i19, i12);
                LayoutState layoutState6 = this.mLayoutState;
                layoutState6.f4826h = i21;
                fill(recycler, layoutState6, state, false);
                i12 = this.mLayoutState.f4820b;
            }
        } else {
            H(anchorInfo4);
            LayoutState layoutState7 = this.mLayoutState;
            layoutState7.f4826h = max2;
            fill(recycler, layoutState7, state, false);
            LayoutState layoutState8 = this.mLayoutState;
            i11 = layoutState8.f4820b;
            int i22 = layoutState8.f4822d;
            int i23 = layoutState8.f4821c;
            if (i23 > 0) {
                max += i23;
            }
            J(this.mAnchorInfo);
            LayoutState layoutState9 = this.mLayoutState;
            layoutState9.f4826h = max;
            layoutState9.f4822d += layoutState9.f4823e;
            fill(recycler, layoutState9, state, false);
            LayoutState layoutState10 = this.mLayoutState;
            i12 = layoutState10.f4820b;
            int i24 = layoutState10.f4821c;
            if (i24 > 0) {
                G(i22, i11);
                LayoutState layoutState11 = this.mLayoutState;
                layoutState11.f4826h = i24;
                fill(recycler, layoutState11, state, false);
                i11 = this.mLayoutState.f4820b;
            }
        }
        if (getChildCount() > 0) {
    ...
    public Parcelable onSaveInstanceState() {
        ...
        if (getChildCount() > 0) {
            ...
            savedState.f4834i = z10;
            if (z10) {
                View t10 = t();
                savedState.f4833e = this.mOrientationHelper.i() - this.mOrientationHelper.d(t10);
                savedState.f4832d = getPosition(t10);
                return savedState;
            }
            View u10 = u();
            savedState.f4832d = getPosition(u10);
            savedState.f4833e = this.mOrientationHelper.g(u10) - this.mOrientationHelper.m();
            return savedState;
        }
        savedState.b();
        return savedState;
    ...
    int scrollBy(int i10, RecyclerView.Recycler recycler, RecyclerView.State state) {
        ...
        LayoutState layoutState = this.mLayoutState;
        int fill = layoutState.f4825g + fill(recycler, layoutState, state, false);
        if (fill < 0) {
            return 0;
        }
        if (abs > fill) {
    ...
    public LinearLayoutManager(Context context, AttributeSet attributeSet, int i10, int i11) {
        ...
        setStackFromEnd(properties.f4849d);
    }
}
