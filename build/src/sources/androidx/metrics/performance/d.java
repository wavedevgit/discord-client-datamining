...
public class d extends o3.c {
    ...
    private static Handler f4770q;

    /* renamed from: j  reason: collision with root package name */
    private final Window f4771j;
    ...
    private final o3.a f4775n;

    /* renamed from: o  reason: collision with root package name */
    private final Window.OnFrameMetricsAvailableListener f4776o;
    ...
    public d(final JankStats jankStats, View view, Window window) {
        ...
        this.f4771j = window;
        this.f4775n = new o3.a(0L, 0L, 0L, false, h());
        this.f4776o = new Window.OnFrameMetricsAvailableListener() { // from class: o3.d
    ...
    public static final void j(d this$0, JankStats jankStats, Window window, FrameMetrics frameMetrics, int i10) {
        ...
        long max = Math.max(this$0.m(frameMetrics), this$0.f4774m);
        if (max >= this$0.f4773l && max != this$0.f4772k) {
    ...
    private final androidx.metrics.performance.a n(Window window) {
        androidx.metrics.performance.a aVar = (androidx.metrics.performance.a) window.getDecorView().getTag(o3.g.f40232a);
        if (aVar == null) {
            androidx.metrics.performance.a aVar2 = new androidx.metrics.performance.a(new ArrayList());
            if (f4770q == null) {
                HandlerThread handlerThread = new HandlerThread("FrameMetricsAggregator");
                handlerThread.start();
                f4770q = new Handler(handlerThread.getLooper());
            }
            window.addOnFrameMetricsAvailableListener(aVar2, f4770q);
            window.getDecorView().setTag(o3.g.f40232a, aVar2);
            return aVar2;
        }
        return aVar;
    }
    ...
    public void c(boolean z10) {
        synchronized (this.f4771j) {
            try {
                if (z10) {
                    if (this.f4773l == 0) {
                        n(this.f4771j).a(this.f4776o);
                        this.f4773l = System.nanoTime();
                    }
                } else {
                    p(this.f4771j, this.f4776o);
                    this.f4773l = 0L;
                }
    ...
    public o3.a l(long j10, long j11, FrameMetrics frameMetrics) {
        ...
        this.f4774m = j10 + metric;
        g a10 = g().a();
        if (a10 != null) {
            a10.c(j10, this.f4774m, h());
        }
        if (metric > j11) {
            z10 = true;
        } else {
        ...
        this.f4775n.g(j10, metric, frameMetrics.getMetric(8), z10);
        return this.f4775n;
    }
