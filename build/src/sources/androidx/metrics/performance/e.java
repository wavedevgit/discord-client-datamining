...
public final class e extends o3.e {
    ...
    public e(JankStats jankStats, View view, Window window) {
        ...
        this.f5080r = new o3.b(0L, 0L, 0L, 0L, 0L, false, h());
    }
    ...
    public o3.b l(long j10, long j11, FrameMetrics frameMetrics) {
        ...
        this.f5080r.h(j10, metric, (metric2 - frameMetrics.getMetric(12)) + frameMetrics.getMetric(7), metric2, metric2 - frameMetrics.getMetric(13), z10);
        return this.f5080r;
    }
}
