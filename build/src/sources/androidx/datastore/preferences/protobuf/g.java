...
public abstract class g implements Iterable, Serializable {
    ...
    public static final g f3591e = new i(y.f3844c);

    /* renamed from: i  reason: collision with root package name */
    private static final f f3592i;

    /* renamed from: o  reason: collision with root package name */
    private static final Comparator f3593o;

    /* renamed from: d  reason: collision with root package name */
    private int f3594d = 0;
    ...
    static class b implements Comparator {
        ...
        public int compare(g gVar, g gVar2) {
            InterfaceC0042g k10 = gVar.k();
            InterfaceC0042g k11 = gVar2.k();
    ...
    public static final class e extends i {
        ...
        public byte c(int i10) {
            g.d(i10, size());
            return this.f3600p[this.f3598q + i10];
        }
    ...
    public static class i extends h {
        ...
        public final boolean j() {
            int x10 = x();
            return p1.n(this.f3600p, x10, size() + x10);
        }

        @Override // androidx.datastore.preferences.protobuf.g
        protected final int m(int i10, int i11, int i12) {
            return y.i(i10, this.f3600p, x() + i11, i12);
        }
        ...
        public final g o(int i10, int i11) {
            ...
            return new e(this.f3600p, x() + i10, e10);
        }

        @Override // androidx.datastore.preferences.protobuf.g
        protected final String r(Charset charset) {
            return new String(this.f3600p, x(), size(), charset);
        }

        @Override // androidx.datastore.preferences.protobuf.g
        public int size() {
            return this.f3600p.length;
        }

        @Override // androidx.datastore.preferences.protobuf.g
        final void v(androidx.datastore.preferences.protobuf.f fVar) {
            fVar.a(this.f3600p, x(), size());
        }
            ...
            if (i11 <= gVar.size()) {
                ...
                if (i12 <= gVar.size()) {
                    if (gVar instanceof i) {
                        i iVar = (i) gVar;
                        byte[] bArr = this.f3600p;
                        byte[] bArr2 = iVar.f3600p;
                        int x10 = x() + i11;
                        int x11 = x();
                        int x12 = iVar.x() + i10;
                        while (x11 < x10) {
    ...
    public static g g(byte[] bArr, int i10, int i11) {
        ...
        return new i(f3592i.a(bArr, i10, i11));
    }

    public static g h(String str) {
        return new i(str.getBytes(y.f3842a));
    }
