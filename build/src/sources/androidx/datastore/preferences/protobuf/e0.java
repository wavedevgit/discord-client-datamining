...
abstract class e0 {
    ...
    private static final e0 f3597a = new b();

    /* renamed from: b  reason: collision with root package name */
    private static final e0 f3598b = new c();

    /* loaded from: /home/runner/work/discord-client-datamining/discord-client-datamining/build/classes.dex */
    private static final class b extends e0 {

        /* renamed from: c  reason: collision with root package name */
        private static final Class f3599c = Collections.unmodifiableList(Collections.EMPTY_LIST).getClass();
        ...
        private static List g(Object obj, long j10, int i10) {
            ...
            if (f10.isEmpty()) {
                if (f10 instanceof d0) {
                    ...
                    arrayList = ((y.b) f10).E0(i10);
                } else {
                    arrayList = new ArrayList(i10);
                }
                o1.O(obj, j10, arrayList);
                return arrayList;
            } else if (f3599c.isAssignableFrom(f10.getClass())) {
        ...
        void c(Object obj, long j10) {
            ...
            } else if (!f3599c.isAssignableFrom(list.getClass())) {
