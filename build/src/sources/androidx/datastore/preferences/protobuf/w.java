...
public abstract class w extends androidx.datastore.preferences.protobuf.a {
    ...
    public static abstract class a extends a.AbstractC0044a {
        ...
        private final w f3981d;

        /* renamed from: e  reason: collision with root package name */
        protected w f3982e;

        /* renamed from: i  reason: collision with root package name */
        protected boolean f3983i = false;

        /* JADX INFO: Access modifiers changed from: protected */
        public a(w wVar) {
            this.f3981d = wVar;
            this.f3982e = (w) wVar.k(d.NEW_MUTABLE_INSTANCE);
        }
        ...
        public void k() {
            if (this.f3983i) {
                w wVar = (w) this.f3982e.k(d.NEW_MUTABLE_INSTANCE);
                o(wVar, this.f3982e);
                this.f3982e = wVar;
                this.f3983i = false;
            }
