...
public abstract class w extends androidx.datastore.preferences.protobuf.a {
    ...
    public static abstract class a extends a.AbstractC0041a {
        ...
        protected boolean f3989i = false;

        /* JADX INFO: Access modifiers changed from: protected */
        public a(w wVar) {
            this.f3987d = wVar;
            this.f3988e = (w) wVar.k(d.NEW_MUTABLE_INSTANCE);
        }
        ...
        public void k() {
            if (this.f3989i) {
                w wVar = (w) this.f3988e.k(d.NEW_MUTABLE_INSTANCE);
                o(wVar, this.f3988e);
                this.f3988e = wVar;
                this.f3989i = false;
            }
