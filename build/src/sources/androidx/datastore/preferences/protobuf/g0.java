...
public final class g0 implements e1 {
    ...
    private static final n0 f3645b = new a();

    /* renamed from: a  reason: collision with root package name */
    private final n0 f3646a;
    ...
    public static class b implements n0 {
        ...
        b(n0... n0VarArr) {
            this.f3647a = n0VarArr;
        }

        @Override // androidx.datastore.preferences.protobuf.n0
        public m0 a(Class cls) {
            n0[] n0VarArr;
            for (n0 n0Var : this.f3647a) {
                if (n0Var.b(cls)) {
                    return n0Var.a(cls);
                }
            }
    ...
    private g0(n0 n0Var) {
        this.f3646a = (n0) y.b(n0Var, "messageInfoFactory");
    }
}
