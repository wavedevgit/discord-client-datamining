...
public final class IncorrectJpegMetadataQuirk implements y1 {
    ...
    private static final Set f2151a = new HashSet(Arrays.asList("A24"));
    ...
    private static boolean e() {
        if ("Samsung".equalsIgnoreCase(Build.BRAND) && f2151a.contains(Build.DEVICE.toUpperCase(Locale.US))) {
            return true;
        }
        return false;
    }
