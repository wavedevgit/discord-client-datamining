...
public abstract class ImageProcessingUtil {
    ...
    private static a d(n nVar) {
        ...
        int g10 = nVar.Z0()[0].g();
        int g11 = nVar.Z0()[1].g();
        if (nativeShiftPixel(nVar.Z0()[0].e(), f10, nVar.Z0()[1].e(), f11, nVar.Z0()[2].e(), f12, g10, g11, width, height, g10, g11, g11) != 0) {
    ...
    public static Bitmap f(n nVar) {
        if (nVar.getFormat() == 35) {
            ...
            if (nativeConvertAndroid420ToBitmap(nVar.Z0()[0].e(), f10, nVar.Z0()[1].e(), f11, nVar.Z0()[2].e(), f12, g10, g11, createBitmap, createBitmap.getRowBytes(), width, height) == 0) {
                return createBitmap;
            }
    ...
    public static n g(final n nVar, j1 j1Var, ByteBuffer byteBuffer, int i10, boolean z10) {
        ...
        if (!k(i10)) {
            ...
            if (Log.isLoggable("MH", 3)) {
                y0.a("ImageProcessingUtil", String.format(Locale.US, "Image processing performance profiling, duration: [%d], image count: %d", Long.valueOf(System.currentTimeMillis() - currentTimeMillis), Integer.valueOf(f2078a)));
                f2078a++;
            }
            final n b10 = j1Var.b();
            if (b10 == null) {
    ...
    private static a h(n nVar, Surface surface, ByteBuffer byteBuffer, int i10, boolean z10) {
        ...
        if (nativeConvertAndroid420ToABGR(nVar.Z0()[0].e(), f10, nVar.Z0()[1].e(), f11, nVar.Z0()[2].e(), f12, g10, g11, surface, byteBuffer, width, height, i11, i12, i13, i10) != 0) {
            return a.ERROR_CONVERSION;
        }
        return a.SUCCESS;
    }
    ...
    private static boolean l(n nVar) {
        if (nVar.getFormat() == 35 && nVar.Z0().length == 3) {
            return true;
        }
        return false;
    }
    ...
    private static a n(n nVar, ImageWriter imageWriter, ByteBuffer byteBuffer, ByteBuffer byteBuffer2, ByteBuffer byteBuffer3, int i10) {
        ...
        if (nativeRotateYUV(nVar.Z0()[0].e(), f10, nVar.Z0()[1].e(), f11, nVar.Z0()[2].e(), f12, g10, b10.getPlanes()[0].getBuffer(), b10.getPlanes()[0].getRowStride(), b10.getPlanes()[0].getPixelStride(), b10.getPlanes()[1].getBuffer(), b10.getPlanes()[1].getRowStride(), b10.getPlanes()[1].getPixelStride(), b10.getPlanes()[2].getBuffer(), b10.getPlanes()[2].getRowStride(), b10.getPlanes()[2].getPixelStride(), byteBuffer, byteBuffer2, byteBuffer3, width, height, i10) != 0) {
            return a.ERROR_CONVERSION;
        }
