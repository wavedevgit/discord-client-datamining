...
public abstract class ImageProcessingUtil {
    ...
    private static a d(n nVar) {
        ...
        int h10 = nVar.e1()[0].h();
        int h11 = nVar.e1()[1].h();
        if (nativeShiftPixel(nVar.e1()[0].f(), g10, nVar.e1()[1].f(), g11, nVar.e1()[2].f(), g12, h10, h11, width, height, h10, h11, h11) != 0) {
    ...
    public static Bitmap f(n nVar) {
        if (nVar.getFormat() == 35) {
            ...
            if (nativeConvertAndroid420ToBitmap(nVar.e1()[0].f(), g10, nVar.e1()[1].f(), g11, nVar.e1()[2].f(), g12, h10, h11, createBitmap, createBitmap.getRowBytes(), width, height) == 0) {
                return createBitmap;
            }
    ...
    public static n g(final n nVar, j1 j1Var, ByteBuffer byteBuffer, int i10, boolean z10) {
        ...
        if (!k(i10)) {
            ...
            if (Log.isLoggable("MH", 3)) {
                y0.a("ImageProcessingUtil", String.format(Locale.US, "Image processing performance profiling, duration: [%d], image count: %d", Long.valueOf(System.currentTimeMillis() - currentTimeMillis), Integer.valueOf(f2081a)));
                f2081a++;
            }
            final n b10 = j1Var.b();
            if (b10 == null) {
    ...
    private static a h(n nVar, Surface surface, ByteBuffer byteBuffer, int i10, boolean z10) {
        ...
        if (nativeConvertAndroid420ToABGR(nVar.e1()[0].f(), g10, nVar.e1()[1].f(), g11, nVar.e1()[2].f(), g12, h10, h11, surface, byteBuffer, width, height, i11, i12, i13, i10) != 0) {
            return a.ERROR_CONVERSION;
        }
        return a.SUCCESS;
    }
    ...
    private static boolean l(n nVar) {
        if (nVar.getFormat() == 35 && nVar.e1().length == 3) {
            return true;
        }
        return false;
    }
    ...
    private static a n(n nVar, ImageWriter imageWriter, ByteBuffer byteBuffer, ByteBuffer byteBuffer2, ByteBuffer byteBuffer3, int i10) {
        ...
        if (nativeRotateYUV(nVar.e1()[0].f(), g10, nVar.e1()[1].f(), g11, nVar.e1()[2].f(), g12, h10, b10.getPlanes()[0].getBuffer(), b10.getPlanes()[0].getRowStride(), b10.getPlanes()[0].getPixelStride(), b10.getPlanes()[1].getBuffer(), b10.getPlanes()[1].getRowStride(), b10.getPlanes()[1].getPixelStride(), b10.getPlanes()[2].getBuffer(), b10.getPlanes()[2].getRowStride(), b10.getPlanes()[2].getPixelStride(), byteBuffer, byteBuffer2, byteBuffer3, width, height, i10) != 0) {
            return a.ERROR_CONVERSION;
        }
