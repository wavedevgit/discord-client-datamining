...
public final class t extends i {
    ...
    SurfaceTexture f2186f;

    /* renamed from: g  reason: collision with root package name */
    ListenableFuture f2187g;
    ...
    SurfaceTexture f2190j;

    /* renamed from: k  reason: collision with root package name */
    AtomicReference f2191k;
    ...
    public class a implements TextureView.SurfaceTextureListener {
        ...
        /* loaded from: /home/runner/work/discord-client-datamining/discord-client-datamining/build/classes.dex */
        class C0027a implements d0.c {

            /* renamed from: a  reason: collision with root package name */
            final /* synthetic */ SurfaceTexture f2195a;

            C0027a(SurfaceTexture surfaceTexture) {
                this.f2195a = surfaceTexture;
            }
        ...
        public void onSurfaceTextureAvailable(SurfaceTexture surfaceTexture, int i10, int i11) {
            ...
            t tVar = t.this;
            tVar.f2186f = surfaceTexture;
            if (tVar.f2187g != null) {
                b2.e.g(tVar.f2188h);
                y0.a("TextureViewImpl", "Surface invalidated " + t.this.f2188h);
                t.this.f2188h.m().d();
                return;
            }
            tVar.q();
        ...
        public boolean onSurfaceTextureDestroyed(SurfaceTexture surfaceTexture) {
            t tVar = t.this;
            tVar.f2186f = null;
            ListenableFuture listenableFuture = tVar.f2187g;
            if (listenableFuture != null) {
                d0.n.j(listenableFuture, new C0027a(surfaceTexture), androidx.core.content.a.h(t.this.f2185e.getContext()));
                t.this.f2190j = surfaceTexture;
                return false;
            }
        ...
        public void onSurfaceTextureUpdated(SurfaceTexture surfaceTexture) {
            c.a aVar = (c.a) t.this.f2191k.getAndSet(null);
            if (aVar != null) {
                aVar.c(null);
            }
            t.this.getClass();
            Executor executor = t.this.f2193m;
        }
    }
    ...
    public static /* synthetic */ Object j(t tVar, Surface surface, final c.a aVar) {
        ...
        return "provideSurface[request=" + tVar.f2188h + " surface=" + surface + "]";
    }
    ...
    public static /* synthetic */ void k(t tVar, Surface surface, ListenableFuture listenableFuture, w1 w1Var) {
        ...
        tVar.o();
        surface.release();
        if (tVar.f2187g == listenableFuture) {
            tVar.f2187g = null;
        }
        if (tVar.f2188h == w1Var) {
            tVar.f2188h = null;
        }
    }

    public static /* synthetic */ void l(t tVar, w1 w1Var) {
        w1 w1Var2 = tVar.f2188h;
    ...
    public static /* synthetic */ Object m(t tVar, c.a aVar) {
        tVar.f2191k.set(aVar);
        return "textureViewImpl_waitForNextFrame";
    }

    private void o() {
        i.a aVar = this.f2192l;
        if (aVar != null) {
            aVar.a();
            this.f2192l = null;
        }
    ...
    public void g(final w1 w1Var, i.a aVar) {
        ...
        this.f2192l = aVar;
        n();
        w1 w1Var2 = this.f2188h;
        if (w1Var2 != null) {
            w1Var2.v();
        }
        this.f2188h = w1Var;
        w1Var.j(androidx.core.content.a.h(this.f2185e.getContext()), new Runnable() { // from class: androidx.camera.view.p
    ...
    public ListenableFuture i() {
        return androidx.concurrent.futures.c.a(new c.InterfaceC0030c() { // from class: androidx.camera.view.q
    ...
    public void n() {
        b2.e.g(this.f2152b);
        b2.e.g(this.f2151a);
        TextureView textureView = new TextureView(this.f2152b.getContext());
        this.f2185e = textureView;
        textureView.setLayoutParams(new FrameLayout.LayoutParams(this.f2151a.getWidth(), this.f2151a.getHeight()));
        this.f2185e.setSurfaceTextureListener(new a());
        this.f2152b.removeAllViews();
        this.f2152b.addView(this.f2185e);
    }

    void q() {
        SurfaceTexture surfaceTexture;
        Size size = this.f2151a;
        if (size != null && (surfaceTexture = this.f2186f) != null && this.f2188h != null) {
            surfaceTexture.setDefaultBufferSize(size.getWidth(), this.f2151a.getHeight());
            final Surface surface = new Surface(this.f2186f);
            final w1 w1Var = this.f2188h;
            final ListenableFuture a10 = androidx.concurrent.futures.c.a(new c.InterfaceC0030c() { // from class: androidx.camera.view.r
                @Override // androidx.concurrent.futures.c.InterfaceC0030c
                public final Object a(c.a aVar) {
            ...
            }, androidx.core.content.a.h(this.f2185e.getContext()));
            f();
        }
    }
}
