...
public final class e {
    ...
    private static final PreviewView.d f2089i = PreviewView.d.FILL_CENTER;
    ...
    private PreviewView.d f2097h = f2089i;
    ...
    public static /* synthetic */ class a {
        ...
        static {
            ...
            try {
                f2098a[PreviewView.d.FILL_CENTER.ordinal()] = 2;
            } catch (NoSuchFieldError unused2) {
            }
            try {
                f2098a[PreviewView.d.FIT_END.ordinal()] = 3;
            } catch (NoSuchFieldError unused3) {
            }
            try {
                f2098a[PreviewView.d.FILL_END.ordinal()] = 4;
            } catch (NoSuchFieldError unused4) {
            }
            try {
                f2098a[PreviewView.d.FIT_START.ordinal()] = 5;
            } catch (NoSuchFieldError unused5) {
            }
            try {
                f2098a[PreviewView.d.FILL_START.ordinal()] = 6;
    ...
    private int e() {
        ...
        return -b0.c.b(this.f2094e);
    }

    private Size f() {
        if (b0.q.i(this.f2092c)) {
            return new Size(this.f2091b.height(), this.f2091b.width());
        }
        return new Size(this.f2091b.width(), this.f2091b.height());
    }

    private RectF l(Size size, int i10) {
        b2.e.i(m());
        Matrix j10 = j(size, i10);
        RectF rectF = new RectF(0.0f, 0.0f, this.f2090a.getWidth(), this.f2090a.getHeight());
        j10.mapRect(rectF);
        return rectF;
    }
    ...
    private boolean m() {
        boolean z10;
        if (this.f2096g && this.f2094e == -1) {
            z10 = false;
        } else {
            z10 = true;
        }
        if (this.f2091b != null && this.f2090a != null && z10) {
            return true;
        }
        return false;
    }
    ...
    public Bitmap a(Bitmap bitmap, Size size, int i10) {
        ...
        matrix.postScale(l10.width() / this.f2090a.getWidth(), l10.height() / this.f2090a.getHeight());
    ...
    RectF d(Size size, int i10) {
        ...
        Matrix matrix = new Matrix();
        p(matrix, rectF2, rectF, this.f2097h);
    ...
    public Matrix h(Size size, int i10) {
        ...
        Matrix matrix = new Matrix(this.f2093d);
    ...
    public Matrix j(Size size, int i10) {
        ...
        Matrix d11 = b0.q.d(new RectF(this.f2091b), d10, this.f2092c);
        if (this.f2095f && this.f2096g) {
            if (b0.q.i(this.f2092c)) {
                d11.preScale(1.0f, -1.0f, this.f2091b.centerX(), this.f2091b.centerY());
                return d11;
            }
            d11.preScale(-1.0f, 1.0f, this.f2091b.centerX(), this.f2091b.centerY());
        }
    ...
    public void s(Size size, int i10, View view) {
        ...
        if (size.getHeight() != 0 && size.getWidth() != 0) {
            ...
            if (view instanceof TextureView) {
                ...
                boolean z11 = false;
                if (this.f2096g && display != null && display.getRotation() != this.f2094e) {
                    z10 = true;
                } else {
                    z10 = false;
                }
            ...
            view.setPivotX(0.0f);
            view.setPivotY(0.0f);
            view.setScaleX(l10.width() / this.f2090a.getWidth());
            view.setScaleY(l10.height() / this.f2090a.getHeight());
