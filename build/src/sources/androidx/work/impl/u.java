...
public class u implements androidx.work.impl.foreground.a {
    ...
    private static final String f5753l = k4.m.i("Processor");

    /* renamed from: b  reason: collision with root package name */
    private Context f5755b;

    /* renamed from: c  reason: collision with root package name */
    private androidx.work.a f5756c;

    /* renamed from: d  reason: collision with root package name */
    private r4.b f5757d;

    /* renamed from: e  reason: collision with root package name */
    private WorkDatabase f5758e;

    /* renamed from: g  reason: collision with root package name */
    private Map f5760g = new HashMap();

    /* renamed from: f  reason: collision with root package name */
    private Map f5759f = new HashMap();

    /* renamed from: i  reason: collision with root package name */
    private Set f5762i = new HashSet();

    /* renamed from: j  reason: collision with root package name */
    private final List f5763j = new ArrayList();

    /* renamed from: a  reason: collision with root package name */
    private PowerManager.WakeLock f5754a = null;

    /* renamed from: k  reason: collision with root package name */
    private final Object f5764k = new Object();

    /* renamed from: h  reason: collision with root package name */
    private Map f5761h = new HashMap();
    ...
    public static /* synthetic */ p4.u b(u uVar, ArrayList arrayList, String str) {
        arrayList.addAll(uVar.f5758e.I().a(str));
        return uVar.f5758e.H().i(str);
    }

    public static /* synthetic */ void c(u uVar, p4.m mVar, boolean z10) {
        synchronized (uVar.f5764k) {
            try {
                for (f fVar : uVar.f5763j) {
                    fVar.b(mVar, z10);
                }
            } catch (Throwable th2) {
                throw th2;
    ...
    private t0 f(String str) {
        boolean z10;
        t0 t0Var = (t0) this.f5759f.remove(str);
        if (t0Var != null) {
            z10 = true;
        } else {
            z10 = false;
        ...
        if (!z10) {
            t0Var = (t0) this.f5760g.remove(str);
        }
        this.f5761h.remove(str);
        if (z10) {
            r();
        }
        return t0Var;
    ...
    private t0 h(String str) {
        t0 t0Var = (t0) this.f5759f.get(str);
        if (t0Var == null) {
            return (t0) this.f5760g.get(str);
        }
        return t0Var;
    }
    ...
    private void n(final p4.m mVar, final boolean z10) {
        this.f5757d.a().execute(new Runnable() { // from class: androidx.work.impl.t
    ...
    private void r() {
        synchronized (this.f5764k) {
            try {
                if (this.f5759f.isEmpty()) {
                    this.f5755b.startService(androidx.work.impl.foreground.b.g(this.f5755b));
                    PowerManager.WakeLock wakeLock = this.f5754a;
                    if (wakeLock != null) {
                        wakeLock.release();
                        this.f5754a = null;
                    }
    ...
    public void a(String str, k4.g gVar) {
        synchronized (this.f5764k) {
            try {
                ...
                t0 t0Var = (t0) this.f5760g.remove(str);
                if (t0Var != null) {
                    if (this.f5754a == null) {
                        PowerManager.WakeLock b10 = q4.t.b(this.f5755b, "ProcessorForegroundLck");
                        this.f5754a = b10;
                        b10.acquire();
                    }
                    this.f5759f.put(str, t0Var);
                    androidx.core.content.a.p(this.f5755b, androidx.work.impl.foreground.b.f(this.f5755b, t0Var.d(), gVar));
                }
            } catch (Throwable th2) {
                throw th2;
            }
    ...
    public boolean j(String str) {
        boolean contains;
        synchronized (this.f5764k) {
            contains = this.f5762i.contains(str);
        }
        return contains;
    }
    ...
    public boolean p(a0 a0Var, WorkerParameters.a aVar) {
        ...
        p4.u uVar = (p4.u) this.f5758e.z(new Callable() { // from class: androidx.work.impl.r
        ...
        synchronized (this.f5764k) {
            try {
                try {
                    try {
                        if (k(b10)) {
                            Set set = (Set) this.f5761h.get(b10);
                            ...
                            final t0 b11 = new t0.c(this.f5755b, this.f5756c, this.f5757d, this, this.f5758e, uVar, arrayList).c(aVar).b();
                            ...
                            this.f5760g.put(b10, b11);
                            HashSet hashSet = new HashSet();
                            hashSet.add(a0Var);
                            this.f5761h.put(b10, hashSet);
                            this.f5757d.c().execute(b11);
                            k4.m e12 = k4.m.e();
                            String str3 = f5753l;
