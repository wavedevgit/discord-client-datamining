...
public class u implements androidx.work.impl.foreground.a {
    ...
    private static final String f5709l = k4.m.i("Processor");

    /* renamed from: b  reason: collision with root package name */
    private Context f5711b;

    /* renamed from: c  reason: collision with root package name */
    private androidx.work.a f5712c;

    /* renamed from: d  reason: collision with root package name */
    private r4.b f5713d;

    /* renamed from: e  reason: collision with root package name */
    private WorkDatabase f5714e;

    /* renamed from: g  reason: collision with root package name */
    private Map f5716g = new HashMap();

    /* renamed from: f  reason: collision with root package name */
    private Map f5715f = new HashMap();

    /* renamed from: i  reason: collision with root package name */
    private Set f5718i = new HashSet();

    /* renamed from: j  reason: collision with root package name */
    private final List f5719j = new ArrayList();

    /* renamed from: a  reason: collision with root package name */
    private PowerManager.WakeLock f5710a = null;

    /* renamed from: k  reason: collision with root package name */
    private final Object f5720k = new Object();

    /* renamed from: h  reason: collision with root package name */
    private Map f5717h = new HashMap();
    ...
    public static /* synthetic */ p4.u b(u uVar, ArrayList arrayList, String str) {
        arrayList.addAll(uVar.f5714e.I().a(str));
        return uVar.f5714e.H().i(str);
    }

    public static /* synthetic */ void c(u uVar, p4.m mVar, boolean z10) {
        synchronized (uVar.f5720k) {
            try {
                for (f fVar : uVar.f5719j) {
                    fVar.b(mVar, z10);
                }
            } catch (Throwable th2) {
                throw th2;
    ...
    private t0 f(String str) {
        boolean z10;
        t0 t0Var = (t0) this.f5715f.remove(str);
        if (t0Var != null) {
            z10 = true;
        } else {
            z10 = false;
        ...
        if (!z10) {
            t0Var = (t0) this.f5716g.remove(str);
        }
        this.f5717h.remove(str);
        if (z10) {
            r();
        }
        return t0Var;
    ...
    private t0 h(String str) {
        t0 t0Var = (t0) this.f5715f.get(str);
        if (t0Var == null) {
            return (t0) this.f5716g.get(str);
        }
        return t0Var;
    }
    ...
    private void n(final p4.m mVar, final boolean z10) {
        this.f5713d.a().execute(new Runnable() { // from class: androidx.work.impl.t
        ...
        synchronized (this.f5720k) {
            try {
                if (this.f5715f.isEmpty()) {
                    this.f5711b.startService(androidx.work.impl.foreground.b.g(this.f5711b));
                    PowerManager.WakeLock wakeLock = this.f5710a;
                    if (wakeLock != null) {
                        wakeLock.release();
                        this.f5710a = null;
                    }
    ...
    public void a(String str, k4.g gVar) {
        synchronized (this.f5720k) {
            try {
                ...
                t0 t0Var = (t0) this.f5716g.remove(str);
                if (t0Var != null) {
                    if (this.f5710a == null) {
                        PowerManager.WakeLock b10 = q4.t.b(this.f5711b, "ProcessorForegroundLck");
                        this.f5710a = b10;
                        b10.acquire();
                    }
                    this.f5715f.put(str, t0Var);
                    androidx.core.content.a.p(this.f5711b, androidx.work.impl.foreground.b.f(this.f5711b, t0Var.d(), gVar));
                }
            } catch (Throwable th2) {
                throw th2;
            }
    ...
    public boolean j(String str) {
        boolean contains;
        synchronized (this.f5720k) {
            contains = this.f5718i.contains(str);
        }
        return contains;
    }
    ...
    public boolean p(a0 a0Var, WorkerParameters.a aVar) {
        ...
        p4.u uVar = (p4.u) this.f5714e.z(new Callable() { // from class: androidx.work.impl.r
        ...
        synchronized (this.f5720k) {
            try {
                try {
                    try {
                        if (k(b10)) {
                            Set set = (Set) this.f5717h.get(b10);
                            ...
                            final t0 b11 = new t0.c(this.f5711b, this.f5712c, this.f5713d, this, this.f5714e, uVar, arrayList).c(aVar).b();
                            ...
                            this.f5716g.put(b10, b11);
                            HashSet hashSet = new HashSet();
                            hashSet.add(a0Var);
                            this.f5717h.put(b10, hashSet);
                            this.f5713d.c().execute(b11);
                            k4.m e12 = k4.m.e();
                            String str3 = f5709l;
