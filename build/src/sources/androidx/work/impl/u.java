...
public class u implements androidx.work.impl.foreground.a {
    ...
    private static final String f5860l = k4.m.i("Processor");
    ...
    private Map f5867g = new HashMap();

    /* renamed from: f  reason: collision with root package name */
    private Map f5866f = new HashMap();

    /* renamed from: i  reason: collision with root package name */
    private Set f5869i = new HashSet();

    /* renamed from: j  reason: collision with root package name */
    private final List f5870j = new ArrayList();

    /* renamed from: a  reason: collision with root package name */
    private PowerManager.WakeLock f5861a = null;

    /* renamed from: k  reason: collision with root package name */
    private final Object f5871k = new Object();

    /* renamed from: h  reason: collision with root package name */
    private Map f5868h = new HashMap();
    ...
    public static /* synthetic */ p4.u b(u uVar, ArrayList arrayList, String str) {
        arrayList.addAll(uVar.f5865e.I().a(str));
        return uVar.f5865e.H().i(str);
    }

    public static /* synthetic */ void c(u uVar, p4.m mVar, boolean z10) {
        synchronized (uVar.f5871k) {
            try {
                for (f fVar : uVar.f5870j) {
                    fVar.b(mVar, z10);
                }
            } catch (Throwable th2) {
                throw th2;
    ...
    private t0 f(String str) {
        boolean z10;
        t0 t0Var = (t0) this.f5866f.remove(str);
        if (t0Var != null) {
            z10 = true;
        } else {
            z10 = false;
        ...
        if (!z10) {
            t0Var = (t0) this.f5867g.remove(str);
        }
    ...
    private t0 h(String str) {
        t0 t0Var = (t0) this.f5866f.get(str);
        if (t0Var == null) {
            return (t0) this.f5867g.get(str);
        }
        return t0Var;
    }
    ...
    private void n(final p4.m mVar, final boolean z10) {
        this.f5864d.a().execute(new Runnable() { // from class: androidx.work.impl.t
    ...
    public void a(String str, k4.g gVar) {
        synchronized (this.f5871k) {
            try {
                ...
                t0 t0Var = (t0) this.f5867g.remove(str);
                if (t0Var != null) {
                    if (this.f5861a == null) {
                        PowerManager.WakeLock b10 = q4.t.b(this.f5862b, "ProcessorForegroundLck");
                        this.f5861a = b10;
                        b10.acquire();
                    }
                    this.f5866f.put(str, t0Var);
                    androidx.core.content.a.p(this.f5862b, androidx.work.impl.foreground.b.f(this.f5862b, t0Var.d(), gVar));
                }
            } catch (Throwable th2) {
                throw th2;
            }
    ...
    public boolean j(String str) {
        boolean contains;
        synchronized (this.f5871k) {
            contains = this.f5869i.contains(str);
        }
        return contains;
    }
    ...
    public boolean p(a0 a0Var, WorkerParameters.a aVar) {
        ...
        p4.u uVar = (p4.u) this.f5865e.z(new Callable() { // from class: androidx.work.impl.r
        ...
        synchronized (this.f5871k) {
            try {
                try {
                    try {
                        if (k(b10)) {
                            Set set = (Set) this.f5868h.get(b10);
                            ...
                            final t0 b11 = new t0.c(this.f5862b, this.f5863c, this.f5864d, this, this.f5865e, uVar, arrayList).c(aVar).b();
                            ...
                            this.f5867g.put(b10, b11);
                            HashSet hashSet = new HashSet();
                            hashSet.add(a0Var);
                            this.f5868h.put(b10, hashSet);
                            this.f5864d.c().execute(b11);
                            k4.m e12 = k4.m.e();
                            String str3 = f5860l;
