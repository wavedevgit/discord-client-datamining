...
public class b implements androidx.work.impl.f {
    ...
    private static final String f5985q = m.i("CommandHandler");
    ...
    private final Object f5988i = new Object();

    /* renamed from: o  reason: collision with root package name */
    private final k4.b f5989o;

    /* renamed from: p  reason: collision with root package name */
    private final b0 f5990p;
    ...
    private void g(Intent intent, int i10, g gVar) {
        ...
        new c(this.f5986d, this.f5989o, i10, gVar).a();
    }
    ...
    private void h(Intent intent, int i10, g gVar) {
        synchronized (this.f5988i) {
            try {
                ...
                if (!this.f5987e.containsKey(p10)) {
                    f fVar = new f(this.f5986d, i10, gVar, this.f5990p.d(p10));
                    this.f5987e.put(p10, fVar);
                    fVar.f();
                } else {
                    m e11 = m.e();
        ...
        try {
            ...
            if (i11 == null) {
                ...
                if (!i11.k()) {
                    ...
                    a.c(this.f5986d, p11, p10, c10);
                } else {
                    m e14 = m.e();
                    e14.a(str, "Opportunistically setting an alarm for " + p10 + "at " + c10);
                    a.c(this.f5986d, p11, p10, c10);
                    gVar.f().a().execute(new g.b(gVar, a(this.f5986d), i10));
                }
                p11.A();
            }
        } finally {
    ...
    private void l(Intent intent, g gVar) {
        ...
        if (extras.containsKey("KEY_WORKSPEC_GENERATION")) {
            ...
            c10 = new ArrayList(1);
            a0 b10 = this.f5990p.b(new p4.m(string, i10));
            if (b10 != null) {
                c10.add(b10);
            }
        } else {
            c10 = this.f5990p.c(string);
        }
        for (a0 a0Var : c10) {
            m e10 = m.e();
            String str = f5985q;
            ...
            gVar.i().e(a0Var);
            a.a(this.f5986d, gVar.g().p(), a0Var.a());
    ...
    public void b(p4.m mVar, boolean z10) {
        synchronized (this.f5988i) {
            try {
                f fVar = (f) this.f5987e.remove(mVar);
                this.f5990p.b(mVar);
                if (fVar != null) {
                    fVar.g(z10);
                }
