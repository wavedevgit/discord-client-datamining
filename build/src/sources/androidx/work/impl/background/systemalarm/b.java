...
public class b implements androidx.work.impl.f {
    ...
    private static final String f5692q = m.i("CommandHandler");

    /* renamed from: d  reason: collision with root package name */
    private final Context f5693d;

    /* renamed from: e  reason: collision with root package name */
    private final Map f5694e = new HashMap();

    /* renamed from: i  reason: collision with root package name */
    private final Object f5695i = new Object();

    /* renamed from: o  reason: collision with root package name */
    private final k4.b f5696o;

    /* renamed from: p  reason: collision with root package name */
    private final b0 f5697p;
    ...
    private void g(Intent intent, int i10, g gVar) {
        ...
        new c(this.f5693d, this.f5696o, i10, gVar).a();
    }
    ...
    private void h(Intent intent, int i10, g gVar) {
        synchronized (this.f5695i) {
            try {
                ...
                if (!this.f5694e.containsKey(p10)) {
                    f fVar = new f(this.f5693d, i10, gVar, this.f5697p.d(p10));
                    this.f5694e.put(p10, fVar);
                    fVar.f();
                } else {
                    m e11 = m.e();
        ...
        try {
            ...
            if (i11 == null) {
                ...
                if (!i11.k()) {
                    ...
                    a.c(this.f5693d, p11, p10, c10);
                } else {
                    m e14 = m.e();
                    e14.a(str, "Opportunistically setting an alarm for " + p10 + "at " + c10);
                    a.c(this.f5693d, p11, p10, c10);
                    gVar.f().a().execute(new g.b(gVar, a(this.f5693d), i10));
                }
                p11.A();
            }
        } finally {
    ...
    private void l(Intent intent, g gVar) {
        ...
        if (extras.containsKey("KEY_WORKSPEC_GENERATION")) {
            ...
            c10 = new ArrayList(1);
            a0 b10 = this.f5697p.b(new p4.m(string, i10));
            if (b10 != null) {
                c10.add(b10);
            }
        } else {
            c10 = this.f5697p.c(string);
        }
        for (a0 a0Var : c10) {
            m e10 = m.e();
            String str = f5692q;
            ...
            gVar.i().e(a0Var);
            a.a(this.f5693d, gVar.g().p(), a0Var.a());
    ...
    public void b(p4.m mVar, boolean z10) {
        synchronized (this.f5695i) {
            try {
                f fVar = (f) this.f5694e.remove(mVar);
                this.f5697p.b(mVar);
                if (fVar != null) {
                    fVar.g(z10);
                }
