...
public class a {
    ...
    public JobInfo a(u uVar, int i10) {
        ...
        persistableBundle.putString("EXTRA_WORK_SPEC_ID", uVar.f42015a);
        ...
        boolean z11 = false;
        if (!dVar.h()) {
            if (uVar.f42026l == k4.a.LINEAR) {
                i11 = 0;
            } else {
                i11 = 1;
            }
            extras.setBackoffCriteria(uVar.f42027m, i11);
        }
        ...
        if (i12 >= 31 && uVar.f42031q && !z10 && !z11) {
