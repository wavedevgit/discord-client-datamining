...
public class a {
    ...
    private static final String f6036c = m.i("SystemJobInfoConverter");

    /* renamed from: a  reason: collision with root package name */
    private final ComponentName f6037a;

    /* renamed from: b  reason: collision with root package name */
    private final k4.b f6038b;
    ...
    public static /* synthetic */ class C0078a {
        ...
        static {
            ...
            try {
                f6039a[n.CONNECTED.ordinal()] = 2;
            } catch (NoSuchFieldError unused2) {
            }
            try {
                f6039a[n.UNMETERED.ordinal()] = 3;
            } catch (NoSuchFieldError unused3) {
            }
            try {
                f6039a[n.NOT_ROAMING.ordinal()] = 4;
            } catch (NoSuchFieldError unused4) {
            }
            try {
                f6039a[n.METERED.ordinal()] = 5;
    ...
    public a(Context context, k4.b bVar) {
        this.f6038b = bVar;
        this.f6037a = new ComponentName(context.getApplicationContext(), SystemJobService.class);
    }
    ...
    static int c(n nVar) {
        int i10 = C0078a.f6039a[nVar.ordinal()];
        if (i10 != 1) {
            if (i10 == 2) {
                return 1;
            }
    ...
    public JobInfo a(u uVar, int i10) {
        ...
        persistableBundle.putString("EXTRA_WORK_SPEC_ID", uVar.f43733a);
        persistableBundle.putInt("EXTRA_WORK_SPEC_GENERATION", uVar.f());
        persistableBundle.putBoolean("EXTRA_IS_PERIODIC", uVar.m());
        JobInfo.Builder extras = new JobInfo.Builder(i10, this.f6037a).setRequiresCharging(dVar.g()).setRequiresDeviceIdle(dVar.h()).setExtras(persistableBundle);
        d(extras, dVar.d());
        boolean z11 = false;
        if (!dVar.h()) {
            if (uVar.f43744l == k4.a.LINEAR) {
                i11 = 0;
            } else {
                i11 = 1;
            }
            extras.setBackoffCriteria(uVar.f43745m, i11);
        }
        long max = Math.max(uVar.c() - this.f6038b.a(), 0L);
        if (Build.VERSION.SDK_INT <= 28) {
            extras.setMinimumLatency(max);
        } else if (max > 0) {
            extras.setMinimumLatency(max);
        } else if (!uVar.f43749q) {
        ...
        if (i12 >= 31 && uVar.f43749q && !z10 && !z11) {
