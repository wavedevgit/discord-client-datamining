...
public final class f0 {
    ...
    public static final f0 f5768a = new f0();

    private f0() {
    }

    private final File c(Context context) {
        return new File(a.f5677a.a(context), "androidx.work.workdb");
    }
    ...
    public final Map e(Context context) {
        ...
        for (String str : strArr) {
            Pair a11 = as.v.a(new File(b10.getPath() + str), new File(a10.getPath() + str));
            linkedHashMap.put(a11.c(), a11.d());
        }
        return kotlin.collections.o0.r(linkedHashMap, as.v.a(b10, a10));
    }
}
