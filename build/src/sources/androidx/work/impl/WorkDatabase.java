...
public abstract class WorkDatabase extends r3.u {
    ...
    public static final a f5658p = new a(null);
    ...
    public static final class a {
        ...
        public static final x3.h c(Context context, h.b configuration) {
            ...
            h.b.a a10 = h.b.f54584f.a(context);
            a10.d(configuration.f54586b).c(configuration.f54587c).e(true).a(true);
        ...
        public final WorkDatabase b(final Context context, Executor queryExecutor, k4.b clock, boolean z10) {
            ...
            return (WorkDatabase) f10.g(queryExecutor).a(new d(clock)).b(k.f5794c).b(new v(context, 2, 3)).b(l.f5795c).b(m.f5796c).b(new v(context, 5, 6)).b(n.f5798c).b(o.f5799c).b(p.f5802c).b(new r0(context)).b(new v(context, 10, 11)).b(g.f5787c).b(h.f5790c).b(i.f5791c).b(j.f5793c).e().d();
        }
