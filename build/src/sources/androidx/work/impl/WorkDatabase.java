...
public abstract class WorkDatabase extends r3.u {
    ...
    public static final class a {
        ...
        public static final x3.h c(Context context, h.b configuration) {
            ...
            h.b.a a10 = h.b.f54885f.a(context);
            a10.d(configuration.f54887b).c(configuration.f54888c).e(true).a(true);
        ...
        public final WorkDatabase b(final Context context, Executor queryExecutor, k4.b clock, boolean z10) {
            ...
            return (WorkDatabase) f10.g(queryExecutor).a(new d(clock)).b(k.f5804c).b(new v(context, 2, 3)).b(l.f5805c).b(m.f5806c).b(new v(context, 5, 6)).b(n.f5808c).b(o.f5809c).b(p.f5812c).b(new r0(context)).b(new v(context, 10, 11)).b(g.f5797c).b(h.f5800c).b(i.f5801c).b(j.f5803c).e().d();
        }
