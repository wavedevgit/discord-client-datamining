...
public abstract class WorkDatabase extends r3.u {
    ...
    public static final class a {
        ...
        public static final x3.h c(Context context, h.b configuration) {
            ...
            h.b.a a10 = h.b.f53084f.a(context);
            a10.d(configuration.f53086b).c(configuration.f53087c).e(true).a(true);
        ...
        public final WorkDatabase b(final Context context, Executor queryExecutor, k4.b clock, boolean z10) {
            ...
            return (WorkDatabase) f10.g(queryExecutor).a(new d(clock)).b(k.f5656c).b(new v(context, 2, 3)).b(l.f5657c).b(m.f5658c).b(new v(context, 5, 6)).b(n.f5660c).b(o.f5661c).b(p.f5664c).b(new r0(context)).b(new v(context, 10, 11)).b(g.f5649c).b(h.f5652c).b(i.f5653c).b(j.f5655c).e().d();
        }
