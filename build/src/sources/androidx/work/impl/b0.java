...
public final class b0 {
    ...
    private final Object f5679a = new Object();

    /* renamed from: b  reason: collision with root package name */
    private final Map f5680b = new LinkedHashMap();

    public final boolean a(p4.m id2) {
        boolean containsKey;
        Intrinsics.checkNotNullParameter(id2, "id");
        synchronized (this.f5679a) {
            containsKey = this.f5680b.containsKey(id2);
        }
        return containsKey;
    }
    ...
    public final a0 b(p4.m id2) {
        ...
        Intrinsics.checkNotNullParameter(id2, "id");
        synchronized (this.f5679a) {
            a0Var = (a0) this.f5680b.remove(id2);
        }
        return a0Var;
    }
