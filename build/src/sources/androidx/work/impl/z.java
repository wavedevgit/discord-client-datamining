...
public abstract class z {
    ...
    private static final String f5784a = k4.m.i("Schedulers");
    ...
    public static w c(Context context, WorkDatabase workDatabase, androidx.work.a aVar) {
        ...
        k4.m.e().a(f5784a, "Created SystemJobScheduler and enabled SystemJobService");
        return bVar;
    }
    ...
    private static void d(p4.v vVar, k4.b bVar, List list) {
        if (list.size() > 0) {
            ...
            Iterator it = list.iterator();
            while (it.hasNext()) {
                vVar.o(((p4.u) it.next()).f44958a, a10);
            }
        }
    }
