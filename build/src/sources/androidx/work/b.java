...
public final class b {
    ...
    private static final String f5497b = m.i("Data");

    /* renamed from: c  reason: collision with root package name */
    public static final b f5498c = new a().a();
    ...
    public static final class a {
        ...
        /* renamed from: a  reason: collision with root package name */
        private Map f5500a = new HashMap();

        public b a() {
            b bVar = new b(this.f5500a);
            b.o(bVar);
            return bVar;
        }
        ...
        public a b(String str, Object obj) {
            if (obj == null) {
                this.f5500a.put(str, null);
                return this;
            }
            Class<?> cls = obj.getClass();
            if (cls != Boolean.class && cls != Byte.class && cls != Integer.class && cls != Long.class && cls != Float.class && cls != Double.class && cls != String.class && cls != Boolean[].class && cls != Byte[].class && cls != Integer[].class && cls != Long[].class && cls != Float[].class && cls != Double[].class && cls != String[].class) {
                if (cls == boolean[].class) {
                    this.f5500a.put(str, b.a((boolean[]) obj));
                    return this;
                } else if (cls == byte[].class) {
                    this.f5500a.put(str, b.b((byte[]) obj));
                    return this;
                } else if (cls == int[].class) {
                    this.f5500a.put(str, b.e((int[]) obj));
                    return this;
                } else if (cls == long[].class) {
                    this.f5500a.put(str, b.f((long[]) obj));
                    return this;
                } else if (cls == float[].class) {
                    this.f5500a.put(str, b.d((float[]) obj));
                    return this;
                } else if (cls == double[].class) {
                    this.f5500a.put(str, b.c((double[]) obj));
                    return this;
                } else {
        ...
        public a e(String str, boolean z10) {
            this.f5500a.put(str, Boolean.valueOf(z10));
            return this;
        }

        public a f(String str, int i10) {
            this.f5500a.put(str, Integer.valueOf(i10));
            return this;
        }

        public a g(String str, long j10) {
            this.f5500a.put(str, Long.valueOf(j10));
            return this;
        }

        public a h(String str, String str2) {
            this.f5500a.put(str, str2);
            return this;
        }

        public a i(String str, String[] strArr) {
            this.f5500a.put(str, strArr);
            return this;
        }
    }

    public b(b bVar) {
        this.f5499a = new HashMap(bVar.f5499a);
    }
    ...
    */
    public static androidx.work.b g(byte[] r7) {
        ...
        L35:
            r7 = move-exception
            java.lang.String r3 = androidx.work.b.f5497b
        ...
        L3f:
            r7 = move-exception
            java.lang.String r2 = androidx.work.b.f5497b
        ...
        L4f:
            ...
            goto L4b
        L51:
            java.lang.String r4 = androidx.work.b.f5497b     // Catch: java.lang.Throwable -> L2b
    ...
    public static byte[] o(b bVar) {
        ...
        try {
            ...
            for (Map.Entry entry : bVar.f5499a.entrySet()) {
            ...
            try {
                ...
                Log.e(f5497b, "Error in Data#toByteArray: ", e11);
            }
            try {
                byteArrayOutputStream.close();
            } catch (IOException e12) {
                Log.e(f5497b, "Error in Data#toByteArray: ", e12);
            }
            ...
            Log.e(f5497b, "Error in Data#toByteArray: ", e);
            byte[] byteArray = byteArrayOutputStream.toByteArray();
            if (objectOutputStream2 != null) {
                try {
                    objectOutputStream2.close();
                } catch (IOException e14) {
                    Log.e(f5497b, "Error in Data#toByteArray: ", e14);
                }
            }
            try {
                byteArrayOutputStream.close();
            } catch (IOException e15) {
                Log.e(f5497b, "Error in Data#toByteArray: ", e15);
            }
            return byteArray;
        } catch (Throwable th3) {
            th = th3;
            ...
            if (objectOutputStream2 != null) {
                try {
                    ...
                    Log.e(f5497b, "Error in Data#toByteArray: ", e16);
                }
            }
            try {
                byteArrayOutputStream.close();
            } catch (IOException e17) {
                Log.e(f5497b, "Error in Data#toByteArray: ", e17);
            }
            throw th;
        }
    }
    ...
    public boolean equals(Object obj) {
        ...
        b bVar = (b) obj;
        Set<String> keySet = this.f5499a.keySet();
        if (!keySet.equals(bVar.f5499a.keySet())) {
            return false;
        }
        for (String str : keySet) {
            Object obj2 = this.f5499a.get(str);
            Object obj3 = bVar.f5499a.get(str);
    ...
    public boolean h(String str, boolean z10) {
        Object obj = this.f5499a.get(str);
    ...
    public Map j() {
        return Collections.unmodifiableMap(this.f5499a);
    }
    ...
    public String toString() {
        ...
        if (!this.f5499a.isEmpty()) {
            for (String str : this.f5499a.keySet()) {
                sb2.append(str);
                sb2.append(" : ");
                Object obj = this.f5499a.get(str);
