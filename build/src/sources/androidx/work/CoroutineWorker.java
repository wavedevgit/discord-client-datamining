...
public abstract class CoroutineWorker extends c {
    ...
    private final CompletableJob f5590p;

    /* renamed from: q  reason: collision with root package name */
    private final androidx.work.impl.utils.futures.c f5591q;

    /* renamed from: r  reason: collision with root package name */
    private final CoroutineDispatcher f5592r;
    ...
    static final class a extends k implements Function2 {
        ...
        final /* synthetic */ l f5595i;

        /* renamed from: o  reason: collision with root package name */
        final /* synthetic */ CoroutineWorker f5596o;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        a(l lVar, CoroutineWorker coroutineWorker, Continuation continuation) {
            super(2, continuation);
            this.f5595i = lVar;
            this.f5596o = coroutineWorker;
        }

        @Override // kotlin.coroutines.jvm.internal.a
        public final Continuation create(Object obj, Continuation continuation) {
            return new a(this.f5595i, this.f5596o, continuation);
        }
        ...
        public final Object invokeSuspend(Object obj) {
            ...
            if (i10 != 0) {
                ...
                kotlin.c.b(obj);
                l lVar2 = this.f5595i;
                CoroutineWorker coroutineWorker = this.f5596o;
                this.f5593d = lVar2;
                this.f5594e = 1;
    ...
    public static final void q(CoroutineWorker this$0) {
        ...
        if (this$0.f5591q.isCancelled()) {
            Job.a.a(this$0.f5590p, null, 1, null);
        }
    }
    ...
    public final ListenableFuture d() {
        ...
        ps.i.d(a10, null, null, new a(lVar, this, null), 3, null);
        return lVar;
    }
    ...
    public final void l() {
        super.l();
        this.f5591q.cancel(false);
    }

    @Override // androidx.work.c
    public final ListenableFuture n() {
        ps.i.d(i.a(s().V0(this.f5590p)), null, null, new b(null), 3, null);
        return this.f5591q;
    }
