...
public abstract class CoroutineWorker extends c {
    ...
    private final CompletableJob f5600p;

    /* renamed from: q  reason: collision with root package name */
    private final androidx.work.impl.utils.futures.c f5601q;

    /* renamed from: r  reason: collision with root package name */
    private final CoroutineDispatcher f5602r;
    ...
    static final class a extends k implements Function2 {
        ...
        final /* synthetic */ l f5605i;

        /* renamed from: o  reason: collision with root package name */
        final /* synthetic */ CoroutineWorker f5606o;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        a(l lVar, CoroutineWorker coroutineWorker, Continuation continuation) {
            super(2, continuation);
            this.f5605i = lVar;
            this.f5606o = coroutineWorker;
        }

        @Override // kotlin.coroutines.jvm.internal.a
        public final Continuation create(Object obj, Continuation continuation) {
            return new a(this.f5605i, this.f5606o, continuation);
        }
        ...
        public final Object invokeSuspend(Object obj) {
            ...
            if (i10 != 0) {
                ...
                kotlin.c.b(obj);
                l lVar2 = this.f5605i;
                CoroutineWorker coroutineWorker = this.f5606o;
                this.f5603d = lVar2;
                this.f5604e = 1;
    ...
    public static final void q(CoroutineWorker this$0) {
        ...
        if (this$0.f5601q.isCancelled()) {
            Job.a.a(this$0.f5600p, null, 1, null);
        }
    }
    ...
    public final ListenableFuture d() {
        CompletableJob b10;
        b10 = a0.b(null, 1, null);
        CoroutineScope a10 = i.a(s().O0(b10));
        l lVar = new l(b10, null, 2, null);
        ys.i.d(a10, null, null, new a(lVar, this, null), 3, null);
        return lVar;
    }
    ...
    public final void l() {
        super.l();
        this.f5601q.cancel(false);
    }

    @Override // androidx.work.c
    public final ListenableFuture n() {
        ys.i.d(i.a(s().O0(this.f5600p)), null, null, new b(null), 3, null);
        return this.f5601q;
    }
