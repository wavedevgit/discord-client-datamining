...
public class LruCache {
    ...
    public final Object d(Object key) {
        ...
        synchronized (this.f2323c) {
            ...
            synchronized (this.f2323c) {
                try {
                    this.f2326f++;
                    d10 = this.f2322b.d(key, a11);
                    if (d10 != null) {
                        this.f2322b.d(key, d10);
                    } else {
                        this.f2324d += h(key, a11);
    ...
    public final Object f(Object key, Object value) {
        ...
        synchronized (this.f2323c) {
            try {
                this.f2325e++;
                this.f2324d += h(key, value);
                d10 = this.f2322b.d(key, value);
                if (d10 != null) {
                    this.f2324d -= h(key, d10);
                }
                Unit unit = Unit.f31988a;
            } catch (Throwable th2) {
                throw th2;
    ...
    public final Object g(Object key) {
        ...
        synchronized (this.f2323c) {
            try {
                e10 = this.f2322b.e(key);
                if (e10 != null) {
                    this.f2324d -= h(key, e10);
                }
                Unit unit = Unit.f31988a;
            } catch (Throwable th2) {
                throw th2;
    ...
    */
    public void k(int r7) {
        ...
        L0:
            v0.b r0 = r6.f2323c
            monitor-enter(r0)
            int r1 = r6.f2324d     // Catch: java.lang.Throwable -> L15
            r2 = 1
            if (r1 < 0) goto L19
            v0.c r1 = r6.f2322b     // Catch: java.lang.Throwable -> L15
        ...
        L40:
            ...
            v0.c r4 = r6.f2322b     // Catch: java.lang.Throwable -> L15
            r4.e(r3)     // Catch: java.lang.Throwable -> L15
            int r4 = r6.f2324d     // Catch: java.lang.Throwable -> L15
            int r5 = r6.h(r3, r1)     // Catch: java.lang.Throwable -> L15
            int r4 = r4 - r5
            r6.f2324d = r4     // Catch: java.lang.Throwable -> L15
            int r4 = r6.f2327g     // Catch: java.lang.Throwable -> L15
            int r4 = r4 + r2
            r6.f2327g = r4     // Catch: java.lang.Throwable -> L15
            monitor-exit(r0)
            r0 = 0
            r6.b(r2, r3, r1, r0)
            goto L0
    ...
    public String toString() {
        ...
        synchronized (this.f2323c) {
            try {
                int i11 = this.f2328h;
                int i12 = this.f2329i + i11;
                if (i12 != 0) {
                    i10 = (i11 * 100) / i12;
                } else {
                    i10 = 0;
                }
                str = "LruCache[maxSize=" + this.f2321a + ",hits=" + this.f2328h + ",misses=" + this.f2329i + ",hitRate=" + i10 + "%]";
            } catch (Throwable th2) {
                throw th2;
            }
        }
