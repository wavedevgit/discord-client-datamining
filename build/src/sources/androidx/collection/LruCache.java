...
public class LruCache {
    ...
    public final Object f(Object key, Object value) {
        ...
        synchronized (this.f2169c) {
            try {
                this.f2171e++;
                this.f2170d += h(key, value);
                d10 = this.f2168b.d(key, value);
                if (d10 != null) {
    ...
    */
    public void k(int r7) {
        ...
        L0:
            v0.b r0 = r6.f2169c
            monitor-enter(r0)
            int r1 = r6.f2170d     // Catch: java.lang.Throwable -> L15
            r2 = 1
            if (r1 < 0) goto L19
            v0.c r1 = r6.f2168b     // Catch: java.lang.Throwable -> L15
        ...
        L40:
            ...
            v0.c r4 = r6.f2168b     // Catch: java.lang.Throwable -> L15
            r4.e(r3)     // Catch: java.lang.Throwable -> L15
            int r4 = r6.f2170d     // Catch: java.lang.Throwable -> L15
            int r5 = r6.h(r3, r1)     // Catch: java.lang.Throwable -> L15
            int r4 = r4 - r5
            r6.f2170d = r4     // Catch: java.lang.Throwable -> L15
            int r4 = r6.f2173g     // Catch: java.lang.Throwable -> L15
            int r4 = r4 + r2
            r6.f2173g = r4     // Catch: java.lang.Throwable -> L15
            monitor-exit(r0)
            r0 = 0
            r6.b(r2, r3, r1, r0)
            goto L0
    ...
    public String toString() {
        ...
        synchronized (this.f2169c) {
            try {
                int i11 = this.f2174h;
                int i12 = this.f2175i + i11;
                if (i12 != 0) {
                    i10 = (i11 * 100) / i12;
                } else {
                    i10 = 0;
                }
                str = "LruCache[maxSize=" + this.f2167a + ",hits=" + this.f2174h + ",misses=" + this.f2175i + ",hitRate=" + i10 + "%]";
            } catch (Throwable th2) {
                throw th2;
            }
        }
