...
public final class h0 implements SavedStateRegistry.b {
    ...
    private final Lazy f4649d;

    public h0(SavedStateRegistry savedStateRegistry, final q0 viewModelStoreOwner) {
        Intrinsics.checkNotNullParameter(savedStateRegistry, "savedStateRegistry");
        Intrinsics.checkNotNullParameter(viewModelStoreOwner, "viewModelStoreOwner");
        this.f4646a = savedStateRegistry;
        this.f4649d = as.l.b(new Function0() { // from class: androidx.lifecycle.g0
    ...
    private final i0 d() {
        return (i0) this.f4649d.getValue();
    }
    ...
    public final void e() {
        Pair[] pairArr;
        if (!this.f4647b) {
            Bundle a10 = this.f4646a.a("androidx.lifecycle.internal.SavedStateHandlesProvider");
            Map i10 = kotlin.collections.o0.i();
            if (i10.isEmpty()) {
                pairArr = new Pair[0];
            } else {
