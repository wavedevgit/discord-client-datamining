...
public final class h0 implements SavedStateRegistry.b {
    ...
    private final SavedStateRegistry f4610a;
    ...
    private final Lazy f4613d;

    public h0(SavedStateRegistry savedStateRegistry, final q0 viewModelStoreOwner) {
        Intrinsics.checkNotNullParameter(savedStateRegistry, "savedStateRegistry");
        Intrinsics.checkNotNullParameter(viewModelStoreOwner, "viewModelStoreOwner");
        this.f4610a = savedStateRegistry;
        this.f4613d = or.l.a(new Function0() { // from class: androidx.lifecycle.g0
    ...
    private final i0 d() {
        return (i0) this.f4613d.getValue();
    }
    ...
    public Bundle a() {
        ...
        if (i10.isEmpty()) {
            ...
            for (Map.Entry entry : i10.entrySet()) {
                arrayList.add(or.v.a((String) entry.getKey(), entry.getValue()));
            }
    ...
    public final void e() {
        Pair[] pairArr;
        if (!this.f4611b) {
            Bundle a10 = this.f4610a.a("androidx.lifecycle.internal.SavedStateHandlesProvider");
            Map i10 = kotlin.collections.o0.i();
            if (i10.isEmpty()) {
                pairArr = new Pair[0];
            } else {
