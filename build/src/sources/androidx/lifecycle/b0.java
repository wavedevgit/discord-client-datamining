...
public final class b0 {
    ...
    public b0(Map initialState) {
        ...
        this.f4623a = new LinkedHashMap();
        this.f4624b = new j3.b(initialState);
    }

    private final MutableLiveData d(String str, boolean z10, Object obj) {
        String b10;
        b bVar;
        if (this.f4624b.c().containsKey(str)) {
            b10 = f0.b(str);
        ...
        if (obj2 == null) {
            if (this.f4624b.e().containsKey(str)) {
                bVar = new b(this, str, this.f4624b.e().get(str));
            } else if (z10) {
                this.f4624b.e().put(str, obj);
    ...
    public final bt.j0 e(String key, Object obj) {
        Intrinsics.checkNotNullParameter(key, "key");
        if (this.f4624b.c().containsKey(key)) {
            return bt.g.a(this.f4624b.d(key, obj));
        }
        return this.f4624b.g(key, obj);
    }

    public final Set f() {
        return x0.l(this.f4624b.h(), this.f4623a.keySet());
    }
    ...
    public final void h(String key, Object obj) {
        ...
        Intrinsics.checkNotNullParameter(key, "key");
        if (f4622c.b(obj)) {
            Object obj2 = this.f4623a.get(key);
    ...
    public static final class b extends MutableLiveData {
        ...
        public void o(Object obj) {
            j3.b bVar;
            b0 b0Var = this.f4626m;
            if (b0Var != null && (bVar = b0Var.f4624b) != null) {
                bVar.k(this.f4625l, obj);
            }
            super.o(obj);
        }
    ...
    public b0() {
        this.f4623a = new LinkedHashMap();
        this.f4624b = new j3.b(null, 1, null);
    }
}
