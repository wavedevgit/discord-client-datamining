...
public final class b0 {
    ...
    public b0(Map initialState) {
        ...
        this.f4614b = new j3.b(initialState);
    }

    private final MutableLiveData d(String str, boolean z10, Object obj) {
        String b10;
        b bVar;
        if (this.f4614b.c().containsKey(str)) {
            b10 = f0.b(str);
        ...
        if (obj2 == null) {
            if (this.f4614b.e().containsKey(str)) {
                bVar = new b(this, str, this.f4614b.e().get(str));
            } else if (z10) {
                this.f4614b.e().put(str, obj);
    ...
    public final ss.j0 e(String key, Object obj) {
        Intrinsics.checkNotNullParameter(key, "key");
        if (this.f4614b.c().containsKey(key)) {
            return ss.g.a(this.f4614b.d(key, obj));
        }
        return this.f4614b.g(key, obj);
    }

    public final Set f() {
        return x0.l(this.f4614b.h(), this.f4613a.keySet());
    }
    ...
    public final void h(String key, Object obj) {
        ...
        Intrinsics.checkNotNullParameter(key, "key");
        if (f4612c.b(obj)) {
            Object obj2 = this.f4613a.get(key);
    ...
    public static final class b extends MutableLiveData {
        ...
        public void o(Object obj) {
            ...
            if (b0Var != null && (bVar = b0Var.f4614b) != null) {
                bVar.k(this.f4615l, obj);
            }
            super.o(obj);
        }
    ...
    public b0() {
        this.f4613a = new LinkedHashMap();
        this.f4614b = new j3.b(null, 1, null);
    }
}
