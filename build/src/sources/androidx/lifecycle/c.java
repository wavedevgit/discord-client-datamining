...
final class c {
    ...
    static c f4617c = new c();

    /* renamed from: a  reason: collision with root package name */
    private final Map f4618a = new HashMap();

    /* renamed from: b  reason: collision with root package name */
    private final Map f4619b = new HashMap();
    ...
    public static class a {
        ...
        a(Map map) {
            ...
            for (Map.Entry entry : map.entrySet()) {
                ...
                List list = (List) this.f4620a.get(aVar);
                if (list == null) {
                    list = new ArrayList();
                    this.f4620a.put(aVar, list);
                }
        ...
        public void a(LifecycleOwner lifecycleOwner, Lifecycle.a aVar, Object obj) {
            b((List) this.f4620a.get(aVar), lifecycleOwner, aVar, obj);
            b((List) this.f4620a.get(Lifecycle.a.ON_ANY), lifecycleOwner, aVar, obj);
        }
    }
    ...
    public static final class b {
            ...
            try {
                ...
                if (i10 != 0) {
                    if (i10 != 1) {
                        ...
                        this.f4623b.invoke(obj, lifecycleOwner, aVar);
                        return;
                    }
                    this.f4623b.invoke(obj, lifecycleOwner);
                    return;
                }
                this.f4623b.invoke(obj, null);
        ...
        public boolean equals(Object obj) {
            ...
            b bVar = (b) obj;
            if (this.f4622a == bVar.f4622a && this.f4623b.getName().equals(bVar.f4623b.getName())) {
                return true;
            }
            return false;
        }
        ...
        public int hashCode() {
            return (this.f4622a * 31) + this.f4623b.getName().hashCode();
        }
    }
    ...
    private a a(Class cls, Method[] methodArr) {
        ...
        if (superclass != null && (c10 = c(superclass)) != null) {
            hashMap.putAll(c10.f4621b);
        }
        for (Class<?> cls2 : cls.getInterfaces()) {
            for (Map.Entry entry : c(cls2).f4621b.entrySet()) {
        ...
        this.f4618a.put(cls, aVar);
        this.f4619b.put(cls, Boolean.valueOf(z10));
        return aVar;
    }
    ...
    public boolean d(Class cls) {
        Boolean bool = (Boolean) this.f4619b.get(cls);
        if (bool != null) {
        ...
        this.f4619b.put(cls, Boolean.FALSE);
        return false;
    }
}
