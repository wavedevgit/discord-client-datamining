...
public final class t {
    ...
    private static final Map f4673b = new HashMap();

    /* renamed from: c  reason: collision with root package name */
    private static final Map f4674c = new HashMap();
    ...
    public static final m f(Object object) {
        ...
        if (tVar.d(cls) == 2) {
            ...
            for (int i10 = 0; i10 < size; i10++) {
                f4672a.a((Constructor) list.get(i10), object);
                gVarArr[i10] = null;
            }
    ...
    private final int g(Class cls) {
        ...
        if (b10 != null) {
            f4674c.put(cls, CollectionsKt.e(b10));
            return 2;
        } else if (c.f4617c.d(cls)) {
            return 1;
        } else {
            ...
            if (e(superclass)) {
                ...
                Object obj = f4674c.get(superclass);
                Intrinsics.checkNotNull(obj);
