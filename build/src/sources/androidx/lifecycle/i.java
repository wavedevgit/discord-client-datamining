...
public final class i {
    ...
    public static final class b implements m {
        ...
        final /* synthetic */ Lifecycle f4490d;

        /* renamed from: e  reason: collision with root package name */
        final /* synthetic */ SavedStateRegistry f4491e;

        b(Lifecycle lifecycle, SavedStateRegistry savedStateRegistry) {
            this.f4490d = lifecycle;
            this.f4491e = savedStateRegistry;
        }
    ...
    public static final d0 b(SavedStateRegistry registry, Lifecycle lifecycle, String str, Bundle bundle) {
        ...
        d0 d0Var = new d0(str, b0.f4461c.a(registry.a(str), bundle));
        d0Var.a(registry, lifecycle);
        f4489a.c(registry, lifecycle);
        return d0Var;
    }
    ...
    private final void c(SavedStateRegistry savedStateRegistry, Lifecycle lifecycle) {
        ...
        if (b10 != Lifecycle.State.f4393e && !b10.d(Lifecycle.State.f4395o)) {
