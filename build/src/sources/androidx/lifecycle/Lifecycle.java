...
public abstract class Lifecycle {
    ...
    public static final class State {
        ...
        public static final State f4553d = new State("DESTROYED", 0);

        /* renamed from: e  reason: collision with root package name */
        public static final State f4554e = new State("INITIALIZED", 1);

        /* renamed from: i  reason: collision with root package name */
        public static final State f4555i = new State("CREATED", 2);

        /* renamed from: o  reason: collision with root package name */
        public static final State f4556o = new State("STARTED", 3);

        /* renamed from: p  reason: collision with root package name */
        public static final State f4557p = new State("RESUMED", 4);

        /* renamed from: q  reason: collision with root package name */
        private static final /* synthetic */ State[] f4558q;

        /* renamed from: r  reason: collision with root package name */
        private static final /* synthetic */ EnumEntries f4559r;
        ...
        private static final /* synthetic */ State[] a() {
            return new State[]{f4553d, f4554e, f4555i, f4556o, f4557p};
        }
        ...
        public static final class C0052a {
            ...
            public /* synthetic */ class C0053a {
                ...
                static {
                    ...
                    try {
                        iArr[State.f4555i.ordinal()] = 1;
                    } catch (NoSuchFieldError unused) {
                    }
                    try {
                        iArr[State.f4556o.ordinal()] = 2;
                    } catch (NoSuchFieldError unused2) {
                    }
                    try {
                        iArr[State.f4557p.ordinal()] = 3;
                    } catch (NoSuchFieldError unused3) {
                    }
                    try {
                        iArr[State.f4553d.ordinal()] = 4;
                    } catch (NoSuchFieldError unused4) {
                    }
                    try {
                        iArr[State.f4554e.ordinal()] = 5;
            ...
            public final a a(State state) {
                Intrinsics.checkNotNullParameter(state, "state");
                int i10 = C0053a.f4560a[state.ordinal()];
                if (i10 != 1) {
                    if (i10 != 2) {
                        if (i10 != 3) {
                            return null;
