...
public abstract class q {
    public static final void a(LifecycleOwner lifecycleOwner, Lifecycle.State current, Lifecycle.State next) {
        ...
        if (current == Lifecycle.State.f4847e && next == Lifecycle.State.f4846d) {
            throw new IllegalStateException(("State must be at least '" + Lifecycle.State.f4848i + "' to be moved to '" + next + "' in component " + lifecycleOwner).toString());
        }
