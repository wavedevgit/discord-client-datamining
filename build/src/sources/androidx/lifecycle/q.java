...
public abstract class q {
    public static final void a(LifecycleOwner lifecycleOwner, Lifecycle.State current, Lifecycle.State next) {
        ...
        if (current == Lifecycle.State.f4554e && next == Lifecycle.State.f4553d) {
            throw new IllegalStateException(("State must be at least '" + Lifecycle.State.f4555i + "' to be moved to '" + next + "' in component " + lifecycleOwner).toString());
        }
