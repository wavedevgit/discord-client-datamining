...
public final class FragmentContainerView extends FrameLayout {
    ...
    private final List f4073d;

    /* renamed from: e  reason: collision with root package name */
    private final List f4074e;

    /* renamed from: i  reason: collision with root package name */
    private View.OnApplyWindowInsetsListener f4075i;
    ...
    private final void a(View view) {
        if (this.f4074e.contains(view)) {
            this.f4073d.add(view);
        }
    }
    ...
    public WindowInsets dispatchApplyWindowInsets(WindowInsets insets) {
        ...
        View.OnApplyWindowInsetsListener onApplyWindowInsetsListener = this.f4075i;
    ...
    protected boolean drawChild(Canvas canvas, View child, long j10) {
        Intrinsics.checkNotNullParameter(canvas, "canvas");
        Intrinsics.checkNotNullParameter(child, "child");
        if (this.f4076o && !this.f4073d.isEmpty() && this.f4073d.contains(child)) {
            return false;
        }
    ...
    public void endViewTransition(View view) {
        ...
        this.f4074e.remove(view);
        if (this.f4073d.remove(view)) {
            this.f4076o = true;
        }
    ...
    public void setOnApplyWindowInsetsListener(View.OnApplyWindowInsetsListener onApplyWindowInsetsListener) {
        this.f4075i = onApplyWindowInsetsListener;
    }
    ...
    public FragmentContainerView(Context context, AttributeSet attributeSet, int i10) {
        ...
        if (attributeSet != null) {
            ...
            int[] FragmentContainerView = f3.c.f24351e;
            Intrinsics.checkNotNullExpressionValue(FragmentContainerView, "FragmentContainerView");
            TypedArray obtainStyledAttributes = context.obtainStyledAttributes(attributeSet, FragmentContainerView, 0, 0);
            if (classAttribute == null) {
                classAttribute = obtainStyledAttributes.getString(f3.c.f24352f);
                str = "android:name";
            } else {
                str = "class";
            }
    ...
    public FragmentContainerView(Context context, AttributeSet attrs, FragmentManager fm2) {
        ...
        classAttribute = classAttribute == null ? obtainStyledAttributes.getString(f3.c.f24352f) : classAttribute;
        String string = obtainStyledAttributes.getString(f3.c.f24353g);
        obtainStyledAttributes.recycle();
        int id2 = getId();
