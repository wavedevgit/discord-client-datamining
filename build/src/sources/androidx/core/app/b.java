...
public abstract class b extends androidx.core.content.a {
    ...
    static class f extends android.app.SharedElementCallback {
        ...
        private final SharedElementCallback f3081a;

        f(SharedElementCallback sharedElementCallback) {
            this.f3081a = sharedElementCallback;
        }

        @Override // android.app.SharedElementCallback
        public Parcelable onCaptureSharedElementSnapshot(View view, Matrix matrix, RectF rectF) {
            return this.f3081a.b(view, matrix, rectF);
        }

        @Override // android.app.SharedElementCallback
        public View onCreateSnapshotView(Context context, Parcelable parcelable) {
            return this.f3081a.c(context, parcelable);
        }

        @Override // android.app.SharedElementCallback
        public void onMapSharedElements(List list, Map map) {
            this.f3081a.d(list, map);
        }
        ...
        public void onSharedElementEnd(List list, List list2, List list3) {
            this.f3081a.f(list, list2, list3);
        }

        @Override // android.app.SharedElementCallback
        public void onSharedElementStart(List list, List list2, List list3) {
            this.f3081a.g(list, list2, list3);
        }
        ...
        public void onSharedElementsArrived(List list, List list2, final SharedElementCallback.OnSharedElementsReadyListener onSharedElementsReadyListener) {
            this.f3081a.h(list, list2, new SharedElementCallback.a() { // from class: androidx.core.app.c
                @Override // androidx.core.app.SharedElementCallback.a
                public final void onSharedElementsReady() {
                    b.C0033b.a(onSharedElementsReadyListener);
                }
            });
        }
    }
