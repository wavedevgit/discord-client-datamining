...
public class FileProvider extends ContentProvider {
    ...
    public static class b implements PathStrategy {
        ...
        private final HashMap f3263b = new HashMap();
        ...
        public Uri a(File file) {
            ...
            try {
                ...
                for (Map.Entry entry2 : this.f3263b.entrySet()) {
                ...
                if (entry != null) {
                    ...
                    return new Uri.Builder().scheme("content").authority(this.f3262a).encodedPath(Uri.encode((String) entry.getKey()) + '/' + Uri.encode(substring, "/")).build();
                }
        ...
        public File b(Uri uri) {
            ...
            if (indexOf != -1) {
                ...
                File file = (File) this.f3263b.get(decode);
                if (file != null) {
        ...
        void c(String str, File file) {
            if (!TextUtils.isEmpty(str)) {
                try {
                    this.f3263b.put(str, file.getCanonicalFile());
                    return;
