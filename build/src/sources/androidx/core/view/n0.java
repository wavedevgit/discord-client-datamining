...
public abstract class n0 {
    ...
    public static final class c implements Iterator, KMutableIterator {
        ...
        final /* synthetic */ ViewGroup f3508e;

        c(ViewGroup viewGroup) {
            this.f3508e = viewGroup;
        }

        @Override // java.util.Iterator
        /* renamed from: a */
        public View next() {
            ViewGroup viewGroup = this.f3508e;
            int i10 = this.f3507d;
            this.f3507d = i10 + 1;
        ...
        public boolean hasNext() {
            if (this.f3507d < this.f3508e.getChildCount()) {
                return true;
            }
            return false;
        }
    ...
    public static final class d implements Sequence {
        ...
        @Override // kotlin.sequences.Sequence
        public Iterator iterator() {
            return new d0(n0.a(this.f3509a).iterator(), b.f3506d);
        }
    }
