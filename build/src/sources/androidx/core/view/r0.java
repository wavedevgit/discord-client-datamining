...
public final class r0 {
    ...
    private final WeakReference f3546a;
    ...
    public class a extends AnimatorListenerAdapter {
        ...
        public void onAnimationStart(Animator animator) {
            this.f3547a.c(this.f3548b);
        }
    }

    /* JADX INFO: Access modifiers changed from: package-private */
    public r0(View view) {
        this.f3546a = new WeakReference(view);
    }
    ...
    public r0 b(float f10) {
        View view = (View) this.f3546a.get();
        if (view != null) {
    ...
    public r0 j(final u0 u0Var) {
        ...
        final View view = (View) this.f3546a.get();
        if (view != null) {
            if (u0Var != null) {
