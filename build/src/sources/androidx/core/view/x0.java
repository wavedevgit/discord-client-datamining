...
public final class x0 {
    ...
    public static class c extends e {
        ...
        private static final Interpolator f3415f = new PathInterpolator(0.0f, 1.1f, 0.0f, 1.0f);

        /* renamed from: g  reason: collision with root package name */
        private static final Interpolator f3416g = new h3.a();

        /* renamed from: h  reason: collision with root package name */
        private static final Interpolator f3417h = new DecelerateInterpolator(1.5f);

        /* renamed from: i  reason: collision with root package name */
        private static final Interpolator f3418i = new AccelerateInterpolator(1.5f);
        ...
        public static class a implements View.OnApplyWindowInsetsListener {
            ...
            private WindowInsetsCompat f3420b;
            ...
            class C0040a implements ValueAnimator.AnimatorUpdateListener {
                ...
                /* renamed from: b  reason: collision with root package name */
                final /* synthetic */ WindowInsetsCompat f3422b;

                /* renamed from: c  reason: collision with root package name */
                final /* synthetic */ WindowInsetsCompat f3423c;
                ...
                C0040a(x0 x0Var, WindowInsetsCompat windowInsetsCompat, WindowInsetsCompat windowInsetsCompat2, int i10, View view) {
                    this.f3421a = x0Var;
                    this.f3422b = windowInsetsCompat;
                    this.f3423c = windowInsetsCompat2;
                    this.f3424d = i10;
                    this.f3425e = view;
                }
                ...
                public void onAnimationUpdate(ValueAnimator valueAnimator) {
                    this.f3421a.e(valueAnimator.getAnimatedFraction());
                    c.k(this.f3425e, c.o(this.f3422b, this.f3423c, this.f3421a.b(), this.f3424d), Collections.singletonList(this.f3421a));
                }
            }
            ...
            class RunnableC0041c implements Runnable {
                ...
                /* renamed from: d  reason: collision with root package name */
                final /* synthetic */ View f3430d;

                /* renamed from: e  reason: collision with root package name */
                final /* synthetic */ x0 f3431e;

                /* renamed from: i  reason: collision with root package name */
                final /* synthetic */ a f3432i;

                /* renamed from: o  reason: collision with root package name */
                final /* synthetic */ ValueAnimator f3433o;

                RunnableC0041c(View view, x0 x0Var, a aVar, ValueAnimator valueAnimator) {
                    this.f3430d = view;
                    this.f3431e = x0Var;
                    this.f3432i = aVar;
                    this.f3433o = valueAnimator;
                }

                @Override // java.lang.Runnable
                public void run() {
                    c.l(this.f3430d, this.f3431e, this.f3432i);
                    this.f3433o.start();
                }
            }
            ...
            a(View view, b bVar) {
                ...
                this.f3420b = windowInsetsCompat;
            }
            ...
            public WindowInsets onApplyWindowInsets(View view, WindowInsets windowInsets) {
                long j10;
                if (!view.isLaidOut()) {
                    this.f3420b = WindowInsetsCompat.D(windowInsets, view);
                    return c.m(view, windowInsets);
                }
                WindowInsetsCompat D = WindowInsetsCompat.D(windowInsets, view);
                if (this.f3420b == null) {
                    this.f3420b = h0.G(view);
                }
                if (this.f3420b == null) {
                    this.f3420b = D;
                    return c.m(view, windowInsets);
                ...
                WindowInsetsCompat windowInsetsCompat = this.f3420b;
                ...
                duration.addUpdateListener(new C0040a(x0Var, D, windowInsetsCompat, i12, view));
                duration.addListener(new b(x0Var, view));
                y.a(view, new RunnableC0041c(view, x0Var, f10, duration));
                this.f3420b = D;
                return c.m(view, windowInsets);
            }
        }
        ...
        static void e(WindowInsetsCompat windowInsetsCompat, WindowInsetsCompat windowInsetsCompat2, int[] iArr, int[] iArr2) {
            ...
            for (int i10 = 1; i10 <= 512; i10 <<= 1) {
                ...
                int i11 = f10.f3163a;
                int i12 = f11.f3163a;
                if (i11 <= i12 && f10.f3164b <= f11.f3164b && f10.f3165c <= f11.f3165c && f10.f3166d <= f11.f3166d) {
                    z10 = false;
                } else {
                    z10 = true;
                }
        ...
        static a f(WindowInsetsCompat windowInsetsCompat, WindowInsetsCompat windowInsetsCompat2, int i10) {
            Insets f10 = windowInsetsCompat.f(i10);
            Insets f11 = windowInsetsCompat2.f(i10);
            return new a(Insets.c(Math.min(f10.f3163a, f11.f3163a), Math.min(f10.f3164b, f11.f3164b), Math.min(f10.f3165c, f11.f3165c), Math.min(f10.f3166d, f11.f3166d)), Insets.c(Math.max(f10.f3163a, f11.f3163a), Math.max(f10.f3164b, f11.f3164b), Math.max(f10.f3165c, f11.f3165c), Math.max(f10.f3166d, f11.f3166d)));
        }
        ...
        static WindowInsetsCompat o(WindowInsetsCompat windowInsetsCompat, WindowInsetsCompat windowInsetsCompat2, float f10, int i10) {
            ...
            for (int i11 = 1; i11 <= 512; i11 <<= 1) {
                if ((i10 & i11) == 0) {
                    ...
                    float f13 = 1.0f - f10;
                    aVar.b(i11, WindowInsetsCompat.s(f11, (int) (((f11.f3163a - f12.f3163a) * f13) + 0.5d), (int) (((f11.f3164b - f12.f3164b) * f13) + 0.5d), (int) (((f11.f3165c - f12.f3165c) * f13) + 0.5d), (int) (((f11.f3166d - f12.f3166d) * f13) + 0.5d)));
                }
            }
            return aVar.a();
        }
    ...
    public static class e {
        ...
        /* renamed from: c  reason: collision with root package name */
        private final Interpolator f3442c;
        ...
        public float b() {
            Interpolator interpolator = this.f3442c;
            if (interpolator != null) {
                return interpolator.getInterpolation(this.f3441b);
            }
            return this.f3441b;
        }
    ...
    public x0(int i10, Interpolator interpolator, long j10) {
        if (Build.VERSION.SDK_INT >= 30) {
            this.f3412a = new d(i10, interpolator, j10);
        } else {
            this.f3412a = new c(i10, interpolator, j10);
        }
    }
    ...
    public static class d extends e {
        ...
        /* renamed from: f  reason: collision with root package name */
        private final WindowInsetsAnimation f3435f;
        ...
        public static class a extends WindowInsetsAnimation$Callback {
            ...
            /* renamed from: c  reason: collision with root package name */
            private ArrayList f3438c;

            /* renamed from: d  reason: collision with root package name */
            private final HashMap f3439d;
            ...
            private x0 a(WindowInsetsAnimation windowInsetsAnimation) {
                x0 x0Var = (x0) this.f3439d.get(windowInsetsAnimation);
                if (x0Var == null) {
                    x0 f10 = x0.f(windowInsetsAnimation);
                    this.f3439d.put(windowInsetsAnimation, f10);
                    return f10;
                }
                return x0Var;
            }
            ...
            public void onEnd(WindowInsetsAnimation windowInsetsAnimation) {
                this.f3436a.onEnd(a(windowInsetsAnimation));
                this.f3439d.remove(windowInsetsAnimation);
            }

            public void onPrepare(WindowInsetsAnimation windowInsetsAnimation) {
                this.f3436a.onPrepare(a(windowInsetsAnimation));
            }
            ...
            public WindowInsets onProgress(WindowInsets windowInsets, List list) {
                ...
                return this.f3436a.onProgress(WindowInsetsCompat.C(windowInsets), this.f3437b).B();
            }

            public WindowInsetsAnimation.Bounds onStart(WindowInsetsAnimation windowInsetsAnimation, WindowInsetsAnimation.Bounds bounds) {
                return this.f3436a.onStart(a(windowInsetsAnimation), a.d(bounds)).c();
            }
        }

        d(WindowInsetsAnimation windowInsetsAnimation) {
            super(0, null, 0L);
            this.f3435f = windowInsetsAnimation;
        }
        ...
        public long a() {
            return this.f3435f.getDurationMillis();
        }

        @Override // androidx.core.view.x0.e
        public float b() {
            return this.f3435f.getInterpolatedFraction();
        }

        @Override // androidx.core.view.x0.e
        public int c() {
            return this.f3435f.getTypeMask();
        }

        @Override // androidx.core.view.x0.e
        public void d(float f10) {
            this.f3435f.setFraction(f10);
        }
    ...
    public static final class a {
        ...
        /* renamed from: a  reason: collision with root package name */
        private final Insets f3413a;

        /* renamed from: b  reason: collision with root package name */
        private final Insets f3414b;
