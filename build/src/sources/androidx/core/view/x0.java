...
public final class x0 {
    ...
    public static class c extends e {
        ...
        private static final Interpolator f3553f = new PathInterpolator(0.0f, 1.1f, 0.0f, 1.0f);

        /* renamed from: g  reason: collision with root package name */
        private static final Interpolator f3554g = new h3.a();

        /* renamed from: h  reason: collision with root package name */
        private static final Interpolator f3555h = new DecelerateInterpolator(1.5f);

        /* renamed from: i  reason: collision with root package name */
        private static final Interpolator f3556i = new AccelerateInterpolator(1.5f);
        ...
        public static class a implements View.OnApplyWindowInsetsListener {
            ...
            private WindowInsetsCompat f3558b;
            ...
            class C0041a implements ValueAnimator.AnimatorUpdateListener {
                ...
                /* renamed from: a  reason: collision with root package name */
                final /* synthetic */ x0 f3559a;

                /* renamed from: b  reason: collision with root package name */
                final /* synthetic */ WindowInsetsCompat f3560b;

                /* renamed from: c  reason: collision with root package name */
                final /* synthetic */ WindowInsetsCompat f3561c;

                /* renamed from: d  reason: collision with root package name */
                final /* synthetic */ int f3562d;

                /* renamed from: e  reason: collision with root package name */
                final /* synthetic */ View f3563e;
                ...
                C0041a(x0 x0Var, WindowInsetsCompat windowInsetsCompat, WindowInsetsCompat windowInsetsCompat2, int i10, View view) {
                    ...
                    this.f3561c = windowInsetsCompat2;
                    this.f3562d = i10;
                    this.f3563e = view;
                }
                ...
                public void onAnimationUpdate(ValueAnimator valueAnimator) {
                    this.f3559a.e(valueAnimator.getAnimatedFraction());
                    c.k(this.f3563e, c.o(this.f3560b, this.f3561c, this.f3559a.b(), this.f3562d), Collections.singletonList(this.f3559a));
                }
            }
            ...
            class RunnableC0042c implements Runnable {
                ...
                /* renamed from: e  reason: collision with root package name */
                final /* synthetic */ x0 f3569e;

                /* renamed from: i  reason: collision with root package name */
                final /* synthetic */ a f3570i;

                /* renamed from: o  reason: collision with root package name */
                final /* synthetic */ ValueAnimator f3571o;

                RunnableC0042c(View view, x0 x0Var, a aVar, ValueAnimator valueAnimator) {
                    this.f3568d = view;
                    this.f3569e = x0Var;
                    this.f3570i = aVar;
                    this.f3571o = valueAnimator;
                }

                @Override // java.lang.Runnable
                public void run() {
                    c.l(this.f3568d, this.f3569e, this.f3570i);
                    this.f3571o.start();
                }
            }
            ...
            a(View view, b bVar) {
                ...
                this.f3558b = windowInsetsCompat;
            }
            ...
            public WindowInsets onApplyWindowInsets(View view, WindowInsets windowInsets) {
                long j10;
                if (!view.isLaidOut()) {
                    this.f3558b = WindowInsetsCompat.D(windowInsets, view);
                    return c.m(view, windowInsets);
                }
                WindowInsetsCompat D = WindowInsetsCompat.D(windowInsets, view);
                if (this.f3558b == null) {
                    this.f3558b = h0.G(view);
                }
                if (this.f3558b == null) {
                    this.f3558b = D;
                    return c.m(view, windowInsets);
                ...
                WindowInsetsCompat windowInsetsCompat = this.f3558b;
        ...
        static void e(WindowInsetsCompat windowInsetsCompat, WindowInsetsCompat windowInsetsCompat2, int[] iArr, int[] iArr2) {
            ...
            for (int i10 = 1; i10 <= 512; i10 <<= 1) {
                ...
                int i11 = f10.f3301a;
                int i12 = f11.f3301a;
                if (i11 <= i12 && f10.f3302b <= f11.f3302b && f10.f3303c <= f11.f3303c && f10.f3304d <= f11.f3304d) {
                    z10 = false;
                } else {
                    z10 = true;
                }
        ...
        static a f(WindowInsetsCompat windowInsetsCompat, WindowInsetsCompat windowInsetsCompat2, int i10) {
            Insets f10 = windowInsetsCompat.f(i10);
            Insets f11 = windowInsetsCompat2.f(i10);
            return new a(Insets.c(Math.min(f10.f3301a, f11.f3301a), Math.min(f10.f3302b, f11.f3302b), Math.min(f10.f3303c, f11.f3303c), Math.min(f10.f3304d, f11.f3304d)), Insets.c(Math.max(f10.f3301a, f11.f3301a), Math.max(f10.f3302b, f11.f3302b), Math.max(f10.f3303c, f11.f3303c), Math.max(f10.f3304d, f11.f3304d)));
        }
        ...
        static WindowInsetsCompat o(WindowInsetsCompat windowInsetsCompat, WindowInsetsCompat windowInsetsCompat2, float f10, int i10) {
            ...
            for (int i11 = 1; i11 <= 512; i11 <<= 1) {
                if ((i10 & i11) == 0) {
                    ...
                    float f13 = 1.0f - f10;
                    aVar.b(i11, WindowInsetsCompat.s(f11, (int) (((f11.f3301a - f12.f3301a) * f13) + 0.5d), (int) (((f11.f3302b - f12.f3302b) * f13) + 0.5d), (int) (((f11.f3303c - f12.f3303c) * f13) + 0.5d), (int) (((f11.f3304d - f12.f3304d) * f13) + 0.5d)));
                }
            }
            return aVar.a();
        }
    ...
    public static class e {
        ...
        /* renamed from: c  reason: collision with root package name */
        private final Interpolator f3580c;

        /* renamed from: d  reason: collision with root package name */
        private final long f3581d;

        /* renamed from: e  reason: collision with root package name */
        private float f3582e = 1.0f;
        ...
        public float b() {
            Interpolator interpolator = this.f3580c;
            if (interpolator != null) {
                return interpolator.getInterpolation(this.f3579b);
            }
            return this.f3579b;
        }
    ...
    public x0(int i10, Interpolator interpolator, long j10) {
        if (Build.VERSION.SDK_INT >= 30) {
            this.f3550a = new d(i10, interpolator, j10);
        } else {
            this.f3550a = new c(i10, interpolator, j10);
        }
    }
    ...
    public static class d extends e {
        ...
        /* renamed from: f  reason: collision with root package name */
        private final WindowInsetsAnimation f3573f;
        ...
        public static class a extends WindowInsetsAnimation$Callback {
            ...
            /* renamed from: c  reason: collision with root package name */
            private ArrayList f3576c;

            /* renamed from: d  reason: collision with root package name */
            private final HashMap f3577d;
            ...
            private x0 a(WindowInsetsAnimation windowInsetsAnimation) {
                x0 x0Var = (x0) this.f3577d.get(windowInsetsAnimation);
                if (x0Var == null) {
                    x0 f10 = x0.f(windowInsetsAnimation);
                    this.f3577d.put(windowInsetsAnimation, f10);
                    return f10;
                }
                return x0Var;
            }
            ...
            public void onEnd(WindowInsetsAnimation windowInsetsAnimation) {
                this.f3574a.onEnd(a(windowInsetsAnimation));
                this.f3577d.remove(windowInsetsAnimation);
            }

            public void onPrepare(WindowInsetsAnimation windowInsetsAnimation) {
                this.f3574a.onPrepare(a(windowInsetsAnimation));
            }
            ...
            public WindowInsets onProgress(WindowInsets windowInsets, List list) {
                ...
                if (arrayList == null) {
                    ...
                    this.f3575b = Collections.unmodifiableList(arrayList2);
                } else {
                    arrayList.clear();
                }
                ...
                return this.f3574a.onProgress(WindowInsetsCompat.C(windowInsets), this.f3575b).B();
            }

            public WindowInsetsAnimation.Bounds onStart(WindowInsetsAnimation windowInsetsAnimation, WindowInsetsAnimation.Bounds bounds) {
                return this.f3574a.onStart(a(windowInsetsAnimation), a.d(bounds)).c();
            }
        }

        d(WindowInsetsAnimation windowInsetsAnimation) {
            super(0, null, 0L);
            this.f3573f = windowInsetsAnimation;
        }
        ...
        public long a() {
            return this.f3573f.getDurationMillis();
        }

        @Override // androidx.core.view.x0.e
        public float b() {
            return this.f3573f.getInterpolatedFraction();
        }

        @Override // androidx.core.view.x0.e
        public int c() {
            return this.f3573f.getTypeMask();
        }

        @Override // androidx.core.view.x0.e
        public void d(float f10) {
            this.f3573f.setFraction(f10);
        }
    ...
    public static final class a {
        ...
        /* renamed from: a  reason: collision with root package name */
        private final Insets f3551a;

        /* renamed from: b  reason: collision with root package name */
        private final Insets f3552b;
        ...
        public String toString() {
            return "Bounds{lower=" + this.f3551a + " upper=" + this.f3552b + "}";
        }

        private a(WindowInsetsAnimation.Bounds bounds) {
            this.f3551a = d.g(bounds);
            this.f3552b = d.f(bounds);
        }
    }
    ...
    private x0(WindowInsetsAnimation windowInsetsAnimation) {
        this(0, null, 0L);
        if (Build.VERSION.SDK_INT >= 30) {
            this.f3550a = new d(windowInsetsAnimation);
        }
    }
}
