...
public abstract class e0 {
    ...
    private static Map f3468a = Collections.synchronizedMap(new WeakHashMap());
    ...
    public static void a(VelocityTracker velocityTracker, MotionEvent motionEvent) {
        ...
        if (Build.VERSION.SDK_INT < 34 && motionEvent.getSource() == 4194304) {
            if (!f3468a.containsKey(velocityTracker)) {
                f3468a.put(velocityTracker, new f0());
            }
            ((f0) f3468a.get(velocityTracker)).a(motionEvent);
        }
    }
    ...
    private static f0 e(VelocityTracker velocityTracker) {
        return (f0) f3468a.get(velocityTracker);
    }
}
