...
public abstract class q0 {
    ...
    public static void c(ViewParent viewParent, View view, int i10, int i11, int[] iArr, int i12) {
        if (viewParent instanceof u) {
            ((u) viewParent).onNestedPreScroll(view, i10, i11, iArr, i12);
        } else if (i12 == 0) {
            try {
    ...
    public static void d(ViewParent viewParent, View view, int i10, int i11, int i12, int i13, int i14, int[] iArr) {
        if (viewParent instanceof v) {
            ((v) viewParent).onNestedScroll(view, i10, i11, i12, i13, i14, iArr);
            return;
        }
        iArr[0] = iArr[0] + i12;
        iArr[1] = iArr[1] + i13;
        if (viewParent instanceof u) {
            ((u) viewParent).onNestedScroll(view, i10, i11, i12, i13, i14);
        } else if (i14 == 0) {
            try {
    ...
    public static void e(ViewParent viewParent, View view, View view2, int i10, int i11) {
        if (viewParent instanceof u) {
            ((u) viewParent).onNestedScrollAccepted(view, view2, i10, i11);
        } else if (i11 == 0) {
            try {
    ...
    public static boolean f(ViewParent viewParent, View view, View view2, int i10, int i11) {
        if (viewParent instanceof u) {
            return ((u) viewParent).onStartNestedScroll(view, view2, i10, i11);
        }
        if (i11 == 0) {
            try {
    ...
    public static void g(ViewParent viewParent, View view, int i10) {
        if (viewParent instanceof u) {
            ((u) viewParent).onStopNestedScroll(view, i10);
        } else if (i10 == 0) {
            try {
                a.g(viewParent, view);
            } catch (AbstractMethodError e10) {
