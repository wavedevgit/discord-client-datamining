                ...
                switch (f2709o.get(index)) {
                    ...
                    case 3:
                        if (obtainStyledAttributes.peekValue(index).type == 3) {
                            ...
                            this.f2713d = i1.a.f27750c[obtainStyledAttributes.getInteger(index, 0)];
                            break;
                        }
                    case 4:
            ...
            switch (f2637h.get(index)) {
                ...
                case 65:
                    if (typedArray.peekValue(index).type == 3) {
                        ...
                        aVar.f2648d.f2713d = i1.a.f27750c[typedArray.getInteger(index, 0)];
                        break;
                    }
                case 66:
            ...
            switch (f2638i.get(index)) {
                ...
                case 65:
                    if (typedArray.peekValue(index).type == 3) {
                        ...
                        c0027a.c(65, i1.a.f27750c[typedArray.getInteger(index, 0)]);
                        break;
                    }
                case 66:
