...
public class IdentityCredentialApiHiddenActivity extends Activity {
    ...
    private final void a(Bundle bundle) {
        if (bundle != null) {
            this.f3669e = bundle.getBoolean("androidx.credentials.playservices.AWAITING_RESULT", false);
        }
    }
    ...
    protected void onActivityResult(int i10, int i11, Intent intent) {
        ...
        ResultReceiver resultReceiver = this.f3668d;
    ...
    protected void onCreate(Bundle bundle) {
        ...
        if (pendingIntent != null) {
            startIntentSenderForResult(pendingIntent.getIntentSender(), m2.a.f36731b.b(), null, 0, 0, 0, null);
            return;
        }
        ResultReceiver resultReceiver2 = this.f3668d;
        if (resultReceiver2 != null) {
            m2.a.f36731b.e(resultReceiver2, "GET_UNKNOWN", "Internal error");
        }
        finish();
    }
    ...
    protected void onSaveInstanceState(Bundle outState) {
        ...
        outState.putBoolean("androidx.credentials.playservices.AWAITING_RESULT", this.f3669e);
