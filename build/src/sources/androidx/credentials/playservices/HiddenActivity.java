...
public class HiddenActivity extends Activity {
    ...
    public static final class b extends Lambda implements Function1 {
        ...
        public final void a(ve.b bVar) {
            try {
                HiddenActivity.this.f3961e = true;
                HiddenActivity.this.startIntentSenderForResult(bVar.b().getIntentSender(), this.f3963e, null, 0, 0, 0, null);
            } catch (IntentSender.SendIntentException e10) {
                HiddenActivity hiddenActivity = HiddenActivity.this;
                ResultReceiver resultReceiver = hiddenActivity.f3960d;
    ...
    public static final class c extends Lambda implements Function1 {
        ...
        public final void a(g gVar) {
            try {
                HiddenActivity.this.f3961e = true;
                HiddenActivity.this.startIntentSenderForResult(gVar.b().getIntentSender(), this.f3965e, null, 0, 0, 0, null);
            } catch (IntentSender.SendIntentException e10) {
                HiddenActivity hiddenActivity = HiddenActivity.this;
                ResultReceiver resultReceiver = hiddenActivity.f3960d;
                Intrinsics.checkNotNull(resultReceiver);
    ...
    public static final class d extends Lambda implements Function1 {
        ...
        public final void a(PendingIntent result) {
            ...
            try {
                HiddenActivity.this.f3961e = true;
                HiddenActivity.this.startIntentSenderForResult(result.getIntentSender(), this.f3967e, null, 0, 0, 0, null);
            } catch (IntentSender.SendIntentException e10) {
                HiddenActivity hiddenActivity = HiddenActivity.this;
                ResultReceiver resultReceiver = hiddenActivity.f3960d;
                Intrinsics.checkNotNull(resultReceiver);
    ...
    public static final class e extends Lambda implements Function1 {
        ...
        public final void a(PendingIntent pendingIntent) {
            try {
                HiddenActivity.this.f3961e = true;
                HiddenActivity.this.startIntentSenderForResult(pendingIntent.getIntentSender(), this.f3969e, null, 0, 0, 0, null);
            } catch (IntentSender.SendIntentException e10) {
                HiddenActivity hiddenActivity = HiddenActivity.this;
                ResultReceiver resultReceiver = hiddenActivity.f3960d;
                Intrinsics.checkNotNull(resultReceiver);
    ...
    private final void l() {
        ...
        if (aVar != null) {
            ...
            task = c10.g(new yg.g() { // from class: l2.g
                @Override // yg.g
    ...
    private final void o() {
        ...
        if (fVar != null) {
            ...
            task = f10.g(new yg.g() { // from class: l2.c
                @Override // yg.g
                public final void onSuccess(Object obj) {
    ...
    private final void r() {
        ...
        if (rVar != null) {
            ...
            task = C.g(new yg.g() { // from class: l2.a
                @Override // yg.g
                public final void onSuccess(Object obj) {
    ...
    private final void u() {
        ...
        if (dVar != null) {
            ...
            task = b10.g(new yg.g() { // from class: l2.e
                @Override // yg.g
                public final void onSuccess(Object obj) {
    ...
    private final void x(Bundle bundle) {
        if (bundle != null) {
            this.f3961e = bundle.getBoolean("androidx.credentials.playservices.AWAITING_RESULT", false);
        }
    }
    ...
    protected void onSaveInstanceState(Bundle outState) {
        ...
        outState.putBoolean("androidx.credentials.playservices.AWAITING_RESULT", this.f3961e);
