...
public class HiddenActivity extends Activity {
    ...
    public static final class b extends Lambda implements Function1 {
        ...
        public final void a(ve.b bVar) {
            try {
                HiddenActivity.this.f3632e = true;
                HiddenActivity.this.startIntentSenderForResult(bVar.b().getIntentSender(), this.f3634e, null, 0, 0, 0, null);
            } catch (IntentSender.SendIntentException e10) {
                HiddenActivity hiddenActivity = HiddenActivity.this;
                ResultReceiver resultReceiver = hiddenActivity.f3631d;
    ...
    public static final class c extends Lambda implements Function1 {
        ...
        public final void a(g gVar) {
            try {
                HiddenActivity.this.f3632e = true;
                HiddenActivity.this.startIntentSenderForResult(gVar.b().getIntentSender(), this.f3636e, null, 0, 0, 0, null);
            } catch (IntentSender.SendIntentException e10) {
                HiddenActivity hiddenActivity = HiddenActivity.this;
                ResultReceiver resultReceiver = hiddenActivity.f3631d;
                Intrinsics.checkNotNull(resultReceiver);
    ...
    public static final class d extends Lambda implements Function1 {
        ...
        public final void a(PendingIntent result) {
            ...
            try {
                HiddenActivity.this.f3632e = true;
                HiddenActivity.this.startIntentSenderForResult(result.getIntentSender(), this.f3638e, null, 0, 0, 0, null);
            } catch (IntentSender.SendIntentException e10) {
                HiddenActivity hiddenActivity = HiddenActivity.this;
                ResultReceiver resultReceiver = hiddenActivity.f3631d;
                Intrinsics.checkNotNull(resultReceiver);
    ...
    public static final class e extends Lambda implements Function1 {
        ...
        public final void a(PendingIntent pendingIntent) {
            try {
                HiddenActivity.this.f3632e = true;
                HiddenActivity.this.startIntentSenderForResult(pendingIntent.getIntentSender(), this.f3640e, null, 0, 0, 0, null);
            } catch (IntentSender.SendIntentException e10) {
                HiddenActivity hiddenActivity = HiddenActivity.this;
                ResultReceiver resultReceiver = hiddenActivity.f3631d;
                Intrinsics.checkNotNull(resultReceiver);
    ...
    private final void l() {
        ...
        if (aVar != null) {
            ...
            task = c10.g(new xg.g() { // from class: l2.g
                @Override // xg.g
    ...
    public static final void n(HiddenActivity hiddenActivity, Exception e10) {
        ...
        if ((e10 instanceof ef.b) && m2.a.f37242b.d().contains(Integer.valueOf(((ef.b) e10).b()))) {
            str = "GET_INTERRUPTED";
        } else {
    ...
    private final void o() {
        ...
        if (fVar != null) {
            ...
            task = f10.g(new xg.g() { // from class: l2.c
                @Override // xg.g
                public final void onSuccess(Object obj) {
    ...
    private final void r() {
        ...
        if (rVar != null) {
            ...
            task = C.g(new xg.g() { // from class: l2.a
                @Override // xg.g
                public final void onSuccess(Object obj) {
    ...
    private final void u() {
        ...
        if (dVar != null) {
            ...
            task = b10.g(new xg.g() { // from class: l2.e
                @Override // xg.g
                public final void onSuccess(Object obj) {
    ...
    private final void x(Bundle bundle) {
        if (bundle != null) {
            this.f3632e = bundle.getBoolean("androidx.credentials.playservices.AWAITING_RESULT", false);
        }
    }

    /* JADX INFO: Access modifiers changed from: private */
    public final void y(ResultReceiver resultReceiver, String str, String str2) {
        m2.a.f37242b.e(resultReceiver, str, str2);
        finish();
    }
    ...
    protected void onActivityResult(int i10, int i11, Intent intent) {
        ...
        ResultReceiver resultReceiver = this.f3631d;
        if (resultReceiver != null) {
            m2.a.f37242b.f(resultReceiver, i10, i11, intent);
        }
        this.f3632e = false;
        finish();
    }
    ...
    protected void onSaveInstanceState(Bundle outState) {
        ...
        outState.putBoolean("androidx.credentials.playservices.AWAITING_RESULT", this.f3632e);
