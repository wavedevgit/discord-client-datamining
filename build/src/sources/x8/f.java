...
public abstract class f {
    ...
    private static final Uri f54697a = Uri.withAppendedPath((Uri) eb.a.e(ContactsContract.AUTHORITY_URI), "display_photo");
    ...
    public static boolean l(Uri uri) {
        if (uri.getPath() == null || !m(uri) || !"com.android.contacts".equals(uri.getAuthority()) || uri.getPath().startsWith((String) eb.a.e(f54697a.getPath()))) {
            return false;
        }
        return true;
    }
