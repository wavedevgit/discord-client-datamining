...
class n implements l {
    ...
    private final g f48329a;

    /* renamed from: b  reason: collision with root package name */
    private final q f48330b;

    /* renamed from: c  reason: collision with root package name */
    private final t f48331c;

    /* renamed from: d  reason: collision with root package name */
    private final Map f48332d;

    /* renamed from: e  reason: collision with root package name */
    private final l.a f48333e;

    /* loaded from: /home/runner/work/discord-client-datamining/discord-client-datamining/build/classes4.dex */
    static class a implements l.b {

        /* renamed from: a  reason: collision with root package name */
        private final Map f48334a = new HashMap();
        ...
        public l a(g gVar, q qVar) {
            l.a aVar = this.f48335b;
            if (aVar == null) {
                aVar = new b();
            }
            return new n(gVar, qVar, new t(), Collections.unmodifiableMap(this.f48334a), aVar);
        }

        @Override // sr.l.b
        public l.b b(Class cls, l.c cVar) {
            if (cVar == null) {
                this.f48334a.remove(cls);
                return this;
            }
            this.f48334a.put(cls, cVar);
            return this;
        }
    }
    ...
    private void G(aw.r rVar) {
        l.c cVar = (l.c) this.f48332d.get(rVar.getClass());
        if (cVar != null) {
            cVar.a(this, rVar);
        } else {
            i(rVar);
    ...
    public void F(Class cls, int i10) {
        s a10 = this.f48329a.c().a(cls);
        if (a10 != null) {
            c(i10, a10.a(this.f48329a, this.f48330b));
        }
    }
