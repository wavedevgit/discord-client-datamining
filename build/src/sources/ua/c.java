...
public class c implements RequestListener {
    ...
    public c(Set set) {
        this.f51224a = new ArrayList(set.size());
        Iterator it = set.iterator();
        while (it.hasNext()) {
            RequestListener requestListener = (RequestListener) it.next();
            if (requestListener != null) {
                this.f51224a.add(requestListener);
            }
        }
    }
    ...
    public void onProducerEvent(String str, String str2, String str3) {
        int size = this.f51224a.size();
        for (int i10 = 0; i10 < size; i10++) {
            try {
                ((RequestListener) this.f51224a.get(i10)).onProducerEvent(str, str2, str3);
            } catch (Exception e10) {
    ...
    public void onProducerFinishWithCancellation(String str, String str2, Map map) {
        ...
        for (int i10 = 0; i10 < size; i10++) {
            try {
                ((RequestListener) this.f51224a.get(i10)).onProducerFinishWithCancellation(str, str2, map);
            } catch (Exception e10) {
    ...
    public void onProducerFinishWithFailure(String str, String str2, Throwable th2, Map map) {
        ...
        for (int i10 = 0; i10 < size; i10++) {
            try {
                ((RequestListener) this.f51224a.get(i10)).onProducerFinishWithFailure(str, str2, th2, map);
            } catch (Exception e10) {
    ...
    public void onProducerFinishWithSuccess(String str, String str2, Map map) {
        ...
        for (int i10 = 0; i10 < size; i10++) {
            try {
                ((RequestListener) this.f51224a.get(i10)).onProducerFinishWithSuccess(str, str2, map);
            } catch (Exception e10) {
    ...
    public void onProducerStart(String str, String str2) {
        ...
        for (int i10 = 0; i10 < size; i10++) {
            try {
                ((RequestListener) this.f51224a.get(i10)).onProducerStart(str, str2);
            } catch (Exception e10) {
    ...
    public void onRequestCancellation(String str) {
        ...
        for (int i10 = 0; i10 < size; i10++) {
            try {
                ((RequestListener) this.f51224a.get(i10)).onRequestCancellation(str);
            } catch (Exception e10) {
    ...
    public void onRequestFailure(ImageRequest imageRequest, String str, Throwable th2, boolean z10) {
        ...
        for (int i10 = 0; i10 < size; i10++) {
            try {
                ((RequestListener) this.f51224a.get(i10)).onRequestFailure(imageRequest, str, th2, z10);
            } catch (Exception e10) {
    ...
    public void onRequestStart(ImageRequest imageRequest, Object obj, String str, boolean z10) {
        ...
        for (int i10 = 0; i10 < size; i10++) {
            try {
                ((RequestListener) this.f51224a.get(i10)).onRequestStart(imageRequest, obj, str, z10);
            } catch (Exception e10) {
    ...
    public void onRequestSuccess(ImageRequest imageRequest, String str, boolean z10) {
        ...
        for (int i10 = 0; i10 < size; i10++) {
            try {
                ((RequestListener) this.f51224a.get(i10)).onRequestSuccess(imageRequest, str, z10);
            } catch (Exception e10) {
    ...
    public void onUltimateProducerReached(String str, String str2, boolean z10) {
        ...
        for (int i10 = 0; i10 < size; i10++) {
            try {
                ((RequestListener) this.f51224a.get(i10)).onUltimateProducerReached(str, str2, z10);
            } catch (Exception e10) {
                a("InternalListener exception in onProducerFinishWithSuccess", e10);
            }
        }
    ...
    public boolean requiresExtraMap(String str) {
        int size = this.f51224a.size();
        for (int i10 = 0; i10 < size; i10++) {
            if (((RequestListener) this.f51224a.get(i10)).requiresExtraMap(str)) {
                return true;
            }
        }
        return false;
    ...
    public c(RequestListener... requestListenerArr) {
        this.f51224a = new ArrayList(requestListenerArr.length);
