...
public class h {
    ...
    private static volatile h f23248b;

    /* renamed from: c  reason: collision with root package name */
    private static final Logger f23249c;
    ...
    public static final class a {
        ...
        private final h e() {
            ...
            c a11;
            d b10;
            if (j() && (b10 = d.f23229e.b()) != null) {
                return b10;
            }
            if (i() && (a11 = c.f23226e.a()) != null) {
                return a11;
            }
            if (k() && (a10 = g.f23244e.a()) != null) {
                return a10;
            }
            f a12 = f.f23242d.a();
            if (a12 != null) {
    ...
    static {
        ...
        f23247a = aVar;
        f23248b = aVar.f();
        f23249c = Logger.getLogger(OkHttpClient.class.getName());
    }
    ...
    public hu.c c(X509TrustManager trustManager) {
        ...
        return new hu.a(d(trustManager));
    }
    ...
    public hu.e d(X509TrustManager trustManager) {
        ...
        return new hu.b((X509Certificate[]) Arrays.copyOf(acceptedIssuers, acceptedIssuers.length));
    }
    ...
    public Object i(String closer) {
        ...
        if (f23249c.isLoggable(Level.FINE)) {
