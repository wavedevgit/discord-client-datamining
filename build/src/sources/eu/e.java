...
public final class e extends h {
    ...
    public static final b f23233i = new b(null);

    /* renamed from: d  reason: collision with root package name */
    private final Method f23234d;

    /* renamed from: e  reason: collision with root package name */
    private final Method f23235e;

    /* renamed from: f  reason: collision with root package name */
    private final Method f23236f;

    /* renamed from: g  reason: collision with root package name */
    private final Class f23237g;

    /* renamed from: h  reason: collision with root package name */
    private final Class f23238h;
            ...
            if (Intrinsics.areEqual(name, "unsupported") && Intrinsics.areEqual(Void.TYPE, returnType)) {
                ...
                if ((Intrinsics.areEqual(name, "selectProtocol") || Intrinsics.areEqual(name, "select")) && Intrinsics.areEqual(String.class, returnType) && objArr.length == 1) {
                    ...
                    if (obj instanceof List) {
                        ...
                        String str2 = (String) this.f23239a.get(0);
                        this.f23241c = str2;
                        return str2;
                    }
                }
    ...
    public e(Method putMethod, Method getMethod, Method removeMethod, Class clientProviderClass, Class serverProviderClass) {
        ...
        this.f23234d = putMethod;
        this.f23235e = getMethod;
        this.f23236f = removeMethod;
        this.f23237g = clientProviderClass;
        this.f23238h = serverProviderClass;
    }
    ...
    public void b(SSLSocket sslSocket) {
        ...
        try {
            this.f23236f.invoke(null, sslSocket);
    ...
    public void e(SSLSocket sslSocket, String str, List protocols) {
        ...
        Intrinsics.checkNotNullParameter(protocols, "protocols");
        try {
            this.f23234d.invoke(null, sslSocket, Proxy.newProxyInstance(h.class.getClassLoader(), new Class[]{this.f23237g, this.f23238h}, new a(h.f23247a.b(protocols))));
        } catch (IllegalAccessException e10) {
    ...
    public String h(SSLSocket sslSocket) {
        Intrinsics.checkNotNullParameter(sslSocket, "sslSocket");
        try {
            InvocationHandler invocationHandler = Proxy.getInvocationHandler(this.f23235e.invoke(null, sslSocket));
