...
public final class d {
    ...
    private final String b(c.C0302c c0302c) {
        Object obj = c0302c.b().get("coil#disk_cache_key");
    ...
    private final boolean d(c.C0302c c0302c) {
        Boolean bool;
        Object obj = c0302c.b().get("coil#is_sampled");
    ...
    */
    private final boolean e(g5.h r18, e5.c.b r19, e5.c.C0302c r20, h5.i r21, h5.h r22) {
        /*
            r17 = this;
            r0 = r17
            r1 = r20
    ...
    public final c.C0302c a(g5.h hVar, c.b bVar, h5.i iVar, h5.h hVar2) {
        c.C0302c c0302c;
        if (!hVar.C().d()) {
            return null;
        }
        ...
        if (c0302c == null || !c(hVar, bVar, c0302c, iVar, hVar2)) {
            return null;
        }
        return c0302c;
    }
    ...
    public final q g(b.a aVar, g5.h hVar, c.b bVar, c.C0302c c0302c) {
        return new q(new BitmapDrawable(hVar.l().getResources(), c0302c.a()), hVar, x4.h.f54912d, bVar, b(c0302c), d(c0302c), k.t(aVar));
    }
    ...
    public final boolean h(c.b bVar, g5.h hVar, a.b bVar2) {
        ...
        if (hVar.C().e() && (b10 = this.f22315a.b()) != null && bVar != null) {
            ...
            if (bitmapDrawable != null && (bitmap = bitmapDrawable.getBitmap()) != null) {
                ...
                b10.c(bVar, new c.C0302c(bitmap, linkedHashMap));
                return true;
            }
        }
        return false;
