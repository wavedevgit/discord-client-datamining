...
public final class b {
    ...
    public /* synthetic */ class C0122b {
        ...
        static {
            ...
            try {
                iArr[aw.a.MILLISECOND.ordinal()] = 1;
            } catch (NoSuchFieldError unused) {
            }
            try {
                iArr[aw.a.SECOND.ordinal()] = 2;
            } catch (NoSuchFieldError unused2) {
            }
            try {
                iArr[aw.a.MINUTE.ordinal()] = 3;
            } catch (NoSuchFieldError unused3) {
            }
            try {
                iArr[aw.a.HOUR.ordinal()] = 4;
            } catch (NoSuchFieldError unused4) {
            }
            try {
                iArr[aw.a.DAY.ordinal()] = 5;
            } catch (NoSuchFieldError unused5) {
            }
            try {
                iArr[aw.a.MONTH.ordinal()] = 6;
            } catch (NoSuchFieldError unused6) {
            }
            try {
                iArr[aw.a.YEAR.ordinal()] = 7;
    ...
    private final String b(aw.a aVar) {
        switch (C0122b.f6228a[aVar.ordinal()]) {
            case 1:
                return "";
            case 2:
                return ".001Z";
    ...
    public final e a(String isoDate, aw.a precision) {
