...
public abstract class f {
    ...
    public static final Drawable b(Context context, int i10, int i11) {
        ...
        int c10 = androidx.core.content.a.c(context, tp.b.f49772a);
        int c11 = androidx.core.content.a.c(context, tp.b.f49773b);
        ...
        gradientDrawable.setSize(i11 + ((int) bq.h.a(24.0d)), gradientDrawable.getMinimumHeight());
        return new InsetDrawable((Drawable) gradientDrawable, (int) bq.h.a(4.0d));
    }
    ...
    public static final void d(TextView textView, String text) {
        ...
        c10.d(textView, e10);
        if (e10.getSpans(0, e10.length(), vr.g.class).length == 0 && e10.getSpans(0, e10.length(), URLSpan.class).length == 0) {
