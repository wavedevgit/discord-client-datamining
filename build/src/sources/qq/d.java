...
public final class d {
    ...
    public static final d f46179a;

    /* renamed from: b  reason: collision with root package name */
    private static final Lazy f46180b;

    /* renamed from: c  reason: collision with root package name */
    private static final b f46181c;

    /* renamed from: d  reason: collision with root package name */
    private static final Map f46182d;

    /* renamed from: e  reason: collision with root package name */
    private static final b4 f46183e;
    ...
    static {
        d dVar = new d();
        f46179a = dVar;
        f46180b = as.l.b(new Function0() { // from class: qq.c
    ...
    private final List d() {
        ...
        for (Map.Entry entry2 : linkedHashMap.entrySet()) {
            arrayList.add(f46179a.m((b) entry2.getValue()));
        }
    ...
    public final b4 g(String str) {
        ...
        if (str != null && str.length() == 2) {
            ...
            Intrinsics.checkNotNullExpressionValue(upperCase, "toUpperCase(...)");
            b bVar = (b) f46182d.get(upperCase);
