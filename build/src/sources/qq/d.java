...
public final class d {
    ...
    public static final d f45610a;

    /* renamed from: b  reason: collision with root package name */
    private static final Lazy f45611b;

    /* renamed from: c  reason: collision with root package name */
    private static final b f45612c;

    /* renamed from: d  reason: collision with root package name */
    private static final Map f45613d;

    /* renamed from: e  reason: collision with root package name */
    private static final b4 f45614e;

    /* loaded from: /home/runner/work/discord-client-datamining/discord-client-datamining/build/classes4.dex */
    public static final class a implements Comparator {
        @Override // java.util.Comparator
        public final int compare(Object obj, Object obj2) {
            return ds.a.d(((b4) obj).getText(), ((b4) obj2).getText());
        }
    }
    ...
    static {
        d dVar = new d();
        f45610a = dVar;
        f45611b = as.l.b(new Function0() { // from class: qq.c
    ...
    private final List d() {
        ...
        for (Map.Entry entry2 : linkedHashMap.entrySet()) {
            arrayList.add(f45610a.m((b) entry2.getValue()));
        }
    ...
    public final b4 g(String str) {
        ...
        if (str != null && str.length() == 2) {
            ...
            Intrinsics.checkNotNullExpressionValue(upperCase, "toUpperCase(...)");
            b bVar = (b) f45613d.get(upperCase);
    ...
    */
    public final java.lang.String i(pq.b4 r8) {
        /*
            r7 = this;
        ...
        L3e:
            ...
            return r8
        */
        throw new UnsupportedOperationException("Method not decompiled: qq.d.i(pq.b4):java.lang.String");
    }
