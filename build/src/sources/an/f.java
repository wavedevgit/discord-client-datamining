...
public final class f extends ReactViewGroup implements h {
    ...
    private final ThemedReactContext f864d;

    /* renamed from: e  reason: collision with root package name */
    private final JSTouchDispatcher f865e;

    /* renamed from: i  reason: collision with root package name */
    private c f866i;

    /* renamed from: o  reason: collision with root package name */
    private EventDispatcher f867o;

    /* renamed from: p  reason: collision with root package name */
    private StateWrapper f868p;
    ...
    public f(ThemedReactContext reactContext) {
        ...
        this.f864d = reactContext;
        this.f865e = new JSTouchDispatcher(this);
        if (ReactFeatureFlags.dispatchPointerEvents) {
            this.f866i = new c(this);
        }
    }

    private final void e(int i10, int i11) {
        WritableNativeMap writableNativeMap = new WritableNativeMap();
        writableNativeMap.putDouble("screenWidth", om.d.a(i10));
        writableNativeMap.putDouble("screenHeight", om.d.a(i11));
        StateWrapper stateWrapper = this.f868p;
    ...
    public void handleException(Throwable t10) {
        ...
        this.f864d.getReactApplicationContext().handleException(new RuntimeException(t10));
    }
    ...
    public void onChildEndedNativeGesture(View childView, MotionEvent ev2) {
        ...
        EventDispatcher eventDispatcher = this.f867o;
        if (eventDispatcher != null) {
            this.f865e.onChildEndedNativeGesture(ev2, eventDispatcher);
        }
        c cVar = this.f866i;
        if (cVar != null) {
    ...
    public boolean onHoverEvent(MotionEvent event) {
        ...
        EventDispatcher eventDispatcher = this.f867o;
        if (eventDispatcher != null && (cVar = this.f866i) != null) {
    ...
    public boolean onInterceptTouchEvent(MotionEvent event) {
        ...
        if (eventDispatcher != null) {
            try {
                this.f865e.handleTouchEvent(event, eventDispatcher);
                c cVar = this.f866i;
                if (cVar != null) {
                    cVar.f(event, eventDispatcher, true);
                ...
                sm.a.f48171a.e(g.a(), "Can not handle touch event", e10);
    ...
    public void onChildStartedNativeGesture(View view, MotionEvent ev2) {
        ...
        EventDispatcher eventDispatcher = this.f867o;
        if (eventDispatcher != null) {
            this.f865e.onChildStartedNativeGesture(ev2, eventDispatcher);
            c cVar = this.f866i;
            if (cVar != null) {
