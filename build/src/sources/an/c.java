...
public abstract class c {
    ...
    public static final Set f1162a;

    /* renamed from: b  reason: collision with root package name */
    public static final Type[] f1163b;

    /* renamed from: c  reason: collision with root package name */
    public static final Class f1164c;

    /* renamed from: d  reason: collision with root package name */
    private static final Class f1165d;

    /* renamed from: e  reason: collision with root package name */
    private static final Map f1166e;

    /* loaded from: /home/runner/work/discord-client-datamining/discord-client-datamining/build/classes4.dex */
    public static final class a implements GenericArrayType {

        /* renamed from: d  reason: collision with root package name */
        private final Type f1167d;

        public a(Type type) {
            this.f1167d = c.a(type);
        }
        ...
        public int hashCode() {
            return this.f1167d.hashCode();
        }

        public String toString() {
            return c.v(this.f1167d) + "[]";
        }
    }
    ...
    public static final class b implements ParameterizedType {
        ...
        /* renamed from: d  reason: collision with root package name */
        private final Type f1168d;

        /* renamed from: e  reason: collision with root package name */
        private final Type f1169e;

        /* renamed from: i  reason: collision with root package name */
        public final Type[] f1170i;
        ...
        public b(Type type, Type type2, Type... typeArr) {
            ...
            this.f1168d = a10;
            this.f1169e = c.a(type2);
            this.f1170i = (Type[]) typeArr.clone();
            int i10 = 0;
            while (true) {
                Type[] typeArr2 = this.f1170i;
                if (i10 < typeArr2.length) {
                    typeArr2[i10].getClass();
                    c.b(this.f1170i[i10]);
                    Type[] typeArr3 = this.f1170i;
        ...
        public int hashCode() {
            return (Arrays.hashCode(this.f1170i) ^ this.f1169e.hashCode()) ^ c.g(this.f1168d);
        }

        public String toString() {
            StringBuilder sb2 = new StringBuilder((this.f1170i.length + 1) * 30);
            sb2.append(c.v(this.f1169e));
            if (this.f1170i.length == 0) {
                return sb2.toString();
            }
            sb2.append("<");
            sb2.append(c.v(this.f1170i[0]));
            for (int i10 = 1; i10 < this.f1170i.length; i10++) {
                sb2.append(", ");
                sb2.append(c.v(this.f1170i[i10]));
            }
            sb2.append(">");
            return sb2.toString();
        }
    ...
    /* loaded from: /home/runner/work/discord-client-datamining/discord-client-datamining/build/classes4.dex */
    public static final class C0011c implements WildcardType {

        /* renamed from: d  reason: collision with root package name */
        private final Type f1171d;

        /* renamed from: e  reason: collision with root package name */
        private final Type f1172e;

        public C0011c(Type[] typeArr, Type[] typeArr2) {
                ...
                if (typeArr.length == 1) {
                    if (typeArr2.length == 1) {
                        ...
                        if (typeArr[0] == Object.class) {
                            this.f1172e = c.a(typeArr2[0]);
                            this.f1171d = Object.class;
                            return;
                        }
        ...
        public Type[] getLowerBounds() {
            Type type = this.f1172e;
            return type != null ? new Type[]{type} : c.f1163b;
        }

        @Override // java.lang.reflect.WildcardType
        public Type[] getUpperBounds() {
            return new Type[]{this.f1171d};
        }
        ...
        public int hashCode() {
            ...
            return i10 ^ (this.f1171d.hashCode() + 31);
        }

        public String toString() {
            if (this.f1172e != null) {
                return "? super " + c.v(this.f1172e);
            } else if (this.f1171d == Object.class) {
                return "?";
            } else {
                return "? extends " + c.v(this.f1171d);
            }
        }
    }
    ...
    static {
        ...
        L18:
            ...
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: an.c.<clinit>():void");
    }
    ...
    public static Type a(Type type) {
        if (type instanceof Class) {
            ...
            if (type instanceof C0011c) {
                return type;
            }
            WildcardType wildcardType = (WildcardType) type;
            return new C0011c(wildcardType.getUpperBounds(), wildcardType.getLowerBounds());
        } else {
            return type;
        }
    }
    ...
    public static boolean i(Class cls) {
        Class<? extends Annotation> cls2 = f1165d;
    ...
    */
    private static java.lang.reflect.Type r(java.lang.reflect.Type r8, java.lang.Class r9, java.lang.reflect.Type r10, java.util.Collection r11) {
        ...
        Lbf:
            return r10
        */
        throw new UnsupportedOperationException("Method not decompiled: an.c.r(java.lang.reflect.Type, java.lang.Class, java.lang.reflect.Type, java.util.Collection):java.lang.reflect.Type");
    }
