...
public final class v extends kotlin.coroutines.jvm.internal.d implements FlowCollector, CoroutineStackFrame {
    ...
    public final FlowCollector f42018d;

    /* renamed from: e  reason: collision with root package name */
    public final CoroutineContext f42019e;

    /* renamed from: i  reason: collision with root package name */
    public final int f42020i;

    /* renamed from: o  reason: collision with root package name */
    private CoroutineContext f42021o;

    /* renamed from: p  reason: collision with root package name */
    private Continuation f42022p;

    public v(FlowCollector flowCollector, CoroutineContext coroutineContext) {
        super(r.f42012d, kotlin.coroutines.e.f32538d);
        this.f42018d = flowCollector;
        this.f42019e = coroutineContext;
        this.f42020i = ((Number) coroutineContext.y1(0, new Function2() { // from class: ns.u
    ...
    private final Object m(Continuation continuation, Object obj) {
        ...
        CoroutineContext coroutineContext = this.f42021o;
        if (coroutineContext != context) {
            k(context, coroutineContext, obj);
            this.f42021o = context;
        }
        this.f42022p = continuation;
        Function3 a10 = w.a();
        FlowCollector flowCollector = this.f42018d;
        ...
        if (!Intrinsics.areEqual(invoke, rr.b.f())) {
            this.f42022p = null;
        }
        return invoke;
    }
    ...
    private final void n(m mVar, Object obj) {
        throw new IllegalStateException(StringsKt.j("\n            Flow exception transparency is violated:\n                Previous 'emit' call has thrown exception " + mVar.f42006e + ", but then emission attempt of value '" + obj + "' has been detected.\n                Emissions from 'catch' blocks are prohibited in order to avoid unspecified behaviour, 'Flow.catch' operator can be used instead.\n                For a more detailed explanation, please refer to Flow documentation.\n            ").toString());
    }
    ...
    public Object emit(Object obj, Continuation continuation) {
        try {
            ...
            this.f42021o = new m(th2, continuation.getContext());
            throw th2;
        }
    }
    ...
    public CoroutineStackFrame getCallerFrame() {
        Continuation continuation = this.f42022p;
    ...
    protected Object invokeSuspend(Object obj) {
        ...
        if (e10 != null) {
            this.f42021o = new m(e10, getContext());
        }
        Continuation continuation = this.f42022p;
