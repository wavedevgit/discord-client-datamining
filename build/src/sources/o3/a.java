...
public class a extends FrameData {
    ...
    public boolean equals(Object obj) {
        if ((obj instanceof a) && super.equals(obj) && this.f39122e == ((a) obj).f39122e) {
            return true;
        }
        return false;
    }
    ...
    @Override // androidx.metrics.performance.FrameData
    public int hashCode() {
        return (super.hashCode() * 31) + Long.hashCode(this.f39122e);
    }

    @Override // androidx.metrics.performance.FrameData
    public String toString() {
        return "FrameData(frameStartNanos=" + b() + ", frameDurationUiNanos=" + a() + ", frameDurationCpuNanos=" + this.f39122e + ", isJank=" + d() + ", states=" + c() + ')';
    }
}
