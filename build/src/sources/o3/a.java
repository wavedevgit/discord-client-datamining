...
public class a extends FrameData {
    ...
    public boolean equals(Object obj) {
        if ((obj instanceof a) && super.equals(obj) && this.f42320e == ((a) obj).f42320e) {
            return true;
        }
        return false;
    }
    ...
    @Override // androidx.metrics.performance.FrameData
    public int hashCode() {
        return (super.hashCode() * 31) + Long.hashCode(this.f42320e);
    }

    @Override // androidx.metrics.performance.FrameData
    public String toString() {
        return "FrameData(frameStartNanos=" + b() + ", frameDurationUiNanos=" + a() + ", frameDurationCpuNanos=" + this.f42320e + ", isJank=" + d() + ", states=" + c() + ')';
    }
}
