...
public final class i implements Serializable {
    ...
    public static final i f31622b = new i(0);
    ...
    public final j$.time.temporal.k a(ChronoLocalDate chronoLocalDate) {
        j$.time.chrono.j jVar = (j$.time.chrono.j) chronoLocalDate.a(o.f31646b);
        if (jVar == null || j$.time.chrono.k.f31542a.equals(jVar)) {
    ...
    public final boolean equals(Object obj) {
        ...
        return (obj instanceof i) && this.f31623a == ((i) obj).f31623a;
    }

    public final int hashCode() {
        return Integer.rotateLeft(this.f31623a, 16) + Integer.rotateLeft(0, 8);
    }
