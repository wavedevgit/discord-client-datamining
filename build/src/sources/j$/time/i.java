...
public final class i implements Serializable {
    ...
    public static final i f31638b = new i(0);
    ...
    public final j$.time.temporal.k a(ChronoLocalDate chronoLocalDate) {
        j$.time.chrono.j jVar = (j$.time.chrono.j) chronoLocalDate.a(o.f31662b);
        if (jVar == null || j$.time.chrono.k.f31558a.equals(jVar)) {
    ...
    public final boolean equals(Object obj) {
        ...
        return (obj instanceof i) && this.f31639a == ((i) obj).f31639a;
    }

    public final int hashCode() {
        return Integer.rotateLeft(this.f31639a, 16) + Integer.rotateLeft(0, 8);
    }
