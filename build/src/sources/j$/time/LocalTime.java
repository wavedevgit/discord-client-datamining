...
public final class LocalTime implements j$.time.temporal.k, j$.time.temporal.l, Comparable<LocalTime>, Serializable {
    ...
    public static final LocalTime f30489e;

    /* renamed from: f  reason: collision with root package name */
    public static final LocalTime[] f30490f = new LocalTime[24];
    ...
    static {
        int i10 = 0;
        while (true) {
            LocalTime[] localTimeArr = f30490f;
    ...
    public static LocalTime t(TemporalAccessor temporalAccessor) {
        ...
        LocalTime localTime = (LocalTime) temporalAccessor.a(o.f30625g);
        if (localTime != null) {
            return localTime;
        }
    ...
    public static LocalTime parse(CharSequence charSequence) {
        DateTimeFormatter dateTimeFormatter = DateTimeFormatter.f30523f;
    ...
    public LocalTime(int i10, int i11, int i12, int i13) {
        this.f30491a = (byte) i10;
        this.f30492b = (byte) i11;
        this.f30493c = (byte) i12;
        this.f30494d = i13;
    }
    ...
    public final int w(n nVar) {
        switch (e.f30520a[((j$.time.temporal.a) nVar).ordinal()]) {
            ...
            case 9:
                return this.f30492b;
            case 10:
                return (this.f30491a * 60) + this.f30492b;
            case 11:
                return this.f30491a % 12;
            case 12:
                int i10 = this.f30491a % 12;
                if (i10 % 12 == 0) {
                    return 12;
                }
                return i10;
            ...
            switch (e.f30520a[aVar.ordinal()]) {
                ...
                case 7:
                    ...
                    if (this.f30493c != i10) {
                        ...
                        return r(this.f30491a, this.f30492b, i10, this.f30494d);
                    }
                    break;
                case 8:
                ...
                case 9:
                    ...
                    if (this.f30492b != i11) {
                        j$.time.temporal.a.MINUTE_OF_HOUR.E(i11);
                        return r(this.f30491a, i11, this.f30493c, this.f30494d);
                    }
                    break;
                case 10:
                    return C(j10 - ((this.f30491a * 60) + this.f30492b));
                case 11:
                    return B(j10 - (this.f30491a % 12));
                case 12:
                    if (j10 == 12) {
                        j10 = 0;
                    }
                ...
                case 13:
                    ...
                    if (this.f30491a != i12) {
                        ...
                        return r(i12, this.f30492b, this.f30493c, this.f30494d);
                    }
                    break;
                case 14:
                    if (j10 == 24) {
                    ...
                    if (this.f30491a != i13) {
                        ...
                        return r(i13, this.f30492b, this.f30493c, this.f30494d);
                    }
                    break;
                case 15:
                    return B((j10 - (this.f30491a / 12)) * 12);
                default:
                    throw new DateTimeException("Unsupported field: " + nVar);
            }
            return this;
    ...
    public final LocalTime I(int i10) {
        ...
        return r(this.f30491a, this.f30492b, this.f30493c, i10);
    }

    @Override // j$.time.temporal.k
    public final j$.time.temporal.k h(long j10, j$.time.temporal.b bVar) {
        if (bVar != null) {
            switch (e.f30521b[bVar.ordinal()]) {
                case 1:
                    return E(j10);
                case 2:
    ...
    public final LocalTime B(long j10) {
        return j10 == 0 ? this : r(((((int) (j10 % 24)) + this.f30491a) + 24) % 24, this.f30492b, this.f30493c, this.f30494d);
    }

    public final LocalTime C(long j10) {
        if (j10 != 0) {
            int i10 = (this.f30491a * 60) + this.f30492b;
            int i11 = ((((int) (j10 % 1440)) + i10) + 1440) % 1440;
            if (i10 != i11) {
                return r(i11 / 60, i11 % 60, this.f30493c, this.f30494d);
            }
        }
        return this;
    }
    ...
    public final LocalTime F(long j10) {
        if (j10 != 0) {
            int i10 = (this.f30492b * 60) + (this.f30491a * 3600) + this.f30493c;
            int i11 = ((((int) (j10 % 86400)) + i10) + 86400) % 86400;
            if (i10 != i11) {
                return r(i11 / 3600, (i11 / 60) % 60, i11 % 60, this.f30494d);
            }
        }
        return this;
    }
    ...
    public final Object a(TemporalQuery temporalQuery) {
        if (temporalQuery == o.f30620b || temporalQuery == o.f30619a || temporalQuery == o.f30623e || temporalQuery == o.f30622d) {
            return null;
        }
    ...
    public int toSecondOfDay() {
        return (this.f30492b * 60) + (this.f30491a * 3600) + this.f30493c;
    }

    public final long G() {
        return (this.f30493c * 1000000000) + (this.f30492b * 60000000000L) + (this.f30491a * 3600000000000L) + this.f30494d;
    }

    @Override // java.lang.Comparable
    public int compareTo(LocalTime localTime) {
        int compare = Integer.compare(this.f30491a, localTime.f30491a);
        return (compare == 0 && (compare = Integer.compare(this.f30492b, localTime.f30492b)) == 0 && (compare = Integer.compare(this.f30493c, localTime.f30493c)) == 0) ? Integer.compare(this.f30494d, localTime.f30494d) : compare;
    }
    ...
    public final boolean equals(Object obj) {
        ...
        if (obj instanceof LocalTime) {
            ...
            if (this.f30491a == localTime.f30491a && this.f30492b == localTime.f30492b && this.f30493c == localTime.f30493c && this.f30494d == localTime.f30494d) {
                return true;
            }
        }
        return false;
    ...
    public String toString() {
        ...
        byte b10 = this.f30491a;
        byte b11 = this.f30492b;
        byte b12 = this.f30493c;
