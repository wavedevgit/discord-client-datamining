...
public final class LocalTime implements j$.time.temporal.k, j$.time.temporal.l, Comparable<LocalTime>, Serializable {
    ...
    public static final LocalTime f31512e;

    /* renamed from: f  reason: collision with root package name */
    public static final LocalTime[] f31513f = new LocalTime[24];

    /* renamed from: a  reason: collision with root package name */
    public final byte f31514a;

    /* renamed from: b  reason: collision with root package name */
    public final byte f31515b;

    /* renamed from: c  reason: collision with root package name */
    public final byte f31516c;
    ...
    static {
        int i10 = 0;
        while (true) {
            LocalTime[] localTimeArr = f31513f;
    ...
    public static LocalTime t(TemporalAccessor temporalAccessor) {
        ...
        LocalTime localTime = (LocalTime) temporalAccessor.a(o.f31651g);
        if (localTime != null) {
            return localTime;
        }
    ...
    public static LocalTime parse(CharSequence charSequence) {
        DateTimeFormatter dateTimeFormatter = DateTimeFormatter.f31548f;
    ...
    public LocalTime(int i10, int i11, int i12, int i13) {
        this.f31514a = (byte) i10;
        this.f31515b = (byte) i11;
        this.f31516c = (byte) i12;
        this.f31517d = i13;
    }
    ...
    public final int w(j$.time.temporal.n nVar) {
        switch (f.f31546a[((j$.time.temporal.a) nVar).ordinal()]) {
            ...
            case 9:
                return this.f31515b;
            case 10:
                return (this.f31514a * 60) + this.f31515b;
            case 11:
                return this.f31514a % 12;
            case 12:
                int i10 = this.f31514a % 12;
                if (i10 % 12 == 0) {
                    return 12;
                }
                return i10;
            ...
            switch (f.f31546a[aVar.ordinal()]) {
                ...
                case 7:
                    ...
                    if (this.f31516c != i10) {
                        ...
                        return r(this.f31514a, this.f31515b, i10, this.f31517d);
                    }
                    break;
                case 8:
                ...
                case 9:
                    ...
                    if (this.f31515b != i11) {
                        j$.time.temporal.a.MINUTE_OF_HOUR.E(i11);
                        return r(this.f31514a, i11, this.f31516c, this.f31517d);
                    }
                    break;
                case 10:
                    return C(j10 - ((this.f31514a * 60) + this.f31515b));
                case 11:
                    return B(j10 - (this.f31514a % 12));
                case 12:
                    if (j10 == 12) {
                        j10 = 0;
                    }
                ...
                case 13:
                    ...
                    if (this.f31514a != i12) {
                        ...
                        return r(i12, this.f31515b, this.f31516c, this.f31517d);
                    }
                    break;
                case 14:
                    if (j10 == 24) {
                    ...
                    if (this.f31514a != i13) {
                        ...
                        return r(i13, this.f31515b, this.f31516c, this.f31517d);
                    }
                    break;
                case 15:
                    return B((j10 - (this.f31514a / 12)) * 12);
                default:
                    throw new DateTimeException("Unsupported field: " + nVar);
            }
            return this;
    ...
    public final LocalTime I(int i10) {
        ...
        return r(this.f31514a, this.f31515b, this.f31516c, i10);
    }

    @Override // j$.time.temporal.k
    public final j$.time.temporal.k h(long j10, j$.time.temporal.b bVar) {
        if (bVar != null) {
            switch (f.f31547b[bVar.ordinal()]) {
                case 1:
                    return E(j10);
                case 2:
    ...
    public final LocalTime B(long j10) {
        return j10 == 0 ? this : r(((((int) (j10 % 24)) + this.f31514a) + 24) % 24, this.f31515b, this.f31516c, this.f31517d);
    }

    public final LocalTime C(long j10) {
        if (j10 != 0) {
            int i10 = (this.f31514a * 60) + this.f31515b;
            int i11 = ((((int) (j10 % 1440)) + i10) + 1440) % 1440;
            if (i10 != i11) {
                return r(i11 / 60, i11 % 60, this.f31516c, this.f31517d);
            }
        }
        return this;
    }
    ...
    public final LocalTime F(long j10) {
        if (j10 != 0) {
            int i10 = (this.f31515b * 60) + (this.f31514a * 3600) + this.f31516c;
            int i11 = ((((int) (j10 % 86400)) + i10) + 86400) % 86400;
            if (i10 != i11) {
                return r(i11 / 3600, (i11 / 60) % 60, i11 % 60, this.f31517d);
            }
        }
        return this;
    }
    ...
    public final Object a(TemporalQuery temporalQuery) {
        if (temporalQuery == o.f31646b || temporalQuery == o.f31645a || temporalQuery == o.f31649e || temporalQuery == o.f31648d) {
            return null;
        }
    ...
    public int toSecondOfDay() {
        return (this.f31515b * 60) + (this.f31514a * 3600) + this.f31516c;
    }

    public final long G() {
        return (this.f31516c * 1000000000) + (this.f31515b * 60000000000L) + (this.f31514a * 3600000000000L) + this.f31517d;
    }

    @Override // java.lang.Comparable
    public int compareTo(LocalTime localTime) {
        int compare = Integer.compare(this.f31514a, localTime.f31514a);
        return (compare == 0 && (compare = Integer.compare(this.f31515b, localTime.f31515b)) == 0 && (compare = Integer.compare(this.f31516c, localTime.f31516c)) == 0) ? Integer.compare(this.f31517d, localTime.f31517d) : compare;
    }
    ...
    public final boolean equals(Object obj) {
        ...
        if (obj instanceof LocalTime) {
            ...
            if (this.f31514a == localTime.f31514a && this.f31515b == localTime.f31515b && this.f31516c == localTime.f31516c && this.f31517d == localTime.f31517d) {
                return true;
            }
        }
        return false;
    ...
    public String toString() {
        ...
        byte b10 = this.f31514a;
        byte b11 = this.f31515b;
        byte b12 = this.f31516c;
