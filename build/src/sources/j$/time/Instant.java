...
public final class Instant implements j$.time.temporal.k, j$.time.temporal.l, Comparable<Instant>, Serializable {
    ...
    public static final Instant f31048c = new Instant(0, 0);
    public static final Instant MIN = ofEpochSecond(-31557014167219200L, 0);
    public static final Instant MAX = ofEpochSecond(31556889864403199L, 999999999);

    public static Instant now() {
        ConcurrentMap concurrentMap = ZoneOffset.f31068c;
    ...
    public final int g(n nVar) {
        if (nVar instanceof j$.time.temporal.a) {
            int i10 = a.f31074a[((j$.time.temporal.a) nVar).ordinal()];
            if (i10 != 1) {
                if (i10 != 2) {
                    if (i10 == 3) {
                        return this.f31050b / 1000000;
                    }
                    if (i10 == 4) {
                        j$.time.temporal.a aVar = j$.time.temporal.a.INSTANT_SECONDS;
                        aVar.f31176b.a(this.f31049a, aVar);
                    }
                    throw new DateTimeException("Unsupported field: " + nVar);
                }
                return this.f31050b / 1000;
            }
            return this.f31050b;
        }
    ...
    public final long m(n nVar) {
        int i10;
        if (nVar instanceof j$.time.temporal.a) {
            int i11 = a.f31074a[((j$.time.temporal.a) nVar).ordinal()];
            if (i11 == 1) {
                i10 = this.f31050b;
            } else if (i11 == 2) {
                i10 = this.f31050b / 1000;
            } else if (i11 != 3) {
                if (i11 == 4) {
                    return this.f31049a;
                }
    ...
    public final j$.time.temporal.k b(long j10, n nVar) {
        if (nVar instanceof j$.time.temporal.a) {
            ...
            aVar.E(j10);
            int i10 = a.f31074a[aVar.ordinal()];
            if (i10 != 1) {
                if (i10 == 2) {
                    int i11 = ((int) j10) * 1000;
                    if (i11 != this.f31050b) {
                        return r(this.f31049a, i11);
                    }
                } else if (i10 == 3) {
                    int i12 = ((int) j10) * 1000000;
                    if (i12 != this.f31050b) {
                        return r(this.f31049a, i12);
                    }
                } else if (i10 == 4) {
                    if (j10 != this.f31049a) {
                        return r(j10, this.f31050b);
                    }
                } else {
                    throw new DateTimeException("Unsupported field: " + nVar);
                }
            } else if (j10 != this.f31050b) {
                return r(this.f31049a, (int) j10);
            }
            return this;
        }
    ...
    public final Instant t(long j10, long j11) {
        ...
        return ofEpochSecond(Math.addExact(Math.addExact(this.f31049a, j10), j11 / 1000000000), this.f31050b + (j11 % 1000000000));
    }
    ...
    public final Object a(TemporalQuery temporalQuery) {
        ...
        if (temporalQuery == o.f31189b || temporalQuery == o.f31188a || temporalQuery == o.f31192e || temporalQuery == o.f31191d || temporalQuery == o.f31193f || temporalQuery == o.f31194g) {
            return null;
        }
    ...
    public final j$.time.temporal.k d(j$.time.temporal.k kVar) {
        return kVar.b(this.f31049a, j$.time.temporal.a.INSTANT_SECONDS).b(this.f31050b, j$.time.temporal.a.NANO_OF_SECOND);
    }
    ...
    public int compareTo(Instant instant) {
        int compare = Long.compare(this.f31049a, instant.f31049a);
        return compare != 0 ? compare : this.f31050b - instant.f31050b;
    }
    ...
    public final boolean equals(Object obj) {
        ...
        if (obj instanceof Instant) {
            ...
            if (this.f31049a == instant.f31049a && this.f31050b == instant.f31050b) {
                return true;
            }
        }
        return false;
    ...
    public int hashCode() {
        long j10 = this.f31049a;
        return (this.f31050b * 51) + ((int) (j10 ^ (j10 >>> 32)));
    }

    public String toString() {
        return DateTimeFormatter.f31093g.a(this);
    }
}
