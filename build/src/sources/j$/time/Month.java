...
public final class Month implements TemporalAccessor, j$.time.temporal.l {
    ...
    public static final Month[] f31064a;

    /* renamed from: b  reason: collision with root package name */
    public static final /* synthetic */ Month[] f31065b;
    ...
    static {
        ...
        DECEMBER = r11;
        f31065b = new Month[]{r02, r12, r22, r32, r42, r52, r62, r72, r82, r92, r10, r11};
        f31064a = values();
    }
    ...
    public final j$.time.temporal.k d(j$.time.temporal.k kVar) {
        ...
        Object obj = (j$.time.chrono.j) kVar.a(o.f31189b);
        if (obj == null) {
            obj = j$.time.chrono.k.f31087a;
        }
        if (!((j$.time.chrono.a) obj).equals(j$.time.chrono.k.f31087a)) {
    ...
    public final int t(boolean z10) {
        int i10 = f.f31091a[ordinal()];
        return i10 != 1 ? (i10 == 2 || i10 == 3 || i10 == 4 || i10 == 5) ? 30 : 31 : z10 ? 29 : 28;
    }

    public final int r(boolean z10) {
        switch (f.f31091a[ordinal()]) {
            case 1:
                return 32;
            case 2:
                return (z10 ? 1 : 0) + 91;
