...
public final class i implements g, Serializable {
    ...
    public final transient e f29461a;

    /* renamed from: b  reason: collision with root package name */
    public final transient ZoneOffset f29462b;

    /* renamed from: c  reason: collision with root package name */
    public final transient j$.time.j f29463c;
    ...
    public static i t(j$.time.j jVar, ZoneOffset zoneOffset, e eVar) {
        ...
        if (f10.size() == 1) {
            ...
            eVar = eVar.w(eVar.f29457a, 0L, 0L, Duration.r(aVar.f29578c.getTotalSeconds() - aVar.f29577b.getTotalSeconds(), 0).f29423a, 0L);
    ...
    public final int hashCode() {
        return (this.f29461a.hashCode() ^ this.f29462b.hashCode()) ^ Integer.rotateLeft(this.f29463c.hashCode(), 3);
    }
    ...
    public final j$.time.temporal.k b(long j10, n nVar) {
        if (nVar instanceof j$.time.temporal.a) {
            ...
            int i10 = h.f29460a[aVar.ordinal()];
            if (i10 != 1) {
                if (i10 == 2) {
                    ZoneOffset ofTotalSeconds = ZoneOffset.ofTotalSeconds(aVar.f29553b.a(j10, aVar));
                    e eVar = this.f29461a;
                    Instant ofEpochSecond = Instant.ofEpochSecond(eVar.q(ofTotalSeconds), eVar.e().f29440d);
                    j$.time.j jVar = this.f29463c;
                    f();
                    k kVar = k.f29464a;
                ...
                return t(this.f29463c, this.f29462b, this.f29461a.b(j10, nVar));
            }
    ...
    public final i h(long j10, p pVar) {
        if (pVar instanceof j$.time.temporal.b) {
            return (i) c(this.f29461a.h(j10, pVar));
        }
        f();
    ...
    public final String toString() {
        String str = this.f29461a.toString() + this.f29462b.toString();
        if (this.f29462b != this.f29463c) {
            return str + '[' + this.f29463c.toString() + ']';
        }
        return str;
    }
}
