...
public interface g extends j$.time.temporal.k, Comparable {
    ...
    default int g(n nVar) {
        if (nVar instanceof j$.time.temporal.a) {
            int i10 = f.f31082a[((j$.time.temporal.a) nVar).ordinal()];
            if (i10 != 1) {
                if (i10 == 2) {
    ...
    default g c(l lVar) {
        f();
        return i.r(k.f31087a, lVar.d(this));
    }

    @Override // j$.time.temporal.TemporalAccessor
    default Object a(TemporalQuery temporalQuery) {
        if (temporalQuery == o.f31192e || temporalQuery == o.f31188a) {
            return y();
        }
        if (temporalQuery == o.f31191d) {
            return n();
        }
    ...
    default int compareTo(g gVar) {
        ...
        if (compare == 0 && (compare = e().f31063d - gVar.e().f31063d) == 0 && (compare = s().compareTo(gVar.s())) == 0 && (compare = y().r().compareTo(gVar.y().r())) == 0) {
            f();
            k kVar = k.f31087a;
            gVar.f();
            return 0;
