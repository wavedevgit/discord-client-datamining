...
public final class e {
    ...
    public static final CopyOnWriteArrayList f29846b;

    /* renamed from: c  reason: collision with root package name */
    public static final ConcurrentMap f29847c;

    /* renamed from: a  reason: collision with root package name */
    public final Set f29848a;

    static {
        CopyOnWriteArrayList copyOnWriteArrayList = new CopyOnWriteArrayList();
        f29846b = copyOnWriteArrayList;
        f29847c = new ConcurrentHashMap(IntBufferBatchMountItem.INSTRUCTION_UPDATE_PADDING, 0.75f, 2);
    ...
    public static c a(String str) {
        ...
        ConcurrentHashMap concurrentHashMap = (ConcurrentHashMap) f29847c;
        ...
        } else if (eVar.f29848a.contains(str)) {
    ...
    public static void b(e eVar) {
        ...
        for (String str : eVar.f29848a) {
            Objects.requireNonNull(str, "zoneId");
            if (((e) ((ConcurrentHashMap) f29847c).putIfAbsent(str, eVar)) != null) {
    ...
    public e() {
        ...
        this.f29848a = Collections.unmodifiableSet(linkedHashSet);
    }
}
