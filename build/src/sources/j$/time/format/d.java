    ...
    */
    public final boolean r(j$.time.format.q r8, java.lang.StringBuilder r9) {
        /*
            ...
            int r0 = r9.length()
            r1 = 1
            boolean r2 = r7.f30541b
            if (r2 == 0) goto Le
            int r3 = r8.f30580c
            int r3 = r3 + r1
            r8.f30580c = r3
        Le:
            j$.time.format.e[] r3 = r7.f30540a     // Catch: java.lang.Throwable -> L27
    ...
    public final int t(o oVar, CharSequence charSequence, int i10) {
        ...
        e[] eVarArr = this.f30540a;
        int i11 = 0;
        if (z10) {
            ArrayList arrayList = oVar.f30573d;
            u c10 = oVar.c();
            c10.getClass();
            u uVar = new u();
            ((HashMap) uVar.f30584a).putAll(c10.f30584a);
            uVar.f30585b = c10.f30585b;
            uVar.f30586c = c10.f30586c;
            uVar.f30587d = c10.f30587d;
            arrayList.add(uVar);
            ...
            while (i11 < length) {
                ...
                if (i12 < 0) {
                    ArrayList arrayList2 = oVar.f30573d;
                    arrayList2.remove(arrayList2.size() - 1);
                    return i10;
                }
                i11++;
            }
            ArrayList arrayList3 = oVar.f30573d;
