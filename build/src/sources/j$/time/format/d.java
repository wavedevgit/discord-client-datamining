    ...
    */
    public final boolean r(j$.time.format.q r8, java.lang.StringBuilder r9) {
        /*
            ...
            int r0 = r9.length()
            r1 = 1
            boolean r2 = r7.f31566b
            if (r2 == 0) goto Le
            int r3 = r8.f31605c
            int r3 = r3 + r1
            r8.f31605c = r3
        Le:
            j$.time.format.e[] r3 = r7.f31565a     // Catch: java.lang.Throwable -> L27
    ...
    public final int t(o oVar, CharSequence charSequence, int i10) {
        ...
        e[] eVarArr = this.f31565a;
        int i11 = 0;
        if (z10) {
            ArrayList arrayList = oVar.f31598d;
            u c10 = oVar.c();
            c10.getClass();
            u uVar = new u();
            ((HashMap) uVar.f31609a).putAll(c10.f31609a);
            uVar.f31610b = c10.f31610b;
            uVar.f31611c = c10.f31611c;
            uVar.f31612d = c10.f31612d;
            arrayList.add(uVar);
            ...
            while (i11 < length) {
                ...
                if (i12 < 0) {
                    ArrayList arrayList2 = oVar.f31598d;
                    arrayList2.remove(arrayList2.size() - 1);
                    return i10;
                }
                i11++;
            }
            ArrayList arrayList3 = oVar.f31598d;
