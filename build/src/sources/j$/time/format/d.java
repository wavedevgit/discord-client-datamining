    ...
    */
    public final boolean r(j$.time.format.q r8, java.lang.StringBuilder r9) {
        /*
            ...
            int r0 = r9.length()
            r1 = 1
            boolean r2 = r7.f29741b
            if (r2 == 0) goto Le
            int r3 = r8.f29780c
            int r3 = r3 + r1
            r8.f29780c = r3
        Le:
            j$.time.format.e[] r3 = r7.f29740a     // Catch: java.lang.Throwable -> L27
    ...
    public final int t(o oVar, CharSequence charSequence, int i10) {
        boolean z10 = this.f29741b;
        e[] eVarArr = this.f29740a;
        int i11 = 0;
        if (z10) {
            ArrayList arrayList = oVar.f29773d;
            u c10 = oVar.c();
            c10.getClass();
            u uVar = new u();
            ((HashMap) uVar.f29784a).putAll(c10.f29784a);
            uVar.f29785b = c10.f29785b;
            uVar.f29786c = c10.f29786c;
            uVar.f29787d = c10.f29787d;
            arrayList.add(uVar);
            ...
            while (i11 < length) {
                ...
                if (i12 < 0) {
                    ArrayList arrayList2 = oVar.f29773d;
                    arrayList2.remove(arrayList2.size() - 1);
                    return i10;
                }
                i11++;
            }
            ArrayList arrayList3 = oVar.f29773d;
