    ...
    */
    public final boolean r(j$.time.format.q r8, java.lang.StringBuilder r9) {
        /*
            ...
            int r0 = r9.length()
            r1 = 1
            boolean r2 = r7.f30465b
            if (r2 == 0) goto Le
            int r3 = r8.f30504c
            int r3 = r3 + r1
            r8.f30504c = r3
        Le:
            j$.time.format.e[] r3 = r7.f30464a     // Catch: java.lang.Throwable -> L27
    ...
    public final int t(o oVar, CharSequence charSequence, int i10) {
        ...
        e[] eVarArr = this.f30464a;
        int i11 = 0;
        if (z10) {
            ArrayList arrayList = oVar.f30497d;
            u c10 = oVar.c();
            c10.getClass();
            u uVar = new u();
            ((HashMap) uVar.f30508a).putAll(c10.f30508a);
            uVar.f30509b = c10.f30509b;
            uVar.f30510c = c10.f30510c;
            uVar.f30511d = c10.f30511d;
            arrayList.add(uVar);
            ...
            while (i11 < length) {
                ...
                if (i12 < 0) {
                    ArrayList arrayList2 = oVar.f30497d;
                    arrayList2.remove(arrayList2.size() - 1);
                    return i10;
                }
                i11++;
            }
            ArrayList arrayList3 = oVar.f30497d;
