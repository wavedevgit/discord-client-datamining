...
public final class i implements e {
    ...
    public static final String[] f30555c = {"+HH", "+HHmm", "+HH:mm", "+HHMM", "+HH:MM", "+HHMMss", "+HH:MM:ss", "+HHMMSS", "+HH:MM:SS"};

    /* renamed from: d  reason: collision with root package name */
    public static final i f30556d = new i("+HH:MM:ss", "Z");

    /* renamed from: e  reason: collision with root package name */
    public static final i f30557e = new i("+HH:MM:ss", "0");
    ...
    public final int t(o oVar, CharSequence charSequence, int i10) {
        ...
        int length2 = this.f30558a.length();
        if (length2 == 0) {
            if (i10 == length) {
            ...
            if (oVar.g(charSequence, i10, this.f30558a, 0, length2)) {
        ...
        if (charAt == '+' || charAt == '-') {
            ...
            if (!a(iArr, 1, charSequence, true)) {
                if (!a(iArr, 2, charSequence, this.f30559b >= 3) && !a(iArr, 3, charSequence, false)) {
    ...
    public final String toString() {
        String replace = this.f30558a.replace("'", "''");
        return "Offset(" + f30555c[this.f30559b] + ",'" + replace + "')";
    }
}
