...
public final class g implements e {
    ...
    public static volatile Map.Entry f29745b;

    /* renamed from: c  reason: collision with root package name */
    public static volatile Map.Entry f29746c;
    ...
    public final boolean r(q qVar, StringBuilder sb2) {
        switch (this.f29747a) {
            case 0:
                ...
                TemporalAccessor temporalAccessor = qVar.f29778a;
                ...
                int a11 = aVar.f29807b.a(valueOf != null ? valueOf.longValue() : 0L, aVar);
                if (longValue >= -62167219200L) {
                    ...
                    sb2.append(B2);
                    if (B2.f29688b.f29693c == 0) {
                        sb2.append(":00");
                    }
                    if (j12 < 0) {
                        if (B2.f29687a.getYear() == -10000) {
                ...
                return true;
            default:
                j$.time.b bVar = DateTimeFormatterBuilder.f29730f;
                TemporalAccessor temporalAccessor2 = qVar.f29778a;
                Object a12 = temporalAccessor2.a(bVar);
                if (a12 == null && qVar.f29780c == 0) {
    ...
    public final int t(o oVar, CharSequence charSequence, int i10) {
        ...
        switch (this.f29747a) {
            case 0:
                ...
                d dVar = dateTimeFormatterBuilder.toFormatter().f29725a;
                if (dVar.f29741b) {
                    dVar = new d(dVar.f29740a, false);
                }
                o oVar2 = new o(oVar.f29770a);
                oVar2.f29771b = oVar.f29771b;
                oVar2.f29772c = oVar.f29772c;
            ...
            default:
                ...
                if (i10 <= length) {
                    if (i10 != length) {
                        ...
                        if (charAt == '+' || charAt == '-') {
                            return a(oVar, charSequence, i10, i10, i.f29755d);
                        }
                        int i14 = i10 + 2;
                        if (length >= i14) {
                            ...
                            if (oVar.a(charAt, 'U') && oVar.a(charAt2, 'T')) {
                                int i15 = i10 + 3;
                                return (length < i15 || !oVar.a(charSequence.charAt(i14), 'C')) ? a(oVar, charSequence, i10, i14, i.f29756e) : a(oVar, charSequence, i10, i15, i.f29756e);
                            } else if (oVar.a(charAt, 'G') && length >= (i11 = i10 + 3) && oVar.a(charAt2, 'M') && oVar.a(charSequence.charAt(i14), 'T')) {
                                return a(oVar, charSequence, i10, i11, i.f29756e);
                            }
                        }
                        CopyOnWriteArrayList copyOnWriteArrayList = j$.time.zone.e.f29846b;
                        HashSet hashSet = new HashSet(((ConcurrentHashMap) j$.time.zone.e.f29847c).keySet());
                        int size = hashSet.size();
                        Map.Entry entry = oVar.f29771b ? f29745b : f29746c;
                        if (entry == null || ((Integer) entry.getKey()).intValue() != size) {
                            synchronized (this) {
                                try {
                                    entry = oVar.f29771b ? f29745b : f29746c;
                                    if (entry == null || ((Integer) entry.getKey()).intValue() != size) {
                                        Integer valueOf = Integer.valueOf(size);
                                        k kVar = oVar.f29771b ? new k("", null, null) : new k("", null, null);
