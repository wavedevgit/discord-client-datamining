...
public final class DateTimeFormatter {
    ...
    public static final DateTimeFormatter f31548f;

    /* renamed from: g  reason: collision with root package name */
    public static final DateTimeFormatter f31549g;

    /* renamed from: a  reason: collision with root package name */
    public final d f31550a;

    /* renamed from: b  reason: collision with root package name */
    public final Locale f31551b;

    /* renamed from: c  reason: collision with root package name */
    public final t f31552c;

    /* renamed from: d  reason: collision with root package name */
    public final v f31553d;

    /* renamed from: e  reason: collision with root package name */
    public final j$.time.chrono.j f31554e;
    ...
    static {
        ...
        parseCaseInsensitive8.h(j$.time.temporal.j.f31643c, 4, 10, wVar);
        parseCaseInsensitive8.d("-W");
        parseCaseInsensitive8.g(j$.time.temporal.j.f31642b, 2);
        ...
        f31549g = parseCaseInsensitive9.k(vVar, null);
    ...
    public final String a(TemporalAccessor temporalAccessor) {
        ...
        try {
            this.f31550a.r(new q(temporalAccessor, this), sb2);
            return sb2.toString();
    ...
    /* JADX WARN: Code restructure failed: missing block: B:131:0x030c, code lost:
        if (((java.util.HashMap) r9.f31609a).containsKey(j$.time.temporal.a.SECOND_OF_MINUTE) != false) goto L104;
     */
    ...
    */
    ...
    public final String toString() {
        String dVar = this.f31550a.toString();
