...
public final class q {
    ...
    public final TemporalAccessor f31153a;

    /* renamed from: b  reason: collision with root package name */
    public final DateTimeFormatter f31154b;
    ...
    public q(TemporalAccessor temporalAccessor, DateTimeFormatter dateTimeFormatter) {
        ...
        j$.time.chrono.j jVar = dateTimeFormatter.f31104e;
        if (jVar != null) {
            j$.time.chrono.j jVar2 = (j$.time.chrono.j) temporalAccessor.a(j$.time.temporal.o.f31196b);
            j$.time.k kVar = (j$.time.k) temporalAccessor.a(j$.time.temporal.o.f31195a);
            ...
            if (jVar != null) {
                ...
                if (jVar != null) {
                    ...
                    } else if (jVar != j$.time.chrono.k.f31092a || jVar2 != null) {
        ...
        this.f31153a = temporalAccessor;
        this.f31154b = dateTimeFormatter;
    }

    public final Long a(j$.time.temporal.n nVar) {
        try {
            return Long.valueOf(this.f31153a.m(nVar));
