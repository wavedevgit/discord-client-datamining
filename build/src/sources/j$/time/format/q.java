...
public final class q {
    ...
    public final TemporalAccessor f31603a;

    /* renamed from: b  reason: collision with root package name */
    public final DateTimeFormatter f31604b;
    ...
    public q(TemporalAccessor temporalAccessor, DateTimeFormatter dateTimeFormatter) {
        ...
        j$.time.chrono.j jVar = dateTimeFormatter.f31554e;
        if (jVar != null) {
            j$.time.chrono.j jVar2 = (j$.time.chrono.j) temporalAccessor.a(j$.time.temporal.o.f31646b);
            j$.time.k kVar = (j$.time.k) temporalAccessor.a(j$.time.temporal.o.f31645a);
            ...
            if (jVar != null) {
                ...
                if (jVar != null) {
                    ...
                    } else if (jVar != j$.time.chrono.k.f31542a || jVar2 != null) {
        ...
        this.f31603a = temporalAccessor;
        this.f31604b = dateTimeFormatter;
    }

    public final Long a(j$.time.temporal.n nVar) {
        try {
            return Long.valueOf(this.f31603a.m(nVar));
