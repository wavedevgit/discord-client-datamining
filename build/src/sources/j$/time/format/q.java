...
public final class q {
    ...
    public final TemporalAccessor f29778a;

    /* renamed from: b  reason: collision with root package name */
    public final DateTimeFormatter f29779b;
    ...
    public q(TemporalAccessor temporalAccessor, DateTimeFormatter dateTimeFormatter) {
        ...
        j$.time.chrono.j jVar = dateTimeFormatter.f29729e;
        if (jVar != null) {
            j$.time.chrono.j jVar2 = (j$.time.chrono.j) temporalAccessor.a(j$.time.temporal.o.f29820b);
            j$.time.j jVar3 = (j$.time.j) temporalAccessor.a(j$.time.temporal.o.f29819a);
            ...
            if (jVar != null) {
                ...
                if (jVar != null) {
                    ...
                    } else if (jVar != j$.time.chrono.k.f29718a || jVar2 != null) {
        ...
        this.f29778a = temporalAccessor;
        this.f29779b = dateTimeFormatter;
    }

    public final Long a(j$.time.temporal.n nVar) {
        try {
            return Long.valueOf(this.f29778a.m(nVar));
