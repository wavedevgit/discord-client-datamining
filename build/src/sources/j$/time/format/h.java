...
public final class h implements e {
    ...
    public static final long[] f31123f = {0, 10, 100, 1000, 10000, 100000, 1000000, 10000000, 100000000, 1000000000, 10000000000L};

    /* renamed from: a  reason: collision with root package name */
    public final j$.time.temporal.n f31124a;
    ...
    public final boolean r(q qVar, StringBuilder sb2) {
        j$.time.temporal.n nVar = this.f31124a;
        ...
        int i12 = this.f31125b;
        w wVar = this.f31127d;
        if (i11 >= 0) {
            int i13 = b.f31113a[wVar.ordinal()];
            if (i13 != 1) {
                if (i13 == 2) {
                    sb2.append('+');
                }
            } else if (i12 < 19 && longValue >= f31123f[i12]) {
                sb2.append('+');
            }
        } else {
            int i14 = b.f31113a[wVar.ordinal()];
