...
public final class o {
    ...
    public final DateTimeFormatter f31145a;

    /* renamed from: b  reason: collision with root package name */
    public boolean f31146b = true;

    /* renamed from: c  reason: collision with root package name */
    public boolean f31147c = true;
    ...
    public o(DateTimeFormatter dateTimeFormatter) {
        ...
        this.f31145a = dateTimeFormatter;
        arrayList.add(new u());
    }
    ...
    public final Long d(j$.time.temporal.a aVar) {
        return (Long) ((HashMap) c().f31159a).get(aVar);
    }

    public final int f(j$.time.temporal.n nVar, long j10, int i10, int i11) {
        Objects.requireNonNull(nVar, "field");
        Long l10 = (Long) ((HashMap) c().f31159a).put(nVar, Long.valueOf(j10));
