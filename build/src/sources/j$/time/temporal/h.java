...
public abstract class h implements n {
    ...
    public static final int[] f30612a;

    /* renamed from: b  reason: collision with root package name */
    public static final /* synthetic */ h[] f30613b;
    ...
    public static boolean I(TemporalAccessor temporalAccessor) {
        ...
        Object obj = (j$.time.chrono.j) temporalAccessor.a(o.f30621b);
        if (obj == null) {
            obj = j$.time.chrono.k.f30519a;
        }
        return ((j$.time.chrono.a) obj).equals(j$.time.chrono.k.f30519a);
    }
    ...
    static {
        h hVar = new h() { // from class: j$.time.temporal.d
            ...
            public final long B(TemporalAccessor temporalAccessor) {
                ...
                int i10 = (g11 - 1) / 3;
                j$.time.chrono.k kVar = j$.time.chrono.k.f30519a;
                return g10 - h.f30612a[i10 + (j$.time.chrono.k.w(m10) ? 4 : 0)];
            }
            ...
            public final TemporalAccessor w(Map map, u uVar, v vVar) {
                ...
                int a10 = aVar.f30608b.a(l10.longValue(), aVar);
            ...
            public final TemporalAccessor w(Map map, u uVar, v vVar) {
                ...
                if (h.I(uVar)) {
                    ...
                    if (vVar == v.LENIENT) {
                        ...
                        int a11 = aVar.f30608b.a(l11.longValue(), aVar);
        ...
        h hVar4 = new h() { // from class: j$.time.temporal.g
            ...
            public final k C(k kVar, long j10) {
                ...
                int a10 = a.YEAR.f30608b.a(j10, h.WEEK_BASED_YEAR);
        ...
        f30613b = new h[]{hVar, hVar2, hVar3, hVar4};
        f30612a = new int[]{0, 90, 181, 273, 0, 91, 182, 274};
    }
    ...
    public static int E(LocalDate localDate) {
        ...
        if (localDate.x() != 180) {
            localDate = LocalDate.C(localDate.f30483a, 180);
        }
        return (int) H(localDate.H(-1L)).f30630d;
    }
