...
public abstract class h implements n {
    ...
    public static final /* synthetic */ h[] f29510b;
    ...
    public static boolean I(TemporalAccessor temporalAccessor) {
        ...
        Object obj = (j$.time.chrono.j) temporalAccessor.a(o.f29518b);
        if (obj == null) {
            obj = j$.time.chrono.k.f29416a;
        }
        return ((j$.time.chrono.a) obj).equals(j$.time.chrono.k.f29416a);
    }
    ...
    static {
        h hVar = new h() { // from class: j$.time.temporal.d
            ...
            public final long B(TemporalAccessor temporalAccessor) {
                ...
                int i10 = (g11 - 1) / 3;
                j$.time.chrono.k kVar = j$.time.chrono.k.f29416a;
                return g10 - h.f29509a[i10 + (j$.time.chrono.k.w(m10) ? 4 : 0)];
            }
            ...
            public final TemporalAccessor w(Map map, u uVar, v vVar) {
                ...
                int a10 = aVar.f29505b.a(l10.longValue(), aVar);
            ...
            public final TemporalAccessor w(Map map, u uVar, v vVar) {
                ...
                if (h.I(uVar)) {
                    ...
                    if (vVar == v.LENIENT) {
                        ...
                        int a11 = aVar.f29505b.a(l11.longValue(), aVar);
        ...
        h hVar4 = new h() { // from class: j$.time.temporal.g
            ...
            public final k C(k kVar, long j10) {
                ...
                int a10 = a.YEAR.f29505b.a(j10, h.WEEK_BASED_YEAR);
        ...
        f29510b = new h[]{hVar, hVar2, hVar3, hVar4};
        f29509a = new int[]{0, 90, 181, 273, 0, 91, 182, 274};
    }
    ...
    public static int E(LocalDate localDate) {
        ...
        if (localDate.x() != 180) {
            localDate = LocalDate.C(localDate.f29380a, 180);
        }
        return (int) H(localDate.H(-1L)).f29527d;
    }
