...
public abstract class d {
    ...
    private static final boolean f57694a;

    /* renamed from: b  reason: collision with root package name */
    private static final d f57695b;

    /* renamed from: c  reason: collision with root package name */
    private static final boolean f57696c;
    ...
    static {
        ...
        try {
            f57695b = (d) Class.forName(property).newInstance();
        } catch (Exception e10) {
