...
public final class j implements Interceptor {
    ...
    public static final a f56143b = new a(null);

    /* renamed from: a  reason: collision with root package name */
    private final OkHttpClient f56144a;
    ...
    private final Request a(Response response, String str) {
        ...
        if (!this.f56144a.v() || (D0 = Response.D0(response, "Location", null, 2, null)) == null || (r10 = response.Y0().n().r(D0)) == null) {
            return null;
        }
        if (!Intrinsics.areEqual(r10.s(), response.Y0().n().s()) && !this.f56144a.w()) {
            return null;
        }
        ...
        if (!ut.e.j(response.Y0().n(), r10)) {
            k10.i("Authorization");
        }
        return k10.m(r10).b();
    }

    private final Request b(Response response, yt.c cVar) {
        tt.k kVar;
        yt.f h10;
                    ...
                    if (L != 503) {
                        if (L != 407) {
                            ...
                            if (kVar.b().type() == Proxy.Type.HTTP) {
                                return this.f56144a.I().a(kVar, response);
                            }
    ...
    private final boolean d(IOException iOException, yt.e eVar, Request request, boolean z10) {
        if (!this.f56144a.M()) {
            return false;
        }
    ...
    */
    public okhttp3.Response intercept(okhttp3.Interceptor.Chain r11) {
        ...
        L19:
            ...
            if (r6 != 0) goto Ld3
            okhttp3.Response r0 = r11.a(r0)     // Catch: java.lang.Throwable -> L42 java.io.IOException -> L99 yt.i -> Lb4
            if (r7 == 0) goto L40
        ...
        L42:
            ...
            goto Ldb
        L45:
            yt.c r0 = r1.p()     // Catch: java.lang.Throwable -> L42
        ...
        L6e:
            ...
            if (r0 == 0) goto L77
            ut.e.m(r0)     // Catch: java.lang.Throwable -> L42
        L77:
            int r8 = r8 + 1
            r0 = 20
            if (r8 > r0) goto L82
        ...
        L99:
            r6 = move-exception
            boolean r9 = r6 instanceof bu.a     // Catch: java.lang.Throwable -> L42
            r9 = r9 ^ r5
        ...
        La9:
            ...
            goto L19
        Laf:
            java.lang.Throwable r11 = ut.e.b0(r6, r2)     // Catch: java.lang.Throwable -> L42
            throw r11     // Catch: java.lang.Throwable -> L42
        Lb4:
            r6 = move-exception
        ...
        Lca:
            ...
            java.lang.Throwable r11 = ut.e.b0(r11, r2)     // Catch: java.lang.Throwable -> L42
            throw r11     // Catch: java.lang.Throwable -> L42
        Ld3:
        ...
        Ldb:
            ...
            throw r11
        */
        throw new UnsupportedOperationException("Method not decompiled: zt.j.intercept(okhttp3.Interceptor$Chain):okhttp3.Response");
    }
}
