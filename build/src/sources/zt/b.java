...
public class b implements s {
    ...
    private static final ConcurrentMap f56631a = new ConcurrentHashMap();

    /* renamed from: b  reason: collision with root package name */
    private static final Set f56632b;

    /* renamed from: c  reason: collision with root package name */
    private static final Map f56633c;

    /* renamed from: d  reason: collision with root package name */
    private static final Map f56634d;
    ...
    static {
        ...
        hashSet.add("Zulu");
        f56632b = Collections.unmodifiableSet(hashSet);
        HashMap hashMap = new HashMap();
        g(hashMap, "data/zone1970.tab");
        f56633c = Collections.unmodifiableMap(hashMap);
        ...
        f56634d = Collections.unmodifiableMap(hashMap2);
    }
    ...
    public Set b(Locale locale, boolean z10) {
        ...
        if (z10) {
            ...
            String str = (String) f56634d.get(country);
            if (str != null) {
                return Collections.singleton(str);
            }
        }
        Set set = (Set) f56633c.get(country);
        if (set == null) {
    ...
    public String f(String str, net.time4j.tz.d dVar, Locale locale) {
        if (f56632b.contains(str)) {
            return "";
        }
        Map map = (Map) f56631a.get(locale);
        if (map == null) {
            ...
            map = (Map) f56631a.putIfAbsent(locale, hashMap);
            if (map == null) {
                map = hashMap;
            }
        }
