...
public final class k extends pj.f {
    ...
    private static final wj.d f50662j = wj.d.b();

    /* renamed from: k  reason: collision with root package name */
    static boolean f50663k = true;

    /* renamed from: d  reason: collision with root package name */
    private final rj.b f50664d;

    /* renamed from: e  reason: collision with root package name */
    private final l f50665e;

    /* renamed from: f  reason: collision with root package name */
    private final nk f50666f;

    /* renamed from: g  reason: collision with root package name */
    private final pk f50667g;

    /* renamed from: h  reason: collision with root package name */
    private final wj.a f50668h = new wj.a();
    ...
    private final void m(final xe xeVar, long j10, final vj.a aVar, List list) {
        ...
        this.f50666f.f(new mk() { // from class: uj.i
            @Override // mg.mk
            public final ck zza() {
        ...
        c3 c3Var = new c3();
        c3Var.e(xeVar);
        c3Var.f(Boolean.valueOf(f50663k));
        c3Var.g(b.c(this.f50664d));
        c3Var.c(f1Var.g());
        c3Var.d(f1Var2.g());
        final e3 h10 = c3Var.h();
        final j jVar = new j(this);
        final nk nkVar = this.f50666f;
        ...
        boolean z10 = this.f50669i;
        long j11 = currentTimeMillis - elapsedRealtime;
        pk pkVar = this.f50667g;
        if (true != z10) {
            i10 = 24301;
        } else {
            i10 = 24302;
    ...
    public final synchronized void d() {
        ...
        try {
            ...
            nk nkVar = this.f50666f;
            zeVar.e(weVar);
            mf mfVar = new mf();
            mfVar.i(b.c(this.f50664d));
            zeVar.g(mfVar.j());
    ...
    public final /* synthetic */ ck j(long j10, xe xeVar, f1 f1Var, f1 f1Var2, vj.a aVar) {
        ...
        jeVar.d(xeVar);
        jeVar.e(Boolean.valueOf(f50663k));
    ...
    public final synchronized List i(vj.a aVar) {
        ...
        try {
            try {
                wj.a aVar3 = this.f50668h;
                long elapsedRealtime = SystemClock.elapsedRealtime();
                aVar3.a(aVar);
                try {
                    List c10 = this.f50665e.c(aVar);
                    kVar = this;
                    aVar2 = aVar;
                    try {
