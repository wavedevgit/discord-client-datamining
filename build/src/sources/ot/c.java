...
public final class c implements Serializable {
    ...
    public static /* synthetic */ class a {
        ...
        static final /* synthetic */ int[] f44438a;
        ...
        static {
            ...
            try {
                f44438a[f.TT.ordinal()] = 2;
            } catch (NoSuchFieldError unused2) {
            }
            try {
                f44438a[f.POSIX.ordinal()] = 3;
    ...
    private static void a(double d10, f fVar) {
        if (!Double.isNaN(d10) && !Double.isInfinite(d10)) {
            int i10 = a.f44438a[fVar.ordinal()];
    ...
    static double d(a0 a0Var, f fVar) {
        return ((a0Var.l(fVar) + e(fVar)) + (a0Var.p(fVar) / 1.0E9d)) / 86400.0d;
    }
    ...
    public a0 h() {
        ...
        f fVar2 = this.scale;
        if (!wt.d.w().D() && fVar2 != (fVar = f.POSIX)) {
            if (fVar2 == f.TT) {
                f0 M0 = f0.M0((long) Math.floor(b()), pt.a0.MODIFIED_JULIAN_DATE);
                d10 -= f.d(M0.f(), M0.t());
            }
            d10 += 6.3072E7d;
            fVar2 = fVar;
        }
        return a0.l0(nt.c.m((long) d10, e(fVar2)), (int) ((d10 - Math.floor(d10)) * 1.0E9d), fVar2);
    }

    public int hashCode() {
        return ot.a.a(this.value) ^ this.scale.hashCode();
    }
