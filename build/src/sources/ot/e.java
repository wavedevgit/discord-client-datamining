...
public abstract class e {
    ...
    public static final e f44454d;

    /* renamed from: e  reason: collision with root package name */
    public static final e f44455e;

    /* renamed from: i  reason: collision with root package name */
    public static final e f44456i;

    /* renamed from: o  reason: collision with root package name */
    public static final e f44457o;

    /* renamed from: p  reason: collision with root package name */
    private static final int[] f44458p;

    /* renamed from: q  reason: collision with root package name */
    private static final double[] f44459q;

    /* renamed from: r  reason: collision with root package name */
    private static final double[] f44460r;

    /* renamed from: s  reason: collision with root package name */
    private static final double[][] f44461s;

    /* renamed from: t  reason: collision with root package name */
    private static final /* synthetic */ e[] f44462t;
    ...
    enum a extends e {
        ...
        private double n(double d10) {
            i0 t02 = ot.c.f(d10).h().t0(p.f40286v);
            return t02.V().B0() + (((Integer) t02.X().v(g0.K)).intValue() / 86400.0d);
        }

        private double p(double d10) {
            double d11 = (d10 * 0.9856d) - 3.289d;
            return ot.a.b((Math.sin(Math.toRadians(d11)) * 1.916d) + d11 + (Math.sin(Math.toRadians(d11) * 2.0d) * 0.02d) + 282.634d);
        }

        @Override // ot.e
        public double g(double d10) {
            return Math.toDegrees(Math.asin(Math.sin(Math.toRadians(p(n(d10)))) * 0.39782d));
        }

        @Override // ot.e
        public double l(double d10) {
            double p10 = p(n(d10));
            double b10 = ot.a.b(Math.toDegrees(Math.atan(Math.tan(Math.toRadians(p10)) * 0.91764d)));
    ...
    static {
        ...
        f44454d = aVar;
        e eVar = new e("NOAA", 1) { // from class: ot.e.b
            private double n(double d10) {
            ...
            public double l(double d10) {
                ...
                return ot.a.b(Math.toDegrees(Math.atan2(Math.cos(Math.toRadians(s(m10))) * Math.sin(radians), Math.cos(radians))));
            }
        };
        f44455e = eVar;
        e eVar2 = new e("CC", 2) { // from class: ot.e.c
            private double n(double d10) {
            ...
            public double h(double d10, String str) {
                ...
                if (str.equals("right-ascension")) {
                    ...
                    return ot.a.b(Math.toDegrees(Math.atan2(Math.cos(Math.toRadians(r(m10))) * Math.sin(radians), Math.cos(radians))));
        ...
        f44456i = eVar2;
        e eVar3 = new e("TIME4J", 3) { // from class: ot.e.d
            private double n(double d10) {
            ...
            public double h(double d10, String str) {
                ...
                if (str.equals("right-ascension")) {
                    ...
                    return ot.a.b(Math.toDegrees(Math.atan2(Math.cos(Math.toRadians(e.i(m10) + dArr[1])) * Math.sin(radians), Math.cos(radians))));
                } else if (str.equals("nutation")) {
        ...
        f44457o = eVar3;
        f44462t = new e[]{aVar, eVar, eVar2, eVar3};
        f44458p = new int[]{403406, 195207, 119433, 112392, 3891, 2819, 1721, 660, 350, 334, 314, 268, 242, 234, 158, 132, 129, MediaEngine.MAX_SUPPORTED_PROTOCOL_VERSION, 99, 93, 86, 78, 72, 68, 64, 46, 38, 37, 32, 29, 28, 27, 27, 25, 24, 21, 21, 20, 18, 17, 14, 13, 13, 13, 12, 10, 10, 10, 10};
    ...
    public static double f(double d10, double d11) {
        double d12 = 0.0d;
        for (int length = f44458p.length - 1; length >= 0; length--) {
            d12 += f44458p[length] * Math.sin(Math.toRadians(f44459q[length] + (f44460r[length] * d10)));
        }
    ...
    static void k(double d10, double[] dArr) {
        ...
        double d11 = 0.0d;
        double d12 = 0.0d;
        for (int length = f44461s.length - 1; length >= 0; length--) {
            double[] dArr2 = f44461s[length];
