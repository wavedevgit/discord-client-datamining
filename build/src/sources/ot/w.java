...
public enum w {
    ...
    public static /* synthetic */ class a {
        ...
        static {
            ...
            try {
                f44786a[w.SIMPLE_DATE_FORMAT.ordinal()] = 2;
            } catch (NoSuchFieldError unused2) {
            }
            try {
                f44786a[w.CLDR_24.ordinal()] = 3;
            } catch (NoSuchFieldError unused3) {
            }
            try {
                f44786a[w.CLDR_DATE.ordinal()] = 4;
            } catch (NoSuchFieldError unused4) {
            }
            try {
                f44786a[w.DYNAMIC.ordinal()] = 5;
    ...
    private static boolean B(mt.x xVar) {
        return w(xVar).equals("iso8601");
    }

    private Map D(c.d dVar, mt.x xVar, Locale locale, char c10, int i10) {
    ...
    private static void a(c.d dVar, mt.p pVar, int i10) {
        dVar.u(pVar, i10, 9);
    }

    private static void d(c.d dVar, mt.p pVar) {
        dVar.z(pVar);
    }
        ...
        if (i10 != 1) {
            if (i10 != 2) {
                if (i10 != 3) {
                    if (i10 != 4) {
                        if (i10 == 5) {
                            dVar.b0(nt.a.f42032g, nt.v.NARROW);
                    ...
                    dVar.b0(nt.a.f42032g, nt.v.WIDE);
                    dVar.z(net.time4j.f0.D);
                    dVar.L();
                    return;
                }
                dVar.b0(nt.a.f42032g, nt.v.ABBREVIATED);
                dVar.z(net.time4j.f0.D);
                dVar.L();
                return;
            }
    ...
    private static void f(c.d dVar, int i10, nt.t tVar) {
        if (i10 != 1 && i10 != 2) {
            if (i10 != 3) {
                if (i10 != 4) {
                    if (i10 == 5) {
            ...
            dVar.a0(pt.a.f46625k, i10);
            dVar.A(tVar);
            dVar.L();
        }
    }

    private static void g(mt.p pVar, char c10, c.d dVar, int i10, boolean z10) {
        if (i10 == 1) {
            dVar.j(pVar, 1, 2);
        } else if (i10 != 2 && !z10) {
    ...
    private Map p(c.d dVar, mt.x xVar, Locale locale, char c10, int i10, boolean z10) {
        nt.v vVar;
        nt.v vVar2;
        nt.v z11;
        int i11 = 4;
        switch (c10) {
            ...
            case 'G':
                ...
                dVar.b0(nt.a.f42032g, vVar2);
                net.time4j.history.d D = net.time4j.history.d.D(locale);
                dVar.A((nt.t) nt.t.class.cast(D.i()));
                dVar.L();
            ...
            case 'K':
                ...
                break;
            case 'L':
                dVar.b0(nt.a.f42033h, nt.m.STANDALONE);
                if (!z10) {
                    i11 = i10;
                }
            ...
            case 'Z':
                if (i10 < 4) {
                    dVar.C(nt.e.LONG, false, Collections.singletonList("+0000"));
                    break;
                } else if (i10 == 4) {
                    dVar.p();
                    break;
                } else if (i10 == 5) {
                    dVar.C(nt.e.LONG, true, Collections.singletonList("Z"));
                    break;
                } else {
            ...
            case 'a':
                if (z10) {
                    z11 = nt.v.ABBREVIATED;
                } else {
                    z11 = z(i10);
                }
                dVar.b0(nt.a.f42032g, z11);
            ...
            case 'g':
                dVar.q(mt.a0.MODIFIED_JULIAN_DATE, i10, 18, x.SHOW_WHEN_NEGATIVE);
                break;
            case 'h':
    ...
    private Map q(c.d dVar, char c10, int i10, Locale locale) {
        ...
        mt.p s10 = s(x(dVar), locale, c10);
        if (s10 != null) {
            if (z10 && (((z11 = s10 instanceof nt.t)) || Enum.class.isAssignableFrom(s10.getType()))) {
                if (i10 != 1) {
                    if (i10 != 2) {
                        if (i10 != 3) {
                            if (i10 == 4) {
                        ...
                        dVar.b0(nt.a.f42032g, nt.v.SHORT);
                    }
                } else {
                    dVar.b0(nt.a.f42032g, nt.v.NARROW);
                }
    ...
    private static mt.p r(Set set, char c10, String str) {
        char c11;
        if (c10 == 'L') {
            c11 = 'M';
        } else if (c10 == 'c') {
    ...
    private static mt.p s(mt.x xVar, Locale locale, int i10) {
        mt.p t10 = t(xVar, locale, i10, false);
        if (t10 == null) {
    ...
    private static mt.p t(mt.x xVar, Locale locale, int i10, boolean z10) {
        if (z10) {
            i10 = j(i10);
        }
        for (mt.p pVar : xVar.B()) {
            int d10 = pVar.d();
            if (z10) {
                d10 = j(d10);
                continue;
        ...
        for (mt.s sVar : xVar.x()) {
            for (mt.p pVar2 : sVar.b(locale, nt.a.f())) {
                int d11 = pVar2.d();
                if (z10) {
                    d11 = j(d11);
                    continue;
    ...
    private static mt.p u(mt.x xVar) {
        for (mt.s sVar : xVar.x()) {
            for (mt.p pVar : sVar.b(Locale.ROOT, nt.a.f())) {
    ...
    private Map v(c.d dVar, mt.x xVar, char c10, int i10, Locale locale) {
        mt.p pVar;
        nt.v vVar;
        nt.v vVar2;
        nt.v vVar3;
        if (c10 == 'g') {
            ...
            mt.p r10 = r(y10, c10, name);
            nt.t tVar = null;
            if (Integer.class.isAssignableFrom(r10.getType())) {
                if (r10 instanceof pt.a) {
                    tVar = (nt.t) k(r10);
                }
                pVar = (mt.p) k(r10);
            } else if (r10 instanceof nt.t) {
                tVar = (nt.t) k(r10);
                pVar = null;
            } else {
                                ...
                                if (c10 != 'w') {
                                    if (c10 != 'y') {
                                        ...
                                        if (locale.getLanguage().equals("am") && w(xVar).equals("ethiopic")) {
                                            dVar.b0(nt.a.f42037l, nt.j.f42092r);
                                        } else {
                                            z10 = false;
                                        }
                                        if (i10 == 2) {
    ...
    private static String w(mt.x xVar) {
    ...
    private static mt.x x(c.d dVar) {
        return dVar.P();
    }

    private static Set y(mt.x xVar, char c10, Locale locale) {
        if (c10 != 'w' && c10 != 'W' && c10 != 'e' && c10 != 'c') {
            return xVar.B();
        }
        for (mt.s sVar : xVar.x()) {
            for (mt.p pVar : sVar.b(locale, nt.a.f())) {
    ...
    private static nt.v z(int i10) {
        if (i10 <= 3) {
            return nt.v.ABBREVIATED;
        }
        if (i10 == 4) {
            return nt.v.WIDE;
        }
        ...
        if (i11 != 1) {
            if (i11 != 2) {
                if (i11 != 3) {
                    ...
                    Class r10 = x10.r();
                    if (!mt.m.class.isAssignableFrom(r10) && !mt.l.class.isAssignableFrom(r10)) {
