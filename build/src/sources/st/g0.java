...
public final class g0 implements v {
    ...
    private final p f50380e;

    /* renamed from: i  reason: collision with root package name */
    private final Object f50381i;
    ...
    private q k(q qVar, p pVar) {
        return qVar.E(pVar, qVar.m(pVar));
    }
    ...
    private q m(q qVar, boolean z10) {
        if (qVar instanceof k0) {
            return (q) qVar.w().n().cast(a((k0) k0.class.cast(qVar), this.f50380e, z10));
        }
        throw new r("Base units not supported by: " + qVar.w().n());
    }
    ...
    private q p(q qVar, p pVar, Object obj, boolean z10) {
        q x10 = qVar.x();
        return (q) x10.w().C(pVar).s(x10, pVar.getType().cast(obj), z10);
    }

    private q q(q qVar, p pVar) {
        z C = qVar.w().C(pVar);
        return (q) C.s(qVar, C.h(qVar), pVar.f());
    }

    private q r(q qVar, p pVar) {
        z C = qVar.w().C(pVar);
        return (q) C.s(qVar, C.m(qVar), pVar.f());
    }
    ...
    public q apply(q qVar) {
        switch (this.f50379d) {
            case 0:
                return p(qVar, this.f50380e, this.f50381i, false);
            case 1:
                return k(qVar, this.f50380e);
            case 2:
                return i(qVar, this.f50380e);
            case 3:
                return g(qVar, this.f50380e);
            case 4:
                return e(qVar, this.f50380e);
            case 5:
                return p(qVar, this.f50380e, this.f50381i, true);
            case 6:
                return m(qVar, false);
            case 7:
                return m(qVar, true);
            default:
                throw new UnsupportedOperationException("Unknown mode: " + this.f50379d);
        }
    }
