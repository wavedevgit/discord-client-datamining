...
public final class p extends a {
    ...
    private final Format f49461p;

    /* renamed from: q  reason: collision with root package name */
    private long f49462q;

    /* renamed from: r  reason: collision with root package name */
    private boolean f49463r;
    ...
    public void b() {
        c j10 = j();
        j10.b(0L);
        b0 c10 = j10.c(0, this.f49460o);
        c10.b(this.f49461p);
        try {
            long b10 = this.f49423i.b(this.f49416b.e(this.f49462q));
            if (b10 != -1) {
                b10 += this.f49462q;
            }
            tc.e eVar = new tc.e(this.f49423i, this.f49462q, b10);
            for (int i10 = 0; i10 != -1; i10 = c10.a(eVar, Integer.MAX_VALUE, true)) {
                this.f49462q += i10;
            }
            c10.d(this.f49421g, 1, (int) this.f49462q, 0, null);
            le.o.a(this.f49423i);
            this.f49463r = true;
        } catch (Throwable th2) {
            le.o.a(this.f49423i);
