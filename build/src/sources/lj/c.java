...
public class c {
    ...
    private static final Pattern f36441d = Pattern.compile("[0-9]+s");

    /* renamed from: e  reason: collision with root package name */
    private static final Charset f36442e = Charset.forName("UTF-8");

    /* renamed from: a  reason: collision with root package name */
    private final Context f36443a;

    /* renamed from: b  reason: collision with root package name */
    private final ij.b f36444b;

    /* renamed from: c  reason: collision with root package name */
    private final e f36445c = new e();
    ...
    private String f() {
        try {
            Context context = this.f36443a;
            byte[] a10 = com.google.android.gms.common.util.a.a(context, context.getPackageName());
            if (a10 == null) {
                Log.e("ContentValues", "Could not get fingerprint hash for package: " + this.f36443a.getPackageName());
                return null;
            }
            return h.a(a10, false);
        } catch (PackageManager.NameNotFoundException e10) {
            Log.e("ContentValues", "No such package: " + this.f36443a.getPackageName(), e10);
            return null;
        }
    }
    ...
    private HttpURLConnection l(URL url, String str) {
        try {
            ...
            httpURLConnection.addRequestProperty("X-Android-Package", this.f36443a.getPackageName());
            i iVar = (i) this.f36444b.get();
            if (iVar != null) {
                try {
    ...
    static long m(String str) {
        q.b(f36441d.matcher(str).matches(), "Invalid Expiration Timestamp.");
    ...
    private d n(HttpURLConnection httpURLConnection) {
        ...
        JsonReader jsonReader = new JsonReader(new InputStreamReader(inputStream, f36442e));
        f.a a10 = f.a();
        d.a a11 = d.a();
    ...
    private static String o(HttpURLConnection httpURLConnection) {
        ...
        BufferedReader bufferedReader = new BufferedReader(new InputStreamReader(errorStream, f36442e));
        try {
            try {
