...
public abstract class b {
    ...
    private static final byte[] f7280a = w0.s0("OpusHead");
    ...
    public static final class a {
        ...
        private final h0 f7286f;

        /* renamed from: g  reason: collision with root package name */
        private final h0 f7287g;
        ...
        public boolean a() {
            ...
            this.f7284d = J;
            if (this.f7282b == this.f7288h) {
                this.f7283c = this.f7287g.L();
                this.f7287g.V(4);
                int i12 = this.f7289i - 1;
                this.f7289i = i12;
                if (i12 > 0) {
                    i10 = this.f7287g.L() - 1;
                } else {
    ...
    public static final class f implements d {
        ...
        /* renamed from: c  reason: collision with root package name */
        private final h0 f7302c;

        public f(a.b bVar, Format format) {
            h0 h0Var = bVar.f7279b;
            this.f7302c = h0Var;
            h0Var.U(12);
            int L = h0Var.L();
    ...
    public static final class g implements d {
        ...
        public g(a.b bVar) {
            ...
            this.f7303a = h0Var;
            h0Var.U(12);
            this.f7305c = h0Var.L() & SetSpanOperation.SPAN_MAX_PRIORITY;
            this.f7304b = h0Var.L();
        }
    ...
    public static final class i {
        ...
        /* renamed from: a  reason: collision with root package name */
        public final Metadata f7311a;

        /* renamed from: b  reason: collision with root package name */
        public final Metadata f7312b;

        /* renamed from: c  reason: collision with root package name */
        public final Metadata f7313c;

        public i(Metadata metadata, Metadata metadata2, Metadata metadata3) {
            this.f7311a = metadata;
            this.f7312b = metadata2;
            this.f7313c = metadata3;
        }
    }

    private static o A(a.C0110a c0110a, a.b bVar, long j10, rc.m mVar, boolean z10, boolean z11) {
        long j11;
        long[] jArr;
        long[] jArr2;
        a.C0110a f10;
        Pair i10;
        a.C0110a c0110a2 = (a.C0110a) ne.a.e(c0110a.f(1835297121));
        int e10 = e(l(((a.b) ne.a.e(c0110a2.g(1751411826))).f7279b));
        if (e10 == -1) {
            return null;
        }
        h z12 = z(((a.b) ne.a.e(c0110a.g(1953196132))).f7279b);
        ...
        long j13 = q(bVar.f7279b).f7295b;
        if (j11 != -9223372036854775807L) {
            j12 = w0.X0(j11, 1000000L, j13);
        }
        long j14 = j12;
        Pair n10 = n(((a.b) ne.a.e(c0110a2.g(1835296868))).f7279b);
        a.b g10 = ((a.C0110a) ne.a.e(((a.C0110a) ne.a.e(c0110a2.f(1835626086))).f(1937007212))).g(1937011556);
        if (g10 != null) {
            e x10 = x(g10.f7279b, z12.f7308a, z12.f7310c, (String) n10.second, mVar, z11);
            if (!z10 && (f10 = c0110a.f(1701082227)) != null && (i10 = i(f10)) != null) {
            ...
            return new o(z12.f7308a, e10, ((Long) n10.first).longValue(), j13, j14, x10.f7297b, x10.f7299d, x10.f7296a, x10.f7298c, jArr, jArr2);
        }
        throw l0.a("Malformed sample table (stbl) missing sample description (stsd)", null);
    }

    public static List B(a.C0110a c0110a, v vVar, long j10, rc.m mVar, boolean z10, boolean z11, ii.f fVar) {
        o oVar;
        ArrayList arrayList = new ArrayList();
        for (int i10 = 0; i10 < c0110a.f7278d.size(); i10++) {
            a.C0110a c0110a2 = (a.C0110a) c0110a.f7278d.get(i10);
            if (c0110a2.f7275a == 1953653099 && (oVar = (o) fVar.apply(A(c0110a2, (a.b) ne.a.e(c0110a.g(1836476516)), j10, mVar, z10, z11))) != null) {
                arrayList.add(w(oVar, (a.C0110a) ne.a.e(((a.C0110a) ne.a.e(((a.C0110a) ne.a.e(c0110a2.f(1835297121))).f(1835626086))).f(1937007212)), vVar));
            }
        }
        return arrayList;
    }
    ...
    private static void E(h0 h0Var, int i10, int i11, int i12, int i13, int i14, rc.m mVar, e eVar, int i15) {
        ...
        if (i25 == 1701733238) {
            ...
            if (t10 != null) {
                ...
                if (mVar3 == null) {
                    ...
                    mVar3 = mVar3.c(((p) t10.second).f7421b);
                }
                eVar2.f7296a[i15] = (p) t10.second;
            }
            h0Var.U(f11);
        }
                ...
                if (q11 == 1685480259 || q11 == 1685485123) {
                    ...
                    if (q11 == 1987076931) {
                        ...
                        if (q11 == 1681012275) {
                            ...
                            tc.n.a(z12, null);
                            c0111b = j(h0Var, f13);
                            String str7 = c0111b.f7290a;
                            byte[] bArr3 = c0111b.f7291b;
                            if (bArr3 != null) {
                                list2 = s.s(bArr3);
                            } else {
                                list2 = list;
        ...
        if (c0111b != null) {
            O.I(li.e.k(c0111b.f7292c)).b0(li.e.k(c0111b.f7293d));
        }
        eVar.f7297b = O.G();
    }
    ...
    */
    ...
    private static Pair i(a.C0110a c0110a) {
        long J;
        long q10;
        a.b g10 = c0110a.g(1701606260);
        if (g10 == null) {
            return null;
        }
        h0 h0Var = g10.f7279b;
    ...
    private static C0111b j(h0 h0Var, int i10) {
        long j10;
        h0Var.U(i10 + 12);
        h0Var.V(1);
        k(h0Var);
        ...
        if (!"audio/mpeg".equals(h10) && !"audio/vnd.dts".equals(h10) && !"audio/vnd.dts.hd".equals(h10)) {
            ...
            return new C0111b(h10, bArr, j11, j10);
        }
        return new C0111b(h10, null, -1L, -1L);
    }
    ...
    public static Metadata o(a.C0110a c0110a) {
        a.b g10 = c0110a.g(1751411826);
        a.b g11 = c0110a.g(1801812339);
        a.b g12 = c0110a.g(1768715124);
        if (g10 == null || g11 == null || g12 == null || l(g10.f7279b) != 1835299937) {
            return null;
        }
        h0 h0Var = g11.f7279b;
        h0Var.U(12);
    ...
    private static void p(h0 h0Var, int i10, int i11, int i12, e eVar) {
        ...
        if (i10 == 1835365492) {
            ...
            String B = h0Var.B();
            if (B != null) {
                eVar.f7297b = new Format.b().T(i12).g0(B).G();
            }
        }
    }
    ...
    private static r w(o oVar, a.C0110a c0110a, v vVar) {
        d gVar;
        boolean z10;
        h0 h0Var;
        h0 h0Var2;
        ...
        int i23;
        int i24;
        a.b g10 = c0110a.g(1937011578);
        if (g10 != null) {
            gVar = new f(g10, oVar.f7414f);
        } else {
            a.b g11 = c0110a.g(1937013298);
            if (g11 != null) {
                gVar = new g(g11);
            } else {
        ...
        a.b g12 = c0110a.g(1937007471);
        if (g12 == null) {
            g12 = (a.b) ne.a.e(c0110a.g(1668232756));
            z10 = true;
        } else {
            z10 = false;
        }
        h0 h0Var3 = g12.f7279b;
        h0 h0Var4 = ((a.b) ne.a.e(c0110a.g(1937011555))).f7279b;
        h0 h0Var5 = ((a.b) ne.a.e(c0110a.g(1937011827))).f7279b;
        a.b g13 = c0110a.g(1937011571);
        if (g13 != null) {
            h0Var = g13.f7279b;
        } else {
            h0Var = null;
        }
        a.b g14 = c0110a.g(1668576371);
        if (g14 != null) {
            h0Var2 = g14.f7279b;
        } else {
            h0Var2 = null;
        ...
        int b10 = gVar.b();
        String str2 = oVar.f7414f.f12706w;
        ...
        if (i14 != 0) {
            ...
            while (aVar.a()) {
                int i26 = aVar.f7282b;
                jArr4[i26] = aVar.f7284d;
                iArr8[i26] = aVar.f7283c;
            }
            d.b a10 = bd.d.a(b10, jArr4, iArr8, L3);
            long[] jArr5 = a10.f7318a;
            iArr = a10.f7319b;
            int i27 = a10.f7320c;
            long[] jArr6 = a10.f7321d;
            int[] iArr9 = a10.f7322e;
            j11 = a10.f7323f;
            jArr2 = jArr5;
            i18 = i27;
            jArr = jArr6;
        ...
        long j17 = j11;
        long X0 = w0.X0(j17, 1000000L, oVar.f7411c);
        long[] jArr8 = oVar.f7416h;
        if (jArr8 == null) {
            w0.Z0(jArr, 1000000L, oVar.f7411c);
            return new r(oVar, jArr2, iArr, i18, jArr, iArr2, X0);
        }
        int[] iArr12 = iArr;
        int i44 = c10;
        int[] iArr13 = iArr12;
        if (jArr8.length == 1 && oVar.f7410b == 1 && jArr.length >= 2) {
            long j18 = ((long[]) ne.a.e(oVar.f7417i))[i13];
            long X02 = j18 + w0.X0(oVar.f7416h[i13], oVar.f7411c, oVar.f7412d);
            long[] jArr9 = jArr2;
            long[] jArr10 = jArr;
            ...
            j17 = j17;
            if (b11) {
                long X03 = w0.X0(j18 - jArr[i13], oVar.f7414f.K, oVar.f7411c);
                long X04 = w0.X0(j17 - X02, oVar.f7414f.K, oVar.f7411c);
                if ((X03 != j10 || X04 != j10) && X03 <= 2147483647L && X04 <= 2147483647L) {
                    vVar.f49495a = (int) X03;
                    vVar.f49496b = (int) X04;
                    w0.Z0(jArr, 1000000L, oVar.f7411c);
                    return new r(oVar, jArr9, iArr13, i18, jArr, iArr2, w0.X0(oVar.f7416h[i13], 1000000L, oVar.f7412d));
                }
            }
            jArr2 = jArr9;
            iArr13 = iArr13;
        }
        long[] jArr11 = oVar.f7416h;
        if (jArr11.length == 1 && jArr11[i13] == j10) {
            long j19 = ((long[]) ne.a.e(oVar.f7417i))[i13];
            for (int i45 = i13; i45 < jArr.length; i45++) {
                jArr[i45] = w0.X0(jArr[i45] - j19, 1000000L, oVar.f7411c);
            }
            return new r(oVar, jArr2, iArr13, i18, jArr, iArr2, w0.X0(j17 - j19, 1000000L, oVar.f7411c));
        }
        if (oVar.f7410b == 1) {
            r10 = 1;
        } else {
        ...
        long[] jArr12 = (long[]) ne.a.e(oVar.f7417i);
        int i46 = i13;
        int i47 = i46;
        int i48 = i47;
        int i49 = i48;
        while (true) {
            long[] jArr13 = oVar.f7416h;
            iArr3 = iArr15;
            ...
            if (j20 != -1) {
                ...
                i21 = i46;
                int i50 = i47;
                long X05 = w0.X0(j21, oVar.f7411c, oVar.f7412d);
                iArr7 = iArr16;
        ...
        int i54 = i52;
        long j23 = j10;
        while (i52 < oVar.f7416h.length) {
            long j24 = oVar.f7417i[i52];
            int i55 = iArr17[i52];
            int i56 = i53;
            int i57 = iArr3[i52];
            int i58 = i18;
            ...
            while (i55 < i57) {
                long[] jArr16 = jArr2;
                int[] iArr18 = iArr13;
                long X06 = w0.X0(j23, 1000000L, oVar.f7412d);
                long X07 = w0.X0(jArr[i55] - j24, 1000000L, oVar.f7411c);
                int i60 = i57;
                long[] jArr17 = jArr;
                if (c(oVar.f7410b)) {
                    iArr6 = iArr2;
        ...
        return new r(oVar, jArr3, iArr4, i18, jArr15, iArr5, w0.X0(j23, 1000000L, oVar.f7412d));
    }
        ...
        while (i12 < q10) {
            ...
            if (q12 == 1635148593 || q12 == 1635148595 || q12 == 1701733238 || q12 == 1831958048 || q12 == 1836070006 || q12 == 1752589105 || q12 == 1751479857 || q12 == 1932670515 || q12 == 1211250227 || q12 == 1987063864 || q12 == 1987063865 || q12 == 1635135537 || q12 == 1685479798 || q12 == 1685479729 || q12 == 1685481573 || q12 == 1685481521) {
                ...
                if (q12 == 1835365492) {
                    ...
                    eVar.f7297b = new Format.b().T(i10).g0("application/x-camera-motion").G();
                }
            } else {
    ...
    private static void y(h0 h0Var, int i10, int i11, int i12, int i13, String str, e eVar) {
        ...
        eVar.f7297b = new Format.b().T(i13).g0(str2).X(str).k0(j10).V(sVar).G();
    }
