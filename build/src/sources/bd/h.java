    ...
    private static ld.m d(int i10, String str, h0 h0Var) {
        ...
        if (h0Var.q() == 1684108385 && q10 >= 22) {
            ...
            if (N > 0) {
                ...
                return new ld.m(str, null, s.u(str2));
            }
        }
    ...
    */
    private static ld.m g(ne.h0 r3) {
        /*
            ...
            r0 = 0
            if (r3 <= 0) goto L11
            java.lang.String[] r1 = bd.h.f6603a
            int r2 = r1.length
            if (r3 > r2) goto L11
            int r3 = r3 + (-1)
            r3 = r1[r3]
    ...
    private static ld.m h(int i10, String str, h0 h0Var) {
        ...
        if (h0Var.q() == 1684108385) {
            h0Var.V(8);
            return new ld.m(str, null, s.u(h0Var.C(q10 - 16)));
        }
    ...
    private static ld.i i(int i10, String str, h0 h0Var, boolean z10, boolean z11) {
        ...
        if (j10 >= 0) {
            if (z10) {
                return new ld.m(str, null, s.u(Integer.toString(j10)));
            }
