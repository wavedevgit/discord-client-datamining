...
public final class f implements k {
    ...
    private long i(long j10) {
        return this.f6590m + ((j10 * 1000000) / this.f6581d.f39403d);
    }
        ...
        if (metadata != null) {
            ...
            for (int i10 = 0; i10 < e10; i10++) {
                ...
                if (d10 instanceof md.m) {
                    md.m mVar = (md.m) d10;
                    if (mVar.f36883d.equals("TLEN")) {
                        return w0.K0(Long.parseLong((String) mVar.f36896o.get(0)));
                    }
                }
            }
    ...
    private g p(l lVar) {
        h0 h0Var = new h0(this.f6581d.f39402c);
        lVar.n(h0Var.e(), 0, this.f6581d.f39402c);
    ...
    private int r(l lVar) {
        ...
        if (this.f6594q == null) {
            ...
            Format.b Q = new Format.b().g0(this.f6581d.f39401b).Y(RecyclerView.ItemAnimator.FLAG_APPEARED_IN_PRE_LAYOUT).J(this.f6581d.f39404e).h0(this.f6581d.f39403d).P(this.f6582e.f51276a).Q(this.f6582e.f51277b);
            if ((this.f6578a & 8) != 0) {
                metadata = null;
            } else {
    ...
    private int s(l lVar) {
        ...
        if (this.f6593p == 0) {
            ...
            if (n(q10, this.f6588k) && u.j(q10) != -1) {
                ...
                this.f6593p = this.f6581d.f39402c;
                g gVar = this.f6594q;
                if (gVar instanceof b) {
                    b bVar = (b) gVar;
                    bVar.c(i(this.f6591n + aVar.f39406g), lVar.getPosition() + this.f6581d.f39402c);
        ...
        this.f6587j.a(i(this.f6591n), 1, this.f6581d.f39402c, 0, null);
        this.f6591n += this.f6581d.f39406g;
        this.f6593p = 0;
        return 0;
    }
