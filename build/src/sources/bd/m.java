...
final class m {
    ...
    private static final li.p f6344d = li.p.d(':');

    /* renamed from: e  reason: collision with root package name */
    private static final li.p f6345e = li.p.d('*');

    /* renamed from: a  reason: collision with root package name */
    private final List f6346a = new ArrayList();
    ...
    private void a(tc.l lVar, y yVar) {
        ...
        this.f6348c = h0Var.u() + 8;
        if (h0Var.q() != 1397048916) {
            yVar.f50603a = 0L;
            return;
        }
        yVar.f50603a = lVar.getPosition() - (this.f6348c - 12);
        this.f6347b = 2;
    }
    ...
    private void d(tc.l lVar, y yVar) {
        ...
        for (int i11 = 0; i11 < i10 / 12; i11++) {
            ...
            if (w10 != 2192 && w10 != 2816 && w10 != 2817 && w10 != 2819 && w10 != 2820) {
                ...
                this.f6346a.add(new a(w10, (length - this.f6348c) - h0Var.u(), h0Var.u()));
            }
        }
        ...
        this.f6347b = 3;
        yVar.f50603a = ((a) this.f6346a.get(0)).f6350b;
    }

    private void e(tc.l lVar, List list) {
        long position = lVar.getPosition();
        int length = (int) ((lVar.getLength() - lVar.getPosition()) - this.f6348c);
        h0 h0Var = new h0(length);
        lVar.readFully(h0Var.e(), 0, length);
        for (int i10 = 0; i10 < this.f6346a.size(); i10++) {
            a aVar = (a) this.f6346a.get(i10);
            h0Var.U((int) (aVar.f6350b - position));
            h0Var.V(4);
            int u10 = h0Var.u();
            int b10 = b(h0Var.E(u10));
            int i11 = aVar.f6351c - (u10 + 8);
            if (b10 != 2192) {
    ...
    private static md.c f(h0 h0Var, int i10) {
        ...
        List f10 = f6345e.f(h0Var.E(i10));
        for (int i11 = 0; i11 < f10.size(); i11++) {
            List f11 = f6344d.f((CharSequence) f10.get(i11));
            if (f11.size() == 3) {
                try {
