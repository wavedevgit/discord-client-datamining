...
final class m {
    ...
    private static final mi.p f6637d = mi.p.d(':');

    /* renamed from: e  reason: collision with root package name */
    private static final mi.p f6638e = mi.p.d('*');

    /* renamed from: a  reason: collision with root package name */
    private final List f6639a = new ArrayList();
    ...
    private void a(tc.l lVar, y yVar) {
        ...
        this.f6641c = h0Var.u() + 8;
        if (h0Var.q() != 1397048916) {
            yVar.f50579a = 0L;
            return;
        }
        yVar.f50579a = lVar.getPosition() - (this.f6641c - 12);
        this.f6640b = 2;
    }
    ...
    private void d(tc.l lVar, y yVar) {
        ...
        for (int i11 = 0; i11 < i10 / 12; i11++) {
            ...
            if (w10 != 2192 && w10 != 2816 && w10 != 2817 && w10 != 2819 && w10 != 2820) {
                ...
                this.f6639a.add(new a(w10, (length - this.f6641c) - h0Var.u(), h0Var.u()));
            }
        }
        ...
        this.f6640b = 3;
        yVar.f50579a = ((a) this.f6639a.get(0)).f6643b;
    }

    private void e(tc.l lVar, List list) {
        long position = lVar.getPosition();
        int length = (int) ((lVar.getLength() - lVar.getPosition()) - this.f6641c);
        h0 h0Var = new h0(length);
        lVar.readFully(h0Var.e(), 0, length);
        for (int i10 = 0; i10 < this.f6639a.size(); i10++) {
            a aVar = (a) this.f6639a.get(i10);
            h0Var.U((int) (aVar.f6643b - position));
            h0Var.V(4);
            int u10 = h0Var.u();
            int b10 = b(h0Var.E(u10));
            int i11 = aVar.f6644c - (u10 + 8);
            if (b10 != 2192) {
    ...
    private static md.c f(h0 h0Var, int i10) {
        ...
        List f10 = f6638e.f(h0Var.E(i10));
        for (int i11 = 0; i11 < f10.size(); i11++) {
            List f11 = f6637d.f((CharSequence) f10.get(i11));
            if (f11.size() == 3) {
                try {
