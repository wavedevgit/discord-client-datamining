...
final class i implements g {
    ...
    public static i a(long j10, long j11, u.a aVar, h0 h0Var) {
        ...
        if ((q10 & 1) == 1 && (L = h0Var.L()) != 0) {
            ...
            return new i(j11, aVar.f39402c, X0, J, jArr);
        }
        return null;
    }

    private long c(int i10) {
        return (this.f6604c * i10) / 100;
    }
    ...
    public long b(long j10) {
        long j11;
        double d10;
        long j12 = j10 - this.f6602a;
        if (g() && j12 > this.f6603b) {
            long[] jArr = (long[]) oe.a.i(this.f6607f);
            double d11 = (j12 * 256.0d) / this.f6605d;
    ...
    public z.a e(long j10) {
        double d10;
        if (!g()) {
            return new z.a(new a0(0L, this.f6602a + this.f6603b));
        }
        long r10 = w0.r(j10, 0L, this.f6604c);
        double d11 = (r10 * 100.0d) / this.f6604c;
        double d12 = 0.0d;
        if (d11 > 0.0d) {
            if (d11 >= 100.0d) {
                d12 = 256.0d;
        ...
        return new z.a(new a0(r10, this.f6602a + w0.r(Math.round((d12 / 256.0d) * this.f6605d), this.f6603b, this.f6605d - 1)));
    }
