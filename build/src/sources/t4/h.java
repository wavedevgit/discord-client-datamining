...
public final class h implements qu.b {

    /* renamed from: a  reason: collision with root package name */
    public static final h f50323a = new h();

    private h() {
    }

    private final Object a(i iVar, Function0 function0, Function0 function02) {
        if (Intrinsics.areEqual(iVar, i.b.f50325a)) {
            return function02.invoke();
        }
        if (Intrinsics.areEqual(iVar, i.a.f50324a)) {
            return function0.invoke();
        }
        if (Intrinsics.areEqual(iVar, i.c.f50326a)) {
            return null;
        }
        throw new p();
    }
    ...
    private final Object b(List list, i iVar) {
        ...
        List l02 = CollectionsKt.l0(vv.a.b(list));
