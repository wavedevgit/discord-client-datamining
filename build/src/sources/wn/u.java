...
public final class u implements wp.b {

    /* renamed from: d  reason: collision with root package name */
    private final List f52742d;

    /* renamed from: e  reason: collision with root package name */
    private final List f52743e;

    /* renamed from: i  reason: collision with root package name */
    private final StepStyles.UiStepStyle f52744i;
    ...
    public u(List list, List componentConfigs, StepStyles.UiStepStyle uiStepStyle, String str, String str2, String str3, String str4) {
        ...
        this.f52742d = list;
        this.f52743e = componentConfigs;
        this.f52744i = uiStepStyle;
        this.f52745o = str;
        this.f52746p = str2;
        this.f52747q = str3;
        this.f52748r = str4;
    ...
    public final void writeToParcel(Parcel dest, int i10) {
        ...
        List<Parcelable> list = this.f52742d;
        if (list == null) {
            dest.writeInt(0);
        } else {
            dest.writeInt(1);
        ...
        List<Parcelable> list2 = this.f52743e;
        dest.writeInt(list2.size());
        for (Parcelable parcelable2 : list2) {
            dest.writeParcelable(parcelable2, i10);
        }
        dest.writeParcelable(this.f52744i, i10);
        dest.writeString(this.f52745o);
        dest.writeString(this.f52746p);
        dest.writeString(this.f52747q);
        dest.writeString(this.f52748r);
    }
}
