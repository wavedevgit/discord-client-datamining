...
public final class l implements Parcelable {
    ...
    private final u f52547d;

    /* renamed from: e  reason: collision with root package name */
    private final b3 f52548e;
    ...
    public l(u documentStartPage, b3 uploadOptionsDialog) {
        ...
        this.f52547d = documentStartPage;
        this.f52548e = uploadOptionsDialog;
    }
    ...
    public final void writeToParcel(Parcel dest, int i10) {
        ...
        this.f52547d.writeToParcel(dest, i10);
        this.f52548e.writeToParcel(dest, i10);
    }
}
