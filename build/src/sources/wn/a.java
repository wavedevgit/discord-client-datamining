...
public final class a implements un.i {
    ...
    private final g f53922a;

    /* renamed from: b  reason: collision with root package name */
    private final CoroutineScope f53923b;

    /* renamed from: c  reason: collision with root package name */
    private wn.e f53924c;

    /* renamed from: d  reason: collision with root package name */
    private MutableStateFlow f53925d;
    ...
    public static final class C0719a extends kotlin.coroutines.jvm.internal.k implements Function3 {
        ...
        public final Object invokeSuspend(Object obj) {
            e.d dVar;
            Object f10 = wr.b.f();
            int i10 = this.f53928d;
            if (i10 != 0) {
                if (i10 == 1) {
                    dVar = (e.d) this.f53929e;
                    kotlin.c.b(obj);
                } else {
                ...
                kotlin.c.b(obj);
                e.d dVar2 = (e.d) this.f53930i;
                this.f53929e = dVar2;
                this.f53928d = 1;
                if (((FlowCollector) this.f53929e).emit(dVar2, this) == f10) {
                    return f10;
                }
                dVar = dVar2;
            }
            return kotlin.coroutines.jvm.internal.b.a(!Intrinsics.areEqual(dVar, e.d.b.f53978a));
        }
        ...
        public final Object invoke(FlowCollector flowCollector, e.d dVar, Continuation continuation) {
            ...
            c0719a.f53929e = flowCollector;
            c0719a.f53930i = dVar;
            return c0719a.invokeSuspend(Unit.f32056a);
        }
    }
    ...
    public static final class b extends kotlin.coroutines.jvm.internal.k implements Function2 {
        ...
        public static final class C0720a implements FlowCollector {
            ...
            public final Object emit(e.d dVar, Continuation continuation) {
                if (!Intrinsics.areEqual(dVar, e.d.a.f53977a)) {
                    if (Intrinsics.areEqual(dVar, e.d.C0722d.f53980a)) {
                        this.f53933d.f53925d.setValue(x.e.f51901a);
                    } else if (Intrinsics.areEqual(dVar, e.d.b.f53978a)) {
                        this.f53933d.f53925d.setValue(new x.a(this.f53933d.f53926e));
                        a aVar = this.f53933d;
                        aVar.f53924c = aVar.f53922a.a();
                        this.f53933d.f53926e = false;
                    } else if (dVar instanceof e.d.c) {
                        e.c a10 = ((e.d.c) dVar).a();
                        if (a10 instanceof e.c.a) {
                            if (this.f53933d.f53922a.b()) {
                                Job job = this.f53933d.f53927f;
                                if (job != null) {
                                    Job.a.a(job, null, 1, null);
                                }
                                this.f53933d.u();
                            } else {
                                this.f53933d.f53925d.setValue(x.b.f51898a);
                            }
                        } else if (a10 instanceof e.c.b) {
                            this.f53933d.f53925d.setValue(x.c.f51899a);
                        } else {
                            throw new qr.p();
                        }
                    } else {
        ...
        public final Object invokeSuspend(Object obj) {
            ...
            if (i10 != 0) {
                ...
                kotlin.c.b(obj);
                a aVar = a.this;
                Flow e10 = rs.g.e(aVar.t(aVar.f53924c.K()));
    ...
    public static final class c extends kotlin.coroutines.jvm.internal.k implements Function2 {
        ...
        public final Object invokeSuspend(Object obj) {
            ...
            if (this.f53934d == 0) {
                kotlin.c.b(obj);
                a.this.f53925d.setValue(x.c.f51899a);
                a.this.d();
                return Unit.f32056a;
            }
            throw new IllegalStateException("call to 'resume' before 'invoke' with coroutine");
    ...
    public static final class d extends kotlin.coroutines.jvm.internal.d {
        ...
        public final Object invokeSuspend(Object obj) {
            this.f53937e = obj;
            this.f53939o |= Integer.MIN_VALUE;
    ...
    public static final class e extends kotlin.coroutines.jvm.internal.d {
        ...
        public final Object invokeSuspend(Object obj) {
            this.f53940d = obj;
            this.f53942i |= Integer.MIN_VALUE;
    ...
    public a(g camera2ManagerFactory) {
        ...
        this.f53922a = camera2ManagerFactory;
        this.f53923b = kotlinx.coroutines.i.a(m0.a().Y0(j1.b(null, 1, null)));
        this.f53924c = camera2ManagerFactory.a();
        this.f53925d = l0.a(x.c.f51899a);
    }
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public final void u() {
        this.f53924c = this.f53922a.a();
        os.i.d(this.f53923b, m0.c(), null, new c(null), 2, null);
    }
    ...
    public void d() {
        Job d10;
        if (!Intrinsics.areEqual(this.f53925d.getValue(), x.c.f51899a) && !(this.f53925d.getValue() instanceof x.a)) {
            return;
        }
        Job job = this.f53927f;
        if (job != null) {
            Job.a.a(job, null, 1, null);
        }
        this.f53925d.setValue(x.d.f51900a);
        d10 = os.i.d(this.f53923b, null, null, new b(null), 3, null);
        this.f53927f = d10;
        this.f53924c.T();
    }
    ...
    */
    public java.lang.Object g(kotlin.coroutines.Continuation r5) {
        ...
        L13:
            ...
            r0.<init>(r5)
        L18:
            java.lang.Object r5 = r0.f53937e
            java.lang.Object r1 = wr.b.f()
            int r2 = r0.f53939o
            r3 = 1
            if (r2 == 0) goto L3b
            if (r2 != r3) goto L33
            java.lang.Object r0 = r0.f53936d
            wn.a r0 = (wn.a) r0
            kotlin.c.b(r5)
        ...
        L3b:
            kotlin.c.b(r5)
            kotlinx.coroutines.flow.MutableStateFlow r5 = r4.f53925d
            java.lang.Object r5 = r5.getValue()
            un.x$e r2 = un.x.e.f51901a
    ...
    */
    public java.lang.Object i(kotlin.coroutines.Continuation r5) {
        ...
        L13:
            ...
            r0.<init>(r5)
        L18:
            java.lang.Object r5 = r0.f53940d
            java.lang.Object r1 = wr.b.f()
            int r2 = r0.f53942i
            r3 = 1
            if (r2 == 0) goto L37
    ...
    */
    public java.lang.Object j(kotlin.coroutines.Continuation r5) {
        ...
        L13:
            ...
            r0.<init>(r5)
        L18:
            java.lang.Object r5 = r0.f53943d
            java.lang.Object r1 = wr.b.f()
            int r2 = r0.f53945i
            r3 = 1
            if (r2 == 0) goto L37
