...
public final class e extends Event implements tn.b {
    ...
    public static final a f52941d = new a(null);
    ...
    public short getCoalescingKey() {
        return (short) ((this.f52943b * 10) + (this.f52944c ? 1 : 0));
    }

    @Override // com.facebook.react.uimanager.events.Event
    protected WritableMap getEventData() {
        WritableMap createMap = Arguments.createMap();
        createMap.putString("tabKey", this.f52942a);
        createMap.putBoolean("repeatedSelectionHandledBySpecialEffect", this.f52944c);
        return createMap;
    }
