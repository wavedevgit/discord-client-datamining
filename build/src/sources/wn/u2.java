...
public abstract class u2 {
    ...
    public static final List c(List list) {
        ...
        for (String str : list2) {
            arrayList.add(new d.a(str, a.f52428e, 0, 4, null));
        }
        return arrayList;
    }
    ...
    public static final String d(GenericFileUploadErrorResponse.DocumentErrorResponse documentErrorResponse, Context context) {
        if (documentErrorResponse instanceof GenericFileUploadErrorResponse.DocumentErrorResponse.DisabledFileTypeError) {
            ...
            String string = context.getString(cp.e.f20641d, disabledFileTypeError.getDetails().getUploadedFileType(), CollectionsKt.x0(disabledFileTypeError.getDetails().getEnabledFileTypes(), ", ", null, null, 0, null, null, 62, null));
            ...
            String string2 = context.getString(cp.e.f20642e);
            ...
            String string3 = context.getString(cp.e.f20646i, Integer.valueOf(((GenericFileUploadErrorResponse.DocumentErrorResponse.PageLimitExceededError) documentErrorResponse).getDetails().getPageLimit()));
            ...
            String string4 = context.getString(cp.e.f20644g);
            ...
            String string5 = context.getString(cp.e.f20644g);
            ...
            String string6 = context.getString(cp.e.f20645h);
            ...
            String string7 = context.getString(cp.e.f20643f, Integer.valueOf(((GenericFileUploadErrorResponse.DocumentErrorResponse.GovernmentIdDimensionSizeError) documentErrorResponse).getDetails().getMinDimensionSize()));
            Intrinsics.checkNotNullExpressionValue(string7, "getString(...)");
            return string7;
        } else if (documentErrorResponse instanceof GenericFileUploadErrorResponse.DocumentErrorResponse.UnknownError) {
            String string8 = context.getString(cp.e.f20647j);
