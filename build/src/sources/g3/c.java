...
public final class c {
    ...
    private static C0334c f23883b = C0334c.f23895d;
    ...
    public static final class C0334c {
        ...
        public static final a f23894c = new a(null);

        /* renamed from: d  reason: collision with root package name */
        public static final C0334c f23895d = new C0334c(x0.d(), null, o0.i());

        /* renamed from: a  reason: collision with root package name */
        private final Set f23896a;

        /* renamed from: b  reason: collision with root package name */
        private final Map f23897b;
    ...
    private final C0334c b(Fragment fragment) {
        while (fragment != null) {
            if (fragment.isAdded()) {
                FragmentManager parentFragmentManager = fragment.getParentFragmentManager();
                Intrinsics.checkNotNullExpressionValue(parentFragmentManager, "declaringFragment.parentFragmentManager");
                if (parentFragmentManager.H0() != null) {
                    C0334c H0 = parentFragmentManager.H0();
    ...
    private final void c(C0334c c0334c, final m mVar) {
        Fragment a10 = mVar.a();
    ...
    public static final void l(Fragment violatingFragment, Fragment targetFragment, int i10) {
        ...
        c cVar = f23882a;
        cVar.e(jVar);
        C0334c b10 = cVar.b(violatingFragment);
    ...
    private final boolean q(C0334c c0334c, Class cls, Class cls2) {
