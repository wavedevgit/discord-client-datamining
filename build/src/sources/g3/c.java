...
public final class c {
    ...
    private static C0368c f23408b = C0368c.f23420d;
    ...
    public static final class C0368c {
        ...
        public static final C0368c f23420d = new C0368c(x0.d(), null, o0.i());

        /* renamed from: a  reason: collision with root package name */
        private final Set f23421a;

        /* renamed from: b  reason: collision with root package name */
        private final Map f23422b;
        ...
        public C0368c(Set flags, b bVar, Map allowedViolations) {
    ...
    private final C0368c b(Fragment fragment) {
        while (fragment != null) {
            if (fragment.isAdded()) {
                FragmentManager parentFragmentManager = fragment.getParentFragmentManager();
                Intrinsics.checkNotNullExpressionValue(parentFragmentManager, "declaringFragment.parentFragmentManager");
                if (parentFragmentManager.H0() != null) {
                    C0368c H0 = parentFragmentManager.H0();
    ...
    private final void c(C0368c c0368c, final m mVar) {
        Fragment a10 = mVar.a();
        final String name = a10.getClass().getName();
        if (c0368c.a().contains(a.PENALTY_LOG)) {
            Log.d("FragmentStrictMode", "Policy violation in " + name, mVar);
        }
        c0368c.b();
        if (c0368c.a().contains(a.PENALTY_DEATH)) {
    ...
    public static final void l(Fragment violatingFragment, Fragment targetFragment, int i10) {
        ...
        c cVar = f23407a;
        cVar.e(jVar);
        C0368c b10 = cVar.b(violatingFragment);
    ...
    private final boolean q(C0368c c0368c, Class cls, Class cls2) {
        Set set = (Set) c0368c.c().get(cls.getName());
        if (set == null) {
            return true;
        }
