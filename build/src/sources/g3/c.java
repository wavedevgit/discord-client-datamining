...
public final class c {
    ...
    private final C0339c b(Fragment fragment) {
        while (fragment != null) {
            if (fragment.isAdded()) {
                FragmentManager parentFragmentManager = fragment.getParentFragmentManager();
                Intrinsics.checkNotNullExpressionValue(parentFragmentManager, "declaringFragment.parentFragmentManager");
                if (parentFragmentManager.I0() != null) {
                    C0339c I0 = parentFragmentManager.I0();
    ...
    private final void c(C0339c c0339c, final m mVar) {
        ...
        if (c0339c.a().contains(a.PENALTY_LOG)) {
            Log.d("FragmentStrictMode", "Policy violation in " + name, mVar);
        }
        c0339c.b();
        if (c0339c.a().contains(a.PENALTY_DEATH)) {
    ...
    private final void p(Fragment fragment, Runnable runnable) {
        if (fragment.isAdded()) {
            Handler i10 = fragment.getParentFragmentManager().C0().i();
    ...
    private final boolean q(C0339c c0339c, Class cls, Class cls2) {
        Set set = (Set) c0339c.c().get(cls.getName());
        if (set == null) {
            return true;
        }
