...
public final class b extends hu.c {
    ...
    private final X509TrustManager f25592b;

    /* renamed from: c  reason: collision with root package name */
    private final X509TrustManagerExtensions f25593c;
    ...
    public b(X509TrustManager trustManager, X509TrustManagerExtensions x509TrustManagerExtensions) {
        ...
        this.f25592b = trustManager;
        this.f25593c = x509TrustManagerExtensions;
    }
    ...
    public List a(List chain, String hostname) {
        ...
        try {
            List<X509Certificate> checkServerTrusted = this.f25593c.checkServerTrusted((X509Certificate[]) chain.toArray(new X509Certificate[0]), "RSA", hostname);
    ...
    public boolean equals(Object obj) {
        if ((obj instanceof b) && ((b) obj).f25592b == this.f25592b) {
            return true;
        }
        return false;
    }
    ...
    public int hashCode() {
        return System.identityHashCode(this.f25592b);
    }
}
