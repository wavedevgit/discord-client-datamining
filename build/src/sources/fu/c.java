...
public final class c {
    ...
    private static final CopyOnWriteArraySet f25595b = new CopyOnWriteArraySet();

    /* renamed from: c  reason: collision with root package name */
    private static final Map f25596c;
    ...
    private final void c(String str, String str2) {
        ...
        if (f25595b.add(logger)) {
            ...
            logger.addHandler(d.f25597a);
        }
    }

    private final String d(String str) {
        String str2 = (String) f25596c.get(str);
        if (str2 == null) {
    ...
    public final void b() {
        for (Map.Entry entry : f25596c.entrySet()) {
