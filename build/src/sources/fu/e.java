...
public abstract class e {
    ...
    private static final ByteString f23503a;

    /* renamed from: b  reason: collision with root package name */
    private static final ByteString f23504b;
        ...
        for (int i10 = 0; i10 < size; i10++) {
            if (StringsKt.A(headerName, headers.e(i10), true)) {
                try {
                    ...
                    ju.h.f31441a.g().k("Unable to parse challenge", 5, e10);
                }
            }
        }
        return arrayList;
    ...
    public static final boolean b(Response response) {
        ...
        int L = response.L();
        if (((L >= 100 && L < 200) || L == 204 || L == 304) && au.e.v(response) == -1 && !StringsKt.A("chunked", Response.D0(response, "Transfer-Encoding", null, 2, null), true)) {
            return false;
        }
        return true;
    }
    ...
    */
    private static final void c(okio.Buffer r7, java.util.List r8) {
        ...
        Lbc:
            ...
            goto L2
        */
        throw new UnsupportedOperationException("Method not decompiled: fu.e.c(okio.Buffer, java.util.List):void");
    }
    ...
    private static final String d(Buffer buffer) {
        if (buffer.readByte() == 34) {
            ...
            while (true) {
                long d02 = buffer.d0(f23503a);
                if (d02 == -1) {
                    return null;
                }
                if (buffer.F0(d02) == 34) {
                    buffer2.u0(buffer, d02);
                    buffer.readByte();
                    return buffer2.T1();
    ...
    public static final void f(CookieJar cookieJar, HttpUrl url, Headers headers) {
        ...
        if (cookieJar != CookieJar.f43733b) {
            List e10 = Cookie.f43709j.e(url, headers);
            if (e10.isEmpty()) {
                return;
            }
