...
public abstract class f {
    public static void a(Spannable spannable, int i10, int i11, g gVar, d dVar, Map map, int i12) {
        ...
        if (gVar.q()) {
            ee.d.a(spannable, new ForegroundColorSpan(gVar.c()), i10, i11, 33);
        }
        if (gVar.p()) {
            ee.d.a(spannable, new BackgroundColorSpan(gVar.b()), i10, i11, 33);
        }
        if (gVar.d() != null) {
            ee.d.a(spannable, new TypefaceSpan(gVar.d()), i10, i11, 33);
        }
        if (gVar.o() != null) {
            b bVar = (b) oe.a.e(gVar.o());
            int i15 = bVar.f27113a;
            if (i15 == -1) {
                if (i12 != 2 && i12 != 1) {
                    i15 = 1;
                } else {
            ...
            int i16 = bVar.f27115c;
            if (i16 == -2) {
                i16 = 1;
            }
            ee.d.a(spannable, new ee.e(i15, i14, i16), i10, i11, 33);
        }
        int j10 = gVar.j();
        if (j10 != 2) {
            if (j10 == 3 || j10 == 4) {
            ...
            if (d10 != null && (e10 = e(d10, map)) != null) {
                if (e10.g() == 1 && e10.f(0).f27134b != null) {
                    String str = (String) w0.j(e10.f(0).f27134b);
                    g f11 = f(e10.f27138f, e10.l(), map);
                    if (f11 != null) {
                        i13 = f11.i();
                    } else {
                        i13 = -1;
                    }
                    if (i13 == -1 && (f10 = f(d10.f27138f, d10.l(), map)) != null) {
                        i13 = f10.i();
                    }
                    spannable.setSpan(new ee.c(str, i13), i10, i11, 33);
                } else {
        ...
        if (gVar.n()) {
            ee.d.a(spannable, new ee.a(), i10, i11, 33);
        }
        int f12 = gVar.f();
        if (f12 != 1) {
            if (f12 != 2) {
                ...
                ee.d.a(spannable, new RelativeSizeSpan(gVar.e() / 100.0f), i10, i11, 33);
                return;
            }
            ee.d.a(spannable, new RelativeSizeSpan(gVar.e()), i10, i11, 33);
            return;
        }
        ee.d.a(spannable, new AbsoluteSizeSpan((int) gVar.e(), true), i10, i11, 33);
    }
    ...
    private static d d(d dVar, Map map) {
        while (dVar != null) {
            g f10 = f(dVar.f27138f, dVar.l(), map);
            if (f10 != null && f10.j() == 1) {
                return dVar;
            }
            dVar = dVar.f27142j;
    ...
    private static d e(d dVar, Map map) {
        ...
        while (!arrayDeque.isEmpty()) {
            ...
            g f10 = f(dVar2.f27138f, dVar2.l(), map);
            if (f10 != null && f10.j() == 3) {
                return dVar2;
            }
