...
public abstract class k {
    ...
    static final AtomicReference f7494a = new AtomicReference();

    public static n9 a(bk.e eVar) {
        k9 k9Var;
        h9 h9Var;
        l9 l9Var;
        i9 i9Var;
    ...
    public static void c(qd qdVar, final boolean z10, final ca caVar) {
        qdVar.f(new od() { // from class: ck.j
            @Override // pg.od
            public final ed zza() {
                ba baVar;
                boolean z11 = z10;
    ...
    public static boolean d() {
        AtomicReference atomicReference = f7494a;
        if (atomicReference.get() != null) {
            return ((Boolean) atomicReference.get()).booleanValue();
        }
        boolean a10 = b.a(tj.i.c().b());
