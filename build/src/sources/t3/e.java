...
public abstract class e {
    ...
    private static final List b(Cursor cursor) {
        ...
        while (cursor.moveToNext()) {
            ...
            c10.add(new d.C0659d(i10, i11, string, string2));
        }
        ...
        try {
            ...
            while (H1.moveToNext()) {
                if (H1.getInt(columnIndex2) == 0) {
                    ...
                    ArrayList<d.C0659d> arrayList3 = new ArrayList();
                    for (Object obj : b10) {
                        if (((d.C0659d) obj).e() == i10) {
                            arrayList3.add(obj);
                        }
                    }
                    for (d.C0659d c0659d : arrayList3) {
                        arrayList.add(c0659d.d());
                        arrayList2.add(c0659d.f());
                    }
