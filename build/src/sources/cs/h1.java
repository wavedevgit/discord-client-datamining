...
public final class h1 extends a0 implements FunctionBase, KFunction, l {
    ...
    static final /* synthetic */ KProperty[] f21148x = {Reflection.property1(new PropertyReference1Impl(h1.class, "descriptor", "getDescriptor()Lorg/jetbrains/kotlin/descriptors/FunctionDescriptor;", 0))};

    /* renamed from: r  reason: collision with root package name */
    private final c1 f21149r;

    /* renamed from: s  reason: collision with root package name */
    private final String f21150s;

    /* renamed from: t  reason: collision with root package name */
    private final Object f21151t;

    /* renamed from: u  reason: collision with root package name */
    private final z2.a f21152u;

    /* renamed from: v  reason: collision with root package name */
    private final Lazy f21153v;

    /* renamed from: w  reason: collision with root package name */
    private final Lazy f21154w;
    ...
    public static final ds.h L(h1 h1Var) {
        Object d10;
        ds.h P;
        n g10 = e3.f21130a.g(h1Var.D());
        if (g10 instanceof n.d) {
            if (h1Var.F()) {
                ...
                return new ds.a(jClass, arrayList, a.EnumC0282a.f22356e, a.b.f22360e, null, 16, null);
            }
            ...
            return new ds.a(jClass2, arrayList2, a.EnumC0282a.f22356e, a.b.f22359d, d11);
        } else {
            throw new ir.p();
        }
        if (d10 instanceof Constructor) {
            ...
            if (!Modifier.isStatic(method2.getModifiers())) {
                P = h1Var.N(method2);
            } else if (h1Var.D().getAnnotations().mo1194findAnnotation(j3.j()) != null) {
                P = h1Var.O(method2);
            } else {
        ...
        return ds.o.j(P, h1Var.D(), false, 2, null);
    }

    private final ds.i M(Constructor constructor, FunctionDescriptor functionDescriptor, boolean z10) {
    ...
    private final ds.h P(Method method, boolean z10) {
        Object S;
        if (G()) {
            if (V(method)) {
                S = this.f21151t;
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public static final ds.h Q(h1 h1Var) {
        ...
        if (g10 instanceof n.e) {
            ...
            if (h1Var.F()) {
                ...
                return new ds.a(jClass, arrayList, a.EnumC0282a.f22355d, a.b.f22360e, null, 16, null);
            }
            ...
            return new ds.a(jClass2, arrayList2, a.EnumC0282a.f22355d, a.b.f22359d, d10);
        } else {
        ...
        if (genericDeclaration instanceof Constructor) {
            ...
            if (h1Var.D().getAnnotations().mo1194findAnnotation(j3.j()) != null) {
        ...
        return ds.o.i(hVar, h1Var.D(), true);
    }

    /* JADX INFO: Access modifiers changed from: private */
    public static final FunctionDescriptor R(h1 h1Var, String str) {
        return h1Var.B().k(str, h1Var.f21150s);
    }

    private final Object S() {
        return ds.o.h(this.f21151t, D());
    }
    ...
    @Override // cs.a0
    public ds.h A() {
        return (ds.h) this.f21153v.getValue();
    }
    ...
    @Override // cs.a0
    public ds.h C() {
        return (ds.h) this.f21154w.getValue();
    }

    @Override // cs.a0
    public boolean G() {
        if (this.f21151t != CallableReference.NO_RECEIVER) {
            return true;
        }
        return false;
    }
    ...
    public FunctionDescriptor D() {
        Object b10 = this.f21152u.b(this, f21148x[0]);
    ...
    public boolean equals(Object obj) {
        h1 c10 = j3.c(obj);
        if (c10 == null || !Intrinsics.areEqual(B(), c10.B()) || !Intrinsics.areEqual(getName(), c10.getName()) || !Intrinsics.areEqual(this.f21150s, c10.f21150s) || !Intrinsics.areEqual(this.f21151t, c10.f21151t)) {
            return false;
        }
        return true;
    }
    ...
    public int hashCode() {
        return (((B().hashCode() * 31) + getName().hashCode()) * 31) + this.f21150s.hashCode();
    }
    ...
    */
    public h1(cs.c1 r10, kotlin.reflect.jvm.internal.impl.descriptors.FunctionDescriptor r11) {
        /*
            r9 = this;
            ...
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: cs.h1.<init>(cs.c1, kotlin.reflect.jvm.internal.impl.descriptors.FunctionDescriptor):void");
    }
}
