...
public final class w0 extends c1 implements KClass, x0, w2 {
    ...
    public final class a extends c1.b {
        ...
        public a() {
            ...
            this.f21289n = z2.c(new d0(w0.this));
            this.f21290o = z2.c(new e0(w0.this));
            this.f21291p = z2.c(new f0(w0.this));
            this.f21292q = z2.c(new g0(w0.this));
            this.f21293r = z2.c(new h0(this));
            this.f21294s = z2.c(new i0(this));
            this.f21295t = z2.c(new j0(this));
            this.f21296u = z2.c(new k0(this));
        }
        ...
        public static final Collection E(w0 w0Var) {
            return w0Var.u(w0Var.L(), c1.d.f21111d);
        }

        /* JADX INFO: Access modifiers changed from: private */
        public static final Collection F(w0 w0Var) {
            return w0Var.u(w0Var.M(), c1.d.f21111d);
        }
        ...
        private final Collection M() {
            Object b10 = this.f21290o.b(this, f21278w[10]);
            Intrinsics.checkNotNullExpressionValue(b10, "getValue(...)");
            return (Collection) b10;
        }

        private final Collection O() {
            Object b10 = this.f21291p.b(this, f21278w[11]);
            Intrinsics.checkNotNullExpressionValue(b10, "getValue(...)");
            return (Collection) b10;
        }

        private final Collection P() {
            Object b10 = this.f21292q.b(this, f21278w[12]);
            Intrinsics.checkNotNullExpressionValue(b10, "getValue(...)");
            return (Collection) b10;
        }
        ...
        public static final Collection T(w0 w0Var) {
            return w0Var.u(w0Var.L(), c1.d.f21112e);
        }

        /* JADX INFO: Access modifiers changed from: private */
        public static final Collection U(w0 w0Var) {
            return w0Var.u(w0Var.M(), c1.d.f21112e);
        }
        ...
        public static final List a0(a aVar, w0 w0Var) {
            ...
            if (!KotlinBuiltIns.isSpecialClassWithNoSupertypes(aVar.N())) {
                ...
                arrayList.add(new t2(anyType, m0.f21193d));
            }
        ...
        public static final Type b0(KotlinType kotlinType, a aVar, w0 w0Var) {
            ...
            if (mo1198getDeclarationDescriptor instanceof ClassDescriptor) {
                Class q10 = j3.q((ClassDescriptor) mo1198getDeclarationDescriptor);
                if (q10 != null) {
                    ...
                    throw new x2("No superclass of " + aVar + " in Java reflection for " + mo1198getDeclarationDescriptor);
                }
                throw new x2("Unsupported superclass of " + aVar + ": " + mo1198getDeclarationDescriptor);
            }
            throw new x2("Supertype not a class: " + mo1198getDeclarationDescriptor);
        }
        ...
        public final Collection H() {
            Object b10 = this.f21296u.b(this, f21278w[16]);
            Intrinsics.checkNotNullExpressionValue(b10, "getValue(...)");
            return (Collection) b10;
        }

        public final Collection I() {
            Object b10 = this.f21293r.b(this, f21278w[13]);
            Intrinsics.checkNotNullExpressionValue(b10, "getValue(...)");
            return (Collection) b10;
        }

        public final Collection J() {
            Object b10 = this.f21294s.b(this, f21278w[14]);
            Intrinsics.checkNotNullExpressionValue(b10, "getValue(...)");
            return (Collection) b10;
        }

        public final List K() {
            Object b10 = this.f21280e.b(this, f21278w[1]);
            Intrinsics.checkNotNullExpressionValue(b10, "getValue(...)");
            return (List) b10;
        }

        public final Collection L() {
            Object b10 = this.f21289n.b(this, f21278w[9]);
            Intrinsics.checkNotNullExpressionValue(b10, "getValue(...)");
            return (Collection) b10;
        }

        public final ClassDescriptor N() {
            Object b10 = this.f21279d.b(this, f21278w[0]);
            Intrinsics.checkNotNullExpressionValue(b10, "getValue(...)");
            return (ClassDescriptor) b10;
        }

        public final String Q() {
            return (String) this.f21282g.b(this, f21278w[3]);
        }

        public final String R() {
            return (String) this.f21281f.b(this, f21278w[2]);
        }

        public final List S() {
            Object b10 = this.f21286k.b(this, f21278w[6]);
            Intrinsics.checkNotNullExpressionValue(b10, "getValue(...)");
            return (List) b10;
        }
    }
    ...
    public ClassDescriptor getDescriptor() {
        return ((a) this.f21277p.getValue()).N();
    }
    ...
    public boolean equals(Object obj) {
        if ((obj instanceof w0) && Intrinsics.areEqual(vr.a.c(this), vr.a.c((KClass) obj))) {
            return true;
        }
        return false;
    }
    ...
    public List getAnnotations() {
        return ((a) this.f21277p.getValue()).K();
    }
    ...
    public Collection getMembers() {
        return ((a) this.f21277p.getValue()).H();
    }

    @Override // kotlin.reflect.KClass
    public String getQualifiedName() {
        return ((a) this.f21277p.getValue()).Q();
    }

    @Override // kotlin.reflect.KClass
    public String getSimpleName() {
        return ((a) this.f21277p.getValue()).R();
    }

    @Override // kotlin.reflect.KClass
    public List getTypeParameters() {
        return ((a) this.f21277p.getValue()).S();
    }

    @Override // kotlin.reflect.KClass
    public int hashCode() {
        return vr.a.c(this).hashCode();
    }
    ...
    public PropertyDescriptor t(int i10) {
        ...
        if (Intrinsics.areEqual(getJClass().getSimpleName(), "DefaultImpls") && (declaringClass = getJClass().getDeclaringClass()) != null && declaringClass.isInterface()) {
            KClass e10 = vr.a.e(declaringClass);
        ...
        if (deserializedClassDescriptor != null) {
            ...
            if (property != null) {
                return (PropertyDescriptor) j3.h(getJClass(), property, deserializedClassDescriptor.getC().getNameResolver(), deserializedClassDescriptor.getC().getTypeTable(), deserializedClassDescriptor.getMetadataVersion(), d.f21299d);
            }
        }
        return null;
    }
