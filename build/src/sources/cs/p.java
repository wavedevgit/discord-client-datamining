...
public abstract class p {
    ...
    public static final class a extends p {
        ...
        public String a() {
            ...
            String name = this.f21211a.getName();
            Intrinsics.checkNotNullExpressionValue(name, "getName(...)");
            sb2.append(JvmAbi.getterName(name));
            sb2.append("()");
            Class<?> type = this.f21211a.getType();
    ...
    public static final class c extends p {
        ...
        /* renamed from: a  reason: collision with root package name */
        private final PropertyDescriptor f21214a;

        /* renamed from: b  reason: collision with root package name */
        private final ProtoBuf.Property f21215b;

        /* renamed from: c  reason: collision with root package name */
        private final JvmProtoBuf.JvmPropertySignature f21216c;

        /* renamed from: d  reason: collision with root package name */
        private final NameResolver f21217d;

        /* renamed from: e  reason: collision with root package name */
        private final TypeTable f21218e;
        ...
        public c(PropertyDescriptor descriptor, ProtoBuf.Property proto, JvmProtoBuf.JvmPropertySignature signature, NameResolver nameResolver, TypeTable typeTable) {
            ...
            this.f21214a = descriptor;
            this.f21215b = proto;
            this.f21216c = signature;
            this.f21217d = nameResolver;
            this.f21218e = typeTable;
        ...
        private final String c() {
            DeclarationDescriptor containingDeclaration = this.f21214a.getContainingDeclaration();
            Intrinsics.checkNotNullExpressionValue(containingDeclaration, "getContainingDeclaration(...)");
            if (Intrinsics.areEqual(this.f21214a.getVisibility(), DescriptorVisibilities.INTERNAL) && (containingDeclaration instanceof DeserializedClassDescriptor)) {
                ...
                String str = (num == null || (str = this.f21217d.getString(num.intValue())) == null) ? "main" : "main";
                return '$' + NameUtils.sanitizeAsJavaIdentifier(str);
            } else if (Intrinsics.areEqual(this.f21214a.getVisibility(), DescriptorVisibilities.PRIVATE) && (containingDeclaration instanceof PackageFragmentDescriptor)) {
                PropertyDescriptor propertyDescriptor = this.f21214a;
    ...
    public static final class d extends p {
        ...
        /* renamed from: a  reason: collision with root package name */
        private final n.e f21220a;

        /* renamed from: b  reason: collision with root package name */
        private final n.e f21221b;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        public d(n.e getterSignature, n.e eVar) {
            super(null);
            Intrinsics.checkNotNullParameter(getterSignature, "getterSignature");
            this.f21220a = getterSignature;
            this.f21221b = eVar;
        }
