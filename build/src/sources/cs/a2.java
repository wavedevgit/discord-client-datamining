...
public class a2 extends j2 implements kotlin.reflect.j {
    ...
    public a2(c1 container, PropertyDescriptor descriptor) {
        ...
        this.f21095z = ir.l.a(oVar, new y1(this));
        this.A = ir.l.a(oVar, new z1(this));
    }
    ...
    /* renamed from: Y */
    public a getGetter() {
        return (a) this.f21095z.getValue();
    }
