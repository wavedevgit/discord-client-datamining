...
public abstract class j2 extends a0 implements KProperty {
    ...
    public static final b f21164x = new b(null);

    /* renamed from: y  reason: collision with root package name */
    private static final Object f21165y = new Object();

    /* renamed from: r  reason: collision with root package name */
    private final c1 f21166r;

    /* renamed from: s  reason: collision with root package name */
    private final String f21167s;

    /* renamed from: t  reason: collision with root package name */
    private final String f21168t;

    /* renamed from: u  reason: collision with root package name */
    private final Object f21169u;

    /* renamed from: v  reason: collision with root package name */
    private final Lazy f21170v;

    /* renamed from: w  reason: collision with root package name */
    private final z2.a f21171w;
    ...
    public static abstract class c extends a implements KProperty.b {
        ...
        /* renamed from: t  reason: collision with root package name */
        static final /* synthetic */ KProperty[] f21172t = {Reflection.property1(new PropertyReference1Impl(c.class, "descriptor", "getDescriptor()Lorg/jetbrains/kotlin/descriptors/PropertyGetterDescriptor;", 0))};
        ...
        @Override // cs.a0
        public ds.h A() {
            return (ds.h) this.f21174s.getValue();
        }

        @Override // cs.j2.a
        /* renamed from: O */
        public PropertyGetterDescriptor I() {
            Object b10 = this.f21173r.b(this, f21172t[0]);
    ...
    public static abstract class d extends a implements e.a {
        ...
        /* renamed from: t  reason: collision with root package name */
        static final /* synthetic */ KProperty[] f21175t = {Reflection.property1(new PropertyReference1Impl(d.class, "descriptor", "getDescriptor()Lorg/jetbrains/kotlin/descriptors/PropertySetterDescriptor;", 0))};
        ...
        @Override // cs.a0
        public ds.h A() {
            return (ds.h) this.f21177s.getValue();
        }

        @Override // cs.j2.a
        /* renamed from: O */
        public PropertySetterDescriptor I() {
            Object b10 = this.f21176r.b(this, f21175t[0]);
            Intrinsics.checkNotNullExpressionValue(b10, "getValue(...)");
    ...
    public static final PropertyDescriptor I(j2 j2Var) {
        return j2Var.B().n(j2Var.getName(), j2Var.f21168t);
    }

    /* JADX INFO: Access modifiers changed from: private */
    public static final Field J(j2 j2Var) {
        Class<?> enclosingClass;
        p f10 = e3.f21130a.f(j2Var.D());
    ...
    @Override // cs.a0
    public boolean G() {
        if (this.f21169u != CallableReference.NO_RECEIVER) {
            return true;
        }
        return false;
    }
        ...
        try {
            ...
            if ((obj != obj4 && obj2 != obj4) || D().getExtensionReceiverParameter() != null) {
                ...
                if (accessibleObject != null) {
                    accessibleObject.setAccessible(bs.a.a(this));
                }
                if (member == null) {
                    return null;
                }
    ...
    public PropertyDescriptor D() {
        Object invoke = this.f21171w.invoke();
    ...
    public final Field R() {
        return (Field) this.f21170v.getValue();
    }
    ...
    public boolean equals(Object obj) {
        j2 d10 = j3.d(obj);
        if (d10 == null || !Intrinsics.areEqual(B(), d10.B()) || !Intrinsics.areEqual(getName(), d10.getName()) || !Intrinsics.areEqual(this.f21168t, d10.f21168t) || !Intrinsics.areEqual(this.f21169u, d10.f21169u)) {
            return false;
        }
        return true;
    }
    ...
    public int hashCode() {
        return (((B().hashCode() * 31) + getName().hashCode()) * 31) + this.f21168t.hashCode();
    }
    ...
    */
    public j2(cs.c1 r8, kotlin.reflect.jvm.internal.impl.descriptors.PropertyDescriptor r9) {
        /*
            r7 = this;
            ...
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: cs.j2.<init>(cs.c1, kotlin.reflect.jvm.internal.impl.descriptors.PropertyDescriptor):void");
    }
}
