...
public final class t2 implements KTypeBase {
    ...
    static final /* synthetic */ KProperty[] f21247p = {Reflection.property1(new PropertyReference1Impl(t2.class, "classifier", "getClassifier()Lkotlin/reflect/KClassifier;", 0)), Reflection.property1(new PropertyReference1Impl(t2.class, "arguments", "getArguments()Ljava/util/List;", 0))};

    /* renamed from: d  reason: collision with root package name */
    private final KotlinType f21248d;

    /* renamed from: e  reason: collision with root package name */
    private final z2.a f21249e;

    /* renamed from: i  reason: collision with root package name */
    private final z2.a f21250i;

    /* renamed from: o  reason: collision with root package name */
    private final z2.a f21251o;
    ...
    public t2(KotlinType type, Function0 function0) {
        ...
        this.f21249e = aVar;
        this.f21250i = z2.c(new p2(this));
        this.f21251o = z2.c(new q2(this, function0));
    }
    ...
    public static final List f(t2 t2Var, Function0 function0) {
        s2 s2Var;
        KTypeProjection d10;
        List<TypeProjection> arguments = t2Var.f21248d.getArguments();
        ...
        for (Object obj : list) {
            ...
            if (typeProjection.isStarProjection()) {
                ...
                int i12 = a.f21252a[typeProjection.getProjectionKind().ordinal()];
                if (i12 != 1) {
                    if (i12 != 2) {
                        if (i12 == 3) {
        ...
        if (mo1198getDeclarationDescriptor instanceof ClassDescriptor) {
            ...
            if (q10.isArray()) {
                ...
                if (typeProjection != null && (type = typeProjection.getType()) != null) {
                    ...
                    if (k10 != null) {
                        return new w0(j3.f(vr.a.b(bs.b.a(k10))));
                    }
            ...
            return new v2(null, (TypeParameterDescriptor) mo1198getDeclarationDescriptor);
        } else {
            if (!(mo1198getDeclarationDescriptor instanceof TypeAliasDescriptor)) {
                return null;
            }
            throw new ir.q("An operation is not implemented: Type alias classifiers are not yet supported");
        }
    }
    ...
    public boolean equals(Object obj) {
        if (obj instanceof t2) {
            t2 t2Var = (t2) obj;
            if (Intrinsics.areEqual(this.f21248d, t2Var.f21248d) && Intrinsics.areEqual(getClassifier(), t2Var.getClassifier()) && Intrinsics.areEqual(getArguments(), t2Var.getArguments())) {
                return true;
            }
            return false;
        }
    ...
    public List getAnnotations() {
        return j3.e(this.f21248d);
    }

    @Override // kotlin.jvm.internal.KTypeBase, kotlin.reflect.KType
    public List getArguments() {
        Object b10 = this.f21251o.b(this, f21247p[1]);
    ...
    public kotlin.reflect.d getClassifier() {
        return (kotlin.reflect.d) this.f21250i.b(this, f21247p[0]);
    }

    @Override // kotlin.jvm.internal.KTypeBase
    public Type getJavaType() {
        z2.a aVar = this.f21249e;
        if (aVar != null) {
    ...
    public int hashCode() {
        int i10;
        int hashCode = this.f21248d.hashCode() * 31;
    ...
    public boolean isMarkedNullable() {
        return this.f21248d.isMarkedNullable();
    }
    ...
    public String toString() {
        return d3.f21122a.l(this.f21248d);
    }
