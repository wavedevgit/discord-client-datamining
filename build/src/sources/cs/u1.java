...
public final class u1 extends c1 {
    ...
    public final class a extends c1.b {
        ...
        private final ReflectKotlinClass i() {
            return (ReflectKotlinClass) this.f21259d.b(this, f21258j[0]);
        }
        ...
        public static final Collection o(u1 u1Var, a aVar) {
            return u1Var.u(aVar.m(), c1.d.f21111d);
        }

        /* JADX INFO: Access modifiers changed from: private */
        public static final ir.u p(a aVar) {
            ...
            if (i10 != null && (classHeader = i10.getClassHeader()) != null) {
                ...
                if (data != null && strings != null) {
                    ...
                    return new ir.u((JvmNameResolver) readPackageDataFrom.a(), (ProtoBuf.Package) readPackageDataFrom.b(), classHeader.getMetadataVersion());
                }
            }
            return null;
        }
        ...
        public final Collection j() {
            Object b10 = this.f21263h.b(this, f21258j[2]);
            Intrinsics.checkNotNullExpressionValue(b10, "getValue(...)");
            return (Collection) b10;
        }

        public final ir.u k() {
            return (ir.u) this.f21262g.getValue();
        }

        public final Class l() {
            return (Class) this.f21261f.getValue();
        }

        public final MemberScope m() {
            Object b10 = this.f21260e.b(this, f21258j[1]);
            Intrinsics.checkNotNullExpressionValue(b10, "getValue(...)");
    ...
    private final MemberScope E() {
        return ((a) this.f21257p.getValue()).m();
    }
    ...
    public Collection getMembers() {
        return ((a) this.f21257p.getValue()).j();
    }
    ...
    public PropertyDescriptor t(int i10) {
        ir.u k10 = ((a) this.f21257p.getValue()).k();
        if (k10 != null) {
            ...
            if (property != null) {
                ...
                return (PropertyDescriptor) j3.h(jClass, property, jvmNameResolver, new TypeTable(typeTable), metadataVersion, b.f21265d);
            }
        }
        return null;
    }
    ...
    @Override // cs.c1
    protected Class v() {
        Class l10 = ((a) this.f21257p.getValue()).l();
        if (l10 == null) {
            return getJClass();
        }
        return l10;
