...
public abstract class j3 {
    ...
    private static final FqName f21178a = new FqName("kotlin.jvm.JvmStatic");
    ...
    private static final Object a(ArrayValue arrayValue, ClassLoader classLoader) {
        ...
        int i10 = 0;
        switch (primitiveArrayElementType == null ? -1 : a.f21179a[primitiveArrayElementType.ordinal()]) {
            case -1:
                if (KotlinBuiltIns.isArray(type)) {
                    KotlinType type2 = ((TypeProjection) CollectionsKt.Q0(type.getArguments())).getType();
                    Intrinsics.checkNotNullExpressionValue(type2, "getType(...)");
                    ClassifierDescriptor mo1198getDeclarationDescriptor = type2.getConstructor().mo1198getDeclarationDescriptor();
                    ClassDescriptor classDescriptor = mo1198getDeclarationDescriptor instanceof ClassDescriptor ? (ClassDescriptor) mo1198getDeclarationDescriptor : null;
    ...
    private static final Annotation p(AnnotationDescriptor annotationDescriptor) {
        ...
        return (Annotation) ds.f.h(cls, kotlin.collections.o0.u(arrayList), null, 4, null);
    }
    ...
    private static final Object s(ConstantValue constantValue, ClassLoader classLoader) {
        ...
        if (constantValue instanceof EnumValue) {
            ...
            if (value2 instanceof KClassValue.Value.NormalClass) {
                ...
                ClassifierDescriptor mo1198getDeclarationDescriptor = ((KClassValue.Value.LocalClass) value2).getType().getConstructor().mo1198getDeclarationDescriptor();
    ...
    private static final List t(List list) {
        ...
        while (true) {
            if (!it.hasNext()) {
                break;
            } else if (Intrinsics.areEqual(vr.a.b(vr.a.a((Annotation) it.next())).getSimpleName(), "Container")) {
                list = new ArrayList();
                for (Annotation annotation : list2) {
                    Class b10 = vr.a.b(vr.a.a(annotation));
