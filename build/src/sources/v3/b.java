...
public final class b {
    ...
    private static final a f50587i = new a(null);

    /* renamed from: a  reason: collision with root package name */
    private final f f50588a;

    /* renamed from: b  reason: collision with root package name */
    private final Function0 f50589b;

    /* renamed from: c  reason: collision with root package name */
    private final c f50590c;

    /* renamed from: d  reason: collision with root package name */
    private final Map f50591d;

    /* renamed from: e  reason: collision with root package name */
    private boolean f50592e;

    /* renamed from: f  reason: collision with root package name */
    private Bundle f50593f;

    /* renamed from: g  reason: collision with root package name */
    private boolean f50594g;
    ...
    public b(f owner, Function0 onAttach) {
        ...
        this.f50588a = owner;
        this.f50589b = onAttach;
        this.f50590c = new c();
        this.f50591d = new LinkedHashMap();
        this.f50595h = true;
    }
    ...
    public final SavedStateRegistry.b d(String key) {
        ...
        synchronized (this.f50590c) {
            Iterator it = this.f50591d.entrySet().iterator();
            do {
                bVar = null;
                if (!it.hasNext()) {
                    break;
    ...
    public final void f() {
        if (this.f50588a.getLifecycle().b() == Lifecycle.State.f4393e) {
            if (!this.f50592e) {
                this.f50589b.invoke();
                this.f50588a.getLifecycle().a(new m() { // from class: v3.a
    ...
    public final void h(Bundle bundle) {
        ...
        if (!this.f50588a.getLifecycle().b().d(Lifecycle.State.f4395o)) {
            if (!this.f50594g) {
                Bundle bundle2 = null;
                if (bundle != null) {
                ...
                this.f50593f = bundle2;
                this.f50594g = true;
                return;
            }
            throw new IllegalStateException("SavedStateRegistry was already restored.");
        }
        throw new IllegalStateException(("performRestore cannot be called when owner is " + this.f50588a.getLifecycle().b()).toString());
    }
    ...
    public final void i(Bundle outBundle) {
        ...
        Bundle a11 = g.a(a10);
        Bundle bundle = this.f50593f;
        if (bundle != null) {
            g.b(a11, bundle);
        }
        synchronized (this.f50590c) {
            try {
                for (Map.Entry entry2 : this.f50591d.entrySet()) {
    ...
    public final void j(String key, SavedStateRegistry.b provider) {
        ...
        synchronized (this.f50590c) {
            if (!this.f50591d.containsKey(key)) {
                this.f50591d.put(key, provider);
                Unit unit = Unit.f33282a;
            } else {
    ...
    public final void k(String key) {
        Intrinsics.checkNotNullParameter(key, "key");
        synchronized (this.f50590c) {
            SavedStateRegistry.b bVar = (SavedStateRegistry.b) this.f50591d.remove(key);
        }
    }
}
