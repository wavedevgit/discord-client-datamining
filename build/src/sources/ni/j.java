...
public abstract class j {
    ...
    private static final t0 f38488a = new t0("PhoneskyVerificationUtils");
    ...
    public static boolean b(Context context) {
        try {
            if (!context.getPackageManager().getApplicationInfo("com.android.vending", 0).enabled) {
                f38488a.d("Play Store package is disabled.", new Object[0]);
            } else {
                try {
                    ...
                    f38488a.d("Play Store package is not found.", new Object[0]);
                }
            }
    ...
    private static boolean c(Signature[] signatureArr) {
        ...
        f38488a.d("Play Store package is not signed -- possibly self-built package. Could not verify.", new Object[0]);
        return false;
    }
}
