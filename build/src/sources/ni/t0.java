...
public final class t0 {
    ...
    public t0(String str) {
        ...
        this.f37930a = ("UID: [" + myUid + "]  PID: [" + myPid + "] ").concat(str);
    }
    ...
    public final int a(String str, Object... objArr) {
        if (Log.isLoggable("PlayCore", 6)) {
            return Log.e("PlayCore", e(this.f37930a, str, objArr));
        }
        return 0;
    }
    ...
    public final int b(Throwable th2, String str, Object... objArr) {
        if (Log.isLoggable("PlayCore", 6)) {
            return Log.e("PlayCore", e(this.f37930a, str, objArr), th2);
        }
        return 0;
    }
    ...
    public final int c(String str, Object... objArr) {
        if (Log.isLoggable("PlayCore", 4)) {
            return Log.i("PlayCore", e(this.f37930a, str, objArr));
        }
        return 0;
    }
    ...
    public final int d(String str, Object... objArr) {
        if (Log.isLoggable("PlayCore", 5)) {
            return Log.w("PlayCore", e(this.f37930a, str, objArr));
        }
        return 0;
    }
}
