...
public abstract class d {
    public static final void a(WorkDatabase workDatabase, androidx.work.a configuration, c0 continuation) {
        ...
        while (!r10.isEmpty()) {
            ...
            if ((list instanceof Collection) && list.isEmpty()) {
                ...
                i10 = 0;
                for (k4.z zVar : list) {
                    if (zVar.d().f42997j.e() && (i10 = i10 + 1) < 0) {
                        CollectionsKt.u();
                    }
                }
            }
    ...
    public static final p4.u b(p4.u workSpec) {
        ...
        k4.d dVar = workSpec.f42997j;
        String str = workSpec.f42990c;
        if (!Intrinsics.areEqual(str, ConstraintTrackingWorker.class.getName()) && (dVar.f() || dVar.i())) {
            androidx.work.b a10 = new b.a().c(workSpec.f42992e).h("androidx.work.impl.workers.ConstraintTrackingWorker.ARGUMENT_CLASS_NAME", str).a();
