...
public class c implements Runnable {
    ...
    private static final String f46497i = k4.m.i("EnqueueRunnable");

    /* renamed from: d  reason: collision with root package name */
    private final c0 f46498d;

    /* renamed from: e  reason: collision with root package name */
    private final androidx.work.impl.q f46499e;
    ...
    */
    ...
    public boolean a() {
        p0 g10 = this.f46498d.g();
        WorkDatabase p10 = g10.p();
        p10.e();
        try {
            d.a(p10, g10.i(), this.f46498d);
            boolean e10 = e(this.f46498d);
            p10.A();
            return e10;
        } finally {
            p10.i();
    ...
    public void run() {
        try {
            if (!this.f46498d.h()) {
                if (a()) {
                    m.c(this.f46498d.g().h(), RescheduleReceiver.class, true);
                    f();
                }
                this.f46499e.a(k4.q.f31500a);
                return;
            }
            throw new IllegalStateException("WorkContinuation has cycles (" + this.f46498d + ")");
        } catch (Throwable th2) {
            this.f46499e.a(new q.b.a(th2));
        }
    }
