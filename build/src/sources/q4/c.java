...
public class c implements Runnable {
    ...
    private static final String f45252i = k4.m.i("EnqueueRunnable");

    /* renamed from: d  reason: collision with root package name */
    private final c0 f45253d;

    /* renamed from: e  reason: collision with root package name */
    private final androidx.work.impl.q f45254e;
    ...
    */
    ...
    public boolean a() {
        p0 g10 = this.f45253d.g();
        WorkDatabase p10 = g10.p();
        p10.e();
        try {
            d.a(p10, g10.i(), this.f45253d);
            boolean e10 = e(this.f45253d);
            p10.A();
            return e10;
        } finally {
            p10.i();
    ...
    public void run() {
        try {
            if (!this.f45253d.h()) {
                if (a()) {
                    m.c(this.f45253d.g().h(), RescheduleReceiver.class, true);
                    f();
                }
                this.f45254e.a(k4.q.f30668a);
                return;
            }
            throw new IllegalStateException("WorkContinuation has cycles (" + this.f45253d + ")");
        } catch (Throwable th2) {
            this.f45254e.a(new q.b.a(th2));
        }
    }
