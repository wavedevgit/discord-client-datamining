...
public class c implements Runnable {
    ...
    private static final String f46916i = k4.m.i("EnqueueRunnable");

    /* renamed from: d  reason: collision with root package name */
    private final c0 f46917d;

    /* renamed from: e  reason: collision with root package name */
    private final androidx.work.impl.q f46918e;
    ...
    */
    ...
    public boolean a() {
        p0 g10 = this.f46917d.g();
        WorkDatabase p10 = g10.p();
        p10.e();
        try {
            d.a(p10, g10.i(), this.f46917d);
            boolean e10 = e(this.f46917d);
            p10.A();
            return e10;
        } finally {
            p10.i();
    ...
    public void run() {
        try {
            if (!this.f46917d.h()) {
                if (a()) {
                    m.c(this.f46917d.g().h(), RescheduleReceiver.class, true);
                    f();
                }
                this.f46918e.a(k4.q.f32985a);
                return;
            }
            throw new IllegalStateException("WorkContinuation has cycles (" + this.f46917d + ")");
        } catch (Throwable th2) {
            this.f46918e.a(new q.b.a(th2));
        }
    }
