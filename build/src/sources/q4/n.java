...
public class n {
    ...
    private final WorkDatabase f47196a;

    public n(WorkDatabase workDatabase) {
        this.f47196a = workDatabase;
    }
    ...
    public long a() {
        Long b10 = this.f47196a.D().b("last_force_stop_ms");
        if (b10 != null) {
    ...
    public boolean b() {
        Long b10 = this.f47196a.D().b("reschedule_needed");
    ...
    public void d(long j10) {
        this.f47196a.D().a(new p4.d("last_force_stop_ms", Long.valueOf(j10)));
    }

    public void e(boolean z10) {
        this.f47196a.D().a(new p4.d("reschedule_needed", z10));
    }
}
