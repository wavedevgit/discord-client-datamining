...
public final class h {
    ...
    private final WorkDatabase f46923a;

    public h(WorkDatabase workDatabase) {
        Intrinsics.checkNotNullParameter(workDatabase, "workDatabase");
        this.f46923a = workDatabase;
    }
    ...
    public static final Integer d(h this$0) {
        ...
        d10 = i.d(this$0.f46923a, "next_alarm_manager_id");
    ...
    public static final Integer f(h this$0, int i10, int i11) {
        int d10;
        Intrinsics.checkNotNullParameter(this$0, "this$0");
        d10 = i.d(this$0.f46923a, "next_job_scheduler_id");
        if (i10 > d10 || d10 > i11) {
            i.e(this$0.f46923a, "next_job_scheduler_id", i10 + 1);
        } else {
            i10 = d10;
        }
    ...
    public final int c() {
        Object z10 = this.f46923a.z(new Callable() { // from class: q4.f
    ...
    public final int e(final int i10, final int i11) {
        Object z10 = this.f46923a.z(new Callable() { // from class: q4.g
            @Override // java.util.concurrent.Callable
            public final Object call() {
                Integer f10;
