...
public final class g implements Parcelable {
    ...
    private final StepStyles.UiStepStyle f22051i;
    ...
    public g(List list, List componentConfigs, StepStyles.UiStepStyle uiStepStyle) {
        ...
        this.f22049d = list;
        this.f22050e = componentConfigs;
        this.f22051i = uiStepStyle;
    }
    ...
    public final Drawable a(Context context) {
        ...
        StepStyles.UiStepStyle uiStepStyle = this.f22051i;
        if (uiStepStyle != null) {
    ...
    public boolean equals(Object obj) {
        ...
        g gVar = (g) obj;
        if (Intrinsics.areEqual(this.f22049d, gVar.f22049d) && Intrinsics.areEqual(this.f22050e, gVar.f22050e) && Intrinsics.areEqual(this.f22051i, gVar.f22051i)) {
            return true;
        }
        return false;
    }
    ...
    public int hashCode() {
        ...
        int hashCode2 = ((hashCode * 31) + this.f22050e.hashCode()) * 31;
        StepStyles.UiStepStyle uiStepStyle = this.f22051i;
        if (uiStepStyle != null) {
    ...
    public final void writeToParcel(Parcel dest, int i10) {
        ...
        List<Parcelable> list = this.f22049d;
        if (list == null) {
            dest.writeInt(0);
        } else {
            dest.writeInt(1);
        ...
        List<Parcelable> list2 = this.f22050e;
        dest.writeInt(list2.size());
        for (Parcelable parcelable2 : list2) {
            dest.writeParcelable(parcelable2, i10);
        }
        dest.writeParcelable(this.f22051i, i10);
    }
}
