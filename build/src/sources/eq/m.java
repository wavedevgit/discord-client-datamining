...
public final class m {
    ...
    private final View f(Context context, g gVar, boolean z10, Map map, m5 m5Var, boolean z11, boolean z12) {
        ...
        List<k5> list = l10;
        ArrayList arrayList = new ArrayList();
        List k10 = k(list, com.withpersona.sdk2.inquiry.steps.ui.components.f.j(gVar.Q()), context, z10, arrayList, m5Var);
            ...
            if (gVar.getStyles() == null) {
                for (k5 k5Var : list) {
                    ...
                    if (!(k5Var instanceof x4) && (aVar = (a) map.get(k5Var.getName())) != null && (d10 = aVar.d()) != null && i10 != CollectionsKt.n(list)) {
                        constraintSet.C(d10.getId(), 4, (int) sp.h.a(16.0d));
                    }
                    i10 = i11;
                }
            }
        ...
        if (!z11) {
            root.setPadding(root.getPaddingLeft(), root.getPaddingTop(), root.getPaddingRight(), (int) sp.h.a(24.0d));
        }
        constraintSet.c(root);
        Context context2 = c10.getRoot().getContext();
        Intrinsics.checkNotNullExpressionValue(context2, "getContext(...)");
        if (!sp.f.g(context2) && z12) {
            c(root);
        }
    ...
    private final List k(List list, Map map, Context context, boolean z10, List list2, m5 m5Var) {
        ...
        while (it.hasNext()) {
            k5 k5Var = (k5) it.next();
            if (k5Var instanceof gq.a) {
                gq.a aVar = (gq.a) k5Var;
                ...
                j10 = gq.b.a(aVar, m5Var, (ActionButton) obj);
            } else if (k5Var instanceof gq.i) {
                gq.i iVar = (gq.i) k5Var;
                ...
                j10 = gq.j.a(iVar, m5Var, (CancelButton) obj2);
            } else if (k5Var instanceof gq.m) {
                gq.m mVar = (gq.m) k5Var;
            ...
            } else if (k5Var instanceof gq.e) {
                j10 = gq.g.b((gq.e) k5Var, m5Var);
                ...
                List k10 = f22078a.k(clickableStackComponent.getChildren(), map, context, z10, list2, m5Var);
                ...
                j10 = gq.l.b(clickableStackComponent, m5Var, list2, k10, (ClickableStack) obj29);
            } else if (k5Var instanceof f0) {
                f0 f0Var = (f0) k5Var;
                List k11 = f22078a.k(f0Var.getChildren(), map, context, z10, list2, m5Var);
                ...
                y yVar = (y) k5Var;
                List k12 = f22078a.k(yVar.getChildren(), map, context, z10, list2, m5Var);
    ...
    public final void c(ConstraintLayout parentView) {
        ...
        if (view2 != null) {
            view2.requestFocus();
            view2.post(new Runnable() { // from class: eq.l
    ...
    public final h g(Context context, g uiScreen, boolean z10, boolean z11, boolean z12) {
        ...
        if (yVar != null) {
            view = e(context, yVar, com.withpersona.sdk2.inquiry.steps.ui.components.f.j(uiScreen.Q()), z10, linkedHashMap, m5Var);
            linkedHashMap = linkedHashMap;
            m5Var = m5Var;
        }
        cq.s.b(f10, new Function0() { // from class: eq.k
    ...
    public final h l(up.b binding, g uiScreen, Function2 function2, boolean z10) {
        ...
        if (uiScreen.f() == StyleElements.PositionType.CENTER) {
            binding.f51748c.setFillViewport(true);
        ...
        binding.f51747b.addView(h10.a());
        ConstraintLayout root = binding.getRoot();
        Intrinsics.checkNotNullExpressionValue(root, "getRoot(...)");
        cq.f.d(root, false, false, false, false, 13, null);
        if (h10.b() != null) {
            binding.f51749d.addView(h10.b());
            cq.f.d(h10.b(), false, false, false, false, 2, null);
        }
        if (function2 != null) {
        ...
        if (e10 != null) {
            binding.f51750e.setControlsColor(e10.intValue());
        }
        return h10;
    }
}
