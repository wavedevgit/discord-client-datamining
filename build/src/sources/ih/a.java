...
public class a {
    ...
    private static final int f26714f = (int) Math.round(5.1000000000000005d);
    ...
    private boolean e(int i10) {
        if (c.l(i10, SetSpanOperation.SPAN_MAX_PRIORITY) == this.f26718d) {
            return true;
        }
        return false;
    }
    ...
    public int b(int i10, float f10) {
        ...
        int j10 = gh.a.j(c.l(i10, SetSpanOperation.SPAN_MAX_PRIORITY), this.f26716b, a10);
        if (a10 > 0.0f && (i11 = this.f26717c) != 0) {
            j10 = gh.a.i(j10, c.l(i11, f26714f));
        }
