...
public class c implements h {
    ...
    public boolean a(UnsatisfiedLinkError unsatisfiedLinkError, e0[] e0VarArr) {
        ...
        File file = new File(this.f45009a.getApplicationInfo().nativeLibraryDir);
        if (!file.exists()) {
            ...
            if (!(e0Var instanceof com.facebook.soloader.c)) {
                ...
                try {
                    for (g0.c cVar2 : cVar.o()) {
                        if (!new File(file, cVar2.f12454d).exists()) {
                            arrayList.add(cVar2.f12454d);
                        }
                    }
