...
public class j implements h {
    ...
    */
    private boolean b(com.facebook.soloader.e0[] r7, java.lang.String r8) {
        /*
            r6 = this;
        ...
        L6c:
            return r2
        */
        throw new UnsupportedOperationException("Method not decompiled: pb.j.b(com.facebook.soloader.e0[], java.lang.String):boolean");
    }
    ...
    private boolean d(e0[] e0VarArr, String str, int i10) {
        try {
            for (e0 e0Var : e0VarArr) {
                if ((e0Var instanceof com.facebook.soloader.c) && ((com.facebook.soloader.c) e0Var).x(str, i10)) {
                    return true;
                }
            }
            return false;
    ...
    public boolean a(UnsatisfiedLinkError unsatisfiedLinkError, e0[] e0VarArr) {
        ...
        c0 c0Var = (c0) unsatisfiedLinkError;
        String a10 = c0Var.a();
