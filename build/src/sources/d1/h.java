...
public class h {
    ...
    public static final a f21569g;

    /* renamed from: h  reason: collision with root package name */
    private static final h f21570h;

    /* renamed from: i  reason: collision with root package name */
    private static final h f21571i;

    /* renamed from: j  reason: collision with root package name */
    private static final h f21572j;
    ...
    public static final class a {
        ...
        public final float[] b(c cVar, c cVar2, int i10) {
            float[] c10;
            float[] c11;
            if (!m.e(i10, m.f21599a.a())) {
                return null;
            }
            long e10 = cVar.e();
            b.a aVar = d1.b.f21536a;
        ...
        public final h f(c source) {
            ...
            return new C0275a(source, m.f21599a.c());
        }
    ...
    public static final class b extends h {
        ...
        private final w f21579k;

        /* renamed from: l  reason: collision with root package name */
        private final w f21580l;

        /* renamed from: m  reason: collision with root package name */
        private final float[] f21581m;
        ...
        @Override // d1.h
        public long e(float f10, float f11, float f12, float f13) {
            float a10 = (float) this.f21579k.D().a(f10);
            float a11 = (float) this.f21579k.D().a(f11);
            float a12 = (float) this.f21579k.D().a(f12);
            return c1.b.a((float) this.f21580l.G().a(d.n(this.f21581m, a10, a11, a12)), (float) this.f21580l.G().a(d.o(this.f21581m, a10, a11, a12)), (float) this.f21580l.G().a(d.p(this.f21581m, a10, a11, a12)), f13, this.f21580l);
        }
        ...
        private b(w mSource, w mDestination, int i10) {
            ...
            this.f21579k = mSource;
            this.f21580l = mDestination;
            this.f21581m = f(mSource, mDestination, i10);
        }
    }
    ...
    static {
        ...
        f21569g = aVar;
        g gVar = g.f21545a;
        f21570h = aVar.f(gVar.h());
        w h10 = gVar.h();
        c g10 = gVar.g();
        m.a aVar2 = m.f21599a;
        f21571i = new h(h10, g10, aVar2.b(), null);
        f21572j = new h(gVar.g(), gVar.h(), aVar2.b(), null);
    }
    ...
    public long e(float f10, float f11, float f12, float f13) {
        long h10 = this.f21575c.h(f10, f11, f12);
        ...
        float i10 = this.f21575c.i(f10, f11, f12);
        float[] fArr = this.f21578f;
        if (fArr != null) {
        ...
        return this.f21576d.j(f15, f14, i10, f13, this.f21574b);
    }
    ...
    private h(c source, c destination, c transformSource, c transformDestination, int i10, float[] fArr) {
        ...
        this.f21573a = source;
        this.f21574b = destination;
        this.f21575c = transformSource;
        this.f21576d = transformDestination;
        this.f21577e = i10;
        this.f21578f = fArr;
    }
    ...
    */
    private h(d1.c r13, d1.c r14, int r15) {
        /*
            ...
            long r0 = r13.e()
            d1.b$a r2 = d1.b.f21536a
            long r3 = r2.b()
            boolean r0 = d1.b.e(r0, r3)
            r1 = 2
            r3 = 0
            if (r0 == 0) goto L28
            d1.j r0 = d1.j.f21582a
            d1.y r0 = r0.b()
