...
public class h {
    ...
    public static final a f20408g;

    /* renamed from: h  reason: collision with root package name */
    private static final h f20409h;

    /* renamed from: i  reason: collision with root package name */
    private static final h f20410i;

    /* renamed from: j  reason: collision with root package name */
    private static final h f20411j;

    /* renamed from: a  reason: collision with root package name */
    private final c f20412a;
    ...
    private final c f20415d;

    /* renamed from: e  reason: collision with root package name */
    private final int f20416e;

    /* renamed from: f  reason: collision with root package name */
    private final float[] f20417f;
    ...
    public static final class a {
        ...
        public final float[] b(c cVar, c cVar2, int i10) {
            float[] c10;
            float[] c11;
            if (!m.e(i10, m.f20438a.a())) {
                return null;
            }
            long e10 = cVar.e();
            b.a aVar = d1.b.f20375a;
        ...
        public final h f(c source) {
            ...
            return new C0302a(source, m.f20438a.c());
        }
    ...
    public static final class b extends h {
        ...
        private final w f20418k;

        /* renamed from: l  reason: collision with root package name */
        private final w f20419l;
        ...
        @Override // d1.h
        public long e(float f10, float f11, float f12, float f13) {
            float a10 = (float) this.f20418k.D().a(f10);
            float a11 = (float) this.f20418k.D().a(f11);
            float a12 = (float) this.f20418k.D().a(f12);
            return c1.b.a((float) this.f20419l.G().a(d.n(this.f20420m, a10, a11, a12)), (float) this.f20419l.G().a(d.o(this.f20420m, a10, a11, a12)), (float) this.f20419l.G().a(d.p(this.f20420m, a10, a11, a12)), f13, this.f20419l);
        }
        ...
        private b(w mSource, w mDestination, int i10) {
            ...
            this.f20418k = mSource;
            this.f20419l = mDestination;
            this.f20420m = f(mSource, mDestination, i10);
        }
    }
    ...
    static {
        ...
        f20408g = aVar;
        g gVar = g.f20384a;
        f20409h = aVar.f(gVar.h());
        w h10 = gVar.h();
        c g10 = gVar.g();
        m.a aVar2 = m.f20438a;
        f20410i = new h(h10, g10, aVar2.b(), null);
        f20411j = new h(gVar.g(), gVar.h(), aVar2.b(), null);
    }
    ...
    public long e(float f10, float f11, float f12, float f13) {
        long h10 = this.f20414c.h(f10, f11, f12);
        ...
        float i10 = this.f20414c.i(f10, f11, f12);
        float[] fArr = this.f20417f;
        if (fArr != null) {
        ...
        return this.f20415d.j(f15, f14, i10, f13, this.f20413b);
    }
    ...
    private h(c source, c destination, c transformSource, c transformDestination, int i10, float[] fArr) {
        ...
        this.f20412a = source;
        this.f20413b = destination;
        this.f20414c = transformSource;
        this.f20415d = transformDestination;
        this.f20416e = i10;
        this.f20417f = fArr;
    }
    ...
    */
    private h(d1.c r13, d1.c r14, int r15) {
        /*
            ...
            long r0 = r13.e()
            d1.b$a r2 = d1.b.f20375a
            long r3 = r2.b()
            boolean r0 = d1.b.e(r0, r3)
            r1 = 2
            r3 = 0
            if (r0 == 0) goto L28
            d1.j r0 = d1.j.f20421a
            d1.y r0 = r0.b()
