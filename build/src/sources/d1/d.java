...
public abstract class d {
    ...
    public static final h h(c connect, c destination, int i10) {
        ...
        if (connect == gVar.h()) {
            ...
            if (destination == gVar.g() && m.e(i10, m.f21386a.b())) {
                return h.f21356g.e();
            }
        } else if (connect == gVar.g() && destination == gVar.h() && m.e(i10, m.f21386a.b())) {
            return h.f21356g.c();
        }
        if (connect == destination) {
            return h.f21356g.f(connect);
        }
        long e10 = connect.e();
        b.a aVar = b.f21323a;
