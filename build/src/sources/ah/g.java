...
public class g {
    ...
    private final SimpleArrayMap f636a = new SimpleArrayMap();

    /* renamed from: b  reason: collision with root package name */
    private final SimpleArrayMap f637b = new SimpleArrayMap();
    ...
    public boolean equals(Object obj) {
        ...
        return this.f636a.equals(((g) obj).f636a);
    }

    public boolean f(String str) {
        if (this.f636a.get(str) != null) {
            return true;
        }
        return false;
    }
    ...
    public void g(String str, PropertyValuesHolder[] propertyValuesHolderArr) {
        this.f637b.put(str, propertyValuesHolderArr);
    }

    public void h(String str, h hVar) {
        this.f636a.put(str, hVar);
    }
    ...
    public String toString() {
        return '\n' + getClass().getName() + '{' + Integer.toHexString(System.identityHashCode(this)) + " timings: " + this.f636a + "}\n";
    }
}
