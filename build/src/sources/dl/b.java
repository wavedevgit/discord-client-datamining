...
final class b {
    ...
    private final List f20826b = new ArrayList(5);

    /* renamed from: h  reason: collision with root package name */
    private final int[] f20832h = new int[3];

    /* JADX INFO: Access modifiers changed from: package-private */
    public b(lk.b bVar, int i10, int i11, int i12, int i13, float f10, q qVar) {
        this.f20825a = bVar;
        this.f20827c = i10;
        this.f20828d = i11;
        this.f20829e = i12;
    ...
    private float b(int i10, int i11, int i12, int i13) {
        lk.b bVar = this.f20825a;
        int i14 = bVar.i();
        int[] iArr = this.f20832h;
        iArr[0] = 0;
        iArr[1] = 0;
        iArr[2] = 0;
        int i15 = i10;
    ...
    private a e(int[] iArr, int i10, int i11) {
        ...
        if (!Float.isNaN(b10)) {
            ...
            for (a aVar : this.f20826b) {
                if (aVar.f(f10, b10, a10)) {
                    return aVar.g(b10, a10, f10);
                }
            }
            this.f20826b.add(new a(a10, b10, f10));
            return null;
        }
        return null;
    }
    ...
    public a c() {
        ...
        int i12 = this.f20830f;
        int i13 = this.f20829e + i11;
        int i14 = this.f20828d + (i12 / 2);
        int[] iArr = new int[3];
        for (int i15 = 0; i15 < i12; i15++) {
            ...
            iArr[2] = 0;
            int i17 = i11;
            while (i17 < i13 && !this.f20825a.e(i17, i16)) {
                i17++;
            }
            int i18 = 0;
            while (i17 < i13) {
                if (this.f20825a.e(i17, i16)) {
                    if (i18 == 1) {
                        iArr[1] = iArr[1] + 1;
                    } else if (i18 == 2) {
