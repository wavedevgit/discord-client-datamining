...
public abstract class a {
    ...
    */
    private static java.util.List d(boolean r8, ok.b r9) {
        /*
        ...
        L7a:
            return r0
        */
        throw new UnsupportedOperationException("Method not decompiled: dl.a.d(boolean, ok.b):java.util.List");
    }

    private static int[] e(ok.b bVar, int i10, int i11, int i12, int[] iArr, int[] iArr2) {
    ...
    private static p[] f(ok.b bVar, int i10, int i11, int i12, int i13, int i14, int[] iArr) {
        int i15;
        boolean z10;
        int[] e10;
        p[] pVarArr = new p[4];
    ...
    private static p[] g(ok.b bVar, int i10, int i11) {
        int h10 = bVar.h();
        int l10 = bVar.l();
        p[] pVarArr = new p[8];
        int i12 = 10;
        ...
        if (pVar != null) {
            ...
            p pVar2 = pVarArr[5];
            if (pVar2 != null) {
                i12 = (int) Math.max((((int) pVar2.d()) - d10) * 0.5f, 10.0f);
            }
            i13 = d10;
            i14 = c10;
        }
