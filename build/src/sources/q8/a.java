...
public abstract class a {
    ...
    private static c f43987a = b.a();

    public static void A(Class cls, String str, Object obj, Object obj2) {
        if (f43987a.isLoggable(2)) {
            f43987a.v(r(cls), q(str, obj, obj2));
        }
    }
    ...
    public static void C(Class cls, String str, Object obj, Object obj2, Object obj3, Object obj4) {
        if (f43987a.isLoggable(2)) {
            f43987a.v(r(cls), q(str, obj, obj2, obj3, obj4));
        }
    }

    public static void D(Class cls, String str, Object... objArr) {
        if (f43987a.isLoggable(2)) {
            f43987a.v(r(cls), q(str, objArr));
        }
    }

    public static void E(String str, String str2, Object... objArr) {
        if (f43987a.isLoggable(2)) {
            f43987a.v(str, q(str2, objArr));
        }
    }

    public static void F(Class cls, String str) {
        if (f43987a.isLoggable(5)) {
            f43987a.w(r(cls), str);
        }
    }
    ...
    public static void K(String str, String str2, Throwable th2) {
        if (f43987a.isLoggable(5)) {
            f43987a.w(str, str2, th2);
        }
    }

    public static void L(String str, String str2, Object... objArr) {
        if (f43987a.isLoggable(5)) {
            f43987a.w(str, q(str2, objArr));
        }
    }

    public static void M(String str, Throwable th2, String str2, Object... objArr) {
        if (f43987a.isLoggable(5)) {
            f43987a.w(str, q(str2, objArr), th2);
        }
    }

    public static void N(Class cls, String str, Throwable th2) {
        if (f43987a.isLoggable(6)) {
            f43987a.wtf(r(cls), str, th2);
        }
    }

    public static void O(String str, String str2, Object... objArr) {
        if (f43987a.isLoggable(6)) {
            f43987a.wtf(str, q(str2, objArr));
        }
    }

    public static void a(Class cls, String str, Object obj) {
        if (f43987a.isLoggable(3)) {
            f43987a.d(r(cls), q(str, obj));
        }
    }
    ...
    public static void n(String str, String str2, Throwable th2) {
        if (f43987a.isLoggable(6)) {
            f43987a.e(str, str2, th2);
        }
    }

    public static void o(String str, String str2, Object... objArr) {
        if (f43987a.isLoggable(6)) {
            f43987a.e(str, q(str2, objArr));
        }
    }

    public static void p(String str, Throwable th2, String str2, Object... objArr) {
        if (f43987a.isLoggable(6)) {
            f43987a.e(str, q(str2, objArr), th2);
        }
    }
    ...
    public static void t(String str, String str2, Object obj, Object obj2) {
        if (f43987a.isLoggable(4)) {
            f43987a.i(str, q(str2, obj, obj2));
        }
    }

    public static void u(String str, String str2, Object obj, Object obj2, Object obj3) {
        if (f43987a.isLoggable(4)) {
            f43987a.i(str, q(str2, obj, obj2, obj3));
        }
    }

    public static void v(String str, String str2, Object... objArr) {
        if (f43987a.isLoggable(4)) {
            f43987a.i(str, q(str2, objArr));
        }
    }

    public static boolean w(int i10) {
        return f43987a.isLoggable(i10);
    }
