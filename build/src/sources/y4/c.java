...
public final class c implements Closeable, Flushable {
    ...
    private final c0 f55962d;

    /* renamed from: e  reason: collision with root package name */
    private final long f55963e;

    /* renamed from: i  reason: collision with root package name */
    private final int f55964i;

    /* renamed from: o  reason: collision with root package name */
    private final int f55965o;

    /* renamed from: p  reason: collision with root package name */
    private final c0 f55966p;

    /* renamed from: q  reason: collision with root package name */
    private final c0 f55967q;

    /* renamed from: r  reason: collision with root package name */
    private final c0 f55968r;

    /* renamed from: s  reason: collision with root package name */
    private final LinkedHashMap f55969s;

    /* renamed from: t  reason: collision with root package name */
    private final CoroutineScope f55970t;

    /* renamed from: u  reason: collision with root package name */
    private long f55971u;

    /* renamed from: v  reason: collision with root package name */
    private int f55972v;

    /* renamed from: w  reason: collision with root package name */
    private BufferedSink f55973w;

    /* renamed from: x  reason: collision with root package name */
    private boolean f55974x;

    /* renamed from: y  reason: collision with root package name */
    private boolean f55975y;
    ...
    public final class b {
        ...
        public b(C0773c c0773c) {
            this.f55977a = c0773c;
            this.f55979c = new boolean[c.this.f55965o];
        }
        ...
        private final void d(boolean z10) {
            ...
            synchronized (cVar) {
                try {
                    if (!this.f55978b) {
                        if (Intrinsics.areEqual(this.f55977a.b(), this)) {
                            cVar.C0(this, z10);
                        }
                        this.f55978b = true;
        ...
        public final c0 f(int i10) {
            ...
            synchronized (cVar) {
                if (!this.f55978b) {
                    this.f55979c[i10] = true;
                    Object obj = this.f55977a.c().get(i10);
    ...
    public final class C0773c {
        ...
        /* renamed from: b  reason: collision with root package name */
        private final long[] f55982b;

        /* renamed from: c  reason: collision with root package name */
        private final ArrayList f55983c;

        /* renamed from: d  reason: collision with root package name */
        private final ArrayList f55984d;
        ...
        public C0773c(String str) {
            this.f55981a = str;
            this.f55982b = new long[c.this.f55965o];
            this.f55983c = new ArrayList(c.this.f55965o);
            this.f55984d = new ArrayList(c.this.f55965o);
            StringBuilder sb2 = new StringBuilder(str);
            sb2.append('.');
            int length = sb2.length();
            int i10 = c.this.f55965o;
            for (int i11 = 0; i11 < i10; i11++) {
                sb2.append(i11);
                this.f55983c.add(c.this.f55962d.m(sb2.toString()));
                sb2.append(".tmp");
                this.f55984d.add(c.this.f55962d.m(sb2.toString()));
        ...
        public final void j(List list) {
            if (list.size() == c.this.f55965o) {
                try {
                    int size = list.size();
                    for (int i10 = 0; i10 < size; i10++) {
                        this.f55982b[i10] = Long.parseLong((String) list.get(i10));
                    }
                    return;
        ...
        public final d n() {
            if (!this.f55985e || this.f55987g != null || this.f55986f) {
                return null;
            }
            ArrayList arrayList = this.f55983c;
            c cVar = c.this;
    ...
    public final class d implements Closeable {
        ...
        /* renamed from: d  reason: collision with root package name */
        private final C0773c f55990d;

        /* renamed from: e  reason: collision with root package name */
        private boolean f55991e;
        ...
        public void close() {
            if (!this.f55991e) {
                ...
                synchronized (cVar) {
                    try {
                        C0773c c0773c = this.f55990d;
                        c0773c.k(c0773c.f() - 1);
                        if (this.f55990d.f() == 0 && this.f55990d.h()) {
                            cVar.b1(this.f55990d);
                        }
                        Unit unit = Unit.f32556a;
                    } catch (Throwable th2) {
                        throw th2;
        ...
        public final c0 h(int i10) {
            if (!this.f55991e) {
                return (c0) this.f55990d.a().get(i10);
            }
    ...
    public c(h hVar, c0 c0Var, CoroutineDispatcher coroutineDispatcher, long j10, int i10, int i11) {
        ...
        if (j10 > 0) {
            if (i11 > 0) {
                this.f55966p = c0Var.m("journal");
                this.f55967q = c0Var.m("journal.tmp");
                this.f55968r = c0Var.m("journal.bkp");
                this.f55969s = new LinkedHashMap(0, 0.75f, true);
                this.f55970t = kotlinx.coroutines.i.a(j1.b(null, 1, null).O0(coroutineDispatcher.z1(1)));
                this.C = new e(hVar);
                return;
            }
        ...
        if (Intrinsics.areEqual(g10.b(), bVar)) {
            ...
            if (z10 && !g10.h()) {
                ...
                while (i10 < i13) {
                    ...
                    g10.e()[i10] = j10;
                    this.f55971u = (this.f55971u - j11) + j10;
                    i10++;
                }
            } else {
                int i14 = this.f55965o;
                while (i10 < i14) {
            ...
            this.f55972v++;
            BufferedSink bufferedSink = this.f55973w;
            Intrinsics.checkNotNull(bufferedSink);
            if (!z10 && !g10.g()) {
                this.f55969s.remove(g10.d());
                bufferedSink.q0("REMOVE");
                bufferedSink.writeByte(32);
                bufferedSink.q0(g10.d());
                bufferedSink.writeByte(10);
                bufferedSink.flush();
                if (this.f55971u <= this.f55963e || L0()) {
                    N0();
                }
                return;
            }
    ...
    private final void E0() {
        close();
        k5.e.b(this.C, this.f55962d);
    }

    /* JADX INFO: Access modifiers changed from: private */
    public final boolean L0() {
        if (this.f55972v >= 2000) {
            return true;
        }
        return false;
    }
    ...
    private final void N0() {
        ys.i.d(this.f55970t, null, null, new f(null), 3, null);
    }

    private final BufferedSink O0() {
        return x.c(new y4.d(this.C.a(this.f55966p), new Function1() { // from class: y4.b
    ...
    private final void V0() {
        Iterator it = this.f55969s.values().iterator();
        long j10 = 0;
        while (it.hasNext()) {
    ...
    */
    private final void Z0() {
        ...
        L5b:
            ...
            goto Lb6
        L5d:
            java.util.LinkedHashMap r2 = r10.f55969s     // Catch: java.lang.Throwable -> L5b
            int r2 = r2.size()     // Catch: java.lang.Throwable -> L5b
            int r0 = r0 - r2
            r10.f55972v = r0     // Catch: java.lang.Throwable -> L5b
        ...
        L70:
            ...
            r10.f55973w = r0     // Catch: java.lang.Throwable -> L5b
        L76:
            kotlin.Unit r0 = kotlin.Unit.f32556a     // Catch: java.lang.Throwable -> L5b
            if (r1 == 0) goto L80
    ...
    private final void a1(String str) {
        ...
        if (h02 != -1) {
            ...
            LinkedHashMap linkedHashMap = this.f55969s;
    ...
    public final boolean b1(C0773c c0773c) {
        ...
        if (c0773c.f() > 0 && (bufferedSink = this.f55973w) != null) {
        ...
        if (c0773c.f() <= 0 && c0773c.b() == null) {
            int i10 = this.f55965o;
            for (int i11 = 0; i11 < i10; i11++) {
                this.C.h((c0) c0773c.a().get(i11));
                this.f55971u -= c0773c.e()[i11];
                c0773c.e()[i11] = 0;
            }
            this.f55972v++;
            BufferedSink bufferedSink2 = this.f55973w;
    ...
    private final boolean f1() {
        for (C0773c c0773c : this.f55969s.values()) {
            if (!c0773c.h()) {
                b1(c0773c);
                return true;
            }
    ...
    public final void w1() {
        while (this.f55971u > this.f55963e) {
            if (!f1()) {
                return;
            }
        }
    ...
    public final synchronized void z1() {
        try {
            ...
            BufferedSink c10 = x.c(this.C.p(this.f55967q, false));
            c10.q0("libcore.io.DiskLruCache").writeByte(10);
            c10.q0("1").writeByte(10);
            c10.W0(this.f55964i).writeByte(10);
            c10.W0(this.f55965o).writeByte(10);
            c10.writeByte(10);
            for (C0773c c0773c : this.f55969s.values()) {
                if (c0773c.b() != null) {
                    c10.q0("DIRTY");
            ...
            th = null;
            if (th == null) {
                if (this.C.j(this.f55966p)) {
                    this.C.c(this.f55966p, this.f55968r);
                    this.C.c(this.f55967q, this.f55966p);
                    this.C.h(this.f55968r);
                } else {
                    this.C.c(this.f55967q, this.f55966p);
                }
                this.f55973w = O0();
    ...
    public final synchronized b F0(String str) {
        ...
        x1(str);
        H0();
        C0773c c0773c = (C0773c) this.f55969s.get(str);
        if (c0773c != null) {
            bVar = c0773c.b();
        } else {
            bVar = null;
    ...
    public final synchronized void H0() {
        try {
            ...
            this.C.h(this.f55967q);
            if (this.C.j(this.f55968r)) {
                if (this.C.j(this.f55966p)) {
                    this.C.h(this.f55968r);
                } else {
                    this.C.c(this.f55968r, this.f55966p);
                }
            }
            if (this.C.j(this.f55966p)) {
                try {
    ...
    public synchronized void close() {
        try {
            if (this.f55975y && !this.f55976z) {
                for (C0773c c0773c : (C0773c[]) this.f55969s.values().toArray(new C0773c[0])) {
                    b b10 = c0773c.b();
                    if (b10 != null) {
                        b10.e();
                    }
                ...
                w1();
                kotlinx.coroutines.i.f(this.f55970t, null, 1, null);
                BufferedSink bufferedSink = this.f55973w;
                Intrinsics.checkNotNull(bufferedSink);
                bufferedSink.close();
                this.f55973w = null;
