...
public abstract class e {
    ...
    public static final e f32308d;

    /* renamed from: e  reason: collision with root package name */
    public static final e f32309e;

    /* renamed from: i  reason: collision with root package name */
    public static final e f32310i;

    /* renamed from: o  reason: collision with root package name */
    public static final e f32311o;

    /* renamed from: p  reason: collision with root package name */
    private static final int[] f32312p;

    /* renamed from: q  reason: collision with root package name */
    private static final double[] f32313q;

    /* renamed from: r  reason: collision with root package name */
    private static final double[] f32314r;

    /* renamed from: s  reason: collision with root package name */
    private static final double[][] f32315s;

    /* renamed from: t  reason: collision with root package name */
    private static final /* synthetic */ e[] f32316t;
    ...
    enum a extends e {
        ...
        private double o(double d10) {
            i0 t02 = jt.c.f(d10).h().t0(p.f40787v);
            return t02.V().B0() + (((Integer) t02.X().v(g0.K)).intValue() / 86400.0d);
        }

        private double p(double d10) {
            double d11 = (d10 * 0.9856d) - 3.289d;
            return jt.a.b((Math.sin(Math.toRadians(d11)) * 1.916d) + d11 + (Math.sin(Math.toRadians(d11) * 2.0d) * 0.02d) + 282.634d);
        }
        ...
        public double l(double d10) {
            double p10 = p(o(d10));
            double b10 = jt.a.b(Math.toDegrees(Math.atan(Math.tan(Math.toRadians(p10)) * 0.91764d)));
    ...
    static {
        ...
        f32308d = aVar;
        e eVar = new e("NOAA", 1) { // from class: jt.e.b
            private double o(double d10) {
            ...
            @Override // jt.e
            public double g(double d10) {
                return Math.toDegrees(o(e.m(d10)));
            }
            ...
            public double l(double d10) {
                ...
                return jt.a.b(Math.toDegrees(Math.atan2(Math.cos(Math.toRadians(s(m10))) * Math.sin(radians), Math.cos(radians))));
            }
        };
        f32309e = eVar;
        e eVar2 = new e("CC", 2) { // from class: jt.e.c
            private double o(double d10) {
            ...
            public double h(double d10, String str) {
                ...
                if (str.equals("declination")) {
                    return Math.toDegrees(o(m10));
                }
                if (str.equals("right-ascension")) {
                    double radians = Math.toRadians(e.f(m10, q(m10)));
                    return jt.a.b(Math.toDegrees(Math.atan2(Math.cos(Math.toRadians(r(m10))) * Math.sin(radians), Math.cos(radians))));
        ...
        f32310i = eVar2;
        e eVar3 = new e("TIME4J", 3) { // from class: jt.e.d
            private double o(double d10) {
            ...
            public double h(double d10, String str) {
                ...
                if (str.equals("right-ascension")) {
                    ...
                    return jt.a.b(Math.toDegrees(Math.atan2(Math.cos(Math.toRadians(e.i(m10) + dArr[1])) * Math.sin(radians), Math.cos(radians))));
                } else if (str.equals("nutation")) {
    ...
    public static double f(double d10, double d11) {
        double d12 = 0.0d;
        for (int length = f32312p.length - 1; length >= 0; length--) {
            d12 += f32312p[length] * Math.sin(Math.toRadians(f32313q[length] + (f32314r[length] * d10)));
        }
    ...
    static void k(double d10, double[] dArr) {
        ...
        double d11 = 0.0d;
        double d12 = 0.0d;
        for (int length = f32315s.length - 1; length >= 0; length--) {
            double[] dArr2 = f32315s[length];
