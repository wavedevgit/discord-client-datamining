...
public final class e implements Comparable<e> {
    ...
    private static final e f31338e;

    /* renamed from: i  reason: collision with root package name */
    private static final e f31339i;

    /* renamed from: o  reason: collision with root package name */
    private static final e f31340o;

    /* renamed from: p  reason: collision with root package name */
    private static final e f31341p;

    /* renamed from: d  reason: collision with root package name */
    private final Instant f31342d;
    ...
    static {
        ...
        Intrinsics.checkNotNullExpressionValue(ofEpochSecond, "ofEpochSecond(...)");
        f31338e = new e(ofEpochSecond);
        Instant ofEpochSecond2 = Instant.ofEpochSecond(3093527980800L, 0L);
        Intrinsics.checkNotNullExpressionValue(ofEpochSecond2, "ofEpochSecond(...)");
        f31339i = new e(ofEpochSecond2);
    ...
    public int compareTo(e other) {
        ...
        return this.f31342d.compareTo(other.f31342d);
    }

    public boolean equals(Object obj) {
        if (this != obj) {
            if (!(obj instanceof e) || !Intrinsics.areEqual(this.f31342d, ((e) obj).f31342d)) {
                return false;
            }
            return true;
        }
    ...
    public final long f() {
        return this.f31342d.getEpochSecond();
    }

    public int hashCode() {
        return this.f31342d.hashCode();
    }

    public String toString() {
        String instant = this.f31342d.toString();
