...
public abstract class a {
    ...
    private static final AtomicBoolean f32003a = new AtomicBoolean(false);

    /* renamed from: b  reason: collision with root package name */
    private static final AtomicBoolean f32004b = new AtomicBoolean(false);
    ...
    public static class b implements Runnable {
        ...
        public void run() {
            ...
            try {
                ...
                e eVar = e.FULL;
                Log.i("TIME4A", ot.c.B(eVar, eVar, locale, t10).l(b10));
    ...
    public static void c(Context context, jt.b bVar) {
        if (!f32003a.getAndSet(true)) {
    ...
    public static void d(Context context) {
        if (context != null && !f32004b.getAndSet(true)) {
