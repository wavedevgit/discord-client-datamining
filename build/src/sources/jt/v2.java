...
public final class v2 extends d2 {
    ...
    public byte[] f() {
        byte[] copyOf = Arrays.copyOf(this.f31087a, d());
        Intrinsics.checkNotNullExpressionValue(copyOf, "copyOf(...)");
    ...
    private v2(byte[] bufferWithData) {
        ...
        this.f31087a = bufferWithData;
        this.f31088b = qr.y.l(bufferWithData);
        b(10);
    }
}
