...
public abstract class g {
    ...
    private static final long f31349a = LocalDate.MIN.toEpochDay();

    /* renamed from: b  reason: collision with root package name */
    private static final long f31350b = LocalDate.MAX.toEpochDay();

    private static final LocalDate a(long j10) {
        long j11 = f31349a;
        if (j10 <= f31350b && j11 <= j10) {
    ...
    public static final f c(f fVar, long j10, c.b unit) {
        ...
        Intrinsics.checkNotNullParameter(unit, "unit");
        try {
            if (unit instanceof c.C0437c) {
                plusMonths = a(lt.b.a(fVar.h().toEpochDay(), lt.b.c(j10, ((c.C0437c) unit).d())));
            } else if (unit instanceof c.d) {
                plusMonths = fVar.h().plusMonths(lt.b.c(j10, ((c.d) unit).d()));
            } else {
                throw new p();
            }
