...
public class t0 extends a {
    ...
    private final y f31381e;

    /* renamed from: f  reason: collision with root package name */
    private final char[] f31382f;

    /* renamed from: g  reason: collision with root package name */
    protected int f31383g;

    /* renamed from: h  reason: collision with root package name */
    private final d f31384h;
    ...
    public t0(y reader, char[] buffer) {
        ...
        this.f31381e = reader;
        this.f31382f = buffer;
        this.f31383g = IntBufferBatchMountItem.INSTRUCTION_UPDATE_LAYOUT;
        this.f31384h = new d(buffer);
        U(0);
    }
    ...
    private final void U(int i10) {
        ...
        while (true) {
            ...
            int a10 = this.f31381e.a(b10, i10, length - i10);
            if (a10 == -1) {
                D().f(i10);
                this.f31383g = -1;
                break;
    ...
    @Override // jt.a
    public void u() {
        int length = D().length() - this.f31296a;
        if (length > this.f31383g) {
            return;
        }
        U(length);
    }
