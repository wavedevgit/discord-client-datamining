...
public final class v0 extends t0 {
    ...
    private final Pair W(int i10) {
        ...
        if (charAt != '*') {
            if (charAt != '/') {
                return or.v.a(Integer.valueOf(i10), Boolean.FALSE);
            }
            int i12 = i11;
            while (i10 != -1) {
                ...
                if (h02 == -1) {
                    ...
                    return or.v.a(Integer.valueOf(h02 + 1), Boolean.TRUE);
                }
            }
            return or.v.a(-1, Boolean.TRUE);
        }
        boolean z10 = false;
        int i13 = i11;
        while (i10 != -1) {
            ...
            if (i02 != -1) {
                return or.v.a(Integer.valueOf(i02 + 2), Boolean.TRUE);
            }
