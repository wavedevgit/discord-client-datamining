...
public abstract class t1 {
    ...
    public static final KSerializer d(KClass kClass, KSerializer... args) {
        Intrinsics.checkNotNullParameter(kClass, "<this>");
        Intrinsics.checkNotNullParameter(args, "args");
        return c(ds.a.b(kClass), (KSerializer[]) Arrays.copyOf(args, args.length));
    }
    ...
    */
    private static final kotlinx.serialization.KSerializer h(java.lang.Class r11) {
        ...
        Lae:
            return r1
        */
        throw new UnsupportedOperationException("Method not decompiled: jt.t1.h(java.lang.Class):kotlinx.serialization.KSerializer");
    }

    public static final Map i() {
        Map c10 = kotlin.collections.o0.c();
        c10.put(Reflection.getOrCreateKotlinClass(String.class), gt.a.E(StringCompanionObject.INSTANCE));
        c10.put(Reflection.getOrCreateKotlinClass(Character.TYPE), gt.a.y(CharCompanionObject.INSTANCE));
        c10.put(Reflection.getOrCreateKotlinClass(char[].class), gt.a.d());
        c10.put(Reflection.getOrCreateKotlinClass(Double.TYPE), gt.a.z(DoubleCompanionObject.INSTANCE));
        c10.put(Reflection.getOrCreateKotlinClass(double[].class), gt.a.e());
        c10.put(Reflection.getOrCreateKotlinClass(Float.TYPE), gt.a.A(FloatCompanionObject.INSTANCE));
        ...
        try {
            c10.put(Reflection.getOrCreateKotlinClass(qr.c0.class), gt.a.s());
        } catch (ClassNotFoundException | NoClassDefFoundError unused2) {
        }
        try {
            c10.put(Reflection.getOrCreateKotlinClass(qr.a0.class), gt.a.r());
        } catch (ClassNotFoundException | NoClassDefFoundError unused3) {
        }
        try {
            c10.put(Reflection.getOrCreateKotlinClass(qr.f0.class), gt.a.t());
        } catch (ClassNotFoundException | NoClassDefFoundError unused4) {
        }
        try {
            c10.put(Reflection.getOrCreateKotlinClass(qr.y.class), gt.a.q());
    ...
    public static final boolean l(KClass kClass) {
        Intrinsics.checkNotNullParameter(kClass, "<this>");
        return ds.a.b(kClass).isInterface();
    }

    private static final boolean m(Class cls) {
        if (cls.getAnnotation(ft.m.class) == null && cls.getAnnotation(ft.d.class) == null) {
            return true;
        }
        return false;
    }
    ...
    private static final boolean n(Class cls) {
        if (cls.getAnnotation(ft.d.class) != null) {
            return true;
        }
        ft.m mVar = (ft.m) cls.getAnnotation(ft.m.class);
        if (mVar != null && Intrinsics.areEqual(Reflection.getOrCreateKotlinClass(mVar.with()), Reflection.getOrCreateKotlinClass(ft.g.class))) {
            return true;
        }
        return false;
    }
    ...
    public static final boolean o(KClass rootClass) {
        ...
        return ds.a.b(rootClass).isArray();
    }
    ...
    public static final Void q(Class cls) {
        Intrinsics.checkNotNullParameter(cls, "<this>");
        throw new ft.n(u1.e(ds.a.e(cls)));
    }

    public static final Object[] r(ArrayList arrayList, KClass eClass) {
        Intrinsics.checkNotNullParameter(arrayList, "<this>");
        Intrinsics.checkNotNullParameter(eClass, "eClass");
        Object newInstance = Array.newInstance(ds.a.b(eClass), arrayList.size());
