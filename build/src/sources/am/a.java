    ...
    public a(ExifInterface exifInterface) {
        ...
        if (attribute != null && attribute2 != null && attribute3 != null && attribute4 != null) {
            if (attribute2.equals("N")) {
                this.f760a = a(attribute);
            } else {
                this.f760a = Float.valueOf(0.0f - a(attribute).floatValue());
            }
            if (attribute4.equals("E")) {
                this.f761b = a(attribute3);
            } else {
                this.f761b = Float.valueOf(0.0f - a(attribute3).floatValue());
            }
        }
    }
