...
public final class d extends BaseReactPackage implements ViewManagerOnDemandReactPackage {
    ...
    private final Lazy f37124a = l.b(new Function0() { // from class: mn.a
    ...
    private final Map d() {
        return (Map) this.f37124a.getValue();
    }

    /* JADX INFO: Access modifiers changed from: private */
    public static final Map e() {
        return o0.f(v.a(RNGestureHandlerButtonViewManager.REACT_CLASS, ModuleSpec.Companion.viewManagerSpec(new Provider() { // from class: mn.c
    ...
    public ReactModuleInfoProvider getReactModuleInfoProvider() {
        try {
            ...
            return new ReactModuleInfoProvider() { // from class: mn.b
