...
public interface b {
    ...
    Object a(@s("inquiryId") @NotNull String str, @i("Authorization") @NotNull String str2, @nv.a @NotNull OneTimeLinkCodeForPersonasRequest oneTimeLinkCodeForPersonasRequest, @NotNull Continuation<? super z<OneTimeLinkCodeResponse>> continuation);
    ...
    Object d(@i("Authorization") @NotNull String str, @nv.a @NotNull AddressAutocompleteRequest addressAutocompleteRequest, @NotNull Continuation<? super z<AddressAutocompleteResponse>> continuation);
}
