...
public final class c0 implements Collection, KMappedMarker {
    ...
    public static final class a implements Iterator, KMappedMarker {
        ...
        public long a() {
            int i10 = this.f6058e;
            long[] jArr = this.f6057d;
            if (i10 < jArr.length) {
                this.f6058e = i10 + 1;
                return b0.d(jArr[i10]);
            }
            throw new NoSuchElementException(String.valueOf(this.f6058e));
        }

        @Override // java.util.Iterator
        public boolean hasNext() {
            if (this.f6058e < this.f6057d.length) {
                return true;
            }
            return false;
        }
    ...
    */
    public static boolean g(long[] r4, java.util.Collection r5) {
        ...
        L16:
            ...
            boolean r2 = r0 instanceof as.b0
            if (r2 == 0) goto L31
            as.b0 r0 = (as.b0) r0
            long r2 = r0.h()
        ...
        L33:
            return r1
        */
        throw new UnsupportedOperationException("Method not decompiled: as.c0.g(long[], java.util.Collection):boolean");
    }

    public static boolean i(long[] jArr, Object obj) {
        if (!(obj instanceof c0) || !Intrinsics.areEqual(jArr, ((c0) obj).t())) {
            return false;
        }
        return true;
    }
    ...
    public boolean containsAll(Collection elements) {
        ...
        return g(this.f6056d, elements);
    }

    public boolean e(long j10) {
        return f(this.f6056d, j10);
    }

    @Override // java.util.Collection
    public boolean equals(Object obj) {
        return i(this.f6056d, obj);
    }

    @Override // java.util.Collection
    public int hashCode() {
        return o(this.f6056d);
    }

    @Override // java.util.Collection
    public boolean isEmpty() {
        return p(this.f6056d);
    }

    @Override // java.util.Collection, java.lang.Iterable
    public Iterator iterator() {
        return q(this.f6056d);
    }

    @Override // java.util.Collection
    /* renamed from: k */
    public int size() {
        return l(this.f6056d);
    }
