...
public final class f0 implements Collection, KMappedMarker {
    ...
    public static final class a implements Iterator, KMappedMarker {
        ...
        public short a() {
            int i10 = this.f6069e;
            short[] sArr = this.f6068d;
            if (i10 < sArr.length) {
                this.f6069e = i10 + 1;
                return e0.d(sArr[i10]);
            }
            throw new NoSuchElementException(String.valueOf(this.f6069e));
        }

        @Override // java.util.Iterator
        public boolean hasNext() {
            if (this.f6069e < this.f6068d.length) {
                return true;
            }
            return false;
        }
    ...
    */
    public static boolean g(short[] r3, java.util.Collection r4) {
        ...
        L16:
            ...
            boolean r2 = r0 instanceof as.e0
            if (r2 == 0) goto L31
            as.e0 r0 = (as.e0) r0
            short r0 = r0.h()
        ...
        L33:
            return r1
        */
        throw new UnsupportedOperationException("Method not decompiled: as.f0.g(short[], java.util.Collection):boolean");
    }
    ...
    public boolean containsAll(Collection elements) {
        ...
        return g(this.f6067d, elements);
    }

    public boolean e(short s10) {
        return f(this.f6067d, s10);
    }

    @Override // java.util.Collection
    public boolean equals(Object obj) {
        return i(this.f6067d, obj);
    }

    @Override // java.util.Collection
    public int hashCode() {
        return o(this.f6067d);
    }

    @Override // java.util.Collection
    public boolean isEmpty() {
        return p(this.f6067d);
    }

    @Override // java.util.Collection, java.lang.Iterable
    public Iterator iterator() {
        return q(this.f6067d);
    }

    @Override // java.util.Collection
    /* renamed from: k */
    public int size() {
        return l(this.f6067d);
    }
