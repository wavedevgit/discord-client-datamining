...
public final class y implements Collection, KMappedMarker {
    ...
    public static final class a implements Iterator, KMappedMarker {
        ...
        public byte a() {
            ...
            throw new NoSuchElementException(String.valueOf(this.f6101e));
        }

        @Override // java.util.Iterator
        public boolean hasNext() {
            if (this.f6101e < this.f6100d.length) {
                return true;
            }
            return false;
        }
    ...
    */
    public static boolean g(byte[] r3, java.util.Collection r4) {
        ...
        L33:
            return r1
        */
        throw new UnsupportedOperationException("Method not decompiled: as.y.g(byte[], java.util.Collection):boolean");
    }
    ...
    public boolean containsAll(Collection elements) {
        ...
        return g(this.f6099d, elements);
    }

    public boolean e(byte b10) {
        return f(this.f6099d, b10);
    }

    @Override // java.util.Collection
    public boolean equals(Object obj) {
        return i(this.f6099d, obj);
    }

    @Override // java.util.Collection
    public int hashCode() {
        return o(this.f6099d);
    }

    @Override // java.util.Collection
    public boolean isEmpty() {
        return p(this.f6099d);
    }

    @Override // java.util.Collection, java.lang.Iterable
    public Iterator iterator() {
        return q(this.f6099d);
    }

    @Override // java.util.Collection
    /* renamed from: k */
    public int size() {
        return l(this.f6099d);
    }
