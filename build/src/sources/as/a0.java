...
public final class a0 implements Collection, KMappedMarker {
    ...
    public static final class a implements Iterator, KMappedMarker {
        ...
        public int a() {
            ...
            throw new NoSuchElementException(String.valueOf(this.f6053e));
        }

        @Override // java.util.Iterator
        public boolean hasNext() {
            if (this.f6053e < this.f6052d.length) {
                return true;
            }
            return false;
        }
    ...
    */
    public static boolean g(int[] r3, java.util.Collection r4) {
        ...
        L33:
            return r1
        */
        throw new UnsupportedOperationException("Method not decompiled: as.a0.g(int[], java.util.Collection):boolean");
    }
    ...
    public boolean containsAll(Collection elements) {
        ...
        return g(this.f6051d, elements);
    }

    public boolean e(int i10) {
        return f(this.f6051d, i10);
    }

    @Override // java.util.Collection
    public boolean equals(Object obj) {
        return i(this.f6051d, obj);
    }

    @Override // java.util.Collection
    public int hashCode() {
        return o(this.f6051d);
    }

    @Override // java.util.Collection
    public boolean isEmpty() {
        return p(this.f6051d);
    }
