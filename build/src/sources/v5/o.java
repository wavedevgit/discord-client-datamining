...
public class o implements n0 {
            ...
            for (int i12 = 1; i12 < fArr.length; i12++) {
                ...
                if (i13 >= 0 || i12 == fArr.length - 1) {
                    if (i13 <= 0) {
                        ...
                        int i14 = i12 - 1;
                        float f12 = fArr[i14];
                        i11 = x5.i.i(fArr2[i14], fArr2[i12], (f10 - f12) / (f11 - f12));
                    }
            ...
            for (int i10 = 1; i10 < fArr.length; i10++) {
                ...
                if (f12 >= f10 || i10 == fArr.length - 1) {
                    if (i10 == fArr.length - 1 && f10 >= f12) {
                        ...
                        int i11 = i10 - 1;
                        float f13 = fArr[i11];
                        int c10 = x5.b.c((f10 - f13) / (f12 - f13), iArr[i11], iArr[i10]);
    ...
    public s5.d a(w5.c cVar, float f10) {
        ...
        if (this.f50700a == -1) {
            this.f50700a = arrayList.size() / 4;
        }
        int i10 = this.f50700a;
        float[] fArr = new float[i10];
        int[] iArr = new int[i10];
        int i11 = 0;
        int i12 = 0;
        for (int i13 = 0; i13 < this.f50700a * 4; i13++) {
            int i14 = i13 / 4;
        ...
        return b(new s5.d(fArr, iArr), arrayList);
    }
}
