...
abstract class u {
    ...
    public static void b(List list) {
        ...
        while (true) {
            ...
            aVar.f53746h = Float.valueOf(aVar2.f53745g);
            if (aVar.f53741c == null && (obj = aVar2.f53740b) != null) {
                aVar.f53741c = obj;
        ...
        if ((aVar3.f53740b == null || aVar3.f53741c == null) && list.size() > 1) {
            list.remove(aVar3);
        }
    }
}
