...
abstract class u {
    ...
    public static void b(List list) {
        ...
        while (true) {
            ...
            aVar.f53749h = Float.valueOf(aVar2.f53748g);
            if (aVar.f53744c == null && (obj = aVar2.f53743b) != null) {
                aVar.f53744c = obj;
        ...
        if ((aVar3.f53743b == null || aVar3.f53744c == null) && list.size() > 1) {
            list.remove(aVar3);
        }
    }
}
