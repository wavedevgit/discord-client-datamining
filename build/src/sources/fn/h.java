...
public final class h implements f.a {
    ...
    private final CoroutineContext f23893b;

    /* renamed from: c  reason: collision with root package name */
    private final Function1 f23894c;

    /* renamed from: d  reason: collision with root package name */
    private final t.c f23895d;

    /* renamed from: e  reason: collision with root package name */
    private final t f23896e;

    /* renamed from: f  reason: collision with root package name */
    private final d f23897f;

    /* renamed from: g  reason: collision with root package name */
    private fn.a f23898g;
    ...
    public /* synthetic */ class a extends FunctionReferenceImpl implements Function1 {
        ...
        /* renamed from: d  reason: collision with root package name */
        final /* synthetic */ Ref.ObjectRef f23899d;

        /* renamed from: e  reason: collision with root package name */
        final /* synthetic */ h f23900e;
        ...
        a(Ref.ObjectRef objectRef, h hVar) {
            ...
            this.f23899d = objectRef;
            this.f23900e = hVar;
        }

        @Override // kotlin.jvm.functions.Function1
        public final Object invoke(Object obj) {
            return h.e(this.f23899d, this.f23900e, obj);
        }
    }
    ...
    public h(Map map, CoroutineContext contextForChildren, Function1 emitActionToParent, t.c cVar, t interceptor, d dVar) {
        ...
        this.f23892a = map;
        this.f23893b = contextForChildren;
        this.f23894c = emitActionToParent;
        this.f23895d = cVar;
        this.f23896e = interceptor;
        this.f23897f = dVar;
        this.f23898g = new fn.a();
    }
    ...
    private final i d(q qVar, Object obj, String str, Function1 function1) {
        ...
        Map map = this.f23892a;
        if (map == null) {
            mVar = null;
        } else {
            mVar = (en.m) map.get(a10);
        }
        ?? iVar = new i(qVar, function1, new j(a10, qVar.b(), obj, mVar, this.f23893b, new a(objectRef, this), this.f23895d, this.f23896e, this.f23897f));
    ...
    public static final Object e(Ref.ObjectRef objectRef, h hVar, Object obj) {
        ...
        return hVar.f23894c.invoke(iVar.c(obj));
    }
