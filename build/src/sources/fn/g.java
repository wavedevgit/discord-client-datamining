...
public final class g implements Parcelable {
    ...
    private final SparseArray f23367e;
    ...
    public boolean equals(Object obj) {
        ...
        g gVar = (g) obj;
        if (Intrinsics.areEqual(this.f23366d, gVar.f23366d) && Intrinsics.areEqual(this.f23367e, gVar.f23367e)) {
            return true;
        }
        return false;
    }
    ...
    public int hashCode() {
        return (this.f23366d.hashCode() * 31) + this.f23367e.hashCode();
    }

    public String toString() {
        return "ViewStateFrame(key=" + this.f23366d + ", viewState=" + this.f23367e + ')';
    }
    ...
    public void writeToParcel(Parcel parcel, int i10) {
        ...
        parcel.writeSparseArray(this.f23367e);
    }
}
