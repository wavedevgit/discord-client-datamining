...
public final class f {
    ...
    private u3.f f22756b;

    /* renamed from: c  reason: collision with root package name */
    private String f22757c;

    /* renamed from: d  reason: collision with root package name */
    private final Map f22758d = new LinkedHashMap();

    /* renamed from: e  reason: collision with root package name */
    private final a f22759e = new a();
    ...
    public final void k(Bundle bundle) {
        ...
        if (this.f22755a == null) {
            ...
            for (fn.a aVar : this.f22758d.values()) {
                if (aVar.getLifecycle().b() == Lifecycle.State.f4544e) {
                    l(aVar);
                }
            }
            return;
    ...
    private final void l(fn.a aVar) {
        Map map = this.f22755a;
        if (map == null) {
            return;
        }
    ...
    private final void n(fn.a aVar) {
        Map map = this.f22755a;
        if (map == null) {
            return;
        }
    ...
    public final void f(String key, u3.f parentOwner) {
        ...
        try {
            savedStateRegistry.c(key, new SavedStateRegistry.b() { // from class: fn.e
    ...
    public final void h(View view, String key) {
        ...
        if (a10 != null) {
            fn.a aVar = new fn.a(key, a10);
            if (((fn.a) this.f22758d.put(key, aVar)) == null) {
                u3.f a11 = j.a(view);
                if (a11 == null) {
                    j.b(view, aVar);
                    l(aVar);
    ...
    public final void j(Collection keysToKeep) {
        ...
        for (String str : x0.j(this.f22758d.keySet(), collection)) {
            this.f22758d.remove(str);
        }
        Map map = this.f22755a;
        if (map == null) {
            return;
    ...
    public final void m(String key) {
        Unit unit;
        Intrinsics.checkNotNullParameter(key, "key");
        fn.a aVar = (fn.a) this.f22758d.remove(key);
        if (aVar == null) {
            unit = null;
        } else {
            n(aVar);
