...
public final class m extends d {
    ...
    private Handler O;
    private Runnable P = new Runnable() { // from class: fn.l
    ...
    public static final class b extends d.c {
        ...
        private final Class f24166b = m.class;

        /* renamed from: c  reason: collision with root package name */
        private final String f24167c = "HoverGestureHandler";
        ...
        @Override // fn.d.c
        /* renamed from: h */
        public gn.c c(m handler) {
            Intrinsics.checkNotNullParameter(handler, "handler");
            return new gn.c(handler);
        }
    }
