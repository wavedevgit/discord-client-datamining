...
public final class c extends g {
    ...
    public static final b f23154q = new b(null);

    /* renamed from: p  reason: collision with root package name */
    private final int f23155p;

    /* loaded from: /home/runner/work/discord-client-datamining/discord-client-datamining/build/classes4.dex */
    public static final class b implements c0 {

        /* renamed from: a  reason: collision with root package name */
        private final /* synthetic */ a f23159a;
        ...
        public View a(d initialRendering, a0 initialViewEnvironment, Context contextForNewView, ViewGroup viewGroup) {
            ...
            return this.f23159a.a(initialRendering, initialViewEnvironment, contextForNewView, viewGroup);
        }

        @Override // bn.c0
        public KClass getType() {
            return this.f23159a.getType();
        }

        private b() {
            this.f23159a = new a(0, 1, null);
        }
    }
    ...
    private final int h(e.a aVar) {
        int i10 = C0316c.f23160a[aVar.ordinal()];
        if (i10 != 1) {
            if (i10 != 2) {
                if (i10 == 3) {
                    return -3;
    ...
    public static final void i(e rendering, DialogInterface dialogInterface) {
        ...
        rendering.d().invoke(e.b.C0317b.f23173a);
    }
    ...
    protected void d(g.a dialogRef) {
        ...
        int i10 = 0;
        if (eVar.b()) {
            aVar.setOnCancelListener(new DialogInterface.OnCancelListener() { // from class: fn.a
        ...
        while (i10 < length) {
            ...
            if (str == null) {
                ...
                aVar.n(h(aVar2), str, new DialogInterface.OnClickListener() { // from class: fn.b
    ...
    public g.a b(e initialModalRendering, a0 initialViewEnvironment) {
        ...
        Intrinsics.checkNotNullParameter(initialViewEnvironment, "initialViewEnvironment");
        androidx.appcompat.app.a create = new a.C0018a(getContext(), this.f23155p).create();
    ...
    public static final class a implements c0 {
        ...
        private final /* synthetic */ bn.f f23157b;

        /* renamed from: fn.c$a$a  reason: collision with other inner class name */
        /* loaded from: /home/runner/work/discord-client-datamining/discord-client-datamining/build/classes4.dex */
        static final class C0314a extends Lambda implements Function4 {
            ...
            /* loaded from: /home/runner/work/discord-client-datamining/discord-client-datamining/build/classes4.dex */
            public /* synthetic */ class C0315a extends FunctionReferenceImpl implements Function2 {
                C0315a(Object obj) {
            ...
            public final View invoke(d initialRendering, a0 initialEnv, Context context, ViewGroup viewGroup) {
                ...
                Intrinsics.checkNotNullParameter(context, "context");
                c cVar = new c(context, null, 0, 0, this.f23158d, 14, null);
                cVar.setId(en.a.f21652b);
                cVar.setLayoutParams(new ViewGroup.LayoutParams(-1, -1));
                g0.a(cVar, initialRendering, initialEnv, new C0315a(cVar));
                return cVar;
            }
        }
        ...
        public a(int i10) {
            this.f23156a = i10;
            this.f23157b = new bn.f(Reflection.getOrCreateKotlinClass(d.class), new C0314a(i10));
        }
        ...
        public View a(d initialRendering, a0 initialViewEnvironment, Context contextForNewView, ViewGroup viewGroup) {
            ...
            Intrinsics.checkNotNullParameter(initialViewEnvironment, "initialViewEnvironment");
            Intrinsics.checkNotNullParameter(contextForNewView, "contextForNewView");
            return this.f23157b.a(initialRendering, initialViewEnvironment, contextForNewView, viewGroup);
        }

        @Override // bn.c0
        public KClass getType() {
            return this.f23157b.getType();
        }
