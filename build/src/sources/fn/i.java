...
public final class i {
    ...
    public static final a f24144n = new a(null);

    /* renamed from: o  reason: collision with root package name */
    private static final PointF f24145o = new PointF();

    /* renamed from: p  reason: collision with root package name */
    private static final float[] f24146p = new float[2];

    /* renamed from: q  reason: collision with root package name */
    private static final Matrix f24147q = new Matrix();

    /* renamed from: r  reason: collision with root package name */
    private static final float[] f24148r = new float[2];

    /* renamed from: s  reason: collision with root package name */
    private static final Comparator f24149s = new Comparator() { // from class: fn.f
    ...
    private final ViewGroup f24150a;

    /* renamed from: b  reason: collision with root package name */
    private final j f24151b;

    /* renamed from: c  reason: collision with root package name */
    private final d0 f24152c;

    /* renamed from: d  reason: collision with root package name */
    private final ViewGroup f24153d;

    /* renamed from: e  reason: collision with root package name */
    private float f24154e;

    /* renamed from: f  reason: collision with root package name */
    private final ArrayList f24155f;

    /* renamed from: g  reason: collision with root package name */
    private final ArrayList f24156g;

    /* renamed from: h  reason: collision with root package name */
    private final ArrayList f24157h;

    /* renamed from: i  reason: collision with root package name */
    private final HashSet f24158i;
    ...
    public static final class a {
        ...
        public final void n(float f10, float f11, ViewGroup viewGroup, View view, PointF pointF) {
            ...
            if (!matrix.isIdentity()) {
                float[] fArr = i.f24146p;
                fArr[0] = scrollX;
                fArr[1] = scrollY;
                matrix.invert(i.f24147q);
                i.f24147q.mapPoints(fArr);
                float f12 = fArr[0];
                scrollY = fArr[1];
                scrollX = f12;
            }
    ...
    public /* synthetic */ class b {
        ...
        static {
            ...
            try {
                iArr[v.f24209d.ordinal()] = 1;
            } catch (NoSuchFieldError unused) {
            }
            try {
                iArr[v.f24211i.ordinal()] = 2;
            } catch (NoSuchFieldError unused2) {
            }
            try {
                iArr[v.f24210e.ordinal()] = 3;
            } catch (NoSuchFieldError unused3) {
            }
            try {
                iArr[v.f24212o.ordinal()] = 4;
    ...
    public i(ViewGroup wrapperView, j handlerRegistry, d0 viewConfigHelper, ViewGroup rootView) {
        ...
        this.f24150a = wrapperView;
        this.f24151b = handlerRegistry;
        this.f24152c = viewConfigHelper;
        this.f24153d = rootView;
        this.f24155f = new ArrayList();
    ...
    private final void C(d dVar, View view) {
        if (this.f24155f.contains(dVar)) {
            return;
        }
        this.f24155f.add(dVar);
        dVar.w0(false);
        dVar.x0(false);
    ...
    private final boolean D(View view, float[] fArr, int i10, MotionEvent motionEvent) {
        boolean z10;
        ArrayList a10 = this.f24151b.a(view);
        if (a10 != null) {
            synchronized (a10) {
                try {
    ...
    private final void E() {
        if (!this.f24159j && this.f24160k == 0) {
            l();
        } else {
            this.f24161l = true;
        }
    ...
    private final boolean G(d dVar) {
        ArrayList<d> arrayList = this.f24155f;
        if (arrayList != null && arrayList.isEmpty()) {
            return false;
        }
        for (d dVar2 : arrayList) {
            if (dVar.Y(dVar2) && dVar2.S() == 4 && !f24144n.h(dVar, dVar2) && dVar.c0(dVar2)) {
                return true;
            }
        }
        return false;
    ...
    private final boolean H(d dVar) {
        ...
        for (d dVar2 : arrayList) {
            if (f24144n.l(dVar, dVar2) && dVar2.S() == 5) {
                return true;
            }
        }
        return false;
    ...
    private final boolean J(View view) {
        if ((view instanceof RNGestureHandlerRootView) && !Intrinsics.areEqual(view, this.f24150a) && ((RNGestureHandlerRootView) view).isRootViewEnabled()) {
            return true;
        }
        return false;
    }
    ...
    private final boolean M(View view, float[] fArr, int i10, MotionEvent motionEvent) {
        ...
        int i11 = b.f24163a[this.f24152c.a(view).ordinal()];
        if (i11 == 1) {
            return false;
        }
        if (i11 != 2) {
            if (i11 != 3) {
                if (i11 == 4) {
                    ...
                    if (!D(view, fArr, i10, motionEvent) && !z10 && !f24144n.m(view, fArr)) {
                        return false;
                    }
                    return true;
                }
        ...
        } else if (!D(view, fArr, i10, motionEvent) && !f24144n.m(view, fArr)) {
            return false;
        } else {
            return true;
        }
    ...
    private final void h(d dVar) {
        if (this.f24156g.contains(dVar)) {
            return;
        }
        this.f24156g.add(dVar);
        this.f24158i.add(Integer.valueOf(dVar.T()));
        dVar.x0(true);
    ...
    private final boolean i(View view) {
        if (view.getVisibility() == 0 && view.getAlpha() >= this.f24154e) {
            return true;
        }
        return false;
    }
    ...
    private final void j() {
        for (d dVar : CollectionsKt.h1(CollectionsKt.T(this.f24156g))) {
            dVar.q();
        }
        for (d dVar2 : CollectionsKt.T(this.f24155f)) {
            dVar2.q();
        }
    }

    private final void k() {
        for (d dVar : CollectionsKt.h1(this.f24156g)) {
            if (!dVar.a0()) {
                this.f24156g.remove(dVar);
                this.f24158i.remove(Integer.valueOf(dVar.T()));
            }
        }
    }

    private final void l() {
        for (d dVar : CollectionsKt.T(this.f24155f)) {
            if (f24144n.i(dVar.S()) && !dVar.a0()) {
                dVar.r0();
                dVar.w0(false);
                dVar.x0(false);
                dVar.v0(Integer.MAX_VALUE);
        ...
        CollectionsKt.J(this.f24155f, new Function1() { // from class: fn.g
    ...
    private final void o(MotionEvent motionEvent) {
        List<d> j12 = CollectionsKt.j1(this.f24155f);
        CollectionsKt.A(j12, f24149s);
        for (d dVar : j12) {
            n(dVar, motionEvent);
        }
    }
    ...
    private final boolean p(View view, float[] fArr, int i10) {
        ...
        for (ViewParent parent = view.getParent(); parent != null; parent = parent.getParent()) {
            if (parent instanceof ViewGroup) {
                ...
                ArrayList a10 = this.f24151b.a((View) parent);
                if (a10 != null) {
                    synchronized (a10) {
                        try {
                            Iterator it = a10.iterator();
    ...
    private final void q(MotionEvent motionEvent) {
        ...
        M(this.f24150a, fArr, pointerId, motionEvent);
        r(this.f24150a, fArr, pointerId, motionEvent);
    }
    ...
    private final boolean r(ViewGroup viewGroup, float[] fArr, int i10, MotionEvent motionEvent) {
        ...
        while (-1 < childCount) {
            View c10 = this.f24152c.c(viewGroup, childCount);
            if (i(c10)) {
                PointF pointF = f24145o;
                a aVar = f24144n;
    ...
    private final boolean w(View view) {
        if ((view instanceof ViewGroup) && !this.f24152c.b((ViewGroup) view)) {
            return false;
        }
        return true;
    }
    ...
    private final boolean x(View view) {
        ...
        if (view == this.f24150a) {
            return true;
        }
        ViewParent parent = view.getParent();
        while (parent != null && parent != this.f24150a) {
            parent = parent.getParent();
        }
        if (parent != this.f24150a) {
            return false;
        }
        return true;
    }
    ...
    private final void z(d dVar) {
        ...
        dVar.v0(i10);
        for (d dVar2 : CollectionsKt.T(this.f24155f)) {
            if (f24144n.k(dVar2, dVar)) {
                dVar2.q();
            }
        }
        for (d dVar3 : CollectionsKt.T(this.f24156g)) {
            if (f24144n.k(dVar3, dVar)) {
                dVar3.x0(false);
            }
        }
        k();
    ...
    public final void A(d handler, int i10, int i11) {
        ...
        if (f24144n.i(i10)) {
            for (d dVar : CollectionsKt.h1(this.f24156g)) {
                if (f24144n.l(dVar, handler) && this.f24158i.contains(Integer.valueOf(dVar.T()))) {
                    if (i10 == 5) {
                        dVar.q();
                        if (dVar.S() == 5) {
                            dVar.w(3, 2);
    ...
    */
    public final boolean B(android.view.MotionEvent r5) {
        ...
        L30:
            ...
            goto L4d
        L39:
            java.util.ArrayList r1 = r4.f24155f
            boolean r1 = r1.isEmpty()
            if (r1 == 0) goto L4d
            android.view.ViewGroup r1 = r4.f24153d
        ...
        L4d:
            return r0
        */
        throw new UnsupportedOperationException("Method not decompiled: fn.i.B(android.view.MotionEvent):boolean");
    }
    ...
    public final MotionEvent K(View view, MotionEvent event) {
        ...
        if (view != null) {
            ...
            if (!Intrinsics.areEqual(viewGroup, this.f24150a)) {
                K(viewGroup, event);
            }
            if (viewGroup != null) {
    ...
    public final void f(View view) {
        ...
        ArrayList<d> a10 = this.f24151b.a(view);
        if (a10 != null) {
            for (final d dVar : a10) {
                if (dVar instanceof q) {
                    C(dVar, view);
                    dVar.T0(new Function0() { // from class: fn.h
