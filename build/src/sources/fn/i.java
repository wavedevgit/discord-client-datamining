...
public final class i {
    ...
    public final void e(float f10, boolean z10, boolean z11) {
        ...
        short a10 = w.f19376s.a(l10);
        EventDispatcher f11 = f();
        if (f11 != null) {
            f11.dispatchEvent(new j(g(), this.f25275a.getId(), l10, z10, z11, a10));
        }
    }

    public final EventDispatcher f() {
        return this.f25275a.getReactEventDispatcher();
    }

    public final int g() {
        return UIManagerHelper.getSurfaceId(this.f25275a);
    }
}
