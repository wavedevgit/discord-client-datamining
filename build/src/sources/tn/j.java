...
public final class j implements e {
    ...
    private final byte[] f50865a = new byte[PeerConnection.PORTALLOCATOR_ENABLE_ANY_ADDRESS_PORTS];

    /* renamed from: b  reason: collision with root package name */
    private final Size f50866b = new Size(0, 0);
    ...
    private final i0 b(ByteBuffer byteBuffer, int i10, int i11, Rect rect) {
        ...
        for (int i13 = rect.top; i13 < i12; i13++) {
            ...
            byteBuffer.get(this.f50865a, 0, width2);
            for (int i14 = 0; i14 < width2; i14++) {
                int i15 = this.f50865a[i14] & 255;
                j10 += i15;
                jArr[i15] = jArr[i15] + 1;
            }
        }
    ...
    private final double e(ByteBuffer byteBuffer, int i10, int i11, Rect rect) {
        ...
        for (int i13 = rect.top; i13 < i12; i13++) {
            ...
            byteBuffer.get(this.f50865a, 0, width2);
            for (int i14 = 0; i14 < width2; i14++) {
                int i15 = (this.f50865a[i14] & 255) - i11;
                j10 += i15 * i15;
            }
        }
