...
public final class c {
    ...
    private final e f48022a;

    /* renamed from: b  reason: collision with root package name */
    private final CoroutineScope f48023b;
    ...
    public static final class a extends k implements Function2 {
        ...
        public final Continuation create(Object obj, Continuation continuation) {
            return new a(this.f48027i, continuation);
        }
        ...
        public final Object invokeSuspend(Object obj) {
            ...
            if (i10 != 0) {
                ...
                kotlin.c.b(obj);
                MutableSharedFlow a10 = c.this.f48022a.a();
                oo.b bVar = this.f48027i;
                this.f48025d = 1;
    ...
    public c(e externalInquiryController) {
        ...
        this.f48022a = externalInquiryController;
        this.f48023b = kotlinx.coroutines.i.a(m0.a().V0(j1.b(null, 1, null)));
    }

    public final void b(oo.b inquiryEvent) {
        Intrinsics.checkNotNullParameter(inquiryEvent, "inquiryEvent");
        js.i.d(this.f48023b, null, null, new a(inquiryEvent, null), 3, null);
    }

    public final void c(i page) {
        Intrinsics.checkNotNullParameter(page, "page");
        if (Intrinsics.areEqual(this.f48024c, page)) {
            return;
        }
        this.f48024c = page;
