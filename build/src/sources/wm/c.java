...
public abstract class c {
    ...
    public static final int b(ThemedReactContext themedReactContext) {
        ...
        Pair pair = (Pair) f53873a.get(a10);
        if (pair == null) {
