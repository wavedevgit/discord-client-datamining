...
public final class i implements c0 {
    ...
    private final KClass f52323a;

    /* renamed from: b  reason: collision with root package name */
    private final Function2 f52324b;

    /* renamed from: c  reason: collision with root package name */
    private final h0 f52325c;

    /* renamed from: d  reason: collision with root package name */
    private final Function4 f52326d;
    ...
    public static final class a extends Lambda implements Function4 {
        ...
        /* renamed from: d  reason: collision with root package name */
        final /* synthetic */ Function1 f52327d;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        a(Function1 function1) {
            super(4);
            this.f52327d = function1;
        }
        ...
        public final void a(View noName_0, Function2 innerShowRendering, Object outerRendering, a0 viewEnvironment) {
            ...
            innerShowRendering.invoke(this.f52327d.invoke(outerRendering), viewEnvironment);
        }
    ...
    static final class b extends Lambda implements Function2 {
        ...
        /* renamed from: d  reason: collision with root package name */
        final /* synthetic */ Function1 f52328d;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        b(Function1 function1) {
            super(2);
            this.f52328d = function1;
        }
        ...
        public final Pair invoke(Object outer, a0 viewEnvironment) {
            ...
            Intrinsics.checkNotNullParameter(viewEnvironment, "viewEnvironment");
            return new Pair(this.f52328d.invoke(outer), viewEnvironment);
        }
    }
    ...
    public static final class c extends Lambda implements Function2 {
        ...
        final /* synthetic */ View f52330e;

        /* renamed from: i  reason: collision with root package name */
        final /* synthetic */ Function2 f52331i;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        c(View view, Function2 function2) {
            super(2);
            this.f52330e = view;
            this.f52331i = function2;
        }

        public final void a(Object rendering, a0 env) {
            Intrinsics.checkNotNullParameter(rendering, "rendering");
            Intrinsics.checkNotNullParameter(env, "env");
            i.this.f52326d.invoke(this.f52330e, this.f52331i, rendering, env);
        }
    ...
    public View a(Object initialRendering, a0 initialViewEnvironment, Context contextForNewView, ViewGroup viewGroup) {
        ...
        Pair pair = (Pair) this.f52324b.invoke(initialRendering, initialViewEnvironment);
        Object a10 = pair.a();
        a0 a0Var = (a0) pair.b();
        View c10 = f0.c((e0) a0Var.a(e0.f52313a), a10, a0Var, contextForNewView, viewGroup, this.f52325c);
