...
public abstract class d0 {
    ...
    public static final class a extends Lambda implements Function0 {
        ...
        final /* synthetic */ c f52310d;

        /* renamed from: e  reason: collision with root package name */
        final /* synthetic */ CoroutineContext f52311e;

        /* renamed from: i  reason: collision with root package name */
        final /* synthetic */ Function2 f52312i;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        a(c cVar, CoroutineContext coroutineContext, Function2 function2) {
            super(0);
            this.f52310d = cVar;
            this.f52311e = coroutineContext;
            this.f52312i = function2;
        }
        ...
        public final void m1234invoke() {
            hs.g.c(this.f52310d.b(), this.f52311e, hs.c0.f27910o, this.f52312i);
        }
    }

    private static final c a(View view) {
        c cVar;
        Object tag = view.getTag(q.f52373b);
        c cVar2 = null;
        if (tag instanceof c) {
            cVar = (c) tag;
        } else {
        ...
        if (cVar2 == null) {
            LifecycleOwner a10 = xm.c.f53686a.a(view);
            if (a10 != null) {
                ...
                c cVar3 = new c(kotlinx.coroutines.i.j(a11, new hs.b0(sb4)));
                view.setTag(q.f52373b, cVar3);
