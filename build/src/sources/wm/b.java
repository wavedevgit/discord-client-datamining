...
public final class b implements d, LifecycleOwner, View.OnAttachStateChangeListener, m {
    ...
    private final Function1 f52684d;

    /* renamed from: e  reason: collision with root package name */
    private View f52685e;

    /* renamed from: i  reason: collision with root package name */
    private final LifecycleRegistry f52686i;

    /* renamed from: o  reason: collision with root package name */
    private boolean f52687o;

    /* renamed from: p  reason: collision with root package name */
    private Lifecycle f52688p;
    ...
    public b(Function1 findParentLifecycle, boolean z10) {
        ...
        this.f52684d = findParentLifecycle;
        if (z10) {
    ...
    public final void a(boolean z10) {
        Lifecycle.State b10;
        Lifecycle lifecycle = this.f52688p;
        if (lifecycle == null) {
            b10 = null;
        } else {
            b10 = lifecycle.b();
        }
        Lifecycle.State b11 = this.f52686i.b();
        Intrinsics.checkNotNullExpressionValue(b11, "localLifecycle.currentState");
        Lifecycle.State state = Lifecycle.State.f4392d;
        if (b11 != state && !this.f52687o) {
            LifecycleRegistry lifecycleRegistry = this.f52686i;
            if (this.f52689q && !z10) {
                b10 = state;
            ...
            if (b10 == state) {
                this.f52687o = true;
                Lifecycle lifecycle2 = this.f52688p;
                if (lifecycle2 != null) {
                    lifecycle2.d(this);
                }
                this.f52688p = null;
                View view = this.f52685e;
                if (view != null) {
                    this.f52685e = null;
    ...
    public void onViewAttachedToWindow(View v10) {
        ...
        if (this.f52686i.b() != Lifecycle.State.f4392d && !this.f52687o) {
            this.f52685e = v10;
            Lifecycle lifecycle = this.f52688p;
            Lifecycle lifecycle2 = (Lifecycle) this.f52684d.invoke(v10);
            this.f52688p = lifecycle2;
            if (lifecycle2 != lifecycle) {
                if (lifecycle != null) {
                    lifecycle.d(this);
                }
                Lifecycle lifecycle3 = this.f52688p;
                if (lifecycle3 != null) {
                    lifecycle3.a(this);
                }
            }
