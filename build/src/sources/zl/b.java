...
public abstract class b {
    ...
    private final ConnectivityManager f55794a;

    /* renamed from: b  reason: collision with root package name */
    private final WifiManager f55795b;

    /* renamed from: c  reason: collision with root package name */
    private final TelephonyManager f55796c;

    /* renamed from: d  reason: collision with root package name */
    private final ReactApplicationContext f55797d;

    /* renamed from: e  reason: collision with root package name */
    public boolean f55798e = false;

    /* renamed from: f  reason: collision with root package name */
    private am.b f55799f = am.b.UNKNOWN;

    /* renamed from: g  reason: collision with root package name */
    private am.a f55800g = null;

    /* renamed from: h  reason: collision with root package name */
    private boolean f55801h = false;
    ...
    public b(ReactApplicationContext reactApplicationContext) {
        this.f55797d = reactApplicationContext;
        this.f55794a = (ConnectivityManager) reactApplicationContext.getSystemService("connectivity");
        this.f55795b = (WifiManager) reactApplicationContext.getApplicationContext().getSystemService("wifi");
        this.f55796c = (TelephonyManager) reactApplicationContext.getSystemService("phone");
    }
    ...
    private WritableMap b(String str) {
        ...
        switch (c10) {
            case 0:
                ...
                break;
            case 1:
                am.a aVar = this.f55800g;
                if (aVar != null) {
                    createMap.putString("cellularGeneration", aVar.f708d);
                }
                String networkOperatorName = this.f55796c.getNetworkOperatorName();
                ...
                break;
            case 2:
                if (d.b(e()) && (wifiManager = this.f55795b) != null && (connectionInfo = wifiManager.getConnectionInfo()) != null) {
                    try {
    ...
    protected WritableMap a(String str) {
        ...
        boolean z12 = false;
        if (d.b(e())) {
            WifiManager wifiManager = this.f55795b;
            if (wifiManager != null) {
        ...
        if (str != null) {
            ...
            str2 = this.f55799f.f718d;
        }
        createMap.putString("type", str2);
        boolean z13 = true;
        if (!this.f55799f.equals(am.b.NONE) && !this.f55799f.equals(am.b.UNKNOWN)) {
            z10 = true;
        } else {
            z10 = false;
        }
        createMap.putBoolean("isConnected", z10);
        if (this.f55801h && (str == null || str.equals(this.f55799f.f718d))) {
            z12 = true;
        }
        createMap.putBoolean("isInternetReachable", z12);
        if (str == null) {
            str = this.f55799f.f718d;
        }
    ...
    public void i(boolean z10) {
        this.f55802i = Boolean.valueOf(z10);
        k(this.f55799f, this.f55800g, this.f55801h);
    }
    ...
    public void k(am.b bVar, am.a aVar, boolean z10) {
        boolean z11;
        boolean z12;
        Boolean bool = this.f55802i;
        if (bool != null) {
            z10 = bool.booleanValue();
        }
        boolean z13 = false;
        if (bVar != this.f55799f) {
            z11 = true;
        } else {
            z11 = false;
        }
        if (aVar != this.f55800g) {
            z12 = true;
        } else {
            z12 = false;
        }
