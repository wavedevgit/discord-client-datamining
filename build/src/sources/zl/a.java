...
public final class a {
    ...
    public static final b f56541c = new b(null);

    /* renamed from: d  reason: collision with root package name */
    private static final String f56542d;

    /* renamed from: e  reason: collision with root package name */
    private static final ZoomLogger f56543e;

    /* renamed from: a  reason: collision with root package name */
    private final InterfaceC0802a f56544a;
    ...
    public a(InterfaceC0802a callback) {
        Intrinsics.checkNotNullParameter(callback, "callback");
        this.f56544a = callback;
    }
    ...
    private final boolean o(int i10) {
        ...
        if (!this.f56544a.h(i10)) {
            return false;
        }
        if (i10 == this.f56545b && !g(i10)) {
            return true;
        }
        int i11 = this.f56545b;
        if (i10 != 0) {
            if (i10 != 1) {
                if (i10 != 2) {
                    if (i10 == 4 && i11 == 3) {
