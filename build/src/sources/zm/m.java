...
public final class m {
    ...
    private final Lazy f56082a;

    /* renamed from: b  reason: collision with root package name */
    private final Lazy f56083b;
    ...
    public static final class a {
        ...
        public static final class C0788a extends Lambda implements Function0 {
            ...
            final /* synthetic */ BufferedSource f56084d;

            /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
            C0788a(BufferedSource bufferedSource) {
                super(0);
                this.f56084d = bufferedSource;
            }

            @Override // kotlin.jvm.functions.Function0
            /* renamed from: a */
            public final Map invoke() {
                int readInt = this.f56084d.readInt();
                BufferedSource bufferedSource = this.f56084d;
                Map d10 = o0.d(readInt);
                int i10 = 0;
                while (i10 < readInt) {
                    i10++;
                    d10.put(an.k.f830c.a(j.a(bufferedSource)), m.f56081c.a(j.a(bufferedSource)));
                }
                return o0.b(d10);
            }
        }
        ...
        public final m a(ByteString bytes) {
            ...
            return new m(i.f56068c.b(j.a(a22)), new C0788a(a22));
        }
    ...
    public m(i iVar, Function0 childTreeSnapshots) {
        ...
        this.f56082a = or.l.b(oVar, new b(iVar));
        this.f56083b = or.l.b(oVar, childTreeSnapshots);
    }

    public final Map a() {
        return (Map) this.f56083b.getValue();
    }

    public final i b() {
        return (i) this.f56082a.getValue();
    }
    ...
    */
    public final okio.ByteString c() {
        ...
        L12:
            if (r1 != 0) goto L16
            okio.ByteString r1 = okio.ByteString.f44061p
        L16:
            zm.j.c(r0, r1)
        ...
        L8e:
            ...
            return r0
        */
        throw new UnsupportedOperationException("Method not decompiled: zm.m.c():okio.ByteString");
    }
