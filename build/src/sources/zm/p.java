...
public final class p extends k implements c {
    ...
    private final KType f56091a;

    /* renamed from: b  reason: collision with root package name */
    private final String f56092b;

    /* renamed from: c  reason: collision with root package name */
    private final s f56093c;
    ...
    public static final class a extends kotlin.coroutines.jvm.internal.k implements Function2 {
        ...
        final /* synthetic */ o f56095e;

        /* renamed from: i  reason: collision with root package name */
        final /* synthetic */ p f56096i;

        /* renamed from: o  reason: collision with root package name */
        final /* synthetic */ k.a f56097o;
        ...
        public final Continuation create(Object obj, Continuation continuation) {
            return new a(this.f56095e, this.f56096i, this.f56097o, continuation);
        }
        ...
        public final Object invokeSuspend(Object obj) {
            ...
            if (i10 != 0) {
                ...
                kotlin.c.b(obj);
                o oVar = this.f56095e;
                String str = this.f56096i.f56092b;
                h c10 = this.f56097o.c();
                this.f56094d = 1;
    ...
    public p(KType workerType, String key) {
        ...
        this.f56091a = workerType;
        this.f56092b = key;
        this.f56093c = w.n(workerType);
    }

    @Override // zm.c
    public String a() {
        return Intrinsics.stringPlus("worker ", this.f56091a);
    }
