...
public final class j implements i0.c {
    ...
    private List e(i0.b bVar) {
        ...
        ne.h0 h0Var = new ne.h0(bVar.f21883d);
        List list2 = this.f21890b;
        while (h0Var.a() > 0) {
            int H = h0Var.H();
    ...
    public i0 b(int i10, i0.b bVar) {
        if (i10 != 2) {
                        ...
                        if (i10 != 36) {
                            if (i10 != 89) {
                                if (i10 != 138) {
                                    if (i10 != 172) {
                                        if (i10 != 257) {
                                            if (i10 != 134) {
                                                if (i10 != 135) {
                                                    switch (i10) {
                                                        case 15:
                                                            ...
                                                            return new w(new i(false, bVar.f21881b));
                                                        case 16:
                                                        ...
                                                        case 17:
                                                            ...
                                                            return new w(new s(bVar.f21881b));
                                                        default:
                                                            switch (i10) {
                                                ...
                                                return new w(new c(bVar.f21881b));
                                            } else if (f(16)) {
                                                return null;
                                            } else {
                                    ...
                                    return new w(new f(bVar.f21881b));
                                }
                                return new w(new k(bVar.f21881b));
                            }
                            return new w(new l(bVar.f21882c));
                        }
            ...
            return new w(new t(bVar.f21881b));
        }
