...
public final class f {
    ...
    private static class b implements c {
        ...
        private Bundle b(Context context) {
            try {
                ...
                ServiceInfo serviceInfo = packageManager.getServiceInfo(new ComponentName(context, this.f52431a), IntBufferBatchMountItem.INSTRUCTION_UPDATE_LAYOUT);
                if (serviceInfo == null) {
                    Log.w("ComponentDiscovery", this.f52431a + " has no service info.");
                    return null;
                }
    ...
    public List b() {
        ArrayList arrayList = new ArrayList();
        for (final String str : this.f52430b.a(this.f52429a)) {
            arrayList.add(new gj.b() { // from class: vi.e
                @Override // gj.b
