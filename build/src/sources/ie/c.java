...
final class c {
    ...
    private static final Pattern f28448c = Pattern.compile("\\[voice=\"([^\"]*)\"\\]");

    /* renamed from: d  reason: collision with root package name */
    private static final Pattern f28449d = Pattern.compile("^((?:[0-9]*\\.)?[0-9]+)(px|em|%)$");

    /* renamed from: a  reason: collision with root package name */
    private final h0 f28450a = new h0();

    /* renamed from: b  reason: collision with root package name */
    private final StringBuilder f28451b = new StringBuilder();

    private void a(d dVar, String str) {
        if (!"".equals(str)) {
            int indexOf = str.indexOf(91);
            if (indexOf != -1) {
                Matcher matcher = f28448c.matcher(str.substring(indexOf));
                if (matcher.matches()) {
    ...
    private static void e(String str, d dVar) {
        Matcher matcher = f28449d.matcher(ii.b.e(str));
        if (!matcher.matches()) {
    ...
    public List d(h0 h0Var) {
        ...
        int f10 = h0Var.f();
        m(h0Var);
        this.f28450a.S(h0Var.e(), h0Var.f());
        this.f28450a.U(f10);
        ArrayList arrayList = new ArrayList();
        while (true) {
            String i10 = i(this.f28450a, this.f28451b);
            if (i10 == null || !"{".equals(g(this.f28450a, this.f28451b))) {
                break;
            }
            d dVar = new d();
            a(dVar, i10);
            ...
            boolean z11 = false;
            while (!z11) {
                int f11 = this.f28450a.f();
                String g10 = g(this.f28450a, this.f28451b);
                ...
                if (!z10) {
                    this.f28450a.U(f11);
                    j(this.f28450a, dVar, this.f28451b);
                }
                str = g10;
                z11 = z10;
            }
