...
public final class k2 implements k5, e0 {
    ...
    private final JsonLogicBoolean f21038e;

    /* renamed from: i  reason: collision with root package name */
    private final List f21039i;
    ...
    public boolean equals(Object obj) {
        ...
        k2 k2Var = (k2) obj;
        if (Intrinsics.areEqual(this.f21037d, k2Var.f21037d) && Intrinsics.areEqual(this.f21038e, k2Var.f21038e)) {
            return true;
        }
        return false;
    }
    ...
    public int hashCode() {
        int hashCode;
        int hashCode2 = this.f21037d.hashCode() * 31;
        JsonLogicBoolean jsonLogicBoolean = this.f21038e;
    ...
    public final void writeToParcel(Parcel dest, int i10) {
        ...
        dest.writeParcelable(this.f21038e, i10);
    }
    ...
    */
    public k2(com.withpersona.sdk2.inquiry.network.dto.ui.components.LocalImage r2) {
        ...
        L15:
            ...
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: dq.k2.<init>(com.withpersona.sdk2.inquiry.network.dto.ui.components.LocalImage):void");
    }
}
