...
public final class f4 implements k5, e0 {
    ...
    private final JsonLogicBoolean f20990e;

    /* renamed from: i  reason: collision with root package name */
    private final int f20991i;

    /* renamed from: o  reason: collision with root package name */
    private final List f20992o;
    ...
    public boolean equals(Object obj) {
        ...
        f4 f4Var = (f4) obj;
        if (Intrinsics.areEqual(this.f20989d, f4Var.f20989d) && Intrinsics.areEqual(this.f20990e, f4Var.f20990e) && this.f20991i == f4Var.f20991i) {
            return true;
        }
        return false;
    }
    ...
    public int hashCode() {
        int hashCode;
        int hashCode2 = this.f20989d.hashCode() * 31;
        JsonLogicBoolean jsonLogicBoolean = this.f20990e;
        if (jsonLogicBoolean == null) {
            hashCode = 0;
        } else {
            hashCode = jsonLogicBoolean.hashCode();
        }
        return ((hashCode2 + hashCode) * 31) + Integer.hashCode(this.f20991i);
    }

    public String toString() {
        String str = this.f20989d;
        JsonLogicBoolean jsonLogicBoolean = this.f20990e;
        int i10 = this.f20991i;
    ...
    public final void writeToParcel(Parcel dest, int i10) {
        ...
        dest.writeString(this.f20989d);
        dest.writeParcelable(this.f20990e, i10);
        dest.writeInt(this.f20991i);
    }
    ...
    */
    public f4(com.withpersona.sdk2.inquiry.network.dto.ui.components.QRCode r5) {
        ...
        L4e:
            ...
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: dq.f4.<init>(com.withpersona.sdk2.inquiry.network.dto.ui.components.QRCode):void");
    }
}
