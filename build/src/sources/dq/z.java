...
public abstract class z {
    public static final View a(y yVar, m5 uiComponentHelper, List componentViews, List children, Footer config) {
        ...
        gq.g c10 = gq.g.c(LayoutInflater.from(a10));
        Intrinsics.checkNotNullExpressionValue(c10, "inflate(...)");
        Integer backgroundColor = config.getBackgroundColor();
        if (backgroundColor != null) {
            c10.f25102c.setBackgroundColor(backgroundColor.intValue());
        }
        StyleElements.SizeSet padding = config.getPadding();
        if (padding != null) {
            int dimensionPixelOffset = a10.getResources().getDimensionPixelOffset(pp.k.f46164b);
            StyleElements.Size left = padding.getLeft();
            if (left != null && (dp6 = left.getDp()) != null) {
                i11 = (int) pp.h.a(dp6.doubleValue());
            } else {
                i11 = 0;
            }
        ...
        if (borderWidth != null) {
            ...
            if (layoutParams != null) {
                ...
                if (top2 != null && (dp2 = top2.getDp()) != null) {
                    i10 = (int) pp.h.a(dp2.doubleValue());
                } else {
                    i10 = 0;
                }
            ...
            if (layoutParams2 != null) {
                layoutParams2.height = (int) pp.h.a(1.0d);
        ...
        constraintSet.f(c10.f25103d);
        ConstraintLayout footerContainerInner = c10.f25103d;
