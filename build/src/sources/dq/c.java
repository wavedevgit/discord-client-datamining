...
public abstract class c {
    public static final void b(ViewGroup viewGroup, StepStyle stepStyle, View innerView, Rect rect) {
        ...
        if (stepStyle != null) {
            ...
            Drawable a10 = fq.c.a(stepStyle, context2);
            if (a10 != null) {
                e(viewGroup, a10);
            }
        }
        ...
        if (stepStyle != null && (modalPaddingValue = stepStyle.getModalPaddingValue()) != null) {
            ...
            if (left != null && (dp5 = left.getDp()) != null) {
                int a11 = (int) kp.h.a(dp5.doubleValue());
                if (rect != null) {
                    i12 = rect.left;
                } else {
                    i12 = 0;
            ...
            if (top != null && (dp4 = top.getDp()) != null) {
                int a12 = (int) kp.h.a(dp4.doubleValue());
                if (rect != null) {
                    i11 = rect.top;
                } else {
                    i11 = 0;
            ...
            if (right != null && (dp3 = right.getDp()) != null) {
                int a13 = (int) kp.h.a(dp3.doubleValue());
                if (rect != null) {
                    i10 = rect.right;
                } else {
                    i10 = 0;
            ...
            if (bottom != null && (dp2 = bottom.getDp()) != null) {
                int a14 = (int) kp.h.a(dp2.doubleValue());
                if (rect != null) {
                    i13 = rect.bottom;
                }
    ...
    private static final void e(ViewGroup viewGroup, Drawable drawable) {
        Sequence F = kotlin.sequences.k.F(n0.a(viewGroup), new Function1() { // from class: dq.b
        ...
        if (layoutParams != null) {
            ...
            layoutParams2.f2488t = viewGroup.getId();
            layoutParams2.f2492v = viewGroup.getId();
            layoutParams2.f2466i = viewGroup.getId();
            layoutParams2.f2472l = viewGroup.getId();
