...
public abstract class e4 {
    public static final TextView b(c4 c4Var, m5 uiComponentHelper, final PrivacyPolicy config) {
        ...
        final gq.t c10 = gq.t.c(uiComponentHelper.b());
        PrivacyPolicy.Attributes attributes = config.getAttributes();
        if (attributes != null) {
            TextView textView = c10.f25149b;
            Intrinsics.checkNotNullExpressionValue(textView, "textView");
            eq.f.d(textView, attributes.getText());
            uiComponentHelper.d(new Function0() { // from class: dq.d4
    ...
    public static final Unit c(PrivacyPolicy privacyPolicy, gq.t tVar) {
        TextBasedComponentStyle styles = privacyPolicy.getStyles();
        if (styles != null) {
            TextView textView = tVar.f25149b;
            Intrinsics.checkNotNullExpressionValue(textView, "textView");
