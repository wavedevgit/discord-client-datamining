...
public final class b4 implements Parcelable {
    ...
    public boolean equals(Object obj) {
        ...
        b4 b4Var = (b4) obj;
        if (Intrinsics.areEqual(this.f20940d, b4Var.f20940d) && Intrinsics.areEqual(this.f20941e, b4Var.f20941e)) {
            return true;
        }
        return false;
    }
    ...
    public int hashCode() {
        return (this.f20940d.hashCode() * 31) + this.f20941e.hashCode();
    }

    public String toString() {
        String str = this.f20940d;
        String str2 = this.f20941e;
    ...
    public final void writeToParcel(Parcel dest, int i10) {
        ...
        dest.writeString(this.f20940d);
        dest.writeString(this.f20941e);
    }
}
