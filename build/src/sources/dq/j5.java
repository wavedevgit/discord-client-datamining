...
public abstract class j5 {
    public static final TextView b(h5 h5Var, m5 uiComponentHelper, final Title config) {
        ...
        final gq.x c10 = gq.x.c(uiComponentHelper.b());
        Title.Attributes attributes = config.getAttributes();
        if (attributes != null) {
            TextView textView = c10.f25162b;
            Intrinsics.checkNotNullExpressionValue(textView, "textView");
            eq.f.d(textView, attributes.getText());
            uiComponentHelper.d(new Function0() { // from class: dq.i5
    ...
    public static final Unit c(Title title, gq.x xVar) {
        TextBasedComponentStyle styles = title.getStyles();
        if (styles != null) {
            TextView textView = xVar.f25162b;
            Intrinsics.checkNotNullExpressionValue(textView, "textView");
