...
public final class q5 implements h {
    ...
    private final JsonLogicBoolean f21121e;

    /* renamed from: i  reason: collision with root package name */
    private final JsonLogicBoolean f21122i;

    /* renamed from: o  reason: collision with root package name */
    private final String f21123o;

    /* renamed from: p  reason: collision with root package name */
    private final Integer f21124p;

    /* renamed from: q  reason: collision with root package name */
    private final String f21125q;

    /* renamed from: r  reason: collision with root package name */
    private final List f21126r;
    ...
    public q5(String name, JsonLogicBoolean jsonLogicBoolean, JsonLogicBoolean jsonLogicBoolean2, String str, Integer num, String str2) {
        ...
        this.f21120d = name;
        this.f21121e = jsonLogicBoolean;
        this.f21122i = jsonLogicBoolean2;
        this.f21123o = str;
        this.f21124p = num;
        this.f21125q = str2;
        this.f21126r = new ArrayList();
    }
    ...
    public final void writeToParcel(Parcel dest, int i10) {
        ...
        dest.writeString(this.f21120d);
        dest.writeParcelable(this.f21121e, i10);
        dest.writeParcelable(this.f21122i, i10);
        dest.writeString(this.f21123o);
    ...
    */
    public q5(com.withpersona.sdk2.inquiry.network.dto.ui.components.VerifyPersonaButton r9) {
        ...
        L48:
            ...
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: dq.q5.<init>(com.withpersona.sdk2.inquiry.network.dto.ui.components.VerifyPersonaButton):void");
    }
}
