...
public abstract class e1 {
    public static final ConstraintLayout b(InputDateComponent inputDateComponent, m5 uiComponentHelper, eq.e dateController, InputDate config) {
        ...
        if (attributes != null) {
            ...
            cq.a aVar = new cq.a(a10, i10, textMonths, textBasedComponentStyle);
            bn.t d10 = dateController.d();
            AutoCompleteTextView monthEditText = c10.f25097g;
            Intrinsics.checkNotNullExpressionValue(monthEditText, "monthEditText");
            bn.u.b(d10, monthEditText);
            c10.f25097g.setAdapter(aVar);
            if (styles != null && (backgroundColor = styles.getBackgroundColor()) != null && (inputSelectBackgroundColor = backgroundColor.getInputSelectBackgroundColor()) != null) {
                c10.f25097g.setDropDownBackgroundDrawable(new ColorDrawable(inputSelectBackgroundColor.intValue()));
            }
            c10.f25093c.setHint(attributes.getPlaceholderDay());
            bn.t c11 = dateController.c();
            TextInputEditText dayEditText = c10.f25094d;
            Intrinsics.checkNotNullExpressionValue(dayEditText, "dayEditText");
            bn.u.b(c11, dayEditText);
            c10.f25098h.setHint(attributes.getPlaceholderYear());
            bn.t g10 = dateController.g();
            TextInputEditText yearEditText = c10.f25099i;
            Intrinsics.checkNotNullExpressionValue(yearEditText, "yearEditText");
            bn.u.b(g10, yearEditText);
        }
        uiComponentHelper.d(new Function0() { // from class: dq.d1
    ...
    public static /* synthetic */ ConstraintLayout c(InputDateComponent inputDateComponent, m5 m5Var, eq.e eVar, InputDate inputDate, int i10, Object obj) {
        if ((i10 & 2) != 0) {
    ...
    public static final Unit d(InputDate.InputDateComponentStyle inputDateComponentStyle, gq.f fVar) {
        ...
        if (inputDateComponentStyle != null && (inputSelectStyle3 = inputDateComponentStyle.getInputSelectStyle()) != null && (labelStyle = inputSelectStyle3.getLabelStyle()) != null) {
            TextView dateLabel = fVar.f25092b;
            Intrinsics.checkNotNullExpressionValue(dateLabel, "dateLabel");
            iq.f0.n(dateLabel, labelStyle, null, 2, null);
        }
