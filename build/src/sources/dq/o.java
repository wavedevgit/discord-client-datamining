...
public final class o implements h {
    ...
    private final JsonLogicBoolean f21086e;

    /* renamed from: i  reason: collision with root package name */
    private final JsonLogicBoolean f21087i;

    /* renamed from: o  reason: collision with root package name */
    private final String f21088o;

    /* renamed from: p  reason: collision with root package name */
    private final Integer f21089p;

    /* renamed from: q  reason: collision with root package name */
    private final List f21090q;
    ...
    public o(String name, JsonLogicBoolean jsonLogicBoolean, JsonLogicBoolean jsonLogicBoolean2, String str, Integer num) {
        ...
        this.f21085d = name;
        this.f21086e = jsonLogicBoolean;
        this.f21087i = jsonLogicBoolean2;
        this.f21088o = str;
        this.f21089p = num;
    ...
    public boolean equals(Object obj) {
        ...
        o oVar = (o) obj;
        if (Intrinsics.areEqual(this.f21085d, oVar.f21085d) && Intrinsics.areEqual(this.f21086e, oVar.f21086e) && Intrinsics.areEqual(this.f21087i, oVar.f21087i) && Intrinsics.areEqual(this.f21088o, oVar.f21088o) && Intrinsics.areEqual(this.f21089p, oVar.f21089p)) {
            return true;
        }
        return false;
    }
    ...
    public int hashCode() {
        ...
        int hashCode2;
        int hashCode3;
        int hashCode4 = this.f21085d.hashCode() * 31;
        JsonLogicBoolean jsonLogicBoolean = this.f21086e;
        int i10 = 0;
        ...
        JsonLogicBoolean jsonLogicBoolean2 = this.f21087i;
    ...
    public final void writeToParcel(Parcel dest, int i10) {
        ...
        dest.writeString(this.f21085d);
        dest.writeParcelable(this.f21086e, i10);
        dest.writeParcelable(this.f21087i, i10);
        dest.writeString(this.f21088o);
        Integer num = this.f21089p;
        if (num == null) {
            dest.writeInt(0);
            return;
    ...
    */
    public o(com.withpersona.sdk2.inquiry.network.dto.ui.components.CompleteButton r8) {
        ...
        L3b:
            ...
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: dq.o.<init>(com.withpersona.sdk2.inquiry.network.dto.ui.components.CompleteButton):void");
    }
}
