...
public abstract class o {
    ...
    /* JADX WARN: Type inference failed for: r0v46, types: [T, dq.h] */
    public static final void i(final TextInputLayout textInputLayout, InputSelectComponentStyle styles) {
        ...
        if (baseBackgroundColorValue != null) {
            ...
            objectRef.element = new Function1() { // from class: dq.h
            ...
            textInputLayout.addOnLayoutChangeListener(new View.OnLayoutChangeListener() { // from class: dq.i
        ...
        if (topBorderWidthValue != null) {
            ...
            textInputLayout.setBoxStrokeWidth((int) Math.ceil(kp.h.a(doubleValue)));
            textInputLayout.setBoxStrokeWidthFocused((int) Math.ceil(kp.h.a(doubleValue)));
        }
        if (textInputLayout.getBoxStrokeWidth() == 0) {
            ...
            if (d10 > 0.0d) {
                ...
                if (bottomBorderWidthValue2 != null) {
                    d11 = kp.h.a(bottomBorderWidthValue2.doubleValue());
                }
        ...
        if (borderRadiusValue != null) {
            ...
            textInputLayout.Z((float) kp.h.a(doubleValue2), (float) kp.h.a(doubleValue2), (float) kp.h.a(doubleValue2), (float) kp.h.a(doubleValue2));
        }
        StyleElements.SizeSet inputSelectBoxMargins = styles.getInputSelectBoxMargins();
        if (inputSelectBoxMargins != null) {
            gq.d.c(textInputLayout, inputSelectBoxMargins);
        }
        ...
        if (editText2 != null) {
            gq.d.c(editText2, new StyleElements.SizeSet(new StyleElements.DPSize(valueOf), new StyleElements.DPSize(valueOf), new StyleElements.DPSize(valueOf), new StyleElements.DPSize(valueOf)));
        }
        ...
        if (baseTextColor != null) {
            ...
            textInputLayout.addOnLayoutChangeListener(new View.OnLayoutChangeListener() { // from class: dq.j
                @Override // android.view.View.OnLayoutChangeListener
                public final void onLayoutChange(View view, int i27, int i28, int i29, int i30, int i31, int i32, int i33, int i34) {
        ...
        if (labelBaseTextColor != null) {
            ...
            textInputLayout.addOnLayoutChangeListener(new View.OnLayoutChangeListener() { // from class: dq.k
                @Override // android.view.View.OnLayoutChangeListener
                public final void onLayoutChange(View view, int i27, int i28, int i29, int i30, int i31, int i32, int i33, int i34) {
        ...
        if (placeholderBaseTextColor != null) {
            ...
            textInputLayout.addOnLayoutChangeListener(new View.OnLayoutChangeListener() { // from class: dq.l
                @Override // android.view.View.OnLayoutChangeListener
                public final void onLayoutChange(View view, int i27, int i28, int i29, int i30, int i31, int i32, int i33, int i34) {
        ...
        if (editText4 != null) {
            editText4.setOnFocusChangeListener(new View.OnFocusChangeListener() { // from class: dq.m
    ...
    public static final void l(TextInputLayout textInputLayout, final Ref.ObjectRef objectRef, View view, final boolean z10) {
        textInputLayout.post(new Runnable() { // from class: dq.n
