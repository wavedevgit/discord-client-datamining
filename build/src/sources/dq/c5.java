...
public final class c5 implements h {
    ...
    private final JsonLogicBoolean f20952e;

    /* renamed from: i  reason: collision with root package name */
    private final JsonLogicBoolean f20953i;

    /* renamed from: o  reason: collision with root package name */
    private final String f20954o;

    /* renamed from: p  reason: collision with root package name */
    private final Integer f20955p;

    /* renamed from: q  reason: collision with root package name */
    private final List f20956q;
    ...
    public c5(String name, JsonLogicBoolean jsonLogicBoolean, JsonLogicBoolean jsonLogicBoolean2, String str, Integer num) {
        ...
        this.f20951d = name;
        this.f20952e = jsonLogicBoolean;
        this.f20953i = jsonLogicBoolean2;
        this.f20954o = str;
        this.f20955p = num;
        this.f20956q = new ArrayList();
    }
    ...
    public boolean equals(Object obj) {
        ...
        c5 c5Var = (c5) obj;
        if (Intrinsics.areEqual(this.f20951d, c5Var.f20951d) && Intrinsics.areEqual(this.f20952e, c5Var.f20952e) && Intrinsics.areEqual(this.f20953i, c5Var.f20953i) && Intrinsics.areEqual(this.f20954o, c5Var.f20954o) && Intrinsics.areEqual(this.f20955p, c5Var.f20955p)) {
            return true;
        }
        return false;
    }
    ...
    public int hashCode() {
        ...
        int hashCode2;
        int hashCode3;
        int hashCode4 = this.f20951d.hashCode() * 31;
        JsonLogicBoolean jsonLogicBoolean = this.f20952e;
        int i10 = 0;
        ...
        JsonLogicBoolean jsonLogicBoolean2 = this.f20953i;
    ...
    public final void writeToParcel(Parcel dest, int i10) {
        ...
        dest.writeString(this.f20951d);
        dest.writeParcelable(this.f20952e, i10);
        dest.writeParcelable(this.f20953i, i10);
        dest.writeString(this.f20954o);
        Integer num = this.f20955p;
        if (num == null) {
            dest.writeInt(0);
            return;
    ...
    */
    public c5(com.withpersona.sdk2.inquiry.network.dto.ui.components.SubmitButton r8) {
        ...
        L3b:
            ...
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: dq.c5.<init>(com.withpersona.sdk2.inquiry.network.dto.ui.components.SubmitButton):void");
    }
}
