...
public final class e implements k5 {
    ...
    public boolean equals(Object obj) {
        ...
        e eVar = (e) obj;
        if (Intrinsics.areEqual(this.f20971d, eVar.f20971d) && this.f20972e == eVar.f20972e) {
            return true;
        }
        return false;
    }
    ...
    public int hashCode() {
        return (this.f20971d.hashCode() * 31) + Boolean.hashCode(this.f20972e);
    }
    ...
    public final void writeToParcel(Parcel dest, int i10) {
        ...
        dest.writeString(this.f20971d);
        dest.writeInt(this.f20972e ? 1 : 0);
    }
    ...
    */
    public e(com.withpersona.sdk2.inquiry.network.dto.ui.components.Branding r3) {
        ...
        L1b:
            ...
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: dq.e.<init>(com.withpersona.sdk2.inquiry.network.dto.ui.components.Branding):void");
    }
}
