...
public final class y implements k5, l5 {
    ...
    private final List f21203e;

    /* renamed from: i  reason: collision with root package name */
    private final Integer f21204i;
    ...
    public boolean equals(Object obj) {
        ...
        y yVar = (y) obj;
        if (Intrinsics.areEqual(this.f21202d, yVar.f21202d) && Intrinsics.areEqual(this.f21203e, yVar.f21203e) && Intrinsics.areEqual(this.f21204i, yVar.f21204i)) {
            return true;
        }
        return false;
    }
    ...
    public int hashCode() {
        int hashCode;
        int hashCode2 = ((this.f21202d.hashCode() * 31) + this.f21203e.hashCode()) * 31;
        Integer num = this.f21204i;
        if (num == null) {
            hashCode = 0;
        } else {
    ...
    public final void writeToParcel(Parcel dest, int i10) {
        ...
        dest.writeString(this.f21202d);
        List<Parcelable> list = this.f21203e;
    ...
    */
    public y(com.withpersona.sdk2.inquiry.network.dto.ui.components.Footer r5) {
        ...
        L40:
            ...
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: dq.y.<init>(com.withpersona.sdk2.inquiry.network.dto.ui.components.Footer):void");
    }
}
