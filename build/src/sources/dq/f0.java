...
public final class f0 implements k5, l5, e0 {
    ...
    private final List f20980e;

    /* renamed from: i  reason: collision with root package name */
    private final JsonLogicBoolean f20981i;

    /* renamed from: o  reason: collision with root package name */
    private final List f20982o;
    ...
    public f0(String name, List children, JsonLogicBoolean jsonLogicBoolean) {
        ...
        this.f20979d = name;
        this.f20980e = children;
        this.f20981i = jsonLogicBoolean;
        this.f20982o = new ArrayList();
    }
    ...
    public static /* synthetic */ f0 b(f0 f0Var, String str, List list, JsonLogicBoolean jsonLogicBoolean, int i10, Object obj) {
        ...
        if ((i10 & 4) != 0) {
            jsonLogicBoolean = f0Var.f20981i;
        }
    ...
    public boolean equals(Object obj) {
        ...
        f0 f0Var = (f0) obj;
        if (Intrinsics.areEqual(this.f20979d, f0Var.f20979d) && Intrinsics.areEqual(this.f20980e, f0Var.f20980e) && Intrinsics.areEqual(this.f20981i, f0Var.f20981i)) {
            return true;
        }
        return false;
    }
    ...
    public int hashCode() {
        int hashCode;
        int hashCode2 = ((this.f20979d.hashCode() * 31) + this.f20980e.hashCode()) * 31;
        JsonLogicBoolean jsonLogicBoolean = this.f20981i;
    ...
    public final void writeToParcel(Parcel dest, int i10) {
        ...
        List<Parcelable> list = this.f20980e;
        dest.writeInt(list.size());
        for (Parcelable parcelable : list) {
            dest.writeParcelable(parcelable, i10);
        }
        dest.writeParcelable(this.f20981i, i10);
    }
    ...
    */
    public f0(com.withpersona.sdk2.inquiry.network.dto.ui.components.HorizontalStack r5) {
        ...
        L40:
            ...
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: dq.f0.<init>(com.withpersona.sdk2.inquiry.network.dto.ui.components.HorizontalStack):void");
    }
}
