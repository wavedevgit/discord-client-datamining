...
public final class d implements a {
    ...
    private final Class f48083b = d.class;
    ...
    public void a(int i10, int i11, Function0 function0) {
        a.C0584a.d(this, i10, i11, function0);
    }
    ...
    public CloseableReference c(int i10, int i11, int i12) {
        return a.C0584a.b(this, i10, i11, i12);
    }
    ...
    public void e(b bitmapFramePreparer, p9.b bitmapFrameCache, o9.a animationBackend, int i10, Function0 function0) {
        ...
        if (1 <= i11) {
            while (true) {
                ...
                if (p8.a.w(2)) {
                    p8.a.A(this.f48083b, "Preparing frame %d, last drawn: %d", Integer.valueOf(a10), Integer.valueOf(i10));
                }
