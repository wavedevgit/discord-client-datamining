...
public abstract class a {
    ...
    private static final AtomicBoolean f25531a = new AtomicBoolean(false);

    /* renamed from: b  reason: collision with root package name */
    private static final AtomicBoolean f25532b = new AtomicBoolean(false);
    ...
    public static class b implements Runnable {
        ...
        public void run() {
            ...
            try {
                ...
                e eVar = e.FULL;
                Log.i("TIME4A", lt.c.B(eVar, eVar, locale, t10).l(b10));
    ...
    public static void c(Context context, ft.b bVar) {
        if (!f25531a.getAndSet(true)) {
    ...
    public static void d(Context context) {
        if (context != null && !f25532b.getAndSet(true)) {
