...
public abstract class a {
    ...
    public final j0 f24699b = new j0();

    /* renamed from: d  reason: collision with root package name */
    private StringBuilder f24701d = new StringBuilder();
    ...
    private final int c(CharSequence charSequence, int i10) {
        ...
        if (i11 >= charSequence.length()) {
            this.f24698a = i10;
            u();
            if (this.f24698a + 4 < charSequence.length()) {
                return c(charSequence, this.f24698a);
            }
            x(this, "Unexpected EOF during unicode escape", 0, null, 6, null);
            throw new lr.h();
        }
        this.f24701d.append((char) ((B(charSequence, i10) << 12) + (B(charSequence, i10 + 1) << 8) + (B(charSequence, i10 + 2) << 4) + B(charSequence, i10 + 3)));
        return i11;
    }
    ...
    private final String s(int i10, int i11) {
        d(i10, i11);
        String sb2 = this.f24701d.toString();
        Intrinsics.checkNotNullExpressionValue(sb2, "toString(...)");
        this.f24701d.setLength(0);
        return sb2;
    }
    ...
    public final void A(String key) {
        ...
        int o02 = StringsKt.o0(L(0, this.f24698a), key, 0, false, 6, null);
                ...
                if (G2 != 8 && G2 != 6) {
                    if (G2 == 9) {
                        if (((Number) CollectionsKt.z0(arrayList)).byteValue() == 8) {
                            ...
                            int i10 = this.f24698a;
                            throw g0.e(i10, "found ] instead of } at path: " + this.f24699b, D());
                        }
                    } else if (G2 == 7) {
                        if (((Number) CollectionsKt.z0(arrayList)).byteValue() == 6) {
                            ...
                            throw g0.e(i11, "found } instead of ] at path: " + this.f24699b, D());
                        }
                    } else if (G2 == 10) {
        ...
        if (i10 > 0 && c10 == '\"') {
            try {
                ...
                if (Intrinsics.areEqual(q10, "null")) {
                    w("Expected string literal but 'null' literal was found", this.f24698a - 1, "Use 'coerceInputValues = true' in 'Json {}' builder to coerce nulls if property has a default value.");
                    throw new lr.h();
                }
            } catch (Throwable th2) {
                this.f24698a = i10;
    ...
    public final boolean g() {
        ...
        if (K != D().length()) {
            ...
            boolean f10 = f(K);
            if (z10) {
                if (this.f24698a != D().length()) {
                    if (D().charAt(this.f24698a) == '\"') {
                        this.f24698a++;
                        return f10;
                    }
    ...
    */
    public final long m() {
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: ft.a.m():long");
    }
    ...
    public final String q() {
        ...
        if (K < D().length() && K != -1) {
            ...
            if (a10 == 0) {
                ...
                if (!z10) {
                    s10 = L(this.f24698a, K);
                } else {
                    s10 = s(this.f24698a, K);
                }
                this.f24698a = K;
                return s10;
            }
    ...
    public String toString() {
        return "JsonReader(source='" + ((Object) D()) + "', currentPosition=" + this.f24698a + ')';
    }
    ...
    public final void v() {
        ...
        x(this, "Expected EOF after parsing, but had " + D().charAt(this.f24698a - 1) + " instead", 0, null, 6, null);
        throw new lr.h();
    }
    ...
    public final Void w(String message, int i10, String hint) {
        ...
        throw g0.e(i10, message + " at path: " + this.f24699b.a() + str, D());
    }
    ...
    public final Void y(byte b10, boolean z10) {
        ...
        int i11 = i10;
        if (this.f24698a != D().length() && i11 >= 0) {
