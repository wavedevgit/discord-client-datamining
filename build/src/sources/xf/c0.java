...
public class c0 extends jf.a {
        ...
        try {
            ...
            if (this.f55195d != null) {
                for (int i10 = 0; i10 < this.f55195d.size(); i10++) {
                    d0 d0Var = (d0) this.f55195d.get(i10);
    ...
    public boolean equals(Object obj) {
        ...
        c0 c0Var = (c0) obj;
        List list2 = this.f55195d;
        if (list2 == null && c0Var.f55195d == null) {
            return true;
        }
        if (list2 == null || (list = c0Var.f55195d) == null || !list2.containsAll(list) || !c0Var.f55195d.containsAll(this.f55195d)) {
            return false;
        }
        return true;
    }
