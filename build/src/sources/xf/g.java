...
public class g extends i {
    ...
    private final v4 f54909d;

    /* renamed from: e  reason: collision with root package name */
    private final v4 f54910e;

    /* renamed from: i  reason: collision with root package name */
    private final v4 f54911i;

    /* renamed from: o  reason: collision with root package name */
    private final String[] f54912o;

    /* JADX INFO: Access modifiers changed from: package-private */
    public g(byte[] bArr, byte[] bArr2, byte[] bArr3, String[] strArr) {
        byte[] bArr4 = (byte[]) hf.q.l(bArr);
        v4 v4Var = v4.f14239e;
        v4 o10 = v4.o(bArr4, 0, bArr4.length);
        byte[] bArr5 = (byte[]) hf.q.l(bArr2);
        v4 o11 = v4.o(bArr5, 0, bArr5.length);
        byte[] bArr6 = (byte[]) hf.q.l(bArr3);
        v4 o12 = v4.o(bArr6, 0, bArr6.length);
        this.f54909d = (v4) hf.q.l(o10);
        this.f54910e = (v4) hf.q.l(o11);
        this.f54911i = (v4) hf.q.l(o12);
        this.f54912o = (String[]) hf.q.l(strArr);
    }

    public byte[] b() {
        return this.f54911i.p();
    }

    public byte[] c() {
        return this.f54910e.p();
    }

    public byte[] d() {
        return this.f54909d.p();
    }
    ...
    public boolean equals(Object obj) {
        ...
        g gVar = (g) obj;
        if (!hf.o.a(this.f54909d, gVar.f54909d) || !hf.o.a(this.f54910e, gVar.f54910e) || !hf.o.a(this.f54911i, gVar.f54911i)) {
            return false;
        }
        return true;
    }
    ...
    */
    public final org.json.JSONObject f() {
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: xf.g.f():org.json.JSONObject");
    }

    public int hashCode() {
        return hf.o.b(Integer.valueOf(hf.o.b(this.f54909d)), Integer.valueOf(hf.o.b(this.f54910e)), Integer.valueOf(hf.o.b(this.f54911i)));
    }
    ...
    public String toString() {
        ...
        a10.b("transports", Arrays.toString(this.f54912o));
        return a10.toString();
    }
