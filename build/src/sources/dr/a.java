...
public final class a implements h {
    ...
    private final Object c(Map map, Object obj) {
        ...
        if (CollectionsKt.d0(this.f21131a.a().keySet(), p02)) {
            su.a aVar = (su.a) this.f21131a.a().get(p02);
            if (aVar != null) {
                return aVar.e(obj2, obj, this);
            }
            return null;
        }
        su.b d10 = d(this.f21131a.b(), p02);
    ...
    private final su.b d(Map map, Object obj) {
        su.b bVar = (su.b) map.get(obj);
        if (bVar != null) {
            return bVar;
        }
