...
public abstract class w {
    ...
    public class a extends qi.b {
        ...
        final /* synthetic */ Iterator f45420i;

        /* renamed from: o  reason: collision with root package name */
        final /* synthetic */ pi.n f45421o;
        ...
        @Override // qi.b
        protected Object a() {
            while (this.f45420i.hasNext()) {
                Object next = this.f45420i.next();
                if (this.f45421o.apply(next)) {
                    return next;
                }
            }
            return b();
    ...
    class b extends t0 {
        ...
        final /* synthetic */ Object f45423e;
    ...
    public static boolean b(Iterator it, pi.n nVar) {
        if (l(it, nVar) != -1) {
            return true;
        }
        return false;
    ...
    */
    public static boolean e(java.util.Iterator r3, java.util.Iterator r4) {
        ...
        L1d:
            ...
            return r3
        */
        throw new UnsupportedOperationException("Method not decompiled: qi.w.e(java.util.Iterator, java.util.Iterator):boolean");
    }
    ...
    public static t0 g(Iterator it, pi.n nVar) {
        pi.m.j(it);
        pi.m.j(nVar);
        return new a(it, nVar);
    }

    public static Object h(Iterator it, pi.n nVar) {
        pi.m.j(it);
        pi.m.j(nVar);
        while (it.hasNext()) {
            Object next = it.next();
    ...
    public static int l(Iterator it, pi.n nVar) {
        pi.m.k(nVar, "predicate");
        int i10 = 0;
        while (it.hasNext()) {
    ...
    public static boolean o(Iterator it, pi.n nVar) {
        pi.m.j(nVar);
        boolean z10 = false;
        while (it.hasNext()) {
            if (nVar.apply(it.next())) {
