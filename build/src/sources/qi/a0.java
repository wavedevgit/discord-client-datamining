...
public abstract class a0 {
    ...
    public static abstract class b implements pi.f {
        ...
        public static final b f45839d = new a("KEY", 0);

        /* renamed from: e  reason: collision with root package name */
        public static final b f45840e = new C0605b("VALUE", 1);

        /* renamed from: i  reason: collision with root package name */
        private static final /* synthetic */ b[] f45841i = a();
        ...
        /* renamed from: qi.a0$b$b  reason: collision with other inner class name */
        /* loaded from: /home/runner/work/discord-client-datamining/discord-client-datamining/build/classes4.dex */
        enum C0605b extends b {
            C0605b(String str, int i10) {
                super(str, i10, null);
            }
    ...
    public static abstract class c extends q0.d {
        ...
        @Override // qi.q0.d, java.util.AbstractSet, java.util.AbstractCollection, java.util.Collection, java.util.Set
        public boolean removeAll(Collection collection) {
            try {
                return super.removeAll((Collection) pi.m.j(collection));
            } catch (UnsupportedOperationException unused) {
                return q0.j(this, collection.iterator());
            }
        }

        @Override // qi.q0.d, java.util.AbstractCollection, java.util.Collection, java.util.Set
    ...
    public static abstract class f extends AbstractMap {
        ...
        /* renamed from: d  reason: collision with root package name */
        private transient Set f45844d;

        /* renamed from: e  reason: collision with root package name */
        private transient Collection f45845e;
        ...
        public Collection values() {
            Collection collection = this.f45845e;
            if (collection == null) {
                Collection b10 = b();
                this.f45845e = b10;
                return b10;
