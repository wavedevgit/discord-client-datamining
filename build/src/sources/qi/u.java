...
class u implements yi.d, yi.c {
    ...
    private final Map f47462a = new HashMap();

    /* renamed from: b  reason: collision with root package name */
    private Queue f47463b = new ArrayDeque();
            ...
            try {
                ...
                for (final Map.Entry entry : d(aVar)) {
                    ((Executor) entry.getValue()).execute(new Runnable(entry, aVar) { // from class: qi.t
                        ...
                        public final /* synthetic */ Map.Entry f47461d;

                        @Override // java.lang.Runnable
                        public final void run() {
                            ((yi.b) this.f47461d.getKey()).a(null);
                        }
                    });
                }
            } catch (Throwable th2) {
    ...
    public synchronized void f(Class cls, Executor executor, yi.b bVar) {
        try {
            ...
            ((ConcurrentHashMap) this.f47462a.get(cls)).put(bVar, executor);
        } catch (Throwable th2) {
            throw th2;
        }
    }
