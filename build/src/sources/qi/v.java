...
public abstract class v {
    public static boolean a(Iterable iterable, pi.n nVar) {
    ...
    public static boolean f(Iterable iterable, pi.n nVar) {
        if ((iterable instanceof RandomAccess) && (iterable instanceof List)) {
            return g((List) iterable, (pi.n) pi.m.j(nVar));
        }
        return w.o(iterable.iterator(), nVar);
    }

    private static boolean g(List list, pi.n nVar) {
        int i10 = 0;
        int i11 = 0;
        while (i10 < list.size()) {
    ...
    private static void h(List list, pi.n nVar, int i10, int i11) {
