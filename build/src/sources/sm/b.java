...
public final class b implements EventDispatcherListener {
    ...
    public static final a f49863h = new a(null);

    /* renamed from: a  reason: collision with root package name */
    private final ReactViewGroup f49864a;

    /* renamed from: b  reason: collision with root package name */
    private final ThemedReactContext f49865b;

    /* renamed from: c  reason: collision with root package name */
    private final l f49866c;

    /* renamed from: d  reason: collision with root package name */
    private Function0 f49867d;

    /* renamed from: e  reason: collision with root package name */
    private final int f49868e;

    /* renamed from: f  reason: collision with root package name */
    private final UIManager f49869f;

    /* renamed from: g  reason: collision with root package name */
    private final EventDispatcher f49870g;
    ...
    public b(ReactViewGroup view, ThemedReactContext reactContext, l config, Function0 callback) {
        ...
        this.f49864a = view;
        this.f49865b = reactContext;
        this.f49866c = config;
        this.f49867d = callback;
        this.f49868e = 2;
        this.f49869f = UIManagerHelper.getUIManager(reactContext.getReactApplicationContext(), 2);
        this.f49870g = UIManagerHelper.getEventDispatcher(reactContext.getReactApplicationContext(), 2);
    }
    ...
    public final void b() {
        EventDispatcher eventDispatcher = this.f49870g;
    ...
    */
    public void onEventDispatch(com.facebook.react.uimanager.events.Event r8) {
        ...
        L13:
            r0 = 0
            com.facebook.react.bridge.UIManager r1 = r7.f49869f     // Catch: java.lang.Exception -> L21
            if (r1 == 0) goto L23
        ...
        L24:
            ...
            goto L4a
        L2b:
            qm.a r2 = qm.a.f46623a
            java.lang.String r3 = sm.c.b()
        ...
        L65:
            ...
            com.facebook.react.uimanager.ThemedReactContext r3 = r7.f49865b
            r2.<init>(r3)
            android.view.ViewGroup$LayoutParams r3 = new android.view.ViewGroup$LayoutParams
            r4 = 0
            r3.<init>(r4, r4)
            r2.setLayoutParams(r3)
            com.facebook.react.views.view.ReactViewGroup r3 = r7.f49864a
            com.facebook.react.uimanager.ThemedReactContext r4 = r7.f49865b
            pm.l r5 = r7.f49866c
            pm.k r6 = new pm.k
            r6.<init>(r3, r0, r4, r5)
            r0.addView(r2)
            boolean r3 = sm.c.a()
            if (r3 == 0) goto Lac
            kotlin.jvm.functions.Function0 r3 = r7.f49867d
        ...
        Lbd:
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: sm.b.onEventDispatch(com.facebook.react.uimanager.events.Event):void");
    }
}
