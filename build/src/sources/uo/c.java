...
public final class c extends FrameLayout {
    ...
    public static final a f50543i = new a(null);

    /* renamed from: d  reason: collision with root package name */
    private final po.b f50544d;

    /* renamed from: e  reason: collision with root package name */
    private final e f50545e;

    /* loaded from: /home/runner/work/discord-client-datamining/discord-client-datamining/build/classes4.dex */
    public static final class a implements c0 {

        /* renamed from: a  reason: collision with root package name */
        private final /* synthetic */ f f50546a;

        /* JADX INFO: Access modifiers changed from: package-private */
        /* renamed from: uo.c$a$a  reason: collision with other inner class name */
        /* loaded from: /home/runner/work/discord-client-datamining/discord-client-datamining/build/classes4.dex */
        public /* synthetic */ class C0670a extends FunctionReferenceImpl implements Function2 {
            C0670a(Object obj) {
        ...
        public static final View c(d initialRendering, a0 initialEnv, Context context, ViewGroup viewGroup) {
            ...
            cVar.setId(f2.f42165h);
            cVar.setLayoutParams(new ViewGroup.LayoutParams(-1, -1));
            g0.a(cVar, initialRendering, initialEnv, new C0670a(cVar));
            return cVar;
        }
        ...
        public View a(d initialRendering, a0 initialViewEnvironment, Context contextForNewView, ViewGroup viewGroup) {
            ...
            return this.f50546a.a(initialRendering, initialViewEnvironment, contextForNewView, viewGroup);
        }

        @Override // wm.c0
        public KClass getType() {
            return this.f50546a.getType();
        }

        private a() {
            this.f50546a = new f(Reflection.getOrCreateKotlinClass(d.class), new Function4() { // from class: uo.b
    ...
    private final View b(d dVar, a0 a0Var) {
        ...
        if (currentView != null) {
            ...
            if (view != null) {
                this.f50545e.d(CollectionsKt.e(nVar));
        ...
        View c11 = f0.c((e0) a0Var.a(e0.f52313a), nVar, a0Var, context, this, new h0() { // from class: uo.a
            @Override // wm.h0
        ...
        g0.h(c11);
        this.f50545e.h(CollectionsKt.l(), currentView, c11);
        this.f50544d.f46411c.removeView(currentView);
        this.f50544d.f46411c.addView(c11);
    ...
    private final View getCurrentView() {
        if (this.f50544d.f46411c.getChildCount() > 0) {
            return this.f50544d.f46411c.getChildAt(0);
        }
        return null;
    }
    ...
    public final void d(d newRendering, a0 newViewEnvironment) {
        ...
        if (!isEnabled()) {
            b10.setAlpha(0.5f);
            this.f50544d.f46410b.setVisibility(0);
            return;
        }
        b10.setAlpha(1.0f);
        this.f50544d.f46410b.setVisibility(8);
    }
    ...
    protected void onAttachedToWindow() {
        ...
        this.f50545e.a(g.a.b(aVar, c10, null, 2, null), c11);
    }
    ...
    protected Parcelable onSaveInstanceState() {
        ...
        if (onSaveInstanceState != null) {
            return new b(onSaveInstanceState, this.f50545e.g());
        }
        return null;
    }
    ...
    public static final class b extends View.BaseSavedState {
        ...
        public void writeToParcel(Parcel out, int i10) {
            ...
            out.writeParcelable(this.f50547d, i10);
        }
        ...
        public b(Parcel source) {
            ...
            this.f50547d = (e.a) readParcelable;
        }
    }
    ...
    public c(Context context, AttributeSet attributeSet, int i10, int i11) {
        ...
        Intrinsics.checkNotNullParameter(context, "context");
        po.b b10 = po.b.b(LayoutInflater.from(context), this);
