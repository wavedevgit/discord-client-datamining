...
public final class f0 implements gn.k {
    ...
    public static final a f51399d = new a(null);

    /* renamed from: b  reason: collision with root package name */
    private final xo.i f51400b;

    /* renamed from: c  reason: collision with root package name */
    private final tq.k f51401c;

    /* loaded from: /home/runner/work/discord-client-datamining/discord-client-datamining/build/classes4.dex */
    public static final class a implements gn.c0 {

        /* renamed from: a  reason: collision with root package name */
        private final /* synthetic */ gn.c0 f51402a;
        ...
        /* synthetic */ class C0699a extends FunctionReferenceImpl implements Function3 {
            ...
            /* renamed from: d  reason: collision with root package name */
            public static final C0699a f51403d = new C0699a();
        ...
        /* synthetic */ class b extends FunctionReferenceImpl implements Function1 {
            ...
            /* renamed from: d  reason: collision with root package name */
            public static final b f51404d = new b();
        ...
        public View a(f5.a initialRendering, gn.a0 initialViewEnvironment, Context contextForNewView, ViewGroup viewGroup) {
            ...
            return this.f51402a.a(initialRendering, initialViewEnvironment, contextForNewView, viewGroup);
        }

        @Override // gn.c0
        public KClass getType() {
            return this.f51402a.getType();
        }

        private a() {
            k.a aVar = gn.k.f25849a;
            this.f51402a = new gn.z(Reflection.getOrCreateKotlinClass(f5.a.class), C0699a.f51403d, b.f51404d);
        }
    }
    ...
    public f0(xo.i binding) {
        ...
        this.f51401c = new tq.k(root);
        LinearLayout contentView = binding.f55621b;
    ...
    private final void j(xo.i iVar, StepStyles.GovernmentIdStepStyle governmentIdStepStyle, gn.a0 a0Var) {
        ...
        if (governmentIdStepStyle != null) {
            ...
            if (textStyle != null && (base5 = textStyle.getBase()) != null && (base6 = base5.getBase()) != null) {
                TextView countrySelectorText = iVar.f55624e;
                ...
                TextView idClassSelectorText = iVar.f55626g;
            ...
            if (buttonPrimaryStyle != null && (base = buttonPrimaryStyle.getBase()) != null && (base2 = base.getBase()) != null) {
                Button continueButton = iVar.f55622c;
    ...
    private final void k(c2 c2Var, final Function1 function1) {
        this.f51401c.u(c2Var, new Function1() { // from class: uo.e0
            @Override // kotlin.jvm.functions.Function1
    ...
    public void a(final f5.a rendering, gn.a0 viewEnvironment) {
        ...
        iVar.f55623d.setOnClickListener(new View.OnClickListener() { // from class: uo.z
            @Override // android.view.View.OnClickListener
            public final void onClick(View view) {
                f0.p(f0.this, rendering, view);
            }
        });
        EditText editText = iVar.f55623d.getEditText();
        if (editText != null) {
        ...
        EditText editText2 = iVar.f55623d.getEditText();
        if (editText2 != null) {
            editText2.setText(str);
        }
        if (str != null) {
            iVar.f55625f.setEnabled(true);
            EditText editText3 = iVar.f55625f.getEditText();
            if (editText3 != null) {
                editText3.setEnabled(true);
            }
            iVar.f55625f.setOnClickListener(new View.OnClickListener() { // from class: uo.b0
                @Override // android.view.View.OnClickListener
                public final void onClick(View view) {
                    f0.r(f0.this, rendering, view);
                }
            });
            EditText editText4 = iVar.f55625f.getEditText();
            if (editText4 != null) {
            ...
            EditText editText5 = iVar.f55625f.getEditText();
            if (editText5 != null) {
            ...
            iVar.f55625f.setEnabled(false);
            EditText editText6 = iVar.f55625f.getEditText();
            if (editText6 != null) {
                editText6.setEnabled(false);
            }
        }
        iVar.f55624e.setText(rendering.b());
        iVar.f55626g.setText(rendering.d());
        iVar.f55622c.setEnabled(rendering.n());
        iVar.f55622c.setOnClickListener(new View.OnClickListener() { // from class: uo.d0
            @Override // android.view.View.OnClickListener
            public final void onClick(View view) {
                f0.t(f5.a.this, view);
            }
        });
        iVar.f55622c.setText(rendering.a());
