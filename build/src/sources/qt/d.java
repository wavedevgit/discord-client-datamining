...
public abstract class d {
    ...
    private static final boolean f47222a;

    /* renamed from: b  reason: collision with root package name */
    private static final d f47223b;

    /* renamed from: c  reason: collision with root package name */
    private static final boolean f47224c;
    ...
    static {
        ...
        try {
            f47223b = (d) Class.forName(property).newInstance();
        } catch (Exception e10) {
