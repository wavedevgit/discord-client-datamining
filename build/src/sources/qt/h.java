...
public final class h implements r {
    ...
    public static /* synthetic */ class a {
        ...
        static {
            ...
            try {
                f47891a[v.ABBREVIATED.ordinal()] = 2;
            } catch (NoSuchFieldError unused2) {
            }
            try {
                f47891a[v.SHORT.ordinal()] = 3;
            } catch (NoSuchFieldError unused3) {
            }
            try {
                f47891a[v.NARROW.ordinal()] = 4;
    ...
    private static String F(char c10, v vVar, n nVar) {
        ...
        sb2.append(c10);
        int i10 = a.f47891a[vVar.ordinal()];
        if (i10 != 1) {
            if (i10 != 2 && i10 != 3) {
                if (i10 == 4) {
                    sb2.append('n');
    ...
    @Override // lt.x
    public String g(Locale locale, v vVar, int i10) {
        String str;
        int i11;
        if (i10 >= 2) {
    ...
    @Override // lt.r
    public String l(y0 y0Var, Locale locale) {
    ...
    @Override // lt.x
    public String v(Locale locale, boolean z10, n nVar) {
        return K(locale, 'D', z10, nVar);
    }
    ...
    @Override // lt.r
    public String y(y0 y0Var, Locale locale) {
        return I(locale, y0Var.name().substring(0, 3).toLowerCase() + "+");
    }
