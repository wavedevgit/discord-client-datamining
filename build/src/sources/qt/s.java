...
public final class s {
    ...
    public s(String[] strArr) {
        this.f48186a = Collections.unmodifiableList(Arrays.asList(strArr));
    }
        ...
        while (i12 < enumArr.length) {
            ...
            if (isEmpty) {
                if (i12 >= size) {
                    ...
                    str3 = (String) this.f48186a.get(i12);
                }
            }
    ...
    public Enum c(CharSequence charSequence, ParsePosition parsePosition, Class cls, pt.d dVar) {
        pt.c cVar = a.f48094i;
        Boolean bool = Boolean.TRUE;
        return e(charSequence, parsePosition, cls, ((Boolean) dVar.a(cVar, bool)).booleanValue(), ((Boolean) dVar.a(a.f48095j, Boolean.FALSE)).booleanValue(), ((Boolean) dVar.a(a.f48096k, bool)).booleanValue());
    }
    ...
    public String f(Enum r32) {
        ...
        if (this.f48186a.size() <= ordinal) {
            return r32.name();
        }
        return (String) this.f48186a.get(ordinal);
    }
    ...
    public String toString() {
        ...
        for (int i10 = 0; i10 < size; i10++) {
            ...
            sb2.append((String) this.f48186a.get(i10));
        }
        sb2.append('}');
        return sb2.toString();
    }
