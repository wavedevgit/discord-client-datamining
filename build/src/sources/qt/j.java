...
public abstract class j {
    ...
    public static final j f48146d;

    /* renamed from: e  reason: collision with root package name */
    public static final j f48147e;

    /* renamed from: i  reason: collision with root package name */
    public static final j f48148i;

    /* renamed from: o  reason: collision with root package name */
    public static final j f48149o;

    /* renamed from: p  reason: collision with root package name */
    public static final j f48150p;

    /* renamed from: q  reason: collision with root package name */
    public static final j f48151q;

    /* renamed from: r  reason: collision with root package name */
    public static final j f48152r;

    /* renamed from: s  reason: collision with root package name */
    public static final j f48153s;

    /* renamed from: t  reason: collision with root package name */
    public static final j f48154t;

    /* renamed from: u  reason: collision with root package name */
    public static final j f48155u;

    /* renamed from: v  reason: collision with root package name */
    public static final j f48156v;

    /* renamed from: w  reason: collision with root package name */
    public static final j f48157w;

    /* renamed from: x  reason: collision with root package name */
    public static final j f48158x;

    /* renamed from: y  reason: collision with root package name */
    public static final j f48159y;

    /* renamed from: z  reason: collision with root package name */
    public static final j f48160z;
    ...
    enum g extends j {
        ...
        @Override // qt.j
        public int r(String str, qt.g gVar) {
    ...
    static {
        ...
        f48146d = gVar;
        j jVar = new j("ARABIC_INDIC", 1, "arab") { // from class: qt.j.h
            @Override // qt.j
            public String m() {
                return "٠١٢٣٤٥٦٧٨٩";
            }
        ...
        f48147e = jVar;
        j jVar2 = new j("ARABIC_INDIC_EXT", 2, "arabext") { // from class: qt.j.i
            @Override // qt.j
            public String m() {
                return "۰۱۲۳۴۵۶۷۸۹";
            }
        ...
        f48148i = jVar2;
        j jVar3 = new j("BENGALI", 3, "beng") { // from class: qt.j.j
            @Override // qt.j
            public String m() {
                return "০১২৩৪৫৬৭৮৯";
            }
        ...
        f48149o = jVar3;
        j jVar4 = new j("DEVANAGARI", 4, "deva") { // from class: qt.j.k
            @Override // qt.j
            public String m() {
                return "०१२३४५६७८९";
            }
        ...
        f48150p = jVar4;
        j jVar5 = new j("DOZENAL", 5, "dozenal") { // from class: qt.j.l
            @Override // qt.j
            public boolean k(char c10) {
            ...
            @Override // qt.j
            public int r(String str, qt.g gVar2) {
        ...
        f48151q = jVar5;
        j jVar6 = new j("ETHIOPIC", 6, "ethiopic") { // from class: qt.j.m
            @Override // qt.j
            public boolean k(char c10) {
            ...
            */
            public java.lang.String t(int r11) {
                ...
                L84:
                    ...
                    throw r0
                */
                throw new UnsupportedOperationException("Method not decompiled: qt.j.m.t(int):java.lang.String");
            }
        };
        f48152r = jVar6;
        j jVar7 = new j("GUJARATI", 7, "gujr") { // from class: qt.j.n
            @Override // qt.j
            public String m() {
                return "૦૧૨૩૪૫૬૭૮૯";
            }
        ...
        f48153s = jVar7;
        j jVar8 = new j("JAPANESE", 8, "jpan") { // from class: qt.j.o
            @Override // qt.j
            public String m() {
                return "一二三四五六七八九十百千";
            }
        ...
        f48154t = jVar8;
        j jVar9 = new j("KHMER", 9, "khmr") { // from class: qt.j.a
            @Override // qt.j
            public String m() {
                return "០១២៣៤៥៦៧៨៩";
            }
        ...
        f48155u = jVar9;
        j jVar10 = new j("MYANMAR", 10, "mymr") { // from class: qt.j.b
            @Override // qt.j
            public String m() {
                return "၀၁၂၃၄၅၆၇၈၉";
            }
        ...
        f48156v = jVar10;
        j jVar11 = new j("ORYA", 11, "orya") { // from class: qt.j.c
            @Override // qt.j
            public String m() {
                return "୦୧୨୩୪୫୬୭୮୯";
            }
        ...
        f48157w = jVar11;
        j jVar12 = new j("ROMAN", 12, "roman") { // from class: qt.j.d
            @Override // qt.j
            public boolean k(char c10) {
            ...
            /*
                ...
                To view partially-correct add '--show-bad-code' argument
            */
            public int r(java.lang.String r12, qt.g r13) {
                /*
                    Method dump skipped, instructions count: 221
                    To view this dump add '--comments-level debug' option
                */
                throw new UnsupportedOperationException("Method not decompiled: qt.j.d.r(java.lang.String, qt.g):int");
            }
        ...
        f48158x = jVar12;
        j jVar13 = new j("TELUGU", 13, "telu") { // from class: qt.j.e
            @Override // qt.j
            public String m() {
                return "౦౧౨౩౪౫౬౭౮౯";
            }
        ...
        f48159y = jVar13;
        j jVar14 = new j("THAI", 14, "thai") { // from class: qt.j.f
            @Override // qt.j
            public String m() {
                return "๐๑๒๓๔๕๖๗๘๙";
            }
    ...
    public static int i(int i10, int i11, int i12) {
        return nt.c.e(i10, nt.c.h(i11, i12));
    }
