...
public final class f {
    ...
    private File f22173c;

    public f(Context context) {
        this.f22172b = context;
        this.f22171a = context.getPackageManager().getPackageInfo(context.getPackageName(), 0).versionCode;
    }
    ...
    private final File v() {
        if (this.f22173c == null) {
            ...
            if (context != null) {
                this.f22173c = context.getFilesDir();
            } else {
                throw new IllegalStateException("context must be non-null to populate null filesDir");
            }
        }
        File file = new File(this.f22173c, "splitcompat");
        u(file);
        return file;
    }

    private final File w() {
        File file = new File(v(), Long.toString(this.f22171a));
        u(file);
        return file;
    }
    ...
    public final void k() {
        ...
        if (list != null) {
            for (String str : list) {
                if (!str.equals(Long.toString(this.f22171a))) {
                    File file = new File(v10, str);
                    Log.d("SplitCompat", "FileStorage: removing directory for different version code (directory = " + file.toString() + ", current version code = " + this.f22171a + ")");
                    l(file);
                }
            }
        }
