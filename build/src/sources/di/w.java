...
public abstract class w {
    ...
    private static final i f20841a = new i("PhoneskyVerificationUtils");
        ...
        try {
            if (context.getPackageManager().getApplicationInfo("com.android.vending", 0).enabled) {
                ...
                if (signatureArr != null && (r0 = signatureArr.length) != 0) {
                    ...
                    f20841a.e("Phonesky package is not signed -- possibly self-built package. Could not verify.", new Object[0]);
                }
            }
