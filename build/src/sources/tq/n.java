...
public final class n extends RecyclerView.Adapter {
    ...
    private final List f50440a;

    /* renamed from: b  reason: collision with root package name */
    private final InputSelectBoxComponentStyle f50441b;

    /* renamed from: c  reason: collision with root package name */
    private final boolean f50442c;

    /* renamed from: d  reason: collision with root package name */
    private final Function1 f50443d;

    /* renamed from: e  reason: collision with root package name */
    private String f50444e;

    /* renamed from: f  reason: collision with root package name */
    private final LayoutInflater f50445f;

    /* renamed from: g  reason: collision with root package name */
    private Set f50446g;

    /* renamed from: h  reason: collision with root package name */
    private final androidx.recyclerview.widget.c f50447h;
    ...
    public n(Context context, List options, InputSelectBoxComponentStyle inputSelectBoxComponentStyle, boolean z10, List initialSelectedOptions, Function1 onClick) {
        ...
        this.f50440a = options;
        this.f50441b = inputSelectBoxComponentStyle;
        this.f50442c = z10;
        this.f50443d = onClick;
        this.f50445f = LayoutInflater.from(context);
        this.f50447h = new androidx.recyclerview.widget.c(this, new a());
        ...
        this.f50446g = CollectionsKt.k1(arrayList2);
        h();
    }
    ...
    private final void f(int i10) {
        ...
        b4 b4Var = (b4) this.f50447h.a().get(i10);
        if (this.f50446g.contains(b4Var)) {
            this.f50446g.remove(b4Var);
        } else {
            Set set = this.f50446g;
            Intrinsics.checkNotNull(b4Var);
            set.add(b4Var);
        }
        notifyItemChanged(i10);
        Function1 function1 = this.f50443d;
        Intrinsics.checkNotNull(b4Var);
        function1.invoke(b4Var);
    }

    public final List c() {
        return CollectionsKt.h1(this.f50446g);
    }
    ...
    public void onBindViewHolder(final RecyclerView.ViewHolder holder, int i10) {
        ...
        qVar.f48850c.setText(b4Var.getText());
        ...
        qVar.f48849b.setOnClickListener(new View.OnClickListener() { // from class: tq.m
            @Override // android.view.View.OnClickListener
            public final void onClick(View view) {
                n.e(n.this, holder, view);
            }
        });
        boolean contains = this.f50446g.contains(b4Var);
        qVar.f48849b.setChecked(contains);
        InputSelectBoxComponentStyle inputSelectBoxComponentStyle = this.f50441b;
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int i10) {
        ...
        q c10 = q.c(this.f50445f, parent, false);
        ...
        if (inputSelectBoxComponentStyle != null) {
            TextView label = qVar.f48850c;
            Intrinsics.checkNotNullExpressionValue(label, "label");
            f0.n(label, inputSelectBoxComponentStyle.getTextBasedStyle(), null, 2, null);
        }
        if (this.f50442c) {
            qVar.f48849b.setVisibility(0);
            qVar.f48849b.setButtonTintList(ColorStateList.valueOf(qVar.f48850c.getCurrentTextColor()));
            return b0Var;
        }
        qVar.f48849b.setVisibility(8);
        return b0Var;
    }
}
