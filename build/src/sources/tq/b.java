...
import ss.g;
@Metadata(d1 = {"\u0000\"\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0000\n\u0002\u0010\u000e\n\u0002\b\u0003\n\u0002\u0018\u0002\n\u0002\b\b\u0018\u00002\b\u0012\u0004\u0012\u00020\u00020\u0001:\u0002\f\u0010B\u0019\u0012\u0006\u0010\u0004\u001a\u00020\u0003\u0012\b\u0010\u0006\u001a\u0004\u0018\u00010\u0005¢\u0006\u0004\b\u0007\u0010\bJ\u0015\u0010\n\u001a\b\u0012\u0004\u0012\u00020\u00020\tH\u0016¢\u0006\u0004\b\n\u0010\u000bR\u0014\u0010\u0004\u001a\u00020\u00038\u0002X\u0082\u0004¢\u0006\u0006\n\u0004\b\f\u0010\rR\u0016\u0010\u0006\u001a\u0004\u0018\u00010\u00058\u0002X\u0082\u0004¢\u0006\u0006\n\u0004\b\u000e\u0010\u000f¨\u0006\u0011"}, d2 = {"Ltq/b;", "Lcn/o;", "Ltq/b$b;", "Ltq/a;", "service", "", "jwt", "<init>", "(Ltq/a;Ljava/lang/String;)V", "Lkotlinx/coroutines/flow/Flow;", "run", "()Lkotlinx/coroutines/flow/Flow;", "b", "Ltq/a;", "c", "Ljava/lang/String;", "a", "webrtc_release"}, k = 1, mv = {2, 0, 0}, xi = 48)
/* loaded from: /home/runner/work/discord-client-datamining/discord-client-datamining/build/classes4.dex */
public final class b implements o<AbstractC0697b> {

    /* renamed from: b  reason: collision with root package name */
    private final tq.a f50899b;
    ...
    public static final class a {
        ...
        private final tq.a f50901a;

        public a(tq.a service) {
            Intrinsics.checkNotNullParameter(service, "service");
            this.f50901a = service;
        }

        public final b a(String str) {
            return new b(this.f50901a, str);
        }
    ...
    public static abstract class AbstractC0697b {
        ...
        public static final class a extends AbstractC0697b {
            ...
            /* renamed from: a  reason: collision with root package name */
            private final InternalErrorInfo f50902a;
            ...
            public boolean equals(Object obj) {
                ...
                if ((obj instanceof a) && Intrinsics.areEqual(this.f50902a, ((a) obj).f50902a)) {
                    return true;
                }
                return false;
            }
            ...
            public String toString() {
                InternalErrorInfo internalErrorInfo = this.f50902a;
        ...
        public static final class C0698b extends AbstractC0697b {
            ...
            /* renamed from: a  reason: collision with root package name */
            private final AuthorizeWebRtcResponse f50903a;

            /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
            public C0698b(AuthorizeWebRtcResponse result) {
                super(null);
    ...
    static final class c extends k implements Function2 {
        ...
        public static final class a extends k implements Function1 {
            ...
            public final Continuation create(Continuation continuation) {
                return new a(this.f50909e, continuation);
            }
            ...
            public final Object invokeSuspend(Object obj) {
                ...
                kotlin.c.b(obj);
                tq.a aVar = this.f50909e.f50899b;
                String str = this.f50909e.f50900c;
                this.f50908d = 1;
        ...
        */
        public final java.lang.Object invokeSuspend(java.lang.Object r15) {
            /*
                ...
                if (r1 == r4) goto L26
                if (r1 != r3) goto L1e
                java.lang.Object r0 = r14.f50906i
            ...
            L1e:
                ...
                throw r15
            L26:
                java.lang.Object r1 = r14.f50904d
                ...
                java.lang.Object r4 = r14.f50906i
                kotlinx.coroutines.flow.FlowCollector r4 = (kotlinx.coroutines.flow.FlowCollector) r4
                kotlin.c.b(r15)
                goto L7c
            L32:
                java.lang.Object r1 = r14.f50906i
                kotlinx.coroutines.flow.FlowCollector r1 = (kotlinx.coroutines.flow.FlowCollector) r1
                kotlin.c.b(r15)
                goto L57
            L3a:
                kotlin.c.b(r15)
                java.lang.Object r15 = r14.f50906i
                kotlinx.coroutines.flow.FlowCollector r15 = (kotlinx.coroutines.flow.FlowCollector) r15
                tq.b$c$a r1 = new tq.b$c$a
                tq.b r7 = tq.b.this
                r1.<init>(r7, r2)
                r14.f50906i = r15
                r14.f50905e = r6
            ...
            Lba:
                return r0
            Lbb:
                kotlin.Unit r15 = kotlin.Unit.f31765a
                return r15
            */
    ...
    public b(tq.a service, String str) {
        Intrinsics.checkNotNullParameter(service, "service");
        this.f50899b = service;
        this.f50900c = str;
    }
