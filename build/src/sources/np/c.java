...
public final class c {
    ...
    private final e f42028a;

    /* renamed from: b  reason: collision with root package name */
    private final CoroutineScope f42029b;
    ...
    public static final class a extends k implements Function2 {
        ...
        public final Continuation create(Object obj, Continuation continuation) {
            return new a(this.f42033i, continuation);
        }

        @Override // kotlin.coroutines.jvm.internal.a
        public final Object invokeSuspend(Object obj) {
            Object f10 = or.b.f();
            int i10 = this.f42031d;
            if (i10 != 0) {
                if (i10 == 1) {
                    kotlin.c.b(obj);
                } else {
                ...
                kotlin.c.b(obj);
                MutableSharedFlow a10 = c.this.f42028a.a();
                lo.b bVar = this.f42033i;
                this.f42031d = 1;
    ...
    public c(e externalInquiryController) {
        ...
        this.f42028a = externalInquiryController;
        this.f42029b = kotlinx.coroutines.i.a(m0.a().U0(j1.b(null, 1, null)));
    }

    public final void b(lo.b inquiryEvent) {
        Intrinsics.checkNotNullParameter(inquiryEvent, "inquiryEvent");
        gs.i.d(this.f42029b, null, null, new a(inquiryEvent, null), 3, null);
    }

    public final void c(i page) {
        Intrinsics.checkNotNullParameter(page, "page");
        if (Intrinsics.areEqual(this.f42030c, page)) {
            return;
        }
        this.f42030c = page;
