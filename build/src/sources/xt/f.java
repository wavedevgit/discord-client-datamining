...
public final class f implements st.i {
    ...
    private static final Locale[] f54812b = new Locale[0];

    /* renamed from: c  reason: collision with root package name */
    public static final Set f54813c;

    /* renamed from: d  reason: collision with root package name */
    public static final f f54814d;

    /* renamed from: e  reason: collision with root package name */
    private static final Map f54815e;
    ...
    static {
        ...
        f54813c = Collections.unmodifiableSet(hashSet);
        f54814d = new f();
        HashMap hashMap = new HashMap();
        for (j jVar : j.values()) {
            hashMap.put(jVar.k(), jVar);
        }
        f54815e = Collections.unmodifiableMap(hashMap);
    }

    private static e g(Locale locale) {
        if (f54813c.contains(d.a(locale))) {
    ...
    public char b(Locale locale) {
        return h(locale, "separator", st.i.f50169a.b(locale));
    }

    @Override // st.i
    public String c(Locale locale) {
        return i(locale, "plus", st.i.f50169a.c(locale));
    }

    @Override // st.i
    public j d(Locale locale) {
        String i10 = i(locale, "numsys", j.f50170d.k());
        j jVar = (j) f54815e.get(i10);
        if (jVar != null) {
            return jVar;
        }
    ...
    public String e(Locale locale) {
        return i(locale, "minus", st.i.f50169a.e(locale));
    }

    @Override // st.i
    public char f(Locale locale) {
        return h(locale, "zero", st.i.f50169a.f(locale));
    }
