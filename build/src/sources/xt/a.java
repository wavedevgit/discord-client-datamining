...
public abstract class a implements l {
    ...
    public static final C0767a f55721b = new C0767a(null);

    /* renamed from: a  reason: collision with root package name */
    private final wt.b f55722a;
    ...
    public abstract class b extends g1 {
        ...
        private final Map f55723c;

        /* renamed from: d  reason: collision with root package name */
        private final wt.b f55724d;

        /* renamed from: e  reason: collision with root package name */
        private int f55725e;

        /* renamed from: f  reason: collision with root package name */
        private final boolean f55726f;

        /* renamed from: g  reason: collision with root package name */
        private final int f55727g;

        /* renamed from: h  reason: collision with root package name */
        final /* synthetic */ a f55728h;
        ...
        public b(a aVar, Map map, SerialDescriptor descriptor) {
            ...
            this.f55723c = map;
            this.f55724d = aVar.a();
            if (!Intrinsics.areEqual(descriptor.getKind(), l.b.f48949a) && !Intrinsics.areEqual(descriptor.getKind(), l.c.f48950a)) {
                z10 = false;
            } else {
                z10 = true;
            }
        ...
        public final Object G(DeserializationStrategy deserializer) {
            ...
            if (deserializer instanceof tt.b) {
                Object obj = this.f55723c.get(k0("type"));
                if (obj != null) {
                    str = obj.toString();
                } else {
                    str = null;
        ...
        public final int S(String tag, SerialDescriptor enumDescriptor) {
            ...
            Object j10 = o0.j(this.f55723c, tag);
    ...
    public final class c extends b {
        ...
        public c p0(SerialDescriptor descriptor) {
            Intrinsics.checkNotNullParameter(descriptor, "descriptor");
            return new c(this.f55729i, o0(), descriptor);
        }
    }
    ...
    public abstract class e extends h1 {
        ...
        /* renamed from: b  reason: collision with root package name */
        private final wt.b f55731b;

        /* renamed from: c  reason: collision with root package name */
        private final Map f55732c = new LinkedHashMap();

        public e() {
            this.f55731b = a.this.a();
        }
        ...
        public void M(String tag, SerialDescriptor enumDescriptor, int i10) {
            Intrinsics.checkNotNullParameter(tag, "tag");
            Intrinsics.checkNotNullParameter(enumDescriptor, "enumDescriptor");
            this.f55732c.put(tag, g0(enumDescriptor.e(i10)));
        }
