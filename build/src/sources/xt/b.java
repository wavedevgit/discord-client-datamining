...
public class b implements s {
    ...
    public q f(q qVar, net.time4j.history.d dVar, rt.d dVar2) {
        ...
        if (qVar.n(dVar.i())) {
        ...
        } else if (((st.g) dVar2.b(st.a.f50163f, st.g.SMART)).a()) {
            jVar2 = j.AD;
        } else {
            jVar = null;
            if (jVar == null && qVar.n(dVar.M())) {
                ...
                if (qVar.n(dVar.C()) && qVar.n(dVar.g())) {
                    ...
                    return qVar.E(f0.f39354z, (f0) dVar.d(dVar.m(jVar, q10)).C(dVar.h(), q11));
                } else {
                    return qVar;
                }
            }
