...
public abstract class h {
    ...
    public static Shader b(Resources resources, XmlPullParser xmlPullParser, AttributeSet attributeSet, Resources.Theme theme) {
        ...
        if (name.equals("gradient")) {
            ...
            if (g10 != 1) {
                if (g10 != 2) {
                    return new LinearGradient(f10, f11, f12, f13, a10.f46360a, a10.f46361b, d(g11));
                }
                return new SweepGradient(f14, f15, a10.f46360a, a10.f46361b);
            } else if (f16 > 0.0f) {
                return new RadialGradient(f14, f15, f16, a10.f46360a, a10.f46361b, d(g11));
            } else {
    ...
    */
    ...
    public static final class a {
        ...
        a(List list, List list2) {
            int size = list.size();
            this.f46360a = new int[size];
            this.f46361b = new float[size];
            for (int i10 = 0; i10 < size; i10++) {
                this.f46360a[i10] = ((Integer) list.get(i10)).intValue();
                this.f46361b[i10] = ((Float) list2.get(i10)).floatValue();
            }
        }

        a(int i10, int i11) {
            this.f46360a = new int[]{i10, i11};
            this.f46361b = new float[]{0.0f, 1.0f};
        }

        a(int i10, int i11, int i12) {
            this.f46360a = new int[]{i10, i11, i12};
            this.f46361b = new float[]{0.0f, 0.5f, 1.0f};
        }
    }
}
