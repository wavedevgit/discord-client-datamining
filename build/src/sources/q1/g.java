...
public abstract class g {
    ...
    private static b f(XmlPullParser xmlPullParser, Resources resources) {
        TypedArray obtainAttributes = resources.obtainAttributes(Xml.asAttributeSet(xmlPullParser), o1.g.f39038h);
        String string = obtainAttributes.getString(o1.g.f39039i);
        String string2 = obtainAttributes.getString(o1.g.f39044n);
        String string3 = obtainAttributes.getString(o1.g.f39045o);
        String string4 = obtainAttributes.getString(o1.g.f39041k);
        int resourceId = obtainAttributes.getResourceId(o1.g.f39040j, 0);
        int integer = obtainAttributes.getInteger(o1.g.f39042l, 1);
        int integer2 = obtainAttributes.getInteger(o1.g.f39043m, 500);
        String string5 = obtainAttributes.getString(o1.g.f39046p);
    ...
    private static d g(XmlPullParser xmlPullParser, Resources resources) {
        ...
        int i13;
        int i14;
        TypedArray obtainAttributes = resources.obtainAttributes(Xml.asAttributeSet(xmlPullParser), o1.g.f39047q);
        if (obtainAttributes.hasValue(o1.g.f39056z)) {
            i10 = o1.g.f39056z;
        } else {
            i10 = o1.g.f39049s;
        }
        int i15 = obtainAttributes.getInt(i10, ReactFontManager.TypefaceStyle.NORMAL);
        if (obtainAttributes.hasValue(o1.g.f39054x)) {
            i11 = o1.g.f39054x;
        } else {
            i11 = o1.g.f39050t;
        }
        ...
        if (obtainAttributes.hasValue(o1.g.f39055y)) {
            i13 = o1.g.f39055y;
        } else {
            i13 = o1.g.f39052v;
        }
        ...
        if (obtainAttributes.hasValue(o1.g.f39053w)) {
            i14 = o1.g.f39053w;
        } else {
            i14 = o1.g.f39048r;
        }
