...
public class e extends d {
    ...
    private static final String f44316q = "pl.e";

    /* renamed from: e  reason: collision with root package name */
    private final a f44317e;

    /* renamed from: i  reason: collision with root package name */
    private final MediaFormat f44318i;

    /* renamed from: o  reason: collision with root package name */
    private final MediaCodec f44319o;

    /* renamed from: p  reason: collision with root package name */
    private final MediaCodecList f44320p;
    ...
    private String b(MediaCodec mediaCodec) {
        try {
            ...
            Log.e(f44316q, "Failed to retrieve media codec info.");
            return "";
        }
    }
    ...
    private String d(MediaCodecList mediaCodecList) {
        ...
        try {
            ...
            Log.e(f44316q, "Failed to retrieve media codec info.", e10);
        }
        return sb2.toString();
    }
    ...
    public String toString() {
        ...
        if (this.f44318i != null) {
            str = str + "Media format: " + this.f44318i.toString() + '\n';
        }
        if (this.f44319o != null) {
            str = str + "Selected media codec info: " + b(this.f44319o) + '\n';
        }
        if (this.f44320p != null) {
            str = str + "Available media codec info list (Name, IsEncoder, Supported Types): " + d(this.f44320p);
        }
        if (getCause() != null) {
    ...
    public e(a aVar, MediaFormat mediaFormat, MediaCodec mediaCodec, MediaCodecList mediaCodecList, Throwable th2) {
        super(th2);
        this.f44317e = aVar;
        this.f44318i = mediaFormat;
        this.f44319o = mediaCodec;
        this.f44320p = mediaCodecList;
    }
}
