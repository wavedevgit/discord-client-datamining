...
public final class g {
    ...
    public static final a f38405i = new a(null);

    /* renamed from: j  reason: collision with root package name */
    private static final g f38406j = new g();
    ...
    private ListenableFuture f38409c;

    /* renamed from: d  reason: collision with root package name */
    private ListenableFuture f38410d;

    /* renamed from: e  reason: collision with root package name */
    private final o0.c f38411e;

    /* renamed from: f  reason: collision with root package name */
    private v f38412f;

    /* renamed from: g  reason: collision with root package name */
    private Context f38413g;

    /* renamed from: h  reason: collision with root package name */
    private final Map f38414h;
    ...
    public static final class a {
        ...
        /* loaded from: /home/runner/work/discord-client-datamining/discord-client-datamining/build/classes.dex */
        static final class C0542a extends Lambda implements Function1 {

            /* renamed from: d  reason: collision with root package name */
            final /* synthetic */ Context f38415d;

            /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
            C0542a(Context context) {
                super(1);
                this.f38415d = context;
            }
            ...
            public final g invoke(v cameraX) {
                ...
                gVar.w(cameraX);
                g gVar2 = g.f38406j;
                Context a10 = b0.e.a(this.f38415d);
        ...
        public final ListenableFuture b(Context context) {
            ...
            b2.e.g(context);
            ListenableFuture s10 = g.f38406j.s(context);
            final C0542a c0542a = new C0542a(context);
    ...
    public static final class b implements d0.c {
        ...
        /* renamed from: a  reason: collision with root package name */
        final /* synthetic */ c.a f38416a;

        /* renamed from: b  reason: collision with root package name */
        final /* synthetic */ v f38417b;
    ...
    public final a0.w p(p pVar, o oVar) {
        ...
        while (it.hasNext()) {
            ...
            x.n nVar = (x.n) next;
            if (!Intrinsics.areEqual(nVar.a(), x.n.f54096a)) {
                y a10 = b1.a(nVar.a());
                Context context = this.f38413g;
    ...
    public final ListenableFuture s(Context context) {
        synchronized (this.f38407a) {
            ListenableFuture listenableFuture = this.f38409c;
            ...
            final v vVar = new v(context, this.f38408b);
            ListenableFuture a10 = androidx.concurrent.futures.c.a(new c.InterfaceC0026c() { // from class: o0.d
    ...
    public static final Object t(g this$0, v cameraX, c.a completer) {
        ...
        synchronized (this$0.f38407a) {
            d0.d b10 = d0.d.b(this$0.f38410d);
    ...
    public final i o(LifecycleOwner lifecycleOwner, p primaryCameraSelector, p pVar, x0 primaryLayoutSettings, x0 secondaryLayoutSettings, z1 z1Var, List effects, x1... useCases) {
        ...
        try {
            ...
            o0.b c10 = this.f38411e.c(lifecycleOwner, e0.f.B(g2Var2, g2Var));
            Collection e12 = this.f38411e.e();
            ...
            if (c10 == null) {
                o0.c cVar = this.f38411e;
                v vVar3 = this.f38412f;
                Intrinsics.checkNotNull(vVar3);
                y.a d10 = vVar3.e().d();
                v vVar4 = this.f38412f;
                Intrinsics.checkNotNull(vVar4);
                b0 d11 = vVar4.d();
                v vVar5 = this.f38412f;
    ...
    public o q(p cameraSelector) {
        ...
        try {
            ...
            synchronized (this.f38407a) {
                obj = this.f38414h.get(a10);
                if (obj == null) {
                    obj = new g2(l10, p10);
                    this.f38414h.put(a10, obj);
                }
                Unit unit = Unit.f31987a;
            }
            return (g2) obj;
