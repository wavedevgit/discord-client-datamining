...
public final class d implements h {
    ...
    private static final int[] f51386d = {8, 13, 11, 2, 0, 1, 7};
    ...
    private static void b(int i10, List list) {
        if (li.e.h(f51386d, i10) != -1 && !list.contains(Integer.valueOf(i10))) {
                    ...
                    if (i10 != 7) {
                        if (i10 != 8) {
                            if (i10 != 11) {
                                ...
                                return new t(format.f11294i, s0Var);
                            }
                            return f(this.f51387b, this.f51388c, format, list, s0Var);
                        }
