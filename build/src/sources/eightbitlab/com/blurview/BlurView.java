...
public class BlurView extends FrameLayout {
    ...
    private void a(AttributeSet attributeSet, int i10) {
        TypedArray obtainStyledAttributes = getContext().obtainStyledAttributes(attributeSet, d.f22844a, i10, 0);
        this.overlayColor = obtainStyledAttributes.getColor(d.f22845b, 0);
