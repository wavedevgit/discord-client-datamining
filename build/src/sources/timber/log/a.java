...
public abstract class a {
    ...
    public static final b f49881a = new b(null);

    /* renamed from: b  reason: collision with root package name */
    private static final ArrayList f49882b = new ArrayList();

    /* renamed from: c  reason: collision with root package name */
    private static volatile c[] f49883c = new c[0];

    /* renamed from: timber.log.a$a  reason: collision with other inner class name */
    /* loaded from: /home/runner/work/discord-client-datamining/discord-client-datamining/build/classes5.dex */
    public static class C0650a extends c {
    }
    ...
    public static final class b extends c {
        ...
        public final void c(c tree) {
            ...
            if (z10) {
                synchronized (a.f49882b) {
                    a.f49882b.add(tree);
                    Object[] array = a.f49882b.toArray(new c[0]);
                    if (array != null) {
                        a.f49883c = (c[]) array;
