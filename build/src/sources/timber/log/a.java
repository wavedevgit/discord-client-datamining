...
public abstract class a {
    ...
    public static final b f50653a = new b(null);

    /* renamed from: b  reason: collision with root package name */
    private static final ArrayList f50654b = new ArrayList();

    /* renamed from: c  reason: collision with root package name */
    private static volatile c[] f50655c = new c[0];

    /* renamed from: timber.log.a$a  reason: collision with other inner class name */
    /* loaded from: /home/runner/work/discord-client-datamining/discord-client-datamining/build/classes5.dex */
    public static class C0667a extends c {
    }
    ...
    public static final class b extends c {
        ...
        public final void c(c tree) {
            ...
            if (z10) {
                synchronized (a.f50654b) {
                    a.f50654b.add(tree);
                    Object[] array = a.f50654b.toArray(new c[0]);
                    if (array != null) {
                        a.f50655c = (c[]) array;
