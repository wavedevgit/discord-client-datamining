...
public abstract class a {
    ...
    public static final b f49504a = new b(null);

    /* renamed from: b  reason: collision with root package name */
    private static final ArrayList f49505b = new ArrayList();

    /* renamed from: c  reason: collision with root package name */
    private static volatile c[] f49506c = new c[0];
    ...
    public static final class b extends c {
        ...
        public final void c(c tree) {
            ...
            if (z10) {
                synchronized (a.f49505b) {
                    a.f49505b.add(tree);
                    Object[] array = a.f49505b.toArray(new c[0]);
                    if (array != null) {
                        a.f49506c = (c[]) array;
