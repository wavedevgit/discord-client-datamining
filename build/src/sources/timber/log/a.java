...
public abstract class a {
    ...
    public static final b f48936a = new b(null);

    /* renamed from: b  reason: collision with root package name */
    private static final ArrayList f48937b = new ArrayList();

    /* renamed from: c  reason: collision with root package name */
    private static volatile c[] f48938c = new c[0];
    ...
    public static final class b extends c {
        ...
        public final void c(c tree) {
            ...
            if (z10) {
                synchronized (a.f48937b) {
                    a.f48937b.add(tree);
                    Object[] array = a.f48937b.toArray(new c[0]);
                    if (array != null) {
                        a.f48938c = (c[]) array;
