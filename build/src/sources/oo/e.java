...
public final class e extends com.google.android.material.bottomsheet.b {
    ...
    public static final a f44591i = new a(null);
    ...
    private final void H(StepStyle stepStyle, po.a aVar, boolean z10) {
        ...
        if (stepStyle != null && (titleStyleValue = stepStyle.getTitleStyleValue()) != null) {
            TextView hintTitle = aVar.f46407f;
        ...
        if (stepStyle != null && (textStyleValue = stepStyle.getTextStyleValue()) != null) {
            TextView hintMessage = aVar.f46406e;
        ...
        if (stepStyle != null && (cancelDialogCloseStyleValue = stepStyle.getCancelDialogCloseStyleValue()) != null) {
            Button closeButton = aVar.f46404c;
            Intrinsics.checkNotNullExpressionValue(closeButton, "closeButton");
            dq.e.f(closeButton, cancelDialogCloseStyleValue, false, !z10, 2, null);
        }
        if (stepStyle != null && (cancelDialogResumeStyleValue = stepStyle.getCancelDialogResumeStyleValue()) != null) {
            Button retryButton = aVar.f46408g;
            Intrinsics.checkNotNullExpressionValue(retryButton, "retryButton");
            dq.e.f(retryButton, cancelDialogResumeStyleValue, false, !z10, 2, null);
        }
    }
    ...
    public static final void L(Dialog dialog, e eVar, DialogInterface dialogInterface) {
        StepStyle stepStyle;
        ViewGroup viewGroup = (ViewGroup) dialog.findViewById(f.f54417f);
        ...
        ConstraintLayout bottomSheetContent = eVar.J().f46403b;
        Intrinsics.checkNotNullExpressionValue(bottomSheetContent, "bottomSheetContent");
        dq.c.c(viewGroup, stepStyle2, bottomSheetContent, null, 4, null);
    }

    /* JADX INFO: Access modifiers changed from: private */
    public static final Unit M(po.a aVar, e eVar, n.b.a aVar2) {
        boolean z10 = true;
        if (aVar.f46404c.getLineCount() <= 1 && aVar.f46408g.getLineCount() <= 1) {
            z10 = false;
        } else {
            Button closeButton = aVar.f46404c;
            Intrinsics.checkNotNullExpressionValue(closeButton, "closeButton");
            ...
            if (layoutParams != null) {
                layoutParams.width = aVar.f46405d.getWidth();
                closeButton.setLayoutParams(layoutParams);
                Button retryButton = aVar.f46408g;
                Intrinsics.checkNotNullExpressionValue(retryButton, "retryButton");
                ViewGroup.LayoutParams layoutParams2 = retryButton.getLayoutParams();
                if (layoutParams2 != null) {
                    layoutParams2.width = aVar.f46405d.getWidth();
                    retryButton.setLayoutParams(layoutParams2);
                    aVar.f46405d.setReferencedIds(new int[]{aVar.f46404c.getId(), aVar.f46408g.getId()});
                } else {
    ...
    public Dialog onCreateDialog(Bundle bundle) {
        ...
        onCreateDialog.setOnShowListener(new DialogInterface.OnShowListener() { // from class: oo.d
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup viewGroup, Bundle bundle) {
        ...
        P(po.a.c(inflater, viewGroup, false));
        ...
        if (I != null) {
            ...
            if (dialog != null && (window = dialog.getWindow()) != null) {
                ...
                if (f10 != null && (backgroundColorValue = f10.getBackgroundColorValue()) != null) {
                    ...
                    d10 = s.d(context, yg.b.f54345o, null, false, 6, null);
                }
                kp.f0.a(window, d10);
            }
            final po.a J = J();
            String g10 = I.g();
            if (g10 != null) {
                J.f46407f.setText(g10);
            }
            String d11 = I.d();
            if (d11 != null) {
                J.f46406e.setText(d11);
            }
            String a10 = I.a();
            if (a10 != null) {
                J.f46404c.setText(a10);
            }
            String e10 = I.e();
            if (e10 != null) {
                J.f46408g.setText(e10);
            }
            J.f46408g.setOnClickListener(new View.OnClickListener() { // from class: oo.a
                @Override // android.view.View.OnClickListener
                public final void onClick(View view2) {
                    e.N(e.this, view2);
                }
            });
            J.f46404c.setOnClickListener(new View.OnClickListener() { // from class: oo.b
                @Override // android.view.View.OnClickListener
                public final void onClick(View view2) {
                    e.O(e.this, I, view2);
                }
            });
            Button closeButton = J.f46404c;
            Intrinsics.checkNotNullExpressionValue(closeButton, "closeButton");
            up.s.b(closeButton, new Function0() { // from class: oo.c
                @Override // kotlin.jvm.functions.Function0
                public final Object invoke() {
                    Unit M;
                    M = e.M(po.a.this, this, I);
                    return M;
                }
            });
            return;
