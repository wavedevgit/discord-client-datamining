...
public abstract class u2 {
    ...
    public static final List c(List list) {
        ...
        for (String str : list2) {
            arrayList.add(new d.a(str, a.f40669e, 0, 4, null));
        }
        return arrayList;
    }
    ...
    public static final String d(GenericFileUploadErrorResponse.DocumentErrorResponse documentErrorResponse, Context context) {
        if (documentErrorResponse instanceof GenericFileUploadErrorResponse.DocumentErrorResponse.DisabledFileTypeError) {
            ...
            String string = context.getString(tp.e.f49786d, disabledFileTypeError.getDetails().getUploadedFileType(), CollectionsKt.x0(disabledFileTypeError.getDetails().getEnabledFileTypes(), ", ", null, null, 0, null, null, 62, null));
            ...
            String string2 = context.getString(tp.e.f49787e);
            ...
            String string3 = context.getString(tp.e.f49791i, Integer.valueOf(((GenericFileUploadErrorResponse.DocumentErrorResponse.PageLimitExceededError) documentErrorResponse).getDetails().getPageLimit()));
            ...
            String string4 = context.getString(tp.e.f49789g);
            ...
            String string5 = context.getString(tp.e.f49789g);
            ...
            String string6 = context.getString(tp.e.f49790h);
            ...
            String string7 = context.getString(tp.e.f49788f, Integer.valueOf(((GenericFileUploadErrorResponse.DocumentErrorResponse.GovernmentIdDimensionSizeError) documentErrorResponse).getDetails().getMinDimensionSize()));
            Intrinsics.checkNotNullExpressionValue(string7, "getString(...)");
            return string7;
        } else if (documentErrorResponse instanceof GenericFileUploadErrorResponse.DocumentErrorResponse.UnknownError) {
            String string8 = context.getString(tp.e.f49792j);
