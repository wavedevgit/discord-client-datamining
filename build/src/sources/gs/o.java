...
public abstract class o {
    private static final boolean a(Member member) {
        ...
        return !yr.a.e(declaringClass).isValue();
    }
    ...
    public static final List n(SimpleType type) {
        ...
        ClassifierDescriptor mo1197getDeclarationDescriptor = type.getConstructor().mo1197getDeclarationDescriptor();
    ...
    private static final List o(SimpleType simpleType) {
        ...
        if (InlineClassesUtilsKt.needsMfvcFlattening(simpleType)) {
            ClassifierDescriptor mo1197getDeclarationDescriptor = simpleType.getConstructor().mo1197getDeclarationDescriptor();
            Intrinsics.checkNotNull(mo1197getDeclarationDescriptor, "null cannot be cast to non-null type org.jetbrains.kotlin.descriptors.ClassDescriptor");
            MultiFieldValueClassRepresentation<SimpleType> multiFieldValueClassRepresentation = DescriptorUtilsKt.getMultiFieldValueClassRepresentation((ClassDescriptor) mo1197getDeclarationDescriptor);
    ...
    public static final Class t(KotlinType kotlinType) {
        ...
        Class s10 = s(kotlinType.getConstructor().mo1197getDeclarationDescriptor());
        if (s10 == null) {
            return null;
        }
