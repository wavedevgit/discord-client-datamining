...
public final class e extends kotlinx.coroutines.a {
    ...
    private final Thread f27151o;

    /* renamed from: p  reason: collision with root package name */
    private final p0 f27152p;
    ...
    public void C(Object obj) {
        if (!Intrinsics.areEqual(Thread.currentThread(), this.f27151o)) {
            Thread thread = this.f27151o;
            b.a();
    ...
    public final Object W0() {
        ...
        b.a();
        try {
            p0 p0Var = this.f27152p;
            r rVar = null;
            if (p0Var != null) {
                p0.q2(p0Var, false, 1, null);
            }
            while (true) {
                p0 p0Var2 = this.f27152p;
                if (p0Var2 != null) {
                    j10 = p0Var2.t2();
                } else {
