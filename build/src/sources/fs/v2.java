...
public final class v2 implements kotlin.reflect.l, x0 {
    ...
    static final /* synthetic */ KProperty[] f24647o = {Reflection.property1(new PropertyReference1Impl(v2.class, "upperBounds", "getUpperBounds()Ljava/util/List;", 0))};

    /* renamed from: d  reason: collision with root package name */
    private final TypeParameterDescriptor f24648d;

    /* renamed from: e  reason: collision with root package name */
    private final z2.a f24649e;

    /* renamed from: i  reason: collision with root package name */
    private final w2 f24650i;
    ...
    public v2(w2 w2Var, TypeParameterDescriptor descriptor) {
        ...
        this.f24648d = descriptor;
        this.f24649e = z2.c(new u2(this));
        if (w2Var == null) {
            ...
            if (containingDeclaration instanceof ClassDescriptor) {
                ...
                if (containingDeclaration2 instanceof ClassDescriptor) {
                    ...
                    if (deserializedMemberDescriptor != null) {
                        KClass e10 = yr.a.e(b(deserializedMemberDescriptor));
                ...
                accept = containingDeclaration.accept(new j(w0Var), Unit.f32464a);
            } else {
    ...
    public boolean equals(Object obj) {
        if (obj instanceof v2) {
            v2 v2Var = (v2) obj;
            if (Intrinsics.areEqual(this.f24650i, v2Var.f24650i) && Intrinsics.areEqual(getName(), v2Var.getName())) {
                return true;
            }
            return false;
        }
    ...
    public List getUpperBounds() {
        Object b10 = this.f24649e.b(this, f24647o[0]);
    ...
    public kotlin.reflect.m getVariance() {
        int i10 = a.f24651a[getDescriptor().getVariance().ordinal()];
        if (i10 != 1) {
            if (i10 != 2) {
                if (i10 == 3) {
                    return kotlin.reflect.m.f35305i;
                }
                throw new lr.p();
            }
            return kotlin.reflect.m.f35304e;
        }
        return kotlin.reflect.m.f35303d;
    }

    public int hashCode() {
        return (this.f24650i.hashCode() * 31) + getName().hashCode();
    }
