...
public final class w0 extends c1 implements KClass, x0, w2 {
    ...
    public final class a extends c1.b {
        ...
        public static final Collection E(w0 w0Var) {
            return w0Var.u(w0Var.L(), c1.d.f24488d);
        }

        /* JADX INFO: Access modifiers changed from: private */
        public static final Collection F(w0 w0Var) {
            return w0Var.u(w0Var.M(), c1.d.f24488d);
        }
        ...
        private final Collection M() {
            Object b10 = this.f24667o.b(this, f24655w[10]);
            Intrinsics.checkNotNullExpressionValue(b10, "getValue(...)");
            return (Collection) b10;
        }

        private final Collection O() {
            Object b10 = this.f24668p.b(this, f24655w[11]);
            Intrinsics.checkNotNullExpressionValue(b10, "getValue(...)");
            return (Collection) b10;
        }

        private final Collection P() {
            Object b10 = this.f24669q.b(this, f24655w[12]);
            Intrinsics.checkNotNullExpressionValue(b10, "getValue(...)");
            return (Collection) b10;
        }
        ...
        public static final Collection T(w0 w0Var) {
            return w0Var.u(w0Var.L(), c1.d.f24489e);
        }

        /* JADX INFO: Access modifiers changed from: private */
        public static final Collection U(w0 w0Var) {
            return w0Var.u(w0Var.M(), c1.d.f24489e);
        }
        ...
        public static final List a0(a aVar, w0 w0Var) {
            ...
            if (!KotlinBuiltIns.isSpecialClassWithNoSupertypes(aVar.N())) {
                ...
                arrayList.add(new t2(anyType, m0.f24570d));
            }
        ...
        public static final Type b0(KotlinType kotlinType, a aVar, w0 w0Var) {
            ...
            if (mo1197getDeclarationDescriptor instanceof ClassDescriptor) {
                Class q10 = j3.q((ClassDescriptor) mo1197getDeclarationDescriptor);
                if (q10 != null) {
                    ...
                    throw new x2("No superclass of " + aVar + " in Java reflection for " + mo1197getDeclarationDescriptor);
                }
                throw new x2("Unsupported superclass of " + aVar + ": " + mo1197getDeclarationDescriptor);
            }
            throw new x2("Supertype not a class: " + mo1197getDeclarationDescriptor);
        }
        ...
        public final Collection H() {
            Object b10 = this.f24673u.b(this, f24655w[16]);
            Intrinsics.checkNotNullExpressionValue(b10, "getValue(...)");
            return (Collection) b10;
        }

        public final Collection I() {
            Object b10 = this.f24670r.b(this, f24655w[13]);
            Intrinsics.checkNotNullExpressionValue(b10, "getValue(...)");
            return (Collection) b10;
        }

        public final Collection J() {
            Object b10 = this.f24671s.b(this, f24655w[14]);
            Intrinsics.checkNotNullExpressionValue(b10, "getValue(...)");
            return (Collection) b10;
        }

        public final List K() {
            Object b10 = this.f24657e.b(this, f24655w[1]);
            Intrinsics.checkNotNullExpressionValue(b10, "getValue(...)");
            return (List) b10;
        }

        public final Collection L() {
            Object b10 = this.f24666n.b(this, f24655w[9]);
            Intrinsics.checkNotNullExpressionValue(b10, "getValue(...)");
            return (Collection) b10;
        }

        public final ClassDescriptor N() {
            Object b10 = this.f24656d.b(this, f24655w[0]);
            Intrinsics.checkNotNullExpressionValue(b10, "getValue(...)");
            return (ClassDescriptor) b10;
        }

        public final String Q() {
            return (String) this.f24659g.b(this, f24655w[3]);
        }

        public final String R() {
            return (String) this.f24658f.b(this, f24655w[2]);
        }

        public final List S() {
            Object b10 = this.f24663k.b(this, f24655w[6]);
            Intrinsics.checkNotNullExpressionValue(b10, "getValue(...)");
            return (List) b10;
        }
    }
    ...
    /* synthetic */ class d extends FunctionReferenceImpl implements Function2 {
        ...
        /* renamed from: d  reason: collision with root package name */
        public static final d f24676d = new d();
    ...
    public w0(Class jClass) {
        ...
        this.f24653o = jClass;
        this.f24654p = lr.l.b(lr.o.f37120e, new b0(this));
    }
    ...
    public ClassDescriptor getDescriptor() {
        return ((a) this.f24654p.getValue()).N();
    }
    ...
    public boolean equals(Object obj) {
        if ((obj instanceof w0) && Intrinsics.areEqual(yr.a.c(this), yr.a.c((KClass) obj))) {
            return true;
        }
        return false;
    }
    ...
    public List getAnnotations() {
        return ((a) this.f24654p.getValue()).K();
    }
    ...
    public Collection getMembers() {
        return ((a) this.f24654p.getValue()).H();
    }

    @Override // kotlin.reflect.KClass
    public String getQualifiedName() {
        return ((a) this.f24654p.getValue()).Q();
    }

    @Override // kotlin.reflect.KClass
    public String getSimpleName() {
        return ((a) this.f24654p.getValue()).R();
    }

    @Override // kotlin.reflect.KClass
    public List getTypeParameters() {
        return ((a) this.f24654p.getValue()).S();
    }
    ...
    public PropertyDescriptor t(int i10) {
        ...
        if (Intrinsics.areEqual(getJClass().getSimpleName(), "DefaultImpls") && (declaringClass = getJClass().getDeclaringClass()) != null && declaringClass.isInterface()) {
            KClass e10 = yr.a.e(declaringClass);
        ...
        if (deserializedClassDescriptor != null) {
            ...
            if (property != null) {
                return (PropertyDescriptor) j3.h(getJClass(), property, deserializedClassDescriptor.getC().getNameResolver(), deserializedClassDescriptor.getC().getTypeTable(), deserializedClassDescriptor.getMetadataVersion(), d.f24676d);
            }
        }
        return null;
    }
