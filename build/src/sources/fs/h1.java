...
public final class h1 extends a0 implements FunctionBase, KFunction, l {
    ...
    static final /* synthetic */ KProperty[] f24525x = {Reflection.property1(new PropertyReference1Impl(h1.class, "descriptor", "getDescriptor()Lorg/jetbrains/kotlin/descriptors/FunctionDescriptor;", 0))};

    /* renamed from: r  reason: collision with root package name */
    private final c1 f24526r;

    /* renamed from: s  reason: collision with root package name */
    private final String f24527s;

    /* renamed from: t  reason: collision with root package name */
    private final Object f24528t;

    /* renamed from: u  reason: collision with root package name */
    private final z2.a f24529u;

    /* renamed from: v  reason: collision with root package name */
    private final Lazy f24530v;

    /* renamed from: w  reason: collision with root package name */
    private final Lazy f24531w;
    ...
    public static final gs.h L(h1 h1Var) {
        Object d10;
        gs.h P;
        n g10 = e3.f24507a.g(h1Var.D());
        if (g10 instanceof n.d) {
            if (h1Var.F()) {
                ...
                return new gs.a(jClass, arrayList, a.EnumC0341a.f26562e, a.b.f26566e, null, 16, null);
            }
            ...
            return new gs.a(jClass2, arrayList2, a.EnumC0341a.f26562e, a.b.f26565d, d11);
        } else {
            throw new lr.p();
        }
        if (d10 instanceof Constructor) {
            ...
            if (!Modifier.isStatic(method2.getModifiers())) {
                P = h1Var.N(method2);
            } else if (h1Var.D().getAnnotations().mo1193findAnnotation(j3.j()) != null) {
                P = h1Var.O(method2);
            } else {
        ...
        return gs.o.j(P, h1Var.D(), false, 2, null);
    }

    private final gs.i M(Constructor constructor, FunctionDescriptor functionDescriptor, boolean z10) {
    ...
    private final gs.h P(Method method, boolean z10) {
        Object S;
        if (G()) {
            if (V(method)) {
                S = this.f24528t;
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public static final gs.h Q(h1 h1Var) {
        ...
        if (g10 instanceof n.e) {
            ...
            if (h1Var.F()) {
                ...
                return new gs.a(jClass, arrayList, a.EnumC0341a.f26561d, a.b.f26566e, null, 16, null);
            }
            ...
            return new gs.a(jClass2, arrayList2, a.EnumC0341a.f26561d, a.b.f26565d, d10);
        } else {
        ...
        if (genericDeclaration instanceof Constructor) {
            ...
            if (h1Var.D().getAnnotations().mo1193findAnnotation(j3.j()) != null) {
        ...
        return gs.o.i(hVar, h1Var.D(), true);
    }

    /* JADX INFO: Access modifiers changed from: private */
    public static final FunctionDescriptor R(h1 h1Var, String str) {
        return h1Var.B().k(str, h1Var.f24527s);
    }

    private final Object S() {
        return gs.o.h(this.f24528t, D());
    }
    ...
    @Override // fs.a0
    public gs.h A() {
        return (gs.h) this.f24530v.getValue();
    }
    ...
    @Override // fs.a0
    public gs.h C() {
        return (gs.h) this.f24531w.getValue();
    }

    @Override // fs.a0
    public boolean G() {
        if (this.f24528t != CallableReference.NO_RECEIVER) {
            return true;
        }
        return false;
    }
    ...
    public FunctionDescriptor D() {
        Object b10 = this.f24529u.b(this, f24525x[0]);
    ...
    public boolean equals(Object obj) {
        h1 c10 = j3.c(obj);
        if (c10 == null || !Intrinsics.areEqual(B(), c10.B()) || !Intrinsics.areEqual(getName(), c10.getName()) || !Intrinsics.areEqual(this.f24527s, c10.f24527s) || !Intrinsics.areEqual(this.f24528t, c10.f24528t)) {
            return false;
        }
        return true;
    }
    ...
    public int hashCode() {
        return (((B().hashCode() * 31) + getName().hashCode()) * 31) + this.f24527s.hashCode();
    }
    ...
    private h1(c1 c1Var, String str, String str2, FunctionDescriptor functionDescriptor, Object obj) {
        ...
        this.f24527s = str2;
        this.f24528t = obj;
        this.f24529u = z2.b(functionDescriptor, new e1(this, str));
        lr.o oVar = lr.o.f37120e;
        this.f24530v = lr.l.b(oVar, new f1(this));
        this.f24531w = lr.l.b(oVar, new g1(this));
    }
    ...
    */
    public h1(fs.c1 r10, kotlin.reflect.jvm.internal.impl.descriptors.FunctionDescriptor r11) {
        /*
            r9 = this;
            ...
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: fs.h1.<init>(fs.c1, kotlin.reflect.jvm.internal.impl.descriptors.FunctionDescriptor):void");
    }
}
