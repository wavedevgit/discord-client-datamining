...
public abstract class j2 extends a0 implements KProperty {
    ...
    public static final b f24541x = new b(null);

    /* renamed from: y  reason: collision with root package name */
    private static final Object f24542y = new Object();

    /* renamed from: r  reason: collision with root package name */
    private final c1 f24543r;
    ...
    private final Object f24546u;

    /* renamed from: v  reason: collision with root package name */
    private final Lazy f24547v;

    /* renamed from: w  reason: collision with root package name */
    private final z2.a f24548w;
    ...
    public static abstract class c extends a implements KProperty.b {
        ...
        /* renamed from: t  reason: collision with root package name */
        static final /* synthetic */ KProperty[] f24549t = {Reflection.property1(new PropertyReference1Impl(c.class, "descriptor", "getDescriptor()Lorg/jetbrains/kotlin/descriptors/PropertyGetterDescriptor;", 0))};

        /* renamed from: r  reason: collision with root package name */
        private final z2.a f24550r = z2.c(new k2(this));

        /* renamed from: s  reason: collision with root package name */
        private final Lazy f24551s = lr.l.b(lr.o.f37120e, new l2(this));

        /* JADX INFO: Access modifiers changed from: private */
        public static final gs.h M(c cVar) {
        ...
        @Override // fs.a0
        public gs.h A() {
            return (gs.h) this.f24551s.getValue();
        }

        @Override // fs.j2.a
        /* renamed from: O */
        public PropertyGetterDescriptor I() {
            Object b10 = this.f24550r.b(this, f24549t[0]);
    ...
    public static abstract class d extends a implements e.a {
        ...
        /* renamed from: t  reason: collision with root package name */
        static final /* synthetic */ KProperty[] f24552t = {Reflection.property1(new PropertyReference1Impl(d.class, "descriptor", "getDescriptor()Lorg/jetbrains/kotlin/descriptors/PropertySetterDescriptor;", 0))};

        /* renamed from: r  reason: collision with root package name */
        private final z2.a f24553r = z2.c(new m2(this));

        /* renamed from: s  reason: collision with root package name */
        private final Lazy f24554s = lr.l.b(lr.o.f37120e, new n2(this));

        /* JADX INFO: Access modifiers changed from: private */
        public static final gs.h M(d dVar) {
        ...
        @Override // fs.a0
        public gs.h A() {
            return (gs.h) this.f24554s.getValue();
        }

        @Override // fs.j2.a
        /* renamed from: O */
        public PropertySetterDescriptor I() {
            Object b10 = this.f24553r.b(this, f24552t[0]);
            Intrinsics.checkNotNullExpressionValue(b10, "getValue(...)");
    ...
    private j2(c1 c1Var, String str, String str2, PropertyDescriptor propertyDescriptor, Object obj) {
        ...
        this.f24545t = str2;
        this.f24546u = obj;
        this.f24547v = lr.l.b(lr.o.f37120e, new h2(this));
    ...
    public static final PropertyDescriptor I(j2 j2Var) {
        return j2Var.B().n(j2Var.getName(), j2Var.f24545t);
    }

    /* JADX INFO: Access modifiers changed from: private */
    public static final Field J(j2 j2Var) {
        Class<?> enclosingClass;
        p f10 = e3.f24507a.f(j2Var.D());
    ...
    @Override // fs.a0
    public boolean G() {
        if (this.f24546u != CallableReference.NO_RECEIVER) {
            return true;
        }
        return false;
    }
        ...
        try {
            ...
            if ((obj != obj4 && obj2 != obj4) || D().getExtensionReceiverParameter() != null) {
                ...
                if (accessibleObject != null) {
                    accessibleObject.setAccessible(es.a.a(this));
                }
                if (member == null) {
                    return null;
                }
    ...
    public PropertyDescriptor D() {
        Object invoke = this.f24548w.invoke();
    ...
    public final Field R() {
        return (Field) this.f24547v.getValue();
    }
    ...
    public boolean equals(Object obj) {
        j2 d10 = j3.d(obj);
        if (d10 == null || !Intrinsics.areEqual(B(), d10.B()) || !Intrinsics.areEqual(getName(), d10.getName()) || !Intrinsics.areEqual(this.f24545t, d10.f24545t) || !Intrinsics.areEqual(this.f24546u, d10.f24546u)) {
            return false;
        }
        return true;
    }
    ...
    public int hashCode() {
        return (((B().hashCode() * 31) + getName().hashCode()) * 31) + this.f24545t.hashCode();
    }
    ...
    */
    public j2(fs.c1 r8, kotlin.reflect.jvm.internal.impl.descriptors.PropertyDescriptor r9) {
        /*
            r7 = this;
            ...
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: fs.j2.<init>(fs.c1, kotlin.reflect.jvm.internal.impl.descriptors.PropertyDescriptor):void");
    }
}
