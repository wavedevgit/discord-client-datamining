...
public final class t2 implements KTypeBase {
    ...
    static final /* synthetic */ KProperty[] f24624p = {Reflection.property1(new PropertyReference1Impl(t2.class, "classifier", "getClassifier()Lkotlin/reflect/KClassifier;", 0)), Reflection.property1(new PropertyReference1Impl(t2.class, "arguments", "getArguments()Ljava/util/List;", 0))};

    /* renamed from: d  reason: collision with root package name */
    private final KotlinType f24625d;

    /* renamed from: e  reason: collision with root package name */
    private final z2.a f24626e;

    /* renamed from: i  reason: collision with root package name */
    private final z2.a f24627i;

    /* renamed from: o  reason: collision with root package name */
    private final z2.a f24628o;
    ...
    public t2(KotlinType type, Function0 function0) {
        ...
        this.f24626e = aVar;
        this.f24627i = z2.c(new p2(this));
        this.f24628o = z2.c(new q2(this, function0));
    }
    ...
    public static final List f(t2 t2Var, Function0 function0) {
        s2 s2Var;
        KTypeProjection d10;
        List<TypeProjection> arguments = t2Var.f24625d.getArguments();
        if (arguments.isEmpty()) {
            return CollectionsKt.l();
        }
        Lazy b10 = lr.l.b(lr.o.f37120e, new r2(t2Var));
        ...
        for (Object obj : list) {
            ...
            if (typeProjection.isStarProjection()) {
                ...
                int i12 = a.f24629a[typeProjection.getProjectionKind().ordinal()];
                if (i12 != 1) {
                    if (i12 != 2) {
                        if (i12 == 3) {
                            d10 = KTypeProjection.f32568c.b(t2Var2);
                        } else {
                            throw new lr.p();
                        }
                    } else {
                        d10 = KTypeProjection.f32568c.a(t2Var2);
                    }
                } else {
                    d10 = KTypeProjection.f32568c.d(t2Var2);
                }
            }
            arrayList.add(d10);
            i10 = i11;
        ...
        if (mo1197getDeclarationDescriptor instanceof ClassDescriptor) {
            ...
            if (q10.isArray()) {
                ...
                if (typeProjection != null && (type = typeProjection.getType()) != null) {
                    ...
                    if (k10 != null) {
                        return new w0(j3.f(yr.a.b(es.b.a(k10))));
                    }
            ...
            return new v2(null, (TypeParameterDescriptor) mo1197getDeclarationDescriptor);
        } else {
            if (!(mo1197getDeclarationDescriptor instanceof TypeAliasDescriptor)) {
                return null;
            }
            throw new lr.q("An operation is not implemented: Type alias classifiers are not yet supported");
        }
    }
    ...
    public boolean equals(Object obj) {
        if (obj instanceof t2) {
            t2 t2Var = (t2) obj;
            if (Intrinsics.areEqual(this.f24625d, t2Var.f24625d) && Intrinsics.areEqual(getClassifier(), t2Var.getClassifier()) && Intrinsics.areEqual(getArguments(), t2Var.getArguments())) {
                return true;
            }
            return false;
        }
    ...
    public List getAnnotations() {
        return j3.e(this.f24625d);
    }

    @Override // kotlin.jvm.internal.KTypeBase, kotlin.reflect.KType
    public List getArguments() {
        Object b10 = this.f24628o.b(this, f24624p[1]);
    ...
    public kotlin.reflect.d getClassifier() {
        return (kotlin.reflect.d) this.f24627i.b(this, f24624p[0]);
    }

    @Override // kotlin.jvm.internal.KTypeBase
    public Type getJavaType() {
        z2.a aVar = this.f24626e;
        if (aVar != null) {
    ...
    public int hashCode() {
        int i10;
        int hashCode = this.f24625d.hashCode() * 31;
    ...
    public boolean isMarkedNullable() {
        return this.f24625d.isMarkedNullable();
    }
    ...
    public String toString() {
        return d3.f24499a.l(this.f24625d);
    }
