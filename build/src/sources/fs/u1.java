...
public final class u1 extends c1 {
    ...
    private final Class f24633o;

    /* renamed from: p  reason: collision with root package name */
    private final Lazy f24634p;
    ...
    public final class a extends c1.b {
        ...
        static final /* synthetic */ KProperty[] f24635j = {Reflection.property1(new PropertyReference1Impl(a.class, "kotlinClass", "getKotlinClass()Lorg/jetbrains/kotlin/descriptors/runtime/components/ReflectKotlinClass;", 0)), Reflection.property1(new PropertyReference1Impl(a.class, "scope", "getScope()Lorg/jetbrains/kotlin/resolve/scopes/MemberScope;", 0)), Reflection.property1(new PropertyReference1Impl(a.class, "members", "getMembers()Ljava/util/Collection;", 0))};

        /* renamed from: d  reason: collision with root package name */
        private final z2.a f24636d;

        /* renamed from: e  reason: collision with root package name */
        private final z2.a f24637e;

        /* renamed from: f  reason: collision with root package name */
        private final Lazy f24638f;

        /* renamed from: g  reason: collision with root package name */
        private final Lazy f24639g;

        /* renamed from: h  reason: collision with root package name */
        private final z2.a f24640h;

        public a() {
            super();
            this.f24636d = z2.c(new p1(u1.this));
            this.f24637e = z2.c(new q1(this));
            lr.o oVar = lr.o.f37120e;
            this.f24638f = lr.l.b(oVar, new r1(this, u1.this));
            this.f24639g = lr.l.b(oVar, new s1(this));
            this.f24640h = z2.c(new t1(u1.this, this));
        }

        private final ReflectKotlinClass i() {
            return (ReflectKotlinClass) this.f24636d.b(this, f24635j[0]);
        }
        ...
        public static final Collection o(u1 u1Var, a aVar) {
            return u1Var.u(aVar.m(), c1.d.f24488d);
        }

        /* JADX INFO: Access modifiers changed from: private */
        public static final lr.u p(a aVar) {
            ...
            if (i10 != null && (classHeader = i10.getClassHeader()) != null) {
                ...
                if (data != null && strings != null) {
                    ...
                    return new lr.u((JvmNameResolver) readPackageDataFrom.a(), (ProtoBuf.Package) readPackageDataFrom.b(), classHeader.getMetadataVersion());
                }
            }
            return null;
        }
        ...
        public final Collection j() {
            Object b10 = this.f24640h.b(this, f24635j[2]);
            Intrinsics.checkNotNullExpressionValue(b10, "getValue(...)");
            return (Collection) b10;
        }

        public final lr.u k() {
            return (lr.u) this.f24639g.getValue();
        }

        public final Class l() {
            return (Class) this.f24638f.getValue();
        }

        public final MemberScope m() {
            Object b10 = this.f24637e.b(this, f24635j[1]);
            Intrinsics.checkNotNullExpressionValue(b10, "getValue(...)");
    ...
    /* synthetic */ class b extends FunctionReferenceImpl implements Function2 {
        ...
        /* renamed from: d  reason: collision with root package name */
        public static final b f24642d = new b();
    ...
    public u1(Class jClass) {
        ...
        this.f24633o = jClass;
        this.f24634p = lr.l.b(lr.o.f37120e, new o1(this));
    }
    ...
    private final MemberScope E() {
        return ((a) this.f24634p.getValue()).m();
    }
    ...
    public Collection getMembers() {
        return ((a) this.f24634p.getValue()).j();
    }
    ...
    public PropertyDescriptor t(int i10) {
        lr.u k10 = ((a) this.f24634p.getValue()).k();
        if (k10 != null) {
            ...
            if (property != null) {
                ...
                return (PropertyDescriptor) j3.h(jClass, property, jvmNameResolver, new TypeTable(typeTable), metadataVersion, b.f24642d);
            }
        }
        return null;
    }
    ...
    @Override // fs.c1
    protected Class v() {
        Class l10 = ((a) this.f24634p.getValue()).l();
        if (l10 == null) {
            return getJClass();
        }
        return l10;
