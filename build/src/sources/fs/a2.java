...
public class a2 extends j2 implements kotlin.reflect.j {
    ...
    public a2(c1 container, PropertyDescriptor descriptor) {
        ...
        this.f24472z = lr.l.b(oVar, new y1(this));
        this.A = lr.l.b(oVar, new z1(this));
    }
    ...
    /* renamed from: Y */
    public a getGetter() {
        return (a) this.f24472z.getValue();
    }
