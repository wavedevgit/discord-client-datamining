...
public class d implements x {
    ...
    public void a(ac.o oVar, int i10, boolean z10) {
        ComponentName componentName = new ComponentName(this.f27041a, JobInfoSchedulerService.class);
        JobScheduler jobScheduler = (JobScheduler) this.f27041a.getSystemService("jobscheduler");
        int c10 = c(oVar);
        if (!z10 && d(jobScheduler, c10, i10)) {
            ec.a.b("JobInfoScheduler", "Upload for context %s is already scheduled. Returning...", oVar);
            return;
        }
        long a02 = this.f27042b.a0(oVar);
        JobInfo.Builder c11 = this.f27043c.c(new JobInfo.Builder(c10, componentName), oVar.d(), a02, i10);
        ...
        ec.a.c("JobInfoScheduler", "Scheduling upload for context %s with jobId=%d in %dms(Backend next call timestamp %d). Attempt %d", oVar, Integer.valueOf(c10), Long.valueOf(this.f27043c.g(oVar.d(), a02, i10)), Long.valueOf(a02), Integer.valueOf(i10));
    ...
    int c(ac.o oVar) {
        ...
        adler32.update(this.f27041a.getPackageName().getBytes(Charset.forName("UTF-8")));
