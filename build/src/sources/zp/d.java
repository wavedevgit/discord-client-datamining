...
public final class d {
    ...
    public static final d f56015a;

    /* renamed from: b  reason: collision with root package name */
    private static final Lazy f56016b;

    /* renamed from: c  reason: collision with root package name */
    private static final b f56017c;

    /* renamed from: d  reason: collision with root package name */
    private static final Map f56018d;

    /* renamed from: e  reason: collision with root package name */
    private static final b4 f56019e;

    /* loaded from: /home/runner/work/discord-client-datamining/discord-client-datamining/build/classes4.dex */
    public static final class a implements Comparator {
        @Override // java.util.Comparator
        public final int compare(Object obj, Object obj2) {
            return mr.a.d(((b4) obj).getText(), ((b4) obj2).getText());
        }
    }
    ...
    static {
        d dVar = new d();
        f56015a = dVar;
        f56016b = jr.l.b(new Function0() { // from class: zp.c
    ...
    private final List d() {
        ...
        for (Map.Entry entry2 : linkedHashMap.entrySet()) {
            arrayList.add(f56015a.m((b) entry2.getValue()));
        }
    ...
    public final b4 g(String str) {
        ...
        if (str != null && str.length() == 2) {
            ...
            Intrinsics.checkNotNullExpressionValue(upperCase, "toUpperCase(...)");
            b bVar = (b) f56018d.get(upperCase);
    ...
    */
    public final java.lang.String i(yp.b4 r8) {
        /*
            r7 = this;
        ...
        L3e:
            ...
            return r8
        */
        throw new UnsupportedOperationException("Method not decompiled: zp.d.i(yp.b4):java.lang.String");
    }
