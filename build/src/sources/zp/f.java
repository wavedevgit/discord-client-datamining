...
public abstract class f {
    ...
    public static final Drawable b(Context context, int i10, int i11) {
        ...
        int c10 = androidx.core.content.a.c(context, cp.b.f20627a);
        int c11 = androidx.core.content.a.c(context, cp.b.f20628b);
        ...
        gradientDrawable.setSize(i11 + ((int) kp.h.a(24.0d)), gradientDrawable.getMinimumHeight());
        return new InsetDrawable((Drawable) gradientDrawable, (int) kp.h.a(4.0d));
    }

    private static final br.e c(Context context) {
        br.e eVar = f56030a;
        if (eVar == null) {
            br.e b10 = br.e.b(context);
            f56030a = b10;
    ...
    public static final void d(TextView textView, String text) {
        ...
        c10.d(textView, e10);
        if (e10.getSpans(0, e10.length(), er.g.class).length == 0 && e10.getSpans(0, e10.length(), URLSpan.class).length == 0) {
