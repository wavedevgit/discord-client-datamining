...
public abstract class o {
    private static final boolean a(Member member) {
        ...
        return !wr.a.e(declaringClass).isValue();
    }
    ...
    public static final List n(SimpleType type) {
        ...
        ClassifierDescriptor mo1200getDeclarationDescriptor = type.getConstructor().mo1200getDeclarationDescriptor();
    ...
    private static final List o(SimpleType simpleType) {
        ...
        if (InlineClassesUtilsKt.needsMfvcFlattening(simpleType)) {
            ClassifierDescriptor mo1200getDeclarationDescriptor = simpleType.getConstructor().mo1200getDeclarationDescriptor();
            Intrinsics.checkNotNull(mo1200getDeclarationDescriptor, "null cannot be cast to non-null type org.jetbrains.kotlin.descriptors.ClassDescriptor");
            MultiFieldValueClassRepresentation<SimpleType> multiFieldValueClassRepresentation = DescriptorUtilsKt.getMultiFieldValueClassRepresentation((ClassDescriptor) mo1200getDeclarationDescriptor);
    ...
    public static final Class t(KotlinType kotlinType) {
        ...
        Class s10 = s(kotlinType.getConstructor().mo1200getDeclarationDescriptor());
        if (s10 == null) {
            return null;
        }
