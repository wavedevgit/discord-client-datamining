...
public abstract class l0 {
    ...
    public static final e0 f50890a = new e0("NO_THREAD_ELEMENTS");

    /* renamed from: b  reason: collision with root package name */
    private static final Function2 f50891b = new Function2() { // from class: ts.i0
    ...
    private static final Function2 f50892c = new Function2() { // from class: ts.j0
        @Override // kotlin.jvm.functions.Function2
        public final Object invoke(Object obj, Object obj2) {
            k1 e10;
    ...
    private static final Function2 f50893d = new Function2() { // from class: ts.k0
        @Override // kotlin.jvm.functions.Function2
        public final Object invoke(Object obj, Object obj2) {
            p0 h10;
    ...
    public static final void f(CoroutineContext coroutineContext, Object obj) {
        ...
        Object z12 = coroutineContext.z1(null, f50892c);
    ...
    public static final Object g(CoroutineContext coroutineContext) {
        Object z12 = coroutineContext.z1(0, f50891b);
    ...
    public static final p0 h(p0 p0Var, CoroutineContext.Element element) {
        if (element instanceof k1) {
            k1 k1Var = (k1) element;
            p0Var.a(k1Var, k1Var.A1(p0Var.f50900a));
        }
        return p0Var;
    }
    ...
    public static final Object i(CoroutineContext coroutineContext, Object obj) {
        ...
        if (obj instanceof Integer) {
            return coroutineContext.z1(new p0(coroutineContext, ((Number) obj).intValue()), f50893d);
        }
