...
public final class v extends kotlin.coroutines.jvm.internal.d implements FlowCollector, CoroutineStackFrame {
    ...
    public final FlowCollector f50994d;

    /* renamed from: e  reason: collision with root package name */
    public final CoroutineContext f50995e;

    /* renamed from: i  reason: collision with root package name */
    public final int f50996i;

    /* renamed from: o  reason: collision with root package name */
    private CoroutineContext f50997o;

    /* renamed from: p  reason: collision with root package name */
    private Continuation f50998p;

    public v(FlowCollector flowCollector, CoroutineContext coroutineContext) {
        super(r.f50988d, kotlin.coroutines.e.f31839d);
        this.f50994d = flowCollector;
        this.f50995e = coroutineContext;
        this.f50996i = ((Number) coroutineContext.u1(0, new Function2() { // from class: ts.u
    ...
    private final Object m(Continuation continuation, Object obj) {
        ...
        CoroutineContext coroutineContext = this.f50997o;
        if (coroutineContext != context) {
            k(context, coroutineContext, obj);
            this.f50997o = context;
        }
        this.f50998p = continuation;
        Function3 a10 = w.a();
        FlowCollector flowCollector = this.f50994d;
        ...
        if (!Intrinsics.areEqual(invoke, xr.b.f())) {
            this.f50998p = null;
        }
        return invoke;
    }
    ...
    private final void n(m mVar, Object obj) {
        throw new IllegalStateException(StringsKt.j("\n            Flow exception transparency is violated:\n                Previous 'emit' call has thrown exception " + mVar.f50982e + ", but then emission attempt of value '" + obj + "' has been detected.\n                Emissions from 'catch' blocks are prohibited in order to avoid unspecified behaviour, 'Flow.catch' operator can be used instead.\n                For a more detailed explanation, please refer to Flow documentation.\n            ").toString());
    }
    ...
    public Object emit(Object obj, Continuation continuation) {
        try {
            ...
            this.f50997o = new m(th2, continuation.getContext());
            throw th2;
        }
    }
    ...
    public CoroutineStackFrame getCallerFrame() {
        Continuation continuation = this.f50998p;
    ...
    protected Object invokeSuspend(Object obj) {
        ...
        if (e10 != null) {
            this.f50997o = new m(e10, getContext());
        }
        Continuation continuation = this.f50998p;
