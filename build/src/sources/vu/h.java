...
public class h {
    ...
    private static volatile h f52016b;

    /* renamed from: c  reason: collision with root package name */
    private static final Logger f52017c;
    ...
    public static final class a {
        ...
        private final h e() {
            ...
            c a11;
            d b10;
            if (j() && (b10 = d.f51997e.b()) != null) {
                return b10;
            }
            if (i() && (a11 = c.f51994e.a()) != null) {
                return a11;
            }
            if (k() && (a10 = g.f52012e.a()) != null) {
                return a10;
            }
            f a12 = f.f52010d.a();
            if (a12 != null) {
    ...
    static {
        ...
        f52015a = aVar;
        f52016b = aVar.f();
        f52017c = Logger.getLogger(OkHttpClient.class.getName());
    }
    ...
    public yu.c c(X509TrustManager trustManager) {
        ...
        return new yu.a(d(trustManager));
    }
    ...
    public yu.e d(X509TrustManager trustManager) {
        ...
        return new yu.b((X509Certificate[]) Arrays.copyOf(acceptedIssuers, acceptedIssuers.length));
    }
    ...
    public Object i(String closer) {
        ...
        if (f52017c.isLoggable(Level.FINE)) {
