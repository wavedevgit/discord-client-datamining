...
public final class r implements te.b {
        ...
        if (!task.p() && !task.n()) {
            ...
            if (k10 instanceof ef.b) {
                ...
                if (b10 != 43001 && b10 != 43002 && b10 != 43003 && b10 != 17) {
                    if (b10 == 43000) {
                        return wg.m.e(new Exception("Failed to get app set ID due to an internal error. Please try again later."));
                    }
                    if (b10 == 15) {
                        return wg.m.e(new Exception("The operation to get app set ID timed out. Please try again later."));
                    }
                } else {
                    return rVar.f624b.h();
                }
    ...
    @Override // te.b
    public final Task h() {
        return this.f623a.h().j(new wg.c() { // from class: ag.q
            @Override // wg.c
