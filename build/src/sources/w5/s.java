...
abstract class s {
    ...
    private static final c.a f52899a = c.a.a("x", "y");
    ...
    public static /* synthetic */ class a {
        ...
        /* renamed from: a  reason: collision with root package name */
        static final /* synthetic */ int[] f52900a;
        ...
        static {
            ...
            try {
                f52900a[c.b.BEGIN_ARRAY.ordinal()] = 2;
            } catch (NoSuchFieldError unused2) {
            }
            try {
                f52900a[c.b.BEGIN_OBJECT.ordinal()] = 3;
    ...
    public static PointF e(x5.c cVar, float f10) {
        int i10 = a.f52900a[cVar.m().ordinal()];
        if (i10 != 1) {
            if (i10 != 2) {
                if (i10 == 3) {
                    return c(cVar, f10);
