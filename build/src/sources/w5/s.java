...
abstract class s {
    ...
    private static final c.a f53301a = c.a.a("x", "y");
    ...
    public static /* synthetic */ class a {
        ...
        static {
            ...
            try {
                f53302a[c.b.BEGIN_ARRAY.ordinal()] = 2;
            } catch (NoSuchFieldError unused2) {
            }
            try {
                f53302a[c.b.BEGIN_OBJECT.ordinal()] = 3;
    ...
    public static PointF e(x5.c cVar, float f10) {
        int i10 = a.f53302a[cVar.m().ordinal()];
        if (i10 != 1) {
            if (i10 != 2) {
                if (i10 == 3) {
                    return c(cVar, f10);
