...
abstract class s {
    ...
    private static final c.a f52331a = c.a.a("x", "y");
    ...
    public static /* synthetic */ class a {
        ...
        /* renamed from: a  reason: collision with root package name */
        static final /* synthetic */ int[] f52332a;
        ...
        static {
            ...
            try {
                f52332a[c.b.BEGIN_ARRAY.ordinal()] = 2;
            } catch (NoSuchFieldError unused2) {
            }
            try {
                f52332a[c.b.BEGIN_OBJECT.ordinal()] = 3;
            } catch (NoSuchFieldError unused3) {
            }
        }
    }

    private static PointF a(x5.c cVar, float f10) {
        cVar.x();
    ...
    private static PointF b(x5.c cVar, float f10) {
        float nextDouble = (float) cVar.nextDouble();
        float nextDouble2 = (float) cVar.nextDouble();
        while (cVar.hasNext()) {
            cVar.T();
    ...
    private static PointF c(x5.c cVar, float f10) {
        cVar.u();
        float f11 = 0.0f;
        float f12 = 0.0f;
        while (cVar.hasNext()) {
            int p10 = cVar.p(f52331a);
            if (p10 != 0) {
                if (p10 != 1) {
                    cVar.s();
                    cVar.T();
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    public static PointF e(x5.c cVar, float f10) {
        int i10 = a.f52332a[cVar.m().ordinal()];
        if (i10 != 1) {
            if (i10 != 2) {
                if (i10 == 3) {
                    return c(cVar, f10);
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    public static List f(x5.c cVar, float f10) {
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    public static float g(x5.c cVar) {
        c.b m10 = cVar.m();
        int i10 = a.f52332a[m10.ordinal()];
        if (i10 != 1) {
            if (i10 == 2) {
                cVar.x();
                float nextDouble = (float) cVar.nextDouble();
