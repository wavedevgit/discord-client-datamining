...
abstract class t {
    ...
    private static SparseArrayCompat f52334b;

    /* renamed from: a  reason: collision with root package name */
    private static final Interpolator f52333a = new LinearInterpolator();

    /* renamed from: c  reason: collision with root package name */
    static c.a f52335c = c.a.a("t", "s", "e", "o", "i", "h", "to", "ti");

    /* renamed from: d  reason: collision with root package name */
    static c.a f52336d = c.a.a("x", "y");
    ...
    private static Interpolator b(PointF pointF, PointF pointF2) {
        ...
        pointF.x = y5.i.b(pointF.x, -1.0f, 1.0f);
        pointF.y = y5.i.b(pointF.y, -100.0f, 100.0f);
        pointF2.x = y5.i.b(pointF2.x, -1.0f, 1.0f);
        float b10 = y5.i.b(pointF2.y, -100.0f, 100.0f);
        pointF2.y = b10;
        int i10 = y5.j.i(pointF.x, pointF.y, pointF2.x, b10);
    ...
    public static z5.a c(x5.c cVar, l5.i iVar, float f10, n0 n0Var, boolean z10, boolean z11) {
        if (z10 && z11) {
    ...
    private static z5.a d(l5.i iVar, x5.c cVar, float f10, n0 n0Var) {
        ...
        cVar.D();
        if (z10) {
            interpolator2 = f52333a;
            obj = obj3;
        } else {
            if (pointF != null && pointF4 != null) {
                interpolator = b(pointF, pointF4);
            } else {
                interpolator = f52333a;
            }
            interpolator2 = interpolator;
            obj = obj2;
        }
        z5.a aVar = new z5.a(iVar, obj3, obj, interpolator2, f11, null);
        aVar.f56106o = pointF2;
        aVar.f56107p = pointF3;
        return aVar;
    }

    private static z5.a e(l5.i iVar, x5.c cVar, float f10, n0 n0Var) {
        Interpolator interpolator;
        Interpolator b10;
        Interpolator b11;
        Object obj;
        ...
        if (z13) {
            ...
            if (pointF4 != null && pointF5 != null) {
                ...
                if (b10 == null && b11 != null) {
                    pointF2 = pointF11;
                    pointF = pointF10;
                    aVar = new z5.a(iVar, obj2, obj, b10, b11, f12, null);
                } else {
                    pointF = pointF10;
                    pointF2 = pointF11;
                    aVar = new z5.a(iVar, obj2, obj, interpolator2, f12, null);
                }
                aVar.f56106o = pointF;
                aVar.f56107p = pointF2;
                return aVar;
            } else {
                interpolator = f52333a;
            }
    ...
    private static z5.a f(x5.c cVar, float f10, n0 n0Var) {
        return new z5.a(n0Var.a(cVar, f10));
    }

    private static SparseArrayCompat g() {
        if (f52334b == null) {
            f52334b = new SparseArrayCompat();
        }
        return f52334b;
    }
