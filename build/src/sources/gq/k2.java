...
public final class k2 implements k5, e0 {
    ...
    private final JsonLogicBoolean f24600e;
    ...
    public boolean equals(Object obj) {
        ...
        k2 k2Var = (k2) obj;
        if (Intrinsics.areEqual(this.f24599d, k2Var.f24599d) && Intrinsics.areEqual(this.f24600e, k2Var.f24600e)) {
            return true;
        }
        return false;
    }
    ...
    public int hashCode() {
        int hashCode;
        int hashCode2 = this.f24599d.hashCode() * 31;
        JsonLogicBoolean jsonLogicBoolean = this.f24600e;
    ...
    public final void writeToParcel(Parcel dest, int i10) {
        ...
        dest.writeString(this.f24599d);
        dest.writeParcelable(this.f24600e, i10);
    }
    ...
    */
    public k2(com.withpersona.sdk2.inquiry.network.dto.ui.components.LocalImage r2) {
        ...
        L15:
            ...
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: gq.k2.<init>(com.withpersona.sdk2.inquiry.network.dto.ui.components.LocalImage):void");
    }
}
