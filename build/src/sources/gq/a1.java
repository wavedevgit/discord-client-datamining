...
public abstract class a1 {
    ...
    public static final class a implements Function1 {
        ...
        public static final a f24491d = new a();
    ...
    public static final ConstraintLayout f(InputConfirmationCodeComponent inputConfirmationCodeComponent, m5 uiComponentHelper, final InputConfirmationCode config) {
        ...
        final jq.c c10 = jq.c.c(uiComponentHelper.b());
        String b10 = inputConfirmationCodeComponent.b().b();
        final List o10 = CollectionsKt.o(c10.f30317b.getEditText(), c10.f30320e.getEditText(), c10.f30322g.getEditText(), c10.f30319d.getEditText());
        for (IndexedValue indexedValue : CollectionsKt.n1(o10)) {
            ...
            if (editText != null) {
                ...
                sp.a0.b(editText, new Function1() { // from class: gq.v0
                    @Override // kotlin.jvm.functions.Function1
            ...
            if (editText2 != null) {
                l(editText, new Function0() { // from class: gq.w0
        ...
        uiComponentHelper.d(new Function0() { // from class: gq.x0
            @Override // kotlin.jvm.functions.Function0
            public final Object invoke() {
                Unit i10;
                i10 = a1.i(jq.c.this, config);
                return i10;
            }
        });
    ...
    public static final Unit g(InputConfirmationCodeComponent inputConfirmationCodeComponent, jq.c cVar, List list, EditText editText, EditText editText2, EditText editText3, String newText) {
        Context context;
        Intrinsics.checkNotNullParameter(newText, "newText");
        en.t b10 = inputConfirmationCodeComponent.b();
        iq.a aVar = iq.a.f29629a;
        ...
        if (newText.length() >= list.size()) {
            ...
            EditText editText4 = cVar.f30319d.getEditText();
            if (editText4 != null && (context = editText4.getContext()) != null) {
                sp.f.d(context);
            }
            EditText editText5 = cVar.f30319d.getEditText();
            if (editText5 != null) {
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public static final Unit i(jq.c cVar, InputConfirmationCode inputConfirmationCode) {
        ConstraintLayout root = cVar.getRoot();
        Intrinsics.checkNotNullExpressionValue(root, "getRoot(...)");
        Sequence<TextInputLayout> F = kotlin.sequences.k.F(androidx.core.view.n0.a(root), a.f24491d);
        ...
        for (TextInputLayout textInputLayout : F) {
            ...
            if (styles != null) {
                lq.a0.k(textInputLayout, styles);
            }
        }
        return Unit.f31765a;
    }
    ...
    private static final void l(final EditText editText, final Function0 function0) {
        if (editText != null) {
            editText.setOnKeyListener(new View.OnKeyListener() { // from class: gq.z0
    ...
    private static final void n(final EditText editText) {
        if (editText != null) {
            editText.setOnFocusChangeListener(new View.OnFocusChangeListener() { // from class: gq.y0
