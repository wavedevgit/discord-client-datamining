...
public abstract class b2 {
    public static final LinearLayout f(final InputRadioGroupComponent inputRadioGroupComponent, m5 uiComponentHelper, final InputRadioGroup config) {
        ...
        final jq.m c10 = jq.m.c(uiComponentHelper.b());
        ...
        for (final OptionWithDescription optionWithDescription : l10) {
            final jq.b c11 = jq.b.c(uiComponentHelper.b(), c10.getRoot(), false);
            TextView radioButtonLabel = c11.f30315d;
            Intrinsics.checkNotNullExpressionValue(radioButtonLabel, "radioButtonLabel");
            hq.f.d(radioButtonLabel, optionWithDescription.getText());
            String descriptionText = optionWithDescription.getDescriptionText();
            if (descriptionText != null && !StringsKt.k0(descriptionText)) {
                c11.f30314c.setVisibility(0);
                TextView radioButtonDescription = c11.f30314c;
                Intrinsics.checkNotNullExpressionValue(radioButtonDescription, "radioButtonDescription");
                hq.f.d(radioButtonDescription, descriptionText);
            } else {
                c11.f30314c.setVisibility(8);
            }
            uiComponentHelper.d(new Function0() { // from class: gq.w1
            ...
            c11.f30313b.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() { // from class: gq.x1
                @Override // android.widget.CompoundButton.OnCheckedChangeListener
                public final void onCheckedChanged(CompoundButton compoundButton, boolean z10) {
                    b2.j(arrayList, config, optionWithDescription, inputRadioGroupComponent, compoundButton, z10);
                }
            });
            c11.getRoot().setOnClickListener(new View.OnClickListener() { // from class: gq.y1
                @Override // android.view.View.OnClickListener
                public final void onClick(View view) {
                    b2.k(jq.b.this, view);
                }
            });
            c10.f30376b.addView(c11.getRoot());
            MaterialRadioButton radioButton = c11.f30313b;
            Intrinsics.checkNotNullExpressionValue(radioButton, "radioButton");
            arrayList.add(radioButton);
            if (Intrinsics.areEqual(inputRadioGroupComponent.b().b(), optionWithDescription.getValue())) {
                c11.f30313b.setChecked(true);
            }
        }
        ...
        if (styles != null && (errorTextStyle = styles.getErrorTextStyle()) != null) {
            TextView radioGroupError = c10.f30377c;
            Intrinsics.checkNotNullExpressionValue(radioGroupError, "radioGroupError");
            lq.f0.n(radioGroupError, errorTextStyle, null, 2, null);
        }
        if (attributes != null) {
            str = attributes.getLabel();
        }
        if (str != null && str.length() != 0) {
            c10.f30378d.setVisibility(0);
            c10.f30378d.setText(str);
            uiComponentHelper.d(new Function0() { // from class: gq.z1
                @Override // kotlin.jvm.functions.Function0
                public final Object invoke() {
                    Unit g10;
            ...
            c10.f30378d.setVisibility(8);
        }
        uiComponentHelper.d(new Function0() { // from class: gq.a2
            @Override // kotlin.jvm.functions.Function0
            public final Object invoke() {
                Unit h10;
    ...
    public static final Unit g(InputRadioGroup inputRadioGroup, jq.m mVar) {
        ...
        if (styles != null && (textBasedStyle = styles.getTextBasedStyle()) != null) {
            TextView radioGroupLabel = mVar.f30378d;
            Intrinsics.checkNotNullExpressionValue(radioGroupLabel, "radioGroupLabel");
            lq.f0.n(radioGroupLabel, textBasedStyle, null, 2, null);
        }
        return Unit.f31765a;
    }

    /* JADX INFO: Access modifiers changed from: private */
    public static final Unit h(InputRadioGroup inputRadioGroup, jq.m mVar) {
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public static final Unit i(InputRadioGroup inputRadioGroup, jq.b bVar) {
        TextBasedComponentStyle descriptionTextStyle;
        TextBasedComponentStyle textBasedStyle;
        InputRadioGroup.InputRadioGroupComponentStyle styles = inputRadioGroup.getStyles();
        if (styles != null && (textBasedStyle = styles.getTextBasedStyle()) != null) {
            TextView radioButtonLabel = bVar.f30315d;
            Intrinsics.checkNotNullExpressionValue(radioButtonLabel, "radioButtonLabel");
            lq.f0.n(radioButtonLabel, textBasedStyle, null, 2, null);
        }
        ...
        if (styles2 != null && (descriptionTextStyle = styles2.getDescriptionTextStyle()) != null) {
            TextView radioButtonDescription = bVar.f30314c;
            Intrinsics.checkNotNullExpressionValue(radioButtonDescription, "radioButtonDescription");
            lq.f0.n(radioButtonDescription, descriptionTextStyle, null, 2, null);
        }
        bVar.f30313b.setButtonTintList(ColorStateList.valueOf(r1.c.l(bVar.f30315d.getCurrentTextColor(), 150)));
        return Unit.f31765a;
    }
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public static final void k(jq.b bVar, View view) {
        if (!bVar.f30313b.isChecked()) {
            bVar.f30313b.setChecked(true);
        }
    }
