...
public final class y implements k5, l5 {
    ...
    public boolean equals(Object obj) {
        ...
        y yVar = (y) obj;
        if (Intrinsics.areEqual(this.f24764d, yVar.f24764d) && Intrinsics.areEqual(this.f24765e, yVar.f24765e) && Intrinsics.areEqual(this.f24766i, yVar.f24766i)) {
            return true;
        }
        return false;
    }
    ...
    public int hashCode() {
        int hashCode;
        int hashCode2 = ((this.f24764d.hashCode() * 31) + this.f24765e.hashCode()) * 31;
        Integer num = this.f24766i;
        if (num == null) {
            hashCode = 0;
        } else {
    ...
    public final void writeToParcel(Parcel dest, int i10) {
        ...
        List<Parcelable> list = this.f24765e;
    ...
    */
    public y(com.withpersona.sdk2.inquiry.network.dto.ui.components.Footer r5) {
        ...
        L40:
            ...
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: gq.y.<init>(com.withpersona.sdk2.inquiry.network.dto.ui.components.Footer):void");
    }
}
