...
public final class f4 implements k5, e0 {
    ...
    private final JsonLogicBoolean f24552e;

    /* renamed from: i  reason: collision with root package name */
    private final int f24553i;

    /* renamed from: o  reason: collision with root package name */
    private final List f24554o;
    ...
    public f4(String name, JsonLogicBoolean jsonLogicBoolean, int i10) {
        ...
        this.f24551d = name;
        this.f24552e = jsonLogicBoolean;
        this.f24553i = i10;
        this.f24554o = new ArrayList();
    }
    ...
    public boolean equals(Object obj) {
        ...
        f4 f4Var = (f4) obj;
        if (Intrinsics.areEqual(this.f24551d, f4Var.f24551d) && Intrinsics.areEqual(this.f24552e, f4Var.f24552e) && this.f24553i == f4Var.f24553i) {
            return true;
        }
        return false;
    }
    ...
    public int hashCode() {
        int hashCode;
        int hashCode2 = this.f24551d.hashCode() * 31;
        JsonLogicBoolean jsonLogicBoolean = this.f24552e;
        if (jsonLogicBoolean == null) {
            hashCode = 0;
        } else {
            hashCode = jsonLogicBoolean.hashCode();
        }
        return ((hashCode2 + hashCode) * 31) + Integer.hashCode(this.f24553i);
    }

    public String toString() {
        String str = this.f24551d;
        JsonLogicBoolean jsonLogicBoolean = this.f24552e;
        int i10 = this.f24553i;
    ...
    public final void writeToParcel(Parcel dest, int i10) {
        ...
        dest.writeString(this.f24551d);
        dest.writeParcelable(this.f24552e, i10);
        dest.writeInt(this.f24553i);
    }
    ...
    */
    public f4(com.withpersona.sdk2.inquiry.network.dto.ui.components.QRCode r5) {
        ...
        L4e:
            ...
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: gq.f4.<init>(com.withpersona.sdk2.inquiry.network.dto.ui.components.QRCode):void");
    }
}
