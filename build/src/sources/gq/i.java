...
public final class i implements h {
    ...
    private final JsonLogicBoolean f24572e;

    /* renamed from: i  reason: collision with root package name */
    private final JsonLogicBoolean f24573i;

    /* renamed from: o  reason: collision with root package name */
    private final String f24574o;

    /* renamed from: p  reason: collision with root package name */
    private final Integer f24575p;

    /* renamed from: q  reason: collision with root package name */
    private final List f24576q;
    ...
    public i(String name, JsonLogicBoolean jsonLogicBoolean, JsonLogicBoolean jsonLogicBoolean2, String str, Integer num) {
        ...
        this.f24571d = name;
        this.f24572e = jsonLogicBoolean;
        this.f24573i = jsonLogicBoolean2;
        this.f24574o = str;
        this.f24575p = num;
        this.f24576q = new ArrayList();
    }
    ...
    public boolean equals(Object obj) {
        ...
        i iVar = (i) obj;
        if (Intrinsics.areEqual(this.f24571d, iVar.f24571d) && Intrinsics.areEqual(this.f24572e, iVar.f24572e) && Intrinsics.areEqual(this.f24573i, iVar.f24573i) && Intrinsics.areEqual(this.f24574o, iVar.f24574o) && Intrinsics.areEqual(this.f24575p, iVar.f24575p)) {
            return true;
        }
        return false;
    }
    ...
    public int hashCode() {
        ...
        int hashCode2;
        int hashCode3;
        int hashCode4 = this.f24571d.hashCode() * 31;
        JsonLogicBoolean jsonLogicBoolean = this.f24572e;
        int i10 = 0;
        ...
        JsonLogicBoolean jsonLogicBoolean2 = this.f24573i;
    ...
    public final void writeToParcel(Parcel dest, int i10) {
        ...
        dest.writeString(this.f24571d);
        dest.writeParcelable(this.f24572e, i10);
        dest.writeParcelable(this.f24573i, i10);
        dest.writeString(this.f24574o);
        Integer num = this.f24575p;
        if (num == null) {
            dest.writeInt(0);
            return;
    ...
    */
    public i(com.withpersona.sdk2.inquiry.network.dto.ui.components.CancelButton r8) {
        ...
        L3b:
            ...
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: gq.i.<init>(com.withpersona.sdk2.inquiry.network.dto.ui.components.CancelButton):void");
    }
}
