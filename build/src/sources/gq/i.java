...
public final class i implements ViewBinding {
    ...
    public final MaterialCheckBox f25108b;

    /* renamed from: c  reason: collision with root package name */
    public final TextView f25109c;

    /* renamed from: d  reason: collision with root package name */
    public final TextView f25110d;
    ...
    private i(ConstraintLayout constraintLayout, MaterialCheckBox materialCheckBox, TextView textView, TextView textView2, TextView textView3) {
        ...
        this.f25108b = materialCheckBox;
        this.f25109c = textView;
        this.f25110d = textView2;
        this.f25111e = textView3;
    }
    ...
    public static i d(LayoutInflater layoutInflater, ViewGroup viewGroup, boolean z10) {
        View inflate = layoutInflater.inflate(bq.f.f7169j, viewGroup, false);
        if (z10) {
