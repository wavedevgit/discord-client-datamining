...
public final class h5 implements k5, v, e0 {
    ...
    private final JsonLogicBoolean f24568e;

    /* renamed from: i  reason: collision with root package name */
    private final JsonLogicBoolean f24569i;

    /* renamed from: o  reason: collision with root package name */
    private final List f24570o;
    ...
    public h5(String name, JsonLogicBoolean jsonLogicBoolean, JsonLogicBoolean jsonLogicBoolean2) {
        ...
        this.f24567d = name;
        this.f24568e = jsonLogicBoolean;
        this.f24569i = jsonLogicBoolean2;
        this.f24570o = new ArrayList();
    }
    ...
    public boolean equals(Object obj) {
        ...
        h5 h5Var = (h5) obj;
        if (Intrinsics.areEqual(this.f24567d, h5Var.f24567d) && Intrinsics.areEqual(this.f24568e, h5Var.f24568e) && Intrinsics.areEqual(this.f24569i, h5Var.f24569i)) {
            return true;
        }
        return false;
    }
    ...
    public int hashCode() {
        int hashCode;
        int hashCode2 = this.f24567d.hashCode() * 31;
        JsonLogicBoolean jsonLogicBoolean = this.f24568e;
        int i10 = 0;
        ...
        JsonLogicBoolean jsonLogicBoolean2 = this.f24569i;
    ...
    public final void writeToParcel(Parcel dest, int i10) {
        ...
        dest.writeString(this.f24567d);
        dest.writeParcelable(this.f24568e, i10);
        dest.writeParcelable(this.f24569i, i10);
    }
    ...
    */
    public h5(com.withpersona.sdk2.inquiry.network.dto.ui.components.Title r4) {
        ...
        L20:
            ...
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: gq.h5.<init>(com.withpersona.sdk2.inquiry.network.dto.ui.components.Title):void");
    }
}
