...
public abstract class e1 {
    public static final ConstraintLayout b(InputDateComponent inputDateComponent, m5 uiComponentHelper, hq.e dateController, InputDate config) {
        ...
        if (attributes != null) {
            ...
            fq.a aVar = new fq.a(a10, i10, textMonths, textBasedComponentStyle);
            en.t d10 = dateController.d();
            AutoCompleteTextView monthEditText = c10.f30351g;
            Intrinsics.checkNotNullExpressionValue(monthEditText, "monthEditText");
            en.u.b(d10, monthEditText);
            c10.f30351g.setAdapter(aVar);
            if (styles != null && (backgroundColor = styles.getBackgroundColor()) != null && (inputSelectBackgroundColor = backgroundColor.getInputSelectBackgroundColor()) != null) {
                c10.f30351g.setDropDownBackgroundDrawable(new ColorDrawable(inputSelectBackgroundColor.intValue()));
            }
            c10.f30347c.setHint(attributes.getPlaceholderDay());
            en.t c11 = dateController.c();
            TextInputEditText dayEditText = c10.f30348d;
            Intrinsics.checkNotNullExpressionValue(dayEditText, "dayEditText");
            en.u.b(c11, dayEditText);
            c10.f30352h.setHint(attributes.getPlaceholderYear());
            en.t g10 = dateController.g();
            TextInputEditText yearEditText = c10.f30353i;
            Intrinsics.checkNotNullExpressionValue(yearEditText, "yearEditText");
            en.u.b(g10, yearEditText);
        }
        uiComponentHelper.d(new Function0() { // from class: gq.d1
    ...
    public static /* synthetic */ ConstraintLayout c(InputDateComponent inputDateComponent, m5 m5Var, hq.e eVar, InputDate inputDate, int i10, Object obj) {
        if ((i10 & 2) != 0) {
    ...
    public static final Unit d(InputDate.InputDateComponentStyle inputDateComponentStyle, jq.f fVar) {
        ...
        if (inputDateComponentStyle != null && (inputSelectStyle3 = inputDateComponentStyle.getInputSelectStyle()) != null && (labelStyle = inputSelectStyle3.getLabelStyle()) != null) {
            TextView dateLabel = fVar.f30346b;
            Intrinsics.checkNotNullExpressionValue(dateLabel, "dateLabel");
            lq.f0.n(dateLabel, labelStyle, null, 2, null);
        }
