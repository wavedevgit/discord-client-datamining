...
public abstract class s1 {
    public static final TextInputLayout b(InputNumberComponent inputNumberComponent, m5 uiComponentHelper, final InputNumber config) {
        ...
        if (attributes != null) {
            ...
            if (precision != null) {
                ...
                EditText editText = c10.f30372c.getEditText();
                if (editText != null) {
                    editText.setFilters(new u[]{new u(intValue)});
                }
            }
        }
        c10.f30371b.setText(String.valueOf(inputNumberComponent.b().b()));
        TextInputEditText editText2 = c10.f30371b;
        Intrinsics.checkNotNullExpressionValue(editText2, "editText");
        editText2.addTextChangedListener(new a(inputNumberComponent));
        uiComponentHelper.d(new Function0() { // from class: gq.r1
    ...
    public static final Unit c(InputNumber inputNumber, jq.k kVar) {
    ...
    public static final class a implements TextWatcher {
        ...
        final /* synthetic */ InputNumberComponent f24701d;

        public a(InputNumberComponent inputNumberComponent) {
            this.f24701d = inputNumberComponent;
        }
