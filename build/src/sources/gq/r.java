...
public final class r implements eq.b {
    ...
    private final List f24691e;

    /* renamed from: i  reason: collision with root package name */
    private final StepStyles.UiStepStyle f24692i;
    ...
    public r(List list, List componentConfigs, StepStyles.UiStepStyle uiStepStyle) {
        ...
        this.f24690d = list;
        this.f24691e = componentConfigs;
        this.f24692i = uiStepStyle;
    }
    ...
    public boolean equals(Object obj) {
        ...
        r rVar = (r) obj;
        if (Intrinsics.areEqual(this.f24690d, rVar.f24690d) && Intrinsics.areEqual(this.f24691e, rVar.f24691e) && Intrinsics.areEqual(this.f24692i, rVar.f24692i)) {
            return true;
        }
        return false;
    }
    ...
    public int hashCode() {
        ...
        int hashCode2 = ((hashCode * 31) + this.f24691e.hashCode()) * 31;
        StepStyles.UiStepStyle uiStepStyle = this.f24692i;
        if (uiStepStyle != null) {
    ...
    public final void writeToParcel(Parcel dest, int i10) {
        ...
        List<Parcelable> list = this.f24690d;
        if (list == null) {
            dest.writeInt(0);
        } else {
            dest.writeInt(1);
        ...
        List<Parcelable> list2 = this.f24691e;
        dest.writeInt(list2.size());
        for (Parcelable parcelable2 : list2) {
            dest.writeParcelable(parcelable2, i10);
        }
        dest.writeParcelable(this.f24692i, i10);
    }
}
