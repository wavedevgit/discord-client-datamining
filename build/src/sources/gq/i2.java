...
public abstract class i2 {
    ...
    public static final TextInputLayout b(InputTextComponent inputTextComponent, m5 uiComponentHelper, final InputText config, en.t textController) {
        String str;
        ...
        final jq.o c10 = jq.o.c(uiComponentHelper.b());
        TextInputEditText editText = c10.f30383b;
        Intrinsics.checkNotNullExpressionValue(editText, "editText");
        en.u.b(textController, editText);
        InputText.Attributes attributes = config.getAttributes();
        if (attributes != null) {
            String label = attributes.getLabel();
            if (label != null) {
                c10.f30384c.setHint(label);
            }
            String placeholder = attributes.getPlaceholder();
            if (placeholder != null) {
                c10.f30384c.setPlaceholderText(placeholder);
                TextInputLayout inputLayout = c10.f30384c;
                Intrinsics.checkNotNullExpressionValue(inputLayout, "inputLayout");
                cq.o.a(inputLayout);
            }
            c10.f30383b.setInputType(e(attributes.getInputType()));
            if (Build.VERSION.SDK_INT >= 26) {
                ...
                c10.f30384c.setAutofillHints(new String[]{str});
            }
        }
        uiComponentHelper.d(new Function0() { // from class: gq.h2
    ...
    public static /* synthetic */ TextInputLayout c(InputTextComponent inputTextComponent, m5 m5Var, InputText inputText, en.t tVar, int i10, Object obj) {
        if ((i10 & 4) != 0) {
    ...
    public static final Unit d(InputText inputText, jq.o oVar) {
        InputTextBasedComponentStyle styles = inputText.getStyles();
        if (styles != null) {
            TextInputLayout inputLayout = oVar.f30384c;
            Intrinsics.checkNotNullExpressionValue(inputLayout, "inputLayout");
    ...
    private static final int e(InputText.InputType inputType) {
        int i10 = a.f24580a[inputType.ordinal()];
        if (i10 == 1) {
            return 1;
        }
        if (i10 != 2) {
    ...
    private static final String f(InputText.AutofillHint autofillHint) {
        switch (a.f24581b[autofillHint.ordinal()]) {
            case 1:
                return "personName";
            case 2:
