...
public final class c5 implements h {
    ...
    private final JsonLogicBoolean f24514e;

    /* renamed from: i  reason: collision with root package name */
    private final JsonLogicBoolean f24515i;

    /* renamed from: o  reason: collision with root package name */
    private final String f24516o;

    /* renamed from: p  reason: collision with root package name */
    private final Integer f24517p;

    /* renamed from: q  reason: collision with root package name */
    private final List f24518q;
    ...
    public c5(String name, JsonLogicBoolean jsonLogicBoolean, JsonLogicBoolean jsonLogicBoolean2, String str, Integer num) {
        ...
        this.f24513d = name;
        this.f24514e = jsonLogicBoolean;
        this.f24515i = jsonLogicBoolean2;
        this.f24516o = str;
        this.f24517p = num;
    ...
    public boolean equals(Object obj) {
        ...
        c5 c5Var = (c5) obj;
        if (Intrinsics.areEqual(this.f24513d, c5Var.f24513d) && Intrinsics.areEqual(this.f24514e, c5Var.f24514e) && Intrinsics.areEqual(this.f24515i, c5Var.f24515i) && Intrinsics.areEqual(this.f24516o, c5Var.f24516o) && Intrinsics.areEqual(this.f24517p, c5Var.f24517p)) {
            return true;
        }
        return false;
    }
    ...
    public int hashCode() {
        ...
        int hashCode2;
        int hashCode3;
        int hashCode4 = this.f24513d.hashCode() * 31;
        JsonLogicBoolean jsonLogicBoolean = this.f24514e;
        int i10 = 0;
        ...
        JsonLogicBoolean jsonLogicBoolean2 = this.f24515i;
    ...
    public final void writeToParcel(Parcel dest, int i10) {
        ...
        dest.writeString(this.f24513d);
        dest.writeParcelable(this.f24514e, i10);
        dest.writeParcelable(this.f24515i, i10);
        dest.writeString(this.f24516o);
        Integer num = this.f24517p;
        if (num == null) {
            dest.writeInt(0);
            return;
    ...
    */
    public c5(com.withpersona.sdk2.inquiry.network.dto.ui.components.SubmitButton r8) {
        ...
        L3b:
            ...
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: gq.c5.<init>(com.withpersona.sdk2.inquiry.network.dto.ui.components.SubmitButton):void");
    }
}
