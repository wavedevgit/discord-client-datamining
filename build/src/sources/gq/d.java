...
public final class d {
    ...
    public static final d f25510a;

    /* renamed from: b  reason: collision with root package name */
    private static final Lazy f25511b;

    /* renamed from: c  reason: collision with root package name */
    private static final b f25512c;

    /* renamed from: d  reason: collision with root package name */
    private static final Map f25513d;

    /* renamed from: e  reason: collision with root package name */
    private static final b4 f25514e;

    /* loaded from: /home/runner/work/discord-client-datamining/discord-client-datamining/build/classes4.dex */
    public static final class a implements Comparator {
        @Override // java.util.Comparator
        public final int compare(Object obj, Object obj2) {
            return tr.a.d(((b4) obj).getText(), ((b4) obj2).getText());
        }
    }
    ...
    static {
        d dVar = new d();
        f25510a = dVar;
        f25511b = qr.l.a(new Function0() { // from class: gq.c
    ...
    private final List d() {
        ...
        for (Map.Entry entry2 : linkedHashMap.entrySet()) {
            arrayList.add(f25510a.m((b) entry2.getValue()));
        }
    ...
    public final b4 g(String str) {
        ...
        if (str != null && str.length() == 2) {
            ...
            Intrinsics.checkNotNullExpressionValue(upperCase, "toUpperCase(...)");
            b bVar = (b) f25513d.get(upperCase);
    ...
    */
    public final java.lang.String i(fq.b4 r8) {
        /*
            r7 = this;
        ...
        L3e:
            ...
            return r8
        */
        throw new UnsupportedOperationException("Method not decompiled: gq.d.i(fq.b4):java.lang.String");
    }
