...
public abstract class u0 {
    public static final LinearLayout c(final InputCheckboxGroupComponent inputCheckboxGroupComponent, m5 uiComponentHelper, final InputCheckboxGroup config) {
        ...
        final jq.j c10 = jq.j.c(uiComponentHelper.b());
        ...
        for (OptionWithDescription optionWithDescription : l10) {
            ...
            jq.i d10 = jq.i.d(uiComponentHelper.b(), c10.f30367b, false);
            Intrinsics.checkNotNullExpressionValue(d10, "inflate(...)");
            c10.f30367b.addView(r0.e(inputCheckboxComponent, uiComponentHelper, d10, inputCheckbox));
            d10.f30362b.setTag(optionWithDescription.getValue());
            if (inputCheckboxGroupComponent.b().b().contains(optionWithDescription.getValue())) {
                d10.f30362b.setChecked(z11);
            }
            MaterialCheckBox checkbox = d10.f30362b;
            Intrinsics.checkNotNullExpressionValue(checkbox, "checkbox");
            arrayList.add(checkbox);
        }
        for (MaterialCheckBox materialCheckBox : arrayList) {
            materialCheckBox.c(new MaterialCheckBox.b() { // from class: gq.s0
        ...
        if (styles != null && (errorTextStyle = styles.getErrorTextStyle()) != null) {
            TextView checkboxGroupError = c10.f30368c;
            Intrinsics.checkNotNullExpressionValue(checkboxGroupError, "checkboxGroupError");
            str = null;
            lq.f0.n(checkboxGroupError, errorTextStyle, null, 2, null);
        } else {
            str = null;
        }
        if (attributes != null) {
        ...
        if (str2 != null && str2.length() != 0) {
            c10.f30369d.setVisibility(0);
            c10.f30369d.setText(str2);
            uiComponentHelper.d(new Function0() { // from class: gq.t0
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public static final Unit e(InputCheckboxGroup inputCheckboxGroup, jq.j jVar) {
        ...
        if (styles != null && (textBasedStyle = styles.getTextBasedStyle()) != null) {
            TextView checkboxGroupLabel = jVar.f30369d;
            Intrinsics.checkNotNullExpressionValue(checkboxGroupLabel, "checkboxGroupLabel");
            lq.f0.n(checkboxGroupLabel, textBasedStyle, null, 2, null);
        }
        return Unit.f31765a;
    }
    ...
    private static final void f(InputCheckboxGroupComponent inputCheckboxGroupComponent, List list) {
        String str;
        hq.l b10 = inputCheckboxGroupComponent.b();
