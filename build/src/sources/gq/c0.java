...
public abstract class c0 {
    public static final LinearLayout c(GovernmentIdNfcScanComponent governmentIdNfcScanComponent, m5 uiComponentHelper, final GovernmentIdNfcScan config) {
        ...
        final TextInputLayout b11 = i2.b(new InputTextComponent(inputText2), uiComponentHelper, inputText2, governmentIdNfcScanComponent.h());
        b11.setId(eq.e.f21981e0);
        ...
        if (attributes23 != null && (hidePrefilledInputs = attributes23.getHidePrefilledInputs()) != null && hidePrefilledInputs.booleanValue()) {
            uiComponentHelper.d(new Function0() { // from class: gq.a0
        ...
        textView.setId(eq.e.f21983f0);
        uiComponentHelper.d(new Function0() { // from class: gq.b0
            @Override // kotlin.jvm.functions.Function0
            public final Object invoke() {
                Unit e10;
        ...
        linearLayout.setTag(new d0(b10, b11, fVar, (jq.f) tag2, a10, textView));
        return linearLayout;
    }
    ...
    public static final Unit e(TextView textView, GovernmentIdNfcScan governmentIdNfcScan) {
        ...
        if (styles != null && (errorLabelStyle = styles.getErrorLabelStyle()) != null) {
            lq.f0.n(textView, errorLabelStyle, null, 2, null);
        }
        return Unit.f31765a;
    }
}
