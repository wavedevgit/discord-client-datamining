...
public final class e implements k5 {
    ...
    public boolean equals(Object obj) {
        ...
        e eVar = (e) obj;
        if (Intrinsics.areEqual(this.f24533d, eVar.f24533d) && this.f24534e == eVar.f24534e) {
            return true;
        }
        return false;
    }
    ...
    public int hashCode() {
        return (this.f24533d.hashCode() * 31) + Boolean.hashCode(this.f24534e);
    }

    public String toString() {
        String str = this.f24533d;
        boolean z10 = this.f24534e;
    ...
    public final void writeToParcel(Parcel dest, int i10) {
        ...
        dest.writeString(this.f24533d);
        dest.writeInt(this.f24534e ? 1 : 0);
    }
    ...
    */
    public e(com.withpersona.sdk2.inquiry.network.dto.ui.components.Branding r3) {
        ...
        L1b:
            ...
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: gq.e.<init>(com.withpersona.sdk2.inquiry.network.dto.ui.components.Branding):void");
    }
}
