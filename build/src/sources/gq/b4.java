...
public final class b4 implements Parcelable {
    ...
    public boolean equals(Object obj) {
        ...
        b4 b4Var = (b4) obj;
        if (Intrinsics.areEqual(this.f24502d, b4Var.f24502d) && Intrinsics.areEqual(this.f24503e, b4Var.f24503e)) {
            return true;
        }
        return false;
    }
    ...
    public int hashCode() {
        return (this.f24502d.hashCode() * 31) + this.f24503e.hashCode();
    }
    ...
    public final void writeToParcel(Parcel dest, int i10) {
        ...
        dest.writeString(this.f24502d);
        dest.writeString(this.f24503e);
    }
}
