...
public final class o implements h {
    ...
    private final JsonLogicBoolean f24648e;

    /* renamed from: i  reason: collision with root package name */
    private final JsonLogicBoolean f24649i;

    /* renamed from: o  reason: collision with root package name */
    private final String f24650o;

    /* renamed from: p  reason: collision with root package name */
    private final Integer f24651p;

    /* renamed from: q  reason: collision with root package name */
    private final List f24652q;
    ...
    public o(String name, JsonLogicBoolean jsonLogicBoolean, JsonLogicBoolean jsonLogicBoolean2, String str, Integer num) {
        ...
        this.f24647d = name;
        this.f24648e = jsonLogicBoolean;
        this.f24649i = jsonLogicBoolean2;
        this.f24650o = str;
        this.f24651p = num;
    ...
    public boolean equals(Object obj) {
        ...
        o oVar = (o) obj;
        if (Intrinsics.areEqual(this.f24647d, oVar.f24647d) && Intrinsics.areEqual(this.f24648e, oVar.f24648e) && Intrinsics.areEqual(this.f24649i, oVar.f24649i) && Intrinsics.areEqual(this.f24650o, oVar.f24650o) && Intrinsics.areEqual(this.f24651p, oVar.f24651p)) {
            return true;
        }
        return false;
    }
    ...
    public int hashCode() {
        ...
        int hashCode2;
        int hashCode3;
        int hashCode4 = this.f24647d.hashCode() * 31;
        JsonLogicBoolean jsonLogicBoolean = this.f24648e;
        int i10 = 0;
        ...
        JsonLogicBoolean jsonLogicBoolean2 = this.f24649i;
    ...
    public final void writeToParcel(Parcel dest, int i10) {
        ...
        dest.writeParcelable(this.f24648e, i10);
        dest.writeParcelable(this.f24649i, i10);
        dest.writeString(this.f24650o);
        Integer num = this.f24651p;
        if (num == null) {
            dest.writeInt(0);
            return;
    ...
    */
    public o(com.withpersona.sdk2.inquiry.network.dto.ui.components.CompleteButton r8) {
        ...
        L3b:
            ...
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: gq.o.<init>(com.withpersona.sdk2.inquiry.network.dto.ui.components.CompleteButton):void");
    }
}
