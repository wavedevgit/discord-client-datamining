...
public abstract class r0 {
    public static final ConstraintLayout d(InputCheckboxComponent inputCheckboxComponent, m5 uiComponentHelper, InputCheckbox config) {
        ...
        jq.i c10 = jq.i.c(uiComponentHelper.b());
        Intrinsics.checkNotNullExpressionValue(c10, "inflate(...)");
        return e(inputCheckboxComponent, uiComponentHelper, c10, config);
    }

    public static final ConstraintLayout e(final InputCheckboxComponent inputCheckboxComponent, m5 uiComponentHelper, final jq.i binding, final InputCheckbox config) {
        String str;
        ...
        binding.f30362b.setChecked(inputCheckboxComponent.a().b());
        binding.f30362b.setClickable(false);
        binding.f30362b.setFocusable(false);
        ...
        if (str != null && !StringsKt.k0(str)) {
            binding.f30365e.setVisibility(0);
            TextView checkboxLabel = binding.f30365e;
            Intrinsics.checkNotNullExpressionValue(checkboxLabel, "checkboxLabel");
            hq.f.d(checkboxLabel, str);
        } else {
            binding.f30365e.setVisibility(8);
        }
        ...
        if (str2 != null && !StringsKt.k0(str2)) {
            binding.f30363c.setVisibility(0);
            TextView checkboxDescription = binding.f30363c;
            Intrinsics.checkNotNullExpressionValue(checkboxDescription, "checkboxDescription");
            hq.f.d(checkboxDescription, str2);
        } else {
            binding.f30363c.setVisibility(8);
        }
        binding.f30362b.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() { // from class: gq.o0
            @Override // android.widget.CompoundButton.OnCheckedChangeListener
            public final void onCheckedChanged(CompoundButton compoundButton, boolean z10) {
                r0.f(InputCheckboxComponent.this, compoundButton, z10);
            }
        });
        binding.getRoot().setOnClickListener(new View.OnClickListener() { // from class: gq.p0
        ...
        if (styles != null && (textColorHighlight = styles.getTextColorHighlight()) != null && (base = textColorHighlight.getBase()) != null && (base2 = base.getBase()) != null && (value = base2.getValue()) != null) {
            binding.f30362b.setButtonTintList(new ColorStateList(new int[][]{new int[]{-16842910}, new int[]{-16842912}, new int[]{16842912}}, new int[]{r1.c.l(sp.s.d(a10, bh.b.f6637k, null, false, 6, null), (int) (q1.j.h(a10.getResources(), bh.d.f6694x) * ((float) SetSpanOperation.SPAN_MAX_PRIORITY))), sp.s.d(a10, bh.b.f6637k, null, false, 6, null), value.intValue()}));
        }
        uiComponentHelper.d(new Function0() { // from class: gq.q0
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public static final void g(jq.i iVar, View view) {
        iVar.f30362b.toggle();
    }

    /* JADX INFO: Access modifiers changed from: private */
    public static final Unit h(InputCheckbox inputCheckbox, jq.i iVar) {
        ...
        if (styles != null && (textBasedStyle = styles.getTextBasedStyle()) != null) {
            TextView checkboxLabel = iVar.f30365e;
            Intrinsics.checkNotNullExpressionValue(checkboxLabel, "checkboxLabel");
            lq.f0.n(checkboxLabel, textBasedStyle, null, 2, null);
        }
        ...
        if (styles2 != null && (descriptionTextStyle = styles2.getDescriptionTextStyle()) != null) {
            TextView checkboxDescription = iVar.f30363c;
            Intrinsics.checkNotNullExpressionValue(checkboxDescription, "checkboxDescription");
            lq.f0.n(checkboxDescription, descriptionTextStyle, null, 2, null);
        }
        ...
        if (styles3 != null && (errorTextStyle = styles3.getErrorTextStyle()) != null) {
            TextView checkboxError = iVar.f30364d;
            Intrinsics.checkNotNullExpressionValue(checkboxError, "checkboxError");
            lq.f0.n(checkboxError, errorTextStyle, null, 2, null);
        }
        TextView checkboxLabel2 = iVar.f30365e;
        ...
        if (layoutParams != null) {
            ...
            TextView checkboxLabel3 = iVar.f30365e;
            Intrinsics.checkNotNullExpressionValue(checkboxLabel3, "checkboxLabel");
            int a10 = cq.p.a(checkboxLabel3);
            TextView checkboxDescription2 = iVar.f30363c;
            Intrinsics.checkNotNullExpressionValue(checkboxDescription2, "checkboxDescription");
            int a11 = a10 + cq.p.a(checkboxDescription2);
            if (a11 != 0) {
                if (a11 != 1) {
                    ((ViewGroup.MarginLayoutParams) layoutParams2).topMargin = (int) sp.h.a(4.0d);
                } else {
                    ((ViewGroup.MarginLayoutParams) layoutParams2).topMargin = (int) sp.h.a(0.0d);
                }
            }
