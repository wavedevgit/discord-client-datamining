...
public final class f0 implements k5, l5, e0 {
    ...
    private final List f24542e;

    /* renamed from: i  reason: collision with root package name */
    private final JsonLogicBoolean f24543i;

    /* renamed from: o  reason: collision with root package name */
    private final List f24544o;
    ...
    public f0(String name, List children, JsonLogicBoolean jsonLogicBoolean) {
        ...
        this.f24541d = name;
        this.f24542e = children;
        this.f24543i = jsonLogicBoolean;
    ...
    public static /* synthetic */ f0 b(f0 f0Var, String str, List list, JsonLogicBoolean jsonLogicBoolean, int i10, Object obj) {
        ...
        if ((i10 & 4) != 0) {
            jsonLogicBoolean = f0Var.f24543i;
        }
    ...
    public boolean equals(Object obj) {
        ...
        f0 f0Var = (f0) obj;
        if (Intrinsics.areEqual(this.f24541d, f0Var.f24541d) && Intrinsics.areEqual(this.f24542e, f0Var.f24542e) && Intrinsics.areEqual(this.f24543i, f0Var.f24543i)) {
            return true;
        }
        return false;
    }
    ...
    public int hashCode() {
        int hashCode;
        int hashCode2 = ((this.f24541d.hashCode() * 31) + this.f24542e.hashCode()) * 31;
        JsonLogicBoolean jsonLogicBoolean = this.f24543i;
    ...
    public final void writeToParcel(Parcel dest, int i10) {
        ...
        dest.writeString(this.f24541d);
        List<Parcelable> list = this.f24542e;
        dest.writeInt(list.size());
        for (Parcelable parcelable : list) {
            dest.writeParcelable(parcelable, i10);
        }
        dest.writeParcelable(this.f24543i, i10);
    }
    ...
    */
    public f0(com.withpersona.sdk2.inquiry.network.dto.ui.components.HorizontalStack r5) {
        ...
        L40:
            ...
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: gq.f0.<init>(com.withpersona.sdk2.inquiry.network.dto.ui.components.HorizontalStack):void");
    }
}
