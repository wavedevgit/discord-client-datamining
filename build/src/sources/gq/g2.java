...
public abstract class g2 {
    public static final TextInputLayout b(InputTextAreaComponent inputTextAreaComponent, m5 uiComponentHelper, final InputTextArea config) {
        ...
        final jq.n c10 = jq.n.c(uiComponentHelper.b());
        InputTextArea.Attributes attributes = config.getAttributes();
        if (attributes != null) {
            en.t b10 = inputTextAreaComponent.b();
            TextInputEditText editText = c10.f30380b;
            Intrinsics.checkNotNullExpressionValue(editText, "editText");
            en.u.b(b10, editText);
            String label = attributes.getLabel();
            if (label != null) {
                c10.f30381c.setHint(label);
            }
            String placeholder = attributes.getPlaceholder();
            if (placeholder != null) {
                c10.f30381c.setPlaceholderText(placeholder);
                TextInputLayout inputLayout = c10.f30381c;
            ...
            if (rows != null) {
                ...
                c10.f30380b.setMaxLines(intValue);
                c10.f30380b.setMinLines(intValue);
                c10.f30380b.setVerticalScrollBarEnabled(true);
            }
        }
        uiComponentHelper.d(new Function0() { // from class: gq.f2
    ...
    public static final Unit c(InputTextArea inputTextArea, jq.n nVar) {
        InputTextBasedComponentStyle styles = inputTextArea.getStyles();
        if (styles != null) {
            TextInputLayout inputLayout = nVar.f30381c;
            Intrinsics.checkNotNullExpressionValue(inputLayout, "inputLayout");
