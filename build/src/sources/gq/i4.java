...
public final class i4 implements k5, e0 {
    ...
    private final JsonLogicBoolean f24584e;
    ...
    public boolean equals(Object obj) {
        ...
        i4 i4Var = (i4) obj;
        if (Intrinsics.areEqual(this.f24583d, i4Var.f24583d) && Intrinsics.areEqual(this.f24584e, i4Var.f24584e)) {
            return true;
        }
        return false;
    }
    ...
    public int hashCode() {
        int hashCode;
        int hashCode2 = this.f24583d.hashCode() * 31;
        JsonLogicBoolean jsonLogicBoolean = this.f24584e;
    ...
    public final void writeToParcel(Parcel dest, int i10) {
        ...
        dest.writeString(this.f24583d);
        dest.writeParcelable(this.f24584e, i10);
    }
    ...
    */
    public i4(com.withpersona.sdk2.inquiry.network.dto.ui.components.RemoteImage r2) {
        ...
        L15:
            ...
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: gq.i4.<init>(com.withpersona.sdk2.inquiry.network.dto.ui.components.RemoteImage):void");
    }
}
