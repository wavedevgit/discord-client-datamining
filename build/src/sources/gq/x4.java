...
public final class x4 implements k5, e0 {
    ...
    private final JsonLogicBoolean f24760e;
    ...
    public x4(String name, JsonLogicBoolean jsonLogicBoolean, int i10, int i11) {
        ...
        this.f24759d = name;
        this.f24760e = jsonLogicBoolean;
        this.f24761i = i10;
        this.f24762o = i11;
        this.f24763p = new ArrayList();
    }
    ...
    public boolean equals(Object obj) {
        ...
        x4 x4Var = (x4) obj;
        if (Intrinsics.areEqual(this.f24759d, x4Var.f24759d) && Intrinsics.areEqual(this.f24760e, x4Var.f24760e) && this.f24761i == x4Var.f24761i && this.f24762o == x4Var.f24762o) {
            return true;
        }
        return false;
    }
    ...
    public int hashCode() {
        int hashCode;
        int hashCode2 = this.f24759d.hashCode() * 31;
        JsonLogicBoolean jsonLogicBoolean = this.f24760e;
        if (jsonLogicBoolean == null) {
            hashCode = 0;
        } else {
            hashCode = jsonLogicBoolean.hashCode();
        }
        return ((((hashCode2 + hashCode) * 31) + Integer.hashCode(this.f24761i)) * 31) + Integer.hashCode(this.f24762o);
    }
    ...
    public final void writeToParcel(Parcel dest, int i10) {
        ...
        dest.writeString(this.f24759d);
        dest.writeParcelable(this.f24760e, i10);
        dest.writeInt(this.f24761i);
        dest.writeInt(this.f24762o);
    }
    ...
    */
    public x4(com.withpersona.sdk2.inquiry.network.dto.ui.components.Spacer r6) {
        ...
        L86:
            ...
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: gq.x4.<init>(com.withpersona.sdk2.inquiry.network.dto.ui.components.Spacer):void");
    }
}
