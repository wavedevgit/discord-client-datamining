...
public final class b implements ViewBinding {
    ...
    private final ConstraintLayout f25058a;

    /* renamed from: b  reason: collision with root package name */
    public final MaterialRadioButton f25059b;
    ...
    private b(ConstraintLayout constraintLayout, MaterialRadioButton materialRadioButton, TextView textView, TextView textView2) {
        ...
        this.f25059b = materialRadioButton;
        this.f25060c = textView;
        this.f25061d = textView2;
    }

    public static b a(View view) {
        int i10 = bq.e.f7129k0;
    ...
    public static b c(LayoutInflater layoutInflater, ViewGroup viewGroup, boolean z10) {
        View inflate = layoutInflater.inflate(bq.f.f7161b, viewGroup, false);
        if (z10) {
