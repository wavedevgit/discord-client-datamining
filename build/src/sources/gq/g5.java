...
public abstract class g5 {
    public static final TextView b(e5 e5Var, m5 uiComponentHelper, final Text config) {
        ...
        final jq.w c10 = jq.w.c(uiComponentHelper.b());
        Text.Attributes attributes = config.getAttributes();
        if (attributes != null) {
            TextView textView = c10.f30414b;
            Intrinsics.checkNotNullExpressionValue(textView, "textView");
            hq.f.d(textView, attributes.getText());
            uiComponentHelper.d(new Function0() { // from class: gq.f5
    ...
    public static final Unit c(Text text, jq.w wVar) {
        TextBasedComponentStyle styles = text.getStyles();
        if (styles != null) {
            TextView textView = wVar.f30414b;
            Intrinsics.checkNotNullExpressionValue(textView, "textView");
