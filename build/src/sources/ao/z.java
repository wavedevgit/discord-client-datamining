...
public abstract class z {
    ...
    public /* synthetic */ class a {
        ...
        public static final /* synthetic */ int[] f6564c;

        /* renamed from: d  reason: collision with root package name */
        public static final /* synthetic */ int[] f6565d;
        ...
        static {
            ...
            try {
                iArr4[c4.e.f5836o.ordinal()] = 1;
            } catch (NoSuchFieldError unused16) {
            }
            try {
                iArr4[c4.e.f5837p.ordinal()] = 2;
            } catch (NoSuchFieldError unused17) {
            }
            try {
                iArr4[c4.e.f5839r.ordinal()] = 3;
            } catch (NoSuchFieldError unused18) {
            }
            try {
                iArr4[c4.e.f5838q.ordinal()] = 4;
            } catch (NoSuchFieldError unused19) {
            }
            try {
                iArr4[c4.e.f5840s.ordinal()] = 5;
        ...
        if (i10 != 1) {
            if (i10 != 2) {
                if (i10 != 3) {
                    ...
                    return new c4.a(new mn.f(CollectionsKt.e(new e.b(false, 1, null))));
                }
                return new c4.a(new mn.f(CollectionsKt.e(new e.a(false, 1, null))));
            }
            return new c4.a(new mn.f(CollectionsKt.e(new e.a(false, 1, null))));
        }
        return new c4.a(new mn.f(CollectionsKt.e(new e.c(false, 1, null))));
    }
    ...
    private static final f5.d c(io.e eVar, c4.e eVar2, String str) {
        if (eVar2 == c4.e.f5839r) {
    ...
    public static final c4.c f(CapturePageConfig capturePageConfig, c4.e side, io.e type, String countryCode, long j10) {
        c4.a a10;
        c4.d b10;
        f5.d c10;
    ...
    private static final f5.d h(CapturePageConfig.OverlayConfig overlayConfig) {
        ...
        if (overlayFallback == null) {
            ...
            i10 = a.f6563b[overlayFallback.ordinal()];
        }
        switch (i10) {
            case -1:
                return f5.d.f.f5990d;
            ...
            case 4:
                return f5.d.a.f5984d;
            case 5:
                return f5.d.b.f5985d;
            case 6:
                return f5.d.f.f5990d;
        }
    }

    public static final bo.a i(NextStep.GovernmentId.AutoClassificationConfig autoClassificationConfig, long j10) {
        Boolean bool;
        Boolean bool2;
        CapturePageConfig capturePageConfig;
        a.C0117a c0117a = bo.a.f7547o;
        c4.c cVar = null;
        ...
        if (autoClassificationConfig != null && (capturePageConfig = autoClassificationConfig.getCapturePageConfig()) != null) {
            cVar = f(capturePageConfig, c4.e.f5836o, io.e.M, "", j10);
        }
        return c0117a.b(bool, bool2, cVar);
    }

    private static final mn.e j(CapturePageConfig.Rule rule) {
        int i10;
        CapturePageConfig.RuleType type = rule.getType();
        if (type == null) {
            i10 = -1;
        } else {
            i10 = a.f6562a[type.ordinal()];
        }
        if (i10 != -1) {
            if (i10 != 1) {
                if (i10 != 2) {
                    if (i10 != 3) {
                        if (i10 != 4) {
                            if (i10 == 5) {
                                return new e.C0499e(Intrinsics.areEqual(rule.isRequired(), Boolean.TRUE));
                            }
                            throw new ir.p();
                        }
    ...
    private static final mn.f k(CapturePageConfig.RuleSet ruleSet) {
        List l10;
        List<CapturePageConfig.Rule> rules = ruleSet.getRules();
        if (rules != null) {
            l10 = new ArrayList();
    ...
    public static final k0 l(mn.g gVar) {
        Date date;
    ...
    public static final k0 m(mn.d0 d0Var) {
    ...
    private static final g4 n(Id.IdLocalIcon idLocalIcon) {
        ...
        if (idLocalIcon == null) {
            ...
            i10 = a.f6564c[idLocalIcon.ordinal()];
        }
        if (i10 != -1) {
            if (i10 != 1) {
                if (i10 != 2) {
