...
public final class d extends CoordinatorLayout implements ReactPointerEventsView {
    ...
    public d(Context context, r0 fragment, ReactPointerEventsView pointerEventsImpl) {
        super(context);
    ...
    @NotNull
    public final r0 getFragment$react_native_screens_release() {
        return this.J;
    }
    ...
    public d(Context context, r0 fragment) {
        this(context, fragment, new com.swmansion.rnscreens.q());
        Intrinsics.checkNotNullParameter(context, "context");
        Intrinsics.checkNotNullParameter(fragment, "fragment");
    }
}
