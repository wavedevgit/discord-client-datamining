...
public abstract class t {
    ...
    private static final List f5918a = CollectionsKt.o("com.noshufou.android.su", "com.noshufou.android.su.elite", "eu.chainfire.supersu", "com.koushikdutta.superuser", "com.thirdparty.superuser", "com.yellowes.su", "com.topjohnwu.magisk", "com.kingroot.kinguser", "com.kingo.root", "com.smedialink.oneclickroot", "com.zhiqupk.root.global", "com.alephzain.framaroot");

    /* renamed from: b  reason: collision with root package name */
    private static final List f5919b = CollectionsKt.o("com.koushikdutta.rommanager", "com.koushikdutta.rommanager.license", "com.dimonvideo.luckypatcher", "com.chelpus.lackypatch", "com.ramdroid.appquarantine", "com.ramdroid.appquarantinepro", "com.android.vending.billing.InAppBillingService.COIN", "com.android.vending.billing.InAppBillingService.LUCK", "com.chelpus.luckypatcher", "com.blackmartalpha", "org.blackmart.market", "com.allinone.free", "com.repodroid.app", "org.creeplays.hack", "com.baseappfull.fwd", "com.zmapp", "com.dv.marketmod.installer", "org.mobilism.android", "com.android.wp.net.log", "com.android.camera.update", "cc.madkite.freedom", "com.solohsu.android.edxp.manager", "org.meowcat.edxposed.manager", "com.xmodgame", "com.cih.game_cih", "com.charles.lpoqasert", "catch_.me_.if_.you_.can_");

    /* renamed from: c  reason: collision with root package name */
    private static final List f5920c = CollectionsKt.o("com.devadvance.rootcloak", "com.devadvance.rootcloakplus", "de.robv.android.xposed.installer", "com.saurik.substrate", "com.zachspong.temprootremovejb", "com.amphoras.hidemyroot", "com.amphoras.hidemyrootadfree", "com.formyhm.hiderootPremium", "com.formyhm.hideroot");

    /* renamed from: d  reason: collision with root package name */
    private static final List f5921d = CollectionsKt.o("/data/local/", "/data/local/bin/", "/data/local/xbin/", "/sbin/", "/su/bin/", "/system/bin/", "/system/bin/.ext/", "/system/bin/failsafe/", "/system/sd/xbin/", "/system/usr/we-need-root/", "/system/xbin/", "/cache/", "/data/", "/dev/");

    /* renamed from: e  reason: collision with root package name */
    private static final List f5922e = CollectionsKt.o("/system", "/system/bin", "/system/sbin", "/system/xbin", "/vendor/bin", "/sbin", "/etc");

    /* renamed from: f  reason: collision with root package name */
    private static Boolean f5923f;

    private static final boolean a(Context context) {
        return i(context, f5919b);
    }

    private static final boolean b(Context context) {
        return i(context, f5918a);
    }

    private static final boolean c(String str) {
        for (String str2 : f5921d) {
    ...
    */
    public static final boolean j(android.content.Context r2) {
        /*
            ...
            java.lang.Boolean r0 = ao.t.f5923f
            if (r0 == 0) goto Le
        ...
        Le:
            ...
            if (r2 == 0) goto L43
            boolean r2 = ao.h.a()     // Catch: java.lang.Exception -> L4a
            if (r2 == 0) goto L49
        L43:
        ...
        L4a:
            ...
            return r0
        */
        throw new UnsupportedOperationException("Method not decompiled: ao.t.j(android.content.Context):boolean");
    }
