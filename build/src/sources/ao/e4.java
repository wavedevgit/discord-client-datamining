...
public final class e4 implements Parcelable {
    ...
    public e4(String countryName, String countryCode, List ids) {
        ...
        this.f5897d = countryName;
        this.f5898e = countryCode;
        this.f5899i = ids;
    }
    ...
    public boolean equals(Object obj) {
        ...
        e4 e4Var = (e4) obj;
        if (Intrinsics.areEqual(this.f5897d, e4Var.f5897d) && Intrinsics.areEqual(this.f5898e, e4Var.f5898e) && Intrinsics.areEqual(this.f5899i, e4Var.f5899i)) {
            return true;
        }
        return false;
    }
    ...
    public int hashCode() {
        return (((this.f5897d.hashCode() * 31) + this.f5898e.hashCode()) * 31) + this.f5899i.hashCode();
    }
    ...
    public final void writeToParcel(Parcel dest, int i10) {
        ...
        dest.writeString(this.f5897d);
        dest.writeString(this.f5898e);
        List<c4> list = this.f5899i;
