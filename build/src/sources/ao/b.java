...
public interface b {
    ...
    @nv.b("/api/internal/verify/v1/document-files/{fileId}")
    ...
    Object e(@i("Authorization") @NotNull String str, @s("inquiryId") @NotNull String str2, @nv.a @NotNull SubmitDocumentRequest submitDocumentRequest, @NotNull Continuation<? super z<?>> continuation);
}
