...
public final class k2 implements k5, e0 {
    ...
    private final JsonLogicBoolean f23515e;

    /* renamed from: i  reason: collision with root package name */
    private final List f23516i;
    ...
    public boolean equals(Object obj) {
        ...
        k2 k2Var = (k2) obj;
        if (Intrinsics.areEqual(this.f23514d, k2Var.f23514d) && Intrinsics.areEqual(this.f23515e, k2Var.f23515e)) {
            return true;
        }
        return false;
    }
    ...
    public int hashCode() {
        int hashCode;
        int hashCode2 = this.f23514d.hashCode() * 31;
        JsonLogicBoolean jsonLogicBoolean = this.f23515e;
    ...
    public final void writeToParcel(Parcel dest, int i10) {
        ...
        dest.writeString(this.f23514d);
        dest.writeParcelable(this.f23515e, i10);
    }
    ...
    */
    public k2(com.withpersona.sdk2.inquiry.network.dto.ui.components.LocalImage r2) {
        ...
        L15:
            ...
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: fq.k2.<init>(com.withpersona.sdk2.inquiry.network.dto.ui.components.LocalImage):void");
    }
}
