...
public final class y implements k5, l5 {
    ...
    private final List f23680e;

    /* renamed from: i  reason: collision with root package name */
    private final Integer f23681i;
    ...
    public boolean equals(Object obj) {
        ...
        y yVar = (y) obj;
        if (Intrinsics.areEqual(this.f23679d, yVar.f23679d) && Intrinsics.areEqual(this.f23680e, yVar.f23680e) && Intrinsics.areEqual(this.f23681i, yVar.f23681i)) {
            return true;
        }
        return false;
    }
    ...
    public int hashCode() {
        int hashCode;
        int hashCode2 = ((this.f23679d.hashCode() * 31) + this.f23680e.hashCode()) * 31;
        Integer num = this.f23681i;
        if (num == null) {
            hashCode = 0;
        } else {
    ...
    public String toString() {
        String str = this.f23679d;
        List list = this.f23680e;
        Integer num = this.f23681i;
    ...
    public final void writeToParcel(Parcel dest, int i10) {
        ...
        dest.writeString(this.f23679d);
        List<Parcelable> list = this.f23680e;
    ...
    */
    public y(com.withpersona.sdk2.inquiry.network.dto.ui.components.Footer r5) {
        ...
        L40:
            ...
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: fq.y.<init>(com.withpersona.sdk2.inquiry.network.dto.ui.components.Footer):void");
    }
}
