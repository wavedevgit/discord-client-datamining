...
public final class f4 implements k5, e0 {
    ...
    private final JsonLogicBoolean f23467e;
    ...
    public boolean equals(Object obj) {
        ...
        f4 f4Var = (f4) obj;
        if (Intrinsics.areEqual(this.f23466d, f4Var.f23466d) && Intrinsics.areEqual(this.f23467e, f4Var.f23467e) && this.f23468i == f4Var.f23468i) {
            return true;
        }
        return false;
    }
    ...
    public int hashCode() {
        int hashCode;
        int hashCode2 = this.f23466d.hashCode() * 31;
        JsonLogicBoolean jsonLogicBoolean = this.f23467e;
        if (jsonLogicBoolean == null) {
            hashCode = 0;
        } else {
            hashCode = jsonLogicBoolean.hashCode();
        }
        return ((hashCode2 + hashCode) * 31) + Integer.hashCode(this.f23468i);
    }
    ...
    public final void writeToParcel(Parcel dest, int i10) {
        ...
        dest.writeString(this.f23466d);
        dest.writeParcelable(this.f23467e, i10);
        dest.writeInt(this.f23468i);
    }
    ...
    */
    public f4(com.withpersona.sdk2.inquiry.network.dto.ui.components.QRCode r5) {
        ...
        L4e:
            ...
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: fq.f4.<init>(com.withpersona.sdk2.inquiry.network.dto.ui.components.QRCode):void");
    }
}
