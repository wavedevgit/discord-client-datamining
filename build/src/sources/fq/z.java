...
public abstract class z {
    public static final View a(y yVar, m5 uiComponentHelper, List componentViews, List children, Footer config) {
        ...
        iq.g c10 = iq.g.c(LayoutInflater.from(a10));
        ...
        if (padding != null) {
            ...
            if (right != null && (dp5 = right.getDp()) != null) {
                i12 = (int) rp.h.a(dp5.doubleValue());
            } else {
                i12 = 0;
            }
            ...
            if (bottom != null && (dp3 = bottom.getDp()) != null) {
                i14 = (int) rp.h.a(dp3.doubleValue());
            } else {
                i14 = 0;
            }
        ...
        if (borderWidth != null) {
            ...
            if (layoutParams != null) {
                ...
                if (top2 != null && (dp2 = top2.getDp()) != null) {
                    i10 = (int) rp.h.a(dp2.doubleValue());
                } else {
                    i10 = 0;
                }
            ...
            if (layoutParams2 != null) {
                layoutParams2.height = (int) rp.h.a(1.0d);
