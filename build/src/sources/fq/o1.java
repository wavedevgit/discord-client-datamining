...
public abstract class o1 {
    public static final void d(final TextInputLayout textInputLayout, y3 newState) {
        ...
        Object tag = textInputLayout.getTag(dq.e.f21027b0);
        ...
        textInputLayout.setTag(dq.e.f21027b0, newState);
        ...
        if (c10 != null) {
            ...
            bq.o.a(textInputLayout);
        }
        if (Intrinsics.areEqual(newState.e(), Boolean.TRUE) && (b10 = newState.b()) != null) {
            textInputLayout.setEndIconMode(-1);
            textInputLayout.setEndIconDrawable(androidx.core.content.a.e(textInputLayout.getContext(), dq.d.f21022d));
            textInputLayout.setEndIconContentDescription(textInputLayout.getContext().getString(jp.e.R));
            EditText editText3 = textInputLayout.getEditText();
            if (editText3 != null) {
                editText3.setTransformationMethod(new s4(b10));
            }
            textInputLayout.setEndIconOnClickListener(new View.OnClickListener() { // from class: fq.n1
        ...
        Object tag2 = textInputLayout.getTag(dq.e.f21041i0);
        ...
        if (b11 != null && !StringsKt.k0(b11)) {
            ...
            textInputLayout.setTag(dq.e.f21041i0, z3Var);
        }
    }
    ...
    public static final TextInputLayout g(InputMaskedTextComponent inputMaskedTextComponent, m5 uiComponentHelper, final InputMaskedText config) {
        ...
        final iq.u c10 = iq.u.c(uiComponentHelper.b());
        ...
        if (editText != null) {
            dn.u.b(inputMaskedTextComponent.b(), editText);
        }
        uiComponentHelper.d(new Function0() { // from class: fq.m1
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public static final Unit h(InputMaskedText inputMaskedText, iq.u uVar) {
