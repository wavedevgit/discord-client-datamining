...
public abstract class q {
    ...
    public static final com.withpersona.sdk2.inquiry.steps.ui.components.a b(com.withpersona.sdk2.inquiry.steps.ui.components.a aVar, k5 old, k5 k5Var) {
        ...
        dq.g g10 = aVar.g();
        List components = aVar.g().getComponents();
        if (components != null) {
            list = com.withpersona.sdk2.inquiry.steps.ui.components.f.m(components, old, k5Var);
        } else {
            list = null;
        }
        return com.withpersona.sdk2.inquiry.steps.ui.components.a.b(aVar, null, null, null, false, false, false, false, dq.g.c(g10, list, null, null, 6, null), 127, null);
    }
}
