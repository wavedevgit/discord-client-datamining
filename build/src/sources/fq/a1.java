...
public abstract class a1 {
    ...
    public static final class a implements Function1 {
        ...
        public static final a f23406d = new a();
    ...
    public static final ConstraintLayout f(InputConfirmationCodeComponent inputConfirmationCodeComponent, m5 uiComponentHelper, final InputConfirmationCode config) {
        ...
        for (IndexedValue indexedValue : CollectionsKt.n1(o10)) {
            ...
            if (editText != null) {
                ...
                rp.a0.b(editText, new Function1() { // from class: fq.v0
                    @Override // kotlin.jvm.functions.Function1
            ...
            if (editText2 != null) {
                l(editText, new Function0() { // from class: fq.w0
        ...
        uiComponentHelper.d(new Function0() { // from class: fq.x0
            @Override // kotlin.jvm.functions.Function0
            public final Object invoke() {
                Unit i10;
                i10 = a1.i(iq.c.this, config);
                return i10;
            }
        });
    ...
    public static final Unit g(InputConfirmationCodeComponent inputConfirmationCodeComponent, iq.c cVar, List list, EditText editText, EditText editText2, EditText editText3, String newText) {
        Context context;
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public static final Unit i(iq.c cVar, InputConfirmationCode inputConfirmationCode) {
        ConstraintLayout root = cVar.getRoot();
        Intrinsics.checkNotNullExpressionValue(root, "getRoot(...)");
        Sequence<TextInputLayout> F = kotlin.sequences.k.F(androidx.core.view.n0.a(root), a.f23406d);
    ...
    private static final void l(final EditText editText, final Function0 function0) {
        if (editText != null) {
            editText.setOnKeyListener(new View.OnKeyListener() { // from class: fq.z0
    ...
    private static final void n(final EditText editText) {
        if (editText != null) {
            editText.setOnFocusChangeListener(new View.OnFocusChangeListener() { // from class: fq.y0
