...
public abstract class i2 {
    ...
    public /* synthetic */ class a {
        ...
        /* renamed from: b */
        public static final /* synthetic */ int[] f23496b;
    ...
    public static final TextInputLayout b(InputTextComponent inputTextComponent, m5 uiComponentHelper, final InputText config, dn.t textController) {
        String str;
    ...
    public static /* synthetic */ TextInputLayout c(InputTextComponent inputTextComponent, m5 m5Var, InputText inputText, dn.t tVar, int i10, Object obj) {
        if ((i10 & 4) != 0) {
    ...
    private static final int e(InputText.InputType inputType) {
        int i10 = a.f23495a[inputType.ordinal()];
        if (i10 == 1) {
            return 1;
        }
        if (i10 != 2) {
    ...
    private static final String f(InputText.AutofillHint autofillHint) {
        switch (a.f23496b[autofillHint.ordinal()]) {
            case 1:
                return "personName";
            case 2:
