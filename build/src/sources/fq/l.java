...
public abstract class l {
    public static final ConstraintLayout b(ClickableStackComponent clickableStackComponent, m5 uiComponentHelper, List componentViews, List children, ClickableStack config) {
        ...
        final iq.e c10 = iq.e.c(uiComponentHelper.b());
        ...
        if (styles != null) {
            uiComponentHelper.d(new Function0() { // from class: fq.k
                @Override // kotlin.jvm.functions.Function0
                public final Object invoke() {
                    Unit c11;
                    c11 = l.c(iq.e.this, styles);
                    return c11;
                }
            });
        }
    ...
    public static final Unit c(iq.e eVar, ClickableStack.ClickableStackComponentStyle clickableStackComponentStyle) {
