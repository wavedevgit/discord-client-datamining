...
public abstract class c {
    ...
    public static final Set f49933a;

    /* renamed from: b  reason: collision with root package name */
    public static final Type[] f49934b;

    /* renamed from: c  reason: collision with root package name */
    public static final Class f49935c;

    /* renamed from: d  reason: collision with root package name */
    private static final Class f49936d;

    /* renamed from: e  reason: collision with root package name */
    private static final Map f49937e;

    /* loaded from: /home/runner/work/discord-client-datamining/discord-client-datamining/build/classes4.dex */
    public static final class a implements GenericArrayType {

        /* renamed from: d  reason: collision with root package name */
        private final Type f49938d;

        public a(Type type) {
            this.f49938d = c.a(type);
        }
        ...
        public int hashCode() {
            return this.f49938d.hashCode();
        }

        public String toString() {
            return c.v(this.f49938d) + "[]";
        }
    }
    ...
    public static final class b implements ParameterizedType {
        ...
        /* renamed from: d  reason: collision with root package name */
        private final Type f49939d;

        /* renamed from: e  reason: collision with root package name */
        private final Type f49940e;

        /* renamed from: i  reason: collision with root package name */
        public final Type[] f49941i;
        ...
        public b(Type type, Type type2, Type... typeArr) {
            ...
            this.f49939d = a10;
            this.f49940e = c.a(type2);
            this.f49941i = (Type[]) typeArr.clone();
            int i10 = 0;
            while (true) {
                Type[] typeArr2 = this.f49941i;
                if (i10 < typeArr2.length) {
                    typeArr2[i10].getClass();
                    c.b(this.f49941i[i10]);
                    Type[] typeArr3 = this.f49941i;
        ...
        public Type[] getActualTypeArguments() {
            return (Type[]) this.f49941i.clone();
        }
        ...
        public int hashCode() {
            return (Arrays.hashCode(this.f49941i) ^ this.f49940e.hashCode()) ^ c.g(this.f49939d);
        }

        public String toString() {
            StringBuilder sb2 = new StringBuilder((this.f49941i.length + 1) * 30);
            sb2.append(c.v(this.f49940e));
            if (this.f49941i.length == 0) {
                return sb2.toString();
            }
            sb2.append("<");
            sb2.append(c.v(this.f49941i[0]));
            for (int i10 = 1; i10 < this.f49941i.length; i10++) {
                sb2.append(", ");
                sb2.append(c.v(this.f49941i[i10]));
            }
            sb2.append(">");
            return sb2.toString();
        }
    ...
    /* loaded from: /home/runner/work/discord-client-datamining/discord-client-datamining/build/classes4.dex */
    public static final class C0652c implements WildcardType {

        /* renamed from: d  reason: collision with root package name */
        private final Type f49942d;

        /* renamed from: e  reason: collision with root package name */
        private final Type f49943e;

        public C0652c(Type[] typeArr, Type[] typeArr2) {
                ...
                if (typeArr.length == 1) {
                    if (typeArr2.length == 1) {
                        ...
                        if (typeArr[0] == Object.class) {
                            this.f49943e = c.a(typeArr2[0]);
                            this.f49942d = Object.class;
                            return;
                        }
        ...
        public Type[] getLowerBounds() {
            Type type = this.f49943e;
            return type != null ? new Type[]{type} : c.f49934b;
        }

        @Override // java.lang.reflect.WildcardType
        public Type[] getUpperBounds() {
            return new Type[]{this.f49942d};
        }
        ...
        public int hashCode() {
            ...
            return i10 ^ (this.f49942d.hashCode() + 31);
        }

        public String toString() {
            if (this.f49943e != null) {
                return "? super " + c.v(this.f49943e);
            } else if (this.f49942d == Object.class) {
                return "?";
            } else {
                return "? extends " + c.v(this.f49942d);
            }
        }
    }
    ...
    static {
        ...
        L18:
            ...
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: tm.c.<clinit>():void");
    }
    ...
    public static Type a(Type type) {
        if (type instanceof Class) {
            ...
            if (type instanceof C0652c) {
                return type;
            }
            WildcardType wildcardType = (WildcardType) type;
            return new C0652c(wildcardType.getUpperBounds(), wildcardType.getLowerBounds());
        } else {
            return type;
        }
    }
    ...
    public static boolean i(Class cls) {
        Class<? extends Annotation> cls2 = f49936d;
    ...
    */
    private static java.lang.reflect.Type r(java.lang.reflect.Type r8, java.lang.Class r9, java.lang.reflect.Type r10, java.util.Collection r11) {
        ...
        Lbf:
            return r10
        */
        throw new UnsupportedOperationException("Method not decompiled: tm.c.r(java.lang.reflect.Type, java.lang.Class, java.lang.reflect.Type, java.util.Collection):java.lang.reflect.Type");
    }
