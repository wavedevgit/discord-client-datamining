...
public final class h extends gd.e {
    ...
    public static final a f37153b = new a() { // from class: ld.g
        @Override // ld.h.a
    ...
    */
    ...
    private static ld.a f(h0 h0Var, int i10, int i11) {
        ...
        h0Var.l(bArr, 0, i12);
        if (i11 == 2) {
            str = "image/" + ii.b.e(new String(bArr, 0, 3, ii.d.f28536b));
            ...
            z10 = z(bArr, 0);
            String e10 = ii.b.e(new String(bArr, 0, z10, ii.d.f28536b));
            if (e10.indexOf(47) == -1) {
                str = "image/" + e10;
            } else {
                str = e10;
    ...
    private static c h(h0 h0Var, int i10, int i11, boolean z10, int i12, a aVar) {
        ...
        String str = new String(h0Var.e(), f10, z11 - f10, ii.d.f28536b);
        h0Var.U(z11 + 1);
        int q10 = h0Var.q();
        int q11 = h0Var.q();
        long J = h0Var.J();
    ...
    private static d i(h0 h0Var, int i10, int i11, boolean z10, int i12, a aVar) {
        ...
        String str = new String(h0Var.e(), f10, z13 - f10, ii.d.f28536b);
        h0Var.U(z13 + 1);
        int H = h0Var.H();
        if ((H & 2) != 0) {
            z11 = true;
        ...
        for (int i13 = 0; i13 < H2; i13++) {
            ...
            strArr[i13] = new String(h0Var.e(), f11, z14 - f11, ii.d.f28536b);
            h0Var.U(z14 + 1);
        }
        ArrayList arrayList = new ArrayList();
        int i14 = f10 + i10;
    ...
    */
    ...
    private static f l(h0 h0Var, int i10) {
        ...
        h0Var.l(bArr, 0, i11);
        int z10 = z(bArr, 0);
        String str = new String(bArr, 0, z10, ii.d.f28536b);
        int i12 = z10 + 1;
    ...
    private static l o(h0 h0Var, int i10) {
        ...
        h0Var.l(bArr, 0, i10);
        int z10 = z(bArr, 0);
        return new l(new String(bArr, 0, z10, ii.d.f28536b), d(bArr, z10 + 1, i10));
    }
    ...
    private static n t(h0 h0Var, int i10, String str) {
        byte[] bArr = new byte[i10];
        h0Var.l(bArr, 0, i10);
        return new n(str, null, new String(bArr, 0, z(bArr, 0), ii.d.f28536b));
    }
    ...
    private static n u(h0 h0Var, int i10) {
        ...
        int v10 = y10 + v(H);
        return new n("WXXX", str, p(bArr, v10, z(bArr, v10), ii.d.f28536b));
    }
    ...
    public Metadata e(byte[] bArr, int i10) {
        ...
        int i12 = m10.f37157c;
        if (m10.f37156b) {
            i12 = A(h0Var, m10.f37157c);
        }
        h0Var.T(f10 + i12);
        boolean z10 = false;
        if (!B(h0Var, m10.f37155a, i11, false)) {
            if (m10.f37155a == 4 && B(h0Var, 4, i11, true)) {
                z10 = true;
            } else {
                y.i("Id3Decoder", "Failed to validate ID3 tag with majorVersion=" + m10.f37155a);
                return null;
            }
        }
        while (h0Var.a() >= i11) {
            i k10 = k(m10.f37155a, h0Var, z10, i11, this.f37154a);
            if (k10 != null) {
                arrayList.add(k10);
            }
        }
