...
public final class a implements Closeable, Parcelable {
    ...
    public boolean equals(Object obj) {
        ...
        if ((obj instanceof a) && Intrinsics.areEqual(this.f43375d, ((a) obj).f43375d)) {
            return true;
        }
        return false;
    }
    ...
    public int hashCode() {
        return this.f43375d.hashCode();
    }

    public String toString() {
        List list = this.f43375d;
    ...
    public final void writeToParcel(Parcel dest, int i10) {
        ...
        List<Parcelable> list = this.f43375d;
