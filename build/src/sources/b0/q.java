...
public abstract class q {
    ...
    public static final RectF f6405a = new RectF(-1.0f, -1.0f, 1.0f, 1.0f);
    ...
    public static Matrix c(RectF rectF) {
        ...
        matrix.setRectToRect(f6405a, rectF, Matrix.ScaleToFit.FILL);
        return matrix;
    }
    ...
    public static Matrix e(RectF rectF, RectF rectF2, int i10, boolean z10) {
        Matrix matrix = new Matrix();
        matrix.setRectToRect(rectF, f6405a, Matrix.ScaleToFit.FILL);
