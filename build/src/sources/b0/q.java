...
public abstract class q {
    ...
    public static final RectF f6083a = new RectF(-1.0f, -1.0f, 1.0f, 1.0f);
    ...
    public static Matrix c(RectF rectF) {
        ...
        matrix.setRectToRect(f6083a, rectF, Matrix.ScaleToFit.FILL);
        return matrix;
    }
    ...
    public static Matrix e(RectF rectF, RectF rectF2, int i10, boolean z10) {
        Matrix matrix = new Matrix();
        matrix.setRectToRect(rectF, f6083a, Matrix.ScaleToFit.FILL);
