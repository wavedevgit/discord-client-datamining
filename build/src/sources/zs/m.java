...
public abstract class m {
    ...
    private static final Lazy f56679a = rr.l.a(c.f56684d);

    /* renamed from: b  reason: collision with root package name */
    private static final Lazy f56680b = rr.l.a(b.f56683d);

    /* renamed from: c  reason: collision with root package name */
    private static final Lazy f56681c = rr.l.a(a.f56682d);

    /* loaded from: /home/runner/work/discord-client-datamining/discord-client-datamining/build/classes5.dex */
    static final class a extends Lambda implements Function0 {

        /* renamed from: d  reason: collision with root package name */
        public static final a f56682d = new a();
    ...
    static final class c extends Lambda implements Function0 {
        ...
        /* renamed from: d  reason: collision with root package name */
        public static final c f56684d = new c();
    ...
    public static final DateTimeFormatter f() {
        return (DateTimeFormatter) f56681c.getValue();
    }

    /* JADX INFO: Access modifiers changed from: private */
    public static final DateTimeFormatter g() {
        return (DateTimeFormatter) f56680b.getValue();
    }

    /* JADX INFO: Access modifiers changed from: private */
    public static final DateTimeFormatter h() {
        return (DateTimeFormatter) f56679a.getValue();
    }

    /* JADX INFO: Access modifiers changed from: private */
    public static final k i(CharSequence charSequence, DateTimeFormatter dateTimeFormatter) {
        try {
            return new k((ZoneOffset) dateTimeFormatter.parse(charSequence, new TemporalQuery() { // from class: zs.l
