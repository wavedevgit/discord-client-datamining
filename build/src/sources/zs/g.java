...
public abstract class g {
    ...
    private static final long f56670a = LocalDate.MIN.toEpochDay();

    /* renamed from: b  reason: collision with root package name */
    private static final long f56671b = LocalDate.MAX.toEpochDay();

    private static final LocalDate a(long j10) {
        long j11 = f56670a;
        if (j10 <= f56671b && j11 <= j10) {
    ...
    public static final f c(f fVar, long j10, c.b unit) {
        ...
        Intrinsics.checkNotNullParameter(unit, "unit");
        try {
            if (unit instanceof c.C0807c) {
                plusMonths = a(bt.b.a(fVar.h().toEpochDay(), bt.b.c(j10, ((c.C0807c) unit).d())));
            } else if (unit instanceof c.d) {
                plusMonths = fVar.h().plusMonths(bt.b.c(j10, ((c.d) unit).d()));
            } else {
                throw new p();
            }
