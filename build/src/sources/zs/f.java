...
public final class f extends g implements k {
    ...
    private final Handler f57121i;

    /* renamed from: o  reason: collision with root package name */
    private final String f57122o;

    /* renamed from: p  reason: collision with root package name */
    private final boolean f57123p;

    /* renamed from: q  reason: collision with root package name */
    private final f f57124q;

    private f(Handler handler, String str, boolean z10) {
        super(null);
        this.f57121i = handler;
        this.f57122o = str;
        this.f57123p = z10;
        this.f57124q = z10 ? this : new f(handler, str, true);
    }
    ...
    public n0 C0(long j10, final Runnable runnable, CoroutineContext coroutineContext) {
        if (this.f57121i.postDelayed(runnable, kotlin.ranges.d.j(j10, 4611686018427387903L))) {
    ...
    public boolean equals(Object obj) {
        if (obj instanceof f) {
            f fVar = (f) obj;
            if (fVar.f57121i == this.f57121i && fVar.f57123p == this.f57123p) {
                return true;
            }
            return false;
        }
    ...
    public int hashCode() {
        int i10;
        int identityHashCode = System.identityHashCode(this.f57121i);
        if (this.f57123p) {
            i10 = 1231;
        } else {
            i10 = 1237;
    ...
    public boolean x1(CoroutineContext coroutineContext) {
        if (this.f57123p && Intrinsics.areEqual(Looper.myLooper(), this.f57121i.getLooper())) {
            return false;
        }
        return true;
    }
