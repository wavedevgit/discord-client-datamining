...
public final class s0 implements Parcelable {
    ...
    public s0(Map poseConfigs) {
        ...
        this.f53906d = poseConfigs;
    }

    public final r0 a(a1.b pose) {
        Intrinsics.checkNotNullParameter(pose, "pose");
        r0 r0Var = (r0) this.f53906d.get(pose);
        if (r0Var == null) {
            return r0.f53886p.a();
        }
        return r0Var;
    ...
    public boolean equals(Object obj) {
        ...
        if ((obj instanceof s0) && Intrinsics.areEqual(this.f53906d, ((s0) obj).f53906d)) {
            return true;
        }
        return false;
    }
    ...
    public int hashCode() {
        return this.f53906d.hashCode();
    }

    public String toString() {
        Map map = this.f53906d;
