...
public final class g implements Parcelable {
    ...
    private final List f52954d;

    /* renamed from: e  reason: collision with root package name */
    private final List f52955e;

    /* renamed from: i  reason: collision with root package name */
    private final StepStyles.UiStepStyle f52956i;
    ...
    public g(List list, List componentConfigs, StepStyles.UiStepStyle uiStepStyle) {
        ...
        this.f52954d = list;
        this.f52955e = componentConfigs;
        this.f52956i = uiStepStyle;
    }
    ...
    public final Drawable a(Context context) {
        ...
        StepStyles.UiStepStyle uiStepStyle = this.f52956i;
        if (uiStepStyle != null) {
    ...
    public boolean equals(Object obj) {
        ...
        g gVar = (g) obj;
        if (Intrinsics.areEqual(this.f52954d, gVar.f52954d) && Intrinsics.areEqual(this.f52955e, gVar.f52955e) && Intrinsics.areEqual(this.f52956i, gVar.f52956i)) {
            return true;
        }
        return false;
    }
    ...
    public int hashCode() {
        ...
        int hashCode2 = ((hashCode * 31) + this.f52955e.hashCode()) * 31;
        StepStyles.UiStepStyle uiStepStyle = this.f52956i;
        if (uiStepStyle != null) {
    ...
    public final void writeToParcel(Parcel dest, int i10) {
        ...
        List<Parcelable> list = this.f52954d;
        if (list == null) {
            dest.writeInt(0);
        } else {
            dest.writeInt(1);
        ...
        List<Parcelable> list2 = this.f52955e;
        dest.writeInt(list2.size());
        for (Parcelable parcelable2 : list2) {
            dest.writeParcelable(parcelable2, i10);
        }
        dest.writeParcelable(this.f52956i, i10);
    }
}
