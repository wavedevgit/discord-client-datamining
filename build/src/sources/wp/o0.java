...
public final class o0 implements gn.c0 {
    ...
    private final /* synthetic */ gn.f f53259a;

    /* renamed from: b  reason: collision with root package name */
    private final fo.t f53260b;

    /* renamed from: c  reason: collision with root package name */
    private final fo.w0 f53261c;
    ...
    public static final class b implements fo.y {
        ...
        /* renamed from: a  reason: collision with root package name */
        final /* synthetic */ xp.a f53262a;

        /* renamed from: b  reason: collision with root package name */
        final /* synthetic */ fo.t f53263b;

        /* renamed from: c  reason: collision with root package name */
        final /* synthetic */ fo.w0 f53264c;

        /* renamed from: d  reason: collision with root package name */
        final /* synthetic */ x5.d.c f53265d;
        ...
        @Override // fo.y
        public void a() {
            PreviewView previewviewSelfieCamera = this.f53262a.f55077k;
            Intrinsics.checkNotNullExpressionValue(previewviewSelfieCamera, "previewviewSelfieCamera");
            t.a aVar = t.a.f24106d;
            fo.t tVar = this.f53263b;
            fo.w0 w0Var = this.f53264c;
            final x5.d.c cVar = this.f53265d;
    ...
    public o0(final fo.t cameraPreview, final fo.w0 selfieDirectionFeed) {
        ...
        this.f53259a = new gn.f(Reflection.getOrCreateKotlinClass(x5.d.c.class), new Function4() { // from class: wp.n0
        ...
        this.f53260b = cameraPreview;
        this.f53261c = selfieDirectionFeed;
    }
    ...
    public static final View c(fo.w0 w0Var, fo.t tVar, x5.d.c initialRendering, gn.a0 initialViewEnvironment, Context context, ViewGroup viewGroup) {
        ...
        if (initialRendering.n() != lo.a.f35950i) {
            Context applicationContext = context.getApplicationContext();
            Intrinsics.checkNotNullExpressionValue(applicationContext, "getApplicationContext(...)");
            ho.m b10 = ho.j.b(applicationContext, ho.n.f27613d);
            if (b10 == null) {
                initialRendering.h().invoke(new fo.s0());
                Camera2PreviewView camera2Preview = c10.f55069c;
                ...
                Camera2PreviewView camera2Preview2 = c10.f55069c;
            ...
            PreviewView previewviewSelfieCamera = c10.f55077k;
            Intrinsics.checkNotNullExpressionValue(previewviewSelfieCamera, "previewviewSelfieCamera");
    ...
    public View a(x5.d.c initialRendering, gn.a0 initialViewEnvironment, Context contextForNewView, ViewGroup viewGroup) {
        ...
        return this.f53259a.a(initialRendering, initialViewEnvironment, contextForNewView, viewGroup);
    }

    @Override // gn.c0
    public KClass getType() {
        return this.f53259a.getType();
    }
}
