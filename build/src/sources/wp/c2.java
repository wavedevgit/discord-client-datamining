...
public final class c2 implements gn.k {
    ...
    private final xp.h f53600b;

    /* renamed from: c  reason: collision with root package name */
    private View f53601c;

    /* loaded from: /home/runner/work/discord-client-datamining/discord-client-datamining/build/classes4.dex */
    public static final class a implements gn.c0 {

        /* renamed from: a  reason: collision with root package name */
        private final /* synthetic */ gn.c0 f53602a;
        ...
        /* synthetic */ class C0741a extends FunctionReferenceImpl implements Function3 {
            ...
            /* renamed from: d  reason: collision with root package name */
            public static final C0741a f53603d = new C0741a();
        ...
        public View a(x5.d.f initialRendering, gn.a0 initialViewEnvironment, Context contextForNewView, ViewGroup viewGroup) {
            ...
            return this.f53602a.a(initialRendering, initialViewEnvironment, contextForNewView, viewGroup);
        }

        @Override // gn.c0
        public KClass getType() {
            return this.f53602a.getType();
        }

        private a() {
            k.a aVar = gn.k.f25849a;
            this.f53602a = new gn.z(Reflection.getOrCreateKotlinClass(x5.d.f.class), C0741a.f53603d, b.f53604d);
        }
    }
    ...
    public c2(final xp.h binding) {
        ...
        this.f53600b = binding;
        Context context = binding.getRoot().getContext();
        Intrinsics.checkNotNullExpressionValue(context, "getContext(...)");
        Integer f10 = bq.s.f(context, tp.a.f50334n, null, false, 6, null);
        if (f10 != null) {
            binding.f55713f.setAnimation(f10.intValue());
            binding.f55713f.u();
        } else {
            binding.f55713f.l(new r5.e("scanner", "**"), l5.b0.f36114a, new z5.e() { // from class: wp.z1
                @Override // z5.e
    ...
    private final void e(StepStyles.SelfieStepStyle selfieStepStyle, gn.a0 a0Var, PendingPageTextPosition pendingPageTextPosition) {
        ...
        int[] iArr = pendingPageTextPosition == PendingPageTextPosition.TOP ? new int[]{this.f53600b.f55714g.getId(), this.f53600b.f55710c.getId(), this.f53600b.f55709b.getId()} : new int[]{this.f53600b.f55709b.getId(), this.f53600b.f55714g.getId(), this.f53600b.f55710c.getId()};
        ConstraintSet constraintSet = new ConstraintSet();
        constraintSet.f(this.f53600b.f55711d);
        int i10 = b.f53605a[pendingPageAlignmentValue.ordinal()];
        if (i10 != 1) {
            if (i10 != 2) {
                if (i10 == 3) {
                    f10 = 1.0f;
        ...
        if (processingTextStyleValue != null) {
            TextView body = this.f53600b.f55710c;
        ...
        if (fillColorValue != null) {
            ...
            this.f53600b.f55713f.I(Color.parseColor("#AA85FF"), intValue2);
            this.f53600b.f55713f.I(Color.parseColor("#4600EB"), intValue2);
        }
        Integer strokeColorValue = selfieStepStyle.getStrokeColorValue();
        if (strokeColorValue != null) {
            this.f53600b.f55713f.I(Color.parseColor("#190052"), strokeColorValue.intValue());
        }
        Integer backgroundColorValue2 = selfieStepStyle.getBackgroundColorValue();
        if (backgroundColorValue2 != null) {
            int intValue3 = backgroundColorValue2.intValue();
            this.f53600b.f55713f.I(Color.parseColor("#FFFFFF"), intValue3);
            this.f53600b.f55713f.I(Color.parseColor("#F1EBFF"), intValue3);
        }
    }
    ...
    public void a(final x5.d.f rendering, gn.a0 viewEnvironment) {
        ...
        Pi2NavigationBar navigationBar = hVar.f55712e;
        Intrinsics.checkNotNullExpressionValue(navigationBar, "navigationBar");
        ConstraintLayout root = hVar.getRoot();
        Intrinsics.checkNotNullExpressionValue(root, "getRoot(...)");
        jq.e.b(c10, function0, function02, navigationBar, root);
        if (rendering.h().length() == 0) {
            hVar.f55714g.setVisibility(8);
        } else {
            hVar.f55714g.setText(rendering.h());
            TextView title = hVar.f55714g;
            Intrinsics.checkNotNullExpressionValue(title, "title");
            lq.s.e(title);
        }
        if (rendering.b().length() == 0) {
            hVar.f55710c.setVisibility(8);
        } else {
            hVar.f55710c.setText(rendering.b());
        }
        RemoteImage a10 = rendering.a();
        if (a10 != null && this.f53601c == null) {
            ConstraintLayout animationContainer = hVar.f55709b;
            Intrinsics.checkNotNullExpressionValue(animationContainer, "animationContainer");
            this.f53601c = wq.b.c(a10, animationContainer, false, 2, null);
            hVar.f55713f.setVisibility(8);
        }
