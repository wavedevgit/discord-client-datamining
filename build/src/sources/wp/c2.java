...
public final class c2 implements gn.k {
    ...
    private final xp.h f53031b;

    /* renamed from: c  reason: collision with root package name */
    private View f53032c;

    /* loaded from: /home/runner/work/discord-client-datamining/discord-client-datamining/build/classes4.dex */
    public static final class a implements gn.c0 {

        /* renamed from: a  reason: collision with root package name */
        private final /* synthetic */ gn.c0 f53033a;
        ...
        /* synthetic */ class C0741a extends FunctionReferenceImpl implements Function3 {
            ...
            /* renamed from: d  reason: collision with root package name */
            public static final C0741a f53034d = new C0741a();
        ...
        public View a(x5.d.f initialRendering, gn.a0 initialViewEnvironment, Context contextForNewView, ViewGroup viewGroup) {
            ...
            return this.f53033a.a(initialRendering, initialViewEnvironment, contextForNewView, viewGroup);
        }

        @Override // gn.c0
        public KClass getType() {
            return this.f53033a.getType();
        }

        private a() {
            k.a aVar = gn.k.f25848a;
            this.f53033a = new gn.z(Reflection.getOrCreateKotlinClass(x5.d.f.class), C0741a.f53034d, b.f53035d);
        }
    }
    ...
    public c2(final xp.h binding) {
        ...
        this.f53031b = binding;
        Context context = binding.getRoot().getContext();
        Intrinsics.checkNotNullExpressionValue(context, "getContext(...)");
        Integer f10 = bq.s.f(context, tp.a.f49765n, null, false, 6, null);
        if (f10 != null) {
            binding.f55144f.setAnimation(f10.intValue());
            binding.f55144f.u();
        } else {
            binding.f55144f.l(new r5.e("scanner", "**"), l5.b0.f35545a, new z5.e() { // from class: wp.z1
                @Override // z5.e
    ...
    public static Integer d(xp.h hVar, z5.b bVar) {
        ...
        Intrinsics.checkNotNullExpressionValue(context, "getContext(...)");
        return Integer.valueOf(bq.s.d(context, f.a.f23298w, null, false, 6, null));
    }
    ...
    private final void e(StepStyles.SelfieStepStyle selfieStepStyle, gn.a0 a0Var, PendingPageTextPosition pendingPageTextPosition) {
        ...
        int[] iArr = pendingPageTextPosition == PendingPageTextPosition.TOP ? new int[]{this.f53031b.f55145g.getId(), this.f53031b.f55141c.getId(), this.f53031b.f55140b.getId()} : new int[]{this.f53031b.f55140b.getId(), this.f53031b.f55145g.getId(), this.f53031b.f55141c.getId()};
        ConstraintSet constraintSet = new ConstraintSet();
        constraintSet.f(this.f53031b.f55142d);
        int i10 = b.f53036a[pendingPageAlignmentValue.ordinal()];
        if (i10 != 1) {
            if (i10 != 2) {
                if (i10 == 3) {
                    f10 = 1.0f;
        ...
        if (processingTextStyleValue != null) {
            TextView body = this.f53031b.f55141c;
        ...
        if (fillColorValue != null) {
            ...
            this.f53031b.f55144f.I(Color.parseColor("#AA85FF"), intValue2);
            this.f53031b.f55144f.I(Color.parseColor("#4600EB"), intValue2);
        }
        Integer strokeColorValue = selfieStepStyle.getStrokeColorValue();
        if (strokeColorValue != null) {
            this.f53031b.f55144f.I(Color.parseColor("#190052"), strokeColorValue.intValue());
        }
        Integer backgroundColorValue2 = selfieStepStyle.getBackgroundColorValue();
        if (backgroundColorValue2 != null) {
            int intValue3 = backgroundColorValue2.intValue();
            this.f53031b.f55144f.I(Color.parseColor("#FFFFFF"), intValue3);
            this.f53031b.f55144f.I(Color.parseColor("#F1EBFF"), intValue3);
        }
    }
    ...
    public void a(final x5.d.f rendering, gn.a0 viewEnvironment) {
        ...
        Pi2NavigationBar navigationBar = hVar.f55143e;
        Intrinsics.checkNotNullExpressionValue(navigationBar, "navigationBar");
        ConstraintLayout root = hVar.getRoot();
        Intrinsics.checkNotNullExpressionValue(root, "getRoot(...)");
        jq.e.b(c10, function0, function02, navigationBar, root);
        if (rendering.h().length() == 0) {
            hVar.f55145g.setVisibility(8);
        } else {
            hVar.f55145g.setText(rendering.h());
            TextView title = hVar.f55145g;
            Intrinsics.checkNotNullExpressionValue(title, "title");
            lq.s.e(title);
        }
        if (rendering.b().length() == 0) {
            hVar.f55141c.setVisibility(8);
        } else {
            hVar.f55141c.setText(rendering.b());
        }
        RemoteImage a10 = rendering.a();
        if (a10 != null && this.f53032c == null) {
            ConstraintLayout animationContainer = hVar.f55140b;
            Intrinsics.checkNotNullExpressionValue(animationContainer, "animationContainer");
            this.f53032c = wq.b.c(a10, animationContainer, false, 2, null);
            hVar.f55144f.setVisibility(8);
        }
