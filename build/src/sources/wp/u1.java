...
public final class u1 implements gn.k {
    ...
    public static final a f53366f = new a(null);

    /* renamed from: b  reason: collision with root package name */
    private final xp.f f53367b;

    /* renamed from: c  reason: collision with root package name */
    private final b f53368c;

    /* renamed from: d  reason: collision with root package name */
    private final LinearLayoutManager f53369d;

    /* renamed from: e  reason: collision with root package name */
    private final GridAutoFitLayoutManager f53370e;

    /* loaded from: /home/runner/work/discord-client-datamining/discord-client-datamining/build/classes4.dex */
    public static final class a implements gn.c0 {

        /* renamed from: a  reason: collision with root package name */
        private final /* synthetic */ gn.c0 f53371a;
        ...
        /* synthetic */ class C0744a extends FunctionReferenceImpl implements Function3 {
            ...
            /* renamed from: d  reason: collision with root package name */
            public static final C0744a f53372d = new C0744a();
        ...
        /* synthetic */ class b extends FunctionReferenceImpl implements Function1 {
            ...
            /* renamed from: d  reason: collision with root package name */
            public static final b f53373d = new b();
        ...
        public View a(x5.d.e initialRendering, gn.a0 initialViewEnvironment, Context contextForNewView, ViewGroup viewGroup) {
            ...
            return this.f53371a.a(initialRendering, initialViewEnvironment, contextForNewView, viewGroup);
        }

        @Override // gn.c0
        public KClass getType() {
            return this.f53371a.getType();
        }

        private a() {
            k.a aVar = gn.k.f25849a;
            this.f53371a = new gn.z(Reflection.getOrCreateKotlinClass(x5.d.e.class), C0744a.f53372d, b.f53373d);
        }
    }
    ...
    public static final class b extends RecyclerView.Adapter {
        ...
        /* renamed from: a  reason: collision with root package name */
        private x5.d.e.a f53374a;

        /* renamed from: b  reason: collision with root package name */
        private List f53375b = CollectionsKt.l();

        /* renamed from: c  reason: collision with root package name */
        private TextBasedComponentStyle f53376c;

        /* renamed from: d  reason: collision with root package name */
        private final bq.e f53377d;
        ...
        public static final class a {
            ...
            public boolean equals(Object obj) {
                ...
                a aVar = (a) obj;
                if (Intrinsics.areEqual(this.f53378a, aVar.f53378a) && Intrinsics.areEqual(this.f53379b, aVar.f53379b)) {
                    return true;
                }
                return false;
            }
            ...
            public int hashCode() {
                ...
                return (hashCode * 31) + this.f53379b.hashCode();
            }

            public String toString() {
                String str = this.f53378a;
                a1 a1Var = this.f53379b;
        ...
        /* synthetic */ class c extends FunctionReferenceImpl implements Function3 {
            ...
            /* renamed from: d  reason: collision with root package name */
            public static final c f53381d = new c();
        ...
        public b() {
            ...
            eVar.j(Reflection.getOrCreateKotlinClass(a.class), Reflection.getOrCreateKotlinClass(xp.g.class), c.f53381d, new Function3() { // from class: wp.w1
                @Override // kotlin.jvm.functions.Function3
        ...
        public static final Unit d(b bVar, a item, xp.g b10, RecyclerView.ViewHolder h10) {
            ...
            ShapeableImageView image = b10.f55138b;
            Intrinsics.checkNotNullExpressionValue(image, "image");
            v4.a.a(image.getContext()).a(new h.a(image.getContext()).d(item.b().a()).r(image).a());
            String a10 = item.a();
            if (a10 != null && !StringsKt.k0(a10)) {
                b10.f55139c.setVisibility(0);
                TextView label = b10.f55139c;
                Intrinsics.checkNotNullExpressionValue(label, "label");
                qq.f.d(label, item.a());
            } else {
                b10.f55139c.setVisibility(8);
            }
            TextBasedComponentStyle textBasedComponentStyle = bVar.f53376c;
            if (textBasedComponentStyle != null) {
                TextView label2 = b10.f55139c;
        ...
        private final void e() {
            ...
            for (a1 a1Var : this.f53375b) {
                String str = null;
                if (a1Var instanceof a1.c) {
                    int i10 = C0745b.f53380a[((a1.c) a1Var).d().ordinal()];
                    if (i10 != 1) {
                        if (i10 != 2) {
                            if (i10 == 3) {
                                x5.d.e.a aVar = this.f53374a;
                                if (aVar != null) {
                                    str = aVar.e();
                                }
                            } else {
                            ...
                            x5.d.e.a aVar2 = this.f53374a;
                            if (aVar2 != null) {
                                str = aVar2.d();
                            }
                        }
                    } else {
                        x5.d.e.a aVar3 = this.f53374a;
                        if (aVar3 != null) {
                            str = aVar3.c();
                        }
                    }
            ...
            bq.e.t(this.f53377d, arrayList, this, null, 4, null);
        }

        public final void f(TextBasedComponentStyle textStyle) {
            Intrinsics.checkNotNullParameter(textStyle, "textStyle");
            this.f53376c = textStyle;
            e();
        }

        public final void g(x5.d.e.a strings) {
            Intrinsics.checkNotNullParameter(strings, "strings");
            this.f53374a = strings;
            e();
        }

        @Override // androidx.recyclerview.widget.RecyclerView.Adapter
        public int getItemCount() {
            return this.f53377d.m();
        }

        @Override // androidx.recyclerview.widget.RecyclerView.Adapter
        public int getItemViewType(int i10) {
            return this.f53377d.o(i10);
        }

        @Override // androidx.recyclerview.widget.RecyclerView.Adapter
        public void onBindViewHolder(RecyclerView.ViewHolder holder, int i10) {
            Intrinsics.checkNotNullParameter(holder, "holder");
            this.f53377d.q(holder, i10);
        }

        @Override // androidx.recyclerview.widget.RecyclerView.Adapter
        public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int i10) {
            Intrinsics.checkNotNullParameter(parent, "parent");
            return this.f53377d.r(parent, i10);
        }
    ...
    public u1(xp.f binding) {
        ...
        b bVar = new b();
        this.f53368c = bVar;
        this.f53369d = new LinearLayoutManager(binding.getRoot().getContext());
        Context context = binding.getRoot().getContext();
        Intrinsics.checkNotNullExpressionValue(context, "getContext(...)");
        this.f53370e = new GridAutoFitLayoutManager(context, binding.getRoot().getContext().getResources().getDimensionPixelSize(u0.f53365a));
        binding.f55133e.setAdapter(bVar);
        binding.f55133e.setHasFixedSize(true);
    ...
    private final void f(StepStyles.SelfieStepStyle selfieStepStyle, gn.a0 a0Var) {
        ...
        if (titleStyleValue != null) {
            TextView textView = this.f53367b.f55135g;
            textView.setPadding(textView.getPaddingLeft(), 0, this.f53367b.f55135g.getPaddingRight(), 0);
            TextView title = this.f53367b.f55135g;
        ...
        if (textStyleValue != null) {
            TextView textView2 = this.f53367b.f55130b;
            textView2.setPadding(textView2.getPaddingLeft(), 0, this.f53367b.f55130b.getPaddingRight(), 0);
            TextView body = this.f53367b.f55130b;
            Intrinsics.checkNotNullExpressionValue(body, "body");
            uq.f0.n(body, textStyleValue, null, 2, null);
            this.f53368c.f(textStyleValue);
        }
        Integer backgroundColorValue = selfieStepStyle.getBackgroundColorValue();
        if (backgroundColorValue != null) {
            int intValue = backgroundColorValue.intValue();
            this.f53367b.getRoot().setBackgroundColor(intValue);
            kq.c.a(a0Var, intValue);
        }
        Context context = this.f53367b.getRoot().getContext();
        Intrinsics.checkNotNullExpressionValue(context, "getContext(...)");
        Drawable a10 = wq.c.a(selfieStepStyle, context);
        if (a10 != null) {
            this.f53367b.getRoot().setBackground(a10);
        }
        Integer headerButtonColorValue = selfieStepStyle.getHeaderButtonColorValue();
        if (headerButtonColorValue != null) {
            this.f53367b.f55132d.setControlsColor(headerButtonColorValue.intValue());
        }
        ButtonSubmitComponentStyle buttonPrimaryStyleValue = selfieStepStyle.getButtonPrimaryStyleValue();
        if (buttonPrimaryStyleValue != null) {
            Button usePhotosButton = this.f53367b.f55136h;
        ...
        if (buttonSecondaryStyle != null && (base = buttonSecondaryStyle.getBase()) != null && (base2 = base.getBase()) != null) {
            Button retakeButton = this.f53367b.f55134f;
        ...
        if (headerButtonColorValue2 != null) {
            this.f53367b.f55132d.setControlsColor(headerButtonColorValue2.intValue());
        }
    }
    ...
    public void a(final x5.d.e rendering, gn.a0 viewEnvironment) {
        ...
        xp.f fVar = this.f53367b;
        if (rendering.f().size() <= 1) {
            fVar.f55133e.setLayoutManager(this.f53369d);
        } else {
            fVar.f55133e.setLayoutManager(this.f53370e);
        }
        TextView title = fVar.f55135g;
        Intrinsics.checkNotNullExpressionValue(title, "title");
        qq.f.d(title, rendering.g().g());
        TextView body = fVar.f55130b;
        Intrinsics.checkNotNullExpressionValue(body, "body");
        qq.f.d(body, rendering.g().a());
        fVar.f55136h.setText(rendering.g().f());
        fVar.f55136h.setOnClickListener(new View.OnClickListener() { // from class: wp.q1
            @Override // android.view.View.OnClickListener
            public final void onClick(View view) {
                u1.h(x5.d.e.this, view);
            }
        });
        fVar.f55134f.setText(rendering.g().b());
        fVar.f55134f.setOnClickListener(new View.OnClickListener() { // from class: wp.r1
            @Override // android.view.View.OnClickListener
            public final void onClick(View view) {
        ...
        this.f53368c.g(rendering.g());
        this.f53368c.setData(rendering.f());
        ...
        Pi2NavigationBar navigationBar = this.f53367b.f55132d;
        Intrinsics.checkNotNullExpressionValue(navigationBar, "navigationBar");
        ConstraintLayout root = this.f53367b.getRoot();
        Intrinsics.checkNotNullExpressionValue(root, "getRoot(...)");
