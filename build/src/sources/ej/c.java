...
public class c {
    ...
    private static final Pattern f21597d = Pattern.compile("[0-9]+s");

    /* renamed from: e  reason: collision with root package name */
    private static final Charset f21598e = Charset.forName("UTF-8");

    /* renamed from: a  reason: collision with root package name */
    private final Context f21599a;

    /* renamed from: b  reason: collision with root package name */
    private final bj.b f21600b;

    /* renamed from: c  reason: collision with root package name */
    private final e f21601c = new e();
    ...
    private String f() {
        try {
            ...
            if (a10 == null) {
                Log.e("ContentValues", "Could not get fingerprint hash for package: " + this.f21599a.getPackageName());
                return null;
            }
            return h.a(a10, false);
        } catch (PackageManager.NameNotFoundException e10) {
            Log.e("ContentValues", "No such package: " + this.f21599a.getPackageName(), e10);
            return null;
        }
    }
    ...
    private HttpURLConnection l(URL url, String str) {
        try {
            ...
            httpURLConnection.addRequestProperty("X-Android-Package", this.f21599a.getPackageName());
            i iVar = (i) this.f21600b.get();
            if (iVar != null) {
                try {
    ...
    static long m(String str) {
        q.b(f21597d.matcher(str).matches(), "Invalid Expiration Timestamp.");
    ...
    private d n(HttpURLConnection httpURLConnection) {
        ...
        JsonReader jsonReader = new JsonReader(new InputStreamReader(inputStream, f21598e));
        f.a a10 = f.a();
        d.a a11 = d.a();
    ...
    private static String o(HttpURLConnection httpURLConnection) {
        ...
        BufferedReader bufferedReader = new BufferedReader(new InputStreamReader(errorStream, f21598e));
        try {
            try {
