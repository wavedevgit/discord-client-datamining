...
public abstract class a {
    ...
    private static final Map f24402a;

    /* renamed from: b  reason: collision with root package name */
    private static final Map f24403b;
    ...
    public static String a(int i10) {
        ...
        return ((String) map.get(valueOf)) + " (https://developer.android.com/reference/com/google/android/play/core/review/model/ReviewErrorCode.html#" + ((String) f24403b.get(valueOf)) + ")";
    }
}
