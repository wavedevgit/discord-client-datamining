...
public final class b {
    private static gk.b b(g gVar, int i10, int i11, int i12) {
        zk.b a10 = gVar.a();
        if (a10 != null) {
            int e10 = a10.e();
            int d10 = a10.d();
    ...
    public gk.b a(String str, ck.a aVar, int i10, int i11, Map map) {
        if (!str.isEmpty()) {
            if (aVar == ck.a.QR_CODE) {
                if (i10 >= 0 && i11 >= 0) {
                    f fVar = f.L;
                    int i12 = 4;
                    if (map != null) {
                        ck.f fVar2 = ck.f.ERROR_CORRECTION;
                        if (map.containsKey(fVar2)) {
                            fVar = f.valueOf(map.get(fVar2).toString());
                        }
                        ck.f fVar3 = ck.f.MARGIN;
