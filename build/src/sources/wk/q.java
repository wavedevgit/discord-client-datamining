...
public final class q extends p {
    ...
    private static final int[] f52899j = {1, 1, 1, 1, 1, 1};

    /* renamed from: k  reason: collision with root package name */
    static final int[][] f52900k = {new int[]{56, 52, 50, 49, 44, 38, 35, 42, 41, 37}, new int[]{7, 11, 13, 14, 19, 25, 28, 21, 22, 26}};

    /* renamed from: i  reason: collision with root package name */
    private final int[] f52901i = new int[4];
    ...
    @Override // wk.p
    protected int[] j(ok.a aVar, int i10) {
        return p.m(aVar, i10, true, f52899j);
    }

    /* JADX INFO: Access modifiers changed from: protected */
    @Override // wk.p
    public int k(ok.a aVar, int[] iArr, StringBuilder sb2) {
        int[] iArr2 = this.f52901i;
        iArr2[0] = 0;
        iArr2[1] = 0;
        iArr2[2] = 0;
        iArr2[3] = 0;
        ...
        for (int i12 = 0; i12 < 6 && i10 < l10; i12++) {
            int i13 = p.i(aVar, iArr2, i10, p.f52895h);
