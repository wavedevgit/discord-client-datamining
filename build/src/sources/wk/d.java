...
public final class d extends k {
    ...
    private static final char[] f52863c = "0123456789ABCDEFGHIJKLMNOPQRSTUVWXYZ-. $/+%abcd*".toCharArray();

    /* renamed from: d  reason: collision with root package name */
    static final int[] f52864d;

    /* renamed from: e  reason: collision with root package name */
    static final int f52865e;

    /* renamed from: a  reason: collision with root package name */
    private final StringBuilder f52866a = new StringBuilder(20);

    /* renamed from: b  reason: collision with root package name */
    private final int[] f52867b = new int[6];
    ...
    private static void h(CharSequence charSequence, int i10, int i11) {
        ...
        if (charSequence.charAt(i10) == f52863c[i12 % 47]) {
            return;
        }
        throw kk.d.a();
    }
    ...
    private int[] j(ok.a aVar) {
        int l10 = aVar.l();
        int j10 = aVar.j(0);
        Arrays.fill(this.f52867b, 0);
        int[] iArr = this.f52867b;
    ...
    public Result b(int i10, ok.a aVar, Map map) {
        ...
        int[] iArr = this.f52867b;
        Arrays.fill(iArr, 0);
        StringBuilder sb2 = this.f52866a;
        sb2.setLength(0);
        while (true) {
            k.e(aVar, j11, iArr);
            int l11 = l(iArr);
