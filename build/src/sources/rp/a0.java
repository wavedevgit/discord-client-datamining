...
public abstract class a0 {
    public static final void a(TextView textView, TextWatcher watcher) {
        ...
        Object tag = textView.getTag(m.f49098l);
        if (tag != null) {
            textView.removeTextChangedListener((TextWatcher) tag);
        }
        textView.addTextChangedListener(watcher);
        textView.setTag(m.f49098l, watcher);
    }
    ...
    public static final void b(TextView textView, Function1 listener) {
        ...
        textView.setTag(m.f49098l, aVar);
    }
    ...
    public static final class a implements TextWatcher {
        ...
        final /* synthetic */ Function1 f49037e;

        a(Function1 function1) {
            this.f49037e = function1;
        }

        @Override // android.text.TextWatcher
        public void afterTextChanged(Editable editable) {
            String valueOf = String.valueOf(editable);
            String str = this.f49036d;
            if (str == null) {
                Intrinsics.throwUninitializedPropertyAccessException("oldText");
                str = null;
            }
            if (!Intrinsics.areEqual(valueOf, str)) {
                this.f49037e.invoke(String.valueOf(editable));
            }
        }

        @Override // android.text.TextWatcher
        public void beforeTextChanged(CharSequence charSequence, int i10, int i11, int i12) {
            this.f49036d = String.valueOf(charSequence);
        }
