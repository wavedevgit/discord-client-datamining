...
public final class e implements ViewBinding {
    ...
    private final ThemeableLottieAnimationView f48940a;

    /* renamed from: b  reason: collision with root package name */
    public final ThemeableLottieAnimationView f48941b;
    ...
    private e(ThemeableLottieAnimationView themeableLottieAnimationView, ThemeableLottieAnimationView themeableLottieAnimationView2) {
        this.f48940a = themeableLottieAnimationView;
        this.f48941b = themeableLottieAnimationView2;
    }
    ...
    public static e d(LayoutInflater layoutInflater, ViewGroup viewGroup, boolean z10) {
        View inflate = layoutInflater.inflate(n.f46203e, viewGroup, false);
        if (z10) {
