...
public final class b implements EventDispatcherListener {
    ...
    private final ReactViewGroup f37396a;

    /* renamed from: b  reason: collision with root package name */
    private final ThemedReactContext f37397b;

    /* renamed from: c  reason: collision with root package name */
    private final l f37398c;

    /* renamed from: d  reason: collision with root package name */
    private Function0 f37399d;

    /* renamed from: e  reason: collision with root package name */
    private final int f37400e;

    /* renamed from: f  reason: collision with root package name */
    private final UIManager f37401f;

    /* renamed from: g  reason: collision with root package name */
    private final EventDispatcher f37402g;
    ...
    public b(ReactViewGroup view, ThemedReactContext reactContext, l config, Function0 callback) {
        ...
        this.f37396a = view;
        this.f37397b = reactContext;
        this.f37398c = config;
        this.f37399d = callback;
        this.f37400e = 2;
        this.f37401f = UIManagerHelper.getUIManager(reactContext.getReactApplicationContext(), 2);
        this.f37402g = UIManagerHelper.getEventDispatcher(reactContext.getReactApplicationContext(), 2);
    }
    ...
    public final void b() {
        EventDispatcher eventDispatcher = this.f37402g;
    ...
    */
    public void onEventDispatch(com.facebook.react.uimanager.events.Event r8) {
        ...
        L13:
            r0 = 0
            com.facebook.react.bridge.UIManager r1 = r7.f37401f     // Catch: java.lang.Exception -> L21
            if (r1 == 0) goto L23
        ...
        L65:
            ...
            com.facebook.react.uimanager.ThemedReactContext r3 = r7.f37397b
            r2.<init>(r3)
            android.view.ViewGroup$LayoutParams r3 = new android.view.ViewGroup$LayoutParams
            r4 = 0
            r3.<init>(r4, r4)
            r2.setLayoutParams(r3)
            com.facebook.react.views.view.ReactViewGroup r3 = r7.f37396a
            com.facebook.react.uimanager.ThemedReactContext r4 = r7.f37397b
            im.l r5 = r7.f37398c
            im.k r6 = new im.k
            r6.<init>(r3, r0, r4, r5)
            r0.addView(r2)
            boolean r3 = lm.c.a()
            if (r3 == 0) goto Lac
            kotlin.jvm.functions.Function0 r3 = r7.f37399d
