...
public class a {
    ...
    private int d(String str, String str2) {
        return this.f24954a.getResources().getIdentifier(str2, str, this.f24954a.getPackageName());
    }

    private int e(int i10) {
        TypedValue typedValue = new TypedValue();
        this.f24954a.getResources().getValue(i10, typedValue, true);
    ...
    public InputStream h(String str) {
        String k10 = k(str);
        return g(k10, this.f24954a.getAssets().open(k10, 2));
    }
    ...
    public InputStream j(String str) {
        ...
        if (split.length == 2) {
            ...
            int e10 = e(d10);
            if (e10 == 3) {
                return g(k10, this.f24954a.getResources().openRawResource(d10));
            }
