...
public class c {
    ...
    public static final class a extends i {
        ...
        protected Object invokeSuspend(Object obj) {
            ...
            this.f51659d = 1;
            kotlin.c.b(obj);
            Intrinsics.checkNotNull(this.f51660e, "null cannot be cast to non-null type kotlin.Function2<R of kotlin.coroutines.intrinsics.IntrinsicsKt__IntrinsicsJvmKt.createCoroutineUnintercepted, kotlin.coroutines.Continuation<T of kotlin.coroutines.intrinsics.IntrinsicsKt__IntrinsicsJvmKt.createCoroutineUnintercepted>, kotlin.Any?>");
            return ((Function2) TypeIntrinsics.beforeCheckcastToFunctionOfArity(this.f51660e, 2)).invoke(this.f51661i, this);
        }
    }
    ...
    public static final class b extends kotlin.coroutines.jvm.internal.d {
        ...
        protected Object invokeSuspend(Object obj) {
            ...
            this.f51662d = 1;
            kotlin.c.b(obj);
            Intrinsics.checkNotNull(this.f51663e, "null cannot be cast to non-null type kotlin.Function2<R of kotlin.coroutines.intrinsics.IntrinsicsKt__IntrinsicsJvmKt.createCoroutineUnintercepted, kotlin.coroutines.Continuation<T of kotlin.coroutines.intrinsics.IntrinsicsKt__IntrinsicsJvmKt.createCoroutineUnintercepted>, kotlin.Any?>");
            return ((Function2) TypeIntrinsics.beforeCheckcastToFunctionOfArity(this.f51663e, 2)).invoke(this.f51664i, this);
        }
    }

    /* renamed from: ur.c$c  reason: collision with other inner class name */
    /* loaded from: /home/runner/work/discord-client-datamining/discord-client-datamining/build/classes4.dex */
    public static final class C0673c extends i {
        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        C0673c(Continuation continuation) {
            super(continuation);
            Intrinsics.checkNotNull(continuation, "null cannot be cast to non-null type kotlin.coroutines.Continuation<kotlin.Any?>");
        }
    ...
    private static final Continuation b(Continuation continuation) {
        ...
        if (context == e.f32062d) {
            return new C0673c(continuation);
        }
