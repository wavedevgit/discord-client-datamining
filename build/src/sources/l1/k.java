...
public class k extends p {
    ...
    public void a(d dVar) {
        androidx.constraintlayout.core.widgets.a aVar = (androidx.constraintlayout.core.widgets.a) this.f36055b;
        int w12 = aVar.w1();
        int i10 = 0;
        int i11 = -1;
        for (f fVar : this.f36061h.f36013l) {
            int i12 = fVar.f36008g;
            if (i11 == -1 || i12 < i11) {
                i11 = i12;
            }
            if (i10 < i12) {
        ...
        if (w12 != 0 && w12 != 2) {
            this.f36061h.d(i10 + aVar.x1());
        } else {
            this.f36061h.d(i11 + aVar.x1());
        }
    }
        ...
        if (constraintWidget instanceof androidx.constraintlayout.core.widgets.a) {
            ...
            if (w12 != 0) {
                if (w12 != 1) {
                    if (w12 != 2) {
                        if (w12 == 3) {
                            this.f36061h.f36006e = f.a.BOTTOM;
                            while (i10 < aVar.M0) {
                                ConstraintWidget constraintWidget2 = aVar.L0[i10];
                                if (v12 || constraintWidget2.V() != 8) {
                                    f fVar = constraintWidget2.f2405f.f36062i;
                                    fVar.f36012k.add(this.f36061h);
                                    this.f36061h.f36013l.add(fVar);
                                }
                                i10++;
                            }
                    ...
                    while (i10 < aVar.M0) {
                        ...
                        if (v12 || constraintWidget3.V() != 8) {
                            f fVar2 = constraintWidget3.f2405f.f36061h;
                            fVar2.f36012k.add(this.f36061h);
                            this.f36061h.f36013l.add(fVar2);
                        }
                        i10++;
                    }
                    q(this.f36055b.f2405f.f36061h);
                ...
                this.f36061h.f36006e = f.a.RIGHT;
                while (i10 < aVar.M0) {
                    ConstraintWidget constraintWidget4 = aVar.L0[i10];
                    if (v12 || constraintWidget4.V() != 8) {
                        f fVar3 = constraintWidget4.f2403e.f36062i;
                        fVar3.f36012k.add(this.f36061h);
                        this.f36061h.f36013l.add(fVar3);
                    }
                    i10++;
                }
            ...
            while (i10 < aVar.M0) {
                ...
                if (v12 || constraintWidget5.V() != 8) {
                    f fVar4 = constraintWidget5.f2403e.f36061h;
                    fVar4.f36012k.add(this.f36061h);
                    this.f36061h.f36013l.add(fVar4);
                }
                i10++;
            }
            q(this.f36055b.f2403e.f36061h);
