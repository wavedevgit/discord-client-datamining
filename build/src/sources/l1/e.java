...
public class e {
    ...
    private ConstraintWidgetContainer f36725a;

    /* renamed from: d  reason: collision with root package name */
    private ConstraintWidgetContainer f36728d;

    /* renamed from: b  reason: collision with root package name */
    private boolean f36726b = true;

    /* renamed from: c  reason: collision with root package name */
    private boolean f36727c = true;

    /* renamed from: e  reason: collision with root package name */
    private ArrayList f36729e = new ArrayList();

    /* renamed from: f  reason: collision with root package name */
    private ArrayList f36730f = new ArrayList();

    /* renamed from: g  reason: collision with root package name */
    private b.InterfaceC0474b f36731g = null;

    /* renamed from: h  reason: collision with root package name */
    private b.a f36732h = new b.a();

    /* renamed from: i  reason: collision with root package name */
    ArrayList f36733i = new ArrayList();

    public e(ConstraintWidgetContainer constraintWidgetContainer) {
        this.f36725a = constraintWidgetContainer;
        this.f36728d = constraintWidgetContainer;
    }
    ...
    private void a(f fVar, int i10, int i11, f fVar2, ArrayList arrayList, m mVar) {
        ...
        p pVar = fVar.f36737d;
        if (pVar.f36788c == null) {
            ConstraintWidgetContainer constraintWidgetContainer = this.f36725a;
            if (pVar != constraintWidgetContainer.f2249e && pVar != constraintWidgetContainer.f2251f) {
                ...
                pVar.f36788c = mVar2;
                mVar2.a(pVar);
                for (d dVar : pVar.f36793h.f36744k) {
                ...
                if (i13 == 1 && (pVar instanceof n)) {
                    for (f fVar7 : ((n) pVar).f36769k.f36745l) {
        ...
        while (it.hasNext()) {
            ...
            if (constraintWidget.V() == 8) {
                ...
                if ((bVar6 == bVar10 || bVar6 == ConstraintWidget.b.FIXED || bVar6 == ConstraintWidget.b.WRAP_CONTENT) && (bVar7 == bVar10 || bVar7 == ConstraintWidget.b.FIXED || bVar7 == ConstraintWidget.b.WRAP_CONTENT)) {
                    ...
                    constraintWidget.f2249e.f36790e.d(constraintWidget.W());
                    constraintWidget.f2251f.f36790e.d(constraintWidget.x());
                    constraintWidget.f2241a = true;
                } else {
                    if (bVar6 == bVar9) {
                        bVar2 = bVar9;
                        ...
                        if (bVar7 != bVar13 && bVar7 != ConstraintWidget.b.FIXED) {
                            ...
                            constraintWidget.f2249e.f36790e.f36755m = constraintWidget.W();
                        } else {
                            bVar = bVar7;
                            i10 = 3;
                            if (i11 == 2) {
                                ...
                                if (dVarArr[0].f2343f == null || dVarArr[1].f2343f == null) {
                                    ...
                                    if (bVar == bVar2 || (bVar6 != (bVar4 = ConstraintWidget.b.WRAP_CONTENT) && bVar6 != ConstraintWidget.b.FIXED)) {
                                        ...
                                        constraintWidget.f2251f.f36790e.f36755m = constraintWidget.x();
                                    } else {
                                        bVar3 = bVar6;
                                        if (i12 == 2) {
    ...
    private int e(ConstraintWidgetContainer constraintWidgetContainer, int i10) {
        int size = this.f36733i.size();
        long j10 = 0;
        for (int i11 = 0; i11 < size; i11++) {
            j10 = Math.max(j10, ((m) this.f36733i.get(i11)).b(constraintWidgetContainer, i10));
        }
        return (int) j10;
    }
    ...
    private void i(p pVar, int i10, ArrayList arrayList) {
        for (d dVar : pVar.f36793h.f36744k) {
            if (dVar instanceof f) {
                a((f) dVar, i10, 0, pVar.f36794i, arrayList, null);
            } else if (dVar instanceof p) {
                a(((p) dVar).f36793h, i10, 0, pVar.f36794i, arrayList, null);
            }
        }
        for (d dVar2 : pVar.f36794i.f36744k) {
            if (dVar2 instanceof f) {
                a((f) dVar2, i10, 1, pVar.f36793h, arrayList, null);
            } else if (dVar2 instanceof p) {
                a(((p) dVar2).f36794i, i10, 1, pVar.f36793h, arrayList, null);
            }
        }
        int i11 = i10;
        if (i11 == 1) {
    ...
    private void l(ConstraintWidget constraintWidget, ConstraintWidget.b bVar, int i10, ConstraintWidget.b bVar2, int i11) {
        b.a aVar = this.f36732h;
        aVar.f36713a = bVar;
        aVar.f36714b = bVar2;
        aVar.f36715c = i10;
        aVar.f36716d = i11;
        this.f36731g.b(constraintWidget, aVar);
        constraintWidget.l1(this.f36732h.f36717e);
        constraintWidget.M0(this.f36732h.f36718f);
        constraintWidget.L0(this.f36732h.f36720h);
        constraintWidget.B0(this.f36732h.f36719g);
    }
    ...
    public void c() {
        ...
        this.f36733i.clear();
        m.f36761h = 0;
        i(this.f36725a.f2249e, 0, this.f36733i);
        i(this.f36725a.f2251f, 1, this.f36733i);
        this.f36726b = false;
    }

    public void d(ArrayList arrayList) {
        arrayList.clear();
        this.f36728d.f2249e.f();
        this.f36728d.f2251f.f();
        arrayList.add(this.f36728d.f2249e);
        arrayList.add(this.f36728d.f2251f);
        Iterator it = this.f36728d.L0.iterator();
    ...
    public boolean f(boolean z10) {
        boolean z11;
        boolean z12 = false;
        if (this.f36726b || this.f36727c) {
            Iterator it = this.f36725a.L0.iterator();
            while (it.hasNext()) {
                ConstraintWidget constraintWidget = (ConstraintWidget) it.next();
                constraintWidget.n();
        ...
        this.f36725a.n1(0);
        this.f36725a.o1(0);
        ConstraintWidget.b u10 = this.f36725a.u(0);
        ConstraintWidget.b u11 = this.f36725a.u(1);
        if (this.f36726b) {
            c();
        }
        int X = this.f36725a.X();
        int Y = this.f36725a.Y();
        this.f36725a.f2249e.f36793h.d(X);
        this.f36725a.f2251f.f36793h.d(Y);
        m();
        ConstraintWidget.b bVar = ConstraintWidget.b.WRAP_CONTENT;
        if (u10 == bVar || u11 == bVar) {
            if (z10) {
                Iterator it2 = this.f36729e.iterator();
                while (true) {
                    if (!it2.hasNext()) {
                        break;
            ...
            if (z10 && u10 == ConstraintWidget.b.WRAP_CONTENT) {
                this.f36725a.Q0(ConstraintWidget.b.FIXED);
                ConstraintWidgetContainer constraintWidgetContainer2 = this.f36725a;
                constraintWidgetContainer2.l1(e(constraintWidgetContainer2, 0));
                ConstraintWidgetContainer constraintWidgetContainer3 = this.f36725a;
                constraintWidgetContainer3.f2249e.f36790e.d(constraintWidgetContainer3.W());
            }
            if (z10 && u11 == ConstraintWidget.b.WRAP_CONTENT) {
                this.f36725a.h1(ConstraintWidget.b.FIXED);
                ConstraintWidgetContainer constraintWidgetContainer4 = this.f36725a;
                constraintWidgetContainer4.M0(e(constraintWidgetContainer4, 1));
                ConstraintWidgetContainer constraintWidgetContainer5 = this.f36725a;
                constraintWidgetContainer5.f2251f.f36790e.d(constraintWidgetContainer5.x());
            }
        }
        ConstraintWidgetContainer constraintWidgetContainer6 = this.f36725a;
        ...
        if (bVar2 != bVar3 && bVar2 != ConstraintWidget.b.MATCH_PARENT) {
            ...
            this.f36725a.f2249e.f36794i.d(W);
            this.f36725a.f2249e.f36790e.d(W - X);
            m();
            ConstraintWidgetContainer constraintWidgetContainer7 = this.f36725a;
            ...
            if (bVar4 == bVar3 || bVar4 == ConstraintWidget.b.MATCH_PARENT) {
                ...
                this.f36725a.f2251f.f36794i.d(x10);
                this.f36725a.f2251f.f36790e.d(x10 - Y);
            }
            m();
            z11 = true;
        }
        Iterator it3 = this.f36729e.iterator();
        while (it3.hasNext()) {
            p pVar = (p) it3.next();
            if (pVar.f36787b != this.f36725a || pVar.f36792g) {
                pVar.e();
            }
        }
        Iterator it4 = this.f36729e.iterator();
        while (true) {
            if (it4.hasNext()) {
                p pVar2 = (p) it4.next();
                if (z11 || pVar2.f36787b != this.f36725a) {
                    if (!pVar2.f36793h.f36743j) {
                        break;
                    }
                    if (!pVar2.f36794i.f36743j) {
                        if (!(pVar2 instanceof j)) {
                            break;
                        }
                    }
                    if (!pVar2.f36790e.f36743j && !(pVar2 instanceof c) && !(pVar2 instanceof j)) {
                        break;
                    }
                }
            } else {
    ...
    public boolean g(boolean z10) {
        if (this.f36726b) {
            ...
            while (it.hasNext()) {
                ...
                constraintWidget.f2241a = false;
                l lVar = constraintWidget.f2249e;
                lVar.f36790e.f36743j = false;
                lVar.f36792g = false;
                lVar.r();
                n nVar = constraintWidget.f2251f;
                nVar.f36790e.f36743j = false;
                nVar.f36792g = false;
                nVar.q();
            }
            this.f36725a.n();
            ...
            lVar2.f36790e.f36743j = false;
            lVar2.f36792g = false;
            lVar2.r();
            n nVar2 = this.f36725a.f2251f;
            nVar2.f36790e.f36743j = false;
            nVar2.f36792g = false;
            nVar2.q();
            c();
        }
        ...
        this.f36725a.n1(0);
        this.f36725a.o1(0);
        this.f36725a.f2249e.f36793h.d(0);
        this.f36725a.f2251f.f36793h.d(0);
        return true;
    }
    ...
    public boolean h(boolean z10, int i10) {
        ...
        if (z10 && (u10 == (bVar = ConstraintWidget.b.WRAP_CONTENT) || u11 == bVar)) {
            ...
            if (i10 == 0) {
                if (z10 && u10 == ConstraintWidget.b.WRAP_CONTENT) {
                    ...
                    ConstraintWidgetContainer constraintWidgetContainer2 = this.f36725a;
                    constraintWidgetContainer2.f2249e.f36790e.d(constraintWidgetContainer2.W());
                }
                ...
                ConstraintWidgetContainer constraintWidgetContainer4 = this.f36725a;
                constraintWidgetContainer4.f2251f.f36790e.d(constraintWidgetContainer4.x());
            }
        }
        if (i10 == 0) {
            ConstraintWidgetContainer constraintWidgetContainer5 = this.f36725a;
        ...
        while (it2.hasNext()) {
            p pVar2 = (p) it2.next();
            if (pVar2.f36791f == i10 && (pVar2.f36787b != this.f36725a || pVar2.f36792g)) {
                pVar2.e();
            }
        }
        Iterator it3 = this.f36729e.iterator();
        while (true) {
            if (it3.hasNext()) {
                p pVar3 = (p) it3.next();
                if (pVar3.f36791f == i10 && (z11 || pVar3.f36787b != this.f36725a)) {
                    if (!pVar3.f36793h.f36743j) {
                        break;
                    } else if (!pVar3.f36794i.f36743j) {
                        break;
                    } else if (!(pVar3 instanceof c) && !pVar3.f36790e.f36743j) {
                        break;
                    }
                }
            } else {
    ...
    public void m() {
        ...
        while (it.hasNext()) {
            ...
            if (!constraintWidget.f2241a) {
                ...
                g gVar2 = constraintWidget.f2249e.f36790e;
                boolean z12 = gVar2.f36743j;
                g gVar3 = constraintWidget.f2251f.f36790e;
                boolean z13 = gVar3.f36743j;
                if (z12 && z13) {
                    ConstraintWidget.b bVar4 = ConstraintWidget.b.FIXED;
                    l(constraintWidget, bVar4, gVar2.f36740g, bVar4, gVar3.f36740g);
                    constraintWidget.f2241a = true;
                } else if (z12 && z11) {
                    l(constraintWidget, ConstraintWidget.b.FIXED, gVar2.f36740g, bVar3, gVar3.f36740g);
                    ...
                    l(constraintWidget, bVar3, gVar2.f36740g, ConstraintWidget.b.FIXED, gVar3.f36740g);
                ...
                if (constraintWidget.f2241a && (gVar = constraintWidget.f2251f.f36770l) != null) {
