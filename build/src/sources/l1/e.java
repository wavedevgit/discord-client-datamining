...
public class e {
    ...
    private ConstraintWidgetContainer f35644a;

    /* renamed from: d  reason: collision with root package name */
    private ConstraintWidgetContainer f35647d;

    /* renamed from: b  reason: collision with root package name */
    private boolean f35645b = true;

    /* renamed from: c  reason: collision with root package name */
    private boolean f35646c = true;

    /* renamed from: e  reason: collision with root package name */
    private ArrayList f35648e = new ArrayList();

    /* renamed from: f  reason: collision with root package name */
    private ArrayList f35649f = new ArrayList();

    /* renamed from: g  reason: collision with root package name */
    private b.InterfaceC0477b f35650g = null;

    /* renamed from: h  reason: collision with root package name */
    private b.a f35651h = new b.a();

    /* renamed from: i  reason: collision with root package name */
    ArrayList f35652i = new ArrayList();

    public e(ConstraintWidgetContainer constraintWidgetContainer) {
        this.f35644a = constraintWidgetContainer;
        this.f35647d = constraintWidgetContainer;
    }
    ...
    private void a(f fVar, int i10, int i11, f fVar2, ArrayList arrayList, m mVar) {
        ...
        p pVar = fVar.f35656d;
        if (pVar.f35707c == null) {
            ConstraintWidgetContainer constraintWidgetContainer = this.f35644a;
            if (pVar != constraintWidgetContainer.f2703e && pVar != constraintWidgetContainer.f2705f) {
                ...
                pVar.f35707c = mVar2;
                mVar2.a(pVar);
                for (d dVar : pVar.f35712h.f35663k) {
                ...
                if (i13 == 1 && (pVar instanceof n)) {
                    for (f fVar7 : ((n) pVar).f35688k.f35664l) {
        ...
        while (it.hasNext()) {
            ...
            if (constraintWidget.V() == 8) {
                ...
                if ((bVar6 == bVar10 || bVar6 == ConstraintWidget.b.FIXED || bVar6 == ConstraintWidget.b.WRAP_CONTENT) && (bVar7 == bVar10 || bVar7 == ConstraintWidget.b.FIXED || bVar7 == ConstraintWidget.b.WRAP_CONTENT)) {
                    ...
                    constraintWidget.f2703e.f35709e.d(constraintWidget.W());
                    constraintWidget.f2705f.f35709e.d(constraintWidget.x());
                    constraintWidget.f2695a = true;
                } else {
                    if (bVar6 == bVar9) {
                        bVar2 = bVar9;
                        ...
                        if (bVar7 != bVar13 && bVar7 != ConstraintWidget.b.FIXED) {
                            ...
                            constraintWidget.f2703e.f35709e.f35674m = constraintWidget.W();
                        } else {
                            bVar = bVar7;
                            i10 = 3;
                            if (i11 == 2) {
                                ...
                                if (dVarArr[0].f2797f == null || dVarArr[1].f2797f == null) {
                                    ...
                                    if (bVar == bVar2 || (bVar6 != (bVar4 = ConstraintWidget.b.WRAP_CONTENT) && bVar6 != ConstraintWidget.b.FIXED)) {
                                        ...
                                        constraintWidget.f2705f.f35709e.f35674m = constraintWidget.x();
                                    } else {
                                        bVar3 = bVar6;
                                        if (i12 == 2) {
    ...
    private int e(ConstraintWidgetContainer constraintWidgetContainer, int i10) {
        int size = this.f35652i.size();
        long j10 = 0;
        for (int i11 = 0; i11 < size; i11++) {
            j10 = Math.max(j10, ((m) this.f35652i.get(i11)).b(constraintWidgetContainer, i10));
        }
        return (int) j10;
    }
    ...
    private void i(p pVar, int i10, ArrayList arrayList) {
        for (d dVar : pVar.f35712h.f35663k) {
            if (dVar instanceof f) {
                a((f) dVar, i10, 0, pVar.f35713i, arrayList, null);
            } else if (dVar instanceof p) {
                a(((p) dVar).f35712h, i10, 0, pVar.f35713i, arrayList, null);
            }
        }
        for (d dVar2 : pVar.f35713i.f35663k) {
            if (dVar2 instanceof f) {
                a((f) dVar2, i10, 1, pVar.f35712h, arrayList, null);
            } else if (dVar2 instanceof p) {
                a(((p) dVar2).f35713i, i10, 1, pVar.f35712h, arrayList, null);
            }
        }
        int i11 = i10;
        if (i11 == 1) {
    ...
    private void l(ConstraintWidget constraintWidget, ConstraintWidget.b bVar, int i10, ConstraintWidget.b bVar2, int i11) {
        b.a aVar = this.f35651h;
        aVar.f35632a = bVar;
        aVar.f35633b = bVar2;
        aVar.f35634c = i10;
        aVar.f35635d = i11;
        this.f35650g.b(constraintWidget, aVar);
        constraintWidget.l1(this.f35651h.f35636e);
        constraintWidget.M0(this.f35651h.f35637f);
        constraintWidget.L0(this.f35651h.f35639h);
        constraintWidget.B0(this.f35651h.f35638g);
    }
    ...
    public void c() {
        ...
        this.f35652i.clear();
        m.f35680h = 0;
        i(this.f35644a.f2703e, 0, this.f35652i);
        i(this.f35644a.f2705f, 1, this.f35652i);
        this.f35645b = false;
    }

    public void d(ArrayList arrayList) {
        arrayList.clear();
        this.f35647d.f2703e.f();
        this.f35647d.f2705f.f();
        arrayList.add(this.f35647d.f2703e);
        arrayList.add(this.f35647d.f2705f);
        Iterator it = this.f35647d.L0.iterator();
    ...
    public boolean f(boolean z10) {
        ...
        if (this.f35645b || this.f35646c) {
            Iterator it = this.f35644a.L0.iterator();
            while (it.hasNext()) {
                ConstraintWidget constraintWidget = (ConstraintWidget) it.next();
                constraintWidget.n();
        ...
        this.f35644a.n1(0);
        this.f35644a.o1(0);
        ConstraintWidget.b u10 = this.f35644a.u(0);
        ConstraintWidget.b u11 = this.f35644a.u(1);
        if (this.f35645b) {
            c();
        }
        int X = this.f35644a.X();
        int Y = this.f35644a.Y();
        this.f35644a.f2703e.f35712h.d(X);
        this.f35644a.f2705f.f35712h.d(Y);
        m();
        ConstraintWidget.b bVar = ConstraintWidget.b.WRAP_CONTENT;
        if (u10 == bVar || u11 == bVar) {
            if (z10) {
                Iterator it2 = this.f35648e.iterator();
                while (true) {
                    if (!it2.hasNext()) {
                        break;
            ...
            if (z10 && u10 == ConstraintWidget.b.WRAP_CONTENT) {
                this.f35644a.Q0(ConstraintWidget.b.FIXED);
                ConstraintWidgetContainer constraintWidgetContainer2 = this.f35644a;
                constraintWidgetContainer2.l1(e(constraintWidgetContainer2, 0));
                ConstraintWidgetContainer constraintWidgetContainer3 = this.f35644a;
                constraintWidgetContainer3.f2703e.f35709e.d(constraintWidgetContainer3.W());
            }
            if (z10 && u11 == ConstraintWidget.b.WRAP_CONTENT) {
                this.f35644a.h1(ConstraintWidget.b.FIXED);
                ConstraintWidgetContainer constraintWidgetContainer4 = this.f35644a;
                constraintWidgetContainer4.M0(e(constraintWidgetContainer4, 1));
                ConstraintWidgetContainer constraintWidgetContainer5 = this.f35644a;
                constraintWidgetContainer5.f2705f.f35709e.d(constraintWidgetContainer5.x());
            }
        }
        ConstraintWidgetContainer constraintWidgetContainer6 = this.f35644a;
        ...
        if (bVar2 != bVar3 && bVar2 != ConstraintWidget.b.MATCH_PARENT) {
            ...
            this.f35644a.f2703e.f35713i.d(W);
            this.f35644a.f2703e.f35709e.d(W - X);
            m();
            ConstraintWidgetContainer constraintWidgetContainer7 = this.f35644a;
            ...
            if (bVar4 == bVar3 || bVar4 == ConstraintWidget.b.MATCH_PARENT) {
                ...
                this.f35644a.f2705f.f35713i.d(x10);
                this.f35644a.f2705f.f35709e.d(x10 - Y);
            }
            m();
            z11 = true;
        }
        Iterator it3 = this.f35648e.iterator();
        while (it3.hasNext()) {
            p pVar = (p) it3.next();
            if (pVar.f35706b != this.f35644a || pVar.f35711g) {
                pVar.e();
            }
        }
        Iterator it4 = this.f35648e.iterator();
        while (true) {
            if (it4.hasNext()) {
                p pVar2 = (p) it4.next();
                if (z11 || pVar2.f35706b != this.f35644a) {
                    if (!pVar2.f35712h.f35662j) {
                        break;
                    }
                    if (!pVar2.f35713i.f35662j) {
                        if (!(pVar2 instanceof j)) {
                            break;
                        }
                    }
                    if (!pVar2.f35709e.f35662j && !(pVar2 instanceof c) && !(pVar2 instanceof j)) {
                        break;
                    }
                }
            } else {
    ...
    public boolean g(boolean z10) {
        if (this.f35645b) {
            ...
            while (it.hasNext()) {
                ...
                constraintWidget.f2695a = false;
                l lVar = constraintWidget.f2703e;
                lVar.f35709e.f35662j = false;
                lVar.f35711g = false;
                lVar.r();
                n nVar = constraintWidget.f2705f;
                nVar.f35709e.f35662j = false;
                nVar.f35711g = false;
                nVar.q();
            }
            this.f35644a.n();
            ...
            lVar2.f35709e.f35662j = false;
            lVar2.f35711g = false;
            lVar2.r();
            n nVar2 = this.f35644a.f2705f;
            nVar2.f35709e.f35662j = false;
            nVar2.f35711g = false;
            nVar2.q();
            c();
        }
        ...
        this.f35644a.n1(0);
        this.f35644a.o1(0);
        this.f35644a.f2703e.f35712h.d(0);
        this.f35644a.f2705f.f35712h.d(0);
        return true;
    }
    ...
    public boolean h(boolean z10, int i10) {
        ...
        if (z10 && (u10 == (bVar = ConstraintWidget.b.WRAP_CONTENT) || u11 == bVar)) {
            Iterator it = this.f35648e.iterator();
            while (true) {
                if (!it.hasNext()) {
                    break;
                }
                p pVar = (p) it.next();
                if (pVar.f35710f == i10 && !pVar.m()) {
                    z10 = false;
                    break;
                }
            }
            if (i10 == 0) {
                if (z10 && u10 == ConstraintWidget.b.WRAP_CONTENT) {
                    ...
                    ConstraintWidgetContainer constraintWidgetContainer2 = this.f35644a;
                    constraintWidgetContainer2.f2703e.f35709e.d(constraintWidgetContainer2.W());
                }
                ...
                ConstraintWidgetContainer constraintWidgetContainer4 = this.f35644a;
                constraintWidgetContainer4.f2705f.f35709e.d(constraintWidgetContainer4.x());
            }
        }
        if (i10 == 0) {
            ConstraintWidgetContainer constraintWidgetContainer5 = this.f35644a;
        ...
        while (it2.hasNext()) {
            p pVar2 = (p) it2.next();
            if (pVar2.f35710f == i10 && (pVar2.f35706b != this.f35644a || pVar2.f35711g)) {
                pVar2.e();
            }
        }
        Iterator it3 = this.f35648e.iterator();
        while (true) {
            if (it3.hasNext()) {
                p pVar3 = (p) it3.next();
                if (pVar3.f35710f == i10 && (z11 || pVar3.f35706b != this.f35644a)) {
                    if (!pVar3.f35712h.f35662j) {
                        break;
                    } else if (!pVar3.f35713i.f35662j) {
                        break;
                    } else if (!(pVar3 instanceof c) && !pVar3.f35709e.f35662j) {
                        break;
                    }
                }
            } else {
    ...
    public void m() {
        ...
        while (it.hasNext()) {
            ...
            if (!constraintWidget.f2695a) {
                ...
                g gVar2 = constraintWidget.f2703e.f35709e;
                boolean z12 = gVar2.f35662j;
                g gVar3 = constraintWidget.f2705f.f35709e;
                boolean z13 = gVar3.f35662j;
                if (z12 && z13) {
                    ConstraintWidget.b bVar4 = ConstraintWidget.b.FIXED;
                    l(constraintWidget, bVar4, gVar2.f35659g, bVar4, gVar3.f35659g);
                    constraintWidget.f2695a = true;
                } else if (z12 && z11) {
                    l(constraintWidget, ConstraintWidget.b.FIXED, gVar2.f35659g, bVar3, gVar3.f35659g);
                    ...
                    l(constraintWidget, bVar3, gVar2.f35659g, ConstraintWidget.b.FIXED, gVar3.f35659g);
                ...
                if (constraintWidget.f2695a && (gVar = constraintWidget.f2705f.f35689l) != null) {
