...
public class b {
    ...
    private final ArrayList f35674a = new ArrayList();

    /* renamed from: b  reason: collision with root package name */
    private a f35675b = new a();

    /* renamed from: c  reason: collision with root package name */
    private ConstraintWidgetContainer f35676c;

    /* loaded from: /home/runner/work/discord-client-datamining/discord-client-datamining/build/classes.dex */
    public static class a {

        /* renamed from: k  reason: collision with root package name */
        public static int f35677k = 0;

        /* renamed from: l  reason: collision with root package name */
        public static int f35678l = 1;

        /* renamed from: m  reason: collision with root package name */
        public static int f35679m = 2;

        /* renamed from: a  reason: collision with root package name */
        public ConstraintWidget.b f35680a;

        /* renamed from: b  reason: collision with root package name */
        public ConstraintWidget.b f35681b;
    ...
    public b(ConstraintWidgetContainer constraintWidgetContainer) {
        this.f35676c = constraintWidgetContainer;
    }

    private boolean a(InterfaceC0477b interfaceC0477b, ConstraintWidget constraintWidget, int i10) {
        boolean z10;
        boolean z11;
        boolean z12;
        boolean z13;
        this.f35675b.f35680a = constraintWidget.A();
        this.f35675b.f35681b = constraintWidget.T();
        this.f35675b.f35682c = constraintWidget.W();
        this.f35675b.f35683d = constraintWidget.x();
        a aVar = this.f35675b;
        aVar.f35688i = false;
        aVar.f35689j = i10;
        ConstraintWidget.b bVar = aVar.f35680a;
        ...
        if (z12 && constraintWidget.f2743y[0] == 4) {
            aVar.f35680a = ConstraintWidget.b.FIXED;
        }
        if (z13 && constraintWidget.f2743y[1] == 4) {
            aVar.f35681b = ConstraintWidget.b.FIXED;
        }
        interfaceC0477b.b(constraintWidget, aVar);
        constraintWidget.l1(this.f35675b.f35684e);
        constraintWidget.M0(this.f35675b.f35685f);
        constraintWidget.L0(this.f35675b.f35687h);
        constraintWidget.B0(this.f35675b.f35686g);
        a aVar2 = this.f35675b;
        aVar2.f35689j = a.f35677k;
        return aVar2.f35688i;
    }
    ...
    */
    ...
    public long d(ConstraintWidgetContainer constraintWidgetContainer, int i10, int i11, int i12, int i13, int i14, int i15, int i16, int i17, int i18) {
        ...
        InterfaceC0477b K1 = constraintWidgetContainer2.K1();
        ...
        if (z10 && (metrics = h1.d.f25732x) != null) {
            metrics.f2673e++;
        }
        ...
        if (!z12 || i19 != 2) {
            ...
            if (size2 > 0) {
                ...
                int max = Math.max(constraintWidgetContainer2.W(), bVar.f35676c.I());
                int max2 = Math.max(constraintWidgetContainer2.x(), bVar.f35676c.H());
                int i27 = 0;
                boolean z22 = false;
                while (i27 < size2) {
                    ConstraintWidget constraintWidget2 = (ConstraintWidget) bVar.f35674a.get(i27);
                    boolean z23 = z21;
                    if (!(constraintWidget2 instanceof androidx.constraintlayout.core.widgets.h)) {
                        ...
                        boolean a10 = z22 | bVar.a(K1, constraintWidget2, a.f35678l);
                ...
                while (true) {
                    ...
                    int i32 = 0;
                    while (i32 < size2) {
                        ConstraintWidget constraintWidget3 = (ConstraintWidget) bVar.f35674a.get(i32);
                        if (((constraintWidget3 instanceof k1.a) && !(constraintWidget3 instanceof androidx.constraintlayout.core.widgets.h)) || (constraintWidget3 instanceof androidx.constraintlayout.core.widgets.f) || constraintWidget3.V() == 8 || ((z24 && constraintWidget3.f2703e.f35757e.f35710j && constraintWidget3.f2705f.f35757e.f35710j) || (constraintWidget3 instanceof androidx.constraintlayout.core.widgets.h))) {
                            i22 = i31;
                        } else {
    ...
    public void e(ConstraintWidgetContainer constraintWidgetContainer) {
        ...
        for (int i10 = 0; i10 < size; i10++) {
            ...
            if (A == bVar || constraintWidget.T() == bVar) {
                this.f35674a.add(constraintWidget);
            }
        }
