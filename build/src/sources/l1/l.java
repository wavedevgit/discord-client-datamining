...
public class l extends p {
    ...
    private static int[] f35561k = new int[2];
    ...
    static /* synthetic */ class a {
        ...
        static {
            ...
            try {
                f35562a[p.b.END.ordinal()] = 2;
            } catch (NoSuchFieldError unused2) {
            }
            try {
                f35562a[p.b.CENTER.ordinal()] = 3;
    ...
    public l(ConstraintWidget constraintWidget) {
        ...
        this.f35596i.f35540e = f.a.RIGHT;
        this.f35593f = 0;
    }
    ...
    */
    ...
    void d() {
        ...
        if (constraintWidget.f2392a) {
            this.f35592e.d(constraintWidget.W());
        }
        if (!this.f35592e.f35545j) {
            ConstraintWidget.b A = this.f35589b.A();
            this.f35591d = A;
            if (A != ConstraintWidget.b.MATCH_CONSTRAINT) {
                ConstraintWidget.b bVar = ConstraintWidget.b.MATCH_PARENT;
                if (A == bVar && (K2 = this.f35589b.K()) != null && (K2.A() == ConstraintWidget.b.FIXED || K2.A() == bVar)) {
                    int W = (K2.W() - this.f35589b.O.f()) - this.f35589b.Q.f();
                    b(this.f35595h, K2.f2400e.f35595h, this.f35589b.O.f());
                    b(this.f35596i, K2.f2400e.f35596i, -this.f35589b.Q.f());
                    this.f35592e.d(W);
                    return;
                } else if (this.f35591d == ConstraintWidget.b.FIXED) {
                    this.f35592e.d(this.f35589b.W());
                }
            }
        } else {
            ConstraintWidget.b bVar2 = this.f35591d;
            ConstraintWidget.b bVar3 = ConstraintWidget.b.MATCH_PARENT;
            if (bVar2 == bVar3 && (K = this.f35589b.K()) != null && (K.A() == ConstraintWidget.b.FIXED || K.A() == bVar3)) {
                b(this.f35595h, K.f2400e.f35595h, this.f35589b.O.f());
                b(this.f35596i, K.f2400e.f35596i, -this.f35589b.Q.f());
                return;
            }
        }
        g gVar = this.f35592e;
        if (gVar.f35545j) {
            ...
            if (constraintWidget2.f2392a) {
                ...
                if (dVar2 != null && dVarArr[1].f2494f != null) {
                    if (constraintWidget2.i0()) {
                        this.f35595h.f35541f = this.f35589b.W[0].f();
                        this.f35596i.f35541f = -this.f35589b.W[1].f();
                        return;
                    }
                    f h10 = h(this.f35589b.W[0]);
                    if (h10 != null) {
                        b(this.f35595h, h10, this.f35589b.W[0].f());
                    }
                    f h11 = h(this.f35589b.W[1]);
                    if (h11 != null) {
                        b(this.f35596i, h11, -this.f35589b.W[1].f());
                    }
                    ...
                    f h12 = h(dVar);
                    if (h12 != null) {
                        b(this.f35595h, h12, this.f35589b.W[0].f());
                    ...
                    if (dVar3.f2494f != null) {
                        f h13 = h(dVar3);
                        if (h13 != null) {
                            b(this.f35596i, h13, -this.f35589b.W[1].f());
                        ...
                        b(this.f35595h, this.f35589b.K().f2400e.f35595h, this.f35589b.X());
                        b(this.f35596i, this.f35595h, this.f35592e.f35542g);
                        return;
                    } else {
                        return;
        ...
        if (this.f35591d == ConstraintWidget.b.MATCH_CONSTRAINT) {
            ConstraintWidget constraintWidget3 = this.f35589b;
            int i10 = constraintWidget3.f2436w;
            if (i10 != 2) {
                if (i10 == 3) {
                    if (constraintWidget3.f2438x == 3) {
                        this.f35595h.f35536a = this;
                        this.f35596i.f35536a = this;
                        n nVar = constraintWidget3.f2402f;
                        nVar.f35595h.f35536a = this;
                        nVar.f35596i.f35536a = this;
                        gVar.f35536a = this;
                        if (constraintWidget3.k0()) {
                            this.f35592e.f35547l.add(this.f35589b.f2402f.f35592e);
                            this.f35589b.f2402f.f35592e.f35546k.add(this.f35592e);
                            n nVar2 = this.f35589b.f2402f;
                            nVar2.f35592e.f35536a = this;
                            this.f35592e.f35547l.add(nVar2.f35595h);
                            this.f35592e.f35547l.add(this.f35589b.f2402f.f35596i);
                            this.f35589b.f2402f.f35595h.f35546k.add(this.f35592e);
                            this.f35589b.f2402f.f35596i.f35546k.add(this.f35592e);
                        } else if (this.f35589b.i0()) {
                            this.f35589b.f2402f.f35592e.f35547l.add(this.f35592e);
                            this.f35592e.f35546k.add(this.f35589b.f2402f.f35592e);
                        } else {
                            this.f35589b.f2402f.f35592e.f35547l.add(this.f35592e);
                        }
                    } else {
                        g gVar2 = constraintWidget3.f2402f.f35592e;
                        gVar.f35547l.add(gVar2);
                        ...
                        this.f35595h.f35547l.add(this.f35592e);
                        this.f35596i.f35547l.add(this.f35592e);
                    }
                }
            } else {
        ...
        androidx.constraintlayout.core.widgets.d dVar5 = dVar4.f2494f;
        if (dVar5 != null && dVarArr2[1].f2494f != null) {
            if (constraintWidget4.i0()) {
                this.f35595h.f35541f = this.f35589b.W[0].f();
                this.f35596i.f35541f = -this.f35589b.W[1].f();
                return;
            }
            f h14 = h(this.f35589b.W[0]);
            f h15 = h(this.f35589b.W[1]);
            if (h14 != null) {
                h14.b(this);
            }
            if (h15 != null) {
    ...
    @Override // l1.p
    boolean m() {
        if (this.f35591d != ConstraintWidget.b.MATCH_CONSTRAINT || this.f35589b.f2436w == 0) {
            return true;
        }
        return false;
    }
    ...
    public String toString() {
        return "HorizontalRun " + this.f35589b.t();
    }
}
