...
public class l extends p {
    ...
    private static int[] f36775k = new int[2];
    ...
    static /* synthetic */ class a {
        ...
        static {
            ...
            try {
                f36776a[p.b.END.ordinal()] = 2;
            } catch (NoSuchFieldError unused2) {
            }
            try {
                f36776a[p.b.CENTER.ordinal()] = 3;
    ...
    public l(ConstraintWidget constraintWidget) {
        ...
        this.f36810i.f36754e = f.a.RIGHT;
        this.f36807f = 0;
    }
    ...
    */
    ...
    void d() {
        ...
        if (constraintWidget.f2241a) {
            this.f36806e.d(constraintWidget.W());
        }
        if (!this.f36806e.f36759j) {
            ConstraintWidget.b A = this.f36803b.A();
            this.f36805d = A;
            if (A != ConstraintWidget.b.MATCH_CONSTRAINT) {
                ConstraintWidget.b bVar = ConstraintWidget.b.MATCH_PARENT;
                if (A == bVar && (K2 = this.f36803b.K()) != null && (K2.A() == ConstraintWidget.b.FIXED || K2.A() == bVar)) {
                    int W = (K2.W() - this.f36803b.O.f()) - this.f36803b.Q.f();
                    b(this.f36809h, K2.f2249e.f36809h, this.f36803b.O.f());
                    b(this.f36810i, K2.f2249e.f36810i, -this.f36803b.Q.f());
                    this.f36806e.d(W);
                    return;
                } else if (this.f36805d == ConstraintWidget.b.FIXED) {
                    this.f36806e.d(this.f36803b.W());
                }
            }
        } else {
            ConstraintWidget.b bVar2 = this.f36805d;
            ConstraintWidget.b bVar3 = ConstraintWidget.b.MATCH_PARENT;
            if (bVar2 == bVar3 && (K = this.f36803b.K()) != null && (K.A() == ConstraintWidget.b.FIXED || K.A() == bVar3)) {
                b(this.f36809h, K.f2249e.f36809h, this.f36803b.O.f());
                b(this.f36810i, K.f2249e.f36810i, -this.f36803b.Q.f());
                return;
            }
        }
        g gVar = this.f36806e;
            ...
            if (constraintWidget2.f2241a) {
                ...
                if (dVar2 != null && dVarArr[1].f2343f != null) {
                    if (constraintWidget2.i0()) {
                        this.f36809h.f36755f = this.f36803b.W[0].f();
                        this.f36810i.f36755f = -this.f36803b.W[1].f();
                        return;
                    }
                    f h10 = h(this.f36803b.W[0]);
                    if (h10 != null) {
                        b(this.f36809h, h10, this.f36803b.W[0].f());
                    }
                    f h11 = h(this.f36803b.W[1]);
                    if (h11 != null) {
                        b(this.f36810i, h11, -this.f36803b.W[1].f());
                    }
                    ...
                    f h12 = h(dVar);
                    if (h12 != null) {
                        b(this.f36809h, h12, this.f36803b.W[0].f());
                    ...
                    if (dVar3.f2343f != null) {
                        f h13 = h(dVar3);
                        if (h13 != null) {
                            b(this.f36810i, h13, -this.f36803b.W[1].f());
                        ...
                        b(this.f36809h, this.f36803b.K().f2249e.f36809h, this.f36803b.X());
                        b(this.f36810i, this.f36809h, this.f36806e.f36756g);
                        return;
                    } else {
                        return;
        ...
        if (this.f36805d == ConstraintWidget.b.MATCH_CONSTRAINT) {
            ...
            if (i10 != 2) {
                if (i10 == 3) {
                    if (constraintWidget3.f2287x == 3) {
                        ...
                        nVar.f36809h.f36750a = this;
                        nVar.f36810i.f36750a = this;
                        gVar.f36750a = this;
                        if (constraintWidget3.k0()) {
                            this.f36806e.f36761l.add(this.f36803b.f2251f.f36806e);
                            this.f36803b.f2251f.f36806e.f36760k.add(this.f36806e);
                            n nVar2 = this.f36803b.f2251f;
                            nVar2.f36806e.f36750a = this;
                            this.f36806e.f36761l.add(nVar2.f36809h);
                            this.f36806e.f36761l.add(this.f36803b.f2251f.f36810i);
                            this.f36803b.f2251f.f36809h.f36760k.add(this.f36806e);
                            this.f36803b.f2251f.f36810i.f36760k.add(this.f36806e);
                        } else if (this.f36803b.i0()) {
                            this.f36803b.f2251f.f36806e.f36761l.add(this.f36806e);
                            this.f36806e.f36760k.add(this.f36803b.f2251f.f36806e);
                        } else {
                            this.f36803b.f2251f.f36806e.f36761l.add(this.f36806e);
                        }
                    } else {
                        g gVar2 = constraintWidget3.f2251f.f36806e;
                        gVar.f36761l.add(gVar2);
                        ...
                        this.f36809h.f36761l.add(this.f36806e);
                        this.f36810i.f36761l.add(this.f36806e);
                    }
                }
            } else {
        ...
        if (dVar5 != null && dVarArr2[1].f2343f != null) {
            ...
            f h14 = h(this.f36803b.W[0]);
            f h15 = h(this.f36803b.W[1]);
            if (h14 != null) {
                h14.b(this);
            }
            if (h15 != null) {
            ...
            f h16 = h(dVar4);
            if (h16 != null) {
                b(this.f36809h, h16, this.f36803b.W[0].f());
            ...
            if (dVar6.f2343f != null) {
                f h17 = h(dVar6);
                if (h17 != null) {
                    b(this.f36810i, h17, -this.f36803b.W[1].f());
    ...
    @Override // l1.p
    boolean m() {
        if (this.f36805d != ConstraintWidget.b.MATCH_CONSTRAINT || this.f36803b.f2285w == 0) {
            return true;
        }
        return false;
    }
    ...
    public String toString() {
        return "HorizontalRun " + this.f36803b.t();
    }
}
