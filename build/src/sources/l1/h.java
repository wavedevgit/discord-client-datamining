...
public abstract class h {
    ...
    private static b.a f36756a = new b.a();

    /* renamed from: b  reason: collision with root package name */
    private static int f36757b = 0;

    /* renamed from: c  reason: collision with root package name */
    private static int f36758c = 0;
    ...
    private static boolean a(int i10, ConstraintWidget constraintWidget) {
        ...
        if (A != bVar5 && !constraintWidget.n0() && A != ConstraintWidget.b.WRAP_CONTENT && ((A != (bVar2 = ConstraintWidget.b.MATCH_CONSTRAINT) || constraintWidget.f2285w != 0 || constraintWidget.f2248d0 != 0.0f || !constraintWidget.a0(0)) && (A != bVar2 || constraintWidget.f2285w != 1 || !constraintWidget.d0(0, constraintWidget.W())))) {
            z10 = false;
        } else {
            z10 = true;
        }
        if (T != bVar5 && !constraintWidget.o0() && T != ConstraintWidget.b.WRAP_CONTENT && ((T != (bVar = ConstraintWidget.b.MATCH_CONSTRAINT) || constraintWidget.f2287x != 0 || constraintWidget.f2248d0 != 0.0f || !constraintWidget.a0(1)) && (T != bVar || constraintWidget.f2287x != 1 || !constraintWidget.d0(1, constraintWidget.x())))) {
            z11 = false;
        } else {
            z11 = true;
        }
        if (constraintWidget.f2248d0 > 0.0f && (z10 || z11)) {
            return true;
        }
        if (!z10 || !z11) {
            return false;
    ...
    private static void b(int i10, ConstraintWidget constraintWidget, b.InterfaceC0474b interfaceC0474b, boolean z10) {
        ...
        if (!(constraintWidget instanceof ConstraintWidgetContainer) && constraintWidget.m0()) {
            ...
            if (a(i11, constraintWidget)) {
                ConstraintWidgetContainer.U1(i11, constraintWidget, interfaceC0474b, new b.a(), b.a.f36710k);
            }
        }
        ...
        if (o10.d() != null && o10.n()) {
            ...
            while (it.hasNext()) {
                ...
                ConstraintWidget constraintWidget2 = dVar5.f2341d;
                int i12 = i10 + 1;
                boolean a10 = a(i12, constraintWidget2);
                if (constraintWidget2.m0() && a10) {
                    z12 = z14;
                    ConstraintWidgetContainer.U1(i12, constraintWidget2, interfaceC0474b, new b.a(), b.a.f36710k);
                } else {
                    z12 = z14;
                }
                if ((dVar5 == constraintWidget2.O && (dVar4 = constraintWidget2.Q.f2343f) != null && dVar4.n()) || (dVar5 == constraintWidget2.Q && (dVar3 = constraintWidget2.O.f2343f) != null && dVar3.n())) {
                    z13 = z12;
                } else {
                    z13 = false;
                }
                ...
                if (A == bVar && !a10) {
                    if (constraintWidget2.A() == bVar && constraintWidget2.A >= 0 && constraintWidget2.f2291z >= 0 && ((constraintWidget2.V() == 8 || (constraintWidget2.f2285w == 0 && constraintWidget2.v() == 0.0f)) && !constraintWidget2.i0() && !constraintWidget2.l0() && z13 && !constraintWidget2.i0())) {
                    ...
                    if (dVar5 == dVar6 && constraintWidget2.Q.f2343f == null) {
                        int f10 = dVar6.f() + e10;
                        ...
                        if (dVar5 == dVar7 && dVar6.f2343f == null) {
                            int f11 = e10 - dVar7.f();
        ...
        if (o11.d() != null && o11.n()) {
            ...
            while (it2.hasNext()) {
                ...
                ConstraintWidget constraintWidget3 = dVar8.f2341d;
                int i13 = i10 + 1;
                boolean a11 = a(i13, constraintWidget3);
                if (constraintWidget3.m0() && a11) {
                    ConstraintWidgetContainer.U1(i13, constraintWidget3, interfaceC0474b, new b.a(), b.a.f36710k);
                }
                if ((dVar8 == constraintWidget3.O && (dVar2 = constraintWidget3.Q.f2343f) != null && dVar2.n()) || (dVar8 == constraintWidget3.Q && (dVar = constraintWidget3.O.f2343f) != null && dVar.n())) {
                    z11 = z15;
                } else {
                    z11 = false;
                }
                ...
                if (A2 == bVar2 && !a11) {
                    if (constraintWidget3.A() == bVar2 && constraintWidget3.A >= 0 && constraintWidget3.f2291z >= 0 && (constraintWidget3.V() == 8 || (constraintWidget3.f2285w == 0 && constraintWidget3.v() == 0.0f))) {
                    ...
                    if (dVar8 == dVar9 && constraintWidget3.Q.f2343f == null) {
                        int f12 = dVar9.f() + e11;
                        ...
                        if (dVar8 == dVar10 && dVar9.f2343f == null) {
    ...
    private static void d(int i10, b.InterfaceC0474b interfaceC0474b, ConstraintWidget constraintWidget, boolean z10) {
        ...
        int e10 = constraintWidget.O.f2343f.e();
        int e11 = constraintWidget.Q.f2343f.e();
    ...
    private static void e(int i10, ConstraintWidget constraintWidget, b.InterfaceC0474b interfaceC0474b, ConstraintWidget constraintWidget2, boolean z10) {
        ...
        int e10 = constraintWidget2.O.f2343f.e() + constraintWidget2.O.f();
        int e11 = constraintWidget2.Q.f2343f.e() - constraintWidget2.Q.f();
        if (e11 >= e10) {
            int W2 = constraintWidget2.W();
            if (constraintWidget2.V() != 8) {
                int i11 = constraintWidget2.f2285w;
                if (i11 == 2) {
                ...
                W2 = Math.max(constraintWidget2.f2291z, W2);
    ...
    private static void f(int i10, b.InterfaceC0474b interfaceC0474b, ConstraintWidget constraintWidget) {
        ...
        int e10 = constraintWidget.P.f2343f.e();
        int e11 = constraintWidget.R.f2343f.e();
    ...
    private static void g(int i10, ConstraintWidget constraintWidget, b.InterfaceC0474b interfaceC0474b, ConstraintWidget constraintWidget2) {
        ...
        int e10 = constraintWidget2.P.f2343f.e() + constraintWidget2.P.f();
        int e11 = constraintWidget2.R.f2343f.e() - constraintWidget2.R.f();
        if (e11 >= e10) {
            int x11 = constraintWidget2.x();
            if (constraintWidget2.V() != 8) {
                int i11 = constraintWidget2.f2287x;
                if (i11 == 2) {
                    if (constraintWidget instanceof ConstraintWidgetContainer) {
    ...
    public static void h(ConstraintWidgetContainer constraintWidgetContainer, b.InterfaceC0474b interfaceC0474b) {
        ...
        for (int i17 = 0; i17 < size; i17++) {
            ...
            if (constraintWidget7.m0() && a(0, constraintWidget7)) {
                ConstraintWidgetContainer.U1(0, constraintWidget7, interfaceC0474b, f36756a, b.a.f36710k);
    ...
    private static void i(int i10, ConstraintWidget constraintWidget, b.InterfaceC0474b interfaceC0474b) {
        ...
        if (o10.d() != null && o10.n()) {
            ...
            while (it.hasNext()) {
                ...
                if ((dVar5 == constraintWidget2.P && (dVar4 = constraintWidget2.R.f2343f) != null && dVar4.n()) || (dVar5 == constraintWidget2.R && (dVar3 = constraintWidget2.P.f2343f) != null && dVar3.n())) {
                    z11 = z12;
                } else {
                    z11 = false;
                }
                ...
                ConstraintWidget.b bVar = ConstraintWidget.b.MATCH_CONSTRAINT;
                if (T == bVar && !a10) {
                    if (constraintWidget2.T() == bVar && constraintWidget2.D >= 0 && constraintWidget2.C >= 0 && ((constraintWidget2.V() == 8 || (constraintWidget2.f2287x == 0 && constraintWidget2.v() == 0.0f)) && !constraintWidget2.k0() && !constraintWidget2.l0() && z11 && !constraintWidget2.k0())) {
                    ...
                    if (dVar5 == dVar6 && constraintWidget2.R.f2343f == null) {
                        int f10 = dVar6.f() + e10;
        ...
        if (o11.d() != null && o11.n()) {
            ...
            while (it2.hasNext()) {
                ...
                if ((dVar8 == constraintWidget3.P && (dVar2 = constraintWidget3.R.f2343f) != null && dVar2.n()) || (dVar8 == constraintWidget3.R && (dVar = constraintWidget3.P.f2343f) != null && dVar.n())) {
                    z10 = z14;
                } else {
                    z10 = false;
                }
                ...
                ConstraintWidget.b bVar2 = ConstraintWidget.b.MATCH_CONSTRAINT;
                if (T2 == bVar2 && !a11) {
                    if (constraintWidget3.T() == bVar2 && constraintWidget3.D >= 0 && constraintWidget3.C >= 0 && (constraintWidget3.V() == 8 || (constraintWidget3.f2287x == 0 && constraintWidget3.v() == 0.0f))) {
                    ...
                    if (dVar8 == dVar9 && constraintWidget3.R.f2343f == null) {
                        int f12 = dVar9.f() + e11;
        ...
        if (o12.d() != null && o12.n()) {
            ...
            while (it3.hasNext()) {
                ...
                ConstraintWidget constraintWidget4 = dVar11.f2341d;
                int i14 = i10 + 1;
                boolean a12 = a(i14, constraintWidget4);
                if (constraintWidget4.m0() && a12) {
                    ConstraintWidgetContainer.U1(i14, constraintWidget4, interfaceC0474b, new b.a(), b.a.f36710k);
                }
