...
public abstract class h {
    ...
    private static b.a f35456a = new b.a();

    /* renamed from: b  reason: collision with root package name */
    private static int f35457b = 0;

    /* renamed from: c  reason: collision with root package name */
    private static int f35458c = 0;
    ...
    private static boolean a(int i10, ConstraintWidget constraintWidget) {
        ...
        if (A != bVar5 && !constraintWidget.n0() && A != ConstraintWidget.b.WRAP_CONTENT && ((A != (bVar2 = ConstraintWidget.b.MATCH_CONSTRAINT) || constraintWidget.f2439w != 0 || constraintWidget.f2402d0 != 0.0f || !constraintWidget.a0(0)) && (A != bVar2 || constraintWidget.f2439w != 1 || !constraintWidget.d0(0, constraintWidget.W())))) {
            z10 = false;
        } else {
            z10 = true;
        }
        if (T != bVar5 && !constraintWidget.o0() && T != ConstraintWidget.b.WRAP_CONTENT && ((T != (bVar = ConstraintWidget.b.MATCH_CONSTRAINT) || constraintWidget.f2441x != 0 || constraintWidget.f2402d0 != 0.0f || !constraintWidget.a0(1)) && (T != bVar || constraintWidget.f2441x != 1 || !constraintWidget.d0(1, constraintWidget.x())))) {
            z11 = false;
        } else {
            z11 = true;
        }
        if (constraintWidget.f2402d0 > 0.0f && (z10 || z11)) {
            return true;
        }
        if (!z10 || !z11) {
            return false;
    ...
    private static void b(int i10, ConstraintWidget constraintWidget, b.InterfaceC0489b interfaceC0489b, boolean z10) {
        boolean z11;
        ...
        if (!(constraintWidget instanceof ConstraintWidgetContainer) && constraintWidget.m0()) {
            ...
            if (a(i11, constraintWidget)) {
                ConstraintWidgetContainer.U1(i11, constraintWidget, interfaceC0489b, new b.a(), b.a.f35410k);
            }
        }
        ...
        if (o10.d() != null && o10.n()) {
            ...
            while (it.hasNext()) {
                ...
                ConstraintWidget constraintWidget2 = dVar5.f2495d;
                int i12 = i10 + 1;
                boolean a10 = a(i12, constraintWidget2);
                if (constraintWidget2.m0() && a10) {
                    z12 = z14;
                    ConstraintWidgetContainer.U1(i12, constraintWidget2, interfaceC0489b, new b.a(), b.a.f35410k);
                } else {
                    z12 = z14;
                }
                if ((dVar5 == constraintWidget2.O && (dVar4 = constraintWidget2.Q.f2497f) != null && dVar4.n()) || (dVar5 == constraintWidget2.Q && (dVar3 = constraintWidget2.O.f2497f) != null && dVar3.n())) {
                    z13 = z12;
                } else {
                    z13 = false;
                }
                ...
                if (A == bVar && !a10) {
                    if (constraintWidget2.A() == bVar && constraintWidget2.A >= 0 && constraintWidget2.f2445z >= 0 && ((constraintWidget2.V() == 8 || (constraintWidget2.f2439w == 0 && constraintWidget2.v() == 0.0f)) && !constraintWidget2.i0() && !constraintWidget2.l0() && z13 && !constraintWidget2.i0())) {
                        e(i12, constraintWidget, interfaceC0489b, constraintWidget2, z10);
                    }
                } else if (!constraintWidget2.m0()) {
                    androidx.constraintlayout.core.widgets.d dVar6 = constraintWidget2.O;
                    if (dVar5 == dVar6 && constraintWidget2.Q.f2497f == null) {
                        int f10 = dVar6.f() + e10;
                        constraintWidget2.G0(f10, constraintWidget2.W() + f10);
                        b(i12, constraintWidget2, interfaceC0489b, z10);
                    } else {
                        androidx.constraintlayout.core.widgets.d dVar7 = constraintWidget2.Q;
                        if (dVar5 == dVar7 && dVar6.f2497f == null) {
                            int f11 = e10 - dVar7.f();
                            constraintWidget2.G0(f11 - constraintWidget2.W(), f11);
                            b(i12, constraintWidget2, interfaceC0489b, z10);
                        } else if (z13 && !constraintWidget2.i0()) {
                            d(i12, interfaceC0489b, constraintWidget2, z10);
                        }
                    }
                }
                z14 = z12;
        ...
        if (o11.d() != null && o11.n()) {
            ...
            while (it2.hasNext()) {
                ...
                ConstraintWidget constraintWidget3 = dVar8.f2495d;
                int i13 = i10 + 1;
                boolean a11 = a(i13, constraintWidget3);
                if (constraintWidget3.m0() && a11) {
                    ConstraintWidgetContainer.U1(i13, constraintWidget3, interfaceC0489b, new b.a(), b.a.f35410k);
                }
                if ((dVar8 == constraintWidget3.O && (dVar2 = constraintWidget3.Q.f2497f) != null && dVar2.n()) || (dVar8 == constraintWidget3.Q && (dVar = constraintWidget3.O.f2497f) != null && dVar.n())) {
                    z11 = z15;
                } else {
                    z11 = false;
                }
    ...
    private static void c(int i10, androidx.constraintlayout.core.widgets.a aVar, b.InterfaceC0489b interfaceC0489b, int i11, boolean z10) {
        if (aVar.u1()) {
            if (i11 == 0) {
                b(i10 + 1, aVar, interfaceC0489b, z10);
            } else {
                i(i10 + 1, aVar, interfaceC0489b);
            }
        }
    }

    private static void d(int i10, b.InterfaceC0489b interfaceC0489b, ConstraintWidget constraintWidget, boolean z10) {
        float f10;
        float y10 = constraintWidget.y();
        int e10 = constraintWidget.O.f2497f.e();
        int e11 = constraintWidget.Q.f2497f.e();
        ...
        b(i10 + 1, constraintWidget, interfaceC0489b, z10);
    }

    private static void e(int i10, ConstraintWidget constraintWidget, b.InterfaceC0489b interfaceC0489b, ConstraintWidget constraintWidget2, boolean z10) {
        int W;
        float y10 = constraintWidget2.y();
        int e10 = constraintWidget2.O.f2497f.e() + constraintWidget2.O.f();
        int e11 = constraintWidget2.Q.f2497f.e() - constraintWidget2.Q.f();
        if (e11 >= e10) {
            int W2 = constraintWidget2.W();
            if (constraintWidget2.V() != 8) {
                int i11 = constraintWidget2.f2439w;
                if (i11 == 2) {
                ...
                W2 = Math.max(constraintWidget2.f2445z, W2);
            ...
            b(i10 + 1, constraintWidget2, interfaceC0489b, z10);
        }
    }

    private static void f(int i10, b.InterfaceC0489b interfaceC0489b, ConstraintWidget constraintWidget) {
        float f10;
        float R = constraintWidget.R();
        int e10 = constraintWidget.P.f2497f.e();
        int e11 = constraintWidget.R.f2497f.e();
        ...
        i(i10 + 1, constraintWidget, interfaceC0489b);
    }

    private static void g(int i10, ConstraintWidget constraintWidget, b.InterfaceC0489b interfaceC0489b, ConstraintWidget constraintWidget2) {
        int x10;
        float R = constraintWidget2.R();
        int e10 = constraintWidget2.P.f2497f.e() + constraintWidget2.P.f();
        int e11 = constraintWidget2.R.f2497f.e() - constraintWidget2.R.f();
        if (e11 >= e10) {
            int x11 = constraintWidget2.x();
            if (constraintWidget2.V() != 8) {
                int i11 = constraintWidget2.f2441x;
                if (i11 == 2) {
                    if (constraintWidget instanceof ConstraintWidgetContainer) {
            ...
            i(i10 + 1, constraintWidget2, interfaceC0489b);
        }
    }

    public static void h(ConstraintWidgetContainer constraintWidgetContainer, b.InterfaceC0489b interfaceC0489b) {
        ...
        if (z10) {
            for (int i12 = 0; i12 < size; i12++) {
                ...
                if (constraintWidget2 instanceof androidx.constraintlayout.core.widgets.f) {
                    ...
                    if (fVar2.t1() == 1) {
                        b(0, fVar2, interfaceC0489b, R1);
                    }
                }
            }
        }
        b(0, constraintWidgetContainer, interfaceC0489b, R1);
        if (z11) {
        ...
        if (z12) {
            for (int i15 = 0; i15 < size; i15++) {
                ...
                if (constraintWidget5 instanceof androidx.constraintlayout.core.widgets.f) {
                    ...
                    if (fVar4.t1() == 0) {
                        i(1, fVar4, interfaceC0489b);
                    }
                }
            }
        }
        i(0, constraintWidgetContainer, interfaceC0489b);
        if (z13) {
            for (int i16 = 0; i16 < size; i16++) {
                ...
                if (constraintWidget6 instanceof androidx.constraintlayout.core.widgets.a) {
                    ...
                    if (aVar2.y1() == 1) {
                        c(0, aVar2, interfaceC0489b, 1, R1);
                    }
                }
            }
        }
        for (int i17 = 0; i17 < size; i17++) {
            ...
            if (constraintWidget7.m0() && a(0, constraintWidget7)) {
                ConstraintWidgetContainer.U1(0, constraintWidget7, interfaceC0489b, f35456a, b.a.f35410k);
                if (constraintWidget7 instanceof androidx.constraintlayout.core.widgets.f) {
                    if (((androidx.constraintlayout.core.widgets.f) constraintWidget7).t1() == 0) {
                        i(0, constraintWidget7, interfaceC0489b);
                    } else {
                        b(0, constraintWidget7, interfaceC0489b, R1);
                    }
                } else {
                    b(0, constraintWidget7, interfaceC0489b, R1);
                    i(0, constraintWidget7, interfaceC0489b);
    ...
    private static void i(int i10, ConstraintWidget constraintWidget, b.InterfaceC0489b interfaceC0489b) {
        boolean z10;
        androidx.constraintlayout.core.widgets.d dVar;
        androidx.constraintlayout.core.widgets.d dVar2;
        boolean z11;
        ...
        if (o10.d() != null && o10.n()) {
            ...
            while (it.hasNext()) {
                ...
                if ((dVar5 == constraintWidget2.P && (dVar4 = constraintWidget2.R.f2497f) != null && dVar4.n()) || (dVar5 == constraintWidget2.R && (dVar3 = constraintWidget2.P.f2497f) != null && dVar3.n())) {
                    z11 = z12;
                } else {
                    z11 = false;
                }
                ...
                ConstraintWidget.b bVar = ConstraintWidget.b.MATCH_CONSTRAINT;
                if (T == bVar && !a10) {
                    if (constraintWidget2.T() == bVar && constraintWidget2.D >= 0 && constraintWidget2.C >= 0 && ((constraintWidget2.V() == 8 || (constraintWidget2.f2441x == 0 && constraintWidget2.v() == 0.0f)) && !constraintWidget2.k0() && !constraintWidget2.l0() && z11 && !constraintWidget2.k0())) {
                        g(i12, constraintWidget, interfaceC0489b, constraintWidget2);
                    }
                } else if (!constraintWidget2.m0()) {
                    androidx.constraintlayout.core.widgets.d dVar6 = constraintWidget2.P;
                    if (dVar5 == dVar6 && constraintWidget2.R.f2497f == null) {
                        int f10 = dVar6.f() + e10;
                        constraintWidget2.J0(f10, constraintWidget2.x() + f10);
                        i(i12, constraintWidget2, interfaceC0489b);
                    } else {
                        ...
                        if (dVar5 == dVar7 && dVar6.f2497f == null) {
                            ...
                            f(i12, interfaceC0489b, constraintWidget2);
                        }
                    }
                }
                z12 = z13;
        ...
        if (o11.d() != null && o11.n()) {
            ...
            while (it2.hasNext()) {
                ...
                if ((dVar8 == constraintWidget3.P && (dVar2 = constraintWidget3.R.f2497f) != null && dVar2.n()) || (dVar8 == constraintWidget3.R && (dVar = constraintWidget3.P.f2497f) != null && dVar.n())) {
                    z10 = z14;
                } else {
                    z10 = false;
                }
                ...
                ConstraintWidget.b bVar2 = ConstraintWidget.b.MATCH_CONSTRAINT;
                if (T2 == bVar2 && !a11) {
                    if (constraintWidget3.T() == bVar2 && constraintWidget3.D >= 0 && constraintWidget3.C >= 0 && (constraintWidget3.V() == 8 || (constraintWidget3.f2441x == 0 && constraintWidget3.v() == 0.0f))) {
                        if (!constraintWidget3.k0() && !constraintWidget3.l0() && z10 && !constraintWidget3.k0()) {
                            g(i13, constraintWidget, interfaceC0489b, constraintWidget3);
                        }
                    }
                } else if (!constraintWidget3.m0()) {
                    androidx.constraintlayout.core.widgets.d dVar9 = constraintWidget3.P;
                    if (dVar8 == dVar9 && constraintWidget3.R.f2497f == null) {
                        int f12 = dVar9.f() + e11;
                        constraintWidget3.J0(f12, constraintWidget3.x() + f12);
                        i(i13, constraintWidget3, interfaceC0489b);
                    } else {
                        ...
                        if (dVar8 == dVar10 && dVar9.f2497f == null) {
                            ...
                            f(i13, interfaceC0489b, constraintWidget3);
                        }
                    }
                }
            }
        ...
        if (o12.d() != null && o12.n()) {
            ...
            while (it3.hasNext()) {
                ...
                ConstraintWidget constraintWidget4 = dVar11.f2495d;
                int i14 = i10 + 1;
                boolean a12 = a(i14, constraintWidget4);
                if (constraintWidget4.m0() && a12) {
                    ConstraintWidgetContainer.U1(i14, constraintWidget4, interfaceC0489b, new b.a(), b.a.f35410k);
                }
                if (constraintWidget4.T() != ConstraintWidget.b.MATCH_CONSTRAINT || a12) {
                    if (!constraintWidget4.m0() && dVar11 == constraintWidget4.S) {
                        ...
                        i(i14, constraintWidget4, interfaceC0489b);
                    }
                }
            }
        }
