...
public abstract class h {
    ...
    private static b.a f35455a = new b.a();

    /* renamed from: b  reason: collision with root package name */
    private static int f35456b = 0;

    /* renamed from: c  reason: collision with root package name */
    private static int f35457c = 0;
    ...
    private static void b(int i10, ConstraintWidget constraintWidget, b.InterfaceC0489b interfaceC0489b, boolean z10) {
        ...
        if (!(constraintWidget instanceof ConstraintWidgetContainer) && constraintWidget.m0()) {
            ...
            if (a(i11, constraintWidget)) {
                ConstraintWidgetContainer.U1(i11, constraintWidget, interfaceC0489b, new b.a(), b.a.f35409k);
            }
        }
        ...
        if (o10.d() != null && o10.n()) {
            ...
            while (it.hasNext()) {
                ...
                if (constraintWidget2.m0() && a10) {
                    z12 = z14;
                    ConstraintWidgetContainer.U1(i12, constraintWidget2, interfaceC0489b, new b.a(), b.a.f35409k);
                } else {
                    z12 = z14;
                }
        ...
        if (o11.d() != null && o11.n()) {
            ...
            while (it2.hasNext()) {
                ...
                if (constraintWidget3.m0() && a11) {
                    ConstraintWidgetContainer.U1(i13, constraintWidget3, interfaceC0489b, new b.a(), b.a.f35409k);
                }
    ...
    public static void h(ConstraintWidgetContainer constraintWidgetContainer, b.InterfaceC0489b interfaceC0489b) {
        ...
        for (int i17 = 0; i17 < size; i17++) {
            ...
            if (constraintWidget7.m0() && a(0, constraintWidget7)) {
                ConstraintWidgetContainer.U1(0, constraintWidget7, interfaceC0489b, f35455a, b.a.f35409k);
        ...
        if (o12.d() != null && o12.n()) {
            ...
            while (it3.hasNext()) {
                ...
                if (constraintWidget4.m0() && a12) {
                    ConstraintWidgetContainer.U1(i14, constraintWidget4, interfaceC0489b, new b.a(), b.a.f35409k);
                }
