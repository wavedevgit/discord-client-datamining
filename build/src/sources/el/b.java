...
public final class b {
    private static ok.b b(g gVar, int i10, int i11, int i12) {
        hl.b a10 = gVar.a();
        if (a10 != null) {
            int e10 = a10.e();
            int d10 = a10.d();
    ...
    public ok.b a(String str, kk.a aVar, int i10, int i11, Map map) {
        if (!str.isEmpty()) {
            if (aVar == kk.a.QR_CODE) {
                if (i10 >= 0 && i11 >= 0) {
                    f fVar = f.L;
                    int i12 = 4;
                    if (map != null) {
                        kk.f fVar2 = kk.f.ERROR_CORRECTION;
                        if (map.containsKey(fVar2)) {
                            fVar = f.valueOf(map.get(fVar2).toString());
                        }
                        kk.f fVar3 = kk.f.MARGIN;
