...
public abstract class e0 {
    ...
    static final Type[] f54098a = new Type[0];

    /* renamed from: b  reason: collision with root package name */
    private static boolean f54099b = true;
    ...
    public static final class a implements GenericArrayType {
        ...
        public int hashCode() {
            return this.f54100d.hashCode();
        }

        public String toString() {
            return e0.u(this.f54100d) + "[]";
        }
    }
    ...
    public static final class b implements ParameterizedType {
        ...
        /* renamed from: d  reason: collision with root package name */
        private final Type f54101d;

        /* renamed from: e  reason: collision with root package name */
        private final Type f54102e;

        /* renamed from: i  reason: collision with root package name */
        private final Type[] f54103i;
        ...
        public b(Type type, Type type2, Type... typeArr) {
            ...
            this.f54101d = type;
            this.f54102e = type2;
            this.f54103i = (Type[]) typeArr.clone();
        }
        ...
        public Type[] getActualTypeArguments() {
            return (Type[]) this.f54103i.clone();
        }
        ...
        public int hashCode() {
            int i10;
            int hashCode = Arrays.hashCode(this.f54103i) ^ this.f54102e.hashCode();
            Type type = this.f54101d;
            if (type != null) {
                i10 = type.hashCode();
            } else {
                i10 = 0;
        ...
        public String toString() {
            Type[] typeArr = this.f54103i;
            if (typeArr.length == 0) {
                return e0.u(this.f54102e);
            }
            StringBuilder sb2 = new StringBuilder((typeArr.length + 1) * 30);
            sb2.append(e0.u(this.f54102e));
            sb2.append("<");
            sb2.append(e0.u(this.f54103i[0]));
            for (int i10 = 1; i10 < this.f54103i.length; i10++) {
                sb2.append(", ");
                sb2.append(e0.u(this.f54103i[i10]));
            }
            sb2.append(">");
            return sb2.toString();
        }
    ...
    public static final class c implements WildcardType {
        ...
        /* renamed from: d  reason: collision with root package name */
        private final Type f54104d;

        /* renamed from: e  reason: collision with root package name */
        private final Type f54105e;
                ...
                if (typeArr.length == 1) {
                    if (typeArr2.length == 1) {
                        ...
                        if (typeArr[0] == Object.class) {
                            this.f54105e = typeArr2[0];
                            this.f54104d = Object.class;
                            return;
                        }
                        throw new IllegalArgumentException();
                    }
        ...
        public Type[] getLowerBounds() {
            Type type = this.f54105e;
            return type != null ? new Type[]{type} : e0.f54098a;
        }

        @Override // java.lang.reflect.WildcardType
        public Type[] getUpperBounds() {
            return new Type[]{this.f54104d};
        }
        ...
        public int hashCode() {
            ...
            return i10 ^ (this.f54104d.hashCode() + 31);
        }

        public String toString() {
            if (this.f54105e != null) {
                return "? super " + e0.u(this.f54105e);
            } else if (this.f54104d == Object.class) {
                return "?";
            } else {
                return "? extends " + e0.u(this.f54104d);
            }
        }
    }
    ...
    public static RuntimeException p(Method method, int i10, String str, Object... objArr) {
        String a10 = v.f54220b.a(method, i10);
    ...
    */
    static java.lang.reflect.Type r(java.lang.reflect.Type r8, java.lang.Class r9, java.lang.reflect.Type r10) {
        ...
        Lb1:
            ...
            java.lang.reflect.Type[] r10 = new java.lang.reflect.Type[r1]
            r10[r2] = r8
            java.lang.reflect.Type[] r8 = wv.e0.f54098a
            r9.<init>(r10, r8)
            return r9
        Lca:
            return r10
        */
        throw new UnsupportedOperationException("Method not decompiled: wv.e0.r(java.lang.reflect.Type, java.lang.Class, java.lang.reflect.Type):java.lang.reflect.Type");
    }
