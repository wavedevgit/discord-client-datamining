...
final class g {
    ...
    private g(int i10) {
        this.f734a = f.a((i10 >> 3) & 3);
        this.f735b = (byte) (i10 & 7);
    }
    ...
    public boolean equals(Object obj) {
        ...
        g gVar = (g) obj;
        if (this.f734a != gVar.f734a || this.f735b != gVar.f735b) {
            return false;
        }
        return true;
    }
    ...
    public int hashCode() {
        return (this.f734a.ordinal() << 3) | this.f735b;
    }
}
