...
final class b {
    ...
    public static b[] b(byte[] bArr, j jVar, f fVar) {
        ...
        if (bArr.length == jVar.h()) {
            ...
            int length = bVarArr[0].f713b.length;
            int i14 = i11 - 1;
            while (i14 >= 0 && bVarArr[i14].f713b.length != length) {
                i14--;
            }
            int i15 = i14 + 1;
            ...
            for (int i17 = 0; i17 < b11; i17++) {
                int i18 = 0;
                while (i18 < i12) {
                    bVarArr[i18].f713b[i17] = bArr[i16];
                    i18++;
                    i16++;
                }
            }
            int i19 = i15;
            while (i19 < i12) {
                bVarArr[i19].f713b[b11] = bArr[i16];
                i19++;
                i16++;
            }
            int length2 = bVarArr[0].f713b.length;
            while (b11 < length2) {
                int i20 = 0;
                while (i20 < i12) {
                    if (i20 < i15) {
                    ...
                    bVarArr[i20].f713b[i10] = bArr[i16];
                    i20++;
                    i16++;
                }
                b11++;
