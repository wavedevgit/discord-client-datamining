...
public class o0 {
    ...
    private j0.y f56482d;

    /* renamed from: e  reason: collision with root package name */
    private j0.y f56483e;

    /* renamed from: f  reason: collision with root package name */
    private j0.y f56484f;

    /* renamed from: g  reason: collision with root package name */
    private j0.y f56485g;

    /* renamed from: h  reason: collision with root package name */
    private j0.y f56486h;

    /* renamed from: i  reason: collision with root package name */
    private j0.y f56487i;

    /* renamed from: j  reason: collision with root package name */
    private j0.y f56488j;

    /* renamed from: k  reason: collision with root package name */
    private j0.y f56489k;

    /* renamed from: l  reason: collision with root package name */
    private j0.y f56490l;

    /* renamed from: m  reason: collision with root package name */
    private final d2 f56491m;

    /* renamed from: n  reason: collision with root package name */
    private final boolean f56492n;
    ...
    public static /* synthetic */ void b(final o0 o0Var, final b bVar) {
        ...
        if (bVar.b().j()) {
            ...
            o0Var.f56479a.execute(new Runnable() { // from class: z.h0
    ...
    public static /* synthetic */ void d(final o0 o0Var, final b bVar) {
        ...
        o0Var.f56479a.execute(new Runnable() { // from class: z.g0
            @Override // java.lang.Runnable
            public final void run() {
                o0.this.m(bVar);
            }
    ...
    private j0.z i(j0.z zVar, int i10) {
        ...
        j0.z zVar2 = (j0.z) this.f56486h.apply(zVar);
        j0.y yVar = this.f56490l;
        if (yVar != null) {
            zVar2 = (j0.z) yVar.apply(zVar2);
        }
        return (j0.z) this.f56484f.apply(i.b.c(zVar2, i10));
    }
    ...
    androidx.camera.core.n j(b bVar) {
        p0 b10 = bVar.b();
        j0.z zVar = (j0.z) this.f56482d.apply(bVar);
        if ((zVar.e() == 35 || this.f56490l != null || this.f56492n) && this.f56481c.c() == 256) {
            j0.z zVar2 = (j0.z) this.f56483e.apply(w.a.c(zVar, b10.c()));
            if (this.f56490l != null) {
                zVar2 = i(zVar2, b10.c());
            }
            zVar = (j0.z) this.f56488j.apply(zVar2);
        }
        return (androidx.camera.core.n) this.f56487i.apply(zVar);
    }
    ...
    n0.h l(b bVar) {
        ...
        p0 b10 = bVar.b();
        j0.z zVar = (j0.z) this.f56483e.apply(w.a.c((j0.z) this.f56482d.apply(bVar), b10.c()));
        if (zVar.i() || this.f56490l != null) {
            zVar = i(zVar, b10.c());
        }
        j0.y yVar = this.f56485g;
        n0.g d10 = b10.d();
    ...
    public void m(b bVar) {
        ...
        final p0 b10 = bVar.b();
        try {
            final Bitmap bitmap = (Bitmap) this.f56489k.apply((j0.z) this.f56482d.apply(bVar));
    ...
    public Void p(a aVar) {
        ...
        this.f56482d = new f0();
        this.f56483e = new w(this.f56491m);
        this.f56486h = new z();
        this.f56484f = new i();
        this.f56485g = new a0();
        this.f56487i = new c0();
        this.f56489k = new v();
        if (aVar.b() == 35 || this.f56492n) {
            this.f56488j = new b0();
            return null;
        }
        return null;
    ...
    o0(Executor executor, j0.w wVar, d2 d2Var) {
        if (androidx.camera.core.internal.compat.quirk.a.b(LowMemoryQuirk.class) != null) {
            this.f56479a = c0.a.f(executor);
        } else {
            this.f56479a = executor;
        }
        this.f56480b = wVar;
        this.f56491m = d2Var;
        this.f56492n = d2Var.a(IncorrectJpegMetadataQuirk.class);
    }
