...
public class o0 {
    ...
    private j0.y f55127d;

    /* renamed from: e  reason: collision with root package name */
    private j0.y f55128e;

    /* renamed from: f  reason: collision with root package name */
    private j0.y f55129f;

    /* renamed from: g  reason: collision with root package name */
    private j0.y f55130g;

    /* renamed from: h  reason: collision with root package name */
    private j0.y f55131h;

    /* renamed from: i  reason: collision with root package name */
    private j0.y f55132i;

    /* renamed from: j  reason: collision with root package name */
    private j0.y f55133j;

    /* renamed from: k  reason: collision with root package name */
    private j0.y f55134k;

    /* renamed from: l  reason: collision with root package name */
    private j0.y f55135l;

    /* renamed from: m  reason: collision with root package name */
    private final d2 f55136m;
    ...
    public static /* synthetic */ void b(final o0 o0Var, final b bVar) {
        ...
        if (bVar.b().j()) {
            ...
            o0Var.f55124a.execute(new Runnable() { // from class: z.h0
    ...
    public static /* synthetic */ void d(final o0 o0Var, final b bVar) {
        ...
        o0Var.f55124a.execute(new Runnable() { // from class: z.g0
            @Override // java.lang.Runnable
            public final void run() {
                o0.this.m(bVar);
            }
    ...
    private j0.z i(j0.z zVar, int i10) {
        ...
        j0.z zVar2 = (j0.z) this.f55131h.apply(zVar);
        j0.y yVar = this.f55135l;
        if (yVar != null) {
            zVar2 = (j0.z) yVar.apply(zVar2);
        }
        return (j0.z) this.f55129f.apply(i.b.c(zVar2, i10));
    }
    ...
    androidx.camera.core.n j(b bVar) {
        p0 b10 = bVar.b();
        j0.z zVar = (j0.z) this.f55127d.apply(bVar);
        if ((zVar.e() == 35 || this.f55135l != null || this.f55137n) && this.f55126c.c() == 256) {
            j0.z zVar2 = (j0.z) this.f55128e.apply(w.a.c(zVar, b10.c()));
            if (this.f55135l != null) {
                zVar2 = i(zVar2, b10.c());
            }
            zVar = (j0.z) this.f55133j.apply(zVar2);
        }
        return (androidx.camera.core.n) this.f55132i.apply(zVar);
    }
    ...
    n0.h l(b bVar) {
        ...
        p0 b10 = bVar.b();
        j0.z zVar = (j0.z) this.f55128e.apply(w.a.c((j0.z) this.f55127d.apply(bVar), b10.c()));
        if (zVar.i() || this.f55135l != null) {
            zVar = i(zVar, b10.c());
        }
        j0.y yVar = this.f55130g;
        n0.g d10 = b10.d();
    ...
    public void m(b bVar) {
        ...
        final p0 b10 = bVar.b();
        try {
            final Bitmap bitmap = (Bitmap) this.f55134k.apply((j0.z) this.f55127d.apply(bVar));
    ...
    public Void p(a aVar) {
        ...
        this.f55127d = new f0();
        this.f55128e = new w(this.f55136m);
        this.f55131h = new z();
        this.f55129f = new i();
        this.f55130g = new a0();
        this.f55132i = new c0();
        this.f55134k = new v();
        if (aVar.b() == 35 || this.f55137n) {
            this.f55133j = new b0();
            return null;
        }
        return null;
    ...
    o0(Executor executor, j0.w wVar, d2 d2Var) {
        if (androidx.camera.core.internal.compat.quirk.a.b(LowMemoryQuirk.class) != null) {
            this.f55124a = c0.a.f(executor);
        } else {
            this.f55124a = executor;
        }
        this.f55125b = wVar;
        this.f55136m = d2Var;
        this.f55137n = d2Var.a(IncorrectJpegMetadataQuirk.class);
    }
