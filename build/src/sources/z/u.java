...
public class u {
    ...
    androidx.camera.core.q f55050b;

    /* renamed from: c  reason: collision with root package name */
    androidx.camera.core.q f55051c;

    /* renamed from: d  reason: collision with root package name */
    private o0.a f55052d;
    ...
    public static abstract class c {
        ...
        /* renamed from: b  reason: collision with root package name */
        private a0.w0 f55059b;

        /* renamed from: a  reason: collision with root package name */
        private a0.k f55058a = new a();

        /* renamed from: c  reason: collision with root package name */
        private a0.w0 f55060c = null;
        ...
        void o(Surface surface, Size size, int i10) {
            this.f55060c = new k1(surface, size, i10);
        }
        ...
        void p(Surface surface) {
            ...
            this.f55059b = new k1(surface, j(), d());
        }
    }

    public static /* synthetic */ void a(u uVar, p0 p0Var) {
        uVar.k(p0Var);
        uVar.f55054f.h(p0Var);
    }
    ...
    private void i(androidx.camera.core.n nVar) {
        b0.p.a();
        o0.a aVar = this.f55052d;
        Objects.requireNonNull(aVar);
        aVar.a().accept(o0.b.c(this.f55049a, nVar));
        p0 p0Var = this.f55049a;
        this.f55049a = null;
        p0Var.q();
    }
    ...
    private void l(androidx.camera.core.n nVar) {
        ...
        o0.a aVar = this.f55052d;
        Objects.requireNonNull(aVar);
        aVar.d().accept(o0.b.c(this.f55049a, nVar));
    }
    ...
    void j(androidx.camera.core.n nVar) {
        ...
        if (this.f55049a == null) {
            ...
            nVar.close();
        } else if (((Integer) nVar.A().c().d(this.f55049a.i())) == null) {
    ...
    public void m() {
        ...
        androidx.camera.core.q qVar = this.f55050b;
        Objects.requireNonNull(qVar);
        n(cVar, qVar, this.f55051c);
    }
    ...
    public o0.a q(c cVar) {
        ...
        Consumer consumer;
        e0 e0Var;
        if (this.f55053e == null && this.f55050b == null) {
            z10 = true;
        } else {
            z10 = false;
        }
        ...
        cVar.p(surface);
        this.f55050b = new androidx.camera.core.q(e0Var);
        ...
        if (cVar.g() != null) {
            ...
            this.f55051c = new androidx.camera.core.q(g10);
    ...
    public class b implements d0.c {
        ...
        public void onFailure(Throwable th2) {
            b0.p.a();
            if (this.f55056a == u.this.f55049a) {
                x.y0.l("CaptureNode", "request aborted, id=" + u.this.f55049a.e());
                if (u.this.f55054f != null) {
                    u.this.f55054f.i();
                }
                u.this.f55049a = null;
            }
