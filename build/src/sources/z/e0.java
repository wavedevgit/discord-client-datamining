...
public class e0 implements j1 {
    ...
    private androidx.camera.core.n j(androidx.camera.core.n nVar) {
        ...
        if (this.f55237b == null) {
            ...
            a10 = q2.a(new Pair(this.f55237b.i(), this.f55237b.h().get(0)));
        }
        this.f55237b = null;
    ...
    public androidx.camera.core.n b() {
        return j(this.f55236a.b());
    }

    @Override // a0.j1
    public int c() {
        return this.f55236a.c();
    }
    ...
    public void e(final j1.a aVar, Executor executor) {
        this.f55236a.e(new j1.a() { // from class: z.d0
            @Override // a0.j1.a
    ...
    public androidx.camera.core.n g() {
        return j(this.f55236a.g());
    }

    @Override // a0.j1
    public int getHeight() {
        return this.f55236a.getHeight();
    }

    @Override // a0.j1
    public Surface getSurface() {
        return this.f55236a.getSurface();
    }

    @Override // a0.j1
    public int getWidth() {
        return this.f55236a.getWidth();
    }
