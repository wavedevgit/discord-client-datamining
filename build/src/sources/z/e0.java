...
public class e0 implements j1 {
    ...
    private androidx.camera.core.n j(androidx.camera.core.n nVar) {
        ...
        if (this.f55089b == null) {
            ...
            a10 = q2.a(new Pair(this.f55089b.i(), this.f55089b.h().get(0)));
        }
        this.f55089b = null;
    ...
    public androidx.camera.core.n b() {
        return j(this.f55088a.b());
    }

    @Override // a0.j1
    public int c() {
        return this.f55088a.c();
    }
    ...
    public void e(final j1.a aVar, Executor executor) {
        this.f55088a.e(new j1.a() { // from class: z.d0
            @Override // a0.j1.a
    ...
    public androidx.camera.core.n g() {
        return j(this.f55088a.g());
    }

    @Override // a0.j1
    public int getHeight() {
        return this.f55088a.getHeight();
    }

    @Override // a0.j1
    public Surface getSurface() {
        return this.f55088a.getSurface();
    }

    @Override // a0.j1
    public int getWidth() {
        return this.f55088a.getWidth();
    }
