...
public final class h extends View {
    ...
    private Window f41324d;

    /* renamed from: e  reason: collision with root package name */
    private n0.i f41325e;
    ...
    public class a implements n0.i {
        ...
        public void a(long j10, final n0.j jVar) {
            ...
            this.f41326a = h.this.getBrightness();
            h.this.setBrightness(1.0f);
            ValueAnimator valueAnimator = this.f41327b;
            if (valueAnimator != null) {
                valueAnimator.cancel();
            }
            h hVar = h.this;
            Objects.requireNonNull(jVar);
            this.f41327b = hVar.e(new Runnable() { // from class: p0.g
        ...
        public void clear() {
            ...
            h.this.setBrightness(this.f41326a);
        }
    }
    ...
    public void setBrightness(float f10) {
        if (this.f41324d == null) {
            ...
            WindowManager.LayoutParams attributes = this.f41324d.getAttributes();
            attributes.screenBrightness = f10;
            this.f41324d.setAttributes(attributes);
    ...
    public class b implements Animator.AnimatorListener {
        ...
        /* renamed from: a  reason: collision with root package name */
        final /* synthetic */ Runnable f41329a;

        b(Runnable runnable) {
            this.f41329a = runnable;
        }

        @Override // android.animation.Animator.AnimatorListener
        public void onAnimationEnd(Animator animator) {
            y0.a("ScreenFlashView", "ScreenFlash#apply: onAnimationEnd");
            Runnable runnable = this.f41329a;
            if (runnable != null) {
                runnable.run();
            }
        }
