...
public abstract class b {
    ...
    private final ConnectivityManager f24424a;

    /* renamed from: b  reason: collision with root package name */
    private final WifiManager f24425b;

    /* renamed from: c  reason: collision with root package name */
    private final TelephonyManager f24426c;

    /* renamed from: d  reason: collision with root package name */
    private final ReactApplicationContext f24427d;

    /* renamed from: e  reason: collision with root package name */
    public boolean f24428e = false;

    /* renamed from: f  reason: collision with root package name */
    private hm.b f24429f = hm.b.UNKNOWN;

    /* renamed from: g  reason: collision with root package name */
    private hm.a f24430g = null;

    /* renamed from: h  reason: collision with root package name */
    private boolean f24431h = false;
    ...
    public b(ReactApplicationContext reactApplicationContext) {
        this.f24427d = reactApplicationContext;
        this.f24424a = (ConnectivityManager) reactApplicationContext.getSystemService("connectivity");
        this.f24425b = (WifiManager) reactApplicationContext.getApplicationContext().getSystemService("wifi");
        this.f24426c = (TelephonyManager) reactApplicationContext.getSystemService("phone");
    }
    ...
    private WritableMap b(String str) {
        ...
        switch (c10) {
            case 0:
                ...
                break;
            case 1:
                hm.a aVar = this.f24430g;
                if (aVar != null) {
                    createMap.putString("cellularGeneration", aVar.f26354d);
                }
                String networkOperatorName = this.f24426c.getNetworkOperatorName();
                ...
                break;
            case 2:
                if (d.b(e()) && (wifiManager = this.f24425b) != null && (connectionInfo = wifiManager.getConnectionInfo()) != null) {
                    try {
    ...
    protected WritableMap a(String str) {
        ...
        boolean z12 = false;
        if (d.b(e())) {
            WifiManager wifiManager = this.f24425b;
            if (wifiManager != null) {
        ...
        if (str != null) {
            ...
            str2 = this.f24429f.f26364d;
        }
        createMap.putString("type", str2);
        boolean z13 = true;
        if (!this.f24429f.equals(hm.b.NONE) && !this.f24429f.equals(hm.b.UNKNOWN)) {
            z10 = true;
        } else {
            z10 = false;
        }
        createMap.putBoolean("isConnected", z10);
        if (this.f24431h && (str == null || str.equals(this.f24429f.f26364d))) {
            z12 = true;
        }
        createMap.putBoolean("isInternetReachable", z12);
        if (str == null) {
            str = this.f24429f.f26364d;
        }
    ...
    public void i(boolean z10) {
        this.f24432i = Boolean.valueOf(z10);
        k(this.f24429f, this.f24430g, this.f24431h);
    }

    public abstract void j();

    /* JADX INFO: Access modifiers changed from: package-private */
    public void k(hm.b bVar, hm.a aVar, boolean z10) {
        boolean z11;
        boolean z12;
        Boolean bool = this.f24432i;
        if (bool != null) {
            z10 = bool.booleanValue();
        }
        boolean z13 = false;
        if (bVar != this.f24429f) {
            z11 = true;
        } else {
            z11 = false;
        }
        if (aVar != this.f24430g) {
            z12 = true;
        } else {
            z12 = false;
        }
