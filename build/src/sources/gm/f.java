...
public class f extends b {
    ...
    private final a f24434j;

    /* renamed from: k  reason: collision with root package name */
    private Network f24435k;

    /* renamed from: l  reason: collision with root package name */
    private NetworkCapabilities f24436l;

    /* loaded from: /home/runner/work/discord-client-datamining/discord-client-datamining/build/classes4.dex */
    private class a extends ConnectivityManager.NetworkCallback {
        @Override // android.net.ConnectivityManager.NetworkCallback
        public void onAvailable(Network network) {
            f.this.f24435k = network;
        ...
        public void onCapabilitiesChanged(Network network, NetworkCapabilities networkCapabilities) {
            f.this.f24435k = network;
            f.this.f24436l = networkCapabilities;
            f.this.s();
        }

        @Override // android.net.ConnectivityManager.NetworkCallback
        public void onLinkPropertiesChanged(Network network, LinkProperties linkProperties) {
            if (f.this.f24435k != null) {
                f.this.f24435k = network;
            }
            f.this.q(h.DEFAULT_SWIPE_ANIMATION_DURATION);
        }
    ...
    public /* synthetic */ void r() {
        try {
            this.f24436l = c().getNetworkCapabilities(this.f24435k);
            s();
    ...
    public void g() {
        try {
            this.f24435k = c().getActiveNetwork();
            q(0);
            c().registerDefaultNetworkCallback(this.f24434j);
        } catch (SecurityException unused) {
        }
    }
    ...
    public void j() {
        try {
            c().unregisterNetworkCallback(this.f24434j);
    ...
    */
    void s() {
        /*
            r10 = this;
            hm.b r0 = hm.b.UNKNOWN
            android.net.Network r1 = r10.f24435k
            android.net.NetworkCapabilities r2 = r10.f24436l
            r3 = 0
            r4 = 0
            if (r2 == 0) goto L9a
            r5 = 2
            ...
            r7 = 1
            if (r5 == 0) goto L16
            hm.b r0 = hm.b.BLUETOOTH
            goto L3a
        L16:
            boolean r5 = r2.hasTransport(r4)
            if (r5 == 0) goto L1f
            hm.b r0 = hm.b.CELLULAR
            goto L3a
        L1f:
            r5 = 3
            boolean r5 = r2.hasTransport(r5)
            if (r5 == 0) goto L29
            hm.b r0 = hm.b.ETHERNET
            goto L3a
        L29:
        ...
        L9c:
            ...
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: gm.f.s():void");
    }
}
