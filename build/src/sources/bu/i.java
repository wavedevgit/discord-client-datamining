...
public final class i implements CookieJar {
    ...
    private final CookieHandler f7119c;

    public i(CookieHandler cookieHandler) {
        Intrinsics.checkNotNullParameter(cookieHandler, "cookieHandler");
        this.f7119c = cookieHandler;
    }
    ...
    private final List a(HttpUrl httpUrl, String str) {
        ...
        int i10 = 0;
        while (i10 < length) {
            int q10 = cu.e.q(str, ";,", i10, length);
            int p10 = cu.e.p(str, '=', i10, q10);
            String Z = cu.e.Z(str, i10, p10);
            if (!StringsKt.P(Z, "$", false, 2, null)) {
                if (p10 < q10) {
                    str2 = cu.e.Z(str, p10 + 1, q10);
                } else {
                    str2 = "";
                }
    ...
    public List loadForRequest(HttpUrl url) {
        ...
        try {
            Map<String, List<String>> cookieHeaders = this.f7119c.get(url.t(), o0.i());
    ...
    public void saveFromResponse(HttpUrl url, List cookies) {
        ...
        while (it.hasNext()) {
            arrayList.add(cu.b.a((Cookie) it.next(), true));
        }
        try {
