...
public class e0 extends r {
    ...
    private static String a(x xVar, p pVar) {
        return "Cannot find any rule for chronological element \"" + pVar.name() + "\" in: " + xVar.q().getName();
    }

    private static String b(x xVar, Object obj) {
        return "Cannot find any rule for chronological unit \"" + c(obj) + "\" in: " + xVar.q().getName();
    }
