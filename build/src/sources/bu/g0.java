...
public final class g0 implements v {
    ...
    private final p f7809e;

    /* renamed from: i  reason: collision with root package name */
    private final Object f7810i;
    ...
    private q m(q qVar, boolean z10) {
        if (qVar instanceof k0) {
            return (q) qVar.w().q().cast(a((k0) k0.class.cast(qVar), this.f7809e, z10));
        }
        throw new r("Base units not supported by: " + qVar.w().q());
    }
    ...
    private q q(q qVar, p pVar) {
        z D = qVar.w().D(pVar);
        return (q) D.x(qVar, D.m(qVar), pVar.k());
    }

    private q r(q qVar, p pVar) {
        z D = qVar.w().D(pVar);
        return (q) D.x(qVar, D.q(qVar), pVar.k());
    }
    ...
    public q apply(q qVar) {
        switch (this.f7808d) {
            case 0:
                return p(qVar, this.f7809e, this.f7810i, false);
            case 1:
                return k(qVar, this.f7809e);
            case 2:
                return i(qVar, this.f7809e);
            case 3:
                return g(qVar, this.f7809e);
            case 4:
                return e(qVar, this.f7809e);
            case 5:
                return p(qVar, this.f7809e, this.f7810i, true);
            case 6:
                return m(qVar, false);
            case 7:
                return m(qVar, true);
            default:
                throw new UnsupportedOperationException("Unknown mode: " + this.f7808d);
        }
    }
