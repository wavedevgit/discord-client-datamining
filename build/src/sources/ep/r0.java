...
public final class r0 implements Parcelable {
    ...
    private final long f23363i;

    /* renamed from: o  reason: collision with root package name */
    private final boolean f23364o;

    /* renamed from: p  reason: collision with root package name */
    public static final a f23359p = new a(null);
    @NotNull
    public static final Parcelable.Creator<r0> CREATOR = new b();

    /* renamed from: q  reason: collision with root package name */
    private static final r0 f23360q = new r0(false, false, 0, false, 15, null);
    ...
    public boolean equals(Object obj) {
        ...
        r0 r0Var = (r0) obj;
        if (this.f23361d == r0Var.f23361d && this.f23362e == r0Var.f23362e && this.f23363i == r0Var.f23363i && this.f23364o == r0Var.f23364o) {
            return true;
        }
        return false;
    }
    ...
    public int hashCode() {
        return (((((Boolean.hashCode(this.f23361d) * 31) + Boolean.hashCode(this.f23362e)) * 31) + Long.hashCode(this.f23363i)) * 31) + Boolean.hashCode(this.f23364o);
    }
    ...
    public final void writeToParcel(Parcel dest, int i10) {
        ...
        dest.writeInt(this.f23361d ? 1 : 0);
        dest.writeInt(this.f23362e ? 1 : 0);
        dest.writeLong(this.f23363i);
        dest.writeInt(this.f23364o ? 1 : 0);
    }
