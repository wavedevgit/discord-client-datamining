...
public final class b implements ViewBinding {
    ...
    private final CoordinatorLayout f23079a;

    /* renamed from: b  reason: collision with root package name */
    public final WorkflowViewStub f23080b;

    /* renamed from: c  reason: collision with root package name */
    public final FloatingActionButton f23081c;
    ...
    private b(CoordinatorLayout coordinatorLayout, WorkflowViewStub workflowViewStub, FloatingActionButton floatingActionButton) {
        this.f23079a = coordinatorLayout;
        this.f23080b = workflowViewStub;
        this.f23081c = floatingActionButton;
    }

    public static b a(View view) {
        int i10 = dp.a.f22033a;
    ...
    public static b c(LayoutInflater layoutInflater, ViewGroup viewGroup, boolean z10) {
        View inflate = layoutInflater.inflate(dp.b.f22038b, viewGroup, false);
        if (z10) {
