...
public abstract class m1 {
    ...
    public static final String a(a1.b bVar) {
        ...
        int i10 = a.f23267a[bVar.ordinal()];
        if (i10 != 1) {
            if (i10 != 2) {
                if (i10 == 3) {
    ...
    public static final Object b(mn.y0 y0Var, op.c sdkFilesManager) {
    ...
    public static final a1.b c(NextStep.Selfie.SelfiePose selfiePose) {
        ...
        int i10 = a.f23268b[selfiePose.ordinal()];
        if (i10 != 1) {
            if (i10 != 2) {
                if (i10 == 3) {
                    return a1.b.f23014i;
    ...
    public static final a1.b d(mn.y0 y0Var) {
        Intrinsics.checkNotNullParameter(y0Var, "<this>");
