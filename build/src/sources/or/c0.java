...
public final class c0 implements Collection, KMappedMarker {
    ...
    public static final class a implements Iterator, KMappedMarker {
        ...
        public long a() {
            ...
            long[] jArr = this.f44207d;
            if (i10 < jArr.length) {
                this.f44208e = i10 + 1;
                return b0.d(jArr[i10]);
            }
            throw new NoSuchElementException(String.valueOf(this.f44208e));
        }

        @Override // java.util.Iterator
        public boolean hasNext() {
            if (this.f44208e < this.f44207d.length) {
                return true;
            }
            return false;
        }
    ...
    */
    public static boolean g(long[] r4, java.util.Collection r5) {
        ...
        L16:
            ...
            boolean r2 = r0 instanceof or.b0
            if (r2 == 0) goto L31
            or.b0 r0 = (or.b0) r0
            long r2 = r0.h()
        ...
        L33:
            return r1
        */
        throw new UnsupportedOperationException("Method not decompiled: or.c0.g(long[], java.util.Collection):boolean");
    }

    public static boolean h(long[] jArr, Object obj) {
        if (!(obj instanceof c0) || !Intrinsics.areEqual(jArr, ((c0) obj).s())) {
            return false;
        }
        return true;
    }
    ...
    public static Iterator p(long[] jArr) {
        return new a(jArr);
    }
    ...
    public boolean containsAll(Collection elements) {
        ...
        return g(this.f44206d, elements);
    }

    public boolean e(long j10) {
        return f(this.f44206d, j10);
    }

    @Override // java.util.Collection
    public boolean equals(Object obj) {
        return h(this.f44206d, obj);
    }

    @Override // java.util.Collection
    public int hashCode() {
        return n(this.f44206d);
    }

    @Override // java.util.Collection
    public boolean isEmpty() {
        return o(this.f44206d);
    }

    @Override // java.util.Collection, java.lang.Iterable
    public Iterator iterator() {
        return p(this.f44206d);
    }

    @Override // java.util.Collection
    /* renamed from: j */
    public int size() {
        return l(this.f44206d);
    }
