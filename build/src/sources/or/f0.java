...
public final class f0 implements Collection, KMappedMarker {
    ...
    public static final class a implements Iterator, KMappedMarker {
        ...
        public short a() {
            int i10 = this.f44219e;
            short[] sArr = this.f44218d;
            if (i10 < sArr.length) {
                this.f44219e = i10 + 1;
                return e0.d(sArr[i10]);
            }
            throw new NoSuchElementException(String.valueOf(this.f44219e));
        }

        @Override // java.util.Iterator
        public boolean hasNext() {
            if (this.f44219e < this.f44218d.length) {
                return true;
            }
            return false;
        }
    ...
    */
    public static boolean g(short[] r3, java.util.Collection r4) {
        ...
        L16:
            ...
            boolean r2 = r0 instanceof or.e0
            if (r2 == 0) goto L31
            or.e0 r0 = (or.e0) r0
            short r0 = r0.h()
        ...
        L33:
            return r1
        */
        throw new UnsupportedOperationException("Method not decompiled: or.f0.g(short[], java.util.Collection):boolean");
    }

    public static boolean h(short[] sArr, Object obj) {
        if (!(obj instanceof f0) || !Intrinsics.areEqual(sArr, ((f0) obj).s())) {
            return false;
        }
        return true;
    }
    ...
    public boolean containsAll(Collection elements) {
        ...
        return g(this.f44217d, elements);
    }

    public boolean e(short s10) {
        return f(this.f44217d, s10);
    }

    @Override // java.util.Collection
    public boolean equals(Object obj) {
        return h(this.f44217d, obj);
    }

    @Override // java.util.Collection
    public int hashCode() {
        return n(this.f44217d);
    }

    @Override // java.util.Collection
    public boolean isEmpty() {
        return o(this.f44217d);
    }

    @Override // java.util.Collection, java.lang.Iterable
    public Iterator iterator() {
        return p(this.f44217d);
    }

    @Override // java.util.Collection
    /* renamed from: j */
    public int size() {
        return l(this.f44217d);
    }
