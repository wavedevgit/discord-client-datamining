...
public abstract class s0 implements KSerializer {
    ...
    private final KSerializer f50064a;

    /* renamed from: b  reason: collision with root package name */
    private final KSerializer f50065b;
    ...
    public void serialize(Encoder encoder, Object obj) {
        ...
        b10.k(getDescriptor(), 0, this.f50064a, a(obj));
        b10.k(getDescriptor(), 1, this.f50065b, c(obj));
        b10.c(getDescriptor());
    }

    private s0(KSerializer kSerializer, KSerializer kSerializer2) {
        this.f50064a = kSerializer;
        this.f50065b = kSerializer2;
    }
}
