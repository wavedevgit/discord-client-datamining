...
public final class i {
    ...
    private void a(CharSequence charSequence, s sVar, rt.d dVar, t tVar, boolean z10) {
        s sVar2;
        int f10 = sVar.f();
        try {
            sVar2 = sVar;
    ...
    private static h w(h hVar, rt.p pVar) {
        ...
        if (hVar.getElement().getType() != pVar.getType() && !(pVar instanceof ut.a)) {
    ...
    */
    public void q(java.lang.CharSequence r9, tt.s r10, rt.d r11, tt.t r12, boolean r13) {
        /*
            r8 = this;
            if (r13 == 0) goto L6
            rt.d r11 = r8.f51035e
        ...
        L9a:
            ...
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: tt.i.q(java.lang.CharSequence, tt.s, rt.d, tt.t, boolean):void");
    }

    /* JADX INFO: Access modifiers changed from: package-private */
    public int r(rt.o oVar, Appendable appendable, rt.d dVar, Set set, boolean z10) {
        rt.d e10;
        StringBuilder sb2;
        int i10;
