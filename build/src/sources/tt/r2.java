...
public abstract class r2 implements Encoder, CompositeEncoder {
    ...
    private final ArrayList f50631a = new ArrayList();
    ...
    @Override // kotlinx.serialization.encoding.Encoder
    public abstract void B(qt.o oVar, Object obj);
    ...
    public void H(qt.o oVar, Object obj) {
    ...
    protected final Object X() {
        return CollectionsKt.z0(this.f50631a);
    }

    /* JADX INFO: Access modifiers changed from: protected */
    public final Object Y() {
        return CollectionsKt.B0(this.f50631a);
    }

    protected abstract Object Z(SerialDescriptor serialDescriptor, int i10);

    protected final Object a0() {
        if (!this.f50631a.isEmpty()) {
            ArrayList arrayList = this.f50631a;
    ...
    @Override // kotlinx.serialization.encoding.CompositeEncoder
    public void k(SerialDescriptor descriptor, int i10, qt.o serializer, Object obj) {
        Intrinsics.checkNotNullParameter(descriptor, "descriptor");
