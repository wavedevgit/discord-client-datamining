...
public abstract class d1 extends a {
    ...
    private final KSerializer f49978a;

    /* renamed from: b  reason: collision with root package name */
    private final KSerializer f49979b;
    ...
    public final void h(kotlinx.serialization.encoding.c decoder, int i10, Map builder, boolean z10) {
        ...
        Intrinsics.checkNotNullParameter(decoder, "decoder");
        Intrinsics.checkNotNullParameter(builder, "builder");
        Object c11 = c.a.c(decoder, getDescriptor(), i10, this.f49978a, null, 8, null);
        if (z10) {
        ...
        int i12 = i11;
        if (builder.containsKey(c11) && !(this.f49979b.getDescriptor().getKind() instanceof st.e)) {
            c10 = decoder.y(getDescriptor(), i12, this.f49979b, kotlin.collections.o0.j(builder, c11));
        } else {
            c10 = c.a.c(decoder, getDescriptor(), i12, this.f49979b, null, 8, null);
        }
        builder.put(c11, c10);
    }
    ...
    private d1(KSerializer kSerializer, KSerializer kSerializer2) {
        super(null);
        this.f49978a = kSerializer;
        this.f49979b = kSerializer2;
    }
}
