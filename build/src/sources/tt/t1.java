...
public abstract class t1 {
    ...
    public static final KSerializer d(KClass kClass, KSerializer... args) {
        Intrinsics.checkNotNullParameter(kClass, "<this>");
        Intrinsics.checkNotNullParameter(args, "args");
        return c(ns.a.b(kClass), (KSerializer[]) Arrays.copyOf(args, args.length));
    }
    ...
    */
    private static final kotlinx.serialization.KSerializer h(java.lang.Class r11) {
        ...
        Lae:
            return r1
        */
        throw new UnsupportedOperationException("Method not decompiled: tt.t1.h(java.lang.Class):kotlinx.serialization.KSerializer");
    }

    public static final Map i() {
        Map c10 = kotlin.collections.o0.c();
        c10.put(Reflection.getOrCreateKotlinClass(String.class), rt.a.I(StringCompanionObject.INSTANCE));
        c10.put(Reflection.getOrCreateKotlinClass(Character.TYPE), rt.a.C(CharCompanionObject.INSTANCE));
        c10.put(Reflection.getOrCreateKotlinClass(char[].class), rt.a.d());
        c10.put(Reflection.getOrCreateKotlinClass(Double.TYPE), rt.a.D(DoubleCompanionObject.INSTANCE));
        c10.put(Reflection.getOrCreateKotlinClass(double[].class), rt.a.e());
        c10.put(Reflection.getOrCreateKotlinClass(Float.TYPE), rt.a.E(FloatCompanionObject.INSTANCE));
        c10.put(Reflection.getOrCreateKotlinClass(float[].class), rt.a.f());
        c10.put(Reflection.getOrCreateKotlinClass(Long.TYPE), rt.a.G(LongCompanionObject.INSTANCE));
        c10.put(Reflection.getOrCreateKotlinClass(long[].class), rt.a.i());
        c10.put(Reflection.getOrCreateKotlinClass(as.b0.class), rt.a.x(as.b0.f6054e));
        c10.put(Reflection.getOrCreateKotlinClass(Integer.TYPE), rt.a.F(IntCompanionObject.INSTANCE));
        c10.put(Reflection.getOrCreateKotlinClass(int[].class), rt.a.g());
        c10.put(Reflection.getOrCreateKotlinClass(as.z.class), rt.a.w(as.z.f6102e));
        c10.put(Reflection.getOrCreateKotlinClass(Short.TYPE), rt.a.H(ShortCompanionObject.INSTANCE));
        c10.put(Reflection.getOrCreateKotlinClass(short[].class), rt.a.o());
        c10.put(Reflection.getOrCreateKotlinClass(as.e0.class), rt.a.y(as.e0.f6065e));
        c10.put(Reflection.getOrCreateKotlinClass(Byte.TYPE), rt.a.B(ByteCompanionObject.INSTANCE));
        c10.put(Reflection.getOrCreateKotlinClass(byte[].class), rt.a.c());
        ...
        c10.put(Reflection.getOrCreateKotlinClass(Unit.class), rt.a.z(Unit.f32556a));
        c10.put(Reflection.getOrCreateKotlinClass(Void.class), rt.a.l());
        try {
            c10.put(Reflection.getOrCreateKotlinClass(Duration.class), rt.a.J(Duration.f35555e));
        } catch (ClassNotFoundException | NoClassDefFoundError unused) {
        }
        try {
            c10.put(Reflection.getOrCreateKotlinClass(as.c0.class), rt.a.s());
        } catch (ClassNotFoundException | NoClassDefFoundError unused2) {
        }
        try {
            c10.put(Reflection.getOrCreateKotlinClass(as.a0.class), rt.a.r());
        } catch (ClassNotFoundException | NoClassDefFoundError unused3) {
        }
        try {
            c10.put(Reflection.getOrCreateKotlinClass(as.f0.class), rt.a.t());
        } catch (ClassNotFoundException | NoClassDefFoundError unused4) {
        }
        try {
            c10.put(Reflection.getOrCreateKotlinClass(as.y.class), rt.a.q());
        } catch (ClassNotFoundException | NoClassDefFoundError unused5) {
        }
        try {
            c10.put(Reflection.getOrCreateKotlinClass(xs.a.class), rt.a.K(xs.a.f55717i));
    ...
    public static final boolean l(KClass kClass) {
        Intrinsics.checkNotNullParameter(kClass, "<this>");
        return ns.a.b(kClass).isInterface();
    }

    private static final boolean m(Class cls) {
        if (cls.getAnnotation(qt.m.class) == null && cls.getAnnotation(qt.d.class) == null) {
            return true;
        }
        return false;
    }
    ...
    private static final boolean n(Class cls) {
        if (cls.getAnnotation(qt.d.class) != null) {
            return true;
        }
        qt.m mVar = (qt.m) cls.getAnnotation(qt.m.class);
        if (mVar != null && Intrinsics.areEqual(Reflection.getOrCreateKotlinClass(mVar.with()), Reflection.getOrCreateKotlinClass(qt.g.class))) {
            return true;
        }
        return false;
    }
    ...
    public static final boolean o(KClass rootClass) {
        ...
        return ns.a.b(rootClass).isArray();
    }
    ...
    public static final Void q(Class cls) {
        Intrinsics.checkNotNullParameter(cls, "<this>");
        throw new qt.n(u1.e(ns.a.e(cls)));
    }

    public static final Object[] r(ArrayList arrayList, KClass eClass) {
        Intrinsics.checkNotNullParameter(arrayList, "<this>");
        Intrinsics.checkNotNullParameter(eClass, "eClass");
        Object newInstance = Array.newInstance(ns.a.b(eClass), arrayList.size());
