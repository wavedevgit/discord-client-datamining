...
public final class s {
    ...
    private final List f51102a;

    /* JADX INFO: Access modifiers changed from: package-private */
    public s(String[] strArr) {
        this.f51102a = Collections.unmodifiableList(Arrays.asList(strArr));
    }
        ...
        while (i12 < enumArr.length) {
            ...
            if (isEmpty) {
                if (i12 >= size) {
                    ...
                    str3 = (String) this.f51102a.get(i12);
                }
            }
    ...
    public Enum c(CharSequence charSequence, ParsePosition parsePosition, Class cls, st.d dVar) {
        st.c cVar = a.f51010i;
        Boolean bool = Boolean.TRUE;
        return e(charSequence, parsePosition, cls, ((Boolean) dVar.b(cVar, bool)).booleanValue(), ((Boolean) dVar.b(a.f51011j, Boolean.FALSE)).booleanValue(), ((Boolean) dVar.b(a.f51012k, bool)).booleanValue());
    }
    ...
    public String f(Enum r32) {
        ...
        if (this.f51102a.size() <= ordinal) {
            return r32.name();
        }
        return (String) this.f51102a.get(ordinal);
    }
    ...
    public String toString() {
        ...
        for (int i10 = 0; i10 < size; i10++) {
            ...
            sb2.append((String) this.f51102a.get(i10));
        }
        sb2.append('}');
        return sb2.toString();
    }
