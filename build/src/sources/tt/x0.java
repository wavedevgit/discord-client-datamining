...
public abstract class x0 implements SerialDescriptor {
    ...
    private final SerialDescriptor f50088a;
    ...
    public boolean equals(Object obj) {
        ...
        x0 x0Var = (x0) obj;
        if (Intrinsics.areEqual(this.f50088a, x0Var.f50088a) && Intrinsics.areEqual(h(), x0Var.h())) {
            return true;
        }
        return false;
    }
    ...
    public int hashCode() {
        return (this.f50088a.hashCode() * 31) + h().hashCode();
    }
    ...
    public String toString() {
        return h() + '(' + this.f50088a + ')';
    }

    private x0(SerialDescriptor serialDescriptor) {
        this.f50088a = serialDescriptor;
        this.f50089b = 1;
    }
}
