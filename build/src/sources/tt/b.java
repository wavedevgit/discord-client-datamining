...
public final class b {
    ...
    private static final Set f51030l;

    /* renamed from: m  reason: collision with root package name */
    private static final f f51031m;

    /* renamed from: n  reason: collision with root package name */
    private static final u f51032n;

    /* renamed from: o  reason: collision with root package name */
    private static final u f51033o;

    /* renamed from: p  reason: collision with root package name */
    private static final ConcurrentMap f51034p;

    /* renamed from: a  reason: collision with root package name */
    private final String f51035a;

    /* renamed from: b  reason: collision with root package name */
    private final Map f51036b;

    /* renamed from: c  reason: collision with root package name */
    private final Map f51037c;

    /* renamed from: d  reason: collision with root package name */
    private final Map f51038d;

    /* renamed from: e  reason: collision with root package name */
    private final Map f51039e;

    /* renamed from: f  reason: collision with root package name */
    private final Map f51040f;

    /* renamed from: g  reason: collision with root package name */
    private final Map f51041g;

    /* renamed from: h  reason: collision with root package name */
    private final Map f51042h;

    /* renamed from: i  reason: collision with root package name */
    private final String f51043i;

    /* renamed from: j  reason: collision with root package name */
    private final Locale f51044j;

    /* renamed from: k  reason: collision with root package name */
    private final MissingResourceException f51045k;
    ...
    public static /* synthetic */ class a {
        ...
        /* renamed from: a  reason: collision with root package name */
        static final /* synthetic */ int[] f51046a;

        /* renamed from: b  reason: collision with root package name */
        static final /* synthetic */ int[] f51047b;
        ...
        static {
            ...
            try {
                f51047b[e.LONG.ordinal()] = 2;
            } catch (NoSuchFieldError unused2) {
            }
            try {
                f51047b[e.MEDIUM.ordinal()] = 3;
            } catch (NoSuchFieldError unused3) {
            }
            try {
                f51047b[e.SHORT.ordinal()] = 4;
            ...
            try {
                f51046a[v.ABBREVIATED.ordinal()] = 2;
            } catch (NoSuchFieldError unused6) {
            }
            try {
                f51046a[v.SHORT.ordinal()] = 3;
            } catch (NoSuchFieldError unused7) {
            }
            try {
                f51046a[v.NARROW.ordinal()] = 4;
    ...
    /* loaded from: /home/runner/work/discord-client-datamining/discord-client-datamining/build/classes5.dex */
    private static class C0705b implements u {
        private C0705b() {
        }
    ...
    private static class c implements f {
        ...
        private static int c(e eVar) {
            int i10 = a.f51047b[eVar.ordinal()];
            if (i10 != 1) {
                if (i10 == 2) {
                    return 1;
                }
        ...
        public String f(e eVar, e eVar2, Locale locale) {
            ...
            return this.f51048a.f(eVar, eVar2, locale).replace("{1}", this.f51048a.b(eVar, locale)).replace("{0}", fVar.g(eVar2, locale));
        }
        ...
        public String g(e eVar, Locale locale) {
            ...
            } else if (fVar instanceof vt.c) {
                g10 = ((vt.c) vt.c.class.cast(fVar)).d(eVar, locale, true);
            } else {
    ...
    private static class d implements u {
        ...
        public String[] a(String str, Locale locale, v vVar, m mVar, boolean z10) {
            ...
            int i10 = a.f51046a[vVar.ordinal()];
            if (i10 != 1) {
                if (i10 != 2 && i10 != 3) {
                    if (i10 == 4) {
        ...
        public String[] e(String str, Locale locale, v vVar, m mVar) {
            ...
            if (i10 != 1) {
                if (i10 != 2 && i10 != 3) {
                    if (i10 == 4) {
                        weekdays = b(e("", locale, v.SHORT, mVar), 7);
                    } else {
    ...
    static {
        ...
        hashSet.add("ur");
        hashSet.add("yi");
        f51030l = Collections.unmodifiableSet(hashSet);
        Iterator it = qt.d.c().g(f.class).iterator();
        if (it.hasNext()) {
            cVar = (f) it.next();
        } else {
            cVar = new yt.c();
        ...
        f51031m = new c(cVar);
        f51032n = new d(null);
        f51033o = new C0705b(null);
        f51034p = new ConcurrentHashMap();
    }

    private b(String str, Locale locale, u uVar) {
        v[] values;
        this.f51035a = uVar.toString();
        int i10 = 0;
        Map unmodifiableMap = Collections.unmodifiableMap(i(str, locale, uVar, false));
        this.f51036b = unmodifiableMap;
        Map i11 = i(str, locale, uVar, true);
        if (i11 == null) {
            this.f51037c = unmodifiableMap;
        } else {
            this.f51037c = Collections.unmodifiableMap(i11);
        }
        ...
        this.f51038d = Collections.unmodifiableMap(enumMap);
        ...
        this.f51040f = Collections.unmodifiableMap(enumMap6);
        HashMap hashMap = new HashMap();
        try {
            yt.e h10 = yt.e.h("calendar/names/" + str + "/" + str, locale);
        ...
        this.f51042h = Collections.unmodifiableMap(hashMap);
        this.f51043i = str;
        this.f51044j = locale;
        this.f51045k = e;
    }
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    public static String a(st.x xVar) {
        tt.c cVar = (tt.c) xVar.n().getAnnotation(tt.c.class);
        if (cVar == null) {
            return "iso8601";
        }
        return cVar.value();
    ...
    public static b c(String str, Locale locale) {
        ...
        if (str != null) {
            ...
            b bVar = (b) f51034p.get(sb3);
            if (bVar == null) {
                if (locale.getLanguage().isEmpty() && str.equals("iso8601")) {
                    uVar = f51033o;
                } else {
                    Iterator it = qt.d.c().g(u.class).iterator();
                    while (true) {
                        if (it.hasNext()) {
                            u uVar2 = (u) it.next();
                ...
                b bVar3 = (b) f51034p.putIfAbsent(sb3, bVar2);
                if (bVar3 != null) {
                    return bVar3;
                }
                return bVar2;
    ...
    private String e(String str) {
        if (this.f51042h.containsKey("useShortKeys") && "true".equals(this.f51042h.get("useShortKeys"))) {
    ...
    private static Map i(String str, Locale locale, u uVar, boolean z10) {
        ...
        for (v vVar : v.values()) {
            EnumMap enumMap2 = new EnumMap(m.class);
            for (m mVar : m.values()) {
                String[] a10 = uVar.a(str, locale, vVar, mVar, z10);
                if (z10 && !z11) {
                    z11 = !Arrays.equals(uVar.a(str, locale, vVar, mVar, false), a10);
                }
                enumMap2.put((EnumMap) mVar, (m) new s(a10));
            }
            enumMap.put((EnumMap) vVar, (v) enumMap2);
        }
        if (z10 && !z11) {
    ...
    private s j(v vVar, m mVar, boolean z10) {
        if (z10) {
            return (s) ((Map) this.f51037c.get(vVar)).get(mVar);
        }
        return (s) ((Map) this.f51036b.get(vVar)).get(mVar);
    }

    public static boolean q(Locale locale) {
        return f51030l.contains(locale.getLanguage());
    }

    public static String r(e eVar, Locale locale) {
        return f51031m.b(eVar, locale);
    }

    public static String s(e eVar, e eVar2, Locale locale) {
        return f51031m.f(eVar, eVar2, locale);
    }

    public static String t(e eVar, Locale locale) {
        return f51031m.g(eVar, locale);
    }

    public static String u(e eVar, e eVar2, Locale locale) {
        return vt.d.a(f51031m.f(eVar, eVar2, locale));
    }
    ...
    public s b(v vVar) {
        return (s) this.f51041g.get(vVar);
    }
    ...
    public s h(v vVar, m mVar) {
        return (s) ((Map) this.f51040f.get(vVar)).get(mVar);
    }

    public s k(v vVar, m mVar) {
        return (s) ((Map) this.f51038d.get(vVar)).get(mVar);
    }
    ...
    public s n(String str, Class cls, String... strArr) {
        ...
        if (this.f51045k == null) {
            ...
            String e10 = e(str);
            int i10 = !st.i.class.isAssignableFrom(cls) ? 1 : 0;
            for (int i11 = 0; i11 < length; i11++) {
                ...
                while (true) {
                    ...
                    if (f10 != null) {
                        str2 = v(f10, i11, i10);
                        if (this.f51042h.containsKey(str2)) {
                            break;
                        }
                        i12++;
                    } else {
                ...
                if (str2 == null) {
                    if (this.f51042h.containsKey(str)) {
                        strArr2[i11] = (String) this.f51042h.get(str);
                    } else {
                        strArr2[i11] = enumArr[i11].name();
                    }
                } else {
                    strArr2[i11] = (String) this.f51042h.get(str2);
                }
            }
            return new s(strArr2);
        }
        throw new MissingResourceException(this.f51045k.getMessage(), this.f51045k.getClassName(), this.f51045k.getKey());
    }

    public s o(st.p pVar, String... strArr) {
        return n(pVar.name(), pVar.getType(), strArr);
    }

    public s p(v vVar, m mVar) {
        return (s) ((Map) this.f51039e.get(vVar)).get(mVar);
    }

    public String toString() {
        return this.f51035a + "(" + this.f51043i + "/" + this.f51044j + ")";
    }
}
