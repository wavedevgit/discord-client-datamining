...
final class q implements s1 {
    ...
    private final Function2 f50624a;

    /* renamed from: b  reason: collision with root package name */
    private final r f50625b;
    ...
    public Object a(KClass key, List types) {
        ...
        Object obj = this.f50625b.get(ns.a.b(key));
        ...
        concurrentHashMap = r1Var.f50630a;
        Object obj3 = concurrentHashMap.get(arrayList);
        if (obj3 == null) {
            try {
                Result.a aVar = Result.f32553e;
                b10 = Result.b((KSerializer) this.f50624a.invoke(key, types));
            } catch (Throwable th2) {
