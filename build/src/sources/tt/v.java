...
final class v implements s1 {
    ...
    private final Function2 f50645a;

    /* renamed from: b  reason: collision with root package name */
    private final ConcurrentHashMap f50646b;

    public v(Function2 compute) {
        Intrinsics.checkNotNullParameter(compute, "compute");
        this.f50645a = compute;
        this.f50646b = new ConcurrentHashMap();
    }
    ...
    public Object a(KClass key, List types) {
        ...
        ConcurrentHashMap concurrentHashMap2 = this.f50646b;
        ...
        if (obj2 == null) {
            try {
                ...
                b10 = Result.b((KSerializer) this.f50645a.invoke(key, types));
            } catch (Throwable th2) {
