...
final class v implements s1 {
    ...
    private final Function2 f50077a;

    /* renamed from: b  reason: collision with root package name */
    private final ConcurrentHashMap f50078b;

    public v(Function2 compute) {
        Intrinsics.checkNotNullParameter(compute, "compute");
        this.f50077a = compute;
        this.f50078b = new ConcurrentHashMap();
    }
    ...
    public Object a(KClass key, List types) {
        ...
        ConcurrentHashMap concurrentHashMap2 = this.f50078b;
        Class b11 = ns.a.b(key);
        ...
        if (obj2 == null) {
            try {
                ...
                b10 = Result.b((KSerializer) this.f50077a.invoke(key, types));
            } catch (Throwable th2) {
