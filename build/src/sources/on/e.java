...
public final class e {
    ...
    private final on.l f44476b;

    /* renamed from: c  reason: collision with root package name */
    private final Camera2PreviewView f44477c;

    /* renamed from: d  reason: collision with root package name */
    private final on.b f44478d;

    /* renamed from: e  reason: collision with root package name */
    private final sn.a f44479e;

    /* renamed from: f  reason: collision with root package name */
    private final boolean f44480f;

    /* renamed from: g  reason: collision with root package name */
    private final rn.a f44481g;

    /* renamed from: h  reason: collision with root package name */
    private final op.c f44482h;

    /* renamed from: i  reason: collision with root package name */
    private final v f44483i;

    /* renamed from: j  reason: collision with root package name */
    private final CoroutineScope f44484j;

    /* renamed from: k  reason: collision with root package name */
    private final String f44485k;

    /* renamed from: l  reason: collision with root package name */
    private final CameraManager f44486l;

    /* renamed from: m  reason: collision with root package name */
    private final CameraCharacteristics f44487m;

    /* renamed from: n  reason: collision with root package name */
    private final int f44488n;

    /* renamed from: o  reason: collision with root package name */
    private final r f44489o;

    /* renamed from: p  reason: collision with root package name */
    private CameraDevice f44490p;

    /* renamed from: q  reason: collision with root package name */
    private final HandlerThread f44491q;

    /* renamed from: r  reason: collision with root package name */
    private final Handler f44492r;

    /* renamed from: s  reason: collision with root package name */
    private on.k f44493s;

    /* renamed from: t  reason: collision with root package name */
    private volatile boolean f44494t;

    /* renamed from: u  reason: collision with root package name */
    private volatile boolean f44495u;

    /* renamed from: v  reason: collision with root package name */
    private volatile boolean f44496v;

    /* renamed from: w  reason: collision with root package name */
    private volatile boolean f44497w;

    /* renamed from: x  reason: collision with root package name */
    private final MutableStateFlow f44498x;

    /* renamed from: y  reason: collision with root package name */
    private final MutableStateFlow f44499y;

    /* renamed from: z  reason: collision with root package name */
    private final j0 f44500z;
    ...
    public interface d {
        ...
        public static final class c implements d {
            ...
            public boolean equals(Object obj) {
                ...
                if ((obj instanceof c) && Intrinsics.areEqual(this.f44506a, ((c) obj).f44506a)) {
                    return true;
                }
                return false;
            }
        ...
        public static final class C0545d implements d {
            ...
            /* renamed from: a  reason: collision with root package name */
            public static final C0545d f44507a = new C0545d();
    ...
    public static final class C0546e extends kotlin.coroutines.jvm.internal.k implements Function2 {
        ...
        public final Object invokeSuspend(Object obj) {
            ...
            if (this.f44508d == 0) {
                kotlin.c.b(obj);
                Object value = e.this.f44499y.getValue();
                d.b bVar = d.b.f44505a;
                if (Intrinsics.areEqual(value, bVar)) {
                    return Unit.f33298a;
                }
                e.this.f44499y.setValue(bVar);
                e.this.J().getHolder().removeCallback(e.this.B);
                e.this.F.block(2000L);
                e.this.f44489o.f();
                e.this.D.close();
                on.k kVar = e.this.f44493s;
                if (kVar != null) {
                    kVar.e();
                }
                e.this.f44493s = null;
                CameraDevice cameraDevice = e.this.f44490p;
                if (cameraDevice != null) {
                    cameraDevice.close();
                }
                e.this.f44490p = null;
                e.this.f44481g.b();
                kotlinx.coroutines.i.f(e.this.f44484j, null, 1, null);
                return Unit.f33298a;
            }
            throw new IllegalStateException("call to 'resume' before 'invoke' with coroutine");
        }
        ...
        @Override // kotlin.jvm.functions.Function2
        public final Object invoke(CoroutineScope coroutineScope, Continuation continuation) {
            return ((C0546e) create(coroutineScope, continuation)).invokeSuspend(Unit.f33298a);
        }
    }
    ...
    public static final class g extends CameraDevice.StateCallback {
        ...
        /* renamed from: a  reason: collision with root package name */
        final /* synthetic */ CancellableContinuation f44513a;

        /* renamed from: b  reason: collision with root package name */
        final /* synthetic */ e f44514b;

        /* renamed from: c  reason: collision with root package name */
        final /* synthetic */ String f44515c;

        g(CancellableContinuation cancellableContinuation, e eVar, String str) {
            this.f44513a = cancellableContinuation;
            this.f44514b = eVar;
            this.f44515c = str;
        }
        ...
        public void onError(CameraDevice device, int i10) {
            ...
            String str2 = this.f44515c;
            RuntimeException runtimeException = new RuntimeException("Camera " + str2 + " error: (" + i10 + ") " + str);
            if (this.f44513a.a()) {
                CancellableContinuation cancellableContinuation = this.f44513a;
        ...
        public void onOpened(CameraDevice device) {
            Intrinsics.checkNotNullParameter(device, "device");
            this.f44513a.resumeWith(Result.b(device));
        }
    }
    ...
    public static final class i extends kotlin.coroutines.jvm.internal.k implements Function2 {
        ...
        public static final class a extends kotlin.coroutines.jvm.internal.k implements Function2 {
            ...
            public static final class C0547a extends kotlin.coroutines.jvm.internal.k implements Function2 {
                ...
                @Override // kotlin.coroutines.jvm.internal.a
                public final Continuation create(Object obj, Continuation continuation) {
                    return new C0547a(this.f44524e, continuation);
                }

                @Override // kotlin.coroutines.jvm.internal.a
                public final Object invokeSuspend(Object obj) {
                    Object f10 = or.b.f();
                    int i10 = this.f44523d;
                    if (i10 != 0) {
                        if (i10 == 1) {
                            kotlin.c.b(obj);
                            return obj;
                    ...
                    kotlin.c.b(obj);
                    Flow r10 = js.g.r(this.f44524e.f44498x);
                    this.f44523d = 1;
                ...
                @Override // kotlin.jvm.functions.Function2
                public final Object invoke(CoroutineScope coroutineScope, Continuation continuation) {
                    return ((C0547a) create(coroutineScope, continuation)).invokeSuspend(Unit.f33298a);
                }
            }
            ...
            @Override // kotlin.coroutines.jvm.internal.a
            public final Continuation create(Object obj, Continuation continuation) {
                return new a(this.f44522e, continuation);
            }
            ...
            public final Object invokeSuspend(Object obj) {
                ...
                kotlin.c.b(obj);
                CoroutineContext coroutineContext = this.f44522e.f44484j.getCoroutineContext();
                C0547a c0547a = new C0547a(this.f44522e, null);
                this.f44521d = 1;
    ...
    public static final class j implements SurfaceHolder.Callback {
        ...
        public static final class a extends kotlin.coroutines.jvm.internal.k implements Function2 {
            ...
            @Override // kotlin.coroutines.jvm.internal.a
            public final Continuation create(Object obj, Continuation continuation) {
                return new a(this.f44527e, continuation);
            }
        ...
        static final class b extends kotlin.coroutines.jvm.internal.k implements Function2 {
            ...
            @Override // kotlin.coroutines.jvm.internal.a
            public final Continuation create(Object obj, Continuation continuation) {
                return new b(this.f44529e, continuation);
            }
        ...
        public static final void b(e eVar) {
            gs.i.d(eVar.f44484j, null, null, new a(eVar, null), 3, null);
        }
        ...
        public void surfaceCreated(SurfaceHolder holder) {
            Intrinsics.checkNotNullParameter(holder, "holder");
            e.this.f44497w = true;
            e.this.J().b(e.this.f44476b.f().getWidth(), e.this.f44476b.f().getHeight(), e.this.f44488n);
        ...
        public void surfaceDestroyed(SurfaceHolder holder) {
            Intrinsics.checkNotNullParameter(holder, "holder");
            e.this.f44497w = false;
            gs.i.d(e.this.f44484j, null, null, new b(e.this, null), 3, null);
        }
    }
    ...
    public static final class k extends kotlin.coroutines.jvm.internal.k implements Function2 {
        ...
        @Override // kotlin.jvm.functions.Function2
        public final Object invoke(CoroutineScope coroutineScope, Continuation continuation) {
            return ((k) create(coroutineScope, continuation)).invokeSuspend(Unit.f33298a);
        }
    }
    ...
    public static final class l extends kotlin.coroutines.jvm.internal.d {
        ...
        public final Object invokeSuspend(Object obj) {
            this.f44533e = obj;
            this.f44534i |= Integer.MIN_VALUE;
    ...
    public static final class m extends kotlin.coroutines.jvm.internal.d {
        ...
        public final Object invokeSuspend(Object obj) {
            this.f44536e = obj;
            this.f44538o |= Integer.MIN_VALUE;
    ...
    public static final class n extends kotlin.coroutines.jvm.internal.d {
        ...
        public final Object invokeSuspend(Object obj) {
            this.f44539d = obj;
            this.f44541i |= Integer.MIN_VALUE;
    ...
    public e(Context context, on.l cameraChoice, Camera2PreviewView previewView, on.b analyzer, sn.a videoCaptureMethod, lq.a aVar, boolean z10, rn.a cameraStatsManager, op.c sdkFilesManager) {
        ...
        this.f44476b = cameraChoice;
        this.f44477c = previewView;
        this.f44478d = analyzer;
        this.f44479e = videoCaptureMethod;
        this.f44480f = z10;
        this.f44481g = cameraStatsManager;
        this.f44482h = sdkFilesManager;
        this.f44483i = cameraChoice.b();
        ...
        this.f44486l = cameraManager;
        CameraCharacteristics cameraCharacteristics = cameraManager.getCameraCharacteristics(d10);
        Intrinsics.checkNotNullExpressionValue(cameraCharacteristics, "getCameraCharacteristics(...)");
        this.f44487m = cameraCharacteristics;
        Object obj = cameraCharacteristics.get(CameraCharacteristics.SENSOR_ORIENTATION);
        if (obj != null) {
            int intValue = ((Number) obj).intValue();
            this.f44488n = intValue;
            Comparable upper = cameraChoice.g().getUpper();
            Intrinsics.checkNotNullExpressionValue(upper, "getUpper(...)");
            this.f44489o = new r(context, cameraChoice, ((Number) upper).intValue(), intValue, z10);
            HandlerThread handlerThread = new HandlerThread("CameraThread");
            handlerThread.start();
            this.f44491q = handlerThread;
            this.f44492r = new Handler(handlerThread.getLooper());
            this.f44495u = true;
            this.f44498x = l0.a(null);
            MutableStateFlow a11 = l0.a(d.a.f44504a);
            this.f44499y = a11;
            this.f44500z = a11;
            this.C = 1.0f;
            this.D = M();
            this.E = c0.b(0, 1, is.a.f31141d, 1, null);
    ...
    public final ImageReader M() {
        ImageReader newInstance = ImageReader.newInstance((int) (this.f44476b.f().getWidth() * this.C), (int) (this.f44476b.f().getHeight() * this.C), 35, 3);
    ...
    public final void P(Image image) {
        try {
            if (Intrinsics.areEqual(this.f44499y.getValue(), d.b.f44505a)) {
                this.F.open();
                ur.a.a(image, null);
            } else if (!this.f44495u && !this.f44496v) {
                ur.a.a(image, null);
            } else {
                if (this.f44496v) {
                    File R = R(image);
                    if (R != null) {
                        this.f44498x.setValue(Result.a(Result.b(R)));
                    }
                } else if (this.f44495u) {
                    try {
                        this.f44478d.f(image, this.f44488n);
    ...
    private final File R(Image image) {
        Bitmap c10 = mn.m0.c(image, this.f44488n);
        if (c10 == null) {
            return null;
        }
        File c11 = this.f44482h.c("jpg");
    ...
    /* JADX WARN: Code restructure failed: missing block: B:24:0x004d, code lost:
        r4.f44499y.setValue(new on.e.d.c(new on.e.c.a("Unable to initialize Camera2 classes", r5)));
     */
    ...
    */
    public static final java.lang.Object U(on.e r4, kotlin.coroutines.Continuation r5) {
        ...
        L13:
            ...
            r0.<init>(r5)
        L18:
            java.lang.Object r5 = r0.f44533e
            java.lang.Object r1 = or.b.f()
            int r2 = r0.f44534i
            r3 = 1
            if (r2 == 0) goto L37
            if (r2 != r3) goto L2f
            java.lang.Object r4 = r0.f44532d
            on.e r4 = (on.e) r4
        ...
        L37:
            kotlin.c.b(r5)
            r0.f44532d = r4     // Catch: java.lang.Exception -> L2d
            r0.f44534i = r3     // Catch: java.lang.Exception -> L2d
            java.lang.Object r5 = r4.L(r0)     // Catch: java.lang.Exception -> L2d
            if (r5 != r1) goto L45
            return r1
        L45:
            kotlinx.coroutines.flow.MutableStateFlow r5 = r4.f44499y     // Catch: java.lang.Exception -> L2d
            on.e$d$d r0 = on.e.d.C0545d.f44507a     // Catch: java.lang.Exception -> L2d
            r5.setValue(r0)     // Catch: java.lang.Exception -> L2d
            goto L5e
        L4d:
            kotlinx.coroutines.flow.MutableStateFlow r4 = r4.f44499y
    ...
    public static final Unit V(e eVar) {
        if (eVar.f44497w) {
            gs.i.d(eVar.f44484j, null, null, new k(null), 3, null);
        }
        return Unit.f33298a;
    }

    public final void G(boolean z10) {
        on.k kVar = this.f44493s;
        if (kVar != null) {
            kVar.i(z10);
            kVar.l();
        }
    ...
    public final void H() {
        on.k kVar = this.f44493s;
        if (kVar != null) {
            kVar.j(this.f44476b.f().getWidth() / 2, this.f44476b.f().getHeight() / 2, new Size((int) (this.f44476b.f().getWidth() * 0.15d), (int) (this.f44476b.f().getHeight() * 0.15d)), 5000L);
            kVar.l();
        }
    }
    ...
    */
    public final java.lang.Object Q(kotlin.coroutines.Continuation r6) {
        ...
        L13:
            ...
            r0.<init>(r6)
        L18:
            java.lang.Object r6 = r0.f44516d
            java.lang.Object r1 = or.b.f()
            int r2 = r0.f44518i
            r3 = 1
            if (r2 == 0) goto L31
    ...
    public final void T() {
        boolean z10;
        if (this.f44480f && androidx.core.content.a.a(this.f44475a, "android.permission.RECORD_AUDIO") != 0) {
            z10 = true;
        } else {
            z10 = false;
        }
        if (androidx.core.content.a.a(this.f44475a, "android.permission.CAMERA") == 0 && !z10) {
            if (this.A) {
                return;
            }
            this.A = true;
            this.f44497w = false;
            this.B = new j();
            this.f44489o.n(new Function0() { // from class: on.d
            ...
            this.f44477c.a();
            this.f44477c.getHolder().addCallback(this.B);
            this.f44481g.c();
            return;
        }
        this.f44499y.setValue(new d.c(new c.b()));
    }
    ...
    */
    public final java.lang.Object W(kotlin.coroutines.Continuation r5) {
        ...
        L13:
            ...
            r0.<init>(r5)
        L18:
            java.lang.Object r5 = r0.f44536e
            java.lang.Object r1 = or.b.f()
            int r2 = r0.f44538o
            r3 = 1
            if (r2 == 0) goto L37
            if (r2 != r3) goto L2f
            java.lang.Object r0 = r0.f44535d
            on.e r0 = (on.e) r0
        ...
        L37:
            ...
            return r5
        L4a:
            kotlin.Result$a r5 = kotlin.Result.f33295e     // Catch: java.lang.Throwable -> L2d
            on.r r5 = r4.f44489o     // Catch: java.lang.Throwable -> L2d
            r0.f44535d = r4     // Catch: java.lang.Throwable -> L2d
            r0.f44538o = r3     // Catch: java.lang.Throwable -> L2d
        ...
        L59:
            r0 = r4
        L5a:
            r0.f44494t = r3     // Catch: java.lang.Throwable -> L2d
            kotlin.Result$a r5 = kotlin.Result.f33295e     // Catch: java.lang.Throwable -> L2d
            ...
            return r5
        L67:
            kotlin.Result$a r0 = kotlin.Result.f33295e
    ...
    */
    public final java.lang.Object X(kotlin.coroutines.Continuation r5) {
        ...
        L13:
            ...
            r0.<init>(r5)
        L18:
            java.lang.Object r5 = r0.f44539d
            java.lang.Object r1 = or.b.f()
            int r2 = r0.f44541i
            r3 = 1
            if (r2 == 0) goto L31
