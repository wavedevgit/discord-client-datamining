...
public final class k {
    ...
    public static final a f44541j = new a(null);

    /* renamed from: a  reason: collision with root package name */
    private final l f44542a;

    /* renamed from: b  reason: collision with root package name */
    private final List f44543b;

    /* renamed from: c  reason: collision with root package name */
    private final Handler f44544c;

    /* renamed from: d  reason: collision with root package name */
    private final CameraCharacteristics f44545d;

    /* renamed from: e  reason: collision with root package name */
    private final CoroutineScope f44546e;

    /* renamed from: f  reason: collision with root package name */
    private boolean f44547f;

    /* renamed from: g  reason: collision with root package name */
    private MeteringRectangle f44548g;

    /* renamed from: h  reason: collision with root package name */
    private Job f44549h;

    /* renamed from: i  reason: collision with root package name */
    private CameraCaptureSession f44550i;
    ...
    public static final class a {
        ...
        public static final class C0548a extends kotlin.coroutines.jvm.internal.d {
            ...
            public final Object invokeSuspend(Object obj) {
                this.f44553i = obj;
                this.f44555p |= Integer.MIN_VALUE;
        ...
        */
        public final java.lang.Object a(on.l r12, android.hardware.camera2.CameraCharacteristics r13, java.util.List r14, android.hardware.camera2.CameraDevice r15, android.os.Handler r16, kotlin.coroutines.Continuation r17) {
            ...
            L15:
                ...
                r1.<init>(r0)
            L1a:
                java.lang.Object r0 = r1.f44553i
                java.lang.Object r2 = or.b.f()
                int r3 = r1.f44555p
                r4 = 1
                if (r3 == 0) goto L3b
                if (r3 != r4) goto L33
                java.lang.Object r12 = r1.f44552e
                on.k r12 = (on.k) r12
                java.lang.Object r13 = r1.f44551d
                on.k r13 = (on.k) r13
                kotlin.c.b(r0)
                goto L58
            L33:
    ...
    public static final class b extends CameraCaptureSession.StateCallback {
        ...
        /* renamed from: a  reason: collision with root package name */
        final /* synthetic */ Continuation f44556a;

        /* renamed from: b  reason: collision with root package name */
        final /* synthetic */ CameraDevice f44557b;

        b(Continuation continuation, CameraDevice cameraDevice) {
            this.f44556a = continuation;
            this.f44557b = cameraDevice;
        }

        @Override // android.hardware.camera2.CameraCaptureSession.StateCallback
        public void onConfigureFailed(CameraCaptureSession session) {
            Intrinsics.checkNotNullParameter(session, "session");
            String id2 = this.f44557b.getId();
            RuntimeException runtimeException = new RuntimeException("Camera " + id2 + " session configuration failed");
            Continuation continuation = this.f44556a;
        ...
        public void onConfigured(CameraCaptureSession session) {
            Intrinsics.checkNotNullParameter(session, "session");
            this.f44556a.resumeWith(Result.b(session));
        }
    ...
    public static final class c extends kotlin.coroutines.jvm.internal.k implements Function2 {
        ...
        /* renamed from: e  reason: collision with root package name */
        final /* synthetic */ long f44559e;

        /* renamed from: i  reason: collision with root package name */
        final /* synthetic */ k f44560i;
        ...
        public static final class a extends kotlin.coroutines.jvm.internal.k implements Function2 {
            ...
            public final Continuation create(Object obj, Continuation continuation) {
                return new a(this.f44562e, continuation);
            }
        ...
        @Override // kotlin.coroutines.jvm.internal.a
        public final Continuation create(Object obj, Continuation continuation) {
            return new c(this.f44559e, this.f44560i, continuation);
        }
    ...
    public final Object f(CameraDevice cameraDevice, Continuation continuation) {
        ...
        k(cameraDevice, this.f44543b, this.f44544c, new b(dVar, cameraDevice));
        Object b10 = dVar.b();
        if (b10 == or.b.f()) {
    ...
    private final CaptureRequest g(CameraCaptureSession cameraCaptureSession, boolean z10, List list) {
        ...
        createCaptureRequest.set(CaptureRequest.CONTROL_AE_TARGET_FPS_RANGE, this.f44542a.g());
        ...
        MeteringRectangle meteringRectangle = this.f44548g;
    ...
    private final boolean h() {
        int i10;
        Integer num = (Integer) this.f44545d.get(CameraCharacteristics.CONTROL_MAX_REGIONS_AF);
        if (num != null) {
            i10 = num.intValue();
        } else {
            i10 = 0;
    ...
    private final boolean k(CameraDevice cameraDevice, List list, Handler handler, CameraCaptureSession.StateCallback stateCallback) {
        if (Build.VERSION.SDK_INT >= 33) {
            ...
            while (it.hasNext()) {
                ...
                outputConfiguration.setDynamicRangeProfile(this.f44542a.a().a());
    ...
    public final void e() {
        kotlinx.coroutines.i.f(this.f44546e, null, 1, null);
    }
    ...
    public final void j(int i10, int i11, Size size, long j10) {
        ...
        this.f44548g = new MeteringRectangle(new Point(i10, i11), size, 1000);
        Job job = this.f44549h;
        if (job != null) {
            Job.a.a(job, null, 1, null);
        }
        d10 = gs.i.d(this.f44546e, null, null, new c(j10, this, null), 3, null);
        this.f44549h = d10;
    }

    public final void l() {
        CameraCaptureSession cameraCaptureSession = this.f44550i;
        if (cameraCaptureSession == null) {
            Intrinsics.throwUninitializedPropertyAccessException("session");
            cameraCaptureSession = null;
        }
        CaptureRequest g10 = g(cameraCaptureSession, this.f44542a.a().b(), this.f44543b);
        CameraCaptureSession cameraCaptureSession2 = this.f44550i;
        if (cameraCaptureSession2 == null) {
            Intrinsics.throwUninitializedPropertyAccessException("session");
            cameraCaptureSession2 = null;
        }
        cameraCaptureSession2.setRepeatingRequest(g10, null, this.f44544c);
    }
    ...
    private k(l lVar, List list, Handler handler, CameraCharacteristics cameraCharacteristics) {
        ...
        this.f44545d = cameraCharacteristics;
        this.f44546e = kotlinx.coroutines.i.a(m0.a().U0(j1.b(null, 1, null)));
    }
}
