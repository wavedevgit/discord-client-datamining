...
public final class d implements e {
    ...
    private static final float[] f44558c = {-0.15f, -0.15f, -0.15f, -0.15f, 2.2f, -0.15f, -0.15f, -0.15f, -0.15f};

    /* renamed from: a  reason: collision with root package name */
    private final Lazy f44559a = jr.l.b(new Function0() { // from class: on.c
    ...
    private final rj.a d() {
        return (rj.a) this.f44559a.getValue();
    }

    private final Bitmap e(Bitmap bitmap) {
        try {
            return Toolkit.b(Toolkit.f16889a, bitmap, f44558c, null, 4, null);
        ...
        try {
            ...
            if (d10 == null) {
                ...
                if (rect2.contains(a11)) {
                    ...
                    return Result.b(new a.C0550a(bVar));
                }
                Result.a aVar7 = Result.f33071e;
                return Result.b(a.b.f44551a);
            } else {
                Result.a aVar8 = Result.f33071e;
                return Result.b(a.b.f44551a);
            }
        } catch (ExecutionException unused) {
            Result.a aVar9 = Result.f33071e;
