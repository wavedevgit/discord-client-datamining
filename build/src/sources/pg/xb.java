...
public final class xb implements ob {
    ...
    private final f8 f43233a;

    /* renamed from: b  reason: collision with root package name */
    private ja f43234b = new ja();
    ...
    public final byte[] c(int i10, boolean z10) {
        ...
        this.f43234b.e(Boolean.FALSE);
        this.f43233a.e(this.f43234b.m());
        try {
            jc.a();
            if (i10 == 0) {
                return new dj.d().j(m6.f42812a).k(true).i().b(this.f43233a.f()).getBytes("utf-8");
            }
            h8 f10 = this.f43233a.f();
            n nVar = new n();
            m6.f42812a.a(nVar);
            return nVar.b().a(f10);
