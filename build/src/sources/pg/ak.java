...
public final class ak implements lj {
    ...
    private final ke f45135a;

    /* renamed from: b  reason: collision with root package name */
    private ki f45136b = new ki();
    ...
    public final byte[] a(int i10, boolean z10) {
        ...
        this.f45136b.e(Boolean.FALSE);
        this.f45135a.i(this.f45136b.m());
        try {
            jk.a();
            if (i10 == 0) {
                return new wi.d().j(cc.f45186a).k(true).i().b(this.f45135a.j()).getBytes("utf-8");
            }
            me j10 = this.f45135a.j();
            e2 e2Var = new e2();
            cc.f45186a.a(e2Var);
