...
public final class ak implements lj {
    ...
    private final ke f45151a;

    /* renamed from: b  reason: collision with root package name */
    private ki f45152b = new ki();
    ...
    public final byte[] a(int i10, boolean z10) {
        ...
        this.f45152b.e(Boolean.FALSE);
        this.f45151a.i(this.f45152b.m());
        try {
            jk.a();
            if (i10 == 0) {
                return new wi.d().j(cc.f45202a).k(true).i().b(this.f45151a.j()).getBytes("utf-8");
            }
            me j10 = this.f45151a.j();
            e2 e2Var = new e2();
            cc.f45202a.a(e2Var);
