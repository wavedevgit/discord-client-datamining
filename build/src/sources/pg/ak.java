...
public final class ak implements lj {
    ...
    private final ke f45183a;

    /* renamed from: b  reason: collision with root package name */
    private ki f45184b = new ki();
    ...
    public final byte[] a(int i10, boolean z10) {
        ...
        this.f45184b.e(Boolean.FALSE);
        this.f45183a.i(this.f45184b.m());
        try {
            jk.a();
            if (i10 == 0) {
                return new wi.d().j(cc.f45234a).k(true).i().b(this.f45183a.j()).getBytes("utf-8");
            }
            me j10 = this.f45183a.j();
            e2 e2Var = new e2();
            cc.f45234a.a(e2Var);
