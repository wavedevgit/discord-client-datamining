...
public final class kk extends hf.a {
    ...
    private final int f45557i;

    /* renamed from: o  reason: collision with root package name */
    private final int f45558o;

    /* renamed from: p  reason: collision with root package name */
    private final long f45559p;
    ...
    public final void writeToParcel(Parcel parcel, int i10) {
        ...
        hf.c.l(parcel, 1, i11);
        hf.c.l(parcel, 2, this.f45556e);
        hf.c.l(parcel, 3, this.f45557i);
        hf.c.l(parcel, 4, this.f45558o);
        hf.c.o(parcel, 5, this.f45559p);
        hf.c.b(parcel, a10);
    }
}
