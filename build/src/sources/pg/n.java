...
public final class n implements cj.b {
    ...
    private final Map f42259a = new HashMap();

    /* renamed from: b  reason: collision with root package name */
    private final Map f42260b = new HashMap();

    /* renamed from: c  reason: collision with root package name */
    private final bj.d f42261c = f42257d;

    @Override // cj.b
    public final /* bridge */ /* synthetic */ cj.b a(Class cls, bj.d dVar) {
        this.f42259a.put(cls, dVar);
        this.f42260b.remove(cls);
        return this;
    }

    public final o b() {
        return new o(new HashMap(this.f42259a), new HashMap(this.f42260b), this.f42261c);
    }
}
