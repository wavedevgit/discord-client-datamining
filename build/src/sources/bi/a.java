...
public abstract class a {
    ...
    private static final Map f7519a;

    /* renamed from: b  reason: collision with root package name */
    private static final Map f7520b;
    ...
    public static String a(int i10) {
        ...
        return ((String) map.get(valueOf)) + " (https://developer.android.com/reference/com/google/android/play/core/review/model/ReviewErrorCode.html#" + ((String) f7520b.get(valueOf)) + ")";
    }
}
