...
public abstract class a {
    ...
    private static final Map f7201a;

    /* renamed from: b  reason: collision with root package name */
    private static final Map f7202b;
    ...
    public static String a(int i10) {
        ...
        return ((String) map.get(valueOf)) + " (https://developer.android.com/reference/com/google/android/play/core/assetpacks/model/AssetPackErrorCode.html#" + ((String) f7202b.get(valueOf)) + ")";
    }
}
