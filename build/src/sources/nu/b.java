...
public final class b extends pu.c {
    ...
    private final X509TrustManager f40033b;

    /* renamed from: c  reason: collision with root package name */
    private final X509TrustManagerExtensions f40034c;
    ...
    public b(X509TrustManager trustManager, X509TrustManagerExtensions x509TrustManagerExtensions) {
        ...
        this.f40033b = trustManager;
        this.f40034c = x509TrustManagerExtensions;
    }
    ...
    public List a(List chain, String hostname) {
        ...
        try {
            List<X509Certificate> checkServerTrusted = this.f40034c.checkServerTrusted((X509Certificate[]) chain.toArray(new X509Certificate[0]), "RSA", hostname);
    ...
    public boolean equals(Object obj) {
        if ((obj instanceof b) && ((b) obj).f40033b == this.f40033b) {
            return true;
        }
        return false;
    }
    ...
    public int hashCode() {
        return System.identityHashCode(this.f40033b);
    }
}
