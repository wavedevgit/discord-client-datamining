...
public final class e {
    ...
    public static final class a {
        ...
        /* JADX WARN: Code restructure failed: missing block: B:17:0x0066, code lost:
            r6 = kotlin.text.StringsKt.E0(au.e.Z(r14, r6 + 1, r3), "\"");
         */
        ...
        */
        public final nu.e a(okhttp3.Headers r21) {
            /*
                Method dump skipped, instructions count: 220
                To view this dump add '--comments-level debug' option
            */
            throw new UnsupportedOperationException("Method not decompiled: nu.e.a.a(okhttp3.Headers):nu.e");
        }
    ...
    public boolean equals(Object obj) {
        ...
        e eVar = (e) obj;
        if (this.f42025a == eVar.f42025a && Intrinsics.areEqual(this.f42026b, eVar.f42026b) && this.f42027c == eVar.f42027c && Intrinsics.areEqual(this.f42028d, eVar.f42028d) && this.f42029e == eVar.f42029e && this.f42030f == eVar.f42030f) {
            return true;
        }
        return false;
    }
    ...
    public String toString() {
        return "WebSocketExtensions(perMessageDeflate=" + this.f42025a + ", clientMaxWindowBits=" + this.f42026b + ", clientNoContextTakeover=" + this.f42027c + ", serverMaxWindowBits=" + this.f42028d + ", serverNoContextTakeover=" + this.f42029e + ", unknownValues=" + this.f42030f + ')';
    }
}
