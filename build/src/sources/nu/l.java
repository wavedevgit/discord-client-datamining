...
public final class l extends f {
    ...
    public static final a f40057j = new a(null);

    /* renamed from: h  reason: collision with root package name */
    private final Class f40058h;

    /* renamed from: i  reason: collision with root package name */
    private final Class f40059i;
    ...
    public static final class a {
        ...
        public final k a(String packageName) {
            ...
            try {
                ...
                mu.h.f37655a.g().k("unable to load android socket classes", 5, e10);
                return null;
            }
        }
    ...
    public l(Class sslSocketClass, Class sslSocketFactoryClass, Class paramClass) {
        ...
        this.f40058h = sslSocketFactoryClass;
        this.f40059i = paramClass;
    }
}
