...
public final class c {
    ...
    private static final CopyOnWriteArraySet f40036b = new CopyOnWriteArraySet();

    /* renamed from: c  reason: collision with root package name */
    private static final Map f40037c;
    ...
    private final void c(String str, String str2) {
        ...
        if (f40036b.add(logger)) {
            ...
            logger.addHandler(d.f40038a);
        }
    }

    private final String d(String str) {
        String str2 = (String) f40037c.get(str);
        if (str2 == null) {
    ...
    public final void b() {
        for (Map.Entry entry : f40037c.entrySet()) {
