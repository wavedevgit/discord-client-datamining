...
public final class h {
    ...
    private final Method f40051b;

    /* renamed from: c  reason: collision with root package name */
    private final Method f40052c;
    ...
    public h(Method method, Method method2, Method method3) {
        this.f40050a = method;
        this.f40051b = method2;
        this.f40052c = method3;
    }

    public final Object a(String closer) {
        Intrinsics.checkNotNullParameter(closer, "closer");
        Method method = this.f40050a;
        if (method != null) {
            try {
                Object invoke = method.invoke(null, null);
                Method method2 = this.f40051b;
