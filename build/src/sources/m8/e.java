...
public abstract class e extends AbstractExecutorService implements ScheduledExecutorService, AutoCloseable {
    ...
    private final Handler f37858d;

    public e(Handler handler) {
        this.f37858d = handler;
    }
    ...
    public boolean a() {
        if (Thread.currentThread() == this.f37858d.getLooper().getThread()) {
            return true;
        }
        return false;
    }
    ...
    public f newTaskFor(Runnable runnable, Object obj) {
        return new f(this.f37858d, runnable, obj);
    }
    ...
    public f newTaskFor(Callable callable) {
        return new f(this.f37858d, callable);
    }
    ...
    public ScheduledFuture schedule(Runnable runnable, long j10, TimeUnit timeUnit) {
        ...
        this.f37858d.postDelayed(newTaskFor, timeUnit.toMillis(j10));
        return newTaskFor;
    }
