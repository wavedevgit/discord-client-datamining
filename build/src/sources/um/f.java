...
public abstract class f {
    ...
    static final class a extends kotlin.coroutines.jvm.internal.k implements Function2 {
        ...
        final /* synthetic */ vm.m f50475i;

        /* renamed from: o  reason: collision with root package name */
        final /* synthetic */ MutableStateFlow f50476o;

        /* renamed from: p  reason: collision with root package name */
        final /* synthetic */ Function2 f50477p;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        a(vm.m mVar, MutableStateFlow mutableStateFlow, Function2 function2, Continuation continuation) {
            super(2, continuation);
            this.f50475i = mVar;
            this.f50476o = mutableStateFlow;
            this.f50477p = function2;
        }

        @Override // kotlin.coroutines.jvm.internal.a
        public final Continuation create(Object obj, Continuation continuation) {
            a aVar = new a(this.f50475i, this.f50476o, this.f50477p, continuation);
            aVar.f50474e = obj;
            return aVar;
        }
        ...
        */
        public final java.lang.Object invokeSuspend(java.lang.Object r8) {
            /*
                ...
                if (r1 == r3) goto L1e
                if (r1 != r2) goto L16
                java.lang.Object r1 = r7.f50474e
            ...
            L26:
                kotlin.c.b(r8)
                java.lang.Object r8 = r7.f50474e
            ...
            L43:
                ...
                return r8
            L4e:
                kotlinx.coroutines.flow.MutableStateFlow r4 = r7.f50476o
                vm.m r5 = r7.f50475i
                um.g r5 = r5.g()
                r4.setValue(r5)
                if (r8 != 0) goto L5d
            L5b:
                ...
                goto L2d
            L5d:
                kotlin.jvm.functions.Function2 r4 = r7.f50477p
    ...
    public static final j0 a(q workflow, CoroutineScope scope, j0 props, m mVar, List interceptors, Function2 onOutput) {
        ...
        vm.m mVar2 = new vm.m(scope, workflow, props, mVar, vm.c.a(interceptors));
        CancellationException cancellationException = null;
        try {
            MutableStateFlow a10 = l0.a(mVar2.g());
            hs.i.d(scope, null, null, new a(mVar2, a10, onOutput, null), 3, null);
            return a10;
        } catch (Throwable th2) {
