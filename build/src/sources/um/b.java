...
public final class b implements EventDispatcherListener {
    ...
    public static final a f51367h = new a(null);

    /* renamed from: a  reason: collision with root package name */
    private final ReactViewGroup f51368a;

    /* renamed from: b  reason: collision with root package name */
    private final ThemedReactContext f51369b;

    /* renamed from: c  reason: collision with root package name */
    private final l f51370c;

    /* renamed from: d  reason: collision with root package name */
    private Function0 f51371d;

    /* renamed from: e  reason: collision with root package name */
    private final int f51372e;

    /* renamed from: f  reason: collision with root package name */
    private final UIManager f51373f;

    /* renamed from: g  reason: collision with root package name */
    private final EventDispatcher f51374g;
    ...
    public b(ReactViewGroup view, ThemedReactContext reactContext, l config, Function0 callback) {
        ...
        this.f51368a = view;
        this.f51369b = reactContext;
        this.f51370c = config;
        this.f51371d = callback;
        this.f51372e = 2;
        this.f51373f = UIManagerHelper.getUIManager(reactContext.getReactApplicationContext(), 2);
        this.f51374g = UIManagerHelper.getEventDispatcher(reactContext.getReactApplicationContext(), 2);
    }
    ...
    public final void b() {
        EventDispatcher eventDispatcher = this.f51374g;
    ...
    */
    public void onEventDispatch(com.facebook.react.uimanager.events.Event r8) {
        ...
        L13:
            r0 = 0
            com.facebook.react.bridge.UIManager r1 = r7.f51373f     // Catch: java.lang.Exception -> L21
            if (r1 == 0) goto L23
        ...
        L65:
            ...
            com.facebook.react.uimanager.ThemedReactContext r3 = r7.f51369b
            r2.<init>(r3)
            android.view.ViewGroup$LayoutParams r3 = new android.view.ViewGroup$LayoutParams
            r4 = 0
            r3.<init>(r4, r4)
            r2.setLayoutParams(r3)
            com.facebook.react.views.view.ReactViewGroup r3 = r7.f51368a
            com.facebook.react.uimanager.ThemedReactContext r4 = r7.f51369b
            rm.l r5 = r7.f51370c
            rm.k r6 = new rm.k
            r6.<init>(r3, r0, r4, r5)
            r0.addView(r2)
            boolean r3 = um.c.a()
            if (r3 == 0) goto Lac
            kotlin.jvm.functions.Function0 r3 = r7.f51371d
            ...
            r3.o(r4)
        L9b:
            androidx.core.view.i0.E0(r0, r6)
            androidx.core.view.i0.x0(r2, r6)
            r3 = 0
        ...
        Lbd:
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: um.b.onEventDispatch(com.facebook.react.uimanager.events.Event):void");
    }
}
