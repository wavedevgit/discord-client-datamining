...
public abstract class l {
    ...
    public static final class b implements Comparator {
        ...
        public final int compare(Object obj, Object obj2) {
            return ur.a.d(Integer.valueOf(((i) obj2).b()), Integer.valueOf(((i) obj).b()));
        }
    }
        ...
        while (true) {
            ...
            while (true) {
                if (i11 < size) {
                    ...
                    arrayList.add(new i(a10, m.f22109d));
                } else {
