...
public abstract class p {
    ...
    public static final class a extends Lambda implements Function0 {
        ...
        final /* synthetic */ Object f22111d;

        /* renamed from: e  reason: collision with root package name */
        final /* synthetic */ Object f22112e;

        /* renamed from: i  reason: collision with root package name */
        final /* synthetic */ et.a f22113i;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        a(Object obj, Object obj2, et.a aVar) {
            super(0);
            this.f22111d = obj;
            this.f22112e = obj2;
            this.f22113i = aVar;
        ...
        public final String invoke() {
            return "Attempting to assign conflicting values '" + this.f22111d + "' and '" + this.f22112e + "' to field '" + this.f22113i.getName() + '\'';
        }
    }

    public static final q a(Integer num, Integer num2, Integer num3, et.a setter, String name, Integer num4) {
    ...
    public static final Object c(et.a aVar, Object obj, Object obj2, int i10, int i11) {
        Object c10 = aVar.c(obj, obj2);
        if (c10 == null) {
            return k.f22105a.b(i11);
        }
        return k.f22105a.a(i10, new a(c10, obj2, aVar));
    }

    public static final q d(Integer num, Integer num2, Integer num3, et.a setter, String name, boolean z10) {
        int i10;
        int i11;
        int i12;
        Intrinsics.checkNotNullParameter(setter, "setter");
    ...
    public static /* synthetic */ q e(Integer num, Integer num2, Integer num3, et.a aVar, String str, boolean z10, int i10, Object obj) {
        if ((i10 & 32) != 0) {
            z10 = false;
        }
    ...
    private static final q f(boolean z10, et.a aVar, String str, int i10, int i11) {
        if (i11 >= (z10 ? 1 : 0) + 1) {
