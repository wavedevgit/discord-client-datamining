...
public abstract class e implements KSerializer {
    ...
    public e(KClass baseClass) {
        ...
        this.descriptor = ct.j.e("JsonContentPolymorphicSerializer<" + baseClass.getSimpleName() + '>', d.b.f19833a, new SerialDescriptor[0], null, 8, null);
    }
    ...
    private final Void a(KClass kClass, KClass kClass2) {
        ...
        throw new at.n("Class '" + simpleName + "' is not registered for polymorphic serialization " + ("in the scope of '" + kClass2.getSimpleName() + '\'') + ".\nMark the base class as 'sealed' or register the serializer explicitly.");
    }
    ...
    public final void serialize(@NotNull Encoder encoder, @NotNull Object value) {
        ...
        if (e10 == null) {
            KSerializer g10 = at.w.g(Reflection.getOrCreateKotlinClass(value.getClass()));
            if (g10 != null) {
                e10 = g10;
            } else {
