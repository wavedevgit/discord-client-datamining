...
public abstract class k {
    ...
    /* renamed from: b */
    private static final long f55883b = 0;

    /* renamed from: e */
    private static h f55886e;

    /* renamed from: f */
    private static long f55887f;

    /* renamed from: g */
    private static final f f55888g;

    /* renamed from: h */
    private static final m f55889h;

    /* renamed from: i */
    private static List f55890i;

    /* renamed from: j */
    private static List f55891j;

    /* renamed from: k */
    private static final b f55892k;

    /* renamed from: l */
    private static final e f55893l;

    /* renamed from: m */
    private static x0.a f55894m;

    /* renamed from: a */
    private static final Function1 f55882a = new Function1() { // from class: y0.j
    ...
    /* renamed from: c */
    private static final x0.b f55884c = new x0.b();

    /* renamed from: d */
    private static final Object f55885d = new Object();
    ...
    static {
        ...
        f55888g = new f();
        f55889h = new m();
        f55890i = CollectionsKt.l();
        f55891j = CollectionsKt.l();
        long j11 = f55887f;
        f55887f = j10 + j11;
        b bVar = new b(j11, aVar.a());
        f55886e = f55886e.j(bVar.d());
        f55892k = bVar;
        f55893l = bVar;
        f55894m = new x0.a(0);
    }
    ...
    private static final boolean p(long j10, long j11, h hVar) {
        if (j11 != f55883b && Intrinsics.compare(j11, j10) <= 0 && !hVar.g(j11)) {
            return true;
        }
        return false;
    }
