...
/* renamed from: app.rive.core.CommandQueue$getBooleanProperty-iFQtAB8$$inlined$suspendNativeRequest$1  reason: invalid class name */
/* loaded from: /home/runner/work/discord-client-datamining/discord-client-datamining/build/classes.dex */
public final class CommandQueue$getBooleanPropertyiFQtAB8$$inlined$suspendNativeRequest$1 extends k implements Function2<CoroutineScope, Continuation<? super Boolean>, Object> {
    ...
    public CommandQueue$getBooleanPropertyiFQtAB8$$inlined$suspendNativeRequest$1(CommandQueue commandQueue, Continuation continuation, CommandQueue commandQueue2, long j10, String str) {
    ...
    public final Object invokeSuspend(@NotNull Object obj) {
        ...
        eVar.c(new Function1<Throwable, Unit>() { // from class: app.rive.core.CommandQueue$getBooleanProperty-iFQtAB8$$inlined$suspendNativeRequest$1.1
            /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
            {
                super(1);
            }
        ...
        commandQueue3.cppGetBooleanProperty(rCPointer.getPointer(), andIncrement, this.$viewModelInstanceHandle$inlined, this.$propertyPath$inlined);
        Object B = eVar.B();
        if (B == b.f()) {
            g.c(this);
        }
    ...
    public final Object invoke(@NotNull CoroutineScope coroutineScope, Continuation<? super Boolean> continuation) {
        return ((CommandQueue$getBooleanPropertyiFQtAB8$$inlined$suspendNativeRequest$1) create(coroutineScope, continuation)).invokeSuspend(Unit.f32464a);
    }
}
