...
@e(c = "app.rive.core.CommandQueue$getViewModelNames-evklBmw$$inlined$suspendNativeRequest$1", f = "CommandQueue.kt", l = {2460}, m = "invokeSuspend")
@SourceDebugExtension({"SMAP\nCommandQueue.kt\nKotlin\n*S Kotlin\n*F\n+ 1 CommandQueue.kt\napp/rive/core/CommandQueue$suspendNativeRequest$2\n+ 2 CancellableContinuation.kt\nkotlinx/coroutines/CancellableContinuationKt\n+ 3 CommandQueue.kt\napp/rive/core/CommandQueue\n*L\n1#1,2459:1\n318#2,9:2460\n327#2,2:2475\n858#3,6:2469\n*S KotlinDebug\n*F\n+ 1 CommandQueue.kt\napp/rive/core/CommandQueue$suspendNativeRequest$2\n*L\n2268#1:2460,9\n2268#1:2475,2\n*E\n"})
/* renamed from: app.rive.core.CommandQueue$getViewModelNames-evklBmw$$inlined$suspendNativeRequest$1  reason: invalid class name */
/* loaded from: /home/runner/work/discord-client-datamining/discord-client-datamining/build/classes.dex */
public final class CommandQueue$getViewModelNamesevklBmw$$inlined$suspendNativeRequest$1 extends k implements Function2<CoroutineScope, Continuation<? super List<? extends String>>, Object> {
    ...
    public CommandQueue$getViewModelNamesevklBmw$$inlined$suspendNativeRequest$1(CommandQueue commandQueue, Continuation continuation, CommandQueue commandQueue2, long j10) {
    ...
    public final Object invokeSuspend(@NotNull Object obj) {
        ...
        eVar.c(new Function1<Throwable, Unit>() { // from class: app.rive.core.CommandQueue$getViewModelNames-evklBmw$$inlined$suspendNativeRequest$1.1
            /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
            {
                super(1);
            }
        ...
        commandQueue3.cppGetViewModelNames(rCPointer.getPointer(), andIncrement, this.$fileHandle$inlined);
        Object B = eVar.B();
        if (B == b.f()) {
            g.c(this);
        }
    ...
    public final Object invoke(@NotNull CoroutineScope coroutineScope, Continuation<? super List<? extends String>> continuation) {
        return ((CommandQueue$getViewModelNamesevklBmw$$inlined$suspendNativeRequest$1) create(coroutineScope, continuation)).invokeSuspend(Unit.f33298a);
    }
}
