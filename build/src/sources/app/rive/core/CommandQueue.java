...
public final class CommandQueue {
    ...
    public static final class PropertyUpdate<T> {
        ...
        public static /* synthetic */ PropertyUpdate m154copyiFQtAB8$default(PropertyUpdate propertyUpdate, long j10, String str, Object obj, int i10, Object obj2) {
            if ((i10 & 1) != 0) {
            ...
            return propertyUpdate.m156copyiFQtAB8(j10, str, obj);
        }

        /* renamed from: component1-VPLto4w  reason: not valid java name */
        public final long m155component1VPLto4w() {
            return this.handle;
        }
        ...
        public final PropertyUpdate<T> m156copyiFQtAB8(long j10, @NotNull String propertyPath, T t10) {
        ...
        public boolean equals(Object obj) {
            ...
            if (obj instanceof PropertyUpdate) {
                ...
                return ViewModelInstanceHandle.m202equalsimpl0(this.handle, propertyUpdate.handle) && Intrinsics.areEqual(this.propertyPath, propertyUpdate.propertyPath) && Intrinsics.areEqual(this.value, propertyUpdate.value);
            }
            return false;
        }

        /* renamed from: getHandle-VPLto4w  reason: not valid java name */
        public final long m157getHandleVPLto4w() {
            return this.handle;
        }
        ...
        public int hashCode() {
            int m203hashCodeimpl = ((ViewModelInstanceHandle.m203hashCodeimpl(this.handle) * 31) + this.propertyPath.hashCode()) * 31;
            T t10 = this.value;
            return m203hashCodeimpl + (t10 == null ? 0 : t10.hashCode());
        }

        @NotNull
        public String toString() {
            String m204toStringimpl = ViewModelInstanceHandle.m204toStringimpl(this.handle);
            String str = this.propertyPath;
            T t10 = this.value;
            return "PropertyUpdate(handle=" + m204toStringimpl + ", propertyPath=" + str + ", value=" + t10 + ")";
        }
    ...
    public static /* synthetic */ void m108drawPOUf8go$default(CommandQueue commandQueue, long j10, long j11, Fit fit, Alignment alignment, RiveSurface riveSurface, int i10, int i11, Object obj) {
        int i12;
        if ((i11 & 32) != 0) {
            i12 = 0;
        } else {
        ...
        commandQueue.m127drawPOUf8go(j10, j11, fit, alignment, riveSurface, i12);
    }
    ...
    private final <T> void m109onPropertyUpdatedUrmHyfM(long j10, long j11, String str, T t10, MutableSharedFlow mutableSharedFlow) {
    ...
    public final void m110advanceStateMachineOFH3VyA(long j10, long j11) {
    ...
    public final Object beginPolling(@NotNull Lifecycle lifecycle, @NotNull FrameTicker frameTicker, @NotNull Continuation<? super Unit> continuation) {
        Object a10 = z.a(lifecycle, Lifecycle.State.f4440p, new CommandQueue$beginPolling$2(frameTicker, this, null), continuation);
        if (a10 == b.f()) {
            return a10;
        }
        return Unit.f33074a;
    ...
    public final void m111bindViewModelInstanceeiyHz8(long j10, long j11) {
    ...
    public final long m112createArtboardByName2ZIOzHc(long j10, @NotNull String name) {
        Intrinsics.checkNotNullParameter(name, "name");
        return ArtboardHandle.m95constructorimpl(cppCreateArtboardByName(this.cppPointer.getPointer(), this.nextRequestID.getAndIncrement(), j10, name));
    }

    /* renamed from: createDefaultArtboard-6NrLy0M  reason: not valid java name */
    public final long m113createDefaultArtboard6NrLy0M(long j10) {
        return ArtboardHandle.m95constructorimpl(cppCreateDefaultArtboard(this.cppPointer.getPointer(), this.nextRequestID.getAndIncrement(), j10));
    }

    /* renamed from: createDefaultStateMachine-xY8vNfM  reason: not valid java name */
    public final long m114createDefaultStateMachinexY8vNfM(long j10) {
        return StateMachineHandle.m193constructorimpl(cppCreateDefaultStateMachine(this.cppPointer.getPointer(), this.nextRequestID.getAndIncrement(), j10));
    }
    ...
    public final RiveSurface createRiveSurface(@NotNull Surface surface) {
        ...
        if (!Intrinsics.areEqual(eglCreateWindowSurface, EGL14.EGL_NO_SURFACE)) {
            ...
            long m161constructorimpl = DrawKey.m161constructorimpl(cppCreateDrawKey(this.cppPointer.getPointer()));
            Intrinsics.checkNotNull(eglCreateWindowSurface);
            return new RiveSurface(surface, eglCreateWindowSurface, this.display, cppCreateRenderTarget, m161constructorimpl, i10, i11, null);
        }
    ...
    public final long m115createStateMachineByNameItmKBmM(long j10, @NotNull String name) {
        Intrinsics.checkNotNullParameter(name, "name");
        return StateMachineHandle.m193constructorimpl(cppCreateStateMachineByName(this.cppPointer.getPointer(), this.nextRequestID.getAndIncrement(), j10, name));
    }

    /* renamed from: createViewModelInstance-j73Dd8U  reason: not valid java name */
    public final long m116createViewModelInstancej73Dd8U(long j10, @NotNull ViewModelInstanceSource source) {
        Intrinsics.checkNotNullParameter(source, "source");
        if (source instanceof ViewModelInstanceSource.Blank) {
            ViewModelSource m66unboximpl = ((ViewModelInstanceSource.Blank) source).m66unboximpl();
            if (m66unboximpl instanceof ViewModelSource.Named) {
                return ViewModelInstanceHandle.m200constructorimpl(cppNamedVMCreateBlankVMI(this.cppPointer.getPointer(), this.nextRequestID.getAndIncrement(), j10, ((ViewModelSource.Named) m66unboximpl).m93unboximpl()));
            }
            if (m66unboximpl instanceof ViewModelSource.DefaultForArtboard) {
                return ViewModelInstanceHandle.m200constructorimpl(cppDefaultVMCreateBlankVMI(this.cppPointer.getPointer(), this.nextRequestID.getAndIncrement(), j10, ((ViewModelSource.DefaultForArtboard) m66unboximpl).m83unboximpl().m17getArtboardHandlenSTdbJo$kotlin_release()));
            }
            throw new p();
        } else if (source instanceof ViewModelInstanceSource.Default) {
            ViewModelSource m73unboximpl = ((ViewModelInstanceSource.Default) source).m73unboximpl();
            if (m73unboximpl instanceof ViewModelSource.Named) {
                return ViewModelInstanceHandle.m200constructorimpl(cppNamedVMCreateDefaultVMI(this.cppPointer.getPointer(), this.nextRequestID.getAndIncrement(), j10, ((ViewModelSource.Named) m73unboximpl).m93unboximpl()));
            }
            if (m73unboximpl instanceof ViewModelSource.DefaultForArtboard) {
                return ViewModelInstanceHandle.m200constructorimpl(cppDefaultVMCreateDefaultVMI(this.cppPointer.getPointer(), this.nextRequestID.getAndIncrement(), j10, ((ViewModelSource.DefaultForArtboard) m73unboximpl).m83unboximpl().m17getArtboardHandlenSTdbJo$kotlin_release()));
            }
            throw new p();
            ...
            if (vmSource instanceof ViewModelSource.Named) {
                return ViewModelInstanceHandle.m200constructorimpl(cppNamedVMCreateNamedVMI(this.cppPointer.getPointer(), this.nextRequestID.getAndIncrement(), j10, ((ViewModelSource.Named) vmSource).m93unboximpl(), named.getInstanceName()));
            }
            if (vmSource instanceof ViewModelSource.DefaultForArtboard) {
                return ViewModelInstanceHandle.m200constructorimpl(cppDefaultVMCreateNamedVMI(this.cppPointer.getPointer(), this.nextRequestID.getAndIncrement(), j10, ((ViewModelSource.DefaultForArtboard) vmSource).m83unboximpl().m17getArtboardHandlenSTdbJo$kotlin_release(), named.getInstanceName()));
            }
            throw new p();
            ...
            return ViewModelInstanceHandle.m200constructorimpl(cppReferenceNestedVMI(this.cppPointer.getPointer(), this.nextRequestID.getAndIncrement(), reference.getInstance().m48getInstanceHandleVPLto4w$kotlin_release(), reference.getPath()));
        } else {
            throw new p();
        }
    }
    ...
    public final Object m117decodeAudioWLIIakE(@NotNull byte[] bArr, @NotNull Continuation<? super AudioHandle> continuation) {
    ...
    public final Object m118decodeFontsOckvAc(@NotNull byte[] bArr, @NotNull Continuation<? super FontHandle> continuation) {
    ...
    public final Object m119decodeImagef0BlWSU(@NotNull byte[] bArr, @NotNull Continuation<? super ImageHandle> continuation) {
    ...
    public final void m120deleteArtboarduiJWFY8(long j10) {
    ...
    public final void m126deleteViewModelInstancemBajs_U(long j10) {
    ...
    public final void m127drawPOUf8go(long j10, long j11, @NotNull Fit fit, @NotNull Alignment alignment, @NotNull RiveSurface surface, int i10) {
        Intrinsics.checkNotNullParameter(fit, "fit");
        Intrinsics.checkNotNullParameter(alignment, "alignment");
        Intrinsics.checkNotNullParameter(surface, "surface");
        cppDraw(this.cppPointer.getPointer(), this.display.getNativeHandle(), surface.getEglSurface().getNativeHandle(), this.context.getNativeHandle(), surface.m191getDrawKeyDhFih_o(), j10, j11, surface.getRenderTargetPointer(), surface.getWidth(), surface.getHeight(), fit, alignment, i10);
    }

    /* renamed from: fireTriggerProperty-ippgHXQ  reason: not valid java name */
    public final void m128fireTriggerPropertyippgHXQ(long j10, @NotNull String propertyPath) {
        Intrinsics.checkNotNullParameter(propertyPath, "propertyPath");
    ...
    public final Object m129getArtboardNamesevklBmw(long j10, @NotNull Continuation<? super List<String>> continuation) {
    ...
    public final Object m130getBooleanPropertyiFQtAB8(long j10, @NotNull String str, @NotNull Continuation<? super Boolean> continuation) {
    ...
    public final Object m131getColorPropertyiFQtAB8(long j10, @NotNull String str, @NotNull Continuation<? super Integer> continuation) {
    ...
    public final Object m132getEnumPropertyiFQtAB8(long j10, @NotNull String str, @NotNull Continuation<? super String> continuation) {
    ...
    public final Object m133getEnumsevklBmw(long j10, @NotNull Continuation<? super List<File.Enum>> continuation) {
    ...
    public final Object m134getNumberPropertyiFQtAB8(long j10, @NotNull String str, @NotNull Continuation<? super Float> continuation) {
    ...
    public final Object m135getStateMachineNamesb88yb0A(long j10, @NotNull Continuation<? super List<String>> continuation) {
    ...
    public final Object m136getStringPropertyiFQtAB8(long j10, @NotNull String str, @NotNull Continuation<? super String> continuation) {
    ...
    public final Object m137getViewModelInstanceNamesmgMojzc(long j10, @NotNull String str, @NotNull Continuation<? super List<String>> continuation) {
    ...
    public final Object m138getViewModelNamesevklBmw(long j10, @NotNull Continuation<? super List<String>> continuation) {
    ...
    public final Object m139getViewModelPropertiesmgMojzc(long j10, @NotNull String str, @NotNull Continuation<? super List<ViewModel.Property>> continuation) {
    ...
    public final Object m140loadFilexVnc2tA(@NotNull byte[] bArr, @NotNull Continuation<? super FileHandle> continuation) {
    ...
    public final void onAudioDecoded(long j10, long j11) {
        ...
        if (cancellableContinuation != null) {
            cancellableContinuation.resumeWith(Result.b(AudioHandle.m101boximpl(j11)));
        }
    }
    ...
    public final void onBooleanPropertyUpdated(long j10, long j11, @NotNull String propertyName, boolean z10) {
        ...
        m109onPropertyUpdatedUrmHyfM(j10, j11, propertyName, Boolean.valueOf(z10), this._booleanPropertyFlow);
    }

    @Keep
    public final void onColorPropertyUpdated(long j10, long j11, @NotNull String propertyName, int i10) {
        Intrinsics.checkNotNullParameter(propertyName, "propertyName");
        m109onPropertyUpdatedUrmHyfM(j10, j11, propertyName, Integer.valueOf(i10), this._colorPropertyFlow);
    }
    ...
    public final void onEnumPropertyUpdated(long j10, long j11, @NotNull String propertyName, @NotNull String value) {
        ...
        m109onPropertyUpdatedUrmHyfM(j10, j11, propertyName, value, this._enumPropertyFlow);
    }
    ...
    public final void onFileLoaded(long j10, long j11) {
        ...
        if (cancellableContinuation != null) {
            cancellableContinuation.resumeWith(Result.b(FileHandle.m167boximpl(j11)));
        }
    }
    ...
    public final void onFontDecoded(long j10, long j11) {
        ...
        if (cancellableContinuation != null) {
            cancellableContinuation.resumeWith(Result.b(FontHandle.m174boximpl(j11)));
        }
    }
    ...
    public final void onImageDecoded(long j10, long j11) {
        ...
        if (cancellableContinuation != null) {
            cancellableContinuation.resumeWith(Result.b(ImageHandle.m181boximpl(j11)));
        }
    }
    ...
    public final void onNumberPropertyUpdated(long j10, long j11, @NotNull String propertyName, float f10) {
        Intrinsics.checkNotNullParameter(propertyName, "propertyName");
        m109onPropertyUpdatedUrmHyfM(j10, j11, propertyName, Float.valueOf(f10), this._numberPropertyFlow);
    }
    ...
    public final void onStateMachineSettled(long j10) {
        this._settledFlow.b(StateMachineHandle.m192boximpl(j10));
    }
    ...
    public final void onStringPropertyUpdated(long j10, long j11, @NotNull String propertyName, @NotNull String value) {
        Intrinsics.checkNotNullParameter(propertyName, "propertyName");
        Intrinsics.checkNotNullParameter(value, "value");
        m109onPropertyUpdatedUrmHyfM(j10, j11, propertyName, value, this._stringPropertyFlow);
    }

    @Keep
    public final void onTriggerPropertyUpdated(long j10, long j11, @NotNull String propertyName) {
        Intrinsics.checkNotNullParameter(propertyName, "propertyName");
        m109onPropertyUpdatedUrmHyfM(j10, j11, propertyName, Unit.f33074a, this._triggerPropertyFlow);
    }
    ...
    public final void m141pointerDownOV3vCas(long j10, @NotNull Fit fit, @NotNull Alignment alignment, float f10, float f11, int i10, float f12, float f13) {
        Intrinsics.checkNotNullParameter(fit, "fit");
        Intrinsics.checkNotNullParameter(alignment, "alignment");
    ...
    public final void m142pointerExitOV3vCas(long j10, @NotNull Fit fit, @NotNull Alignment alignment, float f10, float f11, int i10, float f12, float f13) {
        Intrinsics.checkNotNullParameter(fit, "fit");
        Intrinsics.checkNotNullParameter(alignment, "alignment");
    ...
    public final void m143pointerMoveOV3vCas(long j10, @NotNull Fit fit, @NotNull Alignment alignment, float f10, float f11, int i10, float f12, float f13) {
        Intrinsics.checkNotNullParameter(fit, "fit");
        Intrinsics.checkNotNullParameter(alignment, "alignment");
    ...
    public final void m144pointerUpOV3vCas(long j10, @NotNull Fit fit, @NotNull Alignment alignment, float f10, float f11, int i10, float f12, float f13) {
        Intrinsics.checkNotNullParameter(fit, "fit");
        Intrinsics.checkNotNullParameter(alignment, "alignment");
    ...
    public final void m148setBooleanPropertyiFQtAB8(long j10, @NotNull String propertyPath, boolean z10) {
        Intrinsics.checkNotNullParameter(propertyPath, "propertyPath");
    ...
    public final void m149setColorPropertyiFQtAB8(long j10, @NotNull String propertyPath, int i10) {
        Intrinsics.checkNotNullParameter(propertyPath, "propertyPath");
    ...
    public final void m150setEnumPropertyiFQtAB8(long j10, @NotNull String propertyPath, @NotNull String value) {
        Intrinsics.checkNotNullParameter(propertyPath, "propertyPath");
        Intrinsics.checkNotNullParameter(value, "value");
    ...
    public final void m151setNumberPropertyiFQtAB8(long j10, @NotNull String propertyPath, float f10) {
        Intrinsics.checkNotNullParameter(propertyPath, "propertyPath");
    ...
    public final void m152setStringPropertyiFQtAB8(long j10, @NotNull String propertyPath, @NotNull String value) {
        Intrinsics.checkNotNullParameter(propertyPath, "propertyPath");
        Intrinsics.checkNotNullParameter(value, "value");
    ...
    public final void m153subscribeToPropertyiFQtAB8(long j10, @NotNull String propertyPath, @NotNull ViewModel.PropertyDataType propertyType) {
        Intrinsics.checkNotNullParameter(propertyPath, "propertyPath");
