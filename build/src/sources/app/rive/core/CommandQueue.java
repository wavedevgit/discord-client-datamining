...
public final class CommandQueue {
    ...
    private final /* synthetic */ <T> Object suspendNativeRequest(Function1<? super Long, Unit> function1, Continuation<? super T> continuation) {
        ...
        InlineMarker.mark(0);
        Object g10 = g.g(P1, commandQueue$suspendNativeRequest$2, continuation);
        InlineMarker.mark(1);
        return g10;
    }
    ...
    public final Object beginPolling(@NotNull Lifecycle lifecycle, @NotNull FrameTicker frameTicker, @NotNull Continuation<? super Unit> continuation) {
        Object a10 = z.a(lifecycle, Lifecycle.State.f4557p, new CommandQueue$beginPolling$2(frameTicker, this, null), continuation);
        if (a10 == b.f()) {
            return a10;
        }
        return Unit.f31988a;
    ...
    public final Object m115decodeAudioWLIIakE(@NotNull byte[] bArr, @NotNull Continuation<? super AudioHandle> continuation) {
        return g.g(m0.c().P1(), new CommandQueue$decodeAudioWLIIakE$$inlined$suspendNativeRequest$1(this, null, this, bArr), continuation);
    }
    ...
    public final Object m116decodeFontsOckvAc(@NotNull byte[] bArr, @NotNull Continuation<? super FontHandle> continuation) {
        return g.g(m0.c().P1(), new CommandQueue$decodeFontsOckvAc$$inlined$suspendNativeRequest$1(this, null, this, bArr), continuation);
    }
    ...
    public final Object m117decodeImagef0BlWSU(@NotNull byte[] bArr, @NotNull Continuation<? super ImageHandle> continuation) {
        return g.g(m0.c().P1(), new CommandQueue$decodeImagef0BlWSU$$inlined$suspendNativeRequest$1(this, null, this, bArr), continuation);
    }
    ...
    public final Object m127getArtboardNamesevklBmw(long j10, @NotNull Continuation<? super List<String>> continuation) {
        return g.g(m0.c().P1(), new CommandQueue$getArtboardNamesevklBmw$$inlined$suspendNativeRequest$1(this, null, this, j10), continuation);
    }
    ...
    public final Object m128getBooleanPropertyiFQtAB8(long j10, @NotNull String str, @NotNull Continuation<? super Boolean> continuation) {
        return g.g(m0.c().P1(), new CommandQueue$getBooleanPropertyiFQtAB8$$inlined$suspendNativeRequest$1(this, null, this, j10, str), continuation);
    }
    ...
    public final Object m129getColorPropertyiFQtAB8(long j10, @NotNull String str, @NotNull Continuation<? super Integer> continuation) {
        return g.g(m0.c().P1(), new CommandQueue$getColorPropertyiFQtAB8$$inlined$suspendNativeRequest$1(this, null, this, j10, str), continuation);
    }
    ...
    public final Object m130getEnumPropertyiFQtAB8(long j10, @NotNull String str, @NotNull Continuation<? super String> continuation) {
        return g.g(m0.c().P1(), new CommandQueue$getEnumPropertyiFQtAB8$$inlined$suspendNativeRequest$1(this, null, this, j10, str), continuation);
    }
    ...
    public final Object m131getEnumsevklBmw(long j10, @NotNull Continuation<? super List<File.Enum>> continuation) {
        return g.g(m0.c().P1(), new CommandQueue$getEnumsevklBmw$$inlined$suspendNativeRequest$1(this, null, this, j10), continuation);
    }
    ...
    public final Object m132getNumberPropertyiFQtAB8(long j10, @NotNull String str, @NotNull Continuation<? super Float> continuation) {
        return g.g(m0.c().P1(), new CommandQueue$getNumberPropertyiFQtAB8$$inlined$suspendNativeRequest$1(this, null, this, j10, str), continuation);
    }
    ...
    public final Object m133getStateMachineNamesb88yb0A(long j10, @NotNull Continuation<? super List<String>> continuation) {
        return g.g(m0.c().P1(), new CommandQueue$getStateMachineNamesb88yb0A$$inlined$suspendNativeRequest$1(this, null, this, j10), continuation);
    }
    ...
    public final Object m134getStringPropertyiFQtAB8(long j10, @NotNull String str, @NotNull Continuation<? super String> continuation) {
        return g.g(m0.c().P1(), new CommandQueue$getStringPropertyiFQtAB8$$inlined$suspendNativeRequest$1(this, null, this, j10, str), continuation);
    }
    ...
    public final Object m135getViewModelInstanceNamesmgMojzc(long j10, @NotNull String str, @NotNull Continuation<? super List<String>> continuation) {
        return g.g(m0.c().P1(), new CommandQueue$getViewModelInstanceNamesmgMojzc$$inlined$suspendNativeRequest$1(this, null, this, j10, str), continuation);
    }
    ...
    public final Object m136getViewModelNamesevklBmw(long j10, @NotNull Continuation<? super List<String>> continuation) {
        return g.g(m0.c().P1(), new CommandQueue$getViewModelNamesevklBmw$$inlined$suspendNativeRequest$1(this, null, this, j10), continuation);
    }
    ...
    public final Object m137getViewModelPropertiesmgMojzc(long j10, @NotNull String str, @NotNull Continuation<? super List<ViewModel.Property>> continuation) {
        return g.g(m0.c().P1(), new CommandQueue$getViewModelPropertiesmgMojzc$$inlined$suspendNativeRequest$1(this, null, this, j10, str), continuation);
    }
    ...
    public final Object m138loadFilexVnc2tA(@NotNull byte[] bArr, @NotNull Continuation<? super FileHandle> continuation) {
        return g.g(m0.c().P1(), new CommandQueue$loadFilexVnc2tA$$inlined$suspendNativeRequest$1(this, null, this, bArr), continuation);
    }
    ...
    public final void onTriggerPropertyUpdated(long j10, long j11, @NotNull String propertyName) {
        Intrinsics.checkNotNullParameter(propertyName, "propertyName");
        m107onPropertyUpdatedUrmHyfM(j10, j11, propertyName, Unit.f31988a, this._triggerPropertyFlow);
    }
