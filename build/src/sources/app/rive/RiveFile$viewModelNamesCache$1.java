...
public final class RiveFile$viewModelNamesCache$1 extends k implements Function1<Continuation<? super List<? extends String>>, Object> {
    ...
    public final Object invokeSuspend(@NotNull Object obj) {
        ...
        this.label = 1;
        Object m138getViewModelNamesevklBmw = commandQueue$kotlin_release.m138getViewModelNamesevklBmw(m33getFileHandleENT3xMk$kotlin_release, this);
        if (m138getViewModelNamesevklBmw == f10) {
            return f10;
        }
        return m138getViewModelNamesevklBmw;
    }

    @Override // kotlin.jvm.functions.Function1
    public final Object invoke(Continuation<? super List<String>> continuation) {
        return ((RiveFile$viewModelNamesCache$1) create(continuation)).invokeSuspend(Unit.f33074a);
    }
}
