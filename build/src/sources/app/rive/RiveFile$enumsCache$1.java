...
public final class RiveFile$enumsCache$1 extends k implements Function1<Continuation<? super List<? extends File.Enum>>, Object> {
    int label;
    final /* synthetic */ RiveFile this$0;

    /* JADX INFO: Access modifiers changed from: package-private */
    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public RiveFile$enumsCache$1(RiveFile riveFile, Continuation<? super RiveFile$enumsCache$1> continuation) {
    ...
    public final Object invoke(Continuation<? super List<File.Enum>> continuation) {
        return ((RiveFile$enumsCache$1) create(continuation)).invokeSuspend(Unit.f33298a);
    }
}
