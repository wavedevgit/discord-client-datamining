...
public abstract class RiveTextureView extends TextureView implements TextureView.SurfaceTextureListener {
    ...
    public RiveTextureView(@NotNull Context context, AttributeSet attributeSet) {
        ...
        this.activity$delegate = l.a(as.o.f6083i, new Function0<Activity>() { // from class: app.rive.runtime.kotlin.RiveTextureView$activity$2
        ...
        this.lifecycleObserver$delegate = l.b(new Function0<o>() { // from class: app.rive.runtime.kotlin.RiveTextureView$lifecycleObserver$2
            /* JADX INFO: Access modifiers changed from: package-private */
            {
                super(0);
            }
