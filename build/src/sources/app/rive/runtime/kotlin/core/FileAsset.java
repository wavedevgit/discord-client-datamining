...
public abstract class FileAsset extends NativeObject {
    ...
    private FileAsset(long j10, int i10) {
        ...
        this.name$delegate = l.a(new Function0<String>() { // from class: app.rive.runtime.kotlin.core.FileAsset$name$2
        ...
        this.uniqueFilename$delegate = l.a(new Function0<String>() { // from class: app.rive.runtime.kotlin.core.FileAsset$uniqueFilename$2
            /* JADX INFO: Access modifiers changed from: package-private */
            {
                super(0);
            }
        ...
        this.cdnUrl$delegate = l.a(new Function0<String>() { // from class: app.rive.runtime.kotlin.core.FileAsset$cdnUrl$2
            /* JADX INFO: Access modifiers changed from: package-private */
            {
                super(0);
            }
