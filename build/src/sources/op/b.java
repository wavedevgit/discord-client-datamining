...
public final class b extends j {
    ...
    public static final a f41645q = new a(null);

    /* loaded from: /home/runner/work/discord-client-datamining/discord-client-datamining/build/classes4.dex */
    public static final class a implements c0 {

        /* renamed from: a  reason: collision with root package name */
        private final /* synthetic */ gn.f f41646a;
        ...
        public View a(c initialRendering, a0 initialViewEnvironment, Context contextForNewView, ViewGroup viewGroup) {
            ...
            Intrinsics.checkNotNullParameter(contextForNewView, "contextForNewView");
            return this.f41646a.a(initialRendering, initialViewEnvironment, contextForNewView, viewGroup);
        }

        @Override // gn.c0
        public KClass getType() {
            return this.f41646a.getType();
        }

        private a() {
            this.f41646a = new gn.f(Reflection.getOrCreateKotlinClass(c.class), new Function4() { // from class: op.a
    ...
    public Dialog g(View view) {
        ...
        Dialog dialog = new Dialog(getContext(), tp.f.f50378a);
        Iterator it = s.d(view).iterator();
        while (true) {
            if (it.hasNext()) {
                obj = it.next();
                if (((View) obj).getTag(g.f41653a) instanceof Integer) {
                    break;
                }
            } else {
                obj = null;
