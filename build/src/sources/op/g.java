...
public final class g implements ViewBinding {
    ...
    public final ShapeableImageView f42614b;

    /* renamed from: c  reason: collision with root package name */
    public final TextView f42615c;
    ...
    private g(ConstraintLayout constraintLayout, ShapeableImageView shapeableImageView, TextView textView) {
        ...
        this.f42614b = shapeableImageView;
        this.f42615c = textView;
    }
    ...
    public static g c(LayoutInflater layoutInflater, ViewGroup viewGroup, boolean z10) {
        View inflate = layoutInflater.inflate(x0.f39568g, viewGroup, false);
        if (z10) {
