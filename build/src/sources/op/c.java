...
public final class c {
    ...
    public final List b() {
        return CollectionsKt.e(this.f44612b);
    }

    public final File c(String extension) {
        Intrinsics.checkNotNullParameter(extension, "extension");
        this.f44612b.mkdirs();
        File file = this.f44612b;
    ...
    public final File d(String fileName) {
        ...
        this.f44612b.mkdirs();
        return new File(this.f44612b, fileName);
    }
}
