...
public class n0 extends c {
    ...
    private final JsonObject f37566g;

    /* renamed from: h  reason: collision with root package name */
    private final SerialDescriptor f37567h;
    ...
    private final boolean H0(SerialDescriptor serialDescriptor, int i10, String str) {
        ...
        if (!Intrinsics.areEqual(g10.getKind(), k.b.f30494a) || (g10.b() && (o0(str) instanceof JsonNull))) {
            return false;
        }
    ...
    @Override // mt.c, kt.q2, kotlinx.serialization.encoding.Decoder
    public boolean D() {
        if (!this.f37569j && super.D()) {
            return true;
        }
        return false;
    }
    ...
    @Override // mt.c, kotlinx.serialization.encoding.Decoder
    public kotlinx.serialization.encoding.c b(SerialDescriptor descriptor) {
        Intrinsics.checkNotNullParameter(descriptor, "descriptor");
        if (descriptor == this.f37567h) {
            Json d10 = d();
            JsonElement p02 = p0();
            String h10 = this.f37567h.h();
            if (p02 instanceof JsonObject) {
                return new n0(d10, (JsonObject) p02, C0(), this.f37567h);
            }
    ...
    @Override // mt.c, kt.q2, kotlinx.serialization.encoding.c
    public void c(SerialDescriptor descriptor) {
        Set set;
        Set l10;
        Intrinsics.checkNotNullParameter(descriptor, "descriptor");
        if (!this.f37520f.k() && !(descriptor.getKind() instanceof jt.d)) {
            i0.m(descriptor, d());
            if (!this.f37520f.o()) {
                l10 = kt.q0.a(descriptor);
            } else {
                Set a10 = kt.q0.a(descriptor);
                Map map = (Map) lt.a0.a(d()).a(descriptor, i0.g());
                if (map != null) {
                    set = map.keySet();
                } else {
                    set = null;
    ...
    protected String i0(SerialDescriptor descriptor, int i10) {
        ...
        if (!this.f37520f.o() || D0().keySet().contains(e10)) {
            return e10;
        }
    ...
    public int o(SerialDescriptor descriptor) {
        Intrinsics.checkNotNullParameter(descriptor, "descriptor");
        while (this.f37568i < descriptor.d()) {
            int i10 = this.f37568i;
            this.f37568i = i10 + 1;
            String c02 = c0(descriptor, i10);
            int i11 = this.f37568i - 1;
            this.f37569j = false;
            if (D0().containsKey(c02) || G0(descriptor, i11)) {
                if (!this.f37520f.g() || !H0(descriptor, i11, c02)) {
                    return i11;
                }
            }
        }
