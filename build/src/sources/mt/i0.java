...
public abstract class i0 {
    ...
    private static final x.a f37544a = new x.a();

    /* renamed from: b  reason: collision with root package name */
    private static final x.a f37545b = new x.a();
    ...
    private static final Map b(SerialDescriptor serialDescriptor, Json json) {
        ...
        for (int i10 = 0; i10 < d11; i10++) {
            ...
            lt.t tVar = (lt.t) CollectionsKt.S0(arrayList);
    ...
    private static final void c(Map map, SerialDescriptor serialDescriptor, String str, int i10) {
        String str2;
        if (Intrinsics.areEqual(serialDescriptor.getKind(), k.b.f30494a)) {
            str2 = "enum value";
        } else {
            str2 = "property";
        }
    ...
    private static final boolean d(Json json, SerialDescriptor serialDescriptor) {
        if (json.e().h() && Intrinsics.areEqual(serialDescriptor.getKind(), k.b.f30494a)) {
            return true;
        }
        return false;
    }
    ...
    public static final Map e(final Json json, final SerialDescriptor descriptor) {
        ...
        return (Map) lt.a0.a(json).b(descriptor, f37544a, new Function0() { // from class: mt.h0
    ...
    public static final int j(SerialDescriptor serialDescriptor, Json json, String name, String suffix) {
        ...
        throw new gt.n(serialDescriptor.h() + " does not contain element with name '" + name + '\'' + suffix);
    }
    ...
    public static final lt.u m(SerialDescriptor serialDescriptor, Json json) {
        Intrinsics.checkNotNullParameter(serialDescriptor, "<this>");
        Intrinsics.checkNotNullParameter(json, "json");
        if (Intrinsics.areEqual(serialDescriptor.getKind(), l.a.f30495a)) {
            json.e().l();
        }
        return null;
    }
