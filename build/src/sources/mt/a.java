...
public final class a extends b {
    ...
    public final Map f38340b;

    /* renamed from: c  reason: collision with root package name */
    private final Map f38341c;

    /* renamed from: d  reason: collision with root package name */
    private final Map f38342d;

    /* renamed from: e  reason: collision with root package name */
    private final Map f38343e;
    ...
    public a(Map class2ContextualFactory, Map polyBase2Serializers, Map polyBase2DefaultSerializerProvider, Map polyBase2NamedSerializers, Map polyBase2DefaultDeserializerProvider, boolean z10) {
        ...
        this.f38339a = class2ContextualFactory;
        this.f38340b = polyBase2Serializers;
        this.f38341c = polyBase2DefaultSerializerProvider;
        this.f38342d = polyBase2NamedSerializers;
        this.f38343e = polyBase2DefaultDeserializerProvider;
        this.f38344f = z10;
    }
    ...
    public void a(d collector) {
        ...
        Iterator it = this.f38339a.entrySet().iterator();
        if (!it.hasNext()) {
            for (Map.Entry entry : this.f38340b.entrySet()) {
            ...
            for (Map.Entry entry3 : this.f38341c.entrySet()) {
            ...
            for (Map.Entry entry4 : this.f38343e.entrySet()) {
    ...
    public KSerializer b(KClass kClass, List typeArgumentsSerializers) {
        ...
        android.support.v4.media.session.b.a(this.f38339a.get(kClass));
        return null;
    }
    ...
    public o e(KClass baseClass, Object value) {
        ...
        Map map = (Map) this.f38340b.get(baseClass);
        if (map != null) {
        ...
        Object obj = this.f38341c.get(baseClass);
    ...
    public DeserializationStrategy f(KClass baseClass, String str) {
        ...
        Function1 function1;
        Intrinsics.checkNotNullParameter(baseClass, "baseClass");
        Map map = (Map) this.f38342d.get(baseClass);
        if (map != null) {
        ...
        Object obj = this.f38343e.get(baseClass);
        if (TypeIntrinsics.isFunctionOfArity(obj, 1)) {
            function1 = (Function1) obj;
        } else {
            function1 = null;
