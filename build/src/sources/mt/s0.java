...
public final class s0 implements nt.d {
    ...
    private final void d(SerialDescriptor serialDescriptor, KClass kClass) {
        ...
        for (int i10 = 0; i10 < d10; i10++) {
            ...
            if (Intrinsics.areEqual(e10, this.f37593b)) {
    ...
    private final void e(SerialDescriptor serialDescriptor, KClass kClass) {
        jt.k kind = serialDescriptor.getKind();
        if (!(kind instanceof jt.d) && !Intrinsics.areEqual(kind, k.a.f30493a)) {
            if (!this.f37592a) {
                if (!Intrinsics.areEqual(kind, l.b.f30496a) && !Intrinsics.areEqual(kind, l.c.f30497a) && !(kind instanceof jt.e) && !(kind instanceof k.b)) {
                    return;
                }
