...
class g {
    ...
    public g(c cVar) {
        this.f7290a = new c(cVar);
        this.f7291b = new d[(cVar.e() - cVar.g()) + 1];
    }
    ...
    public final d c(int i10) {
        ...
        for (int i11 = 1; i11 < 5; i11++) {
            int e10 = e(i10) - i11;
            if (e10 >= 0 && (dVar2 = this.f7291b[e10]) != null) {
                return dVar2;
            }
            int e11 = e(i10) + i11;
            d[] dVarArr = this.f7291b;
    ...
    public final int e(int i10) {
        return i10 - this.f7290a.g();
    }

    /* JADX INFO: Access modifiers changed from: package-private */
    public final void f(int i10, d dVar) {
        this.f7291b[e(i10)] = dVar;
    }
