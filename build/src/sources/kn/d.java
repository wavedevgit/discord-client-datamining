...
public final class d extends BaseReactPackage implements ViewManagerOnDemandReactPackage {
    ...
    private final Lazy f30954a = l.a(new Function0() { // from class: kn.a
    ...
    private final Map d() {
        return (Map) this.f30954a.getValue();
    }

    /* JADX INFO: Access modifiers changed from: private */
    public static final Map e() {
        return o0.f(v.a(RNGestureHandlerButtonViewManager.REACT_CLASS, ModuleSpec.Companion.viewManagerSpec(new Provider() { // from class: kn.c
    ...
    public ReactModuleInfoProvider getReactModuleInfoProvider() {
        try {
            ...
            return new ReactModuleInfoProvider() { // from class: kn.b
