...
public final class h {
    ...
    private ReanimatedModule f30956a;
    ...
    public final void a(Event event, ReactContext reactApplicationContext) {
        ...
        if (this.f30956a == null) {
            this.f30956a = (ReanimatedModule) reactApplicationContext.getNativeModule(ReanimatedModule.class);
        }
        ReanimatedModule reanimatedModule = this.f30956a;
