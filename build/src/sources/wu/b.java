...
public final class b extends yu.c {
    ...
    public static final a f54551d = new a(null);

    /* renamed from: b  reason: collision with root package name */
    private final X509TrustManager f54552b;

    /* renamed from: c  reason: collision with root package name */
    private final X509TrustManagerExtensions f54553c;
    ...
    public b(X509TrustManager trustManager, X509TrustManagerExtensions x509TrustManagerExtensions) {
        ...
        this.f54552b = trustManager;
        this.f54553c = x509TrustManagerExtensions;
    }
    ...
    public List a(List chain, String hostname) {
        ...
        try {
            List<X509Certificate> checkServerTrusted = this.f54553c.checkServerTrusted((X509Certificate[]) chain.toArray(new X509Certificate[0]), "RSA", hostname);
    ...
    public boolean equals(Object obj) {
        if ((obj instanceof b) && ((b) obj).f54552b == this.f54552b) {
            return true;
        }
        return false;
    }
    ...
    public int hashCode() {
        return System.identityHashCode(this.f54552b);
    }
}
