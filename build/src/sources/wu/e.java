...
public interface e extends mu.c {

    /* loaded from: /home/runner/work/discord-client-datamining/discord-client-datamining/build/classes5.dex */
    public static final class a {
        private static boolean a(e eVar, List list, Function2 function2) {
            boolean b10 = eVar.b(CollectionsKt.o((Comparable) CollectionsKt.firstOrNull(list), (Comparable) qv.c.b(list)), function2);
            boolean b11 = eVar.b(CollectionsKt.o((Comparable) qv.c.b(list), (Comparable) qv.c.c(list)), function2);
            if (!b10 || !b11) {
                return false;
            }
            return true;
        ...
        public static boolean c(e eVar, List list, Function2 operator) {
            List d10;
            Intrinsics.checkNotNullParameter(operator, "operator");
            if (list != null && (d10 = qv.a.d(list)) != null) {
                if (d10.size() == 2) {
