...
public final class c {
    ...
    private static final CopyOnWriteArraySet f54555b = new CopyOnWriteArraySet();

    /* renamed from: c  reason: collision with root package name */
    private static final Map f54556c;
    ...
    private final void c(String str, String str2) {
        ...
        if (f54555b.add(logger)) {
            ...
            logger.addHandler(d.f54557a);
        }
    }

    private final String d(String str) {
        String str2 = (String) f54556c.get(str);
        if (str2 == null) {
    ...
    public final void b() {
        for (Map.Entry entry : f54556c.entrySet()) {
