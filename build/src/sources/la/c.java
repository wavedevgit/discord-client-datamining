...
public final class c implements y8.a {
    ...
    public static final a f35794c = new a(null);

    /* renamed from: a  reason: collision with root package name */
    private final b f35795a;

    /* renamed from: b  reason: collision with root package name */
    private final com.facebook.imagepipeline.memory.d f35796b;
    ...
    public c(y poolFactory) {
        ...
        this.f35795a = new b(poolFactory.h());
    ...
    public Bitmap a(int i10, int i11, Bitmap.Config bitmapConfig) {
        ...
        CloseableReference a10 = this.f35795a.a((short) i10, (short) i11);
        ...
        try {
            ...
            BitmapFactory.Options b10 = f35794c.b(kVar.J(), bitmapConfig);
            int size = ((h) a10.J()).size();
            Object J = a10.J();
            Intrinsics.checkNotNullExpressionValue(J, "get(...)");
            CloseableReference a11 = this.f35796b.a(size + 2);
            Object J2 = a11.J();
