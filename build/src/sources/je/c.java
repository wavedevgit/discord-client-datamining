...
final class c {
    ...
    private static final Pattern f31481c = Pattern.compile("\\[voice=\"([^\"]*)\"\\]");

    /* renamed from: d  reason: collision with root package name */
    private static final Pattern f31482d = Pattern.compile("^((?:[0-9]*\\.)?[0-9]+)(px|em|%)$");

    /* renamed from: a  reason: collision with root package name */
    private final h0 f31483a = new h0();

    /* renamed from: b  reason: collision with root package name */
    private final StringBuilder f31484b = new StringBuilder();

    private void a(d dVar, String str) {
        if (!"".equals(str)) {
            int indexOf = str.indexOf(91);
            if (indexOf != -1) {
                Matcher matcher = f31481c.matcher(str.substring(indexOf));
                if (matcher.matches()) {
                    dVar.z((String) oe.a.e(matcher.group(1)));
                }
    ...
    private static void e(String str, d dVar) {
        Matcher matcher = f31482d.matcher(pi.b.e(str));
        if (!matcher.matches()) {
            y.i("WebvttCssParser", "Invalid font-size: '" + str + "'.");
            return;
        }
        String str2 = (String) oe.a.e(matcher.group(2));
        str2.getClass();
        char c10 = 65535;
        ...
        dVar.s(Float.parseFloat((String) oe.a.e(matcher.group(1))));
    }
    ...
    public List d(h0 h0Var) {
        boolean z10;
        this.f31484b.setLength(0);
        int f10 = h0Var.f();
        m(h0Var);
        this.f31483a.S(h0Var.e(), h0Var.f());
        this.f31483a.U(f10);
        ArrayList arrayList = new ArrayList();
        while (true) {
            String i10 = i(this.f31483a, this.f31484b);
            if (i10 == null || !"{".equals(g(this.f31483a, this.f31484b))) {
                break;
            }
            d dVar = new d();
            a(dVar, i10);
            ...
            boolean z11 = false;
            while (!z11) {
                int f11 = this.f31483a.f();
                String g10 = g(this.f31483a, this.f31484b);
                ...
                if (!z10) {
                    this.f31483a.U(f11);
                    j(this.f31483a, dVar, this.f31484b);
                }
                str = g10;
                z11 = z10;
            }
