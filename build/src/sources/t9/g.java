...
public final class g implements j {
    ...
    public static final b f49330n = new b(null);

    /* renamed from: a  reason: collision with root package name */
    private final PlatformBitmapFactory f49331a;

    /* renamed from: b  reason: collision with root package name */
    private final p9.c f49332b;

    /* renamed from: c  reason: collision with root package name */
    private final s9.c f49333c;

    /* renamed from: d  reason: collision with root package name */
    private final o9.d f49334d;

    /* renamed from: e  reason: collision with root package name */
    private final int f49335e;

    /* renamed from: f  reason: collision with root package name */
    private final int f49336f;

    /* renamed from: g  reason: collision with root package name */
    private final ConcurrentHashMap f49337g;

    /* renamed from: h  reason: collision with root package name */
    private volatile int f49338h;

    /* renamed from: i  reason: collision with root package name */
    private volatile boolean f49339i;

    /* renamed from: j  reason: collision with root package name */
    private final h f49340j;
    ...
    public static final class a {
        ...
        /* renamed from: a  reason: collision with root package name */
        private final CloseableReference f49344a;
        ...
        public final boolean b() {
            if (!this.f49345b && this.f49344a.F0()) {
                return true;
            }
            return false;
        }
        ...
        public final void c() {
            CloseableReference.N(this.f49344a);
        }
    ...
    public g(PlatformBitmapFactory platformBitmapFactory, p9.c bitmapFrameRenderer, s9.c fpsCompressor, o9.d animationInformation, int i10) {
        ...
        this.f49331a = platformBitmapFactory;
        this.f49332b = bitmapFrameRenderer;
        this.f49333c = fpsCompressor;
        this.f49334d = animationInformation;
        this.f49335e = i10;
        int d10 = kotlin.ranges.d.d((k(l()) * i10) / 1000, 1);
        this.f49336f = d10;
        this.f49337g = new ConcurrentHashMap();
        this.f49340j = new h(l().a());
        this.f49341k = -1;
        this.f49342l = o0.i();
        this.f49343m = x0.d();
        d(k(l()));
        this.f49338h = (int) (d10 * 0.5f);
    }
    ...
    private final boolean g(int i10, int i11, int i12, int i13) {
        ...
        for (Object obj : this.f49340j.d(i10, this.f49336f)) {
            if (this.f49343m.contains(Integer.valueOf(((Number) obj).intValue()))) {
                arrayList.add(obj);
            }
        }
        Set l12 = CollectionsKt.l1(arrayList);
        Set keySet = this.f49337g.keySet();
        Intrinsics.checkNotNullExpressionValue(keySet, "<get-keys>(...)");
        ArrayDeque arrayDeque = new ArrayDeque(x0.j(keySet, l12));
        for (Number number : arrayList) {
            int intValue2 = number.intValue();
            if (this.f49337g.get(Integer.valueOf(intValue2)) == null) {
                int i14 = this.f49341k;
                int i15 = -1;
                ...
                a aVar = (a) this.f49337g.get(Integer.valueOf(i15));
                ...
                if (closeableReference == null) {
                    CloseableReference a11 = this.f49331a.a(i11, i12);
                ...
                try {
                    ...
                    this.f49337g.remove(Integer.valueOf(i15));
                    aVar.d(false);
                    this.f49337g.put(Integer.valueOf(intValue2), aVar);
                } finally {
                }
            }
        }
        if (arrayList.isEmpty()) {
            intValue = (int) (this.f49336f * 0.5f);
        } else {
            int size = arrayList.size();
            intValue = ((Number) arrayList.get(kotlin.ranges.d.m((int) (size * 0.5f), 0, size - 1))).intValue();
        }
        this.f49338h = intValue;
        return true;
    }
    ...
    private final t9.a i(int i10) {
        t9.a aVar;
        Iterator it = new IntRange(0, this.f49340j.b()).iterator();
        do {
            aVar = null;
            if (!it.hasNext()) {
                break;
            }
            int a10 = this.f49340j.a(i10 - ((m0) it).nextInt());
            a aVar2 = (a) this.f49337g.get(Integer.valueOf(a10));
            if (aVar2 != null) {
                if (!aVar2.b()) {
                    aVar2 = null;
                }
    ...
    private final l j(int i10) {
        ...
        if (i11 != null) {
            ...
            this.f49341k = i11.h();
            return new l(clone, l.a.f49355e);
        }
        return new l(null, l.a.f49356i);
    }
    ...
    private final void m(final int i10, final int i11) {
        ...
        this.f49339i = true;
        s9.b.f48853a.b(new Runnable() { // from class: t9.f
    ...
    public static final void n(g this$0, int i10, int i11) {
        ...
        while (true) {
            ...
            int i12 = i10;
            int i13 = i11;
            if (h(gVar, kotlin.ranges.d.d(this$0.f49341k, 0), i12, i13, 0, 8, null)) {
                gVar.f49339i = false;
                return;
            }
            this$0 = gVar;
    ...
    public l c(int i10, int i11, int i12) {
        Integer num = (Integer) this.f49342l.get(Integer.valueOf(i10));
        if (num != null) {
            int intValue = num.intValue();
            this.f49341k = intValue;
            a aVar = (a) this.f49337g.get(num);
            if (aVar == null || !aVar.b()) {
                aVar = null;
            }
            if (aVar != null) {
                if (this.f49340j.c(this.f49338h, intValue, this.f49336f)) {
                    m(i11, i12);
                }
                return new l(aVar.a().clone(), l.a.f49354d);
            }
            m(i11, i12);
            return j(intValue);
        }
    ...
    @Override // t9.j
    public void clear() {
        Collection<a> values = this.f49337g.values();
    ...
    public void d(int i10) {
        Map a10 = this.f49333c.a(l().j() * kotlin.ranges.d.d(l().b(), 1), l().a(), kotlin.ranges.d.i(i10, k(l())));
        this.f49342l = a10;
        this.f49343m = CollectionsKt.l1(a10.values());
    }
