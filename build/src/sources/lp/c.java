...
public final class c implements ViewBinding {
    ...
    private final View f37415a;

    /* renamed from: b  reason: collision with root package name */
    public final ImageView f37416b;

    /* renamed from: c  reason: collision with root package name */
    public final ImageView f37417c;

    private c(View view, ImageView imageView, ImageView imageView2) {
        this.f37415a = view;
        this.f37416b = imageView;
        this.f37417c = imageView2;
    }
    ...
    public static c b(LayoutInflater layoutInflater, ViewGroup viewGroup) {
        if (viewGroup != null) {
            layoutInflater.inflate(n.f32342c, viewGroup);
            return a(viewGroup);
        }
