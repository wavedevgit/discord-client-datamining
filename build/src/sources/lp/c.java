...
public final class c extends FrameLayout {
    ...
    private final gp.b f35954d;

    /* renamed from: e  reason: collision with root package name */
    private final e f35955e;

    /* loaded from: /home/runner/work/discord-client-datamining/discord-client-datamining/build/classes4.dex */
    public static final class a implements c0 {

        /* renamed from: a  reason: collision with root package name */
        private final /* synthetic */ f f35956a;
        ...
        public View a(d initialRendering, a0 initialViewEnvironment, Context contextForNewView, ViewGroup viewGroup) {
            ...
            return this.f35956a.a(initialRendering, initialViewEnvironment, contextForNewView, viewGroup);
        }

        @Override // gn.c0
        public KClass getType() {
            return this.f35956a.getType();
        }

        private a() {
            this.f35956a = new f(Reflection.getOrCreateKotlinClass(d.class), new Function4() { // from class: lp.b
    ...
    private final View b(d dVar, a0 a0Var) {
        ...
        if (currentView != null) {
            ...
            if (view != null) {
                this.f35955e.d(CollectionsKt.e(nVar));
        ...
        View c11 = f0.c((e0) a0Var.a(e0.f25802a), nVar, a0Var, context, this, new h0() { // from class: lp.a
            @Override // gn.h0
        ...
        g0.h(c11);
        this.f35955e.h(CollectionsKt.l(), currentView, c11);
        this.f35954d.f25959c.removeView(currentView);
        this.f35954d.f25959c.addView(c11);
    ...
    private final View getCurrentView() {
        if (this.f35954d.f25959c.getChildCount() > 0) {
            return this.f35954d.f25959c.getChildAt(0);
        }
        return null;
    }
    ...
    public final void d(d newRendering, a0 newViewEnvironment) {
        ...
        if (!isEnabled()) {
            b10.setAlpha(0.5f);
            this.f35954d.f25958b.setVisibility(0);
            return;
        }
        b10.setAlpha(1.0f);
        this.f35954d.f25958b.setVisibility(8);
    }
    ...
    protected void onAttachedToWindow() {
        ...
        this.f35955e.a(g.a.b(aVar, c10, null, 2, null), c11);
    }
    ...
    protected Parcelable onSaveInstanceState() {
        ...
        if (onSaveInstanceState != null) {
            return new b(onSaveInstanceState, this.f35955e.g());
        }
        return null;
    }
    ...
    public static final class b extends View.BaseSavedState {
        ...
        public void writeToParcel(Parcel out, int i10) {
            ...
            out.writeParcelable(this.f35957d, i10);
        }
        ...
        public b(Parcel source) {
            ...
            this.f35957d = (e.a) readParcelable;
        }
    }
