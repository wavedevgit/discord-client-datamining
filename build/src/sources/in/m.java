...
public final class m extends d {
    ...
    private Handler O;
    private Runnable P = new Runnable() { // from class: in.l
    ...
    public static final class b extends d.c {
        ...
        private final Class f27558b = m.class;

        /* renamed from: c  reason: collision with root package name */
        private final String f27559c = "HoverGestureHandler";
        ...
        @Override // in.d.c
        /* renamed from: h */
        public jn.c c(m handler) {
            Intrinsics.checkNotNullParameter(handler, "handler");
            return new jn.c(handler);
        }
    }
