...
public final class c extends g {
    ...
    public static final b f27042q = new b(null);
    ...
    public static final class b implements c0 {
        ...
        private final /* synthetic */ a f27047a;
        ...
        public View a(d initialRendering, a0 initialViewEnvironment, Context contextForNewView, ViewGroup viewGroup) {
            ...
            return this.f27047a.a(initialRendering, initialViewEnvironment, contextForNewView, viewGroup);
        }

        @Override // en.c0
        public KClass getType() {
            return this.f27047a.getType();
        }

        private b() {
            this.f27047a = new a(0, 1, null);
        }
    }
    ...
    private final int h(e.a aVar) {
        int i10 = C0406c.f27048a[aVar.ordinal()];
        if (i10 != 1) {
            if (i10 != 2) {
                if (i10 == 3) {
                    return -3;
    ...
    public static final void i(e rendering, DialogInterface dialogInterface) {
        ...
        rendering.d().invoke(e.b.C0407b.f27061a);
    }
    ...
    protected void d(g.a dialogRef) {
        ...
        int i10 = 0;
        if (eVar.b()) {
            aVar.setOnCancelListener(new DialogInterface.OnCancelListener() { // from class: in.a
        ...
        while (i10 < length) {
            ...
            if (str == null) {
                ...
                aVar.n(h(aVar2), str, new DialogInterface.OnClickListener() { // from class: in.b
    ...
    public g.a b(e initialModalRendering, a0 initialViewEnvironment) {
        ...
        Intrinsics.checkNotNullParameter(initialViewEnvironment, "initialViewEnvironment");
        androidx.appcompat.app.a create = new a.C0018a(getContext(), this.f27043p).create();
    ...
    public static final class a implements c0 {
        ...
        private final /* synthetic */ en.f f27045b;

        /* renamed from: in.c$a$a  reason: collision with other inner class name */
        /* loaded from: /home/runner/work/discord-client-datamining/discord-client-datamining/build/classes4.dex */
        static final class C0404a extends Lambda implements Function4 {

            /* renamed from: d  reason: collision with root package name */
            final /* synthetic */ int f27046d;

            /* JADX INFO: Access modifiers changed from: package-private */
            /* renamed from: in.c$a$a$a  reason: collision with other inner class name */
            /* loaded from: /home/runner/work/discord-client-datamining/discord-client-datamining/build/classes4.dex */
            public /* synthetic */ class C0405a extends FunctionReferenceImpl implements Function2 {
                C0405a(Object obj) {
            ...
            public final View invoke(d initialRendering, a0 initialEnv, Context context, ViewGroup viewGroup) {
                ...
                Intrinsics.checkNotNullParameter(context, "context");
                c cVar = new c(context, null, 0, 0, this.f27046d, 14, null);
                cVar.setId(hn.a.f26366b);
                cVar.setLayoutParams(new ViewGroup.LayoutParams(-1, -1));
                g0.a(cVar, initialRendering, initialEnv, new C0405a(cVar));
                return cVar;
            }
        }
        ...
        public a(int i10) {
            this.f27044a = i10;
            this.f27045b = new en.f(Reflection.getOrCreateKotlinClass(d.class), new C0404a(i10));
        }
        ...
        public View a(d initialRendering, a0 initialViewEnvironment, Context contextForNewView, ViewGroup viewGroup) {
            ...
            Intrinsics.checkNotNullParameter(initialViewEnvironment, "initialViewEnvironment");
            Intrinsics.checkNotNullParameter(contextForNewView, "contextForNewView");
            return this.f27045b.a(initialRendering, initialViewEnvironment, contextForNewView, viewGroup);
        }

        @Override // en.c0
        public KClass getType() {
            return this.f27045b.getType();
        }
