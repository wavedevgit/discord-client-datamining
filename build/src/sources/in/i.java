...
public final class i {
    ...
    public static final a f27536n = new a(null);

    /* renamed from: o  reason: collision with root package name */
    private static final PointF f27537o = new PointF();

    /* renamed from: p  reason: collision with root package name */
    private static final float[] f27538p = new float[2];

    /* renamed from: q  reason: collision with root package name */
    private static final Matrix f27539q = new Matrix();

    /* renamed from: r  reason: collision with root package name */
    private static final float[] f27540r = new float[2];

    /* renamed from: s  reason: collision with root package name */
    private static final Comparator f27541s = new Comparator() { // from class: in.f
    ...
    private final ViewGroup f27542a;

    /* renamed from: b  reason: collision with root package name */
    private final j f27543b;

    /* renamed from: c  reason: collision with root package name */
    private final d0 f27544c;

    /* renamed from: d  reason: collision with root package name */
    private final ViewGroup f27545d;

    /* renamed from: e  reason: collision with root package name */
    private float f27546e;

    /* renamed from: f  reason: collision with root package name */
    private final ArrayList f27547f;

    /* renamed from: g  reason: collision with root package name */
    private final ArrayList f27548g;

    /* renamed from: h  reason: collision with root package name */
    private final ArrayList f27549h;

    /* renamed from: i  reason: collision with root package name */
    private final HashSet f27550i;
    ...
    public static final class a {
        ...
        public final void n(float f10, float f11, ViewGroup viewGroup, View view, PointF pointF) {
            ...
            if (!matrix.isIdentity()) {
                float[] fArr = i.f27538p;
                fArr[0] = scrollX;
                fArr[1] = scrollY;
                matrix.invert(i.f27539q);
                i.f27539q.mapPoints(fArr);
                float f12 = fArr[0];
                scrollY = fArr[1];
                scrollX = f12;
            }
    ...
    public /* synthetic */ class b {
        ...
        static {
            ...
            try {
                iArr[v.f27601d.ordinal()] = 1;
            } catch (NoSuchFieldError unused) {
            }
            try {
                iArr[v.f27603i.ordinal()] = 2;
            } catch (NoSuchFieldError unused2) {
            }
            try {
                iArr[v.f27602e.ordinal()] = 3;
            } catch (NoSuchFieldError unused3) {
            }
            try {
                iArr[v.f27604o.ordinal()] = 4;
    ...
    public i(ViewGroup wrapperView, j handlerRegistry, d0 viewConfigHelper, ViewGroup rootView) {
        ...
        this.f27542a = wrapperView;
        this.f27543b = handlerRegistry;
        this.f27544c = viewConfigHelper;
        this.f27545d = rootView;
        this.f27547f = new ArrayList();
        this.f27548g = new ArrayList();
        this.f27549h = new ArrayList();
        this.f27550i = new HashSet();
    }

    private final void C(d dVar, View view) {
        if (this.f27547f.contains(dVar)) {
            return;
        }
        this.f27547f.add(dVar);
        dVar.w0(false);
        dVar.x0(false);
    ...
    private final boolean D(View view, float[] fArr, int i10, MotionEvent motionEvent) {
        boolean z10;
        ArrayList a10 = this.f27543b.a(view);
        if (a10 != null) {
            synchronized (a10) {
                try {
    ...
    private final void E() {
        if (!this.f27551j && this.f27552k == 0) {
            l();
        } else {
            this.f27553l = true;
        }
    ...
    private final boolean G(d dVar) {
        ArrayList<d> arrayList = this.f27547f;
        if (arrayList != null && arrayList.isEmpty()) {
            return false;
        }
        for (d dVar2 : arrayList) {
            if (dVar.Y(dVar2) && dVar2.S() == 4 && !f27536n.h(dVar, dVar2) && dVar.c0(dVar2)) {
                return true;
            }
        }
        return false;
    ...
    private final boolean H(d dVar) {
        ...
        for (d dVar2 : arrayList) {
            if (f27536n.l(dVar, dVar2) && dVar2.S() == 5) {
                return true;
            }
        }
        return false;
    ...
    private final boolean J(View view) {
        if ((view instanceof RNGestureHandlerRootView) && !Intrinsics.areEqual(view, this.f27542a) && ((RNGestureHandlerRootView) view).isRootViewEnabled()) {
            return true;
        }
        return false;
    }
    ...
    private final boolean M(View view, float[] fArr, int i10, MotionEvent motionEvent) {
        ...
        int i11 = b.f27555a[this.f27544c.a(view).ordinal()];
        if (i11 == 1) {
            return false;
        }
        if (i11 != 2) {
            if (i11 != 3) {
                if (i11 == 4) {
                    ...
                    if (!D(view, fArr, i10, motionEvent) && !z10 && !f27536n.m(view, fArr)) {
                        return false;
                    }
                    return true;
                }
        ...
        } else if (!D(view, fArr, i10, motionEvent) && !f27536n.m(view, fArr)) {
            return false;
        } else {
            return true;
        }
    ...
    private final void h(d dVar) {
        if (this.f27548g.contains(dVar)) {
            return;
        }
        this.f27548g.add(dVar);
        this.f27550i.add(Integer.valueOf(dVar.T()));
        dVar.x0(true);
        int i10 = this.f27554m;
        this.f27554m = i10 + 1;
        dVar.v0(i10);
    }

    private final boolean i(View view) {
        if (view.getVisibility() == 0 && view.getAlpha() >= this.f27546e) {
            return true;
        }
        return false;
    }
    ...
    private final void j() {
        for (d dVar : CollectionsKt.h1(CollectionsKt.T(this.f27548g))) {
            dVar.q();
        }
        for (d dVar2 : CollectionsKt.T(this.f27547f)) {
            dVar2.q();
        }
    }

    private final void k() {
        for (d dVar : CollectionsKt.h1(this.f27548g)) {
            if (!dVar.a0()) {
                this.f27548g.remove(dVar);
                this.f27550i.remove(Integer.valueOf(dVar.T()));
            }
        }
    }

    private final void l() {
        for (d dVar : CollectionsKt.T(this.f27547f)) {
            if (f27536n.i(dVar.S()) && !dVar.a0()) {
                dVar.r0();
                dVar.w0(false);
                dVar.x0(false);
                dVar.v0(Integer.MAX_VALUE);
        ...
        CollectionsKt.J(this.f27547f, new Function1() { // from class: in.g
    ...
    private final void o(MotionEvent motionEvent) {
        List<d> j12 = CollectionsKt.j1(this.f27547f);
        CollectionsKt.A(j12, f27541s);
        for (d dVar : j12) {
            n(dVar, motionEvent);
        }
    }
    ...
    private final boolean p(View view, float[] fArr, int i10) {
        ...
        for (ViewParent parent = view.getParent(); parent != null; parent = parent.getParent()) {
            if (parent instanceof ViewGroup) {
                ...
                ArrayList a10 = this.f27543b.a((View) parent);
                if (a10 != null) {
                    synchronized (a10) {
                        try {
                            Iterator it = a10.iterator();
    ...
    private final void q(MotionEvent motionEvent) {
        ...
        M(this.f27542a, fArr, pointerId, motionEvent);
        r(this.f27542a, fArr, pointerId, motionEvent);
    }
    ...
    private final boolean r(ViewGroup viewGroup, float[] fArr, int i10, MotionEvent motionEvent) {
        ...
        while (-1 < childCount) {
            View c10 = this.f27544c.c(viewGroup, childCount);
            if (i(c10)) {
                PointF pointF = f27537o;
                a aVar = f27536n;
    ...
    private final boolean w(View view) {
        if ((view instanceof ViewGroup) && !this.f27544c.b((ViewGroup) view)) {
            return false;
        }
        return true;
    }
    ...
    private final boolean x(View view) {
        ...
        if (view == this.f27542a) {
            return true;
        }
        ViewParent parent = view.getParent();
        while (parent != null && parent != this.f27542a) {
            parent = parent.getParent();
        }
        if (parent != this.f27542a) {
            return false;
        }
        return true;
    }
    ...
    private final void z(d dVar) {
        ...
        dVar.v0(i10);
        for (d dVar2 : CollectionsKt.T(this.f27547f)) {
            if (f27536n.k(dVar2, dVar)) {
                dVar2.q();
            }
        }
        for (d dVar3 : CollectionsKt.T(this.f27548g)) {
            if (f27536n.k(dVar3, dVar)) {
                dVar3.x0(false);
            }
        }
        k();
    ...
    public final void A(d handler, int i10, int i11) {
        ...
        if (f27536n.i(i10)) {
            for (d dVar : CollectionsKt.h1(this.f27548g)) {
                if (f27536n.l(dVar, handler) && this.f27550i.contains(Integer.valueOf(dVar.T()))) {
                    if (i10 == 5) {
                        dVar.q();
                        if (dVar.S() == 5) {
                            dVar.w(3, 2);
    ...
    */
    public final boolean B(android.view.MotionEvent r5) {
        ...
        L30:
            ...
            goto L4d
        L39:
            java.util.ArrayList r1 = r4.f27547f
            boolean r1 = r1.isEmpty()
            if (r1 == 0) goto L4d
            android.view.ViewGroup r1 = r4.f27545d
        ...
        L4d:
            return r0
        */
        throw new UnsupportedOperationException("Method not decompiled: in.i.B(android.view.MotionEvent):boolean");
    }
    ...
    public final MotionEvent K(View view, MotionEvent event) {
        ...
        if (view != null) {
            ...
            if (!Intrinsics.areEqual(viewGroup, this.f27542a)) {
                K(viewGroup, event);
            }
            if (viewGroup != null) {
    ...
    public final void f(View view) {
        ...
        ArrayList<d> a10 = this.f27543b.a(view);
        if (a10 != null) {
            for (final d dVar : a10) {
                if (dVar instanceof q) {
                    C(dVar, view);
                    dVar.T0(new Function0() { // from class: in.h
