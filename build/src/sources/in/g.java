...
public abstract class g extends FrameLayout {
    ...
    private final WorkflowViewStub f27062d;

    /* renamed from: e  reason: collision with root package name */
    private List f27063e;

    /* renamed from: i  reason: collision with root package name */
    private final Lazy f27064i;

    /* renamed from: o  reason: collision with root package name */
    private final fn.f f27065o;
    ...
    public static final class b implements Parcelable {
        ...
        public boolean equals(Object obj) {
            ...
            b bVar = (b) obj;
            if (Intrinsics.areEqual(this.f27071d, bVar.f27071d) && Intrinsics.areEqual(this.f27072e, bVar.f27072e)) {
                return true;
            }
            return false;
        }
        ...
        public int hashCode() {
            return (this.f27071d.hashCode() * 31) + this.f27072e.hashCode();
        }

        public String toString() {
            return "KeyAndBundle(compatibilityKey=" + this.f27071d + ", bundle=" + this.f27072e + ')';
        }
        ...
        public void writeToParcel(Parcel parcel, int i10) {
            ...
            parcel.writeBundle(this.f27072e);
        }
    }
    ...
    static final class d extends Lambda implements Function0 {
        ...
        public final fn.d invoke() {
            fn.d c10 = fn.d.f22751f.c(g.this);
            if (c10 != null) {
                return c10;
            }
    ...
    public static final class f implements View.OnAttachStateChangeListener {
        ...
        /* renamed from: e  reason: collision with root package name */
        private Lifecycle f27077e;

        /* renamed from: i  reason: collision with root package name */
        final /* synthetic */ a f27078i;
        ...
        public void onViewAttachedToWindow(View v10) {
            ...
            Lifecycle lifecycle = this.f27079o.getParentLifecycleOwner().getLifecycle();
            lifecycle.a(a());
            this.f27077e = lifecycle;
        }

        @Override // android.view.View.OnAttachStateChangeListener
        public void onViewDetachedFromWindow(View v10) {
            Intrinsics.checkNotNullParameter(v10, "v");
            Lifecycle lifecycle = this.f27077e;
            if (lifecycle != null) {
                lifecycle.d(this.f27076d);
            }
            this.f27077e = null;
        }
    }
    ...
    public g(Context context, AttributeSet attributeSet, int i10, int i11) {
        ...
        this.f27062d = workflowViewStub;
        this.f27063e = CollectionsKt.l();
        this.f27064i = l.b(o.f49211i, new d());
        this.f27065o = new fn.f();
    }

    /* JADX INFO: Access modifiers changed from: private */
    public final fn.d getParentLifecycleOwner() {
        return (fn.d) this.f27064i.getValue();
    }

    protected abstract a b(Object obj, a0 a0Var);

    /* JADX INFO: Access modifiers changed from: protected */
    public final void c(in.f newScreen, a0 viewEnvironment) {
        a0 a0Var;
        a b10;
        View b11;
        Intrinsics.checkNotNullParameter(newScreen, "newScreen");
        Intrinsics.checkNotNullParameter(viewEnvironment, "viewEnvironment");
        this.f27062d.c(newScreen.b(), viewEnvironment);
        ArrayList<a> arrayList = new ArrayList();
        int i10 = 0;
        for (Object obj : newScreen.a()) {
            int i11 = i10 + 1;
            if (i10 < this.f27063e.size() && en.h.a(((a) this.f27063e.get(i10)).f(), obj)) {
                a0Var = viewEnvironment;
                b10 = a.b((a) this.f27063e.get(i10), obj, a0Var, null, null, 12, null);
                d(b10);
            } else {
                a0Var = viewEnvironment;
                b10 = b(obj, a0Var);
                b10.k(en.g.f21796a.a(obj, String.valueOf(i10)));
                b11 = h.b(b10.d());
                if (b11 != null) {
                    fn.d.f22751f.d(b11, new e());
                    this.f27065o.h(b11, b10.g());
        ...
        for (a aVar : CollectionsKt.H0(this.f27063e, arrayList)) {
            aVar.c();
        }
        fn.f fVar = this.f27065o;
    ...
    protected void onAttachedToWindow() {
        ...
        this.f27065o.f(g.a.b(aVar, c10, null, 2, null), c11);
    }
    ...
    protected void onRestoreInstanceState(Parcelable state) {
        ...
        if (cVar != null) {
            if (cVar.a().size() == this.f27063e.size()) {
                List a10 = cVar.a();
    ...
    public static final class c extends View.BaseSavedState {
        ...
        public void writeToParcel(Parcel out, int i10) {
            ...
            out.writeTypedList(this.f27073d);
        }
    ...
    public static final class a {
        ...
        private final Object f27066a;

        /* renamed from: b  reason: collision with root package name */
        private final a0 f27067b;

        /* renamed from: c  reason: collision with root package name */
        private final Dialog f27068c;
        ...
        public a(Object modalRendering, a0 viewEnvironment, Dialog dialog, Object obj) {
            ...
            this.f27066a = modalRendering;
            this.f27067b = viewEnvironment;
            this.f27068c = dialog;
            this.f27069d = obj;
        }
        ...
        public final void c() {
            View b10;
            fn.d c10;
            b10 = h.b(this.f27068c);
            if (b10 != null && (c10 = fn.d.f22751f.c(b10)) != null) {
                c10.e();
            }
            this.f27068c.dismiss();
        }
        ...
        public boolean equals(Object obj) {
            ...
            if (obj != null) {
                if (Intrinsics.areEqual(this.f27068c, ((a) obj).f27068c)) {
                    return true;
                }
                return false;
            }
        ...
        public int hashCode() {
            return this.f27068c.hashCode();
        }

        public final void i(b keyAndBundle) {
            Intrinsics.checkNotNullParameter(keyAndBundle, "keyAndBundle");
            if (Intrinsics.areEqual(g.a.b(en.g.f21796a, this.f27066a, null, 2, null), keyAndBundle.b())) {
                Window window = this.f27068c.getWindow();
        ...
        public final b j() {
            ...
            String b10 = g.a.b(en.g.f21796a, this.f27066a, null, 2, null);
