...
public final class e {
    ...
    private static final e[] f46608h = a();
    ...
    private final int f46612d;

    /* renamed from: e  reason: collision with root package name */
    private final int f46613e;

    /* renamed from: f  reason: collision with root package name */
    private final c f46614f;
    ...
    public static e h(int i10, int i11) {
        ...
        if ((i10 & 1) == 0 && (i11 & 1) == 0) {
            for (e eVar : f46608h) {
                if (eVar.f46610b == i10 && eVar.f46611c == i11) {
                    return eVar;
                }
            }
            throw g.a();
    ...
    public String toString() {
        return String.valueOf(this.f46609a);
    }
    ...
    public static final class c {
        ...
        private c(int i10, b bVar) {
            this.f46618a = i10;
            this.f46619b = new b[]{bVar};
        }

        private c(int i10, b bVar, b bVar2) {
            this.f46618a = i10;
            this.f46619b = new b[]{bVar, bVar2};
        }
    }
}
