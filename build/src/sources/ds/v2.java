...
public final class v2 implements kotlin.reflect.l, x0 {
    ...
    static final /* synthetic */ KProperty[] f22329o = {Reflection.property1(new PropertyReference1Impl(v2.class, "upperBounds", "getUpperBounds()Ljava/util/List;", 0))};

    /* renamed from: d  reason: collision with root package name */
    private final TypeParameterDescriptor f22330d;

    /* renamed from: e  reason: collision with root package name */
    private final z2.a f22331e;

    /* renamed from: i  reason: collision with root package name */
    private final w2 f22332i;
    ...
    public v2(w2 w2Var, TypeParameterDescriptor descriptor) {
        ...
        this.f22330d = descriptor;
        this.f22331e = z2.c(new u2(this));
        if (w2Var == null) {
            ...
            if (containingDeclaration instanceof ClassDescriptor) {
                ...
                if (containingDeclaration2 instanceof ClassDescriptor) {
                    ...
                    if (deserializedMemberDescriptor != null) {
                        KClass e10 = wr.a.e(b(deserializedMemberDescriptor));
                ...
                accept = containingDeclaration.accept(new j(w0Var), Unit.f33074a);
            } else {
    ...
    public boolean equals(Object obj) {
        if (obj instanceof v2) {
            v2 v2Var = (v2) obj;
            if (Intrinsics.areEqual(this.f22332i, v2Var.f22332i) && Intrinsics.areEqual(getName(), v2Var.getName())) {
                return true;
            }
            return false;
        }
    ...
    public List getUpperBounds() {
        Object b10 = this.f22331e.b(this, f22329o[0]);
    ...
    public kotlin.reflect.m getVariance() {
        int i10 = a.f22333a[getDescriptor().getVariance().ordinal()];
        if (i10 != 1) {
            if (i10 != 2) {
                if (i10 == 3) {
                    return kotlin.reflect.m.f35915i;
                }
                throw new jr.p();
            }
            return kotlin.reflect.m.f35914e;
        }
        return kotlin.reflect.m.f35913d;
    }

    public int hashCode() {
        return (this.f22332i.hashCode() * 31) + getName().hashCode();
    }
