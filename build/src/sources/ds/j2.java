...
public abstract class j2 extends a0 implements KProperty {
    ...
    public static final b f22223x = new b(null);

    /* renamed from: y  reason: collision with root package name */
    private static final Object f22224y = new Object();

    /* renamed from: r  reason: collision with root package name */
    private final c1 f22225r;

    /* renamed from: s  reason: collision with root package name */
    private final String f22226s;

    /* renamed from: t  reason: collision with root package name */
    private final String f22227t;

    /* renamed from: u  reason: collision with root package name */
    private final Object f22228u;

    /* renamed from: v  reason: collision with root package name */
    private final Lazy f22229v;

    /* renamed from: w  reason: collision with root package name */
    private final z2.a f22230w;
    ...
    public static abstract class c extends a implements KProperty.b {
        ...
        /* renamed from: t  reason: collision with root package name */
        static final /* synthetic */ KProperty[] f22231t = {Reflection.property1(new PropertyReference1Impl(c.class, "descriptor", "getDescriptor()Lorg/jetbrains/kotlin/descriptors/PropertyGetterDescriptor;", 0))};

        /* renamed from: r  reason: collision with root package name */
        private final z2.a f22232r = z2.c(new k2(this));

        /* renamed from: s  reason: collision with root package name */
        private final Lazy f22233s = jr.l.a(jr.o.f32182e, new l2(this));

        /* JADX INFO: Access modifiers changed from: private */
        public static final es.h M(c cVar) {
        ...
        @Override // ds.a0
        public es.h A() {
            return (es.h) this.f22233s.getValue();
        }

        @Override // ds.j2.a
        /* renamed from: O */
        public PropertyGetterDescriptor I() {
            Object b10 = this.f22232r.b(this, f22231t[0]);
    ...
    public static abstract class d extends a implements e.a {
        ...
        /* renamed from: t  reason: collision with root package name */
        static final /* synthetic */ KProperty[] f22234t = {Reflection.property1(new PropertyReference1Impl(d.class, "descriptor", "getDescriptor()Lorg/jetbrains/kotlin/descriptors/PropertySetterDescriptor;", 0))};

        /* renamed from: r  reason: collision with root package name */
        private final z2.a f22235r = z2.c(new m2(this));

        /* renamed from: s  reason: collision with root package name */
        private final Lazy f22236s = jr.l.a(jr.o.f32182e, new n2(this));

        /* JADX INFO: Access modifiers changed from: private */
        public static final es.h M(d dVar) {
        ...
        @Override // ds.a0
        public es.h A() {
            return (es.h) this.f22236s.getValue();
        }

        @Override // ds.j2.a
        /* renamed from: O */
        public PropertySetterDescriptor I() {
            Object b10 = this.f22235r.b(this, f22234t[0]);
            Intrinsics.checkNotNullExpressionValue(b10, "getValue(...)");
    ...
    private j2(c1 c1Var, String str, String str2, PropertyDescriptor propertyDescriptor, Object obj) {
        ...
        this.f22227t = str2;
        this.f22228u = obj;
        this.f22229v = jr.l.a(jr.o.f32182e, new h2(this));
    ...
    public static final PropertyDescriptor I(j2 j2Var) {
        return j2Var.B().n(j2Var.getName(), j2Var.f22227t);
    }

    /* JADX INFO: Access modifiers changed from: private */
    public static final Field J(j2 j2Var) {
        Class<?> enclosingClass;
        p f10 = e3.f22189a.f(j2Var.D());
    ...
    @Override // ds.a0
    public boolean G() {
        if (this.f22228u != CallableReference.NO_RECEIVER) {
            return true;
        }
        return false;
    }
        ...
        try {
            ...
            if ((obj != obj4 && obj2 != obj4) || D().getExtensionReceiverParameter() != null) {
                ...
                if (accessibleObject != null) {
                    accessibleObject.setAccessible(cs.a.a(this));
                }
                if (member == null) {
                    return null;
                }
    ...
    public PropertyDescriptor D() {
        Object invoke = this.f22230w.invoke();
    ...
    public final Field R() {
        return (Field) this.f22229v.getValue();
    }
    ...
    public boolean equals(Object obj) {
        j2 d10 = j3.d(obj);
        if (d10 == null || !Intrinsics.areEqual(B(), d10.B()) || !Intrinsics.areEqual(getName(), d10.getName()) || !Intrinsics.areEqual(this.f22227t, d10.f22227t) || !Intrinsics.areEqual(this.f22228u, d10.f22228u)) {
            return false;
        }
        return true;
    }
    ...
    public int hashCode() {
        return (((B().hashCode() * 31) + getName().hashCode()) * 31) + this.f22227t.hashCode();
    }
    ...
    */
    public j2(ds.c1 r8, kotlin.reflect.jvm.internal.impl.descriptors.PropertyDescriptor r9) {
        /*
            r7 = this;
            ...
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: ds.j2.<init>(ds.c1, kotlin.reflect.jvm.internal.impl.descriptors.PropertyDescriptor):void");
    }
}
