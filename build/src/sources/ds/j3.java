...
public abstract class j3 {
    ...
    private static final FqName f22237a = new FqName("kotlin.jvm.JvmStatic");
    ...
    private static final Object a(ArrayValue arrayValue, ClassLoader classLoader) {
        ...
        int i10 = 0;
        switch (primitiveArrayElementType == null ? -1 : a.f22238a[primitiveArrayElementType.ordinal()]) {
            case -1:
                if (KotlinBuiltIns.isArray(type)) {
                    KotlinType type2 = ((TypeProjection) CollectionsKt.Q0(type.getArguments())).getType();
                    Intrinsics.checkNotNullExpressionValue(type2, "getType(...)");
                    ClassifierDescriptor mo1200getDeclarationDescriptor = type2.getConstructor().mo1200getDeclarationDescriptor();
                    ClassDescriptor classDescriptor = mo1200getDeclarationDescriptor instanceof ClassDescriptor ? (ClassDescriptor) mo1200getDeclarationDescriptor : null;
    ...
    private static final Annotation p(AnnotationDescriptor annotationDescriptor) {
        ...
        return (Annotation) es.f.h(cls, kotlin.collections.o0.u(arrayList), null, 4, null);
    }
    ...
    private static final Object s(ConstantValue constantValue, ClassLoader classLoader) {
        ...
        if (constantValue instanceof EnumValue) {
            ...
            if (value2 instanceof KClassValue.Value.NormalClass) {
                ...
                ClassifierDescriptor mo1200getDeclarationDescriptor = ((KClassValue.Value.LocalClass) value2).getType().getConstructor().mo1200getDeclarationDescriptor();
    ...
    private static final List t(List list) {
        ...
        while (true) {
            if (!it.hasNext()) {
                break;
            } else if (Intrinsics.areEqual(wr.a.b(wr.a.a((Annotation) it.next())).getSimpleName(), "Container")) {
                list = new ArrayList();
