...
public abstract class o {
    private static final boolean a(Member member) {
        ...
        return !vr.a.e(declaringClass).isValue();
    }
    ...
    public static final List n(SimpleType type) {
        ...
        ClassifierDescriptor mo1198getDeclarationDescriptor = type.getConstructor().mo1198getDeclarationDescriptor();
    ...
    private static final List o(SimpleType simpleType) {
        ...
        if (InlineClassesUtilsKt.needsMfvcFlattening(simpleType)) {
            ClassifierDescriptor mo1198getDeclarationDescriptor = simpleType.getConstructor().mo1198getDeclarationDescriptor();
            Intrinsics.checkNotNull(mo1198getDeclarationDescriptor, "null cannot be cast to non-null type org.jetbrains.kotlin.descriptors.ClassDescriptor");
            MultiFieldValueClassRepresentation<SimpleType> multiFieldValueClassRepresentation = DescriptorUtilsKt.getMultiFieldValueClassRepresentation((ClassDescriptor) mo1198getDeclarationDescriptor);
    ...
    public static final Class t(KotlinType kotlinType) {
        ...
        Class s10 = s(kotlinType.getConstructor().mo1198getDeclarationDescriptor());
        if (s10 == null) {
            return null;
        }
