...
public final class w0 extends c1 implements KClass, x0, w2 {
    ...
    public final class a extends c1.b {
        ...
        public static final Collection E(w0 w0Var) {
            return w0Var.u(w0Var.L(), c1.d.f22170d);
        }

        /* JADX INFO: Access modifiers changed from: private */
        public static final Collection F(w0 w0Var) {
            return w0Var.u(w0Var.M(), c1.d.f22170d);
        }
        ...
        private final Collection M() {
            Object b10 = this.f22349o.b(this, f22337w[10]);
            Intrinsics.checkNotNullExpressionValue(b10, "getValue(...)");
            return (Collection) b10;
        }

        private final Collection O() {
            Object b10 = this.f22350p.b(this, f22337w[11]);
            Intrinsics.checkNotNullExpressionValue(b10, "getValue(...)");
            return (Collection) b10;
        }

        private final Collection P() {
            Object b10 = this.f22351q.b(this, f22337w[12]);
            Intrinsics.checkNotNullExpressionValue(b10, "getValue(...)");
            return (Collection) b10;
        }
        ...
        public static final Collection T(w0 w0Var) {
            return w0Var.u(w0Var.L(), c1.d.f22171e);
        }

        /* JADX INFO: Access modifiers changed from: private */
        public static final Collection U(w0 w0Var) {
            return w0Var.u(w0Var.M(), c1.d.f22171e);
        }
        ...
        public static final List a0(a aVar, w0 w0Var) {
            ...
            if (!KotlinBuiltIns.isSpecialClassWithNoSupertypes(aVar.N())) {
                ...
                arrayList.add(new t2(anyType, m0.f22252d));
            }
        ...
        public static final Type b0(KotlinType kotlinType, a aVar, w0 w0Var) {
            ...
            if (mo1200getDeclarationDescriptor instanceof ClassDescriptor) {
                ...
                if (q10 != null) {
                    ...
                    throw new x2("No superclass of " + aVar + " in Java reflection for " + mo1200getDeclarationDescriptor);
                }
                throw new x2("Unsupported superclass of " + aVar + ": " + mo1200getDeclarationDescriptor);
            }
            throw new x2("Supertype not a class: " + mo1200getDeclarationDescriptor);
        }
        ...
        public final Collection H() {
            Object b10 = this.f22355u.b(this, f22337w[16]);
            Intrinsics.checkNotNullExpressionValue(b10, "getValue(...)");
            return (Collection) b10;
        }

        public final Collection I() {
            Object b10 = this.f22352r.b(this, f22337w[13]);
            Intrinsics.checkNotNullExpressionValue(b10, "getValue(...)");
            return (Collection) b10;
        }

        public final Collection J() {
            Object b10 = this.f22353s.b(this, f22337w[14]);
            Intrinsics.checkNotNullExpressionValue(b10, "getValue(...)");
            return (Collection) b10;
        }

        public final List K() {
            Object b10 = this.f22339e.b(this, f22337w[1]);
            Intrinsics.checkNotNullExpressionValue(b10, "getValue(...)");
            return (List) b10;
        }

        public final Collection L() {
            Object b10 = this.f22348n.b(this, f22337w[9]);
            Intrinsics.checkNotNullExpressionValue(b10, "getValue(...)");
            return (Collection) b10;
        }

        public final ClassDescriptor N() {
            Object b10 = this.f22338d.b(this, f22337w[0]);
            Intrinsics.checkNotNullExpressionValue(b10, "getValue(...)");
            return (ClassDescriptor) b10;
        }

        public final String Q() {
            return (String) this.f22341g.b(this, f22337w[3]);
        }

        public final String R() {
            return (String) this.f22340f.b(this, f22337w[2]);
        }

        public final List S() {
            Object b10 = this.f22345k.b(this, f22337w[6]);
            Intrinsics.checkNotNullExpressionValue(b10, "getValue(...)");
            return (List) b10;
        }
    }
    ...
    /* synthetic */ class d extends FunctionReferenceImpl implements Function2 {
        ...
        /* renamed from: d  reason: collision with root package name */
        public static final d f22358d = new d();
    ...
    public w0(Class jClass) {
        ...
        this.f22335o = jClass;
        this.f22336p = jr.l.a(jr.o.f32182e, new b0(this));
    }
    ...
    public ClassDescriptor getDescriptor() {
        return ((a) this.f22336p.getValue()).N();
    }
    ...
    public boolean equals(Object obj) {
        if ((obj instanceof w0) && Intrinsics.areEqual(wr.a.c(this), wr.a.c((KClass) obj))) {
            return true;
        }
        return false;
    }
    ...
    public List getAnnotations() {
        return ((a) this.f22336p.getValue()).K();
    }
    ...
    public Collection getMembers() {
        return ((a) this.f22336p.getValue()).H();
    }

    @Override // kotlin.reflect.KClass
    public String getQualifiedName() {
        return ((a) this.f22336p.getValue()).Q();
    }

    @Override // kotlin.reflect.KClass
    public String getSimpleName() {
        return ((a) this.f22336p.getValue()).R();
    }

    @Override // kotlin.reflect.KClass
    public List getTypeParameters() {
        return ((a) this.f22336p.getValue()).S();
    }
    ...
    public PropertyDescriptor t(int i10) {
        ...
        if (Intrinsics.areEqual(getJClass().getSimpleName(), "DefaultImpls") && (declaringClass = getJClass().getDeclaringClass()) != null && declaringClass.isInterface()) {
            KClass e10 = wr.a.e(declaringClass);
        ...
        if (deserializedClassDescriptor != null) {
            ...
            if (property != null) {
                return (PropertyDescriptor) j3.h(getJClass(), property, deserializedClassDescriptor.getC().getNameResolver(), deserializedClassDescriptor.getC().getTypeTable(), deserializedClassDescriptor.getMetadataVersion(), d.f22358d);
            }
        }
        return null;
    }
