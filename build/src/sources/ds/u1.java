...
public final class u1 extends c1 {
    ...
    private final Class f22315o;

    /* renamed from: p  reason: collision with root package name */
    private final Lazy f22316p;
    ...
    public final class a extends c1.b {
        ...
        static final /* synthetic */ KProperty[] f22317j = {Reflection.property1(new PropertyReference1Impl(a.class, "kotlinClass", "getKotlinClass()Lorg/jetbrains/kotlin/descriptors/runtime/components/ReflectKotlinClass;", 0)), Reflection.property1(new PropertyReference1Impl(a.class, "scope", "getScope()Lorg/jetbrains/kotlin/resolve/scopes/MemberScope;", 0)), Reflection.property1(new PropertyReference1Impl(a.class, "members", "getMembers()Ljava/util/Collection;", 0))};

        /* renamed from: d  reason: collision with root package name */
        private final z2.a f22318d;

        /* renamed from: e  reason: collision with root package name */
        private final z2.a f22319e;

        /* renamed from: f  reason: collision with root package name */
        private final Lazy f22320f;

        /* renamed from: g  reason: collision with root package name */
        private final Lazy f22321g;

        /* renamed from: h  reason: collision with root package name */
        private final z2.a f22322h;

        public a() {
            super();
            this.f22318d = z2.c(new p1(u1.this));
            this.f22319e = z2.c(new q1(this));
            jr.o oVar = jr.o.f32182e;
            this.f22320f = jr.l.a(oVar, new r1(this, u1.this));
            this.f22321g = jr.l.a(oVar, new s1(this));
            this.f22322h = z2.c(new t1(u1.this, this));
        }

        private final ReflectKotlinClass i() {
            return (ReflectKotlinClass) this.f22318d.b(this, f22317j[0]);
        }
        ...
        public static final Collection o(u1 u1Var, a aVar) {
            return u1Var.u(aVar.m(), c1.d.f22170d);
        }

        /* JADX INFO: Access modifiers changed from: private */
        public static final jr.u p(a aVar) {
            ...
            if (i10 != null && (classHeader = i10.getClassHeader()) != null) {
                ...
                if (data != null && strings != null) {
                    ...
                    return new jr.u((JvmNameResolver) readPackageDataFrom.a(), (ProtoBuf.Package) readPackageDataFrom.b(), classHeader.getMetadataVersion());
                }
            }
            return null;
        }
        ...
        public final Collection j() {
            Object b10 = this.f22322h.b(this, f22317j[2]);
            Intrinsics.checkNotNullExpressionValue(b10, "getValue(...)");
            return (Collection) b10;
        }

        public final jr.u k() {
            return (jr.u) this.f22321g.getValue();
        }

        public final Class l() {
            return (Class) this.f22320f.getValue();
        }

        public final MemberScope m() {
            Object b10 = this.f22319e.b(this, f22317j[1]);
            Intrinsics.checkNotNullExpressionValue(b10, "getValue(...)");
    ...
    public u1(Class jClass) {
        ...
        this.f22315o = jClass;
        this.f22316p = jr.l.a(jr.o.f32182e, new o1(this));
    }
    ...
    private final MemberScope E() {
        return ((a) this.f22316p.getValue()).m();
    }
    ...
    public Collection getMembers() {
        return ((a) this.f22316p.getValue()).j();
    }
    ...
    public PropertyDescriptor t(int i10) {
        jr.u k10 = ((a) this.f22316p.getValue()).k();
        if (k10 != null) {
            ...
            if (property != null) {
                ...
                return (PropertyDescriptor) j3.h(jClass, property, jvmNameResolver, new TypeTable(typeTable), metadataVersion, b.f22324d);
            }
        }
        return null;
    }
    ...
    @Override // ds.c1
    protected Class v() {
        Class l10 = ((a) this.f22316p.getValue()).l();
        if (l10 == null) {
            return getJClass();
        }
        return l10;
