...
public abstract class c {
    ...
    public static final Set f54851a;

    /* renamed from: b  reason: collision with root package name */
    public static final Type[] f54852b;

    /* renamed from: c  reason: collision with root package name */
    public static final Class f54853c;

    /* renamed from: d  reason: collision with root package name */
    private static final Class f54854d;

    /* renamed from: e  reason: collision with root package name */
    private static final Map f54855e;

    /* loaded from: /home/runner/work/discord-client-datamining/discord-client-datamining/build/classes4.dex */
    public static final class a implements GenericArrayType {

        /* renamed from: d  reason: collision with root package name */
        private final Type f54856d;

        public a(Type type) {
            this.f54856d = c.a(type);
        }
        ...
        public int hashCode() {
            return this.f54856d.hashCode();
        }

        public String toString() {
            return c.v(this.f54856d) + "[]";
        }
    }
    ...
    public static final class b implements ParameterizedType {
        ...
        /* renamed from: d  reason: collision with root package name */
        private final Type f54857d;

        /* renamed from: e  reason: collision with root package name */
        private final Type f54858e;

        /* renamed from: i  reason: collision with root package name */
        public final Type[] f54859i;
        ...
        public b(Type type, Type type2, Type... typeArr) {
            ...
            this.f54857d = a10;
            this.f54858e = c.a(type2);
            this.f54859i = (Type[]) typeArr.clone();
            int i10 = 0;
            while (true) {
                Type[] typeArr2 = this.f54859i;
                if (i10 < typeArr2.length) {
                    typeArr2[i10].getClass();
                    c.b(this.f54859i[i10]);
                    Type[] typeArr3 = this.f54859i;
        ...
        public Type[] getActualTypeArguments() {
            return (Type[]) this.f54859i.clone();
        }
        ...
        public int hashCode() {
            return (Arrays.hashCode(this.f54859i) ^ this.f54858e.hashCode()) ^ c.g(this.f54857d);
        }

        public String toString() {
            StringBuilder sb2 = new StringBuilder((this.f54859i.length + 1) * 30);
            sb2.append(c.v(this.f54858e));
            if (this.f54859i.length == 0) {
                return sb2.toString();
            }
            sb2.append("<");
            sb2.append(c.v(this.f54859i[0]));
            for (int i10 = 1; i10 < this.f54859i.length; i10++) {
                sb2.append(", ");
                sb2.append(c.v(this.f54859i[i10]));
            }
            sb2.append(">");
            return sb2.toString();
        }
    ...
    /* loaded from: /home/runner/work/discord-client-datamining/discord-client-datamining/build/classes4.dex */
    public static final class C0767c implements WildcardType {

        /* renamed from: d  reason: collision with root package name */
        private final Type f54860d;

        /* renamed from: e  reason: collision with root package name */
        private final Type f54861e;

        public C0767c(Type[] typeArr, Type[] typeArr2) {
                ...
                if (typeArr.length == 1) {
                    if (typeArr2.length == 1) {
                        ...
                        if (typeArr[0] == Object.class) {
                            this.f54861e = c.a(typeArr2[0]);
                            this.f54860d = Object.class;
                            return;
                        }
        ...
        public Type[] getLowerBounds() {
            Type type = this.f54861e;
            return type != null ? new Type[]{type} : c.f54852b;
        }

        @Override // java.lang.reflect.WildcardType
        public Type[] getUpperBounds() {
            return new Type[]{this.f54860d};
        }
        ...
        public int hashCode() {
            ...
            return i10 ^ (this.f54860d.hashCode() + 31);
        }

        public String toString() {
            if (this.f54861e != null) {
                return "? super " + c.v(this.f54861e);
            } else if (this.f54860d == Object.class) {
                return "?";
            } else {
                return "? extends " + c.v(this.f54860d);
            }
        }
    }
    ...
    static {
        ...
        L18:
            ...
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: ym.c.<clinit>():void");
    }
    ...
    public static Type a(Type type) {
        if (type instanceof Class) {
            ...
            if (type instanceof C0767c) {
                return type;
            }
            WildcardType wildcardType = (WildcardType) type;
            return new C0767c(wildcardType.getUpperBounds(), wildcardType.getLowerBounds());
        } else {
            return type;
        }
    }
    ...
    public static boolean i(Class cls) {
        Class<? extends Annotation> cls2 = f54854d;
    ...
    public static j o(String str, String str2, m mVar) {
        ...
        String r10 = mVar.r();
        if (str2.equals(str)) {
            format = String.format("Required value '%s' missing at %s", str, r10);
        } else {
            format = String.format("Required value '%s' (JSON name '%s') missing at %s", str, str2, r10);
        }
        return new j(format);
    }
    ...
    */
    private static java.lang.reflect.Type r(java.lang.reflect.Type r8, java.lang.Class r9, java.lang.reflect.Type r10, java.util.Collection r11) {
        ...
        Lbf:
            return r10
        */
        throw new UnsupportedOperationException("Method not decompiled: ym.c.r(java.lang.reflect.Type, java.lang.Class, java.lang.reflect.Type, java.util.Collection):java.lang.reflect.Type");
    }
    ...
    public static j x(String str, String str2, m mVar) {
        ...
        String r10 = mVar.r();
        if (str2.equals(str)) {
            format = String.format("Non-null value '%s' was null at %s", str, r10);
        } else {
            format = String.format("Non-null value '%s' (JSON name '%s') was null at %s", str, str2, r10);
        }
        return new j(format);
    }
}
