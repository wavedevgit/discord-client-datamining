...
public final class a implements u3.f, LifecycleOwner {
    ...
    private final /* synthetic */ LifecycleOwner f27455e;

    /* renamed from: i  reason: collision with root package name */
    private final SavedStateRegistryController f27456i;

    public a(String key, LifecycleOwner lifecycleOwner) {
        Intrinsics.checkNotNullParameter(key, "key");
        Intrinsics.checkNotNullParameter(lifecycleOwner, "lifecycleOwner");
        this.f27454d = key;
        this.f27455e = lifecycleOwner;
    ...
    public Lifecycle getLifecycle() {
        return this.f27455e.getLifecycle();
    }

    @Override // u3.f
    public SavedStateRegistry getSavedStateRegistry() {
        SavedStateRegistry b10 = this.f27456i.b();
