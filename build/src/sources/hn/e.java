...
public final class e {
    ...
    private final ThemedReactContext f27088a;

    /* renamed from: b  reason: collision with root package name */
    private final b f27089b;

    /* renamed from: c  reason: collision with root package name */
    private final float f27090c;

    /* renamed from: d  reason: collision with root package name */
    private BottomSheetBehavior.g f27091d;
    ...
    public static final class a extends BottomSheetBehavior.g {
        ...
        /* renamed from: a  reason: collision with root package name */
        private final Screen f27092a;

        /* renamed from: b  reason: collision with root package name */
        private final View f27093b;
        ...
        private final float f(int i10) {
            int size = this.f27092a.getSheetDetents().size();
            if (size != 1) {
                if (size != 2) {
                    if (size != 3 || i10 == -1) {
                        return -1.0f;
                    ...
                    BottomSheetBehavior<Screen> sheetBehavior = this.f27092a.getSheetBehavior();
        ...
        public void b(View bottomSheet, float f10) {
            ...
            float f11 = this.f27095d;
            if (f11 < f10 && f10 < this.f27096e) {
                this.f27098g.setCurrentFraction((f10 - f11) / this.f27097f);
            }
        }
        ...
        public void c(View bottomSheet, int i10) {
            ...
            this.f27095d = f(this.f27092a.getSheetLargestUndimmedDetentIndex());
            float f10 = f(kotlin.ranges.d.m(this.f27092a.getSheetLargestUndimmedDetentIndex() + 1, 0, this.f27092a.getSheetDetents().size() - 1));
            this.f27096e = f10;
            this.f27097f = f10 - this.f27095d;
        }
    }
    ...
    public e(ThemedReactContext reactContext, Screen screen) {
        ...
        Intrinsics.checkNotNullParameter(screen, "screen");
        this.f27088a = reactContext;
        this.f27089b = b(screen);
        this.f27090c = 0.3f;
    }

    private final b b(final Screen screen) {
        b bVar = new b(this.f27088a, this.f27090c);
        bVar.setLayoutParams(new ViewGroup.LayoutParams(-1, -1));
        bVar.setOnClickListener(new View.OnClickListener() { // from class: hn.c
    ...
    private final BottomSheetBehavior.g i(Screen screen, boolean z10) {
        if (this.f27091d == null || z10) {
            this.f27091d = new a(screen, this.f27089b, this.f27090c);
        }
        BottomSheetBehavior.g gVar = this.f27091d;
    ...
    public final void h(Screen screen, ViewGroup root) {
        ...
        root.addView(this.f27089b, 0);
        if (!j(screen, screen.getSheetInitialDetentIndex())) {
            this.f27089b.setAlpha(0.0f);
        } else {
            this.f27089b.setAlpha(this.f27090c);
        }
    }
