...
public final class f {
    ...
    private u3.f f28037b;

    /* renamed from: c  reason: collision with root package name */
    private String f28038c;

    /* renamed from: d  reason: collision with root package name */
    private final Map f28039d = new LinkedHashMap();

    /* renamed from: e  reason: collision with root package name */
    private final a f28040e = new a();
    ...
    public final void k(Bundle bundle) {
        Set<String> keySet;
        if (this.f28036a == null) {
            this.f28036a = new LinkedHashMap();
            if (bundle != null && (keySet = bundle.keySet()) != null) {
                for (String str : keySet) {
                    Map map = this.f28036a;
            ...
            for (hn.a aVar : this.f28039d.values()) {
    ...
    public final void h(View view, String key) {
        ...
        if (a10 != null) {
            ...
            if (((hn.a) this.f28039d.put(key, aVar)) == null) {
                u3.f a11 = j.a(view);
                if (a11 == null) {
                    j.b(view, aVar);
                    l(aVar);
    ...
    public final void j(Collection keysToKeep) {
        ...
        for (String str : x0.j(this.f28039d.keySet(), collection)) {
            this.f28039d.remove(str);
        }
        Map map = this.f28036a;
        if (map == null) {
            return;
    ...
    public final void m(String key) {
        Unit unit;
        Intrinsics.checkNotNullParameter(key, "key");
        hn.a aVar = (hn.a) this.f28039d.remove(key);
        if (aVar == null) {
            unit = null;
        } else {
            n(aVar);
