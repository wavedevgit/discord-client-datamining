...
public final class d extends BaseReactPackage implements ViewManagerOnDemandReactPackage {
    ...
    private final Lazy f25959a = l.a(new Function0() { // from class: hn.a
    ...
    private final Map d() {
        return (Map) this.f25959a.getValue();
    }

    /* JADX INFO: Access modifiers changed from: private */
    public static final Map e() {
        return o0.f(v.a(RNGestureHandlerButtonViewManager.REACT_CLASS, ModuleSpec.Companion.viewManagerSpec(new Provider() { // from class: hn.c
    ...
    public ReactModuleInfoProvider getReactModuleInfoProvider() {
        try {
            ...
            return new ReactModuleInfoProvider() { // from class: hn.b
