...
public abstract class i {
    ...
    private static final PointF f55530a = new PointF();
    ...
    public static void h(o oVar, Path path) {
        ...
        f55530a.set(b10.x, b10.y);
        int i10 = 0;
        while (i10 < oVar.a().size()) {
            r5.a aVar = (r5.a) oVar.a().get(i10);
            PointF a10 = aVar.a();
            PointF b11 = aVar.b();
            PointF c10 = aVar.c();
            PointF pointF = f55530a;
    ...
    public static void k(r5.e eVar, int i10, List list, r5.e eVar2, k kVar) {
