...
public final class i0 extends FrameLayout {
    ...
    /* renamed from: d */
    private final WorkflowViewStub f25822d;

    /* renamed from: e */
    private SparseArray f25823e;
    ...
    public static final class b extends kotlin.coroutines.jvm.internal.k implements Function2 {
        ...
        /* renamed from: e */
        final /* synthetic */ Lifecycle f25826e;

        /* renamed from: i */
        final /* synthetic */ Lifecycle.State f25827i;

        /* renamed from: o */
        final /* synthetic */ Flow f25828o;

        /* renamed from: p */
        final /* synthetic */ i0 f25829p;

        /* renamed from: q */
        final /* synthetic */ a0 f25830q;
        ...
        public static final class a extends kotlin.coroutines.jvm.internal.k implements Function2 {
            ...
            /* renamed from: e */
            final /* synthetic */ Flow f25832e;

            /* renamed from: i */
            final /* synthetic */ i0 f25833i;

            /* renamed from: o */
            final /* synthetic */ a0 f25834o;
            ...
            public static final class C0352a implements FlowCollector {
                ...
                /* renamed from: d */
                final /* synthetic */ i0 f25835d;

                /* renamed from: e */
                final /* synthetic */ a0 f25836e;
                ...
                public Object emit(Object obj, Continuation continuation) {
                    this.f25835d.c(obj, this.f25836e);
                    return Unit.f32556a;
                }
            }
            ...
            public final Continuation create(Object obj, Continuation continuation) {
                return new a(this.f25832e, this.f25833i, this.f25834o, continuation);
            }
            ...
            public final Object invokeSuspend(Object obj) {
                ...
                if (i10 != 0) {
                    ...
                    kotlin.c.b(obj);
                    Flow flow = this.f25832e;
                    C0352a c0352a = new C0352a(this.f25833i, this.f25834o);
                    this.f25831d = 1;
        ...
        @Override // kotlin.coroutines.jvm.internal.a
        public final Continuation create(Object obj, Continuation continuation) {
            return new b(this.f25826e, this.f25827i, this.f25828o, this.f25829p, this.f25830q, continuation);
        }
        ...
        public final Object invokeSuspend(Object obj) {
            ...
            if (i10 != 0) {
                ...
                kotlin.c.b(obj);
                Lifecycle lifecycle = this.f25826e;
                Lifecycle.State state = this.f25827i;
                a aVar = new a(this.f25828o, this.f25829p, this.f25830q, null);
                this.f25825d = 1;
    ...
    public final void c(Object newRendering, a0 environment) {
        ...
        Intrinsics.checkNotNullParameter(environment, "environment");
        this.f25822d.c(newRendering, environment);
        SparseArray<Parcelable> sparseArray = this.f25823e;
        if (sparseArray == null) {
            return;
        }
        this.f25823e = null;
        this.f25822d.getActual().restoreHierarchyState(sparseArray);
    }
    ...
    protected Parcelable onSaveInstanceState() {
        ...
        this.f25822d.getActual().saveHierarchyState(sparseArray);
    ...
    public static final class a extends View.BaseSavedState {
        ...
        /* renamed from: d */
        private final SparseArray f25824d;
        ...
        public void writeToParcel(Parcel out, int i10) {
            ...
            out.writeSparseArray(this.f25824d);
        }
