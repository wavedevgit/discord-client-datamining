...
public final class e {
    ...
    private final Map f24447a;

    /* renamed from: b  reason: collision with root package name */
    private final fn.f f24448b;
    ...
    public static final class b extends Lambda implements Function1 {
        ...
        public static final b f24450d = new b();
    ...
    public e(Map viewStates) {
        ...
        this.f24447a = viewStates;
        this.f24448b = new fn.f();
    }

    private final void e(Collection collection) {
        CollectionsKt.I(this.f24447a.keySet(), x0.j(this.f24447a.keySet(), collection));
        this.f24448b.j(collection);
    }

    public final void a(String key, u3.f parentOwner) {
        Intrinsics.checkNotNullParameter(key, "key");
        Intrinsics.checkNotNullParameter(parentOwner, "parentOwner");
        this.f24448b.f(key, parentOwner);
    }
    ...
    public final void h(Collection retainedRenderings, View view, View newView) {
        ...
        b10 = f.b(newView);
        Set a02 = k.a0(k.R(CollectionsKt.b0(retainedRenderings), b.f24450d));
        if (retainedRenderings.size() == a02.size()) {
            this.f24448b.h(newView, b10);
            g gVar = (g) this.f24447a.remove(b10);
            if (gVar != null) {
    ...
    public static final class a implements Parcelable {
        @NotNull
        public static final C0377a CREATOR = new C0377a(null);
        ...
        public a(e viewStateCache) {
            ...
            this.f24449d = o0.w(viewStateCache.c());
        }
        ...
        public a(Parcel source) {
            ...
            this.f24449d = o0.w(linkedHashMap);
        }
    }
