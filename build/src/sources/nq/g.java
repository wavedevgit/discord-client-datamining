...
public final class g implements Parcelable {
    ...
    private final List f38895e;

    /* renamed from: i  reason: collision with root package name */
    private final StepStyles.UiStepStyle f38896i;
    ...
    public g(List list, List componentConfigs, StepStyles.UiStepStyle uiStepStyle) {
        ...
        this.f38894d = list;
        this.f38895e = componentConfigs;
        this.f38896i = uiStepStyle;
    }
    ...
    public final Drawable a(Context context) {
        ...
        StepStyles.UiStepStyle uiStepStyle = this.f38896i;
        if (uiStepStyle != null) {
    ...
    public boolean equals(Object obj) {
        ...
        g gVar = (g) obj;
        if (Intrinsics.areEqual(this.f38894d, gVar.f38894d) && Intrinsics.areEqual(this.f38895e, gVar.f38895e) && Intrinsics.areEqual(this.f38896i, gVar.f38896i)) {
            return true;
        }
        return false;
    }
    ...
    public int hashCode() {
        ...
        int hashCode2 = ((hashCode * 31) + this.f38895e.hashCode()) * 31;
        StepStyles.UiStepStyle uiStepStyle = this.f38896i;
        if (uiStepStyle != null) {
    ...
    public final void writeToParcel(Parcel dest, int i10) {
        ...
        List<Parcelable> list = this.f38894d;
        if (list == null) {
            dest.writeInt(0);
        } else {
            dest.writeInt(1);
        ...
        List<Parcelable> list2 = this.f38895e;
        dest.writeInt(list2.size());
        for (Parcelable parcelable2 : list2) {
            dest.writeParcelable(parcelable2, i10);
        }
        dest.writeParcelable(this.f38896i, i10);
    }
}
