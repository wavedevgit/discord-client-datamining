...
public final class g implements Parcelable {
    ...
    private final List f38325d;

    /* renamed from: e  reason: collision with root package name */
    private final List f38326e;

    /* renamed from: i  reason: collision with root package name */
    private final StepStyles.UiStepStyle f38327i;
    ...
    public g(List list, List componentConfigs, StepStyles.UiStepStyle uiStepStyle) {
        ...
        this.f38325d = list;
        this.f38326e = componentConfigs;
        this.f38327i = uiStepStyle;
    }
    ...
    public final Drawable a(Context context) {
        ...
        StepStyles.UiStepStyle uiStepStyle = this.f38327i;
        if (uiStepStyle != null) {
    ...
    public boolean equals(Object obj) {
        ...
        g gVar = (g) obj;
        if (Intrinsics.areEqual(this.f38325d, gVar.f38325d) && Intrinsics.areEqual(this.f38326e, gVar.f38326e) && Intrinsics.areEqual(this.f38327i, gVar.f38327i)) {
            return true;
        }
        return false;
    }
    ...
    public int hashCode() {
        ...
        int hashCode2 = ((hashCode * 31) + this.f38326e.hashCode()) * 31;
        StepStyles.UiStepStyle uiStepStyle = this.f38327i;
        if (uiStepStyle != null) {
    ...
    public final void writeToParcel(Parcel dest, int i10) {
        ...
        List<Parcelable> list = this.f38325d;
        if (list == null) {
            dest.writeInt(0);
        } else {
            dest.writeInt(1);
        ...
        List<Parcelable> list2 = this.f38326e;
        dest.writeInt(list2.size());
        for (Parcelable parcelable2 : list2) {
            dest.writeParcelable(parcelable2, i10);
        }
        dest.writeParcelable(this.f38327i, i10);
    }
}
