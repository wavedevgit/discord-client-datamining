...
public final class g implements Parcelable {
    ...
    private final List f38327e;

    /* renamed from: i  reason: collision with root package name */
    private final StepStyles.UiStepStyle f38328i;
    ...
    public g(List list, List componentConfigs, StepStyles.UiStepStyle uiStepStyle) {
        ...
        this.f38326d = list;
        this.f38327e = componentConfigs;
        this.f38328i = uiStepStyle;
    }
    ...
    public final Drawable a(Context context) {
        ...
        StepStyles.UiStepStyle uiStepStyle = this.f38328i;
        if (uiStepStyle != null) {
    ...
    public boolean equals(Object obj) {
        ...
        g gVar = (g) obj;
        if (Intrinsics.areEqual(this.f38326d, gVar.f38326d) && Intrinsics.areEqual(this.f38327e, gVar.f38327e) && Intrinsics.areEqual(this.f38328i, gVar.f38328i)) {
            return true;
        }
        return false;
    }
    ...
    public int hashCode() {
        ...
        int hashCode2 = ((hashCode * 31) + this.f38327e.hashCode()) * 31;
        StepStyles.UiStepStyle uiStepStyle = this.f38328i;
        if (uiStepStyle != null) {
    ...
    public final void writeToParcel(Parcel dest, int i10) {
        ...
        List<Parcelable> list = this.f38326d;
        if (list == null) {
            dest.writeInt(0);
        } else {
            dest.writeInt(1);
        ...
        List<Parcelable> list2 = this.f38327e;
        dest.writeInt(list2.size());
        for (Parcelable parcelable2 : list2) {
            dest.writeParcelable(parcelable2, i10);
        }
        dest.writeParcelable(this.f38328i, i10);
    }
}
