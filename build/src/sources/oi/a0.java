...
public abstract class a0 {
    ...
    /* loaded from: /home/runner/work/discord-client-datamining/discord-client-datamining/build/classes4.dex */
    public static abstract class b implements ni.f {

        /* renamed from: d  reason: collision with root package name */
        public static final b f41782d = new a("KEY", 0);

        /* renamed from: e  reason: collision with root package name */
        public static final b f41783e = new C0590b("VALUE", 1);

        /* renamed from: i  reason: collision with root package name */
        private static final /* synthetic */ b[] f41784i = a();
    ...
    public static abstract class c extends q0.d {
        ...
        @Override // oi.q0.d, java.util.AbstractSet, java.util.AbstractCollection, java.util.Collection, java.util.Set
        public boolean removeAll(Collection collection) {
            try {
                return super.removeAll((Collection) ni.m.j(collection));
            } catch (UnsupportedOperationException unused) {
                return q0.j(this, collection.iterator());
            }
        }

        @Override // oi.q0.d, java.util.AbstractCollection, java.util.Collection, java.util.Set
    ...
    public static abstract class f extends AbstractMap {
        ...
        /* renamed from: d  reason: collision with root package name */
        private transient Set f41787d;

        /* renamed from: e  reason: collision with root package name */
        private transient Collection f41788e;
        ...
        public Collection values() {
            Collection collection = this.f41788e;
            if (collection == null) {
                Collection b10 = b();
                this.f41788e = b10;
                return b10;
