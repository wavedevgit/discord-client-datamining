...
public abstract class s extends q implements List, RandomAccess {
    ...
    private static final u0 f41911e = new b(k0.f41869p, 0);
    ...
    public static final class a extends q.a {
        ...
        public s k() {
            this.f41903c = true;
            return s.i(this.f41901a, this.f41902b);
        }
    ...
    public class c extends s {
        ...
        /* renamed from: i  reason: collision with root package name */
        final transient int f41913i;

        /* renamed from: o  reason: collision with root package name */
        final transient int f41914o;
        ...
        @Override // oi.s, java.util.List
        /* renamed from: A */
        public s subList(int i10, int i11) {
            ni.m.n(i10, i11, this.f41914o);
            s sVar = s.this;
            int i12 = this.f41913i;
        ...
        @Override // oi.q
        int e() {
            return s.this.f() + this.f41913i + this.f41914o;
        }

        @Override // oi.q
        int f() {
            return s.this.f() + this.f41913i;
        }
        ...
        public Object get(int i10) {
            ni.m.h(i10, this.f41914o);
            return s.this.get(i10 + this.f41913i);
        }

        @Override // oi.s, java.util.AbstractCollection, java.util.Collection, java.lang.Iterable, java.util.List
