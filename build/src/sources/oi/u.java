...
public abstract class u extends q implements Set {
    ...
    public static class a extends q.a {
        ...
        private void k(Object obj) {
            Objects.requireNonNull(this.f41930d);
            int length = this.f41930d.length - 1;
            int hashCode = obj.hashCode();
            int b10 = p.b(hashCode);
            while (true) {
                int i10 = b10 & length;
                Object[] objArr = this.f41930d;
                Object obj2 = objArr[i10];
                if (obj2 == null) {
                    objArr[i10] = obj;
                    this.f41931e += hashCode;
                    super.d(obj);
                    return;
        ...
        public a a(Object obj) {
            ni.m.j(obj);
            if (this.f41930d != null && u.j(this.f41902b) <= this.f41930d.length) {
                k(obj);
                return this;
            }
            this.f41930d = null;
        ...
        public u l() {
            u l10;
            Object[] objArr;
            int i10 = this.f41902b;
            if (i10 != 0) {
                if (i10 != 1) {
                    if (this.f41930d == null || u.j(i10) != this.f41930d.length) {
                        l10 = u.l(this.f41902b, this.f41901a);
                        this.f41902b = l10.size();
                    } else {
                        if (u.A(this.f41902b, this.f41901a.length)) {
                            objArr = Arrays.copyOf(this.f41901a, this.f41902b);
                        } else {
                            objArr = this.f41901a;
                        }
                        Object[] objArr2 = objArr;
                        int i11 = this.f41931e;
                        Object[] objArr3 = this.f41930d;
                        l10 = new m0(objArr2, i11, objArr3, objArr3.length - 1, this.f41902b);
                    }
                    this.f41903c = true;
                    this.f41930d = null;
                    return l10;
                }
                Object obj = this.f41901a[0];
    ...
    public static int j(int i10) {
        ...
        ni.m.e(z10, "collection too large");
        return 1073741824;
    }
