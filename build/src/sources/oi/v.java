...
public abstract class v {
    public static boolean a(Iterable iterable, ni.n nVar) {
    ...
    public static boolean f(Iterable iterable, ni.n nVar) {
        if ((iterable instanceof RandomAccess) && (iterable instanceof List)) {
            return g((List) iterable, (ni.n) ni.m.j(nVar));
        }
        return w.o(iterable.iterator(), nVar);
    }

    private static boolean g(List list, ni.n nVar) {
        int i10 = 0;
        int i11 = 0;
        while (i10 < list.size()) {
    ...
    private static void h(List list, ni.n nVar, int i10, int i11) {
