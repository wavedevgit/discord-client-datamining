...
public abstract class a {
    public static float[] a(float[] fArr, c cVar) {
        ...
        float f15 = 1.0f / abs;
        if (z10) {
            PointF pointF = cVar.f33026a;
            f10 = pointF.x;
            f11 = pointF.y * f15;
        } else {
            PointF pointF2 = cVar.f33026a;
            f10 = pointF2.x * f15;
            f11 = pointF2.y;
        }
        if (z10) {
            PointF pointF3 = cVar.f33027b;
            f12 = (pointF3.x * 2.0f) - 1.0f;
            f13 = (1.0f - (pointF3.y * 2.0f)) * f15;
        } else {
            PointF pointF4 = cVar.f33027b;
        ...
        Matrix.rotateM(fArr2, 0, cVar.f33028c, 0.0f, 0.0f, 1.0f);
