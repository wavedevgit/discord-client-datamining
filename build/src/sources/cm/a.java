    ...
    public a(ExifInterface exifInterface) {
        ...
        if (attribute != null && attribute2 != null && attribute3 != null && attribute4 != null) {
            if (attribute2.equals("N")) {
                this.f7556a = a(attribute);
            } else {
                this.f7556a = Float.valueOf(0.0f - a(attribute).floatValue());
            }
            if (attribute4.equals("E")) {
                this.f7557b = a(attribute3);
            } else {
                this.f7557b = Float.valueOf(0.0f - a(attribute3).floatValue());
            }
        }
    }
