...
public abstract class a0 {
    ...
    /* JADX WARN: Type inference failed for: r0v59, types: [T, cq.s] */
    public static final void k(final TextInputLayout textInputLayout, InputTextBasedComponentStyle styles) {
        ...
        if (baseBackgroundColorValue != null) {
            ...
            objectRef.element = new Function1() { // from class: cq.s
            ...
            textInputLayout.addOnLayoutChangeListener(new View.OnLayoutChangeListener() { // from class: cq.t
        ...
        if (editText4 != null) {
            ...
            f0.i(editText4, baseFontFamilyValue, valueFontWeightValue, new Function1() { // from class: cq.u
                @Override // kotlin.jvm.functions.Function1
                public final Object invoke(Object obj) {
                    Unit s10;
        ...
        if (Build.VERSION.SDK_INT >= 28 && (valueLineHeightValue = styles.getValueLineHeightValue()) != null) {
            ...
            if (editText7 != null) {
                editText7.setLineHeight((int) jp.h.a(doubleValue5));
            }
        }
        ...
        if (baseTextColor != null) {
            ...
            textInputLayout.addOnLayoutChangeListener(new View.OnLayoutChangeListener() { // from class: cq.v
                @Override // android.view.View.OnLayoutChangeListener
                public final void onLayoutChange(View view, int i28, int i29, int i30, int i31, int i32, int i33, int i34, int i35) {
        ...
        if (labelBaseTextColor != null) {
            ...
            textInputLayout.addOnLayoutChangeListener(new View.OnLayoutChangeListener() { // from class: cq.w
                @Override // android.view.View.OnLayoutChangeListener
                public final void onLayoutChange(View view, int i28, int i29, int i30, int i31, int i32, int i33, int i34, int i35) {
        ...
        if (inputTextBoxMargins != null) {
            fq.d.c(textInputLayout, inputTextBoxMargins);
        }
        ...
        if (placeholderBaseTextColor != null) {
            ...
            textInputLayout.addOnLayoutChangeListener(new View.OnLayoutChangeListener() { // from class: cq.x
                @Override // android.view.View.OnLayoutChangeListener
                public final void onLayoutChange(View view, int i28, int i29, int i30, int i31, int i32, int i33, int i34, int i35) {
        ...
        if (editText10 != null) {
            editText10.setOnFocusChangeListener(new View.OnFocusChangeListener() { // from class: cq.y
    ...
    public static final void o(TextInputLayout textInputLayout, final Ref.ObjectRef objectRef, View view, final boolean z10) {
        textInputLayout.post(new Runnable() { // from class: cq.z
