...
public abstract class b {
    ...
    public static final class a extends BottomSheetBehavior.g {
        ...
        public void b(View bottomSheet, float f10) {
            ...
            if (f10 > 0.0f && (view = this.f20125b) != null) {
                view.setVisibility(0);
            }
            View view2 = this.f20125b;
            if (view2 != null) {
    ...
    public static final void b(BottomSheetBehavior bottomSheetBehavior, Function0 onCancel, final View bottomSheet, View view, View view2) {
        ...
        f.g(bottomSheet, new Function1() { // from class: cq.a
    ...
    public static final Unit c(View view, WindowInsetsCompat insets) {
        ...
        view.setPadding(view.getPaddingLeft(), view.getPaddingTop(), view.getPaddingRight(), Integer.max(g10.f3304d, f10.f3304d));
        ViewGroup.LayoutParams layoutParams = view.getLayoutParams();
        if (layoutParams != null) {
            ViewGroup.MarginLayoutParams marginLayoutParams = (ViewGroup.MarginLayoutParams) layoutParams;
            marginLayoutParams.topMargin = g10.f3302b;
