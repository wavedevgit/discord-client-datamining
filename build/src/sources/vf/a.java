...
public class a extends ef.d {
    ...
    private static final a.g f51122k;

    /* renamed from: l  reason: collision with root package name */
    private static final ef.a f51123l;

    static {
        a.g gVar = new a.g();
        f51122k = gVar;
        f51123l = new ef.a("Fido.FIDO2_API", new t5(), gVar);
    }

    public a(Activity activity) {
        super(activity, f51123l, a.d.f22762c, new ff.a());
    }
