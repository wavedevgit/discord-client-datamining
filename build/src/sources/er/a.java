...
public final class a implements h {
    ...
    private final b f22079a;

    public a(b operations) {
        Intrinsics.checkNotNullParameter(operations, "operations");
        this.f22079a = operations;
    }
    ...
    private final Object c(Map map, Object obj) {
        ...
        if (CollectionsKt.d0(this.f22079a.a().keySet(), p02)) {
            tu.a aVar = (tu.a) this.f22079a.a().get(p02);
            if (aVar != null) {
                return aVar.d(obj2, obj, this);
            }
            return null;
        }
        tu.b d10 = d(this.f22079a.b(), p02);
    ...
    private final tu.b d(Map map, Object obj) {
        tu.b bVar = (tu.b) map.get(obj);
        if (bVar != null) {
            return bVar;
        }
