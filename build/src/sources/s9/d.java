...
public final class d implements a {
    ...
    private final Class f48459b = d.class;
    ...
    @Override // s9.a
    public void e(b bitmapFramePreparer, q9.b bitmapFrameCache, p9.a animationBackend, int i10, Function0 function0) {
        ...
        if (1 <= i11) {
            while (true) {
                ...
                if (q8.a.w(2)) {
                    q8.a.A(this.f48459b, "Preparing frame %d, last drawn: %d", Integer.valueOf(a10), Integer.valueOf(i10));
                }
