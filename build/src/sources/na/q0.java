...
public final class q0 {
    ...
    private final ContentResolver f38725a;

    /* renamed from: b  reason: collision with root package name */
    private final x f38726b;

    /* renamed from: c  reason: collision with root package name */
    private final NetworkFetcher f38727c;

    /* renamed from: d  reason: collision with root package name */
    private final boolean f38728d;

    /* renamed from: e  reason: collision with root package name */
    private final boolean f38729e;

    /* renamed from: f  reason: collision with root package name */
    private final h1 f38730f;

    /* renamed from: g  reason: collision with root package name */
    private final DownsampleMode f38731g;

    /* renamed from: h  reason: collision with root package name */
    private final boolean f38732h;

    /* renamed from: i  reason: collision with root package name */
    private final boolean f38733i;

    /* renamed from: j  reason: collision with root package name */
    private final boolean f38734j;

    /* renamed from: k  reason: collision with root package name */
    private final za.d f38735k;

    /* renamed from: l  reason: collision with root package name */
    private final boolean f38736l;

    /* renamed from: m  reason: collision with root package name */
    private final boolean f38737m;

    /* renamed from: n  reason: collision with root package name */
    private final boolean f38738n;

    /* renamed from: o  reason: collision with root package name */
    private final Set f38739o;
    ...
    private final Lazy f38743s;

    /* renamed from: t  reason: collision with root package name */
    private final Lazy f38744t;

    /* renamed from: u  reason: collision with root package name */
    private final Lazy f38745u;

    /* renamed from: v  reason: collision with root package name */
    private final Lazy f38746v;

    /* renamed from: w  reason: collision with root package name */
    private final Lazy f38747w;

    /* renamed from: x  reason: collision with root package name */
    private final Lazy f38748x;

    /* renamed from: y  reason: collision with root package name */
    private final Lazy f38749y;

    /* renamed from: z  reason: collision with root package name */
    private final Lazy f38750z;
    ...
    public q0(ContentResolver contentResolver, x producerFactory, NetworkFetcher networkFetcher, boolean z10, boolean z11, h1 threadHandoffProducerQueue, DownsampleMode downsampleMode, boolean z12, boolean z13, boolean z14, za.d imageTranscoderFactory, boolean z15, boolean z16, boolean z17, Set set) {
        ...
        this.f38725a = contentResolver;
        this.f38726b = producerFactory;
        this.f38727c = networkFetcher;
        this.f38728d = z10;
        this.f38729e = z11;
        this.f38730f = threadHandoffProducerQueue;
        this.f38731g = downsampleMode;
        this.f38732h = z12;
        this.f38733i = z13;
        this.f38734j = z14;
        this.f38735k = imageTranscoderFactory;
        this.f38736l = z15;
        this.f38737m = z16;
        this.f38738n = z17;
        this.f38739o = set;
        this.f38740p = new LinkedHashMap();
        this.f38741q = new LinkedHashMap();
        this.f38742r = new LinkedHashMap();
        this.f38743s = qr.l.a(new Function0() { // from class: na.y
        ...
        this.f38744t = qr.l.a(new Function0() { // from class: na.p0
            @Override // kotlin.jvm.functions.Function0
            public final Object invoke() {
                b1 V;
                V = q0.V(q0.this);
        ...
        this.f38745u = qr.l.a(new Function0() { // from class: na.z
            @Override // kotlin.jvm.functions.Function0
            public final Object invoke() {
                b1 T;
                T = q0.T(q0.this);
        ...
        this.f38746v = qr.l.a(new Function0() { // from class: na.a0
            @Override // kotlin.jvm.functions.Function0
            public final Object invoke() {
                w0 c02;
                c02 = q0.c0(q0.this);
        ...
        this.f38747w = qr.l.a(new Function0() { // from class: na.b0
            @Override // kotlin.jvm.functions.Function0
            public final Object invoke() {
                w0 u10;
                u10 = q0.u(q0.this);
        ...
        this.f38748x = qr.l.a(new Function0() { // from class: na.c0
            @Override // kotlin.jvm.functions.Function0
            public final Object invoke() {
                f1 d02;
                d02 = q0.d0(q0.this);
        ...
        this.f38749y = qr.l.a(new Function0() { // from class: na.d0
            @Override // kotlin.jvm.functions.Function0
            public final Object invoke() {
                w0 v10;
                v10 = q0.v(q0.this);
        ...
        this.f38750z = qr.l.a(new Function0() { // from class: na.e0
            @Override // kotlin.jvm.functions.Function0
            public final Object invoke() {
                f1 W;
                W = q0.W(q0.this);
                ...
                if (sourceUriType != 0) {
                    switch (sourceUriType) {
                        ...
                        case 4:
                            ...
                            if (q8.a.c(this.f38725a.getType(sourceUri))) {
                                return N();
                            }
                            return I();
                        case 5:
                    ...
                    switch (sourceUriType2) {
                        ...
                        case 4:
                            if (imageRequest.getLoadThumbnailOnlyForAndroidSdkAboveQ()) {
                                ...
                                ya.b.b();
                                return M3;
                            } else if (q8.a.c(this.f38725a.getType(sourceUri2))) {
                                w0 N = N();
                                ya.b.b();
                                return N;
                            } else {
    ...
    private final synchronized w0 B(w0 w0Var) {
        w0 w0Var2;
        w0Var2 = (w0) this.f38742r.get(w0Var);
        if (w0Var2 == null) {
            w0Var2 = this.f38726b.f(w0Var);
            this.f38742r.put(w0Var, w0Var2);
        }
        return w0Var2;
    }
    ...
    private final synchronized w0 Q(w0 w0Var) {
        w0 w0Var2;
        w0Var2 = (w0) this.f38740p.get(w0Var);
        if (w0Var2 == null) {
            u0 B = this.f38726b.B(w0Var);
            Intrinsics.checkNotNullExpressionValue(B, "newPostprocessorProducer(...)");
            w0Var2 = this.f38726b.A(B);
            this.f38740p.put(w0Var, w0Var2);
        }
        return w0Var2;
    }
    ...
    public static final w0 S(q0 this$0) {
        ...
        com.facebook.imagepipeline.producers.f0 q10 = this$0.f38726b.q();
    ...
    public static final w0 U(q0 this$0) {
        Intrinsics.checkNotNullParameter(this$0, "this$0");
        com.facebook.imagepipeline.producers.g0 r10 = this$0.f38726b.r();
        Intrinsics.checkNotNullExpressionValue(r10, "newLocalContentUriFetchProducer(...)");
        return this$0.h0(r10, new m1[]{this$0.f38726b.s(), this$0.f38726b.t()});
    }
    ...
    public static final f1 W(q0 this$0) {
        Intrinsics.checkNotNullParameter(this$0, "this$0");
        if (!ya.b.d()) {
            return this$0.f38726b.E(this$0.y());
        }
    ...
    public static final w0 X(q0 this$0) {
        Intrinsics.checkNotNullParameter(this$0, "this$0");
        com.facebook.imagepipeline.producers.k0 u10 = this$0.f38726b.u();
    ...
    public static final w0 Y(q0 this$0) {
        Intrinsics.checkNotNullParameter(this$0, "this$0");
        com.facebook.imagepipeline.producers.l0 v10 = this$0.f38726b.v();
    ...
    public static final w0 Z(q0 this$0) {
        ...
        if (Build.VERSION.SDK_INT >= 29) {
            com.facebook.imagepipeline.producers.m0 w10 = this$0.f38726b.w();
    ...
    public static final w0 a0(q0 this$0) {
        Intrinsics.checkNotNullParameter(this$0, "this$0");
        com.facebook.imagepipeline.producers.n0 x10 = this$0.f38726b.x();
    ...
    public static final f1 d0(q0 this$0) {
        Intrinsics.checkNotNullParameter(this$0, "this$0");
        if (!ya.b.d()) {
            return this$0.f38726b.E(this$0.z());
        }
    ...
    private final w0 j0(w0 w0Var) {
        ...
        if (!ya.b.d()) {
            if (this.f38733i) {
                r0 z10 = this.f38726b.z(w0Var);
                Intrinsics.checkNotNullExpressionValue(z10, "newPartialDiskCacheProducer(...)");
                m11 = this.f38726b.m(z10);
            } else {
                m11 = this.f38726b.m(w0Var);
            }
            Intrinsics.checkNotNull(m11);
            com.facebook.imagepipeline.producers.u l10 = this.f38726b.l(m11);
        ...
        try {
            if (this.f38733i) {
                r0 z11 = this.f38726b.z(w0Var);
                Intrinsics.checkNotNullExpressionValue(z11, "newPartialDiskCacheProducer(...)");
                m10 = this.f38726b.m(z11);
            } else {
                m10 = this.f38726b.m(w0Var);
            }
            Intrinsics.checkNotNull(m10);
            com.facebook.imagepipeline.producers.u l11 = this.f38726b.l(m10);
    ...
    private final w0 m0(w0 w0Var, m1[] m1VarArr) {
        ...
        j1 F = this.f38726b.F(this.f38726b.D(a10, true, this.f38735k));
    ...
    public static final w0 t(q0 this$0) {
        ...
        if (!ya.b.d()) {
            com.facebook.imagepipeline.producers.k0 u10 = this$0.f38726b.u();
            Intrinsics.checkNotNullExpressionValue(u10, "newLocalFileFetchProducer(...)");
            return this$0.f38726b.b(this$0.k0(u10), this$0.f38730f);
        }
        ya.b.a("ProducerSequenceFactory#getBackgroundLocalFileFetchToEncodeMemorySequence");
        try {
            com.facebook.imagepipeline.producers.k0 u11 = this$0.f38726b.u();
            Intrinsics.checkNotNullExpressionValue(u11, "newLocalFileFetchProducer(...)");
            return this$0.f38726b.b(this$0.k0(u11), this$0.f38730f);
        } finally {
            ya.b.b();
        }
    }
    ...
    public static final w0 u(q0 this$0) {
        Intrinsics.checkNotNullParameter(this$0, "this$0");
        if (!ya.b.d()) {
            return this$0.f38726b.b(this$0.C(), this$0.f38730f);
        }
    ...
    public static final w0 v(q0 this$0) {
        Intrinsics.checkNotNullParameter(this$0, "this$0");
        if (!ya.b.d()) {
            return this$0.i0(this$0.f38727c);
        }
    ...
    public static final w0 w(q0 this$0) {
        Intrinsics.checkNotNullParameter(this$0, "this$0");
        com.facebook.imagepipeline.producers.n i10 = this$0.f38726b.i();
        Intrinsics.checkNotNullExpressionValue(i10, "newDataFetchProducer(...)");
        return this$0.f0(this$0.f38726b.D(x.a(i10), true, this$0.f38735k));
    }

    public final w0 C() {
        return (w0) this.f38749y.getValue();
    }
    ...
    public final w0 E(ImageRequest imageRequest) {
        ...
        if (!ya.b.d()) {
            ...
            if (this.f38738n && imageRequest.getDelayMs() > 0) {
                return F(A);
            }
            return A;
        }
    ...
    public final w0 J() {
        Object value = this.f38750z.getValue();
    ...
    public final w0 O() {
        return (w0) this.f38746v.getValue();
    }

    public final w0 P() {
        Object value = this.f38748x.getValue();
        Intrinsics.checkNotNullExpressionValue(value, "getValue(...)");
        return (w0) value;
    }
    ...
    public final w0 f0(w0 inputProducer) {
        ...
        if (!ya.b.d()) {
            com.facebook.imagepipeline.producers.o j10 = this.f38726b.j(inputProducer);
        ...
        try {
            com.facebook.imagepipeline.producers.o j11 = this.f38726b.j(inputProducer);
    ...
    public final synchronized w0 i0(NetworkFetcher networkFetcher) {
        try {
            ...
            x xVar2 = this.f38726b;
            if (this.f38728d && this.f38731g != DownsampleMode.f10364i) {
                z10 = true;
            }
            c1 D = xVar2.D(a11, z10, this.f38735k);
            ya.b.b();
            return D;
        } catch (Throwable th2) {
            throw th2;
    ...
    public final w0 z() {
        Object value = this.f38747w.getValue();
        Intrinsics.checkNotNullExpressionValue(value, "getValue(...)");
        return (w0) value;
    }
}
