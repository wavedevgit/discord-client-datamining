...
public class b implements s {
    ...
    private static final ConcurrentMap f31938a = new ConcurrentHashMap();

    /* renamed from: b  reason: collision with root package name */
    private static final Set f31939b;

    /* renamed from: c  reason: collision with root package name */
    private static final Map f31940c;

    /* renamed from: d  reason: collision with root package name */
    private static final Map f31941d;
    ...
    static {
        ...
        hashSet.add("Zulu");
        f31939b = Collections.unmodifiableSet(hashSet);
        HashMap hashMap = new HashMap();
        g(hashMap, "data/zone1970.tab");
        f31940c = Collections.unmodifiableMap(hashMap);
        ...
        f31941d = Collections.unmodifiableMap(hashMap2);
    }
    ...
    public Set b(Locale locale, boolean z10) {
        ...
        if (z10) {
            ...
            String str = (String) f31941d.get(country);
            if (str != null) {
                return Collections.singleton(str);
            }
        }
        Set set = (Set) f31940c.get(country);
        if (set == null) {
    ...
    public String f(String str, net.time4j.tz.d dVar, Locale locale) {
        if (f31939b.contains(str)) {
            return "";
        }
        Map map = (Map) f31938a.get(locale);
        if (map == null) {
            ...
            map = (Map) f31938a.putIfAbsent(locale, hashMap);
            if (map == null) {
                map = hashMap;
            }
        }
