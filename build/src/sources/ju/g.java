...
public final class g extends iu.k {
    ...
    public long read(Buffer sink, long j10) {
        ...
        long j12 = this.f32814d;
        if (j11 > j12) {
            j10 = 0;
        } else if (this.f32815e) {
            long j13 = j12 - j11;
            if (j13 == 0) {
                return -1L;
            }
        ...
        long j14 = this.f32816i;
        long j15 = this.f32814d;
        if ((j14 < j15 && i10 == 0) || j14 > j15) {
            if (read > 0 && j14 > j15) {
                a(sink, sink.size() - (this.f32816i - this.f32814d));
            }
            throw new IOException("expected " + this.f32814d + " bytes but got " + this.f32816i);
        }
        return read;
    }
}
