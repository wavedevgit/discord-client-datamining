...
public final class k {
    ...
    static {
        ...
        for (int i10 = 0; i10 < length; i10++) {
            f31338a.a(i10, f31339b[i10], f31340c[i10]);
        }
    }
    ...
    public final int d(ByteString bytes) {
        ...
        for (int i10 = 0; i10 < G; i10++) {
            j10 += f31340c[cu.e.d(bytes.j(i10), SetSpanOperation.SPAN_MAX_PRIORITY)];
        }
        return (int) ((j10 + 7) >> 3);
    }
    ...
    public static final class a {
        ...
        public a() {
            this.f31342a = new a[IntBufferBatchMountItem.INSTRUCTION_UPDATE_EVENT_EMITTER];
            this.f31343b = 0;
            this.f31344c = 0;
        }
