...
public final class l0 extends h {
    ...
    private static final a f32384i = new a(null);

    /* renamed from: j  reason: collision with root package name */
    private static final c0 f32385j = c0.a.e(c0.f32326e, "/", false, 1, null);

    /* renamed from: e  reason: collision with root package name */
    private final c0 f32386e;

    /* renamed from: f  reason: collision with root package name */
    private final h f32387f;

    /* renamed from: g  reason: collision with root package name */
    private final Map f32388g;
    ...
    public l0(c0 zipPath, h fileSystem, Map entries, String str) {
        ...
        this.f32386e = zipPath;
        this.f32387f = fileSystem;
        this.f32388g = entries;
        this.f32389h = str;
    }

    private final c0 r(c0 c0Var) {
        return f32385j.m(c0Var, true);
    }

    private final List s(c0 c0Var, boolean z10) {
        ku.i iVar = (ku.i) this.f32388g.get(r(c0Var));
        if (iVar == null) {
            if (!z10) {
                return null;
            }
    ...
    public g m(c0 path) {
        Throwable th2;
        Intrinsics.checkNotNullParameter(path, "path");
        ku.i iVar = (ku.i) this.f32388g.get(r(path));
        Long l10 = null;
        if (iVar == null) {
            return null;
        }
        if (iVar.i() != -1) {
            f n10 = this.f32387f.n(this.f32386e);
            try {
                BufferedSource d10 = x.d(n10.N(iVar.i()));
                iVar = ku.j.j(d10, iVar);
                if (d10 != null) {
                    try {
                        d10.close();
                    } catch (Throwable th3) {
    ...
    public Source q(c0 file) {
        Intrinsics.checkNotNullParameter(file, "file");
        ku.i iVar = (ku.i) this.f32388g.get(r(file));
        if (iVar != null) {
            f n10 = this.f32387f.n(this.f32386e);
            ...
            if (th == 0) {
                ku.j.m(th2);
                if (iVar.e() == 0) {
                    return new ku.g(th2, iVar.j(), true);
                }
                return new ku.g(new o(new ku.g(th2, iVar.d(), true), new Inflater(true)), iVar.j(), false);
            }
            throw th;
        }
