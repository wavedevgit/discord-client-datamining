...
public final class i0 extends ByteString {
    ...
    private final transient byte[][] f32379q;

    /* renamed from: r  reason: collision with root package name */
    private final transient int[] f32380r;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public i0(byte[][] segments, int[] directory) {
        super(ByteString.f44508p.l());
        Intrinsics.checkNotNullParameter(segments, "segments");
        Intrinsics.checkNotNullParameter(directory, "directory");
        this.f32379q = segments;
        this.f32380r = directory;
    }
    ...
    public void O(Buffer buffer, int i10, int i11) {
        ...
        while (i10 < i13) {
            ...
            if (g0Var2 == null) {
                g0Var.f32368g = g0Var;
                g0Var.f32367f = g0Var;
                buffer.f44496d = g0Var;
            } else {
                Intrinsics.checkNotNull(g0Var2);
                g0 g0Var3 = g0Var2.f32368g;
