...
public abstract class e {
    private static final long a(long j10) {
        if (j10 < 0) {
            return Duration.f34764e.b();
        }
        return Duration.f34764e.a();
    }

    public static final long b(long j10, long j11, ns.b unit) {
    ...
    private static final long c(long j10, long j11, ns.b bVar) {
        long j12 = j10 - j11;
        if (((j12 ^ j10) & (~(j12 ^ j11))) < 0) {
            ns.b bVar2 = ns.b.f40016o;
    ...
    public static final long d(long j10, long j11, ns.b unit) {
        Intrinsics.checkNotNullParameter(unit, "unit");
        if (((j11 - 1) | 1) == LongCompanionObject.MAX_VALUE) {
            if (j10 == j11) {
                return Duration.f34764e.c();
            }
            return Duration.N(a(j11));
