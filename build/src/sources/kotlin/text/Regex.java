...
public final class Regex implements Serializable {
    ...
    public /* synthetic */ class b extends FunctionReferenceImpl implements Function1 {
        ...
        /* renamed from: d */
        public static final b f36223d = new b();
    ...
    public final boolean b(CharSequence input) {
        ...
        return this.f36222d.matcher(input).find();
    }

    public final MatchResult c(CharSequence input, int i10) {
        MatchResult f10;
        Intrinsics.checkNotNullParameter(input, "input");
        Matcher matcher = this.f36222d.matcher(input);
    ...
    public final boolean i(CharSequence input) {
        Intrinsics.checkNotNullParameter(input, "input");
        return this.f36222d.matcher(input).matches();
    }
    ...
    public final String replace(@NotNull CharSequence input, @NotNull String replacement) {
        ...
        String replaceAll = this.f36222d.matcher(input).replaceAll(replacement);
        Intrinsics.checkNotNullExpressionValue(replaceAll, "replaceAll(...)");
        return replaceAll;
    }

    public String toString() {
        String pattern = this.f36222d.toString();
    ...
    */
    public Regex(java.lang.String r2, kotlin.text.m r3) {
        /*
            ...
            kotlin.text.Regex$a r0 = kotlin.text.Regex.f36221e
            int r3 = r3.getValue()
