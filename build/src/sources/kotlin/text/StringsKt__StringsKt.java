...
public class StringsKt__StringsKt extends w {
    ...
    public static final class a implements Sequence {
        ...
        final /* synthetic */ CharSequence f34982a;

        public a(CharSequence charSequence) {
            this.f34982a = charSequence;
        }

        @Override // kotlin.sequences.Sequence
        public Iterator iterator() {
            return new g(this.f34982a);
        }
    }
    ...
    private static final Pair a0(CharSequence charSequence, Collection collection, int i10, boolean z10, boolean z11) {
        ...
        if (!z10 && collection.size() == 1) {
            ...
            return qr.v.a(Integer.valueOf(o02), str);
        }
        ...
        if (charSequence3 instanceof String) {
            ...
            if ((f10 > 0 && d10 <= e10) || (f10 < 0 && e10 <= d10)) {
                ...
                while (true) {
                    ...
                    if (str3 != null) {
                        return qr.v.a(Integer.valueOf(i11), str3);
                    }
                    if (i11 == e10) {
                        break;
                    }
            ...
            if ((f11 > 0 && d11 <= e11) || (f11 < 0 && e11 <= d11)) {
                ...
                while (true) {
                    ...
                    if (str5 != null) {
                        return qr.v.a(Integer.valueOf(i12), str5);
                    }
                    if (i12 == e11) {
                        break;
                    }
    ...
    public static final Pair y0(char[] cArr, boolean z10, CharSequence DelimitedRangesSequence, int i10) {
        ...
        return qr.v.a(Integer.valueOf(j02), 1);
    }
    ...
    public static final Pair z0(List list, boolean z10, CharSequence DelimitedRangesSequence, int i10) {
        ...
        if (a02 != null) {
            return qr.v.a(a02.c(), Integer.valueOf(((String) a02.d()).length()));
        }
        return null;
    }
}
