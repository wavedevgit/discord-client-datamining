...
public abstract class d {
    ...
    private static final int[] f35493a;

    /* renamed from: b  reason: collision with root package name */
    private static final int[] f35494b;

    /* renamed from: c  reason: collision with root package name */
    private static final int[] f35495c;

    /* renamed from: d  reason: collision with root package name */
    private static final long[] f35496d;
    ...
    private static final long l(String str, int i10, int i11, e eVar, int i12) {
        kotlin.collections.d.f32590d.a(i10, i11, str.length());
        e.c c10 = eVar.c();
        if (c10.f()) {
            b(str, i10, i11, i12);
    ...
    public static final String s(byte[] bArr, int i10, int i11, e format) {
        ...
        Intrinsics.checkNotNullParameter(format, "format");
        kotlin.collections.d.f32590d.a(i10, i11, bArr.length);
        if (i10 == i11) {
            return "";
        }
        if (format.d()) {
