...
public final class i implements MatchResult {
    ...
    private final Matcher f35529a;

    /* renamed from: b  reason: collision with root package name */
    private final CharSequence f35530b;

    /* renamed from: c  reason: collision with root package name */
    private final h f35531c;

    /* renamed from: d  reason: collision with root package name */
    private List f35532d;
    ...
    public MatchResult next() {
        ...
        int i11 = end + i10;
        if (i11 <= this.f35530b.length()) {
            Matcher matcher = this.f35529a.pattern().matcher(this.f35530b);
            Intrinsics.checkNotNullExpressionValue(matcher, "matcher(...)");
            f10 = l.f(matcher, i11, this.f35530b);
            return f10;
        }
        return null;
    }
