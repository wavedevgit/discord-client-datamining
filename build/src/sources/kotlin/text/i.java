...
public final class i implements MatchResult {
    ...
    private final Matcher f36255a;

    /* renamed from: b  reason: collision with root package name */
    private final CharSequence f36256b;

    /* renamed from: c  reason: collision with root package name */
    private final h f36257c;

    /* renamed from: d  reason: collision with root package name */
    private List f36258d;
    ...
    public MatchResult next() {
        ...
        int i11 = end + i10;
        if (i11 <= this.f36256b.length()) {
            Matcher matcher = this.f36255a.pattern().matcher(this.f36256b);
            Intrinsics.checkNotNullExpressionValue(matcher, "matcher(...)");
            f10 = l.f(matcher, i11, this.f36256b);
            return f10;
        }
        return null;
    }
