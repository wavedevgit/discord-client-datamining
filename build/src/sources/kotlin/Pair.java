...
public final class Pair<A, B> implements Serializable {
    ...
    private final Object f32551d;

    /* renamed from: e  reason: collision with root package name */
    private final Object f32552e;
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof Pair) {
            Pair pair = (Pair) obj;
            return Intrinsics.areEqual(this.f32551d, pair.f32551d) && Intrinsics.areEqual(this.f32552e, pair.f32552e);
        }
        return false;
    }

    public int hashCode() {
        Object obj = this.f32551d;
        int hashCode = (obj == null ? 0 : obj.hashCode()) * 31;
        Object obj2 = this.f32552e;
        return hashCode + (obj2 != null ? obj2.hashCode() : 0);
    }

    public String toString() {
        return '(' + this.f32551d + ", " + this.f32552e + ')';
    }
}
