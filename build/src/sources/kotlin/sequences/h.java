...
public final class h implements Sequence {
    ...
    private final Function0 f34868a;
    ...
    public static final class a implements Iterator, KMappedMarker {
        ...
        private Object f34870d;

        /* renamed from: e  reason: collision with root package name */
        private int f34871e = -2;
        ...
        private final void a() {
            ...
            int i10;
            if (this.f34871e != -2) {
                Function1 function1 = h.this.f34869b;
                Object obj = this.f34870d;
                Intrinsics.checkNotNull(obj);
                invoke = function1.invoke(obj);
            } else {
                invoke = h.this.f34868a.invoke();
            }
            this.f34870d = invoke;
            if (invoke == null) {
                i10 = 0;
    ...
    public h(Function0 getInitialValue, Function1 getNextValue) {
        ...
        this.f34868a = getInitialValue;
        this.f34869b = getNextValue;
    }
