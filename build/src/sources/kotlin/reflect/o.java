...
public final class o implements TypeVariable, Type {
    ...
    private final l f36130d;

    public o(l typeParameter) {
        Intrinsics.checkNotNullParameter(typeParameter, "typeParameter");
        this.f36130d = typeParameter;
    }
    ...
    public Type[] getBounds() {
        Type c10;
        List<KType> upperBounds = this.f36130d.getUpperBounds();
    ...
    public GenericDeclaration getGenericDeclaration() {
        throw new ir.q("An operation is not implemented: " + ("getGenericDeclaration() is not yet supported for type variables created from KType: " + this.f36130d));
    }

    @Override // java.lang.reflect.TypeVariable
    public String getName() {
        return this.f36130d.getName();
    }
