...
public final class KTypeProjection {
    ...
    public static final KTypeProjection f32661d = new KTypeProjection(null, null);

    /* renamed from: a  reason: collision with root package name */
    private final m f32662a;

    /* renamed from: b  reason: collision with root package name */
    private final KType f32663b;
    ...
    public static final class a {
        ...
        public final KTypeProjection a(KType type) {
            ...
            return new KTypeProjection(m.f35396e, type);
        }

        public final KTypeProjection b(KType type) {
            Intrinsics.checkNotNullParameter(type, "type");
            return new KTypeProjection(m.f35397i, type);
        }

        public final KTypeProjection c() {
            return KTypeProjection.f32661d;
        }

        public final KTypeProjection d(KType type) {
            Intrinsics.checkNotNullParameter(type, "type");
            return new KTypeProjection(m.f35395d, type);
        }
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof KTypeProjection) {
            ...
            return this.f32662a == kTypeProjection.f32662a && Intrinsics.areEqual(this.f32663b, kTypeProjection.f32663b);
        }
        return false;
    }
    ...
    public String toString() {
        ...
        if (mVar == null) {
            ...
            i10 = b.f32664a[mVar.ordinal()];
        }
        if (i10 != -1) {
            if (i10 != 1) {
                if (i10 != 2) {
                    if (i10 == 3) {
                        return "out " + this.f32663b;
                    }
                    throw new as.p();
                }
                return "in " + this.f32663b;
            }
            return String.valueOf(this.f32663b);
        }
        return "*";
    }
}
