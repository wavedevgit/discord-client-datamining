...
public final class ErrorUtils {
    ...
    private static final ModuleDescriptor f35997a = ErrorModuleDescriptor.INSTANCE;

    /* renamed from: b  reason: collision with root package name */
    private static final ErrorClassDescriptor f35998b;

    /* renamed from: c  reason: collision with root package name */
    private static final KotlinType f35999c;

    /* renamed from: d  reason: collision with root package name */
    private static final KotlinType f36000d;

    /* renamed from: e  reason: collision with root package name */
    private static final PropertyDescriptor f36001e;

    /* renamed from: f  reason: collision with root package name */
    private static final Set f36002f;
    ...
    static {
        ...
        f35998b = new ErrorClassDescriptor(special);
        f35999c = createErrorType(ErrorTypeKind.CYCLIC_SUPERTYPES, new String[0]);
        f36000d = createErrorType(ErrorTypeKind.ERROR_PROPERTY_TYPE, new String[0]);
        ErrorPropertyDescriptor errorPropertyDescriptor = new ErrorPropertyDescriptor();
        f36001e = errorPropertyDescriptor;
        f36002f = x0.c(errorPropertyDescriptor);
    }
    ...
    public static final boolean isError(DeclarationDescriptor declarationDescriptor) {
        if (declarationDescriptor != null) {
            ...
            if (errorUtils.a(declarationDescriptor) || errorUtils.a(declarationDescriptor.getContainingDeclaration()) || declarationDescriptor == f35997a) {
                return true;
            }
            return false;
        }
