...
public final class MemberDeserializer {
    ...
    private final DeserializationContext f34794a;

    /* renamed from: b  reason: collision with root package name */
    private final AnnotationDeserializer f34795b;

    public MemberDeserializer(@NotNull DeserializationContext c10) {
        Intrinsics.checkNotNullParameter(c10, "c");
        this.f34794a = c10;
        this.f34795b = new AnnotationDeserializer(c10.getComponents().getModuleDescriptor(), c10.getComponents().getNotFoundClasses());
    }

    private final ProtoContainer i(DeclarationDescriptor declarationDescriptor) {
        if (declarationDescriptor instanceof PackageFragmentDescriptor) {
            return new ProtoContainer.Package(((PackageFragmentDescriptor) declarationDescriptor).getFqName(), this.f34794a.getNameResolver(), this.f34794a.getTypeTable(), this.f34794a.getContainerSource());
        }
    ...
    private final Annotations j(MessageLite messageLite, int i10, AnnotatedCallableKind annotatedCallableKind) {
        ...
        return new NonEmptyDeserializedAnnotations(this.f34794a.getStorageManager(), new g(this, messageLite, annotatedCallableKind));
    }
    ...
    public static final List k(MemberDeserializer memberDeserializer, MessageLite messageLite, AnnotatedCallableKind annotatedCallableKind) {
        List list;
        ProtoContainer i10 = memberDeserializer.i(memberDeserializer.f34794a.getContainingDeclaration());
        if (i10 != null) {
            list = CollectionsKt.h1(memberDeserializer.f34794a.getComponents().getAnnotationAndConstantLoader().loadCallableAnnotations(i10, messageLite, annotatedCallableKind));
        } else {
            list = null;
        }
        if (list == null) {
    ...
    private final ReceiverParameterDescriptor l() {
        ...
        DeclarationDescriptor containingDeclaration = this.f34794a.getContainingDeclaration();
    ...
    private final Annotations m(ProtoBuf.Property property, boolean z10) {
        ...
        return new NonEmptyDeserializedAnnotations(this.f34794a.getStorageManager(), new h(this, z10, property));
    }
    ...
    public static final List n(MemberDeserializer memberDeserializer, boolean z10, ProtoBuf.Property property) {
        ...
        if (i10 != null) {
            if (z10) {
                list = CollectionsKt.h1(memberDeserializer.f34794a.getComponents().getAnnotationAndConstantLoader().loadPropertyDelegateFieldAnnotations(i10, property));
            } else {
                list = CollectionsKt.h1(memberDeserializer.f34794a.getComponents().getAnnotationAndConstantLoader().loadPropertyBackingFieldAnnotations(i10, property));
            }
        } else {
            list = null;
        }
    ...
    private final Annotations o(MessageLite messageLite, AnnotatedCallableKind annotatedCallableKind) {
        return new DeserializedAnnotations(this.f34794a.getStorageManager(), new i(this, messageLite, annotatedCallableKind));
    }
    ...
    public static final List p(MemberDeserializer memberDeserializer, MessageLite messageLite, AnnotatedCallableKind annotatedCallableKind) {
        ...
        ProtoContainer i10 = memberDeserializer.i(memberDeserializer.f34794a.getContainingDeclaration());
        if (i10 != null) {
            list = memberDeserializer.f34794a.getComponents().getAnnotationAndConstantLoader().loadExtensionReceiverParameterAnnotations(i10, messageLite, annotatedCallableKind);
        } else {
            list = null;
        }
        if (list == null) {
    ...
    public static final NullableLazyValue s(MemberDeserializer memberDeserializer, ProtoBuf.Property property, DeserializedPropertyDescriptor deserializedPropertyDescriptor) {
        return memberDeserializer.f34794a.getStorageManager().createNullableLazyValue(new k(memberDeserializer, property, deserializedPropertyDescriptor));
    }
    ...
    public static final ConstantValue t(MemberDeserializer memberDeserializer, ProtoBuf.Property property, DeserializedPropertyDescriptor deserializedPropertyDescriptor) {
        ...
        AnnotationAndConstantLoader<AnnotationDescriptor, ConstantValue<?>> annotationAndConstantLoader = memberDeserializer.f34794a.getComponents().getAnnotationAndConstantLoader();
    ...
    public static final NullableLazyValue u(MemberDeserializer memberDeserializer, ProtoBuf.Property property, DeserializedPropertyDescriptor deserializedPropertyDescriptor) {
        return memberDeserializer.f34794a.getStorageManager().createNullableLazyValue(new l(memberDeserializer, property, deserializedPropertyDescriptor));
    }
    ...
    private final List x(List list, MessageLite messageLite, AnnotatedCallableKind annotatedCallableKind) {
        ...
        for (Object obj : list2) {
            ...
            if (i11 != null && Flags.HAS_ANNOTATIONS.get(i10).booleanValue()) {
                empty = new NonEmptyDeserializedAnnotations(this.f34794a.getStorageManager(), new j(this, i11, messageLite, annotatedCallableKind, i12, valueParameter));
            } else {
                empty = Annotations.Companion.getEMPTY();
            }
            Name name = NameResolverUtilKt.getName(this.f34794a.getNameResolver(), valueParameter.getName());
            KotlinType type = this.f34794a.getTypeDeserializer().type(ProtoTypeTableUtilKt.type(valueParameter, this.f34794a.getTypeTable()));
            ...
            ProtoBuf.Type varargElementType = ProtoTypeTableUtilKt.varargElementType(valueParameter, this.f34794a.getTypeTable());
            if (varargElementType != null) {
                kotlinType = this.f34794a.getTypeDeserializer().type(varargElementType);
            } else {
                kotlinType = null;
            }
    ...
    public static final List y(MemberDeserializer memberDeserializer, ProtoContainer protoContainer, MessageLite messageLite, AnnotatedCallableKind annotatedCallableKind, int i10, ProtoBuf.ValueParameter valueParameter) {
        return CollectionsKt.h1(memberDeserializer.f34794a.getComponents().getAnnotationAndConstantLoader().loadValueParameterAnnotations(protoContainer, messageLite, annotatedCallableKind, i10, valueParameter));
    }
    ...
    public final ClassConstructorDescriptor loadConstructor(@NotNull ProtoBuf.Constructor proto, boolean z10) {
        ...
        DeserializedClassConstructorDescriptor deserializedClassConstructorDescriptor = new DeserializedClassConstructorDescriptor(classDescriptor, null, j(proto, flags, annotatedCallableKind), z10, CallableMemberDescriptor.Kind.DECLARATION, proto, this.f34794a.getNameResolver(), this.f34794a.getTypeTable(), this.f34794a.getVersionRequirementTable(), this.f34794a.getContainerSource(), null, IntBufferBatchMountItem.INSTRUCTION_UPDATE_OVERFLOW_INSET, null);
        MemberDeserializer memberDeserializer = DeserializationContext.childContext$default(this.f34794a, deserializedClassConstructorDescriptor, CollectionsKt.l(), null, null, null, null, 60, null).getMemberDeserializer();
    ...
    public final SimpleFunctionDescriptor loadFunction(@NotNull ProtoBuf.Function proto) {
        ...
        if (Intrinsics.areEqual(DescriptorUtilsKt.getFqNameSafe(this.f34794a.getContainingDeclaration()).child(NameResolverUtilKt.getName(this.f34794a.getNameResolver(), proto.getName())), SuspendFunctionTypeUtilKt.KOTLIN_SUSPEND_BUILT_IN_FUNCTION_FQ_NAME)) {
            versionRequirementTable = VersionRequirementTable.Companion.getEMPTY();
        } else {
            versionRequirementTable = this.f34794a.getVersionRequirementTable();
        }
        Annotations annotations = empty;
        DeserializedSimpleFunctionDescriptor deserializedSimpleFunctionDescriptor = new DeserializedSimpleFunctionDescriptor(this.f34794a.getContainingDeclaration(), null, j10, NameResolverUtilKt.getName(this.f34794a.getNameResolver(), proto.getName()), ProtoEnumFlagsUtilsKt.memberKind(ProtoEnumFlags.INSTANCE, Flags.MEMBER_KIND.get(i10)), proto, this.f34794a.getNameResolver(), this.f34794a.getTypeTable(), versionRequirementTable, this.f34794a.getContainerSource(), null, IntBufferBatchMountItem.INSTRUCTION_UPDATE_OVERFLOW_INSET, null);
        DeserializationContext deserializationContext = this.f34794a;
        ...
        ProtoBuf.Type receiverType = ProtoTypeTableUtilKt.receiverType(proto, this.f34794a.getTypeTable());
        ...
        List<ProtoBuf.Type> contextReceiverTypes = ProtoTypeTableUtilKt.contextReceiverTypes(proto, this.f34794a.getTypeTable());
        ...
        KotlinType type2 = childContext$default.getTypeDeserializer().type(ProtoTypeTableUtilKt.returnType(proto, this.f34794a.getTypeTable()));
        ...
        Pair<CallableDescriptor.UserDataKey<?>, Object> deserializeContractFromFunction = this.f34794a.getComponents().getContractDeserializer().deserializeContractFromFunction(proto, deserializedSimpleFunctionDescriptor, this.f34794a.getTypeTable(), childContext$default.getTypeDeserializer());
    ...
    public final PropertyDescriptor loadProperty(@NotNull ProtoBuf.Property proto) {
        ...
        Intrinsics.checkNotNullExpressionValue(bool, "get(...)");
        boolean booleanValue = bool.booleanValue();
        Name name = NameResolverUtilKt.getName(this.f34794a.getNameResolver(), proto.getName());
        ...
        Intrinsics.checkNotNullExpressionValue(bool6, "get(...)");
        int i11 = r10;
        DeserializedPropertyDescriptor deserializedPropertyDescriptor = new DeserializedPropertyDescriptor(containingDeclaration, null, j10, modality, descriptorVisibility, booleanValue, name, memberKind, booleanValue2, booleanValue3, booleanValue4, booleanValue5, bool6.booleanValue(), proto, this.f34794a.getNameResolver(), this.f34794a.getTypeTable(), this.f34794a.getVersionRequirementTable(), this.f34794a.getContainerSource());
        DeserializationContext deserializationContext2 = this.f34794a;
        List<ProtoBuf.TypeParameter> typeParameterList = proto.getTypeParameterList();
        Intrinsics.checkNotNullExpressionValue(typeParameterList, "getTypeParameterList(...)");
        ...
        DeclarationDescriptor containingDeclaration2 = this.f34794a.getContainingDeclaration();
    ...
    public final TypeAliasDescriptor loadTypeAlias(@NotNull ProtoBuf.TypeAlias proto) {
        ...
        for (ProtoBuf.Annotation annotation : list) {
            AnnotationDeserializer annotationDeserializer = this.f34795b;
            Intrinsics.checkNotNull(annotation);
            arrayList.add(annotationDeserializer.deserializeAnnotation(annotation, this.f34794a.getNameResolver()));
        }
        DeserializedTypeAliasDescriptor deserializedTypeAliasDescriptor = new DeserializedTypeAliasDescriptor(this.f34794a.getStorageManager(), this.f34794a.getContainingDeclaration(), companion.create(arrayList), NameResolverUtilKt.getName(this.f34794a.getNameResolver(), proto.getName()), ProtoEnumFlagsUtilsKt.descriptorVisibility(ProtoEnumFlags.INSTANCE, Flags.VISIBILITY.get(proto.getFlags())), proto, this.f34794a.getNameResolver(), this.f34794a.getTypeTable(), this.f34794a.getVersionRequirementTable(), this.f34794a.getContainerSource());
        DeserializationContext deserializationContext = this.f34794a;
        List<ProtoBuf.TypeParameter> typeParameterList = proto.getTypeParameterList();
        Intrinsics.checkNotNullExpressionValue(typeParameterList, "getTypeParameterList(...)");
        ...
        deserializedTypeAliasDescriptor.initialize(childContext$default.getTypeDeserializer().getOwnTypeParameters(), childContext$default.getTypeDeserializer().simpleType(ProtoTypeTableUtilKt.underlyingType(proto, this.f34794a.getTypeTable()), false), childContext$default.getTypeDeserializer().simpleType(ProtoTypeTableUtilKt.expandedType(proto, this.f34794a.getTypeTable()), false));
