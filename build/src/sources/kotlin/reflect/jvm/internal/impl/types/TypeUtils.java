...
public class TypeUtils {
    ...
    public static class SpecialType extends DelegatingSimpleType {
        ...
        */
        ...
        protected SimpleType getDelegate() {
            throw new IllegalStateException(this.f35096e);
        }
    ...
    */
    ...
    public static TypeParameterDescriptor getTypeParameterDescriptorOrNull(@NotNull KotlinType kotlinType) {
        ...
        if (kotlinType.getConstructor().mo1197getDeclarationDescriptor() instanceof TypeParameterDescriptor) {
            return (TypeParameterDescriptor) kotlinType.getConstructor().mo1197getDeclarationDescriptor();
        }
        return null;
    }
    ...
    public static boolean hasNullableSuperType(@NotNull KotlinType kotlinType) {
        ...
        if (kotlinType.getConstructor().mo1197getDeclarationDescriptor() instanceof ClassDescriptor) {
            return false;
        }
