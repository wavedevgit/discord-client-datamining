...
public abstract class AbstractClassTypeConstructor extends AbstractTypeConstructor {
    ...
    */
    ...
    protected boolean c(ClassifierDescriptor classifierDescriptor) {
        ...
        if ((classifierDescriptor instanceof ClassDescriptor) && a(mo1201getDeclarationDescriptor(), classifierDescriptor)) {
            return true;
        }
        return false;
    }
    ...
    public KotlinBuiltIns getBuiltIns() {
        KotlinBuiltIns builtIns = DescriptorUtilsKt.getBuiltIns(mo1201getDeclarationDescriptor());
        if (builtIns == null) {
            A(1);
        }
        return builtIns;
    ...
    public abstract ClassDescriptor mo1201getDeclarationDescriptor();

    @Override // kotlin.reflect.jvm.internal.impl.types.AbstractTypeConstructor
    protected KotlinType m() {
        if (KotlinBuiltIns.isSpecialClassWithNoSupertypes(mo1201getDeclarationDescriptor())) {
            return null;
        }
    ...
    protected Collection n(boolean z10) {
        DeclarationDescriptor containingDeclaration = mo1201getDeclarationDescriptor().getContainingDeclaration();
        ...
        ClassDescriptor mo1195getCompanionObjectDescriptor = classDescriptor.mo1195getCompanionObjectDescriptor();
        if (z10 && mo1195getCompanionObjectDescriptor != null) {
            smartList.add(mo1195getCompanionObjectDescriptor.getDefaultType());
        }
        return smartList;
    }
}
