...
public final class ClassMapperLite {
    ...
    private static final String f35074a = CollectionsKt.x0(CollectionsKt.o('k', 'o', 't', 'l', 'i', 'n'), "", null, null, 0, null, null, 62, null);

    /* renamed from: b  reason: collision with root package name */
    private static final Map f35075b;
    ...
    static {
        ...
        for (String str5 : CollectionsKt.o("Char", "Byte", "Short", "Int", "Float", "Long", "Double", "String", "Enum")) {
            a(linkedHashMap, str5 + ".Companion", f35074a + "/jvm/internal/" + str5 + "CompanionObject");
        }
