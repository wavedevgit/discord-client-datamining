...
public final class ClassMapperLite {
    ...
    private static final String f34348a = CollectionsKt.x0(CollectionsKt.o('k', 'o', 't', 'l', 'i', 'n'), "", null, null, 0, null, null, 62, null);

    /* renamed from: b  reason: collision with root package name */
    private static final Map f34349b;
    ...
    static {
        ...
        linkedHashMap.put(f34348a + "/Unit", "V");
        ...
        for (String str5 : CollectionsKt.o("Char", "Byte", "Short", "Int", "Float", "Long", "Double", "String", "Enum")) {
            a(linkedHashMap, str5 + ".Companion", f34348a + "/jvm/internal/" + str5 + "CompanionObject");
        }
        f34349b = linkedHashMap;
    }
