...
public abstract class ReflectJavaMember extends ReflectJavaElement implements ReflectJavaAnnotationOwner, ReflectJavaModifierListOwner, JavaMember {
    ...
    public final List a(Type[] parameterTypes, Annotation[][] parameterAnnotations, boolean z10) {
        int i10;
        String str;
        boolean z11;
        ...
        List b10 = Java8ParameterNamesLoader.f33081a.b(getMember());
        if (b10 != null) {
        ...
        for (int i11 = 0; i11 < length; i11++) {
            ...
            if (b10 != null) {
                str = (String) CollectionsKt.q0(b10, i11 + i10);
                if (str == null) {
            ...
            if (z10 && i11 == i.a0(parameterTypes)) {
                z11 = true;
            } else {
                z11 = false;
            }
