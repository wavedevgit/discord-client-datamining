...
public final class TypeMappingMode {
    ...
    private final TypeMappingMode f33801f;

    /* renamed from: g  reason: collision with root package name */
    private final boolean f33802g;

    /* renamed from: h  reason: collision with root package name */
    private final TypeMappingMode f33803h;

    /* renamed from: i  reason: collision with root package name */
    private final TypeMappingMode f33804i;
    ...
    public final TypeMappingMode toGenericArgumentMode(@NotNull Variance effectiveVariance, boolean z10) {
        ...
        if (!z10 || !this.f33798c) {
            ...
            if (i10 != 1) {
                if (i10 != 2) {
                    TypeMappingMode typeMappingMode = this.f33801f;
                    if (typeMappingMode != null) {
                        return typeMappingMode;
                    }
                } else {
                    TypeMappingMode typeMappingMode2 = this.f33804i;
                    if (typeMappingMode2 != null) {
                        return typeMappingMode2;
                    }
                }
            } else {
                TypeMappingMode typeMappingMode3 = this.f33803h;
    ...
    public final TypeMappingMode wrapInlineClassesMode() {
        return new TypeMappingMode(this.f33796a, true, this.f33798c, this.f33799d, this.f33800e, this.f33801f, this.f33802g, this.f33803h, this.f33804i, false, IntBufferBatchMountItem.INSTRUCTION_UPDATE_PADDING, null);
    }
    ...
    public TypeMappingMode(boolean z10, boolean z11, boolean z12, boolean z13, boolean z14, TypeMappingMode typeMappingMode, boolean z15, TypeMappingMode typeMappingMode2, TypeMappingMode typeMappingMode3, boolean z16) {
        ...
        this.f33799d = z13;
        this.f33800e = z14;
        this.f33801f = typeMappingMode;
        this.f33802g = z15;
        this.f33803h = typeMappingMode2;
        this.f33804i = typeMappingMode3;
        this.f33805j = z16;
    }
