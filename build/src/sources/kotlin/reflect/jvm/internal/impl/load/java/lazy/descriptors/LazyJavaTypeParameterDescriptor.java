...
public final class LazyJavaTypeParameterDescriptor extends AbstractLazyTypeParameterDescriptor {
    ...
    private final LazyJavaResolverContext f32725v;

    /* renamed from: w  reason: collision with root package name */
    private final JavaTypeParameter f32726w;
    ...
    public LazyJavaTypeParameterDescriptor(@NotNull LazyJavaResolverContext c10, @NotNull JavaTypeParameter javaTypeParameter, int i10, @NotNull DeclarationDescriptor containingDeclaration) {
        ...
        this.f32725v = c10;
        this.f32726w = javaTypeParameter;
    }

    private final List d() {
        Collection<JavaClassifierType> upperBounds = this.f32726w.getUpperBounds();
        if (upperBounds.isEmpty()) {
            SimpleType anyType = this.f32725v.getModule().getBuiltIns().getAnyType();
            Intrinsics.checkNotNullExpressionValue(anyType, "getAnyType(...)");
            SimpleType nullableAnyType = this.f32725v.getModule().getBuiltIns().getNullableAnyType();
        ...
        for (JavaClassifierType javaClassifierType : collection) {
            arrayList.add(this.f32725v.getTypeResolver().transformJavaType(javaClassifierType, JavaTypeAttributesKt.toAttributes$default(TypeUsage.COMMON, false, false, this, 3, null)));
        }
        return arrayList;
    }
    ...
    protected List b(List bounds) {
        ...
        return this.f32725v.getComponents().getSignatureEnhancement().enhanceTypeParameterBounds(this, bounds, this.f32725v);
    }
