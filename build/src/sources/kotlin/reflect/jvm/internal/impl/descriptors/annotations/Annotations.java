...
public interface Annotations extends Iterable<AnnotationDescriptor>, KMappedMarker {
    @NotNull
    public static final Companion Companion = Companion.f32901a;

    /* loaded from: /home/runner/work/discord-client-datamining/discord-client-datamining/build/classes5.dex */
    public static final class Companion {

        /* renamed from: a  reason: collision with root package name */
        static final /* synthetic */ Companion f32901a = new Companion();

        /* renamed from: b  reason: collision with root package name */
        private static final Annotations f32902b = new Annotations() { // from class: kotlin.reflect.jvm.internal.impl.descriptors.annotations.Annotations$Companion$EMPTY$1
            ...
            public /* bridge */ /* synthetic */ AnnotationDescriptor mo1197findAnnotation(FqName fqName) {
    ...
    public static final class DefaultImpls {
        ...
        public static boolean hasAnnotation(@NotNull Annotations annotations, @NotNull FqName fqName) {
            Intrinsics.checkNotNullParameter(fqName, "fqName");
            if (annotations.mo1197findAnnotation(fqName) != null) {
                return true;
            }
            return false;
        }
    ...
    AnnotationDescriptor mo1197findAnnotation(@NotNull FqName fqName);
