...
public final class DisjointKeysUnionTypeSubstitution extends TypeSubstitution {
    ...
    private final TypeSubstitution f35836a;

    /* renamed from: b  reason: collision with root package name */
    private final TypeSubstitution f35837b;
    ...
    public boolean approximateCapturedTypes() {
        if (!this.f35836a.approximateCapturedTypes() && !this.f35837b.approximateCapturedTypes()) {
            return false;
        }
        return true;
    }
    ...
    public boolean approximateContravariantCapturedTypes() {
        if (!this.f35836a.approximateContravariantCapturedTypes() && !this.f35837b.approximateContravariantCapturedTypes()) {
            return false;
        }
        return true;
    }
    ...
    public Annotations filterAnnotations(@NotNull Annotations annotations) {
        ...
        return this.f35837b.filterAnnotations(this.f35836a.filterAnnotations(annotations));
    }
    ...
    public TypeProjection mo1201get(@NotNull KotlinType key) {
        ...
        TypeProjection mo1201get = this.f35836a.mo1201get(key);
        if (mo1201get == null) {
            return this.f35837b.mo1201get(key);
        }
        return mo1201get;
    }
    ...
    public KotlinType prepareTopLevelType(@NotNull KotlinType topLevelType, @NotNull Variance position) {
        ...
        return this.f35837b.prepareTopLevelType(this.f35836a.prepareTopLevelType(topLevelType, position), position);
    }

    private DisjointKeysUnionTypeSubstitution(TypeSubstitution typeSubstitution, TypeSubstitution typeSubstitution2) {
        this.f35836a = typeSubstitution;
        this.f35837b = typeSubstitution2;
    }
}
