...
public final class ReflectJavaTypeParameter extends ReflectJavaElement implements ReflectJavaAnnotationOwner, JavaTypeParameter {
    ...
    private final TypeVariable f32660a;

    public ReflectJavaTypeParameter(@NotNull TypeVariable<?> typeVariable) {
        Intrinsics.checkNotNullParameter(typeVariable, "typeVariable");
        this.f32660a = typeVariable;
    }

    public boolean equals(Object obj) {
        if ((obj instanceof ReflectJavaTypeParameter) && Intrinsics.areEqual(this.f32660a, ((ReflectJavaTypeParameter) obj).f32660a)) {
            return true;
        }
        return false;
    }
    ...
    public AnnotatedElement getElement() {
        TypeVariable typeVariable = this.f32660a;
    ...
    @NotNull
    public Name getName() {
        Name identifier = Name.identifier(this.f32660a.getName());
    ...
    public String toString() {
        return ReflectJavaTypeParameter.class.getName() + ": " + this.f32660a;
    }
    ...
    public List<ReflectJavaClassifierType> getUpperBounds() {
        Type[] bounds = this.f32660a.getBounds();
