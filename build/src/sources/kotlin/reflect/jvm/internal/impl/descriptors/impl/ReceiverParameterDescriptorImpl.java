...
public class ReceiverParameterDescriptorImpl extends AbstractReceiverParameterDescriptor {
    ...
    private final DeclarationDescriptor f33635i;

    /* renamed from: o  reason: collision with root package name */
    private ReceiverValue f33636o;
    ...
    public DeclarationDescriptor getContainingDeclaration() {
        DeclarationDescriptor declarationDescriptor = this.f33635i;
        if (declarationDescriptor == null) {
            a(8);
        }
    ...
    public ReceiverValue getValue() {
        ReceiverValue receiverValue = this.f33636o;
        if (receiverValue == null) {
            a(7);
        }
    ...
    public ReceiverParameterDescriptorImpl(@NotNull DeclarationDescriptor declarationDescriptor, @NotNull ReceiverValue receiverValue, @NotNull Annotations annotations, @NotNull Name name) {
        ...
        this.f33635i = declarationDescriptor;
        this.f33636o = receiverValue;
    }
}
