...
public final class NullabilityAnnotationStatesImpl<T> implements NullabilityAnnotationStates<T> {
    ...
    private final LockBasedStorageManager f33308b;

    /* renamed from: c  reason: collision with root package name */
    private final MemoizedFunctionToNullable f33309c;

    public NullabilityAnnotationStatesImpl(@NotNull Map<FqName, ? extends T> states) {
        Intrinsics.checkNotNullParameter(states, "states");
        this.f33307a = states;
        LockBasedStorageManager lockBasedStorageManager = new LockBasedStorageManager("Java nullability annotation states");
        this.f33308b = lockBasedStorageManager;
        ...
        this.f33309c = createMemoizedFunctionWithNullableValues;
    }
    ...
    public static final Object b(NullabilityAnnotationStatesImpl nullabilityAnnotationStatesImpl, FqName fqName) {
        ...
        return FqNamesUtilKt.findValueForMostSpecificFqname(fqName, nullabilityAnnotationStatesImpl.f33307a);
    }

    @Override // kotlin.reflect.jvm.internal.impl.load.java.NullabilityAnnotationStates
    public T get(@NotNull FqName fqName) {
        Intrinsics.checkNotNullParameter(fqName, "fqName");
        return (T) this.f33309c.invoke(fqName);
    }
}
