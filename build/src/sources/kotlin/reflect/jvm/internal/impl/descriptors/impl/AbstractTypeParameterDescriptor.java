...
public abstract class AbstractTypeParameterDescriptor extends DeclarationDescriptorNonRootImpl implements TypeParameterDescriptor {
    ...
    private final Variance f32959p;

    /* renamed from: q  reason: collision with root package name */
    private final boolean f32960q;

    /* renamed from: r  reason: collision with root package name */
    private final int f32961r;

    /* renamed from: s  reason: collision with root package name */
    private final NotNullLazyValue f32962s;

    /* renamed from: t  reason: collision with root package name */
    private final NotNullLazyValue f32963t;

    /* renamed from: u  reason: collision with root package name */
    private final StorageManager f32964u;

    /* loaded from: /home/runner/work/discord-client-datamining/discord-client-datamining/build/classes5.dex */
    class a implements Function0 {

        /* renamed from: d  reason: collision with root package name */
        final /* synthetic */ StorageManager f32965d;

        /* renamed from: e  reason: collision with root package name */
        final /* synthetic */ SupertypeLoopChecker f32966e;

        a(StorageManager storageManager, SupertypeLoopChecker supertypeLoopChecker) {
            this.f32965d = storageManager;
            this.f32966e = supertypeLoopChecker;
        }

        @Override // kotlin.jvm.functions.Function0
        /* renamed from: a */
        public TypeConstructor invoke() {
            return new c(AbstractTypeParameterDescriptor.this, this.f32965d, this.f32966e);
        }
    }
    ...
    public class b implements Function0 {
        ...
        public class a implements Function0 {
            ...
            public MemberScope invoke() {
                return TypeIntersectionScope.create("Scope for type parameter " + b.this.f32968d.asString(), AbstractTypeParameterDescriptor.this.getUpperBounds());
            }
        }
    ...
    public class c extends AbstractTypeConstructor {
        ...
        /* renamed from: d  reason: collision with root package name */
        private final SupertypeLoopChecker f32971d;

        /* renamed from: e  reason: collision with root package name */
        final /* synthetic */ AbstractTypeParameterDescriptor f32972e;
        ...
        public c(AbstractTypeParameterDescriptor abstractTypeParameterDescriptor, StorageManager storageManager, SupertypeLoopChecker supertypeLoopChecker) {
            ...
            this.f32972e = abstractTypeParameterDescriptor;
            this.f32971d = supertypeLoopChecker;
        }
        ...
        protected boolean c(ClassifierDescriptor classifierDescriptor) {
            ...
            if ((classifierDescriptor instanceof TypeParameterDescriptor) && DescriptorEquivalenceForOverrides.INSTANCE.areTypeParametersEquivalent(this.f32972e, (TypeParameterDescriptor) classifierDescriptor, true)) {
                return true;
            }
            return false;
        }
        ...
        public KotlinBuiltIns getBuiltIns() {
            KotlinBuiltIns builtIns = DescriptorUtilsKt.getBuiltIns(this.f32972e);
            if (builtIns == null) {
                A(4);
            }
            return builtIns;
        ...
        public ClassifierDescriptor mo1201getDeclarationDescriptor() {
            AbstractTypeParameterDescriptor abstractTypeParameterDescriptor = this.f32972e;
        ...
        protected SupertypeLoopChecker p() {
            SupertypeLoopChecker supertypeLoopChecker = this.f32971d;
        ...
        protected void s(KotlinType kotlinType) {
            ...
            this.f32972e.reportSupertypeLoopError(kotlinType);
        }

        public String toString() {
            return this.f32972e.getName().toString();
        }
    }
    ...
    public AbstractTypeParameterDescriptor(StorageManager storageManager, DeclarationDescriptor declarationDescriptor, Annotations annotations, Name name, Variance variance, boolean z10, int i10, SourceElement sourceElement, SupertypeLoopChecker supertypeLoopChecker) {
        ...
        this.f32959p = variance;
        this.f32960q = z10;
        this.f32961r = i10;
        this.f32962s = storageManager.createLazyValue(new a(storageManager, supertypeLoopChecker));
        this.f32963t = storageManager.createLazyValue(new b(name));
        this.f32964u = storageManager;
    }
    ...
    public SimpleType getDefaultType() {
        SimpleType simpleType = (SimpleType) this.f32963t.invoke();
        if (simpleType == null) {
            a(10);
        }
        return simpleType;
    ...
    public StorageManager getStorageManager() {
        StorageManager storageManager = this.f32964u;
        if (storageManager == null) {
            a(14);
        }
    ...
    public final TypeConstructor getTypeConstructor() {
        TypeConstructor typeConstructor = (TypeConstructor) this.f32962s.invoke();
    ...
    public Variance getVariance() {
        Variance variance = this.f32959p;
        if (variance == null) {
            a(7);
        }
        return variance;
