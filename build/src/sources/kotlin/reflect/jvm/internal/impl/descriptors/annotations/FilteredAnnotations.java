...
public final class FilteredAnnotations implements Annotations {
    ...
    private final Annotations f32910d;

    /* renamed from: e  reason: collision with root package name */
    private final boolean f32911e;

    /* renamed from: i  reason: collision with root package name */
    private final Function1 f32912i;
    ...
    public FilteredAnnotations(@NotNull Annotations delegate, boolean z10, @NotNull Function1<? super FqName, Boolean> fqNameFilter) {
        ...
        this.f32910d = delegate;
        this.f32911e = z10;
        this.f32912i = fqNameFilter;
    }

    private final boolean b(AnnotationDescriptor annotationDescriptor) {
        FqName fqName = annotationDescriptor.getFqName();
        if (fqName != null && ((Boolean) this.f32912i.invoke(fqName)).booleanValue()) {
            return true;
        }
        return false;
    }
    ...
    public AnnotationDescriptor mo1197findAnnotation(@NotNull FqName fqName) {
        ...
        if (((Boolean) this.f32912i.invoke(fqName)).booleanValue()) {
            return this.f32910d.mo1197findAnnotation(fqName);
        }
        return null;
    }
    ...
    public boolean hasAnnotation(@NotNull FqName fqName) {
        Intrinsics.checkNotNullParameter(fqName, "fqName");
        if (((Boolean) this.f32912i.invoke(fqName)).booleanValue()) {
            return this.f32910d.hasAnnotation(fqName);
        }
        return false;
    }
    ...
    public boolean isEmpty() {
        boolean z10;
        Annotations<AnnotationDescriptor> annotations = this.f32910d;
    ...
    public Iterator<AnnotationDescriptor> iterator() {
        Annotations annotations = this.f32910d;
