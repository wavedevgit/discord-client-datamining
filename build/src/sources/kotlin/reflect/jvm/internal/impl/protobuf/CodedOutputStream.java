...
public final class CodedOutputStream {
    ...
    private final byte[] f34469a;

    /* renamed from: b  reason: collision with root package name */
    private final int f34470b;

    /* renamed from: e  reason: collision with root package name */
    private final OutputStream f34473e;
    ...
    private CodedOutputStream(OutputStream outputStream, byte[] bArr) {
        this.f34473e = outputStream;
        this.f34469a = bArr;
        this.f34470b = bArr.length;
    }
    ...
    private void b() {
        OutputStream outputStream = this.f34473e;
        if (outputStream != null) {
            outputStream.write(this.f34469a, 0, this.f34471c);
            this.f34471c = 0;
            return;
        }
    ...
    public void writeRawBytes(byte[] bArr, int i10, int i11) {
        int i12 = this.f34470b;
        int i13 = this.f34471c;
        if (i12 - i13 >= i11) {
            System.arraycopy(bArr, i10, this.f34469a, i13, i11);
            this.f34471c += i11;
            this.f34472d += i11;
            return;
        }
        int i14 = i12 - i13;
        System.arraycopy(bArr, i10, this.f34469a, i13, i14);
        int i15 = i10 + i14;
        int i16 = i11 - i14;
        this.f34471c = this.f34470b;
        this.f34472d += i14;
        b();
        if (i16 <= this.f34470b) {
            System.arraycopy(bArr, i15, this.f34469a, 0, i16);
            this.f34471c = i16;
        } else {
            this.f34473e.write(bArr, i15, i16);
        }
        this.f34472d += i16;
    }
    ...
    public void writeRawBytes(ByteString byteString, int i10, int i11) {
        ...
        int i13 = this.f34471c;
        if (i12 - i13 >= i11) {
            byteString.copyTo(this.f34469a, i10, i13, i11);
            this.f34471c += i11;
            this.f34472d += i11;
            return;
        }
        int i14 = i12 - i13;
        byteString.copyTo(this.f34469a, i10, i13, i14);
        int i15 = i10 + i14;
        int i16 = i11 - i14;
        this.f34471c = this.f34470b;
        this.f34472d += i14;
        b();
        if (i16 <= this.f34470b) {
            byteString.copyTo(this.f34469a, i15, 0, i16);
            this.f34471c = i16;
        } else {
            byteString.j(this.f34473e, i15, i16);
        }
        this.f34472d += i16;
    }
}
