...
public final class CodedOutputStream {
    ...
    private final byte[] f33969a;

    /* renamed from: b  reason: collision with root package name */
    private final int f33970b;

    /* renamed from: e  reason: collision with root package name */
    private final OutputStream f33973e;
    ...
    private CodedOutputStream(OutputStream outputStream, byte[] bArr) {
        this.f33973e = outputStream;
        this.f33969a = bArr;
        this.f33970b = bArr.length;
    }
    ...
    private void b() {
        OutputStream outputStream = this.f33973e;
        if (outputStream != null) {
            outputStream.write(this.f33969a, 0, this.f33971c);
            this.f33971c = 0;
            return;
        }
    ...
    public void writeRawByte(byte b10) {
        if (this.f33971c == this.f33970b) {
            b();
        }
        byte[] bArr = this.f33969a;
    ...
    public void writeRawBytes(byte[] bArr, int i10, int i11) {
        int i12 = this.f33970b;
        int i13 = this.f33971c;
        if (i12 - i13 >= i11) {
            System.arraycopy(bArr, i10, this.f33969a, i13, i11);
            this.f33971c += i11;
            this.f33972d += i11;
            return;
        }
        int i14 = i12 - i13;
        System.arraycopy(bArr, i10, this.f33969a, i13, i14);
        int i15 = i10 + i14;
        int i16 = i11 - i14;
        this.f33971c = this.f33970b;
        this.f33972d += i14;
        b();
        if (i16 <= this.f33970b) {
            System.arraycopy(bArr, i15, this.f33969a, 0, i16);
            this.f33971c = i16;
        } else {
            this.f33973e.write(bArr, i15, i16);
        }
        this.f33972d += i16;
    }
    ...
    public void writeRawBytes(ByteString byteString, int i10, int i11) {
        ...
        int i13 = this.f33971c;
        if (i12 - i13 >= i11) {
            byteString.copyTo(this.f33969a, i10, i13, i11);
            this.f33971c += i11;
            this.f33972d += i11;
            return;
        }
        int i14 = i12 - i13;
        byteString.copyTo(this.f33969a, i10, i13, i14);
        int i15 = i10 + i14;
        int i16 = i11 - i14;
        this.f33971c = this.f33970b;
        this.f33972d += i14;
        b();
        if (i16 <= this.f33970b) {
            byteString.copyTo(this.f33969a, i15, 0, i16);
            this.f33971c = i16;
        } else {
            byteString.i(this.f33973e, i15, i16);
        }
        this.f33972d += i16;
    }
}
