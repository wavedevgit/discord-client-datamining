...
public abstract class DeserializedPackageFragmentImpl extends DeserializedPackageFragment {
    ...
    private final BinaryVersion f35600s;

    /* renamed from: t  reason: collision with root package name */
    private final DeserializedContainerSource f35601t;

    /* renamed from: u  reason: collision with root package name */
    private final NameResolverImpl f35602u;

    /* renamed from: v  reason: collision with root package name */
    private final ProtoBasedClassDataFinder f35603v;

    /* renamed from: w  reason: collision with root package name */
    private ProtoBuf.PackageFragment f35604w;

    /* renamed from: x  reason: collision with root package name */
    private MemberScope f35605x;
    ...
    public DeserializedPackageFragmentImpl(@NotNull FqName fqName, @NotNull StorageManager storageManager, @NotNull ModuleDescriptor module, @NotNull ProtoBuf.PackageFragment proto, @NotNull BinaryVersion metadataVersion, DeserializedContainerSource deserializedContainerSource) {
        ...
        this.f35600s = metadataVersion;
        this.f35601t = deserializedContainerSource;
        ProtoBuf.StringTable strings = proto.getStrings();
        Intrinsics.checkNotNullExpressionValue(strings, "getStrings(...)");
        ProtoBuf.QualifiedNameTable qualifiedNames = proto.getQualifiedNames();
        Intrinsics.checkNotNullExpressionValue(qualifiedNames, "getQualifiedNames(...)");
        NameResolverImpl nameResolverImpl = new NameResolverImpl(strings, qualifiedNames);
        this.f35602u = nameResolverImpl;
        this.f35603v = new ProtoBasedClassDataFinder(proto, nameResolverImpl, metadataVersion, new c(this));
        this.f35604w = proto;
    }
    ...
    public static final SourceElement d(DeserializedPackageFragmentImpl deserializedPackageFragmentImpl, ClassId it) {
        ...
        DeserializedContainerSource deserializedContainerSource = deserializedPackageFragmentImpl.f35601t;
    ...
    public MemberScope getMemberScope() {
        MemberScope memberScope = this.f35605x;
        if (memberScope == null) {
    ...
    public void initialize(@NotNull DeserializationComponents components) {
        ...
        ProtoBuf.PackageFragment packageFragment = this.f35604w;
        if (packageFragment != null) {
            this.f35604w = null;
            ProtoBuf.Package r42 = packageFragment.getPackage();
            Intrinsics.checkNotNullExpressionValue(r42, "getPackage(...)");
            NameResolverImpl nameResolverImpl = this.f35602u;
            BinaryVersion binaryVersion = this.f35600s;
            DeserializedContainerSource deserializedContainerSource = this.f35601t;
            this.f35605x = new DeserializedPackageMemberScope(this, r42, nameResolverImpl, binaryVersion, deserializedContainerSource, components, "scope of " + this, new d(this));
            return;
        }
