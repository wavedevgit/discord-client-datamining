...
public final class Checks {
    ...
    private final Name f34783a;

    /* renamed from: b  reason: collision with root package name */
    private final Regex f34784b;

    /* renamed from: c  reason: collision with root package name */
    private final Collection f34785c;

    /* renamed from: d  reason: collision with root package name */
    private final Function1 f34786d;

    /* renamed from: e  reason: collision with root package name */
    private final Check[] f34787e;
    ...
    public static final class b implements Function1 {
        ...
        /* renamed from: d  reason: collision with root package name */
        public static final b f34789d = new b();
    ...
    public static final class c implements Function1 {
        ...
        /* renamed from: d  reason: collision with root package name */
        public static final c f34790d = new c();
    ...
    private Checks(Name name, Regex regex, Collection collection, Function1 function1, Check... checkArr) {
        this.f34783a = name;
        this.f34784b = regex;
        this.f34785c = collection;
        this.f34786d = function1;
        this.f34787e = checkArr;
    }

    @NotNull
    public final CheckResult checkAll(@NotNull FunctionDescriptor functionDescriptor) {
        Intrinsics.checkNotNullParameter(functionDescriptor, "functionDescriptor");
        for (Check check : this.f34787e) {
            String invoke = check.invoke(functionDescriptor);
            if (invoke != null) {
                return new CheckResult.IllegalSignature(invoke);
            }
        }
        String str = (String) this.f34786d.invoke(functionDescriptor);
        if (str != null) {
    ...
    public final boolean isApplicable(@NotNull FunctionDescriptor functionDescriptor) {
        Intrinsics.checkNotNullParameter(functionDescriptor, "functionDescriptor");
        if (this.f34783a != null && !Intrinsics.areEqual(functionDescriptor.getName(), this.f34783a)) {
            return false;
        }
        if (this.f34784b != null) {
            String asString = functionDescriptor.getName().asString();
            Intrinsics.checkNotNullExpressionValue(asString, "asString(...)");
            if (!this.f34784b.i(asString)) {
                return false;
            }
        }
        Collection collection = this.f34785c;
    ...
    public /* synthetic */ Checks(Name name, Check[] checkArr, Function1 function1, int i10, DefaultConstructorMarker defaultConstructorMarker) {
        this(name, checkArr, (i10 & 4) != 0 ? a.f34788d : function1);
    }
    ...
    public /* synthetic */ Checks(Regex regex, Check[] checkArr, Function1 function1, int i10, DefaultConstructorMarker defaultConstructorMarker) {
        this(regex, checkArr, (i10 & 4) != 0 ? b.f34789d : function1);
    }
    ...
    public /* synthetic */ Checks(Collection collection, Check[] checkArr, Function1 function1, int i10, DefaultConstructorMarker defaultConstructorMarker) {
        this(collection, checkArr, (i10 & 4) != 0 ? c.f34790d : function1);
    }
