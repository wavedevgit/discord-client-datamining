...
public final class DescriptorRendererModifier {
    ...
    private static final /* synthetic */ DescriptorRendererModifier[] f34582e;

    /* renamed from: i  reason: collision with root package name */
    private static final /* synthetic */ EnumEntries f34583i;
    ...
    static {
        ...
        for (DescriptorRendererModifier descriptorRendererModifier : values) {
            if (descriptorRendererModifier.f34584d) {
    ...
    public static DescriptorRendererModifier[] values() {
        return (DescriptorRendererModifier[]) f34582e.clone();
    }
}
