...
public class TypeSubstitutor {
    ...
    private final TypeSubstitution f34611a;
    ...
    public static /* synthetic */ class b {
        ...
        static {
            ...
            try {
                f34612a[d.IN_IN_OUT_POSITION.ordinal()] = 2;
            } catch (NoSuchFieldError unused2) {
            }
            try {
                f34612a[d.NO_CONFLICT.ordinal()] = 3;
    ...
    */
    ...
    private TypeProjection g(TypeProjection typeProjection, int i10) {
        ...
        if (type.getConstructor().mo1202getDeclarationDescriptor() instanceof TypeParameterDescriptor) {
            return typeProjection;
        }
        ...
        KotlinType replace = TypeSubstitutionKt.replace(type, h(type.getConstructor().getParameters(), type.getArguments(), i10), this.f34611a.filterAnnotations(type.getAnnotations()));
    ...
    private List h(List list, List list2, int i10) {
        ...
        for (int i11 = 0; i11 < list.size(); i11++) {
            ...
            int i13 = b.f34612a[c(typeParameterDescriptor.getVariance(), i12.getProjectionKind()).ordinal()];
            if (i13 != 1 && i13 != 2) {
                if (i13 == 3) {
    ...
    private TypeProjection i(TypeProjection typeProjection, TypeParameterDescriptor typeParameterDescriptor, int i10) {
        ...
        b(i10, typeProjection, this.f34611a);
        if (!typeProjection.isStarProjection()) {
            KotlinType type = typeProjection.getType();
            if (type instanceof TypeWithEnhancement) {
                ...
                TypeProjection mo1205get = this.f34611a.mo1205get(type);
                if (mo1205get != null) {
                    typeProjection2 = e(type, mo1205get, typeParameterDescriptor, typeProjection);
                } else {
                ...
                if (typeProjection2 == null && FlexibleTypesKt.isFlexible(type) && !TypeCapabilitiesKt.isCustomTypeParameter(type)) {
                    ...
                    if (typeProjection2 != null) {
                        ...
                        if (!type.getAnnotations().isEmpty()) {
                            makeNullableIfNeeded = TypeUtilsKt.replaceAnnotations(makeNullableIfNeeded, new CompositeAnnotations(makeNullableIfNeeded.getAnnotations(), d(this.f34611a.filterAnnotations(type.getAnnotations()))));
                        }
    ...
    public TypeSubstitution getSubstitution() {
        TypeSubstitution typeSubstitution = this.f34611a;
        if (typeSubstitution == null) {
            a(8);
        }
    ...
    public TypeSubstitutor replaceWithNonApproximatingSubstitution() {
        ...
        if ((typeSubstitution instanceof IndexedParametersSubstitution) && typeSubstitution.approximateContravariantCapturedTypes()) {
            return new TypeSubstitutor(new IndexedParametersSubstitution(((IndexedParametersSubstitution) this.f34611a).getParameters(), ((IndexedParametersSubstitution) this.f34611a).getArguments(), false));
        }
        return this;
    }
    ...
    public TypeProjection substitute(@NotNull TypeProjection typeProjection) {
        ...
        return (this.f34611a.approximateCapturedTypes() || this.f34611a.approximateContravariantCapturedTypes()) ? CapturedTypeApproximationKt.approximateCapturedTypesIfNecessary(substituteWithoutApproximation, this.f34611a.approximateContravariantCapturedTypes()) : substituteWithoutApproximation;
    }
}
