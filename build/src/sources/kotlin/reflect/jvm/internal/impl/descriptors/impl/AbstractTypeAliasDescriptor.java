...
public abstract class AbstractTypeAliasDescriptor extends DeclarationDescriptorNonRootImpl implements TypeAliasDescriptor {
    ...
    static final /* synthetic */ KProperty[] f32860u = {Reflection.property1(new PropertyReference1Impl(AbstractTypeAliasDescriptor.class, "constructors", "getConstructors()Ljava/util/Collection;", 0))};

    /* renamed from: p  reason: collision with root package name */
    private final StorageManager f32861p;

    /* renamed from: q  reason: collision with root package name */
    private final DescriptorVisibility f32862q;

    /* renamed from: r  reason: collision with root package name */
    private final NotNullLazyValue f32863r;

    /* renamed from: s  reason: collision with root package name */
    private List f32864s;

    /* renamed from: t  reason: collision with root package name */
    private final AbstractTypeAliasDescriptor$typeConstructor$1 f32865t;
    ...
    public AbstractTypeAliasDescriptor(@NotNull StorageManager storageManager, @NotNull DeclarationDescriptor containingDeclaration, @NotNull Annotations annotations, @NotNull Name name, @NotNull SourceElement sourceElement, @NotNull DescriptorVisibility visibilityImpl) {
        ...
        this.f32861p = storageManager;
        this.f32862q = visibilityImpl;
        this.f32863r = storageManager.createLazyValue(new a(this));
        this.f32865t = new TypeConstructor() { // from class: kotlin.reflect.jvm.internal.impl.descriptors.impl.AbstractTypeAliasDescriptor$typeConstructor$1
            @Override // kotlin.reflect.jvm.internal.impl.types.TypeConstructor
            public KotlinBuiltIns getBuiltIns() {
                return DescriptorUtilsKt.getBuiltIns(mo1197getDeclarationDescriptor());
            }
            ...
            public Collection<KotlinType> getSupertypes() {
                Collection<KotlinType> supertypes = mo1197getDeclarationDescriptor().getUnderlyingType().getConstructor().getSupertypes();
            ...
            public String toString() {
                return "[typealias " + mo1197getDeclarationDescriptor().getName().asString() + ']';
            }

            @Override // kotlin.reflect.jvm.internal.impl.types.TypeConstructor
            /* renamed from: getDeclarationDescriptor */
            public TypeAliasDescriptor mo1197getDeclarationDescriptor() {
    ...
    public static final Boolean i(AbstractTypeAliasDescriptor abstractTypeAliasDescriptor, UnwrappedType unwrappedType) {
        ...
        if (!KotlinTypeKt.isError(unwrappedType)) {
            ...
            if ((mo1197getDeclarationDescriptor instanceof TypeParameterDescriptor) && !Intrinsics.areEqual(((TypeParameterDescriptor) mo1197getDeclarationDescriptor).getContainingDeclaration(), abstractTypeAliasDescriptor)) {
                z10 = true;
    ...
    public List<TypeParameterDescriptor> getDeclaredTypeParameters() {
        List<TypeParameterDescriptor> list = this.f32864s;
        if (list == null) {
    ...
    public final Collection<TypeAliasConstructorDescriptor> getTypeAliasConstructors() {
        ...
        for (ClassConstructorDescriptor classConstructorDescriptor : constructors) {
            ...
            StorageManager storageManager = this.f32861p;
    ...
    public final void initialize(@NotNull List<? extends TypeParameterDescriptor> declaredTypeParameters) {
        ...
        this.f32864s = declaredTypeParameters;
    }
