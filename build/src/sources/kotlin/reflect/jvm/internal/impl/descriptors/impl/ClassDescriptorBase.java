...
public abstract class ClassDescriptorBase extends AbstractClassDescriptor {
    ...
    private final DeclarationDescriptor f32404p;

    /* renamed from: q  reason: collision with root package name */
    private final SourceElement f32405q;

    /* renamed from: r  reason: collision with root package name */
    private final boolean f32406r;
    ...
    public ClassDescriptorBase(StorageManager storageManager, DeclarationDescriptor declarationDescriptor, Name name, SourceElement sourceElement, boolean z10) {
        ...
        this.f32404p = declarationDescriptor;
        this.f32405q = sourceElement;
        this.f32406r = z10;
    }
    ...
    public DeclarationDescriptor getContainingDeclaration() {
        DeclarationDescriptor declarationDescriptor = this.f32404p;
        if (declarationDescriptor == null) {
            a(4);
        }
    ...
    public SourceElement getSource() {
        SourceElement sourceElement = this.f32405q;
        if (sourceElement == null) {
            a(5);
        }
