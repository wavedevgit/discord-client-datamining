...
public final class TypeIntersectionScope extends AbstractScopeAdapter {
    ...
    private final MemberScope f34783b;
    ...
    public Collection<DeclarationDescriptor> getContributedDescriptors(@NotNull DescriptorKindFilter kindFilter, @NotNull Function1<? super Name, Boolean> nameFilter) {
        ...
        return CollectionsKt.L0(OverridingUtilsKt.selectMostSpecificInEachOverridableGroup(list, j.f34793d), (List) pair.b());
    }
    ...
    public Collection<SimpleFunctionDescriptor> getContributedFunctions(@NotNull Name name, @NotNull LookupLocation location) {
        ...
        return OverridingUtilsKt.selectMostSpecificInEachOverridableGroup(super.getContributedFunctions(name, location), h.f34791d);
    }
    ...
    public Collection<PropertyDescriptor> getContributedVariables(@NotNull Name name, @NotNull LookupLocation location) {
        Intrinsics.checkNotNullParameter(name, "name");
        Intrinsics.checkNotNullParameter(location, "location");
        return OverridingUtilsKt.selectMostSpecificInEachOverridableGroup(super.getContributedVariables(name, location), i.f34792d);
    }

    private TypeIntersectionScope(String str, MemberScope memberScope) {
        this.f34782a = str;
        this.f34783b = memberScope;
    }
}
