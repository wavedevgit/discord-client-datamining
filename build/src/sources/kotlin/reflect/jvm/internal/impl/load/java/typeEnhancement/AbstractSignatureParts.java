...
public abstract class AbstractSignatureParts<TAnnotation> {
    ...
    public static final class a {
        ...
        private final KotlinTypeMarker f33599a;

        /* renamed from: b  reason: collision with root package name */
        private final JavaTypeQualifiersByElementType f33600b;

        /* renamed from: c  reason: collision with root package name */
        private final TypeParameterMarker f33601c;
        ...
        public a(KotlinTypeMarker kotlinTypeMarker, JavaTypeQualifiersByElementType javaTypeQualifiersByElementType, TypeParameterMarker typeParameterMarker) {
            this.f33599a = kotlinTypeMarker;
            this.f33600b = javaTypeQualifiersByElementType;
            this.f33601c = typeParameterMarker;
        }
