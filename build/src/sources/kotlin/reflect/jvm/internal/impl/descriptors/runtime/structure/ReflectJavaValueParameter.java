...
public final class ReflectJavaValueParameter extends ReflectJavaElement implements JavaValueParameter {
    ...
    private final ReflectJavaType f33209a;

    /* renamed from: b  reason: collision with root package name */
    private final Annotation[] f33210b;
    ...
    public ReflectJavaAnnotation findAnnotation(@NotNull FqName fqName) {
        ...
        return ReflectJavaAnnotationOwnerKt.findAnnotation(this.f33210b, fqName);
    }

    @Override // kotlin.reflect.jvm.internal.impl.load.java.structure.JavaAnnotationOwner
    @NotNull
    public List<ReflectJavaAnnotation> getAnnotations() {
        return ReflectJavaAnnotationOwnerKt.getAnnotations(this.f33210b);
    }
