...
public final class JavaNullabilityAnnotationSettingsKt {
    ...
    /* renamed from: a */
    private static final FqName f32687a;

    /* renamed from: b */
    private static final FqName f32688b;

    /* renamed from: c */
    private static final FqName f32689c;

    /* renamed from: d */
    private static final FqName f32690d;

    /* renamed from: e */
    private static final String f32691e;

    /* renamed from: f */
    private static final FqName[] f32692f;

    /* renamed from: g */
    private static final NullabilityAnnotationStates f32693g;

    /* renamed from: h */
    private static final JavaNullabilityAnnotationsStatus f32694h;
    ...
    static {
        ...
        f32692f = new FqName[]{fqName5, new FqName(asString + ".NonNull")};
        ...
        or.j jVar = new or.j(2, 1);
        ReportLevel reportLevel2 = ReportLevel.STRICT;
        f32693g = new NullabilityAnnotationStatesImpl(o0.m(a10, a11, a12, a13, a14, a15, a16, a17, a18, a19, a20, a21, a22, a23, v.a(fqName, new JavaNullabilityAnnotationsStatus(reportLevel, jVar, reportLevel2)), v.a(fqName2, new JavaNullabilityAnnotationsStatus(reportLevel, new or.j(2, 1), reportLevel2)), v.a(fqName3, new JavaNullabilityAnnotationsStatus(reportLevel, new or.j(1, 8), reportLevel2))));
        f32694h = new JavaNullabilityAnnotationsStatus(reportLevel, null, null, 4, null);
    }

    @NotNull
    public static final Jsr305Settings getDefaultJsr305Settings(@NotNull or.j configuredKotlinVersion) {
        ReportLevel reportLevelBefore;
        Intrinsics.checkNotNullParameter(configuredKotlinVersion, "configuredKotlinVersion");
        JavaNullabilityAnnotationsStatus javaNullabilityAnnotationsStatus = f32694h;
    ...
    public static /* synthetic */ Jsr305Settings getDefaultJsr305Settings$default(or.j jVar, int i10, Object obj) {
        if ((i10 & 1) != 0) {
            jVar = or.j.f44224q;
        }
    ...
    @NotNull
    public static final ReportLevel getReportLevelForAnnotation(@NotNull FqName annotation, @NotNull NullabilityAnnotationStates<? extends ReportLevel> configuredReportLevels, @NotNull or.j configuredKotlinVersion) {
        ...
        JavaNullabilityAnnotationsStatus javaNullabilityAnnotationsStatus = (JavaNullabilityAnnotationsStatus) f32693g.get(annotation);
    ...
    public static /* synthetic */ ReportLevel getReportLevelForAnnotation$default(FqName fqName, NullabilityAnnotationStates nullabilityAnnotationStates, or.j jVar, int i10, Object obj) {
        if ((i10 & 4) != 0) {
            jVar = new or.j(1, 7, 20);
        }
