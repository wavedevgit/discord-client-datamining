...
public abstract class ProtoContainer {
    ...
    private final NameResolver f35634a;

    /* renamed from: b  reason: collision with root package name */
    private final TypeTable f35635b;

    /* renamed from: c  reason: collision with root package name */
    private final SourceElement f35636c;

    /* loaded from: /home/runner/work/discord-client-datamining/discord-client-datamining/build/classes5.dex */
    public static final class Class extends ProtoContainer {

        /* renamed from: d  reason: collision with root package name */
        private final ProtoBuf.Class f35637d;

        /* renamed from: e  reason: collision with root package name */
        private final Class f35638e;

        /* renamed from: f  reason: collision with root package name */
        private final ClassId f35639f;

        /* renamed from: g  reason: collision with root package name */
        private final ProtoBuf.Class.Kind f35640g;

        /* renamed from: h  reason: collision with root package name */
        private final boolean f35641h;

        /* renamed from: i  reason: collision with root package name */
        private final boolean f35642i;
        ...
        public Class(@NotNull ProtoBuf.Class classProto, @NotNull NameResolver nameResolver, @NotNull TypeTable typeTable, SourceElement sourceElement, Class r62) {
            ...
            this.f35638e = r62;
            this.f35639f = NameResolverUtilKt.getClassId(nameResolver, classProto.getFqName());
            ProtoBuf.Class.Kind kind = Flags.CLASS_KIND.get(classProto.getFlags());
            this.f35640g = kind == null ? ProtoBuf.Class.Kind.CLASS : kind;
            Boolean bool = Flags.IS_INNER.get(classProto.getFlags());
            Intrinsics.checkNotNullExpressionValue(bool, "get(...)");
            this.f35641h = bool.booleanValue();
            Boolean bool2 = Flags.IS_DATA.get(classProto.getFlags());
            Intrinsics.checkNotNullExpressionValue(bool2, "get(...)");
            this.f35642i = bool2.booleanValue();
        }

        @Override // kotlin.reflect.jvm.internal.impl.serialization.deserialization.ProtoContainer
        @NotNull
        public FqName debugFqName() {
            return this.f35639f.asSingleFqName();
        }
    ...
    private ProtoContainer(NameResolver nameResolver, TypeTable typeTable, SourceElement sourceElement) {
        this.f35634a = nameResolver;
        this.f35635b = typeTable;
        this.f35636c = sourceElement;
    }
}
