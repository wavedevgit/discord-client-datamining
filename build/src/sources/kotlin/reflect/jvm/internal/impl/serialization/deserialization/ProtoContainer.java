...
public abstract class ProtoContainer {
    ...
    private final NameResolver f34892a;

    /* renamed from: b  reason: collision with root package name */
    private final TypeTable f34893b;

    /* renamed from: c  reason: collision with root package name */
    private final SourceElement f34894c;

    /* loaded from: /home/runner/work/discord-client-datamining/discord-client-datamining/build/classes5.dex */
    public static final class Class extends ProtoContainer {

        /* renamed from: d  reason: collision with root package name */
        private final ProtoBuf.Class f34895d;

        /* renamed from: e  reason: collision with root package name */
        private final Class f34896e;

        /* renamed from: f  reason: collision with root package name */
        private final ClassId f34897f;

        /* renamed from: g  reason: collision with root package name */
        private final ProtoBuf.Class.Kind f34898g;

        /* renamed from: h  reason: collision with root package name */
        private final boolean f34899h;
        ...
        public Class(@NotNull ProtoBuf.Class classProto, @NotNull NameResolver nameResolver, @NotNull TypeTable typeTable, SourceElement sourceElement, Class r62) {
            ...
            this.f34895d = classProto;
            this.f34896e = r62;
            this.f34897f = NameResolverUtilKt.getClassId(nameResolver, classProto.getFqName());
            ProtoBuf.Class.Kind kind = Flags.CLASS_KIND.get(classProto.getFlags());
            this.f34898g = kind == null ? ProtoBuf.Class.Kind.CLASS : kind;
            Boolean bool = Flags.IS_INNER.get(classProto.getFlags());
            Intrinsics.checkNotNullExpressionValue(bool, "get(...)");
            this.f34899h = bool.booleanValue();
            Boolean bool2 = Flags.IS_DATA.get(classProto.getFlags());
            Intrinsics.checkNotNullExpressionValue(bool2, "get(...)");
            this.f34900i = bool2.booleanValue();
        }

        @Override // kotlin.reflect.jvm.internal.impl.serialization.deserialization.ProtoContainer
        @NotNull
        public FqName debugFqName() {
            return this.f34897f.asSingleFqName();
        }
    ...
    private ProtoContainer(NameResolver nameResolver, TypeTable typeTable, SourceElement sourceElement) {
        this.f34892a = nameResolver;
        this.f34893b = typeTable;
        this.f34894c = sourceElement;
    }
}
