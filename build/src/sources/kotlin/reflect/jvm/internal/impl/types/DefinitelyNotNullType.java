...
public final class DefinitelyNotNullType extends DelegatingSimpleType implements CustomTypeParameter, DefinitelyNotNullTypeMarker {
    ...
    private final SimpleType f34558e;
    ...
    public KotlinType substitutionResult(@NotNull KotlinType replacement) {
        ...
        return SpecialTypesKt.makeDefinitelyNotNullOrNotNull(replacement.unwrap(), this.f34559i);
    }
    ...
    public SimpleType replaceAttributes(@NotNull TypeAttributes newAttributes) {
        ...
        return new DefinitelyNotNullType(getDelegate().replaceAttributes(newAttributes), this.f34559i);
    }
    ...
    public DefinitelyNotNullType replaceDelegate(@NotNull SimpleType delegate) {
        ...
        return new DefinitelyNotNullType(delegate, this.f34559i);
    }
}
