...
public final class DefinitelyNotNullType extends DelegatingSimpleType implements CustomTypeParameter, DefinitelyNotNullTypeMarker {
    ...
    private final SimpleType f35014e;

    /* renamed from: i  reason: collision with root package name */
    private final boolean f35015i;
    ...
    public static final class Companion {
        ...
        private final boolean a(UnwrappedType unwrappedType) {
            if (!(unwrappedType.getConstructor() instanceof NewTypeVariableConstructor) && !(unwrappedType.getConstructor().mo1197getDeclarationDescriptor() instanceof TypeParameterDescriptor) && !(unwrappedType instanceof NewCapturedType) && !(unwrappedType instanceof StubTypeForBuilderInference)) {
                return false;
            }
            return true;
        }
        ...
        private final boolean b(UnwrappedType unwrappedType, boolean z10) {
            ...
            if (mo1197getDeclarationDescriptor instanceof TypeParameterDescriptorImpl) {
                typeParameterDescriptorImpl = (TypeParameterDescriptorImpl) mo1197getDeclarationDescriptor;
            } else {
            ...
            if (z10 && (unwrappedType.getConstructor().mo1197getDeclarationDescriptor() instanceof TypeParameterDescriptor)) {
                return TypeUtils.isNullableType(unwrappedType);
            }
    ...
    public boolean isTypeParameter() {
        if (!(getDelegate().getConstructor() instanceof NewTypeVariableConstructor) && !(getDelegate().getConstructor().mo1197getDeclarationDescriptor() instanceof TypeParameterDescriptor)) {
            return false;
        }
        return true;
    }
    ...
    public KotlinType substitutionResult(@NotNull KotlinType replacement) {
        ...
        return SpecialTypesKt.makeDefinitelyNotNullOrNotNull(replacement.unwrap(), this.f35015i);
    }
    ...
    public SimpleType replaceAttributes(@NotNull TypeAttributes newAttributes) {
        ...
        return new DefinitelyNotNullType(getDelegate().replaceAttributes(newAttributes), this.f35015i);
    }
    ...
    public DefinitelyNotNullType replaceDelegate(@NotNull SimpleType delegate) {
        ...
        return new DefinitelyNotNullType(delegate, this.f35015i);
    }
}
