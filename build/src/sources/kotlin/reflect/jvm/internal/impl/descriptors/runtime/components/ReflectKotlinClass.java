...
public final class ReflectKotlinClass implements KotlinJvmBinaryClass {
    ...
    private final KotlinClassHeader f33896b;
    ...
    public static final class Factory {
        ...
        public final ReflectKotlinClass create(@NotNull Class<?> klass) {
            ...
            a.f33903a.b(klass, readKotlinClassHeaderAnnotationVisitor);
    ...
    public boolean equals(Object obj) {
        if ((obj instanceof ReflectKotlinClass) && Intrinsics.areEqual(this.f33895a, ((ReflectKotlinClass) obj).f33895a)) {
            return true;
        }
        return false;
    }
    ...
    public ClassId getClassId() {
        return ReflectClassUtilKt.getClassId(this.f33895a);
    }
    ...
    public String getLocation() {
        ...
        String name = this.f33895a.getName();
    ...
    public void loadClassAnnotations(@NotNull KotlinJvmBinaryClass.AnnotationVisitor visitor, byte[] bArr) {
        ...
        a.f33903a.b(this.f33895a, visitor);
    }

    @NotNull
    public String toString() {
        return ReflectKotlinClass.class.getName() + ": " + this.f33895a;
    }

    @Override // kotlin.reflect.jvm.internal.impl.load.kotlin.KotlinJvmBinaryClass
    public void visitMembers(@NotNull KotlinJvmBinaryClass.MemberVisitor visitor, byte[] bArr) {
        Intrinsics.checkNotNullParameter(visitor, "visitor");
        a.f33903a.i(this.f33895a, visitor);
    }

    private ReflectKotlinClass(Class cls, KotlinClassHeader kotlinClassHeader) {
        this.f33895a = cls;
        this.f33896b = kotlinClassHeader;
    }
}
