...
public final class ReflectJavaRecordComponent extends ReflectJavaMember implements JavaRecordComponent {
    ...
    private final Object f33115a;

    public ReflectJavaRecordComponent(@NotNull Object recordComponent) {
        Intrinsics.checkNotNullParameter(recordComponent, "recordComponent");
        this.f33115a = recordComponent;
    }

    @Override // kotlin.reflect.jvm.internal.impl.descriptors.runtime.structure.ReflectJavaMember
    @NotNull
    public Member getMember() {
        Method c10 = Java16RecordComponentsLoader.f33071a.c(this.f33115a);
        if (c10 != null) {
            return c10;
        }
    ...
    public JavaType getType() {
        Class d10 = Java16RecordComponentsLoader.f33071a.d(this.f33115a);
        if (d10 != null) {
