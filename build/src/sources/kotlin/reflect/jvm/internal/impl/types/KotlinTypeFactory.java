...
public final class KotlinTypeFactory {
    ...
    /* renamed from: a */
    private static final Function1 f35855a = a.f35856d;

    /* loaded from: /home/runner/work/discord-client-datamining/discord-client-datamining/build/classes5.dex */
    static final class a implements Function1 {

        /* renamed from: d */
        public static final a f35856d = new a();
    ...
    public static final class b {
        ...
        /* renamed from: a */
        private final SimpleType f35857a;

        /* renamed from: b */
        private final TypeConstructor f35858b;

        public b(SimpleType simpleType, TypeConstructor typeConstructor) {
            this.f35857a = simpleType;
            this.f35858b = typeConstructor;
        }
    ...
    private final MemberScope c(TypeConstructor typeConstructor, List list, KotlinTypeRefiner kotlinTypeRefiner) {
        ...
        if (mo1198getDeclarationDescriptor instanceof TypeParameterDescriptor) {
            return ((TypeParameterDescriptor) mo1198getDeclarationDescriptor).getDefaultType().getMemberScope();
        }
        if (mo1198getDeclarationDescriptor instanceof ClassDescriptor) {
            if (kotlinTypeRefiner == null) {
                kotlinTypeRefiner = DescriptorUtilsKt.getKotlinTypeRefiner(DescriptorUtilsKt.getModule(mo1198getDeclarationDescriptor));
            }
            if (list.isEmpty()) {
                return ModuleAwareClassDescriptorKt.getRefinedUnsubstitutedMemberScopeIfPossible((ClassDescriptor) mo1198getDeclarationDescriptor, kotlinTypeRefiner);
            }
            return ModuleAwareClassDescriptorKt.getRefinedMemberScopeIfPossible((ClassDescriptor) mo1198getDeclarationDescriptor, TypeConstructorSubstitution.Companion.create(typeConstructor, list), kotlinTypeRefiner);
        } else if (mo1198getDeclarationDescriptor instanceof TypeAliasDescriptor) {
            return ErrorUtils.createErrorScope(ErrorScopeKind.SCOPE_FOR_ABBREVIATION_TYPE, true, ((TypeAliasDescriptor) mo1198getDeclarationDescriptor).getName().toString());
        } else {
            if (typeConstructor instanceof IntersectionTypeConstructor) {
                return ((IntersectionTypeConstructor) typeConstructor).createScopeForKotlinType();
            }
            throw new IllegalStateException("Unsupported classifier: " + mo1198getDeclarationDescriptor + " for constructor: " + typeConstructor);
        }
    }
    ...
    private final b d(TypeConstructor typeConstructor, KotlinTypeRefiner kotlinTypeRefiner, List list) {
        ...
        ClassifierDescriptor mo1198getDeclarationDescriptor = typeConstructor.mo1198getDeclarationDescriptor();
        if (mo1198getDeclarationDescriptor == null || (refineDescriptor = kotlinTypeRefiner.refineDescriptor(mo1198getDeclarationDescriptor)) == null) {
            return null;
        }
    ...
    public static final SimpleType simpleType(@NotNull TypeAttributes attributes, @NotNull TypeConstructor constructor, @NotNull List<? extends TypeProjection> arguments, boolean z10, KotlinTypeRefiner kotlinTypeRefiner) {
        ...
        Intrinsics.checkNotNullParameter(constructor, "constructor");
        Intrinsics.checkNotNullParameter(arguments, "arguments");
        if (attributes.isEmpty() && arguments.isEmpty() && !z10 && constructor.mo1198getDeclarationDescriptor() != null) {
            ClassifierDescriptor mo1198getDeclarationDescriptor = constructor.mo1198getDeclarationDescriptor();
            Intrinsics.checkNotNull(mo1198getDeclarationDescriptor);
            SimpleType defaultType = mo1198getDeclarationDescriptor.getDefaultType();
