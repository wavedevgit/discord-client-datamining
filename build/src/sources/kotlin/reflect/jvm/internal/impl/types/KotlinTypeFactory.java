...
public final class KotlinTypeFactory {
    ...
    /* renamed from: a */
    private static final Function1 f35129a = a.f35130d;

    /* loaded from: /home/runner/work/discord-client-datamining/discord-client-datamining/build/classes5.dex */
    static final class a implements Function1 {

        /* renamed from: d */
        public static final a f35130d = new a();
    ...
    public static final class b {
        ...
        /* renamed from: a */
        private final SimpleType f35131a;

        /* renamed from: b */
        private final TypeConstructor f35132b;

        public b(SimpleType simpleType, TypeConstructor typeConstructor) {
            this.f35131a = simpleType;
            this.f35132b = typeConstructor;
        }
    ...
    private final MemberScope c(TypeConstructor typeConstructor, List list, KotlinTypeRefiner kotlinTypeRefiner) {
        ...
        if (mo1201getDeclarationDescriptor instanceof TypeParameterDescriptor) {
            return ((TypeParameterDescriptor) mo1201getDeclarationDescriptor).getDefaultType().getMemberScope();
        }
        if (mo1201getDeclarationDescriptor instanceof ClassDescriptor) {
            if (kotlinTypeRefiner == null) {
                kotlinTypeRefiner = DescriptorUtilsKt.getKotlinTypeRefiner(DescriptorUtilsKt.getModule(mo1201getDeclarationDescriptor));
            }
            if (list.isEmpty()) {
                return ModuleAwareClassDescriptorKt.getRefinedUnsubstitutedMemberScopeIfPossible((ClassDescriptor) mo1201getDeclarationDescriptor, kotlinTypeRefiner);
            }
            return ModuleAwareClassDescriptorKt.getRefinedMemberScopeIfPossible((ClassDescriptor) mo1201getDeclarationDescriptor, TypeConstructorSubstitution.Companion.create(typeConstructor, list), kotlinTypeRefiner);
        } else if (mo1201getDeclarationDescriptor instanceof TypeAliasDescriptor) {
            return ErrorUtils.createErrorScope(ErrorScopeKind.SCOPE_FOR_ABBREVIATION_TYPE, true, ((TypeAliasDescriptor) mo1201getDeclarationDescriptor).getName().toString());
        } else {
            if (typeConstructor instanceof IntersectionTypeConstructor) {
                return ((IntersectionTypeConstructor) typeConstructor).createScopeForKotlinType();
            }
            throw new IllegalStateException("Unsupported classifier: " + mo1201getDeclarationDescriptor + " for constructor: " + typeConstructor);
        }
    }
    ...
    private final b d(TypeConstructor typeConstructor, KotlinTypeRefiner kotlinTypeRefiner, List list) {
        ...
        ClassifierDescriptor mo1201getDeclarationDescriptor = typeConstructor.mo1201getDeclarationDescriptor();
        if (mo1201getDeclarationDescriptor == null || (refineDescriptor = kotlinTypeRefiner.refineDescriptor(mo1201getDeclarationDescriptor)) == null) {
            return null;
        }
    ...
    public static final SimpleType simpleType(@NotNull TypeAttributes attributes, @NotNull TypeConstructor constructor, @NotNull List<? extends TypeProjection> arguments, boolean z10, KotlinTypeRefiner kotlinTypeRefiner) {
        ...
        Intrinsics.checkNotNullParameter(constructor, "constructor");
        Intrinsics.checkNotNullParameter(arguments, "arguments");
        if (attributes.isEmpty() && arguments.isEmpty() && !z10 && constructor.mo1201getDeclarationDescriptor() != null) {
            ClassifierDescriptor mo1201getDeclarationDescriptor = constructor.mo1201getDeclarationDescriptor();
            Intrinsics.checkNotNull(mo1201getDeclarationDescriptor);
            SimpleType defaultType = mo1201getDeclarationDescriptor.getDefaultType();
