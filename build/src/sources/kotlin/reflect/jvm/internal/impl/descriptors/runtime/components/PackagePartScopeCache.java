...
public final class PackagePartScopeCache {
    ...
    private final DeserializedDescriptorResolver f32579a;

    /* renamed from: b  reason: collision with root package name */
    private final ReflectKotlinClassFinder f32580b;

    /* renamed from: c  reason: collision with root package name */
    private final ConcurrentHashMap f32581c;
    ...
    public PackagePartScopeCache(@NotNull DeserializedDescriptorResolver resolver, @NotNull ReflectKotlinClassFinder kotlinClassFinder) {
        ...
        this.f32579a = resolver;
        this.f32580b = kotlinClassFinder;
        this.f32581c = new ConcurrentHashMap();
    }
    ...
    public final MemberScope getPackagePartScope(@NotNull ReflectKotlinClass fileClass) {
        ...
        ConcurrentHashMap concurrentHashMap = this.f32581c;
        ...
        if (obj == null) {
            ...
            if (fileClass.getClassHeader().getKind() == KotlinClassHeader.Kind.MULTIFILE_CLASS) {
                ...
                for (String str : fileClass.getClassHeader().getMultifilePartNames()) {
                    ...
                    KotlinJvmBinaryClass findKotlinClass = KotlinClassFinderKt.findKotlinClass(this.f32580b, companion.topLevel(fqNameForTopLevelClassMaybeWithDollars), this.f32579a.getComponents().getConfiguration().getMetadataVersion());
            ...
            EmptyPackageFragmentDescriptor emptyPackageFragmentDescriptor = new EmptyPackageFragmentDescriptor(this.f32579a.getComponents().getModuleDescriptor(), packageFqName);
            ArrayList arrayList = new ArrayList();
            for (KotlinJvmBinaryClass kotlinJvmBinaryClass : e10) {
                MemberScope createKotlinPackagePartScope = this.f32579a.createKotlinPackagePartScope(emptyPackageFragmentDescriptor, kotlinJvmBinaryClass);
