...
public final class PackagePartScopeCache {
    ...
    private final DeserializedDescriptorResolver f32357a;

    /* renamed from: b  reason: collision with root package name */
    private final ReflectKotlinClassFinder f32358b;

    /* renamed from: c  reason: collision with root package name */
    private final ConcurrentHashMap f32359c;
    ...
    public PackagePartScopeCache(@NotNull DeserializedDescriptorResolver resolver, @NotNull ReflectKotlinClassFinder kotlinClassFinder) {
        ...
        this.f32357a = resolver;
        this.f32358b = kotlinClassFinder;
    ...
    public final MemberScope getPackagePartScope(@NotNull ReflectKotlinClass fileClass) {
        ...
        ConcurrentHashMap concurrentHashMap = this.f32359c;
        ...
        if (obj == null) {
            ...
            if (fileClass.getClassHeader().getKind() == KotlinClassHeader.Kind.MULTIFILE_CLASS) {
                ...
                for (String str : fileClass.getClassHeader().getMultifilePartNames()) {
                    ...
                    KotlinJvmBinaryClass findKotlinClass = KotlinClassFinderKt.findKotlinClass(this.f32358b, companion.topLevel(fqNameForTopLevelClassMaybeWithDollars), this.f32357a.getComponents().getConfiguration().getMetadataVersion());
            ...
            EmptyPackageFragmentDescriptor emptyPackageFragmentDescriptor = new EmptyPackageFragmentDescriptor(this.f32357a.getComponents().getModuleDescriptor(), packageFqName);
            ArrayList arrayList = new ArrayList();
            for (KotlinJvmBinaryClass kotlinJvmBinaryClass : e10) {
                MemberScope createKotlinPackagePartScope = this.f32357a.createKotlinPackagePartScope(emptyPackageFragmentDescriptor, kotlinJvmBinaryClass);
