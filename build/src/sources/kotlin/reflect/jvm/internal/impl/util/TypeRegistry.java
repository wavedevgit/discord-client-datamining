...
public abstract class TypeRegistry<K, V> {
    ...
    private final ConcurrentHashMap f34558a = new ConcurrentHashMap();

    /* renamed from: b  reason: collision with root package name */
    private final AtomicInteger f34559b = new AtomicInteger(0);

    /* JADX INFO: Access modifiers changed from: private */
    public static final int b(TypeRegistry typeRegistry, String it) {
        Intrinsics.checkNotNullParameter(it, "it");
        return typeRegistry.f34559b.getAndIncrement();
    }
    ...
    public final Collection c() {
        Collection<V> values = this.f34558a.values();
    ...
    public final int getId(@NotNull String keyQualifiedName) {
        ...
        return customComputeIfAbsent(this.f34558a, keyQualifiedName, new i(this));
    }
}
