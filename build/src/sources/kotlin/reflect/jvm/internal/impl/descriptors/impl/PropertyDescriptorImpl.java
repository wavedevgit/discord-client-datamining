...
public class PropertyDescriptorImpl extends VariableDescriptorWithInitializerImpl implements PropertyDescriptor {
    ...
    private final Modality f33093t;

    /* renamed from: u  reason: collision with root package name */
    private DescriptorVisibility f33094u;

    /* renamed from: v  reason: collision with root package name */
    private Collection f33095v;

    /* renamed from: w  reason: collision with root package name */
    private final PropertyDescriptor f33096w;

    /* renamed from: x  reason: collision with root package name */
    private final CallableMemberDescriptor.Kind f33097x;

    /* renamed from: y  reason: collision with root package name */
    private final boolean f33098y;

    /* renamed from: z  reason: collision with root package name */
    private final boolean f33099z;

    /* loaded from: /home/runner/work/discord-client-datamining/discord-client-datamining/build/classes5.dex */
    public class CopyConfiguration {

        /* renamed from: a  reason: collision with root package name */
        private DeclarationDescriptor f33100a;

        /* renamed from: b  reason: collision with root package name */
        private Modality f33101b;

        /* renamed from: c  reason: collision with root package name */
        private DescriptorVisibility f33102c;

        /* renamed from: f  reason: collision with root package name */
        private CallableMemberDescriptor.Kind f33105f;

        /* renamed from: i  reason: collision with root package name */
        private ReceiverParameterDescriptor f33108i;

        /* renamed from: k  reason: collision with root package name */
        private Name f33110k;

        /* renamed from: l  reason: collision with root package name */
        private KotlinType f33111l;

        /* renamed from: d  reason: collision with root package name */
        private PropertyDescriptor f33103d = null;

        /* renamed from: e  reason: collision with root package name */
        private boolean f33104e = false;

        /* renamed from: g  reason: collision with root package name */
        private TypeSubstitution f33106g = TypeSubstitution.EMPTY;

        /* renamed from: h  reason: collision with root package name */
        private boolean f33107h = true;

        /* renamed from: j  reason: collision with root package name */
        private List f33109j = null;

        public CopyConfiguration() {
            this.f33100a = PropertyDescriptorImpl.this.getContainingDeclaration();
            this.f33101b = PropertyDescriptorImpl.this.getModality();
            this.f33102c = PropertyDescriptorImpl.this.getVisibility();
            this.f33105f = PropertyDescriptorImpl.this.getKind();
            this.f33108i = PropertyDescriptorImpl.this.F;
            this.f33110k = PropertyDescriptorImpl.this.getName();
            this.f33111l = PropertyDescriptorImpl.this.getType();
        }
        ...
        PropertyGetterDescriptor n() {
            PropertyDescriptor propertyDescriptor = this.f33103d;
        ...
        public CopyConfiguration setOwner(@NotNull DeclarationDescriptor declarationDescriptor) {
            ...
            this.f33100a = declarationDescriptor;
            return this;
        }
        ...
        public CopyConfiguration setVisibility(@NotNull DescriptorVisibility descriptorVisibility) {
            ...
            this.f33102c = descriptorVisibility;
            return this;
        }
    }
    ...
    public PropertyDescriptorImpl(DeclarationDescriptor declarationDescriptor, PropertyDescriptor propertyDescriptor, Annotations annotations, Modality modality, DescriptorVisibility descriptorVisibility, boolean z10, Name name, CallableMemberDescriptor.Kind kind, SourceElement sourceElement, boolean z11, boolean z12, boolean z13, boolean z14, boolean z15, boolean z16) {
        ...
        this.f33093t = modality;
        this.f33094u = descriptorVisibility;
        this.f33096w = propertyDescriptor == null ? this : propertyDescriptor;
        this.f33097x = kind;
        this.f33098y = z11;
        this.f33099z = z12;
        this.A = z13;
    ...
    */
    ...
    protected PropertyDescriptor d(CopyConfiguration copyConfiguration) {
        ...
        PropertyDescriptorImpl c10 = c(copyConfiguration.f33100a, copyConfiguration.f33101b, copyConfiguration.f33102c, copyConfiguration.f33103d, copyConfiguration.f33105f, copyConfiguration.f33110k, e(copyConfiguration.f33104e, copyConfiguration.f33103d));
        if (copyConfiguration.f33109j != null) {
            list = copyConfiguration.f33109j;
        } else {
            list = getTypeParameters();
        }
        ArrayList arrayList = new ArrayList(list.size());
        TypeSubstitutor substituteTypeParameters = DescriptorSubstitutor.substituteTypeParameters(list, copyConfiguration.f33106g, c10, arrayList);
        KotlinType kotlinType2 = copyConfiguration.f33111l;
        ...
        ReceiverParameterDescriptor receiverParameterDescriptor3 = copyConfiguration.f33108i;
        ...
        if (this.I == null) {
            ...
            propertyGetterDescriptorImpl = new PropertyGetterDescriptorImpl(c10, this.I.getAnnotations(), copyConfiguration.f33101b, g(this.I.getVisibility(), copyConfiguration.f33105f), this.I.isDefault(), this.I.isExternal(), this.I.isInline(), copyConfiguration.f33105f, copyConfiguration.n(), SourceElement.NO_SOURCE);
        }
        ...
        if (this.J == null) {
            ...
            propertySetterDescriptorImpl = new PropertySetterDescriptorImpl(c10, this.J.getAnnotations(), copyConfiguration.f33101b, g(this.J.getVisibility(), copyConfiguration.f33105f), this.J.isDefault(), this.J.isExternal(), this.J.isInline(), copyConfiguration.f33105f, copyConfiguration.o(), SourceElement.NO_SOURCE);
        }
        if (propertySetterDescriptorImpl != null) {
            ...
            if (substitutedValueParameters == null) {
                ...
                substitutedValueParameters = Collections.singletonList(PropertySetterDescriptorImpl.createSetterParameter(propertySetterDescriptorImpl, DescriptorUtilsKt.getBuiltIns(copyConfiguration.f33100a).getNothingType(), this.J.getValueParameters().get(0).getAnnotations()));
            }
        ...
        if (isConst() && (function0 = this.f33134s) != null) {
            c10.setCompileTimeInitializer(this.f33133r, function0);
        }
        return c10;
    }
    ...
    public CallableMemberDescriptor.Kind getKind() {
        CallableMemberDescriptor.Kind kind = this.f33097x;
        if (kind == null) {
            a(39);
        }
        return kind;
    ...
    public Modality getModality() {
        Modality modality = this.f33093t;
        if (modality == null) {
            a(24);
        }
        return modality;
    ...
    public Collection<? extends PropertyDescriptor> getOverriddenDescriptors() {
        Collection<? extends PropertyDescriptor> collection = this.f33095v;
        if (collection == null) {
    ...
    public DescriptorVisibility getVisibility() {
        DescriptorVisibility descriptorVisibility = this.f33094u;
        if (descriptorVisibility == null) {
            a(25);
        }
        return descriptorVisibility;
    ...
    public PropertyDescriptor getOriginal() {
        PropertyDescriptor propertyDescriptor = this.f33096w;
