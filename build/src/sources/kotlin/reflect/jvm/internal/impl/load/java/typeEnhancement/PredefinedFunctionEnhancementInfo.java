...
public final class PredefinedFunctionEnhancementInfo {
    ...
    private final TypeEnhancementInfo f33532a;

    /* renamed from: b  reason: collision with root package name */
    private final List f33533b;

    /* renamed from: c  reason: collision with root package name */
    private final String f33534c;

    /* renamed from: d  reason: collision with root package name */
    private final PredefinedFunctionEnhancementInfo f33535d;
    ...
    public PredefinedFunctionEnhancementInfo(TypeEnhancementInfo typeEnhancementInfo, @NotNull List<TypeEnhancementInfo> parametersInfo, String str) {
        ...
        this.f33532a = typeEnhancementInfo;
        this.f33533b = parametersInfo;
        this.f33534c = str;
        ...
        this.f33535d = predefinedFunctionEnhancementInfo;
    }
