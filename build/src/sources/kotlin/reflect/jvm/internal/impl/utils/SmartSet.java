...
public final class SmartSet<T> extends g {
    ...
    private static final class a implements Iterator, KMutableIterator {
        ...
        /* renamed from: d  reason: collision with root package name */
        private final Iterator f36126d;

        public a(Object[] array) {
            Intrinsics.checkNotNullParameter(array, "array");
            this.f36126d = ArrayIteratorKt.iterator(array);
        }
        ...
        public boolean hasNext() {
            return this.f36126d.hasNext();
        }

        @Override // java.util.Iterator
        public Object next() {
            return this.f36126d.next();
        }
    }
    ...
    private static final class b implements Iterator, KMutableIterator {
        ...
        /* renamed from: d  reason: collision with root package name */
        private final Object f36127d;

        /* renamed from: e  reason: collision with root package name */
        private boolean f36128e = true;
    ...
    public boolean add(T t10) {
        ...
        if (size() == 0) {
            ...
            if (Intrinsics.areEqual(this.f36124d, t10)) {
                return false;
            }
            this.f36124d = new Object[]{this.f36124d, t10};
        } else if (size() < 5) {
    ...
    public boolean contains(Object obj) {
        ...
        if (size() == 1) {
            return Intrinsics.areEqual(this.f36124d, obj);
        }
        if (size() < 5) {
            Object obj2 = this.f36124d;
