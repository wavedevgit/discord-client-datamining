...
public class AnnotationDescriptorImpl implements AnnotationDescriptor {
    ...
    private final KotlinType f32890a;

    /* renamed from: b  reason: collision with root package name */
    private final Map f32891b;

    /* renamed from: c  reason: collision with root package name */
    private final SourceElement f32892c;
    ...
    public AnnotationDescriptorImpl(@NotNull KotlinType kotlinType, @NotNull Map<Name, ConstantValue<?>> map, @NotNull SourceElement sourceElement) {
        ...
        this.f32890a = kotlinType;
        this.f32891b = map;
        this.f32892c = sourceElement;
    }
    ...
    public Map<Name, ConstantValue<?>> getAllValueArguments() {
        Map<Name, ConstantValue<?>> map = this.f32891b;
        if (map == null) {
            a(4);
        }
        return map;
    ...
    public SourceElement getSource() {
        SourceElement sourceElement = this.f32892c;
        if (sourceElement == null) {
            a(5);
        }
    ...
    public KotlinType getType() {
        KotlinType kotlinType = this.f32890a;
        if (kotlinType == null) {
            a(3);
        }
        return kotlinType;
