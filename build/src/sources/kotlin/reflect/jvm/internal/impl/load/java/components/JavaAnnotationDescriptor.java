...
public class JavaAnnotationDescriptor implements PossiblyExternalAnnotationDescriptor {
    ...
    static final /* synthetic */ KProperty[] f34071f = {Reflection.property1(new PropertyReference1Impl(JavaAnnotationDescriptor.class, "type", "getType()Lorg/jetbrains/kotlin/types/SimpleType;", 0))};

    /* renamed from: a  reason: collision with root package name */
    private final FqName f34072a;

    /* renamed from: b  reason: collision with root package name */
    private final SourceElement f34073b;

    /* renamed from: c  reason: collision with root package name */
    private final NotNullLazyValue f34074c;

    /* renamed from: d  reason: collision with root package name */
    private final JavaAnnotationArgument f34075d;
    ...
    public JavaAnnotationDescriptor(@NotNull LazyJavaResolverContext c10, JavaAnnotation javaAnnotation, @NotNull FqName fqName) {
        ...
        this.f34074c = c10.getStorageManager().createLazyValue(new a(c10, this));
        ...
        this.f34075d = javaAnnotationArgument;
        boolean z10 = false;
    ...
    public SimpleType getType() {
        return (SimpleType) StorageKt.getValue(this.f34074c, this, f34071f[0]);
    }
}
