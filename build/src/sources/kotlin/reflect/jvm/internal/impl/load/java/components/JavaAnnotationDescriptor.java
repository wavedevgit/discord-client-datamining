...
public class JavaAnnotationDescriptor implements PossiblyExternalAnnotationDescriptor {
    ...
    static final /* synthetic */ KProperty[] f32776f = {Reflection.property1(new PropertyReference1Impl(JavaAnnotationDescriptor.class, "type", "getType()Lorg/jetbrains/kotlin/types/SimpleType;", 0))};

    /* renamed from: a  reason: collision with root package name */
    private final FqName f32777a;

    /* renamed from: b  reason: collision with root package name */
    private final SourceElement f32778b;

    /* renamed from: c  reason: collision with root package name */
    private final NotNullLazyValue f32779c;

    /* renamed from: d  reason: collision with root package name */
    private final JavaAnnotationArgument f32780d;
    ...
    public JavaAnnotationDescriptor(@NotNull LazyJavaResolverContext c10, JavaAnnotation javaAnnotation, @NotNull FqName fqName) {
        ...
        this.f32778b = NO_SOURCE;
        this.f32779c = c10.getStorageManager().createLazyValue(new a(c10, this));
        ...
        this.f32780d = javaAnnotationArgument;
        boolean z10 = false;
    ...
    public SimpleType getType() {
        return (SimpleType) StorageKt.getValue(this.f32779c, this, f32776f[0]);
    }
}
