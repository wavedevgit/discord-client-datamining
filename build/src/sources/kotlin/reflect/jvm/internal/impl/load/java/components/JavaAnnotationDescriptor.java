...
public class JavaAnnotationDescriptor implements PossiblyExternalAnnotationDescriptor {
    ...
    static final /* synthetic */ KProperty[] f33345f = {Reflection.property1(new PropertyReference1Impl(JavaAnnotationDescriptor.class, "type", "getType()Lorg/jetbrains/kotlin/types/SimpleType;", 0))};

    /* renamed from: a  reason: collision with root package name */
    private final FqName f33346a;

    /* renamed from: b  reason: collision with root package name */
    private final SourceElement f33347b;

    /* renamed from: c  reason: collision with root package name */
    private final NotNullLazyValue f33348c;

    /* renamed from: d  reason: collision with root package name */
    private final JavaAnnotationArgument f33349d;
    ...
    public JavaAnnotationDescriptor(@NotNull LazyJavaResolverContext c10, JavaAnnotation javaAnnotation, @NotNull FqName fqName) {
        ...
        this.f33347b = NO_SOURCE;
        this.f33348c = c10.getStorageManager().createLazyValue(new a(c10, this));
        ...
        this.f33349d = javaAnnotationArgument;
        boolean z10 = false;
    ...
    public SimpleType getType() {
        return (SimpleType) StorageKt.getValue(this.f33348c, this, f33345f[0]);
    }
}
