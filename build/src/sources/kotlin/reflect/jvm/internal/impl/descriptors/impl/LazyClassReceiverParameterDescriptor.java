...
public class LazyClassReceiverParameterDescriptor extends AbstractReceiverParameterDescriptor {
    ...
    private final ClassDescriptor f32473i;

    /* renamed from: o  reason: collision with root package name */
    private final ImplicitClassReceiver f32474o;
    ...
    public LazyClassReceiverParameterDescriptor(@NotNull ClassDescriptor classDescriptor) {
        ...
        this.f32473i = classDescriptor;
        this.f32474o = new ImplicitClassReceiver(classDescriptor, null);
    }
    ...
    public DeclarationDescriptor getContainingDeclaration() {
        ClassDescriptor classDescriptor = this.f32473i;
        if (classDescriptor == null) {
            a(2);
        }
    ...
    public ReceiverValue getValue() {
        ImplicitClassReceiver implicitClassReceiver = this.f32474o;
    ...
    public String toString() {
        return "class " + this.f32473i.getName() + "::this";
    }
}
