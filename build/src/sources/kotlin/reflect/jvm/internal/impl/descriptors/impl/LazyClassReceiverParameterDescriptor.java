...
public class LazyClassReceiverParameterDescriptor extends AbstractReceiverParameterDescriptor {
    ...
    private final ClassDescriptor f33042i;

    /* renamed from: o  reason: collision with root package name */
    private final ImplicitClassReceiver f33043o;
    ...
    public LazyClassReceiverParameterDescriptor(@NotNull ClassDescriptor classDescriptor) {
        ...
        this.f33042i = classDescriptor;
        this.f33043o = new ImplicitClassReceiver(classDescriptor, null);
    }
    ...
    public DeclarationDescriptor getContainingDeclaration() {
        ClassDescriptor classDescriptor = this.f33042i;
        if (classDescriptor == null) {
            a(2);
        }
    ...
    public ReceiverValue getValue() {
        ImplicitClassReceiver implicitClassReceiver = this.f33043o;
    ...
    public String toString() {
        return "class " + this.f33042i.getName() + "::this";
    }
}
