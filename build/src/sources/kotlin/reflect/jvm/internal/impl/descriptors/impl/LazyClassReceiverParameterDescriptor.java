...
public class LazyClassReceiverParameterDescriptor extends AbstractReceiverParameterDescriptor {
    ...
    private final ClassDescriptor f32494i;

    /* renamed from: o  reason: collision with root package name */
    private final ImplicitClassReceiver f32495o;
    ...
    public LazyClassReceiverParameterDescriptor(@NotNull ClassDescriptor classDescriptor) {
        ...
        this.f32494i = classDescriptor;
        this.f32495o = new ImplicitClassReceiver(classDescriptor, null);
    }
    ...
    public DeclarationDescriptor getContainingDeclaration() {
        ClassDescriptor classDescriptor = this.f32494i;
        if (classDescriptor == null) {
            a(2);
        }
    ...
    public ReceiverValue getValue() {
        ImplicitClassReceiver implicitClassReceiver = this.f32495o;
    ...
    public String toString() {
        return "class " + this.f32494i.getName() + "::this";
    }
}
