...
public class LazyClassReceiverParameterDescriptor extends AbstractReceiverParameterDescriptor {
    ...
    private final ClassDescriptor f32474i;

    /* renamed from: o  reason: collision with root package name */
    private final ImplicitClassReceiver f32475o;
    ...
    public LazyClassReceiverParameterDescriptor(@NotNull ClassDescriptor classDescriptor) {
        ...
        this.f32474i = classDescriptor;
        this.f32475o = new ImplicitClassReceiver(classDescriptor, null);
    }
    ...
    public DeclarationDescriptor getContainingDeclaration() {
        ClassDescriptor classDescriptor = this.f32474i;
        if (classDescriptor == null) {
            a(2);
        }
    ...
    public ReceiverValue getValue() {
        ImplicitClassReceiver implicitClassReceiver = this.f32475o;
    ...
    public String toString() {
        return "class " + this.f32474i.getName() + "::this";
    }
}
