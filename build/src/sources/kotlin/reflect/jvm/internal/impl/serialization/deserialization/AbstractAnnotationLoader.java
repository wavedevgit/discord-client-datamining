...
public abstract class AbstractAnnotationLoader<A> implements AnnotationLoader<A> {
    ...
    private final SerializerExtensionProtocol f35339a;
    ...
    public List<A> loadCallableAnnotations(@NotNull ProtoContainer container, @NotNull MessageLite proto, @NotNull AnnotatedCallableKind kind) {
        ...
        if (proto instanceof ProtoBuf.Constructor) {
            list = (List) ((ProtoBuf.Constructor) proto).getExtension(this.f35339a.getConstructorAnnotation());
        } else if (proto instanceof ProtoBuf.Function) {
            list = (List) ((ProtoBuf.Function) proto).getExtension(this.f35339a.getFunctionAnnotation());
        } else if (proto instanceof ProtoBuf.Property) {
            int i10 = WhenMappings.$EnumSwitchMapping$0[kind.ordinal()];
            if (i10 != 1) {
                if (i10 != 2) {
                    if (i10 == 3) {
                        list = (List) ((ProtoBuf.Property) proto).getExtension(this.f35339a.getPropertySetterAnnotation());
                    } else {
                        throw new IllegalStateException("Unsupported callable kind with property proto");
                    }
                } else {
                    list = (List) ((ProtoBuf.Property) proto).getExtension(this.f35339a.getPropertyGetterAnnotation());
                }
            } else {
                list = (List) ((ProtoBuf.Property) proto).getExtension(this.f35339a.getPropertyAnnotation());
            }
        } else {
    ...
    public List<A> loadClassAnnotations(@NotNull ProtoContainer.Class container) {
        Intrinsics.checkNotNullParameter(container, "container");
        List list = (List) container.getClassProto().getExtension(this.f35339a.getClassAnnotation());
        if (list == null) {
            list = CollectionsKt.l();
        }
        List<ProtoBuf.Annotation> list2 = list;
    ...
    public List<A> loadEnumEntryAnnotations(@NotNull ProtoContainer container, @NotNull ProtoBuf.EnumEntry proto) {
        Intrinsics.checkNotNullParameter(container, "container");
        Intrinsics.checkNotNullParameter(proto, "proto");
        List list = (List) proto.getExtension(this.f35339a.getEnumEntryAnnotation());
        if (list == null) {
            list = CollectionsKt.l();
        }
        List<ProtoBuf.Annotation> list2 = list;
    ...
    public List<A> loadExtensionReceiverParameterAnnotations(@NotNull ProtoContainer container, @NotNull MessageLite proto, @NotNull AnnotatedCallableKind kind) {
        ...
        if (proto instanceof ProtoBuf.Function) {
            GeneratedMessageLite.GeneratedExtension<ProtoBuf.Function, List<ProtoBuf.Annotation>> functionExtensionReceiverAnnotation = this.f35339a.getFunctionExtensionReceiverAnnotation();
            ...
            GeneratedMessageLite.GeneratedExtension<ProtoBuf.Property, List<ProtoBuf.Annotation>> propertyExtensionReceiverAnnotation = this.f35339a.getPropertyExtensionReceiverAnnotation();
    ...
    public List<A> loadPropertyBackingFieldAnnotations(@NotNull ProtoContainer container, @NotNull ProtoBuf.Property proto) {
        ...
        Intrinsics.checkNotNullParameter(container, "container");
        Intrinsics.checkNotNullParameter(proto, "proto");
        GeneratedMessageLite.GeneratedExtension<ProtoBuf.Property, List<ProtoBuf.Annotation>> propertyBackingFieldAnnotation = this.f35339a.getPropertyBackingFieldAnnotation();
    ...
    public List<A> loadPropertyDelegateFieldAnnotations(@NotNull ProtoContainer container, @NotNull ProtoBuf.Property proto) {
        ...
        Intrinsics.checkNotNullParameter(container, "container");
        Intrinsics.checkNotNullParameter(proto, "proto");
        GeneratedMessageLite.GeneratedExtension<ProtoBuf.Property, List<ProtoBuf.Annotation>> propertyDelegatedFieldAnnotation = this.f35339a.getPropertyDelegatedFieldAnnotation();
    ...
    public List<A> loadTypeAnnotations(@NotNull ProtoBuf.Type proto, @NotNull NameResolver nameResolver) {
        ...
        List list = (List) proto.getExtension(this.f35339a.getTypeAnnotation());
        if (list == null) {
            list = CollectionsKt.l();
        }
        List<ProtoBuf.Annotation> list2 = list;
    ...
    public List<A> loadTypeParameterAnnotations(@NotNull ProtoBuf.TypeParameter proto, @NotNull NameResolver nameResolver) {
        Intrinsics.checkNotNullParameter(proto, "proto");
        Intrinsics.checkNotNullParameter(nameResolver, "nameResolver");
        List list = (List) proto.getExtension(this.f35339a.getTypeParameterAnnotation());
        if (list == null) {
            list = CollectionsKt.l();
        }
        List<ProtoBuf.Annotation> list2 = list;
    ...
    public List<A> loadValueParameterAnnotations(@NotNull ProtoContainer container, @NotNull MessageLite callableProto, @NotNull AnnotatedCallableKind kind, int i10, @NotNull ProtoBuf.ValueParameter proto) {
        ...
        Intrinsics.checkNotNullParameter(kind, "kind");
        Intrinsics.checkNotNullParameter(proto, "proto");
        List list = (List) proto.getExtension(this.f35339a.getParameterAnnotation());
        if (list == null) {
            list = CollectionsKt.l();
        }
        List<ProtoBuf.Annotation> list2 = list;
