...
public final class IntersectionTypeConstructor implements TypeConstructor, IntersectionTypeConstructorMarker {
    ...
    public IntersectionTypeConstructor(@NotNull Collection<? extends KotlinType> typesToIntersect) {
        ...
        this.f35125b = linkedHashSet;
        this.f35126c = linkedHashSet.hashCode();
    }
    ...
    public final MemberScope createScopeForKotlinType() {
        return TypeIntersectionScope.Companion.create("member scope for intersection type", this.f35125b);
    }
    ...
    public boolean equals(Object obj) {
        ...
        return Intrinsics.areEqual(this.f35125b, ((IntersectionTypeConstructor) obj).f35125b);
    }
    ...
    public KotlinBuiltIns getBuiltIns() {
        KotlinBuiltIns builtIns = ((KotlinType) this.f35125b.iterator().next()).getConstructor().getBuiltIns();
    ...
    public final String makeDebugNameForIntersectionType(@NotNull final Function1<? super KotlinType, ? extends Object> getProperTypeRelatedToStringify) {
        ...
        return CollectionsKt.x0(CollectionsKt.W0(this.f35125b, new Comparator() { // from class: kotlin.reflect.jvm.internal.impl.types.IntersectionTypeConstructor$makeDebugNameForIntersectionType$$inlined$sortedBy$1
    ...
    public final IntersectionTypeConstructor setAlternative(KotlinType kotlinType) {
        return new IntersectionTypeConstructor(this.f35125b, kotlinType);
    }
