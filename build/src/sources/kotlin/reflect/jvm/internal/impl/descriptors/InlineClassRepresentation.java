...
public final class InlineClassRepresentation<Type extends RigidTypeMarker> extends ValueClassRepresentation<Type> {
    ...
    private final Name f32287a;

    /* renamed from: b  reason: collision with root package name */
    private final RigidTypeMarker f32288b;
    ...
    public InlineClassRepresentation(@NotNull Name underlyingPropertyName, @NotNull Type underlyingType) {
        ...
        this.f32287a = underlyingPropertyName;
        this.f32288b = underlyingType;
    }

    @Override // kotlin.reflect.jvm.internal.impl.descriptors.ValueClassRepresentation
    public boolean containsPropertyWithName(@NotNull Name name) {
        Intrinsics.checkNotNullParameter(name, "name");
        return Intrinsics.areEqual(this.f32287a, name);
    }
    ...
    public final Type getUnderlyingType() {
        return (Type) this.f32288b;
    }

    @NotNull
    public String toString() {
        return "InlineClassRepresentation(underlyingPropertyName=" + this.f32287a + ", underlyingType=" + this.f32288b + ')';
    }
}
