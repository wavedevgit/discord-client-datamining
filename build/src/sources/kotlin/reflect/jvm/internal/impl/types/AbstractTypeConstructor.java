...
public abstract class AbstractTypeConstructor extends ClassifierBasedTypeConstructor {
    ...
    private final NotNullLazyValue f34523b;
    ...
    public final class a implements TypeConstructor {
        ...
        private final KotlinTypeRefiner f34525a;

        /* renamed from: b  reason: collision with root package name */
        private final Lazy f34526b;

        /* renamed from: c  reason: collision with root package name */
        final /* synthetic */ AbstractTypeConstructor f34527c;

        public a(AbstractTypeConstructor abstractTypeConstructor, KotlinTypeRefiner kotlinTypeRefiner) {
            Intrinsics.checkNotNullParameter(kotlinTypeRefiner, "kotlinTypeRefiner");
            this.f34527c = abstractTypeConstructor;
            this.f34525a = kotlinTypeRefiner;
            this.f34526b = as.l.a(as.o.f6082e, new j(this, abstractTypeConstructor));
        }

        private final List b() {
            return (List) this.f34526b.getValue();
        }

        /* JADX INFO: Access modifiers changed from: private */
        public static final List d(a aVar, AbstractTypeConstructor abstractTypeConstructor) {
            return KotlinTypeRefinerKt.refineTypes(aVar.f34525a, abstractTypeConstructor.getSupertypes());
        }
        ...
        public boolean equals(Object obj) {
            return this.f34527c.equals(obj);
        }

        @Override // kotlin.reflect.jvm.internal.impl.types.TypeConstructor
        public KotlinBuiltIns getBuiltIns() {
            KotlinBuiltIns builtIns = this.f34527c.getBuiltIns();
        ...
        public ClassifierDescriptor mo1202getDeclarationDescriptor() {
            return this.f34527c.mo1202getDeclarationDescriptor();
        }

        @Override // kotlin.reflect.jvm.internal.impl.types.TypeConstructor
        public List getParameters() {
            List<TypeParameterDescriptor> parameters = this.f34527c.getParameters();
            Intrinsics.checkNotNullExpressionValue(parameters, "getParameters(...)");
            return parameters;
        }

        public int hashCode() {
            return this.f34527c.hashCode();
        }

        @Override // kotlin.reflect.jvm.internal.impl.types.TypeConstructor
        public boolean isDenotable() {
            return this.f34527c.isDenotable();
        }

        @Override // kotlin.reflect.jvm.internal.impl.types.TypeConstructor
        public TypeConstructor refine(KotlinTypeRefiner kotlinTypeRefiner) {
            Intrinsics.checkNotNullParameter(kotlinTypeRefiner, "kotlinTypeRefiner");
            return this.f34527c.refine(kotlinTypeRefiner);
        }

        public String toString() {
            return this.f34527c.toString();
        }
    }
    ...
    public static final class b {
        ...
        /* renamed from: a  reason: collision with root package name */
        private final Collection f34528a;

        /* renamed from: b  reason: collision with root package name */
        private List f34529b;

        public b(Collection allSupertypes) {
            Intrinsics.checkNotNullParameter(allSupertypes, "allSupertypes");
            this.f34528a = allSupertypes;
            this.f34529b = CollectionsKt.e(ErrorUtils.INSTANCE.getErrorTypeForLoopInSupertypes());
        }
    ...
    public AbstractTypeConstructor(@NotNull StorageManager storageManager) {
        ...
        this.f34523b = storageManager.createLazyValueWithPostCompute(new c(this), d.f34671d, new e(this));
    }
    ...
    private final Collection k(TypeConstructor typeConstructor, boolean z10) {
        ...
        if (abstractTypeConstructor != null && (L0 = CollectionsKt.L0(((b) abstractTypeConstructor.f34523b.invoke()).a(), abstractTypeConstructor.n(z10))) != null) {
            return L0;
        }
    ...
    public List<KotlinType> getSupertypes() {
        return ((b) this.f34523b.invoke()).b();
    }
}
