...
public abstract class AbstractTypeConstructor extends ClassifierBasedTypeConstructor {
    ...
    private final NotNullLazyValue f35092b;
    ...
    public final class a implements TypeConstructor {
        ...
        private final KotlinTypeRefiner f35094a;

        /* renamed from: b  reason: collision with root package name */
        private final Lazy f35095b;

        /* renamed from: c  reason: collision with root package name */
        final /* synthetic */ AbstractTypeConstructor f35096c;

        public a(AbstractTypeConstructor abstractTypeConstructor, KotlinTypeRefiner kotlinTypeRefiner) {
            Intrinsics.checkNotNullParameter(kotlinTypeRefiner, "kotlinTypeRefiner");
            this.f35096c = abstractTypeConstructor;
            this.f35094a = kotlinTypeRefiner;
            this.f35095b = as.l.a(as.o.f6082e, new j(this, abstractTypeConstructor));
        }

        private final List b() {
            return (List) this.f35095b.getValue();
        }

        /* JADX INFO: Access modifiers changed from: private */
        public static final List d(a aVar, AbstractTypeConstructor abstractTypeConstructor) {
            return KotlinTypeRefinerKt.refineTypes(aVar.f35094a, abstractTypeConstructor.getSupertypes());
        }
        ...
        public boolean equals(Object obj) {
            return this.f35096c.equals(obj);
        }

        @Override // kotlin.reflect.jvm.internal.impl.types.TypeConstructor
        public KotlinBuiltIns getBuiltIns() {
            KotlinBuiltIns builtIns = this.f35096c.getBuiltIns();
        ...
        public ClassifierDescriptor mo1201getDeclarationDescriptor() {
            return this.f35096c.mo1201getDeclarationDescriptor();
        }

        @Override // kotlin.reflect.jvm.internal.impl.types.TypeConstructor
        public List getParameters() {
            List<TypeParameterDescriptor> parameters = this.f35096c.getParameters();
        ...
        public boolean isDenotable() {
            return this.f35096c.isDenotable();
        }

        @Override // kotlin.reflect.jvm.internal.impl.types.TypeConstructor
        public TypeConstructor refine(KotlinTypeRefiner kotlinTypeRefiner) {
            Intrinsics.checkNotNullParameter(kotlinTypeRefiner, "kotlinTypeRefiner");
            return this.f35096c.refine(kotlinTypeRefiner);
        }

        public String toString() {
            return this.f35096c.toString();
        }
    }
    ...
    public static final class b {
        ...
        public b(Collection allSupertypes) {
            ...
            this.f35097a = allSupertypes;
            this.f35098b = CollectionsKt.e(ErrorUtils.INSTANCE.getErrorTypeForLoopInSupertypes());
        }
    ...
    public AbstractTypeConstructor(@NotNull StorageManager storageManager) {
        ...
        this.f35092b = storageManager.createLazyValueWithPostCompute(new c(this), d.f35240d, new e(this));
    }
    ...
    private final Collection k(TypeConstructor typeConstructor, boolean z10) {
        ...
        if (abstractTypeConstructor != null && (L0 = CollectionsKt.L0(((b) abstractTypeConstructor.f35092b.invoke()).a(), abstractTypeConstructor.n(z10))) != null) {
            return L0;
        }
    ...
    public List<KotlinType> getSupertypes() {
        return ((b) this.f35092b.invoke()).b();
    }
}
