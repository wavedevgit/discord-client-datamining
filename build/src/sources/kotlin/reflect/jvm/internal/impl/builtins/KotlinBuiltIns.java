...
public abstract class KotlinBuiltIns {
    ...
    private ModuleDescriptorImpl f32116a;

    /* renamed from: b  reason: collision with root package name */
    private NotNullLazyValue f32117b;

    /* renamed from: c  reason: collision with root package name */
    private final NotNullLazyValue f32118c;

    /* renamed from: d  reason: collision with root package name */
    private final NotNullLazyValue f32119d;

    /* renamed from: e  reason: collision with root package name */
    private final MemoizedFunctionToNotNull f32120e;

    /* renamed from: f  reason: collision with root package name */
    private final StorageManager f32121f;
    ...
    class c implements Function1 {
        ...
        public ClassDescriptor invoke(Name name) {
            ClassifierDescriptor mo1202getContributedClassifier = KotlinBuiltIns.this.getBuiltInsPackageScope().mo1202getContributedClassifier(name, NoLookupLocation.FROM_BUILTINS);
            if (mo1202getContributedClassifier != null) {
                ...
                throw new AssertionError("Must be a class descriptor " + name + ", but was " + mo1202getContributedClassifier);
            }
    ...
    class d implements Function0 {
        ...
        /* renamed from: d  reason: collision with root package name */
        final /* synthetic */ ModuleDescriptorImpl f32125d;

        d(ModuleDescriptorImpl moduleDescriptorImpl) {
            this.f32125d = moduleDescriptorImpl;
        }

        @Override // kotlin.jvm.functions.Function0
        /* renamed from: a */
        public Void invoke() {
            if (KotlinBuiltIns.this.f32116a == null) {
                KotlinBuiltIns.this.f32116a = this.f32125d;
                return null;
            }
            throw new AssertionError("Built-ins module is already set: " + KotlinBuiltIns.this.f32116a + " (attempting to reset to " + this.f32125d + ")");
        }
    }
    ...
    public static class e {
        ...
        /* renamed from: a  reason: collision with root package name */
        public final Map f32127a;

        /* renamed from: b  reason: collision with root package name */
        public final Map f32128b;

        /* renamed from: c  reason: collision with root package name */
        public final Map f32129c;
    ...
    public KotlinBuiltIns(StorageManager storageManager) {
        ...
        this.f32121f = storageManager;
        this.f32119d = storageManager.createLazyValue(new a());
        this.f32118c = storageManager.createLazyValue(new b());
        this.f32120e = storageManager.createMemoizedFunction(new c());
    }
    ...
    */
    ...
    public static PrimitiveType getPrimitiveArrayElementType(@NotNull KotlinType kotlinType) {
        ...
        return getPrimitiveArrayType(mo1201getDeclarationDescriptor);
    }
    ...
    private ClassDescriptor h(String str) {
        ...
        ClassDescriptor classDescriptor = (ClassDescriptor) this.f32120e.invoke(Name.identifier(str));
    ...
    public static boolean isPrimitiveArray(@NotNull KotlinType kotlinType) {
        ...
        ClassifierDescriptor mo1201getDeclarationDescriptor = kotlinType.getConstructor().mo1201getDeclarationDescriptor();
        if (mo1201getDeclarationDescriptor != null && getPrimitiveArrayType(mo1201getDeclarationDescriptor) != null) {
            return true;
        }
        return false;
    }
    ...
    public static boolean isPrimitiveTypeOrNullablePrimitiveType(@NotNull KotlinType kotlinType) {
        ...
        ClassifierDescriptor mo1201getDeclarationDescriptor = kotlinType.getConstructor().mo1201getDeclarationDescriptor();
        if ((mo1201getDeclarationDescriptor instanceof ClassDescriptor) && isPrimitiveClass((ClassDescriptor) mo1201getDeclarationDescriptor)) {
            return true;
        }
        return false;
    }
    ...
    public static boolean isTypeConstructorForGivenClass(@NotNull TypeConstructor typeConstructor, @NotNull FqNameUnsafe fqNameUnsafe) {
        ...
        if ((mo1201getDeclarationDescriptor instanceof ClassDescriptor) && e(mo1201getDeclarationDescriptor, fqNameUnsafe)) {
            return true;
        }
        return false;
    }
    ...
    private static KotlinType j(KotlinType kotlinType, ModuleDescriptor moduleDescriptor) {
        ...
        if (!unsignedTypes.isShortNameOfUnsignedArray(mo1201getDeclarationDescriptor.getName()) || (classId = DescriptorUtilsKt.getClassId(mo1201getDeclarationDescriptor)) == null || (unsignedClassIdByArrayClassId = unsignedTypes.getUnsignedClassIdByArrayClassId(classId)) == null || (findClassAcrossModuleDependencies = FindClassInModuleKt.findClassAcrossModuleDependencies(moduleDescriptor, unsignedClassIdByArrayClassId)) == null) {
            return null;
        }
    ...
    public void f(boolean z10) {
        ModuleDescriptorImpl moduleDescriptorImpl = new ModuleDescriptorImpl(BUILTINS_MODULE_NAME, this.f32121f, this, null);
        this.f32116a = moduleDescriptorImpl;
        moduleDescriptorImpl.initialize(BuiltInsLoader.Companion.getInstance().createPackageFragmentProvider(this.f32121f, this.f32116a, getClassDescriptorFactories(), k(), g(), z10));
        ModuleDescriptorImpl moduleDescriptorImpl2 = this.f32116a;
    ...
    public KotlinType getArrayElementTypeOrNull(@NotNull KotlinType kotlinType) {
        ...
        KotlinType kotlinType2 = (KotlinType) ((e) this.f32118c.invoke()).f32129c.get(makeNotNullable);
        if (kotlinType2 != null) {
            return kotlinType2;
        }
    ...
    public ModuleDescriptorImpl getBuiltInsModule() {
        if (this.f32116a == null) {
            this.f32116a = (ModuleDescriptorImpl) this.f32117b.invoke();
        }
        ModuleDescriptorImpl moduleDescriptorImpl = this.f32116a;
    ...
    public Iterable getClassDescriptorFactories() {
        List singletonList = Collections.singletonList(new BuiltInFictitiousFunctionClassFactory(this.f32121f, getBuiltInsModule()));
    ...
    public SimpleType getPrimitiveArrayKotlinType(@NotNull PrimitiveType primitiveType) {
        ...
        SimpleType simpleType = (SimpleType) ((e) this.f32118c.invoke()).f32127a.get(primitiveType);
        if (simpleType == null) {
            a(74);
        }
        return simpleType;
    ...
    public StorageManager m() {
        StorageManager storageManager = this.f32121f;
        if (storageManager == null) {
            a(6);
        }
    ...
    public void setBuiltInsModule(@NotNull ModuleDescriptorImpl moduleDescriptorImpl) {
        ...
        this.f32121f.compute(new d(moduleDescriptorImpl));
    }
