...
public abstract class KotlinBuiltIns {
    ...
    private ModuleDescriptorImpl f32684a;

    /* renamed from: b  reason: collision with root package name */
    private NotNullLazyValue f32685b;

    /* renamed from: c  reason: collision with root package name */
    private final NotNullLazyValue f32686c;

    /* renamed from: d  reason: collision with root package name */
    private final NotNullLazyValue f32687d;

    /* renamed from: e  reason: collision with root package name */
    private final MemoizedFunctionToNotNull f32688e;

    /* renamed from: f  reason: collision with root package name */
    private final StorageManager f32689f;
    ...
    class d implements Function0 {
        ...
        /* renamed from: d  reason: collision with root package name */
        final /* synthetic */ ModuleDescriptorImpl f32693d;

        d(ModuleDescriptorImpl moduleDescriptorImpl) {
            this.f32693d = moduleDescriptorImpl;
        }

        @Override // kotlin.jvm.functions.Function0
        /* renamed from: a */
        public Void invoke() {
            if (KotlinBuiltIns.this.f32684a == null) {
                KotlinBuiltIns.this.f32684a = this.f32693d;
                return null;
            }
            throw new AssertionError("Built-ins module is already set: " + KotlinBuiltIns.this.f32684a + " (attempting to reset to " + this.f32693d + ")");
        }
    }
    ...
    public static class e {
        ...
        /* renamed from: a  reason: collision with root package name */
        public final Map f32695a;

        /* renamed from: b  reason: collision with root package name */
        public final Map f32696b;
    ...
    public KotlinBuiltIns(StorageManager storageManager) {
        ...
        this.f32689f = storageManager;
        this.f32687d = storageManager.createLazyValue(new a());
        this.f32686c = storageManager.createLazyValue(new b());
        this.f32688e = storageManager.createMemoizedFunction(new c());
    }
    ...
    */
    ...
    private ClassDescriptor h(String str) {
        ...
        ClassDescriptor classDescriptor = (ClassDescriptor) this.f32688e.invoke(Name.identifier(str));
    ...
    public void f(boolean z10) {
        ModuleDescriptorImpl moduleDescriptorImpl = new ModuleDescriptorImpl(BUILTINS_MODULE_NAME, this.f32689f, this, null);
        this.f32684a = moduleDescriptorImpl;
        moduleDescriptorImpl.initialize(BuiltInsLoader.Companion.getInstance().createPackageFragmentProvider(this.f32689f, this.f32684a, getClassDescriptorFactories(), k(), g(), z10));
        ModuleDescriptorImpl moduleDescriptorImpl2 = this.f32684a;
    ...
    public KotlinType getArrayElementTypeOrNull(@NotNull KotlinType kotlinType) {
        ...
        KotlinType kotlinType2 = (KotlinType) ((e) this.f32686c.invoke()).f32697c.get(makeNotNullable);
        if (kotlinType2 != null) {
            return kotlinType2;
        }
    ...
    public ModuleDescriptorImpl getBuiltInsModule() {
        if (this.f32684a == null) {
            this.f32684a = (ModuleDescriptorImpl) this.f32685b.invoke();
        }
        ModuleDescriptorImpl moduleDescriptorImpl = this.f32684a;
    ...
    public Iterable getClassDescriptorFactories() {
        List singletonList = Collections.singletonList(new BuiltInFictitiousFunctionClassFactory(this.f32689f, getBuiltInsModule()));
    ...
    public SimpleType getPrimitiveArrayKotlinType(@NotNull PrimitiveType primitiveType) {
        ...
        SimpleType simpleType = (SimpleType) ((e) this.f32686c.invoke()).f32695a.get(primitiveType);
        if (simpleType == null) {
            a(74);
        }
        return simpleType;
    ...
    public StorageManager m() {
        StorageManager storageManager = this.f32689f;
        if (storageManager == null) {
            a(6);
        }
    ...
    public void setBuiltInsModule(@NotNull ModuleDescriptorImpl moduleDescriptorImpl) {
        ...
        this.f32689f.compute(new d(moduleDescriptorImpl));
    }
