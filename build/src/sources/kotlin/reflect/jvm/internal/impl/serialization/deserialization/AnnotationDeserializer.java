...
public final class AnnotationDeserializer {
    ...
    private final ModuleDescriptor f34829a;

    /* renamed from: b  reason: collision with root package name */
    private final NotFoundClasses f34830b;
    ...
    private final boolean a(ConstantValue constantValue, KotlinType kotlinType, ProtoBuf.Annotation.Argument.Value value) {
        ...
        if (i10 != 10) {
            if (i10 != 13) {
                return Intrinsics.areEqual(constantValue.getType(this.f34829a), kotlinType);
            }
    ...
    private final KotlinBuiltIns b() {
        return this.f34829a.getBuiltIns();
    }
    ...
    private final ClassDescriptor d(ClassId classId) {
        return FindClassInModuleKt.findNonGenericClassAcrossDependencies(this.f34829a, classId, this.f34830b);
    }
