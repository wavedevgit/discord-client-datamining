...
public final class AnnotationDeserializer {
    ...
    private final ModuleDescriptor f34260a;

    /* renamed from: b  reason: collision with root package name */
    private final NotFoundClasses f34261b;
    ...
    private final boolean a(ConstantValue constantValue, KotlinType kotlinType, ProtoBuf.Annotation.Argument.Value value) {
        ...
        if (i10 != 10) {
            if (i10 != 13) {
                return Intrinsics.areEqual(constantValue.getType(this.f34260a), kotlinType);
            }
    ...
    private final KotlinBuiltIns b() {
        return this.f34260a.getBuiltIns();
    }
    ...
    private final ClassDescriptor d(ClassId classId) {
        return FindClassInModuleKt.findNonGenericClassAcrossDependencies(this.f34260a, classId, this.f34261b);
    }
