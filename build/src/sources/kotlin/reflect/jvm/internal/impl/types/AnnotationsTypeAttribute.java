...
public final class AnnotationsTypeAttribute extends TypeAttribute<AnnotationsTypeAttribute> {
    ...
    public boolean equals(Object obj) {
        ...
        return Intrinsics.areEqual(((AnnotationsTypeAttribute) obj).f35825a, this.f35825a);
    }
    ...
    public AnnotationsTypeAttribute add(AnnotationsTypeAttribute annotationsTypeAttribute) {
        return annotationsTypeAttribute == null ? this : new AnnotationsTypeAttribute(AnnotationsKt.composeAnnotations(this.f35825a, annotationsTypeAttribute.f35825a));
    }
