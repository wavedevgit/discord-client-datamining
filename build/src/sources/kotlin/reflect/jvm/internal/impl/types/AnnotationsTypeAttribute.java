...
public final class AnnotationsTypeAttribute extends TypeAttribute<AnnotationsTypeAttribute> {
    ...
    public boolean equals(Object obj) {
        ...
        return Intrinsics.areEqual(((AnnotationsTypeAttribute) obj).f35099a, this.f35099a);
    }
    ...
    public AnnotationsTypeAttribute add(AnnotationsTypeAttribute annotationsTypeAttribute) {
        return annotationsTypeAttribute == null ? this : new AnnotationsTypeAttribute(AnnotationsKt.composeAnnotations(this.f35099a, annotationsTypeAttribute.f35099a));
    }
