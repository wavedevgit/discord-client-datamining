...
public final class AnnotationsTypeAttribute extends TypeAttribute<AnnotationsTypeAttribute> {
    ...
    public boolean equals(Object obj) {
        ...
        return Intrinsics.areEqual(((AnnotationsTypeAttribute) obj).f34308a, this.f34308a);
    }
    ...
    public AnnotationsTypeAttribute add(AnnotationsTypeAttribute annotationsTypeAttribute) {
        return annotationsTypeAttribute == null ? this : new AnnotationsTypeAttribute(AnnotationsKt.composeAnnotations(this.f34308a, annotationsTypeAttribute.f34308a));
    }
