...
public class LazySubstitutingClassDescriptor extends ModuleAwareClassDescriptor {
    ...
    private final ModuleAwareClassDescriptor f33776d;

    /* renamed from: e  reason: collision with root package name */
    private final TypeSubstitutor f33777e;

    /* renamed from: i  reason: collision with root package name */
    private TypeSubstitutor f33778i;

    /* renamed from: o  reason: collision with root package name */
    private List f33779o;

    /* renamed from: p  reason: collision with root package name */
    private List f33780p;

    /* renamed from: q  reason: collision with root package name */
    private TypeConstructor f33781q;
    ...
    public LazySubstitutingClassDescriptor(ModuleAwareClassDescriptor moduleAwareClassDescriptor, TypeSubstitutor typeSubstitutor) {
        this.f33776d = moduleAwareClassDescriptor;
        this.f33777e = typeSubstitutor;
    }
    ...
    */
    ...
    private TypeSubstitutor c() {
        if (this.f33778i == null) {
            if (this.f33777e.isEmpty()) {
                this.f33778i = this.f33777e;
            } else {
                List<TypeParameterDescriptor> parameters = this.f33776d.getTypeConstructor().getParameters();
                this.f33779o = new ArrayList(parameters.size());
                this.f33778i = DescriptorSubstitutor.substituteTypeParameters(parameters, this.f33777e.getSubstitution(), this, this.f33779o);
                this.f33780p = CollectionsKt.k0(this.f33779o, new a());
            }
        }
        return this.f33778i;
    }
    ...
    public SimpleType d(SimpleType simpleType) {
        if (simpleType != null && !this.f33777e.isEmpty()) {
    ...
    public Annotations getAnnotations() {
        Annotations annotations = this.f33776d.getAnnotations();
        if (annotations == null) {
            a(19);
        }
        return annotations;
    ...
    public ClassDescriptor mo1192getCompanionObjectDescriptor() {
        return this.f33776d.mo1192getCompanionObjectDescriptor();
    }

    @Override // kotlin.reflect.jvm.internal.impl.descriptors.ClassDescriptor
    @NotNull
    public Collection<ClassConstructorDescriptor> getConstructors() {
        Collection<ClassConstructorDescriptor> constructors = this.f33776d.getConstructors();
    ...
    public DeclarationDescriptor getContainingDeclaration() {
        DeclarationDescriptor containingDeclaration = this.f33776d.getContainingDeclaration();
    ...
    public List<TypeParameterDescriptor> getDeclaredTypeParameters() {
        c();
        List<TypeParameterDescriptor> list = this.f33780p;
        if (list == null) {
            a(30);
        }
        return list;
    ...
    public ClassKind getKind() {
        ClassKind kind = this.f33776d.getKind();
        if (kind == null) {
            a(25);
        }
        return kind;
    ...
    public MemberScope getMemberScope(@NotNull TypeSubstitution typeSubstitution, @NotNull KotlinTypeRefiner kotlinTypeRefiner) {
        ...
        MemberScope memberScope = this.f33776d.getMemberScope(typeSubstitution, kotlinTypeRefiner);
        if (this.f33777e.isEmpty()) {
            if (memberScope == null) {
                a(7);
            }
    ...
    public Modality getModality() {
        Modality modality = this.f33776d.getModality();
        if (modality == null) {
            a(26);
        }
        return modality;
    ...
    @NotNull
    public Name getName() {
        Name name = this.f33776d.getName();
        if (name == null) {
            a(20);
        }
        return name;
    ...
    public Collection<ClassDescriptor> getSealedSubclasses() {
        Collection<ClassDescriptor> sealedSubclasses = this.f33776d.getSealedSubclasses();
    ...
    public MemberScope getStaticScope() {
        MemberScope staticScope = this.f33776d.getStaticScope();
        if (staticScope == null) {
            a(15);
        }
        return staticScope;
    ...
    public TypeConstructor getTypeConstructor() {
        TypeConstructor typeConstructor = this.f33776d.getTypeConstructor();
        if (this.f33777e.isEmpty()) {
        ...
        if (this.f33781q == null) {
            ...
            this.f33781q = new ClassTypeConstructorImpl(this, this.f33779o, arrayList, LockBasedStorageManager.NO_LOCKS);
        }
        TypeConstructor typeConstructor2 = this.f33781q;
    ...
    public MemberScope getUnsubstitutedInnerClassesScope() {
        MemberScope unsubstitutedInnerClassesScope = this.f33776d.getUnsubstitutedInnerClassesScope();
    ...
    public MemberScope getUnsubstitutedMemberScope() {
        MemberScope unsubstitutedMemberScope = getUnsubstitutedMemberScope(DescriptorUtilsKt.getKotlinTypeRefiner(DescriptorUtils.getContainingModule(this.f33776d)));
    ...
    public ClassConstructorDescriptor mo1193getUnsubstitutedPrimaryConstructor() {
        return this.f33776d.mo1193getUnsubstitutedPrimaryConstructor();
    }

    @Override // kotlin.reflect.jvm.internal.impl.descriptors.ClassDescriptor
    public ValueClassRepresentation<SimpleType> getValueClassRepresentation() {
        ValueClassRepresentation<SimpleType> valueClassRepresentation = this.f33776d.getValueClassRepresentation();
    ...
    public DescriptorVisibility getVisibility() {
        DescriptorVisibility visibility = this.f33776d.getVisibility();
        if (visibility == null) {
            a(27);
        }
        return visibility;
    ...
    public boolean isActual() {
        return this.f33776d.isActual();
    }

    @Override // kotlin.reflect.jvm.internal.impl.descriptors.ClassDescriptor
    public boolean isCompanionObject() {
        return this.f33776d.isCompanionObject();
    }

    @Override // kotlin.reflect.jvm.internal.impl.descriptors.ClassDescriptor
    public boolean isData() {
        return this.f33776d.isData();
    }

    @Override // kotlin.reflect.jvm.internal.impl.descriptors.MemberDescriptor
    public boolean isExpect() {
        return this.f33776d.isExpect();
    }

    @Override // kotlin.reflect.jvm.internal.impl.descriptors.MemberDescriptor
    public boolean isExternal() {
        return this.f33776d.isExternal();
    }

    @Override // kotlin.reflect.jvm.internal.impl.descriptors.ClassDescriptor
    public boolean isFun() {
        return this.f33776d.isFun();
    }

    @Override // kotlin.reflect.jvm.internal.impl.descriptors.ClassDescriptor
    public boolean isInline() {
        return this.f33776d.isInline();
    }

    @Override // kotlin.reflect.jvm.internal.impl.descriptors.ClassifierDescriptorWithTypeParameters
    public boolean isInner() {
        return this.f33776d.isInner();
    }

    @Override // kotlin.reflect.jvm.internal.impl.descriptors.ClassDescriptor
    public boolean isValue() {
        return this.f33776d.isValue();
    }
    ...
    public MemberScope getUnsubstitutedMemberScope(@NotNull KotlinTypeRefiner kotlinTypeRefiner) {
        ...
        MemberScope unsubstitutedMemberScope = this.f33776d.getUnsubstitutedMemberScope(kotlinTypeRefiner);
        if (this.f33777e.isEmpty()) {
            if (unsubstitutedMemberScope == null) {
                a(14);
            }
    ...
    public ClassDescriptor getOriginal() {
        ClassDescriptor original = this.f33776d.getOriginal();
        if (original == null) {
            a(21);
        }
        return original;
