...
public class ImplicitClassReceiver implements ImplicitReceiver, ThisClassReceiver {
    ...
    private final ClassDescriptor f34709a;

    /* renamed from: b  reason: collision with root package name */
    private final ImplicitClassReceiver f34710b;

    /* renamed from: c  reason: collision with root package name */
    private final ClassDescriptor f34711c;
    ...
    public ImplicitClassReceiver(@NotNull ClassDescriptor classDescriptor, ImplicitClassReceiver implicitClassReceiver) {
        ...
        this.f34709a = classDescriptor;
        this.f34710b = implicitClassReceiver == null ? this : implicitClassReceiver;
        this.f34711c = classDescriptor;
    }

    public boolean equals(Object obj) {
        ImplicitClassReceiver implicitClassReceiver;
        ClassDescriptor classDescriptor = this.f34709a;
        ...
        if (implicitClassReceiver != null) {
            classDescriptor2 = implicitClassReceiver.f34709a;
        }
    ...
    public SimpleType getType() {
        SimpleType defaultType = this.f34709a.getDefaultType();
