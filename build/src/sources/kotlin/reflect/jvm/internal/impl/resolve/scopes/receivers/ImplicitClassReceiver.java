...
public class ImplicitClassReceiver implements ImplicitReceiver, ThisClassReceiver {
    ...
    private final ClassDescriptor f34801a;

    /* renamed from: b  reason: collision with root package name */
    private final ImplicitClassReceiver f34802b;

    /* renamed from: c  reason: collision with root package name */
    private final ClassDescriptor f34803c;
    ...
    public ImplicitClassReceiver(@NotNull ClassDescriptor classDescriptor, ImplicitClassReceiver implicitClassReceiver) {
        ...
        this.f34801a = classDescriptor;
        this.f34802b = implicitClassReceiver == null ? this : implicitClassReceiver;
        this.f34803c = classDescriptor;
    }

    public boolean equals(Object obj) {
        ImplicitClassReceiver implicitClassReceiver;
        ClassDescriptor classDescriptor = this.f34801a;
        ...
        if (implicitClassReceiver != null) {
            classDescriptor2 = implicitClassReceiver.f34801a;
        }
    ...
    public SimpleType getType() {
        SimpleType defaultType = this.f34801a.getDefaultType();
