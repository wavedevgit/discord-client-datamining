...
public final class CapturedTypeConstructorImpl implements CapturedTypeConstructor {
    ...
    private final TypeProjection f34677a;

    /* renamed from: b  reason: collision with root package name */
    private NewCapturedTypeConstructor f34678b;

    public CapturedTypeConstructorImpl(@NotNull TypeProjection projection) {
        Intrinsics.checkNotNullParameter(projection, "projection");
        this.f34677a = projection;
    ...
    public final void setNewTypeConstructor(NewCapturedTypeConstructor newCapturedTypeConstructor) {
        this.f34678b = newCapturedTypeConstructor;
    }
    ...
    public /* bridge */ /* synthetic */ ClassifierDescriptor mo1201getDeclarationDescriptor() {
