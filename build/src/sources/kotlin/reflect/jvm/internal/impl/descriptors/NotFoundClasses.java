...
public final class NotFoundClasses {
    ...
    private final StorageManager f32296a;

    /* renamed from: b  reason: collision with root package name */
    private final ModuleDescriptor f32297b;

    /* renamed from: c  reason: collision with root package name */
    private final MemoizedFunctionToNotNull f32298c;

    /* renamed from: d  reason: collision with root package name */
    private final MemoizedFunctionToNotNull f32299d;
    ...
    public static final class MockClassDescriptor extends ClassDescriptorBase {
        ...
        private final boolean f32300s;

        /* renamed from: t  reason: collision with root package name */
        private final List f32301t;

        /* renamed from: u  reason: collision with root package name */
        private final ClassTypeConstructorImpl f32302u;
        ...
        public MockClassDescriptor(@NotNull StorageManager storageManager, @NotNull DeclarationDescriptor container, @NotNull Name name, boolean z10, int i10) {
            ...
            this.f32302u = new ClassTypeConstructorImpl(this, TypeParameterUtilsKt.computeConstructorTypeParameters(this), x0.c(DescriptorUtilsKt.getModule(this).getBuiltIns().getAnyType()), storageManager);
        }
    ...
    public static final class a {
        ...
        /* renamed from: a  reason: collision with root package name */
        private final ClassId f32303a;

        /* renamed from: b  reason: collision with root package name */
        private final List f32304b;

        public a(ClassId classId, List typeParametersCount) {
            Intrinsics.checkNotNullParameter(classId, "classId");
            Intrinsics.checkNotNullParameter(typeParametersCount, "typeParametersCount");
            this.f32303a = classId;
            this.f32304b = typeParametersCount;
        }
        ...
        public boolean equals(Object obj) {
            ...
            if (obj instanceof a) {
                a aVar = (a) obj;
                return Intrinsics.areEqual(this.f32303a, aVar.f32303a) && Intrinsics.areEqual(this.f32304b, aVar.f32304b);
            }
            return false;
        }
        ...
        public String toString() {
            return "ClassRequest(classId=" + this.f32303a + ", typeParametersCount=" + this.f32304b + ')';
        }
    }
    ...
    public NotFoundClasses(@NotNull StorageManager storageManager, @NotNull ModuleDescriptor module) {
        ...
        this.f32296a = storageManager;
        this.f32297b = module;
        this.f32298c = storageManager.createMemoizedFunction(new c(this));
        this.f32299d = storageManager.createMemoizedFunction(new d(this));
    }
    ...
    public static final ClassDescriptor c(NotFoundClasses notFoundClasses, a aVar) {
        ...
        if (!a10.isLocal()) {
            ...
            if (outerClassId == null || (declarationDescriptor = notFoundClasses.getClass(outerClassId, CollectionsKt.f0(b10, 1))) == null) {
                declarationDescriptor = (ClassOrPackageFragmentDescriptor) notFoundClasses.f32298c.invoke(a10.getPackageFqName());
            }
            DeclarationDescriptor declarationDescriptor2 = declarationDescriptor;
            boolean isNestedClass = a10.isNestedClass();
            StorageManager storageManager = notFoundClasses.f32296a;
    ...
    public static final PackageFragmentDescriptor d(NotFoundClasses notFoundClasses, FqName fqName) {
        ...
        return new EmptyPackageFragmentDescriptor(notFoundClasses.f32297b, fqName);
    }
    ...
    public final ClassDescriptor getClass(@NotNull ClassId classId, @NotNull List<Integer> typeParametersCount) {
        Intrinsics.checkNotNullParameter(classId, "classId");
        Intrinsics.checkNotNullParameter(typeParametersCount, "typeParametersCount");
        return (ClassDescriptor) this.f32299d.invoke(new a(classId, typeParametersCount));
    }
}
