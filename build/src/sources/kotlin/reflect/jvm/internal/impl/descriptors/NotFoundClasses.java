...
public final class NotFoundClasses {
    ...
    private final StorageManager f32295a;

    /* renamed from: b  reason: collision with root package name */
    private final ModuleDescriptor f32296b;

    /* renamed from: c  reason: collision with root package name */
    private final MemoizedFunctionToNotNull f32297c;

    /* renamed from: d  reason: collision with root package name */
    private final MemoizedFunctionToNotNull f32298d;
    ...
    public static final class MockClassDescriptor extends ClassDescriptorBase {
        ...
        private final List f32300t;

        /* renamed from: u  reason: collision with root package name */
        private final ClassTypeConstructorImpl f32301u;
        ...
        public MockClassDescriptor(@NotNull StorageManager storageManager, @NotNull DeclarationDescriptor container, @NotNull Name name, boolean z10, int i10) {
            ...
            this.f32300t = arrayList;
            this.f32301u = new ClassTypeConstructorImpl(this, TypeParameterUtilsKt.computeConstructorTypeParameters(this), x0.c(DescriptorUtilsKt.getModule(this).getBuiltIns().getAnyType()), storageManager);
        }
    ...
    public static final class a {
        ...
        /* renamed from: a  reason: collision with root package name */
        private final ClassId f32302a;

        /* renamed from: b  reason: collision with root package name */
        private final List f32303b;

        public a(ClassId classId, List typeParametersCount) {
            Intrinsics.checkNotNullParameter(classId, "classId");
            Intrinsics.checkNotNullParameter(typeParametersCount, "typeParametersCount");
            this.f32302a = classId;
            this.f32303b = typeParametersCount;
        }
        ...
        public boolean equals(Object obj) {
            ...
            if (obj instanceof a) {
                a aVar = (a) obj;
                return Intrinsics.areEqual(this.f32302a, aVar.f32302a) && Intrinsics.areEqual(this.f32303b, aVar.f32303b);
            }
            return false;
        }
        ...
        public String toString() {
            return "ClassRequest(classId=" + this.f32302a + ", typeParametersCount=" + this.f32303b + ')';
        }
    }
    ...
    public NotFoundClasses(@NotNull StorageManager storageManager, @NotNull ModuleDescriptor module) {
        ...
        this.f32295a = storageManager;
        this.f32296b = module;
        this.f32297c = storageManager.createMemoizedFunction(new c(this));
        this.f32298d = storageManager.createMemoizedFunction(new d(this));
    }
    ...
    public static final ClassDescriptor c(NotFoundClasses notFoundClasses, a aVar) {
        ...
        if (!a10.isLocal()) {
            ...
            if (outerClassId == null || (declarationDescriptor = notFoundClasses.getClass(outerClassId, CollectionsKt.f0(b10, 1))) == null) {
                declarationDescriptor = (ClassOrPackageFragmentDescriptor) notFoundClasses.f32297c.invoke(a10.getPackageFqName());
            }
            DeclarationDescriptor declarationDescriptor2 = declarationDescriptor;
            boolean isNestedClass = a10.isNestedClass();
            StorageManager storageManager = notFoundClasses.f32295a;
    ...
    public static final PackageFragmentDescriptor d(NotFoundClasses notFoundClasses, FqName fqName) {
        ...
        return new EmptyPackageFragmentDescriptor(notFoundClasses.f32296b, fqName);
    }
    ...
    public final ClassDescriptor getClass(@NotNull ClassId classId, @NotNull List<Integer> typeParametersCount) {
        Intrinsics.checkNotNullParameter(classId, "classId");
        Intrinsics.checkNotNullParameter(typeParametersCount, "typeParametersCount");
        return (ClassDescriptor) this.f32298d.invoke(new a(classId, typeParametersCount));
    }
}
