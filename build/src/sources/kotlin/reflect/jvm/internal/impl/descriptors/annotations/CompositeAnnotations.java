...
public final class CompositeAnnotations implements Annotations {
    ...
    public AnnotationDescriptor mo1194findAnnotation(@NotNull FqName fqName) {
        ...
        return (AnnotationDescriptor) k.K(k.S(CollectionsKt.b0(this.f33635d), new c(fqName)));
    }

    @Override // kotlin.reflect.jvm.internal.impl.descriptors.annotations.Annotations
    public boolean hasAnnotation(@NotNull FqName fqName) {
        Intrinsics.checkNotNullParameter(fqName, "fqName");
        for (Annotations annotations : CollectionsKt.b0(this.f33635d)) {
    ...
    public boolean isEmpty() {
        List<Annotations> list = this.f33635d;
    ...
    public Iterator<AnnotationDescriptor> iterator() {
        return k.L(CollectionsKt.b0(this.f33635d), d.f33659d).iterator();
    }
