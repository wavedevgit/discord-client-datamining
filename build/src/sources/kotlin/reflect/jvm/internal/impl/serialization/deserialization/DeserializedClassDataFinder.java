...
public final class DeserializedClassDataFinder implements ClassDataFinder {
    ...
    public ClassData findClassData(@NotNull ClassId classId) {
        ...
        for (PackageFragmentDescriptor packageFragmentDescriptor : PackageFragmentProviderKt.packageFragments(this.f34324a, classId.getPackageFqName())) {
