...
public final class JavaTypeEnhancement {
    ...
    private final JavaResolverSettings f33602a;
    ...
    public static final class b {
        ...
        /* renamed from: a  reason: collision with root package name */
        private final SimpleType f33605a;
    ...
    public JavaTypeEnhancement(@NotNull JavaResolverSettings javaResolverSettings) {
        ...
        this.f33602a = javaResolverSettings;
    }
    ...
    */
    ...
    private final SimpleType d(SimpleType simpleType) {
        if (this.f33602a.getCorrectNullabilityForNotNullTypeParameter()) {
