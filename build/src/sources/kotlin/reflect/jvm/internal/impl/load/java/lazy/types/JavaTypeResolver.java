...
public final class JavaTypeResolver {
    ...
    private final LazyJavaResolverContext f33010a;

    /* renamed from: b  reason: collision with root package name */
    private final TypeParameterResolver f33011b;

    /* renamed from: c  reason: collision with root package name */
    private final RawProjectionComputer f33012c;

    /* renamed from: d  reason: collision with root package name */
    private final TypeParameterUpperBoundEraser f33013d;
    ...
    public JavaTypeResolver(@NotNull LazyJavaResolverContext c10, @NotNull TypeParameterResolver typeParameterResolver) {
        ...
        this.f33010a = c10;
        this.f33011b = typeParameterResolver;
        RawProjectionComputer rawProjectionComputer = new RawProjectionComputer();
        this.f33012c = rawProjectionComputer;
        this.f33013d = new TypeParameterUpperBoundEraser(rawProjectionComputer, null, 2, null);
    }
    ...
    */
    ...
    private final List d(JavaClassifierType javaClassifierType, List list, TypeConstructor typeConstructor, JavaTypeAttributes javaTypeAttributes) {
        ...
        for (TypeParameterDescriptor typeParameterDescriptor : list2) {
            if (TypeUtilsKt.hasTypeParameterRecursiveBounds(typeParameterDescriptor, null, javaTypeAttributes.getVisitedTypeParameters())) {
                ...
                typeConstructor2 = typeConstructor;
                javaTypeAttributes2 = javaTypeAttributes;
                computeProjection = this.f33012c.computeProjection(typeParameterDescriptor, javaTypeAttributes2.markIsRaw(javaClassifierType2.isRaw()), this.f33013d, new LazyWrappedType(this.f33010a.getStorageManager(), new a(this, typeParameterDescriptor, javaTypeAttributes2, typeConstructor2, javaClassifierType2)));
            }
    ...
    public static final KotlinType e(JavaTypeResolver javaTypeResolver, TypeParameterDescriptor typeParameterDescriptor, JavaTypeAttributes javaTypeAttributes, TypeConstructor typeConstructor, JavaClassifierType javaClassifierType) {
        ...
        TypeParameterUpperBoundEraser typeParameterUpperBoundEraser = javaTypeResolver.f33013d;
    ...
    private final SimpleType f(JavaClassifierType javaClassifierType, JavaTypeAttributes javaTypeAttributes, SimpleType simpleType) {
        ...
        if (simpleType != null && (defaultAttributes = simpleType.getAttributes()) != null) {
            ...
            javaClassifierType2 = javaClassifierType;
            defaultAttributes = TypeAttributesKt.toDefaultAttributes(new LazyJavaAnnotations(this.f33010a, javaClassifierType2, false, 4, null));
        }
    ...
    private final TypeConstructor g(JavaClassifierType javaClassifierType, JavaTypeAttributes javaTypeAttributes) {
        ...
        if (classifier instanceof JavaClass) {
            ...
            if (fqName != null) {
                ...
                if (k10 == null) {
                    k10 = this.f33010a.getComponents().getModuleClassResolver().resolveClass(javaClass);
                }
            ...
            TypeParameterDescriptor resolveTypeParameter = this.f33011b.resolveTypeParameter((JavaTypeParameter) classifier);
    ...
    private final TypeConstructor h(JavaClassifierType javaClassifierType) {
        TypeConstructor typeConstructor = this.f33010a.getComponents().getDeserializedDescriptorResolver().getComponents().getNotFoundClasses().getClass(ClassId.Companion.topLevel(new FqName(javaClassifierType.getClassifierQualifiedName())), CollectionsKt.e(0)).getTypeConstructor();
    ...
    private final ClassDescriptor k(JavaClassifierType javaClassifierType, JavaTypeAttributes javaTypeAttributes, FqName fqName) {
        ...
        if (javaTypeAttributes.isForAnnotationParameter()) {
            fqName2 = JavaTypeResolverKt.f33014a;
            if (Intrinsics.areEqual(fqName, fqName2)) {
                return this.f33010a.getComponents().getReflectionTypes().getKClass();
            }
        }
        JavaToKotlinClassMapper javaToKotlinClassMapper = JavaToKotlinClassMapper.INSTANCE;
        ClassDescriptor mapJavaToKotlin$default = JavaToKotlinClassMapper.mapJavaToKotlin$default(javaToKotlinClassMapper, fqName, this.f33010a.getModule().getBuiltIns(), null, 4, null);
    ...
    private final TypeProjection n(JavaType javaType, JavaTypeAttributes javaTypeAttributes, TypeParameterDescriptor typeParameterDescriptor) {
        ...
        if (javaType instanceof JavaWildcardType) {
            ...
            if (bound != null && !i(variance, typeParameterDescriptor)) {
                AnnotationDescriptor extractNullabilityAnnotationOnBoundedWildcard = UtilsKt.extractNullabilityAnnotationOnBoundedWildcard(this.f33010a, javaWildcardType);
    ...
    public final KotlinType transformArrayType(@NotNull JavaArrayType arrayType, @NotNull JavaTypeAttributes attr, boolean z10) {
        ...
        LazyJavaAnnotations lazyJavaAnnotations = new LazyJavaAnnotations(this.f33010a, arrayType, true);
        if (primitiveType != null) {
            SimpleType primitiveArrayKotlinType = this.f33010a.getModule().getBuiltIns().getPrimitiveArrayKotlinType(primitiveType);
        ...
        if (attr.isForAnnotationParameter()) {
            ...
            SimpleType arrayType2 = this.f33010a.getModule().getBuiltIns().getArrayType(variance, transformJavaType, lazyJavaAnnotations);
            Intrinsics.checkNotNullExpressionValue(arrayType2, "getArrayType(...)");
            return arrayType2;
        }
        SimpleType arrayType3 = this.f33010a.getModule().getBuiltIns().getArrayType(Variance.INVARIANT, transformJavaType, lazyJavaAnnotations);
        Intrinsics.checkNotNullExpressionValue(arrayType3, "getArrayType(...)");
        return KotlinTypeFactory.flexibleType(arrayType3, this.f33010a.getModule().getBuiltIns().getArrayType(Variance.OUT_VARIANCE, transformJavaType, lazyJavaAnnotations).makeNullableAsSpecified(true));
    }
    ...
    public final KotlinType transformJavaType(JavaType javaType, @NotNull JavaTypeAttributes attr) {
        ...
        if (javaType instanceof JavaPrimitiveType) {
            ...
            if (type != null) {
                unitType = this.f33010a.getModule().getBuiltIns().getPrimitiveKotlinType(type);
            } else {
                unitType = this.f33010a.getModule().getBuiltIns().getUnitType();
            }
            ...
            if (javaType instanceof JavaWildcardType) {
                ...
                SimpleType defaultBound = this.f33010a.getModule().getBuiltIns().getDefaultBound();
                Intrinsics.checkNotNullExpressionValue(defaultBound, "getDefaultBound(...)");
                return defaultBound;
            } else if (javaType == null) {
                SimpleType defaultBound2 = this.f33010a.getModule().getBuiltIns().getDefaultBound();
