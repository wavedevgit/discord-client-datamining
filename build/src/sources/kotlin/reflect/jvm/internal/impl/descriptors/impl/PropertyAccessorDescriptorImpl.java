...
public abstract class PropertyAccessorDescriptorImpl extends DeclarationDescriptorNonRootImpl implements PropertyAccessorDescriptor {
    ...
    private final boolean f33086q;

    /* renamed from: r  reason: collision with root package name */
    private final Modality f33087r;

    /* renamed from: s  reason: collision with root package name */
    private final PropertyDescriptor f33088s;

    /* renamed from: t  reason: collision with root package name */
    private final boolean f33089t;

    /* renamed from: u  reason: collision with root package name */
    private final CallableMemberDescriptor.Kind f33090u;

    /* renamed from: v  reason: collision with root package name */
    private DescriptorVisibility f33091v;

    /* renamed from: w  reason: collision with root package name */
    private FunctionDescriptor f33092w;
    ...
    public PropertyAccessorDescriptorImpl(@NotNull Modality modality, @NotNull DescriptorVisibility descriptorVisibility, @NotNull PropertyDescriptor propertyDescriptor, @NotNull Annotations annotations, @NotNull Name name, boolean z10, boolean z11, boolean z12, CallableMemberDescriptor.Kind kind, @NotNull SourceElement sourceElement) {
        ...
        this.f33092w = null;
        this.f33087r = modality;
        this.f33091v = descriptorVisibility;
        this.f33088s = propertyDescriptor;
        this.f33085p = z10;
        this.f33086q = z11;
        this.f33089t = z12;
        this.f33090u = kind;
    ...
    public PropertyDescriptor getCorrespondingProperty() {
        PropertyDescriptor propertyDescriptor = this.f33088s;
        if (propertyDescriptor == null) {
            a(13);
        }
    ...
    public CallableMemberDescriptor.Kind getKind() {
        CallableMemberDescriptor.Kind kind = this.f33090u;
        if (kind == null) {
            a(6);
        }
        return kind;
    ...
    public Modality getModality() {
        Modality modality = this.f33087r;
        if (modality == null) {
            a(10);
        }
        return modality;
    ...
    public DescriptorVisibility getVisibility() {
        DescriptorVisibility descriptorVisibility = this.f33091v;
        if (descriptorVisibility == null) {
            a(11);
        }
    ...
    public void setInitialSignatureDescriptor(FunctionDescriptor functionDescriptor) {
        this.f33092w = functionDescriptor;
    }
