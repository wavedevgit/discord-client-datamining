...
public class ClassTypeConstructorImpl extends AbstractClassTypeConstructor {
    ...
    private final ClassDescriptor f35102d;

    /* renamed from: e  reason: collision with root package name */
    private final List f35103e;

    /* renamed from: f  reason: collision with root package name */
    private final Collection f35104f;
    ...
    public ClassTypeConstructorImpl(@NotNull ClassDescriptor classDescriptor, @NotNull List<? extends TypeParameterDescriptor> list, @NotNull Collection<KotlinType> collection, @NotNull StorageManager storageManager) {
        ...
        this.f35102d = classDescriptor;
        this.f35103e = Collections.unmodifiableList(new ArrayList(list));
        this.f35104f = Collections.unmodifiableCollection(collection);
    }
    ...
    public List<TypeParameterDescriptor> getParameters() {
        List<TypeParameterDescriptor> list = this.f35103e;
        if (list == null) {
            A(4);
        }
        return list;
    ...
    protected Collection l() {
        Collection collection = this.f35104f;
        if (collection == null) {
            A(6);
        }
        return collection;
    ...
    public String toString() {
        return DescriptorUtils.getFqName(this.f35102d).asString();
    }

    @Override // kotlin.reflect.jvm.internal.impl.types.AbstractClassTypeConstructor, kotlin.reflect.jvm.internal.impl.types.ClassifierBasedTypeConstructor, kotlin.reflect.jvm.internal.impl.types.TypeConstructor
    @NotNull
    /* renamed from: getDeclarationDescriptor */
    public ClassDescriptor mo1201getDeclarationDescriptor() {
        ClassDescriptor classDescriptor = this.f35102d;
        if (classDescriptor == null) {
            A(5);
        }
