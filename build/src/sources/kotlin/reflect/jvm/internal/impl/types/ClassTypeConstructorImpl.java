...
public class ClassTypeConstructorImpl extends AbstractClassTypeConstructor {
    ...
    private final ClassDescriptor f34311d;

    /* renamed from: e  reason: collision with root package name */
    private final List f34312e;

    /* renamed from: f  reason: collision with root package name */
    private final Collection f34313f;
    ...
    public ClassTypeConstructorImpl(@NotNull ClassDescriptor classDescriptor, @NotNull List<? extends TypeParameterDescriptor> list, @NotNull Collection<KotlinType> collection, @NotNull StorageManager storageManager) {
        ...
        this.f34311d = classDescriptor;
        this.f34312e = Collections.unmodifiableList(new ArrayList(list));
        this.f34313f = Collections.unmodifiableCollection(collection);
    }
    ...
    public List<TypeParameterDescriptor> getParameters() {
        List<TypeParameterDescriptor> list = this.f34312e;
        if (list == null) {
            A(4);
        }
        return list;
    ...
    protected Collection l() {
        Collection collection = this.f34313f;
        if (collection == null) {
            A(6);
        }
        return collection;
    ...
    public String toString() {
        return DescriptorUtils.getFqName(this.f34311d).asString();
    }
    ...
    public ClassDescriptor mo1199getDeclarationDescriptor() {
        ClassDescriptor classDescriptor = this.f34311d;
        if (classDescriptor == null) {
            A(5);
        }
