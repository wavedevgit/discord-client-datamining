...
public class ClassTypeConstructorImpl extends AbstractClassTypeConstructor {
    ...
    private final ClassDescriptor f35828d;

    /* renamed from: e  reason: collision with root package name */
    private final List f35829e;

    /* renamed from: f  reason: collision with root package name */
    private final Collection f35830f;
    ...
    public ClassTypeConstructorImpl(@NotNull ClassDescriptor classDescriptor, @NotNull List<? extends TypeParameterDescriptor> list, @NotNull Collection<KotlinType> collection, @NotNull StorageManager storageManager) {
        ...
        this.f35828d = classDescriptor;
        this.f35829e = Collections.unmodifiableList(new ArrayList(list));
        this.f35830f = Collections.unmodifiableCollection(collection);
    }
    ...
    public List<TypeParameterDescriptor> getParameters() {
        List<TypeParameterDescriptor> list = this.f35829e;
        if (list == null) {
            A(4);
        }
        return list;
    ...
    protected Collection l() {
        Collection collection = this.f35830f;
        if (collection == null) {
            A(6);
        }
        return collection;
    ...
    public String toString() {
        return DescriptorUtils.getFqName(this.f35828d).asString();
    }
    ...
    public ClassDescriptor mo1198getDeclarationDescriptor() {
        ClassDescriptor classDescriptor = this.f35828d;
        if (classDescriptor == null) {
            A(5);
        }
