...
public final class DeserializedTypeParameterDescriptor extends AbstractLazyTypeParameterDescriptor {
    ...
    private final DeserializationContext f34193v;

    /* renamed from: w  reason: collision with root package name */
    private final ProtoBuf.TypeParameter f34194w;

    /* renamed from: x  reason: collision with root package name */
    private final DeserializedAnnotations f34195x;
    ...
    */
    ...
    public static final List e(DeserializedTypeParameterDescriptor deserializedTypeParameterDescriptor) {
        return CollectionsKt.h1(deserializedTypeParameterDescriptor.f34193v.getComponents().getAnnotationAndConstantLoader().loadTypeParameterAnnotations(deserializedTypeParameterDescriptor.f34194w, deserializedTypeParameterDescriptor.f34193v.getNameResolver()));
    }

    @Override // kotlin.reflect.jvm.internal.impl.descriptors.impl.AbstractTypeParameterDescriptor
    protected List c() {
        List<ProtoBuf.Type> upperBounds = ProtoTypeTableUtilKt.upperBounds(this.f34194w, this.f34193v.getTypeTable());
        if (upperBounds.isEmpty()) {
            return CollectionsKt.e(DescriptorUtilsKt.getBuiltIns(this).getDefaultBound());
        }
        List<ProtoBuf.Type> list = upperBounds;
        TypeDeserializer typeDeserializer = this.f34193v.getTypeDeserializer();
