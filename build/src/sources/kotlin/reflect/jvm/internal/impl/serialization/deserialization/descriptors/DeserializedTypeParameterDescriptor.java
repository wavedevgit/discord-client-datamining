...
public final class DeserializedTypeParameterDescriptor extends AbstractLazyTypeParameterDescriptor {
    ...
    private final DeserializationContext f35726v;

    /* renamed from: w  reason: collision with root package name */
    private final ProtoBuf.TypeParameter f35727w;

    /* renamed from: x  reason: collision with root package name */
    private final DeserializedAnnotations f35728x;
    ...
    */
    ...
    public static final List e(DeserializedTypeParameterDescriptor deserializedTypeParameterDescriptor) {
        return CollectionsKt.h1(deserializedTypeParameterDescriptor.f35726v.getComponents().getAnnotationAndConstantLoader().loadTypeParameterAnnotations(deserializedTypeParameterDescriptor.f35727w, deserializedTypeParameterDescriptor.f35726v.getNameResolver()));
    }

    @Override // kotlin.reflect.jvm.internal.impl.descriptors.impl.AbstractTypeParameterDescriptor
    protected List c() {
        List<ProtoBuf.Type> upperBounds = ProtoTypeTableUtilKt.upperBounds(this.f35727w, this.f35726v.getTypeTable());
        if (upperBounds.isEmpty()) {
            return CollectionsKt.e(DescriptorUtilsKt.getBuiltIns(this).getDefaultBound());
        }
        List<ProtoBuf.Type> list = upperBounds;
        TypeDeserializer typeDeserializer = this.f35726v.getTypeDeserializer();
