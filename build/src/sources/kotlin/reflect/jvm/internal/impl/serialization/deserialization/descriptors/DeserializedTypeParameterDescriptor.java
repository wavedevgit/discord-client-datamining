...
public final class DeserializedTypeParameterDescriptor extends AbstractLazyTypeParameterDescriptor {
    ...
    private final DeserializationContext f34415v;

    /* renamed from: w  reason: collision with root package name */
    private final ProtoBuf.TypeParameter f34416w;

    /* renamed from: x  reason: collision with root package name */
    private final DeserializedAnnotations f34417x;
    ...
    */
    ...
    public static final List e(DeserializedTypeParameterDescriptor deserializedTypeParameterDescriptor) {
        return CollectionsKt.h1(deserializedTypeParameterDescriptor.f34415v.getComponents().getAnnotationAndConstantLoader().loadTypeParameterAnnotations(deserializedTypeParameterDescriptor.f34416w, deserializedTypeParameterDescriptor.f34415v.getNameResolver()));
    }

    @Override // kotlin.reflect.jvm.internal.impl.descriptors.impl.AbstractTypeParameterDescriptor
    protected List c() {
        List<ProtoBuf.Type> upperBounds = ProtoTypeTableUtilKt.upperBounds(this.f34416w, this.f34415v.getTypeTable());
        if (upperBounds.isEmpty()) {
            return CollectionsKt.e(DescriptorUtilsKt.getBuiltIns(this).getDefaultBound());
        }
        List<ProtoBuf.Type> list = upperBounds;
        TypeDeserializer typeDeserializer = this.f34415v.getTypeDeserializer();
