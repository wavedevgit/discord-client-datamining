...
public final class BuiltInFictitiousFunctionClassFactory implements ClassDescriptorFactory {
    ...
    private final StorageManager f31947a;

    /* renamed from: b  reason: collision with root package name */
    private final ModuleDescriptor f31948b;
    ...
    public ClassDescriptor createClass(@NotNull ClassId classId) {
        ...
        for (Object obj : this.f31948b.getPackage(packageFqName).getFragments()) {
        ...
        return new FunctionClassDescriptor(this.f31947a, packageFragmentDescriptor, component1, component2);
    }
