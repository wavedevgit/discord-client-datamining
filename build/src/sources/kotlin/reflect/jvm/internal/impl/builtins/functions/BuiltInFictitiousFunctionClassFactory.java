...
public final class BuiltInFictitiousFunctionClassFactory implements ClassDescriptorFactory {
    ...
    private final StorageManager f33464a;

    /* renamed from: b  reason: collision with root package name */
    private final ModuleDescriptor f33465b;
    ...
    public ClassDescriptor createClass(@NotNull ClassId classId) {
        ...
        for (Object obj : this.f33465b.getPackage(packageFqName).getFragments()) {
        ...
        return new FunctionClassDescriptor(this.f33464a, packageFragmentDescriptor, component1, component2);
    }
