...
public final class BuiltInFictitiousFunctionClassFactory implements ClassDescriptorFactory {
    ...
    private final StorageManager f32169a;

    /* renamed from: b  reason: collision with root package name */
    private final ModuleDescriptor f32170b;
    ...
    public ClassDescriptor createClass(@NotNull ClassId classId) {
        ...
        for (Object obj : this.f32170b.getPackage(packageFqName).getFragments()) {
        ...
        return new FunctionClassDescriptor(this.f32169a, packageFragmentDescriptor, component1, component2);
    }
