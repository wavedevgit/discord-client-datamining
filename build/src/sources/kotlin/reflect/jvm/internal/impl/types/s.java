...
public final class s extends SimpleType {
    ...
    private final TypeConstructor f34735e;

    /* renamed from: i  reason: collision with root package name */
    private final List f34736i;

    /* renamed from: o  reason: collision with root package name */
    private final boolean f34737o;

    /* renamed from: p  reason: collision with root package name */
    private final MemberScope f34738p;

    /* renamed from: q  reason: collision with root package name */
    private final Function1 f34739q;
    ...
    public s(TypeConstructor constructor, List arguments, boolean z10, MemberScope memberScope, Function1 refinedTypeFactory) {
        ...
        this.f34735e = constructor;
        this.f34736i = arguments;
        this.f34737o = z10;
        this.f34738p = memberScope;
        this.f34739q = refinedTypeFactory;
    ...
    public SimpleType refine(KotlinTypeRefiner kotlinTypeRefiner) {
        ...
        SimpleType simpleType = (SimpleType) this.f34739q.invoke(kotlinTypeRefiner);
