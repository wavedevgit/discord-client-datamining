...
public final class SubstitutingScope implements MemberScope {
    ...
    private final MemberScope f34208a;

    /* renamed from: b  reason: collision with root package name */
    private final Lazy f34209b;

    /* renamed from: c  reason: collision with root package name */
    private final TypeSubstitutor f34210c;

    /* renamed from: d  reason: collision with root package name */
    private Map f34211d;

    /* renamed from: e  reason: collision with root package name */
    private final Lazy f34212e;

    public SubstitutingScope(@NotNull MemberScope workerScope, @NotNull TypeSubstitutor givenSubstitutor) {
        Intrinsics.checkNotNullParameter(workerScope, "workerScope");
        Intrinsics.checkNotNullParameter(givenSubstitutor, "givenSubstitutor");
        this.f34208a = workerScope;
        this.f34209b = l.b(new f(givenSubstitutor));
        ...
        this.f34210c = CapturedTypeConstructorKt.wrapWithCapturingSubstitution$default(substitution, false, 1, null).buildSubstitutor();
        this.f34212e = l.b(new g(this));
    }

    /* JADX INFO: Access modifiers changed from: private */
    public static final Collection a(SubstitutingScope substitutingScope) {
        return substitutingScope.e(ResolutionScope.DefaultImpls.getContributedDescriptors$default(substitutingScope.f34208a, null, null, 3, null));
    }

    private final Collection d() {
        return (Collection) this.f34212e.getValue();
    }
    ...
    private final DeclarationDescriptor f(DeclarationDescriptor declarationDescriptor) {
        ...
        if (obj == null) {
            if (declarationDescriptor instanceof Substitutable) {
                obj = ((Substitutable) declarationDescriptor).substitute(this.f34210c);
                if (obj != null) {
    ...
    public Set<Name> getClassifierNames() {
        return this.f34208a.getClassifierNames();
    }
    ...
    public ClassifierDescriptor mo1203getContributedClassifier(@NotNull Name name, @NotNull LookupLocation location) {
        ...
        ClassifierDescriptor mo1203getContributedClassifier = this.f34208a.mo1203getContributedClassifier(name, location);
        if (mo1203getContributedClassifier != null) {
            return (ClassifierDescriptor) f(mo1203getContributedClassifier);
        }
        return null;
    }
    ...
    public Collection<? extends SimpleFunctionDescriptor> getContributedFunctions(@NotNull Name name, @NotNull LookupLocation location) {
        Intrinsics.checkNotNullParameter(name, "name");
        Intrinsics.checkNotNullParameter(location, "location");
        return e(this.f34208a.getContributedFunctions(name, location));
    }
    ...
    public Collection<? extends PropertyDescriptor> getContributedVariables(@NotNull Name name, @NotNull LookupLocation location) {
        Intrinsics.checkNotNullParameter(name, "name");
        Intrinsics.checkNotNullParameter(location, "location");
        return e(this.f34208a.getContributedVariables(name, location));
    }

    @Override // kotlin.reflect.jvm.internal.impl.resolve.scopes.MemberScope
    @NotNull
    public Set<Name> getFunctionNames() {
        return this.f34208a.getFunctionNames();
    }

    @Override // kotlin.reflect.jvm.internal.impl.resolve.scopes.MemberScope
    @NotNull
    public Set<Name> getVariableNames() {
        return this.f34208a.getVariableNames();
    }

    @Override // kotlin.reflect.jvm.internal.impl.resolve.scopes.ResolutionScope
    /* renamed from: recordLookup */
    public void mo1206recordLookup(@NotNull Name name, @NotNull LookupLocation lookupLocation) {
