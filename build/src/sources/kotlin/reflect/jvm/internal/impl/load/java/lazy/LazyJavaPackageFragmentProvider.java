...
public final class LazyJavaPackageFragmentProvider implements PackageFragmentProviderOptimized {
    ...
    private final LazyJavaResolverContext f32850a;

    /* renamed from: b  reason: collision with root package name */
    private final CacheWithNotNullValues f32851b;
    ...
    public LazyJavaPackageFragmentProvider(@NotNull JavaResolverComponents components) {
        ...
        this.f32850a = lazyJavaResolverContext;
        this.f32851b = lazyJavaResolverContext.getStorageManager().createCacheWithNotNullValues();
    }

    private final LazyJavaPackageFragment b(FqName fqName) {
        JavaPackage findPackage$default = JavaClassFinder$$Util.findPackage$default(this.f32850a.getComponents().getFinder(), fqName, false, 2, null);
        if (findPackage$default == null) {
            return null;
        }
        return (LazyJavaPackageFragment) this.f32851b.computeIfAbsent(fqName, new d(this, findPackage$default));
    }
    ...
    public static final LazyJavaPackageFragment c(LazyJavaPackageFragmentProvider lazyJavaPackageFragmentProvider, JavaPackage javaPackage) {
        return new LazyJavaPackageFragment(lazyJavaPackageFragmentProvider.f32850a, javaPackage);
    }
    ...
    public boolean isEmpty(@NotNull FqName fqName) {
        Intrinsics.checkNotNullParameter(fqName, "fqName");
        if (JavaClassFinder$$Util.findPackage$default(this.f32850a.getComponents().getFinder(), fqName, false, 2, null) != null) {
            return false;
        }
        return true;
    }
    ...
    public String toString() {
        return "LazyJavaPackageFragmentProvider of module " + this.f32850a.getComponents().getModule();
    }
