    ...
    */
    ...
    public boolean equals(Object obj) {
        ...
        if (obj != null && getClass() == obj.getClass()) {
            return this.f33936a.equals(((JvmClassName) obj).f33936a);
        }
        return false;
    }
    ...
    public FqName getFqNameForTopLevelClassMaybeWithDollars() {
        return new FqName(this.f33936a.replace('/', '.'));
    }
    ...
    public FqName getPackageFqName() {
        int lastIndexOf = this.f33936a.lastIndexOf("/");
        if (lastIndexOf == -1) {
        ...
        return new FqName(this.f33936a.substring(0, lastIndexOf).replace('/', '.'));
    }
