    ...
    */
    ...
    public boolean equals(Object obj) {
        ...
        if (obj != null && getClass() == obj.getClass()) {
            return this.f34158a.equals(((JvmClassName) obj).f34158a);
        }
        return false;
    }
    ...
    public FqName getFqNameForTopLevelClassMaybeWithDollars() {
        return new FqName(this.f34158a.replace('/', '.'));
    }
    ...
    public FqName getPackageFqName() {
        int lastIndexOf = this.f34158a.lastIndexOf("/");
        if (lastIndexOf == -1) {
        ...
        return new FqName(this.f34158a.substring(0, lastIndexOf).replace('/', '.'));
    }
