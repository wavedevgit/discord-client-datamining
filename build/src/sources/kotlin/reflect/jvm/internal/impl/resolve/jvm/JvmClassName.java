    ...
    */
    ...
    public boolean equals(Object obj) {
        ...
        if (obj != null && getClass() == obj.getClass()) {
            return this.f34727a.equals(((JvmClassName) obj).f34727a);
        }
        return false;
    }
    ...
    public FqName getFqNameForTopLevelClassMaybeWithDollars() {
        return new FqName(this.f34727a.replace('/', '.'));
    }
    ...
    public FqName getPackageFqName() {
        int lastIndexOf = this.f34727a.lastIndexOf("/");
        if (lastIndexOf == -1) {
        ...
        return new FqName(this.f34727a.substring(0, lastIndexOf).replace('/', '.'));
    }
