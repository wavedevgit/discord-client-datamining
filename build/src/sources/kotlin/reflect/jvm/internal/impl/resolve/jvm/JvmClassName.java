    ...
    */
    ...
    public boolean equals(Object obj) {
        ...
        if (obj != null && getClass() == obj.getClass()) {
            return this.f35453a.equals(((JvmClassName) obj).f35453a);
        }
        return false;
    }
    ...
    public FqName getFqNameForTopLevelClassMaybeWithDollars() {
        return new FqName(this.f35453a.replace('/', '.'));
    }
    ...
    public FqName getPackageFqName() {
        int lastIndexOf = this.f35453a.lastIndexOf("/");
        if (lastIndexOf == -1) {
        ...
        return new FqName(this.f35453a.substring(0, lastIndexOf).replace('/', '.'));
    }
