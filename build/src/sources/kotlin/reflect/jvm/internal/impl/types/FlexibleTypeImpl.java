...
public final class FlexibleTypeImpl extends FlexibleType implements CustomTypeParameter {
    ...
    private final void b() {
        if (RUN_SLOW_ASSERTIONS && !this.f35844o) {
            this.f35844o = true;
    ...
    public boolean isTypeParameter() {
        if ((getLowerBound().getConstructor().mo1198getDeclarationDescriptor() instanceof TypeParameterDescriptor) && Intrinsics.areEqual(getLowerBound().getConstructor(), getUpperBound().getConstructor())) {
            return true;
        }
        return false;
    }
