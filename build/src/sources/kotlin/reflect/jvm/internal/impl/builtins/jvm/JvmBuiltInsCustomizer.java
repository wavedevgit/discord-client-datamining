...
public final class JvmBuiltInsCustomizer implements AdditionalClassPartsProvider, PlatformDependentDeclarationFilter {
    ...
    private final boolean B(ConstructorDescriptor constructorDescriptor, ClassDescriptor classDescriptor) {
        ...
        if (constructorDescriptor.getValueParameters().size() == 1) {
            ...
            ClassifierDescriptor mo1198getDeclarationDescriptor = ((ValueParameterDescriptor) CollectionsKt.Q0(valueParameters)).getType().getConstructor().mo1198getDeclarationDescriptor();
            if (mo1198getDeclarationDescriptor != null) {
                fqNameUnsafe = DescriptorUtilsKt.getFqNameUnsafe(mo1198getDeclarationDescriptor);
            } else {
                fqNameUnsafe = null;
            }
    ...
    public static final Iterable v(JvmBuiltInsCustomizer jvmBuiltInsCustomizer, ClassDescriptor classDescriptor) {
        ...
        for (KotlinType kotlinType : supertypes) {
            ...
            if (mo1198getDeclarationDescriptor != null) {
                classifierDescriptor = mo1198getDeclarationDescriptor.getOriginal();
            } else {
