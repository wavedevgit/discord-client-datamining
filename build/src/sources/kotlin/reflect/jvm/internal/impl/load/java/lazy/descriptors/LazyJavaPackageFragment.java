...
public final class LazyJavaPackageFragment extends PackageFragmentDescriptorImpl {
    ...
    static final /* synthetic */ KProperty[] f32684z = {Reflection.property1(new PropertyReference1Impl(LazyJavaPackageFragment.class, "binaryClasses", "getBinaryClasses$descriptors_jvm()Ljava/util/Map;", 0)), Reflection.property1(new PropertyReference1Impl(LazyJavaPackageFragment.class, "partToFacade", "getPartToFacade()Ljava/util/HashMap;", 0))};

    /* renamed from: r  reason: collision with root package name */
    private final JavaPackage f32685r;

    /* renamed from: s  reason: collision with root package name */
    private final LazyJavaResolverContext f32686s;

    /* renamed from: t  reason: collision with root package name */
    private final MetadataVersion f32687t;

    /* renamed from: u  reason: collision with root package name */
    private final NotNullLazyValue f32688u;

    /* renamed from: v  reason: collision with root package name */
    private final JvmPackageScope f32689v;

    /* renamed from: w  reason: collision with root package name */
    private final NotNullLazyValue f32690w;

    /* renamed from: x  reason: collision with root package name */
    private final Annotations f32691x;

    /* renamed from: y  reason: collision with root package name */
    private final NotNullLazyValue f32692y;
    ...
    public LazyJavaPackageFragment(@NotNull LazyJavaResolverContext outerContext, @NotNull JavaPackage jPackage) {
        ...
        this.f32686s = childForClassOrPackage$default;
        this.f32687t = outerContext.getComponents().getDeserializedDescriptorResolver().getComponents().getConfiguration().getMetadataVersion();
        this.f32688u = childForClassOrPackage$default.getStorageManager().createLazyValue(new t(this));
        this.f32689v = new JvmPackageScope(childForClassOrPackage$default, jPackage, this);
        this.f32690w = childForClassOrPackage$default.getStorageManager().createRecursionTolerantLazyValue(new u(this), CollectionsKt.l());
        ...
        this.f32691x = resolveAnnotations;
        this.f32692y = childForClassOrPackage$default.getStorageManager().createLazyValue(new v(this));
    }
    ...
    public static final Map e(LazyJavaPackageFragment lazyJavaPackageFragment) {
        ...
        for (String str : lazyJavaPackageFragment.f32686s.getComponents().getPackagePartProvider().findPackageParts(lazyJavaPackageFragment.getFqName().asString())) {
            ...
            KotlinJvmBinaryClass findKotlinClass = KotlinClassFinderKt.findKotlinClass(lazyJavaPackageFragment.f32686s.getComponents().getKotlinClassFinder(), companion.topLevel(fqNameForTopLevelClassMaybeWithDollars), lazyJavaPackageFragment.f32687t);
            if (findKotlinClass != null) {
                pair = rr.v.a(str, findKotlinClass);
            } else {
                pair = null;
            }
            if (pair != null) {
    ...
    public static final List g(LazyJavaPackageFragment lazyJavaPackageFragment) {
        Collection<JavaPackage> subPackages = lazyJavaPackageFragment.f32685r.getSubPackages();
    ...
    public final ClassDescriptor findClassifierByJavaClass$descriptors_jvm(@NotNull JavaClass jClass) {
        ...
        return this.f32689v.getJavaScope$descriptors_jvm().findClassifierByJavaClass$descriptors_jvm(jClass);
    }
    ...
    public final Map<String, KotlinJvmBinaryClass> getBinaryClasses$descriptors_jvm() {
        return (Map) StorageKt.getValue(this.f32688u, this, f32684z[0]);
    }
    ...
    public final List<FqName> getSubPackageFqNames$descriptors_jvm() {
        return (List) this.f32690w.invoke();
    }

    @Override // kotlin.reflect.jvm.internal.impl.descriptors.impl.PackageFragmentDescriptorImpl, kotlin.reflect.jvm.internal.impl.descriptors.impl.DeclarationDescriptorImpl
    @NotNull
    public String toString() {
        return "Lazy Java package fragment: " + getFqName() + " of module " + this.f32686s.getComponents().getModule();
    }
