...
public final class LazyJavaPackageFragment extends PackageFragmentDescriptorImpl {
    ...
    static final /* synthetic */ KProperty[] f33475z = {Reflection.property1(new PropertyReference1Impl(LazyJavaPackageFragment.class, "binaryClasses", "getBinaryClasses$descriptors_jvm()Ljava/util/Map;", 0)), Reflection.property1(new PropertyReference1Impl(LazyJavaPackageFragment.class, "partToFacade", "getPartToFacade()Ljava/util/HashMap;", 0))};

    /* renamed from: r  reason: collision with root package name */
    private final JavaPackage f33476r;

    /* renamed from: s  reason: collision with root package name */
    private final LazyJavaResolverContext f33477s;

    /* renamed from: t  reason: collision with root package name */
    private final MetadataVersion f33478t;

    /* renamed from: u  reason: collision with root package name */
    private final NotNullLazyValue f33479u;

    /* renamed from: v  reason: collision with root package name */
    private final JvmPackageScope f33480v;

    /* renamed from: w  reason: collision with root package name */
    private final NotNullLazyValue f33481w;

    /* renamed from: x  reason: collision with root package name */
    private final Annotations f33482x;

    /* renamed from: y  reason: collision with root package name */
    private final NotNullLazyValue f33483y;
    ...
    public LazyJavaPackageFragment(@NotNull LazyJavaResolverContext outerContext, @NotNull JavaPackage jPackage) {
        ...
        this.f33477s = childForClassOrPackage$default;
        this.f33478t = outerContext.getComponents().getDeserializedDescriptorResolver().getComponents().getConfiguration().getMetadataVersion();
        this.f33479u = childForClassOrPackage$default.getStorageManager().createLazyValue(new t(this));
        this.f33480v = new JvmPackageScope(childForClassOrPackage$default, jPackage, this);
        this.f33481w = childForClassOrPackage$default.getStorageManager().createRecursionTolerantLazyValue(new u(this), CollectionsKt.l());
        ...
        this.f33482x = resolveAnnotations;
        this.f33483y = childForClassOrPackage$default.getStorageManager().createLazyValue(new v(this));
    }
    ...
    public static final Map e(LazyJavaPackageFragment lazyJavaPackageFragment) {
        ...
        for (String str : lazyJavaPackageFragment.f33477s.getComponents().getPackagePartProvider().findPackageParts(lazyJavaPackageFragment.getFqName().asString())) {
            ...
            KotlinJvmBinaryClass findKotlinClass = KotlinClassFinderKt.findKotlinClass(lazyJavaPackageFragment.f33477s.getComponents().getKotlinClassFinder(), companion.topLevel(fqNameForTopLevelClassMaybeWithDollars), lazyJavaPackageFragment.f33478t);
            if (findKotlinClass != null) {
                pair = as.v.a(str, findKotlinClass);
            } else {
                pair = null;
            }
            if (pair != null) {
    ...
    public static final List g(LazyJavaPackageFragment lazyJavaPackageFragment) {
        Collection<JavaPackage> subPackages = lazyJavaPackageFragment.f33476r.getSubPackages();
    ...
    public final ClassDescriptor findClassifierByJavaClass$descriptors_jvm(@NotNull JavaClass jClass) {
        ...
        return this.f33480v.getJavaScope$descriptors_jvm().findClassifierByJavaClass$descriptors_jvm(jClass);
    }
    ...
    public final Map<String, KotlinJvmBinaryClass> getBinaryClasses$descriptors_jvm() {
        return (Map) StorageKt.getValue(this.f33479u, this, f33475z[0]);
    }
    ...
    public final List<FqName> getSubPackageFqNames$descriptors_jvm() {
        return (List) this.f33481w.invoke();
    }

    @Override // kotlin.reflect.jvm.internal.impl.descriptors.impl.PackageFragmentDescriptorImpl, kotlin.reflect.jvm.internal.impl.descriptors.impl.DeclarationDescriptorImpl
    @NotNull
    public String toString() {
        return "Lazy Java package fragment: " + getFqName() + " of module " + this.f33477s.getComponents().getModule();
    }
