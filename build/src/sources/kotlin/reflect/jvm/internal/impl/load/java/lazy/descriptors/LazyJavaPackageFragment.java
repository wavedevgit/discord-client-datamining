...
public final class LazyJavaPackageFragment extends PackageFragmentDescriptorImpl {
    ...
    static final /* synthetic */ KProperty[] f34201z = {Reflection.property1(new PropertyReference1Impl(LazyJavaPackageFragment.class, "binaryClasses", "getBinaryClasses$descriptors_jvm()Ljava/util/Map;", 0)), Reflection.property1(new PropertyReference1Impl(LazyJavaPackageFragment.class, "partToFacade", "getPartToFacade()Ljava/util/HashMap;", 0))};

    /* renamed from: r  reason: collision with root package name */
    private final JavaPackage f34202r;

    /* renamed from: s  reason: collision with root package name */
    private final LazyJavaResolverContext f34203s;

    /* renamed from: t  reason: collision with root package name */
    private final MetadataVersion f34204t;

    /* renamed from: u  reason: collision with root package name */
    private final NotNullLazyValue f34205u;

    /* renamed from: v  reason: collision with root package name */
    private final JvmPackageScope f34206v;

    /* renamed from: w  reason: collision with root package name */
    private final NotNullLazyValue f34207w;

    /* renamed from: x  reason: collision with root package name */
    private final Annotations f34208x;

    /* renamed from: y  reason: collision with root package name */
    private final NotNullLazyValue f34209y;
    ...
    public LazyJavaPackageFragment(@NotNull LazyJavaResolverContext outerContext, @NotNull JavaPackage jPackage) {
        ...
        this.f34203s = childForClassOrPackage$default;
        this.f34204t = outerContext.getComponents().getDeserializedDescriptorResolver().getComponents().getConfiguration().getMetadataVersion();
        this.f34205u = childForClassOrPackage$default.getStorageManager().createLazyValue(new t(this));
        this.f34206v = new JvmPackageScope(childForClassOrPackage$default, jPackage, this);
        this.f34207w = childForClassOrPackage$default.getStorageManager().createRecursionTolerantLazyValue(new u(this), CollectionsKt.l());
        ...
        this.f34208x = resolveAnnotations;
        this.f34209y = childForClassOrPackage$default.getStorageManager().createLazyValue(new v(this));
    }
    ...
    public static final Map e(LazyJavaPackageFragment lazyJavaPackageFragment) {
        ...
        for (String str : lazyJavaPackageFragment.f34203s.getComponents().getPackagePartProvider().findPackageParts(lazyJavaPackageFragment.getFqName().asString())) {
            ...
            KotlinJvmBinaryClass findKotlinClass = KotlinClassFinderKt.findKotlinClass(lazyJavaPackageFragment.f34203s.getComponents().getKotlinClassFinder(), companion.topLevel(fqNameForTopLevelClassMaybeWithDollars), lazyJavaPackageFragment.f34204t);
    ...
    public static final List g(LazyJavaPackageFragment lazyJavaPackageFragment) {
        Collection<JavaPackage> subPackages = lazyJavaPackageFragment.f34202r.getSubPackages();
    ...
    public final ClassDescriptor findClassifierByJavaClass$descriptors_jvm(@NotNull JavaClass jClass) {
        ...
        return this.f34206v.getJavaScope$descriptors_jvm().findClassifierByJavaClass$descriptors_jvm(jClass);
    }
    ...
    public final Map<String, KotlinJvmBinaryClass> getBinaryClasses$descriptors_jvm() {
        return (Map) StorageKt.getValue(this.f34205u, this, f34201z[0]);
    }
    ...
    public final List<FqName> getSubPackageFqNames$descriptors_jvm() {
        return (List) this.f34207w.invoke();
    }

    @Override // kotlin.reflect.jvm.internal.impl.descriptors.impl.PackageFragmentDescriptorImpl, kotlin.reflect.jvm.internal.impl.descriptors.impl.DeclarationDescriptorImpl
    @NotNull
    public String toString() {
        return "Lazy Java package fragment: " + getFqName() + " of module " + this.f34203s.getComponents().getModule();
    }
