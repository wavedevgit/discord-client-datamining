...
public abstract class FunctionTypeKind {
    ...
    public FunctionTypeKind(@NotNull FqName packageFqName, @NotNull String classNamePrefix, boolean z10, ClassId classId, boolean z11) {
        ...
        this.f32753a = packageFqName;
        this.f32754b = classNamePrefix;
        this.f32755c = z10;
        this.f32756d = classId;
        this.f32757e = z11;
    }
    ...
    public final Name numberedClassName(int i10) {
        Name identifier = Name.identifier(this.f32754b + i10);
    ...
    public String toString() {
        return this.f32753a + '.' + this.f32754b + 'N';
    }
}
