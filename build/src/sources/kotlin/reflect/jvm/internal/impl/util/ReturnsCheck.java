...
public abstract class ReturnsCheck implements Check {
    ...
    private final Function1 f34778b;
    ...
    public boolean check(@NotNull FunctionDescriptor functionDescriptor) {
        ...
        return Intrinsics.areEqual(functionDescriptor.getReturnType(), this.f34778b.invoke(DescriptorUtilsKt.getBuiltIns(functionDescriptor)));
    }
