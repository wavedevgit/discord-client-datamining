...
public abstract class ReturnsCheck implements Check {
    ...
    private final Function1 f34556b;
    ...
    public boolean check(@NotNull FunctionDescriptor functionDescriptor) {
        ...
        return Intrinsics.areEqual(functionDescriptor.getReturnType(), this.f34556b.invoke(DescriptorUtilsKt.getBuiltIns(functionDescriptor)));
    }
