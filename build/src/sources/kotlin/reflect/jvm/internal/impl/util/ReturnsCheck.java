...
public abstract class ReturnsCheck implements Check {
    ...
    private final Function1 f35347b;
    ...
    public boolean check(@NotNull FunctionDescriptor functionDescriptor) {
        ...
        return Intrinsics.areEqual(functionDescriptor.getReturnType(), this.f35347b.invoke(DescriptorUtilsKt.getBuiltIns(functionDescriptor)));
    }
    ...
    private ReturnsCheck(String str, Function1 function1) {
        this.f35346a = str;
        this.f35347b = function1;
        this.f35348c = "must return " + str;
    }
}
