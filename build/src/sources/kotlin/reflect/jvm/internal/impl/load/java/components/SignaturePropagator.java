...
public interface SignaturePropagator {
    ...
    public static class PropagatedSignature {
        ...
        private final KotlinType f33363a;

        /* renamed from: b  reason: collision with root package name */
        private final KotlinType f33364b;

        /* renamed from: c  reason: collision with root package name */
        private final List f33365c;

        /* renamed from: d  reason: collision with root package name */
        private final List f33366d;

        /* renamed from: e  reason: collision with root package name */
        private final List f33367e;
        ...
        public PropagatedSignature(@NotNull KotlinType kotlinType, KotlinType kotlinType2, @NotNull List<ValueParameterDescriptor> list, @NotNull List<TypeParameterDescriptor> list2, @NotNull List<String> list3, boolean z10) {
            ...
            this.f33363a = kotlinType;
            this.f33364b = kotlinType2;
            this.f33365c = list;
            this.f33366d = list2;
            this.f33367e = list3;
            this.f33368f = z10;
        ...
        public KotlinType getReturnType() {
            KotlinType kotlinType = this.f33363a;
            if (kotlinType == null) {
                a(4);
            }
            return kotlinType;
        ...
        public List<TypeParameterDescriptor> getTypeParameters() {
            List<TypeParameterDescriptor> list = this.f33366d;
            if (list == null) {
                a(6);
            }
            return list;
        ...
        public List<ValueParameterDescriptor> getValueParameters() {
            List<ValueParameterDescriptor> list = this.f33365c;
            if (list == null) {
                a(5);
            }
            return list;
