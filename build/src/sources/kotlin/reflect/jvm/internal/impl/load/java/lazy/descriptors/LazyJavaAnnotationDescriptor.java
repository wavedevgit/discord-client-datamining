...
public final class LazyJavaAnnotationDescriptor implements PossiblyExternalAnnotationDescriptor {
    ...
    public LazyJavaAnnotationDescriptor(@NotNull LazyJavaResolverContext c10, @NotNull JavaAnnotation javaAnnotation, boolean z10) {
        ...
        this.f33967a = c10;
        this.f33968b = javaAnnotation;
        this.f33969c = c10.getStorageManager().createNullableLazyValue(new c(this));
        this.f33970d = c10.getStorageManager().createLazyValue(new d(this));
        this.f33971e = c10.getComponents().getSourceElementFactory().source(javaAnnotation);
        this.f33972f = c10.getStorageManager().createLazyValue(new e(this));
        this.f33973g = javaAnnotation.isIdeExternalAnnotation();
        this.f33974h = javaAnnotation.isFreshlySupportedTypeUseAnnotation() || z10;
    }
    ...
    public static final Map d(LazyJavaAnnotationDescriptor lazyJavaAnnotationDescriptor) {
        ...
        for (JavaAnnotationArgument javaAnnotationArgument : lazyJavaAnnotationDescriptor.f33968b.getArguments()) {
    ...
    private final ClassDescriptor e(FqName fqName) {
        return FindClassInModuleKt.findNonGenericClassAcrossDependencies(this.f33967a.getModule(), ClassId.Companion.topLevel(fqName), this.f33967a.getComponents().getDeserializedDescriptorResolver().getComponents().getNotFoundClasses());
    }

    /* JADX INFO: Access modifiers changed from: private */
    public static final FqName f(LazyJavaAnnotationDescriptor lazyJavaAnnotationDescriptor) {
        ClassId classId = lazyJavaAnnotationDescriptor.f33968b.getClassId();
        if (classId != null) {
    ...
    private final ConstantValue h(JavaAnnotation javaAnnotation) {
        return new AnnotationValue(new LazyJavaAnnotationDescriptor(this.f33967a, javaAnnotation, false, 4, null));
    }
    ...
    private final ConstantValue i(Name name, List list) {
        ...
        if (annotationParameterByName == null || (arrayType = annotationParameterByName.getType()) == null) {
            arrayType = this.f33967a.getComponents().getModule().getBuiltIns().getArrayType(Variance.INVARIANT, ErrorUtils.createErrorType(ErrorTypeKind.UNKNOWN_ARRAY_ELEMENT_TYPE_OF_ANNOTATION_ARGUMENT, new String[0]));
    ...
    private final ConstantValue k(JavaType javaType) {
        return KClassValue.Companion.create(this.f33967a.getTypeResolver().transformJavaType(javaType, JavaTypeAttributesKt.toAttributes$default(TypeUsage.COMMON, false, false, null, 7, null)));
    }
    ...
    public static final SimpleType l(LazyJavaAnnotationDescriptor lazyJavaAnnotationDescriptor) {
        ...
        if (fqName == null) {
            return ErrorUtils.createErrorType(ErrorTypeKind.NOT_FOUND_FQNAME_FOR_JAVA_ANNOTATION, lazyJavaAnnotationDescriptor.f33968b.toString());
        }
        ClassDescriptor mapJavaToKotlin$default = JavaToKotlinClassMapper.mapJavaToKotlin$default(JavaToKotlinClassMapper.INSTANCE, fqName, lazyJavaAnnotationDescriptor.f33967a.getModule().getBuiltIns(), null, 4, null);
        if (mapJavaToKotlin$default == null) {
            JavaClass resolve = lazyJavaAnnotationDescriptor.f33968b.resolve();
            if (resolve != null) {
                mapJavaToKotlin$default = lazyJavaAnnotationDescriptor.f33967a.getComponents().getModuleClassResolver().resolveClass(resolve);
            } else {
    ...
    public Map<Name, ConstantValue<?>> getAllValueArguments() {
        return (Map) StorageKt.getValue(this.f33972f, this, f33966i[2]);
    }

    @Override // kotlin.reflect.jvm.internal.impl.descriptors.annotations.AnnotationDescriptor
    public FqName getFqName() {
        return (FqName) StorageKt.getValue(this.f33969c, this, f33966i[0]);
    }
    ...
    public SimpleType getType() {
        return (SimpleType) StorageKt.getValue(this.f33970d, this, f33966i[1]);
    }
