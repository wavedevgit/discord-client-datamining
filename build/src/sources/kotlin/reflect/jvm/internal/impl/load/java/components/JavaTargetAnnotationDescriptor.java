...
public final class JavaTargetAnnotationDescriptor extends JavaAnnotationDescriptor {
    ...
    static final /* synthetic */ KProperty[] f32793h = {Reflection.property1(new PropertyReference1Impl(JavaTargetAnnotationDescriptor.class, "allValueArguments", "getAllValueArguments()Ljava/util/Map;", 0))};

    /* renamed from: g  reason: collision with root package name */
    private final NotNullLazyValue f32794g;
    ...
    public JavaTargetAnnotationDescriptor(@NotNull JavaAnnotation annotation, @NotNull LazyJavaResolverContext c10) {
        ...
        this.f32794g = c10.getStorageManager().createLazyValue(new e(this));
    }
    ...
    public Map<Name, ConstantValue<Object>> getAllValueArguments() {
        return (Map) StorageKt.getValue(this.f32794g, this, f32793h[0]);
    }
}
