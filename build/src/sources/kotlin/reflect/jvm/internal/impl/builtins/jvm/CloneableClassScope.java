...
public final class CloneableClassScope extends GivenFunctionsMemberScope {
    ...
    private static final Name f32194d;
    ...
    public static final class Companion {
        ...
        public final Name getCLONE_NAME() {
            return CloneableClassScope.f32194d;
        }
    ...
    protected List c() {
        SimpleFunctionDescriptorImpl create = SimpleFunctionDescriptorImpl.create(f(), Annotations.Companion.getEMPTY(), f32194d, CallableMemberDescriptor.Kind.DECLARATION, SourceElement.NO_SOURCE);
