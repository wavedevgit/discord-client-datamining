...
public final class CloneableClassScope extends GivenFunctionsMemberScope {
    ...
    private static final Name f31972d;
    ...
    public static final class Companion {
        ...
        public final Name getCLONE_NAME() {
            return CloneableClassScope.f31972d;
        }
    ...
    protected List c() {
        SimpleFunctionDescriptorImpl create = SimpleFunctionDescriptorImpl.create(f(), Annotations.Companion.getEMPTY(), f31972d, CallableMemberDescriptor.Kind.DECLARATION, SourceElement.NO_SOURCE);
