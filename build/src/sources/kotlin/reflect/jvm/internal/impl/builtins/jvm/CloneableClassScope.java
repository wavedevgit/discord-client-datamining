...
public final class CloneableClassScope extends GivenFunctionsMemberScope {
    ...
    private static final Name f32763d;
    ...
    public static final class Companion {
        ...
        public final Name getCLONE_NAME() {
            return CloneableClassScope.f32763d;
        }
    ...
    protected List c() {
        SimpleFunctionDescriptorImpl create = SimpleFunctionDescriptorImpl.create(f(), Annotations.Companion.getEMPTY(), f32763d, CallableMemberDescriptor.Kind.DECLARATION, SourceElement.NO_SOURCE);
