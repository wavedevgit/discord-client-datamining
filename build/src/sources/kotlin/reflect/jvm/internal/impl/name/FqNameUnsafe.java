...
public final class FqNameUnsafe {
    ...
    private static final Name f34377e;

    /* renamed from: f  reason: collision with root package name */
    private static final Pattern f34378f;

    /* renamed from: a  reason: collision with root package name */
    private final String f34379a;

    /* renamed from: b  reason: collision with root package name */
    private transient FqName f34380b;

    /* renamed from: c  reason: collision with root package name */
    private transient FqNameUnsafe f34381c;

    /* renamed from: d  reason: collision with root package name */
    private transient Name f34382d;
    ...
    private final void a() {
        int b10 = b(this.f34379a);
        if (b10 >= 0) {
            String substring = this.f34379a.substring(b10 + 1);
            Intrinsics.checkNotNullExpressionValue(substring, "substring(...)");
            this.f34382d = Name.guessByFirstCharacter(substring);
            String substring2 = this.f34379a.substring(0, b10);
            Intrinsics.checkNotNullExpressionValue(substring2, "substring(...)");
            this.f34381c = new FqNameUnsafe(substring2);
            return;
        }
        this.f34382d = Name.guessByFirstCharacter(this.f34379a);
        this.f34381c = FqName.ROOT.toUnsafe();
    }
    ...
    public final FqNameUnsafe child(@NotNull Name name) {
        ...
        if (isRoot()) {
            ...
            str = this.f34379a + '.' + name.asString();
        }
    ...
    public boolean equals(Object obj) {
        ...
        if ((obj instanceof FqNameUnsafe) && Intrinsics.areEqual(this.f34379a, ((FqNameUnsafe) obj).f34379a)) {
            return true;
        }
        return false;
    }
    ...
    public final boolean isSafe() {
        if (this.f34380b == null && StringsKt.h0(asString(), '<', 0, false, 6, null) >= 0) {
            return false;
        }
        return true;
    }
    ...
    public final FqNameUnsafe parent() {
        FqNameUnsafe fqNameUnsafe = this.f34381c;
        if (fqNameUnsafe != null) {
            return fqNameUnsafe;
        }
        if (!isRoot()) {
            a();
            FqNameUnsafe fqNameUnsafe2 = this.f34381c;
    ...
    public final Name shortName() {
        Name name = this.f34382d;
        if (name != null) {
            return name;
        }
        if (!isRoot()) {
            a();
            Name name2 = this.f34382d;
    ...
    public final boolean startsWith(@NotNull Name segment) {
        ...
        int h02 = StringsKt.h0(this.f34379a, '.', 0, false, 6, null);
        if (h02 == -1) {
            h02 = this.f34379a.length();
        }
        int i10 = h02;
        String asString = segment.asString();
        Intrinsics.checkNotNullExpressionValue(asString, "asString(...)");
        if (i10 != asString.length() || !StringsKt.E(this.f34379a, 0, asString, 0, i10, false, 16, null)) {
            return false;
        }
        return true;
    }
    ...
    public final FqName toSafe() {
        FqName fqName = this.f34380b;
        if (fqName == null) {
            FqName fqName2 = new FqName(this);
            this.f34380b = fqName2;
            return fqName2;
        }
        return fqName;
    }
    ...
    public String toString() {
        if (isRoot()) {
            String asString = f34377e.asString();
            Intrinsics.checkNotNullExpressionValue(asString, "asString(...)");
            return asString;
        }
        return this.f34379a;
