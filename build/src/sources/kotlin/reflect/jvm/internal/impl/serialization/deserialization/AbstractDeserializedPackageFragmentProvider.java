...
public abstract class AbstractDeserializedPackageFragmentProvider implements PackageFragmentProviderOptimized {
    ...
    private final StorageManager f35564a;

    /* renamed from: b  reason: collision with root package name */
    private final KotlinMetadataFinder f35565b;

    /* renamed from: c  reason: collision with root package name */
    private final ModuleDescriptor f35566c;

    /* renamed from: d  reason: collision with root package name */
    protected DeserializationComponents f35567d;

    /* renamed from: e  reason: collision with root package name */
    private final MemoizedFunctionToNullable f35568e;
    ...
    public AbstractDeserializedPackageFragmentProvider(@NotNull StorageManager storageManager, @NotNull KotlinMetadataFinder finder, @NotNull ModuleDescriptor moduleDescriptor) {
        ...
        this.f35564a = storageManager;
        this.f35565b = finder;
        this.f35566c = moduleDescriptor;
        this.f35568e = storageManager.createMemoizedFunctionWithNullableValues(new a(this));
    }
    ...
    public void collectPackageFragments(@NotNull FqName fqName, @NotNull Collection<PackageFragmentDescriptor> packageFragments) {
        ...
        CollectionsKt.addIfNotNull(packageFragments, this.f35568e.invoke(fqName));
    }

    protected final DeserializationComponents d() {
        DeserializationComponents deserializationComponents = this.f35567d;
    ...
    public List<PackageFragmentDescriptor> getPackageFragments(@NotNull FqName fqName) {
        Intrinsics.checkNotNullParameter(fqName, "fqName");
        return kotlin.collections.CollectionsKt.p(this.f35568e.invoke(fqName));
    }
    ...
    public final void h(DeserializationComponents deserializationComponents) {
        ...
        this.f35567d = deserializationComponents;
    }
    ...
    public boolean isEmpty(@NotNull FqName fqName) {
        ...
        Intrinsics.checkNotNullParameter(fqName, "fqName");
        if (this.f35568e.isComputed(fqName)) {
            b10 = (PackageFragmentDescriptor) this.f35568e.invoke(fqName);
        } else {
            b10 = b(fqName);
        }
        if (b10 == null) {
