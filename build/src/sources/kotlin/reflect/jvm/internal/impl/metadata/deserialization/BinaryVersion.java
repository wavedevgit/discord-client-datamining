...
public abstract class BinaryVersion {
    ...
    public BinaryVersion(@NotNull int... numbers) {
        ...
        this.f33478d = b04 != null ? b04.intValue() : -1;
        if (numbers.length > 3) {
    ...
    public final boolean a(BinaryVersion ourVersion) {
        ...
        if (i10 == 0) {
            if (ourVersion.f33476b != 0 || this.f33477c != ourVersion.f33477c) {
                return false;
            }
            return true;
        } else if (i10 != ourVersion.f33476b || this.f33477c > ourVersion.f33477c) {
            return false;
        } else {
            return true;
        }
    ...
    public boolean equals(Object obj) {
        if (obj != null && Intrinsics.areEqual(getClass(), obj.getClass())) {
            ...
            if (this.f33476b == binaryVersion.f33476b && this.f33477c == binaryVersion.f33477c && this.f33478d == binaryVersion.f33478d && Intrinsics.areEqual(this.f33479e, binaryVersion.f33479e)) {
                return true;
            }
            return false;
        }
    ...
    public int hashCode() {
        int i10 = this.f33476b;
        int i11 = i10 + (i10 * 31) + this.f33477c;
        int i12 = i11 + (i11 * 31) + this.f33478d;
        return i12 + (i12 * 31) + this.f33479e.hashCode();
    }

    public final boolean isAtLeast(@NotNull BinaryVersion version) {
        Intrinsics.checkNotNullParameter(version, "version");
        return isAtLeast(version.f33476b, version.f33477c, version.f33478d);
    }

    public final boolean isAtMost(int i10, int i11, int i12) {
        int i13 = this.f33476b;
        if (i13 < i10) {
            return true;
        }
        if (i13 > i10) {
        ...
        int i14 = this.f33477c;
        if (i14 < i11) {
            return true;
        }
        if (i14 <= i11 && this.f33478d <= i12) {
            return true;
        }
        return false;
    }
    ...
    public final boolean isAtLeast(int i10, int i11, int i12) {
        ...
        return i14 >= i11 && this.f33478d >= i12;
    }
}
