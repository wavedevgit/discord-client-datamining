...
public abstract class BinaryVersion {
    ...
    public BinaryVersion(@NotNull int... numbers) {
        ...
        this.f34269d = b04 != null ? b04.intValue() : -1;
        if (numbers.length > 3) {
    ...
    public final boolean a(BinaryVersion ourVersion) {
        ...
        if (i10 == 0) {
            if (ourVersion.f34267b != 0 || this.f34268c != ourVersion.f34268c) {
                return false;
            }
            return true;
        } else if (i10 != ourVersion.f34267b || this.f34268c > ourVersion.f34268c) {
            return false;
        } else {
            return true;
        }
    ...
    public boolean equals(Object obj) {
        if (obj != null && Intrinsics.areEqual(getClass(), obj.getClass())) {
            ...
            if (this.f34267b == binaryVersion.f34267b && this.f34268c == binaryVersion.f34268c && this.f34269d == binaryVersion.f34269d && Intrinsics.areEqual(this.f34270e, binaryVersion.f34270e)) {
                return true;
            }
            return false;
        }
    ...
    public int hashCode() {
        int i10 = this.f34267b;
        int i11 = i10 + (i10 * 31) + this.f34268c;
        int i12 = i11 + (i11 * 31) + this.f34269d;
        return i12 + (i12 * 31) + this.f34270e.hashCode();
    }

    public final boolean isAtLeast(@NotNull BinaryVersion version) {
        Intrinsics.checkNotNullParameter(version, "version");
        return isAtLeast(version.f34267b, version.f34268c, version.f34269d);
    }

    public final boolean isAtMost(int i10, int i11, int i12) {
        int i13 = this.f34267b;
        if (i13 < i10) {
            return true;
        }
        if (i13 > i10) {
        ...
        int i14 = this.f34268c;
        if (i14 < i11) {
            return true;
        }
        if (i14 <= i11 && this.f34269d <= i12) {
            return true;
        }
        return false;
    }
    ...
    public final boolean isAtLeast(int i10, int i11, int i12) {
        ...
        return i14 >= i11 && this.f34269d >= i12;
    }
}
