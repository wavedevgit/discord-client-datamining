...
public abstract class BinaryVersion {
    ...
    public BinaryVersion(@NotNull int... numbers) {
        ...
        this.f33700d = b04 != null ? b04.intValue() : -1;
        if (numbers.length > 3) {
    ...
    public final boolean a(BinaryVersion ourVersion) {
        ...
        if (i10 == 0) {
            if (ourVersion.f33698b != 0 || this.f33699c != ourVersion.f33699c) {
                return false;
            }
            return true;
        } else if (i10 != ourVersion.f33698b || this.f33699c > ourVersion.f33699c) {
            return false;
        } else {
            return true;
        }
    ...
    public boolean equals(Object obj) {
        if (obj != null && Intrinsics.areEqual(getClass(), obj.getClass())) {
            ...
            if (this.f33698b == binaryVersion.f33698b && this.f33699c == binaryVersion.f33699c && this.f33700d == binaryVersion.f33700d && Intrinsics.areEqual(this.f33701e, binaryVersion.f33701e)) {
                return true;
            }
            return false;
        }
    ...
    public int hashCode() {
        int i10 = this.f33698b;
        int i11 = i10 + (i10 * 31) + this.f33699c;
        int i12 = i11 + (i11 * 31) + this.f33700d;
        return i12 + (i12 * 31) + this.f33701e.hashCode();
    }

    public final boolean isAtLeast(@NotNull BinaryVersion version) {
        Intrinsics.checkNotNullParameter(version, "version");
        return isAtLeast(version.f33698b, version.f33699c, version.f33700d);
    }

    public final boolean isAtMost(int i10, int i11, int i12) {
        int i13 = this.f33698b;
        if (i13 < i10) {
            return true;
        }
        if (i13 > i10) {
        ...
        int i14 = this.f33699c;
        if (i14 < i11) {
            return true;
        }
        if (i14 <= i11 && this.f33700d <= i12) {
            return true;
        }
        return false;
    }
    ...
    public final boolean isAtLeast(int i10, int i11, int i12) {
        ...
        return i14 >= i11 && this.f33700d >= i12;
    }
}
