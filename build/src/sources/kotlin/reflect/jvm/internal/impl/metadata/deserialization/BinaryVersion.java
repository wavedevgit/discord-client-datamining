...
public abstract class BinaryVersion {
    ...
    public BinaryVersion(@NotNull int... numbers) {
        ...
        this.f34995d = b04 != null ? b04.intValue() : -1;
        if (numbers.length > 3) {
    ...
    public final boolean a(BinaryVersion ourVersion) {
        ...
        if (i10 == 0) {
            if (ourVersion.f34993b != 0 || this.f34994c != ourVersion.f34994c) {
                return false;
            }
            return true;
        } else if (i10 != ourVersion.f34993b || this.f34994c > ourVersion.f34994c) {
            return false;
        } else {
            return true;
        }
    ...
    public boolean equals(Object obj) {
        if (obj != null && Intrinsics.areEqual(getClass(), obj.getClass())) {
            ...
            if (this.f34993b == binaryVersion.f34993b && this.f34994c == binaryVersion.f34994c && this.f34995d == binaryVersion.f34995d && Intrinsics.areEqual(this.f34996e, binaryVersion.f34996e)) {
                return true;
            }
            return false;
        }
    ...
    public int hashCode() {
        int i10 = this.f34993b;
        int i11 = i10 + (i10 * 31) + this.f34994c;
        int i12 = i11 + (i11 * 31) + this.f34995d;
        return i12 + (i12 * 31) + this.f34996e.hashCode();
    }

    public final boolean isAtLeast(@NotNull BinaryVersion version) {
        Intrinsics.checkNotNullParameter(version, "version");
        return isAtLeast(version.f34993b, version.f34994c, version.f34995d);
    }

    public final boolean isAtMost(int i10, int i11, int i12) {
        int i13 = this.f34993b;
        if (i13 < i10) {
            return true;
        }
        if (i13 > i10) {
        ...
        int i14 = this.f34994c;
        if (i14 < i11) {
            return true;
        }
        if (i14 <= i11 && this.f34995d <= i12) {
            return true;
        }
        return false;
    }
    ...
    public final boolean isAtLeast(int i10, int i11, int i12) {
        ...
        return i14 >= i11 && this.f34995d >= i12;
    }
}
