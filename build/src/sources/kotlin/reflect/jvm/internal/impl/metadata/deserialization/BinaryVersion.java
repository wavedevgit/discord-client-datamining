...
public abstract class BinaryVersion {
    ...
    public BinaryVersion(@NotNull int... numbers) {
        ...
        this.f33721d = b04 != null ? b04.intValue() : -1;
        if (numbers.length > 3) {
    ...
    public final boolean a(BinaryVersion ourVersion) {
        ...
        if (i10 == 0) {
            if (ourVersion.f33719b != 0 || this.f33720c != ourVersion.f33720c) {
                return false;
            }
            return true;
        } else if (i10 != ourVersion.f33719b || this.f33720c > ourVersion.f33720c) {
            return false;
        } else {
            return true;
        }
    ...
    public boolean equals(Object obj) {
        if (obj != null && Intrinsics.areEqual(getClass(), obj.getClass())) {
            ...
            if (this.f33719b == binaryVersion.f33719b && this.f33720c == binaryVersion.f33720c && this.f33721d == binaryVersion.f33721d && Intrinsics.areEqual(this.f33722e, binaryVersion.f33722e)) {
                return true;
            }
            return false;
        }
    ...
    public int hashCode() {
        int i10 = this.f33719b;
        int i11 = i10 + (i10 * 31) + this.f33720c;
        int i12 = i11 + (i11 * 31) + this.f33721d;
        return i12 + (i12 * 31) + this.f33722e.hashCode();
    }

    public final boolean isAtLeast(@NotNull BinaryVersion version) {
        Intrinsics.checkNotNullParameter(version, "version");
        return isAtLeast(version.f33719b, version.f33720c, version.f33721d);
    }

    public final boolean isAtMost(int i10, int i11, int i12) {
        int i13 = this.f33719b;
        if (i13 < i10) {
            return true;
        }
        if (i13 > i10) {
        ...
        int i14 = this.f33720c;
        if (i14 < i11) {
            return true;
        }
        if (i14 <= i11 && this.f33721d <= i12) {
            return true;
        }
        return false;
    }
    ...
    public final boolean isAtLeast(int i10, int i11, int i12) {
        ...
        return i14 >= i11 && this.f33721d >= i12;
    }
}
