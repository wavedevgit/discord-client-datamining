...
public abstract class BinaryVersion {
    ...
    public BinaryVersion(@NotNull int... numbers) {
        ...
        this.f35011d = b04 != null ? b04.intValue() : -1;
        if (numbers.length > 3) {
    ...
    public final boolean a(BinaryVersion ourVersion) {
        ...
        if (i10 == 0) {
            if (ourVersion.f35009b != 0 || this.f35010c != ourVersion.f35010c) {
                return false;
            }
            return true;
        } else if (i10 != ourVersion.f35009b || this.f35010c > ourVersion.f35010c) {
            return false;
        } else {
            return true;
        }
    ...
    public boolean equals(Object obj) {
        if (obj != null && Intrinsics.areEqual(getClass(), obj.getClass())) {
            ...
            if (this.f35009b == binaryVersion.f35009b && this.f35010c == binaryVersion.f35010c && this.f35011d == binaryVersion.f35011d && Intrinsics.areEqual(this.f35012e, binaryVersion.f35012e)) {
                return true;
            }
            return false;
        }
    ...
    public int hashCode() {
        int i10 = this.f35009b;
        int i11 = i10 + (i10 * 31) + this.f35010c;
        int i12 = i11 + (i11 * 31) + this.f35011d;
        return i12 + (i12 * 31) + this.f35012e.hashCode();
    }

    public final boolean isAtLeast(@NotNull BinaryVersion version) {
        Intrinsics.checkNotNullParameter(version, "version");
        return isAtLeast(version.f35009b, version.f35010c, version.f35011d);
    }
    ...
    public final boolean isAtLeast(int i10, int i11, int i12) {
        ...
        return i14 >= i11 && this.f35011d >= i12;
    }
}
