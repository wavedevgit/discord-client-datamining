...
public final class TypeAliasExpansion {
    ...
    private final TypeAliasExpansion f34647a;

    /* renamed from: b  reason: collision with root package name */
    private final TypeAliasDescriptor f34648b;
    ...
    public final TypeProjection getReplacement(@NotNull TypeConstructor constructor) {
        ...
        if (mo1199getDeclarationDescriptor instanceof TypeParameterDescriptor) {
            return (TypeProjection) this.f34650d.get(mo1199getDeclarationDescriptor);
        }
        return null;
    }
    ...
    public final boolean isRecursion(@NotNull TypeAliasDescriptor descriptor) {
        ...
        if (!Intrinsics.areEqual(this.f34648b, descriptor)) {
            TypeAliasExpansion typeAliasExpansion = this.f34647a;
    ...
    private TypeAliasExpansion(TypeAliasExpansion typeAliasExpansion, TypeAliasDescriptor typeAliasDescriptor, List list, Map map) {
        this.f34647a = typeAliasExpansion;
        this.f34648b = typeAliasDescriptor;
        this.f34649c = list;
        this.f34650d = map;
    }
}
