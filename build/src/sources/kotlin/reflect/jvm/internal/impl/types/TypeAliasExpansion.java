...
public final class TypeAliasExpansion {
    ...
    private final TypeAliasExpansion f35147a;

    /* renamed from: b  reason: collision with root package name */
    private final TypeAliasDescriptor f35148b;

    /* renamed from: c  reason: collision with root package name */
    private final List f35149c;
    ...
    public final TypeProjection getReplacement(@NotNull TypeConstructor constructor) {
        ...
        if (mo1201getDeclarationDescriptor instanceof TypeParameterDescriptor) {
            return (TypeProjection) this.f35150d.get(mo1201getDeclarationDescriptor);
        }
        return null;
    }
    ...
    public final boolean isRecursion(@NotNull TypeAliasDescriptor descriptor) {
        ...
        if (!Intrinsics.areEqual(this.f35148b, descriptor)) {
            TypeAliasExpansion typeAliasExpansion = this.f35147a;
    ...
    private TypeAliasExpansion(TypeAliasExpansion typeAliasExpansion, TypeAliasDescriptor typeAliasDescriptor, List list, Map map) {
        this.f35147a = typeAliasExpansion;
        this.f35148b = typeAliasDescriptor;
        this.f35149c = list;
        this.f35150d = map;
    }
}
