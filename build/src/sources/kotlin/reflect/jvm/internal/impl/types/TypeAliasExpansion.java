...
public final class TypeAliasExpansion {
    ...
    private final TypeAliasExpansion f35873a;

    /* renamed from: b  reason: collision with root package name */
    private final TypeAliasDescriptor f35874b;

    /* renamed from: c  reason: collision with root package name */
    private final List f35875c;

    /* renamed from: d  reason: collision with root package name */
    private final Map f35876d;
    ...
    public final TypeProjection getReplacement(@NotNull TypeConstructor constructor) {
        ...
        if (mo1198getDeclarationDescriptor instanceof TypeParameterDescriptor) {
            return (TypeProjection) this.f35876d.get(mo1198getDeclarationDescriptor);
        }
        return null;
    }
    ...
    public final boolean isRecursion(@NotNull TypeAliasDescriptor descriptor) {
        ...
        if (!Intrinsics.areEqual(this.f35874b, descriptor)) {
            TypeAliasExpansion typeAliasExpansion = this.f35873a;
    ...
    private TypeAliasExpansion(TypeAliasExpansion typeAliasExpansion, TypeAliasDescriptor typeAliasDescriptor, List list, Map map) {
        this.f35873a = typeAliasExpansion;
        this.f35874b = typeAliasDescriptor;
        this.f35875c = list;
        this.f35876d = map;
    }
}
