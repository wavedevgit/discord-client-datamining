...
public class DFS {
    ...
    public static abstract class CollectingNodeHandler<N, R, C extends Iterable<R>> extends AbstractNodeHandler<N, C> {
        ...
        protected final Iterable f35365a;
    ...
    static class a extends AbstractNodeHandler {
        ...
        /* renamed from: a  reason: collision with root package name */
        final /* synthetic */ Function1 f35367a;

        /* renamed from: b  reason: collision with root package name */
        final /* synthetic */ boolean[] f35368b;

        a(Function1 function1, boolean[] zArr) {
            this.f35367a = function1;
            this.f35368b = zArr;
        }
        ...
        public Boolean result() {
            return Boolean.valueOf(this.f35368b[0]);
        }

        @Override // kotlin.reflect.jvm.internal.impl.utils.DFS.AbstractNodeHandler, kotlin.reflect.jvm.internal.impl.utils.DFS.NodeHandler
        public boolean beforeChildren(Object obj) {
            if (((Boolean) this.f35367a.invoke(obj)).booleanValue()) {
                this.f35368b[0] = true;
            }
