...
public final class DescriptorKindFilter {
    ...
    private static int f34177c;

    /* renamed from: d  reason: collision with root package name */
    private static final int f34178d;

    /* renamed from: e  reason: collision with root package name */
    private static final int f34179e;

    /* renamed from: f  reason: collision with root package name */
    private static final int f34180f;

    /* renamed from: g  reason: collision with root package name */
    private static final int f34181g;

    /* renamed from: h  reason: collision with root package name */
    private static final int f34182h;

    /* renamed from: i  reason: collision with root package name */
    private static final int f34183i;

    /* renamed from: j  reason: collision with root package name */
    private static final int f34184j;

    /* renamed from: k  reason: collision with root package name */
    private static final int f34185k;

    /* renamed from: l  reason: collision with root package name */
    private static final int f34186l;

    /* renamed from: m  reason: collision with root package name */
    private static final int f34187m;

    /* renamed from: n  reason: collision with root package name */
    private static final List f34188n;

    /* renamed from: o  reason: collision with root package name */
    private static final List f34189o;

    /* renamed from: a  reason: collision with root package name */
    private final List f34190a;
    ...
    public static final class Companion {
        ...
        public final int a() {
            int i10 = DescriptorKindFilter.f34177c;
            DescriptorKindFilter.f34177c <<= 1;
            return i10;
        }

        public final int getALL_KINDS_MASK() {
            return DescriptorKindFilter.f34184j;
        }

        public final int getCLASSIFIERS_MASK() {
            return DescriptorKindFilter.f34185k;
        }

        public final int getFUNCTIONS_MASK() {
            return DescriptorKindFilter.f34182h;
        }

        public final int getNON_SINGLETON_CLASSIFIERS_MASK() {
            return DescriptorKindFilter.f34178d;
        }

        public final int getPACKAGES_MASK() {
            return DescriptorKindFilter.f34181g;
        }

        public final int getSINGLETON_CLASSIFIERS_MASK() {
            return DescriptorKindFilter.f34179e;
        }

        public final int getTYPE_ALIASES_MASK() {
            return DescriptorKindFilter.f34180f;
        }

        public final int getVARIABLES_MASK() {
            return DescriptorKindFilter.f34183i;
        }
    ...
    static {
        ...
        for (Field field2 : arrayList) {
            ...
            if (descriptorKindFilter != null) {
                int i13 = descriptorKindFilter.f34191b;
    ...
    public boolean equals(Object obj) {
        ...
        if (Intrinsics.areEqual(this.f34190a, descriptorKindFilter.f34190a) && this.f34191b == descriptorKindFilter.f34191b) {
            return true;
        }
        return false;
    }
    ...
    public final DescriptorKindFilter restrictedToKindsOrNull(int i10) {
        int i11 = i10 & this.f34191b;
        if (i11 == 0) {
            return null;
        }
        return new DescriptorKindFilter(i11, this.f34190a);
    }
    ...
    public String toString() {
        ...
        String str;
        String str2;
        Iterator it = f34188n.iterator();
        while (true) {
            if (it.hasNext()) {
                obj = it.next();
                if (((Companion.a) obj).a() == this.f34191b) {
                    break;
                }
            } else {
                obj = null;
        ...
        return "DescriptorKindFilter(" + str + ", " + this.f34190a + ')';
    }
