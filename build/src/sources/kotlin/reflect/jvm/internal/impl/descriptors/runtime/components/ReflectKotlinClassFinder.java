...
public final class ReflectKotlinClassFinder implements KotlinClassFinder {
    ...
    private final ClassLoader f33155a;

    /* renamed from: b  reason: collision with root package name */
    private final BuiltInsResourceLoader f33156b;

    public ReflectKotlinClassFinder(@NotNull ClassLoader classLoader) {
        Intrinsics.checkNotNullParameter(classLoader, "classLoader");
        this.f33155a = classLoader;
        this.f33156b = new BuiltInsResourceLoader();
    }

    private final KotlinClassFinder.Result a(String str) {
        ReflectKotlinClass create;
        Class<?> tryLoadClass = ReflectJavaClassFinderKt.tryLoadClass(this.f33155a, str);
    ...
    public InputStream findBuiltInsData(@NotNull FqName packageFqName) {
        ...
        return this.f33156b.loadResource(BuiltInSerializerProtocol.INSTANCE.getBuiltInsFilePath(packageFqName));
    }
