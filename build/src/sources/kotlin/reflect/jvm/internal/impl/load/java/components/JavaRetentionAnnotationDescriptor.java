...
public final class JavaRetentionAnnotationDescriptor extends JavaAnnotationDescriptor {
    ...
    static final /* synthetic */ KProperty[] f32790h = {Reflection.property1(new PropertyReference1Impl(JavaRetentionAnnotationDescriptor.class, "allValueArguments", "getAllValueArguments()Ljava/util/Map;", 0))};

    /* renamed from: g  reason: collision with root package name */
    private final NotNullLazyValue f32791g;
    ...
    public JavaRetentionAnnotationDescriptor(@NotNull JavaAnnotation annotation, @NotNull LazyJavaResolverContext c10) {
        ...
        this.f32791g = c10.getStorageManager().createLazyValue(new d(this));
    }
    ...
    public Map<Name, ConstantValue<?>> getAllValueArguments() {
        return (Map) StorageKt.getValue(this.f32791g, this, f32790h[0]);
    }
}
