...
public final class NameResolverImpl implements NameResolver {
    ...
    private final ProtoBuf.StringTable f33773a;

    /* renamed from: b  reason: collision with root package name */
    private final ProtoBuf.QualifiedNameTable f33774b;
    ...
    public NameResolverImpl(@NotNull ProtoBuf.StringTable strings, @NotNull ProtoBuf.QualifiedNameTable qualifiedNames) {
        ...
        this.f33773a = strings;
        this.f33774b = qualifiedNames;
    }
    ...
    private final u a(int i10) {
        ...
        boolean z10 = false;
        while (i10 != -1) {
            ProtoBuf.QualifiedNameTable.QualifiedName qualifiedName = this.f33774b.getQualifiedName(i10);
            String string = this.f33773a.getString(qualifiedName.getShortName());
    ...
    public String getString(int i10) {
        String string = this.f33773a.getString(i10);
