...
public final class NameResolverImpl implements NameResolver {
    ...
    private final ProtoBuf.StringTable f33482a;

    /* renamed from: b  reason: collision with root package name */
    private final ProtoBuf.QualifiedNameTable f33483b;
    ...
    public NameResolverImpl(@NotNull ProtoBuf.StringTable strings, @NotNull ProtoBuf.QualifiedNameTable qualifiedNames) {
        ...
        this.f33482a = strings;
        this.f33483b = qualifiedNames;
    }
    ...
    private final u a(int i10) {
        ...
        boolean z10 = false;
        while (i10 != -1) {
            ProtoBuf.QualifiedNameTable.QualifiedName qualifiedName = this.f33483b.getQualifiedName(i10);
            String string = this.f33482a.getString(qualifiedName.getShortName());
    ...
    public String getString(int i10) {
        String string = this.f33482a.getString(i10);
