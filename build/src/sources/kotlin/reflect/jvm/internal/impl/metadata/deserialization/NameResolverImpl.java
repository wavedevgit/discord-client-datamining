...
public final class NameResolverImpl implements NameResolver {
    ...
    private final ProtoBuf.StringTable f34273a;

    /* renamed from: b  reason: collision with root package name */
    private final ProtoBuf.QualifiedNameTable f34274b;
    ...
    public NameResolverImpl(@NotNull ProtoBuf.StringTable strings, @NotNull ProtoBuf.QualifiedNameTable qualifiedNames) {
        ...
        this.f34273a = strings;
        this.f34274b = qualifiedNames;
    }
    ...
    private final u a(int i10) {
        ...
        boolean z10 = false;
        while (i10 != -1) {
            ProtoBuf.QualifiedNameTable.QualifiedName qualifiedName = this.f34274b.getQualifiedName(i10);
            String string = this.f34273a.getString(qualifiedName.getShortName());
    ...
    public String getString(int i10) {
        String string = this.f34273a.getString(i10);
