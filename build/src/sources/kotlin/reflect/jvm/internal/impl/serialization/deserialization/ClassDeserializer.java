...
public final class ClassDeserializer {
    ...
    private static final Set f34267c = x0.c(ClassId.Companion.topLevel(StandardNames.FqNames.cloneable.toSafe()));

    /* renamed from: a  reason: collision with root package name */
    private final DeserializationComponents f34268a;

    /* renamed from: b  reason: collision with root package name */
    private final Function1 f34269b;
    ...
    public static final class Companion {
        ...
        public final Set<ClassId> getBLACK_LIST() {
            return ClassDeserializer.f34267c;
        }
    ...
    public static final class a {
        ...
        /* renamed from: a  reason: collision with root package name */
        private final ClassId f34270a;

        /* renamed from: b  reason: collision with root package name */
        private final ClassData f34271b;

        public a(ClassId classId, ClassData classData) {
            Intrinsics.checkNotNullParameter(classId, "classId");
            this.f34270a = classId;
            this.f34271b = classData;
        }
        ...
        public boolean equals(Object obj) {
            if ((obj instanceof a) && Intrinsics.areEqual(this.f34270a, ((a) obj).f34270a)) {
                return true;
            }
            return false;
        }
    ...
    public ClassDeserializer(@NotNull DeserializationComponents components) {
        ...
        this.f34268a = components;
        this.f34269b = components.getStorageManager().createMemoizedFunctionWithNullableValues(new b(this));
    }
    ...
    private final ClassDescriptor c(a aVar) {
        ...
        ClassId b10 = aVar.b();
        for (ClassDescriptorFactory classDescriptorFactory : this.f34268a.getFictitiousClassDescriptorFactories()) {
            ClassDescriptor createClass = classDescriptorFactory.createClass(b10);
            if (createClass != null) {
                return createClass;
            }
        }
        if (f34267c.contains(b10)) {
            return null;
        }
        ClassData a10 = aVar.a();
        if (a10 == null && (a10 = this.f34268a.getClassDataFinder().findClassData(b10)) == null) {
            return null;
        }
        ...
        if (outerClassId != null) {
            ...
            Iterator<T> it = PackageFragmentProviderKt.packageFragments(this.f34268a.getPackageFragmentProvider(), b10.getPackageFqName()).iterator();
            while (true) {
                if (it.hasNext()) {
                    obj = it.next();
            ...
            DeserializationComponents deserializationComponents = this.f34268a;
    ...
    public final ClassDescriptor deserializeClass(@NotNull ClassId classId, ClassData classData) {
        Intrinsics.checkNotNullParameter(classId, "classId");
        return (ClassDescriptor) this.f34269b.invoke(new a(classId, classData));
    }
}
