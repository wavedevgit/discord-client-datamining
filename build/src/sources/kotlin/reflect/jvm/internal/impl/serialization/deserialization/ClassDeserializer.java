...
public final class ClassDeserializer {
    ...
    private static final Set f34835c = x0.c(ClassId.Companion.topLevel(StandardNames.FqNames.cloneable.toSafe()));

    /* renamed from: a  reason: collision with root package name */
    private final DeserializationComponents f34836a;

    /* renamed from: b  reason: collision with root package name */
    private final Function1 f34837b;
    ...
    public static final class Companion {
        ...
        public final Set<ClassId> getBLACK_LIST() {
            return ClassDeserializer.f34835c;
        }
    ...
    public static final class a {
        ...
        /* renamed from: a  reason: collision with root package name */
        private final ClassId f34838a;

        /* renamed from: b  reason: collision with root package name */
        private final ClassData f34839b;

        public a(ClassId classId, ClassData classData) {
            Intrinsics.checkNotNullParameter(classId, "classId");
            this.f34838a = classId;
            this.f34839b = classData;
        }
        ...
        public boolean equals(Object obj) {
            if ((obj instanceof a) && Intrinsics.areEqual(this.f34838a, ((a) obj).f34838a)) {
                return true;
            }
            return false;
        }
    ...
    public ClassDeserializer(@NotNull DeserializationComponents components) {
        ...
        this.f34836a = components;
        this.f34837b = components.getStorageManager().createMemoizedFunctionWithNullableValues(new b(this));
    }
    ...
    private final ClassDescriptor c(a aVar) {
        ...
        ClassId b10 = aVar.b();
        for (ClassDescriptorFactory classDescriptorFactory : this.f34836a.getFictitiousClassDescriptorFactories()) {
            ClassDescriptor createClass = classDescriptorFactory.createClass(b10);
            if (createClass != null) {
                return createClass;
            }
        }
        if (f34835c.contains(b10)) {
            return null;
        }
        ClassData a10 = aVar.a();
        if (a10 == null && (a10 = this.f34836a.getClassDataFinder().findClassData(b10)) == null) {
            return null;
        }
        ...
        if (outerClassId != null) {
            ...
            Iterator<T> it = PackageFragmentProviderKt.packageFragments(this.f34836a.getPackageFragmentProvider(), b10.getPackageFqName()).iterator();
            while (true) {
                if (it.hasNext()) {
                    obj = it.next();
            ...
            DeserializationComponents deserializationComponents = this.f34836a;
    ...
    public final ClassDescriptor deserializeClass(@NotNull ClassId classId, ClassData classData) {
        Intrinsics.checkNotNullParameter(classId, "classId");
        return (ClassDescriptor) this.f34837b.invoke(new a(classId, classData));
    }
}
