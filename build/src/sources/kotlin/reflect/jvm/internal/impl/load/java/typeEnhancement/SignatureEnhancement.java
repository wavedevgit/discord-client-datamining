...
public final class SignatureEnhancement {
    ...
    private final JavaTypeEnhancement f33536a;

    public SignatureEnhancement(@NotNull JavaTypeEnhancement typeEnhancement) {
        Intrinsics.checkNotNullParameter(typeEnhancement, "typeEnhancement");
        this.f33536a = typeEnhancement;
    }

    private final boolean f(KotlinType kotlinType) {
        return TypeUtils.contains(kotlinType, b1.f33557d);
    }

    /* JADX INFO: Access modifiers changed from: private */
    public static final Boolean g(UnwrappedType unwrappedType) {
        boolean z10;
        ClassifierDescriptor mo1197getDeclarationDescriptor = unwrappedType.getConstructor().mo1197getDeclarationDescriptor();
        if (mo1197getDeclarationDescriptor == null) {
            return Boolean.FALSE;
        }
        Name name = mo1197getDeclarationDescriptor.getName();
        JavaToKotlinClassMap javaToKotlinClassMap = JavaToKotlinClassMap.INSTANCE;
        if (Intrinsics.areEqual(name, javaToKotlinClassMap.getFUNCTION_N_FQ_NAME().shortName()) && Intrinsics.areEqual(DescriptorUtilsKt.fqNameOrNull(mo1197getDeclarationDescriptor), javaToKotlinClassMap.getFUNCTION_N_FQ_NAME())) {
            z10 = true;
        } else {
            z10 = false;
        }
    ...
    private final KotlinType i(c1 c1Var, KotlinType kotlinType, List list, TypeEnhancementInfo typeEnhancementInfo, boolean z10) {
        return this.f33536a.enhance(kotlinType, c1Var.computeIndexedQualifiers(kotlinType, list, typeEnhancementInfo, z10), c1Var.getSkipRawTypeArguments());
    }
    ...
    */
    ...
    public final List<KotlinType> enhanceTypeParameterBounds(@NotNull TypeParameterDescriptor typeParameter, @NotNull List<? extends KotlinType> bounds, @NotNull LazyJavaResolverContext context) {
        ...
        for (KotlinType kotlinType2 : list) {
            if (TypeUtilsKt.contains(kotlinType2, a1.f33553d)) {
