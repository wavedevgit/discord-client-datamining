...
public final class IntegerLiteralTypeConstructor implements TypeConstructor {
    ...
    private final ModuleDescriptor f35415b;

    /* renamed from: c  reason: collision with root package name */
    private final Set f35416c;

    /* renamed from: d  reason: collision with root package name */
    private final SimpleType f35417d;

    /* renamed from: e  reason: collision with root package name */
    private final Lazy f35418e;
    ...
    public static final class Companion {
        ...
        public /* synthetic */ class WhenMappings {
            ...
            static {
                ...
                try {
                    iArr[a.f35419d.ordinal()] = 1;
                } catch (NoSuchFieldError unused) {
                }
                try {
                    iArr[a.f35420e.ordinal()] = 2;
        ...
        public static final class a {
            ...
            /* renamed from: d  reason: collision with root package name */
            public static final a f35419d = new a("COMMON_SUPER_TYPE", 0);

            /* renamed from: e  reason: collision with root package name */
            public static final a f35420e = new a("INTERSECTION_TYPE", 1);

            /* renamed from: i  reason: collision with root package name */
            private static final /* synthetic */ a[] f35421i;

            /* renamed from: o  reason: collision with root package name */
            private static final /* synthetic */ EnumEntries f35422o;
        ...
        private final SimpleType b(IntegerLiteralTypeConstructor integerLiteralTypeConstructor, IntegerLiteralTypeConstructor integerLiteralTypeConstructor2, a aVar) {
            ...
            return KotlinTypeFactory.integerLiteralType(TypeAttributes.Companion.getEmpty(), new IntegerLiteralTypeConstructor(integerLiteralTypeConstructor.f35414a, integerLiteralTypeConstructor.f35415b, t02, null), false);
        }
    ...
    private final List c() {
        return (List) this.f35418e.getValue();
    }

    private final boolean d() {
        Collection<KotlinType> allSignedLiteralTypes = PrimitiveTypeUtilKt.getAllSignedLiteralTypes(this.f35415b);
        if ((allSignedLiteralTypes instanceof Collection) && allSignedLiteralTypes.isEmpty()) {
            return true;
        }
        for (KotlinType kotlinType : allSignedLiteralTypes) {
            if (this.f35416c.contains(kotlinType)) {
                return false;
            }
        }
        return true;
    ...
    public static final List e(IntegerLiteralTypeConstructor integerLiteralTypeConstructor) {
        ...
        List r10 = CollectionsKt.r(TypeSubstitutionKt.replace$default(defaultType, CollectionsKt.e(new TypeProjectionImpl(Variance.IN_VARIANCE, integerLiteralTypeConstructor.f35417d)), null, 2, null));
    ...
    private final String f() {
        return '[' + CollectionsKt.x0(this.f35416c, ",", null, null, 0, null, c.f35431d, 30, null) + ']';
    }
    ...
    public KotlinBuiltIns getBuiltIns() {
        return this.f35415b.getBuiltIns();
    }
    ...
    private IntegerLiteralTypeConstructor(long j10, ModuleDescriptor moduleDescriptor, Set set) {
        this.f35417d = KotlinTypeFactory.integerLiteralType(TypeAttributes.Companion.getEmpty(), this, false);
        this.f35418e = l.b(new b(this));
        this.f35414a = j10;
        this.f35415b = moduleDescriptor;
        this.f35416c = set;
    }
}
