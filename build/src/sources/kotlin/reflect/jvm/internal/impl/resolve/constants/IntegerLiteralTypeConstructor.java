...
public final class IntegerLiteralTypeConstructor implements TypeConstructor {
    ...
    private final ModuleDescriptor f34689b;

    /* renamed from: c  reason: collision with root package name */
    private final Set f34690c;

    /* renamed from: d  reason: collision with root package name */
    private final SimpleType f34691d;

    /* renamed from: e  reason: collision with root package name */
    private final Lazy f34692e;
    ...
    public static final class Companion {
        ...
        public static final class a {
            ...
            /* renamed from: d  reason: collision with root package name */
            public static final a f34693d = new a("COMMON_SUPER_TYPE", 0);

            /* renamed from: e  reason: collision with root package name */
            public static final a f34694e = new a("INTERSECTION_TYPE", 1);

            /* renamed from: i  reason: collision with root package name */
            private static final /* synthetic */ a[] f34695i;

            /* renamed from: o  reason: collision with root package name */
            private static final /* synthetic */ EnumEntries f34696o;
        ...
        private final SimpleType b(IntegerLiteralTypeConstructor integerLiteralTypeConstructor, IntegerLiteralTypeConstructor integerLiteralTypeConstructor2, a aVar) {
            ...
            return KotlinTypeFactory.integerLiteralType(TypeAttributes.Companion.getEmpty(), new IntegerLiteralTypeConstructor(integerLiteralTypeConstructor.f34688a, integerLiteralTypeConstructor.f34689b, t02, null), false);
        }
    ...
    private final List c() {
        return (List) this.f34692e.getValue();
    }

    private final boolean d() {
        Collection<KotlinType> allSignedLiteralTypes = PrimitiveTypeUtilKt.getAllSignedLiteralTypes(this.f34689b);
        if ((allSignedLiteralTypes instanceof Collection) && allSignedLiteralTypes.isEmpty()) {
            return true;
        }
        for (KotlinType kotlinType : allSignedLiteralTypes) {
            if (this.f34690c.contains(kotlinType)) {
                return false;
            }
        }
        return true;
    ...
    public static final List e(IntegerLiteralTypeConstructor integerLiteralTypeConstructor) {
        ...
        List r10 = CollectionsKt.r(TypeSubstitutionKt.replace$default(defaultType, CollectionsKt.e(new TypeProjectionImpl(Variance.IN_VARIANCE, integerLiteralTypeConstructor.f34691d)), null, 2, null));
    ...
    private final String f() {
        return '[' + CollectionsKt.x0(this.f34690c, ",", null, null, 0, null, c.f34705d, 30, null) + ']';
    }
    ...
    public KotlinBuiltIns getBuiltIns() {
        return this.f34689b.getBuiltIns();
    }
    ...
    private IntegerLiteralTypeConstructor(long j10, ModuleDescriptor moduleDescriptor, Set set) {
        this.f34691d = KotlinTypeFactory.integerLiteralType(TypeAttributes.Companion.getEmpty(), this, false);
        this.f34692e = l.b(new b(this));
        this.f34688a = j10;
        this.f34689b = moduleDescriptor;
        this.f34690c = set;
    }
}
