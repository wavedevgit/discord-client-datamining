...
public final class IntegerLiteralTypeConstructor implements TypeConstructor {
    ...
    private final long f35430a;

    /* renamed from: b  reason: collision with root package name */
    private final ModuleDescriptor f35431b;

    /* renamed from: c  reason: collision with root package name */
    private final Set f35432c;

    /* renamed from: d  reason: collision with root package name */
    private final SimpleType f35433d;

    /* renamed from: e  reason: collision with root package name */
    private final Lazy f35434e;
    ...
    public static final class Companion {
        ...
        public /* synthetic */ class WhenMappings {
            ...
            static {
                ...
                try {
                    iArr[a.f35435d.ordinal()] = 1;
                } catch (NoSuchFieldError unused) {
                }
                try {
                    iArr[a.f35436e.ordinal()] = 2;
        ...
        public static final class a {
            ...
            /* renamed from: d  reason: collision with root package name */
            public static final a f35435d = new a("COMMON_SUPER_TYPE", 0);

            /* renamed from: e  reason: collision with root package name */
            public static final a f35436e = new a("INTERSECTION_TYPE", 1);

            /* renamed from: i  reason: collision with root package name */
            private static final /* synthetic */ a[] f35437i;

            /* renamed from: o  reason: collision with root package name */
            private static final /* synthetic */ EnumEntries f35438o;
        ...
        private final SimpleType b(IntegerLiteralTypeConstructor integerLiteralTypeConstructor, IntegerLiteralTypeConstructor integerLiteralTypeConstructor2, a aVar) {
            ...
            return KotlinTypeFactory.integerLiteralType(TypeAttributes.Companion.getEmpty(), new IntegerLiteralTypeConstructor(integerLiteralTypeConstructor.f35430a, integerLiteralTypeConstructor.f35431b, t02, null), false);
        }
    ...
    private final List c() {
        return (List) this.f35434e.getValue();
    }

    private final boolean d() {
        Collection<KotlinType> allSignedLiteralTypes = PrimitiveTypeUtilKt.getAllSignedLiteralTypes(this.f35431b);
        if ((allSignedLiteralTypes instanceof Collection) && allSignedLiteralTypes.isEmpty()) {
            return true;
        }
        for (KotlinType kotlinType : allSignedLiteralTypes) {
            if (this.f35432c.contains(kotlinType)) {
                return false;
            }
        }
        return true;
    ...
    public static final List e(IntegerLiteralTypeConstructor integerLiteralTypeConstructor) {
        ...
        List r10 = CollectionsKt.r(TypeSubstitutionKt.replace$default(defaultType, CollectionsKt.e(new TypeProjectionImpl(Variance.IN_VARIANCE, integerLiteralTypeConstructor.f35433d)), null, 2, null));
    ...
    private final String f() {
        return '[' + CollectionsKt.x0(this.f35432c, ",", null, null, 0, null, c.f35447d, 30, null) + ']';
    }
    ...
    public KotlinBuiltIns getBuiltIns() {
        return this.f35431b.getBuiltIns();
    }
    ...
    private IntegerLiteralTypeConstructor(long j10, ModuleDescriptor moduleDescriptor, Set set) {
        this.f35433d = KotlinTypeFactory.integerLiteralType(TypeAttributes.Companion.getEmpty(), this, false);
        this.f35434e = l.b(new b(this));
        this.f35430a = j10;
        this.f35431b = moduleDescriptor;
        this.f35432c = set;
    }
}
