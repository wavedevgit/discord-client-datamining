...
public final class NewCapturedType extends SimpleType implements CapturedTypeMarker {
    ...
    private final CaptureStatus f35933e;

    /* renamed from: i  reason: collision with root package name */
    private final NewCapturedTypeConstructor f35934i;

    /* renamed from: o  reason: collision with root package name */
    private final UnwrappedType f35935o;

    /* renamed from: p  reason: collision with root package name */
    private final TypeAttributes f35936p;

    /* renamed from: q  reason: collision with root package name */
    private final boolean f35937q;

    /* renamed from: r  reason: collision with root package name */
    private final boolean f35938r;
    ...
    public SimpleType replaceAttributes(@NotNull TypeAttributes newAttributes) {
        ...
        return new NewCapturedType(this.f35933e, getConstructor(), this.f35935o, newAttributes, isMarkedNullable(), this.f35938r);
    }
    ...
    public NewCapturedType(@NotNull CaptureStatus captureStatus, @NotNull NewCapturedTypeConstructor constructor, UnwrappedType unwrappedType, @NotNull TypeAttributes attributes, boolean z10, boolean z11) {
        ...
        this.f35933e = captureStatus;
        this.f35934i = constructor;
        this.f35935o = unwrappedType;
        this.f35936p = attributes;
        this.f35937q = z10;
        this.f35938r = z11;
    }
    ...
    public NewCapturedType makeNullableAsSpecified(boolean z10) {
        return new NewCapturedType(this.f35933e, getConstructor(), this.f35935o, getAttributes(), z10, false, 32, null);
    }
    ...
    public NewCapturedType refine(@NotNull KotlinTypeRefiner kotlinTypeRefiner) {
        ...
        CaptureStatus captureStatus = this.f35933e;
        NewCapturedTypeConstructor refine = getConstructor().refine(kotlinTypeRefiner);
        UnwrappedType unwrappedType = this.f35935o;
