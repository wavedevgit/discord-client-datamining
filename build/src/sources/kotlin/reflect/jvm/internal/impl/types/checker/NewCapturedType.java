...
public final class NewCapturedType extends SimpleType implements CapturedTypeMarker {
    ...
    private final CaptureStatus f35949e;

    /* renamed from: i  reason: collision with root package name */
    private final NewCapturedTypeConstructor f35950i;

    /* renamed from: o  reason: collision with root package name */
    private final UnwrappedType f35951o;

    /* renamed from: p  reason: collision with root package name */
    private final TypeAttributes f35952p;

    /* renamed from: q  reason: collision with root package name */
    private final boolean f35953q;

    /* renamed from: r  reason: collision with root package name */
    private final boolean f35954r;
    ...
    public SimpleType replaceAttributes(@NotNull TypeAttributes newAttributes) {
        ...
        return new NewCapturedType(this.f35949e, getConstructor(), this.f35951o, newAttributes, isMarkedNullable(), this.f35954r);
    }
    ...
    public NewCapturedType(@NotNull CaptureStatus captureStatus, @NotNull NewCapturedTypeConstructor constructor, UnwrappedType unwrappedType, @NotNull TypeAttributes attributes, boolean z10, boolean z11) {
        ...
        this.f35949e = captureStatus;
        this.f35950i = constructor;
        this.f35951o = unwrappedType;
        this.f35952p = attributes;
        this.f35953q = z10;
        this.f35954r = z11;
    }
    ...
    public NewCapturedType makeNullableAsSpecified(boolean z10) {
        return new NewCapturedType(this.f35949e, getConstructor(), this.f35951o, getAttributes(), z10, false, 32, null);
    }
    ...
    public NewCapturedType refine(@NotNull KotlinTypeRefiner kotlinTypeRefiner) {
        ...
        CaptureStatus captureStatus = this.f35949e;
        NewCapturedTypeConstructor refine = getConstructor().refine(kotlinTypeRefiner);
        UnwrappedType unwrappedType = this.f35951o;
