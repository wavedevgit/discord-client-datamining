...
public abstract class ByteString implements Iterable<Byte> {
    ...
    public static final class Output extends OutputStream {
        ...
        private static final byte[] f34450q = new byte[0];

        /* renamed from: d  reason: collision with root package name */
        private final int f34451d;

        /* renamed from: e  reason: collision with root package name */
        private final ArrayList f34452e;

        /* renamed from: i  reason: collision with root package name */
        private int f34453i;

        /* renamed from: o  reason: collision with root package name */
        private byte[] f34454o;
        ...
        private void h(int i10) {
            this.f34452e.add(new b(this.f34454o));
            int length = this.f34453i + this.f34454o.length;
            this.f34453i = length;
            this.f34454o = new byte[Math.max(this.f34451d, Math.max(i10, length >>> 1))];
            this.f34455p = 0;
        }

        private void i() {
            int i10 = this.f34455p;
            byte[] bArr = this.f34454o;
            if (i10 < bArr.length) {
                if (i10 > 0) {
                    this.f34452e.add(new b(a(bArr, i10)));
                }
            } else {
                this.f34452e.add(new b(this.f34454o));
                this.f34454o = f34450q;
            }
            this.f34453i += this.f34455p;
            this.f34455p = 0;
        }

        public synchronized int size() {
            return this.f34453i + this.f34455p;
        }

        public synchronized ByteString toByteString() {
            i();
            return ByteString.copyFrom(this.f34452e);
        }
        ...
        public synchronized void write(int i10) {
            try {
                if (this.f34455p == this.f34454o.length) {
                    h(1);
                }
                byte[] bArr = this.f34454o;
        ...
        public synchronized void write(byte[] bArr, int i10, int i11) {
            try {
                byte[] bArr2 = this.f34454o;
                int length = bArr2.length;
                int i12 = this.f34455p;
                if (i11 <= length - i12) {
                    ...
                    int i13 = i11 - length2;
                    h(i13);
                    System.arraycopy(bArr, i10 + length2, this.f34454o, 0, i13);
                    this.f34455p = i13;
                }
            } catch (Throwable th2) {
                throw th2;
