...
public final class RuntimeModuleData {
    ...
    private final DeserializationComponents f33158a;

    /* renamed from: b  reason: collision with root package name */
    private final PackagePartScopeCache f33159b;
    ...
    public final ModuleDescriptor getModule() {
        return this.f33158a.getModuleDescriptor();
    }
    ...
    private RuntimeModuleData(DeserializationComponents deserializationComponents, PackagePartScopeCache packagePartScopeCache) {
        this.f33158a = deserializationComponents;
        this.f33159b = packagePartScopeCache;
    }
}
