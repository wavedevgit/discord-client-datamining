...
public final class FunctionClassDescriptor extends AbstractClassDescriptor {
    ...
    private static final ClassId f32740x;

    /* renamed from: y  reason: collision with root package name */
    private static final ClassId f32741y;

    /* renamed from: p  reason: collision with root package name */
    private final StorageManager f32742p;

    /* renamed from: q  reason: collision with root package name */
    private final PackageFragmentDescriptor f32743q;

    /* renamed from: r  reason: collision with root package name */
    private final FunctionTypeKind f32744r;

    /* renamed from: s  reason: collision with root package name */
    private final int f32745s;

    /* renamed from: t  reason: collision with root package name */
    private final a f32746t;

    /* renamed from: u  reason: collision with root package name */
    private final FunctionClassScope f32747u;

    /* renamed from: v  reason: collision with root package name */
    private final List f32748v;

    /* renamed from: w  reason: collision with root package name */
    private final FunctionClassKind f32749w;
    ...
    private final class a extends AbstractClassTypeConstructor {
        public a() {
            super(FunctionClassDescriptor.this.f32742p);
        }
        ...
        public List getParameters() {
            return FunctionClassDescriptor.this.f32748v;
        }
        ...
        protected Collection l() {
            ...
            if (Intrinsics.areEqual(functionTypeKind, function)) {
                o10 = CollectionsKt.e(FunctionClassDescriptor.f32740x);
            } else if (Intrinsics.areEqual(functionTypeKind, FunctionTypeKind.KFunction.INSTANCE)) {
                o10 = CollectionsKt.o(FunctionClassDescriptor.f32741y, new ClassId(StandardNames.BUILT_INS_PACKAGE_FQ_NAME, function.numberedClassName(FunctionClassDescriptor.this.getArity())));
            } else {
                ...
                if (Intrinsics.areEqual(functionTypeKind, suspendFunction)) {
                    ...
                    o10 = CollectionsKt.o(FunctionClassDescriptor.f32741y, new ClassId(StandardNames.COROUTINES_PACKAGE_FQ_NAME, suspendFunction.numberedClassName(FunctionClassDescriptor.this.getArity())));
                } else {
                    AddToStdlibKt.shouldNotBeCalled$default(null, 1, null);
                    throw new h();
                }
            }
            ModuleDescriptor containingDeclaration = FunctionClassDescriptor.this.f32743q.getContainingDeclaration();
    ...
    public FunctionClassDescriptor(@NotNull StorageManager storageManager, @NotNull PackageFragmentDescriptor containingDeclaration, @NotNull FunctionTypeKind functionTypeKind, int i10) {
        ...
        this.f32742p = storageManager;
        this.f32743q = containingDeclaration;
        this.f32744r = functionTypeKind;
        this.f32745s = i10;
        this.f32746t = new a();
        this.f32747u = new FunctionClassScope(storageManager, this);
        ...
        while (it.hasNext()) {
            ...
            arrayList2.add(Unit.f32556a);
        }
        b(arrayList, this, Variance.OUT_VARIANCE, "R");
        this.f32748v = CollectionsKt.h1(arrayList);
        this.f32749w = FunctionClassKind.Companion.getFunctionClassKind(this.f32744r);
    }
    ...
    private static final void b(ArrayList arrayList, FunctionClassDescriptor functionClassDescriptor, Variance variance, String str) {
        arrayList.add(TypeParameterDescriptorImpl.createWithDefaultBound(functionClassDescriptor, Annotations.Companion.getEMPTY(), false, variance, Name.identifier(str), arrayList.size(), functionClassDescriptor.f32742p));
    }
