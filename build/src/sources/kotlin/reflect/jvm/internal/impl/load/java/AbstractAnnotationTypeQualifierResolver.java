...
public abstract class AbstractAnnotationTypeQualifierResolver<TAnnotation> {
    ...
    private static final a f32437c = new a(null);

    /* renamed from: d  reason: collision with root package name */
    private static final Map f32438d;

    /* renamed from: a  reason: collision with root package name */
    private final JavaTypeEnhancementState f32439a;

    /* renamed from: b  reason: collision with root package name */
    private final ConcurrentHashMap f32440b;
    ...
    private final JavaDefaultQualifiers c(Object obj) {
        ...
        if (k10.isIgnore() || (e10 = e(a10, kotlin.reflect.jvm.internal.impl.load.java.a.f32547d)) == null) {
            return null;
        }
    ...
    */
    private final kotlin.reflect.jvm.internal.impl.load.java.typeEnhancement.NullabilityQualifierWithMigrationStatus h(java.lang.Object r6, boolean r7) {
        /*
            ...
            return r1
        L8:
            kotlin.reflect.jvm.internal.impl.load.java.JavaTypeEnhancementState r2 = r5.f32439a
    ...
    private final ReportLevel i(Object obj) {
        ...
        if (fqName != null && JavaDefaultQualifiersKt.getJSPECIFY_DEFAULT_ANNOTATIONS().containsKey(fqName)) {
            return (ReportLevel) this.f32439a.getGetReportLevelForAnnotation().invoke(fqName);
        }
        return j(obj);
    }
    ...
    private final ReportLevel j(Object obj) {
        ...
        return this.f32439a.getJsr305().getGlobalLevel();
    }

    private final ReportLevel k(Object obj) {
        Iterable enumArguments;
        String str;
        ReportLevel reportLevel = this.f32439a.getJsr305().getUserDefinedLevelForSpecificAnnotation().get(getFqName(obj));
        if (reportLevel != null) {
            return reportLevel;
        }
        ...
        ReportLevel migrationLevel = this.f32439a.getJsr305().getMigrationLevel();
    ...
    private final JavaDefaultQualifiers l(Object obj) {
        ...
        if (this.f32439a.getDisabledDefaultAnnotations() || (javaDefaultQualifiers = JavaDefaultQualifiersKt.getBUILT_IN_TYPE_QUALIFIER_DEFAULT_ANNOTATIONS().get(getFqName(obj))) == null) {
            return null;
        }
    ...
    private final Pair m(Object obj) {
        Object f10;
        Object obj2;
        if (this.f32439a.getJsr305().isDisabled() || (f10 = f(obj, JvmAnnotationNamesKt.getJAVAX_TYPE_QUALIFIER_DEFAULT_ANNOTATION_FQ_NAME())) == null) {
            return null;
        }
        ...
        for (String str : enumArguments) {
            AnnotationQualifierApplicabilityType annotationQualifierApplicabilityType = (AnnotationQualifierApplicabilityType) f32438d.get(str);
    ...
    public final JavaTypeQualifiersByElementType extractAndMergeDefaultQualifiers(JavaTypeQualifiersByElementType javaTypeQualifiersByElementType, @NotNull Iterable<? extends TAnnotation> annotations) {
        ...
        if (!this.f32439a.getDisabledDefaultAnnotations()) {
    ...
    public final TAnnotation resolveTypeQualifierAnnotation(@NotNull TAnnotation annotation) {
        ...
        Intrinsics.checkNotNullParameter(annotation, "annotation");
        if (this.f32439a.getJsr305().isDisabled()) {
            return null;
        }
        if (!CollectionsKt.d0(JvmAnnotationNamesKt.getBUILT_IN_TYPE_QUALIFIER_ANNOTATIONS(), getFqName(annotation)) && !g(annotation, JvmAnnotationNamesKt.getJAVAX_TYPE_QUALIFIER_ANNOTATION_FQ_NAME())) {
            ...
            ConcurrentHashMap concurrentHashMap = this.f32440b;
