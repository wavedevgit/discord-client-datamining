...
public class LockBasedStorageManager implements StorageManager {
    ...
    protected final SimpleLock f34492a;

    /* renamed from: b  reason: collision with root package name */
    private final ExceptionHandlingStrategy f34493b;

    /* renamed from: c  reason: collision with root package name */
    private final String f34494c;

    /* renamed from: d  reason: collision with root package name */
    private static final String f34491d = StringsKt.g1(LockBasedStorageManager.class.getCanonicalName(), ".", "");
    ...
    class b extends i {
        ...
        final /* synthetic */ Object f34495o;
    ...
    class c extends j {
        ...
        @Override // kotlin.reflect.jvm.internal.impl.storage.LockBasedStorageManager.g
        protected n c(boolean z10) {
            Function1 function1 = this.f34497p;
            if (function1 == null) {
                n c10 = super.c(z10);
                if (c10 == null) {
                    a(0);
    ...
    public static class f {
        ...
        /* renamed from: a  reason: collision with root package name */
        private final Object f34500a;

        /* renamed from: b  reason: collision with root package name */
        private final Function0 f34501b;

        public f(Object obj, Function0 function0) {
            this.f34500a = obj;
            this.f34501b = function0;
        }
        ...
        public boolean equals(Object obj) {
            ...
            if (obj != null && getClass() == obj.getClass() && this.f34500a.equals(((f) obj).f34500a)) {
                return true;
            }
            return false;
        }
    ...
    public static class g implements NullableLazyValue {
        ...
        /* renamed from: d  reason: collision with root package name */
        private final LockBasedStorageManager f34502d;

        /* renamed from: e  reason: collision with root package name */
        private final Function0 f34503e;

        /* renamed from: i  reason: collision with root package name */
        private volatile Object f34504i;
        ...
        public g(LockBasedStorageManager lockBasedStorageManager, Function0 function0) {
            ...
            this.f34504i = m.NOT_COMPUTED;
            this.f34502d = lockBasedStorageManager;
        ...
        protected n c(boolean z10) {
            n e10 = this.f34502d.e("in a lazy value", null);
            if (e10 == null) {
                a(2);
            }
            return e10;
        ...
        public Object invoke() {
            Object invoke;
            Object obj = this.f34504i;
            if (!(obj instanceof m)) {
                return WrappedValues.unescapeThrowable(obj);
            }
            this.f34502d.f34492a.lock();
            try {
                Object obj2 = this.f34504i;
                if (!(obj2 instanceof m)) {
                    invoke = WrappedValues.unescapeThrowable(obj2);
                } else {
                    m mVar = m.COMPUTING;
                    if (obj2 == mVar) {
                        this.f34504i = m.RECURSION_WAS_DETECTED;
                        n c10 = c(true);
                        if (!c10.c()) {
                            invoke = c10.b();
                        }
                    ...
                    this.f34504i = mVar;
                    invoke = this.f34503e.invoke();
                    b(invoke);
                    this.f34504i = invoke;
                }
                return invoke;
            } finally {
                this.f34502d.f34492a.unlock();
            }
        }

        public boolean isComputed() {
            if (this.f34504i != m.NOT_COMPUTED && this.f34504i != m.COMPUTING) {
                return true;
            }
            return false;
        }
    ...
    private static abstract class h extends g {
        ...
        /* renamed from: o  reason: collision with root package name */
        private volatile kotlin.reflect.jvm.internal.impl.storage.a f34505o;
        ...
        protected final void b(Object obj) {
            this.f34505o = new kotlin.reflect.jvm.internal.impl.storage.a(obj);
            try {
                d(obj);
            } finally {
                this.f34505o = null;
        ...
        public Object invoke() {
            kotlin.reflect.jvm.internal.impl.storage.a aVar = this.f34505o;
            if (aVar != null && aVar.b()) {
                return aVar.a();
            }
            return super.invoke();
    ...
    public static class k implements MemoizedFunctionToNullable {
        ...
        /* renamed from: d  reason: collision with root package name */
        private final LockBasedStorageManager f34506d;

        /* renamed from: e  reason: collision with root package name */
        private final ConcurrentMap f34507e;

        /* renamed from: i  reason: collision with root package name */
        private final Function1 f34508i;
        ...
        public k(LockBasedStorageManager lockBasedStorageManager, ConcurrentMap concurrentMap, Function1 function1) {
            ...
            this.f34506d = lockBasedStorageManager;
            this.f34507e = concurrentMap;
            this.f34508i = function1;
        }
        ...
        private AssertionError b(Object obj, Object obj2) {
            return (AssertionError) LockBasedStorageManager.f(new AssertionError("Inconsistent key detected. " + m.COMPUTING + " is expected, was: " + obj2 + ", most probably race condition detected on input " + obj + " under " + this.f34506d));
        }

        private AssertionError c(Object obj, Object obj2) {
            AssertionError assertionError = (AssertionError) LockBasedStorageManager.f(new AssertionError("Race condition detected on input " + obj + ". Old value is " + obj2 + " under " + this.f34506d));
        ...
        private AssertionError e(Object obj, Throwable th2) {
            return (AssertionError) LockBasedStorageManager.f(new AssertionError("Unable to remove " + obj + " under " + this.f34506d, th2));
        }

        protected n d(Object obj, boolean z10) {
            n e10 = this.f34506d.e("", obj);
            if (e10 == null) {
                a(3);
            }
            return e10;
        ...
        public Object invoke(Object obj) {
            ...
            Object obj2 = this.f34507e.get(obj);
            if (obj2 != null && obj2 != m.COMPUTING) {
                return WrappedValues.unescapeExceptionOrNull(obj2);
            }
            this.f34506d.f34492a.lock();
            try {
                Object obj3 = this.f34507e.get(obj);
                m mVar = m.COMPUTING;
                if (obj3 == mVar) {
                ...
                this.f34507e.put(obj, mVar);
                Object invoke = this.f34508i.invoke(obj);
                Object put = this.f34507e.put(obj, WrappedValues.escapeNull(invoke));
                if (put == mVar) {
                    return invoke;
                }
                throw c(obj, put);
            } finally {
                this.f34506d.f34492a.unlock();
            }
        }
    ...
    public static class n {
        ...
        public String toString() {
            ...
            return String.valueOf(this.f34513a);
        }
    }
    ...
    */
    ...
    static /* synthetic */ ExceptionHandlingStrategy b(LockBasedStorageManager lockBasedStorageManager) {
        return lockBasedStorageManager.f34493b;
    }
    ...
    public static Throwable f(Throwable th2) {
        ...
        while (true) {
            if (i10 < length) {
                if (!stackTrace[i10].getClassName().startsWith(f34491d)) {
                    break;
                }
                i10++;
            } else {
    ...
    public String toString() {
        return getClass().getSimpleName() + "@" + Integer.toHexString(hashCode()) + " (" + this.f34494c + ")";
    }
    ...
    private LockBasedStorageManager(String str, ExceptionHandlingStrategy exceptionHandlingStrategy, SimpleLock simpleLock) {
        ...
        this.f34492a = simpleLock;
        this.f34493b = exceptionHandlingStrategy;
        this.f34494c = str;
    }
