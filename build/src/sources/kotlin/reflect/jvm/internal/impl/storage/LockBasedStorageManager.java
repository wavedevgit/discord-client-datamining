...
public class LockBasedStorageManager implements StorageManager {
    ...
    protected final SimpleLock f35061a;

    /* renamed from: b  reason: collision with root package name */
    private final ExceptionHandlingStrategy f35062b;

    /* renamed from: c  reason: collision with root package name */
    private final String f35063c;

    /* renamed from: d  reason: collision with root package name */
    private static final String f35060d = StringsKt.g1(LockBasedStorageManager.class.getCanonicalName(), ".", "");
    ...
    class b extends i {
        ...
        final /* synthetic */ Object f35064o;
    ...
    class c extends j {
        ...
        final /* synthetic */ Function1 f35066p;

        /* renamed from: q  reason: collision with root package name */
        final /* synthetic */ Function1 f35067q;
        ...
        @Override // kotlin.reflect.jvm.internal.impl.storage.LockBasedStorageManager.g
        protected n c(boolean z10) {
            Function1 function1 = this.f35066p;
            if (function1 == null) {
                n c10 = super.c(z10);
                if (c10 == null) {
                    a(0);
    ...
    public static class f {
        ...
        /* renamed from: a  reason: collision with root package name */
        private final Object f35069a;

        /* renamed from: b  reason: collision with root package name */
        private final Function0 f35070b;

        public f(Object obj, Function0 function0) {
            this.f35069a = obj;
            this.f35070b = function0;
        }
        ...
        public boolean equals(Object obj) {
            ...
            if (obj != null && getClass() == obj.getClass() && this.f35069a.equals(((f) obj).f35069a)) {
                return true;
            }
            return false;
        }
    ...
    public static class g implements NullableLazyValue {
        ...
        /* renamed from: d  reason: collision with root package name */
        private final LockBasedStorageManager f35071d;

        /* renamed from: e  reason: collision with root package name */
        private final Function0 f35072e;

        /* renamed from: i  reason: collision with root package name */
        private volatile Object f35073i;
        ...
        public g(LockBasedStorageManager lockBasedStorageManager, Function0 function0) {
            ...
            this.f35073i = m.NOT_COMPUTED;
            this.f35071d = lockBasedStorageManager;
        ...
        protected n c(boolean z10) {
            n e10 = this.f35071d.e("in a lazy value", null);
            if (e10 == null) {
                a(2);
            }
            return e10;
        ...
        public Object invoke() {
            Object invoke;
            Object obj = this.f35073i;
            if (!(obj instanceof m)) {
                return WrappedValues.unescapeThrowable(obj);
            }
            this.f35071d.f35061a.lock();
            try {
                Object obj2 = this.f35073i;
                if (!(obj2 instanceof m)) {
                    invoke = WrappedValues.unescapeThrowable(obj2);
                } else {
                    m mVar = m.COMPUTING;
                    if (obj2 == mVar) {
                        this.f35073i = m.RECURSION_WAS_DETECTED;
                        n c10 = c(true);
                        if (!c10.c()) {
                            invoke = c10.b();
                        }
                    ...
                    this.f35073i = mVar;
                    invoke = this.f35072e.invoke();
                    b(invoke);
                    this.f35073i = invoke;
                }
                return invoke;
            } finally {
                this.f35071d.f35061a.unlock();
            }
        }

        public boolean isComputed() {
            if (this.f35073i != m.NOT_COMPUTED && this.f35073i != m.COMPUTING) {
                return true;
            }
            return false;
        }
    ...
    private static abstract class h extends g {
        ...
        /* renamed from: o  reason: collision with root package name */
        private volatile kotlin.reflect.jvm.internal.impl.storage.a f35074o;
        ...
        protected final void b(Object obj) {
            this.f35074o = new kotlin.reflect.jvm.internal.impl.storage.a(obj);
            try {
                d(obj);
            } finally {
                this.f35074o = null;
        ...
        public Object invoke() {
            kotlin.reflect.jvm.internal.impl.storage.a aVar = this.f35074o;
            if (aVar != null && aVar.b()) {
                return aVar.a();
            }
            return super.invoke();
    ...
    public static class k implements MemoizedFunctionToNullable {
        ...
        /* renamed from: d  reason: collision with root package name */
        private final LockBasedStorageManager f35075d;

        /* renamed from: e  reason: collision with root package name */
        private final ConcurrentMap f35076e;

        /* renamed from: i  reason: collision with root package name */
        private final Function1 f35077i;
        ...
        public k(LockBasedStorageManager lockBasedStorageManager, ConcurrentMap concurrentMap, Function1 function1) {
            ...
            this.f35075d = lockBasedStorageManager;
            this.f35076e = concurrentMap;
            this.f35077i = function1;
        }
        ...
        private AssertionError b(Object obj, Object obj2) {
            return (AssertionError) LockBasedStorageManager.f(new AssertionError("Inconsistent key detected. " + m.COMPUTING + " is expected, was: " + obj2 + ", most probably race condition detected on input " + obj + " under " + this.f35075d));
        }

        private AssertionError c(Object obj, Object obj2) {
            AssertionError assertionError = (AssertionError) LockBasedStorageManager.f(new AssertionError("Race condition detected on input " + obj + ". Old value is " + obj2 + " under " + this.f35075d));
        ...
        private AssertionError e(Object obj, Throwable th2) {
            return (AssertionError) LockBasedStorageManager.f(new AssertionError("Unable to remove " + obj + " under " + this.f35075d, th2));
        }

        protected n d(Object obj, boolean z10) {
            n e10 = this.f35075d.e("", obj);
            if (e10 == null) {
                a(3);
            }
            return e10;
        ...
        public Object invoke(Object obj) {
            ...
            Object obj2 = this.f35076e.get(obj);
            if (obj2 != null && obj2 != m.COMPUTING) {
                return WrappedValues.unescapeExceptionOrNull(obj2);
            }
            this.f35075d.f35061a.lock();
            try {
                Object obj3 = this.f35076e.get(obj);
                m mVar = m.COMPUTING;
                if (obj3 == mVar) {
                ...
                this.f35076e.put(obj, mVar);
                Object invoke = this.f35077i.invoke(obj);
                Object put = this.f35076e.put(obj, WrappedValues.escapeNull(invoke));
                if (put == mVar) {
                    return invoke;
                }
                throw c(obj, put);
            } finally {
                this.f35075d.f35061a.unlock();
            }
        }
    ...
    public static class n {
        ...
        public String toString() {
            ...
            return String.valueOf(this.f35082a);
        }
    }
    ...
    */
    ...
    static /* synthetic */ ExceptionHandlingStrategy b(LockBasedStorageManager lockBasedStorageManager) {
        return lockBasedStorageManager.f35062b;
    }
    ...
    public static Throwable f(Throwable th2) {
        ...
        while (true) {
            if (i10 < length) {
                if (!stackTrace[i10].getClassName().startsWith(f35060d)) {
                    break;
                }
                i10++;
            } else {
    ...
    public String toString() {
        return getClass().getSimpleName() + "@" + Integer.toHexString(hashCode()) + " (" + this.f35063c + ")";
    }
    ...
    private LockBasedStorageManager(String str, ExceptionHandlingStrategy exceptionHandlingStrategy, SimpleLock simpleLock) {
        ...
        this.f35061a = simpleLock;
        this.f35062b = exceptionHandlingStrategy;
        this.f35063c = str;
    }
