...
public final class JavaToKotlinClassMap {
    ...
    private static final String f32197a;
    ...
    private static final String f32200d;

    /* renamed from: e  reason: collision with root package name */
    private static final ClassId f32201e;

    /* renamed from: f  reason: collision with root package name */
    private static final FqName f32202f;

    /* renamed from: g  reason: collision with root package name */
    private static final ClassId f32203g;

    /* renamed from: h  reason: collision with root package name */
    private static final ClassId f32204h;

    /* renamed from: i  reason: collision with root package name */
    private static final ClassId f32205i;

    /* renamed from: j  reason: collision with root package name */
    private static final HashMap f32206j;

    /* renamed from: k  reason: collision with root package name */
    private static final HashMap f32207k;

    /* renamed from: l  reason: collision with root package name */
    private static final HashMap f32208l;

    /* renamed from: m  reason: collision with root package name */
    private static final HashMap f32209m;

    /* renamed from: n  reason: collision with root package name */
    private static final HashMap f32210n;

    /* renamed from: o  reason: collision with root package name */
    private static final HashMap f32211o;

    /* renamed from: p  reason: collision with root package name */
    private static final List f32212p;

    /* loaded from: /home/runner/work/discord-client-datamining/discord-client-datamining/build/classes5.dex */
    public static final class PlatformMutabilityMapping {

        /* renamed from: a  reason: collision with root package name */
        private final ClassId f32213a;

        /* renamed from: b  reason: collision with root package name */
        private final ClassId f32214b;

        /* renamed from: c  reason: collision with root package name */
        private final ClassId f32215c;
        ...
        public PlatformMutabilityMapping(@NotNull ClassId javaClass, @NotNull ClassId kotlinReadOnly, @NotNull ClassId kotlinMutable) {
            ...
            this.f32213a = javaClass;
            this.f32214b = kotlinReadOnly;
            this.f32215c = kotlinMutable;
        }
        ...
        public boolean equals(Object obj) {
            ...
            if (obj instanceof PlatformMutabilityMapping) {
                ...
                return Intrinsics.areEqual(this.f32213a, platformMutabilityMapping.f32213a) && Intrinsics.areEqual(this.f32214b, platformMutabilityMapping.f32214b) && Intrinsics.areEqual(this.f32215c, platformMutabilityMapping.f32215c);
            }
            return false;
        }
        ...
        public int hashCode() {
            return (((this.f32213a.hashCode() * 31) + this.f32214b.hashCode()) * 31) + this.f32215c.hashCode();
        }

        @NotNull
        public String toString() {
            return "PlatformMutabilityMapping(javaClass=" + this.f32213a + ", kotlinReadOnly=" + this.f32214b + ", kotlinMutable=" + this.f32215c + ')';
        }
    }
    ...
    static {
        ...
        f32200d = sb5.toString();
        ClassId.Companion companion = ClassId.Companion;
        ClassId classId = companion.topLevel(new FqName("kotlin.jvm.functions.FunctionN"));
        f32201e = classId;
        f32202f = classId.asSingleFqName();
        StandardClassIds standardClassIds = StandardClassIds.INSTANCE;
        f32203g = standardClassIds.getKFunction();
        f32204h = standardClassIds.getKClass();
        f32205i = javaToKotlinClassMap.g(Class.class);
        f32206j = new HashMap();
        f32207k = new HashMap();
        f32208l = new HashMap();
        f32209m = new HashMap();
        ...
        for (int i10 = 0; i10 < 23; i10++) {
            ...
            javaToKotlinClassMap3.c(new FqName(f32198b + i10), f32203g);
        }
        for (int i11 = 0; i11 < 22; i11++) {
            FunctionTypeKind.KSuspendFunction kSuspendFunction2 = FunctionTypeKind.KSuspendFunction.INSTANCE;
            INSTANCE.c(new FqName((kSuspendFunction2.getPackageFqName() + '.' + kSuspendFunction2.getClassNamePrefix()) + i11), f32203g);
        }
    ...
    private final void b(ClassId classId, ClassId classId2) {
        f32206j.put(classId.asSingleFqName().toUnsafe(), classId2);
    }

    private final void c(FqName fqName, ClassId classId) {
        f32207k.put(fqName.toUnsafe(), classId);
    }
    ...
    private final void d(PlatformMutabilityMapping platformMutabilityMapping) {
        ...
        f32210n.put(component3, component2);
        f32211o.put(component2, component3);
        FqName asSingleFqName = component2.asSingleFqName();
        FqName asSingleFqName2 = component3.asSingleFqName();
        f32208l.put(component3.asSingleFqName().toUnsafe(), asSingleFqName);
        f32209m.put(asSingleFqName.toUnsafe(), asSingleFqName2);
    }
    ...
    public final boolean isMutable(FqNameUnsafe fqNameUnsafe) {
        return f32208l.containsKey(fqNameUnsafe);
    }

    public final boolean isReadOnly(FqNameUnsafe fqNameUnsafe) {
        return f32209m.containsKey(fqNameUnsafe);
    }

    public final ClassId mapJavaToKotlin(@NotNull FqName fqName) {
        Intrinsics.checkNotNullParameter(fqName, "fqName");
        return (ClassId) f32206j.get(fqName.toUnsafe());
    }

    public final ClassId mapKotlinToJava(@NotNull FqNameUnsafe kotlinFqName) {
        Intrinsics.checkNotNullParameter(kotlinFqName, "kotlinFqName");
        if (h(kotlinFqName, f32197a)) {
            return f32201e;
        }
        if (h(kotlinFqName, f32199c)) {
            return f32201e;
        }
        if (h(kotlinFqName, f32198b)) {
            return f32203g;
        }
        if (h(kotlinFqName, f32200d)) {
            return f32203g;
        }
        return (ClassId) f32207k.get(kotlinFqName);
    }

    public final FqName mutableToReadOnly(FqNameUnsafe fqNameUnsafe) {
        return (FqName) f32208l.get(fqNameUnsafe);
    }

    public final FqName readOnlyToMutable(FqNameUnsafe fqNameUnsafe) {
        return (FqName) f32209m.get(fqNameUnsafe);
    }
}
