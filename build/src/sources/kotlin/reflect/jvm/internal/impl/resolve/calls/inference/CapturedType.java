...
public final class CapturedType extends SimpleType implements CapturedTypeMarker {
    ...
    private final TypeProjection f35415e;

    /* renamed from: i  reason: collision with root package name */
    private final CapturedTypeConstructor f35416i;

    /* renamed from: o  reason: collision with root package name */
    private final boolean f35417o;

    /* renamed from: p  reason: collision with root package name */
    private final TypeAttributes f35418p;
    ...
    public SimpleType replaceAttributes(@NotNull TypeAttributes newAttributes) {
        ...
        return new CapturedType(this.f35415e, getConstructor(), isMarkedNullable(), newAttributes);
    }

    @Override // kotlin.reflect.jvm.internal.impl.types.UnwrappedType
    @NotNull
    public CapturedType makeNullableAsSpecified(boolean z10) {
        return z10 == isMarkedNullable() ? this : new CapturedType(this.f35415e, getConstructor(), z10, getAttributes());
    }
    ...
    public CapturedType refine(@NotNull KotlinTypeRefiner kotlinTypeRefiner) {
        ...
        TypeProjection refine = this.f35415e.refine(kotlinTypeRefiner);
    ...
    public CapturedType(@NotNull TypeProjection typeProjection, @NotNull CapturedTypeConstructor constructor, boolean z10, @NotNull TypeAttributes attributes) {
        ...
        this.f35415e = typeProjection;
        this.f35416i = constructor;
        this.f35417o = z10;
        this.f35418p = attributes;
    }
}
