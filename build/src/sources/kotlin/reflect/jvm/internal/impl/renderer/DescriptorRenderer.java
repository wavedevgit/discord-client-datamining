...
public abstract class DescriptorRenderer {
    ...
    static {
        ...
        Companion = companion;
        WITHOUT_MODIFIERS = companion.withOptions(a.f34621d);
        COMPACT_WITH_MODIFIERS = companion.withOptions(c.f34623d);
        COMPACT = companion.withOptions(d.f34624d);
        COMPACT_WITHOUT_SUPERTYPES = companion.withOptions(e.f34625d);
        COMPACT_WITH_SHORT_TYPES = companion.withOptions(f.f34626d);
        ONLY_NAMES_WITH_SHORT_TYPES = companion.withOptions(g.f34627d);
        FQ_NAMES_IN_TYPES = companion.withOptions(h.f34628d);
        FQ_NAMES_IN_TYPES_WITH_ANNOTATIONS = companion.withOptions(i.f34629d);
        SHORT_NAMES_IN_TYPES = companion.withOptions(j.f34630d);
        DEBUG_TEXT = companion.withOptions(k.f34631d);
        HTML = companion.withOptions(b.f34622d);
    }
