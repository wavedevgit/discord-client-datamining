...
public abstract class DescriptorRenderer {
    ...
    static {
        ...
        Companion = companion;
        WITHOUT_MODIFIERS = companion.withOptions(a.f34052d);
        COMPACT_WITH_MODIFIERS = companion.withOptions(c.f34054d);
        COMPACT = companion.withOptions(d.f34055d);
        COMPACT_WITHOUT_SUPERTYPES = companion.withOptions(e.f34056d);
        COMPACT_WITH_SHORT_TYPES = companion.withOptions(f.f34057d);
        ONLY_NAMES_WITH_SHORT_TYPES = companion.withOptions(g.f34058d);
        FQ_NAMES_IN_TYPES = companion.withOptions(h.f34059d);
        FQ_NAMES_IN_TYPES_WITH_ANNOTATIONS = companion.withOptions(i.f34060d);
        SHORT_NAMES_IN_TYPES = companion.withOptions(j.f34061d);
        DEBUG_TEXT = companion.withOptions(k.f34062d);
        HTML = companion.withOptions(b.f34053d);
    }
