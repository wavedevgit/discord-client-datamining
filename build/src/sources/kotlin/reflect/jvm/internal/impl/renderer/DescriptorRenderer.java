...
public abstract class DescriptorRenderer {
    ...
    static {
        ...
        Companion = companion;
        WITHOUT_MODIFIERS = companion.withOptions(a.f35363d);
        COMPACT_WITH_MODIFIERS = companion.withOptions(c.f35365d);
        COMPACT = companion.withOptions(d.f35366d);
        COMPACT_WITHOUT_SUPERTYPES = companion.withOptions(e.f35367d);
        COMPACT_WITH_SHORT_TYPES = companion.withOptions(f.f35368d);
        ONLY_NAMES_WITH_SHORT_TYPES = companion.withOptions(g.f35369d);
        FQ_NAMES_IN_TYPES = companion.withOptions(h.f35370d);
        FQ_NAMES_IN_TYPES_WITH_ANNOTATIONS = companion.withOptions(i.f35371d);
        SHORT_NAMES_IN_TYPES = companion.withOptions(j.f35372d);
        DEBUG_TEXT = companion.withOptions(k.f35373d);
        HTML = companion.withOptions(b.f35364d);
    }
