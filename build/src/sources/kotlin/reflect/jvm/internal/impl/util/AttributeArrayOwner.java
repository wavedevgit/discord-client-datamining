...
public abstract class AttributeArrayOwner<K, T> extends AbstractArrayMapOwner<K, T> {
    ...
    protected final void d(String keyQualifiedName, Object value) {
        ...
        int size = this.f35328d.getSize();
        if (size != 0) {
            if (size == 1) {
                ArrayMap arrayMap = this.f35328d;
                try {
