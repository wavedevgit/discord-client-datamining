...
public interface CoroutineContext {
    ...
    public static final class a {
        public static CoroutineContext b(CoroutineContext coroutineContext, CoroutineContext context) {
            ...
            return (CoroutineContext) context.y1(coroutineContext, new Function2() { // from class: qr.c
        ...
        public static CoroutineContext c(CoroutineContext acc, Element element) {
            ...
            CoroutineContext e12 = acc.e1(element.getKey());
            e eVar = e.f32538d;
            if (e12 == eVar) {
                return element;
            }
            ...
            d dVar = (d) e12.l(bVar);
            if (dVar == null) {
                return new c(e12, element);
            }
            CoroutineContext e13 = e12.e1(bVar);
            if (e13 == eVar) {
                return new c(element, dVar);
            }
            return new c(new c(e13, element), dVar);
        }
    }
