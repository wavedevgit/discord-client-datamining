...
public interface CoroutineContext {
    ...
    public static final class a {
        public static CoroutineContext b(CoroutineContext coroutineContext, CoroutineContext context) {
            ...
            return (CoroutineContext) context.A1(coroutineContext, new Function2() { // from class: or.c
        ...
        public static CoroutineContext c(CoroutineContext acc, Element element) {
            ...
            CoroutineContext y12 = acc.y1(element.getKey());
            e eVar = e.f33148d;
            if (y12 == eVar) {
                return element;
            }
            ...
            d dVar = (d) y12.l(bVar);
            if (dVar == null) {
                return new c(y12, element);
            }
            CoroutineContext y13 = y12.y1(bVar);
            if (y13 == eVar) {
                return new c(element, dVar);
            }
            return new c(new c(y13, element), dVar);
        }
    }
