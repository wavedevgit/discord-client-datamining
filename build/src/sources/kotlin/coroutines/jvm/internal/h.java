...
public final class h {
    ...
    public static final h f32632a = new h();

    /* renamed from: b  reason: collision with root package name */
    private static final a f32633b = new a(null, null, null);

    /* renamed from: c  reason: collision with root package name */
    private static a f32634c;
    ...
    public static final class a {
        ...
        /* renamed from: b  reason: collision with root package name */
        public final Method f32636b;

        /* renamed from: c  reason: collision with root package name */
        public final Method f32637c;

        public a(Method method, Method method2, Method method3) {
            this.f32635a = method;
            this.f32636b = method2;
            this.f32637c = method3;
        }
    }
    ...
    public final String b(kotlin.coroutines.jvm.internal.a continuation) {
        ...
        if (aVar != f32633b && (method = aVar.f32635a) != null && (invoke = method.invoke(continuation.getClass(), null)) != null && (method2 = aVar.f32636b) != null && (invoke2 = method2.invoke(invoke, null)) != null) {
            Method method3 = aVar.f32637c;
            if (method3 != null) {
