...
public class CollectionsKt___CollectionsKt extends a0 {
    ...
    public static final class a implements Sequence {
        ...
        /* renamed from: a */
        final /* synthetic */ Iterable f32567a;

        public a(Iterable iterable) {
            this.f32567a = iterable;
        }

        @Override // kotlin.sequences.Sequence
        public Iterator iterator() {
            return this.f32567a.iterator();
        }
    }
    ...
    public static List p1(Iterable iterable, Iterable other) {
        ...
        while (it.hasNext() && it2.hasNext()) {
            arrayList.add(as.v.a(it.next(), it2.next()));
        }
        return arrayList;
    }
    ...
    public static List q1(Iterable iterable, Object[] other) {
        ...
        for (Object obj : iterable) {
            ...
            arrayList.add(as.v.a(obj, other[i10]));
            i10++;
        }
        return arrayList;
    }
