...
public abstract class d extends kotlin.collections.b implements List, KMappedMarker {
    ...
    private static final class C0454d extends d implements RandomAccess {
        ...
        public C0454d(d list, int i10, int i11) {
            ...
            this.f32094e = list;
            this.f32095i = i10;
            d.f32090d.d(i10, i11, list.size());
            this.f32096o = i11 - i10;
        }
        ...
        public Object get(int i10) {
            d.f32090d.b(i10, this.f32096o);
            return this.f32094e.get(this.f32095i + i10);
        }
    }
    ...
    public boolean equals(Object obj) {
        ...
        return f32090d.f(this, (Collection) obj);
    }
