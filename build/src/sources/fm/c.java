...
public abstract class c {
    public static final Function0 b(EditText editText, Function6 action) {
        ...
        eVar.j();
        return new Function0() { // from class: fm.b
    ...
    public static final class a implements TextWatcher {
        ...
        final /* synthetic */ Ref.ObjectRef f25241d;

        /* renamed from: e  reason: collision with root package name */
        final /* synthetic */ Function1 f25242e;

        a(Ref.ObjectRef objectRef, Function1 function1) {
            this.f25241d = objectRef;
            this.f25242e = function1;
        }
        ...
        public void onTextChanged(CharSequence charSequence, int i10, int i11, int i12) {
            ...
            if (!Intrinsics.areEqual((Object) valueOf, this.f25241d.element)) {
                this.f25241d.element = valueOf;
                this.f25242e.invoke(valueOf);
            }
        }
