...
public class Timeout {
    ...
    public static final b f44368d = new b(null);

    /* renamed from: e  reason: collision with root package name */
    public static final Timeout f44369e = new a();
    ...
    public void f() {
        if (!Thread.currentThread().isInterrupted()) {
            if (this.f44370a && this.f44371b - System.nanoTime() <= 0) {
