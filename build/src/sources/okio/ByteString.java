...
public class ByteString implements Serializable, Comparable {
    ...
    public static final a f44060o = new a(null);

    /* renamed from: p  reason: collision with root package name */
    public static final ByteString f44061p = new ByteString(new byte[0]);

    /* renamed from: d  reason: collision with root package name */
    private final byte[] f44062d;

    /* renamed from: e  reason: collision with root package name */
    private transient int f44063e;

    /* renamed from: i  reason: collision with root package name */
    private transient String f44064i;
        ...
        public final ByteString e(String str) {
            ...
            if (str.length() % 2 == 0) {
                ...
                for (int i10 = 0; i10 < length; i10++) {
                    int i11 = i10 * 2;
                    bArr[i10] = (byte) ((pu.b.b(str.charAt(i11)) << 4) + pu.b.b(str.charAt(i11 + 1)));
                }
        ...
        if (i10 >= 0) {
            if (e10 <= l().length) {
                if (e10 - i10 >= 0) {
                    ...
                    return new ByteString(i.q(l(), i10, e10));
                }
    ...
    public void N(OutputStream out) {
        ...
        out.write(this.f44062d);
    }

    public void O(Buffer buffer, int i10, int i11) {
        Intrinsics.checkNotNullParameter(buffer, "buffer");
        pu.b.d(this, buffer, i10, i11);
    }
    ...
    public ByteString g(String algorithm) {
        ...
        messageDigest.update(this.f44062d, 0, G());
    ...
    public String q() {
        ...
        for (byte b10 : l()) {
            int i11 = i10 + 1;
            cArr[i10] = pu.b.f()[(b10 >> 4) & 15];
            i10 += 2;
            cArr[i11] = pu.b.f()[b10 & 15];
        }
            ...
            if (e10 <= l().length) {
                if (e10 >= 0) {
                    if (e10 == l().length) {
                        ...
                        byteString = new ByteString(i.q(l(), 0, e10));
                    }
    ...
    public int x(byte[] other, int i10) {
        Intrinsics.checkNotNullParameter(other, "other");
        for (int min = Math.min(b.e(this, i10), l().length - other.length); -1 < min; min--) {
