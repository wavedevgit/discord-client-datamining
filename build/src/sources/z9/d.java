...
public class d extends z9.a {
    ...
    public static final a f55326o = new a(null);

    /* renamed from: i  reason: collision with root package name */
    private final List f55327i = new ArrayList(2);
    ...
    public void B(String id2, Object obj, b.a aVar) {
        ...
        int size = this.f55327i.size();
        for (int i10 = 0; i10 < size; i10++) {
            try {
                try {
                    ((b) this.f55327i.get(i10)).B(id2, obj, aVar);
    ...
    public final synchronized void E(b listener) {
        ...
        this.f55327i.add(listener);
    }

    public final synchronized void F(b listener) {
        Intrinsics.checkNotNullParameter(listener, "listener");
        this.f55327i.remove(listener);
    }
    ...
    public void a(String id2, Object obj, b.a aVar) {
        ...
        for (int i10 = 0; i10 < size; i10++) {
            try {
                try {
                    ((b) this.f55327i.get(i10)).a(id2, obj, aVar);
                    Unit unit = Unit.f33282a;
                } catch (Exception e10) {
    ...
    public void h(String id2, Throwable th2, b.a aVar) {
        ...
        for (int i10 = 0; i10 < size; i10++) {
            try {
                try {
                    ((b) this.f55327i.get(i10)).h(id2, th2, aVar);
                    Unit unit = Unit.f33282a;
                } catch (Exception e10) {
    ...
    public void onIntermediateImageSet(String id2, Object obj) {
        ...
        for (int i10 = 0; i10 < size; i10++) {
            try {
                try {
                    ((b) this.f55327i.get(i10)).onIntermediateImageSet(id2, obj);
                    Unit unit = Unit.f33282a;
                } catch (Exception e10) {
    ...
    public void x(String id2, b.a aVar) {
        ...
        for (int i10 = 0; i10 < size; i10++) {
            try {
                try {
                    ((b) this.f55327i.get(i10)).x(id2, aVar);
                    Unit unit = Unit.f33282a;
                } catch (Exception e10) {
