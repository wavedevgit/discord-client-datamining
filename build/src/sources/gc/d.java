...
public class d implements x {
    ...
    private final hc.d f24913b;

    /* renamed from: c  reason: collision with root package name */
    private final f f24914c;
    ...
    public void a(zb.o oVar, int i10, boolean z10) {
        ComponentName componentName = new ComponentName(this.f24912a, JobInfoSchedulerService.class);
        JobScheduler jobScheduler = (JobScheduler) this.f24912a.getSystemService("jobscheduler");
        int c10 = c(oVar);
        if (!z10 && d(jobScheduler, c10, i10)) {
            dc.a.b("JobInfoScheduler", "Upload for context %s is already scheduled. Returning...", oVar);
            return;
        }
        long t02 = this.f24913b.t0(oVar);
        JobInfo.Builder c11 = this.f24914c.c(new JobInfo.Builder(c10, componentName), oVar.d(), t02, i10);
        ...
        dc.a.c("JobInfoScheduler", "Scheduling upload for context %s with jobId=%d in %dms(Backend next call timestamp %d). Attempt %d", oVar, Integer.valueOf(c10), Long.valueOf(this.f24914c.g(oVar.d(), t02, i10)), Long.valueOf(t02), Integer.valueOf(i10));
    ...
    int c(zb.o oVar) {
        ...
        adler32.update(this.f24912a.getPackageName().getBytes(Charset.forName("UTF-8")));
