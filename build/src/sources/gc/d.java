...
public class d implements x {
    ...
    public void a(zb.o oVar, int i10, boolean z10) {
        ComponentName componentName = new ComponentName(this.f26699a, JobInfoSchedulerService.class);
        JobScheduler jobScheduler = (JobScheduler) this.f26699a.getSystemService("jobscheduler");
        int c10 = c(oVar);
        if (!z10 && d(jobScheduler, c10, i10)) {
            dc.a.b("JobInfoScheduler", "Upload for context %s is already scheduled. Returning...", oVar);
            return;
        }
        long r02 = this.f26700b.r0(oVar);
        JobInfo.Builder c11 = this.f26701c.c(new JobInfo.Builder(c10, componentName), oVar.d(), r02, i10);
        ...
        dc.a.c("JobInfoScheduler", "Scheduling upload for context %s with jobId=%d in %dms(Backend next call timestamp %d). Attempt %d", oVar, Integer.valueOf(c10), Long.valueOf(this.f26701c.g(oVar.d(), r02, i10)), Long.valueOf(r02), Integer.valueOf(i10));
    ...
    int c(zb.o oVar) {
        ...
        adler32.update(this.f26699a.getPackageName().getBytes(Charset.forName("UTF-8")));
