...
public class d implements x {
    ...
    private final hc.d f25913b;

    /* renamed from: c  reason: collision with root package name */
    private final f f25914c;
    ...
    public void a(zb.o oVar, int i10, boolean z10) {
        ComponentName componentName = new ComponentName(this.f25912a, JobInfoSchedulerService.class);
        JobScheduler jobScheduler = (JobScheduler) this.f25912a.getSystemService("jobscheduler");
        int c10 = c(oVar);
        if (!z10 && d(jobScheduler, c10, i10)) {
            dc.a.b("JobInfoScheduler", "Upload for context %s is already scheduled. Returning...", oVar);
            return;
        }
        long q02 = this.f25913b.q0(oVar);
        JobInfo.Builder c11 = this.f25914c.c(new JobInfo.Builder(c10, componentName), oVar.d(), q02, i10);
        ...
        dc.a.c("JobInfoScheduler", "Scheduling upload for context %s with jobId=%d in %dms(Backend next call timestamp %d). Attempt %d", oVar, Integer.valueOf(c10), Long.valueOf(this.f25914c.g(oVar.d(), q02, i10)), Long.valueOf(q02), Integer.valueOf(i10));
    ...
    int c(zb.o oVar) {
        ...
        adler32.update(this.f25912a.getPackageName().getBytes(Charset.forName("UTF-8")));
