...
public abstract class c {
    public static final Function0 b(EditText editText, Function6 action) {
        ...
        eVar.j();
        return new Function0() { // from class: mm.b
    ...
    public static final TextWatcher d(EditText editText, Function1 action) {
        ...
        try {
            ...
            qm.a.f(qm.a.f46623a, editText.getClass().getSimpleName(), "Can not attach listener because `fieldValue` does not belong to `ArrayList<TextWatcher>`", null, 4, null);
            return aVar;
        } catch (ClassCastException e10) {
            qm.a aVar2 = qm.a.f46623a;
            String simpleName = editText.getClass().getSimpleName();
            String message = e10.getMessage();
            qm.a.f(aVar2, simpleName, "Can not attach listener because casting failed: " + message, null, 4, null);
            return aVar;
        } catch (IllegalArgumentException e11) {
            qm.a aVar3 = qm.a.f46623a;
            String simpleName2 = editText.getClass().getSimpleName();
            String message2 = e11.getMessage();
            qm.a.f(aVar3, simpleName2, "Can not attach listener to be the first in the list: " + message2 + ". Attaching to the end...", null, 4, null);
            editText.addTextChangedListener(aVar);
            return aVar;
        } catch (NoSuchFieldException e12) {
            qm.a aVar4 = qm.a.f46623a;
            String simpleName3 = editText.getClass().getSimpleName();
            String message3 = e12.getMessage();
            qm.a.f(aVar4, simpleName3, "Can not attach listener because field `mListeners` not found: " + message3 + ". Attaching to the end...", null, 4, null);
            editText.addTextChangedListener(aVar);
            return aVar;
        }
    }
    ...
    public static final class a implements TextWatcher {
        ...
        final /* synthetic */ Ref.ObjectRef f37244d;

        /* renamed from: e  reason: collision with root package name */
        final /* synthetic */ Function1 f37245e;

        a(Ref.ObjectRef objectRef, Function1 function1) {
            this.f37244d = objectRef;
            this.f37245e = function1;
        }
        ...
        public void onTextChanged(CharSequence charSequence, int i10, int i11, int i12) {
            ...
            if (!Intrinsics.areEqual((Object) valueOf, this.f37244d.element)) {
                this.f37244d.element = valueOf;
                this.f37245e.invoke(valueOf);
            }
        }
