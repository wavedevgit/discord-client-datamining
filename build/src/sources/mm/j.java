...
public final class j {
    ...
    public static final void h(Activity activity, boolean z10, int i10) {
        ...
        if (z10) {
            ...
            ofObject.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() { // from class: mm.i
    ...
    public final void g(final int i10, final boolean z10) {
        ...
        UiThreadUtil.runOnUiThread(new Runnable() { // from class: mm.g
    ...
    public final void j(final boolean z10) {
        UiThreadUtil.runOnUiThread(new Runnable() { // from class: mm.f
            @Override // java.lang.Runnable
            public final void run() {
                j.k(z10, this);
            }
    ...
    public final void l(final String style) {
        ...
        UiThreadUtil.runOnUiThread(new Runnable() { // from class: mm.h
            @Override // java.lang.Runnable
            public final void run() {
                j.m(j.this, style);
            }
    ...
    public final void n(final boolean z10) {
        UiThreadUtil.runOnUiThread(new Runnable() { // from class: mm.e
            @Override // java.lang.Runnable
            public final void run() {
                j.o(j.this, z10);
            }
