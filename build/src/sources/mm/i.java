...
public abstract class i {
    ...
    private static final int[] f37253a = new int[2];
    ...
    public static final void a(View view, Rect rect) {
        ...
        qm.a.f(qm.a.f46623a, "View.copyBoundsInWindow", "Can not copy bounds as view is not attached to window", null, 4, null);
    }
