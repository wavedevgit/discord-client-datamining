...
public abstract class x0 implements SerialDescriptor {
    ...
    private final SerialDescriptor f35237a;
    ...
    public boolean equals(Object obj) {
        ...
        x0 x0Var = (x0) obj;
        if (Intrinsics.areEqual(this.f35237a, x0Var.f35237a) && Intrinsics.areEqual(h(), x0Var.h())) {
            return true;
        }
        return false;
    }
    ...
    public int hashCode() {
        return (this.f35237a.hashCode() * 31) + h().hashCode();
    }
    ...
    public String toString() {
        return h() + '(' + this.f35237a + ')';
    }

    private x0(SerialDescriptor serialDescriptor) {
        this.f35237a = serialDescriptor;
        this.f35238b = 1;
    }
}
