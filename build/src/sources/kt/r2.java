...
public abstract class r2 implements Encoder, CompositeEncoder {
    ...
    private final ArrayList f35211a = new ArrayList();
    ...
    @Override // kotlinx.serialization.encoding.CompositeEncoder
    public void F(SerialDescriptor descriptor, int i10, gt.o serializer, Object obj) {
        Intrinsics.checkNotNullParameter(descriptor, "descriptor");
    ...
    public void H(gt.o oVar, Object obj) {
    ...
    protected final Object X() {
        return CollectionsKt.z0(this.f35211a);
    }

    /* JADX INFO: Access modifiers changed from: protected */
    public final Object Y() {
        return CollectionsKt.B0(this.f35211a);
    }
    ...
    protected final Object a0() {
        if (!this.f35211a.isEmpty()) {
            ArrayList arrayList = this.f35211a;
            return arrayList.remove(CollectionsKt.n(arrayList));
        }
        throw new gt.n("No tag in stack for requested element");
    }
    ...
    @Override // kotlinx.serialization.encoding.Encoder
    public abstract void h(gt.o oVar, Object obj);
    ...
    @Override // kotlinx.serialization.encoding.Encoder
    public CompositeEncoder j(SerialDescriptor serialDescriptor, int i10) {
