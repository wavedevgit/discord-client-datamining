...
public abstract class d {
    ...
    private static final boolean f36167a;

    /* renamed from: b  reason: collision with root package name */
    private static final d f36168b;

    /* renamed from: c  reason: collision with root package name */
    private static final boolean f36169c;
    ...
    static {
        ...
        try {
            f36168b = (d) Class.forName(property).newInstance();
        } catch (Exception e10) {
