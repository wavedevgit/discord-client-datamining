...
public abstract class h2 {
    ...
    private static final Map f35147a = t1.i();

    public static final SerialDescriptor a(String serialName, jt.e kind) {
    ...
    public static final KSerializer b(KClass kClass) {
        ...
        return (KSerializer) f35147a.get(kClass);
    }

    private static final void c(String str) {
        for (KSerializer kSerializer : f35147a.values()) {
