...
public final class u0 extends d1 {
    ...
    private final SerialDescriptor f35222c;
    ...
    public u0(KSerializer kSerializer, KSerializer vSerializer) {
        ...
        this.f35222c = new t0(kSerializer.getDescriptor(), vSerializer.getDescriptor());
    }

    @Override // kt.d1, kotlinx.serialization.KSerializer, gt.o, kotlinx.serialization.DeserializationStrategy
