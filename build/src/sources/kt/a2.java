...
public class a2 implements SerialDescriptor, l {
    ...
    /* renamed from: f */
    private final List[] f35099f;

    /* renamed from: g */
    private List f35100g;
    ...
    /* renamed from: j */
    private final Lazy f35103j;

    /* renamed from: k */
    private final Lazy f35104k;

    /* renamed from: l */
    private final Lazy f35105l;

    public a2(String serialName, h0 h0Var, int i10) {
        Intrinsics.checkNotNullParameter(serialName, "serialName");
        this.f35094a = serialName;
        this.f35095b = h0Var;
        this.f35096c = i10;
        this.f35097d = -1;
        ...
        this.f35099f = new List[i12];
        this.f35101h = new boolean[i12];
        this.f35102i = kotlin.collections.o0.i();
        rr.o oVar = rr.o.f49210e;
        this.f35103j = rr.l.b(oVar, new Function0() { // from class: kt.x1
        ...
        this.f35104k = rr.l.b(oVar, new Function0() { // from class: kt.y1
            @Override // kotlin.jvm.functions.Function0
            public final Object invoke() {
        ...
        this.f35105l = rr.l.b(oVar, new Function0() { // from class: kt.z1
            @Override // kotlin.jvm.functions.Function0
            public final Object invoke() {
                int n10;
                n10 = a2.n(a2.this);
    ...
    private final Map q() {
        ...
        int length = this.f35098e.length;
        for (int i10 = 0; i10 < length; i10++) {
            hashMap.put(this.f35098e[i10], Integer.valueOf(i10));
        }
        return hashMap;
    }
    ...
    private final KSerializer[] s() {
        return (KSerializer[]) this.f35103j.getValue();
    }

    private final int u() {
        return ((Number) this.f35105l.getValue()).intValue();
    }
    ...
    public int c(String name) {
        ...
        Integer num = (Integer) this.f35102i.get(name);
        if (num != null) {
            return num.intValue();
        }
        return -3;
    ...
    public final void o(String name, boolean z10) {
        Intrinsics.checkNotNullParameter(name, "name");
        String[] strArr = this.f35098e;
        int i10 = this.f35097d + 1;
        this.f35097d = i10;
        strArr[i10] = name;
        this.f35101h[i10] = z10;
        this.f35099f[i10] = null;
        if (i10 == this.f35096c - 1) {
            this.f35102i = q();
        }
    }

    public final SerialDescriptor[] t() {
        return (SerialDescriptor[]) this.f35104k.getValue();
    }

    public String toString() {
        IntRange u10 = kotlin.ranges.d.u(0, this.f35096c);
        return CollectionsKt.x0(u10, ", ", h() + '(', ")", 0, null, new Function1() { // from class: kt.w1
    ...
    public final void v(Annotation annotation) {
        ...
        List list = this.f35099f[this.f35097d];
        if (list == null) {
            list = new ArrayList(1);
            this.f35099f[this.f35097d] = list;
        }
        list.add(annotation);
    }
