...
public abstract class f2 extends s {
    ...
    private final SerialDescriptor f35138b;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public f2(KSerializer primitiveSerializer) {
        super(primitiveSerializer, null);
        Intrinsics.checkNotNullParameter(primitiveSerializer, "primitiveSerializer");
        this.f35138b = new e2(primitiveSerializer.getDescriptor());
    }
    ...
    @Override // kt.a, kotlinx.serialization.DeserializationStrategy
    ...
    public final void serialize(Encoder encoder, Object obj) {
        ...
        int e10 = e(obj);
        SerialDescriptor serialDescriptor = this.f35138b;
        CompositeEncoder j10 = encoder.j(serialDescriptor, e10);
        u(j10, obj, e10);
