...
public final class b {
    ...
    /* loaded from: /home/runner/work/discord-client-datamining/discord-client-datamining/build/classes5.dex */
    private static class C0470b implements u {
        private C0470b() {
        }
    ...
    private static class c implements f {
        ...
        public String d(e eVar, Locale locale) {
            ...
            if (fVar == null) {
                ...
                d10 = ((mt.c) mt.c.class.cast(fVar)).i(eVar, locale, true);
            } else {
                d10 = fVar.d(eVar, locale);
            }
            return mt.d.a(d10);
        }
    ...
    private static class d implements u {
        ...
        public String[] e(String str, Locale locale, v vVar, m mVar) {
            ...
            if (i10 != 1) {
                if (i10 != 2 && i10 != 3) {
                    if (i10 == 4) {
                        weekdays = c(e("", locale, v.SHORT, mVar), 7);
                    } else {
    ...
    private b(String str, Locale locale, u uVar) {
        ...
        while (i12 < length) {
            ...
            while (i13 < length2) {
                m mVar = values3[i13];
                enumMap2.put((EnumMap) mVar, (m) new s(uVar.j(str, locale, vVar, mVar)));
                i13++;
                values2 = values2;
            }
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    public static String a(jt.x xVar) {
    ...
    public s n(String str, Class cls, String... strArr) {
        ...
        if (this.f36587k == null) {
            ...
            String e10 = e(str);
            int i10 = !jt.i.class.isAssignableFrom(cls) ? 1 : 0;
