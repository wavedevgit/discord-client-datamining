...
public abstract class m {
    ...
    private static final mt.q f35835a = new mt.q(new mt.x(new MutablePropertyReference1Impl() { // from class: kt.m.a
    ...
    private static final k f35836b = new k(null, null, null, null, 15, null);
}
