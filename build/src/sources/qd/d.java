...
public final class d implements p, p.a {
    ...
    public final p f47135d;

    /* renamed from: e  reason: collision with root package name */
    private p.a f47136e;

    /* renamed from: i  reason: collision with root package name */
    private a[] f47137i = new a[0];

    /* renamed from: o  reason: collision with root package name */
    private long f47138o;
    ...
    private final class a implements m0 {
        ...
        public int c(lc.x xVar, qc.f fVar, int i10) {
            ...
            long g10 = d.this.g();
            int c10 = this.f47141d.c(xVar, fVar, i10);
            if (c10 == -5) {
                ...
                if (i11 != 0 || format.N != 0) {
                    ...
                    if (dVar.f47140q == Long.MIN_VALUE) {
                        i12 = format.N;
                    }
                    xVar.f37126b = format.b().P(i11).Q(i12).G();
                }
                return -5;
            }
            long j10 = d.this.f47140q;
            if (j10 != Long.MIN_VALUE && ((c10 == -4 && fVar.f47094p >= j10) || (c10 == -3 && g10 == Long.MIN_VALUE && !fVar.f47093o))) {
                fVar.h();
                fVar.s(4);
                this.f47142e = true;
                return -4;
        ...
        public boolean isReady() {
            if (!d.this.p() && this.f47141d.isReady()) {
                return true;
            }
            return false;
        }
    ...
    private lc.t0 a(long j10, lc.t0 t0Var) {
        long j11;
        long r10 = ne.w0.r(t0Var.f37120a, 0L, j10 - this.f47139p);
        long j12 = t0Var.f37121b;
        long j13 = this.f47140q;
        ...
        if (r10 == t0Var.f37120a && r11 == t0Var.f37121b) {
            return t0Var;
        }
    ...
    @Override // qd.p, qd.n0
    public long b() {
        long b10 = this.f47135d.b();
        if (b10 != Long.MIN_VALUE) {
            long j10 = this.f47140q;
    ...
    public long e(long j10, lc.t0 t0Var) {
        ...
        return this.f47135d.e(j10, a(j10, t0Var));
    }

    @Override // qd.p, qd.n0
    public boolean f(long j10) {
        return this.f47135d.f(j10);
    }

    @Override // qd.p, qd.n0
    public long g() {
        long g10 = this.f47135d.g();
    ...
    public void j(p pVar) {
        ((p.a) ne.a.e(this.f47136e)).j(this);
    }

    @Override // qd.p
    public void k(p.a aVar, long j10) {
        this.f47136e = aVar;
        this.f47135d.k(this, j10);
    }
    ...
    */
    ...
    public long m() {
        ...
        if (p()) {
            ...
            this.f47138o = -9223372036854775807L;
            long m10 = m();
    ...
    */
    public long o(com.google.android.exoplayer2.trackselection.g[] r10, boolean[] r11, qd.m0[] r12, boolean[] r13, long r14) {
        ...
        L61:
            ...
            r13 = r4[r0]
            if (r13 != 0) goto L6d
            qd.d$a[] r13 = r9.f47137i
            r13[r0] = r8
            goto L7e
        L6d:
            qd.d$a[] r14 = r9.f47137i
            r15 = r14[r0]
            if (r15 == 0) goto L77
            qd.m0 r15 = r15.f47141d
            if (r15 == r13) goto L7e
        L77:
    ...
    boolean p() {
        if (this.f47138o != -9223372036854775807L) {
            return true;
        }
        return false;
    }
    ...
    public void i(p pVar) {
        ((p.a) ne.a.e(this.f47136e)).i(this);
    }
    ...
    @Override // qd.p
    public w0 t() {
        return this.f47135d.t();
    }

    @Override // qd.p
    public void u(long j10, boolean z10) {
        this.f47135d.u(j10, z10);
    }
