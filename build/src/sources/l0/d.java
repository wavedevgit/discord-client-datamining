...
public abstract class d {
    ...
    public static final int[] f35486a = {12344};

    /* renamed from: b  reason: collision with root package name */
    public static final int[] f35487b = {12445, 13632, 12344};

    /* renamed from: c  reason: collision with root package name */
    public static final String f35488c;

    /* renamed from: d  reason: collision with root package name */
    public static final String f35489d;

    /* renamed from: e  reason: collision with root package name */
    private static final a0 f35490e;

    /* renamed from: f  reason: collision with root package name */
    private static final a0 f35491f;

    /* renamed from: g  reason: collision with root package name */
    private static final a0 f35492g;

    /* renamed from: h  reason: collision with root package name */
    public static final float[] f35493h;

    /* renamed from: i  reason: collision with root package name */
    public static final FloatBuffer f35494i;

    /* renamed from: j  reason: collision with root package name */
    public static final float[] f35495j;

    /* renamed from: k  reason: collision with root package name */
    public static final FloatBuffer f35496k;

    /* renamed from: l  reason: collision with root package name */
    public static final l0.g f35497l;
    ...
    public static abstract class f {
        ...
        /* renamed from: a  reason: collision with root package name */
        protected int f35502a;

        /* renamed from: b  reason: collision with root package name */
        protected int f35503b = -1;

        /* renamed from: c  reason: collision with root package name */
        protected int f35504c = -1;

        /* renamed from: d  reason: collision with root package name */
        protected int f35505d = -1;
        ...
        */
        protected f(java.lang.String r7, java.lang.String r8) {
            /*
                ...
                if (r3 != r0) goto L4a
                r6.f35502a = r2     // Catch: java.lang.IllegalArgumentException -> L46 java.lang.IllegalStateException -> L48
                r6.c()
                return
            L46:
                r0 = move-exception
        ...
        public void c() {
            int glGetAttribLocation = GLES20.glGetAttribLocation(this.f35502a, "aPosition");
            this.f35505d = glGetAttribLocation;
            d.j(glGetAttribLocation, "aPosition");
            int glGetUniformLocation = GLES20.glGetUniformLocation(this.f35502a, "uTransMatrix");
            this.f35503b = glGetUniformLocation;
            d.j(glGetUniformLocation, "uTransMatrix");
            int glGetUniformLocation2 = GLES20.glGetUniformLocation(this.f35502a, "uAlphaScale");
            this.f35504c = glGetUniformLocation2;
            d.j(glGetUniformLocation2, "uAlphaScale");
        }

        public void b() {
            GLES20.glDeleteProgram(this.f35502a);
        }

        public void d(float f10) {
            GLES20.glUniform1f(this.f35504c, f10);
            d.g("glUniform1f");
        }

        public void e(float[] fArr) {
            GLES20.glUniformMatrix4fv(this.f35503b, 1, false, fArr, 0);
            d.g("glUniformMatrix4fv");
        }

        public void f() {
            GLES20.glUseProgram(this.f35502a);
            d.g("glUseProgram");
            GLES20.glEnableVertexAttribArray(this.f35505d);
            d.g("glEnableVertexAttribArray");
            GLES20.glVertexAttribPointer(this.f35505d, 2, 5126, false, 0, (Buffer) d.f35494i);
    ...
    public static class g extends f {
        ...
        private void c() {
            c();
            int glGetUniformLocation = GLES20.glGetUniformLocation(this.f35502a, "sTexture");
            this.f35506e = glGetUniformLocation;
            d.j(glGetUniformLocation, "sTexture");
            int glGetAttribLocation = GLES20.glGetAttribLocation(this.f35502a, "aTextureCoord");
            this.f35508g = glGetAttribLocation;
            d.j(glGetAttribLocation, "aTextureCoord");
            int glGetUniformLocation2 = GLES20.glGetUniformLocation(this.f35502a, "uTexMatrix");
            this.f35507f = glGetUniformLocation2;
        ...
        private static a0 g(z zVar, e eVar) {
            ...
            return eVar == e.YUV ? d.f35492g : d.f35491f;
        }

        @Override // l0.d.f
        public void f() {
            super.f();
            GLES20.glUniform1i(this.f35506e, 0);
            GLES20.glEnableVertexAttribArray(this.f35508g);
            d.g("glEnableVertexAttribArray");
            GLES20.glVertexAttribPointer(this.f35508g, 2, 5126, false, 0, (Buffer) d.f35496k);
            d.g("glVertexAttribPointer");
        }

        public void h(float[] fArr) {
            GLES20.glUniformMatrix4fv(this.f35507f, 1, false, fArr, 0);
            d.g("glUniformMatrix4fv");
        }

        public g(z zVar, a0 a0Var) {
            super(zVar.d() ? d.f35489d : d.f35488c, d.v(a0Var));
            this.f35506e = -1;
            this.f35507f = -1;
            this.f35508g = -1;
            c();
    ...
    static {
        ...
        f35488c = String.format(locale, "uniform mat4 uTexMatrix;\nuniform mat4 uTransMatrix;\nattribute vec4 aPosition;\nattribute vec4 aTextureCoord;\nvarying vec2 %s;\nvoid main() {\n    gl_Position = uTransMatrix * aPosition;\n    %s = (uTexMatrix * aTextureCoord).xy;\n}\n", "vTextureCoord", "vTextureCoord");
        f35489d = String.format(locale, "#version 300 es\nin vec4 aPosition;\nin vec4 aTextureCoord;\nuniform mat4 uTexMatrix;\nuniform mat4 uTransMatrix;\nout vec2 %s;\nvoid main() {\n  gl_Position = uTransMatrix * aPosition;\n  %s = (uTexMatrix * aTextureCoord).xy;\n}\n", "vTextureCoord", "vTextureCoord");
        f35490e = new a();
        f35491f = new b();
        f35492g = new c();
        ...
        f35495j = fArr2;
        f35496k = m(fArr2);
        f35497l = l0.g.d(EGL14.EGL_NO_SURFACE, 0, 0);
    }
