...
public abstract class d {
    ...
    public static final int[] f35383a = {12344};

    /* renamed from: b  reason: collision with root package name */
    public static final int[] f35384b = {12445, 13632, 12344};

    /* renamed from: c  reason: collision with root package name */
    public static final String f35385c;

    /* renamed from: d  reason: collision with root package name */
    public static final String f35386d;

    /* renamed from: e  reason: collision with root package name */
    private static final a0 f35387e;

    /* renamed from: f  reason: collision with root package name */
    private static final a0 f35388f;

    /* renamed from: g  reason: collision with root package name */
    private static final a0 f35389g;

    /* renamed from: h  reason: collision with root package name */
    public static final float[] f35390h;

    /* renamed from: i  reason: collision with root package name */
    public static final FloatBuffer f35391i;

    /* renamed from: j  reason: collision with root package name */
    public static final float[] f35392j;

    /* renamed from: k  reason: collision with root package name */
    public static final FloatBuffer f35393k;

    /* renamed from: l  reason: collision with root package name */
    public static final l0.g f35394l;
    ...
    public static abstract class f {
        ...
        /* renamed from: a  reason: collision with root package name */
        protected int f35399a;

        /* renamed from: b  reason: collision with root package name */
        protected int f35400b = -1;

        /* renamed from: c  reason: collision with root package name */
        protected int f35401c = -1;

        /* renamed from: d  reason: collision with root package name */
        protected int f35402d = -1;
        ...
        */
        protected f(java.lang.String r7, java.lang.String r8) {
            /*
                ...
                if (r3 != r0) goto L4a
                r6.f35399a = r2     // Catch: java.lang.IllegalArgumentException -> L46 java.lang.IllegalStateException -> L48
                r6.c()
                return
            L46:
                r0 = move-exception
        ...
        public void c() {
            int glGetAttribLocation = GLES20.glGetAttribLocation(this.f35399a, "aPosition");
            this.f35402d = glGetAttribLocation;
            d.j(glGetAttribLocation, "aPosition");
            int glGetUniformLocation = GLES20.glGetUniformLocation(this.f35399a, "uTransMatrix");
            this.f35400b = glGetUniformLocation;
            d.j(glGetUniformLocation, "uTransMatrix");
            int glGetUniformLocation2 = GLES20.glGetUniformLocation(this.f35399a, "uAlphaScale");
            this.f35401c = glGetUniformLocation2;
            d.j(glGetUniformLocation2, "uAlphaScale");
        }

        public void b() {
            GLES20.glDeleteProgram(this.f35399a);
        }

        public void d(float f10) {
            GLES20.glUniform1f(this.f35401c, f10);
            d.g("glUniform1f");
        }

        public void e(float[] fArr) {
            GLES20.glUniformMatrix4fv(this.f35400b, 1, false, fArr, 0);
            d.g("glUniformMatrix4fv");
        }

        public void f() {
            GLES20.glUseProgram(this.f35399a);
            d.g("glUseProgram");
            GLES20.glEnableVertexAttribArray(this.f35402d);
            d.g("glEnableVertexAttribArray");
            GLES20.glVertexAttribPointer(this.f35402d, 2, 5126, false, 0, (Buffer) d.f35391i);
    ...
    public static class g extends f {
        ...
        private void c() {
            c();
            int glGetUniformLocation = GLES20.glGetUniformLocation(this.f35399a, "sTexture");
            this.f35403e = glGetUniformLocation;
            d.j(glGetUniformLocation, "sTexture");
            int glGetAttribLocation = GLES20.glGetAttribLocation(this.f35399a, "aTextureCoord");
            this.f35405g = glGetAttribLocation;
            d.j(glGetAttribLocation, "aTextureCoord");
            int glGetUniformLocation2 = GLES20.glGetUniformLocation(this.f35399a, "uTexMatrix");
            this.f35404f = glGetUniformLocation2;
        ...
        private static a0 g(z zVar, e eVar) {
            ...
            return eVar == e.YUV ? d.f35389g : d.f35388f;
        }

        @Override // l0.d.f
        public void f() {
            super.f();
            GLES20.glUniform1i(this.f35403e, 0);
            GLES20.glEnableVertexAttribArray(this.f35405g);
            d.g("glEnableVertexAttribArray");
            GLES20.glVertexAttribPointer(this.f35405g, 2, 5126, false, 0, (Buffer) d.f35393k);
            d.g("glVertexAttribPointer");
        }

        public void h(float[] fArr) {
            GLES20.glUniformMatrix4fv(this.f35404f, 1, false, fArr, 0);
            d.g("glUniformMatrix4fv");
        }

        public g(z zVar, a0 a0Var) {
            super(zVar.d() ? d.f35386d : d.f35385c, d.v(a0Var));
            this.f35403e = -1;
            this.f35404f = -1;
            this.f35405g = -1;
            c();
    ...
    static {
        ...
        f35385c = String.format(locale, "uniform mat4 uTexMatrix;\nuniform mat4 uTransMatrix;\nattribute vec4 aPosition;\nattribute vec4 aTextureCoord;\nvarying vec2 %s;\nvoid main() {\n    gl_Position = uTransMatrix * aPosition;\n    %s = (uTexMatrix * aTextureCoord).xy;\n}\n", "vTextureCoord", "vTextureCoord");
        f35386d = String.format(locale, "#version 300 es\nin vec4 aPosition;\nin vec4 aTextureCoord;\nuniform mat4 uTexMatrix;\nuniform mat4 uTransMatrix;\nout vec2 %s;\nvoid main() {\n  gl_Position = uTransMatrix * aPosition;\n  %s = (uTexMatrix * aTextureCoord).xy;\n}\n", "vTextureCoord", "vTextureCoord");
        f35387e = new a();
        f35388f = new b();
        f35389g = new c();
        ...
        f35392j = fArr2;
        f35393k = m(fArr2);
        f35394l = l0.g.d(EGL14.EGL_NO_SURFACE, 0, 0);
    }
