...
public abstract class d {
    ...
    public static final int[] f36210a = {12344};

    /* renamed from: b  reason: collision with root package name */
    public static final int[] f36211b = {12445, 13632, 12344};

    /* renamed from: c  reason: collision with root package name */
    public static final String f36212c;

    /* renamed from: d  reason: collision with root package name */
    public static final String f36213d;

    /* renamed from: e  reason: collision with root package name */
    private static final a0 f36214e;

    /* renamed from: f  reason: collision with root package name */
    private static final a0 f36215f;

    /* renamed from: g  reason: collision with root package name */
    private static final a0 f36216g;

    /* renamed from: h  reason: collision with root package name */
    public static final float[] f36217h;

    /* renamed from: i  reason: collision with root package name */
    public static final FloatBuffer f36218i;

    /* renamed from: j  reason: collision with root package name */
    public static final float[] f36219j;

    /* renamed from: k  reason: collision with root package name */
    public static final FloatBuffer f36220k;

    /* renamed from: l  reason: collision with root package name */
    public static final l0.g f36221l;
    ...
    /* loaded from: /home/runner/work/discord-client-datamining/discord-client-datamining/build/classes.dex */
    public static class C0473d extends f {
        public C0473d() {
    ...
    public static abstract class f {
        ...
        /* renamed from: a  reason: collision with root package name */
        protected int f36226a;

        /* renamed from: b  reason: collision with root package name */
        protected int f36227b = -1;

        /* renamed from: c  reason: collision with root package name */
        protected int f36228c = -1;

        /* renamed from: d  reason: collision with root package name */
        protected int f36229d = -1;
        ...
        */
        protected f(java.lang.String r7, java.lang.String r8) {
            /*
                ...
                if (r3 != r0) goto L4a
                r6.f36226a = r2     // Catch: java.lang.IllegalArgumentException -> L46 java.lang.IllegalStateException -> L48
                r6.c()
                return
            L46:
                r0 = move-exception
        ...
        public void c() {
            int glGetAttribLocation = GLES20.glGetAttribLocation(this.f36226a, "aPosition");
            this.f36229d = glGetAttribLocation;
            d.j(glGetAttribLocation, "aPosition");
            int glGetUniformLocation = GLES20.glGetUniformLocation(this.f36226a, "uTransMatrix");
            this.f36227b = glGetUniformLocation;
            d.j(glGetUniformLocation, "uTransMatrix");
            int glGetUniformLocation2 = GLES20.glGetUniformLocation(this.f36226a, "uAlphaScale");
            this.f36228c = glGetUniformLocation2;
            d.j(glGetUniformLocation2, "uAlphaScale");
        }

        public void b() {
            GLES20.glDeleteProgram(this.f36226a);
        }

        public void d(float f10) {
            GLES20.glUniform1f(this.f36228c, f10);
            d.g("glUniform1f");
        }

        public void e(float[] fArr) {
            GLES20.glUniformMatrix4fv(this.f36227b, 1, false, fArr, 0);
            d.g("glUniformMatrix4fv");
        }

        public void f() {
            GLES20.glUseProgram(this.f36226a);
            d.g("glUseProgram");
            GLES20.glEnableVertexAttribArray(this.f36229d);
            d.g("glEnableVertexAttribArray");
            GLES20.glVertexAttribPointer(this.f36229d, 2, 5126, false, 0, (Buffer) d.f36218i);
    ...
    public static class g extends f {
        ...
        private void c() {
            c();
            int glGetUniformLocation = GLES20.glGetUniformLocation(this.f36226a, "sTexture");
            this.f36230e = glGetUniformLocation;
            d.j(glGetUniformLocation, "sTexture");
            int glGetAttribLocation = GLES20.glGetAttribLocation(this.f36226a, "aTextureCoord");
            this.f36232g = glGetAttribLocation;
            d.j(glGetAttribLocation, "aTextureCoord");
            int glGetUniformLocation2 = GLES20.glGetUniformLocation(this.f36226a, "uTexMatrix");
            this.f36231f = glGetUniformLocation2;
        ...
        private static a0 g(z zVar, e eVar) {
            ...
            return eVar == e.YUV ? d.f36216g : d.f36215f;
        }

        @Override // l0.d.f
        public void f() {
            super.f();
            GLES20.glUniform1i(this.f36230e, 0);
            GLES20.glEnableVertexAttribArray(this.f36232g);
            d.g("glEnableVertexAttribArray");
            GLES20.glVertexAttribPointer(this.f36232g, 2, 5126, false, 0, (Buffer) d.f36220k);
            d.g("glVertexAttribPointer");
        }

        public void h(float[] fArr) {
            GLES20.glUniformMatrix4fv(this.f36231f, 1, false, fArr, 0);
            d.g("glUniformMatrix4fv");
        }

        public g(z zVar, a0 a0Var) {
            super(zVar.d() ? d.f36213d : d.f36212c, d.v(a0Var));
            this.f36230e = -1;
            this.f36231f = -1;
            this.f36232g = -1;
            c();
    ...
    static {
        ...
        f36212c = String.format(locale, "uniform mat4 uTexMatrix;\nuniform mat4 uTransMatrix;\nattribute vec4 aPosition;\nattribute vec4 aTextureCoord;\nvarying vec2 %s;\nvoid main() {\n    gl_Position = uTransMatrix * aPosition;\n    %s = (uTexMatrix * aTextureCoord).xy;\n}\n", "vTextureCoord", "vTextureCoord");
        f36213d = String.format(locale, "#version 300 es\nin vec4 aPosition;\nin vec4 aTextureCoord;\nuniform mat4 uTexMatrix;\nuniform mat4 uTransMatrix;\nout vec2 %s;\nvoid main() {\n  gl_Position = uTransMatrix * aPosition;\n  %s = (uTexMatrix * aTextureCoord).xy;\n}\n", "vTextureCoord", "vTextureCoord");
        f36214e = new a();
        f36215f = new b();
        f36216g = new c();
        ...
        f36219j = fArr2;
        f36220k = m(fArr2);
        f36221l = l0.g.d(EGL14.EGL_NO_SURFACE, 0, 0);
    }
