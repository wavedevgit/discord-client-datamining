...
public final class KoreanCalendar extends net.time4j.calendar.f implements kt.h {
    ...
    private static class SPX implements Externalizable {
        ...
        private transient Object f40430d;
        ...
        private void b(ObjectOutput objectOutput) {
            net.time4j.calendar.f fVar = (net.time4j.calendar.f) this.f40430d;
    ...
    private static class c extends net.time4j.calendar.a {
        ...
        public KoreanCalendar j(jt.q qVar, jt.d dVar, boolean z10, boolean z11) {
            j b10;
            int q10 = qVar.q(net.time4j.calendar.b.f40444a);
            if (q10 == Integer.MIN_VALUE) {
                t tVar = KoreanCalendar.f40425v;
                if (qVar.o(tVar)) {
                    jt.p pVar = KoreanCalendar.f40423t;
                    if (qVar.o(pVar)) {
            ...
            t tVar2 = KoreanCalendar.f40427x;
            if (qVar.o(tVar2)) {
                h hVar = (h) qVar.p(tVar2);
                int q12 = qVar.q(KoreanCalendar.f40429z);
    ...
    private static class d extends net.time4j.calendar.d {
        ...
        /* renamed from: d  reason: collision with root package name */
        private static final List f40431d;

        /* renamed from: e  reason: collision with root package name */
        private static final long f40432e;

        /* renamed from: f  reason: collision with root package name */
        private static final long f40433f;

        /* renamed from: g  reason: collision with root package name */
        private static final long f40434g;

        /* renamed from: h  reason: collision with root package name */
        private static final long f40435h;
        ...
        static {
            ...
            arrayList.add(net.time4j.tz.p.s(fVar, 8, 30));
            arrayList.add(net.time4j.tz.p.s(fVar, 9, 0));
            f40431d = Collections.unmodifiableList(arrayList);
            f40432e = f0.H0(1908, 4, 1).j();
            f40433f = f0.H0(1912, 1, 1).j();
            f40434g = f0.H0(1954, 3, 21).j();
            f40435h = f0.H0(1961, 8, 10).j();
        }
        ...
        public net.time4j.tz.p i(long j10) {
            if (j10 < f40432e) {
                return (net.time4j.tz.p) f40431d.get(0);
            }
            if (j10 < f40433f) {
                return (net.time4j.tz.p) f40431d.get(1);
            }
            if (j10 < f40434g) {
                return (net.time4j.tz.p) f40431d.get(2);
            }
            if (j10 < f40435h) {
                return (net.time4j.tz.p) f40431d.get(3);
            }
            return (net.time4j.tz.p) f40431d.get(4);
        }
    ...
    public enum e implements w {
        ...
        /* renamed from: d  reason: collision with root package name */
        private final transient double f40442d;
    ...
    static {
        ...
        jt.p e10 = kVar.e();
        f40424u = e10;
        net.time4j.calendar.e eVar = net.time4j.calendar.e.f40457d;
        f40425v = eVar;
        i D2 = i.D();
        f40426w = D2;
        g gVar = g.f40470d;
        ...
        e eVar4 = e.DAYS;
        h0.b d12 = e11.e(fVar3, X, eVar4).e(fVar4, net.time4j.calendar.f.Z(), eVar4).e(gVar2, new s(k0(), new a()), eVar4).d(rVar, r.K(rVar)).d(net.time4j.calendar.b.f40444a, new n(dVar, fVar4));
        e eVar5 = e.CYCLES;
