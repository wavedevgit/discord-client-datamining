...
public final class KoreanCalendar extends net.time4j.calendar.f implements lt.h {
    ...
    private static class SPX implements Externalizable {
        ...
        private transient Object f40293d;
        ...
        private void b(ObjectOutput objectOutput) {
            net.time4j.calendar.f fVar = (net.time4j.calendar.f) this.f40293d;
    ...
    /* loaded from: /home/runner/work/discord-client-datamining/discord-client-datamining/build/classes5.dex */
    public static class a implements kt.t {
        a() {
        }

        @Override // kt.t
        /* renamed from: a */
        public kt.k apply(KoreanCalendar koreanCalendar) {
    ...
    private static class b implements z {
        ...
        @Override // kt.z
        /* renamed from: b */
        public kt.p a(KoreanCalendar koreanCalendar) {
            throw new AbstractMethodError("Never called.");
        }

        @Override // kt.z
        /* renamed from: c */
        public kt.p g(KoreanCalendar koreanCalendar) {
            throw new AbstractMethodError("Never called.");
        }
        ...
        @Override // kt.z
        /* renamed from: e */
        public k o(KoreanCalendar koreanCalendar) {
            return k.DANGI;
        }
        ...
        @Override // kt.z
        /* renamed from: k */
        public KoreanCalendar v(KoreanCalendar koreanCalendar, k kVar, boolean z10) {
    ...
    private static class c extends net.time4j.calendar.a {
        ...
        @Override // kt.u
        /* renamed from: e */
        public KoreanCalendar h(kt.q qVar, kt.d dVar, boolean z10, boolean z11) {
            j b10;
            int t10 = qVar.t(net.time4j.calendar.b.f40307a);
            if (t10 == Integer.MIN_VALUE) {
                t tVar = KoreanCalendar.f40288v;
                if (qVar.s(tVar)) {
                    kt.p pVar = KoreanCalendar.f40286t;
                    if (qVar.s(pVar)) {
                        b10 = ((net.time4j.calendar.c) qVar.v(tVar)).q(qVar.t(pVar));
                    }
                }
                int t11 = qVar.t(k.DANGI.e());
            ...
            t tVar2 = KoreanCalendar.f40290x;
            if (qVar.s(tVar2)) {
                h hVar = (h) qVar.v(tVar2);
                int t12 = qVar.t(KoreanCalendar.f40292z);
                if (t12 != Integer.MIN_VALUE) {
                    return KoreanCalendar.m0(b10, hVar, t12);
                }
            } else {
                int t13 = qVar.t(KoreanCalendar.A);
                if (t13 != Integer.MIN_VALUE && t13 >= 1) {
                    return (KoreanCalendar) KoreanCalendar.m0(b10, h.f(1), 1).K(t13 - 1, e.DAYS);
                }
            }
            return null;
        }
    ...
    private static class d extends net.time4j.calendar.d {
        ...
        /* renamed from: d  reason: collision with root package name */
        private static final List f40294d;

        /* renamed from: e  reason: collision with root package name */
        private static final long f40295e;

        /* renamed from: f  reason: collision with root package name */
        private static final long f40296f;

        /* renamed from: g  reason: collision with root package name */
        private static final long f40297g;

        /* renamed from: h  reason: collision with root package name */
        private static final long f40298h;
        ...
        static {
            ...
            arrayList.add(net.time4j.tz.p.s(fVar, 8, 30));
            arrayList.add(net.time4j.tz.p.s(fVar, 9, 0));
            f40294d = Collections.unmodifiableList(arrayList);
            f40295e = f0.H0(1908, 4, 1).i();
            f40296f = f0.H0(1912, 1, 1).i();
            f40297g = f0.H0(1954, 3, 21).i();
            f40298h = f0.H0(1961, 8, 10).i();
        }
        ...
        public net.time4j.tz.p i(long j10) {
            if (j10 < f40295e) {
                return (net.time4j.tz.p) f40294d.get(0);
            }
            if (j10 < f40296f) {
                return (net.time4j.tz.p) f40294d.get(1);
            }
            if (j10 < f40297g) {
                return (net.time4j.tz.p) f40294d.get(2);
            }
            if (j10 < f40298h) {
                return (net.time4j.tz.p) f40294d.get(3);
            }
            return (net.time4j.tz.p) f40294d.get(4);
        }
    ...
    public enum e implements w {
        ...
        /* renamed from: d  reason: collision with root package name */
        private final transient double f40305d;
    ...
    private static class f implements z {
        ...
        @Override // kt.z
        /* renamed from: f */
        public Integer o(KoreanCalendar koreanCalendar) {
            return 3978;
        }
        ...
        public boolean l(KoreanCalendar koreanCalendar, Integer num) {
            ...
            int intValue = o(koreanCalendar).intValue();
        ...
        @Override // kt.z
        /* renamed from: m */
        public KoreanCalendar v(KoreanCalendar koreanCalendar, Integer num, boolean z10) {
            if (num != null) {
    ...
    static {
        ...
        kt.p e10 = kVar.e();
        f40287u = e10;
        net.time4j.calendar.e eVar = net.time4j.calendar.e.f40320d;
        f40288v = eVar;
        i D2 = i.D();
        f40289w = D2;
        g gVar = g.f40333d;
        ...
        e eVar4 = e.DAYS;
        h0.b d12 = e11.e(fVar3, X, eVar4).e(fVar4, net.time4j.calendar.f.Z(), eVar4).e(gVar2, new s(k0(), new a()), eVar4).d(rVar, r.K(rVar)).d(net.time4j.calendar.b.f40307a, new n(dVar, fVar4));
        e eVar5 = e.CYCLES;
