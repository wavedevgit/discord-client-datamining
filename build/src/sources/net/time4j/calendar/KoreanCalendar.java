...
public final class KoreanCalendar extends net.time4j.calendar.f implements nt.h {
    ...
    private static class SPX implements Externalizable {
        ...
        private transient Object f40332d;
        ...
        private void b(ObjectOutput objectOutput) {
            net.time4j.calendar.f fVar = (net.time4j.calendar.f) this.f40332d;
    ...
    /* loaded from: /home/runner/work/discord-client-datamining/discord-client-datamining/build/classes5.dex */
    public static class a implements mt.t {
        a() {
        }

        @Override // mt.t
        /* renamed from: a */
        public mt.k apply(KoreanCalendar koreanCalendar) {
    ...
    private static class b implements z {
        ...
        @Override // mt.z
        /* renamed from: b */
        public mt.p a(KoreanCalendar koreanCalendar) {
            throw new AbstractMethodError("Never called.");
        }

        @Override // mt.z
        /* renamed from: c */
        public mt.p h(KoreanCalendar koreanCalendar) {
            throw new AbstractMethodError("Never called.");
        }

        @Override // mt.z
        /* renamed from: d */
        public k l(KoreanCalendar koreanCalendar) {
            return k.DANGI;
        }
        ...
        @Override // mt.z
        /* renamed from: f */
        public k z(KoreanCalendar koreanCalendar) {
            return k.DANGI;
        }

        @Override // mt.z
        /* renamed from: g */
        public boolean q(KoreanCalendar koreanCalendar, k kVar) {
            if (kVar == k.DANGI) {
                return true;
            }
            return false;
    ...
    private static class c extends net.time4j.calendar.a {
        ...
        @Override // mt.u
        /* renamed from: e */
        public KoreanCalendar m(mt.q qVar, mt.d dVar, boolean z10, boolean z11) {
            j b10;
            int j10 = qVar.j(net.time4j.calendar.b.f40346a);
            if (j10 == Integer.MIN_VALUE) {
                t tVar = KoreanCalendar.f40327v;
                if (qVar.q(tVar)) {
                    mt.p pVar = KoreanCalendar.f40325t;
                    if (qVar.q(pVar)) {
                        b10 = ((net.time4j.calendar.c) qVar.o(tVar)).q(qVar.j(pVar));
                    }
                }
                int j11 = qVar.j(k.DANGI.e());
            ...
            t tVar2 = KoreanCalendar.f40329x;
            if (qVar.q(tVar2)) {
                h hVar = (h) qVar.o(tVar2);
                int j12 = qVar.j(KoreanCalendar.f40331z);
                if (j12 != Integer.MIN_VALUE) {
                    return KoreanCalendar.m0(b10, hVar, j12);
                }
            } else {
                int j13 = qVar.j(KoreanCalendar.A);
                if (j13 != Integer.MIN_VALUE && j13 >= 1) {
                    return (KoreanCalendar) KoreanCalendar.m0(b10, h.f(1), 1).K(j13 - 1, e.DAYS);
                }
            }
            return null;
        }
    ...
    private static class d extends net.time4j.calendar.d {
        ...
        /* renamed from: d  reason: collision with root package name */
        private static final List f40333d;

        /* renamed from: e  reason: collision with root package name */
        private static final long f40334e;

        /* renamed from: f  reason: collision with root package name */
        private static final long f40335f;

        /* renamed from: g  reason: collision with root package name */
        private static final long f40336g;

        /* renamed from: h  reason: collision with root package name */
        private static final long f40337h;
        ...
        static {
            ...
            arrayList.add(net.time4j.tz.p.s(fVar, 8, 30));
            arrayList.add(net.time4j.tz.p.s(fVar, 9, 0));
            f40333d = Collections.unmodifiableList(arrayList);
            f40334e = f0.H0(1908, 4, 1).i();
            f40335f = f0.H0(1912, 1, 1).i();
            f40336g = f0.H0(1954, 3, 21).i();
            f40337h = f0.H0(1961, 8, 10).i();
        }
        ...
        public net.time4j.tz.p i(long j10) {
            if (j10 < f40334e) {
                return (net.time4j.tz.p) f40333d.get(0);
            }
            if (j10 < f40335f) {
                return (net.time4j.tz.p) f40333d.get(1);
            }
            if (j10 < f40336g) {
                return (net.time4j.tz.p) f40333d.get(2);
            }
            if (j10 < f40337h) {
                return (net.time4j.tz.p) f40333d.get(3);
            }
            return (net.time4j.tz.p) f40333d.get(4);
        }
    ...
    public enum e implements w {
        ...
        /* renamed from: d  reason: collision with root package name */
        private final transient double f40344d;
    ...
    private static class f implements z {
        ...
        @Override // mt.z
        /* renamed from: e */
        public Integer l(KoreanCalendar koreanCalendar) {
            return 5332;
        }
        ...
        @Override // mt.z
        /* renamed from: g */
        public Integer z(KoreanCalendar koreanCalendar) {
            return Integer.valueOf(d(koreanCalendar));
        }

        @Override // mt.z
        /* renamed from: i */
        public boolean q(KoreanCalendar koreanCalendar, Integer num) {
            if (num == null) {
                return false;
            }
            int intValue = r(koreanCalendar).intValue();
            int intValue2 = l(koreanCalendar).intValue();
    ...
    static {
        ...
        mt.p e10 = kVar.e();
        f40326u = e10;
        net.time4j.calendar.e eVar = net.time4j.calendar.e.f40359d;
        f40327v = eVar;
        i D2 = i.D();
        f40328w = D2;
        g gVar = g.f40372d;
        ...
        e eVar4 = e.DAYS;
        h0.b d12 = e11.e(fVar3, X, eVar4).e(fVar4, net.time4j.calendar.f.Z(), eVar4).e(gVar2, new s(k0(), new a()), eVar4).d(rVar, r.K(rVar)).d(net.time4j.calendar.b.f40346a, new n(dVar, fVar4));
        e eVar5 = e.CYCLES;
