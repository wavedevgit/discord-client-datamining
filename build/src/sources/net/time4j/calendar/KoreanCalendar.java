...
public final class KoreanCalendar extends net.time4j.calendar.f implements kt.h {
    ...
    private static class SPX implements Externalizable {
        ...
        private transient Object f40414d;
        ...
        private void b(ObjectOutput objectOutput) {
            net.time4j.calendar.f fVar = (net.time4j.calendar.f) this.f40414d;
    ...
    /* loaded from: /home/runner/work/discord-client-datamining/discord-client-datamining/build/classes5.dex */
    public static class a implements jt.t {
        a() {
        }

        @Override // jt.t
        /* renamed from: a */
        public jt.k apply(KoreanCalendar koreanCalendar) {
    ...
    private static class b implements z {
        ...
        @Override // jt.z
        /* renamed from: b */
        public jt.p a(KoreanCalendar koreanCalendar) {
            throw new AbstractMethodError("Never called.");
        }

        @Override // jt.z
        /* renamed from: c */
        public jt.p h(KoreanCalendar koreanCalendar) {
            throw new AbstractMethodError("Never called.");
        }

        @Override // jt.z
        /* renamed from: d */
        public k j(KoreanCalendar koreanCalendar) {
            return k.DANGI;
        }

        @Override // jt.z
        /* renamed from: e */
        public k p(KoreanCalendar koreanCalendar) {
            return k.DANGI;
        }

        @Override // jt.z
        /* renamed from: f */
        public k x(KoreanCalendar koreanCalendar) {
            return k.DANGI;
        }

        @Override // jt.z
        /* renamed from: g */
        public boolean l(KoreanCalendar koreanCalendar, k kVar) {
            if (kVar == k.DANGI) {
                return true;
            }
            return false;
        ...
        @Override // jt.z
        /* renamed from: i */
        public KoreanCalendar w(KoreanCalendar koreanCalendar, k kVar, boolean z10) {
            if (l(koreanCalendar, kVar)) {
    ...
    private static class c extends net.time4j.calendar.a {
        ...
        @Override // jt.u
        /* renamed from: e */
        public KoreanCalendar j(jt.q qVar, jt.d dVar, boolean z10, boolean z11) {
            j b10;
            int q10 = qVar.q(net.time4j.calendar.b.f40428a);
            if (q10 == Integer.MIN_VALUE) {
                t tVar = KoreanCalendar.f40409v;
                if (qVar.o(tVar)) {
                    jt.p pVar = KoreanCalendar.f40407t;
                    if (qVar.o(pVar)) {
                        b10 = ((net.time4j.calendar.c) qVar.p(tVar)).q(qVar.q(pVar));
                    }
                }
                int q11 = qVar.q(k.DANGI.e());
            ...
            t tVar2 = KoreanCalendar.f40411x;
            if (qVar.o(tVar2)) {
                h hVar = (h) qVar.p(tVar2);
                int q12 = qVar.q(KoreanCalendar.f40413z);
                if (q12 != Integer.MIN_VALUE) {
                    return KoreanCalendar.m0(b10, hVar, q12);
                }
            } else {
                int q13 = qVar.q(KoreanCalendar.A);
                if (q13 != Integer.MIN_VALUE && q13 >= 1) {
                    return (KoreanCalendar) KoreanCalendar.m0(b10, h.f(1), 1).K(q13 - 1, e.DAYS);
                }
            }
            return null;
        }
    ...
    private static class d extends net.time4j.calendar.d {
        ...
        /* renamed from: d  reason: collision with root package name */
        private static final List f40415d;

        /* renamed from: e  reason: collision with root package name */
        private static final long f40416e;

        /* renamed from: f  reason: collision with root package name */
        private static final long f40417f;

        /* renamed from: g  reason: collision with root package name */
        private static final long f40418g;

        /* renamed from: h  reason: collision with root package name */
        private static final long f40419h;
        ...
        static {
            ...
            arrayList.add(net.time4j.tz.p.s(fVar, 8, 30));
            arrayList.add(net.time4j.tz.p.s(fVar, 9, 0));
            f40415d = Collections.unmodifiableList(arrayList);
            f40416e = f0.H0(1908, 4, 1).j();
            f40417f = f0.H0(1912, 1, 1).j();
            f40418g = f0.H0(1954, 3, 21).j();
            f40419h = f0.H0(1961, 8, 10).j();
        }
        ...
        public net.time4j.tz.p i(long j10) {
            if (j10 < f40416e) {
                return (net.time4j.tz.p) f40415d.get(0);
            }
            if (j10 < f40417f) {
                return (net.time4j.tz.p) f40415d.get(1);
            }
            if (j10 < f40418g) {
                return (net.time4j.tz.p) f40415d.get(2);
            }
            if (j10 < f40419h) {
                return (net.time4j.tz.p) f40415d.get(3);
            }
            return (net.time4j.tz.p) f40415d.get(4);
        }
    ...
    public enum e implements w {
        ...
        /* renamed from: d  reason: collision with root package name */
        private final transient double f40426d;
    ...
    private static class f implements z {
        ...
        @Override // jt.z
        /* renamed from: e */
        public Integer j(KoreanCalendar koreanCalendar) {
            return 5332;
        }
        ...
        @Override // jt.z
        /* renamed from: g */
        public Integer x(KoreanCalendar koreanCalendar) {
            return Integer.valueOf(d(koreanCalendar));
        }

        @Override // jt.z
        /* renamed from: i */
        public boolean l(KoreanCalendar koreanCalendar, Integer num) {
            if (num == null) {
                return false;
            }
            int intValue = p(koreanCalendar).intValue();
            int intValue2 = j(koreanCalendar).intValue();
        ...
        @Override // jt.z
        /* renamed from: m */
        public KoreanCalendar w(KoreanCalendar koreanCalendar, Integer num, boolean z10) {
            if (num != null) {
                if (l(koreanCalendar, num)) {
    ...
    static {
        ...
        jt.p e10 = kVar.e();
        f40408u = e10;
        net.time4j.calendar.e eVar = net.time4j.calendar.e.f40441d;
        f40409v = eVar;
        i D2 = i.D();
        f40410w = D2;
        g gVar = g.f40454d;
        ...
        e eVar4 = e.DAYS;
        h0.b d12 = e11.e(fVar3, X, eVar4).e(fVar4, net.time4j.calendar.f.Z(), eVar4).e(gVar2, new s(k0(), new a()), eVar4).d(rVar, r.K(rVar)).d(net.time4j.calendar.b.f40428a, new n(dVar, fVar4));
        e eVar5 = e.CYCLES;
