...
public final class KoreanCalendar extends net.time4j.calendar.f implements cu.h {
    ...
    private static class SPX implements Externalizable {
        ...
        private transient Object f37292d;
        ...
        private void b(ObjectOutput objectOutput) {
            net.time4j.calendar.f fVar = (net.time4j.calendar.f) this.f37292d;
    ...
    private static class c extends net.time4j.calendar.a {
        ...
        public KoreanCalendar h(bu.q qVar, bu.d dVar, boolean z10, boolean z11) {
            j b10;
            int m10 = qVar.m(net.time4j.calendar.b.f37306a);
            if (m10 == Integer.MIN_VALUE) {
                t tVar = KoreanCalendar.f37287v;
                if (qVar.n(tVar)) {
                    bu.p pVar = KoreanCalendar.f37285t;
                    if (qVar.n(pVar)) {
            ...
            t tVar2 = KoreanCalendar.f37289x;
            if (qVar.n(tVar2)) {
                h hVar = (h) qVar.k(tVar2);
                int m12 = qVar.m(KoreanCalendar.f37291z);
    ...
    private static class d extends net.time4j.calendar.d {
        ...
        /* renamed from: d  reason: collision with root package name */
        private static final List f37293d;

        /* renamed from: e  reason: collision with root package name */
        private static final long f37294e;

        /* renamed from: f  reason: collision with root package name */
        private static final long f37295f;
        ...
        static {
            ...
            arrayList.add(net.time4j.tz.p.s(fVar, 8, 30));
            arrayList.add(net.time4j.tz.p.s(fVar, 9, 0));
            f37293d = Collections.unmodifiableList(arrayList);
            f37294e = f0.H0(1908, 4, 1).i();
            f37295f = f0.H0(1912, 1, 1).i();
            f37296g = f0.H0(1954, 3, 21).i();
            f37297h = f0.H0(1961, 8, 10).i();
        }
        ...
        public net.time4j.tz.p i(long j10) {
            if (j10 < f37294e) {
                return (net.time4j.tz.p) f37293d.get(0);
            }
            if (j10 < f37295f) {
                return (net.time4j.tz.p) f37293d.get(1);
            }
            if (j10 < f37296g) {
                return (net.time4j.tz.p) f37293d.get(2);
            }
            if (j10 < f37297h) {
                return (net.time4j.tz.p) f37293d.get(3);
            }
            return (net.time4j.tz.p) f37293d.get(4);
        }
    ...
    public enum e implements w {
        ...
        /* renamed from: d  reason: collision with root package name */
        private final transient double f37304d;
    ...
    static {
        ...
        bu.p e10 = kVar.e();
        f37286u = e10;
        net.time4j.calendar.e eVar = net.time4j.calendar.e.f37319d;
        f37287v = eVar;
        i D2 = i.D();
        f37288w = D2;
        g gVar = g.f37332d;
        ...
        e eVar4 = e.DAYS;
        h0.b d12 = e11.e(fVar3, X, eVar4).e(fVar4, net.time4j.calendar.f.Z(), eVar4).e(gVar2, new s(k0(), new a()), eVar4).d(rVar, r.K(rVar)).d(net.time4j.calendar.b.f37306a, new n(dVar, fVar4));
        e eVar5 = e.CYCLES;
