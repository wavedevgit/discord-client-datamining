...
public final class KoreanCalendar extends net.time4j.calendar.f implements st.h {
    ...
    private static class SPX implements Externalizable {
        ...
        private transient Object f39147d;
        ...
        private void b(ObjectOutput objectOutput) {
            net.time4j.calendar.f fVar = (net.time4j.calendar.f) this.f39147d;
    ...
    /* loaded from: /home/runner/work/discord-client-datamining/discord-client-datamining/build/classes5.dex */
    public static class a implements rt.t {
        a() {
        }

        @Override // rt.t
        /* renamed from: a */
        public rt.k apply(KoreanCalendar koreanCalendar) {
    ...
    private static class b implements z {
        ...
        @Override // rt.z
        /* renamed from: b */
        public rt.p a(KoreanCalendar koreanCalendar) {
            throw new AbstractMethodError("Never called.");
        }

        @Override // rt.z
        /* renamed from: c */
        public rt.p g(KoreanCalendar koreanCalendar) {
            throw new AbstractMethodError("Never called.");
        }
        ...
        @Override // rt.z
        /* renamed from: h */
        public boolean n(KoreanCalendar koreanCalendar, k kVar) {
            if (kVar == k.DANGI) {
                return true;
            }
            return false;
        ...
        @Override // rt.z
        /* renamed from: i */
        public KoreanCalendar u(KoreanCalendar koreanCalendar, k kVar, boolean z10) {
            if (n(koreanCalendar, kVar)) {
    ...
    private static class c extends net.time4j.calendar.a {
        ...
        @Override // rt.u
        /* renamed from: e */
        public KoreanCalendar l(rt.q qVar, rt.d dVar, boolean z10, boolean z11) {
            j b10;
            int q10 = qVar.q(net.time4j.calendar.b.f39161a);
            if (q10 == Integer.MIN_VALUE) {
                t tVar = KoreanCalendar.f39142v;
                if (qVar.n(tVar)) {
                    rt.p pVar = KoreanCalendar.f39140t;
                    if (qVar.n(pVar)) {
                        b10 = ((net.time4j.calendar.c) qVar.s(tVar)).q(qVar.q(pVar));
                    }
                }
            ...
            t tVar2 = KoreanCalendar.f39144x;
            if (qVar.n(tVar2)) {
                h hVar = (h) qVar.s(tVar2);
                int q12 = qVar.q(KoreanCalendar.f39146z);
    ...
    private static class d extends net.time4j.calendar.d {
        ...
        /* renamed from: d  reason: collision with root package name */
        private static final List f39148d;

        /* renamed from: e  reason: collision with root package name */
        private static final long f39149e;

        /* renamed from: f  reason: collision with root package name */
        private static final long f39150f;

        /* renamed from: g  reason: collision with root package name */
        private static final long f39151g;

        /* renamed from: h  reason: collision with root package name */
        private static final long f39152h;
        ...
        static {
            ...
            arrayList.add(net.time4j.tz.p.s(fVar, 8, 30));
            arrayList.add(net.time4j.tz.p.s(fVar, 9, 0));
            f39148d = Collections.unmodifiableList(arrayList);
            f39149e = f0.H0(1908, 4, 1).i();
            f39150f = f0.H0(1912, 1, 1).i();
            f39151g = f0.H0(1954, 3, 21).i();
            f39152h = f0.H0(1961, 8, 10).i();
        }
        ...
        public net.time4j.tz.p i(long j10) {
            if (j10 < f39149e) {
                return (net.time4j.tz.p) f39148d.get(0);
            }
            if (j10 < f39150f) {
                return (net.time4j.tz.p) f39148d.get(1);
            }
            if (j10 < f39151g) {
                return (net.time4j.tz.p) f39148d.get(2);
            }
            if (j10 < f39152h) {
                return (net.time4j.tz.p) f39148d.get(3);
            }
            return (net.time4j.tz.p) f39148d.get(4);
        }
    ...
    public enum e implements w {
        ...
        /* renamed from: d  reason: collision with root package name */
        private final transient double f39159d;
    ...
    private static class f implements z {
        ...
        @Override // rt.z
        /* renamed from: i */
        public boolean n(KoreanCalendar koreanCalendar, Integer num) {
            if (num == null) {
                return false;
            }
        ...
        @Override // rt.z
        /* renamed from: j */
        public KoreanCalendar u(KoreanCalendar koreanCalendar, Integer num, boolean z10) {
            if (num != null) {
                if (n(koreanCalendar, num)) {
    ...
    static {
        ...
        rt.p e10 = kVar.e();
        f39141u = e10;
        net.time4j.calendar.e eVar = net.time4j.calendar.e.f39174d;
        f39142v = eVar;
        i C2 = i.C();
        f39143w = C2;
        g gVar = g.f39187d;
        ...
        e eVar4 = e.DAYS;
        h0.b d12 = e11.e(fVar3, X, eVar4).e(fVar4, net.time4j.calendar.f.Z(), eVar4).e(gVar2, new s(k0(), new a()), eVar4).d(rVar, r.K(rVar)).d(net.time4j.calendar.b.f39161a, new n(dVar, fVar4));
        e eVar5 = e.CYCLES;
