...
public final class KoreanCalendar extends net.time4j.calendar.f implements tt.h {
    ...
    private static class SPX implements Externalizable {
        ...
        private transient Object f38287d;
        ...
        private void b(ObjectOutput objectOutput) {
            net.time4j.calendar.f fVar = (net.time4j.calendar.f) this.f38287d;
    ...
    /* loaded from: /home/runner/work/discord-client-datamining/discord-client-datamining/build/classes5.dex */
    public static class a implements st.t {
        a() {
        }

        @Override // st.t
        /* renamed from: a */
        public st.k apply(KoreanCalendar koreanCalendar) {
    ...
    private static class b implements z {
        ...
        @Override // st.z
        /* renamed from: b */
        public st.p a(KoreanCalendar koreanCalendar) {
            throw new AbstractMethodError("Never called.");
        }

        @Override // st.z
        /* renamed from: c */
        public st.p g(KoreanCalendar koreanCalendar) {
            throw new AbstractMethodError("Never called.");
        }

        @Override // st.z
        /* renamed from: d */
        public k h(KoreanCalendar koreanCalendar) {
            return k.DANGI;
        }

        @Override // st.z
        /* renamed from: e */
        public k m(KoreanCalendar koreanCalendar) {
            return k.DANGI;
        }
        ...
        @Override // st.z
        /* renamed from: j */
        public boolean k(KoreanCalendar koreanCalendar, k kVar) {
            if (kVar == k.DANGI) {
                return true;
            }
            return false;
        ...
        @Override // st.z
        /* renamed from: l */
        public KoreanCalendar s(KoreanCalendar koreanCalendar, k kVar, boolean z10) {
            if (k(koreanCalendar, kVar)) {
    ...
    private static class c extends net.time4j.calendar.a {
        ...
        @Override // st.u
        /* renamed from: e */
        public KoreanCalendar i(st.q qVar, st.d dVar, boolean z10, boolean z11) {
            j b10;
            int v10 = qVar.v(net.time4j.calendar.b.f38301a);
            if (v10 == Integer.MIN_VALUE) {
                t tVar = KoreanCalendar.f38282v;
                if (qVar.s(tVar)) {
                    st.p pVar = KoreanCalendar.f38280t;
                    if (qVar.s(pVar)) {
                        b10 = ((net.time4j.calendar.c) qVar.t(tVar)).q(qVar.v(pVar));
                    }
                }
                int v11 = qVar.v(k.DANGI.e());
            ...
            t tVar2 = KoreanCalendar.f38284x;
            if (qVar.s(tVar2)) {
                h hVar = (h) qVar.t(tVar2);
                int v12 = qVar.v(KoreanCalendar.f38286z);
                if (v12 != Integer.MIN_VALUE) {
                    return KoreanCalendar.m0(b10, hVar, v12);
                }
            } else {
                int v13 = qVar.v(KoreanCalendar.A);
                if (v13 != Integer.MIN_VALUE && v13 >= 1) {
                    return (KoreanCalendar) KoreanCalendar.m0(b10, h.f(1), 1).K(v13 - 1, e.DAYS);
                }
            }
            return null;
        }
    ...
    private static class d extends net.time4j.calendar.d {
        ...
        /* renamed from: d  reason: collision with root package name */
        private static final List f38288d;

        /* renamed from: e  reason: collision with root package name */
        private static final long f38289e;

        /* renamed from: f  reason: collision with root package name */
        private static final long f38290f;

        /* renamed from: g  reason: collision with root package name */
        private static final long f38291g;

        /* renamed from: h  reason: collision with root package name */
        private static final long f38292h;
        ...
        static {
            ...
            arrayList.add(net.time4j.tz.p.s(fVar, 8, 30));
            arrayList.add(net.time4j.tz.p.s(fVar, 9, 0));
            f38288d = Collections.unmodifiableList(arrayList);
            f38289e = f0.H0(1908, 4, 1).i();
            f38290f = f0.H0(1912, 1, 1).i();
            f38291g = f0.H0(1954, 3, 21).i();
            f38292h = f0.H0(1961, 8, 10).i();
        }
        ...
        public net.time4j.tz.p i(long j10) {
            if (j10 < f38289e) {
                return (net.time4j.tz.p) f38288d.get(0);
            }
            if (j10 < f38290f) {
                return (net.time4j.tz.p) f38288d.get(1);
            }
            if (j10 < f38291g) {
                return (net.time4j.tz.p) f38288d.get(2);
            }
            if (j10 < f38292h) {
                return (net.time4j.tz.p) f38288d.get(3);
            }
            return (net.time4j.tz.p) f38288d.get(4);
        }
    ...
    public enum e implements w {
        ...
        /* renamed from: d  reason: collision with root package name */
        private final transient double f38299d;
    ...
    private static class f implements z {
        ...
        @Override // st.z
        /* renamed from: f */
        public Integer m(KoreanCalendar koreanCalendar) {
            return 3978;
        }
        ...
        @Override // st.z
        /* renamed from: l */
        public boolean k(KoreanCalendar koreanCalendar, Integer num) {
            if (num == null) {
                return false;
            }
            int intValue = m(koreanCalendar).intValue();
            int intValue2 = h(koreanCalendar).intValue();
        ...
        @Override // st.z
        /* renamed from: o */
        public KoreanCalendar s(KoreanCalendar koreanCalendar, Integer num, boolean z10) {
            if (num != null) {
                if (k(koreanCalendar, num)) {
    ...
    static {
        ...
        st.p e10 = kVar.e();
        f38281u = e10;
        net.time4j.calendar.e eVar = net.time4j.calendar.e.f38314d;
        f38282v = eVar;
        i C2 = i.C();
        f38283w = C2;
        g gVar = g.f38327d;
        ...
        f fVar5 = new f(null);
        e eVar2 = e.YEARS;
        h0.b d11 = d10.e(e10, fVar5, eVar2).e(eVar, net.time4j.calendar.f.g0(gVar), eVar2).d(C2, i.C());
        ...
        e eVar4 = e.DAYS;
        h0.b d12 = e11.e(fVar3, X, eVar4).e(fVar4, net.time4j.calendar.f.Z(), eVar4).e(gVar2, new s(k0(), new a()), eVar4).d(rVar, r.K(rVar)).d(net.time4j.calendar.b.f38301a, new n(dVar, fVar4));
        e eVar5 = e.CYCLES;
