...
public final class KoreanCalendar extends net.time4j.calendar.f implements cu.h {
    ...
    private static class SPX implements Externalizable {
        ...
        private transient Object f37860d;
        ...
        private void b(ObjectOutput objectOutput) {
            net.time4j.calendar.f fVar = (net.time4j.calendar.f) this.f37860d;
    ...
    /* loaded from: /home/runner/work/discord-client-datamining/discord-client-datamining/build/classes5.dex */
    public static class a implements bu.t {
        a() {
        }

        @Override // bu.t
        /* renamed from: a */
        public bu.k apply(KoreanCalendar koreanCalendar) {
    ...
    private static class b implements z {
        ...
        @Override // bu.z
        /* renamed from: b */
        public bu.p a(KoreanCalendar koreanCalendar) {
            throw new AbstractMethodError("Never called.");
        }

        @Override // bu.z
        /* renamed from: c */
        public bu.p h(KoreanCalendar koreanCalendar) {
            throw new AbstractMethodError("Never called.");
        }
        ...
        @Override // bu.z
        /* renamed from: e */
        public k q(KoreanCalendar koreanCalendar) {
            return k.DANGI;
        }
        ...
        @Override // bu.z
        /* renamed from: g */
        public boolean o(KoreanCalendar koreanCalendar, k kVar) {
            if (kVar == k.DANGI) {
                return true;
            }
            return false;
    ...
    private static class c extends net.time4j.calendar.a {
        ...
        @Override // bu.u
        /* renamed from: e */
        public KoreanCalendar h(bu.q qVar, bu.d dVar, boolean z10, boolean z11) {
            j b10;
            int m10 = qVar.m(net.time4j.calendar.b.f37874a);
            if (m10 == Integer.MIN_VALUE) {
                t tVar = KoreanCalendar.f37855v;
                if (qVar.n(tVar)) {
                    bu.p pVar = KoreanCalendar.f37853t;
                    if (qVar.n(pVar)) {
                        b10 = ((net.time4j.calendar.c) qVar.k(tVar)).q(qVar.m(pVar));
                    }
                }
                int m11 = qVar.m(k.DANGI.e());
            ...
            t tVar2 = KoreanCalendar.f37857x;
            if (qVar.n(tVar2)) {
                h hVar = (h) qVar.k(tVar2);
                int m12 = qVar.m(KoreanCalendar.f37859z);
                if (m12 != Integer.MIN_VALUE) {
                    return KoreanCalendar.m0(b10, hVar, m12);
                }
            } else {
                int m13 = qVar.m(KoreanCalendar.A);
                if (m13 != Integer.MIN_VALUE && m13 >= 1) {
                    return (KoreanCalendar) KoreanCalendar.m0(b10, h.f(1), 1).K(m13 - 1, e.DAYS);
                }
            }
            return null;
        }
    ...
    private static class d extends net.time4j.calendar.d {
        ...
        /* renamed from: d  reason: collision with root package name */
        private static final List f37861d;

        /* renamed from: e  reason: collision with root package name */
        private static final long f37862e;

        /* renamed from: f  reason: collision with root package name */
        private static final long f37863f;

        /* renamed from: g  reason: collision with root package name */
        private static final long f37864g;

        /* renamed from: h  reason: collision with root package name */
        private static final long f37865h;
        ...
        static {
            ...
            arrayList.add(net.time4j.tz.p.s(fVar, 8, 30));
            arrayList.add(net.time4j.tz.p.s(fVar, 9, 0));
            f37861d = Collections.unmodifiableList(arrayList);
            f37862e = f0.H0(1908, 4, 1).i();
            f37863f = f0.H0(1912, 1, 1).i();
            f37864g = f0.H0(1954, 3, 21).i();
            f37865h = f0.H0(1961, 8, 10).i();
        }
        ...
        public net.time4j.tz.p i(long j10) {
            if (j10 < f37862e) {
                return (net.time4j.tz.p) f37861d.get(0);
            }
            if (j10 < f37863f) {
                return (net.time4j.tz.p) f37861d.get(1);
            }
            if (j10 < f37864g) {
                return (net.time4j.tz.p) f37861d.get(2);
            }
            if (j10 < f37865h) {
                return (net.time4j.tz.p) f37861d.get(3);
            }
            return (net.time4j.tz.p) f37861d.get(4);
        }
    ...
    public enum e implements w {
        ...
        /* renamed from: d  reason: collision with root package name */
        private final transient double f37872d;
    ...
    private static class f implements z {
        ...
        @Override // bu.z
        /* renamed from: f */
        public Integer q(KoreanCalendar koreanCalendar) {
            return 3978;
        }
        ...
        @Override // bu.z
        /* renamed from: i */
        public boolean o(KoreanCalendar koreanCalendar, Integer num) {
            if (num == null) {
                return false;
            }
            int intValue = q(koreanCalendar).intValue();
            int intValue2 = m(koreanCalendar).intValue();
    ...
    static {
        ...
        bu.p e10 = kVar.e();
        f37854u = e10;
        net.time4j.calendar.e eVar = net.time4j.calendar.e.f37887d;
        f37855v = eVar;
        i D2 = i.D();
        f37856w = D2;
        g gVar = g.f37900d;
        ...
        e eVar4 = e.DAYS;
        h0.b d12 = e11.e(fVar3, X, eVar4).e(fVar4, net.time4j.calendar.f.Z(), eVar4).e(gVar2, new s(k0(), new a()), eVar4).d(rVar, r.K(rVar)).d(net.time4j.calendar.b.f37874a, new n(dVar, fVar4));
        e eVar5 = e.CYCLES;
