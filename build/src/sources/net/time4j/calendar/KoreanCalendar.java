...
public final class KoreanCalendar extends net.time4j.calendar.f implements st.h {
    ...
    private static class SPX implements Externalizable {
        ...
        private transient Object f39195d;
        ...
        private void b(ObjectOutput objectOutput) {
            net.time4j.calendar.f fVar = (net.time4j.calendar.f) this.f39195d;
    ...
    private static class c extends net.time4j.calendar.a {
        ...
        public KoreanCalendar l(rt.q qVar, rt.d dVar, boolean z10, boolean z11) {
            j b10;
            int q10 = qVar.q(net.time4j.calendar.b.f39209a);
            if (q10 == Integer.MIN_VALUE) {
                t tVar = KoreanCalendar.f39190v;
                if (qVar.n(tVar)) {
                    rt.p pVar = KoreanCalendar.f39188t;
                    if (qVar.n(pVar)) {
            ...
            t tVar2 = KoreanCalendar.f39192x;
            if (qVar.n(tVar2)) {
                h hVar = (h) qVar.s(tVar2);
                int q12 = qVar.q(KoreanCalendar.f39194z);
    ...
    private static class d extends net.time4j.calendar.d {
        ...
        /* renamed from: d  reason: collision with root package name */
        private static final List f39196d;

        /* renamed from: e  reason: collision with root package name */
        private static final long f39197e;

        /* renamed from: f  reason: collision with root package name */
        private static final long f39198f;

        /* renamed from: g  reason: collision with root package name */
        private static final long f39199g;

        /* renamed from: h  reason: collision with root package name */
        private static final long f39200h;
        ...
        static {
            ...
            arrayList.add(net.time4j.tz.p.s(fVar, 8, 30));
            arrayList.add(net.time4j.tz.p.s(fVar, 9, 0));
            f39196d = Collections.unmodifiableList(arrayList);
            f39197e = f0.H0(1908, 4, 1).i();
            f39198f = f0.H0(1912, 1, 1).i();
            f39199g = f0.H0(1954, 3, 21).i();
            f39200h = f0.H0(1961, 8, 10).i();
        }
        ...
        public net.time4j.tz.p i(long j10) {
            if (j10 < f39197e) {
                return (net.time4j.tz.p) f39196d.get(0);
            }
            if (j10 < f39198f) {
                return (net.time4j.tz.p) f39196d.get(1);
            }
            if (j10 < f39199g) {
                return (net.time4j.tz.p) f39196d.get(2);
            }
            if (j10 < f39200h) {
                return (net.time4j.tz.p) f39196d.get(3);
            }
            return (net.time4j.tz.p) f39196d.get(4);
        }
    ...
    public enum e implements w {
        ...
        /* renamed from: d  reason: collision with root package name */
        private final transient double f39207d;
    ...
    static {
        ...
        rt.p e10 = kVar.e();
        f39189u = e10;
        net.time4j.calendar.e eVar = net.time4j.calendar.e.f39222d;
        f39190v = eVar;
        i C2 = i.C();
        f39191w = C2;
        g gVar = g.f39235d;
        ...
        e eVar4 = e.DAYS;
        h0.b d12 = e11.e(fVar3, X, eVar4).e(fVar4, net.time4j.calendar.f.Z(), eVar4).e(gVar2, new s(k0(), new a()), eVar4).d(rVar, r.K(rVar)).d(net.time4j.calendar.b.f39209a, new n(dVar, fVar4));
        e eVar5 = e.CYCLES;
