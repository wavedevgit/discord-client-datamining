...
final class n implements z {
    ...
    private final Map f37342d;

    /* renamed from: e  reason: collision with root package name */
    private final bu.p f37343e;

    /* JADX INFO: Access modifiers changed from: package-private */
    public n(bu.k kVar, bu.p pVar) {
        this.f37342d = Collections.singletonMap("calendrical", kVar);
        this.f37343e = pVar;
    }

    private bu.k b(bu.q qVar) {
        return (bu.k) this.f37342d.get("calendrical");
    }
    ...
    public Integer m(bu.q qVar) {
        bu.k b10 = b(qVar);
        return j(b10.c(((bu.q) b10.b(b10.a())).C(this.f37343e, 1)));
    }
    ...
    public Integer q(bu.q qVar) {
        bu.k b10 = b(qVar);
        return j(b10.c(((bu.q) b10.b(b10.d())).C(this.f37343e, 1)));
    }

    @Override // bu.z
    /* renamed from: g */
    public Integer y(bu.q qVar) {
        return j(b(qVar).c(qVar.C(this.f37343e, 1)));
    }
