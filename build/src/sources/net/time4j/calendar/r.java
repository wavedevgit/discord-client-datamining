...
public final class r extends net.time4j.calendar.service.f implements l {
    ...
    private final transient jt.p f40522s;

    /* renamed from: t  reason: collision with root package name */
    private final transient jt.p f40523t;
    ...
    private static class a implements c0 {
        ...
        private int e(jt.q qVar) {
            int q10 = qVar.q(this.f40524d.f40522s);
            while (true) {
                int i10 = q10 + 7;
                if (i10 <= ((Integer) qVar.i(this.f40524d.f40522s)).intValue()) {
                    q10 = i10;
                } else {
        ...
        public int v(jt.q qVar) {
            return gt.c.a(qVar.q(this.f40524d.f40522s) - 1, 7) + 1;
        }
        ...
        public jt.q k(jt.q qVar, int i10, boolean z10) {
            if (m(qVar, i10)) {
                return qVar.F(this.f40524d.L(i10, (y0) qVar.p(this.f40524d.f40523t)));
            }
    ...
    public static class b implements v {
        ...
        /* renamed from: d  reason: collision with root package name */
        private final r f40525d;

        /* renamed from: e  reason: collision with root package name */
        private final long f40526e;

        /* renamed from: i  reason: collision with root package name */
        private final y0 f40527i;
        ...
        public jt.q apply(jt.q qVar) {
            int d10;
            long a10;
            y0 y0Var = (y0) qVar.p(this.f40525d.f40523t);
            int q10 = qVar.q(this.f40525d.f40522s);
            if (this.f40526e == 2147483647L) {
                int intValue = ((Integer) qVar.i(this.f40525d.f40522s)).intValue() - q10;
                int d11 = y0Var.d() + (intValue % 7);
                if (d11 > 7) {
                    d11 -= 7;
                }
                int d12 = this.f40527i.d() - d11;
                a10 = intValue + d12;
                if (d12 > 0) {
                    a10 -= 7;
                }
            } else {
                a10 = ((this.f40526e - (gt.c.a((q10 + d10) - 1, 7) + 1)) * 7) + (this.f40527i.d() - y0Var.d());
            }
