...
public abstract class d implements bu.k {
    ...
    private static final long f37315a = f0.H0(1645, 1, 28).i();

    /* renamed from: b  reason: collision with root package name */
    private static final long f37316b = f0.H0(3000, 1, 27).i();

    /* renamed from: c  reason: collision with root package name */
    private static final long f37317c = f0.H0(-2636, 2, 15).i();
    ...
    private long o(long j10) {
        return au.d.NEW_MOON.e(n(j10)).t0(i(j10)).f0().i();
    }
    ...
    private long w(long j10) {
        ...
        au.b bVar = au.b.WINTER_SOLSTICE;
    ...
    final boolean k(long j10) {
        if ((((int) Math.floor(p.o(au.c.g(n(j10)).c()) / 30.0d)) + 2) % 12 == (((int) Math.floor(p.o(au.c.g(n(p(j10 + 1))).c()) / 30.0d)) + 2) % 12) {
            return true;
        }
        return false;
    }
    ...
    public final long p(long j10) {
        return au.d.NEW_MOON.d(n(j10)).t0(i(j10)).f0().i();
    }

    /* JADX INFO: Access modifiers changed from: package-private */
    public final long q(int i10, int i11) {
        return s((long) Math.floor(f37317c + (((((i10 - 1) * 60) + i11) - 0.5d) * 365.242189d)));
    }
    ...
    public final f b(long j10) {
        ...
        int i10 = 12;
        int d10 = zt.c.d(m10, 12);
        if (d10 != 0) {
            i10 = d10;
        }
        long floor = (long) Math.floor((1.5d - (i10 / 12.0d)) + ((j10 - f37317c) / 365.242189d));
        int i11 = 60;
