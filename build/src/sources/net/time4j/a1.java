...
public final class a1 implements Serializable {
    ...
    private static final Map f40357w = new ConcurrentHashMap();

    /* renamed from: x  reason: collision with root package name */
    public static final a1 f40358x = new a1(y0.MONDAY, 4, y0.SATURDAY, y0.SUNDAY);

    /* renamed from: y  reason: collision with root package name */
    private static final kt.y f40359y;

    /* renamed from: d  reason: collision with root package name */
    private final transient y0 f40360d;

    /* renamed from: e  reason: collision with root package name */
    private final transient int f40361e;

    /* renamed from: i  reason: collision with root package name */
    private final transient y0 f40362i;

    /* renamed from: o  reason: collision with root package name */
    private final transient y0 f40363o;

    /* renamed from: p  reason: collision with root package name */
    private final transient net.time4j.c f40364p;

    /* renamed from: q  reason: collision with root package name */
    private final transient net.time4j.c f40365q;

    /* renamed from: r  reason: collision with root package name */
    private final transient net.time4j.c f40366r;

    /* renamed from: s  reason: collision with root package name */
    private final transient net.time4j.c f40367s;

    /* renamed from: t  reason: collision with root package name */
    private final transient c0 f40368t;

    /* renamed from: u  reason: collision with root package name */
    private final transient Set f40369u;

    /* renamed from: v  reason: collision with root package name */
    private final transient jt.n f40370v;

    /* loaded from: /home/runner/work/discord-client-datamining/discord-client-datamining/build/classes5.dex */
    class a implements jt.n {

        /* renamed from: d  reason: collision with root package name */
        final /* synthetic */ y0 f40371d;

        /* renamed from: e  reason: collision with root package name */
        final /* synthetic */ y0 f40372e;
        ...
        public boolean test(gt.a aVar) {
            ...
            if (h10 != this.f40371d && h10 != this.f40372e) {
                return false;
            }
            return true;
        }
    ...
    private static class b implements jt.z {
        ...
        private jt.p b(jt.q qVar, boolean z10) {
            int i10;
            f0 f0Var = (f0) qVar.p(f0.f40588y);
            c0 i11 = this.f40374d.K().i();
        ...
        private int q(f0 f0Var, int i10) {
            ...
            int e10 = a1.c((f0Var.C0() - g10) + 1).e(this.f40374d.K());
            if (e10 <= 8 - this.f40374d.K().g()) {
                i11 = 2 - e10;
            } else {
                i11 = 9 - e10;
            }
        ...
        public Integer j(jt.q qVar) {
            return Integer.valueOf(f((f0) qVar.p(f0.f40588y)));
        }

        @Override // jt.z
        /* renamed from: m */
        public Integer p(jt.q qVar) {
            return Integer.valueOf(i((f0) qVar.p(f0.f40588y)));
        }

        @Override // jt.z
        /* renamed from: n */
        public Integer x(jt.q qVar) {
            return Integer.valueOf(o((f0) qVar.p(f0.f40588y)));
        }
    ...
    private static class c implements jt.z {
        ...
        private int b(f0 f0Var) {
            ...
            if (f10 <= g10) {
                int i10 = ((g10 - f10) / 7) + 1;
                if ((i10 >= 53 || (!this.f40375d.M() && i10 >= 5)) && f(f0Var, 1) + g(f0Var, 0) <= g10) {
                    return 1;
                }
                return i10;
            }
        ...
        /* renamed from: o */
        public Integer x(jt.q qVar) {
            return Integer.valueOf(b((f0) qVar.p(f0.f40588y)));
        }
        ...
        public boolean l(jt.q qVar, Integer num) {
            ...
            int intValue = num.intValue();
            if (this.f40375d.M() && intValue >= 1 && intValue <= 52) {
                return true;
            }
            if (this.f40375d.M() && intValue != 53) {
                return false;
            }
            f0 f0Var = (f0) qVar.p(f0.f40588y);
    ...
    private static class e implements jt.z {
        ...
        public y0 j(jt.q qVar) {
            f0 f0Var = (f0) qVar.p(f0.f40588y);
            if ((f0Var.j() + 7) - f0Var.A0().e(this.f40376d.K()) > f0.r0().n().a()) {
                return y0.FRIDAY;
            }
            return this.f40376d.e();
        }
        ...
        public y0 p(jt.q qVar) {
            f0 f0Var = (f0) qVar.p(f0.f40588y);
            if ((f0Var.j() + 1) - f0Var.A0().e(this.f40376d.K()) < f0.r0().n().d()) {
                return y0.MONDAY;
            }
            return this.f40376d.A();
        }

        @Override // jt.z
        /* renamed from: g */
        public y0 x(jt.q qVar) {
            return ((f0) qVar.p(f0.f40588y)).A0();
        }
        ...
        public jt.q w(jt.q qVar, y0 y0Var, boolean z10) {
            if (y0Var != null) {
                ...
                return qVar.E(pVar, f0Var.S0((C0 + y0Var.e(this.f40376d.K())) - c10.e(this.f40376d.K())));
            }
    ...
    public class f extends net.time4j.a implements c0, kt.l, kt.t {
        ...
        private kt.s H(jt.d dVar, kt.m mVar) {
            return kt.b.d((Locale) dVar.b(kt.a.f36546c, Locale.ROOT)).p((kt.v) dVar.b(kt.a.f36550g, kt.v.WIDE), mVar);
        }
        ...
        public y0 z(CharSequence charSequence, ParsePosition parsePosition, jt.d dVar) {
            ...
            if (y0Var == null && ((Boolean) dVar.b(kt.a.f36554k, Boolean.TRUE)).booleanValue()) {
        ...
        public void u(jt.o oVar, Appendable appendable, jt.d dVar) {
            appendable.append(H(dVar, (kt.m) dVar.b(kt.a.f36551h, kt.m.FORMAT)).f((Enum) oVar.p(this)));
        }
            ...
            if (i10 >= 1 && i10 <= 7) {
                if (y0Var2 != null) {
                    if (y0Var3 != null) {
                        ...
                        f fVar = new f();
                        this.f40368t = fVar;
                        this.f40370v = new a(y0Var2, y0Var3);
                        ...
                        hashSet.add(dVar3);
                        hashSet.add(dVar4);
                        this.f40369u = Collections.unmodifiableSet(hashSet);
                        return;
                    }
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof a1) {
            a1 a1Var = (a1) obj;
            if (this.f40360d == a1Var.f40360d && this.f40361e == a1Var.f40361e && this.f40362i == a1Var.f40362i && this.f40363o == a1Var.f40363o) {
                return true;
            }
        }
        return false;
    ...
    public int hashCode() {
        return (this.f40360d.name().hashCode() * 17) + (this.f40361e * 37);
    }
