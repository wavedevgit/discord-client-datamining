...
public final class a1 implements Serializable {
    ...
    private static final Map f37787w = new ConcurrentHashMap();

    /* renamed from: x  reason: collision with root package name */
    public static final a1 f37788x = new a1(y0.MONDAY, 4, y0.SATURDAY, y0.SUNDAY);

    /* renamed from: y  reason: collision with root package name */
    private static final cu.y f37789y;

    /* renamed from: d  reason: collision with root package name */
    private final transient y0 f37790d;

    /* renamed from: e  reason: collision with root package name */
    private final transient int f37791e;

    /* renamed from: i  reason: collision with root package name */
    private final transient y0 f37792i;

    /* renamed from: o  reason: collision with root package name */
    private final transient y0 f37793o;

    /* renamed from: p  reason: collision with root package name */
    private final transient net.time4j.c f37794p;

    /* renamed from: q  reason: collision with root package name */
    private final transient net.time4j.c f37795q;

    /* renamed from: r  reason: collision with root package name */
    private final transient net.time4j.c f37796r;

    /* renamed from: s  reason: collision with root package name */
    private final transient net.time4j.c f37797s;

    /* renamed from: t  reason: collision with root package name */
    private final transient c0 f37798t;

    /* renamed from: u  reason: collision with root package name */
    private final transient Set f37799u;

    /* renamed from: v  reason: collision with root package name */
    private final transient bu.n f37800v;

    /* loaded from: /home/runner/work/discord-client-datamining/discord-client-datamining/build/classes5.dex */
    class a implements bu.n {

        /* renamed from: d  reason: collision with root package name */
        final /* synthetic */ y0 f37801d;

        /* renamed from: e  reason: collision with root package name */
        final /* synthetic */ y0 f37802e;
        ...
        public boolean test(zt.a aVar) {
            ...
            if (h10 != this.f37801d && h10 != this.f37802e) {
                return false;
            }
            return true;
        }
    ...
    private static class b implements bu.z {
        ...
        private bu.p b(bu.q qVar, boolean z10) {
            int i10;
            f0 f0Var = (f0) qVar.k(f0.f38018y);
            c0 i11 = this.f37804d.K().i();
        ...
        private int p(f0 f0Var, int i10) {
            ...
            int e10 = a1.c((f0Var.C0() - g10) + 1).e(this.f37804d.K());
            if (e10 <= 8 - this.f37804d.K().g()) {
                i11 = 2 - e10;
            } else {
                i11 = 9 - e10;
            }
        ...
        public Integer m(bu.q qVar) {
            return Integer.valueOf(f((f0) qVar.k(f0.f38018y)));
        }

        @Override // bu.z
        /* renamed from: j */
        public Integer q(bu.q qVar) {
            return Integer.valueOf(i((f0) qVar.k(f0.f38018y)));
        }

        @Override // bu.z
        /* renamed from: k */
        public Integer y(bu.q qVar) {
            return Integer.valueOf(l((f0) qVar.k(f0.f38018y)));
        }
    ...
    private static class c implements bu.z {
        ...
        private int b(f0 f0Var) {
            ...
            if (f10 <= g10) {
                int i10 = ((g10 - f10) / 7) + 1;
                if ((i10 >= 53 || (!this.f37805d.M() && i10 >= 5)) && f(f0Var, 1) + g(f0Var, 0) <= g10) {
                    return 1;
                }
                return i10;
            }
        ...
        /* renamed from: l */
        public Integer y(bu.q qVar) {
            return Integer.valueOf(b((f0) qVar.k(f0.f38018y)));
        }
        ...
        public boolean o(bu.q qVar, Integer num) {
            ...
            int intValue = num.intValue();
            if (this.f37805d.M() && intValue >= 1 && intValue <= 52) {
                return true;
            }
            if (this.f37805d.M() && intValue != 53) {
                return false;
            }
            f0 f0Var = (f0) qVar.k(f0.f38018y);
    ...
    private static class e implements bu.z {
        ...
        public y0 m(bu.q qVar) {
            f0 f0Var = (f0) qVar.k(f0.f38018y);
            if ((f0Var.i() + 7) - f0Var.A0().e(this.f37806d.K()) > f0.r0().p().a()) {
                return y0.FRIDAY;
            }
            return this.f37806d.f();
        }
        ...
        public y0 q(bu.q qVar) {
            f0 f0Var = (f0) qVar.k(f0.f38018y);
            if ((f0Var.i() + 1) - f0Var.A0().e(this.f37806d.K()) < f0.r0().p().d()) {
                return y0.MONDAY;
            }
            return this.f37806d.B();
        }

        @Override // bu.z
        /* renamed from: g */
        public y0 y(bu.q qVar) {
            return ((f0) qVar.k(f0.f38018y)).A0();
        }
        ...
        public bu.q x(bu.q qVar, y0 y0Var, boolean z10) {
            if (y0Var != null) {
                ...
                return qVar.E(pVar, f0Var.S0((C0 + y0Var.e(this.f37806d.K())) - c10.e(this.f37806d.K())));
            }
            ...
            if (i10 >= 1 && i10 <= 7) {
                if (y0Var2 != null) {
                    if (y0Var3 != null) {
                        ...
                        f fVar = new f();
                        this.f37798t = fVar;
                        this.f37800v = new a(y0Var2, y0Var3);
                        ...
                        hashSet.add(dVar3);
                        hashSet.add(dVar4);
                        this.f37799u = Collections.unmodifiableSet(hashSet);
                        return;
                    }
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof a1) {
            a1 a1Var = (a1) obj;
            if (this.f37790d == a1Var.f37790d && this.f37791e == a1Var.f37791e && this.f37792i == a1Var.f37792i && this.f37793o == a1Var.f37793o) {
                return true;
            }
        }
        return false;
    ...
    public int hashCode() {
        return (this.f37790d.name().hashCode() * 17) + (this.f37791e * 37);
    }
