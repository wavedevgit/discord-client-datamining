...
public final class a0 extends bu.k0 implements iu.g {
    ...
    private static final long f37195i;

    /* renamed from: o  reason: collision with root package name */
    private static final long f37196o;

    /* renamed from: p  reason: collision with root package name */
    private static final a0 f37197p;

    /* renamed from: q  reason: collision with root package name */
    private static final a0 f37198q;

    /* renamed from: r  reason: collision with root package name */
    private static final a0 f37199r;

    /* renamed from: s  reason: collision with root package name */
    private static final Set f37200s;
    private static final long serialVersionUID = -3192884724477742274L;

    /* renamed from: t  reason: collision with root package name */
    private static final Map f37201t;

    /* renamed from: u  reason: collision with root package name */
    private static final Map f37202u;

    /* renamed from: v  reason: collision with root package name */
    private static final bu.h0 f37203v;

    /* renamed from: w  reason: collision with root package name */
    public static final a0 f37204w;

    /* renamed from: x  reason: collision with root package name */
    public static final bu.p f37205x;

    /* renamed from: y  reason: collision with root package name */
    public static final bu.p f37206y;

    /* renamed from: z  reason: collision with root package name */
    public static final bu.p f37207z;

    /* renamed from: d  reason: collision with root package name */
    private final transient long f37208d;

    /* renamed from: e  reason: collision with root package name */
    private final transient int f37209e;
    ...
    public static /* synthetic */ class a {
        ...
        static final /* synthetic */ int[] f37211b;

        /* renamed from: c  reason: collision with root package name */
        static final /* synthetic */ int[] f37212c;
        ...
        static {
            ...
            try {
                f37212c[TimeUnit.HOURS.ordinal()] = 2;
            } catch (NoSuchFieldError unused2) {
            }
            try {
                f37212c[TimeUnit.MINUTES.ordinal()] = 3;
            } catch (NoSuchFieldError unused3) {
            }
            try {
                f37212c[TimeUnit.SECONDS.ordinal()] = 4;
            } catch (NoSuchFieldError unused4) {
            }
            try {
                f37212c[TimeUnit.MILLISECONDS.ordinal()] = 5;
            } catch (NoSuchFieldError unused5) {
            }
            try {
                f37212c[TimeUnit.MICROSECONDS.ordinal()] = 6;
            } catch (NoSuchFieldError unused6) {
            }
            try {
                f37212c[TimeUnit.NANOSECONDS.ordinal()] = 7;
            ...
            try {
                f37211b[o0.NANOSECONDS.ordinal()] = 2;
            ...
            try {
                f37210a[iu.f.UTC.ordinal()] = 2;
            } catch (NoSuchFieldError unused11) {
            }
            try {
                f37210a[iu.f.TAI.ordinal()] = 3;
            } catch (NoSuchFieldError unused12) {
            }
            try {
                f37210a[iu.f.GPS.ordinal()] = 4;
            } catch (NoSuchFieldError unused13) {
            }
            try {
                f37210a[iu.f.TT.ordinal()] = 5;
            } catch (NoSuchFieldError unused14) {
            }
            try {
                f37210a[iu.f.UT.ordinal()] = 6;
    ...
    public enum d implements bu.p, bu.z {
        ...
        /* renamed from: F */
        public Long f() {
            return Long.valueOf(a0.f37196o);
        }

        @Override // bu.p
        /* renamed from: G */
        public Long B() {
            return Long.valueOf(a0.f37195i);
        }
        ...
        public boolean o(a0 a0Var, Long l10) {
            ...
            if (longValue < a0.f37195i || longValue > a0.f37196o) {
                return false;
            }
            return true;
        }
    ...
    private static class e implements bu.u {
        ...
        public a0 h(bu.q qVar, bu.d dVar, boolean z10, boolean z11) {
            ...
            net.time4j.tz.p B;
            a0 a0Var2;
            iu.f fVar = (iu.f) dVar.b(cu.a.f21130w, iu.f.UTC);
            ...
            if (kVar != null) {
                ...
                if (qVar.n(b0Var)) {
                    a0Var = i0Var.Y(net.time4j.tz.l.N(kVar).Q(((net.time4j.tz.o) dVar.b(cu.a.f21112e, net.time4j.tz.l.f37723o)).a(((Boolean) qVar.k(b0Var)).booleanValue() ? net.time4j.tz.g.EARLIER_OFFSET : net.time4j.tz.g.LATER_OFFSET)));
                } else {
                    bu.c cVar3 = cu.a.f21112e;
                    if (dVar.a(cVar3)) {
        ...
        public bu.o m(a0 a0Var, bu.d dVar) {
            ...
            if (dVar.a(cVar)) {
                return a0Var.v0((iu.f) dVar.b(cu.a.f21130w, iu.f.UTC)).h0((net.time4j.tz.k) dVar.c(cVar));
            }
    ...
    private static class g implements bu.z {
        ...
        public a0 x(a0 a0Var, TimeUnit timeUnit, boolean z10) {
            a0 l02;
            if (timeUnit != null) {
                switch (a.f37212c[timeUnit.ordinal()]) {
                    case 1:
                        return a0.m0(zt.c.b(a0Var.f37208d, 86400) * 86400, iu.f.POSIX);
                    case 2:
                        return a0.m0(zt.c.b(a0Var.f37208d, 3600) * 3600, iu.f.POSIX);
                    case 3:
                        return a0.m0(zt.c.b(a0Var.f37208d, 60) * 60, iu.f.POSIX);
                    case 4:
                        l02 = a0.l0(a0Var.f37208d, 0, iu.f.POSIX);
                        break;
                    case 5:
                        l02 = a0.l0(a0Var.f37208d, (a0Var.a() / 1000000) * 1000000, iu.f.POSIX);
                        break;
                    case 6:
                        l02 = a0.l0(a0Var.f37208d, (a0Var.a() / 1000) * 1000, iu.f.POSIX);
                        break;
                    case 7:
                        return a0Var;
                    default:
    ...
    private static class h implements bu.m0 {
        ...
        /* renamed from: a  reason: collision with root package name */
        private final TimeUnit f37217a;

        h(TimeUnit timeUnit) {
            this.f37217a = timeUnit;
        }

        @Override // bu.m0
        /* renamed from: c */
        public a0 b(a0 a0Var, long j10) {
            if (this.f37217a.compareTo(TimeUnit.SECONDS) >= 0) {
                return a0.l0(zt.c.f(a0Var.o(), zt.c.i(j10, this.f37217a.toSeconds(1L))), a0Var.a(), iu.f.POSIX);
            }
            long f10 = zt.c.f(a0Var.a(), zt.c.i(j10, this.f37217a.toNanos(1L)));
        ...
        public long a(a0 a0Var, a0 a0Var2) {
            ...
            switch (a.f37212c[this.f37217a.ordinal()]) {
                case 1:
                    return f10 / 86400;
                case 2:
                    return f10 / 3600;
                ...
                case 6:
                    return f10 / 1000;
                default:
                    throw new UnsupportedOperationException(this.f37217a.name());
            }
        }
    }
    ...
    static {
        ...
        f37198q = a0Var4;
        f37199r = new a0(63158400L, 0, fVar);
        ...
        hashSet.add(g0.H);
        hashSet.add(g0.I);
        f37200s = Collections.unmodifiableSet(hashSet);
        ...
        f37201t = Collections.unmodifiableMap(hashMap);
        ...
        f37202u = Collections.unmodifiableMap(enumMap);
        ...
        bu.p pVar = j0.f37592p;
        k10.d(pVar, new g(null));
        f37203v = k10.l(new b(null)).h();
        f37204w = new a0(0L, 0, iu.f.POSIX);
        f37205x = dVar;
        f37206y = cVar;
        f37207z = pVar;
        A = new f(null);
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public f0 c0() {
        return f0.M0(zt.c.b(this.f37208d, 86400), bu.a0.UNIX);
    }

    private long d0() {
        if (iu.d.x().G()) {
            long j10 = iu.d.x().j(this.f37208d);
            if (k0()) {
                return j10 + 1;
            }
            return j10;
        }
        return this.f37208d - 63072000;
    }
    ...
    private static int f0(a0 a0Var) {
        return zt.c.d(a0Var.f37208d, 86400);
    }
    ...
    public static a0 o0(DataInput dataInput, boolean z10, boolean z11) {
        ...
        if (readLong == f37195i && i10 == 0) {
            if (!z10) {
                return f37197p;
            }
            throw new InvalidObjectException("Minimum is no leap second.");
        } else if (readLong == f37196o && i10 == 999999999) {
            if (!z10) {
                return f37198q;
            }
    ...
    public a0 u0(iu.f fVar) {
        if (fVar != iu.f.UTC) {
            if (!j0()) {
                int i10 = a.f37210a[fVar.ordinal()];
                if (i10 != 1) {
                    if (i10 != 3) {
                        if (i10 != 4) {
                            if (i10 != 5 && i10 != 6) {
                            ...
                            return new a0(zt.c.m(this.f37208d, 63072000L), a(), fVar);
                        }
                        return new a0(zt.c.m(this.f37208d, 315964800L), a(), fVar);
                    }
                    return new a0(zt.c.m(this.f37208d, -378691200L), a(), fVar);
                }
            } else {
    ...
    public a0 v0(iu.f fVar) {
        switch (a.f37210a[fVar.ordinal()]) {
            case 1:
                if (j0()) {
                    return new a0(a(), this.f37208d);
                }
                break;
            case 2:
                break;
    ...
    @Override // zt.f
    public int a() {
        return this.f37209e & (-1073741825);
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof a0) {
            a0 a0Var = (a0) obj;
            if (this.f37208d != a0Var.f37208d) {
                return false;
            }
            if (iu.d.x().G()) {
                if (this.f37209e == a0Var.f37209e) {
                    return true;
                }
                return false;
            } else if (a() == a0Var.a()) {
    ...
    public a0 n0(long j10, o0 o0Var) {
        ...
        try {
            int i11 = a.f37211b[o0Var.ordinal()];
            if (i11 != 1) {
                if (i11 == 2) {
                    ...
                    if (iu.d.x().G()) {
                        ...
                        l02 = l0(zt.c.f(this.f37208d, b10), d10, iu.f.POSIX);
                    }
                } else {
                ...
                l02 = l0(zt.c.f(this.f37208d, j10), a(), iu.f.POSIX);
            }
            if (i10 < 0) {
                U(l02);
            }
    ...
    public r p0(bu.j jVar, String str, net.time4j.tz.k kVar, bu.f0 f0Var) {
        i0 t02 = t0(kVar);
        t02.X();
        ((i0) t02.J(f0Var.b(t02.V(), kVar), net.time4j.g.f37467i)).V();
        throw null;
    }

    public r q0(bu.x xVar, net.time4j.tz.k kVar, bu.f0 f0Var) {
        i0 t02 = t0(kVar);
        return r.b(((i0) t02.J(f0Var.b(t02.V(), kVar), net.time4j.g.f37467i)).V().S(xVar.q()), t02.X());
    }
    ...
    public long s(iu.f fVar) {
        ...
        switch (a.f37210a[fVar.ordinal()]) {
            ...
            case 3:
                if (d0() < 0) {
                    double e10 = iu.f.e(c0()) + (this.f37208d - 63072000) + (a() / 1.0E9d);
            ...
            case 5:
                if (this.f37208d < 63072000) {
                    double e11 = iu.f.e(c0()) + (this.f37208d - 63072000) + (a() / 1.0E9d);
    ...
    public void w0(DataOutput dataOutput) {
        ...
        dataOutput.writeLong(this.f37208d);
        if (a10 > 0) {
        ...
        if (fVar == iu.f.POSIX) {
            ...
            if (x10.G()) {
                if (fVar == iu.f.UTC) {
                    ...
                    j12 = floor - x10.j(K);
                    this.f37208d = K;
                    if (j12 != j11 || K == f37196o) {
                        this.f37209e = r02;
                    } else if (j12 == 1) {
                        this.f37209e = 1073741824 | r02;
                    } else {
