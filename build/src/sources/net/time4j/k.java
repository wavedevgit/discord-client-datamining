...
public final class k {
    ...
    private static final SortedMap f40598d;

    /* renamed from: e  reason: collision with root package name */
    private static k f40599e;

    /* renamed from: f  reason: collision with root package name */
    private static final kt.c f40600f;

    /* renamed from: a  reason: collision with root package name */
    private final transient Locale f40601a;

    /* renamed from: b  reason: collision with root package name */
    private final transient String f40602b;

    /* renamed from: c  reason: collision with root package name */
    private final transient SortedMap f40603c;
    ...
    /* loaded from: /home/runner/work/discord-client-datamining/discord-client-datamining/build/classes5.dex */
    static class b extends kt.e implements lt.t, kt.z {
        private static final long serialVersionUID = 5589976208326940032L;

        /* renamed from: d  reason: collision with root package name */
        private final transient boolean f40605d;

        /* renamed from: e  reason: collision with root package name */
        private final transient k f40606e;
        ...
        private String T(CharSequence charSequence, ParsePosition parsePosition, kt.d dVar, lt.m mVar) {
            String str;
            Map map;
            String str2;
            String str3;
            ...
            if (this.f40605d) {
                ...
                arrayList.addAll(new LinkedHashSet(this.f40606e.f40603c.values()));
                if (this.f40606e.p()) {
                    arrayList.add("midnight");
                    arrayList.add("noon");
                }
            }
            Map q10 = this.f40606e.p() ? k.q(M(), G()) : null;
        ...
        public String e() {
            if (!this.f40605d) {
                return (String) this.f40606e.f40603c.get((g0) this.f40606e.f40603c.lastKey());
            }
            return "pm";
        }
        ...
        public String A() {
            if (!this.f40605d) {
                return (String) this.f40606e.f40603c.get((g0) this.f40606e.f40603c.firstKey());
            }
            return "am";
        }
        ...
        /* JADX INFO: Access modifiers changed from: package-private */
        public Locale M() {
            return this.f40606e.f40601a;
        }

        @Override // kt.z
        /* renamed from: N */
        public String h(kt.q qVar) {
            return e();
        }

        @Override // kt.z
        /* renamed from: O */
        public String o(kt.q qVar) {
            return A();
        }

        @Override // kt.z
        /* renamed from: P */
        public String x(kt.q qVar) {
            String str;
            ...
            if (this.f40606e.p()) {
                ...
                if (str != null && q10.containsKey(k.k(q10, lt.v.ABBREVIATED, lt.m.FORMAT, str))) {
                    return str;
                }
            }
            return (String) this.f40606e.f40603c.get(this.f40606e.o(g0Var));
        }
        ...
        @Override // kt.z
        /* renamed from: R */
        public boolean l(kt.q qVar, String str) {
            return false;
        }

        @Override // lt.t
        /* renamed from: S */
        public String k(CharSequence charSequence, ParsePosition parsePosition, kt.d dVar) {
            int index = parsePosition.getIndex();
            ...
            if (T == null && ((Boolean) dVar.a(lt.a.f37636k, Boolean.TRUE)).booleanValue()) {
        ...
        @Override // kt.z
        /* renamed from: U */
        public kt.q v(kt.q qVar, String str, boolean z10) {
        ...
        protected boolean j(kt.e eVar) {
            return this.f40606e.equals(((b) eVar).f40606e);
        }
        ...
        public void s(kt.o oVar, Appendable appendable, kt.d dVar) {
            ...
            if (this.f40605d) {
                str = (String) this.f40606e.l(vVar, mVar).apply(oVar);
            } else {
                str = (String) this.f40606e.j(vVar, mVar).apply(oVar);
            }
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    /* loaded from: /home/runner/work/discord-client-datamining/discord-client-datamining/build/classes5.dex */
    public static class c implements kt.s {
        private static k e(Locale locale, kt.d dVar) {
            if (dVar.c(k.f40600f)) {
                return (k) dVar.b(k.f40600f);
            }
            return k.r(locale, (String) dVar.a(lt.a.f37627b, "iso8601"));
        }

        private static int f(kt.q qVar) {
        ...
        */
        public kt.q a(kt.q r17, java.util.Locale r18, kt.d r19) {
            /*
                Method dump skipped, instructions count: 361
                To view this dump add '--comments-level debug' option
            */
            throw new UnsupportedOperationException("Method not decompiled: net.time4j.k.c.a(kt.q, java.util.Locale, kt.d):kt.q");
        }
    ...
    /* loaded from: /home/runner/work/discord-client-datamining/discord-client-datamining/build/classes5.dex */
    public class d implements kt.t {

        /* renamed from: a  reason: collision with root package name */
        private final boolean f40607a;

        /* renamed from: b  reason: collision with root package name */
        private final lt.v f40608b;

        /* renamed from: c  reason: collision with root package name */
        private final lt.m f40609c;

        d(boolean z10, lt.v vVar, lt.m mVar) {
            if (vVar != null) {
                if (mVar != null) {
                    this.f40607a = z10;
                    this.f40608b = vVar;
        ...
        @Override // kt.t
        /* renamed from: a */
        public String apply(kt.o oVar) {
            g0 g0Var = (g0) oVar.v(g0.A);
            k kVar = k.this;
            Locale locale = kVar.f40601a;
            if (this.f40607a) {
                String n10 = k.n(g0Var);
                if (kVar.p()) {
                    Map q10 = k.q(locale, kVar.f40602b);
                    String k10 = k.k(q10, this.f40608b, this.f40609c, n10);
                    if (!q10.containsKey(k10)) {
                        if (n10.equals("midnight")) {
                            k10 = k.k(q10, this.f40608b, this.f40609c, "am");
                        } else if (n10.equals("noon")) {
                            k10 = k.k(q10, this.f40608b, this.f40609c, "pm");
                        }
                    }
                    if (q10.containsKey(k10)) {
                ...
                Map q11 = k.q(locale, kVar.f40602b);
                if (g0Var.B0()) {
                    String k11 = k.k(q11, this.f40608b, this.f40609c, "midnight");
                    if (q11.containsKey(k11)) {
                        return (String) q11.get(k11);
                    }
                } else if (g0Var.C0(g0.G0(12))) {
                    String k12 = k.k(q11, this.f40608b, this.f40609c, "noon");
                    if (q11.containsKey(k12)) {
                        return (String) q11.get(k12);
                    }
                }
                String k13 = k.k(q11, this.f40608b, this.f40609c, (String) kVar.f40603c.get(kVar.o(g0Var)));
                if (q11.containsKey(k13)) {
                    return (String) q11.get(k13);
                }
            } else {
                return (String) kVar.f40603c.get(kVar.o(g0Var));
            }
    ...
    static {
        ...
        f40598d = unmodifiableSortedMap;
        f40599e = new k(Locale.ROOT, "iso8601", unmodifiableSortedMap);
        f40600f = lt.a.e("CUSTOM_DAY_PERIOD", k.class);
    }

    private k(Locale locale, String str, SortedMap sortedMap) {
        this.f40601a = locale;
        this.f40602b = str;
        this.f40603c = Collections.unmodifiableSortedMap(sortedMap);
    }
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public static String k(Map map, lt.v vVar, lt.m mVar, String str) {
        if (vVar == lt.v.SHORT) {
            vVar = lt.v.ABBREVIATED;
        }
        String str2 = t(vVar, mVar) + str;
        if (!map.containsKey(str2)) {
            if (mVar == lt.m.STANDALONE) {
                lt.v vVar2 = lt.v.ABBREVIATED;
                if (vVar == vVar2) {
                    return k(map, vVar, lt.m.FORMAT, str);
                }
                return k(map, vVar2, mVar, str);
            }
            lt.v vVar3 = lt.v.ABBREVIATED;
            if (vVar != vVar3) {
        ...
        for (String str2 : q10.keySet()) {
            if (a(str2)) {
                ...
                if (parseInt == 24) {
                    ...
                    F0 = (g0) F0.K((parseInt * 60) + parseInt2, g.f40468e);
                } else {
                    throw new IllegalStateException("Invalid time key: " + str2);
                }
    ...
    private static String t(lt.v vVar, lt.m mVar) {
        char c10;
        int i10 = a.f40604a[vVar.ordinal()];
        if (i10 != 1) {
            if (i10 != 2) {
                c10 = 'a';
            } else {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof k) {
            k kVar = (k) obj;
            Locale locale = this.f40601a;
            if (locale == null) {
                if (kVar.f40601a != null) {
                    return false;
                }
            } else if (!locale.equals(kVar.f40601a)) {
                return false;
            }
            if (this.f40603c.equals(kVar.f40603c) && this.f40602b.equals(kVar.f40602b)) {
                return true;
            }
        }
        return false;
    ...
    public int hashCode() {
        return this.f40603c.hashCode();
    }

    public kt.t j(lt.v vVar, lt.m mVar) {
        return new d(false, vVar, mVar);
    }

    public kt.t l(lt.v vVar, lt.m mVar) {
    ...
    public g0 m(g0 g0Var) {
        ...
        for (g0 g0Var2 : this.f40603c.keySet()) {
            if (g0Var.y0(g0Var2)) {
                return g0Var2;
            }
        }
        return (g0) this.f40603c.firstKey();
    }
    ...
    public g0 o(g0 g0Var) {
        ...
        g0 g0Var2 = (g0) this.f40603c.lastKey();
        for (g0 g0Var3 : this.f40603c.keySet()) {
            if (g0Var.C0(g0Var3)) {
                return g0Var3;
            }
            if (g0Var.y0(g0Var3)) {
    ...
    public String toString() {
        ...
        if (p()) {
            ...
            sb2.append(',');
            if (!this.f40602b.equals("iso8601")) {
