...
public final class h extends l {
    ...
    @Override // net.time4j.tz.l
    public l Q(o oVar) {
        if (this.f39621id != null && E() != oVar) {
            if (oVar == l.f39627o) {
                return new h(this.f39621id, this.tz, false);
            }
            if (oVar == l.f39628p) {
                return new h(this.f39621id, this.tz, true);
            }
