...
public final class h extends l {
    ...
    private static p S(int i10) {
        return p.t(pt.c.a(i10, 1000));
    }

    private Object readResolve() {
        k kVar = this.f39573id;
        if (kVar == null) {
            return new h();
        }
    ...
    public p A(pt.a aVar, pt.g gVar) {
        ...
        int g10 = aVar.g();
        if (gVar.h() == 24) {
            long l10 = pt.b.l(pt.c.f(pt.b.k(aVar), 1L));
            int i14 = pt.b.i(l10);
            int h10 = pt.b.h(l10);
            i10 = pt.b.g(l10);
            r10 = h10;
    ...
    public p B(pt.f fVar) {
        ...
        return S(timeZone.getOffset(fVar.m() * 1000));
    }
    ...
    public boolean I(pt.f fVar) {
        ...
        return timeZone.inDaylightTime(new Date(fVar.m() * 1000));
    }
    ...
    @Override // net.time4j.tz.l
    public l Q(o oVar) {
        if (this.f39573id != null && E() != oVar) {
            if (oVar == l.f39579o) {
                return new h(this.f39573id, this.tz, false);
            }
            if (oVar == l.f39580p) {
                return new h(this.f39573id, this.tz, true);
            }
