...
public final class h extends l {
    ...
    public p A(gt.a aVar, gt.g gVar) {
        ...
        int g10 = aVar.g();
        if (gVar.h() == 24) {
            long l10 = gt.b.l(gt.c.f(gt.b.k(aVar), 1L));
            int i14 = gt.b.i(l10);
            int h10 = gt.b.h(l10);
            i10 = gt.b.g(l10);
            u10 = h10;
        ...
        return S(timeZone.getOffset(i11, i12, u10 - 1, i10, i13, i16));
    }
    ...
    public boolean I(gt.f fVar) {
        ...
        return timeZone.inDaylightTime(new Date(fVar.r() * 1000));
    }
    ...
    public boolean K(gt.a aVar, gt.g gVar) {
        ...
        gregorianCalendar.set(f10, u10 - 1, g10, h10, e10, d10);
        if (gregorianCalendar.get(1) == f10 && gregorianCalendar.get(2) + 1 == u10 && gregorianCalendar.get(5) == g10 && gregorianCalendar.get(11) == h10 && gregorianCalendar.get(12) == e10 && gregorianCalendar.get(13) == d10 && gregorianCalendar.get(14) == a10) {
            return false;
        }
        return true;
    }
