...
public final class n implements o, Serializable {
    ...
    private static final Map f40776i = new HashMap();
    private static final long serialVersionUID = 1790434289322009750L;

    /* renamed from: d  reason: collision with root package name */
    private final transient b f40777d;

    /* renamed from: e  reason: collision with root package name */
    private final transient g f40778e;
    ...
    static /* synthetic */ class a {
        ...
        static {
            ...
            try {
                f40779a[b.NEXT_VALID_TIME.ordinal()] = 2;
            } catch (NoSuchFieldError unused2) {
            }
            try {
                f40779a[b.ABORT.ordinal()] = 3;
    ...
    static {
        ...
        for (b bVar : b.values()) {
            for (g gVar : g.values()) {
                f40776i.put(Integer.valueOf((bVar.ordinal() * 2) + gVar.ordinal()), new n(bVar, gVar));
            }
        }
    }
    ...
    public static n d(b bVar, g gVar) {
        return (n) f40776i.get(Integer.valueOf((bVar.ordinal() * 2) + gVar.ordinal()));
    }

    private static void e(ht.a aVar, ht.g gVar, l lVar) {
    ...
    private static long f(int i10, int i11, int i12, int i13, int i14, int i15) {
        return ht.c.i(ht.c.m(ht.b.j(i10, i11, i12), 40587L), 86400L) + (i13 * 3600) + (i14 * 60) + i15;
    }
    ...
    public o a(g gVar) {
        if (gVar == this.f40778e) {
            return this;
        }
        return this.f40777d.a(gVar);
    }

    @Override // net.time4j.tz.o
    public long b(ht.a aVar, ht.g gVar, l lVar) {
        int i10;
        int i11;
        long f10;
        int m10;
        ...
        int d10 = gVar.d();
        m y10 = lVar.y();
        if (y10 == null && this.f40778e == g.LATER_OFFSET && ((bVar = this.f40777d) == b.PUSH_FORWARD || bVar == b.ABORT)) {
            ...
            if (this.f40777d == b.ABORT && (f12 != i12 || r10 != i13 || g10 != i14 || h10 != i15 || e10 != i16 || d10 != i17)) {
                e(aVar, gVar, lVar);
            }
            ...
            if (e11 != null) {
                if (e11.m()) {
                    int i18 = a.f40779a[this.f40777d.ordinal()];
                    if (i18 != 1) {
                        if (i18 != 2) {
                            if (i18 == 3) {
                                e(aVar, gVar, lVar);
                            } else {
                                throw new UnsupportedOperationException(this.f40777d.name());
                            }
                        } else {
                            return e11.g();
                        }
                    ...
                    if (e11.o()) {
                        ...
                        l10 = e11.l();
                        if (this.f40778e == g.EARLIER_OFFSET) {
                            l10 = e11.h();
                        }
                    }
                    f10 = f(f12, i11, g10, i10, e10, d10);
                    m10 = ((p) y10.d(aVar, gVar).get(0)).m();
                }
                return f11 - l10;
            }
            i10 = h10;
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    public int c() {
        return (this.f40777d.ordinal() * 2) + this.f40778e.ordinal();
    }
