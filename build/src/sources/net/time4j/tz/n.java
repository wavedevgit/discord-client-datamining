...
public final class n implements o, Serializable {
    ...
    private static final Map f38343i = new HashMap();
    private static final long serialVersionUID = 1790434289322009750L;

    /* renamed from: d  reason: collision with root package name */
    private final transient b f38344d;

    /* renamed from: e  reason: collision with root package name */
    private final transient g f38345e;

    /* loaded from: /home/runner/work/discord-client-datamining/discord-client-datamining/build/classes5.dex */
    static /* synthetic */ class a {

        /* renamed from: a  reason: collision with root package name */
        static final /* synthetic */ int[] f38346a;
        ...
        static {
            ...
            try {
                f38346a[b.NEXT_VALID_TIME.ordinal()] = 2;
            } catch (NoSuchFieldError unused2) {
            }
            try {
                f38346a[b.ABORT.ordinal()] = 3;
    ...
    static {
        ...
        for (b bVar : b.values()) {
            for (g gVar : g.values()) {
                f38343i.put(Integer.valueOf((bVar.ordinal() * 2) + gVar.ordinal()), new n(bVar, gVar));
            }
        }
    }
    ...
    public static n d(b bVar, g gVar) {
        return (n) f38343i.get(Integer.valueOf((bVar.ordinal() * 2) + gVar.ordinal()));
    }
    ...
    public o a(g gVar) {
        if (gVar == this.f38345e) {
            return this;
        }
        return this.f38344d.a(gVar);
    }
    ...
    public long b(zt.a aVar, zt.g gVar, l lVar) {
        ...
        int d10 = gVar.d();
        m y10 = lVar.y();
        if (y10 == null && this.f38345e == g.LATER_OFFSET && ((bVar = this.f38344d) == b.PUSH_FORWARD || bVar == b.ABORT)) {
            ...
            if (this.f38344d == b.ABORT && (f12 != i12 || q10 != i13 || g10 != i14 || h10 != i15 || e10 != i16 || d10 != i17)) {
                e(aVar, gVar, lVar);
            }
            ...
            if (d11 != null) {
                if (d11.m()) {
                    int i18 = a.f38346a[this.f38344d.ordinal()];
                    if (i18 != 1) {
                        if (i18 != 2) {
                            if (i18 == 3) {
                                e(aVar, gVar, lVar);
                            } else {
                                throw new UnsupportedOperationException(this.f38344d.name());
                            }
                        } else {
                            return d11.g();
                        }
                    ...
                    if (d11.n()) {
                        ...
                        l10 = d11.l();
                        if (this.f38345e == g.EARLIER_OFFSET) {
                            l10 = d11.h();
                        }
                    }
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    public int c() {
        return (this.f38344d.ordinal() * 2) + this.f38345e.ordinal();
    }
