...
public abstract class l implements Serializable {
    ...
    private static final String f38716d = System.getProperty("line.separator");

    /* renamed from: e  reason: collision with root package name */
    private static final String f38717e = System.getProperty("net.time4j.tz.repository.version");

    /* renamed from: i  reason: collision with root package name */
    private static final Comparator f38718i = new a();

    /* renamed from: o  reason: collision with root package name */
    public static final o f38719o;

    /* renamed from: p  reason: collision with root package name */
    public static final o f38720p;

    /* renamed from: q  reason: collision with root package name */
    private static final boolean f38721q;

    /* renamed from: r  reason: collision with root package name */
    private static final boolean f38722r;

    /* renamed from: s  reason: collision with root package name */
    private static volatile e f38723s;

    /* renamed from: t  reason: collision with root package name */
    private static volatile l f38724t;

    /* renamed from: u  reason: collision with root package name */
    private static volatile boolean f38725u;

    /* renamed from: v  reason: collision with root package name */
    private static int f38726v;

    /* renamed from: w  reason: collision with root package name */
    private static final Map f38727w;

    /* renamed from: x  reason: collision with root package name */
    private static final Map f38728x;

    /* renamed from: y  reason: collision with root package name */
    private static final r f38729y;

    /* renamed from: z  reason: collision with root package name */
    private static final r f38730z;
    ...
    public static class b {
        public static void a() {
            ...
            e unused = l.f38723s = new e();
            l.A.clear();
            if (l.f38722r) {
                l unused2 = l.f38724t = l.f();
            }
        }
    }
    ...
    private static class e {
        ...
        e() {
            ...
            arrayList.add(p.f38781v);
            for (Map.Entry entry : l.D.entrySet()) {
                r rVar = (r) entry.getValue();
                if (rVar != l.f38729y || l.f38730z == l.f38729y) {
            ...
            Collections.sort(arrayList, l.f38718i);
            Collections.sort(arrayList2, l.f38718i);
            this.f38732a = Collections.unmodifiableList(arrayList);
            this.f38733b = Collections.unmodifiableList(arrayList2);
        }
    }
    ...
    private static l F(k kVar, String str, boolean z10) {
        ...
        if (cVar != null) {
            lVar = (l) cVar.get();
            if (lVar == null) {
                concurrentMap.remove(cVar.f38731a);
            }
        } else {
            lVar = null;
        }
    ...
    public static List t() {
        return f38723s.f38732a;
    }

    public static List u(String str) {
        if (str.equals("INCLUDE_ALIAS")) {
            return f38723s.f38733b;
        }
        r D2 = D(str);
        if (D2 == null) {
        ...
        Collections.sort(arrayList, f38718i);
        return Collections.unmodifiableList(arrayList);
    }
    ...
    public abstract p A(qt.a aVar, qt.g gVar);

    public abstract p B(qt.f fVar);

    public abstract o E();

    public abstract boolean I(qt.f fVar);

    public abstract boolean J();

    public abstract boolean K(qt.a aVar, qt.g gVar);
