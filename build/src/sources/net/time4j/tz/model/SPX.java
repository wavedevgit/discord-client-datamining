...
final class SPX implements Externalizable {
    ...
    private transient Object f40779d;

    /* renamed from: e  reason: collision with root package name */
    private transient int f40780e;
    ...
    private static int m(g gVar) {
        return gVar.f().j(g0.K) + kt.c.g(gVar.c() * 86400);
    }
    ...
    public void readExternal(ObjectInput objectInput) {
        switch (objectInput.readByte()) {
            case 120:
                this.f40779d = d(objectInput);
                return;
            case 121:
                this.f40779d = c(objectInput);
                return;
            case 122:
                this.f40779d = e(objectInput);
                return;
            case 123:
            case 124:
            default:
            ...
            case 125:
                this.f40779d = g(objectInput);
                return;
            case 126:
                this.f40779d = a(objectInput);
                return;
            case Byte.MAX_VALUE:
                this.f40779d = b(objectInput);
                return;
        }
    }
    ...
    public void writeExternal(ObjectOutput objectOutput) {
        objectOutput.writeByte(this.f40780e);
        switch (this.f40780e) {
            case 120:
                s(this.f40779d, objectOutput);
                return;
            case 121:
                r(this.f40779d, objectOutput);
                return;
            case 122:
                t(this.f40779d, objectOutput);
                return;
            case 123:
            case 124:
            default:
            ...
            case 125:
                w(this.f40779d, objectOutput);
                return;
            case 126:
                p(this.f40779d, objectOutput);
                return;
            case 127:
                q(this.f40779d, objectOutput);
                return;
        }
    }
