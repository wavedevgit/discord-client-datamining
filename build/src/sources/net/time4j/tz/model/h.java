...
public final class h extends g {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof h) {
            h hVar = (h) obj;
            if (this.f39662q == hVar.f39662q && super.l(hVar)) {
                return true;
            }
        }
        return false;
    ...
    protected f0 j(int i10) {
        ...
        int c10 = pt.b.c(i10, k10, d10) - this.f39662q;
        if (c10 < 0) {
            c10 += 7;
        }
