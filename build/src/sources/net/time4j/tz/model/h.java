...
public final class h extends g {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof h) {
            h hVar = (h) obj;
            if (this.f37758q == hVar.f37758q && super.l(hVar)) {
                return true;
            }
        }
        return false;
    ...
    protected f0 j(int i10) {
        ...
        int c10 = zt.b.c(i10, k10, d10) - this.f37758q;
        if (c10 < 0) {
            c10 += 7;
        }
