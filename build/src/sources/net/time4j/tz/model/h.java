...
public final class h extends g {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof h) {
            h hVar = (h) obj;
            if (this.f39614q == hVar.f39614q && super.l(hVar)) {
                return true;
            }
        }
        return false;
    ...
    public int hashCode() {
        return (this.f39614q * 17) + (k() * 37);
    }

    @Override // net.time4j.tz.model.g
    protected f0 j(int i10) {
        byte k10 = k();
        int d10 = pt.b.d(i10, k10);
        int c10 = pt.b.c(i10, k10, d10) - this.f39614q;
        if (c10 < 0) {
            c10 += 7;
        }
