...
public abstract class l implements m, Serializable {
    ...
    static final String f37773d = System.getProperty("line.separator");
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    public static long j(zt.a aVar, zt.g gVar) {
        return zt.c.i(a0.UNIX.o(zt.b.j(aVar.f(), aVar.q(), aVar.g()), a0.MODIFIED_JULIAN_DATE), 86400L) + (gVar.h() * 3600) + (gVar.e() * 60) + gVar.d();
    }
