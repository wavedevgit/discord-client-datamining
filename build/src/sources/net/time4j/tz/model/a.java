...
public final class a extends l {
    ...
    private final transient q[] f40863e;

    /* renamed from: i  reason: collision with root package name */
    private final transient boolean f40864i;

    /* renamed from: o  reason: collision with root package name */
    private final transient List f40865o;

    /* renamed from: p  reason: collision with root package name */
    private transient int f40866p = 0;
    ...
    public a(List list, boolean z10, boolean z11) {
        if (!list.isEmpty()) {
            ...
            this.f40863e = qVarArr;
            this.f40865o = o(qVarArr, 0L, l.f(1));
            return;
        }
    ...
    @Override // net.time4j.tz.m
    public p c() {
        return p.t(this.f40863e[0].h());
    }

    @Override // net.time4j.tz.m
    public q d(gt.f fVar) {
        int r10 = r(fVar.r(), this.f40863e);
        if (r10 == 0) {
            return null;
        }
        return this.f40863e[r10 - 1];
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof a) {
            return Arrays.equals(this.f40863e, ((a) obj).f40863e);
        }
        return false;
    }
    ...
    public int hashCode() {
        ...
        if (i10 == 0) {
            int hashCode = Arrays.hashCode(this.f40863e);
            this.f40866p = hashCode;
            return hashCode;
        }
        return i10;
    }
    ...
    public boolean l(a aVar, int i10, int i11) {
        int min = Math.min(i10, this.f40863e.length);
        if (min != Math.min(i11, aVar.f40863e.length)) {
            return false;
        }
        for (int i12 = 0; i12 < min; i12++) {
            if (!this.f40863e[i12].equals(aVar.f40863e[i12])) {
                return false;
            }
        }
        return true;
    ...
    public q m(gt.a aVar, gt.g gVar, j jVar) {
        ...
        int s10 = s(j10, this.f40863e);
        q[] qVarArr = this.f40863e;
    ...
    public int q(int i10) {
        int min = Math.min(i10, this.f40863e.length);
        q[] qVarArr = new q[min];
        System.arraycopy(this.f40863e, 0, qVarArr, 0, min);
        return Arrays.hashCode(qVarArr);
    }

    /* JADX INFO: Access modifiers changed from: package-private */
    public void t(int i10, ObjectOutput objectOutput) {
        SPX.z(this.f40863e, i10, objectOutput);
    }
    ...
    public String toString() {
        ...
        sb2.append(this.f40863e.length);
        sb2.append(",hash=");
        sb2.append(hashCode());
        sb2.append(']');
        return sb2.toString();
    ...
    public void u(ObjectOutput objectOutput) {
        t(this.f40863e.length, objectOutput);
    }
}
