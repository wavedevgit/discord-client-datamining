...
final class SPX implements Externalizable {
    ...
    private transient Object f40741d;

    /* renamed from: e  reason: collision with root package name */
    private transient int f40742e;
    ...
    private void g(ObjectOutput objectOutput) {
        objectOutput.writeByte(((n) this.f40741d).c() | 208);
    }

    private void h(ObjectOutput objectOutput) {
        boolean z10;
        int i10;
        c cVar = (c) this.f40741d;
        if (cVar.E() != l.f40764o) {
            z10 = true;
        } else {
            z10 = false;
    ...
    public void readExternal(ObjectInput objectInput) {
        ...
        switch ((readByte & 255) >> 4) {
            case 12:
                this.f40741d = a(objectInput, readByte);
                return;
            case 13:
                this.f40741d = c(readByte);
                return;
            case 14:
                this.f40741d = d(objectInput, readByte);
                return;
            case 15:
                this.f40741d = b(objectInput, readByte);
                return;
            default:
