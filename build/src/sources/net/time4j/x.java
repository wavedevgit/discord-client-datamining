...
public final class x extends b implements l0 {
    ...
    static final bu.p f38360r = new x();
    private static final long serialVersionUID = 5930990958663061693L;

    /* renamed from: o  reason: collision with root package name */
    private final transient Long f38361o;

    /* renamed from: p  reason: collision with root package name */
    private final transient Long f38362p;

    /* renamed from: q  reason: collision with root package name */
    private final transient bu.t f38363q;
    ...
    private x(String str, long j10, long j11) {
        super(str);
        this.f38361o = Long.valueOf(j10);
        this.f38362p = Long.valueOf(j11);
        this.f38363q = new m0(this, true);
    }
}
