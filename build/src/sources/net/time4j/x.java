...
public final class x extends b implements l0 {
    ...
    static final bu.p f37792r = new x();
    private static final long serialVersionUID = 5930990958663061693L;

    /* renamed from: o  reason: collision with root package name */
    private final transient Long f37793o;

    /* renamed from: p  reason: collision with root package name */
    private final transient Long f37794p;

    /* renamed from: q  reason: collision with root package name */
    private final transient bu.t f37795q;
    ...
    private x(String str, long j10, long j11) {
        super(str);
        this.f37793o = Long.valueOf(j10);
        this.f37794p = Long.valueOf(j11);
        this.f37795q = new m0(this, true);
    }
}
