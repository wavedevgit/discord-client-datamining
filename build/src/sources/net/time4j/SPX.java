...
final class SPX implements Externalizable {
    ...
    private transient Object f39692d;

    /* renamed from: e  reason: collision with root package name */
    private transient int f39693e;
    ...
    private void i(DataOutput dataOutput) {
        j((f0) this.f39692d, 1, dataOutput);
    }
    ...
    private static void j(f0 f0Var, int i10, DataOutput dataOutput) {
        ...
        dataOutput.writeByte((i10 << 4) | f0Var.t());
    ...
    private void k(ObjectOutput objectOutput) {
        int i10;
        k.b bVar = (k.b) k.b.class.cast(this.f39692d);
        Locale M = bVar.M();
        if (bVar.Q()) {
            i10 = 113;
        } else {
    ...
    private void l(ObjectOutput objectOutput) {
        boolean z10;
        int i10;
        n nVar = (n) n.class.cast(this.f39692d);
    ...
    private void m(ObjectOutput objectOutput) {
        int i10;
        y yVar = (y) y.class.cast(this.f39692d);
        if (yVar.g() == wt.f.UTC) {
            i10 = 81;
        } else {
            i10 = 80;
    ...
    public void readExternal(ObjectInput objectInput) {
        ...
        switch ((readByte & 255) >> 4) {
            case 1:
                this.f39692d = a(objectInput, readByte);
                return;
            case 2:
                this.f39692d = f(objectInput);
                return;
            case 3:
                this.f39692d = h(objectInput, readByte);
                return;
            case 4:
                this.f39692d = e(objectInput, readByte);
                return;
            case 5:
                this.f39692d = d(objectInput, readByte);
                return;
            case 6:
                this.f39692d = c(objectInput, readByte);
                return;
            case 7:
                this.f39692d = b(objectInput, readByte);
                return;
            case 8:
                this.f39692d = g(objectInput, readByte);
                return;
            default:
