...
final class s0 extends o {
    ...
    public g0 apply(g0 g0Var) {
        return (g0) ((bu.v) this.f38245i).apply(g0Var);
    }
    ...
    public s0(bu.p pVar, int i10, Object obj) {
        ...
        switch (i10) {
            case -1:
                this.f38245i = e(pVar, obj);
                return;
            case 0:
                this.f38245i = bu.g0.l(pVar);
                return;
            case 1:
                this.f38245i = bu.g0.j(pVar);
                return;
            case 2:
                this.f38245i = bu.g0.f(pVar);
                return;
            case 3:
                this.f38245i = bu.g0.h(pVar);
                return;
            case 4:
                this.f38245i = c(pVar, false);
                return;
            case 5:
                this.f38245i = c(pVar, true);
                return;
            case 6:
                this.f38245i = d(pVar, obj);
                return;
            default:
