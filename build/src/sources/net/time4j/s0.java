...
final class s0 extends o {
    ...
    public g0 apply(g0 g0Var) {
        return (g0) ((bu.v) this.f37676i).apply(g0Var);
    }
    ...
    public s0(bu.p pVar, int i10, Object obj) {
        ...
        switch (i10) {
            case -1:
                this.f37676i = e(pVar, obj);
                return;
            case 0:
                this.f37676i = bu.g0.l(pVar);
                return;
            case 1:
                this.f37676i = bu.g0.j(pVar);
                return;
            case 2:
                this.f37676i = bu.g0.f(pVar);
                return;
            case 3:
                this.f37676i = bu.g0.h(pVar);
                return;
            case 4:
                this.f37676i = c(pVar, false);
                return;
            case 5:
                this.f37676i = c(pVar, true);
                return;
            case 6:
                this.f37676i = d(pVar, obj);
                return;
            default:
