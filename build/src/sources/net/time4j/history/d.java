...
public final class d implements Serializable {
    ...
    private final transient ot.b f40638d;

    /* renamed from: e  reason: collision with root package name */
    private final transient List f40639e;

    /* renamed from: i  reason: collision with root package name */
    private final transient net.time4j.history.a f40640i;

    /* renamed from: o  reason: collision with root package name */
    private final transient o f40641o;

    /* renamed from: p  reason: collision with root package name */
    private final transient g f40642p;

    /* renamed from: q  reason: collision with root package name */
    private final transient p f40643q;

    /* renamed from: r  reason: collision with root package name */
    private final transient p f40644r;

    /* renamed from: s  reason: collision with root package name */
    private final transient t f40645s;

    /* renamed from: t  reason: collision with root package name */
    private final transient p f40646t;

    /* renamed from: u  reason: collision with root package name */
    private final transient p f40647u;

    /* renamed from: v  reason: collision with root package name */
    private final transient t f40648v;

    /* renamed from: w  reason: collision with root package name */
    private final transient t f40649w;

    /* renamed from: x  reason: collision with root package name */
    private final transient t f40650x;

    /* renamed from: y  reason: collision with root package name */
    private final transient p f40651y;

    /* renamed from: z  reason: collision with root package name */
    private final transient Set f40652z;
    ...
    public static /* synthetic */ class a {
        ...
        static final /* synthetic */ int[] f40654b;

        /* renamed from: c  reason: collision with root package name */
        static final /* synthetic */ int[] f40655c;
        ...
        static {
            ...
            try {
                f40655c[nt.a.AFTER_NEW_YEAR.ordinal()] = 2;
            } catch (NoSuchFieldError unused2) {
            }
            try {
                f40655c[nt.a.BEFORE_NEW_YEAR.ordinal()] = 3;
            ...
            try {
                f40654b[j.BYZANTINE.ordinal()] = 2;
            } catch (NoSuchFieldError unused5) {
            }
            try {
                f40654b[j.AB_URBE_CONDITA.ordinal()] = 3;
            ...
            try {
                f40653a[ot.b.PROLEPTIC_JULIAN.ordinal()] = 2;
            } catch (NoSuchFieldError unused8) {
            }
            try {
                f40653a[ot.b.PROLEPTIC_BYZANTINE.ordinal()] = 3;
            } catch (NoSuchFieldError unused9) {
            }
            try {
                f40653a[ot.b.SWEDEN.ordinal()] = 4;
            } catch (NoSuchFieldError unused10) {
            }
            try {
                f40653a[ot.b.INTRODUCTION_ON_1582_10_15.ordinal()] = 5;
            } catch (NoSuchFieldError unused11) {
            }
            try {
                f40653a[ot.b.SINGLE_CUTOVER_DATE.ordinal()] = 6;
    ...
    static {
        ...
        hashMap.put("FR", G(f0.H0(1582, 12, 20)).K(n.f40691p.f(1567)));
        ...
        hashMap.put("IT-PISA", E().K(n.f40694s.f(1749)));
        d E3 = E();
        n nVar5 = n.f40688e;
    ...
    private d(ot.b bVar, List list) {
        this(bVar, list, null, null, g.f40663d);
    }
    ...
    private static d F(long j10) {
        ...
        return new d(bVar, Collections.singletonList(new f(j10, c.f40635e, c.f40634d)));
    }
    ...
    public static d j(String str) {
        ...
        if (str.startsWith("historic-")) {
            ...
            if (split.length != 0) {
                ...
                switch (a.f40653a[valueOf.ordinal()]) {
                    case 1:
                        return B;
                    case 2:
                        return C;
                ...
                if (split6[0].equals("era-preference")) {
                    ...
                    if (!substring2.equals("default")) {
                        ...
                        try {
                            ...
                            int i15 = a.f40654b[valueOf3.ordinal()];
                            if (i15 != 1) {
                                if (i15 != 2) {
                                    if (i15 == 3) {
    ...
    private static f0 r(String[] strArr, String str) {
        ...
        if (split.length == 2) {
            if (split[0].equals("cutover")) {
                try {
                    return (f0) lt.l.f37631m.D(split[1]);
                } catch (ParseException unused) {
                }
            }
    ...
    private b t() {
        net.time4j.history.a aVar = this.f40640i;
        if (aVar != null) {
            return aVar.d();
        }
        return c.f40635e;
    ...
    public d I(net.time4j.history.a aVar) {
        if (aVar != null) {
            ...
            return new d(this.f40638d, this.f40639e, aVar, this.f40641o, this.f40642p);
        }
        throw new NullPointerException("Missing ancient julian leap years.");
    }

    public d J(g gVar) {
        if (!gVar.equals(this.f40642p) && y()) {
            return new d(this.f40638d, this.f40639e, this.f40640i, this.f40641o, gVar);
        }
        return this;
    }

    public d K(o oVar) {
        if (oVar.equals(o.f40697d)) {
            if (this.f40641o != null) {
                return new d(this.f40638d, this.f40639e, this.f40640i, null, this.f40642p);
            }
        } else if (y()) {
            return new d(this.f40638d, this.f40639e, this.f40640i, oVar, this.f40642p);
        }
        return this;
    }

    public p L(nt.a aVar) {
        int i10 = a.f40655c[aVar.ordinal()];
        if (i10 != 1) {
            if (i10 != 2) {
                if (i10 == 3) {
                    return this.f40647u;
    ...
    public h e(f0 f0Var) {
        h hVar;
        long longValue = ((Long) f0Var.p(a0.MODIFIED_JULIAN_DATE)).longValue();
        int size = this.f40639e.size() - 1;
        while (true) {
            if (size >= 0) {
                f fVar = (f) this.f40639e.get(size);
                if (longValue >= fVar.f40659a) {
                    hVar = fVar.f40660b.e(longValue);
                    break;
                }
                size--;
            } else {
        ...
        j d10 = this.f40642p.d(hVar, f0Var);
        if (d10 != hVar.e()) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof d) {
            d dVar = (d) obj;
            if (this.f40638d == dVar.f40638d && z(this.f40640i, dVar.f40640i) && z(this.f40641o, dVar.f40641o) && this.f40642p.equals(dVar.f40642p)) {
                if (this.f40638d != ot.b.SINGLE_CUTOVER_DATE || ((f) this.f40639e.get(0)).f40659a == ((f) dVar.f40639e.get(0)).f40659a) {
                    return true;
                }
                return false;
            }
    ...
    public int hashCode() {
        ot.b bVar = this.f40638d;
        if (bVar == ot.b.SINGLE_CUTOVER_DATE) {
            long j10 = ((f) this.f40639e.get(0)).f40659a;
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    public b k(h hVar) {
        for (int size = this.f40639e.size() - 1; size >= 0; size--) {
            f fVar = (f) this.f40639e.get(size);
            if (hVar.compareTo(fVar.f40661c) >= 0) {
                return fVar.f40660b;
            }
            if (hVar.compareTo(fVar.f40662d) > 0) {
                return null;
            }
        }
        return t();
    ...
    public h m(j jVar, int i10) {
        h d10 = v().d(jVar, i10);
        if (B(d10)) {
            j d11 = this.f40642p.d(d10, d(d10));
            if (d11 != jVar) {
    ...
    public f0 q() {
        List list = this.f40639e;
        long j10 = ((f) list.get(list.size() - 1)).f40659a;
    ...
    public int u(j jVar, int i10) {
        ...
        try {
            ...
            if (oVar == null) {
                ...
                if (jVar == j.BC) {
                    if (i10 == 1) {
                        hVar = this.f40641o.d(j.AD, 1);
                    } else {
                        hVar = this.f40641o.d(jVar, i10 - 1);
                    }
                } else {
                    h d11 = this.f40641o.d(jVar, i10 + 1);
                    if (jVar == j.BYZANTINE) {
                        hVar = this.f40641o.d(j.AD, jVar.a(i10));
            ...
            return (int) (net.time4j.f.f40555s.e(d(d10), d(hVar)) + i11);
    ...
    public String w() {
        ...
        sb2.append("historic-");
        sb2.append(this.f40638d.name());
        int i10 = a.f40653a[this.f40638d.ordinal()];
    ...
    public boolean y() {
        List list = this.f40639e;
        if (((f) list.get(list.size() - 1)).f40659a > Long.MIN_VALUE) {
            return true;
        }
        return false;
    }
    ...
    private d(ot.b bVar, List list, net.time4j.history.a aVar, o oVar, g gVar) {
        ...
        if (gVar != null) {
            ...
            hashSet.add(lVar6);
            hashSet.add(lVar7);
            this.f40652z = Collections.unmodifiableSet(hashSet);
            return;
        }
