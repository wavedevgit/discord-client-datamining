...
public final class d implements Serializable {
    public static final kt.c A = lt.a.e("YEAR_DEFINITION", ot.a.class);
    ...
    private final transient pt.b f40517d;

    /* renamed from: e  reason: collision with root package name */
    private final transient List f40518e;

    /* renamed from: i  reason: collision with root package name */
    private final transient net.time4j.history.a f40519i;

    /* renamed from: o  reason: collision with root package name */
    private final transient o f40520o;

    /* renamed from: p  reason: collision with root package name */
    private final transient g f40521p;

    /* renamed from: q  reason: collision with root package name */
    private final transient p f40522q;

    /* renamed from: r  reason: collision with root package name */
    private final transient p f40523r;

    /* renamed from: s  reason: collision with root package name */
    private final transient t f40524s;

    /* renamed from: t  reason: collision with root package name */
    private final transient p f40525t;

    /* renamed from: u  reason: collision with root package name */
    private final transient p f40526u;

    /* renamed from: v  reason: collision with root package name */
    private final transient t f40527v;

    /* renamed from: w  reason: collision with root package name */
    private final transient t f40528w;

    /* renamed from: x  reason: collision with root package name */
    private final transient t f40529x;

    /* renamed from: y  reason: collision with root package name */
    private final transient p f40530y;

    /* renamed from: z  reason: collision with root package name */
    private final transient Set f40531z;
    ...
    public static /* synthetic */ class a {
        ...
        static final /* synthetic */ int[] f40533b;

        /* renamed from: c  reason: collision with root package name */
        static final /* synthetic */ int[] f40534c;

        static {
            int[] iArr = new int[ot.a.values().length];
            f40534c = iArr;
            try {
                iArr[ot.a.DUAL_DATING.ordinal()] = 1;
            } catch (NoSuchFieldError unused) {
            }
            try {
                f40534c[ot.a.AFTER_NEW_YEAR.ordinal()] = 2;
            } catch (NoSuchFieldError unused2) {
            }
            try {
                f40534c[ot.a.BEFORE_NEW_YEAR.ordinal()] = 3;
            ...
            try {
                f40533b[j.BYZANTINE.ordinal()] = 2;
            } catch (NoSuchFieldError unused5) {
            }
            try {
                f40533b[j.AB_URBE_CONDITA.ordinal()] = 3;
            } catch (NoSuchFieldError unused6) {
            }
            int[] iArr3 = new int[pt.b.values().length];
            f40532a = iArr3;
            try {
                iArr3[pt.b.PROLEPTIC_GREGORIAN.ordinal()] = 1;
            } catch (NoSuchFieldError unused7) {
            }
            try {
                f40532a[pt.b.PROLEPTIC_JULIAN.ordinal()] = 2;
            } catch (NoSuchFieldError unused8) {
            }
            try {
                f40532a[pt.b.PROLEPTIC_BYZANTINE.ordinal()] = 3;
            } catch (NoSuchFieldError unused9) {
            }
            try {
                f40532a[pt.b.SWEDEN.ordinal()] = 4;
            } catch (NoSuchFieldError unused10) {
            }
            try {
                f40532a[pt.b.INTRODUCTION_ON_1582_10_15.ordinal()] = 5;
            } catch (NoSuchFieldError unused11) {
            }
            try {
                f40532a[pt.b.SINGLE_CUTOVER_DATE.ordinal()] = 6;
    ...
    static {
        ...
        d dVar2 = new d(pt.b.SWEDEN, Collections.unmodifiableList(arrayList));
        G = dVar2;
        ...
        hashMap.put("FR", G(f0.H0(1582, 12, 20)).K(n.f40570p.f(1567)));
        ...
        hashMap.put("IT-PISA", E().K(n.f40573s.f(1749)));
        d E3 = E();
        n nVar5 = n.f40567e;
    ...
    private d(pt.b bVar, List list) {
        this(bVar, list, null, null, g.f40542d);
    }
    ...
    private static d F(long j10) {
        pt.b bVar;
        if (j10 == E) {
            bVar = pt.b.INTRODUCTION_ON_1582_10_15;
        } else {
            bVar = pt.b.SINGLE_CUTOVER_DATE;
        }
        return new d(bVar, Collections.singletonList(new f(j10, c.f40514e, c.f40513d)));
    }
    ...
    public static d j(String str) {
        ...
        if (str.startsWith("historic-")) {
            ...
            if (split.length != 0) {
                pt.b valueOf = pt.b.valueOf(split[0]);
                switch (a.f40532a[valueOf.ordinal()]) {
                    case 1:
                        return B;
                    case 2:
                        return C;
                ...
                if (split6[0].equals("era-preference")) {
                    ...
                    if (!substring2.equals("default")) {
                        ...
                        try {
                            ...
                            f0 i13 = mt.l.i(split7[1].substring(7));
                            f0 i14 = mt.l.i(split7[2].substring(5));
                            int i15 = a.f40533b[valueOf3.ordinal()];
                            if (i15 != 1) {
                                if (i15 != 2) {
                                    if (i15 == 3) {
    ...
    private static f0 r(String[] strArr, String str) {
        ...
        if (split.length == 2) {
            if (split[0].equals("cutover")) {
                try {
                    return (f0) mt.l.f39347m.D(split[1]);
                } catch (ParseException unused) {
                }
            }
    ...
    private b t() {
        net.time4j.history.a aVar = this.f40519i;
        if (aVar != null) {
            return aVar.d();
        }
        return c.f40514e;
    ...
    public d I(net.time4j.history.a aVar) {
        if (aVar != null) {
            ...
            return new d(this.f40517d, this.f40518e, aVar, this.f40520o, this.f40521p);
        }
        throw new NullPointerException("Missing ancient julian leap years.");
    }

    public d J(g gVar) {
        if (!gVar.equals(this.f40521p) && y()) {
            return new d(this.f40517d, this.f40518e, this.f40519i, this.f40520o, gVar);
        }
        return this;
    }

    public d K(o oVar) {
        if (oVar.equals(o.f40576d)) {
            if (this.f40520o != null) {
                return new d(this.f40517d, this.f40518e, this.f40519i, null, this.f40521p);
            }
        } else if (y()) {
            return new d(this.f40517d, this.f40518e, this.f40519i, oVar, this.f40521p);
        }
        return this;
    }

    public p L(ot.a aVar) {
        int i10 = a.f40534c[aVar.ordinal()];
        if (i10 != 1) {
            if (i10 != 2) {
                if (i10 == 3) {
                    return this.f40526u;
    ...
    public h e(f0 f0Var) {
        h hVar;
        long longValue = ((Long) f0Var.v(a0.MODIFIED_JULIAN_DATE)).longValue();
        int size = this.f40518e.size() - 1;
        while (true) {
            if (size >= 0) {
                f fVar = (f) this.f40518e.get(size);
                if (longValue >= fVar.f40538a) {
                    hVar = fVar.f40539b.e(longValue);
                    break;
                }
                size--;
            } else {
        ...
        j d10 = this.f40521p.d(hVar, f0Var);
        if (d10 != hVar.e()) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof d) {
            d dVar = (d) obj;
            if (this.f40517d == dVar.f40517d && z(this.f40519i, dVar.f40519i) && z(this.f40520o, dVar.f40520o) && this.f40521p.equals(dVar.f40521p)) {
                if (this.f40517d != pt.b.SINGLE_CUTOVER_DATE || ((f) this.f40518e.get(0)).f40538a == ((f) dVar.f40518e.get(0)).f40538a) {
                    return true;
                }
                return false;
            }
    ...
    public int hashCode() {
        pt.b bVar = this.f40517d;
        if (bVar == pt.b.SINGLE_CUTOVER_DATE) {
            long j10 = ((f) this.f40518e.get(0)).f40538a;
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    public b k(h hVar) {
        for (int size = this.f40518e.size() - 1; size >= 0; size--) {
            f fVar = (f) this.f40518e.get(size);
            if (hVar.compareTo(fVar.f40540c) >= 0) {
                return fVar.f40539b;
            }
            if (hVar.compareTo(fVar.f40541d) > 0) {
                return null;
            }
        }
        return t();
    ...
    public h m(j jVar, int i10) {
        h d10 = v().d(jVar, i10);
        if (B(d10)) {
            j d11 = this.f40521p.d(d10, d(d10));
            if (d11 != jVar) {
    ...
    public f0 q() {
        List list = this.f40518e;
        long j10 = ((f) list.get(list.size() - 1)).f40538a;
    ...
    public int u(j jVar, int i10) {
        ...
        try {
            ...
            if (oVar == null) {
                ...
                if (jVar == j.BC) {
                    if (i10 == 1) {
                        hVar = this.f40520o.d(j.AD, 1);
                    } else {
                        hVar = this.f40520o.d(jVar, i10 - 1);
                    }
                } else {
                    h d11 = this.f40520o.d(jVar, i10 + 1);
                    if (jVar == j.BYZANTINE) {
                        hVar = this.f40520o.d(j.AD, jVar.a(i10));
            ...
            return (int) (net.time4j.f.f40434s.e(d(d10), d(hVar)) + i11);
    ...
    public String w() {
        ...
        sb2.append("historic-");
        sb2.append(this.f40517d.name());
        int i10 = a.f40532a[this.f40517d.ordinal()];
    ...
    public boolean y() {
        List list = this.f40518e;
        if (((f) list.get(list.size() - 1)).f40538a > Long.MIN_VALUE) {
            return true;
        }
        return false;
    }

    private d(pt.b bVar, List list, net.time4j.history.a aVar, o oVar, g gVar) {
        if (list.isEmpty()) {
        ...
        if (gVar != null) {
            ...
            hashSet.add(lVar6);
            hashSet.add(lVar7);
            this.f40531z = Collections.unmodifiableSet(hashSet);
            return;
        }
