...
public final class d implements Serializable {
    public static final mt.c A = nt.a.e("YEAR_DEFINITION", qt.a.class);
    ...
    private final transient rt.b f40556d;

    /* renamed from: e  reason: collision with root package name */
    private final transient List f40557e;

    /* renamed from: i  reason: collision with root package name */
    private final transient net.time4j.history.a f40558i;

    /* renamed from: o  reason: collision with root package name */
    private final transient o f40559o;

    /* renamed from: p  reason: collision with root package name */
    private final transient g f40560p;

    /* renamed from: q  reason: collision with root package name */
    private final transient p f40561q;

    /* renamed from: r  reason: collision with root package name */
    private final transient p f40562r;

    /* renamed from: s  reason: collision with root package name */
    private final transient t f40563s;

    /* renamed from: t  reason: collision with root package name */
    private final transient p f40564t;

    /* renamed from: u  reason: collision with root package name */
    private final transient p f40565u;

    /* renamed from: v  reason: collision with root package name */
    private final transient t f40566v;

    /* renamed from: w  reason: collision with root package name */
    private final transient t f40567w;

    /* renamed from: x  reason: collision with root package name */
    private final transient t f40568x;

    /* renamed from: y  reason: collision with root package name */
    private final transient p f40569y;

    /* renamed from: z  reason: collision with root package name */
    private final transient Set f40570z;
    ...
    public static /* synthetic */ class a {
        ...
        static final /* synthetic */ int[] f40572b;

        /* renamed from: c  reason: collision with root package name */
        static final /* synthetic */ int[] f40573c;

        static {
            int[] iArr = new int[qt.a.values().length];
            f40573c = iArr;
            try {
                iArr[qt.a.DUAL_DATING.ordinal()] = 1;
            } catch (NoSuchFieldError unused) {
            }
            try {
                f40573c[qt.a.AFTER_NEW_YEAR.ordinal()] = 2;
            } catch (NoSuchFieldError unused2) {
            }
            try {
                f40573c[qt.a.BEFORE_NEW_YEAR.ordinal()] = 3;
            ...
            try {
                f40572b[j.BYZANTINE.ordinal()] = 2;
            } catch (NoSuchFieldError unused5) {
            }
            try {
                f40572b[j.AB_URBE_CONDITA.ordinal()] = 3;
            } catch (NoSuchFieldError unused6) {
            }
            int[] iArr3 = new int[rt.b.values().length];
            f40571a = iArr3;
            try {
                iArr3[rt.b.PROLEPTIC_GREGORIAN.ordinal()] = 1;
            } catch (NoSuchFieldError unused7) {
            }
            try {
                f40571a[rt.b.PROLEPTIC_JULIAN.ordinal()] = 2;
            } catch (NoSuchFieldError unused8) {
            }
            try {
                f40571a[rt.b.PROLEPTIC_BYZANTINE.ordinal()] = 3;
            } catch (NoSuchFieldError unused9) {
            }
            try {
                f40571a[rt.b.SWEDEN.ordinal()] = 4;
            } catch (NoSuchFieldError unused10) {
            }
            try {
                f40571a[rt.b.INTRODUCTION_ON_1582_10_15.ordinal()] = 5;
            } catch (NoSuchFieldError unused11) {
            }
            try {
                f40571a[rt.b.SINGLE_CUTOVER_DATE.ordinal()] = 6;
    ...
    static {
        ...
        long longValue = ((Long) f0.H0(1582, 10, 15).o(a0.MODIFIED_JULIAN_DATE)).longValue();
        E = longValue;
        F = F(longValue);
        ...
        d dVar2 = new d(rt.b.SWEDEN, Collections.unmodifiableList(arrayList));
        G = dVar2;
        ...
        hashMap.put("FR", G(f0.H0(1582, 12, 20)).K(n.f40609p.f(1567)));
        ...
        hashMap.put("IT-PISA", E().K(n.f40612s.f(1749)));
        d E3 = E();
        n nVar5 = n.f40606e;
    ...
    private d(rt.b bVar, List list) {
        this(bVar, list, null, null, g.f40581d);
    }
    ...
    private static d F(long j10) {
        rt.b bVar;
        if (j10 == E) {
            bVar = rt.b.INTRODUCTION_ON_1582_10_15;
        } else {
            bVar = rt.b.SINGLE_CUTOVER_DATE;
        }
        return new d(bVar, Collections.singletonList(new f(j10, c.f40553e, c.f40552d)));
    }
    ...
    public static d G(f0 f0Var) {
        ...
        long longValue = ((Long) f0Var.o(a0.MODIFIED_JULIAN_DATE)).longValue();
        c(longValue);
        if (longValue == E) {
            return F;
        }
    ...
    public static d j(String str) {
        ...
        if (str.startsWith("historic-")) {
            ...
            if (split.length != 0) {
                rt.b valueOf = rt.b.valueOf(split[0]);
                switch (a.f40571a[valueOf.ordinal()]) {
                    case 1:
                        return B;
                    case 2:
                        return C;
                ...
                if (split6[0].equals("era-preference")) {
                    ...
                    if (!substring2.equals("default")) {
                        ...
                        try {
                            ...
                            f0 i13 = ot.l.i(split7[1].substring(7));
                            f0 i14 = ot.l.i(split7[2].substring(5));
                            int i15 = a.f40572b[valueOf3.ordinal()];
                            if (i15 != 1) {
                                if (i15 != 2) {
                                    if (i15 == 3) {
    ...
    private static f0 r(String[] strArr, String str) {
        ...
        if (split.length == 2) {
            if (split[0].equals("cutover")) {
                try {
                    return (f0) ot.l.f44702m.D(split[1]);
                } catch (ParseException unused) {
                }
            }
    ...
    private b t() {
        net.time4j.history.a aVar = this.f40558i;
        if (aVar != null) {
            return aVar.d();
        }
        return c.f40553e;
    ...
    public d I(net.time4j.history.a aVar) {
        if (aVar != null) {
            ...
            return new d(this.f40556d, this.f40557e, aVar, this.f40559o, this.f40560p);
        }
        throw new NullPointerException("Missing ancient julian leap years.");
    }

    public d J(g gVar) {
        if (!gVar.equals(this.f40560p) && y()) {
            return new d(this.f40556d, this.f40557e, this.f40558i, this.f40559o, gVar);
        }
        return this;
    }

    public d K(o oVar) {
        if (oVar.equals(o.f40615d)) {
            if (this.f40559o != null) {
                return new d(this.f40556d, this.f40557e, this.f40558i, null, this.f40560p);
            }
        } else if (y()) {
            return new d(this.f40556d, this.f40557e, this.f40558i, oVar, this.f40560p);
        }
        return this;
    }

    public p L(qt.a aVar) {
        int i10 = a.f40573c[aVar.ordinal()];
        if (i10 != 1) {
            if (i10 != 2) {
                if (i10 == 3) {
                    return this.f40565u;
    ...
    public h e(f0 f0Var) {
        h hVar;
        long longValue = ((Long) f0Var.o(a0.MODIFIED_JULIAN_DATE)).longValue();
        int size = this.f40557e.size() - 1;
        while (true) {
            if (size >= 0) {
                f fVar = (f) this.f40557e.get(size);
                if (longValue >= fVar.f40577a) {
                    hVar = fVar.f40578b.e(longValue);
                    break;
                }
                size--;
            } else {
        ...
        j d10 = this.f40560p.d(hVar, f0Var);
        if (d10 != hVar.e()) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof d) {
            d dVar = (d) obj;
            if (this.f40556d == dVar.f40556d && z(this.f40558i, dVar.f40558i) && z(this.f40559o, dVar.f40559o) && this.f40560p.equals(dVar.f40560p)) {
                if (this.f40556d != rt.b.SINGLE_CUTOVER_DATE || ((f) this.f40557e.get(0)).f40577a == ((f) dVar.f40557e.get(0)).f40577a) {
                    return true;
                }
                return false;
            }
    ...
    public int hashCode() {
        rt.b bVar = this.f40556d;
        if (bVar == rt.b.SINGLE_CUTOVER_DATE) {
            long j10 = ((f) this.f40557e.get(0)).f40577a;
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    public b k(h hVar) {
        for (int size = this.f40557e.size() - 1; size >= 0; size--) {
            f fVar = (f) this.f40557e.get(size);
            if (hVar.compareTo(fVar.f40579c) >= 0) {
                return fVar.f40578b;
            }
            if (hVar.compareTo(fVar.f40580d) > 0) {
                return null;
            }
        }
        return t();
    ...
    public h m(j jVar, int i10) {
        h d10 = v().d(jVar, i10);
        if (B(d10)) {
            j d11 = this.f40560p.d(d10, d(d10));
            if (d11 != jVar) {
    ...
    public f0 q() {
        ...
        long j10 = ((f) list.get(list.size() - 1)).f40577a;
    ...
    public int u(j jVar, int i10) {
        ...
        try {
            ...
            if (oVar == null) {
                ...
                if (jVar == j.BC) {
                    if (i10 == 1) {
                        hVar = this.f40559o.d(j.AD, 1);
                    } else {
                        hVar = this.f40559o.d(jVar, i10 - 1);
                    }
                } else {
                    h d11 = this.f40559o.d(jVar, i10 + 1);
                    if (jVar == j.BYZANTINE) {
                        hVar = this.f40559o.d(j.AD, jVar.a(i10));
            ...
            return (int) (net.time4j.f.f40473s.e(d(d10), d(hVar)) + i11);
    ...
    public String w() {
        ...
        sb2.append("historic-");
        sb2.append(this.f40556d.name());
        int i10 = a.f40571a[this.f40556d.ordinal()];
    ...
    public boolean y() {
        List list = this.f40557e;
        if (((f) list.get(list.size() - 1)).f40577a > Long.MIN_VALUE) {
            return true;
        }
        return false;
    }

    private d(rt.b bVar, List list, net.time4j.history.a aVar, o oVar, g gVar) {
        if (list.isEmpty()) {
        ...
        if (gVar != null) {
            ...
            hashSet.add(lVar6);
            hashSet.add(lVar7);
            this.f40570z = Collections.unmodifiableSet(hashSet);
            return;
        }
