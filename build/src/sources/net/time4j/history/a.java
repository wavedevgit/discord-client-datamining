...
public final class a {
    ...
    private static final int[] f39360c;

    /* renamed from: d  reason: collision with root package name */
    private static final h f39361d = h.i(j.AD, 8, 1, 1);

    /* renamed from: e  reason: collision with root package name */
    private static final h f39362e = h.i(j.BC, 45, 1, 1);

    /* renamed from: f  reason: collision with root package name */
    public static final a f39363f;
    ...
    class C0540a implements b {
        ...
        private boolean g(int i10) {
            if (Arrays.binarySearch(a.this.f39364a, i10) >= 0) {
                return true;
            }
            return false;
        }
        ...
        public long a(h hVar) {
            long j10;
            if (hVar.compareTo(a.f39361d) >= 0) {
                return c.f39368e.a(hVar);
            }
            if (hVar.compareTo(a.f39362e) >= 0) {
                int c10 = c(hVar);
                long j11 = -676021;
    ...
    public boolean equals(Object obj) {
        ...
        if ((obj instanceof a) && this.f39364a == ((a) obj).f39364a) {
            return true;
        }
        return false;
    }
    ...
    public int hashCode() {
        return Arrays.hashCode(this.f39364a);
    }

    public String toString() {
        StringBuilder sb2 = new StringBuilder();
        for (int i10 = 0; i10 < this.f39364a.length; i10++) {
            if (i10 > 0) {
                sb2.append(", ");
            }
            int i11 = 1 - this.f39364a[i10];
            if (i11 > 0) {
                sb2.append("BC ");
                sb2.append(i11);
            } else {
                sb2.append("AD ");
                sb2.append(this.f39364a[i10]);
            }
        }
        return sb2.toString();
    }
