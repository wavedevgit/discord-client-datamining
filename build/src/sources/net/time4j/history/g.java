...
public final class g {
    ...
    static final g f40663d = new g();

    /* renamed from: e  reason: collision with root package name */
    private static final h f40664e = h.i(j.AD, 1, 1, 1);

    /* renamed from: f  reason: collision with root package name */
    private static final h f40665f = h.i(j.BC, 38, 1, 1);

    /* renamed from: g  reason: collision with root package name */
    private static final f0 f40666g = f0.G0(2000, 1);

    /* renamed from: a  reason: collision with root package name */
    private final j f40667a;

    /* renamed from: b  reason: collision with root package name */
    private final f0 f40668b;

    /* renamed from: c  reason: collision with root package name */
    private final f0 f40669c;

    private g() {
        this.f40667a = null;
        this.f40668b = (f0) f0.r0().Q();
        this.f40669c = (f0) f0.r0().P();
    }
    ...
    public j d(h hVar, f0 f0Var) {
        if (this.f40667a != null && !f0Var.Q(this.f40668b) && !f0Var.P(this.f40669c)) {
            if (this.f40667a == j.HISPANIC && hVar.compareTo(f40665f) < 0) {
                return j.BC;
            }
            return this.f40667a;
        } else if (hVar.compareTo(f40664e) < 0) {
            return j.BC;
        } else {
            return j.AD;
        }
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof g) {
            ...
            if (this == gVar2) {
                ...
                return false;
            } else if (this.f40667a == gVar.f40667a && this.f40668b.equals(gVar.f40668b) && this.f40669c.equals(gVar.f40669c)) {
                return true;
            }
        }
        return false;
    ...
    public void h(DataOutput dataOutput) {
        ...
        dataOutput.writeUTF(this.f40667a.name());
        f0 f0Var = this.f40668b;
        a0 a0Var = a0.MODIFIED_JULIAN_DATE;
        dataOutput.writeLong(((Long) f0Var.p(a0Var)).longValue());
        dataOutput.writeLong(((Long) this.f40669c.p(a0Var)).longValue());
    }

    public int hashCode() {
        return (this.f40667a.hashCode() * 17) + (this.f40668b.hashCode() * 31) + (this.f40669c.hashCode() * 37);
    }
