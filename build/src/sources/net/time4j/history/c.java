...
abstract class c implements net.time4j.history.b {
    ...
    public static final c f40012d;

    /* renamed from: e  reason: collision with root package name */
    public static final c f40013e;

    /* renamed from: i  reason: collision with root package name */
    public static final c f40014i;

    /* renamed from: o  reason: collision with root package name */
    private static final /* synthetic */ c[] f40015o;
    ...
    enum a extends c {
        ...
        public long a(h hVar) {
            return nt.b.j(c.h(hVar), hVar.f(), hVar.d());
        }

        @Override // net.time4j.history.b
        public int d(h hVar) {
            return nt.b.d(c.h(hVar), hVar.f());
        }
        ...
        public boolean f(h hVar) {
            return nt.b.f(c.h(hVar), hVar.f(), hVar.d());
        }
    }
