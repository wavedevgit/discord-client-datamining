...
final class SPX implements Externalizable {
    ...
    private static final int[] f38496i = new int[0];
    private static final long serialVersionUID = 1;

    /* renamed from: d  reason: collision with root package name */
    private transient Object f38497d;

    /* renamed from: e  reason: collision with root package name */
    private transient int f38498e;
    ...
    public static /* synthetic */ class a {
        ...
        static {
            ...
            f38499a = iArr;
            try {
                iArr[xt.b.PROLEPTIC_GREGORIAN.ordinal()] = 1;
            } catch (NoSuchFieldError unused) {
            }
            try {
                f38499a[xt.b.PROLEPTIC_JULIAN.ordinal()] = 2;
            } catch (NoSuchFieldError unused2) {
            }
            try {
                f38499a[xt.b.PROLEPTIC_BYZANTINE.ordinal()] = 3;
            } catch (NoSuchFieldError unused3) {
            }
            try {
                f38499a[xt.b.SWEDEN.ordinal()] = 4;
            } catch (NoSuchFieldError unused4) {
            }
            try {
                f38499a[xt.b.INTRODUCTION_ON_1582_10_15.ordinal()] = 5;
    ...
    private d b(DataInput dataInput, byte b10) {
        int i10 = a.f38499a[a(b10 & 15).ordinal()];
        if (i10 != 1) {
            if (i10 != 2) {
                if (i10 != 3) {
                    if (i10 != 4) {
    ...
    private void d(DataOutput dataOutput) {
        int[] iArr;
        d dVar = (d) this.f38497d;
        dataOutput.writeByte(dVar.s().a() | (this.f38498e << 4));
        if (dVar.s() == xt.b.SINGLE_CUTOVER_DATE) {
            dataOutput.writeLong(((f) dVar.p().get(0)).f38532a);
        }
        if (dVar.x()) {
            iArr = dVar.l().e();
        } else {
