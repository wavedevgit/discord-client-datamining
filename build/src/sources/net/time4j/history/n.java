...
public abstract class n {
    ...
    public static final n f38133d;

    /* renamed from: e  reason: collision with root package name */
    public static final n f38134e;

    /* renamed from: i  reason: collision with root package name */
    public static final n f38135i;

    /* renamed from: o  reason: collision with root package name */
    public static final n f38136o;

    /* renamed from: p  reason: collision with root package name */
    public static final n f38137p;

    /* renamed from: q  reason: collision with root package name */
    public static final n f38138q;

    /* renamed from: r  reason: collision with root package name */
    public static final n f38139r;

    /* renamed from: s  reason: collision with root package name */
    public static final n f38140s;

    /* renamed from: t  reason: collision with root package name */
    public static final n f38141t;

    /* renamed from: u  reason: collision with root package name */
    private static final /* synthetic */ n[] f38142u;
    ...
    static {
        ...
        n nVar7 = new n("CALCULUS_PISANUS", 7) { // from class: net.time4j.history.n.h
            ...
            @Override // net.time4j.history.n
            net.time4j.history.h d(j jVar, int i10) {
                return n.f38139r.d(jVar, i10 + 1);
            }

            @Override // net.time4j.history.n
            int e(boolean z10, o oVar, j jVar, int i10, int i11, int i12) {
                return n.f38139r.e(z10, oVar, jVar, i10 + 1, i11, i12);
            }
        };
        f38140s = nVar7;
        ...
        f38141t = nVar8;
        f38142u = new n[]{aVar, nVar, nVar2, nVar3, nVar4, nVar5, nVar6, nVar7, nVar8};
    }
