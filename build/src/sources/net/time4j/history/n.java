...
public abstract class n {
    ...
    public static final n f37565d;

    /* renamed from: e  reason: collision with root package name */
    public static final n f37566e;

    /* renamed from: i  reason: collision with root package name */
    public static final n f37567i;

    /* renamed from: o  reason: collision with root package name */
    public static final n f37568o;

    /* renamed from: p  reason: collision with root package name */
    public static final n f37569p;

    /* renamed from: q  reason: collision with root package name */
    public static final n f37570q;

    /* renamed from: r  reason: collision with root package name */
    public static final n f37571r;

    /* renamed from: s  reason: collision with root package name */
    public static final n f37572s;

    /* renamed from: t  reason: collision with root package name */
    public static final n f37573t;

    /* renamed from: u  reason: collision with root package name */
    private static final /* synthetic */ n[] f37574u;
    ...
    static {
        ...
        n nVar7 = new n("CALCULUS_PISANUS", 7) { // from class: net.time4j.history.n.h
            ...
            @Override // net.time4j.history.n
            net.time4j.history.h d(j jVar, int i10) {
                return n.f37571r.d(jVar, i10 + 1);
            }

            @Override // net.time4j.history.n
            int e(boolean z10, o oVar, j jVar, int i10, int i11, int i12) {
                return n.f37571r.e(z10, oVar, jVar, i10 + 1, i11, i12);
            }
        };
        f37572s = nVar7;
        ...
        f37573t = nVar8;
        f37574u = new n[]{aVar, nVar, nVar2, nVar3, nVar4, nVar5, nVar6, nVar7, nVar8};
    }
