...
public abstract class n {
    ...
    public static final n f40687d;

    /* renamed from: e  reason: collision with root package name */
    public static final n f40688e;

    /* renamed from: i  reason: collision with root package name */
    public static final n f40689i;

    /* renamed from: o  reason: collision with root package name */
    public static final n f40690o;

    /* renamed from: p  reason: collision with root package name */
    public static final n f40691p;

    /* renamed from: q  reason: collision with root package name */
    public static final n f40692q;

    /* renamed from: r  reason: collision with root package name */
    public static final n f40693r;

    /* renamed from: s  reason: collision with root package name */
    public static final n f40694s;

    /* renamed from: t  reason: collision with root package name */
    public static final n f40695t;

    /* renamed from: u  reason: collision with root package name */
    private static final /* synthetic */ n[] f40696u;
    ...
    static {
        ...
        n nVar7 = new n("CALCULUS_PISANUS", 7) { // from class: net.time4j.history.n.h
            ...
            @Override // net.time4j.history.n
            net.time4j.history.h d(j jVar, int i10) {
                return n.f40693r.d(jVar, i10 + 1);
            }

            @Override // net.time4j.history.n
            int e(boolean z10, o oVar, j jVar, int i10, int i11, int i12) {
                return n.f40693r.e(z10, oVar, jVar, i10 + 1, i11, i12);
            }
        };
        f40694s = nVar7;
        ...
        f40695t = nVar8;
        f40696u = new n[]{aVar, nVar, nVar2, nVar3, nVar4, nVar5, nVar6, nVar7, nVar8};
    }
