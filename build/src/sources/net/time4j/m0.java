...
public final class m0 implements bu.t {
    ...
    public BigDecimal apply(bu.q qVar) {
        long longValue = ((Number) qVar.k(this.f38195a)).longValue();
        long longValue2 = ((Number) qVar.t(this.f38195a)).longValue();
        long longValue3 = ((Number) qVar.v(this.f38195a)).longValue();
        ...
        if (this.f38196b && (qVar instanceof g0) && !((g0) g0.class.cast(qVar)).w0(this.f38195a)) {
            if (longValue == longValue3) {
