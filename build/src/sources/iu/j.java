...
public final class j implements Interceptor {
    ...
    private final OkHttpClient f29668a;
    ...
    private final Request a(Response response, String str) {
        ...
        if (!this.f29668a.w() || (Z = Response.Z(response, "Location", null, 2, null)) == null || (r10 = response.W0().n().r(Z)) == null) {
            return null;
        }
        if (!Intrinsics.areEqual(r10.s(), response.W0().n().s()) && !this.f29668a.x()) {
            return null;
        }
        Request.Builder k10 = response.W0().k();
        if (f.b(str)) {
            int z11 = response.z();
            f fVar = f.f29653a;
        ...
        if (!du.e.j(response.W0().n(), r10)) {
            k10.i("Authorization");
        }
        return k10.m(r10).b();
    }

    private final Request b(Response response, hu.c cVar) {
        cu.k kVar;
        hu.f h10;
        ...
        if (z10 != 307 && z10 != 308) {
            if (z10 != 401) {
                if (z10 != 421) {
                    if (z10 != 503) {
                        if (z10 != 407) {
                            ...
                            } else if (!this.f29668a.M()) {
                                return null;
                            } else {
                                RequestBody c10 = response.W0().c();
                                if (c10 != null && c10.isOneShot()) {
                                    return null;
                                }
                                Response O0 = response.O0();
                                if ((O0 != null && O0.z() == 408) || f(response, 0) > 0) {
                                    return null;
                                }
                                return response.W0();
                            }
                            ...
                            if (kVar.b().type() == Proxy.Type.HTTP) {
                                return this.f29668a.J().a(kVar, response);
                            }
                            throw new ProtocolException("Received HTTP_PROXY_AUTH (407) code while not using proxy");
                        }
                    } else {
                        Response O02 = response.O0();
                        if ((O02 != null && O02.z() == 503) || f(response, Integer.MAX_VALUE) != 0) {
                            return null;
                        }
                        return response.W0();
                    }
                } else {
                    RequestBody c11 = response.W0().c();
                ...
                return this.f29668a.i().a(kVar, response);
            }
        }
    ...
    private final boolean d(IOException iOException, hu.e eVar, Request request, boolean z10) {
        if (!this.f29668a.M()) {
            return false;
        }
    ...
    */
    public okhttp3.Response intercept(okhttp3.Interceptor.Chain r11) {
        ...
        L19:
            ...
            if (r6 != 0) goto Ld3
            okhttp3.Response r0 = r11.a(r0)     // Catch: java.lang.Throwable -> L42 java.io.IOException -> L99 hu.i -> Lb4
            if (r7 == 0) goto L40
            okhttp3.Response$a r0 = r0.J0()     // Catch: java.lang.Throwable -> L42
            okhttp3.Response$a r6 = r7.J0()     // Catch: java.lang.Throwable -> L42
        ...
        L42:
            ...
            goto Ldb
        L45:
            hu.c r0 = r1.o()     // Catch: java.lang.Throwable -> L42
        ...
        L6e:
            ...
            if (r0 == 0) goto L77
            du.e.m(r0)     // Catch: java.lang.Throwable -> L42
        L77:
            int r8 = r8 + 1
            r0 = 20
            if (r8 > r0) goto L82
        ...
        L99:
            r6 = move-exception
            boolean r9 = r6 instanceof ku.a     // Catch: java.lang.Throwable -> L42
            r9 = r9 ^ r5
        ...
        La9:
            ...
            goto L19
        Laf:
            java.lang.Throwable r11 = du.e.b0(r6, r2)     // Catch: java.lang.Throwable -> L42
            throw r11     // Catch: java.lang.Throwable -> L42
        Lb4:
            r6 = move-exception
        ...
        Lca:
            ...
            java.lang.Throwable r11 = du.e.b0(r11, r2)     // Catch: java.lang.Throwable -> L42
            throw r11     // Catch: java.lang.Throwable -> L42
        Ld3:
        ...
        Ldb:
            ...
            throw r11
        */
        throw new UnsupportedOperationException("Method not decompiled: iu.j.intercept(okhttp3.Interceptor$Chain):okhttp3.Response");
    }
}
