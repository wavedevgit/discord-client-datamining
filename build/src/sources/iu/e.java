...
public abstract class e {
    ...
    private static final ByteString f29651a;

    /* renamed from: b  reason: collision with root package name */
    private static final ByteString f29652b;
        ...
        for (int i10 = 0; i10 < size; i10++) {
            if (StringsKt.A(headerName, headers.e(i10), true)) {
                try {
                    ...
                    mu.h.f37655a.g().k("Unable to parse challenge", 5, e10);
                }
            }
        }
        return arrayList;
    ...
    public static final boolean b(Response response) {
        ...
        if (Intrinsics.areEqual(response.W0().j(), "HEAD")) {
            return false;
        }
        int z10 = response.z();
        if (((z10 >= 100 && z10 < 200) || z10 == 204 || z10 == 304) && du.e.v(response) == -1 && !StringsKt.A("chunked", Response.Z(response, "Transfer-Encoding", null, 2, null), true)) {
            return false;
        }
        return true;
    }
    ...
    */
    private static final void c(okio.Buffer r7, java.util.List r8) {
        ...
        Lbc:
            ...
            goto L2
        */
        throw new UnsupportedOperationException("Method not decompiled: iu.e.c(okio.Buffer, java.util.List):void");
    }
    ...
    private static final String e(Buffer buffer) {
        long g02 = buffer.g0(f29652b);
        if (g02 == -1) {
            g02 = buffer.size();
        }
        if (g02 != 0) {
            return buffer.Y0(g02);
        }
        return null;
    }
    ...
    public static final void f(CookieJar cookieJar, HttpUrl url, Headers headers) {
        ...
        if (cookieJar != CookieJar.f42014b) {
            List e10 = Cookie.f41990j.e(url, headers);
            if (e10.isEmpty()) {
                return;
            }
