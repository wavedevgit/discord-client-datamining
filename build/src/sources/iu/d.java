...
public final class d implements Iterable, Comparator {
    ...
    public static final boolean f30422q = Boolean.getBoolean("net.time4j.scale.leapseconds.suppressed");

    /* renamed from: r  reason: collision with root package name */
    public static final boolean f30423r = Boolean.getBoolean("net.time4j.scale.leapseconds.final");

    /* renamed from: s  reason: collision with root package name */
    public static final String f30424s = System.getProperty("net.time4j.scale.leapseconds.path", "data/leapseconds.data");

    /* renamed from: t  reason: collision with root package name */
    private static final iu.a[] f30425t = new iu.a[0];

    /* renamed from: u  reason: collision with root package name */
    private static final d f30426u = new d();
    ...
    private final iu.a[] f30429i;

    /* renamed from: o  reason: collision with root package name */
    private volatile iu.a[] f30430o;

    /* renamed from: p  reason: collision with root package name */
    private final boolean f30431p;
    ...
    private d() {
        ...
        if (cVar != null && i10 != 0) {
            ...
            boolean z11 = f30423r;
            if (z11) {
                this.f30428e = Collections.unmodifiableList(new ArrayList(treeSet));
            } else {
                this.f30428e = new CopyOnWriteArrayList(treeSet);
            }
            iu.a[] F = F();
            this.f30429i = F;
            this.f30430o = F;
            ...
            if (z11) {
                boolean b10 = cVar.b();
                if (b10) {
                    Iterator it = this.f30428e.iterator();
                    while (true) {
                        if (it.hasNext()) {
                            if (((iu.a) it.next()).a() < 0) {
                                z10 = true;
        ...
        this.f30427d = null;
        this.f30428e = Collections.EMPTY_LIST;
        iu.a[] aVarArr = f30425t;
        this.f30429i = aVarArr;
        this.f30430o = aVarArr;
        this.f30431p = false;
    }

    private iu.a[] F() {
        ArrayList arrayList = new ArrayList(this.f30428e.size());
        arrayList.addAll(this.f30428e);
