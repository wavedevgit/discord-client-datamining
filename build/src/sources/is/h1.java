...
public final class h1 extends a0 implements FunctionBase, KFunction, l {
    ...
    static final /* synthetic */ KProperty[] f30212x = {Reflection.property1(new PropertyReference1Impl(h1.class, "descriptor", "getDescriptor()Lorg/jetbrains/kotlin/descriptors/FunctionDescriptor;", 0))};

    /* renamed from: r  reason: collision with root package name */
    private final c1 f30213r;

    /* renamed from: s  reason: collision with root package name */
    private final String f30214s;

    /* renamed from: t  reason: collision with root package name */
    private final Object f30215t;

    /* renamed from: u  reason: collision with root package name */
    private final z2.a f30216u;

    /* renamed from: v  reason: collision with root package name */
    private final Lazy f30217v;

    /* renamed from: w  reason: collision with root package name */
    private final Lazy f30218w;
    ...
    public static final js.h L(h1 h1Var) {
        Object d10;
        js.h P;
        n g10 = e3.f30194a.g(h1Var.D());
        if (g10 instanceof n.d) {
            if (h1Var.F()) {
                ...
                return new js.a(jClass, arrayList, a.EnumC0431a.f31245e, a.b.f31249e, null, 16, null);
            }
            ...
            return new js.a(jClass2, arrayList2, a.EnumC0431a.f31245e, a.b.f31248d, d11);
        } else {
            throw new or.p();
        }
        ...
        return js.o.j(P, h1Var.D(), false, 2, null);
    }

    private final js.i M(Constructor constructor, FunctionDescriptor functionDescriptor, boolean z10) {
    ...
    private final js.h P(Method method, boolean z10) {
        Object S;
        if (G()) {
            if (V(method)) {
                S = this.f30215t;
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public static final js.h Q(h1 h1Var) {
        ...
        if (g10 instanceof n.e) {
            ...
            if (h1Var.F()) {
                ...
                return new js.a(jClass, arrayList, a.EnumC0431a.f31244d, a.b.f31249e, null, 16, null);
            }
            ...
            return new js.a(jClass2, arrayList2, a.EnumC0431a.f31244d, a.b.f31248d, d10);
        } else {
        ...
        return js.o.i(hVar, h1Var.D(), true);
    }

    /* JADX INFO: Access modifiers changed from: private */
    public static final FunctionDescriptor R(h1 h1Var, String str) {
        return h1Var.B().k(str, h1Var.f30214s);
    }

    private final Object S() {
        return js.o.h(this.f30215t, D());
    }
    ...
    @Override // is.a0
    public js.h A() {
        return (js.h) this.f30217v.getValue();
    }
    ...
    @Override // is.a0
    public js.h C() {
        return (js.h) this.f30218w.getValue();
    }

    @Override // is.a0
    public boolean G() {
        if (this.f30215t != CallableReference.NO_RECEIVER) {
            return true;
        }
        return false;
    }
    ...
    public FunctionDescriptor D() {
        Object b10 = this.f30216u.b(this, f30212x[0]);
    ...
    public boolean equals(Object obj) {
        h1 c10 = j3.c(obj);
        if (c10 == null || !Intrinsics.areEqual(B(), c10.B()) || !Intrinsics.areEqual(getName(), c10.getName()) || !Intrinsics.areEqual(this.f30214s, c10.f30214s) || !Intrinsics.areEqual(this.f30215t, c10.f30215t)) {
            return false;
        }
        return true;
    }
    ...
    public int hashCode() {
        return (((B().hashCode() * 31) + getName().hashCode()) * 31) + this.f30214s.hashCode();
    }
    ...
    private h1(c1 c1Var, String str, String str2, FunctionDescriptor functionDescriptor, Object obj) {
        ...
        this.f30214s = str2;
        this.f30215t = obj;
        this.f30216u = z2.b(functionDescriptor, new e1(this, str));
        or.o oVar = or.o.f44232e;
        this.f30217v = or.l.b(oVar, new f1(this));
        this.f30218w = or.l.b(oVar, new g1(this));
    }
    ...
    */
    public h1(is.c1 r10, kotlin.reflect.jvm.internal.impl.descriptors.FunctionDescriptor r11) {
        /*
            r9 = this;
            ...
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: is.h1.<init>(is.c1, kotlin.reflect.jvm.internal.impl.descriptors.FunctionDescriptor):void");
    }
}
