...
public class a2 extends j2 implements kotlin.reflect.j {
    ...
    public a2(c1 container, PropertyDescriptor descriptor) {
        ...
        this.f30159z = or.l.b(oVar, new y1(this));
        this.A = or.l.b(oVar, new z1(this));
    }
    ...
    /* renamed from: Y */
    public a getGetter() {
        return (a) this.f30159z.getValue();
    }
