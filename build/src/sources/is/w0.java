...
public final class w0 extends c1 implements KClass, x0, w2 {
    ...
    public final class a extends c1.b {
        ...
        public static final Collection E(w0 w0Var) {
            return w0Var.u(w0Var.L(), c1.d.f30175d);
        }

        /* JADX INFO: Access modifiers changed from: private */
        public static final Collection F(w0 w0Var) {
            return w0Var.u(w0Var.M(), c1.d.f30175d);
        }
        ...
        private final Collection M() {
            Object b10 = this.f30354o.b(this, f30342w[10]);
            Intrinsics.checkNotNullExpressionValue(b10, "getValue(...)");
            return (Collection) b10;
        }

        private final Collection O() {
            Object b10 = this.f30355p.b(this, f30342w[11]);
            Intrinsics.checkNotNullExpressionValue(b10, "getValue(...)");
            return (Collection) b10;
        }

        private final Collection P() {
            Object b10 = this.f30356q.b(this, f30342w[12]);
            Intrinsics.checkNotNullExpressionValue(b10, "getValue(...)");
            return (Collection) b10;
        }
        ...
        public static final Collection T(w0 w0Var) {
            return w0Var.u(w0Var.L(), c1.d.f30176e);
        }

        /* JADX INFO: Access modifiers changed from: private */
        public static final Collection U(w0 w0Var) {
            return w0Var.u(w0Var.M(), c1.d.f30176e);
        }
        ...
        public static final List a0(a aVar, w0 w0Var) {
            ...
            if (!KotlinBuiltIns.isSpecialClassWithNoSupertypes(aVar.N())) {
                ...
                arrayList.add(new t2(anyType, m0.f30257d));
            }
        ...
        public final Collection H() {
            Object b10 = this.f30360u.b(this, f30342w[16]);
            Intrinsics.checkNotNullExpressionValue(b10, "getValue(...)");
            return (Collection) b10;
        }

        public final Collection I() {
            Object b10 = this.f30357r.b(this, f30342w[13]);
            Intrinsics.checkNotNullExpressionValue(b10, "getValue(...)");
            return (Collection) b10;
        }

        public final Collection J() {
            Object b10 = this.f30358s.b(this, f30342w[14]);
            Intrinsics.checkNotNullExpressionValue(b10, "getValue(...)");
            return (Collection) b10;
        }

        public final List K() {
            Object b10 = this.f30344e.b(this, f30342w[1]);
            Intrinsics.checkNotNullExpressionValue(b10, "getValue(...)");
            return (List) b10;
        }

        public final Collection L() {
            Object b10 = this.f30353n.b(this, f30342w[9]);
            Intrinsics.checkNotNullExpressionValue(b10, "getValue(...)");
            return (Collection) b10;
        }

        public final ClassDescriptor N() {
            Object b10 = this.f30343d.b(this, f30342w[0]);
            Intrinsics.checkNotNullExpressionValue(b10, "getValue(...)");
            return (ClassDescriptor) b10;
        }

        public final String Q() {
            return (String) this.f30346g.b(this, f30342w[3]);
        }

        public final String R() {
            return (String) this.f30345f.b(this, f30342w[2]);
        }

        public final List S() {
            Object b10 = this.f30350k.b(this, f30342w[6]);
            Intrinsics.checkNotNullExpressionValue(b10, "getValue(...)");
            return (List) b10;
        }
    }
    ...
    /* synthetic */ class d extends FunctionReferenceImpl implements Function2 {
        ...
        /* renamed from: d  reason: collision with root package name */
        public static final d f30363d = new d();
    ...
    public w0(Class jClass) {
        ...
        this.f30340o = jClass;
        this.f30341p = or.l.b(or.o.f44232e, new b0(this));
    }
    ...
    public ClassDescriptor getDescriptor() {
        return ((a) this.f30341p.getValue()).N();
    }
    ...
    public boolean equals(Object obj) {
        if ((obj instanceof w0) && Intrinsics.areEqual(bs.a.c(this), bs.a.c((KClass) obj))) {
            return true;
        }
        return false;
    }
    ...
    public List getAnnotations() {
        return ((a) this.f30341p.getValue()).K();
    }
    ...
    public Collection getMembers() {
        return ((a) this.f30341p.getValue()).H();
    }

    @Override // kotlin.reflect.KClass
    public String getQualifiedName() {
        return ((a) this.f30341p.getValue()).Q();
    }

    @Override // kotlin.reflect.KClass
    public String getSimpleName() {
        return ((a) this.f30341p.getValue()).R();
    }

    @Override // kotlin.reflect.KClass
    public List getTypeParameters() {
        return ((a) this.f30341p.getValue()).S();
    }
    ...
    public PropertyDescriptor t(int i10) {
        ...
        if (Intrinsics.areEqual(getJClass().getSimpleName(), "DefaultImpls") && (declaringClass = getJClass().getDeclaringClass()) != null && declaringClass.isInterface()) {
            KClass e10 = bs.a.e(declaringClass);
        ...
        if (deserializedClassDescriptor != null) {
            ...
            if (property != null) {
                return (PropertyDescriptor) j3.h(getJClass(), property, deserializedClassDescriptor.getC().getNameResolver(), deserializedClassDescriptor.getC().getTypeTable(), deserializedClassDescriptor.getMetadataVersion(), d.f30363d);
            }
        }
        return null;
    }
