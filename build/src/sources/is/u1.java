...
public final class u1 extends c1 {
    ...
    private final Class f30320o;

    /* renamed from: p  reason: collision with root package name */
    private final Lazy f30321p;
    ...
    public final class a extends c1.b {
        ...
        static final /* synthetic */ KProperty[] f30322j = {Reflection.property1(new PropertyReference1Impl(a.class, "kotlinClass", "getKotlinClass()Lorg/jetbrains/kotlin/descriptors/runtime/components/ReflectKotlinClass;", 0)), Reflection.property1(new PropertyReference1Impl(a.class, "scope", "getScope()Lorg/jetbrains/kotlin/resolve/scopes/MemberScope;", 0)), Reflection.property1(new PropertyReference1Impl(a.class, "members", "getMembers()Ljava/util/Collection;", 0))};

        /* renamed from: d  reason: collision with root package name */
        private final z2.a f30323d;

        /* renamed from: e  reason: collision with root package name */
        private final z2.a f30324e;

        /* renamed from: f  reason: collision with root package name */
        private final Lazy f30325f;

        /* renamed from: g  reason: collision with root package name */
        private final Lazy f30326g;

        /* renamed from: h  reason: collision with root package name */
        private final z2.a f30327h;

        public a() {
            super();
            this.f30323d = z2.c(new p1(u1.this));
            this.f30324e = z2.c(new q1(this));
            or.o oVar = or.o.f44232e;
            this.f30325f = or.l.b(oVar, new r1(this, u1.this));
            this.f30326g = or.l.b(oVar, new s1(this));
            this.f30327h = z2.c(new t1(u1.this, this));
        }

        private final ReflectKotlinClass i() {
            return (ReflectKotlinClass) this.f30323d.b(this, f30322j[0]);
        }
        ...
        public static final Collection o(u1 u1Var, a aVar) {
            return u1Var.u(aVar.m(), c1.d.f30175d);
        }

        /* JADX INFO: Access modifiers changed from: private */
        public static final or.u p(a aVar) {
            ...
            if (i10 != null && (classHeader = i10.getClassHeader()) != null) {
                ...
                if (data != null && strings != null) {
                    ...
                    return new or.u((JvmNameResolver) readPackageDataFrom.a(), (ProtoBuf.Package) readPackageDataFrom.b(), classHeader.getMetadataVersion());
                }
            }
            return null;
        }
        ...
        public final Collection j() {
            Object b10 = this.f30327h.b(this, f30322j[2]);
            Intrinsics.checkNotNullExpressionValue(b10, "getValue(...)");
            return (Collection) b10;
        }

        public final or.u k() {
            return (or.u) this.f30326g.getValue();
        }

        public final Class l() {
            return (Class) this.f30325f.getValue();
        }

        public final MemberScope m() {
            Object b10 = this.f30324e.b(this, f30322j[1]);
            Intrinsics.checkNotNullExpressionValue(b10, "getValue(...)");
    ...
    /* synthetic */ class b extends FunctionReferenceImpl implements Function2 {
        ...
        /* renamed from: d  reason: collision with root package name */
        public static final b f30329d = new b();
    ...
    public u1(Class jClass) {
        ...
        this.f30320o = jClass;
        this.f30321p = or.l.b(or.o.f44232e, new o1(this));
    }
    ...
    private final MemberScope E() {
        return ((a) this.f30321p.getValue()).m();
    }
    ...
    public Collection getMembers() {
        return ((a) this.f30321p.getValue()).j();
    }
    ...
    public PropertyDescriptor t(int i10) {
        or.u k10 = ((a) this.f30321p.getValue()).k();
        if (k10 != null) {
            ...
            if (property != null) {
                ...
                return (PropertyDescriptor) j3.h(jClass, property, jvmNameResolver, new TypeTable(typeTable), metadataVersion, b.f30329d);
            }
        }
        return null;
    }
    ...
    @Override // is.c1
    protected Class v() {
        Class l10 = ((a) this.f30321p.getValue()).l();
        if (l10 == null) {
            return getJClass();
        }
        return l10;
