...
public final class m extends b0 {
    ...
    private final e f31193p;

    /* renamed from: q  reason: collision with root package name */
    private final /* synthetic */ AtomicReferenceArray f31194q;

    public m(long j10, m mVar, e eVar, int i10) {
        super(j10, mVar, i10);
        this.f31193p = eVar;
        this.f31194q = new AtomicReferenceArray(f.f31166b * 2);
    }
    ...
    public final void C(int i10, boolean z10) {
        if (z10) {
            y().w1((this.f37432i * f.f31166b) + i10);
        }
        t();
    }
    ...
    */
    public void s(int r4, java.lang.Throwable r5, kotlin.coroutines.CoroutineContext r6) {
        ...
        Le:
            ...
            boolean r2 = r1 instanceof gs.w1
            if (r2 != 0) goto L73
            boolean r2 = r1 instanceof is.x
            if (r2 == 0) goto L1b
            goto L73
        L1b:
            ls.e0 r2 = is.f.j()
        ...
        L62:
            ...
            if (r0 == 0) goto L99
            is.e r4 = r3.y()
            kotlin.jvm.functions.Function1 r4 = r4.f31146e
            if (r4 == 0) goto L99
            ls.x.a(r4, r5, r6)
            return
        L73:
        ...
        L99:
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: is.m.s(int, java.lang.Throwable, kotlin.coroutines.CoroutineContext):void");
    }
