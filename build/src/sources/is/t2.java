...
public final class t2 implements KTypeBase {
    ...
    static final /* synthetic */ KProperty[] f30311p = {Reflection.property1(new PropertyReference1Impl(t2.class, "classifier", "getClassifier()Lkotlin/reflect/KClassifier;", 0)), Reflection.property1(new PropertyReference1Impl(t2.class, "arguments", "getArguments()Ljava/util/List;", 0))};

    /* renamed from: d  reason: collision with root package name */
    private final KotlinType f30312d;

    /* renamed from: e  reason: collision with root package name */
    private final z2.a f30313e;

    /* renamed from: i  reason: collision with root package name */
    private final z2.a f30314i;

    /* renamed from: o  reason: collision with root package name */
    private final z2.a f30315o;
    ...
    public t2(KotlinType type, Function0 function0) {
        ...
        this.f30313e = aVar;
        this.f30314i = z2.c(new p2(this));
        this.f30315o = z2.c(new q2(this, function0));
    }
    ...
    public static final List f(t2 t2Var, Function0 function0) {
        s2 s2Var;
        KTypeProjection d10;
        List<TypeProjection> arguments = t2Var.f30312d.getArguments();
        if (arguments.isEmpty()) {
            return CollectionsKt.l();
        }
        Lazy b10 = or.l.b(or.o.f44232e, new r2(t2Var));
        ...
        for (Object obj : list) {
            ...
            if (typeProjection.isStarProjection()) {
                ...
                int i12 = a.f30316a[typeProjection.getProjectionKind().ordinal()];
                if (i12 != 1) {
                    if (i12 != 2) {
                        if (i12 == 3) {
        ...
        if (mo1199getDeclarationDescriptor instanceof ClassDescriptor) {
            ...
            if (q10.isArray()) {
                ...
                if (typeProjection != null && (type = typeProjection.getType()) != null) {
                    ...
                    if (k10 != null) {
                        return new w0(j3.f(bs.a.b(hs.b.a(k10))));
                    }
            ...
            throw new or.q("An operation is not implemented: Type alias classifiers are not yet supported");
        }
    }
    ...
    public boolean equals(Object obj) {
        if (obj instanceof t2) {
            t2 t2Var = (t2) obj;
            if (Intrinsics.areEqual(this.f30312d, t2Var.f30312d) && Intrinsics.areEqual(getClassifier(), t2Var.getClassifier()) && Intrinsics.areEqual(getArguments(), t2Var.getArguments())) {
                return true;
            }
            return false;
        }
    ...
    public List getAnnotations() {
        return j3.e(this.f30312d);
    }

    @Override // kotlin.jvm.internal.KTypeBase, kotlin.reflect.KType
    public List getArguments() {
        Object b10 = this.f30315o.b(this, f30311p[1]);
    ...
    public kotlin.reflect.d getClassifier() {
        return (kotlin.reflect.d) this.f30314i.b(this, f30311p[0]);
    }

    @Override // kotlin.jvm.internal.KTypeBase
    public Type getJavaType() {
        z2.a aVar = this.f30313e;
        if (aVar != null) {
    ...
    public int hashCode() {
        int i10;
        int hashCode = this.f30312d.hashCode() * 31;
    ...
    public boolean isMarkedNullable() {
        return this.f30312d.isMarkedNullable();
    }
    ...
    public String toString() {
        return d3.f30186a.l(this.f30312d);
    }
