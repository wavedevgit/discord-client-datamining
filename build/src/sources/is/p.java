...
public abstract class p {
    ...
    public static final class a extends p {
        ...
        public String a() {
            ...
            String name = this.f30275a.getName();
            Intrinsics.checkNotNullExpressionValue(name, "getName(...)");
            sb2.append(JvmAbi.getterName(name));
            sb2.append("()");
            Class<?> type = this.f30275a.getType();
    ...
    public static final class b extends p {
        ...
        private final Method f30277b;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        public b(Method getterMethod, Method method) {
            super(null);
            Intrinsics.checkNotNullParameter(getterMethod, "getterMethod");
            this.f30276a = getterMethod;
            this.f30277b = method;
        }
    ...
    public static final class c extends p {
        ...
        /* renamed from: a  reason: collision with root package name */
        private final PropertyDescriptor f30278a;

        /* renamed from: b  reason: collision with root package name */
        private final ProtoBuf.Property f30279b;

        /* renamed from: c  reason: collision with root package name */
        private final JvmProtoBuf.JvmPropertySignature f30280c;

        /* renamed from: d  reason: collision with root package name */
        private final NameResolver f30281d;

        /* renamed from: e  reason: collision with root package name */
        private final TypeTable f30282e;
        ...
        public c(PropertyDescriptor descriptor, ProtoBuf.Property proto, JvmProtoBuf.JvmPropertySignature signature, NameResolver nameResolver, TypeTable typeTable) {
            ...
            this.f30278a = descriptor;
            this.f30279b = proto;
            this.f30280c = signature;
            this.f30281d = nameResolver;
            this.f30282e = typeTable;
        ...
        private final String c() {
            DeclarationDescriptor containingDeclaration = this.f30278a.getContainingDeclaration();
            Intrinsics.checkNotNullExpressionValue(containingDeclaration, "getContainingDeclaration(...)");
            if (Intrinsics.areEqual(this.f30278a.getVisibility(), DescriptorVisibilities.INTERNAL) && (containingDeclaration instanceof DeserializedClassDescriptor)) {
                ...
                String str = (num == null || (str = this.f30281d.getString(num.intValue())) == null) ? "main" : "main";
                return '$' + NameUtils.sanitizeAsJavaIdentifier(str);
            } else if (Intrinsics.areEqual(this.f30278a.getVisibility(), DescriptorVisibilities.PRIVATE) && (containingDeclaration instanceof PackageFragmentDescriptor)) {
                PropertyDescriptor propertyDescriptor = this.f30278a;
    ...
    public static final class d extends p {
        ...
        /* renamed from: a  reason: collision with root package name */
        private final n.e f30284a;

        /* renamed from: b  reason: collision with root package name */
        private final n.e f30285b;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        public d(n.e getterSignature, n.e eVar) {
            super(null);
            Intrinsics.checkNotNullParameter(getterSignature, "getterSignature");
            this.f30284a = getterSignature;
            this.f30285b = eVar;
        }
