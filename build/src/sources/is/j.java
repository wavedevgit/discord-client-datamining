...
public class j extends DeclarationDescriptorVisitorEmptyBodies {
    ...
    private final c1 f30225a;

    public j(c1 container) {
        Intrinsics.checkNotNullParameter(container, "container");
        this.f30225a = container;
    }
    ...
    public a0 visitFunctionDescriptor(FunctionDescriptor descriptor, Unit data) {
        ...
        return new h1(this.f30225a, descriptor);
    }
    ...
    public a0 visitPropertyDescriptor(PropertyDescriptor descriptor, Unit data) {
        ...
        if (descriptor.isVar()) {
            if (i12 != 0) {
                if (i12 != 1) {
                    if (i12 == 2) {
                        return new n1(this.f30225a, descriptor);
                    }
                } else {
                    return new l1(this.f30225a, descriptor);
                }
            } else {
                return new j1(this.f30225a, descriptor);
            }
        } else if (i12 != 0) {
            if (i12 != 1) {
                if (i12 == 2) {
                    return new g2(this.f30225a, descriptor);
                }
            } else {
                return new d2(this.f30225a, descriptor);
            }
        } else {
            return new a2(this.f30225a, descriptor);
        }
