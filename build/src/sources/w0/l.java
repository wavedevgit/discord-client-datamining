...
public final class l implements os.z {
    ...
    private final CoroutineContext f53245d;

    /* renamed from: e  reason: collision with root package name */
    private final Function2 f53246e;

    /* renamed from: i  reason: collision with root package name */
    private final CoroutineScope f53247i;

    public l(CoroutineContext coroutineContext, Function2 function2) {
        CoroutineContext coroutineContext2;
        this.f53245d = coroutineContext;
        this.f53246e = function2;
        if (coroutineContext.m(z0.a.f55815d) != null) {
            coroutineContext2 = this;
        } else {
            coroutineContext2 = kotlin.coroutines.e.f32082d;
        }
        this.f53247i = kotlinx.coroutines.i.a(coroutineContext.Y0(coroutineContext2));
    }

    @Override // os.z
    public void V0(CoroutineContext coroutineContext, Throwable th2) {
        android.support.v4.media.session.b.a(coroutineContext.m(z0.a.f55815d));
        os.z zVar = (os.z) this.f53245d.m(os.z.f43544j);
        if (zVar != null) {
