...
public abstract class z extends y0.o implements y0.l {
    ...
    public static final class a extends y0.p {
        ...
        /* renamed from: f */
        public a a(long j10) {
            return new a(y0.k.e().d(), this.f52094c);
        }
    ...
    public Object getValue() {
        return ((a) y0.k.m(this.f52093i, this)).g();
    }

    @Override // w0.q
    public void setValue(Object obj) {
        y0.e a10;
        a aVar = (a) y0.k.d(this.f52093i);
        if (!d().a(aVar.g(), obj)) {
            a aVar2 = this.f52093i;
            synchronized (y0.k.g()) {
                a10 = y0.e.f55291d.a();
    ...
    public String toString() {
        return "MutableState(value=" + ((a) y0.k.d(this.f52093i)).g() + ")@" + hashCode();
    }
}
