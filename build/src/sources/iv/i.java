...
final class i extends e.a {
    ...
    private final Executor f31334a;

    /* loaded from: /home/runner/work/discord-client-datamining/discord-client-datamining/build/classes5.dex */
    class a implements e {

        /* renamed from: a  reason: collision with root package name */
        final /* synthetic */ Type f31335a;

        /* renamed from: b  reason: collision with root package name */
        final /* synthetic */ Executor f31336b;
    ...
    public static final class b implements d {
        ...
        public class a implements f {
            ...
            public void a(d dVar, final Throwable th2) {
                Executor executor = b.this.f31338d;
                final f fVar = this.f31340a;
        ...
        @Override // iv.d
        public Request h() {
            return this.f31339e.h();
        }

        @Override // iv.d
        public boolean x() {
            return this.f31339e.x();
        }

        @Override // iv.d
        /* renamed from: clone */
        public d m1190clone() {
            return new b(this.f31338d, this.f31339e.clone());
        }
    }

    /* JADX INFO: Access modifiers changed from: package-private */
    public i(Executor executor) {
        this.f31334a = executor;
    }
