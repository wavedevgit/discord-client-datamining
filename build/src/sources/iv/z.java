...
public final class z<T> {
    ...
    public static z c(int i10, ResponseBody responseBody) {
        ...
        if (i10 >= 400) {
            return d(responseBody, new Response.a().b(new s.c(responseBody.contentType(), responseBody.contentLength())).g(i10).m("Response.error()").p(tt.j.HTTP_1_1).r(new Request.Builder().l("http://localhost/").b()).c());
        }
    ...
    public static z i(Object obj) {
        return j(obj, new Response.a().g(androidx.recyclerview.widget.h.DEFAULT_DRAG_ANIMATION_DURATION).m("OK").p(tt.j.HTTP_1_1).r(new Request.Builder().l("http://localhost/").b()).c());
    }
