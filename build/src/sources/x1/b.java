...
public final class b {
    ...
    private final int c() {
        ...
        Integer num = (Integer) this.f53143e.get(str + '/' + str2 + '/' + str3 + ':' + str4);
        if (num == null) {
            num = Integer.valueOf(this.f53142d);
        }
        return num.intValue();
    }
