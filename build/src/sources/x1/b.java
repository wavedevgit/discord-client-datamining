...
public final class b {
    ...
    private final int c() {
        ...
        Integer num = (Integer) this.f53351e.get(str + '/' + str2 + '/' + str3 + ':' + str4);
        if (num == null) {
            num = Integer.valueOf(this.f53350d);
        }
        return num.intValue();
    }
