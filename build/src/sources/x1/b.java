...
public final class b {
    ...
    private final int c() {
        ...
        Integer num = (Integer) this.f54432e.get(str + '/' + str2 + '/' + str3 + ':' + str4);
        if (num == null) {
            num = Integer.valueOf(this.f54431d);
        }
        return num.intValue();
    }
