...
public abstract class e {
    ...
    public static final e f6208d;

    /* renamed from: e  reason: collision with root package name */
    public static final e f6209e;

    /* renamed from: i  reason: collision with root package name */
    public static final e f6210i;

    /* renamed from: o  reason: collision with root package name */
    public static final e f6211o;

    /* renamed from: p  reason: collision with root package name */
    private static final int[] f6212p;

    /* renamed from: q  reason: collision with root package name */
    private static final double[] f6213q;

    /* renamed from: r  reason: collision with root package name */
    private static final double[] f6214r;

    /* renamed from: s  reason: collision with root package name */
    private static final double[][] f6215s;

    /* renamed from: t  reason: collision with root package name */
    private static final /* synthetic */ e[] f6216t;
    ...
    enum a extends e {
        ...
        private double n(double d10) {
            i0 t02 = au.c.f(d10).h().t0(p.f38354v);
            return t02.V().B0() + (((Integer) t02.X().k(g0.K)).intValue() / 86400.0d);
        }

        private double o(double d10) {
            double d11 = (d10 * 0.9856d) - 3.289d;
            return au.a.b((Math.sin(Math.toRadians(d11)) * 1.916d) + d11 + (Math.sin(Math.toRadians(d11) * 2.0d) * 0.02d) + 282.634d);
        }
        ...
        public double l(double d10) {
            double o10 = o(n(d10));
            double b10 = au.a.b(Math.toDegrees(Math.atan(Math.tan(Math.toRadians(o10)) * 0.91764d)));
    ...
    static {
        ...
        f6208d = aVar;
        e eVar = new e("NOAA", 1) { // from class: au.e.b
            private double n(double d10) {
            ...
            public double l(double d10) {
                ...
                return au.a.b(Math.toDegrees(Math.atan2(Math.cos(Math.toRadians(s(m10))) * Math.sin(radians), Math.cos(radians))));
            }
        };
        f6209e = eVar;
        e eVar2 = new e("CC", 2) { // from class: au.e.c
            private double n(double d10) {
            ...
            public double h(double d10, String str) {
                ...
                if (str.equals("right-ascension")) {
                    ...
                    return au.a.b(Math.toDegrees(Math.atan2(Math.cos(Math.toRadians(r(m10))) * Math.sin(radians), Math.cos(radians))));
        ...
        f6210i = eVar2;
        e eVar3 = new e("TIME4J", 3) { // from class: au.e.d
            private double n(double d10) {
            ...
            public double h(double d10, String str) {
                ...
                if (str.equals("right-ascension")) {
                    ...
                    return au.a.b(Math.toDegrees(Math.atan2(Math.cos(Math.toRadians(e.i(m10) + dArr[1])) * Math.sin(radians), Math.cos(radians))));
                } else if (str.equals("nutation")) {
    ...
    public static double f(double d10, double d11) {
        double d12 = 0.0d;
        for (int length = f6212p.length - 1; length >= 0; length--) {
            d12 += f6212p[length] * Math.sin(Math.toRadians(f6213q[length] + (f6214r[length] * d10)));
        }
    ...
    static void k(double d10, double[] dArr) {
        ...
        double d11 = 0.0d;
        double d12 = 0.0d;
        for (int length = f6215s.length - 1; length >= 0; length--) {
            double[] dArr2 = f6215s[length];
