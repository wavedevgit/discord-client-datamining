...
public final class c implements Serializable {
    ...
    public static /* synthetic */ class a {
        ...
        static {
            ...
            try {
                f6192a[f.TT.ordinal()] = 2;
            } catch (NoSuchFieldError unused2) {
            }
            try {
                f6192a[f.POSIX.ordinal()] = 3;
    ...
    static double d(a0 a0Var, f fVar) {
        return ((a0Var.s(fVar) + e(fVar)) + (a0Var.u(fVar) / 1.0E9d)) / 86400.0d;
    }
    ...
    public a0 h() {
        ...
        f fVar2 = this.scale;
        if (!iu.d.x().G() && fVar2 != (fVar = f.POSIX)) {
            if (fVar2 == f.TT) {
                f0 M0 = f0.M0((long) Math.floor(b()), bu.a0.MODIFIED_JULIAN_DATE);
                d10 -= f.d(M0.f(), M0.q());
            }
            d10 += 6.3072E7d;
            fVar2 = fVar;
        }
        return a0.l0(zt.c.m((long) d10, e(fVar2)), (int) ((d10 - Math.floor(d10)) * 1.0E9d), fVar2);
    }

    public int hashCode() {
        return au.a.a(this.value) ^ this.scale.hashCode();
    }
