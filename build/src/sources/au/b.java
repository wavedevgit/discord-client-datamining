...
public class b implements s {
    ...
    private static final ConcurrentMap f6209a = new ConcurrentHashMap();

    /* renamed from: b  reason: collision with root package name */
    private static final Set f6210b;

    /* renamed from: c  reason: collision with root package name */
    private static final Map f6211c;

    /* renamed from: d  reason: collision with root package name */
    private static final Map f6212d;
    ...
    static {
        ...
        hashSet.add("Zulu");
        f6210b = Collections.unmodifiableSet(hashSet);
        HashMap hashMap = new HashMap();
        g(hashMap, "data/zone1970.tab");
        f6211c = Collections.unmodifiableMap(hashMap);
        ...
        f6212d = Collections.unmodifiableMap(hashMap2);
    }
    ...
    public Set b(Locale locale, boolean z10) {
        ...
        if (z10) {
            ...
            String str = (String) f6212d.get(country);
            if (str != null) {
                return Collections.singleton(str);
            }
        }
        Set set = (Set) f6211c.get(country);
        if (set == null) {
    ...
    public String f(String str, net.time4j.tz.d dVar, Locale locale) {
        if (f6210b.contains(str)) {
            return "";
        }
        Map map = (Map) f6209a.get(locale);
        if (map == null) {
            ...
            map = (Map) f6209a.putIfAbsent(locale, hashMap);
            if (map == null) {
                map = hashMap;
            }
        }
