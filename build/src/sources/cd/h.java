    ...
    */
    private static md.m g(oe.h0 r3) {
        /*
            ...
            r0 = 0
            if (r3 <= 0) goto L11
            java.lang.String[] r1 = cd.h.f7444a
            int r2 = r1.length
            if (r3 > r2) goto L11
            int r3 = r3 + (-1)
            r3 = r1[r3]
    ...
    public static void k(int i10, v vVar, Format.b bVar) {
        if (i10 == 1 && vVar.a()) {
            bVar.P(vVar.f51528a).Q(vVar.f51529b);
        }
    }
        ...
        if (metadata2 != null) {
            for (int i11 = 0; i11 < metadata2.e(); i11++) {
                ...
                if (d10 instanceof nd.a) {
                    nd.a aVar = (nd.a) d10;
                    if (aVar.f38156d.equals("com.android.capture.fps")) {
                        if (i10 == 2) {
