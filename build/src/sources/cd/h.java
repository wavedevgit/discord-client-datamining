...
abstract class h {
    ...
    private static md.a b(h0 h0Var) {
        ...
        if (h0Var.q() == 1684108385) {
            ...
            h0Var.l(bArr, 0, i10);
            return new md.a(str, null, 3, bArr);
        }
    ...
    private static md.m d(int i10, String str, h0 h0Var) {
        int q10 = h0Var.q();
        if (h0Var.q() == 1684108385 && q10 >= 22) {
            ...
            if (N > 0) {
                ...
                return new md.m(str, null, s.u(str2));
            }
        }
    ...
    private static md.i e(h0 h0Var, int i10) {
        String str = null;
        String str2 = null;
        int i11 = -1;
        int i12 = -1;
        ...
        h0Var.U(i11);
        h0Var.V(16);
        return new md.j(str, str2, h0Var.C(i12 - 16));
    }

    public static nd.a f(h0 h0Var, int i10, String str) {
        while (true) {
            int f10 = h0Var.f();
            if (f10 < i10) {
                int q10 = h0Var.q();
                if (h0Var.q() == 1684108385) {
                    ...
                    h0Var.l(bArr, 0, i11);
                    return new nd.a(str, bArr, q12, q11);
                }
                h0Var.U(f10 + q10);
            } else {
                return null;
    ...
    */
    private static md.m g(oe.h0 r3) {
        /*
            int r3 = j(r3)
            r0 = 0
            if (r3 <= 0) goto L11
            java.lang.String[] r1 = cd.h.f8125a
            int r2 = r1.length
            if (r3 > r2) goto L11
            int r3 = r3 + (-1)
            r3 = r1[r3]
        ...
        L20:
            ...
            return r0
        */
        throw new UnsupportedOperationException("Method not decompiled: cd.h.g(oe.h0):md.m");
    }

    private static md.m h(int i10, String str, h0 h0Var) {
        int q10 = h0Var.q();
        if (h0Var.q() == 1684108385) {
            h0Var.V(8);
            return new md.m(str, null, s.u(h0Var.C(q10 - 16)));
        }
        y.i("MetadataUtil", "Failed to parse text attribute: " + a.a(i10));
        return null;
    }

    private static md.i i(int i10, String str, h0 h0Var, boolean z10, boolean z11) {
        int j10 = j(h0Var);
        if (z11) {
            j10 = Math.min(1, j10);
        }
        if (j10 >= 0) {
            if (z10) {
                return new md.m(str, null, s.u(Integer.toString(j10)));
            }
            return new md.e("und", str, Integer.toString(j10));
        }
    ...
    public static void k(int i10, v vVar, Format.b bVar) {
        if (i10 == 1 && vVar.a()) {
            bVar.P(vVar.f51276a).Q(vVar.f51277b);
        }
    }
    ...
    public static void l(int i10, Metadata metadata, Metadata metadata2, Format.b bVar, Metadata... metadataArr) {
        ...
        if (metadata2 != null) {
            for (int i11 = 0; i11 < metadata2.e(); i11++) {
                ...
                if (d10 instanceof nd.a) {
                    nd.a aVar = (nd.a) d10;
                    if (aVar.f37729d.equals("com.android.capture.fps")) {
                        if (i10 == 2) {
