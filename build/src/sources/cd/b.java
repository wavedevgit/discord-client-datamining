...
final class b extends i {
    ...
    private static final class a implements g {
        ...
        private long f8248c = -1;

        /* renamed from: d  reason: collision with root package name */
        private long f8249d = -1;
        ...
        public z b() {
            ...
            ne.a.g(z10);
            return new s(this.f8246a, this.f8248c);
        }
    ...
    protected boolean h(h0 h0Var, long j10, i.b bVar) {
        ...
        if (tVar == null) {
            ...
            this.f8244n = tVar2;
            bVar.f8286a = tVar2.g(Arrays.copyOfRange(e10, 9, h0Var.g()), null);
            return true;
        } else if ((e10[0] & ByteCompanionObject.MAX_VALUE) == 3) {
            t.a f10 = r.f(h0Var);
            t b10 = tVar.b(f10);
            this.f8244n = b10;
            this.f8245o = new a(b10, f10);
            return true;
        } else if (!o(e10)) {
            return true;
        } else {
