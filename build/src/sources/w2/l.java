...
public final class l {
    ...
    private final CoroutineScope f52696a;

    /* renamed from: b  reason: collision with root package name */
    private final Function2 f52697b;

    /* renamed from: c  reason: collision with root package name */
    private final at.g f52698c;

    /* renamed from: d  reason: collision with root package name */
    private final AtomicInteger f52699d;

    /* loaded from: /home/runner/work/discord-client-datamining/discord-client-datamining/build/classes.dex */
    static final class a extends Lambda implements Function1 {

        /* renamed from: d  reason: collision with root package name */
        final /* synthetic */ Function1 f52700d;

        /* renamed from: e  reason: collision with root package name */
        final /* synthetic */ l f52701e;

        /* renamed from: i  reason: collision with root package name */
        final /* synthetic */ Function2 f52702i;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        a(Function1 function1, l lVar, Function2 function2) {
            super(1);
            this.f52700d = function1;
            this.f52701e = lVar;
            this.f52702i = function2;
        }
        ...
        public final void invoke(Throwable th2) {
            Unit unit;
            this.f52700d.invoke(th2);
            this.f52701e.f52698c.v(th2);
            do {
                Object f10 = at.k.f(this.f52701e.f52698c.o());
                if (f10 == null) {
                    unit = null;
                    continue;
                } else {
                    this.f52702i.invoke(f10, th2);
                    unit = Unit.f32556a;
                    continue;
                }
            } while (unit != null);
        ...
        */
        public final java.lang.Object invokeSuspend(java.lang.Object r6) {
            ...
            L12:
                ...
                throw r6
            L1a:
                java.lang.Object r1 = r5.f52703d
    ...
    public l(CoroutineScope scope, Function1 onComplete, Function2 onUndeliveredElement, Function2 consumeMessage) {
        ...
        this.f52696a = scope;
        this.f52697b = consumeMessage;
        this.f52698c = at.j.b(Integer.MAX_VALUE, null, null, 6, null);
        this.f52699d = new AtomicInteger(0);
        Job job = (Job) scope.getCoroutineContext().m(Job.f35565k);
        if (job == null) {
            return;
        }
    ...
    public final void e(Object obj) {
        ...
        if (d10 instanceof k.a) {
            ...
            if (this.f52699d.getAndIncrement() == 0) {
                ys.i.d(this.f52696a, null, null, new b(null), 3, null);
            }
        } else {
