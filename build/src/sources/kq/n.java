...
public final class n extends RecyclerView.Adapter {
    ...
    private final InputSelectBoxComponentStyle f35021b;

    /* renamed from: c  reason: collision with root package name */
    private final boolean f35022c;

    /* renamed from: d  reason: collision with root package name */
    private final Function1 f35023d;

    /* renamed from: e  reason: collision with root package name */
    private String f35024e;

    /* renamed from: f  reason: collision with root package name */
    private final LayoutInflater f35025f;

    /* renamed from: g  reason: collision with root package name */
    private Set f35026g;

    /* renamed from: h  reason: collision with root package name */
    private final androidx.recyclerview.widget.c f35027h;
    ...
    public n(Context context, List options, InputSelectBoxComponentStyle inputSelectBoxComponentStyle, boolean z10, List initialSelectedOptions, Function1 onClick) {
        ...
        this.f35020a = options;
        this.f35021b = inputSelectBoxComponentStyle;
        this.f35022c = z10;
        this.f35023d = onClick;
        this.f35025f = LayoutInflater.from(context);
        this.f35027h = new androidx.recyclerview.widget.c(this, new a());
        ...
        this.f35026g = CollectionsKt.k1(arrayList2);
        h();
    }
    ...
    private final void f(int i10) {
        ...
        b4 b4Var = (b4) this.f35027h.a().get(i10);
        if (this.f35026g.contains(b4Var)) {
            this.f35026g.remove(b4Var);
        } else {
            Set set = this.f35026g;
            Intrinsics.checkNotNull(b4Var);
            set.add(b4Var);
        }
        notifyItemChanged(i10);
        Function1 function1 = this.f35023d;
        Intrinsics.checkNotNull(b4Var);
        function1.invoke(b4Var);
    }

    public final List c() {
        return CollectionsKt.h1(this.f35026g);
    }
    ...
    public void onBindViewHolder(final RecyclerView.ViewHolder holder, int i10) {
        ...
        qVar.f30397c.setText(b4Var.getText());
        qVar.getRoot().setOnClickListener(new View.OnClickListener() { // from class: kq.l
            @Override // android.view.View.OnClickListener
            public final void onClick(View view) {
                n.d(n.this, holder, view);
            }
        });
        qVar.f30396b.setOnClickListener(new View.OnClickListener() { // from class: kq.m
            @Override // android.view.View.OnClickListener
            public final void onClick(View view) {
                n.e(n.this, holder, view);
            }
        });
        boolean contains = this.f35026g.contains(b4Var);
        qVar.f30396b.setChecked(contains);
        InputSelectBoxComponentStyle inputSelectBoxComponentStyle = this.f35021b;
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int i10) {
        ...
        q c10 = q.c(this.f35025f, parent, false);
        ...
        if (inputSelectBoxComponentStyle != null) {
            TextView label = qVar.f30397c;
            Intrinsics.checkNotNullExpressionValue(label, "label");
            f0.n(label, inputSelectBoxComponentStyle.getTextBasedStyle(), null, 2, null);
        }
        if (this.f35022c) {
            qVar.f30396b.setVisibility(0);
            qVar.f30396b.setButtonTintList(ColorStateList.valueOf(qVar.f30397c.getCurrentTextColor()));
            return b0Var;
        }
        qVar.f30396b.setVisibility(8);
        return b0Var;
    }
}
