...
public abstract class o {
    ...
    /* JADX WARN: Type inference failed for: r0v46, types: [kq.h, T] */
    public static final void i(final TextInputLayout textInputLayout, InputSelectComponentStyle styles) {
        ...
        if (baseBackgroundColorValue != null) {
            ...
            objectRef.element = new Function1() { // from class: kq.h
            ...
            textInputLayout.addOnLayoutChangeListener(new View.OnLayoutChangeListener() { // from class: kq.i
        ...
        if (topBorderWidthValue != null) {
            ...
            textInputLayout.setBoxStrokeWidth((int) Math.ceil(rp.h.a(doubleValue)));
            textInputLayout.setBoxStrokeWidthFocused((int) Math.ceil(rp.h.a(doubleValue)));
        }
        if (textInputLayout.getBoxStrokeWidth() == 0) {
            ...
            if (d10 > 0.0d) {
                ...
                if (bottomBorderWidthValue2 != null) {
                    d11 = rp.h.a(bottomBorderWidthValue2.doubleValue());
                }
        ...
        if (borderRadiusValue != null) {
            ...
            textInputLayout.Z((float) rp.h.a(doubleValue2), (float) rp.h.a(doubleValue2), (float) rp.h.a(doubleValue2), (float) rp.h.a(doubleValue2));
        }
        StyleElements.SizeSet inputSelectBoxMargins = styles.getInputSelectBoxMargins();
        if (inputSelectBoxMargins != null) {
            nq.d.c(textInputLayout, inputSelectBoxMargins);
        }
        ...
        if (editText2 != null) {
            nq.d.c(editText2, new StyleElements.SizeSet(new StyleElements.DPSize(valueOf), new StyleElements.DPSize(valueOf), new StyleElements.DPSize(valueOf), new StyleElements.DPSize(valueOf)));
        }
        ...
        if (baseTextColor != null) {
            ...
            textInputLayout.addOnLayoutChangeListener(new View.OnLayoutChangeListener() { // from class: kq.j
                @Override // android.view.View.OnLayoutChangeListener
                public final void onLayoutChange(View view, int i27, int i28, int i29, int i30, int i31, int i32, int i33, int i34) {
        ...
        if (labelBaseTextColor != null) {
            ...
            textInputLayout.addOnLayoutChangeListener(new View.OnLayoutChangeListener() { // from class: kq.k
                @Override // android.view.View.OnLayoutChangeListener
                public final void onLayoutChange(View view, int i27, int i28, int i29, int i30, int i31, int i32, int i33, int i34) {
        ...
        if (placeholderBaseTextColor != null) {
            ...
            textInputLayout.addOnLayoutChangeListener(new View.OnLayoutChangeListener() { // from class: kq.l
                @Override // android.view.View.OnLayoutChangeListener
                public final void onLayoutChange(View view, int i27, int i28, int i29, int i30, int i31, int i32, int i33, int i34) {
        ...
        if (editText4 != null) {
            editText4.setOnFocusChangeListener(new View.OnFocusChangeListener() { // from class: kq.m
    ...
    public static final void l(TextInputLayout textInputLayout, final Ref.ObjectRef objectRef, View view, final boolean z10) {
        textInputLayout.post(new Runnable() { // from class: kq.n
