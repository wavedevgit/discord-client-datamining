...
public final class a implements m {
    ...
    private static final p[] f38710b = new p[0];

    /* renamed from: a  reason: collision with root package name */
    private final d f38711a = new d();
    ...
    public Result a(c cVar, Map map) {
        ...
        if (map != null && map.containsKey(fk.e.PURE_BARCODE)) {
            eVar = this.f38711a.b(b(cVar.a()));
            b10 = f38710b;
        } else {
            g b11 = new ok.a(cVar.a()).b();
            e b12 = this.f38711a.b(b11.a());
            b10 = b11.b();
            eVar = b12;
        }
        Result result = new Result(eVar.k(), eVar.g(), b10, fk.a.DATA_MATRIX);
        List a10 = eVar.a();
        if (a10 != null) {
