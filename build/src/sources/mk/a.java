...
public final class a implements m {
    ...
    private static final p[] f39077b = new p[0];

    /* renamed from: a  reason: collision with root package name */
    private final c f39078a = new c();
    ...
    public Result a(ck.c cVar, Map map) {
        e b10 = this.f39078a.b(b(cVar.a()), map);
        Result result = new Result(b10.k(), b10.g(), f39077b, ck.a.MAXICODE);
