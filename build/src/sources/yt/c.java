...
public final class c implements u, vt.c {

    /* renamed from: a  reason: collision with root package name */
    private static final Set f55778a;

    /* renamed from: b  reason: collision with root package name */
    private static final Set f55779b;
    ...
    static {
        ...
        f55779b = Collections.unmodifiableSet(hashSet2);
    }
    ...
    private static char t(tt.e eVar) {
    ...
    public boolean c(Locale locale) {
        return f55778a.contains(d.a(locale));
    }

    @Override // vt.c
    public String d(tt.e eVar, Locale locale, boolean z10) {
        String str;
        if (z10 && eVar == tt.e.FULL) {
            str = "F(alt)";
        } else {
            str = "F(" + t(eVar) + ")_t";
        }
