...
public final class e {
    ...
    private static final ConcurrentMap f55786e = new ConcurrentHashMap(32);

    /* renamed from: f  reason: collision with root package name */
    private static final ReferenceQueue f55787f = new ReferenceQueue();

    /* renamed from: a  reason: collision with root package name */
    private final e f55788a;

    /* renamed from: b  reason: collision with root package name */
    private final Map f55789b;

    /* renamed from: c  reason: collision with root package name */
    private final String f55790c;

    /* renamed from: d  reason: collision with root package name */
    private final Locale f55791d;
    ...
    private static class b {
        ...
        public boolean equals(Object obj) {
            ...
            if (obj instanceof b) {
                b bVar = (b) obj;
                if (this.f55793a.equals(bVar.f55793a) && this.f55794b.equals(bVar.f55794b)) {
                    return true;
                }
            }
            return false;
        ...
        public int hashCode() {
            return (this.f55793a.hashCode() << 3) ^ this.f55794b.hashCode();
        }

        public String toString() {
            return this.f55793a + "/" + this.f55794b;
        }
    }
    ...
    private e(g gVar, String str, Locale locale) {
        ...
        while (true) {
            ...
            if (g10 != null) {
                ...
                this.f55789b = Collections.unmodifiableMap(hashMap);
                return;
            }
        }
    }
    ...
    public static e h(String str, Locale locale) {
        ...
        if (!str.isEmpty()) {
            if (locale != null) {
                ...
                a aVar = (a) f55786e.get(bVar);
                if (aVar != null && (eVar = (e) aVar.get()) != null) {
                    return eVar;
                }
                while (true) {
                    Reference poll = f55787f.poll();
                    if (poll == null) {
                        break;
                    }
                    f55786e.remove(((a) poll).f55792a);
                }
                ...
                if (!arrayList.isEmpty()) {
                    ...
                    f55786e.putIfAbsent(bVar, new a(eVar2, bVar));
                    return eVar2;
                }
    ...
    private static e i(String str, Locale locale) {
        ...
        InputStream e10 = qt.d.c().e(qt.d.c().f(substring, e.class, j10), true);
        g gVar = null;
        if (e10 == null) {
            try {
                e10 = qt.d.c().d(e.class, j10, true);
    ...
    public boolean b(String str) {
        if (str != null) {
            e eVar = this;
            while (((String) eVar.f55789b.get(str)) == null) {
                eVar = eVar.f55788a;
                if (eVar == null) {
                    return false;
                }
    ...
    public String f(String str) {
        if (str != null) {
            e eVar = this;
            do {
                String str2 = (String) eVar.f55789b.get(str);
                if (str2 != null) {
                    return str2;
                }
                eVar = eVar.f55788a;
            } while (eVar != null);
            throw new MissingResourceException("Cannot find property resource for: " + j(this.f55790c, this.f55791d) + "=>" + str, e.class.getName(), str);
        }
        throw new NullPointerException("Missing resource key.");
    }

    public Set g() {
        HashSet hashSet = new HashSet(this.f55789b.keySet());
        e eVar = this;
        while (true) {
            eVar = eVar.f55788a;
            if (eVar != null) {
                hashSet.addAll(eVar.f55789b.keySet());
            } else {
    ...
    private e(e eVar, e eVar2) {
        this.f55788a = eVar2;
        this.f55790c = eVar.f55790c;
        this.f55791d = eVar.f55791d;
        this.f55789b = eVar.f55789b;
    }
}
