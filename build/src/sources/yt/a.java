...
public abstract class a {
    ...
    private static final AtomicBoolean f56407a = new AtomicBoolean(false);

    /* renamed from: b  reason: collision with root package name */
    private static final AtomicBoolean f56408b = new AtomicBoolean(false);
    ...
    public static void d(Context context) {
        if (context != null && !f56408b.getAndSet(true)) {
