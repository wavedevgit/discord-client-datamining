...
public class i implements y {
    ...
    private final Map f55804c;

    /* renamed from: d  reason: collision with root package name */
    private final Map f55805d;

    /* renamed from: e  reason: collision with root package name */
    private final Map f55806e;

    public i() {
        String substring;
        y0 y0Var;
        HashMap hashMap;
        URI f10 = qt.d.c().f("i18n", i.class, "data/week.data");
        InputStream e10 = qt.d.c().e(f10, true);
        if (e10 == null) {
            try {
                e10 = qt.d.c().d(i.class, "data/week.data", true);
        ...
        if (e10 != null) {
                    ...
                    try {
                        ...
                        while (true) {
                            ...
                            if (readLine != null) {
                                if (!readLine.startsWith("#")) {
                                    ...
                                    if (trim.equals("minDays-4")) {
                                        ...
                                        if (trim.startsWith("start-")) {
                                            ...
                                            throw new IllegalStateException("Unexpected format: " + this.f55802a);
                                        }
                                ...
                                this.f55803b = Collections.unmodifiableSet(hashSet);
                                this.f55804c = Collections.unmodifiableMap(hashMap2);
                                this.f55805d = Collections.unmodifiableMap(hashMap3);
                                this.f55806e = Collections.unmodifiableMap(hashMap4);
                                try {
                                    e10.close();
                                    return;
                        ...
                        throw new IllegalStateException("Unexpected format: " + this.f55802a, e12);
                    }
            ...
            this.f55802a = "@STATIC";
            this.f55803b = Collections.EMPTY_SET;
    ...
    public int a(Locale locale) {
        ...
        y0 y0Var = y0.SUNDAY;
        if (this.f55806e.containsKey(country)) {
            y0Var = (y0) this.f55806e.get(country);
        }
        return y0Var.d();
    }
    ...
    public int b(Locale locale) {
        if (this.f55803b.isEmpty()) {
            return new GregorianCalendar(locale).getMinimalDaysInFirstWeek();
        }
        String country = locale.getCountry();
        if ((country.isEmpty() && locale.getLanguage().isEmpty()) || this.f55803b.contains(country)) {
            return 4;
        }
        return 1;
    }
    ...
    public int c(Locale locale) {
        ...
        if (this.f55805d.containsKey(country)) {
            y0Var = (y0) this.f55805d.get(country);
        }
        return y0Var.d();
    }
    ...
    public int d(Locale locale) {
        ...
        String country = locale.getCountry();
        y0 y0Var = y0.MONDAY;
        if (this.f55804c.containsKey(country)) {
            y0Var = (y0) this.f55804c.get(country);
        }
        return y0Var.d();
    }

    public String toString() {
        return getClass().getName() + this.f55802a;
    }
}
