...
public final class h implements r {
    ...
    public static /* synthetic */ class a {
        ...
        static final /* synthetic */ int[] f55801a;
        ...
        static {
            ...
            try {
                f55801a[v.ABBREVIATED.ordinal()] = 2;
            } catch (NoSuchFieldError unused2) {
            }
            try {
                f55801a[v.SHORT.ordinal()] = 3;
            } catch (NoSuchFieldError unused3) {
            }
            try {
                f55801a[v.NARROW.ordinal()] = 4;
    ...
    private static String F(char c10, v vVar, n nVar) {
        ...
        sb2.append(c10);
        int i10 = a.f55801a[vVar.ordinal()];
        if (i10 != 1) {
            if (i10 != 2 && i10 != 3) {
                if (i10 == 4) {
                    sb2.append('n');
    ...
    @Override // tt.r
    public String E(y0 y0Var, Locale locale) {
    ...
    @Override // tt.r
    public String o(y0 y0Var, Locale locale) {
        return I(locale, y0Var.name().substring(0, 3).toLowerCase() + "-");
    }
    ...
    @Override // tt.x
    public String y(Locale locale, v vVar, int i10) {
        String str;
        int i11;
        if (i10 >= 2) {
