...
public final class a {
    ...
    private static final int[] f24032g = {3808, 476, 2107, 1799};

    /* renamed from: a  reason: collision with root package name */
    private final gk.b f24033a;
    ...
    public static final class b {
        ...
        p c() {
            return new p(this.f24041a, this.f24042b);
        }

        public String toString() {
            return "<" + this.f24041a + ' ' + this.f24042b + '>';
        }
    }
    ...
    private int e(p[] pVarArr) {
        ...
        if (o(pVarArr[0]) && o(pVarArr[1]) && o(pVarArr[2]) && o(pVarArr[3])) {
            ...
            C0315a h10 = h(j12, this.f24034b);
            int a10 = h10.a();
            if (this.f24034b) {
                this.f24035c = (a10 >> 6) + 1;
                this.f24036d = (a10 & 63) + 1;
            } else {
                this.f24035c = (a10 >> 11) + 1;
                this.f24036d = (a10 & 2047) + 1;
            }
            return h10.b();
        }
        throw k.a();
    ...
    private p[] f(b bVar) {
        ...
        this.f24034b = z10;
        return d(new p[]{new p(bVar.a() + 0.5f, bVar.b() - 0.5f), new p(bVar2.a() + 0.5f, bVar2.b() + 0.5f), new p(bVar3.a() - 0.5f, bVar3.b() + 0.5f), new p(bVar4.a() - 0.5f, bVar4.b() - 0.5f)}, (i10 * 2) - 3, this.f24037e * 2);
    }
    ...
    private int g(b bVar, b bVar2) {
        ...
        float a11 = bVar.a();
        float b11 = bVar.b();
        boolean e10 = this.f24033a.e(bVar.a(), bVar.b());
        int floor = (int) Math.floor(c10);
        int i10 = 0;
        for (int i11 = 0; i11 < floor; i11++) {
            if (this.f24033a.e(hk.a.c(a11), hk.a.c(b11)) != e10) {
                i10++;
            }
            a11 += a10;
            b11 += b10;
    ...
    private static C0315a h(long j10, boolean z10) {
        int i10;
        int i11;
        if (z10) {
            i10 = 7;
        ...
        try {
            int a10 = new c(ik.a.f28445k).a(iArr, i12);
            int i14 = 0;
            for (int i15 = 0; i15 < i11; i15++) {
                i14 = (i14 << 4) + iArr[i15];
            }
            return new C0315a(i14, a10);
        } catch (e unused) {
            throw k.a();
        }
    }
    ...
    private b j(b bVar, boolean z10, int i10, int i11) {
        ...
        while (true) {
            b10 += i11;
            if (!n(a10, b10) || this.f24033a.e(a10, b10) != z10) {
                break;
            }
            a10 += i10;
        }
        int i12 = a10 - i10;
        int i13 = b10 - i11;
        while (n(i12, i13) && this.f24033a.e(i12, i13) == z10) {
            i12 += i10;
        }
        int i14 = i12 - i10;
        while (n(i14, i13) && this.f24033a.e(i14, i13) == z10) {
            i13 += i11;
        }
    ...
    private b k() {
        ...
        p c14;
        try {
            p[] c15 = new hk.b(this.f24033a).c();
            pVar2 = c15[0];
            pVar3 = c15[1];
            pVar = c15[2];
            c10 = c15[3];
        } catch (k unused) {
            int l10 = this.f24033a.l() / 2;
            int i10 = this.f24033a.i() / 2;
            int i11 = l10 + 7;
            int i12 = i10 - 7;
        ...
        try {
            p[] c21 = new hk.b(this.f24033a, 15, c19, c20).c();
            c11 = c21[0];
            c12 = c21[1];
            c13 = c21[2];
            c14 = c21[3];
    ...
    private p[] l(p[] pVarArr) {
        return d(pVarArr, this.f24037e * 2, i());
    }
    ...
    private static int m(int[] iArr, int i10) {
        ...
        for (int i14 = 0; i14 < 4; i14++) {
            if (Integer.bitCount(f24032g[i14] ^ i13) <= 2) {
                return i14;
            }
        }
        throw k.a();
    ...
    private boolean n(int i10, int i11) {
        if (i10 >= 0 && i10 < this.f24033a.l() && i11 >= 0 && i11 < this.f24033a.i()) {
            return true;
        }
        return false;
    }
    ...
    private boolean p(b bVar, b bVar2, b bVar3, b bVar4) {
        b bVar5 = new b(Math.max(0, bVar.a() - 3), Math.min(this.f24033a.i() - 1, bVar.b() + 3));
        b bVar6 = new b(Math.max(0, bVar2.a() - 3), Math.max(0, bVar2.b() - 3));
        b bVar7 = new b(Math.min(this.f24033a.l() - 1, bVar3.a() + 3), Math.max(0, Math.min(this.f24033a.i() - 1, bVar3.b() - 3)));
        b bVar8 = new b(Math.min(this.f24033a.l() - 1, bVar4.a() + 3), Math.min(this.f24033a.i() - 1, bVar4.b() + 3));
    ...
    private int r(p pVar, p pVar2, int i10) {
        ...
        for (int i12 = 0; i12 < i10; i12++) {
            float f11 = i12;
            if (this.f24033a.e(hk.a.c((f11 * c11) + c10), hk.a.c((f11 * d11) + d10))) {
                i11 |= 1 << ((i10 - i12) - 1);
            }
        }
        return i11;
    ...
    public dk.a a(boolean z10) {
        ...
        int e10 = e(f10);
        gk.b bVar = this.f24033a;
        int i10 = this.f24038f;
        return new dk.a(q(bVar, f10[i10 % 4], f10[(i10 + 1) % 4], f10[(i10 + 2) % 4], f10[(i10 + 3) % 4]), l(f10), this.f24034b, this.f24036d, this.f24035c, e10);
    }
}
