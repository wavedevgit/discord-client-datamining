...
public abstract class d {
    ...
    private static final boolean f27963a;

    /* renamed from: b  reason: collision with root package name */
    private static final d f27964b;
    ...
    static {
        ...
        try {
            f27964b = (d) Class.forName(property).newInstance();
        } catch (Exception e10) {
