...
public final class s implements KSerializer {
    ...
    public static final s f26986a = new s();

    /* renamed from: b  reason: collision with root package name */
    private static final SerialDescriptor f26987b = ft.j.b("kotlinx.serialization.json.JsonLiteral", e.i.f23483a);
    ...
    public void serialize(Encoder encoder, r value) {
        ...
        if (value.c()) {
            ...
            or.b0 h10 = e0.h(value.b());
            if (h10 != null) {
                encoder.j(et.a.J(or.b0.f44204e).getDescriptor()).k(h10.h());
                return;
            }
