...
public abstract class e {
    ...
    public static final e f28231d;

    /* renamed from: e  reason: collision with root package name */
    public static final e f28232e;

    /* renamed from: i  reason: collision with root package name */
    public static final e f28233i;

    /* renamed from: o  reason: collision with root package name */
    public static final e f28234o;

    /* renamed from: p  reason: collision with root package name */
    private static final int[] f28235p;

    /* renamed from: q  reason: collision with root package name */
    private static final double[] f28236q;

    /* renamed from: r  reason: collision with root package name */
    private static final double[] f28237r;

    /* renamed from: s  reason: collision with root package name */
    private static final double[][] f28238s;

    /* renamed from: t  reason: collision with root package name */
    private static final /* synthetic */ e[] f28239t;
    ...
    enum a extends e {
        ...
        private double o(double d10) {
            i0 t02 = ht.c.f(d10).h().t0(p.f40924v);
            return t02.V().B0() + (((Integer) t02.X().p(g0.K)).intValue() / 86400.0d);
        }

        private double p(double d10) {
            double d11 = (d10 * 0.9856d) - 3.289d;
            return ht.a.b((Math.sin(Math.toRadians(d11)) * 1.916d) + d11 + (Math.sin(Math.toRadians(d11) * 2.0d) * 0.02d) + 282.634d);
        }

        @Override // ht.e
        public double g(double d10) {
            return Math.toDegrees(Math.asin(Math.sin(Math.toRadians(p(o(d10)))) * 0.39782d));
        }

        @Override // ht.e
        public double k(double d10) {
            double p10 = p(o(d10));
            double b10 = ht.a.b(Math.toDegrees(Math.atan(Math.tan(Math.toRadians(p10)) * 0.91764d)));
            return (b10 + (Math.floor(p10 / 90.0d) * 90.0d)) - (Math.floor(b10 / 90.0d) * 90.0d);
        }
    }
    ...
    static {
        ...
        f28231d = aVar;
        e eVar = new e("NOAA", 1) { // from class: ht.e.b
            private double o(double d10) {
            ...
            private double t(double d10) {
                return ((r(d10) + p(d10)) - 0.00569d) - (Math.sin(Math.toRadians(125.04d - (d10 * 1934.136d))) * 0.00478d);
            }

            @Override // ht.e
            public double g(double d10) {
                return Math.toDegrees(o(e.l(d10)));
            }

            @Override // ht.e
            public double k(double d10) {
                double l10 = e.l(d10);
                double radians = Math.toRadians(t(l10));
                return ht.a.b(Math.toDegrees(Math.atan2(Math.cos(Math.toRadians(s(l10))) * Math.sin(radians), Math.cos(radians))));
            }
        };
        f28232e = eVar;
        e eVar2 = new e("CC", 2) { // from class: ht.e.c
            private double o(double d10) {
            ...
            public double h(double d10, String str) {
                ...
                if (str.equals("declination")) {
                    return Math.toDegrees(o(l10));
                }
                if (str.equals("right-ascension")) {
                    double radians = Math.toRadians(e.f(l10, q(l10)));
                    return ht.a.b(Math.toDegrees(Math.atan2(Math.cos(Math.toRadians(r(l10))) * Math.sin(radians), Math.cos(radians))));
        ...
        f28233i = eVar2;
        e eVar3 = new e("TIME4J", 3) { // from class: ht.e.d
            private double o(double d10) {
            ...
            public double h(double d10, String str) {
                ...
                if (str.equals("right-ascension")) {
                    double[] dArr = new double[2];
                    e.j(l10, dArr);
                    double radians = Math.toRadians(e.f(l10, dArr[0]));
                    return ht.a.b(Math.toDegrees(Math.atan2(Math.cos(Math.toRadians(e.i(l10) + dArr[1])) * Math.sin(radians), Math.cos(radians))));
                } else if (str.equals("nutation")) {
    ...
    public static double f(double d10, double d11) {
        double d12 = 0.0d;
        for (int length = f28235p.length - 1; length >= 0; length--) {
            d12 += f28235p[length] * Math.sin(Math.toRadians(f28236q[length] + (f28237r[length] * d10)));
        }
    ...
    static void j(double d10, double[] dArr) {
        ...
        double d11 = 0.0d;
        double d12 = 0.0d;
        for (int length = f28238s.length - 1; length >= 0; length--) {
            double[] dArr2 = f28238s[length];
