...
public final class g implements ViewTreeObserver.OnPreDrawListener, View.OnAttachStateChangeListener {
    ...
    public static final a f50564o = new a(null);

    /* renamed from: d  reason: collision with root package name */
    private final View f50565d;

    /* renamed from: e  reason: collision with root package name */
    private final Runnable f50566e;

    /* renamed from: i  reason: collision with root package name */
    private ViewTreeObserver f50567i;
    ...
    private final void a() {
        if (this.f50567i.isAlive()) {
            this.f50567i.removeOnPreDrawListener(this);
        } else {
            this.f50565d.getViewTreeObserver().removeOnPreDrawListener(this);
        }
        this.f50565d.removeOnAttachStateChangeListener(this);
    }
    ...
    public void onViewAttachedToWindow(View v10) {
        ...
        this.f50567i = v10.getViewTreeObserver();
    }
    ...
    private g(View view, Runnable runnable) {
        this.f50565d = view;
        this.f50566e = runnable;
        ViewTreeObserver viewTreeObserver = view.getViewTreeObserver();
        Intrinsics.checkNotNullExpressionValue(viewTreeObserver, "getViewTreeObserver(...)");
        this.f50567i = viewTreeObserver;
    }
}
