...
public class b extends aa.a implements Closeable, c0 {
    ...
    private final w8.b f27573i;

    /* renamed from: o  reason: collision with root package name */
    private final j f27574o;

    /* renamed from: p  reason: collision with root package name */
    private final i f27575p;

    /* renamed from: q  reason: collision with root package name */
    private i f27576q;

    /* renamed from: r  reason: collision with root package name */
    private final boolean f27577r;
    ...
    public void n(boolean z10) {
        if (z10) {
            C(this.f27574o, this.f27573i.now());
        } else {
            z(this.f27574o, this.f27573i.now());
        }
    }
