...
final class d implements InputFilter {
    ...
    public static class a extends e.f {
        ...
        /* renamed from: a  reason: collision with root package name */
        private final Reference f20258a;

        /* renamed from: b  reason: collision with root package name */
        private final Reference f20259b;

        a(TextView textView, d dVar) {
            this.f20258a = new WeakReference(textView);
            this.f20259b = new WeakReference(dVar);
        }
        ...
        public void b() {
            ...
            CharSequence p10;
            super.b();
            TextView textView = (TextView) this.f20258a.get();
            if (c(textView, (InputFilter) this.f20259b.get()) && textView.isAttachedToWindow() && text != (p10 = androidx.emoji2.text.e.c().p((text = textView.getText())))) {
    ...
    private e.f a() {
        if (this.f20257b == null) {
            this.f20257b = new a(this.f20256a, this);
        }
        return this.f20257b;
    }
    ...
    public CharSequence filter(CharSequence charSequence, int i10, int i11, Spanned spanned, int i12, int i13) {
        if (!this.f20256a.isInEditMode()) {
            ...
            if (e10 != 0) {
                ...
                } else if (i13 == 0 && i12 == 0 && spanned.length() == 0 && charSequence == this.f20256a.getText()) {
                    return charSequence;
                } else {
