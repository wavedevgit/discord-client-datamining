...
public final class a {
    ...
    private int f21641b = Integer.MAX_VALUE;

    /* renamed from: c  reason: collision with root package name */
    private int f21642c = 0;
    ...
    private static class C0277a extends b {
        ...
        /* renamed from: a  reason: collision with root package name */
        private final EditText f21643a;

        /* renamed from: b  reason: collision with root package name */
        private final g f21644b;

        C0277a(EditText editText, boolean z10) {
            this.f21643a = editText;
        ...
        InputConnection c(InputConnection inputConnection, EditorInfo editorInfo) {
            ...
            return new c(this.f21643a, inputConnection, editorInfo);
        }
    ...
    public a(EditText editText, boolean z10) {
        ...
        this.f21640a = new C0277a(editText, z10);
    }

    public KeyListener a(KeyListener keyListener) {
        return this.f21640a.a(keyListener);
    }
    ...
    public InputConnection c(InputConnection inputConnection, EditorInfo editorInfo) {
        ...
        return this.f21640a.c(inputConnection, editorInfo);
    }
