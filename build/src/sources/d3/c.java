...
final class c extends InputConnectionWrapper {
    ...
    private final TextView f21648a;

    /* renamed from: b  reason: collision with root package name */
    private final a f21649b;
    ...
    private Editable a() {
        return this.f21648a.getEditableText();
    }

    @Override // android.view.inputmethod.InputConnectionWrapper, android.view.inputmethod.InputConnection
    public boolean deleteSurroundingText(int i10, int i11) {
        if (!this.f21649b.a(this, a(), i10, i11, false) && !super.deleteSurroundingText(i10, i11)) {
            return false;
        }
        return true;
    }
    ...
    public boolean deleteSurroundingTextInCodePoints(int i10, int i11) {
        if (!this.f21649b.a(this, a(), i10, i11, true) && !super.deleteSurroundingTextInCodePoints(i10, i11)) {
            return false;
        }
        return true;
    }
