...
public final class c implements f {
    ...
    public c(String stepName, Map componentParams) {
        ...
        this.f7469d = stepName;
        this.f7470e = componentParams;
    }
    ...
    public boolean equals(Object obj) {
        ...
        c cVar = (c) obj;
        if (Intrinsics.areEqual(this.f7469d, cVar.f7469d) && Intrinsics.areEqual(this.f7470e, cVar.f7470e)) {
            return true;
        }
        return false;
    }
    ...
    public int hashCode() {
        return (this.f7469d.hashCode() * 31) + this.f7470e.hashCode();
    }
