...
public class t implements Appendable, CharSequence {
    ...
    private final StringBuilder f7563d;

    /* renamed from: e  reason: collision with root package name */
    private final Deque f7564e;
    ...
    public t append(CharSequence charSequence) {
        ...
        this.f7563d.append(charSequence);
        return this;
    }
    ...
    public t append(CharSequence charSequence, int i10, int i11) {
        ...
        this.f7563d.append(subSequence);
        return this;
    }

    @Override // java.lang.CharSequence
    public char charAt(int i10) {
        return this.f7563d.charAt(i10);
    }

    public t d(String str) {
        this.f7563d.append(str);
        return this;
    }
    ...
    public List f(int i10, int i11) {
        ...
        if (i10 == 0 && length == i11) {
            ArrayList arrayList = new ArrayList(this.f7564e);
            Collections.reverse(arrayList);
            return Collections.unmodifiableList(arrayList);
        }
        ArrayList arrayList2 = new ArrayList(0);
        Iterator descendingIterator = this.f7564e.descendingIterator();
        while (descendingIterator.hasNext()) {
            a aVar = (a) descendingIterator.next();
            int i13 = aVar.f7566b;
            if ((i13 >= i10 && i13 < i11) || (((i12 = aVar.f7567c) <= i11 && i12 > i10) || (i13 < i10 && i12 > i11))) {
                arrayList2.add(aVar);
            }
        }
    ...
    public char h() {
        return this.f7563d.charAt(length() - 1);
    }

    public t i(Object obj, int i10, int i11, int i12) {
        this.f7564e.push(new a(obj, i10, i11, i12));
        return this;
    }

    public SpannableStringBuilder l() {
        b bVar = new b(this.f7563d);
        for (a aVar : this.f7564e) {
            bVar.setSpan(aVar.f7565a, aVar.f7566b, aVar.f7567c, aVar.f7568d);
        }
        return bVar;
    }
    ...
    public CharSequence subSequence(int i10, int i11) {
        ...
        if (f10.isEmpty()) {
            return this.f7563d.subSequence(i10, i11);
        }
        SpannableStringBuilder spannableStringBuilder = new SpannableStringBuilder(this.f7563d.subSequence(i10, i11));
        int length = spannableStringBuilder.length();
        for (a aVar : f10) {
            int max = Math.max(0, aVar.f7566b - i10);
            spannableStringBuilder.setSpan(aVar.f7565a, max, Math.min(length, (aVar.f7567c - aVar.f7566b) + max), aVar.f7568d);
        }
    ...
    public t(CharSequence charSequence) {
        this.f7564e = new ArrayDeque(8);
        this.f7563d = new StringBuilder(charSequence);
        e(0, charSequence);
    }
}
