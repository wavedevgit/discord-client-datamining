...
public final class h implements com.google.android.exoplayer2.upstream.cache.d {
    ...
    private final TreeSet f38037b = new TreeSet(new Comparator() { // from class: me.g
    ...
    public static int h(c cVar, c cVar2) {
        long j10 = cVar.f38030q;
        long j11 = cVar2.f38030q;
        if (j10 - j11 == 0) {
    ...
    private void i(com.google.android.exoplayer2.upstream.cache.a aVar, long j10) {
        while (this.f38038c + j10 > this.f38036a && !this.f38037b.isEmpty()) {
            aVar.d((c) this.f38037b.first());
        }
    }
