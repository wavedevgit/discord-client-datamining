...
public final class f implements d {
    ...
    public static final f f38037c = new f(Collections.EMPTY_MAP);
    ...
    public f(Map map) {
        this.f38039b = Collections.unmodifiableMap(map);
    }
    ...
    private static byte[] i(Object obj) {
        ...
        if (obj instanceof String) {
            return ((String) obj).getBytes(ii.d.f28521c);
        }
    ...
    public final long a(String str, long j10) {
        byte[] bArr = (byte[]) this.f38039b.get(str);
        if (bArr != null) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj != null && f.class == obj.getClass()) {
            return j(this.f38039b, ((f) obj).f38039b);
        }
        return false;
    }

    public f g(e eVar) {
        Map f10 = f(this.f38039b, eVar);
        if (j(this.f38039b, f10)) {
            return this;
        }
        return new f(f10);
    }
    ...
    public Set h() {
        return this.f38039b.entrySet();
    }

    public int hashCode() {
        if (this.f38038a == 0) {
            int i10 = 0;
            for (Map.Entry entry : this.f38039b.entrySet()) {
