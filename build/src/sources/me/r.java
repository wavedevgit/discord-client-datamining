...
public final class r implements e, c0 {
    ...
    public static final oi.s f37016p = oi.s.x(4400000L, 3200000L, 2300000L, 1600000L, 810000L);

    /* renamed from: q  reason: collision with root package name */
    public static final oi.s f37017q = oi.s.x(1400000L, 990000L, 730000L, 510000L, 230000L);

    /* renamed from: r  reason: collision with root package name */
    public static final oi.s f37018r = oi.s.x(2100000L, 1400000L, 1000000L, 890000L, 640000L);

    /* renamed from: s  reason: collision with root package name */
    public static final oi.s f37019s = oi.s.x(2600000L, 1700000L, 1300000L, 1000000L, 700000L);

    /* renamed from: t  reason: collision with root package name */
    public static final oi.s f37020t = oi.s.x(5700000L, 3700000L, 2300000L, 1700000L, 990000L);

    /* renamed from: u  reason: collision with root package name */
    public static final oi.s f37021u = oi.s.x(2800000L, 1800000L, 1400000L, 1100000L, 870000L);

    /* renamed from: v  reason: collision with root package name */
    private static r f37022v;

    /* renamed from: a  reason: collision with root package name */
    private final oi.t f37023a;

    /* renamed from: b  reason: collision with root package name */
    private final e.a.C0533a f37024b;

    /* renamed from: c  reason: collision with root package name */
    private final z f37025c;

    /* renamed from: d  reason: collision with root package name */
    private final oe.e f37026d;
    ...
    private long f37033k;

    /* renamed from: l  reason: collision with root package name */
    private long f37034l;
    ...
    public static final class b {
        ...
        public b(Context context) {
            ...
            this.f37038a = applicationContext;
            this.f37039b = b(w0.O(context));
            this.f37040c = 2000;
            this.f37041d = oe.e.f40604a;
            this.f37042e = true;
        }
        ...
        private static Map b(String str) {
            ...
            hashMap.put(3, (Long) r.f37017q.get(l10[1]));
            hashMap.put(4, (Long) r.f37018r.get(l10[2]));
            hashMap.put(5, (Long) r.f37019s.get(l10[3]));
            hashMap.put(10, (Long) r.f37020t.get(l10[4]));
            hashMap.put(9, (Long) r.f37021u.get(l10[5]));
            hashMap.put(7, (Long) sVar.get(l10[0]));
            return hashMap;
        }

        public r a() {
            return new r(this.f37038a, this.f37039b, this.f37040c, this.f37041d, this.f37042e);
        }
    }
    ...
    private long m(int i10) {
        Long l10 = (Long) this.f37023a.get(Integer.valueOf(i10));
        if (l10 == null) {
            l10 = (Long) this.f37023a.get(0);
        }
        if (l10 == null) {
            l10 = 1000000L;
        }
    ...
    private void p(int i10, long j10, long j11) {
        if (i10 == 0 && j10 == 0 && j11 == this.f37035m) {
            return;
        }
        this.f37035m = j11;
        this.f37024b.c(i10, j10, j11);
    }
        ...
        try {
            try {
                ...
                if (i10 != 1 && i10 != 0 && i10 != 8) {
                    this.f37034l = m(i10);
                    long b10 = this.f37026d.b();
                    if (this.f37028f > 0) {
                        i11 = (int) (b10 - this.f37029g);
                    } else {
                        i11 = 0;
                    }
                    p(i11, this.f37030h, this.f37034l);
                    this.f37029g = b10;
                    this.f37030h = 0L;
                    this.f37033k = 0L;
                    this.f37032j = 0L;
    ...
    /* JADX WARN: Code restructure failed: missing block: B:18:0x004e, code lost:
        if (r10.f37033k >= 524288) goto L17;
     */
    @Override // me.c0
    /*
    ...
    */
    public synchronized void c(com.google.android.exoplayer2.upstream.DataSource r11, com.google.android.exoplayer2.upstream.a r12, boolean r13) {
        /*
            ...
            return
        L9:
            int r11 = r10.f37028f     // Catch: java.lang.Throwable -> L72
            r12 = 1
            if (r11 <= 0) goto L10
            r11 = r12
            goto L11
        ...
        L11:
            ...
            oe.e r11 = r10.f37026d     // Catch: java.lang.Throwable -> L72
            long r0 = r11.b()     // Catch: java.lang.Throwable -> L72
            long r2 = r10.f37029g     // Catch: java.lang.Throwable -> L72
            long r2 = r0 - r2
            int r5 = (int) r2     // Catch: java.lang.Throwable -> L72
            long r2 = r10.f37032j     // Catch: java.lang.Throwable -> L72
            long r6 = (long) r5     // Catch: java.lang.Throwable -> L72
            long r2 = r2 + r6
            r10.f37032j = r2     // Catch: java.lang.Throwable -> L72
            long r2 = r10.f37033k     // Catch: java.lang.Throwable -> L72
            long r6 = r10.f37030h     // Catch: java.lang.Throwable -> L72
            long r2 = r2 + r6
            r10.f37033k = r2     // Catch: java.lang.Throwable -> L72
            if (r5 <= 0) goto L75
            ...
            float r11 = r11 / r13
            me.z r13 = r10.f37025c     // Catch: java.lang.Throwable -> L72
            ...
            if (r11 >= 0) goto L55
            long r2 = r10.f37033k     // Catch: java.lang.Throwable -> L51
        ...
        L51:
            ...
            goto L7d
        L55:
            me.z r11 = r10.f37025c     // Catch: java.lang.Throwable -> L72
            r13 = 1056964608(0x3f000000, float:0.5)
            float r11 = r11.f(r13)     // Catch: java.lang.Throwable -> L72
            long r2 = (long) r11     // Catch: java.lang.Throwable -> L72
            r10.f37034l = r2     // Catch: java.lang.Throwable -> L72
        L60:
            long r6 = r10.f37030h     // Catch: java.lang.Throwable -> L72
            long r8 = r10.f37034l     // Catch: java.lang.Throwable -> L72
            r4 = r10
            r4.p(r5, r6, r8)     // Catch: java.lang.Throwable -> L6f
            r4.f37029g = r0     // Catch: java.lang.Throwable -> L6f
            r0 = 0
            r4.f37030h = r0     // Catch: java.lang.Throwable -> L6f
            goto L76
        L6f:
            r0 = move-exception
        L70:
        ...
        L75:
            r4 = r10
        L76:
            int r11 = r4.f37028f     // Catch: java.lang.Throwable -> L6f
            int r11 = r11 - r12
            r4.f37028f = r11     // Catch: java.lang.Throwable -> L6f
            monitor-exit(r10)
            return
        L7d:
    ...
    private r(Context context, Map map, int i10, oe.e eVar, boolean z10) {
        this.f37023a = oi.t.c(map);
        this.f37024b = new e.a.C0533a();
        this.f37025c = new z(i10);
        this.f37026d = eVar;
        this.f37027e = z10;
        if (context != null) {
            f0 d10 = f0.d(context);
