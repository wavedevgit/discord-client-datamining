...
public abstract class t {
    ...
    private static final Pattern f36423a = Pattern.compile("bytes (\\d+)-(\\d+)/(?:\\d+|\\*)");

    /* renamed from: b  reason: collision with root package name */
    private static final Pattern f36424b = Pattern.compile("bytes (?:(?:\\d+-\\d+)|\\*)/(\\d+)");
    ...
    */
    public static long b(java.lang.String r9, java.lang.String r10) {
        ...
        L28:
            ...
            if (r0 != 0) goto La3
            java.util.regex.Pattern r0 = me.t.f36423a
    ...
    public static long c(String str) {
        ...
        Matcher matcher = f36424b.matcher(str);
        if (!matcher.matches()) {
            return -1L;
        }
