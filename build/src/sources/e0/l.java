...
class l {
    ...
    private final Rational f22210c;
    ...
    public l(d0 d0Var, Rational rational) {
        this.f22208a = d0Var.a();
        this.f22209b = d0Var.c();
        this.f22210c = rational;
        boolean z10 = true;
    ...
    private Rational c(i1 i1Var, List list) {
        if (i1Var.v()) {
            return k.n(i1Var.x(), this.f22211d);
        }
        Size d10 = d(i1Var);
        if (d10 != null) {
            return b(d10, list);
    ...
    private Size d(i1 i1Var) {
        return a(i1Var.J(null), i1Var.z(0), this.f22209b, this.f22208a);
    }
    ...
    public List f(List list, x2 x2Var) {
        ...
        if (!arrayList2.isEmpty()) {
            ...
            if (c10 == null) {
                ...
                Collections.sort(arrayList4, new a.C0090a(c10, this.f22210c));
