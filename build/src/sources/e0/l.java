...
class l {
    ...
    private final Rational f21248c;
    ...
    public l(d0 d0Var, Rational rational) {
        this.f21246a = d0Var.a();
        this.f21247b = d0Var.c();
        this.f21248c = rational;
        boolean z10 = true;
    ...
    private Rational c(i1 i1Var, List list) {
        if (i1Var.v()) {
            return k.n(i1Var.x(), this.f21249d);
        }
        Size d10 = d(i1Var);
        if (d10 != null) {
            return b(d10, list);
    ...
    private Size d(i1 i1Var) {
        return a(i1Var.J(null), i1Var.z(0), this.f21247b, this.f21246a);
    }
    ...
    public List f(List list, x2 x2Var) {
        ...
        if (!arrayList2.isEmpty()) {
            ...
            if (c10 == null) {
                ...
                Collections.sort(arrayList4, new a.C0092a(c10, this.f21248c));
