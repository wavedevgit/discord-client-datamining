...
public abstract class e {
    ...
    private static final GradientDrawable b(BaseButtonComponentStyle baseButtonComponentStyle, boolean z10, boolean z11) {
        ...
        if (borderWidthValue != null) {
            i10 = (int) pp.h.a(borderWidthValue.doubleValue());
        } else {
            i10 = 0;
        }
        ...
        if (borderRadiusValue != null) {
            float a10 = (float) pp.h.a(borderRadiusValue.doubleValue());
    ...
    public static final void c(final Button button, final BaseButtonComponentStyle styles, final boolean z10, final boolean z11) {
        ...
        if (button.isLaidOut()) {
            ...
            zp.s.b(button, new Function0() { // from class: iq.d
    ...
    private static final void e(BaseButtonComponentStyle baseButtonComponentStyle, Button button, boolean z10, boolean z11) {
        ...
        if (lineHeightValue != null) {
            ...
            if (Build.VERSION.SDK_INT >= 28) {
                button.setLineHeight((int) pp.h.a(doubleValue));
            }
        }
        ...
        if (marginValue != null) {
            ...
            if (view instanceof ButtonWithLoadingIndicator) {
                ...
                if (left != null && (dp5 = left.getDp()) != null) {
                    paddingLeft = (int) pp.h.a(dp5.doubleValue());
                } else {
                ...
                if (top != null && (dp4 = top.getDp()) != null) {
                    paddingTop = (int) pp.h.a(dp4.doubleValue());
                } else {
                ...
                if (right != null && (dp3 = right.getDp()) != null) {
                    paddingRight = (int) pp.h.a(dp3.doubleValue());
                } else {
                ...
                if (bottom != null && (dp2 = bottom.getDp()) != null) {
                    paddingBottom = (int) pp.h.a(dp2.doubleValue());
                } else {
        ...
        if (layoutParams != null) {
            ...
            if (widthValue != null) {
                ...
                if (z11) {
                    layoutParams.width = kotlin.ranges.d.i((int) pp.h.a(doubleValue2), measuredWidth);
                }
            }
            ...
            if (heightValue != null) {
                ...
                if (z11) {
                    layoutParams.height = (int) pp.h.a(doubleValue3);
                }
            }
            if (view instanceof ButtonWithLoadingIndicator) {
            ...
            if (justificationValue != null && (layoutParams instanceof ConstraintLayout.LayoutParams)) {
                ...
                int i16 = a.f30089a[justificationValue.ordinal()];
                if (i16 != 1) {
                    if (i16 != 2) {
                        if (i16 == 3) {
                            f10 = 1.0f;
