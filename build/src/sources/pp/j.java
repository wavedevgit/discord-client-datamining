...
public final class j {
    ...
    private final z.a f45104b;

    /* renamed from: c  reason: collision with root package name */
    private final g.a f45105c;

    /* renamed from: d  reason: collision with root package name */
    private final zp.b f45106d;
    ...
    public static final class a extends k implements Function2 {
        ...
        final /* synthetic */ x1.e f45108e;

        /* renamed from: i  reason: collision with root package name */
        final /* synthetic */ k.a f45109i;
        ...
        public final Continuation create(Object obj, Continuation continuation) {
            return new a(this.f45108e, this.f45109i, continuation);
        }
        ...
        public final Object invokeSuspend(Object obj) {
            ...
            if (i10 != 0) {
                ...
                kotlin.c.b(obj);
                long w10 = this.f45108e.w();
                this.f45107d = 1;
                if (i0.a(w10, this) == f10) {
                    return f10;
                }
            }
            bn.h c11 = this.f45109i.c();
    ...
    public j(Context applicationContext, z.a cameraXControllerFactory, g.a camera2ManagerFactoryFactory, zp.b navigationStateManager) {
        ...
        this.f45103a = applicationContext;
        this.f45104b = cameraXControllerFactory;
        this.f45105c = camera2ManagerFactoryFactory;
        this.f45106d = navigationStateManager;
    }
    ...
    public static final Unit i(k.a aVar, File it) {
        ...
        arrayList.add(new a1.d(absolutePath, a1.a.f37283i));
        bn.h c11 = aVar.c();
    ...
    public static final Unit p(j jVar, k.a aVar, x5.b bVar) {
        m6.t(jVar.f45103a, aVar, bVar, true);
        return Unit.f32008a;
    }
    ...
    public final Object q(final x5.b renderProps, final x1.e renderState, final k.a context) {
        ...
        if (renderState.A()) {
            enumC0522c = x5.d.c.EnumC0522c.f38188w;
        } else {
            enumC0522c = x5.d.c.EnumC0522c.f38186u;
        }
        ...
        }, x10, enumC0522c2, !Intrinsics.areEqual(renderProps.u(), d2.b.f37375a));
        boolean t10 = renderProps.t();
        zp.a b10 = this.f45106d.b();
        ...
        }, aVar, null, renderProps.z().b(), this.f45104b, this.f45105c, 0.0f, null, renderState.q(), false, false, false, 50331648, null);
    }
}
