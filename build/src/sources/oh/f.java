...
public class f extends oh.a {
    ...
    class a extends AnimatorListenerAdapter {
        ...
        public void onAnimationEnd(Animator animator) {
            f.this.f40080b.setTranslationX(0.0f);
            f.this.k(0.0f, this.f40098a, this.f40099b);
        }
    }
    ...
    public f(View view) {
        ...
        this.f40095g = resources.getDimension(bh.d.f6812t);
        this.f40096h = resources.getDimension(bh.d.f6810s);
        this.f40097i = resources.getDimension(bh.d.f6814u);
    }

    private boolean g(int i10, int i11) {
        if ((Gravity.getAbsoluteGravity(i10, this.f40080b.getLayoutDirection()) & i11) == i11) {
            return true;
        }
        return false;
    }
    ...
    private int i(boolean z10) {
        ViewGroup.LayoutParams layoutParams = this.f40080b.getLayoutParams();
    ...
    public void f() {
        ...
        animatorSet.setDuration(this.f40083e);
        animatorSet.start();
    }
    ...
    public void h(BackEventCompat backEventCompat, int i10, Animator.AnimatorListener animatorListener, ValueAnimator.AnimatorUpdateListener animatorUpdateListener) {
        ...
        boolean g10 = g(i10, 3);
        float width = (this.f40080b.getWidth() * this.f40080b.getScaleX()) + i(g10);
        View view = this.f40080b;
    ...
    public void k(float f10, boolean z10, int i10) {
        ...
        int width = this.f40080b.getWidth();
        int height = this.f40080b.getHeight();
        float f13 = width;
        if (f13 > 0.0f) {
            float f14 = height;
            if (f14 > 0.0f) {
                float f15 = this.f40095g / f13;
                float f16 = this.f40096h / f13;
                float f17 = this.f40097i / f14;
                View view = this.f40080b;
                if (g10) {
                    f13 = 0.0f;
                }
                ...
                if (!Float.isNaN(f18) && !Float.isNaN(a12)) {
                    this.f40080b.setScaleX(f18);
                    this.f40080b.setScaleY(a12);
                    View view2 = this.f40080b;
