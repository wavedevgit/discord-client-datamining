...
public final class c {
    ...
    private final d f40654a = a();

    /* renamed from: b  reason: collision with root package name */
    private final oh.b f40655b;
    ...
    public static class b implements d {
        ...
        /* renamed from: a  reason: collision with root package name */
        private OnBackInvokedCallback f40657a;
        ...
        public void a(@NonNull oh.b bVar, @NonNull View view, boolean z10) {
            ...
            int i10;
            if (this.f40657a != null || (findOnBackInvokedDispatcher = view.findOnBackInvokedDispatcher()) == null) {
                return;
            }
        ...
        public void b(@NonNull View view) {
            ...
            findOnBackInvokedDispatcher.unregisterOnBackInvokedCallback(this.f40657a);
            this.f40657a = null;
        }
    ...
    public static class C0551c extends b {
        ...
        class a implements OnBackAnimationCallback {
            ...
            public void onBackProgressed(BackEvent backEvent) {
                ...
                this.f40658a.c(new BackEventCompat(backEvent));
            }
            ...
            public void onBackStarted(BackEvent backEvent) {
                ...
                this.f40658a.b(new BackEventCompat(backEvent));
            }
        }
    ...
    private void c(boolean z10) {
        d dVar = this.f40654a;
        if (dVar != null) {
            dVar.a(this.f40655b, this.f40656c, z10);
        }
    }
