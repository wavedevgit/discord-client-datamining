...
abstract class d {
    ...
    public static ok.e a(byte[] bArr, j jVar, f fVar, Map map) {
        h a10;
        h hVar;
        int i10;
        StringBuilder sb2;
        ...
        while (true) {
            try {
                ...
                if (hVar == h.TERMINATOR) {
                    ...
                    return new ok.e(bArr2, sb4, arrayList, obj, i13, i14, i11);
                }
                bArr2 = bArr;
    ...
    private static void b(ok.c cVar, StringBuilder sb2, int i10, boolean z10) {
        while (i10 > 1) {
            if (cVar.a() >= 11) {
                int d10 = cVar.d(11);
                sb2.append(h(d10 / 45));
    ...
    private static void c(ok.c cVar, StringBuilder sb2, int i10, ok.d dVar, Collection collection, Map map) {
        Charset f10;
        if (i10 * 8 <= cVar.a()) {
    ...
    private static void d(ok.c cVar, StringBuilder sb2, int i10) {
        ...
        if (n.f40782c != null) {
            if (i10 * 13 <= cVar.a()) {
                ...
                sb2.append(new String(bArr, n.f40782c));
                return;
            }
            throw kk.g.a();
        }
    ...
    private static void e(ok.c cVar, StringBuilder sb2, int i10) {
        ...
        if (n.f40781b != null) {
            if (i10 * 13 <= cVar.a()) {
                ...
                sb2.append(new String(bArr, n.f40781b));
                return;
            }
            throw kk.g.a();
        }
    ...
    private static void f(ok.c cVar, StringBuilder sb2, int i10) {
        while (i10 >= 3) {
            if (cVar.a() >= 10) {
                int d10 = cVar.d(10);
                if (d10 < 1000) {
    ...
    private static int g(ok.c cVar) {
        int d10 = cVar.d(8);
