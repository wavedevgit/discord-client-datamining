...
public final class t {
    ...
    public static final class a {
        ...
        public static final a f49957d = new a("FRONT", 0);

        /* renamed from: e  reason: collision with root package name */
        public static final a f49958e = new a("BACK", 1);

        /* renamed from: i  reason: collision with root package name */
        public static final a f49959i = new a("EXTERNAL", 2);

        /* renamed from: o  reason: collision with root package name */
        private static final /* synthetic */ a[] f49960o;

        /* renamed from: p  reason: collision with root package name */
        private static final /* synthetic */ EnumEntries f49961p;
        ...
        private static final /* synthetic */ a[] a() {
            return new a[]{f49957d, f49958e, f49959i};
        }
    ...
    public static final class b implements DefaultLifecycleObserver {
        ...
        /* renamed from: d  reason: collision with root package name */
        final /* synthetic */ ExecutorService f49962d;

        b(ExecutorService executorService) {
            this.f49962d = executorService;
        }

        @Override // androidx.lifecycle.DefaultLifecycleObserver
        public void onDestroy(LifecycleOwner owner) {
            Intrinsics.checkNotNullParameter(owner, "owner");
            this.f49962d.shutdown();
        }
    }
    ...
    public static final class c extends kotlin.coroutines.jvm.internal.d {
        ...
        public final Object invokeSuspend(Object obj) {
            this.f49965i = obj;
            this.f49967p |= Integer.MIN_VALUE;
    ...
    public static final class d implements n0.f {
        ...
        /* renamed from: a  reason: collision with root package name */
        final /* synthetic */ Continuation f49968a;

        /* renamed from: b  reason: collision with root package name */
        final /* synthetic */ File f49969b;

        d(Continuation continuation, File file) {
            this.f49968a = continuation;
            this.f49969b = file;
        }
        ...
        public void d(n0.h outputFileResults) {
            ...
            Continuation continuation = this.f49968a;
            Result.a aVar = Result.f31985e;
            continuation.resumeWith(Result.b(Result.a(Result.b(this.f49969b))));
        }
    ...
    public static final void h(ListenableFuture listenableFuture, int i10, boolean z10, f.a aVar, ExecutorService executorService, PreviewView previewView, x.p pVar, t tVar, Function1 function1) {
        ...
        try {
            ...
            tVar.f49956a = new w(n10, n0Var, tVar.i(n10));
            Context context2 = previewView.getContext();
            Intrinsics.checkNotNullExpressionValue(context2, "getContext(...)");
            pp.f.i(context2).getLifecycle().a(new b(executorService));
    ...
    */
    private final sn.v i(x.i r12) {
        ...
        L42:
            ...
            r4 = 1
            if (r3 != r4) goto L4c
            sn.v$b r1 = sn.v.b.f49987e     // Catch: java.lang.IllegalArgumentException -> L90
            goto L5a
        L4c:
            if (r1 != 0) goto L4f
            goto L58
        L4f:
            ...
            if (r1 != 0) goto L58
            sn.v$b r1 = sn.v.b.f49986d     // Catch: java.lang.IllegalArgumentException -> L90
            goto L5a
        L58:
            sn.v$b r1 = sn.v.b.f49988i     // Catch: java.lang.IllegalArgumentException -> L90
        L5a:
        ...
        L6d:
            ...
            goto L6d
        L8a:
            sn.v r12 = new sn.v     // Catch: java.lang.IllegalArgumentException -> L90
        ...
        L90:
            ...
            return r4
        */
        throw new UnsupportedOperationException("Method not decompiled: sn.t.i(x.i):sn.v");
    }
    ...
    public final void f(final PreviewView previewView, a cameraDirection, final f.a aVar, final boolean z10, final Function1 onCameraError) {
        ...
        previewView.post(new Runnable() { // from class: sn.r
            @Override // java.lang.Runnable
            public final void run() {
    ...
    /*
        ...
        To view partially-correct add '--show-bad-code' argument
    */
    public final java.lang.Object j(up.c r7, kotlin.coroutines.Continuation r8) {
        /*
            r6 = this;
            boolean r0 = r8 instanceof sn.t.c
            if (r0 == 0) goto L13
            r0 = r8
            sn.t$c r0 = (sn.t.c) r0
            int r1 = r0.f49967p
        ...
        L13:
            ...
            r0.<init>(r8)
        L18:
            java.lang.Object r8 = r0.f49965i
            java.lang.Object r1 = ur.b.f()
            int r2 = r0.f49967p
            r3 = 1
            if (r2 == 0) goto L39
            if (r2 != r3) goto L31
            java.lang.Object r7 = r0.f49964e
            up.c r7 = (up.c) r7
            java.lang.Object r7 = r0.f49963d
            sn.t r7 = (sn.t) r7
            kotlin.c.b(r8)
            goto L8d
        L31:
        ...
        L39:
            ...
            ms.c1 r4 = ms.m0.c()
            ms.c1 r4 = r4.f2()
            java.util.concurrent.Executor r4 = ms.u0.a(r4)
            sn.t$d r5 = new sn.t$d
            r5.<init>(r8, r7)
            r3.x0(r2, r4, r5)
        L7d:
            java.lang.Object r8 = r8.b()
            java.lang.Object r7 = ur.b.f()
            if (r8 != r7) goto L8a
        ...
        L8d:
            ...
            return r7
        */
        throw new UnsupportedOperationException("Method not decompiled: sn.t.j(up.c, kotlin.coroutines.Continuation):java.lang.Object");
    }
}
