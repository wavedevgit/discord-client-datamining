...
public final class p0 {
    ...
    public static final a f49915p = new a(null);

    /* renamed from: q  reason: collision with root package name */
    private static final Regex f49916q = new Regex("([ACI][A-Z0-9<]{1})([A-Z]{3})([A-Z0-9<]{9})([0-9]{1})([A-Z0-9<]{15})");

    /* renamed from: r  reason: collision with root package name */
    private static final Regex f49917r = new Regex("([0-9]{6})([0-9]{1})([MFX<]{1})([0-9]{6})([0-9]{1})([A-Z]{3})([A-Z0-9<]{11})([0-9]{1})");

    /* renamed from: s  reason: collision with root package name */
    private static final Regex f49918s = new Regex("([A-Z0-9<]{30})");

    /* renamed from: t  reason: collision with root package name */
    private static final Regex f49919t = new Regex("([ACI][A-Z0-9<]{1})([A-Z]{3})([A-Z0-9<]{31})");

    /* renamed from: u  reason: collision with root package name */
    private static final Regex f49920u = new Regex("([A-Z0-9<]{9})([0-9]{1})([A-Z]{3})([0-9]{6})([0-9]{1})([MFX<]{1})([0-9]{6})([0-9]{1})([A-Z0-9<]{7})([0-9]{1})");

    /* renamed from: v  reason: collision with root package name */
    private static final Regex f49921v = new Regex("(P[A-Z0-9<]{1})([A-Z]{3})([A-Z0-9<]+?<<+)");

    /* renamed from: w  reason: collision with root package name */
    private static final Regex f49922w = new Regex("(P[A-Z0-9<]{1})([A-Z]{3})([A-Z0-9<]+?)<<([A-Z0-9<]+<<+)");

    /* renamed from: x  reason: collision with root package name */
    private static final Regex f49923x = new Regex("([A-Z0-9<]{9})([0-9]{1})([A-Z]{3})([0-9]{6})([0-9]{1})([MFX<]{1})([0-9]{6})([0-9]{1})?([A-Z0-9<]{14})?([0-9]{1})?([0-9]{1})?");
    ...
    private final String f49932i;

    /* renamed from: j  reason: collision with root package name */
    private final String f49933j;

    /* renamed from: k  reason: collision with root package name */
    private final String f49934k;

    /* renamed from: l  reason: collision with root package name */
    private final Date f49935l;

    /* renamed from: m  reason: collision with root package name */
    private final Date f49936m;

    /* renamed from: n  reason: collision with root package name */
    private final Date f49937n;

    /* renamed from: o  reason: collision with root package name */
    private final String f49938o;
    ...
    public static final class a {
        ...
        private final p0 f(String str) {
            ...
            int i10;
            boolean z10;
            MatchResult d12 = Regex.d(p0.f49916q, str, 0, 2, null);
            if (d12 == null || (d10 = Regex.d(p0.f49917r, str, 0, 2, null)) == null || (d11 = Regex.d(p0.f49918s, StringsKt.J(StringsKt.J(str, d12.getValue(), "", false, 4, null), d10.getValue(), "", false, 4, null), 0, 2, null)) == null) {
                return null;
            }
            ...
            return new p0(CollectionsKt.x0(CollectionsKt.o(d12, d10, d11), ReactEditTextInputConnectionWrapper.NEWLINE_RAW_VALUE, null, null, 0, null, new Function1() { // from class: sn.o0
        ...
        private final p0 h(String str) {
            MatchResult d10;
            MatchResult d11 = Regex.d(p0.f49922w, str, 0, 2, null);
            if (d11 == null || (d10 = Regex.d(p0.f49923x, str, 0, 2, null)) == null) {
                return null;
            }
            return new p0(CollectionsKt.x0(CollectionsKt.o(d11, d10), ReactEditTextInputConnectionWrapper.NEWLINE_RAW_VALUE, null, null, 0, null, new Function1() { // from class: sn.n0
                @Override // kotlin.jvm.functions.Function1
    ...
    public boolean equals(Object obj) {
        ...
        p0 p0Var = (p0) obj;
        if (Intrinsics.areEqual(this.f49924a, p0Var.f49924a) && Intrinsics.areEqual(this.f49925b, p0Var.f49925b) && Intrinsics.areEqual(this.f49926c, p0Var.f49926c) && Intrinsics.areEqual(this.f49927d, p0Var.f49927d) && Intrinsics.areEqual(this.f49928e, p0Var.f49928e) && Intrinsics.areEqual(this.f49929f, p0Var.f49929f) && Intrinsics.areEqual(this.f49930g, p0Var.f49930g) && Intrinsics.areEqual(this.f49931h, p0Var.f49931h) && Intrinsics.areEqual(this.f49932i, p0Var.f49932i) && Intrinsics.areEqual(this.f49933j, p0Var.f49933j) && Intrinsics.areEqual(this.f49934k, p0Var.f49934k) && Intrinsics.areEqual(this.f49935l, p0Var.f49935l) && Intrinsics.areEqual(this.f49936m, p0Var.f49936m) && Intrinsics.areEqual(this.f49937n, p0Var.f49937n) && Intrinsics.areEqual(this.f49938o, p0Var.f49938o)) {
            return true;
        }
        return false;
    }
    ...
    public int hashCode() {
        ...
        int hashCode12;
        int hashCode13;
        int hashCode14 = this.f49924a.hashCode() * 31;
    ...
    public String toString() {
        ...
        String str2 = this.f49925b;
        String str3 = this.f49926c;
        String str4 = this.f49927d;
        String str5 = this.f49928e;
        String str6 = this.f49929f;
        String str7 = this.f49930g;
        String str8 = this.f49931h;
        String str9 = this.f49932i;
        String str10 = this.f49933j;
        String str11 = this.f49934k;
        Date date = this.f49935l;
        Date date2 = this.f49936m;
        Date date3 = this.f49937n;
        String str12 = this.f49938o;
