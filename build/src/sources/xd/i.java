...
public final class i implements k.a {
    ...
    private final g f54601a;

    /* renamed from: b  reason: collision with root package name */
    private final f f54602b;

    /* renamed from: c  reason: collision with root package name */
    private static final Pattern f54577c = Pattern.compile("AVERAGE-BANDWIDTH=(\\d+)\\b");

    /* renamed from: d  reason: collision with root package name */
    private static final Pattern f54578d = Pattern.compile("VIDEO=\"(.+?)\"");

    /* renamed from: e  reason: collision with root package name */
    private static final Pattern f54579e = Pattern.compile("AUDIO=\"(.+?)\"");

    /* renamed from: f  reason: collision with root package name */
    private static final Pattern f54580f = Pattern.compile("SUBTITLES=\"(.+?)\"");

    /* renamed from: g  reason: collision with root package name */
    private static final Pattern f54581g = Pattern.compile("CLOSED-CAPTIONS=\"(.+?)\"");

    /* renamed from: h  reason: collision with root package name */
    private static final Pattern f54582h = Pattern.compile("[^-]BANDWIDTH=(\\d+)\\b");

    /* renamed from: i  reason: collision with root package name */
    private static final Pattern f54583i = Pattern.compile("CHANNELS=\"(.+?)\"");

    /* renamed from: j  reason: collision with root package name */
    private static final Pattern f54584j = Pattern.compile("CODECS=\"(.+?)\"");

    /* renamed from: k  reason: collision with root package name */
    private static final Pattern f54585k = Pattern.compile("RESOLUTION=(\\d+x\\d+)");

    /* renamed from: l  reason: collision with root package name */
    private static final Pattern f54586l = Pattern.compile("FRAME-RATE=([\\d\\.]+)\\b");

    /* renamed from: m  reason: collision with root package name */
    private static final Pattern f54587m = Pattern.compile("#EXT-X-TARGETDURATION:(\\d+)\\b");

    /* renamed from: n  reason: collision with root package name */
    private static final Pattern f54588n = Pattern.compile("DURATION=([\\d\\.]+)\\b");

    /* renamed from: o  reason: collision with root package name */
    private static final Pattern f54589o = Pattern.compile("PART-TARGET=([\\d\\.]+)\\b");

    /* renamed from: p  reason: collision with root package name */
    private static final Pattern f54590p = Pattern.compile("#EXT-X-VERSION:(\\d+)\\b");

    /* renamed from: q  reason: collision with root package name */
    private static final Pattern f54591q = Pattern.compile("#EXT-X-PLAYLIST-TYPE:(.+)\\b");

    /* renamed from: r  reason: collision with root package name */
    private static final Pattern f54592r = Pattern.compile("CAN-SKIP-UNTIL=([\\d\\.]+)\\b");

    /* renamed from: s  reason: collision with root package name */
    private static final Pattern f54593s = c("CAN-SKIP-DATERANGES");

    /* renamed from: t  reason: collision with root package name */
    private static final Pattern f54594t = Pattern.compile("SKIPPED-SEGMENTS=(\\d+)\\b");

    /* renamed from: u  reason: collision with root package name */
    private static final Pattern f54595u = Pattern.compile("[:|,]HOLD-BACK=([\\d\\.]+)\\b");

    /* renamed from: v  reason: collision with root package name */
    private static final Pattern f54596v = Pattern.compile("PART-HOLD-BACK=([\\d\\.]+)\\b");

    /* renamed from: w  reason: collision with root package name */
    private static final Pattern f54597w = c("CAN-BLOCK-RELOAD");

    /* renamed from: x  reason: collision with root package name */
    private static final Pattern f54598x = Pattern.compile("#EXT-X-MEDIA-SEQUENCE:(\\d+)\\b");

    /* renamed from: y  reason: collision with root package name */
    private static final Pattern f54599y = Pattern.compile("#EXTINF:([\\d\\.]+)\\b");

    /* renamed from: z  reason: collision with root package name */
    private static final Pattern f54600z = Pattern.compile("#EXTINF:[\\d\\.]+\\b,(.+)");
    ...
    private static final Pattern f54575a0 = Pattern.compile("IMPORT=\"(.+?)\"");

    /* renamed from: b0  reason: collision with root package name */
    private static final Pattern f54576b0 = Pattern.compile("\\{\\$([a-zA-Z0-9\\-_]+)\\}");
    ...
    public static class b {
        ...
        /* renamed from: a  reason: collision with root package name */
        private final BufferedReader f54603a;

        /* renamed from: b  reason: collision with root package name */
        private final Queue f54604b;
        ...
        public boolean a() {
            ...
            if (!this.f54604b.isEmpty()) {
                this.f54605c = (String) oe.a.e((String) this.f54604b.poll());
                return true;
            }
            do {
                String readLine = this.f54603a.readLine();
                this.f54605c = readLine;
                if (readLine != null) {
                    trim = readLine.trim();
                    this.f54605c = trim;
                } else {
    ...
    private static String B(String str, Map map) {
        Matcher matcher = f54576b0.matcher(str);
    ...
    private static m.b k(String str, String str2, Map map) {
        ...
        if ("urn:uuid:edef8ba9-79d6-4ace-a3c8-27dcd51d21ed".equals(str2)) {
            ...
            return new m.b(mc.d.f36228d, "video/mp4", Base64.decode(z10.substring(z10.indexOf(44)), 0));
        } else if ("com.widevine".equals(str2)) {
            return new m.b(mc.d.f36228d, "hls", w0.s0(str));
        } else {
    ...
    */
            ...
            if (bVar.a()) {
                ...
                if (b10.startsWith("#EXT-X-DEFINE")) {
                    ...
                    if (b10.equals("#EXT-X-INDEPENDENT-SEGMENTS")) {
                        ...
                        arrayList5 = arrayList16;
                        int m10 = m(b10, f54582h);
                        int s10 = s(b10, f54577c, -1);
                        String v10 = v(b10, f54584j, hashMap2);
                        arrayList6 = arrayList15;
                        String v11 = v(b10, f54585k, hashMap2);
                        if (v11 != null) {
                            z11 = z13;
                        ...
                        arrayList7 = arrayList12;
                        String v12 = v(b10, f54586l, hashMap2);
                        if (v12 != null) {
                        ...
                        arrayList8 = arrayList11;
                        String v13 = v(b10, f54578d, hashMap2);
                        String v14 = v(b10, f54579e, hashMap2);
                        String v15 = v(b10, f54580f, hashMap2);
                        String v16 = v(b10, f54581g, hashMap2);
                        if (startsWith) {
                ...
                while (i15 < arrayList9.size()) {
                    ...
                    if (hashSet.add(bVar3.f54566a)) {
                        if (bVar3.f54567b.f12302u == null) {
                            z10 = i14;
                        } else {
                            z10 = 0;
                        }
                        ...
                        bVarArr[0] = new q(null, null, (List) oe.a.e((ArrayList) hashMap.get(bVar3.f54566a)));
                        arrayList24.add(bVar3.a(bVar3.f54567b.b().Z(new Metadata(bVarArr)).G()));
                    }
                    i15++;
                    i14 = 1;
                }
                ...
                while (i16 < arrayList14.size()) {
                    ...
                    switch (c10) {
                        case 0:
                            ...
                            if (g10 != null) {
                                String M2 = w0.M(g10.f54567b.f12301t, 3);
                                X2.K(M2);
                                str2 = c0.g(M2);
                            } else {
                                str2 = null;
                        ...
                        case 2:
                            ...
                            if (f11 != null) {
                                bVar2 = f11;
                                String M3 = w0.M(f11.f54567b.f12301t, 1);
                                X2.K(M3);
                                str4 = c0.g(M3);
                            } else {
                                bVar2 = f11;
                            ...
                            String v18 = v(str6, f54583i, hashMap2);
                            if (v18 != null) {
                        ...
                        case 3:
                            ...
                            if (h10 != null) {
                                Format format2 = h10.f54567b;
                                String M4 = w0.M(format2.f12301t, 2);
    ...
    private static f.C0764f y(String str) {
        long j10;
        long j11;
        double r10 = r(str, f54592r, -9.223372036854776E18d);
        ...
        boolean q10 = q(str, f54593s, false);
        double r11 = r(str, f54595u, -9.223372036854776E18d);
        if (r11 == -9.223372036854776E18d) {
            j11 = -9223372036854775807L;
        } else {
            j11 = (long) (r11 * 1000000.0d);
        }
        double r12 = r(str, f54596v, -9.223372036854776E18d);
        if (r12 != -9.223372036854776E18d) {
            j12 = (long) (r12 * 1000000.0d);
        }
        return new f.C0764f(j10, q10, j11, j12, q(str, f54597w, false));
    }
    ...
    public h a(Uri uri, InputStream inputStream) {
        ...
        try {
            if (b(bufferedReader)) {
                ...
                arrayDeque.add(trim);
                return o(this.f54601a, this.f54602b, new b(arrayDeque, bufferedReader), uri.toString());
            }
