...
public abstract class j {
    ...
    private static final k0 f55641a = new k0("PhoneskyVerificationUtils");
    ...
    public static boolean b(Context context) {
        try {
            if (!context.getPackageManager().getApplicationInfo("com.android.vending", 0).enabled) {
                f55641a.e("Play Store package is disabled.", new Object[0]);
            } else {
                try {
                    ...
                    if (signatureArr != null && (r0 = signatureArr.length) != 0) {
                        ...
                        f55641a.e("Play Store package is not signed -- possibly self-built package. Could not verify.", new Object[0]);
                    }
                } catch (PackageManager.NameNotFoundException unused) {
                    f55641a.e("Play Store package is not found.", new Object[0]);
                }
            }
