...
public abstract class u2 {
    ...
    public static final List c(List list) {
        ...
        for (String str : list2) {
            arrayList.add(new d.a(str, a.f6659e, 0, 4, null));
        }
        return arrayList;
    }
    ...
    public static final String d(GenericFileUploadErrorResponse.DocumentErrorResponse documentErrorResponse, Context context) {
        if (documentErrorResponse instanceof GenericFileUploadErrorResponse.DocumentErrorResponse.DisabledFileTypeError) {
            ...
            String string = context.getString(hp.e.f26799d, disabledFileTypeError.getDetails().getUploadedFileType(), CollectionsKt.x0(disabledFileTypeError.getDetails().getEnabledFileTypes(), ", ", null, null, 0, null, null, 62, null));
            ...
            String string2 = context.getString(hp.e.f26800e);
            ...
            String string3 = context.getString(hp.e.f26804i, Integer.valueOf(((GenericFileUploadErrorResponse.DocumentErrorResponse.PageLimitExceededError) documentErrorResponse).getDetails().getPageLimit()));
            ...
            String string4 = context.getString(hp.e.f26802g);
            ...
            String string5 = context.getString(hp.e.f26802g);
            ...
            String string6 = context.getString(hp.e.f26803h);
            ...
            String string7 = context.getString(hp.e.f26801f, Integer.valueOf(((GenericFileUploadErrorResponse.DocumentErrorResponse.GovernmentIdDimensionSizeError) documentErrorResponse).getDetails().getMinDimensionSize()));
            Intrinsics.checkNotNullExpressionValue(string7, "getString(...)");
            return string7;
        } else if (documentErrorResponse instanceof GenericFileUploadErrorResponse.DocumentErrorResponse.UnknownError) {
            String string8 = context.getString(hp.e.f26805j);
