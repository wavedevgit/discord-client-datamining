...
public final class b3 implements bq.b {

    /* renamed from: d  reason: collision with root package name */
    private final List f6676d;

    /* renamed from: e  reason: collision with root package name */
    private final List f6677e;

    /* renamed from: i  reason: collision with root package name */
    private final StepStyles.UiStepStyle f6678i;
    ...
    public static final a f6675s = new a(null);
    @NotNull
    ...
    public static final class a {
        ...
        public final b3 a(String str, String str2, String str3, StepStyles.DocumentStepStyle documentStepStyle) {
            ...
            if (documentStepStyle != null && (buttonPrimaryStyleValue = documentStepStyle.getButtonPrimaryStyleValue()) != null) {
                buttonCombinedStepComponentStyle = bo.b.b(buttonPrimaryStyleValue);
            } else {
            ...
            if (documentStepStyle != null && (buttonSecondaryStyleValue = documentStepStyle.getButtonSecondaryStyleValue()) != null) {
                buttonCombinedStepComponentStyle2 = bo.b.a(buttonSecondaryStyleValue);
            }
    ...
    public b3(List list, List componentConfigs, StepStyles.UiStepStyle uiStepStyle, String str, String str2, String str3, String str4) {
        ...
        this.f6676d = list;
        this.f6677e = componentConfigs;
        this.f6678i = uiStepStyle;
        this.f6679o = str;
        this.f6680p = str2;
        this.f6681q = str3;
        this.f6682r = str4;
    ...
    public final void writeToParcel(Parcel dest, int i10) {
        ...
        List<Parcelable> list = this.f6676d;
        if (list == null) {
            dest.writeInt(0);
        } else {
            dest.writeInt(1);
        ...
        List<Parcelable> list2 = this.f6677e;
        dest.writeInt(list2.size());
        for (Parcelable parcelable2 : list2) {
            dest.writeParcelable(parcelable2, i10);
        }
        dest.writeParcelable(this.f6678i, i10);
        dest.writeString(this.f6679o);
        dest.writeString(this.f6680p);
        dest.writeString(this.f6681q);
        dest.writeString(this.f6682r);
    }
}
