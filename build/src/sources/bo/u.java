...
public final class u implements bq.b {

    /* renamed from: d  reason: collision with root package name */
    private final List f6973d;

    /* renamed from: e  reason: collision with root package name */
    private final List f6974e;

    /* renamed from: i  reason: collision with root package name */
    private final StepStyles.UiStepStyle f6975i;
    ...
    public u(List list, List componentConfigs, StepStyles.UiStepStyle uiStepStyle, String str, String str2, String str3, String str4) {
        ...
        this.f6973d = list;
        this.f6974e = componentConfigs;
        this.f6975i = uiStepStyle;
        this.f6976o = str;
        this.f6977p = str2;
        this.f6978q = str3;
        this.f6979r = str4;
    ...
    public final void writeToParcel(Parcel dest, int i10) {
        ...
        List<Parcelable> list = this.f6973d;
        if (list == null) {
            dest.writeInt(0);
        } else {
            dest.writeInt(1);
        ...
        List<Parcelable> list2 = this.f6974e;
        dest.writeInt(list2.size());
        for (Parcelable parcelable2 : list2) {
            dest.writeParcelable(parcelable2, i10);
        }
        dest.writeParcelable(this.f6975i, i10);
        dest.writeString(this.f6976o);
        dest.writeString(this.f6977p);
        dest.writeString(this.f6978q);
        dest.writeString(this.f6979r);
    }
}
