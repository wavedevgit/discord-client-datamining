...
public final class f0 implements vm.k {
    ...
    private final fo.i f7564b;

    /* renamed from: c  reason: collision with root package name */
    private final bq.k f7565c;

    /* loaded from: /home/runner/work/discord-client-datamining/discord-client-datamining/build/classes4.dex */
    public static final class a implements vm.c0 {

        /* renamed from: a  reason: collision with root package name */
        private final /* synthetic */ vm.c0 f7566a;

        /* renamed from: bo.f0$a$a  reason: collision with other inner class name */
        /* loaded from: /home/runner/work/discord-client-datamining/discord-client-datamining/build/classes4.dex */
        /* synthetic */ class C0118a extends FunctionReferenceImpl implements Function3 {

            /* renamed from: d  reason: collision with root package name */
            public static final C0118a f7567d = new C0118a();

            C0118a() {
                super(3, fo.i.class, "inflate", "inflate(Landroid/view/LayoutInflater;Landroid/view/ViewGroup;Z)Lcom/withpersona/sdk2/inquiry/governmentid/databinding/Pi2GovernmentidSelectCountryAndIdClassBinding;", 0);
            }

            public final fo.i a(LayoutInflater p02, ViewGroup viewGroup, boolean z10) {
                Intrinsics.checkNotNullParameter(p02, "p0");
                return fo.i.c(p02, viewGroup, z10);
            }
        ...
        /* synthetic */ class b extends FunctionReferenceImpl implements Function1 {
            ...
            /* renamed from: d  reason: collision with root package name */
            public static final b f7568d = new b();
            ...
            /* renamed from: a */
            public final f0 invoke(fo.i p02) {
                Intrinsics.checkNotNullParameter(p02, "p0");
                return new f0(p02);
            }
        }
        ...
        @Override // vm.c0
        /* renamed from: b */
        public View a(f5.a initialRendering, vm.a0 initialViewEnvironment, Context contextForNewView, ViewGroup viewGroup) {
            Intrinsics.checkNotNullParameter(initialRendering, "initialRendering");
            Intrinsics.checkNotNullParameter(initialViewEnvironment, "initialViewEnvironment");
            Intrinsics.checkNotNullParameter(contextForNewView, "contextForNewView");
            return this.f7566a.a(initialRendering, initialViewEnvironment, contextForNewView, viewGroup);
        }

        @Override // vm.c0
        public KClass getType() {
            return this.f7566a.getType();
        }
    ...
    public f0(fo.i binding) {
        Intrinsics.checkNotNullParameter(binding, "binding");
        this.f7564b = binding;
        CoordinatorLayout root = binding.getRoot();
        Intrinsics.checkNotNullExpressionValue(root, "getRoot(...)");
        this.f7565c = new bq.k(root);
        LinearLayout contentView = binding.f25401b;
        Intrinsics.checkNotNullExpressionValue(contentView, "contentView");
        tp.f.d(contentView, false, false, false, false, 15, null);
    }

    private final void j(fo.i iVar, StepStyles.GovernmentIdStepStyle governmentIdStepStyle, vm.a0 a0Var) {
        ...
        if (governmentIdStepStyle != null) {
            ...
            if (titleStyle != null && (base7 = titleStyle.getBase()) != null && (base8 = base7.getBase()) != null) {
                TextView title = iVar.f25408i;
                Intrinsics.checkNotNullExpressionValue(title, "title");
                cq.f0.n(title, base8, null, 2, null);
            }
            ...
            if (textStyle != null && (base5 = textStyle.getBase()) != null && (base6 = base5.getBase()) != null) {
                TextView countrySelectorText = iVar.f25404e;
                Intrinsics.checkNotNullExpressionValue(countrySelectorText, "countrySelectorText");
                cq.f0.n(countrySelectorText, base6, null, 2, null);
                TextView idClassSelectorText = iVar.f25406g;
                Intrinsics.checkNotNullExpressionValue(idClassSelectorText, "idClassSelectorText");
                cq.f0.n(idClassSelectorText, base6, null, 2, null);
            }
            ...
            if (inputSelectStyle != null && (base3 = inputSelectStyle.getBase()) != null && (base4 = base3.getBase()) != null) {
                TextInputLayout countrySelector = iVar.f25403d;
                Intrinsics.checkNotNullExpressionValue(countrySelector, "countrySelector");
                cq.o.i(countrySelector, base4);
                TextInputLayout idClassSelector = iVar.f25405f;
                Intrinsics.checkNotNullExpressionValue(idClassSelector, "idClassSelector");
                cq.o.i(idClassSelector, base4);
            }
            ...
            if (buttonPrimaryStyle != null && (base = buttonPrimaryStyle.getBase()) != null && (base2 = base.getBase()) != null) {
                Button continueButton = iVar.f25402c;
    ...
    private final void k(c2 c2Var, final Function1 function1) {
        this.f7565c.u(c2Var, new Function1() { // from class: bo.e0
            @Override // kotlin.jvm.functions.Function1
    ...
    @Override // vm.k
    /* renamed from: m */
    public void a(final f5.a rendering, vm.a0 viewEnvironment) {
        String str;
        Intrinsics.checkNotNullParameter(rendering, "rendering");
        Intrinsics.checkNotNullParameter(viewEnvironment, "viewEnvironment");
        fo.i iVar = this.f7564b;
        rp.a f10 = rendering.f();
        Function0 function0 = new Function0() { // from class: bo.x
        ...
        Function0 function02 = new Function0() { // from class: bo.y
            @Override // kotlin.jvm.functions.Function0
            public final Object invoke() {
                Unit o10;
                o10 = f0.o(f5.a.this);
        ...
        iVar.f25403d.setOnClickListener(new View.OnClickListener() { // from class: bo.z
            @Override // android.view.View.OnClickListener
            public final void onClick(View view) {
                f0.p(f0.this, rendering, view);
            }
        });
        EditText editText = iVar.f25403d.getEditText();
        if (editText != null) {
            editText.setOnClickListener(new View.OnClickListener() { // from class: bo.a0
                @Override // android.view.View.OnClickListener
                public final void onClick(View view) {
        ...
        EditText editText2 = iVar.f25403d.getEditText();
        if (editText2 != null) {
            editText2.setText(str);
        }
        if (str != null) {
            iVar.f25405f.setEnabled(true);
            EditText editText3 = iVar.f25405f.getEditText();
            if (editText3 != null) {
                editText3.setEnabled(true);
            }
            iVar.f25405f.setOnClickListener(new View.OnClickListener() { // from class: bo.b0
                @Override // android.view.View.OnClickListener
                public final void onClick(View view) {
                    f0.r(f0.this, rendering, view);
                }
            });
            EditText editText4 = iVar.f25405f.getEditText();
            if (editText4 != null) {
                editText4.setOnClickListener(new View.OnClickListener() { // from class: bo.c0
                    @Override // android.view.View.OnClickListener
                    public final void onClick(View view) {
            ...
            EditText editText5 = iVar.f25405f.getEditText();
            if (editText5 != null) {
            ...
            iVar.f25405f.setEnabled(false);
            EditText editText6 = iVar.f25405f.getEditText();
            if (editText6 != null) {
                editText6.setEnabled(false);
            }
        }
        iVar.f25404e.setText(rendering.b());
        iVar.f25406g.setText(rendering.d());
        iVar.f25402c.setEnabled(rendering.n());
        iVar.f25402c.setOnClickListener(new View.OnClickListener() { // from class: bo.d0
            @Override // android.view.View.OnClickListener
            public final void onClick(View view) {
                f0.t(f5.a.this, view);
            }
        });
        iVar.f25402c.setText(rendering.a());
