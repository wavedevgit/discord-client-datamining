...
public final class l implements Parcelable {
    ...
    private final u f6778d;

    /* renamed from: e  reason: collision with root package name */
    private final b3 f6779e;
    ...
    public l(u documentStartPage, b3 uploadOptionsDialog) {
        ...
        this.f6778d = documentStartPage;
        this.f6779e = uploadOptionsDialog;
    }
    ...
    public final void writeToParcel(Parcel dest, int i10) {
        ...
        this.f6778d.writeToParcel(dest, i10);
        this.f6779e.writeToParcel(dest, i10);
    }
}
