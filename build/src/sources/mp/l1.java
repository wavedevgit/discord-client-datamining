...
public final class l1 implements dn.k {
    ...
    private final np.e f37533b;

    /* renamed from: c  reason: collision with root package name */
    private View f37534c;

    /* loaded from: /home/runner/work/discord-client-datamining/discord-client-datamining/build/classes4.dex */
    public static final class a implements dn.c0 {

        /* renamed from: a  reason: collision with root package name */
        private final /* synthetic */ dn.c0 f37535a;
        ...
        /* synthetic */ class C0509a extends FunctionReferenceImpl implements Function3 {
            ...
            /* renamed from: d  reason: collision with root package name */
            public static final C0509a f37536d = new C0509a();
        ...
        /* synthetic */ class b extends FunctionReferenceImpl implements Function1 {
            ...
            /* renamed from: d  reason: collision with root package name */
            public static final b f37537d = new b();
        ...
        public View a(x5.d.b initialRendering, dn.a0 initialViewEnvironment, Context contextForNewView, ViewGroup viewGroup) {
            ...
            return this.f37535a.a(initialRendering, initialViewEnvironment, contextForNewView, viewGroup);
        }

        @Override // dn.c0
        public KClass getType() {
            return this.f37535a.getType();
        }

        private a() {
            k.a aVar = dn.k.f20913a;
            this.f37535a = new dn.z(Reflection.getOrCreateKotlinClass(x5.d.b.class), C0509a.f37536d, b.f37537d);
        }
    }

    public l1(np.e binding) {
        Intrinsics.checkNotNullParameter(binding, "binding");
        this.f37533b = binding;
    ...
    private final void e(StepStyles.SelfieStepStyle selfieStepStyle, dn.a0 a0Var) {
        ...
        if (titleStyleValue != null) {
            TextView textView = this.f37533b.f41177m;
            textView.setPadding(textView.getPaddingLeft(), 0, this.f37533b.f41177m.getPaddingRight(), 0);
            TextView textviewSelfieStartTitle = this.f37533b.f41177m;
        ...
        if (textStyleValue != null) {
            TextView textView2 = this.f37533b.f41176l;
            textView2.setPadding(textView2.getPaddingLeft(), 0, this.f37533b.f41176l.getPaddingRight(), 0);
            TextView textviewSelfieStartBody = this.f37533b.f41176l;
        ...
        if (disclaimerStyleValue != null) {
            TextView textView3 = this.f37533b.f41175k;
            textView3.setPadding(textView3.getPaddingLeft(), 0, this.f37533b.f41175k.getPaddingRight(), 0);
            TextView textviewSelfieDisclosure = this.f37533b.f41175k;
    ...
    private final void j(StepStyles.SelfieStepStyle selfieStepStyle) {
        if (selfieStepStyle != null) {
            ThemeableLottieAnimationView instructionAnimation = this.f37533b.f41169e;
        ...
        ThemeableLottieAnimationView themeableLottieAnimationView = this.f37533b.f41169e;
        int parseColor = Color.parseColor("#022050");
        Context context = this.f37533b.getRoot().getContext();
        Intrinsics.checkNotNullExpressionValue(context, "getContext(...)");
        themeableLottieAnimationView.I(parseColor, rp.s.d(context, ah.b.f651m, null, false, 6, null));
        ThemeableLottieAnimationView themeableLottieAnimationView2 = this.f37533b.f41169e;
        int parseColor2 = Color.parseColor("#AA85FF");
        Context context2 = this.f37533b.getRoot().getContext();
        Intrinsics.checkNotNullExpressionValue(context2, "getContext(...)");
        themeableLottieAnimationView2.I(parseColor2, rp.s.d(context2, ah.b.f652n, null, false, 6, null));
        Context context3 = this.f37533b.getRoot().getContext();
        Intrinsics.checkNotNullExpressionValue(context3, "getContext(...)");
        int d10 = rp.s.d(context3, ah.b.f652n, null, false, 6, null);
        Context context4 = this.f37533b.getRoot().getContext();
        Intrinsics.checkNotNullExpressionValue(context4, "getContext(...)");
        this.f37533b.f41169e.I(Color.parseColor("#DBCCFF"), r1.c.c(d10, rp.s.d(context4, ah.b.f653o, null, false, 6, null), 0.66f));
    }
    ...
    public void a(final x5.d.b rendering, dn.a0 viewEnvironment) {
        ...
        np.e eVar = this.f37533b;
        Context context = eVar.getRoot().getContext();
        Intrinsics.checkNotNullExpressionValue(context, "getContext(...)");
        Integer f10 = rp.s.f(context, jp.a.f30828t, null, false, 6, null);
        if (f10 != null) {
            this.f37533b.f41168d.setImageResource(f10.intValue());
            this.f37533b.f41168d.setVisibility(0);
        }
        eVar.f41177m.setText(rendering.j());
        eVar.f41176l.setText(rendering.g());
        ir.e.b(eVar.f41175k.getContext()).c(eVar.f41175k, rendering.a());
        eVar.f41174j.setText(rendering.h());
        eVar.f41174j.setOnClickListener(new View.OnClickListener() { // from class: mp.i1
        ...
        Pi2NavigationBar navigationBar = eVar.f41171g;
        ...
        Context context2 = this.f37533b.getRoot().getContext();
        Intrinsics.checkNotNullExpressionValue(context2, "getContext(...)");
        Integer f11 = rp.s.f(context2, jp.a.f30823o, null, false, 6, null);
        if (rendering.b() != null) {
            if (this.f37534c == null) {
                RemoteImage b10 = rendering.b();
                ConstraintLayout nestedUiContainer = eVar.f41172h;
                Intrinsics.checkNotNullExpressionValue(nestedUiContainer, "nestedUiContainer");
                this.f37534c = mq.b.c(b10, nestedUiContainer, false, 2, null);
                eVar.f41169e.setVisibility(8);
            }
        } else if (f11 != null) {
            eVar.f41169e.setAnimation(f11.intValue());
            eVar.f41169e.v();
        } else {
            j(rendering.i());
        }
