...
public final class b implements ViewBinding {
    ...
    public final WorkflowViewStub f37380b;

    /* renamed from: c  reason: collision with root package name */
    public final FloatingActionButton f37381c;
    ...
    private b(CoordinatorLayout coordinatorLayout, WorkflowViewStub workflowViewStub, FloatingActionButton floatingActionButton) {
        ...
        this.f37380b = workflowViewStub;
        this.f37381c = floatingActionButton;
    }

    public static b a(View view) {
        int i10 = lp.a.f36271a;
    ...
    public static b c(LayoutInflater layoutInflater, ViewGroup viewGroup, boolean z10) {
        View inflate = layoutInflater.inflate(lp.b.f36276b, viewGroup, false);
        if (z10) {
