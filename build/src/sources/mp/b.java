...
public final class b implements ViewBinding {
    ...
    public final FrameLayout f39127b;

    /* renamed from: c  reason: collision with root package name */
    public final NestedScrollView f39128c;

    /* renamed from: d  reason: collision with root package name */
    public final FrameLayout f39129d;

    /* renamed from: e  reason: collision with root package name */
    public final Pi2NavigationBar f39130e;
    ...
    private b(ConstraintLayout constraintLayout, FrameLayout frameLayout, NestedScrollView nestedScrollView, FrameLayout frameLayout2, Pi2NavigationBar pi2NavigationBar) {
        ...
        this.f39127b = frameLayout;
        this.f39128c = nestedScrollView;
        this.f39129d = frameLayout2;
        this.f39130e = pi2NavigationBar;
    }
    ...
    public static b c(LayoutInflater layoutInflater, ViewGroup viewGroup, boolean z10) {
        View inflate = layoutInflater.inflate(n.f36276b, viewGroup, false);
        if (z10) {
