...
public interface e extends dv.c {

    /* loaded from: /home/runner/work/discord-client-datamining/discord-client-datamining/build/classes5.dex */
    public static final class a {
        private static boolean a(e eVar, List list, Function2 function2) {
            boolean b10 = eVar.b(CollectionsKt.o((Comparable) CollectionsKt.firstOrNull(list), (Comparable) mw.c.b(list)), function2);
            boolean b11 = eVar.b(CollectionsKt.o((Comparable) mw.c.b(list), (Comparable) mw.c.c(list)), function2);
            if (!b10 || !b11) {
                return false;
            }
            return true;
