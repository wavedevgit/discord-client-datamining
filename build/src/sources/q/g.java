...
public class g implements a0.u {
    ...
    private final a0.q2 f46774a;

    /* renamed from: b  reason: collision with root package name */
    private final CaptureResult f46775b;

    public g(a0.q2 q2Var, CaptureResult captureResult) {
        this.f46774a = q2Var;
        this.f46775b = captureResult;
    }

    @Override // a0.u
    public long a() {
        Long l10 = (Long) this.f46775b.get(CaptureResult.SENSOR_TIMESTAMP);
        if (l10 == null) {
            return -1L;
        }
    ...
    public void b(h.b bVar) {
        super.b(bVar);
        try {
            Integer num = (Integer) this.f46775b.get(CaptureResult.JPEG_ORIENTATION);
            if (num != null) {
                bVar.m(num.intValue());
            }
        ...
        Long l10 = (Long) this.f46775b.get(CaptureResult.SENSOR_EXPOSURE_TIME);
        if (l10 != null) {
            bVar.f(l10.longValue());
        }
        Float f10 = (Float) this.f46775b.get(CaptureResult.LENS_APERTURE);
        if (f10 != null) {
            bVar.l(f10.floatValue());
        }
        Integer num2 = (Integer) this.f46775b.get(CaptureResult.SENSOR_SENSITIVITY);
        if (num2 != null) {
            Integer num3 = (Integer) this.f46775b.get(CaptureResult.CONTROL_POST_RAW_SENSITIVITY_BOOST);
            if (num3 != null) {
                num2 = Integer.valueOf(num2.intValue() * ((int) (num3.intValue() / 100.0f)));
            }
            bVar.k(num2.intValue());
        }
        Float f11 = (Float) this.f46775b.get(CaptureResult.LENS_FOCAL_LENGTH);
        if (f11 != null) {
            bVar.h(f11.floatValue());
        }
        Integer num4 = (Integer) this.f46775b.get(CaptureResult.CONTROL_AWB_MODE);
        if (num4 != null) {
            h.c cVar = h.c.AUTO;
            if (num4.intValue() == 0) {
                cVar = h.c.MANUAL;
    ...
    @Override // a0.u
    public a0.t d() {
        Integer num = (Integer) this.f46775b.get(CaptureResult.FLASH_STATE);
        if (num == null) {
            return a0.t.UNKNOWN;
        }
    ...
    @Override // a0.u
    public a0.r e() {
        Integer num = (Integer) this.f46775b.get(CaptureResult.CONTROL_AWB_MODE);
        if (num == null) {
            return a0.r.UNKNOWN;
        }
        switch (num.intValue()) {
    ...
    @Override // a0.u
    public a0.n g() {
        Integer num = (Integer) this.f46775b.get(CaptureResult.CONTROL_AE_MODE);
        if (num == null) {
            return a0.n.UNKNOWN;
        }
        int intValue = num.intValue();
    ...
    @Override // a0.u
    public a0.q h() {
        Integer num = (Integer) this.f46775b.get(CaptureResult.CONTROL_AF_STATE);
        if (num == null) {
            return a0.q.UNKNOWN;
        }
        switch (num.intValue()) {
    ...
    @Override // a0.u
    public a0.s i() {
        Integer num = (Integer) this.f46775b.get(CaptureResult.CONTROL_AWB_STATE);
        if (num == null) {
            return a0.s.UNKNOWN;
        }
        int intValue = num.intValue();
    ...
    @Override // a0.u
    public a0.p j() {
        Integer num = (Integer) this.f46775b.get(CaptureResult.CONTROL_AF_MODE);
        if (num == null) {
            return a0.p.UNKNOWN;
        }
        int intValue = num.intValue();
    ...
    @Override // a0.u
    public a0.o k() {
        Integer num = (Integer) this.f46775b.get(CaptureResult.CONTROL_AE_STATE);
        if (num == null) {
            return a0.o.UNKNOWN;
        }
        int intValue = num.intValue();
