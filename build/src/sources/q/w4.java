...
public final class w4 {
    ...
    private final u f47162a;

    /* renamed from: b  reason: collision with root package name */
    private final MutableLiveData f47163b;

    /* renamed from: c  reason: collision with root package name */
    private final boolean f47164c;

    /* renamed from: d  reason: collision with root package name */
    private final Executor f47165d;
    ...
    public w4(u uVar, r.a0 a0Var, Executor executor) {
        this.f47162a = uVar;
        this.f47165d = executor;
        Objects.requireNonNull(a0Var);
        this.f47164c = u.g.a(new w0(a0Var));
        this.f47163b = new MutableLiveData(0);
    ...
    public static /* synthetic */ Object a(final w4 w4Var, final boolean z10, final c.a aVar) {
        w4Var.f47165d.execute(new Runnable() { // from class: q.t4
    ...
    public static /* synthetic */ boolean b(w4 w4Var, TotalCaptureResult totalCaptureResult) {
        ...
        if (w4Var.f47167f != null) {
            ...
            if (z10 == w4Var.f47168g) {
                w4Var.f47167f.c(null);
                w4Var.f47167f = null;
            }
        }
        return false;
    ...
    public ListenableFuture d(final boolean z10) {
        ...
        h(this.f47163b, Integer.valueOf(z10 ? 1 : 0));
    ...
    public void g(boolean z10) {
        if (this.f47166e != z10) {
            ...
            if (!z10) {
                if (this.f47168g) {
                    this.f47168g = false;
                    this.f47162a.y(false);
                    h(this.f47163b, 0);
                }
                c.a aVar = this.f47167f;
                if (aVar != null) {
                    aVar.f(new j.a("Camera is not active."));
                    this.f47167f = null;
                }
