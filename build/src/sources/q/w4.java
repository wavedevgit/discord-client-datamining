...
public final class w4 {
    ...
    private final u f43681a;

    /* renamed from: b  reason: collision with root package name */
    private final MutableLiveData f43682b;

    /* renamed from: c  reason: collision with root package name */
    private final boolean f43683c;

    /* renamed from: d  reason: collision with root package name */
    private final Executor f43684d;
    ...
    public w4(u uVar, r.a0 a0Var, Executor executor) {
        this.f43681a = uVar;
        this.f43684d = executor;
        Objects.requireNonNull(a0Var);
        this.f43683c = u.g.a(new w0(a0Var));
        this.f43682b = new MutableLiveData(0);
    ...
    public static /* synthetic */ Object a(final w4 w4Var, final boolean z10, final c.a aVar) {
        w4Var.f43684d.execute(new Runnable() { // from class: q.t4
    ...
    public static /* synthetic */ boolean b(w4 w4Var, TotalCaptureResult totalCaptureResult) {
        ...
        if (w4Var.f43686f != null) {
            ...
            if (z10 == w4Var.f43687g) {
                w4Var.f43686f.c(null);
                w4Var.f43686f = null;
            }
        }
        return false;
    ...
    public ListenableFuture d(final boolean z10) {
        ...
        h(this.f43682b, Integer.valueOf(z10 ? 1 : 0));
    ...
    public void g(boolean z10) {
        if (this.f43685e != z10) {
            ...
            if (!z10) {
                if (this.f43687g) {
                    this.f43687g = false;
                    this.f43681a.y(false);
                    h(this.f43682b, 0);
                }
                c.a aVar = this.f43686f;
                if (aVar != null) {
                    aVar.f(new j.a("Camera is not active."));
                    this.f43686f = null;
                }
