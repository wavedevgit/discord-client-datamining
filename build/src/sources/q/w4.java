...
public final class w4 {
    ...
    private final MutableLiveData f46211b;

    /* renamed from: c  reason: collision with root package name */
    private final boolean f46212c;

    /* renamed from: d  reason: collision with root package name */
    private final Executor f46213d;
    ...
    public w4(u uVar, r.a0 a0Var, Executor executor) {
        ...
        this.f46212c = u.g.a(new w0(a0Var));
        this.f46211b = new MutableLiveData(0);
    ...
    public static /* synthetic */ Object a(final w4 w4Var, final boolean z10, final c.a aVar) {
        w4Var.f46213d.execute(new Runnable() { // from class: q.t4
    ...
    public static /* synthetic */ boolean b(w4 w4Var, TotalCaptureResult totalCaptureResult) {
        ...
        if (w4Var.f46215f != null) {
            ...
            if (z10 == w4Var.f46216g) {
                w4Var.f46215f.c(null);
                w4Var.f46215f = null;
            }
        }
        return false;
    ...
    public ListenableFuture d(final boolean z10) {
        ...
        h(this.f46211b, Integer.valueOf(z10 ? 1 : 0));
    ...
    public void g(boolean z10) {
        if (this.f46214e != z10) {
            ...
            if (!z10) {
                if (this.f46216g) {
                    this.f46216g = false;
                    this.f46210a.y(false);
                    h(this.f46211b, 0);
                }
                c.a aVar = this.f46215f;
                if (aVar != null) {
                    aVar.f(new j.a("Camera is not active."));
                    this.f46215f = null;
                }
