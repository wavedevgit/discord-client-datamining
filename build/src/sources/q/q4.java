...
public class q4 extends m4 {
    ...
    private final ScheduledExecutorService f44115o;

    /* renamed from: p  reason: collision with root package name */
    private final Object f44116p;

    /* renamed from: q  reason: collision with root package name */
    private List f44117q;

    /* renamed from: r  reason: collision with root package name */
    ListenableFuture f44118r;

    /* renamed from: s  reason: collision with root package name */
    private final u.i f44119s;

    /* renamed from: t  reason: collision with root package name */
    private final u.h f44120t;

    /* renamed from: u  reason: collision with root package name */
    private final u.t f44121u;

    /* renamed from: v  reason: collision with root package name */
    private final u.v f44122v;

    /* renamed from: w  reason: collision with root package name */
    private final AtomicBoolean f44123w;
    ...
    public q4(a0.d2 d2Var, a0.d2 d2Var2, c3 c3Var, Executor executor, ScheduledExecutorService scheduledExecutorService, Handler handler) {
        ...
        this.f44116p = new Object();
        boolean z10 = false;
        this.f44123w = new AtomicBoolean(false);
        this.f44119s = new u.i(d2Var, d2Var2);
        this.f44121u = new u.t((d2Var.a(CaptureSessionStuckQuirk.class) || d2Var.a(IncorrectCaptureStateQuirk.class)) ? true : true);
        this.f44120t = new u.h(d2Var2);
        this.f44122v = new u.v(d2Var2);
        this.f44115o = scheduledExecutorService;
    }
    ...
    @Override // q.m4, q.g4
    public void close() {
        if (!this.f44123w.compareAndSet(false, true)) {
        ...
        this.f44121u.e().a(new Runnable() { // from class: q.o4
    ...
    public void e(int i10) {
        ...
        if (i10 == 5) {
            synchronized (this.f44116p) {
                try {
                    if (D() && this.f44117q != null) {
                        J("Close DeferrableSurfaces for CameraDevice error.");
                        for (a0.w0 w0Var : this.f44117q) {
                            w0Var.d();
                        }
                    }
                } catch (Throwable th2) {
    ...
    public int h(CaptureRequest captureRequest, CameraCaptureSession.CaptureCallback captureCallback) {
        return super.h(captureRequest, this.f44121u.d(captureCallback));
    }
    ...
    public int j(List list, CameraCaptureSession.CaptureCallback captureCallback) {
        return super.j(list, this.f44121u.d(captureCallback));
    }

    @Override // q.g4
    public ListenableFuture n() {
        return d0.n.q(1500L, this.f44115o, this.f44121u.e());
    }

    @Override // q.m4, q.g4.c
    public void q(g4 g4Var) {
        synchronized (this.f44116p) {
            this.f44119s.a(this.f44117q);
        }
        J("onClosed()");
        super.q(g4Var);
    }
    ...
    public void s(g4 g4Var) {
        ...
        this.f44120t.c(g4Var, this.f44069b.e(), this.f44069b.d(), new h.a() { // from class: q.n4
            @Override // u.h.a
        ...
        synchronized (this.f44116p) {
            try {
                if (D()) {
                    ...
                    ListenableFuture listenableFuture = this.f44118r;
