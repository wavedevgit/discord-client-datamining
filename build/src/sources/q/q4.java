...
public class q4 extends m4 {
    ...
    private final ScheduledExecutorService f46542o;

    /* renamed from: p  reason: collision with root package name */
    private final Object f46543p;

    /* renamed from: q  reason: collision with root package name */
    private List f46544q;

    /* renamed from: r  reason: collision with root package name */
    ListenableFuture f46545r;

    /* renamed from: s  reason: collision with root package name */
    private final u.i f46546s;

    /* renamed from: t  reason: collision with root package name */
    private final u.h f46547t;

    /* renamed from: u  reason: collision with root package name */
    private final u.t f46548u;

    /* renamed from: v  reason: collision with root package name */
    private final u.v f46549v;

    /* renamed from: w  reason: collision with root package name */
    private final AtomicBoolean f46550w;
    ...
    public q4(a0.d2 d2Var, a0.d2 d2Var2, c3 c3Var, Executor executor, ScheduledExecutorService scheduledExecutorService, Handler handler) {
        ...
        this.f46543p = new Object();
        boolean z10 = false;
        this.f46550w = new AtomicBoolean(false);
        this.f46546s = new u.i(d2Var, d2Var2);
        this.f46548u = new u.t((d2Var.a(CaptureSessionStuckQuirk.class) || d2Var.a(IncorrectCaptureStateQuirk.class)) ? true : true);
        this.f46547t = new u.h(d2Var2);
        this.f46549v = new u.v(d2Var2);
        this.f46542o = scheduledExecutorService;
    }
    ...
    @Override // q.m4, q.g4
    public void close() {
        if (!this.f46550w.compareAndSet(false, true)) {
        ...
        this.f46548u.e().a(new Runnable() { // from class: q.o4
    ...
    public void e(int i10) {
        ...
        if (i10 == 5) {
            synchronized (this.f46543p) {
                try {
                    if (D() && this.f46544q != null) {
                        J("Close DeferrableSurfaces for CameraDevice error.");
                        for (a0.w0 w0Var : this.f46544q) {
                            w0Var.d();
                        }
                    }
                } catch (Throwable th2) {
    ...
    public int h(CaptureRequest captureRequest, CameraCaptureSession.CaptureCallback captureCallback) {
        return super.h(captureRequest, this.f46548u.d(captureCallback));
    }
    ...
    public int j(List list, CameraCaptureSession.CaptureCallback captureCallback) {
        return super.j(list, this.f46548u.d(captureCallback));
    }

    @Override // q.g4
    public ListenableFuture n() {
        return d0.n.q(1500L, this.f46542o, this.f46548u.e());
    }

    @Override // q.m4, q.g4.c
    public void q(g4 g4Var) {
        synchronized (this.f46543p) {
            this.f46546s.a(this.f46544q);
        }
        J("onClosed()");
        super.q(g4Var);
    }
    ...
    public void s(g4 g4Var) {
        ...
        this.f46547t.c(g4Var, this.f46496b.e(), this.f46496b.d(), new h.a() { // from class: q.n4
            @Override // u.h.a
        ...
        synchronized (this.f46543p) {
            try {
                if (D()) {
                    ...
                    ListenableFuture listenableFuture = this.f46545r;
