...
public class q4 extends m4 {
    ...
    private final ScheduledExecutorService f46963o;

    /* renamed from: p  reason: collision with root package name */
    private final Object f46964p;

    /* renamed from: q  reason: collision with root package name */
    private List f46965q;

    /* renamed from: r  reason: collision with root package name */
    ListenableFuture f46966r;

    /* renamed from: s  reason: collision with root package name */
    private final u.i f46967s;

    /* renamed from: t  reason: collision with root package name */
    private final u.h f46968t;

    /* renamed from: u  reason: collision with root package name */
    private final u.t f46969u;

    /* renamed from: v  reason: collision with root package name */
    private final u.v f46970v;

    /* renamed from: w  reason: collision with root package name */
    private final AtomicBoolean f46971w;
    ...
    public q4(a0.d2 d2Var, a0.d2 d2Var2, c3 c3Var, Executor executor, ScheduledExecutorService scheduledExecutorService, Handler handler) {
        ...
        this.f46964p = new Object();
        boolean z10 = false;
        this.f46971w = new AtomicBoolean(false);
        this.f46967s = new u.i(d2Var, d2Var2);
        this.f46969u = new u.t((d2Var.a(CaptureSessionStuckQuirk.class) || d2Var.a(IncorrectCaptureStateQuirk.class)) ? true : true);
        this.f46968t = new u.h(d2Var2);
        this.f46970v = new u.v(d2Var2);
        this.f46963o = scheduledExecutorService;
    }
    ...
    @Override // q.m4, q.g4
    public void close() {
        if (!this.f46971w.compareAndSet(false, true)) {
        ...
        this.f46969u.e().a(new Runnable() { // from class: q.o4
    ...
    public void e(int i10) {
        ...
        if (i10 == 5) {
            synchronized (this.f46964p) {
                try {
                    if (D() && this.f46965q != null) {
                        J("Close DeferrableSurfaces for CameraDevice error.");
                        for (a0.w0 w0Var : this.f46965q) {
                            w0Var.d();
                        }
                    }
                } catch (Throwable th2) {
    ...
    public int h(CaptureRequest captureRequest, CameraCaptureSession.CaptureCallback captureCallback) {
        return super.h(captureRequest, this.f46969u.d(captureCallback));
    }
    ...
    public int j(List list, CameraCaptureSession.CaptureCallback captureCallback) {
        return super.j(list, this.f46969u.d(captureCallback));
    }

    @Override // q.g4
    public ListenableFuture n() {
        return d0.n.q(1500L, this.f46963o, this.f46969u.e());
    }

    @Override // q.m4, q.g4.c
    public void q(g4 g4Var) {
        synchronized (this.f46964p) {
            this.f46967s.a(this.f46965q);
        }
        J("onClosed()");
        super.q(g4Var);
    }
    ...
    public void s(g4 g4Var) {
        ...
        this.f46968t.c(g4Var, this.f46917b.e(), this.f46917b.d(), new h.a() { // from class: q.n4
            @Override // u.h.a
        ...
        synchronized (this.f46964p) {
            try {
                if (D()) {
                    ...
                    ListenableFuture listenableFuture = this.f46966r;
