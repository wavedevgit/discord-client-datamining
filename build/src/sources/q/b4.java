...
public class b4 {
    ...
    private a0.w0 f46512a;

    /* renamed from: b  reason: collision with root package name */
    private a0.i2 f46513b;

    /* renamed from: d  reason: collision with root package name */
    private final Size f46515d;

    /* renamed from: f  reason: collision with root package name */
    private final c f46517f;

    /* renamed from: e  reason: collision with root package name */
    private final u.x f46516e = new u.x();

    /* renamed from: g  reason: collision with root package name */
    private i2.c f46518g = null;

    /* renamed from: c  reason: collision with root package name */
    private final b f46514c = new b();
    ...
    public class a implements d0.c {
        ...
        /* renamed from: a  reason: collision with root package name */
        final /* synthetic */ Surface f46519a;

        /* renamed from: b  reason: collision with root package name */
        final /* synthetic */ SurfaceTexture f46520b;

        a(Surface surface, SurfaceTexture surfaceTexture) {
            this.f46519a = surface;
            this.f46520b = surfaceTexture;
        }
    ...
    public static /* synthetic */ void a(b4 b4Var, a0.i2 i2Var, i2.g gVar) {
        b4Var.f46513b = b4Var.d();
        c cVar = b4Var.f46517f;
        if (cVar != null) {
            cVar.a();
        }
    }
    ...
    a0.i2 d() {
        ...
        surfaceTexture.setDefaultBufferSize(this.f46515d.getWidth(), this.f46515d.getHeight());
        Surface surface = new Surface(surfaceTexture);
        i2.b p10 = i2.b.p(this.f46514c, this.f46515d);
        p10.x(1);
        a0.k1 k1Var = new a0.k1(surface);
        this.f46512a = k1Var;
        d0.n.j(k1Var.k(), new a(surface, surfaceTexture), c0.a.a());
        p10.l(this.f46512a);
        i2.c cVar = this.f46518g;
        if (cVar != null) {
            cVar.b();
        }
