...
public class b4 {
    ...
    private a0.w0 f46662a;

    /* renamed from: b  reason: collision with root package name */
    private a0.i2 f46663b;

    /* renamed from: d  reason: collision with root package name */
    private final Size f46665d;

    /* renamed from: f  reason: collision with root package name */
    private final c f46667f;

    /* renamed from: e  reason: collision with root package name */
    private final u.x f46666e = new u.x();

    /* renamed from: g  reason: collision with root package name */
    private i2.c f46668g = null;

    /* renamed from: c  reason: collision with root package name */
    private final b f46664c = new b();
    ...
    public class a implements d0.c {
        ...
        /* renamed from: a  reason: collision with root package name */
        final /* synthetic */ Surface f46669a;

        /* renamed from: b  reason: collision with root package name */
        final /* synthetic */ SurfaceTexture f46670b;

        a(Surface surface, SurfaceTexture surfaceTexture) {
            this.f46669a = surface;
            this.f46670b = surfaceTexture;
        }

        @Override // d0.c
        /* renamed from: a */
        public void onSuccess(Void r12) {
            this.f46669a.release();
            this.f46670b.release();
        }
    ...
    public static /* synthetic */ void a(b4 b4Var, a0.i2 i2Var, i2.g gVar) {
        b4Var.f46663b = b4Var.d();
        c cVar = b4Var.f46667f;
        if (cVar != null) {
            cVar.a();
        }
    }
    ...
    a0.i2 d() {
        ...
        surfaceTexture.setDefaultBufferSize(this.f46665d.getWidth(), this.f46665d.getHeight());
        Surface surface = new Surface(surfaceTexture);
        i2.b p10 = i2.b.p(this.f46664c, this.f46665d);
        p10.x(1);
        a0.k1 k1Var = new a0.k1(surface);
        this.f46662a = k1Var;
        d0.n.j(k1Var.k(), new a(surface, surfaceTexture), c0.a.a());
        p10.l(this.f46662a);
        i2.c cVar = this.f46668g;
        if (cVar != null) {
            cVar.b();
        }
