...
final class p0 extends n0 {
    ...
    private final JsonObject f21384k;

    /* renamed from: l  reason: collision with root package name */
    private final List f21385l;
    ...
    @Override // ct.n0, ct.c, at.q2, kotlinx.serialization.encoding.c
    public void c(SerialDescriptor descriptor) {
        Intrinsics.checkNotNullParameter(descriptor, "descriptor");
    }

    @Override // ct.n0, at.g1
    protected String i0(SerialDescriptor descriptor, int i10) {
        Intrinsics.checkNotNullParameter(descriptor, "descriptor");
        return (String) this.f21385l.get(i10 / 2);
    }

    @Override // ct.n0, kotlinx.serialization.encoding.c
    public int o(SerialDescriptor descriptor) {
        Intrinsics.checkNotNullParameter(descriptor, "descriptor");
        int i10 = this.f21387n;
        if (i10 < this.f21386m - 1) {
            int i11 = i10 + 1;
            this.f21387n = i11;
            return i11;
        }
