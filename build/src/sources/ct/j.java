...
public final class j extends e {
    ...
    private final Iterable f21064o;
    ...
    static final class a extends kotlin.coroutines.jvm.internal.k implements Function2 {
        ...
        final /* synthetic */ Flow f21066e;

        /* renamed from: i  reason: collision with root package name */
        final /* synthetic */ z f21067i;
        ...
        public final Continuation create(Object obj, Continuation continuation) {
            return new a(this.f21066e, this.f21067i, continuation);
        }
    ...
    protected e f(CoroutineContext coroutineContext, int i10, at.a aVar) {
        return new j(this.f21064o, coroutineContext, i10, aVar);
    }

    @Override // ct.e
    public at.v m(CoroutineScope coroutineScope) {
        return at.s.c(coroutineScope, this.f21031d, this.f21032e, k());
    }

    public j(Iterable iterable, CoroutineContext coroutineContext, int i10, at.a aVar) {
        super(coroutineContext, i10, aVar);
        this.f21064o = iterable;
    }
}
