...
public final class n0 implements b0 {
    ...
    private bj.b f37337a;

    /* renamed from: b  reason: collision with root package name */
    private final bj.b f37338b;

    /* renamed from: c  reason: collision with root package name */
    private final e0 f37339c;
    ...
    public n0(Context context, e0 e0Var) {
        ...
        if (aVar.a().contains(xb.c.b("json"))) {
            this.f37337a = new qi.w(new bj.b() { // from class: lg.k0
                @Override // bj.b
        ...
        this.f37338b = new qi.w(new bj.b() { // from class: lg.l0
            @Override // bj.b
            public final Object get() {
