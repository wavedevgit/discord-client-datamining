...
public class a0 {
    ...
    private final a f45774b;

    /* renamed from: c  reason: collision with root package name */
    private final String f45775c;

    /* renamed from: a  reason: collision with root package name */
    private final Map f45773a = new HashMap();

    /* renamed from: d  reason: collision with root package name */
    private s0 f45776d = null;
    ...
    private a0(CameraCharacteristics cameraCharacteristics, String str) {
        if (Build.VERSION.SDK_INT >= 28) {
            this.f45774b = new x(cameraCharacteristics);
        } else {
            this.f45774b = new y(cameraCharacteristics);
        }
        this.f45775c = str;
    }
    ...
    public Object a(CameraCharacteristics.Key key) {
        if (c(key)) {
            return this.f45774b.a(key);
        }
        synchronized (this) {
            try {
                Object obj = this.f45773a.get(key);
                if (obj != null) {
                    return obj;
                }
                Object a10 = this.f45774b.a(key);
                if (a10 != null) {
                    this.f45773a.put(key, a10);
                }
                return a10;
            } catch (Throwable th2) {
                throw th2;
        ...
        if (this.f45776d == null) {
            try {
                ...
                if (streamConfigurationMap != null) {
                    this.f45776d = s0.e(streamConfigurationMap, new u.n(this.f45775c));
                } else {
