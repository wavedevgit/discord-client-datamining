...
public final class vk implements dk {
    ...
    private ij.b f39749a;

    /* renamed from: b  reason: collision with root package name */
    private final ij.b f39750b;

    /* renamed from: c  reason: collision with root package name */
    private final fk f39751c;
    ...
    public vk(Context context, fk fkVar) {
        ...
        if (aVar.a().contains(yb.c.b("json"))) {
            this.f39749a = new xi.w(new ij.b() { // from class: og.sk
                @Override // ij.b
        ...
        this.f39750b = new xi.w(new ij.b() { // from class: og.tk
            @Override // ij.b
            public final Object get() {
    ...
    public final void a(ck ckVar) {
        if (this.f39751c.a() == 0) {
            ij.b bVar = this.f39749a;
            if (bVar != null) {
                ((yb.h) bVar.get()).a(b(this.f39751c, ckVar));
                return;
            }
            return;
        }
        ((yb.h) this.f39750b.get()).a(b(this.f39751c, ckVar));
    }
}
