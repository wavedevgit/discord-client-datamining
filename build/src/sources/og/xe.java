...
public final class xe {
    ...
    public final String toString() {
        ...
        sb2.append('{');
        we weVar = this.f43761b.f43714c;
        String str = "";
        while (weVar != null) {
            Object obj = weVar.f43713b;
            sb2.append(str);
            String str2 = weVar.f43712a;
            if (str2 != null) {
                sb2.append(str2);
                sb2.append('=');
            }
