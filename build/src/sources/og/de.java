...
public final class de extends hf.a {
    ...
    private final int f42801o;

    /* renamed from: p  reason: collision with root package name */
    private final long f42802p;
    ...
    public final void writeToParcel(Parcel parcel, int i10) {
        ...
        hf.c.l(parcel, 1, this.f42798d);
        hf.c.l(parcel, 2, this.f42799e);
        hf.c.l(parcel, 3, this.f42800i);
        hf.c.l(parcel, 4, this.f42801o);
        hf.c.o(parcel, 5, this.f42802p);
        hf.c.b(parcel, a10);
    }
}
