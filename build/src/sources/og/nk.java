...
public final class nk {
    ...
    private static i1 f40085k;

    /* renamed from: l  reason: collision with root package name */
    private static final k1 f40086l = k1.c("optional-module-barcode", "com.google.android.gms.vision.barcode");
    ...
    private final dk f40089c;

    /* renamed from: d  reason: collision with root package name */
    private final wj.m f40090d;

    /* renamed from: e  reason: collision with root package name */
    private final Task f40091e;

    /* renamed from: f  reason: collision with root package name */
    private final Task f40092f;

    /* renamed from: g  reason: collision with root package name */
    private final String f40093g;

    /* renamed from: h  reason: collision with root package name */
    private final int f40094h;

    /* renamed from: i  reason: collision with root package name */
    private final Map f40095i = new HashMap();

    /* renamed from: j  reason: collision with root package name */
    private final Map f40096j = new HashMap();

    public nk(Context context, final wj.m mVar, dk dkVar, String str) {
        int i10;
        this.f40087a = context.getPackageName();
        this.f40088b = wj.c.a(context);
        this.f40090d = mVar;
        this.f40089c = dkVar;
        al.a();
        this.f40093g = str;
        this.f40091e = wj.g.a().b(new Callable() { // from class: og.jk
        ...
        this.f40092f = a10.b(new Callable() { // from class: og.kk
            @Override // java.util.concurrent.Callable
            public final Object call() {
                return wj.m.this.a();
            }
    ...
    private final String j() {
        if (this.f40091e.p()) {
            return (String) this.f40091e.l();
        }
        return hf.m.a().b(this.f40093g);
    }

    private final boolean k(ye yeVar, long j10, long j11) {
        if (this.f40095i.get(yeVar) == null || j10 - ((Long) this.f40095i.get(yeVar)).longValue() > TimeUnit.SECONDS.toMillis(30L)) {
            return true;
        }
        return false;
    }
    ...
    public final /* synthetic */ void c(ck ckVar, ye yeVar, String str) {
        ...
        String b10 = ckVar.b();
        yi yiVar = new yi();
        yiVar.b(this.f40087a);
        yiVar.c(this.f40088b);
        yiVar.h(i());
        yiVar.g(Boolean.TRUE);
        yiVar.l(b10);
        yiVar.j(str);
        if (this.f40092f.p()) {
            a10 = (String) this.f40092f.l();
        } else {
            a10 = this.f40090d.a();
        }
        yiVar.i(a10);
        yiVar.d(10);
        yiVar.k(Integer.valueOf(this.f40094h));
        ckVar.d(yiVar);
        this.f40089c.a(ckVar);
    }
    ...
    public final void f(mk mkVar, ye yeVar) {
        ...
        this.f40095i.put(yeVar, Long.valueOf(elapsedRealtime));
        e(mkVar.zza(), yeVar, j());
    }

    /* JADX INFO: Access modifiers changed from: package-private */
    public final /* synthetic */ void g(ye yeVar, bk.j jVar) {
        n1 n1Var = (n1) this.f40096j.get(yeVar);
        if (n1Var != null) {
            ...
            this.f40096j.remove(yeVar);
        }
    }

    /* JADX INFO: Access modifiers changed from: package-private */
    public final /* synthetic */ void h(final ye yeVar, Object obj, long j10, final bk.j jVar) {
        if (!this.f40096j.containsKey(yeVar)) {
            this.f40096j.put(yeVar, l0.p());
        }
        ((n1) this.f40096j.get(yeVar)).c(obj, Long.valueOf(j10));
        long elapsedRealtime = SystemClock.elapsedRealtime();
        if (!k(yeVar, elapsedRealtime, 30L)) {
            return;
        }
