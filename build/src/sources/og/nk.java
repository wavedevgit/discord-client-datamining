...
public final class nk {
    ...
    private static i1 f39516k;

    /* renamed from: l  reason: collision with root package name */
    private static final k1 f39517l = k1.c("optional-module-barcode", "com.google.android.gms.vision.barcode");
    ...
    private final dk f39520c;

    /* renamed from: d  reason: collision with root package name */
    private final wj.m f39521d;

    /* renamed from: e  reason: collision with root package name */
    private final Task f39522e;

    /* renamed from: f  reason: collision with root package name */
    private final Task f39523f;
    ...
    private final Map f39526i = new HashMap();

    /* renamed from: j  reason: collision with root package name */
    private final Map f39527j = new HashMap();

    public nk(Context context, final wj.m mVar, dk dkVar, String str) {
        int i10;
        this.f39518a = context.getPackageName();
        this.f39519b = wj.c.a(context);
        this.f39521d = mVar;
        this.f39520c = dkVar;
        al.a();
        this.f39524g = str;
        this.f39522e = wj.g.a().b(new Callable() { // from class: og.jk
        ...
        this.f39523f = a10.b(new Callable() { // from class: og.kk
            @Override // java.util.concurrent.Callable
            public final Object call() {
                return wj.m.this.a();
            }
    ...
    private final String j() {
        if (this.f39522e.p()) {
            return (String) this.f39522e.l();
        }
        return hf.m.a().b(this.f39524g);
    }

    private final boolean k(ye yeVar, long j10, long j11) {
        if (this.f39526i.get(yeVar) == null || j10 - ((Long) this.f39526i.get(yeVar)).longValue() > TimeUnit.SECONDS.toMillis(30L)) {
            return true;
        }
        return false;
    }
    ...
    public final /* synthetic */ void c(ck ckVar, ye yeVar, String str) {
        ...
        String b10 = ckVar.b();
        yi yiVar = new yi();
        yiVar.b(this.f39518a);
        yiVar.c(this.f39519b);
        yiVar.h(i());
        yiVar.g(Boolean.TRUE);
        yiVar.l(b10);
        yiVar.j(str);
        if (this.f39523f.p()) {
            a10 = (String) this.f39523f.l();
        } else {
            a10 = this.f39521d.a();
        }
        yiVar.i(a10);
        yiVar.d(10);
        yiVar.k(Integer.valueOf(this.f39525h));
        ckVar.d(yiVar);
        this.f39520c.a(ckVar);
    }
    ...
    public final void f(mk mkVar, ye yeVar) {
        ...
        this.f39526i.put(yeVar, Long.valueOf(elapsedRealtime));
        e(mkVar.zza(), yeVar, j());
    }

    /* JADX INFO: Access modifiers changed from: package-private */
    public final /* synthetic */ void g(ye yeVar, bk.j jVar) {
        n1 n1Var = (n1) this.f39527j.get(yeVar);
        if (n1Var != null) {
            ...
            this.f39527j.remove(yeVar);
        }
    }

    /* JADX INFO: Access modifiers changed from: package-private */
    public final /* synthetic */ void h(final ye yeVar, Object obj, long j10, final bk.j jVar) {
        if (!this.f39527j.containsKey(yeVar)) {
            this.f39527j.put(yeVar, l0.p());
        }
        ((n1) this.f39527j.get(yeVar)).c(obj, Long.valueOf(j10));
        long elapsedRealtime = SystemClock.elapsedRealtime();
        if (!k(yeVar, elapsedRealtime, 30L)) {
            return;
        }
