...
public final class qk implements ck {
    ...
    private final ze f41285a;

    /* renamed from: b  reason: collision with root package name */
    private yi f41286b = new yi();
    ...
    public final byte[] a(int i10, boolean z10) {
        ...
        this.f41286b.e(Boolean.FALSE);
        this.f41285a.i(this.f41286b.m());
        try {
            al.a();
            if (i10 == 0) {
                return new bj.d().j(qc.f41284a).k(true).i().b(this.f41285a.j()).getBytes("utf-8");
            }
            bf j10 = this.f41285a.j();
            t2 t2Var = new t2();
            qc.f41284a.a(t2Var);
