...
public final class yd implements pd {
    ...
    private bj.b f43785a;

    /* renamed from: b  reason: collision with root package name */
    private final bj.b f43786b;

    /* renamed from: c  reason: collision with root package name */
    private final gd f43787c;
    ...
    public yd(Context context, gd gdVar) {
        ...
        if (aVar.a().contains(xb.c.b("json"))) {
            this.f43785a = new qi.w(new bj.b() { // from class: og.vd
                @Override // bj.b
        ...
        this.f43786b = new qi.w(new bj.b() { // from class: og.wd
            @Override // bj.b
            public final Object get() {
    ...
    public final void a(ed edVar) {
        if (this.f43787c.a() == 0) {
            bj.b bVar = this.f43785a;
            if (bVar != null) {
                ((xb.h) bVar.get()).a(b(this.f43787c, edVar));
                return;
            }
            return;
        }
        ((xb.h) this.f43786b.get()).a(b(this.f43787c, edVar));
    }
}
