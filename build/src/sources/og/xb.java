...
public final class xb implements ob {
    ...
    private final f8 f42746a;

    /* renamed from: b  reason: collision with root package name */
    private ja f42747b = new ja();
    ...
    public final byte[] b(int i10, boolean z10) {
        ...
        this.f42747b.e(Boolean.FALSE);
        this.f42746a.e(this.f42747b.m());
        try {
            jc.a();
            if (i10 == 0) {
                return new aj.d().j(m6.f42325a).k(true).i().b(this.f42746a.f()).getBytes("utf-8");
            }
            h8 f10 = this.f42746a.f();
            n nVar = new n();
            m6.f42325a.a(nVar);
            return nVar.b().a(f10);
