...
public abstract class i0 extends k0 implements Serializable {
    ...
    /* renamed from: i */
    private final transient Map f39843i;

    /* renamed from: o */
    private transient int f39844o;
    ...
    public final boolean c(Object obj, Object obj2) {
        Collection collection = (Collection) this.f39843i.get(obj);
        if (collection == null) {
            Collection g10 = g();
            if (g10.add(obj2)) {
                this.f39844o++;
                this.f39843i.put(obj, g10);
                return true;
            }
    ...
    @Override // og.k0
    final Map e() {
        return new a0(this, this.f39843i);
    }

    @Override // og.k0
    final Set f() {
        return new c0(this, this.f39843i);
    }
    ...
    public final void o() {
        for (Collection collection : this.f39843i.values()) {
            collection.clear();
        }
        this.f39843i.clear();
        this.f39844o = 0;
