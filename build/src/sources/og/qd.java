...
public final class qd {
    ...
    private static p0 f43451k;

    /* renamed from: l  reason: collision with root package name */
    private static final r0 f43452l = r0.c("optional-module-barcode", "com.google.android.gms.vision.barcode");
    ...
    private final pd f43455c;

    /* renamed from: d  reason: collision with root package name */
    private final pj.m f43456d;

    /* renamed from: e  reason: collision with root package name */
    private final Task f43457e;

    /* renamed from: f  reason: collision with root package name */
    private final Task f43458f;

    /* renamed from: g  reason: collision with root package name */
    private final String f43459g;

    /* renamed from: h  reason: collision with root package name */
    private final int f43460h;

    /* renamed from: i  reason: collision with root package name */
    private final Map f43461i = new HashMap();

    /* renamed from: j  reason: collision with root package name */
    private final Map f43462j = new HashMap();

    public qd(Context context, final pj.m mVar, pd pdVar, String str) {
        int i10;
        this.f43453a = context.getPackageName();
        this.f43454b = pj.c.a(context);
        this.f43456d = mVar;
        this.f43455c = pdVar;
        ce.a();
        this.f43459g = str;
        this.f43457e = pj.g.a().b(new Callable() { // from class: og.id
        ...
        pj.g a10 = pj.g.a();
        mVar.getClass();
        this.f43458f = a10.b(new Callable() { // from class: og.jd
            @Override // java.util.concurrent.Callable
            public final Object call() {
                return pj.m.this.a();
            }
    ...
    private final String j() {
        if (this.f43457e.p()) {
            return (String) this.f43457e.l();
        }
        return gf.m.a().b(this.f43459g);
    }

    private final boolean k(da daVar, long j10, long j11) {
        if (this.f43461i.get(daVar) == null || j10 - ((Long) this.f43461i.get(daVar)).longValue() > TimeUnit.SECONDS.toMillis(30L)) {
            return true;
        }
        return false;
    }
    ...
    public final /* synthetic */ void c(ed edVar, da daVar, String str) {
        ...
        String b10 = edVar.b();
        fc fcVar = new fc();
        fcVar.b(this.f43453a);
        fcVar.c(this.f43454b);
        fcVar.h(i());
        fcVar.g(Boolean.TRUE);
        fcVar.l(b10);
        fcVar.j(str);
        if (this.f43458f.p()) {
            a10 = (String) this.f43458f.l();
        } else {
            a10 = this.f43456d.a();
        }
        fcVar.i(a10);
        fcVar.d(10);
        fcVar.k(Integer.valueOf(this.f43460h));
        edVar.c(fcVar);
        this.f43455c.a(edVar);
    }
    ...
    public final void f(od odVar, da daVar) {
        ...
        this.f43461i.put(daVar, Long.valueOf(elapsedRealtime));
        e(odVar.zza(), daVar, j());
    }

    /* JADX INFO: Access modifiers changed from: package-private */
    public final /* synthetic */ void g(da daVar, yj.h hVar) {
        u0 u0Var = (u0) this.f43462j.get(daVar);
        if (u0Var != null) {
            ...
            this.f43462j.remove(daVar);
        }
    }

    /* JADX INFO: Access modifiers changed from: package-private */
    public final /* synthetic */ void h(final da daVar, Object obj, long j10, final yj.h hVar) {
        if (!this.f43462j.containsKey(daVar)) {
            this.f43462j.put(daVar, t.r());
        }
        ((u0) this.f43462j.get(daVar)).d(obj, Long.valueOf(j10));
        long elapsedRealtime = SystemClock.elapsedRealtime();
        if (!k(daVar, elapsedRealtime, 30L)) {
            return;
        }
        ...
        pj.g.d().execute(new Runnable(daVar, hVar, null) { // from class: og.md
            ...
            /* renamed from: e  reason: collision with root package name */
            public final /* synthetic */ da f43299e;

            /* renamed from: i  reason: collision with root package name */
            public final /* synthetic */ yj.h f43300i;

            @Override // java.lang.Runnable
            public final void run() {
                qd.this.g(this.f43299e, this.f43300i);
            }
        });
    }
}
