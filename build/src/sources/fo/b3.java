...
public final class b3 implements eq.b {

    /* renamed from: d  reason: collision with root package name */
    private final List f22778d;

    /* renamed from: e  reason: collision with root package name */
    private final List f22779e;

    /* renamed from: i  reason: collision with root package name */
    private final StepStyles.UiStepStyle f22780i;

    /* renamed from: o  reason: collision with root package name */
    private final String f22781o;

    /* renamed from: p  reason: collision with root package name */
    private final String f22782p;

    /* renamed from: q  reason: collision with root package name */
    private final String f22783q;

    /* renamed from: r  reason: collision with root package name */
    private final String f22784r;

    /* renamed from: s  reason: collision with root package name */
    public static final a f22777s = new a(null);
    @NotNull
    ...
    public static final class a {
        ...
        public final b3 a(String str, String str2, String str3, StepStyles.DocumentStepStyle documentStepStyle) {
            ...
            if (documentStepStyle != null && (buttonPrimaryStyleValue = documentStepStyle.getButtonPrimaryStyleValue()) != null) {
                buttonCombinedStepComponentStyle = fo.b.b(buttonPrimaryStyleValue);
            } else {
            ...
            if (documentStepStyle != null && (buttonSecondaryStyleValue = documentStepStyle.getButtonSecondaryStyleValue()) != null) {
                buttonCombinedStepComponentStyle2 = fo.b.a(buttonSecondaryStyleValue);
            }
    ...
    public b3(List list, List componentConfigs, StepStyles.UiStepStyle uiStepStyle, String str, String str2, String str3, String str4) {
        ...
        this.f22778d = list;
        this.f22779e = componentConfigs;
        this.f22780i = uiStepStyle;
        this.f22781o = str;
        this.f22782p = str2;
        this.f22783q = str3;
        this.f22784r = str4;
    ...
    public final void writeToParcel(Parcel dest, int i10) {
        ...
        List<Parcelable> list = this.f22778d;
        if (list == null) {
            dest.writeInt(0);
        } else {
            dest.writeInt(1);
        ...
        List<Parcelable> list2 = this.f22779e;
        dest.writeInt(list2.size());
        for (Parcelable parcelable2 : list2) {
            dest.writeParcelable(parcelable2, i10);
        }
        dest.writeParcelable(this.f22780i, i10);
        dest.writeString(this.f22781o);
        dest.writeString(this.f22782p);
        dest.writeString(this.f22783q);
        dest.writeString(this.f22784r);
    }
}
