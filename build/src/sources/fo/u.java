...
public final class u implements eq.b {

    /* renamed from: d  reason: collision with root package name */
    private final List f23075d;

    /* renamed from: e  reason: collision with root package name */
    private final List f23076e;

    /* renamed from: i  reason: collision with root package name */
    private final StepStyles.UiStepStyle f23077i;

    /* renamed from: o  reason: collision with root package name */
    private final String f23078o;

    /* renamed from: p  reason: collision with root package name */
    private final String f23079p;

    /* renamed from: q  reason: collision with root package name */
    private final String f23080q;

    /* renamed from: r  reason: collision with root package name */
    private final String f23081r;

    /* renamed from: s  reason: collision with root package name */
    public static final a f23074s = new a(null);
    @NotNull
    ...
    public u(List list, List componentConfigs, StepStyles.UiStepStyle uiStepStyle, String str, String str2, String str3, String str4) {
        ...
        this.f23075d = list;
        this.f23076e = componentConfigs;
        this.f23077i = uiStepStyle;
        this.f23078o = str;
        this.f23079p = str2;
        this.f23080q = str3;
        this.f23081r = str4;
    ...
    public final void writeToParcel(Parcel dest, int i10) {
        ...
        List<Parcelable> list = this.f23075d;
        if (list == null) {
            dest.writeInt(0);
        } else {
            dest.writeInt(1);
        ...
        List<Parcelable> list2 = this.f23076e;
        dest.writeInt(list2.size());
        for (Parcelable parcelable2 : list2) {
            dest.writeParcelable(parcelable2, i10);
        }
        dest.writeParcelable(this.f23077i, i10);
        dest.writeString(this.f23078o);
        dest.writeString(this.f23079p);
        dest.writeString(this.f23080q);
        dest.writeString(this.f23081r);
    }
}
