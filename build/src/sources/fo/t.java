...
public final class t {
    ...
    public static final class a {
        ...
        public static final a f24106d = new a("FRONT", 0);

        /* renamed from: e  reason: collision with root package name */
        public static final a f24107e = new a("BACK", 1);

        /* renamed from: i  reason: collision with root package name */
        public static final a f24108i = new a("EXTERNAL", 2);

        /* renamed from: o  reason: collision with root package name */
        private static final /* synthetic */ a[] f24109o;

        /* renamed from: p  reason: collision with root package name */
        private static final /* synthetic */ EnumEntries f24110p;
        ...
        private static final /* synthetic */ a[] a() {
            return new a[]{f24106d, f24107e, f24108i};
        }
    ...
    public static final class b implements DefaultLifecycleObserver {
        ...
        /* renamed from: d  reason: collision with root package name */
        final /* synthetic */ ExecutorService f24111d;

        b(ExecutorService executorService) {
            this.f24111d = executorService;
        }

        @Override // androidx.lifecycle.DefaultLifecycleObserver
        public void onDestroy(LifecycleOwner owner) {
            Intrinsics.checkNotNullParameter(owner, "owner");
            this.f24111d.shutdown();
        }
    }
    ...
    public static final class d implements n0.f {
        ...
        /* renamed from: a  reason: collision with root package name */
        final /* synthetic */ Continuation f24117a;

        /* renamed from: b  reason: collision with root package name */
        final /* synthetic */ File f24118b;

        d(Continuation continuation, File file) {
            this.f24117a = continuation;
            this.f24118b = file;
        }
        ...
        public void d(n0.h outputFileResults) {
            ...
            Continuation continuation = this.f24117a;
            Result.a aVar = Result.f31984e;
            continuation.resumeWith(Result.b(Result.a(Result.b(this.f24118b))));
        }
    ...
    public static final void h(ListenableFuture listenableFuture, int i10, boolean z10, f.a aVar, ExecutorService executorService, PreviewView previewView, x.p pVar, t tVar, Function1 function1) {
        ...
        try {
            ...
            tVar.f24105a = new w(n10, n0Var, tVar.i(n10));
            Context context2 = previewView.getContext();
            Intrinsics.checkNotNullExpressionValue(context2, "getContext(...)");
            bq.f.i(context2).getLifecycle().a(new b(executorService));
    ...
    */
    private final fo.v i(x.i r12) {
        ...
        L42:
            ...
            r4 = 1
            if (r3 != r4) goto L4c
            fo.v$b r1 = fo.v.b.f24136e     // Catch: java.lang.IllegalArgumentException -> L90
            goto L5a
        L4c:
            if (r1 != 0) goto L4f
            goto L58
        L4f:
            ...
            if (r1 != 0) goto L58
            fo.v$b r1 = fo.v.b.f24135d     // Catch: java.lang.IllegalArgumentException -> L90
            goto L5a
        L58:
            fo.v$b r1 = fo.v.b.f24137i     // Catch: java.lang.IllegalArgumentException -> L90
        L5a:
        ...
        L6d:
            ...
            goto L6d
        L8a:
            fo.v r12 = new fo.v     // Catch: java.lang.IllegalArgumentException -> L90
        ...
        L90:
            ...
            return r4
        */
        throw new UnsupportedOperationException("Method not decompiled: fo.t.i(x.i):fo.v");
    }
    ...
    public final void f(final PreviewView previewView, a cameraDirection, final f.a aVar, final boolean z10, final Function1 onCameraError) {
        ...
        previewView.post(new Runnable() { // from class: fo.r
            @Override // java.lang.Runnable
            public final void run() {
    ...
    /*
        ...
        To view partially-correct add '--show-bad-code' argument
    */
    public final java.lang.Object j(gq.c r7, kotlin.coroutines.Continuation r8) {
        /*
            r6 = this;
            boolean r0 = r8 instanceof fo.t.c
            if (r0 == 0) goto L13
            r0 = r8
            fo.t$c r0 = (fo.t.c) r0
            int r1 = r0.f24116p
            ...
            goto L18
        L13:
            fo.t$c r0 = new fo.t$c
            r0.<init>(r8)
        L18:
            java.lang.Object r8 = r0.f24114i
            java.lang.Object r1 = gs.b.f()
            int r2 = r0.f24116p
            r3 = 1
            if (r2 == 0) goto L39
            if (r2 != r3) goto L31
            java.lang.Object r7 = r0.f24113e
            gq.c r7 = (gq.c) r7
            java.lang.Object r7 = r0.f24112d
            fo.t r7 = (fo.t) r7
            kotlin.c.b(r8)
            goto L8d
        L31:
        ...
        L39:
            ...
            ys.c1 r4 = ys.m0.c()
            ys.c1 r4 = r4.P1()
            java.util.concurrent.Executor r4 = ys.u0.a(r4)
            fo.t$d r5 = new fo.t$d
            r5.<init>(r8, r7)
            r3.x0(r2, r4, r5)
        L7d:
            java.lang.Object r8 = r8.b()
            java.lang.Object r7 = gs.b.f()
            if (r8 != r7) goto L8a
        ...
        L8d:
            ...
            return r7
        */
        throw new UnsupportedOperationException("Method not decompiled: fo.t.j(gq.c, kotlin.coroutines.Continuation):java.lang.Object");
    }
}
