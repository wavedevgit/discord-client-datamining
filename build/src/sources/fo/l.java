...
public final class l implements Parcelable {
    ...
    private final u f22880d;

    /* renamed from: e  reason: collision with root package name */
    private final b3 f22881e;
    ...
    public l(u documentStartPage, b3 uploadOptionsDialog) {
        ...
        this.f22880d = documentStartPage;
        this.f22881e = uploadOptionsDialog;
    }
    ...
    public final void writeToParcel(Parcel dest, int i10) {
        ...
        this.f22880d.writeToParcel(dest, i10);
        this.f22881e.writeToParcel(dest, i10);
    }
}
