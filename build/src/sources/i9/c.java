...
public class c implements ControllerListener {
    ...
    private final List f28066d = new ArrayList(2);
    ...
    public synchronized void a(ControllerListener controllerListener) {
        this.f28066d.add(controllerListener);
    }
    ...
    public synchronized void onFailure(String str, Throwable th2) {
        int size = this.f28066d.size();
        for (int i10 = 0; i10 < size; i10++) {
            try {
                ControllerListener controllerListener = (ControllerListener) this.f28066d.get(i10);
