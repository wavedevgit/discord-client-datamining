...
public class c implements ControllerListener {
    ...
    private final List f27278d = new ArrayList(2);
    ...
    public synchronized void a(ControllerListener controllerListener) {
        this.f27278d.add(controllerListener);
    }
    ...
    public synchronized void onFailure(String str, Throwable th2) {
        int size = this.f27278d.size();
        for (int i10 = 0; i10 < size; i10++) {
            try {
                ControllerListener controllerListener = (ControllerListener) this.f27278d.get(i10);
