...
public final class a {
    ...
    public static final b f55468c = new b(null);

    /* renamed from: d  reason: collision with root package name */
    private static final String f55469d;

    /* renamed from: e  reason: collision with root package name */
    private static final ZoomLogger f55470e;

    /* renamed from: a  reason: collision with root package name */
    private final InterfaceC0752a f55471a;
    ...
    private final boolean o(int i10) {
        ...
        if (!this.f55471a.h(i10)) {
            return false;
        }
        if (i10 == this.f55472b && !g(i10)) {
            return true;
        }
