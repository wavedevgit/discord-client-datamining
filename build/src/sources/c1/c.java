...
public abstract class c implements Comparable {
    ...
    private static final short f7981e = d(5120);

    /* renamed from: i  reason: collision with root package name */
    private static final short f7982i = d(-1025);

    /* renamed from: o  reason: collision with root package name */
    private static final short f7983o = d(31743);

    /* renamed from: p  reason: collision with root package name */
    private static final short f7984p = d(1024);

    /* renamed from: q  reason: collision with root package name */
    private static final short f7985q = d(1);

    /* renamed from: r  reason: collision with root package name */
    private static final short f7986r = d(32256);

    /* renamed from: s  reason: collision with root package name */
    private static final short f7987s = d(-1024);

    /* renamed from: t  reason: collision with root package name */
    private static final short f7988t = d(ShortCompanionObject.MIN_VALUE);

    /* renamed from: u  reason: collision with root package name */
    private static final short f7989u = d(31744);

    /* renamed from: v  reason: collision with root package name */
    private static final short f7990v = d(0);

    /* renamed from: w  reason: collision with root package name */
    private static final short f7991w = a(1.0f);

    /* renamed from: x  reason: collision with root package name */
    private static final short f7992x = a(-1.0f);

    /* renamed from: y  reason: collision with root package name */
    private static final float f7993y;
    ...
    static {
        ...
        f7993y = Float.intBitsToFloat(1056964608);
    }

    public static short a(float f10) {
        return d(f7980d.b(f10));
    }
    ...
    public static final float e(short s10) {
        ...
        if (i14 == 0) {
            if (i15 != 0) {
                FloatCompanionObject floatCompanionObject = FloatCompanionObject.INSTANCE;
                float intBitsToFloat = Float.intBitsToFloat(i15 + 1056964608) - f7993y;
                if (i13 == 0) {
