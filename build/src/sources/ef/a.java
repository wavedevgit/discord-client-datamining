...
public abstract class a extends BroadcastReceiver {
    ...
    private static SoftReference f22771a;

    /* renamed from: b  reason: collision with root package name */
    private static SoftReference f22772b;
    ...
    protected Executor a() {
        ...
        synchronized (a.class) {
            try {
                SoftReference softReference = f22771a;
                ...
                if (executorService == null) {
                    ...
                    f22771a = new SoftReference(executorService);
                }
            } catch (Throwable th2) {
                throw th2;
            }
    ...
    public final /* synthetic */ void d(Intent intent, final Context context, boolean z10, BroadcastReceiver.PendingResult pendingResult) {
        ...
        try {
            ...
            if (intent2 != null) {
                ...
                synchronized (a.class) {
                    SoftReference softReference = f22772b;
                    if (softReference != null) {
                    ...
                    if (executor == null) {
                        ...
                        f22772b = new SoftReference(executor);
                    }
                }
