...
public abstract class e4 {
    public static final TextView b(c4 c4Var, m5 uiComponentHelper, final PrivacyPolicy config) {
        ...
        final bq.t c10 = bq.t.c(uiComponentHelper.b());
        PrivacyPolicy.Attributes attributes = config.getAttributes();
        if (attributes != null) {
            TextView textView = c10.f7509b;
            Intrinsics.checkNotNullExpressionValue(textView, "textView");
            zp.f.d(textView, attributes.getText());
            uiComponentHelper.d(new Function0() { // from class: yp.d4
    ...
    public static final Unit c(PrivacyPolicy privacyPolicy, bq.t tVar) {
        TextBasedComponentStyle styles = privacyPolicy.getStyles();
        if (styles != null) {
            TextView textView = tVar.f7509b;
            Intrinsics.checkNotNullExpressionValue(textView, "textView");
