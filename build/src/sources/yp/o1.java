...
public abstract class o1 {
    public static final void d(final TextInputLayout textInputLayout, y3 newState) {
        ...
        Object tag = textInputLayout.getTag(wp.e.f52880b0);
        ...
        textInputLayout.setTag(wp.e.f52880b0, newState);
        ...
        if (c10 != null) {
            ...
            up.o.a(textInputLayout);
        }
        if (Intrinsics.areEqual(newState.e(), Boolean.TRUE) && (b10 = newState.b()) != null) {
            textInputLayout.setEndIconMode(-1);
            textInputLayout.setEndIconDrawable(androidx.core.content.a.e(textInputLayout.getContext(), wp.d.f52875d));
            textInputLayout.setEndIconContentDescription(textInputLayout.getContext().getString(cp.e.R));
            EditText editText3 = textInputLayout.getEditText();
            if (editText3 != null) {
                editText3.setTransformationMethod(new s4(b10));
            }
            textInputLayout.setEndIconOnClickListener(new View.OnClickListener() { // from class: yp.n1
        ...
        Object tag2 = textInputLayout.getTag(wp.e.f52894i0);
        ...
        if (b11 != null && !StringsKt.k0(b11)) {
            ...
            textInputLayout.setTag(wp.e.f52894i0, z3Var);
        }
    }
    ...
    public static final TextInputLayout g(InputMaskedTextComponent inputMaskedTextComponent, m5 uiComponentHelper, final InputMaskedText config) {
        ...
        final bq.u c10 = bq.u.c(uiComponentHelper.b());
        ...
        if (editText != null) {
            wm.u.b(inputMaskedTextComponent.b(), editText);
        }
        uiComponentHelper.d(new Function0() { // from class: yp.m1
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public static final Unit h(InputMaskedText inputMaskedText, bq.u uVar) {
