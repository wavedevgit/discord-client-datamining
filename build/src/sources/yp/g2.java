...
public abstract class g2 {
    public static final TextInputLayout b(InputTextAreaComponent inputTextAreaComponent, m5 uiComponentHelper, final InputTextArea config) {
        ...
        final bq.n c10 = bq.n.c(uiComponentHelper.b());
        InputTextArea.Attributes attributes = config.getAttributes();
        if (attributes != null) {
            wm.t b10 = inputTextAreaComponent.b();
            TextInputEditText editText = c10.f7486b;
            Intrinsics.checkNotNullExpressionValue(editText, "editText");
            wm.u.b(b10, editText);
            String label = attributes.getLabel();
            if (label != null) {
                c10.f7487c.setHint(label);
            }
            String placeholder = attributes.getPlaceholder();
            if (placeholder != null) {
                c10.f7487c.setPlaceholderText(placeholder);
                TextInputLayout inputLayout = c10.f7487c;
            ...
            if (rows != null) {
                ...
                c10.f7486b.setMaxLines(intValue);
                c10.f7486b.setMinLines(intValue);
                c10.f7486b.setVerticalScrollBarEnabled(true);
            }
        }
        uiComponentHelper.d(new Function0() { // from class: yp.f2
    ...
    public static final Unit c(InputTextArea inputTextArea, bq.n nVar) {
        InputTextBasedComponentStyle styles = inputTextArea.getStyles();
        if (styles != null) {
            TextInputLayout inputLayout = nVar.f7487c;
            Intrinsics.checkNotNullExpressionValue(inputLayout, "inputLayout");
