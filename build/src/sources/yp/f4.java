...
public final class f4 implements k5, e0 {
    ...
    private final JsonLogicBoolean f54927e;

    /* renamed from: i  reason: collision with root package name */
    private final int f54928i;

    /* renamed from: o  reason: collision with root package name */
    private final List f54929o;
    ...
    public f4(String name, JsonLogicBoolean jsonLogicBoolean, int i10) {
        ...
        this.f54926d = name;
        this.f54927e = jsonLogicBoolean;
        this.f54928i = i10;
        this.f54929o = new ArrayList();
    }
    ...
    public boolean equals(Object obj) {
        ...
        f4 f4Var = (f4) obj;
        if (Intrinsics.areEqual(this.f54926d, f4Var.f54926d) && Intrinsics.areEqual(this.f54927e, f4Var.f54927e) && this.f54928i == f4Var.f54928i) {
            return true;
        }
        return false;
    }
    ...
    public int hashCode() {
        int hashCode;
        int hashCode2 = this.f54926d.hashCode() * 31;
        JsonLogicBoolean jsonLogicBoolean = this.f54927e;
        if (jsonLogicBoolean == null) {
            hashCode = 0;
        } else {
            hashCode = jsonLogicBoolean.hashCode();
        }
        return ((hashCode2 + hashCode) * 31) + Integer.hashCode(this.f54928i);
    }

    public String toString() {
        String str = this.f54926d;
        JsonLogicBoolean jsonLogicBoolean = this.f54927e;
        int i10 = this.f54928i;
    ...
    public final void writeToParcel(Parcel dest, int i10) {
        ...
        dest.writeString(this.f54926d);
        dest.writeParcelable(this.f54927e, i10);
        dest.writeInt(this.f54928i);
    }
    ...
    */
    public f4(com.withpersona.sdk2.inquiry.network.dto.ui.components.QRCode r5) {
        ...
        L4e:
            ...
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: yp.f4.<init>(com.withpersona.sdk2.inquiry.network.dto.ui.components.QRCode):void");
    }
}
