...
public final class x4 implements k5, e0 {
    ...
    private final JsonLogicBoolean f55135e;

    /* renamed from: i  reason: collision with root package name */
    private final int f55136i;

    /* renamed from: o  reason: collision with root package name */
    private final int f55137o;

    /* renamed from: p  reason: collision with root package name */
    private final List f55138p;
    ...
    public x4(String name, JsonLogicBoolean jsonLogicBoolean, int i10, int i11) {
        ...
        this.f55134d = name;
        this.f55135e = jsonLogicBoolean;
        this.f55136i = i10;
        this.f55137o = i11;
        this.f55138p = new ArrayList();
    }
    ...
    public boolean equals(Object obj) {
        ...
        x4 x4Var = (x4) obj;
        if (Intrinsics.areEqual(this.f55134d, x4Var.f55134d) && Intrinsics.areEqual(this.f55135e, x4Var.f55135e) && this.f55136i == x4Var.f55136i && this.f55137o == x4Var.f55137o) {
            return true;
        }
        return false;
    }
    ...
    public int hashCode() {
        int hashCode;
        int hashCode2 = this.f55134d.hashCode() * 31;
        JsonLogicBoolean jsonLogicBoolean = this.f55135e;
        if (jsonLogicBoolean == null) {
            hashCode = 0;
        } else {
            hashCode = jsonLogicBoolean.hashCode();
        }
        return ((((hashCode2 + hashCode) * 31) + Integer.hashCode(this.f55136i)) * 31) + Integer.hashCode(this.f55137o);
    }

    public String toString() {
        String str = this.f55134d;
        JsonLogicBoolean jsonLogicBoolean = this.f55135e;
        int i10 = this.f55136i;
        int i11 = this.f55137o;
    ...
    public final void writeToParcel(Parcel dest, int i10) {
        ...
        dest.writeString(this.f55134d);
        dest.writeParcelable(this.f55135e, i10);
        dest.writeInt(this.f55136i);
        dest.writeInt(this.f55137o);
    }
    ...
    */
    public x4(com.withpersona.sdk2.inquiry.network.dto.ui.components.Spacer r6) {
        ...
        L86:
            ...
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: yp.x4.<init>(com.withpersona.sdk2.inquiry.network.dto.ui.components.Spacer):void");
    }
}
