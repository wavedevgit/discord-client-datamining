...
public final class d {
    ...
    public static final d f54919a;

    /* renamed from: b  reason: collision with root package name */
    private static final Lazy f54920b;

    /* renamed from: c  reason: collision with root package name */
    private static final b f54921c;

    /* renamed from: d  reason: collision with root package name */
    private static final Map f54922d;

    /* renamed from: e  reason: collision with root package name */
    private static final b4 f54923e;
    ...
    static {
        d dVar = new d();
        f54919a = dVar;
        f54920b = ir.l.b(new Function0() { // from class: yp.c
    ...
    private final List d() {
        ...
        for (Map.Entry entry2 : linkedHashMap.entrySet()) {
            arrayList.add(f54919a.m((b) entry2.getValue()));
        }
    ...
    public final b4 g(String str) {
        ...
        if (str != null && str.length() == 2) {
            ...
            Intrinsics.checkNotNullExpressionValue(upperCase, "toUpperCase(...)");
            b bVar = (b) f54922d.get(upperCase);
