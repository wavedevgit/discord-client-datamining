...
public final class q5 implements h {
    ...
    private final JsonLogicBoolean f55058e;

    /* renamed from: i  reason: collision with root package name */
    private final JsonLogicBoolean f55059i;

    /* renamed from: o  reason: collision with root package name */
    private final String f55060o;

    /* renamed from: p  reason: collision with root package name */
    private final Integer f55061p;

    /* renamed from: q  reason: collision with root package name */
    private final String f55062q;

    /* renamed from: r  reason: collision with root package name */
    private final List f55063r;

    /* renamed from: s  reason: collision with root package name */
    private boolean f55064s;
    ...
    public q5(String name, JsonLogicBoolean jsonLogicBoolean, JsonLogicBoolean jsonLogicBoolean2, String str, Integer num, String str2) {
        ...
        this.f55057d = name;
        this.f55058e = jsonLogicBoolean;
        this.f55059i = jsonLogicBoolean2;
        this.f55060o = str;
        this.f55061p = num;
        this.f55062q = str2;
        this.f55063r = new ArrayList();
    }
    ...
    public final void writeToParcel(Parcel dest, int i10) {
        ...
        dest.writeString(this.f55057d);
        dest.writeParcelable(this.f55058e, i10);
        dest.writeParcelable(this.f55059i, i10);
        dest.writeString(this.f55060o);
        Integer num = this.f55061p;
        if (num == null) {
            intValue = 0;
        } else {
            dest.writeInt(1);
    ...
    */
    public q5(com.withpersona.sdk2.inquiry.network.dto.ui.components.VerifyPersonaButton r9) {
        ...
        L48:
            ...
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: yp.q5.<init>(com.withpersona.sdk2.inquiry.network.dto.ui.components.VerifyPersonaButton):void");
    }
}
