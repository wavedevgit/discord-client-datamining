...
public abstract class b2 {
    public static final LinearLayout f(final InputRadioGroupComponent inputRadioGroupComponent, m5 uiComponentHelper, final InputRadioGroup config) {
        ...
        final bq.m c10 = bq.m.c(uiComponentHelper.b());
        ...
        for (final OptionWithDescription optionWithDescription : l10) {
            final bq.b c11 = bq.b.c(uiComponentHelper.b(), c10.getRoot(), false);
            TextView radioButtonLabel = c11.f7421d;
            Intrinsics.checkNotNullExpressionValue(radioButtonLabel, "radioButtonLabel");
            zp.f.d(radioButtonLabel, optionWithDescription.getText());
            String descriptionText = optionWithDescription.getDescriptionText();
            if (descriptionText != null && !StringsKt.k0(descriptionText)) {
                c11.f7420c.setVisibility(0);
                TextView radioButtonDescription = c11.f7420c;
                Intrinsics.checkNotNullExpressionValue(radioButtonDescription, "radioButtonDescription");
                zp.f.d(radioButtonDescription, descriptionText);
            } else {
                c11.f7420c.setVisibility(8);
            }
            uiComponentHelper.d(new Function0() { // from class: yp.w1
            ...
            c11.f7419b.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() { // from class: yp.x1
                @Override // android.widget.CompoundButton.OnCheckedChangeListener
                public final void onCheckedChanged(CompoundButton compoundButton, boolean z10) {
                    b2.j(arrayList, config, optionWithDescription, inputRadioGroupComponent, compoundButton, z10);
                }
            });
            c11.getRoot().setOnClickListener(new View.OnClickListener() { // from class: yp.y1
                @Override // android.view.View.OnClickListener
                public final void onClick(View view) {
                    b2.k(bq.b.this, view);
                }
            });
            c10.f7482b.addView(c11.getRoot());
            MaterialRadioButton radioButton = c11.f7419b;
            Intrinsics.checkNotNullExpressionValue(radioButton, "radioButton");
            arrayList.add(radioButton);
            if (Intrinsics.areEqual(inputRadioGroupComponent.b().b(), optionWithDescription.getValue())) {
                c11.f7419b.setChecked(true);
            }
        }
        ...
        if (styles != null && (errorTextStyle = styles.getErrorTextStyle()) != null) {
            TextView radioGroupError = c10.f7483c;
            Intrinsics.checkNotNullExpressionValue(radioGroupError, "radioGroupError");
            dq.f0.n(radioGroupError, errorTextStyle, null, 2, null);
        }
        if (attributes != null) {
            str = attributes.getLabel();
        }
        if (str != null && str.length() != 0) {
            c10.f7484d.setVisibility(0);
            c10.f7484d.setText(str);
            uiComponentHelper.d(new Function0() { // from class: yp.z1
                @Override // kotlin.jvm.functions.Function0
                public final Object invoke() {
                    Unit g10;
            ...
            c10.f7484d.setVisibility(8);
        }
        uiComponentHelper.d(new Function0() { // from class: yp.a2
            @Override // kotlin.jvm.functions.Function0
            public final Object invoke() {
                Unit h10;
    ...
    public static final Unit g(InputRadioGroup inputRadioGroup, bq.m mVar) {
        ...
        if (styles != null && (textBasedStyle = styles.getTextBasedStyle()) != null) {
            TextView radioGroupLabel = mVar.f7484d;
            Intrinsics.checkNotNullExpressionValue(radioGroupLabel, "radioGroupLabel");
            dq.f0.n(radioGroupLabel, textBasedStyle, null, 2, null);
        }
        return Unit.f33074a;
    }

    /* JADX INFO: Access modifiers changed from: private */
    public static final Unit h(InputRadioGroup inputRadioGroup, bq.m mVar) {
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public static final Unit i(InputRadioGroup inputRadioGroup, bq.b bVar) {
        TextBasedComponentStyle descriptionTextStyle;
        TextBasedComponentStyle textBasedStyle;
        InputRadioGroup.InputRadioGroupComponentStyle styles = inputRadioGroup.getStyles();
        if (styles != null && (textBasedStyle = styles.getTextBasedStyle()) != null) {
            TextView radioButtonLabel = bVar.f7421d;
            Intrinsics.checkNotNullExpressionValue(radioButtonLabel, "radioButtonLabel");
            dq.f0.n(radioButtonLabel, textBasedStyle, null, 2, null);
        }
        ...
        if (styles2 != null && (descriptionTextStyle = styles2.getDescriptionTextStyle()) != null) {
            TextView radioButtonDescription = bVar.f7420c;
            Intrinsics.checkNotNullExpressionValue(radioButtonDescription, "radioButtonDescription");
            dq.f0.n(radioButtonDescription, descriptionTextStyle, null, 2, null);
        }
        bVar.f7419b.setButtonTintList(ColorStateList.valueOf(r1.c.l(bVar.f7421d.getCurrentTextColor(), 150)));
        return Unit.f33074a;
    }
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public static final void k(bq.b bVar, View view) {
        if (!bVar.f7419b.isChecked()) {
            bVar.f7419b.setChecked(true);
        }
    }
