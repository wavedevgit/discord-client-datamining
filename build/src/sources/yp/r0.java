...
public abstract class r0 {
    public static final ConstraintLayout d(final InputCheckboxComponent inputCheckboxComponent, m5 uiComponentHelper, final bq.i binding, final InputCheckbox config) {
        String str;
        ...
        binding.f7468b.setChecked(inputCheckboxComponent.a().b());
        binding.f7468b.setClickable(false);
        binding.f7468b.setFocusable(false);
        ...
        if (str != null && !StringsKt.k0(str)) {
            binding.f7471e.setVisibility(0);
            TextView checkboxLabel = binding.f7471e;
            Intrinsics.checkNotNullExpressionValue(checkboxLabel, "checkboxLabel");
            zp.f.d(checkboxLabel, str);
        } else {
            binding.f7471e.setVisibility(8);
        }
        ...
        if (str2 != null && !StringsKt.k0(str2)) {
            binding.f7469c.setVisibility(0);
            TextView checkboxDescription = binding.f7469c;
            Intrinsics.checkNotNullExpressionValue(checkboxDescription, "checkboxDescription");
            zp.f.d(checkboxDescription, str2);
        } else {
            binding.f7469c.setVisibility(8);
        }
        binding.f7468b.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() { // from class: yp.o0
            @Override // android.widget.CompoundButton.OnCheckedChangeListener
            public final void onCheckedChanged(CompoundButton compoundButton, boolean z10) {
                r0.f(InputCheckboxComponent.this, compoundButton, z10);
            }
        });
        binding.getRoot().setOnClickListener(new View.OnClickListener() { // from class: yp.p0
        ...
        if (styles != null && (textColorHighlight = styles.getTextColorHighlight()) != null && (base = textColorHighlight.getBase()) != null && (base2 = base.getBase()) != null && (value = base2.getValue()) != null) {
            binding.f7468b.setButtonTintList(new ColorStateList(new int[][]{new int[]{-16842910}, new int[]{-16842912}, new int[]{16842912}}, new int[]{r1.c.l(kp.s.d(a10, yg.b.f54341k, null, false, 6, null), (int) (q1.j.h(a10.getResources(), yg.d.f54398x) * ((float) SetSpanOperation.SPAN_MAX_PRIORITY))), kp.s.d(a10, yg.b.f54341k, null, false, 6, null), value.intValue()}));
        }
        uiComponentHelper.d(new Function0() { // from class: yp.q0
    ...
    public static final ConstraintLayout e(InputCheckboxComponent inputCheckboxComponent, m5 uiComponentHelper, InputCheckbox config) {
        ...
        Intrinsics.checkNotNullParameter(uiComponentHelper, "uiComponentHelper");
        Intrinsics.checkNotNullParameter(config, "config");
        bq.i c10 = bq.i.c(uiComponentHelper.b());
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public static final void g(bq.i iVar, View view) {
        iVar.f7468b.toggle();
    }

    /* JADX INFO: Access modifiers changed from: private */
    public static final Unit h(InputCheckbox inputCheckbox, bq.i iVar) {
        ...
        if (styles != null && (textBasedStyle = styles.getTextBasedStyle()) != null) {
            TextView checkboxLabel = iVar.f7471e;
            Intrinsics.checkNotNullExpressionValue(checkboxLabel, "checkboxLabel");
            dq.f0.n(checkboxLabel, textBasedStyle, null, 2, null);
        }
        ...
        if (styles2 != null && (descriptionTextStyle = styles2.getDescriptionTextStyle()) != null) {
            TextView checkboxDescription = iVar.f7469c;
            Intrinsics.checkNotNullExpressionValue(checkboxDescription, "checkboxDescription");
            dq.f0.n(checkboxDescription, descriptionTextStyle, null, 2, null);
        }
        ...
        if (styles3 != null && (errorTextStyle = styles3.getErrorTextStyle()) != null) {
            TextView checkboxError = iVar.f7470d;
            Intrinsics.checkNotNullExpressionValue(checkboxError, "checkboxError");
            dq.f0.n(checkboxError, errorTextStyle, null, 2, null);
        }
        TextView checkboxLabel2 = iVar.f7471e;
        ...
        if (layoutParams != null) {
            ...
            TextView checkboxLabel3 = iVar.f7471e;
            Intrinsics.checkNotNullExpressionValue(checkboxLabel3, "checkboxLabel");
            int a10 = up.p.a(checkboxLabel3);
            TextView checkboxDescription2 = iVar.f7469c;
            Intrinsics.checkNotNullExpressionValue(checkboxDescription2, "checkboxDescription");
            int a11 = a10 + up.p.a(checkboxDescription2);
            if (a11 != 0) {
                if (a11 != 1) {
                    ((ViewGroup.MarginLayoutParams) layoutParams2).topMargin = (int) kp.h.a(4.0d);
                } else {
                    ((ViewGroup.MarginLayoutParams) layoutParams2).topMargin = (int) kp.h.a(0.0d);
                }
            }
