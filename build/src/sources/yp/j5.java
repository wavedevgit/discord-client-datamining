...
public abstract class j5 {
    public static final TextView b(h5 h5Var, m5 uiComponentHelper, final Title config) {
        ...
        final bq.x c10 = bq.x.c(uiComponentHelper.b());
        Title.Attributes attributes = config.getAttributes();
        if (attributes != null) {
            TextView textView = c10.f7522b;
            Intrinsics.checkNotNullExpressionValue(textView, "textView");
            zp.f.d(textView, attributes.getText());
            uiComponentHelper.d(new Function0() { // from class: yp.i5
    ...
    public static final Unit c(Title title, bq.x xVar) {
        TextBasedComponentStyle styles = title.getStyles();
        if (styles != null) {
            TextView textView = xVar.f7522b;
            Intrinsics.checkNotNullExpressionValue(textView, "textView");
