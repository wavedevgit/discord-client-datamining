...
public abstract class f {
    ...
    public static final Drawable b(Context context, int i10, int i11) {
        ...
        int c10 = androidx.core.content.a.c(context, bp.b.f7629a);
        int c11 = androidx.core.content.a.c(context, bp.b.f7630b);
        ...
        gradientDrawable.setSize(i11 + ((int) jp.h.a(24.0d)), gradientDrawable.getMinimumHeight());
        return new InsetDrawable((Drawable) gradientDrawable, (int) jp.h.a(4.0d));
    }
    ...
    public static final void d(TextView textView, String text) {
        ...
        c10.d(textView, e10);
        if (e10.getSpans(0, e10.length(), dr.g.class).length == 0 && e10.getSpans(0, e10.length(), URLSpan.class).length == 0) {
