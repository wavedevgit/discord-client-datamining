...
public abstract class h0 {
    public static final ConstraintLayout b(f0 f0Var, m5 uiComponentHelper, List componentViews, List children, HorizontalStack config) {
        ...
        final bq.h c10 = bq.h.c(uiComponentHelper.b());
        ...
        if (styles != null) {
            uiComponentHelper.d(new Function0() { // from class: yp.g0
                @Override // kotlin.jvm.functions.Function0
                public final Object invoke() {
                    Unit c11;
                    c11 = h0.c(bq.h.this, styles);
                    return c11;
                }
            });
        }
    ...
    public static final Unit c(bq.h hVar, HorizontalStack.HorizontalStackComponentStyle horizontalStackComponentStyle) {
        ConstraintLayout root = hVar.getRoot();
        Intrinsics.checkNotNullExpressionValue(root, "getRoot(...)");
        dq.q.c(root, horizontalStackComponentStyle);
        return Unit.f33074a;
    }
}
