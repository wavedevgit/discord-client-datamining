...
public final class m implements h {
    ...
    private final JsonLogicBoolean f54992e;

    /* renamed from: i  reason: collision with root package name */
    private final JsonLogicBoolean f54993i;

    /* renamed from: o  reason: collision with root package name */
    private final String f54994o;

    /* renamed from: p  reason: collision with root package name */
    private final Integer f54995p;

    /* renamed from: q  reason: collision with root package name */
    private final List f54996q;
    ...
    public m(String name, JsonLogicBoolean jsonLogicBoolean, JsonLogicBoolean jsonLogicBoolean2, String str, Integer num) {
        ...
        this.f54991d = name;
        this.f54992e = jsonLogicBoolean;
        this.f54993i = jsonLogicBoolean2;
        this.f54994o = str;
        this.f54995p = num;
        this.f54996q = new ArrayList();
    }
    ...
    public boolean equals(Object obj) {
        ...
        m mVar = (m) obj;
        if (Intrinsics.areEqual(this.f54991d, mVar.f54991d) && Intrinsics.areEqual(this.f54992e, mVar.f54992e) && Intrinsics.areEqual(this.f54993i, mVar.f54993i) && Intrinsics.areEqual(this.f54994o, mVar.f54994o) && Intrinsics.areEqual(this.f54995p, mVar.f54995p)) {
            return true;
        }
        return false;
    }
    ...
    public int hashCode() {
        ...
        int hashCode2;
        int hashCode3;
        int hashCode4 = this.f54991d.hashCode() * 31;
        JsonLogicBoolean jsonLogicBoolean = this.f54992e;
        int i10 = 0;
        ...
        JsonLogicBoolean jsonLogicBoolean2 = this.f54993i;
    ...
    public final void writeToParcel(Parcel dest, int i10) {
        ...
        dest.writeString(this.f54991d);
        dest.writeParcelable(this.f54992e, i10);
        dest.writeParcelable(this.f54993i, i10);
        dest.writeString(this.f54994o);
        Integer num = this.f54995p;
        if (num == null) {
            dest.writeInt(0);
            return;
    ...
    */
    public m(com.withpersona.sdk2.inquiry.network.dto.ui.components.CombinedStepButton r8) {
        ...
        L3b:
            ...
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: yp.m.<init>(com.withpersona.sdk2.inquiry.network.dto.ui.components.CombinedStepButton):void");
    }
}
