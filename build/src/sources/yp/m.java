...
public final class m {
    ...
    private final View f(Context context, g gVar, boolean z10, Map map, m5 m5Var, boolean z11, boolean z12) {
            ...
            if (gVar.getStyles() == null) {
                for (k5 k5Var : list) {
                    ...
                    if (!(k5Var instanceof x4) && (aVar = (a) map.get(k5Var.getName())) != null && (d10 = aVar.d()) != null && i10 != CollectionsKt.n(list)) {
                        constraintSet.C(d10.getId(), 4, (int) mp.h.a(16.0d));
                    }
                    i10 = i11;
                }
            }
        ...
        if (!z11) {
            root.setPadding(root.getPaddingLeft(), root.getPaddingTop(), root.getPaddingRight(), (int) mp.h.a(24.0d));
        }
        constraintSet.c(root);
        Context context2 = c10.getRoot().getContext();
        Intrinsics.checkNotNullExpressionValue(context2, "getContext(...)");
        if (!mp.f.g(context2) && z12) {
            c(root);
        }
    ...
    private final List k(List list, Map map, Context context, boolean z10, List list2, m5 m5Var) {
        ...
        while (it.hasNext()) {
            k5 k5Var = (k5) it.next();
            if (k5Var instanceof aq.a) {
                aq.a aVar = (aq.a) k5Var;
                ...
                j10 = aq.b.a(aVar, m5Var, (ActionButton) obj);
            } else if (k5Var instanceof aq.i) {
                aq.i iVar = (aq.i) k5Var;
                ...
                j10 = aq.j.a(iVar, m5Var, (CancelButton) obj2);
            } else if (k5Var instanceof aq.m) {
                aq.m mVar = (aq.m) k5Var;
            ...
            } else if (k5Var instanceof aq.e) {
                j10 = aq.g.b((aq.e) k5Var, m5Var);
    ...
    public final void c(ConstraintLayout parentView) {
        ...
        if (view2 != null) {
            view2.requestFocus();
            view2.post(new Runnable() { // from class: yp.l
    ...
    public final h g(Context context, g uiScreen, boolean z10, boolean z11, boolean z12) {
        ...
        wp.s.b(f10, new Function0() { // from class: yp.k
    ...
    public final h l(op.b binding, g uiScreen, Function2 function2, boolean z10) {
        ...
        if (uiScreen.f() == StyleElements.PositionType.CENTER) {
            binding.f44392c.setFillViewport(true);
        ...
        binding.f44391b.addView(h10.a());
        ConstraintLayout root = binding.getRoot();
        Intrinsics.checkNotNullExpressionValue(root, "getRoot(...)");
        wp.f.d(root, false, false, false, false, 13, null);
        if (h10.b() != null) {
            binding.f44393d.addView(h10.b());
            wp.f.d(h10.b(), false, false, false, false, 2, null);
        }
        if (function2 != null) {
        ...
        if (e10 != null) {
            binding.f44394e.setControlsColor(e10.intValue());
        }
        return h10;
    }
}
