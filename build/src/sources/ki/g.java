...
public final class g {
    ...
    private final f f30900d;

    /* renamed from: e  reason: collision with root package name */
    private PackageInfo f30901e;

    public g(Context context, ii.f fVar, b bVar) {
        f fVar2 = new f(new ii.b(fVar));
        this.f30897a = fVar;
        this.f30898b = bVar;
    ...
    private final PackageInfo d() {
        if (this.f30901e == null) {
            try {
                this.f30901e = this.f30899c.getPackageManager().getPackageInfo(this.f30899c.getPackageName(), 64);
    ...
    public final boolean a(File[] fileArr) {
        ...
        do {
            length--;
            if (length >= 0) {
                this.f30900d.b(assetManager, fileArr[length]);
            } else {
                return true;
            }
        } while (j10 == this.f30900d.a());
        return false;
    }
    ...
    public final boolean b(List list) {
        ...
        while (it.hasNext()) {
            if (!this.f30897a.g(((Intent) it.next()).getStringExtra("split_id")).exists()) {
                return false;
            }
        }
        return true;
