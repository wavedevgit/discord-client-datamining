...
public final class o {
    ...
    private static final Pattern f31768b = Pattern.compile("lib/([^/]+)/(.*\\.so)$");

    /* renamed from: a  reason: collision with root package name */
    private final f f31769a;
    ...
    private static void e(u uVar, l lVar) {
        ...
        try {
            ...
            while (entries.hasMoreElements()) {
                ...
                Matcher matcher = f31768b.matcher(nextElement.getName());
                if (matcher.matches()) {
            ...
            for (String str : Build.SUPPORTED_ABIS) {
                if (hashMap.containsKey(str)) {
                    ...
                    for (n nVar : (Set) hashMap.get(str)) {
                        if (hashMap2.containsKey(nVar.f31766a)) {
                            Log.d("SplitCompat", String.format("NativeLibraryExtractor: skipping library %s for ABI %s; already present for a better ABI", nVar.f31766a, str));
                        } else {
                            hashMap2.put(nVar.f31766a, nVar);
                            Log.d("SplitCompat", String.format("NativeLibraryExtractor: using library %s for ABI %s", nVar.f31766a, str));
                        }
                    }
                } else {
    ...
    public final void f(u uVar, Set set, m mVar) {
        ...
        while (it.hasNext()) {
            n nVar = (n) it.next();
            File c10 = this.f31769a.c(uVar.b(), nVar.f31766a);
            boolean z10 = false;
            if (c10.exists() && c10.length() == nVar.f31767b.getSize() && f.p(c10)) {
                z10 = true;
            }
            mVar.a(nVar, c10, z10);
        }
    ...
    public final Set c() {
        ...
        Set<u> j10 = this.f31769a.j();
        for (String str : this.f31769a.h()) {
        ...
        for (u uVar : j10) {
            ...
            for (File file : this.f31769a.i(uVar.b())) {
