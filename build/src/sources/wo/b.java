...
public final class b extends j {
    ...
    public static final a f52728q = new a(null);

    /* loaded from: /home/runner/work/discord-client-datamining/discord-client-datamining/build/classes4.dex */
    public static final class a implements c0 {

        /* renamed from: a  reason: collision with root package name */
        private final /* synthetic */ vm.f f52729a;

        /* JADX INFO: Access modifiers changed from: package-private */
        /* renamed from: wo.b$a$a  reason: collision with other inner class name */
        /* loaded from: /home/runner/work/discord-client-datamining/discord-client-datamining/build/classes4.dex */
        public /* synthetic */ class C0721a extends FunctionReferenceImpl implements Function2 {
            C0721a(Object obj) {
            ...
            public final void a(zm.f p02, a0 p12) {
        ...
        public static final View c(c initialRendering, a0 initialEnv, Context contextForNewView, ViewGroup viewGroup) {
            ...
            bVar.setId(g.f52737b);
            bVar.setLayoutParams(new ViewGroup.LayoutParams(-1, -1));
            g0.a(bVar, initialRendering, initialEnv, new C0721a(bVar));
            return bVar;
        }
        ...
        public View a(c initialRendering, a0 initialViewEnvironment, Context contextForNewView, ViewGroup viewGroup) {
            ...
            Intrinsics.checkNotNullParameter(contextForNewView, "contextForNewView");
            return this.f52729a.a(initialRendering, initialViewEnvironment, contextForNewView, viewGroup);
        }

        @Override // vm.c0
        public KClass getType() {
            return this.f52729a.getType();
        }

        private a() {
            this.f52729a = new vm.f(Reflection.getOrCreateKotlinClass(c.class), new Function4() { // from class: wo.a
    ...
    public Dialog g(View view) {
        ...
        Dialog dialog = new Dialog(getContext(), bp.f.f7666a);
        Iterator it = s.d(view).iterator();
        while (true) {
            if (it.hasNext()) {
                obj = it.next();
                if (((View) obj).getTag(g.f52736a) instanceof Integer) {
                    break;
                }
            } else {
                obj = null;
