...
public final class e extends com.google.android.material.bottomsheet.b {
    ...
    public static final a f53885i = new a(null);
    ...
    private final void H(StepStyle stepStyle, xo.a aVar, boolean z10) {
        ...
        if (stepStyle != null && (titleStyleValue = stepStyle.getTitleStyleValue()) != null) {
            TextView hintTitle = aVar.f55253f;
        ...
        if (stepStyle != null && (textStyleValue = stepStyle.getTextStyleValue()) != null) {
            TextView hintMessage = aVar.f55252e;
        ...
        if (stepStyle != null && (cancelDialogCloseStyleValue = stepStyle.getCancelDialogCloseStyleValue()) != null) {
            Button closeButton = aVar.f55250c;
            Intrinsics.checkNotNullExpressionValue(closeButton, "closeButton");
            lq.e.f(closeButton, cancelDialogCloseStyleValue, false, !z10, 2, null);
        }
        if (stepStyle != null && (cancelDialogResumeStyleValue = stepStyle.getCancelDialogResumeStyleValue()) != null) {
            Button retryButton = aVar.f55254g;
            Intrinsics.checkNotNullExpressionValue(retryButton, "retryButton");
            lq.e.f(retryButton, cancelDialogResumeStyleValue, false, !z10, 2, null);
        }
    }
    ...
    public static final void L(Dialog dialog, e eVar, DialogInterface dialogInterface) {
        StepStyle stepStyle;
        ViewGroup viewGroup = (ViewGroup) dialog.findViewById(f.f6713f);
        ...
        ConstraintLayout bottomSheetContent = eVar.J().f55249b;
        Intrinsics.checkNotNullExpressionValue(bottomSheetContent, "bottomSheetContent");
        lq.c.c(viewGroup, stepStyle2, bottomSheetContent, null, 4, null);
    }

    /* JADX INFO: Access modifiers changed from: private */
    public static final Unit M(xo.a aVar, e eVar, n.b.a aVar2) {
        boolean z10 = true;
        if (aVar.f55250c.getLineCount() <= 1 && aVar.f55254g.getLineCount() <= 1) {
            z10 = false;
        } else {
            Button closeButton = aVar.f55250c;
            Intrinsics.checkNotNullExpressionValue(closeButton, "closeButton");
            ...
            if (layoutParams != null) {
                layoutParams.width = aVar.f55251d.getWidth();
                closeButton.setLayoutParams(layoutParams);
                Button retryButton = aVar.f55254g;
                Intrinsics.checkNotNullExpressionValue(retryButton, "retryButton");
                ViewGroup.LayoutParams layoutParams2 = retryButton.getLayoutParams();
                if (layoutParams2 != null) {
                    layoutParams2.width = aVar.f55251d.getWidth();
                    retryButton.setLayoutParams(layoutParams2);
                    aVar.f55251d.setReferencedIds(new int[]{aVar.f55250c.getId(), aVar.f55254g.getId()});
                } else {
    ...
    public Dialog onCreateDialog(Bundle bundle) {
        ...
        onCreateDialog.setOnShowListener(new DialogInterface.OnShowListener() { // from class: wo.d
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup viewGroup, Bundle bundle) {
        ...
        P(xo.a.c(inflater, viewGroup, false));
        ...
        if (I != null) {
            ...
            if (dialog != null && (window = dialog.getWindow()) != null) {
                ...
                if (f10 != null && (backgroundColorValue = f10.getBackgroundColorValue()) != null) {
                    ...
                    d10 = s.d(context, bh.b.f6641o, null, false, 6, null);
                }
                sp.f0.a(window, d10);
            }
            final xo.a J = J();
            String h10 = I.h();
            if (h10 != null) {
                J.f55253f.setText(h10);
            }
            String d11 = I.d();
            if (d11 != null) {
                J.f55252e.setText(d11);
            }
            String a10 = I.a();
            if (a10 != null) {
                J.f55250c.setText(a10);
            }
            String e10 = I.e();
            if (e10 != null) {
                J.f55254g.setText(e10);
            }
            J.f55254g.setOnClickListener(new View.OnClickListener() { // from class: wo.a
                @Override // android.view.View.OnClickListener
                public final void onClick(View view2) {
                    e.N(e.this, view2);
                }
            });
            J.f55250c.setOnClickListener(new View.OnClickListener() { // from class: wo.b
                @Override // android.view.View.OnClickListener
                public final void onClick(View view2) {
                    e.O(e.this, I, view2);
                }
            });
            Button closeButton = J.f55250c;
            Intrinsics.checkNotNullExpressionValue(closeButton, "closeButton");
            cq.s.b(closeButton, new Function0() { // from class: wo.c
                @Override // kotlin.jvm.functions.Function0
                public final Object invoke() {
                    Unit M;
                    M = e.M(xo.a.this, this, I);
                    return M;
                }
            });
            return;
