...
public abstract class e {
    ...
    public static boolean b(b[] bVarArr, b[] bVarArr2) {
        ...
        for (int i10 = 0; i10 < bVarArr.length; i10++) {
            if (bVarArr[i10].f46459a != bVarArr2[i10].f46459a || bVarArr[i10].f46460b.length != bVarArr2[i10].f46460b.length) {
                return false;
            }
        }
        return true;
    ...
    */
    ...
    public static void j(b[] bVarArr, Path path) {
        ...
        char c10 = 'm';
        for (b bVar : bVarArr) {
            b.e(path, fArr, c10, bVar.f46459a, bVar.f46460b);
            c10 = bVar.f46459a;
        }
    }
    ...
    public static void k(b[] bVarArr, b[] bVarArr2) {
        for (int i10 = 0; i10 < bVarArr2.length; i10++) {
            bVarArr[i10].f46459a = bVarArr2[i10].f46459a;
            for (int i11 = 0; i11 < bVarArr2[i10].f46460b.length; i11++) {
                bVarArr[i10].f46460b[i11] = bVarArr2[i10].f46460b[i11];
            }
        }
    }
    ...
    public static class b {
        ...
        b(b bVar) {
            this.f46459a = bVar.f46459a;
            float[] fArr = bVar.f46460b;
            this.f46460b = e.c(fArr, 0, fArr.length);
        }
    }
}
