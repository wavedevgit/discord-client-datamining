...
public abstract class e {
    ...
    public static boolean b(b[] bVarArr, b[] bVarArr2) {
        ...
        for (int i10 = 0; i10 < bVarArr.length; i10++) {
            if (bVarArr[i10].f47436a != bVarArr2[i10].f47436a || bVarArr[i10].f47437b.length != bVarArr2[i10].f47437b.length) {
                return false;
            }
        }
        return true;
    ...
    */
    ...
    public static void j(b[] bVarArr, Path path) {
        ...
        char c10 = 'm';
        for (b bVar : bVarArr) {
            b.e(path, fArr, c10, bVar.f47436a, bVar.f47437b);
            c10 = bVar.f47436a;
        }
    }
    ...
    public static void k(b[] bVarArr, b[] bVarArr2) {
        for (int i10 = 0; i10 < bVarArr2.length; i10++) {
            bVarArr[i10].f47436a = bVarArr2[i10].f47436a;
            for (int i11 = 0; i11 < bVarArr2[i10].f47437b.length; i11++) {
                bVarArr[i10].f47437b[i11] = bVarArr2[i10].f47437b[i11];
            }
        }
    }
    ...
    public static class b {
        ...
        /* renamed from: a  reason: collision with root package name */
        private char f47436a;

        /* renamed from: b  reason: collision with root package name */
        private final float[] f47437b;
        ...
        b(b bVar) {
            this.f47436a = bVar.f47436a;
            float[] fArr = bVar.f47437b;
            this.f47437b = e.c(fArr, 0, fArr.length);
        }
    }
}
