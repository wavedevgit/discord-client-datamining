...
public abstract class e {
    ...
    public static boolean b(b[] bVarArr, b[] bVarArr2) {
        ...
        for (int i10 = 0; i10 < bVarArr.length; i10++) {
            if (bVarArr[i10].f48462a != bVarArr2[i10].f48462a || bVarArr[i10].f48463b.length != bVarArr2[i10].f48463b.length) {
                return false;
            }
        }
        return true;
    ...
    */
    ...
    public static void j(b[] bVarArr, Path path) {
        ...
        char c10 = 'm';
        for (b bVar : bVarArr) {
            b.e(path, fArr, c10, bVar.f48462a, bVar.f48463b);
            c10 = bVar.f48462a;
        }
    }
    ...
    public static void k(b[] bVarArr, b[] bVarArr2) {
        for (int i10 = 0; i10 < bVarArr2.length; i10++) {
            bVarArr[i10].f48462a = bVarArr2[i10].f48462a;
            for (int i11 = 0; i11 < bVarArr2[i10].f48463b.length; i11++) {
                bVarArr[i10].f48463b[i11] = bVarArr2[i10].f48463b[i11];
            }
        }
    }
    ...
    public static class b {
        ...
        b(b bVar) {
            this.f48462a = bVar.f48462a;
            float[] fArr = bVar.f48463b;
            this.f48463b = e.c(fArr, 0, fArr.length);
        }
    }
}
