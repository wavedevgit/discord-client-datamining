...
public class e implements k {
    ...
    public static final p f638c0 = new p() { // from class: ad.d
        @Override // uc.p
        public final k[] b() {
            return e.b();
        }
    ...
    private static final byte[] f639d0 = {49, 10, 48, 48, 58, 48, 48, 58, 48, 48, 44, 48, 48, 48, 32, 45, 45, 62, 32, 48, 48, 58, 48, 48, 58, 48, 48, 44, 48, 48, 48, 10};

    /* renamed from: e0  reason: collision with root package name */
    private static final byte[] f640e0 = w0.s0("Format: Start, End, ReadOrder, Layer, Style, Name, MarginL, MarginR, MarginV, Effect, Text");

    /* renamed from: f0  reason: collision with root package name */
    private static final byte[] f641f0 = {68, 105, 97, 108, 111, 103, 117, 101, 58, 32, 48, 58, 48, 48, 58, 48, 48, 58, 48, 48, 44, 48, 58, 48, 48, 58, 48, 48, 58, 48, 48, 44};

    /* renamed from: g0  reason: collision with root package name */
    private static final byte[] f642g0 = {87, 69, 66, 86, 84, 84, 10, 10, 48, 48, 58, 48, 48, 58, 48, 48, 46, 48, 48, 48, 32, 45, 45, 62, 32, 48, 48, 58, 48, 48, 58, 48, 48, 46, 48, 48, 48, 10};

    /* renamed from: h0  reason: collision with root package name */
    private static final UUID f643h0 = new UUID(72057594037932032L, -9223371306706625679L);

    /* renamed from: i0  reason: collision with root package name */
    private static final Map f644i0;
    private long A;
    private long B;
    private z C;
    private z D;
    ...
    private final ad.c f645a;

    /* renamed from: a0  reason: collision with root package name */
    private boolean f646a0;
    ...
    private final SparseArray f649c;

    /* renamed from: d  reason: collision with root package name */
    private final boolean f650d;

    /* renamed from: e  reason: collision with root package name */
    private final h0 f651e;

    /* renamed from: f  reason: collision with root package name */
    private final h0 f652f;

    /* renamed from: g  reason: collision with root package name */
    private final h0 f653g;

    /* renamed from: h  reason: collision with root package name */
    private final h0 f654h;

    /* renamed from: i  reason: collision with root package name */
    private final h0 f655i;

    /* renamed from: j  reason: collision with root package name */
    private final h0 f656j;

    /* renamed from: k  reason: collision with root package name */
    private final h0 f657k;

    /* renamed from: l  reason: collision with root package name */
    private final h0 f658l;

    /* renamed from: m  reason: collision with root package name */
    private final h0 f659m;

    /* renamed from: n  reason: collision with root package name */
    private final h0 f660n;

    /* renamed from: o  reason: collision with root package name */
    private ByteBuffer f661o;
    ...
    private boolean f671y;

    /* renamed from: z  reason: collision with root package name */
    private long f672z;

    /* loaded from: /home/runner/work/discord-client-datamining/discord-client-datamining/build/classes3.dex */
    private final class b implements ad.b {
        private b() {
        }
    ...
    public static final class c {
        ...
        /* renamed from: s  reason: collision with root package name */
        public float f692s = 0.0f;

        /* renamed from: t  reason: collision with root package name */
        public float f693t = 0.0f;

        /* renamed from: u  reason: collision with root package name */
        public float f694u = 0.0f;

        /* renamed from: v  reason: collision with root package name */
        public byte[] f695v = null;
        ...
        private static boolean l(h0 h0Var) {
            try {
                ...
                if (z10 == 65534) {
                    h0Var.U(24);
                    if (h0Var.A() == e.f643h0.getMostSignificantBits()) {
                        if (h0Var.A() == e.f643h0.getLeastSignificantBits()) {
                            return true;
                        }
                    }
                }
        ...
        public void i(m mVar, int i10) {
            ...
            switch (c10) {
                ...
                case 6:
                    ...
                    break;
                case 7:
                    Pair k10 = k(new h0(g(this.f675b)));
                ...
                case '\b':
                    ...
                    System.arraycopy(g(this.f675b), 0, bArr2, 0, 4);
                ...
                case '\n':
                    ...
                    break;
                case 11:
                    singletonList = s.u(g(this.f675b));
                    str = null;
                ...
                case ChatViewRecyclerTypes.GUILD_INVITE_DISABLED /* 25 */:
                    singletonList = s.v(e.f640e0, g(this.f675b));
                    str = null;
                    str4 = "text/x-ssa";
                    i12 = -1;
                    i11 = -1;
                ...
                case ' ':
                    ...
                    singletonList.add(g(this.f675b));
    ...
    static {
        ...
        f644i0 = Collections.unmodifiableMap(hashMap);
    }
    ...
    private void B(l lVar, int i10) {
        ...
        lVar.readFully(this.f653g.e(), this.f653g.g(), i10 - this.f653g.g());
        this.f653g.T(i10);
    }
    ...
    private int H(l lVar, c cVar, int i10, boolean z10) {
        boolean z11;
        int i11;
        if ("S_TEXT/UTF8".equals(cVar.f675b)) {
            I(lVar, f639d0, i10);
            return q();
        } else if ("S_TEXT/ASS".equals(cVar.f675b)) {
            I(lVar, f641f0, i10);
            return q();
        } else if ("S_TEXT/WEBVTT".equals(cVar.f675b)) {
            I(lVar, f642g0, i10);
            return q();
        } else {
            b0 b0Var = cVar.X;
            ...
            if (!this.V) {
                if (cVar.f681h) {
                    ...
                    if (!z13) {
                        lVar.readFully(this.f653g.e(), 0, 1);
                        this.S++;
                        if ((this.f653g.e()[0] & ByteCompanionObject.MIN_VALUE) != 128) {
                            this.Z = this.f653g.e()[0];
                            this.W = true;
                        } else {
                    ...
                    if ((b10 & 1) == 1) {
                        ...
                        this.O |= 1073741824;
                        if (!this.f646a0) {
                            lVar.readFully(this.f658l.e(), 0, 8);
                            this.S += 8;
                            this.f646a0 = true;
                            byte[] e10 = this.f653g.e();
                            if (!z11) {
                                i12 = 0;
                            }
                            e10[0] = (byte) (i12 | 8);
                            this.f653g.U(0);
                            b0Var.d(this.f653g, 1, 1);
                            this.T++;
                            this.f658l.U(0);
                            b0Var.d(this.f658l, 8, 1);
                            this.T += 8;
                        }
                        if (z11) {
                            if (!this.X) {
                            ...
                            int i13 = this.Y * 4;
                            this.f653g.Q(i13);
                            lVar.readFully(this.f653g.e(), 0, i13);
                            this.S += i13;
                            short s10 = (short) ((this.Y / 2) + 1);
                            int i14 = (s10 * 6) + 2;
                            ByteBuffer byteBuffer = this.f661o;
                            if (byteBuffer == null || byteBuffer.capacity() < i14) {
                                this.f661o = ByteBuffer.allocate(i14);
                            }
                            this.f661o.position(0);
                            this.f661o.putShort(s10);
                            int i15 = 0;
                            int i16 = 0;
                            while (true) {
                                i11 = this.Y;
                                ...
                                int L = this.f653g.L();
                                if (i15 % 2 == 0) {
                                    this.f661o.putShort((short) (L - i16));
                                } else {
                                    this.f661o.putInt(L - i16);
                                }
                                i15++;
                                i16 = L;
                            }
                            ...
                            if (i11 % 2 == 1) {
                                this.f661o.putInt(i17);
                            } else {
                                this.f661o.putShort((short) i17);
                                this.f661o.putInt(0);
                            }
                            this.f659m.S(this.f661o.array(), i14);
                            b0Var.d(this.f659m, i14, 1);
                            this.T += i14;
                        }
                    }
                } else {
                    byte[] bArr = cVar.f682i;
                    if (bArr != null) {
                        this.f656j.S(bArr, bArr.length);
                    }
                }
                if (cVar.o(z10)) {
                    this.O |= 268435456;
                    this.f660n.Q(0);
                    int g10 = (this.f656j.g() + i10) - this.S;
                    this.f653g.Q(4);
                    this.f653g.e()[0] = (byte) ((g10 >> 24) & SetSpanOperation.SPAN_MAX_PRIORITY);
                    this.f653g.e()[1] = (byte) ((g10 >> 16) & SetSpanOperation.SPAN_MAX_PRIORITY);
                    this.f653g.e()[2] = (byte) ((g10 >> 8) & SetSpanOperation.SPAN_MAX_PRIORITY);
                    this.f653g.e()[3] = (byte) (g10 & SetSpanOperation.SPAN_MAX_PRIORITY);
                    b0Var.d(this.f653g, 4, 2);
                    this.T += 4;
                }
                this.V = true;
            }
            int g11 = i10 + this.f656j.g();
            if (!"V_MPEG4/ISO/AVC".equals(cVar.f675b) && !"V_MPEGH/ISO/HEVC".equals(cVar.f675b)) {
                if (cVar.T != null) {
                    if (this.f656j.g() != 0) {
                        z12 = false;
                    }
            ...
            if ("A_VORBIS".equals(cVar.f675b)) {
                this.f654h.U(0);
                b0Var.e(this.f654h, 4);
                this.T += 4;
            }
            return q();
        }
    ...
    private void I(l lVar, byte[] bArr, int i10) {
        ...
        if (this.f657k.b() < length) {
            this.f657k.R(Arrays.copyOf(bArr, length + i10));
        } else {
            System.arraycopy(bArr, 0, this.f657k.e(), 0, bArr.length);
        }
        lVar.readFully(this.f657k.e(), bArr.length, i10);
        this.f657k.U(0);
        this.f657k.T(length);
    }

    private int J(l lVar, b0 b0Var, int i10) {
        int a10 = this.f656j.a();
        if (a10 > 0) {
            int min = Math.min(i10, a10);
            b0Var.e(this.f656j, min);
            return min;
        }
    ...
    private void K(l lVar, byte[] bArr, int i10, int i11) {
        int min = Math.min(i11, this.f656j.a());
        lVar.readFully(bArr, i10 + min, i11 - min);
        if (min > 0) {
            this.f656j.l(bArr, i10, min);
        }
    }
    ...
    private uc.z m(z zVar, z zVar2) {
        int i10;
        if (this.f663q != -1 && this.f666t != -9223372036854775807L && zVar != null && zVar.c() != 0 && zVar2 != null && zVar2.c() == zVar.c()) {
            int c10 = zVar.c();
            ...
            for (int i12 = 0; i12 < c10; i12++) {
                ...
                jArr[i12] = this.f663q + zVar2.b(i12);
            }
            while (true) {
                i10 = c10 - 1;
                if (i11 >= i10) {
            ...
            iArr[i10] = (int) ((this.f663q + this.f662p) - jArr[i10]);
            long j10 = this.f666t - jArr3[i10];
            jArr2[i10] = j10;
            if (j10 <= 0) {
            ...
            return new uc.c(iArr, jArr, jArr2, jArr3);
        }
        return new z.b(this.f666t);
    }
    ...
    */
    private void n(ad.e.c r18, long r19, int r21, int r22, int r23) {
        /*
            r17 = this;
            r0 = r17
            r1 = r18
        ...
        Lc8:
            ...
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: ad.e.n(ad.e$c, long, int, int, int):void");
    }
                    ...
                    if (i10 != 19899) {
                        if (i10 != 20533) {
                            if (i10 != 21968) {
                                if (i10 != 408125543) {
                                    if (i10 != 475249515) {
                                        if (i10 == 524531317 && !this.f668v) {
                                            if (this.f650d && this.f672z != -1) {
                                                this.f671y = true;
                                                return;
                                            }
                                            this.f648b0.j(new z.b(this.f666t));
                                            this.f668v = true;
                                            return;
                                        }
                                        return;
    ...
    public void a(long j10, long j11) {
        ...
        this.f647b.e();
        C();
        for (int i10 = 0; i10 < this.f649c.size(); i10++) {
            ((c) this.f649c.valueAt(i10)).n();
        }
    }
    ...
    @Override // uc.k
    public final int h(l lVar, uc.y yVar) {
        this.F = false;
        boolean z10 = true;
        while (z10 && !this.F) {
            z10 = this.f645a.a(lVar);
        ...
        for (int i10 = 0; i10 < this.f649c.size(); i10++) {
            c cVar = (c) this.f649c.valueAt(i10);
            cVar.f();
            cVar.j();
        }
        return -1;
    ...
    /* JADX WARN: Code restructure failed: missing block: B:94:0x0244, code lost:
        throw mc.l0.a("EBML lacing sample size out of range.", null);
     */
    ...
    /*
        ...
        To view partially-correct add '--show-bad-code' argument
    */
    protected void l(int r24, int r25, uc.l r26) {
        /*
            Method dump skipped, instructions count: 773
            To view this dump add '--comments-level debug' option
        */
        throw new UnsupportedOperationException("Method not decompiled: ad.e.l(int, int, uc.l):void");
    }
    ...
    protected void o(int i10) {
        ...
        if (i10 != 160) {
                ...
                if (i10 != 19899) {
                    if (i10 != 25152) {
                        if (i10 != 28032) {
                            ...
                            if (this.f664r == -9223372036854775807L) {
                                this.f664r = 1000000L;
                            }
                            long j10 = this.f665s;
                            if (j10 != -9223372036854775807L) {
            ...
            c cVar3 = (c) oe.a.i(this.f667u);
            String str = cVar3.f675b;
            if (str != null) {
                if (y(str)) {
                    cVar3.i(this.f648b0, cVar3.f676c);
                    this.f649c.put(cVar3.f676c, cVar3);
                }
                this.f667u = null;
                return;
            }
            ...
            c cVar4 = (c) this.f649c.get(this.M);
            cVar4.f();
            if (this.R > 0 && "A_OPUS".equals(cVar4.f675b)) {
                this.f660n.R(ByteBuffer.allocate(8).order(ByteOrder.LITTLE_ENDIAN).putLong(this.R).array());
            }
            int i12 = 0;
            ...
            int i14 = 0;
            while (i14 < this.K) {
                long j12 = this.H + ((cVar4.f678e * i14) / 1000);
                int i15 = this.O;
                if (i14 == 0 && !this.Q) {
                    i15 |= 1;
                }
            ...
            if (i10 != 17545) {
                switch (i10) {
                    ...
                    default:
                        switch (i10) {
                            case 30323:
                                t(i10).f692s = (float) d10;
                                return;
                            case 30324:
                                t(i10).f693t = (float) d10;
                                return;
                            case 30325:
                                t(i10).f694u = (float) d10;
                                return;
                            default:
                                return;
                        }
    ...
    protected void v(c cVar, l lVar, int i10) {
        if (cVar.f680g != 1685485123 && cVar.f680g != 1685480259) {
            lVar.k(i10);
            return;
        }
    ...
    protected void w(c cVar, int i10, l lVar, int i11) {
        if (i10 == 4 && "V_VP9".equals(cVar.f675b)) {
            this.f660n.Q(i11);
            lVar.readFully(this.f660n.e(), 0, i11);
            return;
        }
        lVar.k(i11);
    }
                ...
                switch (i10) {
                    ...
                    default:
                        switch (i10) {
                            ...
                            case 21946:
                                j(i10);
                                int i14 = pe.c.i((int) j10);
                                if (i14 != -1) {
                                    this.f667u.f699z = i14;
                                    return;
                                }
                                return;
                            case 21947:
                                j(i10);
                                this.f667u.f697x = true;
                                int h10 = pe.c.h((int) j10);
                                if (h10 != -1) {
                                    this.f667u.f698y = h10;
                                    return;
                                }
                                return;
                            case 21948:
    ...
    e(ad.c cVar, int i10) {
        this.f663q = -1L;
        this.f664r = -9223372036854775807L;
        this.f665s = -9223372036854775807L;
        this.f666t = -9223372036854775807L;
        this.f672z = -1L;
        this.A = -1L;
        this.B = -9223372036854775807L;
        this.f645a = cVar;
