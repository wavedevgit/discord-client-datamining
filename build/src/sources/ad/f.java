...
public final class f implements k {
    ...
    private long i(long j10) {
        return this.f496m + ((j10 * 1000000) / this.f487d.f38809d);
    }
        ...
        if (metadata != null) {
            ...
            for (int i10 = 0; i10 < e10; i10++) {
                ...
                if (d10 instanceof ld.m) {
                    ld.m mVar = (ld.m) d10;
                    if (mVar.f36061d.equals("TLEN")) {
                        return w0.K0(Long.parseLong((String) mVar.f36074o.get(0)));
                    }
                }
            }
    ...
    private g p(l lVar) {
        h0 h0Var = new h0(this.f487d.f38808c);
        lVar.n(h0Var.e(), 0, this.f487d.f38808c);
        u.a aVar = this.f487d;
        int i10 = 21;
        if ((aVar.f38806a & 1) != 0) {
            if (aVar.f38810e != 1) {
    ...
    private int r(l lVar) {
        ...
        if (this.f500q == null) {
            ...
            this.f491h.q(h10);
            b0 b0Var = this.f493j;
            Format.b Q = new Format.b().g0(this.f487d.f38807b).Y(RecyclerView.ItemAnimator.FLAG_APPEARED_IN_PRE_LAYOUT).J(this.f487d.f38810e).h0(this.f487d.f38809d).P(this.f488e.f50572a).Q(this.f488e.f50573b);
            if ((this.f484a & 8) != 0) {
                metadata = null;
            } else {
                metadata = this.f495l;
    ...
    private int s(l lVar) {
        ...
        if (this.f499p == 0) {
            ...
            if (n(q10, this.f494k) && u.j(q10) != -1) {
                ...
                this.f499p = this.f487d.f38808c;
                g gVar = this.f500q;
                if (gVar instanceof b) {
                    b bVar = (b) gVar;
                    bVar.c(i(this.f497n + aVar.f38812g), lVar.getPosition() + this.f487d.f38808c);
        ...
        this.f493j.d(i(this.f497n), 1, this.f487d.f38808c, 0, null);
        this.f497n += this.f487d.f38812g;
        this.f499p = 0;
        return 0;
    }
