...
public abstract class j2 extends a0 implements KProperty {
    ...
    public static final b f51066x = new b(null);

    /* renamed from: y  reason: collision with root package name */
    private static final Object f51067y = new Object();

    /* renamed from: r  reason: collision with root package name */
    private final c1 f51068r;

    /* renamed from: s  reason: collision with root package name */
    private final String f51069s;

    /* renamed from: t  reason: collision with root package name */
    private final String f51070t;

    /* renamed from: u  reason: collision with root package name */
    private final Object f51071u;

    /* renamed from: v  reason: collision with root package name */
    private final Lazy f51072v;

    /* renamed from: w  reason: collision with root package name */
    private final z2.a f51073w;
    ...
    public static abstract class c extends a implements KProperty.b {
        ...
        /* renamed from: t  reason: collision with root package name */
        static final /* synthetic */ KProperty[] f51074t = {Reflection.property1(new PropertyReference1Impl(c.class, "descriptor", "getDescriptor()Lorg/jetbrains/kotlin/descriptors/PropertyGetterDescriptor;", 0))};

        /* renamed from: r  reason: collision with root package name */
        private final z2.a f51075r = z2.c(new k2(this));

        /* renamed from: s  reason: collision with root package name */
        private final Lazy f51076s = as.l.a(as.o.f6082e, new l2(this));
        ...
        @Override // us.a0
        public vs.h A() {
            return (vs.h) this.f51076s.getValue();
        }

        @Override // us.j2.a
        /* renamed from: O */
        public PropertyGetterDescriptor I() {
            Object b10 = this.f51075r.b(this, f51074t[0]);
    ...
    public static abstract class d extends a implements e.a {
        ...
        /* renamed from: t  reason: collision with root package name */
        static final /* synthetic */ KProperty[] f51077t = {Reflection.property1(new PropertyReference1Impl(d.class, "descriptor", "getDescriptor()Lorg/jetbrains/kotlin/descriptors/PropertySetterDescriptor;", 0))};

        /* renamed from: r  reason: collision with root package name */
        private final z2.a f51078r = z2.c(new m2(this));

        /* renamed from: s  reason: collision with root package name */
        private final Lazy f51079s = as.l.a(as.o.f6082e, new n2(this));
        ...
        @Override // us.a0
        public vs.h A() {
            return (vs.h) this.f51079s.getValue();
        }

        @Override // us.j2.a
        /* renamed from: O */
        public PropertySetterDescriptor I() {
            Object b10 = this.f51078r.b(this, f51077t[0]);
            Intrinsics.checkNotNullExpressionValue(b10, "getValue(...)");
    ...
    private j2(c1 c1Var, String str, String str2, PropertyDescriptor propertyDescriptor, Object obj) {
        ...
        this.f51070t = str2;
        this.f51071u = obj;
        this.f51072v = as.l.a(as.o.f6082e, new h2(this));
    ...
    public static final PropertyDescriptor I(j2 j2Var) {
        return j2Var.B().n(j2Var.getName(), j2Var.f51070t);
    }

    /* JADX INFO: Access modifiers changed from: private */
    public static final Field J(j2 j2Var) {
        Class<?> enclosingClass;
        p f10 = e3.f51032a.f(j2Var.D());
    ...
    @Override // us.a0
    public boolean G() {
        if (this.f51071u != CallableReference.NO_RECEIVER) {
            return true;
        }
        return false;
    }
    ...
    public PropertyDescriptor D() {
        Object invoke = this.f51073w.invoke();
    ...
    public final Field R() {
        return (Field) this.f51072v.getValue();
    }
    ...
    public boolean equals(Object obj) {
        j2 d10 = j3.d(obj);
        if (d10 == null || !Intrinsics.areEqual(B(), d10.B()) || !Intrinsics.areEqual(getName(), d10.getName()) || !Intrinsics.areEqual(this.f51070t, d10.f51070t) || !Intrinsics.areEqual(this.f51071u, d10.f51071u)) {
            return false;
        }
        return true;
    }
    ...
    public int hashCode() {
        return (((B().hashCode() * 31) + getName().hashCode()) * 31) + this.f51070t.hashCode();
    }
