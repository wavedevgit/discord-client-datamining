...
public abstract class j3 {
    ...
    private static final Annotation p(AnnotationDescriptor annotationDescriptor) {
        ...
        return (Annotation) vs.f.h(cls, kotlin.collections.o0.u(arrayList), null, 4, null);
    }
    ...
    private static final List t(List list) {
        ...
        while (true) {
            if (!it.hasNext()) {
                break;
            } else if (Intrinsics.areEqual(ns.a.b(ns.a.a((Annotation) it.next())).getSimpleName(), "Container")) {
                list = new ArrayList();
