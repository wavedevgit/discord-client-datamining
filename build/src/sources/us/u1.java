...
public final class u1 extends c1 {
    ...
    private final Class f51727o;

    /* renamed from: p  reason: collision with root package name */
    private final Lazy f51728p;
    ...
    public final class a extends c1.b {
        ...
        static final /* synthetic */ KProperty[] f51729j = {Reflection.property1(new PropertyReference1Impl(a.class, "kotlinClass", "getKotlinClass()Lorg/jetbrains/kotlin/descriptors/runtime/components/ReflectKotlinClass;", 0)), Reflection.property1(new PropertyReference1Impl(a.class, "scope", "getScope()Lorg/jetbrains/kotlin/resolve/scopes/MemberScope;", 0)), Reflection.property1(new PropertyReference1Impl(a.class, "members", "getMembers()Ljava/util/Collection;", 0))};

        /* renamed from: d  reason: collision with root package name */
        private final z2.a f51730d;

        /* renamed from: e  reason: collision with root package name */
        private final z2.a f51731e;

        /* renamed from: f  reason: collision with root package name */
        private final Lazy f51732f;

        /* renamed from: g  reason: collision with root package name */
        private final Lazy f51733g;

        /* renamed from: h  reason: collision with root package name */
        private final z2.a f51734h;

        public a() {
            super();
            this.f51730d = z2.c(new p1(u1.this));
            this.f51731e = z2.c(new q1(this));
            as.o oVar = as.o.f6082e;
            this.f51732f = as.l.a(oVar, new r1(this, u1.this));
            this.f51733g = as.l.a(oVar, new s1(this));
            this.f51734h = z2.c(new t1(u1.this, this));
        }

        private final ReflectKotlinClass i() {
            return (ReflectKotlinClass) this.f51730d.b(this, f51729j[0]);
        }
        ...
        public static final Collection o(u1 u1Var, a aVar) {
            return u1Var.u(aVar.m(), c1.d.f51582d);
        }

        /* JADX INFO: Access modifiers changed from: private */
        public static final as.u p(a aVar) {
            ...
            if (i10 != null && (classHeader = i10.getClassHeader()) != null) {
                ...
                if (data != null && strings != null) {
                    ...
                    return new as.u((JvmNameResolver) readPackageDataFrom.a(), (ProtoBuf.Package) readPackageDataFrom.b(), classHeader.getMetadataVersion());
                }
            }
            return null;
        }
        ...
        public final Collection j() {
            Object b10 = this.f51734h.b(this, f51729j[2]);
            Intrinsics.checkNotNullExpressionValue(b10, "getValue(...)");
            return (Collection) b10;
        }

        public final as.u k() {
            return (as.u) this.f51733g.getValue();
        }

        public final Class l() {
            return (Class) this.f51732f.getValue();
        }

        public final MemberScope m() {
            Object b10 = this.f51731e.b(this, f51729j[1]);
            Intrinsics.checkNotNullExpressionValue(b10, "getValue(...)");
    ...
    public u1(Class jClass) {
        ...
        this.f51727o = jClass;
        this.f51728p = as.l.a(as.o.f6082e, new o1(this));
    }
    ...
    private final MemberScope E() {
        return ((a) this.f51728p.getValue()).m();
    }
    ...
    public Collection getMembers() {
        return ((a) this.f51728p.getValue()).j();
    }
    ...
    public PropertyDescriptor t(int i10) {
        as.u k10 = ((a) this.f51728p.getValue()).k();
        if (k10 != null) {
            ...
            if (property != null) {
                ...
                return (PropertyDescriptor) j3.h(jClass, property, jvmNameResolver, new TypeTable(typeTable), metadataVersion, b.f51736d);
            }
        }
        return null;
    }
    ...
    @Override // us.c1
    protected Class v() {
        Class l10 = ((a) this.f51728p.getValue()).l();
        if (l10 == null) {
            return getJClass();
        }
        return l10;
