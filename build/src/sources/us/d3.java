...
public final class d3 {
    ...
    public static final d3 f51593a = new d3();

    /* renamed from: b  reason: collision with root package name */
    private static final DescriptorRenderer f51594b = DescriptorRenderer.FQ_NAMES_IN_TYPES;
    ...
    public /* synthetic */ class a {
        ...
        static {
            ...
            try {
                iArr[i.a.f32673e.ordinal()] = 1;
            } catch (NoSuchFieldError unused) {
            }
            try {
                iArr[i.a.f32672d.ordinal()] = 2;
            } catch (NoSuchFieldError unused2) {
            }
            try {
                iArr[i.a.f32674i.ordinal()] = 3;
    ...
    public final String f(FunctionDescriptor descriptor) {
        ...
        DescriptorRenderer descriptorRenderer = f51594b;
        Name name = descriptor.getName();
        Intrinsics.checkNotNullExpressionValue(name, "getName(...)");
        sb2.append(descriptorRenderer.renderName(name, true));
        List<ValueParameterDescriptor> valueParameters = descriptor.getValueParameters();
        Intrinsics.checkNotNullExpressionValue(valueParameters, "getValueParameters(...)");
        CollectionsKt.v0(valueParameters, sb2, ", ", "(", ")", 0, null, b3.f51571d, 48, null);
        sb2.append(": ");
    ...
    public final String h(FunctionDescriptor invoke) {
        ...
        Intrinsics.checkNotNullExpressionValue(valueParameters, "getValueParameters(...)");
        CollectionsKt.v0(valueParameters, sb2, ", ", "(", ")", 0, null, c3.f51587d, 48, null);
        sb2.append(" -> ");
    ...
    public final String j(x1 parameter) {
        ...
        StringBuilder sb2 = new StringBuilder();
        int i10 = a.f51595a[parameter.getKind().ordinal()];
        if (i10 != 1) {
            if (i10 != 2) {
                if (i10 == 3) {
        ...
        sb2.append(" of ");
        sb2.append(f51593a.e(parameter.g().D()));
        return sb2.toString();
    }
    ...
    public final String l(KotlinType type) {
        ...
        return f51594b.renderType(type);
    }
}
