...
public final class v2 implements kotlin.reflect.l, x0 {
    ...
    static final /* synthetic */ KProperty[] f51172o = {Reflection.property1(new PropertyReference1Impl(v2.class, "upperBounds", "getUpperBounds()Ljava/util/List;", 0))};

    /* renamed from: d  reason: collision with root package name */
    private final TypeParameterDescriptor f51173d;

    /* renamed from: e  reason: collision with root package name */
    private final z2.a f51174e;

    /* renamed from: i  reason: collision with root package name */
    private final w2 f51175i;
    ...
    public v2(w2 w2Var, TypeParameterDescriptor descriptor) {
        ...
        this.f51173d = descriptor;
        this.f51174e = z2.c(new u2(this));
        if (w2Var == null) {
            ...
            if (containingDeclaration instanceof ClassDescriptor) {
                ...
                if (containingDeclaration2 instanceof ClassDescriptor) {
                    ...
                    if (deserializedMemberDescriptor != null) {
                        KClass e10 = ns.a.e(b(deserializedMemberDescriptor));
                ...
                accept = containingDeclaration.accept(new j(w0Var), Unit.f31987a);
            } else {
    ...
    public boolean equals(Object obj) {
        if (obj instanceof v2) {
            v2 v2Var = (v2) obj;
            if (Intrinsics.areEqual(this.f51175i, v2Var.f51175i) && Intrinsics.areEqual(getName(), v2Var.getName())) {
                return true;
            }
            return false;
        }
    ...
    public List getUpperBounds() {
        Object b10 = this.f51174e.b(this, f51172o[0]);
    ...
    public kotlin.reflect.m getVariance() {
        int i10 = a.f51176a[getDescriptor().getVariance().ordinal()];
        if (i10 != 1) {
            if (i10 != 2) {
                if (i10 == 3) {
                    return kotlin.reflect.m.f34828i;
                }
                throw new as.p();
            }
            return kotlin.reflect.m.f34827e;
        }
        return kotlin.reflect.m.f34826d;
    }

    public int hashCode() {
        return (this.f51175i.hashCode() * 31) + getName().hashCode();
    }
