...
public abstract class a extends BroadcastReceiver {
    ...
    private static SoftReference f22108a;

    /* renamed from: b  reason: collision with root package name */
    private static SoftReference f22109b;
    ...
    protected Executor a() {
        ...
        synchronized (a.class) {
            try {
                SoftReference softReference = f22108a;
                ...
                if (executorService == null) {
                    ...
                    f22108a = new SoftReference(executorService);
                }
            } catch (Throwable th2) {
                throw th2;
            }
    ...
    public final /* synthetic */ void d(Intent intent, final Context context, boolean z10, BroadcastReceiver.PendingResult pendingResult) {
        ...
        try {
            ...
            if (intent2 != null) {
                ...
                synchronized (a.class) {
                    SoftReference softReference = f22109b;
                    if (softReference != null) {
                    ...
                    if (executor == null) {
                        ...
                        f22109b = new SoftReference(executor);
                    }
                }
