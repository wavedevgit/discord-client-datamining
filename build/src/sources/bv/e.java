...
public interface e extends ru.c {

    /* loaded from: /home/runner/work/discord-client-datamining/discord-client-datamining/build/classes5.dex */
    public static final class a {
        private static boolean a(e eVar, List list, Function2 function2) {
            boolean b10 = eVar.b(CollectionsKt.o((Comparable) CollectionsKt.firstOrNull(list), (Comparable) vv.c.b(list)), function2);
            boolean b11 = eVar.b(CollectionsKt.o((Comparable) vv.c.b(list), (Comparable) vv.c.c(list)), function2);
            if (!b10 || !b11) {
                return false;
            }
            return true;
