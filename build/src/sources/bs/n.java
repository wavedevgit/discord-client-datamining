...
public class n extends m {
    ...
    private static final g u(g gVar) {
    ...
    private static final String z(File file, File file2) {
        g u10 = u(k.c(file));
        g u11 = u(k.c(file2));
        if (!Intrinsics.areEqual(u10.a(), u11.a())) {
            return null;
        }
        int c10 = u11.c();
        int c11 = u10.c();
        ...
        int i10 = 0;
        while (i10 < min && Intrinsics.areEqual(u10.b().get(i10), u11.b().get(i10))) {
            i10++;
        }
        StringBuilder sb2 = new StringBuilder();
        int i11 = c10 - 1;
        if (i10 <= i11) {
            while (!Intrinsics.areEqual(((File) u11.b().get(i11)).getName(), "..")) {
                sb2.append("..");
                if (i11 != i10) {
        ...
        if (i10 < c11) {
            ...
            CollectionsKt.v0(CollectionsKt.f0(u10.b(), i10), sb2, separator, null, null, 0, null, null, 124, null);
        }
        return sb2.toString();
    }
}
