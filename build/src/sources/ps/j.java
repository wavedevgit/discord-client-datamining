...
public abstract /* synthetic */ class j {
    ...
    public static final class a extends kotlin.coroutines.jvm.internal.k implements Function2 {
        ...
        public final Continuation create(Object obj, Continuation continuation) {
            return new a(this.f46390e, continuation);
        }
    ...
    public static final Object a(Flow flow, Continuation continuation) {
        Object collect = flow.collect(qs.s.f48074d, continuation);
        if (collect == ur.b.f()) {
            return collect;
        }
        return Unit.f31988a;
    ...
    public static final Job d(Flow flow, CoroutineScope coroutineScope) {
        Job d10;
        d10 = ms.i.d(coroutineScope, null, null, new a(flow, null), 3, null);
        return d10;
    }
}
