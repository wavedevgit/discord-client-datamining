...
public class b extends d implements Runnable {
    ...
    private d0.a f20319i;

    /* renamed from: o  reason: collision with root package name */
    private final BlockingQueue f20320o = new LinkedBlockingQueue(1);

    /* renamed from: p  reason: collision with root package name */
    private final CountDownLatch f20321p = new CountDownLatch(1);

    /* renamed from: q  reason: collision with root package name */
    private ListenableFuture f20322q;

    /* renamed from: r  reason: collision with root package name */
    volatile ListenableFuture f20323r;

    /* loaded from: /home/runner/work/discord-client-datamining/discord-client-datamining/build/classes.dex */
    class a implements Runnable {

        /* renamed from: d  reason: collision with root package name */
        final /* synthetic */ ListenableFuture f20324d;

        a(ListenableFuture listenableFuture) {
            this.f20324d = listenableFuture;
        }
    ...
    public b(d0.a aVar, ListenableFuture listenableFuture) {
        this.f20319i = (d0.a) b2.e.g(aVar);
        this.f20322q = (ListenableFuture) b2.e.g(listenableFuture);
    }
    ...
    public boolean cancel(boolean z10) {
        if (super.cancel(z10)) {
            h(this.f20320o, Boolean.valueOf(z10));
            g(this.f20322q, z10);
            g(this.f20323r, z10);
            return true;
        }
    ...
    public Object get() {
        if (!isDone()) {
            ListenableFuture listenableFuture = this.f20322q;
            if (listenableFuture != null) {
                listenableFuture.get();
            }
            this.f20321p.await();
            ListenableFuture listenableFuture2 = this.f20323r;
        ...
        try {
            try {
                try {
                    try {
                        try {
                            ListenableFuture apply = this.f20319i.apply(n.m(this.f20322q));
                            this.f20323r = apply;
                            if (isCancelled()) {
                                apply.cancel(((Boolean) i(this.f20320o)).booleanValue());
                                this.f20323r = null;
                            } else {
    ...
    public Object get(long j10, TimeUnit timeUnit) {
        if (!isDone()) {
            ...
            if (this.f20321p.await(j10, timeUnit)) {
