...
public class d implements ListenableFuture {
    ...
    private final ListenableFuture f21274d;
    ...
    d(ListenableFuture listenableFuture) {
        this.f21274d = (ListenableFuture) b2.e.g(listenableFuture);
    }
    ...
    public void a(Runnable runnable, Executor executor) {
        this.f21274d.a(runnable, executor);
    }

    /* JADX INFO: Access modifiers changed from: package-private */
    public boolean c(Object obj) {
        c.a aVar = this.f21275e;
        if (aVar != null) {
            return aVar.c(obj);
        }
        return false;
    ...
    public boolean cancel(boolean z10) {
        return this.f21274d.cancel(z10);
    }
    ...
    public boolean isCancelled() {
        return this.f21274d.isCancelled();
    }

    @Override // java.util.concurrent.Future
    public boolean isDone() {
        return this.f21274d.isDone();
    }

    @Override // java.util.concurrent.Future
    public Object get(long j10, TimeUnit timeUnit) {
        return this.f21274d.get(j10, timeUnit);
    }

    /* JADX INFO: Access modifiers changed from: package-private */
    public d() {
        this.f21274d = androidx.concurrent.futures.c.a(new a());
    }
}
