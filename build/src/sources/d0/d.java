...
public class d implements ListenableFuture {
    ...
    private final ListenableFuture f19922d;
    ...
    d(ListenableFuture listenableFuture) {
        this.f19922d = (ListenableFuture) b2.e.g(listenableFuture);
    }
    ...
    public void a(Runnable runnable, Executor executor) {
        this.f19922d.a(runnable, executor);
    }

    /* JADX INFO: Access modifiers changed from: package-private */
    public boolean c(Object obj) {
        c.a aVar = this.f19923e;
        if (aVar != null) {
            return aVar.c(obj);
        }
        return false;
    ...
    public boolean cancel(boolean z10) {
        return this.f19922d.cancel(z10);
    }
    ...
    @Override // java.util.concurrent.Future
    public Object get() {
        return this.f19922d.get();
    }

    @Override // java.util.concurrent.Future
    public boolean isCancelled() {
        return this.f19922d.isCancelled();
    }

    @Override // java.util.concurrent.Future
    public boolean isDone() {
        return this.f19922d.isDone();
    }

    @Override // java.util.concurrent.Future
    public Object get(long j10, TimeUnit timeUnit) {
        return this.f19922d.get(j10, timeUnit);
    }

    /* JADX INFO: Access modifiers changed from: package-private */
    public d() {
        this.f19922d = androidx.concurrent.futures.c.a(new a());
    }
}
