...
public final class g implements ViewTreeObserver.OnPreDrawListener, View.OnAttachStateChangeListener {
    ...
    public static final a f6981o = new a(null);

    /* renamed from: d  reason: collision with root package name */
    private final View f6982d;

    /* renamed from: e  reason: collision with root package name */
    private final Runnable f6983e;

    /* renamed from: i  reason: collision with root package name */
    private ViewTreeObserver f6984i;
    ...
    private final void a() {
        if (this.f6984i.isAlive()) {
            this.f6984i.removeOnPreDrawListener(this);
        } else {
            this.f6982d.getViewTreeObserver().removeOnPreDrawListener(this);
        }
        this.f6982d.removeOnAttachStateChangeListener(this);
    }
    ...
    public void onViewAttachedToWindow(View v10) {
        ...
        this.f6984i = v10.getViewTreeObserver();
    }
