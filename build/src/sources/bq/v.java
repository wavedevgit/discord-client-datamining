...
public final class v implements ViewBinding {
    ...
    private final ConstraintLayout f7512a;
    ...
    public final MaterialCardView f7517f;
    ...
    private v(ConstraintLayout constraintLayout, TextView textView, ImageView imageView, TextView textView2, TextView textView3, MaterialCardView materialCardView, ImageView imageView2) {
        ...
        this.f7515d = textView2;
        this.f7516e = textView3;
        this.f7517f = materialCardView;
        this.f7518g = imageView2;
    }

    public static v a(View view) {
        int i10 = wp.e.f52877a;
    ...
    public static v d(LayoutInflater layoutInflater, ViewGroup viewGroup, boolean z10) {
        View inflate = layoutInflater.inflate(wp.f.f52951w, viewGroup, false);
        if (z10) {
