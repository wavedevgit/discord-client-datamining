...
public abstract class a0 {
    public static final void a(TextView textView, TextWatcher watcher) {
        ...
        Object tag = textView.getTag(m.f7400l);
        if (tag != null) {
            textView.removeTextChangedListener((TextWatcher) tag);
        }
        textView.addTextChangedListener(watcher);
        textView.setTag(m.f7400l, watcher);
    }
    ...
    public static final class a implements TextWatcher {
        ...
        final /* synthetic */ Function1 f7339e;

        a(Function1 function1) {
            this.f7339e = function1;
        }
        ...
        public void afterTextChanged(Editable editable) {
            ...
            if (!Intrinsics.areEqual(valueOf, str)) {
                this.f7339e.invoke(String.valueOf(editable));
            }
        }

        @Override // android.text.TextWatcher
        public void beforeTextChanged(CharSequence charSequence, int i10, int i11, int i12) {
            this.f7338d = String.valueOf(charSequence);
        }
