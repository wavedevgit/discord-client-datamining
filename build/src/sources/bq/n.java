...
public class n extends FrameLayout {
    ...
    public static final a f6994i = new a(null);

    /* renamed from: d  reason: collision with root package name */
    private final fn.e f6995d;
    ...
    public static final class a implements c0 {
        ...
        private final /* synthetic */ dn.f f6997a;

        /* JADX INFO: Access modifiers changed from: package-private */
        /* renamed from: bq.n$a$a  reason: collision with other inner class name */
        /* loaded from: /home/runner/work/discord-client-datamining/discord-client-datamining/build/classes4.dex */
        public /* synthetic */ class C0112a extends FunctionReferenceImpl implements Function2 {
            C0112a(Object obj) {
        ...
        public View a(k initialRendering, a0 initialViewEnvironment, Context contextForNewView, ViewGroup viewGroup) {
            ...
            return this.f6997a.a(initialRendering, initialViewEnvironment, contextForNewView, viewGroup);
        }

        @Override // dn.c0
        public KClass getType() {
            return this.f6997a.getType();
        }

        private a() {
            this.f6997a = new dn.f(Reflection.getOrCreateKotlinClass(k.class), new Function4() { // from class: bq.m
    ...
    public /* synthetic */ class c {
        ...
        static {
            ...
            try {
                iArr[j.f6987d.ordinal()] = 1;
            } catch (NoSuchFieldError unused) {
            }
            try {
                iArr[j.f6988e.ordinal()] = 2;
            } catch (NoSuchFieldError unused2) {
            }
            try {
                iArr[j.f6989i.ordinal()] = 3;
    ...
    protected void b(View view, View newView, j transition) {
        ...
        if (view != null) {
            ...
            int i10 = c.f6999a[transition.ordinal()];
            if (i10 != 1) {
                if (i10 != 2) {
                    if (i10 == 3) {
    ...
    protected final void c(k newRendering, a0 newViewEnvironment) {
        ...
        a0 c11 = newViewEnvironment.c(v.a(fn.a.f23353d, fn.a.First));
        dn.n nVar = new dn.n(newRendering.a(), "screen_with_transition");
        ...
        if (currentView != null) {
            ...
            if (view != null) {
                this.f6995d.d(CollectionsKt.e(nVar));
                g0.g(view, nVar, c11);
                return;
            }
        }
        ...
        View c12 = f0.c((e0) c11.a(e0.f20867a), nVar, c11, context, this, new h0() { // from class: bq.l
            @Override // dn.h0
    ...
    protected void onAttachedToWindow() {
        ...
        this.f6995d.a(g.a.b(aVar, c10, null, 2, null), c11);
    }
    ...
    protected Parcelable onSaveInstanceState() {
        ...
        if (onSaveInstanceState != null) {
            return new b(onSaveInstanceState, this.f6995d.g());
        }
        return null;
    }
    ...
    public static final class b extends View.BaseSavedState {
        ...
        public void writeToParcel(Parcel out, int i10) {
            ...
            out.writeParcelable(this.f6998d, i10);
        }
        ...
        public b(Parcel source) {
            ...
            this.f6998d = (e.a) readParcelable;
        }
    }
