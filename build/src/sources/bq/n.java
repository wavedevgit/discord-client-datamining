...
public final class n implements ViewBinding {
    ...
    private final TextInputLayout f7485a;

    /* renamed from: b  reason: collision with root package name */
    public final TextInputEditText f7486b;

    /* renamed from: c  reason: collision with root package name */
    public final TextInputLayout f7487c;
    ...
    private n(TextInputLayout textInputLayout, TextInputEditText textInputEditText, TextInputLayout textInputLayout2) {
        ...
        this.f7486b = textInputEditText;
        this.f7487c = textInputLayout2;
    }
    ...
    public static n d(LayoutInflater layoutInflater, ViewGroup viewGroup, boolean z10) {
        View inflate = layoutInflater.inflate(wp.f.f52944p, viewGroup, false);
        if (z10) {
