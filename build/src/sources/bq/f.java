...
public final class f implements ViewBinding {
    ...
    private final ConstraintLayout f7451a;

    /* renamed from: b  reason: collision with root package name */
    public final TextView f7452b;

    /* renamed from: c  reason: collision with root package name */
    public final TextInputLayout f7453c;

    /* renamed from: d  reason: collision with root package name */
    public final TextInputEditText f7454d;

    /* renamed from: e  reason: collision with root package name */
    public final TextView f7455e;

    /* renamed from: f  reason: collision with root package name */
    public final TextInputLayout f7456f;

    /* renamed from: g  reason: collision with root package name */
    public final AutoCompleteTextView f7457g;

    /* renamed from: h  reason: collision with root package name */
    public final TextInputLayout f7458h;

    /* renamed from: i  reason: collision with root package name */
    public final TextInputEditText f7459i;
    ...
    private f(ConstraintLayout constraintLayout, TextView textView, TextInputLayout textInputLayout, TextInputEditText textInputEditText, TextView textView2, TextInputLayout textInputLayout2, AutoCompleteTextView autoCompleteTextView, TextInputLayout textInputLayout3, TextInputEditText textInputEditText2) {
        ...
        this.f7453c = textInputLayout;
        this.f7454d = textInputEditText;
        this.f7455e = textView2;
        this.f7456f = textInputLayout2;
        this.f7457g = autoCompleteTextView;
        this.f7458h = textInputLayout3;
        this.f7459i = textInputEditText2;
    }

    public static f a(View view) {
        int i10 = wp.e.f52919v;
    ...
    public static f d(LayoutInflater layoutInflater, ViewGroup viewGroup, boolean z10) {
        View inflate = layoutInflater.inflate(wp.f.f52934f, viewGroup, false);
        if (z10) {
