...
public abstract class b {
    ...
    public static final class a extends Exception {
        ...
        private final EnumC0374a f28306d;
        ...
        a(String str, EnumC0374a enumC0374a) {
            super(str);
            this.f28306d = enumC0374a;
        }
    }
    ...
    private static Bitmap d(n nVar) {
        ...
        nVar.e1()[0].f().rewind();
        ImageProcessingUtil.j(createBitmap, nVar.e1()[0].f(), nVar.e1()[0].g());
        return createBitmap;
    }
    ...
    public static byte[] l(n nVar, Rect rect, int i10, int i11) {
        if (nVar.getFormat() == 35) {
            ...
            throw new a("YuvImage failed to encode jpeg.", a.EnumC0374a.ENCODE_FAILED);
        }
        throw new IllegalArgumentException("Incorrect image format of the input image proxy: " + nVar.getFormat());
    }
