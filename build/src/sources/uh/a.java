...
public abstract class a {
    ...
    private static final int[] f51559a = {16842752, b.f6634i0};

    /* renamed from: b  reason: collision with root package name */
    private static final int[] f51560b = {b.E};

    private static int a(Context context, AttributeSet attributeSet) {
        TypedArray obtainStyledAttributes = context.obtainStyledAttributes(attributeSet, f51559a);
    ...
    private static int b(Context context, AttributeSet attributeSet, int i10, int i11) {
        TypedArray obtainStyledAttributes = context.obtainStyledAttributes(attributeSet, f51560b, i10, i11);
        int resourceId = obtainStyledAttributes.getResourceId(0, 0);
        obtainStyledAttributes.recycle();
        return resourceId;
    }
