...
public final class l implements x {
    ...
    private MediaItem.f f48588b;

    /* renamed from: c  reason: collision with root package name */
    private v f48589c;

    /* renamed from: d  reason: collision with root package name */
    private DataSource.Factory f48590d;
    ...
    private v b(MediaItem.f fVar) {
        String uri;
        DataSource.Factory factory = this.f48590d;
        if (factory == null) {
            factory = new d.b().b(this.f48591e);
        }
        ...
        h a10 = new h.b().e(fVar.f12391d, g0.f48529d).b(fVar.f12396q).c(fVar.f12397r).d(si.e.l(fVar.f12400u)).a(h0Var);
        a10.F(0, fVar.c());
        return a10;
    }
    ...
    public v a(MediaItem mediaItem) {
        ...
        if (fVar != null && w0.f39606a >= 18) {
            synchronized (this.f48587a) {
                try {
                    if (!w0.c(fVar, this.f48588b)) {
                        this.f48588b = fVar;
                        this.f48589c = b(fVar);
                    }
                    vVar = (v) oe.a.e(this.f48589c);
                } catch (Throwable th2) {
                    throw th2;
                }
            }
