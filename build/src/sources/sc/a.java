...
public class a extends f implements g {
    ...
    public a(Call.Factory factory, String str, CacheControl cacheControl, g.C0160g c0160g) {
        this(factory, str, cacheControl, c0160g, null);
    }
    ...
    private Request u(com.google.android.exoplayer2.upstream.a aVar) {
        ...
        if (m10 != null) {
            ...
            } else if (aVar.f12945c == 2) {
                requestBody = RequestBody.create((MediaType) null, w0.f40202f);
            }
