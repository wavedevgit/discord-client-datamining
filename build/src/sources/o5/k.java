...
public class k extends g {
    ...
    private final PointF f41560i;

    public k(List list) {
        super(list);
        this.f41560i = new PointF();
    }
    ...
    public PointF j(y5.a aVar, float f10, float f11, float f12) {
        ...
        if (obj2 != null && (obj = aVar.f55029c) != null) {
            ...
            if (cVar != null && (pointF = (PointF) cVar.b(aVar.f55033g, aVar.f55034h.floatValue(), pointF2, pointF3, f10, e(), f())) != null) {
                return pointF;
            }
            PointF pointF4 = this.f41560i;
            float f13 = pointF2.x;
