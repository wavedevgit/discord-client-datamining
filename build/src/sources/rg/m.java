...
public abstract class m extends o implements Serializable {
    ...
    /* renamed from: i */
    private transient Map f46994i;

    /* renamed from: o */
    private transient int f46995o;
    ...
    public final boolean b(Object obj, Object obj2) {
        Collection collection = (Collection) this.f46994i.get(obj);
        if (collection == null) {
            Collection g10 = g();
            if (g10.add(obj2)) {
                this.f46995o++;
                this.f46994i.put(obj, g10);
                return true;
            }
    ...
    @Override // rg.o
    final Map e() {
        return new e(this, this.f46994i);
    }

    @Override // rg.o
    final Set f() {
        return new g(this, this.f46994i);
    }
    ...
    public final void o() {
        for (Collection collection : this.f46994i.values()) {
            collection.clear();
        }
        this.f46994i.clear();
        this.f46995o = 0;
