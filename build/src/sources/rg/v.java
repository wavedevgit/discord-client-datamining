...
final class v extends AbstractSet {
    ...
    public final boolean contains(Object obj) {
        int z10;
        Map o10 = this.f47769d.o();
        if (o10 != null) {
            return o10.entrySet().contains(obj);
        }
        if (obj instanceof Map.Entry) {
            Map.Entry entry = (Map.Entry) obj;
            z10 = this.f47769d.z(entry.getKey());
            if (z10 != -1 && dl.a(c0.m(this.f47769d, z10), entry.getValue())) {
                return true;
            }
        }
        return false;
    ...
    public final boolean remove(Object obj) {
        ...
        if (obj instanceof Map.Entry) {
            ...
            if (!c0Var.u()) {
                ...
                if (b11 != -1) {
                    this.f47769d.t(b11, y10);
                    c0 c0Var3 = this.f47769d;
                    i10 = c0Var3.f47164q;
                    c0Var3.f47164q = i10 - 1;
                    this.f47769d.r();
                    return true;
                }
                return false;
