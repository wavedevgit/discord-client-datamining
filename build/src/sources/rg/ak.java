...
public final class ak implements lj {
    ...
    private final ke f46564a;

    /* renamed from: b  reason: collision with root package name */
    private ki f46565b = new ki();
    ...
    public final byte[] a(int i10, boolean z10) {
        ...
        this.f46565b.e(Boolean.FALSE);
        this.f46564a.i(this.f46565b.m());
        try {
            jk.a();
            if (i10 == 0) {
                return new dj.d().j(cc.f46615a).k(true).i().b(this.f46564a.j()).getBytes("utf-8");
            }
            me j10 = this.f46564a.j();
            e2 e2Var = new e2();
            cc.f46615a.a(e2Var);
