...
public final class c {
    ...
    public static final class a extends Lambda implements Function0 {
        ...
        final /* synthetic */ Function0 f56025d;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        a(Function0 function0) {
            super(0);
            this.f56025d = function0;
        }

        @Override // kotlin.jvm.functions.Function0
        /* renamed from: a */
        public final File invoke() {
            File file = (File) this.f56025d.invoke();
            String s10 = j.s(file);
            h hVar = h.f56030a;
    ...
    public final w2.f a(x2.b bVar, List migrations, CoroutineScope scope, Function0 produceFile) {
        ...
        return new b(w2.g.f53095a.a(h.f56030a, bVar, migrations, scope, new a(produceFile)));
    }
}
