...
public class f extends b {
    ...
    private final a f28571j;

    /* renamed from: k  reason: collision with root package name */
    private Network f28572k;

    /* renamed from: l  reason: collision with root package name */
    private NetworkCapabilities f28573l;

    /* loaded from: /home/runner/work/discord-client-datamining/discord-client-datamining/build/classes4.dex */
    private class a extends ConnectivityManager.NetworkCallback {
        @Override // android.net.ConnectivityManager.NetworkCallback
        public void onAvailable(Network network) {
            f.this.f28572k = network;
        ...
        public void onCapabilitiesChanged(Network network, NetworkCapabilities networkCapabilities) {
            f.this.f28572k = network;
            f.this.f28573l = networkCapabilities;
            f.this.s();
        }

        @Override // android.net.ConnectivityManager.NetworkCallback
        public void onLinkPropertiesChanged(Network network, LinkProperties linkProperties) {
            if (f.this.f28572k != null) {
                f.this.f28572k = network;
            }
            f.this.q(h.DEFAULT_SWIPE_ANIMATION_DURATION);
        }
    ...
    public /* synthetic */ void r() {
        try {
            this.f28573l = c().getNetworkCapabilities(this.f28572k);
            s();
    ...
    public void g() {
        try {
            this.f28572k = c().getActiveNetwork();
            q(0);
            c().registerDefaultNetworkCallback(this.f28571j);
        } catch (SecurityException unused) {
        }
    }
    ...
    public void j() {
        try {
            c().unregisterNetworkCallback(this.f28571j);
    ...
    */
    void s() {
        /*
            ...
            android.net.Network r1 = r10.f28572k
            android.net.NetworkCapabilities r2 = r10.f28573l
            r3 = 0
            r4 = 0
            if (r2 == 0) goto L9a
            r5 = 2
