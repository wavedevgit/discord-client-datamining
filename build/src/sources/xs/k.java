...
public class k implements kotlinx.coroutines.d, d, l, w1 {
    ...
    private static final /* synthetic */ AtomicReferenceFieldUpdater f55291q = AtomicReferenceFieldUpdater.newUpdater(k.class, Object.class, "state$volatile");

    /* renamed from: d  reason: collision with root package name */
    private final CoroutineContext f55292d;

    /* renamed from: e  reason: collision with root package name */
    private List f55293e;

    /* renamed from: i  reason: collision with root package name */
    private Object f55294i;

    /* renamed from: o  reason: collision with root package name */
    private int f55295o;

    /* renamed from: p  reason: collision with root package name */
    private Object f55296p;
    ...
    public final class a {
        ...
        public final Object f55297a;

        /* renamed from: b  reason: collision with root package name */
        private final Function3 f55298b;

        /* renamed from: c  reason: collision with root package name */
        private final Function3 f55299c;

        /* renamed from: d  reason: collision with root package name */
        private final Object f55300d;

        /* renamed from: e  reason: collision with root package name */
        private final Object f55301e;

        /* renamed from: f  reason: collision with root package name */
        public final Function3 f55302f;

        /* renamed from: g  reason: collision with root package name */
        public Object f55303g;

        /* renamed from: h  reason: collision with root package name */
        public int f55304h = -1;

        public a(Object obj, Function3 function3, Function3 function32, Object obj2, Object obj3, Function3 function33) {
            this.f55297a = obj;
            this.f55298b = function3;
            this.f55299c = function32;
            this.f55300d = obj2;
            this.f55301e = obj3;
            this.f55302f = function33;
        }

        public final Function3 a(l lVar, Object obj) {
            Function3 function3 = this.f55302f;
            if (function3 != null) {
                return (Function3) function3.invoke(lVar, this.f55300d, obj);
            }
            return null;
        }

        public final void b() {
            Object obj = this.f55303g;
            k kVar = k.this;
            n0 n0Var = null;
            if (obj instanceof b0) {
                ((b0) obj).s(this.f55304h, null, kVar.getContext());
                return;
            }
        ...
        public final Object d(Object obj) {
            return this.f55299c.invoke(this.f55297a, this.f55300d, obj);
        }

        public final boolean e(k kVar) {
            e0 e0Var;
            this.f55298b.invoke(this.f55297a, kVar, this.f55300d);
            Object obj = kVar.f55296p;
            e0Var = m.f55314e;
            if (obj == e0Var) {
                return true;
            }
    ...
    public static final class b extends kotlin.coroutines.jvm.internal.d {
        ...
        public final Object invokeSuspend(Object obj) {
            this.f55307e = obj;
            this.f55309o |= Integer.MIN_VALUE;
    ...
    public k(CoroutineContext coroutineContext) {
        e0 e0Var;
        e0 e0Var2;
        this.f55292d = coroutineContext;
        e0Var = m.f55311b;
        this.state$volatile = e0Var;
        this.f55293e = new ArrayList(2);
        this.f55295o = -1;
        e0Var2 = m.f55314e;
        this.f55296p = e0Var2;
    }
    ...
    private final void l(a aVar) {
        ...
        AtomicReferenceFieldUpdater atomicReferenceFieldUpdater = f55291q;
        e0Var = m.f55312c;
    ...
    private final Object m(Continuation continuation) {
        Object obj = f55291q.get(this);
        Intrinsics.checkNotNull(obj, "null cannot be cast to non-null type kotlinx.coroutines.selects.SelectImplementation.ClauseData<R of kotlinx.coroutines.selects.SelectImplementation>");
        a aVar = (a) obj;
        Object obj2 = this.f55296p;
        l(aVar);
    ...
    */
    public final java.lang.Object q(kotlin.coroutines.Continuation r6) {
        /*
            r5 = this;
            boolean r0 = r6 instanceof xs.k.b
            if (r0 == 0) goto L13
            r0 = r6
            xs.k$b r0 = (xs.k.b) r0
            int r1 = r0.f55309o
            ...
            goto L18
        L13:
            xs.k$b r0 = new xs.k$b
            r0.<init>(r6)
        L18:
            java.lang.Object r6 = r0.f55307e
        ...
        L2c:
            ...
            throw r6
        L34:
            java.lang.Object r2 = r0.f55306d
            xs.k r2 = (xs.k) r2
            kotlin.c.b(r6)
            goto L4b
        L3c:
        ...
        L57:
            return r6
        */
        throw new UnsupportedOperationException("Method not decompiled: xs.k.q(kotlin.coroutines.Continuation):java.lang.Object");
    }
    ...
    private final boolean t() {
        return f55291q.get(this) instanceof a;
    }
        ...
        while (true) {
            ...
            if (!(obj3 instanceof CancellableContinuation)) {
                ...
                if (!Intrinsics.areEqual(obj3, e0Var2) && !(obj3 instanceof a)) {
                    ...
                    if (!Intrinsics.areEqual(obj3, e0Var3)) {
                        ...
                        if (Intrinsics.areEqual(obj3, e0Var4)) {
                            if (androidx.concurrent.futures.b.a(f55291q, this, obj3, CollectionsKt.e(obj))) {
                                return 1;
                            }
                        } else if (obj3 instanceof List) {
                            if (androidx.concurrent.futures.b.a(f55291q, this, obj3, CollectionsKt.M0((Collection) obj3, obj))) {
                                return 1;
                            }
                        } else {
                ...
                if (r10 == null) {
                    ...
                    if (androidx.concurrent.futures.b.a(f55291q, this, obj3, r10)) {
                        this.f55296p = obj2;
    ...
    */
    private final java.lang.Object z(kotlin.coroutines.Continuation r6) {
        /*
            ...
            kotlin.coroutines.Continuation r1 = xr.b.c(r6)
            r2 = 1
            r0.<init>(r1, r2)
            r0.H()
        ...
        L41:
            ...
            goto L41
        L4f:
            boolean r1 = r2 instanceof xs.k.a
            if (r1 == 0) goto L79
            kotlin.Unit r1 = kotlin.Unit.f31765a
            xs.k$a r2 = (xs.k.a) r2
        ...
        L79:
            ...
            throw r6
        */
        throw new UnsupportedOperationException("Method not decompiled: xs.k.z(kotlin.coroutines.Continuation):java.lang.Object");
    }
    ...
    @Override // xs.d
    public void f(h hVar, Function2 function2) {
    ...
    public final void u(a aVar, boolean z10) {
        if (f55291q.get(this) instanceof a) {
            return;
        }
        if (!z10) {
            k(aVar.f55297a);
        ...
        if (aVar.e(this)) {
            ...
            aVar.f55303g = this.f55294i;
            aVar.f55304h = this.f55295o;
            this.f55294i = null;
            this.f55295o = -1;
            return;
        }
        f55291q.set(this, aVar);
    }
