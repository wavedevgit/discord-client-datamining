...
public abstract class m {
    ...
    private static final zs.q f54195a = new zs.q(new zs.x(new MutablePropertyReference1Impl() { // from class: xs.m.a
    ...
    private static final k f54196b = new k(null, null, null, null, 15, null);
}
