...
public abstract class p {
    public static final void a(o oVar, Function1[] alternativeFormats, Function1 primaryFormat) {
        ...
        if (oVar instanceof b) {
            ((b) oVar).i((Function1[]) Arrays.copyOf(alternativeFormats, alternativeFormats.length), (Function1) TypeIntrinsics.beforeCheckcastToFunctionOfArity(primaryFormat, 1));
            return;
        }
