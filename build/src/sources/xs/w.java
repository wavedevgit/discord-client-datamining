...
public abstract class w {
    ...
    public static final KSerializer b(dt.b bVar, Type type) {
        return x.d(bVar, type);
    }

    public static final KSerializer c(dt.b bVar, KType kType) {
    ...
    public static final KSerializer e(dt.b bVar, Type type) {
        return x.h(bVar, type);
    }

    public static final KSerializer f(dt.b bVar, KType kType) {
    ...
    public static final List h(dt.b bVar, List list, boolean z10) {
