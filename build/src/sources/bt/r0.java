...
final class r0 implements KType {
    ...
    public boolean equals(Object obj) {
        ...
        if (classifier instanceof KClass) {
            ...
            if (dVar != null && (dVar instanceof KClass)) {
                return Intrinsics.areEqual(wr.a.b((KClass) classifier), wr.a.b((KClass) dVar));
            }
        }
        return false;
    }
    ...
    public List getAnnotations() {
        return this.f7690d.getAnnotations();
    }

    @Override // kotlin.reflect.KType
    public List getArguments() {
        return this.f7690d.getArguments();
    }

    @Override // kotlin.reflect.KType
    public kotlin.reflect.d getClassifier() {
        return this.f7690d.getClassifier();
    }
    ...
    public boolean isMarkedNullable() {
        return this.f7690d.isMarkedNullable();
    }

    public String toString() {
        return "KTypeWrapper: " + this.f7690d;
    }
}
