...
public abstract class d1 extends a {
    ...
    private final KSerializer f7608a;

    /* renamed from: b  reason: collision with root package name */
    private final KSerializer f7609b;
    ...
    public final void h(kotlinx.serialization.encoding.c decoder, int i10, Map builder, boolean z10) {
        ...
        Intrinsics.checkNotNullParameter(decoder, "decoder");
        Intrinsics.checkNotNullParameter(builder, "builder");
        Object c11 = c.a.c(decoder, getDescriptor(), i10, this.f7608a, null, 8, null);
        if (z10) {
        ...
        int i12 = i11;
        if (builder.containsKey(c11) && !(this.f7609b.getDescriptor().getKind() instanceof at.e)) {
            c10 = decoder.y(getDescriptor(), i12, this.f7609b, kotlin.collections.o0.j(builder, c11));
        } else {
            c10 = c.a.c(decoder, getDescriptor(), i12, this.f7609b, null, 8, null);
        }
        builder.put(c11, c10);
    }
    ...
    private d1(KSerializer kSerializer, KSerializer kSerializer2) {
        super(null);
        this.f7608a = kSerializer;
        this.f7609b = kSerializer2;
    }
}
