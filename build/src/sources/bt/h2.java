...
public abstract class h2 {
    ...
    private static final Map f7628a = t1.i();

    public static final SerialDescriptor a(String serialName, at.e kind) {
    ...
    public static final KSerializer b(KClass kClass) {
        ...
        return (KSerializer) f7628a.get(kClass);
    }

    private static final void c(String str) {
        for (KSerializer kSerializer : f7628a.values()) {
