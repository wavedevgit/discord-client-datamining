...
public abstract class x0 implements SerialDescriptor {
    ...
    private final SerialDescriptor f7718a;
    ...
    public boolean equals(Object obj) {
        ...
        x0 x0Var = (x0) obj;
        if (Intrinsics.areEqual(this.f7718a, x0Var.f7718a) && Intrinsics.areEqual(h(), x0Var.h())) {
            return true;
        }
        return false;
    }
    ...
    public int hashCode() {
        return (this.f7718a.hashCode() * 31) + h().hashCode();
    }
    ...
    public String toString() {
        return h() + '(' + this.f7718a + ')';
    }

    private x0(SerialDescriptor serialDescriptor) {
        this.f7718a = serialDescriptor;
        this.f7719b = 1;
    }
}
