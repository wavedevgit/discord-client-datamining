...
public class b0 extends ct.b implements MutableSharedFlow, bt.c, ct.q {
    ...
    private final at.a f7528r;

    /* renamed from: s  reason: collision with root package name */
    private Object[] f7529s;
    ...
    /* loaded from: /home/runner/work/discord-client-datamining/discord-client-datamining/build/classes5.dex */
    public static final class a implements ys.n0 {
        ...
        public final Object f7536i;

        /* renamed from: o  reason: collision with root package name */
        public final Continuation f7537o;

        public a(b0 b0Var, long j10, Object obj, Continuation continuation) {
            this.f7534d = b0Var;
            this.f7535e = j10;
            this.f7536i = obj;
            this.f7537o = continuation;
        }
    ...
    public /* synthetic */ class b {
        ...
        static {
            ...
            try {
                iArr[at.a.f6104d.ordinal()] = 1;
            } catch (NoSuchFieldError unused) {
            }
            try {
                iArr[at.a.f6106i.ordinal()] = 2;
            } catch (NoSuchFieldError unused2) {
            }
            try {
                iArr[at.a.f6105e.ordinal()] = 3;
    ...
    public b0(int i10, int i11, at.a aVar) {
        this.f7526p = i10;
        this.f7527q = i11;
        this.f7528r = aVar;
    }
    ...
    */
    static /* synthetic */ java.lang.Object A(bt.b0 r8, kotlinx.coroutines.flow.FlowCollector r9, kotlin.coroutines.Continuation r10) {
        /*
            Method dump skipped, instructions count: 224
            To view this dump add '--comments-level debug' option
        */
        throw new UnsupportedOperationException("Method not decompiled: bt.b0.A(bt.b0, kotlinx.coroutines.flow.FlowCollector, kotlin.coroutines.Continuation):java.lang.Object");
    }

    private final void B(long j10) {
        ct.d[] c10;
        if (ct.b.a(this) != 0 && (c10 = ct.b.c(this)) != null) {
            for (ct.d dVar : c10) {
                if (dVar != null) {
                    d0 d0Var = (d0) dVar;
                    long j11 = d0Var.f7552a;
                    if (j11 >= 0 && j11 < j10) {
                        d0Var.f7552a = j10;
                    }
                }
            ...
            try {
                ...
                for (Continuation continuation2 : I) {
                    if (continuation2 != null) {
                        ...
                        continuation2.resumeWith(Result.b(Unit.f32556a));
                    }
                }
                Object B = eVar.B();
                if (B == gs.b.f()) {
    ...
    public final Continuation[] I(Continuation[] continuationArr) {
        ...
        if (ct.b.a(this) != 0 && (c10 = ct.b.c(this)) != null) {
            ...
            while (i10 < length2) {
                ct.d dVar = c10[i10];
                if (dVar != null && (continuation = (d0Var = (d0) dVar).f7553b) != null && T(d0Var) >= 0) {
    ...
    private final long J() {
        return K() + this.f7532v;
    }

    /* JADX INFO: Access modifiers changed from: private */
    public final long K() {
        return Math.min(this.f7531u, this.f7530t);
    }
    ...
    private final long N() {
        return K() + this.f7532v + this.f7533w;
    }

    private final int O() {
        return (int) ((K() + this.f7532v) - this.f7530t);
    }

    /* JADX INFO: Access modifiers changed from: private */
    public final int P() {
        return this.f7532v + this.f7533w;
    }
    ...
    public final boolean R(Object obj) {
        ...
        if (this.f7532v >= this.f7527q && this.f7531u <= this.f7530t) {
            int i10 = b.f7538a[this.f7528r.ordinal()];
            if (i10 != 1) {
                if (i10 == 2) {
                    return true;
                }
        ...
        H(obj);
        int i11 = this.f7532v + 1;
        this.f7532v = i11;
        if (i11 > this.f7527q) {
            E();
        }
        if (O() > this.f7526p) {
            V(this.f7530t + 1, this.f7531u, J(), N());
        }
        return true;
    }
    ...
    private final boolean S(Object obj) {
        ...
        H(obj);
        int i10 = this.f7532v + 1;
        this.f7532v = i10;
        if (i10 > this.f7526p) {
            E();
        }
        this.f7531u = K() + this.f7532v;
        return true;
    }

    /* JADX INFO: Access modifiers changed from: private */
    public final long T(d0 d0Var) {
        long j10 = d0Var.f7552a;
        if (j10 >= J() && (this.f7527q > 0 || j10 > K() || this.f7533w == 0)) {
            return -1L;
        }
        return j10;
    }
    ...
    private final void V(long j10, long j11, long j12, long j13) {
        ...
        this.f7530t = j10;
        this.f7531u = j11;
        this.f7532v = (int) (j12 - min);
        this.f7533w = (int) (j13 - j12);
    }
    ...
    private final void z() {
        Object f10;
        if (this.f7527q != 0 || this.f7533w > 1) {
            Object[] objArr = this.f7529s;
            Intrinsics.checkNotNull(objArr);
            while (this.f7533w > 0) {
    ...
    public final Object L() {
        ...
        Object[] objArr = this.f7529s;
        Intrinsics.checkNotNull(objArr);
        f10 = c0.f(objArr, (this.f7530t + O()) - 1);
        return f10;
    }
    ...
    public final Continuation[] W(long j10) {
        ...
        if (this.f7527q == 0 && this.f7533w > 0) {
            j15++;
        }
        if (ct.b.a(this) != 0 && (c10 = ct.b.c(this)) != null) {
            for (ct.d dVar : c10) {
                if (dVar != null) {
                    long j16 = ((d0) dVar).f7552a;
                    if (j16 >= 0 && j16 < j15) {
                        j15 = j16;
                    }
                }
        ...
        long J = J();
        if (l() > 0) {
            i10 = Math.min(this.f7533w, this.f7527q - ((int) (J - j15)));
        } else {
            i10 = this.f7533w;
        }
        Continuation[] continuationArr = ct.c.f21024a;
        ...
        long max = Math.max(this.f7530t, J - Math.min(this.f7526p, i13));
        if (this.f7527q == 0 && max < j17) {
            Object[] objArr2 = this.f7529s;
            Intrinsics.checkNotNull(objArr2);
            f10 = c0.f(objArr2, max);
            if (Intrinsics.areEqual(f10, c0.f7546a)) {
                J += j13;
                max += j13;
            }
        }
