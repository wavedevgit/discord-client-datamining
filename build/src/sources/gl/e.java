...
public class e {
    ...
    private static final b f25772e = new b();

    /* renamed from: a  reason: collision with root package name */
    private final ok.b f25773a;

    /* renamed from: c  reason: collision with root package name */
    private boolean f25775c;

    /* renamed from: b  reason: collision with root package name */
    private final List f25774b = new ArrayList();

    /* renamed from: d  reason: collision with root package name */
    private final int[] f25776d = new int[5];
    ...
    private boolean b(int i10, int i11) {
        ...
        int[] k10 = k();
        int i15 = 0;
        while (i10 >= i15 && i11 >= i15 && this.f25773a.e(i11 - i15, i10 - i15)) {
            k10[2] = k10[2] + 1;
            i15++;
        }
        if (k10[2] == 0) {
        ...
        int h10 = this.f25773a.h();
        int l10 = this.f25773a.l();
        int i16 = 1;
        while (true) {
            int i17 = i10 + i16;
            if (i17 >= h10 || (i14 = i11 + i16) >= l10 || !this.f25773a.e(i14, i17)) {
                break;
            }
            k10[2] = k10[2] + 1;
            i16++;
        ...
        while (true) {
            int i18 = i10 + i16;
            if (i18 >= h10 || (i13 = i11 + i16) >= l10 || this.f25773a.e(i13, i18)) {
                break;
            }
            k10[3] = k10[3] + 1;
            i16++;
        ...
        while (true) {
            int i19 = i10 + i16;
            if (i19 >= h10 || (i12 = i11 + i16) >= l10 || !this.f25773a.e(i12, i19)) {
                break;
            }
            k10[4] = k10[4] + 1;
            i16++;
    ...
    */
    private float c(int r11, int r12, int r13, int r14) {
        ...
        Lbf:
            return r6
        */
        throw new UnsupportedOperationException("Method not decompiled: gl.e.c(int, int, int, int):float");
    }
    ...
    */
    private float d(int r11, int r12, int r13, int r14) {
        ...
        Lc0:
            return r6
        */
        throw new UnsupportedOperationException("Method not decompiled: gl.e.d(int, int, int, int):float");
    }
    ...
    private int h() {
        if (this.f25774b.size() <= 1) {
            return 0;
        }
        d dVar = null;
        for (d dVar2 : this.f25774b) {
            if (dVar2.h() >= 2) {
                if (dVar == null) {
                    dVar = dVar2;
                } else {
    ...
    private boolean m() {
        int size = this.f25774b.size();
        float f10 = 0.0f;
        int i10 = 0;
        float f11 = 0.0f;
        for (d dVar : this.f25774b) {
            if (dVar.h() >= 2) {
                i10++;
                f11 += dVar.i();
            }
    ...
    */
    private gl.d[] n() {
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: gl.e.n():gl.d[]");
    }
    ...
    public final f g(Map map) {
        boolean z10;
        if (map != null && map.containsKey(kk.e.TRY_HARDER)) {
            z10 = true;
        } else {
            z10 = false;
        }
    ...
    protected final boolean l(int[] iArr, int i10, int i11) {
        ...
        if (!Float.isNaN(d10)) {
            ...
            if (!Float.isNaN(c10) && b(i14, (int) c10)) {
                float f10 = i13 / 7.0f;
                while (true) {
                    if (i12 < this.f25774b.size()) {
                        d dVar = (d) this.f25774b.get(i12);
                        if (dVar.f(f10, d10, c10)) {
                            this.f25774b.set(i12, dVar.g(d10, c10, f10));
                            break;
                        }
                        i12++;
                    } else {
                        this.f25774b.add(new d(c10, d10, f10));
                        break;
                    }
                }
                return true;
