...
public final class m implements h {
    ...
    private final char f49163d;

    /* renamed from: e  reason: collision with root package name */
    private final char f49164e;

    /* renamed from: i  reason: collision with root package name */
    private final String f49165i;

    /* renamed from: o  reason: collision with root package name */
    private final pt.c f49166o;

    /* renamed from: p  reason: collision with root package name */
    private final boolean f49167p;

    /* renamed from: q  reason: collision with root package name */
    private final boolean f49168q;

    /* renamed from: r  reason: collision with root package name */
    private final boolean f49169r;
    ...
    public m(String str) {
        if (!str.isEmpty()) {
            ...
            if (charAt >= ' ') {
                boolean z10 = true;
                this.f49167p = true;
                this.f49168q = (str.length() == 1 && i(charAt)) ? z10 : false;
                this.f49169r = false;
                return;
            }
    ...
    private void j(CharSequence charSequence, s sVar) {
        int f10 = sVar.f();
        sVar.k(f10, "Cannot parse: \"" + charSequence + "\" (expected: [" + this.f49165i + "], found: [" + charSequence.subSequence(f10, Math.min(this.f49165i.length() + f10, charSequence.length())) + "])");
    }
    ...
    */
    private void k(java.lang.CharSequence r9, rt.s r10, pt.d r11, boolean r12) {
        /*
            r8 = this;
            int r0 = r10.f()
            char r1 = r8.f49163d
        ...
        L67:
            if (r6 == 0) goto L8b
            if (r12 == 0) goto L6e
            boolean r11 = r8.f49167p
            goto L7c
        L6e:
            pt.c r12 = qt.a.f48094i
        ...
        Lba:
            ...
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: rt.m.k(java.lang.CharSequence, rt.s, pt.d, boolean):void");
    }

    private void l(CharSequence charSequence, s sVar, pt.d dVar, boolean z10) {
        boolean booleanValue;
        boolean q10;
        int f10 = sVar.f();
        if (z10) {
            booleanValue = this.f49167p;
        } else {
        ...
        if (z10) {
            ...
            q10 = qt.b.q((Locale) dVar.a(qt.a.f48088c, Locale.ROOT));
        }
        int m10 = m(charSequence, f10, this.f49165i, booleanValue, q10);
        if (m10 == -1) {
            j(charSequence, sVar);
        } else {
            sVar.l(f10 + m10);
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    public int c() {
        String str = this.f49165i;
        if (str == null) {
            return 0;
        }
        int length = str.length();
        int i10 = 0;
        for (int i11 = 0; i11 < length && Character.isDigit(this.f49165i.charAt(i11)); i11++) {
            i10++;
        }
        return i10;
    }
    ...
    public void d(CharSequence charSequence, s sVar, pt.d dVar, t tVar, boolean z10) {
        if (z10 && this.f49168q) {
            int f10 = sVar.f();
            if (f10 < charSequence.length() && charSequence.charAt(f10) == this.f49163d) {
                sVar.l(f10 + 1);
            } else if (this.f49163d == '.' && ((Boolean) dVar.a(qt.a.f48096k, Boolean.TRUE)).booleanValue()) {
            } else {
                j(charSequence, sVar);
            }
        } else if (this.f49165i == null) {
    ...
    public h e(c cVar, pt.d dVar, int i10) {
        boolean z10;
        boolean q10 = qt.b.q((Locale) dVar.a(qt.a.f48088c, Locale.ROOT));
        char c10 = this.f49163d;
        char c11 = this.f49164e;
        String str = this.f49165i;
        pt.c cVar2 = this.f49166o;
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof m) {
            m mVar = (m) obj;
            pt.c cVar = this.f49166o;
            if (cVar != null) {
                return cVar.equals(mVar.f49166o);
            }
            String str = this.f49165i;
            if (str == null) {
                if (mVar.f49165i == null && this.f49163d == mVar.f49163d && this.f49164e == mVar.f49164e) {
                    return true;
                }
                return false;
            } else if (str.equals(mVar.f49165i) && this.f49168q == mVar.f49168q) {
                return true;
            }
        }
        return false;
    ...
    public int f(pt.o oVar, Appendable appendable, pt.d dVar, Set set, boolean z10) {
        ...
        String str = this.f49165i;
        if (str == null) {
            appendable.append(this.f49163d);
            return 1;
        }
        appendable.append(str);
        return this.f49165i.length();
    }

    @Override // rt.h
    public boolean g() {
        if (this.f49165i == null || c() != this.f49165i.length()) {
            return false;
        }
        return true;
    }
    ...
    public int hashCode() {
        ...
        return name.hashCode() ^ this.f49163d;
    }
    ...
    public String toString() {
        ...
        if (this.f49166o != null) {
            sb2.append('{');
            sb2.append(this.f49166o);
            sb2.append('}');
        } else {
            String str = this.f49165i;
            if (str == null) {
                sb2.append(this.f49163d);
                if (this.f49164e != this.f49163d) {
    ...
    private m(char c10, char c11, String str, pt.c cVar, boolean z10, boolean z11, boolean z12) {
        this.f49163d = c10;
        this.f49164e = c11;
        this.f49165i = str;
        this.f49166o = cVar;
