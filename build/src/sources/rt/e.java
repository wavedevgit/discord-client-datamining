...
public abstract class e {
    ...
    public static final e f49336d;

    /* renamed from: e  reason: collision with root package name */
    public static final e f49337e;

    /* renamed from: i  reason: collision with root package name */
    public static final e f49338i;

    /* renamed from: o  reason: collision with root package name */
    public static final e f49339o;

    /* renamed from: p  reason: collision with root package name */
    private static final int[] f49340p;

    /* renamed from: q  reason: collision with root package name */
    private static final double[] f49341q;

    /* renamed from: r  reason: collision with root package name */
    private static final double[] f49342r;

    /* renamed from: s  reason: collision with root package name */
    private static final double[][] f49343s;

    /* renamed from: t  reason: collision with root package name */
    private static final /* synthetic */ e[] f49344t;
    ...
    enum a extends e {
        ...
        private double n(double d10) {
            i0 t02 = rt.c.f(d10).h().t0(p.f38781v);
            return t02.V().B0() + (((Integer) t02.X().t(g0.K)).intValue() / 86400.0d);
        }

        private double o(double d10) {
            double d11 = (d10 * 0.9856d) - 3.289d;
            return rt.a.b((Math.sin(Math.toRadians(d11)) * 1.916d) + d11 + (Math.sin(Math.toRadians(d11) * 2.0d) * 0.02d) + 282.634d);
        }
        ...
        public double l(double d10) {
            double o10 = o(n(d10));
            double b10 = rt.a.b(Math.toDegrees(Math.atan(Math.tan(Math.toRadians(o10)) * 0.91764d)));
    ...
    static {
        ...
        f49336d = aVar;
        e eVar = new e("NOAA", 1) { // from class: rt.e.b
            private double n(double d10) {
            ...
            public double l(double d10) {
                ...
                return rt.a.b(Math.toDegrees(Math.atan2(Math.cos(Math.toRadians(s(m10))) * Math.sin(radians), Math.cos(radians))));
            }
        };
        f49337e = eVar;
        e eVar2 = new e("CC", 2) { // from class: rt.e.c
            private double n(double d10) {
            ...
            public double h(double d10, String str) {
                ...
                if (str.equals("right-ascension")) {
                    ...
                    return rt.a.b(Math.toDegrees(Math.atan2(Math.cos(Math.toRadians(r(m10))) * Math.sin(radians), Math.cos(radians))));
        ...
        f49338i = eVar2;
        e eVar3 = new e("TIME4J", 3) { // from class: rt.e.d
            private double n(double d10) {
            ...
            public double h(double d10, String str) {
                ...
                if (str.equals("right-ascension")) {
                    ...
                    return rt.a.b(Math.toDegrees(Math.atan2(Math.cos(Math.toRadians(e.i(m10) + dArr[1])) * Math.sin(radians), Math.cos(radians))));
                } else if (str.equals("nutation")) {
    ...
    public static double f(double d10, double d11) {
        double d12 = 0.0d;
        for (int length = f49340p.length - 1; length >= 0; length--) {
            d12 += f49340p[length] * Math.sin(Math.toRadians(f49341q[length] + (f49342r[length] * d10)));
        }
    ...
    static void k(double d10, double[] dArr) {
        ...
        double d11 = 0.0d;
        double d12 = 0.0d;
        for (int length = f49343s.length - 1; length >= 0; length--) {
            double[] dArr2 = f49343s[length];
