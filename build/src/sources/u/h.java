...
public class h {
    ...
    private final CaptureSessionOnClosedNotCalledQuirk f50023a;
    ...
    public h(d2 d2Var) {
        this.f50023a = (CaptureSessionOnClosedNotCalledQuirk) d2Var.b(CaptureSessionOnClosedNotCalledQuirk.class);
    }
