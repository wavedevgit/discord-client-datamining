...
public class h {
    ...
    private final CaptureSessionOnClosedNotCalledQuirk f51138a;
    ...
    public h(d2 d2Var) {
        this.f51138a = (CaptureSessionOnClosedNotCalledQuirk) d2Var.b(CaptureSessionOnClosedNotCalledQuirk.class);
    }
