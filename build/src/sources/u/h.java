...
public class h {
    ...
    private final CaptureSessionOnClosedNotCalledQuirk f50310a;
    ...
    public h(d2 d2Var) {
        this.f50310a = (CaptureSessionOnClosedNotCalledQuirk) d2Var.b(CaptureSessionOnClosedNotCalledQuirk.class);
    }
