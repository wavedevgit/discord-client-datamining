...
public class h {
    ...
    private final CaptureSessionOnClosedNotCalledQuirk f50886a;
    ...
    public h(d2 d2Var) {
        this.f50886a = (CaptureSessionOnClosedNotCalledQuirk) d2Var.b(CaptureSessionOnClosedNotCalledQuirk.class);
    }
