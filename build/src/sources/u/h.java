...
public class h {
    ...
    private final CaptureSessionOnClosedNotCalledQuirk f50307a;
    ...
    public h(d2 d2Var) {
        this.f50307a = (CaptureSessionOnClosedNotCalledQuirk) d2Var.b(CaptureSessionOnClosedNotCalledQuirk.class);
    }
