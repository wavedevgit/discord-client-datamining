...
public class h {
    ...
    private final CaptureSessionOnClosedNotCalledQuirk f51079a;
    ...
    public h(d2 d2Var) {
        this.f51079a = (CaptureSessionOnClosedNotCalledQuirk) d2Var.b(CaptureSessionOnClosedNotCalledQuirk.class);
    }
