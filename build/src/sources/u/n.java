...
public class n {
    ...
    private final ExtraSupportedOutputSizeQuirk f50317b = (ExtraSupportedOutputSizeQuirk) androidx.camera.camera2.internal.compat.quirk.b.b(ExtraSupportedOutputSizeQuirk.class);
    ...
    public n(String str) {
        this.f50316a = str;
        this.f50318c = new e(str);
    }

    private void a(List list, int i10) {
        ExtraSupportedOutputSizeQuirk extraSupportedOutputSizeQuirk = this.f50317b;
