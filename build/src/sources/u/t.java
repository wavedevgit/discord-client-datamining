...
public class t {
    ...
    private final List f51096b = Collections.synchronizedList(new ArrayList());
    ...
    public static class a extends CameraCaptureSession.CaptureCallback {
        ...
        /* renamed from: a  reason: collision with root package name */
        final ListenableFuture f51097a = androidx.concurrent.futures.c.a(new c.InterfaceC0029c() { // from class: u.s
    ...
    public static /* synthetic */ void a(t tVar, a aVar, ListenableFuture listenableFuture) {
        ...
        tVar.f51096b.remove(listenableFuture);
    }
    ...
    private CameraCaptureSession.CaptureCallback c() {
        final a aVar = new a();
        final ListenableFuture listenableFuture = aVar.f51097a;
        this.f51096b.add(listenableFuture);
    ...
    public ListenableFuture e() {
        if (this.f51096b.isEmpty()) {
            return d0.n.p(null);
        }
        return d0.n.s(d0.n.x(d0.n.w(new ArrayList(this.f51096b)), new Function() { // from class: u.q
    ...
    public void g() {
        LinkedList linkedList = new LinkedList(this.f51096b);
