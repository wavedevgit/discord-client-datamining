...
public final class f0 implements Collection, KMappedMarker {
    ...
    public static final class a implements Iterator, KMappedMarker {
        ...
        public short a() {
            ...
            short[] sArr = this.f49196d;
            if (i10 < sArr.length) {
                this.f49197e = i10 + 1;
                return e0.d(sArr[i10]);
            }
            throw new NoSuchElementException(String.valueOf(this.f49197e));
        }

        @Override // java.util.Iterator
        public boolean hasNext() {
            if (this.f49197e < this.f49196d.length) {
                return true;
            }
            return false;
        }
    ...
    */
    public static boolean g(short[] r3, java.util.Collection r4) {
        ...
        L16:
            ...
            boolean r2 = r0 instanceof rr.e0
            if (r2 == 0) goto L31
            rr.e0 r0 = (rr.e0) r0
            short r0 = r0.h()
        ...
        L33:
            return r1
        */
        throw new UnsupportedOperationException("Method not decompiled: rr.f0.g(short[], java.util.Collection):boolean");
    }
    ...
    public boolean containsAll(Collection elements) {
        ...
        return g(this.f49195d, elements);
    }

    public boolean e(short s10) {
        return f(this.f49195d, s10);
    }

    @Override // java.util.Collection
    public boolean equals(Object obj) {
        return h(this.f49195d, obj);
    }

    @Override // java.util.Collection
    public int hashCode() {
        return o(this.f49195d);
    }

    @Override // java.util.Collection
    public boolean isEmpty() {
        return p(this.f49195d);
    }

    @Override // java.util.Collection, java.lang.Iterable
    public Iterator iterator() {
        return q(this.f49195d);
    }

    @Override // java.util.Collection
    /* renamed from: j */
    public int size() {
        return l(this.f49195d);
    }
