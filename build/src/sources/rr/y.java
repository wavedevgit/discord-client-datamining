...
public final class y implements Collection, KMappedMarker {
    ...
    public static final class a implements Iterator, KMappedMarker {
        ...
        public byte a() {
            ...
            byte[] bArr = this.f49228d;
            if (i10 < bArr.length) {
                this.f49229e = i10 + 1;
                return x.d(bArr[i10]);
            }
            throw new NoSuchElementException(String.valueOf(this.f49229e));
        }

        @Override // java.util.Iterator
        public boolean hasNext() {
            if (this.f49229e < this.f49228d.length) {
                return true;
            }
            return false;
        }
    ...
    */
    public static boolean g(byte[] r3, java.util.Collection r4) {
        ...
        L33:
            return r1
        */
        throw new UnsupportedOperationException("Method not decompiled: rr.y.g(byte[], java.util.Collection):boolean");
    }
    ...
    public boolean containsAll(Collection elements) {
        ...
        return g(this.f49227d, elements);
    }

    public boolean e(byte b10) {
        return f(this.f49227d, b10);
    }

    @Override // java.util.Collection
    public boolean equals(Object obj) {
        return h(this.f49227d, obj);
    }

    @Override // java.util.Collection
    public int hashCode() {
        return o(this.f49227d);
    }

    @Override // java.util.Collection
    public boolean isEmpty() {
        return p(this.f49227d);
    }

    @Override // java.util.Collection, java.lang.Iterable
    public Iterator iterator() {
        return q(this.f49227d);
    }

    @Override // java.util.Collection
    /* renamed from: j */
    public int size() {
        return l(this.f49227d);
    }
