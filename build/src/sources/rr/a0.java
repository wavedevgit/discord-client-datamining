...
public final class a0 implements Collection, KMappedMarker {
    ...
    public static final class a implements Iterator, KMappedMarker {
        ...
        public int a() {
            int i10 = this.f49181e;
            int[] iArr = this.f49180d;
            if (i10 < iArr.length) {
                this.f49181e = i10 + 1;
                return z.d(iArr[i10]);
            }
            throw new NoSuchElementException(String.valueOf(this.f49181e));
        }

        @Override // java.util.Iterator
        public boolean hasNext() {
            if (this.f49181e < this.f49180d.length) {
                return true;
            }
            return false;
        }
    ...
    */
    public static boolean g(int[] r3, java.util.Collection r4) {
        ...
        L33:
            return r1
        */
        throw new UnsupportedOperationException("Method not decompiled: rr.a0.g(int[], java.util.Collection):boolean");
    }

    public static boolean h(int[] iArr, Object obj) {
        if (!(obj instanceof a0) || !Intrinsics.areEqual(iArr, ((a0) obj).t())) {
            return false;
        }
        return true;
    }
    ...
    public boolean containsAll(Collection elements) {
        ...
        return g(this.f49179d, elements);
    }

    public boolean e(int i10) {
        return f(this.f49179d, i10);
    }

    @Override // java.util.Collection
    public boolean equals(Object obj) {
        return h(this.f49179d, obj);
    }

    @Override // java.util.Collection
    public int hashCode() {
        return o(this.f49179d);
    }

    @Override // java.util.Collection
    public boolean isEmpty() {
        return p(this.f49179d);
    }

    @Override // java.util.Collection, java.lang.Iterable
    public Iterator iterator() {
        return q(this.f49179d);
    }

    @Override // java.util.Collection
    /* renamed from: j */
    public int size() {
        return l(this.f49179d);
    }
