...
public final class c0 implements Collection, KMappedMarker {
    ...
    public static final class a implements Iterator, KMappedMarker {
        ...
        public long a() {
            ...
            long[] jArr = this.f49185d;
            if (i10 < jArr.length) {
                this.f49186e = i10 + 1;
                return b0.d(jArr[i10]);
            }
            throw new NoSuchElementException(String.valueOf(this.f49186e));
        }

        @Override // java.util.Iterator
        public boolean hasNext() {
            if (this.f49186e < this.f49185d.length) {
                return true;
            }
            return false;
        }
    ...
    */
    public static boolean g(long[] r4, java.util.Collection r5) {
        ...
        L16:
            ...
            boolean r2 = r0 instanceof rr.b0
            if (r2 == 0) goto L31
            rr.b0 r0 = (rr.b0) r0
            long r2 = r0.h()
        ...
        L33:
            return r1
        */
        throw new UnsupportedOperationException("Method not decompiled: rr.c0.g(long[], java.util.Collection):boolean");
    }
    ...
    public boolean containsAll(Collection elements) {
        ...
        return g(this.f49184d, elements);
    }

    public boolean e(long j10) {
        return f(this.f49184d, j10);
    }

    @Override // java.util.Collection
    public boolean equals(Object obj) {
        return h(this.f49184d, obj);
    }

    @Override // java.util.Collection
    public int hashCode() {
        return o(this.f49184d);
    }

    @Override // java.util.Collection
    public boolean isEmpty() {
        return p(this.f49184d);
    }

    @Override // java.util.Collection, java.lang.Iterable
    public Iterator iterator() {
        return q(this.f49184d);
    }

    @Override // java.util.Collection
    /* renamed from: j */
    public int size() {
        return l(this.f49184d);
    }
