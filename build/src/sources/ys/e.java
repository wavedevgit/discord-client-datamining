...
public final class e extends kotlinx.coroutines.a {
    ...
    private final Thread f56358o;

    /* renamed from: p  reason: collision with root package name */
    private final p0 f56359p;
    ...
    public void F(Object obj) {
        if (!Intrinsics.areEqual(Thread.currentThread(), this.f56358o)) {
            Thread thread = this.f56358o;
            b.a();
    ...
    public final Object c1() {
        ...
        b.a();
        try {
            p0 p0Var = this.f56359p;
            r rVar = null;
            if (p0Var != null) {
                p0.l2(p0Var, false, 1, null);
            }
            while (true) {
                p0 p0Var2 = this.f56359p;
                if (p0Var2 != null) {
                    j10 = p0Var2.t2();
                } else {
