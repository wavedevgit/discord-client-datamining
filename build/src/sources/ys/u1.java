...
public final class u1 extends dt.a0 {
    ...
    private final ThreadLocal f55826p;
    ...
    */
    public u1(kotlin.coroutines.CoroutineContext r3, kotlin.coroutines.Continuation r4) {
        ...
        Le:
            ...
            kotlin.coroutines.d$b r0 = kotlin.coroutines.d.f32059j
    ...
    private final void e1() {
        if (this.threadLocalIsSet) {
            Pair pair = (Pair) this.f55826p.get();
            if (pair != null) {
    ...
    protected void V0(Object obj) {
        e1();
        Object a10 = t.a(obj, this.f21867o);
        Continuation continuation = this.f21867o;
        CoroutineContext context = continuation.getContext();
        u1 u1Var = null;
        Object i10 = dt.l0.i(context, null);
        if (i10 != dt.l0.f21897a) {
            u1Var = x.m(continuation, context, i10);
        }
        try {
            this.f21867o.resumeWith(a10);
    ...
    public final boolean d1() {
        boolean z10;
        if (this.threadLocalIsSet && this.f55826p.get() == null) {
            z10 = true;
        } else {
            z10 = false;
        }
    ...
    public final void g1(CoroutineContext coroutineContext, Object obj) {
        ...
        this.f55826p.set(as.v.a(coroutineContext, obj));
    }
}
