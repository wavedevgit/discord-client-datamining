...
public abstract class g {
    ...
    private static final long f55597a = LocalDate.MIN.toEpochDay();

    /* renamed from: b  reason: collision with root package name */
    private static final long f55598b = LocalDate.MAX.toEpochDay();

    private static final LocalDate a(long j10) {
        long j11 = f55597a;
        if (j10 <= f55598b && j11 <= j10) {
    ...
    public static final f c(f fVar, long j10, c.b unit) {
        ...
        Intrinsics.checkNotNullParameter(unit, "unit");
        try {
            if (unit instanceof c.C0757c) {
                plusMonths = a(at.b.a(fVar.h().toEpochDay(), at.b.c(j10, ((c.C0757c) unit).d())));
            } else if (unit instanceof c.d) {
                plusMonths = fVar.h().plusMonths(at.b.c(j10, ((c.d) unit).d()));
            } else {
                throw new p();
            }
