...
public abstract class p0 extends CoroutineDispatcher {
    ...
    private long f55809i;

    /* renamed from: o  reason: collision with root package name */
    private boolean f55810o;

    /* renamed from: p  reason: collision with root package name */
    private ArrayDeque f55811p;
    ...
    public final void P1(boolean z10) {
        long a22 = this.f55809i - a2(z10);
        this.f55809i = a22;
        if (a22 <= 0 && this.f55810o) {
            shutdown();
        }
    }

    public final void c2(kotlinx.coroutines.m mVar) {
        ArrayDeque arrayDeque = this.f55811p;
        if (arrayDeque == null) {
            arrayDeque = new ArrayDeque();
            this.f55811p = arrayDeque;
        }
