...
public final class v extends kotlin.coroutines.jvm.internal.d implements FlowCollector, CoroutineStackFrame {
    ...
    public final FlowCollector f37618d;

    /* renamed from: e  reason: collision with root package name */
    public final CoroutineContext f37619e;

    /* renamed from: i  reason: collision with root package name */
    public final int f37620i;

    /* renamed from: o  reason: collision with root package name */
    private CoroutineContext f37621o;

    /* renamed from: p  reason: collision with root package name */
    private Continuation f37622p;

    public v(FlowCollector flowCollector, CoroutineContext coroutineContext) {
        super(r.f37612d, kotlin.coroutines.e.f33148d);
        this.f37618d = flowCollector;
        this.f37619e = coroutineContext;
        this.f37620i = ((Number) coroutineContext.A1(0, new Function2() { // from class: ls.u
    ...
    private final Object m(Continuation continuation, Object obj) {
        ...
        CoroutineContext coroutineContext = this.f37621o;
        if (coroutineContext != context) {
            k(context, coroutineContext, obj);
            this.f37621o = context;
        }
        this.f37622p = continuation;
        Function3 a10 = w.a();
        FlowCollector flowCollector = this.f37618d;
        ...
        if (!Intrinsics.areEqual(invoke, pr.b.f())) {
            this.f37622p = null;
        }
        return invoke;
    }
    ...
    private final void n(m mVar, Object obj) {
        throw new IllegalStateException(StringsKt.j("\n            Flow exception transparency is violated:\n                Previous 'emit' call has thrown exception " + mVar.f37606e + ", but then emission attempt of value '" + obj + "' has been detected.\n                Emissions from 'catch' blocks are prohibited in order to avoid unspecified behaviour, 'Flow.catch' operator can be used instead.\n                For a more detailed explanation, please refer to Flow documentation.\n            ").toString());
    }
    ...
    public Object emit(Object obj, Continuation continuation) {
        try {
            ...
            this.f37621o = new m(th2, continuation.getContext());
            throw th2;
        }
    }
    ...
    public CoroutineStackFrame getCallerFrame() {
        Continuation continuation = this.f37622p;
    ...
    protected Object invokeSuspend(Object obj) {
        ...
        if (e10 != null) {
            this.f37621o = new m(e10, getContext());
        }
        Continuation continuation = this.f37622p;
