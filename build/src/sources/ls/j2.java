...
public abstract class j2 extends a0 implements KProperty {
    ...
    public static final b f36461x = new b(null);

    /* renamed from: y  reason: collision with root package name */
    private static final Object f36462y = new Object();

    /* renamed from: r  reason: collision with root package name */
    private final c1 f36463r;
    ...
    private final Object f36466u;

    /* renamed from: v  reason: collision with root package name */
    private final Lazy f36467v;

    /* renamed from: w  reason: collision with root package name */
    private final z2.a f36468w;
    ...
    public static abstract class c extends a implements KProperty.b {
        ...
        /* renamed from: t  reason: collision with root package name */
        static final /* synthetic */ KProperty[] f36469t = {Reflection.property1(new PropertyReference1Impl(c.class, "descriptor", "getDescriptor()Lorg/jetbrains/kotlin/descriptors/PropertyGetterDescriptor;", 0))};

        /* renamed from: r  reason: collision with root package name */
        private final z2.a f36470r = z2.c(new k2(this));

        /* renamed from: s  reason: collision with root package name */
        private final Lazy f36471s = rr.l.b(rr.o.f49210e, new l2(this));

        /* JADX INFO: Access modifiers changed from: private */
        public static final ms.h M(c cVar) {
        ...
        @Override // ls.a0
        public ms.h A() {
            return (ms.h) this.f36471s.getValue();
        }

        @Override // ls.j2.a
        /* renamed from: O */
        public PropertyGetterDescriptor I() {
            Object b10 = this.f36470r.b(this, f36469t[0]);
    ...
    public static abstract class d extends a implements e.a {
        ...
        /* renamed from: t  reason: collision with root package name */
        static final /* synthetic */ KProperty[] f36472t = {Reflection.property1(new PropertyReference1Impl(d.class, "descriptor", "getDescriptor()Lorg/jetbrains/kotlin/descriptors/PropertySetterDescriptor;", 0))};

        /* renamed from: r  reason: collision with root package name */
        private final z2.a f36473r = z2.c(new m2(this));

        /* renamed from: s  reason: collision with root package name */
        private final Lazy f36474s = rr.l.b(rr.o.f49210e, new n2(this));

        /* JADX INFO: Access modifiers changed from: private */
        public static final ms.h M(d dVar) {
        ...
        @Override // ls.a0
        public ms.h A() {
            return (ms.h) this.f36474s.getValue();
        }

        @Override // ls.j2.a
        /* renamed from: O */
        public PropertySetterDescriptor I() {
            Object b10 = this.f36473r.b(this, f36472t[0]);
            Intrinsics.checkNotNullExpressionValue(b10, "getValue(...)");
    ...
    private j2(c1 c1Var, String str, String str2, PropertyDescriptor propertyDescriptor, Object obj) {
        ...
        this.f36465t = str2;
        this.f36466u = obj;
        this.f36467v = rr.l.b(rr.o.f49210e, new h2(this));
    ...
    public static final PropertyDescriptor I(j2 j2Var) {
        return j2Var.B().n(j2Var.getName(), j2Var.f36465t);
    }

    /* JADX INFO: Access modifiers changed from: private */
    public static final Field J(j2 j2Var) {
        Class<?> enclosingClass;
        p f10 = e3.f36427a.f(j2Var.D());
    ...
    @Override // ls.a0
    public boolean G() {
        if (this.f36466u != CallableReference.NO_RECEIVER) {
            return true;
        }
        return false;
    }
        ...
        try {
            ...
            if ((obj != obj4 && obj2 != obj4) || D().getExtensionReceiverParameter() != null) {
                ...
                if (accessibleObject != null) {
                    accessibleObject.setAccessible(ks.a.a(this));
                }
                if (member == null) {
                    return null;
                }
    ...
    public PropertyDescriptor D() {
        Object invoke = this.f36468w.invoke();
    ...
    public final Field R() {
        return (Field) this.f36467v.getValue();
    }
    ...
    public boolean equals(Object obj) {
        j2 d10 = j3.d(obj);
        if (d10 == null || !Intrinsics.areEqual(B(), d10.B()) || !Intrinsics.areEqual(getName(), d10.getName()) || !Intrinsics.areEqual(this.f36465t, d10.f36465t) || !Intrinsics.areEqual(this.f36466u, d10.f36466u)) {
            return false;
        }
        return true;
    }
    ...
    public int hashCode() {
        return (((B().hashCode() * 31) + getName().hashCode()) * 31) + this.f36465t.hashCode();
    }
    ...
    */
    public j2(ls.c1 r8, kotlin.reflect.jvm.internal.impl.descriptors.PropertyDescriptor r9) {
        /*
            r7 = this;
            ...
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: ls.j2.<init>(ls.c1, kotlin.reflect.jvm.internal.impl.descriptors.PropertyDescriptor):void");
    }
}
