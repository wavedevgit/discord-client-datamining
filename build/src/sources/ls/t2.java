...
public final class t2 implements KTypeBase {
    ...
    static final /* synthetic */ KProperty[] f36544p = {Reflection.property1(new PropertyReference1Impl(t2.class, "classifier", "getClassifier()Lkotlin/reflect/KClassifier;", 0)), Reflection.property1(new PropertyReference1Impl(t2.class, "arguments", "getArguments()Ljava/util/List;", 0))};

    /* renamed from: d  reason: collision with root package name */
    private final KotlinType f36545d;

    /* renamed from: e  reason: collision with root package name */
    private final z2.a f36546e;

    /* renamed from: i  reason: collision with root package name */
    private final z2.a f36547i;

    /* renamed from: o  reason: collision with root package name */
    private final z2.a f36548o;
    ...
    public t2(KotlinType type, Function0 function0) {
        ...
        this.f36546e = aVar;
        this.f36547i = z2.c(new p2(this));
        this.f36548o = z2.c(new q2(this, function0));
    }
    ...
    public static final List f(t2 t2Var, Function0 function0) {
        s2 s2Var;
        KTypeProjection d10;
        List<TypeProjection> arguments = t2Var.f36545d.getArguments();
        if (arguments.isEmpty()) {
            return CollectionsKt.l();
        }
        Lazy b10 = rr.l.b(rr.o.f49210e, new r2(t2Var));
        ...
        for (Object obj : list) {
            ...
            if (typeProjection.isStarProjection()) {
                ...
                int i12 = a.f36549a[typeProjection.getProjectionKind().ordinal()];
                if (i12 != 1) {
                    if (i12 != 2) {
                        if (i12 == 3) {
                            d10 = KTypeProjection.f31869c.b(t2Var2);
                        } else {
                            throw new rr.p();
                        }
                    } else {
                        d10 = KTypeProjection.f31869c.a(t2Var2);
                    }
                } else {
                    d10 = KTypeProjection.f31869c.d(t2Var2);
                }
            }
            arrayList.add(d10);
            i10 = i11;
        ...
        if (mo1199getDeclarationDescriptor instanceof ClassDescriptor) {
            ...
            if (q10.isArray()) {
                ...
                if (typeProjection != null && (type = typeProjection.getType()) != null) {
                    ...
                    if (k10 != null) {
                        return new w0(j3.f(es.a.b(ks.b.a(k10))));
                    }
            ...
            throw new rr.q("An operation is not implemented: Type alias classifiers are not yet supported");
        }
    }
    ...
    public boolean equals(Object obj) {
        if (obj instanceof t2) {
            t2 t2Var = (t2) obj;
            if (Intrinsics.areEqual(this.f36545d, t2Var.f36545d) && Intrinsics.areEqual(getClassifier(), t2Var.getClassifier()) && Intrinsics.areEqual(getArguments(), t2Var.getArguments())) {
                return true;
            }
            return false;
        }
    ...
    public List getAnnotations() {
        return j3.e(this.f36545d);
    }

    @Override // kotlin.jvm.internal.KTypeBase, kotlin.reflect.KType
    public List getArguments() {
        Object b10 = this.f36548o.b(this, f36544p[1]);
    ...
    public kotlin.reflect.d getClassifier() {
        return (kotlin.reflect.d) this.f36547i.b(this, f36544p[0]);
    }

    @Override // kotlin.jvm.internal.KTypeBase
    public Type getJavaType() {
        z2.a aVar = this.f36546e;
        if (aVar != null) {
    ...
    public int hashCode() {
        int i10;
        int hashCode = this.f36545d.hashCode() * 31;
    ...
    public boolean isMarkedNullable() {
        return this.f36545d.isMarkedNullable();
    }
    ...
    public String toString() {
        return d3.f36419a.l(this.f36545d);
    }
