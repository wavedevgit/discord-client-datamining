...
public final class u1 extends c1 {
    ...
    private final Class f36553o;

    /* renamed from: p  reason: collision with root package name */
    private final Lazy f36554p;
    ...
    public final class a extends c1.b {
        ...
        static final /* synthetic */ KProperty[] f36555j = {Reflection.property1(new PropertyReference1Impl(a.class, "kotlinClass", "getKotlinClass()Lorg/jetbrains/kotlin/descriptors/runtime/components/ReflectKotlinClass;", 0)), Reflection.property1(new PropertyReference1Impl(a.class, "scope", "getScope()Lorg/jetbrains/kotlin/resolve/scopes/MemberScope;", 0)), Reflection.property1(new PropertyReference1Impl(a.class, "members", "getMembers()Ljava/util/Collection;", 0))};

        /* renamed from: d  reason: collision with root package name */
        private final z2.a f36556d;

        /* renamed from: e  reason: collision with root package name */
        private final z2.a f36557e;

        /* renamed from: f  reason: collision with root package name */
        private final Lazy f36558f;

        /* renamed from: g  reason: collision with root package name */
        private final Lazy f36559g;

        /* renamed from: h  reason: collision with root package name */
        private final z2.a f36560h;

        public a() {
            super();
            this.f36556d = z2.c(new p1(u1.this));
            this.f36557e = z2.c(new q1(this));
            rr.o oVar = rr.o.f49210e;
            this.f36558f = rr.l.b(oVar, new r1(this, u1.this));
            this.f36559g = rr.l.b(oVar, new s1(this));
            this.f36560h = z2.c(new t1(u1.this, this));
        }

        private final ReflectKotlinClass i() {
            return (ReflectKotlinClass) this.f36556d.b(this, f36555j[0]);
        }
        ...
        public static final Collection o(u1 u1Var, a aVar) {
            return u1Var.u(aVar.m(), c1.d.f36408d);
        }

        /* JADX INFO: Access modifiers changed from: private */
        public static final rr.u p(a aVar) {
            ...
            if (i10 != null && (classHeader = i10.getClassHeader()) != null) {
                ...
                if (data != null && strings != null) {
                    ...
                    return new rr.u((JvmNameResolver) readPackageDataFrom.a(), (ProtoBuf.Package) readPackageDataFrom.b(), classHeader.getMetadataVersion());
                }
            }
            return null;
        }
        ...
        public final Collection j() {
            Object b10 = this.f36560h.b(this, f36555j[2]);
            Intrinsics.checkNotNullExpressionValue(b10, "getValue(...)");
            return (Collection) b10;
        }

        public final rr.u k() {
            return (rr.u) this.f36559g.getValue();
        }

        public final Class l() {
            return (Class) this.f36558f.getValue();
        }

        public final MemberScope m() {
            Object b10 = this.f36557e.b(this, f36555j[1]);
            Intrinsics.checkNotNullExpressionValue(b10, "getValue(...)");
    ...
    /* synthetic */ class b extends FunctionReferenceImpl implements Function2 {
        ...
        /* renamed from: d  reason: collision with root package name */
        public static final b f36562d = new b();
    ...
    public u1(Class jClass) {
        ...
        this.f36553o = jClass;
        this.f36554p = rr.l.b(rr.o.f49210e, new o1(this));
    }
    ...
    private final MemberScope E() {
        return ((a) this.f36554p.getValue()).m();
    }
    ...
    public Collection getMembers() {
        return ((a) this.f36554p.getValue()).j();
    }
    ...
    public PropertyDescriptor t(int i10) {
        rr.u k10 = ((a) this.f36554p.getValue()).k();
        if (k10 != null) {
            ...
            if (property != null) {
                ...
                return (PropertyDescriptor) j3.h(jClass, property, jvmNameResolver, new TypeTable(typeTable), metadataVersion, b.f36562d);
            }
        }
        return null;
    }
    ...
    @Override // ls.c1
    protected Class v() {
        Class l10 = ((a) this.f36554p.getValue()).l();
        if (l10 == null) {
            return getJClass();
        }
        return l10;
