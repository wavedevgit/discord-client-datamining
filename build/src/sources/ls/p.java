...
public abstract class p {
    ...
    public static final class a extends p {
        ...
        public String a() {
            ...
            String name = this.f36508a.getName();
            Intrinsics.checkNotNullExpressionValue(name, "getName(...)");
            sb2.append(JvmAbi.getterName(name));
            sb2.append("()");
            Class<?> type = this.f36508a.getType();
    ...
    public static final class b extends p {
        ...
        /* renamed from: a  reason: collision with root package name */
        private final Method f36509a;

        /* renamed from: b  reason: collision with root package name */
        private final Method f36510b;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        public b(Method getterMethod, Method method) {
            super(null);
            Intrinsics.checkNotNullParameter(getterMethod, "getterMethod");
            this.f36509a = getterMethod;
            this.f36510b = method;
        }
    ...
    public static final class c extends p {
        ...
        /* renamed from: a  reason: collision with root package name */
        private final PropertyDescriptor f36511a;

        /* renamed from: b  reason: collision with root package name */
        private final ProtoBuf.Property f36512b;

        /* renamed from: c  reason: collision with root package name */
        private final JvmProtoBuf.JvmPropertySignature f36513c;

        /* renamed from: d  reason: collision with root package name */
        private final NameResolver f36514d;

        /* renamed from: e  reason: collision with root package name */
        private final TypeTable f36515e;
        ...
        public c(PropertyDescriptor descriptor, ProtoBuf.Property proto, JvmProtoBuf.JvmPropertySignature signature, NameResolver nameResolver, TypeTable typeTable) {
            ...
            this.f36511a = descriptor;
            this.f36512b = proto;
            this.f36513c = signature;
            this.f36514d = nameResolver;
            this.f36515e = typeTable;
        ...
        private final String c() {
            DeclarationDescriptor containingDeclaration = this.f36511a.getContainingDeclaration();
            Intrinsics.checkNotNullExpressionValue(containingDeclaration, "getContainingDeclaration(...)");
            if (Intrinsics.areEqual(this.f36511a.getVisibility(), DescriptorVisibilities.INTERNAL) && (containingDeclaration instanceof DeserializedClassDescriptor)) {
                ...
                String str = (num == null || (str = this.f36514d.getString(num.intValue())) == null) ? "main" : "main";
                return '$' + NameUtils.sanitizeAsJavaIdentifier(str);
            } else if (Intrinsics.areEqual(this.f36511a.getVisibility(), DescriptorVisibilities.PRIVATE) && (containingDeclaration instanceof PackageFragmentDescriptor)) {
                PropertyDescriptor propertyDescriptor = this.f36511a;
    ...
    public static final class d extends p {
        ...
        /* renamed from: a  reason: collision with root package name */
        private final n.e f36517a;

        /* renamed from: b  reason: collision with root package name */
        private final n.e f36518b;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        public d(n.e getterSignature, n.e eVar) {
            super(null);
            Intrinsics.checkNotNullParameter(getterSignature, "getterSignature");
            this.f36517a = getterSignature;
            this.f36518b = eVar;
        }

        @Override // ls.p
        public String a() {
            return this.f36517a.a();
        }
