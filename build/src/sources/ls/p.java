...
public class p {
    ...
    private static final /* synthetic */ AtomicReferenceFieldUpdater f37482d = AtomicReferenceFieldUpdater.newUpdater(p.class, Object.class, "_next$volatile");

    /* renamed from: e  reason: collision with root package name */
    private static final /* synthetic */ AtomicReferenceFieldUpdater f37483e = AtomicReferenceFieldUpdater.newUpdater(p.class, Object.class, "_prev$volatile");

    /* renamed from: i  reason: collision with root package name */
    private static final /* synthetic */ AtomicReferenceFieldUpdater f37484i = AtomicReferenceFieldUpdater.newUpdater(p.class, Object.class, "_removedRef$volatile");
    ...
    /* JADX WARN: Code restructure failed: missing block: B:19:0x003f, code lost:
        if (androidx.concurrent.futures.b.a(ls.p.f37482d, r3, r2, ((ls.y) r4).f37504a) != false) goto L20;
     */
    /*
    ...
    */
    ...
    private final void j(p pVar) {
        ...
        } while (!androidx.concurrent.futures.b.a(f37483e, pVar, pVar2, this));
        if (q()) {
            pVar.h();
        }
    }
    ...
    private final y t() {
        y yVar = (y) f37484i.get(this);
        if (yVar == null) {
            y yVar2 = new y(this);
            f37484i.set(this, yVar2);
            return yVar2;
        }
        return yVar;
    }
    ...
    public final boolean c(p pVar, int i10) {
        ...
        do {
            m10 = m();
            if (m10 instanceof n) {
                if ((((n) m10).f37479o & i10) == 0 && m10.c(pVar, i10)) {
                    return true;
                }
                return false;
            }
    ...
    public final boolean e(p pVar, p pVar2) {
        f37483e.set(pVar, this);
        f37482d.set(pVar, pVar2);
        if (!androidx.concurrent.futures.b.a(f37482d, this, pVar2, pVar)) {
            return false;
        }
        pVar.j(pVar2);
        return true;
    ...
    public final boolean f(p pVar) {
        f37483e.set(pVar, this);
        f37482d.set(pVar, this);
        while (k() == this) {
            if (androidx.concurrent.futures.b.a(f37482d, this, this, pVar)) {
                pVar.j(this);
                return true;
            }
        }
    ...
    public final p l() {
        ...
        if (yVar != null && (pVar = yVar.f37504a) != null) {
            return pVar;
        }
    ...
    public final p s() {
        ...
        do {
            ...
            Intrinsics.checkNotNull(k10, "null cannot be cast to non-null type kotlinx.coroutines.internal.LockFreeLinkedListNode");
            pVar = (p) k10;
        } while (!androidx.concurrent.futures.b.a(f37482d, this, k10, pVar.t()));
        pVar.h();
        return null;
    }
