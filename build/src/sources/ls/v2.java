...
public final class v2 implements kotlin.reflect.l, x0 {
    ...
    static final /* synthetic */ KProperty[] f36567o = {Reflection.property1(new PropertyReference1Impl(v2.class, "upperBounds", "getUpperBounds()Ljava/util/List;", 0))};

    /* renamed from: d  reason: collision with root package name */
    private final TypeParameterDescriptor f36568d;

    /* renamed from: e  reason: collision with root package name */
    private final z2.a f36569e;

    /* renamed from: i  reason: collision with root package name */
    private final w2 f36570i;
    ...
    public v2(w2 w2Var, TypeParameterDescriptor descriptor) {
        ...
        this.f36568d = descriptor;
        this.f36569e = z2.c(new u2(this));
        if (w2Var == null) {
            ...
            if (containingDeclaration instanceof ClassDescriptor) {
                ...
                if (containingDeclaration2 instanceof ClassDescriptor) {
                    ...
                    if (deserializedMemberDescriptor != null) {
                        KClass e10 = es.a.e(b(deserializedMemberDescriptor));
                ...
                accept = containingDeclaration.accept(new j(w0Var), Unit.f31765a);
            } else {
    ...
    public boolean equals(Object obj) {
        if (obj instanceof v2) {
            v2 v2Var = (v2) obj;
            if (Intrinsics.areEqual(this.f36570i, v2Var.f36570i) && Intrinsics.areEqual(getName(), v2Var.getName())) {
                return true;
            }
            return false;
        }
    ...
    public List getUpperBounds() {
        Object b10 = this.f36569e.b(this, f36567o[0]);
    ...
    public kotlin.reflect.m getVariance() {
        int i10 = a.f36571a[getDescriptor().getVariance().ordinal()];
        if (i10 != 1) {
            if (i10 != 2) {
                if (i10 == 3) {
                    return kotlin.reflect.m.f34606i;
                }
                throw new rr.p();
            }
            return kotlin.reflect.m.f34605e;
        }
        return kotlin.reflect.m.f34604d;
    }

    public int hashCode() {
        return (this.f36570i.hashCode() * 31) + getName().hashCode();
    }
