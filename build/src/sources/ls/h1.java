...
public final class h1 extends a0 implements FunctionBase, KFunction, l {
    ...
    static final /* synthetic */ KProperty[] f36445x = {Reflection.property1(new PropertyReference1Impl(h1.class, "descriptor", "getDescriptor()Lorg/jetbrains/kotlin/descriptors/FunctionDescriptor;", 0))};

    /* renamed from: r  reason: collision with root package name */
    private final c1 f36446r;

    /* renamed from: s  reason: collision with root package name */
    private final String f36447s;

    /* renamed from: t  reason: collision with root package name */
    private final Object f36448t;

    /* renamed from: u  reason: collision with root package name */
    private final z2.a f36449u;

    /* renamed from: v  reason: collision with root package name */
    private final Lazy f36450v;

    /* renamed from: w  reason: collision with root package name */
    private final Lazy f36451w;
    ...
    public static final ms.h L(h1 h1Var) {
        Object d10;
        ms.h P;
        n g10 = e3.f36427a.g(h1Var.D());
        if (g10 instanceof n.d) {
            if (h1Var.F()) {
                ...
                return new ms.a(jClass, arrayList, a.EnumC0540a.f37459e, a.b.f37463e, null, 16, null);
            }
            ...
            return new ms.a(jClass2, arrayList2, a.EnumC0540a.f37459e, a.b.f37462d, d11);
        } else {
            throw new rr.p();
        }
        ...
        return ms.o.j(P, h1Var.D(), false, 2, null);
    }

    private final ms.i M(Constructor constructor, FunctionDescriptor functionDescriptor, boolean z10) {
    ...
    private final ms.h P(Method method, boolean z10) {
        Object S;
        if (G()) {
            if (V(method)) {
                S = this.f36448t;
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public static final ms.h Q(h1 h1Var) {
        ...
        if (g10 instanceof n.e) {
            ...
            if (h1Var.F()) {
                ...
                return new ms.a(jClass, arrayList, a.EnumC0540a.f37458d, a.b.f37463e, null, 16, null);
            }
            ...
            return new ms.a(jClass2, arrayList2, a.EnumC0540a.f37458d, a.b.f37462d, d10);
        } else {
        ...
        return ms.o.i(hVar, h1Var.D(), true);
    }

    /* JADX INFO: Access modifiers changed from: private */
    public static final FunctionDescriptor R(h1 h1Var, String str) {
        return h1Var.B().k(str, h1Var.f36447s);
    }

    private final Object S() {
        return ms.o.h(this.f36448t, D());
    }
    ...
    @Override // ls.a0
    public ms.h A() {
        return (ms.h) this.f36450v.getValue();
    }
    ...
    @Override // ls.a0
    public ms.h C() {
        return (ms.h) this.f36451w.getValue();
    }

    @Override // ls.a0
    public boolean G() {
        if (this.f36448t != CallableReference.NO_RECEIVER) {
            return true;
        }
        return false;
    }
    ...
    public FunctionDescriptor D() {
        Object b10 = this.f36449u.b(this, f36445x[0]);
    ...
    public boolean equals(Object obj) {
        h1 c10 = j3.c(obj);
        if (c10 == null || !Intrinsics.areEqual(B(), c10.B()) || !Intrinsics.areEqual(getName(), c10.getName()) || !Intrinsics.areEqual(this.f36447s, c10.f36447s) || !Intrinsics.areEqual(this.f36448t, c10.f36448t)) {
            return false;
        }
        return true;
    }
    ...
    public int hashCode() {
        return (((B().hashCode() * 31) + getName().hashCode()) * 31) + this.f36447s.hashCode();
    }
    ...
    private h1(c1 c1Var, String str, String str2, FunctionDescriptor functionDescriptor, Object obj) {
        ...
        this.f36447s = str2;
        this.f36448t = obj;
        this.f36449u = z2.b(functionDescriptor, new e1(this, str));
        rr.o oVar = rr.o.f49210e;
        this.f36450v = rr.l.b(oVar, new f1(this));
        this.f36451w = rr.l.b(oVar, new g1(this));
    }
    ...
    */
    public h1(ls.c1 r10, kotlin.reflect.jvm.internal.impl.descriptors.FunctionDescriptor r11) {
        /*
            r9 = this;
            ...
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: ls.h1.<init>(ls.c1, kotlin.reflect.jvm.internal.impl.descriptors.FunctionDescriptor):void");
    }
}
