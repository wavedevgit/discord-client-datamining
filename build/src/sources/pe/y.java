...
public interface y {
    ...
    public static final class a {
        ...
        public static /* synthetic */ void c(a aVar, DecoderCounters decoderCounters) {
            aVar.getClass();
            decoderCounters.c();
            ((y) w0.j(aVar.f42304b)).k(decoderCounters);
        }

        public static /* synthetic */ void i(a aVar, Format format, DecoderReuseEvaluation decoderReuseEvaluation) {
            ((y) w0.j(aVar.f42304b)).x(format);
            ((y) w0.j(aVar.f42304b)).h(format, decoderReuseEvaluation);
        }
            ...
            if (handler != null) {
                handler.post(new Runnable() { // from class: pe.u
                    ...
                    public final void run() {
                        ((y) w0.j(y.a.this.f42304b)).d(str, j10, j11);
                    }
                });
            }
        }
        ...
        public void n(final int i10, final long j10) {
            ...
            if (handler != null) {
                handler.post(new Runnable() { // from class: pe.p
                    @Override // java.lang.Runnable
                    public final void run() {
                        ((y) w0.j(y.a.this.f42304b)).m(i10, j10);
                    }
                });
            }
        }
        ...
        public void o(final DecoderCounters decoderCounters) {
            ...
            if (handler != null) {
                handler.post(new Runnable() { // from class: pe.v
                    @Override // java.lang.Runnable
                    public final void run() {
                        ((y) w0.j(y.a.this.f42304b)).p(decoderCounters);
                    }
                });
            }
        }
        ...
        public void q(final Object obj) {
            if (this.f42303a != null) {
                ...
                this.f42303a.post(new Runnable() { // from class: pe.q
                    @Override // java.lang.Runnable
                    public final void run() {
                        ((y) w0.j(y.a.this.f42304b)).o(obj, elapsedRealtime);
                    }
                });
            }
        }
        ...
        public void r(final long j10, final int i10) {
            ...
            if (handler != null) {
                handler.post(new Runnable() { // from class: pe.x
                    @Override // java.lang.Runnable
                    public final void run() {
                        ((y) w0.j(y.a.this.f42304b)).s(j10, i10);
                    }
                });
            }
        }
        ...
        public void t(final VideoSize videoSize) {
            ...
            if (handler != null) {
                handler.post(new Runnable() { // from class: pe.o
                    @Override // java.lang.Runnable
                    public final void run() {
                        ((y) w0.j(y.a.this.f42304b)).onVideoSizeChanged(videoSize);
                    }
                });
            }
        }
