...
public abstract class a {
    ...
    public static void a(Drawable drawable, Resources.Theme theme) {
        C0623a.a(drawable, theme);
    }

    public static boolean b(Drawable drawable) {
        return C0623a.b(drawable);
    }
    ...
    public static void g(Drawable drawable, Resources resources, XmlPullParser xmlPullParser, AttributeSet attributeSet, Resources.Theme theme) {
        C0623a.d(drawable, resources, xmlPullParser, attributeSet, theme);
    }
    ...
    public static void n(Drawable drawable, int i10) {
        C0623a.g(drawable, i10);
    }

    public static void o(Drawable drawable, ColorStateList colorStateList) {
        C0623a.h(drawable, colorStateList);
    }

    public static void p(Drawable drawable, PorterDuff.Mode mode) {
        C0623a.i(drawable, mode);
    }
