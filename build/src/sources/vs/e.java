...
public class e extends i implements Mutex {
    ...
    private static final /* synthetic */ AtomicReferenceFieldUpdater f52364i = AtomicReferenceFieldUpdater.newUpdater(e.class, Object.class, "owner$volatile");

    /* renamed from: h  reason: collision with root package name */
    private final Function3 f52365h;
    ...
    public final class a implements CancellableContinuation, w1 {
        ...
        public final kotlinx.coroutines.e f52366d;

        /* renamed from: e  reason: collision with root package name */
        public final Object f52367e;
        ...
        public boolean a() {
            return this.f52366d.a();
        }

        @Override // kotlinx.coroutines.CancellableContinuation
        public void c(Function1 function1) {
            this.f52366d.c(function1);
        }

        @Override // ms.w1
        public void d(b0 b0Var, int i10) {
            this.f52366d.d(b0Var, i10);
        }

        @Override // kotlinx.coroutines.CancellableContinuation
        public Object e(Throwable th2) {
            return this.f52366d.e(th2);
        }

        @Override // kotlinx.coroutines.CancellableContinuation
        public void f(CoroutineDispatcher coroutineDispatcher, Throwable th2) {
            this.f52366d.f(coroutineDispatcher, th2);
        }

        @Override // kotlinx.coroutines.CancellableContinuation
        public boolean g(Throwable th2) {
            return this.f52366d.g(th2);
        }

        @Override // kotlin.coroutines.Continuation
        public CoroutineContext getContext() {
            return this.f52366d.getContext();
        }

        @Override // kotlinx.coroutines.CancellableContinuation
        /* renamed from: i */
        public void q(Unit unit, Function3 function3) {
            e.w().set(e.this, this.f52367e);
            kotlinx.coroutines.e eVar = this.f52366d;
            final e eVar2 = e.this;
            eVar.R(unit, new Function1() { // from class: vs.d
        ...
        public boolean isCompleted() {
            return this.f52366d.isCompleted();
        }

        @Override // kotlinx.coroutines.CancellableContinuation
        /* renamed from: k */
        public void r(CoroutineDispatcher coroutineDispatcher, Unit unit) {
            this.f52366d.r(coroutineDispatcher, unit);
        }
        ...
        public Object u(Unit unit, Object obj, Function3 function3) {
            final e eVar = e.this;
            Object u10 = this.f52366d.u(unit, obj, new Function3() { // from class: vs.c
    ...
    public e(boolean z10) {
        ...
        this.f52365h = new Function3() { // from class: vs.a
            @Override // kotlin.jvm.functions.Function3
            public final Object invoke(Object obj, Object obj2, Object obj3) {
                Function3 C;
                C = e.C(e.this, (us.l) obj, obj2, obj3);
                return C;
            }
        };
    }
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public static final Function3 C(final e eVar, us.l lVar, final Object obj, Object obj2) {
        return new Function3() { // from class: vs.b
            @Override // kotlin.jvm.functions.Function3
        ...
        while (z()) {
            ...
            if (obj2 != e0Var) {
                if (obj2 == obj || obj == null) {
                    AtomicReferenceFieldUpdater atomicReferenceFieldUpdater = f52364i;
                    e0Var2 = f.f52369a;
    ...
    public String toString() {
        return "Mutex@" + ms.e0.b(this) + "[isLocked=" + z() + ",owner=" + f52364i.get(this) + ']';
    }
