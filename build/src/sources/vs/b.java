...
public final class b extends s implements Executor {
    ...
    public static final b f53010o = new b();

    /* renamed from: p  reason: collision with root package name */
    private static final CoroutineDispatcher f53011p;

    static {
        int e10;
        k kVar = k.f53028i;
        e10 = h0.e("kotlinx.coroutines.io.parallelism", kotlin.ranges.d.d(64, f0.a()), 0, 0, 12, null);
        f53011p = CoroutineDispatcher.b2(kVar, e10, null, 2, null);
    }
    ...
    public void execute(Runnable runnable) {
        D1(kotlin.coroutines.e.f32130d, runnable);
    }
