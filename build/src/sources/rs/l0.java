...
public abstract class l0 {
    ...
    public static final e0 f48979a = new e0("NO_THREAD_ELEMENTS");

    /* renamed from: b  reason: collision with root package name */
    private static final Function2 f48980b = new Function2() { // from class: rs.i0
    ...
    private static final Function2 f48981c = new Function2() { // from class: rs.j0
        @Override // kotlin.jvm.functions.Function2
        public final Object invoke(Object obj, Object obj2) {
            k1 e10;
    ...
    private static final Function2 f48982d = new Function2() { // from class: rs.k0
        @Override // kotlin.jvm.functions.Function2
        public final Object invoke(Object obj, Object obj2) {
            p0 h10;
    ...
    public static final void f(CoroutineContext coroutineContext, Object obj) {
        ...
        Object A1 = coroutineContext.A1(null, f48981c);
    ...
    public static final Object g(CoroutineContext coroutineContext) {
        Object A1 = coroutineContext.A1(0, f48980b);
    ...
    public static final p0 h(p0 p0Var, CoroutineContext.Element element) {
        if (element instanceof k1) {
            k1 k1Var = (k1) element;
            p0Var.a(k1Var, k1Var.B1(p0Var.f48989a));
        }
        return p0Var;
    }
    ...
    public static final Object i(CoroutineContext coroutineContext, Object obj) {
        ...
        if (obj instanceof Integer) {
            return coroutineContext.A1(new p0(coroutineContext, ((Number) obj).intValue()), f48982d);
        }
