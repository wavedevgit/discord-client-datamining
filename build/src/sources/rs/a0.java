...
public class a0 extends kotlinx.coroutines.a implements CoroutineStackFrame {
    ...
    public final Continuation f48949o;

    public a0(CoroutineContext coroutineContext, Continuation continuation) {
        super(coroutineContext, true, true);
        this.f48949o = continuation;
    }

    /* JADX INFO: Access modifiers changed from: protected */
    @Override // kotlinx.coroutines.b0
    public void C(Object obj) {
        j.b(ur.b.c(this.f48949o), ms.t.a(obj, this.f48949o));
    }

    @Override // kotlinx.coroutines.a
    protected void Q0(Object obj) {
        Continuation continuation = this.f48949o;
        continuation.resumeWith(ms.t.a(obj, continuation));
    }
