...
public abstract class m {
    ...
    private static final ts.q f48582a = new ts.q(new ts.x(new MutablePropertyReference1Impl() { // from class: rs.m.a
    ...
    private static final k f48583b = new k(null, null, null, null, 15, null);
}
