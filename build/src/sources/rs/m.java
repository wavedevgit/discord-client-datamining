...
public final class m extends b0 {
    ...
    private final e f49300p;

    /* renamed from: q  reason: collision with root package name */
    private final /* synthetic */ AtomicReferenceArray f49301q;

    public m(long j10, m mVar, e eVar, int i10) {
        super(j10, mVar, i10);
        this.f49300p = eVar;
        this.f49301q = new AtomicReferenceArray(f.f49273b * 2);
    }
    ...
    public final void C(int i10, boolean z10) {
        if (z10) {
            y().w1((this.f51768i * f.f49273b) + i10);
        }
        t();
    }
    ...
    */
    public void s(int r4, java.lang.Throwable r5, kotlin.coroutines.CoroutineContext r6) {
        ...
        Le:
            ...
            boolean r2 = r1 instanceof ps.w1
            if (r2 != 0) goto L73
            boolean r2 = r1 instanceof rs.x
            if (r2 == 0) goto L1b
            goto L73
        L1b:
            us.e0 r2 = rs.f.j()
        ...
        L62:
            ...
            if (r0 == 0) goto L99
            rs.e r4 = r3.y()
            kotlin.jvm.functions.Function1 r4 = r4.f49253e
            if (r4 == 0) goto L99
            us.x.a(r4, r5, r6)
            return
        L73:
        ...
        L99:
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: rs.m.s(int, java.lang.Throwable, kotlin.coroutines.CoroutineContext):void");
    }
