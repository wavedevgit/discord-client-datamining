...
public abstract class b {
    public static final KClass a(SerialDescriptor serialDescriptor) {
        ...
        if (serialDescriptor instanceof c) {
            return ((c) serialDescriptor).f6066b;
        }
    ...
    public static final SerialDescriptor b(et.b bVar, SerialDescriptor descriptor) {
        KSerializer c10;
        Intrinsics.checkNotNullParameter(bVar, "<this>");
        Intrinsics.checkNotNullParameter(descriptor, "descriptor");
        KClass a10 = a(descriptor);
        if (a10 == null || (c10 = et.b.c(bVar, a10, null, 2, null)) == null) {
            return null;
        }
