...
public abstract class m {
    ...
    private static final ct.q f6134a = new ct.q(new ct.x(new MutablePropertyReference1Impl() { // from class: at.m.a
    ...
    private static final k f6135b = new k(null, null, null, null, 15, null);
}
