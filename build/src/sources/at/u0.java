...
public final class u0 extends d1 {
    ...
    private final SerialDescriptor f6889c;
    ...
    public u0(KSerializer kSerializer, KSerializer vSerializer) {
        ...
        this.f6889c = new t0(kSerializer.getDescriptor(), vSerializer.getDescriptor());
    }

    @Override // at.d1, kotlinx.serialization.KSerializer, xs.o, kotlinx.serialization.DeserializationStrategy
