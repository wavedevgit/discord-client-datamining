...
public abstract class d1 extends a {
    ...
    private final KSerializer f6794a;

    /* renamed from: b  reason: collision with root package name */
    private final KSerializer f6795b;
    ...
    public final void h(kotlinx.serialization.encoding.c decoder, int i10, Map builder, boolean z10) {
        ...
        Intrinsics.checkNotNullParameter(decoder, "decoder");
        Intrinsics.checkNotNullParameter(builder, "builder");
        Object c11 = c.a.c(decoder, getDescriptor(), i10, this.f6794a, null, 8, null);
        if (z10) {
        ...
        int i12 = i11;
        if (builder.containsKey(c11) && !(this.f6795b.getDescriptor().getKind() instanceof zs.e)) {
            c10 = decoder.y(getDescriptor(), i12, this.f6795b, kotlin.collections.o0.j(builder, c11));
        } else {
            c10 = c.a.c(decoder, getDescriptor(), i12, this.f6795b, null, 8, null);
        }
        builder.put(c11, c10);
    }
    ...
    public void serialize(Encoder encoder, Object obj) {
        ...
        while (d10.hasNext()) {
            ...
            int i12 = i11 + 1;
            i10.j(getDescriptor(), i11, m(), key);
            i11 += 2;
            i10.j(getDescriptor(), i12, n(), value);
        }
        i10.c(descriptor);
    }
    ...
    private d1(KSerializer kSerializer, KSerializer kSerializer2) {
        super(null);
        this.f6794a = kSerializer;
        this.f6795b = kSerializer2;
    }
}
