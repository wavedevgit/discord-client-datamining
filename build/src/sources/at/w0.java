...
public final class w0 extends t {
    ...
    private final SerialDescriptor f6898b;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public w0(KSerializer eSerializer) {
        super(eSerializer);
        Intrinsics.checkNotNullParameter(eSerializer, "eSerializer");
        this.f6898b = new v0(eSerializer.getDescriptor());
    }

    @Override // at.s, kotlinx.serialization.KSerializer, xs.o, kotlinx.serialization.DeserializationStrategy
