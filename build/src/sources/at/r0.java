...
final class r0 implements KType {
    ...
    public boolean equals(Object obj) {
        ...
        if (classifier instanceof KClass) {
            ...
            if (dVar != null && (dVar instanceof KClass)) {
                return Intrinsics.areEqual(vr.a.b((KClass) classifier), vr.a.b((KClass) dVar));
            }
        }
        return false;
    }
    ...
    public List getAnnotations() {
        return this.f6876d.getAnnotations();
    }

    @Override // kotlin.reflect.KType
    public List getArguments() {
        return this.f6876d.getArguments();
    }

    @Override // kotlin.reflect.KType
    public kotlin.reflect.d getClassifier() {
        return this.f6876d.getClassifier();
    }
    ...
    public boolean isMarkedNullable() {
        return this.f6876d.isMarkedNullable();
    }

    public String toString() {
        return "KTypeWrapper: " + this.f6876d;
    }
}
