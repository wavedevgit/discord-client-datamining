...
public abstract class h2 {
    ...
    private static final Map f6814a = t1.i();

    public static final SerialDescriptor a(String serialName, zs.e kind) {
    ...
    public static final KSerializer b(KClass kClass) {
        ...
        return (KSerializer) f6814a.get(kClass);
    }

    private static final void c(String str) {
        for (KSerializer kSerializer : f6814a.values()) {
