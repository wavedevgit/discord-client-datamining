...
public final class i {
    ...
    public static final a f50245o = new a(null);

    /* renamed from: a  reason: collision with root package name */
    private final int f50246a;

    /* renamed from: b  reason: collision with root package name */
    private final f f50247b;
    ...
    private long f50250e;

    /* renamed from: f  reason: collision with root package name */
    private long f50251f;

    /* renamed from: g  reason: collision with root package name */
    private final ArrayDeque f50252g;

    /* renamed from: h  reason: collision with root package name */
    private boolean f50253h;

    /* renamed from: i  reason: collision with root package name */
    private final c f50254i;

    /* renamed from: j  reason: collision with root package name */
    private final b f50255j;

    /* renamed from: k  reason: collision with root package name */
    private final d f50256k;

    /* renamed from: l  reason: collision with root package name */
    private final d f50257l;

    /* renamed from: m  reason: collision with root package name */
    private tu.b f50258m;

    /* renamed from: n  reason: collision with root package name */
    private IOException f50259n;
    ...
    public final class b implements Sink {
        ...
        /* renamed from: d  reason: collision with root package name */
        private boolean f50260d;

        /* renamed from: e  reason: collision with root package name */
        private final Buffer f50261e = new Buffer();

        /* renamed from: i  reason: collision with root package name */
        private Headers f50262i;
        ...
        private final void a(boolean z10) {
            ...
            synchronized (iVar) {
                try {
                    iVar.s().v();
                    while (iVar.r() >= iVar.q() && !this.f50260d && !this.f50263o && iVar.h() == null) {
                        iVar.D();
                    }
                    iVar.s().C();
                    iVar.c();
                    min = Math.min(iVar.q() - iVar.r(), this.f50261e.size());
                    iVar.B(iVar.r() + min);
                    if (z10 && min == this.f50261e.size()) {
                        z11 = true;
                    } else {
                        z11 = false;
                    }
            ...
            i.this.s().v();
            try {
                i.this.g().x2(i.this.j(), z12, this.f50261e, min);
            } finally {
                i.this.s().C();
            }
        }
        ...
        public void close() {
            ...
            boolean z11;
            i iVar = i.this;
            if (mu.e.f36663h && Thread.holdsLock(iVar)) {
            ...
            synchronized (iVar2) {
                ...
                Unit unit = Unit.f31987a;
                if (!i.this.o().f50260d) {
                    if (this.f50261e.size() > 0) {
                        z11 = true;
                    } else {
                        z11 = false;
                    }
                    if (this.f50262i != null) {
                        while (this.f50261e.size() > 0) {
                            a(false);
                        }
                        f g10 = i.this.g();
                        int j10 = i.this.j();
                        Headers headers = this.f50262i;
        ...
        public void u0(Buffer source, long j10) {
            ...
            this.f50261e.u0(source, j10);
            while (this.f50261e.size() >= 16384) {
                a(false);
            }
        }
    }
    ...
    public final class c implements Source {
        ...
        /* renamed from: d  reason: collision with root package name */
        private final long f50265d;

        /* renamed from: e  reason: collision with root package name */
        private boolean f50266e;

        /* renamed from: i  reason: collision with root package name */
        private final Buffer f50267i = new Buffer();

        /* renamed from: o  reason: collision with root package name */
        private final Buffer f50268o = new Buffer();

        /* renamed from: p  reason: collision with root package name */
        private Headers f50269p;

        /* renamed from: q  reason: collision with root package name */
        private boolean f50270q;
        ...
        public final void i(BufferedSource source, long j10) {
            ...
            while (j11 > 0) {
                synchronized (i.this) {
                    z10 = this.f50266e;
                    z11 = false;
                    if (this.f50268o.size() + j11 > this.f50265d) {
                        z12 = true;
                    } else {
                        z12 = false;
                    }
                ...
                if (z12) {
                    ...
                    long read = source.read(this.f50267i, j11);
                    if (read != -1) {
                        j11 -= read;
                        i iVar2 = i.this;
                        synchronized (iVar2) {
                            try {
                                if (this.f50270q) {
                                    ...
                                    if (this.f50268o.size() == 0) {
                                        z11 = true;
                                    }
                                    this.f50268o.A0(this.f50267i);
                                    if (z11) {
        ...
        */
        public long read(okio.Buffer r19, long r20) {
            ...
            L11:
                ...
                if (r7 == 0) goto L3b
                boolean r7 = r1.f50266e     // Catch: java.lang.Throwable -> L38
                if (r7 != 0) goto L3b
            ...
            L3b:
                r7 = 0
            L3c:
                boolean r8 = r1.f50270q     // Catch: java.lang.Throwable -> L38
                if (r8 != 0) goto Lbb
                okio.Buffer r8 = r1.f50268o     // Catch: java.lang.Throwable -> L38
                ...
                goto La0
            L95:
                boolean r4 = r1.f50266e     // Catch: java.lang.Throwable -> L38
                if (r4 != 0) goto L9f
                if (r7 != 0) goto L9f
            ...
            La0:
                ...
                kotlin.Unit r4 = kotlin.Unit.f31987a     // Catch: java.lang.Throwable -> Lb9
                monitor-exit(r6)
                if (r11 == 0) goto Lb0
                r4 = 0
                goto L11
    ...
    public i(int i10, f connection, boolean z10, boolean z11, Headers headers) {
        ...
        this.f50246a = i10;
        this.f50247b = connection;
        this.f50251f = connection.a1().c();
        ArrayDeque arrayDeque = new ArrayDeque();
        this.f50252g = arrayDeque;
        this.f50254i = new c(connection.Z0().c(), z11);
        this.f50255j = new b(z10);
        this.f50256k = new d();
        this.f50257l = new d();
        if (headers != null) {
            if (!t()) {
    ...
    private final boolean e(tu.b bVar, IOException iOException) {
        ...
        synchronized (this) {
            ...
            this.f50258m = bVar;
            this.f50259n = iOException;
            Intrinsics.checkNotNull(this, "null cannot be cast to non-null type java.lang.Object");
            notifyAll();
            if (this.f50254i.h() && this.f50255j.i()) {
                return false;
            }
            Unit unit = Unit.f31987a;
            this.f50247b.g2(this.f50246a);
            return true;
        }
    }
    ...
    public final synchronized Headers C() {
        Object removeFirst;
        this.f50256k.v();
        while (this.f50252g.isEmpty() && this.f50258m == null) {
            D();
        }
        this.f50256k.C();
        if (!this.f50252g.isEmpty()) {
            removeFirst = this.f50252g.removeFirst();
            Intrinsics.checkNotNullExpressionValue(removeFirst, "headersQueue.removeFirst()");
        } else {
            IOException iOException = this.f50259n;
            if (iOException == null) {
                tu.b bVar = this.f50258m;
    ...
    public final void b() {
        ...
        synchronized (this) {
            try {
                if (this.f50254i.h() || !this.f50254i.a() || (!this.f50255j.i() && !this.f50255j.h())) {
                    z10 = false;
                    u10 = u();
                    Unit unit = Unit.f31987a;
                }
    ...
    public final void d(tu.b rstStatusCode, IOException iOException) {
        ...
        this.f50247b.A2(this.f50246a, rstStatusCode);
    }
    ...
    public final void f(tu.b errorCode) {
        ...
        this.f50247b.B2(this.f50246a, errorCode);
    }
    ...
    public final synchronized boolean u() {
        try {
            ...
            if (this.f50255j.i() || this.f50255j.h()) {
                if (this.f50253h) {
                    return false;
                }
            }
    ...
    */
    public final void x(okhttp3.Headers r3, boolean r4) {
        ...
        L37:
            monitor-enter(r2)
            boolean r0 = r2.f50253h     // Catch: java.lang.Throwable -> L46
            r1 = 1
            if (r0 == 0) goto L48
            if (r4 != 0) goto L40
            goto L48
        L40:
            tu.i$c r0 = r2.f50254i     // Catch: java.lang.Throwable -> L46
        ...
        L46:
            ...
            goto L6f
        L48:
            r2.f50253h = r1     // Catch: java.lang.Throwable -> L46
            java.util.ArrayDeque r0 = r2.f50252g     // Catch: java.lang.Throwable -> L46
            r0.add(r3)     // Catch: java.lang.Throwable -> L46
        L4f:
            if (r4 == 0) goto L56
            tu.i$c r3 = r2.f50254i     // Catch: java.lang.Throwable -> L46
        ...
        L56:
            ...
            kotlin.Unit r4 = kotlin.Unit.f31987a     // Catch: java.lang.Throwable -> L46
            monitor-exit(r2)
            if (r3 != 0) goto L6e
            tu.f r3 = r2.f50247b
            int r4 = r2.f50246a
