...
public final class s1 implements gn.k {
    ...
    public static final a f49639d = new a(null);

    /* renamed from: b  reason: collision with root package name */
    private final xo.j f49640b;

    /* renamed from: c  reason: collision with root package name */
    private View f49641c;

    /* loaded from: /home/runner/work/discord-client-datamining/discord-client-datamining/build/classes4.dex */
    public static final class a implements gn.c0 {

        /* renamed from: a  reason: collision with root package name */
        private final /* synthetic */ gn.c0 f49642a;
        ...
        /* synthetic */ class C0678a extends FunctionReferenceImpl implements Function3 {
            ...
            /* renamed from: d  reason: collision with root package name */
            public static final C0678a f49643d = new C0678a();
        ...
        /* synthetic */ class b extends FunctionReferenceImpl implements Function1 {
            ...
            /* renamed from: d  reason: collision with root package name */
            public static final b f49644d = new b();
        ...
        public View a(f5.f initialRendering, gn.a0 initialViewEnvironment, Context contextForNewView, ViewGroup viewGroup) {
            ...
            return this.f49642a.a(initialRendering, initialViewEnvironment, contextForNewView, viewGroup);
        }

        @Override // gn.c0
        public KClass getType() {
            return this.f49642a.getType();
        }

        private a() {
            k.a aVar = gn.k.f25848a;
            this.f49642a = new gn.z(Reflection.getOrCreateKotlinClass(f5.f.class), C0678a.f49643d, b.f49644d);
        }
    }
    ...
    public s1(final xo.j binding) {
        ...
        this.f49640b = binding;
        Context context = binding.getRoot().getContext();
        Intrinsics.checkNotNullExpressionValue(context, "getContext(...)");
        Integer f10 = bq.s.f(context, tp.a.f49765n, null, false, 6, null);
        if (f10 != null) {
            binding.f55065f.setAnimation(f10.intValue());
            binding.f55065f.v();
        } else {
            binding.f55065f.l(new r5.e("scanner", "**"), l5.b0.f35545a, new z5.e() { // from class: to.r1
                @Override // z5.e
    ...
    public static Integer c(s1 s1Var, xo.j jVar, z5.b bVar) {
        ...
        Intrinsics.checkNotNullExpressionValue(context, "getContext(...)");
        return Integer.valueOf(g(s1Var, context, f.a.f23298w, null, false, 6, null));
    }
    ...
    private final void e(StepStyles.GovernmentIdStepStyle governmentIdStepStyle, gn.a0 a0Var, PendingPageTextPosition pendingPageTextPosition) {
        ...
        int[] iArr = pendingPageTextPosition == PendingPageTextPosition.TOP ? new int[]{this.f49640b.f55066g.getId(), this.f49640b.f55062c.getId(), this.f49640b.f55061b.getId()} : new int[]{this.f49640b.f55061b.getId(), this.f49640b.f55066g.getId(), this.f49640b.f55062c.getId()};
        ConstraintSet constraintSet = new ConstraintSet();
        constraintSet.f(this.f49640b.f55063d);
        int i10 = b.f49645a[pendingPageAlignmentValue.ordinal()];
        if (i10 != 1) {
            if (i10 != 2) {
                if (i10 == 3) {
                    f10 = 1.0f;
        ...
        constraintSet.c(this.f49640b.f55063d);
        Integer backgroundColorValue = governmentIdStepStyle.getBackgroundColorValue();
        if (backgroundColorValue != null) {
            int intValue = backgroundColorValue.intValue();
            this.f49640b.getRoot().setBackgroundColor(intValue);
            kq.c.a(a0Var, intValue);
        }
        Context context = this.f49640b.getRoot().getContext();
        Intrinsics.checkNotNullExpressionValue(context, "getContext(...)");
        Drawable a10 = wq.c.a(governmentIdStepStyle, context);
        if (a10 != null) {
            this.f49640b.getRoot().setBackground(a10);
        }
        TextBasedComponentStyle processingTitleStyleValue = governmentIdStepStyle.getProcessingTitleStyleValue();
        if (processingTitleStyleValue != null) {
            TextView title = this.f49640b.f55066g;
        ...
        if (processingTextStyleValue != null) {
            TextView body = this.f49640b.f55062c;
        ...
        if (fillColorValue != null) {
            ...
            this.f49640b.f55065f.I(Color.parseColor("#AA85FF"), intValue2);
            this.f49640b.f55065f.I(Color.parseColor("#4600EB"), intValue2);
        }
        Integer strokeColorValue = governmentIdStepStyle.getStrokeColorValue();
        if (strokeColorValue != null) {
            this.f49640b.f55065f.I(Color.parseColor("#190052"), strokeColorValue.intValue());
        }
        ...
        if (backgroundColorValue2 != null) {
            ...
            this.f49640b.f55065f.I(Color.parseColor("#FFFFFF"), intValue3);
            this.f49640b.f55065f.I(Color.parseColor("#F1EBFF"), intValue3);
        }
    }
    ...
    public void a(final f5.f rendering, gn.a0 viewEnvironment) {
        ...
        Pi2NavigationBar navigationBar = jVar.f55064e;
        Intrinsics.checkNotNullExpressionValue(navigationBar, "navigationBar");
        ConstraintLayout root = jVar.getRoot();
        Intrinsics.checkNotNullExpressionValue(root, "getRoot(...)");
        jq.e.b(c10, function0, function02, navigationBar, root);
        if (rendering.h().length() == 0) {
            jVar.f55066g.setVisibility(8);
        } else {
            jVar.f55066g.setText(rendering.h());
            TextView title = jVar.f55066g;
            Intrinsics.checkNotNullExpressionValue(title, "title");
            lq.s.e(title);
        }
        if (rendering.b().length() == 0) {
            jVar.f55062c.setVisibility(8);
        } else {
            jVar.f55062c.setText(rendering.b());
        }
        ...
        if (remoteImage != null && this.f49641c == null) {
            ConstraintLayout animationContainer = this.f49640b.f55061b;
            Intrinsics.checkNotNullExpressionValue(animationContainer, "animationContainer");
            this.f49641c = wq.b.c(remoteImage, animationContainer, false, 2, null);
            jVar.f55065f.setVisibility(8);
        }
