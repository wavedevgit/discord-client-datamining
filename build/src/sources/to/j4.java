...
public final class j4 implements Parcelable {
    ...
    private final Map f49899d;

    /* loaded from: /home/runner/work/discord-client-datamining/discord-client-datamining/build/classes4.dex */
    public static final class a {

        /* renamed from: a  reason: collision with root package name */
        private final Map f49900a = new LinkedHashMap();

        public final j4 a() {
            return new j4(this.f49900a);
        }

        public final void b(String str, String str2, c4.e side, String text) {
            Intrinsics.checkNotNullParameter(side, "side");
            Intrinsics.checkNotNullParameter(text, "text");
            Map map = this.f49900a;
    ...
    public boolean equals(Object obj) {
        ...
        if ((obj instanceof j4) && Intrinsics.areEqual(this.f49899d, ((j4) obj).f49899d)) {
            return true;
        }
        return false;
    }
