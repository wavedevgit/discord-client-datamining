...
public final class j4 implements Parcelable {
    ...
    public static final class a {
        ...
        private final Map f49332a = new LinkedHashMap();

        public final j4 a() {
            return new j4(this.f49332a);
        }

        public final void b(String str, String str2, c4.e side, String text) {
            Intrinsics.checkNotNullParameter(side, "side");
            Intrinsics.checkNotNullParameter(text, "text");
            Map map = this.f49332a;
    ...
    public boolean equals(Object obj) {
        ...
        if ((obj instanceof j4) && Intrinsics.areEqual(this.f49331d, ((j4) obj).f49331d)) {
            return true;
        }
        return false;
    }
