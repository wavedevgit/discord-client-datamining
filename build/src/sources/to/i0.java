...
public final class i0 implements gn.c0 {
    ...
    private final /* synthetic */ gn.f f49312a;

    /* renamed from: b  reason: collision with root package name */
    private final fo.f0 f49313b;

    /* renamed from: c  reason: collision with root package name */
    private final fo.t f49314c;
    ...
    public static final class b implements fo.y {
        ...
        /* renamed from: a  reason: collision with root package name */
        final /* synthetic */ xo.b f49315a;

        /* renamed from: b  reason: collision with root package name */
        final /* synthetic */ f5.b f49316b;

        /* renamed from: c  reason: collision with root package name */
        final /* synthetic */ fo.t f49317c;

        /* renamed from: d  reason: collision with root package name */
        final /* synthetic */ fo.f0 f49318d;
        ...
        @Override // fo.y
        public void a() {
            PreviewView previewView = this.f49315a.f54976y;
            Intrinsics.checkNotNullExpressionValue(previewView, "previewView");
            this.f49317c.f(previewView, t.a.f24107e, this.f49318d, true, this.f49316b.x());
        }
    }
    ...
    public i0(final fo.f0 governmentIdFeed, final fo.t cameraPreview) {
        ...
        this.f49312a = new gn.f(Reflection.getOrCreateKotlinClass(f5.b.class), new Function4() { // from class: to.h0
        ...
        this.f49313b = governmentIdFeed;
        this.f49314c = cameraPreview;
    }
    ...
    public static final View c(fo.f0 f0Var, fo.t tVar, f5.b initialRendering, gn.a0 initialViewEnvironment, Context context, ViewGroup viewGroup) {
        ...
        if (initialRendering.G() != lo.a.f35949e && initialRendering.G() != lo.a.f35948d) {
            z.a h10 = initialRendering.h();
            PreviewView previewView = c10.f54976y;
            Intrinsics.checkNotNullExpressionValue(previewView, "previewView");
            ...
            ho.m b10 = ho.j.b(applicationContext, ho.n.f27614e);
            if (b10 == null) {
                initialRendering.x().invoke(new fo.s0());
                Camera2PreviewView camera2Preview = c10.f54954c;
                ...
                Camera2PreviewView camera2Preview2 = c10.f54954c;
    ...
    public View a(f5.b initialRendering, gn.a0 initialViewEnvironment, Context contextForNewView, ViewGroup viewGroup) {
        ...
        return this.f49312a.a(initialRendering, initialViewEnvironment, contextForNewView, viewGroup);
    }

    @Override // gn.c0
    public KClass getType() {
        return this.f49312a.getType();
    }
}
