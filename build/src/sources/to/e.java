...
public final class e extends com.google.android.material.bottomsheet.b {
    ...
    public static final a f50882i = new a(null);
    ...
    private final void H(StepStyle stepStyle, uo.a aVar, boolean z10) {
        ...
        if (stepStyle != null && (titleStyleValue = stepStyle.getTitleStyleValue()) != null) {
            TextView hintTitle = aVar.f51642f;
        ...
        if (stepStyle != null && (textStyleValue = stepStyle.getTextStyleValue()) != null) {
            TextView hintMessage = aVar.f51641e;
        ...
        if (stepStyle != null && (cancelDialogCloseStyleValue = stepStyle.getCancelDialogCloseStyleValue()) != null) {
            Button closeButton = aVar.f51639c;
            Intrinsics.checkNotNullExpressionValue(closeButton, "closeButton");
            iq.e.f(closeButton, cancelDialogCloseStyleValue, false, !z10, 2, null);
        }
        if (stepStyle != null && (cancelDialogResumeStyleValue = stepStyle.getCancelDialogResumeStyleValue()) != null) {
            Button retryButton = aVar.f51643g;
            Intrinsics.checkNotNullExpressionValue(retryButton, "retryButton");
            iq.e.f(retryButton, cancelDialogResumeStyleValue, false, !z10, 2, null);
        }
    }
    ...
    public static final void L(Dialog dialog, e eVar, DialogInterface dialogInterface) {
        StepStyle stepStyle;
        ViewGroup viewGroup = (ViewGroup) dialog.findViewById(f.f55630f);
        ...
        ConstraintLayout bottomSheetContent = eVar.J().f51638b;
        Intrinsics.checkNotNullExpressionValue(bottomSheetContent, "bottomSheetContent");
        iq.c.c(viewGroup, stepStyle2, bottomSheetContent, null, 4, null);
    }

    /* JADX INFO: Access modifiers changed from: private */
    public static final Unit M(uo.a aVar, e eVar, n.b.a aVar2) {
        boolean z10 = true;
        if (aVar.f51639c.getLineCount() <= 1 && aVar.f51643g.getLineCount() <= 1) {
            z10 = false;
        } else {
            Button closeButton = aVar.f51639c;
            Intrinsics.checkNotNullExpressionValue(closeButton, "closeButton");
            ...
            if (layoutParams != null) {
                layoutParams.width = aVar.f51640d.getWidth();
                closeButton.setLayoutParams(layoutParams);
                Button retryButton = aVar.f51643g;
                Intrinsics.checkNotNullExpressionValue(retryButton, "retryButton");
                ViewGroup.LayoutParams layoutParams2 = retryButton.getLayoutParams();
                if (layoutParams2 != null) {
                    layoutParams2.width = aVar.f51640d.getWidth();
                    retryButton.setLayoutParams(layoutParams2);
                    aVar.f51640d.setReferencedIds(new int[]{aVar.f51639c.getId(), aVar.f51643g.getId()});
                } else {
    ...
    public Dialog onCreateDialog(Bundle bundle) {
        ...
        onCreateDialog.setOnShowListener(new DialogInterface.OnShowListener() { // from class: to.d
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup viewGroup, Bundle bundle) {
        ...
        P(uo.a.c(inflater, viewGroup, false));
        ...
        if (I != null) {
            ...
            if (dialog != null && (window = dialog.getWindow()) != null) {
                ...
                if (f10 != null && (backgroundColorValue = f10.getBackgroundColorValue()) != null) {
                    ...
                    d10 = s.d(context, zg.b.f55558o, null, false, 6, null);
                }
                pp.f0.a(window, d10);
            }
            final uo.a J = J();
            String g10 = I.g();
            if (g10 != null) {
                J.f51642f.setText(g10);
            }
            String d11 = I.d();
            if (d11 != null) {
                J.f51641e.setText(d11);
            }
            String a10 = I.a();
            if (a10 != null) {
                J.f51639c.setText(a10);
            }
            String e10 = I.e();
            if (e10 != null) {
                J.f51643g.setText(e10);
            }
            J.f51643g.setOnClickListener(new View.OnClickListener() { // from class: to.a
                @Override // android.view.View.OnClickListener
                public final void onClick(View view2) {
                    e.N(e.this, view2);
                }
            });
            J.f51639c.setOnClickListener(new View.OnClickListener() { // from class: to.b
                @Override // android.view.View.OnClickListener
                public final void onClick(View view2) {
                    e.O(e.this, I, view2);
                }
            });
            Button closeButton = J.f51639c;
            Intrinsics.checkNotNullExpressionValue(closeButton, "closeButton");
            zp.s.b(closeButton, new Function0() { // from class: to.c
                @Override // kotlin.jvm.functions.Function0
                public final Object invoke() {
                    Unit M;
                    M = e.M(uo.a.this, this, I);
                    return M;
                }
            });
            return;
