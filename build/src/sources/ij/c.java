...
public class c {
    ...
    private File a() {
        if (this.f26904a == null) {
            synchronized (this) {
                try {
                    if (this.f26904a == null) {
                        File filesDir = this.f26905b.j().getFilesDir();
                        this.f26904a = new File(filesDir, "PersistedInstallation." + this.f26905b.n() + ".json");
                    }
                } finally {
                }
            }
    ...
    public d b(d dVar) {
        ...
        try {
            ...
            createTempFile = File.createTempFile("PersistedInstallation", "tmp", this.f26905b.j().getFilesDir());
