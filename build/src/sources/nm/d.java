...
public final class d {
    ...
    public static final a f41860c = new a(null);

    /* renamed from: a  reason: collision with root package name */
    private final ReactApplicationContext f41861a;
    ...
    private final int f() {
        ...
        Activity currentActivity = this.f41861a.getCurrentActivity();
    ...
    public static final void l(d dVar, int i10) {
        ...
        Window window;
        if (dVar.f() != i10 && (currentActivity = dVar.f41861a.getCurrentActivity()) != null && (window = currentActivity.getWindow()) != null) {
            window.setSoftInputMode(i10);
        }
    }

    public final void d(final boolean z10) {
        final Activity currentActivity = this.f41861a.getCurrentActivity();
        final EditText b10 = om.a.f44546a.b();
        if (b10 != null) {
