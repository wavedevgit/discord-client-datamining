...
public abstract class s extends hk.a {

    /* renamed from: o  reason: collision with root package name */
    private static Map f26302o = new ConcurrentHashMap();

    /* renamed from: e  reason: collision with root package name */
    private int f26303e = -1;

    /* renamed from: i  reason: collision with root package name */
    protected e1 f26304i = e1.c();

    /* loaded from: /home/runner/work/discord-client-datamining/discord-client-datamining/build/classes4.dex */
    public static abstract class a extends a.AbstractC0383a {

        /* renamed from: d  reason: collision with root package name */
        private final s f26305d;
    ...
    /* loaded from: /home/runner/work/discord-client-datamining/discord-client-datamining/build/classes4.dex */
    protected static class b extends hk.b {

        /* renamed from: b  reason: collision with root package name */
        private final s f26307b;
    ...
    private static s A(s sVar, InputStream inputStream, l lVar) {
        try {
            ...
            g f10 = g.f(new a.AbstractC0383a.C0384a(inputStream, g.v(read, inputStream)));
            s B = B(sVar, f10, lVar);
            try {
                f10.a(0);
                return B;
    ...
    public static s l(Class cls) {
        s sVar = (s) f26302o.get(cls);
        if (sVar == null) {
            try {
                Class.forName(cls.getName(), true, cls.getClassLoader());
                sVar = (s) f26302o.get(cls);
        ...
        if (sVar == null) {
            ...
            if (defaultInstanceForType != null) {
                f26302o.put(cls, defaultInstanceForType);
    ...
    void E(int i10) {
        if (i10 >= 0) {
            this.f26303e = (i10 & Integer.MAX_VALUE) | (this.f26303e & Integer.MIN_VALUE);
            return;
        }
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    public boolean t() {
        if ((this.f26303e & Integer.MIN_VALUE) != 0) {
            return true;
        }
        return false;
    }
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    public void v() {
        this.f26303e &= Integer.MAX_VALUE;
    }
