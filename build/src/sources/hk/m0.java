...
final class m0 implements x0 {
    ...
    private final i0 f26293a;

    /* renamed from: b  reason: collision with root package name */
    private final d1 f26294b;

    /* renamed from: c  reason: collision with root package name */
    private final boolean f26295c;

    /* renamed from: d  reason: collision with root package name */
    private final m f26296d;

    private m0(d1 d1Var, m mVar, i0 i0Var) {
        this.f26294b = d1Var;
        this.f26295c = mVar.d(i0Var);
        this.f26296d = mVar;
        this.f26293a = i0Var;
    }
    ...
    private boolean j(w0 w0Var, l lVar, m mVar, p pVar, d1 d1Var, Object obj) {
        ...
        if (tag != j1.f26236a) {
            if (j1.b(tag) == 2) {
                Object a10 = mVar.a(lVar, this.f26293a, j1.a(tag));
                if (a10 != null) {
        ...
        while (w0Var.z() != Integer.MAX_VALUE) {
            ...
            if (tag2 == j1.f26238c) {
                i10 = w0Var.g();
                obj2 = mVar.a(lVar, this.f26293a, i10);
            } else if (tag2 == j1.f26239d) {
                if (obj2 != null) {
    ...
    public void a(Object obj, Object obj2) {
        z0.g(this.f26294b, obj, obj2);
        if (this.f26295c) {
            z0.e(this.f26296d, obj, obj2);
        }
    }
    ...
    public final boolean c(Object obj) {
        return this.f26296d.b(obj).b();
    }

    @Override // hk.x0
    public Object d() {
        i0 i0Var = this.f26293a;
    ...
    public int e(Object obj) {
        int hashCode = this.f26294b.g(obj).hashCode();
        if (this.f26295c) {
            return (hashCode * 53) + this.f26296d.b(obj).hashCode();
        }
        return hashCode;
    }
    ...
    public boolean f(Object obj, Object obj2) {
        if (!this.f26294b.g(obj).equals(this.f26294b.g(obj2))) {
            return false;
        }
        if (this.f26295c) {
            return this.f26296d.b(obj).equals(this.f26296d.b(obj2));
        }
        return true;
    }
    ...
    public void g(Object obj, w0 w0Var, l lVar) {
        h(this.f26294b, this.f26296d, obj, w0Var, lVar);
    }
}
