...
public abstract class i1 {
    ...
    private static final b f26235a;
        ...
        */
        int c(int r7, byte[] r8, int r9, int r10) {
            ...
            L86:
                ...
                return r7
            */
            throw new UnsupportedOperationException("Method not decompiled: hk.i1.c.c(int, byte[], int, int):int");
        }
    }
    ...
    static final class d extends b {
        ...
        */
        private static int e(byte[] r10, long r11, int r13) {
            ...
            L6d:
                ...
                r0 = 3
                long r11 = r11 + r0
                byte r0 = hk.h1.s(r10, r8)
                if (r0 <= r6) goto L7
            L8f:
                return r5
            */
            throw new UnsupportedOperationException("Method not decompiled: hk.i1.d.e(byte[], long, int):int");
        }
        ...
        private static int f(byte[] bArr, long j10, int i10) {
            ...
            while (true) {
                int i13 = i11 + 8;
                if (i13 > i10 || (h1.y(bArr, h1.f26218h + j10) & (-9187201950435737472L)) != 0) {
                    break;
                }
                j10 += 8;
                i11 = i13;
        ...
        /* JADX WARN: Code restructure failed: missing block: B:35:0x0058, code lost:
            if (hk.h1.s(r12, r0) > (-65)) goto L36;
         */
        /* JADX WARN: Code restructure failed: missing block: B:58:0x009e, code lost:
            if (hk.h1.s(r12, r0) > (-65)) goto L56;
         */
        @Override // hk.i1.b
        /*
            Code decompiled incorrectly, please refer to instructions dump.
        ...
        */
        int c(int r11, byte[] r12, int r13, int r14) {
            ...
            */
            throw new UnsupportedOperationException("Method not decompiled: hk.i1.d.c(int, byte[], int, int):int");
        }
    }
    ...
    public static boolean j(byte[] bArr) {
        return f26235a.b(bArr, 0, bArr.length);
    }

    /* JADX INFO: Access modifiers changed from: package-private */
    public static boolean k(byte[] bArr, int i10, int i11) {
        return f26235a.b(bArr, i10, i11);
    }
}
