...
public abstract class f implements Iterable, Serializable {
    ...
    public static final f f26165e = new i(u.f26325d);

    /* renamed from: i  reason: collision with root package name */
    private static final InterfaceC0385f f26166i;

    /* renamed from: o  reason: collision with root package name */
    private static final Comparator f26167o;

    /* renamed from: d  reason: collision with root package name */
    private int f26168d = 0;
    ...
    public class a extends c {
        ...
        a() {
            this.f26170e = f.this.size();
        }

        @Override // java.util.Iterator
        public boolean hasNext() {
            if (this.f26169d < this.f26170e) {
                return true;
            }
            return false;
        }
    ...
    /* loaded from: /home/runner/work/discord-client-datamining/discord-client-datamining/build/classes4.dex */
    private static final class d implements InterfaceC0385f {
        private d() {
        }

        @Override // hk.f.InterfaceC0385f
    ...
    public static final class e extends i {
        ...
        @Override // hk.f.i, hk.f
        public byte c(int i10) {
            f.d(i10, size());
            return this.f26174p[this.f26172q + i10];
        }
    ...
    public static class i extends h {
            ...
            if (i11 <= fVar.size()) {
                ...
                if (i12 <= fVar.size()) {
                    if (fVar instanceof i) {
                        i iVar = (i) fVar;
                        byte[] bArr = this.f26174p;
                        byte[] bArr2 = iVar.f26174p;
                        int B = B() + i11;
                        int B2 = B();
                        int B3 = iVar.B() + i10;
                        while (B2 < B) {
        ...
        public final boolean j() {
            int B = B();
            return i1.k(this.f26174p, B, size() + B);
        }

        @Override // hk.f
        protected final int o(int i10, int i11, int i12) {
            return u.h(i10, this.f26174p, B() + i11, i12);
        }
        ...
        public final f q(int i10, int i11) {
            ...
            return new e(this.f26174p, B() + i10, e10);
        }

        @Override // hk.f
        public int size() {
            return this.f26174p.length;
        }

        @Override // hk.f
        protected final String t(Charset charset) {
            return new String(this.f26174p, B(), size(), charset);
        }
    }

    /* loaded from: /home/runner/work/discord-client-datamining/discord-client-datamining/build/classes4.dex */
    private static final class j implements InterfaceC0385f {
        private j() {
        }
    ...
    public static f g(byte[] bArr, int i10, int i11) {
        ...
        return new i(f26166i.a(bArr, i10, i11));
    }

    public static f h(String str) {
        return new i(str.getBytes(u.f26323b));
    }
