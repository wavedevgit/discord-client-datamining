...
final class l0 implements x0 {
    ...
    private static final int[] f26274r = new int[0];

    /* renamed from: s  reason: collision with root package name */
    private static final Unsafe f26275s = h1.B();
    ...
    private final n0 f26288m;

    /* renamed from: n  reason: collision with root package name */
    private final y f26289n;

    /* renamed from: o  reason: collision with root package name */
    private final d1 f26290o;

    /* renamed from: p  reason: collision with root package name */
    private final m f26291p;

    /* renamed from: q  reason: collision with root package name */
    private final d0 f26292q;
    ...
    private l0(int[] iArr, Object[] objArr, int i10, int i11, i0 i0Var, boolean z10, boolean z11, int[] iArr2, int i12, int i13, n0 n0Var, y yVar, d1 d1Var, m mVar, d0 d0Var) {
        ...
        this.f26278c = i10;
        this.f26279d = i11;
        this.f26282g = i0Var instanceof s;
        this.f26283h = z10;
    ...
    private void C(Object obj, Object obj2, int i10) {
        ...
        switch (b0(c02)) {
            ...
            case ChatViewRecyclerTypes.MEDIA_ATTACHMENT_MOSAIC_IMAGE /* 49 */:
                this.f26289n.d(obj, obj2, J);
                return;
            case 50:
                z0.f(this.f26292q, obj, obj2, J);
                return;
    ...
    private Object D(Object obj, int i10) {
        ...
        Object object = f26275s.getObject(obj, J);
        if (u(object)) {
            return object;
        }
        Object d10 = n10.d();
    ...
    private Object E(Object obj, int i10, int i11) {
        ...
        Object object = f26275s.getObject(obj, J(c0(i11)));
        if (u(object)) {
            return object;
        }
        Object d10 = n10.d();
    ...
    */
    static hk.l0 H(hk.v0 r33, hk.n0 r34, hk.y r35, hk.d1 r36, hk.m r37, hk.d0 r38) {
        /*
            Method dump skipped, instructions count: 977
            To view this dump add '--comments-level debug' option
        */
        throw new UnsupportedOperationException("Method not decompiled: hk.l0.H(hk.v0, hk.n0, hk.y, hk.d1, hk.m, hk.d0):hk.l0");
    }

    private int I(int i10) {
        return this.f26276a[i10];
    }
    ...
    private int P(int i10) {
        if (i10 >= this.f26278c && i10 <= this.f26279d) {
            return Y(i10, 0);
        }
        return -1;
    }
    ...
    private void U(Object obj, int i10, w0 w0Var) {
        if (o(i10)) {
            w0Var.m(this.f26289n.e(obj, J(i10)));
        } else {
            w0Var.A(this.f26289n.e(obj, J(i10)));
        }
    }
    ...
    private int Y(int i10, int i11) {
        int length = (this.f26276a.length / 3) - 1;
        while (i11 <= length) {
    ...
    private void Z(Object obj, int i10, Object obj2) {
        f26275s.putObject(obj, J(c0(i10)), obj2);
        W(obj, i10);
    }

    private void a0(Object obj, int i10, int i11, Object obj2) {
        f26275s.putObject(obj, J(c0(i11)), obj2);
        X(obj, i10, i11);
    }
    ...
    private u.a l(int i10) {
        android.support.v4.media.session.b.a(this.f26277b[((i10 / 3) * 2) + 1]);
        return null;
    }

    private Object m(int i10) {
        return this.f26277b[(i10 / 3) * 2];
    }

    private x0 n(int i10) {
        int i11 = (i10 / 3) * 2;
        x0 x0Var = (x0) this.f26277b[i11];
        if (x0Var != null) {
            return x0Var;
        }
        x0 c10 = t0.a().c((Class) this.f26277b[i11 + 1]);
        this.f26277b[i11] = c10;
        return c10;
    }
        ...
        if (j10 == 1048575) {
            ...
            switch (b0(c02)) {
                ...
                case 9:
                    ...
                    return true;
                case 10:
                    equals = f.f26165e.equals(h1.A(obj, J));
                    break;
                case 11:
                    if (h1.x(obj, J) == 0) {
                        return false;
    ...
    private boolean t(Object obj, int i10, int i11) {
        Map e10 = this.f26292q.e(h1.A(obj, J(i10)));
        if (e10.isEmpty()) {
            return true;
        }
        if (this.f26292q.b(m(i11)).f26149c.a() != j1.c.MESSAGE) {
            return true;
        }
        x0 x0Var = null;
    ...
    /* JADX WARN: Code restructure failed: missing block: B:51:0x00a9, code lost:
        if (r0 >= r9.f26287l) goto L293;
     */
    /* JADX WARN: Code restructure failed: missing block: B:52:0x00ab, code lost:
        r1 = r9;
        r4 = r1.k(r2, r9.f26285j[r0], r4, r17, r19);
        r6 = r17;
        r0 = r0 + 1;
        r9 = r1;
     */
    ...
    /*
        ...
        To view partially-correct add '--show-bad-code' argument
    */
    private void y(hk.d1 r17, hk.m r18, java.lang.Object r19, hk.w0 r20, hk.l r21) {
        /*
            Method dump skipped, instructions count: 2052
            To view this dump add '--comments-level debug' option
        */
        throw new UnsupportedOperationException("Method not decompiled: hk.l0.y(hk.d1, hk.m, java.lang.Object, hk.w0, hk.l):void");
    }
    ...
    private final void z(Object obj, int i10, Object obj2, l lVar, w0 w0Var) {
        ...
        Object A = h1.A(obj, J);
        if (A == null) {
            A = this.f26292q.d(obj2);
            h1.O(obj, J, A);
        } else if (this.f26292q.g(A)) {
            Object d10 = this.f26292q.d(obj2);
            this.f26292q.a(d10, A);
            h1.O(obj, J, d10);
            A = d10;
        }
        w0Var.K(this.f26292q.c(A), this.f26292q.b(obj2), lVar);
    }
    ...
    public void a(Object obj, Object obj2) {
        i(obj);
        obj2.getClass();
        for (int i10 = 0; i10 < this.f26276a.length; i10 += 3) {
            C(obj, obj2, i10);
        }
        z0.g(this.f26290o, obj, obj2);
        if (this.f26281f) {
            z0.e(this.f26291p, obj, obj2);
        }
    }
                ...
                if (b02 != 9) {
                    if (b02 != 60 && b02 != 68) {
                        switch (b02) {
                            ...
                            case 48:
                            case ChatViewRecyclerTypes.MEDIA_ATTACHMENT_MOSAIC_IMAGE /* 49 */:
                                this.f26289n.c(obj, J);
                                break;
                            case 50:
                                Unsafe unsafe = f26275s;
                                Object object = unsafe.getObject(obj, J);
                                if (object != null) {
                                    unsafe.putObject(obj, J, this.f26292q.f(object));
                                    break;
                                } else {
                                    break;
                                }
                        ...
                        n(i10).b(f26275s.getObject(obj, J));
                    }
                }
                if (p(obj, i10)) {
                    n(i10).b(f26275s.getObject(obj, J));
    ...
    public final boolean c(Object obj) {
        ...
        int i13 = 0;
        int i14 = 0;
        while (i13 < this.f26286k) {
            int i15 = this.f26285j[i13];
            int I = I(i15);
            int c02 = c0(i15);
            int i16 = this.f26276a[i15 + 2];
            int i17 = i16 & 1048575;
            int i18 = 1 << (i16 >>> 20);
            if (i17 != i12) {
                if (i17 != 1048575) {
                    i14 = f26275s.getInt(obj, i17);
                }
                i11 = i14;
                i10 = i17;
            } else {
        ...
        Object obj3 = obj;
        if (this.f26281f && !this.f26291p.b(obj3).b()) {
            return false;
        }
        return true;
    }
    ...
    @Override // hk.x0
    public Object d() {
        return this.f26288m.a(this.f26280e);
    }
    ...
    public int e(Object obj) {
        ...
        int hashCode = (i11 * 53) + this.f26290o.g(obj).hashCode();
        if (this.f26281f) {
            return (hashCode * 53) + this.f26291p.b(obj).hashCode();
        }
        return hashCode;
    }
    ...
    public boolean f(Object obj, Object obj2) {
        ...
        if (!this.f26290o.g(obj).equals(this.f26290o.g(obj2))) {
            return false;
        }
        if (this.f26281f) {
            return this.f26291p.b(obj).equals(this.f26291p.b(obj2));
        }
        return true;
    }
    ...
    public void g(Object obj, w0 w0Var, l lVar) {
        lVar.getClass();
        i(obj);
        y(this.f26290o, this.f26291p, obj, w0Var, lVar);
    }
}
