...
public final class c implements tu.b, b {
    ...
    private final String j(List list, int i10, int i11) {
        ...
        try {
            ...
            if (list.size() == 2) {
                x02 = f24832a.i(x02, i10);
            } else if (list.size() > 2) {
                x02 = f24832a.d(x02, i10, i11);
            }
            b10 = Result.b(x02);
        } catch (Throwable th2) {
    ...
    public String f(Object obj, Object obj2) {
        List c10 = dw.a.c(obj);
        return f24832a.j(c10, d.b(String.valueOf(dw.c.b(c10))), d.b(String.valueOf(dw.c.c(c10))));
    }
