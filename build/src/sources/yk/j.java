...
public abstract class j {
    ...
    private static final zk.a f55515a = new zk.a();
    ...
    */
    private static int c(lk.b r5, int r6, int r7, boolean r8, int r9, int r10) {
        /*
            if (r8 == 0) goto L4
            r0 = -1
            goto L5
        ...
        L28:
            return r2
        */
        throw new UnsupportedOperationException("Method not decompiled: yk.j.c(lk.b, int, int, boolean, int, int):int");
    }
    ...
    private static int e(int[] iArr, int[] iArr2, int i10) {
        if ((iArr2 == null || iArr2.length <= (i10 / 2) + 3) && i10 >= 0 && i10 <= 512) {
            return f55515a.a(iArr, i10, iArr2);
        }
        throw hk.d.a();
    }
    ...
    private static lk.e g(f fVar) {
        ...
        return h(fVar.k(), iArr, xk.a.b(arrayList), xk.a.b(arrayList3), iArr2);
    }

    private static lk.e h(int i10, int[] iArr, int[] iArr2, int[] iArr3, int[][] iArr4) {
    ...
    /*
        ...
        To view partially-correct add '--show-bad-code' argument
    */
    public static lk.e i(lk.b r17, hk.p r18, hk.p r19, hk.p r20, hk.p r21, int r22, int r23) {
        /*
            Method dump skipped, instructions count: 265
            To view this dump add '--comments-level debug' option
        */
        throw new UnsupportedOperationException("Method not decompiled: yk.j.i(lk.b, hk.p, hk.p, hk.p, hk.p, int, int):lk.e");
    }

    private static lk.e j(int[] iArr, int i10, int[] iArr2) {
        if (iArr.length != 0) {
            int i11 = 1 << (i10 + 1);
            int e10 = e(iArr, iArr2, i11);
            w(iArr, i11);
            lk.e b10 = e.b(iArr, String.valueOf(i10));
    ...
    private static d k(lk.b bVar, int i10, int i11, boolean z10, int i12, int i13, int i14, int i15) {
        int i16;
        int d10;
        int a10;
        ...
        if (!d(d11, i14, i15) || (a10 = xk.a.a((d10 = i.d(q10)))) == -1) {
            return null;
        }
    ...
    /*
        ...
        To view partially-correct add '--show-bad-code' argument
    */
    private static int[] q(lk.b r7, int r8, int r9, boolean r10, int r11, int r12) {
        /*
            r0 = 8
            int[] r1 = new int[r0]
            r2 = 1
        ...
        L34:
            return r1
        */
        throw new UnsupportedOperationException("Method not decompiled: yk.j.q(lk.b, int, int, boolean, int, int):int[]");
    }
    ...
    private static h s(lk.b bVar, c cVar, p pVar, boolean z10, int i10, int i11) {
        int i12;
        int b10;
