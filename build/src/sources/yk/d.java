...
public final class d extends p {
    ...
    public boolean f(float f10, float f11, float f12) {
        ...
        float abs = Math.abs(f10 - this.f54820c);
        if (abs > 1.0f && abs > this.f54820c) {
            return false;
        }
        return true;
    }
    ...
    public d g(float f10, float f11, float f12) {
        ...
        float c10 = (i10 * c()) + f11;
        float f13 = i11;
        return new d(c10 / f13, ((this.f54821d * d()) + f10) / f13, ((this.f54821d * this.f54820c) + f12) / f13, i11);
    }
