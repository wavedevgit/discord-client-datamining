...
final class f {
    ...
    public f(a aVar, c cVar) {
        ...
        this.f55462d = a10;
        this.f55461c = cVar;
        this.f55460b = new g[a10 + 2];
    }

    private void a(g gVar) {
        if (gVar != null) {
            ((h) gVar).g(this.f55459a);
        }
    }
    ...
    private int d() {
        ...
        for (int i10 = 1; i10 < this.f55462d + 1; i10++) {
            d[] d10 = this.f55460b[i10].d();
    ...
    private void e(int i10, int i11, d[] dVarArr) {
        d[] dVarArr2;
        d dVar = dVarArr[i11];
        d[] d10 = this.f55460b[i10 - 1].d();
        g gVar = this.f55460b[i10 + 1];
        if (gVar != null) {
            dVarArr2 = gVar.d();
        } else {
            dVarArr2 = d10;
    ...
    private void g() {
        g[] gVarArr = this.f55460b;
        g gVar = gVarArr[0];
        if (gVar != null && gVarArr[this.f55462d + 1] != null) {
            d[] d10 = gVar.d();
            d[] d11 = this.f55460b[this.f55462d + 1].d();
            for (int i10 = 0; i10 < d10.length; i10++) {
                d dVar = d10[i10];
                if (dVar != null && d11[i10] != null && dVar.c() == d11[i10].c()) {
                    for (int i11 = 1; i11 <= this.f55462d; i11++) {
                        d dVar2 = this.f55460b[i11].d()[i10];
                        if (dVar2 != null) {
                            dVar2.i(d10[i10].c());
                            if (!dVar2.g()) {
                                this.f55460b[i11].d()[i10] = null;
                            }
                        }
                    }
                }
    ...
    private int h() {
        ...
        for (int i11 = 0; i11 < d10.length; i11++) {
            ...
            if (dVar != null) {
                int c10 = dVar.c();
                int i12 = 0;
                for (int i13 = 1; i13 < this.f55462d + 1 && i12 < 2; i13++) {
                    d dVar2 = this.f55460b[i13].d()[i11];
                    if (dVar2 != null) {
                        i12 = c(c10, i12, dVar2);
                        if (!dVar2.g()) {
                            i10++;
    ...
    private int i() {
        ...
        for (int i12 = 0; i12 < d10.length; i12++) {
            ...
            if (dVar != null) {
                int c10 = dVar.c();
                int i13 = 0;
                for (int i14 = this.f55462d + 1; i14 > 0 && i13 < 2; i14--) {
                    d dVar2 = this.f55460b[i14].d()[i12];
                    if (dVar2 != null) {
                        i13 = c(c10, i13, dVar2);
                        if (!dVar2.g()) {
                            i11++;
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    public g n(int i10) {
        return this.f55460b[i10];
    }

    /* JADX INFO: Access modifiers changed from: package-private */
    public g[] o() {
        a(this.f55460b[0]);
        a(this.f55460b[this.f55462d + 1]);
        int i10 = 928;
        while (true) {
            int d10 = d();
            if (d10 <= 0 || d10 >= i10) {
    ...
    public String toString() {
        ...
        g gVar = gVarArr[0];
        if (gVar == null) {
            gVar = gVarArr[this.f55462d + 1];
        }
        Formatter formatter = new Formatter();
        for (int i10 = 0; i10 < gVar.d().length; i10++) {
            try {
                formatter.format("CW %3d:", Integer.valueOf(i10));
                for (int i11 = 0; i11 < this.f55462d + 2; i11++) {
                    g gVar2 = this.f55460b[i11];
                    if (gVar2 == null) {
