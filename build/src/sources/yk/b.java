...
final class b {
    ...
    private final int f54807f;

    /* renamed from: g  reason: collision with root package name */
    private final float f54808g;

    /* renamed from: b  reason: collision with root package name */
    private final List f54803b = new ArrayList(5);

    /* renamed from: h  reason: collision with root package name */
    private final int[] f54809h = new int[3];
    ...
    private float b(int i10, int i11, int i12, int i13) {
        gk.b bVar = this.f54802a;
        int i14 = bVar.i();
        int[] iArr = this.f54809h;
        iArr[0] = 0;
        iArr[1] = 0;
        iArr[2] = 0;
        int i15 = i10;
    ...
    private a e(int[] iArr, int i10, int i11) {
        ...
        if (!Float.isNaN(b10)) {
            ...
            for (a aVar : this.f54803b) {
                if (aVar.f(f10, b10, a10)) {
                    return aVar.g(b10, a10, f10);
                }
            }
            this.f54803b.add(new a(a10, b10, f10));
            return null;
        }
        return null;
    }
    ...
    public a c() {
        ...
        a e10;
        a e11;
        int i11 = this.f54804c;
        int i12 = this.f54807f;
        int i13 = this.f54806e + i11;
        int i14 = this.f54805d + (i12 / 2);
        int[] iArr = new int[3];
        for (int i15 = 0; i15 < i12; i15++) {
            ...
            iArr[2] = 0;
            int i17 = i11;
            while (i17 < i13 && !this.f54802a.e(i17, i16)) {
                i17++;
            }
            int i18 = 0;
            while (i17 < i13) {
                if (this.f54802a.e(i17, i16)) {
                    if (i18 == 1) {
                        iArr[1] = iArr[1] + 1;
                    } else if (i18 == 2) {
