...
public abstract class a {
    ...
    private static final int[] f54792a = {0, 4, 1, 5};

    /* renamed from: b  reason: collision with root package name */
    private static final int[] f54793b = {6, 2, 7, 3};

    /* renamed from: c  reason: collision with root package name */
    private static final int[] f54794c = {8, 1, 1, 1, 1, 1, 1, 3};

    /* renamed from: d  reason: collision with root package name */
    private static final int[] f54795d = {7, 1, 1, 3, 1, 1, 1, 2, 1};

    /* renamed from: e  reason: collision with root package name */
    private static final int[] f54796e = {0, 180, 270, 90};

    private static jk.b a(jk.b bVar, int i10) {
        if (i10 % 360 == 0) {
            return bVar;
        }
        jk.b clone = bVar.clone();
        clone.m(i10);
        return clone;
    }
    ...
    */
    private static java.util.List c(boolean r8, jk.b r9) {
        /*
        ...
        L7a:
            return r0
        */
        throw new UnsupportedOperationException("Method not decompiled: yk.a.c(boolean, jk.b):java.util.List");
    }
    ...
    private static int[] e(jk.b bVar, int i10, int i11, int i12, int[] iArr, int[] iArr2) {
    ...
    private static p[] f(jk.b bVar, int i10, int i11, int i12, int i13, int i14, int[] iArr) {
        int i15;
        boolean z10;
        int[] e10;
        p[] pVarArr = new p[4];
    ...
    private static p[] g(jk.b bVar, int i10, int i11) {
        int i12 = bVar.i();
        int l10 = bVar.l();
        p[] pVarArr = new p[8];
        int i13 = 10;
        int i14 = i10;
        int i15 = i11;
        b(pVarArr, f(bVar, i12, l10, i14, i15, 10, f54794c), f54792a);
        p pVar = pVarArr[4];
        if (pVar != null) {
            int c10 = (int) pVar.c();
        ...
        b(pVarArr, f(bVar, i12, l10, i14, i15, i13, f54795d), f54793b);
        return pVarArr;
    }
