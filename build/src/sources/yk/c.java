...
public class c {
    ...
    private static int c(p pVar, p pVar2, p pVar3, float f10) {
        int c10 = (hk.a.c(p.b(pVar, pVar2) / f10) + hk.a.c(p.b(pVar, pVar3) / f10)) / 2;
        int i10 = c10 + 7;
        int i11 = i10 & 3;
        if (i11 != 0) {
            if (i11 != 2) {
    ...
    private static gk.b h(gk.b bVar, m mVar, int i10) {
        return gk.k.b().d(bVar, i10, i10, mVar);
    }
    ...
    private float j(int i10, int i11, int i12, int i13) {
        ...
        if (i15 < 0) {
            f10 = i10 / (i10 - i15);
            i15 = 0;
        } else if (i15 >= this.f54819a.l()) {
            f10 = ((this.f54819a.l() - 1) - i10) / (i15 - i10);
            i15 = this.f54819a.l() - 1;
        } else {
            f10 = 1.0f;
        }
        float f12 = i11;
        ...
        if (i17 < 0) {
            f11 = f12 / (i11 - i17);
        } else if (i17 >= this.f54819a.i()) {
            f11 = ((this.f54819a.i() - 1) - i11) / (i17 - i11);
            i16 = this.f54819a.i() - 1;
        } else {
            i16 = i17;
            f11 = 1.0f;
        }
    ...
    public final g e(Map map) {
        ...
        return g(new e(this.f54819a, null).g(map));
    }

    protected final a f(float f10, int i10, int i11, float f11) {
        int i12 = (int) (f11 * f10);
        int max = Math.max(0, i10 - i12);
        int min = Math.min(this.f54819a.l() - 1, i10 + i12) - max;
        float f12 = 3.0f * f10;
        if (min >= f12) {
            int max2 = Math.max(0, i11 - i12);
            int min2 = Math.min(this.f54819a.i() - 1, i11 + i12) - max2;
            if (min2 >= f12) {
                return new b(this.f54819a, max, max2, min, min2, f10, null).c();
            }
            throw k.a();
        }
        throw k.a();
    ...
    protected final g g(f fVar) {
        ...
        if (a11 >= 1.0f) {
            ...
            aVar = null;
            return new g(h(this.f54819a, d(b10, c10, a10, aVar, c11), c11), aVar == null ? new p[]{a10, b10, c10} : new p[]{a10, b10, c10, aVar});
        }
        throw k.a();
    }
}
