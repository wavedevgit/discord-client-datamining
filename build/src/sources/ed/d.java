...
abstract class d {
    ...
    public static boolean a(l lVar) {
        h0 h0Var = new h0(8);
        int i10 = a.a(lVar, h0Var).f21440a;
    ...
    public static long c(l lVar) {
        ...
        lVar.n(h0Var.e(), 0, 8);
        long v10 = h0Var.v();
        lVar.k(((int) a10.f21441b) + 8);
        return v10;
    }

    private static a d(int i10, l lVar, h0 h0Var) {
        a a10 = a.a(lVar, h0Var);
        while (a10.f21440a != i10) {
            y.i("WavHeaderReader", "Ignoring unknown WAV chunk: " + a10.f21440a);
            long j10 = a10.f21441b + 8;
            if (j10 <= 2147483647L) {
                lVar.k((int) j10);
                a10 = a.a(lVar, h0Var);
            } else {
                throw l0.d("Chunk is too large (~2GB+) to skip; id: " + a10.f21440a);
            }
        }
        return a10;
    }
    ...
    public static Pair e(l lVar) {
        ...
        lVar.k(8);
        return Pair.create(Long.valueOf(lVar.getPosition()), Long.valueOf(d10.f21441b));
    }
}
