...
public final class x extends uc.a {
    ...
    private static final class b implements a.f {
        ...
        private final s0 f21588a;

        /* renamed from: b  reason: collision with root package name */
        private final oe.h0 f21589b;
        ...
        public a.e a(uc.l lVar, long j10) {
            ...
            this.f21589b.Q(min);
            lVar.n(this.f21589b.e(), 0, min);
            return c(this.f21589b, j10, position);
        }

        @Override // uc.a.f
        public void b() {
            this.f21589b.R(w0.f40716f);
        }

        private b(s0 s0Var) {
            this.f21588a = s0Var;
            this.f21589b = new oe.h0();
        }
    }
