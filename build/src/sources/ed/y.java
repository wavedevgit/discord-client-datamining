...
final class y {
    ...
    private final s0 f21590a = new s0(0);

    /* renamed from: f  reason: collision with root package name */
    private long f21595f = -9223372036854775807L;

    /* renamed from: g  reason: collision with root package name */
    private long f21596g = -9223372036854775807L;

    /* renamed from: h  reason: collision with root package name */
    private long f21597h = -9223372036854775807L;

    /* renamed from: b  reason: collision with root package name */
    private final oe.h0 f21591b = new oe.h0();
    ...
    private int h(uc.l lVar, uc.y yVar) {
        ...
        this.f21591b.Q(min);
        lVar.e();
        lVar.n(this.f21591b.e(), 0, min);
        this.f21595f = i(this.f21591b);
        this.f21593d = true;
        return 0;
    }
    ...
    public int g(uc.l lVar, uc.y yVar) {
        ...
        if (this.f21596g == -9223372036854775807L) {
            return b(lVar);
        }
        if (!this.f21593d) {
            return h(lVar, yVar);
        ...
        long b10 = this.f21590a.b(this.f21596g) - this.f21590a.b(j10);
        this.f21597h = b10;
        if (b10 < 0) {
            oe.y.i("PsDurationReader", "Invalid duration: " + this.f21597h + ". Using TIME_UNSET instead.");
            this.f21597h = -9223372036854775807L;
        }
        return b(lVar);
    }
}
