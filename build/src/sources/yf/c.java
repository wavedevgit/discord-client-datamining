...
public final class c extends jf.a {
    ...
    private final Bundle f55530e;

    /* renamed from: i  reason: collision with root package name */
    private final Bundle f55531i;
    ...
    private final String f55534q;

    /* renamed from: r  reason: collision with root package name */
    public static final a f55528r = new a(null);
    @NotNull
    ...
    public c(String type, Bundle credentialRetrievalData, Bundle candidateQueryData, String requestMatcher, String requestType, String protocolType) {
        ...
        this.f55529d = type;
        this.f55530e = credentialRetrievalData;
        this.f55531i = candidateQueryData;
        this.f55532o = requestMatcher;
        this.f55533p = requestType;
        this.f55534q = protocolType;
        boolean z11 = true;
