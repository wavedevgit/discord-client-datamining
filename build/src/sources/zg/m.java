...
public abstract class m {
    public static Object a(Task task) {
        hf.q.j();
        hf.q.h();
        hf.q.m(task, "Task must not be null");
        if (task.o()) {
            return i(task);
        }
        p pVar = new p(null);
    ...
    public static Object b(Task task, long j10, TimeUnit timeUnit) {
        ...
        hf.q.h();
        hf.q.m(task, "Task must not be null");
        hf.q.m(timeUnit, "TimeUnit must not be null");
        if (task.o()) {
            return i(task);
        }
        p pVar = new p(null);
    ...
    public static Task c(Executor executor, Callable callable) {
        hf.q.m(executor, "Executor must not be null");
        hf.q.m(callable, "Callback must not be null");
        m0 m0Var = new m0();
