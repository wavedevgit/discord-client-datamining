...
public final class t {
    ...
    public static final class a {
        ...
        public static final a f52711d = new a("FRONT", 0);

        /* renamed from: e  reason: collision with root package name */
        public static final a f52712e = new a("BACK", 1);

        /* renamed from: i  reason: collision with root package name */
        public static final a f52713i = new a("EXTERNAL", 2);

        /* renamed from: o  reason: collision with root package name */
        private static final /* synthetic */ a[] f52714o;

        /* renamed from: p  reason: collision with root package name */
        private static final /* synthetic */ EnumEntries f52715p;
        ...
        private static final /* synthetic */ a[] a() {
            return new a[]{f52711d, f52712e, f52713i};
        }
    ...
    public static final class b implements DefaultLifecycleObserver {
        ...
        /* renamed from: d  reason: collision with root package name */
        final /* synthetic */ ExecutorService f52716d;

        b(ExecutorService executorService) {
            this.f52716d = executorService;
        }

        @Override // androidx.lifecycle.DefaultLifecycleObserver
        public void onDestroy(LifecycleOwner owner) {
            Intrinsics.checkNotNullParameter(owner, "owner");
            this.f52716d.shutdown();
        }
    }
    ...
    public static final class c extends kotlin.coroutines.jvm.internal.d {
        ...
        public final Object invokeSuspend(Object obj) {
            this.f52719i = obj;
            this.f52721p |= Integer.MIN_VALUE;
    ...
    public static final class d implements n0.f {
        ...
        /* renamed from: a  reason: collision with root package name */
        final /* synthetic */ Continuation f52722a;

        /* renamed from: b  reason: collision with root package name */
        final /* synthetic */ File f52723b;

        d(Continuation continuation, File file) {
            this.f52722a = continuation;
            this.f52723b = file;
        }
        ...
        public void d(n0.h outputFileResults) {
            ...
            Continuation continuation = this.f52722a;
            Result.a aVar = Result.f31762e;
            continuation.resumeWith(Result.b(Result.a(Result.b(this.f52723b))));
        }
    ...
    public static final void h(ListenableFuture listenableFuture, int i10, boolean z10, f.a aVar, ExecutorService executorService, PreviewView previewView, x.p pVar, t tVar, Function1 function1) {
        ...
        try {
            ...
            tVar.f52710a = new w(n10, n0Var, tVar.i(n10));
            Context context2 = previewView.getContext();
            Intrinsics.checkNotNullExpressionValue(context2, "getContext(...)");
            sp.f.i(context2).getLifecycle().a(new b(executorService));
    ...
    */
    private final vn.v i(x.i r12) {
        ...
        L42:
            ...
            r4 = 1
            if (r3 != r4) goto L4c
            vn.v$b r1 = vn.v.b.f52741e     // Catch: java.lang.IllegalArgumentException -> L90
            goto L5a
        L4c:
            if (r1 != 0) goto L4f
            goto L58
        L4f:
            ...
            if (r1 != 0) goto L58
            vn.v$b r1 = vn.v.b.f52740d     // Catch: java.lang.IllegalArgumentException -> L90
            goto L5a
        L58:
            vn.v$b r1 = vn.v.b.f52742i     // Catch: java.lang.IllegalArgumentException -> L90
        L5a:
        ...
        L6d:
            ...
            goto L6d
        L8a:
            vn.v r12 = new vn.v     // Catch: java.lang.IllegalArgumentException -> L90
        ...
        L90:
            ...
            return r4
        */
        throw new UnsupportedOperationException("Method not decompiled: vn.t.i(x.i):vn.v");
    }
    ...
    public final void f(final PreviewView previewView, a cameraDirection, final f.a aVar, final boolean z10, final Function1 onCameraError) {
        ...
        previewView.post(new Runnable() { // from class: vn.r
            @Override // java.lang.Runnable
            public final void run() {
    ...
    /*
        ...
        To view partially-correct add '--show-bad-code' argument
    */
    public final java.lang.Object j(xp.c r7, kotlin.coroutines.Continuation r8) {
        /*
            r6 = this;
            boolean r0 = r8 instanceof vn.t.c
            if (r0 == 0) goto L13
            r0 = r8
            vn.t$c r0 = (vn.t.c) r0
            int r1 = r0.f52721p
            ...
            goto L18
        L13:
            vn.t$c r0 = new vn.t$c
            r0.<init>(r8)
        L18:
            java.lang.Object r8 = r0.f52719i
            java.lang.Object r1 = xr.b.f()
            int r2 = r0.f52721p
            r3 = 1
            if (r2 == 0) goto L39
            if (r2 != r3) goto L31
            java.lang.Object r7 = r0.f52718e
            xp.c r7 = (xp.c) r7
            java.lang.Object r7 = r0.f52717d
            vn.t r7 = (vn.t) r7
            kotlin.c.b(r8)
            goto L8d
        L31:
        ...
        L39:
            ...
            ps.c1 r4 = ps.m0.c()
            ps.c1 r4 = r4.e2()
            java.util.concurrent.Executor r4 = ps.u0.a(r4)
            vn.t$d r5 = new vn.t$d
            r5.<init>(r8, r7)
            r3.x0(r2, r4, r5)
        L7d:
            java.lang.Object r8 = r8.b()
            java.lang.Object r7 = xr.b.f()
            if (r8 != r7) goto L8a
        ...
        L8d:
            ...
            return r7
        */
        throw new UnsupportedOperationException("Method not decompiled: vn.t.j(xp.c, kotlin.coroutines.Continuation):java.lang.Object");
    }
}
