...
public abstract class m0 {
    ...
    public static final class a implements j0 {
        ...
        private final Image f52660a;

        /* renamed from: b  reason: collision with root package name */
        private final Lazy f52661b;

        /* renamed from: c  reason: collision with root package name */
        private final Lazy f52662c;
        ...
        private final int f52665f;

        a(final Image image, final int i10) {
            this.f52660a = image;
            this.f52661b = rr.l.a(new Function0() { // from class: vn.k0
            ...
            this.f52662c = rr.l.a(new Function0() { // from class: vn.l0
                @Override // kotlin.jvm.functions.Function0
                public final Object invoke() {
                    Bitmap c10;
            ...
            this.f52663d = image.getWidth();
            this.f52664e = image.getHeight();
            this.f52665f = i10;
        }
        ...
        /* JADX INFO: Access modifiers changed from: private */
        public static final ak.a g(Image image, int i10) {
            ak.a c10 = ak.a.c(image, i10);
        ...
        @Override // vn.j0
        public Bitmap e() {
            return (Bitmap) this.f52662c.getValue();
        }

        @Override // vn.j0
        public ak.a f() {
            return (ak.a) this.f52661b.getValue();
        }
