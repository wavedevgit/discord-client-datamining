...
public final class p0 {
    ...
    public static final a f52669p = new a(null);

    /* renamed from: q  reason: collision with root package name */
    private static final Regex f52670q = new Regex("([ACI][A-Z0-9<]{1})([A-Z]{3})([A-Z0-9<]{9})([0-9]{1})([A-Z0-9<]{15})");

    /* renamed from: r  reason: collision with root package name */
    private static final Regex f52671r = new Regex("([0-9]{6})([0-9]{1})([MFX<]{1})([0-9]{6})([0-9]{1})([A-Z]{3})([A-Z0-9<]{11})([0-9]{1})");

    /* renamed from: s  reason: collision with root package name */
    private static final Regex f52672s = new Regex("([A-Z0-9<]{30})");

    /* renamed from: t  reason: collision with root package name */
    private static final Regex f52673t = new Regex("([ACI][A-Z0-9<]{1})([A-Z]{3})([A-Z0-9<]{31})");

    /* renamed from: u  reason: collision with root package name */
    private static final Regex f52674u = new Regex("([A-Z0-9<]{9})([0-9]{1})([A-Z]{3})([0-9]{6})([0-9]{1})([MFX<]{1})([0-9]{6})([0-9]{1})([A-Z0-9<]{7})([0-9]{1})");

    /* renamed from: v  reason: collision with root package name */
    private static final Regex f52675v = new Regex("(P[A-Z0-9<]{1})([A-Z]{3})([A-Z0-9<]+?<<+)");

    /* renamed from: w  reason: collision with root package name */
    private static final Regex f52676w = new Regex("(P[A-Z0-9<]{1})([A-Z]{3})([A-Z0-9<]+?)<<([A-Z0-9<]+<<+)");

    /* renamed from: x  reason: collision with root package name */
    private static final Regex f52677x = new Regex("([A-Z0-9<]{9})([0-9]{1})([A-Z]{3})([0-9]{6})([0-9]{1})([MFX<]{1})([0-9]{6})([0-9]{1})?([A-Z0-9<]{14})?([0-9]{1})?([0-9]{1})?");
    ...
    private final String f52687j;

    /* renamed from: k  reason: collision with root package name */
    private final String f52688k;

    /* renamed from: l  reason: collision with root package name */
    private final Date f52689l;

    /* renamed from: m  reason: collision with root package name */
    private final Date f52690m;

    /* renamed from: n  reason: collision with root package name */
    private final Date f52691n;

    /* renamed from: o  reason: collision with root package name */
    private final String f52692o;
    ...
    public static final class a {
        ...
        private final p0 f(String str) {
            ...
            int i10;
            boolean z10;
            MatchResult d12 = Regex.d(p0.f52670q, str, 0, 2, null);
            if (d12 == null || (d10 = Regex.d(p0.f52671r, str, 0, 2, null)) == null || (d11 = Regex.d(p0.f52672s, StringsKt.J(StringsKt.J(str, d12.getValue(), "", false, 4, null), d10.getValue(), "", false, 4, null), 0, 2, null)) == null) {
                return null;
            }
            ...
            return new p0(CollectionsKt.x0(CollectionsKt.o(d12, d10, d11), ReactEditTextInputConnectionWrapper.NEWLINE_RAW_VALUE, null, null, 0, null, new Function1() { // from class: vn.o0
        ...
        private final p0 h(String str) {
            MatchResult d10;
            MatchResult d11 = Regex.d(p0.f52676w, str, 0, 2, null);
            if (d11 == null || (d10 = Regex.d(p0.f52677x, str, 0, 2, null)) == null) {
                return null;
            }
            return new p0(CollectionsKt.x0(CollectionsKt.o(d11, d10), ReactEditTextInputConnectionWrapper.NEWLINE_RAW_VALUE, null, null, 0, null, new Function1() { // from class: vn.n0
                @Override // kotlin.jvm.functions.Function1
    ...
    public boolean equals(Object obj) {
        ...
        p0 p0Var = (p0) obj;
        if (Intrinsics.areEqual(this.f52678a, p0Var.f52678a) && Intrinsics.areEqual(this.f52679b, p0Var.f52679b) && Intrinsics.areEqual(this.f52680c, p0Var.f52680c) && Intrinsics.areEqual(this.f52681d, p0Var.f52681d) && Intrinsics.areEqual(this.f52682e, p0Var.f52682e) && Intrinsics.areEqual(this.f52683f, p0Var.f52683f) && Intrinsics.areEqual(this.f52684g, p0Var.f52684g) && Intrinsics.areEqual(this.f52685h, p0Var.f52685h) && Intrinsics.areEqual(this.f52686i, p0Var.f52686i) && Intrinsics.areEqual(this.f52687j, p0Var.f52687j) && Intrinsics.areEqual(this.f52688k, p0Var.f52688k) && Intrinsics.areEqual(this.f52689l, p0Var.f52689l) && Intrinsics.areEqual(this.f52690m, p0Var.f52690m) && Intrinsics.areEqual(this.f52691n, p0Var.f52691n) && Intrinsics.areEqual(this.f52692o, p0Var.f52692o)) {
            return true;
        }
        return false;
    }
    ...
    public int hashCode() {
        ...
        int hashCode12;
        int hashCode13;
        int hashCode14 = this.f52678a.hashCode() * 31;
        String str = this.f52679b;
        int i10 = 0;
        if (str == null) {
            hashCode = 0;
        } else {
    ...
    public String toString() {
        ...
        String str2 = this.f52679b;
        String str3 = this.f52680c;
        String str4 = this.f52681d;
        String str5 = this.f52682e;
        String str6 = this.f52683f;
        String str7 = this.f52684g;
        String str8 = this.f52685h;
        String str9 = this.f52686i;
        String str10 = this.f52687j;
        String str11 = this.f52688k;
        Date date = this.f52689l;
        Date date2 = this.f52690m;
        Date date3 = this.f52691n;
        String str12 = this.f52692o;
