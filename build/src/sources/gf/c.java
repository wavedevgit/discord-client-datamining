...
public abstract class c {
    ...
    private final Context f25015s;

    /* renamed from: t  reason: collision with root package name */
    private final Looper f25016t;

    /* renamed from: u  reason: collision with root package name */
    private final h f25017u;

    /* renamed from: v  reason: collision with root package name */
    private final com.google.android.gms.common.g f25018v;

    /* renamed from: w  reason: collision with root package name */
    final Handler f25019w;
    ...
    private volatile String f25013q = null;

    /* renamed from: x  reason: collision with root package name */
    private final Object f25020x = new Object();

    /* renamed from: y  reason: collision with root package name */
    private final Object f25021y = new Object();
    ...
    public c(Context context, Looper looper, h hVar, com.google.android.gms.common.g gVar, int i10, a aVar, b bVar, String str) {
        ...
        this.f25018v = gVar;
        this.f25019w = new x0(this, looper);
        this.H = i10;
        this.F = aVar;
        this.G = bVar;
        this.I = str;
            ...
            try {
                ...
                if (i10 != 1) {
                    if (i10 != 2 && i10 != 3) {
                        ...
                        a1 a1Var = this.D;
                        if (a1Var != null && (m1Var2 = this.f25014r) != null) {
                            String a10 = m1Var2.a();
                            String b10 = m1Var2.b();
                            ...
                            h hVar = this.f25017u;
                            String a11 = this.f25014r.a();
                            q.l(a11);
                            hVar.d(a11, this.f25014r.b(), 4225, a1Var, R(), this.f25014r.c());
                        ...
                        if (m1Var.c() && n() < 17895000) {
                            throw new IllegalStateException("Internal Error, the minimum apk version of this BaseGmsClient is too low to support dynamic lookup. Start service action: ".concat(String.valueOf(this.f25014r.a())));
                        }
                        h hVar2 = this.f25017u;
                        String a12 = this.f25014r.a();
                        q.l(a12);
                        com.google.android.gms.common.b c11 = hVar2.c(new h1(a12, this.f25014r.b(), 4225, this.f25014r.c()), a1Var2, R(), v());
                        if (!c11.h()) {
                            String a13 = this.f25014r.a();
                            String b11 = this.f25014r.b();
                    ...
                    a1 a1Var3 = this.D;
                    if (a1Var3 != null) {
                        h hVar3 = this.f25017u;
                        String a14 = this.f25014r.a();
                        q.l(a14);
                        hVar3.d(a14, this.f25014r.b(), 4225, a1Var3, R(), this.f25014r.c());
                        this.D = null;
                    }
                }
            } finally {
    ...
    protected void J(IInterface iInterface) {
        this.f25010i = System.currentTimeMillis();
    }

    /* JADX INFO: Access modifiers changed from: protected */
    public void K(com.google.android.gms.common.b bVar) {
        this.f25011o = bVar.c();
        this.f25012p = System.currentTimeMillis();
    }
    ...
    protected final String R() {
        String str = this.I;
        if (str == null) {
            return this.f25015s.getClass().getName();
        }
        return str;
    }
    ...
    public void k(j jVar, Set set) {
        ...
        fVar.f25059o = this.f25015s.getPackageName();
        fVar.f25062r = z10;
        if (set != null) {
            fVar.f25061q = (Scope[]) set.toArray(new Scope[0]);
        }
        if (g()) {
            Account t10 = t();
            if (t10 == null) {
