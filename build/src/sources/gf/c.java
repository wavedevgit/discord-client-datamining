...
public abstract class c {
    ...
    private final Context f26756s;

    /* renamed from: t  reason: collision with root package name */
    private final Looper f26757t;

    /* renamed from: u  reason: collision with root package name */
    private final h f26758u;

    /* renamed from: v  reason: collision with root package name */
    private final com.google.android.gms.common.g f26759v;

    /* renamed from: w  reason: collision with root package name */
    final Handler f26760w;
    ...
    private volatile String f26754q = null;

    /* renamed from: x  reason: collision with root package name */
    private final Object f26761x = new Object();

    /* renamed from: y  reason: collision with root package name */
    private final Object f26762y = new Object();
    ...
    public c(Context context, Looper looper, h hVar, com.google.android.gms.common.g gVar, int i10, a aVar, b bVar, String str) {
        ...
        this.f26759v = gVar;
        this.f26760w = new z0(this, looper);
        this.H = i10;
        this.F = aVar;
        this.G = bVar;
        this.I = str;
            ...
            try {
                ...
                if (i10 != 1) {
                    if (i10 != 2 && i10 != 3) {
                        ...
                        c1 c1Var = this.D;
                        if (c1Var != null && (q1Var2 = this.f26755r) != null) {
                            Log.e("GmsClient", "Calling connect() while still connected, missing disconnect() for " + q1Var2.b() + " on " + q1Var2.a());
                            h hVar = this.f26758u;
                            String b11 = this.f26755r.b();
                            q.l(b11);
                            hVar.e(b11, this.f26755r.a(), 4225, c1Var, V(), this.f26755r.c());
                        ...
                        if (q1Var.c() && n() < 17895000) {
                            throw new IllegalStateException("Internal Error, the minimum apk version of this BaseGmsClient is too low to support dynamic lookup. Start service action: ".concat(String.valueOf(this.f26755r.b())));
                        }
                        h hVar2 = this.f26758u;
                        String b12 = this.f26755r.b();
                        q.l(b12);
                        com.google.android.gms.common.b c10 = hVar2.c(new j1(b12, this.f26755r.a(), 4225, this.f26755r.c()), c1Var2, V(), v());
                        if (!c10.f()) {
                            Log.w("GmsClient", "unable to connect to service: " + this.f26755r.b() + " on " + this.f26755r.a());
                            if (c10.b() == -1) {
                                b10 = 16;
                            } else {
                                b10 = c10.b();
                    ...
                    c1 c1Var3 = this.D;
                    if (c1Var3 != null) {
                        h hVar3 = this.f26758u;
                        String b13 = this.f26755r.b();
                        q.l(b13);
                        hVar3.e(b13, this.f26755r.a(), 4225, c1Var3, V(), this.f26755r.c());
                        this.D = null;
                    }
                }
            } finally {
    ...
    protected void J(IInterface iInterface) {
        this.f26751i = System.currentTimeMillis();
    }

    /* JADX INFO: Access modifiers changed from: protected */
    public void K(com.google.android.gms.common.b bVar) {
        this.f26752o = bVar.b();
        this.f26753p = System.currentTimeMillis();
    }

    /* JADX INFO: Access modifiers changed from: protected */
    public void L(int i10) {
        this.f26749d = i10;
        this.f26750e = System.currentTimeMillis();
    }

    /* JADX INFO: Access modifiers changed from: protected */
    public void M(int i10, IBinder iBinder, Bundle bundle, int i11) {
        this.f26760w.sendMessage(this.f26760w.obtainMessage(1, i11, -1, new d1(this, i10, iBinder, bundle)));
    }
    ...
    public void P(int i10) {
        this.f26760w.sendMessage(this.f26760w.obtainMessage(6, this.N.get(), i10));
    }
    ...
    protected final String V() {
        String str = this.I;
        if (str == null) {
            return this.f26756s.getClass().getName();
        }
        return str;
    }
    ...
    public final void c0(int i10, Bundle bundle, int i11) {
        this.f26760w.sendMessage(this.f26760w.obtainMessage(7, i11, -1, new e1(this, i10, bundle)));
    }

    public String d() {
        q1 q1Var;
        if (a() && (q1Var = this.f26755r) != null) {
            return q1Var.a();
        }
    ...
    public void j(j jVar, Set set) {
        ...
        String str2 = str;
        int i10 = this.H;
        int i11 = com.google.android.gms.common.g.f14817a;
        Scope[] scopeArr = f.f26796z;
        ...
        fVar.f26800o = this.f26756s.getPackageName();
        fVar.f26803r = z10;
        if (set != null) {
            fVar.f26802q = (Scope[]) set.toArray(new Scope[0]);
        }
        if (g()) {
            Account t10 = t();
            if (t10 == null) {
