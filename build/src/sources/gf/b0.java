...
public abstract class b0 {
    ...
    private static final SimpleArrayMap f25052a = new SimpleArrayMap();

    /* renamed from: b  reason: collision with root package name */
    private static Locale f25053b;
    ...
    public static String b(Context context, int i10) {
        ...
        if (i10 != 1) {
            if (i10 != 2) {
                ...
                return resources.getString(cf.b.f7419a);
            }
            return resources.getString(cf.b.f7428j);
        }
        return resources.getString(cf.b.f7422d);
    }
    ...
    public static String c(Context context, int i10) {
        ...
        if (i10 != 1) {
            if (i10 != 2) {
                                ...
                                if (i10 != 20) {
                                    switch (i10) {
                                        ...
                                        case ChatViewRecyclerTypes.EPHEMERAL_INDICATION /* 18 */:
                                            return resources.getString(cf.b.f7431m, a10);
                                        default:
                                            return resources.getString(com.google.android.gms.common.m.f13787a, a10);
                                    }
                                }
                                return g(context, "common_google_play_services_restricted_profile_text", a10);
                            }
                            return resources.getString(cf.b.f7427i, a10);
                        }
                ...
                return resources.getString(cf.b.f7420b, a10);
            } else if (com.google.android.gms.common.util.g.d(context)) {
                return resources.getString(cf.b.f7432n);
            } else {
                return resources.getString(cf.b.f7429k, a10);
            }
        }
        return resources.getString(cf.b.f7423e, a10);
    }
    ...
    public static String e(Context context, int i10) {
        ...
        if (f10 == null) {
            return context.getResources().getString(cf.b.f7426h);
        }
        return f10;
    }
    ...
    public static String f(Context context, int i10) {
        ...
        switch (i10) {
            case 1:
                return resources.getString(cf.b.f7424f);
            case 2:
                return resources.getString(cf.b.f7430l);
            case 3:
                return resources.getString(cf.b.f7421c);
            case 4:
            case 6:
            case ChatViewRecyclerTypes.EPHEMERAL_INDICATION /* 18 */:
                return null;
