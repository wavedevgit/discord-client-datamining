...
public final class j1 extends Fragment implements h {
    ...
    private static final WeakHashMap f25639e = new WeakHashMap();

    /* renamed from: d  reason: collision with root package name */
    private final i1 f25640d = new i1();

    public static j1 x(FragmentActivity fragmentActivity) {
        j1 j1Var;
        FragmentManager supportFragmentManager = fragmentActivity.getSupportFragmentManager();
        WeakHashMap weakHashMap = f25639e;
    ...
    public final g b(String str, Class cls) {
        return this.f25640d.a(str, cls);
    }

    @Override // gf.h
    public final void d(String str, g gVar) {
        this.f25640d.b(str, gVar);
    }

    @Override // androidx.fragment.app.Fragment
    public final void dump(String str, FileDescriptor fileDescriptor, PrintWriter printWriter, String[] strArr) {
        super.dump(str, fileDescriptor, printWriter, strArr);
        this.f25640d.j(str, fileDescriptor, printWriter, strArr);
    }
    ...
    public final void onActivityResult(int i10, int i11, Intent intent) {
        ...
        this.f25640d.f(i10, i11, intent);
    }

    @Override // androidx.fragment.app.Fragment
    public final void onCreate(Bundle bundle) {
        super.onCreate(bundle);
        this.f25640d.c(bundle);
    }
