...
public final class l1 implements Handler.Callback {
    ...
    public final boolean handleMessage(Message message) {
        ...
        if (i10 == 0) {
            hashMap = this.f26828d.f26845g;
            synchronized (hashMap) {
                try {
                    j1 j1Var = (j1) message.obj;
                    hashMap2 = this.f26828d.f26845g;
                    k1 k1Var = (k1) hashMap2.get(j1Var);
                    if (k1Var != null && k1Var.i()) {
                        if (k1Var.j()) {
                            k1Var.g("GmsClientSupervisor");
                        }
                        hashMap3 = this.f26828d.f26845g;
            ...
            hashMap4 = this.f26828d.f26845g;
            synchronized (hashMap4) {
                try {
                    j1 j1Var2 = (j1) message.obj;
                    hashMap5 = this.f26828d.f26845g;
