...
public final class n0 implements OnCompleteListener {
        ...
        if (eVar.e()) {
            ...
            if (a10 != null) {
                if (a10.d()) {
                    ...
                    e0 t10 = eVar.t(bVar);
                    if (t10 != null) {
                        if (t10.v() instanceof hf.c) {
                            hf.c cVar = (hf.c) t10.v();
                            if (cVar.I() && !cVar.d()) {
                                hf.e b10 = b(t10, cVar, i10);
                                if (b10 != null) {
                                    t10.G();
                                    z10 = b10.f();
                                } else {
    ...
    private static hf.e b(e0 e0Var, hf.c cVar, int i10) {
        int[] c10;
        int[] d10;
        hf.e G = cVar.G();
    ...
    public final void onComplete(Task task) {
        ...
        if (this.f25643a.e()) {
            hf.s a10 = hf.r.b().a();
            if ((a10 == null || a10.d()) && (t10 = this.f25643a.t(this.f25645c)) != null && (t10.v() instanceof hf.c)) {
                hf.c cVar = (hf.c) t10.v();
                boolean z11 = true;
                int i13 = 0;
                if (this.f25646d > 0) {
                ...
                if (a10 != null) {
                    ...
                    i10 = a10.f();
                    if (cVar.I() && !cVar.d()) {
                        hf.e b11 = b(t10, cVar, this.f25644b);
                        if (b11 != null) {
                            if (!b11.f() || this.f25646d <= 0) {
                                z11 = false;
                            }
                            c11 = b11.b();
                            z10 = z11;
                ...
                if (z10) {
                    long j12 = this.f25646d;
                    long j13 = this.f25647e;
                ...
                eVar.C(new hf.n(this.f25644b, i13, c10, j10, j11, null, null, y10, i15), i10, i12, i11);
            }
        }
    }
}
