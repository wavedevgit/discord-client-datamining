...
public final class f0 implements Collection, KMappedMarker {
    ...
    public static final class a implements Iterator, KMappedMarker {
        ...
        public short a() {
            int i10 = this.f37107e;
            short[] sArr = this.f37106d;
            if (i10 < sArr.length) {
                this.f37107e = i10 + 1;
                return e0.d(sArr[i10]);
            }
            throw new NoSuchElementException(String.valueOf(this.f37107e));
        }

        @Override // java.util.Iterator
        public boolean hasNext() {
            if (this.f37107e < this.f37106d.length) {
                return true;
            }
            return false;
        }
    ...
    */
    public static boolean g(short[] r3, java.util.Collection r4) {
        ...
        L16:
            ...
            boolean r2 = r0 instanceof lr.e0
            if (r2 == 0) goto L31
            lr.e0 r0 = (lr.e0) r0
            short r0 = r0.h()
        ...
        L33:
            return r1
        */
        throw new UnsupportedOperationException("Method not decompiled: lr.f0.g(short[], java.util.Collection):boolean");
    }
    ...
    public boolean containsAll(Collection elements) {
        ...
        return g(this.f37105d, elements);
    }

    public boolean e(short s10) {
        return f(this.f37105d, s10);
    }

    @Override // java.util.Collection
    public boolean equals(Object obj) {
        return h(this.f37105d, obj);
    }

    @Override // java.util.Collection
    public int hashCode() {
        return m(this.f37105d);
    }

    @Override // java.util.Collection
    public boolean isEmpty() {
        return n(this.f37105d);
    }

    @Override // java.util.Collection, java.lang.Iterable
    public Iterator iterator() {
        return o(this.f37105d);
    }

    @Override // java.util.Collection
    /* renamed from: j */
    public int size() {
        return k(this.f37105d);
    }
