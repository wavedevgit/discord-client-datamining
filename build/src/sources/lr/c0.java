...
public final class c0 implements Collection, KMappedMarker {
    ...
    public static final class a implements Iterator, KMappedMarker {
        ...
        public long a() {
            ...
            throw new NoSuchElementException(String.valueOf(this.f37096e));
        }

        @Override // java.util.Iterator
        public boolean hasNext() {
            if (this.f37096e < this.f37095d.length) {
                return true;
            }
            return false;
        }
    ...
    */
    public static boolean g(long[] r4, java.util.Collection r5) {
        ...
        L16:
            ...
            boolean r2 = r0 instanceof lr.b0
            if (r2 == 0) goto L31
            lr.b0 r0 = (lr.b0) r0
            long r2 = r0.h()
        ...
        L33:
            return r1
        */
        throw new UnsupportedOperationException("Method not decompiled: lr.c0.g(long[], java.util.Collection):boolean");
    }
    ...
    public boolean containsAll(Collection elements) {
        ...
        return g(this.f37094d, elements);
    }

    public boolean e(long j10) {
        return f(this.f37094d, j10);
    }

    @Override // java.util.Collection
    public boolean equals(Object obj) {
        return h(this.f37094d, obj);
    }

    @Override // java.util.Collection
    public int hashCode() {
        return m(this.f37094d);
    }

    @Override // java.util.Collection
    public boolean isEmpty() {
        return n(this.f37094d);
    }

    @Override // java.util.Collection, java.lang.Iterable
    public Iterator iterator() {
        return o(this.f37094d);
    }

    @Override // java.util.Collection
    /* renamed from: j */
    public int size() {
        return k(this.f37094d);
    }
