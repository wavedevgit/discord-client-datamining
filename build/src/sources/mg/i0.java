...
public abstract class i0 extends k0 implements Serializable {
    ...
    /* renamed from: i */
    private final transient Map f38257i;

    /* renamed from: o */
    private transient int f38258o;
    ...
    public final boolean c(Object obj, Object obj2) {
        Collection collection = (Collection) this.f38257i.get(obj);
        if (collection == null) {
            Collection g10 = g();
            if (g10.add(obj2)) {
                this.f38258o++;
                this.f38257i.put(obj, g10);
                return true;
            }
    ...
    @Override // mg.k0
    final Map e() {
        return new a0(this, this.f38257i);
    }

    @Override // mg.k0
    final Set f() {
        return new c0(this, this.f38257i);
    }
    ...
    public final void o() {
        for (Collection collection : this.f38257i.values()) {
            collection.clear();
        }
        this.f38257i.clear();
        this.f38258o = 0;
