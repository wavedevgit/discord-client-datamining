...
public final class qk implements ck {
    ...
    private final ze f38049a;

    /* renamed from: b  reason: collision with root package name */
    private yi f38050b = new yi();
    ...
    public final byte[] a(int i10, boolean z10) {
        ...
        this.f38050b.e(Boolean.FALSE);
        this.f38049a.i(this.f38050b.m());
        try {
            al.a();
            if (i10 == 0) {
                return new zi.d().j(qc.f38048a).k(true).i().b(this.f38049a.j()).getBytes("utf-8");
            }
            bf j10 = this.f38049a.j();
            t2 t2Var = new t2();
            qc.f38048a.a(t2Var);
