...
public final class qk implements ck {
    ...
    private final ze f38590a;

    /* renamed from: b  reason: collision with root package name */
    private yi f38591b = new yi();
    ...
    public final byte[] a(int i10, boolean z10) {
        ...
        this.f38591b.e(Boolean.FALSE);
        this.f38590a.i(this.f38591b.m());
        try {
            al.a();
            if (i10 == 0) {
                return new wi.d().j(qc.f38589a).k(true).i().b(this.f38590a.j()).getBytes("utf-8");
            }
            bf j10 = this.f38590a.j();
            t2 t2Var = new t2();
            qc.f38589a.a(t2Var);
