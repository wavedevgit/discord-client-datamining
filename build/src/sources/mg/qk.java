...
public final class qk implements ck {
    ...
    private final ze f38594a;

    /* renamed from: b  reason: collision with root package name */
    private yi f38595b = new yi();
    ...
    public final byte[] a(int i10, boolean z10) {
        ...
        this.f38595b.e(Boolean.FALSE);
        this.f38594a.i(this.f38595b.m());
        try {
            al.a();
            if (i10 == 0) {
                return new wi.d().j(qc.f38593a).k(true).i().b(this.f38594a.j()).getBytes("utf-8");
            }
            bf j10 = this.f38594a.j();
            t2 t2Var = new t2();
            qc.f38593a.a(t2Var);
