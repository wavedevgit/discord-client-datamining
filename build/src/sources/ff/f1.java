...
public abstract class f1 extends g implements DialogInterface.OnCancelListener {
    ...
    protected volatile boolean f24311e;

    /* renamed from: i  reason: collision with root package name */
    protected final AtomicReference f24312i;

    /* renamed from: o  reason: collision with root package name */
    private final Handler f24313o;

    /* renamed from: p  reason: collision with root package name */
    protected final com.google.android.gms.common.f f24314p;

    /* JADX INFO: Access modifiers changed from: package-private */
    public f1(h hVar, com.google.android.gms.common.f fVar) {
        super(hVar);
        this.f24312i = new AtomicReference(null);
        this.f24313o = new fg.h(Looper.getMainLooper());
        this.f24314p = fVar;
    }

    /* JADX INFO: Access modifiers changed from: private */
    public final void l(com.google.android.gms.common.b bVar, int i10) {
        this.f24312i.set(null);
        m(bVar, i10);
    }
    ...
    public final void e(int i10, int i11, Intent intent) {
        c1 c1Var = (c1) this.f24312i.get();
        if (i10 != 1) {
            if (i10 == 2) {
                int g10 = this.f24314p.g(b());
                if (g10 == 0) {
                    o();
                    return;
                } else if (c1Var != null) {
    ...
    public final void f(Bundle bundle) {
        ...
        super.f(bundle);
        if (bundle != null) {
            AtomicReference atomicReference = this.f24312i;
    ...
    public final void onCancel(DialogInterface dialogInterface) {
        l(new com.google.android.gms.common.b(13, null), p((c1) this.f24312i.get()));
    }
    ...
    public final void s(com.google.android.gms.common.b bVar, int i10) {
        ...
        do {
            atomicReference = this.f24312i;
            if (p0.d.a(atomicReference, null, c1Var)) {
                this.f24313o.post(new e1(this, c1Var));
                return;
            }
