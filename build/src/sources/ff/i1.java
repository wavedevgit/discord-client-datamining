...
final class i1 {
    ...
    private final Map f25120a = Collections.synchronizedMap(new u0.a());

    /* renamed from: b  reason: collision with root package name */
    private int f25121b = 0;

    /* renamed from: c  reason: collision with root package name */
    private Bundle f25122c;

    /* JADX INFO: Access modifiers changed from: package-private */
    public final g c(String str, Class cls) {
        return (g) cls.cast(this.f25120a.get(str));
    }

    /* JADX INFO: Access modifiers changed from: package-private */
    public final void d(String str, g gVar) {
        if (!this.f25120a.containsKey(str)) {
            this.f25120a.put(str, gVar);
            if (this.f25121b > 0) {
    ...
    public final void e(String str, FileDescriptor fileDescriptor, PrintWriter printWriter, String[] strArr) {
        for (g gVar : this.f25120a.values()) {
