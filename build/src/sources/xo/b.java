...
public final class b extends j {
    ...
    public static final a f53724q = new a(null);

    /* loaded from: /home/runner/work/discord-client-datamining/discord-client-datamining/build/classes4.dex */
    public static final class a implements c0 {

        /* renamed from: a  reason: collision with root package name */
        private final /* synthetic */ wm.f f53725a;

        /* JADX INFO: Access modifiers changed from: package-private */
        /* renamed from: xo.b$a$a  reason: collision with other inner class name */
        /* loaded from: /home/runner/work/discord-client-datamining/discord-client-datamining/build/classes4.dex */
        public /* synthetic */ class C0745a extends FunctionReferenceImpl implements Function2 {
            C0745a(Object obj) {
            ...
            public final void a(an.f p02, a0 p12) {
        ...
        public static final View c(c initialRendering, a0 initialEnv, Context contextForNewView, ViewGroup viewGroup) {
            ...
            bVar.setId(g.f53733b);
            bVar.setLayoutParams(new ViewGroup.LayoutParams(-1, -1));
            g0.a(bVar, initialRendering, initialEnv, new C0745a(bVar));
            return bVar;
        }
        ...
        public View a(c initialRendering, a0 initialViewEnvironment, Context contextForNewView, ViewGroup viewGroup) {
            ...
            Intrinsics.checkNotNullParameter(contextForNewView, "contextForNewView");
            return this.f53725a.a(initialRendering, initialViewEnvironment, contextForNewView, viewGroup);
        }
        ...
        private a() {
            this.f53725a = new wm.f(Reflection.getOrCreateKotlinClass(c.class), new Function4() { // from class: xo.a
    ...
    public Dialog g(View view) {
        ...
        Dialog dialog = new Dialog(getContext(), cp.f.f20664a);
        Iterator it = s.d(view).iterator();
        while (true) {
            if (it.hasNext()) {
                obj = it.next();
                if (((View) obj).getTag(g.f53732a) instanceof Integer) {
                    break;
                }
            } else {
                obj = null;
