...
public abstract class z {
    public static final View a(y yVar, m5 uiComponentHelper, List componentViews, List children, Footer config) {
        ...
        aq.g c10 = aq.g.c(LayoutInflater.from(a10));
        Intrinsics.checkNotNullExpressionValue(c10, "inflate(...)");
        Integer backgroundColor = config.getBackgroundColor();
        if (backgroundColor != null) {
            c10.f6648c.setBackgroundColor(backgroundColor.intValue());
        }
        ...
        if (borderWidth != null) {
            ...
            if (layoutParams != null) {
                ...
                if (top2 != null && (dp2 = top2.getDp()) != null) {
                    i10 = (int) jp.h.a(dp2.doubleValue());
                } else {
                    i10 = 0;
                }
            ...
            if (layoutParams2 != null) {
                layoutParams2.height = (int) jp.h.a(1.0d);
        ...
        constraintSet.f(c10.f6649d);
        ConstraintLayout footerContainerInner = c10.f6649d;
