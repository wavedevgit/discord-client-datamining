...
public abstract class e4 {
    public static final TextView b(c4 c4Var, m5 uiComponentHelper, final PrivacyPolicy config) {
        ...
        final aq.t c10 = aq.t.c(uiComponentHelper.b());
        PrivacyPolicy.Attributes attributes = config.getAttributes();
        if (attributes != null) {
            TextView textView = c10.f6695b;
            Intrinsics.checkNotNullExpressionValue(textView, "textView");
            yp.f.d(textView, attributes.getText());
            uiComponentHelper.d(new Function0() { // from class: xp.d4
    ...
    public static final Unit c(PrivacyPolicy privacyPolicy, aq.t tVar) {
        TextBasedComponentStyle styles = privacyPolicy.getStyles();
        if (styles != null) {
            TextView textView = tVar.f6695b;
            Intrinsics.checkNotNullExpressionValue(textView, "textView");
