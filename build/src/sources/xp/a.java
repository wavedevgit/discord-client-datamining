...
public final class a implements ViewBinding {
    ...
    private final ConstraintLayout f55636a;

    /* renamed from: b  reason: collision with root package name */
    public final Button f55637b;

    /* renamed from: c  reason: collision with root package name */
    public final Camera2PreviewView f55638c;

    /* renamed from: d  reason: collision with root package name */
    public final View f55639d;

    /* renamed from: e  reason: collision with root package name */
    public final TextView f55640e;

    /* renamed from: f  reason: collision with root package name */
    public final TextView f55641f;

    /* renamed from: g  reason: collision with root package name */
    public final ProgressBar f55642g;

    /* renamed from: h  reason: collision with root package name */
    public final Pi2NavigationBar f55643h;

    /* renamed from: i  reason: collision with root package name */
    public final Barrier f55644i;

    /* renamed from: j  reason: collision with root package name */
    public final FrameLayout f55645j;

    /* renamed from: k  reason: collision with root package name */
    public final PreviewView f55646k;

    /* renamed from: l  reason: collision with root package name */
    public final OldSelfieOverlayView f55647l;
    ...
    private a(ConstraintLayout constraintLayout, Button button, Camera2PreviewView camera2PreviewView, View view, TextView textView, TextView textView2, ProgressBar progressBar, Pi2NavigationBar pi2NavigationBar, Barrier barrier, FrameLayout frameLayout, PreviewView previewView, OldSelfieOverlayView oldSelfieOverlayView, TextView textView3) {
        this.f55636a = constraintLayout;
        this.f55637b = button;
        this.f55638c = camera2PreviewView;
        this.f55639d = view;
        this.f55640e = textView;
        this.f55641f = textView2;
        this.f55642g = progressBar;
        this.f55643h = pi2NavigationBar;
        this.f55644i = barrier;
        this.f55645j = frameLayout;
        this.f55646k = previewView;
        this.f55647l = oldSelfieOverlayView;
        this.f55648m = textView3;
    }
    ...
    public static a d(LayoutInflater layoutInflater, ViewGroup viewGroup, boolean z10) {
        View inflate = layoutInflater.inflate(x0.f54081a, viewGroup, false);
        if (z10) {
