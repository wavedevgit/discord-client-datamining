...
public final class e implements k5 {
    ...
    public boolean equals(Object obj) {
        ...
        e eVar = (e) obj;
        if (Intrinsics.areEqual(this.f53554d, eVar.f53554d) && this.f53555e == eVar.f53555e) {
            return true;
        }
        return false;
    }
    ...
    public int hashCode() {
        return (this.f53554d.hashCode() * 31) + Boolean.hashCode(this.f53555e);
    }

    public String toString() {
        String str = this.f53554d;
        boolean z10 = this.f53555e;
    ...
    public final void writeToParcel(Parcel dest, int i10) {
        ...
        dest.writeString(this.f53554d);
        dest.writeInt(this.f53555e ? 1 : 0);
    }
    ...
    */
    public e(com.withpersona.sdk2.inquiry.network.dto.ui.components.Branding r3) {
        ...
        L1b:
            ...
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: xp.e.<init>(com.withpersona.sdk2.inquiry.network.dto.ui.components.Branding):void");
    }
}
