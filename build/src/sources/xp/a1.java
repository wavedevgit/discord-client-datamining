...
public abstract class a1 {
    ...
    public static final ConstraintLayout f(InputConfirmationCodeComponent inputConfirmationCodeComponent, m5 uiComponentHelper, final InputConfirmationCode config) {
        ...
        final aq.c c10 = aq.c.c(uiComponentHelper.b());
        String b10 = inputConfirmationCodeComponent.b().b();
        final List o10 = CollectionsKt.o(c10.f6609b.getEditText(), c10.f6612e.getEditText(), c10.f6614g.getEditText(), c10.f6611d.getEditText());
        for (IndexedValue indexedValue : CollectionsKt.n1(o10)) {
            ...
            if (editText != null) {
                ...
                jp.a0.b(editText, new Function1() { // from class: xp.v0
                    @Override // kotlin.jvm.functions.Function1
            ...
            if (editText2 != null) {
                l(editText, new Function0() { // from class: xp.w0
        ...
        uiComponentHelper.d(new Function0() { // from class: xp.x0
            @Override // kotlin.jvm.functions.Function0
            public final Object invoke() {
                Unit i10;
                i10 = a1.i(aq.c.this, config);
                return i10;
            }
        });
    ...
    public static final Unit g(InputConfirmationCodeComponent inputConfirmationCodeComponent, aq.c cVar, List list, EditText editText, EditText editText2, EditText editText3, String newText) {
        Context context;
        ...
        if (newText.length() >= list.size()) {
            ...
            EditText editText4 = cVar.f6611d.getEditText();
            if (editText4 != null && (context = editText4.getContext()) != null) {
                jp.f.d(context);
            }
            EditText editText5 = cVar.f6611d.getEditText();
            if (editText5 != null) {
    ...
    private static final void l(final EditText editText, final Function0 function0) {
        if (editText != null) {
            editText.setOnKeyListener(new View.OnKeyListener() { // from class: xp.z0
    ...
    private static final void n(final EditText editText) {
        if (editText != null) {
            editText.setOnFocusChangeListener(new View.OnFocusChangeListener() { // from class: xp.y0
