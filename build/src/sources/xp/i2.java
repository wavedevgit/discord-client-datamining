...
public abstract class i2 {
    ...
    public static final TextInputLayout b(InputTextComponent inputTextComponent, m5 uiComponentHelper, final InputText config, vm.t textController) {
        String str;
        ...
        final aq.o c10 = aq.o.c(uiComponentHelper.b());
        TextInputEditText editText = c10.f6675b;
        Intrinsics.checkNotNullExpressionValue(editText, "editText");
        vm.u.b(textController, editText);
        InputText.Attributes attributes = config.getAttributes();
        if (attributes != null) {
            String label = attributes.getLabel();
            if (label != null) {
                c10.f6676c.setHint(label);
            }
            String placeholder = attributes.getPlaceholder();
            if (placeholder != null) {
                c10.f6676c.setPlaceholderText(placeholder);
                TextInputLayout inputLayout = c10.f6676c;
                Intrinsics.checkNotNullExpressionValue(inputLayout, "inputLayout");
                tp.o.a(inputLayout);
            }
            c10.f6675b.setInputType(e(attributes.getInputType()));
            if (Build.VERSION.SDK_INT >= 26) {
                ...
                c10.f6676c.setAutofillHints(new String[]{str});
            }
        }
        uiComponentHelper.d(new Function0() { // from class: xp.h2
    ...
    public static /* synthetic */ TextInputLayout c(InputTextComponent inputTextComponent, m5 m5Var, InputText inputText, vm.t tVar, int i10, Object obj) {
        if ((i10 & 4) != 0) {
    ...
    public static final Unit d(InputText inputText, aq.o oVar) {
        InputTextBasedComponentStyle styles = inputText.getStyles();
        if (styles != null) {
            TextInputLayout inputLayout = oVar.f6676c;
            Intrinsics.checkNotNullExpressionValue(inputLayout, "inputLayout");
