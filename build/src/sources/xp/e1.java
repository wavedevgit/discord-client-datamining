...
public abstract class e1 {
    public static final ConstraintLayout b(InputDateComponent inputDateComponent, m5 uiComponentHelper, yp.e dateController, InputDate config) {
        ...
        if (attributes != null) {
            ...
            wp.a aVar = new wp.a(a10, i10, textMonths, textBasedComponentStyle);
            vm.t d10 = dateController.d();
            AutoCompleteTextView monthEditText = c10.f6643g;
            Intrinsics.checkNotNullExpressionValue(monthEditText, "monthEditText");
            vm.u.b(d10, monthEditText);
            c10.f6643g.setAdapter(aVar);
            if (styles != null && (backgroundColor = styles.getBackgroundColor()) != null && (inputSelectBackgroundColor = backgroundColor.getInputSelectBackgroundColor()) != null) {
                c10.f6643g.setDropDownBackgroundDrawable(new ColorDrawable(inputSelectBackgroundColor.intValue()));
            }
            c10.f6639c.setHint(attributes.getPlaceholderDay());
            vm.t c11 = dateController.c();
            TextInputEditText dayEditText = c10.f6640d;
            Intrinsics.checkNotNullExpressionValue(dayEditText, "dayEditText");
            vm.u.b(c11, dayEditText);
            c10.f6644h.setHint(attributes.getPlaceholderYear());
            vm.t g10 = dateController.g();
            TextInputEditText yearEditText = c10.f6645i;
            Intrinsics.checkNotNullExpressionValue(yearEditText, "yearEditText");
            vm.u.b(g10, yearEditText);
        }
        uiComponentHelper.d(new Function0() { // from class: xp.d1
    ...
    public static /* synthetic */ ConstraintLayout c(InputDateComponent inputDateComponent, m5 m5Var, yp.e eVar, InputDate inputDate, int i10, Object obj) {
        if ((i10 & 2) != 0) {
    ...
    public static final Unit d(InputDate.InputDateComponentStyle inputDateComponentStyle, aq.f fVar) {
        ...
        if (inputDateComponentStyle != null && (inputSelectStyle3 = inputDateComponentStyle.getInputSelectStyle()) != null && (labelStyle = inputSelectStyle3.getLabelStyle()) != null) {
            TextView dateLabel = fVar.f6638b;
            Intrinsics.checkNotNullExpressionValue(dateLabel, "dateLabel");
            cq.f0.n(dateLabel, labelStyle, null, 2, null);
        }
