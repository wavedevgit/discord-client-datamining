...
public abstract class h0 {
    public static final ConstraintLayout b(f0 f0Var, m5 uiComponentHelper, List componentViews, List children, HorizontalStack config) {
        ...
        final aq.h c10 = aq.h.c(uiComponentHelper.b());
        ...
        if (styles != null) {
            uiComponentHelper.d(new Function0() { // from class: xp.g0
                @Override // kotlin.jvm.functions.Function0
                public final Object invoke() {
                    Unit c11;
                    c11 = h0.c(aq.h.this, styles);
                    return c11;
                }
            });
        }
    ...
    public static final Unit c(aq.h hVar, HorizontalStack.HorizontalStackComponentStyle horizontalStackComponentStyle) {
