...
public abstract class r4 {
    ...
    private static final String i(String str, RemoteImage.RemoteImageComponentStyle remoteImageComponentStyle) {
        ...
        if (remoteImageComponentStyle != null && (originalFillColorValue2 = remoteImageComponentStyle.getOriginalFillColorValue()) != null) {
            ...
            if (newFillColorValue != null && jp.h.g(newFillColorValue.intValue()) != null) {
                str3 = StringsKt.J(str, jp.h.g(intValue), "{{ fill_color }}", false, 4, null);
            } else {
                str3 = str;
            }
            str2 = str3;
        ...
        if (remoteImageComponentStyle != null && (originalHighlightColorValue2 = remoteImageComponentStyle.getOriginalHighlightColorValue()) != null) {
            ...
            if (newHighlightColorValue != null && jp.h.g(newHighlightColorValue.intValue()) != null) {
                str2 = StringsKt.J(str2, jp.h.g(intValue2), "{{ highlight_color }}", false, 4, null);
            }
        }
        String str4 = str2;
        if (remoteImageComponentStyle != null && (originalBackgroundColorValue2 = remoteImageComponentStyle.getOriginalBackgroundColorValue()) != null) {
            ...
            if (newBackgroundColorValue != null && jp.h.g(newBackgroundColorValue.intValue()) != null) {
                str4 = StringsKt.J(str4, jp.h.g(intValue3), "{{ background_color }}", false, 4, null);
            }
        }
        String str5 = str4;
        if (remoteImageComponentStyle != null && (originalStrokeColorValue2 = remoteImageComponentStyle.getOriginalStrokeColorValue()) != null) {
            ...
            if (newStrokeColorValue != null && jp.h.g(newStrokeColorValue.intValue()) != null) {
                str5 = StringsKt.J(str5, jp.h.g(intValue4), "{{ stroke_color }}", false, 4, null);
            }
        }
        if (remoteImageComponentStyle != null && (originalFillColorValue = remoteImageComponentStyle.getOriginalFillColorValue()) != null) {
            ...
            if (newFillColorValue2 != null && (g13 = jp.h.g(newFillColorValue2.intValue())) != null) {
                str5 = w(str5, "{{ fill_color }}", g13, jp.h.g(intValue5));
            }
        }
        if (remoteImageComponentStyle != null && (originalHighlightColorValue = remoteImageComponentStyle.getOriginalHighlightColorValue()) != null) {
            ...
            if (newHighlightColorValue2 != null && (g12 = jp.h.g(newHighlightColorValue2.intValue())) != null) {
                str5 = w(str5, "{{ highlight_color }}", g12, jp.h.g(intValue6));
            }
        }
        if (remoteImageComponentStyle != null && (originalBackgroundColorValue = remoteImageComponentStyle.getOriginalBackgroundColorValue()) != null) {
            ...
            if (newBackgroundColorValue2 != null && (g11 = jp.h.g(newBackgroundColorValue2.intValue())) != null) {
                str5 = w(str5, "{{ background_color }}", g11, jp.h.g(intValue7));
            }
        }
        if (remoteImageComponentStyle != null && (originalStrokeColorValue = remoteImageComponentStyle.getOriginalStrokeColorValue()) != null) {
            ...
            if (newStrokeColorValue2 != null && (g10 = jp.h.g(newStrokeColorValue2.intValue())) != null) {
                return w(str5, "{{ stroke_color }}", g10, jp.h.g(intValue8));
            }
        }
        return str5;
    }
    ...
    private static final void k(final ImageView imageView, String str, final RemoteImage.RemoteImageComponentStyle remoteImageComponentStyle) {
        ...
        r10.e(new k.a() { // from class: xp.p4
            @Override // x4.k.a
    ...
    private static final View n(i4 i4Var, m5 m5Var, final RemoteImage remoteImage) {
        ...
        if (str != null && contentType != null) {
            ...
            if (i10 != 1) {
                if (i10 != 2) {
                    if (i10 == 3) {
                        g10 = jp.s.g(a10, str, jp.t.f32378i);
                        if (g10 != null) {
                            booleanRef.element = true;
                        } else {
                            g10 = jp.s.g(a10, str, jp.t.f32377e);
                        }
                    } else {
                        throw new ir.p();
                    }
            ...
            if (g10 != null) {
                ...
                if (i11 != 1) {
                    if (i11 != 2) {
                        if (i11 == 3) {
                            final lp.f c10 = lp.f.c(m5Var.b());
                            m5Var.d(new Function0() { // from class: xp.o4
                                @Override // kotlin.jvm.functions.Function0
                                public final Object invoke() {
                                    Unit q10;
                                    q10 = r4.q(lp.f.this, remoteImage, booleanRef, a10, intValue);
                                    return q10;
                                }
                            });
                            eVar = c10;
                        ...
                        final lp.f c11 = lp.f.c(m5Var.b());
                        m5Var.d(new Function0() { // from class: xp.n4
                            @Override // kotlin.jvm.functions.Function0
                            public final Object invoke() {
                                Unit p10;
                                p10 = r4.p(lp.f.this, remoteImage, intValue);
                                return p10;
                            }
                        });
                        eVar = c11;
                    ...
                    final lp.e c12 = lp.e.c(m5Var.b());
                    m5Var.d(new Function0() { // from class: xp.m4
                        @Override // kotlin.jvm.functions.Function0
                        public final Object invoke() {
                            Unit o10;
                            o10 = r4.o(lp.e.this, remoteImage);
                            return o10;
                        }
                    });
                    c12.f37421b.setAnimation(intValue);
                    eVar = c12;
                }
                return eVar.getRoot();
            }
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public static final Unit o(lp.e eVar, RemoteImage remoteImage) {
        ThemeableLottieAnimationView lottieView = eVar.f37421b;
        Intrinsics.checkNotNullExpressionValue(lottieView, "lottieView");
        cq.g.f(lottieView, remoteImage);
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public static final Unit p(lp.f fVar, RemoteImage remoteImage, int i10) {
        ImageView imageView = fVar.f37423b;
        Intrinsics.checkNotNullExpressionValue(imageView, "imageView");
        cq.g.f(imageView, remoteImage);
        fVar.f37423b.setImageResource(i10);
        fVar.f37423b.setScaleType(ImageView.ScaleType.FIT_XY);
        fVar.f37423b.setAdjustViewBounds(true);
        return Unit.f33282a;
    }

    /* JADX INFO: Access modifiers changed from: private */
    public static final Unit q(final lp.f fVar, final RemoteImage remoteImage, Ref.BooleanRef booleanRef, Context context, int i10) {
        ImageView imageView = fVar.f37423b;
        Intrinsics.checkNotNullExpressionValue(imageView, "imageView");
        cq.g.f(imageView, remoteImage);
        if (booleanRef.element) {
            Context context2 = fVar.f37423b.getContext();
            Intrinsics.checkNotNullExpressionValue(context2, "getContext(...)");
            v4.h d10 = new h.a(context2).d();
            String resourcePackageName = context.getResources().getResourcePackageName(i10);
            String lowerCase = jp.t.f32378i.toString().toLowerCase(Locale.ROOT);
            Intrinsics.checkNotNullExpressionValue(lowerCase, "toLowerCase(...)");
            String resourceEntryName = context.getResources().getResourceEntryName(i10);
            Uri parse = Uri.parse("android.resource://" + resourcePackageName + "/" + lowerCase + "/" + resourceEntryName);
            ImageView imageView2 = fVar.f37423b;
            Intrinsics.checkNotNullExpressionValue(imageView2, "imageView");
            h.a r10 = new h.a(imageView2.getContext()).d(parse).r(imageView2);
            r10.e(new k.a() { // from class: xp.q4
                @Override // x4.k.a
                public final x4.k a(a5.l lVar, g5.m mVar, v4.h hVar) {
                    x4.k r11;
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public static final x4.k r(RemoteImage remoteImage, lp.f fVar, a5.l result, g5.m options, v4.h hVar) {
        Intrinsics.checkNotNullParameter(result, "result");
        Intrinsics.checkNotNullParameter(options, "options");
        Intrinsics.checkNotNullParameter(hVar, "<unused var>");
        byte[] n12 = result.c().h().n1();
        ...
        Intrinsics.checkNotNullExpressionValue(bytes, "getBytes(...)");
        Buffer write = new Buffer().write(bytes);
        Context context = fVar.f37423b.getContext();
        Intrinsics.checkNotNullExpressionValue(context, "getContext(...)");
        return new x4.z(x4.u.f(write, context), options, false, 4, null);
    }
    ...
    private static final View s(i4 i4Var, m5 m5Var, final RemoteImage remoteImage) {
        ...
        if (contentType == null) {
            ...
            i10 = a.f53703a[contentType.ordinal()];
        }
        if (i10 != 1) {
            if (i10 != 3) {
                final lp.f c10 = lp.f.c(m5Var.b());
                m5Var.d(new Function0() { // from class: xp.l4
                    @Override // kotlin.jvm.functions.Function0
                    public final Object invoke() {
                        Unit v10;
                        v10 = r4.v(lp.f.this, remoteImage, attributes);
                        return v10;
                    }
                });
                eVar = c10;
                ...
                final lp.f c11 = lp.f.c(m5Var.b());
                m5Var.d(new Function0() { // from class: xp.j4
                    @Override // kotlin.jvm.functions.Function0
                    public final Object invoke() {
                        Unit t10;
                        t10 = r4.t(lp.f.this, remoteImage, attributes);
                        return t10;
                    }
                });
                eVar = c11;
            ...
            final lp.e c12 = lp.e.c(m5Var.b());
            m5Var.d(new Function0() { // from class: xp.k4
                @Override // kotlin.jvm.functions.Function0
                public final Object invoke() {
                    Unit u10;
                    u10 = r4.u(lp.e.this, remoteImage);
                    return u10;
                }
            });
            c12.f37421b.J(attributes.getUrl());
            eVar = c12;
        }
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public static final Unit t(lp.f fVar, RemoteImage remoteImage, RemoteImage.Attributes attributes) {
        ImageView imageView = fVar.f37423b;
        Intrinsics.checkNotNullExpressionValue(imageView, "imageView");
        cq.g.f(imageView, remoteImage);
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public static final Unit u(lp.e eVar, RemoteImage remoteImage) {
        ThemeableLottieAnimationView lottieView = eVar.f37421b;
        Intrinsics.checkNotNullExpressionValue(lottieView, "lottieView");
        cq.g.f(lottieView, remoteImage);
        eVar.f37421b.setRepeatMode(1);
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public static final Unit v(lp.f fVar, RemoteImage remoteImage, RemoteImage.Attributes attributes) {
        String str;
        ImageView imageView = fVar.f37423b;
        Intrinsics.checkNotNullExpressionValue(imageView, "imageView");
        cq.g.f(imageView, remoteImage);
