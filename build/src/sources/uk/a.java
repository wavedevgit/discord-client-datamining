...
public final class a implements m {
    ...
    private static final p[] f51345b = new p[0];

    /* renamed from: a  reason: collision with root package name */
    private final c f51346a = new c();
    ...
    public Result a(kk.c cVar, Map map) {
        e b10 = this.f51346a.b(b(cVar.a()), map);
        Result result = new Result(b10.k(), b10.g(), f51345b, kk.a.MAXICODE);
