...
public final class d extends k {
    ...
    private static final char[] f51651c = "0123456789ABCDEFGHIJKLMNOPQRSTUVWXYZ-. $/+%abcd*".toCharArray();

    /* renamed from: d  reason: collision with root package name */
    static final int[] f51652d;

    /* renamed from: e  reason: collision with root package name */
    static final int f51653e;

    /* renamed from: a  reason: collision with root package name */
    private final StringBuilder f51654a = new StringBuilder(20);

    /* renamed from: b  reason: collision with root package name */
    private final int[] f51655b = new int[6];
    ...
    private static void h(CharSequence charSequence, int i10, int i11) {
        ...
        if (charSequence.charAt(i10) == f51651c[i12 % 47]) {
            return;
        }
        throw ik.d.a();
    }
    ...
    private int[] j(mk.a aVar) {
        int l10 = aVar.l();
        int j10 = aVar.j(0);
        Arrays.fill(this.f51655b, 0);
        int[] iArr = this.f51655b;
    ...
    public Result b(int i10, mk.a aVar, Map map) {
        ...
        int[] iArr = this.f51655b;
        Arrays.fill(iArr, 0);
        StringBuilder sb2 = this.f51654a;
        sb2.setLength(0);
        while (true) {
            k.e(aVar, j11, iArr);
            int l11 = l(iArr);
                ...
                if (k10 == '*') {
                    ...
                    if (j12 != l10 && aVar.h(j12)) {
                        if (sb2.length() >= 2) {
                            ...
                            float f10 = i10;
                            Result result = new Result(i(sb2), null, new ik.p[]{new ik.p((j10[1] + j10[0]) / 2.0f, f10), new ik.p(j11 + (i13 / 2.0f), f10)}, ik.a.CODE_93);
                            result.h(ik.o.SYMBOLOGY_IDENTIFIER, "]G0");
                            return result;
                        }
                        throw ik.k.a();
                    }
