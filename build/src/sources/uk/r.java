...
abstract class r {
    ...
    private static final Map f51454a;

    /* renamed from: b  reason: collision with root package name */
    private static final Map f51455b;

    /* renamed from: c  reason: collision with root package name */
    private static final Map f51456c;

    /* renamed from: d  reason: collision with root package name */
    private static final Map f51457d;
    ...
    static {
        ...
        for (int i10 = 90; i10 <= 99; i10++) {
            f51454a.put(String.valueOf(i10), a.b(30));
        }
        ...
        for (int i11 = 310; i11 <= 316; i11++) {
            f51456c.put(String.valueOf(i11), a.a(6));
        }
        for (int i12 = 320; i12 <= 337; i12++) {
            f51456c.put(String.valueOf(i12), a.a(6));
        }
        for (int i13 = 340; i13 <= 357; i13++) {
            f51456c.put(String.valueOf(i13), a.a(6));
        }
        for (int i14 = 360; i14 <= 369; i14++) {
            f51456c.put(String.valueOf(i14), a.a(6));
        }
        Map map = f51456c;
        map.put("390", a.b(15));
        map.put("391", a.b(18));
    ...
    public static String a(String str) {
        ...
        if (str.length() >= 2) {
            a aVar = (a) f51454a.get(str.substring(0, 2));
            if (aVar != null) {
                if (aVar.f51458a) {
                    return c(2, aVar.f51459b, str);
                }
                return b(2, aVar.f51459b, str);
            } else if (str.length() >= 3) {
                String substring = str.substring(0, 3);
                a aVar2 = (a) f51455b.get(substring);
                if (aVar2 != null) {
                    if (aVar2.f51458a) {
                        return c(3, aVar2.f51459b, str);
                    }
                    return b(3, aVar2.f51459b, str);
                } else if (str.length() >= 4) {
                    a aVar3 = (a) f51456c.get(substring);
                    if (aVar3 != null) {
                        if (aVar3.f51458a) {
                            return c(4, aVar3.f51459b, str);
                        }
                        return b(4, aVar3.f51459b, str);
                    }
                    a aVar4 = (a) f51457d.get(str.substring(0, 4));
                    if (aVar4 != null) {
                        if (aVar4.f51458a) {
                            return c(4, aVar4.f51459b, str);
                        }
                        return b(4, aVar4.f51459b, str);
                    }
                    throw fk.k.a();
                } else {
                    throw fk.k.a();
