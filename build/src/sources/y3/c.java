...
public final class c implements x3.g {
    ...
    public static final a f55917i = new a(null);

    /* renamed from: o  reason: collision with root package name */
    private static final String[] f55918o = {"", " OR ROLLBACK ", " OR ABORT ", " OR FAIL ", " OR IGNORE ", " OR REPLACE "};

    /* renamed from: p  reason: collision with root package name */
    private static final String[] f55919p = new String[0];

    /* renamed from: d  reason: collision with root package name */
    private final SQLiteDatabase f55920d;

    /* renamed from: e  reason: collision with root package name */
    private final List f55921e;
    ...
    public c(SQLiteDatabase delegate) {
        ...
        this.f55920d = delegate;
        this.f55921e = delegate.getAttachedDbs();
    }
    ...
    public Cursor O(final j query, CancellationSignal cancellationSignal) {
        Intrinsics.checkNotNullParameter(query, "query");
        SQLiteDatabase sQLiteDatabase = this.f55920d;
        String a10 = query.a();
        String[] strArr = f55919p;
    ...
    public Cursor R0(j query) {
        ...
        Cursor rawQueryWithFactory = this.f55920d.rawQueryWithFactory(new SQLiteDatabase.CursorFactory() { // from class: y3.b
            @Override // android.database.sqlite.SQLiteDatabase.CursorFactory
    ...
    @Override // x3.g
    public boolean W1() {
        return this.f55920d.inTransaction();
    }
    ...
    public final boolean i(SQLiteDatabase sqLiteDatabase) {
        ...
        return Intrinsics.areEqual(this.f55920d, sqLiteDatabase);
    }

    @Override // x3.g
    public boolean i2() {
        return x3.b.b(this.f55920d);
    }

    @Override // x3.g
    public boolean isOpen() {
        return this.f55920d.isOpen();
    }

    @Override // x3.g
    public void k0() {
        this.f55920d.setTransactionSuccessful();
    }
    ...
    public void l0(String sql, Object[] bindArgs) {
        ...
        this.f55920d.execSQL(sql, bindArgs);
    }

    @Override // x3.g
    public void m0() {
        this.f55920d.beginTransactionNonExclusive();
    }

    @Override // x3.g
    public k m1(String sql) {
        Intrinsics.checkNotNullParameter(sql, "sql");
        SQLiteStatement compileStatement = this.f55920d.compileStatement(sql);
    ...
    @Override // x3.g
    public String t() {
        return this.f55920d.getPath();
    }

    @Override // x3.g
    public void t0() {
        this.f55920d.endTransaction();
    }
