...
public class c {
    ...
    private static final c f21753a = new c();
    ...
    private static byte[] l(byte[] bArr, int i10, int i11) {
        ...
        try {
            ...
            throw new sj.a("Image conversion error from NV21 format", 13, e10);
        }
    }
    ...
    public ByteBuffer d(ck.a aVar, boolean z10) {
        ByteBuffer allocateDirect;
        ...
        if (g10 != -1) {
            if (g10 != 17) {
                if (g10 != 35) {
                    ...
                    throw new sj.a("Unsupported image format", 13);
                }
