...
public class b {
    ...
    private static final Object f45315d = new Object();
    ...
    public b(Drawable.Callback callback, String str, c cVar, Map map) {
        ...
        if (!(callback instanceof View)) {
            ...
            this.f45316a = ((View) callback).getContext().getApplicationContext();
        }
    }

    private Bitmap c(String str, Bitmap bitmap) {
        synchronized (f45315d) {
            ((x) this.f45318c.get(str)).g(bitmap);
        }
        return bitmap;
    }

    public Bitmap a(String str) {
        x xVar = (x) this.f45318c.get(str);
        if (xVar == null) {
            return null;
        }
        Bitmap b10 = xVar.b();
        ...
        try {
            if (!TextUtils.isEmpty(this.f45317b)) {
                AssetManager assets = context.getAssets();
                try {
                    Bitmap decodeStream = BitmapFactory.decodeStream(assets.open(this.f45317b + c10), null, options);
    ...
    public boolean b(Context context) {
        ...
        if (this.f45316a instanceof Application) {
            context = context.getApplicationContext();
        }
        if (context != this.f45316a) {
            return false;
        }
        return true;
    }
