...
public final class h implements r {
    ...
    public static /* synthetic */ class a {
        ...
        static {
            ...
            try {
                f27724a[v.ABBREVIATED.ordinal()] = 2;
            } catch (NoSuchFieldError unused2) {
            }
            try {
                f27724a[v.SHORT.ordinal()] = 3;
            } catch (NoSuchFieldError unused3) {
            }
            try {
                f27724a[v.NARROW.ordinal()] = 4;
    ...
    private static String F(char c10, v vVar, n nVar) {
        ...
        sb2.append(c10);
        int i10 = a.f27724a[vVar.ordinal()];
        if (i10 != 1) {
            if (i10 != 2 && i10 != 3) {
                if (i10 == 4) {
                    sb2.append('n');
    ...
    @Override // cu.r
    public String k(y0 y0Var, Locale locale) {
        return I(locale, y0Var.name().substring(0, 3).toLowerCase() + "-");
    }

    @Override // cu.r
    public String l(Locale locale, boolean z10, n nVar) {
    ...
    @Override // cu.x
    public String n(Locale locale, boolean z10, n nVar) {
        return K(locale, 'W', z10, nVar);
    }

    @Override // cu.x
    public String o(Locale locale, v vVar, n nVar) {
    ...
    @Override // cu.x
    public String s(Locale locale, v vVar, int i10) {
        String str;
        int i11;
        if (i10 >= 2) {
