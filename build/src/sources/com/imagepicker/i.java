...
public class i extends f {
    ...
    public i(Uri uri, Context context) {
        ...
        if (extractMetadata != null) {
            this.f18029d = Math.round(Float.parseFloat(extractMetadata)) / 1000;
        }
        if (extractMetadata2 != null) {
            this.f18030e = Integer.parseInt(extractMetadata2);
        }
        if (extractMetadata3 != null) {
            this.f18005a = a(extractMetadata3.substring(0, extractMetadata3.indexOf(".")).replace("T", " "), "yyyyMMdd HHmmss");
        }
        if (b10 != null) {
            this.f18007c = b10.getWidth();
            this.f18006b = b10.getHeight();
        }
        try {
