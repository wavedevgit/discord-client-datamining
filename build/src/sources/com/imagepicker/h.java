...
public abstract class h {
    ...
    public static String f18020a = "rn_image_picker_lib_temp_";

    /* renamed from: b  reason: collision with root package name */
    public static String f18021b = "camera_unavailable";

    /* renamed from: c  reason: collision with root package name */
    public static String f18022c = "permission";

    /* renamed from: d  reason: collision with root package name */
    public static String f18023d = "others";

    /* renamed from: e  reason: collision with root package name */
    public static String f18024e = "photo";

    /* renamed from: f  reason: collision with root package name */
    public static String f18025f = "video";

    /* renamed from: g  reason: collision with root package name */
    public static String f18026g = "mixed";

    /* renamed from: h  reason: collision with root package name */
    public static String f18027h = "any";

    /* renamed from: i  reason: collision with root package name */
    public static String f18028i = "This library does not require Manifest.permission.CAMERA, if you add this permission in manifest then you have to obtain the same.";
    ...
    public static Uri C(Uri uri, UUID uuid, Context context, g gVar) {
        try {
            ...
            createScaledBitmap.compress(h(r10), gVar.f18012e, context.getContentResolver().openOutputStream(Uri.fromFile(c10)));
            F(c10, s10, context);
    ...
    static boolean G(int i10, int i11, g gVar) {
        int i12 = gVar.f18013f;
        if ((i12 == 0 || gVar.f18014g == 0) && gVar.f18012e == 100) {
            return false;
        }
        if (i12 >= i10 && gVar.f18014g >= i11 && gVar.f18012e == 100) {
            return false;
        }
        return true;
    }
    ...
    public static File c(Context context, UUID uuid, String str) {
        ...
        File file = new File(context.getCacheDir(), f18020a + uuid + "." + str);
        file.createNewFile();
        return file;
    }
    ...
    static int[] n(int i10, int i11, g gVar) {
        int i12;
        int i13 = gVar.f18013f;
        if (i13 != 0 && (i12 = gVar.f18014g) != 0) {
            if (i13 < i10) {
                i11 = (int) ((i13 / i10) * i11);
                i10 = i13;
            }
    ...
    static ReadableMap p(Uri uri, g gVar, Context context) {
        ...
        if (gVar.f18009b.booleanValue()) {
            createMap.putString("base64", g(uri, context));
        }
        if (gVar.f18010c.booleanValue()) {
    ...
    public static ReadableMap t(List list, UUID uuid, g gVar, Context context) {
        boolean equals = gVar.f18019l.equals(f18024e);
        boolean equals2 = gVar.f18019l.equals(f18025f);
        boolean equals3 = gVar.f18019l.equals(f18026g);
        boolean equals4 = gVar.f18019l.equals(f18027h);
