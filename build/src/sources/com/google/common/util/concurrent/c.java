...
public abstract class c extends d {
    ...
    private static final class a implements Runnable {
        ...
        public void run() {
            Throwable a10;
            Future future = this.f17153d;
            if ((future instanceof ti.a) && (a10 = ti.b.a((ti.a) future)) != null) {
                this.f17154e.onFailure(a10);
                return;
            }
            try {
                this.f17154e.onSuccess(c.b(this.f17153d));
            } catch (Error e10) {
                e = e10;
                this.f17154e.onFailure(e);
            } catch (RuntimeException e11) {
                e = e11;
                this.f17154e.onFailure(e);
            } catch (ExecutionException e12) {
                this.f17154e.onFailure(e12.getCause());
            }
        }

        public String toString() {
            return h.b(this).c(this.f17154e).toString();
        }
    }
