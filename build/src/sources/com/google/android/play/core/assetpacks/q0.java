...
final class q0 extends th.o {
    ...
    private final File f15573d;

    /* renamed from: e  reason: collision with root package name */
    private final File f15574e;

    /* renamed from: i  reason: collision with root package name */
    private final NavigableMap f15575i = new TreeMap();
    ...
    public q0(File file, File file2) {
        ...
        if (!a10.isEmpty()) {
            long j10 = 0;
            for (File file3 : a10) {
                this.f15575i.put(Long.valueOf(j10), file3);
                j10 += file3.length();
            }
            return;
        }
    ...
    private final InputStream n(long j10, Long l10) {
        FileInputStream fileInputStream = new FileInputStream((File) this.f15575i.get(l10));
    ...
    @Override // th.o
    public final long a() {
        Map.Entry lastEntry = this.f15575i.lastEntry();
    ...
    public final InputStream h(long j10, long j11) {
        if (j10 >= 0 && j11 >= 0) {
            long j12 = j10 + j11;
            if (j12 <= a()) {
                Long l10 = (Long) this.f15575i.floorKey(Long.valueOf(j10));
                Long l11 = (Long) this.f15575i.floorKey(Long.valueOf(j12));
                if (l10.equals(l11)) {
                    return new p0(n(j10, l10), j11);
                }
                ArrayList arrayList = new ArrayList();
                arrayList.add(n(j10, l10));
                Collection values = this.f15575i.subMap(l10, false, l11, false).values();
                if (!values.isEmpty()) {
                    arrayList.add(new sh.d(Collections.enumeration(values)));
                }
                arrayList.add(new p0(new FileInputStream((File) this.f15575i.get(l11)), j11 - (l11.longValue() - j10)));
