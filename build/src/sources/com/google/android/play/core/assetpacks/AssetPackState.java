...
public abstract class AssetPackState {
    ...
    public static AssetPackState e(Bundle bundle, String str, b2 b2Var, o3 o3Var, g0 g0Var) {
        int a10 = g0Var.a(bundle.getInt(zh.b.a("status", str)), str);
        int i10 = bundle.getInt(zh.b.a("error_code", str));
        long j10 = bundle.getLong(zh.b.a("bytes_downloaded", str));
        long j11 = bundle.getLong(zh.b.a("total_bytes_to_download", str));
        double a11 = b2Var.a(str);
        long j12 = bundle.getLong(zh.b.a("pack_version", str));
        long j13 = bundle.getLong(zh.b.a("pack_base_version", str));
        int i11 = 1;
        if (a10 == 4) {
            if (j13 != 0 && j13 != j12) {
                i11 = 2;
        ...
        return a(str, a10, i10, j10, j11, a11, i11, bundle.getString(zh.b.a("pack_version_tag", str), String.valueOf(bundle.getInt("app_version_code"))), o3Var.a(str));
    }
