...
public final class m1 {
    ...
    private static final th.k0 f15511g = new th.k0("ExtractChunkTaskHandler");

    /* renamed from: a  reason: collision with root package name */
    private final byte[] f15512a = new byte[8192];

    /* renamed from: b  reason: collision with root package name */
    private final n0 f15513b;

    /* renamed from: c  reason: collision with root package name */
    private final b2 f15514c;

    /* renamed from: d  reason: collision with root package name */
    private final o3 f15515d;

    /* renamed from: e  reason: collision with root package name */
    private final th.r f15516e;

    /* renamed from: f  reason: collision with root package name */
    private final th.r f15517f;
    ...
    private final File b(l1 l1Var) {
        File C = this.f15513b.C(l1Var.f15640b, l1Var.f15477c, l1Var.f15478d, l1Var.f15480f);
        if (!C.exists()) {
            C.mkdirs();
        }
        return C;
    ...
    /* JADX WARN: Code restructure failed: missing block: B:100:0x02ce, code lost:
        com.google.android.play.core.assetpacks.m1.f15511g.e("Could not close file for chunk %s of slice %s of pack %s.", java.lang.Integer.valueOf(r21.f15482h), r21.f15480f, r21.f15640b);
     */
