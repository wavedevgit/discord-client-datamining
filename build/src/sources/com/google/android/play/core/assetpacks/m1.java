...
public final class m1 {
    ...
    private static final yh.k0 f16025g = new yh.k0("ExtractChunkTaskHandler");

    /* renamed from: a  reason: collision with root package name */
    private final byte[] f16026a = new byte[8192];

    /* renamed from: b  reason: collision with root package name */
    private final n0 f16027b;

    /* renamed from: c  reason: collision with root package name */
    private final b2 f16028c;

    /* renamed from: d  reason: collision with root package name */
    private final o3 f16029d;

    /* renamed from: e  reason: collision with root package name */
    private final yh.r f16030e;

    /* renamed from: f  reason: collision with root package name */
    private final yh.r f16031f;

    /* JADX INFO: Access modifiers changed from: package-private */
    public m1(n0 n0Var, yh.r rVar, yh.r rVar2, b2 b2Var, o3 o3Var) {
        this.f16027b = n0Var;
        this.f16030e = rVar;
        this.f16031f = rVar2;
        this.f16028c = b2Var;
    ...
    private final File b(l1 l1Var) {
        File C = this.f16027b.C(l1Var.f16154b, l1Var.f15991c, l1Var.f15992d, l1Var.f15994f);
        if (!C.exists()) {
            C.mkdirs();
        }
        return C;
    ...
    /* JADX WARN: Code restructure failed: missing block: B:100:0x02ce, code lost:
        com.google.android.play.core.assetpacks.m1.f16025g.e("Could not close file for chunk %s of slice %s of pack %s.", java.lang.Integer.valueOf(r21.f15996h), r21.f15994f, r21.f16154b);
     */
