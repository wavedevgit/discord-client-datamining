...
public final class SessionStateBroadcastReceiver extends BroadcastReceiver {
    ...
    private static final th.k0 f15271a = new th.k0("SessionStateBroadcastReceiver");

    @Override // android.content.BroadcastReceiver
    public final void onReceive(Context context, Intent intent) {
        Bundle bundleExtra = intent.getBundleExtra("com.google.android.play.core.FLAGS");
        if (bundleExtra == null) {
            f15271a.b("Empty flags bundle received from broadcast.", new Object[0]);
        } else if (!bundleExtra.getBoolean("enableWorkManager")) {
        } else {
            Bundle bundleExtra2 = intent.getBundleExtra("com.google.android.play.core.assetpacks.receiver.EXTRA_SESSION_STATE");
            if (bundleExtra2 == null) {
                f15271a.b("Empty bundle received from broadcast.", new Object[0]);
            } else {
