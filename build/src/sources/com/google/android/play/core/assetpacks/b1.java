...
public abstract class b1 {
    ...
    private static void e(y0 y0Var) {
        ...
        for (String str : y0Var.g("pack_names")) {
            y0Var.b(bi.b.a("pack_version", str));
            y0Var.a(bi.b.a("pack_version_tag", str));
            y0Var.e(bi.b.a("status", str));
            y0Var.b(bi.b.a("total_bytes_to_download", str));
            for (String str2 : y0Var.g(bi.b.a("slice_ids", str))) {
                y0Var.c(bi.b.b("chunk_intents", str, str2));
                y0Var.a(bi.b.b("uncompressed_hash_sha256", str, str2));
                y0Var.b(bi.b.b("uncompressed_size", str, str2));
                y0Var.e(bi.b.b("patch_format", str, str2));
                y0Var.e(bi.b.b("compression_format", str, str2));
            }
        }
    }
}
