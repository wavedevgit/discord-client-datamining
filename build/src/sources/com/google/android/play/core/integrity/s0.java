...
final class s0 extends c.a {
    ...
    public /* synthetic */ s0(long j10, int i10, bi.f fVar) {
        this.f16352a = j10;
    }
    ...
    public final String toString() {
        return "PrepareIntegrityTokenRequest{cloudProjectNumber=" + this.f16352a + ", webViewRequestMode=0}";
    }
}
