...
public final class n0 {
    ...
    private static final xh.k0 f15898c = new xh.k0("AssetPackStorage");

    /* renamed from: d  reason: collision with root package name */
    private static final long f15899d;

    /* renamed from: e  reason: collision with root package name */
    private static final long f15900e;

    /* renamed from: a  reason: collision with root package name */
    private final Context f15901a;

    /* renamed from: b  reason: collision with root package name */
    private final q3 f15902b;

    static {
        TimeUnit timeUnit = TimeUnit.DAYS;
        f15899d = timeUnit.toMillis(14L);
        f15900e = timeUnit.toMillis(28L);
    }
    ...
    private static long g(File file, boolean z10) {
        ...
        if (file.exists()) {
            ...
            if (z10 && file.listFiles().length > 1) {
                f15898c.e("Multiple pack versions found, using highest version code.", new Object[0]);
            }
            try {
                ...
                f15898c.c(e10, "Corrupt asset pack directories.", new Object[0]);
            }
    ...
    private final File k() {
        return new File(this.f15901a.getFilesDir(), "assetpacks");
    }
    ...
    private final List m() {
        ...
        try {
            ...
            f15898c.b("Could not process directory while scanning installed packs. %s", e10);
            return arrayList;
        }
    }
    ...
    final String E(String str) {
        ...
        if (!file.exists()) {
            f15898c.a("Pack not found with pack name: %s", str);
            return null;
        }
        File file2 = new File(file, String.valueOf(this.f15902b.a()));
        if (!file2.exists()) {
            f15898c.a("Pack not found with pack name: %s app version: %s", str, Integer.valueOf(this.f15902b.a()));
            return null;
        }
        File[] listFiles = file2.listFiles();
        if (listFiles != null && (length = listFiles.length) != 0) {
            if (length > 1) {
                f15898c.b("Multiple pack versions found for pack name: %s app version: %s", str, Integer.valueOf(this.f15902b.a()));
                return null;
            }
            return listFiles[0].getCanonicalPath();
        }
        f15898c.a("No pack version found for pack name: %s app version: %s", str, Integer.valueOf(this.f15902b.a()));
        return null;
    }
    ...
    public final void I() {
        for (File file : m()) {
            if (file.listFiles() != null) {
                n(file);
                long g10 = g(file, false);
                if (this.f15902b.a() != g10) {
                    try {
                        new File(new File(file, String.valueOf(g10)), "stale.tmp").createNewFile();
                    } catch (IOException unused) {
                        f15898c.b("Could not write staleness marker.", new Object[0]);
                    }
                }
                for (File file2 : file.listFiles()) {
                    n(file2);
    ...
    public final void J() {
        ...
        if (l().exists()) {
            for (File file : l().listFiles()) {
                if (System.currentTimeMillis() - file.lastModified() > f15899d) {
                    o(file);
                } else {
                    n(file);
                }
        ...
        for (File file : m()) {
            if (file.listFiles() != null) {
                for (File file2 : file.listFiles()) {
                    ...
                    if (file3.exists() && System.currentTimeMillis() - file3.lastModified() > f15900e) {
                        o(file2);
                    }
                }
            }
    ...
    public final b s(String str) {
        ...
        if (!file.isDirectory()) {
            f15898c.b("Failed to find assets directory: %s", file);
            return null;
        }
