...
final class u extends o {
    ...
    public final void g(Bundle bundle) {
        this.f16021h.f16066d.u(this.f15916c);
        x.f16061g.b("onError(%d), retrying notifyModuleCompleted...", Integer.valueOf(bundle.getInt("error_code")));
        int i10 = this.f16020g;
        if (i10 > 0) {
            this.f16021h.k(this.f16018e, this.f16019f, i10 - 1);
        }
    }
}
