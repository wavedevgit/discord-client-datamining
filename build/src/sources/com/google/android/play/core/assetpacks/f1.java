...
final class f1 extends FilterInputStream {
    ...
    private final e3 f16767d;

    /* renamed from: e  reason: collision with root package name */
    private byte[] f16768e;
    ...
    public f1(InputStream inputStream) {
        super(inputStream);
        this.f16767d = new e3();
        this.f16768e = new byte[RecyclerView.ItemAnimator.FLAG_APPEARED_IN_PRE_LAYOUT];
        this.f16770o = false;
        this.f16771p = false;
    }

    private final boolean B(int i10) {
        int x10 = x(this.f16768e, 0, i10);
        if (x10 != i10) {
            int i11 = i10 - x10;
            if (x(this.f16768e, x10, i11) != i11) {
                this.f16767d.b(this.f16768e, 0, x10);
                return false;
            }
        }
        this.f16767d.b(this.f16768e, 0, i10);
        return true;
    }
    ...
    public final h4 h() {
        ...
        if (this.f16769i > 0) {
            ...
            if (this.f16770o && !this.f16771p) {
                if (!B(30)) {
                    this.f16770o = true;
                    return this.f16767d.c();
                }
                h4 c10 = this.f16767d.c();
                if (c10.d()) {
                    this.f16771p = true;
                    return c10;
                } else if (c10.b() != 4294967295L) {
                    int a10 = this.f16767d.a() - 30;
                    ...
                    if (j10 > length) {
                        ...
                        this.f16768e = Arrays.copyOf(this.f16768e, length);
                    }
                    if (!B(a10)) {
                        this.f16770o = true;
                        return this.f16767d.c();
                    }
                    h4 c11 = this.f16767d.c();
                    this.f16769i = c11.b();
                    return c11;
                } else {
