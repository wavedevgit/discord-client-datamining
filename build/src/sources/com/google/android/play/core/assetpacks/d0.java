...
public final class d0 extends ai.j0 {
    ...
    private final r2 f16590g;

    /* renamed from: h  reason: collision with root package name */
    private final y1 f16591h;

    /* renamed from: i  reason: collision with root package name */
    private final g1 f16592i;

    /* renamed from: j  reason: collision with root package name */
    private final b2 f16593j;

    /* renamed from: k  reason: collision with root package name */
    private final o3 f16594k;

    /* renamed from: l  reason: collision with root package name */
    private final Handler f16595l;

    /* renamed from: m  reason: collision with root package name */
    private final ai.r f16596m;

    /* renamed from: n  reason: collision with root package name */
    private final ai.r f16597n;

    /* renamed from: o  reason: collision with root package name */
    private final ai.r f16598o;
    ...
    public d0(Context context, r2 r2Var, y1 y1Var, ai.r rVar, b2 b2Var, g1 g1Var, ai.r rVar2, ai.r rVar3, o3 o3Var) {
        ...
        this.f16595l = new Handler(Looper.getMainLooper());
        this.f16590g = r2Var;
        this.f16591h = y1Var;
        this.f16596m = rVar;
        this.f16593j = b2Var;
    ...
    public static /* synthetic */ void g(d0 d0Var, Bundle bundle) {
        if (d0Var.f16590g.p(bundle)) {
            d0Var.f16591h.a();
        }
    }

    public static /* synthetic */ void h(final d0 d0Var, Bundle bundle, final AssetPackState assetPackState) {
        if (d0Var.f16590g.o(bundle)) {
            d0Var.f16595l.post(new Runnable() { // from class: com.google.android.play.core.assetpacks.z
                @Override // java.lang.Runnable
                public final void run() {
                    d0.this.e(assetPackState);
                }
            });
            ((t4) d0Var.f16596m.a()).f();
        }
    }
    ...
    public final void b(Context context, Intent intent) {
        ...
        if (stringArrayList != null && stringArrayList.size() == 1) {
            final AssetPackState c10 = AssetPackState.c(bundleExtra2, stringArrayList.get(0), this.f16593j, this.f16594k);
            ...
            if (pendingIntent != null) {
                this.f16592i.a(pendingIntent);
            }
            ((Executor) this.f16598o.a()).execute(new Runnable() { // from class: com.google.android.play.core.assetpacks.b0
                @Override // java.lang.Runnable
                public final void run() {
                    d0.h(d0.this, bundleExtra2, c10);
                }
            });
            ((Executor) this.f16597n.a()).execute(new Runnable() { // from class: com.google.android.play.core.assetpacks.c0
                @Override // java.lang.Runnable
                public final void run() {
