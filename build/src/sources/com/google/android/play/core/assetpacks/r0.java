...
final class r0 extends b {
    ...
    public final boolean equals(Object obj) {
        ...
        if (obj instanceof b) {
            b bVar = (b) obj;
            if (this.f15956c == bVar.c() && ((str = this.f15957d) != null ? str.equals(bVar.d()) : bVar.d() == null) && ((str2 = this.f15958e) != null ? str2.equals(bVar.b()) : bVar.b() == null)) {
                return true;
            }
        }
        return false;
    ...
    public final String toString() {
        return "AssetPackLocation{packStorageMethod=" + this.f15956c + ", path=" + this.f15957d + ", assetsPath=" + this.f15958e + "}";
    }
}
