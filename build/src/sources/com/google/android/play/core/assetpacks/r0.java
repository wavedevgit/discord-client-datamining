...
final class r0 extends b {
    ...
    public final boolean equals(Object obj) {
        ...
        if (obj instanceof b) {
            b bVar = (b) obj;
            if (this.f16846c == bVar.c() && ((str = this.f16847d) != null ? str.equals(bVar.d()) : bVar.d() == null) && ((str2 = this.f16848e) != null ? str2.equals(bVar.b()) : bVar.b() == null)) {
                return true;
            }
        }
        return false;
    ...
    public final String toString() {
        return "AssetPackLocation{packStorageMethod=" + this.f16846c + ", path=" + this.f16847d + ", assetsPath=" + this.f16848e + "}";
    }
}
