...
final class m3 {
    ...
    private final NotificationManager f16923b;

    /* JADX INFO: Access modifiers changed from: package-private */
    public m3(Context context) {
        this.f16922a = context;
        this.f16923b = (NotificationManager) context.getSystemService("notification");
    }
    ...
    private final synchronized void c(String str) {
        ...
        try {
            sh.f.a();
            this.f16923b.createNotificationChannel(com.google.android.gms.common.e.a("playcore-assetpacks-service-notification-channel", str, 2));
        } catch (Throwable th2) {
            throw th2;
        }
    }
    ...
    public final Notification a(Bundle bundle) {
        ...
        if (Build.VERSION.SDK_INT < 26) {
            timeoutAfter = new Notification.Builder(this.f16922a).setPriority(-2);
        } else {
            timeoutAfter = sh.e.a(this.f16922a, "playcore-assetpacks-service-notification-channel").setTimeoutAfter(bundle.getLong("notification_timeout", 600000L));
        }
        ...
        if (parcelable instanceof PendingIntent) {
            ...
            activity = PendingIntent.getActivity(this.f16922a, 0, intent, 201326592);
        }
        if (activity != null) {
