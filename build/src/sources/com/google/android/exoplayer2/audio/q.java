...
final class q extends i {
    ...
    private static final int f13438i = Float.floatToIntBits(Float.NaN);

    private static void m(int i10, ByteBuffer byteBuffer) {
        int floatToIntBits = Float.floatToIntBits((float) (i10 * 4.656612875245797E-10d));
        if (floatToIntBits == f13438i) {
    ...
    public d.a h(d.a aVar) {
        ...
        if (w0.D0(i10)) {
            if (i10 != 4) {
                return new d.a(aVar.f13239a, aVar.f13240b, 4);
            }
            return d.a.f13238e;
        }
        throw new d.b(aVar);
