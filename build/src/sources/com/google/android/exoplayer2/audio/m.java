...
public class m extends fd.r implements a0 {
    ...
    private static boolean E1(String str) {
        if (w0.f40279a < 24 && "OMX.SEC.aac.dec".equals(str) && "samsung".equals(w0.f40281c)) {
    ...
    private int G1(fd.q qVar, Format format) {
        int i10;
        if ("OMX.google.raw.decoder".equals(qVar.f24983a) && (i10 = w0.f40279a) < 24 && (i10 != 23 || !w0.H0(this.R0))) {
            return -1;
        }
    ...
    public DecoderReuseEvaluation V0(x xVar) {
        this.W0 = (Format) ne.a.e(xVar.f37110b);
    ...
    protected void W0(Format format, MediaFormat mediaFormat) {
        ...
        if (format2 != null) {
            ...
            if ("audio/raw".equals(format.f12706w)) {
                i10 = format.L;
            } else if (w0.f40279a >= 24 && mediaFormat.containsKey("pcm-encoding")) {
    ...
    protected void a1(qc.f fVar) {
        if (this.Z0 && !fVar.l()) {
            if (Math.abs(fVar.f47078p - this.Y0) > 500000) {
                this.Y0 = fVar.f47078p;
            }
            this.Z0 = false;
        }
    }
