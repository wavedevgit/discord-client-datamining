...
public abstract class a extends Timeline {
    ...
    private final int f12632q;

    /* renamed from: r  reason: collision with root package name */
    private final rd.o0 f12633r;
    ...
    private int F(int i10, boolean z10) {
        if (z10) {
            return this.f12633r.c(i10);
        }
        if (i10 < this.f12632q - 1) {
            return i10 + 1;
        }
        return -1;
    }
    ...
    public final Timeline.b k(int i10, Timeline.b bVar, boolean z10) {
        ...
        bVar.f12594i += E;
        if (z10) {
            bVar.f12593e = C(B(x10), oe.a.e(bVar.f12593e));
        }
        return bVar;
    }
    ...
    public final Timeline.d s(int i10, Timeline.d dVar, long j10) {
        ...
        Object B = B(y10);
        if (!Timeline.d.C.equals(dVar.f12603d)) {
            B = C(B, dVar.f12603d);
        }
        dVar.f12603d = B;
        dVar.f12617z += D;
