...
public abstract class a extends Timeline {
    ...
    private int F(int i10, boolean z10) {
        if (z10) {
            return this.f12017r.c(i10);
        }
        if (i10 < this.f12016q - 1) {
            return i10 + 1;
        }
        return -1;
    }
    ...
    public final Timeline.b k(int i10, Timeline.b bVar, boolean z10) {
        ...
        bVar.f11978i += E;
        if (z10) {
            bVar.f11977e = C(B(x10), ne.a.e(bVar.f11977e));
        }
        return bVar;
    }
    ...
    public final Timeline.d s(int i10, Timeline.d dVar, long j10) {
        ...
        Object B = B(y10);
        if (!Timeline.d.C.equals(dVar.f11987d)) {
            B = C(B, dVar.f11987d);
        }
        dVar.f11987d = B;
        dVar.f12001z += D;
