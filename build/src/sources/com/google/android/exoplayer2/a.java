...
public abstract class a extends Timeline {
    ...
    private int F(int i10, boolean z10) {
        if (z10) {
            return this.f12634r.c(i10);
        }
        if (i10 < this.f12633q - 1) {
            return i10 + 1;
        }
        return -1;
    }
    ...
    public final Timeline.b k(int i10, Timeline.b bVar, boolean z10) {
        ...
        bVar.f12595i += E;
        if (z10) {
            bVar.f12594e = C(B(x10), oe.a.e(bVar.f12594e));
        }
        return bVar;
    }
    ...
    public final Timeline.d s(int i10, Timeline.d dVar, long j10) {
        ...
        Object B = B(y10);
        if (!Timeline.d.C.equals(dVar.f12604d)) {
            B = C(B, dVar.f12604d);
        }
        dVar.f12604d = B;
        dVar.f12618z += D;
