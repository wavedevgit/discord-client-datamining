...
public final class i0 extends com.google.android.exoplayer2.e implements Player {
    ...
    public i0(k kVar, Player player) {
        ...
        this.f13231d = hVar;
        try {
            oe.y.f("ExoPlayerImpl", "Init " + Integer.toHexString(System.identityHashCode(this)) + " [ExoPlayerLib/2.19.1] [" + oe.w0.f39042e + "]");
    ...
    private long B1(r1 r1Var) {
        if (r1Var.f13380b.b()) {
            r1Var.f13379a.l(r1Var.f13380b.f46438a, this.f13251n);
    ...
    private int E1(r1 r1Var) {
        ...
        return r1Var.f13379a.l(r1Var.f13380b.f46438a, this.f13251n).f12595i;
    }
    ...
    private Player.PositionInfo I1(long j10) {
        ...
        if (!this.f13260r0.f13379a.u()) {
            ...
            Object obj3 = r1Var.f13380b.f46438a;
        ...
        return new Player.PositionInfo(obj, Q, mediaItem, obj2, i11, p12, j11, bVar.f46439b, bVar.f46440c);
    }
    ...
    private Player.PositionInfo J1(int i10, r1 r1Var, int i11) {
        ...
        if (i10 == 0) {
            if (r1Var.f13380b.b()) {
                ...
                j10 = bVar.e(bVar2.f46439b, bVar2.f46440c);
                M1 = M1(r1Var);
            } else {
                if (r1Var.f13380b.f46442e != -1) {
        ...
        return new Player.PositionInfo(obj, i12, mediaItem, obj2, i13, p12, p13, bVar3.f46439b, bVar3.f46440c);
    }
    ...
    private static long M1(r1 r1Var) {
        ...
        Timeline.b bVar = new Timeline.b();
        r1Var.f13379a.l(r1Var.f13380b.f46438a, bVar);
        if (r1Var.f13381c == -9223372036854775807L) {
    ...
    private r1 S1(r1 r1Var, Timeline timeline, Pair pair) {
        ...
        if (timeline.u()) {
            ...
            r1 c10 = j11.d(l10, K0, K0, K0, 0L, rd.w0.f46510o, this.f13227b, qi.s.t()).c(l10);
            c10.f13394p = c10.f13396r;
            return c10;
        }
        Object obj = j11.f13380b.f46438a;
        ...
        if (!equals || longValue < K02) {
            ...
            int f10 = timeline.f(j11.f13389k.f46438a);
            if (f10 != -1 && timeline.j(f10, this.f13251n).f12595i == timeline.l(bVar.f46438a, this.f13251n).f12595i) {
                return j11;
            }
            timeline.l(bVar.f46438a, this.f13251n);
            if (bVar.b()) {
                j10 = this.f13251n.e(bVar.f46439b, bVar.f46440c);
            } else {
    ...
    private void h2(List list, int i10, long j10, boolean z10) {
        ...
        if (z10) {
            ...
            if (this.f13260r0.f13380b.f46438a.equals(h10.f13380b.f46438a) && !this.f13260r0.f13379a.u()) {
                z11 = true;
            } else {
                z11 = false;
            }
        ...
        h10 = S12.h(i12);
        this.f13245k.O0(s12, i11, oe.w0.K0(j11), this.M);
        if (this.f13260r0.f13380b.f46438a.equals(h10.f13380b.f46438a)) {
        }
        z11 = false;
        t2(h10, 0, 1, z11, 4, C1(h10), -1, false);
    }
    ...
    private void t2(final r1 r1Var, final int i10, final int i11, boolean z10, final int i12, long j10, int i13, boolean z11) {
        ...
        if (booleanValue) {
            if (!r1Var.f13379a.u()) {
                mediaItem = r1Var.f13379a.r(r1Var.f13379a.l(r1Var.f13380b.f46438a, this.f13251n).f12595i, this.f13101a).f12606i;
            }
        ...
        if (rVar != rVar2) {
            this.f13239h.h(rVar2.f31727e);
            this.f13247l.h(2, new x.a() { // from class: com.google.android.exoplayer2.h0
                @Override // oe.x.a
                public final void invoke(Object obj) {
                    ((Player.b) obj).onTracksChanged(r1.this.f13387i.f31726d);
                }
            });
        }
        if (!equals2) {
    ...
    private Pair z1(r1 r1Var, r1 r1Var2, boolean z10, int i10, boolean z11, boolean z12) {
        ...
        if (!timeline.r(timeline.l(r1Var2.f13380b.f46438a, this.f13251n).f12595i, this.f13101a).f12604d.equals(timeline2.r(timeline2.l(r1Var.f13380b.f46438a, this.f13251n).f12595i, this.f13101a).f12604d)) {
            if (z10 && i10 == 0) {
                i11 = 1;
            } else if (z10 && i10 == 1) {
                i11 = 2;
        ...
        } else if (z10 && i10 == 0 && r1Var2.f13380b.f46441d < r1Var.f13380b.f46441d) {
    ...
    public ke.m D1() {
        w2();
        return new ke.m(this.f13260r0.f13387i.f31725c);
    }
    ...
    public int E() {
        ...
        r1 r1Var = this.f13260r0;
        return r1Var.f13379a.f(r1Var.f13380b.f46438a);
    }
    ...
    public int I() {
        w2();
        if (f()) {
            return this.f13260r0.f13380b.f46440c;
        }
        return -1;
    }
    ...
    public long V() {
        ...
        r1 r1Var = this.f13260r0;
        if (r1Var.f13389k.f46441d != r1Var.f13380b.f46441d) {
            return r1Var.f13379a.r(Q(), this.f13101a).f();
        }
        long j10 = r1Var.f13394p;
        if (this.f13260r0.f13389k.b()) {
            r1 r1Var2 = this.f13260r0;
            Timeline.b l10 = r1Var2.f13379a.l(r1Var2.f13389k.f46438a, this.f13251n);
            long i10 = l10.i(this.f13260r0.f13389k.f46439b);
    ...
    public void X1() {
        ...
        oe.y.f("ExoPlayerImpl", "Release " + Integer.toHexString(System.identityHashCode(this)) + " [ExoPlayerLib/2.19.1] [" + oe.w0.f39042e + "] [" + mc.u.b() + "]");
        w2();
        if (oe.w0.f39038a < 21 && (audioTrack = this.T) != null) {
            audioTrack.release();
            this.T = null;
        }
    ...
    public long getDuration() {
        ...
        if (f()) {
            ...
            r1Var.f13379a.l(bVar.f46438a, this.f13251n);
            return oe.w0.p1(this.f13251n.e(bVar.f46439b, bVar.f46440c));
        }
        return d0();
    }
    ...
    public void k(int i10, int i11) {
        ...
        if (i10 < size && i10 != min) {
            ...
            t2(Y1, 0, 1, !Y1.f13380b.f46438a.equals(this.f13260r0.f13380b.f46438a), 4, C1(Y1), -1, false);
        }
    }
    ...
    public Tracks o() {
        w2();
        return this.f13260r0.f13387i.f31726d;
    }
    ...
    public int r() {
        w2();
        if (f()) {
            return this.f13260r0.f13380b.f46439b;
        }
        return -1;
    }
