...
public class c implements com.google.android.exoplayer2.source.dash.a {
    ...
    private final u f13485a;

    /* renamed from: b  reason: collision with root package name */
    private final ud.b f13486b;
    ...
    private final DataSource f13489e;
    ...
    private final e.c f13492h;

    /* renamed from: i  reason: collision with root package name */
    protected final b[] f13493i;

    /* renamed from: j  reason: collision with root package name */
    private g f13494j;

    /* renamed from: k  reason: collision with root package name */
    private vd.c f13495k;
    ...
    public static final class a implements a.InterfaceC0166a {
        ...
        /* renamed from: a  reason: collision with root package name */
        private final DataSource.Factory f13499a;

        /* renamed from: b  reason: collision with root package name */
        private final int f13500b;

        /* renamed from: c  reason: collision with root package name */
        private final g.a f13501c;
        ...
        public com.google.android.exoplayer2.source.dash.a a(u uVar, vd.c cVar, ud.b bVar, int i10, int[] iArr, com.google.android.exoplayer2.trackselection.g gVar, int i11, long j10, boolean z10, List list, e.c cVar2, c0 c0Var, t1 t1Var, me.g gVar2) {
            DataSource createDataSource = this.f13499a.createDataSource();
            if (c0Var != null) {
                createDataSource.i(c0Var);
            }
            return new c(this.f13501c, uVar, cVar, bVar, i10, iArr, gVar, i11, createDataSource, j10, this.f13500b, z10, list, cVar2, t1Var, gVar2);
        }
    ...
    public static final class b {
        ...
        /* renamed from: c  reason: collision with root package name */
        public final vd.b f13504c;

        /* renamed from: d  reason: collision with root package name */
        public final f f13505d;
        ...
        b b(long j10, j jVar) {
            long f10;
            long f11;
            f l10 = this.f13503b.l();
            f l11 = jVar.l();
            if (l10 == null) {
                return new b(j10, jVar, this.f13504c, this.f13502a, this.f13507f, l10);
            }
            if (!l10.h()) {
                return new b(j10, jVar, this.f13504c, this.f13502a, this.f13507f, l11);
            }
            long g10 = l10.g(j10);
            if (g10 == 0) {
                return new b(j10, jVar, this.f13504c, this.f13502a, this.f13507f, l11);
            ...
            if (i12 == 0) {
                ...
                if (b12 < b10) {
                    ...
                    return new b(j10, jVar, this.f13504c, this.f13502a, f11, l11);
                }
        ...
        b c(f fVar) {
            return new b(this.f13506e, this.f13503b, this.f13504c, this.f13502a, this.f13507f, fVar);
        }

        b d(vd.b bVar) {
            return new b(this.f13506e, this.f13503b, bVar, this.f13502a, this.f13507f, this.f13505d);
        }

        public long e(long j10) {
            return this.f13505d.c(this.f13506e, j10) + this.f13507f;
        }

        public long f() {
            return this.f13505d.i() + this.f13507f;
        }

        public long g(long j10) {
            return (e(j10) + this.f13505d.j(this.f13506e, j10)) - 1;
        }

        public long h() {
            return this.f13505d.g(this.f13506e);
        }

        public long i(long j10) {
            return k(j10) + this.f13505d.a(j10 - this.f13507f, this.f13506e);
        }

        public long j(long j10) {
            return this.f13505d.f(j10, this.f13506e) + this.f13507f;
        }

        public long k(long j10) {
            return this.f13505d.b(j10 - this.f13507f);
        }

        public i l(long j10) {
            return this.f13505d.e(j10 - this.f13507f);
        }

        public boolean m(long j10, long j11) {
            if (this.f13505d.h() || j11 == -9223372036854775807L || i(j10) <= j11) {
                return true;
            }
            return false;
        }
    ...
    protected static final class C0167c extends td.b {
        ...
        public long a() {
            c();
            return this.f13508e.k(d());
        }

        @Override // td.o
        public long b() {
            c();
            return this.f13508e.i(d());
        }
    }
    ...
    public c(g.a aVar, u uVar, vd.c cVar, ud.b bVar, int i10, int[] iArr, com.google.android.exoplayer2.trackselection.g gVar, int i11, DataSource dataSource, long j10, int i12, boolean z10, List list, e.c cVar2, t1 t1Var, me.g gVar2) {
        ...
        long g10 = cVar.g(i10);
        ArrayList n10 = n();
        this.f13493i = new b[gVar.length()];
        int i14 = 0;
    ...
    private i.a k(com.google.android.exoplayer2.trackselection.g gVar, List list) {
        ...
        int f10 = ud.b.f(list);
        return new i.a(f10, f10 - this.f13486b.g(list), length, i10);
    }
    ...
    public void f(vd.c cVar, int i10) {
        try {
            ...
            long g10 = cVar.g(i10);
            ArrayList n10 = n();
            for (int i11 = 0; i11 < this.f13493i.length; i11++) {
                b[] bVarArr = this.f13493i;
                bVarArr[i11] = bVarArr[i11].b(g10, (j) n10.get(this.f13494j.d(i11)));
            }
        } catch (rd.b e10) {
            this.f13497m = e10;
        }
    ...
    public int h(long j10, List list) {
        if (this.f13497m == null && this.f13494j.length() >= 2) {
            return this.f13494j.n(j10, list);
        }
        return list.size();
    }
    ...
    public boolean i(long j10, td.f fVar, List list) {
        ...
        return this.f13494j.k(j10, fVar, list);
    }
    ...
    public void j(long j10, long j11, List list, td.h hVar) {
        ...
        if (cVar3.f13497m == null) {
            ...
            long K02 = w0.K0(w0.f0(cVar3.f13490f));
            ...
            int length = cVar3.f13494j.length();
            ...
            boolean z15 = z14;
            o[] oVarArr4 = oVarArr2;
            cVar5.f13494j.e(j10, j14, cVar5.l(K02, j10), list, oVarArr4);
            b r10 = cVar5.r(cVar5.f13494j.b());
            td.g gVar = r10.f13502a;
            if (gVar != null) {
                j jVar = r10.f13503b;
                if (gVar.e() == null) {
                    iVar = jVar.n();
    ...
    @Override // td.j
    public void release() {
        for (b bVar : this.f13493i) {
            td.g gVar = bVar.f13502a;
            if (gVar != null) {
                gVar.release();
            }
        }
