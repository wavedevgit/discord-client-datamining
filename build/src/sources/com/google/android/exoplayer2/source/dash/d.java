...
final class d implements m0 {
    ...
    public int c(x xVar, qc.f fVar, int i10) {
        ...
        if (z10 && !this.f13852o) {
            ...
            if ((i10 & 4) == 0) {
                byte[] a10 = this.f13850e.a(this.f13853p.f50178a[i11]);
                fVar.u(a10.length);
                fVar.f47076i.put(a10);
            }
            fVar.f47078p = this.f13851i[i11];
            fVar.s(1);
            return -4;
        } else {
            xVar.f37110b = this.f13849d;
            this.f13854q = true;
            return -5;
        }
    }
