...
final class d implements m0 {
    ...
    public int c(x xVar, qc.f fVar, int i10) {
        ...
        if (z10 && !this.f12795o) {
            ...
            if ((i10 & 4) == 0) {
                byte[] a10 = this.f12793e.a(this.f12796p.f51395a[i11]);
                fVar.u(a10.length);
                fVar.f46657i.put(a10);
            }
            fVar.f46659p = this.f12794i[i11];
            fVar.s(1);
            return -4;
        } else {
            xVar.f36077b = this.f12792d;
            this.f12797q = true;
            return -5;
        }
    }
