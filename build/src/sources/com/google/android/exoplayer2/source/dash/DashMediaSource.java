...
public final class DashMediaSource extends qd.a {
    ...
    private final MediaItem f12713s;

    /* renamed from: t  reason: collision with root package name */
    private final boolean f12714t;

    /* renamed from: u  reason: collision with root package name */
    private final DataSource.Factory f12715u;

    /* renamed from: v  reason: collision with root package name */
    private final a.InterfaceC0162a f12716v;

    /* renamed from: w  reason: collision with root package name */
    private final qd.h f12717w;

    /* renamed from: x  reason: collision with root package name */
    private final v f12718x;

    /* renamed from: y  reason: collision with root package name */
    private final i f12719y;

    /* renamed from: z  reason: collision with root package name */
    private final td.b f12720z;

    /* loaded from: /home/runner/work/discord-client-datamining/discord-client-datamining/build/classes3.dex */
    public static final class Factory implements r.a {

        /* renamed from: a  reason: collision with root package name */
        private final a.InterfaceC0162a f12721a;

        /* renamed from: b  reason: collision with root package name */
        private final DataSource.Factory f12722b;

        /* renamed from: c  reason: collision with root package name */
        private x f12723c;

        /* renamed from: d  reason: collision with root package name */
        private qd.h f12724d;
        ...
        public DashMediaSource a(MediaItem mediaItem) {
            ...
            return new DashMediaSource(mediaItem, null, this.f12722b, bVar, this.f12721a, this.f12724d, null, this.f12723c.a(mediaItem), this.f12725e, this.f12726f, this.f12727g, null);
        }

        public Factory b(i iVar) {
            this.f12725e = (i) ne.a.f(iVar, "MediaSource.Factory#setLoadErrorHandlingPolicy no longer handles null by instantiating a new DefaultLoadErrorHandlingPolicy. Explicitly construct and pass an instance in order to retain the old behavior.");
            return this;
        }

        public Factory(a.InterfaceC0162a interfaceC0162a, DataSource.Factory factory) {
            this.f12721a = (a.InterfaceC0162a) ne.a.e(interfaceC0162a);
            this.f12722b = factory;
            this.f12723c = new l();
            this.f12725e = new com.google.android.exoplayer2.upstream.g();
            this.f12726f = 30000L;
            this.f12727g = 5000000L;
            this.f12724d = new qd.i();
        }
    }
    ...
    public static final class b extends Timeline {
        ...
        /* renamed from: x  reason: collision with root package name */
        private final ud.c f12737x;

        /* renamed from: y  reason: collision with root package name */
        private final MediaItem f12738y;

        /* renamed from: z  reason: collision with root package name */
        private final MediaItem.g f12739z;
        ...
        public b(long j10, long j11, long j12, int i10, long j13, long j14, long j15, ud.c cVar, MediaItem mediaItem, MediaItem.g gVar) {
            ...
            this.f12736w = j15;
            this.f12737x = cVar;
            this.f12738y = mediaItem;
            this.f12739z = gVar;
        }

        private long w(long j10) {
            td.f l10;
            long j11 = this.f12736w;
            if (!x(this.f12737x)) {
                return j11;
            }
            if (j10 > 0) {
            ...
            long j12 = this.f12734u + j11;
            long g10 = this.f12737x.g(0);
            int i10 = 0;
            while (i10 < this.f12737x.e() - 1 && j12 >= g10) {
                j12 -= g10;
                i10++;
                g10 = this.f12737x.g(i10);
            }
        ...
        public int f(Object obj) {
            int intValue;
            if (!(obj instanceof Integer) || (intValue = ((Integer) obj).intValue() - this.f12733t) < 0 || intValue >= m()) {
                return -1;
            }
            return intValue;
        }
        ...
        @Override // com.google.android.exoplayer2.Timeline
        public int m() {
            return this.f12737x.e();
        }

        @Override // com.google.android.exoplayer2.Timeline
        public Object q(int i10) {
            ne.a.c(i10, 0, m());
            return Integer.valueOf(this.f12733t + i10);
        }
        ...
        public Timeline.d s(int i10, Timeline.d dVar, long j10) {
            ...
            MediaItem mediaItem = this.f12738y;
            ud.c cVar = this.f12737x;
            return dVar.h(obj, mediaItem, cVar, this.f12730q, this.f12731r, this.f12732s, true, x(cVar), this.f12739z, w10, this.f12735v, 0, m() - 1, this.f12734u);
        }
    ...
    public static final class d implements k.a {
        ...
        /* renamed from: a  reason: collision with root package name */
        private static final Pattern f12741a = Pattern.compile("(.+?)(Z|((\\+|-|−)(\\d\\d)(:?(\\d\\d))?))");
    ...
    /* synthetic */ DashMediaSource(MediaItem mediaItem, ud.c cVar, DataSource.Factory factory, k.a aVar, a.InterfaceC0162a interfaceC0162a, qd.h hVar, le.g gVar, v vVar, i iVar, long j10, long j11, a aVar2) {
        this(mediaItem, cVar, factory, aVar, interfaceC0162a, hVar, gVar, vVar, iVar, j10, j11);
    }
    ...
    private static long M(ud.c cVar, long j10) {
        ...
        return oi.c.a(K04, 1000L, RoundingMode.CEILING);
    }
    ...
    public void a0(boolean z10) {
        ...
        for (int i10 = 0; i10 < this.G.size(); i10++) {
            ...
            if (keyAt >= this.f12712a0) {
                ((com.google.android.exoplayer2.source.dash.b) this.G.valueAt(i10)).M(this.T, keyAt - this.f12712a0);
            }
        }
        ud.g d10 = this.T.d(0);
        int e10 = this.T.e() - 1;
    ...
    private void f0(k kVar, j.b bVar, int i10) {
        this.C.s(new LoadEventInfo(kVar.f13446a, kVar.f13447b, this.M.n(kVar, bVar, i10)), kVar.f13448c);
    }
    ...
    public void g0() {
        ...
        this.U = false;
        f0(new k(this.L, uri, 4, this.D), this.E, this.f12719y.b(4));
    }
    ...
    */
    ...
    protected void B(c0 c0Var) {
        this.N = c0Var;
        this.f12718x.a(Looper.myLooper(), z());
        this.f12718x.d();
        if (this.f12714t) {
            a0(false);
            return;
        }
        this.L = this.f12715u.createDataSource();
    ...
    void U(k kVar, long j10, long j11) {
        ...
        if (cVar.f51368d) {
            ...
            int i11 = this.Y;
            this.Y = i11 + 1;
            if (i11 < this.f12719y.b(kVar.f13448c)) {
                e0(N());
                return;
            } else {
                this.O = new td.c();
    ...
    j.c V(k kVar, long j10, long j11, IOException iOException, int i10) {
        j.c h10;
        LoadEventInfo loadEventInfo = new LoadEventInfo(kVar.f13446a, kVar.f13447b, kVar.f(), kVar.d(), j10, j11, kVar.a());
        long a10 = this.f12719y.a(new i.c(loadEventInfo, new MediaLoadData(kVar.f13448c), iOException, i10));
    ...
    j.c X(k kVar, long j10, long j11, IOException iOException) {
        this.C.q(new LoadEventInfo(kVar.f13446a, kVar.f13447b, kVar.f(), kVar.d(), j10, j11, kVar.a()), kVar.f13448c, iOException, true);
        this.f12719y.d(kVar.f13446a);
        Y(iOException);
        return j.f13428f;
    }
    ...
    private DashMediaSource(MediaItem mediaItem, ud.c cVar, DataSource.Factory factory, k.a aVar, a.InterfaceC0162a interfaceC0162a, qd.h hVar, le.g gVar, v vVar, i iVar, long j10, long j11) {
        this.f12713s = mediaItem;
        this.Q = mediaItem.f11627o;
        this.R = ((MediaItem.h) ne.a.e(mediaItem.f11625e)).f11715d;
        this.S = mediaItem.f11625e.f11715d;
        this.T = cVar;
        this.f12715u = factory;
        this.D = aVar;
        this.f12716v = interfaceC0162a;
        this.f12718x = vVar;
        this.f12719y = iVar;
        this.A = j10;
        this.B = j11;
        this.f12717w = hVar;
        this.f12720z = new td.b();
