...
public class OkHttpDataSource extends f implements h {
    ...
    private final Call.Factory f12570e;

    /* renamed from: f  reason: collision with root package name */
    private final h.g f12571f;

    /* renamed from: g  reason: collision with root package name */
    private final String f12572g;

    /* renamed from: h  reason: collision with root package name */
    private final CacheControl f12573h;

    /* renamed from: i  reason: collision with root package name */
    private final h.g f12574i;

    /* renamed from: j  reason: collision with root package name */
    private n f12575j;

    /* renamed from: k  reason: collision with root package name */
    private com.google.android.exoplayer2.upstream.a f12576k;

    /* renamed from: l  reason: collision with root package name */
    private Response f12577l;

    /* renamed from: m  reason: collision with root package name */
    private InputStream f12578m;
    ...
    private long f12581p;

    /* loaded from: /home/runner/work/discord-client-datamining/discord-client-datamining/build/classes3.dex */
    public static final class Factory implements h.c {

        /* renamed from: a  reason: collision with root package name */
        private final h.g f12582a = new h.g();

        /* renamed from: b  reason: collision with root package name */
        private final Call.Factory f12583b;
        ...
        public OkHttpDataSource createDataSource() {
            OkHttpDataSource okHttpDataSource = new OkHttpDataSource(this.f12583b, this.f12584c, this.f12586e, this.f12582a, this.f12587f, null);
            c0 c0Var = this.f12585d;
            if (c0Var != null) {
    ...
    public class a implements b {
        ...
        /* renamed from: d  reason: collision with root package name */
        final /* synthetic */ SettableFuture f12588d;

        a(SettableFuture settableFuture) {
            this.f12588d = settableFuture;
        }

        @Override // cu.b
        public void onFailure(Call call, IOException iOException) {
            this.f12588d.y(iOException);
        }

        @Override // cu.b
        public void onResponse(Call call, Response response) {
            this.f12588d.x(response);
        }
    }
    ...
    private void s() {
        Response response = this.f12577l;
        if (response != null) {
    ...
    private Request u(com.google.android.exoplayer2.upstream.a aVar) {
        ...
        HttpUrl m10 = HttpUrl.m(aVar.f13405a.toString());
        if (m10 != null) {
            Request.Builder m11 = new Request.Builder().m(m10);
            CacheControl cacheControl = this.f12573h;
            if (cacheControl != null) {
                m11.c(cacheControl);
            }
            HashMap hashMap = new HashMap();
            h.g gVar = this.f12574i;
            if (gVar != null) {
                hashMap.putAll(gVar.b());
            }
            hashMap.putAll(this.f12571f.b());
            hashMap.putAll(aVar.f13409e);
            ...
            } else if (aVar.f13407c == 2) {
                requestBody = RequestBody.create((MediaType) null, w0.f40716f);
            }
    ...
    private int v(byte[] bArr, int i10, int i11) {
        ...
        if (j10 != -1) {
            long j11 = j10 - this.f12581p;
            if (j11 == 0) {
                return -1;
            }
            i11 = (int) Math.min(i11, j11);
        }
        int read = ((InputStream) w0.j(this.f12578m)).read(bArr, i10, i11);
        if (read == -1) {
            return -1;
        }
        this.f12581p += read;
    ...
    private void w(long j10, com.google.android.exoplayer2.upstream.a aVar) {
        if (j10 != 0) {
            ...
            while (j10 > 0) {
                try {
                    int read = ((InputStream) w0.j(this.f12578m)).read(bArr, 0, (int) Math.min(j10, (long) RecyclerView.ItemAnimator.FLAG_APPEARED_IN_PRE_LAYOUT));
    ...
    public long b(com.google.android.exoplayer2.upstream.a aVar) {
        ...
        q(aVar);
        try {
            Response t10 = t(this.f12570e.a(u(aVar)));
            this.f12577l = t10;
            ResponseBody responseBody = (ResponseBody) oe.a.e(t10.n());
            this.f12578m = responseBody.byteStream();
            int z10 = t10.z();
            long j11 = -1;
            if (!t10.isSuccessful()) {
                if (z10 == 416) {
                    if (aVar.f13411g == t.c(t10.C0().c("Content-Range"))) {
                        this.f12579n = true;
                        r(aVar);
                        long j12 = aVar.f13412h;
                        if (j12 == -1) {
                            return 0L;
                        }
                        return j12;
                ...
                try {
                    bArr = w0.i1((InputStream) oe.a.e(this.f12578m));
                ...
                throw new h.f(z10, t10.G0(), mVar, i10, aVar, bArr2);
            }
    ...
    public Uri m() {
        ...
        return Uri.parse(response.W0().n().toString());
    }
    ...
    public int read(byte[] bArr, int i10, int i11) {
        try {
            ...
            throw h.d.c(e10, (com.google.android.exoplayer2.upstream.a) w0.j(this.f12576k), 2);
        }
    }
    ...
    private OkHttpDataSource(Call.Factory factory, String str, CacheControl cacheControl, h.g gVar, n nVar) {
        super(true);
        this.f12570e = (Call.Factory) oe.a.e(factory);
        this.f12572g = str;
        this.f12573h = cacheControl;
        this.f12574i = gVar;
        this.f12575j = nVar;
        this.f12571f = new h.g();
    }
}
