...
public abstract class e implements Player {
    ...
    protected final Timeline.d f13101a = new Timeline.d();
    ...
    public final boolean N() {
        Timeline v10 = v();
        if (!v10.u() && v10.r(Q(), this.f13101a).f12611s) {
            return true;
        }
        return false;
    }
    ...
    public final boolean b0() {
        Timeline v10 = v();
        if (!v10.u() && v10.r(Q(), this.f13101a).g()) {
            return true;
        }
        return false;
    }
    ...
    public final boolean t() {
        Timeline v10 = v();
        if (!v10.u() && v10.r(Q(), this.f13101a).f12612t) {
            return true;
        }
        return false;
    }
