...
public final class c implements AnalyticsListener, d.a {
    ...
    private final d f12719b;

    /* renamed from: c  reason: collision with root package name */
    private final PlaybackSession f12720c;

    /* renamed from: i  reason: collision with root package name */
    private String f12726i;

    /* renamed from: j  reason: collision with root package name */
    private PlaybackMetrics.Builder f12727j;

    /* renamed from: k  reason: collision with root package name */
    private int f12728k;

    /* renamed from: n  reason: collision with root package name */
    private PlaybackException f12731n;
    ...
    private Format f12735r;

    /* renamed from: s  reason: collision with root package name */
    private Format f12736s;

    /* renamed from: t  reason: collision with root package name */
    private Format f12737t;
    ...
    private final Timeline.d f12722e = new Timeline.d();

    /* renamed from: f  reason: collision with root package name */
    private final Timeline.b f12723f = new Timeline.b();

    /* renamed from: h  reason: collision with root package name */
    private final HashMap f12725h = new HashMap();

    /* renamed from: g  reason: collision with root package name */
    private final HashMap f12724g = new HashMap();

    /* renamed from: d  reason: collision with root package name */
    private final long f12721d = SystemClock.elapsedRealtime();

    /* renamed from: l  reason: collision with root package name */
    private int f12729l = 0;

    /* renamed from: m  reason: collision with root package name */
    private int f12730m = 0;
    ...
    private void A(int i10, long j10, Format format, int i11) {
        TrackChangeEvent.Builder timeSinceCreatedMillis = o1.a(i10).setTimeSinceCreatedMillis(j10 - this.f12721d);
        if (format != null) {
            ...
            String str2 = format.f12305w;
            if (str2 != null) {
                timeSinceCreatedMillis.setSampleMimeType(str2);
            }
            String str3 = format.f12302t;
            if (str3 != null) {
                timeSinceCreatedMillis.setCodecName(str3);
            }
            int i12 = format.f12301s;
            if (i12 != -1) {
        ...
        this.A = true;
        this.f12720c.reportTrackChangeEvent(timeSinceCreatedMillis.build());
    }
    ...
    private boolean e(b bVar) {
        if (bVar != null && bVar.f12748c.equals(this.f12719b.a())) {
            return true;
        }
        return false;
    }
    ...
    private void g() {
        ...
        if (builder != null && this.A) {
            builder.setAudioUnderrunCount(this.f12743z);
            this.f12727j.setVideoFramesDropped(this.f12741x);
            this.f12727j.setVideoFramesPlayed(this.f12742y);
            Long l10 = (Long) this.f12724g.get(this.f12726i);
            PlaybackMetrics.Builder builder2 = this.f12727j;
            if (l10 == null) {
                longValue = 0;
            } else {
            ...
            Long l11 = (Long) this.f12725h.get(this.f12726i);
            PlaybackMetrics.Builder builder3 = this.f12727j;
            if (l11 == null) {
                longValue2 = 0;
            } else {
            ...
            PlaybackMetrics.Builder builder4 = this.f12727j;
            ...
            this.f12720c.reportPlaybackMetrics(this.f12727j.build());
        }
        this.f12727j = null;
        this.f12726i = null;
        this.f12743z = 0;
    ...
    private static m i(s sVar) {
        ...
        while (it.hasNext()) {
            ...
            for (int i10 = 0; i10 < aVar.f12628d; i10++) {
                if (aVar.g(i10) && (mVar = aVar.c(i10).f12308z) != null) {
                    return mVar;
                }
            }
        }
    ...
    private static a k(PlaybackException playbackException, Context context, boolean z10) {
        ...
        boolean z11;
        int i11;
        if (playbackException.f12548d == 1001) {
            return new a(20, 0);
        }
        ...
        if (th2 instanceof IOException) {
            ...
            if (th2 instanceof r.b) {
                return new a(13, w0.Z(((r.b) th2).f25538o));
            }
            if (th2 instanceof gd.m) {
                return new a(14, w0.Z(((gd.m) th2).f25497e));
            }
            if (th2 instanceof OutOfMemoryError) {
                return new a(14, 0);
            }
            if (th2 instanceof f.b) {
                return new a(17, ((f.b) th2).f12845d);
            }
    ...
    private static int o(MediaItem mediaItem) {
        MediaItem.h hVar = mediaItem.f12343e;
        if (hVar == null) {
            return 0;
        }
        int z02 = w0.z0(hVar.f12433d, hVar.f12434e);
        if (z02 != 0) {
            if (z02 != 1) {
                if (z02 != 2) {
                    return 1;
    ...
    private void q(AnalyticsListener.Events events) {
        for (int i10 = 0; i10 < events.d(); i10++) {
            ...
            if (b10 == 0) {
                ...
                this.f12719b.g(c10, this.f12728k);
            } else {
                this.f12719b.d(c10);
            }
        }
    ...
    private void r(long j10) {
        int n10 = n(this.f12718a);
        if (n10 != this.f12730m) {
            this.f12730m = n10;
            this.f12720c.reportNetworkEvent(p1.a().setNetworkType(n10).setTimeSinceCreatedMillis(j10 - this.f12721d).build());
        }
    }

    private void s(long j10) {
        boolean z10;
        PlaybackException playbackException = this.f12731n;
        ...
        this.f12720c.reportPlaybackErrorEvent(n1.a().setTimeSinceCreatedMillis(j10 - this.f12721d).setErrorCode(k10.f12744a).setSubErrorCode(k10.f12745b).setException(playbackException).build());
        this.A = true;
        this.f12731n = null;
    }
    ...
    private void t(Player player, AnalyticsListener.Events events, long j10) {
        ...
        if (this.f12729l != B) {
            this.f12729l = B;
            this.A = true;
            this.f12720c.reportPlaybackStateEvent(m1.a().setState(this.f12729l).setTimeSinceCreatedMillis(j10 - this.f12721d).build());
        }
    }
    ...
    private void u(Player player, AnalyticsListener.Events events, long j10) {
        ...
        if (e(this.f12732o)) {
            b bVar = this.f12732o;
            Format format = bVar.f12746a;
            if (format.C != -1) {
                z(j10, format, bVar.f12747b);
                this.f12732o = null;
            }
        }
        if (e(this.f12733p)) {
            b bVar2 = this.f12733p;
            v(j10, bVar2.f12746a, bVar2.f12747b);
            this.f12733p = null;
        }
        if (e(this.f12734q)) {
            b bVar3 = this.f12734q;
            x(j10, bVar3.f12746a, bVar3.f12747b);
            this.f12734q = null;
        }
    }

    private void v(long j10, Format format, int i10) {
        if (w0.c(this.f12736s, format)) {
            return;
        }
        if (this.f12736s == null && i10 == 0) {
            i10 = 1;
        }
        this.f12736s = format;
        A(0, j10, format, i10);
    ...
    private void w(Player player, AnalyticsListener.Events events) {
        ...
        if (events.a(0)) {
            ...
            if (this.f12727j != null) {
                y(c10.f12643b, c10.f12645d);
            }
        }
        if (events.a(2) && this.f12727j != null && (i10 = i(player.o().b())) != null) {
            r1.a(w0.j(this.f12727j)).setDrmType(j(i10));
        }
        if (events.a(1011)) {
            this.f12743z++;
        }
    ...
    private void x(long j10, Format format, int i10) {
        if (w0.c(this.f12737t, format)) {
            return;
        }
        if (this.f12737t == null && i10 == 0) {
            i10 = 1;
        }
        this.f12737t = format;
        A(2, j10, format, i10);
    ...
    private void y(Timeline timeline, r.b bVar) {
        ...
        timeline.r(this.f12723f.f12595i, this.f12722e);
        builder.setStreamType(o(this.f12722e.f12606i));
        Timeline.d dVar = this.f12722e;
        if (dVar.f12617y != -9223372036854775807L && !dVar.f12615w && !dVar.f12612t && !dVar.g()) {
            builder.setMediaDurationMillis(this.f12722e.f());
        }
        if (this.f12722e.g()) {
            i10 = 2;
        } else {
    ...
    private void z(long j10, Format format, int i10) {
        if (w0.c(this.f12735r, format)) {
            return;
        }
        if (this.f12735r == null && i10 == 0) {
            i10 = 1;
        }
        this.f12735r = format;
        A(1, j10, format, i10);
    ...
    public void a(AnalyticsListener.EventTime eventTime, String str, boolean z10) {
        ...
        if ((bVar == null || !bVar.b()) && str.equals(this.f12726i)) {
            g();
        }
        this.f12724g.remove(str);
        this.f12725h.remove(str);
    }
    ...
    public void b(AnalyticsListener.EventTime eventTime, String str) {
        ...
        g();
        this.f12726i = str;
        this.f12727j = q1.a().setPlayerName("ExoPlayerLib").setPlayerVersion("2.19.1");
        y(eventTime.f12643b, eventTime.f12645d);
    }
    ...
    public LogSessionId m() {
        return this.f12720c.getSessionId();
    }
    ...
    public void onBandwidthEstimate(AnalyticsListener.EventTime eventTime, int i10, long j10, long j11) {
        ...
        r.b bVar = eventTime.f12645d;
        if (bVar != null) {
            String e10 = this.f12719b.e(eventTime.f12643b, (r.b) oe.a.e(bVar));
            Long l10 = (Long) this.f12725h.get(e10);
            Long l11 = (Long) this.f12724g.get(e10);
            HashMap hashMap = this.f12725h;
            long j12 = 0;
            if (l10 == null) {
                longValue = 0;
            } else {
    ...
    public void onDownstreamFormatChanged(AnalyticsListener.EventTime eventTime, MediaLoadData mediaLoadData) {
        if (eventTime.f12645d != null) {
            b bVar = new b((Format) oe.a.e(mediaLoadData.f13425c), mediaLoadData.f13426d, this.f12719b.e(eventTime.f12643b, (r.b) oe.a.e(eventTime.f12645d)));
            int i10 = mediaLoadData.f13424b;
            if (i10 != 0) {
                if (i10 != 1) {
                    if (i10 != 2) {
                        if (i10 != 3) {
    ...
    public void onLoadError(AnalyticsListener.EventTime eventTime, LoadEventInfo loadEventInfo, MediaLoadData mediaLoadData, IOException iOException, boolean z10) {
        this.f12739v = mediaLoadData.f13423a;
    }

    @Override // com.google.android.exoplayer2.analytics.AnalyticsListener
    public void onPlayerError(AnalyticsListener.EventTime eventTime, PlaybackException playbackException) {
        this.f12731n = playbackException;
    }
    ...
    public void onVideoDisabled(AnalyticsListener.EventTime eventTime, DecoderCounters decoderCounters) {
        this.f12741x += decoderCounters.f13090g;
        this.f12742y += decoderCounters.f13088e;
    }
    ...
    public void onVideoSizeChanged(AnalyticsListener.EventTime eventTime, VideoSize videoSize) {
        ...
        if (bVar != null) {
            Format format = bVar.f12746a;
            if (format.C == -1) {
                this.f12732o = new b(format.b().n0(videoSize.f14180d).S(videoSize.f14181e).G(), bVar.f12747b, bVar.f12748c);
            }
        }
    }
}
