...
public class a implements mc.a {
    ...
    public static final class C0157a {
        ...
        private static boolean i(r.b bVar, Object obj, boolean z10, int i10, int i11, int i12) {
            if (!bVar.f46817a.equals(obj)) {
                return false;
            }
            if (!z10 || bVar.f46818b != i10 || bVar.f46819c != i11) {
                if (z10 || bVar.f46818b != -1 || bVar.f46821e != i12) {
                    return false;
                }
                return true;
            }
    ...
    private AnalyticsListener.EventTime W0(r.b bVar) {
        ...
        if (bVar != null && f10 != null) {
            return V0(f10, f10.l(bVar.f46817a, this.f11969e).f11877i, bVar);
        }
    ...
    protected final AnalyticsListener.EventTime V0(Timeline timeline, int i10, r.b bVar) {
        ...
        if (bVar2 != null && bVar2.b()) {
            if (z10 && this.f11974r.r() == bVar2.f46818b && this.f11974r.I() == bVar2.f46819c) {
                j10 = this.f11974r.Z();
            }
        } else if (z10) {
            j10 = this.f11974r.K();
