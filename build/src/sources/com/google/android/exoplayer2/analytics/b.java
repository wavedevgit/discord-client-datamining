...
public final class b implements d {
    ...
    public final class a {
        ...
        public boolean i(int i10, r.b bVar) {
            ...
            if (bVar2 == null) {
                if (bVar.b() || bVar.f47287d != this.f13114c) {
                    return false;
                }
                return true;
            } else if (bVar.f47287d != bVar2.f47287d || bVar.f47285b != bVar2.f47285b || bVar.f47286c != bVar2.f47286c) {
                return false;
            } else {
                return true;
            }
        ...
        public boolean j(AnalyticsListener.EventTime eventTime) {
            ...
            int f10 = eventTime.f13044b.f(bVar.f47284a);
            int f11 = eventTime.f13044b.f(this.f13115d.f47284a);
            r.b bVar2 = eventTime.f13046d;
            if (bVar2.f47287d < this.f13115d.f47287d || f10 < f11) {
                return false;
            }
            if (f10 > f11) {
                return true;
            ...
            if (bVar2.b()) {
                ...
                int i10 = bVar3.f47285b;
                int i11 = bVar3.f47286c;
                r.b bVar4 = this.f13115d;
                int i12 = bVar4.f47285b;
                if (i10 > i12 || (i10 == i12 && i11 > bVar4.f47286c)) {
                    return true;
                }
                return false;
            }
            int i13 = eventTime.f13046d.f47288e;
            if (i13 == -1 || i13 > this.f13115d.f47285b) {
                return true;
            }
            return false;
        }
        ...
        public void k(int i10, r.b bVar) {
            if (this.f13114c == -1 && i10 == this.f13113b && bVar != null && bVar.f47287d >= b.this.o()) {
                this.f13114c = bVar.f47287d;
            }
        }
        ...
        public boolean m(Timeline timeline, Timeline timeline2) {
            ...
            if (bVar != null && timeline2.f(bVar.f47284a) == -1) {
                return false;
            }
            return true;
        }
    ...
    private void q(AnalyticsListener.EventTime eventTime) {
        ...
        r.b bVar = eventTime.f13046d;
        if (bVar != null && bVar.b()) {
            if (aVar == null || aVar.f13114c != eventTime.f13046d.f47287d || aVar.f13115d == null || aVar.f13115d.f47285b != eventTime.f13046d.f47285b || aVar.f13115d.f47286c != eventTime.f13046d.f47286c) {
                r.b bVar2 = eventTime.f13046d;
                this.f13108e.d(eventTime, p(eventTime.f13045c, new r.b(bVar2.f47284a, bVar2.f47287d)).f13112a, p10.f13112a);
            }
        }
    }
    ...
    public synchronized void d(AnalyticsListener.EventTime eventTime) {
        ...
        if (bVar2 != null && bVar2.b()) {
            r.b bVar3 = eventTime.f13046d;
            r.b bVar4 = new r.b(bVar3.f47284a, bVar3.f47287d, bVar3.f47285b);
            a p11 = p(eventTime.f13045c, bVar4);
            if (!p11.f13116e) {
                p11.f13116e = true;
                eventTime.f13044b.l(eventTime.f13046d.f47284a, this.f13105b);
                this.f13108e.c(new AnalyticsListener.EventTime(eventTime.f13043a, eventTime.f13044b, eventTime.f13045c, bVar4, Math.max(0L, w0.p1(this.f13105b.i(eventTime.f13046d.f47285b)) + this.f13105b.p()), eventTime.f13048f, eventTime.f13049g, eventTime.f13050h, eventTime.f13051i, eventTime.f13052j), p11.f13112a);
            }
        }
        if (!p10.f13116e) {
            p10.f13116e = true;
    ...
    public synchronized String h(Timeline timeline, r.b bVar) {
        return p(timeline.l(bVar.f47284a, this.f13105b).f12996i, bVar).f13112a;
    }
