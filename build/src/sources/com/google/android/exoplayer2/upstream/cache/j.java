...
final class j extends me.c {
    ...
    private static final Pattern f13056r = Pattern.compile("^(.+)\\.(\\d+)\\.(\\d+)\\.v1\\.exo$", 32);

    /* renamed from: s  reason: collision with root package name */
    private static final Pattern f13057s = Pattern.compile("^(.+)\\.(\\d+)\\.(\\d+)\\.v2\\.exo$", 32);

    /* renamed from: t  reason: collision with root package name */
    private static final Pattern f13058t = Pattern.compile("^(\\d+)\\.(\\d+)\\.(\\d+)\\.v3\\.exo$", 32);
    ...
    public static j g(File file, long j10, long j11, h hVar) {
        ...
        File file2 = file;
        Matcher matcher = f13058t.matcher(name);
    ...
    private static File l(File file, h hVar) {
        String str;
        String name = file.getName();
        Matcher matcher = f13057s.matcher(name);
        if (matcher.matches()) {
            str = w0.o1((String) ne.a.e(matcher.group(1)));
        } else {
            matcher = f13056r.matcher(name);
            if (matcher.matches()) {
    ...
    public j f(File file, long j10) {
        ne.a.g(this.f37825o);
        return new j(this.f37822d, this.f37823e, this.f37824i, j10, file);
    }
}
