...
public abstract class h {
    public static Tracks a(MappingTrackSelector.MappedTrackInfo mappedTrackInfo, List[] listArr) {
        ...
        for (int i10 = 0; i10 < mappedTrackInfo.d(); i10++) {
            ...
            for (int i11 = 0; i11 < f10.f48058d; i11++) {
                u0 b10 = f10.b(i11);
        ...
        for (int i15 = 0; i15 < h10.f48058d; i15++) {
            u0 b11 = h10.b(i15);
            int[] iArr2 = new int[b11.f48042d];
            Arrays.fill(iArr2, 0);
            aVar.a(new Tracks.a(b11, false, iArr2, new boolean[b11.f48042d]));
        }
