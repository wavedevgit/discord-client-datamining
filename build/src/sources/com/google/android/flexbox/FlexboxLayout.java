...
public class FlexboxLayout extends ViewGroup implements a {
    ...
    private void c(Canvas canvas, boolean z10, boolean z11) {
        ...
        for (int i12 = 0; i12 < size; i12++) {
            ...
            for (int i13 = 0; i13 < flexLine.f14591h; i13++) {
                ...
                if (reorderedChildAt != null && reorderedChildAt.getVisibility() != 8) {
                    ...
                    if (g(i14, i13)) {
                        ...
                        f(canvas, left, flexLine.f14585b, flexLine.f14590g);
                    }
                    if (i13 == flexLine.f14591h - 1 && (this.mShowDividerVertical & 4) > 0) {
                        if (z10) {
                        ...
                        f(canvas, right, flexLine.f14585b, flexLine.f14590g);
                    }
                }
            }
            if (h(i12)) {
                if (z11) {
                    i11 = flexLine.f14587d;
                } else {
                    i11 = flexLine.f14585b - this.mDividerHorizontalHeight;
                }
                e(canvas, paddingLeft, i11, max);
            }
            if (i(i12) && (this.mShowDividerHorizontal & 4) > 0) {
                if (z11) {
                    i10 = flexLine.f14585b - this.mDividerHorizontalHeight;
                } else {
                    i10 = flexLine.f14587d;
                }
            ...
            for (int i13 = 0; i13 < flexLine.f14591h; i13++) {
                ...
                if (reorderedChildAt != null && reorderedChildAt.getVisibility() != 8) {
                    ...
                    if (g(i14, i13)) {
                        ...
                        e(canvas, flexLine.f14584a, top, flexLine.f14590g);
                    }
                    if (i13 == flexLine.f14591h - 1 && (this.mShowDividerHorizontal & 4) > 0) {
                        if (z11) {
                        ...
                        e(canvas, flexLine.f14584a, bottom, flexLine.f14590g);
                    }
                }
            }
            if (h(i12)) {
                if (z10) {
                    i11 = flexLine.f14586c;
                } else {
                    i11 = flexLine.f14584a - this.mDividerVerticalWidth;
                }
                f(canvas, i11, paddingTop, max);
            }
            if (i(i12) && (this.mShowDividerVertical & 4) > 0) {
                if (z10) {
                    i10 = flexLine.f14584a - this.mDividerVerticalWidth;
                } else {
                    i10 = flexLine.f14586c;
                }
    ...
    */
    ...
    private void l(int i10, int i11) {
        ...
        this.mFlexLines = this.mFlexLinesResult.f14607a;
        this.mFlexboxHelper.p(i10, i11);
        if (this.mAlignItems == 3) {
            for (FlexLine flexLine : this.mFlexLines) {
                int i12 = Integer.MIN_VALUE;
                for (int i13 = 0; i13 < flexLine.f14591h; i13++) {
                    View reorderedChildAt = getReorderedChildAt(flexLine.f14598o + i13);
                    if (reorderedChildAt != null && reorderedChildAt.getVisibility() != 8) {
                        LayoutParams layoutParams = (LayoutParams) reorderedChildAt.getLayoutParams();
                        if (this.mFlexWrap != 2) {
                            i12 = Math.max(i12, reorderedChildAt.getMeasuredHeight() + Math.max(flexLine.f14595l - reorderedChildAt.getBaseline(), ((ViewGroup.MarginLayoutParams) layoutParams).topMargin) + ((ViewGroup.MarginLayoutParams) layoutParams).bottomMargin);
                        } else {
                            i12 = Math.max(i12, reorderedChildAt.getMeasuredHeight() + ((ViewGroup.MarginLayoutParams) layoutParams).topMargin + Math.max((flexLine.f14595l - reorderedChildAt.getMeasuredHeight()) + reorderedChildAt.getBaseline(), ((ViewGroup.MarginLayoutParams) layoutParams).bottomMargin));
                        }
                    }
                }
                flexLine.f14590g = i12;
            }
        }
        this.mFlexboxHelper.o(i10, i11, getPaddingTop() + getPaddingBottom());
        this.mFlexboxHelper.X();
        n(this.mFlexDirection, i10, i11, this.mFlexLinesResult.f14608b);
    }
    ...
    public int getLargestMainSize() {
        ...
        for (FlexLine flexLine : this.mFlexLines) {
            i10 = Math.max(i10, flexLine.f14588e);
        }
        return i10;
    }
    ...
    public void onNewFlexItemAdded(View view, int i10, int i11, FlexLine flexLine) {
        if (g(i10, i11)) {
            if (isMainAxisDirectionHorizontal()) {
                int i12 = flexLine.f14588e;
                int i13 = this.mDividerVerticalWidth;
                flexLine.f14588e = i12 + i13;
                flexLine.f14589f += i13;
                return;
            }
            int i14 = flexLine.f14588e;
            int i15 = this.mDividerHorizontalHeight;
            flexLine.f14588e = i14 + i15;
            flexLine.f14589f += i15;
        }
    }
    ...
    public void onNewFlexLineAdded(FlexLine flexLine) {
        if (isMainAxisDirectionHorizontal()) {
            if ((this.mShowDividerVertical & 4) > 0) {
                int i10 = flexLine.f14588e;
                int i11 = this.mDividerVerticalWidth;
                flexLine.f14588e = i10 + i11;
                flexLine.f14589f += i11;
            }
    ...
    public FlexboxLayout(Context context, AttributeSet attributeSet, int i10) {
        ...
        TypedArray obtainStyledAttributes = context.obtainStyledAttributes(attributeSet, c.f14666b, i10, 0);
        this.mFlexDirection = obtainStyledAttributes.getInt(c.f14672h, 0);
        this.mFlexWrap = obtainStyledAttributes.getInt(c.f14673i, 0);
        this.mJustifyContent = obtainStyledAttributes.getInt(c.f14674j, 0);
        this.mAlignItems = obtainStyledAttributes.getInt(c.f14668d, 0);
        this.mAlignContent = obtainStyledAttributes.getInt(c.f14667c, 0);
        this.mMaxLine = obtainStyledAttributes.getInt(c.f14675k, -1);
        Drawable drawable = obtainStyledAttributes.getDrawable(c.f14669e);
        if (drawable != null) {
            setDividerDrawableHorizontal(drawable);
            setDividerDrawableVertical(drawable);
        }
        Drawable drawable2 = obtainStyledAttributes.getDrawable(c.f14670f);
        if (drawable2 != null) {
            setDividerDrawableHorizontal(drawable2);
        }
        Drawable drawable3 = obtainStyledAttributes.getDrawable(c.f14671g);
        if (drawable3 != null) {
            setDividerDrawableVertical(drawable3);
        }
        int i11 = obtainStyledAttributes.getInt(c.f14676l, 0);
        if (i11 != 0) {
            this.mShowDividerVertical = i11;
            this.mShowDividerHorizontal = i11;
        }
        int i12 = obtainStyledAttributes.getInt(c.f14678n, 0);
        if (i12 != 0) {
            this.mShowDividerVertical = i12;
        }
        int i13 = obtainStyledAttributes.getInt(c.f14677m, 0);
        if (i13 != 0) {
    ...
    public static class LayoutParams extends ViewGroup.MarginLayoutParams implements b {
        ...
        public LayoutParams(Context context, AttributeSet attributeSet) {
            ...
            this.f14616q = -1;
            this.f14617r = -1;
            this.f14618s = 16777215;
            this.f14619t = 16777215;
            TypedArray obtainStyledAttributes = context.obtainStyledAttributes(attributeSet, c.f14679o);
            this.f14611d = obtainStyledAttributes.getInt(c.f14688x, 1);
            this.f14612e = obtainStyledAttributes.getFloat(c.f14682r, 0.0f);
            this.f14613i = obtainStyledAttributes.getFloat(c.f14683s, 1.0f);
            this.f14614o = obtainStyledAttributes.getInt(c.f14680p, -1);
            this.f14615p = obtainStyledAttributes.getFraction(c.f14681q, 1, 1, -1.0f);
            this.f14616q = obtainStyledAttributes.getDimensionPixelSize(c.f14687w, -1);
            this.f14617r = obtainStyledAttributes.getDimensionPixelSize(c.f14686v, -1);
            this.f14618s = obtainStyledAttributes.getDimensionPixelSize(c.f14685u, 16777215);
            this.f14619t = obtainStyledAttributes.getDimensionPixelSize(c.f14684t, 16777215);
            this.f14620u = obtainStyledAttributes.getBoolean(c.f14689y, false);
            obtainStyledAttributes.recycle();
        }
        ...
        public LayoutParams(LayoutParams layoutParams) {
            ...
            this.f14618s = 16777215;
            this.f14619t = 16777215;
            this.f14611d = layoutParams.f14611d;
            this.f14612e = layoutParams.f14612e;
            this.f14613i = layoutParams.f14613i;
            this.f14614o = layoutParams.f14614o;
            this.f14615p = layoutParams.f14615p;
            this.f14616q = layoutParams.f14616q;
            this.f14617r = layoutParams.f14617r;
            this.f14618s = layoutParams.f14618s;
            this.f14619t = layoutParams.f14619t;
            this.f14620u = layoutParams.f14620u;
        }
