...
public class FlexboxHelper {
    ...
    private final com.google.android.flexbox.a f13199a;
    ...
    public static class b implements Comparable {
        ...
        public int compareTo(b bVar) {
            ...
            int i11 = bVar.f13207e;
            if (i10 != i11) {
                return i10 - i11;
            }
            return this.f13206d - bVar.f13206d;
        }

        public String toString() {
            return "Order{order=" + this.f13207e + ", index=" + this.f13206d + '}';
        }
    }
    ...
    private int A(int i10, com.google.android.flexbox.b bVar, int i11) {
        com.google.android.flexbox.a aVar = this.f13199a;
        int childWidthMeasureSpec = aVar.getChildWidthMeasureSpec(i10, aVar.getPaddingLeft() + this.f13199a.getPaddingRight() + bVar.E1() + bVar.Y1() + i11, bVar.getWidth());
    ...
    private int H(boolean z10) {
        if (z10) {
            return this.f13199a.getPaddingBottom();
        }
        return this.f13199a.getPaddingEnd();
    }
    ...
    private int J(boolean z10) {
        if (z10) {
            return this.f13199a.getPaddingTop();
        }
        return this.f13199a.getPaddingStart();
    }
    ...
    private boolean P(View view, int i10, int i11, int i12, int i13, com.google.android.flexbox.b bVar, int i14, int i15, int i16) {
        ...
        int maxLine = this.f13199a.getMaxLine();
        if (maxLine != -1 && maxLine <= i16 + 1) {
            return false;
        }
        int decorationLengthMainAxis = this.f13199a.getDecorationLengthMainAxis(view, i14, i15);
    ...
    private void T(int i10, int i11, FlexLine flexLine, int i12, int i13, boolean z10) {
        ...
        int i14;
        int i15;
        int i16 = flexLine.f13185e;
        float f12 = flexLine.f13191k;
        float f13 = 0.0f;
        if (f12 > 0.0f && i12 <= i16) {
            float f14 = (i16 - i12) / f12;
            flexLine.f13185e = i13 + flexLine.f13186f;
            if (!z10) {
                flexLine.f13187g = Integer.MIN_VALUE;
            }
            int i17 = 0;
            boolean z11 = false;
            int i18 = 0;
            float f15 = 0.0f;
            while (i17 < flexLine.f13188h) {
                int i19 = flexLine.f13195o + i17;
                View reorderedFlexItemAt = this.f13199a.getReorderedFlexItemAt(i19);
                if (reorderedFlexItemAt == null || reorderedFlexItemAt.getVisibility() == 8) {
                    f10 = f13;
                    f11 = f14;
                } else {
                    com.google.android.flexbox.b bVar = (com.google.android.flexbox.b) reorderedFlexItemAt.getLayoutParams();
                    int flexDirection = this.f13199a.getFlexDirection();
                    f10 = f13;
                    if (flexDirection != 0 && flexDirection != 1) {
                        int measuredHeight = reorderedFlexItemAt.getMeasuredHeight();
                        long[] jArr = this.f13203e;
                        if (jArr != null) {
                            measuredHeight = x(jArr[i19]);
                        }
                        int measuredWidth = reorderedFlexItemAt.getMeasuredWidth();
                        long[] jArr2 = this.f13203e;
                        if (jArr2 != null) {
                            measuredWidth = y(jArr2[i19]);
                        }
                        if (!this.f13200b[i19] && bVar.E() > f10) {
                            float E = measuredHeight - (bVar.E() * f14);
                            if (i17 == flexLine.f13188h - 1) {
                                E += f15;
                                f15 = f10;
                            }
                            ...
                            if (round < bVar.b2()) {
                                round = bVar.b2();
                                this.f13200b[i19] = true;
                                flexLine.f13191k -= bVar.E();
                                z11 = true;
                            } else {
                                f15 += E - round;
                                double d10 = f15;
                            ...
                            int A = A(i10, bVar, flexLine.f13193m);
                            ...
                            this.f13199a.updateViewCache(i19, reorderedFlexItemAt);
                            measuredWidth = measuredWidth2;
                            measuredHeight = measuredHeight2;
                        }
                        i14 = Math.max(i18, measuredWidth + bVar.E1() + bVar.Y1() + this.f13199a.getDecorationLengthCrossAxis(reorderedFlexItemAt));
                        flexLine.f13185e += measuredHeight + bVar.N() + bVar.B1();
                        f11 = f14;
                    } else {
                        int measuredWidth3 = reorderedFlexItemAt.getMeasuredWidth();
                        long[] jArr3 = this.f13203e;
                        if (jArr3 != null) {
                            measuredWidth3 = y(jArr3[i19]);
                        }
                        int measuredHeight3 = reorderedFlexItemAt.getMeasuredHeight();
                        long[] jArr4 = this.f13203e;
                        f11 = f14;
                        if (jArr4 != null) {
                        ...
                        if (!this.f13200b[i19] && bVar.E() > f10) {
                            ...
                            int z12 = z(i11, bVar, flexLine.f13193m);
                        ...
                        int max = Math.max(i18, measuredHeight3 + bVar.N() + bVar.B1() + this.f13199a.getDecorationLengthCrossAxis(reorderedFlexItemAt));
                        flexLine.f13185e += measuredWidth3 + bVar.E1() + bVar.Y1();
                        i14 = max;
                    }
                    flexLine.f13187g = Math.max(flexLine.f13187g, i14);
                    i18 = i14;
                }
                i17++;
                f14 = f11;
    ...
    private int[] U(int i10, List list, SparseIntArray sparseIntArray) {
        ...
        while (it.hasNext()) {
            b bVar = (b) it.next();
            int i12 = bVar.f13206d;
            iArr[i11] = i12;
            sparseIntArray.append(i12, bVar.f13207e);
            i11++;
        }
        return iArr;
    }
    ...
    private void V(View view, int i10, int i11) {
        ...
        int min = Math.min(Math.max(((i10 - bVar.E1()) - bVar.Y1()) - this.f13199a.getDecorationLengthCrossAxis(view), bVar.L()), bVar.Y0());
        long[] jArr = this.f13203e;
        if (jArr != null) {
        ...
        this.f13199a.updateViewCache(i11, view);
    }

    private void W(View view, int i10, int i11) {
        int measuredWidth;
        com.google.android.flexbox.b bVar = (com.google.android.flexbox.b) view.getLayoutParams();
        int min = Math.min(Math.max(((i10 - bVar.N()) - bVar.B1()) - this.f13199a.getDecorationLengthCrossAxis(view), bVar.b2()), bVar.h2());
        long[] jArr = this.f13203e;
        if (jArr != null) {
    ...
    private void a(List list, FlexLine flexLine, int i10, int i11) {
        flexLine.f13193m = i11;
        this.f13199a.onNewFlexLineAdded(flexLine);
        flexLine.f13196p = i10;
        list.add(flexLine);
    }
    ...
    */
    private void i(android.view.View r7, int r8) {
        ...
        L3e:
            ...
            r7.measure(r1, r0)
            r6.Z(r8, r1, r0, r7)
            com.google.android.flexbox.a r0 = r6.f13199a
    ...
    private List l(int i10) {
        ...
        for (int i11 = 0; i11 < i10; i11++) {
            b bVar = new b();
            bVar.f13207e = ((com.google.android.flexbox.b) this.f13199a.getFlexItemAt(i11).getLayoutParams()).getOrder();
            bVar.f13206d = i11;
            arrayList.add(bVar);
        }
        return arrayList;
    ...
    private void r(int i10) {
        ...
        if (zArr == null) {
            this.f13200b = new boolean[Math.max(i10, 10)];
        } else if (zArr.length < i10) {
            this.f13200b = new boolean[Math.max(zArr.length * 2, i10)];
        } else {
    ...
    private void w(int i10, int i11, FlexLine flexLine, int i12, int i13, boolean z10) {
        ...
        double d10;
        double d11;
        float f12 = flexLine.f13190j;
        float f13 = 0.0f;
        if (f12 > 0.0f && i12 >= (i14 = flexLine.f13185e)) {
            ...
            int i17 = 0;
            float f15 = 0.0f;
            while (i16 < flexLine.f13188h) {
                int i18 = flexLine.f13195o + i16;
                View reorderedFlexItemAt = this.f13199a.getReorderedFlexItemAt(i18);
                if (reorderedFlexItemAt == null || reorderedFlexItemAt.getVisibility() == 8) {
                    f10 = f13;
                    f11 = f14;
                    z11 = z11;
                    ...
                    if (flexDirection == 0 || flexDirection == 1) {
                        ...
                        if (!this.f13200b[i18] && bVar.A0() > f10) {
                            float A0 = measuredWidth + (bVar.A0() * f11);
                            if (i16 == flexLine.f13188h - 1) {
                                A0 += f15;
                                f15 = f10;
                            }
                            ...
                            if (round > bVar.Y0()) {
                                round = bVar.Y0();
                                this.f13200b[i18] = true;
                                flexLine.f13190j -= bVar.A0();
                                z11 = true;
                            } else {
                                f15 += A0 - round;
                                double d12 = f15;
                            ...
                            int z13 = z(i11, bVar, flexLine.f13193m);
                            int makeMeasureSpec = View.MeasureSpec.makeMeasureSpec(round, 1073741824);
                            reorderedFlexItemAt.measure(makeMeasureSpec, z13);
                            int measuredWidth2 = reorderedFlexItemAt.getMeasuredWidth();
                            int measuredHeight2 = reorderedFlexItemAt.getMeasuredHeight();
                            Z(i18, makeMeasureSpec, z13, reorderedFlexItemAt);
                            this.f13199a.updateViewCache(i18, reorderedFlexItemAt);
                            measuredWidth = measuredWidth2;
                            measuredHeight = measuredHeight2;
                        } else {
                            z11 = z12;
                        }
                        int max = Math.max(i17, measuredHeight + bVar.N() + bVar.B1() + this.f13199a.getDecorationLengthCrossAxis(reorderedFlexItemAt));
                        flexLine.f13185e += measuredWidth + bVar.E1() + bVar.Y1();
                        i15 = max;
                    } else {
                        int measuredHeight3 = reorderedFlexItemAt.getMeasuredHeight();
                        long[] jArr3 = this.f13203e;
                        ...
                        i15 = Math.max(i17, measuredWidth3 + bVar.E1() + bVar.Y1() + this.f13199a.getDecorationLengthCrossAxis(reorderedFlexItemAt));
                        flexLine.f13185e += measuredHeight3 + bVar.N() + bVar.B1();
                    }
                    flexLine.f13187g = Math.max(flexLine.f13187g, i15);
                    i17 = i15;
                }
                i16++;
                f14 = f11;
    ...
    private int z(int i10, com.google.android.flexbox.b bVar, int i11) {
        com.google.android.flexbox.a aVar = this.f13199a;
        int childHeightMeasureSpec = aVar.getChildHeightMeasureSpec(i10, aVar.getPaddingTop() + this.f13199a.getPaddingBottom() + bVar.N() + bVar.B1() + i11, bVar.getHeight());
    ...
    public boolean O(SparseIntArray sparseIntArray) {
        int flexItemCount = this.f13199a.getFlexItemCount();
        if (sparseIntArray.size() != flexItemCount) {
            return true;
        }
        for (int i10 = 0; i10 < flexItemCount; i10++) {
            View flexItemAt = this.f13199a.getFlexItemAt(i10);
    ...
    public void Q(View view, FlexLine flexLine, int i10, int i11, int i12, int i13) {
        com.google.android.flexbox.b bVar = (com.google.android.flexbox.b) view.getLayoutParams();
        int alignItems = this.f13199a.getAlignItems();
        if (bVar.B() != -1) {
            alignItems = bVar.B();
        }
        int i14 = flexLine.f13187g;
        if (alignItems != 0) {
            if (alignItems != 1) {
                if (alignItems != 2) {
                    if (alignItems != 3) {
                    ...
                    } else if (this.f13199a.getFlexWrap() != 2) {
                        int max = Math.max(flexLine.f13192l - view.getBaseline(), bVar.N());
                        view.layout(i10, i11 + max, i12, i13 + max);
                        return;
                    } else {
                        int max2 = Math.max((flexLine.f13192l - view.getMeasuredHeight()) + view.getBaseline(), bVar.B1());
                        view.layout(i10, i11 - max2, i12, i13 - max2);
                        return;
                    }
                } else {
                    int measuredHeight = (((i14 - view.getMeasuredHeight()) + bVar.N()) - bVar.B1()) / 2;
                    if (this.f13199a.getFlexWrap() != 2) {
    ...
    public void Y(int i10) {
        ...
        if (i10 < this.f13199a.getFlexItemCount()) {
            int flexDirection = this.f13199a.getFlexDirection();
            if (this.f13199a.getAlignItems() == 4) {
                ...
                List flexLinesInternal = this.f13199a.getFlexLinesInternal();
                int size = flexLinesInternal.size();
                while (i11 < size) {
                    FlexLine flexLine = (FlexLine) flexLinesInternal.get(i11);
                    int i12 = flexLine.f13188h;
                    for (int i13 = 0; i13 < i12; i13++) {
                        int i14 = flexLine.f13195o + i13;
                        if (i13 < this.f13199a.getFlexItemCount() && (reorderedFlexItemAt = this.f13199a.getReorderedFlexItemAt(i14)) != null && reorderedFlexItemAt.getVisibility() != 8) {
                            com.google.android.flexbox.b bVar = (com.google.android.flexbox.b) reorderedFlexItemAt.getLayoutParams();
                            if (bVar.B() == -1 || bVar.B() == 4) {
                                if (flexDirection != 0 && flexDirection != 1) {
                                    ...
                                    V(reorderedFlexItemAt, flexLine.f13187g, i14);
                                } else {
                                    W(reorderedFlexItemAt, flexLine.f13187g, i14);
                                }
                            }
                        }
                    }
            ...
            for (FlexLine flexLine2 : this.f13199a.getFlexLinesInternal()) {
                for (Integer num : flexLine2.f13194n) {
                    View reorderedFlexItemAt2 = this.f13199a.getReorderedFlexItemAt(num.intValue());
                    if (flexDirection != 0 && flexDirection != 1) {
                        if (flexDirection != 2 && flexDirection != 3) {
                            throw new IllegalArgumentException("Invalid flex direction: " + flexDirection);
                        }
                        V(reorderedFlexItemAt2, flexLine2.f13187g, num.intValue());
                    } else {
                        W(reorderedFlexItemAt2, flexLine2.f13187g, num.intValue());
                    }
                }
            }
        }
    ...
    public void b(FlexLinesResult flexLinesResult, int i10, int i11, int i12, int i13, int i14, List list) {
        ...
        int i31;
        int i32 = i10;
        boolean isMainAxisDirectionHorizontal = this.f13199a.isMainAxisDirectionHorizontal();
        ...
        flexLinesResult.f13204a = arrayList;
        if (i14 == -1) {
            z10 = true;
        } else {
            z10 = false;
        ...
        int i33 = i13;
        flexLine2.f13195o = i33;
        int i34 = K + I;
        flexLine2.f13185e = i34;
        int flexItemCount = this.f13199a.getFlexItemCount();
        boolean z13 = z10;
        ...
        while (true) {
            if (i33 < flexItemCount) {
                View reorderedFlexItemAt = this.f13199a.getReorderedFlexItemAt(i33);
                if (reorderedFlexItemAt == null) {
                    ...
                    if (reorderedFlexItemAt.getVisibility() == 8) {
                        ...
                        if (bVar.B() == 4) {
                            flexLine3.f13194n.add(Integer.valueOf(i33));
                        }
                        ...
                        if (isMainAxisDirectionHorizontal) {
                            i18 = mode;
                            i21 = this.f13199a.getChildWidthMeasureSpec(i32, i16 + E(bVar, true) + C(bVar, true), G);
                            i17 = size;
                            i19 = i36;
                            int childHeightMeasureSpec = this.f13199a.getChildHeightMeasureSpec(i11, J + H + D(bVar, true) + B(bVar, true) + i36, F(bVar, true));
                            ...
                            i19 = i36;
                            i20 = 0;
                            int childWidthMeasureSpec = this.f13199a.getChildWidthMeasureSpec(i11, J + H + D(bVar, false) + B(bVar, false) + i19, F(bVar, false));
                            int childHeightMeasureSpec2 = this.f13199a.getChildHeightMeasureSpec(i32, i16 + E(bVar, false) + C(bVar, false), G);
                        ...
                        this.f13199a.updateViewCache(i33, reorderedFlexItemAt);
                        ...
                        size = i17;
                        if (P(reorderedFlexItemAt, i18, size, flexLine3.f13185e, M(reorderedFlexItemAt, isMainAxisDirectionHorizontal) + E(bVar, isMainAxisDirectionHorizontal) + C(bVar, isMainAxisDirectionHorizontal), bVar, i22, i42, arrayList.size())) {
                            if (flexLine4.c() > 0) {
                                if (i22 > 0) {
                                    i31 = i22 - 1;
                                } else {
                            ...
                            if (z14) {
                                if (bVar.getHeight() == -1) {
                                    com.google.android.flexbox.a aVar = this.f13199a;
                                    reorderedFlexItemAt.measure(i41, aVar.getChildHeightMeasureSpec(i11, aVar.getPaddingTop() + this.f13199a.getPaddingBottom() + bVar.N() + bVar.B1() + i30, bVar.getHeight()));
                                    i(reorderedFlexItemAt, i22);
                                }
                            } else if (bVar.getWidth() == -1) {
                                com.google.android.flexbox.a aVar2 = this.f13199a;
                                reorderedFlexItemAt.measure(aVar2.getChildWidthMeasureSpec(i11, aVar2.getPaddingLeft() + this.f13199a.getPaddingRight() + bVar.E1() + bVar.Y1() + i30, bVar.getWidth()), i41);
                                i(reorderedFlexItemAt, i22);
                            }
                            FlexLine flexLine5 = new FlexLine();
                            flexLine5.f13188h = 1;
                            flexLine5.f13185e = i23;
                            flexLine5.f13195o = i22;
                            i24 = i30;
                            i25 = i40;
                            flexLine = flexLine5;
                        ...
                        boolean z15 = flexLine.f13197q;
                        if (bVar.A0() != 0.0f) {
                            i27 = 1;
                        } else {
                            i27 = i40;
                        }
                        flexLine.f13197q = (z15 ? 1 : 0) | i27;
                        boolean z16 = flexLine.f13198r;
                        if (bVar.E() != 0.0f) {
                            i28 = 1;
                        } else {
                            i28 = i40;
                        }
                        flexLine.f13198r = (z16 ? 1 : 0) | i28;
                        int[] iArr = this.f13201c;
                        if (iArr != null) {
                            iArr[i22] = arrayList.size();
                        }
                        z11 = z14;
                        flexLine.f13185e += M(reorderedFlexItemAt, z11) + E(bVar, z11) + C(bVar, z11);
                        flexLine.f13190j += bVar.A0();
                        flexLine.f13191k += bVar.E();
                        this.f13199a.onNewFlexItemAdded(reorderedFlexItemAt, i22, i25, flexLine);
                        int max = Math.max(i26, L(reorderedFlexItemAt, z11) + D(bVar, z11) + B(bVar, z11) + this.f13199a.getDecorationLengthCrossAxis(reorderedFlexItemAt));
                        flexLine.f13187g = Math.max(flexLine.f13187g, max);
                        if (z11) {
                            if (this.f13199a.getFlexWrap() != 2) {
                                flexLine.f13192l = Math.max(flexLine.f13192l, reorderedFlexItemAt.getBaseline() + bVar.N());
                            } else {
                                flexLine.f13192l = Math.max(flexLine.f13192l, (reorderedFlexItemAt.getMeasuredHeight() - reorderedFlexItemAt.getBaseline()) + bVar.B1());
                            }
                        }
                        i29 = i39;
                        if (N(i22, i29, flexLine)) {
                            a(arrayList, flexLine, i22, i24);
                            i24 += flexLine.f13187g;
                        }
                        if (i14 != -1 && arrayList.size() > 0) {
                            if (((FlexLine) arrayList.get(arrayList.size() - 1)).f13196p >= i14 && i22 >= i14 && !z13) {
                                i24 = -flexLine.a();
                                z12 = true;
                                if (i24 <= i12 && z12) {
    ...
    public int[] n(View view, int i10, ViewGroup.LayoutParams layoutParams, SparseIntArray sparseIntArray) {
        ...
        if (view != null && (layoutParams instanceof com.google.android.flexbox.b)) {
            bVar.f13207e = ((com.google.android.flexbox.b) layoutParams).getOrder();
        } else {
            bVar.f13207e = 1;
        }
        if (i10 != -1 && i10 != flexItemCount) {
            if (i10 < this.f13199a.getFlexItemCount()) {
                ...
                while (i10 < flexItemCount) {
                    ((b) l10.get(i10)).f13206d++;
                    i10++;
                }
            } else {
                bVar.f13206d = flexItemCount;
            }
        } else {
            bVar.f13206d = flexItemCount;
        }
    ...
    public void o(int i10, int i11, int i12) {
        ...
        List<FlexLine> flexLinesInternal = this.f13199a.getFlexLinesInternal();
        if (i13 == 1073741824) {
            int sumOfCrossSize = this.f13199a.getSumOfCrossSize() + i12;
            int i15 = 0;
            if (flexLinesInternal.size() == 1) {
                ((FlexLine) flexLinesInternal.get(0)).f13187g = i14 - i12;
            } else if (flexLinesInternal.size() >= 2) {
                int alignContent = this.f13199a.getAlignContent();
                if (alignContent != 1) {
                    if (alignContent != 2) {
                        if (alignContent != 3) {
                            if (alignContent != 4) {
                                if (alignContent == 5 && sumOfCrossSize < i14) {
                                    ...
                                    while (i15 < size3) {
                                        ...
                                        float f11 = flexLine.f13187g + size2;
                                ...
                                this.f13199a.setFlexLines(k(flexLinesInternal, i14, sumOfCrossSize));
                                return;
                            } else {
                                int size4 = (i14 - sumOfCrossSize) / (flexLinesInternal.size() * 2);
                                ArrayList arrayList = new ArrayList();
                                FlexLine flexLine2 = new FlexLine();
                                flexLine2.f13187g = size4;
                                for (FlexLine flexLine3 : flexLinesInternal) {
                                    arrayList.add(flexLine2);
                                    arrayList.add(flexLine3);
                                    arrayList.add(flexLine2);
                                }
                                this.f13199a.setFlexLines(arrayList);
                                return;
                            }
                        } else if (sumOfCrossSize < i14) {
                            ...
                            while (i15 < size6) {
                                ...
                                if (i15 != flexLinesInternal.size() - 1) {
                                    ...
                                    if (i15 == flexLinesInternal.size() - 2) {
                                        flexLine4.f13187g = Math.round(f12 + size5);
                                        f12 = 0.0f;
                                    } else {
                                        flexLine4.f13187g = Math.round(size5);
                                    }
                                    int i16 = flexLine4.f13187g;
                                    f12 += size5 - i16;
                                    if (f12 > 1.0f) {
                                        flexLine4.f13187g = i16 + 1;
                                        f12 -= 1.0f;
                                    } else if (f12 < -1.0f) {
                                        flexLine4.f13187g = i16 - 1;
                                        f12 += 1.0f;
                            ...
                            this.f13199a.setFlexLines(arrayList2);
                            return;
                        } else {
                            return;
                        }
    ...
    public void q(int i10, int i11, int i12) {
        ...
        int i14;
        int i15;
        r(this.f13199a.getFlexItemCount());
        if (i12 < this.f13199a.getFlexItemCount()) {
            int flexDirection = this.f13199a.getFlexDirection();
            int flexDirection2 = this.f13199a.getFlexDirection();
            if (flexDirection2 != 0 && flexDirection2 != 1) {
                ...
                if (mode != 1073741824) {
                    size = this.f13199a.getLargestMainSize();
                }
                paddingLeft = this.f13199a.getPaddingTop();
                paddingRight = this.f13199a.getPaddingBottom();
            } else {
                int mode2 = View.MeasureSpec.getMode(i10);
                size = View.MeasureSpec.getSize(i10);
                int largestMainSize = this.f13199a.getLargestMainSize();
                if (mode2 != 1073741824) {
                    size = Math.min(largestMainSize, size);
                }
                paddingLeft = this.f13199a.getPaddingLeft();
                paddingRight = this.f13199a.getPaddingRight();
            }
            ...
            while (i13 < size2) {
                ...
                int i18 = flexLine.f13185e;
                if (i18 < i17 && flexLine.f13197q) {
                    i14 = i10;
                    i15 = i11;
    ...
    public void s(int i10) {
        int[] iArr = this.f13201c;
        if (iArr == null) {
            this.f13201c = new int[Math.max(i10, 10)];
        } else if (iArr.length < i10) {
            this.f13201c = Arrays.copyOf(this.f13201c, Math.max(iArr.length * 2, i10));
        }
    }
    ...
    public void t(int i10) {
        long[] jArr = this.f13202d;
        if (jArr == null) {
            this.f13202d = new long[Math.max(i10, 10)];
        } else if (jArr.length < i10) {
            this.f13202d = Arrays.copyOf(this.f13202d, Math.max(jArr.length * 2, i10));
        }
    }
    ...
    public void u(int i10) {
        long[] jArr = this.f13203e;
        if (jArr == null) {
            this.f13203e = new long[Math.max(i10, 10)];
        } else if (jArr.length < i10) {
            this.f13203e = Arrays.copyOf(this.f13203e, Math.max(jArr.length * 2, i10));
        }
    }
