...
public class f extends g {
    ...
    private static final f f13412f = new f();

    /* renamed from: d  reason: collision with root package name */
    public static final int f13410d = g.f13414a;
        ...
        if (i10 == 18) {
            ...
            if (com.google.android.gms.common.util.g.c(context)) {
                ...
                if (com.google.android.gms.common.util.g.d(context)) {
                    Z.a(cf.a.f7155a, resources.getString(cf.b.f7170o), pendingIntent);
                } else {
                    Z.v(pendingIntent);
                }
            } else {
                Z.U(17301642).b0(resources.getString(cf.b.f7163h)).g0(System.currentTimeMillis()).v(pendingIntent).w(d10);
            }
            if (com.google.android.gms.common.util.k.e()) {
                ...
                if (str2 == null) {
                    ...
                    String string = context.getResources().getString(cf.b.f7162g);
    ...
    public final boolean w(Context context, b bVar, int i10) {
        ...
        t(context, bVar.b(), null, PendingIntent.getActivity(context, 0, GoogleApiActivity.a(context, l10, i10, true), fg.g.f23986a | 134217728));
        return true;
    }
}
