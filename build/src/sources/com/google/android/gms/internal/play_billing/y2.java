...
public final class y2 implements g3 {
    ...
    private static final int[] f14407o = new int[0];

    /* renamed from: p  reason: collision with root package name */
    private static final Unsafe f14408p = g4.l();
    ...
    private final int f14416h;

    /* renamed from: i  reason: collision with root package name */
    private final int f14417i;

    /* renamed from: j  reason: collision with root package name */
    private final k2 f14418j;

    /* renamed from: k  reason: collision with root package name */
    private final w3 f14419k;

    /* renamed from: l  reason: collision with root package name */
    private final f1 f14420l;

    /* renamed from: m  reason: collision with root package name */
    private final a3 f14421m;

    /* renamed from: n  reason: collision with root package name */
    private final q2 f14422n;
    ...
    */
    public static com.google.android.gms.internal.play_billing.y2 A(java.lang.Class r32, com.google.android.gms.internal.play_billing.s2 r33, com.google.android.gms.internal.play_billing.a3 r34, com.google.android.gms.internal.play_billing.k2 r35, com.google.android.gms.internal.play_billing.w3 r36, com.google.android.gms.internal.play_billing.f1 r37, com.google.android.gms.internal.play_billing.q2 r38) {
        /*
            Method dump skipped, instructions count: 1050
            To view this dump add '--comments-level debug' option
        */
        throw new UnsupportedOperationException("Method not decompiled: com.google.android.gms.internal.play_billing.y2.A(java.lang.Class, com.google.android.gms.internal.play_billing.s2, com.google.android.gms.internal.play_billing.a3, com.google.android.gms.internal.play_billing.k2, com.google.android.gms.internal.play_billing.w3, com.google.android.gms.internal.play_billing.f1, com.google.android.gms.internal.play_billing.q2):com.google.android.gms.internal.play_billing.y2");
    }
    ...
    private final int E(int i10) {
        return this.f14409a[i10 + 2];
    }

    private final int F(int i10, int i11) {
        int length = (this.f14409a.length / 3) - 1;
        while (i11 <= length) {
            int i12 = (length + i11) >>> 1;
            int i13 = i12 * 3;
            int i14 = this.f14409a[i13];
            if (i10 == i14) {
                return i13;
            }
            if (i10 < i14) {
    ...
    private final u1 J(int i10) {
        int i11 = i10 / 3;
        return (u1) this.f14410b[i11 + i11 + 1];
    }

    private final g3 K(int i10) {
        Object[] objArr = this.f14410b;
        int i11 = i10 / 3;
        int i12 = i11 + i11;
        ...
        this.f14410b[i12] = b10;
        return b10;
    }

    private final Object L(int i10) {
        int i11 = i10 / 3;
        return this.f14410b[i11 + i11];
    }
    ...
    private final Object M(Object obj, int i10) {
        ...
        Object object = f14408p.getObject(obj, H);
        if (u(object)) {
            return object;
        }
        Object k10 = K.k();
    ...
    private final Object N(Object obj, int i10, int i11) {
        ...
        Object object = f14408p.getObject(obj, H(i11) & 1048575);
        if (u(object)) {
            return object;
        }
        Object k10 = K.k();
    ...
    private final void j(Object obj, Object obj2, int i10) {
        ...
        throw new IllegalStateException("Source subfield " + this.f14409a[i10] + " is present but null: " + obj2.toString());
    }

    private final void l(Object obj, Object obj2, int i10) {
        int i11 = this.f14409a[i10];
        if (!v(obj2, i11, i10)) {
            return;
        }
        Unsafe unsafe = f14408p;
    ...
    private final void o(Object obj, int i10, Object obj2) {
        f14408p.putObject(obj, H(i10) & 1048575, obj2);
        m(obj, i10);
    }

    private final void p(Object obj, int i10, int i11, Object obj2) {
        f14408p.putObject(obj, H(i11) & 1048575, obj2);
        n(obj, i10, i11);
    }
        ...
        if (j10 == 1048575) {
            ...
            switch (G(H)) {
                ...
                case 9:
                    ...
                    return true;
                case 10:
                    if (r0.f14359e.equals(g4.k(obj, j11))) {
                        return false;
                    }
                    return true;
                case 11:
    ...
    private static final void x(int i10, Object obj, o4 o4Var) {
    ...
    public final int a(Object obj) {
        ...
        int i17 = 0;
        int i18 = 1048575;
        while (i15 < y2Var.f14409a.length) {
            int H = y2Var.H(i15);
            int G = G(H);
            int[] iArr = y2Var.f14409a;
            int i19 = iArr[i15];
            int i20 = iArr[i15 + 2];
            int i21 = i20 & i14;
            if (G <= 17) {
            ...
            switch (G) {
                case 0:
                    if (y2Var.s(obj2, i15, i18, i16, i10)) {
                        w10 = z0.w(i19 << 3);
                        o10 = w10 + 8;
                        i17 = i23 + o10;
                        break;
        ...
        w3 w3Var = y2Var.f14419k;
        int a10 = i17 + w3Var.a(w3Var.d(obj2));
        if (y2Var.f14414f) {
            j1 b10 = y2Var.f14420l.b(obj2);
            int i46 = 0;
            for (int i47 = 0; i47 < b10.f14257a.b(); i47++) {
                Map.Entry g10 = b10.f14257a.g(i47);
                android.support.v4.media.session.b.a(g10.getKey());
                i46 += j1.b(null, g10.getValue());
            }
            for (Map.Entry entry2 : b10.f14257a.c()) {
        ...
        if (u(obj)) {
            ...
            for (int i10 = 0; i10 < iArr.length; i10 += 3) {
                ...
                if (G != 9) {
                    ...
                    } else if (v(obj, this.f14409a[i10], i10)) {
                        K(i10).b(f14408p.getObject(obj, j10));
                    }
                }
                if (r(obj, i10)) {
                    K(i10).b(f14408p.getObject(obj, j10));
    ...
    public final int d(Object obj) {
        ...
        int i11;
        int i12 = 0;
        for (int i13 = 0; i13 < this.f14409a.length; i13 += 3) {
            int H = H(i13);
            int[] iArr = this.f14409a;
            int i14 = 1048575 & H;
            int G = G(H);
        ...
        int hashCode = (i12 * 53) + this.f14419k.d(obj).hashCode();
        if (this.f14414f) {
            return (hashCode * 53) + this.f14420l.b(obj).f14257a.hashCode();
        }
        return hashCode;
    }
    ...
    public final void e(Object obj, Object obj2) {
        i(obj);
        obj2.getClass();
        for (int i10 = 0; i10 < this.f14409a.length; i10 += 3) {
            int H = H(i10);
            int i11 = 1048575 & H;
            int[] iArr = this.f14409a;
            int G = G(H);
        ...
        i3.x(this.f14419k, obj, obj2);
        if (this.f14414f) {
            i3.w(this.f14420l, obj, obj2);
        }
    }
    ...
    public final boolean f(Object obj, Object obj2) {
        ...
        for (int i10 = 0; i10 < this.f14409a.length; i10 += 3) {
            ...
            switch (G(H)) {
                case 0:
                    if (q(obj, obj2, i10) && Double.doubleToLongBits(g4.f(obj, j10)) == Double.doubleToLongBits(g4.f(obj2, j10))) {
                        continue;
                    }
                    return false;
                case 1:
                    if (q(obj, obj2, i10) && Float.floatToIntBits(g4.g(obj, j10)) == Float.floatToIntBits(g4.g(obj2, j10))) {
                        continue;
                    }
                    return false;
                case 2:
                    if (q(obj, obj2, i10) && g4.i(obj, j10) == g4.i(obj2, j10)) {
                        continue;
                    }
                    return false;
                case 3:
                    ...
                    return false;
                case 4:
                    if (q(obj, obj2, i10) && g4.h(obj, j10) == g4.h(obj2, j10)) {
                        continue;
                    }
                    return false;
                case 5:
                ...
                case 6:
                    ...
                    return false;
                case 7:
                    if (q(obj, obj2, i10) && g4.B(obj, j10) == g4.B(obj2, j10)) {
                        continue;
                    }
                    return false;
                case 8:
                    if (q(obj, obj2, i10) && i3.g(g4.k(obj, j10), g4.k(obj2, j10))) {
                        continue;
                    }
                    return false;
                case 9:
        ...
        if (!this.f14419k.d(obj).equals(this.f14419k.d(obj2))) {
            return false;
        }
        if (this.f14414f) {
            return this.f14420l.b(obj).equals(this.f14420l.b(obj2));
        }
        return true;
    }
    ...
    */
    ...
    public final boolean h(Object obj) {
        ...
        int i13 = 0;
        int i14 = 1048575;
        while (i12 < this.f14416h) {
            int[] iArr = this.f14415g;
            int[] iArr2 = this.f14409a;
            int i15 = iArr[i12];
            int i16 = iArr2[i15];
            int H = H(i15);
            int i17 = this.f14409a[i15 + 2];
            int i18 = i17 & 1048575;
            int i19 = 1 << (i17 >>> 20);
            if (i18 != i14) {
                if (i18 != 1048575) {
                    i13 = f14408p.getInt(obj, i18);
                }
                i11 = i13;
                i10 = i18;
            } else {
            ...
            Object obj2 = obj;
            if ((268435456 & H) != 0 && !s(obj2, i15, i10, i11, i19)) {
                return false;
            }
            int G = G(H);
            if (G != 9 && G != 17) {
                if (G != 27) {
                    ...
                    } else if (v(obj2, i16, i15) && !t(obj2, H, K(i15))) {
                        return false;
                    }
                }
            ...
            } else if (s(obj2, i15, i10, i11, i19) && !t(obj2, H, K(i15))) {
                return false;
            }
            i12++;
            obj = obj2;
        ...
        Object obj3 = obj;
        if (this.f14414f && !this.f14420l.b(obj3).h()) {
            return false;
        }
        return true;
    }
    ...
    /*
        ...
        To view partially-correct add '--show-bad-code' argument
    */
    public final int y(java.lang.Object r33, byte[] r34, int r35, int r36, int r37, com.google.android.gms.internal.play_billing.d0 r38) {
        /*
            Method dump skipped, instructions count: 3524
            To view this dump add '--comments-level debug' option
        */
        throw new UnsupportedOperationException("Method not decompiled: com.google.android.gms.internal.play_billing.y2.y(java.lang.Object, byte[], int, int, int, com.google.android.gms.internal.play_billing.d0):int");
    }
}
