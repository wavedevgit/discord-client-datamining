...
final class g2 extends k2 {
    ...
    private static final Class f14911c = Collections.unmodifiableList(Collections.EMPTY_LIST).getClass();
    ...
    public final void a(Object obj, long j10) {
        ...
        if (list instanceof e2) {
            unmodifiableList = ((e2) list).h();
        } else if (!f14911c.isAssignableFrom(list.getClass())) {
    ...
    public final void b(Object obj, Object obj2, long j10) {
        ...
        if (list2.isEmpty()) {
            ...
            if (f14911c.isAssignableFrom(list2.getClass())) {
