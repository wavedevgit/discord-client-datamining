...
public abstract class a4 extends AtomicReference implements Runnable {
    ...
    private static final Runnable f14643d = new y3(null);

    /* renamed from: e  reason: collision with root package name */
    private static final Runnable f14644e = new y3(null);
        ...
        if (runnable instanceof Thread) {
            ...
            if (compareAndSet(runnable, x3Var)) {
                try {
                    ...
                    thread.interrupt();
                    if (((Runnable) getAndSet(f14643d)) == f14644e) {
            ...
            if (!f10) {
                try {
                    ...
                    try {
                        ...
                        if (!compareAndSet(currentThread, f14643d)) {
                            g(currentThread);
                        }
                        c(th2);
                        return;
