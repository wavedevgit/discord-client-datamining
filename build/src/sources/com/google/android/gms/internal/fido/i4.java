...
final class i4 extends f4 implements d4 {
    ...
    public final /* bridge */ /* synthetic */ ScheduledFuture schedule(Runnable runnable, long j10, TimeUnit timeUnit) {
        ScheduledExecutorService scheduledExecutorService = this.f14125e;
    ...
    public final /* bridge */ /* synthetic */ ScheduledFuture scheduleAtFixedRate(Runnable runnable, long j10, long j11, TimeUnit timeUnit) {
        ...
        return new g4(h4Var, this.f14125e.scheduleAtFixedRate(h4Var, j10, j11, timeUnit));
    }

    @Override // java.util.concurrent.ScheduledExecutorService
    public final /* bridge */ /* synthetic */ ScheduledFuture scheduleWithFixedDelay(Runnable runnable, long j10, long j11, TimeUnit timeUnit) {
        h4 h4Var = new h4(runnable);
        return new g4(h4Var, this.f14125e.scheduleWithFixedDelay(h4Var, j10, j11, timeUnit));
    }

    @Override // java.util.concurrent.ScheduledExecutorService
    public final /* bridge */ /* synthetic */ ScheduledFuture schedule(Callable callable, long j10, TimeUnit timeUnit) {
        l4 l4Var = new l4(callable);
        return new g4(l4Var, this.f14125e.schedule(l4Var, j10, timeUnit));
    }
}
