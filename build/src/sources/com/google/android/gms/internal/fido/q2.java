    ...
    */
        ...
        while (true) {
            ...
            if (i12 < cArr.length) {
                if (y.a(cArr[i12])) {
                    ...
                    char[] cArr2 = new char[this.f14729b.length];
                    while (true) {
                        char[] cArr3 = this.f14729b;
                        if (i11 >= cArr3.length) {
                            break;
                        }
                        char c11 = cArr3[i11];
                    ...
                    q2 q2Var = new q2(this.f14728a.concat(".upperCase()"), cArr2);
                    if (this.f14735h && !q2Var.f14735h) {
                        byte[] bArr = q2Var.f14734g;
                        byte[] copyOf = Arrays.copyOf(bArr, bArr.length);
                        for (i10 = 65; i10 <= 90; i10++) {
                            int i14 = i10 | 32;
                            byte[] bArr2 = q2Var.f14734g;
                            byte b10 = bArr2[i10];
                            byte b11 = bArr2[i14];
                            if (b10 == -1) {
                                copyOf[i10] = b11;
                        ...
                        return new q2(q2Var.f14728a.concat(".ignoreCase()"), q2Var.f14729b, copyOf, true);
                    }
                    return q2Var;
                }
                i12++;
    ...
    public final boolean equals(Object obj) {
        if (obj instanceof q2) {
            q2 q2Var = (q2) obj;
            if (this.f14735h == q2Var.f14735h && Arrays.equals(this.f14729b, q2Var.f14729b)) {
                return true;
            }
        }
        return false;
    ...
    public final int hashCode() {
        ...
        int hashCode = Arrays.hashCode(this.f14729b);
        if (true != z10) {
            i10 = 1237;
        } else {
            i10 = 1231;
    ...
    private q2(String str, char[] cArr, byte[] bArr, boolean z10) {
        ...
        try {
            ...
            this.f14732e = i10;
            this.f14733f = b10 >> numberOfTrailingZeros;
            this.f14730c = length - 1;
            this.f14734g = bArr;
            boolean[] zArr = new boolean[i10];
            for (int i11 = 0; i11 < this.f14733f; i11++) {
                zArr[w2.a(i11 * 8, this.f14731d, RoundingMode.CEILING)] = true;
            }
            this.f14735h = z10;
