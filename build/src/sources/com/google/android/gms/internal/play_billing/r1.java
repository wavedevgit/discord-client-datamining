...
final class r1 extends b0 implements RandomAccess, v1, c3 {
    ...
    private static final r1 f15043o = new r1(new int[0], 0, false);
    ...
    public final /* bridge */ /* synthetic */ x1 J(int i10) {
        if (i10 >= this.f15045i) {
            return new r1(Arrays.copyOf(this.f15044e, i10), this.f15045i, true);
        }
    ...
    public final /* synthetic */ void add(int i10, Object obj) {
        ...
        b();
        if (i10 >= 0 && i10 <= (i11 = this.f15045i)) {
            int i12 = i10 + 1;
            int[] iArr = this.f15044e;
            if (i11 < iArr.length) {
                System.arraycopy(iArr, i10, iArr, i12, i11 - i10);
            } else {
                int[] iArr2 = new int[((i11 * 3) / 2) + 1];
                System.arraycopy(iArr, 0, iArr2, 0, i10);
                System.arraycopy(this.f15044e, i10, iArr2, i12, this.f15045i - i10);
                this.f15044e = iArr2;
            }
            this.f15044e[i10] = intValue;
            this.f15045i++;
    ...
    public final boolean addAll(Collection collection) {
        ...
        if (Integer.MAX_VALUE - i11 >= i10) {
            ...
            int[] iArr = this.f15044e;
            if (i12 > iArr.length) {
                this.f15044e = Arrays.copyOf(iArr, i12);
            }
            System.arraycopy(r1Var.f15044e, 0, this.f15044e, this.f15045i, r1Var.f15045i);
            this.f15045i = i12;
            ((AbstractList) this).modCount++;
            return true;
        }
    ...
    public final void e(int i10) {
        ...
        int[] iArr3 = this.f15044e;
        int i12 = this.f15045i;
        this.f15045i = i12 + 1;
        iArr3[i12] = i10;
    }
    ...
    public final boolean equals(Object obj) {
        ...
        r1 r1Var = (r1) obj;
        if (this.f15045i != r1Var.f15045i) {
            return false;
        }
        int[] iArr = r1Var.f15044e;
        for (int i10 = 0; i10 < this.f15045i; i10++) {
            if (this.f15044e[i10] != iArr[i10]) {
                return false;
            }
        }
        return true;
    ...
    public final /* synthetic */ Object get(int i10) {
        g(i10);
        return Integer.valueOf(this.f15044e[i10]);
    }

    @Override // com.google.android.gms.internal.play_billing.b0, java.util.AbstractList, java.util.Collection, java.util.List
    public final int hashCode() {
        int i10 = 1;
        for (int i11 = 0; i11 < this.f15045i; i11++) {
            i10 = (i10 * 31) + this.f15044e[i11];
        }
        return i10;
    }
    ...
    protected final void removeRange(int i10, int i11) {
        ...
        if (i11 >= i10) {
            int[] iArr = this.f15044e;
            System.arraycopy(iArr, i11, iArr, i10, this.f15045i - i11);
            this.f15045i -= i11 - i10;
            ((AbstractList) this).modCount++;
            return;
        }
