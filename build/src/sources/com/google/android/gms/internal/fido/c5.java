...
public final class c5 extends l5 {
    ...
    public c5(e1 e1Var) {
        ...
        this.f14981d = e1Var;
        int i10 = 0;
        for (int i11 = 0; i11 < this.f14981d.size(); i11++) {
            int a10 = ((l5) this.f14981d.get(i11)).a();
            if (i10 < a10) {
                i10 = a10;
            }
        }
    ...
    public final /* bridge */ /* synthetic */ int compareTo(Object obj) {
        ...
        if (l5.e(ByteCompanionObject.MIN_VALUE) != l5Var.zza()) {
            ...
            c5 c5Var = (c5) l5Var;
            if (this.f14981d.size() != c5Var.f14981d.size()) {
                size = this.f14981d.size();
                size2 = c5Var.f14981d.size();
            } else {
                for (int i10 = 0; i10 < this.f14981d.size(); i10++) {
                    int compareTo = ((l5) this.f14981d.get(i10)).compareTo((l5) c5Var.f14981d.get(i10));
                    if (compareTo != 0) {
                        return compareTo;
                    }
                }
    ...
    public final boolean equals(Object obj) {
        ...
        return this.f14981d.equals(((c5) obj).f14981d);
    }

    public final int hashCode() {
        return Arrays.hashCode(new Object[]{Integer.valueOf(l5.e(ByteCompanionObject.MIN_VALUE)), this.f14981d});
    }

    public final String toString() {
        if (this.f14981d.isEmpty()) {
            return "[]";
        }
        ArrayList arrayList = new ArrayList();
        e1 e1Var = this.f14981d;
        int size = e1Var.size();
