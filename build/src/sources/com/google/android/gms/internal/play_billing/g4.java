...
abstract class g4 {
    ...
    private static final Unsafe f14335a;

    /* renamed from: b  reason: collision with root package name */
    private static final Class f14336b;

    /* renamed from: c  reason: collision with root package name */
    private static final boolean f14337c;

    /* renamed from: d  reason: collision with root package name */
    private static final f4 f14338d;

    /* renamed from: e  reason: collision with root package name */
    private static final boolean f14339e;

    /* renamed from: f  reason: collision with root package name */
    private static final boolean f14340f;

    /* renamed from: g  reason: collision with root package name */
    static final long f14341g;

    /* renamed from: h  reason: collision with root package name */
    static final boolean f14342h;
    ...
    private static int E(Class cls) {
        if (f14340f) {
            return f14338d.f14325a.arrayBaseOffset(cls);
        }
        return -1;
    }
    ...
    private static int a(Class cls) {
        if (f14340f) {
            return f14338d.f14325a.arrayIndexScale(cls);
        }
        return -1;
    }
    ...
    public static void d(Object obj, long j10, byte b10) {
        f4 f4Var = f14338d;
        long j11 = (-4) & j10;
        int i10 = f4Var.f14325a.getInt(obj, j11);
        int i11 = ((~((int) j10)) & 3) << 3;
        f4Var.f14325a.putInt(obj, j11, ((255 & b10) << i11) | (i10 & (~(SetSpanOperation.SPAN_MAX_PRIORITY << i11))));
    }
    ...
    public static void e(Object obj, long j10, byte b10) {
        ...
        long j11 = (-4) & j10;
        int i10 = (((int) j10) & 3) << 3;
        f4Var.f14325a.putInt(obj, j11, ((255 & b10) << i10) | (f4Var.f14325a.getInt(obj, j11) & (~(SetSpanOperation.SPAN_MAX_PRIORITY << i10))));
    }

    /* JADX INFO: Access modifiers changed from: package-private */
    public static double f(Object obj, long j10) {
        return f14338d.a(obj, j10);
    }

    /* JADX INFO: Access modifiers changed from: package-private */
    public static float g(Object obj, long j10) {
        return f14338d.b(obj, j10);
    }

    /* JADX INFO: Access modifiers changed from: package-private */
    public static int h(Object obj, long j10) {
        return f14338d.f14325a.getInt(obj, j10);
    }

    /* JADX INFO: Access modifiers changed from: package-private */
    public static long i(Object obj, long j10) {
        return f14338d.f14325a.getLong(obj, j10);
    }

    /* JADX INFO: Access modifiers changed from: package-private */
    public static Object j(Class cls) {
        try {
            return f14335a.allocateInstance(cls);
    ...
    public static Object k(Object obj, long j10) {
        return f14338d.f14325a.getObject(obj, j10);
    }
