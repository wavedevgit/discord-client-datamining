...
final class e3 extends b0 implements RandomAccess {
    ...
    private static final e3 f13820o = new e3(new Object[0], 0, false);
    ...
    private final String d(int i10) {
        int i11 = this.f13822i;
        return "Index:" + i10 + ", Size:" + i11;
    }

    private final void e(int i10) {
        if (i10 >= 0 && i10 < this.f13822i) {
            return;
        }
    ...
    public final /* bridge */ /* synthetic */ x1 F(int i10) {
        if (i10 >= this.f13822i) {
            return new e3(Arrays.copyOf(this.f13821e, i10), this.f13822i, true);
        }
    ...
    public final void add(int i10, Object obj) {
        int i11;
        b();
        if (i10 >= 0 && i10 <= (i11 = this.f13822i)) {
            int i12 = i10 + 1;
            Object[] objArr = this.f13821e;
            if (i11 < objArr.length) {
                System.arraycopy(objArr, i10, objArr, i12, i11 - i10);
            } else {
                Object[] objArr2 = new Object[((i11 * 3) / 2) + 1];
                System.arraycopy(objArr, 0, objArr2, 0, i10);
                System.arraycopy(this.f13821e, i10, objArr2, i12, this.f13822i - i10);
                this.f13821e = objArr2;
            }
            this.f13821e[i10] = obj;
            this.f13822i++;
    ...
    public final boolean add(Object obj) {
        ...
        if (i10 == objArr.length) {
            this.f13821e = Arrays.copyOf(objArr, ((i10 * 3) / 2) + 1);
        }
        Object[] objArr2 = this.f13821e;
        int i11 = this.f13822i;
        this.f13822i = i11 + 1;
        objArr2[i11] = obj;
        ((AbstractList) this).modCount++;
