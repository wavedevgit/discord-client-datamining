...
public final class d2 extends b0 implements RandomAccess, e2 {
    ...
    private static final d2 f14205i;

    /* renamed from: o  reason: collision with root package name */
    public static final e2 f14206o;

    /* renamed from: e  reason: collision with root package name */
    private final List f14207e;
    ...
    public final Object W(int i10) {
        return this.f14207e.get(i10);
    }

    @Override // java.util.AbstractList, java.util.List
    public final /* bridge */ /* synthetic */ void add(int i10, Object obj) {
        b();
        this.f14207e.add(i10, (String) obj);
    ...
    public final boolean addAll(int i10, Collection collection) {
        ...
        if (collection instanceof e2) {
            collection = ((e2) collection).m();
        }
        boolean addAll = this.f14207e.addAll(i10, collection);
        ((AbstractList) this).modCount++;
        return addAll;
    }
    ...
    public final String get(int i10) {
        Object obj = this.f14207e.get(i10);
        if (obj instanceof String) {
            return (String) obj;
        }
        if (obj instanceof r0) {
            r0 r0Var = (r0) obj;
            String o10 = r0Var.o(y1.f14402b);
            if (r0Var.i()) {
                this.f14207e.set(i10, o10);
            }
            return o10;
        }
        byte[] bArr = (byte[]) obj;
    ...
    public final /* bridge */ /* synthetic */ Object remove(int i10) {
        b();
        Object remove = this.f14207e.remove(i10);
        ((AbstractList) this).modCount++;
        return d(remove);
    }
    ...
    public final /* bridge */ /* synthetic */ Object set(int i10, Object obj) {
        b();
        return d(this.f14207e.set(i10, (String) obj));
    }
    ...
    private d2(boolean z10) {
        super(false);
        this.f14207e = Collections.EMPTY_LIST;
    }
