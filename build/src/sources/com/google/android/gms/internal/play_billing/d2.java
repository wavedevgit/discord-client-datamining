...
public final class d2 extends b0 implements RandomAccess, e2 {
    ...
    private static final d2 f15214i;

    /* renamed from: o  reason: collision with root package name */
    public static final e2 f15215o;
    ...
    public final Object V(int i10) {
        return this.f15216e.get(i10);
    }

    @Override // java.util.AbstractList, java.util.List
    public final /* bridge */ /* synthetic */ void add(int i10, Object obj) {
        b();
        this.f15216e.add(i10, (String) obj);
    ...
    public final boolean addAll(int i10, Collection collection) {
        ...
        if (collection instanceof e2) {
            collection = ((e2) collection).l();
        }
        boolean addAll = this.f15216e.addAll(i10, collection);
        ((AbstractList) this).modCount++;
        return addAll;
    }
    ...
    public final String get(int i10) {
        Object obj = this.f15216e.get(i10);
        if (obj instanceof String) {
            return (String) obj;
        }
        if (obj instanceof r0) {
            r0 r0Var = (r0) obj;
            String n10 = r0Var.n(y1.f15411b);
            if (r0Var.i()) {
                this.f15216e.set(i10, n10);
            }
            return n10;
        }
        byte[] bArr = (byte[]) obj;
    ...
    @Override // com.google.android.gms.internal.play_billing.e2
    public final List l() {
        return Collections.unmodifiableList(this.f15216e);
    }

    @Override // com.google.android.gms.internal.play_billing.b0, java.util.AbstractList, java.util.List
    public final /* bridge */ /* synthetic */ Object remove(int i10) {
        b();
        Object remove = this.f15216e.remove(i10);
        ((AbstractList) this).modCount++;
        return d(remove);
    }
    ...
    public final /* bridge */ /* synthetic */ Object set(int i10, Object obj) {
        b();
        return d(this.f15216e.set(i10, (String) obj));
    }

    @Override // java.util.AbstractCollection, java.util.Collection, java.util.List
    public final int size() {
        return this.f15216e.size();
    }
    ...
    private d2(boolean z10) {
        super(false);
        this.f15216e = Collections.EMPTY_LIST;
    }
