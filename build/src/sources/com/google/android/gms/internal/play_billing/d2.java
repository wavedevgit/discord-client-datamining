...
public final class d2 extends b0 implements RandomAccess, e2 {
    ...
    private static final d2 f14843i;

    /* renamed from: o  reason: collision with root package name */
    public static final e2 f14844o;

    /* renamed from: e  reason: collision with root package name */
    private final List f14845e;
    ...
    public final /* bridge */ /* synthetic */ void add(int i10, Object obj) {
        b();
        this.f14845e.add(i10, (String) obj);
    ...
    public final boolean addAll(int i10, Collection collection) {
        ...
        boolean addAll = this.f14845e.addAll(i10, collection);
        ((AbstractList) this).modCount++;
        return addAll;
    }
    ...
    public final String get(int i10) {
        Object obj = this.f14845e.get(i10);
        if (obj instanceof String) {
            return (String) obj;
        }
        if (obj instanceof r0) {
            r0 r0Var = (r0) obj;
            String n10 = r0Var.n(y1.f15040b);
            if (r0Var.i()) {
                this.f14845e.set(i10, n10);
            }
            return n10;
        }
        byte[] bArr = (byte[]) obj;
    ...
    @Override // com.google.android.gms.internal.play_billing.e2
    public final List l() {
        return Collections.unmodifiableList(this.f14845e);
    }

    @Override // com.google.android.gms.internal.play_billing.b0, java.util.AbstractList, java.util.List
    public final /* bridge */ /* synthetic */ Object remove(int i10) {
        b();
        Object remove = this.f14845e.remove(i10);
        ((AbstractList) this).modCount++;
        return d(remove);
    }
    ...
    public final /* bridge */ /* synthetic */ Object set(int i10, Object obj) {
        b();
        return d(this.f14845e.set(i10, (String) obj));
    }
    ...
    private d2(boolean z10) {
        super(false);
        this.f14845e = Collections.EMPTY_LIST;
    }
