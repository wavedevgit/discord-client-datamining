...
public abstract class e0 {
    ...
    public static int a(byte[] bArr, int i10, d0 d0Var) {
        ...
        int i11 = d0Var.f14880a;
        if (i11 >= 0) {
            if (i11 <= bArr.length - h10) {
                if (i11 == 0) {
                    d0Var.f14882c = r0.f15040e;
                    return h10;
                }
                d0Var.f14882c = r0.o(bArr, h10, i11);
                return h10 + i11;
            }
            throw a2.g();
        }
    ...
    public static int c(g3 g3Var, byte[] bArr, int i10, int i11, int i12, d0 d0Var) {
        Object h10 = g3Var.h();
        int l10 = l(h10, g3Var, bArr, i10, i11, i12, d0Var);
        g3Var.b(h10);
        d0Var.f14882c = h10;
        return l10;
    }
    ...
    static int d(g3 g3Var, byte[] bArr, int i10, int i11, d0 d0Var) {
        Object h10 = g3Var.h();
        int m10 = m(h10, g3Var, bArr, i10, i11, d0Var);
        g3Var.b(h10);
        d0Var.f14882c = h10;
        return m10;
    }
    ...
    public static int e(g3 g3Var, int i10, byte[] bArr, int i11, int i12, x1 x1Var, d0 d0Var) {
        ...
        x1Var.add(d0Var.f14882c);
        while (d10 < i12) {
            int h10 = h(bArr, d10, d0Var);
            if (i10 != d0Var.f14880a) {
                break;
            }
    ...
    public static int f(byte[] bArr, int i10, x1 x1Var, d0 d0Var) {
        r1 r1Var = (r1) x1Var;
        int h10 = h(bArr, i10, d0Var);
        int i11 = d0Var.f14880a + h10;
        while (h10 < i11) {
            h10 = h(bArr, h10, d0Var);
            r1Var.e(d0Var.f14880a);
        }
        if (h10 == i11) {
            return h10;
        }
        ...
        if ((i10 >>> 3) != 0) {
            ...
            if (i13 != 0) {
                if (i13 != 1) {
                    ...
                    int i16 = d0Var.f14880a;
                    if (i16 >= 0) {
                        if (i16 <= bArr.length - h11) {
                            if (i16 == 0) {
                                x3Var.j(i10, r0.f15040e);
                            } else {
                                x3Var.j(i10, r0.o(bArr, h11, i16));
                            }
                            return h11 + i16;
                        }
                        throw a2.g();
            ...
            x3Var.j(i10, Long.valueOf(d0Var.f14881b));
            return k10;
        }
        throw a2.b();
    }
