...
public abstract class e0 {
    ...
    public static int a(byte[] bArr, int i10, d0 d0Var) {
        ...
        int i11 = d0Var.f14879a;
        if (i11 >= 0) {
            if (i11 <= bArr.length - h10) {
                if (i11 == 0) {
                    d0Var.f14881c = r0.f15039e;
                    return h10;
                }
                d0Var.f14881c = r0.o(bArr, h10, i11);
                return h10 + i11;
            }
            throw a2.g();
        }
    ...
    public static int e(g3 g3Var, int i10, byte[] bArr, int i11, int i12, x1 x1Var, d0 d0Var) {
        ...
        x1Var.add(d0Var.f14881c);
        while (d10 < i12) {
            int h10 = h(bArr, d10, d0Var);
            if (i10 != d0Var.f14879a) {
                break;
            }
    ...
    public static int f(byte[] bArr, int i10, x1 x1Var, d0 d0Var) {
        r1 r1Var = (r1) x1Var;
        int h10 = h(bArr, i10, d0Var);
        int i11 = d0Var.f14879a + h10;
        while (h10 < i11) {
            h10 = h(bArr, h10, d0Var);
            r1Var.e(d0Var.f14879a);
        }
        if (h10 == i11) {
            return h10;
        }
        ...
        if ((i10 >>> 3) != 0) {
            ...
            if (i13 != 0) {
                if (i13 != 1) {
                    ...
                    int i16 = d0Var.f14879a;
                    if (i16 >= 0) {
                        if (i16 <= bArr.length - h11) {
                            if (i16 == 0) {
                                x3Var.j(i10, r0.f15039e);
                            } else {
            ...
            x3Var.j(i10, Long.valueOf(d0Var.f14880b));
            return k10;
        }
        throw a2.b();
    }
