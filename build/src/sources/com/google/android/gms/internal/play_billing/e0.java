...
public abstract class e0 {
    ...
    public static int a(byte[] bArr, int i10, d0 d0Var) {
        ...
        int i11 = d0Var.f13805a;
        if (i11 >= 0) {
            if (i11 <= bArr.length - h10) {
                if (i11 == 0) {
                    d0Var.f13807c = r0.f13965e;
                    return h10;
                }
                d0Var.f13807c = r0.m(bArr, h10, i11);
                return h10 + i11;
            }
            throw a2.g();
        }
    ...
    public static int e(g3 g3Var, int i10, byte[] bArr, int i11, int i12, x1 x1Var, d0 d0Var) {
        ...
        x1Var.add(d0Var.f13807c);
        while (d10 < i12) {
            int h10 = h(bArr, d10, d0Var);
            if (i10 != d0Var.f13805a) {
                break;
            }
    ...
    public static int f(byte[] bArr, int i10, x1 x1Var, d0 d0Var) {
        r1 r1Var = (r1) x1Var;
        int h10 = h(bArr, i10, d0Var);
        int i11 = d0Var.f13805a + h10;
        while (h10 < i11) {
            h10 = h(bArr, h10, d0Var);
            r1Var.e(d0Var.f13805a);
        }
        if (h10 == i11) {
            return h10;
        }
        ...
        if ((i10 >>> 3) != 0) {
            ...
            if (i13 != 0) {
                if (i13 != 1) {
                    ...
                    int i16 = d0Var.f13805a;
                    if (i16 >= 0) {
                        if (i16 <= bArr.length - h11) {
                            if (i16 == 0) {
                                x3Var.j(i10, r0.f13965e);
                            } else {
            ...
            x3Var.j(i10, Long.valueOf(d0Var.f13806b));
            return k10;
        }
        throw a2.b();
    }
