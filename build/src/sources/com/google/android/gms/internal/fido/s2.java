...
final class s2 extends t2 {
    ...
    final void a(Appendable appendable, byte[] bArr, int i10, int i11) {
        ...
        for (int i13 = i11; i13 >= 3; i13 -= 3) {
            ...
            appendable.append(this.f14081b.a(i14 >>> 18));
            appendable.append(this.f14081b.a((i14 >>> 12) & 63));
            appendable.append(this.f14081b.a((i14 >>> 6) & 63));
            appendable.append(this.f14081b.a(i14 & 63));
            i12 += 3;
        }
        if (i12 < i11) {
