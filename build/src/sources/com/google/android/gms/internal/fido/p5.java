...
final class p5 {
    ...
    private final Deque f14187a = new ArrayDeque(16);
    ...
    private final long h() {
        ...
        return ((Long) this.f14187a.peek()).longValue();
    }

    private final void i(long j10) {
        this.f14187a.pop();
        this.f14187a.push(Long.valueOf(j10));
    }
    ...
    public final void b() {
        ...
        throw new IOException(String.format("data item not completed, stackSize: %s scope: %s", Integer.valueOf(this.f14187a.size()), Long.valueOf(h())));
    }
