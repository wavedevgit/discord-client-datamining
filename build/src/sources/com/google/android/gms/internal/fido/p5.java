...
final class p5 {
    ...
    private final Deque f14764a = new ArrayDeque(16);
    ...
    private final long h() {
        ...
        return ((Long) this.f14764a.peek()).longValue();
    }

    private final void i(long j10) {
        this.f14764a.pop();
        this.f14764a.push(Long.valueOf(j10));
    }
    ...
    public final void b() {
        ...
        throw new IOException(String.format("data item not completed, stackSize: %s scope: %s", Integer.valueOf(this.f14764a.size()), Long.valueOf(h())));
    }
