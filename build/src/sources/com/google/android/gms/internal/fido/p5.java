...
final class p5 {
    ...
    private final Deque f14765a = new ArrayDeque(16);
    ...
    private final long h() {
        ...
        return ((Long) this.f14765a.peek()).longValue();
    }

    private final void i(long j10) {
        this.f14765a.pop();
        this.f14765a.push(Long.valueOf(j10));
    }
    ...
    public final void b() {
        ...
        throw new IOException(String.format("data item not completed, stackSize: %s scope: %s", Integer.valueOf(this.f14765a.size()), Long.valueOf(h())));
    }
