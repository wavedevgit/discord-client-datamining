...
final class r2 extends t2 {
    ...
    private r2(q2 q2Var) {
        super(q2Var, null);
        char[] cArr;
        this.f14783e = new char[IntBufferBatchMountItem.INSTRUCTION_UPDATE_PADDING];
        cArr = q2Var.f14771b;
        k0.c(cArr.length == 16);
        for (int i10 = 0; i10 < 256; i10++) {
            this.f14783e[i10] = q2Var.a(i10 >>> 4);
            this.f14783e[i10 | IntBufferBatchMountItem.INSTRUCTION_UPDATE_EVENT_EMITTER] = q2Var.a(i10 & 15);
        }
    }
    ...
    final void a(Appendable appendable, byte[] bArr, int i10, int i11) {
        ...
        for (int i12 = 0; i12 < i11; i12++) {
            ...
            appendable.append(this.f14783e[i13]);
            appendable.append(this.f14783e[i13 | IntBufferBatchMountItem.INSTRUCTION_UPDATE_EVENT_EMITTER]);
        }
    }
