...
public abstract class z0 extends g0 {
    ...
    private static final Logger f14526b = Logger.getLogger(z0.class.getName());

    /* renamed from: c  reason: collision with root package name */
    private static final boolean f14527c = g4.C();
    ...
    public static int v(String str) {
        ...
        try {
            ...
            length = str.getBytes(y1.f14505b).length;
        }
    ...
    public final void a(String str, k4 k4Var) {
        f14526b.logp(Level.WARNING, "com.google.protobuf.CodedOutputStream", "inefficientWriteStringNoTag", "Converting ill-formed UTF-16. Your Protocol Buffer will not round trip correctly!", (Throwable) k4Var);
        byte[] bytes = str.getBytes(y1.f14505b);
        try {
