...
public final class w0 extends z0 {
    ...
    public final void A(byte[] bArr, int i10, int i11) {
        try {
            System.arraycopy(bArr, 0, this.f15072d, this.f15074f, i11);
            this.f15074f += i11;
        } catch (IndexOutOfBoundsException e10) {
            throw new x0(String.format("Pos: %d, limit: %d, len: %d", Integer.valueOf(this.f15074f), Integer.valueOf(this.f15073e), Integer.valueOf(i11)), e10);
        }
    }
    ...
    public final void B(String str) {
        ...
        try {
            ...
            if (w11 == w10) {
                int i11 = i10 + w11;
                this.f15074f = i11;
                int b10 = l4.b(str, this.f15072d, i11, this.f15073e - i11);
                this.f15074f = i10;
                q((b10 - i10) - w11);
                this.f15074f = b10;
                return;
            ...
            int i12 = this.f15074f;
            this.f15074f = l4.b(str, bArr, i12, this.f15073e - i12);
        } catch (k4 e10) {
            this.f15074f = i10;
            a(str, e10);
    ...
    public final int c() {
        return this.f15073e - this.f15074f;
    }
    ...
    public final void d(byte b10) {
        try {
            ...
            throw new x0(String.format("Pos: %d, limit: %d, len: %d", Integer.valueOf(this.f15074f), Integer.valueOf(this.f15073e), 1), e10);
        }
    }
    ...
    public final void s(long j10) {
        boolean z10;
        z10 = z0.f15105c;
        if (!z10 || this.f15073e - this.f15074f < 10) {
            while ((j10 & (-128)) != 0) {
                try {
                    byte[] bArr = this.f15072d;
                    int i10 = this.f15074f;
        ...
        while (true) {
            int i12 = (int) j10;
            if ((j10 & (-128)) == 0) {
                byte[] bArr3 = this.f15072d;
                int i13 = this.f15074f;
                this.f15074f = i13 + 1;
                g4.s(bArr3, i13, (byte) i12);
                return;
            }
            byte[] bArr4 = this.f15072d;
