...
public final class w0 extends z0 {
    ...
    public final void A(byte[] bArr, int i10, int i11) {
        try {
            System.arraycopy(bArr, 0, this.f14354d, this.f14356f, i11);
            this.f14356f += i11;
        } catch (IndexOutOfBoundsException e10) {
            throw new x0(String.format("Pos: %d, limit: %d, len: %d", Integer.valueOf(this.f14356f), Integer.valueOf(this.f14355e), Integer.valueOf(i11)), e10);
        }
    }
    ...
    public final void B(String str) {
        ...
        try {
            ...
            if (w11 == w10) {
                int i11 = i10 + w11;
                this.f14356f = i11;
                int b10 = l4.b(str, this.f14354d, i11, this.f14355e - i11);
                this.f14356f = i10;
                q((b10 - i10) - w11);
                this.f14356f = b10;
                return;
            ...
            this.f14356f = l4.b(str, bArr, i12, this.f14355e - i12);
        } catch (k4 e10) {
            this.f14356f = i10;
            a(str, e10);
    ...
    public final int c() {
        return this.f14355e - this.f14356f;
    }
    ...
    public final void d(byte b10) {
        try {
            ...
            throw new x0(String.format("Pos: %d, limit: %d, len: %d", Integer.valueOf(this.f14356f), Integer.valueOf(this.f14355e), 1), e10);
        }
    }
    ...
    public final void s(long j10) {
        boolean z10;
        z10 = z0.f14387c;
        if (!z10 || this.f14355e - this.f14356f < 10) {
            while ((j10 & (-128)) != 0) {
                try {
                    byte[] bArr = this.f14354d;
                    int i10 = this.f14356f;
        ...
        while (true) {
            int i12 = (int) j10;
            if ((j10 & (-128)) == 0) {
                byte[] bArr3 = this.f14354d;
                int i13 = this.f14356f;
                this.f14356f = i13 + 1;
                g4.s(bArr3, i13, (byte) i12);
                return;
            }
            byte[] bArr4 = this.f14354d;
            int i14 = this.f14356f;
            this.f14356f = i14 + 1;
