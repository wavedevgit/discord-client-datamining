...
final class a extends c {
    ...
    final SideSheetBehavior f15303a;

    /* JADX INFO: Access modifiers changed from: package-private */
    public a(SideSheetBehavior sideSheetBehavior) {
        this.f15303a = sideSheetBehavior;
    }
    ...
    @Override // com.google.android.material.sidesheet.c
    public int d() {
        return Math.max(0, this.f15303a.m0() + this.f15303a.k0());
    }

    /* JADX INFO: Access modifiers changed from: package-private */
    @Override // com.google.android.material.sidesheet.c
    public int e() {
        return (-this.f15303a.d0()) - this.f15303a.k0();
    }

    /* JADX INFO: Access modifiers changed from: package-private */
    @Override // com.google.android.material.sidesheet.c
    public int f() {
        return this.f15303a.k0();
    }

    /* JADX INFO: Access modifiers changed from: package-private */
    @Override // com.google.android.material.sidesheet.c
    public int g() {
        return -this.f15303a.d0();
    }

    /* JADX INFO: Access modifiers changed from: package-private */
    @Override // com.google.android.material.sidesheet.c
    public int h(View view) {
        return view.getRight() + this.f15303a.k0();
    }
    ...
    public boolean m(float f10, float f11) {
        if (d.a(f10, f11) && Math.abs(f10) > this.f15303a.o0()) {
            return true;
        }
        return false;
    }
    ...
    public boolean n(View view, float f10) {
        if (Math.abs(view.getLeft() + (f10 * this.f15303a.i0())) > this.f15303a.j0()) {
            return true;
        }
        return false;
    }
