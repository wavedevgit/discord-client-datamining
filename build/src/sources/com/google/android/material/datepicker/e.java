...
abstract class e {
    ...
    public static String a(Context context, long j10, boolean z10, boolean z11, boolean z12) {
        String d10 = d(j10);
        if (z10) {
            d10 = String.format(context.getString(zg.i.f55695q), d10);
        }
        if (z11) {
            return String.format(context.getString(zg.i.f55694p), d10);
        }
        if (z12) {
            return String.format(context.getString(zg.i.f55691m), d10);
        }
        return d10;
    }
    ...
    public static String e(Context context, int i10) {
        if (t.g().get(1) == i10) {
            return String.format(context.getString(zg.i.f55692n), Integer.valueOf(i10));
        }
        return String.format(context.getString(zg.i.f55693o), Integer.valueOf(i10));
    }
