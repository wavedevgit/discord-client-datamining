...
abstract class b {
    ...
    public class a extends b {
        ...
        int d() {
            return this.f15507b.getHeight();
        }

        @Override // com.google.android.material.carousel.b
        int e() {
            return this.f15507b.getPaddingLeft();
        }

        @Override // com.google.android.material.carousel.b
        int f() {
            return this.f15507b.getWidth() - this.f15507b.getPaddingRight();
        }
        ...
        public void i(View view, int i10, int i11) {
            int e10 = e();
            this.f15507b.layoutDecoratedWithMargins(view, e10, i10, e10 + k(view), i11);
        }
        ...
        int k(View view) {
            ...
            return this.f15507b.getDecoratedMeasuredWidth(view) + ((ViewGroup.MarginLayoutParams) layoutParams).leftMargin + ((ViewGroup.MarginLayoutParams) layoutParams).rightMargin;
        }
    }
    ...
    public class C0178b extends b {
        ...
        /* renamed from: b  reason: collision with root package name */
        final /* synthetic */ CarouselLayoutManager f15508b;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        C0178b(int i10, CarouselLayoutManager carouselLayoutManager) {
            super(i10, null);
            this.f15508b = carouselLayoutManager;
        }

        @Override // com.google.android.material.carousel.b
        int d() {
            return this.f15508b.getHeight() - this.f15508b.getPaddingBottom();
        }
        ...
        @Override // com.google.android.material.carousel.b
        int h() {
            return this.f15508b.getPaddingTop();
        }

        @Override // com.google.android.material.carousel.b
        public void i(View view, int i10, int i11) {
            int h10 = h();
            this.f15508b.layoutDecoratedWithMargins(view, i10, h10, i11, h10 + k(view));
        }
        ...
        int k(View view) {
            RecyclerView.LayoutParams layoutParams = (RecyclerView.LayoutParams) view.getLayoutParams();
            return this.f15508b.getDecoratedMeasuredHeight(view) + ((ViewGroup.MarginLayoutParams) layoutParams).topMargin + ((ViewGroup.MarginLayoutParams) layoutParams).bottomMargin;
        }
    }
