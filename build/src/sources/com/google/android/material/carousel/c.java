...
abstract class c {
    ...
    public class a extends c {
        ...
        final /* synthetic */ CarouselLayoutManager f15789b;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        a(int i10, CarouselLayoutManager carouselLayoutManager) {
            super(i10, null);
            this.f15789b = carouselLayoutManager;
        }
        ...
        @Override // com.google.android.material.carousel.c
        int g() {
            return this.f15789b.getPaddingLeft();
        }

        @Override // com.google.android.material.carousel.c
        int h() {
            return this.f15789b.getWidth() - this.f15789b.getPaddingRight();
        }
        ...
        public void k(View view, int i10, int i11) {
            int g10 = g();
            this.f15789b.layoutDecoratedWithMargins(view, g10, i10, g10 + m(view), i11);
        }
        ...
        int m(View view) {
            ...
            return this.f15789b.getDecoratedMeasuredWidth(view) + ((ViewGroup.MarginLayoutParams) layoutParams).leftMargin + ((ViewGroup.MarginLayoutParams) layoutParams).rightMargin;
        }
    }
    ...
    public class b extends c {
        ...
        /* renamed from: b  reason: collision with root package name */
        final /* synthetic */ CarouselLayoutManager f15790b;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        b(int i10, CarouselLayoutManager carouselLayoutManager) {
            super(i10, null);
            this.f15790b = carouselLayoutManager;
        }
        ...
        @Override // com.google.android.material.carousel.c
        int e() {
            return this.f15790b.getHeight() - this.f15790b.getPaddingBottom();
        }
        ...
        @Override // com.google.android.material.carousel.c
        int j() {
            return this.f15790b.getPaddingTop();
        }

        @Override // com.google.android.material.carousel.c
        public void k(View view, int i10, int i11) {
            int j10 = j();
            this.f15790b.layoutDecoratedWithMargins(view, i10, j10, i11, j10 + m(view));
        }
        ...
        int m(View view) {
            RecyclerView.LayoutParams layoutParams = (RecyclerView.LayoutParams) view.getLayoutParams();
            return this.f15790b.getDecoratedMeasuredHeight(view) + ((ViewGroup.MarginLayoutParams) layoutParams).topMargin + ((ViewGroup.MarginLayoutParams) layoutParams).bottomMargin;
        }
    }
