...
public final class h extends d {
    ...
    private static final int[] f14812d = {1};

    /* renamed from: e  reason: collision with root package name */
    private static final int[] f14813e = {1, 0};

    /* renamed from: c  reason: collision with root package name */
    private int f14814c = 0;
    ...
    public f g(b bVar, View view) {
        ...
        if (i(c10, bVar.getItemCount())) {
            c10 = a.c(f10, a10, d10, max, new int[]{c10.f14773c}, f13, new int[]{c10.f14774d}, min, new int[]{c10.f14777g});
        }
    ...
    public boolean h(b bVar, int i10) {
        if (i10 >= this.f14814c || bVar.getItemCount() < this.f14814c) {
            if (i10 >= this.f14814c && bVar.getItemCount() < this.f14814c) {
                return true;
            }
            return false;
    ...
    boolean i(a aVar, int i10) {
        boolean z10;
        int e10 = aVar.e() - i10;
        if (e10 > 0 && (aVar.f14773c > 0 || aVar.f14774d > 1)) {
            z10 = true;
        } else {
            z10 = false;
        }
        while (e10 > 0) {
            int i11 = aVar.f14773c;
            if (i11 > 0) {
                aVar.f14773c = i11 - 1;
            } else {
                int i12 = aVar.f14774d;
                if (i12 > 1) {
                    aVar.f14774d = i12 - 1;
                }
            }
