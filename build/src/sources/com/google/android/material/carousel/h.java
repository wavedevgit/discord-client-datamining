...
public final class h extends d {
    ...
    private static final int[] f15821d = {1};

    /* renamed from: e  reason: collision with root package name */
    private static final int[] f15822e = {1, 0};
    ...
    public f g(b bVar, View view) {
        ...
        if (i(c10, bVar.getItemCount())) {
            c10 = a.c(f10, a10, d10, max, new int[]{c10.f15782c}, f13, new int[]{c10.f15783d}, min, new int[]{c10.f15786g});
        }
    ...
    public boolean h(b bVar, int i10) {
        if (i10 >= this.f15823c || bVar.getItemCount() < this.f15823c) {
            if (i10 >= this.f15823c && bVar.getItemCount() < this.f15823c) {
                return true;
            }
            return false;
    ...
    boolean i(a aVar, int i10) {
        boolean z10;
        int e10 = aVar.e() - i10;
        if (e10 > 0 && (aVar.f15782c > 0 || aVar.f15783d > 1)) {
            z10 = true;
        } else {
            z10 = false;
        }
        while (e10 > 0) {
            int i11 = aVar.f15782c;
            if (i11 > 0) {
                aVar.f15782c = i11 - 1;
            } else {
                int i12 = aVar.f15783d;
                if (i12 > 1) {
                    aVar.f15783d = i12 - 1;
                }
            }
