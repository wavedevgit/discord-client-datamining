...
abstract class c extends e {
    ...
    private Runnable f15522o;

    /* renamed from: p  reason: collision with root package name */
    OverScroller f15523p;
    ...
    private VelocityTracker f15528u;
    ...
    public class a implements Runnable {
        ...
        private final CoordinatorLayout f15529d;

        /* renamed from: e  reason: collision with root package name */
        private final View f15530e;

        a(CoordinatorLayout coordinatorLayout, View view) {
            this.f15529d = coordinatorLayout;
            this.f15530e = view;
        }
        ...
        public void run() {
            ...
            if (this.f15530e != null && (overScroller = c.this.f15523p) != null) {
                if (overScroller.computeScrollOffset()) {
                    c cVar = c.this;
                    cVar.T(this.f15529d, this.f15530e, cVar.f15523p.getCurrY());
                    h0.f0(this.f15530e, this);
                    return;
                }
                c.this.R(this.f15529d, this.f15530e);
            }
        }
    }
    ...
    private void M() {
        if (this.f15528u == null) {
            this.f15528u = VelocityTracker.obtain();
        }
    }
    ...
    */
    public boolean H(androidx.coordinatorlayout.widget.CoordinatorLayout r10, android.view.View r11, android.view.MotionEvent r12) {
        ...
        L4b:
            ...
            goto L80
        L4d:
            android.view.VelocityTracker r1 = r9.f15528u
            if (r1 == 0) goto L71
            r1.addMovement(r12)
            android.view.VelocityTracker r1 = r9.f15528u
        ...
        L72:
            r9.f15524q = r7
            r9.f15525r = r6
            android.view.VelocityTracker r2 = r9.f15528u
            if (r2 == 0) goto L80
            r2.recycle()
            r2 = 0
            r9.f15528u = r2
    ...
    final boolean N(CoordinatorLayout coordinatorLayout, View view, int i10, int i11, float f10) {
        Runnable runnable = this.f15522o;
        if (runnable != null) {
            view.removeCallbacks(runnable);
            this.f15522o = null;
        }
        if (this.f15523p == null) {
            this.f15523p = new OverScroller(view.getContext());
        }
        this.f15523p.fling(0, I(), 0, Math.round(f10), 0, 0, i10, i11);
        if (this.f15523p.computeScrollOffset()) {
    ...
    public boolean o(CoordinatorLayout coordinatorLayout, View view, MotionEvent motionEvent) {
        ...
        if (this.f15527t < 0) {
            this.f15527t = ViewConfiguration.get(coordinatorLayout.getContext()).getScaledTouchSlop();
        }
        if (motionEvent.getActionMasked() == 2 && this.f15524q) {
            int i10 = this.f15525r;
            if (i10 == -1 || (findPointerIndex = motionEvent.findPointerIndex(i10)) == -1) {
                return false;
            }
            int y10 = (int) motionEvent.getY(findPointerIndex);
            if (Math.abs(y10 - this.f15526s) > this.f15527t) {
                this.f15526s = y10;
                return true;
            }
        }
        if (motionEvent.getActionMasked() == 0) {
            ...
            if (z10) {
                this.f15526s = y11;
                this.f15525r = motionEvent.getPointerId(0);
                M();
                OverScroller overScroller = this.f15523p;
                if (overScroller != null && !overScroller.isFinished()) {
                    this.f15523p.abortAnimation();
                    return true;
                }
            }
        }
        VelocityTracker velocityTracker = this.f15528u;
