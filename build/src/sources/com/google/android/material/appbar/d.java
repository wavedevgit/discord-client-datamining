...
abstract class d extends e {
    ...
    public d() {
        this.f15532o = new Rect();
        this.f15533p = new Rect();
        this.f15534q = 0;
    }
    ...
    public void J(CoordinatorLayout coordinatorLayout, View view, int i10) {
        ...
        if (L != null) {
            ...
            Rect rect2 = this.f15533p;
            j.a(R(fVar.f2850c), view.getMeasuredWidth(), view.getMeasuredHeight(), rect, rect2, i10);
            int M = M(L);
            view.layout(rect2.left, rect2.top - M, rect2.right, rect2.bottom - M);
            this.f15534q = rect2.top - L.getBottom();
            return;
        }
