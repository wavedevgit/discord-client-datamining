...
abstract class g {
    ...
    public static void b(View view, float f10) {
        int integer = view.getResources().getInteger(yg.g.f54196a);
        StateListAnimator stateListAnimator = new StateListAnimator();
        long j10 = integer;
        stateListAnimator.addState(new int[]{16842910, yg.b.f54086d0, -yg.b.f54088e0}, ObjectAnimator.ofFloat(view, ViewProps.ELEVATION, 0.0f).setDuration(j10));
