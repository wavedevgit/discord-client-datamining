...
abstract class g {
    ...
    private static final int[] f14143a = {16843848};
    ...
    public static void b(View view, float f10) {
        int integer = view.getResources().getInteger(yg.g.f54193a);
        StateListAnimator stateListAnimator = new StateListAnimator();
        long j10 = integer;
        stateListAnimator.addState(new int[]{16842910, yg.b.f54083d0, -yg.b.f54085e0}, ObjectAnimator.ofFloat(view, ViewProps.ELEVATION, 0.0f).setDuration(j10));
    ...
    public static void c(View view, AttributeSet attributeSet, int i10, int i11) {
        ...
        TypedArray i12 = l.i(context, attributeSet, f14143a, i10, i11, new int[0]);
        try {
            if (i12.hasValue(0)) {
