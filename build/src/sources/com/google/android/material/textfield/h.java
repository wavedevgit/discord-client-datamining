...
public abstract class h extends oh.g {
    ...
    public static class c extends h {
        ...
        public void r(Canvas canvas) {
            if (this.K.f16489w.isEmpty()) {
                super.r(canvas);
                return;
            }
            canvas.save();
            if (Build.VERSION.SDK_INT >= 26) {
                canvas.clipOutRect(this.K.f16489w);
            } else {
                canvas.clipRect(this.K.f16489w, Region.Op.DIFFERENCE);
            }
            super.r(canvas);
            canvas.restore();
        }
    ...
    void p0(float f10, float f11, float f12, float f13) {
        if (f10 == this.K.f16489w.left && f11 == this.K.f16489w.top && f12 == this.K.f16489w.right && f13 == this.K.f16489w.bottom) {
            return;
        }
        this.K.f16489w.set(f10, f11, f12, f13);
        invalidateSelf();
    }
