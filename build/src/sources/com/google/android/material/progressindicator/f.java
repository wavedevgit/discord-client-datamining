...
public final class f extends b {
    ...
    public f(Context context, AttributeSet attributeSet, int i10, int i11) {
        ...
        this.f16127o = i12.getInt(l.E1, 0);
        this.f16128p = Math.max(qh.c.d(context, i12, l.I1, dimensionPixelSize), this.f16071a * 2);
        this.f16129q = qh.c.d(context, i12, l.H1, dimensionPixelSize2);
        this.f16130r = i12.getInt(l.G1, 0);
        this.f16131s = i12.getBoolean(l.F1, true);
        i12.recycle();
        h();
    }
}
