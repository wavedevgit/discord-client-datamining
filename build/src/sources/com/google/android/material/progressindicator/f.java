...
public final class f extends g {
    ...
    public void draw(Canvas canvas) {
        ...
        if (!getBounds().isEmpty() && isVisible() && canvas.getClipBounds(rect)) {
            ...
            this.f14891x.setStyle(Paint.Style.FILL);
            this.f14891x.setAntiAlias(true);
            h.a aVar = this.D;
            b bVar = this.f14880e;
            aVar.f14898c = bVar.f14850c[0];
            int i10 = bVar.f14854g;
            if (i10 > 0) {
                this.A.d(canvas, this.f14891x, x(), 1.0f, this.f14880e.f14851d, getAlpha(), (int) ((i10 * u1.a.a(x(), 0.0f, 0.01f)) / 0.01f));
            } else {
                this.A.d(canvas, this.f14891x, 0.0f, 1.0f, bVar.f14851d, getAlpha(), 0);
            }
            this.A.c(canvas, this.f14891x, this.D, getAlpha());
            this.A.b(canvas, this.f14891x, this.f14880e.f14850c[0], getAlpha());
            canvas.restore();
        }
    }
