...
public class FabTransformationSheetBehavior extends FabTransformationBehavior {
    ...
    private void f0(View view, boolean z10) {
        ...
        if (parent instanceof CoordinatorLayout) {
            ...
            if (z10) {
                this.f15267t = new HashMap(childCount);
            }
            for (int i10 = 0; i10 < childCount; i10++) {
                ...
                if (childAt != view && !z11) {
                    if (!z10) {
                        Map map = this.f15267t;
                        if (map != null && map.containsKey(childAt)) {
                            h0.x0(childAt, ((Integer) this.f15267t.get(childAt)).intValue());
                        }
                    } else {
                        this.f15267t.put(childAt, Integer.valueOf(childAt.getImportantForAccessibility()));
                        h0.x0(childAt, 4);
                    }
                }
            }
    ...
    protected FabTransformationBehavior.b d0(Context context, boolean z10) {
        ...
        bVar.f15260a = g.c(context, i10);
        bVar.f15261b = new i(17, 0.0f, 0.0f);
        return bVar;
    }
