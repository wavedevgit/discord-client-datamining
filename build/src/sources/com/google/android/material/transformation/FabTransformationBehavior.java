...
public abstract class FabTransformationBehavior extends ExpandableTransformationBehavior {
    ...
    private final Rect f15764i;

    /* renamed from: o  reason: collision with root package name */
    private final RectF f15765o;

    /* renamed from: p  reason: collision with root package name */
    private final RectF f15766p;
    ...
    class a extends AnimatorListenerAdapter {
        ...
        final /* synthetic */ boolean f15770a;

        /* renamed from: b  reason: collision with root package name */
        final /* synthetic */ View f15771b;

        /* renamed from: c  reason: collision with root package name */
        final /* synthetic */ View f15772c;
    ...
    public FabTransformationBehavior() {
        this.f15764i = new Rect();
        this.f15765o = new RectF();
        this.f15766p = new RectF();
        this.f15767q = new int[2];
    }
    ...
    private void P(View view, b bVar, h hVar, h hVar2, float f10, float f11, float f12, float f13, RectF rectF) {
        ...
        Rect rect = this.f15764i;
        view.getWindowVisibleDisplayFrame(rect);
        RectF rectF2 = this.f15765o;
        rectF2.set(rect);
        RectF rectF3 = this.f15766p;
        V(view, rectF3);
        rectF3.offset(U, U2);
    ...
    private void Q(View view, RectF rectF) {
        V(view, rectF);
        rectF.offset(this.f15768r, this.f15769s);
    }
    ...
    private Pair R(float f10, float f11, boolean z10, b bVar) {
        ...
        if (f10 != 0.0f && f11 != 0.0f) {
            if ((z10 && f11 < 0.0f) || (!z10 && i10 > 0)) {
                e10 = bVar.f15774a.e("translationXCurveUpwards");
                e11 = bVar.f15774a.e("translationYCurveUpwards");
            } else {
                e10 = bVar.f15774a.e("translationXCurveDownwards");
                e11 = bVar.f15774a.e("translationYCurveDownwards");
            }
        } else {
            e10 = bVar.f15774a.e("translationXLinear");
            e11 = bVar.f15774a.e("translationYLinear");
        }
    ...
    private float S(View view, View view2, i iVar) {
        ...
        float centerX2;
        float f10;
        RectF rectF = this.f15765o;
        RectF rectF2 = this.f15766p;
        Q(view, rectF);
        V(view2, rectF2);
        int i10 = iVar.f7613a & 7;
        if (i10 != 1) {
            if (i10 != 3) {
                if (i10 != 5) {
                    f10 = 0.0f;
                    return f10 + iVar.f7614b;
                }
    ...
    private float T(View view, View view2, i iVar) {
        ...
        Q(view, rectF);
        V(view2, rectF2);
        int i10 = iVar.f7613a & 112;
        if (i10 != 16) {
            if (i10 != 48) {
                if (i10 != 80) {
                    f10 = 0.0f;
                    return f10 + iVar.f7615c;
                }
    ...
    private float U(b bVar, h hVar, float f10, float f11) {
        long c10 = hVar.c();
        long d10 = hVar.d();
        h e10 = bVar.f15774a.e("expansion");
    ...
    private void W(View view, View view2, boolean z10, boolean z11, b bVar, List list, List list2) {
        ...
        if (z10) {
            if (!z11) {
                d.f7601a.set(O, Float.valueOf(0.0f));
            }
            ofFloat = ObjectAnimator.ofFloat(O, d.f7601a, 1.0f);
        } else {
            ofFloat = ObjectAnimator.ofFloat(O, d.f7601a, 0.0f);
        }
        bVar.f15774a.e("contentFade").a(ofFloat);
        list.add(ofFloat);
    }
    ...
    private void Y(View view, View view2, boolean z10, b bVar, List list) {
        float S = S(view, view2, bVar.f15775b);
        float T = T(view, view2, bVar.f15775b);
    ...
    private void Z(View view, View view2, boolean z10, boolean z11, b bVar, List list, List list2) {
        ...
        bVar.f15774a.e(ViewProps.ELEVATION).a(ofFloat);
        list.add(ofFloat);
    }
    ...
    protected AnimatorSet N(View view, View view2, boolean z10, boolean z11) {
        ...
        if (z10) {
            this.f15768r = view.getTranslationX();
            this.f15769s = view.getTranslationY();
        }
