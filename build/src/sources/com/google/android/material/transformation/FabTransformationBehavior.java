...
public abstract class FabTransformationBehavior extends ExpandableTransformationBehavior {
    ...
    private float S(View view, View view2, i iVar) {
        ...
        Q(view, rectF);
        V(view2, rectF2);
        int i10 = iVar.f55676a & 7;
        if (i10 != 1) {
            if (i10 != 3) {
                if (i10 != 5) {
                    f10 = 0.0f;
                    return f10 + iVar.f55677b;
                }
    ...
    private float T(View view, View view2, i iVar) {
        ...
        Q(view, rectF);
        V(view2, rectF2);
        int i10 = iVar.f55676a & 112;
        if (i10 != 16) {
            if (i10 != 48) {
                if (i10 != 80) {
                    f10 = 0.0f;
                    return f10 + iVar.f55678c;
                }
    ...
    private void W(View view, View view2, boolean z10, boolean z11, b bVar, List list, List list2) {
        ...
        if (z10) {
            if (!z11) {
                d.f55664a.set(O, Float.valueOf(0.0f));
            }
            ofFloat = ObjectAnimator.ofFloat(O, d.f55664a, 1.0f);
        } else {
            ofFloat = ObjectAnimator.ofFloat(O, d.f55664a, 0.0f);
        }
