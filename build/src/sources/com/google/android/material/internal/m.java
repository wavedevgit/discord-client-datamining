...
public abstract class m {
    ...
    private static void b(Context context, AttributeSet attributeSet, int i10, int i11) {
        TypedArray obtainStyledAttributes = context.obtainStyledAttributes(attributeSet, bh.l.f7061k8, i10, i11);
        boolean z10 = obtainStyledAttributes.getBoolean(bh.l.f7081m8, false);
        obtainStyledAttributes.recycle();
        if (z10) {
            TypedValue typedValue = new TypedValue();
            if (!context.getTheme().resolveAttribute(bh.b.f6761x, typedValue, true) || (typedValue.type == 18 && typedValue.data == 0)) {
                c(context);
            }
        }
        a(context);
    ...
    private static void d(Context context, AttributeSet attributeSet, int[] iArr, int i10, int i11, int... iArr2) {
        ...
        TypedArray obtainStyledAttributes = context.obtainStyledAttributes(attributeSet, bh.l.f7061k8, i10, i11);
        boolean z11 = false;
        if (!obtainStyledAttributes.getBoolean(bh.l.f7091n8, false)) {
            obtainStyledAttributes.recycle();
            return;
        }
        if (iArr2 != null && iArr2.length != 0) {
            ...
            if (obtainStyledAttributes.getResourceId(bh.l.f7071l8, -1) != -1) {
                z11 = true;
            }
            z10 = z11;
        }
    ...
    public static boolean g(Context context) {
        return qh.b.b(context, bh.b.f6760w, false);
    }
