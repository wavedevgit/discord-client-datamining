...
public class CheckableImageButton extends androidx.appcompat.widget.l implements Checkable {
    ...
    private static final int[] f15227r = {16842912};
    ...
    public static class b extends u2.a {
        ...
        public void writeToParcel(Parcel parcel, int i10) {
            ...
            parcel.writeInt(this.f15232i ? 1 : 0);
        }
    ...
    protected void onRestoreInstanceState(Parcelable parcelable) {
        ...
        setChecked(bVar.f15232i);
    }

    @Override // android.view.View
    protected Parcelable onSaveInstanceState() {
        b bVar = new b(super.onSaveInstanceState());
        bVar.f15232i = this.f15228o;
        return bVar;
    }
    ...
    public void setChecked(boolean z10) {
        if (this.f15229p && this.f15228o != z10) {
            this.f15228o = z10;
