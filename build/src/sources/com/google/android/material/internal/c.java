...
public abstract class c {
    public static void a(Window window, boolean z10, Integer num, Integer num2) {
        ...
        if (z11 || z12) {
            int b10 = jh.a.b(window.getContext(), 16842801, -16777216);
            if (z11) {
        ...
        f(window, d(c10, jh.a.h(num.intValue())));
        e(window, d(b11, jh.a.h(num2.intValue())));
    }

    private static int b(Context context, boolean z10) {
        if (z10 && Build.VERSION.SDK_INT < 27) {
            return r1.c.l(jh.a.b(context, 16843858, -16777216), IntBufferBatchMountItem.INSTRUCTION_UPDATE_LAYOUT);
        }
        if (z10) {
            return 0;
        }
        return jh.a.b(context, 16843858, -16777216);
    }
    ...
    private static int c(Context context, boolean z10) {
        ...
        return jh.a.b(context, 16843857, -16777216);
    }
    ...
    public static void e(Window window, boolean z10) {
        x0.b(window, window.getDecorView()).d(z10);
    }

    public static void f(Window window, boolean z10) {
        x0.b(window, window.getDecorView()).e(z10);
    }
}
