...
public class MaterialRadioButton extends q {
    ...
    private static final int f15296r = j.f55720s;

    /* renamed from: s  reason: collision with root package name */
    private static final int[][] f15297s = {new int[]{16842910, 16842912}, new int[]{16842910, -16842912}, new int[]{-16842910, 16842912}, new int[]{-16842910, -16842912}};

    /* renamed from: p  reason: collision with root package name */
    private ColorStateList f15298p;
    ...
    private ColorStateList getMaterialThemeColorsTintList() {
        if (this.f15298p == null) {
            int d10 = a.d(this, b.f55548h);
            int d11 = a.d(this, b.f55554k);
            int d12 = a.d(this, b.f55558o);
            int[][] iArr = f15297s;
            ...
            this.f15298p = new ColorStateList(iArr, iArr2);
        }
        return this.f15298p;
    }
    ...
    */
    public MaterialRadioButton(android.content.Context r7, android.util.AttributeSet r8, int r9) {
        /*
            r6 = this;
            int r4 = com.google.android.material.radiobutton.MaterialRadioButton.f15296r
            android.content.Context r7 = sh.a.c(r7, r8, r9, r4)
            r6.<init>(r7, r8, r9)
            android.content.Context r0 = r6.getContext()
            int[] r2 = zg.k.f55843l4
            r7 = 0
            int[] r5 = new int[r7]
            r1 = r8
            r3 = r9
            android.content.res.TypedArray r8 = com.google.android.material.internal.l.i(r0, r1, r2, r3, r4, r5)
            int r9 = zg.k.f55853m4
            boolean r9 = r8.hasValue(r9)
            if (r9 == 0) goto L29
            int r9 = zg.k.f55853m4
            android.content.res.ColorStateList r9 = mh.c.a(r0, r8, r9)
            androidx.core.widget.d.d(r6, r9)
        L29:
            int r9 = zg.k.f55862n4
