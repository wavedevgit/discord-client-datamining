...
public class FloatingActionButton extends p implements hh.a, n, CoordinatorLayout.b {
    ...
    private ColorStateList f16010e;

    /* renamed from: i  reason: collision with root package name */
    private PorterDuff.Mode f16011i;

    /* renamed from: o  reason: collision with root package name */
    private ColorStateList f16012o;

    /* renamed from: p  reason: collision with root package name */
    private PorterDuff.Mode f16013p;

    /* renamed from: q  reason: collision with root package name */
    private ColorStateList f16014q;
    ...
    private final Rect f16022y;

    /* renamed from: z  reason: collision with root package name */
    private final AppCompatImageHelper f16023z;
    ...
    public class b implements nh.b {
        ...
        public void a(int i10, int i11, int i12, int i13) {
            FloatingActionButton.this.f16021x.set(i10, i11, i12, i13);
            FloatingActionButton floatingActionButton = FloatingActionButton.this;
            floatingActionButton.setPadding(i10 + floatingActionButton.f16018u, i11 + FloatingActionButton.this.f16018u, i12 + FloatingActionButton.this.f16018u, i13 + FloatingActionButton.this.f16018u);
        }
        ...
        @Override // nh.b
        public boolean c() {
            return FloatingActionButton.this.f16020w;
        }
    }
    ...
    private void k() {
        ...
        ColorStateList colorStateList = this.f16012o;
        if (colorStateList == null) {
            s1.a.c(drawable);
            return;
        }
        int colorForState = colorStateList.getColorForState(getDrawableState(), 0);
        PorterDuff.Mode mode = this.f16013p;
        if (mode == null) {
    ...
    public int getRippleColor() {
        ColorStateList colorStateList = this.f16014q;
        if (colorStateList != null) {
    ...
    protected void onMeasure(int i10, int i11) {
        ...
        this.f16018u = (sizeDimension - this.f16019v) / 2;
        getImpl().c0();
        int min = Math.min(View.resolveSize(sizeDimension, i10), View.resolveSize(sizeDimension, i11));
        Rect rect = this.f16021x;
    ...
    public boolean onTouchEvent(MotionEvent motionEvent) {
        if (motionEvent.getAction() == 0) {
            h(this.f16022y);
            if (!this.f16022y.contains((int) motionEvent.getX(), (int) motionEvent.getY())) {
                return false;
            }
        }
    ...
    public void setBackgroundTintList(ColorStateList colorStateList) {
        if (this.f16010e != colorStateList) {
    ...
    public void setSupportImageTintList(ColorStateList colorStateList) {
        if (this.f16012o != colorStateList) {
            this.f16012o = colorStateList;
            k();
        }
    }

    public void setSupportImageTintMode(PorterDuff.Mode mode) {
        if (this.f16013p != mode) {
            this.f16013p = mode;
            k();
        }
    }
    ...
    protected static class BaseBehavior<T extends FloatingActionButton> extends CoordinatorLayout.c {
        ...
        private void K(CoordinatorLayout coordinatorLayout, FloatingActionButton floatingActionButton) {
            int i10;
            Rect rect = floatingActionButton.f16021x;
        ...
        private boolean N(View view, FloatingActionButton floatingActionButton) {
            CoordinatorLayout.f fVar = (CoordinatorLayout.f) floatingActionButton.getLayoutParams();
            if (!this.f16025e || fVar.e() != view.getId() || floatingActionButton.getUserSetVisibility() != 0) {
                return false;
            }
            return true;
        }
        ...
        private boolean O(CoordinatorLayout coordinatorLayout, AppBarLayout appBarLayout, FloatingActionButton floatingActionButton) {
            ...
            if (this.f16024d == null) {
                this.f16024d = new Rect();
            }
            Rect rect = this.f16024d;
        ...
        public boolean f(CoordinatorLayout coordinatorLayout, FloatingActionButton floatingActionButton, Rect rect) {
            Rect rect2 = floatingActionButton.f16021x;
    ...
    */
    public FloatingActionButton(android.content.Context r11, android.util.AttributeSet r12, int r13) {
        /*
            ...
            r12.U(r0)
            com.google.android.material.floatingactionbutton.b r12 = r10.getImpl()
            android.content.res.ColorStateList r0 = r10.f16010e
            android.graphics.PorterDuff$Mode r1 = r10.f16011i
            android.content.res.ColorStateList r3 = r10.f16014q
            int r4 = r10.f16015r
            r12.u(r0, r1, r3, r4)
            com.google.android.material.floatingactionbutton.b r12 = r10.getImpl()
            r12.Q(r6)
    ...
    public void setRippleColor(ColorStateList colorStateList) {
        if (this.f16014q != colorStateList) {
            this.f16014q = colorStateList;
            getImpl().S(this.f16014q);
        }
    }
}
