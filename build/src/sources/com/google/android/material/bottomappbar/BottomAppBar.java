...
public abstract class BottomAppBar extends Toolbar implements CoordinatorLayout.b {
    ...
    private static final int f14175i0 = j.f54256m;

    /* renamed from: j0  reason: collision with root package name */
    private static final int f14176j0 = b.F;

    /* renamed from: k0  reason: collision with root package name */
    private static final int f14177k0 = b.P;
    ...
    public static void Y(BottomAppBar bottomAppBar, View view) {
        ((CoordinatorLayout.f) view.getLayoutParams()).f2864d = 17;
        throw null;
    }
    ...
    public static class Behavior extends HideBottomViewOnScrollBehavior<BottomAppBar> {
        ...
        private final Rect f14178x;

        /* renamed from: y  reason: collision with root package name */
        private WeakReference f14179y;
        ...
        class a implements View.OnLayoutChangeListener {
            ...
            public void onLayoutChange(View view, int i10, int i11, int i12, int i13, int i14, int i15, int i16, int i17) {
                android.support.v4.media.session.b.a(Behavior.this.f14179y.get());
        ...
        public boolean S(CoordinatorLayout coordinatorLayout, BottomAppBar bottomAppBar, int i10) {
            this.f14179y = new WeakReference(bottomAppBar);
            View T = BottomAppBar.T(bottomAppBar);
            if (T != null && !h0.S(T)) {
                BottomAppBar.Y(bottomAppBar, T);
                this.f14180z = ((ViewGroup.MarginLayoutParams) ((CoordinatorLayout.f) T.getLayoutParams())).bottomMargin;
                if (T instanceof FloatingActionButton) {
                    ...
                    if (floatingActionButton.getShowMotionSpec() == null) {
                        floatingActionButton.setShowMotionSpecResource(yg.a.f54073b);
                    }
                    if (floatingActionButton.getHideMotionSpec() == null) {
                        floatingActionButton.setHideMotionSpecResource(yg.a.f54072a);
                    }
