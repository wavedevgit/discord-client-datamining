...
public class i0 {
    ...
    private final Bundle f16470a;

    public i0(Bundle bundle) {
        if (bundle != null) {
            this.f16470a = new Bundle(bundle);
            return;
        }
    ...
    private String w(String str) {
        if (!this.f16470a.containsKey(str) && str.startsWith("gcm.n.")) {
            String v10 = v(str);
            if (this.f16470a.containsKey(v10)) {
                return v10;
            }
        }
        return str;
    ...
    public String p(String str) {
        return this.f16470a.getString(w(str));
    }
    ...
    public Bundle x() {
        Bundle bundle = new Bundle(this.f16470a);
        for (String str : this.f16470a.keySet()) {
            if (!s(str)) {
                bundle.remove(str);
            }
        }
