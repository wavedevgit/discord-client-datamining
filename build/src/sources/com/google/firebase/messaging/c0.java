...
public class c0 {
    ...
    private final ni.e f17460a;

    /* renamed from: b  reason: collision with root package name */
    private final h0 f17461b;

    /* renamed from: c  reason: collision with root package name */
    private final Rpc f17462c;

    /* renamed from: d  reason: collision with root package name */
    private final bj.b f17463d;

    /* renamed from: e  reason: collision with root package name */
    private final bj.b f17464e;

    /* renamed from: f  reason: collision with root package name */
    private final cj.e f17465f;
    ...
    private String d() {
        try {
            return b(MessageDigest.getInstance("SHA-1").digest(this.f17460a.l().getBytes()));
    ...
    */
    private void i(java.lang.String r3, java.lang.String r4, android.os.Bundle r5) {
        /*
            ...
            r5.putString(r4, r3)
            com.google.firebase.messaging.h0 r3 = r2.f17461b
            int r3 = r3.d()
            ...
            r5.putString(r3, r4)
            cj.e r3 = r2.f17465f     // Catch: java.lang.InterruptedException -> L76 java.util.concurrent.ExecutionException -> L78
            r4 = 0
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    public Task f() {
        return c(k(h0.c(this.f17460a), "*", new Bundle()));
    }

    /* JADX INFO: Access modifiers changed from: package-private */
    public Task j(boolean z10) {
        return this.f17462c.d(z10);
    }
