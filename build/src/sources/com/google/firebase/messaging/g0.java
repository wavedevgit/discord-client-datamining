...
public abstract class g0 {
    ...
    public static boolean a() {
        ...
        try {
            ...
            try {
                ...
                if (packageManager != null && (applicationInfo = packageManager.getApplicationInfo(j10.getPackageName(), IntBufferBatchMountItem.INSTRUCTION_UPDATE_LAYOUT)) != null && (bundle = applicationInfo.metaData) != null && bundle.containsKey("delivery_metrics_exported_to_big_query_enabled")) {
    ...
    static lj.a b(a.b bVar, Intent intent) {
        if (intent == null) {
            return null;
        }
        ...
        a.C0485a h10 = lj.a.p().m(p(extras)).e(bVar).f(f(extras)).i(m()).k(a.d.ANDROID).h(k(extras));
        String h11 = h(extras);
        if (h11 != null) {
            h10.g(h11);
        }
    ...
    static String f(Bundle bundle) {
        ...
        try {
            return (String) yg.m.a(com.google.firebase.installations.c.p(ri.e.k()).getId());
    ...
    static String l(Bundle bundle) {
        if (bundle != null && i0.t(bundle)) {
            return ViewProps.DISPLAY;
        }
        return "data";
    }

    static String m() {
        return ri.e.k().j().getPackageName();
    }
    ...
    private static void w(a.b bVar, Intent intent, xb.i iVar) {
        if (iVar == null) {
            Log.e("FirebaseMessaging", "TransportFactory is null. Skip exporting message delivery metrics to Big Query");
            return;
        }
        lj.a b10 = b(bVar, intent);
        if (b10 == null) {
            return;
        }
        try {
            iVar.a("FCM_CLIENT_EVENT_LOGGING", lj.b.class, xb.c.b("proto"), new xb.g() { // from class: com.google.firebase.messaging.f0
                @Override // xb.g
                public final Object apply(Object obj) {
                    return ((lj.b) obj).c();
                }
            }).a(xb.d.f(lj.b.b().b(b10).a(), xb.f.b(Integer.valueOf(intent.getIntExtra("google.product_id", 111881503)))));
    ...
    static void x(String str, Bundle bundle) {
        try {
            ...
            android.support.v4.media.session.b.a(ri.e.k().i(si.a.class));
