...
public class m {
    ...
    private static final Object f16112c = new Object();

    /* renamed from: d  reason: collision with root package name */
    private static i1 f16113d;

    /* renamed from: a  reason: collision with root package name */
    private final Context f16114a;

    /* renamed from: b  reason: collision with root package name */
    private final Executor f16115b = new g2.i();
    ...
    public Task h(final Context context, final Intent intent) {
        ...
        return wg.m.c(this.f16115b, new Callable() { // from class: com.google.firebase.messaging.i
        ...
        }).i(this.f16115b, new wg.c() { // from class: com.google.firebase.messaging.j
            @Override // wg.c
            public final Object a(Task task) {
