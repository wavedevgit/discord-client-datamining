...
public class FirebaseCommonRegistrar implements ComponentRegistrar {
    ...
    public List getComponents() {
        ...
        arrayList.add(h.c("android-target-sdk", new h.a() { // from class: qi.f
            @Override // mj.h.a
            public final String a(Object obj) {
                return FirebaseCommonRegistrar.c((Context) obj);
            }
        }));
        arrayList.add(h.c("android-min-sdk", new h.a() { // from class: qi.g
            @Override // mj.h.a
            public final String a(Object obj) {
                return FirebaseCommonRegistrar.b((Context) obj);
            }
        }));
        arrayList.add(h.c("android-platform", new h.a() { // from class: qi.h
            @Override // mj.h.a
            public final String a(Object obj) {
                return FirebaseCommonRegistrar.d((Context) obj);
            }
        }));
        arrayList.add(h.c("android-installer", new h.a() { // from class: qi.i
            @Override // mj.h.a
            public final String a(Object obj) {
