...
public abstract class NativeProxyCommon {
    private final an.a gestureHandlerStateManager;
    ...
    public NativeProxyCommon(ReactApplicationContext reactApplicationContext) {
        ...
        try {
            ...
            aVar = (an.a) reactApplicationContext.getNativeModule(RNGestureHandlerModule.class);
    ...
    public void setGestureState(int i10, int i11) {
        an.a aVar = this.gestureHandlerStateManager;
        if (aVar != null) {
