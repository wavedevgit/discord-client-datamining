...
public final class ScreenDummyLayoutHelper implements LifecycleEventListener {
    ...
    public static final a f17960u = new a(null);

    /* renamed from: v  reason: collision with root package name */
    private static WeakReference f17961v = new WeakReference(null);

    /* renamed from: d  reason: collision with root package name */
    private CoordinatorLayout f17962d;

    /* renamed from: e  reason: collision with root package name */
    private AppBarLayout f17963e;

    /* renamed from: i  reason: collision with root package name */
    private View f17964i;

    /* renamed from: o  reason: collision with root package name */
    private Toolbar f17965o;
    ...
    private com.swmansion.rnscreens.utils.a f17968r;

    /* renamed from: s  reason: collision with root package name */
    private WeakReference f17969s;

    /* renamed from: t  reason: collision with root package name */
    private volatile boolean f17970t;
    ...
    public static final class a {
        ...
        public final ScreenDummyLayoutHelper getInstance() {
            return (ScreenDummyLayoutHelper) ScreenDummyLayoutHelper.f17961v.get();
        }
    ...
    public ScreenDummyLayoutHelper(ReactApplicationContext reactContext) {
        ...
        this.f17968r = com.swmansion.rnscreens.utils.a.f17971c.a();
        this.f17969s = new WeakReference(reactContext);
        try {
        ...
        f17961v = new WeakReference(this);
    ...
    private final float computeDummyLayout(int i10, boolean z10) {
        float f10;
        if (!this.f17970t && !g(j(new Function0() { // from class: nn.e
            ...
            return 0.0f;
        } else if (this.f17968r.c(new b(i10, z10))) {
            return this.f17968r.b();
        } else {
            ...
            if (z10) {
                Toolbar toolbar = this.f17965o;
                if (toolbar == null) {
                    Intrinsics.throwUninitializedPropertyAccessException("toolbar");
                    toolbar = null;
                }
                toolbar.setTitle("");
                Toolbar toolbar2 = this.f17965o;
                if (toolbar2 == null) {
                    Intrinsics.throwUninitializedPropertyAccessException("toolbar");
                    toolbar2 = null;
                }
                ...
                Toolbar toolbar3 = this.f17965o;
                if (toolbar3 == null) {
                    Intrinsics.throwUninitializedPropertyAccessException("toolbar");
                    toolbar3 = null;
                }
                toolbar3.setTitle("FontSize123!#$");
                Toolbar toolbar4 = this.f17965o;
                if (toolbar4 == null) {
                    Intrinsics.throwUninitializedPropertyAccessException("toolbar");
                    toolbar4 = null;
                }
                toolbar4.setContentInsetStartWithNavigation(this.f17967q);
            }
            ScreenStackHeaderConfig.a aVar = ScreenStackHeaderConfig.O;
            Toolbar toolbar5 = this.f17965o;
            if (toolbar5 == null) {
                Intrinsics.throwUninitializedPropertyAccessException("toolbar");
                toolbar5 = null;
            }
            ...
            CoordinatorLayout coordinatorLayout = this.f17962d;
            if (coordinatorLayout == null) {
                Intrinsics.throwUninitializedPropertyAccessException("coordinatorLayout");
                coordinatorLayout = null;
            }
            coordinatorLayout.measure(makeMeasureSpec, makeMeasureSpec2);
            CoordinatorLayout coordinatorLayout2 = this.f17962d;
            if (coordinatorLayout2 == null) {
                Intrinsics.throwUninitializedPropertyAccessException("coordinatorLayout");
                coordinatorLayout2 = null;
            }
            coordinatorLayout2.layout(0, 0, width, height);
            AppBarLayout appBarLayout2 = this.f17963e;
            ...
            this.f17968r = new com.swmansion.rnscreens.utils.a(new b(i10, z10), dIPFromPixel);
            return dIPFromPixel;
        }
    }
    ...
    private final void f(Context context) {
        ...
        this.f17967q = toolbar2.getContentInsetStartWithNavigation();
        AppBarLayout appBarLayout2 = this.f17963e;
        if (appBarLayout2 == null) {
            Intrinsics.throwUninitializedPropertyAccessException("appBarLayout");
            appBarLayout2 = null;
        ...
        AppBarLayout appBarLayout3 = this.f17963e;
        if (appBarLayout3 == null) {
            Intrinsics.throwUninitializedPropertyAccessException("appBarLayout");
            appBarLayout3 = null;
        }
        coordinatorLayout.addView(appBarLayout3);
        View view3 = this.f17964i;
        if (view3 == null) {
    ...
    private final ReactApplicationContext j(Function0 function0) {
        Object obj = this.f17969s.get();
        if (function0 == null) {
            function0 = new Function0() { // from class: nn.g
                @Override // kotlin.jvm.functions.Function0
                public final Object invoke() {
                    Object l10;
    ...
    public void onHostDestroy() {
        ReactApplicationContext reactApplicationContext = (ReactApplicationContext) this.f17969s.get();
    ...
    public void onHostResume() {
        ReactApplicationContext j10 = j(new Function0() { // from class: nn.f
            @Override // kotlin.jvm.functions.Function0
            public final Object invoke() {
                Object h10;
