...
public final class e1 {
    ...
    private SearchView f18400a;

    /* renamed from: b  reason: collision with root package name */
    private Integer f18401b;

    /* renamed from: c  reason: collision with root package name */
    private Drawable f18402c;

    public e1(SearchView searchView) {
        Intrinsics.checkNotNullParameter(searchView, "searchView");
        this.f18400a = searchView;
    }

    private final ImageView a() {
        return (ImageView) this.f18400a.findViewById(f.f.f22252z);
    }

    private final EditText b() {
        View findViewById = this.f18400a.findViewById(f.f.E);
    ...
    private final ImageView c() {
        return (ImageView) this.f18400a.findViewById(f.f.f22251y);
    }

    private final View d() {
        return this.f18400a.findViewById(f.f.D);
    }
    ...
    public final void g(String placeholder, boolean z10) {
        ...
        if (z10) {
            this.f18400a.setQueryHint(placeholder);
            return;
        }
        EditText b10 = b();
        if (b10 != null) {
