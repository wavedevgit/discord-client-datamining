...
public final class p {
    ...
    private final com.google.android.material.bottomnavigation.c f19280a;

    /* renamed from: b  reason: collision with root package name */
    private final List f19281b;

    /* renamed from: c  reason: collision with root package name */
    private final o f19282c;
    ...
    public p(ContextThemeWrapper context, com.google.android.material.bottomnavigation.c bottomNavigationView, List tabScreenFragments) {
        ...
        this.f19280a = bottomNavigationView;
        this.f19281b = tabScreenFragments;
        this.f19282c = new o(context, bottomNavigationView);
    }

    private final void b() {
        MenuItem b10;
        Menu menu = this.f19280a.getMenu();
        Intrinsics.checkNotNullExpressionValue(menu, "getMenu(...)");
        if (menu.size() != this.f19281b.size()) {
            this.f19280a.getMenu().clear();
        }
        int i10 = 0;
        for (Object obj : this.f19281b) {
            int i11 = i10 + 1;
            if (i10 < 0) {
                CollectionsKt.v();
            }
            e eVar = (e) obj;
            Menu menu2 = this.f19280a.getMenu();
    ...
    public final void a(MenuItem menuItem, a tabScreen) {
        ...
        this.f19282c.d(menuItem, tabScreen);
        this.f19282c.b(menuItem, tabScreen);
    }

    public final void c(l tabsHost) {
        Intrinsics.checkNotNullParameter(tabsHost, "tabsHost");
        this.f19282c.e(tabsHost);
        b();
        this.f19282c.c(tabsHost);
    }
}
