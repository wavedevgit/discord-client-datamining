...
public final class j {
    ...
    private final List f19184a = new ArrayList();
    ...
    private final boolean d() {
        if (this.f19184a.isEmpty() && this.f19185b.isEmpty()) {
            return false;
        }
        return true;
    }
