...
public final class k extends ViewGroup implements UIManagerListener, i {
    ...
    public static final a f19185p = new a(null);

    /* renamed from: d  reason: collision with root package name */
    private final ThemedReactContext f19186d;

    /* renamed from: e  reason: collision with root package name */
    private final ArrayList f19187e;

    /* renamed from: i  reason: collision with root package name */
    private final h f19188i;

    /* renamed from: o  reason: collision with root package name */
    private final j f19189o;
    ...
    public /* synthetic */ class b {
        ...
        static {
            ...
            try {
                iArr[a.EnumC0229a.f19198d.ordinal()] = 1;
            } catch (NoSuchFieldError unused) {
            }
            try {
                iArr[a.EnumC0229a.f19199e.ordinal()] = 2;
    ...
    private final void b(com.swmansion.rnscreens.gamma.stack.screen.a aVar) {
        if (aVar.getActivityMode() == a.EnumC0229a.f19199e && !aVar.b()) {
            this.f19189o.a(aVar);
            return;
        }
    ...
    private final void c(com.swmansion.rnscreens.gamma.stack.screen.a aVar) {
        if (aVar.getActivityMode() == a.EnumC0229a.f19199e) {
            this.f19189o.b(aVar);
        }
    }
    ...
    public void a(com.swmansion.rnscreens.gamma.stack.screen.a stackScreen) {
        ...
        if (stackScreen.getActivityMode() == a.EnumC0229a.f19199e) {
    ...
    public final void d(com.swmansion.rnscreens.gamma.stack.screen.a stackScreen, int i10) {
        Intrinsics.checkNotNullParameter(stackScreen, "stackScreen");
        this.f19187e.add(i10, stackScreen);
    ...
    public void didMountItems(UIManager uiManager) {
        Intrinsics.checkNotNullParameter(uiManager, "uiManager");
        this.f19189o.c(this.f19188i, this.f19187e);
    }
    ...
    public final void e(com.swmansion.rnscreens.gamma.stack.screen.a stackScreen) {
        Intrinsics.checkNotNullParameter(stackScreen, "stackScreen");
        int i10 = b.f19190a[stackScreen.getActivityMode().ordinal()];
        if (i10 != 1) {
            if (i10 == 2) {
                this.f19189o.b(stackScreen);
                return;
            }
            throw new p();
        }
        this.f19189o.a(stackScreen);
    }

    public final void f() {
        for (com.swmansion.rnscreens.gamma.stack.screen.a aVar : CollectionsKt.T(this.f19187e)) {
            b(aVar);
        }
        this.f19187e.clear();
    }
    ...
    public final void g(com.swmansion.rnscreens.gamma.stack.screen.a reactSubview) {
        ...
        this.f19187e.remove(reactSubview);
        b(reactSubview);
    }
    ...
    public final void h(int i10) {
        Object remove = this.f19187e.remove(i10);
    ...
    protected void onLayout(boolean z10, int i10, int i11, int i12, int i13) {
        this.f19188i.layout(i10, i11, i12, i13);
    }

    @Override // android.view.View
    protected void onMeasure(int i10, int i11) {
        super.onMeasure(i10, i11);
        this.f19188i.measure(i10, i11);
    }
