...
public final class NativeProxy {
    ...
    private static final ConcurrentHashMap f18774b = new ConcurrentHashMap();
    @fb.a
    @NotNull
    ...
    public static final class a {
        ...
        public final void a(int i10, Screen view) {
            ...
            NativeProxy.f18774b.put(Integer.valueOf(i10), new WeakReference(view));
        }

        public final void b() {
            NativeProxy.f18774b.clear();
        }

        public final void c(int i10) {
            NativeProxy.f18774b.remove(Integer.valueOf(i10));
        }
    ...
    public final void notifyScreenRemoved(int i10) {
        WeakReference weakReference = (WeakReference) f18774b.get(Integer.valueOf(i10));
