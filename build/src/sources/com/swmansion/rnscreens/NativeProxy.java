...
public final class NativeProxy {
    ...
    public static final class a {
        ...
        public final void a(int i10, Screen view) {
            ...
            NativeProxy.f18282b.put(Integer.valueOf(i10), new WeakReference(view));
        }

        public final void b() {
            NativeProxy.f18282b.clear();
        }

        public final void c(int i10) {
            NativeProxy.f18282b.remove(Integer.valueOf(i10));
        }
    ...
    public final void notifyScreenRemoved(int i10) {
        WeakReference weakReference = (WeakReference) f18282b.get(Integer.valueOf(i10));
