    ...
    private final void updateTransition(double d10) {
        ...
        if (this.topScreenId != -1) {
            ...
            if (eventDispatcherForReactTag != null) {
                eventDispatcherForReactTag.dispatchEvent(new in.j(UIManagerHelper.getSurfaceId(this.reactContext), this.topScreenId, f10, true, true, a10));
            }
        }
    }
