...
public final class s extends BaseReactPackage {
    ...
    public static final a f18477b = new a(null);

    /* renamed from: a  reason: collision with root package name */
    private ScreenDummyLayoutHelper f18478a;
    ...
    public List createViewManagers(ReactApplicationContext reactContext) {
        ...
        this.f18478a = new ScreenDummyLayoutHelper(reactContext);
        j.f18416d.f(reactContext);
