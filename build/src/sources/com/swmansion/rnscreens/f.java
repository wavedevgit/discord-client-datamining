...
public abstract class f extends ViewGroup {
    ...
    public static final a f18403q = new a(null);

    /* renamed from: d  reason: collision with root package name */
    private StateWrapper f18404d;

    /* renamed from: e  reason: collision with root package name */
    private float f18405e;

    /* renamed from: i  reason: collision with root package name */
    private float f18406i;

    /* renamed from: o  reason: collision with root package name */
    private float f18407o;
    ...
    public final void a(int i10, int i11, int i12, int i13) {
        ...
        if (Math.abs(this.f18405e - dIPFromPixel) >= 0.9f || Math.abs(this.f18406i - dIPFromPixel2) >= 0.9f || Math.abs(this.f18407o - dIPFromPixel3) >= 0.9f || Math.abs(this.f18408p - dIPFromPixel4) >= 0.9f) {
            this.f18405e = dIPFromPixel;
            this.f18406i = dIPFromPixel2;
            this.f18407o = dIPFromPixel3;
            this.f18408p = dIPFromPixel4;
            ...
            StateWrapper stateWrapper = this.f18404d;
