...
public final class RNGestureHandlerModule extends NativeRNGestureHandlerModuleSpec implements in.a {
    @NotNull
    ...
    private final <T extends kn.d> void createGestureHandlerHelper(String str, int i10, ReadableMap readableMap) {
        if (this.registry.h(i10) == null) {
            d.c b10 = e.f18086a.b(str);
            if (b10 != null) {
                kn.d b11 = b10.b(getReactApplicationContext(), i10);
    ...
    private final <T extends kn.d> void updateGestureHandlerHelper(int i10, ReadableMap readableMap) {
        d.c a10;
        kn.d h10 = this.registry.h(i10);
        if (h10 == null || (a10 = e.f18086a.a(h10)) == null) {
            return;
        }
