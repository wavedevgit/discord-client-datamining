...
public final class RNGestureHandlerModule extends NativeRNGestureHandlerModuleSpec implements gn.a {
    @NotNull
    ...
    private final <T extends in.d> void createGestureHandlerHelper(String str, int i10, ReadableMap readableMap) {
        if (this.registry.h(i10) == null) {
            d.c b10 = e.f18106a.b(str);
            if (b10 != null) {
                in.d b11 = b10.b(getReactApplicationContext(), i10);
    ...
    private final <T extends in.d> void updateGestureHandlerHelper(int i10, ReadableMap readableMap) {
        d.c a10;
        in.d h10 = this.registry.h(i10);
        if (h10 == null || (a10 = e.f18106a.a(h10)) == null) {
            return;
        }
