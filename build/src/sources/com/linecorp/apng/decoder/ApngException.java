...
public final class ApngException extends Exception {
    ...
    private final ErrorCode f16796d;
    ...
    public static final class ErrorCode {
        ...
        private static final /* synthetic */ ErrorCode[] f16797e;

        /* renamed from: i  reason: collision with root package name */
        private static final /* synthetic */ EnumEntries f16798i;
        ...
        public static ErrorCode[] values() {
            return (ErrorCode[]) f16797e.clone();
        }
    ...
    public String getMessage() {
        String str;
        switch (WhenMappings.$EnumSwitchMapping$0[this.f16796d.ordinal()]) {
            case 1:
