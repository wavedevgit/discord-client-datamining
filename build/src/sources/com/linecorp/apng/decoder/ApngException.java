...
public final class ApngException extends Exception {
    ...
    private final ErrorCode f17310d;
    ...
    public static final class ErrorCode {
        ...
        private static final /* synthetic */ ErrorCode[] f17311e;
        ...
        public static ErrorCode[] values() {
            return (ErrorCode[]) f17311e.clone();
        }
    ...
    public String getMessage() {
        String str;
        switch (WhenMappings.$EnumSwitchMapping$0[this.f17310d.ordinal()]) {
            case 1:
