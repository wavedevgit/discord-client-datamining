...
public final class Apng {
    ...
    public static final class Companion {
        ...
        public final Apng copy(@NotNull Apng apng) {
            ...
            try {
                int copy = ApngDecoderJni.copy(apng.f18051a, decodeResult);
                Trace.endSection();
                a(copy);
                try {
    ...
    public final void drawWithIndex(int i10, @NotNull Canvas canvas, Rect rect, @NotNull Rect dst, @NotNull Paint paint) {
        ...
        Trace.beginSection("Apng#draw");
        ApngDecoderJni.draw(this.f18051a, i10, this.f18058h);
        Trace.endSection();
        canvas.drawBitmap(this.f18058h, rect, dst, paint);
    }
    ...
    public final int getByteCount() {
        return this.f18058h.getAllocationByteCount();
    }

    @NotNull
    public final Bitmap.Config getConfig() {
        Bitmap.Config config = this.f18058h.getConfig();
    ...
    public final boolean isRecycled() {
        return this.f18058h.isRecycled();
    }

    public final void recycle() {
        ApngDecoderJni.recycle(this.f18051a);
    }
}
