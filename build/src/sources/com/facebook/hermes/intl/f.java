...
public abstract class f {
    public static HashMap a(List list, Object obj, List list2) {
        ...
        while (it.hasNext()) {
            ...
            Object b10 = ea.d.b();
            Object obj2 = b10;
            if (!c10.f11003b.isEmpty()) {
                obj2 = b10;
                if (c10.f11003b.containsKey(str)) {
                    String str2 = (String) c10.f11003b.get(str);
            ...
            if (ea.d.m(obj2) && !ea.i.c(str, ea.d.h(obj2), c10.f11002a)) {
        ...
        for (String str4 : hashSet) {
            ...
            String h10 = ea.d.h(ea.i.f(str4, ea.d.r((String) c10.f11003b.get(str4))));
            if (!ea.d.m(h10) || ea.i.c(str4, ea.d.h(h10), c10.f11002a)) {
                arrayList.add(h10);
                c10.f11002a.f(str4, arrayList);
            }
        }
        hashMap.put("locale", c10.f11002a);
        return hashMap;
    }
}
