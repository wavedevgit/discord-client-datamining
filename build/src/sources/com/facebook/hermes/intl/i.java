...
public class i implements com.facebook.hermes.intl.b {
    ...
    private static String i(ea.b bVar, b.EnumC0152b enumC0152b, b.k kVar) {
        ...
        if (kVar == b.k.UNDEFINED) {
            return ((SimpleDateFormat) DateFormat.getDateInstance(l(enumC0152b), (ULocale) bVar.h())).toLocalizedPattern();
        }
        return ((SimpleDateFormat) DateFormat.getDateTimeInstance(l(enumC0152b), m(kVar), (ULocale) bVar.h())).toLocalizedPattern();
    }

    private static String j(ea.b bVar, b.m mVar, b.d dVar, b.n nVar, b.i iVar, b.c cVar, b.f fVar, b.h hVar, b.j jVar, b.l lVar, b.g gVar, b.EnumC0152b enumC0152b, b.k kVar, Object obj) {
        StringBuilder sb2 = new StringBuilder();
        if (enumC0152b == b.EnumC0152b.UNDEFINED && kVar == b.k.UNDEFINED) {
            sb2.append(mVar.d());
            sb2.append(dVar.d());
            sb2.append(nVar.d());
            sb2.append(iVar.d());
            ...
            sb2.append(i(bVar, enumC0152b, kVar));
            HashMap a10 = bVar.a();
    ...
    static int l(b.EnumC0152b enumC0152b) {
        ...
        if (i10 != 1) {
            ...
            throw new ea.f("Invalid DateStyle: " + enumC0152b.toString());
        }
        return 0;
    }
    ...
    @Override // com.facebook.hermes.intl.b
    public void h(ea.b bVar, String str, String str2, b.e eVar, b.m mVar, b.d dVar, b.n nVar, b.i iVar, b.c cVar, b.f fVar, b.h hVar, b.j jVar, b.l lVar, b.g gVar, Object obj, b.EnumC0152b enumC0152b, b.k kVar, Object obj2) {
        Calendar calendar;
        ea.b bVar2;
        String j10 = j(bVar, mVar, dVar, nVar, iVar, cVar, fVar, hVar, jVar, lVar, gVar, enumC0152b, kVar, obj2);
        if (str.isEmpty()) {
            calendar = null;
        } else {
