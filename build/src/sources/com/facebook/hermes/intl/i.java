...
public class i implements com.facebook.hermes.intl.b {
    ...
    private DateFormat f10393a = null;
    ...
    public static /* synthetic */ class a {
        ...
        static {
            ...
            try {
                f10395b[b.k.LONG.ordinal()] = 2;
            } catch (NoSuchFieldError unused2) {
            }
            try {
                f10395b[b.k.MEDIUM.ordinal()] = 3;
            } catch (NoSuchFieldError unused3) {
            }
            try {
                f10395b[b.k.SHORT.ordinal()] = 4;
            } catch (NoSuchFieldError unused4) {
            }
            try {
                f10395b[b.k.UNDEFINED.ordinal()] = 5;
            } catch (NoSuchFieldError unused5) {
            }
            int[] iArr2 = new int[b.EnumC0155b.values().length];
            f10394a = iArr2;
            try {
                iArr2[b.EnumC0155b.FULL.ordinal()] = 1;
            } catch (NoSuchFieldError unused6) {
            }
            try {
                f10394a[b.EnumC0155b.LONG.ordinal()] = 2;
            } catch (NoSuchFieldError unused7) {
            }
            try {
                f10394a[b.EnumC0155b.MEDIUM.ordinal()] = 3;
            } catch (NoSuchFieldError unused8) {
            }
            try {
                f10394a[b.EnumC0155b.SHORT.ordinal()] = 4;
            } catch (NoSuchFieldError unused9) {
            }
            try {
                f10394a[b.EnumC0155b.UNDEFINED.ordinal()] = 5;
    ...
    private static String i(da.b bVar, b.EnumC0155b enumC0155b, b.k kVar) {
        ...
        if (kVar == b.k.UNDEFINED) {
            return ((SimpleDateFormat) DateFormat.getDateInstance(l(enumC0155b), (ULocale) bVar.h())).toLocalizedPattern();
        }
        return ((SimpleDateFormat) DateFormat.getDateTimeInstance(l(enumC0155b), m(kVar), (ULocale) bVar.h())).toLocalizedPattern();
    }

    private static String j(da.b bVar, b.m mVar, b.d dVar, b.n nVar, b.i iVar, b.c cVar, b.f fVar, b.h hVar, b.j jVar, b.l lVar, b.g gVar, b.EnumC0155b enumC0155b, b.k kVar, Object obj) {
        StringBuilder sb2 = new StringBuilder();
        if (enumC0155b == b.EnumC0155b.UNDEFINED && kVar == b.k.UNDEFINED) {
            sb2.append(mVar.d());
            sb2.append(dVar.d());
            sb2.append(nVar.d());
            sb2.append(iVar.d());
            ...
            sb2.append(i(bVar, enumC0155b, kVar));
            HashMap a10 = bVar.a();
    ...
    static int l(b.EnumC0155b enumC0155b) {
        int i10 = a.f10394a[enumC0155b.ordinal()];
        if (i10 != 1) {
            if (i10 == 2) {
                return 1;
            }
            ...
            throw new da.f("Invalid DateStyle: " + enumC0155b.toString());
        }
        return 0;
    }

    static int m(b.k kVar) {
        int i10 = a.f10395b[kVar.ordinal()];
        if (i10 != 1) {
            if (i10 == 2) {
                return 1;
            }
    ...
    public AttributedCharacterIterator a(double d10) {
        return this.f10393a.formatToCharacterIterator(Double.valueOf(d10));
    }

    @Override // com.facebook.hermes.intl.b
    public String b(double d10) {
        return this.f10393a.format(new Date((long) d10));
    }
    ...
    @Override // com.facebook.hermes.intl.b
    public void g(da.b bVar, String str, String str2, b.e eVar, b.m mVar, b.d dVar, b.n nVar, b.i iVar, b.c cVar, b.f fVar, b.h hVar, b.j jVar, b.l lVar, b.g gVar, Object obj, b.EnumC0155b enumC0155b, b.k kVar, Object obj2) {
        Calendar calendar;
        da.b bVar2;
        String j10 = j(bVar, mVar, dVar, nVar, iVar, cVar, fVar, hVar, jVar, lVar, gVar, enumC0155b, kVar, obj2);
        if (str.isEmpty()) {
            calendar = null;
        } else {
        ...
        if (calendar != null) {
            this.f10393a = DateFormat.getPatternInstance(calendar, j10, (ULocale) bVar2.h());
        } else {
            this.f10393a = DateFormat.getPatternInstance(j10, (ULocale) bVar2.h());
        }
        if (da.d.n(obj) || da.d.j(obj)) {
            return;
        }
        this.f10393a.setTimeZone(TimeZone.getTimeZone(da.d.h(obj)));
    }
