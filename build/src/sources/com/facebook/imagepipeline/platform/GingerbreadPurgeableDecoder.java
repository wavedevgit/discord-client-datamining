...
public class GingerbreadPurgeableDecoder extends DalvikPurgeableDecoder {
    ...
    private static Method f11670d;

    /* renamed from: c  reason: collision with root package name */
    private final b f11671c = c.i();
    ...
    private static MemoryFile h(CloseableReference closeableReference, int i10, byte[] bArr) {
        ...
        try {
            jVar = new j((h) closeableReference.D0());
            try {
                aVar = new a(jVar, i10);
            } catch (Throwable th2) {
                th = th2;
    ...
    private synchronized Method j() {
        if (f11670d == null) {
            try {
                f11670d = MemoryFile.class.getDeclaredMethod("getFileDescriptor", null);
            } catch (Exception e10) {
                throw n.a(e10);
            }
        }
    ...
    protected Bitmap c(CloseableReference closeableReference, BitmapFactory.Options options) {
        return i(closeableReference, ((h) closeableReference.D0()).size(), null, options);
    }
