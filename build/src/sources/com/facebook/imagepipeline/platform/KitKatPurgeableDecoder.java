...
public class KitKatPurgeableDecoder extends DalvikPurgeableDecoder {
    ...
    private final com.facebook.imagepipeline.memory.d f11672c;
    ...
    protected Bitmap c(CloseableReference closeableReference, BitmapFactory.Options options) {
        ...
        int size = hVar.size();
        CloseableReference a10 = this.f11672c.a(size);
        try {
            byte[] bArr = (byte[]) a10.D0();
            hVar.o(0, bArr, 0, size);
    ...
    protected Bitmap d(CloseableReference closeableReference, int i10, BitmapFactory.Options options) {
        ...
        if (DalvikPurgeableDecoder.e(closeableReference, i10)) {
            ...
            bArr = DalvikPurgeableDecoder.f11658b;
        }
        h hVar = (h) closeableReference.D0();
        if (i10 <= hVar.size()) {
            z10 = true;
        ...
        int i11 = i10 + 2;
        CloseableReference a10 = this.f11672c.a(i11);
        try {
            byte[] bArr2 = (byte[]) a10.D0();
            hVar.o(0, bArr2, 0, i10);
            if (bArr != null) {
                h(bArr2, i10);
                i10 = i11;
            }
