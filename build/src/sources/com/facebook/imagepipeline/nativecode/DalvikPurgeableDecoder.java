...
public abstract class DalvikPurgeableDecoder implements wa.d {
    ...
    protected static final byte[] f11658b;

    /* renamed from: a  reason: collision with root package name */
    private final va.b f11659a = va.c.a();
    ...
    public CloseableReference g(Bitmap bitmap) {
        ...
        try {
            ...
            if (this.f11659a.g(bitmap)) {
                return CloseableReference.U0(bitmap, this.f11659a.e());
            }
            int j10 = cb.d.j(bitmap);
            bitmap.recycle();
            throw new ma.c(String.format(Locale.US, "Attempted to pin a bitmap of size %d bytes. The current pool count is %d, the current pool size is %d bytes. The current pool max count is %d, the current pool max size is %d bytes.", Integer.valueOf(j10), Integer.valueOf(this.f11659a.b()), Long.valueOf(this.f11659a.f()), Integer.valueOf(this.f11659a.c()), Integer.valueOf(this.f11659a.d())));
        } catch (Exception e10) {
            bitmap.recycle();
            throw n.a(e10);
        }
