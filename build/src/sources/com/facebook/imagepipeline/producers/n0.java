...
public class n0 implements w0 {
    ...
    private final ContentResolver f10839b;

    /* loaded from: /home/runner/work/discord-client-datamining/discord-client-datamining/build/classes3.dex */
    class a extends e1 {

        /* renamed from: q  reason: collision with root package name */
        final /* synthetic */ y0 f10840q;

        /* renamed from: r  reason: collision with root package name */
        final /* synthetic */ ProducerContext f10841r;

        /* renamed from: s  reason: collision with root package name */
        final /* synthetic */ ImageRequest f10842s;
        ...
        a(Consumer consumer, y0 y0Var, ProducerContext producerContext, String str, y0 y0Var2, ProducerContext producerContext2, ImageRequest imageRequest) {
            ...
            this.f10840q = y0Var2;
            this.f10841r = producerContext2;
            this.f10842s = imageRequest;
        }
        ...
        public void e(Exception exc) {
            super.e(exc);
            this.f10840q.b(this.f10841r, "VideoThumbnailProducer", false);
            this.f10841r.m("local", MediaStreamTrack.VIDEO_TRACK_KIND);
        }
        ...
        public CloseableReference c() {
            ...
            Bitmap bitmap;
            try {
                str = n0.this.i(this.f10842s);
            } catch (IllegalArgumentException unused) {
                str = null;
            }
            if (str != null) {
                bitmap = ThumbnailUtils.createVideoThumbnail(str, n0.g(this.f10842s));
            } else {
                bitmap = null;
            }
            if (bitmap == null) {
                bitmap = n0.h(n0.this.f10839b, this.f10842s.getSourceUri());
            }
            if (bitmap == null) {
                return null;
            }
            sa.f p12 = sa.f.p1(bitmap, ka.e.a(), sa.n.f49515d, 0);
            this.f10841r.y("image_format", "thumbnail");
            p12.W(this.f10841r.getExtras());
        ...
        public void f(CloseableReference closeableReference) {
            ...
            y0 y0Var = this.f10840q;
            ProducerContext producerContext = this.f10841r;
            if (closeableReference != null) {
                z10 = true;
            } else {
                z10 = false;
    ...
    public String i(ImageRequest imageRequest) {
        return w8.f.e(this.f10839b, imageRequest.getSourceUri());
    }
