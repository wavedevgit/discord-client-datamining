...
public class n0 implements w0 {
    ...
    private final Executor f11455a;

    /* renamed from: b  reason: collision with root package name */
    private final ContentResolver f11456b;

    /* loaded from: /home/runner/work/discord-client-datamining/discord-client-datamining/build/classes3.dex */
    class a extends e1 {

        /* renamed from: q  reason: collision with root package name */
        final /* synthetic */ y0 f11457q;

        /* renamed from: r  reason: collision with root package name */
        final /* synthetic */ ProducerContext f11458r;

        /* renamed from: s  reason: collision with root package name */
        final /* synthetic */ ImageRequest f11459s;
        ...
        a(Consumer consumer, y0 y0Var, ProducerContext producerContext, String str, y0 y0Var2, ProducerContext producerContext2, ImageRequest imageRequest) {
            ...
            this.f11457q = y0Var2;
            this.f11458r = producerContext2;
            this.f11459s = imageRequest;
        }
        ...
        public void e(Exception exc) {
            super.e(exc);
            this.f11457q.b(this.f11458r, "VideoThumbnailProducer", false);
            this.f11458r.m("local", MediaStreamTrack.VIDEO_TRACK_KIND);
        }
        ...
        public CloseableReference c() {
            ...
            Bitmap bitmap;
            try {
                str = n0.this.i(this.f11459s);
            } catch (IllegalArgumentException unused) {
                str = null;
            }
            if (str != null) {
                bitmap = ThumbnailUtils.createVideoThumbnail(str, n0.g(this.f11459s));
            } else {
                bitmap = null;
            }
            if (bitmap == null) {
                bitmap = n0.h(n0.this.f11456b, this.f11459s.getSourceUri());
            }
            if (bitmap == null) {
                return null;
            }
            ta.f N = ta.f.N(bitmap, la.e.a(), ta.n.f48672d, 0);
            this.f11458r.p("image_format", "thumbnail");
            N.J(this.f11458r.getExtras());
        ...
        public void f(CloseableReference closeableReference) {
            ...
            y0 y0Var = this.f11457q;
            ProducerContext producerContext = this.f11458r;
            if (closeableReference != null) {
                z10 = true;
            } else {
                z10 = false;
    ...
    public String i(ImageRequest imageRequest) {
        return x8.f.e(this.f11456b, imageRequest.getSourceUri());
    }
