...
public final class a1 extends j0 {
    ...
    private final ContentResolver f10713c;
    ...
    public a1(Executor executor, s8.i pooledByteBufferFactory, ContentResolver contentResolver) {
        super(executor, pooledByteBufferFactory);
        Intrinsics.checkNotNullParameter(executor, "executor");
        Intrinsics.checkNotNullParameter(pooledByteBufferFactory, "pooledByteBufferFactory");
        Intrinsics.checkNotNullParameter(contentResolver, "contentResolver");
        this.f10713c = contentResolver;
    }

    @Override // com.facebook.imagepipeline.producers.j0
    protected ta.k d(ImageRequest imageRequest) {
        Intrinsics.checkNotNullParameter(imageRequest, "imageRequest");
        InputStream openInputStream = this.f10713c.openInputStream(imageRequest.getSourceUri());
