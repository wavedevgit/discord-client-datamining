...
public class c1 implements w0 {
    ...
    private final r8.i f10310b;

    /* renamed from: c  reason: collision with root package name */
    private final w0 f10311c;

    /* renamed from: d  reason: collision with root package name */
    private final boolean f10312d;

    /* renamed from: e  reason: collision with root package name */
    private final za.d f10313e;
    ...
    private class a extends s {
        ...
        /* renamed from: d  reason: collision with root package name */
        private final za.d f10315d;

        /* renamed from: e  reason: collision with root package name */
        private final ProducerContext f10316e;
        ...
        /* loaded from: /home/runner/work/discord-client-datamining/discord-client-datamining/build/classes3.dex */
        class C0144a implements e0.d {

            /* renamed from: a  reason: collision with root package name */
            final /* synthetic */ c1 f10320a;
            ...
            public void a(sa.k kVar, int i10) {
                if (kVar != null) {
                    a aVar = a.this;
                    aVar.v(kVar, i10, (za.c) o8.j.g(aVar.f10315d.createImageTranscoder(kVar.L(), a.this.f10314c)));
                    return;
                }
                a.this.o().b(null, i10);
            }
        ...
        class b extends f {
            ...
            /* renamed from: a  reason: collision with root package name */
            final /* synthetic */ c1 f10322a;

            /* renamed from: b  reason: collision with root package name */
            final /* synthetic */ Consumer f10323b;

            b(c1 c1Var, Consumer consumer) {
                this.f10322a = c1Var;
                this.f10323b = consumer;
            }
        ...
        a(Consumer consumer, ProducerContext producerContext, boolean z10, za.d dVar) {
            super(consumer);
            this.f10317f = false;
            this.f10316e = producerContext;
            Boolean resizingAllowedOverride = producerContext.V().getResizingAllowedOverride();
            this.f10314c = resizingAllowedOverride != null ? resizingAllowedOverride.booleanValue() : z10;
            this.f10315d = dVar;
            this.f10318g = new e0(c1.this.f10309a, new C0144a(c1.this), 100);
            producerContext.h(new b(c1.this, consumer));
        }

        private sa.k A(sa.k kVar) {
            if (!this.f10316e.V().getRotationOptions().f() && kVar.q1() != 0 && kVar.q1() != -1) {
                return x(kVar, 0);
            }
            return kVar;
        }
        ...
        public void v(sa.k kVar, int i10, za.c cVar) {
            this.f10316e.F().d(this.f10316e, "ResizeAndRotateProducer");
            ImageRequest V = this.f10316e.V();
            r8.k c10 = c1.this.f10310b.c();
            try {
                try {
                    ...
                    if (c11.a() != 2) {
                        ...
                        try {
                            ...
                            kVar2.B1(fa.b.f23671b);
                            kVar2.V0();
                            this.f10316e.F().j(this.f10316e, "ResizeAndRotateProducer", y10);
                            if (c11.a() != 1) {
                                i10 |= 16;
                            }
                            o().b(kVar2, i10);
                    ...
                    this.f10316e.F().k(this.f10316e, "ResizeAndRotateProducer", e10, null);
                    if (c.d(i10)) {
                        o().onFailure(e10);
                    }
                    c10.close();
        ...
        private void w(sa.k kVar, int i10, fa.c cVar) {
            sa.k A;
            if (cVar != fa.b.f23671b && cVar != fa.b.f23681l) {
                A = z(kVar);
            } else {
                A = A(kVar);
            }
        ...
        private Map y(sa.k kVar, ResizeOptions resizeOptions, za.b bVar, String str) {
            String str2;
            if (!this.f10316e.F().f(this.f10316e, "ResizeAndRotateProducer")) {
                return null;
            }
            String str3 = kVar.getWidth() + "x" + kVar.getHeight();
            if (resizeOptions != null) {
                str2 = resizeOptions.f10062a + "x" + resizeOptions.f10063b;
            } else {
                str2 = "Unspecified";
            }
            ...
            hashMap.put("queueTime", String.valueOf(this.f10318g.f()));
        ...
        private sa.k z(sa.k kVar) {
            RotationOptions rotationOptions = this.f10316e.V().getRotationOptions();
        ...
        public void h(sa.k kVar, int i10) {
            if (!this.f10317f) {
                ...
                fa.c L = kVar.L();
                w8.e h10 = c1.h(this.f10316e.V(), kVar, (za.c) o8.j.g(this.f10315d.createImageTranscoder(L, this.f10314c)));
                if (d10 || h10 != w8.e.UNSET) {
                    if (h10 != w8.e.YES) {
                        w(kVar, i10, L);
                    } else if (this.f10318g.k(kVar, i10)) {
                        if (!d10 && !this.f10316e.L()) {
                            return;
                        }
                        this.f10318g.h();
                    }
    ...
    public c1(Executor executor, r8.i iVar, w0 w0Var, boolean z10, za.d dVar) {
        this.f10309a = (Executor) o8.j.g(executor);
        this.f10310b = (r8.i) o8.j.g(iVar);
        this.f10311c = (w0) o8.j.g(w0Var);
        this.f10313e = (za.d) o8.j.g(dVar);
        this.f10312d = z10;
    }
    ...
    private static boolean g(RotationOptions rotationOptions, sa.k kVar) {
        if (rotationOptions.i() && !rotationOptions.f()) {
            return za.e.f55697b.contains(Integer.valueOf(kVar.b1()));
        }
        kVar.y1(0);
        return false;
    }
    ...
    public static w8.e h(ImageRequest imageRequest, sa.k kVar, za.c cVar) {
        boolean z10;
        if (kVar != null && kVar.L() != fa.c.f23687d) {
            if (!cVar.d(kVar.L())) {
                return w8.e.NO;
            }
    ...
    public void b(Consumer consumer, ProducerContext producerContext) {
        this.f10311c.b(new a(consumer, producerContext, this.f10312d, this.f10313e), producerContext);
    }
}
