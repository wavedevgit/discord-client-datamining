...
public final class r implements w0 {
    ...
    private final ScheduledExecutorService f10941b;

    public r(w0 inputProducer, ScheduledExecutorService scheduledExecutorService) {
        Intrinsics.checkNotNullParameter(inputProducer, "inputProducer");
        this.f10940a = inputProducer;
        this.f10941b = scheduledExecutorService;
    }
    ...
    public static final void d(r this$0, Consumer consumer, ProducerContext context) {
        ...
        this$0.f10940a.b(consumer, context);
    }
    ...
    public void b(final Consumer consumer, final ProducerContext context) {
        ...
        ScheduledExecutorService scheduledExecutorService = this.f10941b;
        if (scheduledExecutorService != null) {
            ...
            this.f10940a.b(consumer, context);
        }
    }
}
