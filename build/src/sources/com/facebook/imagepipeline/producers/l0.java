...
public final class l0 extends j0 {
    ...
    private final Resources f11440c;
    ...
    public l0(Executor executor, s8.i pooledByteBufferFactory, Resources resources) {
        ...
        this.f11440c = resources;
    }

    private final int g(ImageRequest imageRequest) {
        AssetFileDescriptor assetFileDescriptor = null;
        try {
            assetFileDescriptor = this.f11440c.openRawResourceFd(f11439d.b(imageRequest));
    ...
    protected ta.k d(ImageRequest imageRequest) {
        ...
        return e(this.f11440c.openRawResource(f11439d.b(imageRequest)), g(imageRequest));
    }
