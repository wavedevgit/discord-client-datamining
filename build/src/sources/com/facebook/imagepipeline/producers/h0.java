...
public class h0 extends j0 implements m1 {
    ...
    private static final Class f11786d = h0.class;

    /* renamed from: e  reason: collision with root package name */
    private static final String[] f11787e = {"_id", "_data"};

    /* renamed from: f  reason: collision with root package name */
    private static final String[] f11788f = {"_data"};

    /* renamed from: g  reason: collision with root package name */
    private static final Rect f11789g = new Rect(0, 0, IntBufferBatchMountItem.INSTRUCTION_UPDATE_PADDING, 384);

    /* renamed from: h  reason: collision with root package name */
    private static final Rect f11790h = new Rect(0, 0, 96, 96);

    /* renamed from: c  reason: collision with root package name */
    private final ContentResolver f11791c;

    public h0(Executor executor, r8.i iVar, ContentResolver contentResolver) {
        super(executor, iVar);
        this.f11791c = contentResolver;
    }

    private sa.k g(Uri uri, ResizeOptions resizeOptions) {
        Cursor query;
        sa.k j10;
        if (resizeOptions == null || (query = this.f11791c.query(uri, f11787e, null, null, null)) == null) {
            return null;
        }
        try {
            if (query.moveToFirst() && (j10 = j(resizeOptions, query.getLong(query.getColumnIndex("_id")))) != null) {
                ...
                if (columnIndex >= 0) {
                    j10.E1(i(query.getString(columnIndex)));
                }
                query.close();
                return j10;
            }
    ...
    private static int i(String str) {
        if (str != null) {
            try {
                ...
                p8.a.l(f11786d, e10, "Unable to retrieve thumbnail rotation for %s", str);
                return 0;
            }
        }
        return 0;
    ...
    private sa.k j(ResizeOptions resizeOptions, long j10) {
        ...
        if (k10 == 0 || (queryMiniThumbnail = MediaStore.Images.Thumbnails.queryMiniThumbnail(this.f11791c, j10, k10, f11788f)) == null) {
            return null;
        }
        try {
