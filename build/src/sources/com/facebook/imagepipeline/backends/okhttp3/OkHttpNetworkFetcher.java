...
public class OkHttpNetworkFetcher extends d {
    ...
    public static final class a extends f {
        ...
        final /* synthetic */ Call f11024a;

        /* renamed from: b  reason: collision with root package name */
        final /* synthetic */ OkHttpNetworkFetcher f11025b;

        a(Call call, OkHttpNetworkFetcher okHttpNetworkFetcher) {
            this.f11024a = call;
            this.f11025b = okHttpNetworkFetcher;
        }
        ...
        public void b() {
            if (Intrinsics.areEqual(Looper.myLooper(), Looper.getMainLooper())) {
                Executor executor = this.f11025b.cancellationExecutor;
                final Call call = this.f11024a;
    ...
    public static final class b implements lu.b {
        ...
        final /* synthetic */ OkHttpNetworkFetchState f11026d;

        /* renamed from: e  reason: collision with root package name */
        final /* synthetic */ OkHttpNetworkFetcher f11027e;

        /* renamed from: i  reason: collision with root package name */
        final /* synthetic */ NetworkFetcher.Callback f11028i;
        ...
        b(OkHttpNetworkFetchState okHttpNetworkFetchState, OkHttpNetworkFetcher okHttpNetworkFetcher, NetworkFetcher.Callback callback) {
            this.f11026d = okHttpNetworkFetchState;
            this.f11027e = okHttpNetworkFetcher;
            this.f11028i = callback;
        }
        ...
        public void onFailure(Call call, IOException e10) {
            ...
            this.f11027e.a(call, e10, this.f11028i);
        }
        ...
        public void onResponse(Call call, Response response) {
            ...
            this.f11026d.f11022g = SystemClock.elapsedRealtime();
            ResponseBody n10 = response.n();
            if (n10 != null) {
                OkHttpNetworkFetcher okHttpNetworkFetcher = this.f11027e;
                NetworkFetcher.Callback callback = this.f11028i;
                OkHttpNetworkFetchState okHttpNetworkFetchState = this.f11026d;
                try {
                    try {
                        if (!response.isSuccessful()) {
                            okHttpNetworkFetcher.a(call, okHttpNetworkFetcher.b("Unexpected HTTP code " + response, response), callback);
                        } else {
                            BytesRange c10 = BytesRange.f11040c.c(response.J("Content-Range"));
                            if (c10 != null && (c10.f11042a != 0 || c10.f11043b != Integer.MAX_VALUE)) {
                ...
                OkHttpNetworkFetcher okHttpNetworkFetcher2 = this.f11027e;
                okHttpNetworkFetcher2.a(call, okHttpNetworkFetcher2.b("Response body null: " + response, response), this.f11028i);
            }
        }
    }
    ...
    public final IOException b(String str, Response response) {
        return new IOException(str, c.f11031i.a(response));
    }
    ...
    public void fetchWithRequest(@NotNull OkHttpNetworkFetchState fetchState, @NotNull NetworkFetcher.Callback callback, @NotNull Request request) {
        ...
        a10.b1(new b(fetchState, this, callback));
    }
    ...
    public Map<String, String> getExtraMap(@NotNull OkHttpNetworkFetchState fetchState, int i10) {
        Intrinsics.checkNotNullParameter(fetchState, "fetchState");
        return o0.m(v.a(QUEUE_TIME, String.valueOf(fetchState.f11022g - fetchState.f11021f)), v.a(FETCH_TIME, String.valueOf(fetchState.f11023h - fetchState.f11022g)), v.a(TOTAL_TIME, String.valueOf(fetchState.f11023h - fetchState.f11021f)), v.a(IMAGE_SIZE, String.valueOf(i10)));
    }

    @Override // com.facebook.imagepipeline.producers.NetworkFetcher
    public void onFetchCompletion(@NotNull OkHttpNetworkFetchState fetchState, int i10) {
        Intrinsics.checkNotNullParameter(fetchState, "fetchState");
        fetchState.f11023h = SystemClock.elapsedRealtime();
    }
