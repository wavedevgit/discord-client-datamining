...
public class e extends a implements s8.a {
    ...
    public e(s8.d memoryTrimmableRegistry, z poolParams, a0 poolStatsTracker) {
        ...
        SparseIntArray sparseIntArray = poolParams.f52467c;
        if (sparseIntArray != null) {
            this.f11249k = new int[sparseIntArray.size()];
            int size = sparseIntArray.size();
            for (int i10 = 0; i10 < size; i10++) {
                this.f11249k[i10] = sparseIntArray.keyAt(i10);
            }
        } else {
            this.f11249k = new int[0];
        }
        s();
    }
