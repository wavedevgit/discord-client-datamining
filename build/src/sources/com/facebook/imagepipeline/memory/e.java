...
public class e extends a implements r8.a {
    ...
    public e(r8.d memoryTrimmableRegistry, z poolParams, a0 poolStatsTracker) {
        ...
        SparseIntArray sparseIntArray = poolParams.f50984c;
        if (sparseIntArray != null) {
            this.f11280k = new int[sparseIntArray.size()];
            int size = sparseIntArray.size();
            for (int i10 = 0; i10 < size; i10++) {
                this.f11280k[i10] = sparseIntArray.keyAt(i10);
            }
        } else {
            this.f11280k = new int[0];
        }
        s();
    }
