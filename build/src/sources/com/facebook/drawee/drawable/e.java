...
public class e extends a {
    ...
    private final Drawable[] f9940t;

    /* renamed from: u  reason: collision with root package name */
    private final boolean f9941u;

    /* renamed from: v  reason: collision with root package name */
    private final int f9942v;

    /* renamed from: w  reason: collision with root package name */
    private final int f9943w;
    ...
    private void p() {
        if (this.H && this.f9944x == 2 && this.D[this.f9943w]) {
            z9.m mVar = this.F;
            if (mVar != null) {
                mVar.b();
            }
    ...
    private void q() {
        this.f9944x = 2;
        Arrays.fill(this.A, this.f9942v);
        this.A[0] = 255;
        Arrays.fill(this.B, this.f9942v);
        this.B[0] = 255;
        Arrays.fill(this.D, this.f9941u);
        this.D[0] = true;
    }
    ...
    private boolean s(float f10) {
        int i10;
        boolean z10 = true;
        for (int i11 = 0; i11 < this.f9940t.length; i11++) {
    ...
    */
    public void draw(android.graphics.Canvas r9) {
        ...
        L2c:
            int[] r0 = r8.B
            int[] r4 = r8.A
            android.graphics.drawable.Drawable[] r5 = r8.f9940t
            int r5 = r5.length
        ...
        L4f:
            ...
            goto L2a
        L52:
            android.graphics.drawable.Drawable[] r0 = r8.f9940t
            int r1 = r0.length
            if (r2 >= r1) goto L72
            r0 = r0[r2]
            int[] r1 = r8.B
