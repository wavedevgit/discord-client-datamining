...
public abstract class b {
    ...
    private static final Drawable f11178a = new ColorDrawable(0);
    ...
    public static Drawable d(Drawable drawable, a aVar, Resources resources) {
        try {
            ...
            if (drawable != null && aVar != null && aVar.m() == a.EnumC0151a.BITMAP_ONLY) {
                if (drawable instanceof f) {
                    c c10 = c((f) drawable);
                    c10.setDrawable(a(c10.setDrawable(f11178a), aVar, resources));
                    return drawable;
                }
    ...
    public static Drawable e(Drawable drawable, a aVar) {
        try {
            ...
            if (drawable != null && aVar != null && aVar.m() == a.EnumC0151a.OVERLAY_COLOR) {
    ...
    public static void i(c cVar, a aVar, Resources resources) {
        ...
        if (aVar != null && aVar.m() == a.EnumC0151a.BITMAP_ONLY) {
            if (drawable instanceof h) {
                b((h) drawable, aVar);
            } else if (drawable != null) {
                c10.setDrawable(f11178a);
    ...
    public static void j(c cVar, a aVar) {
        Drawable drawable = cVar.getDrawable();
        if (aVar != null && aVar.m() == a.EnumC0151a.OVERLAY_COLOR) {
            ...
            cVar.setDrawable(e(cVar.setDrawable(f11178a), aVar));
        } else if (drawable instanceof k) {
            Drawable drawable2 = f11178a;
    ...
    public static n k(c cVar, ScalingUtils$ScaleType scalingUtils$ScaleType) {
        Drawable f10 = f(cVar.setDrawable(f11178a), scalingUtils$ScaleType);
