...
public final class ReadableMapBuffer extends HybridClassBase implements MapBuffer {
    ...
    public final class MapBufferEntry implements MapBuffer.Entry {
        ...
        @Override // com.facebook.react.common.mapbuffer.MapBuffer.Entry
        public int getKey() {
            return ReadableMapBuffer.this.m1162readUnsignedShortBwKQO78(this.bucketOffset) & 65535;
        }
        ...
        public MapBuffer.DataType getType() {
            if (ReactNativeFeatureFlags.enableAndroidTextMeasurementOptimizations()) {
                return ReadableMapBuffer.DATA_TYPES[65535 & ReadableMapBuffer.this.m1162readUnsignedShortBwKQO78(this.bucketOffset + 2)];
            }
            return MapBuffer.DataType.values()[65535 & ReadableMapBuffer.this.m1162readUnsignedShortBwKQO78(this.bucketOffset + 2)];
        }
    }
    ...
    private final int getBucketIndexForKey(int i10) {
        ...
        if (i10 <= kEY_RANGE$ReactAndroid_release.e() && d10 <= i10) {
            ...
            while (i11 <= count) {
                int i12 = (i11 + count) >>> 1;
                int m1162readUnsignedShortBwKQO78 = m1162readUnsignedShortBwKQO78(getKeyOffsetForBucketIndex(i12)) & 65535;
                int i13 = 65535 & d11;
                if (Intrinsics.compare(m1162readUnsignedShortBwKQO78, i13) < 0) {
                    i11 = i12 + 1;
                } else if (Intrinsics.compare(m1162readUnsignedShortBwKQO78, i13) > 0) {
                    count = i12 - 1;
                } else {
                    return i12;
                }
    ...
    private final MapBuffer.DataType readDataType(int i10) {
        int m1162readUnsignedShortBwKQO78 = m1162readUnsignedShortBwKQO78(getKeyOffsetForBucketIndex(i10) + 2) & 65535;
        if (ReactNativeFeatureFlags.enableAndroidTextMeasurementOptimizations()) {
            return DATA_TYPES[m1162readUnsignedShortBwKQO78];
        }
        return MapBuffer.DataType.values()[m1162readUnsignedShortBwKQO78];
    }
    ...
    private final void readHeader() {
        ...
        this.count = m1162readUnsignedShortBwKQO78(this.buffer.position()) & 65535;
    }
    ...
    public final short m1162readUnsignedShortBwKQO78(int i10) {
