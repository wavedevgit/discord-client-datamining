...
public final class MultiplicationAnimatedNode extends ValueAnimatedNode {
    ...
    public String prettyPrint$ReactAndroid_release() {
        ...
        return "MultiplicationAnimatedNode[" + i10 + "]: input nodes: " + iArr + " - super: " + prettyPrint$ReactAndroid_release;
    }
    ...
    public void update$ReactAndroid_release() {
        ...
        for (int i10 = 0; i10 < length; i10++) {
            AnimatedNode nodeById = this.nativeAnimatedNodesManager.getNodeById(this.inputNodes[i10]);
