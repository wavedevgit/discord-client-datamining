...
public final class Inspector {
    ...
    public static final class Companion {
        ...
        public final LocalConnection connect(int i10, @NotNull RemoteConnection remote) {
            ...
            try {
                ...
                q8.a.n(ReactConstants.TAG, "Inspector doesn't work in open source yet", e10);
    ...
    public static final class Page {
        ...
        private final int f11638id;
        @NotNull
        private final String title;
        @NotNull

        /* renamed from: vm  reason: collision with root package name */
        private final String f11639vm;
        ...
        public final String getVM() {
            return this.f11639vm;
        }

        @NotNull
        public String toString() {
            int i10 = this.f11638id;
