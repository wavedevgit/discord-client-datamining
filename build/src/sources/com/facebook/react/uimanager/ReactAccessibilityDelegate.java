...
public class ReactAccessibilityDelegate extends ExploreByTouchHelper {
    ...
    static {
        ...
        sCounter = 1056964608;
        delimiterLength = 2;
        hashMap.put("activate", Integer.valueOf(AccessibilityNodeInfoCompat.a.f3316i.b()));
        hashMap.put("longpress", Integer.valueOf(AccessibilityNodeInfoCompat.a.f3317j.b()));
        hashMap.put("increment", Integer.valueOf(AccessibilityNodeInfoCompat.a.f3324q.b()));
        hashMap.put("decrement", Integer.valueOf(AccessibilityNodeInfoCompat.a.f3325r.b()));
        hashMap.put("expand", Integer.valueOf(AccessibilityNodeInfoCompat.a.f3330w.b()));
        hashMap.put(StackTraceHelper.COLLAPSE_KEY, Integer.valueOf(AccessibilityNodeInfoCompat.a.f3331x.b()));
    }
    ...
    public boolean performAccessibilityAction(View view, int i10, Bundle bundle) {
        ...
        if (this.mAccessibilityActionsMap.containsKey(Integer.valueOf(i10))) {
            ...
            if (accessibilityRole == AccessibilityRole.ADJUSTABLE) {
                if (i10 == AccessibilityNodeInfoCompat.a.f3324q.b() || i10 == AccessibilityNodeInfoCompat.a.f3325r.b()) {
