...
public final class BorderDrawable extends Drawable {
    ...
    public void draw(@NotNull Canvas canvas) {
        ...
        if (numArr == null || (colorEdges = BorderColors.m1167resolveimpl(numArr, getLayoutDirection(), this.context)) == null) {
    ...
    public final void setBorderColor(@NotNull LogicalEdge position, Integer num) {
        ...
        Integer[] numArr = this.borderColors;
        if (numArr == null) {
            numArr = BorderColors.m1163constructorimpl$default(null, 1, null);
        }
