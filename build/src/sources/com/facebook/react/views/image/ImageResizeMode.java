...
public final class ImageResizeMode {
    ...
    public static final ScalingUtils$ScaleType defaultValue() {
        ScalingUtils$ScaleType CENTER_CROP = ScalingUtils$ScaleType.f9922i;
            ...
            switch (str.hashCode()) {
                case -1881872635:
                    if (str.equals(RESIZE_MODE_STRETCH)) {
                        ScalingUtils$ScaleType FIT_XY = ScalingUtils$ScaleType.f9914a;
                ...
                case -1364013995:
                    if (str.equals(RESIZE_MODE_CENTER)) {
                        ScalingUtils$ScaleType CENTER_INSIDE = ScalingUtils$ScaleType.f9921h;
                ...
                case 951526612:
                    if (str.equals(RESIZE_MODE_CONTAIN)) {
                        ScalingUtils$ScaleType FIT_CENTER = ScalingUtils$ScaleType.f9918e;
