    ...
    */
    ...
    public final void setTextContentType(@NotNull ReactEditText view, String str) {
        ...
        if (str == null) {
            ...
            q8.a.J(ReactConstants.TAG, "Invalid autoComplete: " + str);
            setImportantForAutofill(view, 2);
        }
    }
        ...
        if (background != null) {
            if (background.getConstantState() != null) {
                try {
                    ...
                    q8.a.n(TAG, "NullPointerException when setting underlineColorAndroid for TextInput", e10);
                }
            }
            if (num == null) {
