...
public final class ReactVirtualView extends ReactViewGroup implements ReactScrollViewHelper.ScrollListener, ReactScrollViewHelper.LayoutChangeListener, View.OnLayoutChangeListener {
    ...
    public static /* synthetic */ void debugLog$ReactAndroid_release$default(ReactVirtualView reactVirtualView, String subtag, Function0 block, int i10, Object obj) {
        ...
        if (reactVirtualView.getDebugLogEnabled$ReactAndroid_release()) {
            ...
            if (z10) {
                q8.a.b("ReactVirtualView:" + subtag, block.invoke() + " [" + reactVirtualView.getId() + "][" + reactVirtualView.getNativeId$ReactAndroid_release() + "]");
                return;
            }
            q8.a.J("ReactVirtualView:" + subtag, block.invoke() + " [" + reactVirtualView.getId() + "][" + reactVirtualView.getNativeId$ReactAndroid_release() + "]");
        }
    }
        ...
        if (this.modeChangeEmitter != null && (view = this.parentScrollView) != null) {
            ...
            if ((this.targetRect.width() == 0 && this.targetRect.height() == 0) || this.thresholdRect.isEmpty()) {
                if (getDebugLogEnabled$ReactAndroid_release()) {
                    ...
                    if (z14) {
                        ...
                        q8.a.b("ReactVirtualView:dispatchOnModeChangeIfNeeded", ((Object) str) + " [" + getId() + "][" + getNativeId$ReactAndroid_release() + "]");
                        return;
                    }
                    String str2 = "empty rects target=" + this.targetRect.toShortString() + " threshold=" + this.thresholdRect.toShortString();
                    q8.a.J("ReactVirtualView:dispatchOnModeChangeIfNeeded", ((Object) str2) + " [" + getId() + "][" + getNativeId$ReactAndroid_release() + "]");
                    return;
                }
                return;
            }
            if (z10) {
                if (!this.lastRect.isEmpty() && Intrinsics.areEqual(this.lastRect, this.targetRect)) {
                    if (getDebugLogEnabled$ReactAndroid_release()) {
                        ...
                        if (z13) {
                            q8.a.b("ReactVirtualView:dispatchOnModeChangeIfNeeded", ((Object) "no rect change") + " [" + getId() + "][" + getNativeId$ReactAndroid_release() + "]");
                            return;
                        }
                        q8.a.J("ReactVirtualView:dispatchOnModeChangeIfNeeded", ((Object) "no rect change") + " [" + getId() + "][" + getNativeId$ReactAndroid_release() + "]");
                        return;
                    }
                    return;
                }
            ...
            if (getDebugLogEnabled$ReactAndroid_release()) {
                ...
                if (z12) {
                    ...
                    q8.a.b("ReactVirtualView:dispatchOnModeChangeIfNeeded", ((Object) str3) + " [" + getId() + "][" + getNativeId$ReactAndroid_release() + "]");
                } else {
                    String str4 = "mode=" + this.mode + " target=" + this.targetRect.toShortString() + " threshold=" + this.thresholdRect.toShortString();
                    q8.a.J("ReactVirtualView:dispatchOnModeChangeIfNeeded", ((Object) str4) + " [" + getId() + "][" + getNativeId$ReactAndroid_release() + "]");
                }
            }
    ...
    private final void maybeEmitModeChanges(VirtualViewMode virtualViewMode, VirtualViewMode virtualViewMode2) {
        ...
        if (getDebugLogEnabled$ReactAndroid_release()) {
            ...
            if (z10) {
                ...
                q8.a.b("ReactVirtualView:Mode change", ((Object) str) + " [" + getId() + "][" + getNativeId$ReactAndroid_release() + "]");
            } else {
                String str2 = virtualViewMode + "->" + virtualViewMode2;
                q8.a.J("ReactVirtualView:Mode change", ((Object) str2) + " [" + getId() + "][" + getNativeId$ReactAndroid_release() + "]");
            }
        }
        rb.a.c(0L, "VirtualView::mode change " + virtualViewMode + " -> " + virtualViewMode2 + ", nativeID=" + getNativeId$ReactAndroid_release());
    ...
    public final void debugLog$ReactAndroid_release(@NotNull String subtag, @NotNull Function0<String> block) {
        ...
        if (getDebugLogEnabled$ReactAndroid_release()) {
            z10 = ReactVirtualViewKt.IS_DEBUG_BUILD;
            if (z10) {
                q8.a.b("ReactVirtualView:" + subtag, block.invoke() + " [" + getId() + "][" + getNativeId$ReactAndroid_release() + "]");
                return;
            }
            q8.a.J("ReactVirtualView:" + subtag, block.invoke() + " [" + getId() + "][" + getNativeId$ReactAndroid_release() + "]");
        }
    }
    ...
    public final void doAttachedToWindow$ReactAndroid_release() {
        ...
        if (getDebugLogEnabled$ReactAndroid_release()) {
            z10 = ReactVirtualViewKt.IS_DEBUG_BUILD;
            if (z10) {
                q8.a.b("ReactVirtualView:onAttachedToWindow", ((Object) "") + " [" + getId() + "][" + getNativeId$ReactAndroid_release() + "]");
            } else {
                q8.a.J("ReactVirtualView:onAttachedToWindow", ((Object) "") + " [" + getId() + "][" + getNativeId$ReactAndroid_release() + "]");
            }
        }
        if (this.detectWindowFocus) {
