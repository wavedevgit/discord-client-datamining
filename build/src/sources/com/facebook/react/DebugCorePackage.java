...
public final class DebugCorePackage extends BaseReactPackage implements ViewManagerOnDemandReactPackage {
    @NotNull
    private final Lazy viewManagersMap$delegate = lr.l.b(lr.o.f37121i, new Function0() { // from class: com.facebook.react.b
    ...
    public static final Map viewManagersMap_delegate$lambda$1() {
        return o0.f(lr.v.a(DebuggingOverlayManager.REACT_CLASS, ModuleSpec.Companion.viewManagerSpec(new Provider() { // from class: com.facebook.react.d
