    ...
    public static final class Companion {
        ...
        private final Dialog createAppCompatDialog(Context context, Bundle bundle, DialogInterface.OnClickListener onClickListener) {
            ...
            if (bundle.containsKey("title")) {
                ...
                c0016a.b(getAccessibleTitle(context, str));
            }
            if (bundle.containsKey(AlertFragment.ARG_BUTTON_POSITIVE)) {
                c0016a.i(bundle.getString(AlertFragment.ARG_BUTTON_POSITIVE), onClickListener);
            }
            if (bundle.containsKey(AlertFragment.ARG_BUTTON_NEGATIVE)) {
                c0016a.f(bundle.getString(AlertFragment.ARG_BUTTON_NEGATIVE), onClickListener);
            }
            if (bundle.containsKey(AlertFragment.ARG_BUTTON_NEUTRAL)) {
                c0016a.g(bundle.getString(AlertFragment.ARG_BUTTON_NEUTRAL), onClickListener);
            }
            if (bundle.containsKey("message")) {
                c0016a.e(bundle.getString("message"));
            }
            if (bundle.containsKey(AlertFragment.ARG_ITEMS)) {
                c0016a.d(bundle.getCharSequenceArray(AlertFragment.ARG_ITEMS), onClickListener);
            }
        ...
        private final boolean isAppCompatTheme(Context context) {
            TypedArray obtainStyledAttributes = context.obtainStyledAttributes(j.f22457y0);
