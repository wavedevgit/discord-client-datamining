    ...
    public static final class Companion {
        ...
        private final Dialog createAppCompatDialog(Context context, Bundle bundle, DialogInterface.OnClickListener onClickListener) {
            ...
            if (bundle.containsKey("title")) {
                String str = (String) eb.a.c(bundle.getString("title"));
        ...
        private final View getAccessibleTitle(Context context, String str) {
            ...
            Object c10 = eb.a.c(inflate.findViewById(R.id.alert_title));
            ...
            i0.k0(textView, new androidx.core.view.a() { // from class: com.facebook.react.modules.dialog.AlertFragment$Companion$getAccessibleTitle$1
