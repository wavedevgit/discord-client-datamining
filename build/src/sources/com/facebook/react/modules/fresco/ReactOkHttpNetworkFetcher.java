...
public final class ReactOkHttpNetworkFetcher extends OkHttpNetworkFetcher {
    ...
    public void fetch(@NotNull OkHttpNetworkFetcher.OkHttpNetworkFetchState fetchState, @NotNull NetworkFetcher.Callback callback) {
        ...
        fetchState.f10443f = SystemClock.elapsedRealtime();
        Uri g10 = fetchState.g();
        Intrinsics.checkNotNullExpressionValue(g10, "getUri(...)");
        CacheControl.a aVar = new CacheControl.a();
        if (fetchState.b().I() instanceof ReactNetworkImageRequest) {
            ImageRequest I = fetchState.b().I();
            Intrinsics.checkNotNull(I, "null cannot be cast to non-null type com.facebook.react.modules.fresco.ReactNetworkImageRequest");
            ReactNetworkImageRequest reactNetworkImageRequest = (ReactNetworkImageRequest) I;
        ...
        Headers.b bVar = Headers.f42023e;
        if (map == null) {
            map = o0.i();
        }
