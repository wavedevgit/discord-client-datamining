...
public final class SystraceRequestListener extends a {
    ...
    public void onProducerEvent(@NotNull String requestId, @NotNull String producerName, @NotNull String eventName) {
        ...
        qb.a.n(0L, "FRESCO_PRODUCER_EVENT_" + StringsKt.I(requestId, ':', '_', false, 4, null) + "_" + StringsKt.I(producerName, ':', '_', false, 4, null) + "_" + StringsKt.I(eventName, ':', '_', false, 4, null), a.EnumC0564a.f47050e);
    }
