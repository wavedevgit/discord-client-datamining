...
public final class ReconnectingWebSocket extends l {
    ...
    private final void abort(String str, Throwable th2) {
        String str2 = TAG;
        q8.a.n(str2, "Error occurred, shutting down websocket connection: " + str, th2);
        closeWebSocketQuietly();
    }
    ...
    private final void reconnect() {
        if (!this.closed) {
            if (!this.suppressConnectionErrors) {
                ...
                q8.a.J(str, "Couldn't connect to \"" + str2 + "\", will silently retry");
