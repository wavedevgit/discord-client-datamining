    ...
    public void setProperty(T t10, String str, Object obj) {
        ...
        switch (c10) {
            case 0:
                ...
                rNSVGClipPathManagerInterface.setFilter(t10, str2);
                return;
            case 1:
                ...
                return;
            case 2:
                ((RNSVGClipPathManagerInterface) this.mViewManager).setMatrix(t10, (ReadableArray) obj);
                return;
            case 3:
                ((RNSVGClipPathManagerInterface) this.mViewManager).setPropList(t10, (ReadableArray) obj);
                return;
            case 4:
                ...
                rNSVGClipPathManagerInterface2.setMarkerEnd(t10, str2);
                return;
            case 5:
                ...
                rNSVGClipPathManagerInterface3.setMarkerMid(t10, str2);
                return;
            case 6:
                ((RNSVGClipPathManagerInterface) this.mViewManager).setStroke(t10, new DynamicFromObject(obj));
                return;
            case 7:
                ((RNSVGClipPathManagerInterface) this.mViewManager).setFontWeight(t10, new DynamicFromObject(obj));
                return;
            case '\b':
                ...
                rNSVGClipPathManagerInterface4.setFillRule(t10, i10);
                return;
            case '\t':
                ...
                rNSVGClipPathManagerInterface5.setStrokeOpacity(t10, f11);
                return;
            case '\n':
                ...
                rNSVGClipPathManagerInterface6.setPointerEvents(t10, str2);
                return;
            case 11:
                ...
                rNSVGClipPathManagerInterface7.setFillOpacity(t10, f11);
                return;
            case '\f':
                ...
                rNSVGClipPathManagerInterface8.setStrokeDashoffset(t10, f10);
                return;
            case '\r':
                ((RNSVGClipPathManagerInterface) this.mViewManager).setFill(t10, new DynamicFromObject(obj));
                return;
            case 14:
                ((RNSVGClipPathManagerInterface) this.mViewManager).setFont(t10, new DynamicFromObject(obj));
                return;
            case 15:
                ...
                rNSVGClipPathManagerInterface9.setMask(t10, str2);
                return;
            case 16:
                ...
                rNSVGClipPathManagerInterface10.setName(t10, str2);
                return;
            case 17:
                ...
                rNSVGClipPathManagerInterface11.setStrokeMiterlimit(t10, f10);
                return;
            case ChatViewRecyclerTypes.EPHEMERAL_INDICATION /* 18 */:
                ((RNSVGClipPathManagerInterface) this.mViewManager).setColor(t10, ColorPropConverter.getColor(obj, t10.getContext()));
                return;
            case ChatViewRecyclerTypes.INTERACTION_STATUS /* 19 */:
                ...
                rNSVGClipPathManagerInterface12.setVectorEffect(t10, i11);
                return;
            case 20:
                ...
                rNSVGClipPathManagerInterface13.setMarkerStart(t10, str2);
                return;
            case ChatViewRecyclerTypes.FLAGGED_MESSAGE_EMBED /* 21 */:
                ((RNSVGClipPathManagerInterface) this.mViewManager).setFontSize(t10, new DynamicFromObject(obj));
                return;
            case ChatViewRecyclerTypes.FLAGGED_MESSAGE_ACTION_BAR /* 22 */:
                ((RNSVGClipPathManagerInterface) this.mViewManager).setStrokeDasharray(t10, new DynamicFromObject(obj));
                return;
            case 23:
                ...
                rNSVGClipPathManagerInterface14.setClipPath(t10, str2);
                return;
            case ChatViewRecyclerTypes.SURVEY_INDICATION /* 24 */:
                ...
                rNSVGClipPathManagerInterface15.setClipRule(t10, i14);
                return;
            case ChatViewRecyclerTypes.GUILD_INVITE_DISABLED /* 25 */:
                ...
                rNSVGClipPathManagerInterface16.setStrokeLinecap(t10, i13);
                return;
            case ChatViewRecyclerTypes.MEDIA_MOSAIC_ATTACHMENT /* 26 */:
                ...
                rNSVGClipPathManagerInterface17.setDisplay(t10, str2);
                return;
            case 27:
                ...
                rNSVGClipPathManagerInterface18.setStrokeLinejoin(t10, i12);
                return;
            case 28:
                RNSVGClipPathManagerInterface rNSVGClipPathManagerInterface19 = (RNSVGClipPathManagerInterface) this.mViewManager;
                if (obj != null) {
                    z10 = ((Boolean) obj).booleanValue();
                }
                rNSVGClipPathManagerInterface19.setResponsible(t10, z10);
                return;
            case 29:
                ((RNSVGClipPathManagerInterface) this.mViewManager).setStrokeWidth(t10, new DynamicFromObject(obj));
                return;
            default:
