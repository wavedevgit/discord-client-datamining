    ...
    public void setProperty(T t10, String str, Object obj) {
        ...
        switch (c10) {
            case 0:
                ...
                rNSModalScreenManagerInterface.setSynchronousShadowStateUpdatesEnabled(t10, z11);
                return;
            case 1:
                ...
                rNSModalScreenManagerInterface2.setHomeIndicatorHidden(t10, z23);
                return;
            case 2:
                ...
                rNSModalScreenManagerInterface3.setGestureEnabled(t10, z10);
                return;
            case 3:
                ...
                rNSModalScreenManagerInterface4.setHideKeyboardOnSwipe(t10, z22);
                return;
            case 4:
                ...
                rNSModalScreenManagerInterface5.setSheetCornerRadius(t10, f10);
                return;
            case 5:
                ...
                rNSModalScreenManagerInterface6.setNavigationBarHidden(t10, z21);
                return;
            case 6:
                ...
                rNSModalScreenManagerInterface7.setStatusBarTranslucent(t10, z20);
                return;
            case 7:
            ...
            case '\b':
                ...
                rNSModalScreenManagerInterface8.setActivityState(t10, f10);
                return;
            case '\t':
            ...
            case '\n':
                ...
                rNSModalScreenManagerInterface9.setStatusBarStyle(t10, str3);
                return;
            case 11:
                ...
                rNSModalScreenManagerInterface10.setFullScreenSwipeShadowEnabled(t10, z10);
                return;
            case '\f':
            ...
            case 14:
                ...
                rNSModalScreenManagerInterface11.setScreenId(t10, str2);
                return;
            case 15:
                ...
                rNSModalScreenManagerInterface12.setSheetInitialDetent(t10, i11);
                return;
            case 16:
            ...
            case ChatViewRecyclerTypes.EPHEMERAL_INDICATION /* 18 */:
                ...
                rNSModalScreenManagerInterface13.setPreventNativeDismiss(t10, z19);
                return;
            case ChatViewRecyclerTypes.INTERACTION_STATUS /* 19 */:
                ...
                rNSModalScreenManagerInterface14.setStatusBarHidden(t10, z18);
                return;
            case 20:
            ...
            case ChatViewRecyclerTypes.FLAGGED_MESSAGE_ACTION_BAR /* 22 */:
                ...
                rNSModalScreenManagerInterface15.setScreenOrientation(t10, str3);
                return;
            case 23:
                ...
                rNSModalScreenManagerInterface16.setSheetLargestUndimmedDetent(t10, i12);
                return;
            case ChatViewRecyclerTypes.SURVEY_INDICATION /* 24 */:
                ...
                rNSModalScreenManagerInterface17.setTransitionDuration(t10, intValue);
                return;
            case ChatViewRecyclerTypes.GUILD_INVITE_DISABLED /* 25 */:
                ...
                rNSModalScreenManagerInterface18.setSheetShouldOverflowTopInset(t10, z17);
                return;
            ...
            case 27:
                ...
                rNSModalScreenManagerInterface19.setCustomAnimationOnSwipe(t10, z16);
                return;
            case 28:
                ...
                rNSModalScreenManagerInterface20.setNavigationBarTranslucent(t10, z15);
                return;
            case 29:
                ...
                rNSModalScreenManagerInterface21.setSheetElevation(t10, i10);
                return;
            case 30:
                ...
                rNSModalScreenManagerInterface22.setSheetDefaultResizeAnimationEnabled(t10, z10);
                return;
            case ChatViewRecyclerTypes.EMBEDDED_ACTIVITY_INVITE /* 31 */:
                ...
                rNSModalScreenManagerInterface23.setSheetGrabberVisible(t10, z14);
                return;
            case ' ':
                RNSModalScreenManagerInterface rNSModalScreenManagerInterface24 = (RNSModalScreenManagerInterface) this.mViewManager;
                if (obj != null) {
                    str3 = (String) obj;
                }
                rNSModalScreenManagerInterface24.setStatusBarAnimation(t10, str3);
                return;
            case ChatViewRecyclerTypes.AUTO_MODERATION_NOTIFICATION_EMBED /* 33 */:
                RNSModalScreenManagerInterface rNSModalScreenManagerInterface25 = (RNSModalScreenManagerInterface) this.mViewManager;
                if (obj != null) {
                    z13 = ((Boolean) obj).booleanValue();
                }
                rNSModalScreenManagerInterface25.setNativeBackButtonDismissalEnabled(t10, z13);
                return;
            case ChatViewRecyclerTypes.CHANNEL_DEADCHAT_PROMPT_ACTIONS /* 34 */:
                RNSModalScreenManagerInterface rNSModalScreenManagerInterface26 = (RNSModalScreenManagerInterface) this.mViewManager;
                if (obj != null) {
                    z12 = ((Boolean) obj).booleanValue();
                }
                rNSModalScreenManagerInterface26.setSheetExpandsWhenScrolledToEdge(t10, z12);
                return;
            default:
