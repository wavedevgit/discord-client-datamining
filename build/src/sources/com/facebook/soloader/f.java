...
public class f extends e0 {
    ...
    protected final File f12444a;

    /* renamed from: b  reason: collision with root package name */
    protected int f12445b;

    /* renamed from: c  reason: collision with root package name */
    protected final List f12446c;
    ...
    public int d(String str, int i10, StrictMode.ThreadPolicy threadPolicy) {
        return g(str, i10, this.f12444a, threadPolicy);
    }

    public File f(String str) {
        File file = new File(this.f12444a, str);
        if (file.exists()) {
            return file;
        }
        return null;
    ...
    protected int g(String str, int i10, File file, StrictMode.ThreadPolicy threadPolicy) {
        if (SoLoader.f12418b != null) {
            ...
            try {
                SoLoader.f12418b.a(canonicalPath, i10);
                return 1;
    ...
    public String toString() {
        ...
        return c() + "[root = " + name + " flags = " + this.f12445b + ']';
    }

    public f(File file, int i10, String[] strArr) {
        this.f12444a = file;
        this.f12445b = i10;
        this.f12446c = Arrays.asList(strArr);
    }
}
