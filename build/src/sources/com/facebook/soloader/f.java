...
public class f extends e0 {
    ...
    protected final File f11465a;

    /* renamed from: b  reason: collision with root package name */
    protected int f11466b;

    /* renamed from: c  reason: collision with root package name */
    protected final List f11467c;
    ...
    public int d(String str, int i10, StrictMode.ThreadPolicy threadPolicy) {
        return g(str, i10, this.f11465a, threadPolicy);
    }

    public File f(String str) {
        File file = new File(this.f11465a, str);
        if (file.exists()) {
            return file;
        }
        return null;
    ...
    protected int g(String str, int i10, File file, StrictMode.ThreadPolicy threadPolicy) {
        if (SoLoader.f11439b != null) {
            if (this.f11467c.contains(str)) {
            ...
            try {
                SoLoader.f11439b.a(canonicalPath, i10);
                return 1;
    ...
    public String toString() {
        ...
        return c() + "[root = " + name + " flags = " + this.f11466b + ']';
    }

    public f(File file, int i10, String[] strArr) {
        this.f11465a = file;
        this.f11466b = i10;
        this.f11467c = Arrays.asList(strArr);
    }
}
