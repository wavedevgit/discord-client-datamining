...
public class f extends e0 {
    ...
    protected final File f12042a;

    /* renamed from: b  reason: collision with root package name */
    protected int f12043b;

    /* renamed from: c  reason: collision with root package name */
    protected final List f12044c;
    ...
    public int d(String str, int i10, StrictMode.ThreadPolicy threadPolicy) {
        return g(str, i10, this.f12042a, threadPolicy);
    }

    public File f(String str) {
        File file = new File(this.f12042a, str);
        if (file.exists()) {
            return file;
        }
        return null;
    ...
    protected int g(String str, int i10, File file, StrictMode.ThreadPolicy threadPolicy) {
        if (SoLoader.f12016b != null) {
            ...
            try {
                SoLoader.f12016b.a(canonicalPath, i10);
                return 1;
    ...
    public String toString() {
        ...
        return c() + "[root = " + name + " flags = " + this.f12043b + ']';
    }

    public f(File file, int i10, String[] strArr) {
        this.f12042a = file;
        this.f12043b = i10;
        this.f12044c = Arrays.asList(strArr);
    }
}
