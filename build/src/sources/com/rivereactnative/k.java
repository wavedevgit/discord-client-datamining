...
public final class k extends RiveAnimationView {
    ...
    private final ThemedReactContext f17696d;
    ...
    public void onAttachedToWindow() {
        try {
            ...
            n.f17706a.b(e10, "ReactNativeRiveAnimationView.onAttachedToWindow - RiveException");
        } catch (Exception e11) {
            n.f17706a.b(e11, "ReactNativeRiveAnimationView.onAttachedToWindow - Exception");
        }
    }
}
