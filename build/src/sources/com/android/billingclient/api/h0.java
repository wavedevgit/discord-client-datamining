...
public final class h0 extends BroadcastReceiver {
    ...
    public final void onReceive(Context context, Intent intent) {
        ...
        if (extras == null) {
            ...
            tVar3 = this.f8669c.f8674c;
            BillingResult billingResult = u.f8729j;
            tVar3.e(s.a(11, 1, billingResult));
            i0 i0Var = this.f8669c;
            kVar4 = i0Var.f8673b;
            if (kVar4 != null) {
                kVar5 = i0Var.f8673b;
        ...
        if (!action.equals("com.android.vending.billing.PURCHASES_UPDATED") && !action.equals("com.android.vending.billing.LOCAL_BROADCAST_PURCHASES_UPDATED")) {
            if (action.equals("com.android.vending.billing.ALTERNATIVE_BILLING")) {
                ...
                tVar2 = this.f8669c.f8674c;
                BillingResult billingResult2 = u.f8729j;
                tVar2.e(s.a(77, i10, billingResult2));
                kVar2 = this.f8669c.f8673b;
