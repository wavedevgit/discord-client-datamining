...
public class b extends BillingClient {
    ...
    /* renamed from: c */
    private final Handler f8616c;

    /* renamed from: d */
    private volatile i0 f8617d;
    ...
    /* renamed from: g */
    private volatile k6 f8620g;

    /* renamed from: h */
    private volatile p f8621h;
    ...
    public b(String str, Context context, t tVar, ExecutorService executorService) {
        this.f8614a = 0;
        this.f8616c = new Handler(Looper.getMainLooper());
        this.f8624k = 0;
        String U = U();
        this.f8615b = U;
        ...
        k5 E = l5.E();
        E.o(U);
        E.m(this.f8618e.getPackageName());
        this.f8619f = new v(this.f8618e, (l5) E.f());
        this.f8618e.getPackageName();
    }
    ...
    public static /* bridge */ /* synthetic */ b6.i0 N(b bVar, String str, int i10) {
        ...
        Bundle c10 = com.google.android.gms.internal.play_billing.a0.c(bVar.f8627n, bVar.f8635v, bVar.f8639z.a(), bVar.f8639z.b(), bVar.f8615b);
        List list = null;
        String str2 = null;
        while (true) {
            try {
                if (bVar.f8627n) {
                    k6 k6Var = bVar.f8620g;
                    if (true != bVar.f8635v) {
                        i11 = 9;
                    } else {
                        i11 = 19;
                    }
                    A = k6Var.Z(i11, bVar.f8618e.getPackageName(), str, str2, c10);
                } else {
                    A = bVar.f8620g.A(3, bVar.f8618e.getPackageName(), str, str2);
                }
                f0 a10 = g0.a(A, "BillingClient", "getPurchase()");
                ...
                if (TextUtils.isEmpty(str2)) {
                    return new b6.i0(u.f8731l, arrayList);
                }
                list = null;
            } catch (Exception e11) {
                BillingResult billingResult2 = u.f8732m;
    ...
    private final BillingResult R(final BillingResult billingResult) {
        ...
        this.f8616c.post(new Runnable() { // from class: com.android.billingclient.api.j0
    ...
    public final BillingResult S() {
        if (this.f8614a != 0 && this.f8614a != 3) {
            return u.f8729j;
        }
        return u.f8732m;
    }
    ...
    private final String T(QueryProductDetailsParams queryProductDetailsParams) {
        ...
        return this.f8618e.getPackageName();
    }
    ...
    public final Future V(Callable callable, long j10, final Runnable runnable, Handler handler) {
        if (this.B == null) {
            this.B = Executors.newFixedThreadPool(com.google.android.gms.internal.play_billing.a0.f14851a, new k(this));
        }
        try {
    ...
    public final void W(r4 r4Var) {
        this.f8619f.d(r4Var, this.f8624k);
    }

    public final void X(v4 v4Var) {
        this.f8619f.a(v4Var, this.f8624k);
    }

    private final void Y(String str, final b6.i iVar) {
        if (!f()) {
            BillingResult billingResult = u.f8732m;
    ...
    private final void Z(String str, final b6.j jVar) {
        if (!f()) {
            ...
            BillingResult billingResult2 = u.f8726g;
    ...
    public static /* bridge */ /* synthetic */ r h0(b bVar, String str) {
        ...
        while (bVar.f8625l) {
            try {
                Bundle o02 = bVar.f8620g.o0(6, bVar.f8618e.getPackageName(), str, str2, c10);
                ...
                if (z10) {
                    bVar.W(s.a(26, 11, u.f8729j));
                }
                str2 = o02.getString("INAPP_CONTINUATION_TOKEN");
                com.google.android.gms.internal.play_billing.a0.h("BillingClient", "Continuation token: ".concat(String.valueOf(str2)));
                if (TextUtils.isEmpty(str2)) {
                    return new r(u.f8731l, arrayList);
                }
    ...
    private void m(Context context, b6.k kVar, c cVar, b6.x xVar, String str, t tVar) {
        ...
        this.f8617d = new i0(this.f8618e, kVar, null, xVar, null, this.f8619f);
        this.f8639z = cVar;
        if (xVar != null) {
            z10 = true;
        } else {
    ...
    public final /* synthetic */ void F(BillingResult billingResult) {
        if (this.f8617d.d() != null) {
            this.f8617d.d().onPurchasesUpdated(billingResult, null);
        } else {
    ...
    public final void a(final b6.a aVar, final b6.b bVar) {
        if (!f()) {
            ...
            BillingResult billingResult2 = u.f8728i;
            W(s.a(26, 3, billingResult2));
            bVar.a(billingResult2);
        } else if (!this.f8627n) {
            BillingResult billingResult3 = u.f8721b;
    ...
    public final /* synthetic */ Bundle d0(int i10, String str, String str2, BillingFlowParams billingFlowParams, Bundle bundle) {
        return this.f8620g.N(i10, this.f8618e.getPackageName(), str, str2, null, bundle);
    }
    ...
    public final BillingResult e(String str) {
        ...
        if (!f()) {
            BillingResult billingResult15 = u.f8732m;
        ...
        BillingResult billingResult16 = u.f8720a;
        switch (str.hashCode()) {
            case -422092961:
                if (str.equals("subscriptionsUpdate")) {
                    if (this.f8623j) {
                        billingResult = u.f8731l;
                    } else {
                        billingResult = u.f8735p;
                    }
            ...
            case 96321:
                if (str.equals("aaa")) {
                    if (this.f8631r) {
                        billingResult2 = u.f8731l;
                    } else {
                        billingResult2 = u.f8738s;
                    }
            ...
            case 97314:
                if (str.equals("bbb")) {
                    if (this.f8629p) {
                        billingResult3 = u.f8731l;
                    } else {
                        billingResult3 = u.f8742w;
                    }
            ...
            case 98307:
                if (str.equals("ccc")) {
                    if (this.f8632s) {
                        billingResult4 = u.f8731l;
                    } else {
                        billingResult4 = u.f8739t;
                    }
            ...
            case 99300:
                if (str.equals("ddd")) {
                    if (this.f8630q) {
                        billingResult5 = u.f8731l;
                    } else {
                        billingResult5 = u.f8740u;
                    }
            ...
            case 100293:
                if (str.equals("eee")) {
                    if (this.f8632s) {
                        billingResult6 = u.f8731l;
                    } else {
                        billingResult6 = u.f8739t;
                    }
            ...
            case 101286:
                if (str.equals("fff")) {
                    if (this.f8633t) {
                        billingResult7 = u.f8731l;
                    } else {
                        billingResult7 = u.f8741v;
                    }
            ...
            case 106251:
                if (str.equals("kkk")) {
                    if (this.f8638y) {
                        billingResult12 = u.f8731l;
                    } else {
                        billingResult12 = u.f8744y;
                    }
            ...
            case 207616302:
                if (str.equals("priceChangeConfirmation")) {
                    if (this.f8626m) {
                        billingResult13 = u.f8731l;
                    } else {
                        billingResult13 = u.f8737r;
                    }
            ...
            case 1987365622:
                if (str.equals("subscriptions")) {
                    if (this.f8622i) {
                        billingResult14 = u.f8731l;
                    } else {
                        billingResult14 = u.f8734o;
                    }
        ...
        BillingResult billingResult17 = u.f8745z;
        b0(billingResult17, 34, 1);
        return billingResult17;
    }

    public final /* synthetic */ Bundle e0(String str, String str2) {
        return this.f8620g.u0(3, this.f8618e.getPackageName(), str, str2, null);
    }

    @Override // com.android.billingclient.api.BillingClient
    public final boolean f() {
        return (this.f8614a != 2 || this.f8620g == null || this.f8621h == null) ? false : true;
    }
    ...
    public final BillingResult g(Activity activity, final BillingFlowParams billingFlowParams) {
        ...
        int i11;
        final int i12;
        if (this.f8617d != null && this.f8617d.d() != null) {
            if (!f()) {
                BillingResult billingResult = u.f8732m;
            ...
            if (e10.equals("subs") && !this.f8622i) {
                ...
                BillingResult billingResult5 = u.f8741v;
                ...
                if (!this.f8625l) {
                    ...
                    }, 5000L, null, this.f8616c);
                    i10 = 80;
                } else {
                    boolean z12 = this.f8627n;
                    boolean z13 = this.f8635v;
                    boolean a10 = this.f8639z.a();
                    boolean b10 = this.f8639z.b();
                    boolean z14 = this.A;
                    String str6 = this.f8615b;
                    final Bundle bundle = new Bundle();
                    ...
                    if (bundle.containsKey("SKU_OFFER_ID_TOKEN_LIST") && !this.f8630q) {
                        BillingResult billingResult6 = u.f8740u;
                    ...
                    if (intent == null) {
                        ...
                        try {
                            bundle.putString("proxyPackageVersion", this.f8618e.getPackageManager().getPackageInfo(stringExtra, 0).versionName);
                        } catch (PackageManager.NameNotFoundException unused) {
                            bundle.putString("proxyPackageVersion", "package not found");
                        }
                    }
                    if (this.f8633t && !h10.isEmpty()) {
                        i11 = 17;
                    } else if (this.f8631r && z11) {
                        i11 = 15;
                    } else if (this.f8627n) {
                        i12 = 9;
                ...
                try {
                    if (V == null) {
                        BillingResult billingResult7 = u.f8732m;
                    ...
                    BillingResult billingResult8 = u.f8733n;
                    ...
                    e = e13;
                    com.google.android.gms.internal.play_billing.a0.j("BillingClient", "Time out while launching billing flow. Try to reconnect", e);
                    BillingResult billingResult82 = u.f8733n;
                    ...
                    BillingResult billingResult9 = u.f8732m;
    ...
    public final void i(final QueryProductDetailsParams queryProductDetailsParams, final b6.h hVar) {
        if (!f()) {
            ...
            BillingResult billingResult2 = u.f8741v;
    ...
    public final void l(b6.c cVar) {
        if (f()) {
            ...
            X(s.c(6));
            cVar.onBillingSetupFinished(u.f8731l);
            return;
        }
        int i10 = 1;
        if (this.f8614a == 1) {
            ...
            this.f8621h = new p(this, cVar, null);
            Intent intent = new Intent("com.android.vending.billing.InAppBillingService.BIND");
            intent.setPackage("com.android.vending");
            List<ResolveInfo> queryIntentServices = this.f8618e.getPackageManager().queryIntentServices(intent, 0);
            if (queryIntentServices != null && !queryIntentServices.isEmpty()) {
                ...
                if (serviceInfo != null) {
                    ...
                    if ("com.android.vending".equals(str) && str2 != null) {
                        ...
                        intent2.putExtra("playBillingLibraryVersion", this.f8615b);
                        if (this.f8618e.bindService(intent2, this.f8621h, 1)) {
            ...
            BillingResult billingResult3 = u.f8722c;
    ...
    public final /* synthetic */ Object l0(b6.a aVar, b6.b bVar) {
        try {
            k6 k6Var = this.f8620g;
            String packageName = this.f8618e.getPackageName();
            String a10 = aVar.a();
            String str = this.f8615b;
    ...
    public final /* synthetic */ Object m0(b6.e eVar, b6.f fVar) {
        ...
        try {
            ...
            if (this.f8627n) {
                k6 k6Var = this.f8620g;
                String packageName = this.f8618e.getPackageName();
                boolean z10 = this.f8627n;
                String str2 = this.f8615b;
                Bundle bundle = new Bundle();
                if (z10) {
                    bundle.putString("playBillingLibraryVersion", str2);
                }
                Bundle j02 = k6Var.j0(9, packageName, a10, bundle);
                o10 = j02.getInt("RESPONSE_CODE");
                str = com.google.android.gms.internal.play_billing.a0.e(j02, "BillingClient");
            } else {
                o10 = this.f8620g.o(3, this.f8618e.getPackageName(), a10);
                str = "";
            }
            BillingResult a11 = u.a(o10, str);
            if (o10 == 0) {
                com.google.android.gms.internal.play_billing.a0.h("BillingClient", "Successfully consumed purchase.");
                fVar.a(a11, a10);
                return null;
            }
            com.google.android.gms.internal.play_billing.a0.i("BillingClient", "Error consuming purchase with token. Response code: " + o10);
            W(s.a(23, 4, a11));
            fVar.a(a11, a10);
            return null;
        } catch (Exception e10) {
    ...
    public final /* synthetic */ Object n0(Bundle bundle, b6.d dVar) {
        try {
            this.f8620g.D0(18, this.f8618e.getPackageName(), bundle, new q(dVar, this.f8619f, this.f8624k, null));
    ...
    public final /* synthetic */ Object o0(QueryProductDetailsParams queryProductDetailsParams, b6.h hVar) {
        ...
        while (true) {
            if (i14 < size) {
                ...
                bundle.putString("playBillingLibraryVersion", this.f8615b);
                try {
                    k6 k6Var = this.f8620g;
                    if (true != this.f8636w) {
                        i13 = 17;
                    ...
                    Bundle h02 = k6Var3.h0(i17, packageName, c10, bundle, bundle2);
                    i12 = 4;
                    ...
                    if (h02 == null) {
                        ...
                        W(s.a(44, 7, u.C));
                        break;
                    } else if (!h02.containsKey("DETAILS_LIST")) {
                        i10 = com.google.android.gms.internal.play_billing.a0.b(h02, "BillingClient");
    ...
    public b(String str, c cVar, Context context, b6.d0 d0Var, t tVar, ExecutorService executorService) {
        ...
        this.f8619f = new v(this.f8618e, (l5) E.f());
        com.google.android.gms.internal.play_billing.a0.i("BillingClient", "Billing client should have a valid listener but the provided is null.");
        this.f8617d = new i0(this.f8618e, null, null, null, null, this.f8619f);
        this.f8639z = cVar;
        this.f8618e.getPackageName();
    }
