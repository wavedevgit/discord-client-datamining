...
final class w {
    ...
    public w(Context context) {
        try {
            ac.t.f(context);
            this.f8171b = ac.t.c().g(com.google.android.datatransport.cct.a.f11658g).a("PLAY_BILLING_LIBRARY", v5.class, yb.c.b("proto"), new yb.g() { // from class: b6.c0
                @Override // yb.g
