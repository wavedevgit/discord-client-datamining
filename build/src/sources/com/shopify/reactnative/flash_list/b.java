...
public final class b extends ReactViewGroup {
    ...
    private final com.shopify.reactnative.flash_list.a f17865d;
    ...
    private double f17868o;

    /* loaded from: /home/runner/work/discord-client-datamining/discord-client-datamining/build/classes4.dex */
    public static final class a implements Comparator {
        @Override // java.util.Comparator
        public final int compare(Object obj, Object obj2) {
            return rr.a.d(Integer.valueOf(((d) obj).getIndex()), Integer.valueOf(((d) obj2).getIndex()));
        }
    }
    ...
    public b(Context context) {
        ...
        this.f17865d = new com.shopify.reactnative.flash_list.a();
        this.f17868o = 1.0d;
    }
    ...
    private final void c() {
        ...
        if (eventDispatcherForReactTag != null) {
            ...
            eventDispatcherForReactTag.dispatchEvent(new c(UIManagerHelper.getSurfaceId((ReactContext) context2), getId(), this.f17865d.d() / this.f17868o, this.f17865d.c() / this.f17868o));
        }
    }
    ...
    private final void d() {
        ...
        if (!this.f17867i && parentScrollView != null) {
            if (this.f17865d.e()) {
    ...
    private final void e() {
        int top;
        if (getChildCount() > 1 && !this.f17867i) {
            ...
            com.shopify.reactnative.flash_list.a aVar = this.f17865d;
            if (aVar.e()) {
                top = getLeft();
            } else {
                top = getTop();
    ...
    private final int getFooterDiff() {
        ...
        return this.f17865d.f() - (bottom2 - top);
    }
    ...
    public void dispatchDraw(Canvas canvas) {
        ...
        View parentScrollView = getParentScrollView();
        if (this.f17866e && parentScrollView != null) {
            if (this.f17865d.e()) {
            ...
            this.f17865d.b(scrollY, Math.max(top - scrollY, 0), Math.max((height + scrollY) - bottom, 0));
            c();
        }
    }
