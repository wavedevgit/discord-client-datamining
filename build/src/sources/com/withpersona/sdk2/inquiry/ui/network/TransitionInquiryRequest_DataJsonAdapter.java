...
public final class TransitionInquiryRequest_DataJsonAdapter extends h {
    ...
    public TransitionInquiryRequest.Data fromJson(m reader) {
        ...
        while (reader.hasNext()) {
            int t02 = reader.t0(this.f20471a);
            if (t02 != -1) {
                if (t02 == 0 && (attributes = (TransitionInquiryRequest.Attributes) this.f20472b.fromJson(reader)) == null) {
    ...
    public void toJson(t writer, TransitionInquiryRequest.Data data) {
        ...
        if (data != null) {
            ...
            this.f20472b.toJson(writer, data.a());
            writer.E();
            return;
        }
