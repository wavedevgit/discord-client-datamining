...
public final class OneTimeLinkCodeForPersonasRequestJsonAdapter extends h {
    ...
    private final m.b f20447a;

    /* renamed from: b  reason: collision with root package name */
    private final h f20448b;
    ...
    public OneTimeLinkCodeForPersonasRequest fromJson(m reader) {
        ...
        while (reader.hasNext()) {
            int t02 = reader.t0(this.f20447a);
            if (t02 != -1) {
                if (t02 == 0 && (meta = (OneTimeLinkCodeForPersonasRequest.Meta) this.f20448b.fromJson(reader)) == null) {
    ...
    public void toJson(t writer, OneTimeLinkCodeForPersonasRequest oneTimeLinkCodeForPersonasRequest) {
        ...
        if (oneTimeLinkCodeForPersonasRequest != null) {
            writer.l();
            writer.t0("meta");
            this.f20448b.toJson(writer, oneTimeLinkCodeForPersonasRequest.a());
            writer.E();
            return;
        }
