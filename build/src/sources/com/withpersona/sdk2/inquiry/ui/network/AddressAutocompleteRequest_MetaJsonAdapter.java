...
public final class AddressAutocompleteRequest_MetaJsonAdapter extends h {
    ...
    public AddressAutocompleteRequest.Meta fromJson(m reader) {
        ...
        while (reader.hasNext()) {
            int W = reader.W(this.f19790a);
            if (W != -1) {
                if (W != 0) {
                    if (W == 1 && (str2 = (String) this.f19791b.fromJson(reader)) == null) {
                        throw c.x("searchInput", "searchInput", reader);
                    }
                } else {
                    str = (String) this.f19791b.fromJson(reader);
                    if (str == null) {
    ...
    public void toJson(t writer, AddressAutocompleteRequest.Meta meta) {
        ...
        if (meta != null) {
            ...
            this.f19791b.toJson(writer, meta.a());
            writer.W("searchInput");
            this.f19791b.toJson(writer, meta.b());
            writer.E();
            return;
        }
