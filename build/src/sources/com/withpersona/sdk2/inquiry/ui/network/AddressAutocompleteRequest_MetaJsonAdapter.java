...
public final class AddressAutocompleteRequest_MetaJsonAdapter extends h {
    ...
    public AddressAutocompleteRequest.Meta fromJson(m reader) {
        ...
        while (reader.hasNext()) {
            int A0 = reader.A0(this.f20769a);
            if (A0 != -1) {
                if (A0 != 0) {
                    if (A0 == 1 && (str2 = (String) this.f20770b.fromJson(reader)) == null) {
                        throw c.x("searchInput", "searchInput", reader);
                    }
                } else {
                    str = (String) this.f20770b.fromJson(reader);
                    if (str == null) {
    ...
    public void toJson(t writer, AddressAutocompleteRequest.Meta meta) {
        ...
        if (meta != null) {
            ...
            this.f20770b.toJson(writer, meta.a());
            writer.A0("searchInput");
            this.f20770b.toJson(writer, meta.b());
            writer.E();
            return;
        }
