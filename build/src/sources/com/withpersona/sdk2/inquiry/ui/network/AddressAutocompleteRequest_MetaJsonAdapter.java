...
public final class AddressAutocompleteRequest_MetaJsonAdapter extends h {
    ...
    private final m.b f19384a;

    /* renamed from: b  reason: collision with root package name */
    private final h f19385b;
    ...
    public AddressAutocompleteRequest.Meta fromJson(m reader) {
        ...
        while (reader.hasNext()) {
            int A0 = reader.A0(this.f19384a);
            if (A0 != -1) {
                if (A0 != 0) {
                    if (A0 == 1 && (str2 = (String) this.f19385b.fromJson(reader)) == null) {
                        throw c.x("searchInput", "searchInput", reader);
                    }
                } else {
                    str = (String) this.f19385b.fromJson(reader);
                    if (str == null) {
    ...
    public void toJson(t writer, AddressAutocompleteRequest.Meta meta) {
        ...
        if (meta != null) {
            ...
            this.f19385b.toJson(writer, meta.a());
            writer.A0("searchInput");
            this.f19385b.toJson(writer, meta.b());
            writer.E();
            return;
        }
