...
public final class OneTimeLinkCodeForPersonasRequest_NamedComponentParamJsonAdapter extends h {
    ...
    private final m.b f20818a;

    /* renamed from: b  reason: collision with root package name */
    private final h f20819b;

    /* renamed from: c  reason: collision with root package name */
    private final h f20820c;
    ...
    public OneTimeLinkCodeForPersonasRequest.NamedComponentParam fromJson(m reader) {
        ...
        while (reader.hasNext()) {
            int A0 = reader.A0(this.f20818a);
            if (A0 != -1) {
                if (A0 != 0) {
                    if (A0 == 1 && (componentParam = (ComponentParam) this.f20820c.fromJson(reader)) == null) {
                        throw c.x("value__", "value", reader);
                    }
                } else {
                    str = (String) this.f20819b.fromJson(reader);
                    if (str == null) {
    ...
    public void toJson(t writer, OneTimeLinkCodeForPersonasRequest.NamedComponentParam namedComponentParam) {
        ...
        if (namedComponentParam != null) {
            ...
            this.f20819b.toJson(writer, namedComponentParam.a());
            writer.A0("value");
            this.f20820c.toJson(writer, namedComponentParam.b());
            writer.E();
            return;
        }
