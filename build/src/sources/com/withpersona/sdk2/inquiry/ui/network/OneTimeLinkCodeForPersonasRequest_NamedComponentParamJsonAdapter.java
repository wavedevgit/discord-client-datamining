...
public final class OneTimeLinkCodeForPersonasRequest_NamedComponentParamJsonAdapter extends h {
    ...
    private final m.b f20451a;

    /* renamed from: b  reason: collision with root package name */
    private final h f20452b;
    ...
    public OneTimeLinkCodeForPersonasRequest.NamedComponentParam fromJson(m reader) {
        ...
        while (reader.hasNext()) {
            int t02 = reader.t0(this.f20451a);
            if (t02 != -1) {
                if (t02 != 0) {
                    if (t02 == 1 && (componentParam = (ComponentParam) this.f20453c.fromJson(reader)) == null) {
                        throw c.x("value__", "value", reader);
                    }
                } else {
                    str = (String) this.f20452b.fromJson(reader);
                    if (str == null) {
    ...
    public void toJson(t writer, OneTimeLinkCodeForPersonasRequest.NamedComponentParam namedComponentParam) {
        ...
        if (namedComponentParam != null) {
            ...
            this.f20452b.toJson(writer, namedComponentParam.a());
            writer.t0("value");
            this.f20453c.toJson(writer, namedComponentParam.b());
            writer.E();
            return;
        }
