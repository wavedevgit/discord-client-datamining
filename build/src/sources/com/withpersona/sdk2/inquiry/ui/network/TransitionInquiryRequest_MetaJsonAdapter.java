...
public final class TransitionInquiryRequest_MetaJsonAdapter extends h {
    ...
    private final m.b f20840a;

    /* renamed from: b  reason: collision with root package name */
    private final h f20841b;
    ...
    public TransitionInquiryRequest.Meta fromJson(m reader) {
        ...
        while (reader.hasNext()) {
            int A0 = reader.A0(this.f20840a);
            if (A0 != -1) {
                if (A0 != 0) {
                    if (A0 == 1 && (str2 = (String) this.f20841b.fromJson(reader)) == null) {
                        throw c.x("fromStep", "fromStep", reader);
                    }
                } else {
                    str = (String) this.f20841b.fromJson(reader);
                    if (str == null) {
    ...
    public void toJson(t writer, TransitionInquiryRequest.Meta meta) {
        ...
        if (meta != null) {
            ...
            this.f20841b.toJson(writer, meta.a());
            writer.A0("fromStep");
            this.f20841b.toJson(writer, meta.b());
            writer.E();
            return;
        }
