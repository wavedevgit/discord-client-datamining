...
public final class TransitionInquiryRequest_MetaJsonAdapter extends h {
    ...
    public TransitionInquiryRequest.Meta fromJson(m reader) {
        ...
        while (reader.hasNext()) {
            int t02 = reader.t0(this.f20473a);
            if (t02 != -1) {
                if (t02 != 0) {
                    if (t02 == 1 && (str2 = (String) this.f20474b.fromJson(reader)) == null) {
                        throw c.x("fromStep", "fromStep", reader);
                    }
                } else {
                    str = (String) this.f20474b.fromJson(reader);
                    if (str == null) {
    ...
    public void toJson(t writer, TransitionInquiryRequest.Meta meta) {
        ...
        if (meta != null) {
            ...
            this.f20474b.toJson(writer, meta.a());
            writer.t0("fromStep");
            this.f20474b.toJson(writer, meta.b());
            writer.E();
            return;
        }
