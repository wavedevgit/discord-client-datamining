...
public final class TransitionInquiryRequestJsonAdapter extends h {
    ...
    private final m.b f20833a;

    /* renamed from: b  reason: collision with root package name */
    private final h f20834b;
    ...
    public TransitionInquiryRequest fromJson(m reader) {
        ...
        while (reader.hasNext()) {
            int A0 = reader.A0(this.f20833a);
            if (A0 != -1) {
                if (A0 != 0) {
                    if (A0 == 1 && (meta = (TransitionInquiryRequest.Meta) this.f20835c.fromJson(reader)) == null) {
                        throw c.x("meta", "meta", reader);
                    }
                } else {
                    data = (TransitionInquiryRequest.Data) this.f20834b.fromJson(reader);
                    if (data == null) {
    ...
    public void toJson(t writer, TransitionInquiryRequest transitionInquiryRequest) {
        ...
        if (transitionInquiryRequest != null) {
            writer.l();
            writer.A0("data");
            this.f20834b.toJson(writer, transitionInquiryRequest.a());
            writer.A0("meta");
            this.f20835c.toJson(writer, transitionInquiryRequest.b());
            writer.E();
            return;
        }
