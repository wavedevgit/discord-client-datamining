...
public final class TransitionInquiryRequestJsonAdapter extends h {
    ...
    private final m.b f19854a;

    /* renamed from: b  reason: collision with root package name */
    private final h f19855b;

    /* renamed from: c  reason: collision with root package name */
    private final h f19856c;
    ...
    public TransitionInquiryRequest fromJson(m reader) {
        ...
        while (reader.hasNext()) {
            int W = reader.W(this.f19854a);
            if (W != -1) {
                if (W != 0) {
                    if (W == 1 && (meta = (TransitionInquiryRequest.Meta) this.f19856c.fromJson(reader)) == null) {
                        throw c.x("meta", "meta", reader);
                    }
                } else {
                    data = (TransitionInquiryRequest.Data) this.f19855b.fromJson(reader);
                    if (data == null) {
    ...
    public void toJson(t writer, TransitionInquiryRequest transitionInquiryRequest) {
        ...
        if (transitionInquiryRequest != null) {
            writer.k();
            writer.W("data");
            this.f19855b.toJson(writer, transitionInquiryRequest.a());
            writer.W("meta");
            this.f19856c.toJson(writer, transitionInquiryRequest.b());
            writer.E();
            return;
        }
