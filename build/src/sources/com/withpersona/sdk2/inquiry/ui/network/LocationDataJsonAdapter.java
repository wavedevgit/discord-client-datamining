...
public final class LocationDataJsonAdapter extends h {
    ...
    private final m.b f19416a;

    /* renamed from: b  reason: collision with root package name */
    private final h f19417b;

    /* renamed from: c  reason: collision with root package name */
    private final h f19418c;

    /* renamed from: d  reason: collision with root package name */
    private volatile Constructor f19419d;
    ...
    public LocationData fromJson(m reader) {
        ...
        while (reader.hasNext()) {
            switch (reader.A0(this.f19416a)) {
                case -1:
                    reader.E0();
                    reader.P();
                    break;
                case 0:
                    str = (String) this.f19417b.fromJson(reader);
                    if (str != null) {
                        break;
                    } else {
                ...
                case 1:
                    str2 = (String) this.f19418c.fromJson(reader);
                    i10 &= -3;
                    break;
                case 2:
                    str3 = (String) this.f19418c.fromJson(reader);
                    i10 &= -5;
                    break;
                case 3:
                    str4 = (String) this.f19418c.fromJson(reader);
                    i10 &= -9;
                    break;
                case 4:
                    str5 = (String) this.f19418c.fromJson(reader);
                    i10 &= -17;
                    break;
                case 5:
                    str6 = (String) this.f19418c.fromJson(reader);
                    i10 &= -33;
                    break;
                case 6:
                    str7 = (String) this.f19418c.fromJson(reader);
                    i10 &= -65;
                    break;
                case 7:
                    str8 = (String) this.f19418c.fromJson(reader);
                    i10 &= -129;
                    break;
            }
        }
    ...
    public void toJson(t writer, LocationData locationData) {
        ...
        if (locationData != null) {
            ...
            this.f19417b.toJson(writer, locationData.h());
            writer.A0("address_street_1");
            this.f19418c.toJson(writer, locationData.e());
            writer.A0("address_street_2");
            this.f19418c.toJson(writer, locationData.f());
            writer.A0("address_city");
            this.f19418c.toJson(writer, locationData.b());
            writer.A0("address_subdivision");
            this.f19418c.toJson(writer, locationData.g());
            writer.A0("address_postal_code");
            this.f19418c.toJson(writer, locationData.d());
            writer.A0("address_country_code");
            this.f19418c.toJson(writer, locationData.c());
            writer.A0("address_business_name");
            this.f19418c.toJson(writer, locationData.a());
            writer.E();
            return;
        }
