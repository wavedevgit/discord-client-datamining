...
public final class SpotlightView extends View {
    ...
    private final void c(Context context, AttributeSet attributeSet) {
        ...
        if (context != null && (theme = context.getTheme()) != null && (obtainStyledAttributes = theme.obtainStyledAttributes(attributeSet, p4.f6446a, 0, 0)) != null) {
            try {
                this.f19665d = obtainStyledAttributes.getResourceId(p4.f6448c, 0);
                this.f19666e = obtainStyledAttributes.getDimension(p4.f6447b, 0.0f);
            } finally {
    ...
    public static final Unit d(final SpotlightView spotlightView) {
        ...
        if ((parent instanceof View) && (findViewById = ((View) parent).findViewById(spotlightView.f19665d)) != null) {
            findViewById.addOnLayoutChangeListener(new View.OnLayoutChangeListener() { // from class: ko.c
    ...
    protected void onFinishInflate() {
        ...
        s.b(this, new Function0() { // from class: ko.b
