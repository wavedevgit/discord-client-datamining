...
public final class AutoClassifyResponse_IdClassesForCountryJsonAdapter extends h {
    ...
    private final m.b f19617a;

    /* renamed from: b  reason: collision with root package name */
    private final h f19618b;

    /* renamed from: c  reason: collision with root package name */
    private final h f19619c;
    ...
    public AutoClassifyResponse.IdClassesForCountry fromJson(m reader) {
        ...
        while (reader.hasNext()) {
            int A0 = reader.A0(this.f19617a);
            if (A0 != -1) {
                if (A0 != 0) {
                    if (A0 != 1) {
                        if (A0 == 2 && (list = (List) this.f19619c.fromJson(reader)) == null) {
                            throw c.x("idConfigs", "idConfigs", reader);
                        }
                    } else {
                        str2 = (String) this.f19618b.fromJson(reader);
                        if (str2 == null) {
                            throw c.x("countryCode", "countryCode", reader);
                        }
                    }
                } else {
                    str = (String) this.f19618b.fromJson(reader);
                    if (str == null) {
    ...
    public void toJson(t writer, AutoClassifyResponse.IdClassesForCountry idClassesForCountry) {
        ...
        if (idClassesForCountry != null) {
            ...
            this.f19618b.toJson(writer, idClassesForCountry.b());
            writer.A0("countryCode");
            this.f19618b.toJson(writer, idClassesForCountry.a());
            writer.A0("idConfigs");
            this.f19619c.toJson(writer, idClassesForCountry.c());
            writer.E();
            return;
        }
