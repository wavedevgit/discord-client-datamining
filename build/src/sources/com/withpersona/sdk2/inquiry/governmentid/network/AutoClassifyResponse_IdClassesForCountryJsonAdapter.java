...
public final class AutoClassifyResponse_IdClassesForCountryJsonAdapter extends h {
    ...
    private final m.b f19250a;

    /* renamed from: b  reason: collision with root package name */
    private final h f19251b;

    /* renamed from: c  reason: collision with root package name */
    private final h f19252c;
    ...
    public AutoClassifyResponse.IdClassesForCountry fromJson(m reader) {
        ...
        while (reader.hasNext()) {
            int t02 = reader.t0(this.f19250a);
            if (t02 != -1) {
                if (t02 != 0) {
                    if (t02 != 1) {
                        if (t02 == 2 && (list = (List) this.f19252c.fromJson(reader)) == null) {
                            throw c.x("idConfigs", "idConfigs", reader);
                        }
                    } else {
                        str2 = (String) this.f19251b.fromJson(reader);
                        if (str2 == null) {
                            throw c.x("countryCode", "countryCode", reader);
                        }
                    }
                } else {
                    str = (String) this.f19251b.fromJson(reader);
                    if (str == null) {
    ...
    public void toJson(t writer, AutoClassifyResponse.IdClassesForCountry idClassesForCountry) {
        ...
        if (idClassesForCountry != null) {
            ...
            this.f19251b.toJson(writer, idClassesForCountry.b());
            writer.t0("countryCode");
            this.f19251b.toJson(writer, idClassesForCountry.a());
            writer.t0("idConfigs");
            this.f19252c.toJson(writer, idClassesForCountry.c());
            writer.E();
            return;
        }
