...
public final class AutoClassifyResponse_ClassificationFailedResponseJsonAdapter extends h {
    ...
    private final m.b f18227a;

    /* renamed from: b  reason: collision with root package name */
    private final h f18228b;
    ...
    /* renamed from: a */
    public AutoClassifyResponse.ClassificationFailedResponse fromJson(m reader) {
        Intrinsics.checkNotNullParameter(reader, "reader");
        reader.r();
        List list = null;
        while (reader.hasNext()) {
            int A0 = reader.A0(this.f18227a);
            if (A0 != -1) {
                if (A0 == 0 && (list = (List) this.f18228b.fromJson(reader)) == null) {
    ...
    public void toJson(t writer, AutoClassifyResponse.ClassificationFailedResponse classificationFailedResponse) {
        ...
        if (classificationFailedResponse != null) {
            ...
            this.f18228b.toJson(writer, classificationFailedResponse.a());
            writer.E();
            return;
        }
    ...
    public String toString() {
        ...
        sb2.append("AutoClassifyResponse.ClassificationFailedResponse");
        sb2.append(')');
        return sb2.toString();
    }
}
