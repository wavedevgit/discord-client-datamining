...
public final class AutoClassifyResponse_IdRejectedResponseJsonAdapter extends h {
    ...
    public AutoClassifyResponse.IdRejectedResponse fromJson(m reader) {
        ...
        while (reader.hasNext()) {
            int W = reader.W(this.f18641a);
            if (W != -1) {
                if (W == 0 && (list = (List) this.f18642b.fromJson(reader)) == null) {
    ...
    public void toJson(t writer, AutoClassifyResponse.IdRejectedResponse idRejectedResponse) {
        ...
        if (idRejectedResponse != null) {
            writer.k();
            writer.W("idClassesByCountries");
            this.f18642b.toJson(writer, idRejectedResponse.a());
            writer.E();
            return;
        }
