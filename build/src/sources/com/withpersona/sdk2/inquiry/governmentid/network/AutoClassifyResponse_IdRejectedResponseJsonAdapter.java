...
public final class AutoClassifyResponse_IdRejectedResponseJsonAdapter extends h {
    ...
    /* renamed from: a */
    public AutoClassifyResponse.IdRejectedResponse fromJson(m reader) {
        Intrinsics.checkNotNullParameter(reader, "reader");
        reader.r();
        List list = null;
        while (reader.hasNext()) {
            int t02 = reader.t0(this.f19253a);
            if (t02 != -1) {
                if (t02 == 0 && (list = (List) this.f19254b.fromJson(reader)) == null) {
        ...
        throw c.o("idClassesByCountries", "idClassesByCountries", reader);
    }

    @Override // com.squareup.moshi.h
    /* renamed from: b */
    public void toJson(t writer, AutoClassifyResponse.IdRejectedResponse idRejectedResponse) {
        Intrinsics.checkNotNullParameter(writer, "writer");
        if (idRejectedResponse != null) {
            writer.l();
            writer.t0("idClassesByCountries");
            this.f19254b.toJson(writer, idRejectedResponse.a());
            writer.E();
            return;
        }
    ...
    public String toString() {
        ...
        sb2.append("AutoClassifyResponse.IdRejectedResponse");
        sb2.append(')');
        return sb2.toString();
    }
}
