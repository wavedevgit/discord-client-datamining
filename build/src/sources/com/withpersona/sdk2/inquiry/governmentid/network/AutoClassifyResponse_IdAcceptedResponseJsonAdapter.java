...
public final class AutoClassifyResponse_IdAcceptedResponseJsonAdapter extends h {
    ...
    private final m.b f19614a;

    /* renamed from: b  reason: collision with root package name */
    private final h f19615b;

    /* renamed from: c  reason: collision with root package name */
    private final h f19616c;
    ...
    public AutoClassifyResponse.IdAcceptedResponse fromJson(m reader) {
        ...
        while (reader.hasNext()) {
            int A0 = reader.A0(this.f19614a);
            if (A0 != -1) {
                if (A0 != 0) {
                    if (A0 != 1) {
                        if (A0 == 2 && (id2 = (Id) this.f19616c.fromJson(reader)) == null) {
                            throw c.x("idConfig", "idConfig", reader);
                        }
                    } else {
                        str2 = (String) this.f19615b.fromJson(reader);
                        if (str2 == null) {
                            throw c.x("idClass", "idClass", reader);
                        }
                    }
                } else {
                    str = (String) this.f19615b.fromJson(reader);
                    if (str == null) {
    ...
    public void toJson(t writer, AutoClassifyResponse.IdAcceptedResponse idAcceptedResponse) {
        ...
        if (idAcceptedResponse != null) {
            ...
            this.f19615b.toJson(writer, idAcceptedResponse.a());
            writer.A0("idClass");
            this.f19615b.toJson(writer, idAcceptedResponse.b());
            writer.A0("idConfig");
            this.f19616c.toJson(writer, idAcceptedResponse.c());
            writer.E();
            return;
        }
