...
public final class AutoClassifyResponse_IdAcceptedResponseJsonAdapter extends h {
    ...
    private final m.b f18635a;

    /* renamed from: b  reason: collision with root package name */
    private final h f18636b;

    /* renamed from: c  reason: collision with root package name */
    private final h f18637c;
    ...
    public AutoClassifyResponse.IdAcceptedResponse fromJson(m reader) {
        ...
        while (reader.hasNext()) {
            int W = reader.W(this.f18635a);
            if (W != -1) {
                if (W != 0) {
                    if (W != 1) {
                        if (W == 2 && (id2 = (Id) this.f18637c.fromJson(reader)) == null) {
                            throw c.x("idConfig", "idConfig", reader);
                        }
                    } else {
                        str2 = (String) this.f18636b.fromJson(reader);
                        if (str2 == null) {
                            throw c.x("idClass", "idClass", reader);
                        }
                    }
                } else {
                    str = (String) this.f18636b.fromJson(reader);
                    if (str == null) {
    ...
    public void toJson(t writer, AutoClassifyResponse.IdAcceptedResponse idAcceptedResponse) {
        ...
        if (idAcceptedResponse != null) {
            ...
            this.f18636b.toJson(writer, idAcceptedResponse.a());
            writer.W("idClass");
            this.f18636b.toJson(writer, idAcceptedResponse.b());
            writer.W("idConfig");
            this.f18637c.toJson(writer, idAcceptedResponse.c());
            writer.E();
            return;
        }
