...
public final class AutoClassifyResponse_IdAcceptedResponseJsonAdapter extends h {
    ...
    private final m.b f19247a;

    /* renamed from: b  reason: collision with root package name */
    private final h f19248b;

    /* renamed from: c  reason: collision with root package name */
    private final h f19249c;
    ...
    public AutoClassifyResponse.IdAcceptedResponse fromJson(m reader) {
        ...
        while (reader.hasNext()) {
            int t02 = reader.t0(this.f19247a);
            if (t02 != -1) {
                if (t02 != 0) {
                    if (t02 != 1) {
                        if (t02 == 2 && (id2 = (Id) this.f19249c.fromJson(reader)) == null) {
                            throw c.x("idConfig", "idConfig", reader);
                        }
                    } else {
                        str2 = (String) this.f19248b.fromJson(reader);
                        if (str2 == null) {
                            throw c.x("idClass", "idClass", reader);
                        }
                    }
                } else {
                    str = (String) this.f19248b.fromJson(reader);
                    if (str == null) {
    ...
    public void toJson(t writer, AutoClassifyResponse.IdAcceptedResponse idAcceptedResponse) {
        ...
        if (idAcceptedResponse != null) {
            ...
            this.f19248b.toJson(writer, idAcceptedResponse.a());
            writer.t0("idClass");
            this.f19248b.toJson(writer, idAcceptedResponse.b());
            writer.t0("idConfig");
            this.f19249c.toJson(writer, idAcceptedResponse.c());
            writer.E();
            return;
        }
