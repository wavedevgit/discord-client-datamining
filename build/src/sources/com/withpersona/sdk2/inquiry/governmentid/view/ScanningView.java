...
public final class ScanningView extends View {
    ...
    public static final a f19287v = new a(null);

    /* renamed from: d  reason: collision with root package name */
    private final Matrix f19288d;

    /* renamed from: e  reason: collision with root package name */
    private final ValueAnimator f19289e;

    /* renamed from: i  reason: collision with root package name */
    private SweepGradient f19290i;

    /* renamed from: o  reason: collision with root package name */
    private final Paint f19291o;

    /* renamed from: p  reason: collision with root package name */
    private Path f19292p;

    /* renamed from: q  reason: collision with root package name */
    private float f19293q;

    /* renamed from: r  reason: collision with root package name */
    private float f19294r;
    ...
    public ScanningView(Context context, AttributeSet attributeSet) {
        ...
        this.f19288d = new Matrix();
        this.f19294r = (float) h.a(8.0d);
        this.f19295s = true;
        Context context2 = getContext();
        Intrinsics.checkNotNullExpressionValue(context2, "getContext(...)");
        this.f19296t = s.d(context2, f.a.f23301v, null, false, 6, null);
        this.f19297u = -1;
        this.f19290i = b();
        Paint paint = new Paint(1);
        paint.setStyle(Paint.Style.STROKE);
        paint.setStrokeWidth((float) h.a(3.0d));
        paint.setShader(this.f19290i);
        this.f19291o = paint;
        this.f19292p = c();
        ValueAnimator ofFloat = ValueAnimator.ofFloat(0.0f, 1.0f);
        ofFloat.setDuration(4000L);
        ofFloat.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() { // from class: lo.a
    ...
    private final SweepGradient b() {
        ...
        if (this.f19295s) {
            ...
            iArr = new int[]{i10, i10, this.f19296t};
        } else {
            int i11 = this.f19297u;
    ...
    private final Path c() {
        Path path = new Path();
        float strokeWidth = this.f19291o.getStrokeWidth();
    ...
    private final void e() {
        ...
        this.f19288d.setRotate(this.f19293q, 0.5f, 0.5f);
        float f10 = max;
        this.f19288d.postScale(f10, f10);
        this.f19288d.postTranslate((measuredWidth - max) / 2.0f, (measuredHeight - max) / 2.0f);
        this.f19290i.setLocalMatrix(this.f19288d);
        invalidate();
    }
    ...
    public final float getStrokeWidth() {
        return this.f19291o.getStrokeWidth();
    }
    ...
    protected void onDraw(Canvas canvas) {
        ...
        super.onDraw(canvas);
        canvas.drawPath(this.f19292p, this.f19291o);
    }
    ...
    public final void setStrokeWidth(float f10) {
        if (this.f19291o.getStrokeWidth() == f10) {
            return;
        }
        this.f19291o.setStrokeWidth(f10);
        invalidate();
    }
}
