...
public final class ScanningView extends View {
    ...
    public static final a f19654v = new a(null);

    /* renamed from: d  reason: collision with root package name */
    private final Matrix f19655d;

    /* renamed from: e  reason: collision with root package name */
    private final ValueAnimator f19656e;

    /* renamed from: i  reason: collision with root package name */
    private SweepGradient f19657i;

    /* renamed from: o  reason: collision with root package name */
    private final Paint f19658o;

    /* renamed from: p  reason: collision with root package name */
    private Path f19659p;
    ...
    public ScanningView(Context context, AttributeSet attributeSet) {
        ...
        this.f19655d = new Matrix();
        this.f19661r = (float) h.a(8.0d);
        this.f19662s = true;
        Context context2 = getContext();
        Intrinsics.checkNotNullExpressionValue(context2, "getContext(...)");
        this.f19663t = s.d(context2, f.a.f24090v, null, false, 6, null);
        this.f19664u = -1;
        this.f19657i = b();
        Paint paint = new Paint(1);
        paint.setStyle(Paint.Style.STROKE);
        paint.setStrokeWidth((float) h.a(3.0d));
        paint.setShader(this.f19657i);
        this.f19658o = paint;
        this.f19659p = c();
    ...
    private final SweepGradient b() {
        ...
        if (this.f19662s) {
            ...
            iArr = new int[]{i10, i10, this.f19663t};
        } else {
            int i11 = this.f19664u;
    ...
    private final Path c() {
        Path path = new Path();
        float strokeWidth = this.f19658o.getStrokeWidth();
    ...
    private final void e() {
        ...
        this.f19655d.setRotate(this.f19660q, 0.5f, 0.5f);
        float f10 = max;
        this.f19655d.postScale(f10, f10);
        this.f19655d.postTranslate((measuredWidth - max) / 2.0f, (measuredHeight - max) / 2.0f);
        this.f19657i.setLocalMatrix(this.f19655d);
        invalidate();
    }
    ...
    public final float getStrokeWidth() {
        return this.f19658o.getStrokeWidth();
    }
    ...
    protected void onDraw(Canvas canvas) {
        ...
        super.onDraw(canvas);
        canvas.drawPath(this.f19659p, this.f19658o);
    }
    ...
    public final void setStrokeWidth(float f10) {
        if (this.f19658o.getStrokeWidth() == f10) {
            return;
        }
        this.f19658o.setStrokeWidth(f10);
        invalidate();
    }
}
