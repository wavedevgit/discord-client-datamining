...
public final class VideoCaptureConfig {
    ...
    private final List f18791b;

    /* renamed from: c  reason: collision with root package name */
    private final List f18792c;
    ...
    public VideoCaptureConfig(long j10, @NotNull List<? extends NextStep.GovernmentId.CaptureFileType> enabledCaptureFileTypes, @NotNull List<? extends a> videoCaptureMethods, @g(name = "webRTCJwt") String str, boolean z10) {
        ...
        this.f18790a = j10;
        this.f18791b = enabledCaptureFileTypes;
        this.f18792c = videoCaptureMethods;
        this.f18793d = str;
        this.f18794e = z10;
    }
    ...
    public final boolean e() {
        return this.f18791b.contains(NextStep.GovernmentId.CaptureFileType.Video);
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof VideoCaptureConfig) {
            ...
            return this.f18790a == videoCaptureConfig.f18790a && Intrinsics.areEqual(this.f18791b, videoCaptureConfig.f18791b) && Intrinsics.areEqual(this.f18792c, videoCaptureConfig.f18792c) && Intrinsics.areEqual(this.f18793d, videoCaptureConfig.f18793d) && this.f18794e == videoCaptureConfig.f18794e;
        }
        return false;
    }

    public int hashCode() {
        int hashCode = ((((Long.hashCode(this.f18790a) * 31) + this.f18791b.hashCode()) * 31) + this.f18792c.hashCode()) * 31;
        String str = this.f18793d;
        return ((hashCode + (str == null ? 0 : str.hashCode())) * 31) + Boolean.hashCode(this.f18794e);
    }

    public String toString() {
        long j10 = this.f18790a;
        List list = this.f18791b;
        List list2 = this.f18792c;
        String str = this.f18793d;
