...
public final class VideoCaptureConfig {
    ...
    public VideoCaptureConfig(long j10, @NotNull List<? extends NextStep.GovernmentId.CaptureFileType> enabledCaptureFileTypes, @NotNull List<? extends a> videoCaptureMethods, @g(name = "webRTCJwt") String str, boolean z10) {
        ...
        this.f19649a = j10;
        this.f19650b = enabledCaptureFileTypes;
        this.f19651c = videoCaptureMethods;
        this.f19652d = str;
        this.f19653e = z10;
    }
    ...
    public final boolean e() {
        return this.f19650b.contains(NextStep.GovernmentId.CaptureFileType.Video);
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof VideoCaptureConfig) {
            ...
            return this.f19649a == videoCaptureConfig.f19649a && Intrinsics.areEqual(this.f19650b, videoCaptureConfig.f19650b) && Intrinsics.areEqual(this.f19651c, videoCaptureConfig.f19651c) && Intrinsics.areEqual(this.f19652d, videoCaptureConfig.f19652d) && this.f19653e == videoCaptureConfig.f19653e;
        }
        return false;
    }

    public int hashCode() {
        int hashCode = ((((Long.hashCode(this.f19649a) * 31) + this.f19650b.hashCode()) * 31) + this.f19651c.hashCode()) * 31;
        String str = this.f19652d;
        return ((hashCode + (str == null ? 0 : str.hashCode())) * 31) + Boolean.hashCode(this.f19653e);
    }

    public String toString() {
        long j10 = this.f19649a;
        List list = this.f19650b;
        List list2 = this.f19651c;
        String str = this.f19652d;
