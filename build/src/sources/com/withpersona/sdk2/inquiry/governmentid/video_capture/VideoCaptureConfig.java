...
public final class VideoCaptureConfig {
    ...
    public VideoCaptureConfig(long j10, @NotNull List<? extends NextStep.GovernmentId.CaptureFileType> enabledCaptureFileTypes, @NotNull List<? extends a> videoCaptureMethods, @g(name = "webRTCJwt") String str, boolean z10) {
        ...
        this.f18264a = j10;
        this.f18265b = enabledCaptureFileTypes;
        this.f18266c = videoCaptureMethods;
        this.f18267d = str;
        this.f18268e = z10;
    }
    ...
    public final boolean e() {
        return this.f18265b.contains(NextStep.GovernmentId.CaptureFileType.Video);
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof VideoCaptureConfig) {
            ...
            return this.f18264a == videoCaptureConfig.f18264a && Intrinsics.areEqual(this.f18265b, videoCaptureConfig.f18265b) && Intrinsics.areEqual(this.f18266c, videoCaptureConfig.f18266c) && Intrinsics.areEqual(this.f18267d, videoCaptureConfig.f18267d) && this.f18268e == videoCaptureConfig.f18268e;
        }
        return false;
    }

    public int hashCode() {
        int hashCode = ((((Long.hashCode(this.f18264a) * 31) + this.f18265b.hashCode()) * 31) + this.f18266c.hashCode()) * 31;
        String str = this.f18267d;
        return ((hashCode + (str == null ? 0 : str.hashCode())) * 31) + Boolean.hashCode(this.f18268e);
    }

    public String toString() {
        long j10 = this.f18264a;
        List list = this.f18265b;
        List list2 = this.f18266c;
        String str = this.f18267d;
        boolean z10 = this.f18268e;
