...
public final class VideoCaptureConfig {
    ...
    public VideoCaptureConfig(long j10, @NotNull List<? extends NextStep.GovernmentId.CaptureFileType> enabledCaptureFileTypes, @NotNull List<? extends a> videoCaptureMethods, @g(name = "webRTCJwt") String str, boolean z10) {
        ...
        this.f18650a = j10;
        this.f18651b = enabledCaptureFileTypes;
        this.f18652c = videoCaptureMethods;
        this.f18653d = str;
        this.f18654e = z10;
    }
    ...
    public final boolean e() {
        return this.f18651b.contains(NextStep.GovernmentId.CaptureFileType.Video);
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof VideoCaptureConfig) {
            ...
            return this.f18650a == videoCaptureConfig.f18650a && Intrinsics.areEqual(this.f18651b, videoCaptureConfig.f18651b) && Intrinsics.areEqual(this.f18652c, videoCaptureConfig.f18652c) && Intrinsics.areEqual(this.f18653d, videoCaptureConfig.f18653d) && this.f18654e == videoCaptureConfig.f18654e;
        }
        return false;
    }

    public int hashCode() {
        int hashCode = ((((Long.hashCode(this.f18650a) * 31) + this.f18651b.hashCode()) * 31) + this.f18652c.hashCode()) * 31;
        String str = this.f18653d;
        return ((hashCode + (str == null ? 0 : str.hashCode())) * 31) + Boolean.hashCode(this.f18654e);
    }

    public String toString() {
        long j10 = this.f18650a;
        List list = this.f18651b;
        List list2 = this.f18652c;
        String str = this.f18653d;
