...
public final class RawExtractionJsonAdapter extends h {
    ...
    /* renamed from: a */
    public RawExtraction fromJson(m reader) {
        Intrinsics.checkNotNullParameter(reader, "reader");
        reader.r();
        String str = null;
        String str2 = null;
        while (reader.hasNext()) {
            int t02 = reader.t0(this.f19232a);
            if (t02 != -1) {
                if (t02 != 0) {
                    if (t02 == 1 && (str2 = (String) this.f19233b.fromJson(reader)) == null) {
                        throw c.x("value__", "value", reader);
                    }
                } else {
                    str = (String) this.f19233b.fromJson(reader);
                    if (str == null) {
    ...
    public void toJson(t writer, RawExtraction rawExtraction) {
        ...
        if (rawExtraction != null) {
            writer.l();
            writer.t0("type");
            this.f19233b.toJson(writer, rawExtraction.a());
            writer.t0("value");
            this.f19233b.toJson(writer, rawExtraction.b());
            writer.E();
            return;
        }
