...
public final class RawExtractionJsonAdapter extends h {
    ...
    public RawExtraction fromJson(m reader) {
        ...
        while (reader.hasNext()) {
            int W = reader.W(this.f18620a);
            if (W != -1) {
                if (W != 0) {
                    if (W == 1 && (str2 = (String) this.f18621b.fromJson(reader)) == null) {
                        throw c.x("value__", "value", reader);
                    }
                } else {
                    str = (String) this.f18621b.fromJson(reader);
                    if (str == null) {
    ...
    public void toJson(t writer, RawExtraction rawExtraction) {
        ...
        if (rawExtraction != null) {
            writer.k();
            writer.W("type");
            this.f18621b.toJson(writer, rawExtraction.a());
            writer.W("value");
            this.f18621b.toJson(writer, rawExtraction.b());
            writer.E();
            return;
        }
