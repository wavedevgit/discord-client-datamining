...
public final class RawExtractionJsonAdapter extends h {
    ...
    public RawExtraction fromJson(m reader) {
        ...
        while (reader.hasNext()) {
            int A0 = reader.A0(this.f19599a);
            if (A0 != -1) {
                if (A0 != 0) {
                    if (A0 == 1 && (str2 = (String) this.f19600b.fromJson(reader)) == null) {
                        throw c.x("value__", "value", reader);
                    }
                } else {
                    str = (String) this.f19600b.fromJson(reader);
                    if (str == null) {
    ...
    public void toJson(t writer, RawExtraction rawExtraction) {
        ...
        if (rawExtraction != null) {
            writer.l();
            writer.A0("type");
            this.f19600b.toJson(writer, rawExtraction.a());
            writer.A0("value");
            this.f19600b.toJson(writer, rawExtraction.b());
            writer.E();
            return;
        }
