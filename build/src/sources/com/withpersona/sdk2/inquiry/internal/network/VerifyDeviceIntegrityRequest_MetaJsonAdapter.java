...
public final class VerifyDeviceIntegrityRequest_MetaJsonAdapter extends com.squareup.moshi.h {
    ...
    private final m.b f20240a;

    /* renamed from: b  reason: collision with root package name */
    private final com.squareup.moshi.h f20241b;

    /* renamed from: c  reason: collision with root package name */
    private volatile Constructor f20242c;
    ...
    public VerifyDeviceIntegrityRequest.Meta fromJson(m reader) {
        ...
        while (reader.hasNext()) {
            int A0 = reader.A0(this.f20240a);
            if (A0 != -1) {
                if (A0 != 0) {
                    if (A0 == 1) {
                        str2 = (String) this.f20241b.fromJson(reader);
                        i10 &= -3;
                    }
                } else {
                    str = (String) this.f20241b.fromJson(reader);
                    i10 &= -2;
                }
            } else {
                reader.E0();
        ...
        Constructor constructor = this.f20242c;
        if (constructor == null) {
            constructor = VerifyDeviceIntegrityRequest.Meta.class.getDeclaredConstructor(String.class, String.class, Integer.TYPE, sm.c.f49081c);
            this.f20242c = constructor;
    ...
    public void toJson(t writer, VerifyDeviceIntegrityRequest.Meta meta) {
        ...
        if (meta != null) {
            writer.l();
            writer.A0("packageName");
            this.f20241b.toJson(writer, meta.b());
            writer.A0("integrityToken");
            this.f20241b.toJson(writer, meta.a());
            writer.E();
            return;
        }
