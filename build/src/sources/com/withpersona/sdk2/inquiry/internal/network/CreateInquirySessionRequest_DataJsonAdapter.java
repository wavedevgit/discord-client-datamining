...
public final class CreateInquirySessionRequest_DataJsonAdapter extends com.squareup.moshi.h {
    ...
    private final com.squareup.moshi.h f20168b;

    /* renamed from: c  reason: collision with root package name */
    private volatile Constructor f20169c;
    ...
    public CreateInquirySessionRequest.Data fromJson(m reader) {
        ...
        while (reader.hasNext()) {
            int J = reader.J(this.f20167a);
            if (J != -1) {
                if (J == 0) {
                    str = (String) this.f20168b.fromJson(reader);
                    if (str != null) {
                        i10 = -2;
                    } else {
        ...
        Constructor constructor = this.f20169c;
        if (constructor == null) {
            constructor = CreateInquirySessionRequest.Data.class.getDeclaredConstructor(String.class, Integer.TYPE, dn.c.f21828c);
            this.f20169c = constructor;
    ...
    public void toJson(t writer, CreateInquirySessionRequest.Data data) {
        ...
        if (data != null) {
            writer.i();
            writer.J("type");
            this.f20168b.toJson(writer, data.a());
            writer.s();
            return;
        }
