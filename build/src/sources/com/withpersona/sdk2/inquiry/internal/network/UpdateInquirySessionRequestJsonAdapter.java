...
public final class UpdateInquirySessionRequestJsonAdapter extends com.squareup.moshi.h {
    ...
    private final m.b f20245a;

    /* renamed from: b  reason: collision with root package name */
    private final com.squareup.moshi.h f20246b;
    ...
    public UpdateInquirySessionRequest fromJson(m reader) {
        ...
        while (reader.hasNext()) {
            int J = reader.J(this.f20245a);
            if (J != -1) {
                if (J == 0 && (data = (UpdateInquirySessionRequest.Data) this.f20246b.fromJson(reader)) == null) {
    ...
    public void toJson(t writer, UpdateInquirySessionRequest updateInquirySessionRequest) {
        ...
        if (updateInquirySessionRequest != null) {
            writer.i();
            writer.J("data");
            this.f20246b.toJson(writer, updateInquirySessionRequest.a());
            writer.s();
            return;
        }
