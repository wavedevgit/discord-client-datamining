...
public final class InquiryActivity extends AppCompatActivity {
    ...
    private final Lazy f18812d = rr.l.a(new Function0() { // from class: vo.j
    ...
    private final Lazy f18813e = new p0(Reflection.getOrCreateKotlinClass(m.class), new b(this), new a(this), new c(null, this));

    /* loaded from: /home/runner/work/discord-client-datamining/discord-client-datamining/build/classes4.dex */
    public static final class a extends Lambda implements Function0 {

        /* renamed from: d  reason: collision with root package name */
        final /* synthetic */ ComponentActivity f18814d;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        public a(ComponentActivity componentActivity) {
            super(0);
            this.f18814d = componentActivity;
        }

        @Override // kotlin.jvm.functions.Function0
        /* renamed from: a */
        public final ViewModelProvider.Factory invoke() {
            return this.f18814d.getDefaultViewModelProviderFactory();
        }
    }
    ...
    public static final class b extends Lambda implements Function0 {
        ...
        /* renamed from: d  reason: collision with root package name */
        final /* synthetic */ ComponentActivity f18815d;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        public b(ComponentActivity componentActivity) {
            super(0);
            this.f18815d = componentActivity;
        }

        @Override // kotlin.jvm.functions.Function0
        /* renamed from: a */
        public final ViewModelStore invoke() {
            return this.f18815d.getViewModelStore();
        }
    }
    ...
    public static final class c extends Lambda implements Function0 {
        ...
        /* renamed from: d  reason: collision with root package name */
        final /* synthetic */ Function0 f18816d;

        /* renamed from: e  reason: collision with root package name */
        final /* synthetic */ ComponentActivity f18817e;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        public c(Function0 function0, ComponentActivity componentActivity) {
            super(0);
            this.f18816d = function0;
            this.f18817e = componentActivity;
        }
        ...
        public final CreationExtras invoke() {
            ...
            Function0 function0 = this.f18816d;
            if (function0 != null && (creationExtras = (CreationExtras) function0.invoke()) != null) {
                return creationExtras;
            }
            return this.f18817e.getDefaultViewModelCreationExtras();
        }
    }
    ...
    private final h D() {
        return (h) this.f18812d.getValue();
    }

    private final m E() {
        return (m) this.f18813e.getValue();
    }
    ...
    private final void F(Bundle bundle) {
        ...
        xo.c c10 = xo.c.c(LayoutInflater.from(this));
        ...
        getSupportFragmentManager().w1(D().p(), this, new i0() { // from class: vo.k
