...
public final class ExchangeOneTimeLinkCodeRequest_DataJsonAdapter extends com.squareup.moshi.h {
    ...
    public ExchangeOneTimeLinkCodeRequest.Data fromJson(m reader) {
        ...
        if (constructor == null) {
            constructor = ExchangeOneTimeLinkCodeRequest.Data.class.getDeclaredConstructor(ExchangeOneTimeLinkCodeRequest.Attributes.class, String.class, Integer.TYPE, sm.c.f49081c);
