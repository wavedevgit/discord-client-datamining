...
public final class FallbackModeService_SessionIdRequestJsonAdapter extends com.squareup.moshi.h {
    ...
    private final com.squareup.moshi.h f19837c;

    /* renamed from: d  reason: collision with root package name */
    private final com.squareup.moshi.h f19838d;
    ...
    public FallbackModeService.SessionIdRequest fromJson(m reader) {
        ...
        while (reader.hasNext()) {
            switch (reader.J(this.f19835a)) {
                ...
                case 1:
                    str2 = (String) this.f19837c.fromJson(reader);
                    break;
                case 2:
                    str3 = (String) this.f19837c.fromJson(reader);
                    break;
                case 3:
                    str4 = (String) this.f19837c.fromJson(reader);
                    break;
                case 4:
                    str5 = (String) this.f19837c.fromJson(reader);
                    break;
                case 5:
                    str6 = (String) this.f19837c.fromJson(reader);
                    break;
                case 6:
                    str7 = (String) this.f19837c.fromJson(reader);
                    break;
                case 7:
                    inquiryFieldMap = (InquiryFieldMap) this.f19838d.fromJson(reader);
                    break;
                case 8:
                    str8 = (String) this.f19837c.fromJson(reader);
                    break;
            }
        }
        reader.D();
    ...
    public void toJson(t writer, FallbackModeService.SessionIdRequest sessionIdRequest) {
        ...
        if (sessionIdRequest != null) {
            ...
            this.f19836b.toJson(writer, sessionIdRequest.f());
            writer.J("inquiry-template-version-id");
            this.f19837c.toJson(writer, sessionIdRequest.g());
            writer.J("inquiry-id");
            this.f19837c.toJson(writer, sessionIdRequest.e());
            writer.J("reference-id");
            this.f19837c.toJson(writer, sessionIdRequest.h());
            writer.J("account-id");
            this.f19837c.toJson(writer, sessionIdRequest.a());
            writer.J("environment");
            this.f19837c.toJson(writer, sessionIdRequest.b());
            writer.J("environment-id");
            this.f19837c.toJson(writer, sessionIdRequest.c());
            writer.J("fields");
            this.f19838d.toJson(writer, sessionIdRequest.d());
            writer.J("theme-set-id");
            this.f19837c.toJson(writer, sessionIdRequest.i());
            writer.s();
            return;
        }
