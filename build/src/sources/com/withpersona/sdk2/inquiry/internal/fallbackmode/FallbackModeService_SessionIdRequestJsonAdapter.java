...
public final class FallbackModeService_SessionIdRequestJsonAdapter extends com.squareup.moshi.h {
    ...
    private final m.b f19813a;

    /* renamed from: b  reason: collision with root package name */
    private final com.squareup.moshi.h f19814b;

    /* renamed from: c  reason: collision with root package name */
    private final com.squareup.moshi.h f19815c;

    /* renamed from: d  reason: collision with root package name */
    private final com.squareup.moshi.h f19816d;
    ...
    public FallbackModeService.SessionIdRequest fromJson(m reader) {
        ...
        while (reader.hasNext()) {
            switch (reader.A0(this.f19813a)) {
                case -1:
                    reader.E0();
                    reader.P();
                    break;
                case 0:
                    str = (String) this.f19814b.fromJson(reader);
                    if (str != null) {
                        break;
                    } else {
                        throw sm.c.x("inquiryTemplateId", "inquiry-template-id", reader);
                    }
                case 1:
                    str2 = (String) this.f19815c.fromJson(reader);
                    break;
                case 2:
                    str3 = (String) this.f19815c.fromJson(reader);
                    break;
                case 3:
                    str4 = (String) this.f19815c.fromJson(reader);
                    break;
                case 4:
                    str5 = (String) this.f19815c.fromJson(reader);
                    break;
                case 5:
                    str6 = (String) this.f19815c.fromJson(reader);
                    break;
                case 6:
                    str7 = (String) this.f19815c.fromJson(reader);
                    break;
                case 7:
                    inquiryFieldMap = (InquiryFieldMap) this.f19816d.fromJson(reader);
                    break;
                case 8:
                    str8 = (String) this.f19815c.fromJson(reader);
                    break;
            }
        }
        reader.y();
        ...
        throw sm.c.o("inquiryTemplateId", "inquiry-template-id", reader);
    }
    ...
    public void toJson(t writer, FallbackModeService.SessionIdRequest sessionIdRequest) {
        ...
        if (sessionIdRequest != null) {
            ...
            this.f19814b.toJson(writer, sessionIdRequest.f());
            writer.A0("inquiry-template-version-id");
            this.f19815c.toJson(writer, sessionIdRequest.g());
            writer.A0("inquiry-id");
            this.f19815c.toJson(writer, sessionIdRequest.e());
            writer.A0("reference-id");
            this.f19815c.toJson(writer, sessionIdRequest.h());
            writer.A0("account-id");
            this.f19815c.toJson(writer, sessionIdRequest.a());
            writer.A0("environment");
            this.f19815c.toJson(writer, sessionIdRequest.b());
            writer.A0("environment-id");
            this.f19815c.toJson(writer, sessionIdRequest.c());
            writer.A0("fields");
            this.f19816d.toJson(writer, sessionIdRequest.d());
            writer.A0("theme-set-id");
            this.f19815c.toJson(writer, sessionIdRequest.i());
            writer.E();
            return;
        }
