...
public final class CreateInquirySessionRequest_MetaJsonAdapter extends com.squareup.moshi.h {
    ...
    private final m.b f20148a;

    /* renamed from: b  reason: collision with root package name */
    private final com.squareup.moshi.h f20149b;
    ...
    public CreateInquirySessionRequest.Meta fromJson(m reader) {
        ...
        while (reader.hasNext()) {
            int A0 = reader.A0(this.f20148a);
            if (A0 != -1) {
                if (A0 == 0 && (str = (String) this.f20149b.fromJson(reader)) == null) {
                    throw sm.c.x("inquiryId", "inquiryId", reader);
                }
            } else {
                reader.E0();
                reader.P();
        ...
        throw sm.c.o("inquiryId", "inquiryId", reader);
    }
    ...
    public void toJson(t writer, CreateInquirySessionRequest.Meta meta) {
        ...
        if (meta != null) {
            writer.l();
            writer.A0("inquiryId");
            this.f20149b.toJson(writer, meta.a());
            writer.E();
            return;
        }
