...
public final class ExchangeOneTimeLinkCodeRequest {
    ...
    public static final class Attributes {
        ...
        public boolean equals(Object obj) {
            ...
            return (obj instanceof Attributes) && Intrinsics.areEqual(this.f19318a, ((Attributes) obj).f19318a);
        }
    ...
    public static final class Data {
        ...
        /* renamed from: a  reason: collision with root package name */
        private final Attributes f19319a;
        ...
        public boolean equals(Object obj) {
            ...
            if (obj instanceof Data) {
                Data data = (Data) obj;
                return Intrinsics.areEqual(this.f19319a, data.f19319a) && Intrinsics.areEqual(this.f19320b, data.f19320b);
            }
            return false;
        }
        ...
        public String toString() {
            Attributes attributes = this.f19319a;
