...
public final class ExchangeOneTimeLinkCodeRequest {
    ...
    public static final class Attributes {
        ...
        public boolean equals(Object obj) {
            ...
            return (obj instanceof Attributes) && Intrinsics.areEqual(this.f20198a, ((Attributes) obj).f20198a);
        }
    ...
    public static final class Data {
        ...
        /* renamed from: a  reason: collision with root package name */
        private final Attributes f20199a;
        ...
        public boolean equals(Object obj) {
            ...
            if (obj instanceof Data) {
                Data data = (Data) obj;
                return Intrinsics.areEqual(this.f20199a, data.f20199a) && Intrinsics.areEqual(this.f20200b, data.f20200b);
            }
            return false;
        }
        ...
        public String toString() {
            Attributes attributes = this.f20199a;
