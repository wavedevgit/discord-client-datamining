...
public final class ExchangeOneTimeLinkCodeRequest {
    ...
    public static final class Attributes {
        ...
        public boolean equals(Object obj) {
            ...
            return (obj instanceof Attributes) && Intrinsics.areEqual(this.f20199a, ((Attributes) obj).f20199a);
        }
    ...
    public static final class Data {
        ...
        /* renamed from: a  reason: collision with root package name */
        private final Attributes f20200a;
        ...
        public boolean equals(Object obj) {
            ...
            if (obj instanceof Data) {
                Data data = (Data) obj;
                return Intrinsics.areEqual(this.f20200a, data.f20200a) && Intrinsics.areEqual(this.f20201b, data.f20201b);
            }
            return false;
        }
        ...
        public String toString() {
            Attributes attributes = this.f20200a;
