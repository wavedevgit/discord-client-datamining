...
public final class ExchangeOneTimeLinkCodeRequest {
    ...
    public static final class Attributes {
        ...
        public boolean equals(Object obj) {
            ...
            return (obj instanceof Attributes) && Intrinsics.areEqual(this.f18792a, ((Attributes) obj).f18792a);
        }
    ...
    public static final class Data {
        ...
        /* renamed from: a  reason: collision with root package name */
        private final Attributes f18793a;
        ...
        public boolean equals(Object obj) {
            ...
            if (obj instanceof Data) {
                Data data = (Data) obj;
                return Intrinsics.areEqual(this.f18793a, data.f18793a) && Intrinsics.areEqual(this.f18794b, data.f18794b);
            }
            return false;
        }
        ...
        public String toString() {
            Attributes attributes = this.f18793a;
