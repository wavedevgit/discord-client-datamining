...
public final class Pi2NavigationBar extends ConstraintLayout {
    ...
    private final void c(AttributeSet attributeSet, int i10, int i11) {
        if (attributeSet != null) {
            TypedArray obtainStyledAttributes = getContext().obtainStyledAttributes(attributeSet, p.f7434a, i10, i11);
    ...
    public final void l(jq.a state, final Function0 back, final Function0 cancel) {
        int i10;
    ...
    protected void onFinishInflate() {
        ...
        int dimensionPixelOffset = getContext().getResources().getDimensionPixelOffset(k.f7366a);
