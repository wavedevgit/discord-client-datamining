...
public final class ButtonWithLoadingIndicator extends FrameLayout {
    ...
    public ButtonWithLoadingIndicator(Context context, int i10) {
        ...
        this.f19566d = b10;
        this.f19568i = a(Integer.valueOf(i10));
        b();
    }
    ...
    private final void b() {
        getProgressBar().setIndeterminateTintList(ColorStateList.valueOf(this.f19568i.getCurrentTextColor()));
    }

    private final void c() {
        if (this.f19567e) {
            this.f19568i.setTextScaleX(0.0f);
            getProgressBar().setVisibility(0);
            return;
        }
        this.f19568i.setTextScaleX(1.0f);
    ...
    public final ProgressBar getProgressBar() {
        ProgressBar progressBar = this.f19566d.f48939b;
    ...
    public final CharSequence getText() {
        CharSequence text = this.f19568i.getText();
    ...
    public final void setIsLoading(boolean z10) {
        ...
        this.f19567e = z10;
        this.f19568i.setActivated(z10);
        c();
    }

    @Override // android.view.View
    public void setOnClickListener(View.OnClickListener onClickListener) {
        this.f19568i.setOnClickListener(onClickListener);
    }

    public final void setText(@NotNull CharSequence value) {
        Intrinsics.checkNotNullParameter(value, "value");
        this.f19568i.setText(value);
    }
