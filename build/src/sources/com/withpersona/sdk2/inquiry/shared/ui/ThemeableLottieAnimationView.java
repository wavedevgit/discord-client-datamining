...
public final class ThemeableLottieAnimationView extends LottieAnimationView {
    ...
    static final class a extends k implements Function2 {
        ...
        final /* synthetic */ ThemeableLottieAnimationView f19692i;
        ...
        /* loaded from: /home/runner/work/discord-client-datamining/discord-client-datamining/build/classes4.dex */
        public static final class C0280a extends k implements Function2 {

            /* renamed from: d  reason: collision with root package name */
            int f19693d;

            /* renamed from: e  reason: collision with root package name */
            final /* synthetic */ ThemeableLottieAnimationView f19694e;

            /* renamed from: i  reason: collision with root package name */
            final /* synthetic */ String f19695i;

            /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
            C0280a(ThemeableLottieAnimationView themeableLottieAnimationView, String str, Continuation continuation) {
                super(2, continuation);
                this.f19694e = themeableLottieAnimationView;
                this.f19695i = str;
            }

            @Override // kotlin.coroutines.jvm.internal.a
            public final Continuation create(Object obj, Continuation continuation) {
                return new C0280a(this.f19694e, this.f19695i, continuation);
            }
            ...
            public final Object invokeSuspend(Object obj) {
                ...
                if (this.f19693d == 0) {
                    kotlin.c.b(obj);
                    this.f19694e.A(this.f19695i, null);
                    return Unit.f31765a;
                }
            ...
            public final Object invoke(CoroutineScope coroutineScope, Continuation continuation) {
                return ((C0280a) create(coroutineScope, continuation)).invokeSuspend(Unit.f31765a);
            }
        }
        ...
        a(String str, ThemeableLottieAnimationView themeableLottieAnimationView, Continuation continuation) {
            super(2, continuation);
            this.f19691e = str;
            this.f19692i = themeableLottieAnimationView;
        }
        ...
        public static final String k(String str) {
            try {
                ...
                String R1 = x.d(x.k(openStream)).R1();
                cs.c.a(openStream, null);
                return R1;
        ...
        @Override // kotlin.coroutines.jvm.internal.a
        public final Continuation create(Object obj, Continuation continuation) {
            return new a(this.f19691e, this.f19692i, continuation);
        }
        ...
        /* JADX WARN: Code restructure failed: missing block: B:16:0x004b, code lost:
            if (ps.g.g(r1, r3, r6) == r0) goto L16;
         */
        ...
        */
        public final java.lang.Object invokeSuspend(java.lang.Object r7) {
            ...
            L35:
                ...
                com.withpersona.sdk2.inquiry.shared.ui.ThemeableLottieAnimationView r4 = r6.f19692i
                r5 = 0
                r3.<init>(r4, r7, r5)
                r6.f19690d = r2
                java.lang.Object r7 = ps.g.g(r1, r3, r6)
                if (r7 != r0) goto L4e
            L4d:
                return r0
            L4e:
    ...
    public static final void G(ThemeableLottieAnimationView themeableLottieAnimationView, l5.i iVar) {
        themeableLottieAnimationView.k(new e("**"), b0.f35648a, new com.withpersona.sdk2.inquiry.shared.ui.a(themeableLottieAnimationView));
        themeableLottieAnimationView.k(new e("**"), b0.f35649b, new b(themeableLottieAnimationView));
    }
    ...
    public final Job J(String url) {
        ...
        d10 = ps.i.d(this.B, null, null, new a(url, this, null), 3, null);
        return d10;
    }
