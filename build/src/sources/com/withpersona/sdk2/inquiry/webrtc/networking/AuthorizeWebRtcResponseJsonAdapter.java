...
public final class AuthorizeWebRtcResponseJsonAdapter extends h {
    ...
    public AuthorizeWebRtcResponse fromJson(m reader) {
        ...
        while (reader.hasNext()) {
            int A0 = reader.A0(this.f20855a);
            if (A0 != -1) {
                if (A0 != 0) {
                    if (A0 != 1) {
                        if (A0 == 2) {
                            str3 = (String) this.f20856b.fromJson(reader);
                        }
                    } else {
                        str2 = (String) this.f20856b.fromJson(reader);
                    }
                } else {
                    str = (String) this.f20856b.fromJson(reader);
                }
            } else {
                reader.E0();
                reader.P();
    ...
    public void toJson(t writer, AuthorizeWebRtcResponse authorizeWebRtcResponse) {
        ...
        if (authorizeWebRtcResponse != null) {
            ...
            this.f20856b.toJson(writer, authorizeWebRtcResponse.c());
            writer.A0("credential");
            this.f20856b.toJson(writer, authorizeWebRtcResponse.a());
            writer.A0("server_url");
            this.f20856b.toJson(writer, authorizeWebRtcResponse.b());
            writer.E();
            return;
        }
