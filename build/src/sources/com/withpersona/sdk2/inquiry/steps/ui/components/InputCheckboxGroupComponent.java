...
public final class InputCheckboxGroupComponent implements k5, v, e0, b5 {
    ...
    private final Set f19756e;

    /* renamed from: i  reason: collision with root package name */
    private final JsonLogicBoolean f19757i;

    /* renamed from: o  reason: collision with root package name */
    private final JsonLogicBoolean f19758o;

    /* renamed from: p  reason: collision with root package name */
    private final List f19759p;
    ...
    public InputCheckboxGroupComponent(String name, Set value, JsonLogicBoolean jsonLogicBoolean, JsonLogicBoolean jsonLogicBoolean2) {
        ...
        this.f19755d = name;
        this.f19756e = value;
        this.f19757i = jsonLogicBoolean;
        this.f19758o = jsonLogicBoolean2;
        this.f19759p = new ArrayList();
        this.f19760q = new l(value);
    }
    ...
    public static /* synthetic */ InputCheckboxGroupComponent e(InputCheckboxGroupComponent inputCheckboxGroupComponent, String str, Set set, JsonLogicBoolean jsonLogicBoolean, JsonLogicBoolean jsonLogicBoolean2, int i10, Object obj) {
        if ((i10 & 1) != 0) {
            str = inputCheckboxGroupComponent.f19755d;
        }
        if ((i10 & 2) != 0) {
            set = inputCheckboxGroupComponent.f19756e;
        }
        if ((i10 & 4) != 0) {
            jsonLogicBoolean = inputCheckboxGroupComponent.f19757i;
        }
        if ((i10 & 8) != 0) {
            jsonLogicBoolean2 = inputCheckboxGroupComponent.f19758o;
        }
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof InputCheckboxGroupComponent) {
            ...
            return Intrinsics.areEqual(this.f19755d, inputCheckboxGroupComponent.f19755d) && Intrinsics.areEqual(this.f19756e, inputCheckboxGroupComponent.f19756e) && Intrinsics.areEqual(this.f19757i, inputCheckboxGroupComponent.f19757i) && Intrinsics.areEqual(this.f19758o, inputCheckboxGroupComponent.f19758o);
        }
        return false;
    }
    ...
    public int hashCode() {
        int hashCode = ((this.f19755d.hashCode() * 31) + this.f19756e.hashCode()) * 31;
        JsonLogicBoolean jsonLogicBoolean = this.f19757i;
        int hashCode2 = (hashCode + (jsonLogicBoolean == null ? 0 : jsonLogicBoolean.hashCode())) * 31;
        JsonLogicBoolean jsonLogicBoolean2 = this.f19758o;
    ...
    public final void writeToParcel(Parcel dest, int i10) {
        ...
        dest.writeString(this.f19755d);
        Set<String> set = this.f19756e;
        dest.writeInt(set.size());
        for (String str : set) {
            dest.writeString(str);
        }
        dest.writeParcelable(this.f19757i, i10);
        dest.writeParcelable(this.f19758o, i10);
    }
