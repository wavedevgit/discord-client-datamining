...
public final class MetaJsonAdapter extends h {
    ...
    public Meta fromJson(m reader) {
        ...
        while (reader.hasNext()) {
            int t02 = reader.t0(this.f20382a);
            if (t02 != -1) {
                if (t02 == 0 && (list = (List) this.f20383b.fromJson(reader)) == null) {
        ...
        throw c.o("predictions", "predictions", reader);
    }
    ...
    public void toJson(t writer, Meta meta) {
        ...
        if (meta != null) {
            writer.l();
            writer.t0("predictions");
            this.f20383b.toJson(writer, meta.a());
            writer.E();
            return;
        }
