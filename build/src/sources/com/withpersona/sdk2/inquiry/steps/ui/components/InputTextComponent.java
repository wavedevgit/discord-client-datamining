...
public final class InputTextComponent implements k5, w4, v, e0 {
    ...
    private final JsonLogicBoolean f19704i;

    /* renamed from: o  reason: collision with root package name */
    private final JsonLogicBoolean f19705o;

    /* renamed from: p  reason: collision with root package name */
    private final TextBasedComponentStyle f19706p;

    /* renamed from: q  reason: collision with root package name */
    private final List f19707q;
    ...
    public InputTextComponent(String name, String value, JsonLogicBoolean jsonLogicBoolean, JsonLogicBoolean jsonLogicBoolean2, TextBasedComponentStyle textBasedComponentStyle) {
        ...
        this.f19702d = name;
        this.f19703e = value;
        this.f19704i = jsonLogicBoolean;
        this.f19705o = jsonLogicBoolean2;
        this.f19706p = textBasedComponentStyle;
        this.f19707q = new ArrayList();
        this.f19708r = w.a(value);
    }
    ...
    public static /* synthetic */ InputTextComponent e(InputTextComponent inputTextComponent, String str, String str2, JsonLogicBoolean jsonLogicBoolean, JsonLogicBoolean jsonLogicBoolean2, TextBasedComponentStyle textBasedComponentStyle, int i10, Object obj) {
        if ((i10 & 1) != 0) {
            str = inputTextComponent.f19702d;
        }
        if ((i10 & 2) != 0) {
            str2 = inputTextComponent.f19703e;
        }
        if ((i10 & 4) != 0) {
            jsonLogicBoolean = inputTextComponent.f19704i;
        }
        if ((i10 & 8) != 0) {
            jsonLogicBoolean2 = inputTextComponent.f19705o;
        }
        if ((i10 & 16) != 0) {
            textBasedComponentStyle = inputTextComponent.f19706p;
        }
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof InputTextComponent) {
            ...
            return Intrinsics.areEqual(this.f19702d, inputTextComponent.f19702d) && Intrinsics.areEqual(this.f19703e, inputTextComponent.f19703e) && Intrinsics.areEqual(this.f19704i, inputTextComponent.f19704i) && Intrinsics.areEqual(this.f19705o, inputTextComponent.f19705o) && Intrinsics.areEqual(this.f19706p, inputTextComponent.f19706p);
        }
        return false;
    }
    ...
    public int hashCode() {
        int hashCode = ((this.f19702d.hashCode() * 31) + this.f19703e.hashCode()) * 31;
        JsonLogicBoolean jsonLogicBoolean = this.f19704i;
        int hashCode2 = (hashCode + (jsonLogicBoolean == null ? 0 : jsonLogicBoolean.hashCode())) * 31;
        JsonLogicBoolean jsonLogicBoolean2 = this.f19705o;
        int hashCode3 = (hashCode2 + (jsonLogicBoolean2 == null ? 0 : jsonLogicBoolean2.hashCode())) * 31;
        TextBasedComponentStyle textBasedComponentStyle = this.f19706p;
    ...
    public final void writeToParcel(Parcel dest, int i10) {
        ...
        dest.writeString(this.f19702d);
        dest.writeString(this.f19703e);
        dest.writeParcelable(this.f19704i, i10);
        dest.writeParcelable(this.f19705o, i10);
        dest.writeParcelable(this.f19706p, i10);
    }
