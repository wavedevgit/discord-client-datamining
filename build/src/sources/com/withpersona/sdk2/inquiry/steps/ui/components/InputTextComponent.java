...
public final class InputTextComponent implements k5, w4, v, e0 {
    ...
    private final JsonLogicBoolean f19298i;

    /* renamed from: o  reason: collision with root package name */
    private final JsonLogicBoolean f19299o;

    /* renamed from: p  reason: collision with root package name */
    private final TextBasedComponentStyle f19300p;

    /* renamed from: q  reason: collision with root package name */
    private final List f19301q;
    ...
    public InputTextComponent(String name, String value, JsonLogicBoolean jsonLogicBoolean, JsonLogicBoolean jsonLogicBoolean2, TextBasedComponentStyle textBasedComponentStyle) {
        ...
        this.f19296d = name;
        this.f19297e = value;
        this.f19298i = jsonLogicBoolean;
        this.f19299o = jsonLogicBoolean2;
        this.f19300p = textBasedComponentStyle;
        this.f19301q = new ArrayList();
        this.f19302r = w.a(value);
    }
    ...
    public static /* synthetic */ InputTextComponent e(InputTextComponent inputTextComponent, String str, String str2, JsonLogicBoolean jsonLogicBoolean, JsonLogicBoolean jsonLogicBoolean2, TextBasedComponentStyle textBasedComponentStyle, int i10, Object obj) {
        if ((i10 & 1) != 0) {
            str = inputTextComponent.f19296d;
        }
        if ((i10 & 2) != 0) {
            str2 = inputTextComponent.f19297e;
        }
        if ((i10 & 4) != 0) {
            jsonLogicBoolean = inputTextComponent.f19298i;
        }
        if ((i10 & 8) != 0) {
            jsonLogicBoolean2 = inputTextComponent.f19299o;
        }
        if ((i10 & 16) != 0) {
            textBasedComponentStyle = inputTextComponent.f19300p;
        }
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof InputTextComponent) {
            ...
            return Intrinsics.areEqual(this.f19296d, inputTextComponent.f19296d) && Intrinsics.areEqual(this.f19297e, inputTextComponent.f19297e) && Intrinsics.areEqual(this.f19298i, inputTextComponent.f19298i) && Intrinsics.areEqual(this.f19299o, inputTextComponent.f19299o) && Intrinsics.areEqual(this.f19300p, inputTextComponent.f19300p);
        }
        return false;
    }
    ...
    public int hashCode() {
        int hashCode = ((this.f19296d.hashCode() * 31) + this.f19297e.hashCode()) * 31;
        JsonLogicBoolean jsonLogicBoolean = this.f19298i;
        int hashCode2 = (hashCode + (jsonLogicBoolean == null ? 0 : jsonLogicBoolean.hashCode())) * 31;
        JsonLogicBoolean jsonLogicBoolean2 = this.f19299o;
        int hashCode3 = (hashCode2 + (jsonLogicBoolean2 == null ? 0 : jsonLogicBoolean2.hashCode())) * 31;
        TextBasedComponentStyle textBasedComponentStyle = this.f19300p;
    ...
    public final void writeToParcel(Parcel dest, int i10) {
        ...
        dest.writeString(this.f19296d);
        dest.writeString(this.f19297e);
        dest.writeParcelable(this.f19298i, i10);
        dest.writeParcelable(this.f19299o, i10);
        dest.writeParcelable(this.f19300p, i10);
    }
