...
public final class InputTextComponent implements k5, w4, v, e0 {
    ...
    private final JsonLogicBoolean f20683i;

    /* renamed from: o  reason: collision with root package name */
    private final JsonLogicBoolean f20684o;

    /* renamed from: p  reason: collision with root package name */
    private final TextBasedComponentStyle f20685p;

    /* renamed from: q  reason: collision with root package name */
    private final List f20686q;
    ...
    public InputTextComponent(String name, String value, JsonLogicBoolean jsonLogicBoolean, JsonLogicBoolean jsonLogicBoolean2, TextBasedComponentStyle textBasedComponentStyle) {
        ...
        this.f20681d = name;
        this.f20682e = value;
        this.f20683i = jsonLogicBoolean;
        this.f20684o = jsonLogicBoolean2;
        this.f20685p = textBasedComponentStyle;
        this.f20686q = new ArrayList();
        this.f20687r = w.a(value);
    }
    ...
    public static /* synthetic */ InputTextComponent e(InputTextComponent inputTextComponent, String str, String str2, JsonLogicBoolean jsonLogicBoolean, JsonLogicBoolean jsonLogicBoolean2, TextBasedComponentStyle textBasedComponentStyle, int i10, Object obj) {
        if ((i10 & 1) != 0) {
            str = inputTextComponent.f20681d;
        }
        if ((i10 & 2) != 0) {
            str2 = inputTextComponent.f20682e;
        }
        if ((i10 & 4) != 0) {
            jsonLogicBoolean = inputTextComponent.f20683i;
        }
        if ((i10 & 8) != 0) {
            jsonLogicBoolean2 = inputTextComponent.f20684o;
        }
        if ((i10 & 16) != 0) {
            textBasedComponentStyle = inputTextComponent.f20685p;
        }
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof InputTextComponent) {
            ...
            return Intrinsics.areEqual(this.f20681d, inputTextComponent.f20681d) && Intrinsics.areEqual(this.f20682e, inputTextComponent.f20682e) && Intrinsics.areEqual(this.f20683i, inputTextComponent.f20683i) && Intrinsics.areEqual(this.f20684o, inputTextComponent.f20684o) && Intrinsics.areEqual(this.f20685p, inputTextComponent.f20685p);
        }
        return false;
    }
    ...
    public int hashCode() {
        int hashCode = ((this.f20681d.hashCode() * 31) + this.f20682e.hashCode()) * 31;
        JsonLogicBoolean jsonLogicBoolean = this.f20683i;
        int hashCode2 = (hashCode + (jsonLogicBoolean == null ? 0 : jsonLogicBoolean.hashCode())) * 31;
        JsonLogicBoolean jsonLogicBoolean2 = this.f20684o;
        int hashCode3 = (hashCode2 + (jsonLogicBoolean2 == null ? 0 : jsonLogicBoolean2.hashCode())) * 31;
        TextBasedComponentStyle textBasedComponentStyle = this.f20685p;
    ...
    public final void writeToParcel(Parcel dest, int i10) {
        ...
        dest.writeString(this.f20681d);
        dest.writeString(this.f20682e);
        dest.writeParcelable(this.f20683i, i10);
        dest.writeParcelable(this.f20684o, i10);
        dest.writeParcelable(this.f20685p, i10);
    }
