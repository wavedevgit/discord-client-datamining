...
public final class AddressAutocompleteResponseJsonAdapter extends h {
    ...
    private final m.b f19361a;

    /* renamed from: b  reason: collision with root package name */
    private final h f19362b;
    ...
    /* renamed from: a */
    public AddressAutocompleteResponse fromJson(m reader) {
        Intrinsics.checkNotNullParameter(reader, "reader");
        reader.r();
        Meta meta = null;
        while (reader.hasNext()) {
            int A0 = reader.A0(this.f19361a);
            if (A0 != -1) {
                if (A0 == 0 && (meta = (Meta) this.f19362b.fromJson(reader)) == null) {
    ...
    public void toJson(t writer, AddressAutocompleteResponse addressAutocompleteResponse) {
        ...
        if (addressAutocompleteResponse != null) {
            writer.l();
            writer.A0("meta");
            this.f19362b.toJson(writer, addressAutocompleteResponse.a());
            writer.E();
            return;
        }
