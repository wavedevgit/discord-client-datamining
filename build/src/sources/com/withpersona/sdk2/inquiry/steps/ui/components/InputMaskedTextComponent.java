...
public final class InputMaskedTextComponent implements k5, w4, v, e0 {
    ...
    private final JsonLogicBoolean f19645i;

    /* renamed from: o  reason: collision with root package name */
    private final JsonLogicBoolean f19646o;

    /* renamed from: p  reason: collision with root package name */
    private final InputTextBasedComponentStyle f19647p;

    /* renamed from: q  reason: collision with root package name */
    private final List f19648q;
    ...
    public InputMaskedTextComponent(String name, String value, JsonLogicBoolean jsonLogicBoolean, JsonLogicBoolean jsonLogicBoolean2, InputTextBasedComponentStyle inputTextBasedComponentStyle) {
        ...
        this.f19643d = name;
        this.f19644e = value;
        this.f19645i = jsonLogicBoolean;
        this.f19646o = jsonLogicBoolean2;
        this.f19647p = inputTextBasedComponentStyle;
        this.f19648q = new ArrayList();
        this.f19649r = w.a(value);
    }
    ...
    public static /* synthetic */ InputMaskedTextComponent e(InputMaskedTextComponent inputMaskedTextComponent, String str, String str2, JsonLogicBoolean jsonLogicBoolean, JsonLogicBoolean jsonLogicBoolean2, InputTextBasedComponentStyle inputTextBasedComponentStyle, int i10, Object obj) {
        if ((i10 & 1) != 0) {
            str = inputMaskedTextComponent.f19643d;
        }
        if ((i10 & 2) != 0) {
            str2 = inputMaskedTextComponent.f19644e;
        }
        if ((i10 & 4) != 0) {
            jsonLogicBoolean = inputMaskedTextComponent.f19645i;
        }
        if ((i10 & 8) != 0) {
            jsonLogicBoolean2 = inputMaskedTextComponent.f19646o;
        }
        if ((i10 & 16) != 0) {
            inputTextBasedComponentStyle = inputMaskedTextComponent.f19647p;
        }
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof InputMaskedTextComponent) {
            ...
            return Intrinsics.areEqual(this.f19643d, inputMaskedTextComponent.f19643d) && Intrinsics.areEqual(this.f19644e, inputMaskedTextComponent.f19644e) && Intrinsics.areEqual(this.f19645i, inputMaskedTextComponent.f19645i) && Intrinsics.areEqual(this.f19646o, inputMaskedTextComponent.f19646o) && Intrinsics.areEqual(this.f19647p, inputMaskedTextComponent.f19647p);
        }
        return false;
    }
    ...
    public int hashCode() {
        int hashCode = ((this.f19643d.hashCode() * 31) + this.f19644e.hashCode()) * 31;
        JsonLogicBoolean jsonLogicBoolean = this.f19645i;
        int hashCode2 = (hashCode + (jsonLogicBoolean == null ? 0 : jsonLogicBoolean.hashCode())) * 31;
        JsonLogicBoolean jsonLogicBoolean2 = this.f19646o;
        int hashCode3 = (hashCode2 + (jsonLogicBoolean2 == null ? 0 : jsonLogicBoolean2.hashCode())) * 31;
        InputTextBasedComponentStyle inputTextBasedComponentStyle = this.f19647p;
    ...
    public final void writeToParcel(Parcel dest, int i10) {
        ...
        dest.writeString(this.f19643d);
        dest.writeString(this.f19644e);
        dest.writeParcelable(this.f19645i, i10);
        dest.writeParcelable(this.f19646o, i10);
        dest.writeParcelable(this.f19647p, i10);
    }
