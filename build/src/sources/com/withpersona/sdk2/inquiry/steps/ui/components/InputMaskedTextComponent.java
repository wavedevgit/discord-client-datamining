...
public final class InputMaskedTextComponent implements k5, w4, v, e0 {
    ...
    private final JsonLogicBoolean f19665i;

    /* renamed from: o  reason: collision with root package name */
    private final JsonLogicBoolean f19666o;

    /* renamed from: p  reason: collision with root package name */
    private final InputTextBasedComponentStyle f19667p;
    ...
    public InputMaskedTextComponent(String name, String value, JsonLogicBoolean jsonLogicBoolean, JsonLogicBoolean jsonLogicBoolean2, InputTextBasedComponentStyle inputTextBasedComponentStyle) {
        ...
        this.f19663d = name;
        this.f19664e = value;
        this.f19665i = jsonLogicBoolean;
        this.f19666o = jsonLogicBoolean2;
        this.f19667p = inputTextBasedComponentStyle;
        this.f19668q = new ArrayList();
        this.f19669r = w.a(value);
    }
    ...
    public static /* synthetic */ InputMaskedTextComponent e(InputMaskedTextComponent inputMaskedTextComponent, String str, String str2, JsonLogicBoolean jsonLogicBoolean, JsonLogicBoolean jsonLogicBoolean2, InputTextBasedComponentStyle inputTextBasedComponentStyle, int i10, Object obj) {
        if ((i10 & 1) != 0) {
            str = inputMaskedTextComponent.f19663d;
        }
        if ((i10 & 2) != 0) {
            str2 = inputMaskedTextComponent.f19664e;
        }
        if ((i10 & 4) != 0) {
            jsonLogicBoolean = inputMaskedTextComponent.f19665i;
        }
        if ((i10 & 8) != 0) {
            jsonLogicBoolean2 = inputMaskedTextComponent.f19666o;
        }
        if ((i10 & 16) != 0) {
            inputTextBasedComponentStyle = inputMaskedTextComponent.f19667p;
        }
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof InputMaskedTextComponent) {
            ...
            return Intrinsics.areEqual(this.f19663d, inputMaskedTextComponent.f19663d) && Intrinsics.areEqual(this.f19664e, inputMaskedTextComponent.f19664e) && Intrinsics.areEqual(this.f19665i, inputMaskedTextComponent.f19665i) && Intrinsics.areEqual(this.f19666o, inputMaskedTextComponent.f19666o) && Intrinsics.areEqual(this.f19667p, inputMaskedTextComponent.f19667p);
        }
        return false;
    }
    ...
    public int hashCode() {
        int hashCode = ((this.f19663d.hashCode() * 31) + this.f19664e.hashCode()) * 31;
        JsonLogicBoolean jsonLogicBoolean = this.f19665i;
        int hashCode2 = (hashCode + (jsonLogicBoolean == null ? 0 : jsonLogicBoolean.hashCode())) * 31;
        JsonLogicBoolean jsonLogicBoolean2 = this.f19666o;
        int hashCode3 = (hashCode2 + (jsonLogicBoolean2 == null ? 0 : jsonLogicBoolean2.hashCode())) * 31;
        InputTextBasedComponentStyle inputTextBasedComponentStyle = this.f19667p;
    ...
    public final void writeToParcel(Parcel dest, int i10) {
        ...
        dest.writeString(this.f19663d);
        dest.writeString(this.f19664e);
        dest.writeParcelable(this.f19665i, i10);
        dest.writeParcelable(this.f19666o, i10);
        dest.writeParcelable(this.f19667p, i10);
    }
