...
public final class InputPhoneNumberComponent implements k5, w4, v, e0 {
    ...
    private final JsonLogicBoolean f20291i;

    /* renamed from: o  reason: collision with root package name */
    private final JsonLogicBoolean f20292o;

    /* renamed from: p  reason: collision with root package name */
    private final TextBasedComponentStyle f20293p;

    /* renamed from: q  reason: collision with root package name */
    private String f20294q;

    /* renamed from: r  reason: collision with root package name */
    private final List f20295r;

    /* renamed from: s  reason: collision with root package name */
    private final c2 f20296s;

    /* renamed from: t  reason: collision with root package name */
    private k f20297t;

    /* renamed from: u  reason: collision with root package name */
    private final List f20298u;

    /* renamed from: v  reason: collision with root package name */
    private t f20299v;

    /* renamed from: w  reason: collision with root package name */
    public static final b f20288w = new b(null);
    @NotNull
    ...
    public static final class a implements c2 {
        ...
        @Override // yp.c2
        public List f() {
            return CollectionsKt.e(zp.d.f56015a.g(InputPhoneNumberComponent.this.k()));
        }
    ...
    public InputPhoneNumberComponent(String name, String value, JsonLogicBoolean jsonLogicBoolean, JsonLogicBoolean jsonLogicBoolean2, TextBasedComponentStyle textBasedComponentStyle, String str) {
        ...
        this.f20289d = name;
        this.f20290e = value;
        this.f20291i = jsonLogicBoolean;
        this.f20292o = jsonLogicBoolean2;
        this.f20293p = textBasedComponentStyle;
        this.f20294q = str;
        this.f20295r = new ArrayList();
        zp.d dVar = zp.d.f56015a;
        this.f20298u = dVar.f();
        this.f20296s = new a();
        this.f20297t = new k(dVar.g(this.f20294q));
        this.f20299v = w.a(value);
    }
    ...
    public static /* synthetic */ InputPhoneNumberComponent e(InputPhoneNumberComponent inputPhoneNumberComponent, String str, String str2, JsonLogicBoolean jsonLogicBoolean, JsonLogicBoolean jsonLogicBoolean2, TextBasedComponentStyle textBasedComponentStyle, String str3, int i10, Object obj) {
        if ((i10 & 1) != 0) {
            str = inputPhoneNumberComponent.f20289d;
        }
        if ((i10 & 2) != 0) {
            str2 = inputPhoneNumberComponent.f20290e;
        }
        if ((i10 & 4) != 0) {
            jsonLogicBoolean = inputPhoneNumberComponent.f20291i;
        }
        if ((i10 & 8) != 0) {
            jsonLogicBoolean2 = inputPhoneNumberComponent.f20292o;
        }
        if ((i10 & 16) != 0) {
            textBasedComponentStyle = inputPhoneNumberComponent.f20293p;
        }
        if ((i10 & 32) != 0) {
            str3 = inputPhoneNumberComponent.f20294q;
        }
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof InputPhoneNumberComponent) {
            ...
            return Intrinsics.areEqual(this.f20289d, inputPhoneNumberComponent.f20289d) && Intrinsics.areEqual(this.f20290e, inputPhoneNumberComponent.f20290e) && Intrinsics.areEqual(this.f20291i, inputPhoneNumberComponent.f20291i) && Intrinsics.areEqual(this.f20292o, inputPhoneNumberComponent.f20292o) && Intrinsics.areEqual(this.f20293p, inputPhoneNumberComponent.f20293p) && Intrinsics.areEqual(this.f20294q, inputPhoneNumberComponent.f20294q);
        }
        return false;
    }
    ...
    public String toString() {
        ...
        String str2 = this.f20290e;
        JsonLogicBoolean jsonLogicBoolean = this.f20291i;
        JsonLogicBoolean jsonLogicBoolean2 = this.f20292o;
        TextBasedComponentStyle textBasedComponentStyle = this.f20293p;
        String str3 = this.f20294q;
    ...
    public final void writeToParcel(Parcel dest, int i10) {
        ...
        dest.writeString(this.f20289d);
        dest.writeString(this.f20290e);
        dest.writeParcelable(this.f20291i, i10);
        dest.writeParcelable(this.f20292o, i10);
        dest.writeParcelable(this.f20293p, i10);
        dest.writeString(this.f20294q);
    }
}
