...
public final class InputPhoneNumberComponent implements k5, w4, v, e0 {
    ...
    private final JsonLogicBoolean f19273i;

    /* renamed from: o  reason: collision with root package name */
    private final JsonLogicBoolean f19274o;

    /* renamed from: p  reason: collision with root package name */
    private final TextBasedComponentStyle f19275p;

    /* renamed from: q  reason: collision with root package name */
    private String f19276q;

    /* renamed from: r  reason: collision with root package name */
    private final List f19277r;

    /* renamed from: s  reason: collision with root package name */
    private final c2 f19278s;

    /* renamed from: t  reason: collision with root package name */
    private k f19279t;

    /* renamed from: u  reason: collision with root package name */
    private final List f19280u;

    /* renamed from: v  reason: collision with root package name */
    private t f19281v;

    /* renamed from: w  reason: collision with root package name */
    public static final b f19270w = new b(null);
    @NotNull
    ...
    public static final class a implements c2 {
        ...
        @Override // aq.c2
        public List f() {
            return CollectionsKt.e(bq.d.f6729a.g(InputPhoneNumberComponent.this.k()));
        }
    ...
    public InputPhoneNumberComponent(String name, String value, JsonLogicBoolean jsonLogicBoolean, JsonLogicBoolean jsonLogicBoolean2, TextBasedComponentStyle textBasedComponentStyle, String str) {
        ...
        this.f19271d = name;
        this.f19272e = value;
        this.f19273i = jsonLogicBoolean;
        this.f19274o = jsonLogicBoolean2;
        this.f19275p = textBasedComponentStyle;
        this.f19276q = str;
        this.f19277r = new ArrayList();
        bq.d dVar = bq.d.f6729a;
        this.f19280u = dVar.f();
        this.f19278s = new a();
        this.f19279t = new k(dVar.g(this.f19276q));
        this.f19281v = w.a(value);
    }
    ...
    public static /* synthetic */ InputPhoneNumberComponent e(InputPhoneNumberComponent inputPhoneNumberComponent, String str, String str2, JsonLogicBoolean jsonLogicBoolean, JsonLogicBoolean jsonLogicBoolean2, TextBasedComponentStyle textBasedComponentStyle, String str3, int i10, Object obj) {
        if ((i10 & 1) != 0) {
            str = inputPhoneNumberComponent.f19271d;
        }
        if ((i10 & 2) != 0) {
            str2 = inputPhoneNumberComponent.f19272e;
        }
        if ((i10 & 4) != 0) {
            jsonLogicBoolean = inputPhoneNumberComponent.f19273i;
        }
        if ((i10 & 8) != 0) {
            jsonLogicBoolean2 = inputPhoneNumberComponent.f19274o;
        }
        if ((i10 & 16) != 0) {
            textBasedComponentStyle = inputPhoneNumberComponent.f19275p;
        }
        if ((i10 & 32) != 0) {
            str3 = inputPhoneNumberComponent.f19276q;
        }
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof InputPhoneNumberComponent) {
            ...
            return Intrinsics.areEqual(this.f19271d, inputPhoneNumberComponent.f19271d) && Intrinsics.areEqual(this.f19272e, inputPhoneNumberComponent.f19272e) && Intrinsics.areEqual(this.f19273i, inputPhoneNumberComponent.f19273i) && Intrinsics.areEqual(this.f19274o, inputPhoneNumberComponent.f19274o) && Intrinsics.areEqual(this.f19275p, inputPhoneNumberComponent.f19275p) && Intrinsics.areEqual(this.f19276q, inputPhoneNumberComponent.f19276q);
        }
        return false;
    }
    ...
    public int hashCode() {
        int hashCode = ((this.f19271d.hashCode() * 31) + this.f19272e.hashCode()) * 31;
        JsonLogicBoolean jsonLogicBoolean = this.f19273i;
        int hashCode2 = (hashCode + (jsonLogicBoolean == null ? 0 : jsonLogicBoolean.hashCode())) * 31;
        JsonLogicBoolean jsonLogicBoolean2 = this.f19274o;
        int hashCode3 = (hashCode2 + (jsonLogicBoolean2 == null ? 0 : jsonLogicBoolean2.hashCode())) * 31;
        TextBasedComponentStyle textBasedComponentStyle = this.f19275p;
    ...
    public final void writeToParcel(Parcel dest, int i10) {
        ...
        dest.writeString(this.f19272e);
        dest.writeParcelable(this.f19273i, i10);
        dest.writeParcelable(this.f19274o, i10);
        dest.writeParcelable(this.f19275p, i10);
        dest.writeString(this.f19276q);
    }
}
