...
public final class e implements k5, a4, c2, v, e0 {
    ...
    private final InputSelectComponentStyle f20756e;

    /* renamed from: i  reason: collision with root package name */
    private final List f20757i;

    /* renamed from: o  reason: collision with root package name */
    private final JsonLogicBoolean f20758o;

    /* renamed from: p  reason: collision with root package name */
    private final JsonLogicBoolean f20759p;
    ...
    public static final a f20754w = new a(null);
    @NotNull
    ...
    public e(String name, InputSelectComponentStyle inputSelectComponentStyle, List selectedOptions, JsonLogicBoolean jsonLogicBoolean, JsonLogicBoolean jsonLogicBoolean2, String str, String str2, List options) {
        ...
        this.f20755d = name;
        this.f20756e = inputSelectComponentStyle;
        this.f20757i = selectedOptions;
        this.f20758o = jsonLogicBoolean;
        this.f20759p = jsonLogicBoolean2;
        this.f20760q = str;
        this.f20761r = str2;
        this.f20762s = options;
        this.f20763t = new ArrayList();
        this.f20765v = new k(f());
    }
    ...
    public static /* synthetic */ e i(e eVar, String str, InputSelectComponentStyle inputSelectComponentStyle, List list, JsonLogicBoolean jsonLogicBoolean, JsonLogicBoolean jsonLogicBoolean2, String str2, String str3, List list2, int i10, Object obj) {
        ...
        if ((i10 & 2) != 0) {
            inputSelectComponentStyle = eVar.f20756e;
        }
        if ((i10 & 4) != 0) {
            list = eVar.f20757i;
        }
        if ((i10 & 8) != 0) {
            jsonLogicBoolean = eVar.f20758o;
        }
        if ((i10 & 16) != 0) {
            jsonLogicBoolean2 = eVar.f20759p;
        }
        if ((i10 & 32) != 0) {
            str2 = eVar.f20760q;
        }
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof e) {
            e eVar = (e) obj;
            return Intrinsics.areEqual(this.f20755d, eVar.f20755d) && Intrinsics.areEqual(this.f20756e, eVar.f20756e) && Intrinsics.areEqual(this.f20757i, eVar.f20757i) && Intrinsics.areEqual(this.f20758o, eVar.f20758o) && Intrinsics.areEqual(this.f20759p, eVar.f20759p) && Intrinsics.areEqual(this.f20760q, eVar.f20760q) && Intrinsics.areEqual(this.f20761r, eVar.f20761r) && Intrinsics.areEqual(this.f20762s, eVar.f20762s);
        }
        return false;
    }
    ...
    public int hashCode() {
        int hashCode = this.f20755d.hashCode() * 31;
        InputSelectComponentStyle inputSelectComponentStyle = this.f20756e;
        int hashCode2 = (((hashCode + (inputSelectComponentStyle == null ? 0 : inputSelectComponentStyle.hashCode())) * 31) + this.f20757i.hashCode()) * 31;
        JsonLogicBoolean jsonLogicBoolean = this.f20758o;
        int hashCode3 = (hashCode2 + (jsonLogicBoolean == null ? 0 : jsonLogicBoolean.hashCode())) * 31;
        JsonLogicBoolean jsonLogicBoolean2 = this.f20759p;
        int hashCode4 = (hashCode3 + (jsonLogicBoolean2 == null ? 0 : jsonLogicBoolean2.hashCode())) * 31;
        String str = this.f20760q;
        int hashCode5 = (hashCode4 + (str == null ? 0 : str.hashCode())) * 31;
        String str2 = this.f20761r;
        return ((hashCode5 + (str2 != null ? str2.hashCode() : 0)) * 31) + this.f20762s.hashCode();
    }
    ...
    public String toString() {
        ...
        InputSelectComponentStyle inputSelectComponentStyle = this.f20756e;
        List list = this.f20757i;
        JsonLogicBoolean jsonLogicBoolean = this.f20758o;
        JsonLogicBoolean jsonLogicBoolean2 = this.f20759p;
        String str2 = this.f20760q;
        String str3 = this.f20761r;
        List list2 = this.f20762s;
    ...
    public final void writeToParcel(Parcel dest, int i10) {
        ...
        dest.writeString(this.f20755d);
        dest.writeParcelable(this.f20756e, i10);
        List<b4> list = this.f20757i;
        dest.writeInt(list.size());
        for (b4 b4Var : list) {
            b4Var.writeToParcel(dest, i10);
        }
        dest.writeParcelable(this.f20758o, i10);
        dest.writeParcelable(this.f20759p, i10);
        dest.writeString(this.f20760q);
        dest.writeString(this.f20761r);
        List<b4> list2 = this.f20762s;
