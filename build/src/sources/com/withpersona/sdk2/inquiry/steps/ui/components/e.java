...
public final class e implements k5, a4, c2, v, e0 {
    ...
    private final InputSelectComponentStyle f19875e;

    /* renamed from: i  reason: collision with root package name */
    private final List f19876i;

    /* renamed from: o  reason: collision with root package name */
    private final JsonLogicBoolean f19877o;

    /* renamed from: p  reason: collision with root package name */
    private final JsonLogicBoolean f19878p;

    /* renamed from: q  reason: collision with root package name */
    private final String f19879q;

    /* renamed from: r  reason: collision with root package name */
    private final String f19880r;

    /* renamed from: s  reason: collision with root package name */
    private final List f19881s;

    /* renamed from: t  reason: collision with root package name */
    private final List f19882t;

    /* renamed from: u  reason: collision with root package name */
    private final boolean f19883u;

    /* renamed from: v  reason: collision with root package name */
    private k f19884v;

    /* renamed from: w  reason: collision with root package name */
    public static final a f19873w = new a(null);
    @NotNull
    ...
    public e(String name, InputSelectComponentStyle inputSelectComponentStyle, List selectedOptions, JsonLogicBoolean jsonLogicBoolean, JsonLogicBoolean jsonLogicBoolean2, String str, String str2, List options) {
        ...
        this.f19874d = name;
        this.f19875e = inputSelectComponentStyle;
        this.f19876i = selectedOptions;
        this.f19877o = jsonLogicBoolean;
        this.f19878p = jsonLogicBoolean2;
        this.f19879q = str;
        this.f19880r = str2;
        this.f19881s = options;
        this.f19882t = new ArrayList();
        this.f19884v = new k(f());
    }
    ...
    public static /* synthetic */ e i(e eVar, String str, InputSelectComponentStyle inputSelectComponentStyle, List list, JsonLogicBoolean jsonLogicBoolean, JsonLogicBoolean jsonLogicBoolean2, String str2, String str3, List list2, int i10, Object obj) {
        ...
        if ((i10 & 2) != 0) {
            inputSelectComponentStyle = eVar.f19875e;
        }
        if ((i10 & 4) != 0) {
            list = eVar.f19876i;
        }
        if ((i10 & 8) != 0) {
            jsonLogicBoolean = eVar.f19877o;
        }
        if ((i10 & 16) != 0) {
            jsonLogicBoolean2 = eVar.f19878p;
        }
        if ((i10 & 32) != 0) {
            str2 = eVar.f19879q;
        }
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof e) {
            e eVar = (e) obj;
            return Intrinsics.areEqual(this.f19874d, eVar.f19874d) && Intrinsics.areEqual(this.f19875e, eVar.f19875e) && Intrinsics.areEqual(this.f19876i, eVar.f19876i) && Intrinsics.areEqual(this.f19877o, eVar.f19877o) && Intrinsics.areEqual(this.f19878p, eVar.f19878p) && Intrinsics.areEqual(this.f19879q, eVar.f19879q) && Intrinsics.areEqual(this.f19880r, eVar.f19880r) && Intrinsics.areEqual(this.f19881s, eVar.f19881s);
        }
        return false;
    }
    ...
    public int hashCode() {
        ...
        InputSelectComponentStyle inputSelectComponentStyle = this.f19875e;
        int hashCode2 = (((hashCode + (inputSelectComponentStyle == null ? 0 : inputSelectComponentStyle.hashCode())) * 31) + this.f19876i.hashCode()) * 31;
        JsonLogicBoolean jsonLogicBoolean = this.f19877o;
        int hashCode3 = (hashCode2 + (jsonLogicBoolean == null ? 0 : jsonLogicBoolean.hashCode())) * 31;
        JsonLogicBoolean jsonLogicBoolean2 = this.f19878p;
        int hashCode4 = (hashCode3 + (jsonLogicBoolean2 == null ? 0 : jsonLogicBoolean2.hashCode())) * 31;
        String str = this.f19879q;
        int hashCode5 = (hashCode4 + (str == null ? 0 : str.hashCode())) * 31;
        String str2 = this.f19880r;
        return ((hashCode5 + (str2 != null ? str2.hashCode() : 0)) * 31) + this.f19881s.hashCode();
    }
    ...
    public String toString() {
        ...
        JsonLogicBoolean jsonLogicBoolean = this.f19877o;
        JsonLogicBoolean jsonLogicBoolean2 = this.f19878p;
        String str2 = this.f19879q;
        String str3 = this.f19880r;
        List list2 = this.f19881s;
    ...
    public final void writeToParcel(Parcel dest, int i10) {
        ...
        dest.writeString(this.f19874d);
        dest.writeParcelable(this.f19875e, i10);
        List<b4> list = this.f19876i;
        dest.writeInt(list.size());
        for (b4 b4Var : list) {
            b4Var.writeToParcel(dest, i10);
        }
        dest.writeParcelable(this.f19877o, i10);
        dest.writeParcelable(this.f19878p, i10);
        dest.writeString(this.f19879q);
        dest.writeString(this.f19880r);
        List<b4> list2 = this.f19881s;
