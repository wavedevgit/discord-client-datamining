...
public final class InputCheckboxComponent implements k5, u4, v, e0 {
    ...
    private final JsonLogicBoolean f19631i;

    /* renamed from: o  reason: collision with root package name */
    private final JsonLogicBoolean f19632o;

    /* renamed from: p  reason: collision with root package name */
    private final List f19633p;
    ...
    public InputCheckboxComponent(String name, boolean z10, JsonLogicBoolean jsonLogicBoolean, JsonLogicBoolean jsonLogicBoolean2) {
        ...
        this.f19629d = name;
        this.f19630e = z10;
        this.f19631i = jsonLogicBoolean;
        this.f19632o = jsonLogicBoolean2;
        this.f19633p = new ArrayList();
        this.f19634q = new m(z10);
    }
    ...
    public static /* synthetic */ InputCheckboxComponent c(InputCheckboxComponent inputCheckboxComponent, String str, boolean z10, JsonLogicBoolean jsonLogicBoolean, JsonLogicBoolean jsonLogicBoolean2, int i10, Object obj) {
        if ((i10 & 1) != 0) {
            str = inputCheckboxComponent.f19629d;
        }
        if ((i10 & 2) != 0) {
            z10 = inputCheckboxComponent.f19630e;
        }
        if ((i10 & 4) != 0) {
            jsonLogicBoolean = inputCheckboxComponent.f19631i;
        }
        if ((i10 & 8) != 0) {
            jsonLogicBoolean2 = inputCheckboxComponent.f19632o;
        }
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof InputCheckboxComponent) {
            ...
            return Intrinsics.areEqual(this.f19629d, inputCheckboxComponent.f19629d) && this.f19630e == inputCheckboxComponent.f19630e && Intrinsics.areEqual(this.f19631i, inputCheckboxComponent.f19631i) && Intrinsics.areEqual(this.f19632o, inputCheckboxComponent.f19632o);
        }
        return false;
    }
    ...
    public int hashCode() {
        int hashCode = ((this.f19629d.hashCode() * 31) + Boolean.hashCode(this.f19630e)) * 31;
        JsonLogicBoolean jsonLogicBoolean = this.f19631i;
        int hashCode2 = (hashCode + (jsonLogicBoolean == null ? 0 : jsonLogicBoolean.hashCode())) * 31;
        JsonLogicBoolean jsonLogicBoolean2 = this.f19632o;
    ...
    public final void writeToParcel(Parcel dest, int i10) {
        ...
        dest.writeString(this.f19629d);
        dest.writeInt(this.f19630e ? 1 : 0);
        dest.writeParcelable(this.f19631i, i10);
        dest.writeParcelable(this.f19632o, i10);
    }
