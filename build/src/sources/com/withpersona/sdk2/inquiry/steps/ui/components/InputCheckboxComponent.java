...
public final class InputCheckboxComponent implements k5, u4, v, e0 {
    ...
    private final JsonLogicBoolean f20243i;

    /* renamed from: o  reason: collision with root package name */
    private final JsonLogicBoolean f20244o;

    /* renamed from: p  reason: collision with root package name */
    private final List f20245p;
    ...
    public InputCheckboxComponent(String name, boolean z10, JsonLogicBoolean jsonLogicBoolean, JsonLogicBoolean jsonLogicBoolean2) {
        ...
        this.f20241d = name;
        this.f20242e = z10;
        this.f20243i = jsonLogicBoolean;
        this.f20244o = jsonLogicBoolean2;
        this.f20245p = new ArrayList();
        this.f20246q = new m(z10);
    }
    ...
    public static /* synthetic */ InputCheckboxComponent c(InputCheckboxComponent inputCheckboxComponent, String str, boolean z10, JsonLogicBoolean jsonLogicBoolean, JsonLogicBoolean jsonLogicBoolean2, int i10, Object obj) {
        if ((i10 & 1) != 0) {
            str = inputCheckboxComponent.f20241d;
        }
        if ((i10 & 2) != 0) {
            z10 = inputCheckboxComponent.f20242e;
        }
        if ((i10 & 4) != 0) {
            jsonLogicBoolean = inputCheckboxComponent.f20243i;
        }
        if ((i10 & 8) != 0) {
            jsonLogicBoolean2 = inputCheckboxComponent.f20244o;
        }
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof InputCheckboxComponent) {
            ...
            return Intrinsics.areEqual(this.f20241d, inputCheckboxComponent.f20241d) && this.f20242e == inputCheckboxComponent.f20242e && Intrinsics.areEqual(this.f20243i, inputCheckboxComponent.f20243i) && Intrinsics.areEqual(this.f20244o, inputCheckboxComponent.f20244o);
        }
        return false;
    }
    ...
    public int hashCode() {
        int hashCode = ((this.f20241d.hashCode() * 31) + Boolean.hashCode(this.f20242e)) * 31;
        JsonLogicBoolean jsonLogicBoolean = this.f20243i;
        int hashCode2 = (hashCode + (jsonLogicBoolean == null ? 0 : jsonLogicBoolean.hashCode())) * 31;
        JsonLogicBoolean jsonLogicBoolean2 = this.f20244o;
    ...
    public final void writeToParcel(Parcel dest, int i10) {
        ...
        dest.writeString(this.f20241d);
        dest.writeInt(this.f20242e ? 1 : 0);
        dest.writeParcelable(this.f20243i, i10);
        dest.writeParcelable(this.f20244o, i10);
    }
