...
public final class InputCheckboxComponent implements k5, u4, v, e0 {
    ...
    private final JsonLogicBoolean f19225i;

    /* renamed from: o  reason: collision with root package name */
    private final JsonLogicBoolean f19226o;
    ...
    public InputCheckboxComponent(String name, boolean z10, JsonLogicBoolean jsonLogicBoolean, JsonLogicBoolean jsonLogicBoolean2) {
        ...
        this.f19223d = name;
        this.f19224e = z10;
        this.f19225i = jsonLogicBoolean;
        this.f19226o = jsonLogicBoolean2;
        this.f19227p = new ArrayList();
        this.f19228q = new m(z10);
    }
    ...
    public static /* synthetic */ InputCheckboxComponent c(InputCheckboxComponent inputCheckboxComponent, String str, boolean z10, JsonLogicBoolean jsonLogicBoolean, JsonLogicBoolean jsonLogicBoolean2, int i10, Object obj) {
        if ((i10 & 1) != 0) {
            str = inputCheckboxComponent.f19223d;
        }
        if ((i10 & 2) != 0) {
            z10 = inputCheckboxComponent.f19224e;
        }
        if ((i10 & 4) != 0) {
            jsonLogicBoolean = inputCheckboxComponent.f19225i;
        }
        if ((i10 & 8) != 0) {
            jsonLogicBoolean2 = inputCheckboxComponent.f19226o;
        }
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof InputCheckboxComponent) {
            ...
            return Intrinsics.areEqual(this.f19223d, inputCheckboxComponent.f19223d) && this.f19224e == inputCheckboxComponent.f19224e && Intrinsics.areEqual(this.f19225i, inputCheckboxComponent.f19225i) && Intrinsics.areEqual(this.f19226o, inputCheckboxComponent.f19226o);
        }
        return false;
    }
    ...
    public int hashCode() {
        int hashCode = ((this.f19223d.hashCode() * 31) + Boolean.hashCode(this.f19224e)) * 31;
        JsonLogicBoolean jsonLogicBoolean = this.f19225i;
        int hashCode2 = (hashCode + (jsonLogicBoolean == null ? 0 : jsonLogicBoolean.hashCode())) * 31;
        JsonLogicBoolean jsonLogicBoolean2 = this.f19226o;
    ...
    public final void writeToParcel(Parcel dest, int i10) {
        ...
        dest.writeString(this.f19223d);
        dest.writeInt(this.f19224e ? 1 : 0);
        dest.writeParcelable(this.f19225i, i10);
        dest.writeParcelable(this.f19226o, i10);
    }
