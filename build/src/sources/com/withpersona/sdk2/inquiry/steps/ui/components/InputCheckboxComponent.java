...
public final class InputCheckboxComponent implements k5, u4, v, e0 {
    ...
    private final JsonLogicBoolean f19611i;

    /* renamed from: o  reason: collision with root package name */
    private final JsonLogicBoolean f19612o;
    ...
    public InputCheckboxComponent(String name, boolean z10, JsonLogicBoolean jsonLogicBoolean, JsonLogicBoolean jsonLogicBoolean2) {
        ...
        this.f19609d = name;
        this.f19610e = z10;
        this.f19611i = jsonLogicBoolean;
        this.f19612o = jsonLogicBoolean2;
        this.f19613p = new ArrayList();
        this.f19614q = new m(z10);
    }
    ...
    public static /* synthetic */ InputCheckboxComponent c(InputCheckboxComponent inputCheckboxComponent, String str, boolean z10, JsonLogicBoolean jsonLogicBoolean, JsonLogicBoolean jsonLogicBoolean2, int i10, Object obj) {
        if ((i10 & 1) != 0) {
            str = inputCheckboxComponent.f19609d;
        }
        if ((i10 & 2) != 0) {
            z10 = inputCheckboxComponent.f19610e;
        }
        if ((i10 & 4) != 0) {
            jsonLogicBoolean = inputCheckboxComponent.f19611i;
        }
        if ((i10 & 8) != 0) {
            jsonLogicBoolean2 = inputCheckboxComponent.f19612o;
        }
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof InputCheckboxComponent) {
            ...
            return Intrinsics.areEqual(this.f19609d, inputCheckboxComponent.f19609d) && this.f19610e == inputCheckboxComponent.f19610e && Intrinsics.areEqual(this.f19611i, inputCheckboxComponent.f19611i) && Intrinsics.areEqual(this.f19612o, inputCheckboxComponent.f19612o);
        }
        return false;
    }
    ...
    public int hashCode() {
        int hashCode = ((this.f19609d.hashCode() * 31) + Boolean.hashCode(this.f19610e)) * 31;
        JsonLogicBoolean jsonLogicBoolean = this.f19611i;
        int hashCode2 = (hashCode + (jsonLogicBoolean == null ? 0 : jsonLogicBoolean.hashCode())) * 31;
        JsonLogicBoolean jsonLogicBoolean2 = this.f19612o;
        return hashCode2 + (jsonLogicBoolean2 != null ? jsonLogicBoolean2.hashCode() : 0);
    }

    public String toString() {
        String str = this.f19609d;
        boolean z10 = this.f19610e;
        JsonLogicBoolean jsonLogicBoolean = this.f19611i;
        JsonLogicBoolean jsonLogicBoolean2 = this.f19612o;
    ...
    public final void writeToParcel(Parcel dest, int i10) {
        ...
        dest.writeString(this.f19609d);
        dest.writeInt(this.f19610e ? 1 : 0);
        dest.writeParcelable(this.f19611i, i10);
        dest.writeParcelable(this.f19612o, i10);
    }
