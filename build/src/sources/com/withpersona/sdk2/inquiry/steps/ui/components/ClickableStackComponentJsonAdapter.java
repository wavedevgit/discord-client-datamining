...
public final class ClickableStackComponentJsonAdapter extends h {
    ...
    public ClickableStackComponent fromJson(m reader) {
        ...
        while (reader.hasNext()) {
            switch (reader.J(this.f19566a)) {
                case -1:
                    reader.E0();
                    reader.S();
                    break;
                case 0:
                    str = (String) this.f19567b.fromJson(reader);
                    if (str != null) {
                        break;
                    } else {
                ...
                case 1:
                    list = (List) this.f19568c.fromJson(reader);
                    if (list != null) {
                        break;
                    } else {
                        throw an.c.x("children", "children", reader);
                    }
                case 2:
                    jsonLogicBoolean2 = (JsonLogicBoolean) this.f19569d.fromJson(reader);
                    break;
                case 3:
                    jsonLogicBoolean = (JsonLogicBoolean) this.f19569d.fromJson(reader);
                    break;
                case 4:
                    clickableStackComponentStyle = (ClickableStack.ClickableStackComponentStyle) this.f19570e.fromJson(reader);
                    break;
                case 5:
                    bool2 = (Boolean) this.f19571f.fromJson(reader);
                    if (bool2 != null) {
                        i10 = -33;
                        break;
                    } else {
                        throw an.c.x("isActive", "isActive", reader);
                    }
            }
        }
        reader.D();
        if (i10 == -33) {
            if (str != null) {
                ...
                throw an.c.o("children", "children", reader);
            }
            throw an.c.o(StackTraceHelper.NAME_KEY, StackTraceHelper.NAME_KEY, reader);
        }
        Constructor constructor = this.f19572g;
        if (constructor == null) {
            constructor = ClickableStackComponent.class.getDeclaredConstructor(String.class, List.class, JsonLogicBoolean.class, JsonLogicBoolean.class, ClickableStack.ClickableStackComponentStyle.class, Boolean.TYPE, Integer.TYPE, an.c.f1164c);
            this.f19572g = constructor;
    ...
    public void toJson(t writer, ClickableStackComponent clickableStackComponent) {
        ...
        if (clickableStackComponent != null) {
            ...
            this.f19567b.toJson(writer, clickableStackComponent.getName());
            writer.J("children");
            this.f19568c.toJson(writer, clickableStackComponent.getChildren());
            writer.J(ViewProps.HIDDEN);
            this.f19569d.toJson(writer, clickableStackComponent.getHidden());
            writer.J("disabled");
            this.f19569d.toJson(writer, clickableStackComponent.getDisabled());
            writer.J("styles");
            this.f19570e.toJson(writer, clickableStackComponent.c());
            writer.J("isActive");
            this.f19571f.toJson(writer, Boolean.valueOf(clickableStackComponent.e()));
            writer.s();
            return;
        }
