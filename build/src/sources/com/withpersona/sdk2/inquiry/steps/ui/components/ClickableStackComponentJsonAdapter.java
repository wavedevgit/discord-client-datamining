...
public final class ClickableStackComponentJsonAdapter extends h {
    ...
    public ClickableStackComponent fromJson(m reader) {
        ...
        while (reader.hasNext()) {
            switch (reader.J(this.f19706a)) {
                case -1:
                    reader.C0();
                    reader.T();
                    break;
                case 0:
                    str = (String) this.f19707b.fromJson(reader);
                    if (str != null) {
                        break;
                    } else {
                ...
                case 1:
                    list = (List) this.f19708c.fromJson(reader);
                    if (list != null) {
                        break;
                    } else {
                        throw bn.c.x("children", "children", reader);
                    }
                case 2:
                    jsonLogicBoolean2 = (JsonLogicBoolean) this.f19709d.fromJson(reader);
                    break;
                case 3:
                    jsonLogicBoolean = (JsonLogicBoolean) this.f19709d.fromJson(reader);
                    break;
                case 4:
                    clickableStackComponentStyle = (ClickableStack.ClickableStackComponentStyle) this.f19710e.fromJson(reader);
                    break;
                case 5:
                    bool2 = (Boolean) this.f19711f.fromJson(reader);
                    if (bool2 != null) {
                        i10 = -33;
                        break;
                    } else {
                        throw bn.c.x("isActive", "isActive", reader);
                    }
            }
        }
        reader.D();
        if (i10 == -33) {
            if (str != null) {
                ...
                throw bn.c.o("children", "children", reader);
            }
            throw bn.c.o(StackTraceHelper.NAME_KEY, StackTraceHelper.NAME_KEY, reader);
        }
        Constructor constructor = this.f19712g;
        if (constructor == null) {
            constructor = ClickableStackComponent.class.getDeclaredConstructor(String.class, List.class, JsonLogicBoolean.class, JsonLogicBoolean.class, ClickableStack.ClickableStackComponentStyle.class, Boolean.TYPE, Integer.TYPE, bn.c.f7152c);
            this.f19712g = constructor;
    ...
    public void toJson(t writer, ClickableStackComponent clickableStackComponent) {
        ...
        if (clickableStackComponent != null) {
            ...
            this.f19707b.toJson(writer, clickableStackComponent.getName());
            writer.J("children");
            this.f19708c.toJson(writer, clickableStackComponent.getChildren());
            writer.J(ViewProps.HIDDEN);
            this.f19709d.toJson(writer, clickableStackComponent.getHidden());
            writer.J("disabled");
            this.f19709d.toJson(writer, clickableStackComponent.getDisabled());
            writer.J("styles");
            this.f19710e.toJson(writer, clickableStackComponent.c());
            writer.J("isActive");
            this.f19711f.toJson(writer, Boolean.valueOf(clickableStackComponent.e()));
            writer.s();
            return;
        }
