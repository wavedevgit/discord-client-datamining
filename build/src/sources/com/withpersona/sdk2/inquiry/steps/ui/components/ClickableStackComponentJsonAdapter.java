    ...
    public ClickableStackComponent fromJson(m reader) {
            ...
            switch (reader.J(this.f20587a)) {
                ...
                case 5:
                    ...
                    if (bool2 != null) {
                        ...
                        throw dn.c.x("isActive", "isActive", reader);
                    }
            }
        }
        reader.D();
        if (i10 == -33) {
            if (str != null) {
                ...
                throw dn.c.o("children", "children", reader);
            }
