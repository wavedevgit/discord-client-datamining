...
public final class InputNumberComponent implements k5, v4, v, e0 {
    ...
    public InputNumberComponent(String name, Number number, JsonLogicBoolean jsonLogicBoolean, JsonLogicBoolean jsonLogicBoolean2) {
        ...
        this.f20653p = new ArrayList();
        this.f20654q = new i(number);
    }
    ...
    public static /* synthetic */ InputNumberComponent e(InputNumberComponent inputNumberComponent, String str, Number number, JsonLogicBoolean jsonLogicBoolean, JsonLogicBoolean jsonLogicBoolean2, int i10, Object obj) {
        if ((i10 & 1) != 0) {
            str = inputNumberComponent.f20649d;
        }
        if ((i10 & 2) != 0) {
            number = inputNumberComponent.f20650e;
        }
        if ((i10 & 4) != 0) {
            jsonLogicBoolean = inputNumberComponent.f20651i;
        }
        if ((i10 & 8) != 0) {
            jsonLogicBoolean2 = inputNumberComponent.f20652o;
        }
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof InputNumberComponent) {
            ...
            return Intrinsics.areEqual(this.f20649d, inputNumberComponent.f20649d) && Intrinsics.areEqual(this.f20650e, inputNumberComponent.f20650e) && Intrinsics.areEqual(this.f20651i, inputNumberComponent.f20651i) && Intrinsics.areEqual(this.f20652o, inputNumberComponent.f20652o);
        }
        return false;
    }
