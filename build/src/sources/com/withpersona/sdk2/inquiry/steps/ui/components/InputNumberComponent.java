...
public final class InputNumberComponent implements k5, v4, v, e0 {
    ...
    private final Number f20283e;

    /* renamed from: i  reason: collision with root package name */
    private final JsonLogicBoolean f20284i;

    /* renamed from: o  reason: collision with root package name */
    private final JsonLogicBoolean f20285o;

    /* renamed from: p  reason: collision with root package name */
    private final List f20286p;
    ...
    public InputNumberComponent(String name, Number number, JsonLogicBoolean jsonLogicBoolean, JsonLogicBoolean jsonLogicBoolean2) {
        ...
        this.f20282d = name;
        this.f20283e = number;
        this.f20284i = jsonLogicBoolean;
        this.f20285o = jsonLogicBoolean2;
        this.f20286p = new ArrayList();
        this.f20287q = new i(number);
    }
    ...
    public static /* synthetic */ InputNumberComponent e(InputNumberComponent inputNumberComponent, String str, Number number, JsonLogicBoolean jsonLogicBoolean, JsonLogicBoolean jsonLogicBoolean2, int i10, Object obj) {
        if ((i10 & 1) != 0) {
            str = inputNumberComponent.f20282d;
        }
        if ((i10 & 2) != 0) {
            number = inputNumberComponent.f20283e;
        }
        if ((i10 & 4) != 0) {
            jsonLogicBoolean = inputNumberComponent.f20284i;
        }
        if ((i10 & 8) != 0) {
            jsonLogicBoolean2 = inputNumberComponent.f20285o;
        }
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof InputNumberComponent) {
            ...
            return Intrinsics.areEqual(this.f20282d, inputNumberComponent.f20282d) && Intrinsics.areEqual(this.f20283e, inputNumberComponent.f20283e) && Intrinsics.areEqual(this.f20284i, inputNumberComponent.f20284i) && Intrinsics.areEqual(this.f20285o, inputNumberComponent.f20285o);
        }
        return false;
    }
    ...
    public int hashCode() {
        int hashCode = this.f20282d.hashCode() * 31;
        Number number = this.f20283e;
        int hashCode2 = (hashCode + (number == null ? 0 : number.hashCode())) * 31;
        JsonLogicBoolean jsonLogicBoolean = this.f20284i;
        int hashCode3 = (hashCode2 + (jsonLogicBoolean == null ? 0 : jsonLogicBoolean.hashCode())) * 31;
        JsonLogicBoolean jsonLogicBoolean2 = this.f20285o;
    ...
    public final void writeToParcel(Parcel dest, int i10) {
        ...
        dest.writeSerializable(this.f20283e);
        dest.writeParcelable(this.f20284i, i10);
        dest.writeParcelable(this.f20285o, i10);
    }
