...
public final class SignatureView extends MaterialCardView {
    ...
    private Bitmap f19897t;

    /* renamed from: u  reason: collision with root package name */
    private Canvas f19898u;

    /* renamed from: v  reason: collision with root package name */
    private RectF f19899v;

    /* renamed from: w  reason: collision with root package name */
    private Path f19900w;

    /* renamed from: x  reason: collision with root package name */
    private final Paint f19901x;

    /* renamed from: y  reason: collision with root package name */
    private final Paint f19902y;
    ...
    public SignatureView(Context context, AttributeSet attributeSet) {
        ...
        this.f19899v = new RectF();
        this.f19900w = new Path();
        this.f19901x = new Paint(4);
        this.f19902y = new Paint();
        j(context, attributeSet);
    }

    private final Rect g() {
        RectF rectF = new RectF(this.f19899v.left - this.f19902y.getStrokeWidth(), this.f19899v.top - this.f19902y.getStrokeWidth(), this.f19899v.right + this.f19902y.getStrokeWidth(), this.f19899v.bottom + this.f19902y.getStrokeWidth());
        Rect rect = new Rect();
        rectF.roundOut(rect);
        return rect;
    }
    ...
    private final void j(Context context, AttributeSet attributeSet) {
        this.f19902y.setAntiAlias(true);
        this.f19902y.setDither(true);
        this.f19902y.setColor(-16777216);
        this.f19902y.setStyle(Paint.Style.STROKE);
        this.f19902y.setStrokeJoin(Paint.Join.ROUND);
        this.f19902y.setStrokeCap(Paint.Cap.ROUND);
        this.f19902y.setStrokeWidth(5.0f);
    }

    private final boolean k() {
        return this.f19899v.isEmpty();
    }

    private final void l(float f10, float f11) {
        this.f19900w.lineTo(f10, f11);
        this.f19903z = f10;
        this.A = f11;
    }
    ...
    private final void m(float f10, float f11) {
        this.f19900w.reset();
        this.f19900w.moveTo(f10, f11);
        this.f19903z = f10;
        this.A = f11;
    }

    private final void n() {
        Canvas canvas = this.f19898u;
        if (canvas == null) {
            return;
        }
        if (!this.f19900w.isEmpty()) {
            this.f19900w.lineTo(this.f19903z, this.A);
            canvas.drawPath(this.f19900w, this.f19902y);
        } else {
            this.f19900w.moveTo(this.f19903z - 0.5f, this.A - 0.5f);
            this.f19900w.lineTo(this.f19903z, this.A);
            canvas.drawPoint(this.f19903z, this.A, this.f19902y);
        }
        o();
        this.f19900w.reset();
    }
    ...
    private final void o() {
        ...
        this.f19900w.computeBounds(rectF, true);
        if (!this.f19900w.isEmpty()) {
            float f10 = 2;
            rectF.inset((-this.f19902y.getStrokeWidth()) / f10, (-this.f19902y.getStrokeWidth()) / f10);
        }
        rectF.sort();
        this.f19899v.union(rectF);
        this.f19899v.sort();
    }
    ...
    protected void onDraw(Canvas canvas) {
        ...
        Bitmap bitmap = this.f19897t;
        if (bitmap != null) {
            canvas.drawBitmap(bitmap, 0.0f, 0.0f, this.f19901x);
        }
        h(canvas);
        canvas.drawPath(this.f19900w, this.f19902y);
    }
    ...
    protected void onSizeChanged(int i10, int i11, int i12, int i13) {
        ...
        if (i10 > 0 && i11 > 0) {
            ...
            this.f19897t = createBitmap;
            Intrinsics.checkNotNullExpressionValue(createBitmap, "also(...)");
            this.f19898u = new Canvas(createBitmap);
        }
    }
