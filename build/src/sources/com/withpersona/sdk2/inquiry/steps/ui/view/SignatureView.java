...
public final class SignatureView extends MaterialCardView {
    ...
    private Bitmap f19757t;

    /* renamed from: u  reason: collision with root package name */
    private Canvas f19758u;

    /* renamed from: v  reason: collision with root package name */
    private RectF f19759v;

    /* renamed from: w  reason: collision with root package name */
    private Path f19760w;

    /* renamed from: x  reason: collision with root package name */
    private final Paint f19761x;

    /* renamed from: y  reason: collision with root package name */
    private final Paint f19762y;

    /* renamed from: z  reason: collision with root package name */
    private float f19763z;

    public SignatureView(Context context, AttributeSet attributeSet) {
        super(context, attributeSet);
        this.f19759v = new RectF();
        this.f19760w = new Path();
        this.f19761x = new Paint(4);
        this.f19762y = new Paint();
        j(context, attributeSet);
    }

    private final Rect g() {
        RectF rectF = new RectF(this.f19759v.left - this.f19762y.getStrokeWidth(), this.f19759v.top - this.f19762y.getStrokeWidth(), this.f19759v.right + this.f19762y.getStrokeWidth(), this.f19759v.bottom + this.f19762y.getStrokeWidth());
        Rect rect = new Rect();
        rectF.roundOut(rect);
        return rect;
    }
    ...
    private final void j(Context context, AttributeSet attributeSet) {
        this.f19762y.setAntiAlias(true);
        this.f19762y.setDither(true);
        this.f19762y.setColor(-16777216);
        this.f19762y.setStyle(Paint.Style.STROKE);
        this.f19762y.setStrokeJoin(Paint.Join.ROUND);
        this.f19762y.setStrokeCap(Paint.Cap.ROUND);
        this.f19762y.setStrokeWidth(5.0f);
    }

    private final boolean k() {
        return this.f19759v.isEmpty();
    }

    private final void l(float f10, float f11) {
        this.f19760w.lineTo(f10, f11);
        this.f19763z = f10;
        this.A = f11;
    }
    ...
    private final void m(float f10, float f11) {
        this.f19760w.reset();
        this.f19760w.moveTo(f10, f11);
        this.f19763z = f10;
        this.A = f11;
    }

    private final void n() {
        Canvas canvas = this.f19758u;
        if (canvas == null) {
            return;
        }
        if (!this.f19760w.isEmpty()) {
            this.f19760w.lineTo(this.f19763z, this.A);
            canvas.drawPath(this.f19760w, this.f19762y);
        } else {
            this.f19760w.moveTo(this.f19763z - 0.5f, this.A - 0.5f);
            this.f19760w.lineTo(this.f19763z, this.A);
            canvas.drawPoint(this.f19763z, this.A, this.f19762y);
        }
        o();
        this.f19760w.reset();
    }
    ...
    private final void o() {
        ...
        this.f19760w.computeBounds(rectF, true);
        if (!this.f19760w.isEmpty()) {
            float f10 = 2;
            rectF.inset((-this.f19762y.getStrokeWidth()) / f10, (-this.f19762y.getStrokeWidth()) / f10);
        }
        rectF.sort();
        this.f19759v.union(rectF);
        this.f19759v.sort();
    }
    ...
    protected void onDraw(Canvas canvas) {
        ...
        Bitmap bitmap = this.f19757t;
        if (bitmap != null) {
            canvas.drawBitmap(bitmap, 0.0f, 0.0f, this.f19761x);
        }
        h(canvas);
        canvas.drawPath(this.f19760w, this.f19762y);
    }
    ...
    protected void onSizeChanged(int i10, int i11, int i12, int i13) {
        ...
        if (i10 > 0 && i11 > 0) {
            ...
            this.f19757t = createBitmap;
            Intrinsics.checkNotNullExpressionValue(createBitmap, "also(...)");
            this.f19758u = new Canvas(createBitmap);
        }
    }
