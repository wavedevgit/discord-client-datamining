...
public final class SignatureView extends MaterialCardView {
    ...
    private Bitmap f19371t;

    /* renamed from: u  reason: collision with root package name */
    private Canvas f19372u;

    /* renamed from: v  reason: collision with root package name */
    private RectF f19373v;

    /* renamed from: w  reason: collision with root package name */
    private Path f19374w;

    /* renamed from: x  reason: collision with root package name */
    private final Paint f19375x;

    /* renamed from: y  reason: collision with root package name */
    private final Paint f19376y;

    /* renamed from: z  reason: collision with root package name */
    private float f19377z;

    public SignatureView(Context context, AttributeSet attributeSet) {
        super(context, attributeSet);
        this.f19373v = new RectF();
        this.f19374w = new Path();
        this.f19375x = new Paint(4);
        this.f19376y = new Paint();
        j(context, attributeSet);
    }

    private final Rect g() {
        RectF rectF = new RectF(this.f19373v.left - this.f19376y.getStrokeWidth(), this.f19373v.top - this.f19376y.getStrokeWidth(), this.f19373v.right + this.f19376y.getStrokeWidth(), this.f19373v.bottom + this.f19376y.getStrokeWidth());
        Rect rect = new Rect();
        rectF.roundOut(rect);
        return rect;
    }
    ...
    private final void j(Context context, AttributeSet attributeSet) {
        this.f19376y.setAntiAlias(true);
        this.f19376y.setDither(true);
        this.f19376y.setColor(-16777216);
        this.f19376y.setStyle(Paint.Style.STROKE);
        this.f19376y.setStrokeJoin(Paint.Join.ROUND);
        this.f19376y.setStrokeCap(Paint.Cap.ROUND);
        this.f19376y.setStrokeWidth(5.0f);
    }

    private final boolean k() {
        return this.f19373v.isEmpty();
    }

    private final void l(float f10, float f11) {
        this.f19374w.lineTo(f10, f11);
        this.f19377z = f10;
        this.A = f11;
    }
    ...
    private final void m(float f10, float f11) {
        this.f19374w.reset();
        this.f19374w.moveTo(f10, f11);
        this.f19377z = f10;
        this.A = f11;
    }

    private final void n() {
        Canvas canvas = this.f19372u;
        if (canvas == null) {
            return;
        }
        if (!this.f19374w.isEmpty()) {
            this.f19374w.lineTo(this.f19377z, this.A);
            canvas.drawPath(this.f19374w, this.f19376y);
        } else {
            this.f19374w.moveTo(this.f19377z - 0.5f, this.A - 0.5f);
            this.f19374w.lineTo(this.f19377z, this.A);
            canvas.drawPoint(this.f19377z, this.A, this.f19376y);
        }
        o();
        this.f19374w.reset();
    }
    ...
    private final void o() {
        ...
        this.f19374w.computeBounds(rectF, true);
        if (!this.f19374w.isEmpty()) {
            float f10 = 2;
            rectF.inset((-this.f19376y.getStrokeWidth()) / f10, (-this.f19376y.getStrokeWidth()) / f10);
        }
        rectF.sort();
        this.f19373v.union(rectF);
        this.f19373v.sort();
    }
    ...
    protected void onDraw(Canvas canvas) {
        ...
        Bitmap bitmap = this.f19371t;
        if (bitmap != null) {
            canvas.drawBitmap(bitmap, 0.0f, 0.0f, this.f19375x);
        }
        h(canvas);
        canvas.drawPath(this.f19374w, this.f19376y);
    }
    ...
    protected void onSizeChanged(int i10, int i11, int i12, int i13) {
        ...
        if (i10 > 0 && i11 > 0) {
            ...
            this.f19371t = createBitmap;
            Intrinsics.checkNotNullExpressionValue(createBitmap, "also(...)");
            this.f19372u = new Canvas(createBitmap);
        }
    }
