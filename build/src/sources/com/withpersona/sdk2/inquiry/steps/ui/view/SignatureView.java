...
public final class SignatureView extends MaterialCardView {
    ...
    private Bitmap f19777t;

    /* renamed from: u  reason: collision with root package name */
    private Canvas f19778u;

    /* renamed from: v  reason: collision with root package name */
    private RectF f19779v;

    /* renamed from: w  reason: collision with root package name */
    private Path f19780w;

    /* renamed from: x  reason: collision with root package name */
    private final Paint f19781x;

    /* renamed from: y  reason: collision with root package name */
    private final Paint f19782y;

    /* renamed from: z  reason: collision with root package name */
    private float f19783z;

    public SignatureView(Context context, AttributeSet attributeSet) {
        super(context, attributeSet);
        this.f19779v = new RectF();
        this.f19780w = new Path();
        this.f19781x = new Paint(4);
        this.f19782y = new Paint();
        j(context, attributeSet);
    }

    private final Rect g() {
        RectF rectF = new RectF(this.f19779v.left - this.f19782y.getStrokeWidth(), this.f19779v.top - this.f19782y.getStrokeWidth(), this.f19779v.right + this.f19782y.getStrokeWidth(), this.f19779v.bottom + this.f19782y.getStrokeWidth());
        Rect rect = new Rect();
        rectF.roundOut(rect);
        return rect;
    }
    ...
    private final void j(Context context, AttributeSet attributeSet) {
        this.f19782y.setAntiAlias(true);
        this.f19782y.setDither(true);
        this.f19782y.setColor(-16777216);
        this.f19782y.setStyle(Paint.Style.STROKE);
        this.f19782y.setStrokeJoin(Paint.Join.ROUND);
        this.f19782y.setStrokeCap(Paint.Cap.ROUND);
        this.f19782y.setStrokeWidth(5.0f);
    }

    private final boolean k() {
        return this.f19779v.isEmpty();
    }

    private final void l(float f10, float f11) {
        this.f19780w.lineTo(f10, f11);
        this.f19783z = f10;
        this.A = f11;
    }
    ...
    private final void m(float f10, float f11) {
        this.f19780w.reset();
        this.f19780w.moveTo(f10, f11);
        this.f19783z = f10;
        this.A = f11;
    }

    private final void n() {
        Canvas canvas = this.f19778u;
        if (canvas == null) {
            return;
        }
        if (!this.f19780w.isEmpty()) {
            this.f19780w.lineTo(this.f19783z, this.A);
            canvas.drawPath(this.f19780w, this.f19782y);
        } else {
            this.f19780w.moveTo(this.f19783z - 0.5f, this.A - 0.5f);
            this.f19780w.lineTo(this.f19783z, this.A);
            canvas.drawPoint(this.f19783z, this.A, this.f19782y);
        }
        o();
        this.f19780w.reset();
    }
    ...
    private final void o() {
        ...
        this.f19780w.computeBounds(rectF, true);
        if (!this.f19780w.isEmpty()) {
            float f10 = 2;
            rectF.inset((-this.f19782y.getStrokeWidth()) / f10, (-this.f19782y.getStrokeWidth()) / f10);
        }
        rectF.sort();
        this.f19779v.union(rectF);
        this.f19779v.sort();
    }
    ...
    protected void onDraw(Canvas canvas) {
        ...
        Bitmap bitmap = this.f19777t;
        if (bitmap != null) {
            canvas.drawBitmap(bitmap, 0.0f, 0.0f, this.f19781x);
        }
        h(canvas);
        canvas.drawPath(this.f19780w, this.f19782y);
    }
    ...
    protected void onSizeChanged(int i10, int i11, int i12, int i13) {
        ...
        if (i10 > 0 && i11 > 0) {
            ...
            this.f19777t = createBitmap;
            Intrinsics.checkNotNullExpressionValue(createBitmap, "also(...)");
            this.f19778u = new Canvas(createBitmap);
        }
    }
