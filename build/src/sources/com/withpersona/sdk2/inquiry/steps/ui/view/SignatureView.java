...
public final class SignatureView extends MaterialCardView {
    ...
    private Bitmap f20756t;

    /* renamed from: u  reason: collision with root package name */
    private Canvas f20757u;

    /* renamed from: v  reason: collision with root package name */
    private RectF f20758v;

    /* renamed from: w  reason: collision with root package name */
    private Path f20759w;

    /* renamed from: x  reason: collision with root package name */
    private final Paint f20760x;

    /* renamed from: y  reason: collision with root package name */
    private final Paint f20761y;

    /* renamed from: z  reason: collision with root package name */
    private float f20762z;

    public SignatureView(Context context, AttributeSet attributeSet) {
        super(context, attributeSet);
        this.f20758v = new RectF();
        this.f20759w = new Path();
        this.f20760x = new Paint(4);
        this.f20761y = new Paint();
        j(context, attributeSet);
    }

    private final Rect g() {
        RectF rectF = new RectF(this.f20758v.left - this.f20761y.getStrokeWidth(), this.f20758v.top - this.f20761y.getStrokeWidth(), this.f20758v.right + this.f20761y.getStrokeWidth(), this.f20758v.bottom + this.f20761y.getStrokeWidth());
        Rect rect = new Rect();
        rectF.roundOut(rect);
        return rect;
    }
    ...
    private final void j(Context context, AttributeSet attributeSet) {
        this.f20761y.setAntiAlias(true);
        this.f20761y.setDither(true);
        this.f20761y.setColor(-16777216);
        this.f20761y.setStyle(Paint.Style.STROKE);
        this.f20761y.setStrokeJoin(Paint.Join.ROUND);
        this.f20761y.setStrokeCap(Paint.Cap.ROUND);
        this.f20761y.setStrokeWidth(5.0f);
    }

    private final boolean k() {
        return this.f20758v.isEmpty();
    }

    private final void l(float f10, float f11) {
        this.f20759w.lineTo(f10, f11);
        this.f20762z = f10;
        this.A = f11;
    }
    ...
    private final void m(float f10, float f11) {
        this.f20759w.reset();
        this.f20759w.moveTo(f10, f11);
        this.f20762z = f10;
        this.A = f11;
    }

    private final void n() {
        Canvas canvas = this.f20757u;
        if (canvas == null) {
            return;
        }
        if (!this.f20759w.isEmpty()) {
            this.f20759w.lineTo(this.f20762z, this.A);
            canvas.drawPath(this.f20759w, this.f20761y);
        } else {
            this.f20759w.moveTo(this.f20762z - 0.5f, this.A - 0.5f);
            this.f20759w.lineTo(this.f20762z, this.A);
            canvas.drawPoint(this.f20762z, this.A, this.f20761y);
        }
        o();
        this.f20759w.reset();
    }
    ...
    private final void o() {
        ...
        this.f20759w.computeBounds(rectF, true);
        if (!this.f20759w.isEmpty()) {
            float f10 = 2;
            rectF.inset((-this.f20761y.getStrokeWidth()) / f10, (-this.f20761y.getStrokeWidth()) / f10);
        }
        rectF.sort();
        this.f20758v.union(rectF);
        this.f20758v.sort();
    }
    ...
    protected void onDraw(Canvas canvas) {
        ...
        Bitmap bitmap = this.f20756t;
        if (bitmap != null) {
            canvas.drawBitmap(bitmap, 0.0f, 0.0f, this.f20760x);
        }
        h(canvas);
        canvas.drawPath(this.f20759w, this.f20761y);
    }
    ...
    protected void onSizeChanged(int i10, int i11, int i12, int i13) {
        ...
        if (i10 > 0 && i11 > 0) {
            ...
            this.f20756t = createBitmap;
            Intrinsics.checkNotNullExpressionValue(createBitmap, "also(...)");
            this.f20757u = new Canvas(createBitmap);
        }
    }
