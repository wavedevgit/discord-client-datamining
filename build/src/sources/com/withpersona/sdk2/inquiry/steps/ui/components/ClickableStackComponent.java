...
public final class ClickableStackComponent implements k5, l5, v, e0 {
    ...
    private final List f19580e;

    /* renamed from: i  reason: collision with root package name */
    private final JsonLogicBoolean f19581i;

    /* renamed from: o  reason: collision with root package name */
    private final JsonLogicBoolean f19582o;

    /* renamed from: p  reason: collision with root package name */
    private final ClickableStack.ClickableStackComponentStyle f19583p;

    /* renamed from: q  reason: collision with root package name */
    private boolean f19584q;

    /* renamed from: r  reason: collision with root package name */
    private final List f19585r;
    ...
    public ClickableStackComponent(String name, List children, JsonLogicBoolean jsonLogicBoolean, JsonLogicBoolean jsonLogicBoolean2, ClickableStack.ClickableStackComponentStyle clickableStackComponentStyle, boolean z10) {
        ...
        this.f19579d = name;
        this.f19580e = children;
        this.f19581i = jsonLogicBoolean;
        this.f19582o = jsonLogicBoolean2;
        this.f19583p = clickableStackComponentStyle;
        this.f19584q = z10;
    ...
    public static /* synthetic */ ClickableStackComponent b(ClickableStackComponent clickableStackComponent, String str, List list, JsonLogicBoolean jsonLogicBoolean, JsonLogicBoolean jsonLogicBoolean2, ClickableStack.ClickableStackComponentStyle clickableStackComponentStyle, boolean z10, int i10, Object obj) {
        if ((i10 & 1) != 0) {
            str = clickableStackComponent.f19579d;
        }
        if ((i10 & 2) != 0) {
            list = clickableStackComponent.f19580e;
        }
        if ((i10 & 4) != 0) {
            jsonLogicBoolean = clickableStackComponent.f19581i;
        }
        if ((i10 & 8) != 0) {
            jsonLogicBoolean2 = clickableStackComponent.f19582o;
        }
        if ((i10 & 16) != 0) {
            clickableStackComponentStyle = clickableStackComponent.f19583p;
        }
        if ((i10 & 32) != 0) {
            z10 = clickableStackComponent.f19584q;
        }
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof ClickableStackComponent) {
            ...
            return Intrinsics.areEqual(this.f19579d, clickableStackComponent.f19579d) && Intrinsics.areEqual(this.f19580e, clickableStackComponent.f19580e) && Intrinsics.areEqual(this.f19581i, clickableStackComponent.f19581i) && Intrinsics.areEqual(this.f19582o, clickableStackComponent.f19582o) && Intrinsics.areEqual(this.f19583p, clickableStackComponent.f19583p) && this.f19584q == clickableStackComponent.f19584q;
        }
        return false;
    }
    ...
    public int hashCode() {
        int hashCode = ((this.f19579d.hashCode() * 31) + this.f19580e.hashCode()) * 31;
        JsonLogicBoolean jsonLogicBoolean = this.f19581i;
        int hashCode2 = (hashCode + (jsonLogicBoolean == null ? 0 : jsonLogicBoolean.hashCode())) * 31;
        JsonLogicBoolean jsonLogicBoolean2 = this.f19582o;
        int hashCode3 = (hashCode2 + (jsonLogicBoolean2 == null ? 0 : jsonLogicBoolean2.hashCode())) * 31;
        ClickableStack.ClickableStackComponentStyle clickableStackComponentStyle = this.f19583p;
        return ((hashCode3 + (clickableStackComponentStyle != null ? clickableStackComponentStyle.hashCode() : 0)) * 31) + Boolean.hashCode(this.f19584q);
    }
    ...
    public final void writeToParcel(Parcel dest, int i10) {
        ...
        List<Parcelable> list = this.f19580e;
        dest.writeInt(list.size());
        for (Parcelable parcelable : list) {
            dest.writeParcelable(parcelable, i10);
        }
        dest.writeParcelable(this.f19581i, i10);
        dest.writeParcelable(this.f19582o, i10);
        dest.writeParcelable(this.f19583p, i10);
        dest.writeInt(this.f19584q ? 1 : 0);
    }
    ...
    */
    public ClickableStackComponent(com.withpersona.sdk2.inquiry.network.dto.ui.components.ClickableStack r11) {
        ...
        L1a:
            ...
            dq.k5 r3 = com.withpersona.sdk2.inquiry.steps.ui.components.f.l(r3)
            if (r3 == 0) goto L1a
            r1.add(r3)
            goto L1a
        L30:
