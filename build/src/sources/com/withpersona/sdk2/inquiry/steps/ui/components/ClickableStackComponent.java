...
public final class ClickableStackComponent implements k5, l5, v, e0 {
    ...
    private final List f19560e;

    /* renamed from: i  reason: collision with root package name */
    private final JsonLogicBoolean f19561i;

    /* renamed from: o  reason: collision with root package name */
    private final JsonLogicBoolean f19562o;

    /* renamed from: p  reason: collision with root package name */
    private final ClickableStack.ClickableStackComponentStyle f19563p;

    /* renamed from: q  reason: collision with root package name */
    private boolean f19564q;

    /* renamed from: r  reason: collision with root package name */
    private final List f19565r;
    ...
    public ClickableStackComponent(String name, List children, JsonLogicBoolean jsonLogicBoolean, JsonLogicBoolean jsonLogicBoolean2, ClickableStack.ClickableStackComponentStyle clickableStackComponentStyle, boolean z10) {
        ...
        this.f19559d = name;
        this.f19560e = children;
        this.f19561i = jsonLogicBoolean;
        this.f19562o = jsonLogicBoolean2;
        this.f19563p = clickableStackComponentStyle;
        this.f19564q = z10;
        this.f19565r = new ArrayList();
    }
    ...
    public static /* synthetic */ ClickableStackComponent b(ClickableStackComponent clickableStackComponent, String str, List list, JsonLogicBoolean jsonLogicBoolean, JsonLogicBoolean jsonLogicBoolean2, ClickableStack.ClickableStackComponentStyle clickableStackComponentStyle, boolean z10, int i10, Object obj) {
        if ((i10 & 1) != 0) {
            str = clickableStackComponent.f19559d;
        }
        if ((i10 & 2) != 0) {
            list = clickableStackComponent.f19560e;
        }
        if ((i10 & 4) != 0) {
            jsonLogicBoolean = clickableStackComponent.f19561i;
        }
        if ((i10 & 8) != 0) {
            jsonLogicBoolean2 = clickableStackComponent.f19562o;
        }
        if ((i10 & 16) != 0) {
            clickableStackComponentStyle = clickableStackComponent.f19563p;
        }
        if ((i10 & 32) != 0) {
            z10 = clickableStackComponent.f19564q;
        }
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof ClickableStackComponent) {
            ...
            return Intrinsics.areEqual(this.f19559d, clickableStackComponent.f19559d) && Intrinsics.areEqual(this.f19560e, clickableStackComponent.f19560e) && Intrinsics.areEqual(this.f19561i, clickableStackComponent.f19561i) && Intrinsics.areEqual(this.f19562o, clickableStackComponent.f19562o) && Intrinsics.areEqual(this.f19563p, clickableStackComponent.f19563p) && this.f19564q == clickableStackComponent.f19564q;
        }
        return false;
    }
    ...
    public int hashCode() {
        int hashCode = ((this.f19559d.hashCode() * 31) + this.f19560e.hashCode()) * 31;
        JsonLogicBoolean jsonLogicBoolean = this.f19561i;
        int hashCode2 = (hashCode + (jsonLogicBoolean == null ? 0 : jsonLogicBoolean.hashCode())) * 31;
        JsonLogicBoolean jsonLogicBoolean2 = this.f19562o;
        int hashCode3 = (hashCode2 + (jsonLogicBoolean2 == null ? 0 : jsonLogicBoolean2.hashCode())) * 31;
        ClickableStack.ClickableStackComponentStyle clickableStackComponentStyle = this.f19563p;
        return ((hashCode3 + (clickableStackComponentStyle != null ? clickableStackComponentStyle.hashCode() : 0)) * 31) + Boolean.hashCode(this.f19564q);
    }
    ...
    public final void writeToParcel(Parcel dest, int i10) {
        ...
        dest.writeString(this.f19559d);
        List<Parcelable> list = this.f19560e;
        dest.writeInt(list.size());
        for (Parcelable parcelable : list) {
            dest.writeParcelable(parcelable, i10);
        }
        dest.writeParcelable(this.f19561i, i10);
        dest.writeParcelable(this.f19562o, i10);
        dest.writeParcelable(this.f19563p, i10);
        dest.writeInt(this.f19564q ? 1 : 0);
    }
