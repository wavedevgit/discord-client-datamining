...
public final class InputCurrencyComponent implements k5, v4, v, e0 {
    ...
    private final Number f19243e;

    /* renamed from: i  reason: collision with root package name */
    private final JsonLogicBoolean f19244i;

    /* renamed from: o  reason: collision with root package name */
    private final JsonLogicBoolean f19245o;

    /* renamed from: p  reason: collision with root package name */
    private final TextBasedComponentStyle f19246p;
    ...
    public InputCurrencyComponent(String name, Number number, JsonLogicBoolean jsonLogicBoolean, JsonLogicBoolean jsonLogicBoolean2, TextBasedComponentStyle textBasedComponentStyle) {
        ...
        this.f19242d = name;
        this.f19243e = number;
        this.f19244i = jsonLogicBoolean;
        this.f19245o = jsonLogicBoolean2;
        this.f19246p = textBasedComponentStyle;
        this.f19247q = new ArrayList();
        this.f19248r = new i(number);
    }
    ...
    public static /* synthetic */ InputCurrencyComponent e(InputCurrencyComponent inputCurrencyComponent, String str, Number number, JsonLogicBoolean jsonLogicBoolean, JsonLogicBoolean jsonLogicBoolean2, TextBasedComponentStyle textBasedComponentStyle, int i10, Object obj) {
        if ((i10 & 1) != 0) {
            str = inputCurrencyComponent.f19242d;
        }
        if ((i10 & 2) != 0) {
            number = inputCurrencyComponent.f19243e;
        }
        if ((i10 & 4) != 0) {
            jsonLogicBoolean = inputCurrencyComponent.f19244i;
        }
        if ((i10 & 8) != 0) {
            jsonLogicBoolean2 = inputCurrencyComponent.f19245o;
        }
        if ((i10 & 16) != 0) {
            textBasedComponentStyle = inputCurrencyComponent.f19246p;
        }
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof InputCurrencyComponent) {
            ...
            return Intrinsics.areEqual(this.f19242d, inputCurrencyComponent.f19242d) && Intrinsics.areEqual(this.f19243e, inputCurrencyComponent.f19243e) && Intrinsics.areEqual(this.f19244i, inputCurrencyComponent.f19244i) && Intrinsics.areEqual(this.f19245o, inputCurrencyComponent.f19245o) && Intrinsics.areEqual(this.f19246p, inputCurrencyComponent.f19246p);
        }
        return false;
    }
    ...
    public int hashCode() {
        ...
        Number number = this.f19243e;
        int hashCode2 = (hashCode + (number == null ? 0 : number.hashCode())) * 31;
        JsonLogicBoolean jsonLogicBoolean = this.f19244i;
        int hashCode3 = (hashCode2 + (jsonLogicBoolean == null ? 0 : jsonLogicBoolean.hashCode())) * 31;
        JsonLogicBoolean jsonLogicBoolean2 = this.f19245o;
        int hashCode4 = (hashCode3 + (jsonLogicBoolean2 == null ? 0 : jsonLogicBoolean2.hashCode())) * 31;
        TextBasedComponentStyle textBasedComponentStyle = this.f19246p;
    ...
    public final void writeToParcel(Parcel dest, int i10) {
        ...
        dest.writeString(this.f19242d);
        dest.writeSerializable(this.f19243e);
        dest.writeParcelable(this.f19244i, i10);
        dest.writeParcelable(this.f19245o, i10);
        dest.writeParcelable(this.f19246p, i10);
    }
