...
public final class InputCurrencyComponent implements k5, v4, v, e0 {
    ...
    private final Number f19629e;

    /* renamed from: i  reason: collision with root package name */
    private final JsonLogicBoolean f19630i;

    /* renamed from: o  reason: collision with root package name */
    private final JsonLogicBoolean f19631o;

    /* renamed from: p  reason: collision with root package name */
    private final TextBasedComponentStyle f19632p;

    /* renamed from: q  reason: collision with root package name */
    private final List f19633q;
    ...
    public InputCurrencyComponent(String name, Number number, JsonLogicBoolean jsonLogicBoolean, JsonLogicBoolean jsonLogicBoolean2, TextBasedComponentStyle textBasedComponentStyle) {
        ...
        this.f19628d = name;
        this.f19629e = number;
        this.f19630i = jsonLogicBoolean;
        this.f19631o = jsonLogicBoolean2;
        this.f19632p = textBasedComponentStyle;
        this.f19633q = new ArrayList();
        this.f19634r = new i(number);
    }
    ...
    public static /* synthetic */ InputCurrencyComponent e(InputCurrencyComponent inputCurrencyComponent, String str, Number number, JsonLogicBoolean jsonLogicBoolean, JsonLogicBoolean jsonLogicBoolean2, TextBasedComponentStyle textBasedComponentStyle, int i10, Object obj) {
        if ((i10 & 1) != 0) {
            str = inputCurrencyComponent.f19628d;
        }
        if ((i10 & 2) != 0) {
            number = inputCurrencyComponent.f19629e;
        }
        if ((i10 & 4) != 0) {
            jsonLogicBoolean = inputCurrencyComponent.f19630i;
        }
        if ((i10 & 8) != 0) {
            jsonLogicBoolean2 = inputCurrencyComponent.f19631o;
        }
        if ((i10 & 16) != 0) {
            textBasedComponentStyle = inputCurrencyComponent.f19632p;
        }
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof InputCurrencyComponent) {
            ...
            return Intrinsics.areEqual(this.f19628d, inputCurrencyComponent.f19628d) && Intrinsics.areEqual(this.f19629e, inputCurrencyComponent.f19629e) && Intrinsics.areEqual(this.f19630i, inputCurrencyComponent.f19630i) && Intrinsics.areEqual(this.f19631o, inputCurrencyComponent.f19631o) && Intrinsics.areEqual(this.f19632p, inputCurrencyComponent.f19632p);
        }
        return false;
    }
    ...
    public int hashCode() {
        ...
        Number number = this.f19629e;
        int hashCode2 = (hashCode + (number == null ? 0 : number.hashCode())) * 31;
        JsonLogicBoolean jsonLogicBoolean = this.f19630i;
        int hashCode3 = (hashCode2 + (jsonLogicBoolean == null ? 0 : jsonLogicBoolean.hashCode())) * 31;
        JsonLogicBoolean jsonLogicBoolean2 = this.f19631o;
        int hashCode4 = (hashCode3 + (jsonLogicBoolean2 == null ? 0 : jsonLogicBoolean2.hashCode())) * 31;
        TextBasedComponentStyle textBasedComponentStyle = this.f19632p;
    ...
    public final void writeToParcel(Parcel dest, int i10) {
        ...
        dest.writeSerializable(this.f19629e);
        dest.writeParcelable(this.f19630i, i10);
        dest.writeParcelable(this.f19631o, i10);
        dest.writeParcelable(this.f19632p, i10);
    }
