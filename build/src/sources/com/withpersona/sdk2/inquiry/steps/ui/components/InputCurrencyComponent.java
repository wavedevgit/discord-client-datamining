...
public final class InputCurrencyComponent implements k5, v4, v, e0 {
    ...
    private final Number f20261e;

    /* renamed from: i  reason: collision with root package name */
    private final JsonLogicBoolean f20262i;

    /* renamed from: o  reason: collision with root package name */
    private final JsonLogicBoolean f20263o;

    /* renamed from: p  reason: collision with root package name */
    private final TextBasedComponentStyle f20264p;

    /* renamed from: q  reason: collision with root package name */
    private final List f20265q;
    ...
    public InputCurrencyComponent(String name, Number number, JsonLogicBoolean jsonLogicBoolean, JsonLogicBoolean jsonLogicBoolean2, TextBasedComponentStyle textBasedComponentStyle) {
        ...
        this.f20260d = name;
        this.f20261e = number;
        this.f20262i = jsonLogicBoolean;
        this.f20263o = jsonLogicBoolean2;
        this.f20264p = textBasedComponentStyle;
        this.f20265q = new ArrayList();
        this.f20266r = new i(number);
    }
    ...
    public static /* synthetic */ InputCurrencyComponent e(InputCurrencyComponent inputCurrencyComponent, String str, Number number, JsonLogicBoolean jsonLogicBoolean, JsonLogicBoolean jsonLogicBoolean2, TextBasedComponentStyle textBasedComponentStyle, int i10, Object obj) {
        if ((i10 & 1) != 0) {
            str = inputCurrencyComponent.f20260d;
        }
        if ((i10 & 2) != 0) {
            number = inputCurrencyComponent.f20261e;
        }
        if ((i10 & 4) != 0) {
            jsonLogicBoolean = inputCurrencyComponent.f20262i;
        }
        if ((i10 & 8) != 0) {
            jsonLogicBoolean2 = inputCurrencyComponent.f20263o;
        }
        if ((i10 & 16) != 0) {
            textBasedComponentStyle = inputCurrencyComponent.f20264p;
        }
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof InputCurrencyComponent) {
            ...
            return Intrinsics.areEqual(this.f20260d, inputCurrencyComponent.f20260d) && Intrinsics.areEqual(this.f20261e, inputCurrencyComponent.f20261e) && Intrinsics.areEqual(this.f20262i, inputCurrencyComponent.f20262i) && Intrinsics.areEqual(this.f20263o, inputCurrencyComponent.f20263o) && Intrinsics.areEqual(this.f20264p, inputCurrencyComponent.f20264p);
        }
        return false;
    }
    ...
    public int hashCode() {
        int hashCode = this.f20260d.hashCode() * 31;
        Number number = this.f20261e;
        int hashCode2 = (hashCode + (number == null ? 0 : number.hashCode())) * 31;
        JsonLogicBoolean jsonLogicBoolean = this.f20262i;
        int hashCode3 = (hashCode2 + (jsonLogicBoolean == null ? 0 : jsonLogicBoolean.hashCode())) * 31;
        JsonLogicBoolean jsonLogicBoolean2 = this.f20263o;
        int hashCode4 = (hashCode3 + (jsonLogicBoolean2 == null ? 0 : jsonLogicBoolean2.hashCode())) * 31;
        TextBasedComponentStyle textBasedComponentStyle = this.f20264p;
    ...
    public final void writeToParcel(Parcel dest, int i10) {
        ...
        dest.writeString(this.f20260d);
        dest.writeSerializable(this.f20261e);
        dest.writeParcelable(this.f20262i, i10);
        dest.writeParcelable(this.f20263o, i10);
        dest.writeParcelable(this.f20264p, i10);
    }
