...
public final class InputCurrencyComponent implements k5, v4, v, e0 {
    ...
    private final Number f20628e;

    /* renamed from: i  reason: collision with root package name */
    private final JsonLogicBoolean f20629i;

    /* renamed from: o  reason: collision with root package name */
    private final JsonLogicBoolean f20630o;

    /* renamed from: p  reason: collision with root package name */
    private final TextBasedComponentStyle f20631p;

    /* renamed from: q  reason: collision with root package name */
    private final List f20632q;
    ...
    public InputCurrencyComponent(String name, Number number, JsonLogicBoolean jsonLogicBoolean, JsonLogicBoolean jsonLogicBoolean2, TextBasedComponentStyle textBasedComponentStyle) {
        ...
        this.f20627d = name;
        this.f20628e = number;
        this.f20629i = jsonLogicBoolean;
        this.f20630o = jsonLogicBoolean2;
        this.f20631p = textBasedComponentStyle;
        this.f20632q = new ArrayList();
        this.f20633r = new i(number);
    }
    ...
    public static /* synthetic */ InputCurrencyComponent e(InputCurrencyComponent inputCurrencyComponent, String str, Number number, JsonLogicBoolean jsonLogicBoolean, JsonLogicBoolean jsonLogicBoolean2, TextBasedComponentStyle textBasedComponentStyle, int i10, Object obj) {
        if ((i10 & 1) != 0) {
            str = inputCurrencyComponent.f20627d;
        }
        if ((i10 & 2) != 0) {
            number = inputCurrencyComponent.f20628e;
        }
        if ((i10 & 4) != 0) {
            jsonLogicBoolean = inputCurrencyComponent.f20629i;
        }
        if ((i10 & 8) != 0) {
            jsonLogicBoolean2 = inputCurrencyComponent.f20630o;
        }
        if ((i10 & 16) != 0) {
            textBasedComponentStyle = inputCurrencyComponent.f20631p;
        }
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof InputCurrencyComponent) {
            ...
            return Intrinsics.areEqual(this.f20627d, inputCurrencyComponent.f20627d) && Intrinsics.areEqual(this.f20628e, inputCurrencyComponent.f20628e) && Intrinsics.areEqual(this.f20629i, inputCurrencyComponent.f20629i) && Intrinsics.areEqual(this.f20630o, inputCurrencyComponent.f20630o) && Intrinsics.areEqual(this.f20631p, inputCurrencyComponent.f20631p);
        }
        return false;
    }
    ...
    public int hashCode() {
        int hashCode = this.f20627d.hashCode() * 31;
        Number number = this.f20628e;
        int hashCode2 = (hashCode + (number == null ? 0 : number.hashCode())) * 31;
        JsonLogicBoolean jsonLogicBoolean = this.f20629i;
        int hashCode3 = (hashCode2 + (jsonLogicBoolean == null ? 0 : jsonLogicBoolean.hashCode())) * 31;
        JsonLogicBoolean jsonLogicBoolean2 = this.f20630o;
        int hashCode4 = (hashCode3 + (jsonLogicBoolean2 == null ? 0 : jsonLogicBoolean2.hashCode())) * 31;
        TextBasedComponentStyle textBasedComponentStyle = this.f20631p;
    ...
    public final void writeToParcel(Parcel dest, int i10) {
        ...
        dest.writeSerializable(this.f20628e);
        dest.writeParcelable(this.f20629i, i10);
        dest.writeParcelable(this.f20630o, i10);
        dest.writeParcelable(this.f20631p, i10);
    }
