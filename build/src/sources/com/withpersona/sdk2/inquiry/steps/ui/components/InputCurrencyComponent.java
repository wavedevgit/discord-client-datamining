...
public final class InputCurrencyComponent implements k5, v4, v, e0 {
    ...
    private final Number f19769e;

    /* renamed from: i  reason: collision with root package name */
    private final JsonLogicBoolean f19770i;

    /* renamed from: o  reason: collision with root package name */
    private final JsonLogicBoolean f19771o;

    /* renamed from: p  reason: collision with root package name */
    private final TextBasedComponentStyle f19772p;

    /* renamed from: q  reason: collision with root package name */
    private final List f19773q;
    ...
    public InputCurrencyComponent(String name, Number number, JsonLogicBoolean jsonLogicBoolean, JsonLogicBoolean jsonLogicBoolean2, TextBasedComponentStyle textBasedComponentStyle) {
        ...
        this.f19768d = name;
        this.f19769e = number;
        this.f19770i = jsonLogicBoolean;
        this.f19771o = jsonLogicBoolean2;
        this.f19772p = textBasedComponentStyle;
        this.f19773q = new ArrayList();
        this.f19774r = new i(number);
    }
    ...
    public static /* synthetic */ InputCurrencyComponent e(InputCurrencyComponent inputCurrencyComponent, String str, Number number, JsonLogicBoolean jsonLogicBoolean, JsonLogicBoolean jsonLogicBoolean2, TextBasedComponentStyle textBasedComponentStyle, int i10, Object obj) {
        if ((i10 & 1) != 0) {
            str = inputCurrencyComponent.f19768d;
        }
        if ((i10 & 2) != 0) {
            number = inputCurrencyComponent.f19769e;
        }
        if ((i10 & 4) != 0) {
            jsonLogicBoolean = inputCurrencyComponent.f19770i;
        }
        if ((i10 & 8) != 0) {
            jsonLogicBoolean2 = inputCurrencyComponent.f19771o;
        }
        if ((i10 & 16) != 0) {
            textBasedComponentStyle = inputCurrencyComponent.f19772p;
        }
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof InputCurrencyComponent) {
            ...
            return Intrinsics.areEqual(this.f19768d, inputCurrencyComponent.f19768d) && Intrinsics.areEqual(this.f19769e, inputCurrencyComponent.f19769e) && Intrinsics.areEqual(this.f19770i, inputCurrencyComponent.f19770i) && Intrinsics.areEqual(this.f19771o, inputCurrencyComponent.f19771o) && Intrinsics.areEqual(this.f19772p, inputCurrencyComponent.f19772p);
        }
        return false;
    }
    ...
    public int hashCode() {
        int hashCode = this.f19768d.hashCode() * 31;
        Number number = this.f19769e;
        int hashCode2 = (hashCode + (number == null ? 0 : number.hashCode())) * 31;
        JsonLogicBoolean jsonLogicBoolean = this.f19770i;
        int hashCode3 = (hashCode2 + (jsonLogicBoolean == null ? 0 : jsonLogicBoolean.hashCode())) * 31;
        JsonLogicBoolean jsonLogicBoolean2 = this.f19771o;
        int hashCode4 = (hashCode3 + (jsonLogicBoolean2 == null ? 0 : jsonLogicBoolean2.hashCode())) * 31;
        TextBasedComponentStyle textBasedComponentStyle = this.f19772p;
    ...
    public final void writeToParcel(Parcel dest, int i10) {
        ...
        dest.writeString(this.f19768d);
        dest.writeSerializable(this.f19769e);
        dest.writeParcelable(this.f19770i, i10);
        dest.writeParcelable(this.f19771o, i10);
        dest.writeParcelable(this.f19772p, i10);
    }
