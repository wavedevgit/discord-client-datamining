...
public final class SuggestionJsonAdapter extends h {
    ...
    private final m.b f20754a;

    /* renamed from: b  reason: collision with root package name */
    private final h f20755b;
    ...
    /* renamed from: a */
    public Suggestion fromJson(m reader) {
        Intrinsics.checkNotNullParameter(reader, "reader");
        reader.r();
        String str = null;
        String str2 = null;
        while (reader.hasNext()) {
            int A0 = reader.A0(this.f20754a);
            if (A0 != -1) {
                if (A0 != 0) {
                    if (A0 == 1 && (str2 = (String) this.f20755b.fromJson(reader)) == null) {
                        throw c.x("address", "address", reader);
                    }
                } else {
                    str = (String) this.f20755b.fromJson(reader);
                    if (str == null) {
        ...
        if (str != null) {
            ...
            throw c.o("address", "address", reader);
        }
    ...
    public void toJson(t writer, Suggestion suggestion) {
        ...
        if (suggestion != null) {
            ...
            this.f20755b.toJson(writer, suggestion.b());
            writer.A0("address");
            this.f20755b.toJson(writer, suggestion.a());
            writer.E();
            return;
        }
