...
public final class SuggestionJsonAdapter extends h {
    ...
    public Suggestion fromJson(m reader) {
        ...
        while (reader.hasNext()) {
            int W = reader.W(this.f19775a);
            if (W != -1) {
                if (W != 0) {
                    if (W == 1 && (str2 = (String) this.f19776b.fromJson(reader)) == null) {
                        throw c.x("address", "address", reader);
                    }
                } else {
                    str = (String) this.f19776b.fromJson(reader);
                    if (str == null) {
    ...
    public void toJson(t writer, Suggestion suggestion) {
        ...
        if (suggestion != null) {
            ...
            this.f19776b.toJson(writer, suggestion.b());
            writer.W("address");
            this.f19776b.toJson(writer, suggestion.a());
            writer.E();
            return;
        }
