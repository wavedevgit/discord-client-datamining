...
public final class ESignatureComponent implements k5, xp.d, v, e0 {
    ...
    private final JsonLogicBoolean f20573e;

    /* renamed from: i  reason: collision with root package name */
    private final JsonLogicBoolean f20574i;

    /* renamed from: o  reason: collision with root package name */
    private Bitmap f20575o;

    /* renamed from: p  reason: collision with root package name */
    private final List f20576p;

    /* renamed from: q  reason: collision with root package name */
    private yp.a f20577q;
    ...
    public ESignatureComponent(String name, JsonLogicBoolean jsonLogicBoolean, JsonLogicBoolean jsonLogicBoolean2) {
        ...
        this.f20572d = name;
        this.f20573e = jsonLogicBoolean;
        this.f20574i = jsonLogicBoolean2;
        this.f20576p = new ArrayList();
        this.f20577q = new yp.a(null);
    }
    ...
    public static /* synthetic */ ESignatureComponent e(ESignatureComponent eSignatureComponent, String str, JsonLogicBoolean jsonLogicBoolean, JsonLogicBoolean jsonLogicBoolean2, int i10, Object obj) {
        if ((i10 & 1) != 0) {
            str = eSignatureComponent.f20572d;
        }
        if ((i10 & 2) != 0) {
            jsonLogicBoolean = eSignatureComponent.f20573e;
        }
        if ((i10 & 4) != 0) {
            jsonLogicBoolean2 = eSignatureComponent.f20574i;
        }
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof ESignatureComponent) {
            ...
            return Intrinsics.areEqual(this.f20572d, eSignatureComponent.f20572d) && Intrinsics.areEqual(this.f20573e, eSignatureComponent.f20573e) && Intrinsics.areEqual(this.f20574i, eSignatureComponent.f20574i);
        }
        return false;
    }
    ...
    public int hashCode() {
        int hashCode = this.f20572d.hashCode() * 31;
        JsonLogicBoolean jsonLogicBoolean = this.f20573e;
        int hashCode2 = (hashCode + (jsonLogicBoolean == null ? 0 : jsonLogicBoolean.hashCode())) * 31;
        JsonLogicBoolean jsonLogicBoolean2 = this.f20574i;
    ...
    public final void writeToParcel(Parcel dest, int i10) {
        ...
        dest.writeString(this.f20572d);
        dest.writeParcelable(this.f20573e, i10);
        dest.writeParcelable(this.f20574i, i10);
    }
