...
public final class ESignatureComponent implements k5, gq.d, v, e0 {
    ...
    private final JsonLogicBoolean f19714e;

    /* renamed from: i  reason: collision with root package name */
    private final JsonLogicBoolean f19715i;

    /* renamed from: o  reason: collision with root package name */
    private Bitmap f19716o;

    /* renamed from: p  reason: collision with root package name */
    private final List f19717p;

    /* renamed from: q  reason: collision with root package name */
    private hq.a f19718q;
    ...
    public ESignatureComponent(String name, JsonLogicBoolean jsonLogicBoolean, JsonLogicBoolean jsonLogicBoolean2) {
        ...
        this.f19713d = name;
        this.f19714e = jsonLogicBoolean;
        this.f19715i = jsonLogicBoolean2;
        this.f19717p = new ArrayList();
        this.f19718q = new hq.a(null);
    }
    ...
    public static /* synthetic */ ESignatureComponent e(ESignatureComponent eSignatureComponent, String str, JsonLogicBoolean jsonLogicBoolean, JsonLogicBoolean jsonLogicBoolean2, int i10, Object obj) {
        if ((i10 & 1) != 0) {
            str = eSignatureComponent.f19713d;
        }
        if ((i10 & 2) != 0) {
            jsonLogicBoolean = eSignatureComponent.f19714e;
        }
        if ((i10 & 4) != 0) {
            jsonLogicBoolean2 = eSignatureComponent.f19715i;
        }
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof ESignatureComponent) {
            ...
            return Intrinsics.areEqual(this.f19713d, eSignatureComponent.f19713d) && Intrinsics.areEqual(this.f19714e, eSignatureComponent.f19714e) && Intrinsics.areEqual(this.f19715i, eSignatureComponent.f19715i);
        }
        return false;
    }
    ...
    public int hashCode() {
        int hashCode = this.f19713d.hashCode() * 31;
        JsonLogicBoolean jsonLogicBoolean = this.f19714e;
        int hashCode2 = (hashCode + (jsonLogicBoolean == null ? 0 : jsonLogicBoolean.hashCode())) * 31;
        JsonLogicBoolean jsonLogicBoolean2 = this.f19715i;
    ...
    public final void writeToParcel(Parcel dest, int i10) {
        ...
        dest.writeString(this.f19713d);
        dest.writeParcelable(this.f19714e, i10);
        dest.writeParcelable(this.f19715i, i10);
    }
