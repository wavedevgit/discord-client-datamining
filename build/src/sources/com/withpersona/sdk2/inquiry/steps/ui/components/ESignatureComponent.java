...
public final class ESignatureComponent implements k5, dq.d, v, e0 {
    ...
    private final JsonLogicBoolean f19594e;

    /* renamed from: i  reason: collision with root package name */
    private final JsonLogicBoolean f19595i;

    /* renamed from: o  reason: collision with root package name */
    private Bitmap f19596o;

    /* renamed from: p  reason: collision with root package name */
    private final List f19597p;

    /* renamed from: q  reason: collision with root package name */
    private eq.a f19598q;
    ...
    public ESignatureComponent(String name, JsonLogicBoolean jsonLogicBoolean, JsonLogicBoolean jsonLogicBoolean2) {
        ...
        this.f19593d = name;
        this.f19594e = jsonLogicBoolean;
        this.f19595i = jsonLogicBoolean2;
        this.f19597p = new ArrayList();
        this.f19598q = new eq.a(null);
    }
    ...
    public static /* synthetic */ ESignatureComponent e(ESignatureComponent eSignatureComponent, String str, JsonLogicBoolean jsonLogicBoolean, JsonLogicBoolean jsonLogicBoolean2, int i10, Object obj) {
        if ((i10 & 1) != 0) {
            str = eSignatureComponent.f19593d;
        }
        if ((i10 & 2) != 0) {
            jsonLogicBoolean = eSignatureComponent.f19594e;
        }
        if ((i10 & 4) != 0) {
            jsonLogicBoolean2 = eSignatureComponent.f19595i;
        }
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof ESignatureComponent) {
            ...
            return Intrinsics.areEqual(this.f19593d, eSignatureComponent.f19593d) && Intrinsics.areEqual(this.f19594e, eSignatureComponent.f19594e) && Intrinsics.areEqual(this.f19595i, eSignatureComponent.f19595i);
        }
        return false;
    }
    ...
    public int hashCode() {
        int hashCode = this.f19593d.hashCode() * 31;
        JsonLogicBoolean jsonLogicBoolean = this.f19594e;
        int hashCode2 = (hashCode + (jsonLogicBoolean == null ? 0 : jsonLogicBoolean.hashCode())) * 31;
        JsonLogicBoolean jsonLogicBoolean2 = this.f19595i;
    ...
    public final void writeToParcel(Parcel dest, int i10) {
        ...
        dest.writeString(this.f19593d);
        dest.writeParcelable(this.f19594e, i10);
        dest.writeParcelable(this.f19595i, i10);
    }
