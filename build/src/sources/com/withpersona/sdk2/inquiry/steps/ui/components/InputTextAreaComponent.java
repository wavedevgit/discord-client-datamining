...
public final class InputTextAreaComponent implements k5, w4, v, e0 {
    ...
    private final JsonLogicBoolean f20676i;

    /* renamed from: o  reason: collision with root package name */
    private final JsonLogicBoolean f20677o;

    /* renamed from: p  reason: collision with root package name */
    private final TextBasedComponentStyle f20678p;

    /* renamed from: q  reason: collision with root package name */
    private final List f20679q;
    ...
    public InputTextAreaComponent(String name, String value, JsonLogicBoolean jsonLogicBoolean, JsonLogicBoolean jsonLogicBoolean2, TextBasedComponentStyle textBasedComponentStyle) {
        ...
        this.f20674d = name;
        this.f20675e = value;
        this.f20676i = jsonLogicBoolean;
        this.f20677o = jsonLogicBoolean2;
        this.f20678p = textBasedComponentStyle;
        this.f20679q = new ArrayList();
        this.f20680r = w.a(value);
    }
    ...
    public static /* synthetic */ InputTextAreaComponent e(InputTextAreaComponent inputTextAreaComponent, String str, String str2, JsonLogicBoolean jsonLogicBoolean, JsonLogicBoolean jsonLogicBoolean2, TextBasedComponentStyle textBasedComponentStyle, int i10, Object obj) {
        if ((i10 & 1) != 0) {
            str = inputTextAreaComponent.f20674d;
        }
        if ((i10 & 2) != 0) {
            str2 = inputTextAreaComponent.f20675e;
        }
        if ((i10 & 4) != 0) {
            jsonLogicBoolean = inputTextAreaComponent.f20676i;
        }
        if ((i10 & 8) != 0) {
            jsonLogicBoolean2 = inputTextAreaComponent.f20677o;
        }
        if ((i10 & 16) != 0) {
            textBasedComponentStyle = inputTextAreaComponent.f20678p;
        }
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof InputTextAreaComponent) {
            ...
            return Intrinsics.areEqual(this.f20674d, inputTextAreaComponent.f20674d) && Intrinsics.areEqual(this.f20675e, inputTextAreaComponent.f20675e) && Intrinsics.areEqual(this.f20676i, inputTextAreaComponent.f20676i) && Intrinsics.areEqual(this.f20677o, inputTextAreaComponent.f20677o) && Intrinsics.areEqual(this.f20678p, inputTextAreaComponent.f20678p);
        }
        return false;
    }
    ...
    public int hashCode() {
        int hashCode = ((this.f20674d.hashCode() * 31) + this.f20675e.hashCode()) * 31;
        JsonLogicBoolean jsonLogicBoolean = this.f20676i;
        int hashCode2 = (hashCode + (jsonLogicBoolean == null ? 0 : jsonLogicBoolean.hashCode())) * 31;
        JsonLogicBoolean jsonLogicBoolean2 = this.f20677o;
        int hashCode3 = (hashCode2 + (jsonLogicBoolean2 == null ? 0 : jsonLogicBoolean2.hashCode())) * 31;
        TextBasedComponentStyle textBasedComponentStyle = this.f20678p;
    ...
    public final void writeToParcel(Parcel dest, int i10) {
        ...
        dest.writeString(this.f20674d);
        dest.writeString(this.f20675e);
        dest.writeParcelable(this.f20676i, i10);
        dest.writeParcelable(this.f20677o, i10);
        dest.writeParcelable(this.f20678p, i10);
    }
