...
public final class InputTextAreaComponent implements k5, w4, v, e0 {
    ...
    private final JsonLogicBoolean f19697i;

    /* renamed from: o  reason: collision with root package name */
    private final JsonLogicBoolean f19698o;

    /* renamed from: p  reason: collision with root package name */
    private final TextBasedComponentStyle f19699p;

    /* renamed from: q  reason: collision with root package name */
    private final List f19700q;
    ...
    public InputTextAreaComponent(String name, String value, JsonLogicBoolean jsonLogicBoolean, JsonLogicBoolean jsonLogicBoolean2, TextBasedComponentStyle textBasedComponentStyle) {
        ...
        this.f19695d = name;
        this.f19696e = value;
        this.f19697i = jsonLogicBoolean;
        this.f19698o = jsonLogicBoolean2;
        this.f19699p = textBasedComponentStyle;
        this.f19700q = new ArrayList();
        this.f19701r = w.a(value);
    }
    ...
    public static /* synthetic */ InputTextAreaComponent e(InputTextAreaComponent inputTextAreaComponent, String str, String str2, JsonLogicBoolean jsonLogicBoolean, JsonLogicBoolean jsonLogicBoolean2, TextBasedComponentStyle textBasedComponentStyle, int i10, Object obj) {
        if ((i10 & 1) != 0) {
            str = inputTextAreaComponent.f19695d;
        }
        if ((i10 & 2) != 0) {
            str2 = inputTextAreaComponent.f19696e;
        }
        if ((i10 & 4) != 0) {
            jsonLogicBoolean = inputTextAreaComponent.f19697i;
        }
        if ((i10 & 8) != 0) {
            jsonLogicBoolean2 = inputTextAreaComponent.f19698o;
        }
        if ((i10 & 16) != 0) {
            textBasedComponentStyle = inputTextAreaComponent.f19699p;
        }
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof InputTextAreaComponent) {
            ...
            return Intrinsics.areEqual(this.f19695d, inputTextAreaComponent.f19695d) && Intrinsics.areEqual(this.f19696e, inputTextAreaComponent.f19696e) && Intrinsics.areEqual(this.f19697i, inputTextAreaComponent.f19697i) && Intrinsics.areEqual(this.f19698o, inputTextAreaComponent.f19698o) && Intrinsics.areEqual(this.f19699p, inputTextAreaComponent.f19699p);
        }
        return false;
    }
    ...
    public int hashCode() {
        int hashCode = ((this.f19695d.hashCode() * 31) + this.f19696e.hashCode()) * 31;
        JsonLogicBoolean jsonLogicBoolean = this.f19697i;
        int hashCode2 = (hashCode + (jsonLogicBoolean == null ? 0 : jsonLogicBoolean.hashCode())) * 31;
        JsonLogicBoolean jsonLogicBoolean2 = this.f19698o;
        int hashCode3 = (hashCode2 + (jsonLogicBoolean2 == null ? 0 : jsonLogicBoolean2.hashCode())) * 31;
        TextBasedComponentStyle textBasedComponentStyle = this.f19699p;
    ...
    public final void writeToParcel(Parcel dest, int i10) {
        ...
        dest.writeString(this.f19695d);
        dest.writeString(this.f19696e);
        dest.writeParcelable(this.f19697i, i10);
        dest.writeParcelable(this.f19698o, i10);
        dest.writeParcelable(this.f19699p, i10);
    }
