...
public final class InputTextAreaComponent implements k5, w4, v, e0 {
    ...
    private final JsonLogicBoolean f19677i;

    /* renamed from: o  reason: collision with root package name */
    private final JsonLogicBoolean f19678o;

    /* renamed from: p  reason: collision with root package name */
    private final TextBasedComponentStyle f19679p;

    /* renamed from: q  reason: collision with root package name */
    private final List f19680q;
    ...
    public InputTextAreaComponent(String name, String value, JsonLogicBoolean jsonLogicBoolean, JsonLogicBoolean jsonLogicBoolean2, TextBasedComponentStyle textBasedComponentStyle) {
        ...
        this.f19675d = name;
        this.f19676e = value;
        this.f19677i = jsonLogicBoolean;
        this.f19678o = jsonLogicBoolean2;
        this.f19679p = textBasedComponentStyle;
        this.f19680q = new ArrayList();
        this.f19681r = w.a(value);
    }
    ...
    public static /* synthetic */ InputTextAreaComponent e(InputTextAreaComponent inputTextAreaComponent, String str, String str2, JsonLogicBoolean jsonLogicBoolean, JsonLogicBoolean jsonLogicBoolean2, TextBasedComponentStyle textBasedComponentStyle, int i10, Object obj) {
        if ((i10 & 1) != 0) {
            str = inputTextAreaComponent.f19675d;
        }
        if ((i10 & 2) != 0) {
            str2 = inputTextAreaComponent.f19676e;
        }
        if ((i10 & 4) != 0) {
            jsonLogicBoolean = inputTextAreaComponent.f19677i;
        }
        if ((i10 & 8) != 0) {
            jsonLogicBoolean2 = inputTextAreaComponent.f19678o;
        }
        if ((i10 & 16) != 0) {
            textBasedComponentStyle = inputTextAreaComponent.f19679p;
        }
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof InputTextAreaComponent) {
            ...
            return Intrinsics.areEqual(this.f19675d, inputTextAreaComponent.f19675d) && Intrinsics.areEqual(this.f19676e, inputTextAreaComponent.f19676e) && Intrinsics.areEqual(this.f19677i, inputTextAreaComponent.f19677i) && Intrinsics.areEqual(this.f19678o, inputTextAreaComponent.f19678o) && Intrinsics.areEqual(this.f19679p, inputTextAreaComponent.f19679p);
        }
        return false;
    }
    ...
    public int hashCode() {
        int hashCode = ((this.f19675d.hashCode() * 31) + this.f19676e.hashCode()) * 31;
        JsonLogicBoolean jsonLogicBoolean = this.f19677i;
        int hashCode2 = (hashCode + (jsonLogicBoolean == null ? 0 : jsonLogicBoolean.hashCode())) * 31;
        JsonLogicBoolean jsonLogicBoolean2 = this.f19678o;
        int hashCode3 = (hashCode2 + (jsonLogicBoolean2 == null ? 0 : jsonLogicBoolean2.hashCode())) * 31;
        TextBasedComponentStyle textBasedComponentStyle = this.f19679p;
    ...
    public final void writeToParcel(Parcel dest, int i10) {
        ...
        dest.writeString(this.f19675d);
        dest.writeString(this.f19676e);
        dest.writeParcelable(this.f19677i, i10);
        dest.writeParcelable(this.f19678o, i10);
        dest.writeParcelable(this.f19679p, i10);
    }
