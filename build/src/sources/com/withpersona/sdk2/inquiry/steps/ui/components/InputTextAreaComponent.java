...
public final class InputTextAreaComponent implements k5, w4, v, e0 {
    ...
    private final JsonLogicBoolean f19817i;

    /* renamed from: o  reason: collision with root package name */
    private final JsonLogicBoolean f19818o;

    /* renamed from: p  reason: collision with root package name */
    private final TextBasedComponentStyle f19819p;

    /* renamed from: q  reason: collision with root package name */
    private final List f19820q;
    ...
    public InputTextAreaComponent(String name, String value, JsonLogicBoolean jsonLogicBoolean, JsonLogicBoolean jsonLogicBoolean2, TextBasedComponentStyle textBasedComponentStyle) {
        ...
        this.f19815d = name;
        this.f19816e = value;
        this.f19817i = jsonLogicBoolean;
        this.f19818o = jsonLogicBoolean2;
        this.f19819p = textBasedComponentStyle;
        this.f19820q = new ArrayList();
        this.f19821r = w.a(value);
    }
    ...
    public static /* synthetic */ InputTextAreaComponent e(InputTextAreaComponent inputTextAreaComponent, String str, String str2, JsonLogicBoolean jsonLogicBoolean, JsonLogicBoolean jsonLogicBoolean2, TextBasedComponentStyle textBasedComponentStyle, int i10, Object obj) {
        if ((i10 & 1) != 0) {
            str = inputTextAreaComponent.f19815d;
        }
        if ((i10 & 2) != 0) {
            str2 = inputTextAreaComponent.f19816e;
        }
        if ((i10 & 4) != 0) {
            jsonLogicBoolean = inputTextAreaComponent.f19817i;
        }
        if ((i10 & 8) != 0) {
            jsonLogicBoolean2 = inputTextAreaComponent.f19818o;
        }
        if ((i10 & 16) != 0) {
            textBasedComponentStyle = inputTextAreaComponent.f19819p;
        }
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof InputTextAreaComponent) {
            ...
            return Intrinsics.areEqual(this.f19815d, inputTextAreaComponent.f19815d) && Intrinsics.areEqual(this.f19816e, inputTextAreaComponent.f19816e) && Intrinsics.areEqual(this.f19817i, inputTextAreaComponent.f19817i) && Intrinsics.areEqual(this.f19818o, inputTextAreaComponent.f19818o) && Intrinsics.areEqual(this.f19819p, inputTextAreaComponent.f19819p);
        }
        return false;
    }
    ...
    public int hashCode() {
        int hashCode = ((this.f19815d.hashCode() * 31) + this.f19816e.hashCode()) * 31;
        JsonLogicBoolean jsonLogicBoolean = this.f19817i;
        int hashCode2 = (hashCode + (jsonLogicBoolean == null ? 0 : jsonLogicBoolean.hashCode())) * 31;
        JsonLogicBoolean jsonLogicBoolean2 = this.f19818o;
        int hashCode3 = (hashCode2 + (jsonLogicBoolean2 == null ? 0 : jsonLogicBoolean2.hashCode())) * 31;
        TextBasedComponentStyle textBasedComponentStyle = this.f19819p;
    ...
    public final void writeToParcel(Parcel dest, int i10) {
        ...
        dest.writeString(this.f19815d);
        dest.writeString(this.f19816e);
        dest.writeParcelable(this.f19817i, i10);
        dest.writeParcelable(this.f19818o, i10);
        dest.writeParcelable(this.f19819p, i10);
    }
