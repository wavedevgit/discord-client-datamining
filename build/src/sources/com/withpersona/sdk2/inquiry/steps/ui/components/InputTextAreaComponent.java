...
public final class InputTextAreaComponent implements k5, w4, v, e0 {
    ...
    private final JsonLogicBoolean f20309i;

    /* renamed from: o  reason: collision with root package name */
    private final JsonLogicBoolean f20310o;

    /* renamed from: p  reason: collision with root package name */
    private final TextBasedComponentStyle f20311p;

    /* renamed from: q  reason: collision with root package name */
    private final List f20312q;
    ...
    public InputTextAreaComponent(String name, String value, JsonLogicBoolean jsonLogicBoolean, JsonLogicBoolean jsonLogicBoolean2, TextBasedComponentStyle textBasedComponentStyle) {
        ...
        this.f20307d = name;
        this.f20308e = value;
        this.f20309i = jsonLogicBoolean;
        this.f20310o = jsonLogicBoolean2;
        this.f20311p = textBasedComponentStyle;
        this.f20312q = new ArrayList();
        this.f20313r = w.a(value);
    }
    ...
    public static /* synthetic */ InputTextAreaComponent e(InputTextAreaComponent inputTextAreaComponent, String str, String str2, JsonLogicBoolean jsonLogicBoolean, JsonLogicBoolean jsonLogicBoolean2, TextBasedComponentStyle textBasedComponentStyle, int i10, Object obj) {
        if ((i10 & 1) != 0) {
            str = inputTextAreaComponent.f20307d;
        }
        if ((i10 & 2) != 0) {
            str2 = inputTextAreaComponent.f20308e;
        }
        if ((i10 & 4) != 0) {
            jsonLogicBoolean = inputTextAreaComponent.f20309i;
        }
        if ((i10 & 8) != 0) {
            jsonLogicBoolean2 = inputTextAreaComponent.f20310o;
        }
        if ((i10 & 16) != 0) {
            textBasedComponentStyle = inputTextAreaComponent.f20311p;
        }
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof InputTextAreaComponent) {
            ...
            return Intrinsics.areEqual(this.f20307d, inputTextAreaComponent.f20307d) && Intrinsics.areEqual(this.f20308e, inputTextAreaComponent.f20308e) && Intrinsics.areEqual(this.f20309i, inputTextAreaComponent.f20309i) && Intrinsics.areEqual(this.f20310o, inputTextAreaComponent.f20310o) && Intrinsics.areEqual(this.f20311p, inputTextAreaComponent.f20311p);
        }
        return false;
    }
    ...
    public int hashCode() {
        int hashCode = ((this.f20307d.hashCode() * 31) + this.f20308e.hashCode()) * 31;
        JsonLogicBoolean jsonLogicBoolean = this.f20309i;
        int hashCode2 = (hashCode + (jsonLogicBoolean == null ? 0 : jsonLogicBoolean.hashCode())) * 31;
        JsonLogicBoolean jsonLogicBoolean2 = this.f20310o;
        int hashCode3 = (hashCode2 + (jsonLogicBoolean2 == null ? 0 : jsonLogicBoolean2.hashCode())) * 31;
        TextBasedComponentStyle textBasedComponentStyle = this.f20311p;
    ...
    public final void writeToParcel(Parcel dest, int i10) {
        ...
        dest.writeString(this.f20307d);
        dest.writeString(this.f20308e);
        dest.writeParcelable(this.f20309i, i10);
        dest.writeParcelable(this.f20310o, i10);
        dest.writeParcelable(this.f20311p, i10);
    }
