...
public final class InputDateComponent implements k5, s, v, e0 {
    ...
    private final JsonLogicBoolean f19657i;

    /* renamed from: o  reason: collision with root package name */
    private final JsonLogicBoolean f19658o;

    /* renamed from: p  reason: collision with root package name */
    private final String f19659p;

    /* renamed from: q  reason: collision with root package name */
    private final List f19660q;

    /* renamed from: r  reason: collision with root package name */
    private final List f19661r;

    /* renamed from: s  reason: collision with root package name */
    private eq.e f19662s;
    ...
    public InputDateComponent(String name, String str, JsonLogicBoolean jsonLogicBoolean, JsonLogicBoolean jsonLogicBoolean2, String str2, List monthList) {
        ...
        this.f19655d = name;
        this.f19656e = str;
        this.f19657i = jsonLogicBoolean;
        this.f19658o = jsonLogicBoolean2;
        this.f19659p = str2;
        this.f19660q = monthList;
        this.f19661r = new ArrayList();
        this.f19662s = new eq.e(str, str2, monthList);
    }
    ...
    public static /* synthetic */ InputDateComponent e(InputDateComponent inputDateComponent, String str, String str2, JsonLogicBoolean jsonLogicBoolean, JsonLogicBoolean jsonLogicBoolean2, String str3, List list, int i10, Object obj) {
        if ((i10 & 1) != 0) {
            str = inputDateComponent.f19655d;
        }
        if ((i10 & 2) != 0) {
            str2 = inputDateComponent.f19656e;
        }
        if ((i10 & 4) != 0) {
            jsonLogicBoolean = inputDateComponent.f19657i;
        }
        if ((i10 & 8) != 0) {
            jsonLogicBoolean2 = inputDateComponent.f19658o;
        }
        if ((i10 & 16) != 0) {
            str3 = inputDateComponent.f19659p;
        }
        if ((i10 & 32) != 0) {
            list = inputDateComponent.f19660q;
        }
        String str4 = str3;
        List list2 = list;
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof InputDateComponent) {
            ...
            return Intrinsics.areEqual(this.f19655d, inputDateComponent.f19655d) && Intrinsics.areEqual(this.f19656e, inputDateComponent.f19656e) && Intrinsics.areEqual(this.f19657i, inputDateComponent.f19657i) && Intrinsics.areEqual(this.f19658o, inputDateComponent.f19658o) && Intrinsics.areEqual(this.f19659p, inputDateComponent.f19659p) && Intrinsics.areEqual(this.f19660q, inputDateComponent.f19660q);
        }
        return false;
    }

    public void f(eq.e eVar) {
    ...
    public int hashCode() {
        int hashCode = this.f19655d.hashCode() * 31;
        String str = this.f19656e;
        int hashCode2 = (hashCode + (str == null ? 0 : str.hashCode())) * 31;
        JsonLogicBoolean jsonLogicBoolean = this.f19657i;
        int hashCode3 = (hashCode2 + (jsonLogicBoolean == null ? 0 : jsonLogicBoolean.hashCode())) * 31;
        JsonLogicBoolean jsonLogicBoolean2 = this.f19658o;
        int hashCode4 = (hashCode3 + (jsonLogicBoolean2 == null ? 0 : jsonLogicBoolean2.hashCode())) * 31;
        String str2 = this.f19659p;
        return ((hashCode4 + (str2 != null ? str2.hashCode() : 0)) * 31) + this.f19660q.hashCode();
    }
    ...
    public String toString() {
        ...
        JsonLogicBoolean jsonLogicBoolean = this.f19657i;
        JsonLogicBoolean jsonLogicBoolean2 = this.f19658o;
        String str3 = this.f19659p;
        List list = this.f19660q;
    ...
    public final void writeToParcel(Parcel dest, int i10) {
        ...
        dest.writeString(this.f19655d);
        dest.writeString(this.f19656e);
        dest.writeParcelable(this.f19657i, i10);
        dest.writeParcelable(this.f19658o, i10);
        dest.writeString(this.f19659p);
        dest.writeStringList(this.f19660q);
    }
