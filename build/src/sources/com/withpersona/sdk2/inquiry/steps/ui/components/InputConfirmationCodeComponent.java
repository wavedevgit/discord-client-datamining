...
public final class InputConfirmationCodeComponent implements k5, w4, v, e0 {
    ...
    private final JsonLogicBoolean f19763i;

    /* renamed from: o  reason: collision with root package name */
    private final JsonLogicBoolean f19764o;

    /* renamed from: p  reason: collision with root package name */
    private final List f19765p;

    /* renamed from: q  reason: collision with root package name */
    private t f19766q;

    /* renamed from: r  reason: collision with root package name */
    private final iq.c f19767r;
    ...
    public InputConfirmationCodeComponent(String name, String value, JsonLogicBoolean jsonLogicBoolean, JsonLogicBoolean jsonLogicBoolean2) {
        ...
        this.f19761d = name;
        this.f19762e = value;
        this.f19763i = jsonLogicBoolean;
        this.f19764o = jsonLogicBoolean2;
        this.f19765p = new ArrayList();
        this.f19766q = w.a(value);
        this.f19767r = new iq.c();
    }
    ...
    public static /* synthetic */ InputConfirmationCodeComponent e(InputConfirmationCodeComponent inputConfirmationCodeComponent, String str, String str2, JsonLogicBoolean jsonLogicBoolean, JsonLogicBoolean jsonLogicBoolean2, int i10, Object obj) {
        if ((i10 & 1) != 0) {
            str = inputConfirmationCodeComponent.f19761d;
        }
        if ((i10 & 2) != 0) {
            str2 = inputConfirmationCodeComponent.f19762e;
        }
        if ((i10 & 4) != 0) {
            jsonLogicBoolean = inputConfirmationCodeComponent.f19763i;
        }
        if ((i10 & 8) != 0) {
            jsonLogicBoolean2 = inputConfirmationCodeComponent.f19764o;
        }
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof InputConfirmationCodeComponent) {
            ...
            return Intrinsics.areEqual(this.f19761d, inputConfirmationCodeComponent.f19761d) && Intrinsics.areEqual(this.f19762e, inputConfirmationCodeComponent.f19762e) && Intrinsics.areEqual(this.f19763i, inputConfirmationCodeComponent.f19763i) && Intrinsics.areEqual(this.f19764o, inputConfirmationCodeComponent.f19764o);
        }
        return false;
    }
    ...
    public int hashCode() {
        int hashCode = ((this.f19761d.hashCode() * 31) + this.f19762e.hashCode()) * 31;
        JsonLogicBoolean jsonLogicBoolean = this.f19763i;
        int hashCode2 = (hashCode + (jsonLogicBoolean == null ? 0 : jsonLogicBoolean.hashCode())) * 31;
        JsonLogicBoolean jsonLogicBoolean2 = this.f19764o;
    ...
    public final void writeToParcel(Parcel dest, int i10) {
        ...
        dest.writeString(this.f19761d);
        dest.writeString(this.f19762e);
        dest.writeParcelable(this.f19763i, i10);
        dest.writeParcelable(this.f19764o, i10);
    }
