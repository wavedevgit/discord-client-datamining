...
public final class InputConfirmationCodeComponent implements k5, w4, v, e0 {
    ...
    private final JsonLogicBoolean f19237i;

    /* renamed from: o  reason: collision with root package name */
    private final JsonLogicBoolean f19238o;

    /* renamed from: p  reason: collision with root package name */
    private final List f19239p;

    /* renamed from: q  reason: collision with root package name */
    private t f19240q;

    /* renamed from: r  reason: collision with root package name */
    private final cq.c f19241r;
    ...
    public InputConfirmationCodeComponent(String name, String value, JsonLogicBoolean jsonLogicBoolean, JsonLogicBoolean jsonLogicBoolean2) {
        ...
        this.f19235d = name;
        this.f19236e = value;
        this.f19237i = jsonLogicBoolean;
        this.f19238o = jsonLogicBoolean2;
        this.f19239p = new ArrayList();
        this.f19240q = w.a(value);
        this.f19241r = new cq.c();
    }
    ...
    public static /* synthetic */ InputConfirmationCodeComponent e(InputConfirmationCodeComponent inputConfirmationCodeComponent, String str, String str2, JsonLogicBoolean jsonLogicBoolean, JsonLogicBoolean jsonLogicBoolean2, int i10, Object obj) {
        if ((i10 & 1) != 0) {
            str = inputConfirmationCodeComponent.f19235d;
        }
        if ((i10 & 2) != 0) {
            str2 = inputConfirmationCodeComponent.f19236e;
        }
        if ((i10 & 4) != 0) {
            jsonLogicBoolean = inputConfirmationCodeComponent.f19237i;
        }
        if ((i10 & 8) != 0) {
            jsonLogicBoolean2 = inputConfirmationCodeComponent.f19238o;
        }
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof InputConfirmationCodeComponent) {
            ...
            return Intrinsics.areEqual(this.f19235d, inputConfirmationCodeComponent.f19235d) && Intrinsics.areEqual(this.f19236e, inputConfirmationCodeComponent.f19236e) && Intrinsics.areEqual(this.f19237i, inputConfirmationCodeComponent.f19237i) && Intrinsics.areEqual(this.f19238o, inputConfirmationCodeComponent.f19238o);
        }
        return false;
    }
    ...
    public int hashCode() {
        int hashCode = ((this.f19235d.hashCode() * 31) + this.f19236e.hashCode()) * 31;
        JsonLogicBoolean jsonLogicBoolean = this.f19237i;
        int hashCode2 = (hashCode + (jsonLogicBoolean == null ? 0 : jsonLogicBoolean.hashCode())) * 31;
        JsonLogicBoolean jsonLogicBoolean2 = this.f19238o;
    ...
    public final void writeToParcel(Parcel dest, int i10) {
        ...
        dest.writeString(this.f19235d);
        dest.writeString(this.f19236e);
        dest.writeParcelable(this.f19237i, i10);
        dest.writeParcelable(this.f19238o, i10);
    }
