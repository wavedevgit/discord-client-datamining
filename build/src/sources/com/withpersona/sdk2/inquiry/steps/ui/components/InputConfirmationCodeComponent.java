...
public final class InputConfirmationCodeComponent implements k5, w4, v, e0 {
    ...
    private final JsonLogicBoolean f19623i;

    /* renamed from: o  reason: collision with root package name */
    private final JsonLogicBoolean f19624o;

    /* renamed from: p  reason: collision with root package name */
    private final List f19625p;

    /* renamed from: q  reason: collision with root package name */
    private t f19626q;

    /* renamed from: r  reason: collision with root package name */
    private final hq.c f19627r;
    ...
    public InputConfirmationCodeComponent(String name, String value, JsonLogicBoolean jsonLogicBoolean, JsonLogicBoolean jsonLogicBoolean2) {
        ...
        this.f19621d = name;
        this.f19622e = value;
        this.f19623i = jsonLogicBoolean;
        this.f19624o = jsonLogicBoolean2;
        this.f19625p = new ArrayList();
        this.f19626q = w.a(value);
        this.f19627r = new hq.c();
    }
    ...
    public static /* synthetic */ InputConfirmationCodeComponent e(InputConfirmationCodeComponent inputConfirmationCodeComponent, String str, String str2, JsonLogicBoolean jsonLogicBoolean, JsonLogicBoolean jsonLogicBoolean2, int i10, Object obj) {
        if ((i10 & 1) != 0) {
            str = inputConfirmationCodeComponent.f19621d;
        }
        if ((i10 & 2) != 0) {
            str2 = inputConfirmationCodeComponent.f19622e;
        }
        if ((i10 & 4) != 0) {
            jsonLogicBoolean = inputConfirmationCodeComponent.f19623i;
        }
        if ((i10 & 8) != 0) {
            jsonLogicBoolean2 = inputConfirmationCodeComponent.f19624o;
        }
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof InputConfirmationCodeComponent) {
            ...
            return Intrinsics.areEqual(this.f19621d, inputConfirmationCodeComponent.f19621d) && Intrinsics.areEqual(this.f19622e, inputConfirmationCodeComponent.f19622e) && Intrinsics.areEqual(this.f19623i, inputConfirmationCodeComponent.f19623i) && Intrinsics.areEqual(this.f19624o, inputConfirmationCodeComponent.f19624o);
        }
        return false;
    }
    ...
    public int hashCode() {
        int hashCode = ((this.f19621d.hashCode() * 31) + this.f19622e.hashCode()) * 31;
        JsonLogicBoolean jsonLogicBoolean = this.f19623i;
        int hashCode2 = (hashCode + (jsonLogicBoolean == null ? 0 : jsonLogicBoolean.hashCode())) * 31;
        JsonLogicBoolean jsonLogicBoolean2 = this.f19624o;
    ...
    public final void writeToParcel(Parcel dest, int i10) {
        ...
        dest.writeString(this.f19621d);
        dest.writeString(this.f19622e);
        dest.writeParcelable(this.f19623i, i10);
        dest.writeParcelable(this.f19624o, i10);
    }
