...
public final class CreateDocumentRequest_AttributesJsonAdapter extends h {
    ...
    private final m.b f19471a;

    /* renamed from: b  reason: collision with root package name */
    private final h f19472b;

    /* renamed from: c  reason: collision with root package name */
    private final h f19473c;
    ...
    public CreateDocumentRequest.Attributes fromJson(m reader) {
        ...
        while (reader.hasNext()) {
            int A0 = reader.A0(this.f19471a);
            if (A0 != -1) {
                if (A0 != 0) {
                    if (A0 == 1 && (num = (Integer) this.f19473c.fromJson(reader)) == null) {
                        throw sm.c.x("fileLimit", "fileLimit", reader);
                    }
                } else {
                    str = (String) this.f19472b.fromJson(reader);
                    if (str == null) {
        ...
        if (str != null) {
            ...
            throw sm.c.o("fileLimit", "fileLimit", reader);
        }
    ...
    public void toJson(t writer, CreateDocumentRequest.Attributes attributes) {
        ...
        if (attributes != null) {
            writer.l();
            writer.A0("kind");
            this.f19472b.toJson(writer, attributes.b());
            writer.A0("fileLimit");
            this.f19473c.toJson(writer, Integer.valueOf(attributes.a()));
            writer.E();
            return;
        }
