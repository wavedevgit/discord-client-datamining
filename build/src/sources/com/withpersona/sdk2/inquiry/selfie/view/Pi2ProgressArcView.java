...
public final class Pi2ProgressArcView extends View {
    ...
    public static final a f19065t = new a(null);

    /* renamed from: d  reason: collision with root package name */
    private final Paint f19066d;

    /* renamed from: e  reason: collision with root package name */
    private final float f19067e;

    /* renamed from: i  reason: collision with root package name */
    private final float f19068i;

    /* renamed from: o  reason: collision with root package name */
    private float f19069o;

    /* renamed from: p  reason: collision with root package name */
    private ValueAnimator f19070p;

    /* renamed from: q  reason: collision with root package name */
    private ValueAnimator f19071q;

    /* renamed from: r  reason: collision with root package name */
    private ValueAnimator f19072r;
    ...
    public static final class b implements ValueAnimator.AnimatorUpdateListener {
        ...
        private float f19074a;

        /* renamed from: b  reason: collision with root package name */
        final /* synthetic */ ValueAnimator f19075b;

        /* renamed from: c  reason: collision with root package name */
        final /* synthetic */ Pi2ProgressArcView f19076c;

        b(ValueAnimator valueAnimator, Pi2ProgressArcView pi2ProgressArcView) {
            this.f19075b = valueAnimator;
            this.f19076c = pi2ProgressArcView;
        }

        @Override // android.animation.ValueAnimator.AnimatorUpdateListener
        public void onAnimationUpdate(ValueAnimator animator) {
            Intrinsics.checkNotNullParameter(animator, "animator");
            Object animatedValue = this.f19075b.getAnimatedValue();
            Intrinsics.checkNotNull(animatedValue, "null cannot be cast to non-null type kotlin.Float");
            float floatValue = ((Float) animatedValue).floatValue();
            float abs = Math.abs(floatValue - this.f19074a);
            float f10 = this.f19076c.f19073s;
            Pi2ProgressArcView pi2ProgressArcView = this.f19076c;
            pi2ProgressArcView.f19073s = (pi2ProgressArcView.f19073s + abs) % 360;
            if (f10 > this.f19076c.f19073s) {
                this.f19076c.f19073s = 0.0f;
                animator.cancel();
            }
            this.f19074a = floatValue;
    ...
    static final class c implements Runnable {
        ...
        /* renamed from: d  reason: collision with root package name */
        private final /* synthetic */ Function0 f19077d;

        c(Function0 function) {
            Intrinsics.checkNotNullParameter(function, "function");
            this.f19077d = function;
        }
    ...
    public static final class d implements ValueAnimator.AnimatorUpdateListener {
        ...
        /* renamed from: b  reason: collision with root package name */
        final /* synthetic */ ValueAnimator f19079b;

        /* renamed from: c  reason: collision with root package name */
        final /* synthetic */ Pi2ProgressArcView f19080c;

        d(ValueAnimator valueAnimator, Pi2ProgressArcView pi2ProgressArcView) {
            this.f19079b = valueAnimator;
            this.f19080c = pi2ProgressArcView;
        }

        @Override // android.animation.ValueAnimator.AnimatorUpdateListener
        public void onAnimationUpdate(ValueAnimator animator) {
            Intrinsics.checkNotNullParameter(animator, "animator");
            Object animatedValue = this.f19079b.getAnimatedValue();
            Intrinsics.checkNotNull(animatedValue, "null cannot be cast to non-null type kotlin.Float");
            float floatValue = ((Float) animatedValue).floatValue();
            float abs = Math.abs(floatValue - this.f19078a);
            Pi2ProgressArcView pi2ProgressArcView = this.f19080c;
            pi2ProgressArcView.f19073s = (pi2ProgressArcView.f19073s + abs) % 360;
            this.f19078a = floatValue;
            this.f19080c.invalidate();
        }
    }
    ...
    public static final class e implements Animator.AnimatorListener {
        ...
        /* renamed from: a  reason: collision with root package name */
        final /* synthetic */ Function0 f19081a;

        /* renamed from: b  reason: collision with root package name */
        final /* synthetic */ Pi2ProgressArcView f19082b;

        public e(Function0 function0, Pi2ProgressArcView pi2ProgressArcView) {
            this.f19081a = function0;
            this.f19082b = pi2ProgressArcView;
        }
        ...
        public void onAnimationEnd(Animator animator) {
            Function0 function0 = this.f19081a;
            if (function0 != null) {
                this.f19082b.postDelayed(new c(function0), 100L);
            }
        }
    ...
    private final void h(float f10, Function0 function0) {
        ...
        ValueAnimator valueAnimator = this.f19070p;
        if (valueAnimator != null) {
            valueAnimator.cancel();
        }
        float f11 = this.f19069o;
        final ValueAnimator ofFloat = ValueAnimator.ofFloat(f11, f10);
        ofFloat.setDuration(((float) 1000) * (Math.abs(f10 - f11) / 100.0f));
        ofFloat.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() { // from class: lp.o
            @Override // android.animation.ValueAnimator.AnimatorUpdateListener
    ...
    public static final void i(Pi2ProgressArcView pi2ProgressArcView, ValueAnimator valueAnimator, ValueAnimator it) {
        ...
        Intrinsics.checkNotNull(animatedValue, "null cannot be cast to non-null type kotlin.Float");
        pi2ProgressArcView.f19069o = ((Float) animatedValue).floatValue();
        pi2ProgressArcView.invalidate();
    }

    public final void e() {
        ValueAnimator valueAnimator = this.f19072r;
        if (valueAnimator != null) {
            valueAnimator.cancel();
        }
        ValueAnimator valueAnimator2 = this.f19071q;
        ...
        ofFloat.setRepeatMode(2);
        ofFloat.start();
        this.f19071q = ofFloat;
    }

    public final void f(float f10, Function0 function0) {
        ValueAnimator valueAnimator = this.f19071q;
        if (valueAnimator != null) {
            valueAnimator.cancel();
        }
        d();
    ...
    protected void onDraw(Canvas canvas) {
        ...
        float min = (this.f19067e * Math.min(getWidth(), getHeight())) - (this.f19066d.getStrokeWidth() / 2);
        float width = getWidth() / 2;
        float height = getHeight() / 2;
        canvas.drawArc(width - min, height - min, width + min, height + min, this.f19068i + this.f19073s, (this.f19069o * 360) / 100.0f, false, this.f19066d);
    }

    public final void setStrokeColor(int i10) {
        this.f19066d.setColor(i10);
    }

    public final void setStrokeWidth(float f10) {
        this.f19066d.setStrokeWidth(f10);
    }
    ...
    public Pi2ProgressArcView(Context context, AttributeSet attributeSet, int i10) {
        ...
        this.f19066d = paint;
        TypedArray obtainStyledAttributes = context.obtainStyledAttributes(attributeSet, z0.f28108d, i10, 0);
        Intrinsics.checkNotNullExpressionValue(obtainStyledAttributes, "obtainStyledAttributes(...)");
        try {
            this.f19067e = obtainStyledAttributes.getFloat(z0.f28109e, 0.4f);
            this.f19068i = obtainStyledAttributes.getFloat(z0.f28111g, 270.0f);
            this.f19069o = obtainStyledAttributes.getFloat(z0.f28110f, 0.0f);
            paint.setColor(obtainStyledAttributes.getColor(z0.f28112h, -1));
            paint.setStrokeWidth(obtainStyledAttributes.getDimensionPixelSize(z0.f28113i, 4));
