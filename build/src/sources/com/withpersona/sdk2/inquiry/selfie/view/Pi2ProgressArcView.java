...
public final class Pi2ProgressArcView extends View {
    ...
    public static final a f19591t = new a(null);

    /* renamed from: d  reason: collision with root package name */
    private final Paint f19592d;

    /* renamed from: e  reason: collision with root package name */
    private final float f19593e;

    /* renamed from: i  reason: collision with root package name */
    private final float f19594i;

    /* renamed from: o  reason: collision with root package name */
    private float f19595o;

    /* renamed from: p  reason: collision with root package name */
    private ValueAnimator f19596p;

    /* renamed from: q  reason: collision with root package name */
    private ValueAnimator f19597q;

    /* renamed from: r  reason: collision with root package name */
    private ValueAnimator f19598r;

    /* renamed from: s  reason: collision with root package name */
    private float f19599s;
    ...
    public static final class b implements ValueAnimator.AnimatorUpdateListener {
        ...
        final /* synthetic */ ValueAnimator f19601b;

        /* renamed from: c  reason: collision with root package name */
        final /* synthetic */ Pi2ProgressArcView f19602c;

        b(ValueAnimator valueAnimator, Pi2ProgressArcView pi2ProgressArcView) {
            this.f19601b = valueAnimator;
            this.f19602c = pi2ProgressArcView;
        }

        @Override // android.animation.ValueAnimator.AnimatorUpdateListener
        public void onAnimationUpdate(ValueAnimator animator) {
            Intrinsics.checkNotNullParameter(animator, "animator");
            Object animatedValue = this.f19601b.getAnimatedValue();
            Intrinsics.checkNotNull(animatedValue, "null cannot be cast to non-null type kotlin.Float");
            float floatValue = ((Float) animatedValue).floatValue();
            float abs = Math.abs(floatValue - this.f19600a);
            float f10 = this.f19602c.f19599s;
            Pi2ProgressArcView pi2ProgressArcView = this.f19602c;
            pi2ProgressArcView.f19599s = (pi2ProgressArcView.f19599s + abs) % 360;
            if (f10 > this.f19602c.f19599s) {
                this.f19602c.f19599s = 0.0f;
                animator.cancel();
            }
            this.f19600a = floatValue;
            this.f19602c.invalidate();
        }
    }
    ...
    static final class c implements Runnable {
        ...
        /* renamed from: d  reason: collision with root package name */
        private final /* synthetic */ Function0 f19603d;

        c(Function0 function) {
            Intrinsics.checkNotNullParameter(function, "function");
            this.f19603d = function;
        }
    ...
    public static final class d implements ValueAnimator.AnimatorUpdateListener {
        ...
        /* renamed from: b  reason: collision with root package name */
        final /* synthetic */ ValueAnimator f19605b;

        /* renamed from: c  reason: collision with root package name */
        final /* synthetic */ Pi2ProgressArcView f19606c;

        d(ValueAnimator valueAnimator, Pi2ProgressArcView pi2ProgressArcView) {
            this.f19605b = valueAnimator;
            this.f19606c = pi2ProgressArcView;
        }

        @Override // android.animation.ValueAnimator.AnimatorUpdateListener
        public void onAnimationUpdate(ValueAnimator animator) {
            Intrinsics.checkNotNullParameter(animator, "animator");
            Object animatedValue = this.f19605b.getAnimatedValue();
            Intrinsics.checkNotNull(animatedValue, "null cannot be cast to non-null type kotlin.Float");
            float floatValue = ((Float) animatedValue).floatValue();
            float abs = Math.abs(floatValue - this.f19604a);
            Pi2ProgressArcView pi2ProgressArcView = this.f19606c;
            pi2ProgressArcView.f19599s = (pi2ProgressArcView.f19599s + abs) % 360;
            this.f19604a = floatValue;
            this.f19606c.invalidate();
        }
    }
    ...
    public static final class e implements Animator.AnimatorListener {
        ...
        /* renamed from: a  reason: collision with root package name */
        final /* synthetic */ Function0 f19607a;

        /* renamed from: b  reason: collision with root package name */
        final /* synthetic */ Pi2ProgressArcView f19608b;

        public e(Function0 function0, Pi2ProgressArcView pi2ProgressArcView) {
            this.f19607a = function0;
            this.f19608b = pi2ProgressArcView;
        }
        ...
        public void onAnimationEnd(Animator animator) {
            Function0 function0 = this.f19607a;
            if (function0 != null) {
                this.f19608b.postDelayed(new c(function0), 100L);
            }
        }
    ...
    private final void h(float f10, Function0 function0) {
        ...
        ValueAnimator valueAnimator = this.f19596p;
        if (valueAnimator != null) {
            valueAnimator.cancel();
        }
        float f11 = this.f19595o;
        final ValueAnimator ofFloat = ValueAnimator.ofFloat(f11, f10);
        ofFloat.setDuration(((float) 1000) * (Math.abs(f10 - f11) / 100.0f));
        ofFloat.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() { // from class: rp.o
            @Override // android.animation.ValueAnimator.AnimatorUpdateListener
    ...
    public static final void i(Pi2ProgressArcView pi2ProgressArcView, ValueAnimator valueAnimator, ValueAnimator it) {
        ...
        Intrinsics.checkNotNull(animatedValue, "null cannot be cast to non-null type kotlin.Float");
        pi2ProgressArcView.f19595o = ((Float) animatedValue).floatValue();
        pi2ProgressArcView.invalidate();
    }

    public final void e() {
        ValueAnimator valueAnimator = this.f19598r;
        if (valueAnimator != null) {
            valueAnimator.cancel();
        }
        ValueAnimator valueAnimator2 = this.f19597q;
        ...
        ofFloat.setRepeatMode(2);
        ofFloat.start();
        this.f19597q = ofFloat;
    }

    public final void f(float f10, Function0 function0) {
        ValueAnimator valueAnimator = this.f19597q;
        if (valueAnimator != null) {
            valueAnimator.cancel();
        }
        d();
    ...
    protected void onDraw(Canvas canvas) {
        ...
        float min = (this.f19593e * Math.min(getWidth(), getHeight())) - (this.f19592d.getStrokeWidth() / 2);
        float width = getWidth() / 2;
        float height = getHeight() / 2;
        canvas.drawArc(width - min, height - min, width + min, height + min, this.f19594i + this.f19599s, (this.f19595o * 360) / 100.0f, false, this.f19592d);
    }

    public final void setStrokeColor(int i10) {
        this.f19592d.setColor(i10);
    }

    public final void setStrokeWidth(float f10) {
        this.f19592d.setStrokeWidth(f10);
    }
    ...
    public Pi2ProgressArcView(Context context, AttributeSet attributeSet, int i10) {
        ...
        this.f19592d = paint;
        TypedArray obtainStyledAttributes = context.obtainStyledAttributes(attributeSet, z0.f39990d, i10, 0);
        Intrinsics.checkNotNullExpressionValue(obtainStyledAttributes, "obtainStyledAttributes(...)");
        try {
            this.f19593e = obtainStyledAttributes.getFloat(z0.f39991e, 0.4f);
            this.f19594i = obtainStyledAttributes.getFloat(z0.f39993g, 270.0f);
            this.f19595o = obtainStyledAttributes.getFloat(z0.f39992f, 0.0f);
            paint.setColor(obtainStyledAttributes.getColor(z0.f39994h, -1));
            paint.setStrokeWidth(obtainStyledAttributes.getDimensionPixelSize(z0.f39995i, 4));
