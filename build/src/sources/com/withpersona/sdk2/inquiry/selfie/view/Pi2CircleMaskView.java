...
public final class Pi2CircleMaskView extends View {
    ...
    private Bitmap f19588i;

    /* renamed from: o  reason: collision with root package name */
    private Paint f19589o;

    /* renamed from: p  reason: collision with root package name */
    private Paint f19590p;
    ...
    private final long b(float f10) {
        return gs.a.e((Math.abs(getScaleX() - f10) / 4.0f) * ((float) 500));
    }

    private final Bitmap c() {
        Bitmap bitmap = this.f19588i;
        if (bitmap != null) {
        ...
        canvas.drawColor(this.f19587e);
        canvas.drawCircle(canvas.getWidth() / 2.0f, canvas.getHeight() / 2.0f, this.f19586d * Math.min(canvas.getWidth(), canvas.getHeight()), this.f19590p);
        this.f19588i = createBitmap;
        return createBitmap;
    }
    ...
    public final void d(boolean z10, final Function0 function0) {
        if (z10) {
            ...
            animate.scaleX(1.0f);
            animate.scaleY(1.0f);
            animate.withEndAction(new Runnable() { // from class: rp.n
    ...
    protected void onDraw(Canvas canvas) {
        ...
        canvas.drawBitmap(c(), 0.0f, 0.0f, this.f19589o);
    }
    ...
    public Pi2CircleMaskView(Context context, AttributeSet attributeSet, int i10) {
        ...
        Intrinsics.checkNotNullParameter(context, "context");
        this.f19589o = new Paint(7);
        Paint paint = new Paint(1);
        paint.setColor(0);
        paint.setXfermode(new PorterDuffXfermode(PorterDuff.Mode.CLEAR));
        this.f19590p = paint;
        TypedArray obtainStyledAttributes = context.obtainStyledAttributes(attributeSet, z0.f39987a, i10, 0);
        Intrinsics.checkNotNullExpressionValue(obtainStyledAttributes, "obtainStyledAttributes(...)");
        try {
            this.f19586d = obtainStyledAttributes.getFloat(z0.f39988b, 0.4f);
            this.f19587e = obtainStyledAttributes.getColor(z0.f39989c, -16777216);
