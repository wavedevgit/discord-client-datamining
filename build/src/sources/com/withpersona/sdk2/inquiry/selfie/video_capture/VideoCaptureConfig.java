...
public final class VideoCaptureConfig {
    ...
    public VideoCaptureConfig(long j10, @NotNull List<? extends NextStep.Selfie.CaptureFileType> enabledCaptureFileTypes, @NotNull List<? extends a> videoCaptureMethods, @g(name = "webRTCJwt") String str, boolean z10) {
        ...
        this.f20411a = j10;
        this.f20412b = enabledCaptureFileTypes;
        this.f20413c = videoCaptureMethods;
        this.f20414d = str;
        this.f20415e = z10;
    }
    ...
    private final Object e(Boolean bool, Boolean bool2, Context context) {
        ...
        boolean z12 = false;
        boolean z13 = true;
        if (this.f20412b.contains(NextStep.Selfie.CaptureFileType.Video) && CollectionsKt.firstOrNull(this.f20413c) == a.f49090d) {
            z10 = true;
        } else {
            z10 = false;
        }
        ...
        if (z10 && !z11) {
            ...
            List<NextStep.Selfie.CaptureFileType> list2 = this.f20412b;
        ...
        a aVar9 = (a) CollectionsKt.firstOrNull(this.f20413c);
        if (aVar9 == null) {
            aVar9 = a.f49092i;
        }
    ...
    public final Object d(Boolean bool, Boolean bool2, Context applicationContext) {
        ...
        if (!this.f20412b.contains(NextStep.Selfie.CaptureFileType.Video)) {
        ...
        if (e10 == null) {
            a aVar2 = (a) f10;
            if (aVar2 != a.f49090d && aVar2 != a.f49091e) {
                z10 = false;
            } else {
                z10 = true;
            }
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof VideoCaptureConfig) {
            ...
            return this.f20411a == videoCaptureConfig.f20411a && Intrinsics.areEqual(this.f20412b, videoCaptureConfig.f20412b) && Intrinsics.areEqual(this.f20413c, videoCaptureConfig.f20413c) && Intrinsics.areEqual(this.f20414d, videoCaptureConfig.f20414d) && this.f20415e == videoCaptureConfig.f20415e;
        }
        return false;
    }
    ...
    public int hashCode() {
        int hashCode = ((((Long.hashCode(this.f20411a) * 31) + this.f20412b.hashCode()) * 31) + this.f20413c.hashCode()) * 31;
        String str = this.f20414d;
        return ((hashCode + (str == null ? 0 : str.hashCode())) * 31) + Boolean.hashCode(this.f20415e);
    }

    public String toString() {
        long j10 = this.f20411a;
        List list = this.f20412b;
        List list2 = this.f20413c;
        String str = this.f20414d;
