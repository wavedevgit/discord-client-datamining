...
public final class VideoCaptureConfig {
    ...
    public VideoCaptureConfig(long j10, @NotNull List<? extends NextStep.Selfie.CaptureFileType> enabledCaptureFileTypes, @NotNull List<? extends a> videoCaptureMethods, @g(name = "webRTCJwt") String str, boolean z10) {
        ...
        this.f19552a = j10;
        this.f19553b = enabledCaptureFileTypes;
        this.f19554c = videoCaptureMethods;
        this.f19555d = str;
        this.f19556e = z10;
    }
    ...
    private final Object e(Boolean bool, Boolean bool2, Context context) {
        ...
        boolean z12 = false;
        boolean z13 = true;
        if (this.f19553b.contains(NextStep.Selfie.CaptureFileType.Video) && CollectionsKt.firstOrNull(this.f19554c) == a.f7161d) {
            z10 = true;
        } else {
            z10 = false;
        }
        ...
        if (z10 && !z11) {
            ...
            List<NextStep.Selfie.CaptureFileType> list2 = this.f19553b;
        ...
        a aVar9 = (a) CollectionsKt.firstOrNull(this.f19554c);
        if (aVar9 == null) {
            aVar9 = a.f7163i;
        }
    ...
    public final Object d(Boolean bool, Boolean bool2, Context applicationContext) {
        ...
        if (!this.f19553b.contains(NextStep.Selfie.CaptureFileType.Video)) {
        ...
        if (e10 == null) {
            a aVar2 = (a) f10;
            if (aVar2 != a.f7161d && aVar2 != a.f7162e) {
                z10 = false;
            } else {
                z10 = true;
            }
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof VideoCaptureConfig) {
            ...
            return this.f19552a == videoCaptureConfig.f19552a && Intrinsics.areEqual(this.f19553b, videoCaptureConfig.f19553b) && Intrinsics.areEqual(this.f19554c, videoCaptureConfig.f19554c) && Intrinsics.areEqual(this.f19555d, videoCaptureConfig.f19555d) && this.f19556e == videoCaptureConfig.f19556e;
        }
        return false;
    }
    ...
    public int hashCode() {
        int hashCode = ((((Long.hashCode(this.f19552a) * 31) + this.f19553b.hashCode()) * 31) + this.f19554c.hashCode()) * 31;
        String str = this.f19555d;
        return ((hashCode + (str == null ? 0 : str.hashCode())) * 31) + Boolean.hashCode(this.f19556e);
    }

    public String toString() {
        long j10 = this.f19552a;
        List list = this.f19553b;
        List list2 = this.f19554c;
        String str = this.f19555d;
        boolean z10 = this.f19556e;
