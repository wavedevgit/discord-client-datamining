...
public final class VideoCaptureConfig {
    ...
    private final List f20045b;

    /* renamed from: c  reason: collision with root package name */
    private final List f20046c;
    ...
    public VideoCaptureConfig(long j10, @NotNull List<? extends NextStep.Selfie.CaptureFileType> enabledCaptureFileTypes, @NotNull List<? extends a> videoCaptureMethods, @g(name = "webRTCJwt") String str, boolean z10) {
        ...
        this.f20044a = j10;
        this.f20045b = enabledCaptureFileTypes;
        this.f20046c = videoCaptureMethods;
        this.f20047d = str;
        this.f20048e = z10;
    }
    ...
    private final Object e(Boolean bool, Boolean bool2, Context context) {
        ...
        boolean z12 = false;
        boolean z13 = true;
        if (this.f20045b.contains(NextStep.Selfie.CaptureFileType.Video) && CollectionsKt.firstOrNull(this.f20046c) == a.f49944d) {
            z10 = true;
        } else {
            z10 = false;
        }
        ...
        if (z10 && !z11) {
            ...
            List<NextStep.Selfie.CaptureFileType> list2 = this.f20045b;
        ...
        a aVar9 = (a) CollectionsKt.firstOrNull(this.f20046c);
        if (aVar9 == null) {
            aVar9 = a.f49946i;
        }
    ...
    public final Object d(Boolean bool, Boolean bool2, Context applicationContext) {
        ...
        if (!this.f20045b.contains(NextStep.Selfie.CaptureFileType.Video)) {
        ...
        if (e10 == null) {
            a aVar2 = (a) f10;
            if (aVar2 != a.f49944d && aVar2 != a.f49945e) {
                z10 = false;
            } else {
                z10 = true;
            }
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof VideoCaptureConfig) {
            ...
            return this.f20044a == videoCaptureConfig.f20044a && Intrinsics.areEqual(this.f20045b, videoCaptureConfig.f20045b) && Intrinsics.areEqual(this.f20046c, videoCaptureConfig.f20046c) && Intrinsics.areEqual(this.f20047d, videoCaptureConfig.f20047d) && this.f20048e == videoCaptureConfig.f20048e;
        }
        return false;
    }
    ...
    public int hashCode() {
        int hashCode = ((((Long.hashCode(this.f20044a) * 31) + this.f20045b.hashCode()) * 31) + this.f20046c.hashCode()) * 31;
        String str = this.f20047d;
        return ((hashCode + (str == null ? 0 : str.hashCode())) * 31) + Boolean.hashCode(this.f20048e);
    }

    public String toString() {
        long j10 = this.f20044a;
        List list = this.f20045b;
        List list2 = this.f20046c;
        String str = this.f20047d;
