...
public final class OldSelfieOverlayView extends ConstraintLayout {
    ...
    /* renamed from: d */
    private final ip.b f19031d;

    /* renamed from: e */
    private final Lazy f19032e;

    /* renamed from: i */
    private final Lazy f19033i;

    /* renamed from: o */
    private final int f19034o;

    /* renamed from: p */
    private final int f19035p;

    /* renamed from: q */
    private RemoteImage f19036q;

    /* renamed from: r */
    private RemoteImage f19037r;

    /* renamed from: s */
    private View f19038s;

    /* renamed from: t */
    private final List f19039t;

    /* renamed from: u */
    private final List f19040u;

    /* renamed from: v */
    private View f19041v;
    ...
    public static final class a extends AnimatorListenerAdapter {
        ...
        public void onAnimationEnd(Animator animation) {
            ...
            List<Function0> h12 = CollectionsKt.h1(OldSelfieOverlayView.this.f19040u);
            OldSelfieOverlayView.this.f19040u.clear();
    ...
    public static final class b {
        ...
        /* renamed from: d */
        public static final b f19044d = new b("CLEAR", 0);

        /* renamed from: e */
        public static final b f19045e = new b("CENTER", 1);

        /* renamed from: i */
        public static final b f19046i = new b("CENTER_COMPLETE", 2);

        /* renamed from: o */
        public static final b f19047o = new b("LOOK_LEFT_HINT", 3);

        /* renamed from: p */
        public static final b f19048p = new b("LOOK_LEFT", 4);

        /* renamed from: q */
        public static final b f19049q = new b("LOOK_LEFT_COMPLETE", 5);

        /* renamed from: r */
        public static final b f19050r = new b("LOOK_RIGHT_HINT", 6);

        /* renamed from: s */
        public static final b f19051s = new b("LOOK_RIGHT", 7);

        /* renamed from: t */
        public static final b f19052t = new b("LOOK_RIGHT_COMPLETE", 8);

        /* renamed from: u */
        public static final b f19053u = new b("FINALIZING", 9);

        /* renamed from: v */
        public static final b f19054v = new b("COMPLETE_WITH_CAPTURE", 10);

        /* renamed from: w */
        public static final b f19055w = new b("COMPLETE", 11);

        /* renamed from: x */
        private static final /* synthetic */ b[] f19056x;

        /* renamed from: y */
        private static final /* synthetic */ EnumEntries f19057y;
        ...
        private static final /* synthetic */ b[] a() {
            return new b[]{f19044d, f19045e, f19046i, f19047o, f19048p, f19049q, f19050r, f19051s, f19052t, f19053u, f19054v, f19055w};
        }
    ...
    public /* synthetic */ class c {
        ...
        static {
            ...
            try {
                iArr[b.f19044d.ordinal()] = 1;
            } catch (NoSuchFieldError unused) {
            }
            try {
                iArr[b.f19045e.ordinal()] = 2;
            } catch (NoSuchFieldError unused2) {
            }
            try {
                iArr[b.f19046i.ordinal()] = 3;
            } catch (NoSuchFieldError unused3) {
            }
            try {
                iArr[b.f19047o.ordinal()] = 4;
            } catch (NoSuchFieldError unused4) {
            }
            try {
                iArr[b.f19048p.ordinal()] = 5;
            } catch (NoSuchFieldError unused5) {
            }
            try {
                iArr[b.f19049q.ordinal()] = 6;
            } catch (NoSuchFieldError unused6) {
            }
            try {
                iArr[b.f19050r.ordinal()] = 7;
            } catch (NoSuchFieldError unused7) {
            }
            try {
                iArr[b.f19051s.ordinal()] = 8;
            } catch (NoSuchFieldError unused8) {
            }
            try {
                iArr[b.f19052t.ordinal()] = 9;
            } catch (NoSuchFieldError unused9) {
            }
            try {
                iArr[b.f19053u.ordinal()] = 10;
            } catch (NoSuchFieldError unused10) {
            }
            try {
                iArr[b.f19054v.ordinal()] = 11;
            } catch (NoSuchFieldError unused11) {
            }
            try {
                iArr[b.f19055w.ordinal()] = 12;
    ...
    public static final Drawable C(Context context) {
        Integer f10 = s.f(context, ep.a.f22469q, null, false, 6, null);
        if (f10 != null) {
            return androidx.core.content.a.e(context, f10.intValue());
        }
        return androidx.core.content.a.e(context, v0.f27558a);
    }

    public static final Drawable D(Context context) {
        Integer f10 = s.f(context, ep.a.f22471s, null, false, 6, null);
        if (f10 != null) {
            return androidx.core.content.a.e(context, f10.intValue());
        }
        return androidx.core.content.a.e(context, v0.f27559b);
    }

    private final void F(final ip.b bVar, final Function0 function0) {
        View blindsView = bVar.f30977b;
        Intrinsics.checkNotNullExpressionValue(blindsView, "blindsView");
        y(blindsView, 80L).withEndAction(new Runnable() { // from class: lp.k
    ...
    public static final void G(OldSelfieOverlayView oldSelfieOverlayView, ip.b bVar, final Function0 function0) {
        View blindsView = bVar.f30977b;
        Intrinsics.checkNotNullExpressionValue(blindsView, "blindsView");
        oldSelfieOverlayView.v(blindsView, 80L).withEndAction(new Runnable() { // from class: lp.b
            @Override // java.lang.Runnable
            public final void run() {
    ...
    public static final Unit K(OldSelfieOverlayView oldSelfieOverlayView, Function0 function0) {
        oldSelfieOverlayView.M(oldSelfieOverlayView.f19031d, y0.f28093a, function0);
        return Unit.f32464a;
    }
    ...
    private final void M(final ip.b bVar, int i10, final Function0 function0) {
        this.f19039t.add(new Function0() { // from class: lp.i
            @Override // kotlin.jvm.functions.Function0
            public final Object invoke() {
                Unit N;
                N = OldSelfieOverlayView.N(ip.b.this, this, function0);
                return N;
            }
        });
        bVar.f30979d.setAnimation(i10);
    }

    public static final Unit N(final ip.b bVar, OldSelfieOverlayView oldSelfieOverlayView, final Function0 function0) {
        bVar.f30979d.setFrame(0);
        ThemeableLottieAnimationView hintAnimation = bVar.f30979d;
        Intrinsics.checkNotNullExpressionValue(hintAnimation, "hintAnimation");
        z(oldSelfieOverlayView, hintAnimation, 0L, 1, null).withEndAction(new Runnable() { // from class: lp.l
            @Override // java.lang.Runnable
            public final void run() {
                OldSelfieOverlayView.O(OldSelfieOverlayView.this, bVar, function0);
            }
        });
        View hintOverlayView = bVar.f30981f;
        Intrinsics.checkNotNullExpressionValue(hintOverlayView, "hintOverlayView");
        z(oldSelfieOverlayView, hintOverlayView, 0L, 1, null);
        return Unit.f32464a;
    }

    public static final void O(OldSelfieOverlayView oldSelfieOverlayView, final ip.b bVar, final Function0 function0) {
        oldSelfieOverlayView.f19040u.add(new Function0() { // from class: lp.c
            @Override // kotlin.jvm.functions.Function0
            public final Object invoke() {
                Unit P;
        ...
        bVar.f30979d.playAnimation();
    }

    public static final Unit P(OldSelfieOverlayView oldSelfieOverlayView, ip.b bVar, final Function0 function0) {
        ThemeableLottieAnimationView hintAnimation = bVar.f30979d;
        Intrinsics.checkNotNullExpressionValue(hintAnimation, "hintAnimation");
        w(oldSelfieOverlayView, hintAnimation, 0L, 1, null).withEndAction(new Runnable() { // from class: lp.d
            @Override // java.lang.Runnable
            public final void run() {
    ...
    private final void R(final ImageView imageView, Drawable drawable) {
        ...
        if (drawable == null) {
            w(this, imageView, 0L, 1, null).withEndAction(new Runnable() { // from class: lp.j
                @Override // java.lang.Runnable
                public final void run() {
    ...
    private final boolean T(Context context) {
        Integer f10 = s.f(context, ep.a.f22469q, null, false, 6, null);
        Integer f11 = s.f(context, ep.a.f22471s, null, false, 6, null);
        if ((f10 == null || f11 == null) && this.f19036q == null && this.f19037r == null) {
            return true;
        }
        return false;
    }
    ...
    private final Drawable getDrawableLeft() {
        return (Drawable) this.f19032e.getValue();
    }

    private final Drawable getDrawableRight() {
        return (Drawable) this.f19033i.getValue();
    }

    public static void k(OldSelfieOverlayView oldSelfieOverlayView, i iVar) {
        List<Function0> h12 = CollectionsKt.h1(oldSelfieOverlayView.f19039t);
        oldSelfieOverlayView.f19039t.clear();
        for (Function0 function0 : h12) {
            function0.invoke();
        }
    }
    ...
    private final ViewPropertyAnimator v(final View view, long j10) {
        ViewPropertyAnimator withEndAction = view.animate().alpha(0.0f).setDuration(j10).withEndAction(new Runnable() { // from class: lp.m
            @Override // java.lang.Runnable
            public final void run() {
    ...
    public final void A(StepStyles.SelfieStepStyle styles) {
        ...
        if (selfieCaptureFeedBoxBorderColorValue != null) {
            this.f19031d.f30983h.setStrokeColor(selfieCaptureFeedBoxBorderColorValue.intValue());
        }
        ...
        if (selfieCaptureFeedBoxBorderWidthValue != null) {
            this.f19031d.f30983h.setStrokeWidth((float) h.a(selfieCaptureFeedBoxBorderWidthValue.doubleValue()));
        }
        ...
        if (selfieCaptureIconStrokeColor != null) {
            ...
            this.f19031d.f30979d.I(Color.parseColor("#022050"), intValue);
            this.f19031d.f30979d.I(Color.parseColor("#280087"), intValue);
        }
        ...
        if (selfieCaptureIconFillColor != null) {
            ...
            this.f19031d.f30979d.I(Color.parseColor("#AA85FF"), intValue2);
            this.f19031d.f30979d.I(Color.parseColor("#8552FF"), intValue2);
        }
        ...
        if (selfieCaptureIconBackgroundFillColor != null) {
            this.f19031d.f30979d.I(Color.parseColor("#DBCCFF"), selfieCaptureIconBackgroundFillColor.intValue());
        }
    }

    public final void B(Function0 onComplete) {
        Intrinsics.checkNotNullParameter(onComplete, "onComplete");
        Pi2CircleMaskView.e(this.f19031d.f30978c, false, onComplete, 1, null);
    }

    public final boolean E() {
        return this.f19031d.f30978c.g();
    }

    public final void I(b viewState, boolean z10, final Function0 function0) {
        Intrinsics.checkNotNullParameter(viewState, "viewState");
        if (this.f19042w != viewState) {
            this.f19042w = viewState;
            removeView(this.f19041v);
            Context context = getContext();
            Intrinsics.checkNotNullExpressionValue(context, "getContext(...)");
            boolean T = T(context);
            ip.b bVar = this.f19031d;
            if (z10) {
                bVar.f30983h.setVisibility(0);
            } else {
                bVar.f30983h.setVisibility(8);
            }
            switch (c.f19058a[viewState.ordinal()]) {
                case 1:
                    bVar.f30978c.h();
                    bVar.f30983h.f(0.0f, function0);
                    return;
                case 2:
                    Pi2CircleMaskView.e(bVar.f30978c, false, null, 3, null);
                    bVar.f30983h.f(0.0f, function0);
                    return;
                case 3:
                    Pi2CircleMaskView.e(bVar.f30978c, false, null, 3, null);
                    Pi2ProgressArcView.g(bVar.f30983h, 0.0f, null, 2, null);
                    F(this.f19031d, function0);
                    return;
                case 4:
                    Pi2CircleMaskView.e(bVar.f30978c, false, null, 3, null);
                    Pi2ProgressArcView.g(bVar.f30983h, 0.0f, null, 2, null);
                    if (T) {
                        M(this.f19031d, this.f19034o, function0);
                        return;
                ...
                case 5:
                    ...
                    bVar.f30983h.f(0.0f, function0);
                    if (!T) {
                        RemoteImage remoteImage = this.f19036q;
                        if (remoteImage != null) {
                            this.f19041v = hq.b.b(remoteImage, this, true);
                            return;
                        }
                        bVar.f30982g.setVisibility(0);
                        ImageView hintImage = bVar.f30980e;
                ...
                case 6:
                    Pi2CircleMaskView.e(bVar.f30978c, false, null, 3, null);
                    Pi2ProgressArcView.g(bVar.f30983h, 50.0f, null, 2, null);
                    F(this.f19031d, function0);
                    return;
                case 7:
                    Pi2CircleMaskView.e(bVar.f30978c, false, null, 3, null);
                    Pi2ProgressArcView.g(bVar.f30983h, 50.0f, null, 2, null);
                    if (T) {
                        M(this.f19031d, this.f19035p, function0);
                        return;
                    } else if (function0 != null) {
                        function0.invoke();
                        return;
                ...
                case 8:
                    Pi2CircleMaskView.e(bVar.f30978c, false, null, 3, null);
                    bVar.f30983h.f(50.0f, function0);
                    if (!T) {
                        RemoteImage remoteImage2 = this.f19037r;
                        if (remoteImage2 != null) {
                            this.f19041v = hq.b.b(remoteImage2, this, true);
                            return;
                        }
                        bVar.f30982g.setVisibility(0);
                        ImageView hintImage2 = bVar.f30980e;
                ...
                case 9:
                    Pi2CircleMaskView.e(bVar.f30978c, false, null, 3, null);
                    Pi2ProgressArcView.g(bVar.f30983h, 100.0f, null, 2, null);
                    F(this.f19031d, function0);
                    return;
                case 10:
                    Pi2CircleMaskView.e(bVar.f30978c, false, null, 3, null);
                ...
                case 11:
                    Pi2CircleMaskView.e(bVar.f30978c, false, null, 3, null);
                    Pi2ProgressArcView.g(bVar.f30983h, 100.0f, null, 2, null);
                    F(this.f19031d, new Function0() { // from class: lp.g
                        @Override // kotlin.jvm.functions.Function0
                        public final Object invoke() {
                            Unit K;
                ...
                case 12:
                    Pi2CircleMaskView.e(bVar.f30978c, false, null, 3, null);
                    bVar.f30983h.f(100.0f, new Function0() { // from class: lp.h
                        @Override // kotlin.jvm.functions.Function0
                        public final Object invoke() {
                            Unit L;
    ...
    public OldSelfieOverlayView(final Context context, AttributeSet attributeSet, int i10) {
        ...
        Intrinsics.checkNotNullParameter(context, "context");
        ip.b b10 = ip.b.b(LayoutInflater.from(context), this);
        Intrinsics.checkNotNullExpressionValue(b10, "inflate(...)");
        this.f19031d = b10;
        this.f19032e = l.a(new Function0() { // from class: lp.a
            @Override // kotlin.jvm.functions.Function0
            public final Object invoke() {
                Drawable C;
        ...
        this.f19033i = l.a(new Function0() { // from class: lp.e
            @Override // kotlin.jvm.functions.Function0
            public final Object invoke() {
                Drawable D;
        ...
        Integer f10 = s.f(context, ep.a.f22470r, null, false, 6, null);
        this.f19034o = f10 != null ? f10.intValue() : y0.f28094b;
        Integer f11 = s.f(context, ep.a.f22470r, null, false, 6, null);
        this.f19035p = f11 != null ? f11.intValue() : y0.f28095c;
        this.f19039t = new ArrayList();
        this.f19040u = new ArrayList();
        ThemeableLottieAnimationView themeableLottieAnimationView = b10.f30979d;
        themeableLottieAnimationView.j(new z() { // from class: lp.f
            @Override // l5.z
