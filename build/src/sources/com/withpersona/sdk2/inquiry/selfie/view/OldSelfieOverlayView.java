...
public final class OldSelfieOverlayView extends ConstraintLayout {
    ...
    /* renamed from: d */
    private final fp.b f20416d;

    /* renamed from: e */
    private final Lazy f20417e;

    /* renamed from: i */
    private final Lazy f20418i;

    /* renamed from: o */
    private final int f20419o;

    /* renamed from: p */
    private final int f20420p;

    /* renamed from: q */
    private RemoteImage f20421q;

    /* renamed from: r */
    private RemoteImage f20422r;

    /* renamed from: s */
    private View f20423s;

    /* renamed from: t */
    private final List f20424t;

    /* renamed from: u */
    private final List f20425u;

    /* renamed from: v */
    private View f20426v;
    ...
    public static final class a extends AnimatorListenerAdapter {
        ...
        public void onAnimationEnd(Animator animation) {
            ...
            List<Function0> h12 = CollectionsKt.h1(OldSelfieOverlayView.this.f20425u);
            OldSelfieOverlayView.this.f20425u.clear();
    ...
    public static final class b {
        ...
        /* renamed from: d */
        public static final b f20429d = new b("CLEAR", 0);

        /* renamed from: e */
        public static final b f20430e = new b("CENTER", 1);

        /* renamed from: i */
        public static final b f20431i = new b("CENTER_COMPLETE", 2);

        /* renamed from: o */
        public static final b f20432o = new b("LOOK_LEFT_HINT", 3);

        /* renamed from: p */
        public static final b f20433p = new b("LOOK_LEFT", 4);

        /* renamed from: q */
        public static final b f20434q = new b("LOOK_LEFT_COMPLETE", 5);

        /* renamed from: r */
        public static final b f20435r = new b("LOOK_RIGHT_HINT", 6);

        /* renamed from: s */
        public static final b f20436s = new b("LOOK_RIGHT", 7);

        /* renamed from: t */
        public static final b f20437t = new b("LOOK_RIGHT_COMPLETE", 8);

        /* renamed from: u */
        public static final b f20438u = new b("FINALIZING", 9);

        /* renamed from: v */
        public static final b f20439v = new b("COMPLETE_WITH_CAPTURE", 10);

        /* renamed from: w */
        public static final b f20440w = new b("COMPLETE", 11);

        /* renamed from: x */
        private static final /* synthetic */ b[] f20441x;

        /* renamed from: y */
        private static final /* synthetic */ EnumEntries f20442y;
        ...
        private static final /* synthetic */ b[] a() {
            return new b[]{f20429d, f20430e, f20431i, f20432o, f20433p, f20434q, f20435r, f20436s, f20437t, f20438u, f20439v, f20440w};
        }
    ...
    public /* synthetic */ class c {
        ...
        static {
            ...
            try {
                iArr[b.f20429d.ordinal()] = 1;
            } catch (NoSuchFieldError unused) {
            }
            try {
                iArr[b.f20430e.ordinal()] = 2;
            } catch (NoSuchFieldError unused2) {
            }
            try {
                iArr[b.f20431i.ordinal()] = 3;
            } catch (NoSuchFieldError unused3) {
            }
            try {
                iArr[b.f20432o.ordinal()] = 4;
            } catch (NoSuchFieldError unused4) {
            }
            try {
                iArr[b.f20433p.ordinal()] = 5;
            } catch (NoSuchFieldError unused5) {
            }
            try {
                iArr[b.f20434q.ordinal()] = 6;
            } catch (NoSuchFieldError unused6) {
            }
            try {
                iArr[b.f20435r.ordinal()] = 7;
            } catch (NoSuchFieldError unused7) {
            }
            try {
                iArr[b.f20436s.ordinal()] = 8;
            } catch (NoSuchFieldError unused8) {
            }
            try {
                iArr[b.f20437t.ordinal()] = 9;
            } catch (NoSuchFieldError unused9) {
            }
            try {
                iArr[b.f20438u.ordinal()] = 10;
            } catch (NoSuchFieldError unused10) {
            }
            try {
                iArr[b.f20439v.ordinal()] = 11;
            } catch (NoSuchFieldError unused11) {
            }
            try {
                iArr[b.f20440w.ordinal()] = 12;
    ...
    public static final Drawable C(Context context) {
        Integer f10 = s.f(context, bp.a.f7625q, null, false, 6, null);
        if (f10 != null) {
            return androidx.core.content.a.e(context, f10.intValue());
        }
        return androidx.core.content.a.e(context, v0.f23432a);
    }

    public static final Drawable D(Context context) {
        Integer f10 = s.f(context, bp.a.f7627s, null, false, 6, null);
        if (f10 != null) {
            return androidx.core.content.a.e(context, f10.intValue());
        }
        return androidx.core.content.a.e(context, v0.f23433b);
    }

    private final void F(final fp.b bVar, final Function0 function0) {
        View blindsView = bVar.f25430b;
        Intrinsics.checkNotNullExpressionValue(blindsView, "blindsView");
        y(blindsView, 80L).withEndAction(new Runnable() { // from class: ip.k
    ...
    public static final void G(OldSelfieOverlayView oldSelfieOverlayView, fp.b bVar, final Function0 function0) {
        View blindsView = bVar.f25430b;
        Intrinsics.checkNotNullExpressionValue(blindsView, "blindsView");
        oldSelfieOverlayView.v(blindsView, 80L).withEndAction(new Runnable() { // from class: ip.b
            @Override // java.lang.Runnable
            public final void run() {
    ...
    private final void M(final fp.b bVar, int i10, final Function0 function0) {
        this.f20424t.add(new Function0() { // from class: ip.i
            @Override // kotlin.jvm.functions.Function0
            public final Object invoke() {
                Unit N;
                N = OldSelfieOverlayView.N(fp.b.this, this, function0);
                return N;
            }
        });
        bVar.f25432d.setAnimation(i10);
    }

    public static final Unit N(final fp.b bVar, OldSelfieOverlayView oldSelfieOverlayView, final Function0 function0) {
        bVar.f25432d.setFrame(0);
        ThemeableLottieAnimationView hintAnimation = bVar.f25432d;
        Intrinsics.checkNotNullExpressionValue(hintAnimation, "hintAnimation");
        z(oldSelfieOverlayView, hintAnimation, 0L, 1, null).withEndAction(new Runnable() { // from class: ip.l
            @Override // java.lang.Runnable
            public final void run() {
    ...
    public static final void O(OldSelfieOverlayView oldSelfieOverlayView, final fp.b bVar, final Function0 function0) {
        oldSelfieOverlayView.f20425u.add(new Function0() { // from class: ip.c
            @Override // kotlin.jvm.functions.Function0
            public final Object invoke() {
                Unit P;
        ...
        bVar.f25432d.playAnimation();
    }

    public static final Unit P(OldSelfieOverlayView oldSelfieOverlayView, fp.b bVar, final Function0 function0) {
        ThemeableLottieAnimationView hintAnimation = bVar.f25432d;
        Intrinsics.checkNotNullExpressionValue(hintAnimation, "hintAnimation");
        w(oldSelfieOverlayView, hintAnimation, 0L, 1, null).withEndAction(new Runnable() { // from class: ip.d
            @Override // java.lang.Runnable
            public final void run() {
    ...
    private final void R(final ImageView imageView, Drawable drawable) {
        ...
        if (drawable == null) {
            w(this, imageView, 0L, 1, null).withEndAction(new Runnable() { // from class: ip.j
                @Override // java.lang.Runnable
                public final void run() {
    ...
    private final boolean T(Context context) {
        Integer f10 = s.f(context, bp.a.f7625q, null, false, 6, null);
        Integer f11 = s.f(context, bp.a.f7627s, null, false, 6, null);
        if ((f10 == null || f11 == null) && this.f20421q == null && this.f20422r == null) {
            return true;
        }
        return false;
    }
    ...
    private final Drawable getDrawableLeft() {
        return (Drawable) this.f20417e.getValue();
    }

    private final Drawable getDrawableRight() {
        return (Drawable) this.f20418i.getValue();
    }

    public static void k(OldSelfieOverlayView oldSelfieOverlayView, i iVar) {
        List<Function0> h12 = CollectionsKt.h1(oldSelfieOverlayView.f20424t);
        oldSelfieOverlayView.f20424t.clear();
        for (Function0 function0 : h12) {
            function0.invoke();
        }
    }
    ...
    private final ViewPropertyAnimator v(final View view, long j10) {
        ViewPropertyAnimator withEndAction = view.animate().alpha(0.0f).setDuration(j10).withEndAction(new Runnable() { // from class: ip.m
            @Override // java.lang.Runnable
            public final void run() {
    ...
    public final void A(StepStyles.SelfieStepStyle styles) {
        ...
        if (selfieCaptureFeedBoxBorderColorValue != null) {
            this.f20416d.f25436h.setStrokeColor(selfieCaptureFeedBoxBorderColorValue.intValue());
        }
        ...
        if (selfieCaptureFeedBoxBorderWidthValue != null) {
            this.f20416d.f25436h.setStrokeWidth((float) h.a(selfieCaptureFeedBoxBorderWidthValue.doubleValue()));
        }
        ...
        if (selfieCaptureIconStrokeColor != null) {
            ...
            this.f20416d.f25432d.I(Color.parseColor("#022050"), intValue);
            this.f20416d.f25432d.I(Color.parseColor("#280087"), intValue);
        }
        ...
        if (selfieCaptureIconFillColor != null) {
            ...
            this.f20416d.f25432d.I(Color.parseColor("#AA85FF"), intValue2);
            this.f20416d.f25432d.I(Color.parseColor("#8552FF"), intValue2);
        }
        ...
        if (selfieCaptureIconBackgroundFillColor != null) {
            this.f20416d.f25432d.I(Color.parseColor("#DBCCFF"), selfieCaptureIconBackgroundFillColor.intValue());
        }
    }

    public final void B(Function0 onComplete) {
        Intrinsics.checkNotNullParameter(onComplete, "onComplete");
        Pi2CircleMaskView.e(this.f20416d.f25431c, false, onComplete, 1, null);
    }

    public final boolean E() {
        return this.f20416d.f25431c.g();
    }

    public final void I(b viewState, boolean z10, final Function0 function0) {
        Intrinsics.checkNotNullParameter(viewState, "viewState");
        if (this.f20427w != viewState) {
            this.f20427w = viewState;
            removeView(this.f20426v);
            Context context = getContext();
            Intrinsics.checkNotNullExpressionValue(context, "getContext(...)");
            boolean T = T(context);
            fp.b bVar = this.f20416d;
            if (z10) {
                bVar.f25436h.setVisibility(0);
            } else {
                bVar.f25436h.setVisibility(8);
            }
            switch (c.f20443a[viewState.ordinal()]) {
                case 1:
                    bVar.f25431c.h();
                    bVar.f25436h.f(0.0f, function0);
                    return;
                case 2:
                    Pi2CircleMaskView.e(bVar.f25431c, false, null, 3, null);
                    bVar.f25436h.f(0.0f, function0);
                    return;
                case 3:
                    Pi2CircleMaskView.e(bVar.f25431c, false, null, 3, null);
                    Pi2ProgressArcView.g(bVar.f25436h, 0.0f, null, 2, null);
                    F(this.f20416d, function0);
                    return;
                case 4:
                    Pi2CircleMaskView.e(bVar.f25431c, false, null, 3, null);
                    Pi2ProgressArcView.g(bVar.f25436h, 0.0f, null, 2, null);
                    if (T) {
                        M(this.f20416d, this.f20419o, function0);
                        return;
                ...
                case 5:
                    ...
                    bVar.f25436h.f(0.0f, function0);
                    if (!T) {
                        RemoteImage remoteImage = this.f20421q;
                        if (remoteImage != null) {
                            this.f20426v = eq.b.b(remoteImage, this, true);
                            return;
                        }
                        bVar.f25435g.setVisibility(0);
                        ImageView hintImage = bVar.f25433e;
                ...
                case 6:
                    Pi2CircleMaskView.e(bVar.f25431c, false, null, 3, null);
                    Pi2ProgressArcView.g(bVar.f25436h, 50.0f, null, 2, null);
                    F(this.f20416d, function0);
                    return;
                case 7:
                    Pi2CircleMaskView.e(bVar.f25431c, false, null, 3, null);
                    Pi2ProgressArcView.g(bVar.f25436h, 50.0f, null, 2, null);
                    if (T) {
                        M(this.f20416d, this.f20420p, function0);
                        return;
                    } else if (function0 != null) {
                        function0.invoke();
                        return;
                ...
                case 8:
                    Pi2CircleMaskView.e(bVar.f25431c, false, null, 3, null);
                    bVar.f25436h.f(50.0f, function0);
                    if (!T) {
                        RemoteImage remoteImage2 = this.f20422r;
                        if (remoteImage2 != null) {
                            this.f20426v = eq.b.b(remoteImage2, this, true);
                            return;
                        }
                        bVar.f25435g.setVisibility(0);
                        ImageView hintImage2 = bVar.f25433e;
                ...
                case 9:
                    Pi2CircleMaskView.e(bVar.f25431c, false, null, 3, null);
                    Pi2ProgressArcView.g(bVar.f25436h, 100.0f, null, 2, null);
                    F(this.f20416d, function0);
                    return;
                case 10:
                    Pi2CircleMaskView.e(bVar.f25431c, false, null, 3, null);
                ...
                case 11:
                    Pi2CircleMaskView.e(bVar.f25431c, false, null, 3, null);
                    Pi2ProgressArcView.g(bVar.f25436h, 100.0f, null, 2, null);
                    F(this.f20416d, new Function0() { // from class: ip.g
                        @Override // kotlin.jvm.functions.Function0
                        public final Object invoke() {
                            Unit K;
                ...
                case 12:
                    Pi2CircleMaskView.e(bVar.f25431c, false, null, 3, null);
                    bVar.f25436h.f(100.0f, new Function0() { // from class: ip.h
                        @Override // kotlin.jvm.functions.Function0
                        public final Object invoke() {
                            Unit L;
    ...
    public OldSelfieOverlayView(final Context context, AttributeSet attributeSet, int i10) {
        ...
        Intrinsics.checkNotNullParameter(context, "context");
        fp.b b10 = fp.b.b(LayoutInflater.from(context), this);
        Intrinsics.checkNotNullExpressionValue(b10, "inflate(...)");
        this.f20416d = b10;
        this.f20417e = l.b(new Function0() { // from class: ip.a
            @Override // kotlin.jvm.functions.Function0
            public final Object invoke() {
                Drawable C;
        ...
        this.f20418i = l.b(new Function0() { // from class: ip.e
            @Override // kotlin.jvm.functions.Function0
            public final Object invoke() {
                Drawable D;
        ...
        Integer f10 = s.f(context, bp.a.f7626r, null, false, 6, null);
        this.f20419o = f10 != null ? f10.intValue() : y0.f23968b;
        Integer f11 = s.f(context, bp.a.f7626r, null, false, 6, null);
        this.f20420p = f11 != null ? f11.intValue() : y0.f23969c;
        this.f20424t = new ArrayList();
        this.f20425u = new ArrayList();
        ThemeableLottieAnimationView themeableLottieAnimationView = b10.f25432d;
        themeableLottieAnimationView.j(new z() { // from class: ip.f
            @Override // l5.z
