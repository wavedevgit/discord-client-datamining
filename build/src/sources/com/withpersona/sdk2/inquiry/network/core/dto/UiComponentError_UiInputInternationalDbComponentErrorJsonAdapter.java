...
public final class UiComponentError_UiInputInternationalDbComponentErrorJsonAdapter extends h {
    @NotNull
    ...
    @NotNull
    public UiComponentError.UiInputInternationalDbComponentError fromJson(@NotNull m mVar) {
        mVar.s();
        String str = null;
        String str2 = null;
        Map map = null;
