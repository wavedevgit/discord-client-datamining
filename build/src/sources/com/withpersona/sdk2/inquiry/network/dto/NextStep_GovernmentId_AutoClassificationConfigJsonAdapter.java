...
public final class NextStep_GovernmentId_AutoClassificationConfigJsonAdapter extends h {
    ...
    public NextStep.GovernmentId.AutoClassificationConfig fromJson(@NotNull m reader) {
        ...
        if (constructor == null) {
            constructor = NextStep.GovernmentId.AutoClassificationConfig.class.getDeclaredConstructor(Boolean.class, Boolean.class, CapturePageConfig.class, Integer.TYPE, sm.c.f49081c);
