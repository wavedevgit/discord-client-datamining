...
public final class ButtonCancelComponentStyleJsonAdapter extends h {
    ...
    public ButtonCancelComponentStyleJsonAdapter(@NotNull w moshi) {
    ...
    @NotNull
    public ButtonCancelComponentStyle fromJson(@NotNull m reader) {
    ...
    @Override // com.squareup.moshi.h
    public void toJson(@NotNull t writer, ButtonCancelComponentStyle buttonCancelComponentStyle) {
