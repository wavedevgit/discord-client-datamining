...
public final class CreatePersonaSheetJsonAdapter extends h {
    ...
    public CreatePersonaSheetJsonAdapter(@NotNull w moshi) {
        ...
        h f11 = moshi.f(CreatePersonaSheet.Attributes.class, x0.d(), "attributes");
        Intrinsics.checkNotNullExpressionValue(f11, "adapter(...)");
        this.nullableAttributesAdapter = f11;
        h f12 = moshi.f(CreatePersonaSheet.CreatePersonaSheetStyle.class, x0.d(), "styles");
        Intrinsics.checkNotNullExpressionValue(f12, "adapter(...)");
        this.nullableCreatePersonaSheetStyleAdapter = f12;
    }
    ...
    @NotNull
    public CreatePersonaSheet fromJson(@NotNull m reader) {
        ...
        while (reader.hasNext()) {
            ...
            if (A0 == -1) {
                ...
                attributes = (CreatePersonaSheet.Attributes) this.nullableAttributesAdapter.fromJson(reader);
            } else if (A0 == 2) {
                createPersonaSheetStyle = (CreatePersonaSheet.CreatePersonaSheetStyle) this.nullableCreatePersonaSheetStyleAdapter.fromJson(reader);
            }
        }
        reader.y();
        if (str != null) {
    ...
    @Override // com.squareup.moshi.h
    public void toJson(@NotNull t writer, CreatePersonaSheet createPersonaSheet) {
        Intrinsics.checkNotNullParameter(writer, "writer");
        if (createPersonaSheet != null) {
            writer.l();
            writer.A0(StackTraceHelper.NAME_KEY);
            this.stringAdapter.toJson(writer, createPersonaSheet.getName());
            writer.A0("attributes");
            this.nullableAttributesAdapter.toJson(writer, createPersonaSheet.getAttributes());
            writer.A0("styles");
            this.nullableCreatePersonaSheetStyleAdapter.toJson(writer, createPersonaSheet.getStyles());
            writer.E();
            return;
        }
