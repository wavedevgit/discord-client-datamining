    ...
    public NextStep.GovernmentId.LocalizationOverride fromJson(@NotNull m reader) {
        ...
        if (str4 != null) {
            if (str5 != null) {
                ...
                throw vm.c.o("text", "text", reader);
            }
            throw vm.c.o("key", "key", reader);
        }
        throw vm.c.o("page", "page", reader);
    }
