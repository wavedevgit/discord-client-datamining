...
public final class AttributeStyles_ClickableStackGapStyleJsonAdapter extends h {
    @NotNull
    private final h nullableMeasurementAdapter;
    @NotNull
    private final m.b options;

    public AttributeStyles_ClickableStackGapStyleJsonAdapter(@NotNull w moshi) {
    ...
    @NotNull
    public AttributeStyles.ClickableStackGapStyle fromJson(@NotNull m reader) {
    ...
    @Override // com.squareup.moshi.h
    public void toJson(@NotNull t writer, AttributeStyles.ClickableStackGapStyle clickableStackGapStyle) {
        Intrinsics.checkNotNullParameter(writer, "writer");
        if (clickableStackGapStyle != null) {
            writer.k();
            writer.W("base");
            this.nullableMeasurementAdapter.toJson(writer, clickableStackGapStyle.getBase());
            writer.E();
            return;
        }
