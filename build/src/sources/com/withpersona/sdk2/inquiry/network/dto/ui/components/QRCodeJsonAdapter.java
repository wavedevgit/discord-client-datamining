...
public final class QRCodeJsonAdapter extends h {
    ...
    @NotNull
    private final h nullableQRCodeComponentStyleAdapter;
    @NotNull
    private final m.b options;
    @NotNull
    private final h stringAdapter;

    public QRCodeJsonAdapter(@NotNull w moshi) {
        ...
        h f11 = moshi.f(QRCode.Attributes.class, x0.d(), "attributes");
        Intrinsics.checkNotNullExpressionValue(f11, "adapter(...)");
        this.nullableAttributesAdapter = f11;
        h f12 = moshi.f(QRCode.QRCodeComponentStyle.class, x0.d(), "styles");
        Intrinsics.checkNotNullExpressionValue(f12, "adapter(...)");
        this.nullableQRCodeComponentStyleAdapter = f12;
    }
    ...
    public QRCode fromJson(@NotNull m reader) {
        ...
        if (constructor == null) {
            constructor = QRCode.class.getDeclaredConstructor(String.class, QRCode.Attributes.class, QRCode.QRCodeComponentStyle.class, Integer.TYPE, c.f49081c);
            this.constructorRef = constructor;
            Intrinsics.checkNotNullExpressionValue(constructor, "also(...)");
        }
        if (str != null) {
            QRCode newInstance = constructor.newInstance(str, attributes, qRCodeComponentStyle, Integer.valueOf(i10), null);
