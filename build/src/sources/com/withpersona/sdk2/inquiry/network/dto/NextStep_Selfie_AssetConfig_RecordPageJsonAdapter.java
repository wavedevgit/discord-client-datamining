...
public final class NextStep_Selfie_AssetConfig_RecordPageJsonAdapter extends h {
    ...
    public NextStep.Selfie.AssetConfig.RecordPage fromJson(@NotNull m reader) {
        ...
        if (constructor == null) {
            constructor = NextStep.Selfie.AssetConfig.RecordPage.class.getDeclaredConstructor(RemoteImage.class, RemoteImage.class, RemoteImage.class, Integer.TYPE, bn.c.f7152c);
