...
public final class InputCheckboxGroupJsonAdapter extends h {
    ...
    public InputCheckboxGroupJsonAdapter(@NotNull w moshi) {
        ...
        h f11 = moshi.f(InputCheckboxGroup.Attributes.class, x0.d(), "attributes");
    ...
    public InputCheckboxGroup fromJson(@NotNull m reader) {
        ...
        if (constructor == null) {
            constructor = InputCheckboxGroup.class.getDeclaredConstructor(String.class, InputCheckboxGroup.Attributes.class, InputCheckbox.InputCheckboxComponentStyle.class, Integer.TYPE, c.f51688c);
            this.constructorRef = constructor;
            Intrinsics.checkNotNullExpressionValue(constructor, "also(...)");
        }
        if (str != null) {
            InputCheckboxGroup newInstance = constructor.newInstance(str, attributes, inputCheckboxComponentStyle, Integer.valueOf(i10), null);
