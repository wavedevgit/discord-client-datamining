...
public final class AttributeStyles_ESignatureBackgroundColorStyleJsonAdapter extends h {
    ...
    public AttributeStyles_ESignatureBackgroundColorStyleJsonAdapter(@NotNull w moshi) {
        Intrinsics.checkNotNullParameter(moshi, "moshi");
        m.b a10 = m.b.a("base", "signaturePreview");
        ...
        h f11 = moshi.f(StyleElements.SimpleElementColor.class, x0.d(), "signaturePreview");
        Intrinsics.checkNotNullExpressionValue(f11, "adapter(...)");
        this.nullableSimpleElementColorAdapter = f11;
    }
