...
public final class Included_FontJsonAdapter extends h {
    ...
    public Included.Font fromJson(@NotNull m reader) {
        ...
        while (reader.hasNext()) {
            ...
            if (t02 == -1) {
                reader.F0();
                reader.P();
            } else if (t02 == 0 && (fontAttributes = (Included.Font.FontAttributes) this.fontAttributesAdapter.fromJson(reader)) == null) {
    ...
    @Override // com.squareup.moshi.h
    public void toJson(@NotNull t writer, Included.Font font) {
