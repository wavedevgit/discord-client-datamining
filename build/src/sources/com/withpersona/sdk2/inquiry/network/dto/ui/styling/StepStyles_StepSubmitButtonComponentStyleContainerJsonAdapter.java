...
public final class StepStyles_StepSubmitButtonComponentStyleContainerJsonAdapter extends h {
    @NotNull
    private final h nullableButtonSubmitComponentStyleAdapter;
    @NotNull
    private final m.b options;

    public StepStyles_StepSubmitButtonComponentStyleContainerJsonAdapter(@NotNull w moshi) {
    ...
    @NotNull
    public StepStyles.StepSubmitButtonComponentStyleContainer fromJson(@NotNull m reader) {
    ...
    @Override // com.squareup.moshi.h
    public void toJson(@NotNull t writer, StepStyles.StepSubmitButtonComponentStyleContainer stepSubmitButtonComponentStyleContainer) {
        Intrinsics.checkNotNullParameter(writer, "writer");
        if (stepSubmitButtonComponentStyleContainer != null) {
            writer.l();
            writer.A0("base");
            this.nullableButtonSubmitComponentStyleAdapter.toJson(writer, stepSubmitButtonComponentStyleContainer.getBase());
            writer.E();
            return;
        }
