...
public final class GenericFileUploadErrorResponse_DocumentErrorResponse_FileLimitExceededErrorJsonAdapter extends h {
    @NotNull
    ...
    public GenericFileUploadErrorResponse_DocumentErrorResponse_FileLimitExceededErrorJsonAdapter(@NotNull w wVar) {
        this.stringAdapter = wVar.f(String.class, x0.d(), "title");
        this.detailsAdapter = wVar.f(GenericFileUploadErrorResponse.DocumentErrorResponse.FileLimitExceededError.Details.class, x0.d(), "details");
    }
    ...
    public GenericFileUploadErrorResponse.DocumentErrorResponse.FileLimitExceededError fromJson(@NotNull m mVar) {
        ...
        while (mVar.hasNext()) {
            ...
            } else if (t02 == 2 && (details = (GenericFileUploadErrorResponse.DocumentErrorResponse.FileLimitExceededError.Details) this.detailsAdapter.fromJson(mVar)) == null) {
