...
public final class AttributeStyles_ESignatureSecondaryButtonStylesContainerJsonAdapter extends h {
    @NotNull
    private final h nullableButtonCancelComponentStyleAdapter;
    @NotNull
    private final m.b options;

    public AttributeStyles_ESignatureSecondaryButtonStylesContainerJsonAdapter(@NotNull w moshi) {
    ...
    @NotNull
    public AttributeStyles.ESignatureSecondaryButtonStylesContainer fromJson(@NotNull m reader) {
