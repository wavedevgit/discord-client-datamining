...
public final class StepStyles_UiStepStrokeColorJsonAdapter extends h {
    ...
    @NotNull
    public StepStyles.UiStepStrokeColor fromJson(@NotNull m reader) {
    ...
    @Override // com.squareup.moshi.h
    public void toJson(@NotNull t writer, StepStyles.UiStepStrokeColor uiStepStrokeColor) {
        Intrinsics.checkNotNullParameter(writer, "writer");
        if (uiStepStrokeColor != null) {
            writer.k();
            writer.W("base");
            this.nullableSimpleElementColorAdapter.toJson(writer, uiStepStrokeColor.getBase());
            writer.E();
            return;
        }
