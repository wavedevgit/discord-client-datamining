...
public final class InputTextArea_AttributesJsonAdapter extends h {
    ...
    public InputTextArea_AttributesJsonAdapter(@NotNull w moshi) {
        Intrinsics.checkNotNullParameter(moshi, "moshi");
        m.b a10 = m.b.a("prefill", "label", ReactTextInputShadowNode.PROP_PLACEHOLDER, "rows", ViewProps.HIDDEN, "disabled");
        Intrinsics.checkNotNullExpressionValue(a10, "of(...)");
        this.options = a10;
        h f10 = moshi.f(String.class, x0.d(), "prefill");
        Intrinsics.checkNotNullExpressionValue(f10, "adapter(...)");
        this.nullableStringAdapter = f10;
        h f11 = moshi.f(Integer.class, x0.d(), "rows");
    ...
    public String toString() {
        ...
        sb2.append("InputTextArea.Attributes");
        sb2.append(')');
        return sb2.toString();
    }
