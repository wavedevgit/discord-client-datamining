...
public final class CapturePageConfig_ManualCaptureConfigJsonAdapter extends h {
    ...
    public CapturePageConfig_ManualCaptureConfigJsonAdapter(@NotNull w moshi) {
        Intrinsics.checkNotNullParameter(moshi, "moshi");
        m.b a10 = m.b.a("isEnabled", "delayMs");
        Intrinsics.checkNotNullExpressionValue(a10, "of(...)");
        this.options = a10;
        h f10 = moshi.f(Boolean.class, x0.d(), "isEnabled");
        Intrinsics.checkNotNullExpressionValue(f10, "adapter(...)");
        this.nullableBooleanAdapter = f10;
        h f11 = moshi.f(Long.class, x0.d(), "delayMs");
