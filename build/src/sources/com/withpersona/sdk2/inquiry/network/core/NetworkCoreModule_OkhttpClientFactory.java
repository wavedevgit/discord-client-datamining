...
public final class NetworkCoreModule_OkhttpClientFactory implements br.d {
    ...
    public static OkHttpClient okhttpClient(NetworkCoreModule networkCoreModule, Set<Interceptor> set, Map<String, String> map, Context context, g gVar, co.b bVar, dp.b bVar2) {
        return (OkHttpClient) br.g.d(networkCoreModule.okhttpClient(set, map, context, gVar, bVar, bVar2));
    }
    ...
    public OkHttpClient get() {
        return okhttpClient(this.module, (Set) this.interceptorsProvider.get(), (Map) this.headersProvider.get(), (Context) this.contextProvider.get(), (g) this.deviceVendorIDProvider.get(), (co.b) this.deviceInfoProvider.get(), (dp.b) this.loggerProvider.get());
    }
}
