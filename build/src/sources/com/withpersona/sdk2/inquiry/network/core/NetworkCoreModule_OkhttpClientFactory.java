...
public final class NetworkCoreModule_OkhttpClientFactory implements zq.d {
    ...
    public static OkHttpClient okhttpClient(NetworkCoreModule networkCoreModule, Set<Interceptor> set, Map<String, String> map, Context context, g gVar, ao.b bVar, bp.b bVar2) {
        return (OkHttpClient) zq.g.d(networkCoreModule.okhttpClient(set, map, context, gVar, bVar, bVar2));
    }
    ...
    public OkHttpClient get() {
        return okhttpClient(this.module, (Set) this.interceptorsProvider.get(), (Map) this.headersProvider.get(), (Context) this.contextProvider.get(), (g) this.deviceVendorIDProvider.get(), (ao.b) this.deviceInfoProvider.get(), (bp.b) this.loggerProvider.get());
    }
}
