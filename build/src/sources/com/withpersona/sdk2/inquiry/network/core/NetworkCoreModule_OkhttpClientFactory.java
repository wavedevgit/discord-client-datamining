...
public final class NetworkCoreModule_OkhttpClientFactory implements tq.d {
    ...
    public static OkHttpClient okhttpClient(NetworkCoreModule networkCoreModule, Set<Interceptor> set, Map<String, String> map, Context context, g gVar, un.b bVar, vo.b bVar2) {
        return (OkHttpClient) tq.g.d(networkCoreModule.okhttpClient(set, map, context, gVar, bVar, bVar2));
    }
    ...
    public OkHttpClient get() {
        return okhttpClient(this.module, (Set) this.interceptorsProvider.get(), (Map) this.headersProvider.get(), (Context) this.contextProvider.get(), (g) this.deviceVendorIDProvider.get(), (un.b) this.deviceInfoProvider.get(), (vo.b) this.loggerProvider.get());
    }
}
