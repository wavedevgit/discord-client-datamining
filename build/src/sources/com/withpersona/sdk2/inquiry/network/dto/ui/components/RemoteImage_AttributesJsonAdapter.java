...
public final class RemoteImage_AttributesJsonAdapter extends h {
    ...
    public RemoteImage.Attributes fromJson(@NotNull m reader) {
        ...
        if (constructor == null) {
            constructor = RemoteImage.Attributes.class.getDeclaredConstructor(String.class, RemoteImage.ContentType.class, String.class, String.class, String.class, RemoteImage.ContentType.class, JsonLogicBoolean.class, Integer.TYPE, c.f51691c);
