...
public final class AttributeStyles_LocalImageHeightStyleJsonAdapter extends h {
    ...
    @NotNull
    public AttributeStyles.LocalImageHeightStyle fromJson(@NotNull m reader) {
    ...
    @Override // com.squareup.moshi.h
    public void toJson(@NotNull t writer, AttributeStyles.LocalImageHeightStyle localImageHeightStyle) {
        Intrinsics.checkNotNullParameter(writer, "writer");
        if (localImageHeightStyle != null) {
            writer.k();
            writer.J("base");
            this.nullableMeasurementAdapter.toJson(writer, localImageHeightStyle.getBase());
            writer.s();
            return;
        }
