...
public final class InputTextBasedComponentStyleJsonAdapter extends h {
    ...
    @NotNull
    private final h nullableInputTextStrokeColorStyleAdapter;
    @NotNull
    private final m.b options;

    public InputTextBasedComponentStyleJsonAdapter(@NotNull w moshi) {
        Intrinsics.checkNotNullParameter(moshi, "moshi");
        m.b a10 = m.b.a(ViewProps.MARGIN, ViewProps.FONT_FAMILY, ViewProps.FONT_SIZE, ViewProps.FONT_WEIGHT, ViewProps.LETTER_SPACING, ViewProps.LINE_HEIGHT, "textColor", "borderRadius", ViewProps.BORDER_WIDTH, ViewProps.BACKGROUND_COLOR, ViewProps.BORDER_COLOR, "strokeColor");
        ...
        h f11 = moshi.f(AttributeStyles.ComplexTextBasedFontFamilyStyle.class, x0.d(), ViewProps.FONT_FAMILY);
        Intrinsics.checkNotNullExpressionValue(f11, "adapter(...)");
        this.nullableComplexTextBasedFontFamilyStyleAdapter = f11;
        h f12 = moshi.f(AttributeStyles.ComplexTextBasedFontSizeStyle.class, x0.d(), ViewProps.FONT_SIZE);
        Intrinsics.checkNotNullExpressionValue(f12, "adapter(...)");
        this.nullableComplexTextBasedFontSizeStyleAdapter = f12;
        h f13 = moshi.f(AttributeStyles.ComplexTextBasedFontWeightStyle.class, x0.d(), ViewProps.FONT_WEIGHT);
        Intrinsics.checkNotNullExpressionValue(f13, "adapter(...)");
        this.nullableComplexTextBasedFontWeightStyleAdapter = f13;
        h f14 = moshi.f(AttributeStyles.ComplexTextBasedLetterSpacingStyle.class, x0.d(), ViewProps.LETTER_SPACING);
        Intrinsics.checkNotNullExpressionValue(f14, "adapter(...)");
        this.nullableComplexTextBasedLetterSpacingStyleAdapter = f14;
        h f15 = moshi.f(AttributeStyles.ComplexTextBasedLineHeightStyle.class, x0.d(), ViewProps.LINE_HEIGHT);
        Intrinsics.checkNotNullExpressionValue(f15, "adapter(...)");
        this.nullableComplexTextBasedLineHeightStyleAdapter = f15;
        h f16 = moshi.f(AttributeStyles.ComplexTextBasedTextColorStyle.class, x0.d(), "textColor");
        Intrinsics.checkNotNullExpressionValue(f16, "adapter(...)");
        this.nullableComplexTextBasedTextColorStyleAdapter = f16;
        h f17 = moshi.f(AttributeStyles.InputTextBorderRadiusStyle.class, x0.d(), "borderRadius");
        Intrinsics.checkNotNullExpressionValue(f17, "adapter(...)");
        this.nullableInputTextBorderRadiusStyleAdapter = f17;
        h f18 = moshi.f(AttributeStyles.InputTextBorderWidthStyle.class, x0.d(), ViewProps.BORDER_WIDTH);
        Intrinsics.checkNotNullExpressionValue(f18, "adapter(...)");
        this.nullableInputTextBorderWidthStyleAdapter = f18;
        h f19 = moshi.f(AttributeStyles.InputTextBackgroundColorStyle.class, x0.d(), ViewProps.BACKGROUND_COLOR);
        Intrinsics.checkNotNullExpressionValue(f19, "adapter(...)");
        this.nullableInputTextBackgroundColorStyleAdapter = f19;
        ...
        h f21 = moshi.f(AttributeStyles.InputTextStrokeColorStyle.class, x0.d(), "strokeColor");
        Intrinsics.checkNotNullExpressionValue(f21, "adapter(...)");
        this.nullableInputTextStrokeColorStyleAdapter = f21;
    }
    ...
    public String toString() {
        ...
        sb2.append("InputTextBasedComponentStyle");
        sb2.append(')');
        return sb2.toString();
    }
