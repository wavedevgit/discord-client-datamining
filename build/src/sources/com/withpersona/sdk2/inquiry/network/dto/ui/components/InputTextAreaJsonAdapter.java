...
public final class InputTextAreaJsonAdapter extends h {
    ...
    public InputTextAreaJsonAdapter(@NotNull w moshi) {
        ...
        h f11 = moshi.f(InputTextArea.Attributes.class, x0.d(), "attributes");
    ...
    @NotNull
    public InputTextArea fromJson(@NotNull m reader) {
    ...
    @Override // com.squareup.moshi.h
    public void toJson(@NotNull t writer, InputTextArea inputTextArea) {
        Intrinsics.checkNotNullParameter(writer, "writer");
        if (inputTextArea != null) {
            writer.k();
            writer.J(StackTraceHelper.NAME_KEY);
            this.stringAdapter.toJson(writer, inputTextArea.getName());
            writer.J("attributes");
            this.nullableAttributesAdapter.toJson(writer, inputTextArea.getAttributes());
            writer.J("styles");
            this.nullableInputTextBasedComponentStyleAdapter.toJson(writer, inputTextArea.getStyles());
            writer.s();
            return;
        }
