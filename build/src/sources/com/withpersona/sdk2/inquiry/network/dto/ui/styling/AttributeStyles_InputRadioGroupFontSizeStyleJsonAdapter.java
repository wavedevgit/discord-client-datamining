...
public final class AttributeStyles_InputRadioGroupFontSizeStyleJsonAdapter extends h {
    @NotNull
    private final h nullableMeasurementAdapter;
    @NotNull
    private final m.b options;

    public AttributeStyles_InputRadioGroupFontSizeStyleJsonAdapter(@NotNull w moshi) {
    ...
    @Override // com.squareup.moshi.h
    public void toJson(@NotNull t writer, AttributeStyles.InputRadioGroupFontSizeStyle inputRadioGroupFontSizeStyle) {
