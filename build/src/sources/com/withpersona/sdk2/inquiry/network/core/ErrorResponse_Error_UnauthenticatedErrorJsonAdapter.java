...
public final class ErrorResponse_Error_UnauthenticatedErrorJsonAdapter extends h {
    @NotNull
    ...
    @NotNull
    public ErrorResponse.Error.UnauthenticatedError fromJson(@NotNull m mVar) {
        mVar.u();
        String str = null;
        String str2 = null;
        while (mVar.hasNext()) {
