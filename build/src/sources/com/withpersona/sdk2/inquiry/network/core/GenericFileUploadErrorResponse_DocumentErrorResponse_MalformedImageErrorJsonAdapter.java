...
public final class GenericFileUploadErrorResponse_DocumentErrorResponse_MalformedImageErrorJsonAdapter extends h {
    @NotNull
    ...
    public GenericFileUploadErrorResponse_DocumentErrorResponse_MalformedImageErrorJsonAdapter(@NotNull w wVar) {
        ...
        this.detailsAdapter = wVar.f(GenericFileUploadErrorResponse.DocumentErrorResponse.MalformedImageError.Details.class, x0.d(), "details");
    }
    ...
    @NotNull
    public GenericFileUploadErrorResponse.DocumentErrorResponse.MalformedImageError fromJson(@NotNull m mVar) {
        mVar.u();
        String str = null;
        String str2 = null;
        ...
        while (mVar.hasNext()) {
            ...
            } else if (J == 2 && (details = (GenericFileUploadErrorResponse.DocumentErrorResponse.MalformedImageError.Details) this.detailsAdapter.fromJson(mVar)) == null) {
