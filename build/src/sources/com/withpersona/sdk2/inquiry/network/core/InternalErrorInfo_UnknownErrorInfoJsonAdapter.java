...
public final class InternalErrorInfo_UnknownErrorInfoJsonAdapter extends h {
    @NotNull
    ...
    public String toString() {
        ...
        sb2.append("InternalErrorInfo.UnknownErrorInfo");
        sb2.append(')');
        return sb2.toString();
    }
    ...
    @NotNull
    public InternalErrorInfo.UnknownErrorInfo fromJson(@NotNull m mVar) {
        mVar.r();
        String str = null;
        while (mVar.hasNext()) {
