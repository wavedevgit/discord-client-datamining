...
public final class InquiryField_FloatFieldJsonAdapter extends h {
    ...
    public InquiryField_FloatFieldJsonAdapter(@NotNull w moshi) {
        Intrinsics.checkNotNullParameter(moshi, "moshi");
        m.b a10 = m.b.a("value", "type");
        Intrinsics.checkNotNullExpressionValue(a10, "of(...)");
        this.options = a10;
        h f10 = moshi.f(Float.class, x0.d(), "value");
    ...
    @NotNull
    public InquiryField.FloatField fromJson(@NotNull m reader) {
        ...
        if (constructor == null) {
            constructor = InquiryField.FloatField.class.getDeclaredConstructor(Float.class, String.class, Integer.TYPE, vm.c.f51688c);
            this.constructorRef = constructor;
            Intrinsics.checkNotNullExpressionValue(constructor, "also(...)");
        }
        InquiryField.FloatField newInstance = constructor.newInstance(f10, str, Integer.valueOf(i10), null);
        Intrinsics.checkNotNullExpressionValue(newInstance, "newInstance(...)");
        return newInstance;
    }

    @Override // com.squareup.moshi.h
    public void toJson(@NotNull t writer, InquiryField.FloatField floatField) {
