...
public final class AttributeStyles_RemoteImageJustifyStyleJsonAdapter extends h {
    @NotNull
    private final h nullablePositionAdapter;
    @NotNull
    private final m.b options;

    public AttributeStyles_RemoteImageJustifyStyleJsonAdapter(@NotNull w moshi) {
    ...
    @NotNull
    public AttributeStyles.RemoteImageJustifyStyle fromJson(@NotNull m reader) {
    ...
    @Override // com.squareup.moshi.h
    public void toJson(@NotNull t writer, AttributeStyles.RemoteImageJustifyStyle remoteImageJustifyStyle) {
        Intrinsics.checkNotNullParameter(writer, "writer");
        if (remoteImageJustifyStyle != null) {
            writer.k();
            writer.W("base");
            this.nullablePositionAdapter.toJson(writer, remoteImageJustifyStyle.getBase());
            writer.E();
            return;
        }
