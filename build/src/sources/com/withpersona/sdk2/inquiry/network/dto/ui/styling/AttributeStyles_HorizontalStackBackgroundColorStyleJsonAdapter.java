...
public final class AttributeStyles_HorizontalStackBackgroundColorStyleJsonAdapter extends h {
    ...
    @NotNull
    public AttributeStyles.HorizontalStackBackgroundColorStyle fromJson(@NotNull m reader) {
    ...
    @Override // com.squareup.moshi.h
    public void toJson(@NotNull t writer, AttributeStyles.HorizontalStackBackgroundColorStyle horizontalStackBackgroundColorStyle) {
        Intrinsics.checkNotNullParameter(writer, "writer");
        if (horizontalStackBackgroundColorStyle != null) {
            writer.l();
            writer.t0("base");
            this.nullableSimpleElementColorAdapter.toJson(writer, horizontalStackBackgroundColorStyle.getBase());
            writer.E();
            return;
        }
