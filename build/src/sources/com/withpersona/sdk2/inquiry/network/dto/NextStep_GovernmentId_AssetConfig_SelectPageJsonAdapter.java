...
public final class NextStep_GovernmentId_AssetConfig_SelectPageJsonAdapter extends h {
    ...
    public NextStep_GovernmentId_AssetConfig_SelectPageJsonAdapter(@NotNull w moshi) {
        Intrinsics.checkNotNullParameter(moshi, "moshi");
        m.b a10 = m.b.a("headerPictograph", "iconDriversLicense", "iconPassport", "iconNationalId", "iconGovernmentId");
    ...
    public String toString() {
        ...
        sb2.append("NextStep.GovernmentId.AssetConfig.SelectPage");
        sb2.append(')');
        return sb2.toString();
    }
    ...
    public NextStep.GovernmentId.AssetConfig.SelectPage fromJson(@NotNull m reader) {
        ...
        if (constructor == null) {
            constructor = NextStep.GovernmentId.AssetConfig.SelectPage.class.getDeclaredConstructor(RemoteImage.class, RemoteImage.class, RemoteImage.class, RemoteImage.class, RemoteImage.class, Integer.TYPE, sm.c.f49081c);
            this.constructorRef = constructor;
            Intrinsics.checkNotNullExpressionValue(constructor, "also(...)");
        }
        NextStep.GovernmentId.AssetConfig.SelectPage newInstance = constructor.newInstance(remoteImage12, remoteImage11, remoteImage10, remoteImage9, remoteImage8, Integer.valueOf(i10), null);
