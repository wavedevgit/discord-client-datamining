...
public final class InputMaskedTextJsonAdapter extends h {
    ...
    public InputMaskedTextJsonAdapter(@NotNull w moshi) {
        ...
        h f11 = moshi.f(InputTextBasedComponentStyle.class, x0.d(), "styles");
        Intrinsics.checkNotNullExpressionValue(f11, "adapter(...)");
        this.nullableInputTextBasedComponentStyleAdapter = f11;
        h f12 = moshi.f(InputMaskedText.Attributes.class, x0.d(), "attributes");
    ...
    @NotNull
    public InputMaskedText fromJson(@NotNull m reader) {
        ...
        while (reader.hasNext()) {
            ...
            if (A0 == -1) {
                ...
                attributes = (InputMaskedText.Attributes) this.nullableAttributesAdapter.fromJson(reader);
            }
        }
        reader.y();
        if (str != null) {
    ...
    @Override // com.squareup.moshi.h
    public void toJson(@NotNull t writer, InputMaskedText inputMaskedText) {
        Intrinsics.checkNotNullParameter(writer, "writer");
        if (inputMaskedText != null) {
            writer.l();
            writer.A0(StackTraceHelper.NAME_KEY);
            this.stringAdapter.toJson(writer, inputMaskedText.getName());
            writer.A0("styles");
            this.nullableInputTextBasedComponentStyleAdapter.toJson(writer, inputMaskedText.getStyles());
            writer.A0("attributes");
            this.nullableAttributesAdapter.toJson(writer, inputMaskedText.getAttributes());
            writer.E();
            return;
        }
