...
public final class CombinedStepImagePreviewJsonAdapter extends h {
    ...
    public CombinedStepImagePreview fromJson(@NotNull m reader) {
        ...
        if (constructor == null) {
            constructor = CombinedStepImagePreview.class.getDeclaredConstructor(String.class, CombinedStepImagePreview.Attributes.class, CombinedStepImagePreview.CombinedStepImagePreviewComponentStyle.class, Integer.TYPE, c.f1164c);
