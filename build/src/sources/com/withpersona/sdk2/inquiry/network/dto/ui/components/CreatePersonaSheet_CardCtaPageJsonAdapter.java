...
public final class CreatePersonaSheet_CardCtaPageJsonAdapter extends h {
    ...
    public CreatePersonaSheet.CardCtaPage fromJson(@NotNull m reader) {
        ...
        if (constructor == null) {
            constructor = CreatePersonaSheet.CardCtaPage.class.getDeclaredConstructor(NextStep.Ui.class, CreatePersonaSheet.CardCtaPage.ComponentNameMapping.class, Integer.TYPE, c.f54853c);
