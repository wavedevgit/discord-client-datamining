...
public final class AttributeStyles_ButtonBasedHeightStyleJsonAdapter extends h {
    ...
    @NotNull
    public AttributeStyles.ButtonBasedHeightStyle fromJson(@NotNull m reader) {
    ...
    @Override // com.squareup.moshi.h
    public void toJson(@NotNull t writer, AttributeStyles.ButtonBasedHeightStyle buttonBasedHeightStyle) {
        Intrinsics.checkNotNullParameter(writer, "writer");
        if (buttonBasedHeightStyle != null) {
            writer.k();
            writer.W("base");
            this.nullableMeasurementAdapter.toJson(writer, buttonBasedHeightStyle.getBase());
            writer.E();
            return;
        }
