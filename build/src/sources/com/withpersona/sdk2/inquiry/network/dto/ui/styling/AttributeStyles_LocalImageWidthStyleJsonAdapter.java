...
public final class AttributeStyles_LocalImageWidthStyleJsonAdapter extends h {
    ...
    @NotNull
    public AttributeStyles.LocalImageWidthStyle fromJson(@NotNull m reader) {
    ...
    @Override // com.squareup.moshi.h
    public void toJson(@NotNull t writer, AttributeStyles.LocalImageWidthStyle localImageWidthStyle) {
        Intrinsics.checkNotNullParameter(writer, "writer");
        if (localImageWidthStyle != null) {
            writer.k();
            writer.W("base");
            this.nullableMeasurementAdapter.toJson(writer, localImageWidthStyle.getBase());
            writer.E();
            return;
        }
