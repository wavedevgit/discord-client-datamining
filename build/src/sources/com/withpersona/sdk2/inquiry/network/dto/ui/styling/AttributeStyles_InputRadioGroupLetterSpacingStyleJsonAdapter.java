...
public final class AttributeStyles_InputRadioGroupLetterSpacingStyleJsonAdapter extends h {
    @NotNull
    private final h nullableMeasurementAdapter;
    @NotNull
    private final m.b options;

    public AttributeStyles_InputRadioGroupLetterSpacingStyleJsonAdapter(@NotNull w moshi) {
    ...
    @NotNull
    public AttributeStyles.InputRadioGroupLetterSpacingStyle fromJson(@NotNull m reader) {
    ...
    public void toJson(@NotNull t writer, AttributeStyles.InputRadioGroupLetterSpacingStyle inputRadioGroupLetterSpacingStyle) {
        ...
        if (inputRadioGroupLetterSpacingStyle != null) {
            ...
            this.nullableMeasurementAdapter.toJson(writer, inputRadioGroupLetterSpacingStyle.getDescription());
            writer.W("error");
            this.nullableMeasurementAdapter.toJson(writer, inputRadioGroupLetterSpacingStyle.getError());
            writer.E();
            return;
        }
