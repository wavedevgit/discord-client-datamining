...
public final class AttributeStyles_HorizontalStackBorderColorStyleJsonAdapter extends h {
    @NotNull
    private final h nullableSimpleElementColorAdapter;
    @NotNull
    private final m.b options;

    public AttributeStyles_HorizontalStackBorderColorStyleJsonAdapter(@NotNull w moshi) {
    ...
    @Override // com.squareup.moshi.h
    public void toJson(@NotNull t writer, AttributeStyles.HorizontalStackBorderColorStyle horizontalStackBorderColorStyle) {
