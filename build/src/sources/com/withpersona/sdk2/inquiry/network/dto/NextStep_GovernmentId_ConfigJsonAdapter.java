            ...
            if (reader.hasNext()) {
                ...
                switch (reader.W(this.options)) {
                    ...
                    case 8:
                        ...
                        if (str2 == null) {
                            throw ym.c.x("fieldKeyIdclass", "fieldKeyIdclass", reader);
                        }
                        bool = bool5;
                        break;
                    case 9:
                ...
                if (localizations != null) {
                    if (str != null) {
                        ...
                        throw ym.c.o("fieldKeyIdclass", "fieldKeyIdclass", reader);
                    }
