...
public final class StepStyles_UiStepTitleComponentStyleJsonAdapter extends h {
    @NotNull
    private final h nullableStepTextBasedComponentStyleContainerAdapter;
    @NotNull
    private final m.b options;

    public StepStyles_UiStepTitleComponentStyleJsonAdapter(@NotNull w moshi) {
        Intrinsics.checkNotNullParameter(moshi, "moshi");
        m.b a10 = m.b.a("base", "uiStepProcessingTitle");
    ...
    @Override // com.squareup.moshi.h
    public void toJson(@NotNull t writer, StepStyles.UiStepTitleComponentStyle uiStepTitleComponentStyle) {
