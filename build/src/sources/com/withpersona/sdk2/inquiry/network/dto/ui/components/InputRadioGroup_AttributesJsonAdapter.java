...
public final class InputRadioGroup_AttributesJsonAdapter extends h {
    ...
    public InputRadioGroup.Attributes fromJson(@NotNull m reader) {
        ...
        if (constructor == null) {
            constructor = InputRadioGroup.Attributes.class.getDeclaredConstructor(String.class, String.class, List.class, JsonLogicBoolean.class, JsonLogicBoolean.class, Integer.TYPE, c.f49935c);
