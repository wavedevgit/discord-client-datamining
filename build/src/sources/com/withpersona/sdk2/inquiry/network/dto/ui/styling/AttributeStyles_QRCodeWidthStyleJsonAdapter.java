...
public final class AttributeStyles_QRCodeWidthStyleJsonAdapter extends h {
    @NotNull
    private final h nullableMeasurementAdapter;
    @NotNull
    private final m.b options;

    public AttributeStyles_QRCodeWidthStyleJsonAdapter(@NotNull w moshi) {
    ...
    @NotNull
    public AttributeStyles.QRCodeWidthStyle fromJson(@NotNull m reader) {
    ...
    @Override // com.squareup.moshi.h
    public void toJson(@NotNull t writer, AttributeStyles.QRCodeWidthStyle qRCodeWidthStyle) {
        Intrinsics.checkNotNullParameter(writer, "writer");
        if (qRCodeWidthStyle != null) {
            writer.k();
            writer.W("base");
            this.nullableMeasurementAdapter.toJson(writer, qRCodeWidthStyle.getBase());
            writer.E();
            return;
        }
