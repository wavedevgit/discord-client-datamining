...
public final class GenericFileUploadErrorResponse_DocumentErrorResponse_MalformedPdfErrorJsonAdapter extends h {
    @NotNull
    ...
    public GenericFileUploadErrorResponse_DocumentErrorResponse_MalformedPdfErrorJsonAdapter(@NotNull w wVar) {
        ...
        this.detailsAdapter = wVar.f(GenericFileUploadErrorResponse.DocumentErrorResponse.MalformedPdfError.Details.class, x0.d(), "details");
    }
    ...
    @NotNull
    public GenericFileUploadErrorResponse.DocumentErrorResponse.MalformedPdfError fromJson(@NotNull m mVar) {
        mVar.r();
        String str = null;
        String str2 = null;
        ...
        while (mVar.hasNext()) {
            ...
            } else if (t02 == 2 && (details = (GenericFileUploadErrorResponse.DocumentErrorResponse.MalformedPdfError.Details) this.detailsAdapter.fromJson(mVar)) == null) {
