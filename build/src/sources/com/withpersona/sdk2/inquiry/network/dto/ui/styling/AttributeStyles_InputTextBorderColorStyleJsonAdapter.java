...
public final class AttributeStyles_InputTextBorderColorStyleJsonAdapter extends h {
    @NotNull
    private final h nullableComplexElementColorAdapter;
    @NotNull
    private final m.b options;

    public AttributeStyles_InputTextBorderColorStyleJsonAdapter(@NotNull w moshi) {
    ...
    @NotNull
    public AttributeStyles.InputTextBorderColorStyle fromJson(@NotNull m reader) {
    ...
    @Override // com.squareup.moshi.h
    public void toJson(@NotNull t writer, AttributeStyles.InputTextBorderColorStyle inputTextBorderColorStyle) {
        Intrinsics.checkNotNullParameter(writer, "writer");
        if (inputTextBorderColorStyle != null) {
            writer.k();
            writer.W("base");
            this.nullableComplexElementColorAdapter.toJson(writer, inputTextBorderColorStyle.getBase());
            writer.E();
            return;
        }
