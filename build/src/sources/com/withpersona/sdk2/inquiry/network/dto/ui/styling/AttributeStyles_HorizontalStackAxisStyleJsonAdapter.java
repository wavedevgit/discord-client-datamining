...
public final class AttributeStyles_HorizontalStackAxisStyleJsonAdapter extends h {
    @NotNull
    private final h nullableAxisContainerAdapter;
    @NotNull
    private final m.b options;

    public AttributeStyles_HorizontalStackAxisStyleJsonAdapter(@NotNull w moshi) {
    ...
    @NotNull
    public AttributeStyles.HorizontalStackAxisStyle fromJson(@NotNull m reader) {
