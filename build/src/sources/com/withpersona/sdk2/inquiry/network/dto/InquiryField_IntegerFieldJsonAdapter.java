...
public final class InquiryField_IntegerFieldJsonAdapter extends h {
    ...
    public InquiryField_IntegerFieldJsonAdapter(@NotNull w moshi) {
        Intrinsics.checkNotNullParameter(moshi, "moshi");
        m.b a10 = m.b.a("value", "type");
        Intrinsics.checkNotNullExpressionValue(a10, "of(...)");
        this.options = a10;
        h f10 = moshi.f(Integer.class, x0.d(), "value");
    ...
    public InquiryField.IntegerField fromJson(@NotNull m reader) {
        ...
        if (constructor == null) {
            constructor = InquiryField.IntegerField.class.getDeclaredConstructor(Integer.class, String.class, Integer.TYPE, vm.c.f51691c);
            this.constructorRef = constructor;
            Intrinsics.checkNotNullExpressionValue(constructor, "also(...)");
        }
        InquiryField.IntegerField newInstance = constructor.newInstance(num, str, Integer.valueOf(i10), null);
