...
public final class LottieAnimationViewManager extends SimpleViewManager<LottieAnimationView> implements LottieAnimationViewManagerInterface<LottieAnimationView> {
    ...
    public static final class a implements Animator.AnimatorListener {
        ...
        final /* synthetic */ LottieAnimationView f8378a;

        a(LottieAnimationView lottieAnimationView) {
            this.f8378a = lottieAnimationView;
        }

        @Override // android.animation.Animator.AnimatorListener
        public void onAnimationCancel(Animator animation) {
            Intrinsics.checkNotNullParameter(animation, "animation");
            g.r(this.f8378a, true);
        }

        @Override // android.animation.Animator.AnimatorListener
        public void onAnimationEnd(Animator animation) {
            Intrinsics.checkNotNullParameter(animation, "animation");
            g.r(this.f8378a, false);
        }
    ...
    public LottieAnimationView createViewInstance(@NotNull ThemedReactContext context) {
        ...
        e10.j(new a0() { // from class: com.airbnb.android.react.lottie.b
            @Override // l5.a0
    ...
    public void setEnableSafeModeAndroid(@NotNull LottieAnimationView view, boolean z10) {
        Intrinsics.checkNotNullParameter(view, "view");
