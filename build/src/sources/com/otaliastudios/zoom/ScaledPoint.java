...
public final class ScaledPoint {
    ...
    public static /* synthetic */ ScaledPoint b(ScaledPoint scaledPoint, float f10, float f11, int i10, Object obj) {
        if ((i10 & 1) != 0) {
            f10 = scaledPoint.f18153a;
        }
        if ((i10 & 2) != 0) {
            f11 = scaledPoint.f18154b;
        }
    ...
    public final ScaledPoint e(ScaledPoint scaledPoint) {
        ...
        return new ScaledPoint(this.f18153a - scaledPoint.f18153a, this.f18154b - scaledPoint.f18154b);
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof ScaledPoint) {
            ...
            return Intrinsics.areEqual((Object) Float.valueOf(this.f18153a), (Object) Float.valueOf(scaledPoint.f18153a)) && Intrinsics.areEqual((Object) Float.valueOf(this.f18154b), (Object) Float.valueOf(scaledPoint.f18154b));
        }
        return false;
    }
    ...
    public final void g(Number x10, Number y10) {
        ...
        this.f18153a = x10.floatValue();
        this.f18154b = y10.floatValue();
    }
    ...
    public int hashCode() {
        return (Float.hashCode(this.f18153a) * 31) + Float.hashCode(this.f18154b);
    }
    ...
    public final AbsolutePoint j(float f10, AbsolutePoint outPoint) {
        ...
        outPoint.h(Float.valueOf(this.f18153a / f10), Float.valueOf(this.f18154b / f10));
        return outPoint;
    }

    public String toString() {
        return "ScaledPoint(x=" + this.f18153a + ", y=" + this.f18154b + ')';
    }
