...
public final class AFd1rSDK {
    ...
    public static final Pair<Integer, Integer> getCurrencyIso4217Code(@NotNull String str) {
        ...
        if (h10 != null) {
            ...
            if (getMonetizationNetwork(num, num2, num3, num4, num5, num6)) {
                ...
                return ir.v.a(valueOf, Integer.valueOf((num4.intValue() * 1000000) + (num5.intValue() * 1000) + num7.intValue()));
            }
        }
        return null;
    }
    ...
    public static final Pair<Integer, Integer> getMonetizationNetwork(@NotNull String str) {
        ...
        if (h10 != null) {
            ...
            if (intOrNull != null) {
                return ir.v.a(Integer.valueOf(intOrNull.intValue() * 1000000), Integer.valueOf(((intOrNull.intValue() + 1) * 1000000) - 1));
            }
            if (intOrNull2 != null && intOrNull3 != null) {
                return ir.v.a(Integer.valueOf((intOrNull2.intValue() * 1000000) + (intOrNull3.intValue() * 1000)), Integer.valueOf(((intOrNull2.intValue() * 1000000) + ((intOrNull3.intValue() + 1) * 1000)) - 1));
            }
        }
        return null;
    }
