...
public final class AFg1eSDK extends AFh1ySDK {
    ...
    private final void getMonetizationNetwork(AFLogger.LogLevel logLevel, AFg1cSDK aFg1cSDK, String str, Throwable th2) {
        if (getMediationNetwork(logLevel)) {
            String revenue = getRevenue(str, aFg1cSDK);
            int i10 = AFa1ySDK.AFAdRevenueData[logLevel.ordinal()];
            if (i10 != 1) {
                if (i10 != 2) {
                    if (i10 != 3) {
                        if (i10 != 4) {
                            if (i10 == 5) {
                                Log.e("AppsFlyer_6.17.3", revenue, th2);
                                return;
                            }
                            return;
                        }
    ...
    public final void e(@NotNull AFg1cSDK aFg1cSDK, @NotNull String str, @NotNull Throwable th2, boolean z10, boolean z11, boolean z12, boolean z13) {
        ...
        if (z11) {
            getMonetizationNetwork(AFLogger.LogLevel.ERROR, aFg1cSDK, str, th2);
        } else if (z10) {
            getMonetizationNetwork(AFLogger.LogLevel.DEBUG, aFg1cSDK, str, null);
        }
    }
