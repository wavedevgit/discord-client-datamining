...
public final class AFc1cSDK {
    ...
    public static final class AFa1vSDK {
        ...
        public static AFc1cSDK getCurrencyIso4217Code(@NotNull String str) {
            Intrinsics.checkNotNullParameter(str, "");
            List<String> split$default = StringsKt.split$default(str, new String[]{ReactEditTextInputConnectionWrapper.NEWLINE_RAW_VALUE}, false, 0, 6, null);
            ...
            for (String str5 : split$default) {
                if (StringsKt.P(str5, "label=", false, 2, null)) {
                    str2 = getCurrencyIso4217Code(str5, "label=");
                } else if (StringsKt.P(str5, "hashName=", false, 2, null)) {
                    str3 = getCurrencyIso4217Code(str5, "hashName=");
                } else if (StringsKt.P(str5, "stackTrace=", false, 2, null)) {
                    str4 = getCurrencyIso4217Code(str5, "stackTrace=");
                } else if (!StringsKt.P(str5, "c=", false, 2, null)) {
                    break;
                } else {
                    String substring = str5.substring(2);
                    Intrinsics.checkNotNullExpressionValue(substring, "");
                    num = Integer.valueOf(Integer.parseInt(StringsKt.k1(substring).toString()));
                }
            }
    ...
    public final boolean equals(Object obj) {
        ...
        if (Intrinsics.areEqual(this.getMediationNetwork, aFc1cSDK.getMediationNetwork) && Intrinsics.areEqual(this.getRevenue, aFc1cSDK.getRevenue) && Intrinsics.areEqual(this.AFAdRevenueData, aFc1cSDK.AFAdRevenueData) && this.getCurrencyIso4217Code == aFc1cSDK.getCurrencyIso4217Code) {
            return true;
        }
        return false;
    }
