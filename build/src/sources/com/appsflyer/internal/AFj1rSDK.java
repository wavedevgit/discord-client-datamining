...
public final class AFj1rSDK {
    ...
    public /* synthetic */ void component4(final Runnable runnable) {
        AFj1wSDK aFj1wSDK = new AFj1wSDK(this.getMonetizationNetwork.getCurrencyIso4217Code(), this.getMonetizationNetwork.getMediationNetwork(), AFj1xSDK.INSTAGRAM, runnable, new Runnable() { // from class: com.appsflyer.internal.g0
    ...
    public /* synthetic */ void getCurrencyIso4217Code(final Runnable runnable) {
        this.getMonetizationNetwork.getMediationNetwork().execute(new Runnable() { // from class: com.appsflyer.internal.d0
            @Override // java.lang.Runnable
            public final void run() {
    ...
    public final void AFAdRevenueData(final Context context, final Runnable runnable, final AFc1bSDK aFc1bSDK) {
        aFc1bSDK.getMediationNetwork().execute(new Runnable() { // from class: com.appsflyer.internal.f0
            @Override // java.lang.Runnable
            public final void run() {
    ...
    public final void getMediationNetwork(final Runnable runnable) {
        this.getCurrencyIso4217Code.add(new AFj1wSDK(this.getMonetizationNetwork.getCurrencyIso4217Code(), this.getMonetizationNetwork.getMediationNetwork(), AFj1xSDK.FACEBOOK, runnable, new Runnable() { // from class: com.appsflyer.internal.c0
            @Override // java.lang.Runnable
            public final void run() {
    ...
    public final AFi1bSDK getMonetizationNetwork(final Runnable runnable) {
        return new AFi1bSDK(new Runnable() { // from class: com.appsflyer.internal.i0
            @Override // java.lang.Runnable
            public final void run() {
    ...
    public /* synthetic */ void getMediationNetwork(AFi1bSDK aFi1bSDK, Runnable runnable) {
        ...
        boolean z10 = aFi1bSDK.areAllFieldsValid == AFj1qSDK.AFa1vSDK.NOT_STARTED;
        if (mediationNetwork == 1) {
            if (z10 || mediationNetwork2) {
                runnable.run();
            }
        }
    }
    ...
    public /* synthetic */ void AFAdRevenueData(Runnable runnable) {
        AFj1wSDK aFj1wSDK = new AFj1wSDK(this.getMonetizationNetwork.getCurrencyIso4217Code(), this.getMonetizationNetwork.getMediationNetwork(), AFj1xSDK.FACEBOOK_LITE, runnable, new Runnable() { // from class: com.appsflyer.internal.h0
            @Override // java.lang.Runnable
            public final void run() {
    ...
    public final Runnable getRevenue(final AFi1bSDK aFi1bSDK, final Runnable runnable) {
        return new Runnable() { // from class: com.appsflyer.internal.e0
            @Override // java.lang.Runnable
            public final void run() {
