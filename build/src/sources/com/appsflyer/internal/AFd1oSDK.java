...
public final class AFd1oSDK extends AFc1aSDK {
    ...
    public /* synthetic */ AFd1oSDK(AFc1pSDK aFc1pSDK, byte[] bArr, Map map, int i10, int i11, DefaultConstructorMarker defaultConstructorMarker) {
        this(aFc1pSDK, bArr, (i11 & 4) != 0 ? null : map, (i11 & 8) != 0 ? 2000 : i10);
    }
    ...
    private AFd1oSDK(@NotNull AFc1pSDK aFc1pSDK, @NotNull byte[] bArr, Map<String, String> map, int i10) {
        super(bArr, map, i10);
