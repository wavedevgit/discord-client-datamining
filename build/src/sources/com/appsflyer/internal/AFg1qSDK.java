...
public final class AFg1qSDK implements AFg1rSDK {
    ...
    private static int f8860i = 1;

    /* renamed from: w  reason: collision with root package name */
    private static int f8861w;
    @NotNull
    ...
    private void AFInAppEventParameterName(@NotNull Map<String, Object> map) {
        ...
        if (j10 != 0) {
            f8861w = (f8860i + 41) % IntBufferBatchMountItem.INSTRUCTION_UPDATE_LAYOUT;
            map.put("prev_session_dur", Long.valueOf(j10));
            f8860i = (f8861w + 31) % IntBufferBatchMountItem.INSTRUCTION_UPDATE_LAYOUT;
        }
        f8861w = (f8860i + 111) % IntBufferBatchMountItem.INSTRUCTION_UPDATE_LAYOUT;
    }
    ...
    private static void AFKeystoreWrapper(@NotNull Map<String, Object> map) {
        int i10 = f8861w + 41;
        f8860i = i10 % IntBufferBatchMountItem.INSTRUCTION_UPDATE_LAYOUT;
        if (i10 % 2 != 0) {
            Intrinsics.checkNotNullParameter(map, "");
            ...
            if (monetizationNetwork != null && revenue != null && Integer.parseInt(revenue) > 0) {
                f8861w = (f8860i + 57) % IntBufferBatchMountItem.INSTRUCTION_UPDATE_LAYOUT;
    ...
    private void AFLogger(@NotNull Map<String, Object> map) {
        ...
        if (string != null) {
            f8861w = (f8860i + 39) % IntBufferBatchMountItem.INSTRUCTION_UPDATE_LAYOUT;
            if (string.length() != 0) {
                f8861w = (f8860i + 117) % IntBufferBatchMountItem.INSTRUCTION_UPDATE_LAYOUT;
    ...
    */
    ...
    private void afDebugLog(@NotNull Map<String, Object> map) {
        ...
        if (getMonetizationNetwork().getBoolean(AppsFlyerProperties.COLLECT_FACEBOOK_ATTR_ID, true)) {
            f8860i = (f8861w + 113) % IntBufferBatchMountItem.INSTRUCTION_UPDATE_LAYOUT;
            try {
                ...
                f8861w = (f8860i + 105) % IntBufferBatchMountItem.INSTRUCTION_UPDATE_LAYOUT;
            } catch (Throwable unused) {
                str = null;
            }
            if (str != null) {
                f8861w = (f8860i + 119) % IntBufferBatchMountItem.INSTRUCTION_UPDATE_LAYOUT;
                map.put("fb", str);
            }
        }
    }
    ...
    private static long areAllFieldsValid() {
        f8860i = (f8861w + 121) % IntBufferBatchMountItem.INSTRUCTION_UPDATE_LAYOUT;
        long currentTimeMillis = System.currentTimeMillis() - SystemClock.elapsedRealtime();
        f8860i = (f8861w + 3) % IntBufferBatchMountItem.INSTRUCTION_UPDATE_LAYOUT;
        return currentTimeMillis;
    }

    private void component1(@NotNull Map<String, Object> map) {
        f8860i = (f8861w + 53) % IntBufferBatchMountItem.INSTRUCTION_UPDATE_LAYOUT;
        Intrinsics.checkNotNullParameter(map, "");
        AFf1cSDK.getMonetizationNetwork(map, this.areAllFieldsValid);
        int i10 = f8860i + 43;
        f8861w = i10 % IntBufferBatchMountItem.INSTRUCTION_UPDATE_LAYOUT;
        if (i10 % 2 != 0) {
            throw null;
        }
    }
    ...
    private String component2() {
        ...
        if (string == null) {
            f8860i = (f8861w + 75) % IntBufferBatchMountItem.INSTRUCTION_UPDATE_LAYOUT;
    ...
    private static /* synthetic */ Object component3(Object[] objArr) {
        ...
        f8860i = (f8861w + 85) % IntBufferBatchMountItem.INSTRUCTION_UPDATE_LAYOUT;
        Intrinsics.checkNotNullParameter(map, "");
        ...
        if (revenue != null) {
            int i12 = f8861w + 43;
            f8860i = i12 % IntBufferBatchMountItem.INSTRUCTION_UPDATE_LAYOUT;
            if (i12 % 2 == 0) {
    ...
    private boolean component4() {
        f8861w = (f8860i + 59) % IntBufferBatchMountItem.INSTRUCTION_UPDATE_LAYOUT;
        boolean parseBoolean = Boolean.parseBoolean(this.component1.getMonetizationNetwork("sentSuccessfully", null));
        f8861w = (f8860i + 69) % IntBufferBatchMountItem.INSTRUCTION_UPDATE_LAYOUT;
        return parseBoolean;
    }
    ...
    private final void copy(Map<String, Object> map) {
        ...
        f8860i = (f8861w + 63) % IntBufferBatchMountItem.INSTRUCTION_UPDATE_LAYOUT;
    }
    ...
    private void copydefault(@NotNull Map<String, Object> map) {
        ...
        if (currencyIso4217Code > 0) {
            ...
            f8861w = (f8860i + 13) % IntBufferBatchMountItem.INSTRUCTION_UPDATE_LAYOUT;
            j10 = -1;
        }
    ...
    private void d(@NotNull Map<String, Object> map) {
        ...
        if (this.component1.getRevenue("is_stop_tracking_used")) {
            f8860i = (f8861w + 49) % IntBufferBatchMountItem.INSTRUCTION_UPDATE_LAYOUT;
            map.put("istu", String.valueOf(this.component1.getMediationNetwork("is_stop_tracking_used", false)));
            f8860i = (f8861w + 79) % IntBufferBatchMountItem.INSTRUCTION_UPDATE_LAYOUT;
        }
        int i10 = f8860i + 125;
        f8861w = i10 % IntBufferBatchMountItem.INSTRUCTION_UPDATE_LAYOUT;
        if (i10 % 2 == 0) {
    ...
    /* JADX WARN: Code restructure failed: missing block: B:9:0x004f, code lost:
        r0 = com.appsflyer.internal.AFg1qSDK.f8860i + 33;
        com.appsflyer.internal.AFg1qSDK.f8861w = r0 % com.facebook.react.fabric.mounting.mountitems.IntBufferBatchMountItem.INSTRUCTION_UPDATE_LAYOUT;
     */
    /*
        Code decompiled incorrectly, please refer to instructions dump.
        To view partially-correct add '--show-bad-code' argument
    */
    private void e(@org.jetbrains.annotations.NotNull java.util.Map<java.lang.String, java.lang.Object> r4) {
        /*
            r3 = this;
            int r0 = com.appsflyer.internal.AFg1qSDK.f8861w
            int r0 = r0 + 5
            int r1 = r0 % 128
            com.appsflyer.internal.AFg1qSDK.f8860i = r1
            int r0 = r0 % 2
        ...
        L32:
            ...
            if (r0 != 0) goto L6a
        L4f:
            int r0 = com.appsflyer.internal.AFg1qSDK.f8860i
            int r0 = r0 + 33
            int r1 = r0 % 128
            com.appsflyer.internal.AFg1qSDK.f8861w = r1
            int r0 = r0 % 2
    ...
    */
    private final void equals(java.util.Map<java.lang.String, java.lang.Object> r4) {
        ...
        L23:
            ...
            r4.put(r2, r0)
        L36:
            int r4 = com.appsflyer.internal.AFg1qSDK.f8860i
            int r4 = r4 + 69
            int r0 = r4 % 128
            com.appsflyer.internal.AFg1qSDK.f8861w = r0
            int r4 = r4 % r1
            if (r4 != 0) goto L42
            return
        L42:
    ...
    private String getCurrencyIso4217Code(@NotNull SimpleDateFormat simpleDateFormat, int i10) {
        ...
        if (monetizationNetwork == null) {
            int i11 = f8860i + 125;
            f8861w = i11 % IntBufferBatchMountItem.INSTRUCTION_UPDATE_LAYOUT;
            if (i11 % 2 == 0 ? i10 > 1 : i10 > 0) {
                monetizationNetwork = "";
            } else {
                AFLogger.afDebugLog("AppsFlyer: first launch detected");
                String format = simpleDateFormat.format(new Date());
                f8861w = (f8860i + 121) % IntBufferBatchMountItem.INSTRUCTION_UPDATE_LAYOUT;
                monetizationNetwork = format;
            }
            this.component1.AFAdRevenueData("appsFlyerFirstInstall", monetizationNetwork);
            f8860i = (f8861w + 59) % IntBufferBatchMountItem.INSTRUCTION_UPDATE_LAYOUT;
        }
        ...
        switch (i13 + (((~(i14 | i15)) | (~(i14 | i10))) * 98) + (((~(i15 | (~i10))) | i14 | (~(i10 | i12))) * (-49)) + (((~(i10 | i11)) | (~(i12 | i14))) * 49)) {
            ...
            case 11:
                ...
                if (!aFg1qSDK.getMonetizationNetwork().getBoolean(AppsFlyerProperties.COLLECT_ANDROID_ID_FORCE_BY_USER, false)) {
                    f8860i = (f8861w + 57) % IntBufferBatchMountItem.INSTRUCTION_UPDATE_LAYOUT;
                    if (!aFg1qSDK.getMonetizationNetwork().getBoolean(AppsFlyerProperties.COLLECT_IMEI_FORCE_BY_USER, false)) {
                        f8861w = (f8860i + 81) % IntBufferBatchMountItem.INSTRUCTION_UPDATE_LAYOUT;
                ...
                f8861w = (f8860i + 93) % IntBufferBatchMountItem.INSTRUCTION_UPDATE_LAYOUT;
                return Boolean.TRUE;
            case 12:
                f8861w = (f8860i + 83) % IntBufferBatchMountItem.INSTRUCTION_UPDATE_LAYOUT;
                Long valueOf = Long.valueOf(((AFg1qSDK) objArr[0]).areAllFieldsValid.n_().firstInstallTime);
                f8860i = (f8861w + 45) % IntBufferBatchMountItem.INSTRUCTION_UPDATE_LAYOUT;
                return valueOf;
            default:
    ...
    private void i(@NotNull Map<String, Object> map) {
        ...
        f8860i = (f8861w + 97) % IntBufferBatchMountItem.INSTRUCTION_UPDATE_LAYOUT;
    ...
    private void registerClient(@NotNull Map<String, Object> map) {
        f8860i = (f8861w + 51) % IntBufferBatchMountItem.INSTRUCTION_UPDATE_LAYOUT;
        Intrinsics.checkNotNullParameter(map, "");
    ...
    private final void toString(Map<String, Object> map) {
        ...
        if (i10 % 2 == 0) {
            if (AFg1kSDK.AFAdRevenueData(this.getMediationNetwork)) {
                ...
                f8860i = (f8861w + 29) % IntBufferBatchMountItem.INSTRUCTION_UPDATE_LAYOUT;
                return;
            }
            return;
        }
    ...
    private void w(@NotNull Map<String, Object> map) {
        ...
        if (i10 % 2 == 0) {
            ...
            if (mediationNetwork != null && mediationNetwork.length() != 0) {
                int i11 = f8861w + 83;
                f8860i = i11 % IntBufferBatchMountItem.INSTRUCTION_UPDATE_LAYOUT;
                if (i11 % 2 != 0) {
    ...
    public final void AFAdRevenueData(@NotNull AFh1jSDK aFh1jSDK) {
        ...
        if (!this.areAllFieldsValid.component1()) {
            ...
            if (aFh1pSDK == null) {
                f8860i = (f8861w + 101) % IntBufferBatchMountItem.INSTRUCTION_UPDATE_LAYOUT;
                return;
            }
        ...
        if (i11 % 2 != 0) {
            ...
            int i12 = f8860i + 33;
            f8861w = i12 % IntBufferBatchMountItem.INSTRUCTION_UPDATE_LAYOUT;
            if (i12 % 2 != 0) {
                int i13 = 92 / 0;
                return;
            }
    ...
    public final void getRevenue(@NotNull Map<String, Object> map) {
        ...
        if (AFAdRevenueData != null) {
            ...
            if (!getMonetizationNetwork().getBoolean(AppsFlyerProperties.DISABLE_NETWORK_DATA, false)) {
                f8861w = (f8860i + 89) % IntBufferBatchMountItem.INSTRUCTION_UPDATE_LAYOUT;
                ...
                f8861w = (f8860i + 95) % IntBufferBatchMountItem.INSTRUCTION_UPDATE_LAYOUT;
            }
            int i10 = f8860i + 7;
            f8861w = i10 % IntBufferBatchMountItem.INSTRUCTION_UPDATE_LAYOUT;
            if (i10 % 2 != 0) {
    ...
    private static /* synthetic */ Object areAllFieldsValid(Object[] objArr) {
        ...
        if (!hashMap.isEmpty()) {
            int i10 = (f8860i + 111) % IntBufferBatchMountItem.INSTRUCTION_UPDATE_LAYOUT;
            f8861w = i10;
            int i11 = i10 + 31;
            f8860i = i11 % IntBufferBatchMountItem.INSTRUCTION_UPDATE_LAYOUT;
            if (i11 % 2 == 0) {
        ...
        f8861w = (f8860i + 29) % IntBufferBatchMountItem.INSTRUCTION_UPDATE_LAYOUT;
        return null;
    }
    ...
    public final void getMonetizationNetwork(@NotNull AFh1jSDK aFh1jSDK) {
        f8861w = (f8860i + 21) % IntBufferBatchMountItem.INSTRUCTION_UPDATE_LAYOUT;
        Intrinsics.checkNotNullParameter(aFh1jSDK, "");
        ...
        if (aFh1jSDK.getMonetizationNetwork()) {
            ...
            Intrinsics.checkNotNullExpressionValue(map, "");
            component1(map);
            f8860i = (f8861w + 81) % IntBufferBatchMountItem.INSTRUCTION_UPDATE_LAYOUT;
        }
        Intrinsics.checkNotNullExpressionValue(map, "");
        w(map);
    ...
    private static /* synthetic */ Object component2(Object[] objArr) {
        AFg1qSDK aFg1qSDK = (AFg1qSDK) objArr[0];
        f8861w = (f8860i + 79) % IntBufferBatchMountItem.INSTRUCTION_UPDATE_LAYOUT;
    ...
    private static /* synthetic */ Object component1(Object[] objArr) {
        ...
        if (str != null) {
            f8860i = (f8861w + 95) % IntBufferBatchMountItem.INSTRUCTION_UPDATE_LAYOUT;
            map.put("btch", str);
        }
        int i10 = f8860i + 31;
        f8861w = i10 % IntBufferBatchMountItem.INSTRUCTION_UPDATE_LAYOUT;
    ...
    private final String equals() {
        ...
        if (getMonetizationNetwork(AFAdRevenueData)) {
            ...
            f8861w = (f8860i + 51) % IntBufferBatchMountItem.INSTRUCTION_UPDATE_LAYOUT;
        }
        if (getMonetizationNetwork(AFAdRevenueData)) {
            f8860i = (f8861w + 101) % IntBufferBatchMountItem.INSTRUCTION_UPDATE_LAYOUT;
            return null;
    ...
    /* JADX WARN: Code restructure failed: missing block: B:14:0x0064, code lost:
        com.appsflyer.internal.AFg1qSDK.f8861w = (com.appsflyer.internal.AFg1qSDK.f8860i + 93) % com.facebook.react.fabric.mounting.mountitems.IntBufferBatchMountItem.INSTRUCTION_UPDATE_LAYOUT;
    ...
    */
    private static /* synthetic */ java.lang.Object copydefault(java.lang.Object[] r18) {
        ...
        L23:
            ...
            int r4 = r4 + 55
            int r7 = r4 % 128
            com.appsflyer.internal.AFg1qSDK.f8861w = r7
            int r4 = r4 % r3
    ...
    private final SimpleDateFormat getMediationNetwork() {
        f8861w = (f8860i + 87) % IntBufferBatchMountItem.INSTRUCTION_UPDATE_LAYOUT;
    ...
    public final void getMediationNetwork(@NotNull AFh1jSDK aFh1jSDK) {
        f8861w = (f8860i + 55) % IntBufferBatchMountItem.INSTRUCTION_UPDATE_LAYOUT;
        Intrinsics.checkNotNullParameter(aFh1jSDK, "");
        Map<String, Object> map = aFh1jSDK.getCurrencyIso4217Code;
        Intrinsics.checkNotNullExpressionValue(map, "");
        AFAdRevenueData(map);
    ...
    public final void getCurrencyIso4217Code(@NotNull Map<String, Object> map, int i10, int i11) {
        ...
        if (component4()) {
            f8861w = (f8860i + 61) % IntBufferBatchMountItem.INSTRUCTION_UPDATE_LAYOUT;
            z10 = false;
        } else {
            f8860i = (f8861w + 115) % IntBufferBatchMountItem.INSTRUCTION_UPDATE_LAYOUT;
            z10 = true;
        }
        map.put("isFirstCall", String.valueOf(z10));
        f8860i = (f8861w + 37) % IntBufferBatchMountItem.INSTRUCTION_UPDATE_LAYOUT;
    }
    ...
    /* JADX WARN: Code restructure failed: missing block: B:11:0x007a, code lost:
        r8 = com.appsflyer.internal.AFg1qSDK.f8860i + 85;
        com.appsflyer.internal.AFg1qSDK.f8861w = r8 % com.facebook.react.fabric.mounting.mountitems.IntBufferBatchMountItem.INSTRUCTION_UPDATE_LAYOUT;
     */
    ...
    */
    private void getCurrencyIso4217Code(@org.jetbrains.annotations.NotNull java.util.Map<java.lang.String, java.lang.Object> r7, boolean r8) {
        /*
            ...
            r0.put(r2, r1)
            if (r8 == 0) goto L9a
            int r8 = com.appsflyer.internal.AFg1qSDK.f8861w
            int r8 = r8 + 41
            int r1 = r8 % 128
            com.appsflyer.internal.AFg1qSDK.f8860i = r1
            r1 = 2
        ...
        L64:
            ...
            if (r8 > r1) goto L9a
        L7a:
            int r8 = com.appsflyer.internal.AFg1qSDK.f8860i
            int r8 = r8 + 85
            int r2 = r8 % 128
            com.appsflyer.internal.AFg1qSDK.f8861w = r2
            int r8 = r8 % r1
            if (r8 != 0) goto L8f
    ...
    public final void getMonetizationNetwork(@NotNull Map<String, Object> map) {
        Object b10;
        f8860i = (f8861w + 27) % IntBufferBatchMountItem.INSTRUCTION_UPDATE_LAYOUT;
        Intrinsics.checkNotNullParameter(map, "");
        ...
        if (str != null) {
            ...
            if (i10 % 2 == 0) {
                if (map.get("af_deeplink") != null) {
                    ...
                    if (e10 != null) {
                        f8860i = (f8861w + 123) % IntBufferBatchMountItem.INSTRUCTION_UPDATE_LAYOUT;
        ...
        f8861w = (f8860i + 53) % IntBufferBatchMountItem.INSTRUCTION_UPDATE_LAYOUT;
    }
    ...
    private static List<AFe1mSDK> copydefault() {
        f8861w = (f8860i + 103) % IntBufferBatchMountItem.INSTRUCTION_UPDATE_LAYOUT;
        ...
        f8861w = (f8860i + 67) % IntBufferBatchMountItem.INSTRUCTION_UPDATE_LAYOUT;
        return o10;
    }

    @Override // com.appsflyer.internal.AFg1rSDK
    public final void getMediationNetwork(@NotNull Map<String, Object> map) {
        f8860i = (f8861w + 77) % IntBufferBatchMountItem.INSTRUCTION_UPDATE_LAYOUT;
        Intrinsics.checkNotNullParameter(map, "");
    ...
    private final void getCurrencyIso4217Code(Map<String, Object> map, int i10) {
        f8861w = (f8860i + 75) % IntBufferBatchMountItem.INSTRUCTION_UPDATE_LAYOUT;
        try {
    ...
    private void AFAdRevenueData(@NotNull Map<String, Object> map, int i10) {
        ...
        if (AFAdRevenueData == null || Intrinsics.areEqual(AFAdRevenueData, areAllFieldsValid)) {
            ...
            f8860i = (f8861w + 17) % IntBufferBatchMountItem.INSTRUCTION_UPDATE_LAYOUT;
            z10 = true;
        }
        if (AFAdRevenueData == null) {
            int i11 = f8860i + 79;
    ...
    public final void getCurrencyIso4217Code(@NotNull AFh1jSDK aFh1jSDK) {
        f8860i = (f8861w + 1) % IntBufferBatchMountItem.INSTRUCTION_UPDATE_LAYOUT;
        Intrinsics.checkNotNullParameter(aFh1jSDK, "");
        Map<String, Object> map = aFh1jSDK.getCurrencyIso4217Code;
        Intrinsics.checkNotNullExpressionValue(map, "");
    ...
    private String getMonetizationNetwork(int i10) {
        ...
        if (i11 % 2 == 0) {
            ...
            if (i10 <= 1) {
                ...
                int i12 = (f8861w + 117) % IntBufferBatchMountItem.INSTRUCTION_UPDATE_LAYOUT;
                f8860i = i12;
                f8861w = (i12 + 23) % IntBufferBatchMountItem.INSTRUCTION_UPDATE_LAYOUT;
            }
    ...
    private void AFAdRevenueData(@NotNull Map<String, Object> map, boolean z10) {
        ...
        if (z10) {
            ...
            f8861w = (f8860i + 125) % IntBufferBatchMountItem.INSTRUCTION_UPDATE_LAYOUT;
        }
    }

    private static void getMonetizationNetwork(@NotNull Map<String, Object> map, String str) {
        f8860i = (f8861w + 43) % IntBufferBatchMountItem.INSTRUCTION_UPDATE_LAYOUT;
        Intrinsics.checkNotNullParameter(map, "");
        if (str != null) {
            f8860i = (f8861w + 77) % IntBufferBatchMountItem.INSTRUCTION_UPDATE_LAYOUT;
            map.put("phone", str);
            f8861w = (f8860i + 1) % IntBufferBatchMountItem.INSTRUCTION_UPDATE_LAYOUT;
        }
    }
    ...
    private String AFAdRevenueData(int i10) {
        ...
        if (this.component1.getRevenue("preInstallName")) {
            ...
            if (i10 <= 1) {
                int i13 = f8860i + 99;
                f8861w = i13 % IntBufferBatchMountItem.INSTRUCTION_UPDATE_LAYOUT;
                if (i13 % 2 == 0) {
                    String equals = equals();
                    if (equals == null) {
                        int i14 = f8861w + 19;
                        f8860i = i14 % IntBufferBatchMountItem.INSTRUCTION_UPDATE_LAYOUT;
                        if (i14 % 2 != 0) {
        ...
        if (str != null) {
            f8860i = (f8861w + 73) % IntBufferBatchMountItem.INSTRUCTION_UPDATE_LAYOUT;
    ...
    private static boolean getMonetizationNetwork(File file) {
        ...
        f8860i = (f8861w + 39) % IntBufferBatchMountItem.INSTRUCTION_UPDATE_LAYOUT;
        return false;
    }
    ...
    */
    private static java.lang.String getMonetizationNetwork(java.io.File r5, java.lang.String r6) {
        /*
            ...
            int r1 = r0 + 87
            int r2 = r1 % 128
            com.appsflyer.internal.AFg1qSDK.f8860i = r2
            int r1 = r1 % 2
            r2 = 0
            if (r1 == 0) goto L92
            if (r5 != 0) goto L1e
            int r0 = r0 + 39
            int r5 = r0 % 128
            com.appsflyer.internal.AFg1qSDK.f8860i = r5
            int r0 = r0 % 2
            if (r0 != 0) goto L1d
            r5 = 58
            int r5 = r5 / 0
    ...
    public final void getCurrencyIso4217Code(@NotNull Map<String, Object> map) {
        String[] strArr;
        f8861w = (f8860i + 15) % IntBufferBatchMountItem.INSTRUCTION_UPDATE_LAYOUT;
        Intrinsics.checkNotNullParameter(map, "");
    ...
    private void AFAdRevenueData(@NotNull Map<String, Object> map, String str) {
        ...
        if (i10 % 2 != 0) {
            ...
            f8861w = (f8860i + 17) % IntBufferBatchMountItem.INSTRUCTION_UPDATE_LAYOUT;
            return;
        }
        Intrinsics.checkNotNullParameter(map, "");
        throw null;
    ...
    private static /* synthetic */ Object getCurrencyIso4217Code(Object[] objArr) {
        AFg1qSDK aFg1qSDK = (AFg1qSDK) objArr[0];
        f8860i = (f8861w + 55) % IntBufferBatchMountItem.INSTRUCTION_UPDATE_LAYOUT;
    ...
    public final long getCurrencyIso4217Code() {
        f8861w = (f8860i + 7) % IntBufferBatchMountItem.INSTRUCTION_UPDATE_LAYOUT;
        long currentTimeMillis = System.currentTimeMillis();
        f8860i = (f8861w + 105) % IntBufferBatchMountItem.INSTRUCTION_UPDATE_LAYOUT;
        return currentTimeMillis;
    }
    ...
    private void getCurrencyIso4217Code(@NotNull AFh1jSDK aFh1jSDK, String str, String str2, AFb1rSDK aFb1rSDK) {
        ...
        if (aFh1jSDK.getCurrencyIso4217Code() == AFe1mSDK.CONVERSION) {
            f8860i = (f8861w + 13) % IntBufferBatchMountItem.INSTRUCTION_UPDATE_LAYOUT;
            Intrinsics.checkNotNullExpressionValue(map, "");
            equals(map);
            copy(map);
            toString(map);
    ...
    private static String AFAdRevenueData(AFc1oSDK aFc1oSDK, String str) {
        f8861w = (f8860i + 77) % IntBufferBatchMountItem.INSTRUCTION_UPDATE_LAYOUT;
    ...
    private static File AFAdRevenueData(String str) {
        ...
        f8861w = (f8860i + 5) % IntBufferBatchMountItem.INSTRUCTION_UPDATE_LAYOUT;
        return null;
    }
    ...
    private final String getCurrencyIso4217Code(String str) {
        f8861w = (f8860i + 63) % IntBufferBatchMountItem.INSTRUCTION_UPDATE_LAYOUT;
