...
public final class AFb1jSDK {
    ...
    public static final synchronized void getCurrencyIso4217Code(@NotNull String str, @NotNull AFc1oSDK aFc1oSDK) {
    ...
    @NotNull
    public static final synchronized String getRevenue(@NotNull AFc1oSDK aFc1oSDK) {
        String str;
        synchronized (AFb1jSDK.class) {
            try {
                Intrinsics.checkNotNullParameter(aFc1oSDK, "");
