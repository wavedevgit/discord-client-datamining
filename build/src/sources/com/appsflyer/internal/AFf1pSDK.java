...
public final class AFf1pSDK extends AFf1uSDK {
    ...
    */
    ...
    private void equals() {
        unregisterClient = (f9255d + 41) % IntBufferBatchMountItem.INSTRUCTION_UPDATE_LAYOUT;
        ...
        unregisterClient = (f9255d + 9) % IntBufferBatchMountItem.INSTRUCTION_UPDATE_LAYOUT;
    }
    ...
    private static /* synthetic */ Object getMonetizationNetwork(Object[] objArr) {
        ...
        if (applicationInfo == null) {
            ...
            f9255d = i10 % IntBufferBatchMountItem.INSTRUCTION_UPDATE_LAYOUT;
            if (i10 % 2 == 0) {
                return "";
            }
            throw null;
    ...
    protected final void areAllFieldsValid(AFh1jSDK aFh1jSDK) {
        ...
        if (i10 % 2 == 0) {
            ...
            if (component4 != null) {
                ...
                unregisterClient = (f9255d + 35) % IntBufferBatchMountItem.INSTRUCTION_UPDATE_LAYOUT;
                return;
            }
            return;
        }
    ...
    protected final void getCurrencyIso4217Code(AFh1jSDK aFh1jSDK) {
        f9255d = (unregisterClient + 53) % IntBufferBatchMountItem.INSTRUCTION_UPDATE_LAYOUT;
    }

    @Override // com.appsflyer.internal.AFe1eSDK, com.appsflyer.internal.AFe1lSDK
    public final void getRevenue() {
        f9255d = (unregisterClient + 55) % IntBufferBatchMountItem.INSTRUCTION_UPDATE_LAYOUT;
        super.getRevenue();
        ResponseNetwork responseNetwork = ((AFe1eSDK) this).component3;
        if (responseNetwork != null && responseNetwork.isSuccessful()) {
            equals();
        }
        unregisterClient = (f9255d + 49) % IntBufferBatchMountItem.INSTRUCTION_UPDATE_LAYOUT;
    }
    ...
    */
    ...
    protected final void getMonetizationNetwork(AFh1jSDK aFh1jSDK) {
        unregisterClient = (f9255d + 103) % IntBufferBatchMountItem.INSTRUCTION_UPDATE_LAYOUT;
    }
    ...
    private static /* synthetic */ Object getMediationNetwork(Object[] objArr) {
        ...
        int i10 = (f9255d + 35) % IntBufferBatchMountItem.INSTRUCTION_UPDATE_LAYOUT;
        unregisterClient = i10;
        int i11 = i10 + 69;
        f9255d = i11 % IntBufferBatchMountItem.INSTRUCTION_UPDATE_LAYOUT;
        if (i11 % 2 != 0) {
            int i12 = 75 / 0;
