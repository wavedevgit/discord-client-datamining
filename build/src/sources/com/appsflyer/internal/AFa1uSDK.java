...
public final class AFa1uSDK extends AppsFlyerLib {
    ...
    /* loaded from: /home/runner/work/discord-client-datamining/discord-client-datamining/build/classes.dex */
    public class C0139AFa1uSDK implements AFe1sSDK {
        C0139AFa1uSDK() {
        }
                ...
                if (afLogForce != null && z10) {
                    afLogForce.getMonetizationNetwork((AFf1rSDK) aFe1lSDK, new Function0() { // from class: com.appsflyer.internal.i
                        ...
                        public final Object invoke() {
                            ...
                            monetizationNetwork = AFa1uSDK.C0139AFa1uSDK.this.getMonetizationNetwork();
    ...
    public AFa1uSDK() {
        ...
        copydefault.getMonetizationNetwork.add(new C0139AFa1uSDK());
    }
    ...
    public /* synthetic */ void AFAdRevenueData(AFf1oSDK aFf1oSDK) {
        ...
        if (i10 % 2 == 0) {
            ...
            if (aFf1oSDK == AFf1oSDK.SUCCESS) {
                ...
                f8845d = i11 % IntBufferBatchMountItem.INSTRUCTION_UPDATE_LAYOUT;
                if (i11 % 2 != 0) {
            ...
            if (!aFc1bSDK.equals().getCurrencyIso4217Code()) {
                f8845d = (AFKeystoreWrapper + 77) % IntBufferBatchMountItem.INSTRUCTION_UPDATE_LAYOUT;
    ...
    private static /* synthetic */ Object areAllFieldsValid(Object[] objArr) {
        ...
        if (i10 % 2 == 0) {
            ...
            if (!list.contains(asList)) {
                list.add(asList);
                f8845d = (AFKeystoreWrapper + 71) % IntBufferBatchMountItem.INSTRUCTION_UPDATE_LAYOUT;
            }
            return null;
        }
    ...
    private static void c_(Context context, PackageInfo packageInfo) {
        try {
            ...
            if (applicationInfo != null) {
                ...
                f8845d = i10 % IntBufferBatchMountItem.INSTRUCTION_UPDATE_LAYOUT;
                if (i10 % 2 != 0) {
                    if ((applicationInfo.flags & PeerConnection.PORTALLOCATOR_ENABLE_ANY_ADDRESS_PORTS) != 0) {
                        if (Build.VERSION.SDK_INT >= 31) {
                            if (context.getResources().getIdentifier("appsflyer_data_extraction_rules", "xml", context.getPackageName()) != 0) {
                                ...
                                AFKeystoreWrapper = (f8845d + 109) % IntBufferBatchMountItem.INSTRUCTION_UPDATE_LAYOUT;
                                return;
                            }
        ...
        if (i11 % 2 != 0) {
            ...
            if (context != null) {
                ...
                while (i10 < length) {
                    ...
                    f8845d = i12 % IntBufferBatchMountItem.INSTRUCTION_UPDATE_LAYOUT;
                    if (i12 % 2 == 0) {
                ...
                if (!AFLogger2.getMediationNetwork()) {
                    ...
                    f8845d = (AFKeystoreWrapper + 47) % IntBufferBatchMountItem.INSTRUCTION_UPDATE_LAYOUT;
                }
            } else {
    ...
    private static /* synthetic */ Object component2(Object[] objArr) {
        int i10 = (f8845d + 45) % IntBufferBatchMountItem.INSTRUCTION_UPDATE_LAYOUT;
    ...
    private static /* synthetic */ Object component3(Object[] objArr) {
        f8845d = (AFKeystoreWrapper + 59) % IntBufferBatchMountItem.INSTRUCTION_UPDATE_LAYOUT;
    ...
    public static AFa1uSDK getMonetizationNetwork() {
        int i10 = (f8845d + 87) % IntBufferBatchMountItem.INSTRUCTION_UPDATE_LAYOUT;
        AFKeystoreWrapper = i10;
        AFa1uSDK aFa1uSDK = areAllFieldsValid;
        f8845d = (i10 + 85) % IntBufferBatchMountItem.INSTRUCTION_UPDATE_LAYOUT;
        return aFa1uSDK;
    }
    ...
    public static /* synthetic */ Object getRevenue(Object[] objArr, int i10, int i11, int i12) {
        ...
        switch (i13 + (((~i15) | i14) * (-668)) + ((i10 | (~(i12 | i14))) * 1336) + ((i15 | i14) * 668)) {
            ...
            case 2:
                f8845d = (AFKeystoreWrapper + 89) % IntBufferBatchMountItem.INSTRUCTION_UPDATE_LAYOUT;
                ((AFa1uSDK) objArr[0]).setSharingFilterForPartners((String[]) objArr[1]);
                f8845d = (AFKeystoreWrapper + 21) % IntBufferBatchMountItem.INSTRUCTION_UPDATE_LAYOUT;
                return null;
            case 3:
                AFa1uSDK aFa1uSDK = (AFa1uSDK) objArr[0];
                boolean booleanValue = ((Boolean) objArr[1]).booleanValue();
                ...
                AFKeystoreWrapper = (f8845d + 105) % IntBufferBatchMountItem.INSTRUCTION_UPDATE_LAYOUT;
                return null;
            case 4:
            ...
            case 6:
                ...
                f8845d = (AFKeystoreWrapper + 61) % IntBufferBatchMountItem.INSTRUCTION_UPDATE_LAYOUT;
                ((AFa1uSDK) objArr[0]).component2 = TimeUnit.SECONDS.toMillis(intValue);
                AFKeystoreWrapper = (f8845d + 111) % IntBufferBatchMountItem.INSTRUCTION_UPDATE_LAYOUT;
                return null;
            case 7:
            ...
            case 10:
                f8845d = (AFKeystoreWrapper + 7) % IntBufferBatchMountItem.INSTRUCTION_UPDATE_LAYOUT;
                ((AFa1uSDK) objArr[0]).logEvent((Context) objArr[1], (String) objArr[2], (Map) objArr[3], null);
                f8845d = (AFKeystoreWrapper + 119) % IntBufferBatchMountItem.INSTRUCTION_UPDATE_LAYOUT;
                return null;
            case 11:
            ...
            case 12:
                ...
                f8845d = (AFKeystoreWrapper + 69) % IntBufferBatchMountItem.INSTRUCTION_UPDATE_LAYOUT;
                return null;
            case 13:
            ...
            case 20:
                ...
                AFKeystoreWrapper = (f8845d + 31) % IntBufferBatchMountItem.INSTRUCTION_UPDATE_LAYOUT;
                return null;
            ...
            case ChatViewRecyclerTypes.SURVEY_INDICATION /* 24 */:
                ...
                AFKeystoreWrapper = (f8845d + 5) % IntBufferBatchMountItem.INSTRUCTION_UPDATE_LAYOUT;
                ...
                AFKeystoreWrapper = (f8845d + 65) % IntBufferBatchMountItem.INSTRUCTION_UPDATE_LAYOUT;
                return null;
            default:
                AFa1uSDK aFa1uSDK7 = (AFa1uSDK) objArr[0];
                boolean booleanValue3 = ((Boolean) objArr[1]).booleanValue();
                int i20 = AFKeystoreWrapper + 57;
                f8845d = i20 % IntBufferBatchMountItem.INSTRUCTION_UPDATE_LAYOUT;
                if (i20 % 2 == 0) {
    ...
    */
    private static /* synthetic */ java.lang.Object hashCode(java.lang.Object[] r10) {
        /*
            ...
            int r7 = r7 + 35
            int r8 = r7 % 128
            com.appsflyer.internal.AFa1uSDK.f8845d = r8
            int r7 = r7 % r4
        ...
        L64:
            ...
            int r8 = r8 + 7
            int r9 = r8 % 128
            com.appsflyer.internal.AFa1uSDK.f8845d = r9
            int r8 = r8 % r4
            if (r8 == 0) goto L84
            java.lang.String r7 = r7.toString()
            boolean r7 = r7.isEmpty()
            if (r7 != 0) goto L8c
            int r7 = com.appsflyer.internal.AFa1uSDK.f8845d
            int r7 = r7 + 93
            int r7 = r7 % 128
        ...
        L8d:
            ...
            int r10 = r10 + 93
            int r1 = r10 % 128
            com.appsflyer.internal.AFa1uSDK.f8845d = r1
            int r10 = r10 % r4
    ...
    public final void appendParametersToDeepLinkingURL(String str, Map<String, String> map) {
        ...
        if (i10 % 2 == 0) {
            ...
            f8845d = (AFKeystoreWrapper + 99) % IntBufferBatchMountItem.INSTRUCTION_UPDATE_LAYOUT;
            return;
        }
    ...
    public final void enableFacebookDeferredApplinks(boolean z10) {
        ...
        f8845d = (AFKeystoreWrapper + 73) % IntBufferBatchMountItem.INSTRUCTION_UPDATE_LAYOUT;
    }
    ...
    /* JADX WARN: Code restructure failed: missing block: B:9:0x0048, code lost:
        com.appsflyer.internal.AFa1uSDK.AFKeystoreWrapper = (com.appsflyer.internal.AFa1uSDK.f8845d + 115) % com.facebook.react.fabric.mounting.mountitems.IntBufferBatchMountItem.INSTRUCTION_UPDATE_LAYOUT;
     */
    @Override // com.appsflyer.AppsFlyerLib
    /*
        Code decompiled incorrectly, please refer to instructions dump.
    ...
    */
    public final java.lang.String getAppsFlyerUID(@androidx.annotation.NonNull android.content.Context r7) {
        /*
            r6 = this;
            int r0 = com.appsflyer.internal.AFa1uSDK.f8845d
            int r0 = r0 + 55
            int r1 = r0 % 128
    ...
    public final void getMediationNetwork(@NonNull Context context) {
        int i10 = (f8845d + 37) % IntBufferBatchMountItem.INSTRUCTION_UPDATE_LAYOUT;
        AFKeystoreWrapper = i10;
    ...
    public final String getSdkVersion() {
        f8845d = (AFKeystoreWrapper + 105) % IntBufferBatchMountItem.INSTRUCTION_UPDATE_LAYOUT;
    ...
    public final boolean isPreInstalledApp(Context context) {
        f8845d = (AFKeystoreWrapper + 35) % IntBufferBatchMountItem.INSTRUCTION_UPDATE_LAYOUT;
        getMediationNetwork(context);
        ...
        f8845d = (AFKeystoreWrapper + 15) % IntBufferBatchMountItem.INSTRUCTION_UPDATE_LAYOUT;
    ...
    public final void logSession(Context context) {
        f8845d = (AFKeystoreWrapper + 25) % IntBufferBatchMountItem.INSTRUCTION_UPDATE_LAYOUT;
    ...
    /* JADX WARN: Code restructure failed: missing block: B:9:0x0050, code lost:
        com.appsflyer.internal.AFa1uSDK.f8845d = (com.appsflyer.internal.AFa1uSDK.AFKeystoreWrapper + 9) % com.facebook.react.fabric.mounting.mountitems.IntBufferBatchMountItem.INSTRUCTION_UPDATE_LAYOUT;
    ...
    */
    public final void registerValidatorListener(android.content.Context r7, com.appsflyer.AppsFlyerInAppPurchaseValidatorListener r8) {
        /*
            ...
            int r7 = r7 + 97
            int r0 = r7 % 128
            com.appsflyer.internal.AFa1uSDK.f8845d = r0
            int r7 = r7 % 2
        ...
        L50:
            ...
            int r7 = r7 + 9
            int r7 = r7 % 128
            com.appsflyer.internal.AFa1uSDK.f8845d = r7
    ...
    public final void sendPurchaseData(Context context, Map<String, Object> map, PurchaseHandler.PurchaseValidationCallback purchaseValidationCallback) {
        ...
        if (areAllFieldsValid2.getMonetizationNetwork(map, purchaseValidationCallback, "subscriptions")) {
            ...
            f8845d = (AFKeystoreWrapper + 91) % IntBufferBatchMountItem.INSTRUCTION_UPDATE_LAYOUT;
        }
    }
    ...
    /* JADX WARN: Code restructure failed: missing block: B:10:0x0029, code lost:
        ...
        com.appsflyer.internal.AFa1uSDK.f8845d = (com.appsflyer.internal.AFa1uSDK.AFKeystoreWrapper + 85) % com.facebook.react.fabric.mounting.mountitems.IntBufferBatchMountItem.INSTRUCTION_UPDATE_LAYOUT;
     */
    ...
    */
    ...
    public final void setAdditionalData(Map<String, Object> map) {
        AFKeystoreWrapper = (f8845d + 23) % IntBufferBatchMountItem.INSTRUCTION_UPDATE_LAYOUT;
        if (map != null) {
        ...
        f8845d = (AFKeystoreWrapper + 9) % IntBufferBatchMountItem.INSTRUCTION_UPDATE_LAYOUT;
    }
    ...
    public final void setAndroidIdData(String str) {
        ...
        AFKeystoreWrapper = (f8845d + 53) % IntBufferBatchMountItem.INSTRUCTION_UPDATE_LAYOUT;
    }
    ...
    public final void setAppId(String str) {
        ...
        AFKeystoreWrapper = (f8845d + 89) % IntBufferBatchMountItem.INSTRUCTION_UPDATE_LAYOUT;
    }
    ...
    public final void setAppInviteOneLink(String str) {
        ...
        AFKeystoreWrapper = (f8845d + 91) % IntBufferBatchMountItem.INSTRUCTION_UPDATE_LAYOUT;
    }
    ...
    public final void setCollectIMEI(boolean z10) {
        f8845d = (AFKeystoreWrapper + 111) % IntBufferBatchMountItem.INSTRUCTION_UPDATE_LAYOUT;
        ...
        AFKeystoreWrapper = (f8845d + 115) % IntBufferBatchMountItem.INSTRUCTION_UPDATE_LAYOUT;
    }

    @Override // com.appsflyer.AppsFlyerLib
    @Deprecated
    public final void setCollectOaid(boolean z10) {
        AFKeystoreWrapper = (f8845d + 43) % IntBufferBatchMountItem.INSTRUCTION_UPDATE_LAYOUT;
        ...
        f8845d = (AFKeystoreWrapper + 55) % IntBufferBatchMountItem.INSTRUCTION_UPDATE_LAYOUT;
    }

    @Override // com.appsflyer.AppsFlyerLib
    public final void setConsentData(@NonNull AppsFlyerConsent appsFlyerConsent) {
        f8845d = (AFKeystoreWrapper + 117) % IntBufferBatchMountItem.INSTRUCTION_UPDATE_LAYOUT;
        ...
        f8845d = (AFKeystoreWrapper + 63) % IntBufferBatchMountItem.INSTRUCTION_UPDATE_LAYOUT;
    }
    ...
    public final void setCurrencyCode(String str) {
        ...
        AFKeystoreWrapper = (f8845d + 15) % IntBufferBatchMountItem.INSTRUCTION_UPDATE_LAYOUT;
    }
    ...
    public final void setCustomerIdAndLogSession(String str, @NonNull Context context) {
        if (context != null) {
            ...
            if (i10 % 2 == 0) {
                ...
                f8845d = (AFKeystoreWrapper + 51) % IntBufferBatchMountItem.INSTRUCTION_UPDATE_LAYOUT;
                return;
            }
            getRevenue();
            throw null;
    ...
    public final void setCustomerUserId(String str) {
        ...
        f8845d = (AFKeystoreWrapper + 5) % IntBufferBatchMountItem.INSTRUCTION_UPDATE_LAYOUT;
    }
    ...
    public final void setDebugLog(boolean z10) {
        ...
        f8845d = (AFKeystoreWrapper + 3) % IntBufferBatchMountItem.INSTRUCTION_UPDATE_LAYOUT;
    }
    ...
    */
    public final void setDisableAdvertisingIdentifiers(boolean r5) {
        ...
        L2e:
            ...
            r1.component3 = r5
            if (r5 == 0) goto L78
            int r5 = com.appsflyer.internal.AFa1uSDK.f8845d
            int r5 = r5 + 109
            int r1 = r5 % 128
            com.appsflyer.internal.AFa1uSDK.AFKeystoreWrapper = r1
            int r5 = r5 % 2
    ...
    public final void setExtension(String str) {
        AFKeystoreWrapper = (f8845d + 9) % IntBufferBatchMountItem.INSTRUCTION_UPDATE_LAYOUT;
    ...
    /* JADX WARN: Code restructure failed: missing block: B:18:0x008b, code lost:
        ...
        com.appsflyer.internal.AFa1uSDK.f8845d = r7 % com.facebook.react.fabric.mounting.mountitems.IntBufferBatchMountItem.INSTRUCTION_UPDATE_LAYOUT;
     */
    ...
    /* JADX WARN: Code restructure failed: missing block: B:9:0x004c, code lost:
        ...
        r7 = com.appsflyer.internal.AFa1uSDK.f8845d + 57;
    ...
    */
    ...
    public final void setLogLevel(@NonNull AFLogger.LogLevel logLevel) {
        ...
        if (logLevel.getLevel() > AFLogger.LogLevel.NONE.getLevel()) {
            AFKeystoreWrapper = (f8845d + 125) % IntBufferBatchMountItem.INSTRUCTION_UPDATE_LAYOUT;
            z10 = true;
        } else {
            AFKeystoreWrapper = (f8845d + 43) % IntBufferBatchMountItem.INSTRUCTION_UPDATE_LAYOUT;
            z10 = false;
    ...
    public final void setPreinstallAttribution(String str, String str2, String str3) {
        ...
        try {
            ...
            if (str2 != null) {
                ...
                AFKeystoreWrapper = (f8845d + 69) % IntBufferBatchMountItem.INSTRUCTION_UPDATE_LAYOUT;
            }
            if (str3 != null) {
        ...
        if (jSONObject.has("pid")) {
            AFKeystoreWrapper = (f8845d + 77) % IntBufferBatchMountItem.INSTRUCTION_UPDATE_LAYOUT;
    ...
    public final void setResolveDeepLinkURLs(String... strArr) {
        AFKeystoreWrapper = (f8845d + 51) % IntBufferBatchMountItem.INSTRUCTION_UPDATE_LAYOUT;
        ...
        f8845d = (AFKeystoreWrapper + 37) % IntBufferBatchMountItem.INSTRUCTION_UPDATE_LAYOUT;
    }
    ...
    public final void setSharingFilterForAllPartners() {
        AFKeystoreWrapper = (f8845d + 113) % IntBufferBatchMountItem.INSTRUCTION_UPDATE_LAYOUT;
    ...
    public final void start(@NonNull Context context) {
        ...
        if (i10 % 2 == 0) {
            start(context, null);
            AFKeystoreWrapper = (f8845d + 61) % IntBufferBatchMountItem.INSTRUCTION_UPDATE_LAYOUT;
            return;
        }
        start(context, null);
        throw null;
    ...
    public final void validateAndLogInAppPurchase(Context context, String str, String str2, String str3, String str4, String str5, Map<String, String> map) {
        ...
        if (str != null && str4 != null) {
            ...
            f8845d = (i10 + 55) % IntBufferBatchMountItem.INSTRUCTION_UPDATE_LAYOUT;
            if (str2 != null) {
                int i11 = i10 + 105;
    ...
    public final void waitForCustomerUserId(boolean z10) {
        ...
        f8845d = (AFKeystoreWrapper + 107) % IntBufferBatchMountItem.INSTRUCTION_UPDATE_LAYOUT;
    }
    ...
    */
    ...
    public final void getMonetizationNetwork(Context context, String str) {
        ...
        try {
            ...
            if (jSONArray2.length() < 5) {
                ...
                AFKeystoreWrapper = (f8845d + 57) % IntBufferBatchMountItem.INSTRUCTION_UPDATE_LAYOUT;
            }
    ...
    public /* synthetic */ void copy() {
        ...
        if (i10 % 2 != 0) {
            ...
            if (Build.VERSION.SDK_INT >= 31) {
                ...
                AFKeystoreWrapper = (f8845d + 67) % IntBufferBatchMountItem.INSTRUCTION_UPDATE_LAYOUT;
            }
            ...
            if (mediationNetwork == 1 && component3.getCurrencyIso4217Code.getRevenue("first_launch")) {
                AFKeystoreWrapper = (f8845d + 71) % IntBufferBatchMountItem.INSTRUCTION_UPDATE_LAYOUT;
            ...
            if (mediationNetwork > 0 && component3.getCurrencyIso4217Code.getRevenue("gcd")) {
                AFKeystoreWrapper = (f8845d + 75) % IntBufferBatchMountItem.INSTRUCTION_UPDATE_LAYOUT;
    ...
    public final void start(@NonNull Context context, String str) {
        f8845d = (AFKeystoreWrapper + 1) % IntBufferBatchMountItem.INSTRUCTION_UPDATE_LAYOUT;
        start(context, str, null);
        f8845d = (AFKeystoreWrapper + 29) % IntBufferBatchMountItem.INSTRUCTION_UPDATE_LAYOUT;
    }
    ...
    public final void start(@NonNull Context context, String str, final AppsFlyerRequestListener appsFlyerRequestListener) {
        ...
        if (this.component3 == null) {
            ...
            f8845d = (AFKeystoreWrapper + 109) % IntBufferBatchMountItem.INSTRUCTION_UPDATE_LAYOUT;
            this.component3 = O_;
        }
        ...
        if (!TextUtils.isEmpty(str)) {
            ...
            f8845d = i13 % IntBufferBatchMountItem.INSTRUCTION_UPDATE_LAYOUT;
            if (i13 % 2 == 0) {
                copydefault();
                int i14 = 69 / 0;
                if (appsFlyerRequestListener == null) {
            ...
            AFKeystoreWrapper = (f8845d + 29) % IntBufferBatchMountItem.INSTRUCTION_UPDATE_LAYOUT;
            appsFlyerRequestListener.onError(41, "No dev key");
            return;
        }
    ...
    private boolean areAllFieldsValid() {
        f8845d = (AFKeystoreWrapper + 19) % IntBufferBatchMountItem.INSTRUCTION_UPDATE_LAYOUT;
        if (this.component4 > 0) {
            ...
            if (currentTimeMillis < this.component2 && !isStopped()) {
                ...
                AFKeystoreWrapper = (f8845d + 97) % IntBufferBatchMountItem.INSTRUCTION_UPDATE_LAYOUT;
    ...
    private static /* synthetic */ Object getMediationNetwork(Object[] objArr) {
        ...
        if (currencyIso4217Code != null) {
            f8845d = (AFKeystoreWrapper + 87) % IntBufferBatchMountItem.INSTRUCTION_UPDATE_LAYOUT;
            ...
            if (AppsFlyerProperties.getInstance().AFAdRevenueData()) {
                ...
                AFKeystoreWrapper = (f8845d + 55) % IntBufferBatchMountItem.INSTRUCTION_UPDATE_LAYOUT;
            }
        }
        int i11 = f8845d + 35;
        AFKeystoreWrapper = i11 % IntBufferBatchMountItem.INSTRUCTION_UPDATE_LAYOUT;
    ...
    private static void component2(Context context) {
        try {
            ...
            if (!asList.contains("android.permission.ACCESS_NETWORK_STATE")) {
                AFKeystoreWrapper = (f8845d + 95) % IntBufferBatchMountItem.INSTRUCTION_UPDATE_LAYOUT;
            ...
            f8845d = (AFKeystoreWrapper + 33) % IntBufferBatchMountItem.INSTRUCTION_UPDATE_LAYOUT;
        } catch (Exception e10) {
    ...
    */
    final synchronized com.appsflyer.internal.AFf1nSDK AFAdRevenueData() {
        /*
            ...
            int r0 = r0 + 83
            int r1 = r0 % 128
            com.appsflyer.internal.AFa1uSDK.f8845d = r1     // Catch: java.lang.Throwable -> L18
            int r0 = r0 % 2
            if (r0 != 0) goto L1a
    ...
    */
    ...
    public /* synthetic */ void getMediationNetwork(boolean z10) {
        int i10 = AFKeystoreWrapper;
        f8845d = (i10 + 113) % IntBufferBatchMountItem.INSTRUCTION_UPDATE_LAYOUT;
        if (z10) {
            f8845d = (i10 + 99) % IntBufferBatchMountItem.INSTRUCTION_UPDATE_LAYOUT;
    ...
    public static String getMediationNetwork() {
        AFKeystoreWrapper = (f8845d + 63) % IntBufferBatchMountItem.INSTRUCTION_UPDATE_LAYOUT;
    ...
    public static Map<String, Object> getMonetizationNetwork(Map<String, Object> map) {
        ...
        AFKeystoreWrapper = (f8845d + 27) % IntBufferBatchMountItem.INSTRUCTION_UPDATE_LAYOUT;
    ...
    private static /* synthetic */ Object getMonetizationNetwork(Object[] objArr) {
        ...
        try {
            ...
            AFLogger.afWarnLog("Cannot set preinstall attribution data without a media source");
            f8845d = (AFKeystoreWrapper + 113) % IntBufferBatchMountItem.INSTRUCTION_UPDATE_LAYOUT;
            return null;
        } catch (JSONException e10) {
    ...
    private static boolean AFAdRevenueData(String str) {
        ...
        AFKeystoreWrapper = (f8845d + 87) % IntBufferBatchMountItem.INSTRUCTION_UPDATE_LAYOUT;
        return z10;
    }
    ...
    /* JADX WARN: Code restructure failed: missing block: B:35:0x00c7, code lost:
        com.appsflyer.internal.AFa1uSDK.f8845d = (com.appsflyer.internal.AFa1uSDK.AFKeystoreWrapper + 55) % com.facebook.react.fabric.mounting.mountitems.IntBufferBatchMountItem.INSTRUCTION_UPDATE_LAYOUT;
     */
    ...
    */
    private static /* synthetic */ java.lang.Object getCurrencyIso4217Code(java.lang.Object[] r7) {
        /*
            ...
            int r3 = r3 + 85
            int r4 = r3 % 128
            com.appsflyer.internal.AFa1uSDK.f8845d = r4
            int r3 = r3 % 2
            r4 = 0
        ...
        L3c:
            ...
            int r2 = r2 + 39
            int r3 = r2 % 128
            com.appsflyer.internal.AFa1uSDK.f8845d = r3
            int r2 = r2 % 2
            r3 = -389316474(0xffffffffe8cb8086, float:-7.68809E24)
    ...
    /* JADX WARN: Code restructure failed: missing block: B:26:0x005b, code lost:
        com.appsflyer.internal.AFa1uSDK.AFKeystoreWrapper = (com.appsflyer.internal.AFa1uSDK.f8845d + 7) % com.facebook.react.fabric.mounting.mountitems.IntBufferBatchMountItem.INSTRUCTION_UPDATE_LAYOUT;
    ...
    */
    private void getMonetizationNetwork(com.appsflyer.internal.AFh1jSDK r5) {
        ...
        L2d:
            ...
            int r0 = r0 + 105
            int r2 = r0 % 128
            com.appsflyer.internal.AFa1uSDK.f8845d = r2
            int r0 = r0 % 2
            if (r0 != 0) goto L51
    ...
    private static void AFAdRevenueData(@NonNull AFh1jSDK aFh1jSDK, AFh1rSDK aFh1rSDK) {
        ...
        if (aFh1rSDK != null) {
            ...
            f8845d = (i11 + 95) % IntBufferBatchMountItem.INSTRUCTION_UPDATE_LAYOUT;
        }
    }
    ...
    */
    private static int AFAdRevenueData(com.appsflyer.internal.AFc1oSDK r3, java.lang.String r4, boolean r5) {
        ...
        L1b:
            ...
            r3.getRevenue(r4, r0)
        L1f:
            int r3 = com.appsflyer.internal.AFa1uSDK.f8845d
            int r3 = r3 + 99
            int r4 = r3 % 128
    ...
    private void getRevenue(AppsFlyerConversionListener appsFlyerConversionListener) {
        if (appsFlyerConversionListener == null) {
            AFKeystoreWrapper = (f8845d + 13) % IntBufferBatchMountItem.INSTRUCTION_UPDATE_LAYOUT;
            return;
        }
    ...
    */
    private static java.lang.String getCurrencyIso4217Code(android.app.Activity r7) {
        /*
            ...
            if (r1 == 0) goto L6b
            int r2 = com.appsflyer.internal.AFa1uSDK.f8845d
            int r2 = r2 + 123
            int r2 = r2 % 128
    ...
    public final Map<String, Object> getRevenue(AFh1jSDK aFh1jSDK) {
        ...
        f8845d = (AFKeystoreWrapper + 115) % IntBufferBatchMountItem.INSTRUCTION_UPDATE_LAYOUT;
        return map;
    }
