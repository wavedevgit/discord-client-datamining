...
public final class AFd1ySDK implements AFd1xSDK {
    ...
    public AFd1ySDK(@NotNull AFc1bSDK aFc1bSDK) {
        ...
        this.getCurrencyIso4217Code = as.l.b(new Function0<AFf1lSDK>() { // from class: com.appsflyer.internal.AFd1ySDK.1
            {
                super(0);
            }
        ...
        this.getMediationNetwork = as.l.b(new Function0<AFc1pSDK>() { // from class: com.appsflyer.internal.AFd1ySDK.5
            {
                super(0);
            }
        ...
        this.getMonetizationNetwork = as.l.b(new Function0<AFc1oSDK>() { // from class: com.appsflyer.internal.AFd1ySDK.3
            {
                super(0);
            }
        ...
        this.AFAdRevenueData = as.l.b(new Function0<AFf1cSDK>() { // from class: com.appsflyer.internal.AFd1ySDK.9
            {
                super(0);
            }
        ...
        this.component2 = as.l.b(new Function0<ExecutorService>() { // from class: com.appsflyer.internal.AFd1ySDK.2
            {
                super(0);
            }
        ...
        this.areAllFieldsValid = as.l.b(new Function0<AFd1uSDK>() { // from class: com.appsflyer.internal.AFd1ySDK.4
            {
                super(0);
            }
        ...
        this.component3 = as.l.b(new Function0<AFd1vSDK>() { // from class: com.appsflyer.internal.AFd1ySDK.6
            {
                super(0);
            }
        ...
        if (i16 == 1) {
            ...
            if (i16 != 3) {
                if (i16 != 4) {
                    ...
                    Map m10 = o0.m(as.v.a("deviceInfo", (Map) objArr[0]), as.v.a("excs", AFd1tSDK.AFAdRevenueData((List) objArr[1])));
    ...
    */
    ...
    private final Map<String, String> getCurrencyIso4217Code(AFh1aSDK aFh1aSDK) {
        ...
        Map<String, String> m10 = o0.m(as.v.a(((String) objArr[0]).intern(), Build.BRAND), as.v.a("model", Build.MODEL), as.v.a("app_id", getMonetizationNetwork().getRevenue.getRevenue.getPackageName()), as.v.a("p_ex", new AFa1ySDK().getMediationNetwork()), as.v.a("api", String.valueOf(Build.VERSION.SDK_INT)), as.v.a("sdk", this.component1), as.v.a("uid", AFb1jSDK.getRevenue(getMonetizationNetwork().getMonetizationNetwork)), as.v.a("exc_config", aFh1aSDK.getMonetizationNetwork()));
    ...
    private static /* synthetic */ Object getCurrencyIso4217Code(Object[] objArr) {
        ...
        ((AFd1ySDK) objArr[0]).component2().getRevenue(bytes, o0.f(as.v.a("Authorization", AFj1bSDK.getRevenue(str, (String) objArr[2]))), 2000);
