...
public final class AFd1hSDK extends AFd1dSDK {
    ...
    public static final class AFa1tSDK {
        ...
        static String getMediationNetwork(String str, String str2, String str3) {
            String format = String.format(AFd1lSDK.getRevenue, AppsFlyerLib.getInstance().getHostPrefix(), AFa1uSDK.getMonetizationNetwork().getHostName());
    ...
    /* synthetic */ AFd1hSDK(String str, Map map, byte[] bArr, String str2, boolean z10, int i10, DefaultConstructorMarker defaultConstructorMarker) {
    ...
    public static final AFd1hSDK AFAdRevenueData(@NotNull String str, String str2, @NotNull String str3, @NotNull String str4) {
        ...
        AFd1hSDK aFd1hSDK = new AFd1hSDK(mediationNetwork, o0.m(ir.v.a("Connection", "close"), ir.v.a("af_request_epoch_ms", valueOf), ir.v.a("af_sig", AFa1tSDK.AFAdRevenueData(str, str3, str2, str4, valueOf))), null, null, false, 28, null);
        aFd1hSDK.component3 = 10000;
        return aFd1hSDK;
    }

    private AFd1hSDK(String str, Map<String, String> map, byte[] bArr, String str2, boolean z10) {
