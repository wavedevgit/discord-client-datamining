...
public final class AFa1gSDK {
    ...
    public static final class AFa1vSDK {
        ...
        @NotNull
        public static AFa1gSDK AFAdRevenueData(@NotNull AFa1hSDK aFa1hSDK) {
            Intrinsics.checkNotNullParameter(aFa1hSDK, "");
            return new AFa1gSDK(new LinkedHashMap(), aFa1hSDK, null);
        }

        @NotNull
        public static AFa1gSDK getMediationNetwork(@NotNull AFh1jSDK aFh1jSDK) {
    ...
    /* synthetic */ AFa1gSDK(Map map, AFa1hSDK aFa1hSDK, int i10, DefaultConstructorMarker defaultConstructorMarker) {
        this(map, (i10 & 2) != 0 ? null : aFa1hSDK);
    }
