...
public final class AFe1fSDK extends AFe1lSDK<AFh1pSDK> {
    ...
    public AFe1fSDK(@NotNull AFc1bSDK aFc1bSDK) {
        ...
        this.component4 = as.l.b(new Function0<Long>() { // from class: com.appsflyer.internal.AFe1fSDK.4
            {
                super(0);
            }
        ...
        this.copydefault = as.l.b(new Function0<Boolean>() { // from class: com.appsflyer.internal.AFe1fSDK.1
            {
                super(0);
            }
    ...
    */
    private final boolean getCurrencyIso4217Code(android.content.Context r11, com.appsflyer.internal.AFe1fSDK.AFa1tSDK r12) {
        ...
        L2e:
            kotlin.Unit r11 = kotlin.Unit.f31987a     // Catch: java.lang.Throwable -> L21
            if (r11 == 0) goto L34
            r11 = 1
            return r11
        L34:
