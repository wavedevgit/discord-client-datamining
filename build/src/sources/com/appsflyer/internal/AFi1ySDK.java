...
public final class AFi1ySDK {
    ...
    public final boolean getMonetizationNetwork() {
        ...
        if (millis > ((AFc1bSDK) AFa1uSDK.getRevenue(new Object[]{monetizationNetwork}, 389316487, -389316474, System.identityHashCode(monetizationNetwork))).component4().getCurrencyIso4217Code()) {
            return true;
        }
        return false;
    }
