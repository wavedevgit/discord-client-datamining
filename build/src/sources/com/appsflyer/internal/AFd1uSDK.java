                    ...
                    for (File file : listFiles) {
                        ...
                        if (listFiles2 != null) {
                            ...
                            for (File file2 : listFiles2) {
                                ...
                                AFc1cSDK currencyIso4217Code = AFc1cSDK.AFa1vSDK.getCurrencyIso4217Code(cs.j.j(file2, null, 1, null));
        ...
        synchronized (this) {
            ...
            if (file != null) {
                try {
                    ...
                    cs.j.l(file2, AFAdRevenueData.getMediationNetwork(), null, 2, null);
                    str2 = str3;
                } catch (Exception e10) {
            ...
            try {
                ...
                if (monetizationNetwork != null) {
                    if (strArr.length == 0) {
                        ...
                        z10 = cs.j.r(monetizationNetwork);
                    } else {
                        ...
                        if (listFiles != null) {
                            ...
                            for (File file2 : arrayList) {
                                Intrinsics.checkNotNullExpressionValue(file2, "");
                                arrayList2.add(Boolean.valueOf(cs.j.r(file2)));
                            }
