...
public final class AFe1aSDK extends AFe1lSDK<Unit> {
    ...
    public final AFe1uSDK getMediationNetwork() {
        ...
        try {
            ...
            if (context != null && (a10 = v.a(context.getSystemService(u.a()))) != null) {
                ...
                Map n10 = o0.n(qr.v.a("event_name", this.areAllFieldsValid.getMediationNetwork), qr.v.a("app_id", this.component1.getRevenue.getRevenue.getPackageName()), qr.v.a("app_version", this.component1.n_().versionName), qr.v.a("sdk_version", AFc1pSDK.getCurrencyIso4217Code()), qr.v.a("api_version", AFc1pSDK.AFAdRevenueData()), qr.v.a("timestamp", String.valueOf(this.component2.getCurrencyIso4217Code())), qr.v.a("request_id", AFc1pSDK.getMonetizationNetwork()), qr.v.a("gaid", component4));
                ...
                if (AFAdRevenueData != null) {
                    n10.put("install_time", String.valueOf(AFAdRevenueData.longValue()));
                }
                ...
                if (aFe1rSDK instanceof AFe1rSDK.AFa1ySDK) {
                    ...
                    if (f10 != null) {
                        n10.put("event_revenue", String.valueOf(f10.floatValue()));
                    }
                    Integer num = ((AFe1rSDK.AFa1ySDK) this.areAllFieldsValid).getRevenue;
                    if (num != null) {
                        n10.put("event_count", String.valueOf(num.intValue()));
                    }
                }
                ...
                a10.registerTrigger(build, this.component3, new AFa1zSDK(objectRef, countDownLatch, this));
            }
