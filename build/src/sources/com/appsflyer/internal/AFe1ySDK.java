...
public final class AFe1ySDK {
    ...
    @NotNull
    private static final List<String> component2 = CollectionsKt.o("googleplay", "playstore", "googleplaystore");
    ...
    public AFe1ySDK(@NotNull AFc1pSDK aFc1pSDK, @NotNull AFc1oSDK aFc1oSDK) {
        ...
        this.component4 = ir.l.b(new Function0<String>() { // from class: com.appsflyer.internal.AFe1ySDK.4
            {
                super(0);
            }
            ...
            public final String invoke() {
                ...
                String str = "";
                if (currencyIso4217Code != null && !StringsKt.k0(currencyIso4217Code)) {
                    String obj = StringsKt.k1(currencyIso4217Code).toString();
        ...
        this.getCurrencyIso4217Code = ir.l.b(new Function0<String>() { // from class: com.appsflyer.internal.AFe1ySDK.3
            {
                super(0);
            }
    ...
    public final String getCurrencyIso4217Code() {
        ...
        int i10 = AFa1zSDK.getRevenue[aFe1tSDK.ordinal()];
        if (i10 != 1) {
            if (i10 != 2) {
                if (i10 == 3) {
                    return "";
