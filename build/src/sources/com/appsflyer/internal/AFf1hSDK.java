...
public final class AFf1hSDK {
    ...
    public AFf1hSDK(@NotNull AFc1pSDK aFc1pSDK, @NotNull AFf1iSDK aFf1iSDK) {
        ...
        this.getMediationNetwork = qr.l.a(new Function0<Boolean>() { // from class: com.appsflyer.internal.AFf1hSDK.2
            {
                super(0);
            }
        ...
        this.getMonetizationNetwork = qr.l.a(new Function0<Boolean>() { // from class: com.appsflyer.internal.AFf1hSDK.1
            {
                super(0);
            }
