...
public final class OrientationModule extends ReactContextBaseJavaModule {
    ...
    public static final class a {
        ...
        public static final a f11631e = new a("LOCKED_PORTRAIT", 0, 1);

        /* renamed from: i  reason: collision with root package name */
        public static final a f11632i = new a("LOCKED_LANDSCAPE", 1, 6);

        /* renamed from: o  reason: collision with root package name */
        public static final a f11633o = new a("LOCKED_LANDSCAPE_LEFT", 2, 0);

        /* renamed from: p  reason: collision with root package name */
        public static final a f11634p = new a("LOCKED_LANDSCAPE_RIGHT", 3, 8);

        /* renamed from: q  reason: collision with root package name */
        public static final a f11635q = new a("UNLOCKED", 4, 4);

        /* renamed from: r  reason: collision with root package name */
        public static final a f11636r = new a("UNSPECIFIED", 5, -1);

        /* renamed from: s  reason: collision with root package name */
        private static final /* synthetic */ a[] f11637s;

        /* renamed from: t  reason: collision with root package name */
        private static final /* synthetic */ EnumEntries f11638t;
        ...
        private static final /* synthetic */ a[] a() {
            return new a[]{f11631e, f11632i, f11633o, f11634p, f11635q, f11636r};
        }
    ...
    public OrientationModule(@NotNull ReactApplicationContext reactContext) {
        ...
        reactContext.addLifecycleEventListener(new wb.a(reactContext, new Function1() { // from class: com.github.yamill.orientation.a
        ...
        reactContext.addLifecycleEventListener(new wb.b(reactContext, new Function0() { // from class: com.github.yamill.orientation.b
        ...
        reactContext.addLifecycleEventListener(new wb.c(reactContext, new Function0() { // from class: com.github.yamill.orientation.c
            @Override // kotlin.jvm.functions.Function0
            public final Object invoke() {
    ...
    private final void updateOrientation(a aVar, boolean z10, boolean z11) {
        ...
        if (this.lockState != aVar || this.autoRotateEnabled != z10 || this.autoRotateIgnored != z11) {
            ...
            if (aVar != null) {
                ...
                if (!z10 && !z11 && aVar != (aVar2 = a.f11636r) && (currentActivity2 = this.reactContext.getCurrentActivity()) != null) {
    ...
    public final void lockToLandscape() {
        updateOrientation$default(this, a.f11632i, false, false, 6, null);
    }

    @ReactMethod
    public final void lockToLandscapeLeft() {
        updateOrientation$default(this, a.f11633o, false, false, 6, null);
    }

    @ReactMethod
    public final void lockToLandscapeRight() {
        updateOrientation$default(this, a.f11634p, false, false, 6, null);
    }

    @ReactMethod
    @SuppressLint({"SourceLockedOrientationActivity"})
    public final void lockToPortrait() {
        updateOrientation$default(this, a.f11631e, false, false, 6, null);
    }

    @ReactMethod
    public final void unlockAllOrientations() {
        updateOrientation$default(this, a.f11635q, false, false, 6, null);
    }
}
