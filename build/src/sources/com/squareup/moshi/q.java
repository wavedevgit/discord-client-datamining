...
final class q extends m {
    ...
    private static final Object f18833s = new Object();

    /* renamed from: r  reason: collision with root package name */
    private Object[] f18834r;
    ...
    public static final class a implements Iterator, Cloneable {
        ...
        /* renamed from: a */
        public a clone() {
            return new a(this.f18835d, this.f18836e, this.f18837i);
        }

        @Override // java.util.Iterator
        public boolean hasNext() {
            if (this.f18837i < this.f18836e.length) {
                return true;
            }
            return false;
        }
        ...
        @Override // java.util.Iterator
        public Object next() {
            Object[] objArr = this.f18836e;
            int i10 = this.f18837i;
            this.f18837i = i10 + 1;
            return objArr[i10];
        }
    ...
    private void F0(Object obj) {
        ...
        if (i10 == this.f18834r.length) {
            if (i10 != 256) {
                ...
                Object[] objArr = this.f18834r;
                this.f18834r = Arrays.copyOf(objArr, objArr.length * 2);
            } else {
                throw new j("Nesting too deep at " + t());
            }
        }
        Object[] objArr2 = this.f18834r;
    ...
    public void D() {
        ...
        if (aVar.f18835d == cVar && !aVar.hasNext()) {
    ...
    public int J(m.b bVar) {
        ...
        for (int i10 = 0; i10 < length; i10++) {
            if (bVar.f18807a[i10].equals(L0)) {
                this.f18834r[this.f18800d - 1] = entry.getValue();
                this.f18802i[this.f18800d - 2] = L0;
                return i10;
            }
        }
        return -1;
    ...
    public int Q(m.b bVar) {
        ...
        for (int i11 = 0; i11 < length; i11++) {
            if (bVar.f18807a[i11].equals(str2)) {
                G0();
                return i11;
            }
        }
    ...
    public void close() {
        Arrays.fill(this.f18834r, 0, this.f18800d, (Object) null);
        this.f18834r[0] = f18833s;
        this.f18801e[0] = 8;
        this.f18800d = 1;
    }
    ...
    public void x() {
        ...
        int i10 = this.f18800d;
        objArr[i10 - 1] = aVar;
        this.f18801e[i10 - 1] = 1;
        this.f18803o[i10 - 1] = 0;
        if (aVar.hasNext()) {
            F0(aVar.next());
        }
    }
    ...
    public void z0() {
        if (!this.f18805q) {
            this.f18834r[this.f18800d - 1] = ((Map.Entry) H0(Map.Entry.class, m.c.NAME)).getValue();
            this.f18802i[this.f18800d - 2] = "null";
            return;
        }
        m.c s10 = s();
        o0();
    ...
    q(q qVar) {
        super(qVar);
        this.f18834r = (Object[]) qVar.f18834r.clone();
        for (int i10 = 0; i10 < this.f18800d; i10++) {
            Object[] objArr = this.f18834r;
