...
final class q extends m {
    ...
    private static final Object f17557s = new Object();

    /* renamed from: r  reason: collision with root package name */
    private Object[] f17558r;
    ...
    public static final class a implements Iterator, Cloneable {
        ...
        /* renamed from: a */
        public a clone() {
            return new a(this.f17559d, this.f17560e, this.f17561i);
        }

        @Override // java.util.Iterator
        public boolean hasNext() {
            if (this.f17561i < this.f17560e.length) {
                return true;
            }
            return false;
        }
    ...
    private void J0(Object obj) {
        ...
        if (i10 == this.f17558r.length) {
            if (i10 != 256) {
                ...
                Object[] objArr = this.f17558r;
                this.f17558r = Arrays.copyOf(objArr, objArr.length * 2);
            } else {
                throw new j("Nesting too deep at " + q());
            }
        }
        Object[] objArr2 = this.f17558r;
    ...
    public int A0(m.b bVar) {
        ...
        for (int i10 = 0; i10 < length; i10++) {
            if (bVar.f17531a[i10].equals(V0)) {
                this.f17558r[this.f17524d - 1] = entry.getValue();
                this.f17526i[this.f17524d - 2] = V0;
                return i10;
            }
        }
        return -1;
    ...
    public int C0(m.b bVar) {
        ...
        for (int i11 = 0; i11 < length; i11++) {
            if (bVar.f17531a[i11].equals(str2)) {
                M0();
                return i11;
            }
        }
    ...
    public m.c E() {
        ...
        Object obj = this.f17558r[i10 - 1];
        if (obj instanceof a) {
            return ((a) obj).f17559d;
        }
    ...
    public void E0() {
        if (!this.f17529q) {
            this.f17558r[this.f17524d - 1] = ((Map.Entry) R0(Map.Entry.class, m.c.NAME)).getValue();
            this.f17526i[this.f17524d - 2] = "null";
            return;
        }
        m.c E = E();
        l0();
    ...
    public void close() {
        Arrays.fill(this.f17558r, 0, this.f17524d, (Object) null);
        this.f17558r[0] = f17557s;
        this.f17525e[0] = 8;
        this.f17524d = 1;
    }
    ...
    public void s() {
        ...
        if (aVar.f17559d == cVar && !aVar.hasNext()) {
            M0();
            return;
        }
        throw I0(aVar, cVar);
    ...
    public void u() {
        ...
        int i10 = this.f17524d;
        objArr[i10 - 1] = aVar;
        this.f17525e[i10 - 1] = 1;
        this.f17527o[i10 - 1] = 0;
        if (aVar.hasNext()) {
            J0(aVar.next());
        }
    }
    ...
    q(q qVar) {
        super(qVar);
        this.f17558r = (Object[]) qVar.f17558r.clone();
