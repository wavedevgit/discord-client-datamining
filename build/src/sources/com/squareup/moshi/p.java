...
final class p extends t {
    ...
    private static final String[] f18571x = new String[IntBufferBatchMountItem.INSTRUCTION_UPDATE_LAYOUT];

    /* renamed from: u  reason: collision with root package name */
    private final BufferedSink f18572u;
    ...
    static {
        for (int i10 = 0; i10 <= 31; i10++) {
            f18571x[i10] = String.format("\\u%04x", Integer.valueOf(i10));
        }
        String[] strArr = f18571x;
        strArr[34] = "\\\"";
        strArr[92] = "\\\\";
        strArr[9] = "\\t";
        strArr[8] = "\\b";
    ...
    private t E1(int i10, int i11, char c10) {
        ...
        if (this.f18574w == null) {
            ...
            this.f18572u.writeByte(c10);
            return this;
        }
        throw new IllegalStateException("Dangling name: " + this.f18574w);
    }

    private void U1() {
        if (this.f18599p != null) {
            this.f18572u.writeByte(10);
            int i10 = this.f18595d;
            for (int i11 = 1; i11 < i10; i11++) {
                this.f18572u.o0(this.f18599p);
            }
        }
    }
    ...
    */
    public static void Y1(okio.BufferedSink r7, java.lang.String r8) {
        /*
            java.lang.String[] r0 = com.squareup.moshi.p.f18571x
            r1 = 34
            r7.writeByte(r1)
            int r2 = r8.length()
            r3 = 0
    ...
    public t V0(double d10) {
        if (!this.f18600q && (Double.isNaN(d10) || Double.isInfinite(d10))) {
            ...
            b2();
            B1();
            this.f18572u.o0(Double.toString(d10));
            int[] iArr = this.f18598o;
            int i10 = this.f18595d - 1;
            iArr[i10] = iArr[i10] + 1;
            return this;
    ...
    public t Y0(long j10) {
        ...
        b2();
        B1();
        this.f18572u.o0(Long.toString(j10));
        int[] iArr = this.f18598o;
        int i10 = this.f18595d - 1;
        iArr[i10] = iArr[i10] + 1;
        return this;
    ...
    public t e1(Number number) {
        ...
        if (!this.f18600q && (obj.equals("-Infinity") || obj.equals("Infinity") || obj.equals("NaN"))) {
    ...
    public t t0(String str) {
        if (str != null) {
            if (this.f18595d != 0) {
                int F0 = F0();
                if ((F0 == 3 || F0 == 5) && this.f18574w == null && !this.f18602s) {
                    this.f18574w = str;
    ...
    public t y1(boolean z10) {
        ...
        if (!this.f18602s) {
            b2();
            B1();
            BufferedSink bufferedSink = this.f18572u;
            if (z10) {
                str = "true";
            } else {
                str = "false";
