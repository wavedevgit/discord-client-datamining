...
public final class o extends m {
    ...
    private final BufferedSource f18821r;

    /* renamed from: s  reason: collision with root package name */
    private final Buffer f18822s;
    ...
    private static final ByteString f18819y = ByteString.h("'\\");

    /* renamed from: z  reason: collision with root package name */
    private static final ByteString f18820z = ByteString.h("\"\\");
    ...
    public o(BufferedSource bufferedSource) {
        ...
        if (bufferedSource != null) {
            this.f18821r = bufferedSource;
            this.f18822s = bufferedSource.f();
            C(6);
            return;
        }
        ...
        if (i11 == 1) {
            ...
            if (i11 == 4) {
                ...
                if (O02 != 58) {
                    if (O02 == 61) {
                        F0();
                        if (this.f18821r.D0(1L) && this.f18822s.Z(0L) == 62) {
                            this.f18822s.readByte();
                        }
                    } else {
                        throw C0("Expected ':'");
    ...
    private int H0(String str, m.b bVar) {
        ...
        for (int i10 = 0; i10 < length; i10++) {
            if (str.equals(bVar.f18806a[i10])) {
                this.f18823t = 0;
                this.f18801i[this.f18799d - 1] = str;
                return i10;
            }
        }
        return -1;
    ...
    /* JADX WARN: Code restructure failed: missing block: B:18:0x0037, code lost:
        if (r6.f18821r.D0(2) != false) goto L28;
     */
    ...
    */
    private int O0(boolean r7) {
        ...
        L1:
            r1 = r0
        L2:
            okio.BufferedSource r2 = r6.f18821r
            int r3 = r1 + 1
            long r4 = (long) r3
            boolean r2 = r2.D0(r4)
            if (r2 == 0) goto L80
            okio.Buffer r2 = r6.f18822s
            long r4 = (long) r1
            byte r2 = r2.Z(r4)
            r4 = 10
            if (r2 == r4) goto L7e
            ...
            goto L7e
        L25:
            okio.Buffer r3 = r6.f18822s
            long r4 = (long) r1
            r3.skip(r4)
            r1 = 47
            if (r2 != r1) goto L72
            okio.BufferedSource r3 = r6.f18821r
            r4 = 2
            boolean r3 = r3.D0(r4)
            if (r3 != 0) goto L3a
            goto L7d
    ...
    private String S0(ByteString byteString) {
        ...
        while (true) {
            long g02 = this.f18821r.g0(byteString);
            if (g02 != -1) {
                if (this.f18822s.Z(g02) == 92) {
                    if (sb2 == null) {
                        sb2 = new StringBuilder();
                    }
                    sb2.append(this.f18822s.d1(g02));
                    this.f18822s.readByte();
                    sb2.append(b1());
                } else if (sb2 == null) {
                    String d12 = this.f18822s.d1(g02);
                    this.f18822s.readByte();
                    return d12;
                } else {
                    sb2.append(this.f18822s.d1(g02));
    ...
    private String V0() {
        long g02 = this.f18821r.g0(A);
        if (g02 != -1) {
            return this.f18822s.d1(g02);
        }
        return this.f18822s.X1();
    }
    ...
    private int Z0() {
        ...
        while (i11 < length) {
            int i12 = i11 + 1;
            if (!this.f18821r.D0(i12)) {
                return 0;
            }
            byte Z2 = this.f18822s.Z(i11);
            if (Z2 != str.charAt(i11) && Z2 != str2.charAt(i11)) {
                return 0;
            }
            i11 = i12;
        }
        if (this.f18821r.D0(length + 1) && N0(this.f18822s.Z(length))) {
            return 0;
        }
        this.f18822s.skip(length);
        this.f18823t = i10;
        return i10;
    }
    ...
    */
    ...
    private char b1() {
        int i10;
        if (this.f18821r.D0(1L)) {
            byte readByte = this.f18822s.readByte();
                    ...
                    if (readByte != 102) {
                        ...
                        if (readByte != 114) {
                            if (readByte != 116) {
                                ...
                                } else if (this.f18821r.D0(4L)) {
                                    char c10 = 0;
                                    for (int i11 = 0; i11 < 4; i11++) {
                                        byte Z = this.f18822s.Z(i11);
                                        char c11 = (char) (c10 << 4);
                                        if (Z >= 48 && Z <= 57) {
                                            i10 = Z - 48;
                                        } else if (Z >= 97 && Z <= 102) {
                                            ...
                                            throw C0("\\u" + this.f18822s.d1(4L));
                                        } else {
                                            i10 = Z - 55;
                                        }
                                        c10 = (char) (c11 + i10);
                                    }
                                    this.f18822s.skip(4L);
                                    return c10;
                                } else {
    ...
    private boolean w1() {
        boolean z10;
        long size;
        BufferedSource bufferedSource = this.f18821r;
    ...
    public int J(m.b bVar) {
        ...
        if (i10 == 15) {
            return H0(this.f18826w, bVar);
        }
        int T1 = this.f18821r.T1(bVar.f18807b);
        if (T1 != -1) {
            this.f18823t = 0;
            this.f18801i[this.f18799d - 1] = bVar.f18806a[T1];
            return T1;
        }
        String str = this.f18801i[this.f18799d - 1];
        String o02 = o0();
        int H0 = H0(o02, bVar);
        if (H0 == -1) {
            this.f18823t = 15;
    ...
    public int Q(m.b bVar) {
        ...
        if (i11 == 11) {
            return L0(this.f18826w, bVar);
        }
        int T1 = this.f18821r.T1(bVar.f18807b);
        if (T1 != -1) {
            this.f18823t = 0;
            int[] iArr2 = this.f18802o;
            int i12 = this.f18799d - 1;
        ...
        if (L0 == -1) {
            this.f18823t = 11;
            this.f18826w = g12;
            this.f18802o[this.f18799d - 1] = iArr[i10] - 1;
        }
        return L0;
    }
                ...
                if (i11 == 3) {
                    ...
                    if (i11 == 4) {
                        ...
                        if (i11 != 9 && i11 != 13) {
                            if (i11 != 8 && i11 != 12) {
                                if (i11 == 17) {
                                    this.f18822s.skip(this.f18825v);
                                } else if (i11 == 18) {
                                    throw new j("Expected a value but was " + s() + " at path " + t());
                                }
                            } else {
    ...
    public String g1() {
        ...
        if (i10 == 10) {
            ...
            d12 = Long.toString(this.f18824u);
        } else if (i10 == 17) {
            d12 = this.f18822s.d1(this.f18825v);
        } else {
    ...
    */
    ...
    public double nextDouble() {
        ...
        if (i10 == 17) {
            this.f18826w = this.f18822s.d1(this.f18825v);
        } else if (i10 == 9) {
            this.f18826w = S0(f18820z);
        } else if (i10 == 8) {
            this.f18826w = S0(f18819y);
        } else if (i10 == 10) {
            this.f18826w = V0();
        } else if (i10 != 11) {
        ...
        this.f18823t = 11;
        try {
            double parseDouble = Double.parseDouble(this.f18826w);
            ...
            throw new j("Expected a double but was " + this.f18826w + " at path " + t());
        }
    }
    ...
    public int nextInt() {
        ...
        if (i10 == 16) {
            ...
            throw new j("Expected an int but was " + this.f18824u + " at path " + t());
        }
        if (i10 == 17) {
            this.f18826w = this.f18822s.d1(this.f18825v);
        } else if (i10 != 9 && i10 != 8) {
        ...
        try {
            ...
            if (i14 == parseDouble) {
                this.f18826w = null;
                this.f18823t = 0;
                int[] iArr3 = this.f18802o;
                int i15 = this.f18799d - 1;
                iArr3[i15] = iArr3[i15] + 1;
                return i14;
            }
            throw new j("Expected an int but was " + this.f18826w + " at path " + t());
    ...
    public long nextLong() {
        ...
        this.f18823t = 11;
        try {
            long longValueExact = new BigDecimal(this.f18826w).longValueExact();
            this.f18826w = null;
            this.f18823t = 0;
            int[] iArr3 = this.f18802o;
            int i13 = this.f18799d - 1;
            ...
            throw new j("Expected a long but was " + this.f18826w + " at path " + t());
        }
    }
    ...
    public String toString() {
        return "JsonReader(" + this.f18821r + ")";
    }
    ...
    o(o oVar) {
        super(oVar);
        this.f18823t = 0;
        BufferedSource peek = oVar.f18821r.peek();
        this.f18821r = peek;
        this.f18822s = peek.f();
        this.f18823t = oVar.f18823t;
        this.f18824u = oVar.f18824u;
        this.f18825v = oVar.f18825v;
        this.f18826w = oVar.f18826w;
        try {
            peek.U0(oVar.f18822s.size());
