...
public final class WorkflowViewStub extends View {
    ...
    public final View c(Object rendering, a0 viewEnvironment) {
        ...
        View view = this.f18677d;
        ViewGroup viewGroup = null;
        if (!g0.b(view, rendering)) {
            view = null;
        }
        if (view == null) {
            ViewParent parent = this.f18677d.getParent();
            if (parent instanceof ViewGroup) {
                viewGroup = (ViewGroup) parent;
            }
            ViewGroup viewGroup2 = viewGroup;
            if (viewGroup2 != null) {
                View view2 = this.f18677d;
                if (view2 != this && (c10 = d.f53687n.c(view2)) != null) {
                    c10.d();
                }
                Context context = viewGroup2.getContext();
                Intrinsics.checkNotNullExpressionValue(context, "parent.context");
                View c11 = f0.c((e0) viewEnvironment.a(e0.f52313a), rendering, viewEnvironment, context, viewGroup2, new h0() { // from class: wm.l0
                    @Override // wm.h0
    ...
    public int getVisibility() {
        ...
        return this.f18677d.getVisibility();
    }
    ...
    public void setBackground(Drawable drawable) {
        ...
        if (!Intrinsics.areEqual(this.f18677d, this) && (view = this.f18677d) != null && drawable != null) {
    ...
    public void setVisibility(int i10) {
        ...
        if (!Intrinsics.areEqual(this.f18677d, this) && (view = this.f18677d) != null) {
    ...
    public WorkflowViewStub(Context context, AttributeSet attributeSet, int i10, int i11) {
        ...
        this.f18678e = obtainStyledAttributes.getBoolean(r.W, true);
