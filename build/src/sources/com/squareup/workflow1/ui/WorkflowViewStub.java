...
public final class WorkflowViewStub extends View {
    ...
    public final View c(Object rendering, a0 viewEnvironment) {
        ...
        View view = this.f18185d;
        ViewGroup viewGroup = null;
        if (!g0.b(view, rendering)) {
            view = null;
        }
        if (view == null) {
            ViewParent parent = this.f18185d.getParent();
            if (parent instanceof ViewGroup) {
                viewGroup = (ViewGroup) parent;
            }
            ...
            if (viewGroup2 != null) {
                ...
                if (view2 != this && (c10 = d.f22751f.c(view2)) != null) {
                    c10.e();
                }
                Context context = viewGroup2.getContext();
                Intrinsics.checkNotNullExpressionValue(context, "parent.context");
                View c11 = f0.c((e0) viewEnvironment.a(e0.f21788a), rendering, viewEnvironment, context, viewGroup2, new h0() { // from class: en.l0
                    @Override // en.h0
    ...
    public int getVisibility() {
        ...
        return this.f18185d.getVisibility();
    }
    ...
    public void setBackground(Drawable drawable) {
        ...
        if (!Intrinsics.areEqual(this.f18185d, this) && (view = this.f18185d) != null && drawable != null) {
    ...
    public void setVisibility(int i10) {
        ...
        if (!Intrinsics.areEqual(this.f18185d, this) && (view = this.f18185d) != null) {
    ...
    public WorkflowViewStub(Context context, AttributeSet attributeSet, int i10, int i11) {
        ...
        this.f18186e = obtainStyledAttributes.getBoolean(r.W, true);
