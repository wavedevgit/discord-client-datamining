...
public final class Promise<T> {
    ...
    static final class b implements Function1 {
        ...
        final /* synthetic */ Continuation f16857d;

        b(Continuation continuation) {
            this.f16857d = continuation;
        }

        public final void a(Object obj) {
            this.f16857d.resumeWith(Result.b(obj));
        }
    ...
    static final class c implements Function1 {
        ...
        /* renamed from: d  reason: collision with root package name */
        final /* synthetic */ Continuation f16858d;

        c(Continuation continuation) {
            this.f16858d = continuation;
        }

        public final void a(Throwable error) {
            Intrinsics.checkNotNullParameter(error, "error");
            Continuation continuation = this.f16858d;
    ...
    public final Object await(@NotNull Continuation<? super T> continuation) {
        d dVar = new d(rr.b.c(continuation));
        then(new b(dVar));
