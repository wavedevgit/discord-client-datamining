...
public final class Promise<T> {
    ...
    static final class b implements Function1 {
        ...
        final /* synthetic */ Continuation f17889d;

        b(Continuation continuation) {
            this.f17889d = continuation;
        }

        public final void a(Object obj) {
            this.f17889d.resumeWith(Result.b(obj));
        }
    ...
    static final class c implements Function1 {
        ...
        /* renamed from: d  reason: collision with root package name */
        final /* synthetic */ Continuation f17890d;

        c(Continuation continuation) {
            this.f17890d = continuation;
        }

        public final void a(Throwable error) {
            Intrinsics.checkNotNullParameter(error, "error");
            Continuation continuation = this.f17890d;
    ...
    public final Object await(@NotNull Continuation<? super T> continuation) {
        d dVar = new d(pr.b.c(continuation));
        then(new b(dVar));
        m1172catch(new c(dVar));
        Object b10 = dVar.b();
        if (b10 == pr.b.f()) {
            g.c(continuation);
        }
    ...
    public final Promise<T> m1172catch(@NotNull Function1<? super Throwable, Unit> listener) {
