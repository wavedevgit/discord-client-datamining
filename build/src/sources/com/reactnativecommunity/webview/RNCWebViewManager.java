...
public class RNCWebViewManager extends SimpleViewManager<com.reactnativecommunity.webview.b> {
    ...
    public static class f extends WebChromeClient implements LifecycleEventListener {
        ...
        public void onProgressChanged(WebView webView, int i10) {
            ...
            ((g) webView).g(webView, new km.d(com.reactnativecommunity.webview.b.c(webView), createMap));
        }
    ...
    public static class g extends WebView implements LifecycleEventListener {
        ...
        public void k(final String str) {
            ...
            if (this.f18338q != null && this.f18340s != null) {
                ...
                g(this, new km.f(com.reactnativecommunity.webview.b.c(this), createMap));
            }
        }
    ...
    public void setAssetLoaderConfig(com.reactnativecommunity.webview.b bVar, ReadableMap readableMap) {
        ...
        if (readableMap.hasKey("httpAllowed")) {
            c0314b.d(readableMap.getBoolean("httpAllowed"));
        }
            ...
            for (int i10 = 0; i10 < array.size(); i10++) {
                ...
                if (string2 == null) {
                    ...
                    if (string3 == null) {
                        ...
                        c0314b.a(string3, new b.f(bVar.getContext()));
                    } else if (string2.equals("assets")) {
                        c0314b.a(string3, new b.a(bVar.getContext()));
                        ...
                        if (string4 == null) {
                            ...
                            c0314b.a(string3, new b.c(bVar.getContext(), new File(string4)));
                        }
                    }
                }
            }
    ...
    public static class h extends WebViewClient {
        ...
        protected void b(WebView webView, String str) {
            ((g) webView).g(webView, new km.c(com.reactnativecommunity.webview.b.c(webView), a(webView, str)));
        }
        ...
        public void onReceivedError(WebView webView, int i10, String str, String str2) {
            ...
            ((g) webView).g(webView, new km.b(com.reactnativecommunity.webview.b.c(webView), a10));
        }
        ...
        public void onReceivedHttpError(WebView webView, WebResourceRequest webResourceRequest, WebResourceResponse webResourceResponse) {
            ...
            if (webResourceRequest.isForMainFrame()) {
                ...
                ((g) webView).g(webView, new km.a(com.reactnativecommunity.webview.b.c(webView), a10));
            }
        }
        ...
        public boolean onRenderProcessGone(WebView webView, RenderProcessGoneDetail renderProcessGoneDetail) {
            ...
            ((g) webView).g(webView, new km.g(com.reactnativecommunity.webview.b.c(webView), a10));
            return true;
        }
