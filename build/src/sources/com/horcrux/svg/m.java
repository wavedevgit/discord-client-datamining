...
public class m extends q {
    ...
    private static final Pattern f17625p = Pattern.compile("[0-9.-]+");

    /* renamed from: i  reason: collision with root package name */
    public ReadableArray f17626i;
    ...
    public Bitmap c(HashMap hashMap, Bitmap bitmap) {
        ...
        setupPaint(paint, this.f17627o, this.f17626i);
    ...
    public void k(Dynamic dynamic) {
        if (dynamic != null && !dynamic.isNull()) {
            ...
            if (type.equals(ReadableType.Number)) {
                this.f17626i = JavaOnlyArray.of(0, Integer.valueOf(dynamic.asInt()));
            } else if (type.equals(ReadableType.Array)) {
                this.f17626i = dynamic.asArray();
            } else {
                JavaOnlyArray javaOnlyArray = new JavaOnlyArray();
                javaOnlyArray.pushInt(0);
                Matcher matcher = f17625p.matcher(dynamic.asString());
                while (matcher.find()) {
    ...
    public void l(ReadableMap readableMap) {
        ...
        if (i10 == 0) {
            ...
            if (type.equals(ReadableType.Number)) {
                this.f17626i = JavaOnlyArray.of(0, Integer.valueOf(readableMap.getInt("payload")));
            } else if (type.equals(ReadableType.Map)) {
                this.f17626i = JavaOnlyArray.of(0, readableMap.getMap("payload"));
            }
        } else if (i10 == 1) {
            this.f17626i = JavaOnlyArray.of(1, readableMap.getString("brushRef"));
        } else {
            this.f17626i = JavaOnlyArray.of(Integer.valueOf(i10));
        }
        invalidate();
    }
