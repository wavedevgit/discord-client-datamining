...
public class m extends q {
    ...
    private static final Pattern f16593p = Pattern.compile("[0-9.-]+");

    /* renamed from: i  reason: collision with root package name */
    public ReadableArray f16594i;

    /* renamed from: o  reason: collision with root package name */
    public float f16595o;
    ...
    public Bitmap c(HashMap hashMap, Bitmap bitmap) {
        ...
        setupPaint(paint, this.f16595o, this.f16594i);
    ...
    public void k(Dynamic dynamic) {
        if (dynamic != null && !dynamic.isNull()) {
            ...
            if (type.equals(ReadableType.Number)) {
                this.f16594i = JavaOnlyArray.of(0, Integer.valueOf(dynamic.asInt()));
            } else if (type.equals(ReadableType.Array)) {
                this.f16594i = dynamic.asArray();
            } else {
                JavaOnlyArray javaOnlyArray = new JavaOnlyArray();
                javaOnlyArray.pushInt(0);
                Matcher matcher = f16593p.matcher(dynamic.asString());
                while (matcher.find()) {
    ...
    public void l(ReadableMap readableMap) {
        ...
        if (i10 == 0) {
            ...
            if (type.equals(ReadableType.Number)) {
                this.f16594i = JavaOnlyArray.of(0, Integer.valueOf(readableMap.getInt("payload")));
            } else if (type.equals(ReadableType.Map)) {
                this.f16594i = JavaOnlyArray.of(0, readableMap.getMap("payload"));
            }
        } else if (i10 == 1) {
            this.f16594i = JavaOnlyArray.of(1, readableMap.getString("brushRef"));
        } else {
            this.f16594i = JavaOnlyArray.of(Integer.valueOf(i10));
        }
        invalidate();
    }
