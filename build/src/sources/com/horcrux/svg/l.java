...
class l extends q {
    ...
    static /* synthetic */ class a {
        ...
        static {
            ...
            try {
                f17096a[v.IN.ordinal()] = 2;
            } catch (NoSuchFieldError unused2) {
            }
            try {
                f17096a[v.OUT.ordinal()] = 3;
            } catch (NoSuchFieldError unused3) {
            }
            try {
                f17096a[v.ATOP.ordinal()] = 4;
            } catch (NoSuchFieldError unused4) {
            }
            try {
                f17096a[v.XOR.ordinal()] = 5;
            } catch (NoSuchFieldError unused5) {
            }
            try {
                f17096a[v.ARITHMETIC.ordinal()] = 6;
    ...
    public Bitmap c(HashMap hashMap, Bitmap bitmap) {
        Bitmap e10 = q.e(hashMap, bitmap, this.f17089i);
        Bitmap e11 = q.e(hashMap, bitmap, this.f17090o);
        ...
        switch (a.f17096a[this.f17095t.ordinal()]) {
            case 1:
            ...
            case 6:
                ...
                while (i10 < width) {
                    ...
                    float f11 = i13;
                    float f12 = i16;
                    float f13 = this.f17092q;
                    float f14 = (f10 * f11 * f12) + (f11 * f13);
                    float f15 = this.f17093r;
                    float f16 = f14 + (f12 * f15);
                    float f17 = this.f17094s;
                    float f18 = i14;
                    float f19 = i18;
                    float f20 = i15;
                    float f21 = i19;
    ...
    public void m(Float f10) {
        this.f17091p = f10.floatValue();
        invalidate();
    }

    public void n(Float f10) {
        this.f17092q = f10.floatValue();
        invalidate();
    }

    public void o(Float f10) {
        this.f17093r = f10.floatValue();
        invalidate();
    }

    public void p(Float f10) {
        this.f17094s = f10.floatValue();
        invalidate();
    }

    public void q(String str) {
        this.f17095t = v.d(str);
        invalidate();
    }
}
