...
abstract class j0 {
    ...
    static float f17945a;

    /* renamed from: b  reason: collision with root package name */
    private static int f17946b;

    /* renamed from: c  reason: collision with root package name */
    private static int f17947c;

    /* renamed from: d  reason: collision with root package name */
    private static String f17948d;

    /* renamed from: e  reason: collision with root package name */
    private static Path f17949e;

    /* renamed from: f  reason: collision with root package name */
    static ArrayList f17950f;

    /* renamed from: g  reason: collision with root package name */
    private static float f17951g;

    /* renamed from: h  reason: collision with root package name */
    private static float f17952h;

    /* renamed from: i  reason: collision with root package name */
    private static float f17953i;

    /* renamed from: j  reason: collision with root package name */
    private static float f17954j;

    /* renamed from: k  reason: collision with root package name */
    private static float f17955k;

    /* renamed from: l  reason: collision with root package name */
    private static float f17956l;
    ...
    private static void A(float f10, float f11, float f12, float f13) {
        f17953i = f10;
        f17954j = f11;
        e((f17951g * 2.0f) - f17953i, (f17952h * 2.0f) - f17954j, f10, f11, f12, f13);
    }

    private static void B(float f10, float f11) {
        C(f10 + f17951g, f11 + f17952h);
    }

    private static void C(float f10, float f11) {
        u((f17951g * 2.0f) - f17953i, (f17952h * 2.0f) - f17954j, f10, f11);
    }

    private static void a(float f10, float f11, float f12, boolean z10, boolean z11, float f13, float f14) {
        b(f10, f11, f12, z10, z11, f13 + f17951g, f14 + f17952h);
    }
    ...
    private static void b(float f10, float f11, float f12, boolean z10, boolean z11, float f13, float f14) {
        ...
        if (abs2 != 0.0f && abs != 0.0f && (f13 != f24 || f14 != f25)) {
            ...
            if (abs2 == f23 && radians == f20) {
                ...
                float f48 = f17945a;
                f17949e.arcTo(new RectF((f44 - abs2) * f48, (f45 - abs2) * f48, (f44 + abs2) * f48, (f45 + abs2) * f48), degrees, abs3);
                f17950f.add(new i0(g.kCGPathElementAddCurveToPoint, new m0[]{new m0(f46, f47)}));
                return;
            }
    ...
    */
    ...
    private static void d() {
        if (f17957m) {
            ...
            f17957m = false;
            f17949e.close();
            f17950f.add(new i0(g.kCGPathElementCloseSubpath, new m0[]{new m0(f17951g, f17952h)}));
        }
    }
    ...
    private static void e(float f10, float f11, float f12, float f13, float f14, float f15) {
        ...
        f17950f.add(new i0(g.kCGPathElementAddCurveToPoint, new m0[]{new m0(f10, f11), new m0(f12, f13), new m0(f14, f15)}));
    }
    ...
    private static void l(float f10, float f11) {
        ...
        f17950f.add(new i0(g.kCGPathElementAddLineToPoint, new m0[]{new m0(f10, f11)}));
    }

    private static void m(float f10, float f11) {
        n(f10 + f17951g, f11 + f17952h);
    }
    ...
    private static void n(float f10, float f11) {
        ...
        f17950f.add(new i0(g.kCGPathElementMoveToPoint, new m0[]{new m0(f10, f11)}));
    }

    /* JADX INFO: Access modifiers changed from: package-private */
    public static Path o(String str) {
        boolean z10;
        f17950f = new ArrayList();
        Path path = new Path();
        f17949e = path;
        if (str == null) {
            return path;
        ...
        while (f17946b < f17947c) {
            ...
            if (i10 < f17947c) {
                ...
                char charAt = f17948d.charAt(i10);
                if (!z10 && charAt != 'M' && charAt != 'm') {
                    throw new IllegalArgumentException(String.format("Unexpected character '%c' (i=%d, s=%s)", Character.valueOf(charAt), Integer.valueOf(f17946b), f17948d));
                }
                if (i(charAt)) {
                    f17946b++;
                    z11 = false;
                    ...
                    if (c10 != 'Z' && c10 != 'z') {
                        ...
                        throw new IllegalArgumentException(String.format("Unexpected number after 'z' (s=%s)", f17948d));
                    }
                } else {
                    throw new IllegalArgumentException(String.format("Unexpected character '%c' (i=%d, s=%s)", Character.valueOf(charAt), Integer.valueOf(f17946b), f17948d));
                }
                ...
                switch (c10) {
                    ...
                    case 'v':
                        ...
                        break;
                    default:
                        throw new IllegalArgumentException(String.format("Unexpected comand '%c' (s=%s)", Character.valueOf(c10), f17948d));
                }
                if (z11) {
                    if (h10) {
                        c10 = 'M';
    ...
    private static boolean p() {
        y();
        char charAt = f17948d.charAt(f17946b);
        if (charAt != '0' && charAt != '1') {
            throw new Error(String.format("Unexpected flag '%c' (i=%d, s=%s)", Character.valueOf(charAt), Integer.valueOf(f17946b), f17948d));
        }
        int i10 = f17946b + 1;
        f17946b = i10;
        if (i10 < f17947c && f17948d.charAt(i10) == ',') {
            f17946b++;
        }
        y();
        if (charAt == '1') {
    ...
    private static float q() {
        ...
        throw new Error(String.format("Unexpected end (s=%s)", f17948d));
    }
    ...
    private static float s() {
        ...
        int i10 = f17946b;
        if (i10 != f17947c) {
            char charAt2 = f17948d.charAt(i10);
            if (charAt2 == '-' || charAt2 == '+') {
                int i11 = f17946b + 1;
                f17946b = i11;
                charAt2 = f17948d.charAt(i11);
            }
            if (charAt2 >= '0' && charAt2 <= '9') {
                x();
                int i12 = f17946b;
                if (i12 < f17947c) {
                    charAt2 = f17948d.charAt(i12);
                }
            } else if (charAt2 != '.') {
                throw new IllegalArgumentException(String.format("Invalid number formating character '%c' (i=%d, s=%s)", Character.valueOf(charAt2), Integer.valueOf(f17946b), f17948d));
            }
            if (charAt2 == '.') {
                f17946b++;
                x();
                int i13 = f17946b;
                if (i13 < f17947c) {
                    charAt2 = f17948d.charAt(i13);
                }
            }
            if (charAt2 == 'e' || charAt2 == 'E') {
                int i14 = f17946b;
                if (i14 + 1 < f17947c && (charAt = f17948d.charAt(i14 + 1)) != 'm' && charAt != 'x') {
                    int i15 = f17946b + 1;
                    f17946b = i15;
                    char charAt3 = f17948d.charAt(i15);
                    if (charAt3 != '+' && charAt3 != '-') {
                        if (charAt3 >= '0' && charAt3 <= '9') {
                            x();
                        } else {
                            throw new IllegalArgumentException(String.format("Invalid number formating character '%c' (i=%d, s=%s)", Character.valueOf(charAt3), Integer.valueOf(f17946b), f17948d));
                        }
                    } else {
                        f17946b++;
                        x();
            ...
            String substring = f17948d.substring(i10, f17946b);
            float parseFloat = Float.parseFloat(substring);
            if (!Float.isInfinite(parseFloat) && !Float.isNaN(parseFloat)) {
                return parseFloat;
            }
            throw new IllegalArgumentException(String.format("Invalid number '%s' (start=%d, i=%d, s=%s)", substring, Integer.valueOf(i10), Integer.valueOf(f17946b), f17948d));
        }
        throw new Error(String.format("Unexpected end (s=%s)", f17948d));
    }
    ...
    private static void u(float f10, float f11, float f12, float f13) {
        ...
        float f14 = f10 * 2.0f;
        float f15 = f11 * 2.0f;
        float f16 = (f17951g + f14) / 3.0f;
        float f17 = (f17952h + f15) / 3.0f;
    ...
    private static void x() {
        while (true) {
            int i10 = f17946b;
            if (i10 < f17947c && Character.isDigit(f17948d.charAt(i10))) {
                f17946b++;
            } else {
                return;
            }
    ...
    private static void y() {
        while (true) {
            int i10 = f17946b;
            if (i10 < f17947c && Character.isWhitespace(f17948d.charAt(i10))) {
                f17946b++;
            } else {
                return;
            }
