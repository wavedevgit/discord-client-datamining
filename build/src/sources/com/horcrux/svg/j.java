...
class j extends q {
    ...
    static /* synthetic */ class a {
        ...
        static {
            ...
            try {
                f17944a[t.NORMAL.ordinal()] = 2;
            } catch (NoSuchFieldError unused2) {
            }
            try {
                f17944a[t.SCREEN.ordinal()] = 3;
            } catch (NoSuchFieldError unused3) {
            }
            try {
                f17944a[t.LIGHTEN.ordinal()] = 4;
            } catch (NoSuchFieldError unused4) {
            }
            try {
                f17944a[t.DARKEN.ordinal()] = 5;
            } catch (NoSuchFieldError unused5) {
            }
            try {
                f17944a[t.MULTIPLY.ordinal()] = 6;
    ...
    public j(ReactContext reactContext) {
        super(reactContext);
        this.f18027e.mX = new SVGLength(0.0d);
        this.f18027e.mY = new SVGLength(0.0d);
        this.f18027e.mW = new SVGLength("100%");
        this.f18027e.mH = new SVGLength("100%");
    }
    ...
    public Bitmap c(HashMap hashMap, Bitmap bitmap) {
        Bitmap e10 = q.e(hashMap, bitmap, this.f17941i);
        Bitmap e11 = q.e(hashMap, bitmap, this.f17942o);
        if (this.f17943p == t.MULTIPLY) {
        ...
        int i10 = a.f17944a[this.f17943p.ordinal()];
        if (i10 != 1 && i10 != 2) {
            if (i10 != 3) {
                if (i10 != 4) {
                    if (i10 == 5) {
