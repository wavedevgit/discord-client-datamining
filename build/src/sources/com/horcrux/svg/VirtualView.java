...
public abstract class VirtualView extends ReactViewGroup {
    ...
    public static /* synthetic */ class a {
        ...
        static {
            ...
            try {
                f16381a[SVGLength.UnitType.EXS.ordinal()] = 2;
            } catch (NoSuchFieldError unused2) {
            }
            try {
                f16381a[SVGLength.UnitType.CM.ordinal()] = 3;
            } catch (NoSuchFieldError unused3) {
            }
            try {
                f16381a[SVGLength.UnitType.MM.ordinal()] = 4;
            } catch (NoSuchFieldError unused4) {
            }
            try {
                f16381a[SVGLength.UnitType.IN.ordinal()] = 5;
            } catch (NoSuchFieldError unused5) {
            }
            try {
                f16381a[SVGLength.UnitType.PT.ordinal()] = 6;
            } catch (NoSuchFieldError unused6) {
            }
            try {
                f16381a[SVGLength.UnitType.PC.ordinal()] = 7;
    ...
    private double fromRelativeFast(SVGLength sVGLength) {
        ...
        switch (a.f16381a[sVGLength.f16341b.ordinal()]) {
            case 1:
        ...
        return sVGLength.f16340a * fontSizeFromContext * this.mScale;
    }
    ...
    public double relativeOn(SVGLength sVGLength, float f10) {
        ...
        if (unitType == SVGLength.UnitType.NUMBER) {
            return sVGLength.f16340a * this.mScale;
        }
        if (unitType == SVGLength.UnitType.PERCENTAGE) {
            return (sVGLength.f16340a / 100.0d) * f10;
        }
    ...
    public double relativeOnFraction(SVGLength sVGLength, float f10) {
        ...
        SVGLength.UnitType unitType = sVGLength.f16341b;
        if (unitType == SVGLength.UnitType.NUMBER) {
            d10 = sVGLength.f16340a;
        } else if (unitType == SVGLength.UnitType.PERCENTAGE) {
            d10 = sVGLength.f16340a / 100.0d;
        } else {
            return fromRelativeFast(sVGLength);
        }
        return d10 * f10;
    ...
    public double relativeOnHeight(SVGLength sVGLength) {
        SvgView svgView = getSvgView();
        if (sVGLength.f16341b == SVGLength.UnitType.PERCENTAGE && svgView != null && svgView.getViewBox().height() != 0.0f) {
    ...
    public double relativeOnWidth(SVGLength sVGLength) {
        SvgView svgView = getSvgView();
        if (sVGLength.f16341b == SVGLength.UnitType.PERCENTAGE && svgView != null && svgView.getViewBox().width() != 0.0f) {
