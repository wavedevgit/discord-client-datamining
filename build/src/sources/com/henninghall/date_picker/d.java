...
public class d {
    ...
    public static /* synthetic */ class a {
        ...
        static {
            ...
            try {
                f17612a[al.b.time.ordinal()] = 2;
            } catch (NoSuchFieldError unused2) {
            }
            try {
                f17612a[al.b.date.ordinal()] = 3;
    ...
    private ArrayList c() {
        String replaceAll = h.c(this.f17611a.u()).replaceAll("\\('(.+?)'\\)", "\\${$1}").replaceAll("'.+?'", "").replaceAll("\\$\\{(.+?)\\}", "('$1')");
    ...
    public String a() {
        Calendar t10 = this.f17611a.t();
        String s10 = this.f17611a.s();
        if (t10 != null) {
            return o.b(t10);
        }
        return s10;
    ...
    public ArrayList e() {
        ArrayList arrayList = new ArrayList();
        al.b z10 = this.f17611a.z();
        int i10 = a.f17612a[z10.ordinal()];
        if (i10 != 1) {
            if (i10 != 2) {
                if (i10 == 3) {
        ...
        if ((z10 == al.b.time || z10 == al.b.datetime) && this.f17611a.f17726o.g()) {
    ...
    public boolean g() {
        if (this.f17611a.r() == al.a.locale) {
            return h.h(this.f17611a.u());
        }
        return o.c();
    }
}
