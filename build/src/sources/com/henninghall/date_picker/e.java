...
public abstract class e {
    private static DeviceEventManagerModule.RCTDeviceEventEmitter a() {
        return (DeviceEventManagerModule.RCTDeviceEventEmitter) c.f17468a.getJSModule(DeviceEventManagerModule.RCTDeviceEventEmitter.class);
    }
    ...
    public static void e(kl.c cVar, String str, View view) {
        WritableMap createMap = Arguments.createMap();
