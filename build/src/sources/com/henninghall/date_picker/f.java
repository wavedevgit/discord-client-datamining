...
public abstract class f {
    ...
    public static EnumMap f16584a = c("EEE, MMM d", "d", "y");

    /* renamed from: b  reason: collision with root package name */
    private static HashMap f16585b = new a();
    ...
    public class b extends EnumMap {
        ...
        final /* synthetic */ String f16588i;
    ...
    public static String b(String str, c cVar) {
        try {
            return ((String) ((EnumMap) f16585b.get(str)).get(cVar)).replaceAll(",", "");
