...
public final class DatabaseVersions {
    ...
    static {
        ...
        }), l.a(oVar, new Function0() { // from class: com.discord.app_database.c
            @Override // kotlin.jvm.functions.Function0
            public final Object invoke() {
    ...
    public static final /* synthetic */ void write$Self$app_database_release(DatabaseVersions databaseVersions, CompositeEncoder compositeEncoder, SerialDescriptor serialDescriptor) {
        ...
        compositeEncoder.j(serialDescriptor, 0, (xs.o) lazyArr[0].getValue(), databaseVersions.guildVersions);
        compositeEncoder.j(serialDescriptor, 1, (xs.o) lazyArr[1].getValue(), databaseVersions.nonGuildVersions);
    }
