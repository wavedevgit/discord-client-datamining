...
public final class GuildVersion {
    ...
    public static final /* synthetic */ void write$Self$app_database_release(GuildVersion guildVersion, CompositeEncoder compositeEncoder, SerialDescriptor serialDescriptor) {
        compositeEncoder.z(serialDescriptor, 0, guildVersion.f8430id);
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof GuildVersion) {
            ...
            return Intrinsics.areEqual(this.f8430id, guildVersion.f8430id) && this.version == guildVersion.version;
        }
        return false;
    }
    ...
    public int hashCode() {
        return (this.f8430id.hashCode() * 31) + Long.hashCode(this.version);
    }
