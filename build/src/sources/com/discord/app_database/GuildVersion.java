...
public final class GuildVersion {
    ...
    public static final /* synthetic */ void write$Self$app_database_release(GuildVersion guildVersion, CompositeEncoder compositeEncoder, SerialDescriptor serialDescriptor) {
        compositeEncoder.y(serialDescriptor, 0, guildVersion.f9549id);
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof GuildVersion) {
            ...
            return Intrinsics.areEqual(this.f9549id, guildVersion.f9549id) && this.version == guildVersion.version;
        }
        return false;
    }
    ...
    public int hashCode() {
        return (this.f9549id.hashCode() * 31) + Long.hashCode(this.version);
    }

    @NotNull
    public String toString() {
        String str = this.f9549id;
