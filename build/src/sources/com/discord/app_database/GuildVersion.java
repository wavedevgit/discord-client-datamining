...
public final class GuildVersion {
    ...
    public static final /* synthetic */ void write$Self$app_database_release(GuildVersion guildVersion, CompositeEncoder compositeEncoder, SerialDescriptor serialDescriptor) {
        compositeEncoder.x(serialDescriptor, 0, guildVersion.f9178id);
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof GuildVersion) {
            ...
            return Intrinsics.areEqual(this.f9178id, guildVersion.f9178id) && this.version == guildVersion.version;
        }
        return false;
    }
    ...
    public int hashCode() {
        return (this.f9178id.hashCode() * 31) + Long.hashCode(this.version);
    }

    @NotNull
    public String toString() {
        String str = this.f9178id;
