...
public final class NonGuildVersion {
    ...
    public static final /* synthetic */ void write$Self$app_database_release(NonGuildVersion nonGuildVersion, CompositeEncoder compositeEncoder, SerialDescriptor serialDescriptor) {
        compositeEncoder.y(serialDescriptor, 0, nonGuildVersion.f8147id);
        ...
        if (compositeEncoder.z(serialDescriptor, 2) || nonGuildVersion.versionString != null) {
            compositeEncoder.s(serialDescriptor, 2, n2.f20978a, nonGuildVersion.versionString);
        }
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof NonGuildVersion) {
            ...
            return Intrinsics.areEqual(this.f8147id, nonGuildVersion.f8147id) && this.version == nonGuildVersion.version && Intrinsics.areEqual(this.versionString, nonGuildVersion.versionString);
        }
        return false;
    }
    ...
    public int hashCode() {
        int hashCode = ((this.f8147id.hashCode() * 31) + Long.hashCode(this.version)) * 31;
