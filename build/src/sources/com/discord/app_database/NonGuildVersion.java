...
public final class NonGuildVersion {
    ...
    public static final /* synthetic */ void write$Self$app_database_release(NonGuildVersion nonGuildVersion, CompositeEncoder compositeEncoder, SerialDescriptor serialDescriptor) {
        compositeEncoder.x(serialDescriptor, 0, nonGuildVersion.f9179id);
        if (compositeEncoder.y(serialDescriptor, 1) || nonGuildVersion.version != 0) {
            compositeEncoder.E(serialDescriptor, 1, nonGuildVersion.version);
        }
        if (compositeEncoder.y(serialDescriptor, 2) || nonGuildVersion.versionString != null) {
            compositeEncoder.B(serialDescriptor, 2, n2.f7662a, nonGuildVersion.versionString);
        }
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof NonGuildVersion) {
            ...
            return Intrinsics.areEqual(this.f9179id, nonGuildVersion.f9179id) && this.version == nonGuildVersion.version && Intrinsics.areEqual(this.versionString, nonGuildVersion.versionString);
        }
        return false;
    }
    ...
    public int hashCode() {
        int hashCode = ((this.f9179id.hashCode() * 31) + Long.hashCode(this.version)) * 31;
