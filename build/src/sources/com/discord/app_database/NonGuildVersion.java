...
public final class NonGuildVersion {
    ...
    public static final /* synthetic */ void write$Self$app_database_release(NonGuildVersion nonGuildVersion, CompositeEncoder compositeEncoder, SerialDescriptor serialDescriptor) {
        compositeEncoder.y(serialDescriptor, 0, nonGuildVersion.f8571id);
        if (compositeEncoder.z(serialDescriptor, 1) || nonGuildVersion.version != 0) {
            compositeEncoder.D(serialDescriptor, 1, nonGuildVersion.version);
        }
        if (compositeEncoder.z(serialDescriptor, 2) || nonGuildVersion.versionString != null) {
            compositeEncoder.i(serialDescriptor, 2, n2.f35181a, nonGuildVersion.versionString);
        }
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof NonGuildVersion) {
            ...
            return Intrinsics.areEqual(this.f8571id, nonGuildVersion.f8571id) && this.version == nonGuildVersion.version && Intrinsics.areEqual(this.versionString, nonGuildVersion.versionString);
        }
        return false;
    }
    ...
    public int hashCode() {
        int hashCode = ((this.f8571id.hashCode() * 31) + Long.hashCode(this.version)) * 31;
