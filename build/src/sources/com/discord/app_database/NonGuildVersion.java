...
public final class NonGuildVersion {
    ...
    public static final /* synthetic */ void write$Self$app_database_release(NonGuildVersion nonGuildVersion, CompositeEncoder compositeEncoder, SerialDescriptor serialDescriptor) {
        compositeEncoder.y(serialDescriptor, 0, nonGuildVersion.f9550id);
        ...
        if (compositeEncoder.A(serialDescriptor, 2) || nonGuildVersion.versionString != null) {
            compositeEncoder.z(serialDescriptor, 2, n2.f6848a, nonGuildVersion.versionString);
        }
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof NonGuildVersion) {
            ...
            return Intrinsics.areEqual(this.f9550id, nonGuildVersion.f9550id) && this.version == nonGuildVersion.version && Intrinsics.areEqual(this.versionString, nonGuildVersion.versionString);
        }
        return false;
    }
    ...
    public int hashCode() {
        int hashCode = ((this.f9550id.hashCode() * 31) + Long.hashCode(this.version)) * 31;
