...
public final class NonGuildVersion {
    ...
    public static final /* synthetic */ void write$Self$app_database_release(NonGuildVersion nonGuildVersion, CompositeEncoder compositeEncoder, SerialDescriptor serialDescriptor) {
        compositeEncoder.x(serialDescriptor, 0, nonGuildVersion.f8532id);
        ...
        if (compositeEncoder.z(serialDescriptor, 2) || nonGuildVersion.versionString != null) {
            compositeEncoder.A(serialDescriptor, 2, n2.f25302a, nonGuildVersion.versionString);
        }
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof NonGuildVersion) {
            ...
            return Intrinsics.areEqual(this.f8532id, nonGuildVersion.f8532id) && this.version == nonGuildVersion.version && Intrinsics.areEqual(this.versionString, nonGuildVersion.versionString);
        }
        return false;
    }
    ...
    public int hashCode() {
        int hashCode = ((this.f8532id.hashCode() * 31) + Long.hashCode(this.version)) * 31;
