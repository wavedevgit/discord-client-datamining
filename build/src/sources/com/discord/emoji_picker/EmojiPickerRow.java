    ...
    public static final class Emoji {
        ...
        public boolean equals(Object obj) {
            ...
            if (obj instanceof Emoji) {
                ...
                return Intrinsics.areEqual(this.f9925id, emoji.f9925id) && Intrinsics.areEqual(this.name, emoji.name) && Intrinsics.areEqual(this.url, emoji.url) && this.animated == emoji.animated && this.disabled == emoji.disabled;
            }
            return false;
        }
