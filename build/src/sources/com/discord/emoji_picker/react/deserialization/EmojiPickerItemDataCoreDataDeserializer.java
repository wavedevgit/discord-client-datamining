...
public final class EmojiPickerItemDataCoreDataDeserializer {
    ...
    private final void deserializeTypeNativeSection(ReadableMap readableMap, List<EmojiPickerItemData.CoreData.NativeSection.Guild> list, List<EmojiPickerItemData.CoreData.NativeSection.Unicode> list2, boolean z10) {
        ...
        if (string != null) {
            ...
            ReadableArray nonNullArray2 = NativeMapExtensionsKt.getNonNullArray(readableMap, "emojisHidden");
            HashSet hashSet2 = new HashSet();
            Iterator it2 = NativeArrayExtensionsKt.sizeRange(nonNullArray2).iterator();
            while (it2.hasNext()) {
                String string3 = nonNullArray2.getString(((m0) it2).nextInt());
                Intrinsics.checkNotNull(string3);
                hashSet2.add(Long.valueOf(Long.parseLong(string3)));
            }
            list.add(new EmojiPickerItemData.CoreData.NativeSection.Guild(string, nonNullString, i10, hashSet, hashSet2, z10, readableMap.getBoolean("hasPremiumInlineRoadblockHeader"), readableMap.getBoolean("hasPremiumInlineRoadblockFooter")));
            return;
        }
