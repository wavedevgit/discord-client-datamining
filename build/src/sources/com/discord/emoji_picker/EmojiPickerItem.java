...
public abstract class EmojiPickerItem {
    ...
    public static final class EmojiPlaceholder extends EmojiPickerItem {
        ...
        public boolean equals(Object obj) {
            ...
            return (obj instanceof EmojiPlaceholder) && this.f9342id == ((EmojiPlaceholder) obj).f9342id;
        }

        public int hashCode() {
            return Long.hashCode(this.f9342id);
        }
    ...
    public static final class FooterUpsell extends EmojiPickerItem {
        ...
        public boolean equals(Object obj) {
            ...
            return (obj instanceof FooterUpsell) && Intrinsics.areEqual(this.f9343id, ((FooterUpsell) obj).f9343id);
        }
        ...
        public int hashCode() {
            return this.f9343id.hashCode();
        }

        @Override // com.discord.emoji_picker.EmojiPickerItem
        public long itemId() {
            return IdUtilsKt.convertToId(this.f9343id);
        }
    ...
    public static final class PremiumInlineRoadblockFooter extends EmojiPickerItem {
        ...
        public static /* synthetic */ PremiumInlineRoadblockFooter copy$default(PremiumInlineRoadblockFooter premiumInlineRoadblockFooter, String str, int i10, Object obj) {
            if ((i10 & 1) != 0) {
                str = premiumInlineRoadblockFooter.f9344id;
            }
        ...
        public boolean equals(Object obj) {
            ...
            return (obj instanceof PremiumInlineRoadblockFooter) && Intrinsics.areEqual(this.f9344id, ((PremiumInlineRoadblockFooter) obj).f9344id);
        }
        ...
        public int hashCode() {
            return this.f9344id.hashCode();
        }

        @Override // com.discord.emoji_picker.EmojiPickerItem
        public long itemId() {
            return IdUtilsKt.convertToId(this.f9344id);
        }
    ...
    public static final class PremiumInlineRoadblockHeader extends EmojiPickerItem {
        ...
        public static /* synthetic */ PremiumInlineRoadblockHeader copy$default(PremiumInlineRoadblockHeader premiumInlineRoadblockHeader, String str, int i10, Object obj) {
            if ((i10 & 1) != 0) {
                str = premiumInlineRoadblockHeader.f9345id;
            }
        ...
        public boolean equals(Object obj) {
            ...
            return (obj instanceof PremiumInlineRoadblockHeader) && Intrinsics.areEqual(this.f9345id, ((PremiumInlineRoadblockHeader) obj).f9345id);
        }
        ...
        public int hashCode() {
            return this.f9345id.hashCode();
        }

        @Override // com.discord.emoji_picker.EmojiPickerItem
        public long itemId() {
            return IdUtilsKt.convertToId(this.f9345id);
        }
    ...
    public static final class Spacer extends EmojiPickerItem {
        ...
        public boolean equals(Object obj) {
            ...
            if (obj instanceof Spacer) {
                ...
                return Intrinsics.areEqual(this.f9346id, spacer.f9346id) && this.height == spacer.height;
            }
            return false;
        }
        ...
        public int hashCode() {
            return (this.f9346id.hashCode() * 31) + Integer.hashCode(this.height);
        }

        @Override // com.discord.emoji_picker.EmojiPickerItem
        public long itemId() {
            return IdUtilsKt.convertToId(this.f9346id);
        }
    ...
    public static final class Category extends EmojiPickerItem {
        ...
        public boolean equals(Object obj) {
            ...
            if (obj instanceof Category) {
                ...
                return Intrinsics.areEqual(this.title, category.title) && this.f9340id == category.f9340id && this.isInsidePremiumRoadBlock == category.isInsidePremiumRoadBlock;
            }
            return false;
        }
        ...
        public int hashCode() {
            return (((this.title.hashCode() * 31) + Long.hashCode(this.f9340id)) * 31) + Boolean.hashCode(this.isInsidePremiumRoadBlock);
        }
    ...
    public static final class Emoji extends EmojiPickerItem {
        ...
        public boolean equals(Object obj) {
            ...
            if (obj instanceof Emoji) {
                ...
                return this.f9341id == emoji.f9341id && Intrinsics.areEqual(this.name, emoji.name) && this.animated == emoji.animated && this.disabled == emoji.disabled && Intrinsics.areEqual(this.unicode, emoji.unicode) && this.isInsidePremiumRoadBlock == emoji.isInsidePremiumRoadBlock;
            }
            return false;
        }
        ...
        public int hashCode() {
            int hashCode = ((((((Long.hashCode(this.f9341id) * 31) + this.name.hashCode()) * 31) + Boolean.hashCode(this.animated)) * 31) + this.disabled.hashCode()) * 31;
            UnicodeEmojis.Emoji emoji = this.unicode;
