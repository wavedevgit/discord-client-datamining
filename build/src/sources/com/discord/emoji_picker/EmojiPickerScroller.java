...
public final class EmojiPickerScroller {
    ...
    public static final class ScrollEvent {
        ...
        public static /* synthetic */ ScrollEvent copy$default(ScrollEvent scrollEvent, int i10, int i11, int i12, int i13, int i14, int i15, int i16, Object obj) {
            if ((i16 & 1) != 0) {
                i10 = scrollEvent.f9348x;
            }
            if ((i16 & 2) != 0) {
                i11 = scrollEvent.f9349y;
            }
            if ((i16 & 4) != 0) {
        ...
        public boolean equals(Object obj) {
            ...
            if (obj instanceof ScrollEvent) {
                ...
                return this.f9348x == scrollEvent.f9348x && this.f9349y == scrollEvent.f9349y && this.width == scrollEvent.width && this.height == scrollEvent.height && this.contentWidth == scrollEvent.contentWidth && this.contentHeight == scrollEvent.contentHeight;
            }
            return false;
        }
        ...
        public int hashCode() {
            return (((((((((Integer.hashCode(this.f9348x) * 31) + Integer.hashCode(this.f9349y)) * 31) + Integer.hashCode(this.width)) * 31) + Integer.hashCode(this.height)) * 31) + Integer.hashCode(this.contentWidth)) * 31) + Integer.hashCode(this.contentHeight);
        }
