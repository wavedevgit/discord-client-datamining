...
public class OnScrollEvent implements ReactEvent {
    ...
    private final float f9403x;

    /* renamed from: y  reason: collision with root package name */
    private final float f9404y;
    ...
    public WritableMap serialize() {
        return NativeMapExtensionsKt.nativeMapOf(v.a("contentInset", NativeMapExtensionsKt.nativeMapOf(v.a(ViewProps.LEFT, 0), v.a(ViewProps.TOP, 0), v.a(ViewProps.BOTTOM, 0), v.a(ViewProps.RIGHT, 0))), v.a("contentOffset", NativeMapExtensionsKt.nativeMapOf(v.a("x", Float.valueOf(this.f9403x)), v.a("y", Float.valueOf(this.f9404y)))), v.a("contentSize", NativeMapExtensionsKt.nativeMapOf(v.a("width", Float.valueOf(this.contentWidth)), v.a("height", Float.valueOf(this.contentHeight)))), v.a("layoutMeasurement", NativeMapExtensionsKt.nativeMapOf(v.a("width", Float.valueOf(this.width)), v.a("height", Float.valueOf(this.height)))));
    }
