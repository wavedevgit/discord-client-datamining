...
public final class SoundExtensionsKt$fetchSound$1 extends k implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
    ...
    public static final class AnonymousClass1<T> implements FlowCollector {
        ...
        /* loaded from: /home/runner/work/discord-client-datamining/discord-client-datamining/build/classes3.dex */
        public static final class C01421 extends k implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
            ...
            /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
            /* JADX WARN: Multi-variable type inference failed */
            C01421(SoundManager soundManager, int i10, int i11, DownloadState downloadState, Function1<? super Integer, Unit> function1, Continuation<? super C01421> continuation) {
                super(2, continuation);
                this.$soundManager = soundManager;
                this.$key = i10;
                this.$usage = i11;
            ...
            @Override // kotlin.coroutines.jvm.internal.a
            public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
                return new C01421(this.$soundManager, this.$key, this.$usage, this.$downloadState, this.$soundResIdPrepared, continuation);
            }
        ...
        /* JADX WARN: Code restructure failed: missing block: B:24:0x0067, code lost:
            if (os.g.g(r0, r9, r2) == r3) goto L28;
         */
        /* JADX WARN: Code restructure failed: missing block: B:27:0x0079, code lost:
            if (os.g.g(r4, r6, r2) != r3) goto L19;
         */
        /* JADX WARN: Code restructure failed: missing block: B:32:0x008e, code lost:
            if (os.g.g(r0, r4, r2) == r3) goto L28;
         */
        ...
        */
        public final java.lang.Object emit(com.discord.file_downloader.DownloadState r17, kotlin.coroutines.Continuation<? super kotlin.Unit> r18) {
            ...
            L46:
                ...
                if (r0 == 0) goto L7f
                os.c1 r0 = os.m0.c()     // Catch: java.lang.Exception -> L44
                ...
                java.lang.Object r0 = os.g.g(r0, r9, r2)     // Catch: java.lang.Exception -> L44
                if (r0 != r3) goto L7c
                goto L90
            L6a:
                os.c1 r4 = os.m0.c()
                ...
                r6.<init>(r0, r5)
                r2.label = r7
                java.lang.Object r0 = os.g.g(r4, r6, r2)
                if (r0 != r3) goto L7c
                goto L90
            L7c:
            ...
            L7f:
                ...
                r4.<init>(r5)
                r2.label = r6
                java.lang.Object r0 = os.g.g(r0, r4, r2)
                if (r0 != r3) goto L91
            L90:
                return r3
            L91:
