...
public final class TimeElapsed {
    ...
    public TimeElapsed(long j10) {
        this.startTime = j10;
        this.durationMillis$delegate = l.b(new Function0() { // from class: com.discord.misc.utilities.time.a
        ...
        this.duration$delegate = l.b(new Function0() { // from class: com.discord.misc.utilities.time.b
            @Override // kotlin.jvm.functions.Function0
            public final Object invoke() {
