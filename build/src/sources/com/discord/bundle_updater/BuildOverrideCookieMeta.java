...
public final class BuildOverrideCookieMeta {
    ...
    static {
        ...
        $childSerializers = new Lazy[]{null, null, rr.l.b(oVar, new Function0() { // from class: com.discord.bundle_updater.c
        ...
        }), rr.l.b(oVar, new Function0() { // from class: com.discord.bundle_updater.d
            @Override // kotlin.jvm.functions.Function0
            public final Object invoke() {
        ...
        }), null, rr.l.b(oVar, new Function0() { // from class: com.discord.bundle_updater.e
            @Override // kotlin.jvm.functions.Function0
            public final Object invoke() {
    ...
    public static final /* synthetic */ KSerializer _childSerializers$_anonymous_$1() {
        return new u0(n2.f35181a, p0.f35197a);
    }
    ...
    public static final /* synthetic */ void write$Self$bundle_updater_release(BuildOverrideCookieMeta buildOverrideCookieMeta, CompositeEncoder compositeEncoder, SerialDescriptor serialDescriptor) {
        ...
        if (compositeEncoder.z(serialDescriptor, 0) || buildOverrideCookieMeta.expiresAt != null) {
            compositeEncoder.i(serialDescriptor, 0, n2.f35181a, buildOverrideCookieMeta.expiresAt);
        }
        if (compositeEncoder.z(serialDescriptor, 1) || buildOverrideCookieMeta.releaseChannel != null) {
            compositeEncoder.i(serialDescriptor, 1, n2.f35181a, buildOverrideCookieMeta.releaseChannel);
        }
        if (compositeEncoder.z(serialDescriptor, 2) || buildOverrideCookieMeta.validForUserIds != null) {
            compositeEncoder.i(serialDescriptor, 2, (gt.o) lazyArr[2].getValue(), buildOverrideCookieMeta.validForUserIds);
        }
        if (compositeEncoder.z(serialDescriptor, 3) || buildOverrideCookieMeta.allowedVersions != null) {
            compositeEncoder.i(serialDescriptor, 3, (gt.o) lazyArr[3].getValue(), buildOverrideCookieMeta.allowedVersions);
        }
        if (compositeEncoder.z(serialDescriptor, 4) || buildOverrideCookieMeta.allowLoggedOut != null) {
            compositeEncoder.i(serialDescriptor, 4, kt.h.f35145a, buildOverrideCookieMeta.allowLoggedOut);
        }
        if (compositeEncoder.z(serialDescriptor, 5) || buildOverrideCookieMeta.experiments != null) {
            compositeEncoder.i(serialDescriptor, 5, (gt.o) lazyArr[5].getValue(), buildOverrideCookieMeta.experiments);
        }
    }
