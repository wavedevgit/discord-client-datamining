...
public final class BuildOverrideCookieMeta {
    ...
    static {
        ...
        $childSerializers = new Lazy[]{null, null, lr.l.b(oVar, new Function0() { // from class: com.discord.bundle_updater.c
        ...
        }), lr.l.b(oVar, new Function0() { // from class: com.discord.bundle_updater.d
            @Override // kotlin.jvm.functions.Function0
            public final Object invoke() {
        ...
        }), null, lr.l.b(oVar, new Function0() { // from class: com.discord.bundle_updater.e
            @Override // kotlin.jvm.functions.Function0
            public final Object invoke() {
    ...
    public static final /* synthetic */ KSerializer _childSerializers$_anonymous_$1() {
        return new u0(n2.f20978a, p0.f20994a);
    }
    ...
    public static final /* synthetic */ void write$Self$bundle_updater_release(BuildOverrideCookieMeta buildOverrideCookieMeta, CompositeEncoder compositeEncoder, SerialDescriptor serialDescriptor) {
        ...
        if (compositeEncoder.z(serialDescriptor, 0) || buildOverrideCookieMeta.expiresAt != null) {
            compositeEncoder.s(serialDescriptor, 0, n2.f20978a, buildOverrideCookieMeta.expiresAt);
        }
        if (compositeEncoder.z(serialDescriptor, 1) || buildOverrideCookieMeta.releaseChannel != null) {
            compositeEncoder.s(serialDescriptor, 1, n2.f20978a, buildOverrideCookieMeta.releaseChannel);
        }
        if (compositeEncoder.z(serialDescriptor, 2) || buildOverrideCookieMeta.validForUserIds != null) {
            compositeEncoder.s(serialDescriptor, 2, (at.o) lazyArr[2].getValue(), buildOverrideCookieMeta.validForUserIds);
        }
        if (compositeEncoder.z(serialDescriptor, 3) || buildOverrideCookieMeta.allowedVersions != null) {
            compositeEncoder.s(serialDescriptor, 3, (at.o) lazyArr[3].getValue(), buildOverrideCookieMeta.allowedVersions);
        }
        if (compositeEncoder.z(serialDescriptor, 4) || buildOverrideCookieMeta.allowLoggedOut != null) {
            compositeEncoder.s(serialDescriptor, 4, dt.h.f20942a, buildOverrideCookieMeta.allowLoggedOut);
        }
        if (compositeEncoder.z(serialDescriptor, 5) || buildOverrideCookieMeta.experiments != null) {
            compositeEncoder.s(serialDescriptor, 5, (at.o) lazyArr[5].getValue(), buildOverrideCookieMeta.experiments);
        }
    }
