...
public final class BuildOverrideCookieBuild {
    ...
    public static /* synthetic */ BuildOverrideCookieBuild copy$default(BuildOverrideCookieBuild buildOverrideCookieBuild, String str, String str2, int i10, Object obj) {
        ...
        if ((i10 & 2) != 0) {
            str2 = buildOverrideCookieBuild.f8206id;
        }
    ...
    public static final /* synthetic */ void write$Self$bundle_updater_release(BuildOverrideCookieBuild buildOverrideCookieBuild, CompositeEncoder compositeEncoder, SerialDescriptor serialDescriptor) {
        ...
        compositeEncoder.y(serialDescriptor, 1, buildOverrideCookieBuild.f8206id);
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof BuildOverrideCookieBuild) {
            ...
            return Intrinsics.areEqual(this.type, buildOverrideCookieBuild.type) && Intrinsics.areEqual(this.f8206id, buildOverrideCookieBuild.f8206id);
        }
        return false;
    }
    ...
    public int hashCode() {
        return (this.type.hashCode() * 31) + this.f8206id.hashCode();
    }

    @NotNull
    public final WritableNativeMap toNativeMap() {
        return NativeMapExtensionsKt.nativeMapOf(v.a("type", this.type), v.a(StackTraceHelper.ID_KEY, this.f8206id));
    }

    @NotNull
    public String toString() {
        String str = this.type;
        String str2 = this.f8206id;
