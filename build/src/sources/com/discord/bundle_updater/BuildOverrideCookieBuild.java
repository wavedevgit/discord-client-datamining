...
public final class BuildOverrideCookieBuild {
    ...
    public static /* synthetic */ BuildOverrideCookieBuild copy$default(BuildOverrideCookieBuild buildOverrideCookieBuild, String str, String str2, int i10, Object obj) {
        ...
        if ((i10 & 2) != 0) {
            str2 = buildOverrideCookieBuild.f9609id;
        }
    ...
    public static final /* synthetic */ void write$Self$bundle_updater_release(BuildOverrideCookieBuild buildOverrideCookieBuild, CompositeEncoder compositeEncoder, SerialDescriptor serialDescriptor) {
        ...
        compositeEncoder.y(serialDescriptor, 1, buildOverrideCookieBuild.f9609id);
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof BuildOverrideCookieBuild) {
            ...
            return Intrinsics.areEqual(this.type, buildOverrideCookieBuild.type) && Intrinsics.areEqual(this.f9609id, buildOverrideCookieBuild.f9609id);
        }
        return false;
    }
    ...
    public int hashCode() {
        return (this.type.hashCode() * 31) + this.f9609id.hashCode();
    }

    @NotNull
    public final WritableNativeMap toNativeMap() {
        return NativeMapExtensionsKt.nativeMapOf(v.a("type", this.type), v.a(StackTraceHelper.ID_KEY, this.f9609id));
    }

    @NotNull
    public String toString() {
        String str = this.type;
        String str2 = this.f9609id;
