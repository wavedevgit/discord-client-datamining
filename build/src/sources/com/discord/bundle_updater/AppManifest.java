...
public final class AppManifest {
    ...
    static {
        ...
        $childSerializers = new Lazy[]{null, rr.l.b(oVar, new Function0() { // from class: com.discord.bundle_updater.a
        ...
        }), rr.l.b(oVar, new Function0() { // from class: com.discord.bundle_updater.b
            @Override // kotlin.jvm.functions.Function0
            public final Object invoke() {
    ...
    public static final /* synthetic */ void write$Self$bundle_updater_release(AppManifest appManifest, CompositeEncoder compositeEncoder, SerialDescriptor serialDescriptor) {
        ...
        compositeEncoder.F(serialDescriptor, 0, AppManifestMetadata$$serializer.INSTANCE, appManifest.metadata);
        if (compositeEncoder.z(serialDescriptor, 1) || !Intrinsics.areEqual(appManifest.hashes, o0.i())) {
            compositeEncoder.F(serialDescriptor, 1, (gt.o) lazyArr[1].getValue(), appManifest.hashes);
        }
        if (compositeEncoder.z(serialDescriptor, 2) || !Intrinsics.areEqual(appManifest.patches, o0.i())) {
            compositeEncoder.F(serialDescriptor, 2, (gt.o) lazyArr[2].getValue(), appManifest.patches);
        }
    }
