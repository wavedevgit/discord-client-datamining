...
public final class AppManifest {
    ...
    static {
        ...
        $childSerializers = new Lazy[]{null, jr.l.a(oVar, new Function0() { // from class: com.discord.bundle_updater.a
        ...
        }), jr.l.a(oVar, new Function0() { // from class: com.discord.bundle_updater.b
            @Override // kotlin.jvm.functions.Function0
            public final Object invoke() {
    ...
    public static final /* synthetic */ void write$Self$bundle_updater_release(AppManifest appManifest, CompositeEncoder compositeEncoder, SerialDescriptor serialDescriptor) {
        ...
        compositeEncoder.m(serialDescriptor, 0, AppManifestMetadata$$serializer.INSTANCE, appManifest.metadata);
        if (compositeEncoder.y(serialDescriptor, 1) || !Intrinsics.areEqual(appManifest.hashes, o0.i())) {
            compositeEncoder.m(serialDescriptor, 1, (ys.o) lazyArr[1].getValue(), appManifest.hashes);
        }
        if (compositeEncoder.y(serialDescriptor, 2) || !Intrinsics.areEqual(appManifest.patches, o0.i())) {
            compositeEncoder.m(serialDescriptor, 2, (ys.o) lazyArr[2].getValue(), appManifest.patches);
        }
    }
