...
public final class ContactSyncPayloadEntry {
    ...
    public /* synthetic */ ContactSyncPayloadEntry(int i10, String str, SerializationConstructorMarker serializationConstructorMarker) {
        if (1 != (i10 & 1)) {
            v1.b(i10, 1, ContactSyncPayloadEntry$$serializer.INSTANCE.getDescriptor());
        }
        this.friendId = str;
    }
    ...
    public boolean equals(Object obj) {
        ...
        return (obj instanceof ContactSyncPayloadEntry) && Intrinsics.areEqual(this.friendId, ((ContactSyncPayloadEntry) obj).friendId);
    }
