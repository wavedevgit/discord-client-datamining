...
public final class ContactSyncBlobEntry {
    ...
    public static final /* synthetic */ void write$Self$contact_sync_release(ContactSyncBlobEntry contactSyncBlobEntry, CompositeEncoder compositeEncoder, SerialDescriptor serialDescriptor) {
        compositeEncoder.z(serialDescriptor, 0, contactSyncBlobEntry.phone);
        compositeEncoder.z(serialDescriptor, 1, contactSyncBlobEntry.unencryptedName);
        compositeEncoder.y(serialDescriptor, 2, contactSyncBlobEntry.hasImageData);
        compositeEncoder.z(serialDescriptor, 3, contactSyncBlobEntry.deviceContactId);
        compositeEncoder.z(serialDescriptor, 4, contactSyncBlobEntry.givenName);
        compositeEncoder.z(serialDescriptor, 5, contactSyncBlobEntry.familyName);
    }
