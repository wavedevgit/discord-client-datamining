...
public final class ContactSyncBlobEntry {
    ...
    public static final /* synthetic */ void write$Self$contact_sync_release(ContactSyncBlobEntry contactSyncBlobEntry, CompositeEncoder compositeEncoder, SerialDescriptor serialDescriptor) {
        compositeEncoder.x(serialDescriptor, 0, contactSyncBlobEntry.phone);
        compositeEncoder.x(serialDescriptor, 1, contactSyncBlobEntry.unencryptedName);
        compositeEncoder.w(serialDescriptor, 2, contactSyncBlobEntry.hasImageData);
        compositeEncoder.x(serialDescriptor, 3, contactSyncBlobEntry.deviceContactId);
        compositeEncoder.x(serialDescriptor, 4, contactSyncBlobEntry.givenName);
        compositeEncoder.x(serialDescriptor, 5, contactSyncBlobEntry.familyName);
    }
