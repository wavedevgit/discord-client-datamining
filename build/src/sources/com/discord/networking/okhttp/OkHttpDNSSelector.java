...
import qr.a;
import ut.h;
@Metadata(d1 = {"\u0000\"\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0003\n\u0002\u0010\u000e\n\u0000\n\u0002\u0010 \n\u0002\u0018\u0002\n\u0002\b\u0005\b\u0000\u0018\u00002\u00020\u0001:\u0001\rB\u000f\u0012\u0006\u0010\u0003\u001a\u00020\u0002¢\u0006\u0004\b\u0004\u0010\u0005J\u001d\u0010\n\u001a\b\u0012\u0004\u0012\u00020\t0\b2\u0006\u0010\u0007\u001a\u00020\u0006H\u0016¢\u0006\u0004\b\n\u0010\u000bR\u0014\u0010\u0003\u001a\u00020\u00028\u0002X\u0082\u0004¢\u0006\u0006\n\u0004\b\u0003\u0010\f¨\u0006\u000e"}, d2 = {"Lcom/discord/networking/okhttp/OkHttpDNSSelector;", "Lut/h;", "Lcom/discord/networking/okhttp/OkHttpDNSSelector$IPvMode;", "mode", "<init>", "(Lcom/discord/networking/okhttp/OkHttpDNSSelector$IPvMode;)V", "", "hostname", "", "Ljava/net/InetAddress;", "lookup", "(Ljava/lang/String;)Ljava/util/List;", "Lcom/discord/networking/okhttp/OkHttpDNSSelector$IPvMode;", "IPvMode", "networking_release"}, k = 1, mv = {2, 1, 0}, xi = 48)
...
public final class OkHttpDNSSelector implements h {
    ...
    public List<InetAddress> lookup(@NotNull String hostname) {
        ...
        List<InetAddress> lookup = h.f50700b.lookup(hostname);
        ...
        if (i10 != 1) {
            ...
            return CollectionsKt.W0(lookup, new Comparator() { // from class: com.discord.networking.okhttp.OkHttpDNSSelector$lookup$$inlined$sortedBy$2
                ...
                public final int compare(T t10, T t11) {
                    return mr.a.d(Boolean.valueOf(Inet6Address.class.isInstance((InetAddress) t10)), Boolean.valueOf(Inet6Address.class.isInstance((InetAddress) t11)));
                }
            });
        }
        return CollectionsKt.W0(lookup, new Comparator() { // from class: com.discord.networking.okhttp.OkHttpDNSSelector$lookup$$inlined$sortedBy$1
            @Override // java.util.Comparator
            public final int compare(T t10, T t11) {
                return mr.a.d(Boolean.valueOf(Inet4Address.class.isInstance((InetAddress) t10)), Boolean.valueOf(Inet4Address.class.isInstance((InetAddress) t11)));
            }
        });
    }
}
