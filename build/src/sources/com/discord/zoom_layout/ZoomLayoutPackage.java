...
public final class ZoomLayoutPackage extends BaseReactPackage {
    ...
    public Void m1155getModule(@NotNull String name, @NotNull ReactApplicationContext reactContext) {
    ...
    public /* bridge */ /* synthetic */ NativeModule getModule(String str, ReactApplicationContext reactApplicationContext) {
        return (NativeModule) m1155getModule(str, reactApplicationContext);
    }
}
