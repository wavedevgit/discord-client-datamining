...
public final class OnLayoutEvent implements ReactEvent {
    ...
    private final float f10428x;

    /* renamed from: y  reason: collision with root package name */
    private final float f10429y;
    ...
    public static /* synthetic */ OnLayoutEvent copy$default(OnLayoutEvent onLayoutEvent, float f10, float f11, float f12, float f13, int i10, Object obj) {
        if ((i10 & 1) != 0) {
            f10 = onLayoutEvent.f10428x;
        }
        if ((i10 & 2) != 0) {
            f11 = onLayoutEvent.f10429y;
        }
        if ((i10 & 4) != 0) {
    ...
    public static final /* synthetic */ void write$Self$fastest_list_release(OnLayoutEvent onLayoutEvent, CompositeEncoder compositeEncoder, SerialDescriptor serialDescriptor) {
        compositeEncoder.s(serialDescriptor, 0, onLayoutEvent.f10428x);
        compositeEncoder.s(serialDescriptor, 1, onLayoutEvent.f10429y);
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof OnLayoutEvent) {
            ...
            return Float.compare(this.f10428x, onLayoutEvent.f10428x) == 0 && Float.compare(this.f10429y, onLayoutEvent.f10429y) == 0 && Float.compare(this.width, onLayoutEvent.width) == 0 && Float.compare(this.height, onLayoutEvent.height) == 0;
        }
        return false;
    }
    ...
    public int hashCode() {
        return (((((Float.hashCode(this.f10428x) * 31) + Float.hashCode(this.f10429y)) * 31) + Float.hashCode(this.width)) * 31) + Float.hashCode(this.height);
    }

    @Override // com.discord.reactevents.ReactEvent
    @NotNull
    public WritableMap serialize() {
        return NativeMapExtensionsKt.nativeMapOf(v.a("layout", NativeMapExtensionsKt.nativeMapOf(v.a("x", Float.valueOf(this.f10428x)), v.a("y", Float.valueOf(this.f10429y)), v.a("width", Float.valueOf(this.width)), v.a("height", Float.valueOf(this.height)))));
    }

    @NotNull
    public String toString() {
        float f10 = this.f10428x;
        float f11 = this.f10429y;
