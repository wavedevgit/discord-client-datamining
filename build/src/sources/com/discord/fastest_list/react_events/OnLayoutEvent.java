...
public final class OnLayoutEvent implements ReactEvent {
    ...
    private final float f9409x;

    /* renamed from: y  reason: collision with root package name */
    private final float f9410y;
    ...
    public static /* synthetic */ OnLayoutEvent copy$default(OnLayoutEvent onLayoutEvent, float f10, float f11, float f12, float f13, int i10, Object obj) {
        if ((i10 & 1) != 0) {
            f10 = onLayoutEvent.f9409x;
        }
        if ((i10 & 2) != 0) {
            f11 = onLayoutEvent.f9410y;
        }
        if ((i10 & 4) != 0) {
    ...
    public static final /* synthetic */ void write$Self$fastest_list_release(OnLayoutEvent onLayoutEvent, CompositeEncoder compositeEncoder, SerialDescriptor serialDescriptor) {
        compositeEncoder.r(serialDescriptor, 0, onLayoutEvent.f9409x);
        compositeEncoder.r(serialDescriptor, 1, onLayoutEvent.f9410y);
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof OnLayoutEvent) {
            ...
            return Float.compare(this.f9409x, onLayoutEvent.f9409x) == 0 && Float.compare(this.f9410y, onLayoutEvent.f9410y) == 0 && Float.compare(this.width, onLayoutEvent.width) == 0 && Float.compare(this.height, onLayoutEvent.height) == 0;
        }
        return false;
    }
    ...
    public int hashCode() {
        return (((((Float.hashCode(this.f9409x) * 31) + Float.hashCode(this.f9410y)) * 31) + Float.hashCode(this.width)) * 31) + Float.hashCode(this.height);
    }

    @Override // com.discord.reactevents.ReactEvent
    @NotNull
    public WritableMap serialize() {
        return NativeMapExtensionsKt.nativeMapOf(v.a("layout", NativeMapExtensionsKt.nativeMapOf(v.a("x", Float.valueOf(this.f9409x)), v.a("y", Float.valueOf(this.f9410y)), v.a("width", Float.valueOf(this.width)), v.a("height", Float.valueOf(this.height)))));
    }

    @NotNull
    public String toString() {
        float f10 = this.f9409x;
        float f11 = this.f9410y;
