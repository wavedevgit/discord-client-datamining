...
public final class OnLayoutEvent implements ReactEvent {
    ...
    public static /* synthetic */ OnLayoutEvent copy$default(OnLayoutEvent onLayoutEvent, float f10, float f11, float f12, float f13, int i10, Object obj) {
        if ((i10 & 1) != 0) {
            f10 = onLayoutEvent.f10057x;
        }
        if ((i10 & 2) != 0) {
            f11 = onLayoutEvent.f10058y;
        }
        if ((i10 & 4) != 0) {
    ...
    public static final /* synthetic */ void write$Self$fastest_list_release(OnLayoutEvent onLayoutEvent, CompositeEncoder compositeEncoder, SerialDescriptor serialDescriptor) {
        compositeEncoder.r(serialDescriptor, 0, onLayoutEvent.f10057x);
        compositeEncoder.r(serialDescriptor, 1, onLayoutEvent.f10058y);
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof OnLayoutEvent) {
            ...
            return Float.compare(this.f10057x, onLayoutEvent.f10057x) == 0 && Float.compare(this.f10058y, onLayoutEvent.f10058y) == 0 && Float.compare(this.width, onLayoutEvent.width) == 0 && Float.compare(this.height, onLayoutEvent.height) == 0;
        }
        return false;
    }
    ...
    public int hashCode() {
        return (((((Float.hashCode(this.f10057x) * 31) + Float.hashCode(this.f10058y)) * 31) + Float.hashCode(this.width)) * 31) + Float.hashCode(this.height);
    }

    @Override // com.discord.reactevents.ReactEvent
    @NotNull
    public WritableMap serialize() {
        return NativeMapExtensionsKt.nativeMapOf(v.a("layout", NativeMapExtensionsKt.nativeMapOf(v.a("x", Float.valueOf(this.f10057x)), v.a("y", Float.valueOf(this.f10058y)), v.a("width", Float.valueOf(this.width)), v.a("height", Float.valueOf(this.height)))));
    }

    @NotNull
    public String toString() {
        float f10 = this.f10057x;
        float f11 = this.f10058y;
