...
public class OnScrollEvent implements ReactEvent {
    ...
    public WritableMap serialize() {
        return NativeMapExtensionsKt.nativeMapOf(v.a("contentInset", NativeMapExtensionsKt.nativeMapOf(v.a(ViewProps.LEFT, 0), v.a(ViewProps.TOP, 0), v.a(ViewProps.BOTTOM, 0), v.a(ViewProps.RIGHT, 0))), v.a("contentOffset", NativeMapExtensionsKt.nativeMapOf(v.a("x", Float.valueOf(this.f10027x)), v.a("y", Float.valueOf(this.f10028y)))), v.a("contentSize", NativeMapExtensionsKt.nativeMapOf(v.a("width", Float.valueOf(this.contentWidth)), v.a("height", Float.valueOf(this.contentHeight)))), v.a("layoutMeasurement", NativeMapExtensionsKt.nativeMapOf(v.a("width", Float.valueOf(this.width)), v.a("height", Float.valueOf(this.height)))));
    }
