    ...
    public static final class Data {
        ...
        public boolean equals(Object obj) {
            ...
            if (obj instanceof Data) {
                Data data = (Data) obj;
                return this.f10045x == data.f10045x && this.f10046y == data.f10046y && this.width == data.width && this.height == data.height && this.contentWidth == data.contentWidth && this.contentHeight == data.contentHeight;
            }
            return false;
        }
        ...
        public int hashCode() {
            return (((((((((Integer.hashCode(this.f10045x) * 31) + Integer.hashCode(this.f10046y)) * 31) + Integer.hashCode(this.width)) * 31) + Integer.hashCode(this.height)) * 31) + Integer.hashCode(this.contentWidth)) * 31) + Integer.hashCode(this.contentHeight);
        }
