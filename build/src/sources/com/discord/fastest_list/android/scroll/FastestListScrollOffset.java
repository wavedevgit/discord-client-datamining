    ...
    public static final class Data {
        ...
        public boolean equals(Object obj) {
            ...
            if (obj instanceof Data) {
                Data data = (Data) obj;
                return this.f10014x == data.f10014x && this.f10015y == data.f10015y && this.width == data.width && this.height == data.height && this.contentWidth == data.contentWidth && this.contentHeight == data.contentHeight;
            }
            return false;
        }
        ...
        public int hashCode() {
            return (((((((((Integer.hashCode(this.f10014x) * 31) + Integer.hashCode(this.f10015y)) * 31) + Integer.hashCode(this.width)) * 31) + Integer.hashCode(this.height)) * 31) + Integer.hashCode(this.contentWidth)) * 31) + Integer.hashCode(this.contentHeight);
        }
        ...
        public String toString() {
            int i10 = this.f10014x;
            int i11 = this.f10015y;
            int i12 = this.width;
            int i13 = this.height;
