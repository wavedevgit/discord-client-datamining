    ...
    public static final class Data {
        ...
        public boolean equals(Object obj) {
            ...
            if (obj instanceof Data) {
                Data data = (Data) obj;
                return this.f10013x == data.f10013x && this.f10014y == data.f10014y && this.width == data.width && this.height == data.height && this.contentWidth == data.contentWidth && this.contentHeight == data.contentHeight;
            }
            return false;
        }
        ...
        public int hashCode() {
            return (((((((((Integer.hashCode(this.f10013x) * 31) + Integer.hashCode(this.f10014y)) * 31) + Integer.hashCode(this.width)) * 31) + Integer.hashCode(this.height)) * 31) + Integer.hashCode(this.contentWidth)) * 31) + Integer.hashCode(this.contentHeight);
        }
