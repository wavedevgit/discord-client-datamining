...
public final class FastestListVisibleItemsTracker {
    ...
    private final void computeVisibleItems(int i10, int i11) {
        ...
        this.onVisibleItemsChanged.invoke(this.sectionsId, Integer.valueOf(itemAtPosition.mo878getSectionsZRFyWU()), Integer.valueOf(itemAtPosition2.mo878getSectionsZRFyWU()), Integer.valueOf(itemAtPosition.m895getItemJXkbwXs()), Integer.valueOf(itemAtPosition2.m895getItemJXkbwXs()));
    }
