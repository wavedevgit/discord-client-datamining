...
public final class FastestListPlaceholderConfig {
    @NotNull
    ...
    private final FastestListPlaceholderType component1() {
        return this.listFooter;
    }

    private final FastestListPlaceholderType component2() {
        return this.listHeader;
    }

    private final FastestListPlaceholderType component3() {
        return this.sectionFooter;
    }

    private final FastestListPlaceholderType component4() {
        return this.sectionHeader;
    }

    private final FastestListPlaceholderType component5() {
        return this.sectionItem;
    }

    private final FastestListPlaceholderType component6() {
        return this.sectionItemAtFront;
    }

    private final FastestListPlaceholderType component7() {
        return this.sectionItemAtRear;
    }

    private final FastestListPlaceholderType component8() {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof FastestListPlaceholderConfig) {
            FastestListPlaceholderConfig fastestListPlaceholderConfig = (FastestListPlaceholderConfig) obj;
    ...
    public final FastestListPlaceholderType getForEntry(@NotNull FastestListSections.Entry entry) {
        ...
        if (entry instanceof FastestListSections.Entry.SectionItem) {
            ...
            if (sectionItem.getAtFront() && sectionItem.getAtRear()) {
                ...
                return fastestListPlaceholderType;
            } else if (sectionItem.getAtFront()) {
                FastestListPlaceholderType fastestListPlaceholderType2 = this.sectionItemAtFront;
                if (fastestListPlaceholderType2 instanceof FastestListPlaceholderType.None) {
                    return this.sectionItem;
                }
                return fastestListPlaceholderType2;
            } else if (sectionItem.getAtRear()) {
                FastestListPlaceholderType fastestListPlaceholderType3 = this.sectionItemAtRear;
                if (fastestListPlaceholderType3 instanceof FastestListPlaceholderType.None) {
                    return this.sectionItem;
                }
                return fastestListPlaceholderType3;
            } else {
                return this.sectionItem;
            }
        } else if (entry instanceof FastestListSections.Entry.ListFooter) {
            return this.listFooter;
        } else {
    ...
    public int hashCode() {
        return (((((((((((((this.listFooter.hashCode() * 31) + this.listHeader.hashCode()) * 31) + this.sectionFooter.hashCode()) * 31) + this.sectionHeader.hashCode()) * 31) + this.sectionItem.hashCode()) * 31) + this.sectionItemAtFront.hashCode()) * 31) + this.sectionItemAtRear.hashCode()) * 31) + this.sectionItemSingleton.hashCode();
    }

    @NotNull
    public String toString() {
        FastestListPlaceholderType fastestListPlaceholderType = this.listFooter;
        FastestListPlaceholderType fastestListPlaceholderType2 = this.listHeader;
        FastestListPlaceholderType fastestListPlaceholderType3 = this.sectionFooter;
        FastestListPlaceholderType fastestListPlaceholderType4 = this.sectionHeader;
        FastestListPlaceholderType fastestListPlaceholderType5 = this.sectionItem;
        FastestListPlaceholderType fastestListPlaceholderType6 = this.sectionItemAtFront;
        FastestListPlaceholderType fastestListPlaceholderType7 = this.sectionItemAtRear;
        FastestListPlaceholderType fastestListPlaceholderType8 = this.sectionItemSingleton;
        return "FastestListPlaceholderConfig(listFooter=" + fastestListPlaceholderType + ", listHeader=" + fastestListPlaceholderType2 + ", sectionFooter=" + fastestListPlaceholderType3 + ", sectionHeader=" + fastestListPlaceholderType4 + ", sectionItem=" + fastestListPlaceholderType5 + ", sectionItemAtFront=" + fastestListPlaceholderType6 + ", sectionItemAtRear=" + fastestListPlaceholderType7 + ", sectionItemSingleton=" + fastestListPlaceholderType8 + ")";
    }
}
