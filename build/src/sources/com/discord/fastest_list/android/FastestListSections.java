...
public final class FastestListSections {
    ...
    public static abstract class Entry {
        ...
        public static final class ListFooter extends Entry {
            ...
            public static /* synthetic */ ListFooter m879copyX8oRnOs$default(ListFooter listFooter, String str, int i10, int i11, int i12, Object obj) {
                if ((i12 & 1) != 0) {
                    str = listFooter.key;
                }
                if ((i12 & 2) != 0) {
                ...
                return listFooter.m881copyX8oRnOs(str, i10, i11);
            }
            ...
            public final int m880component2sZRFyWU() {
                return this.section;
            }
            ...
            public final ListFooter m881copyX8oRnOs(@NotNull String key, int i10, int i11) {
            ...
            public boolean equals(Object obj) {
                ...
                if (obj instanceof ListFooter) {
                    ...
                    return Intrinsics.areEqual(this.key, listFooter.key) && Section.m906equalsimpl0(this.section, listFooter.section) && this.size == listFooter.size;
                }
                return false;
            }
            ...
            public int mo878getSectionsZRFyWU() {
                return this.section;
            }
            ...
            public int hashCode() {
                return (((this.key.hashCode() * 31) + Section.m907hashCodeimpl(this.section)) * 31) + Integer.hashCode(this.size);
            }

            @NotNull
            public String toString() {
                String str = this.key;
                String m908toStringimpl = Section.m908toStringimpl(this.section);
                int i10 = this.size;
                return "ListFooter(key=" + str + ", section=" + m908toStringimpl + ", size=" + i10 + ")";
            }
        ...
        public static final class ListHeader extends Entry {
            ...
            /* renamed from: copy-X8oRnOs$default  reason: not valid java name */
            public static /* synthetic */ ListHeader m882copyX8oRnOs$default(ListHeader listHeader, String str, int i10, int i11, int i12, Object obj) {
                if ((i12 & 1) != 0) {
                    str = listHeader.key;
                }
                if ((i12 & 2) != 0) {
                ...
                return listHeader.m884copyX8oRnOs(str, i10, i11);
            }
            ...
            /* renamed from: component2-sZRFyWU  reason: not valid java name */
            public final int m883component2sZRFyWU() {
                return this.section;
            }
            ...
            @NotNull
            /* renamed from: copy-X8oRnOs  reason: not valid java name */
            public final ListHeader m884copyX8oRnOs(@NotNull String key, int i10, int i11) {
                Intrinsics.checkNotNullParameter(key, "key");
            ...
            public boolean equals(Object obj) {
                ...
                if (obj instanceof ListHeader) {
                    ...
                    return Intrinsics.areEqual(this.key, listHeader.key) && Section.m906equalsimpl0(this.section, listHeader.section) && this.size == listHeader.size;
                }
                return false;
            }
            ...
            public String toString() {
                ...
                String m908toStringimpl = Section.m908toStringimpl(this.section);
                int i10 = this.size;
                return "ListHeader(key=" + str + ", section=" + m908toStringimpl + ", size=" + i10 + ")";
            }
        ...
        public static final class SectionFooter extends Entry {
            ...
            /* renamed from: copy-X8oRnOs$default  reason: not valid java name */
            public static /* synthetic */ SectionFooter m885copyX8oRnOs$default(SectionFooter sectionFooter, String str, int i10, int i11, int i12, Object obj) {
                if ((i12 & 1) != 0) {
                ...
                return sectionFooter.m887copyX8oRnOs(str, i10, i11);
            }
            ...
            /* renamed from: component2-sZRFyWU  reason: not valid java name */
            public final int m886component2sZRFyWU() {
                return this.section;
            }
            ...
            @NotNull
            /* renamed from: copy-X8oRnOs  reason: not valid java name */
            public final SectionFooter m887copyX8oRnOs(@NotNull String key, int i10, int i11) {
                Intrinsics.checkNotNullParameter(key, "key");
            ...
            public boolean equals(Object obj) {
                ...
                if (obj instanceof SectionFooter) {
                    ...
                    return Intrinsics.areEqual(this.key, sectionFooter.key) && Section.m906equalsimpl0(this.section, sectionFooter.section) && this.size == sectionFooter.size;
                }
                return false;
            }
            ...
            public String toString() {
                ...
                String m908toStringimpl = Section.m908toStringimpl(this.section);
                int i10 = this.size;
                return "SectionFooter(key=" + str + ", section=" + m908toStringimpl + ", size=" + i10 + ")";
            }
        ...
        public static final class SectionHeader extends Entry {
            ...
            /* renamed from: copy-X8oRnOs$default  reason: not valid java name */
            public static /* synthetic */ SectionHeader m888copyX8oRnOs$default(SectionHeader sectionHeader, String str, int i10, int i11, int i12, Object obj) {
                if ((i12 & 1) != 0) {
                ...
                return sectionHeader.m890copyX8oRnOs(str, i10, i11);
            }
            ...
            /* renamed from: component2-sZRFyWU  reason: not valid java name */
            public final int m889component2sZRFyWU() {
                return this.section;
            }
            ...
            @NotNull
            /* renamed from: copy-X8oRnOs  reason: not valid java name */
            public final SectionHeader m890copyX8oRnOs(@NotNull String key, int i10, int i11) {
                Intrinsics.checkNotNullParameter(key, "key");
            ...
            public boolean equals(Object obj) {
                ...
                if (obj instanceof SectionHeader) {
                    ...
                    return Intrinsics.areEqual(this.key, sectionHeader.key) && Section.m906equalsimpl0(this.section, sectionHeader.section) && this.size == sectionHeader.size;
                }
                return false;
            }
            ...
            public String toString() {
                ...
                String m908toStringimpl = Section.m908toStringimpl(this.section);
                int i10 = this.size;
                return "SectionHeader(key=" + str + ", section=" + m908toStringimpl + ", size=" + i10 + ")";
            }
        ...
        public static final class SectionItem extends Entry {
            ...
            public static final Companion Companion = new Companion(null);
            @NotNull
            private static final SectionItem DEFAULT_AT_START = new SectionItem("", 0, Item.m897constructorimpl(0), 0, false, false, 58, null);
            @NotNull
            private static final SectionItem DEFAULT_AT_END = new SectionItem("", 0, Item.m897constructorimpl(-1), 0, false, false, 58, null);
            ...
            public static /* synthetic */ SectionItem m891copy84MWo2c$default(SectionItem sectionItem, String str, int i10, int i11, int i12, boolean z10, boolean z11, int i13, Object obj) {
                if ((i13 & 1) != 0) {
                    str = sectionItem.key;
                }
                if ((i13 & 2) != 0) {
                ...
                boolean z12 = z10;
                boolean z13 = z11;
                return sectionItem.m894copy84MWo2c(str, i10, i11, i12, z12, z13);
            }
            ...
            /* renamed from: component2-sZRFyWU  reason: not valid java name */
            public final int m892component2sZRFyWU() {
                return this.section;
            }

            /* renamed from: component3-JXkbwXs  reason: not valid java name */
            public final int m893component3JXkbwXs() {
                return this.item;
            }
            ...
            public final SectionItem m894copy84MWo2c(@NotNull String key, int i10, int i11, int i12, boolean z10, boolean z11) {
                Intrinsics.checkNotNullParameter(key, "key");
            ...
            public boolean equals(Object obj) {
                ...
                if (obj instanceof SectionItem) {
                    ...
                    return Intrinsics.areEqual(this.key, sectionItem.key) && Section.m906equalsimpl0(this.section, sectionItem.section) && Item.m899equalsimpl0(this.item, sectionItem.item) && this.size == sectionItem.size && this.atFront == sectionItem.atFront && this.atRear == sectionItem.atRear;
                }
                return false;
            }
            ...
            public final int m895getItemJXkbwXs() {
                return this.item;
            }
            ...
            public int hashCode() {
                return (((((((((this.key.hashCode() * 31) + Section.m907hashCodeimpl(this.section)) * 31) + Item.m900hashCodeimpl(this.item)) * 31) + Integer.hashCode(this.size)) * 31) + Boolean.hashCode(this.atFront)) * 31) + Boolean.hashCode(this.atRear);
            }
            ...
            public String toString() {
                String str = this.key;
                String m908toStringimpl = Section.m908toStringimpl(this.section);
                String m901toStringimpl = Item.m901toStringimpl(this.item);
                int i10 = this.size;
                boolean z10 = this.atFront;
                boolean z11 = this.atRear;
                return "SectionItem(key=" + str + ", section=" + m908toStringimpl + ", item=" + m901toStringimpl + ", size=" + i10 + ", atFront=" + z10 + ", atRear=" + z11 + ")";
            }
            ...
            public /* synthetic */ SectionItem(String str, int i10, int i11, int i12, boolean z10, boolean z11, int i13, DefaultConstructorMarker defaultConstructorMarker) {
                this(str, (i13 & 2) != 0 ? Section.m904constructorimpl(0) : i10, (i13 & 4) != 0 ? Item.m897constructorimpl(0) : i11, (i13 & 8) != 0 ? 0 : i12, (i13 & 16) != 0 ? false : z10, (i13 & 32) != 0 ? false : z11, null);
            }
        ...
        public abstract int mo878getSectionsZRFyWU();
    ...
    public static final class Item {
        ...
        public static final /* synthetic */ Item m896boximpl(int i10) {
            return new Item(i10);
        }

        /* renamed from: constructor-impl  reason: not valid java name */
        public static int m897constructorimpl(int i10) {
            return i10;
        }

        /* renamed from: equals-impl  reason: not valid java name */
        public static boolean m898equalsimpl(int i10, Object obj) {
            return (obj instanceof Item) && i10 == ((Item) obj).m902unboximpl();
        }

        /* renamed from: equals-impl0  reason: not valid java name */
        public static final boolean m899equalsimpl0(int i10, int i11) {
            return i10 == i11;
        }

        /* renamed from: hashCode-impl  reason: not valid java name */
        public static int m900hashCodeimpl(int i10) {
            return Integer.hashCode(i10);
        }

        /* renamed from: toString-impl  reason: not valid java name */
        public static String m901toStringimpl(int i10) {
            return "Item(value=" + i10 + ")";
        }

        public boolean equals(Object obj) {
            return m898equalsimpl(this.value, obj);
        }
        ...
        public final /* synthetic */ int m902unboximpl() {
            return this.value;
        }
    }
    ...
    public static final class Section {
        ...
        /* renamed from: box-impl  reason: not valid java name */
        public static final /* synthetic */ Section m903boximpl(int i10) {
            return new Section(i10);
        }

        /* renamed from: constructor-impl  reason: not valid java name */
        public static int m904constructorimpl(int i10) {
            return i10;
        }

        /* renamed from: equals-impl  reason: not valid java name */
        public static boolean m905equalsimpl(int i10, Object obj) {
            return (obj instanceof Section) && i10 == ((Section) obj).m909unboximpl();
        }
        ...
        /* renamed from: toString-impl  reason: not valid java name */
        public static String m908toStringimpl(int i10) {
            return "Section(value=" + i10 + ")";
        }

        public boolean equals(Object obj) {
            return m905equalsimpl(this.value, obj);
        }
        ...
        public String toString() {
            return m908toStringimpl(this.value);
        }
    ...
    public final Integer m877getItemPositionjEcWkE0(int i10, int i11) {
        ...
        while (true) {
            if (it.hasNext()) {
                ...
                if (next instanceof Entry.SectionItem) {
                    ...
                    if (Item.m899equalsimpl0(sectionItem.m895getItemJXkbwXs(), i11) && Section.m906equalsimpl0(sectionItem.mo878getSectionsZRFyWU(), i10)) {
                        break;
                    }
                }
                i12++;
