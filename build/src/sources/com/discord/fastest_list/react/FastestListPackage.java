...
public final class FastestListPackage extends BaseReactPackage {
    ...
    public Void m910getModule(@NotNull String name, @NotNull ReactApplicationContext reactContext) {
    ...
    public /* bridge */ /* synthetic */ NativeModule getModule(String str, ReactApplicationContext reactApplicationContext) {
        return (NativeModule) m910getModule(str, reactApplicationContext);
    }
}
