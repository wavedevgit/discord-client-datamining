...
public final class FastestListDeserializerSectionsKt {
    private static final FastestListSections.Entry.SectionFooter createSectionFooter(String str, boolean z10, int i10, ReadableArray readableArray, Integer num, ReadableArray readableArray2) {
        ...
        return new FastestListSections.Entry.SectionFooter(companion.createKey(str, i10, str2), FastestListSections.Section.m904constructorimpl(i10), dpToPx, null);
    }
    ...
    private static final FastestListSections.Entry.SectionHeader createSectionHeader(String str, boolean z10, int i10, ReadableArray readableArray, Integer num, ReadableArray readableArray2) {
        ...
        return new FastestListSections.Entry.SectionHeader(companion.createKey(str, i10, str2), FastestListSections.Section.m904constructorimpl(i10), dpToPx, null);
    }
    ...
    private static final FastestListSections.Entry.SectionItem createSectionItem(String str, boolean z10, int i10, int i11, int i12, ReadableArray readableArray, Integer num, ReadableArray readableArray2) {
        ...
        int m904constructorimpl = FastestListSections.Section.m904constructorimpl(i10);
        int m897constructorimpl = FastestListSections.Item.m897constructorimpl(i12);
        if (i12 == 0) {
            z11 = true;
        } else {
            z11 = false;
        ...
        return new FastestListSections.Entry.SectionItem(createKey, m904constructorimpl, m897constructorimpl, i13, z11, z12, null);
    }
    ...
    public static final FastestListSections.Versioned invoke(@NotNull FastestListSections.Versioned.Companion companion, @NotNull ReadableMap value) {
        ...
        if (dpToPx > 0) {
            ...
            listHeader = new FastestListSections.Entry.ListHeader(FastestListSections.Entry.ListHeader.Companion.createKey(nonNullString, nonNullString3), FastestListSections.Section.m904constructorimpl(0), dpToPx, null);
        } else {
            readableArray2 = nonNullArray6;
            num4 = num2;
            readableArray3 = nonNullArray4;
        ...
        if (dpToPx2 > 0) {
            listFooter = new FastestListSections.Entry.ListFooter(FastestListSections.Entry.ListFooter.Companion.createKey(nonNullString, nonNullString4), FastestListSections.Section.m904constructorimpl(Math.max(0, CollectionsKt.n(intList))), dpToPx2, null);
        } else {
            listFooter = null;
        }
