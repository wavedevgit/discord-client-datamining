...
public final class ShareBroadcastReceiverAppClicked implements ReactEvent {
    ...
    private final String f10445app;
    ...
    public static /* synthetic */ ShareBroadcastReceiverAppClicked copy$default(ShareBroadcastReceiverAppClicked shareBroadcastReceiverAppClicked, String str, String str2, int i10, Object obj) {
        if ((i10 & 1) != 0) {
            str = shareBroadcastReceiverAppClicked.f10445app;
        }
        if ((i10 & 2) != 0) {
    ...
    public static final /* synthetic */ void write$Self$share_release(ShareBroadcastReceiverAppClicked shareBroadcastReceiverAppClicked, CompositeEncoder compositeEncoder, SerialDescriptor serialDescriptor) {
        compositeEncoder.x(serialDescriptor, 0, shareBroadcastReceiverAppClicked.f10445app);
        compositeEncoder.B(serialDescriptor, 1, n2.f7662a, shareBroadcastReceiverAppClicked.location);
    }

    @NotNull
    public final String component1() {
        return this.f10445app;
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof ShareBroadcastReceiverAppClicked) {
            ...
            return Intrinsics.areEqual(this.f10445app, shareBroadcastReceiverAppClicked.f10445app) && Intrinsics.areEqual(this.location, shareBroadcastReceiverAppClicked.location);
        }
        return false;
    }
    ...
    public int hashCode() {
        int hashCode = this.f10445app.hashCode() * 31;
