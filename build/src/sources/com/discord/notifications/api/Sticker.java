...
public final class Sticker implements Parcelable {
    ...
    public static final class Creator implements Parcelable.Creator<Sticker> {
        ...
        public final Sticker createFromParcel(Parcel parcel) {
            ...
            long m1134unboximpl = ((StickerId) parcel.readParcelable(Sticker.class.getClassLoader())).m1134unboximpl();
            ...
            return new Sticker(m1134unboximpl, readString, valueOf, guildId, readString2, valueOf2, readString3, valueOf3, bool, null);
        }
    ...
    public static /* synthetic */ Sticker m1029copyfJhvhH4$default(Sticker sticker, long j10, String str, Long l10, GuildId guildId, String str2, StickerFormatType stickerFormatType, String str3, StickerType stickerType, Boolean bool, int i10, Object obj) {
        if ((i10 & 1) != 0) {
            j10 = sticker.f10278id;
        }
        long j11 = j10;
        if ((i10 & 2) != 0) {
            str = sticker.name;
    ...
    public static /* synthetic */ void m1030getGuildIdqOKuAAo$annotations() {
    }

    /* renamed from: getId-e_wqtJY$annotations  reason: not valid java name */
    public static /* synthetic */ void m1031getIde_wqtJY$annotations() {
    }
    ...
    public static final /* synthetic */ void write$Self$notification_api_release(Sticker sticker, CompositeEncoder compositeEncoder, SerialDescriptor serialDescriptor) {
        if (compositeEncoder.y(serialDescriptor, 0) || !StickerId.m1129equalsimpl0(sticker.f10278id, StickerId.m1126constructorimpl(0L))) {
            compositeEncoder.m(serialDescriptor, 0, StickerId$$serializer.INSTANCE, StickerId.m1125boximpl(sticker.f10278id));
        }
        compositeEncoder.x(serialDescriptor, 1, sticker.name);
        if (compositeEncoder.y(serialDescriptor, 2) || sticker.packId != null) {
            compositeEncoder.B(serialDescriptor, 2, z0.f7736a, sticker.packId);
        }
        if (compositeEncoder.y(serialDescriptor, 3) || sticker.guildId != null) {
            compositeEncoder.B(serialDescriptor, 3, GuildId$$serializer.INSTANCE, sticker.guildId);
        }
        if (compositeEncoder.y(serialDescriptor, 4) || !Intrinsics.areEqual(sticker.description, "")) {
            compositeEncoder.x(serialDescriptor, 4, sticker.description);
        }
        if (compositeEncoder.y(serialDescriptor, 5) || sticker.formatType != StickerFormatType.Companion.fromInt(0)) {
            compositeEncoder.m(serialDescriptor, 5, StickerFormatType.Serializer.INSTANCE, sticker.formatType);
        }
        if (compositeEncoder.y(serialDescriptor, 6) || !Intrinsics.areEqual(sticker.tags, "")) {
            compositeEncoder.x(serialDescriptor, 6, sticker.tags);
        }
        if (compositeEncoder.y(serialDescriptor, 7) || sticker.type != StickerType.Companion.fromInt(0)) {
            compositeEncoder.m(serialDescriptor, 7, StickerType.Serializer.INSTANCE, sticker.type);
        }
        if (compositeEncoder.y(serialDescriptor, 8) || sticker.available != null) {
            compositeEncoder.B(serialDescriptor, 8, h.f7626a, sticker.available);
        }
    }

    /* renamed from: component1-e_wqtJY  reason: not valid java name */
    public final long m1032component1e_wqtJY() {
    ...
    public final GuildId m1033component4qOKuAAo() {
        return this.guildId;
    }
    ...
    public final Sticker m1034copyfJhvhH4(long j10, @NotNull String name, Long l10, GuildId guildId, @NotNull String description, @NotNull StickerFormatType formatType, @NotNull String tags, @NotNull StickerType type, Boolean bool) {
    ...
    public final GuildId m1035getGuildIdqOKuAAo() {
        return this.guildId;
    }

    /* renamed from: getId-e_wqtJY  reason: not valid java name */
    public final long m1036getIde_wqtJY() {
        return this.f10278id;
    }
    ...
    public int hashCode() {
        int m1130hashCodeimpl = ((StickerId.m1130hashCodeimpl(this.f10278id) * 31) + this.name.hashCode()) * 31;
        Long l10 = this.packId;
        int hashCode = (m1130hashCodeimpl + (l10 == null ? 0 : l10.hashCode())) * 31;
        GuildId guildId = this.guildId;
        int m1078hashCodeimpl = (((((((((hashCode + (guildId == null ? 0 : GuildId.m1078hashCodeimpl(guildId.m1082unboximpl()))) * 31) + this.description.hashCode()) * 31) + this.formatType.hashCode()) * 31) + this.tags.hashCode()) * 31) + this.type.hashCode()) * 31;
    ...
    public String toString() {
        String m1132toStringimpl = StickerId.m1132toStringimpl(this.f10278id);
        ...
        Boolean bool = this.available;
        return "Sticker(id=" + m1132toStringimpl + ", name=" + str + ", packId=" + l10 + ", guildId=" + guildId + ", description=" + str2 + ", formatType=" + stickerFormatType + ", tags=" + str3 + ", type=" + stickerType + ", available=" + bool + ")";
    }

    @Override // android.os.Parcelable
    public final void writeToParcel(@NotNull Parcel dest, int i10) {
        Intrinsics.checkNotNullParameter(dest, "dest");
        dest.writeParcelable(StickerId.m1125boximpl(this.f10278id), i10);
    ...
    private /* synthetic */ Sticker(int i10, StickerId stickerId, String str, Long l10, GuildId guildId, String str2, StickerFormatType stickerFormatType, String str3, StickerType stickerType, Boolean bool, SerializationConstructorMarker serializationConstructorMarker) {
        ...
        this.f10278id = (i10 & 1) == 0 ? StickerId.m1126constructorimpl(0L) : stickerId.m1134unboximpl();
        this.name = str;
        if ((i10 & 4) == 0) {
            this.packId = null;
        } else {
    ...
    public /* synthetic */ Sticker(long j10, String str, Long l10, GuildId guildId, String str2, StickerFormatType stickerFormatType, String str3, StickerType stickerType, Boolean bool, int i10, DefaultConstructorMarker defaultConstructorMarker) {
        this((i10 & 1) != 0 ? StickerId.m1126constructorimpl(0L) : j10, str, (i10 & 4) != 0 ? null : l10, (i10 & 8) != 0 ? null : guildId, (i10 & 16) != 0 ? "" : str2, (i10 & 32) != 0 ? StickerFormatType.Companion.fromInt(0) : stickerFormatType, (i10 & 64) != 0 ? "" : str3, (i10 & IntBufferBatchMountItem.INSTRUCTION_UPDATE_LAYOUT) != 0 ? StickerType.Companion.fromInt(0) : stickerType, (i10 & IntBufferBatchMountItem.INSTRUCTION_UPDATE_EVENT_EMITTER) != 0 ? null : bool, null);
    }
}
