...
public final class Sticker implements Parcelable {
    ...
    public static final /* synthetic */ void write$Self$notification_api_release(Sticker sticker, CompositeEncoder compositeEncoder, SerialDescriptor serialDescriptor) {
        if (compositeEncoder.z(serialDescriptor, 0) || !StickerId.m1126equalsimpl0(sticker.f9670id, StickerId.m1123constructorimpl(0L))) {
            compositeEncoder.F(serialDescriptor, 0, StickerId$$serializer.INSTANCE, StickerId.m1122boximpl(sticker.f9670id));
        }
        compositeEncoder.y(serialDescriptor, 1, sticker.name);
        if (compositeEncoder.z(serialDescriptor, 2) || sticker.packId != null) {
            compositeEncoder.i(serialDescriptor, 2, z0.f35255a, sticker.packId);
        }
        if (compositeEncoder.z(serialDescriptor, 3) || sticker.guildId != null) {
            compositeEncoder.i(serialDescriptor, 3, GuildId$$serializer.INSTANCE, sticker.guildId);
        }
        ...
        if (compositeEncoder.z(serialDescriptor, 5) || sticker.formatType != StickerFormatType.Companion.fromInt(0)) {
            compositeEncoder.F(serialDescriptor, 5, StickerFormatType.Serializer.INSTANCE, sticker.formatType);
        }
        ...
        if (compositeEncoder.z(serialDescriptor, 7) || sticker.type != StickerType.Companion.fromInt(0)) {
            compositeEncoder.F(serialDescriptor, 7, StickerType.Serializer.INSTANCE, sticker.type);
        }
        if (compositeEncoder.z(serialDescriptor, 8) || sticker.available != null) {
            compositeEncoder.i(serialDescriptor, 8, h.f35145a, sticker.available);
        }
    }
    ...
    public int hashCode() {
        int m1127hashCodeimpl = ((StickerId.m1127hashCodeimpl(this.f9670id) * 31) + this.name.hashCode()) * 31;
    ...
    public String toString() {
        String m1129toStringimpl = StickerId.m1129toStringimpl(this.f9670id);
    ...
    public final void writeToParcel(@NotNull Parcel dest, int i10) {
        ...
        dest.writeParcelable(StickerId.m1122boximpl(this.f9670id), i10);
    ...
    private /* synthetic */ Sticker(int i10, StickerId stickerId, String str, Long l10, GuildId guildId, String str2, StickerFormatType stickerFormatType, String str3, StickerType stickerType, Boolean bool, SerializationConstructorMarker serializationConstructorMarker) {
        ...
        this.f9670id = (i10 & 1) == 0 ? StickerId.m1123constructorimpl(0L) : stickerId.m1131unboximpl();
        this.name = str;
        if ((i10 & 4) == 0) {
            this.packId = null;
        } else {
