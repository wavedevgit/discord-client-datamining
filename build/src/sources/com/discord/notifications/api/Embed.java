...
public final class Embed {
    ...
    @NotNull
    private static final Lazy[] $childSerializers = {l.a(o.f6082e, new Function0() { // from class: q7.b
    ...
    public static final /* synthetic */ void write$Self$notification_api_release(Embed embed, CompositeEncoder compositeEncoder, SerialDescriptor serialDescriptor) {
        ...
        if (compositeEncoder.z(serialDescriptor, 0) || embed.fields != null) {
            compositeEncoder.o(serialDescriptor, 0, (qt.o) lazyArr[0].getValue(), embed.fields);
        }
    }
