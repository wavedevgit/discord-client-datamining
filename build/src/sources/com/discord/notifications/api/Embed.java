...
public final class Embed {
    ...
    @NotNull
    private static final Lazy[] $childSerializers = {l.a(o.f31119e, new Function0() { // from class: p7.b
    ...
    public static final /* synthetic */ void write$Self$notification_api_release(Embed embed, CompositeEncoder compositeEncoder, SerialDescriptor serialDescriptor) {
        ...
        if (compositeEncoder.A(serialDescriptor, 0) || embed.fields != null) {
            compositeEncoder.z(serialDescriptor, 0, (xs.o) lazyArr[0].getValue(), embed.fields);
        }
    }
