...
public final class EmbedField {
    ...
    public static final /* synthetic */ void write$Self$notification_api_release(EmbedField embedField, CompositeEncoder compositeEncoder, SerialDescriptor serialDescriptor) {
        if (compositeEncoder.y(serialDescriptor, 0) || embedField.name != null) {
            compositeEncoder.B(serialDescriptor, 0, n2.f7662a, embedField.name);
        }
        if (compositeEncoder.y(serialDescriptor, 1) || embedField.value != null) {
            compositeEncoder.B(serialDescriptor, 1, n2.f7662a, embedField.value);
        }
    }
