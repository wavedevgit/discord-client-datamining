...
public final class KvMessageEntry {
    ...
    static {
        o oVar = o.f32182e;
        $childSerializers = new Lazy[]{l.a(oVar, new Function0() { // from class: p7.c
        ...
        }), l.a(oVar, new Function0() { // from class: p7.d
            @Override // kotlin.jvm.functions.Function0
            public final Object invoke() {
    ...
    public static /* synthetic */ KvMessageEntry m998copykA7ecXY$default(KvMessageEntry kvMessageEntry, List list, List list2, JsonObject jsonObject, String str, long j10, int i10, Object obj) {
        ...
        if ((i10 & 8) != 0) {
            str = kvMessageEntry.f10277id;
        }
        if ((i10 & 16) != 0) {
            j10 = kvMessageEntry.channelId;
        }
        long j11 = j10;
        return kvMessageEntry.m1003copykA7ecXY(list3, list4, jsonObject, str, j11);
    }

    /* renamed from: getChannelId-o4g7jtM$annotations  reason: not valid java name */
    public static /* synthetic */ void m999getChannelIdo4g7jtM$annotations() {
    }

    /* renamed from: getId-3Eiw7ao$annotations  reason: not valid java name */
    public static /* synthetic */ void m1000getId3Eiw7ao$annotations() {
    }
    ...
    public static final /* synthetic */ void write$Self$notification_api_release(KvMessageEntry kvMessageEntry, CompositeEncoder compositeEncoder, SerialDescriptor serialDescriptor) {
        ...
        compositeEncoder.m(serialDescriptor, 0, (ys.o) lazyArr[0].getValue(), kvMessageEntry.members);
        compositeEncoder.m(serialDescriptor, 1, (ys.o) lazyArr[1].getValue(), kvMessageEntry.users);
        compositeEncoder.m(serialDescriptor, 2, y.f20833a, kvMessageEntry.message);
        compositeEncoder.m(serialDescriptor, 3, MessageId$$serializer.INSTANCE, MessageId.m1086boximpl(kvMessageEntry.f10277id));
        compositeEncoder.m(serialDescriptor, 4, ChannelId$$serializer.INSTANCE, ChannelId.m1060boximpl(kvMessageEntry.channelId));
    }
    ...
    public final String m1001component43Eiw7ao() {
        return this.f10277id;
    }

    /* renamed from: component5-o4g7jtM  reason: not valid java name */
    public final long m1002component5o4g7jtM() {
        return this.channelId;
    }

    @NotNull
    /* renamed from: copy-kA7ecXY  reason: not valid java name */
    public final KvMessageEntry m1003copykA7ecXY(@NotNull List<JsonObject> members, @NotNull List<JsonObject> users, @NotNull JsonObject message, @NotNull String id2, long j10) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof KvMessageEntry) {
            ...
            return Intrinsics.areEqual(this.members, kvMessageEntry.members) && Intrinsics.areEqual(this.users, kvMessageEntry.users) && Intrinsics.areEqual(this.message, kvMessageEntry.message) && MessageId.m1090equalsimpl0(this.f10277id, kvMessageEntry.f10277id) && ChannelId.m1064equalsimpl0(this.channelId, kvMessageEntry.channelId);
        }
        return false;
    }

    /* renamed from: getChannelId-o4g7jtM  reason: not valid java name */
    public final long m1004getChannelIdo4g7jtM() {
        return this.channelId;
    }

    @NotNull
    /* renamed from: getId-3Eiw7ao  reason: not valid java name */
    public final String m1005getId3Eiw7ao() {
        return this.f10277id;
    }
    ...
    public int hashCode() {
        return (((((((this.members.hashCode() * 31) + this.users.hashCode()) * 31) + this.message.hashCode()) * 31) + MessageId.m1091hashCodeimpl(this.f10277id)) * 31) + ChannelId.m1065hashCodeimpl(this.channelId);
    }
    ...
    public String toString() {
        ...
        String m1093toStringimpl = MessageId.m1093toStringimpl(this.f10277id);
        String m1067toStringimpl = ChannelId.m1067toStringimpl(this.channelId);
        return "KvMessageEntry(members=" + list + ", users=" + list2 + ", message=" + jsonObject + ", id=" + m1093toStringimpl + ", channelId=" + m1067toStringimpl + ")";
    }
