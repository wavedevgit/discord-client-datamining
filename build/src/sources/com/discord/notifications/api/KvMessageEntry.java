...
public final class KvMessageEntry {
    ...
    public static /* synthetic */ KvMessageEntry m996copykA7ecXY$default(KvMessageEntry kvMessageEntry, List list, List list2, JsonObject jsonObject, String str, long j10, int i10, Object obj) {
        ...
        if ((i10 & 8) != 0) {
            str = kvMessageEntry.f10648id;
        }
        if ((i10 & 16) != 0) {
            j10 = kvMessageEntry.channelId;
        }
        long j11 = j10;
        return kvMessageEntry.m1001copykA7ecXY(list3, list4, jsonObject, str, j11);
    }

    /* renamed from: getChannelId-o4g7jtM$annotations  reason: not valid java name */
    public static /* synthetic */ void m997getChannelIdo4g7jtM$annotations() {
    }

    /* renamed from: getId-3Eiw7ao$annotations  reason: not valid java name */
    public static /* synthetic */ void m998getId3Eiw7ao$annotations() {
    }
    ...
    public static final /* synthetic */ void write$Self$notification_api_release(KvMessageEntry kvMessageEntry, CompositeEncoder compositeEncoder, SerialDescriptor serialDescriptor) {
        ...
        compositeEncoder.j(serialDescriptor, 0, (xs.o) lazyArr[0].getValue(), kvMessageEntry.members);
        compositeEncoder.j(serialDescriptor, 1, (xs.o) lazyArr[1].getValue(), kvMessageEntry.users);
        compositeEncoder.j(serialDescriptor, 2, y.f7835a, kvMessageEntry.message);
        compositeEncoder.j(serialDescriptor, 3, MessageId$$serializer.INSTANCE, MessageId.m1084boximpl(kvMessageEntry.f10648id));
        compositeEncoder.j(serialDescriptor, 4, ChannelId$$serializer.INSTANCE, ChannelId.m1058boximpl(kvMessageEntry.channelId));
    }
    ...
    public final long m1000component5o4g7jtM() {
        return this.channelId;
    }

    @NotNull
    /* renamed from: copy-kA7ecXY  reason: not valid java name */
    public final KvMessageEntry m1001copykA7ecXY(@NotNull List<JsonObject> members, @NotNull List<JsonObject> users, @NotNull JsonObject message, @NotNull String id2, long j10) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof KvMessageEntry) {
            ...
            return Intrinsics.areEqual(this.members, kvMessageEntry.members) && Intrinsics.areEqual(this.users, kvMessageEntry.users) && Intrinsics.areEqual(this.message, kvMessageEntry.message) && MessageId.m1088equalsimpl0(this.f10648id, kvMessageEntry.f10648id) && ChannelId.m1062equalsimpl0(this.channelId, kvMessageEntry.channelId);
        }
        return false;
    }

    /* renamed from: getChannelId-o4g7jtM  reason: not valid java name */
    public final long m1002getChannelIdo4g7jtM() {
        return this.channelId;
    }
    ...
    public int hashCode() {
        return (((((((this.members.hashCode() * 31) + this.users.hashCode()) * 31) + this.message.hashCode()) * 31) + MessageId.m1089hashCodeimpl(this.f10648id)) * 31) + ChannelId.m1063hashCodeimpl(this.channelId);
    }
    ...
    public String toString() {
        ...
        String m1091toStringimpl = MessageId.m1091toStringimpl(this.f10648id);
