...
public final class DirectReplyUser {
    ...
    public static /* synthetic */ DirectReplyUser m992copyASSxI_0$default(DirectReplyUser directReplyUser, long j10, String str, String str2, String str3, int i10, Object obj) {
        if ((i10 & 1) != 0) {
            j10 = directReplyUser.f10647id;
        }
        long j11 = j10;
        if ((i10 & 2) != 0) {
        ...
        return directReplyUser.m994copyASSxI_0(j11, str4, str5, str3);
    }
    ...
    public static final /* synthetic */ void write$Self$notification_api_release(DirectReplyUser directReplyUser, CompositeEncoder compositeEncoder, SerialDescriptor serialDescriptor) {
        compositeEncoder.j(serialDescriptor, 0, UserId$$serializer.INSTANCE, UserId.m1136boximpl(directReplyUser.f10647id));
        if (compositeEncoder.A(serialDescriptor, 1) || directReplyUser.username != null) {
            compositeEncoder.z(serialDescriptor, 1, n2.f6848a, directReplyUser.username);
        }
        if (compositeEncoder.A(serialDescriptor, 2) || directReplyUser.discriminator != null) {
            compositeEncoder.z(serialDescriptor, 2, n2.f6848a, directReplyUser.discriminator);
        }
        if (compositeEncoder.A(serialDescriptor, 3) || directReplyUser.avatar != null) {
            compositeEncoder.z(serialDescriptor, 3, n2.f6848a, directReplyUser.avatar);
        }
    }

    /* renamed from: component1-re6GcUE  reason: not valid java name */
    public final long m993component1re6GcUE() {
    ...
    public final DirectReplyUser m994copyASSxI_0(long j10, String str, String str2, String str3) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof DirectReplyUser) {
            ...
            return UserId.m1140equalsimpl0(this.f10647id, directReplyUser.f10647id) && Intrinsics.areEqual(this.username, directReplyUser.username) && Intrinsics.areEqual(this.discriminator, directReplyUser.discriminator) && Intrinsics.areEqual(this.avatar, directReplyUser.avatar);
        }
        return false;
    }
    ...
    public final long m995getIdre6GcUE() {
        return this.f10647id;
    }
    ...
    public int hashCode() {
        int m1141hashCodeimpl = UserId.m1141hashCodeimpl(this.f10647id) * 31;
    ...
    public String toString() {
        String m1143toStringimpl = UserId.m1143toStringimpl(this.f10647id);
        String str = this.username;
        String str2 = this.discriminator;
        String str3 = this.avatar;
        return "DirectReplyUser(id=" + m1143toStringimpl + ", username=" + str + ", discriminator=" + str2 + ", avatar=" + str3 + ")";
    }
    ...
    private /* synthetic */ DirectReplyUser(int i10, UserId userId, String str, String str2, String str3, SerializationConstructorMarker serializationConstructorMarker) {
        ...
        this.f10647id = userId.m1145unboximpl();
        if ((i10 & 2) == 0) {
            this.username = null;
        } else {
            this.username = str;
