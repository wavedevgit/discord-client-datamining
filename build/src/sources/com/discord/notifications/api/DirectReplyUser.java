...
public final class DirectReplyUser {
    ...
    public static final /* synthetic */ void write$Self$notification_api_release(DirectReplyUser directReplyUser, CompositeEncoder compositeEncoder, SerialDescriptor serialDescriptor) {
        compositeEncoder.F(serialDescriptor, 0, UserId$$serializer.INSTANCE, UserId.m1135boximpl(directReplyUser.f9668id));
        if (compositeEncoder.z(serialDescriptor, 1) || directReplyUser.username != null) {
            compositeEncoder.i(serialDescriptor, 1, n2.f35181a, directReplyUser.username);
        }
        if (compositeEncoder.z(serialDescriptor, 2) || directReplyUser.discriminator != null) {
            compositeEncoder.i(serialDescriptor, 2, n2.f35181a, directReplyUser.discriminator);
        }
        if (compositeEncoder.z(serialDescriptor, 3) || directReplyUser.avatar != null) {
            compositeEncoder.i(serialDescriptor, 3, n2.f35181a, directReplyUser.avatar);
        }
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof DirectReplyUser) {
            ...
            return UserId.m1139equalsimpl0(this.f9668id, directReplyUser.f9668id) && Intrinsics.areEqual(this.username, directReplyUser.username) && Intrinsics.areEqual(this.discriminator, directReplyUser.discriminator) && Intrinsics.areEqual(this.avatar, directReplyUser.avatar);
        }
        return false;
    }
    ...
    public int hashCode() {
        int m1140hashCodeimpl = UserId.m1140hashCodeimpl(this.f9668id) * 31;
    ...
    public String toString() {
        String m1142toStringimpl = UserId.m1142toStringimpl(this.f9668id);
        String str = this.username;
        String str2 = this.discriminator;
        String str3 = this.avatar;
    ...
    private /* synthetic */ DirectReplyUser(int i10, UserId userId, String str, String str2, String str3, SerializationConstructorMarker serializationConstructorMarker) {
        ...
        this.f9668id = userId.m1144unboximpl();
        if ((i10 & 2) == 0) {
            this.username = null;
        } else {
            this.username = str;
