...
public final class DirectReplyUser {
    ...
    public static /* synthetic */ DirectReplyUser m991copyASSxI_0$default(DirectReplyUser directReplyUser, long j10, String str, String str2, String str3, int i10, Object obj) {
        if ((i10 & 1) != 0) {
            j10 = directReplyUser.f9528id;
        }
        long j11 = j10;
        if ((i10 & 2) != 0) {
        ...
        return directReplyUser.m993copyASSxI_0(j11, str4, str5, str3);
    }
    ...
    public static final /* synthetic */ void write$Self$notification_api_release(DirectReplyUser directReplyUser, CompositeEncoder compositeEncoder, SerialDescriptor serialDescriptor) {
        compositeEncoder.s(serialDescriptor, 0, UserId$$serializer.INSTANCE, UserId.m1135boximpl(directReplyUser.f9528id));
        if (compositeEncoder.A(serialDescriptor, 1) || directReplyUser.username != null) {
            compositeEncoder.l(serialDescriptor, 1, n2.f31089a, directReplyUser.username);
        }
        if (compositeEncoder.A(serialDescriptor, 2) || directReplyUser.discriminator != null) {
            compositeEncoder.l(serialDescriptor, 2, n2.f31089a, directReplyUser.discriminator);
        }
        if (compositeEncoder.A(serialDescriptor, 3) || directReplyUser.avatar != null) {
            compositeEncoder.l(serialDescriptor, 3, n2.f31089a, directReplyUser.avatar);
        }
    }

    /* renamed from: component1-re6GcUE  reason: not valid java name */
    public final long m992component1re6GcUE() {
        return this.f9528id;
    }
    ...
    public final DirectReplyUser m993copyASSxI_0(long j10, String str, String str2, String str3) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof DirectReplyUser) {
            ...
            return UserId.m1139equalsimpl0(this.f9528id, directReplyUser.f9528id) && Intrinsics.areEqual(this.username, directReplyUser.username) && Intrinsics.areEqual(this.discriminator, directReplyUser.discriminator) && Intrinsics.areEqual(this.avatar, directReplyUser.avatar);
        }
        return false;
    }
    ...
    public final long m994getIdre6GcUE() {
        return this.f9528id;
    }
    ...
    public int hashCode() {
        int m1140hashCodeimpl = UserId.m1140hashCodeimpl(this.f9528id) * 31;
    ...
    public String toString() {
        String m1142toStringimpl = UserId.m1142toStringimpl(this.f9528id);
        String str = this.username;
        String str2 = this.discriminator;
        String str3 = this.avatar;
        return "DirectReplyUser(id=" + m1142toStringimpl + ", username=" + str + ", discriminator=" + str2 + ", avatar=" + str3 + ")";
    }
    ...
    private /* synthetic */ DirectReplyUser(int i10, UserId userId, String str, String str2, String str3, SerializationConstructorMarker serializationConstructorMarker) {
        ...
        this.f9528id = userId.m1144unboximpl();
        if ((i10 & 2) == 0) {
            this.username = null;
        } else {
            this.username = str;
