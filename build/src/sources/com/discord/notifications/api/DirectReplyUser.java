...
public final class DirectReplyUser {
    ...
    public static final /* synthetic */ void write$Self$notification_api_release(DirectReplyUser directReplyUser, CompositeEncoder compositeEncoder, SerialDescriptor serialDescriptor) {
        compositeEncoder.D(serialDescriptor, 0, UserId$$serializer.INSTANCE, UserId.m1137boximpl(directReplyUser.f9244id));
        if (compositeEncoder.z(serialDescriptor, 1) || directReplyUser.username != null) {
            compositeEncoder.s(serialDescriptor, 1, n2.f20978a, directReplyUser.username);
        }
        if (compositeEncoder.z(serialDescriptor, 2) || directReplyUser.discriminator != null) {
            compositeEncoder.s(serialDescriptor, 2, n2.f20978a, directReplyUser.discriminator);
        }
        if (compositeEncoder.z(serialDescriptor, 3) || directReplyUser.avatar != null) {
            compositeEncoder.s(serialDescriptor, 3, n2.f20978a, directReplyUser.avatar);
        }
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof DirectReplyUser) {
            ...
            return UserId.m1141equalsimpl0(this.f9244id, directReplyUser.f9244id) && Intrinsics.areEqual(this.username, directReplyUser.username) && Intrinsics.areEqual(this.discriminator, directReplyUser.discriminator) && Intrinsics.areEqual(this.avatar, directReplyUser.avatar);
        }
        return false;
    }
    ...
    public int hashCode() {
        int m1142hashCodeimpl = UserId.m1142hashCodeimpl(this.f9244id) * 31;
    ...
    public String toString() {
        String m1144toStringimpl = UserId.m1144toStringimpl(this.f9244id);
        String str = this.username;
        String str2 = this.discriminator;
        String str3 = this.avatar;
    ...
    private /* synthetic */ DirectReplyUser(int i10, UserId userId, String str, String str2, String str3, SerializationConstructorMarker serializationConstructorMarker) {
        ...
        this.f9244id = userId.m1146unboximpl();
        if ((i10 & 2) == 0) {
            this.username = null;
        } else {
            this.username = str;
