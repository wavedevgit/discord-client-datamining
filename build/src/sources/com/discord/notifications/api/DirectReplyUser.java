...
public final class DirectReplyUser {
    ...
    public static /* synthetic */ DirectReplyUser m994copyASSxI_0$default(DirectReplyUser directReplyUser, long j10, String str, String str2, String str3, int i10, Object obj) {
        if ((i10 & 1) != 0) {
            j10 = directReplyUser.f10276id;
        }
        long j11 = j10;
        if ((i10 & 2) != 0) {
        ...
        return directReplyUser.m996copyASSxI_0(j11, str4, str5, str3);
    }
    ...
    public static final /* synthetic */ void write$Self$notification_api_release(DirectReplyUser directReplyUser, CompositeEncoder compositeEncoder, SerialDescriptor serialDescriptor) {
        compositeEncoder.m(serialDescriptor, 0, UserId$$serializer.INSTANCE, UserId.m1138boximpl(directReplyUser.f10276id));
        if (compositeEncoder.y(serialDescriptor, 1) || directReplyUser.username != null) {
            compositeEncoder.B(serialDescriptor, 1, n2.f7662a, directReplyUser.username);
        }
        if (compositeEncoder.y(serialDescriptor, 2) || directReplyUser.discriminator != null) {
            compositeEncoder.B(serialDescriptor, 2, n2.f7662a, directReplyUser.discriminator);
        }
        if (compositeEncoder.y(serialDescriptor, 3) || directReplyUser.avatar != null) {
            compositeEncoder.B(serialDescriptor, 3, n2.f7662a, directReplyUser.avatar);
        }
    }

    /* renamed from: component1-re6GcUE  reason: not valid java name */
    public final long m995component1re6GcUE() {
    ...
    public final DirectReplyUser m996copyASSxI_0(long j10, String str, String str2, String str3) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof DirectReplyUser) {
            ...
            return UserId.m1142equalsimpl0(this.f10276id, directReplyUser.f10276id) && Intrinsics.areEqual(this.username, directReplyUser.username) && Intrinsics.areEqual(this.discriminator, directReplyUser.discriminator) && Intrinsics.areEqual(this.avatar, directReplyUser.avatar);
        }
        return false;
    }
    ...
    public final long m997getIdre6GcUE() {
        return this.f10276id;
    }
    ...
    public int hashCode() {
        int m1143hashCodeimpl = UserId.m1143hashCodeimpl(this.f10276id) * 31;
    ...
    public String toString() {
        String m1145toStringimpl = UserId.m1145toStringimpl(this.f10276id);
        String str = this.username;
        String str2 = this.discriminator;
        String str3 = this.avatar;
        return "DirectReplyUser(id=" + m1145toStringimpl + ", username=" + str + ", discriminator=" + str2 + ", avatar=" + str3 + ")";
    }
    ...
    private /* synthetic */ DirectReplyUser(int i10, UserId userId, String str, String str2, String str3, SerializationConstructorMarker serializationConstructorMarker) {
        ...
        this.f10276id = userId.m1147unboximpl();
        if ((i10 & 2) == 0) {
            this.username = null;
        } else {
            this.username = str;
