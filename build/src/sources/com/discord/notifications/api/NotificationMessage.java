...
public final class NotificationMessage {
    ...
    static {
        o oVar = o.f6082e;
        $childSerializers = new Lazy[]{l.a(oVar, new Function0() { // from class: q7.f
        ...
        }), null, l.a(oVar, new Function0() { // from class: q7.g
            @Override // kotlin.jvm.functions.Function0
            public final Object invoke() {
        ...
        }), null, l.a(oVar, new Function0() { // from class: q7.h
            @Override // kotlin.jvm.functions.Function0
            public final Object invoke() {
        ...
        }), l.a(oVar, new Function0() { // from class: q7.i
            @Override // kotlin.jvm.functions.Function0
            public final Object invoke() {
    ...
    public static final /* synthetic */ void write$Self$notification_api_release(NotificationMessage notificationMessage, CompositeEncoder compositeEncoder, SerialDescriptor serialDescriptor) {
        ...
        if (compositeEncoder.z(serialDescriptor, 1) || notificationMessage.author != null) {
            compositeEncoder.o(serialDescriptor, 1, y.f51830a, notificationMessage.author);
        }
        ...
        if (compositeEncoder.z(serialDescriptor, 3) || notificationMessage.poll != null) {
            compositeEncoder.o(serialDescriptor, 3, Poll$$serializer.INSTANCE, notificationMessage.poll);
        }
        if (compositeEncoder.z(serialDescriptor, 4) || !Intrinsics.areEqual(notificationMessage.embeds, CollectionsKt.l())) {
            compositeEncoder.k(serialDescriptor, 4, (qt.o) lazyArr[4].getValue(), notificationMessage.embeds);
        }
        if (compositeEncoder.z(serialDescriptor, 5) || !Intrinsics.areEqual(notificationMessage.components, CollectionsKt.l())) {
            compositeEncoder.k(serialDescriptor, 5, (qt.o) lazyArr[5].getValue(), notificationMessage.components);
        }
    }
