...
public final class DirectReplyMessage {
    ...
    public static final class Companion {
        ...
        public final NotificationData toNotificationData(@NotNull String data) {
            ...
            String m993getId3Eiw7ao = directReplyMessage.m993getId3Eiw7ao();
            Integer type = directReplyMessage.getType();
            String content = directReplyMessage.getContent();
            long m992getChannelIdo4g7jtM = directReplyMessage.m992getChannelIdo4g7jtM();
            Integer channelType = directReplyMessage.getChannelType();
            List l10 = CollectionsKt.l();
            long m997getIdre6GcUE = directReplyMessage.getAuthor().m997getIdre6GcUE();
    ...
    public static /* synthetic */ DirectReplyMessage m987copy_6Dih7Q$default(DirectReplyMessage directReplyMessage, String str, long j10, DirectReplyUser directReplyUser, String str2, Integer num, Integer num2, String str3, String str4, int i10, Object obj) {
        if ((i10 & 1) != 0) {
            str = directReplyMessage.f10275id;
        }
        if ((i10 & 2) != 0) {
        ...
        String str5 = str3;
        String str6 = str4;
        return directReplyMessage.m991copy_6Dih7Q(str, j10, directReplyUser, str2, num, num2, str5, str6);
    }

    /* renamed from: getChannelId-o4g7jtM$annotations  reason: not valid java name */
    public static /* synthetic */ void m988getChannelIdo4g7jtM$annotations() {
    }
    ...
    public static final /* synthetic */ void write$Self$notification_api_release(DirectReplyMessage directReplyMessage, CompositeEncoder compositeEncoder, SerialDescriptor serialDescriptor) {
        compositeEncoder.m(serialDescriptor, 0, MessageId$$serializer.INSTANCE, MessageId.m1086boximpl(directReplyMessage.f10275id));
        compositeEncoder.m(serialDescriptor, 1, ChannelId$$serializer.INSTANCE, ChannelId.m1060boximpl(directReplyMessage.channelId));
        compositeEncoder.m(serialDescriptor, 2, DirectReplyUser$$serializer.INSTANCE, directReplyMessage.author);
        if (compositeEncoder.y(serialDescriptor, 3) || directReplyMessage.content != null) {
            compositeEncoder.B(serialDescriptor, 3, n2.f7662a, directReplyMessage.content);
        }
        if (compositeEncoder.y(serialDescriptor, 4) || directReplyMessage.type != null) {
            compositeEncoder.B(serialDescriptor, 4, p0.f7678a, directReplyMessage.type);
        }
        if (compositeEncoder.y(serialDescriptor, 5) || directReplyMessage.channelType != null) {
            compositeEncoder.B(serialDescriptor, 5, p0.f7678a, directReplyMessage.channelType);
        }
        if (compositeEncoder.y(serialDescriptor, 6) || directReplyMessage.channelName != null) {
            compositeEncoder.B(serialDescriptor, 6, n2.f7662a, directReplyMessage.channelName);
        }
        if (compositeEncoder.y(serialDescriptor, 7) || directReplyMessage.guildName != null) {
            compositeEncoder.B(serialDescriptor, 7, n2.f7662a, directReplyMessage.guildName);
        }
    }

    @NotNull
    /* renamed from: component1-3Eiw7ao  reason: not valid java name */
    public final String m989component13Eiw7ao() {
        return this.f10275id;
    }

    /* renamed from: component2-o4g7jtM  reason: not valid java name */
    public final long m990component2o4g7jtM() {
    ...
    public final DirectReplyMessage m991copy_6Dih7Q(@NotNull String id2, long j10, @NotNull DirectReplyUser author, String str, Integer num, Integer num2, String str2, String str3) {
    ...
    public final long m992getChannelIdo4g7jtM() {
        return this.channelId;
    }
    ...
    public final String m993getId3Eiw7ao() {
        return this.f10275id;
    }
    ...
    public int hashCode() {
        int m1091hashCodeimpl = ((((MessageId.m1091hashCodeimpl(this.f10275id) * 31) + ChannelId.m1065hashCodeimpl(this.channelId)) * 31) + this.author.hashCode()) * 31;
    ...
    public String toString() {
        String m1093toStringimpl = MessageId.m1093toStringimpl(this.f10275id);
        ...
        String str2 = this.channelName;
        String str3 = this.guildName;
        return "DirectReplyMessage(id=" + m1093toStringimpl + ", channelId=" + m1067toStringimpl + ", author=" + directReplyUser + ", content=" + str + ", type=" + num + ", channelType=" + num2 + ", channelName=" + str2 + ", guildName=" + str3 + ")";
    }
