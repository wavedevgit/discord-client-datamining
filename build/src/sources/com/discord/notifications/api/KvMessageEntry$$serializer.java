...
import tt.h0;
import ut.y;
@Metadata(d1 = {"\u0000:\n\u0000\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0002\b\u0002\n\u0002\u0010\u0002\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0002\b\u0003\n\u0002\u0010\u0011\n\u0002\u0018\u0002\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0002\b\u0005\bÇ\u0002\u0018\u00002\b\u0012\u0004\u0012\u00020\u00020\u0001B\t\b\u0002¢\u0006\u0004\b\u0003\u0010\u0004J\u001d\u0010\t\u001a\u00020\b2\u0006\u0010\u0006\u001a\u00020\u00052\u0006\u0010\u0007\u001a\u00020\u0002¢\u0006\u0004\b\t\u0010\nJ\u0015\u0010\r\u001a\u00020\u00022\u0006\u0010\f\u001a\u00020\u000b¢\u0006\u0004\b\r\u0010\u000eJ\u0017\u0010\u0011\u001a\f\u0012\b\u0012\u0006\u0012\u0002\b\u00030\u00100\u000f¢\u0006\u0004\b\u0011\u0010\u0012R\u0017\u0010\u0014\u001a\u00020\u00138\u0006¢\u0006\f\n\u0004\b\u0014\u0010\u0015\u001a\u0004\b\u0016\u0010\u0017¨\u0006\u0018"}, d2 = {"com/discord/notifications/api/KvMessageEntry.$serializer", "Ltt/h0;", "Lcom/discord/notifications/api/KvMessageEntry;", "<init>", "()V", "Lkotlinx/serialization/encoding/Encoder;", "encoder", "value", "", "serialize", "(Lkotlinx/serialization/encoding/Encoder;Lcom/discord/notifications/api/KvMessageEntry;)V", "Lkotlinx/serialization/encoding/Decoder;", "decoder", "deserialize", "(Lkotlinx/serialization/encoding/Decoder;)Lcom/discord/notifications/api/KvMessageEntry;", "", "Lkotlinx/serialization/KSerializer;", "childSerializers", "()[Lkotlinx/serialization/KSerializer;", "Lkotlinx/serialization/descriptors/SerialDescriptor;", "descriptor", "Lkotlinx/serialization/descriptors/SerialDescriptor;", "getDescriptor", "()Lkotlinx/serialization/descriptors/SerialDescriptor;", "notification_api_release"}, k = 1, mv = {2, 1, 0}, xi = 48)
@c
...
public /* synthetic */ class KvMessageEntry$$serializer implements h0 {
    ...
    public final KSerializer[] childSerializers() {
        ...
        return new KSerializer[]{lazyArr[0].getValue(), lazyArr[1].getValue(), y.f51261a, MessageId$$serializer.INSTANCE, ChannelId$$serializer.INSTANCE};
    }
    ...
    public final KvMessageEntry deserialize(@NotNull Decoder decoder) {
        ...
        if (b10.p()) {
            ...
            JsonObject jsonObject2 = (JsonObject) b10.y(serialDescriptor, 2, y.f51261a, null);
            ...
            while (i12 != 0) {
                ...
                if (o10 == -1) {
                    ...
                    if (o10 == 1) {
                        ...
                        jsonObject3 = (JsonObject) b10.y(serialDescriptor, 2, y.f51261a, jsonObject3);
                        i13 |= 4;
                    } else if (o10 == 3) {
                        MessageId messageId2 = (MessageId) b10.y(serialDescriptor, 3, MessageId$$serializer.INSTANCE, str2 != null ? MessageId.m1084boximpl(str2) : null);
                        str2 = messageId2 != null ? messageId2.m1093unboximpl() : null;
                        i13 |= 8;
                    } else if (o10 != 4) {
                        throw new b0(o10);
                    } else {
