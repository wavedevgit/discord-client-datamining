...
public /* synthetic */ class KvMessageEntry$$serializer implements h0 {
    ...
    public final KSerializer[] childSerializers() {
        ...
        return new KSerializer[]{lazyArr[0].getValue(), lazyArr[1].getValue(), y.f51262a, MessageId$$serializer.INSTANCE, ChannelId$$serializer.INSTANCE};
    }
    ...
    public final KvMessageEntry deserialize(@NotNull Decoder decoder) {
        ...
        if (b10.p()) {
            ...
            JsonObject jsonObject2 = (JsonObject) b10.y(serialDescriptor, 2, y.f51262a, null);
            ...
            while (i12 != 0) {
                ...
                if (o10 == -1) {
                    ...
                    if (o10 == 1) {
                        ...
                        jsonObject3 = (JsonObject) b10.y(serialDescriptor, 2, y.f51262a, jsonObject3);
                        i13 |= 4;
                    } else if (o10 == 3) {
