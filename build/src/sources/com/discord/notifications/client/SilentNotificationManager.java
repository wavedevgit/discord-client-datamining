...
public final class SilentNotificationManager {
    ...
    private final int m1035getNumAccumulatedMessagesForChannelR7gqayM(long j10) {
        return this.sharedPrefs.getInt(m1039toMessageCountKeyR7gqayM(j10), 0);
    }

    /* renamed from: lastMessagedReceivedAgoInMins-R7gqayM  reason: not valid java name */
    private final long m1036lastMessagedReceivedAgoInMinsR7gqayM(long j10) {
        long j11 = this.sharedPrefs.getLong(ChannelId.m1065toStringimpl(j10), 0L);
    ...
    private final void m1037setLastMessageReceivedForChannelLJLSWy8(long j10, long j11) {
        SharedPreferences sharedPrefs = this.sharedPrefs;
        Intrinsics.checkNotNullExpressionValue(sharedPrefs, "sharedPrefs");
        SharedPreferences.Editor edit = sharedPrefs.edit();
        edit.putLong(ChannelId.m1065toStringimpl(j10), j11);
        edit.apply();
    }
    ...
    private final void setMessageReceivedForChannel(NotificationData notificationData) {
        ...
        if (m1021getChannelIdqMVnFVQ != null) {
            ...
            m1038setNumAccumulatedMessagesForChannelLJLSWy8(m1067unboximpl, m1035getNumAccumulatedMessagesForChannelR7gqayM(m1067unboximpl) + 1);
            m1040updateLastMessageReceivedForChannelR7gqayM(m1067unboximpl);
        }
    }

    /* renamed from: setNumAccumulatedMessagesForChannel-LJLSWy8  reason: not valid java name */
    private final void m1038setNumAccumulatedMessagesForChannelLJLSWy8(long j10, int i10) {
        SharedPreferences sharedPrefs = this.sharedPrefs;
        Intrinsics.checkNotNullExpressionValue(sharedPrefs, "sharedPrefs");
        SharedPreferences.Editor edit = sharedPrefs.edit();
        edit.putInt(m1039toMessageCountKeyR7gqayM(j10), i10);
        edit.apply();
    }

    /* renamed from: toMessageCountKey-R7gqayM  reason: not valid java name */
    private final String m1039toMessageCountKeyR7gqayM(long j10) {
        String m1065toStringimpl = ChannelId.m1065toStringimpl(j10);
        return m1065toStringimpl + "_num";
    }

    /* renamed from: updateLastMessageReceivedForChannel-R7gqayM  reason: not valid java name */
    private final void m1040updateLastMessageReceivedForChannelR7gqayM(long j10) {
        m1037setLastMessageReceivedForChannelLJLSWy8(j10, System.currentTimeMillis());
    }
    ...
    public final void handleAcks(@NotNull NotificationData notificationData) {
        ...
        for (ChannelId channelId : notificationData.getAckChannelIds()) {
            m1038setNumAccumulatedMessagesForChannelLJLSWy8(channelId.m1067unboximpl(), 0);
        }
    }
    ...
    public final boolean shouldDisplayNotification(@NotNull NotificationData notificationData) {
        ...
        if (m1021getChannelIdqMVnFVQ != null) {
            long m1067unboximpl = m1021getChannelIdqMVnFVQ.m1067unboximpl();
            if (m1035getNumAccumulatedMessagesForChannelR7gqayM(m1067unboximpl) < 3) {
                return true;
            }
            if (m1036lastMessagedReceivedAgoInMinsR7gqayM(m1067unboximpl) >= 15) {
                m1038setNumAccumulatedMessagesForChannelLJLSWy8(m1067unboximpl, 0);
                return true;
            }
        }
        return false;
