...
public final class NotificationManagerUtilsKt {
    ...
    public static final List<StatusBarNotification> m1043getCallNotificationsmJqaSGE(@NotNull Context getCallNotifications, long j10) {
        Object b10;
        boolean P;
        ...
        for (StatusBarNotification statusBarNotification : statusBarNotificationArr) {
            if (statusBarNotification.getTag() == null) {
                ...
                String tag = statusBarNotification.getTag();
                Intrinsics.checkNotNullExpressionValue(tag, "getTag(...)");
                P = StringsKt.P(tag, NotificationData.TYPE_CALL_RING + ChannelId.m1064toStringimpl(j10), false, 2, null);
            }
            if (P) {
                arrayList.add(statusBarNotification);
            }
