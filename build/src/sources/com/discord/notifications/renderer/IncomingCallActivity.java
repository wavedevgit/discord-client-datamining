...
public final class IncomingCallActivity extends AppCompatActivity {
    ...
    public final String m1042getIconUrlForAvatarr1nfqec(Context context, String str, GuildId guildId, UserId userId, String str2, int i10) {
        IconUrlUtils iconUrlUtils = IconUrlUtils.INSTANCE;
        IconUrlUtils.init$default(iconUrlUtils, context, null, null, 6, null);
        String m915getForGuildMember2tNb6hE$default = IconUrlUtils.m915getForGuildMember2tNb6hE$default(iconUrlUtils, str, guildId, userId, null, false, 24, null);
        if (m915getForGuildMember2tNb6hE$default.length() == 0) {
            return IconUrlUtils.m916getForUser_fRzTXg$default(iconUrlUtils, context, userId, str2, Integer.valueOf(i10), false, null, 32, null);
        }
