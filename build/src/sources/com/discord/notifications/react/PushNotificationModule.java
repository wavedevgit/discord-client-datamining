...
public final class PushNotificationModule extends ReactContextBaseJavaModule {
    ...
    public PushNotificationModule(@NotNull ReactApplicationContext reactContext) {
        ...
        NotificationClient.Companion.getInstance().setShouldDisplayNotification(new Function0() { // from class: s7.a
        ...
        if (hashCode != -690213213) {
            if (hashCode != -145165322) {
                if (hashCode == 595233003 && type.equals(EVENT_TYPE_NOTIFICATION)) {
                    NotificationClient.Companion.getInstance().setNotificationListener(new Function1() { // from class: s7.c
                ...
                NotificationClient.Companion.getInstance().setLocalNotificationListener(new Function1() { // from class: s7.d
                    @Override // kotlin.jvm.functions.Function1
                    public final Object invoke(Object obj) {
            ...
            NotificationClient.Companion.getInstance().setTokenListener(new Function1() { // from class: s7.b
                @Override // kotlin.jvm.functions.Function1
                public final Object invoke(Object obj) {
