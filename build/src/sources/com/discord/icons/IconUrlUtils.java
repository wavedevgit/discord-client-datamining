...
public final class IconUrlUtils {
    ...
    public static /* synthetic */ String m912getApplicationIconweIltyw$default(IconUrlUtils iconUrlUtils, ApplicationId applicationId, String str, int i10, int i11, Object obj) {
        if ((i11 & 4) != 0) {
            i10 = 160;
        }
        return iconUrlUtils.m917getApplicationIconweIltyw(applicationId, str, i10);
    }
    ...
    public static /* synthetic */ String m913getForChannelJYSGpIY$default(IconUrlUtils iconUrlUtils, Context context, ChannelId channelId, String str, boolean z10, Integer num, int i10, Object obj) {
        if ((i10 & 16) != 0) {
            num = null;
        }
        return iconUrlUtils.m918getForChannelJYSGpIY(context, channelId, str, z10, num);
    }

    /* renamed from: getForGuild-14CJxO4$default */
    public static /* synthetic */ String m914getForGuild14CJxO4$default(IconUrlUtils iconUrlUtils, GuildId guildId, String str, String str2, boolean z10, Integer num, int i10, Object obj) {
        if ((i10 & 4) != 0) {
            str2 = null;
        }
        if ((i10 & 8) != 0) {
        ...
        return iconUrlUtils.m919getForGuild14CJxO4(guildId, str, str2, z10, num);
    }

    /* renamed from: getForGuildMember-2tNb6hE$default */
    public static /* synthetic */ String m915getForGuildMember2tNb6hE$default(IconUrlUtils iconUrlUtils, String str, GuildId guildId, UserId userId, Integer num, boolean z10, int i10, Object obj) {
        if ((i10 & 8) != 0) {
            num = null;
        }
        Integer num2 = num;
        ...
        return iconUrlUtils.m920getForGuildMember2tNb6hE(str, guildId, userId, num2, z10);
    }

    /* renamed from: getForUser-_fRzTXg$default */
    public static /* synthetic */ String m916getForUser_fRzTXg$default(IconUrlUtils iconUrlUtils, Context context, UserId userId, String str, Integer num, boolean z10, Integer num2, int i10, Object obj) {
        if ((i10 & 8) != 0) {
            num = null;
        }
        if ((i10 & 16) != 0) {
        ...
        return iconUrlUtils.m921getForUser_fRzTXg(context, userId, str, num, z10, num2);
    }
    ...
    public final String m917getApplicationIconweIltyw(ApplicationId applicationId, String str, int i10) {
    ...
    public final String m918getForChannelJYSGpIY(@NotNull Context context, ChannelId channelId, String str, boolean z10, Integer num) {
        String b10;
    ...
    public final String m919getForGuild14CJxO4(GuildId guildId, String str, String str2, boolean z10, Integer num) {
        String b10;
    ...
    public final String m920getForGuildMember2tNb6hE(String str, GuildId guildId, UserId userId, Integer num, boolean z10) {
        if (str != null && !StringsKt.k0(str) && guildId != null && GuildId.m1077isValidimpl(guildId.m1080unboximpl()) && userId != null && UserId.m1142isValidimpl(userId.m1145unboximpl())) {
            String cdn = Hosts.INSTANCE.getCDN();
    ...
    public final String m921getForUser_fRzTXg(@NotNull Context context, UserId userId, String str, Integer num, boolean z10, Integer num2) {
        String b10;
        Intrinsics.checkNotNullParameter(context, "context");
        if (userId != null) {
            if (UserId.m1139equalsimpl(UserId.m1137constructorimpl(-1L), userId)) {
                if (str == null) {
                    return "";
                }
                return str;
