...
public final class MainApplication extends TTILoggingApplication implements ReactApplication {
    ...
    @NotNull
    private final Lazy reactHost$delegate = l.b(new Function0() { // from class: com.discord.b
    ...
    public static final Unit performInitialization$lambda$6(MainApplication mainApplication) {
        ...
        CrashReporting.INSTANCE.init(mainApplication, (bundle == null || (r0 = bundle.getReleaseName()) == null) ? "discord_android@315.6.0-2+315206" : "discord_android@315.6.0-2+315206");
