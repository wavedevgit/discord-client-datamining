...
public final class MainApplication extends TTILoggingApplication implements ReactApplication {
    ...
    @NotNull
    private final Lazy mountingModeExperiment$delegate = l.b(new Function0() { // from class: com.discord.c
        @Override // kotlin.jvm.functions.Function0
        public final Object invoke() {
    ...
    private final void performInitialization() {
        ...
        es.a.b(false, false, null, "ReactNativeLoader", 10, new Function0() { // from class: com.discord.d
            @Override // kotlin.jvm.functions.Function0
            public final Object invoke() {
        ...
        try {
            ...
            Thread b10 = es.a.b(false, false, null, null, 0, new Function0() { // from class: com.discord.e
                @Override // kotlin.jvm.functions.Function0
                public final Object invoke() {
            ...
            es.a.b(false, false, null, "PreInitReactHost", 0, new Function0() { // from class: com.discord.f
                @Override // kotlin.jvm.functions.Function0
                public final Object invoke() {
    ...
    public static final Unit performInitialization$lambda$7(MainApplication mainApplication) {
        ...
        CrashReporting.INSTANCE.init(mainApplication, (bundle == null || (r0 = bundle.getReleaseName()) == null) ? "discord_android@317.5.0-2+317205" : "discord_android@317.5.0-2+317205");
    ...
    protected void attachBaseContext(@NotNull final Context base) {
        ...
        es.a.b(false, false, null, "helperReactNativeLoader", 10, new Function0() { // from class: com.discord.h
            @Override // kotlin.jvm.functions.Function0
            public final Object invoke() {
    ...
    public void initialize() {
        ...
        if (Build.VERSION.SDK_INT < 28) {
            ...
            es.a.b(false, false, null, "ReactNativeInitThread", 10, new Function0() { // from class: com.discord.i
                @Override // kotlin.jvm.functions.Function0
                public final Object invoke() {
    ...
    public void onCreate() {
        super.onCreate();
        es.a.b(false, false, null, null, 0, new Function0() { // from class: com.discord.g
            @Override // kotlin.jvm.functions.Function0
            public final Object invoke() {
