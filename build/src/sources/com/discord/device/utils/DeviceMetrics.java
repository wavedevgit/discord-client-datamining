...
public final class DeviceMetrics {
    ...
    public final MetricsSize getScreenSize(Activity activity) {
        ...
        try {
            return new MetricsSize(i4.a.f28362a.a().a(activity));
    ...
    public final MetricsSize getWindowSize(Activity activity) {
        ...
        try {
            WindowMetrics a10 = i4.a.f28362a.a().a(activity);
            if (Build.VERSION.SDK_INT >= 34) {
                ...
                return new MetricsSize((a10.a().width() - g10.f3150a) - g10.f3152c, (a10.a().height() - g10.f3151b) - g10.f3153d);
            }
        } catch (Exception unused) {
        }
        return null;
