...
public final class DeviceMetrics {
    ...
    public final MetricsSize getScreenSize(Activity activity) {
        ...
        try {
            return new MetricsSize(i4.a.f28352a.a().a(activity));
    ...
    public final MetricsSize getWindowSize(Activity activity) {
        ...
        try {
            WindowMetrics a10 = i4.a.f28352a.a().a(activity);
            if (Build.VERSION.SDK_INT >= 34) {
                ...
                return new MetricsSize((a10.a().width() - g10.f3304a) - g10.f3306c, (a10.a().height() - g10.f3305b) - g10.f3307d);
            }
        } catch (Exception unused) {
        }
        return null;
