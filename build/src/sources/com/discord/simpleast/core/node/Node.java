...
public class Node<R> {
    ...
    public static class Parent<R> extends Node<R> {
        ...
        */
        public Parent(@org.jetbrains.annotations.NotNull com.discord.simpleast.core.node.Node<R>... r5) {
            /*
                r4 = this;
            ...
            L15:
                ...
                goto Lc
            L18:
                java.util.List r5 = kotlin.collections.CollectionsKt.j1(r0)
        ...
        public String toString() {
            ...
            Collection<Node<R>> children = getChildren();
            if (children != null) {
                str = CollectionsKt.x0(children, "\n->", ">>", "\n>|", 0, null, new Function1<Node<R>, CharSequence>() { // from class: com.discord.simpleast.core.node.Node$Parent$toString$1
