...
public final class ParseSpec<R, S> {
    ...
    public static final class Companion {
        ...
        @NotNull
        public final <R, S> ParseSpec<R, S> createNonterminal(@NotNull Node<R> node, S s10, int i10, int i11) {
            Intrinsics.checkNotNullParameter(node, "node");
            return new ParseSpec<>(node, s10, i10, i11);
        }

        @NotNull
        public final <R, S> ParseSpec<R, S> createTerminal(@NotNull Node<R> node, S s10) {
            Intrinsics.checkNotNullParameter(node, "node");
    ...
    public ParseSpec(@NotNull Node<R> root, S s10, int i10, int i11) {
    ...
    @NotNull
    public static final <R, S> ParseSpec<R, S> createNonterminal(@NotNull Node<R> node, S s10, int i10, int i11) {
        return Companion.createNonterminal(node, s10, i10, i11);
    }

    @NotNull
    public static final <R, S> ParseSpec<R, S> createTerminal(@NotNull Node<R> node, S s10) {
    ...
    public ParseSpec(@NotNull Node<R> root, S s10) {
        Intrinsics.checkNotNullParameter(root, "root");
        this.root = root;
        this.state = s10;
