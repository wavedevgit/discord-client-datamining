...
public abstract class Rule<R, T extends Node<R>, S> {
    ...
    public static abstract class BlockRule<R, T extends Node<R>, S> extends Rule<R, T, S> {
        ...
        public Matcher match(@NotNull CharSequence inspectionSource, String str, S s10) {
            Intrinsics.checkNotNullParameter(inspectionSource, "inspectionSource");
            if (str != null && !StringsKt.Y(str, '\n', false, 2, null)) {
                return null;
            }
            return super.match(inspectionSource, str, s10);
        }
    }
    ...
    @NotNull
    public abstract ParseSpec<R, S> parse(@NotNull Matcher matcher, @NotNull Parser<R, ? super T, S> parser, S s10);
    ...
    */
    public Rule(@org.jetbrains.annotations.NotNull java.util.regex.Pattern r2) {
        /*
            r1 = this;
