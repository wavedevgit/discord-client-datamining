...
public class Parser<R, T extends Node<R>, S> {
    ...
    public final Parser<R, T, S> addRules(@NotNull Rule<R, ? extends T, S>... newRules) {
        ...
        return addRules(i.e(newRules));
    }

    @NotNull
    public final List<T> parse(@NotNull CharSequence charSequence, S s10) {
    ...
    /* JADX WARN: Multi-variable type inference failed */
    @NotNull
    public final List<T> parse(@NotNull CharSequence source, S s10, @NotNull List<? extends Rule<R, ? extends T, S>> rules) {
        Pair pair;
        ...
        while (!stack.isEmpty()) {
            ...
            while (true) {
                ...
                Rule rule = (Rule) ((Rule<R, ? extends T, S>) it.next());
        ...
        List<T> j12 = children != null ? CollectionsKt.j1(children) : null;
        List<T> list = TypeIntrinsics.isMutableList(j12) ? j12 : null;
