...
/* synthetic */ class DCDPackageList$getPackages$49 extends FunctionReferenceImpl implements Function1<ReactApplicationContext, AppLifecycleModule> {
    ...
    public final AppLifecycleModule invoke(ReactApplicationContext p02) {
        Intrinsics.checkNotNullParameter(p02, "p0");
        return new AppLifecycleModule(p02);
    }
}
