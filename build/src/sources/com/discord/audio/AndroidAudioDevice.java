...
public final class AndroidAudioDevice {
    ...
    @NotNull
    private static final Lazy[] $childSerializers = {null, l.a(o.f32182e, new Function0() { // from class: com.discord.audio.a
    ...
    public static final /* synthetic */ void write$Self$audio_release(AndroidAudioDevice androidAudioDevice, CompositeEncoder compositeEncoder, SerialDescriptor serialDescriptor) {
        ...
        if (compositeEncoder.y(serialDescriptor, 0) || androidAudioDevice.deviceType != 0) {
            compositeEncoder.v(serialDescriptor, 0, androidAudioDevice.deviceType);
        }
        if (compositeEncoder.y(serialDescriptor, 1) || androidAudioDevice.simpleDeviceType != SimpleDeviceType.INVALID) {
            compositeEncoder.m(serialDescriptor, 1, (ys.o) lazyArr[1].getValue(), androidAudioDevice.simpleDeviceType);
        }
        if (compositeEncoder.y(serialDescriptor, 2) || androidAudioDevice.deviceId != -1) {
            compositeEncoder.v(serialDescriptor, 2, androidAudioDevice.deviceId);
        }
        if (compositeEncoder.y(serialDescriptor, 3) || !Intrinsics.areEqual(androidAudioDevice.deviceName, "")) {
