    ...
    public static final class ScreenshotData {
        ...
        public boolean equals(Object obj) {
            ...
            if (obj instanceof ScreenshotData) {
                ...
                return this.f8203id == screenshotData.f8203id && Intrinsics.areEqual(this.fileName, screenshotData.fileName) && Intrinsics.areEqual(this.relativePath, screenshotData.relativePath) && Intrinsics.areEqual(this.uri, screenshotData.uri) && this.dateAdded == screenshotData.dateAdded;
            }
            return false;
        }
        ...
        public int hashCode() {
            return (((((((Long.hashCode(this.f8203id) * 31) + this.fileName.hashCode()) * 31) + this.relativePath.hashCode()) * 31) + this.uri.hashCode()) * 31) + Long.hashCode(this.dateAdded);
        }
