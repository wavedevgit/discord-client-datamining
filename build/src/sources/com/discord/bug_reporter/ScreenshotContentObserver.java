    ...
    public static final class ScreenshotData {
        ...
        public boolean equals(Object obj) {
            ...
            if (obj instanceof ScreenshotData) {
                ...
                return this.f9235id == screenshotData.f9235id && Intrinsics.areEqual(this.fileName, screenshotData.fileName) && Intrinsics.areEqual(this.relativePath, screenshotData.relativePath) && Intrinsics.areEqual(this.uri, screenshotData.uri) && this.dateAdded == screenshotData.dateAdded;
            }
            return false;
        }
        ...
        public int hashCode() {
            return (((((((Long.hashCode(this.f9235id) * 31) + this.fileName.hashCode()) * 31) + this.relativePath.hashCode()) * 31) + this.uri.hashCode()) * 31) + Long.hashCode(this.dateAdded);
        }

        @NotNull
        public String toString() {
            long j10 = this.f9235id;
