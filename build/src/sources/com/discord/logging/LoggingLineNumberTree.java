...
public final class LoggingLineNumberTree extends a.c {
    @NotNull
    private final List<String> ignoreClasses = CollectionsKt.o(a.class.getName(), a.b.class.getName(), a.c.class.getName(), a.C0639a.class.getName(), LoggingLineNumberTree.class.getName(), Log.class.getName());
