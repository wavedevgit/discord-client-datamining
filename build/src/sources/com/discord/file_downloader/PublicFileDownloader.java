    ...
    public final boolean onFileDownloaded(ProducerScope producerScope, DownloadManager downloadManager, long j10, String str) {
        ...
        try {
            if (query.moveToFirst()) {
                producerScope.e(new DownloadState.Completed(new File(Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOWNLOADS), str)));
            } else {
                producerScope.e(new DownloadState.Failure(new IllegalStateException(new FileNotFoundException())));
            }
