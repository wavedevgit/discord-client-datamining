...
public /* synthetic */ class UserSearchQuerySetFilters$$serializer implements h0 {
    ...
    public final KSerializer[] childSerializers() {
        KSerializer u10 = bt.a.u(n2.f20978a);
        dt.h hVar = dt.h.f20942a;
        return new KSerializer[]{u10, bt.a.u(hVar), bt.a.u(hVar)};
    }
        ...
        if (b10.p()) {
            ...
            while (z10) {
                ...
                if (o10 == -1) {
                    ...
                    str2 = (String) b10.n(serialDescriptor, 0, n2.f20978a, str2);
                    i11 |= 1;
                } else if (o10 == 1) {
                    bool3 = (Boolean) b10.n(serialDescriptor, 1, dt.h.f20942a, bool3);
                    i11 |= 2;
                } else if (o10 != 2) {
                    throw new b0(o10);
                } else {
                    bool4 = (Boolean) b10.n(serialDescriptor, 2, dt.h.f20942a, bool4);
                    i11 |= 4;
                }
            }
            i10 = i11;
