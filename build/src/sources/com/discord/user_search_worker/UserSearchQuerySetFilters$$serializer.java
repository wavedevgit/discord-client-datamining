...
public /* synthetic */ class UserSearchQuerySetFilters$$serializer implements h0 {
    ...
    public final KSerializer[] childSerializers() {
        KSerializer u10 = rt.a.u(n2.f50032a);
        tt.h hVar = tt.h.f49996a;
        return new KSerializer[]{u10, rt.a.u(hVar), rt.a.u(hVar)};
    }
        ...
        if (b10.p()) {
            ...
            while (z10) {
                ...
                if (o10 == -1) {
                    ...
                    bool3 = (Boolean) b10.n(serialDescriptor, 1, tt.h.f49996a, bool3);
                    i11 |= 2;
                } else if (o10 != 2) {
                    throw new b0(o10);
                } else {
                    bool4 = (Boolean) b10.n(serialDescriptor, 2, tt.h.f49996a, bool4);
                    i11 |= 4;
                }
            }
            i10 = i11;
