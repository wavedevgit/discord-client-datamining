...
public /* synthetic */ class UserSearchQuerySetFilters$$serializer implements h0 {
    ...
    public final KSerializer[] childSerializers() {
        KSerializer u10 = et.a.u(n2.f25302a);
        gt.h hVar = gt.h.f25266a;
        return new KSerializer[]{u10, et.a.u(hVar), et.a.u(hVar)};
    }
        ...
        if (b10.p()) {
            ...
            while (z10) {
                ...
                if (o10 == -1) {
                    ...
                    bool3 = (Boolean) b10.n(serialDescriptor, 1, gt.h.f25266a, bool3);
                    i11 |= 2;
                } else if (o10 != 2) {
                    throw new b0(o10);
                } else {
                    bool4 = (Boolean) b10.n(serialDescriptor, 2, gt.h.f25266a, bool4);
                    i11 |= 4;
                }
            }
            i10 = i11;
