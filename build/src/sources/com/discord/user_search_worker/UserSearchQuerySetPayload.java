...
public final class UserSearchQuerySetPayload {
    ...
    static {
        ...
        }), l.b(oVar, new Function0() { // from class: com.discord.user_search_worker.b
            @Override // kotlin.jvm.functions.Function0
            public final Object invoke() {
        ...
        }), l.b(oVar, new Function0() { // from class: com.discord.user_search_worker.c
            @Override // kotlin.jvm.functions.Function0
            public final Object invoke() {
    ...
    public static final /* synthetic */ void write$Self$user_search_worker_release(UserSearchQuerySetPayload userSearchQuerySetPayload, CompositeEncoder compositeEncoder, SerialDescriptor serialDescriptor) {
        ...
        compositeEncoder.z(serialDescriptor, 0, userSearchQuerySetPayload.query);
        if (compositeEncoder.A(serialDescriptor, 1) || userSearchQuerySetPayload.filters != null) {
            compositeEncoder.l(serialDescriptor, 1, UserSearchQuerySetFilters$$serializer.INSTANCE, userSearchQuerySetPayload.filters);
        }
        if (compositeEncoder.A(serialDescriptor, 2) || userSearchQuerySetPayload.blacklist != null) {
            compositeEncoder.l(serialDescriptor, 2, (ft.o) lazyArr[2].getValue(), userSearchQuerySetPayload.blacklist);
        }
        if (compositeEncoder.A(serialDescriptor, 3) || userSearchQuerySetPayload.whitelist != null) {
            compositeEncoder.l(serialDescriptor, 3, (ft.o) lazyArr[3].getValue(), userSearchQuerySetPayload.whitelist);
        }
        compositeEncoder.s(serialDescriptor, 4, (ft.o) lazyArr[4].getValue(), userSearchQuerySetPayload.boosters);
        compositeEncoder.D(serialDescriptor, 5, userSearchQuerySetPayload.boosterFallback);
        compositeEncoder.x(serialDescriptor, 6, userSearchQuerySetPayload.limit);
    }
