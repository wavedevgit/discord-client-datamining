...
public final class UserSearchQuerySetPayload {
    ...
    public static final /* synthetic */ KSerializer _childSerializers$_anonymous_$1() {
        return new u0(n2.f7662a, x.f7716a);
    }
    ...
    public static final /* synthetic */ void write$Self$user_search_worker_release(UserSearchQuerySetPayload userSearchQuerySetPayload, CompositeEncoder compositeEncoder, SerialDescriptor serialDescriptor) {
        ...
        if (compositeEncoder.y(serialDescriptor, 1) || userSearchQuerySetPayload.filters != null) {
            compositeEncoder.B(serialDescriptor, 1, UserSearchQuerySetFilters$$serializer.INSTANCE, userSearchQuerySetPayload.filters);
        }
        if (compositeEncoder.y(serialDescriptor, 2) || userSearchQuerySetPayload.blacklist != null) {
            compositeEncoder.B(serialDescriptor, 2, (ys.o) lazyArr[2].getValue(), userSearchQuerySetPayload.blacklist);
        }
        if (compositeEncoder.y(serialDescriptor, 3) || userSearchQuerySetPayload.whitelist != null) {
            compositeEncoder.B(serialDescriptor, 3, (ys.o) lazyArr[3].getValue(), userSearchQuerySetPayload.whitelist);
        }
        compositeEncoder.m(serialDescriptor, 4, (ys.o) lazyArr[4].getValue(), userSearchQuerySetPayload.boosters);
