...
public final class UserSearchWorkerResult {
    ...
    public static /* synthetic */ UserSearchWorkerResult copy$default(UserSearchWorkerResult userSearchWorkerResult, String str, String str2, String str3, double d10, int i10, Object obj) {
        if ((i10 & 1) != 0) {
            str = userSearchWorkerResult.f9730id;
        }
        if ((i10 & 2) != 0) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof UserSearchWorkerResult) {
            ...
            return Intrinsics.areEqual(this.f9730id, userSearchWorkerResult.f9730id) && Intrinsics.areEqual(this.username, userSearchWorkerResult.username) && Intrinsics.areEqual(this.comparator, userSearchWorkerResult.comparator) && Double.compare(this.score, userSearchWorkerResult.score) == 0;
        }
        return false;
    }
    ...
    public int hashCode() {
        return (((((this.f9730id.hashCode() * 31) + this.username.hashCode()) * 31) + this.comparator.hashCode()) * 31) + Double.hashCode(this.score);
    }

    @NotNull
    public String toString() {
        String str = this.f9730id;
