...
public final class UserSearchUpdateUsersData extends UserSearchData {
    ...
    @NotNull
    private static final Lazy[] $childSerializers = {l.b(o.f49210e, new Function0() { // from class: com.discord.user_search_worker.d
    ...
    public static final /* synthetic */ KSerializer _childSerializers$_anonymous_() {
        return new kt.f(UserSearchTransformedUser.Serializer.INSTANCE);
    }
