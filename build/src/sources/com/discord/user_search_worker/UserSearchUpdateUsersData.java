...
public final class UserSearchUpdateUsersData extends UserSearchData {
    ...
    @NotNull
    private static final Lazy[] $childSerializers = {l.a(o.f6082e, new Function0() { // from class: com.discord.user_search_worker.d
    ...
    public static final /* synthetic */ KSerializer _childSerializers$_anonymous_() {
        return new tt.f(UserSearchTransformedUser.Serializer.INSTANCE);
    }
