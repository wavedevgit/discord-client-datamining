...
final class MediaPlayerManagerModule$subscribeToPlaybackEvents$1 extends k implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        if (i10 != 0) {
            ...
            kotlin.c.b(obj);
            Flow l10 = bt.g.l(bt.g.z(MediaPlayerManager.INSTANCE.getPlaybackRateFlow$media_player_release(), new AnonymousClass1(null)));
            AnonymousClass2 anonymousClass2 = new AnonymousClass2(this.this$0, null);
            this.label = 1;
            if (bt.g.i(l10, anonymousClass2, this) == f10) {
                return f10;
            }
        }
        return Unit.f31988a;
