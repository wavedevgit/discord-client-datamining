...
public final class CacheDataSourceFactory implements DataSource.Factory {
    ...
    public static final class Companion {
        ...
        private final SimpleCache getSimpleCache(Context context) {
            return new SimpleCache(new File(context.getCacheDir(), CacheDataSourceFactory.CACHE_DIR_NAME), new ne.h(CacheDataSourceFactory.CACHE_MAX_SIZE), new qc.c(context));
        }
