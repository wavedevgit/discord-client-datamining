...
public final class MediaPlayerPlaybackRateChanged implements ReactEvent {
    ...
    public static final /* synthetic */ void write$Self$media_player_release(MediaPlayerPlaybackRateChanged mediaPlayerPlaybackRateChanged, CompositeEncoder compositeEncoder, SerialDescriptor serialDescriptor) {
        compositeEncoder.A(serialDescriptor, 0, MediaPlayerPlaybackSource$$serializer.INSTANCE, mediaPlayerPlaybackRateChanged.source);
    ...
    public WritableMap serialize() {
        ...
        if (this.source != null) {
            nativeMapOf.putMap("source", NativeMapExtensionsKt.toNativeMap(a.f37198b.e(w.b(MediaPlayerPlaybackSource.class), this.source)));
        }
        return nativeMapOf;
    }
