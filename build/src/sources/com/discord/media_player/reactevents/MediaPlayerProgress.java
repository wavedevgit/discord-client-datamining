...
public final class MediaPlayerProgress implements ReactEvent {
    ...
    public static /* synthetic */ MediaPlayerProgress copy$default(MediaPlayerProgress mediaPlayerProgress, double d10, double d11, double d12, int i10, Object obj) {
        if ((i10 & 1) != 0) {
            d10 = mediaPlayerProgress.f10215id;
        }
        double d13 = d10;
        if ((i10 & 2) != 0) {
    ...
    public static final /* synthetic */ void write$Self$media_player_release(MediaPlayerProgress mediaPlayerProgress, CompositeEncoder compositeEncoder, SerialDescriptor serialDescriptor) {
        compositeEncoder.D(serialDescriptor, 0, mediaPlayerProgress.f10215id);
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof MediaPlayerProgress) {
            ...
            return Double.compare(this.f10215id, mediaPlayerProgress.f10215id) == 0 && Double.compare(this.time, mediaPlayerProgress.time) == 0 && Double.compare(this.duration, mediaPlayerProgress.duration) == 0;
        }
        return false;
    }
    ...
    public int hashCode() {
        return (((Double.hashCode(this.f10215id) * 31) + Double.hashCode(this.time)) * 31) + Double.hashCode(this.duration);
    }
