...
public final class MediaPlayerPlaybackSource {
    ...
    public static final class Companion {
        ...
        public final String createId(@NotNull MediaSource mediaSource) {
            ...
            if (m951getMessageIdN_6c4I0 == null) {
                ...
                m1092toStringimpl = MessageId.m1092toStringimpl(m951getMessageIdN_6c4I0);
            }
            ...
            return m1092toStringimpl + "." + index + ":" + i10;
        }
    ...
    public static /* synthetic */ MediaPlayerPlaybackSource m952copyElQ7df0$default(MediaPlayerPlaybackSource mediaPlayerPlaybackSource, String str, String str2, String str3, String str4, Integer num, int i10, Object obj) {
        if ((i10 & 1) != 0) {
            str = mediaPlayerPlaybackSource.f9567id;
        }
        if ((i10 & 2) != 0) {
    ...
    public static final /* synthetic */ void write$Self$media_player_release(MediaPlayerPlaybackSource mediaPlayerPlaybackSource, CompositeEncoder compositeEncoder, SerialDescriptor serialDescriptor) {
        MessageId messageId;
        n2 n2Var = n2.f25302a;
        compositeEncoder.A(serialDescriptor, 0, n2Var, mediaPlayerPlaybackSource.f9567id);
        compositeEncoder.A(serialDescriptor, 1, n2Var, mediaPlayerPlaybackSource.assetUrl);
        compositeEncoder.A(serialDescriptor, 2, n2Var, mediaPlayerPlaybackSource.channelId);
        ...
        compositeEncoder.A(serialDescriptor, 3, messageId$$serializer, messageId);
        compositeEncoder.A(serialDescriptor, 4, p0.f25318a, mediaPlayerPlaybackSource.attachmentIndex);
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof MediaPlayerPlaybackSource) {
            ...
            if (Intrinsics.areEqual(this.f9567id, mediaPlayerPlaybackSource.f9567id) && Intrinsics.areEqual(this.assetUrl, mediaPlayerPlaybackSource.assetUrl) && Intrinsics.areEqual(this.channelId, mediaPlayerPlaybackSource.channelId)) {
                ...
                return m1089equalsimpl0 && Intrinsics.areEqual(this.attachmentIndex, mediaPlayerPlaybackSource.attachmentIndex);
            }
            return false;
        }
        return false;
    ...
    public int hashCode() {
        ...
        int m1090hashCodeimpl = (hashCode3 + (str4 == null ? 0 : MessageId.m1090hashCodeimpl(str4))) * 31;
        Integer num = this.attachmentIndex;
        return m1090hashCodeimpl + (num != null ? num.hashCode() : 0);
    }
    ...
    public String toString() {
        ...
        Integer num = this.attachmentIndex;
        return "MediaPlayerPlaybackSource(id=" + str + ", assetUrl=" + str2 + ", channelId=" + str3 + ", messageId=" + m1092toStringimpl + ", attachmentIndex=" + num + ")";
    }
