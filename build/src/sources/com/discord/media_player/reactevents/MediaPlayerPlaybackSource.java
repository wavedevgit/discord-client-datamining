...
public final class MediaPlayerPlaybackSource {
    ...
    public static /* synthetic */ MediaPlayerPlaybackSource m950copyElQ7df0$default(MediaPlayerPlaybackSource mediaPlayerPlaybackSource, String str, String str2, String str3, String str4, Integer num, int i10, Object obj) {
        if ((i10 & 1) != 0) {
            str = mediaPlayerPlaybackSource.f9606id;
        }
        if ((i10 & 2) != 0) {
    ...
    public static final /* synthetic */ void write$Self$media_player_release(MediaPlayerPlaybackSource mediaPlayerPlaybackSource, CompositeEncoder compositeEncoder, SerialDescriptor serialDescriptor) {
        MessageId messageId;
        n2 n2Var = n2.f35181a;
        compositeEncoder.i(serialDescriptor, 0, n2Var, mediaPlayerPlaybackSource.f9606id);
        compositeEncoder.i(serialDescriptor, 1, n2Var, mediaPlayerPlaybackSource.assetUrl);
        compositeEncoder.i(serialDescriptor, 2, n2Var, mediaPlayerPlaybackSource.channelId);
        ...
        compositeEncoder.i(serialDescriptor, 4, p0.f35197a, mediaPlayerPlaybackSource.attachmentIndex);
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof MediaPlayerPlaybackSource) {
            ...
            if (Intrinsics.areEqual(this.f9606id, mediaPlayerPlaybackSource.f9606id) && Intrinsics.areEqual(this.assetUrl, mediaPlayerPlaybackSource.assetUrl) && Intrinsics.areEqual(this.channelId, mediaPlayerPlaybackSource.channelId)) {
