...
public final class MediaPlayerPause implements ReactEvent {
    ...
    public static final /* synthetic */ void write$Self$media_player_release(MediaPlayerPause mediaPlayerPause, CompositeEncoder compositeEncoder, SerialDescriptor serialDescriptor) {
        compositeEncoder.D(serialDescriptor, 0, mediaPlayerPause.f9465id);
        compositeEncoder.y(serialDescriptor, 1, mediaPlayerPause.paused);
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof MediaPlayerPause) {
            ...
            return Double.compare(this.f9465id, mediaPlayerPause.f9465id) == 0 && this.paused == mediaPlayerPause.paused;
        }
        return false;
    }
    ...
    public int hashCode() {
        return (Double.hashCode(this.f9465id) * 31) + Boolean.hashCode(this.paused);
    }
