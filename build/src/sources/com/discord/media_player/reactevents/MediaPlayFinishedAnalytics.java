...
public final class MediaPlayFinishedAnalytics implements ReactEvent {
    ...
    public static final /* synthetic */ void write$Self$media_player_release(MediaPlayFinishedAnalytics mediaPlayFinishedAnalytics, CompositeEncoder compositeEncoder, SerialDescriptor serialDescriptor) {
        compositeEncoder.D(serialDescriptor, 0, mediaPlayFinishedAnalytics.playWallTimeMs);
        compositeEncoder.D(serialDescriptor, 1, mediaPlayFinishedAnalytics.stallMs);
        ...
        compositeEncoder.D(serialDescriptor, 4, mediaPlayFinishedAnalytics.firstPlayWaitingMs);
        n2 n2Var = n2.f35181a;
        compositeEncoder.i(serialDescriptor, 5, n2Var, mediaPlayFinishedAnalytics.mediaSource);
        compositeEncoder.s(serialDescriptor, 6, mediaPlayFinishedAnalytics.fileDurationSec);
        compositeEncoder.i(serialDescriptor, 7, n2Var, mediaPlayFinishedAnalytics.mimeType);
        ...
        compositeEncoder.D(serialDescriptor, 10, mediaPlayFinishedAnalytics.totalDroppedFrames);
        compositeEncoder.D(serialDescriptor, 11, mediaPlayFinishedAnalytics.totalBandwidthBytes);
    }
