...
public final class MediaPlayerPlaybackProgressUpdated implements ReactEvent {
    ...
    public static final /* synthetic */ void write$Self$media_player_release(MediaPlayerPlaybackProgressUpdated mediaPlayerPlaybackProgressUpdated, CompositeEncoder compositeEncoder, SerialDescriptor serialDescriptor) {
        compositeEncoder.i(serialDescriptor, 0, MediaPlayerPlaybackSource$$serializer.INSTANCE, mediaPlayerPlaybackProgressUpdated.source);
        compositeEncoder.D(serialDescriptor, 1, mediaPlayerPlaybackProgressUpdated.time);
        compositeEncoder.D(serialDescriptor, 2, mediaPlayerPlaybackProgressUpdated.duration);
    }
