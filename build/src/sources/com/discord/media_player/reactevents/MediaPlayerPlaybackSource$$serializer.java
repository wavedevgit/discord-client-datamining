...
import tt.n2;
import tt.p0;
@Metadata(d1 = {"\u0000:\n\u0000\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0002\b\u0002\n\u0002\u0010\u0002\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0002\b\u0003\n\u0002\u0010\u0011\n\u0002\u0018\u0002\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0002\b\u0005\bÇ\u0002\u0018\u00002\b\u0012\u0004\u0012\u00020\u00020\u0001B\t\b\u0002¢\u0006\u0004\b\u0003\u0010\u0004J\u001d\u0010\t\u001a\u00020\b2\u0006\u0010\u0006\u001a\u00020\u00052\u0006\u0010\u0007\u001a\u00020\u0002¢\u0006\u0004\b\t\u0010\nJ\u0015\u0010\r\u001a\u00020\u00022\u0006\u0010\f\u001a\u00020\u000b¢\u0006\u0004\b\r\u0010\u000eJ\u0017\u0010\u0011\u001a\f\u0012\b\u0012\u0006\u0012\u0002\b\u00030\u00100\u000f¢\u0006\u0004\b\u0011\u0010\u0012R\u0017\u0010\u0014\u001a\u00020\u00138\u0006¢\u0006\f\n\u0004\b\u0014\u0010\u0015\u001a\u0004\b\u0016\u0010\u0017¨\u0006\u0018"}, d2 = {"com/discord/media_player/reactevents/MediaPlayerPlaybackSource.$serializer", "Ltt/h0;", "Lcom/discord/media_player/reactevents/MediaPlayerPlaybackSource;", "<init>", "()V", "Lkotlinx/serialization/encoding/Encoder;", "encoder", "value", "", "serialize", "(Lkotlinx/serialization/encoding/Encoder;Lcom/discord/media_player/reactevents/MediaPlayerPlaybackSource;)V", "Lkotlinx/serialization/encoding/Decoder;", "decoder", "deserialize", "(Lkotlinx/serialization/encoding/Decoder;)Lcom/discord/media_player/reactevents/MediaPlayerPlaybackSource;", "", "Lkotlinx/serialization/KSerializer;", "childSerializers", "()[Lkotlinx/serialization/KSerializer;", "Lkotlinx/serialization/descriptors/SerialDescriptor;", "descriptor", "Lkotlinx/serialization/descriptors/SerialDescriptor;", "getDescriptor", "()Lkotlinx/serialization/descriptors/SerialDescriptor;", "media_player_release"}, k = 1, mv = {2, 1, 0}, xi = 48)
@c
...
public /* synthetic */ class MediaPlayerPlaybackSource$$serializer implements h0 {
    ...
    public final KSerializer[] childSerializers() {
        n2 n2Var = n2.f50601a;
        return new KSerializer[]{a.u(n2Var), a.u(n2Var), a.u(n2Var), a.u(MessageId$$serializer.INSTANCE), a.u(p0.f50617a)};
    }
    ...
    public final MediaPlayerPlaybackSource deserialize(@NotNull Decoder decoder) {
        ...
        if (b10.p()) {
            ...
            num = (Integer) b10.n(serialDescriptor, 4, p0.f50617a, null);
            i10 = 31;
            str3 = str6;
            str4 = str5;
        } else {
            ...
            while (z10) {
                ...
                if (o10 == -1) {
                    ...
                    str9 = (String) b10.n(serialDescriptor, 0, n2.f50601a, str9);
                    i11 |= 1;
                } else if (o10 == 1) {
                    str8 = (String) b10.n(serialDescriptor, 1, n2.f50601a, str8);
                    i11 |= 2;
                } else if (o10 == 2) {
                    str = (String) b10.n(serialDescriptor, 2, n2.f50601a, str);
                    i11 |= 4;
                } else if (o10 == 3) {
                    ...
                    str7 = messageId2 != null ? messageId2.m1093unboximpl() : null;
                    i11 |= 8;
                } else if (o10 != 4) {
                    throw new b0(o10);
                } else {
                    num2 = (Integer) b10.n(serialDescriptor, 4, p0.f50617a, num2);
                    i11 |= 16;
                }
            }
            str2 = str7;
