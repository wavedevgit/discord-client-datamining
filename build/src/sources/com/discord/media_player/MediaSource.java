...
public final class MediaSource {
    ...
    public static /* synthetic */ MediaSource m945copyM_16ML8$default(MediaSource mediaSource, String str, String str2, String str3, Integer num, String str4, MediaType mediaType, boolean z10, ChannelId channelId, String str5, Integer num2, Double d10, Boolean bool, int i10, Object obj) {
        if ((i10 & 1) != 0) {
        ...
        return mediaSource.m948copyM_16ML8(str, str2, str3, num, str7, mediaType2, z11, channelId2, str6, num3, d11, bool2);
    }
    ...
    public final ChannelId m946component8qMVnFVQ() {
        return this.channelId;
    }

    /* renamed from: component9-N_6c4I0  reason: not valid java name */
    public final String m947component9N_6c4I0() {
        return this.messageId;
    }

    @NotNull
    /* renamed from: copy-M_16ML8  reason: not valid java name */
    public final MediaSource m948copyM_16ML8(String str, String str2, String str3, Integer num, @NotNull String featureTag, @NotNull MediaType type, boolean z10, ChannelId channelId, String str4, Integer num2, Double d10, Boolean bool) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof MediaSource) {
            ...
            if (Intrinsics.areEqual(this.sourceUrl, mediaSource.sourceUrl) && Intrinsics.areEqual(this.previewUrl, mediaSource.previewUrl) && Intrinsics.areEqual(this.placeholder, mediaSource.placeholder) && Intrinsics.areEqual(this.placeholderVersion, mediaSource.placeholderVersion) && Intrinsics.areEqual(this.featureTag, mediaSource.featureTag) && this.type == mediaSource.type && this.shouldAutoPlay == mediaSource.shouldAutoPlay && Intrinsics.areEqual(this.channelId, mediaSource.channelId)) {
                ...
                return m1088equalsimpl0 && Intrinsics.areEqual(this.index, mediaSource.index) && Intrinsics.areEqual((Object) this.portal, (Object) mediaSource.portal) && Intrinsics.areEqual(this.srcIsAnimated, mediaSource.srcIsAnimated);
            }
            return false;
        }
        return false;
    ...
    public final ChannelId m949getChannelIdqMVnFVQ() {
        return this.channelId;
    }
    ...
    public final String m950getMessageIdN_6c4I0() {
        return this.messageId;
    }
    ...
    public int hashCode() {
        ...
        int m1063hashCodeimpl = (hashCode4 + (channelId == null ? 0 : ChannelId.m1063hashCodeimpl(channelId.m1067unboximpl()))) * 31;
        String str4 = this.messageId;
        int m1089hashCodeimpl = (m1063hashCodeimpl + (str4 == null ? 0 : MessageId.m1089hashCodeimpl(str4))) * 31;
        Integer num2 = this.index;
        int hashCode5 = (m1089hashCodeimpl + (num2 == null ? 0 : num2.hashCode())) * 31;
    ...
    public String toString() {
        ...
        String m1091toStringimpl = str5 == null ? "null" : MessageId.m1091toStringimpl(str5);
        Integer num2 = this.index;
        Double d10 = this.portal;
        Boolean bool = this.srcIsAnimated;
        return "MediaSource(sourceUrl=" + str + ", previewUrl=" + str2 + ", placeholder=" + str3 + ", placeholderVersion=" + num + ", featureTag=" + str4 + ", type=" + mediaType + ", shouldAutoPlay=" + z10 + ", channelId=" + channelId + ", messageId=" + m1091toStringimpl + ", index=" + num2 + ", portal=" + d10 + ", srcIsAnimated=" + bool + ")";
    }
