...
public final class MediaPlayerManagerModule$onMediaPlayerViewWillAppear$1 extends k implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        if (this.label == 0) {
            ...
            reactEvents.emitModuleEvent(reactApplicationContext, new MediaPlayerViewWillAppear(m1065toStringimpl, arrayList));
            return Unit.f33282a;
        }
    ...
    public final Object invoke(CoroutineScope coroutineScope, Continuation<? super Unit> continuation) {
        return ((MediaPlayerManagerModule$onMediaPlayerViewWillAppear$1) create(coroutineScope, continuation)).invokeSuspend(Unit.f33282a);
    }
}
