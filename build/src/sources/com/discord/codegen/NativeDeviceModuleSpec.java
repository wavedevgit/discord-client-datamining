...
public abstract class NativeDeviceModuleSpec extends ReactContextBaseJavaModule implements TurboModule {
    ...
    public final Map<String, Object> getConstants() {
        ...
        if (ReactBuildConfig.DEBUG || ReactBuildConfig.IS_INTERNAL_BUILD) {
            HashSet hashSet = new HashSet(Arrays.asList("device", "deviceBrand", "deviceManufacturer", "deviceModel", "deviceProduct", "isGestureNavigationEnabled", "maxCpuFreq", "ramSize", "smallestScreenWidth", "socName", "systemVersion", "timeZone"));
