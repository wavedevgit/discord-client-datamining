...
public final class DiscordGestureHandlerPackage extends BaseReactPackage {
    ...
    public List<ViewManager<?, LayoutShadowNode>> createViewManagers(@NotNull ReactApplicationContext reactContext) {
        ...
        return CollectionsKt.o(new BlockingGestureViewManager(), new PassthroughTouchViewManager(), new DiscordGestureHandlerRootViewManager());
    }

    /* renamed from: getModule  reason: collision with other method in class */
    public Void m1149getModule(@NotNull String name, @NotNull ReactApplicationContext reactContext) {
    ...
    public /* bridge */ /* synthetic */ NativeModule getModule(String str, ReactApplicationContext reactApplicationContext) {
        return (NativeModule) m1149getModule(str, reactApplicationContext);
    }
}
