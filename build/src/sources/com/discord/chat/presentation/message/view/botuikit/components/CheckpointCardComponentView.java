...
public final class CheckpointCardComponentView extends ConstraintLayout implements ComponentView<CheckpointCardComponent> {
    ...
    private final void configureApplication(CheckpointApplication checkpointApplication) {
        ...
        if (checkpointApplication != null) {
            applicationId = ApplicationId.m1044boximpl(checkpointApplication.m256getApplicationIdVavddsQ());
        } else {
            applicationId = null;
        }
        if (applicationId != null && checkpointApplication.getApplicationImageId() != null) {
            str = IconUrlUtils.m911getApplicationIconweIltyw$default(IconUrlUtils.INSTANCE, ApplicationId.m1044boximpl(checkpointApplication.m256getApplicationIdVavddsQ()), checkpointApplication.getApplicationImageId(), 0, 4, null);
        }
        if (str != null) {
            z10 = true;
        } else {
    ...
    private final void configureGuild(CheckpointGuild checkpointGuild) {
        ...
        if (checkpointGuild != null) {
            guildId = GuildId.m1070boximpl(checkpointGuild.m264getGuildIdfYKD8eg());
        } else {
            guildId = null;
        }
        if (guildId != null && checkpointGuild.getGuildIcon() != null) {
            str = IconUrlUtils.m913getForGuild14CJxO4$default(IconUrlUtils.INSTANCE, GuildId.m1070boximpl(checkpointGuild.m264getGuildIdfYKD8eg()), checkpointGuild.getGuildIcon(), null, false, null, 28, null);
        } else {
            str = null;
        }
        if (str != null) {
        ...
        if (z10) {
            ...
            if (checkpointGuild != null) {
                guildId2 = GuildId.m1070boximpl(checkpointGuild.m264getGuildIdfYKD8eg());
            }
            if (guildId2 != null) {
    ...
    public CheckpointCardComponentView(@NotNull final Context context, AttributeSet attributeSet, int i10) {
        ...
        this.binding$delegate = rr.l.b(o.f49211i, new Function0() { // from class: com.discord.chat.presentation.message.view.botuikit.components.d
