...
public final class ForwardBreadcrumbView extends ConstraintLayout {
    ...
    public static final void configure_JjTCmh4$lambda$0(Function3 function3, ForwardInfo forwardInfo, long j10, String str, View view) {
        function3.invoke(Integer.valueOf(forwardInfo.getSnapshotIndex()), ChannelId.m1057boximpl(j10), MessageId.m1083boximpl(str));
    }

    /* renamed from: configure-JjTCmh4  reason: not valid java name */
    public final void m694configureJjTCmh4(final long j10, @NotNull final String messageId, @NotNull final ForwardInfo info, @NotNull final Function3 onTapForwardFooter) {
