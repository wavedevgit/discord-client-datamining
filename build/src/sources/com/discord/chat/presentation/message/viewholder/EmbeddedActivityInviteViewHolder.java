...
public final class EmbeddedActivityInviteViewHolder extends MessagePartViewHolder {
    ...
    public static final void bind$lambda$2$lambda$1(EmbeddedActivityInviteViewHolder embeddedActivityInviteViewHolder, EmbeddedActivityInviteMessageAccessory embeddedActivityInviteMessageAccessory, View view) {
        embeddedActivityInviteViewHolder.eventHandler.mo463onTapInviteEmbedAFFcxXc(embeddedActivityInviteMessageAccessory.mo537getMessageId3Eiw7ao(), embeddedActivityInviteMessageAccessory.getCodedLinkIndex(), null, null);
    }
    ...
    public final void bind(@NotNull final EmbeddedActivityInviteMessageAccessory embeddedActivityInviteAccessory) {
        ...
        embeddedActivityInviteView.m690setSubtitleText2dg2Uz0(embeddedActivityInviteAccessory.getMargins(), embeddedActivityInviteEmbed.getStructurableSubtitleText(), embeddedActivityInviteAccessory.mo537getMessageId3Eiw7ao(), new EmbeddedActivityInviteViewHolder$bind$1$1(this.eventHandler), new EmbeddedActivityInviteViewHolder$bind$1$2(this.eventHandler), new EmbeddedActivityInviteViewHolder$bind$1$3(this.eventHandler), new EmbeddedActivityInviteViewHolder$bind$1$4(this.eventHandler), new EmbeddedActivityInviteViewHolder$bind$1$5(this.eventHandler), new EmbeddedActivityInviteViewHolder$bind$1$6(this.eventHandler), new EmbeddedActivityInviteViewHolder$bind$1$7(this.eventHandler), new EmbeddedActivityInviteViewHolder$bind$1$8(this.eventHandler), new EmbeddedActivityInviteViewHolder$bind$1$9(this.eventHandler), new Function0() { // from class: com.discord.chat.presentation.message.viewholder.j
