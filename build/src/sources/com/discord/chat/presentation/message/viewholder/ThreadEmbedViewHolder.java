...
public final class ThreadEmbedViewHolder extends MessagePartViewHolder {
    ...
    public static final void bind$lambda$2$lambda$0(Function1 function1, ThreadEmbedMessageAccessory threadEmbedMessageAccessory, View view) {
        function1.invoke(MessageId.m1084boximpl(threadEmbedMessageAccessory.mo537getMessageId3Eiw7ao()));
    }
    ...
    public final void bind(@NotNull final ThreadEmbedMessageAccessory threadItem, @NotNull final Function1<? super MessageId, Unit> onTapThreadEmbed) {
        ...
        if (message == null) {
            ...
            draweeSpanStringBuilder = TextUtilsKt.toSpannable$default(content, context, m238getId3Eiw7ao, shouldAnimateEmoji, shouldShowLinkDecorations, shouldShowRoleDot, shouldShowRoleOnName, paint, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, true, null, baselineHeightPx, null, false, 113246080, null);
        } else {
        ...
        if (message != null) {
            guildId = message.m236getClanTagGuildIdqOKuAAo();
        }
        threadEmbedView.m708setMessageCKTq3AQ(str, str2, num, draweeSpanStringBuilder, z10, str3, str4, guildId);
        if (message != null) {
