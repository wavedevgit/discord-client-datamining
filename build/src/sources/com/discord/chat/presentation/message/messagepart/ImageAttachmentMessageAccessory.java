...
public final class ImageAttachmentMessageAccessory extends MessageAttachmentAccessory {
    ...
    public static /* synthetic */ ImageAttachmentMessageAccessory m605copyNsYpSCE$default(ImageAttachmentMessageAccessory imageAttachmentMessageAccessory, String str, Attachment attachment, int i10, Float f10, int i11, int i12, SpoilerAttributes spoilerAttributes, boolean z10, int i13, Object obj) {
        if ((i13 & 1) != 0) {
        ...
        int i14 = i11;
        int i15 = i12;
        return imageAttachmentMessageAccessory.m607copyNsYpSCE(str, attachment, i10, f10, i14, i15, spoilerAttributes2, z11);
    }

    @NotNull
    /* renamed from: component1-3Eiw7ao  reason: not valid java name */
    public final String m606component13Eiw7ao() {
    ...
    public final ImageAttachmentMessageAccessory m607copyNsYpSCE(@NotNull String messageId, @NotNull Attachment attachment, int i10, Float f10, int i11, int i12, SpoilerAttributes spoilerAttributes, boolean z10) {
