...
public final class MessageComponentsAccessory extends MessageAccessory {
    ...
    public static /* synthetic */ MessageComponentsAccessory m621copypPZZVto$default(MessageComponentsAccessory messageComponentsAccessory, String str, MessageMargins messageMargins, Message message, List list, int i10, int i11, Object obj) {
        if ((i11 & 1) != 0) {
        ...
        return messageComponentsAccessory.m623copypPZZVto(str, messageMargins, message2, list2, i12);
    }

    @NotNull
    /* renamed from: component1-3Eiw7ao  reason: not valid java name */
    public final String m622component13Eiw7ao() {
    ...
    public final MessageComponentsAccessory m623copypPZZVto(@NotNull String messageId, @NotNull MessageMargins margins, @NotNull Message message, @NotNull List<? extends Component> messageComponents, int i10) {
