...
public final class CtaButtonViewHolder extends MessagePartViewHolder {
    ...
    public final void m719bindJjTCmh4(long j10, @NotNull String messageId, @NotNull CtaButton accessory, @NotNull Function3 onTapCtaButton) {
        Intrinsics.checkNotNullParameter(messageId, "messageId");
        Intrinsics.checkNotNullParameter(accessory, "accessory");
        Intrinsics.checkNotNullParameter(onTapCtaButton, "onTapCtaButton");
        this.ctaButtonView.m687setContentP6jPPyA(j10, messageId, accessory.getText(), accessory.getTextColor(), accessory.getBackgroundColor(), accessory.getCallback(), onTapCtaButton);
    }
}
