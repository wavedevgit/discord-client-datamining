        ...
        if (i13 != 1) {
            if (i13 != 2) {
                if (i13 == 3) {
                    ...
                    ((GenericDraweeHierarchy) this.binding.imageInvalid.getHierarchy()).t(ScalingUtils$ScaleType.f11037e);
            ...
            this.binding.imageInvalid.setVisibility(0);
            ((GenericDraweeHierarchy) this.binding.imageInvalid.getHierarchy()).t(ScalingUtils$ScaleType.f11039g);
