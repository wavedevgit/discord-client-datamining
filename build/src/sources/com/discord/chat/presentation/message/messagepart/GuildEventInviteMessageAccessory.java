...
public final class GuildEventInviteMessageAccessory extends MessageAccessory {
    ...
    public String toString() {
        ...
        return "GuildEventInviteMessageAccessory(messageId=" + m1090toStringimpl + ", margins=" + messageMargins + ", codedLinkIndex=" + i10 + ", invite=" + guildEventInviteEmbedImpl + ", shouldAnimateEmoji=" + z10 + ", shouldShowLinkDecorations=" + z11 + ", shouldShowRoleDot=" + z12 + ", shouldShowRoleOnName=" + z13 + ")";
    }
