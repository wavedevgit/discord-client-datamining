...
public final class FlaggedMessageEmbedAccessory extends MessageAccessory {
    ...
    public static /* synthetic */ FlaggedMessageEmbedAccessory m576copyAFFcxXc$default(FlaggedMessageEmbedAccessory flaggedMessageEmbedAccessory, String str, MessageMargins messageMargins, Message message, MessageContext messageContext, int i10, Object obj) {
        if ((i10 & 1) != 0) {
        ...
        return flaggedMessageEmbedAccessory.m578copyAFFcxXc(str, messageMargins, message, messageContext);
    }

    @NotNull
    /* renamed from: component1-3Eiw7ao  reason: not valid java name */
    public final String m577component13Eiw7ao() {
    ...
    public final FlaggedMessageEmbedAccessory m578copyAFFcxXc(@NotNull String messageId, @NotNull MessageMargins margins, @NotNull Message message, @NotNull MessageContext messageContext) {
