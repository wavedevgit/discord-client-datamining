...
public final class ClanTagChipletView extends FrameLayout {
    ...
    public static /* synthetic */ void m502configureD0ylKIU$default(ClanTagChipletView clanTagChipletView, String str, String str2, long j10, ChatEventHandler chatEventHandler, float f10, int i10, Object obj) {
        if ((i10 & 16) != 0) {
            f10 = 1.0f;
        }
        clanTagChipletView.m503configureD0ylKIU(str, str2, j10, chatEventHandler, f10);
    }

    /* renamed from: configure-D0ylKIU  reason: not valid java name */
    public final void m503configureD0ylKIU(@NotNull String tagContent, String str, final long j10, final ChatEventHandler chatEventHandler, float f10) {
        ...
        if (chatEventHandler != null) {
            ...
            NestedScrollOnTouchUtilsKt.setOnClickListenerNested$default(linearLayout, false, new View.OnClickListener() { // from class: com.discord.chat.presentation.message.a
                ...
                public final void onClick(View view) {
                    ChatEventHandler.this.mo454onTapClanTagChipletg3bFfsM(j10);
                }
            }, 1, null);
        }
    }
