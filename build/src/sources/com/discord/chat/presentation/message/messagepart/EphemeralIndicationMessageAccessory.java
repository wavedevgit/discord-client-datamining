...
public final class EphemeralIndicationMessageAccessory extends MessageAccessory {
    ...
    public static /* synthetic */ EphemeralIndicationMessageAccessory m567copyntcYbpo$default(EphemeralIndicationMessageAccessory ephemeralIndicationMessageAccessory, String str, EphemeralIndication ephemeralIndication, int i10, Object obj) {
        if ((i10 & 1) != 0) {
        ...
        return ephemeralIndicationMessageAccessory.m569copyntcYbpo(str, ephemeralIndication);
    }

    @NotNull
    /* renamed from: component1-3Eiw7ao  reason: not valid java name */
    public final String m568component13Eiw7ao() {
    ...
    public final EphemeralIndicationMessageAccessory m569copyntcYbpo(@NotNull String messageId, @NotNull EphemeralIndication ephemeralIndication) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof EphemeralIndicationMessageAccessory) {
            ...
            return MessageId.m1088equalsimpl0(this.messageId, ephemeralIndicationMessageAccessory.messageId) && Intrinsics.areEqual(this.ephemeralIndication, ephemeralIndicationMessageAccessory.ephemeralIndication);
        }
        return false;
    }
    ...
    public int hashCode() {
        return (MessageId.m1089hashCodeimpl(this.messageId) * 31) + this.ephemeralIndication.hashCode();
    }
    ...
    public String toString() {
        ...
        return "EphemeralIndicationMessageAccessory(messageId=" + m1091toStringimpl + ", ephemeralIndication=" + ephemeralIndication + ")";
    }
