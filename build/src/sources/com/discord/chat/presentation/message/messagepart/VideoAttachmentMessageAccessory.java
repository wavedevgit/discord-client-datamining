...
public final class VideoAttachmentMessageAccessory extends MessageAttachmentAccessory implements PortalUiModel {
    ...
    public static /* synthetic */ VideoAttachmentMessageAccessory m670copyz64KZZs$default(VideoAttachmentMessageAccessory videoAttachmentMessageAccessory, long j10, String str, int i10, Attachment attachment, Float f10, int i11, int i12, SpoilerAttributes spoilerAttributes, boolean z10, boolean z11, int i13, Object obj) {
        if ((i13 & 1) != 0) {
    ...
    public final String m672component23Eiw7ao() {
    ...
    public final VideoAttachmentMessageAccessory m673copyz64KZZs(long j10, @NotNull String messageId, int i10, @NotNull Attachment attachment, Float f10, int i11, int i12, SpoilerAttributes spoilerAttributes, boolean z10, boolean z11) {
    ...
    public final long m674getChannelIdo4g7jtM() {
        return this.channelId;
    }
