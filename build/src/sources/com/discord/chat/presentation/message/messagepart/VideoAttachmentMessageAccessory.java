...
public final class VideoAttachmentMessageAccessory extends MessageAttachmentAccessory implements PortalUiModel {
    ...
    public int hashCode() {
        int m1062hashCodeimpl = ((((((ChannelId.m1062hashCodeimpl(this.channelId) * 31) + MessageId.m1088hashCodeimpl(this.messageId)) * 31) + Integer.hashCode(this.index)) * 31) + this.attachment.hashCode()) * 31;
        Float f10 = this.attachmentsOpacity;
        int hashCode = (((((m1062hashCodeimpl + (f10 == null ? 0 : f10.hashCode())) * 31) + Integer.hashCode(this.constrainedWidth)) * 31) + Integer.hashCode(this.radiusPx)) * 31;
    ...
    public String toString() {
        ...
        return "VideoAttachmentMessageAccessory(channelId=" + m1064toStringimpl + ", messageId=" + m1090toStringimpl + ", index=" + i10 + ", attachment=" + attachment + ", attachmentsOpacity=" + f10 + ", constrainedWidth=" + i11 + ", radiusPx=" + i12 + ", spoilerAttributes=" + spoilerAttributes + ", useNewAltTextButton=" + z10 + ", hideMediaPlayButton=" + z11 + ")";
    }
