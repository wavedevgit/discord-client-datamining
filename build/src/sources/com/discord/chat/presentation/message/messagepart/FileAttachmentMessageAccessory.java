...
public final class FileAttachmentMessageAccessory extends MessageAttachmentAccessory {
    ...
    public int hashCode() {
        ...
        int hashCode = (m1088hashCodeimpl + (f10 == null ? 0 : f10.hashCode())) * 31;
    ...
    public String toString() {
        ...
        String str = this.uploaderId;
        String str2 = this.uploaderItemId;
        return "FileAttachmentMessageAccessory(messageId=" + m1090toStringimpl + ", attachment=" + attachment + ", attachmentIndex=" + i10 + ", attachmentsOpacity=" + f10 + ", spoilerAttributes=" + spoilerAttributes + ", uploaderId=" + str + ", uploaderItemId=" + str2 + ")";
    }
