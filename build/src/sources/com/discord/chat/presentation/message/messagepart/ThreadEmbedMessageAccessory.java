...
public final class ThreadEmbedMessageAccessory extends MessageAccessory {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof ThreadEmbedMessageAccessory) {
            ...
            return MessageId.m1087equalsimpl0(this.messageId, threadEmbedMessageAccessory.messageId) && Intrinsics.areEqual(this.threadEmbed, threadEmbedMessageAccessory.threadEmbed);
        }
        return false;
    }
    ...
    public int hashCode() {
        return (MessageId.m1088hashCodeimpl(this.messageId) * 31) + this.threadEmbed.hashCode();
    }
    ...
    public String toString() {
        ...
        return "ThreadEmbedMessageAccessory(messageId=" + m1090toStringimpl + ", threadEmbed=" + threadEmbed + ")";
    }
