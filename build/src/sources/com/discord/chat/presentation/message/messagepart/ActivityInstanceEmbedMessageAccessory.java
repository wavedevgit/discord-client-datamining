...
public final class ActivityInstanceEmbedMessageAccessory extends MessageAccessory {
    ...
    public static /* synthetic */ ActivityInstanceEmbedMessageAccessory m534copyAFFcxXc$default(ActivityInstanceEmbedMessageAccessory activityInstanceEmbedMessageAccessory, String str, MessageMargins messageMargins, ActivityInstanceEmbed activityInstanceEmbed, int i10, int i11, Object obj) {
        if ((i11 & 1) != 0) {
        ...
        return activityInstanceEmbedMessageAccessory.m536copyAFFcxXc(str, messageMargins, activityInstanceEmbed, i10);
    }

    @NotNull
    /* renamed from: component1-3Eiw7ao  reason: not valid java name */
    public final String m535component13Eiw7ao() {
    ...
    public final ActivityInstanceEmbedMessageAccessory m536copyAFFcxXc(@NotNull String messageId, @NotNull MessageMargins margins, @NotNull ActivityInstanceEmbed activityInstanceEmbed, int i10) {
