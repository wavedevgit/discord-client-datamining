...
public final class AudioPlayerUtilsKt {
    ...
    public static final AudioPlayerManager.AudioSource toAudioSource(@NotNull AudioAttachmentMessageAccessory audioAttachmentMessageAccessory) {
        ...
        return new AudioPlayerManager.AudioSource(ChannelId.m1058boximpl(audioAttachmentMessageAccessory.m550getChannelIdo4g7jtM()), audioAttachmentMessageAccessory.mo537getMessageId3Eiw7ao(), audioAttachmentMessageAccessory.getAttachment().getUrl(), Integer.valueOf(audioAttachmentMessageAccessory.getAttachmentIndex()), null);
    }
    ...
    public static final MediaSource toMediaSource(@NotNull AudioPlayerManager.AudioSource audioSource, String str) {
        ...
        ChannelId m715getChannelIdqMVnFVQ = audioSource.m715getChannelIdqMVnFVQ();
        String m716getMessageId3Eiw7ao = audioSource.m716getMessageId3Eiw7ao();
        ...
        return new MediaSource(url, null, null, null, str2, MediaType.AUDIO, false, m715getChannelIdqMVnFVQ, m716getMessageId3Eiw7ao, index, null, null, 3150, null);
    }
