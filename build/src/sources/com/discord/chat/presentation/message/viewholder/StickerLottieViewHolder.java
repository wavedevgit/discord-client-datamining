...
public final class StickerLottieViewHolder extends StickerPartViewHolder {
    ...
    public void bind(@NotNull final Sticker sticker, @NotNull final Function1<? super Sticker, Unit> onStickerClicked, @NotNull final Function1<? super Sticker, Unit> onStickerLongClicked, int i10, int i11) {
        ...
        stickerView.asLottie(url, i10, i11, z10, sticker.getAsset(), sticker.getRenderMode(), sticker.getAccessibilityLabel());
        NestedScrollOnTouchUtilsKt.setOnClickListenerNested$default(this.stickerView, false, new View.OnClickListener() { // from class: com.discord.chat.presentation.message.viewholder.o0
            @Override // android.view.View.OnClickListener
            public final void onClick(View view) {
                Function1.this.invoke(sticker);
            }
        }, 1, null);
        NestedScrollOnTouchUtilsKt.setOnLongClickListenerNested$default(this.stickerView, false, new View.OnLongClickListener() { // from class: com.discord.chat.presentation.message.viewholder.p0
