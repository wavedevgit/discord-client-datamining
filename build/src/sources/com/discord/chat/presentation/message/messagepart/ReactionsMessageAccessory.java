...
public final class ReactionsMessageAccessory extends MessageAccessory {
    ...
    public int hashCode() {
        int m1088hashCodeimpl = ((((((MessageId.m1088hashCodeimpl(this.messageId) * 31) + this.reactions.hashCode()) * 31) + Boolean.hashCode(this.canAddNewReactions)) * 31) + this.addNewReactionAccessibilityLabel.hashCode()) * 31;
        ReactionsTheme reactionsTheme = this.reactionsTheme;
        int hashCode = (m1088hashCodeimpl + (reactionsTheme == null ? 0 : reactionsTheme.hashCode())) * 31;
    ...
    public String toString() {
        ...
        return "ReactionsMessageAccessory(messageId=" + m1090toStringimpl + ", reactions=" + list + ", canAddNewReactions=" + z10 + ", addNewReactionAccessibilityLabel=" + str + ", reactionsTheme=" + reactionsTheme + ", theme=" + discordTheme + ", targetKind=" + str2 + ", embedIndex=" + num + ", showReactLabel=" + z11 + ", showReplyButton=" + z12 + ")";
    }
