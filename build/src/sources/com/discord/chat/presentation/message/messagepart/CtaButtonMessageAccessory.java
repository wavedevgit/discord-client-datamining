...
public final class CtaButtonMessageAccessory extends MessageAccessory {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof CtaButtonMessageAccessory) {
            ...
            return ChannelId.m1061equalsimpl0(this.channelId, ctaButtonMessageAccessory.channelId) && MessageId.m1087equalsimpl0(this.messageId, ctaButtonMessageAccessory.messageId) && Intrinsics.areEqual(this.ctaButton, ctaButtonMessageAccessory.ctaButton);
        }
        return false;
    }
    ...
    public int hashCode() {
        return (((ChannelId.m1062hashCodeimpl(this.channelId) * 31) + MessageId.m1088hashCodeimpl(this.messageId)) * 31) + this.ctaButton.hashCode();
    }
    ...
    public String toString() {
        ...
        return "CtaButtonMessageAccessory(channelId=" + m1064toStringimpl + ", messageId=" + m1090toStringimpl + ", ctaButton=" + ctaButton + ")";
    }
