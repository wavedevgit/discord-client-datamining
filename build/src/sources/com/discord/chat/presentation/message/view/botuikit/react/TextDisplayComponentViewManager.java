...
public final class TextDisplayComponentViewManager extends SimpleViewManager<TextDisplayComponentView> {
    ...
    @NotNull
    private final ReactEvents reactEvents = new ReactEvents(lr.v.a("onTapLink", Reflection.getOrCreateKotlinClass(TapLinkData.class)), lr.v.a("onLongPressLink", Reflection.getOrCreateKotlinClass(LongPressLinkData.class)), lr.v.a("onTapAttachmentLink", Reflection.getOrCreateKotlinClass(TapAttachmentLinkData.class)), lr.v.a("onLongPressAttachmentLink", Reflection.getOrCreateKotlinClass(LongPressAttachmentLinkData.class)), lr.v.a("onTapMention", Reflection.getOrCreateKotlinClass(TapMentionData.class)), lr.v.a("onTapTimestamp", Reflection.getOrCreateKotlinClass(TapTimestampEvent.class)), lr.v.a("onTapInlineCode", Reflection.getOrCreateKotlinClass(TapInlineCodeEvent.class)), lr.v.a("onTapEmoji", Reflection.getOrCreateKotlinClass(TapEmojiData.class)));
    @NotNull
