...
public final class TextDisplayComponentViewManager extends SimpleViewManager<TextDisplayComponentView> {
    ...
    @NotNull
    private final ReactEvents reactEvents = new ReactEvents(as.v.a("onTapLink", Reflection.getOrCreateKotlinClass(TapLinkData.class)), as.v.a("onLongPressLink", Reflection.getOrCreateKotlinClass(LongPressLinkData.class)), as.v.a("onTapAttachmentLink", Reflection.getOrCreateKotlinClass(TapAttachmentLinkData.class)), as.v.a("onLongPressAttachmentLink", Reflection.getOrCreateKotlinClass(LongPressAttachmentLinkData.class)), as.v.a("onTapMention", Reflection.getOrCreateKotlinClass(TapMentionData.class)), as.v.a("onTapTimestamp", Reflection.getOrCreateKotlinClass(TapTimestampEvent.class)), as.v.a("onTapInlineCode", Reflection.getOrCreateKotlinClass(TapInlineCodeEvent.class)), as.v.a("onTapEmoji", Reflection.getOrCreateKotlinClass(TapEmojiData.class)));
    @NotNull
