...
public final class GuildProfileInviteMessageAccessory extends MessageAccessory {
    ...
    public static /* synthetic */ GuildProfileInviteMessageAccessory m602copyu7_MRrM$default(GuildProfileInviteMessageAccessory guildProfileInviteMessageAccessory, String str, int i10, GuildProfileInviteEmbedImpl guildProfileInviteEmbedImpl, int i11, Object obj) {
        if ((i11 & 1) != 0) {
        ...
        return guildProfileInviteMessageAccessory.m604copyu7_MRrM(str, i10, guildProfileInviteEmbedImpl);
    }

    @NotNull
    /* renamed from: component1-3Eiw7ao  reason: not valid java name */
    public final String m603component13Eiw7ao() {
    ...
    public final GuildProfileInviteMessageAccessory m604copyu7_MRrM(@NotNull String messageId, int i10, @NotNull GuildProfileInviteEmbedImpl invite) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof GuildProfileInviteMessageAccessory) {
            ...
            return MessageId.m1088equalsimpl0(this.messageId, guildProfileInviteMessageAccessory.messageId) && this.codedLinkIndex == guildProfileInviteMessageAccessory.codedLinkIndex && Intrinsics.areEqual(this.invite, guildProfileInviteMessageAccessory.invite);
        }
        return false;
    }
    ...
    public int hashCode() {
        return (((MessageId.m1089hashCodeimpl(this.messageId) * 31) + Integer.hashCode(this.codedLinkIndex)) * 31) + this.invite.hashCode();
    }
    ...
    public String toString() {
        ...
        return "GuildProfileInviteMessageAccessory(messageId=" + m1091toStringimpl + ", codedLinkIndex=" + i10 + ", invite=" + guildProfileInviteEmbedImpl + ")";
    }
