...
public final class PostPreviewEmbedViewHolder extends MessagePartViewHolder {
    ...
    public static final void bind$lambda$0(Function4 function4, PostPreviewEmbed postPreviewEmbed, View view) {
        function4.invoke(GuildId.m1071boximpl(postPreviewEmbed.m403getGuildIdfYKD8eg()), ChannelId.m1058boximpl(postPreviewEmbed.m405getParentChannelIdo4g7jtM()), ChannelId.m1058boximpl(postPreviewEmbed.m406getThreadIdo4g7jtM()), MessageId.m1084boximpl(postPreviewEmbed.m404getMessageId3Eiw7ao()));
    }
    ...
    public final void bind(@NotNull final PostPreviewEmbed postPreviewEmbed, @NotNull final Function4 onTapPostPreviewEmbed, SpoilerConfig spoilerConfig) {
        ...
        String m404getMessageId3Eiw7ao = postPreviewEmbed.m404getMessageId3Eiw7ao();
        ...
        postPreviewEmbedView.m704setPostPreviewEmbed4itWklQ(title, subtitle, ctaText, ctaButtonColor, footer, m404getMessageId3Eiw7ao, coverImage, blurredCoverImage, coverImageOverlayText, backgroundImage, onClickListener, shouldSpoiler, z10, z11, z12, spoilerConfig);
    }
}
