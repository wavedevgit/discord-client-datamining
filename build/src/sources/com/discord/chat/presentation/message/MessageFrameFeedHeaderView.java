...
public final class MessageFrameFeedHeaderView extends ConstraintLayout {
    ...
    public static final class MessageBundleHeader {
        ...
        @NotNull
        private static final Lazy[] $childSerializers = {null, null, rr.l.b(rr.o.f49210e, new Function0() { // from class: com.discord.chat.presentation.message.r0
        ...
        public static final /* synthetic */ void write$Self$chat_release(MessageBundleHeader messageBundleHeader, CompositeEncoder compositeEncoder, SerialDescriptor serialDescriptor) {
            ...
            if (compositeEncoder.z(serialDescriptor, 0) || messageBundleHeader.channelIconURL != null) {
                compositeEncoder.i(serialDescriptor, 0, n2.f35181a, messageBundleHeader.channelIconURL);
            }
            if (compositeEncoder.z(serialDescriptor, 1) || messageBundleHeader.chatIconURL != null) {
                compositeEncoder.i(serialDescriptor, 1, n2.f35181a, messageBundleHeader.chatIconURL);
            }
            if (compositeEncoder.z(serialDescriptor, 2) || messageBundleHeader.avatarURLs != null) {
                compositeEncoder.i(serialDescriptor, 2, (gt.o) lazyArr[2].getValue(), messageBundleHeader.avatarURLs);
            }
            if (compositeEncoder.z(serialDescriptor, 3) || messageBundleHeader.channelName != null) {
                compositeEncoder.i(serialDescriptor, 3, n2.f35181a, messageBundleHeader.channelName);
            }
        }
