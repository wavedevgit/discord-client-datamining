...
public final class GiftMessageAccessory extends MessageAccessory {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof GiftMessageAccessory) {
            ...
            return MessageId.m1087equalsimpl0(this.messageId, giftMessageAccessory.messageId) && this.index == giftMessageAccessory.index && Intrinsics.areEqual(this.gift, giftMessageAccessory.gift);
        }
        return false;
    }
    ...
    public int hashCode() {
        return (((MessageId.m1088hashCodeimpl(this.messageId) * 31) + Integer.hashCode(this.index)) * 31) + this.gift.hashCode();
    }
    ...
    public String toString() {
        ...
        return "GiftMessageAccessory(messageId=" + m1090toStringimpl + ", index=" + i10 + ", gift=" + giftEmbed + ")";
    }
