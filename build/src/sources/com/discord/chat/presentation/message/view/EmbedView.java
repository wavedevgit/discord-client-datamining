...
public final class EmbedView extends FrameLayout {
    ...
    private final void m688setFieldsSAQFhFE(List<EmbedField> list, String str, boolean z10, boolean z11, boolean z12, boolean z13, final Function2<? super MessageId, ? super LinkContentNode, Unit> function2, Function1<? super LinkContentNode, Unit> function1, Function1<? super CharSequence, Unit> function12, Function0<Unit> function0, Function1<? super EmojiContentNode, Unit> function13, Function3 function3, Function4 function4) {
    ...
    public final void m689setEmbeduKkM4jM(@NotNull MessageMargins margins, @NotNull final Embed embed, long j10, @NotNull String messageId, int i10, int i11, int i12, boolean z10, boolean z11, boolean z12, boolean z13, boolean z14, @NotNull final Function3 onTitleLinkClicked, @NotNull final Function3 onAuthorLinkClicked, @NotNull final Function2<? super Double, ? super Integer, Unit> onMediaClicked, View.OnLongClickListener onLongClickListener, @NotNull final Function2<? super MessageId, ? super LinkContentNode, Unit> onLinkClicked, @NotNull Function1<? super LinkContentNode, Unit> onLongTapLinkNode, @NotNull Function1<? super CharSequence, Unit> onTapCopyText, @NotNull Function0<Unit> onTapSpoiler, @NotNull Function1<? super EmojiContentNode, Unit> onTapEmoji, @NotNull Function3 onTapChannel, @NotNull Function4 onTapMention, @NotNull Function1<? super CommandMentionContentNode, Unit> onTapCommand, SpoilerConfig spoilerConfig, double d10, final boolean z15, boolean z16, boolean z17, boolean z18) {
        ...
        if (EmbedUtilsKt.isInlineMedia(embed)) {
            final MediaSource m392toMediaSourceUBIQNlQ = EmbedUtilsKt.m392toMediaSourceUBIQNlQ(embed, j10, messageId, z10, Double.valueOf(d10));
            if (m392toMediaSourceUBIQNlQ != null) {
                Space spacer = embedView.binding.spacer;
                Intrinsics.checkNotNullExpressionValue(spacer, "spacer");
                spacer.setVisibility(8);
                if (m392toMediaSourceUBIQNlQ.getPreviewUrl() != null) {
                    ...
                    embedView.setMediaEmbed(mediaView2, embed, m392toMediaSourceUBIQNlQ, i11, MessageMargins.Companion.getWidth(margins, i10, z18));
                    embedView.binding.mediaView.setOnMediaClickListeners(new View.OnClickListener() { // from class: com.discord.chat.presentation.message.view.f0
                        ...
                        public final void onClick(View view) {
                            EmbedView.setEmbed_uKkM4jM$lambda$3$lambda$2(Function2.this, m392toMediaSourceUBIQNlQ, z15, embedView, view);
                        }
                    }, onLongClickListener);
                    z21 = false;
            ...
            embedView.m688setFieldsSAQFhFE(fields, str2, z11, z12, z13, z14, onLinkClicked, onLongTapLinkNode, onTapCopyText, onTapSpoiler, onTapEmoji, onTapChannel, onTapMention);
            ...
            List<MediaSource> m391toImageMediaSourcesSHRpUJI = EmbedUtilsKt.m391toImageMediaSourcesSHRpUJI(embed, j10, messageId);
            if (m391toImageMediaSourcesSHRpUJI != null) {
                ...
                final int i14 = 0;
                for (Object obj : CollectionsKt.q1(m391toImageMediaSourcesSHRpUJI, new EmbedViewResizingMediaView[]{embedViewBinding.inlineMediaView, embedViewBinding.inlineMediaView2, embedViewBinding.inlineMediaView3, embedViewBinding.inlineMediaView4})) {
                    int i15 = i14 + 1;
                    if (i14 < 0) {
                        CollectionsKt.v();
                    }
                ...
                final MediaSource m392toMediaSourceUBIQNlQ2 = EmbedUtilsKt.m392toMediaSourceUBIQNlQ(embed, j10, messageId, z10, Double.valueOf(d10));
                if (m392toMediaSourceUBIQNlQ2 != null) {
                    ...
                    embedView.setMediaEmbed(inlineMediaView, embed, m392toMediaSourceUBIQNlQ2, i11, MessageMargins.Companion.getWidthForEmbedContent(margins, i10, z18));
                    embedView.binding.inlineMediaView.setOnMediaClickListeners(new View.OnClickListener() { // from class: com.discord.chat.presentation.message.view.o0
                        @Override // android.view.View.OnClickListener
                        public final void onClick(View view) {
                            EmbedView.setEmbed_uKkM4jM$lambda$14$lambda$13(Function2.this, m392toMediaSourceUBIQNlQ2, z15, embedView, view);
                        }
                    }, onLongClickListener);
                }
                z20 = true;
                if (WhenMappings.$EnumSwitchMapping$0[embed.getType().ordinal()] != 1 ? m392toMediaSourceUBIQNlQ2 == null : embed.getVideo() == null) {
