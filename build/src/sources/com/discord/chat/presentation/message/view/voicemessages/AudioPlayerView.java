...
public final class AudioPlayerView extends FrameLayout {
    ...
    public interface Listener {
        ...
        public static final class Companion {
            ...
            public final float secondsSinceStart(long j10) {
                ...
                return (float) Duration.J(((Duration) kotlin.ranges.d.f(Duration.h(kotlin.time.b.t(System.currentTimeMillis() - j10, ns.b.f40016o)), Duration.h(Duration.f34764e.c()))).O(), ns.b.f40017p);
            }
        }
    ...
    public static final Unit attachStateChangeListener$lambda$0(AudioPlayerView audioPlayerView, boolean z10) {
        ...
        if (z10) {
            d10 = ps.i.d(CoroutineViewUtilsKt.getAttachedScope(audioPlayerView), null, null, new AudioPlayerView$attachStateChangeListener$1$1(audioPlayerView, null), 3, null);
    ...
    */
    ...
    private final void maybeLogPlaybackEnded() {
        ...
        if (currentPosition != null) {
            ...
            if (l10 != null) {
                ...
                if (listener != null) {
                    Duration.a aVar = Duration.f34764e;
                    listener.mediaAttachmentPlaybackEnded((float) Duration.J(kotlin.time.b.t(longValue, ns.b.f40016o), ns.b.f40017p), secondsSinceStart);
                }
            }
        }
    }
    ...
    private final void maybeLogPlaybackStarted() {
        ...
        if (currentPosition != null) {
            ...
            if (listener != null) {
                Duration.a aVar = Duration.f34764e;
                listener.mediaAttachmentPlaybackStarted((float) Duration.J(kotlin.time.b.t(longValue, ns.b.f40016o), ns.b.f40017p));
            }
        }
    }
    ...
    private final void reset(boolean z10) {
        ...
        d10 = ps.i.d(CoroutineViewUtilsKt.getAttachedScope(this), null, null, new AudioPlayerView$reset$1(this, null), 3, null);
        this.resetJob = d10;
        ps.i.d(CoroutineViewUtilsKt.getAttachedScope(this), null, null, new AudioPlayerView$reset$2(this, null), 3, null);
    }
    ...
    private final int toSeconds(long j10) {
        Duration.a aVar = Duration.f34764e;
        return (int) Math.ceil(Duration.J(kotlin.time.b.t(j10, ns.b.f40016o), ns.b.f40017p));
    }
    ...
    public final void toggleDurationEmitter(boolean z10) {
        ...
        if (z10) {
            d10 = ps.i.d(CoroutineViewUtilsKt.getAttachedScope(this), null, null, new AudioPlayerView$toggleDurationEmitter$2(this, null), 3, null);
    ...
    public AudioPlayerView(@NotNull final Context context, AttributeSet attributeSet, int i10) {
        ...
        this.bounceAnimator$delegate = rr.l.a(new Function0() { // from class: com.discord.chat.presentation.message.view.voicemessages.p
            @Override // kotlin.jvm.functions.Function0
            public final Object invoke() {
        ...
        this.animatorManager$delegate = rr.l.a(new Function0() { // from class: com.discord.chat.presentation.message.view.voicemessages.q
            @Override // kotlin.jvm.functions.Function0
            public final Object invoke() {
