    ...
    public interface Listener {
        ...
        public static final class Companion {
            ...
            public final float secondsSinceStart(long j10) {
                ...
                return (float) Duration.J(((Duration) kotlin.ranges.d.f(Duration.h(kotlin.time.b.t(System.currentTimeMillis() - j10, es.b.f24008o)), Duration.h(Duration.f36281e.c()))).O(), es.b.f24009p);
            }
        }
