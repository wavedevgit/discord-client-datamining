...
public final class AudioPlayerView extends FrameLayout {
    ...
    public interface Listener {
        ...
        public static final class Companion {
            ...
            public final float secondsSinceStart(long j10) {
                ...
                return (float) Duration.J(((Duration) kotlin.ranges.d.f(Duration.h(kotlin.time.b.t(System.currentTimeMillis() - j10, hs.b.f28134o)), Duration.h(Duration.f35463e.c()))).O(), hs.b.f28135p);
            }
        }
    ...
    public static final Unit attachStateChangeListener$lambda$0(AudioPlayerView audioPlayerView, boolean z10) {
        ...
        if (z10) {
            d10 = js.i.d(CoroutineViewUtilsKt.getAttachedScope(audioPlayerView), null, null, new AudioPlayerView$attachStateChangeListener$1$1(audioPlayerView, null), 3, null);
    ...
    */
    ...
    private final void maybeLogPlaybackEnded() {
        ...
        if (currentPosition != null) {
            ...
            if (l10 != null) {
                ...
                if (listener != null) {
                    Duration.a aVar = Duration.f35463e;
                    listener.mediaAttachmentPlaybackEnded((float) Duration.J(kotlin.time.b.t(longValue, hs.b.f28134o), hs.b.f28135p), secondsSinceStart);
                }
            }
        }
    }
    ...
    private final void maybeLogPlaybackStarted() {
        ...
        if (currentPosition != null) {
            ...
            if (listener != null) {
                Duration.a aVar = Duration.f35463e;
                listener.mediaAttachmentPlaybackStarted((float) Duration.J(kotlin.time.b.t(longValue, hs.b.f28134o), hs.b.f28135p));
            }
        }
    }
    ...
    private final void reset(boolean z10) {
        ...
        d10 = js.i.d(CoroutineViewUtilsKt.getAttachedScope(this), null, null, new AudioPlayerView$reset$1(this, null), 3, null);
        this.resetJob = d10;
        js.i.d(CoroutineViewUtilsKt.getAttachedScope(this), null, null, new AudioPlayerView$reset$2(this, null), 3, null);
    }
    ...
    private final int toSeconds(long j10) {
        Duration.a aVar = Duration.f35463e;
        return (int) Math.ceil(Duration.J(kotlin.time.b.t(j10, hs.b.f28134o), hs.b.f28135p));
    }
    ...
    public final void toggleDurationEmitter(boolean z10) {
        ...
        if (z10) {
            d10 = js.i.d(CoroutineViewUtilsKt.getAttachedScope(this), null, null, new AudioPlayerView$toggleDurationEmitter$2(this, null), 3, null);
    ...
    public AudioPlayerView(@NotNull final Context context, AttributeSet attributeSet, int i10) {
        ...
        this.bounceAnimator$delegate = lr.l.a(new Function0() { // from class: com.discord.chat.presentation.message.view.voicemessages.p
            @Override // kotlin.jvm.functions.Function0
            public final Object invoke() {
        ...
        this.animatorManager$delegate = lr.l.a(new Function0() { // from class: com.discord.chat.presentation.message.view.voicemessages.q
            @Override // kotlin.jvm.functions.Function0
            public final Object invoke() {
