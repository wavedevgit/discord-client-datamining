...
public final class AppMessageEmbedAccessory extends MessageAccessory {
    ...
    public int hashCode() {
        return (((((((MessageId.m1088hashCodeimpl(this.messageId) * 31) + this.margins.hashCode()) * 31) + Integer.hashCode(this.codedLinkIndex)) * 31) + this.appMessageEmbed.hashCode()) * 31) + Integer.hashCode(this.constrainedWidth);
    }
    ...
    public String toString() {
        ...
        return "AppMessageEmbedAccessory(messageId=" + m1090toStringimpl + ", margins=" + messageMargins + ", codedLinkIndex=" + i10 + ", appMessageEmbed=" + appMessageEmbedImpl + ", constrainedWidth=" + i11 + ")";
    }
