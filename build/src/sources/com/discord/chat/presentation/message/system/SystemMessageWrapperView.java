...
public final class SystemMessageWrapperView extends FrameLayout {
    ...
    public final void setMessage(@NotNull Message message, @NotNull MessageContext messageContext, @NotNull final ChatEventHandler eventHandler) {
        ...
        Function0 function0 = new Function0() { // from class: com.discord.chat.presentation.message.system.h
            @Override // kotlin.jvm.functions.Function0
            public final Object invoke() {
                ChatEventHandler message$lambda$0;
                message$lambda$0 = SystemMessageWrapperView.setMessage$lambda$0(ChatEventHandler.this);
                return message$lambda$0;
            }
        };
        removeAllViews();
        if (MessageKt.isCallMessage(message)) {
            createAndBindStandaloneView = new CallSystemMessageDelegate(function0).createAndBindStandaloneView(this, message);
        } else {
            createAndBindStandaloneView = new SystemMessageDelegate(function0, new RecyclerView.RecycledViewPool()).createAndBindStandaloneView(this, message, messageContext);
        }
