...
public final class SystemMessageView extends ChatListConstraintLayout implements SpineParentMessage {
    ...
    public static final boolean setMessage$lambda$0(Message message, ChatEventHandler chatEventHandler, View view) {
        ...
        if (mo495getOnMessageLongPressed != null) {
            mo495getOnMessageLongPressed.invoke(MessageId.m1085boximpl(message.m239getId3Eiw7ao()), ChannelId.m1059boximpl(message.m236getChannelIdo4g7jtM()), null, null, null, null);
            return true;
        }
        return true;
    }
    ...
    public final void setMessage(@NotNull final Message message, @NotNull MessageContext context, @NotNull final ChatEventHandler eventHandler) {
        ...
        h0.n0(this, new MessageViewAccessibilityDelegate(message, new View.OnClickListener() { // from class: com.discord.chat.presentation.message.system.g
            @Override // android.view.View.OnClickListener
            public final void onClick(View view) {
