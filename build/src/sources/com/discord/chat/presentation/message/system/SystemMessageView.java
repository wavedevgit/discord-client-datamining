...
public final class SystemMessageView extends ChatListConstraintLayout implements SpineParentMessage {
    ...
    public static final boolean setMessage$lambda$0(Message message, ChatEventHandler chatEventHandler, View view) {
        ...
        if (mo493getOnMessageLongPressed != null) {
            mo493getOnMessageLongPressed.invoke(MessageId.m1083boximpl(message.m237getId3Eiw7ao()), ChannelId.m1057boximpl(message.m234getChannelIdo4g7jtM()), null, null, null, null);
            return true;
        }
        return true;
    }
