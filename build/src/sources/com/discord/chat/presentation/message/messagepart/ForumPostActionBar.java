...
public final class ForumPostActionBar extends MessageAccessory {
    ...
    public int hashCode() {
        int m1088hashCodeimpl = ((MessageId.m1088hashCodeimpl(this.messageId) * 31) + this.postActions.hashCode()) * 31;
        List<MessageReaction> list = this.reactions;
        int hashCode = (((((m1088hashCodeimpl + (list == null ? 0 : list.hashCode())) * 31) + Boolean.hashCode(this.canAddNewReactions)) * 31) + this.addNewReactionAccessibilityLabel.hashCode()) * 31;
    ...
    public String toString() {
        ...
        ReactionsTheme reactionsTheme = this.reactionsTheme;
        return "ForumPostActionBar(messageId=" + m1090toStringimpl + ", postActions=" + forumPostActions + ", reactions=" + list + ", canAddNewReactions=" + z10 + ", addNewReactionAccessibilityLabel=" + str + ", reactionsTheme=" + reactionsTheme + ")";
    }
