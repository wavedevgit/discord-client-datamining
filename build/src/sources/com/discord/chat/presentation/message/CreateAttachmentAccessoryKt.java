...
public final class CreateAttachmentAccessoryKt {
    ...
    public static final MessageAttachmentAccessory createAttachmentAccessory(@NotNull Attachment attachment, @NotNull Message message, int i10, int i11, int i12, Boolean bool) {
        ...
        if (!Intrinsics.areEqual(message.isCurrentUserMessageAuthor(), Boolean.TRUE) || (m238getId3Eiw7ao = message.m239getNonceN_6c4I0()) == null) {
            m238getId3Eiw7ao = message.m238getId3Eiw7ao();
        }
        ...
        if (i13 != 1) {
            if (i13 != 2) {
                if (i13 != 3) {
                    if (i13 == 4) {
                        return new AudioAttachmentMessageAccessory(message.m235getChannelIdo4g7jtM(), m238getId3Eiw7ao, attachment, i10, message.getAttachmentsOpacity(), message.m234getAuthorIdwUX8bhU(), message.getAudioAttachmentBackgroundColor(), MessageFlagKt.hasMessageFlag(Long.valueOf(message.getFlags()), MessageFlag.IS_VOICE_MESSAGE), null);
                    }
                    throw new as.p();
                }
                return new FileAttachmentMessageAccessory(m238getId3Eiw7ao, attachment, i10, message.getAttachmentsOpacity(), forAttachment, attachment.getUploaderId(), attachment.getUploaderItemId(), null);
            }
            String str = m238getId3Eiw7ao;
            ...
            return new VideoAttachmentMessageAccessory(m235getChannelIdo4g7jtM, str, i10, attachment, message.getAttachmentsOpacity(), i11, i12, forAttachment, z10, z12, null);
        }
        String str2 = m238getId3Eiw7ao;
