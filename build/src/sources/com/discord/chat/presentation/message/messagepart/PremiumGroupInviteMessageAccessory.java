...
public final class PremiumGroupInviteMessageAccessory extends MessageAccessory {
    ...
    public static /* synthetic */ PremiumGroupInviteMessageAccessory m635copyntcYbpo$default(PremiumGroupInviteMessageAccessory premiumGroupInviteMessageAccessory, String str, PremiumGroupInviteEmbed premiumGroupInviteEmbed, int i10, Object obj) {
        if ((i10 & 1) != 0) {
        ...
        return premiumGroupInviteMessageAccessory.m637copyntcYbpo(str, premiumGroupInviteEmbed);
    }

    @NotNull
    /* renamed from: component1-3Eiw7ao  reason: not valid java name */
    public final String m636component13Eiw7ao() {
    ...
    public final PremiumGroupInviteMessageAccessory m637copyntcYbpo(@NotNull String messageId, @NotNull PremiumGroupInviteEmbed premiumGroupInvite) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof PremiumGroupInviteMessageAccessory) {
            ...
            return MessageId.m1088equalsimpl0(this.messageId, premiumGroupInviteMessageAccessory.messageId) && Intrinsics.areEqual(this.premiumGroupInvite, premiumGroupInviteMessageAccessory.premiumGroupInvite);
        }
        return false;
    }
    ...
    public int hashCode() {
        return (MessageId.m1089hashCodeimpl(this.messageId) * 31) + this.premiumGroupInvite.hashCode();
    }
    ...
    public String toString() {
        ...
        return "PremiumGroupInviteMessageAccessory(messageId=" + m1091toStringimpl + ", premiumGroupInvite=" + premiumGroupInviteEmbed + ")";
    }
