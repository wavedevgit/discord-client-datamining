...
public final class PollMessageAccessory extends MessageAccessory implements IPollStyleSet {
    ...
    public static final class Companion {
        ...
        public final PollMessageAccessory create(@NotNull Context context, @NotNull Message message, @NotNull PollData pollData) {
            ...
            for (PollAnswer pollAnswer : answers) {
                ...
                arrayList.add(new PollAnswerAccessory(m238getId3Eiw7ao, resources, pollAnswer, l10, canTapAnswers, canSelectMultipleAnswers, canShowVoteCounts, hasVoted, isExpired, inflateUrl, answersInteraction, answerTapAccessibilityLabel, z11, shouldAnimateEmoji, shouldAutoPlayGifs, null, PeerConnection.PORTALLOCATOR_ENABLE_ANY_ADDRESS_PORTS, null));
            }
            return new PollMessageAccessory(message.m235getChannelIdo4g7jtM(), message.m238getId3Eiw7ao(), inflateUrl, pollData, arrayList, null, 32, null);
        }
    ...
    public static /* synthetic */ PollMessageAccessory m627copyj8a4Y88$default(PollMessageAccessory pollMessageAccessory, long j10, String str, String str2, PollData pollData, List list, IPollStyleSet iPollStyleSet, int i10, Object obj) {
        if ((i10 & 1) != 0) {
        ...
        return pollMessageAccessory.m630copyj8a4Y88(j11, str3, str4, pollData2, list3, iPollStyleSet);
    }

    /* renamed from: component1-o4g7jtM  reason: not valid java name */
    public final long m628component1o4g7jtM() {
        return this.channelId;
    }

    @NotNull
    /* renamed from: component2-3Eiw7ao  reason: not valid java name */
    public final String m629component23Eiw7ao() {
    ...
    public final PollMessageAccessory m630copyj8a4Y88(long j10, @NotNull String messageId, String str, @NotNull PollData data, @NotNull List<PollAnswerAccessory> answers, @NotNull IPollStyleSet containerStyleSet) {
    ...
    public final long m631getChannelIdo4g7jtM() {
        return this.channelId;
    }
