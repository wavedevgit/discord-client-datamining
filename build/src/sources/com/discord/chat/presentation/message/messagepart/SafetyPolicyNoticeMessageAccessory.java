...
public final class SafetyPolicyNoticeMessageAccessory extends MessageAccessory {
    ...
    public static /* synthetic */ SafetyPolicyNoticeMessageAccessory m647copyntcYbpo$default(SafetyPolicyNoticeMessageAccessory safetyPolicyNoticeMessageAccessory, String str, SafetyPolicyNoticeEmbed safetyPolicyNoticeEmbed, int i10, Object obj) {
        if ((i10 & 1) != 0) {
        ...
        return safetyPolicyNoticeMessageAccessory.m649copyntcYbpo(str, safetyPolicyNoticeEmbed);
    }

    @NotNull
    /* renamed from: component1-3Eiw7ao  reason: not valid java name */
    public final String m648component13Eiw7ao() {
    ...
    public final SafetyPolicyNoticeMessageAccessory m649copyntcYbpo(@NotNull String messageId, @NotNull SafetyPolicyNoticeEmbed safetyPolicyNoticeEmbed) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof SafetyPolicyNoticeMessageAccessory) {
            ...
            return MessageId.m1088equalsimpl0(this.messageId, safetyPolicyNoticeMessageAccessory.messageId) && Intrinsics.areEqual(this.safetyPolicyNoticeEmbed, safetyPolicyNoticeMessageAccessory.safetyPolicyNoticeEmbed);
        }
        return false;
    }
    ...
    public int hashCode() {
        return (MessageId.m1089hashCodeimpl(this.messageId) * 31) + this.safetyPolicyNoticeEmbed.hashCode();
    }
    ...
    public String toString() {
        ...
        return "SafetyPolicyNoticeMessageAccessory(messageId=" + m1091toStringimpl + ", safetyPolicyNoticeEmbed=" + safetyPolicyNoticeEmbed + ")";
    }
