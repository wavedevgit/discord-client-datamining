...
public final class FlaggedMessageActionBarAccessory extends MessageAccessory {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof FlaggedMessageActionBarAccessory) {
            ...
            return MessageId.m1087equalsimpl0(this.messageId, flaggedMessageActionBarAccessory.messageId) && Intrinsics.areEqual(this.message, flaggedMessageActionBarAccessory.message) && Intrinsics.areEqual(this.autoModerationContext, flaggedMessageActionBarAccessory.autoModerationContext);
        }
        return false;
    }
    ...
    public int hashCode() {
        return (((MessageId.m1088hashCodeimpl(this.messageId) * 31) + this.message.hashCode()) * 31) + this.autoModerationContext.hashCode();
    }
    ...
    public String toString() {
        ...
        return "FlaggedMessageActionBarAccessory(messageId=" + m1090toStringimpl + ", message=" + message + ", autoModerationContext=" + autoModerationContext + ")";
    }
