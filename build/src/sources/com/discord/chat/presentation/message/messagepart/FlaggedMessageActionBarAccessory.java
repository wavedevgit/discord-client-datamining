...
public final class FlaggedMessageActionBarAccessory extends MessageAccessory {
    ...
    public static /* synthetic */ FlaggedMessageActionBarAccessory m573copyu7_MRrM$default(FlaggedMessageActionBarAccessory flaggedMessageActionBarAccessory, String str, Message message, AutoModerationContext autoModerationContext, int i10, Object obj) {
        if ((i10 & 1) != 0) {
        ...
        return flaggedMessageActionBarAccessory.m575copyu7_MRrM(str, message, autoModerationContext);
    }

    @NotNull
    /* renamed from: component1-3Eiw7ao  reason: not valid java name */
    public final String m574component13Eiw7ao() {
    ...
    public final FlaggedMessageActionBarAccessory m575copyu7_MRrM(@NotNull String messageId, @NotNull Message message, @NotNull AutoModerationContext autoModerationContext) {
