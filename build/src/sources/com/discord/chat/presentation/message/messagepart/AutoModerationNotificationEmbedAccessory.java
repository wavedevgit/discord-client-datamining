...
public final class AutoModerationNotificationEmbedAccessory extends MessageAccessory {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof AutoModerationNotificationEmbedAccessory) {
            ...
            return MessageId.m1087equalsimpl0(this.messageId, autoModerationNotificationEmbedAccessory.messageId) && Intrinsics.areEqual(this.message, autoModerationNotificationEmbedAccessory.message) && Intrinsics.areEqual(this.moderationContext, autoModerationNotificationEmbedAccessory.moderationContext);
        }
        return false;
    }
    ...
    public int hashCode() {
        return (((MessageId.m1088hashCodeimpl(this.messageId) * 31) + this.message.hashCode()) * 31) + this.moderationContext.hashCode();
    }
    ...
    public String toString() {
        ...
        return "AutoModerationNotificationEmbedAccessory(messageId=" + m1090toStringimpl + ", message=" + message + ", moderationContext=" + autoModerationContext + ")";
    }
