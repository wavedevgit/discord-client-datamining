...
public final class StickerPngViewHolder extends StickerPartViewHolder {
    ...
    public void bind(@NotNull final Sticker sticker, @NotNull final Function1<? super Sticker, Unit> onStickerClicked, @NotNull final Function1<? super Sticker, Unit> onStickerLongClicked, int i10, int i11) {
        ...
        this.stickerView.asPng(sticker.getUrl(), Integer.valueOf(i10), Integer.valueOf(i11), sticker.getAccessibilityLabel());
        NestedScrollOnTouchUtilsKt.setOnClickListenerNested$default(this.stickerView, false, new View.OnClickListener() { // from class: com.discord.chat.presentation.message.viewholder.q0
            @Override // android.view.View.OnClickListener
            public final void onClick(View view) {
                Function1.this.invoke(sticker);
            }
        }, 1, null);
        NestedScrollOnTouchUtilsKt.setOnLongClickListenerNested$default(this.stickerView, false, new View.OnLongClickListener() { // from class: com.discord.chat.presentation.message.viewholder.r0
