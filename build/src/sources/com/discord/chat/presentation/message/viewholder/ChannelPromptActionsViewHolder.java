...
public final class ChannelPromptActionsViewHolder extends MessagePartViewHolder {
    ...
    public static final void bind$lambda$0(Function3 function3, ChannelPromptActionsAccessory channelPromptActionsAccessory, View view) {
        function3.invoke(MessageId.m1084boximpl(channelPromptActionsAccessory.mo536getMessageId3Eiw7ao()), ChannelId.m1058boximpl(channelPromptActionsAccessory.getMessage().m234getChannelIdo4g7jtM()), "camera");
    }
    ...
    public static final void bind$lambda$1(Function3 function3, ChannelPromptActionsAccessory channelPromptActionsAccessory, View view) {
        function3.invoke(MessageId.m1084boximpl(channelPromptActionsAccessory.mo536getMessageId3Eiw7ao()), ChannelId.m1058boximpl(channelPromptActionsAccessory.getMessage().m234getChannelIdo4g7jtM()), "emoji");
    }
    ...
    public static final void bind$lambda$2(Function3 function3, ChannelPromptActionsAccessory channelPromptActionsAccessory, View view) {
        function3.invoke(MessageId.m1084boximpl(channelPromptActionsAccessory.mo536getMessageId3Eiw7ao()), ChannelId.m1058boximpl(channelPromptActionsAccessory.getMessage().m234getChannelIdo4g7jtM()), "gaming-stats");
    }
    ...
    public static final void bind$lambda$3(Function3 function3, ChannelPromptActionsAccessory channelPromptActionsAccessory, View view) {
        function3.invoke(MessageId.m1084boximpl(channelPromptActionsAccessory.mo536getMessageId3Eiw7ao()), ChannelId.m1058boximpl(channelPromptActionsAccessory.getMessage().m234getChannelIdo4g7jtM()), "gif");
    }
