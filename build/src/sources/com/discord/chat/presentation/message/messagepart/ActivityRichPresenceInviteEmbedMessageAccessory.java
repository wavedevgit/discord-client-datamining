...
public final class ActivityRichPresenceInviteEmbedMessageAccessory extends MessageAccessory {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof ActivityRichPresenceInviteEmbedMessageAccessory) {
            ...
            return MessageId.m1087equalsimpl0(this.messageId, activityRichPresenceInviteEmbedMessageAccessory.messageId) && Intrinsics.areEqual(this.margins, activityRichPresenceInviteEmbedMessageAccessory.margins) && Intrinsics.areEqual(this.activityRichPresenceInviteEmbed, activityRichPresenceInviteEmbedMessageAccessory.activityRichPresenceInviteEmbed);
        }
        return false;
    }
    ...
    public int hashCode() {
        return (((MessageId.m1088hashCodeimpl(this.messageId) * 31) + this.margins.hashCode()) * 31) + this.activityRichPresenceInviteEmbed.hashCode();
    }
    ...
    public String toString() {
        ...
        return "ActivityRichPresenceInviteEmbedMessageAccessory(messageId=" + m1090toStringimpl + ", margins=" + messageMargins + ", activityRichPresenceInviteEmbed=" + activityRichPresenceInviteEmbed + ")";
    }
