...
public final class FlaggedMessageEmbedView extends ConstraintLayout implements VerticalSpacingItemDecoration.SpacingProviderView {
    ...
    private final void configureAuthor(final Message message, final ChatEventHandler chatEventHandler) {
        ...
        if (message.getConnectionsRoleTag() != null) {
            connectionsRoleTagView.m504configureConnectionsRoleTaguESh2Cg(message.m234getAuthorIdwUX8bhU(), message.m237getGuildIdqOKuAAo(), ChannelId.m1058boximpl(message.m235getChannelIdo4g7jtM()), message.getConnectionsRoleTag(), chatEventHandler);
        }
    }
    ...
    public static final void configureAuthor$lambda$22$lambda$20(Message message, ChatEventHandler chatEventHandler, View view) {
        if (message.m234getAuthorIdwUX8bhU() != null) {
            chatEventHandler.mo449onTapAvatarx5gers8(message.m238getId3Eiw7ao(), message.m234getAuthorIdwUX8bhU().m1145unboximpl());
        }
    }
    ...
    public static final boolean configureAuthor$lambda$22$lambda$21(Message message, ChatEventHandler chatEventHandler, View view) {
        if (message.m234getAuthorIdwUX8bhU() != null) {
            chatEventHandler.mo440onLongPressAvatarx5gers8(message.m238getId3Eiw7ao(), message.m234getAuthorIdwUX8bhU().m1145unboximpl());
            return true;
        }
        return true;
    }
    ...
    public static final void configureAuthor$lambda$24$lambda$23(Message message, ChatEventHandler chatEventHandler, View view) {
        if (message.m234getAuthorIdwUX8bhU() != null) {
            chatEventHandler.mo443onLongPressUsernamex5gers8(message.m238getId3Eiw7ao(), message.m234getAuthorIdwUX8bhU().m1145unboximpl());
        }
    }
    ...
    private final void configureMessageContent(MessageMargins messageMargins, Message message) {
        ...
        if (content2 != null && content2.getHasContent()) {
            z11 = true;
            MessageContentView.m699setMessageContent4q5Jro$default(messageContentView, messageMargins, message.getContent(), message.m238getId3Eiw7ao(), MessageKt.shouldAnimateEmoji(message), MessageKt.shouldShowLinkDecorations(message), message.getShouldShowRoleDot(), message.getShouldShowRoleOnName(), new Function1() { // from class: com.discord.chat.presentation.message.view.k1
                ...
                public /* bridge */ /* synthetic */ Object invoke(Object obj) {
                    m692invoke1xi1bu0(((MessageId) obj).m1093unboximpl());
                    return Unit.f31988a;
                }

                /* renamed from: invoke-1xi1bu0  reason: not valid java name */
                public final void m692invoke1xi1bu0(String it) {
