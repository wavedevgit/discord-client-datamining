...
public final class FlaggedMessageEmbedView extends ConstraintLayout implements VerticalSpacingItemDecoration.SpacingProviderView {
    ...
    private final void configureAuthor(final Message message, final ChatEventHandler chatEventHandler) {
        ...
        if (message.getConnectionsRoleTag() != null) {
            connectionsRoleTagView.m505configureConnectionsRoleTaguESh2Cg(message.m235getAuthorIdwUX8bhU(), message.m238getGuildIdqOKuAAo(), ChannelId.m1059boximpl(message.m236getChannelIdo4g7jtM()), message.getConnectionsRoleTag(), chatEventHandler);
        }
    }
        ...
        if (content2 != null && content2.getHasContent()) {
            ...
            MessageContentView.m700setMessageContent4q5Jro$default(messageContentView, messageMargins, message.getContent(), message.m239getId3Eiw7ao(), MessageKt.shouldAnimateEmoji(message), MessageKt.shouldShowLinkDecorations(message), message.getShouldShowRoleDot(), message.getShouldShowRoleOnName(), new Function1() { // from class: com.discord.chat.presentation.message.view.k1
                ...
                public /* bridge */ /* synthetic */ Object invoke(Object obj) {
                    m693invoke1xi1bu0(((MessageId) obj).m1094unboximpl());
                    return Unit.f31988a;
                }
