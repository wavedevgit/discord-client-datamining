...
public final class ActivityRichPresenceInviteEmbedViewHolder extends MessagePartViewHolder {
    ...
    public static final void bind$lambda$0(Function1 function1, ActivityRichPresenceInviteEmbedMessageAccessory activityRichPresenceInviteEmbedMessageAccessory, View view) {
        function1.invoke(MessageId.m1084boximpl(activityRichPresenceInviteEmbedMessageAccessory.mo537getMessageId3Eiw7ao()));
    }
    ...
    public final void bind(@NotNull final ActivityRichPresenceInviteEmbedMessageAccessory accessory, @NotNull final Function1<? super MessageId, Unit> onTapJoinRichPresence) {
        ...
        activityRichPresenceInviteEmbedView.m682setActivityRichPresenceInviteEmbeddJIpDCQ(margins, z10, ctaButtonText, z16, footerLabel, gradientColors, headerText, iconSrc, z13, z14, i10, new View.OnClickListener() { // from class: com.discord.chat.presentation.message.viewholder.a
            @Override // android.view.View.OnClickListener
            public final void onClick(View view) {
                ActivityRichPresenceInviteEmbedViewHolder.bind$lambda$0(Function1.this, accessory, view);
            }
        }, activityRichPresenceInviteEmbed.getPartyMemberAvatarURIs(), activityRichPresenceInviteEmbed.getPartySizeText(), activityRichPresenceInviteEmbed.getPlatformIconKeys(), activityRichPresenceInviteEmbed.getCoverImageUrl(), activityRichPresenceInviteEmbed.getSubtitle(), activityRichPresenceInviteEmbed.getTitle(), activityRichPresenceInviteEmbed.getHiddenEmbedMessageContent(), accessory.mo537getMessageId3Eiw7ao(), new ActivityRichPresenceInviteEmbedViewHolder$bind$2(this.eventHandler), new ActivityRichPresenceInviteEmbedViewHolder$bind$3(this.eventHandler), new ActivityRichPresenceInviteEmbedViewHolder$bind$4(this.eventHandler), new ActivityRichPresenceInviteEmbedViewHolder$bind$5(this.eventHandler), new ActivityRichPresenceInviteEmbedViewHolder$bind$6(this.eventHandler), new ActivityRichPresenceInviteEmbedViewHolder$bind$7(this.eventHandler), new ActivityRichPresenceInviteEmbedViewHolder$bind$8(this.eventHandler), new ActivityRichPresenceInviteEmbedViewHolder$bind$9(this.eventHandler), new ActivityRichPresenceInviteEmbedViewHolder$bind$10(this.eventHandler), new Function0() { // from class: com.discord.chat.presentation.message.viewholder.b
