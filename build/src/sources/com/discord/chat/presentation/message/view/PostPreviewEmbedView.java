...
public final class PostPreviewEmbedView extends ConstraintLayout {
    ...
    private final void setCoverImage(String str, String str2, String str3) {
        ...
        if (str != null && !StringsKt.k0(str)) {
            if (str3 != null && !StringsKt.k0(str3)) {
                ((GenericDraweeHierarchy) this.binding.coverImage.getHierarchy()).t(ScalingUtils$ScaleType.f10636e);
                this.binding.backgroundImage.setImageURI(str3);
            } else {
                ((GenericDraweeHierarchy) this.binding.coverImage.getHierarchy()).t(ScalingUtils$ScaleType.f10640i);
            }
    ...
    private final void m703setFooterAyv7vGE(StructurableText structurableText, String str) {
    ...
    public final void m704setPostPreviewEmbed4itWklQ(@NotNull String title, String str, @NotNull String ctaCopy, int i10, @NotNull StructurableText footer, @NotNull String messageId, String str2, String str3, String str4, String str5, @NotNull View.OnClickListener onButtonClickListener, boolean z10, boolean z11, boolean z12, boolean z13, SpoilerConfig spoilerConfig) {
        ...
        setTitle(title);
        setSubtitle(str);
        m703setFooterAyv7vGE(footer, messageId);
