    ...
    private final void setCoverImage(String str, String str2, String str3) {
        ...
        if (str != null && !StringsKt.k0(str)) {
            if (str3 != null && !StringsKt.k0(str3)) {
                ((GenericDraweeHierarchy) this.binding.coverImage.getHierarchy()).t(ScalingUtils$ScaleType.f10058e);
                this.binding.backgroundImage.setImageURI(str3);
            } else {
                ((GenericDraweeHierarchy) this.binding.coverImage.getHierarchy()).t(ScalingUtils$ScaleType.f10062i);
            }
