...
public final class AutomodSystemMessageView extends ChatListConstraintLayout implements VerticalSpacingItemDecoration.SpacingProviderView, SpineParentMessage {
    ...
    private final void configureAuthor(Message message, final AutoModerationContext autoModerationContext, final ChatEventHandler chatEventHandler) {
        ...
        MessageTagView.m531configureTagViewUl7AT2Q$default(this.binding.messageTagView, autoModerationContext.getHeaderBadgeText(), Boolean.FALSE, null, null, null, chatEventHandler, message.m238getId3Eiw7ao(), message.m235getChannelIdo4g7jtM(), message.getTagType(), null, IntBufferBatchMountItem.INSTRUCTION_UPDATE_PADDING, null);
    ...
    public static final void configureAuthor$lambda$8$lambda$7(ChatEventHandler chatEventHandler, AutoModerationContext autoModerationContext, View view) {
        String str;
        String m1065toStringimpl = ChannelId.m1065toStringimpl(autoModerationContext.getMessage().m250getChannelIdo4g7jtM());
        GuildId m251getGuildIdqOKuAAo = autoModerationContext.getMessage().m251getGuildIdqOKuAAo();
        if (m251getGuildIdqOKuAAo != null) {
            str = GuildId.m1078toStringimpl(m251getGuildIdqOKuAAo.m1080unboximpl());
        } else {
            str = null;
        }
        chatEventHandler.onTapChannel(m1065toStringimpl, str, null);
    }
    ...
    private final List<MessageAccessory> generateMessageAccessories(MessageMargins messageMargins, Message message, MessageContext messageContext) {
        ...
        String m252getId3Eiw7ao = message2.m252getId3Eiw7ao();
        long m250getChannelIdo4g7jtM = message2.m250getChannelIdo4g7jtM();
        GuildId m251getGuildIdqOKuAAo = message2.m251getGuildIdqOKuAAo();
        UserId m253getUserIdwUX8bhU = message2.m253getUserIdwUX8bhU();
    ...
    public final void setMessage(@NotNull Message message, @NotNull MessageContext messageContext, @NotNull ChatEventHandler eventHandler, ComponentProvider componentProvider, boolean z10) {
        ...
        String m238getId3Eiw7ao = message.m238getId3Eiw7ao();
        long m235getChannelIdo4g7jtM = message.m235getChannelIdo4g7jtM();
        GuildId m237getGuildIdqOKuAAo = message.m237getGuildIdqOKuAAo();
        if (message.getForwardInfo() != null) {
            z11 = true;
        }
        messageAccessoriesView.m529setAccessoriesdvvEyHs(messageMargins, m238getId3Eiw7ao, m235getChannelIdo4g7jtM, m237getGuildIdqOKuAAo, generateMessageAccessories, eventHandler, componentProvider, z11);
    }
