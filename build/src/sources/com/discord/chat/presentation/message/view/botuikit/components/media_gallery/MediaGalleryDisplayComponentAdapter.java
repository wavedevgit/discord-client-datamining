...
public final class MediaGalleryDisplayComponentAdapter extends RecyclerView.Adapter {
    ...
    public void onBindViewHolder(@NotNull final MessagePartViewHolder holder, int i10) {
        ...
        if (holder instanceof MosaicItemMessageAttachmentImageViewHolder) {
            ...
            ((MosaicItemMessageAttachmentImageViewHolder) holder).bindGalleryItem(this.containerId, mediaGalleryDisplayComponent.getId(), mediaGalleryItem, getItemCount() == 1, new View.OnClickListener() { // from class: z6.a
            ...
            }, new View.OnLongClickListener() { // from class: z6.b
            ...
            ((MosaicItemMessageAttachmentVideoViewHolder) holder).bindGalleryItem(this.containerId, mediaGalleryDisplayComponent2.getId(), mediaGalleryItem2, getItemCount() == 1, new View.OnClickListener() { // from class: z6.f
                @Override // android.view.View.OnClickListener
                public final void onClick(View view) {
            ...
            }, new View.OnLongClickListener() { // from class: z6.g
                @Override // android.view.View.OnLongClickListener
                public final boolean onLongClick(View view) {
