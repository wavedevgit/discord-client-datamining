...
public final class TimestampMessageAccessory extends MessageAccessory {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof TimestampMessageAccessory) {
            ...
            return MessageId.m1087equalsimpl0(this.messageId, timestampMessageAccessory.messageId) && Intrinsics.areEqual(this.timestamp, timestampMessageAccessory.timestamp) && this.textColor == timestampMessageAccessory.textColor && this.discordFont == timestampMessageAccessory.discordFont;
        }
        return false;
    }
    ...
    public int hashCode() {
        return (((((MessageId.m1088hashCodeimpl(this.messageId) * 31) + this.timestamp.hashCode()) * 31) + Integer.hashCode(this.textColor)) * 31) + this.discordFont.hashCode();
    }
    ...
    public String toString() {
        ...
        return "TimestampMessageAccessory(messageId=" + m1090toStringimpl + ", timestamp=" + str + ", textColor=" + i10 + ", discordFont=" + discordFont + ")";
    }
