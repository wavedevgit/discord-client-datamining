...
public final class MessageView extends ChatListRelativeLayout implements VerticalSpacingItemDecoration.SpacingProviderView, SpineParentMessage, SwipeReplyInitiator, FactoryCreatable {
    ...
    private final void configureAuthor(final Message message, final ChatEventHandler chatEventHandler, ChainPart chainPart) {
        ...
        if (message.getClanTag() != null && message.m236getClanTagGuildIdqOKuAAo() != null) {
            ClanTagChipletView.m502configureD0ylKIU$default(this.binding.clanTagChiplet, message.getClanTag(), message.getClanBadgeUrl(), message.m236getClanTagGuildIdqOKuAAo().m1080unboximpl(), chatEventHandler, 0.0f, 16, null);
        ...
        if (message.getConnectionsRoleTag() != null) {
            this.binding.connectionsRoleTag.m504configureConnectionsRoleTaguESh2Cg(message.m234getAuthorIdwUX8bhU(), message.m237getGuildIdqOKuAAo(), ChannelId.m1058boximpl(message.m235getChannelIdo4g7jtM()), message.getConnectionsRoleTag(), chatEventHandler);
        ...
        this.binding.messageTagView.m532configureTagViewUl7AT2Q(message.getTagText(), message.getTagVerified(), message.getTagTextColor(), message.getTagBackgroundColor(), message.getOpTagText(), chatEventHandler, message.m238getId3Eiw7ao(), message.m235getChannelIdo4g7jtM(), message.getTagType(), message.getTagIconUrl());
    }
    ...
    public static final void configureAuthorClickListeners$lambda$16(Message message, ChatEventHandler chatEventHandler, View view) {
        if (message.m234getAuthorIdwUX8bhU() != null) {
            chatEventHandler.mo486onTapUsernamex5gers8(message.m238getId3Eiw7ao(), message.m234getAuthorIdwUX8bhU().m1145unboximpl());
        }
    }
    ...
    private final List<MessageAccessory> generateMessageAccessories(MessageMargins messageMargins, Message message, MessageContext messageContext, Function6 function6) {
        ...
        if (z10) {
            this.accessories.add(new ForwardHeaderMessageAccessory(message2.m238getId3Eiw7ao(), null));
        }
        ...
        if (content != null && content.getHasContent() && message2.getType() != MessageType.CUSTOM_GIFT) {
            ...
            String m238getId3Eiw7ao2 = message2.m238getId3Eiw7ao();
        ...
        if (message2.getAttachments() != null && message2.getPollData() == null && !MessageFlagKt.hasMessageFlag(Long.valueOf(message2.getFlags()), MessageFlag.IS_COMPONENTS_V2)) {
            ...
            if (!list.isEmpty() && messageContext.getUseAttachmentGridLayout()) {
                if (!Intrinsics.areEqual(message2.isCurrentUserMessageAuthor(), Boolean.TRUE) || (m238getId3Eiw7ao = message2.m239getNonceN_6c4I0()) == null) {
                    m238getId3Eiw7ao = message2.m238getId3Eiw7ao();
                }
                String str5 = m238getId3Eiw7ao;
                ArrayList<MessageAccessory> arrayList5 = this.accessories;
                long m235getChannelIdo4g7jtM = message2.m235getChannelIdo4g7jtM();
                ...
                arrayList5.add(new MediaMosaicAttachmentMessageAccessory(str5, messageMargins, m235getChannelIdo4g7jtM, arrayList6, i11, z10, messageState, z14, null));
            }
            ...
            if (z13) {
                ...
                String m238getId3Eiw7ao3 = message2.m238getId3Eiw7ao();
                long m235getChannelIdo4g7jtM2 = message2.m235getChannelIdo4g7jtM();
        ...
        if (postPreviewEmbeds != null) {
            ...
            for (Object obj2 : postPreviewEmbeds) {
                ...
                this.accessories.add(new PostPreviewEmbedMessageAccessory(message2.m238getId3Eiw7ao(), postPreviewEmbed, i18, SpoilerAttributes.Companion.forMediaPostPreviewEmbed(postPreviewEmbed, message2, i18, postPreviewEmbed.getVerifyAge()), null));
                i18 = i19;
            }
        ...
        if (embeds != null) {
            ...
            for (Object obj3 : embeds) {
                ...
                boolean z15 = z10;
                z10 = z15;
                this.accessories.add(new EmbedMessageAccessory(message2.m238getId3Eiw7ao(), messageMargins, i20, message2.m235getChannelIdo4g7jtM(), i11, i12, embed, MessageKt.shouldAutoPlayGifs(message2), MessageKt.shouldAnimateEmoji(message2), MessageKt.shouldShowLinkDecorations(message2), message2.getShouldShowRoleDot(), message2.getShouldShowRoleOnName(), SpoilerAttributes.Companion.forEmbed(embed, message2, i20, embed.getVerifyAge()), generateMessageAccessories$getLongClickListener(function6, message2, i20, MediaType.Embed), z15, null));
                if (embed.getObscureOrNull() != null) {
                    ArrayList<MessageAccessory> arrayList9 = this.accessories;
                    String m238getId3Eiw7ao4 = message2.m238getId3Eiw7ao();
                    long m235getChannelIdo4g7jtM3 = message2.m235getChannelIdo4g7jtM();
        ...
        if (giftCodes != null) {
            ...
            for (Object obj4 : giftCodes) {
                ...
                this.accessories.add(new GiftMessageAccessory(message2.m238getId3Eiw7ao(), i22, (GiftEmbed) obj4, null));
                i22 = i23;
            }
        ...
        if (referralTrialOffer != null) {
            this.accessories.add(new GiftMessageAccessory(message2.m238getId3Eiw7ao(), 0, referralTrialOffer, null));
        }
        ReferralEmbed referralTrialOfferInfo = message2.getReferralTrialOfferInfo();
        if (referralTrialOfferInfo != null) {
            this.accessories.add(new ReferralMessageAccessory(message2.m238getId3Eiw7ao(), referralTrialOfferInfo, null));
        }
        PremiumGroupInviteEmbed premiumGroupInviteInfo = message2.getPremiumGroupInviteInfo();
        if (premiumGroupInviteInfo != null) {
            this.accessories.add(new PremiumGroupInviteMessageAccessory(message2.m238getId3Eiw7ao(), premiumGroupInviteInfo, null));
        }
        ActivityInstanceEmbed activityInstanceEmbed = message2.getActivityInstanceEmbed();
        if (activityInstanceEmbed != null) {
            this.accessories.add(new ActivityInstanceEmbedMessageAccessory(message2.m238getId3Eiw7ao(), messageMargins, activityInstanceEmbed, i11, null));
        }
            ...
            for (Object obj5 : codedLinks) {
                ...
                if (codedLinkEmbed != null) {
                    ...
                    if (codedLinkEmbed instanceof GuildEventInviteEmbedImpl) {
                        guildProfileInviteMessageAccessory = new GuildEventInviteMessageAccessory(message2.m238getId3Eiw7ao(), messageMargins, i24, (GuildEventInviteEmbedImpl) codedLinkEmbed, MessageKt.shouldAnimateEmoji(message2), MessageKt.shouldShowLinkDecorations(message2), message2.getShouldShowRoleDot(), message2.getShouldShowRoleDot(), null);
                    } else if (codedLinkEmbed instanceof GuildInviteDisabledEmbedImpl) {
                        guildProfileInviteMessageAccessory = new GuildInviteDisabledMessageAccessory(message2.m238getId3Eiw7ao(), i24, (GuildInviteDisabledEmbedImpl) codedLinkEmbed, null);
                    } else if (codedLinkEmbed instanceof GuildInviteEmbedImpl) {
                        guildProfileInviteMessageAccessory = new GuildInviteMessageAccessory(message2.m238getId3Eiw7ao(), i24, (GuildInviteEmbedImpl) codedLinkEmbed, null);
                    } else if (codedLinkEmbed instanceof AppMessageEmbedImpl) {
                        int i26 = i11;
                        guildProfileInviteMessageAccessory = new AppMessageEmbedAccessory(message2.m238getId3Eiw7ao(), messageMargins, i24, (AppMessageEmbedImpl) codedLinkEmbed, i26, null);
                        i11 = i26;
                    } else if (codedLinkEmbed instanceof EmbeddedActivityInviteEmbedImpl) {
                        int i27 = i11;
                        i11 = i27;
                        guildProfileInviteMessageAccessory = new EmbeddedActivityInviteMessageAccessory(message2.m238getId3Eiw7ao(), messageMargins, i24, (EmbeddedActivityInviteEmbedImpl) codedLinkEmbed, i27, null);
                    } else if (codedLinkEmbed instanceof GuildProfileInviteEmbedImpl) {
                        guildProfileInviteMessageAccessory = new GuildProfileInviteMessageAccessory(message2.m238getId3Eiw7ao(), i24, (GuildProfileInviteEmbedImpl) codedLinkEmbed, null);
                    } else {
                        throw new as.p();
                    }
        ...
        if (stickers != null) {
            for (Sticker sticker : stickers) {
                this.accessories.add(new StickerMessageAccessory(message2.m238getId3Eiw7ao(), sticker, null));
            }
            Unit unit6 = Unit.f32556a;
        }
        if (message2.getComponents() != null) {
            defaultConstructorMarker = null;
            this.accessories.add(new MessageComponentsAccessory(message.m238getId3Eiw7ao(), messageMargins, message, message.getComponents(), i11, null));
        } else {
            defaultConstructorMarker = null;
        }
        ...
        if ((z11 && !message.isFirstForumPostMessage()) || messageContext.getContextType() == MessageContextType.MEDIA_VIEWER) {
            ...
            String m238getId3Eiw7ao5 = message.m238getId3Eiw7ao();
            ...
            arrayList11.add(new ReactionsMessageAccessory(m238getId3Eiw7ao5, list4, canAddNewReactions, addNewReactionAccessibilityLabel, reactionsTheme, null, str, num, z12, messageContext.getShowReplyButton(), 32, null));
        }
        ...
        if (activityRichPresenceInviteEmbed != null) {
            this.accessories.add(new ActivityRichPresenceInviteEmbedMessageAccessory(message.m238getId3Eiw7ao(), messageMargins, activityRichPresenceInviteEmbed, defaultConstructorMarker));
        }
        ThreadEmbed threadEmbed = message.getThreadEmbed();
        if (threadEmbed != null) {
            this.accessories.add(new ThreadEmbedMessageAccessory(message.m238getId3Eiw7ao(), threadEmbed, defaultConstructorMarker));
        }
        InteractionStatus interactionStatus = message.getInteractionStatus();
        if (interactionStatus != null) {
            this.accessories.add(new InteractionStatusMessageAccessory(message.m238getId3Eiw7ao(), interactionStatus, defaultConstructorMarker));
        }
        CtaButton ctaButton = message.getCtaButton();
        if (ctaButton != null) {
            this.accessories.add(new CtaButtonMessageAccessory(message.m235getChannelIdo4g7jtM(), message.m238getId3Eiw7ao(), ctaButton, null));
        }
        EphemeralIndication ephemeralIndication = message.getEphemeralIndication();
        if (ephemeralIndication != null) {
            this.accessories.add(new EphemeralIndicationMessageAccessory(message.m238getId3Eiw7ao(), ephemeralIndication, defaultConstructorMarker));
        }
        SurveyIndication surveyIndication = message.getSurveyIndication();
        if (surveyIndication != null) {
            this.accessories.add(new SurveyIndicationMessageAccessory(message.m238getId3Eiw7ao(), surveyIndication, defaultConstructorMarker));
        }
        if (message.isFirstForumPostMessage() && message.getPostActions() != null && messageContext.getContextType() != MessageContextType.MEDIA_VIEWER) {
            this.accessories.add(new ForumPostActionBar(message.m238getId3Eiw7ao(), message.getPostActions(), message.getReactions(), messageContext.getCanAddNewReactions(), messageContext.getAddNewReactionAccessibilityLabel(), messageContext.getReactionsTheme(), null));
        }
        SafetyPolicyNoticeEmbed safetyPolicyNoticeEmbed = message.getSafetyPolicyNoticeEmbed();
        if (safetyPolicyNoticeEmbed != null) {
            this.accessories.add(new SafetyPolicyNoticeMessageAccessory(message.m238getId3Eiw7ao(), safetyPolicyNoticeEmbed, defaultConstructorMarker));
        }
        ...
        if (safetySystemNotificationEmbed != null) {
            this.accessories.add(new SafetySystemNotificationMessageAccessory(message.m238getId3Eiw7ao(), safetySystemNotificationEmbed, defaultConstructorMarker));
        }
        ForwardInfo forwardInfo = message.getForwardInfo();
        if (forwardInfo != null && forwardInfo.getFooterInfo() != null) {
            this.accessories.add(new ForwardBreadcrumbMessageAccessory(message.m238getId3Eiw7ao(), message.m235getChannelIdo4g7jtM(), message.getForwardInfo(), null));
        }
    ...
    public static final boolean generateMessageAccessories$getLongClickListener$lambda$19$lambda$18(Function6 function6, Message message, int i10, MediaType mediaType, View view) {
        function6.invoke(MessageId.m1084boximpl(message.m238getId3Eiw7ao()), ChannelId.m1058boximpl(message.m235getChannelIdo4g7jtM()), Integer.valueOf(i10), mediaType, null, null);
        return true;
    }
    ...
    public static final void setMessage$lambda$11$lambda$10(Function2 function2, Message message, View view) {
        function2.invoke(MessageId.m1084boximpl(message.m238getId3Eiw7ao()), ChannelId.m1058boximpl(message.m235getChannelIdo4g7jtM()));
    }

    /* JADX INFO: Access modifiers changed from: private */
    public static final boolean setMessage$lambda$13$lambda$12(Function6 function6, Message message, View view) {
        function6.invoke(MessageId.m1084boximpl(message.m238getId3Eiw7ao()), ChannelId.m1058boximpl(message.m235getChannelIdo4g7jtM()), null, null, null, null);
        return true;
    }
    ...
    public static final Unit setMessage$lambda$5(ChatEventHandler chatEventHandler, Message message) {
        ChatEventHandler.DefaultImpls.m489onInitiateReply8a0ehIg$default(chatEventHandler, message.m238getId3Eiw7ao(), message.m235getChannelIdo4g7jtM(), null, null, 12, null);
        return Unit.f32556a;
    }

    /* JADX INFO: Access modifiers changed from: private */
    public static final Unit setMessage$lambda$6(ChatEventHandler chatEventHandler, Message message) {
        chatEventHandler.mo437onInitiateThreadpfaIj0E(message.m238getId3Eiw7ao(), message.m235getChannelIdo4g7jtM());
        return Unit.f32556a;
    }

    /* JADX INFO: Access modifiers changed from: private */
    public static final Unit setMessage$lambda$7(ChatEventHandler chatEventHandler, Message message) {
        chatEventHandler.mo435onInitiateEditpfaIj0E(message.m238getId3Eiw7ao(), message.m235getChannelIdo4g7jtM());
        return Unit.f32556a;
    }

    /* JADX INFO: Access modifiers changed from: private */
    public static final Unit setMessage$lambda$9(ChatEventHandler chatEventHandler, Message message) {
        chatEventHandler.mo468onTapMessageReply0eiqbug(message.m235getChannelIdo4g7jtM(), message.m238getId3Eiw7ao());
        return Unit.f32556a;
    }
    ...
    public final void setMessage(@NotNull final Message message, @NotNull MessageContext messageContext, @NotNull final ChatEventHandler eventHandler, ComponentProvider componentProvider, @NotNull Function0<? extends ChainPart> onChainPart, boolean z10, boolean z11) {
        ...
        bindKey(MessageId.m1084boximpl(message.m238getId3Eiw7ao()));
        String str = this.messageId;
        String m238getId3Eiw7ao = message.m238getId3Eiw7ao();
        if (str == null) {
            m1088equalsimpl0 = false;
        } else {
            m1088equalsimpl0 = MessageId.m1088equalsimpl0(str, m238getId3Eiw7ao);
        }
        this.messageId = message.m238getId3Eiw7ao();
        ...
        if (message.getReferencedMessage() != null) {
            ...
            getReplyPreview().m533configureExecutedCommanddB0bEw(message.m238getId3Eiw7ao(), message.getExecutedCommand(), MessageKt.shouldAnimateEmoji(message), MessageKt.shouldShowLinkDecorations(message), message.getShouldShowRoleDot(), message.getShouldShowRoleOnName(), eventHandler);
        } else if (this.replyPreview != null) {
            getReplyPreview().clear();
        }
        final Function2<MessageId, ChannelId, Unit> mo495getOnMessageTapped = eventHandler.mo495getOnMessageTapped();
        if (mo495getOnMessageTapped != null) {
        ...
        final Function6 mo494getOnMessageLongPressed = eventHandler.mo494getOnMessageLongPressed();
        if (mo494getOnMessageLongPressed != null) {
        ...
        final Function2<MessageId, ChannelId, Unit> mo493getOnMessageDoubleTapped = eventHandler.mo493getOnMessageDoubleTapped();
        if (mo493getOnMessageDoubleTapped != null) {
        ...
        List<MessageAccessory> generateMessageAccessories = generateMessageAccessories(messageMargins, message, messageContext, eventHandler.mo494getOnMessageLongPressed());
        ...
        String m238getId3Eiw7ao2 = message.m238getId3Eiw7ao();
        ...
        messageAccessoriesView.m529setAccessoriesdvvEyHs(messageMargins, m238getId3Eiw7ao2, m235getChannelIdo4g7jtM, m237getGuildIdqOKuAAo, generateMessageAccessories, eventHandler, componentProvider, z12);
        ...
        androidx.core.view.i0.k0(this, new MessageViewAccessibilityDelegate(message, onClickListener, onLongClickListener2));
    }
