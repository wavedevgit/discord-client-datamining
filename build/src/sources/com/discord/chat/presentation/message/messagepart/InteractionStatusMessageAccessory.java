...
public final class InteractionStatusMessageAccessory extends MessageAccessory {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof InteractionStatusMessageAccessory) {
            ...
            return MessageId.m1087equalsimpl0(this.messageId, interactionStatusMessageAccessory.messageId) && Intrinsics.areEqual(this.interactionStatus, interactionStatusMessageAccessory.interactionStatus);
        }
        return false;
    }
    ...
    public int hashCode() {
        return (MessageId.m1088hashCodeimpl(this.messageId) * 31) + this.interactionStatus.hashCode();
    }
    ...
    public String toString() {
        ...
        return "InteractionStatusMessageAccessory(messageId=" + m1090toStringimpl + ", interactionStatus=" + interactionStatus + ")";
    }
