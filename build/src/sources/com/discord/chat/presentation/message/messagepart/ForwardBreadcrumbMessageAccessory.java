...
public final class ForwardBreadcrumbMessageAccessory extends MessageAccessory {
    ...
    public static /* synthetic */ ForwardBreadcrumbMessageAccessory m582copyEqy5D80$default(ForwardBreadcrumbMessageAccessory forwardBreadcrumbMessageAccessory, String str, long j10, ForwardInfo forwardInfo, int i10, Object obj) {
        if ((i10 & 1) != 0) {
        ...
        return forwardBreadcrumbMessageAccessory.m585copyEqy5D80(str, j10, forwardInfo);
    }

    @NotNull
    /* renamed from: component1-3Eiw7ao  reason: not valid java name */
    public final String m583component13Eiw7ao() {
        return this.messageId;
    }

    /* renamed from: component2-o4g7jtM  reason: not valid java name */
    public final long m584component2o4g7jtM() {
    ...
    public final ForwardBreadcrumbMessageAccessory m585copyEqy5D80(@NotNull String messageId, long j10, @NotNull ForwardInfo forwardInfo) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof ForwardBreadcrumbMessageAccessory) {
            ...
            return MessageId.m1088equalsimpl0(this.messageId, forwardBreadcrumbMessageAccessory.messageId) && ChannelId.m1062equalsimpl0(this.channelId, forwardBreadcrumbMessageAccessory.channelId) && Intrinsics.areEqual(this.forwardInfo, forwardBreadcrumbMessageAccessory.forwardInfo);
        }
        return false;
    }

    /* renamed from: getChannelId-o4g7jtM  reason: not valid java name */
    public final long m586getChannelIdo4g7jtM() {
        return this.channelId;
    }
    ...
    public int hashCode() {
        return (((MessageId.m1089hashCodeimpl(this.messageId) * 31) + ChannelId.m1063hashCodeimpl(this.channelId)) * 31) + this.forwardInfo.hashCode();
    }
    ...
    public String toString() {
        ...
        return "ForwardBreadcrumbMessageAccessory(messageId=" + m1091toStringimpl + ", channelId=" + m1065toStringimpl + ", forwardInfo=" + forwardInfo + ")";
    }
