...
public final class SelectComponentView extends ConstraintLayout implements ComponentView<SelectComponent> {
    ...
    public SelectComponentView(@NotNull Context context, AttributeSet attributeSet, int i10) {
        ...
        this.progressDots$delegate = as.l.b(new Function0() { // from class: com.discord.chat.presentation.message.view.botuikit.components.k
            @Override // kotlin.jvm.functions.Function0
            public final Object invoke() {
        ...
        this.postProcessor$delegate = as.l.b(new Function0() { // from class: com.discord.chat.presentation.message.view.botuikit.components.l
            @Override // kotlin.jvm.functions.Function0
            public final Object invoke() {
