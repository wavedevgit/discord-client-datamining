...
public final class SelectComponentView extends ConstraintLayout implements ComponentView<SelectComponent> {
    ...
    private final void setImage(SimpleDraweeSpanTextView simpleDraweeSpanTextView, String str, Integer num, boolean z10) {
        ...
        GenericDraweeHierarchyBuilder w10 = GenericDraweeHierarchyBuilder.u(getContext().getResources()).w(ScalingUtils$ScaleType.f9918e);
    ...
    public SelectComponentView(@NotNull Context context, AttributeSet attributeSet, int i10) {
        ...
        this.progressDots$delegate = qr.l.a(new Function0() { // from class: com.discord.chat.presentation.message.view.botuikit.components.k
            @Override // kotlin.jvm.functions.Function0
            public final Object invoke() {
        ...
        this.postProcessor$delegate = qr.l.a(new Function0() { // from class: com.discord.chat.presentation.message.view.botuikit.components.l
            @Override // kotlin.jvm.functions.Function0
            public final Object invoke() {
