...
public final class BlockedGroupChatListItem extends ChatListItem {
    ...
    public static /* synthetic */ BlockedGroupChatListItem copy$default(BlockedGroupChatListItem blockedGroupChatListItem, String str, String str2, int i10, int i11, int i12, boolean z10, List list, int i13, Object obj) {
        ...
        if ((i13 & 2) != 0) {
            str2 = blockedGroupChatListItem.f8744id;
        }
        if ((i13 & 4) != 0) {
    ...
    public int hashCode() {
        return (((((((((((this.text.hashCode() * 31) + this.f8744id.hashCode()) * 31) + Integer.hashCode(this.textColor)) * 31) + Integer.hashCode(this.backgroundColor)) * 31) + Integer.hashCode(this.borderColor)) * 31) + Boolean.hashCode(this.isRevealed)) * 31) + this.content.hashCode();
    }
