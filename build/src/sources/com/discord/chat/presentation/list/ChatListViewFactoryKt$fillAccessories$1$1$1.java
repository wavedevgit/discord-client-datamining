...
final class ChatListViewFactoryKt$fillAccessories$1$1$1 extends kotlin.coroutines.jvm.internal.k implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        if (i10 != 0) {
            ...
            this.label = 1;
            if (ys.g.g(c10, anonymousClass2, this) == f10) {
                return f10;
            }
        }
        return Unit.f31987a;
    ...
    @Override // kotlin.jvm.functions.Function2
    public final Object invoke(CoroutineScope coroutineScope, Continuation<? super Unit> continuation) {
        return ((ChatListViewFactoryKt$fillAccessories$1$1$1) create(coroutineScope, continuation)).invokeSuspend(Unit.f31987a);
    }
}
