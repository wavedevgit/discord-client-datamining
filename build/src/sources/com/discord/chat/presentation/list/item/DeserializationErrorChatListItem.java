...
public final class DeserializationErrorChatListItem extends ChatListItem {
    ...
    public static /* synthetic */ DeserializationErrorChatListItem copy$default(DeserializationErrorChatListItem deserializationErrorChatListItem, String str, String str2, String str3, int i10, Object obj) {
        if ((i10 & 1) != 0) {
            str = deserializationErrorChatListItem.f8746id;
        }
        if ((i10 & 2) != 0) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof DeserializationErrorChatListItem) {
            ...
            return Intrinsics.areEqual(this.f8746id, deserializationErrorChatListItem.f8746id) && Intrinsics.areEqual(this.json, deserializationErrorChatListItem.json) && Intrinsics.areEqual(this.causeMessage, deserializationErrorChatListItem.causeMessage);
        }
        return false;
    }
    ...
    public int hashCode() {
        return (((this.f8746id.hashCode() * 31) + this.json.hashCode()) * 31) + this.causeMessage.hashCode();
    }

    @NotNull
    public String toString() {
        String str = this.f8746id;
