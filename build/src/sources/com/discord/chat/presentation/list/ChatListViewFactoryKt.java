...
public final class ChatListViewFactoryKt {
    @NotNull
    private static final Map<Integer, Integer> accessoriesToCreate = o0.m(qr.v.a(0, 25), qr.v.a(4, 15), qr.v.a(1, 6), qr.v.a(12, 10), qr.v.a(26, 5), qr.v.a(50, 5), qr.v.a(49, 20));
    @NotNull
    private static final Map<? extends Class<? extends BaseChatListItemDelegate<? extends ChatListItem, ?>>, Integer> recycledViewPoolSizes = o0.m(qr.v.a(RegularMessageDelegate.class, 40), qr.v.a(SeparatorDelegate.class, 10));
    ...
    public static final void fillAccessories(@NotNull RecyclerView recycler, @NotNull MessageAccessoriesAdapter accessoriesAdapter, @NotNull RecyclerView.RecycledViewPool accessoriesViewPool) {
        ...
        os.i.d(CoroutineViewUtilsKt.attachedScope(recycler, false), m0.a(), null, new ChatListViewFactoryKt$fillAccessories$1(accessoriesAdapter, recycler, accessoriesViewPool, null), 2, null);
    }
    ...
    public static final void fillChatList(@NotNull RecyclerView recycler, @NotNull BaseChatListAdapter chatListAdapter, @NotNull Map<Class<? extends BaseChatListItemDelegate<? extends ChatListItem, ? extends View>>, Integer> delegateViewTypes, @NotNull RecyclerView.RecycledViewPool chatListViewPool) {
        ...
        os.i.d(CoroutineViewUtilsKt.attachedScope(recycler, false), m0.a(), null, new ChatListViewFactoryKt$fillChatList$1(delegateViewTypes, chatListAdapter, recycler, chatListViewPool, null), 2, null);
    }
}
