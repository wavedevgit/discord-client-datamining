...
public final class ChatListViewFactoryKt$fillAccessories$1 extends kotlin.coroutines.jvm.internal.k implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        while (it.hasNext()) {
            ...
            this.L$3 = it;
            this.label = 1;
            if (os.g.g(c10, chatListViewFactoryKt$fillAccessories$1$1$1, this) == f10) {
                return f10;
            }
        }
        return Unit.f32056a;
    ...
    public final Object invoke(CoroutineScope coroutineScope, Continuation<? super Unit> continuation) {
        return ((ChatListViewFactoryKt$fillAccessories$1) create(coroutineScope, continuation)).invokeSuspend(Unit.f32056a);
    }
}
