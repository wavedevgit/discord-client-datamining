...
public final class ChatListView extends RecyclerView {
                ...
                public final void m495invoke() {
                    ...
                    if (action instanceof ChatListAction.ScrollTo) {
                        ...
                        if (chatListItem instanceof SeparatorChatListItem) {
                            top = new Scroller.TargetAlignment.Top(SizeUtilsKt.getDpToPx(4));
    ...
    private final void sync() {
        ...
        this.updateSubscriptionJob = gs.g.d(CoroutineViewUtilsKt.attachedScope(this, true), null, null, new ChatListView$sync$1(this, null), 3, null);
    }
