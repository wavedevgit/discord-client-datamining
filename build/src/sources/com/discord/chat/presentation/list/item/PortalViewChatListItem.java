...
public final class PortalViewChatListItem extends ChatListItem {
    ...
    public static /* synthetic */ PortalViewChatListItem copy$default(PortalViewChatListItem portalViewChatListItem, String str, View view, Pair pair, int i10, Object obj) {
        if ((i10 & 1) != 0) {
            str = portalViewChatListItem.f8607id;
        }
        if ((i10 & 2) != 0) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof PortalViewChatListItem) {
            ...
            return Intrinsics.areEqual(this.f8607id, portalViewChatListItem.f8607id) && Intrinsics.areEqual(this.view, portalViewChatListItem.view) && Intrinsics.areEqual(this.measuredDimensions, portalViewChatListItem.measuredDimensions);
        }
        return false;
    }
    ...
    public int hashCode() {
        int hashCode = ((this.f8607id.hashCode() * 31) + this.view.hashCode()) * 31;
