...
public class ChatListItemTouchHelper extends RecyclerView.ItemDecoration implements RecyclerView.OnChildAttachStateChangeListener {
    ...
    public void attachToRecyclerView(RecyclerView recyclerView) {
        ...
        if (recyclerView2 != recyclerView) {
            ...
            if (recyclerView != null) {
                ...
                this.mSwipeEscapeVelocity = resources.getDimension(q3.b.f46427f);
                this.mMaxSwipeVelocity = resources.getDimension(q3.b.f46426e);
                setupCallbacks();
            }
        }
    }
    ...
    */
    ...
    /* JADX WARN: Code restructure failed: missing block: B:40:0x009f, code lost:
        if (r19.mCallback.shouldUseSpringyExit() != false) goto L31;
     */
    /*
        Code decompiled incorrectly, please refer to instructions dump.
        To view partially-correct add '--show-bad-code' argument
    */
    void select(androidx.recyclerview.widget.RecyclerView.ViewHolder r20, int r21) {
        /*
            Method dump skipped, instructions count: 302
            To view this dump add '--comments-level debug' option
        */
        throw new UnsupportedOperationException("Method not decompiled: com.discord.chat.presentation.list.ChatListItemTouchHelper.select(androidx.recyclerview.widget.RecyclerView$ViewHolder, int):void");
    }
