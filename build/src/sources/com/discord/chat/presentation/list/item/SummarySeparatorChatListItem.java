...
public final class SummarySeparatorChatListItem extends ChatListItem {
    ...
    */
    ...
    public final String m499getCurrentMsgId3Eiw7ao() {
        if (this.isBeforeContent) {
            return this.summary.m432getStartId3Eiw7ao();
        }
        return this.summary.m431getEndId3Eiw7ao();
    }

    @NotNull
    /* renamed from: getJumpToMsgId-3Eiw7ao  reason: not valid java name */
    public final String m500getJumpToMsgId3Eiw7ao() {
        if (this.isBeforeContent) {
            return this.summary.m431getEndId3Eiw7ao();
        }
        return this.summary.m432getStartId3Eiw7ao();
