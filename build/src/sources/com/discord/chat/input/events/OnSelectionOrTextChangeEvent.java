...
public final class OnSelectionOrTextChangeEvent implements ReactEvent {
    ...
    public static final /* synthetic */ void write$Self$chat_input_release(OnSelectionOrTextChangeEvent onSelectionOrTextChangeEvent, CompositeEncoder compositeEncoder, SerialDescriptor serialDescriptor) {
        compositeEncoder.v(serialDescriptor, 0, onSelectionOrTextChangeEvent.start);
        compositeEncoder.v(serialDescriptor, 1, onSelectionOrTextChangeEvent.end);
        compositeEncoder.x(serialDescriptor, 2, onSelectionOrTextChangeEvent.text);
        compositeEncoder.x(serialDescriptor, 3, onSelectionOrTextChangeEvent.editId);
    }
