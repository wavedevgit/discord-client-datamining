...
public final class OnSelectionOrTextChangeEvent implements ReactEvent {
    ...
    public static final /* synthetic */ void write$Self$chat_input_release(OnSelectionOrTextChangeEvent onSelectionOrTextChangeEvent, CompositeEncoder compositeEncoder, SerialDescriptor serialDescriptor) {
        compositeEncoder.w(serialDescriptor, 0, onSelectionOrTextChangeEvent.start);
        compositeEncoder.w(serialDescriptor, 1, onSelectionOrTextChangeEvent.end);
        compositeEncoder.y(serialDescriptor, 2, onSelectionOrTextChangeEvent.text);
        compositeEncoder.y(serialDescriptor, 3, onSelectionOrTextChangeEvent.editId);
    }
