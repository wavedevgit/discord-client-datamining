...
public final class OnFocusEvent implements ReactEvent {
    ...
    public static final /* synthetic */ void write$Self$chat_input_release(OnFocusEvent onFocusEvent, CompositeEncoder compositeEncoder, SerialDescriptor serialDescriptor) {
        compositeEncoder.v(serialDescriptor, 0, onFocusEvent.start);
        compositeEncoder.v(serialDescriptor, 1, onFocusEvent.end);
        if (compositeEncoder.z(serialDescriptor, 2) || onFocusEvent.target != 0) {
            compositeEncoder.v(serialDescriptor, 2, onFocusEvent.target);
        }
    }
