...
public final class ChatInputNodeStyle {
    ...
    @NotNull
    private static final Lazy[] $childSerializers = {null, null, null, l.b(o.f49210e, new Function0() { // from class: r6.b
    ...
    public static final /* synthetic */ void write$Self$chat_input_release(ChatInputNodeStyle chatInputNodeStyle, CompositeEncoder compositeEncoder, SerialDescriptor serialDescriptor) {
        ...
        if (compositeEncoder.z(serialDescriptor, 0) || chatInputNodeStyle.fontSize != null) {
            compositeEncoder.i(serialDescriptor, 0, p0.f35197a, chatInputNodeStyle.fontSize);
        }
        compositeEncoder.w(serialDescriptor, 1, chatInputNodeStyle.color);
        compositeEncoder.i(serialDescriptor, 2, BackgroundStyle$$serializer.INSTANCE, chatInputNodeStyle.backgroundStyle);
        if (compositeEncoder.z(serialDescriptor, 3) || chatInputNodeStyle.fontWeight != null) {
            compositeEncoder.i(serialDescriptor, 3, (gt.o) lazyArr[3].getValue(), chatInputNodeStyle.fontWeight);
        }
    }
