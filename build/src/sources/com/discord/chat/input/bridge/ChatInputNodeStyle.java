...
public final class ChatInputNodeStyle {
    ...
    @NotNull
    private static final Lazy[] $childSerializers = {null, null, null, l.b(o.f44232e, new Function0() { // from class: q6.b
    ...
    public static final /* synthetic */ void write$Self$chat_input_release(ChatInputNodeStyle chatInputNodeStyle, CompositeEncoder compositeEncoder, SerialDescriptor serialDescriptor) {
        ...
        if (compositeEncoder.z(serialDescriptor, 0) || chatInputNodeStyle.fontSize != null) {
            compositeEncoder.A(serialDescriptor, 0, p0.f25318a, chatInputNodeStyle.fontSize);
        }
        compositeEncoder.v(serialDescriptor, 1, chatInputNodeStyle.color);
        compositeEncoder.A(serialDescriptor, 2, BackgroundStyle$$serializer.INSTANCE, chatInputNodeStyle.backgroundStyle);
        if (compositeEncoder.z(serialDescriptor, 3) || chatInputNodeStyle.fontWeight != null) {
            compositeEncoder.A(serialDescriptor, 3, (dt.o) lazyArr[3].getValue(), chatInputNodeStyle.fontWeight);
        }
    }
