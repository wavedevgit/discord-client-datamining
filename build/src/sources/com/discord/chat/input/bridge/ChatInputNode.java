...
public final class ChatInputNode {
    ...
    public static final /* synthetic */ void write$Self$chat_input_release(ChatInputNode chatInputNode, CompositeEncoder compositeEncoder, SerialDescriptor serialDescriptor) {
        ...
        if (compositeEncoder.y(serialDescriptor, 3) || chatInputNode.style != null) {
            compositeEncoder.B(serialDescriptor, 3, ChatInputNodeStyle$$serializer.INSTANCE, chatInputNode.style);
        }
        if (compositeEncoder.y(serialDescriptor, 4) || chatInputNode.deleteNodeOnBackspace) {
            compositeEncoder.w(serialDescriptor, 4, chatInputNode.deleteNodeOnBackspace);
        }
        if (compositeEncoder.y(serialDescriptor, 5) || chatInputNode.tapAction != null) {
            compositeEncoder.B(serialDescriptor, 5, TapAction$$serializer.INSTANCE, chatInputNode.tapAction);
        }
        if (compositeEncoder.y(serialDescriptor, 6) || chatInputNode.editDisabled) {
