...
public final class ChatInputNode {
    ...
    public static final /* synthetic */ void write$Self$chat_input_release(ChatInputNode chatInputNode, CompositeEncoder compositeEncoder, SerialDescriptor serialDescriptor) {
        compositeEncoder.x(serialDescriptor, 0, chatInputNode.type);
        compositeEncoder.x(serialDescriptor, 1, chatInputNode.location);
        compositeEncoder.x(serialDescriptor, 2, chatInputNode.length);
        if (compositeEncoder.A(serialDescriptor, 3) || chatInputNode.style != null) {
            compositeEncoder.l(serialDescriptor, 3, ChatInputNodeStyle$$serializer.INSTANCE, chatInputNode.style);
        }
        if (compositeEncoder.A(serialDescriptor, 4) || chatInputNode.deleteNodeOnBackspace) {
            compositeEncoder.y(serialDescriptor, 4, chatInputNode.deleteNodeOnBackspace);
        }
        if (compositeEncoder.A(serialDescriptor, 5) || chatInputNode.tapAction != null) {
            compositeEncoder.l(serialDescriptor, 5, TapAction$$serializer.INSTANCE, chatInputNode.tapAction);
        }
        if (compositeEncoder.A(serialDescriptor, 6) || chatInputNode.editDisabled) {
            compositeEncoder.y(serialDescriptor, 6, chatInputNode.editDisabled);
        }
    }
