...
public final class ChatInputRootView extends RelativeLayout implements KeyboardEvent {
    ...
    protected void onAttachedToWindow() {
        ...
        ss.g.y(ss.g.C(ss.g.k(this.currentTextFlow, 100L), new ChatInputRootView$onAttachedToWindow$1(this, null)), CoroutineViewUtilsKt.getAttachedScope(this));
        ss.g.y(ss.g.C(ss.g.k(this.currentLayoutFlow, 32L), new ChatInputRootView$onAttachedToWindow$2(this, null)), CoroutineViewUtilsKt.getAttachedScope(this));
    }
    ...
    public void onKeyboardStateChanged(boolean z10) {
        ...
        if (!z10) {
            d10 = ps.i.d(CoroutineViewUtilsKt.getAttachedScope(this), null, null, new ChatInputRootView$onKeyboardStateChanged$1(this, null), 3, null);
            this.blurJob = d10;
        }
    }
