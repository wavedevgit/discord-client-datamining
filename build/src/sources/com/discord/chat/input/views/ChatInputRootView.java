...
public final class ChatInputRootView extends RelativeLayout implements KeyboardEvent {
    ...
    protected void onAttachedToWindow() {
        ...
        bt.g.y(bt.g.C(bt.g.k(this.currentTextFlow, 100L), new ChatInputRootView$onAttachedToWindow$1(this, null)), CoroutineViewUtilsKt.getAttachedScope(this));
        bt.g.y(bt.g.C(bt.g.k(this.currentLayoutFlow, 32L), new ChatInputRootView$onAttachedToWindow$2(this, null)), CoroutineViewUtilsKt.getAttachedScope(this));
    }
    ...
    public void onKeyboardStateChanged(boolean z10) {
        ...
        if (!z10) {
            d10 = ys.i.d(CoroutineViewUtilsKt.getAttachedScope(this), null, null, new ChatInputRootView$onKeyboardStateChanged$1(this, null), 3, null);
            this.blurJob = d10;
        }
    }
    ...
    public ChatInputRootView(@NotNull final Context context, AttributeSet attributeSet, int i10) {
        ...
        i0.y0(chatInputEditText, new String[]{"image/*"}, new x() { // from class: com.discord.chat.input.views.e
