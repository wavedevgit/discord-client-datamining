...
final class ChatInputRootView$onKeyboardStateChanged$1 extends kotlin.coroutines.jvm.internal.k implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
    int label;
    final /* synthetic */ ChatInputRootView this$0;

    /* JADX INFO: Access modifiers changed from: package-private */
    @Metadata(d1 = {"\u0000\n\n\u0000\n\u0002\u0010\u0002\n\u0002\u0018\u0002\u0010\u0000\u001a\u00020\u0001*\u00020\u0002H\n"}, d2 = {"<anonymous>", "", "Lkotlinx/coroutines/CoroutineScope;"}, k = 3, mv = {2, 1, 0}, xi = 48)
    @kotlin.coroutines.jvm.internal.e(c = "com.discord.chat.input.views.ChatInputRootView$onKeyboardStateChanged$1$1", f = "ChatInputRootView.kt", l = {347}, m = "invokeSuspend")
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        if (!ChatInputRootViewKt.isScreenReaderOn(context)) {
            dCDChatInput = this.this$0.editText;
            dCDChatInput.clearFocus();
            ChatInputRootView.ChatInputListener listener = this.this$0.getListener();
            if (listener != null) {
                dCDChatInput2 = this.this$0.editText;
    ...
    @Override // kotlin.jvm.functions.Function2
    public final Object invoke(CoroutineScope coroutineScope, Continuation<? super Unit> continuation) {
        return ((ChatInputRootView$onKeyboardStateChanged$1) create(coroutineScope, continuation)).invokeSuspend(Unit.f33074a);
    }
}
