...
public final class Truncation {
    ...
    public static final /* synthetic */ void write$Self$chat_release(Truncation truncation, CompositeEncoder compositeEncoder, SerialDescriptor serialDescriptor) {
        compositeEncoder.w(serialDescriptor, 0, truncation.numberOfLines);
        compositeEncoder.x(serialDescriptor, 1, truncation.expandable);
        if (compositeEncoder.z(serialDescriptor, 2) || truncation.seeMoreLabel != null) {
            compositeEncoder.s(serialDescriptor, 2, n2.f20978a, truncation.seeMoreLabel);
        }
        if (compositeEncoder.z(serialDescriptor, 3) || truncation.seeMoreLabelColor != null) {
            compositeEncoder.s(serialDescriptor, 3, p0.f20994a, truncation.seeMoreLabelColor);
        }
    }
