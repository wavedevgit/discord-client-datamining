...
public final class PremiumGroupInviteEmbed {
    ...
    public static final /* synthetic */ void write$Self$chat_release(PremiumGroupInviteEmbed premiumGroupInviteEmbed, CompositeEncoder compositeEncoder, SerialDescriptor serialDescriptor) {
        compositeEncoder.z(serialDescriptor, 0, premiumGroupInviteEmbed.headerText);
        compositeEncoder.x(serialDescriptor, 1, premiumGroupInviteEmbed.headerColor);
        compositeEncoder.x(serialDescriptor, 2, premiumGroupInviteEmbed.backgroundColor);
        compositeEncoder.x(serialDescriptor, 3, premiumGroupInviteEmbed.borderColor);
        compositeEncoder.z(serialDescriptor, 4, premiumGroupInviteEmbed.headerImageUrl);
        compositeEncoder.z(serialDescriptor, 5, premiumGroupInviteEmbed.betaPillText);
        compositeEncoder.x(serialDescriptor, 6, premiumGroupInviteEmbed.betaPillTextColor);
        compositeEncoder.x(serialDescriptor, 7, premiumGroupInviteEmbed.betaPillBackgroundColor);
        compositeEncoder.z(serialDescriptor, 8, premiumGroupInviteEmbed.bodyText);
        compositeEncoder.x(serialDescriptor, 9, premiumGroupInviteEmbed.bodyTextColor);
        compositeEncoder.s(serialDescriptor, 10, AnnotatedStructurableTextSerializer.INSTANCE, premiumGroupInviteEmbed.learnMoreLink);
    }
