...
public final class SafetyPolicyNoticeEmbed {
    ...
    public static final /* synthetic */ void write$Self$chat_release(SafetyPolicyNoticeEmbed safetyPolicyNoticeEmbed, CompositeEncoder compositeEncoder, SerialDescriptor serialDescriptor) {
        compositeEncoder.y(serialDescriptor, 0, safetyPolicyNoticeEmbed.classificationId);
        compositeEncoder.y(serialDescriptor, 1, safetyPolicyNoticeEmbed.titleText);
        compositeEncoder.y(serialDescriptor, 2, safetyPolicyNoticeEmbed.titleIcon);
        compositeEncoder.y(serialDescriptor, 3, safetyPolicyNoticeEmbed.subtitleText);
        compositeEncoder.y(serialDescriptor, 4, safetyPolicyNoticeEmbed.descriptionText);
        compositeEncoder.y(serialDescriptor, 5, safetyPolicyNoticeEmbed.ctaText);
    }
