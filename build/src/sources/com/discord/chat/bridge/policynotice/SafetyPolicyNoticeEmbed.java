...
public final class SafetyPolicyNoticeEmbed {
    ...
    public static final /* synthetic */ void write$Self$chat_release(SafetyPolicyNoticeEmbed safetyPolicyNoticeEmbed, CompositeEncoder compositeEncoder, SerialDescriptor serialDescriptor) {
        compositeEncoder.z(serialDescriptor, 0, safetyPolicyNoticeEmbed.classificationId);
        compositeEncoder.z(serialDescriptor, 1, safetyPolicyNoticeEmbed.titleText);
        compositeEncoder.z(serialDescriptor, 2, safetyPolicyNoticeEmbed.titleIcon);
        compositeEncoder.z(serialDescriptor, 3, safetyPolicyNoticeEmbed.subtitleText);
        compositeEncoder.z(serialDescriptor, 4, safetyPolicyNoticeEmbed.descriptionText);
        compositeEncoder.z(serialDescriptor, 5, safetyPolicyNoticeEmbed.ctaText);
    }
