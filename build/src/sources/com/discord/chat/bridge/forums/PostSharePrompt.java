...
public final class PostSharePrompt {
    ...
    public static final /* synthetic */ void write$Self$chat_release(PostSharePrompt postSharePrompt, CompositeEncoder compositeEncoder, SerialDescriptor serialDescriptor) {
        compositeEncoder.y(serialDescriptor, 0, postSharePrompt.title);
        compositeEncoder.j(serialDescriptor, 1, StructurableTextSerializer.INSTANCE, postSharePrompt.subtitle);
        compositeEncoder.y(serialDescriptor, 2, postSharePrompt.cta);
        compositeEncoder.y(serialDescriptor, 3, postSharePrompt.icon);
        compositeEncoder.y(serialDescriptor, 4, postSharePrompt.closeIcon);
    }
