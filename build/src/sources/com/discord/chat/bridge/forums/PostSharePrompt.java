...
public final class PostSharePrompt {
    ...
    public static final /* synthetic */ void write$Self$chat_release(PostSharePrompt postSharePrompt, CompositeEncoder compositeEncoder, SerialDescriptor serialDescriptor) {
        compositeEncoder.z(serialDescriptor, 0, postSharePrompt.title);
        compositeEncoder.s(serialDescriptor, 1, StructurableTextSerializer.INSTANCE, postSharePrompt.subtitle);
        compositeEncoder.z(serialDescriptor, 2, postSharePrompt.cta);
        compositeEncoder.z(serialDescriptor, 3, postSharePrompt.icon);
        compositeEncoder.z(serialDescriptor, 4, postSharePrompt.closeIcon);
    }
