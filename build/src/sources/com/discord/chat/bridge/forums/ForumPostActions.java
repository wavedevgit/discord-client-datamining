...
public final class ForumPostActions {
    ...
    public static final /* synthetic */ void write$Self$chat_release(ForumPostActions forumPostActions, CompositeEncoder compositeEncoder, SerialDescriptor serialDescriptor) {
        ...
        if (compositeEncoder.A(serialDescriptor, 2) || forumPostActions.followIcon != null) {
            compositeEncoder.z(serialDescriptor, 2, n2.f6848a, forumPostActions.followIcon);
        }
        ...
        if (compositeEncoder.A(serialDescriptor, 4) || forumPostActions.shareIcon != null) {
            compositeEncoder.z(serialDescriptor, 4, n2.f6848a, forumPostActions.shareIcon);
        }
        ...
        if (compositeEncoder.A(serialDescriptor, 6) || forumPostActions.defaultReaction != null) {
            compositeEncoder.z(serialDescriptor, 6, MessageReaction$$serializer.INSTANCE, forumPostActions.defaultReaction);
        }
        if (compositeEncoder.A(serialDescriptor, 7) || forumPostActions.sharePrompt != null) {
            compositeEncoder.z(serialDescriptor, 7, PostSharePrompt$$serializer.INSTANCE, forumPostActions.sharePrompt);
        }
    }
