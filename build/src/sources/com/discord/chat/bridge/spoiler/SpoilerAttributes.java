...
public final class SpoilerAttributes {
    ...
    public static final class Companion {
        ...
        private final SpoilerAttributes forItem(SpoilerableData spoilerableData, String str, String str2, Boolean bool) {
            ...
            if (obscureOrNull != null) {
                return new SpoilerAttributes(SpoilerIdentifier.m414constructorimpl("obscure:containerId(" + str + "):" + str2), new Function1() { // from class: com.discord.chat.bridge.spoiler.c
            ...
            if (spoilerOrNull != null) {
                return new SpoilerAttributes(SpoilerIdentifier.m414constructorimpl("spoiler:containerId(" + str + "):" + str2), new Function1() { // from class: com.discord.chat.bridge.spoiler.e
                    @Override // kotlin.jvm.functions.Function1
                    public final Object invoke(Object obj) {
        ...
        public final SpoilerAttributes forAttachment(@NotNull Attachment attachment, @NotNull Message message, int i10, Boolean bool) {
            ...
            return forItem(attachment, "messageId(" + MessageId.m1091toStringimpl(message.m238getId3Eiw7ao()) + ")", attachment.type().getIndexLabel() + "(" + i10 + ")", bool);
        }
        ...
        public final SpoilerAttributes forEmbed(@NotNull Embed embed, @NotNull Message message, int i10, Boolean bool) {
            ...
            Intrinsics.checkNotNullParameter(message, "message");
            return forItem(embed, "messageId(" + MessageId.m1091toStringimpl(message.m238getId3Eiw7ao()) + ")", "embedIndex(" + i10 + ")", bool);
        }
        ...
        public final SpoilerAttributes forMediaPostPreviewEmbed(@NotNull PostPreviewEmbed embed, @NotNull Message message, int i10, Boolean bool) {
            Intrinsics.checkNotNullParameter(embed, "embed");
            Intrinsics.checkNotNullParameter(message, "message");
            return forItem(embed, "messageId(" + MessageId.m1091toStringimpl(message.m238getId3Eiw7ao()) + ")", "mediaPostPreviewEmbed(" + i10 + ")", bool);
        }
    ...
    public static /* synthetic */ SpoilerAttributes m407copy5Uv3usY$default(SpoilerAttributes spoilerAttributes, String str, Function1 function1, Function1 function12, SpoilerType spoilerType, Boolean bool, int i10, Object obj) {
        if ((i10 & 1) != 0) {
        ...
        return spoilerAttributes.m409copy5Uv3usY(str, function13, function15, spoilerType, bool2);
    }

    private final boolean hasSpoilerConfig() {
        if (!SpoilerManager.INSTANCE.m421isNotRevealedV2PEE7g(this.identifier) && this.type != SpoilerType.OBSCURE) {
            return false;
        }
        return true;
    }
    ...
    public final String m408component1Bq9X6Gg() {
    ...
    public final SpoilerConfig configure(@NotNull final Function0<Unit> onTapSpoiler, @NotNull Function1<? super Boolean, Unit> onTapObscureToggle) {
        ...
        return new SpoilerConfig(spoilerAttributes, onTapObscureToggle, new Function1<SpoilerIdentifier, Unit>() { // from class: com.discord.chat.bridge.spoiler.SpoilerAttributes$configure$4$1
            ...
            public /* bridge */ /* synthetic */ Object invoke(Object obj) {
                m411invokeV2PEE7g(((SpoilerIdentifier) obj).m419unboximpl());
                return Unit.f32556a;
            }
            ...
            public final void m412invokeV2PEE7g(String spoilerId) {
                Intrinsics.checkNotNullParameter(spoilerId, "spoilerId");
                SpoilerManager.INSTANCE.m423markHiddenV2PEE7g(spoilerId);
                onTapSpoiler.invoke();
            }
        });
    }
    ...
    public final SpoilerAttributes m409copy5Uv3usY(@NotNull String identifier, @NotNull Function1<? super Context, String> label, @NotNull Function1<? super Context, String> description, @NotNull SpoilerType type, Boolean bool) {
    ...
    public final String m410getIdentifierBq9X6Gg() {
        return this.identifier;
    }
    ...
    public int hashCode() {
        int m417hashCodeimpl = ((((((SpoilerIdentifier.m417hashCodeimpl(this.identifier) * 31) + this.label.hashCode()) * 31) + this.description.hashCode()) * 31) + this.type.hashCode()) * 31;
        Boolean bool = this.verifyAge;
        return m417hashCodeimpl + (bool == null ? 0 : bool.hashCode());
    }

    @NotNull
    public String toString() {
        String m418toStringimpl = SpoilerIdentifier.m418toStringimpl(this.identifier);
        ...
        Boolean bool = this.verifyAge;
        return "SpoilerAttributes(identifier=" + m418toStringimpl + ", label=" + function1 + ", description=" + function12 + ", type=" + spoilerType + ", verifyAge=" + bool + ")";
    }
