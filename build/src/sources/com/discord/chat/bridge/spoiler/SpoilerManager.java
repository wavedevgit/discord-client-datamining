...
public final class SpoilerManager {
    ...
    public final boolean m421isNotRevealedV2PEE7g(@NotNull String id2) {
        Intrinsics.checkNotNullParameter(id2, "id");
        return !m422isRevealedV2PEE7g(id2);
    }

    /* renamed from: isRevealed-V2PEE7g  reason: not valid java name */
    public final boolean m422isRevealedV2PEE7g(@NotNull String id2) {
        Intrinsics.checkNotNullParameter(id2, "id");
        return revealedSpoilers.contains(SpoilerIdentifier.m413boximpl(id2));
    }

    /* renamed from: markHidden-V2PEE7g  reason: not valid java name */
    public final void m423markHiddenV2PEE7g(@NotNull String id2) {
        Intrinsics.checkNotNullParameter(id2, "id");
        revealedSpoilers.remove(SpoilerIdentifier.m413boximpl(id2));
    }

    /* renamed from: markRevealed-V2PEE7g  reason: not valid java name */
    public final void m424markRevealedV2PEE7g(@NotNull String id2) {
        Intrinsics.checkNotNullParameter(id2, "id");
        revealedSpoilers.add(SpoilerIdentifier.m413boximpl(id2));
    }
