...
public final class SpoilerIdentifier {
    ...
    public static final class Companion {
        ...
        public final String m420forNode2sfwrmE(@NotNull SpoilerContentNode node, @NotNull String containerId, int i10) {
            Intrinsics.checkNotNullParameter(node, "node");
            Intrinsics.checkNotNullParameter(containerId, "containerId");
            int hashCode = node.hashCode();
            return SpoilerIdentifier.m414constructorimpl("spoiler:" + hashCode + ":" + containerId + ":" + i10);
        }
    ...
    public static final /* synthetic */ SpoilerIdentifier m413boximpl(String str) {
        return new SpoilerIdentifier(str);
    }

    @NotNull
    /* renamed from: constructor-impl  reason: not valid java name */
    public static String m414constructorimpl(@NotNull String id2) {
        Intrinsics.checkNotNullParameter(id2, "id");
        return id2;
    }

    /* renamed from: equals-impl  reason: not valid java name */
    public static boolean m415equalsimpl(String str, Object obj) {
        return (obj instanceof SpoilerIdentifier) && Intrinsics.areEqual(str, ((SpoilerIdentifier) obj).m419unboximpl());
    }

    /* renamed from: equals-impl0  reason: not valid java name */
    public static final boolean m416equalsimpl0(String str, String str2) {
        return Intrinsics.areEqual(str, str2);
    }

    /* renamed from: hashCode-impl  reason: not valid java name */
    public static int m417hashCodeimpl(String str) {
        return str.hashCode();
    }

    /* renamed from: toString-impl  reason: not valid java name */
    public static String m418toStringimpl(String str) {
        return "SpoilerIdentifier(id=" + str + ")";
    }

    public boolean equals(Object obj) {
        return m415equalsimpl(this.f9276id, obj);
    }
    ...
    public int hashCode() {
        return m417hashCodeimpl(this.f9276id);
    }

    public String toString() {
        return m418toStringimpl(this.f9276id);
    }

    /* renamed from: unbox-impl  reason: not valid java name */
    public final /* synthetic */ String m419unboximpl() {
        return this.f9276id;
    }
}
