...
public final class ActivityInstanceEmbed {
    ...
    @NotNull
    private static final Lazy[] $childSerializers = {null, null, l.a(o.f6082e, new Function0() { // from class: l6.a
    ...
    public static /* synthetic */ ActivityInstanceEmbed m240copyNxq1Yvc$default(ActivityInstanceEmbed activityInstanceEmbed, long j10, String str, List list, AppMessageEmbedImpl appMessageEmbedImpl, String str2, int i10, Object obj) {
        if ((i10 & 1) != 0) {
        ...
        return activityInstanceEmbed.m242copyNxq1Yvc(j11, str3, list3, appMessageEmbedImpl2, str2);
    }
    ...
    public static final /* synthetic */ void write$Self$chat_release(ActivityInstanceEmbed activityInstanceEmbed, CompositeEncoder compositeEncoder, SerialDescriptor serialDescriptor) {
        ...
        compositeEncoder.k(serialDescriptor, 0, ApplicationId$$serializer.INSTANCE, ApplicationId.m1045boximpl(activityInstanceEmbed.applicationId));
        ...
        if (compositeEncoder.z(serialDescriptor, 2) || activityInstanceEmbed.participantAvatarUris != null) {
            compositeEncoder.o(serialDescriptor, 2, (qt.o) lazyArr[2].getValue(), activityInstanceEmbed.participantAvatarUris);
        }
        ...
        if (compositeEncoder.z(serialDescriptor, 4) || activityInstanceEmbed.participantsDescription != null) {
            compositeEncoder.o(serialDescriptor, 4, n2.f50601a, activityInstanceEmbed.participantsDescription);
        }
    }

    /* renamed from: component1-VavddsQ  reason: not valid java name */
    public final long m241component1VavddsQ() {
    ...
    public final ActivityInstanceEmbed m242copyNxq1Yvc(long j10, @NotNull String instanceId, List<String> list, @NotNull AppMessageEmbedImpl appMessageEmbedModel, String str) {
    ...
    public final long m243getApplicationIdVavddsQ() {
        return this.applicationId;
    }
