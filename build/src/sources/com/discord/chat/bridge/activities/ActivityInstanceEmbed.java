...
public final class ActivityInstanceEmbed {
    ...
    @NotNull
    private static final Lazy[] $childSerializers = {null, null, l.b(o.f49210e, new Function0() { // from class: l6.a
    ...
    public static final /* synthetic */ void write$Self$chat_release(ActivityInstanceEmbed activityInstanceEmbed, CompositeEncoder compositeEncoder, SerialDescriptor serialDescriptor) {
        ...
        compositeEncoder.F(serialDescriptor, 0, ApplicationId$$serializer.INSTANCE, ApplicationId.m1044boximpl(activityInstanceEmbed.applicationId));
        ...
        if (compositeEncoder.z(serialDescriptor, 2) || activityInstanceEmbed.participantAvatarUris != null) {
            compositeEncoder.i(serialDescriptor, 2, (gt.o) lazyArr[2].getValue(), activityInstanceEmbed.participantAvatarUris);
        }
        compositeEncoder.F(serialDescriptor, 3, AppMessageEmbedImpl$$serializer.INSTANCE, activityInstanceEmbed.appMessageEmbedModel);
        if (compositeEncoder.z(serialDescriptor, 4) || activityInstanceEmbed.participantsDescription != null) {
            compositeEncoder.i(serialDescriptor, 4, n2.f35181a, activityInstanceEmbed.participantsDescription);
        }
    }
