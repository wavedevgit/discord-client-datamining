...
public final class ActivityInstanceEmbed {
    ...
    @NotNull
    private static final Lazy[] $childSerializers = {null, null, l.a(o.f32182e, new Function0() { // from class: k6.a
    ...
    public static final /* synthetic */ void write$Self$chat_release(ActivityInstanceEmbed activityInstanceEmbed, CompositeEncoder compositeEncoder, SerialDescriptor serialDescriptor) {
        ...
        compositeEncoder.m(serialDescriptor, 0, ApplicationId$$serializer.INSTANCE, ApplicationId.m1047boximpl(activityInstanceEmbed.applicationId));
        compositeEncoder.x(serialDescriptor, 1, activityInstanceEmbed.instanceId);
        if (compositeEncoder.y(serialDescriptor, 2) || activityInstanceEmbed.participantAvatarUris != null) {
            compositeEncoder.B(serialDescriptor, 2, (ys.o) lazyArr[2].getValue(), activityInstanceEmbed.participantAvatarUris);
        }
        compositeEncoder.m(serialDescriptor, 3, AppMessageEmbedImpl$$serializer.INSTANCE, activityInstanceEmbed.appMessageEmbedModel);
        if (compositeEncoder.y(serialDescriptor, 4) || activityInstanceEmbed.participantsDescription != null) {
            compositeEncoder.B(serialDescriptor, 4, n2.f7662a, activityInstanceEmbed.participantsDescription);
        }
    }
    ...
    public int hashCode() {
        int m1052hashCodeimpl = ((ApplicationId.m1052hashCodeimpl(this.applicationId) * 31) + this.instanceId.hashCode()) * 31;
        List<String> list = this.participantAvatarUris;
        int hashCode = (((m1052hashCodeimpl + (list == null ? 0 : list.hashCode())) * 31) + this.appMessageEmbedModel.hashCode()) * 31;
    ...
    public String toString() {
        ...
        return "ActivityInstanceEmbed(applicationId=" + m1054toStringimpl + ", instanceId=" + str + ", participantAvatarUris=" + list + ", appMessageEmbedModel=" + appMessageEmbedImpl + ", participantsDescription=" + str2 + ")";
    }
