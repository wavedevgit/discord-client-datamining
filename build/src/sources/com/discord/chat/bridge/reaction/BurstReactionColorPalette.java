...
public final class BurstReactionColorPalette implements ReactionView.BurstColorPalette {
    ...
    public static final /* synthetic */ void write$Self$chat_release(BurstReactionColorPalette burstReactionColorPalette, CompositeEncoder compositeEncoder, SerialDescriptor serialDescriptor) {
        n2 n2Var = n2.f6848a;
        compositeEncoder.z(serialDescriptor, 0, n2Var, burstReactionColorPalette.getBackgroundColor());
        compositeEncoder.z(serialDescriptor, 1, n2Var, burstReactionColorPalette.getAccentColor());
        compositeEncoder.z(serialDescriptor, 2, n2Var, burstReactionColorPalette.getHighlightColor());
        compositeEncoder.s(serialDescriptor, 3, burstReactionColorPalette.getOpacity());
    }
