...
public final class MessageReaction implements ReactionView.Reaction {
    ...
    public static final /* synthetic */ void write$Self$chat_release(MessageReaction messageReaction, CompositeEncoder compositeEncoder, SerialDescriptor serialDescriptor) {
        compositeEncoder.x(serialDescriptor, 0, messageReaction.getCount());
        compositeEncoder.y(serialDescriptor, 1, messageReaction.f8555me);
        if (compositeEncoder.A(serialDescriptor, 2) || messageReaction.isMeBurst()) {
            compositeEncoder.y(serialDescriptor, 2, messageReaction.isMeBurst());
        }
        compositeEncoder.s(serialDescriptor, 3, MessageReactionEmoji$$serializer.INSTANCE, messageReaction.getEmoji());
        if (compositeEncoder.A(serialDescriptor, 4) || messageReaction.getBurstCount() != 0) {
            compositeEncoder.x(serialDescriptor, 4, messageReaction.getBurstCount());
        }
        if (compositeEncoder.A(serialDescriptor, 5) || messageReaction.getThemedBurstColors() != null) {
            compositeEncoder.l(serialDescriptor, 5, ThemedBurstReactionColorPalette$$serializer.INSTANCE, messageReaction.getThemedBurstColors());
        }
        if (compositeEncoder.A(serialDescriptor, 6) || messageReaction.isMe() != messageReaction.f8555me) {
            compositeEncoder.y(serialDescriptor, 6, messageReaction.isMe());
        }
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof MessageReaction) {
            ...
            return this.count == messageReaction.count && this.f8555me == messageReaction.f8555me && this.isMeBurst == messageReaction.isMeBurst && Intrinsics.areEqual(this.emoji, messageReaction.emoji) && this.burstCount == messageReaction.burstCount && Intrinsics.areEqual(this.themedBurstColors, messageReaction.themedBurstColors);
        }
        return false;
    }
    ...
    public int hashCode() {
        int hashCode = ((((((((Integer.hashCode(this.count) * 31) + Boolean.hashCode(this.f8555me)) * 31) + Boolean.hashCode(this.isMeBurst)) * 31) + this.emoji.hashCode()) * 31) + Integer.hashCode(this.burstCount)) * 31;
