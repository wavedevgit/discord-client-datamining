...
public final class ReactionsTheme implements ReactionView.ReactionsTheme {
    ...
    public static final /* synthetic */ void write$Self$chat_release(ReactionsTheme reactionsTheme, CompositeEncoder compositeEncoder, SerialDescriptor serialDescriptor) {
        if (compositeEncoder.y(serialDescriptor, 0) || reactionsTheme.getReactionBackgroundColor() != null) {
            compositeEncoder.B(serialDescriptor, 0, p0.f7678a, reactionsTheme.getReactionBackgroundColor());
        }
        if (compositeEncoder.y(serialDescriptor, 1) || reactionsTheme.getReactionBorderColor() != null) {
            compositeEncoder.B(serialDescriptor, 1, p0.f7678a, reactionsTheme.getReactionBorderColor());
        }
        if (compositeEncoder.y(serialDescriptor, 2) || reactionsTheme.getReactionTextColor() != null) {
            compositeEncoder.B(serialDescriptor, 2, p0.f7678a, reactionsTheme.getReactionTextColor());
        }
        if (compositeEncoder.y(serialDescriptor, 3) || reactionsTheme.getActiveReactionBackgroundColor() != null) {
            compositeEncoder.B(serialDescriptor, 3, p0.f7678a, reactionsTheme.getActiveReactionBackgroundColor());
        }
        if (compositeEncoder.y(serialDescriptor, 4) || reactionsTheme.getActiveReactionBorderColor() != null) {
            compositeEncoder.B(serialDescriptor, 4, p0.f7678a, reactionsTheme.getActiveReactionBorderColor());
        }
        if (compositeEncoder.y(serialDescriptor, 5) || reactionsTheme.getActiveReactionTextColor() != null) {
            compositeEncoder.B(serialDescriptor, 5, p0.f7678a, reactionsTheme.getActiveReactionTextColor());
        }
    }
