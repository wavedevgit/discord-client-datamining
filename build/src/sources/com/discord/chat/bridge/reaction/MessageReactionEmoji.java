...
public final class MessageReactionEmoji implements ReactionView.Emoji {
    ...
    public static /* synthetic */ MessageReactionEmoji copy$default(MessageReactionEmoji messageReactionEmoji, String str, String str2, String str3, String str4, Boolean bool, int i10, Object obj) {
        ...
        if ((i10 & 8) != 0) {
            str4 = messageReactionEmoji.f9305id;
        }
        if ((i10 & 16) != 0) {
    ...
    public static final /* synthetic */ void write$Self$chat_release(MessageReactionEmoji messageReactionEmoji, CompositeEncoder compositeEncoder, SerialDescriptor serialDescriptor) {
        if (compositeEncoder.y(serialDescriptor, 0) || messageReactionEmoji.getName() != null) {
            compositeEncoder.B(serialDescriptor, 0, n2.f7662a, messageReactionEmoji.getName());
        }
        compositeEncoder.x(serialDescriptor, 1, messageReactionEmoji.getSrc());
        compositeEncoder.x(serialDescriptor, 2, messageReactionEmoji.getDisplayName());
        if (compositeEncoder.y(serialDescriptor, 3) || messageReactionEmoji.getId() != null) {
            compositeEncoder.B(serialDescriptor, 3, n2.f7662a, messageReactionEmoji.getId());
        }
        if (compositeEncoder.y(serialDescriptor, 4) || messageReactionEmoji.getAnimated() != null) {
            compositeEncoder.B(serialDescriptor, 4, h.f7626a, messageReactionEmoji.getAnimated());
        }
    }
