...
public final class MessageType implements IntEnum {
    ...
    @NotNull
    private final Lazy isSystem$delegate = l.b(new Function0() { // from class: k6.m
    ...
    @NotNull
    private final Lazy isAutomodSystem$delegate = l.b(new Function0() { // from class: k6.n
        @Override // kotlin.jvm.functions.Function0
        public final Object invoke() {
    ...
    @NotNull
    private final Lazy isCall$delegate = l.b(new Function0() { // from class: k6.o
        @Override // kotlin.jvm.functions.Function0
        public final Object invoke() {
