...
public final class ComponentEmoji {
    ...
    public static final /* synthetic */ void write$Self$chat_release(ComponentEmoji componentEmoji, CompositeEncoder compositeEncoder, SerialDescriptor serialDescriptor) {
        if (compositeEncoder.y(serialDescriptor, 0) || componentEmoji.f9272id != null) {
            compositeEncoder.B(serialDescriptor, 0, n2.f7662a, componentEmoji.f9272id);
        }
        compositeEncoder.x(serialDescriptor, 1, componentEmoji.name);
        if (compositeEncoder.y(serialDescriptor, 2) || componentEmoji.src != null) {
            compositeEncoder.B(serialDescriptor, 2, n2.f7662a, componentEmoji.src);
        }
        if (compositeEncoder.y(serialDescriptor, 3) || componentEmoji.animated) {
            compositeEncoder.w(serialDescriptor, 3, componentEmoji.animated);
        }
        if (compositeEncoder.y(serialDescriptor, 4) || componentEmoji.surrogates != null) {
            compositeEncoder.B(serialDescriptor, 4, n2.f7662a, componentEmoji.surrogates);
        }
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof ComponentEmoji) {
            ...
            return Intrinsics.areEqual(this.f9272id, componentEmoji.f9272id) && Intrinsics.areEqual(this.name, componentEmoji.name) && Intrinsics.areEqual(this.src, componentEmoji.src) && this.animated == componentEmoji.animated && Intrinsics.areEqual(this.surrogates, componentEmoji.surrogates);
        }
        return false;
    }
