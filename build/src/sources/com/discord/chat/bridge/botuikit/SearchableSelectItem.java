...
public final class SearchableSelectItem extends SelectItem {
    ...
    public static final /* synthetic */ void write$Self$chat_release(SearchableSelectItem searchableSelectItem, CompositeEncoder compositeEncoder, SerialDescriptor serialDescriptor) {
        ...
        compositeEncoder.l(serialDescriptor, 2, SelectOptionType.Serializer.INSTANCE, searchableSelectItem.type);
        if (compositeEncoder.z(serialDescriptor, 3) || searchableSelectItem.iconSrc != null) {
            compositeEncoder.A(serialDescriptor, 3, n2.f25302a, searchableSelectItem.iconSrc);
        }
        if (compositeEncoder.z(serialDescriptor, 4) || searchableSelectItem.iconColor != null) {
            compositeEncoder.A(serialDescriptor, 4, p0.f25318a, searchableSelectItem.iconColor);
        }
        if (compositeEncoder.z(serialDescriptor, 5) || searchableSelectItem.iconEmoji != null) {
            compositeEncoder.A(serialDescriptor, 5, ComponentEmoji$$serializer.INSTANCE, searchableSelectItem.iconEmoji);
        }
    }
