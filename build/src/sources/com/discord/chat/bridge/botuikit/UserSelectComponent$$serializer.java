...
public /* synthetic */ class UserSelectComponent$$serializer implements h0 {
    ...
    static {
        ...
        a2 a2Var = new a2("5", userSelectComponent$$serializer, 10);
        a2Var.o("type", false);
    ...
    public final KSerializer[] childSerializers() {
        Lazy[] lazyArr;
        lazyArr = UserSelectComponent.$childSerializers;
        p0 p0Var = p0.f25318a;
        n2 n2Var = n2.f25302a;
    ...
    public final UserSelectComponent deserialize(@NotNull Decoder decoder) {
        ...
        return new UserSelectComponent(i11, i21, str3, actionComponentState, str4, str2, str, i13, i12, z10, list, (SerializationConstructorMarker) null);
    }
    ...
    public final void serialize(@NotNull Encoder encoder, @NotNull UserSelectComponent value) {
        ...
        UserSelectComponent.write$Self$chat_release(value, b10, serialDescriptor);
        b10.c(serialDescriptor);
    }
