...
public final class UserSelectComponent extends SearchableSelectComponent {
    ...
    @NotNull
    private static final Lazy[] $childSerializers = {null, null, null, null, null, null, null, null, null, ir.l.a(ir.o.f31119e, new Function0() { // from class: com.discord.chat.bridge.botuikit.p
    ...
    public static final /* synthetic */ KSerializer _childSerializers$_anonymous_() {
        return new at.f(SearchableSelectItem$$serializer.INSTANCE);
    }
    ...
    public static /* synthetic */ UserSelectComponent copy$default(UserSelectComponent userSelectComponent, int i10, String str, ActionComponentState actionComponentState, String str2, String str3, String str4, int i11, int i12, boolean z10, List list, int i13, Object obj) {
        ...
        if ((i13 & 2) != 0) {
            str = userSelectComponent.f9660id;
        }
        if ((i13 & 4) != 0) {
    ...
    public static final /* synthetic */ void write$Self$chat_release(UserSelectComponent userSelectComponent, CompositeEncoder compositeEncoder, SerialDescriptor serialDescriptor) {
        ...
        compositeEncoder.j(serialDescriptor, 2, ActionComponentState.Serializer.INSTANCE, userSelectComponent.getState());
        ...
        if (compositeEncoder.A(serialDescriptor, 4) || userSelectComponent.getPlaceholder() != null) {
            compositeEncoder.z(serialDescriptor, 4, n2.f6848a, userSelectComponent.getPlaceholder());
        }
        if (compositeEncoder.A(serialDescriptor, 5) || userSelectComponent.getAccessibilityLabel() != null) {
            compositeEncoder.z(serialDescriptor, 5, n2.f6848a, userSelectComponent.getAccessibilityLabel());
        }
        ...
        compositeEncoder.j(serialDescriptor, 9, (xs.o) lazyArr[9].getValue(), userSelectComponent.getSelectedOptions());
    }
    ...
    public int hashCode() {
        int hashCode = ((((((Integer.hashCode(this.type) * 31) + this.f9660id.hashCode()) * 31) + this.state.hashCode()) * 31) + this.customId.hashCode()) * 31;
