...
public final class UserSelectComponent extends SearchableSelectComponent {
    ...
    @NotNull
    private static final Lazy[] $childSerializers = {null, null, null, null, null, null, null, null, null, qr.l.b(qr.o.f48092e, new Function0() { // from class: com.discord.chat.bridge.botuikit.p
        @Override // kotlin.jvm.functions.Function0
        public final Object invoke() {
            KSerializer _childSerializers$_anonymous_;
            _childSerializers$_anonymous_ = UserSelectComponent._childSerializers$_anonymous_();
    ...
    public /* synthetic */ UserSelectComponent(int i10, int i11, String str, ActionComponentState actionComponentState, String str2, String str3, String str4, int i12, int i13, boolean z10, List list, SerializationConstructorMarker serializationConstructorMarker) {
    ...
    public static /* synthetic */ UserSelectComponent copy$default(UserSelectComponent userSelectComponent, int i10, String str, ActionComponentState actionComponentState, String str2, String str3, String str4, int i11, int i12, boolean z10, List list, int i13, Object obj) {
        ...
        if ((i13 & 2) != 0) {
            str = userSelectComponent.f8540id;
        }
        if ((i13 & 4) != 0) {
        ...
        String str5 = str3;
        String str6 = str4;
        return userSelectComponent.copy(i10, str, actionComponentState, str2, str5, str6, i14, i15, z11, list3);
    }
    ...
    public static final /* synthetic */ void write$Self$chat_release(UserSelectComponent userSelectComponent, CompositeEncoder compositeEncoder, SerialDescriptor serialDescriptor) {
        ...
        compositeEncoder.x(serialDescriptor, 0, userSelectComponent.getType());
        compositeEncoder.z(serialDescriptor, 1, userSelectComponent.getId());
        compositeEncoder.s(serialDescriptor, 2, ActionComponentState.Serializer.INSTANCE, userSelectComponent.getState());
        compositeEncoder.z(serialDescriptor, 3, userSelectComponent.getCustomId());
        if (compositeEncoder.A(serialDescriptor, 4) || userSelectComponent.getPlaceholder() != null) {
            compositeEncoder.l(serialDescriptor, 4, n2.f31089a, userSelectComponent.getPlaceholder());
        }
        if (compositeEncoder.A(serialDescriptor, 5) || userSelectComponent.getAccessibilityLabel() != null) {
            compositeEncoder.l(serialDescriptor, 5, n2.f31089a, userSelectComponent.getAccessibilityLabel());
        }
        compositeEncoder.x(serialDescriptor, 6, userSelectComponent.getMinValues());
        compositeEncoder.x(serialDescriptor, 7, userSelectComponent.getMaxValues());
        if (compositeEncoder.A(serialDescriptor, 8) || userSelectComponent.getDisabled()) {
            compositeEncoder.y(serialDescriptor, 8, userSelectComponent.getDisabled());
        }
        compositeEncoder.s(serialDescriptor, 9, (ft.o) lazyArr[9].getValue(), userSelectComponent.getSelectedOptions());
    }
    ...
    @NotNull
    public final UserSelectComponent copy(int i10, @NotNull String id2, @NotNull ActionComponentState state, @NotNull String customId, String str, String str2, int i11, int i12, boolean z10, @NotNull List<SearchableSelectItem> selectedOptions) {
        Intrinsics.checkNotNullParameter(id2, "id");
        Intrinsics.checkNotNullParameter(state, "state");
        Intrinsics.checkNotNullParameter(customId, "customId");
        Intrinsics.checkNotNullParameter(selectedOptions, "selectedOptions");
        return new UserSelectComponent(i10, id2, state, customId, str, str2, i11, i12, z10, selectedOptions);
    }
    ...
    public int hashCode() {
        int hashCode = ((((((Integer.hashCode(this.type) * 31) + this.f8540id.hashCode()) * 31) + this.state.hashCode()) * 31) + this.customId.hashCode()) * 31;
    ...
    public String toString() {
        ...
        return "UserSelectComponent(type=" + i10 + ", id=" + str + ", state=" + actionComponentState + ", customId=" + str2 + ", placeholder=" + str3 + ", accessibilityLabel=" + str4 + ", minValues=" + i11 + ", maxValues=" + i12 + ", disabled=" + z10 + ", selectedOptions=" + list + ")";
    }

    public /* synthetic */ UserSelectComponent(int i10, String str, ActionComponentState actionComponentState, String str2, String str3, String str4, int i11, int i12, boolean z10, List list, int i13, DefaultConstructorMarker defaultConstructorMarker) {
    ...
    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public UserSelectComponent(int i10, @NotNull String id2, @NotNull ActionComponentState state, @NotNull String customId, String str, String str2, int i11, int i12, boolean z10, @NotNull List<SearchableSelectItem> selectedOptions) {
        super(null);
        Intrinsics.checkNotNullParameter(id2, "id");
        Intrinsics.checkNotNullParameter(state, "state");
        Intrinsics.checkNotNullParameter(customId, "customId");
