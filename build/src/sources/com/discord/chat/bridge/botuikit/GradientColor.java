...
public final class GradientColor {
    ...
    public static /* synthetic */ GradientColor copy$default(GradientColor gradientColor, int i10, int i11, int i12, float f10, int i13, Object obj) {
        if ((i13 & 1) != 0) {
            i10 = gradientColor.f8670r;
        }
        if ((i13 & 2) != 0) {
            i11 = gradientColor.f8669g;
        }
        if ((i13 & 4) != 0) {
            i12 = gradientColor.f8668b;
        }
        if ((i13 & 8) != 0) {
            f10 = gradientColor.f8667a;
        }
    ...
    public static final /* synthetic */ void write$Self$chat_release(GradientColor gradientColor, CompositeEncoder compositeEncoder, SerialDescriptor serialDescriptor) {
        compositeEncoder.w(serialDescriptor, 0, gradientColor.f8670r);
        compositeEncoder.w(serialDescriptor, 1, gradientColor.f8669g);
        compositeEncoder.w(serialDescriptor, 2, gradientColor.f8668b);
        compositeEncoder.s(serialDescriptor, 3, gradientColor.f8667a);
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof GradientColor) {
            ...
            return this.f8670r == gradientColor.f8670r && this.f8669g == gradientColor.f8669g && this.f8668b == gradientColor.f8668b && Float.compare(this.f8667a, gradientColor.f8667a) == 0;
        }
        return false;
    }
    ...
    public int hashCode() {
        return (((((Integer.hashCode(this.f8670r) * 31) + Integer.hashCode(this.f8669g)) * 31) + Integer.hashCode(this.f8668b)) * 31) + Float.hashCode(this.f8667a);
    }
