...
public final class GradientColor {
    ...
    public static /* synthetic */ GradientColor copy$default(GradientColor gradientColor, int i10, int i11, int i12, float f10, int i13, Object obj) {
        if ((i13 & 1) != 0) {
            i10 = gradientColor.f8246r;
        }
        if ((i13 & 2) != 0) {
            i11 = gradientColor.f8245g;
        }
        if ((i13 & 4) != 0) {
            i12 = gradientColor.f8244b;
        }
        if ((i13 & 8) != 0) {
            f10 = gradientColor.f8243a;
        }
    ...
    public static final /* synthetic */ void write$Self$chat_release(GradientColor gradientColor, CompositeEncoder compositeEncoder, SerialDescriptor serialDescriptor) {
        compositeEncoder.w(serialDescriptor, 0, gradientColor.f8246r);
        compositeEncoder.w(serialDescriptor, 1, gradientColor.f8245g);
        compositeEncoder.w(serialDescriptor, 2, gradientColor.f8244b);
        compositeEncoder.r(serialDescriptor, 3, gradientColor.f8243a);
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof GradientColor) {
            ...
            return this.f8246r == gradientColor.f8246r && this.f8245g == gradientColor.f8245g && this.f8244b == gradientColor.f8244b && Float.compare(this.f8243a, gradientColor.f8243a) == 0;
        }
        return false;
    }
    ...
    public int hashCode() {
        return (((((Integer.hashCode(this.f8246r) * 31) + Integer.hashCode(this.f8245g)) * 31) + Integer.hashCode(this.f8244b)) * 31) + Float.hashCode(this.f8243a);
    }
