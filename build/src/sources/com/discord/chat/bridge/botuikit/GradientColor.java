...
public final class GradientColor {
    ...
    public static /* synthetic */ GradientColor copy$default(GradientColor gradientColor, int i10, int i11, int i12, float f10, int i13, Object obj) {
        if ((i13 & 1) != 0) {
            i10 = gradientColor.f8247r;
        }
        if ((i13 & 2) != 0) {
            i11 = gradientColor.f8246g;
        }
        if ((i13 & 4) != 0) {
            i12 = gradientColor.f8245b;
        }
        if ((i13 & 8) != 0) {
            f10 = gradientColor.f8244a;
        }
    ...
    public static final /* synthetic */ void write$Self$chat_release(GradientColor gradientColor, CompositeEncoder compositeEncoder, SerialDescriptor serialDescriptor) {
        compositeEncoder.w(serialDescriptor, 0, gradientColor.f8247r);
        compositeEncoder.w(serialDescriptor, 1, gradientColor.f8246g);
        compositeEncoder.w(serialDescriptor, 2, gradientColor.f8245b);
        compositeEncoder.r(serialDescriptor, 3, gradientColor.f8244a);
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof GradientColor) {
            ...
            return this.f8247r == gradientColor.f8247r && this.f8246g == gradientColor.f8246g && this.f8245b == gradientColor.f8245b && Float.compare(this.f8244a, gradientColor.f8244a) == 0;
        }
        return false;
    }
    ...
    public int hashCode() {
        return (((((Integer.hashCode(this.f8247r) * 31) + Integer.hashCode(this.f8246g)) * 31) + Integer.hashCode(this.f8245b)) * 31) + Float.hashCode(this.f8244a);
    }
