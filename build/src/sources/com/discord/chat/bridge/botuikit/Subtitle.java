...
public final class Subtitle {
    ...
    public static final /* synthetic */ void write$Self$chat_release(Subtitle subtitle, CompositeEncoder compositeEncoder, SerialDescriptor serialDescriptor) {
        if (compositeEncoder.y(serialDescriptor, 0) || subtitle.badgeUrl != null) {
            compositeEncoder.B(serialDescriptor, 0, n2.f7662a, subtitle.badgeUrl);
        }
        compositeEncoder.x(serialDescriptor, 1, subtitle.text);
        if (compositeEncoder.y(serialDescriptor, 2) || subtitle.ariaDescription != null) {
            compositeEncoder.B(serialDescriptor, 2, n2.f7662a, subtitle.ariaDescription);
        }
        if (compositeEncoder.y(serialDescriptor, 3) || subtitle.clickable != null) {
            compositeEncoder.B(serialDescriptor, 3, ContentInventoryEntryClickable$$serializer.INSTANCE, subtitle.clickable);
        }
    }
