...
public final class UnknownComponent extends Component {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof UnknownComponent) {
            ...
            return this.type == unknownComponent.type && Intrinsics.areEqual(this.f9257id, unknownComponent.f9257id);
        }
        return false;
    }
    ...
    public int hashCode() {
        return (Integer.hashCode(this.type) * 31) + this.f9257id.hashCode();
    }
