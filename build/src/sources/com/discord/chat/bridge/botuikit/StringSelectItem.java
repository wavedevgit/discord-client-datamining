...
public final class StringSelectItem extends SelectItem {
    ...
    public static final /* synthetic */ void write$Self$chat_release(StringSelectItem stringSelectItem, CompositeEncoder compositeEncoder, SerialDescriptor serialDescriptor) {
        ...
        if (compositeEncoder.y(serialDescriptor, 2) || stringSelectItem.emoji != null) {
            compositeEncoder.B(serialDescriptor, 2, ComponentEmoji$$serializer.INSTANCE, stringSelectItem.emoji);
        }
        if (compositeEncoder.y(serialDescriptor, 3) || stringSelectItem.description != null) {
            compositeEncoder.B(serialDescriptor, 3, n2.f7662a, stringSelectItem.description);
        }
        if (compositeEncoder.y(serialDescriptor, 4) || !Intrinsics.areEqual(stringSelectItem.f0default, Boolean.FALSE)) {
            compositeEncoder.B(serialDescriptor, 4, bt.h.f7626a, stringSelectItem.f0default);
        }
    }
