...
public final class StringSelectItem extends SelectItem {
    ...
    public static final /* synthetic */ void write$Self$chat_release(StringSelectItem stringSelectItem, CompositeEncoder compositeEncoder, SerialDescriptor serialDescriptor) {
        ...
        compositeEncoder.y(serialDescriptor, 0, stringSelectItem.getLabel());
        compositeEncoder.y(serialDescriptor, 1, stringSelectItem.getValue());
        if (compositeEncoder.A(serialDescriptor, 2) || stringSelectItem.emoji != null) {
            compositeEncoder.z(serialDescriptor, 2, ComponentEmoji$$serializer.INSTANCE, stringSelectItem.emoji);
        }
        if (compositeEncoder.A(serialDescriptor, 3) || stringSelectItem.description != null) {
            compositeEncoder.z(serialDescriptor, 3, n2.f6848a, stringSelectItem.description);
        }
        if (compositeEncoder.A(serialDescriptor, 4) || !Intrinsics.areEqual(stringSelectItem.f0default, Boolean.FALSE)) {
            compositeEncoder.z(serialDescriptor, 4, at.h.f6812a, stringSelectItem.f0default);
        }
    }
