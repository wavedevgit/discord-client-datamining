...
public final class MediaGalleryDisplayComponent extends Component {
    ...
    @NotNull
    private static final Lazy[] $childSerializers = {null, null, or.l.b(or.o.f44232e, new Function0() { // from class: com.discord.chat.bridge.botuikit.g
    ...
    public static final /* synthetic */ KSerializer _childSerializers$_anonymous_() {
        return new gt.f(MediaGalleryItem$$serializer.INSTANCE);
    }
    ...
    public static /* synthetic */ MediaGalleryDisplayComponent copy$default(MediaGalleryDisplayComponent mediaGalleryDisplayComponent, int i10, String str, List list, int i11, Object obj) {
        ...
        if ((i11 & 2) != 0) {
            str = mediaGalleryDisplayComponent.f8632id;
        }
        if ((i11 & 4) != 0) {
    ...
    public static final /* synthetic */ void write$Self$chat_release(MediaGalleryDisplayComponent mediaGalleryDisplayComponent, CompositeEncoder compositeEncoder, SerialDescriptor serialDescriptor) {
        ...
        compositeEncoder.v(serialDescriptor, 0, mediaGalleryDisplayComponent.getType());
        compositeEncoder.x(serialDescriptor, 1, mediaGalleryDisplayComponent.getId());
        compositeEncoder.l(serialDescriptor, 2, (dt.o) lazyArr[2].getValue(), mediaGalleryDisplayComponent.items);
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof MediaGalleryDisplayComponent) {
            ...
            return this.type == mediaGalleryDisplayComponent.type && Intrinsics.areEqual(this.f8632id, mediaGalleryDisplayComponent.f8632id) && Intrinsics.areEqual(this.items, mediaGalleryDisplayComponent.items);
        }
        return false;
    }
    ...
    public int hashCode() {
        return (((Integer.hashCode(this.type) * 31) + this.f8632id.hashCode()) * 31) + this.items.hashCode();
    }

    @NotNull
    public String toString() {
        int i10 = this.type;
        String str = this.f8632id;
