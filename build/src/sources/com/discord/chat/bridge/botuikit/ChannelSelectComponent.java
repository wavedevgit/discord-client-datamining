...
public final class ChannelSelectComponent extends SearchableSelectComponent {
    ...
    static {
        ...
        $childSerializers = new Lazy[]{null, null, null, null, null, null, null, null, null, jr.l.a(oVar, new Function0() { // from class: com.discord.chat.bridge.botuikit.b
        ...
        }), jr.l.a(oVar, new Function0() { // from class: com.discord.chat.bridge.botuikit.c
            @Override // kotlin.jvm.functions.Function0
            public final Object invoke() {
    ...
    public static /* synthetic */ ChannelSelectComponent copy$default(ChannelSelectComponent channelSelectComponent, int i10, String str, ActionComponentState actionComponentState, String str2, String str3, String str4, int i11, int i12, boolean z10, List list, List list2, int i13, Object obj) {
        ...
        if ((i13 & 2) != 0) {
            str = channelSelectComponent.f9270id;
        }
        if ((i13 & 4) != 0) {
    ...
    public static final /* synthetic */ void write$Self$chat_release(ChannelSelectComponent channelSelectComponent, CompositeEncoder compositeEncoder, SerialDescriptor serialDescriptor) {
        ...
        compositeEncoder.v(serialDescriptor, 0, channelSelectComponent.getType());
        compositeEncoder.x(serialDescriptor, 1, channelSelectComponent.getId());
        compositeEncoder.m(serialDescriptor, 2, ActionComponentState.Serializer.INSTANCE, channelSelectComponent.getState());
        compositeEncoder.x(serialDescriptor, 3, channelSelectComponent.getCustomId());
        if (compositeEncoder.y(serialDescriptor, 4) || channelSelectComponent.getPlaceholder() != null) {
            compositeEncoder.B(serialDescriptor, 4, n2.f7662a, channelSelectComponent.getPlaceholder());
        }
        if (compositeEncoder.y(serialDescriptor, 5) || channelSelectComponent.getAccessibilityLabel() != null) {
            compositeEncoder.B(serialDescriptor, 5, n2.f7662a, channelSelectComponent.getAccessibilityLabel());
        }
        compositeEncoder.v(serialDescriptor, 6, channelSelectComponent.getMinValues());
        compositeEncoder.v(serialDescriptor, 7, channelSelectComponent.getMaxValues());
        if (compositeEncoder.y(serialDescriptor, 8) || channelSelectComponent.getDisabled()) {
            compositeEncoder.w(serialDescriptor, 8, channelSelectComponent.getDisabled());
        }
        compositeEncoder.m(serialDescriptor, 9, (ys.o) lazyArr[9].getValue(), channelSelectComponent.getSelectedOptions());
        if (compositeEncoder.y(serialDescriptor, 10) || channelSelectComponent.channelTypes != null) {
            compositeEncoder.B(serialDescriptor, 10, (ys.o) lazyArr[10].getValue(), channelSelectComponent.channelTypes);
        }
    }
    ...
    public int hashCode() {
        int hashCode = ((((((Integer.hashCode(this.type) * 31) + this.f9270id.hashCode()) * 31) + this.state.hashCode()) * 31) + this.customId.hashCode()) * 31;
