...
public final class ChannelSelectComponent extends SearchableSelectComponent {
    ...
    static {
        rr.o oVar = rr.o.f49210e;
        $childSerializers = new Lazy[]{null, null, null, null, null, null, null, null, null, rr.l.b(oVar, new Function0() { // from class: com.discord.chat.bridge.botuikit.b
        ...
        }), rr.l.b(oVar, new Function0() { // from class: com.discord.chat.bridge.botuikit.c
            @Override // kotlin.jvm.functions.Function0
            public final Object invoke() {
    ...
    public static /* synthetic */ ChannelSelectComponent copy$default(ChannelSelectComponent channelSelectComponent, int i10, String str, ActionComponentState actionComponentState, String str2, String str3, String str4, int i11, int i12, boolean z10, List list, List list2, int i13, Object obj) {
        ...
        if ((i13 & 2) != 0) {
            str = channelSelectComponent.f8661id;
        }
        if ((i13 & 4) != 0) {
    ...
    public static final /* synthetic */ void write$Self$chat_release(ChannelSelectComponent channelSelectComponent, CompositeEncoder compositeEncoder, SerialDescriptor serialDescriptor) {
        ...
        compositeEncoder.w(serialDescriptor, 0, channelSelectComponent.getType());
        compositeEncoder.y(serialDescriptor, 1, channelSelectComponent.getId());
        compositeEncoder.F(serialDescriptor, 2, ActionComponentState.Serializer.INSTANCE, channelSelectComponent.getState());
        ...
        if (compositeEncoder.z(serialDescriptor, 4) || channelSelectComponent.getPlaceholder() != null) {
            compositeEncoder.i(serialDescriptor, 4, n2.f35181a, channelSelectComponent.getPlaceholder());
        }
        if (compositeEncoder.z(serialDescriptor, 5) || channelSelectComponent.getAccessibilityLabel() != null) {
            compositeEncoder.i(serialDescriptor, 5, n2.f35181a, channelSelectComponent.getAccessibilityLabel());
        }
        ...
        if (compositeEncoder.z(serialDescriptor, 8) || channelSelectComponent.getDisabled()) {
            compositeEncoder.x(serialDescriptor, 8, channelSelectComponent.getDisabled());
        }
        compositeEncoder.F(serialDescriptor, 9, (gt.o) lazyArr[9].getValue(), channelSelectComponent.getSelectedOptions());
        if (compositeEncoder.z(serialDescriptor, 10) || channelSelectComponent.channelTypes != null) {
            compositeEncoder.i(serialDescriptor, 10, (gt.o) lazyArr[10].getValue(), channelSelectComponent.channelTypes);
        }
    }
    ...
    public int hashCode() {
        int hashCode = ((((((Integer.hashCode(this.type) * 31) + this.f8661id.hashCode()) * 31) + this.state.hashCode()) * 31) + this.customId.hashCode()) * 31;
