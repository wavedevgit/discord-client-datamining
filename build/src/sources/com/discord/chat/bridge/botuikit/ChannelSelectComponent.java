...
public final class ChannelSelectComponent extends SearchableSelectComponent {
    ...
    static {
        ...
        $childSerializers = new Lazy[]{null, null, null, null, null, null, null, null, null, or.l.b(oVar, new Function0() { // from class: com.discord.chat.bridge.botuikit.b
        ...
        }), or.l.b(oVar, new Function0() { // from class: com.discord.chat.bridge.botuikit.c
            @Override // kotlin.jvm.functions.Function0
            public final Object invoke() {
    ...
    public static /* synthetic */ ChannelSelectComponent copy$default(ChannelSelectComponent channelSelectComponent, int i10, String str, ActionComponentState actionComponentState, String str2, String str3, String str4, int i11, int i12, boolean z10, List list, List list2, int i13, Object obj) {
        ...
        if ((i13 & 2) != 0) {
            str = channelSelectComponent.f8622id;
        }
        if ((i13 & 4) != 0) {
    ...
    public static final /* synthetic */ void write$Self$chat_release(ChannelSelectComponent channelSelectComponent, CompositeEncoder compositeEncoder, SerialDescriptor serialDescriptor) {
        ...
        compositeEncoder.l(serialDescriptor, 2, ActionComponentState.Serializer.INSTANCE, channelSelectComponent.getState());
        ...
        if (compositeEncoder.z(serialDescriptor, 4) || channelSelectComponent.getPlaceholder() != null) {
            compositeEncoder.A(serialDescriptor, 4, n2.f25302a, channelSelectComponent.getPlaceholder());
        }
        if (compositeEncoder.z(serialDescriptor, 5) || channelSelectComponent.getAccessibilityLabel() != null) {
            compositeEncoder.A(serialDescriptor, 5, n2.f25302a, channelSelectComponent.getAccessibilityLabel());
        }
        ...
        if (compositeEncoder.z(serialDescriptor, 8) || channelSelectComponent.getDisabled()) {
            compositeEncoder.w(serialDescriptor, 8, channelSelectComponent.getDisabled());
        }
        compositeEncoder.l(serialDescriptor, 9, (dt.o) lazyArr[9].getValue(), channelSelectComponent.getSelectedOptions());
        if (compositeEncoder.z(serialDescriptor, 10) || channelSelectComponent.channelTypes != null) {
            compositeEncoder.A(serialDescriptor, 10, (dt.o) lazyArr[10].getValue(), channelSelectComponent.channelTypes);
        }
    }
    ...
    public int hashCode() {
        int hashCode = ((((((Integer.hashCode(this.type) * 31) + this.f8622id.hashCode()) * 31) + this.state.hashCode()) * 31) + this.customId.hashCode()) * 31;
