...
public final class ChannelSelectComponent extends SearchableSelectComponent {
    ...
    static {
        ...
        $childSerializers = new Lazy[]{null, null, null, null, null, null, null, null, null, lr.l.b(oVar, new Function0() { // from class: com.discord.chat.bridge.botuikit.b
        ...
        }), lr.l.b(oVar, new Function0() { // from class: com.discord.chat.bridge.botuikit.c
            @Override // kotlin.jvm.functions.Function0
            public final Object invoke() {
    ...
    public static final /* synthetic */ void write$Self$chat_release(ChannelSelectComponent channelSelectComponent, CompositeEncoder compositeEncoder, SerialDescriptor serialDescriptor) {
        ...
        compositeEncoder.D(serialDescriptor, 2, ActionComponentState.Serializer.INSTANCE, channelSelectComponent.getState());
        ...
        if (compositeEncoder.z(serialDescriptor, 4) || channelSelectComponent.getPlaceholder() != null) {
            compositeEncoder.s(serialDescriptor, 4, n2.f20978a, channelSelectComponent.getPlaceholder());
        }
        if (compositeEncoder.z(serialDescriptor, 5) || channelSelectComponent.getAccessibilityLabel() != null) {
            compositeEncoder.s(serialDescriptor, 5, n2.f20978a, channelSelectComponent.getAccessibilityLabel());
        }
        ...
        compositeEncoder.D(serialDescriptor, 9, (at.o) lazyArr[9].getValue(), channelSelectComponent.getSelectedOptions());
        if (compositeEncoder.z(serialDescriptor, 10) || channelSelectComponent.channelTypes != null) {
            compositeEncoder.s(serialDescriptor, 10, (at.o) lazyArr[10].getValue(), channelSelectComponent.channelTypes);
        }
    }
