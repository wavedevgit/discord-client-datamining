...
public final class ChannelSelectComponent extends SearchableSelectComponent {
    ...
    static {
        ...
        $childSerializers = new Lazy[]{null, null, null, null, null, null, null, null, null, as.l.a(oVar, new Function0() { // from class: com.discord.chat.bridge.botuikit.b
        ...
        }), as.l.a(oVar, new Function0() { // from class: com.discord.chat.bridge.botuikit.c
            @Override // kotlin.jvm.functions.Function0
            public final Object invoke() {
    ...
    public static final /* synthetic */ void write$Self$chat_release(ChannelSelectComponent channelSelectComponent, CompositeEncoder compositeEncoder, SerialDescriptor serialDescriptor) {
        ...
        compositeEncoder.k(serialDescriptor, 9, (qt.o) lazyArr[9].getValue(), channelSelectComponent.getSelectedOptions());
        if (compositeEncoder.z(serialDescriptor, 10) || channelSelectComponent.channelTypes != null) {
            compositeEncoder.o(serialDescriptor, 10, (qt.o) lazyArr[10].getValue(), channelSelectComponent.channelTypes);
        }
    }
