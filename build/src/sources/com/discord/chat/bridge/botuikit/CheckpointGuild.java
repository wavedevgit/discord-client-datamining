...
public final class CheckpointGuild {
    ...
    public static /* synthetic */ CheckpointGuild m262copyPzX8qg4$default(CheckpointGuild checkpointGuild, String str, long j10, String str2, int i10, Object obj) {
        if ((i10 & 1) != 0) {
        ...
        return checkpointGuild.m264copyPzX8qg4(str, j10, str2);
    }
    ...
    public static final /* synthetic */ void write$Self$chat_release(CheckpointGuild checkpointGuild, CompositeEncoder compositeEncoder, SerialDescriptor serialDescriptor) {
        ...
        if (compositeEncoder.z(serialDescriptor, 2) || checkpointGuild.guildIcon != null) {
            compositeEncoder.o(serialDescriptor, 2, n2.f50601a, checkpointGuild.guildIcon);
        }
    }
    ...
    public final long m263component2fYKD8eg() {
        return this.guildId;
    }
    ...
    public final CheckpointGuild m264copyPzX8qg4(@NotNull String guildName, long j10, String str) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof CheckpointGuild) {
            ...
            return Intrinsics.areEqual(this.guildName, checkpointGuild.guildName) && GuildId.m1075equalsimpl0(this.guildId, checkpointGuild.guildId) && Intrinsics.areEqual(this.guildIcon, checkpointGuild.guildIcon);
        }
        return false;
    }
    ...
    public final long m265getGuildIdfYKD8eg() {
        return this.guildId;
    }
    ...
    public int hashCode() {
        int hashCode = ((this.guildName.hashCode() * 31) + GuildId.m1076hashCodeimpl(this.guildId)) * 31;
    ...
    public String toString() {
        ...
        return "CheckpointGuild(guildName=" + str + ", guildId=" + m1078toStringimpl + ", guildIcon=" + str2 + ")";
    }
