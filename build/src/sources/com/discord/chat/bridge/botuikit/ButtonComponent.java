...
public final class ButtonComponent extends BaseActionComponent {
    ...
    public static final /* synthetic */ void write$Self$chat_release(ButtonComponent buttonComponent, CompositeEncoder compositeEncoder, SerialDescriptor serialDescriptor) {
        ...
        compositeEncoder.j(serialDescriptor, 2, ActionComponentState.Serializer.INSTANCE, buttonComponent.getState());
        if (compositeEncoder.A(serialDescriptor, 3) || buttonComponent.getCustomId() != null) {
            compositeEncoder.z(serialDescriptor, 3, n2.f6848a, buttonComponent.getCustomId());
        }
        if (compositeEncoder.A(serialDescriptor, 4) || buttonComponent.label != null) {
            compositeEncoder.z(serialDescriptor, 4, n2.f6848a, buttonComponent.label);
        }
        compositeEncoder.j(serialDescriptor, 5, ButtonStyle.Serializer.INSTANCE, buttonComponent.style);
        ...
        if (compositeEncoder.A(serialDescriptor, 7) || buttonComponent.emoji != null) {
            compositeEncoder.z(serialDescriptor, 7, ComponentEmoji$$serializer.INSTANCE, buttonComponent.emoji);
        }
        if (compositeEncoder.A(serialDescriptor, 8) || buttonComponent.url != null) {
            compositeEncoder.z(serialDescriptor, 8, n2.f6848a, buttonComponent.url);
        }
        if (compositeEncoder.A(serialDescriptor, 9) || buttonComponent.skuId != null) {
            compositeEncoder.z(serialDescriptor, 9, n2.f6848a, buttonComponent.skuId);
        }
    }
    ...
    public int hashCode() {
        int hashCode = ((((Integer.hashCode(this.type) * 31) + this.f9640id.hashCode()) * 31) + this.state.hashCode()) * 31;
