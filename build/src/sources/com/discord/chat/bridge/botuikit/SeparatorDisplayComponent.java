...
public final class SeparatorDisplayComponent extends Component {
    ...
    public static /* synthetic */ SeparatorDisplayComponent copy$default(SeparatorDisplayComponent separatorDisplayComponent, int i10, String str, boolean z10, SeparatorSpacingSize separatorSpacingSize, int i11, Object obj) {
        ...
        if ((i11 & 2) != 0) {
            str = separatorDisplayComponent.f9655id;
        }
        if ((i11 & 4) != 0) {
    ...
    public static final /* synthetic */ void write$Self$chat_release(SeparatorDisplayComponent separatorDisplayComponent, CompositeEncoder compositeEncoder, SerialDescriptor serialDescriptor) {
        compositeEncoder.w(serialDescriptor, 0, separatorDisplayComponent.getType());
        compositeEncoder.y(serialDescriptor, 1, separatorDisplayComponent.getId());
        compositeEncoder.x(serialDescriptor, 2, separatorDisplayComponent.divider);
        compositeEncoder.j(serialDescriptor, 3, SeparatorSpacingSize.Serializer.INSTANCE, separatorDisplayComponent.spacing);
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof SeparatorDisplayComponent) {
            ...
            return this.type == separatorDisplayComponent.type && Intrinsics.areEqual(this.f9655id, separatorDisplayComponent.f9655id) && this.divider == separatorDisplayComponent.divider && this.spacing == separatorDisplayComponent.spacing;
        }
        return false;
    }
    ...
    public int hashCode() {
        return (((((Integer.hashCode(this.type) * 31) + this.f9655id.hashCode()) * 31) + Boolean.hashCode(this.divider)) * 31) + this.spacing.hashCode();
    }

    @NotNull
    public String toString() {
        int i10 = this.type;
        String str = this.f9655id;
