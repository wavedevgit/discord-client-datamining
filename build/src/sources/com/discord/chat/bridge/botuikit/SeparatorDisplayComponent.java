...
public final class SeparatorDisplayComponent extends Component {
    ...
    public static /* synthetic */ SeparatorDisplayComponent copy$default(SeparatorDisplayComponent separatorDisplayComponent, int i10, String str, boolean z10, SeparatorSpacingSize separatorSpacingSize, int i11, Object obj) {
        ...
        if ((i11 & 2) != 0) {
            str = separatorDisplayComponent.f9253id;
        }
        if ((i11 & 4) != 0) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof SeparatorDisplayComponent) {
            ...
            return this.type == separatorDisplayComponent.type && Intrinsics.areEqual(this.f9253id, separatorDisplayComponent.f9253id) && this.divider == separatorDisplayComponent.divider && this.spacing == separatorDisplayComponent.spacing;
        }
        return false;
    }
    ...
    public int hashCode() {
        return (((((Integer.hashCode(this.type) * 31) + this.f9253id.hashCode()) * 31) + Boolean.hashCode(this.divider)) * 31) + this.spacing.hashCode();
    }
