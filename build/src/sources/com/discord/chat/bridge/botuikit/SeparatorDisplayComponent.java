...
public final class SeparatorDisplayComponent extends Component {
    ...
    public static /* synthetic */ SeparatorDisplayComponent copy$default(SeparatorDisplayComponent separatorDisplayComponent, int i10, String str, boolean z10, SeparatorSpacingSize separatorSpacingSize, int i11, Object obj) {
        ...
        if ((i11 & 2) != 0) {
            str = separatorDisplayComponent.f8675id;
        }
        if ((i11 & 4) != 0) {
    ...
    public static final /* synthetic */ void write$Self$chat_release(SeparatorDisplayComponent separatorDisplayComponent, CompositeEncoder compositeEncoder, SerialDescriptor serialDescriptor) {
        ...
        compositeEncoder.F(serialDescriptor, 3, SeparatorSpacingSize.Serializer.INSTANCE, separatorDisplayComponent.spacing);
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof SeparatorDisplayComponent) {
            ...
            return this.type == separatorDisplayComponent.type && Intrinsics.areEqual(this.f8675id, separatorDisplayComponent.f8675id) && this.divider == separatorDisplayComponent.divider && this.spacing == separatorDisplayComponent.spacing;
        }
        return false;
    }
    ...
    public int hashCode() {
        return (((((Integer.hashCode(this.type) * 31) + this.f8675id.hashCode()) * 31) + Boolean.hashCode(this.divider)) * 31) + this.spacing.hashCode();
    }

    @NotNull
    public String toString() {
        int i10 = this.type;
        String str = this.f8675id;
