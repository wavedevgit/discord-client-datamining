...
public final class MentionableSelectComponent extends SearchableSelectComponent {
    ...
    @NotNull
    private static final Lazy[] $childSerializers = {null, null, null, null, null, null, null, null, null, qr.l.b(qr.o.f48044e, new Function0() { // from class: com.discord.chat.bridge.botuikit.h
    ...
    public static /* synthetic */ MentionableSelectComponent copy$default(MentionableSelectComponent mentionableSelectComponent, int i10, String str, ActionComponentState actionComponentState, String str2, String str3, String str4, int i11, int i12, boolean z10, List list, int i13, Object obj) {
        ...
        if ((i13 & 2) != 0) {
            str = mentionableSelectComponent.f8532id;
        }
        if ((i13 & 4) != 0) {
    ...
    public static final /* synthetic */ void write$Self$chat_release(MentionableSelectComponent mentionableSelectComponent, CompositeEncoder compositeEncoder, SerialDescriptor serialDescriptor) {
        ...
        compositeEncoder.x(serialDescriptor, 0, mentionableSelectComponent.getType());
        compositeEncoder.z(serialDescriptor, 1, mentionableSelectComponent.getId());
        compositeEncoder.s(serialDescriptor, 2, ActionComponentState.Serializer.INSTANCE, mentionableSelectComponent.getState());
        compositeEncoder.z(serialDescriptor, 3, mentionableSelectComponent.getCustomId());
        if (compositeEncoder.A(serialDescriptor, 4) || mentionableSelectComponent.getPlaceholder() != null) {
            compositeEncoder.l(serialDescriptor, 4, n2.f31041a, mentionableSelectComponent.getPlaceholder());
        }
        if (compositeEncoder.A(serialDescriptor, 5) || mentionableSelectComponent.getAccessibilityLabel() != null) {
            compositeEncoder.l(serialDescriptor, 5, n2.f31041a, mentionableSelectComponent.getAccessibilityLabel());
        }
        compositeEncoder.x(serialDescriptor, 6, mentionableSelectComponent.getMinValues());
        compositeEncoder.x(serialDescriptor, 7, mentionableSelectComponent.getMaxValues());
        if (compositeEncoder.A(serialDescriptor, 8) || mentionableSelectComponent.getDisabled()) {
            compositeEncoder.y(serialDescriptor, 8, mentionableSelectComponent.getDisabled());
        }
        compositeEncoder.s(serialDescriptor, 9, (ft.o) lazyArr[9].getValue(), mentionableSelectComponent.getSelectedOptions());
    }
    ...
    public int hashCode() {
        int hashCode = ((((((Integer.hashCode(this.type) * 31) + this.f8532id.hashCode()) * 31) + this.state.hashCode()) * 31) + this.customId.hashCode()) * 31;
