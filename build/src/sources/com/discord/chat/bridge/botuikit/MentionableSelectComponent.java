...
public final class MentionableSelectComponent extends SearchableSelectComponent {
    ...
    @NotNull
    private static final Lazy[] $childSerializers = {null, null, null, null, null, null, null, null, null, rr.l.b(rr.o.f49210e, new Function0() { // from class: com.discord.chat.bridge.botuikit.h
    ...
    public static /* synthetic */ MentionableSelectComponent copy$default(MentionableSelectComponent mentionableSelectComponent, int i10, String str, ActionComponentState actionComponentState, String str2, String str3, String str4, int i11, int i12, boolean z10, List list, int i13, Object obj) {
        ...
        if ((i13 & 2) != 0) {
            str = mentionableSelectComponent.f8672id;
        }
        if ((i13 & 4) != 0) {
    ...
    public static final /* synthetic */ void write$Self$chat_release(MentionableSelectComponent mentionableSelectComponent, CompositeEncoder compositeEncoder, SerialDescriptor serialDescriptor) {
        ...
        compositeEncoder.F(serialDescriptor, 2, ActionComponentState.Serializer.INSTANCE, mentionableSelectComponent.getState());
        ...
        if (compositeEncoder.z(serialDescriptor, 4) || mentionableSelectComponent.getPlaceholder() != null) {
            compositeEncoder.i(serialDescriptor, 4, n2.f35181a, mentionableSelectComponent.getPlaceholder());
        }
        if (compositeEncoder.z(serialDescriptor, 5) || mentionableSelectComponent.getAccessibilityLabel() != null) {
            compositeEncoder.i(serialDescriptor, 5, n2.f35181a, mentionableSelectComponent.getAccessibilityLabel());
        }
        ...
        compositeEncoder.F(serialDescriptor, 9, (gt.o) lazyArr[9].getValue(), mentionableSelectComponent.getSelectedOptions());
    }
    ...
    public int hashCode() {
        int hashCode = ((((((Integer.hashCode(this.type) * 31) + this.f8672id.hashCode()) * 31) + this.state.hashCode()) * 31) + this.customId.hashCode()) * 31;
