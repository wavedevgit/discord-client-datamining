...
public final class ComponentSerializer extends ut.e {
    @NotNull
    ...
    protected DeserializationStrategy selectDeserializer(@NotNull JsonElement element) {
        ...
        if (jsonElement != null && (o10 = ut.h.o(jsonElement)) != null) {
            num = Integer.valueOf(ut.h.k(o10));
        } else {
            num = null;
        }
