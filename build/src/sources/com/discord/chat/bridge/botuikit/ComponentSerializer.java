...
public final class ComponentSerializer extends bt.e {
    @NotNull
    ...
    protected DeserializationStrategy selectDeserializer(@NotNull JsonElement element) {
        ...
        if (jsonElement != null && (o10 = bt.h.o(jsonElement)) != null) {
            num = Integer.valueOf(bt.h.k(o10));
        } else {
            num = null;
        }
