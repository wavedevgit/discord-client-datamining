...
public final class ComponentSerializer extends ct.e {
    @NotNull
    ...
    protected DeserializationStrategy selectDeserializer(@NotNull JsonElement element) {
        ...
        if (jsonElement != null && (o10 = ct.h.o(jsonElement)) != null) {
            num = Integer.valueOf(ct.h.k(o10));
        } else {
            num = null;
        }
