...
public final class ThumbnailDisplayComponent extends Component implements SpoilerableData {
    ...
    */
    ...
    public int hashCode() {
        int hashCode = ((((Integer.hashCode(this.type) * 31) + this.f8678id.hashCode()) * 31) + this.media.hashCode()) * 31;
