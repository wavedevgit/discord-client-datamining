...
public final class RoleSelectComponent extends SearchableSelectComponent {
    ...
    @NotNull
    private static final Lazy[] $childSerializers = {null, null, null, null, null, null, null, null, null, jr.l.a(jr.o.f32182e, new Function0() { // from class: com.discord.chat.bridge.botuikit.i
    ...
    public static /* synthetic */ RoleSelectComponent copy$default(RoleSelectComponent roleSelectComponent, int i10, String str, ActionComponentState actionComponentState, String str2, String str3, String str4, int i11, int i12, boolean z10, List list, int i13, Object obj) {
        ...
        if ((i13 & 2) != 0) {
            str = roleSelectComponent.f9282id;
        }
        if ((i13 & 4) != 0) {
    ...
    public static final /* synthetic */ void write$Self$chat_release(RoleSelectComponent roleSelectComponent, CompositeEncoder compositeEncoder, SerialDescriptor serialDescriptor) {
        ...
        compositeEncoder.v(serialDescriptor, 0, roleSelectComponent.getType());
        compositeEncoder.x(serialDescriptor, 1, roleSelectComponent.getId());
        compositeEncoder.m(serialDescriptor, 2, ActionComponentState.Serializer.INSTANCE, roleSelectComponent.getState());
        compositeEncoder.x(serialDescriptor, 3, roleSelectComponent.getCustomId());
        if (compositeEncoder.y(serialDescriptor, 4) || roleSelectComponent.getPlaceholder() != null) {
            compositeEncoder.B(serialDescriptor, 4, n2.f7662a, roleSelectComponent.getPlaceholder());
        }
        if (compositeEncoder.y(serialDescriptor, 5) || roleSelectComponent.getAccessibilityLabel() != null) {
            compositeEncoder.B(serialDescriptor, 5, n2.f7662a, roleSelectComponent.getAccessibilityLabel());
        }
        compositeEncoder.v(serialDescriptor, 6, roleSelectComponent.getMinValues());
        compositeEncoder.v(serialDescriptor, 7, roleSelectComponent.getMaxValues());
        if (compositeEncoder.y(serialDescriptor, 8) || roleSelectComponent.getDisabled()) {
            compositeEncoder.w(serialDescriptor, 8, roleSelectComponent.getDisabled());
        }
        compositeEncoder.m(serialDescriptor, 9, (ys.o) lazyArr[9].getValue(), roleSelectComponent.getSelectedOptions());
    }
    ...
    public int hashCode() {
        int hashCode = ((((((Integer.hashCode(this.type) * 31) + this.f9282id.hashCode()) * 31) + this.state.hashCode()) * 31) + this.customId.hashCode()) * 31;
