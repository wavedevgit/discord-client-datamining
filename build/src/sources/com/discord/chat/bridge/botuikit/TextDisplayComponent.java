...
public final class TextDisplayComponent extends Component {
    ...
    public static /* synthetic */ TextDisplayComponent copy$default(TextDisplayComponent textDisplayComponent, int i10, String str, StructurableText structurableText, int i11, Object obj) {
        ...
        if ((i11 & 2) != 0) {
            str = textDisplayComponent.f9286id;
        }
        if ((i11 & 4) != 0) {
    ...
    public static final /* synthetic */ void write$Self$chat_release(TextDisplayComponent textDisplayComponent, CompositeEncoder compositeEncoder, SerialDescriptor serialDescriptor) {
        ...
        compositeEncoder.m(serialDescriptor, 2, StructurableTextSerializer.INSTANCE, textDisplayComponent.content);
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof TextDisplayComponent) {
            ...
            return this.type == textDisplayComponent.type && Intrinsics.areEqual(this.f9286id, textDisplayComponent.f9286id) && Intrinsics.areEqual(this.content, textDisplayComponent.content);
        }
        return false;
    }
    ...
    public int hashCode() {
        return (((Integer.hashCode(this.type) * 31) + this.f9286id.hashCode()) * 31) + this.content.hashCode();
    }

    @NotNull
    public String toString() {
        int i10 = this.type;
        String str = this.f9286id;
