...
public final class TextDisplayComponent extends Component {
    ...
    public static /* synthetic */ TextDisplayComponent copy$default(TextDisplayComponent textDisplayComponent, int i10, String str, StructurableText structurableText, int i11, Object obj) {
        ...
        if ((i11 & 2) != 0) {
            str = textDisplayComponent.f9255id;
        }
        if ((i11 & 4) != 0) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof TextDisplayComponent) {
            ...
            return this.type == textDisplayComponent.type && Intrinsics.areEqual(this.f9255id, textDisplayComponent.f9255id) && Intrinsics.areEqual(this.content, textDisplayComponent.content);
        }
        return false;
    }
    ...
    public int hashCode() {
        return (((Integer.hashCode(this.type) * 31) + this.f9255id.hashCode()) * 31) + this.content.hashCode();
    }
