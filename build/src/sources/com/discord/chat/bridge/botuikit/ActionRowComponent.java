...
public final class ActionRowComponent extends BaseLayoutComponent {
    ...
    private final String f8620id;
    private final int type;
    @NotNull
    public static final Companion Companion = new Companion(null);
    @NotNull
    private static final Lazy[] $childSerializers = {null, null, null, or.l.b(or.o.f44232e, new Function0() { // from class: com.discord.chat.bridge.botuikit.a
    ...
    public static /* synthetic */ ActionRowComponent copy$default(ActionRowComponent actionRowComponent, int i10, String str, String str2, List list, int i11, Object obj) {
        ...
        if ((i11 & 2) != 0) {
            str = actionRowComponent.f8620id;
        }
        if ((i11 & 4) != 0) {
    ...
    public static final /* synthetic */ void write$Self$chat_release(ActionRowComponent actionRowComponent, CompositeEncoder compositeEncoder, SerialDescriptor serialDescriptor) {
        ...
        if (compositeEncoder.z(serialDescriptor, 2) || actionRowComponent.getErrorText() != null) {
            compositeEncoder.A(serialDescriptor, 2, n2.f25302a, actionRowComponent.getErrorText());
        }
        compositeEncoder.l(serialDescriptor, 3, (dt.o) lazyArr[3].getValue(), actionRowComponent.components);
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof ActionRowComponent) {
            ...
            return this.type == actionRowComponent.type && Intrinsics.areEqual(this.f8620id, actionRowComponent.f8620id) && Intrinsics.areEqual(this.errorText, actionRowComponent.errorText) && Intrinsics.areEqual(this.components, actionRowComponent.components);
        }
        return false;
    }
    ...
    public int hashCode() {
        int hashCode = ((Integer.hashCode(this.type) * 31) + this.f8620id.hashCode()) * 31;
