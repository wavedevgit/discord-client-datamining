...
public final class ActionRowComponent extends BaseLayoutComponent {
    ...
    private final String f9639id;
    private final int type;
    @NotNull
    public static final Companion Companion = new Companion(null);
    @NotNull
    private static final Lazy[] $childSerializers = {null, null, null, ir.l.a(ir.o.f31119e, new Function0() { // from class: com.discord.chat.bridge.botuikit.a
    ...
    public static final /* synthetic */ KSerializer _childSerializers$_anonymous_() {
        return new at.f(ComponentSerializer.INSTANCE);
    }
    ...
    public static /* synthetic */ ActionRowComponent copy$default(ActionRowComponent actionRowComponent, int i10, String str, String str2, List list, int i11, Object obj) {
        ...
        if ((i11 & 2) != 0) {
            str = actionRowComponent.f9639id;
        }
        if ((i11 & 4) != 0) {
    ...
    public static final /* synthetic */ void write$Self$chat_release(ActionRowComponent actionRowComponent, CompositeEncoder compositeEncoder, SerialDescriptor serialDescriptor) {
        ...
        if (compositeEncoder.A(serialDescriptor, 2) || actionRowComponent.getErrorText() != null) {
            compositeEncoder.z(serialDescriptor, 2, n2.f6848a, actionRowComponent.getErrorText());
        }
        compositeEncoder.j(serialDescriptor, 3, (xs.o) lazyArr[3].getValue(), actionRowComponent.components);
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof ActionRowComponent) {
            ...
            return this.type == actionRowComponent.type && Intrinsics.areEqual(this.f9639id, actionRowComponent.f9639id) && Intrinsics.areEqual(this.errorText, actionRowComponent.errorText) && Intrinsics.areEqual(this.components, actionRowComponent.components);
        }
        return false;
    }
    ...
    public int hashCode() {
        int hashCode = ((Integer.hashCode(this.type) * 31) + this.f9639id.hashCode()) * 31;
