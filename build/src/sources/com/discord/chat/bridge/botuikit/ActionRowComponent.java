...
public final class ActionRowComponent extends BaseLayoutComponent {
    ...
    private final String f9268id;
    private final int type;
    @NotNull
    public static final Companion Companion = new Companion(null);
    @NotNull
    private static final Lazy[] $childSerializers = {null, null, null, jr.l.a(jr.o.f32182e, new Function0() { // from class: com.discord.chat.bridge.botuikit.a
    ...
    public static final /* synthetic */ KSerializer _childSerializers$_anonymous_() {
        return new bt.f(ComponentSerializer.INSTANCE);
    }
    ...
    public static /* synthetic */ ActionRowComponent copy$default(ActionRowComponent actionRowComponent, int i10, String str, String str2, List list, int i11, Object obj) {
        ...
        if ((i11 & 2) != 0) {
            str = actionRowComponent.f9268id;
        }
        if ((i11 & 4) != 0) {
    ...
    public static final /* synthetic */ void write$Self$chat_release(ActionRowComponent actionRowComponent, CompositeEncoder compositeEncoder, SerialDescriptor serialDescriptor) {
        ...
        compositeEncoder.v(serialDescriptor, 0, actionRowComponent.getType());
        compositeEncoder.x(serialDescriptor, 1, actionRowComponent.getId());
        if (compositeEncoder.y(serialDescriptor, 2) || actionRowComponent.getErrorText() != null) {
            compositeEncoder.B(serialDescriptor, 2, n2.f7662a, actionRowComponent.getErrorText());
        }
        compositeEncoder.m(serialDescriptor, 3, (ys.o) lazyArr[3].getValue(), actionRowComponent.components);
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof ActionRowComponent) {
            ...
            return this.type == actionRowComponent.type && Intrinsics.areEqual(this.f9268id, actionRowComponent.f9268id) && Intrinsics.areEqual(this.errorText, actionRowComponent.errorText) && Intrinsics.areEqual(this.components, actionRowComponent.components);
        }
        return false;
    }
    ...
    public int hashCode() {
        int hashCode = ((Integer.hashCode(this.type) * 31) + this.f9268id.hashCode()) * 31;
