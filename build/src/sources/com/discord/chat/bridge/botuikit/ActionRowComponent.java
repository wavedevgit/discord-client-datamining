...
public final class ActionRowComponent extends BaseLayoutComponent {
    ...
    @NotNull
    private static final Lazy[] $childSerializers = {null, null, null, lr.l.b(lr.o.f37120e, new Function0() { // from class: com.discord.chat.bridge.botuikit.a
    ...
    public static final /* synthetic */ KSerializer _childSerializers$_anonymous_() {
        return new dt.f(ComponentSerializer.INSTANCE);
    }
    ...
    public static final /* synthetic */ void write$Self$chat_release(ActionRowComponent actionRowComponent, CompositeEncoder compositeEncoder, SerialDescriptor serialDescriptor) {
        ...
        if (compositeEncoder.z(serialDescriptor, 2) || actionRowComponent.getErrorText() != null) {
            compositeEncoder.s(serialDescriptor, 2, n2.f20978a, actionRowComponent.getErrorText());
        }
        compositeEncoder.D(serialDescriptor, 3, (at.o) lazyArr[3].getValue(), actionRowComponent.components);
    }
