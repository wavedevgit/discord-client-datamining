...
public final class CheckpointApplication {
    ...
    public static /* synthetic */ CheckpointApplication m253copy0O3FufA$default(CheckpointApplication checkpointApplication, long j10, String str, String str2, int i10, Object obj) {
        if ((i10 & 1) != 0) {
        ...
        return checkpointApplication.m255copy0O3FufA(j10, str, str2);
    }
    ...
    public static final /* synthetic */ void write$Self$chat_release(CheckpointApplication checkpointApplication, CompositeEncoder compositeEncoder, SerialDescriptor serialDescriptor) {
        compositeEncoder.F(serialDescriptor, 0, ApplicationId$$serializer.INSTANCE, ApplicationId.m1044boximpl(checkpointApplication.applicationId));
        if (compositeEncoder.z(serialDescriptor, 1) || checkpointApplication.applicationImageId != null) {
            compositeEncoder.i(serialDescriptor, 1, n2.f35181a, checkpointApplication.applicationImageId);
        }
        compositeEncoder.y(serialDescriptor, 2, checkpointApplication.applicationName);
    }

    /* renamed from: component1-VavddsQ  reason: not valid java name */
    public final long m254component1VavddsQ() {
    ...
    public final CheckpointApplication m255copy0O3FufA(long j10, String str, @NotNull String applicationName) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof CheckpointApplication) {
            ...
            return ApplicationId.m1048equalsimpl0(this.applicationId, checkpointApplication.applicationId) && Intrinsics.areEqual(this.applicationImageId, checkpointApplication.applicationImageId) && Intrinsics.areEqual(this.applicationName, checkpointApplication.applicationName);
        }
        return false;
    }

    /* renamed from: getApplicationId-VavddsQ  reason: not valid java name */
    public final long m256getApplicationIdVavddsQ() {
        return this.applicationId;
    }
    ...
    public int hashCode() {
        int m1049hashCodeimpl = ApplicationId.m1049hashCodeimpl(this.applicationId) * 31;
        String str = this.applicationImageId;
        return ((m1049hashCodeimpl + (str == null ? 0 : str.hashCode())) * 31) + this.applicationName.hashCode();
    }
    ...
    public String toString() {
        ...
        return "CheckpointApplication(applicationId=" + m1051toStringimpl + ", applicationImageId=" + str + ", applicationName=" + str2 + ")";
    }
