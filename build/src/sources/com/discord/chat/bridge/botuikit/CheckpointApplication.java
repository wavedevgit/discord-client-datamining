...
public final class CheckpointApplication {
    ...
    public static final /* synthetic */ void write$Self$chat_release(CheckpointApplication checkpointApplication, CompositeEncoder compositeEncoder, SerialDescriptor serialDescriptor) {
        compositeEncoder.m(serialDescriptor, 0, ApplicationId$$serializer.INSTANCE, ApplicationId.m1047boximpl(checkpointApplication.applicationId));
        if (compositeEncoder.y(serialDescriptor, 1) || checkpointApplication.applicationImageId != null) {
            compositeEncoder.B(serialDescriptor, 1, n2.f7662a, checkpointApplication.applicationImageId);
        }
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof CheckpointApplication) {
            ...
            return ApplicationId.m1051equalsimpl0(this.applicationId, checkpointApplication.applicationId) && Intrinsics.areEqual(this.applicationImageId, checkpointApplication.applicationImageId) && Intrinsics.areEqual(this.applicationName, checkpointApplication.applicationName);
        }
        return false;
    }
    ...
    public int hashCode() {
        int m1052hashCodeimpl = ApplicationId.m1052hashCodeimpl(this.applicationId) * 31;
        String str = this.applicationImageId;
        return ((m1052hashCodeimpl + (str == null ? 0 : str.hashCode())) * 31) + this.applicationName.hashCode();
    }

    @NotNull
    public String toString() {
        String m1054toStringimpl = ApplicationId.m1054toStringimpl(this.applicationId);
        String str = this.applicationImageId;
        String str2 = this.applicationName;
        return "CheckpointApplication(applicationId=" + m1054toStringimpl + ", applicationImageId=" + str + ", applicationName=" + str2 + ")";
    }
    ...
    private /* synthetic */ CheckpointApplication(int i10, ApplicationId applicationId, String str, String str2, SerializationConstructorMarker serializationConstructorMarker) {
        ...
        this.applicationId = applicationId.m1056unboximpl();
        if ((i10 & 2) == 0) {
