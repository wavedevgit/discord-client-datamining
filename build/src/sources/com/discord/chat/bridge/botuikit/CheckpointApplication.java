...
public final class CheckpointApplication {
    ...
    public static final /* synthetic */ void write$Self$chat_release(CheckpointApplication checkpointApplication, CompositeEncoder compositeEncoder, SerialDescriptor serialDescriptor) {
        compositeEncoder.j(serialDescriptor, 0, ApplicationId$$serializer.INSTANCE, ApplicationId.m1045boximpl(checkpointApplication.applicationId));
        if (compositeEncoder.A(serialDescriptor, 1) || checkpointApplication.applicationImageId != null) {
            compositeEncoder.z(serialDescriptor, 1, n2.f6848a, checkpointApplication.applicationImageId);
        }
