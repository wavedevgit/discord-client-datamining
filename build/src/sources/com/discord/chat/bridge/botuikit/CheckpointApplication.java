...
public final class CheckpointApplication {
    ...
    public static /* synthetic */ CheckpointApplication m254copy0O3FufA$default(CheckpointApplication checkpointApplication, long j10, String str, String str2, int i10, Object obj) {
        if ((i10 & 1) != 0) {
        ...
        return checkpointApplication.m256copy0O3FufA(j10, str, str2);
    }
    ...
    public static final /* synthetic */ void write$Self$chat_release(CheckpointApplication checkpointApplication, CompositeEncoder compositeEncoder, SerialDescriptor serialDescriptor) {
        compositeEncoder.k(serialDescriptor, 0, ApplicationId$$serializer.INSTANCE, ApplicationId.m1045boximpl(checkpointApplication.applicationId));
        if (compositeEncoder.z(serialDescriptor, 1) || checkpointApplication.applicationImageId != null) {
            compositeEncoder.o(serialDescriptor, 1, n2.f50601a, checkpointApplication.applicationImageId);
        }
    ...
    public final long m255component1VavddsQ() {
    ...
    public final CheckpointApplication m256copy0O3FufA(long j10, String str, @NotNull String applicationName) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof CheckpointApplication) {
            ...
            return ApplicationId.m1049equalsimpl0(this.applicationId, checkpointApplication.applicationId) && Intrinsics.areEqual(this.applicationImageId, checkpointApplication.applicationImageId) && Intrinsics.areEqual(this.applicationName, checkpointApplication.applicationName);
        }
        return false;
    }

    /* renamed from: getApplicationId-VavddsQ  reason: not valid java name */
    public final long m257getApplicationIdVavddsQ() {
        return this.applicationId;
    }
    ...
    public int hashCode() {
        int m1050hashCodeimpl = ApplicationId.m1050hashCodeimpl(this.applicationId) * 31;
        String str = this.applicationImageId;
        return ((m1050hashCodeimpl + (str == null ? 0 : str.hashCode())) * 31) + this.applicationName.hashCode();
    }
    ...
    public String toString() {
        ...
        return "CheckpointApplication(applicationId=" + m1052toStringimpl + ", applicationImageId=" + str + ", applicationName=" + str2 + ")";
    }
