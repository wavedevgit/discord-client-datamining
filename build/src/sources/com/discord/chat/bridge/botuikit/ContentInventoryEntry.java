...
public final class ContentInventoryEntry {
    ...
    static {
        ...
        $childSerializers = new Lazy[]{null, null, null, null, null, null, null, null, null, null, null, as.l.a(oVar, new Function0() { // from class: com.discord.chat.bridge.botuikit.e
        ...
        }), as.l.a(oVar, new Function0() { // from class: com.discord.chat.bridge.botuikit.f
            @Override // kotlin.jvm.functions.Function0
            public final Object invoke() {
    ...
    public static final /* synthetic */ KSerializer _childSerializers$_anonymous_() {
        return new tt.f(Subtitle$$serializer.INSTANCE);
    }

    /* JADX INFO: Access modifiers changed from: private */
    public static final /* synthetic */ KSerializer _childSerializers$_anonymous_$0() {
        return new tt.f(GradientColor$$serializer.INSTANCE);
    }
    ...
    public static final /* synthetic */ void write$Self$chat_release(ContentInventoryEntry contentInventoryEntry, CompositeEncoder compositeEncoder, SerialDescriptor serialDescriptor) {
        ...
        compositeEncoder.k(serialDescriptor, 0, UserId$$serializer.INSTANCE, UserId.m1136boximpl(contentInventoryEntry.authorId));
        ...
        if (compositeEncoder.z(serialDescriptor, 3) || contentInventoryEntry.imageClickable != null) {
            compositeEncoder.o(serialDescriptor, 3, ContentInventoryEntryClickable$$serializer.INSTANCE, contentInventoryEntry.imageClickable);
        }
        ...
        if (compositeEncoder.z(serialDescriptor, 5) || contentInventoryEntry.platformIconUrl != null) {
            compositeEncoder.o(serialDescriptor, 5, n2.f50032a, contentInventoryEntry.platformIconUrl);
        }
        ...
        if (compositeEncoder.z(serialDescriptor, 8) || contentInventoryEntry.userClickable != null) {
            compositeEncoder.o(serialDescriptor, 8, ContentInventoryEntryClickable$$serializer.INSTANCE, contentInventoryEntry.userClickable);
        }
        ...
        if (compositeEncoder.z(serialDescriptor, 10) || contentInventoryEntry.titleClickable != null) {
            compositeEncoder.o(serialDescriptor, 10, ContentInventoryEntryClickable$$serializer.INSTANCE, contentInventoryEntry.titleClickable);
        }
        compositeEncoder.k(serialDescriptor, 11, (qt.o) lazyArr[11].getValue(), contentInventoryEntry.subtitles);
        compositeEncoder.k(serialDescriptor, 12, (qt.o) lazyArr[12].getValue(), contentInventoryEntry.gradientColors);
        if (compositeEncoder.z(serialDescriptor, 13) || contentInventoryEntry.clickable != null) {
            compositeEncoder.o(serialDescriptor, 13, ContentInventoryEntryClickable$$serializer.INSTANCE, contentInventoryEntry.clickable);
        }
    }

    /* renamed from: component1-re6GcUE  reason: not valid java name */
    public final long m268component1re6GcUE() {
    ...
    public final long m270getAuthorIdre6GcUE() {
        return this.authorId;
    }
