...
public final class ContentInventoryEntry {
    ...
    static {
        ...
        $childSerializers = new Lazy[]{null, null, null, null, null, null, null, null, null, null, null, rr.l.b(oVar, new Function0() { // from class: com.discord.chat.bridge.botuikit.e
        ...
        }), rr.l.b(oVar, new Function0() { // from class: com.discord.chat.bridge.botuikit.f
            @Override // kotlin.jvm.functions.Function0
            public final Object invoke() {
    ...
    public static final /* synthetic */ KSerializer _childSerializers$_anonymous_() {
        return new kt.f(Subtitle$$serializer.INSTANCE);
    }

    /* JADX INFO: Access modifiers changed from: private */
    public static final /* synthetic */ KSerializer _childSerializers$_anonymous_$0() {
        return new kt.f(GradientColor$$serializer.INSTANCE);
    }
    ...
    public static final /* synthetic */ void write$Self$chat_release(ContentInventoryEntry contentInventoryEntry, CompositeEncoder compositeEncoder, SerialDescriptor serialDescriptor) {
        ...
        compositeEncoder.F(serialDescriptor, 0, UserId$$serializer.INSTANCE, UserId.m1135boximpl(contentInventoryEntry.authorId));
        ...
        if (compositeEncoder.z(serialDescriptor, 3) || contentInventoryEntry.imageClickable != null) {
            compositeEncoder.i(serialDescriptor, 3, ContentInventoryEntryClickable$$serializer.INSTANCE, contentInventoryEntry.imageClickable);
        }
        ...
        if (compositeEncoder.z(serialDescriptor, 5) || contentInventoryEntry.platformIconUrl != null) {
            compositeEncoder.i(serialDescriptor, 5, n2.f35181a, contentInventoryEntry.platformIconUrl);
        }
        if (compositeEncoder.z(serialDescriptor, 6) || contentInventoryEntry.platformClickable != null) {
            compositeEncoder.i(serialDescriptor, 6, ContentInventoryEntryClickable$$serializer.INSTANCE, contentInventoryEntry.platformClickable);
        }
        ...
        if (compositeEncoder.z(serialDescriptor, 8) || contentInventoryEntry.userClickable != null) {
            compositeEncoder.i(serialDescriptor, 8, ContentInventoryEntryClickable$$serializer.INSTANCE, contentInventoryEntry.userClickable);
        }
        ...
        if (compositeEncoder.z(serialDescriptor, 10) || contentInventoryEntry.titleClickable != null) {
            compositeEncoder.i(serialDescriptor, 10, ContentInventoryEntryClickable$$serializer.INSTANCE, contentInventoryEntry.titleClickable);
        }
        compositeEncoder.F(serialDescriptor, 11, (gt.o) lazyArr[11].getValue(), contentInventoryEntry.subtitles);
        compositeEncoder.F(serialDescriptor, 12, (gt.o) lazyArr[12].getValue(), contentInventoryEntry.gradientColors);
        if (compositeEncoder.z(serialDescriptor, 13) || contentInventoryEntry.clickable != null) {
            compositeEncoder.i(serialDescriptor, 13, ContentInventoryEntryClickable$$serializer.INSTANCE, contentInventoryEntry.clickable);
        }
    }
