...
public final class ContentInventoryEntry {
    ...
    static {
        ...
        }), qr.l.b(oVar, new Function0() { // from class: com.discord.chat.bridge.botuikit.f
            @Override // kotlin.jvm.functions.Function0
            public final Object invoke() {
    ...
    public static final /* synthetic */ KSerializer _childSerializers$_anonymous_() {
        return new jt.f(Subtitle$$serializer.INSTANCE);
    }

    /* JADX INFO: Access modifiers changed from: private */
    public static final /* synthetic */ KSerializer _childSerializers$_anonymous_$0() {
        return new jt.f(GradientColor$$serializer.INSTANCE);
    }
    ...
    public static final /* synthetic */ void write$Self$chat_release(ContentInventoryEntry contentInventoryEntry, CompositeEncoder compositeEncoder, SerialDescriptor serialDescriptor) {
        ...
        compositeEncoder.s(serialDescriptor, 0, UserId$$serializer.INSTANCE, UserId.m1135boximpl(contentInventoryEntry.authorId));
        compositeEncoder.z(serialDescriptor, 1, contentInventoryEntry.contentId);
        compositeEncoder.z(serialDescriptor, 2, contentInventoryEntry.imageUrl);
        if (compositeEncoder.A(serialDescriptor, 3) || contentInventoryEntry.imageClickable != null) {
            compositeEncoder.l(serialDescriptor, 3, ContentInventoryEntryClickable$$serializer.INSTANCE, contentInventoryEntry.imageClickable);
        }
        ...
        compositeEncoder.z(serialDescriptor, 7, contentInventoryEntry.userActionDescription);
        if (compositeEncoder.A(serialDescriptor, 8) || contentInventoryEntry.userClickable != null) {
            compositeEncoder.l(serialDescriptor, 8, ContentInventoryEntryClickable$$serializer.INSTANCE, contentInventoryEntry.userClickable);
        }
        compositeEncoder.z(serialDescriptor, 9, contentInventoryEntry.title);
        if (compositeEncoder.A(serialDescriptor, 10) || contentInventoryEntry.titleClickable != null) {
            compositeEncoder.l(serialDescriptor, 10, ContentInventoryEntryClickable$$serializer.INSTANCE, contentInventoryEntry.titleClickable);
        }
        compositeEncoder.s(serialDescriptor, 11, (ft.o) lazyArr[11].getValue(), contentInventoryEntry.subtitles);
        compositeEncoder.s(serialDescriptor, 12, (ft.o) lazyArr[12].getValue(), contentInventoryEntry.gradientColors);
        if (compositeEncoder.A(serialDescriptor, 13) || contentInventoryEntry.clickable != null) {
            compositeEncoder.l(serialDescriptor, 13, ContentInventoryEntryClickable$$serializer.INSTANCE, contentInventoryEntry.clickable);
        }
    }
    ...
    public int hashCode() {
        int m1140hashCodeimpl = ((((UserId.m1140hashCodeimpl(this.authorId) * 31) + this.contentId.hashCode()) * 31) + this.imageUrl.hashCode()) * 31;
        ContentInventoryEntryClickable contentInventoryEntryClickable = this.imageClickable;
        int hashCode = (((m1140hashCodeimpl + (contentInventoryEntryClickable == null ? 0 : contentInventoryEntryClickable.hashCode())) * 31) + this.avatarUrl.hashCode()) * 31;
