...
public final class ContentInventoryEntry {
    ...
    static {
        ...
        $childSerializers = new Lazy[]{null, null, null, null, null, null, null, null, null, null, null, ir.l.a(oVar, new Function0() { // from class: com.discord.chat.bridge.botuikit.e
        ...
        }), ir.l.a(oVar, new Function0() { // from class: com.discord.chat.bridge.botuikit.f
            @Override // kotlin.jvm.functions.Function0
            public final Object invoke() {
    ...
    public static final /* synthetic */ KSerializer _childSerializers$_anonymous_() {
        return new at.f(Subtitle$$serializer.INSTANCE);
    }

    /* JADX INFO: Access modifiers changed from: private */
    public static final /* synthetic */ KSerializer _childSerializers$_anonymous_$0() {
        return new at.f(GradientColor$$serializer.INSTANCE);
    }
    ...
    public static final /* synthetic */ void write$Self$chat_release(ContentInventoryEntry contentInventoryEntry, CompositeEncoder compositeEncoder, SerialDescriptor serialDescriptor) {
        ...
        compositeEncoder.j(serialDescriptor, 0, UserId$$serializer.INSTANCE, UserId.m1136boximpl(contentInventoryEntry.authorId));
        ...
        if (compositeEncoder.A(serialDescriptor, 3) || contentInventoryEntry.imageClickable != null) {
            compositeEncoder.z(serialDescriptor, 3, ContentInventoryEntryClickable$$serializer.INSTANCE, contentInventoryEntry.imageClickable);
        }
        ...
        if (compositeEncoder.A(serialDescriptor, 5) || contentInventoryEntry.platformIconUrl != null) {
            compositeEncoder.z(serialDescriptor, 5, n2.f6848a, contentInventoryEntry.platformIconUrl);
        }
        if (compositeEncoder.A(serialDescriptor, 6) || contentInventoryEntry.platformClickable != null) {
            compositeEncoder.z(serialDescriptor, 6, ContentInventoryEntryClickable$$serializer.INSTANCE, contentInventoryEntry.platformClickable);
        }
        compositeEncoder.y(serialDescriptor, 7, contentInventoryEntry.userActionDescription);
        if (compositeEncoder.A(serialDescriptor, 8) || contentInventoryEntry.userClickable != null) {
            compositeEncoder.z(serialDescriptor, 8, ContentInventoryEntryClickable$$serializer.INSTANCE, contentInventoryEntry.userClickable);
        }
        compositeEncoder.y(serialDescriptor, 9, contentInventoryEntry.title);
        if (compositeEncoder.A(serialDescriptor, 10) || contentInventoryEntry.titleClickable != null) {
            compositeEncoder.z(serialDescriptor, 10, ContentInventoryEntryClickable$$serializer.INSTANCE, contentInventoryEntry.titleClickable);
        }
        compositeEncoder.j(serialDescriptor, 11, (xs.o) lazyArr[11].getValue(), contentInventoryEntry.subtitles);
        compositeEncoder.j(serialDescriptor, 12, (xs.o) lazyArr[12].getValue(), contentInventoryEntry.gradientColors);
        if (compositeEncoder.A(serialDescriptor, 13) || contentInventoryEntry.clickable != null) {
            compositeEncoder.z(serialDescriptor, 13, ContentInventoryEntryClickable$$serializer.INSTANCE, contentInventoryEntry.clickable);
        }
    }

    /* renamed from: component1-re6GcUE  reason: not valid java name */
    public final long m267component1re6GcUE() {
    ...
    public int hashCode() {
        int m1141hashCodeimpl = ((((UserId.m1141hashCodeimpl(this.authorId) * 31) + this.contentId.hashCode()) * 31) + this.imageUrl.hashCode()) * 31;
        ContentInventoryEntryClickable contentInventoryEntryClickable = this.imageClickable;
        int hashCode = (((m1141hashCodeimpl + (contentInventoryEntryClickable == null ? 0 : contentInventoryEntryClickable.hashCode())) * 31) + this.avatarUrl.hashCode()) * 31;
