...
public final class CheckpointCardComponent extends Component {
    ...
    public static /* synthetic */ CheckpointCardComponent copy$default(CheckpointCardComponent checkpointCardComponent, int i10, String str, CheckpointDataV2025 checkpointDataV2025, int i11, Object obj) {
        ...
        if ((i11 & 2) != 0) {
            str = checkpointCardComponent.f9271id;
        }
        if ((i11 & 4) != 0) {
    ...
    public static final /* synthetic */ void write$Self$chat_release(CheckpointCardComponent checkpointCardComponent, CompositeEncoder compositeEncoder, SerialDescriptor serialDescriptor) {
        ...
        compositeEncoder.m(serialDescriptor, 2, CheckpointDataV2025$$serializer.INSTANCE, checkpointCardComponent.checkpointData);
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof CheckpointCardComponent) {
            ...
            return this.type == checkpointCardComponent.type && Intrinsics.areEqual(this.f9271id, checkpointCardComponent.f9271id) && Intrinsics.areEqual(this.checkpointData, checkpointCardComponent.checkpointData);
        }
        return false;
    }
    ...
    public int hashCode() {
        return (((Integer.hashCode(this.type) * 31) + this.f9271id.hashCode()) * 31) + this.checkpointData.hashCode();
    }

    @NotNull
    public String toString() {
        int i10 = this.type;
        String str = this.f9271id;
