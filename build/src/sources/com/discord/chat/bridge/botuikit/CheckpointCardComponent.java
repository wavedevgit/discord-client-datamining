...
public final class CheckpointCardComponent extends Component {
    ...
    public static /* synthetic */ CheckpointCardComponent copy$default(CheckpointCardComponent checkpointCardComponent, int i10, String str, CheckpointDataV2025 checkpointDataV2025, int i11, Object obj) {
        ...
        if ((i11 & 2) != 0) {
            str = checkpointCardComponent.f9240id;
        }
        if ((i11 & 4) != 0) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof CheckpointCardComponent) {
            ...
            return this.type == checkpointCardComponent.type && Intrinsics.areEqual(this.f9240id, checkpointCardComponent.f9240id) && Intrinsics.areEqual(this.checkpointData, checkpointCardComponent.checkpointData);
        }
        return false;
    }
    ...
    public int hashCode() {
        return (((Integer.hashCode(this.type) * 31) + this.f9240id.hashCode()) * 31) + this.checkpointData.hashCode();
    }
