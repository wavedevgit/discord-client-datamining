...
public final class CheckpointDataV2025 {
    ...
    public static final /* synthetic */ void write$Self$chat_release(CheckpointDataV2025 checkpointDataV2025, CompositeEncoder compositeEncoder, SerialDescriptor serialDescriptor) {
        compositeEncoder.F(serialDescriptor, 0, UserId$$serializer.INSTANCE, UserId.m1135boximpl(checkpointDataV2025.authorId));
        ...
        if (compositeEncoder.z(serialDescriptor, 8) || checkpointDataV2025.clickable != null) {
            compositeEncoder.i(serialDescriptor, 8, CheckpointCardClickable$$serializer.INSTANCE, checkpointDataV2025.clickable);
        }
        if (compositeEncoder.z(serialDescriptor, 9) || checkpointDataV2025.topEmoji != null) {
            compositeEncoder.i(serialDescriptor, 9, CheckpointEmoji$$serializer.INSTANCE, checkpointDataV2025.topEmoji);
        }
        if (compositeEncoder.z(serialDescriptor, 10) || checkpointDataV2025.topGuild != null) {
            compositeEncoder.i(serialDescriptor, 10, CheckpointGuild$$serializer.INSTANCE, checkpointDataV2025.topGuild);
        }
        if (compositeEncoder.z(serialDescriptor, 11) || checkpointDataV2025.topGame != null) {
            compositeEncoder.i(serialDescriptor, 11, CheckpointApplication$$serializer.INSTANCE, checkpointDataV2025.topGame);
        }
    }
