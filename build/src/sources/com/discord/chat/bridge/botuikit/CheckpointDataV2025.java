...
public final class CheckpointDataV2025 {
    ...
    public static final /* synthetic */ void write$Self$chat_release(CheckpointDataV2025 checkpointDataV2025, CompositeEncoder compositeEncoder, SerialDescriptor serialDescriptor) {
        compositeEncoder.k(serialDescriptor, 0, UserId$$serializer.INSTANCE, UserId.m1136boximpl(checkpointDataV2025.authorId));
        ...
        if (compositeEncoder.z(serialDescriptor, 8) || checkpointDataV2025.clickable != null) {
            compositeEncoder.o(serialDescriptor, 8, CheckpointCardClickable$$serializer.INSTANCE, checkpointDataV2025.clickable);
        }
        if (compositeEncoder.z(serialDescriptor, 9) || checkpointDataV2025.topEmoji != null) {
            compositeEncoder.o(serialDescriptor, 9, CheckpointEmoji$$serializer.INSTANCE, checkpointDataV2025.topEmoji);
        }
        if (compositeEncoder.z(serialDescriptor, 10) || checkpointDataV2025.topGuild != null) {
            compositeEncoder.o(serialDescriptor, 10, CheckpointGuild$$serializer.INSTANCE, checkpointDataV2025.topGuild);
        }
        if (compositeEncoder.z(serialDescriptor, 11) || checkpointDataV2025.topGame != null) {
            compositeEncoder.o(serialDescriptor, 11, CheckpointApplication$$serializer.INSTANCE, checkpointDataV2025.topGame);
        }
    }

    /* renamed from: component1-re6GcUE  reason: not valid java name */
    public final long m259component1re6GcUE() {
    ...
    public final CheckpointDataV2025 m260copycXl1GvU(long j10, @NotNull String cardId, @NotNull String cardAssetUrl, @NotNull String powerLevel, int i10, @NotNull String messagesString, @NotNull String voiceString, @NotNull String reactionString, CheckpointCardClickable checkpointCardClickable, CheckpointEmoji checkpointEmoji, CheckpointGuild checkpointGuild, CheckpointApplication checkpointApplication) {
    ...
    public final long m261getAuthorIdre6GcUE() {
        return this.authorId;
    }
