...
public final class CheckpointDataV2025 {
    ...
    public static final /* synthetic */ void write$Self$chat_release(CheckpointDataV2025 checkpointDataV2025, CompositeEncoder compositeEncoder, SerialDescriptor serialDescriptor) {
        compositeEncoder.s(serialDescriptor, 0, UserId$$serializer.INSTANCE, UserId.m1135boximpl(checkpointDataV2025.authorId));
        compositeEncoder.z(serialDescriptor, 1, checkpointDataV2025.cardId);
        compositeEncoder.z(serialDescriptor, 2, checkpointDataV2025.cardAssetUrl);
        compositeEncoder.z(serialDescriptor, 3, checkpointDataV2025.powerLevel);
        compositeEncoder.x(serialDescriptor, 4, checkpointDataV2025.powerLevelUnits);
        compositeEncoder.z(serialDescriptor, 5, checkpointDataV2025.messagesString);
        compositeEncoder.z(serialDescriptor, 6, checkpointDataV2025.voiceString);
        compositeEncoder.z(serialDescriptor, 7, checkpointDataV2025.reactionString);
        if (compositeEncoder.A(serialDescriptor, 8) || checkpointDataV2025.clickable != null) {
            compositeEncoder.l(serialDescriptor, 8, CheckpointCardClickable$$serializer.INSTANCE, checkpointDataV2025.clickable);
        }
        if (compositeEncoder.A(serialDescriptor, 9) || checkpointDataV2025.topEmoji != null) {
            compositeEncoder.l(serialDescriptor, 9, CheckpointEmoji$$serializer.INSTANCE, checkpointDataV2025.topEmoji);
        }
        if (compositeEncoder.A(serialDescriptor, 10) || checkpointDataV2025.topGuild != null) {
            compositeEncoder.l(serialDescriptor, 10, CheckpointGuild$$serializer.INSTANCE, checkpointDataV2025.topGuild);
        }
        if (compositeEncoder.A(serialDescriptor, 11) || checkpointDataV2025.topGame != null) {
            compositeEncoder.l(serialDescriptor, 11, CheckpointApplication$$serializer.INSTANCE, checkpointDataV2025.topGame);
        }
    }

    /* renamed from: component1-re6GcUE  reason: not valid java name */
    public final long m258component1re6GcUE() {
    ...
    public final CheckpointDataV2025 m259copycXl1GvU(long j10, @NotNull String cardId, @NotNull String cardAssetUrl, @NotNull String powerLevel, int i10, @NotNull String messagesString, @NotNull String voiceString, @NotNull String reactionString, CheckpointCardClickable checkpointCardClickable, CheckpointEmoji checkpointEmoji, CheckpointGuild checkpointGuild, CheckpointApplication checkpointApplication) {
    ...
    public int hashCode() {
        int m1140hashCodeimpl = ((((((((((((((UserId.m1140hashCodeimpl(this.authorId) * 31) + this.cardId.hashCode()) * 31) + this.cardAssetUrl.hashCode()) * 31) + this.powerLevel.hashCode()) * 31) + Integer.hashCode(this.powerLevelUnits)) * 31) + this.messagesString.hashCode()) * 31) + this.voiceString.hashCode()) * 31) + this.reactionString.hashCode()) * 31;
        CheckpointCardClickable checkpointCardClickable = this.clickable;
        int hashCode = (m1140hashCodeimpl + (checkpointCardClickable == null ? 0 : checkpointCardClickable.hashCode())) * 31;
    ...
    public String toString() {
        String m1142toStringimpl = UserId.m1142toStringimpl(this.authorId);
        ...
        CheckpointGuild checkpointGuild = this.topGuild;
        CheckpointApplication checkpointApplication = this.topGame;
        return "CheckpointDataV2025(authorId=" + m1142toStringimpl + ", cardId=" + str + ", cardAssetUrl=" + str2 + ", powerLevel=" + str3 + ", powerLevelUnits=" + i10 + ", messagesString=" + str4 + ", voiceString=" + str5 + ", reactionString=" + str6 + ", clickable=" + checkpointCardClickable + ", topEmoji=" + checkpointEmoji + ", topGuild=" + checkpointGuild + ", topGame=" + checkpointApplication + ")";
    }
    ...
    private /* synthetic */ CheckpointDataV2025(int i10, UserId userId, String str, String str2, String str3, int i11, String str4, String str5, String str6, CheckpointCardClickable checkpointCardClickable, CheckpointEmoji checkpointEmoji, CheckpointGuild checkpointGuild, CheckpointApplication checkpointApplication, SerializationConstructorMarker serializationConstructorMarker) {
        ...
        this.authorId = userId.m1144unboximpl();
        this.cardId = str;
