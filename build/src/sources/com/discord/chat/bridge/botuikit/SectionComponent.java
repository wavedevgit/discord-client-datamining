...
public final class SectionComponent extends BaseLayoutComponent {
    ...
    @NotNull
    private static final Lazy[] $childSerializers = {null, null, null, jr.l.a(jr.o.f32182e, new Function0() { // from class: com.discord.chat.bridge.botuikit.k
    ...
    public static final /* synthetic */ KSerializer _childSerializers$_anonymous_() {
        return new bt.f(SectionChildComponent.Serializer.INSTANCE);
    }
    ...
    public static final /* synthetic */ void write$Self$chat_release(SectionComponent sectionComponent, CompositeEncoder compositeEncoder, SerialDescriptor serialDescriptor) {
        ...
        if (compositeEncoder.y(serialDescriptor, 2) || sectionComponent.getErrorText() != null) {
            compositeEncoder.B(serialDescriptor, 2, n2.f7662a, sectionComponent.getErrorText());
        }
        compositeEncoder.m(serialDescriptor, 3, (ys.o) lazyArr[3].getValue(), sectionComponent.components);
        compositeEncoder.m(serialDescriptor, 4, SectionAccessory.Serializer.INSTANCE, sectionComponent.accessory);
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof SectionComponent) {
            ...
            return this.type == sectionComponent.type && Intrinsics.areEqual(this.f9283id, sectionComponent.f9283id) && Intrinsics.areEqual(this.errorText, sectionComponent.errorText) && Intrinsics.areEqual(this.components, sectionComponent.components) && Intrinsics.areEqual(this.accessory, sectionComponent.accessory);
        }
        return false;
    }
    ...
    public int hashCode() {
        int hashCode = ((Integer.hashCode(this.type) * 31) + this.f9283id.hashCode()) * 31;
