...
public final class SectionComponent extends BaseLayoutComponent {
    ...
    @NotNull
    private static final Lazy[] $childSerializers = {null, null, null, lr.l.b(lr.o.f37120e, new Function0() { // from class: com.discord.chat.bridge.botuikit.k
    ...
    public static final /* synthetic */ KSerializer _childSerializers$_anonymous_() {
        return new dt.f(SectionChildComponent.Serializer.INSTANCE);
    }
    ...
    public static final /* synthetic */ void write$Self$chat_release(SectionComponent sectionComponent, CompositeEncoder compositeEncoder, SerialDescriptor serialDescriptor) {
        ...
        if (compositeEncoder.z(serialDescriptor, 2) || sectionComponent.getErrorText() != null) {
            compositeEncoder.s(serialDescriptor, 2, n2.f20978a, sectionComponent.getErrorText());
        }
        compositeEncoder.D(serialDescriptor, 3, (at.o) lazyArr[3].getValue(), sectionComponent.components);
        compositeEncoder.D(serialDescriptor, 4, SectionAccessory.Serializer.INSTANCE, sectionComponent.accessory);
    }
