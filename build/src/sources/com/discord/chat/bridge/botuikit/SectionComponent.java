...
public final class SectionComponent extends BaseLayoutComponent {
    ...
    private final String f8674id;
    private final int type;
    @NotNull
    public static final Companion Companion = new Companion(null);
    @NotNull
    private static final Lazy[] $childSerializers = {null, null, null, rr.l.b(rr.o.f49210e, new Function0() { // from class: com.discord.chat.bridge.botuikit.k
    ...
    public static final /* synthetic */ KSerializer _childSerializers$_anonymous_() {
        return new kt.f(SectionChildComponent.Serializer.INSTANCE);
    }
    ...
    public static final /* synthetic */ void write$Self$chat_release(SectionComponent sectionComponent, CompositeEncoder compositeEncoder, SerialDescriptor serialDescriptor) {
        ...
        if (compositeEncoder.z(serialDescriptor, 2) || sectionComponent.getErrorText() != null) {
            compositeEncoder.i(serialDescriptor, 2, n2.f35181a, sectionComponent.getErrorText());
        }
        compositeEncoder.F(serialDescriptor, 3, (gt.o) lazyArr[3].getValue(), sectionComponent.components);
        compositeEncoder.F(serialDescriptor, 4, SectionAccessory.Serializer.INSTANCE, sectionComponent.accessory);
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof SectionComponent) {
            ...
            return this.type == sectionComponent.type && Intrinsics.areEqual(this.f8674id, sectionComponent.f8674id) && Intrinsics.areEqual(this.errorText, sectionComponent.errorText) && Intrinsics.areEqual(this.components, sectionComponent.components) && Intrinsics.areEqual(this.accessory, sectionComponent.accessory);
        }
        return false;
    }
    ...
    public int hashCode() {
        int hashCode = ((Integer.hashCode(this.type) * 31) + this.f8674id.hashCode()) * 31;
