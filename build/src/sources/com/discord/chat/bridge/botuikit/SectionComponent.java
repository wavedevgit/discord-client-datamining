...
public final class SectionComponent extends BaseLayoutComponent {
    ...
    @NotNull
    private static final Lazy[] $childSerializers = {null, null, null, ir.l.a(ir.o.f31103e, new Function0() { // from class: com.discord.chat.bridge.botuikit.k
    ...
    public static final /* synthetic */ KSerializer _childSerializers$_anonymous_() {
        return new at.f(SectionChildComponent.Serializer.INSTANCE);
    }
    ...
    public static final /* synthetic */ void write$Self$chat_release(SectionComponent sectionComponent, CompositeEncoder compositeEncoder, SerialDescriptor serialDescriptor) {
        ...
        if (compositeEncoder.A(serialDescriptor, 2) || sectionComponent.getErrorText() != null) {
            compositeEncoder.z(serialDescriptor, 2, n2.f6848a, sectionComponent.getErrorText());
        }
        compositeEncoder.j(serialDescriptor, 3, (xs.o) lazyArr[3].getValue(), sectionComponent.components);
        compositeEncoder.j(serialDescriptor, 4, SectionAccessory.Serializer.INSTANCE, sectionComponent.accessory);
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof SectionComponent) {
            ...
            return this.type == sectionComponent.type && Intrinsics.areEqual(this.f9654id, sectionComponent.f9654id) && Intrinsics.areEqual(this.errorText, sectionComponent.errorText) && Intrinsics.areEqual(this.components, sectionComponent.components) && Intrinsics.areEqual(this.accessory, sectionComponent.accessory);
        }
        return false;
    }
    ...
    public int hashCode() {
        int hashCode = ((Integer.hashCode(this.type) * 31) + this.f9654id.hashCode()) * 31;
