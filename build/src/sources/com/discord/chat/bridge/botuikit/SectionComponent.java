...
public final class SectionComponent extends BaseLayoutComponent {
    ...
    @NotNull
    private static final Lazy[] $childSerializers = {null, null, null, qr.l.b(qr.o.f48092e, new Function0() { // from class: com.discord.chat.bridge.botuikit.k
    ...
    public static final /* synthetic */ KSerializer _childSerializers$_anonymous_() {
        return new jt.f(SectionChildComponent.Serializer.INSTANCE);
    }
    ...
    public static final /* synthetic */ void write$Self$chat_release(SectionComponent sectionComponent, CompositeEncoder compositeEncoder, SerialDescriptor serialDescriptor) {
        ...
        compositeEncoder.x(serialDescriptor, 0, sectionComponent.getType());
        compositeEncoder.z(serialDescriptor, 1, sectionComponent.getId());
        if (compositeEncoder.A(serialDescriptor, 2) || sectionComponent.getErrorText() != null) {
            compositeEncoder.l(serialDescriptor, 2, n2.f31089a, sectionComponent.getErrorText());
        }
        compositeEncoder.s(serialDescriptor, 3, (ft.o) lazyArr[3].getValue(), sectionComponent.components);
        compositeEncoder.s(serialDescriptor, 4, SectionAccessory.Serializer.INSTANCE, sectionComponent.accessory);
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof SectionComponent) {
            ...
            return this.type == sectionComponent.type && Intrinsics.areEqual(this.f8534id, sectionComponent.f8534id) && Intrinsics.areEqual(this.errorText, sectionComponent.errorText) && Intrinsics.areEqual(this.components, sectionComponent.components) && Intrinsics.areEqual(this.accessory, sectionComponent.accessory);
        }
        return false;
    }
    ...
    public int hashCode() {
        int hashCode = ((Integer.hashCode(this.type) * 31) + this.f8534id.hashCode()) * 31;
