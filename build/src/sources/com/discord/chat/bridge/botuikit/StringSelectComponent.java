...
public final class StringSelectComponent extends SelectComponent {
    ...
    static {
        ...
        $childSerializers = new Lazy[]{null, null, null, null, null, null, null, null, null, lr.l.b(oVar, new Function0() { // from class: com.discord.chat.bridge.botuikit.n
        ...
        }), lr.l.b(oVar, new Function0() { // from class: com.discord.chat.bridge.botuikit.o
            @Override // kotlin.jvm.functions.Function0
            public final Object invoke() {
    ...
    public static final /* synthetic */ KSerializer _childSerializers$_anonymous_() {
        return new dt.f(StringSelectItem$$serializer.INSTANCE);
    }
    ...
    public static final /* synthetic */ void write$Self$chat_release(StringSelectComponent stringSelectComponent, CompositeEncoder compositeEncoder, SerialDescriptor serialDescriptor) {
        ...
        compositeEncoder.D(serialDescriptor, 2, ActionComponentState.Serializer.INSTANCE, stringSelectComponent.getState());
        ...
        if (compositeEncoder.z(serialDescriptor, 4) || stringSelectComponent.getPlaceholder() != null) {
            compositeEncoder.s(serialDescriptor, 4, n2.f20978a, stringSelectComponent.getPlaceholder());
        }
        if (compositeEncoder.z(serialDescriptor, 5) || stringSelectComponent.getAccessibilityLabel() != null) {
            compositeEncoder.s(serialDescriptor, 5, n2.f20978a, stringSelectComponent.getAccessibilityLabel());
        }
        ...
        compositeEncoder.D(serialDescriptor, 9, (at.o) lazyArr[9].getValue(), stringSelectComponent.options);
        compositeEncoder.D(serialDescriptor, 10, (at.o) lazyArr[10].getValue(), stringSelectComponent.selectedOptions);
    }
