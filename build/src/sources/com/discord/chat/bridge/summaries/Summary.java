...
public final class Summary {
    ...
    @NotNull
    private static final Lazy[] $childSerializers = {null, null, null, l.a(o.f6082e, new Function0() { // from class: q6.a
    ...
    public static /* synthetic */ Summary m425copyH5KhIT0$default(Summary summary, String str, String str2, String str3, List list, String str4, String str5, int i10, long j10, int i11, Object obj) {
        if ((i11 & 1) != 0) {
            str = summary.f9280id;
        }
        if ((i11 & 2) != 0) {
        ...
        String str7 = str4;
        String str8 = str3;
        return summary.m429copyH5KhIT0(str, str2, str8, list2, str7, str6, i12, j11);
    }
    ...
    public static final /* synthetic */ void write$Self$chat_release(Summary summary, CompositeEncoder compositeEncoder, SerialDescriptor serialDescriptor) {
        ...
        compositeEncoder.y(serialDescriptor, 0, summary.f9280id);
        compositeEncoder.y(serialDescriptor, 1, summary.topic);
        compositeEncoder.y(serialDescriptor, 2, summary.summShort);
        compositeEncoder.k(serialDescriptor, 3, (qt.o) lazyArr[3].getValue(), summary.people);
        MessageId$$serializer messageId$$serializer = MessageId$$serializer.INSTANCE;
        compositeEncoder.k(serialDescriptor, 4, messageId$$serializer, MessageId.m1084boximpl(summary.startId));
        compositeEncoder.k(serialDescriptor, 5, messageId$$serializer, MessageId.m1084boximpl(summary.endId));
        compositeEncoder.w(serialDescriptor, 6, summary.count);
        compositeEncoder.k(serialDescriptor, 7, ChannelId$$serializer.INSTANCE, ChannelId.m1058boximpl(summary.channelId));
    }
    ...
    public final String m426component53Eiw7ao() {
        return this.startId;
    }

    @NotNull
    /* renamed from: component6-3Eiw7ao  reason: not valid java name */
    public final String m427component63Eiw7ao() {
        return this.endId;
    }
    ...
    public final long m428component8o4g7jtM() {
        return this.channelId;
    }

    @NotNull
    /* renamed from: copy-H5KhIT0  reason: not valid java name */
    public final Summary m429copyH5KhIT0(@NotNull String id2, @NotNull String topic, @NotNull String summShort, @NotNull List<UserId> people, @NotNull String startId, @NotNull String endId, int i10, long j10) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof Summary) {
            ...
            return Intrinsics.areEqual(this.f9280id, summary.f9280id) && Intrinsics.areEqual(this.topic, summary.topic) && Intrinsics.areEqual(this.summShort, summary.summShort) && Intrinsics.areEqual(this.people, summary.people) && MessageId.m1088equalsimpl0(this.startId, summary.startId) && MessageId.m1088equalsimpl0(this.endId, summary.endId) && this.count == summary.count && ChannelId.m1062equalsimpl0(this.channelId, summary.channelId);
        }
        return false;
    }

    /* renamed from: getChannelId-o4g7jtM  reason: not valid java name */
    public final long m430getChannelIdo4g7jtM() {
        return this.channelId;
    }
    ...
    public final String m431getEndId3Eiw7ao() {
        return this.endId;
    }
    ...
    public final String m432getStartId3Eiw7ao() {
        return this.startId;
    }
    ...
    public int hashCode() {
        return (((((((((((((this.f9280id.hashCode() * 31) + this.topic.hashCode()) * 31) + this.summShort.hashCode()) * 31) + this.people.hashCode()) * 31) + MessageId.m1089hashCodeimpl(this.startId)) * 31) + MessageId.m1089hashCodeimpl(this.endId)) * 31) + Integer.hashCode(this.count)) * 31) + ChannelId.m1063hashCodeimpl(this.channelId);
    }

    @NotNull
    public String toString() {
        String str = this.f9280id;
        String str2 = this.topic;
        String str3 = this.summShort;
        List<UserId> list = this.people;
        String m1091toStringimpl = MessageId.m1091toStringimpl(this.startId);
        String m1091toStringimpl2 = MessageId.m1091toStringimpl(this.endId);
        int i10 = this.count;
        String m1065toStringimpl = ChannelId.m1065toStringimpl(this.channelId);
        return "Summary(id=" + str + ", topic=" + str2 + ", summShort=" + str3 + ", people=" + list + ", startId=" + m1091toStringimpl + ", endId=" + m1091toStringimpl2 + ", count=" + i10 + ", channelId=" + m1065toStringimpl + ")";
    }
