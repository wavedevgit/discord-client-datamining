...
public final class Summary {
    ...
    @NotNull
    private static final Lazy[] $childSerializers = {null, null, null, l.b(o.f49210e, new Function0() { // from class: q6.a
    ...
    public static final /* synthetic */ void write$Self$chat_release(Summary summary, CompositeEncoder compositeEncoder, SerialDescriptor serialDescriptor) {
        ...
        compositeEncoder.y(serialDescriptor, 0, summary.f8703id);
        compositeEncoder.y(serialDescriptor, 1, summary.topic);
        compositeEncoder.y(serialDescriptor, 2, summary.summShort);
        compositeEncoder.F(serialDescriptor, 3, (gt.o) lazyArr[3].getValue(), summary.people);
        MessageId$$serializer messageId$$serializer = MessageId$$serializer.INSTANCE;
        compositeEncoder.F(serialDescriptor, 4, messageId$$serializer, MessageId.m1083boximpl(summary.startId));
        compositeEncoder.F(serialDescriptor, 5, messageId$$serializer, MessageId.m1083boximpl(summary.endId));
        compositeEncoder.w(serialDescriptor, 6, summary.count);
        compositeEncoder.F(serialDescriptor, 7, ChannelId$$serializer.INSTANCE, ChannelId.m1057boximpl(summary.channelId));
    }
    ...
    public int hashCode() {
        return (((((((((((((this.f8703id.hashCode() * 31) + this.topic.hashCode()) * 31) + this.summShort.hashCode()) * 31) + this.people.hashCode()) * 31) + MessageId.m1088hashCodeimpl(this.startId)) * 31) + MessageId.m1088hashCodeimpl(this.endId)) * 31) + Integer.hashCode(this.count)) * 31) + ChannelId.m1062hashCodeimpl(this.channelId);
    }
