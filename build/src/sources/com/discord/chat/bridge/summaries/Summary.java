...
public final class Summary {
    ...
    public static final /* synthetic */ void write$Self$chat_release(Summary summary, CompositeEncoder compositeEncoder, SerialDescriptor serialDescriptor) {
        ...
        compositeEncoder.y(serialDescriptor, 0, summary.f9281id);
    ...
    public int hashCode() {
        return (((((((((((((this.f9281id.hashCode() * 31) + this.topic.hashCode()) * 31) + this.summShort.hashCode()) * 31) + this.people.hashCode()) * 31) + MessageId.m1089hashCodeimpl(this.startId)) * 31) + MessageId.m1089hashCodeimpl(this.endId)) * 31) + Integer.hashCode(this.count)) * 31) + ChannelId.m1063hashCodeimpl(this.channelId);
    }
