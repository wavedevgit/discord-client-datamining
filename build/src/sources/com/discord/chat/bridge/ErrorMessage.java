...
public final class ErrorMessage extends MessageBase {
    ...
    public static final /* synthetic */ void write$Self$chat_release(ErrorMessage errorMessage, CompositeEncoder compositeEncoder, SerialDescriptor serialDescriptor) {
        ...
        compositeEncoder.j(serialDescriptor, 0, MessageId$$serializer.INSTANCE, MessageId.m1084boximpl(errorMessage.f9635id));
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof ErrorMessage) {
            ...
            return MessageId.m1088equalsimpl0(this.f9635id, errorMessage.f9635id) && Intrinsics.areEqual(this.stackTrace, errorMessage.stackTrace);
        }
        return false;
    }
    ...
    public int hashCode() {
        return (MessageId.m1089hashCodeimpl(this.f9635id) * 31) + this.stackTrace.hashCode();
    }

    @NotNull
    public String toString() {
        String m1091toStringimpl = MessageId.m1091toStringimpl(this.f9635id);
        String str = this.stackTrace;
        return "ErrorMessage(id=" + m1091toStringimpl + ", stackTrace=" + str + ")";
    }
