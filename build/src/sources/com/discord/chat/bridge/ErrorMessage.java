...
public final class ErrorMessage extends MessageBase {
    ...
    public static final /* synthetic */ void write$Self$chat_release(ErrorMessage errorMessage, CompositeEncoder compositeEncoder, SerialDescriptor serialDescriptor) {
        ...
        compositeEncoder.k(serialDescriptor, 0, MessageId$$serializer.INSTANCE, MessageId.m1084boximpl(errorMessage.f9233id));
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof ErrorMessage) {
            ...
            return MessageId.m1088equalsimpl0(this.f9233id, errorMessage.f9233id) && Intrinsics.areEqual(this.stackTrace, errorMessage.stackTrace);
        }
        return false;
    }
    ...
    public int hashCode() {
        return (MessageId.m1089hashCodeimpl(this.f9233id) * 31) + this.stackTrace.hashCode();
    }
