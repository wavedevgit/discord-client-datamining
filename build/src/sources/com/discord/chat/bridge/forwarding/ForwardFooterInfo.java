...
public final class ForwardFooterInfo {
    ...
    public static final /* synthetic */ void write$Self$chat_release(ForwardFooterInfo forwardFooterInfo, CompositeEncoder compositeEncoder, SerialDescriptor serialDescriptor) {
        compositeEncoder.y(serialDescriptor, 0, forwardFooterInfo.timestampLabel);
        compositeEncoder.y(serialDescriptor, 1, forwardFooterInfo.originLabel);
        compositeEncoder.y(serialDescriptor, 2, forwardFooterInfo.accessibilityLabel);
        if (compositeEncoder.z(serialDescriptor, 3) || forwardFooterInfo.originIconUrl != null) {
            compositeEncoder.s(serialDescriptor, 3, n2.f20978a, forwardFooterInfo.originIconUrl);
        }
    }
