...
public final class ForwardInfo {
    ...
    public static final /* synthetic */ void write$Self$chat_release(ForwardInfo forwardInfo, CompositeEncoder compositeEncoder, SerialDescriptor serialDescriptor) {
        compositeEncoder.w(serialDescriptor, 0, forwardInfo.snapshotIndex);
        if (compositeEncoder.A(serialDescriptor, 1) || forwardInfo.footerInfo != null) {
            compositeEncoder.z(serialDescriptor, 1, ForwardFooterInfo$$serializer.INSTANCE, forwardInfo.footerInfo);
        }
    }
