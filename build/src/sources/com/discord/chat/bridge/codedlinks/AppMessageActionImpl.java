...
public final class AppMessageActionImpl implements AppMessageEmbedAction {
    ...
    public static /* synthetic */ AppMessageActionImpl copy$default(AppMessageActionImpl appMessageActionImpl, String str, String str2, Boolean bool, int i10, Object obj) {
        if ((i10 & 1) != 0) {
            str = appMessageActionImpl.f8541id;
        }
        if ((i10 & 2) != 0) {
    ...
    public static final /* synthetic */ void write$Self$chat_release(AppMessageActionImpl appMessageActionImpl, CompositeEncoder compositeEncoder, SerialDescriptor serialDescriptor) {
        compositeEncoder.z(serialDescriptor, 0, appMessageActionImpl.getId());
        compositeEncoder.z(serialDescriptor, 1, appMessageActionImpl.getLabel());
        if (compositeEncoder.A(serialDescriptor, 2) || appMessageActionImpl.getDisabled() != null) {
            compositeEncoder.l(serialDescriptor, 2, h.f31053a, appMessageActionImpl.getDisabled());
        }
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof AppMessageActionImpl) {
            ...
            return Intrinsics.areEqual(this.f8541id, appMessageActionImpl.f8541id) && Intrinsics.areEqual(this.label, appMessageActionImpl.label) && Intrinsics.areEqual(this.disabled, appMessageActionImpl.disabled);
        }
        return false;
    }
    ...
    public int hashCode() {
        int hashCode = ((this.f8541id.hashCode() * 31) + this.label.hashCode()) * 31;
