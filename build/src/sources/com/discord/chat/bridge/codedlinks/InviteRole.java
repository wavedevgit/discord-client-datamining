...
public final class InviteRole implements ItemDiffableType {
    ...
    public static final /* synthetic */ void write$Self$chat_release(InviteRole inviteRole, CompositeEncoder compositeEncoder, SerialDescriptor serialDescriptor) {
        compositeEncoder.x(serialDescriptor, 0, inviteRole.f8643id);
        ...
        if (compositeEncoder.z(serialDescriptor, 3) || inviteRole.roleIcon != null) {
            compositeEncoder.A(serialDescriptor, 3, RoleIcon$$serializer.INSTANCE, inviteRole.roleIcon);
        }
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof InviteRole) {
            ...
            return Intrinsics.areEqual(this.f8643id, inviteRole.f8643id) && Intrinsics.areEqual(this.name, inviteRole.name) && this.color == inviteRole.color && Intrinsics.areEqual(this.roleIcon, inviteRole.roleIcon);
        }
        return false;
    }
    ...
    public int hashCode() {
        int hashCode = ((((this.f8643id.hashCode() * 31) + this.name.hashCode()) * 31) + Integer.hashCode(this.color)) * 31;
