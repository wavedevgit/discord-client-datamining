...
public final class InviteRole implements ItemDiffableType {
    ...
    public static final /* synthetic */ void write$Self$chat_release(InviteRole inviteRole, CompositeEncoder compositeEncoder, SerialDescriptor serialDescriptor) {
        compositeEncoder.y(serialDescriptor, 0, inviteRole.f9662id);
        ...
        if (compositeEncoder.A(serialDescriptor, 3) || inviteRole.roleIcon != null) {
            compositeEncoder.z(serialDescriptor, 3, RoleIcon$$serializer.INSTANCE, inviteRole.roleIcon);
        }
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof InviteRole) {
            ...
            return Intrinsics.areEqual(this.f9662id, inviteRole.f9662id) && Intrinsics.areEqual(this.name, inviteRole.name) && this.color == inviteRole.color && Intrinsics.areEqual(this.roleIcon, inviteRole.roleIcon);
        }
        return false;
    }
    ...
    public int hashCode() {
        int hashCode = ((((this.f9662id.hashCode() * 31) + this.name.hashCode()) * 31) + Integer.hashCode(this.color)) * 31;
