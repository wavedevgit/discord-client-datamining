...
public final class EmbeddedActivityInviteEmbedImpl extends CodedLinkEmbed implements EmbeddedActivityInviteEmbed {
    ...
    @NotNull
    private static final Lazy[] $childSerializers = {null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, l.a(o.f6082e, new Function0() { // from class: com.discord.chat.bridge.codedlinks.c
    ...
    public static final /* synthetic */ void write$Self$chat_release(EmbeddedActivityInviteEmbedImpl embeddedActivityInviteEmbedImpl, CompositeEncoder compositeEncoder, SerialDescriptor serialDescriptor) {
        ...
        if (compositeEncoder.z(serialDescriptor, 5) || embeddedActivityInviteEmbedImpl.getAcceptLabelBackgroundColor() != null) {
            compositeEncoder.o(serialDescriptor, 5, p0.f50048a, embeddedActivityInviteEmbedImpl.getAcceptLabelBackgroundColor());
        }
        if (compositeEncoder.z(serialDescriptor, 6) || embeddedActivityInviteEmbedImpl.getAcceptLabelBorderColor() != null) {
            compositeEncoder.o(serialDescriptor, 6, p0.f50048a, embeddedActivityInviteEmbedImpl.getAcceptLabelBorderColor());
        }
        if (compositeEncoder.z(serialDescriptor, 7) || embeddedActivityInviteEmbedImpl.getAcceptLabelColor() != null) {
            compositeEncoder.o(serialDescriptor, 7, p0.f50048a, embeddedActivityInviteEmbedImpl.getAcceptLabelColor());
        }
        ...
        if (compositeEncoder.z(serialDescriptor, 10) || embeddedActivityInviteEmbedImpl.getBodyTextColor() != null) {
            compositeEncoder.o(serialDescriptor, 10, p0.f50048a, embeddedActivityInviteEmbedImpl.getBodyTextColor());
        }
        if (compositeEncoder.z(serialDescriptor, 11) || embeddedActivityInviteEmbedImpl.getCanBeAccepted() != null) {
            compositeEncoder.o(serialDescriptor, 11, h.f49996a, embeddedActivityInviteEmbedImpl.getCanBeAccepted());
        }
        if (compositeEncoder.z(serialDescriptor, 12) || embeddedActivityInviteEmbedImpl.getEmbedCanBeTapped() != null) {
            compositeEncoder.o(serialDescriptor, 12, h.f49996a, embeddedActivityInviteEmbedImpl.getEmbedCanBeTapped());
        }
        if (compositeEncoder.z(serialDescriptor, 13) || embeddedActivityInviteEmbedImpl.getResolvingGradientEnd() != null) {
            compositeEncoder.o(serialDescriptor, 13, p0.f50048a, embeddedActivityInviteEmbedImpl.getResolvingGradientEnd());
        }
        if (compositeEncoder.z(serialDescriptor, 14) || embeddedActivityInviteEmbedImpl.getResolvingGradientStart() != null) {
            compositeEncoder.o(serialDescriptor, 14, p0.f50048a, embeddedActivityInviteEmbedImpl.getResolvingGradientStart());
        }
        if (compositeEncoder.z(serialDescriptor, 15) || embeddedActivityInviteEmbedImpl.getSplashHasRadialGradient() != null) {
            compositeEncoder.o(serialDescriptor, 15, h.f49996a, embeddedActivityInviteEmbedImpl.getSplashHasRadialGradient());
        }
        if (compositeEncoder.z(serialDescriptor, 16) || embeddedActivityInviteEmbedImpl.getSplashOpacity() != null) {
            compositeEncoder.o(serialDescriptor, 16, p0.f50048a, embeddedActivityInviteEmbedImpl.getSplashOpacity());
        }
        ...
        if (compositeEncoder.z(serialDescriptor, 18) || embeddedActivityInviteEmbedImpl.getInviteSplash() != null) {
            compositeEncoder.o(serialDescriptor, 18, n2Var, embeddedActivityInviteEmbedImpl.getInviteSplash());
        }
        ...
        if (compositeEncoder.z(serialDescriptor, 20) || embeddedActivityInviteEmbedImpl.getSubtitleColor() != null) {
            compositeEncoder.o(serialDescriptor, 20, p0.f50048a, embeddedActivityInviteEmbedImpl.getSubtitleColor());
        }
        if (compositeEncoder.z(serialDescriptor, 21) || embeddedActivityInviteEmbedImpl.getThumbnailBackgroundColor() != null) {
            compositeEncoder.o(serialDescriptor, 21, p0.f50048a, embeddedActivityInviteEmbedImpl.getThumbnailBackgroundColor());
        }
        if (compositeEncoder.z(serialDescriptor, 22) || embeddedActivityInviteEmbedImpl.getThumbnailCornerRadius() != null) {
            compositeEncoder.o(serialDescriptor, 22, p0.f50048a, embeddedActivityInviteEmbedImpl.getThumbnailCornerRadius());
        }
        ...
        if (compositeEncoder.z(serialDescriptor, 25) || embeddedActivityInviteEmbedImpl.getTitleColor() != null) {
            compositeEncoder.o(serialDescriptor, 25, p0.f50048a, embeddedActivityInviteEmbedImpl.getTitleColor());
        }
        ...
        compositeEncoder.k(serialDescriptor, 27, (qt.o) lazyArr[27].getValue(), embeddedActivityInviteEmbedImpl.getParticipantAvatarUris());
        compositeEncoder.k(serialDescriptor, 28, CodedLinkExtendedType.Serializer.INSTANCE, embeddedActivityInviteEmbedImpl.getExtendedType());
        if (compositeEncoder.z(serialDescriptor, 29) || embeddedActivityInviteEmbedImpl.getStructurableSubtitleText() != null) {
            compositeEncoder.o(serialDescriptor, 29, AnnotatedStructurableTextSerializer.INSTANCE, embeddedActivityInviteEmbedImpl.getStructurableSubtitleText());
        }
