...
public final class EmbeddedActivityInviteEmbedImpl extends CodedLinkEmbed implements EmbeddedActivityInviteEmbed {
    ...
    @NotNull
    private static final Lazy[] $childSerializers = {null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, l.b(o.f49210e, new Function0() { // from class: com.discord.chat.bridge.codedlinks.c
    ...
    public static final /* synthetic */ void write$Self$chat_release(EmbeddedActivityInviteEmbedImpl embeddedActivityInviteEmbedImpl, CompositeEncoder compositeEncoder, SerialDescriptor serialDescriptor) {
        ...
        n2 n2Var = n2.f35181a;
        compositeEncoder.i(serialDescriptor, 3, n2Var, embeddedActivityInviteEmbedImpl.getHeaderText());
        if (compositeEncoder.z(serialDescriptor, 4) || embeddedActivityInviteEmbedImpl.getType() != null) {
            compositeEncoder.i(serialDescriptor, 4, InviteType.Serializer.INSTANCE, embeddedActivityInviteEmbedImpl.getType());
        }
        if (compositeEncoder.z(serialDescriptor, 5) || embeddedActivityInviteEmbedImpl.getAcceptLabelBackgroundColor() != null) {
            compositeEncoder.i(serialDescriptor, 5, p0.f35197a, embeddedActivityInviteEmbedImpl.getAcceptLabelBackgroundColor());
        }
        if (compositeEncoder.z(serialDescriptor, 6) || embeddedActivityInviteEmbedImpl.getAcceptLabelBorderColor() != null) {
            compositeEncoder.i(serialDescriptor, 6, p0.f35197a, embeddedActivityInviteEmbedImpl.getAcceptLabelBorderColor());
        }
        if (compositeEncoder.z(serialDescriptor, 7) || embeddedActivityInviteEmbedImpl.getAcceptLabelColor() != null) {
            compositeEncoder.i(serialDescriptor, 7, p0.f35197a, embeddedActivityInviteEmbedImpl.getAcceptLabelColor());
        }
        if (compositeEncoder.z(serialDescriptor, 8) || embeddedActivityInviteEmbedImpl.getAcceptLabelText() != null) {
            compositeEncoder.i(serialDescriptor, 8, n2Var, embeddedActivityInviteEmbedImpl.getAcceptLabelText());
        }
        if (compositeEncoder.z(serialDescriptor, 9) || embeddedActivityInviteEmbedImpl.getBodyText() != null) {
            compositeEncoder.i(serialDescriptor, 9, n2Var, embeddedActivityInviteEmbedImpl.getBodyText());
        }
        if (compositeEncoder.z(serialDescriptor, 10) || embeddedActivityInviteEmbedImpl.getBodyTextColor() != null) {
            compositeEncoder.i(serialDescriptor, 10, p0.f35197a, embeddedActivityInviteEmbedImpl.getBodyTextColor());
        }
        if (compositeEncoder.z(serialDescriptor, 11) || embeddedActivityInviteEmbedImpl.getCanBeAccepted() != null) {
            compositeEncoder.i(serialDescriptor, 11, h.f35145a, embeddedActivityInviteEmbedImpl.getCanBeAccepted());
        }
        if (compositeEncoder.z(serialDescriptor, 12) || embeddedActivityInviteEmbedImpl.getEmbedCanBeTapped() != null) {
            compositeEncoder.i(serialDescriptor, 12, h.f35145a, embeddedActivityInviteEmbedImpl.getEmbedCanBeTapped());
        }
        if (compositeEncoder.z(serialDescriptor, 13) || embeddedActivityInviteEmbedImpl.getResolvingGradientEnd() != null) {
            compositeEncoder.i(serialDescriptor, 13, p0.f35197a, embeddedActivityInviteEmbedImpl.getResolvingGradientEnd());
        }
        if (compositeEncoder.z(serialDescriptor, 14) || embeddedActivityInviteEmbedImpl.getResolvingGradientStart() != null) {
            compositeEncoder.i(serialDescriptor, 14, p0.f35197a, embeddedActivityInviteEmbedImpl.getResolvingGradientStart());
        }
        if (compositeEncoder.z(serialDescriptor, 15) || embeddedActivityInviteEmbedImpl.getSplashHasRadialGradient() != null) {
            compositeEncoder.i(serialDescriptor, 15, h.f35145a, embeddedActivityInviteEmbedImpl.getSplashHasRadialGradient());
        }
        if (compositeEncoder.z(serialDescriptor, 16) || embeddedActivityInviteEmbedImpl.getSplashOpacity() != null) {
            compositeEncoder.i(serialDescriptor, 16, p0.f35197a, embeddedActivityInviteEmbedImpl.getSplashOpacity());
        }
        if (compositeEncoder.z(serialDescriptor, 17) || embeddedActivityInviteEmbedImpl.getSplashUrl() != null) {
            compositeEncoder.i(serialDescriptor, 17, n2Var, embeddedActivityInviteEmbedImpl.getSplashUrl());
        }
        if (compositeEncoder.z(serialDescriptor, 18) || embeddedActivityInviteEmbedImpl.getInviteSplash() != null) {
            compositeEncoder.i(serialDescriptor, 18, n2Var, embeddedActivityInviteEmbedImpl.getInviteSplash());
        }
        if (compositeEncoder.z(serialDescriptor, 19) || embeddedActivityInviteEmbedImpl.getSubtitle() != null) {
            compositeEncoder.i(serialDescriptor, 19, n2Var, embeddedActivityInviteEmbedImpl.getSubtitle());
        }
        if (compositeEncoder.z(serialDescriptor, 20) || embeddedActivityInviteEmbedImpl.getSubtitleColor() != null) {
            compositeEncoder.i(serialDescriptor, 20, p0.f35197a, embeddedActivityInviteEmbedImpl.getSubtitleColor());
        }
        if (compositeEncoder.z(serialDescriptor, 21) || embeddedActivityInviteEmbedImpl.getThumbnailBackgroundColor() != null) {
            compositeEncoder.i(serialDescriptor, 21, p0.f35197a, embeddedActivityInviteEmbedImpl.getThumbnailBackgroundColor());
        }
        if (compositeEncoder.z(serialDescriptor, 22) || embeddedActivityInviteEmbedImpl.getThumbnailCornerRadius() != null) {
            compositeEncoder.i(serialDescriptor, 22, p0.f35197a, embeddedActivityInviteEmbedImpl.getThumbnailCornerRadius());
        }
        if (compositeEncoder.z(serialDescriptor, 23) || embeddedActivityInviteEmbedImpl.getThumbnailText() != null) {
            compositeEncoder.i(serialDescriptor, 23, n2Var, embeddedActivityInviteEmbedImpl.getThumbnailText());
        }
        if (compositeEncoder.z(serialDescriptor, 24) || embeddedActivityInviteEmbedImpl.getThumbnailUrl() != null) {
            compositeEncoder.i(serialDescriptor, 24, n2Var, embeddedActivityInviteEmbedImpl.getThumbnailUrl());
        }
        if (compositeEncoder.z(serialDescriptor, 25) || embeddedActivityInviteEmbedImpl.getTitleColor() != null) {
            compositeEncoder.i(serialDescriptor, 25, p0.f35197a, embeddedActivityInviteEmbedImpl.getTitleColor());
        }
        if (compositeEncoder.z(serialDescriptor, 26) || embeddedActivityInviteEmbedImpl.getTitleText() != null) {
            compositeEncoder.i(serialDescriptor, 26, n2Var, embeddedActivityInviteEmbedImpl.getTitleText());
        }
        compositeEncoder.F(serialDescriptor, 27, (gt.o) lazyArr[27].getValue(), embeddedActivityInviteEmbedImpl.getParticipantAvatarUris());
        compositeEncoder.F(serialDescriptor, 28, CodedLinkExtendedType.Serializer.INSTANCE, embeddedActivityInviteEmbedImpl.getExtendedType());
        if (compositeEncoder.z(serialDescriptor, 29) || embeddedActivityInviteEmbedImpl.getStructurableSubtitleText() != null) {
            compositeEncoder.i(serialDescriptor, 29, AnnotatedStructurableTextSerializer.INSTANCE, embeddedActivityInviteEmbedImpl.getStructurableSubtitleText());
        }
