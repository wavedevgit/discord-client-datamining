...
public final class EmbeddedActivityInviteEmbedImpl extends CodedLinkEmbed implements EmbeddedActivityInviteEmbed {
    ...
    public static final /* synthetic */ void write$Self$chat_release(EmbeddedActivityInviteEmbedImpl embeddedActivityInviteEmbedImpl, CompositeEncoder compositeEncoder, SerialDescriptor serialDescriptor) {
        ...
        n2 n2Var = n2.f6848a;
        compositeEncoder.z(serialDescriptor, 3, n2Var, embeddedActivityInviteEmbedImpl.getHeaderText());
        if (compositeEncoder.A(serialDescriptor, 4) || embeddedActivityInviteEmbedImpl.getType() != null) {
            compositeEncoder.z(serialDescriptor, 4, InviteType.Serializer.INSTANCE, embeddedActivityInviteEmbedImpl.getType());
        }
        if (compositeEncoder.A(serialDescriptor, 5) || embeddedActivityInviteEmbedImpl.getAcceptLabelBackgroundColor() != null) {
            compositeEncoder.z(serialDescriptor, 5, p0.f6864a, embeddedActivityInviteEmbedImpl.getAcceptLabelBackgroundColor());
        }
        if (compositeEncoder.A(serialDescriptor, 6) || embeddedActivityInviteEmbedImpl.getAcceptLabelBorderColor() != null) {
            compositeEncoder.z(serialDescriptor, 6, p0.f6864a, embeddedActivityInviteEmbedImpl.getAcceptLabelBorderColor());
        }
        if (compositeEncoder.A(serialDescriptor, 7) || embeddedActivityInviteEmbedImpl.getAcceptLabelColor() != null) {
            compositeEncoder.z(serialDescriptor, 7, p0.f6864a, embeddedActivityInviteEmbedImpl.getAcceptLabelColor());
        }
        if (compositeEncoder.A(serialDescriptor, 8) || embeddedActivityInviteEmbedImpl.getAcceptLabelText() != null) {
            compositeEncoder.z(serialDescriptor, 8, n2Var, embeddedActivityInviteEmbedImpl.getAcceptLabelText());
        }
        if (compositeEncoder.A(serialDescriptor, 9) || embeddedActivityInviteEmbedImpl.getBodyText() != null) {
            compositeEncoder.z(serialDescriptor, 9, n2Var, embeddedActivityInviteEmbedImpl.getBodyText());
        }
        if (compositeEncoder.A(serialDescriptor, 10) || embeddedActivityInviteEmbedImpl.getBodyTextColor() != null) {
            compositeEncoder.z(serialDescriptor, 10, p0.f6864a, embeddedActivityInviteEmbedImpl.getBodyTextColor());
        }
        if (compositeEncoder.A(serialDescriptor, 11) || embeddedActivityInviteEmbedImpl.getCanBeAccepted() != null) {
            compositeEncoder.z(serialDescriptor, 11, h.f6812a, embeddedActivityInviteEmbedImpl.getCanBeAccepted());
        }
        if (compositeEncoder.A(serialDescriptor, 12) || embeddedActivityInviteEmbedImpl.getEmbedCanBeTapped() != null) {
            compositeEncoder.z(serialDescriptor, 12, h.f6812a, embeddedActivityInviteEmbedImpl.getEmbedCanBeTapped());
        }
        if (compositeEncoder.A(serialDescriptor, 13) || embeddedActivityInviteEmbedImpl.getResolvingGradientEnd() != null) {
            compositeEncoder.z(serialDescriptor, 13, p0.f6864a, embeddedActivityInviteEmbedImpl.getResolvingGradientEnd());
        }
        if (compositeEncoder.A(serialDescriptor, 14) || embeddedActivityInviteEmbedImpl.getResolvingGradientStart() != null) {
            compositeEncoder.z(serialDescriptor, 14, p0.f6864a, embeddedActivityInviteEmbedImpl.getResolvingGradientStart());
        }
        if (compositeEncoder.A(serialDescriptor, 15) || embeddedActivityInviteEmbedImpl.getSplashHasRadialGradient() != null) {
            compositeEncoder.z(serialDescriptor, 15, h.f6812a, embeddedActivityInviteEmbedImpl.getSplashHasRadialGradient());
        }
        if (compositeEncoder.A(serialDescriptor, 16) || embeddedActivityInviteEmbedImpl.getSplashOpacity() != null) {
            compositeEncoder.z(serialDescriptor, 16, p0.f6864a, embeddedActivityInviteEmbedImpl.getSplashOpacity());
        }
        if (compositeEncoder.A(serialDescriptor, 17) || embeddedActivityInviteEmbedImpl.getSplashUrl() != null) {
            compositeEncoder.z(serialDescriptor, 17, n2Var, embeddedActivityInviteEmbedImpl.getSplashUrl());
        }
        if (compositeEncoder.A(serialDescriptor, 18) || embeddedActivityInviteEmbedImpl.getInviteSplash() != null) {
            compositeEncoder.z(serialDescriptor, 18, n2Var, embeddedActivityInviteEmbedImpl.getInviteSplash());
        }
        if (compositeEncoder.A(serialDescriptor, 19) || embeddedActivityInviteEmbedImpl.getSubtitle() != null) {
            compositeEncoder.z(serialDescriptor, 19, n2Var, embeddedActivityInviteEmbedImpl.getSubtitle());
        }
        if (compositeEncoder.A(serialDescriptor, 20) || embeddedActivityInviteEmbedImpl.getSubtitleColor() != null) {
            compositeEncoder.z(serialDescriptor, 20, p0.f6864a, embeddedActivityInviteEmbedImpl.getSubtitleColor());
        }
        if (compositeEncoder.A(serialDescriptor, 21) || embeddedActivityInviteEmbedImpl.getThumbnailBackgroundColor() != null) {
            compositeEncoder.z(serialDescriptor, 21, p0.f6864a, embeddedActivityInviteEmbedImpl.getThumbnailBackgroundColor());
        }
        if (compositeEncoder.A(serialDescriptor, 22) || embeddedActivityInviteEmbedImpl.getThumbnailCornerRadius() != null) {
            compositeEncoder.z(serialDescriptor, 22, p0.f6864a, embeddedActivityInviteEmbedImpl.getThumbnailCornerRadius());
        }
        if (compositeEncoder.A(serialDescriptor, 23) || embeddedActivityInviteEmbedImpl.getThumbnailText() != null) {
            compositeEncoder.z(serialDescriptor, 23, n2Var, embeddedActivityInviteEmbedImpl.getThumbnailText());
        }
        if (compositeEncoder.A(serialDescriptor, 24) || embeddedActivityInviteEmbedImpl.getThumbnailUrl() != null) {
            compositeEncoder.z(serialDescriptor, 24, n2Var, embeddedActivityInviteEmbedImpl.getThumbnailUrl());
        }
        if (compositeEncoder.A(serialDescriptor, 25) || embeddedActivityInviteEmbedImpl.getTitleColor() != null) {
            compositeEncoder.z(serialDescriptor, 25, p0.f6864a, embeddedActivityInviteEmbedImpl.getTitleColor());
        }
        if (compositeEncoder.A(serialDescriptor, 26) || embeddedActivityInviteEmbedImpl.getTitleText() != null) {
            compositeEncoder.z(serialDescriptor, 26, n2Var, embeddedActivityInviteEmbedImpl.getTitleText());
        }
        compositeEncoder.j(serialDescriptor, 27, (xs.o) lazyArr[27].getValue(), embeddedActivityInviteEmbedImpl.getParticipantAvatarUris());
        compositeEncoder.j(serialDescriptor, 28, CodedLinkExtendedType.Serializer.INSTANCE, embeddedActivityInviteEmbedImpl.getExtendedType());
        if (compositeEncoder.A(serialDescriptor, 29) || embeddedActivityInviteEmbedImpl.getStructurableSubtitleText() != null) {
            compositeEncoder.z(serialDescriptor, 29, AnnotatedStructurableTextSerializer.INSTANCE, embeddedActivityInviteEmbedImpl.getStructurableSubtitleText());
        }
