...
public final class GuildProfileInviteEmbedImpl extends CodedLinkEmbed implements GuildProfileInviteEmbed {
    ...
    @NotNull
    private static final Lazy[] $childSerializers = {null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, l.a(o.f6082e, new Function0() { // from class: com.discord.chat.bridge.codedlinks.d
    ...
    public static final /* synthetic */ void write$Self$chat_release(GuildProfileInviteEmbedImpl guildProfileInviteEmbedImpl, CompositeEncoder compositeEncoder, SerialDescriptor serialDescriptor) {
        ...
        if (compositeEncoder.z(serialDescriptor, 0) || guildProfileInviteEmbedImpl.getAcceptLabelBackgroundColor() != null) {
            compositeEncoder.o(serialDescriptor, 0, p0.f50048a, guildProfileInviteEmbedImpl.getAcceptLabelBackgroundColor());
        }
        if (compositeEncoder.z(serialDescriptor, 1) || guildProfileInviteEmbedImpl.getAcceptLabelBorderColor() != null) {
            compositeEncoder.o(serialDescriptor, 1, p0.f50048a, guildProfileInviteEmbedImpl.getAcceptLabelBorderColor());
        }
        if (compositeEncoder.z(serialDescriptor, 2) || guildProfileInviteEmbedImpl.getAcceptLabelColor() != null) {
            compositeEncoder.o(serialDescriptor, 2, p0.f50048a, guildProfileInviteEmbedImpl.getAcceptLabelColor());
        }
        if (compositeEncoder.z(serialDescriptor, 3) || guildProfileInviteEmbedImpl.getAcceptLabelText() != null) {
            compositeEncoder.o(serialDescriptor, 3, n2.f50032a, guildProfileInviteEmbedImpl.getAcceptLabelText());
        }
        if (compositeEncoder.z(serialDescriptor, 4) || guildProfileInviteEmbedImpl.getBodyTextColor() != null) {
            compositeEncoder.o(serialDescriptor, 4, p0.f50048a, guildProfileInviteEmbedImpl.getBodyTextColor());
        }
        if (compositeEncoder.z(serialDescriptor, 5) || guildProfileInviteEmbedImpl.getBodyText() != null) {
            compositeEncoder.o(serialDescriptor, 5, n2.f50032a, guildProfileInviteEmbedImpl.getBodyText());
        }
        ...
        if (compositeEncoder.z(serialDescriptor, 8) || guildProfileInviteEmbedImpl.getCanBeAccepted() != null) {
            compositeEncoder.o(serialDescriptor, 8, h.f49996a, guildProfileInviteEmbedImpl.getCanBeAccepted());
        }
        if (compositeEncoder.z(serialDescriptor, 9) || guildProfileInviteEmbedImpl.getEmbedCanBeTapped() != null) {
            compositeEncoder.o(serialDescriptor, 9, h.f49996a, guildProfileInviteEmbedImpl.getEmbedCanBeTapped());
        }
        ...
        if (compositeEncoder.z(serialDescriptor, 12) || guildProfileInviteEmbedImpl.getResolvingGradientEnd() != null) {
            compositeEncoder.o(serialDescriptor, 12, p0.f50048a, guildProfileInviteEmbedImpl.getResolvingGradientEnd());
        }
        if (compositeEncoder.z(serialDescriptor, 13) || guildProfileInviteEmbedImpl.getResolvingGradientStart() != null) {
            compositeEncoder.o(serialDescriptor, 13, p0.f50048a, guildProfileInviteEmbedImpl.getResolvingGradientStart());
        }
        if (compositeEncoder.z(serialDescriptor, 14) || guildProfileInviteEmbedImpl.getSplashHasRadialGradient() != null) {
            compositeEncoder.o(serialDescriptor, 14, h.f49996a, guildProfileInviteEmbedImpl.getSplashHasRadialGradient());
        }
        if (compositeEncoder.z(serialDescriptor, 15) || guildProfileInviteEmbedImpl.getSplashOpacity() != null) {
            compositeEncoder.o(serialDescriptor, 15, p0.f50048a, guildProfileInviteEmbedImpl.getSplashOpacity());
        }
        ...
        if (compositeEncoder.z(serialDescriptor, 17) || guildProfileInviteEmbedImpl.getInviteSplash() != null) {
            compositeEncoder.o(serialDescriptor, 17, n2Var, guildProfileInviteEmbedImpl.getInviteSplash());
        }
        ...
        if (compositeEncoder.z(serialDescriptor, 19) || guildProfileInviteEmbedImpl.getSubtitleColor() != null) {
            compositeEncoder.o(serialDescriptor, 19, p0.f50048a, guildProfileInviteEmbedImpl.getSubtitleColor());
        }
        if (compositeEncoder.z(serialDescriptor, 20) || guildProfileInviteEmbedImpl.getThumbnailBackgroundColor() != null) {
            compositeEncoder.o(serialDescriptor, 20, p0.f50048a, guildProfileInviteEmbedImpl.getThumbnailBackgroundColor());
        }
        if (compositeEncoder.z(serialDescriptor, 21) || guildProfileInviteEmbedImpl.getThumbnailCornerRadius() != null) {
            compositeEncoder.o(serialDescriptor, 21, p0.f50048a, guildProfileInviteEmbedImpl.getThumbnailCornerRadius());
        }
        ...
        if (compositeEncoder.z(serialDescriptor, 24) || guildProfileInviteEmbedImpl.getTitleColor() != null) {
            compositeEncoder.o(serialDescriptor, 24, p0.f50048a, guildProfileInviteEmbedImpl.getTitleColor());
        }
        ...
        if (compositeEncoder.z(serialDescriptor, 26) || guildProfileInviteEmbedImpl.getType() != null) {
            compositeEncoder.o(serialDescriptor, 26, InviteType.Serializer.INSTANCE, guildProfileInviteEmbedImpl.getType());
        }
        if (compositeEncoder.z(serialDescriptor, 27) || guildProfileInviteEmbedImpl.getExtendedType() != CodedLinkExtendedType.GUILD_PROFILE_INVITE) {
            compositeEncoder.k(serialDescriptor, 27, CodedLinkExtendedType.Serializer.INSTANCE, guildProfileInviteEmbedImpl.getExtendedType());
        }
        if (compositeEncoder.z(serialDescriptor, 28) || guildProfileInviteEmbedImpl.getMemberText() != null) {
            compositeEncoder.o(serialDescriptor, 28, n2Var, guildProfileInviteEmbedImpl.getMemberText());
        }
        if (compositeEncoder.z(serialDescriptor, 29) || guildProfileInviteEmbedImpl.getOnlineText() != null) {
            compositeEncoder.o(serialDescriptor, 29, n2Var, guildProfileInviteEmbedImpl.getOnlineText());
        }
        ...
        if (compositeEncoder.z(serialDescriptor, 33) || guildProfileInviteEmbedImpl.getBadgeIconUrl() != null) {
            compositeEncoder.o(serialDescriptor, 33, n2Var, guildProfileInviteEmbedImpl.getBadgeIconUrl());
        }
        if (compositeEncoder.z(serialDescriptor, 34) || guildProfileInviteEmbedImpl.getEstablishedText() != null) {
            compositeEncoder.o(serialDescriptor, 34, n2Var, guildProfileInviteEmbedImpl.getEstablishedText());
        }
        if (compositeEncoder.z(serialDescriptor, 35) || guildProfileInviteEmbedImpl.getRoles() != null) {
            compositeEncoder.o(serialDescriptor, 35, (qt.o) lazyArr[35].getValue(), guildProfileInviteEmbedImpl.getRoles());
        }
        if (compositeEncoder.z(serialDescriptor, 36) || guildProfileInviteEmbedImpl.getRolesHeadingText() != null) {
            compositeEncoder.o(serialDescriptor, 36, n2Var, guildProfileInviteEmbedImpl.getRolesHeadingText());
        }
    }
