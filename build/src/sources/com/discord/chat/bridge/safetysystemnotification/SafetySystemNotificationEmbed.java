...
public final class SafetySystemNotificationEmbed {
    ...
    @NotNull
    private static final Lazy[] $childSerializers = {null, null, null, null, null, null, null, null, null, null, l.a(o.f31119e, new Function0() { // from class: o6.b
    ...
    public static final /* synthetic */ void write$Self$chat_release(SafetySystemNotificationEmbed safetySystemNotificationEmbed, CompositeEncoder compositeEncoder, SerialDescriptor serialDescriptor) {
        ...
        if (compositeEncoder.A(serialDescriptor, 4) || safetySystemNotificationEmbed.primaryCtaText != null) {
            compositeEncoder.z(serialDescriptor, 4, n2.f6848a, safetySystemNotificationEmbed.primaryCtaText);
        }
        if (compositeEncoder.A(serialDescriptor, 5) || safetySystemNotificationEmbed.primaryCtaType != null) {
            compositeEncoder.z(serialDescriptor, 5, n2.f6848a, safetySystemNotificationEmbed.primaryCtaType);
        }
        if (compositeEncoder.A(serialDescriptor, 6) || safetySystemNotificationEmbed.primaryCtaKey != null) {
            compositeEncoder.z(serialDescriptor, 6, n2.f6848a, safetySystemNotificationEmbed.primaryCtaKey);
        }
        if (compositeEncoder.A(serialDescriptor, 7) || safetySystemNotificationEmbed.secondaryCtaText != null) {
            compositeEncoder.z(serialDescriptor, 7, n2.f6848a, safetySystemNotificationEmbed.secondaryCtaText);
        }
        if (compositeEncoder.A(serialDescriptor, 8) || safetySystemNotificationEmbed.secondaryCtaType != null) {
            compositeEncoder.z(serialDescriptor, 8, n2.f6848a, safetySystemNotificationEmbed.secondaryCtaType);
        }
        if (compositeEncoder.A(serialDescriptor, 9) || safetySystemNotificationEmbed.secondaryCtaKey != null) {
            compositeEncoder.z(serialDescriptor, 9, n2.f6848a, safetySystemNotificationEmbed.secondaryCtaKey);
        }
        compositeEncoder.j(serialDescriptor, 10, (xs.o) lazyArr[10].getValue(), safetySystemNotificationEmbed.footerTheme);
    }
