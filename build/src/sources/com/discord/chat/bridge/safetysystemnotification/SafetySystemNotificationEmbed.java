...
public final class SafetySystemNotificationEmbed {
    ...
    @NotNull
    private static final Lazy[] $childSerializers = {null, null, null, null, null, null, null, null, null, null, l.a(o.f32182e, new Function0() { // from class: o6.b
    ...
    public static final /* synthetic */ void write$Self$chat_release(SafetySystemNotificationEmbed safetySystemNotificationEmbed, CompositeEncoder compositeEncoder, SerialDescriptor serialDescriptor) {
        ...
        if (compositeEncoder.y(serialDescriptor, 4) || safetySystemNotificationEmbed.primaryCtaText != null) {
            compositeEncoder.B(serialDescriptor, 4, n2.f7662a, safetySystemNotificationEmbed.primaryCtaText);
        }
        if (compositeEncoder.y(serialDescriptor, 5) || safetySystemNotificationEmbed.primaryCtaType != null) {
            compositeEncoder.B(serialDescriptor, 5, n2.f7662a, safetySystemNotificationEmbed.primaryCtaType);
        }
        if (compositeEncoder.y(serialDescriptor, 6) || safetySystemNotificationEmbed.primaryCtaKey != null) {
            compositeEncoder.B(serialDescriptor, 6, n2.f7662a, safetySystemNotificationEmbed.primaryCtaKey);
        }
        if (compositeEncoder.y(serialDescriptor, 7) || safetySystemNotificationEmbed.secondaryCtaText != null) {
            compositeEncoder.B(serialDescriptor, 7, n2.f7662a, safetySystemNotificationEmbed.secondaryCtaText);
        }
        if (compositeEncoder.y(serialDescriptor, 8) || safetySystemNotificationEmbed.secondaryCtaType != null) {
            compositeEncoder.B(serialDescriptor, 8, n2.f7662a, safetySystemNotificationEmbed.secondaryCtaType);
        }
        if (compositeEncoder.y(serialDescriptor, 9) || safetySystemNotificationEmbed.secondaryCtaKey != null) {
            compositeEncoder.B(serialDescriptor, 9, n2.f7662a, safetySystemNotificationEmbed.secondaryCtaKey);
        }
        compositeEncoder.m(serialDescriptor, 10, (ys.o) lazyArr[10].getValue(), safetySystemNotificationEmbed.footerTheme);
    }
