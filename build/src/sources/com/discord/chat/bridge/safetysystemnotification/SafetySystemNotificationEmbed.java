...
public final class SafetySystemNotificationEmbed {
    ...
    @NotNull
    private static final Lazy[] $childSerializers = {null, null, null, null, null, null, null, null, null, null, l.b(o.f37120e, new Function0() { // from class: o6.b
    ...
    public static final /* synthetic */ void write$Self$chat_release(SafetySystemNotificationEmbed safetySystemNotificationEmbed, CompositeEncoder compositeEncoder, SerialDescriptor serialDescriptor) {
        ...
        compositeEncoder.y(serialDescriptor, 0, safetySystemNotificationEmbed.titleText);
        compositeEncoder.y(serialDescriptor, 1, safetySystemNotificationEmbed.titleIcon);
        ...
        if (compositeEncoder.z(serialDescriptor, 4) || safetySystemNotificationEmbed.primaryCtaText != null) {
            compositeEncoder.s(serialDescriptor, 4, n2.f20978a, safetySystemNotificationEmbed.primaryCtaText);
        }
        if (compositeEncoder.z(serialDescriptor, 5) || safetySystemNotificationEmbed.primaryCtaType != null) {
            compositeEncoder.s(serialDescriptor, 5, n2.f20978a, safetySystemNotificationEmbed.primaryCtaType);
        }
        if (compositeEncoder.z(serialDescriptor, 6) || safetySystemNotificationEmbed.primaryCtaKey != null) {
            compositeEncoder.s(serialDescriptor, 6, n2.f20978a, safetySystemNotificationEmbed.primaryCtaKey);
        }
        if (compositeEncoder.z(serialDescriptor, 7) || safetySystemNotificationEmbed.secondaryCtaText != null) {
            compositeEncoder.s(serialDescriptor, 7, n2.f20978a, safetySystemNotificationEmbed.secondaryCtaText);
        }
        if (compositeEncoder.z(serialDescriptor, 8) || safetySystemNotificationEmbed.secondaryCtaType != null) {
            compositeEncoder.s(serialDescriptor, 8, n2.f20978a, safetySystemNotificationEmbed.secondaryCtaType);
        }
        if (compositeEncoder.z(serialDescriptor, 9) || safetySystemNotificationEmbed.secondaryCtaKey != null) {
            compositeEncoder.s(serialDescriptor, 9, n2.f20978a, safetySystemNotificationEmbed.secondaryCtaKey);
        }
        compositeEncoder.D(serialDescriptor, 10, (at.o) lazyArr[10].getValue(), safetySystemNotificationEmbed.footerTheme);
    }
