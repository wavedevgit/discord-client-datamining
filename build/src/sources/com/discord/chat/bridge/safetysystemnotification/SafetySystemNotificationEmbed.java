...
public final class SafetySystemNotificationEmbed {
    ...
    @NotNull
    private static final Lazy[] $childSerializers = {null, null, null, null, null, null, null, null, null, null, l.b(o.f49210e, new Function0() { // from class: p6.b
    ...
    public static final /* synthetic */ void write$Self$chat_release(SafetySystemNotificationEmbed safetySystemNotificationEmbed, CompositeEncoder compositeEncoder, SerialDescriptor serialDescriptor) {
        ...
        if (compositeEncoder.z(serialDescriptor, 4) || safetySystemNotificationEmbed.primaryCtaText != null) {
            compositeEncoder.i(serialDescriptor, 4, n2.f35181a, safetySystemNotificationEmbed.primaryCtaText);
        }
        if (compositeEncoder.z(serialDescriptor, 5) || safetySystemNotificationEmbed.primaryCtaType != null) {
            compositeEncoder.i(serialDescriptor, 5, n2.f35181a, safetySystemNotificationEmbed.primaryCtaType);
        }
        if (compositeEncoder.z(serialDescriptor, 6) || safetySystemNotificationEmbed.primaryCtaKey != null) {
            compositeEncoder.i(serialDescriptor, 6, n2.f35181a, safetySystemNotificationEmbed.primaryCtaKey);
        }
        if (compositeEncoder.z(serialDescriptor, 7) || safetySystemNotificationEmbed.secondaryCtaText != null) {
            compositeEncoder.i(serialDescriptor, 7, n2.f35181a, safetySystemNotificationEmbed.secondaryCtaText);
        }
        if (compositeEncoder.z(serialDescriptor, 8) || safetySystemNotificationEmbed.secondaryCtaType != null) {
            compositeEncoder.i(serialDescriptor, 8, n2.f35181a, safetySystemNotificationEmbed.secondaryCtaType);
        }
        if (compositeEncoder.z(serialDescriptor, 9) || safetySystemNotificationEmbed.secondaryCtaKey != null) {
            compositeEncoder.i(serialDescriptor, 9, n2.f35181a, safetySystemNotificationEmbed.secondaryCtaKey);
        }
        compositeEncoder.F(serialDescriptor, 10, (gt.o) lazyArr[10].getValue(), safetySystemNotificationEmbed.footerTheme);
    }
