...
public final class PostPreviewEmbed implements SpoilerableData {
    ...
    */
    ...
    public int hashCode() {
        int m1064hashCodeimpl = ((((((((((((((ChannelId.m1064hashCodeimpl(this.parentChannelId) * 31) + ChannelId.m1064hashCodeimpl(this.threadId)) * 31) + MessageId.m1090hashCodeimpl(this.messageId)) * 31) + GuildId.m1077hashCodeimpl(this.guildId)) * 31) + this.title.hashCode()) * 31) + this.ctaText.hashCode()) * 31) + Integer.hashCode(this.ctaButtonColor)) * 31) + this.footer.hashCode()) * 31;
        String str = this.subtitle;
        int hashCode = (m1064hashCodeimpl + (str == null ? 0 : str.hashCode())) * 31;
    ...
    public String toString() {
        String m1066toStringimpl = ChannelId.m1066toStringimpl(this.parentChannelId);
        String m1066toStringimpl2 = ChannelId.m1066toStringimpl(this.threadId);
        ...
        Boolean bool3 = this.obscureIsOpaque;
        Boolean bool4 = this.verifyAge;
        return "PostPreviewEmbed(parentChannelId=" + m1066toStringimpl + ", threadId=" + m1066toStringimpl2 + ", messageId=" + m1092toStringimpl + ", guildId=" + m1079toStringimpl + ", title=" + str + ", ctaText=" + str2 + ", ctaButtonColor=" + i10 + ", footer=" + structurableText + ", subtitle=" + str3 + ", coverImage=" + str4 + ", blurredCoverImage=" + str5 + ", coverImageOverlayText=" + str6 + ", backgroundImage=" + str7 + ", spoiler=" + str8 + ", obscure=" + str9 + ", obscureAwaitingScan=" + bool + ", shouldSpoiler=" + z10 + ", obscureHideControls=" + bool2 + ", obscureIsOpaque=" + bool3 + ", verifyAge=" + bool4 + ")";
    }
    ...
    private /* synthetic */ PostPreviewEmbed(int i10, ChannelId channelId, ChannelId channelId2, String str, GuildId guildId, String str2, String str3, int i11, StructurableText structurableText, String str4, String str5, String str6, String str7, String str8, String str9, String str10, Boolean bool, boolean z10, Boolean bool2, Boolean bool3, Boolean bool4, String str11, String str12, SerializationConstructorMarker serializationConstructorMarker) {
        ...
        this.parentChannelId = channelId.m1068unboximpl();
        this.threadId = channelId2.m1068unboximpl();
        this.messageId = str;
