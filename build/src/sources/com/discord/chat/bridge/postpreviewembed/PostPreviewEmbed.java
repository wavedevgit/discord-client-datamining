...
public final class PostPreviewEmbed implements SpoilerableData {
    ...
    public static /* synthetic */ PostPreviewEmbed m397copy15l5paM$default(PostPreviewEmbed postPreviewEmbed, long j10, long j11, String str, long j12, String str2, String str3, int i10, StructurableText structurableText, String str4, String str5, String str6, String str7, String str8, String str9, String str10, Boolean bool, boolean z10, Boolean bool2, Boolean bool3, Boolean bool4, int i11, Object obj) {
        Boolean bool5;
        Boolean bool6;
        ...
        return postPreviewEmbed.m402copy15l5paM(j16, j14, str11, j15, str12, str13, i12, structurableText2, str14, str15, str16, str19, str18, str20, str21, bool7, z11, bool8, bool6, bool5);
    }
    ...
    */
    ...
    public final long m398component1o4g7jtM() {
    ...
    public final String m400component33Eiw7ao() {
        return this.messageId;
    }

    /* renamed from: component4-fYKD8eg  reason: not valid java name */
    public final long m401component4fYKD8eg() {
        return this.guildId;
    }
    ...
    public final long m403getGuildIdfYKD8eg() {
        return this.guildId;
    }
    ...
    public final long m405getParentChannelIdo4g7jtM() {
        return this.parentChannelId;
    }
    ...
    public final long m406getThreadIdo4g7jtM() {
        return this.threadId;
    }
    ...
    public int hashCode() {
        int m1063hashCodeimpl = ((((((((((((((ChannelId.m1063hashCodeimpl(this.parentChannelId) * 31) + ChannelId.m1063hashCodeimpl(this.threadId)) * 31) + MessageId.m1089hashCodeimpl(this.messageId)) * 31) + GuildId.m1076hashCodeimpl(this.guildId)) * 31) + this.title.hashCode()) * 31) + this.ctaText.hashCode()) * 31) + Integer.hashCode(this.ctaButtonColor)) * 31) + this.footer.hashCode()) * 31;
        String str = this.subtitle;
        int hashCode = (m1063hashCodeimpl + (str == null ? 0 : str.hashCode())) * 31;
    ...
    public String toString() {
        String m1065toStringimpl = ChannelId.m1065toStringimpl(this.parentChannelId);
        String m1065toStringimpl2 = ChannelId.m1065toStringimpl(this.threadId);
        ...
        Boolean bool3 = this.obscureIsOpaque;
        Boolean bool4 = this.verifyAge;
        return "PostPreviewEmbed(parentChannelId=" + m1065toStringimpl + ", threadId=" + m1065toStringimpl2 + ", messageId=" + m1091toStringimpl + ", guildId=" + m1078toStringimpl + ", title=" + str + ", ctaText=" + str2 + ", ctaButtonColor=" + i10 + ", footer=" + structurableText + ", subtitle=" + str3 + ", coverImage=" + str4 + ", blurredCoverImage=" + str5 + ", coverImageOverlayText=" + str6 + ", backgroundImage=" + str7 + ", spoiler=" + str8 + ", obscure=" + str9 + ", obscureAwaitingScan=" + bool + ", shouldSpoiler=" + z10 + ", obscureHideControls=" + bool2 + ", obscureIsOpaque=" + bool3 + ", verifyAge=" + bool4 + ")";
    }
    ...
    private /* synthetic */ PostPreviewEmbed(int i10, ChannelId channelId, ChannelId channelId2, String str, GuildId guildId, String str2, String str3, int i11, StructurableText structurableText, String str4, String str5, String str6, String str7, String str8, String str9, String str10, Boolean bool, boolean z10, Boolean bool2, Boolean bool3, Boolean bool4, String str11, String str12, SerializationConstructorMarker serializationConstructorMarker) {
        ...
        this.parentChannelId = channelId.m1067unboximpl();
        this.threadId = channelId2.m1067unboximpl();
        this.messageId = str;
