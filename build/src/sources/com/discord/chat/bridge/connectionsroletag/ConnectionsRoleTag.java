...
public final class ConnectionsRoleTag {
    ...
    public static /* synthetic */ ConnectionsRoleTag copy$default(ConnectionsRoleTag connectionsRoleTag, String str, String str2, int i10, int i11, int i12, Object obj) {
        if ((i12 & 1) != 0) {
            str = connectionsRoleTag.f8543id;
        }
        if ((i12 & 2) != 0) {
    ...
    public static final /* synthetic */ void write$Self$chat_release(ConnectionsRoleTag connectionsRoleTag, CompositeEncoder compositeEncoder, SerialDescriptor serialDescriptor) {
        compositeEncoder.z(serialDescriptor, 0, connectionsRoleTag.f8543id);
        compositeEncoder.z(serialDescriptor, 1, connectionsRoleTag.name);
        compositeEncoder.x(serialDescriptor, 2, connectionsRoleTag.backgroundColor);
        compositeEncoder.x(serialDescriptor, 3, connectionsRoleTag.iconColor);
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof ConnectionsRoleTag) {
            ...
            return Intrinsics.areEqual(this.f8543id, connectionsRoleTag.f8543id) && Intrinsics.areEqual(this.name, connectionsRoleTag.name) && this.backgroundColor == connectionsRoleTag.backgroundColor && this.iconColor == connectionsRoleTag.iconColor;
        }
        return false;
    }
    ...
    public int hashCode() {
        return (((((this.f8543id.hashCode() * 31) + this.name.hashCode()) * 31) + Integer.hashCode(this.backgroundColor)) * 31) + Integer.hashCode(this.iconColor);
    }

    @NotNull
    public String toString() {
        String str = this.f8543id;
