...
public final class ConnectionsRoleTag {
    ...
    public static /* synthetic */ ConnectionsRoleTag copy$default(ConnectionsRoleTag connectionsRoleTag, String str, String str2, int i10, int i11, int i12, Object obj) {
        if ((i12 & 1) != 0) {
            str = connectionsRoleTag.f9261id;
        }
        if ((i12 & 2) != 0) {
    ...
    public static final /* synthetic */ void write$Self$chat_release(ConnectionsRoleTag connectionsRoleTag, CompositeEncoder compositeEncoder, SerialDescriptor serialDescriptor) {
        compositeEncoder.y(serialDescriptor, 0, connectionsRoleTag.f9261id);
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof ConnectionsRoleTag) {
            ...
            return Intrinsics.areEqual(this.f9261id, connectionsRoleTag.f9261id) && Intrinsics.areEqual(this.name, connectionsRoleTag.name) && this.backgroundColor == connectionsRoleTag.backgroundColor && this.iconColor == connectionsRoleTag.iconColor;
        }
        return false;
    }
    ...
    public int hashCode() {
        return (((((this.f9261id.hashCode() * 31) + this.name.hashCode()) * 31) + Integer.hashCode(this.backgroundColor)) * 31) + Integer.hashCode(this.iconColor);
    }

    @NotNull
    public String toString() {
        String str = this.f9261id;
