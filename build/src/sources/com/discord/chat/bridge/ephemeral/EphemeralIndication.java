...
public final class EphemeralIndication {
    ...
    public static final /* synthetic */ void write$Self$chat_release(EphemeralIndication ephemeralIndication, CompositeEncoder compositeEncoder, SerialDescriptor serialDescriptor) {
        compositeEncoder.j(serialDescriptor, 0, StructurableTextSerializer.INSTANCE, ephemeralIndication.content);
        compositeEncoder.y(serialDescriptor, 1, ephemeralIndication.helpArticleLink);
        compositeEncoder.y(serialDescriptor, 2, ephemeralIndication.helpButtonAccessibilityLabel);
    }
