...
public final class EphemeralIndication {
    ...
    public static final /* synthetic */ void write$Self$chat_release(EphemeralIndication ephemeralIndication, CompositeEncoder compositeEncoder, SerialDescriptor serialDescriptor) {
        compositeEncoder.l(serialDescriptor, 0, StructurableTextSerializer.INSTANCE, ephemeralIndication.content);
        compositeEncoder.x(serialDescriptor, 1, ephemeralIndication.helpArticleLink);
        compositeEncoder.x(serialDescriptor, 2, ephemeralIndication.helpButtonAccessibilityLabel);
    }
