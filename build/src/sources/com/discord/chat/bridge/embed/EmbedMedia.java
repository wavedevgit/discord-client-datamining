...
public final class EmbedMedia implements EmbedUrlProvider {
    ...
    public static final /* synthetic */ void write$Self$chat_release(EmbedMedia embedMedia, CompositeEncoder compositeEncoder, SerialDescriptor serialDescriptor) {
        compositeEncoder.x(serialDescriptor, 0, embedMedia.url);
        if (compositeEncoder.y(serialDescriptor, 1) || embedMedia.proxyURL != null) {
            compositeEncoder.B(serialDescriptor, 1, n2.f7662a, embedMedia.proxyURL);
        }
        compositeEncoder.v(serialDescriptor, 2, embedMedia.width);
        compositeEncoder.v(serialDescriptor, 3, embedMedia.height);
        if (compositeEncoder.y(serialDescriptor, 4) || embedMedia.placeholder != null) {
            compositeEncoder.B(serialDescriptor, 4, n2.f7662a, embedMedia.placeholder);
        }
        if (compositeEncoder.y(serialDescriptor, 5) || embedMedia.placeholderVersion != null) {
            compositeEncoder.B(serialDescriptor, 5, p0.f7678a, embedMedia.placeholderVersion);
        }
        compositeEncoder.w(serialDescriptor, 6, embedMedia.srcIsAnimated);
        if (compositeEncoder.y(serialDescriptor, 7) || embedMedia.contentType != null) {
            compositeEncoder.B(serialDescriptor, 7, n2.f7662a, embedMedia.contentType);
        }
        if (!compositeEncoder.y(serialDescriptor, 8)) {
        ...
        compositeEncoder.x(serialDescriptor, 8, embedMedia.getEmbedUrl());
    }
