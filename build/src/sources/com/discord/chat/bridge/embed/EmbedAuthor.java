...
public final class EmbedAuthor {
    ...
    public /* synthetic */ EmbedAuthor(int i10, String str, String str2, String str3, String str4, SerializationConstructorMarker serializationConstructorMarker) {
        ...
        this.imageUrl$delegate = l.b(new Function0() { // from class: com.discord.chat.bridge.embed.d
    ...
    public static final /* synthetic */ void write$Self$chat_release(EmbedAuthor embedAuthor, CompositeEncoder compositeEncoder, SerialDescriptor serialDescriptor) {
        compositeEncoder.x(serialDescriptor, 0, embedAuthor.name);
        if (compositeEncoder.y(serialDescriptor, 1) || embedAuthor.url != null) {
            compositeEncoder.B(serialDescriptor, 1, n2.f7662a, embedAuthor.url);
        }
        if (compositeEncoder.y(serialDescriptor, 2) || embedAuthor.iconURL != null) {
            compositeEncoder.B(serialDescriptor, 2, n2.f7662a, embedAuthor.iconURL);
        }
        if (compositeEncoder.y(serialDescriptor, 3) || embedAuthor.iconProxyURL != null) {
            compositeEncoder.B(serialDescriptor, 3, n2.f7662a, embedAuthor.iconProxyURL);
        }
    }
    ...
    public EmbedAuthor(@NotNull String name, String str, String str2, String str3) {
        ...
        this.imageUrl$delegate = l.b(new Function0() { // from class: com.discord.chat.bridge.embed.e
            @Override // kotlin.jvm.functions.Function0
            public final Object invoke() {
                String str4;
