...
public final class EmbedThumbnail implements EmbedUrlProvider {
    ...
    public static final /* synthetic */ void write$Self$chat_release(EmbedThumbnail embedThumbnail, CompositeEncoder compositeEncoder, SerialDescriptor serialDescriptor) {
        compositeEncoder.x(serialDescriptor, 0, embedThumbnail.url);
        if (compositeEncoder.z(serialDescriptor, 1) || embedThumbnail.proxyURL != null) {
            compositeEncoder.A(serialDescriptor, 1, n2.f25302a, embedThumbnail.proxyURL);
        }
        if (compositeEncoder.z(serialDescriptor, 2) || embedThumbnail.videoUrl != null) {
            compositeEncoder.A(serialDescriptor, 2, n2.f25302a, embedThumbnail.videoUrl);
        }
        compositeEncoder.v(serialDescriptor, 3, embedThumbnail.height);
        compositeEncoder.v(serialDescriptor, 4, embedThumbnail.width);
        if (compositeEncoder.z(serialDescriptor, 5) || embedThumbnail.gifv != null) {
            compositeEncoder.A(serialDescriptor, 5, gt.h.f25266a, embedThumbnail.gifv);
        }
        if (compositeEncoder.z(serialDescriptor, 6) || embedThumbnail.showPlayButton != null) {
            compositeEncoder.A(serialDescriptor, 6, gt.h.f25266a, embedThumbnail.showPlayButton);
        }
        if (compositeEncoder.z(serialDescriptor, 7) || embedThumbnail.placeholder != null) {
            compositeEncoder.A(serialDescriptor, 7, n2.f25302a, embedThumbnail.placeholder);
        }
        if (compositeEncoder.z(serialDescriptor, 8) || embedThumbnail.placeholderVersion != null) {
            compositeEncoder.A(serialDescriptor, 8, p0.f25318a, embedThumbnail.placeholderVersion);
        }
        if (compositeEncoder.z(serialDescriptor, 9) || embedThumbnail.srcIsAnimated) {
            compositeEncoder.w(serialDescriptor, 9, embedThumbnail.srcIsAnimated);
        }
        ...
        compositeEncoder.x(serialDescriptor, 10, embedThumbnail.getEmbedUrl());
    }
