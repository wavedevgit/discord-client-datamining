...
public final class EmbedUtilsKt {
    ...
    public static final List<MediaSource> m391toImageMediaSourcesSHRpUJI(@NotNull Embed toImageMediaSources, long j10, @NotNull String str) {
    ...
    public static final MediaSource m392toMediaSourceUBIQNlQ(@NotNull Embed toMediaSource, long j10, @NotNull String messageId, boolean z10, Double d10) {
        String str;
        String str2;
        String str3;
        String str4;
