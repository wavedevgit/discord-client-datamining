    ...
    public static final List<MediaSource> m390toImageMediaSourcesSHRpUJI(@NotNull Embed toImageMediaSources, long j10, @NotNull String str) {
        ...
        if (images != null) {
            ...
            for (Iterator it = list.iterator(); it.hasNext(); it = it) {
                ...
                arrayList2.add(new MediaSource(null, embedMedia.getEmbedUrl(), null, null, getTag(toImageMediaSources), MediaType.IMAGE, false, ChannelId.m1057boximpl(j10), messageId, null, null, Boolean.valueOf(embedMedia.getSrcIsAnimated()), 1549, null));
                messageId = str;
    ...
    public static final MediaSource m391toMediaSourceUBIQNlQ(@NotNull Embed toMediaSource, long j10, @NotNull String messageId, boolean z10, Double d10) {
        ...
        if (i10 != 1) {
            if (i10 != 2) {
                ...
                return new MediaSource(null, str7, str8, num, tag, mediaType, z10, ChannelId.m1057boximpl(j10), messageId, null, null, bool, 1537, null);
            }
            ...
            return new MediaSource(str4, str5, str6, num3, tag2, mediaType2, false, ChannelId.m1057boximpl(j10), messageId, null, d10, Boolean.valueOf(z11), IntBufferBatchMountItem.INSTRUCTION_UPDATE_PADDING, null);
        }
        ...
        return new MediaSource(str, str2, str3, num2, tag3, mediaType3, z10, ChannelId.m1057boximpl(j10), messageId, null, d10, Boolean.valueOf(z11), IntBufferBatchMountItem.INSTRUCTION_UPDATE_PADDING, null);
    }
}
