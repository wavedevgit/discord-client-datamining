...
public final class EmbedField {
    ...
    public static final /* synthetic */ void write$Self$chat_release(EmbedField embedField, CompositeEncoder compositeEncoder, SerialDescriptor serialDescriptor) {
        if (compositeEncoder.z(serialDescriptor, 0) || embedField.rawName != null) {
            compositeEncoder.i(serialDescriptor, 0, n2.f35181a, embedField.rawName);
        }
        if (compositeEncoder.z(serialDescriptor, 1) || embedField.rawValue != null) {
            compositeEncoder.i(serialDescriptor, 1, n2.f35181a, embedField.rawValue);
        }
        if (compositeEncoder.z(serialDescriptor, 2) || embedField.name != null) {
            compositeEncoder.i(serialDescriptor, 2, StructurableTextSerializer.INSTANCE, embedField.name);
        }
        if (compositeEncoder.z(serialDescriptor, 3) || embedField.value != null) {
            compositeEncoder.i(serialDescriptor, 3, StructurableTextSerializer.INSTANCE, embedField.value);
        }
    }
