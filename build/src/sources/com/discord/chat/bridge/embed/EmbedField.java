...
public final class EmbedField {
    ...
    public static final /* synthetic */ void write$Self$chat_release(EmbedField embedField, CompositeEncoder compositeEncoder, SerialDescriptor serialDescriptor) {
        if (compositeEncoder.y(serialDescriptor, 0) || embedField.rawName != null) {
            compositeEncoder.B(serialDescriptor, 0, n2.f7662a, embedField.rawName);
        }
        if (compositeEncoder.y(serialDescriptor, 1) || embedField.rawValue != null) {
            compositeEncoder.B(serialDescriptor, 1, n2.f7662a, embedField.rawValue);
        }
        if (compositeEncoder.y(serialDescriptor, 2) || embedField.name != null) {
            compositeEncoder.B(serialDescriptor, 2, StructurableTextSerializer.INSTANCE, embedField.name);
        }
        if (compositeEncoder.y(serialDescriptor, 3) || embedField.value != null) {
            compositeEncoder.B(serialDescriptor, 3, StructurableTextSerializer.INSTANCE, embedField.value);
        }
    }
