...
public final class ThreadEmbed {
    ...
    public static final /* synthetic */ void write$Self$chat_release(ThreadEmbed threadEmbed, CompositeEncoder compositeEncoder, SerialDescriptor serialDescriptor) {
        compositeEncoder.x(serialDescriptor, 0, threadEmbed.title);
        compositeEncoder.x(serialDescriptor, 1, threadEmbed.messageCountLabel);
        if (compositeEncoder.z(serialDescriptor, 2) || threadEmbed.messagePreviewString != null) {
            compositeEncoder.A(serialDescriptor, 2, n2.f25302a, threadEmbed.messagePreviewString);
        }
        if (compositeEncoder.z(serialDescriptor, 3) || threadEmbed.archived != null) {
            compositeEncoder.A(serialDescriptor, 3, h.f25266a, threadEmbed.archived);
        }
        if (compositeEncoder.z(serialDescriptor, 4) || threadEmbed.archivedIconUrl != null) {
            compositeEncoder.A(serialDescriptor, 4, n2.f25302a, threadEmbed.archivedIconUrl);
        }
        if (compositeEncoder.z(serialDescriptor, 5) || threadEmbed.referencedMessage != null) {
            compositeEncoder.A(serialDescriptor, 5, ThreadEmbedMessage$$serializer.INSTANCE, threadEmbed.referencedMessage);
        }
    }
