...
public final class ThreadEmbed {
    ...
    public static final /* synthetic */ void write$Self$chat_release(ThreadEmbed threadEmbed, CompositeEncoder compositeEncoder, SerialDescriptor serialDescriptor) {
        ...
        if (compositeEncoder.y(serialDescriptor, 2) || threadEmbed.messagePreviewString != null) {
            compositeEncoder.B(serialDescriptor, 2, n2.f7662a, threadEmbed.messagePreviewString);
        }
        if (compositeEncoder.y(serialDescriptor, 3) || threadEmbed.archived != null) {
            compositeEncoder.B(serialDescriptor, 3, h.f7626a, threadEmbed.archived);
        }
        if (compositeEncoder.y(serialDescriptor, 4) || threadEmbed.archivedIconUrl != null) {
            compositeEncoder.B(serialDescriptor, 4, n2.f7662a, threadEmbed.archivedIconUrl);
        }
        if (compositeEncoder.y(serialDescriptor, 5) || threadEmbed.referencedMessage != null) {
            compositeEncoder.B(serialDescriptor, 5, ThreadEmbedMessage$$serializer.INSTANCE, threadEmbed.referencedMessage);
        }
    }
