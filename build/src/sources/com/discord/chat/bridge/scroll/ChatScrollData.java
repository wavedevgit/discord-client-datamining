...
public final class ChatScrollData {
    ...
    public static final /* synthetic */ void write$Self$chat_release(ChatScrollData chatScrollData, CompositeEncoder compositeEncoder, SerialDescriptor serialDescriptor) {
        compositeEncoder.F(serialDescriptor, 0, ChatScrollType.Serializer.INSTANCE, chatScrollData.type);
        ...
        if (compositeEncoder.z(serialDescriptor, 4) || chatScrollData.position != null) {
            compositeEncoder.i(serialDescriptor, 4, p0.f35197a, chatScrollData.position);
        }
    }
