...
public final class BackgroundHighlight {
    ...
    public static final /* synthetic */ void write$Self$chat_release(BackgroundHighlight backgroundHighlight, CompositeEncoder compositeEncoder, SerialDescriptor serialDescriptor) {
        if (compositeEncoder.y(serialDescriptor, 0) || backgroundHighlight.backgroundColor != null) {
            compositeEncoder.B(serialDescriptor, 0, p0.f7678a, backgroundHighlight.backgroundColor);
        }
        if (compositeEncoder.y(serialDescriptor, 1) || backgroundHighlight.gutterColor != null) {
            compositeEncoder.B(serialDescriptor, 1, p0.f7678a, backgroundHighlight.gutterColor);
        }
    }
