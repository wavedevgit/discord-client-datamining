...
public final class Sticker {
    ...
    public static final /* synthetic */ void write$Self$chat_release(Sticker sticker, CompositeEncoder compositeEncoder, SerialDescriptor serialDescriptor) {
        compositeEncoder.E(serialDescriptor, 0, sticker.f8562id);
        compositeEncoder.s(serialDescriptor, 1, StickerFormatType.StickerFormatTypeSerializer.INSTANCE, sticker.formatType);
        compositeEncoder.z(serialDescriptor, 2, sticker.name);
    ...
    public int hashCode() {
        int hashCode = ((((((((Long.hashCode(this.f8562id) * 31) + this.formatType.hashCode()) * 31) + this.name.hashCode()) * 31) + this.asset.hashCode()) * 31) + this.url.hashCode()) * 31;
