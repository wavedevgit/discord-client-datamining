...
public final class Sticker {
    ...
    public static final /* synthetic */ void write$Self$chat_release(Sticker sticker, CompositeEncoder compositeEncoder, SerialDescriptor serialDescriptor) {
        compositeEncoder.D(serialDescriptor, 0, sticker.f8702id);
        compositeEncoder.F(serialDescriptor, 1, StickerFormatType.StickerFormatTypeSerializer.INSTANCE, sticker.formatType);
        ...
        if (compositeEncoder.z(serialDescriptor, 5) || sticker.width != null) {
            compositeEncoder.i(serialDescriptor, 5, p0.f35197a, sticker.width);
        }
        if (compositeEncoder.z(serialDescriptor, 6) || sticker.height != null) {
            compositeEncoder.i(serialDescriptor, 6, p0.f35197a, sticker.height);
        }
    ...
    public int hashCode() {
        int hashCode = ((((((((Long.hashCode(this.f8702id) * 31) + this.formatType.hashCode()) * 31) + this.name.hashCode()) * 31) + this.asset.hashCode()) * 31) + this.url.hashCode()) * 31;
