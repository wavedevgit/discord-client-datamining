...
public final class Sticker {
    ...
    public static final /* synthetic */ void write$Self$chat_release(Sticker sticker, CompositeEncoder compositeEncoder, SerialDescriptor serialDescriptor) {
        compositeEncoder.E(serialDescriptor, 0, sticker.f8663id);
        compositeEncoder.l(serialDescriptor, 1, StickerFormatType.StickerFormatTypeSerializer.INSTANCE, sticker.formatType);
        ...
        if (compositeEncoder.z(serialDescriptor, 5) || sticker.width != null) {
            compositeEncoder.A(serialDescriptor, 5, p0.f25318a, sticker.width);
        }
        if (compositeEncoder.z(serialDescriptor, 6) || sticker.height != null) {
            compositeEncoder.A(serialDescriptor, 6, p0.f25318a, sticker.height);
        }
    ...
    public int hashCode() {
        int hashCode = ((((((((Long.hashCode(this.f8663id) * 31) + this.formatType.hashCode()) * 31) + this.name.hashCode()) * 31) + this.asset.hashCode()) * 31) + this.url.hashCode()) * 31;
