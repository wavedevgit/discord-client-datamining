...
public final class ChannelPromptData {
    ...
    public static final /* synthetic */ void write$Self$chat_release(ChannelPromptData channelPromptData, CompositeEncoder compositeEncoder, SerialDescriptor serialDescriptor) {
        if (compositeEncoder.y(serialDescriptor, 0) || channelPromptData.cameraButtonIcon != null) {
            compositeEncoder.B(serialDescriptor, 0, n2.f7662a, channelPromptData.cameraButtonIcon);
        }
        if (compositeEncoder.y(serialDescriptor, 1) || channelPromptData.gifButtonIcon != null) {
            compositeEncoder.B(serialDescriptor, 1, n2.f7662a, channelPromptData.gifButtonIcon);
        }
        if (compositeEncoder.y(serialDescriptor, 2) || channelPromptData.emojiButtonIcon != null) {
            compositeEncoder.B(serialDescriptor, 2, n2.f7662a, channelPromptData.emojiButtonIcon);
        }
        if (compositeEncoder.y(serialDescriptor, 3) || channelPromptData.gamingStatsButtonText != null) {
            compositeEncoder.B(serialDescriptor, 3, n2.f7662a, channelPromptData.gamingStatsButtonText);
        }
        if (compositeEncoder.y(serialDescriptor, 4) || channelPromptData.cameraButtonText != null) {
            compositeEncoder.B(serialDescriptor, 4, n2.f7662a, channelPromptData.cameraButtonText);
        }
        if (compositeEncoder.y(serialDescriptor, 5) || channelPromptData.gifButtonText != null) {
            compositeEncoder.B(serialDescriptor, 5, n2.f7662a, channelPromptData.gifButtonText);
        }
        if (compositeEncoder.y(serialDescriptor, 6) || channelPromptData.emojiButtonText != null) {
            compositeEncoder.B(serialDescriptor, 6, n2.f7662a, channelPromptData.emojiButtonText);
        }
    }
