...
public final class InteractionStatus {
    ...
    public static final /* synthetic */ void write$Self$chat_release(InteractionStatus interactionStatus, CompositeEncoder compositeEncoder, SerialDescriptor serialDescriptor) {
        compositeEncoder.s(serialDescriptor, 0, InteractionStatusViewState.Serializer.INSTANCE, interactionStatus.state);
        compositeEncoder.s(serialDescriptor, 1, StructurableTextSerializer.INSTANCE, interactionStatus.text);
    }
