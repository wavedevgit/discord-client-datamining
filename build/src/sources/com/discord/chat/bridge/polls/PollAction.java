...
public final class PollAction {
    ...
    @NotNull
    private static final Lazy[] $childSerializers = {null, l.b(o.f49210e, new Function0() { // from class: o6.a
    ...
    public static final /* synthetic */ void write$Self$chat_release(PollAction pollAction, CompositeEncoder compositeEncoder, SerialDescriptor serialDescriptor) {
        ...
        compositeEncoder.F(serialDescriptor, 1, (gt.o) lazyArr[1].getValue(), pollAction.presentation);
        compositeEncoder.x(serialDescriptor, 2, pollAction.enabled);
        if (compositeEncoder.z(serialDescriptor, 3) || pollAction.type != null) {
            compositeEncoder.i(serialDescriptor, 3, n2.f35181a, pollAction.type);
        }
        if (compositeEncoder.z(serialDescriptor, 4) || pollAction.secondaryLabel != null) {
            compositeEncoder.i(serialDescriptor, 4, n2.f35181a, pollAction.secondaryLabel);
        }
        if (compositeEncoder.z(serialDescriptor, 5) || pollAction.accessibilityHint != null) {
            compositeEncoder.i(serialDescriptor, 5, n2.f35181a, pollAction.accessibilityHint);
        }
    }
