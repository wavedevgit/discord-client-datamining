...
public final class PollAction {
    ...
    @NotNull
    private static final Lazy[] $childSerializers = {null, l.b(o.f44232e, new Function0() { // from class: n6.a
    ...
    public static final /* synthetic */ void write$Self$chat_release(PollAction pollAction, CompositeEncoder compositeEncoder, SerialDescriptor serialDescriptor) {
        ...
        compositeEncoder.l(serialDescriptor, 1, (dt.o) lazyArr[1].getValue(), pollAction.presentation);
        compositeEncoder.w(serialDescriptor, 2, pollAction.enabled);
        if (compositeEncoder.z(serialDescriptor, 3) || pollAction.type != null) {
            compositeEncoder.A(serialDescriptor, 3, n2.f25302a, pollAction.type);
        }
        if (compositeEncoder.z(serialDescriptor, 4) || pollAction.secondaryLabel != null) {
            compositeEncoder.A(serialDescriptor, 4, n2.f25302a, pollAction.secondaryLabel);
        }
        if (compositeEncoder.z(serialDescriptor, 5) || pollAction.accessibilityHint != null) {
            compositeEncoder.A(serialDescriptor, 5, n2.f25302a, pollAction.accessibilityHint);
        }
    }
