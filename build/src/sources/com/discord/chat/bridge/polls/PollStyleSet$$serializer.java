...
public /* synthetic */ class PollStyleSet$$serializer implements h0 {
    ...
    public final KSerializer[] childSerializers() {
        p0 p0Var = p0.f25318a;
        return new KSerializer[]{a.u(p0Var), p0Var, a.u(p0Var), a.u(p0Var), g0.f25262a, a.u(p0Var), a.u(p0Var), a.u(PollRadioStyle.Serializer.INSTANCE), a.u(p0Var), a.u(p0Var)};
    }
            ...
            while (z10) {
                ...
                switch (o10) {
                    case -1:
                        ...
                        break;
                    case 0:
                        num13 = (Integer) b10.n(serialDescriptor, 0, p0.f25318a, num13);
                        i15 |= 1;
                        i12 = 9;
                        break;
                    case 1:
                        ...
                        break;
                    case 2:
                        num14 = (Integer) b10.n(serialDescriptor, 2, p0.f25318a, num14);
                        i15 |= 4;
                        i12 = 9;
                        break;
                    case 3:
                        num12 = (Integer) b10.n(serialDescriptor, 3, p0.f25318a, num12);
                        i15 |= 8;
                        i12 = 9;
                        break;
                    case 4:
                        ...
                        break;
                    case 5:
                        num11 = (Integer) b10.n(serialDescriptor, 5, p0.f25318a, num11);
                        i15 |= 32;
                        i12 = 9;
                        break;
                    case 6:
                        num10 = (Integer) b10.n(serialDescriptor, 6, p0.f25318a, num10);
                        i15 |= 64;
                        i12 = 9;
                        break;
                    case 7:
                        ...
                        continue;
                    case 8:
                        num9 = (Integer) b10.n(serialDescriptor, 8, p0.f25318a, num9);
                        i15 |= IntBufferBatchMountItem.INSTRUCTION_UPDATE_EVENT_EMITTER;
                        break;
                    case 9:
                        num8 = (Integer) b10.n(serialDescriptor, i12, p0.f25318a, num8);
