...
public final class PollStyleSet implements IPollStyleSet {
    ...
    @NotNull
    private static final Lazy DEFAULT$delegate = l.b(new Function0() { // from class: n6.f
    ...
    public static final /* synthetic */ void write$Self$chat_release(PollStyleSet pollStyleSet, CompositeEncoder compositeEncoder, SerialDescriptor serialDescriptor) {
        if (compositeEncoder.y(serialDescriptor, 0) || pollStyleSet.border != null) {
            compositeEncoder.B(serialDescriptor, 0, p0.f7678a, pollStyleSet.border);
        }
        if (compositeEncoder.y(serialDescriptor, 1) || pollStyleSet.borderWidth != 0) {
            compositeEncoder.v(serialDescriptor, 1, pollStyleSet.borderWidth);
        }
        if (compositeEncoder.y(serialDescriptor, 2) || pollStyleSet.fill != null) {
            compositeEncoder.B(serialDescriptor, 2, p0.f7678a, pollStyleSet.fill);
        }
        if (compositeEncoder.y(serialDescriptor, 3) || pollStyleSet.label != null) {
            compositeEncoder.B(serialDescriptor, 3, p0.f7678a, pollStyleSet.label);
        }
        if (compositeEncoder.y(serialDescriptor, 4) || Float.compare(pollStyleSet.opacity, 1.0f) != 0) {
            compositeEncoder.r(serialDescriptor, 4, pollStyleSet.opacity);
        }
        if (compositeEncoder.y(serialDescriptor, 5) || pollStyleSet.answerBackground != null) {
            compositeEncoder.B(serialDescriptor, 5, p0.f7678a, pollStyleSet.answerBackground);
        }
        if (compositeEncoder.y(serialDescriptor, 6) || pollStyleSet.answerFill != null) {
            compositeEncoder.B(serialDescriptor, 6, p0.f7678a, pollStyleSet.answerFill);
        }
        if (compositeEncoder.y(serialDescriptor, 7) || pollStyleSet.radioStyle != null) {
            compositeEncoder.B(serialDescriptor, 7, PollRadioStyle.Serializer.INSTANCE, pollStyleSet.radioStyle);
        }
        if (compositeEncoder.y(serialDescriptor, 8) || pollStyleSet.radioBackground != null) {
            compositeEncoder.B(serialDescriptor, 8, p0.f7678a, pollStyleSet.radioBackground);
        }
        if (compositeEncoder.y(serialDescriptor, 9) || pollStyleSet.radioForeground != null) {
            compositeEncoder.B(serialDescriptor, 9, p0.f7678a, pollStyleSet.radioForeground);
        }
    }
