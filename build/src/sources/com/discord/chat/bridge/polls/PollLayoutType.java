...
public final class PollLayoutType implements IntEnum {
    private static final /* synthetic */ EnumEntries $ENTRIES;
    private static final /* synthetic */ PollLayoutType[] $VALUES;
    @NotNull
    public static final Companion Companion;
    private final int serialNumber;
    public static final PollLayoutType UNKNOWN = new PollLayoutType("UNKNOWN", 0, 0);
    public static final PollLayoutType TEXT_AND_IMAGE = new PollLayoutType("TEXT_AND_IMAGE", 1, 1);
    public static final PollLayoutType IMAGE_ONLY = new PollLayoutType("IMAGE_ONLY", 2, 2);
    ...
    private static final /* synthetic */ PollLayoutType[] $values() {
        return new PollLayoutType[]{UNKNOWN, TEXT_AND_IMAGE, IMAGE_ONLY};
    }

    static {
        PollLayoutType[] $values = $values();
        $VALUES = $values;
        $ENTRIES = a.a($values);
        Companion = new Companion(null);
    }

    private PollLayoutType(String str, int i10, int i11) {
    ...
    public static PollLayoutType valueOf(String str) {
        return (PollLayoutType) Enum.valueOf(PollLayoutType.class, str);
    }

    public static PollLayoutType[] values() {
        return (PollLayoutType[]) $VALUES.clone();
    }
