...
public final class PollData {
    ...
    @NotNull
    private static final Lazy[] $childSerializers = {null, null, l.b(o.f49210e, new Function0() { // from class: o6.c
    ...
    public static final /* synthetic */ void write$Self$chat_release(PollData pollData, CompositeEncoder compositeEncoder, SerialDescriptor serialDescriptor) {
        ...
        compositeEncoder.F(serialDescriptor, 0, PollResources$$serializer.INSTANCE, pollData.resources);
        compositeEncoder.F(serialDescriptor, 1, PollMedia$$serializer.INSTANCE, pollData.question);
        compositeEncoder.F(serialDescriptor, 2, (gt.o) lazyArr[2].getValue(), pollData.answers);
        compositeEncoder.F(serialDescriptor, 3, PollChatAnswerInteractionType.Serializer.INSTANCE, pollData.answersInteraction);
        if (compositeEncoder.z(serialDescriptor, 4) || pollData.answerTapAccessibilityLabel != null) {
            compositeEncoder.i(serialDescriptor, 4, n2.f35181a, pollData.answerTapAccessibilityLabel);
        }
        compositeEncoder.F(serialDescriptor, 5, PollLayoutType.Serializer.INSTANCE, pollData.layoutType);
        ...
        if (compositeEncoder.z(serialDescriptor, 12) || pollData.myAvatarUrl != null) {
            compositeEncoder.i(serialDescriptor, 12, n2.f35181a, pollData.myAvatarUrl);
        }
        if (compositeEncoder.z(serialDescriptor, 13) || pollData.secondaryAction != null) {
            compositeEncoder.i(serialDescriptor, 13, PollAction$$serializer.INSTANCE, pollData.secondaryAction);
        }
        if (compositeEncoder.z(serialDescriptor, 14) || pollData.primaryAction != null) {
            compositeEncoder.i(serialDescriptor, 14, PollAction$$serializer.INSTANCE, pollData.primaryAction);
        }
        if (compositeEncoder.z(serialDescriptor, 15) || pollData.tertiaryAction != null) {
            compositeEncoder.i(serialDescriptor, 15, PollAction$$serializer.INSTANCE, pollData.tertiaryAction);
        }
        if (compositeEncoder.z(serialDescriptor, 16) || pollData.promptLabel != null) {
            compositeEncoder.i(serialDescriptor, 16, n2.f35181a, pollData.promptLabel);
        }
    }
