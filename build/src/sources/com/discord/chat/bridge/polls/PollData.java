...
public final class PollData {
    ...
    @NotNull
    private static final Lazy[] $childSerializers = {null, null, l.b(o.f44232e, new Function0() { // from class: n6.c
    ...
    public static final /* synthetic */ void write$Self$chat_release(PollData pollData, CompositeEncoder compositeEncoder, SerialDescriptor serialDescriptor) {
        ...
        compositeEncoder.l(serialDescriptor, 0, PollResources$$serializer.INSTANCE, pollData.resources);
        compositeEncoder.l(serialDescriptor, 1, PollMedia$$serializer.INSTANCE, pollData.question);
        compositeEncoder.l(serialDescriptor, 2, (dt.o) lazyArr[2].getValue(), pollData.answers);
        compositeEncoder.l(serialDescriptor, 3, PollChatAnswerInteractionType.Serializer.INSTANCE, pollData.answersInteraction);
        if (compositeEncoder.z(serialDescriptor, 4) || pollData.answerTapAccessibilityLabel != null) {
            compositeEncoder.A(serialDescriptor, 4, n2.f25302a, pollData.answerTapAccessibilityLabel);
        }
        compositeEncoder.l(serialDescriptor, 5, PollLayoutType.Serializer.INSTANCE, pollData.layoutType);
        ...
        if (compositeEncoder.z(serialDescriptor, 12) || pollData.myAvatarUrl != null) {
            compositeEncoder.A(serialDescriptor, 12, n2.f25302a, pollData.myAvatarUrl);
        }
        if (compositeEncoder.z(serialDescriptor, 13) || pollData.secondaryAction != null) {
            compositeEncoder.A(serialDescriptor, 13, PollAction$$serializer.INSTANCE, pollData.secondaryAction);
        }
        if (compositeEncoder.z(serialDescriptor, 14) || pollData.primaryAction != null) {
            compositeEncoder.A(serialDescriptor, 14, PollAction$$serializer.INSTANCE, pollData.primaryAction);
        }
        if (compositeEncoder.z(serialDescriptor, 15) || pollData.tertiaryAction != null) {
            compositeEncoder.A(serialDescriptor, 15, PollAction$$serializer.INSTANCE, pollData.tertiaryAction);
        }
        if (compositeEncoder.z(serialDescriptor, 16) || pollData.promptLabel != null) {
            compositeEncoder.A(serialDescriptor, 16, n2.f25302a, pollData.promptLabel);
        }
    }
