...
public final class PollData {
    ...
    @NotNull
    private static final Lazy[] $childSerializers = {null, null, l.a(o.f31103e, new Function0() { // from class: n6.c
    ...
    public static final /* synthetic */ void write$Self$chat_release(PollData pollData, CompositeEncoder compositeEncoder, SerialDescriptor serialDescriptor) {
        ...
        compositeEncoder.j(serialDescriptor, 0, PollResources$$serializer.INSTANCE, pollData.resources);
        compositeEncoder.j(serialDescriptor, 1, PollMedia$$serializer.INSTANCE, pollData.question);
        compositeEncoder.j(serialDescriptor, 2, (xs.o) lazyArr[2].getValue(), pollData.answers);
        compositeEncoder.j(serialDescriptor, 3, PollChatAnswerInteractionType.Serializer.INSTANCE, pollData.answersInteraction);
        if (compositeEncoder.A(serialDescriptor, 4) || pollData.answerTapAccessibilityLabel != null) {
            compositeEncoder.z(serialDescriptor, 4, n2.f6848a, pollData.answerTapAccessibilityLabel);
        }
        compositeEncoder.j(serialDescriptor, 5, PollLayoutType.Serializer.INSTANCE, pollData.layoutType);
        ...
        if (compositeEncoder.A(serialDescriptor, 12) || pollData.myAvatarUrl != null) {
            compositeEncoder.z(serialDescriptor, 12, n2.f6848a, pollData.myAvatarUrl);
        }
        if (compositeEncoder.A(serialDescriptor, 13) || pollData.secondaryAction != null) {
            compositeEncoder.z(serialDescriptor, 13, PollAction$$serializer.INSTANCE, pollData.secondaryAction);
        }
        if (compositeEncoder.A(serialDescriptor, 14) || pollData.primaryAction != null) {
            compositeEncoder.z(serialDescriptor, 14, PollAction$$serializer.INSTANCE, pollData.primaryAction);
        }
        if (compositeEncoder.A(serialDescriptor, 15) || pollData.tertiaryAction != null) {
            compositeEncoder.z(serialDescriptor, 15, PollAction$$serializer.INSTANCE, pollData.tertiaryAction);
        }
        if (compositeEncoder.A(serialDescriptor, 16) || pollData.promptLabel != null) {
            compositeEncoder.z(serialDescriptor, 16, n2.f6848a, pollData.promptLabel);
        }
    }
