...
public final class PollData {
    ...
    @NotNull
    private static final Lazy[] $childSerializers = {null, null, l.a(o.f6082e, new Function0() { // from class: o6.c
    ...
    public static final /* synthetic */ void write$Self$chat_release(PollData pollData, CompositeEncoder compositeEncoder, SerialDescriptor serialDescriptor) {
        ...
        compositeEncoder.k(serialDescriptor, 0, PollResources$$serializer.INSTANCE, pollData.resources);
        compositeEncoder.k(serialDescriptor, 1, PollMedia$$serializer.INSTANCE, pollData.question);
        ...
        if (compositeEncoder.z(serialDescriptor, 4) || pollData.answerTapAccessibilityLabel != null) {
            compositeEncoder.o(serialDescriptor, 4, n2.f50601a, pollData.answerTapAccessibilityLabel);
        }
        ...
        if (compositeEncoder.z(serialDescriptor, 12) || pollData.myAvatarUrl != null) {
            compositeEncoder.o(serialDescriptor, 12, n2.f50601a, pollData.myAvatarUrl);
        }
        ...
        if (compositeEncoder.z(serialDescriptor, 14) || pollData.primaryAction != null) {
            compositeEncoder.o(serialDescriptor, 14, PollAction$$serializer.INSTANCE, pollData.primaryAction);
        }
        ...
        if (compositeEncoder.z(serialDescriptor, 16) || pollData.promptLabel != null) {
            compositeEncoder.o(serialDescriptor, 16, n2.f50601a, pollData.promptLabel);
        }
    }
