...
public final class PollMedia {
    ...
    @NotNull
    private static final Lazy[] $childSerializers = {null, l.a(o.f31119e, new Function0() { // from class: n6.d
    ...
    public static final /* synthetic */ void write$Self$chat_release(PollMedia pollMedia, CompositeEncoder compositeEncoder, SerialDescriptor serialDescriptor) {
        ...
        if (compositeEncoder.A(serialDescriptor, 0) || pollMedia.text != null) {
            compositeEncoder.z(serialDescriptor, 0, n2.f6848a, pollMedia.text);
        }
        if (compositeEncoder.A(serialDescriptor, 1) || !Intrinsics.areEqual(pollMedia.attachmentIds, x0.d())) {
            compositeEncoder.j(serialDescriptor, 1, (xs.o) lazyArr[1].getValue(), pollMedia.attachmentIds);
        }
        if (compositeEncoder.A(serialDescriptor, 2) || pollMedia.emoji != null) {
            compositeEncoder.z(serialDescriptor, 2, PollMediaEmoji$$serializer.INSTANCE, pollMedia.emoji);
        }
        if (compositeEncoder.A(serialDescriptor, 3) || pollMedia.stickerId != null) {
            compositeEncoder.z(serialDescriptor, 3, z0.f6922a, pollMedia.stickerId);
        }
    }
