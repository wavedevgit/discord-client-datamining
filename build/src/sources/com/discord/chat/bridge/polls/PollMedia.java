...
public final class PollMedia {
    ...
    @NotNull
    private static final Lazy[] $childSerializers = {null, l.a(o.f32182e, new Function0() { // from class: n6.d
    ...
    public static final /* synthetic */ void write$Self$chat_release(PollMedia pollMedia, CompositeEncoder compositeEncoder, SerialDescriptor serialDescriptor) {
        ...
        if (compositeEncoder.y(serialDescriptor, 0) || pollMedia.text != null) {
            compositeEncoder.B(serialDescriptor, 0, n2.f7662a, pollMedia.text);
        }
        if (compositeEncoder.y(serialDescriptor, 1) || !Intrinsics.areEqual(pollMedia.attachmentIds, x0.d())) {
            compositeEncoder.m(serialDescriptor, 1, (ys.o) lazyArr[1].getValue(), pollMedia.attachmentIds);
        }
        if (compositeEncoder.y(serialDescriptor, 2) || pollMedia.emoji != null) {
            compositeEncoder.B(serialDescriptor, 2, PollMediaEmoji$$serializer.INSTANCE, pollMedia.emoji);
        }
        if (compositeEncoder.y(serialDescriptor, 3) || pollMedia.stickerId != null) {
            compositeEncoder.B(serialDescriptor, 3, z0.f7736a, pollMedia.stickerId);
        }
    }
