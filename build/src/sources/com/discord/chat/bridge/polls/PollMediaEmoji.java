...
public final class PollMediaEmoji {
    ...
    public static final /* synthetic */ void write$Self$chat_release(PollMediaEmoji pollMediaEmoji, CompositeEncoder compositeEncoder, SerialDescriptor serialDescriptor) {
        n2 n2Var = n2.f50033a;
        compositeEncoder.o(serialDescriptor, 0, n2Var, pollMediaEmoji.f9272id);
        ...
        if (compositeEncoder.z(serialDescriptor, 2) || pollMediaEmoji.displayName != null) {
            compositeEncoder.o(serialDescriptor, 2, n2Var, pollMediaEmoji.displayName);
        }
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof PollMediaEmoji) {
            ...
            return Intrinsics.areEqual(this.f9272id, pollMediaEmoji.f9272id) && Intrinsics.areEqual(this.name, pollMediaEmoji.name) && Intrinsics.areEqual(this.displayName, pollMediaEmoji.displayName) && this.animated == pollMediaEmoji.animated;
        }
        return false;
    }
