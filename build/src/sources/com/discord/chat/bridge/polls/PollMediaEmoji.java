...
public final class PollMediaEmoji {
    ...
    public static final /* synthetic */ void write$Self$chat_release(PollMediaEmoji pollMediaEmoji, CompositeEncoder compositeEncoder, SerialDescriptor serialDescriptor) {
        n2 n2Var = n2.f6848a;
        compositeEncoder.z(serialDescriptor, 0, n2Var, pollMediaEmoji.f9674id);
        ...
        if (compositeEncoder.A(serialDescriptor, 2) || pollMediaEmoji.displayName != null) {
            compositeEncoder.z(serialDescriptor, 2, n2Var, pollMediaEmoji.displayName);
        }
        if (compositeEncoder.A(serialDescriptor, 3) || pollMediaEmoji.animated) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof PollMediaEmoji) {
            ...
            return Intrinsics.areEqual(this.f9674id, pollMediaEmoji.f9674id) && Intrinsics.areEqual(this.name, pollMediaEmoji.name) && Intrinsics.areEqual(this.displayName, pollMediaEmoji.displayName) && this.animated == pollMediaEmoji.animated;
        }
        return false;
    }
