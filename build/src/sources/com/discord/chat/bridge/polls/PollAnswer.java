...
public final class PollAnswer {
    ...
    public static final /* synthetic */ void write$Self$chat_release(PollAnswer pollAnswer, CompositeEncoder compositeEncoder, SerialDescriptor serialDescriptor) {
        ...
        compositeEncoder.j(serialDescriptor, 1, PollMedia$$serializer.INSTANCE, pollAnswer.pollMedia);
        ...
        if (compositeEncoder.A(serialDescriptor, 5) || pollAnswer.isSelected != null) {
            compositeEncoder.z(serialDescriptor, 5, h.f6812a, pollAnswer.isSelected);
        }
        if (compositeEncoder.A(serialDescriptor, 6) || pollAnswer.isVictor != null) {
            compositeEncoder.z(serialDescriptor, 6, h.f6812a, pollAnswer.isVictor);
        }
        if (compositeEncoder.A(serialDescriptor, 7) || pollAnswer.shouldAnimateTransition != null) {
            compositeEncoder.z(serialDescriptor, 7, h.f6812a, pollAnswer.shouldAnimateTransition);
        }
