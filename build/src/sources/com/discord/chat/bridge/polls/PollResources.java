...
public final class PollResources {
    ...
    @NotNull
    private static final Lazy[] $childSerializers = {null, null, l.b(o.f48044e, new Function0() { // from class: n6.e
    ...
    public static final /* synthetic */ KSerializer _childSerializers$_anonymous_() {
        return new u0(n2.f31041a, PollStyleSet$$serializer.INSTANCE);
    }
    ...
    public static final /* synthetic */ void write$Self$chat_release(PollResources pollResources, CompositeEncoder compositeEncoder, SerialDescriptor serialDescriptor) {
        ...
        compositeEncoder.z(serialDescriptor, 0, pollResources.selectedIcon);
        compositeEncoder.z(serialDescriptor, 1, pollResources.checkmarkIcon);
        if (compositeEncoder.A(serialDescriptor, 2) || !Intrinsics.areEqual(pollResources.styles, o0.i())) {
            compositeEncoder.s(serialDescriptor, 2, (ft.o) lazyArr[2].getValue(), pollResources.styles);
        }
    }
