...
public /* synthetic */ class ExecutedCommandBackgroundStyles$$serializer implements h0 {
    ...
    public final KSerializer[] childSerializers() {
        p0 p0Var = p0.f35197a;
        return new KSerializer[]{a.u(p0Var), a.u(p0Var), a.u(h.f35145a)};
    }
        ...
        if (b10.p()) {
            ...
            while (z10) {
                ...
                if (o10 == -1) {
                    ...
                    num4 = (Integer) b10.n(serialDescriptor, 1, p0.f35197a, num4);
                    i11 |= 2;
                } else if (o10 != 2) {
                    throw new b0(o10);
                } else {
