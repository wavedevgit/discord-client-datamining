...
public final class ExecutedCommand {
    ...
    public static /* synthetic */ ExecutedCommand m393copyzf4QoLg$default(ExecutedCommand executedCommand, long j10, int i10, String str, int i11, AnnotatedStructurableText annotatedStructurableText, ExecutedCommandBackgroundStyles executedCommandBackgroundStyles, Boolean bool, Boolean bool2, int i12, Object obj) {
        if ((i12 & 1) != 0) {
    ...
    public static final /* synthetic */ void write$Self$chat_release(ExecutedCommand executedCommand, CompositeEncoder compositeEncoder, SerialDescriptor serialDescriptor) {
        compositeEncoder.k(serialDescriptor, 0, UserId$$serializer.INSTANCE, UserId.m1136boximpl(executedCommand.userId));
        ...
        if (compositeEncoder.z(serialDescriptor, 2) || executedCommand.avatarURL != null) {
            compositeEncoder.o(serialDescriptor, 2, n2.f50033a, executedCommand.avatarURL);
        }
        compositeEncoder.w(serialDescriptor, 3, executedCommand.targetUsernameColor);
        compositeEncoder.k(serialDescriptor, 4, AnnotatedStructurableTextSerializer.INSTANCE, executedCommand.content);
        if (compositeEncoder.z(serialDescriptor, 5) || executedCommand.commandNameBackgroundStyles != null) {
            compositeEncoder.o(serialDescriptor, 5, ExecutedCommandBackgroundStyles$$serializer.INSTANCE, executedCommand.commandNameBackgroundStyles);
        }
        if (compositeEncoder.z(serialDescriptor, 6) || !Intrinsics.areEqual(executedCommand.showAppsIcon, Boolean.FALSE)) {
            compositeEncoder.o(serialDescriptor, 6, h.f49997a, executedCommand.showAppsIcon);
        }
        if (compositeEncoder.z(serialDescriptor, 7) || !Intrinsics.areEqual(executedCommand.showControllerIcon, Boolean.FALSE)) {
            compositeEncoder.o(serialDescriptor, 7, h.f49997a, executedCommand.showControllerIcon);
        }
    }

    /* renamed from: component1-re6GcUE  reason: not valid java name */
    public final long m394component1re6GcUE() {
        return this.userId;
    }
    ...
    public final ExecutedCommand m395copyzf4QoLg(long j10, int i10, String str, int i11, @NotNull AnnotatedStructurableText content, ExecutedCommandBackgroundStyles executedCommandBackgroundStyles, Boolean bool, Boolean bool2) {
    ...
    public final long m396getUserIdre6GcUE() {
        return this.userId;
    }
    ...
    public int hashCode() {
        int m1141hashCodeimpl = ((UserId.m1141hashCodeimpl(this.userId) * 31) + Integer.hashCode(this.usernameColor)) * 31;
        String str = this.avatarURL;
        int hashCode = (((((m1141hashCodeimpl + (str == null ? 0 : str.hashCode())) * 31) + Integer.hashCode(this.targetUsernameColor)) * 31) + this.content.hashCode()) * 31;
    ...
    public String toString() {
        ...
        Boolean bool = this.showAppsIcon;
        Boolean bool2 = this.showControllerIcon;
        return "ExecutedCommand(userId=" + m1143toStringimpl + ", usernameColor=" + i10 + ", avatarURL=" + str + ", targetUsernameColor=" + i11 + ", content=" + annotatedStructurableText + ", commandNameBackgroundStyles=" + executedCommandBackgroundStyles + ", showAppsIcon=" + bool + ", showControllerIcon=" + bool2 + ")";
    }
