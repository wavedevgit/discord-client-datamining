...
public final class ExecutedCommand {
    ...
    public static /* synthetic */ ExecutedCommand m392copyzf4QoLg$default(ExecutedCommand executedCommand, long j10, int i10, String str, int i11, AnnotatedStructurableText annotatedStructurableText, ExecutedCommandBackgroundStyles executedCommandBackgroundStyles, Boolean bool, Boolean bool2, int i12, Object obj) {
        if ((i12 & 1) != 0) {
    ...
    public static final /* synthetic */ void write$Self$chat_release(ExecutedCommand executedCommand, CompositeEncoder compositeEncoder, SerialDescriptor serialDescriptor) {
        compositeEncoder.j(serialDescriptor, 0, UserId$$serializer.INSTANCE, UserId.m1136boximpl(executedCommand.userId));
        ...
        if (compositeEncoder.A(serialDescriptor, 2) || executedCommand.avatarURL != null) {
            compositeEncoder.z(serialDescriptor, 2, n2.f6848a, executedCommand.avatarURL);
        }
        compositeEncoder.w(serialDescriptor, 3, executedCommand.targetUsernameColor);
        compositeEncoder.j(serialDescriptor, 4, AnnotatedStructurableTextSerializer.INSTANCE, executedCommand.content);
        if (compositeEncoder.A(serialDescriptor, 5) || executedCommand.commandNameBackgroundStyles != null) {
            compositeEncoder.z(serialDescriptor, 5, ExecutedCommandBackgroundStyles$$serializer.INSTANCE, executedCommand.commandNameBackgroundStyles);
        }
        if (compositeEncoder.A(serialDescriptor, 6) || !Intrinsics.areEqual(executedCommand.showAppsIcon, Boolean.FALSE)) {
            compositeEncoder.z(serialDescriptor, 6, h.f6812a, executedCommand.showAppsIcon);
        }
        if (compositeEncoder.A(serialDescriptor, 7) || !Intrinsics.areEqual(executedCommand.showControllerIcon, Boolean.FALSE)) {
            compositeEncoder.z(serialDescriptor, 7, h.f6812a, executedCommand.showControllerIcon);
        }
    }

    /* renamed from: component1-re6GcUE  reason: not valid java name */
    public final long m393component1re6GcUE() {
        return this.userId;
    }
    ...
    public final ExecutedCommand m394copyzf4QoLg(long j10, int i10, String str, int i11, @NotNull AnnotatedStructurableText content, ExecutedCommandBackgroundStyles executedCommandBackgroundStyles, Boolean bool, Boolean bool2) {
    ...
    public final long m395getUserIdre6GcUE() {
        return this.userId;
    }
