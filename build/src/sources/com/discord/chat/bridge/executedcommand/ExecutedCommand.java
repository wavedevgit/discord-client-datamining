...
public final class ExecutedCommand {
    ...
    public int hashCode() {
        int m1140hashCodeimpl = ((UserId.m1140hashCodeimpl(this.userId) * 31) + Integer.hashCode(this.usernameColor)) * 31;
        String str = this.avatarURL;
        int hashCode = (((((m1140hashCodeimpl + (str == null ? 0 : str.hashCode())) * 31) + Integer.hashCode(this.targetUsernameColor)) * 31) + this.content.hashCode()) * 31;
    ...
    public String toString() {
        ...
        Boolean bool = this.showAppsIcon;
        Boolean bool2 = this.showControllerIcon;
        return "ExecutedCommand(userId=" + m1142toStringimpl + ", usernameColor=" + i10 + ", avatarURL=" + str + ", targetUsernameColor=" + i11 + ", content=" + annotatedStructurableText + ", commandNameBackgroundStyles=" + executedCommandBackgroundStyles + ", showAppsIcon=" + bool + ", showControllerIcon=" + bool2 + ")";
    }
