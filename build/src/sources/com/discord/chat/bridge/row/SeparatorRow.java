...
public final class SeparatorRow extends Row {
    ...
    public static final /* synthetic */ void write$Self$chat_release(SeparatorRow separatorRow, CompositeEncoder compositeEncoder, SerialDescriptor serialDescriptor) {
        compositeEncoder.m(serialDescriptor, 0, ChangeType.Serializer.INSTANCE, separatorRow.getChangeType());
        compositeEncoder.v(serialDescriptor, 1, separatorRow.getIndex());
        compositeEncoder.x(serialDescriptor, 2, separatorRow.text);
        compositeEncoder.x(serialDescriptor, 3, separatorRow.f9306id);
        compositeEncoder.v(serialDescriptor, 4, separatorRow.color);
        if (compositeEncoder.y(serialDescriptor, 5) || separatorRow.scrollTo != null) {
            compositeEncoder.B(serialDescriptor, 5, h.f7626a, separatorRow.scrollTo);
        }
        if (compositeEncoder.y(serialDescriptor, 6) || separatorRow.isBeforeContent != null) {
            compositeEncoder.B(serialDescriptor, 6, h.f7626a, separatorRow.isBeforeContent);
        }
        if (compositeEncoder.y(serialDescriptor, 7) || separatorRow.summary != null) {
            compositeEncoder.B(serialDescriptor, 7, Summary$$serializer.INSTANCE, separatorRow.summary);
        }
    }
    ...
    public int hashCode() {
        int hashCode = ((((((((this.changeType.hashCode() * 31) + Integer.hashCode(this.index)) * 31) + this.text.hashCode()) * 31) + this.f9306id.hashCode()) * 31) + Integer.hashCode(this.color)) * 31;
