...
public final class SeparatorRow extends Row {
    ...
    public static final /* synthetic */ void write$Self$chat_release(SeparatorRow separatorRow, CompositeEncoder compositeEncoder, SerialDescriptor serialDescriptor) {
        compositeEncoder.F(serialDescriptor, 0, ChangeType.Serializer.INSTANCE, separatorRow.getChangeType());
        compositeEncoder.w(serialDescriptor, 1, separatorRow.getIndex());
        compositeEncoder.y(serialDescriptor, 2, separatorRow.text);
        compositeEncoder.y(serialDescriptor, 3, separatorRow.f8697id);
        ...
        if (compositeEncoder.z(serialDescriptor, 5) || separatorRow.scrollTo != null) {
            compositeEncoder.i(serialDescriptor, 5, h.f35145a, separatorRow.scrollTo);
        }
        if (compositeEncoder.z(serialDescriptor, 6) || separatorRow.isBeforeContent != null) {
            compositeEncoder.i(serialDescriptor, 6, h.f35145a, separatorRow.isBeforeContent);
        }
        if (compositeEncoder.z(serialDescriptor, 7) || separatorRow.summary != null) {
            compositeEncoder.i(serialDescriptor, 7, Summary$$serializer.INSTANCE, separatorRow.summary);
        }
    }
    ...
    public int hashCode() {
        int hashCode = ((((((((this.changeType.hashCode() * 31) + Integer.hashCode(this.index)) * 31) + this.text.hashCode()) * 31) + this.f8697id.hashCode()) * 31) + Integer.hashCode(this.color)) * 31;
