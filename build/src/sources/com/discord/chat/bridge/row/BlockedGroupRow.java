...
public final class BlockedGroupRow extends Row {
    ...
    @NotNull
    private static final Lazy[] $childSerializers = {null, null, null, null, null, null, null, null, l.b(o.f49210e, new Function0() { // from class: com.discord.chat.bridge.row.a
    ...
    public static final /* synthetic */ void write$Self$chat_release(BlockedGroupRow blockedGroupRow, CompositeEncoder compositeEncoder, SerialDescriptor serialDescriptor) {
        ...
        compositeEncoder.F(serialDescriptor, 1, ChangeType.Serializer.INSTANCE, blockedGroupRow.getChangeType());
        ...
        compositeEncoder.F(serialDescriptor, 7, BlockedGroupButton$$serializer.INSTANCE, blockedGroupRow.button);
        if (compositeEncoder.z(serialDescriptor, 8) || blockedGroupRow.content != null) {
            compositeEncoder.i(serialDescriptor, 8, (gt.o) lazyArr[8].getValue(), blockedGroupRow.content);
        }
    }
