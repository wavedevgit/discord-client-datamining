...
public final class BlockedGroupRow extends Row {
    ...
    @NotNull
    private static final Lazy[] $childSerializers = {null, null, null, null, null, null, null, null, l.a(o.f31103e, new Function0() { // from class: com.discord.chat.bridge.row.a
    ...
    public static final /* synthetic */ void write$Self$chat_release(BlockedGroupRow blockedGroupRow, CompositeEncoder compositeEncoder, SerialDescriptor serialDescriptor) {
        ...
        compositeEncoder.w(serialDescriptor, 0, blockedGroupRow.getIndex());
        compositeEncoder.j(serialDescriptor, 1, ChangeType.Serializer.INSTANCE, blockedGroupRow.getChangeType());
        compositeEncoder.w(serialDescriptor, 2, blockedGroupRow.color);
        compositeEncoder.w(serialDescriptor, 3, blockedGroupRow.borderColor);
        compositeEncoder.w(serialDescriptor, 4, blockedGroupRow.backgroundColor);
        compositeEncoder.y(serialDescriptor, 5, blockedGroupRow.text);
        compositeEncoder.x(serialDescriptor, 6, blockedGroupRow.revealed);
        compositeEncoder.j(serialDescriptor, 7, BlockedGroupButton$$serializer.INSTANCE, blockedGroupRow.button);
        if (compositeEncoder.A(serialDescriptor, 8) || blockedGroupRow.content != null) {
            compositeEncoder.z(serialDescriptor, 8, (xs.o) lazyArr[8].getValue(), blockedGroupRow.content);
        }
    }
