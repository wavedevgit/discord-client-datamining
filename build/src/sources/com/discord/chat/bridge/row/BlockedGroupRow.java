...
public final class BlockedGroupRow extends Row {
    ...
    @NotNull
    private static final Lazy[] $childSerializers = {null, null, null, null, null, null, null, null, l.b(o.f48092e, new Function0() { // from class: com.discord.chat.bridge.row.a
    ...
    public static final /* synthetic */ void write$Self$chat_release(BlockedGroupRow blockedGroupRow, CompositeEncoder compositeEncoder, SerialDescriptor serialDescriptor) {
        ...
        compositeEncoder.x(serialDescriptor, 0, blockedGroupRow.getIndex());
        compositeEncoder.s(serialDescriptor, 1, ChangeType.Serializer.INSTANCE, blockedGroupRow.getChangeType());
        compositeEncoder.x(serialDescriptor, 2, blockedGroupRow.color);
        compositeEncoder.x(serialDescriptor, 3, blockedGroupRow.borderColor);
        compositeEncoder.x(serialDescriptor, 4, blockedGroupRow.backgroundColor);
        compositeEncoder.z(serialDescriptor, 5, blockedGroupRow.text);
        compositeEncoder.y(serialDescriptor, 6, blockedGroupRow.revealed);
        compositeEncoder.s(serialDescriptor, 7, BlockedGroupButton$$serializer.INSTANCE, blockedGroupRow.button);
        if (compositeEncoder.A(serialDescriptor, 8) || blockedGroupRow.content != null) {
            compositeEncoder.l(serialDescriptor, 8, (ft.o) lazyArr[8].getValue(), blockedGroupRow.content);
        }
    }
