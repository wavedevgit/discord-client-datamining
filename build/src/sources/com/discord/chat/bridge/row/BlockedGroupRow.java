...
public final class BlockedGroupRow extends Row {
    ...
    @NotNull
    private static final Lazy[] $childSerializers = {null, null, null, null, null, null, null, null, l.a(o.f6082e, new Function0() { // from class: com.discord.chat.bridge.row.a
    ...
    public static final /* synthetic */ void write$Self$chat_release(BlockedGroupRow blockedGroupRow, CompositeEncoder compositeEncoder, SerialDescriptor serialDescriptor) {
        ...
        compositeEncoder.k(serialDescriptor, 1, ChangeType.Serializer.INSTANCE, blockedGroupRow.getChangeType());
        ...
        compositeEncoder.k(serialDescriptor, 7, BlockedGroupButton$$serializer.INSTANCE, blockedGroupRow.button);
        if (compositeEncoder.z(serialDescriptor, 8) || blockedGroupRow.content != null) {
            compositeEncoder.o(serialDescriptor, 8, (qt.o) lazyArr[8].getValue(), blockedGroupRow.content);
        }
    }
