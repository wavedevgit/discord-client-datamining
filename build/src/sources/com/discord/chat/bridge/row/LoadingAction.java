...
public final class LoadingAction {
    ...
    @NotNull
    private static final Lazy[] $childSerializers = {l.a(o.f31103e, new Function0() { // from class: com.discord.chat.bridge.row.b
        @Override // kotlin.jvm.functions.Function0
        public final Object invoke() {
            KSerializer _childSerializers$_anonymous_;
            _childSerializers$_anonymous_ = LoadingAction._childSerializers$_anonymous_();
    ...
    public /* synthetic */ LoadingAction(int i10, LoadingActionType loadingActionType, SerializationConstructorMarker serializationConstructorMarker) {
        if (1 != (i10 & 1)) {
            v1.b(i10, 1, LoadingAction$$serializer.INSTANCE.getDescriptor());
        }
    ...
    public static final /* synthetic */ KSerializer _childSerializers$_anonymous_() {
        return LoadingActionType.Companion.serializer();
    }
