...
public final class DeleteRow extends Row {
    ...
    public static final /* synthetic */ void write$Self$chat_release(DeleteRow deleteRow, CompositeEncoder compositeEncoder, SerialDescriptor serialDescriptor) {
        compositeEncoder.w(serialDescriptor, 0, deleteRow.getIndex());
        if (compositeEncoder.z(serialDescriptor, 1) || deleteRow.getChangeType() != ChangeType.DELETE) {
            compositeEncoder.D(serialDescriptor, 1, ChangeType.Serializer.INSTANCE, deleteRow.getChangeType());
        }
    }
