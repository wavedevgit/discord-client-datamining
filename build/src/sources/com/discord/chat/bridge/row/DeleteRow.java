...
public final class DeleteRow extends Row {
    ...
    public static final /* synthetic */ void write$Self$chat_release(DeleteRow deleteRow, CompositeEncoder compositeEncoder, SerialDescriptor serialDescriptor) {
        compositeEncoder.v(serialDescriptor, 0, deleteRow.getIndex());
        if (compositeEncoder.y(serialDescriptor, 1) || deleteRow.getChangeType() != ChangeType.DELETE) {
            compositeEncoder.m(serialDescriptor, 1, ChangeType.Serializer.INSTANCE, deleteRow.getChangeType());
        }
    }
