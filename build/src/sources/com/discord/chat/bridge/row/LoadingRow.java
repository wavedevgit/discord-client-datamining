...
public final class LoadingRow extends Row {
    ...
    public static final /* synthetic */ void write$Self$chat_release(LoadingRow loadingRow, CompositeEncoder compositeEncoder, SerialDescriptor serialDescriptor) {
        compositeEncoder.v(serialDescriptor, 0, loadingRow.getIndex());
        compositeEncoder.l(serialDescriptor, 1, ChangeType.Serializer.INSTANCE, loadingRow.getChangeType());
        compositeEncoder.l(serialDescriptor, 2, LoadMoreButton$$serializer.INSTANCE, loadingRow.button);
        compositeEncoder.w(serialDescriptor, 3, loadingRow.isLoading);
    }
