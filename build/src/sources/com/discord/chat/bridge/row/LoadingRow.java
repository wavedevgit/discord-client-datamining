...
public final class LoadingRow extends Row {
    ...
    public static final /* synthetic */ void write$Self$chat_release(LoadingRow loadingRow, CompositeEncoder compositeEncoder, SerialDescriptor serialDescriptor) {
        compositeEncoder.w(serialDescriptor, 0, loadingRow.getIndex());
        compositeEncoder.D(serialDescriptor, 1, ChangeType.Serializer.INSTANCE, loadingRow.getChangeType());
        compositeEncoder.D(serialDescriptor, 2, LoadMoreButton$$serializer.INSTANCE, loadingRow.button);
        compositeEncoder.x(serialDescriptor, 3, loadingRow.isLoading);
    }
