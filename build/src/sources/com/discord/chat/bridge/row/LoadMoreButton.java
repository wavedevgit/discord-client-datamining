...
public final class LoadMoreButton {
    ...
    public static final /* synthetic */ void write$Self$chat_release(LoadMoreButton loadMoreButton, CompositeEncoder compositeEncoder, SerialDescriptor serialDescriptor) {
        compositeEncoder.m(serialDescriptor, 0, LoadingAction$$serializer.INSTANCE, loadMoreButton.action);
        compositeEncoder.x(serialDescriptor, 1, loadMoreButton.text);
        compositeEncoder.v(serialDescriptor, 2, loadMoreButton.backgroundColor);
        if (compositeEncoder.y(serialDescriptor, 3) || loadMoreButton.cornerRadius != null) {
            compositeEncoder.B(serialDescriptor, 3, p0.f7678a, loadMoreButton.cornerRadius);
        }
        if (compositeEncoder.y(serialDescriptor, 4) || loadMoreButton.color != null) {
            compositeEncoder.B(serialDescriptor, 4, p0.f7678a, loadMoreButton.color);
        }
    }
