...
public final class LoadMoreButton {
    ...
    public static final /* synthetic */ void write$Self$chat_release(LoadMoreButton loadMoreButton, CompositeEncoder compositeEncoder, SerialDescriptor serialDescriptor) {
        compositeEncoder.F(serialDescriptor, 0, LoadingAction$$serializer.INSTANCE, loadMoreButton.action);
        ...
        if (compositeEncoder.z(serialDescriptor, 3) || loadMoreButton.cornerRadius != null) {
            compositeEncoder.i(serialDescriptor, 3, p0.f35197a, loadMoreButton.cornerRadius);
        }
        if (compositeEncoder.z(serialDescriptor, 4) || loadMoreButton.color != null) {
            compositeEncoder.i(serialDescriptor, 4, p0.f35197a, loadMoreButton.color);
        }
    }
