...
public final class MessageRow extends Row {
    ...
    @NotNull
    private static final Lazy[] $childSerializers = {null, null, null, null, null, null, null, null, null, null, null, null, null, l.a(o.f32182e, new Function0() { // from class: com.discord.chat.bridge.row.d
    ...
    public static final /* synthetic */ void write$Self$chat_release(MessageRow messageRow, CompositeEncoder compositeEncoder, SerialDescriptor serialDescriptor) {
        ...
        compositeEncoder.v(serialDescriptor, 0, messageRow.getIndex());
        compositeEncoder.m(serialDescriptor, 1, ChangeType.Serializer.INSTANCE, messageRow.getChangeType());
        if (compositeEncoder.y(serialDescriptor, 2) || messageRow.jumped != null) {
            compositeEncoder.B(serialDescriptor, 2, h.f7626a, messageRow.jumped);
        }
        compositeEncoder.m(serialDescriptor, 3, MessageSerializer.INSTANCE, messageRow.message);
        if (compositeEncoder.y(serialDescriptor, 4) || messageRow.canAddNewReactions != null) {
            compositeEncoder.B(serialDescriptor, 4, h.f7626a, messageRow.canAddNewReactions);
        }
        if (compositeEncoder.y(serialDescriptor, 5) || messageRow.addNewReactionAccessibilityLabel != null) {
            compositeEncoder.B(serialDescriptor, 5, n2.f7662a, messageRow.addNewReactionAccessibilityLabel);
        }
        if (compositeEncoder.y(serialDescriptor, 6) || messageRow.reactionsTheme != null) {
            compositeEncoder.B(serialDescriptor, 6, ReactionsTheme$$serializer.INSTANCE, messageRow.reactionsTheme);
        }
        if (compositeEncoder.y(serialDescriptor, 7) || messageRow.showReplyButton != null) {
            compositeEncoder.B(serialDescriptor, 7, h.f7626a, messageRow.showReplyButton);
        }
        if (compositeEncoder.y(serialDescriptor, 8) || messageRow.renderContentOnly) {
            compositeEncoder.w(serialDescriptor, 8, messageRow.renderContentOnly);
        }
        if (compositeEncoder.y(serialDescriptor, 9) || messageRow.reactTag != null) {
            compositeEncoder.B(serialDescriptor, 9, p0.f7678a, messageRow.reactTag);
        }
        if (compositeEncoder.y(serialDescriptor, 10) || messageRow.truncation != null) {
            compositeEncoder.B(serialDescriptor, 10, Truncation$$serializer.INSTANCE, messageRow.truncation);
        }
        if (compositeEncoder.y(serialDescriptor, 11) || messageRow.backgroundHighlight != null) {
            compositeEncoder.B(serialDescriptor, 11, BackgroundHighlight$$serializer.INSTANCE, messageRow.backgroundHighlight);
        }
        if (compositeEncoder.y(serialDescriptor, 12) || messageRow.swipeActions != SwipeActionsType.NONE) {
            compositeEncoder.m(serialDescriptor, 12, SwipeActionsType.Serializer.INSTANCE, messageRow.swipeActions);
        }
        if (compositeEncoder.y(serialDescriptor, 13) || messageRow.contextType != null) {
            compositeEncoder.B(serialDescriptor, 13, (ys.o) lazyArr[13].getValue(), messageRow.contextType);
        }
    }
