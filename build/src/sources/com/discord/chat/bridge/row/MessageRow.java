...
public final class MessageRow extends Row {
    ...
    public static final /* synthetic */ void write$Self$chat_release(MessageRow messageRow, CompositeEncoder compositeEncoder, SerialDescriptor serialDescriptor) {
        ...
        compositeEncoder.j(serialDescriptor, 1, ChangeType.Serializer.INSTANCE, messageRow.getChangeType());
        if (compositeEncoder.A(serialDescriptor, 2) || messageRow.jumped != null) {
            compositeEncoder.z(serialDescriptor, 2, h.f6812a, messageRow.jumped);
        }
        compositeEncoder.j(serialDescriptor, 3, MessageSerializer.INSTANCE, messageRow.message);
        if (compositeEncoder.A(serialDescriptor, 4) || messageRow.canAddNewReactions != null) {
            compositeEncoder.z(serialDescriptor, 4, h.f6812a, messageRow.canAddNewReactions);
        }
        if (compositeEncoder.A(serialDescriptor, 5) || messageRow.addNewReactionAccessibilityLabel != null) {
            compositeEncoder.z(serialDescriptor, 5, n2.f6848a, messageRow.addNewReactionAccessibilityLabel);
        }
        if (compositeEncoder.A(serialDescriptor, 6) || messageRow.reactionsTheme != null) {
            compositeEncoder.z(serialDescriptor, 6, ReactionsTheme$$serializer.INSTANCE, messageRow.reactionsTheme);
        }
        if (compositeEncoder.A(serialDescriptor, 7) || messageRow.showReplyButton != null) {
            compositeEncoder.z(serialDescriptor, 7, h.f6812a, messageRow.showReplyButton);
        }
        ...
        if (compositeEncoder.A(serialDescriptor, 9) || messageRow.reactTag != null) {
            compositeEncoder.z(serialDescriptor, 9, p0.f6864a, messageRow.reactTag);
        }
        if (compositeEncoder.A(serialDescriptor, 10) || messageRow.truncation != null) {
            compositeEncoder.z(serialDescriptor, 10, Truncation$$serializer.INSTANCE, messageRow.truncation);
        }
        if (compositeEncoder.A(serialDescriptor, 11) || messageRow.backgroundHighlight != null) {
            compositeEncoder.z(serialDescriptor, 11, BackgroundHighlight$$serializer.INSTANCE, messageRow.backgroundHighlight);
        }
        if (compositeEncoder.A(serialDescriptor, 12) || messageRow.swipeActions != SwipeActionsType.NONE) {
            compositeEncoder.j(serialDescriptor, 12, SwipeActionsType.Serializer.INSTANCE, messageRow.swipeActions);
        }
        if (compositeEncoder.A(serialDescriptor, 13) || messageRow.contextType != null) {
            compositeEncoder.z(serialDescriptor, 13, (xs.o) lazyArr[13].getValue(), messageRow.contextType);
        }
    }
