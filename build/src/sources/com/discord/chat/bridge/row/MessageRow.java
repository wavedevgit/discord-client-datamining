...
public final class MessageRow extends Row {
    ...
    @NotNull
    private static final Lazy[] $childSerializers = {null, null, null, null, null, null, null, null, null, null, null, null, null, l.b(o.f37120e, new Function0() { // from class: com.discord.chat.bridge.row.d
    ...
    public static final /* synthetic */ void write$Self$chat_release(MessageRow messageRow, CompositeEncoder compositeEncoder, SerialDescriptor serialDescriptor) {
        ...
        compositeEncoder.D(serialDescriptor, 1, ChangeType.Serializer.INSTANCE, messageRow.getChangeType());
        if (compositeEncoder.z(serialDescriptor, 2) || messageRow.jumped != null) {
            compositeEncoder.s(serialDescriptor, 2, h.f20942a, messageRow.jumped);
        }
        compositeEncoder.D(serialDescriptor, 3, MessageSerializer.INSTANCE, messageRow.message);
        if (compositeEncoder.z(serialDescriptor, 4) || messageRow.canAddNewReactions != null) {
            compositeEncoder.s(serialDescriptor, 4, h.f20942a, messageRow.canAddNewReactions);
        }
        if (compositeEncoder.z(serialDescriptor, 5) || messageRow.addNewReactionAccessibilityLabel != null) {
            compositeEncoder.s(serialDescriptor, 5, n2.f20978a, messageRow.addNewReactionAccessibilityLabel);
        }
        if (compositeEncoder.z(serialDescriptor, 6) || messageRow.reactionsTheme != null) {
            compositeEncoder.s(serialDescriptor, 6, ReactionsTheme$$serializer.INSTANCE, messageRow.reactionsTheme);
        }
        if (compositeEncoder.z(serialDescriptor, 7) || messageRow.showReplyButton != null) {
            compositeEncoder.s(serialDescriptor, 7, h.f20942a, messageRow.showReplyButton);
        }
        ...
        if (compositeEncoder.z(serialDescriptor, 9) || messageRow.reactTag != null) {
            compositeEncoder.s(serialDescriptor, 9, p0.f20994a, messageRow.reactTag);
        }
        if (compositeEncoder.z(serialDescriptor, 10) || messageRow.truncation != null) {
            compositeEncoder.s(serialDescriptor, 10, Truncation$$serializer.INSTANCE, messageRow.truncation);
        }
        if (compositeEncoder.z(serialDescriptor, 11) || messageRow.backgroundHighlight != null) {
            compositeEncoder.s(serialDescriptor, 11, BackgroundHighlight$$serializer.INSTANCE, messageRow.backgroundHighlight);
        }
        if (compositeEncoder.z(serialDescriptor, 12) || messageRow.swipeActions != SwipeActionsType.NONE) {
            compositeEncoder.D(serialDescriptor, 12, SwipeActionsType.Serializer.INSTANCE, messageRow.swipeActions);
        }
        if (compositeEncoder.z(serialDescriptor, 13) || messageRow.contextType != null) {
            compositeEncoder.s(serialDescriptor, 13, (at.o) lazyArr[13].getValue(), messageRow.contextType);
        }
    }
