...
public final class MessageRow extends Row {
    ...
    @NotNull
    private static final Lazy[] $childSerializers = {null, null, null, null, null, null, null, null, null, null, null, null, null, l.b(o.f44232e, new Function0() { // from class: com.discord.chat.bridge.row.d
    ...
    public static final /* synthetic */ void write$Self$chat_release(MessageRow messageRow, CompositeEncoder compositeEncoder, SerialDescriptor serialDescriptor) {
        ...
        compositeEncoder.l(serialDescriptor, 1, ChangeType.Serializer.INSTANCE, messageRow.getChangeType());
        if (compositeEncoder.z(serialDescriptor, 2) || messageRow.jumped != null) {
            compositeEncoder.A(serialDescriptor, 2, h.f25266a, messageRow.jumped);
        }
        compositeEncoder.l(serialDescriptor, 3, MessageSerializer.INSTANCE, messageRow.message);
        if (compositeEncoder.z(serialDescriptor, 4) || messageRow.canAddNewReactions != null) {
            compositeEncoder.A(serialDescriptor, 4, h.f25266a, messageRow.canAddNewReactions);
        }
        if (compositeEncoder.z(serialDescriptor, 5) || messageRow.addNewReactionAccessibilityLabel != null) {
            compositeEncoder.A(serialDescriptor, 5, n2.f25302a, messageRow.addNewReactionAccessibilityLabel);
        }
        if (compositeEncoder.z(serialDescriptor, 6) || messageRow.reactionsTheme != null) {
            compositeEncoder.A(serialDescriptor, 6, ReactionsTheme$$serializer.INSTANCE, messageRow.reactionsTheme);
        }
        if (compositeEncoder.z(serialDescriptor, 7) || messageRow.showReplyButton != null) {
            compositeEncoder.A(serialDescriptor, 7, h.f25266a, messageRow.showReplyButton);
        }
        ...
        if (compositeEncoder.z(serialDescriptor, 9) || messageRow.reactTag != null) {
            compositeEncoder.A(serialDescriptor, 9, p0.f25318a, messageRow.reactTag);
        }
        if (compositeEncoder.z(serialDescriptor, 10) || messageRow.truncation != null) {
            compositeEncoder.A(serialDescriptor, 10, Truncation$$serializer.INSTANCE, messageRow.truncation);
        }
        if (compositeEncoder.z(serialDescriptor, 11) || messageRow.backgroundHighlight != null) {
            compositeEncoder.A(serialDescriptor, 11, BackgroundHighlight$$serializer.INSTANCE, messageRow.backgroundHighlight);
        }
        if (compositeEncoder.z(serialDescriptor, 12) || messageRow.swipeActions != SwipeActionsType.NONE) {
            compositeEncoder.l(serialDescriptor, 12, SwipeActionsType.Serializer.INSTANCE, messageRow.swipeActions);
        }
        if (compositeEncoder.z(serialDescriptor, 13) || messageRow.contextType != null) {
            compositeEncoder.A(serialDescriptor, 13, (dt.o) lazyArr[13].getValue(), messageRow.contextType);
        }
    }
