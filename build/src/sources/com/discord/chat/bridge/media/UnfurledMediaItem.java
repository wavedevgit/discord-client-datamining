...
public final class UnfurledMediaItem {
    ...
    public static final /* synthetic */ void write$Self$chat_release(UnfurledMediaItem unfurledMediaItem, CompositeEncoder compositeEncoder, SerialDescriptor serialDescriptor) {
        ...
        if (compositeEncoder.z(serialDescriptor, 3) || unfurledMediaItem.height != null) {
            compositeEncoder.o(serialDescriptor, 3, p0.f50048a, unfurledMediaItem.height);
        }
        if (compositeEncoder.z(serialDescriptor, 4) || unfurledMediaItem.width != null) {
            compositeEncoder.o(serialDescriptor, 4, p0.f50048a, unfurledMediaItem.width);
        }
        if (compositeEncoder.z(serialDescriptor, 5) || unfurledMediaItem.contentType != null) {
            compositeEncoder.o(serialDescriptor, 5, n2.f50032a, unfurledMediaItem.contentType);
        }
        if (compositeEncoder.z(serialDescriptor, 6) || unfurledMediaItem.placeholder != null) {
            compositeEncoder.o(serialDescriptor, 6, n2.f50032a, unfurledMediaItem.placeholder);
        }
        if (compositeEncoder.z(serialDescriptor, 7) || unfurledMediaItem.placeholderVersion != null) {
            compositeEncoder.o(serialDescriptor, 7, p0.f50048a, unfurledMediaItem.placeholderVersion);
        }
