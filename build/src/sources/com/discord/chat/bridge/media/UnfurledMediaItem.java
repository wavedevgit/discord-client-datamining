...
public final class UnfurledMediaItem {
    ...
    public static final /* synthetic */ void write$Self$chat_release(UnfurledMediaItem unfurledMediaItem, CompositeEncoder compositeEncoder, SerialDescriptor serialDescriptor) {
        ...
        compositeEncoder.D(serialDescriptor, 2, UnfurledMediaLoadingState.Serializer.INSTANCE, unfurledMediaItem.loadingState);
        if (compositeEncoder.z(serialDescriptor, 3) || unfurledMediaItem.height != null) {
            compositeEncoder.s(serialDescriptor, 3, p0.f20994a, unfurledMediaItem.height);
        }
        if (compositeEncoder.z(serialDescriptor, 4) || unfurledMediaItem.width != null) {
            compositeEncoder.s(serialDescriptor, 4, p0.f20994a, unfurledMediaItem.width);
        }
        if (compositeEncoder.z(serialDescriptor, 5) || unfurledMediaItem.contentType != null) {
            compositeEncoder.s(serialDescriptor, 5, n2.f20978a, unfurledMediaItem.contentType);
        }
        if (compositeEncoder.z(serialDescriptor, 6) || unfurledMediaItem.placeholder != null) {
            compositeEncoder.s(serialDescriptor, 6, n2.f20978a, unfurledMediaItem.placeholder);
        }
        if (compositeEncoder.z(serialDescriptor, 7) || unfurledMediaItem.placeholderVersion != null) {
            compositeEncoder.s(serialDescriptor, 7, p0.f20994a, unfurledMediaItem.placeholderVersion);
        }
        if (compositeEncoder.z(serialDescriptor, 8) || unfurledMediaItem.contentScanMetadata != null) {
            compositeEncoder.s(serialDescriptor, 8, ContentScanMetadata$$serializer.INSTANCE, unfurledMediaItem.contentScanMetadata);
        }
