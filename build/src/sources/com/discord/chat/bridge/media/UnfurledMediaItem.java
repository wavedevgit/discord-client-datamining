...
public final class UnfurledMediaItem {
    ...
    public static final /* synthetic */ void write$Self$chat_release(UnfurledMediaItem unfurledMediaItem, CompositeEncoder compositeEncoder, SerialDescriptor serialDescriptor) {
        compositeEncoder.x(serialDescriptor, 0, unfurledMediaItem.url);
        compositeEncoder.x(serialDescriptor, 1, unfurledMediaItem.proxyUrl);
        compositeEncoder.m(serialDescriptor, 2, UnfurledMediaLoadingState.Serializer.INSTANCE, unfurledMediaItem.loadingState);
        if (compositeEncoder.y(serialDescriptor, 3) || unfurledMediaItem.height != null) {
            compositeEncoder.B(serialDescriptor, 3, p0.f7678a, unfurledMediaItem.height);
        }
        if (compositeEncoder.y(serialDescriptor, 4) || unfurledMediaItem.width != null) {
            compositeEncoder.B(serialDescriptor, 4, p0.f7678a, unfurledMediaItem.width);
        }
        if (compositeEncoder.y(serialDescriptor, 5) || unfurledMediaItem.contentType != null) {
            compositeEncoder.B(serialDescriptor, 5, n2.f7662a, unfurledMediaItem.contentType);
        }
        if (compositeEncoder.y(serialDescriptor, 6) || unfurledMediaItem.placeholder != null) {
            compositeEncoder.B(serialDescriptor, 6, n2.f7662a, unfurledMediaItem.placeholder);
        }
        if (compositeEncoder.y(serialDescriptor, 7) || unfurledMediaItem.placeholderVersion != null) {
            compositeEncoder.B(serialDescriptor, 7, p0.f7678a, unfurledMediaItem.placeholderVersion);
        }
        if (compositeEncoder.y(serialDescriptor, 8) || unfurledMediaItem.contentScanMetadata != null) {
            compositeEncoder.B(serialDescriptor, 8, ContentScanMetadata$$serializer.INSTANCE, unfurledMediaItem.contentScanMetadata);
        }
        compositeEncoder.w(serialDescriptor, 9, unfurledMediaItem.srcIsAnimated);
    }
