...
public final class AutoModerationContext {
    ...
    public static final /* synthetic */ void write$Self$chat_release(AutoModerationContext autoModerationContext, CompositeEncoder compositeEncoder, SerialDescriptor serialDescriptor) {
        ...
        if (compositeEncoder.z(serialDescriptor, 2) || autoModerationContext.ruleDisplayText != null) {
            compositeEncoder.i(serialDescriptor, 2, n2.f35181a, autoModerationContext.ruleDisplayText);
        }
        if (compositeEncoder.z(serialDescriptor, 3) || autoModerationContext.keywordDisplayText != null) {
            compositeEncoder.i(serialDescriptor, 3, n2.f35181a, autoModerationContext.keywordDisplayText);
        }
        if (compositeEncoder.z(serialDescriptor, 4) || autoModerationContext.actionsIconURL != null) {
            compositeEncoder.i(serialDescriptor, 4, n2.f35181a, autoModerationContext.actionsIconURL);
        }
        ...
        compositeEncoder.F(serialDescriptor, 7, FlaggedMessageEmbed$$serializer.INSTANCE, autoModerationContext.message);
        if (compositeEncoder.z(serialDescriptor, 8) || autoModerationContext.notification != null) {
            compositeEncoder.i(serialDescriptor, 8, AutoModerationNotification$$serializer.INSTANCE, autoModerationContext.notification);
        }
    }
