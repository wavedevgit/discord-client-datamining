...
public final class FlaggedMessageEmbed {
    ...
    public static /* synthetic */ FlaggedMessageEmbed m243copyYvvreA$default(FlaggedMessageEmbed flaggedMessageEmbed, String str, long j10, GuildId guildId, UserId userId, StructurableText structurableText, String str2, String str3, int i10, Integer num, boolean z10, String str4, Boolean bool, int i11, Object obj) {
        if ((i11 & 1) != 0) {
            str = flaggedMessageEmbed.f8658id;
        }
    ...
    public static final /* synthetic */ void write$Self$chat_release(FlaggedMessageEmbed flaggedMessageEmbed, CompositeEncoder compositeEncoder, SerialDescriptor serialDescriptor) {
        compositeEncoder.F(serialDescriptor, 0, MessageId$$serializer.INSTANCE, MessageId.m1083boximpl(flaggedMessageEmbed.f8658id));
        compositeEncoder.F(serialDescriptor, 1, ChannelId$$serializer.INSTANCE, ChannelId.m1057boximpl(flaggedMessageEmbed.channelId));
        if (compositeEncoder.z(serialDescriptor, 2) || flaggedMessageEmbed.guildId != null) {
            compositeEncoder.i(serialDescriptor, 2, GuildId$$serializer.INSTANCE, flaggedMessageEmbed.guildId);
        }
        if (compositeEncoder.z(serialDescriptor, 3) || flaggedMessageEmbed.userId != null) {
            compositeEncoder.i(serialDescriptor, 3, UserId$$serializer.INSTANCE, flaggedMessageEmbed.userId);
        }
        if (compositeEncoder.z(serialDescriptor, 4) || flaggedMessageEmbed.content != null) {
            compositeEncoder.i(serialDescriptor, 4, StructurableTextSerializer.INSTANCE, flaggedMessageEmbed.content);
        }
        if (compositeEncoder.z(serialDescriptor, 5) || flaggedMessageEmbed.channelName != null) {
            compositeEncoder.i(serialDescriptor, 5, n2.f35181a, flaggedMessageEmbed.channelName);
        }
        if (compositeEncoder.z(serialDescriptor, 6) || flaggedMessageEmbed.username != null) {
            compositeEncoder.i(serialDescriptor, 6, n2.f35181a, flaggedMessageEmbed.username);
        }
        ...
        if (compositeEncoder.z(serialDescriptor, 8) || flaggedMessageEmbed.roleColor != null) {
            compositeEncoder.i(serialDescriptor, 8, p0.f35197a, flaggedMessageEmbed.roleColor);
        }
        ...
        if (compositeEncoder.z(serialDescriptor, 10) || flaggedMessageEmbed.avatarURL != null) {
            compositeEncoder.i(serialDescriptor, 10, n2.f35181a, flaggedMessageEmbed.avatarURL);
        }
        if (compositeEncoder.z(serialDescriptor, 11) || !Intrinsics.areEqual(flaggedMessageEmbed.communicationDisabled, Boolean.FALSE)) {
            compositeEncoder.i(serialDescriptor, 11, h.f35145a, flaggedMessageEmbed.communicationDisabled);
        }
    }
    ...
    public int hashCode() {
        int m1088hashCodeimpl = ((MessageId.m1088hashCodeimpl(this.f8658id) * 31) + ChannelId.m1062hashCodeimpl(this.channelId)) * 31;
    ...
    public String toString() {
        String m1090toStringimpl = MessageId.m1090toStringimpl(this.f8658id);
