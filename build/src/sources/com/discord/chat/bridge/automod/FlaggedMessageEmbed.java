...
public final class FlaggedMessageEmbed {
    ...
    public static /* synthetic */ FlaggedMessageEmbed m245copyYvvreA$default(FlaggedMessageEmbed flaggedMessageEmbed, String str, long j10, GuildId guildId, UserId userId, StructurableText structurableText, String str2, String str3, int i10, Integer num, boolean z10, String str4, Boolean bool, int i11, Object obj) {
        if ((i11 & 1) != 0) {
            str = flaggedMessageEmbed.f8619id;
        }
    ...
    public static final /* synthetic */ void write$Self$chat_release(FlaggedMessageEmbed flaggedMessageEmbed, CompositeEncoder compositeEncoder, SerialDescriptor serialDescriptor) {
        compositeEncoder.l(serialDescriptor, 0, MessageId$$serializer.INSTANCE, MessageId.m1085boximpl(flaggedMessageEmbed.f8619id));
        compositeEncoder.l(serialDescriptor, 1, ChannelId$$serializer.INSTANCE, ChannelId.m1059boximpl(flaggedMessageEmbed.channelId));
        if (compositeEncoder.z(serialDescriptor, 2) || flaggedMessageEmbed.guildId != null) {
            compositeEncoder.A(serialDescriptor, 2, GuildId$$serializer.INSTANCE, flaggedMessageEmbed.guildId);
        }
        if (compositeEncoder.z(serialDescriptor, 3) || flaggedMessageEmbed.userId != null) {
            compositeEncoder.A(serialDescriptor, 3, UserId$$serializer.INSTANCE, flaggedMessageEmbed.userId);
        }
        if (compositeEncoder.z(serialDescriptor, 4) || flaggedMessageEmbed.content != null) {
            compositeEncoder.A(serialDescriptor, 4, StructurableTextSerializer.INSTANCE, flaggedMessageEmbed.content);
        }
        if (compositeEncoder.z(serialDescriptor, 5) || flaggedMessageEmbed.channelName != null) {
            compositeEncoder.A(serialDescriptor, 5, n2.f25302a, flaggedMessageEmbed.channelName);
        }
        if (compositeEncoder.z(serialDescriptor, 6) || flaggedMessageEmbed.username != null) {
            compositeEncoder.A(serialDescriptor, 6, n2.f25302a, flaggedMessageEmbed.username);
        }
        ...
        if (compositeEncoder.z(serialDescriptor, 8) || flaggedMessageEmbed.roleColor != null) {
            compositeEncoder.A(serialDescriptor, 8, p0.f25318a, flaggedMessageEmbed.roleColor);
        }
        ...
        if (compositeEncoder.z(serialDescriptor, 10) || flaggedMessageEmbed.avatarURL != null) {
            compositeEncoder.A(serialDescriptor, 10, n2.f25302a, flaggedMessageEmbed.avatarURL);
        }
        if (compositeEncoder.z(serialDescriptor, 11) || !Intrinsics.areEqual(flaggedMessageEmbed.communicationDisabled, Boolean.FALSE)) {
            compositeEncoder.A(serialDescriptor, 11, h.f25266a, flaggedMessageEmbed.communicationDisabled);
        }
    }
    ...
    public int hashCode() {
        int m1090hashCodeimpl = ((MessageId.m1090hashCodeimpl(this.f8619id) * 31) + ChannelId.m1064hashCodeimpl(this.channelId)) * 31;
    ...
    public String toString() {
        String m1092toStringimpl = MessageId.m1092toStringimpl(this.f8619id);
