...
public final class FlaggedMessageEmbed {
    ...
    public static /* synthetic */ FlaggedMessageEmbed m243copyYvvreA$default(FlaggedMessageEmbed flaggedMessageEmbed, String str, long j10, GuildId guildId, UserId userId, StructurableText structurableText, String str2, String str3, int i10, Integer num, boolean z10, String str4, Boolean bool, int i11, Object obj) {
        if ((i11 & 1) != 0) {
            str = flaggedMessageEmbed.f9638id;
        }
    ...
    public static final /* synthetic */ void write$Self$chat_release(FlaggedMessageEmbed flaggedMessageEmbed, CompositeEncoder compositeEncoder, SerialDescriptor serialDescriptor) {
        compositeEncoder.j(serialDescriptor, 0, MessageId$$serializer.INSTANCE, MessageId.m1084boximpl(flaggedMessageEmbed.f9638id));
        compositeEncoder.j(serialDescriptor, 1, ChannelId$$serializer.INSTANCE, ChannelId.m1058boximpl(flaggedMessageEmbed.channelId));
        if (compositeEncoder.A(serialDescriptor, 2) || flaggedMessageEmbed.guildId != null) {
            compositeEncoder.z(serialDescriptor, 2, GuildId$$serializer.INSTANCE, flaggedMessageEmbed.guildId);
        }
        if (compositeEncoder.A(serialDescriptor, 3) || flaggedMessageEmbed.userId != null) {
            compositeEncoder.z(serialDescriptor, 3, UserId$$serializer.INSTANCE, flaggedMessageEmbed.userId);
        }
        if (compositeEncoder.A(serialDescriptor, 4) || flaggedMessageEmbed.content != null) {
            compositeEncoder.z(serialDescriptor, 4, StructurableTextSerializer.INSTANCE, flaggedMessageEmbed.content);
        }
        if (compositeEncoder.A(serialDescriptor, 5) || flaggedMessageEmbed.channelName != null) {
            compositeEncoder.z(serialDescriptor, 5, n2.f6848a, flaggedMessageEmbed.channelName);
        }
        if (compositeEncoder.A(serialDescriptor, 6) || flaggedMessageEmbed.username != null) {
            compositeEncoder.z(serialDescriptor, 6, n2.f6848a, flaggedMessageEmbed.username);
        }
        ...
        if (compositeEncoder.A(serialDescriptor, 8) || flaggedMessageEmbed.roleColor != null) {
            compositeEncoder.z(serialDescriptor, 8, p0.f6864a, flaggedMessageEmbed.roleColor);
        }
        ...
        if (compositeEncoder.A(serialDescriptor, 10) || flaggedMessageEmbed.avatarURL != null) {
            compositeEncoder.z(serialDescriptor, 10, n2.f6848a, flaggedMessageEmbed.avatarURL);
        }
        if (compositeEncoder.A(serialDescriptor, 11) || !Intrinsics.areEqual(flaggedMessageEmbed.communicationDisabled, Boolean.FALSE)) {
            compositeEncoder.z(serialDescriptor, 11, h.f6812a, flaggedMessageEmbed.communicationDisabled);
        }
    }
    ...
    public int hashCode() {
        int m1089hashCodeimpl = ((MessageId.m1089hashCodeimpl(this.f9638id) * 31) + ChannelId.m1063hashCodeimpl(this.channelId)) * 31;
        GuildId guildId = this.guildId;
        int m1076hashCodeimpl = (m1089hashCodeimpl + (guildId == null ? 0 : GuildId.m1076hashCodeimpl(guildId.m1080unboximpl()))) * 31;
        UserId userId = this.userId;
        int m1141hashCodeimpl = (m1076hashCodeimpl + (userId == null ? 0 : UserId.m1141hashCodeimpl(userId.m1145unboximpl()))) * 31;
        StructurableText structurableText = this.content;
        int hashCode = (m1141hashCodeimpl + (structurableText == null ? 0 : structurableText.hashCode())) * 31;
    ...
    public String toString() {
        String m1091toStringimpl = MessageId.m1091toStringimpl(this.f9638id);
        ...
        String str3 = this.avatarURL;
        Boolean bool = this.communicationDisabled;
        return "FlaggedMessageEmbed(id=" + m1091toStringimpl + ", channelId=" + m1065toStringimpl + ", guildId=" + guildId + ", userId=" + userId + ", content=" + structurableText + ", channelName=" + str + ", username=" + str2 + ", usernameColor=" + i10 + ", roleColor=" + num + ", shouldShowRoleDot=" + z10 + ", avatarURL=" + str3 + ", communicationDisabled=" + bool + ")";
    }
