...
public final class FlaggedMessageEmbed {
    ...
    public static /* synthetic */ FlaggedMessageEmbed m245copyYvvreA$default(FlaggedMessageEmbed flaggedMessageEmbed, String str, long j10, GuildId guildId, UserId userId, StructurableText structurableText, String str2, String str3, int i10, Integer num, boolean z10, String str4, Boolean bool, int i11, Object obj) {
        if ((i11 & 1) != 0) {
            str = flaggedMessageEmbed.f9267id;
        }
    ...
    public static final /* synthetic */ void write$Self$chat_release(FlaggedMessageEmbed flaggedMessageEmbed, CompositeEncoder compositeEncoder, SerialDescriptor serialDescriptor) {
        compositeEncoder.m(serialDescriptor, 0, MessageId$$serializer.INSTANCE, MessageId.m1086boximpl(flaggedMessageEmbed.f9267id));
        compositeEncoder.m(serialDescriptor, 1, ChannelId$$serializer.INSTANCE, ChannelId.m1060boximpl(flaggedMessageEmbed.channelId));
        if (compositeEncoder.y(serialDescriptor, 2) || flaggedMessageEmbed.guildId != null) {
            compositeEncoder.B(serialDescriptor, 2, GuildId$$serializer.INSTANCE, flaggedMessageEmbed.guildId);
        }
        if (compositeEncoder.y(serialDescriptor, 3) || flaggedMessageEmbed.userId != null) {
            compositeEncoder.B(serialDescriptor, 3, UserId$$serializer.INSTANCE, flaggedMessageEmbed.userId);
        }
        if (compositeEncoder.y(serialDescriptor, 4) || flaggedMessageEmbed.content != null) {
            compositeEncoder.B(serialDescriptor, 4, StructurableTextSerializer.INSTANCE, flaggedMessageEmbed.content);
        }
        if (compositeEncoder.y(serialDescriptor, 5) || flaggedMessageEmbed.channelName != null) {
            compositeEncoder.B(serialDescriptor, 5, n2.f7662a, flaggedMessageEmbed.channelName);
        }
        if (compositeEncoder.y(serialDescriptor, 6) || flaggedMessageEmbed.username != null) {
            compositeEncoder.B(serialDescriptor, 6, n2.f7662a, flaggedMessageEmbed.username);
        }
        compositeEncoder.v(serialDescriptor, 7, flaggedMessageEmbed.usernameColor);
        if (compositeEncoder.y(serialDescriptor, 8) || flaggedMessageEmbed.roleColor != null) {
            compositeEncoder.B(serialDescriptor, 8, p0.f7678a, flaggedMessageEmbed.roleColor);
        }
        compositeEncoder.w(serialDescriptor, 9, flaggedMessageEmbed.shouldShowRoleDot);
        if (compositeEncoder.y(serialDescriptor, 10) || flaggedMessageEmbed.avatarURL != null) {
            compositeEncoder.B(serialDescriptor, 10, n2.f7662a, flaggedMessageEmbed.avatarURL);
        }
        if (compositeEncoder.y(serialDescriptor, 11) || !Intrinsics.areEqual(flaggedMessageEmbed.communicationDisabled, Boolean.FALSE)) {
            compositeEncoder.B(serialDescriptor, 11, h.f7626a, flaggedMessageEmbed.communicationDisabled);
        }
    }
    ...
    public int hashCode() {
        int m1091hashCodeimpl = ((MessageId.m1091hashCodeimpl(this.f9267id) * 31) + ChannelId.m1065hashCodeimpl(this.channelId)) * 31;
        GuildId guildId = this.guildId;
        int m1078hashCodeimpl = (m1091hashCodeimpl + (guildId == null ? 0 : GuildId.m1078hashCodeimpl(guildId.m1082unboximpl()))) * 31;
        UserId userId = this.userId;
        int m1143hashCodeimpl = (m1078hashCodeimpl + (userId == null ? 0 : UserId.m1143hashCodeimpl(userId.m1147unboximpl()))) * 31;
        StructurableText structurableText = this.content;
        int hashCode = (m1143hashCodeimpl + (structurableText == null ? 0 : structurableText.hashCode())) * 31;
    ...
    public String toString() {
        String m1093toStringimpl = MessageId.m1093toStringimpl(this.f9267id);
        ...
        String str3 = this.avatarURL;
        Boolean bool = this.communicationDisabled;
        return "FlaggedMessageEmbed(id=" + m1093toStringimpl + ", channelId=" + m1067toStringimpl + ", guildId=" + guildId + ", userId=" + userId + ", content=" + structurableText + ", channelName=" + str + ", username=" + str2 + ", usernameColor=" + i10 + ", roleColor=" + num + ", shouldShowRoleDot=" + z10 + ", avatarURL=" + str3 + ", communicationDisabled=" + bool + ")";
    }
