...
public final class FlaggedMessageEmbed {
    ...
    public static final /* synthetic */ void write$Self$chat_release(FlaggedMessageEmbed flaggedMessageEmbed, CompositeEncoder compositeEncoder, SerialDescriptor serialDescriptor) {
        compositeEncoder.s(serialDescriptor, 0, MessageId$$serializer.INSTANCE, MessageId.m1083boximpl(flaggedMessageEmbed.f8518id));
        compositeEncoder.s(serialDescriptor, 1, ChannelId$$serializer.INSTANCE, ChannelId.m1057boximpl(flaggedMessageEmbed.channelId));
        if (compositeEncoder.A(serialDescriptor, 2) || flaggedMessageEmbed.guildId != null) {
            compositeEncoder.l(serialDescriptor, 2, GuildId$$serializer.INSTANCE, flaggedMessageEmbed.guildId);
        }
        if (compositeEncoder.A(serialDescriptor, 3) || flaggedMessageEmbed.userId != null) {
            compositeEncoder.l(serialDescriptor, 3, UserId$$serializer.INSTANCE, flaggedMessageEmbed.userId);
        }
        if (compositeEncoder.A(serialDescriptor, 4) || flaggedMessageEmbed.content != null) {
            compositeEncoder.l(serialDescriptor, 4, StructurableTextSerializer.INSTANCE, flaggedMessageEmbed.content);
        }
        if (compositeEncoder.A(serialDescriptor, 5) || flaggedMessageEmbed.channelName != null) {
            compositeEncoder.l(serialDescriptor, 5, n2.f31041a, flaggedMessageEmbed.channelName);
        }
        if (compositeEncoder.A(serialDescriptor, 6) || flaggedMessageEmbed.username != null) {
            compositeEncoder.l(serialDescriptor, 6, n2.f31041a, flaggedMessageEmbed.username);
        }
        compositeEncoder.x(serialDescriptor, 7, flaggedMessageEmbed.usernameColor);
        if (compositeEncoder.A(serialDescriptor, 8) || flaggedMessageEmbed.roleColor != null) {
            compositeEncoder.l(serialDescriptor, 8, p0.f31057a, flaggedMessageEmbed.roleColor);
        }
        compositeEncoder.y(serialDescriptor, 9, flaggedMessageEmbed.shouldShowRoleDot);
        if (compositeEncoder.A(serialDescriptor, 10) || flaggedMessageEmbed.avatarURL != null) {
            compositeEncoder.l(serialDescriptor, 10, n2.f31041a, flaggedMessageEmbed.avatarURL);
        }
        if (compositeEncoder.A(serialDescriptor, 11) || !Intrinsics.areEqual(flaggedMessageEmbed.communicationDisabled, Boolean.FALSE)) {
            compositeEncoder.l(serialDescriptor, 11, h.f31005a, flaggedMessageEmbed.communicationDisabled);
        }
    }
    ...
    public final long m245component2o4g7jtM() {
        return this.channelId;
    }

    /* renamed from: component3-qOKuAAo  reason: not valid java name */
    public final GuildId m246component3qOKuAAo() {
        return this.guildId;
    }

    /* renamed from: component4-wUX8bhU  reason: not valid java name */
    public final UserId m247component4wUX8bhU() {
        return this.userId;
    }
    ...
    public final FlaggedMessageEmbed m248copyYvvreA(@NotNull String id2, long j10, GuildId guildId, UserId userId, StructurableText structurableText, String str, String str2, int i10, Integer num, boolean z10, String str3, Boolean bool) {
    ...
    public final long m249getChannelIdo4g7jtM() {
        return this.channelId;
    }
    ...
    public final GuildId m250getGuildIdqOKuAAo() {
        return this.guildId;
    }

    @NotNull
    /* renamed from: getId-3Eiw7ao  reason: not valid java name */
    public final String m251getId3Eiw7ao() {
        return this.f8518id;
    }
    ...
    public final UserId m252getUserIdwUX8bhU() {
        return this.userId;
    }
    ...
    public int hashCode() {
        int m1088hashCodeimpl = ((MessageId.m1088hashCodeimpl(this.f8518id) * 31) + ChannelId.m1062hashCodeimpl(this.channelId)) * 31;
        GuildId guildId = this.guildId;
        int m1075hashCodeimpl = (m1088hashCodeimpl + (guildId == null ? 0 : GuildId.m1075hashCodeimpl(guildId.m1079unboximpl()))) * 31;
        UserId userId = this.userId;
        int m1140hashCodeimpl = (m1075hashCodeimpl + (userId == null ? 0 : UserId.m1140hashCodeimpl(userId.m1144unboximpl()))) * 31;
        StructurableText structurableText = this.content;
        int hashCode = (m1140hashCodeimpl + (structurableText == null ? 0 : structurableText.hashCode())) * 31;
    ...
    public String toString() {
        String m1090toStringimpl = MessageId.m1090toStringimpl(this.f8518id);
        ...
        String str3 = this.avatarURL;
        Boolean bool = this.communicationDisabled;
        return "FlaggedMessageEmbed(id=" + m1090toStringimpl + ", channelId=" + m1064toStringimpl + ", guildId=" + guildId + ", userId=" + userId + ", content=" + structurableText + ", channelName=" + str + ", username=" + str2 + ", usernameColor=" + i10 + ", roleColor=" + num + ", shouldShowRoleDot=" + z10 + ", avatarURL=" + str3 + ", communicationDisabled=" + bool + ")";
    }
