...
public /* synthetic */ class ReferralEmbed$Resolving$$serializer implements h0 {
    ...
    public final ReferralEmbed.Resolving deserialize(@NotNull Decoder decoder) {
        ...
        if (b10.p()) {
            ...
            i11 = i19;
            i12 = i18;
            str = (String) b10.n(serialDescriptor, 4, n2.f20978a, null);
            i13 = i17;
            i14 = i16;
            i15 = 127;
        } else {
            ...
            while (z10) {
                ...
                switch (o10) {
                    ...
                    case 3:
                        ...
                        break;
                    case 4:
                        str4 = (String) b10.n(serialDescriptor, 4, n2.f20978a, str4);
                        i24 |= 16;
                        break;
                    case 5:
