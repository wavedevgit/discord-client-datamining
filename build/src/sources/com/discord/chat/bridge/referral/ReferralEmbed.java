...
public interface ReferralEmbed {
    ...
    public static final class Resolved implements ReferralEmbed {
        ...
        public static final /* synthetic */ void write$Self$chat_release(Resolved resolved, CompositeEncoder compositeEncoder, SerialDescriptor serialDescriptor) {
            ...
            n2 n2Var = n2.f25302a;
            compositeEncoder.A(serialDescriptor, 4, n2Var, resolved.getHeaderLogoUrl());
            if (compositeEncoder.z(serialDescriptor, 5) || resolved.headerUrl != null) {
                compositeEncoder.A(serialDescriptor, 5, n2Var, resolved.headerUrl);
            }
            if (compositeEncoder.z(serialDescriptor, 6) || resolved.thumbnailUrl != null) {
                compositeEncoder.A(serialDescriptor, 6, n2Var, resolved.thumbnailUrl);
            }
            if (compositeEncoder.z(serialDescriptor, 7) || resolved.titleText != null) {
                compositeEncoder.A(serialDescriptor, 7, n2Var, resolved.titleText);
            }
            if (compositeEncoder.z(serialDescriptor, 8) || resolved.titleColor != null) {
                compositeEncoder.A(serialDescriptor, 8, p0.f25318a, resolved.titleColor);
            }
            if (compositeEncoder.z(serialDescriptor, 9) || resolved.bodyText != null) {
                compositeEncoder.A(serialDescriptor, 9, n2Var, resolved.bodyText);
            }
            if (compositeEncoder.z(serialDescriptor, 10) || resolved.structuredBodyText != null) {
                compositeEncoder.A(serialDescriptor, 10, AnnotatedStructurableTextSerializer.INSTANCE, resolved.structuredBodyText);
            }
            if (compositeEncoder.z(serialDescriptor, 11) || resolved.bodyTextColor != null) {
                compositeEncoder.A(serialDescriptor, 11, p0.f25318a, resolved.bodyTextColor);
            }
            if (compositeEncoder.z(serialDescriptor, 12) || resolved.linkButtonLabel != null) {
                compositeEncoder.A(serialDescriptor, 12, AnnotatedStructurableTextSerializer.INSTANCE, resolved.linkButtonLabel);
            }
            if (compositeEncoder.z(serialDescriptor, 13) || resolved.linkButtonColor != null) {
                compositeEncoder.A(serialDescriptor, 13, p0.f25318a, resolved.linkButtonColor);
            }
            if (compositeEncoder.z(serialDescriptor, 14) || resolved.subText != null) {
                compositeEncoder.A(serialDescriptor, 14, n2Var, resolved.subText);
            }
            if (compositeEncoder.z(serialDescriptor, 15) || resolved.subTextColor != null) {
                compositeEncoder.A(serialDescriptor, 15, p0.f25318a, resolved.subTextColor);
            }
            if (compositeEncoder.z(serialDescriptor, 16) || resolved.footerText != null) {
                compositeEncoder.A(serialDescriptor, 16, n2Var, resolved.footerText);
            }
            if (compositeEncoder.z(serialDescriptor, 17) || resolved.footerTextColor != null) {
                compositeEncoder.A(serialDescriptor, 17, p0.f25318a, resolved.footerTextColor);
            }
            if (compositeEncoder.z(serialDescriptor, 18) || resolved.acceptLabelText != null) {
                compositeEncoder.A(serialDescriptor, 18, n2Var, resolved.acceptLabelText);
            }
            if (compositeEncoder.z(serialDescriptor, 19) || resolved.acceptLabelColor != null) {
                compositeEncoder.A(serialDescriptor, 19, p0.f25318a, resolved.acceptLabelColor);
            }
            if (compositeEncoder.z(serialDescriptor, 20) || resolved.acceptLabelIconUrl != null) {
                compositeEncoder.A(serialDescriptor, 20, n2Var, resolved.acceptLabelIconUrl);
            }
            if (compositeEncoder.z(serialDescriptor, 21) || resolved.canBeAccepted != null) {
                compositeEncoder.A(serialDescriptor, 21, h.f25266a, resolved.canBeAccepted);
            }
        }
    ...
    public static final class Resolving implements ReferralEmbed {
        ...
        public static final /* synthetic */ void write$Self$chat_release(Resolving resolving, CompositeEncoder compositeEncoder, SerialDescriptor serialDescriptor) {
            ...
            compositeEncoder.A(serialDescriptor, 4, n2.f25302a, resolving.getHeaderLogoUrl());
