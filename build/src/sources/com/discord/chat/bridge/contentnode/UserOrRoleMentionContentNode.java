...
public final class UserOrRoleMentionContentNode extends MentionContentNode {
    ...
    @NotNull
    private static final Lazy[] $childSerializers = {null, null, null, null, null, null, null, null, as.l.a(as.o.f6082e, new Function0() { // from class: com.discord.chat.bridge.contentnode.x
    ...
    public static final /* synthetic */ KSerializer _childSerializers$_anonymous_() {
        return new tt.f(ContentNodeSerializer.INSTANCE);
    }
    ...
    public static /* synthetic */ UserOrRoleMentionContentNode m381copy5RCyINY$default(UserOrRoleMentionContentNode userOrRoleMentionContentNode, ChannelId channelId, UserId userId, String str, String str2, int i10, RoleColors roleColors, GuildId guildId, RoleId roleId, List list, int i11, Object obj) {
        if ((i11 & 1) != 0) {
        ...
        int i12 = i10;
        String str3 = str;
        return userOrRoleMentionContentNode.m386copy5RCyINY(channelId, userId, str3, str2, i12, roleColors2, guildId2, roleId2, list3);
    }
    ...
    public static final /* synthetic */ void write$Self$chat_release(UserOrRoleMentionContentNode userOrRoleMentionContentNode, CompositeEncoder compositeEncoder, SerialDescriptor serialDescriptor) {
        ...
        if (compositeEncoder.z(serialDescriptor, 0) || userOrRoleMentionContentNode.channelId != null) {
            compositeEncoder.o(serialDescriptor, 0, ChannelId$$serializer.INSTANCE, userOrRoleMentionContentNode.channelId);
        }
        ...
        if (compositeEncoder.z(serialDescriptor, 2) || userOrRoleMentionContentNode.roleName != null) {
            compositeEncoder.o(serialDescriptor, 2, n2.f50032a, userOrRoleMentionContentNode.roleName);
        }
        if (compositeEncoder.z(serialDescriptor, 3) || userOrRoleMentionContentNode.parsedUserId != null) {
            compositeEncoder.o(serialDescriptor, 3, n2.f50032a, userOrRoleMentionContentNode.parsedUserId);
        }
        ...
        if (compositeEncoder.z(serialDescriptor, 5) || userOrRoleMentionContentNode.roleColors != null) {
            compositeEncoder.o(serialDescriptor, 5, RoleColors$$serializer.INSTANCE, userOrRoleMentionContentNode.roleColors);
        }
        if (compositeEncoder.z(serialDescriptor, 6) || userOrRoleMentionContentNode.guildId != null) {
            compositeEncoder.o(serialDescriptor, 6, GuildId$$serializer.INSTANCE, userOrRoleMentionContentNode.guildId);
        }
        if (compositeEncoder.z(serialDescriptor, 7) || userOrRoleMentionContentNode.roleId != null) {
            compositeEncoder.o(serialDescriptor, 7, RoleId$$serializer.INSTANCE, userOrRoleMentionContentNode.roleId);
        }
        compositeEncoder.k(serialDescriptor, 8, (qt.o) lazyArr[8].getValue(), userOrRoleMentionContentNode.getContent());
    }

    /* renamed from: component1-qMVnFVQ */
    public final ChannelId m382component1qMVnFVQ() {
        return this.channelId;
    }

    /* renamed from: component2-wUX8bhU */
    public final UserId m383component2wUX8bhU() {
        return this.userId;
    }
    ...
    public final GuildId m384component7qOKuAAo() {
        return this.guildId;
    }

    /* renamed from: component8-fYaclRY */
    public final RoleId m385component8fYaclRY() {
        return this.roleId;
    }
    ...
    public final UserOrRoleMentionContentNode m386copy5RCyINY(ChannelId channelId, UserId userId, String str, String str2, int i10, RoleColors roleColors, GuildId guildId, RoleId roleId, @NotNull List<? extends ContentNode> content) {
    ...
    public final ChannelId m387getChannelIdqMVnFVQ() {
        return this.channelId;
    }
    ...
    public final GuildId m388getGuildIdqOKuAAo() {
        return this.guildId;
    }
    ...
    public final RoleId m389getRoleIdfYaclRY() {
        return this.roleId;
    }
    ...
    public final UserId m390getUserIdwUX8bhU() {
        return this.userId;
    }
