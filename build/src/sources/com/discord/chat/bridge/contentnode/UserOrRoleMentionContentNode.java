...
public final class UserOrRoleMentionContentNode extends MentionContentNode {
    ...
    @NotNull
    private static final Lazy[] $childSerializers = {null, null, null, null, null, null, null, null, ir.l.a(ir.o.f31119e, new Function0() { // from class: com.discord.chat.bridge.contentnode.x
    ...
    public static final /* synthetic */ void write$Self$chat_release(UserOrRoleMentionContentNode userOrRoleMentionContentNode, CompositeEncoder compositeEncoder, SerialDescriptor serialDescriptor) {
        ...
        if (compositeEncoder.A(serialDescriptor, 0) || userOrRoleMentionContentNode.channelId != null) {
            compositeEncoder.z(serialDescriptor, 0, ChannelId$$serializer.INSTANCE, userOrRoleMentionContentNode.channelId);
        }
        if (compositeEncoder.A(serialDescriptor, 1) || userOrRoleMentionContentNode.userId != null) {
            compositeEncoder.z(serialDescriptor, 1, UserId$$serializer.INSTANCE, userOrRoleMentionContentNode.userId);
        }
        if (compositeEncoder.A(serialDescriptor, 2) || userOrRoleMentionContentNode.roleName != null) {
            compositeEncoder.z(serialDescriptor, 2, n2.f6848a, userOrRoleMentionContentNode.roleName);
        }
        if (compositeEncoder.A(serialDescriptor, 3) || userOrRoleMentionContentNode.parsedUserId != null) {
            compositeEncoder.z(serialDescriptor, 3, n2.f6848a, userOrRoleMentionContentNode.parsedUserId);
        }
        ...
        if (compositeEncoder.A(serialDescriptor, 5) || userOrRoleMentionContentNode.roleColors != null) {
            compositeEncoder.z(serialDescriptor, 5, RoleColors$$serializer.INSTANCE, userOrRoleMentionContentNode.roleColors);
        }
        if (compositeEncoder.A(serialDescriptor, 6) || userOrRoleMentionContentNode.guildId != null) {
            compositeEncoder.z(serialDescriptor, 6, GuildId$$serializer.INSTANCE, userOrRoleMentionContentNode.guildId);
        }
        if (compositeEncoder.A(serialDescriptor, 7) || userOrRoleMentionContentNode.roleId != null) {
            compositeEncoder.z(serialDescriptor, 7, RoleId$$serializer.INSTANCE, userOrRoleMentionContentNode.roleId);
        }
        compositeEncoder.j(serialDescriptor, 8, (xs.o) lazyArr[8].getValue(), userOrRoleMentionContentNode.getContent());
    }
    ...
    public int hashCode() {
        ...
        int m1063hashCodeimpl = (channelId == null ? 0 : ChannelId.m1063hashCodeimpl(channelId.m1067unboximpl())) * 31;
        UserId userId = this.userId;
        int m1141hashCodeimpl = (m1063hashCodeimpl + (userId == null ? 0 : UserId.m1141hashCodeimpl(userId.m1145unboximpl()))) * 31;
        String str = this.roleName;
        int hashCode = (m1141hashCodeimpl + (str == null ? 0 : str.hashCode())) * 31;
        ...
        int m1076hashCodeimpl = (hashCode3 + (guildId == null ? 0 : GuildId.m1076hashCodeimpl(guildId.m1080unboximpl()))) * 31;
        RoleId roleId = this.roleId;
        return ((m1076hashCodeimpl + (roleId != null ? RoleId.m1115hashCodeimpl(roleId.m1119unboximpl()) : 0)) * 31) + this.content.hashCode();
    }
