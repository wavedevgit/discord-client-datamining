...
@ft.m(with = LinkContextDataSerializer.class)
...
public abstract class LinkContextData {
    ...
    public static final class BindDismissMessage extends LinkContext {
        ...
        public static final class DismissedMessage {
            ...
            public static final /* synthetic */ void write$Self$chat_release(DismissedMessage dismissedMessage, CompositeEncoder compositeEncoder, SerialDescriptor serialDescriptor) {
                compositeEncoder.s(serialDescriptor, 0, MessageId$$serializer.INSTANCE, MessageId.m1083boximpl(dismissedMessage.f8545id));
                compositeEncoder.s(serialDescriptor, 1, ChannelId$$serializer.INSTANCE, ChannelId.m1057boximpl(dismissedMessage.channelId));
                if (compositeEncoder.A(serialDescriptor, 2) || dismissedMessage.loggingName != null) {
                    compositeEncoder.l(serialDescriptor, 2, n2.f31089a, dismissedMessage.loggingName);
                }
                compositeEncoder.s(serialDescriptor, 3, LinkContextData$BindDismissMessage$DismissedMessageAuthor$$serializer.INSTANCE, dismissedMessage.author);
            }
            ...
            public boolean equals(Object obj) {
                ...
                if (obj instanceof DismissedMessage) {
                    ...
                    return MessageId.m1087equalsimpl0(this.f8545id, dismissedMessage.f8545id) && ChannelId.m1061equalsimpl0(this.channelId, dismissedMessage.channelId) && Intrinsics.areEqual(this.loggingName, dismissedMessage.loggingName) && Intrinsics.areEqual(this.author, dismissedMessage.author);
                }
                return false;
            }
            ...
            public int hashCode() {
                int m1088hashCodeimpl = ((MessageId.m1088hashCodeimpl(this.f8545id) * 31) + ChannelId.m1062hashCodeimpl(this.channelId)) * 31;
                String str = this.loggingName;
                return ((m1088hashCodeimpl + (str == null ? 0 : str.hashCode())) * 31) + this.author.hashCode();
            }

            @NotNull
            public String toString() {
                String m1090toStringimpl = MessageId.m1090toStringimpl(this.f8545id);
                ...
                return "DismissedMessage(id=" + m1090toStringimpl + ", channelId=" + m1064toStringimpl + ", loggingName=" + str + ", author=" + dismissedMessageAuthor + ")";
            }
        ...
        public static final /* synthetic */ void write$Self$chat_release(BindDismissMessage bindDismissMessage, CompositeEncoder compositeEncoder, SerialDescriptor serialDescriptor) {
            ...
            compositeEncoder.s(serialDescriptor, 2, LinkContextData$BindDismissMessage$DismissedMessage$$serializer.INSTANCE, bindDismissMessage.message);
        }
    ...
    public static final class BindDoNothing extends LinkContext {
        ...
        private static final /* synthetic */ Lazy $cachedSerializer$delegate = qr.l.b(qr.o.f48092e, new Function0() { // from class: com.discord.chat.bridge.contentnode.n
    ...
    public static final class BindGuildMenu extends LinkContext {
        ...
        public static final class MessageReference {
            ...
            public static final /* synthetic */ void write$Self$chat_release(MessageReference messageReference, CompositeEncoder compositeEncoder, SerialDescriptor serialDescriptor) {
                compositeEncoder.s(serialDescriptor, 0, ChannelId$$serializer.INSTANCE, ChannelId.m1057boximpl(messageReference.channelId));
                if (compositeEncoder.A(serialDescriptor, 1) || messageReference.guildId != null) {
                    compositeEncoder.l(serialDescriptor, 1, GuildId$$serializer.INSTANCE, messageReference.guildId);
                }
            }
            ...
            public boolean equals(Object obj) {
                ...
                if (obj instanceof MessageReference) {
                    ...
                    return ChannelId.m1061equalsimpl0(this.channelId, messageReference.channelId) && Intrinsics.areEqual(this.guildId, messageReference.guildId);
                }
                return false;
            }
            ...
            public int hashCode() {
                int m1062hashCodeimpl = ChannelId.m1062hashCodeimpl(this.channelId) * 31;
                GuildId guildId = this.guildId;
                return m1062hashCodeimpl + (guildId == null ? 0 : GuildId.m1075hashCodeimpl(guildId.m1079unboximpl()));
            }
            ...
            public String toString() {
                String m1064toStringimpl = ChannelId.m1064toStringimpl(this.channelId);
                GuildId guildId = this.guildId;
                return "MessageReference(channelId=" + m1064toStringimpl + ", guildId=" + guildId + ")";
            }
        ...
        public static final /* synthetic */ void write$Self$chat_release(BindGuildMenu bindGuildMenu, CompositeEncoder compositeEncoder, SerialDescriptor serialDescriptor) {
            ...
            if (compositeEncoder.A(serialDescriptor, 2) || bindGuildMenu.messageReference != null) {
                compositeEncoder.l(serialDescriptor, 2, LinkContextData$BindGuildMenu$MessageReference$$serializer.INSTANCE, bindGuildMenu.messageReference);
            }
        }
    ...
    public static final class BindInsertText extends LinkContext {
        ...
        public static final /* synthetic */ void write$Self$chat_release(BindInsertText bindInsertText, CompositeEncoder compositeEncoder, SerialDescriptor serialDescriptor) {
            ...
            compositeEncoder.z(serialDescriptor, 2, bindInsertText.text);
            if (compositeEncoder.A(serialDescriptor, 3) || bindInsertText.addSpace != null) {
                compositeEncoder.l(serialDescriptor, 3, jt.h.f31053a, bindInsertText.addSpace);
            }
        }
    ...
    public static final class BindJoinStream extends LinkContext {
        ...
        public static final class ApplicationStream {
            ...
            public static final /* synthetic */ void write$Self$chat_release(ApplicationStream applicationStream, CompositeEncoder compositeEncoder, SerialDescriptor serialDescriptor) {
                compositeEncoder.s(serialDescriptor, 0, UserId$$serializer.INSTANCE, UserId.m1135boximpl(applicationStream.ownerId));
                compositeEncoder.s(serialDescriptor, 1, ChannelId$$serializer.INSTANCE, ChannelId.m1057boximpl(applicationStream.channelId));
                if (compositeEncoder.A(serialDescriptor, 2) || applicationStream.guildId != null) {
                    compositeEncoder.l(serialDescriptor, 2, GuildId$$serializer.INSTANCE, applicationStream.guildId);
                }
                compositeEncoder.z(serialDescriptor, 3, applicationStream.streamType);
                if (compositeEncoder.A(serialDescriptor, 4) || applicationStream.discoverable != null) {
                    compositeEncoder.l(serialDescriptor, 4, jt.h.f31053a, applicationStream.discoverable);
                }
            }
            ...
            public boolean equals(Object obj) {
                ...
                if (obj instanceof ApplicationStream) {
                    ...
                    return UserId.m1139equalsimpl0(this.ownerId, applicationStream.ownerId) && ChannelId.m1061equalsimpl0(this.channelId, applicationStream.channelId) && Intrinsics.areEqual(this.guildId, applicationStream.guildId) && Intrinsics.areEqual(this.streamType, applicationStream.streamType) && Intrinsics.areEqual(this.discoverable, applicationStream.discoverable);
                }
                return false;
            }
            ...
            public int hashCode() {
                int m1140hashCodeimpl = ((UserId.m1140hashCodeimpl(this.ownerId) * 31) + ChannelId.m1062hashCodeimpl(this.channelId)) * 31;
                GuildId guildId = this.guildId;
                int m1075hashCodeimpl = (((m1140hashCodeimpl + (guildId == null ? 0 : GuildId.m1075hashCodeimpl(guildId.m1079unboximpl()))) * 31) + this.streamType.hashCode()) * 31;
            ...
            @NotNull
            public String toString() {
                String m1142toStringimpl = UserId.m1142toStringimpl(this.ownerId);
                String m1064toStringimpl = ChannelId.m1064toStringimpl(this.channelId);
                GuildId guildId = this.guildId;
                String str = this.streamType;
                Boolean bool = this.discoverable;
                return "ApplicationStream(ownerId=" + m1142toStringimpl + ", channelId=" + m1064toStringimpl + ", guildId=" + guildId + ", streamType=" + str + ", discoverable=" + bool + ")";
            }
            ...
            private /* synthetic */ ApplicationStream(int i10, UserId userId, ChannelId channelId, GuildId guildId, String str, Boolean bool, SerializationConstructorMarker serializationConstructorMarker) {
                ...
                this.ownerId = userId.m1144unboximpl();
                this.channelId = channelId.m1066unboximpl();
                if ((i10 & 4) == 0) {
                    this.guildId = null;
                } else {
        ...
        public static final /* synthetic */ void write$Self$chat_release(BindJoinStream bindJoinStream, CompositeEncoder compositeEncoder, SerialDescriptor serialDescriptor) {
            ...
            compositeEncoder.s(serialDescriptor, 2, LinkContextData$BindJoinStream$ApplicationStream$$serializer.INSTANCE, bindJoinStream.stream);
        }
    ...
    public static final class BindJumpToMessage extends LinkContext {
        ...
        public static final /* synthetic */ void write$Self$chat_release(BindJumpToMessage bindJumpToMessage, CompositeEncoder compositeEncoder, SerialDescriptor serialDescriptor) {
            ...
            compositeEncoder.z(serialDescriptor, 2, bindJumpToMessage.targetChannelId);
            compositeEncoder.z(serialDescriptor, 3, bindJumpToMessage.targetMessageId);
        }
    ...
    public static final class BindOpenGdmCustomizeActionSheet extends LinkContext {
        ...
        public static final /* synthetic */ void write$Self$chat_release(BindOpenGdmCustomizeActionSheet bindOpenGdmCustomizeActionSheet, CompositeEncoder compositeEncoder, SerialDescriptor serialDescriptor) {
            ...
            compositeEncoder.z(serialDescriptor, 2, bindOpenGdmCustomizeActionSheet.messageChannelId);
            if (compositeEncoder.A(serialDescriptor, 3) || bindOpenGdmCustomizeActionSheet.linkColor != null) {
                compositeEncoder.l(serialDescriptor, 3, p0.f31105a, bindOpenGdmCustomizeActionSheet.linkColor);
            }
        }
    ...
    public static final class BindOpenInviteSheet extends LinkContext {
        ...
        public static final /* synthetic */ void write$Self$chat_release(BindOpenInviteSheet bindOpenInviteSheet, CompositeEncoder compositeEncoder, SerialDescriptor serialDescriptor) {
            ...
            compositeEncoder.s(serialDescriptor, 2, ChannelId$$serializer.INSTANCE, ChannelId.m1057boximpl(bindOpenInviteSheet.messageChannelId));
        }
        ...
        public boolean equals(Object obj) {
            ...
            return (obj instanceof BindOpenInviteSheet) && ChannelId.m1061equalsimpl0(this.messageChannelId, ((BindOpenInviteSheet) obj).messageChannelId);
        }
        ...
        public int hashCode() {
            return ChannelId.m1062hashCodeimpl(this.messageChannelId);
        }

        @NotNull
        public String toString() {
            String m1064toStringimpl = ChannelId.m1064toStringimpl(this.messageChannelId);
            return "BindOpenInviteSheet(messageChannelId=" + m1064toStringimpl + ")";
        }
        ...
        private /* synthetic */ BindOpenInviteSheet(int i10, String str, Boolean bool, ChannelId channelId, SerializationConstructorMarker serializationConstructorMarker) {
            ...
            this.messageChannelId = channelId.m1066unboximpl();
        }
    ...
    public static final class BindOpenPins extends LinkContext {
        ...
        public static final /* synthetic */ void write$Self$chat_release(BindOpenPins bindOpenPins, CompositeEncoder compositeEncoder, SerialDescriptor serialDescriptor) {
            ...
            compositeEncoder.s(serialDescriptor, 2, ChannelId$$serializer.INSTANCE, ChannelId.m1057boximpl(bindOpenPins.messageChannelId));
        }
        ...
        public boolean equals(Object obj) {
            ...
            return (obj instanceof BindOpenPins) && ChannelId.m1061equalsimpl0(this.messageChannelId, ((BindOpenPins) obj).messageChannelId);
        }
        ...
        public String toString() {
            String m1064toStringimpl = ChannelId.m1064toStringimpl(this.messageChannelId);
            return "BindOpenPins(messageChannelId=" + m1064toStringimpl + ")";
        }
    ...
    public static final class BindOpenRoleSubscriptionOverview extends LinkContext {
        ...
        public static final /* synthetic */ void write$Self$chat_release(BindOpenRoleSubscriptionOverview bindOpenRoleSubscriptionOverview, CompositeEncoder compositeEncoder, SerialDescriptor serialDescriptor) {
            ...
            compositeEncoder.z(serialDescriptor, 2, bindOpenRoleSubscriptionOverview.guildId);
            n2 n2Var = n2.f31089a;
            compositeEncoder.l(serialDescriptor, 3, n2Var, bindOpenRoleSubscriptionOverview.messageId);
            compositeEncoder.l(serialDescriptor, 4, n2Var, bindOpenRoleSubscriptionOverview.channelId);
            compositeEncoder.l(serialDescriptor, 5, n2Var, bindOpenRoleSubscriptionOverview.roleSubscriptionListingId);
        }
    ...
    public static final class BindOpenThreadChannel extends LinkContext {
        ...
        public static final /* synthetic */ void write$Self$chat_release(BindOpenThreadChannel bindOpenThreadChannel, CompositeEncoder compositeEncoder, SerialDescriptor serialDescriptor) {
            ...
            compositeEncoder.s(serialDescriptor, 2, ChannelId$$serializer.INSTANCE, ChannelId.m1057boximpl(bindOpenThreadChannel.threadId));
        }
        ...
        public boolean equals(Object obj) {
            ...
            return (obj instanceof BindOpenThreadChannel) && ChannelId.m1061equalsimpl0(this.threadId, ((BindOpenThreadChannel) obj).threadId);
        }
        ...
        public int hashCode() {
            return ChannelId.m1062hashCodeimpl(this.threadId);
        }

        @NotNull
        public String toString() {
            String m1064toStringimpl = ChannelId.m1064toStringimpl(this.threadId);
            return "BindOpenThreadChannel(threadId=" + m1064toStringimpl + ")";
        }
        ...
        private /* synthetic */ BindOpenThreadChannel(int i10, String str, Boolean bool, ChannelId channelId, SerializationConstructorMarker serializationConstructorMarker) {
            ...
            this.threadId = channelId.m1066unboximpl();
        }
    ...
    public static final class BindOpenUrl extends LinkContext {
        ...
        public static final /* synthetic */ void write$Self$chat_release(BindOpenUrl bindOpenUrl, CompositeEncoder compositeEncoder, SerialDescriptor serialDescriptor) {
            ...
            compositeEncoder.z(serialDescriptor, 2, bindOpenUrl.url);
            if (compositeEncoder.A(serialDescriptor, 3) || bindOpenUrl.linkColor != null) {
                compositeEncoder.l(serialDescriptor, 3, p0.f31105a, bindOpenUrl.linkColor);
            }
        }
    ...
    public static final class BindTapActivityText extends LinkContext {
        ...
        public static final /* synthetic */ void write$Self$chat_release(BindTapActivityText bindTapActivityText, CompositeEncoder compositeEncoder, SerialDescriptor serialDescriptor) {
            ...
            compositeEncoder.s(serialDescriptor, 2, UserId$$serializer.INSTANCE, UserId.m1135boximpl(bindTapActivityText.applicationUserId));
            compositeEncoder.s(serialDescriptor, 3, ChannelId$$serializer.INSTANCE, ChannelId.m1057boximpl(bindTapActivityText.messageChannelId));
        }
        ...
        public boolean equals(Object obj) {
            ...
            if (obj instanceof BindTapActivityText) {
                ...
                return UserId.m1139equalsimpl0(this.applicationUserId, bindTapActivityText.applicationUserId) && ChannelId.m1061equalsimpl0(this.messageChannelId, bindTapActivityText.messageChannelId);
            }
            return false;
        }
        ...
        public int hashCode() {
            return (UserId.m1140hashCodeimpl(this.applicationUserId) * 31) + ChannelId.m1062hashCodeimpl(this.messageChannelId);
        }

        @NotNull
        public String toString() {
            String m1142toStringimpl = UserId.m1142toStringimpl(this.applicationUserId);
            String m1064toStringimpl = ChannelId.m1064toStringimpl(this.messageChannelId);
            return "BindTapActivityText(applicationUserId=" + m1142toStringimpl + ", messageChannelId=" + m1064toStringimpl + ")";
        }
        ...
        private /* synthetic */ BindTapActivityText(int i10, String str, Boolean bool, UserId userId, ChannelId channelId, SerializationConstructorMarker serializationConstructorMarker) {
            ...
            this.applicationUserId = userId.m1144unboximpl();
            this.messageChannelId = channelId.m1066unboximpl();
        }
    ...
    public static final class BindTapCommandName extends LinkContext {
        ...
        public static final /* synthetic */ void write$Self$chat_release(BindTapCommandName bindTapCommandName, CompositeEncoder compositeEncoder, SerialDescriptor serialDescriptor) {
            ...
            compositeEncoder.s(serialDescriptor, 2, userId$$serializer, UserId.m1135boximpl(bindTapCommandName.userId));
            compositeEncoder.s(serialDescriptor, 3, MessageId$$serializer.INSTANCE, MessageId.m1083boximpl(bindTapCommandName.messageId));
            compositeEncoder.s(serialDescriptor, 4, userId$$serializer, UserId.m1135boximpl(bindTapCommandName.applicationUserId));
            compositeEncoder.s(serialDescriptor, 5, MessageType.Serializer.INSTANCE, bindTapCommandName.messageType);
            compositeEncoder.s(serialDescriptor, 6, ChannelId$$serializer.INSTANCE, ChannelId.m1057boximpl(bindTapCommandName.messageChannelId));
        }
        ...
        public boolean equals(Object obj) {
            ...
            if (obj instanceof BindTapCommandName) {
                ...
                return UserId.m1139equalsimpl0(this.userId, bindTapCommandName.userId) && MessageId.m1087equalsimpl0(this.messageId, bindTapCommandName.messageId) && UserId.m1139equalsimpl0(this.applicationUserId, bindTapCommandName.applicationUserId) && this.messageType == bindTapCommandName.messageType && ChannelId.m1061equalsimpl0(this.messageChannelId, bindTapCommandName.messageChannelId);
            }
            return false;
        }
        ...
        public int hashCode() {
            return (((((((UserId.m1140hashCodeimpl(this.userId) * 31) + MessageId.m1088hashCodeimpl(this.messageId)) * 31) + UserId.m1140hashCodeimpl(this.applicationUserId)) * 31) + this.messageType.hashCode()) * 31) + ChannelId.m1062hashCodeimpl(this.messageChannelId);
        }
        ...
        public String toString() {
            ...
            String m1142toStringimpl2 = UserId.m1142toStringimpl(this.applicationUserId);
            MessageType messageType = this.messageType;
            String m1064toStringimpl = ChannelId.m1064toStringimpl(this.messageChannelId);
            return "BindTapCommandName(userId=" + m1142toStringimpl + ", messageId=" + m1090toStringimpl + ", applicationUserId=" + m1142toStringimpl2 + ", messageType=" + messageType + ", messageChannelId=" + m1064toStringimpl + ")";
        }
        ...
        private /* synthetic */ BindTapCommandName(int i10, String str, Boolean bool, UserId userId, String str2, UserId userId2, MessageType messageType, ChannelId channelId, SerializationConstructorMarker serializationConstructorMarker) {
            ...
            this.userId = userId.m1144unboximpl();
            this.messageId = str2;
            this.applicationUserId = userId2.m1144unboximpl();
    ...
    public static final class BindTapUsername extends LinkContext {
        ...
        public static final /* synthetic */ void write$Self$chat_release(BindTapUsername bindTapUsername, CompositeEncoder compositeEncoder, SerialDescriptor serialDescriptor) {
            ...
            compositeEncoder.s(serialDescriptor, 2, UserId$$serializer.INSTANCE, UserId.m1135boximpl(bindTapUsername.userId));
            compositeEncoder.s(serialDescriptor, 3, ChannelId$$serializer.INSTANCE, ChannelId.m1057boximpl(bindTapUsername.messageChannelId));
        }
        ...
        public boolean equals(Object obj) {
            ...
            if (obj instanceof BindTapUsername) {
                ...
                return UserId.m1139equalsimpl0(this.userId, bindTapUsername.userId) && ChannelId.m1061equalsimpl0(this.messageChannelId, bindTapUsername.messageChannelId);
            }
            return false;
        }
        ...
        public int hashCode() {
            return (UserId.m1140hashCodeimpl(this.userId) * 31) + ChannelId.m1062hashCodeimpl(this.messageChannelId);
        }
        ...
        public String toString() {
            String m1142toStringimpl = UserId.m1142toStringimpl(this.userId);
            String m1064toStringimpl = ChannelId.m1064toStringimpl(this.messageChannelId);
            return "BindTapUsername(userId=" + m1142toStringimpl + ", messageChannelId=" + m1064toStringimpl + ")";
        }
    ...
    public static final class BindUserMenu extends LinkContext {
        ...
        public static final /* synthetic */ void write$Self$chat_release(BindUserMenu bindUserMenu, CompositeEncoder compositeEncoder, SerialDescriptor serialDescriptor) {
            ...
            compositeEncoder.s(serialDescriptor, 2, UserId$$serializer.INSTANCE, UserId.m1135boximpl(bindUserMenu.userId));
            if (compositeEncoder.A(serialDescriptor, 3) || bindUserMenu.colorString != null) {
                compositeEncoder.l(serialDescriptor, 3, p0.f31105a, bindUserMenu.colorString);
            }
            if (compositeEncoder.A(serialDescriptor, 4) || bindUserMenu.linkColor != null) {
                compositeEncoder.l(serialDescriptor, 4, p0.f31105a, bindUserMenu.linkColor);
            }
            if (compositeEncoder.A(serialDescriptor, 5) || bindUserMenu.roleColor != null) {
                compositeEncoder.l(serialDescriptor, 5, p0.f31105a, bindUserMenu.roleColor);
            }
            if (compositeEncoder.A(serialDescriptor, 6) || bindUserMenu.roleColors != null) {
                compositeEncoder.l(serialDescriptor, 6, RoleColors$$serializer.INSTANCE, bindUserMenu.roleColors);
            }
            if (compositeEncoder.A(serialDescriptor, 7) || bindUserMenu.shouldShowRoleDot != null) {
                compositeEncoder.l(serialDescriptor, 7, jt.h.f31053a, bindUserMenu.shouldShowRoleDot);
            }
            if (compositeEncoder.A(serialDescriptor, 8) || bindUserMenu.messageChannelId != null) {
                compositeEncoder.l(serialDescriptor, 8, ChannelId$$serializer.INSTANCE, bindUserMenu.messageChannelId);
            }
        }
        ...
        public int hashCode() {
            int m1140hashCodeimpl = UserId.m1140hashCodeimpl(this.userId) * 31;
            Integer num = this.colorString;
            int hashCode = (m1140hashCodeimpl + (num == null ? 0 : num.hashCode())) * 31;
            ...
            return hashCode5 + (channelId != null ? ChannelId.m1062hashCodeimpl(channelId.m1066unboximpl()) : 0);
        }
        ...
        public String toString() {
            ...
            Boolean bool = this.shouldShowRoleDot;
            ChannelId channelId = this.messageChannelId;
            return "BindUserMenu(userId=" + m1142toStringimpl + ", colorString=" + num + ", linkColor=" + num2 + ", roleColor=" + num3 + ", roleColors=" + roleColors + ", shouldShowRoleDot=" + bool + ", messageChannelId=" + channelId + ")";
        }
    ...
    public static final class BindUserSurvey extends LinkContext {
        ...
        public static final class SurveyMessage {
            ...
            public static final /* synthetic */ void write$Self$chat_release(SurveyMessage surveyMessage, CompositeEncoder compositeEncoder, SerialDescriptor serialDescriptor) {
                compositeEncoder.s(serialDescriptor, 0, MessageId$$serializer.INSTANCE, MessageId.m1083boximpl(surveyMessage.f8546id));
                compositeEncoder.s(serialDescriptor, 1, ChannelId$$serializer.INSTANCE, ChannelId.m1057boximpl(surveyMessage.channelId));
                if (compositeEncoder.A(serialDescriptor, 2) || surveyMessage.loggingName != null) {
                    compositeEncoder.l(serialDescriptor, 2, n2.f31089a, surveyMessage.loggingName);
                }
            }
            ...
            public boolean equals(Object obj) {
                ...
                if (obj instanceof SurveyMessage) {
                    ...
                    return MessageId.m1087equalsimpl0(this.f8546id, surveyMessage.f8546id) && ChannelId.m1061equalsimpl0(this.channelId, surveyMessage.channelId) && Intrinsics.areEqual(this.loggingName, surveyMessage.loggingName);
                }
                return false;
            }
            ...
            public int hashCode() {
                int m1088hashCodeimpl = ((MessageId.m1088hashCodeimpl(this.f8546id) * 31) + ChannelId.m1062hashCodeimpl(this.channelId)) * 31;
                String str = this.loggingName;
                return m1088hashCodeimpl + (str == null ? 0 : str.hashCode());
            }

            @NotNull
            public String toString() {
                String m1090toStringimpl = MessageId.m1090toStringimpl(this.f8546id);
                String m1064toStringimpl = ChannelId.m1064toStringimpl(this.channelId);
                String str = this.loggingName;
                return "SurveyMessage(id=" + m1090toStringimpl + ", channelId=" + m1064toStringimpl + ", loggingName=" + str + ")";
            }
        ...
        public static final /* synthetic */ void write$Self$chat_release(BindUserSurvey bindUserSurvey, CompositeEncoder compositeEncoder, SerialDescriptor serialDescriptor) {
            ...
            compositeEncoder.s(serialDescriptor, 2, LinkContextData$BindUserSurvey$SurveyMessage$$serializer.INSTANCE, bindUserSurvey.message);
            if (compositeEncoder.A(serialDescriptor, 3) || bindUserSurvey.notificationType != null) {
                compositeEncoder.l(serialDescriptor, 3, n2.f31089a, bindUserSurvey.notificationType);
            }
        }
    ...
    public static abstract class LinkContext extends LinkContextData {
        ...
        public static final Companion Companion = new Companion(null);
        @NotNull
        private static final Lazy $cachedSerializer$delegate = qr.l.b(qr.o.f48092e, new Function0() { // from class: com.discord.chat.bridge.contentnode.o
            @Override // kotlin.jvm.functions.Function0
            public final Object invoke() {
                KSerializer _init_$_anonymous_;
        ...
        public static final /* synthetic */ void write$Self(LinkContext linkContext, CompositeEncoder compositeEncoder, SerialDescriptor serialDescriptor) {
            compositeEncoder.z(serialDescriptor, 0, linkContext.action);
            if (compositeEncoder.A(serialDescriptor, 1) || linkContext.medium != null) {
                compositeEncoder.l(serialDescriptor, 1, jt.h.f31053a, linkContext.medium);
            }
        }
    ...
    @ft.m(with = LinkUrlSerializer.class)
    ...
    public static final class LinkUrl extends LinkContextData {
        ...
        public static final class LinkUrlSerializer implements KSerializer {
            ...
            public SerialDescriptor getDescriptor() {
                return ht.j.b("LinkUrl", e.i.f26526a);
            }
            ...
            public LinkUrl deserialize(@NotNull Decoder decoder) {
                ...
                try {
                    if (decoder instanceof kt.f) {
                        return new LinkUrl(kt.h.o(((kt.f) decoder).g()).b());
                    }
