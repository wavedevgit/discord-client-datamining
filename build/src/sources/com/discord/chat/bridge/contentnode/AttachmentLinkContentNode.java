...
public final class AttachmentLinkContentNode extends MentionContentNode {
    ...
    @NotNull
    private static final Lazy[] $childSerializers = {null, null, qr.l.b(qr.o.f48044e, new Function0() { // from class: com.discord.chat.bridge.contentnode.a
    ...
    public static final /* synthetic */ void write$Self$chat_release(AttachmentLinkContentNode attachmentLinkContentNode, CompositeEncoder compositeEncoder, SerialDescriptor serialDescriptor) {
        ...
        compositeEncoder.z(serialDescriptor, 0, attachmentLinkContentNode.attachmentUrl);
        compositeEncoder.z(serialDescriptor, 1, attachmentLinkContentNode.attachmentName);
        compositeEncoder.l(serialDescriptor, 2, (ft.o) lazyArr[2].getValue(), attachmentLinkContentNode.getContent());
    }
