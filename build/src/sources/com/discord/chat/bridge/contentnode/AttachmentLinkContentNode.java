...
public final class AttachmentLinkContentNode extends MentionContentNode {
    ...
    @NotNull
    private static final Lazy[] $childSerializers = {null, null, or.l.b(or.o.f44232e, new Function0() { // from class: com.discord.chat.bridge.contentnode.a
    ...
    public static final /* synthetic */ void write$Self$chat_release(AttachmentLinkContentNode attachmentLinkContentNode, CompositeEncoder compositeEncoder, SerialDescriptor serialDescriptor) {
        ...
        compositeEncoder.x(serialDescriptor, 0, attachmentLinkContentNode.attachmentUrl);
        compositeEncoder.x(serialDescriptor, 1, attachmentLinkContentNode.attachmentName);
        compositeEncoder.A(serialDescriptor, 2, (dt.o) lazyArr[2].getValue(), attachmentLinkContentNode.getContent());
    }
