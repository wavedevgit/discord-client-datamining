...
public final class BulletListContentNode extends ContentNode {
    ...
    @NotNull
    private static final Lazy[] $childSerializers = {null, null, as.l.a(as.o.f6082e, new Function0() { // from class: com.discord.chat.bridge.contentnode.c
    ...
    public static final /* synthetic */ KSerializer _childSerializers$_anonymous_() {
        return new tt.f(new tt.f(ContentNodeSerializer.INSTANCE));
    }
    ...
    public static final /* synthetic */ void write$Self$chat_release(BulletListContentNode bulletListContentNode, CompositeEncoder compositeEncoder, SerialDescriptor serialDescriptor) {
        ...
        if (compositeEncoder.z(serialDescriptor, 0) || bulletListContentNode.start != null) {
            compositeEncoder.o(serialDescriptor, 0, z0.f50106a, bulletListContentNode.start);
        }
        ...
        compositeEncoder.k(serialDescriptor, 2, (qt.o) lazyArr[2].getValue(), bulletListContentNode.items);
    }
