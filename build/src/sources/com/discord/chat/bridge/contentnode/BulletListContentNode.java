...
public final class BulletListContentNode extends ContentNode {
    ...
    @NotNull
    private static final Lazy[] $childSerializers = {null, null, jr.l.a(jr.o.f32182e, new Function0() { // from class: com.discord.chat.bridge.contentnode.c
    ...
    public static final /* synthetic */ KSerializer _childSerializers$_anonymous_() {
        return new bt.f(new bt.f(ContentNodeSerializer.INSTANCE));
    }
    ...
    public static final /* synthetic */ void write$Self$chat_release(BulletListContentNode bulletListContentNode, CompositeEncoder compositeEncoder, SerialDescriptor serialDescriptor) {
        ...
        if (compositeEncoder.y(serialDescriptor, 0) || bulletListContentNode.start != null) {
            compositeEncoder.B(serialDescriptor, 0, z0.f7736a, bulletListContentNode.start);
        }
        if (compositeEncoder.y(serialDescriptor, 1) || bulletListContentNode.ordered) {
            compositeEncoder.w(serialDescriptor, 1, bulletListContentNode.ordered);
        }
        compositeEncoder.m(serialDescriptor, 2, (ys.o) lazyArr[2].getValue(), bulletListContentNode.items);
    }
