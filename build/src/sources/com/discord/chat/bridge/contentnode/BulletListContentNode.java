...
public final class BulletListContentNode extends ContentNode {
    ...
    @NotNull
    private static final Lazy[] $childSerializers = {null, null, ir.l.a(ir.o.f31103e, new Function0() { // from class: com.discord.chat.bridge.contentnode.c
    ...
    public static final /* synthetic */ KSerializer _childSerializers$_anonymous_() {
        return new at.f(new at.f(ContentNodeSerializer.INSTANCE));
    }
    ...
    public static final /* synthetic */ void write$Self$chat_release(BulletListContentNode bulletListContentNode, CompositeEncoder compositeEncoder, SerialDescriptor serialDescriptor) {
        ...
        if (compositeEncoder.A(serialDescriptor, 0) || bulletListContentNode.start != null) {
            compositeEncoder.z(serialDescriptor, 0, z0.f6922a, bulletListContentNode.start);
        }
        ...
        compositeEncoder.j(serialDescriptor, 2, (xs.o) lazyArr[2].getValue(), bulletListContentNode.items);
    }
