...
public final class UnderlineContentNode extends ContentNode {
    ...
    @NotNull
    private static final Lazy[] $childSerializers = {rr.l.b(rr.o.f49210e, new Function0() { // from class: com.discord.chat.bridge.contentnode.w
        @Override // kotlin.jvm.functions.Function0
        public final Object invoke() {
            KSerializer _childSerializers$_anonymous_;
            _childSerializers$_anonymous_ = UnderlineContentNode._childSerializers$_anonymous_();
    ...
    public /* synthetic */ UnderlineContentNode(int i10, List list, SerializationConstructorMarker serializationConstructorMarker) {
        super(null);
        if (1 != (i10 & 1)) {
            v1.b(i10, 1, UnderlineContentNode$$serializer.INSTANCE.getDescriptor());
        }
        this.content = list;
    }
    ...
    public boolean equals(Object obj) {
        ...
        return (obj instanceof UnderlineContentNode) && Intrinsics.areEqual(this.content, ((UnderlineContentNode) obj).content);
    }
