...
public final class StaticChannelMentionContentNode extends MentionContentNode {
    ...
    @NotNull
    private static final Lazy[] $childSerializers = {null, null, null, as.l.a(as.o.f6082e, new Function0() { // from class: com.discord.chat.bridge.contentnode.s
    ...
    public static /* synthetic */ StaticChannelMentionContentNode m377copyqphDXf8$default(StaticChannelMentionContentNode staticChannelMentionContentNode, StaticChannelMentionType staticChannelMentionType, GuildId guildId, String str, List list, int i10, Object obj) {
        ...
        return staticChannelMentionContentNode.m379copyqphDXf8(staticChannelMentionType, guildId, str, list);
    }
    ...
    public final GuildId m378component2qOKuAAo() {
        return this.guildId;
    }
    ...
    public final StaticChannelMentionContentNode m379copyqphDXf8(@NotNull StaticChannelMentionType id2, GuildId guildId, String str, @NotNull List<? extends ContentNode> content) {
    ...
    public final GuildId m380getGuildIdqOKuAAo() {
        return this.guildId;
    }
