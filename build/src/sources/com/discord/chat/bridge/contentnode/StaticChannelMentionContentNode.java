...
public final class StaticChannelMentionContentNode extends MentionContentNode {
    ...
    /* renamed from: id */
    private final StaticChannelMentionType f9667id;
    private final String itemId;
    @NotNull
    public static final Companion Companion = new Companion(null);
    @NotNull
    private static final Lazy[] $childSerializers = {null, null, null, ir.l.a(ir.o.f31119e, new Function0() { // from class: com.discord.chat.bridge.contentnode.s
    ...
    public static /* synthetic */ StaticChannelMentionContentNode m376copyqphDXf8$default(StaticChannelMentionContentNode staticChannelMentionContentNode, StaticChannelMentionType staticChannelMentionType, GuildId guildId, String str, List list, int i10, Object obj) {
        if ((i10 & 1) != 0) {
            staticChannelMentionType = staticChannelMentionContentNode.f9667id;
        }
        if ((i10 & 2) != 0) {
    ...
    public static final /* synthetic */ void write$Self$chat_release(StaticChannelMentionContentNode staticChannelMentionContentNode, CompositeEncoder compositeEncoder, SerialDescriptor serialDescriptor) {
        ...
        compositeEncoder.j(serialDescriptor, 0, StaticChannelMentionType.Serializer.INSTANCE, staticChannelMentionContentNode.f9667id);
        if (compositeEncoder.A(serialDescriptor, 1) || staticChannelMentionContentNode.guildId != null) {
            compositeEncoder.z(serialDescriptor, 1, GuildId$$serializer.INSTANCE, staticChannelMentionContentNode.guildId);
        }
        if (compositeEncoder.A(serialDescriptor, 2) || staticChannelMentionContentNode.itemId != null) {
            compositeEncoder.z(serialDescriptor, 2, n2.f6848a, staticChannelMentionContentNode.itemId);
        }
        compositeEncoder.j(serialDescriptor, 3, (xs.o) lazyArr[3].getValue(), staticChannelMentionContentNode.getContent());
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof StaticChannelMentionContentNode) {
            ...
            return this.f9667id == staticChannelMentionContentNode.f9667id && Intrinsics.areEqual(this.guildId, staticChannelMentionContentNode.guildId) && Intrinsics.areEqual(this.itemId, staticChannelMentionContentNode.itemId) && Intrinsics.areEqual(this.content, staticChannelMentionContentNode.content);
        }
        return false;
    }
    ...
    public int hashCode() {
        int hashCode = this.f9667id.hashCode() * 31;
        GuildId guildId = this.guildId;
        int m1076hashCodeimpl = (hashCode + (guildId == null ? 0 : GuildId.m1076hashCodeimpl(guildId.m1080unboximpl()))) * 31;
        String str = this.itemId;
        return ((m1076hashCodeimpl + (str != null ? str.hashCode() : 0)) * 31) + this.content.hashCode();
    }

    @NotNull
    public String toString() {
        StaticChannelMentionType staticChannelMentionType = this.f9667id;
        GuildId guildId = this.guildId;
        String str = this.itemId;
    ...
    private /* synthetic */ StaticChannelMentionContentNode(int i10, StaticChannelMentionType staticChannelMentionType, GuildId guildId, String str, List list, SerializationConstructorMarker serializationConstructorMarker) {
        ...
        this.f9667id = staticChannelMentionType;
        if ((i10 & 2) == 0) {
            this.guildId = null;
        } else {
