...
public final class StaticChannelMentionContentNode extends MentionContentNode {
    ...
    /* renamed from: id */
    private final StaticChannelMentionType f8648id;
    private final String itemId;
    @NotNull
    public static final Companion Companion = new Companion(null);
    @NotNull
    private static final Lazy[] $childSerializers = {null, null, null, or.l.b(or.o.f44232e, new Function0() { // from class: com.discord.chat.bridge.contentnode.s
    ...
    public static /* synthetic */ StaticChannelMentionContentNode m378copyqphDXf8$default(StaticChannelMentionContentNode staticChannelMentionContentNode, StaticChannelMentionType staticChannelMentionType, GuildId guildId, String str, List list, int i10, Object obj) {
        if ((i10 & 1) != 0) {
            staticChannelMentionType = staticChannelMentionContentNode.f8648id;
        }
        if ((i10 & 2) != 0) {
    ...
    public static final /* synthetic */ void write$Self$chat_release(StaticChannelMentionContentNode staticChannelMentionContentNode, CompositeEncoder compositeEncoder, SerialDescriptor serialDescriptor) {
        ...
        compositeEncoder.l(serialDescriptor, 0, StaticChannelMentionType.Serializer.INSTANCE, staticChannelMentionContentNode.f8648id);
        if (compositeEncoder.z(serialDescriptor, 1) || staticChannelMentionContentNode.guildId != null) {
            compositeEncoder.A(serialDescriptor, 1, GuildId$$serializer.INSTANCE, staticChannelMentionContentNode.guildId);
        }
        if (compositeEncoder.z(serialDescriptor, 2) || staticChannelMentionContentNode.itemId != null) {
            compositeEncoder.A(serialDescriptor, 2, n2.f25302a, staticChannelMentionContentNode.itemId);
        }
        compositeEncoder.l(serialDescriptor, 3, (dt.o) lazyArr[3].getValue(), staticChannelMentionContentNode.getContent());
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof StaticChannelMentionContentNode) {
            ...
            return this.f8648id == staticChannelMentionContentNode.f8648id && Intrinsics.areEqual(this.guildId, staticChannelMentionContentNode.guildId) && Intrinsics.areEqual(this.itemId, staticChannelMentionContentNode.itemId) && Intrinsics.areEqual(this.content, staticChannelMentionContentNode.content);
        }
        return false;
    }
    ...
    public int hashCode() {
        int hashCode = this.f8648id.hashCode() * 31;
    ...
    public String toString() {
        StaticChannelMentionType staticChannelMentionType = this.f8648id;
        GuildId guildId = this.guildId;
        String str = this.itemId;
    ...
    private /* synthetic */ StaticChannelMentionContentNode(int i10, StaticChannelMentionType staticChannelMentionType, GuildId guildId, String str, List list, SerializationConstructorMarker serializationConstructorMarker) {
        ...
        this.f8648id = staticChannelMentionType;
        if ((i10 & 2) == 0) {
            this.guildId = null;
        } else {
