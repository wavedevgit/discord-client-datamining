...
public final class StaticChannelMentionContentNode extends MentionContentNode {
    ...
    /* renamed from: id */
    private final StaticChannelMentionType f8687id;
    private final String itemId;
    @NotNull
    public static final Companion Companion = new Companion(null);
    @NotNull
    private static final Lazy[] $childSerializers = {null, null, null, rr.l.b(rr.o.f49210e, new Function0() { // from class: com.discord.chat.bridge.contentnode.s
    ...
    public static /* synthetic */ StaticChannelMentionContentNode m376copyqphDXf8$default(StaticChannelMentionContentNode staticChannelMentionContentNode, StaticChannelMentionType staticChannelMentionType, GuildId guildId, String str, List list, int i10, Object obj) {
        if ((i10 & 1) != 0) {
            staticChannelMentionType = staticChannelMentionContentNode.f8687id;
        }
        if ((i10 & 2) != 0) {
        ...
        return staticChannelMentionContentNode.m378copyqphDXf8(staticChannelMentionType, guildId, str, list);
    }
    ...
    public static final /* synthetic */ void write$Self$chat_release(StaticChannelMentionContentNode staticChannelMentionContentNode, CompositeEncoder compositeEncoder, SerialDescriptor serialDescriptor) {
        ...
        compositeEncoder.F(serialDescriptor, 0, StaticChannelMentionType.Serializer.INSTANCE, staticChannelMentionContentNode.f8687id);
        if (compositeEncoder.z(serialDescriptor, 1) || staticChannelMentionContentNode.guildId != null) {
            compositeEncoder.i(serialDescriptor, 1, GuildId$$serializer.INSTANCE, staticChannelMentionContentNode.guildId);
        }
        if (compositeEncoder.z(serialDescriptor, 2) || staticChannelMentionContentNode.itemId != null) {
            compositeEncoder.i(serialDescriptor, 2, n2.f35181a, staticChannelMentionContentNode.itemId);
        }
        compositeEncoder.F(serialDescriptor, 3, (gt.o) lazyArr[3].getValue(), staticChannelMentionContentNode.getContent());
    }
    ...
    public final GuildId m377component2qOKuAAo() {
        return this.guildId;
    }
    ...
    public final StaticChannelMentionContentNode m378copyqphDXf8(@NotNull StaticChannelMentionType id2, GuildId guildId, String str, @NotNull List<? extends ContentNode> content) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof StaticChannelMentionContentNode) {
            ...
            return this.f8687id == staticChannelMentionContentNode.f8687id && Intrinsics.areEqual(this.guildId, staticChannelMentionContentNode.guildId) && Intrinsics.areEqual(this.itemId, staticChannelMentionContentNode.itemId) && Intrinsics.areEqual(this.content, staticChannelMentionContentNode.content);
        }
        return false;
    }
    ...
    public final GuildId m379getGuildIdqOKuAAo() {
        return this.guildId;
    }
    ...
    public int hashCode() {
        int hashCode = this.f8687id.hashCode() * 31;
        GuildId guildId = this.guildId;
        int m1075hashCodeimpl = (hashCode + (guildId == null ? 0 : GuildId.m1075hashCodeimpl(guildId.m1079unboximpl()))) * 31;
        String str = this.itemId;
        return ((m1075hashCodeimpl + (str != null ? str.hashCode() : 0)) * 31) + this.content.hashCode();
    }

    @NotNull
    public String toString() {
        StaticChannelMentionType staticChannelMentionType = this.f8687id;
        GuildId guildId = this.guildId;
        String str = this.itemId;
    ...
    private /* synthetic */ StaticChannelMentionContentNode(int i10, StaticChannelMentionType staticChannelMentionType, GuildId guildId, String str, List list, SerializationConstructorMarker serializationConstructorMarker) {
        ...
        this.f8687id = staticChannelMentionType;
        if ((i10 & 2) == 0) {
            this.guildId = null;
        } else {
