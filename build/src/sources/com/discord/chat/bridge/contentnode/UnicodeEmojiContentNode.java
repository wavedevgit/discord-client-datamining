...
public final class UnicodeEmojiContentNode extends EmojiContentNode {
    ...
    public static final /* synthetic */ void write$Self$chat_release(UnicodeEmojiContentNode unicodeEmojiContentNode, CompositeEncoder compositeEncoder, SerialDescriptor serialDescriptor) {
        ...
        compositeEncoder.y(serialDescriptor, 0, unicodeEmojiContentNode.content);
        compositeEncoder.y(serialDescriptor, 1, unicodeEmojiContentNode.surrogate);
        if (compositeEncoder.z(serialDescriptor, 2) || unicodeEmojiContentNode.getJumboable()) {
            compositeEncoder.x(serialDescriptor, 2, unicodeEmojiContentNode.getJumboable());
        }
    }
