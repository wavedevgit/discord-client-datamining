...
public final class UnicodeEmojiContentNode extends EmojiContentNode {
    ...
    public static final /* synthetic */ void write$Self$chat_release(UnicodeEmojiContentNode unicodeEmojiContentNode, CompositeEncoder compositeEncoder, SerialDescriptor serialDescriptor) {
        ...
        compositeEncoder.x(serialDescriptor, 0, unicodeEmojiContentNode.content);
        compositeEncoder.x(serialDescriptor, 1, unicodeEmojiContentNode.surrogate);
        if (compositeEncoder.y(serialDescriptor, 2) || unicodeEmojiContentNode.getJumboable()) {
            compositeEncoder.w(serialDescriptor, 2, unicodeEmojiContentNode.getJumboable());
        }
    }
