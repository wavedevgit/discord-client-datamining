...
public final class SpoilerContentNode extends ContentNode implements SpoilerableData {
    ...
    @NotNull
    private static final Lazy[] $childSerializers = {jr.l.a(jr.o.f32182e, new Function0() { // from class: com.discord.chat.bridge.contentnode.r
    ...
    public static final /* synthetic */ void write$Self$chat_release(SpoilerContentNode spoilerContentNode, CompositeEncoder compositeEncoder, SerialDescriptor serialDescriptor) {
        compositeEncoder.m(serialDescriptor, 0, (ys.o) $childSerializers[0].getValue(), spoilerContentNode.content);
        if (compositeEncoder.y(serialDescriptor, 1) || !Intrinsics.areEqual(spoilerContentNode.getSpoilerOrNull(), "")) {
            compositeEncoder.x(serialDescriptor, 1, spoilerContentNode.getSpoilerOrNull());
        }
        if (compositeEncoder.y(serialDescriptor, 2) || !Intrinsics.areEqual(spoilerContentNode.getObscureOrNull(), "")) {
            compositeEncoder.x(serialDescriptor, 2, spoilerContentNode.getObscureOrNull());
        }
    }
