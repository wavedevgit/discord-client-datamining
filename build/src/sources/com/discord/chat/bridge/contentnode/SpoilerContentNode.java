...
public final class SpoilerContentNode extends ContentNode implements SpoilerableData {
    ...
    @NotNull
    private static final Lazy[] $childSerializers = {or.l.b(or.o.f44232e, new Function0() { // from class: com.discord.chat.bridge.contentnode.r
    ...
    public static final /* synthetic */ void write$Self$chat_release(SpoilerContentNode spoilerContentNode, CompositeEncoder compositeEncoder, SerialDescriptor serialDescriptor) {
        compositeEncoder.l(serialDescriptor, 0, (dt.o) $childSerializers[0].getValue(), spoilerContentNode.content);
        if (compositeEncoder.z(serialDescriptor, 1) || !Intrinsics.areEqual(spoilerContentNode.getSpoilerOrNull(), "")) {
            compositeEncoder.x(serialDescriptor, 1, spoilerContentNode.getSpoilerOrNull());
        }
        if (compositeEncoder.z(serialDescriptor, 2) || !Intrinsics.areEqual(spoilerContentNode.getObscureOrNull(), "")) {
