...
public final class CommandMentionContentNode extends MentionContentNode {
    ...
    @NotNull
    private static final Lazy[] $childSerializers = {null, null, null, null, rr.l.b(rr.o.f49210e, new Function0() { // from class: com.discord.chat.bridge.contentnode.g
    ...
    public static final /* synthetic */ void write$Self$chat_release(CommandMentionContentNode commandMentionContentNode, CompositeEncoder compositeEncoder, SerialDescriptor serialDescriptor) {
        ...
        compositeEncoder.F(serialDescriptor, 0, ChannelId$$serializer.INSTANCE, ChannelId.m1057boximpl(commandMentionContentNode.channelId));
        ...
        compositeEncoder.F(serialDescriptor, 4, (gt.o) lazyArr[4].getValue(), commandMentionContentNode.getContent());
    }
