...
public final class CommandMentionContentNode extends MentionContentNode {
    ...
    @NotNull
    private static final Lazy[] $childSerializers = {null, null, null, null, as.l.a(as.o.f6082e, new Function0() { // from class: com.discord.chat.bridge.contentnode.g
    ...
    public static /* synthetic */ CommandMentionContentNode m293copyJrbBJuM$default(CommandMentionContentNode commandMentionContentNode, long j10, String str, String str2, String str3, List list, int i10, Object obj) {
        if ((i10 & 1) != 0) {
        ...
        return commandMentionContentNode.m295copyJrbBJuM(j11, str4, str5, str6, list2);
    }
    ...
    public static final /* synthetic */ void write$Self$chat_release(CommandMentionContentNode commandMentionContentNode, CompositeEncoder compositeEncoder, SerialDescriptor serialDescriptor) {
        ...
        compositeEncoder.k(serialDescriptor, 0, ChannelId$$serializer.INSTANCE, ChannelId.m1058boximpl(commandMentionContentNode.channelId));
        ...
        compositeEncoder.k(serialDescriptor, 4, (qt.o) lazyArr[4].getValue(), commandMentionContentNode.getContent());
    }

    /* renamed from: component1-o4g7jtM  reason: not valid java name */
    public final long m294component1o4g7jtM() {
    ...
    public final CommandMentionContentNode m295copyJrbBJuM(long j10, @NotNull String commandId, @NotNull String commandName, @NotNull String commandKey, @NotNull List<? extends ContentNode> content) {
    ...
    public final long m296getChannelIdo4g7jtM() {
        return this.channelId;
    }
