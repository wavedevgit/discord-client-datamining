...
public final class CommandMentionContentNode extends MentionContentNode {
    ...
    @NotNull
    private static final Lazy[] $childSerializers = {null, null, null, null, jr.l.a(jr.o.f32182e, new Function0() { // from class: com.discord.chat.bridge.contentnode.g
    ...
    public static final /* synthetic */ void write$Self$chat_release(CommandMentionContentNode commandMentionContentNode, CompositeEncoder compositeEncoder, SerialDescriptor serialDescriptor) {
        ...
        compositeEncoder.m(serialDescriptor, 0, ChannelId$$serializer.INSTANCE, ChannelId.m1060boximpl(commandMentionContentNode.channelId));
        ...
        compositeEncoder.m(serialDescriptor, 4, (ys.o) lazyArr[4].getValue(), commandMentionContentNode.getContent());
    }
    ...
    public int hashCode() {
        return (((((((ChannelId.m1065hashCodeimpl(this.channelId) * 31) + this.commandId.hashCode()) * 31) + this.commandName.hashCode()) * 31) + this.commandKey.hashCode()) * 31) + this.content.hashCode();
    }
    ...
    public String toString() {
        ...
        return "CommandMentionContentNode(channelId=" + m1067toStringimpl + ", commandId=" + str + ", commandName=" + str2 + ", commandKey=" + str3 + ", content=" + list + ")";
    }
