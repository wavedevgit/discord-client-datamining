...
public final class CommandMentionContentNode extends MentionContentNode {
    ...
    @NotNull
    private static final Lazy[] $childSerializers = {null, null, null, null, ir.l.a(ir.o.f31103e, new Function0() { // from class: com.discord.chat.bridge.contentnode.g
    ...
    public static final /* synthetic */ void write$Self$chat_release(CommandMentionContentNode commandMentionContentNode, CompositeEncoder compositeEncoder, SerialDescriptor serialDescriptor) {
        ...
        compositeEncoder.j(serialDescriptor, 0, ChannelId$$serializer.INSTANCE, ChannelId.m1058boximpl(commandMentionContentNode.channelId));
        compositeEncoder.y(serialDescriptor, 1, commandMentionContentNode.commandId);
        compositeEncoder.y(serialDescriptor, 2, commandMentionContentNode.commandName);
        compositeEncoder.y(serialDescriptor, 3, commandMentionContentNode.commandKey);
        compositeEncoder.j(serialDescriptor, 4, (xs.o) lazyArr[4].getValue(), commandMentionContentNode.getContent());
    }
    ...
    public int hashCode() {
        return (((((((ChannelId.m1063hashCodeimpl(this.channelId) * 31) + this.commandId.hashCode()) * 31) + this.commandName.hashCode()) * 31) + this.commandKey.hashCode()) * 31) + this.content.hashCode();
    }
    ...
    public String toString() {
        ...
        return "CommandMentionContentNode(channelId=" + m1065toStringimpl + ", commandId=" + str + ", commandName=" + str2 + ", commandKey=" + str3 + ", content=" + list + ")";
    }
