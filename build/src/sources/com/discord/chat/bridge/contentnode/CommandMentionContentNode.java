...
public final class CommandMentionContentNode extends MentionContentNode {
    ...
    @NotNull
    private static final Lazy[] $childSerializers = {null, null, null, null, qr.l.b(qr.o.f48092e, new Function0() { // from class: com.discord.chat.bridge.contentnode.g
    ...
    public static /* synthetic */ CommandMentionContentNode m292copyJrbBJuM$default(CommandMentionContentNode commandMentionContentNode, long j10, String str, String str2, String str3, List list, int i10, Object obj) {
        if ((i10 & 1) != 0) {
        ...
        return commandMentionContentNode.m294copyJrbBJuM(j11, str4, str5, str6, list2);
    }
    ...
    public static final /* synthetic */ void write$Self$chat_release(CommandMentionContentNode commandMentionContentNode, CompositeEncoder compositeEncoder, SerialDescriptor serialDescriptor) {
        ...
        compositeEncoder.s(serialDescriptor, 0, ChannelId$$serializer.INSTANCE, ChannelId.m1057boximpl(commandMentionContentNode.channelId));
        compositeEncoder.z(serialDescriptor, 1, commandMentionContentNode.commandId);
        compositeEncoder.z(serialDescriptor, 2, commandMentionContentNode.commandName);
        compositeEncoder.z(serialDescriptor, 3, commandMentionContentNode.commandKey);
        compositeEncoder.s(serialDescriptor, 4, (ft.o) lazyArr[4].getValue(), commandMentionContentNode.getContent());
    }

    /* renamed from: component1-o4g7jtM  reason: not valid java name */
    public final long m293component1o4g7jtM() {
    ...
    public final CommandMentionContentNode m294copyJrbBJuM(long j10, @NotNull String commandId, @NotNull String commandName, @NotNull String commandKey, @NotNull List<? extends ContentNode> content) {
    ...
    public int hashCode() {
        return (((((((ChannelId.m1062hashCodeimpl(this.channelId) * 31) + this.commandId.hashCode()) * 31) + this.commandName.hashCode()) * 31) + this.commandKey.hashCode()) * 31) + this.content.hashCode();
    }
    ...
    public String toString() {
        ...
        return "CommandMentionContentNode(channelId=" + m1064toStringimpl + ", commandId=" + str + ", commandName=" + str2 + ", commandKey=" + str3 + ", content=" + list + ")";
    }
