...
public final class CustomEmojiContentNode extends EmojiContentNode {
    ...
    public static /* synthetic */ CustomEmojiContentNode copy$default(CustomEmojiContentNode customEmojiContentNode, long j10, String str, String str2, String str3, boolean z10, int i10, Object obj) {
        if ((i10 & 1) != 0) {
            j10 = customEmojiContentNode.f8684id;
        }
        long j11 = j10;
        if ((i10 & 2) != 0) {
    ...
    public static final /* synthetic */ void write$Self$chat_release(CustomEmojiContentNode customEmojiContentNode, CompositeEncoder compositeEncoder, SerialDescriptor serialDescriptor) {
        ...
        compositeEncoder.D(serialDescriptor, 0, customEmojiContentNode.f8684id);
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof CustomEmojiContentNode) {
            ...
            return this.f8684id == customEmojiContentNode.f8684id && Intrinsics.areEqual(this.alt, customEmojiContentNode.alt) && Intrinsics.areEqual(this.src, customEmojiContentNode.src) && Intrinsics.areEqual(this.frozenSrc, customEmojiContentNode.frozenSrc) && this.jumboable == customEmojiContentNode.jumboable;
        }
        return false;
    }
    ...
    public int hashCode() {
        return (((((((Long.hashCode(this.f8684id) * 31) + this.alt.hashCode()) * 31) + this.src.hashCode()) * 31) + this.frozenSrc.hashCode()) * 31) + Boolean.hashCode(this.jumboable);
    }

    @NotNull
    public String toString() {
        long j10 = this.f8684id;
        String str = this.alt;
