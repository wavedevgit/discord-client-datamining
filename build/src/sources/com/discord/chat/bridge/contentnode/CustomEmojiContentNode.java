...
public final class CustomEmojiContentNode extends EmojiContentNode {
    ...
    public static /* synthetic */ CustomEmojiContentNode copy$default(CustomEmojiContentNode customEmojiContentNode, long j10, String str, String str2, String str3, boolean z10, int i10, Object obj) {
        if ((i10 & 1) != 0) {
            j10 = customEmojiContentNode.f8544id;
        }
        long j11 = j10;
        if ((i10 & 2) != 0) {
        ...
        String str6 = str3;
        if ((i10 & 16) != 0) {
            z10 = customEmojiContentNode.jumboable;
        }
        return customEmojiContentNode.copy(j11, str4, str5, str6, z10);
    }
    ...
    public static final /* synthetic */ void write$Self$chat_release(CustomEmojiContentNode customEmojiContentNode, CompositeEncoder compositeEncoder, SerialDescriptor serialDescriptor) {
        ...
        compositeEncoder.E(serialDescriptor, 0, customEmojiContentNode.f8544id);
        compositeEncoder.z(serialDescriptor, 1, customEmojiContentNode.alt);
        compositeEncoder.z(serialDescriptor, 2, customEmojiContentNode.src);
        compositeEncoder.z(serialDescriptor, 3, customEmojiContentNode.frozenSrc);
        if (compositeEncoder.A(serialDescriptor, 4) || customEmojiContentNode.getJumboable()) {
            compositeEncoder.y(serialDescriptor, 4, customEmojiContentNode.getJumboable());
        }
    }
    ...
    @NotNull
    public final CustomEmojiContentNode copy(long j10, @NotNull String alt, @NotNull String src, @NotNull String frozenSrc, boolean z10) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof CustomEmojiContentNode) {
            ...
            return this.f8544id == customEmojiContentNode.f8544id && Intrinsics.areEqual(this.alt, customEmojiContentNode.alt) && Intrinsics.areEqual(this.src, customEmojiContentNode.src) && Intrinsics.areEqual(this.frozenSrc, customEmojiContentNode.frozenSrc) && this.jumboable == customEmojiContentNode.jumboable;
        }
        return false;
    }
    ...
    public int hashCode() {
        return (((((((Long.hashCode(this.f8544id) * 31) + this.alt.hashCode()) * 31) + this.src.hashCode()) * 31) + this.frozenSrc.hashCode()) * 31) + Boolean.hashCode(this.jumboable);
    }

    @NotNull
    public String toString() {
        long j10 = this.f8544id;
        String str = this.alt;
        String str2 = this.src;
        String str3 = this.frozenSrc;
        boolean z10 = this.jumboable;
        return "CustomEmojiContentNode(id=" + j10 + ", alt=" + str + ", src=" + str2 + ", frozenSrc=" + str3 + ", jumboable=" + z10 + ")";
    }
    ...
    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public CustomEmojiContentNode(long j10, @NotNull String alt, @NotNull String src, @NotNull String frozenSrc, boolean z10) {
        super(null);
        Intrinsics.checkNotNullParameter(alt, "alt");
        Intrinsics.checkNotNullParameter(src, "src");
        Intrinsics.checkNotNullParameter(frozenSrc, "frozenSrc");
