...
public final class GameMentionContentNode extends MentionContentNode {
    ...
    @NotNull
    private static final Lazy[] $childSerializers = {null, null, null, as.l.a(as.o.f6082e, new Function0() { // from class: com.discord.chat.bridge.contentnode.j
    ...
    public static /* synthetic */ GameMentionContentNode m297copyEs9QsQ$default(GameMentionContentNode gameMentionContentNode, long j10, String str, String str2, List list, int i10, Object obj) {
        if ((i10 & 1) != 0) {
        ...
        return gameMentionContentNode.m299copyEs9QsQ(j11, str3, str4, list2);
    }
    ...
    public static final /* synthetic */ void write$Self$chat_release(GameMentionContentNode gameMentionContentNode, CompositeEncoder compositeEncoder, SerialDescriptor serialDescriptor) {
        ...
        if (compositeEncoder.z(serialDescriptor, 1) || gameMentionContentNode.icon != null) {
            compositeEncoder.o(serialDescriptor, 1, n2.f50601a, gameMentionContentNode.icon);
        }
    ...
    public final long m298component1o4g7jtM() {
    ...
    public final GameMentionContentNode m299copyEs9QsQ(long j10, String str, @NotNull String applicationId, @NotNull List<? extends ContentNode> content) {
    ...
    public final long m300getChannelIdo4g7jtM() {
        return this.channelId;
    }
