...
public final class GameMentionContentNode extends MentionContentNode {
    ...
    @NotNull
    private static final Lazy[] $childSerializers = {null, null, null, jr.l.a(jr.o.f32182e, new Function0() { // from class: com.discord.chat.bridge.contentnode.j
    ...
    public static final /* synthetic */ void write$Self$chat_release(GameMentionContentNode gameMentionContentNode, CompositeEncoder compositeEncoder, SerialDescriptor serialDescriptor) {
        ...
        compositeEncoder.m(serialDescriptor, 0, ChannelId$$serializer.INSTANCE, ChannelId.m1060boximpl(gameMentionContentNode.channelId));
        if (compositeEncoder.y(serialDescriptor, 1) || gameMentionContentNode.icon != null) {
            compositeEncoder.B(serialDescriptor, 1, n2.f7662a, gameMentionContentNode.icon);
        }
        compositeEncoder.x(serialDescriptor, 2, gameMentionContentNode.applicationId);
        compositeEncoder.m(serialDescriptor, 3, (ys.o) lazyArr[3].getValue(), gameMentionContentNode.getContent());
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof GameMentionContentNode) {
            ...
            return ChannelId.m1064equalsimpl0(this.channelId, gameMentionContentNode.channelId) && Intrinsics.areEqual(this.icon, gameMentionContentNode.icon) && Intrinsics.areEqual(this.applicationId, gameMentionContentNode.applicationId) && Intrinsics.areEqual(this.content, gameMentionContentNode.content);
        }
        return false;
    }
    ...
    public int hashCode() {
        ...
        return ((((m1065hashCodeimpl + (str == null ? 0 : str.hashCode())) * 31) + this.applicationId.hashCode()) * 31) + this.content.hashCode();
    }
    ...
    public String toString() {
        ...
        return "GameMentionContentNode(channelId=" + m1067toStringimpl + ", icon=" + str + ", applicationId=" + str2 + ", content=" + list + ")";
    }
