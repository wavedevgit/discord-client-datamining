...
public final class GameMentionContentNode extends MentionContentNode {
    ...
    @NotNull
    private static final Lazy[] $childSerializers = {null, null, null, ir.l.a(ir.o.f31103e, new Function0() { // from class: com.discord.chat.bridge.contentnode.j
    ...
    public static final /* synthetic */ void write$Self$chat_release(GameMentionContentNode gameMentionContentNode, CompositeEncoder compositeEncoder, SerialDescriptor serialDescriptor) {
        ...
        compositeEncoder.j(serialDescriptor, 0, ChannelId$$serializer.INSTANCE, ChannelId.m1058boximpl(gameMentionContentNode.channelId));
        if (compositeEncoder.A(serialDescriptor, 1) || gameMentionContentNode.icon != null) {
            compositeEncoder.z(serialDescriptor, 1, n2.f6848a, gameMentionContentNode.icon);
        }
        compositeEncoder.y(serialDescriptor, 2, gameMentionContentNode.applicationId);
        compositeEncoder.j(serialDescriptor, 3, (xs.o) lazyArr[3].getValue(), gameMentionContentNode.getContent());
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof GameMentionContentNode) {
            ...
            return ChannelId.m1062equalsimpl0(this.channelId, gameMentionContentNode.channelId) && Intrinsics.areEqual(this.icon, gameMentionContentNode.icon) && Intrinsics.areEqual(this.applicationId, gameMentionContentNode.applicationId) && Intrinsics.areEqual(this.content, gameMentionContentNode.content);
        }
        return false;
    }
    ...
    public int hashCode() {
        ...
        return ((((m1063hashCodeimpl + (str == null ? 0 : str.hashCode())) * 31) + this.applicationId.hashCode()) * 31) + this.content.hashCode();
    }
    ...
    public String toString() {
        ...
        return "GameMentionContentNode(channelId=" + m1065toStringimpl + ", icon=" + str + ", applicationId=" + str2 + ", content=" + list + ")";
    }
