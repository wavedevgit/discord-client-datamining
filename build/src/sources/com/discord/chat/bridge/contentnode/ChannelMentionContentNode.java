...
public final class ChannelMentionContentNode extends MentionContentNode {
    ...
    static {
        ...
        $childSerializers = new Lazy[]{null, null, null, null, as.l.a(oVar, new Function0() { // from class: com.discord.chat.bridge.contentnode.d
        ...
        }), as.l.a(oVar, new Function0() { // from class: com.discord.chat.bridge.contentnode.e
            @Override // kotlin.jvm.functions.Function0
            public final Object invoke() {
    ...
    public static final /* synthetic */ void write$Self$chat_release(ChannelMentionContentNode channelMentionContentNode, CompositeEncoder compositeEncoder, SerialDescriptor serialDescriptor) {
        ...
        if (compositeEncoder.z(serialDescriptor, 1) || channelMentionContentNode.guildId != null) {
            compositeEncoder.o(serialDescriptor, 1, n2.f50032a, channelMentionContentNode.guildId);
        }
        if (compositeEncoder.z(serialDescriptor, 2) || channelMentionContentNode.messageId != null) {
            compositeEncoder.o(serialDescriptor, 2, n2.f50032a, channelMentionContentNode.messageId);
        }
        if (compositeEncoder.z(serialDescriptor, 3) || channelMentionContentNode.originalLink != null) {
            compositeEncoder.o(serialDescriptor, 3, n2.f50032a, channelMentionContentNode.originalLink);
        }
        ...
        compositeEncoder.o(serialDescriptor, 5, (qt.o) lazyArr[5].getValue(), channelMentionContentNode.getContent());
    }
