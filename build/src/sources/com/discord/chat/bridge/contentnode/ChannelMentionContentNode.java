...
public final class ChannelMentionContentNode extends MentionContentNode {
    ...
    static {
        ...
        $childSerializers = new Lazy[]{null, null, null, null, rr.l.b(oVar, new Function0() { // from class: com.discord.chat.bridge.contentnode.d
        ...
        }), rr.l.b(oVar, new Function0() { // from class: com.discord.chat.bridge.contentnode.e
            @Override // kotlin.jvm.functions.Function0
            public final Object invoke() {
    ...
    public static final /* synthetic */ void write$Self$chat_release(ChannelMentionContentNode channelMentionContentNode, CompositeEncoder compositeEncoder, SerialDescriptor serialDescriptor) {
        ...
        if (compositeEncoder.z(serialDescriptor, 1) || channelMentionContentNode.guildId != null) {
            compositeEncoder.i(serialDescriptor, 1, n2.f35181a, channelMentionContentNode.guildId);
        }
        if (compositeEncoder.z(serialDescriptor, 2) || channelMentionContentNode.messageId != null) {
            compositeEncoder.i(serialDescriptor, 2, n2.f35181a, channelMentionContentNode.messageId);
        }
        if (compositeEncoder.z(serialDescriptor, 3) || channelMentionContentNode.originalLink != null) {
            compositeEncoder.i(serialDescriptor, 3, n2.f35181a, channelMentionContentNode.originalLink);
        }
        if (compositeEncoder.z(serialDescriptor, 4) || channelMentionContentNode.inContent != null) {
            compositeEncoder.i(serialDescriptor, 4, (gt.o) lazyArr[4].getValue(), channelMentionContentNode.inContent);
        }
        compositeEncoder.i(serialDescriptor, 5, (gt.o) lazyArr[5].getValue(), channelMentionContentNode.getContent());
    }
