...
public final class ChannelMentionContentNode extends MentionContentNode {
    ...
    static {
        ...
        $childSerializers = new Lazy[]{null, null, null, null, or.l.b(oVar, new Function0() { // from class: com.discord.chat.bridge.contentnode.d
        ...
        }), or.l.b(oVar, new Function0() { // from class: com.discord.chat.bridge.contentnode.e
            @Override // kotlin.jvm.functions.Function0
            public final Object invoke() {
    ...
    public static final /* synthetic */ void write$Self$chat_release(ChannelMentionContentNode channelMentionContentNode, CompositeEncoder compositeEncoder, SerialDescriptor serialDescriptor) {
        ...
        if (compositeEncoder.z(serialDescriptor, 1) || channelMentionContentNode.guildId != null) {
            compositeEncoder.A(serialDescriptor, 1, n2.f25302a, channelMentionContentNode.guildId);
        }
        if (compositeEncoder.z(serialDescriptor, 2) || channelMentionContentNode.messageId != null) {
            compositeEncoder.A(serialDescriptor, 2, n2.f25302a, channelMentionContentNode.messageId);
        }
        if (compositeEncoder.z(serialDescriptor, 3) || channelMentionContentNode.originalLink != null) {
            compositeEncoder.A(serialDescriptor, 3, n2.f25302a, channelMentionContentNode.originalLink);
        }
        if (compositeEncoder.z(serialDescriptor, 4) || channelMentionContentNode.inContent != null) {
            compositeEncoder.A(serialDescriptor, 4, (dt.o) lazyArr[4].getValue(), channelMentionContentNode.inContent);
        }
        compositeEncoder.A(serialDescriptor, 5, (dt.o) lazyArr[5].getValue(), channelMentionContentNode.getContent());
    }
