...
public final class ContentNodeSerializer implements KSerializer {
    ...
    public SerialDescriptor getDescriptor() {
        return st.j.b("ContentNode", e.i.f48368a);
    }
    ...
    public ContentNode deserialize(@NotNull Decoder decoder) {
        ...
        try {
            if (decoder instanceof ut.f) {
                JsonElement g10 = ((ut.f) decoder).g();
                if (g10 instanceof JsonPrimitive) {
                    return new TextContentNode(((JsonPrimitive) g10).b());
                }
                return (ContentNode) ((ut.f) decoder).d().d(ContentNodeKt.access$getSealedClassSerializer$p(), g10);
            }
