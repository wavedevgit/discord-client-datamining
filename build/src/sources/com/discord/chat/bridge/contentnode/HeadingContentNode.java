...
public final class HeadingContentNode extends ContentNode {
    ...
    @NotNull
    private static final Lazy[] $childSerializers = {null, rr.l.b(rr.o.f49210e, new Function0() { // from class: com.discord.chat.bridge.contentnode.k
    ...
    public static final /* synthetic */ void write$Self$chat_release(HeadingContentNode headingContentNode, CompositeEncoder compositeEncoder, SerialDescriptor serialDescriptor) {
        ...
        compositeEncoder.F(serialDescriptor, 1, (gt.o) lazyArr[1].getValue(), headingContentNode.content);
    }
