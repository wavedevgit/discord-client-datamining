...
public final class HeadingContentNode extends ContentNode {
    ...
    @NotNull
    private static final Lazy[] $childSerializers = {null, or.l.b(or.o.f44232e, new Function0() { // from class: com.discord.chat.bridge.contentnode.k
    ...
    public static final /* synthetic */ void write$Self$chat_release(HeadingContentNode headingContentNode, CompositeEncoder compositeEncoder, SerialDescriptor serialDescriptor) {
        ...
        compositeEncoder.v(serialDescriptor, 0, headingContentNode.level);
        compositeEncoder.l(serialDescriptor, 1, (dt.o) lazyArr[1].getValue(), headingContentNode.content);
    }
