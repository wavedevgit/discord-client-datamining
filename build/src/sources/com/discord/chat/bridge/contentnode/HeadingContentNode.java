...
public final class HeadingContentNode extends ContentNode {
    ...
    @NotNull
    private static final Lazy[] $childSerializers = {null, as.l.a(as.o.f6082e, new Function0() { // from class: com.discord.chat.bridge.contentnode.k
    ...
    public static final /* synthetic */ void write$Self$chat_release(HeadingContentNode headingContentNode, CompositeEncoder compositeEncoder, SerialDescriptor serialDescriptor) {
        ...
        compositeEncoder.k(serialDescriptor, 1, (qt.o) lazyArr[1].getValue(), headingContentNode.content);
    }
