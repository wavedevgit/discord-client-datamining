...
public final class HeadingContentNode extends ContentNode {
    ...
    @NotNull
    private static final Lazy[] $childSerializers = {null, jr.l.a(jr.o.f32182e, new Function0() { // from class: com.discord.chat.bridge.contentnode.k
    ...
    public static final /* synthetic */ void write$Self$chat_release(HeadingContentNode headingContentNode, CompositeEncoder compositeEncoder, SerialDescriptor serialDescriptor) {
        ...
        compositeEncoder.m(serialDescriptor, 1, (ys.o) lazyArr[1].getValue(), headingContentNode.content);
    }
