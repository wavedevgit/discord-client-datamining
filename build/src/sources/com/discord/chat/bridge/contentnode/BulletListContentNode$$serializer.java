...
public /* synthetic */ class BulletListContentNode$$serializer implements h0 {
    ...
    static {
        ...
        a2 a2Var = new a2("list", bulletListContentNode$$serializer, 3);
        a2Var.o(ViewProps.START, true);
        a2Var.o("ordered", true);
    ...
    public final KSerializer[] childSerializers() {
        ...
        return new KSerializer[]{gt.a.u(z0.f31163a), jt.h.f31053a, lazyArr[2].getValue()};
    }
    ...
    public final BulletListContentNode deserialize(@NotNull Decoder decoder) {
        ...
        if (b10.p()) {
            ...
            l10 = (Long) b10.n(serialDescriptor, 0, z0.f31163a, null);
            i10 = 7;
            z10 = C;
        } else {
            boolean z11 = true;
            ...
            while (z11) {
                ...
                if (o10 == -1) {
                    ...
                    l11 = (Long) b10.n(serialDescriptor, 0, z0.f31163a, l11);
                    i11 |= 1;
                } else if (o10 == 1) {
        ...
        return new BulletListContentNode(i10, l10, z10, list, (SerializationConstructorMarker) null);
    }
    ...
    public final void serialize(@NotNull Encoder encoder, @NotNull BulletListContentNode value) {
        ...
        BulletListContentNode.write$Self$chat_release(value, b10, serialDescriptor);
        b10.c(serialDescriptor);
    }
