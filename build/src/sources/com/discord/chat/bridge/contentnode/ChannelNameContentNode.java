...
public final class ChannelNameContentNode extends ContentNode {
    ...
    @NotNull
    private static final Lazy[] $childSerializers = {null, null, null, jr.l.a(jr.o.f32182e, new Function0() { // from class: com.discord.chat.bridge.contentnode.f
    ...
    public static final /* synthetic */ void write$Self$chat_release(ChannelNameContentNode channelNameContentNode, CompositeEncoder compositeEncoder, SerialDescriptor serialDescriptor) {
        ...
        if (compositeEncoder.y(serialDescriptor, 0) || channelNameContentNode.channelType != null) {
            compositeEncoder.B(serialDescriptor, 0, ChannelType.Serializer.INSTANCE, channelNameContentNode.channelType);
        }
        compositeEncoder.x(serialDescriptor, 1, channelNameContentNode.iconType);
        if (compositeEncoder.y(serialDescriptor, 2) || channelNameContentNode.icon != null) {
            compositeEncoder.B(serialDescriptor, 2, n2.f7662a, channelNameContentNode.icon);
        }
        compositeEncoder.m(serialDescriptor, 3, (ys.o) lazyArr[3].getValue(), channelNameContentNode.content);
    }
