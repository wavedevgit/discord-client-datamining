...
public final class ChannelNameContentNode extends ContentNode {
    ...
    @NotNull
    private static final Lazy[] $childSerializers = {null, null, null, rr.l.b(rr.o.f49210e, new Function0() { // from class: com.discord.chat.bridge.contentnode.f
    ...
    public static final /* synthetic */ void write$Self$chat_release(ChannelNameContentNode channelNameContentNode, CompositeEncoder compositeEncoder, SerialDescriptor serialDescriptor) {
        ...
        if (compositeEncoder.z(serialDescriptor, 0) || channelNameContentNode.channelType != null) {
            compositeEncoder.i(serialDescriptor, 0, ChannelType.Serializer.INSTANCE, channelNameContentNode.channelType);
        }
        ...
        if (compositeEncoder.z(serialDescriptor, 2) || channelNameContentNode.icon != null) {
            compositeEncoder.i(serialDescriptor, 2, n2.f35181a, channelNameContentNode.icon);
        }
        compositeEncoder.F(serialDescriptor, 3, (gt.o) lazyArr[3].getValue(), channelNameContentNode.content);
    }
