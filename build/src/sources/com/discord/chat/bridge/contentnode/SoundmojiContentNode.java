...
public final class SoundmojiContentNode extends ContentNode {
    ...
    public static /* synthetic */ SoundmojiContentNode m371copyFdtyiUI$default(SoundmojiContentNode soundmojiContentNode, String str, long j10, String str2, String str3, String str4, boolean z10, String str5, String str6, int i10, Object obj) {
        if ((i10 & 1) != 0) {
        ...
        String str7 = str5;
        String str8 = str6;
        return soundmojiContentNode.m374copyFdtyiUI(str, j10, str2, str3, str4, z10, str7, str8);
    }
    ...
    public static final /* synthetic */ void write$Self$chat_release(SoundmojiContentNode soundmojiContentNode, CompositeEncoder compositeEncoder, SerialDescriptor serialDescriptor) {
        ...
        compositeEncoder.k(serialDescriptor, 1, ChannelId$$serializer.INSTANCE, ChannelId.m1058boximpl(soundmojiContentNode.channelId));
        compositeEncoder.k(serialDescriptor, 2, MessageId$$serializer.INSTANCE, MessageId.m1084boximpl(soundmojiContentNode.messageId));
        if (compositeEncoder.z(serialDescriptor, 3) || soundmojiContentNode.content != null) {
            compositeEncoder.o(serialDescriptor, 3, n2.f50032a, soundmojiContentNode.content);
        }
        if (compositeEncoder.z(serialDescriptor, 4) || soundmojiContentNode.guildId != null) {
            compositeEncoder.o(serialDescriptor, 4, n2.f50032a, soundmojiContentNode.guildId);
        }
        ...
        if (compositeEncoder.z(serialDescriptor, 6) || soundmojiContentNode.emojiId != null) {
            compositeEncoder.o(serialDescriptor, 6, n2.f50032a, soundmojiContentNode.emojiId);
        }
        if (compositeEncoder.z(serialDescriptor, 7) || soundmojiContentNode.emojiName != null) {
            compositeEncoder.o(serialDescriptor, 7, n2.f50032a, soundmojiContentNode.emojiName);
        }
    }
    ...
    public final long m372component2o4g7jtM() {
        return this.channelId;
    }

    @NotNull
    /* renamed from: component3-3Eiw7ao  reason: not valid java name */
    public final String m373component33Eiw7ao() {
    ...
    public final SoundmojiContentNode m374copyFdtyiUI(@NotNull String soundId, long j10, @NotNull String messageId, String str, String str2, boolean z10, String str3, String str4) {
