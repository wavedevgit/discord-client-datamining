...
public final class SoundmojiContentNode extends ContentNode {
    ...
    public static final /* synthetic */ void write$Self$chat_release(SoundmojiContentNode soundmojiContentNode, CompositeEncoder compositeEncoder, SerialDescriptor serialDescriptor) {
        ...
        compositeEncoder.j(serialDescriptor, 1, ChannelId$$serializer.INSTANCE, ChannelId.m1058boximpl(soundmojiContentNode.channelId));
        compositeEncoder.j(serialDescriptor, 2, MessageId$$serializer.INSTANCE, MessageId.m1084boximpl(soundmojiContentNode.messageId));
        if (compositeEncoder.A(serialDescriptor, 3) || soundmojiContentNode.content != null) {
            compositeEncoder.z(serialDescriptor, 3, n2.f6848a, soundmojiContentNode.content);
        }
        if (compositeEncoder.A(serialDescriptor, 4) || soundmojiContentNode.guildId != null) {
            compositeEncoder.z(serialDescriptor, 4, n2.f6848a, soundmojiContentNode.guildId);
        }
        ...
        if (compositeEncoder.A(serialDescriptor, 6) || soundmojiContentNode.emojiId != null) {
            compositeEncoder.z(serialDescriptor, 6, n2.f6848a, soundmojiContentNode.emojiId);
        }
        if (compositeEncoder.A(serialDescriptor, 7) || soundmojiContentNode.emojiName != null) {
            compositeEncoder.z(serialDescriptor, 7, n2.f6848a, soundmojiContentNode.emojiName);
        }
    }
    ...
    public int hashCode() {
        int hashCode = ((((this.soundId.hashCode() * 31) + ChannelId.m1063hashCodeimpl(this.channelId)) * 31) + MessageId.m1089hashCodeimpl(this.messageId)) * 31;
    ...
    public String toString() {
        ...
        return "SoundmojiContentNode(soundId=" + str + ", channelId=" + m1065toStringimpl + ", messageId=" + m1091toStringimpl + ", content=" + str2 + ", guildId=" + str3 + ", jumboable=" + z10 + ", emojiId=" + str4 + ", emojiName=" + str5 + ")";
    }
