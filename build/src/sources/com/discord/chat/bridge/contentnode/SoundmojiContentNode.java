...
public final class SoundmojiContentNode extends ContentNode {
    ...
    public static /* synthetic */ SoundmojiContentNode m370copyFdtyiUI$default(SoundmojiContentNode soundmojiContentNode, String str, long j10, String str2, String str3, String str4, boolean z10, String str5, String str6, int i10, Object obj) {
        if ((i10 & 1) != 0) {
        ...
        String str7 = str5;
        String str8 = str6;
        return soundmojiContentNode.m373copyFdtyiUI(str, j10, str2, str3, str4, z10, str7, str8);
    }
    ...
    public static final /* synthetic */ void write$Self$chat_release(SoundmojiContentNode soundmojiContentNode, CompositeEncoder compositeEncoder, SerialDescriptor serialDescriptor) {
        compositeEncoder.y(serialDescriptor, 0, soundmojiContentNode.soundId);
        compositeEncoder.F(serialDescriptor, 1, ChannelId$$serializer.INSTANCE, ChannelId.m1057boximpl(soundmojiContentNode.channelId));
        compositeEncoder.F(serialDescriptor, 2, MessageId$$serializer.INSTANCE, MessageId.m1083boximpl(soundmojiContentNode.messageId));
        if (compositeEncoder.z(serialDescriptor, 3) || soundmojiContentNode.content != null) {
            compositeEncoder.i(serialDescriptor, 3, n2.f35181a, soundmojiContentNode.content);
        }
        if (compositeEncoder.z(serialDescriptor, 4) || soundmojiContentNode.guildId != null) {
            compositeEncoder.i(serialDescriptor, 4, n2.f35181a, soundmojiContentNode.guildId);
        }
        if (compositeEncoder.z(serialDescriptor, 5) || soundmojiContentNode.jumboable) {
            compositeEncoder.x(serialDescriptor, 5, soundmojiContentNode.jumboable);
        }
        if (compositeEncoder.z(serialDescriptor, 6) || soundmojiContentNode.emojiId != null) {
            compositeEncoder.i(serialDescriptor, 6, n2.f35181a, soundmojiContentNode.emojiId);
        }
        if (compositeEncoder.z(serialDescriptor, 7) || soundmojiContentNode.emojiName != null) {
            compositeEncoder.i(serialDescriptor, 7, n2.f35181a, soundmojiContentNode.emojiName);
        }
    }
    ...
    public final long m371component2o4g7jtM() {
        return this.channelId;
    }

    @NotNull
    /* renamed from: component3-3Eiw7ao  reason: not valid java name */
    public final String m372component33Eiw7ao() {
    ...
    public final SoundmojiContentNode m373copyFdtyiUI(@NotNull String soundId, long j10, @NotNull String messageId, String str, String str2, boolean z10, String str3, String str4) {
    ...
    public int hashCode() {
        int hashCode = ((((this.soundId.hashCode() * 31) + ChannelId.m1062hashCodeimpl(this.channelId)) * 31) + MessageId.m1088hashCodeimpl(this.messageId)) * 31;
    ...
    public String toString() {
        ...
        return "SoundmojiContentNode(soundId=" + str + ", channelId=" + m1064toStringimpl + ", messageId=" + m1090toStringimpl + ", content=" + str2 + ", guildId=" + str3 + ", jumboable=" + z10 + ", emojiId=" + str4 + ", emojiName=" + str5 + ")";
    }
