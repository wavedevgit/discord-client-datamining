...
public final class LHeadingContentNode extends ContentNode {
    ...
    @NotNull
    private static final Lazy[] $childSerializers = {null, null, as.l.a(as.o.f6082e, new Function0() { // from class: com.discord.chat.bridge.contentnode.l
    ...
    public static final /* synthetic */ void write$Self$chat_release(LHeadingContentNode lHeadingContentNode, CompositeEncoder compositeEncoder, SerialDescriptor serialDescriptor) {
        ...
        compositeEncoder.k(serialDescriptor, 2, (qt.o) lazyArr[2].getValue(), lHeadingContentNode.content);
    }
