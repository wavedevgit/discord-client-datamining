...
public final class LHeadingContentNode extends ContentNode {
    ...
    @NotNull
    private static final Lazy[] $childSerializers = {null, null, qr.l.b(qr.o.f48044e, new Function0() { // from class: com.discord.chat.bridge.contentnode.l
    ...
    public static final /* synthetic */ void write$Self$chat_release(LHeadingContentNode lHeadingContentNode, CompositeEncoder compositeEncoder, SerialDescriptor serialDescriptor) {
        ...
        compositeEncoder.x(serialDescriptor, 0, lHeadingContentNode.level);
        compositeEncoder.z(serialDescriptor, 1, lHeadingContentNode.className);
        compositeEncoder.s(serialDescriptor, 2, (ft.o) lazyArr[2].getValue(), lHeadingContentNode.content);
    }
