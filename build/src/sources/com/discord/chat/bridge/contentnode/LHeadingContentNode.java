...
public final class LHeadingContentNode extends ContentNode {
    ...
    @NotNull
    private static final Lazy[] $childSerializers = {null, null, rr.l.b(rr.o.f49210e, new Function0() { // from class: com.discord.chat.bridge.contentnode.l
    ...
    public static final /* synthetic */ void write$Self$chat_release(LHeadingContentNode lHeadingContentNode, CompositeEncoder compositeEncoder, SerialDescriptor serialDescriptor) {
        ...
        compositeEncoder.F(serialDescriptor, 2, (gt.o) lazyArr[2].getValue(), lHeadingContentNode.content);
    }
