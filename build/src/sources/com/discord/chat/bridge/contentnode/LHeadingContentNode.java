...
public final class LHeadingContentNode extends ContentNode {
    ...
    @NotNull
    private static final Lazy[] $childSerializers = {null, null, or.l.b(or.o.f44232e, new Function0() { // from class: com.discord.chat.bridge.contentnode.l
    ...
    public static final /* synthetic */ void write$Self$chat_release(LHeadingContentNode lHeadingContentNode, CompositeEncoder compositeEncoder, SerialDescriptor serialDescriptor) {
        ...
        compositeEncoder.v(serialDescriptor, 0, lHeadingContentNode.level);
        compositeEncoder.x(serialDescriptor, 1, lHeadingContentNode.className);
        compositeEncoder.l(serialDescriptor, 2, (dt.o) lazyArr[2].getValue(), lHeadingContentNode.content);
    }
