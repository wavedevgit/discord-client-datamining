...
public final class LoadedReferencedMessage extends ReferencedMessage {
    ...
    public static final /* synthetic */ void write$Self$chat_release(LoadedReferencedMessage loadedReferencedMessage, CompositeEncoder compositeEncoder, SerialDescriptor serialDescriptor) {
        compositeEncoder.D(serialDescriptor, 0, Message$$serializer.INSTANCE, loadedReferencedMessage.message);
        if (compositeEncoder.z(serialDescriptor, 1) || loadedReferencedMessage.systemContent != null) {
            compositeEncoder.s(serialDescriptor, 1, StructurableTextSerializer.INSTANCE, loadedReferencedMessage.systemContent);
        }
    }
