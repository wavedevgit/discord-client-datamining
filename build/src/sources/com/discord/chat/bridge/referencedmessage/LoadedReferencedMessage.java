...
public final class LoadedReferencedMessage extends ReferencedMessage {
    ...
    public static final /* synthetic */ void write$Self$chat_release(LoadedReferencedMessage loadedReferencedMessage, CompositeEncoder compositeEncoder, SerialDescriptor serialDescriptor) {
        compositeEncoder.m(serialDescriptor, 0, Message$$serializer.INSTANCE, loadedReferencedMessage.message);
        if (compositeEncoder.y(serialDescriptor, 1) || loadedReferencedMessage.systemContent != null) {
            compositeEncoder.B(serialDescriptor, 1, StructurableTextSerializer.INSTANCE, loadedReferencedMessage.systemContent);
        }
    }
