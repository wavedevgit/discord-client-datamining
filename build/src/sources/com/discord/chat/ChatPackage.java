...
public final class ChatPackage extends BaseReactPackage {
    ...
    public List<ViewManager<?, LayoutShadowNode>> createViewManagers(@NotNull ReactApplicationContext reactContext) {
        ...
        return CollectionsKt.o(new ChatViewManager(), new ChatListViewManager(), new MessageViewManagers.MessageViewManager(), new MessageViewManagers.SystemMessageViewManager(), new MessageViewManagers.AutoModerationSystemMessageViewManager(), new SelectActionComponentViewManager(), new TextDisplayComponentViewManager());
    }
    ...
    public ReactModuleInfoProvider getReactModuleInfoProvider() {
        return ReactModuleInfoProviderExtensionsKt.createReactModuleInfoProvider$default(CollectionsKt.e(NativeChatModuleSpec.NAME), false, 2, (Object) null);
    }
}
