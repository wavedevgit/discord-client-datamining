...
public final class TapWelcomeReplyData implements ReactEvent {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof TapWelcomeReplyData) {
            ...
            return this.stickerId == tapWelcomeReplyData.stickerId && MessageId.m1087equalsimpl0(this.messageId, tapWelcomeReplyData.messageId);
        }
        return false;
    }
    ...
    public int hashCode() {
        return (Long.hashCode(this.stickerId) * 31) + MessageId.m1088hashCodeimpl(this.messageId);
    }

    @Override // com.discord.reactevents.ReactEvent
    @NotNull
    public WritableMap serialize() {
        return NativeMapExtensionsKt.nativeMapOf(v.a("messageId", MessageId.m1090toStringimpl(this.messageId)), v.a("stickerId", String.valueOf(this.stickerId)));
    }
    ...
    public String toString() {
        ...
        return "TapWelcomeReplyData(stickerId=" + j10 + ", messageId=" + m1090toStringimpl + ")";
    }
