...
public final class TapWelcomeReplyData implements ReactEvent {
    ...
    public static /* synthetic */ TapWelcomeReplyData m853copyAyv7vGE$default(TapWelcomeReplyData tapWelcomeReplyData, long j10, String str, int i10, Object obj) {
        if ((i10 & 1) != 0) {
        ...
        return tapWelcomeReplyData.m855copyAyv7vGE(j10, str);
    }
    ...
    public final String m854component23Eiw7ao() {
        return this.messageId;
    }

    @NotNull
    /* renamed from: copy-Ayv7vGE  reason: not valid java name */
    public final TapWelcomeReplyData m855copyAyv7vGE(long j10, @NotNull String messageId) {
