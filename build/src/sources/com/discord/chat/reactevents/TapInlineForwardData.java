...
public final class TapInlineForwardData implements ReactEvent {
    ...
    public static final /* synthetic */ void write$Self$chat_release(TapInlineForwardData tapInlineForwardData, CompositeEncoder compositeEncoder, SerialDescriptor serialDescriptor) {
        ...
        compositeEncoder.z(serialDescriptor, 3, p0.f6864a, tapInlineForwardData.embedIndex);
        compositeEncoder.z(serialDescriptor, 4, h.f6812a, tapInlineForwardData.triggerHaptic);
        compositeEncoder.z(serialDescriptor, 5, n2.f6848a, tapInlineForwardData.location);
    }
