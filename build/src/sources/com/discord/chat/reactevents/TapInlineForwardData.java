...
public final class TapInlineForwardData implements ReactEvent {
    ...
    public static final /* synthetic */ void write$Self$chat_release(TapInlineForwardData tapInlineForwardData, CompositeEncoder compositeEncoder, SerialDescriptor serialDescriptor) {
        ...
        compositeEncoder.o(serialDescriptor, 3, p0.f50617a, tapInlineForwardData.embedIndex);
        compositeEncoder.o(serialDescriptor, 4, h.f50565a, tapInlineForwardData.triggerHaptic);
        compositeEncoder.o(serialDescriptor, 5, n2.f50601a, tapInlineForwardData.location);
    }
