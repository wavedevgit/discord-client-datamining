...
public final class TapInlineForwardData implements ReactEvent {
    ...
    public static final /* synthetic */ void write$Self$chat_release(TapInlineForwardData tapInlineForwardData, CompositeEncoder compositeEncoder, SerialDescriptor serialDescriptor) {
        compositeEncoder.x(serialDescriptor, 0, tapInlineForwardData.channelId);
        compositeEncoder.x(serialDescriptor, 1, tapInlineForwardData.messageId);
        compositeEncoder.x(serialDescriptor, 2, tapInlineForwardData.targetKind);
        compositeEncoder.A(serialDescriptor, 3, p0.f25318a, tapInlineForwardData.embedIndex);
        compositeEncoder.A(serialDescriptor, 4, h.f25266a, tapInlineForwardData.triggerHaptic);
        compositeEncoder.A(serialDescriptor, 5, n2.f25302a, tapInlineForwardData.location);
    }
