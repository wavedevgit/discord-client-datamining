...
public final class TapInlineForwardData implements ReactEvent {
    ...
    public static final /* synthetic */ void write$Self$chat_release(TapInlineForwardData tapInlineForwardData, CompositeEncoder compositeEncoder, SerialDescriptor serialDescriptor) {
        ...
        compositeEncoder.B(serialDescriptor, 3, p0.f7678a, tapInlineForwardData.embedIndex);
        compositeEncoder.B(serialDescriptor, 4, h.f7626a, tapInlineForwardData.triggerHaptic);
        compositeEncoder.B(serialDescriptor, 5, n2.f7662a, tapInlineForwardData.location);
    }
