...
public final class TapInlineForwardData implements ReactEvent {
    ...
    public static final /* synthetic */ void write$Self$chat_release(TapInlineForwardData tapInlineForwardData, CompositeEncoder compositeEncoder, SerialDescriptor serialDescriptor) {
        ...
        compositeEncoder.s(serialDescriptor, 3, p0.f20994a, tapInlineForwardData.embedIndex);
        compositeEncoder.s(serialDescriptor, 4, h.f20942a, tapInlineForwardData.triggerHaptic);
        compositeEncoder.s(serialDescriptor, 5, n2.f20978a, tapInlineForwardData.location);
    }
