...
public final class TapObscuredMediaToggleData implements ReactEvent {
    ...
    public static final /* synthetic */ void write$Self$chat_release(TapObscuredMediaToggleData tapObscuredMediaToggleData, CompositeEncoder compositeEncoder, SerialDescriptor serialDescriptor) {
        compositeEncoder.x(serialDescriptor, 0, tapObscuredMediaToggleData.messageId);
        compositeEncoder.x(serialDescriptor, 1, tapObscuredMediaToggleData.channelId);
        compositeEncoder.x(serialDescriptor, 2, tapObscuredMediaToggleData.attachmentId);
        compositeEncoder.x(serialDescriptor, 3, tapObscuredMediaToggleData.embedId);
        compositeEncoder.w(serialDescriptor, 4, tapObscuredMediaToggleData.isReveal);
    }
