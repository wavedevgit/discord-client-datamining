...
public final class TapObscuredMediaToggleData implements ReactEvent {
    ...
    public static final /* synthetic */ void write$Self$chat_release(TapObscuredMediaToggleData tapObscuredMediaToggleData, CompositeEncoder compositeEncoder, SerialDescriptor serialDescriptor) {
        compositeEncoder.z(serialDescriptor, 0, tapObscuredMediaToggleData.messageId);
        compositeEncoder.z(serialDescriptor, 1, tapObscuredMediaToggleData.channelId);
        compositeEncoder.z(serialDescriptor, 2, tapObscuredMediaToggleData.attachmentId);
        compositeEncoder.z(serialDescriptor, 3, tapObscuredMediaToggleData.embedId);
        compositeEncoder.y(serialDescriptor, 4, tapObscuredMediaToggleData.isReveal);
    }
