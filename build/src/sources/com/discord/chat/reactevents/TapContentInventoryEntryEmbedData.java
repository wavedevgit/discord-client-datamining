...
public final class TapContentInventoryEntryEmbedData implements ReactEvent {
    ...
    public static final /* synthetic */ void write$Self$chat_release(TapContentInventoryEntryEmbedData tapContentInventoryEntryEmbedData, CompositeEncoder compositeEncoder, SerialDescriptor serialDescriptor) {
        compositeEncoder.z(serialDescriptor, 0, tapContentInventoryEntryEmbedData.messageId);
        compositeEncoder.z(serialDescriptor, 1, tapContentInventoryEntryEmbedData.authorId);
        compositeEncoder.z(serialDescriptor, 2, tapContentInventoryEntryEmbedData.contentId);
        compositeEncoder.z(serialDescriptor, 3, tapContentInventoryEntryEmbedData.tappedElement);
    }
