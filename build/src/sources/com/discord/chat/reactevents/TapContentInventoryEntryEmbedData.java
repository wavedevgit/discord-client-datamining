...
public final class TapContentInventoryEntryEmbedData implements ReactEvent {
    ...
    public static final /* synthetic */ void write$Self$chat_release(TapContentInventoryEntryEmbedData tapContentInventoryEntryEmbedData, CompositeEncoder compositeEncoder, SerialDescriptor serialDescriptor) {
        compositeEncoder.y(serialDescriptor, 0, tapContentInventoryEntryEmbedData.messageId);
        compositeEncoder.y(serialDescriptor, 1, tapContentInventoryEntryEmbedData.authorId);
        compositeEncoder.y(serialDescriptor, 2, tapContentInventoryEntryEmbedData.contentId);
        compositeEncoder.y(serialDescriptor, 3, tapContentInventoryEntryEmbedData.tappedElement);
    }
