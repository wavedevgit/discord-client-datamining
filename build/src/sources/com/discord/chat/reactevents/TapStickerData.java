...
public final class TapStickerData implements ReactEvent {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof TapStickerData) {
            ...
            return Intrinsics.areEqual(this.sticker, tapStickerData.sticker) && MessageId.m1087equalsimpl0(this.messageId, tapStickerData.messageId);
        }
        return false;
    }
    ...
    public int hashCode() {
        return (this.sticker.hashCode() * 31) + MessageId.m1088hashCodeimpl(this.messageId);
    }
    ...
    public String toString() {
        ...
        return "TapStickerData(sticker=" + sticker + ", messageId=" + m1090toStringimpl + ")";
    }
