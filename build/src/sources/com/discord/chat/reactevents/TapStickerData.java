...
public final class TapStickerData implements ReactEvent {
    ...
    public static /* synthetic */ TapStickerData m843copyAyv7vGE$default(TapStickerData tapStickerData, Sticker sticker, String str, int i10, Object obj) {
        if ((i10 & 1) != 0) {
        ...
        return tapStickerData.m845copyAyv7vGE(sticker, str);
    }
    ...
    public final String m844component23Eiw7ao() {
        return this.messageId;
    }

    @NotNull
    /* renamed from: copy-Ayv7vGE  reason: not valid java name */
    public final TapStickerData m845copyAyv7vGE(@NotNull Sticker sticker, @NotNull String messageId) {
    ...
    public final String m846getMessageId3Eiw7ao() {
        return this.messageId;
    }
