...
public final class TapCallData implements ReactEvent {
    ...
    public static final /* synthetic */ void write$Self$chat_release(TapCallData tapCallData, CompositeEncoder compositeEncoder, SerialDescriptor serialDescriptor) {
        compositeEncoder.s(serialDescriptor, 0, MessageId$$serializer.INSTANCE, MessageId.m1083boximpl(tapCallData.messageId));
        compositeEncoder.s(serialDescriptor, 1, ChannelId$$serializer.INSTANCE, ChannelId.m1057boximpl(tapCallData.channelId));
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof TapCallData) {
            ...
            return MessageId.m1087equalsimpl0(this.messageId, tapCallData.messageId) && ChannelId.m1061equalsimpl0(this.channelId, tapCallData.channelId);
        }
        return false;
    }
    ...
    public WritableMap serialize() {
        return NativeMapExtensionsKt.nativeMapOf(v.a("data", NativeMapExtensionsKt.nativeMapOf(v.a("messageId", MessageId.m1090toStringimpl(this.messageId)), v.a("channelId", ChannelId.m1064toStringimpl(this.channelId)))));
    }
    ...
    public String toString() {
        ...
        return "TapCallData(messageId=" + m1090toStringimpl + ", channelId=" + m1064toStringimpl + ")";
    }
