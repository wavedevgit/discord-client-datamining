...
public final class TapCallData implements ReactEvent {
    ...
    public static final /* synthetic */ void write$Self$chat_release(TapCallData tapCallData, CompositeEncoder compositeEncoder, SerialDescriptor serialDescriptor) {
        compositeEncoder.F(serialDescriptor, 0, MessageId$$serializer.INSTANCE, MessageId.m1083boximpl(tapCallData.messageId));
        compositeEncoder.F(serialDescriptor, 1, ChannelId$$serializer.INSTANCE, ChannelId.m1057boximpl(tapCallData.channelId));
    }
