...
public final class TapCallData implements ReactEvent {
    ...
    public static /* synthetic */ TapCallData m789copypfaIj0E$default(TapCallData tapCallData, String str, long j10, int i10, Object obj) {
        if ((i10 & 1) != 0) {
        ...
        return tapCallData.m792copypfaIj0E(str, j10);
    }
    ...
    public static final /* synthetic */ void write$Self$chat_release(TapCallData tapCallData, CompositeEncoder compositeEncoder, SerialDescriptor serialDescriptor) {
        compositeEncoder.k(serialDescriptor, 0, MessageId$$serializer.INSTANCE, MessageId.m1084boximpl(tapCallData.messageId));
        compositeEncoder.k(serialDescriptor, 1, ChannelId$$serializer.INSTANCE, ChannelId.m1058boximpl(tapCallData.channelId));
    }

    @NotNull
    /* renamed from: component1-3Eiw7ao  reason: not valid java name */
    public final String m790component13Eiw7ao() {
        return this.messageId;
    }

    /* renamed from: component2-o4g7jtM  reason: not valid java name */
    public final long m791component2o4g7jtM() {
        return this.channelId;
    }

    @NotNull
    /* renamed from: copy-pfaIj0E  reason: not valid java name */
    public final TapCallData m792copypfaIj0E(@NotNull String messageId, long j10) {
    ...
    public final long m793getChannelIdo4g7jtM() {
        return this.channelId;
    }

    @NotNull
    /* renamed from: getMessageId-3Eiw7ao  reason: not valid java name */
    public final String m794getMessageId3Eiw7ao() {
        return this.messageId;
    }
