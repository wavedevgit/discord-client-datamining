...
public final class LongPressAttachmentLinkData implements ReactEvent {
    ...
    public static final /* synthetic */ void write$Self$chat_release(LongPressAttachmentLinkData longPressAttachmentLinkData, CompositeEncoder compositeEncoder, SerialDescriptor serialDescriptor) {
        if (compositeEncoder.y(serialDescriptor, 0) || longPressAttachmentLinkData.attachmentUrl != null) {
            compositeEncoder.B(serialDescriptor, 0, n2.f7662a, longPressAttachmentLinkData.attachmentUrl);
        }
        if (compositeEncoder.y(serialDescriptor, 1) || longPressAttachmentLinkData.attachmentName != null) {
            compositeEncoder.B(serialDescriptor, 1, n2.f7662a, longPressAttachmentLinkData.attachmentName);
        }
    }
