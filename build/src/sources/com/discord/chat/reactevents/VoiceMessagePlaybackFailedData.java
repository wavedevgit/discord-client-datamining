...
public final class VoiceMessagePlaybackFailedData implements ReactEvent {
    ...
    public static final /* synthetic */ void write$Self$chat_release(VoiceMessagePlaybackFailedData voiceMessagePlaybackFailedData, CompositeEncoder compositeEncoder, SerialDescriptor serialDescriptor) {
        compositeEncoder.j(serialDescriptor, 0, MessageId$$serializer.INSTANCE, MessageId.m1084boximpl(voiceMessagePlaybackFailedData.messageId));
        compositeEncoder.z(serialDescriptor, 1, n2.f6848a, voiceMessagePlaybackFailedData.errorMessage);
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof VoiceMessagePlaybackFailedData) {
            ...
            return MessageId.m1088equalsimpl0(this.messageId, voiceMessagePlaybackFailedData.messageId) && Intrinsics.areEqual(this.errorMessage, voiceMessagePlaybackFailedData.errorMessage);
        }
        return false;
    }
    ...
    public String toString() {
        ...
        String str = this.errorMessage;
        return "VoiceMessagePlaybackFailedData(messageId=" + m1091toStringimpl + ", errorMessage=" + str + ")";
    }
