...
public final class VoiceMessagePlaybackFailedData implements ReactEvent {
    ...
    public static /* synthetic */ VoiceMessagePlaybackFailedData m856copyntcYbpo$default(VoiceMessagePlaybackFailedData voiceMessagePlaybackFailedData, String str, String str2, int i10, Object obj) {
        if ((i10 & 1) != 0) {
        ...
        return voiceMessagePlaybackFailedData.m858copyntcYbpo(str, str2);
    }
    ...
    public static final /* synthetic */ void write$Self$chat_release(VoiceMessagePlaybackFailedData voiceMessagePlaybackFailedData, CompositeEncoder compositeEncoder, SerialDescriptor serialDescriptor) {
        compositeEncoder.s(serialDescriptor, 0, MessageId$$serializer.INSTANCE, MessageId.m1083boximpl(voiceMessagePlaybackFailedData.messageId));
        compositeEncoder.l(serialDescriptor, 1, n2.f31089a, voiceMessagePlaybackFailedData.errorMessage);
    }

    @NotNull
    /* renamed from: component1-3Eiw7ao  reason: not valid java name */
    public final String m857component13Eiw7ao() {
    ...
    public final VoiceMessagePlaybackFailedData m858copyntcYbpo(@NotNull String messageId, String str) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof VoiceMessagePlaybackFailedData) {
            ...
            return MessageId.m1087equalsimpl0(this.messageId, voiceMessagePlaybackFailedData.messageId) && Intrinsics.areEqual(this.errorMessage, voiceMessagePlaybackFailedData.errorMessage);
        }
        return false;
    }
    ...
    public final String m859getMessageId3Eiw7ao() {
        return this.messageId;
    }
    ...
    public String toString() {
        ...
        String str = this.errorMessage;
        return "VoiceMessagePlaybackFailedData(messageId=" + m1090toStringimpl + ", errorMessage=" + str + ")";
    }
