...
public final class VoiceMessagePlaybackFailedData implements ReactEvent {
    ...
    public static final /* synthetic */ void write$Self$chat_release(VoiceMessagePlaybackFailedData voiceMessagePlaybackFailedData, CompositeEncoder compositeEncoder, SerialDescriptor serialDescriptor) {
        compositeEncoder.l(serialDescriptor, 0, MessageId$$serializer.INSTANCE, MessageId.m1085boximpl(voiceMessagePlaybackFailedData.messageId));
        compositeEncoder.A(serialDescriptor, 1, n2.f25302a, voiceMessagePlaybackFailedData.errorMessage);
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof VoiceMessagePlaybackFailedData) {
            ...
            return MessageId.m1089equalsimpl0(this.messageId, voiceMessagePlaybackFailedData.messageId) && Intrinsics.areEqual(this.errorMessage, voiceMessagePlaybackFailedData.errorMessage);
        }
        return false;
    }
    ...
    public int hashCode() {
        int m1090hashCodeimpl = MessageId.m1090hashCodeimpl(this.messageId) * 31;
    ...
    public String toString() {
        ...
        String str = this.errorMessage;
        return "VoiceMessagePlaybackFailedData(messageId=" + m1092toStringimpl + ", errorMessage=" + str + ")";
    }
