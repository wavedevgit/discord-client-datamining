...
public final class SharedClientThemeViewedData implements ReactEvent {
    ...
    public static /* synthetic */ SharedClientThemeViewedData m782copytEk1XsE$default(SharedClientThemeViewedData sharedClientThemeViewedData, String str, int i10, Object obj) {
        if ((i10 & 1) != 0) {
            str = sharedClientThemeViewedData.messageId;
        }
        return sharedClientThemeViewedData.m784copytEk1XsE(str);
    }
    ...
    public static final /* synthetic */ void write$Self$chat_release(SharedClientThemeViewedData sharedClientThemeViewedData, CompositeEncoder compositeEncoder, SerialDescriptor serialDescriptor) {
        MessageId messageId;
        if (compositeEncoder.y(serialDescriptor, 0) || sharedClientThemeViewedData.messageId != null) {
            ...
            compositeEncoder.B(serialDescriptor, 0, messageId$$serializer, messageId);
        }
    }

    /* renamed from: component1-N_6c4I0  reason: not valid java name */
    public final String m783component1N_6c4I0() {
        return this.messageId;
    }

    @NotNull
    /* renamed from: copy-tEk1XsE  reason: not valid java name */
    public final SharedClientThemeViewedData m784copytEk1XsE(String str) {
    ...
    public final String m785getMessageIdN_6c4I0() {
        return this.messageId;
    }
    ...
    public int hashCode() {
        ...
        return MessageId.m1091hashCodeimpl(str);
    }
    ...
    public String toString() {
        ...
        return "SharedClientThemeViewedData(messageId=" + m1093toStringimpl + ")";
    }
