...
public final class TapCommandData implements ReactEvent {
    ...
    public static final /* synthetic */ void write$Self$chat_release(TapCommandData tapCommandData, CompositeEncoder compositeEncoder, SerialDescriptor serialDescriptor) {
        compositeEncoder.z(serialDescriptor, 0, tapCommandData.channelId);
        compositeEncoder.z(serialDescriptor, 1, tapCommandData.commandId);
        compositeEncoder.z(serialDescriptor, 2, tapCommandData.commandName);
        compositeEncoder.z(serialDescriptor, 3, tapCommandData.commandKey);
    }
    ...
    public TapCommandData(@NotNull CommandMentionContentNode node) {
        this(ChannelId.m1064toStringimpl(node.m295getChannelIdo4g7jtM()), node.getCommandId(), node.getCommandName(), node.getCommandKey());
