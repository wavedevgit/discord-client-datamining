...
public final class TapTagData implements ReactEvent {
    ...
    public static final /* synthetic */ void write$Self$chat_release(TapTagData tapTagData, CompositeEncoder compositeEncoder, SerialDescriptor serialDescriptor) {
        compositeEncoder.j(serialDescriptor, 0, MessageId$$serializer.INSTANCE, MessageId.m1084boximpl(tapTagData.messageId));
        compositeEncoder.j(serialDescriptor, 1, ChannelId$$serializer.INSTANCE, ChannelId.m1058boximpl(tapTagData.channelId));
        compositeEncoder.z(serialDescriptor, 2, n2.f6848a, tapTagData.tagType);
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof TapTagData) {
            ...
            return MessageId.m1088equalsimpl0(this.messageId, tapTagData.messageId) && ChannelId.m1062equalsimpl0(this.channelId, tapTagData.channelId) && Intrinsics.areEqual(this.tagType, tapTagData.tagType);
        }
        return false;
    }
    ...
    public String toString() {
        ...
        String str = this.tagType;
        return "TapTagData(messageId=" + m1091toStringimpl + ", channelId=" + m1065toStringimpl + ", tagType=" + str + ")";
    }
