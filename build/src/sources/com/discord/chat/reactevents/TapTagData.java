...
public final class TapTagData implements ReactEvent {
    ...
    public static final /* synthetic */ void write$Self$chat_release(TapTagData tapTagData, CompositeEncoder compositeEncoder, SerialDescriptor serialDescriptor) {
        compositeEncoder.F(serialDescriptor, 0, MessageId$$serializer.INSTANCE, MessageId.m1083boximpl(tapTagData.messageId));
        compositeEncoder.F(serialDescriptor, 1, ChannelId$$serializer.INSTANCE, ChannelId.m1057boximpl(tapTagData.channelId));
        compositeEncoder.i(serialDescriptor, 2, n2.f35181a, tapTagData.tagType);
    }
