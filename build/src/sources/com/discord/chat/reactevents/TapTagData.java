...
public final class TapTagData implements ReactEvent {
    ...
    public static /* synthetic */ TapTagData m846copyEqy5D80$default(TapTagData tapTagData, String str, long j10, String str2, int i10, Object obj) {
        if ((i10 & 1) != 0) {
        ...
        return tapTagData.m849copyEqy5D80(str, j10, str2);
    }
    ...
    public static final /* synthetic */ void write$Self$chat_release(TapTagData tapTagData, CompositeEncoder compositeEncoder, SerialDescriptor serialDescriptor) {
        compositeEncoder.s(serialDescriptor, 0, MessageId$$serializer.INSTANCE, MessageId.m1083boximpl(tapTagData.messageId));
        compositeEncoder.s(serialDescriptor, 1, ChannelId$$serializer.INSTANCE, ChannelId.m1057boximpl(tapTagData.channelId));
        compositeEncoder.l(serialDescriptor, 2, n2.f31041a, tapTagData.tagType);
    }

    @NotNull
    /* renamed from: component1-3Eiw7ao  reason: not valid java name */
    public final String m847component13Eiw7ao() {
        return this.messageId;
    }

    /* renamed from: component2-o4g7jtM  reason: not valid java name */
    public final long m848component2o4g7jtM() {
    ...
    public final TapTagData m849copyEqy5D80(@NotNull String messageId, long j10, String str) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof TapTagData) {
            ...
            return MessageId.m1087equalsimpl0(this.messageId, tapTagData.messageId) && ChannelId.m1061equalsimpl0(this.channelId, tapTagData.channelId) && Intrinsics.areEqual(this.tagType, tapTagData.tagType);
        }
        return false;
    }

    /* renamed from: getChannelId-o4g7jtM  reason: not valid java name */
    public final long m850getChannelIdo4g7jtM() {
        return this.channelId;
    }

    @NotNull
    /* renamed from: getMessageId-3Eiw7ao  reason: not valid java name */
    public final String m851getMessageId3Eiw7ao() {
        return this.messageId;
    }
    ...
    public String toString() {
        ...
        String str = this.tagType;
        return "TapTagData(messageId=" + m1090toStringimpl + ", channelId=" + m1064toStringimpl + ", tagType=" + str + ")";
    }
