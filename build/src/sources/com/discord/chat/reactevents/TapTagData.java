...
public final class TapTagData implements ReactEvent {
    ...
    public static final /* synthetic */ void write$Self$chat_release(TapTagData tapTagData, CompositeEncoder compositeEncoder, SerialDescriptor serialDescriptor) {
        compositeEncoder.l(serialDescriptor, 0, MessageId$$serializer.INSTANCE, MessageId.m1085boximpl(tapTagData.messageId));
        compositeEncoder.l(serialDescriptor, 1, ChannelId$$serializer.INSTANCE, ChannelId.m1059boximpl(tapTagData.channelId));
        compositeEncoder.A(serialDescriptor, 2, n2.f25302a, tapTagData.tagType);
    }
