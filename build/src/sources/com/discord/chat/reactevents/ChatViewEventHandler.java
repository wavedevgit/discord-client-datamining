...
public class ChatViewEventHandler implements ChatEventHandler {
    ...
    public ChatViewEventHandler(@NotNull final Context context, @NotNull final ReactEvents reactEvents, @NotNull final Function0<Integer> reactTag) {
        ...
        this.onMessageLongPressed = new Function6() { // from class: com.discord.chat.reactevents.ChatViewEventHandler$onMessageLongPressed$1
            ...
            public /* bridge */ /* synthetic */ Object invoke(Object obj, Object obj2, Object obj3, Object obj4, Object obj5, Object obj6) {
                m730invokeeTS4JUY(((MessageId) obj).m1092unboximpl(), ((ChannelId) obj2).m1066unboximpl(), (Integer) obj3, (MediaType) obj4, (String) obj5, (Integer) obj6);
                return Unit.f32056a;
            }
            ...
            public final void m730invokeeTS4JUY(String messageId, long j10, Integer num, MediaType mediaType, String str, Integer num2) {
                ...
                function1.invoke(new LongPressMessageEvent(m1090toStringimpl, m1064toStringimpl, i10, (mediaType == null || (r4 = mediaType.getType()) == null) ? "" : "", str, num2));
            }
        };
        this.onMessageTapped = new Function2<MessageId, ChannelId, Unit>() { // from class: com.discord.chat.reactevents.ChatViewEventHandler$onMessageTapped$1
            ...
            public /* bridge */ /* synthetic */ Object invoke(Object obj, Object obj2) {
                m731invokepfaIj0E(((MessageId) obj).m1092unboximpl(), ((ChannelId) obj2).m1066unboximpl());
                return Unit.f32056a;
            }
            ...
            public final void m731invokepfaIj0E(String messageId, long j10) {
                ...
                Intrinsics.checkNotNullParameter(messageId, "messageId");
                function1 = ChatViewEventHandler.this.emitReactEvent;
                function1.invoke(new TapMessageData(MessageId.m1090toStringimpl(messageId), ChannelId.m1064toStringimpl(j10)));
            }
        };
        this.onMessageDoubleTapped = new Function2<MessageId, ChannelId, Unit>() { // from class: com.discord.chat.reactevents.ChatViewEventHandler$onMessageDoubleTapped$1
            @Override // kotlin.jvm.functions.Function2
            public /* bridge */ /* synthetic */ Object invoke(Object obj, Object obj2) {
                m729invokepfaIj0E(((MessageId) obj).m1092unboximpl(), ((ChannelId) obj2).m1066unboximpl());
                return Unit.f32056a;
            }
            ...
            public final void m729invokepfaIj0E(String messageId, long j10) {
                ...
                Intrinsics.checkNotNullParameter(messageId, "messageId");
                function1 = ChatViewEventHandler.this.emitReactEvent;
                function1.invoke(new DoubleTapMessageEvent(MessageId.m1090toStringimpl(messageId), ChannelId.m1064toStringimpl(j10)));
            }
        };
    }
    ...
    public void mo439onLongPressAvatarx5gers8(@NotNull String messageId, long j10) {
        Intrinsics.checkNotNullParameter(messageId, "messageId");
        this.emitReactEvent.invoke(new LongPressAvatarData(MessageId.m1090toStringimpl(messageId), UserId.m1142toStringimpl(j10)));
    }
    ...
    public void mo440onLongPressPollImageYVExdug(long j10, @NotNull String messageId, @NotNull String attachmentId, int i10, int i11, int i12, int i13, @NotNull ViewResizeMode viewResizeMode) {
        ...
        this.emitReactEvent.invoke(new LongPressPollImageData(ChannelId.m1064toStringimpl(j10), MessageId.m1090toStringimpl(messageId), attachmentId, new TapImageData.Layout(i10, i11, i12, i13, viewResizeMode)));
    }
    ...
    public void mo442onLongPressUsernamex5gers8(@NotNull String messageId, long j10) {
        Intrinsics.checkNotNullParameter(messageId, "messageId");
        this.emitReactEvent.invoke(new LongPressUsernameData(MessageId.m1090toStringimpl(messageId), UserId.m1142toStringimpl(j10)));
    }
    ...
    public void mo446onTapAutoModerationActionspfaIj0E(@NotNull String messageId, long j10) {
        Intrinsics.checkNotNullParameter(messageId, "messageId");
        this.emitReactEvent.invoke(new TapAutoModerationActionsData(MessageId.m1090toStringimpl(messageId), ChannelId.m1064toStringimpl(j10)));
    }
    ...
    public void mo447onTapAutoModerationFeedbackpfaIj0E(@NotNull String messageId, long j10) {
        Intrinsics.checkNotNullParameter(messageId, "messageId");
        this.emitReactEvent.invoke(new TapAutoModerationFeedbackData(MessageId.m1090toStringimpl(messageId), ChannelId.m1064toStringimpl(j10)));
    }
    ...
    public void mo448onTapAvatarx5gers8(@NotNull String messageId, long j10) {
        Intrinsics.checkNotNullParameter(messageId, "messageId");
        this.emitReactEvent.invoke(new TapAvatarData(MessageId.m1090toStringimpl(messageId), UserId.m1142toStringimpl(j10)));
    }
    ...
    public void mo451onTapChannelPromptButtonEqy5D80(@NotNull String messageId, long j10, @NotNull String buttonType) {
        ...
        this.emitReactEvent.invoke(new TapChannelPromptButtonData(MessageId.m1090toStringimpl(messageId), ChannelId.m1064toStringimpl(j10), buttonType));
    }
    ...
    public void mo452onTapCheckpointCardx5gers8(@NotNull String messageId, long j10) {
        Intrinsics.checkNotNullParameter(messageId, "messageId");
        this.emitReactEvent.invoke(new TapCheckpointCardData(MessageId.m1090toStringimpl(messageId), UserId.m1142toStringimpl(j10)));
    }

    @Override // com.discord.chat.presentation.events.ChatEventHandler
    /* renamed from: onTapClanTagChiplet-g3bFfsM */
    public void mo453onTapClanTagChipletg3bFfsM(long j10) {
        this.emitReactEvent.invoke(new TapClanTagChipletData(GuildId.m1077toStringimpl(j10)));
    }
    ...
    public void mo454onTapContentInventoryEntryEmbedtsfjtEQ(@NotNull String messageId, long j10, @NotNull String contentId, @NotNull String tappedElement) {
        ...
        this.emitReactEvent.invoke(new TapContentInventoryEntryEmbedData(MessageId.m1090toStringimpl(messageId), UserId.m1142toStringimpl(j10), contentId, tappedElement));
    }
    ...
    public void mo455onTapCtaButtonsekaTiM(long j10, @NotNull String messageId, @NotNull String callback) {
        ...
        this.emitReactEvent.invoke(new TapCtaButton(ChannelId.m1064toStringimpl(j10), MessageId.m1090toStringimpl(messageId), callback));
    }
    ...
    public void mo457onTapFollowForumPostpfaIj0E(@NotNull String messageId, long j10) {
        Intrinsics.checkNotNullParameter(messageId, "messageId");
        this.emitReactEvent.invoke(new TapFollowForumPost(MessageId.m1090toStringimpl(messageId), ChannelId.m1064toStringimpl(j10)));
    }
    ...
    public void mo458onTapForwardFooterSHRpUJI(int i10, long j10, @NotNull String messageId) {
        Intrinsics.checkNotNullParameter(messageId, "messageId");
        this.emitReactEvent.invoke(new TapForwardFooterData(i10, ChannelId.m1064toStringimpl(j10), MessageId.m1090toStringimpl(messageId)));
    }
    ...
    public void mo460onTapImageJR3bP6M(@NotNull String messageId, int i10, @NotNull String type, int i11, int i12, int i13, int i14, @NotNull ViewResizeMode viewResizeMode, Double d10, Integer num, String str, Integer num2) {
        ...
        Intrinsics.checkNotNullParameter(viewResizeMode, "viewResizeMode");
        this.emitReactEvent.invoke(new TapImageData(MessageId.m1090toStringimpl(messageId), i10, type, new TapImageData.Layout(i11, i12, i13, i14, viewResizeMode), d10, num, str, num2));
    }
    ...
    public void mo461onTapInlineForwardj8a4Y88(long j10, @NotNull String messageId, @NotNull String targetKind, Integer num, Boolean bool, String str) {
        ...
        this.emitReactEvent.invoke(new TapInlineForwardData(ChannelId.m1064toStringimpl(j10), MessageId.m1090toStringimpl(messageId), targetKind, num, bool, str));
    }
    ...
    public void mo467onTapMessageReply0eiqbug(long j10, @NotNull String originId) {
        ...
        this.emitReactEvent.invoke(new TapMessageReplyData(ChannelId.m1064toStringimpl(j10), MessageId.m1090toStringimpl(originId)));
    }
    ...
    public void mo468onTapObscuredMediaLearnMore8a0ehIg(@NotNull String messageId, long j10, String str, String str2) {
        Intrinsics.checkNotNullParameter(messageId, "messageId");
        this.emitReactEvent.invoke(new TapObscuredMediaLearnMoreData(MessageId.m1090toStringimpl(messageId), ChannelId.m1064toStringimpl(j10), String.valueOf(str), String.valueOf(str2)));
    }
    ...
    public void mo469onTapObscuredMediaToggleZQwuxwg(@NotNull String messageId, long j10, boolean z10, String str, String str2) {
        Intrinsics.checkNotNullParameter(messageId, "messageId");
        this.emitReactEvent.invoke(new TapObscuredMediaToggleData(MessageId.m1090toStringimpl(messageId), ChannelId.m1064toStringimpl(j10), String.valueOf(str), String.valueOf(str2), z10));
    }
    ...
    public void mo470onTapPollActionsekaTiM(long j10, @NotNull String messageId, @NotNull String type) {
        Intrinsics.checkNotNullParameter(messageId, "messageId");
        Intrinsics.checkNotNullParameter(type, "type");
        this.emitReactEvent.invoke(new TapPollAction(ChannelId.m1064toStringimpl(j10), MessageId.m1090toStringimpl(messageId), type));
    }
    ...
    public void mo471onTapPollAnswersekaTiM(long j10, @NotNull String messageId, @NotNull String answerId) {
        ...
        this.emitReactEvent.invoke(new TapPollAnswer(ChannelId.m1064toStringimpl(j10), MessageId.m1090toStringimpl(messageId), answerId));
    }
    ...
    public void mo472onTapPollSubmitVote0eiqbug(long j10, @NotNull String messageId) {
        Intrinsics.checkNotNullParameter(messageId, "messageId");
        this.emitReactEvent.invoke(new TapPollSubmitVote(ChannelId.m1064toStringimpl(j10), MessageId.m1090toStringimpl(messageId)));
    }
    ...
    public void mo473onTapPostPreviewEmbedkUTrps(long j10, long j11, long j12, @NotNull String messageId) {
        Intrinsics.checkNotNullParameter(messageId, "messageId");
        this.emitReactEvent.invoke(new TapPostPreviewEmbedData(GuildId.m1077toStringimpl(j10), ChannelId.m1064toStringimpl(j11), ChannelId.m1064toStringimpl(j12), messageId, null));
    }
    ...
    public void mo476onTapReactionOverflowpfaIj0E(@NotNull String messageId, long j10) {
        Intrinsics.checkNotNullParameter(messageId, "messageId");
        this.emitReactEvent.invoke(new TapReactionOverflow(MessageId.m1090toStringimpl(messageId), ChannelId.m1064toStringimpl(j10)));
    }
    ...
    public void mo479onTapShareForumPostmgk6anA(long j10, long j11) {
        this.emitReactEvent.invoke(new TapShareForumPost(ChannelId.m1064toStringimpl(j10), GuildId.m1077toStringimpl(j11)));
    }
    ...
    public void onTapSoundmoji(@NotNull SoundmojiContentNode node) {
        Intrinsics.checkNotNullParameter(node, "node");
        this.emitReactEvent.invoke(new TapSoundmojiData(node.getSoundId(), ChannelId.m1064toStringimpl(node.m374getChannelIdo4g7jtM()), node.getGuildId(), node.m375getMessageId3Eiw7ao(), null));
    }
    ...
    public void mo480onTapSummarysekaTiM(long j10, @NotNull String messageId, @NotNull String summaryId) {
        ...
        this.emitReactEvent.invoke(new TapSummaryData(ChannelId.m1064toStringimpl(j10), MessageId.m1090toStringimpl(messageId), summaryId));
    }
    ...
    public void mo481onTapSummaryJumpsekaTiM(long j10, @NotNull String messageId, @NotNull String summaryId) {
        Intrinsics.checkNotNullParameter(messageId, "messageId");
        Intrinsics.checkNotNullParameter(summaryId, "summaryId");
        this.emitReactEvent.invoke(new TapSummaryJumpData(ChannelId.m1064toStringimpl(j10), MessageId.m1090toStringimpl(messageId), summaryId));
    }
    ...
    public void mo484onTapToggleBlockedMessages1xi1bu0(@NotNull String messageId) {
        Intrinsics.checkNotNullParameter(messageId, "messageId");
        this.emitReactEvent.invoke(new TapSeparatorData("toggle", MessageId.m1090toStringimpl(messageId)));
    }
    ...
    public void mo485onTapUsernamex5gers8(@NotNull String messageId, long j10) {
        Intrinsics.checkNotNullParameter(messageId, "messageId");
        this.emitReactEvent.invoke(new TapUsernameData(MessageId.m1090toStringimpl(messageId), UserId.m1142toStringimpl(j10)));
    }
