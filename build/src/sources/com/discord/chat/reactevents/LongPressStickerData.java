...
public final class LongPressStickerData implements ReactEvent {
    ...
    public static /* synthetic */ LongPressStickerData m757copyntcYbpo$default(LongPressStickerData longPressStickerData, String str, Sticker sticker, int i10, Object obj) {
        if ((i10 & 1) != 0) {
        ...
        return longPressStickerData.m759copyntcYbpo(str, sticker);
    }

    @NotNull
    /* renamed from: component1-3Eiw7ao  reason: not valid java name */
    public final String m758component13Eiw7ao() {
    ...
    public final LongPressStickerData m759copyntcYbpo(@NotNull String messageId, @NotNull Sticker sticker) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof LongPressStickerData) {
            ...
            return MessageId.m1088equalsimpl0(this.messageId, longPressStickerData.messageId) && Intrinsics.areEqual(this.sticker, longPressStickerData.sticker);
        }
        return false;
    }
    ...
    public final String m760getMessageId3Eiw7ao() {
        return this.messageId;
    }
    ...
    public String toString() {
        ...
        return "LongPressStickerData(messageId=" + m1091toStringimpl + ", sticker=" + sticker + ")";
    }
