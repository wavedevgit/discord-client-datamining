...
public final class TapButtonActionComponent implements ReactEvent {
    ...
    public static final /* synthetic */ void write$Self$chat_release(TapButtonActionComponent tapButtonActionComponent, CompositeEncoder compositeEncoder, SerialDescriptor serialDescriptor) {
        compositeEncoder.s(serialDescriptor, 0, MessageId$$serializer.INSTANCE, MessageId.m1083boximpl(tapButtonActionComponent.messageId));
        compositeEncoder.z(serialDescriptor, 1, tapButtonActionComponent.componentId);
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof TapButtonActionComponent) {
            ...
            return MessageId.m1087equalsimpl0(this.messageId, tapButtonActionComponent.messageId) && Intrinsics.areEqual(this.componentId, tapButtonActionComponent.componentId);
        }
        return false;
    }
    ...
    public String toString() {
        ...
        return "TapButtonActionComponent(messageId=" + m1090toStringimpl + ", componentId=" + str + ")";
    }
