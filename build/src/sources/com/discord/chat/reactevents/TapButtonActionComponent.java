...
public final class TapButtonActionComponent implements ReactEvent {
    ...
    public static /* synthetic */ TapButtonActionComponent m786copyntcYbpo$default(TapButtonActionComponent tapButtonActionComponent, String str, String str2, int i10, Object obj) {
        if ((i10 & 1) != 0) {
        ...
        return tapButtonActionComponent.m788copyntcYbpo(str, str2);
    }
    ...
    public static final /* synthetic */ void write$Self$chat_release(TapButtonActionComponent tapButtonActionComponent, CompositeEncoder compositeEncoder, SerialDescriptor serialDescriptor) {
        compositeEncoder.m(serialDescriptor, 0, MessageId$$serializer.INSTANCE, MessageId.m1086boximpl(tapButtonActionComponent.messageId));
        compositeEncoder.x(serialDescriptor, 1, tapButtonActionComponent.componentId);
    }

    @NotNull
    /* renamed from: component1-3Eiw7ao  reason: not valid java name */
    public final String m787component13Eiw7ao() {
    ...
    public final TapButtonActionComponent m788copyntcYbpo(@NotNull String messageId, @NotNull String componentId) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof TapButtonActionComponent) {
            ...
            return MessageId.m1090equalsimpl0(this.messageId, tapButtonActionComponent.messageId) && Intrinsics.areEqual(this.componentId, tapButtonActionComponent.componentId);
        }
        return false;
    }
    ...
    public final String m789getMessageId3Eiw7ao() {
        return this.messageId;
    }
    ...
    public String toString() {
        ...
        return "TapButtonActionComponent(messageId=" + m1093toStringimpl + ", componentId=" + str + ")";
    }
