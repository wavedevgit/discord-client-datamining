...
public final class MediaAttachmentPlaybackStartedData implements ReactEvent {
    ...
    public static /* synthetic */ MediaAttachmentPlaybackStartedData m766copyjd4C3YQ$default(MediaAttachmentPlaybackStartedData mediaAttachmentPlaybackStartedData, String str, float f10, float f11, long j10, boolean z10, String str2, int i10, Object obj) {
        if ((i10 & 1) != 0) {
        ...
        long j11 = j10;
        float f12 = f11;
        return mediaAttachmentPlaybackStartedData.m769copyjd4C3YQ(str, f10, f12, j11, z10, str2);
    }
    ...
    public static final /* synthetic */ void write$Self$chat_release(MediaAttachmentPlaybackStartedData mediaAttachmentPlaybackStartedData, CompositeEncoder compositeEncoder, SerialDescriptor serialDescriptor) {
        compositeEncoder.F(serialDescriptor, 0, MessageId$$serializer.INSTANCE, MessageId.m1083boximpl(mediaAttachmentPlaybackStartedData.messageId));
        compositeEncoder.s(serialDescriptor, 1, mediaAttachmentPlaybackStartedData.totalDurationSecs);
        compositeEncoder.s(serialDescriptor, 2, mediaAttachmentPlaybackStartedData.startDurationSecs);
        compositeEncoder.F(serialDescriptor, 3, UserId$$serializer.INSTANCE, UserId.m1135boximpl(mediaAttachmentPlaybackStartedData.senderUserId));
    ...
    public final String m767component13Eiw7ao() {
    ...
    public final long m768component4re6GcUE() {
    ...
    public final MediaAttachmentPlaybackStartedData m769copyjd4C3YQ(@NotNull String messageId, float f10, float f11, long j10, boolean z10, @NotNull String attachmentId) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof MediaAttachmentPlaybackStartedData) {
            ...
            return MessageId.m1087equalsimpl0(this.messageId, mediaAttachmentPlaybackStartedData.messageId) && Float.compare(this.totalDurationSecs, mediaAttachmentPlaybackStartedData.totalDurationSecs) == 0 && Float.compare(this.startDurationSecs, mediaAttachmentPlaybackStartedData.startDurationSecs) == 0 && UserId.m1139equalsimpl0(this.senderUserId, mediaAttachmentPlaybackStartedData.senderUserId) && this.isVoiceMessage == mediaAttachmentPlaybackStartedData.isVoiceMessage && Intrinsics.areEqual(this.attachmentId, mediaAttachmentPlaybackStartedData.attachmentId);
        }
        return false;
    }
    ...
    public final String m770getMessageId3Eiw7ao() {
        return this.messageId;
    }

    /* renamed from: getSenderUserId-re6GcUE  reason: not valid java name */
    public final long m771getSenderUserIdre6GcUE() {
        return this.senderUserId;
    }
    ...
    public int hashCode() {
        return (((((((((MessageId.m1088hashCodeimpl(this.messageId) * 31) + Float.hashCode(this.totalDurationSecs)) * 31) + Float.hashCode(this.startDurationSecs)) * 31) + UserId.m1140hashCodeimpl(this.senderUserId)) * 31) + Boolean.hashCode(this.isVoiceMessage)) * 31) + this.attachmentId.hashCode();
    }
    ...
    public String toString() {
        ...
        String m1142toStringimpl = UserId.m1142toStringimpl(this.senderUserId);
        boolean z10 = this.isVoiceMessage;
        String str = this.attachmentId;
        return "MediaAttachmentPlaybackStartedData(messageId=" + m1090toStringimpl + ", totalDurationSecs=" + f10 + ", startDurationSecs=" + f11 + ", senderUserId=" + m1142toStringimpl + ", isVoiceMessage=" + z10 + ", attachmentId=" + str + ")";
    }
    ...
    private /* synthetic */ MediaAttachmentPlaybackStartedData(int i10, String str, float f10, float f11, UserId userId, boolean z10, String str2, SerializationConstructorMarker serializationConstructorMarker) {
        ...
        this.senderUserId = userId.m1144unboximpl();
