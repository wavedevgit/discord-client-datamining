...
public final class MediaAttachmentPlaybackStartedData implements ReactEvent {
    ...
    public static final /* synthetic */ void write$Self$chat_release(MediaAttachmentPlaybackStartedData mediaAttachmentPlaybackStartedData, CompositeEncoder compositeEncoder, SerialDescriptor serialDescriptor) {
        compositeEncoder.j(serialDescriptor, 0, MessageId$$serializer.INSTANCE, MessageId.m1084boximpl(mediaAttachmentPlaybackStartedData.messageId));
        ...
        compositeEncoder.j(serialDescriptor, 3, UserId$$serializer.INSTANCE, UserId.m1136boximpl(mediaAttachmentPlaybackStartedData.senderUserId));
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof MediaAttachmentPlaybackStartedData) {
            ...
            return MessageId.m1088equalsimpl0(this.messageId, mediaAttachmentPlaybackStartedData.messageId) && Float.compare(this.totalDurationSecs, mediaAttachmentPlaybackStartedData.totalDurationSecs) == 0 && Float.compare(this.startDurationSecs, mediaAttachmentPlaybackStartedData.startDurationSecs) == 0 && UserId.m1140equalsimpl0(this.senderUserId, mediaAttachmentPlaybackStartedData.senderUserId) && this.isVoiceMessage == mediaAttachmentPlaybackStartedData.isVoiceMessage && Intrinsics.areEqual(this.attachmentId, mediaAttachmentPlaybackStartedData.attachmentId);
        }
        return false;
    }
    ...
    public int hashCode() {
        return (((((((((MessageId.m1089hashCodeimpl(this.messageId) * 31) + Float.hashCode(this.totalDurationSecs)) * 31) + Float.hashCode(this.startDurationSecs)) * 31) + UserId.m1141hashCodeimpl(this.senderUserId)) * 31) + Boolean.hashCode(this.isVoiceMessage)) * 31) + this.attachmentId.hashCode();
    }
    ...
    public String toString() {
        ...
        return "MediaAttachmentPlaybackStartedData(messageId=" + m1091toStringimpl + ", totalDurationSecs=" + f10 + ", startDurationSecs=" + f11 + ", senderUserId=" + m1143toStringimpl + ", isVoiceMessage=" + z10 + ", attachmentId=" + str + ")";
    }
