...
public final class MediaAttachmentPlaybackStartedData implements ReactEvent {
    ...
    public static final /* synthetic */ void write$Self$chat_release(MediaAttachmentPlaybackStartedData mediaAttachmentPlaybackStartedData, CompositeEncoder compositeEncoder, SerialDescriptor serialDescriptor) {
        compositeEncoder.s(serialDescriptor, 0, MessageId$$serializer.INSTANCE, MessageId.m1083boximpl(mediaAttachmentPlaybackStartedData.messageId));
        ...
        compositeEncoder.s(serialDescriptor, 3, UserId$$serializer.INSTANCE, UserId.m1135boximpl(mediaAttachmentPlaybackStartedData.senderUserId));
        compositeEncoder.y(serialDescriptor, 4, mediaAttachmentPlaybackStartedData.isVoiceMessage);
        compositeEncoder.z(serialDescriptor, 5, mediaAttachmentPlaybackStartedData.attachmentId);
    }
