...
public final class MediaAttachmentPlaybackStartedData implements ReactEvent {
    ...
    public static /* synthetic */ MediaAttachmentPlaybackStartedData m767copyjd4C3YQ$default(MediaAttachmentPlaybackStartedData mediaAttachmentPlaybackStartedData, String str, float f10, float f11, long j10, boolean z10, String str2, int i10, Object obj) {
        if ((i10 & 1) != 0) {
        ...
        long j11 = j10;
        float f12 = f11;
        return mediaAttachmentPlaybackStartedData.m770copyjd4C3YQ(str, f10, f12, j11, z10, str2);
    }
    ...
    public static final /* synthetic */ void write$Self$chat_release(MediaAttachmentPlaybackStartedData mediaAttachmentPlaybackStartedData, CompositeEncoder compositeEncoder, SerialDescriptor serialDescriptor) {
        compositeEncoder.k(serialDescriptor, 0, MessageId$$serializer.INSTANCE, MessageId.m1084boximpl(mediaAttachmentPlaybackStartedData.messageId));
        ...
        compositeEncoder.k(serialDescriptor, 3, UserId$$serializer.INSTANCE, UserId.m1136boximpl(mediaAttachmentPlaybackStartedData.senderUserId));
    ...
    public final String m768component13Eiw7ao() {
    ...
    public final long m769component4re6GcUE() {
    ...
    public final MediaAttachmentPlaybackStartedData m770copyjd4C3YQ(@NotNull String messageId, float f10, float f11, long j10, boolean z10, @NotNull String attachmentId) {
    ...
    public final String m771getMessageId3Eiw7ao() {
        return this.messageId;
    }

    /* renamed from: getSenderUserId-re6GcUE  reason: not valid java name */
    public final long m772getSenderUserIdre6GcUE() {
        return this.senderUserId;
    }
