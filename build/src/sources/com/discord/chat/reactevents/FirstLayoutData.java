...
public final class FirstLayoutData implements ReactEvent {
    ...
    public static final /* synthetic */ void write$Self$chat_release(FirstLayoutData firstLayoutData, CompositeEncoder compositeEncoder, SerialDescriptor serialDescriptor) {
        compositeEncoder.v(serialDescriptor, 0, firstLayoutData.firstVisibleMessageIndex);
        x xVar = x.f25356a;
        compositeEncoder.A(serialDescriptor, 1, xVar, firstLayoutData.firstVisibleMessagePercentVisible);
        compositeEncoder.v(serialDescriptor, 2, firstLayoutData.lastVisibleMessageIndex);
        compositeEncoder.A(serialDescriptor, 3, xVar, firstLayoutData.lastVisibleMessagePercentVisible);
    }
