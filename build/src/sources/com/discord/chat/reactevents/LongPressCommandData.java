...
public final class LongPressCommandData implements ReactEvent {
    ...
    public static final /* synthetic */ void write$Self$chat_release(LongPressCommandData longPressCommandData, CompositeEncoder compositeEncoder, SerialDescriptor serialDescriptor) {
        compositeEncoder.y(serialDescriptor, 0, longPressCommandData.channelId);
        compositeEncoder.y(serialDescriptor, 1, longPressCommandData.commandId);
        compositeEncoder.y(serialDescriptor, 2, longPressCommandData.commandName);
        compositeEncoder.y(serialDescriptor, 3, longPressCommandData.commandKey);
    }
