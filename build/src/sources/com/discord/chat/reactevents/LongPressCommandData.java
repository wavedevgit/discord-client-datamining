...
public final class LongPressCommandData implements ReactEvent {
    ...
    public /* synthetic */ LongPressCommandData(int i10, String str, String str2, String str3, String str4, SerializationConstructorMarker serializationConstructorMarker) {
        if (15 != (i10 & 15)) {
            v1.b(i10, 15, LongPressCommandData$$serializer.INSTANCE.getDescriptor());
        }
        this.channelId = str;
        this.commandId = str2;
    ...
    public static final /* synthetic */ void write$Self$chat_release(LongPressCommandData longPressCommandData, CompositeEncoder compositeEncoder, SerialDescriptor serialDescriptor) {
        compositeEncoder.x(serialDescriptor, 0, longPressCommandData.channelId);
        compositeEncoder.x(serialDescriptor, 1, longPressCommandData.commandId);
        compositeEncoder.x(serialDescriptor, 2, longPressCommandData.commandName);
        compositeEncoder.x(serialDescriptor, 3, longPressCommandData.commandKey);
    }
