...
public final class LongPressCommandData implements ReactEvent {
    ...
    public static final /* synthetic */ void write$Self$chat_release(LongPressCommandData longPressCommandData, CompositeEncoder compositeEncoder, SerialDescriptor serialDescriptor) {
        compositeEncoder.z(serialDescriptor, 0, longPressCommandData.channelId);
        compositeEncoder.z(serialDescriptor, 1, longPressCommandData.commandId);
        compositeEncoder.z(serialDescriptor, 2, longPressCommandData.commandName);
        compositeEncoder.z(serialDescriptor, 3, longPressCommandData.commandKey);
    }
