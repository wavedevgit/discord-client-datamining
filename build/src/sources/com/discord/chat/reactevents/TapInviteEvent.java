...
public final class TapInviteEvent implements ReactEvent {
    ...
    public static final /* synthetic */ void write$Self$chat_release(TapInviteEvent tapInviteEvent, CompositeEncoder compositeEncoder, SerialDescriptor serialDescriptor) {
        compositeEncoder.x(serialDescriptor, 0, tapInviteEvent.messageId);
        compositeEncoder.v(serialDescriptor, 1, tapInviteEvent.index);
        h hVar = h.f25266a;
        compositeEncoder.A(serialDescriptor, 2, hVar, tapInviteEvent.primary);
        compositeEncoder.A(serialDescriptor, 3, hVar, tapInviteEvent.secondary);
    }
