...
public final class InitiateEditData implements ReactEvent {
    ...
    public /* synthetic */ InitiateEditData(int i10, String str, ChannelId channelId, SerializationConstructorMarker serializationConstructorMarker, DefaultConstructorMarker defaultConstructorMarker) {
        this(i10, str, channelId, serializationConstructorMarker);
    }

    /* renamed from: copy-pfaIj0E$default  reason: not valid java name */
    public static /* synthetic */ InitiateEditData m732copypfaIj0E$default(InitiateEditData initiateEditData, String str, long j10, int i10, Object obj) {
        if ((i10 & 1) != 0) {
        ...
        return initiateEditData.m735copypfaIj0E(str, j10);
    }
    ...
    public static final /* synthetic */ void write$Self$chat_release(InitiateEditData initiateEditData, CompositeEncoder compositeEncoder, SerialDescriptor serialDescriptor) {
        compositeEncoder.s(serialDescriptor, 0, MessageId$$serializer.INSTANCE, MessageId.m1083boximpl(initiateEditData.messageId));
        compositeEncoder.s(serialDescriptor, 1, ChannelId$$serializer.INSTANCE, ChannelId.m1057boximpl(initiateEditData.channelId));
    }

    @NotNull
    /* renamed from: component1-3Eiw7ao  reason: not valid java name */
    public final String m733component13Eiw7ao() {
        return this.messageId;
    }

    /* renamed from: component2-o4g7jtM  reason: not valid java name */
    public final long m734component2o4g7jtM() {
        return this.channelId;
    }

    @NotNull
    /* renamed from: copy-pfaIj0E  reason: not valid java name */
    public final InitiateEditData m735copypfaIj0E(@NotNull String messageId, long j10) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof InitiateEditData) {
            ...
            return MessageId.m1087equalsimpl0(this.messageId, initiateEditData.messageId) && ChannelId.m1061equalsimpl0(this.channelId, initiateEditData.channelId);
        }
        return false;
    }

    /* renamed from: getChannelId-o4g7jtM  reason: not valid java name */
    public final long m736getChannelIdo4g7jtM() {
        return this.channelId;
    }

    @NotNull
    /* renamed from: getMessageId-3Eiw7ao  reason: not valid java name */
    public final String m737getMessageId3Eiw7ao() {
        return this.messageId;
    }

    public int hashCode() {
        return (MessageId.m1088hashCodeimpl(this.messageId) * 31) + ChannelId.m1062hashCodeimpl(this.channelId);
    }
    ...
    public String toString() {
        ...
        return "InitiateEditData(messageId=" + m1090toStringimpl + ", channelId=" + m1064toStringimpl + ")";
    }
    ...
    private /* synthetic */ InitiateEditData(int i10, String str, ChannelId channelId, SerializationConstructorMarker serializationConstructorMarker) {
        if (3 != (i10 & 3)) {
