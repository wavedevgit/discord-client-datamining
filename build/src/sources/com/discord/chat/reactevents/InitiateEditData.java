...
public final class InitiateEditData implements ReactEvent {
    ...
    public static final /* synthetic */ void write$Self$chat_release(InitiateEditData initiateEditData, CompositeEncoder compositeEncoder, SerialDescriptor serialDescriptor) {
        compositeEncoder.F(serialDescriptor, 0, MessageId$$serializer.INSTANCE, MessageId.m1083boximpl(initiateEditData.messageId));
        compositeEncoder.F(serialDescriptor, 1, ChannelId$$serializer.INSTANCE, ChannelId.m1057boximpl(initiateEditData.channelId));
    }
