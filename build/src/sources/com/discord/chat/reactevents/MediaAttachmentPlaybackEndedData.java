...
public final class MediaAttachmentPlaybackEndedData implements ReactEvent {
    ...
    public static /* synthetic */ MediaAttachmentPlaybackEndedData m761copyO97gnAM$default(MediaAttachmentPlaybackEndedData mediaAttachmentPlaybackEndedData, String str, float f10, float f11, long j10, float f12, boolean z10, String str2, int i10, Object obj) {
        if ((i10 & 1) != 0) {
        ...
        long j11 = j10;
        float f14 = f11;
        return mediaAttachmentPlaybackEndedData.m764copyO97gnAM(str, f10, f14, j11, f13, z10, str3);
    }
    ...
    public static final /* synthetic */ void write$Self$chat_release(MediaAttachmentPlaybackEndedData mediaAttachmentPlaybackEndedData, CompositeEncoder compositeEncoder, SerialDescriptor serialDescriptor) {
        compositeEncoder.k(serialDescriptor, 0, MessageId$$serializer.INSTANCE, MessageId.m1084boximpl(mediaAttachmentPlaybackEndedData.messageId));
        ...
        compositeEncoder.k(serialDescriptor, 3, UserId$$serializer.INSTANCE, UserId.m1136boximpl(mediaAttachmentPlaybackEndedData.senderUserId));
    ...
    public final String m762component13Eiw7ao() {
    ...
    public final long m763component4re6GcUE() {
    ...
    public final MediaAttachmentPlaybackEndedData m764copyO97gnAM(@NotNull String messageId, float f10, float f11, long j10, float f12, boolean z10, @NotNull String attachmentId) {
    ...
    public final String m765getMessageId3Eiw7ao() {
        return this.messageId;
    }

    /* renamed from: getSenderUserId-re6GcUE  reason: not valid java name */
    public final long m766getSenderUserIdre6GcUE() {
        return this.senderUserId;
    }
