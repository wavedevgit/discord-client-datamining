...
public final class TapConnectionsRoleTagData implements ReactEvent {
    ...
    public static final /* synthetic */ void write$Self$chat_release(TapConnectionsRoleTagData tapConnectionsRoleTagData, CompositeEncoder compositeEncoder, SerialDescriptor serialDescriptor) {
        compositeEncoder.y(serialDescriptor, 0, tapConnectionsRoleTagData.userId);
        compositeEncoder.y(serialDescriptor, 1, tapConnectionsRoleTagData.guildId);
        compositeEncoder.y(serialDescriptor, 2, tapConnectionsRoleTagData.channelId);
        compositeEncoder.y(serialDescriptor, 3, tapConnectionsRoleTagData.roleId);
    }
