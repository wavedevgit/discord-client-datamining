...
public final class TapConnectionsRoleTagData implements ReactEvent {
    ...
    public static final /* synthetic */ void write$Self$chat_release(TapConnectionsRoleTagData tapConnectionsRoleTagData, CompositeEncoder compositeEncoder, SerialDescriptor serialDescriptor) {
        compositeEncoder.z(serialDescriptor, 0, tapConnectionsRoleTagData.userId);
        compositeEncoder.z(serialDescriptor, 1, tapConnectionsRoleTagData.guildId);
        compositeEncoder.z(serialDescriptor, 2, tapConnectionsRoleTagData.channelId);
        compositeEncoder.z(serialDescriptor, 3, tapConnectionsRoleTagData.roleId);
    }
