...
public final class TapGiftCodeAcceptData implements ReactEvent {
    ...
    public static final /* synthetic */ void write$Self$chat_release(TapGiftCodeAcceptData tapGiftCodeAcceptData, CompositeEncoder compositeEncoder, SerialDescriptor serialDescriptor) {
        MessageId messageId;
        compositeEncoder.y(serialDescriptor, 0, tapGiftCodeAcceptData.giftCode);
    ...
    public int hashCode() {
        ...
        String str = this.messageId;
        return hashCode + (str == null ? 0 : MessageId.m1089hashCodeimpl(str));
    }
    ...
    public String toString() {
        ...
        return "TapGiftCodeAcceptData(giftCode=" + str + ", messageId=" + m1091toStringimpl + ")";
    }
