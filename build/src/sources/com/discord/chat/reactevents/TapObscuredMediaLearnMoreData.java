...
public final class TapObscuredMediaLearnMoreData implements ReactEvent {
    ...
    public static final /* synthetic */ void write$Self$chat_release(TapObscuredMediaLearnMoreData tapObscuredMediaLearnMoreData, CompositeEncoder compositeEncoder, SerialDescriptor serialDescriptor) {
        compositeEncoder.y(serialDescriptor, 0, tapObscuredMediaLearnMoreData.messageId);
        compositeEncoder.y(serialDescriptor, 1, tapObscuredMediaLearnMoreData.channelId);
        compositeEncoder.y(serialDescriptor, 2, tapObscuredMediaLearnMoreData.attachmentId);
        compositeEncoder.y(serialDescriptor, 3, tapObscuredMediaLearnMoreData.embedId);
    }
