...
public final class TapObscuredMediaLearnMoreData implements ReactEvent {
    ...
    public static final /* synthetic */ void write$Self$chat_release(TapObscuredMediaLearnMoreData tapObscuredMediaLearnMoreData, CompositeEncoder compositeEncoder, SerialDescriptor serialDescriptor) {
        compositeEncoder.z(serialDescriptor, 0, tapObscuredMediaLearnMoreData.messageId);
        compositeEncoder.z(serialDescriptor, 1, tapObscuredMediaLearnMoreData.channelId);
        compositeEncoder.z(serialDescriptor, 2, tapObscuredMediaLearnMoreData.attachmentId);
        compositeEncoder.z(serialDescriptor, 3, tapObscuredMediaLearnMoreData.embedId);
    }
