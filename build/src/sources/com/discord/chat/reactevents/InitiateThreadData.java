...
public final class InitiateThreadData implements ReactEvent {
    ...
    public static final /* synthetic */ void write$Self$chat_release(InitiateThreadData initiateThreadData, CompositeEncoder compositeEncoder, SerialDescriptor serialDescriptor) {
        compositeEncoder.F(serialDescriptor, 0, MessageId$$serializer.INSTANCE, MessageId.m1083boximpl(initiateThreadData.messageId));
        compositeEncoder.F(serialDescriptor, 1, ChannelId$$serializer.INSTANCE, ChannelId.m1057boximpl(initiateThreadData.channelId));
    }
