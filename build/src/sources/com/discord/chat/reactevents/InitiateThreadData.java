...
public final class InitiateThreadData implements ReactEvent {
    ...
    public static final /* synthetic */ void write$Self$chat_release(InitiateThreadData initiateThreadData, CompositeEncoder compositeEncoder, SerialDescriptor serialDescriptor) {
        compositeEncoder.s(serialDescriptor, 0, MessageId$$serializer.INSTANCE, MessageId.m1083boximpl(initiateThreadData.messageId));
        compositeEncoder.s(serialDescriptor, 1, ChannelId$$serializer.INSTANCE, ChannelId.m1057boximpl(initiateThreadData.channelId));
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof InitiateThreadData) {
            ...
            return MessageId.m1087equalsimpl0(this.messageId, initiateThreadData.messageId) && ChannelId.m1061equalsimpl0(this.channelId, initiateThreadData.channelId);
        }
        return false;
    }
    ...
    public String toString() {
        ...
        return "InitiateThreadData(messageId=" + m1090toStringimpl + ", channelId=" + m1064toStringimpl + ")";
    }
