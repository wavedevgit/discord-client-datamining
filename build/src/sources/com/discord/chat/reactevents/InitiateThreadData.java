...
public final class InitiateThreadData implements ReactEvent {
    ...
    public static final /* synthetic */ void write$Self$chat_release(InitiateThreadData initiateThreadData, CompositeEncoder compositeEncoder, SerialDescriptor serialDescriptor) {
        compositeEncoder.m(serialDescriptor, 0, MessageId$$serializer.INSTANCE, MessageId.m1086boximpl(initiateThreadData.messageId));
        compositeEncoder.m(serialDescriptor, 1, ChannelId$$serializer.INSTANCE, ChannelId.m1060boximpl(initiateThreadData.channelId));
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof InitiateThreadData) {
            ...
            return MessageId.m1090equalsimpl0(this.messageId, initiateThreadData.messageId) && ChannelId.m1064equalsimpl0(this.channelId, initiateThreadData.channelId);
        }
        return false;
    }
    ...
    public String toString() {
        ...
        return "InitiateThreadData(messageId=" + m1093toStringimpl + ", channelId=" + m1067toStringimpl + ")";
    }
