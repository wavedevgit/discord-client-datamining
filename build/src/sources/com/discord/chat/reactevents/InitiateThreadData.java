...
public final class InitiateThreadData implements ReactEvent {
    ...
    public static /* synthetic */ InitiateThreadData m744copypfaIj0E$default(InitiateThreadData initiateThreadData, String str, long j10, int i10, Object obj) {
        if ((i10 & 1) != 0) {
        ...
        return initiateThreadData.m747copypfaIj0E(str, j10);
    }
    ...
    public static final /* synthetic */ void write$Self$chat_release(InitiateThreadData initiateThreadData, CompositeEncoder compositeEncoder, SerialDescriptor serialDescriptor) {
        compositeEncoder.j(serialDescriptor, 0, MessageId$$serializer.INSTANCE, MessageId.m1084boximpl(initiateThreadData.messageId));
        compositeEncoder.j(serialDescriptor, 1, ChannelId$$serializer.INSTANCE, ChannelId.m1058boximpl(initiateThreadData.channelId));
    }

    @NotNull
    /* renamed from: component1-3Eiw7ao  reason: not valid java name */
    public final String m745component13Eiw7ao() {
        return this.messageId;
    }

    /* renamed from: component2-o4g7jtM  reason: not valid java name */
    public final long m746component2o4g7jtM() {
        return this.channelId;
    }

    @NotNull
    /* renamed from: copy-pfaIj0E  reason: not valid java name */
    public final InitiateThreadData m747copypfaIj0E(@NotNull String messageId, long j10) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof InitiateThreadData) {
            ...
            return MessageId.m1088equalsimpl0(this.messageId, initiateThreadData.messageId) && ChannelId.m1062equalsimpl0(this.channelId, initiateThreadData.channelId);
        }
        return false;
    }

    /* renamed from: getChannelId-o4g7jtM  reason: not valid java name */
    public final long m748getChannelIdo4g7jtM() {
        return this.channelId;
    }

    @NotNull
    /* renamed from: getMessageId-3Eiw7ao  reason: not valid java name */
    public final String m749getMessageId3Eiw7ao() {
        return this.messageId;
    }
    ...
    public String toString() {
        ...
        return "InitiateThreadData(messageId=" + m1091toStringimpl + ", channelId=" + m1065toStringimpl + ")";
    }
