...
public final class TapReactionData implements ReactEvent {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof TapReactionData) {
            ...
            return MessageId.m1089equalsimpl0(this.messageId, tapReactionData.messageId) && Intrinsics.areEqual(this.reaction, tapReactionData.reaction) && Intrinsics.areEqual(this.isBurst, tapReactionData.isBurst) && Intrinsics.areEqual(this.location, tapReactionData.location);
        }
        return false;
    }
    ...
    public int hashCode() {
        ...
        int hashCode = (m1090hashCodeimpl + (reaction == null ? 0 : reaction.hashCode())) * 31;
    ...
    public String toString() {
        ...
        Boolean bool = this.isBurst;
        String str = this.location;
        return "TapReactionData(messageId=" + m1092toStringimpl + ", reaction=" + reaction + ", isBurst=" + bool + ", location=" + str + ")";
    }
