...
public final class TapPostPreviewEmbedData implements ReactEvent {
    ...
    public static /* synthetic */ TapPostPreviewEmbedData m819copywInV0_I$default(TapPostPreviewEmbedData tapPostPreviewEmbedData, String str, String str2, String str3, String str4, int i10, Object obj) {
        if ((i10 & 1) != 0) {
        ...
        return tapPostPreviewEmbedData.m821copywInV0_I(str, str2, str3, str4);
    }
    ...
    public static final /* synthetic */ void write$Self$chat_release(TapPostPreviewEmbedData tapPostPreviewEmbedData, CompositeEncoder compositeEncoder, SerialDescriptor serialDescriptor) {
        ...
        compositeEncoder.k(serialDescriptor, 3, MessageId$$serializer.INSTANCE, MessageId.m1084boximpl(tapPostPreviewEmbedData.messageId));
    }
    ...
    public final String m820component43Eiw7ao() {
        return this.messageId;
    }

    @NotNull
    /* renamed from: copy-wInV0_I  reason: not valid java name */
    public final TapPostPreviewEmbedData m821copywInV0_I(@NotNull String guildId, @NotNull String parentChannelId, @NotNull String threadId, @NotNull String messageId) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof TapPostPreviewEmbedData) {
            ...
            return Intrinsics.areEqual(this.guildId, tapPostPreviewEmbedData.guildId) && Intrinsics.areEqual(this.parentChannelId, tapPostPreviewEmbedData.parentChannelId) && Intrinsics.areEqual(this.threadId, tapPostPreviewEmbedData.threadId) && MessageId.m1088equalsimpl0(this.messageId, tapPostPreviewEmbedData.messageId);
        }
        return false;
    }
    ...
    public final String m822getMessageId3Eiw7ao() {
        return this.messageId;
    }
    ...
    public int hashCode() {
        return (((((this.guildId.hashCode() * 31) + this.parentChannelId.hashCode()) * 31) + this.threadId.hashCode()) * 31) + MessageId.m1089hashCodeimpl(this.messageId);
    }
    ...
    public String toString() {
        ...
        return "TapPostPreviewEmbedData(guildId=" + str + ", parentChannelId=" + str2 + ", threadId=" + str3 + ", messageId=" + m1091toStringimpl + ")";
    }
