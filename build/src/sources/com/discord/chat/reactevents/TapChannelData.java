...
public final class TapChannelData implements ReactEvent {
    ...
    public static final /* synthetic */ void write$Self$chat_release(TapChannelData tapChannelData, CompositeEncoder compositeEncoder, SerialDescriptor serialDescriptor) {
        if (compositeEncoder.y(serialDescriptor, 0) || tapChannelData.guildId != null) {
            compositeEncoder.B(serialDescriptor, 0, n2.f7662a, tapChannelData.guildId);
        }
        if (compositeEncoder.y(serialDescriptor, 1) || tapChannelData.channelId != null) {
            compositeEncoder.B(serialDescriptor, 1, n2.f7662a, tapChannelData.channelId);
        }
        if (compositeEncoder.y(serialDescriptor, 2) || tapChannelData.messageId != null) {
            compositeEncoder.B(serialDescriptor, 2, n2.f7662a, tapChannelData.messageId);
        }
    }
