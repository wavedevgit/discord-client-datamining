...
public final class LongPressMessageEvent implements ReactEvent {
    ...
    public static final /* synthetic */ void write$Self$chat_release(LongPressMessageEvent longPressMessageEvent, CompositeEncoder compositeEncoder, SerialDescriptor serialDescriptor) {
        compositeEncoder.y(serialDescriptor, 0, longPressMessageEvent.messageId);
        compositeEncoder.y(serialDescriptor, 1, longPressMessageEvent.channelId);
        compositeEncoder.w(serialDescriptor, 2, longPressMessageEvent.mediaIndex);
        compositeEncoder.y(serialDescriptor, 3, longPressMessageEvent.mediaType);
        compositeEncoder.s(serialDescriptor, 4, n2.f20978a, longPressMessageEvent.componentId);
        compositeEncoder.s(serialDescriptor, 5, p0.f20994a, longPressMessageEvent.componentMediaIndex);
    }
