...
public final class LongPressMessageEvent implements ReactEvent {
    ...
    public static final /* synthetic */ void write$Self$chat_release(LongPressMessageEvent longPressMessageEvent, CompositeEncoder compositeEncoder, SerialDescriptor serialDescriptor) {
        compositeEncoder.x(serialDescriptor, 0, longPressMessageEvent.messageId);
        compositeEncoder.x(serialDescriptor, 1, longPressMessageEvent.channelId);
        compositeEncoder.v(serialDescriptor, 2, longPressMessageEvent.mediaIndex);
        compositeEncoder.x(serialDescriptor, 3, longPressMessageEvent.mediaType);
        compositeEncoder.A(serialDescriptor, 4, n2.f25302a, longPressMessageEvent.componentId);
        compositeEncoder.A(serialDescriptor, 5, p0.f25318a, longPressMessageEvent.componentMediaIndex);
    }
