...
public final class TapInviteToSpeakData implements ReactEvent {
    ...
    public boolean equals(Object obj) {
        ...
        return (obj instanceof TapInviteToSpeakData) && MessageId.m1087equalsimpl0(this.messageId, ((TapInviteToSpeakData) obj).messageId);
    }
    ...
    public WritableMap serialize() {
        return NativeMapExtensionsKt.nativeMapOf(v.a("messageId", MessageId.m1090toStringimpl(this.messageId)));
    }

    @NotNull
    public String toString() {
        String m1090toStringimpl = MessageId.m1090toStringimpl(this.messageId);
        return "TapInviteToSpeakData(messageId=" + m1090toStringimpl + ")";
    }
