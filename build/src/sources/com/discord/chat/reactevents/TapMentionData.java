...
public final class TapMentionData implements ReactEvent {
    ...
    public static final /* synthetic */ void write$Self$chat_release(TapMentionData tapMentionData, CompositeEncoder compositeEncoder, SerialDescriptor serialDescriptor) {
        n2 n2Var = n2.f7662a;
        compositeEncoder.B(serialDescriptor, 0, n2Var, tapMentionData.userId);
        compositeEncoder.x(serialDescriptor, 1, tapMentionData.channelId);
        compositeEncoder.B(serialDescriptor, 2, n2Var, tapMentionData.roleName);
        compositeEncoder.B(serialDescriptor, 3, n2Var, tapMentionData.parsedUserId);
    }
