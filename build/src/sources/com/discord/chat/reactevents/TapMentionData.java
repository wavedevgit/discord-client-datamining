...
public final class TapMentionData implements ReactEvent {
    ...
    public static final /* synthetic */ void write$Self$chat_release(TapMentionData tapMentionData, CompositeEncoder compositeEncoder, SerialDescriptor serialDescriptor) {
        n2 n2Var = n2.f20978a;
        compositeEncoder.s(serialDescriptor, 0, n2Var, tapMentionData.userId);
        compositeEncoder.y(serialDescriptor, 1, tapMentionData.channelId);
        compositeEncoder.s(serialDescriptor, 2, n2Var, tapMentionData.roleName);
        compositeEncoder.s(serialDescriptor, 3, n2Var, tapMentionData.parsedUserId);
    }
