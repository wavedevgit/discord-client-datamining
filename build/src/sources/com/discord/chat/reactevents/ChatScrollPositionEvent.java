...
public final class ChatScrollPositionEvent implements ReactEvent {
    ...
    public static final /* synthetic */ void write$Self$chat_release(ChatScrollPositionEvent chatScrollPositionEvent, CompositeEncoder compositeEncoder, SerialDescriptor serialDescriptor) {
        compositeEncoder.w(serialDescriptor, 0, chatScrollPositionEvent.isAtBottom);
        compositeEncoder.w(serialDescriptor, 1, chatScrollPositionEvent.isNearBottom);
        compositeEncoder.w(serialDescriptor, 2, chatScrollPositionEvent.isNearTop);
        compositeEncoder.w(serialDescriptor, 3, chatScrollPositionEvent.dragging);
        compositeEncoder.w(serialDescriptor, 4, chatScrollPositionEvent.decelerating);
        compositeEncoder.w(serialDescriptor, 5, chatScrollPositionEvent.shouldShowJumpToPresent);
        compositeEncoder.w(serialDescriptor, 6, chatScrollPositionEvent.isFirstMessageVisible);
        compositeEncoder.v(serialDescriptor, 7, chatScrollPositionEvent.firstVisibleMessageIndex);
        x xVar = x.f7716a;
        compositeEncoder.B(serialDescriptor, 8, xVar, chatScrollPositionEvent.firstVisibleMessagePercentVisible);
        compositeEncoder.v(serialDescriptor, 9, chatScrollPositionEvent.lastVisibleMessageIndex);
        compositeEncoder.B(serialDescriptor, 10, xVar, chatScrollPositionEvent.lastVisibleMessagePercentVisible);
        compositeEncoder.v(serialDescriptor, 11, chatScrollPositionEvent.changesetUpdateId);
    }
