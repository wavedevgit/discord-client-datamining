...
public final class ChatScrollPositionEvent implements ReactEvent {
    ...
    public static final /* synthetic */ void write$Self$chat_release(ChatScrollPositionEvent chatScrollPositionEvent, CompositeEncoder compositeEncoder, SerialDescriptor serialDescriptor) {
        compositeEncoder.x(serialDescriptor, 0, chatScrollPositionEvent.isAtBottom);
        compositeEncoder.x(serialDescriptor, 1, chatScrollPositionEvent.isNearBottom);
        compositeEncoder.x(serialDescriptor, 2, chatScrollPositionEvent.isNearTop);
        compositeEncoder.x(serialDescriptor, 3, chatScrollPositionEvent.dragging);
        compositeEncoder.x(serialDescriptor, 4, chatScrollPositionEvent.decelerating);
        ...
        x xVar = x.f6902a;
        compositeEncoder.z(serialDescriptor, 8, xVar, chatScrollPositionEvent.firstVisibleMessagePercentVisible);
        compositeEncoder.w(serialDescriptor, 9, chatScrollPositionEvent.lastVisibleMessageIndex);
        compositeEncoder.z(serialDescriptor, 10, xVar, chatScrollPositionEvent.lastVisibleMessagePercentVisible);
        compositeEncoder.w(serialDescriptor, 11, chatScrollPositionEvent.changesetUpdateId);
    }
