...
public final class ChatScrollPositionEvent implements ReactEvent {
    ...
    public static final /* synthetic */ void write$Self$chat_release(ChatScrollPositionEvent chatScrollPositionEvent, CompositeEncoder compositeEncoder, SerialDescriptor serialDescriptor) {
        ...
        x xVar = x.f25356a;
        compositeEncoder.A(serialDescriptor, 8, xVar, chatScrollPositionEvent.firstVisibleMessagePercentVisible);
        compositeEncoder.v(serialDescriptor, 9, chatScrollPositionEvent.lastVisibleMessageIndex);
        compositeEncoder.A(serialDescriptor, 10, xVar, chatScrollPositionEvent.lastVisibleMessagePercentVisible);
