...
public final class LongPressChannelData implements ReactEvent {
    ...
    public static final /* synthetic */ void write$Self$chat_release(LongPressChannelData longPressChannelData, CompositeEncoder compositeEncoder, SerialDescriptor serialDescriptor) {
        if (compositeEncoder.y(serialDescriptor, 0) || longPressChannelData.guildId != null) {
            compositeEncoder.B(serialDescriptor, 0, n2.f7662a, longPressChannelData.guildId);
        }
        if (compositeEncoder.y(serialDescriptor, 1) || longPressChannelData.channelId != null) {
            compositeEncoder.B(serialDescriptor, 1, n2.f7662a, longPressChannelData.channelId);
        }
        if (compositeEncoder.y(serialDescriptor, 2) || longPressChannelData.messageId != null) {
            compositeEncoder.B(serialDescriptor, 2, n2.f7662a, longPressChannelData.messageId);
        }
        if (compositeEncoder.y(serialDescriptor, 3) || longPressChannelData.originalLink != null) {
            compositeEncoder.B(serialDescriptor, 3, n2.f7662a, longPressChannelData.originalLink);
        }
    }
