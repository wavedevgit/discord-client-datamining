...
public final class InitiateReplyData implements ReactEvent {
    ...
    public static /* synthetic */ InitiateReplyData m739copy8a0ehIg$default(InitiateReplyData initiateReplyData, String str, long j10, Boolean bool, String str2, int i10, Object obj) {
        if ((i10 & 1) != 0) {
        ...
        return initiateReplyData.m742copy8a0ehIg(str, j10, bool, str2);
    }
    ...
    public static final /* synthetic */ void write$Self$chat_release(InitiateReplyData initiateReplyData, CompositeEncoder compositeEncoder, SerialDescriptor serialDescriptor) {
        compositeEncoder.k(serialDescriptor, 0, MessageId$$serializer.INSTANCE, MessageId.m1084boximpl(initiateReplyData.messageId));
        compositeEncoder.k(serialDescriptor, 1, ChannelId$$serializer.INSTANCE, ChannelId.m1058boximpl(initiateReplyData.channelId));
        if (compositeEncoder.z(serialDescriptor, 2) || !Intrinsics.areEqual(initiateReplyData.triggerHaptic, Boolean.FALSE)) {
            compositeEncoder.o(serialDescriptor, 2, h.f49996a, initiateReplyData.triggerHaptic);
        }
        compositeEncoder.o(serialDescriptor, 3, n2.f50032a, initiateReplyData.location);
    }

    @NotNull
    /* renamed from: component1-3Eiw7ao  reason: not valid java name */
    public final String m740component13Eiw7ao() {
        return this.messageId;
    }

    /* renamed from: component2-o4g7jtM  reason: not valid java name */
    public final long m741component2o4g7jtM() {
    ...
    public final InitiateReplyData m742copy8a0ehIg(@NotNull String messageId, long j10, Boolean bool, String str) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof InitiateReplyData) {
            ...
            return MessageId.m1088equalsimpl0(this.messageId, initiateReplyData.messageId) && ChannelId.m1062equalsimpl0(this.channelId, initiateReplyData.channelId) && Intrinsics.areEqual(this.triggerHaptic, initiateReplyData.triggerHaptic) && Intrinsics.areEqual(this.location, initiateReplyData.location);
        }
        return false;
    }

    /* renamed from: getChannelId-o4g7jtM  reason: not valid java name */
    public final long m743getChannelIdo4g7jtM() {
        return this.channelId;
    }
    ...
    public final String m744getMessageId3Eiw7ao() {
        return this.messageId;
    }
    ...
    public int hashCode() {
        ...
        int hashCode = (m1089hashCodeimpl + (bool == null ? 0 : bool.hashCode())) * 31;
    ...
    public String toString() {
        ...
        Boolean bool = this.triggerHaptic;
        String str = this.location;
        return "InitiateReplyData(messageId=" + m1091toStringimpl + ", channelId=" + m1065toStringimpl + ", triggerHaptic=" + bool + ", location=" + str + ")";
    }
