...
public final class InitiateReplyData implements ReactEvent {
    ...
    public static /* synthetic */ InitiateReplyData m738copy8a0ehIg$default(InitiateReplyData initiateReplyData, String str, long j10, Boolean bool, String str2, int i10, Object obj) {
        if ((i10 & 1) != 0) {
        ...
        return initiateReplyData.m741copy8a0ehIg(str, j10, bool, str2);
    }
    ...
    public static final /* synthetic */ void write$Self$chat_release(InitiateReplyData initiateReplyData, CompositeEncoder compositeEncoder, SerialDescriptor serialDescriptor) {
        compositeEncoder.F(serialDescriptor, 0, MessageId$$serializer.INSTANCE, MessageId.m1083boximpl(initiateReplyData.messageId));
        compositeEncoder.F(serialDescriptor, 1, ChannelId$$serializer.INSTANCE, ChannelId.m1057boximpl(initiateReplyData.channelId));
        if (compositeEncoder.z(serialDescriptor, 2) || !Intrinsics.areEqual(initiateReplyData.triggerHaptic, Boolean.FALSE)) {
            compositeEncoder.i(serialDescriptor, 2, h.f35145a, initiateReplyData.triggerHaptic);
        }
        compositeEncoder.i(serialDescriptor, 3, n2.f35181a, initiateReplyData.location);
    }

    @NotNull
    /* renamed from: component1-3Eiw7ao  reason: not valid java name */
    public final String m739component13Eiw7ao() {
        return this.messageId;
    }

    /* renamed from: component2-o4g7jtM  reason: not valid java name */
    public final long m740component2o4g7jtM() {
    ...
    public final InitiateReplyData m741copy8a0ehIg(@NotNull String messageId, long j10, Boolean bool, String str) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof InitiateReplyData) {
            ...
            return MessageId.m1087equalsimpl0(this.messageId, initiateReplyData.messageId) && ChannelId.m1061equalsimpl0(this.channelId, initiateReplyData.channelId) && Intrinsics.areEqual(this.triggerHaptic, initiateReplyData.triggerHaptic) && Intrinsics.areEqual(this.location, initiateReplyData.location);
        }
        return false;
    }

    /* renamed from: getChannelId-o4g7jtM  reason: not valid java name */
    public final long m742getChannelIdo4g7jtM() {
        return this.channelId;
    }
    ...
    public final String m743getMessageId3Eiw7ao() {
        return this.messageId;
    }
    ...
    public int hashCode() {
        ...
        int hashCode = (m1088hashCodeimpl + (bool == null ? 0 : bool.hashCode())) * 31;
    ...
    public String toString() {
        ...
        Boolean bool = this.triggerHaptic;
        String str = this.location;
        return "InitiateReplyData(messageId=" + m1090toStringimpl + ", channelId=" + m1064toStringimpl + ", triggerHaptic=" + bool + ", location=" + str + ")";
    }
