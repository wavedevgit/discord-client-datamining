...
public final class InitiateReplyData implements ReactEvent {
    ...
    public static final /* synthetic */ void write$Self$chat_release(InitiateReplyData initiateReplyData, CompositeEncoder compositeEncoder, SerialDescriptor serialDescriptor) {
        compositeEncoder.D(serialDescriptor, 0, MessageId$$serializer.INSTANCE, MessageId.m1085boximpl(initiateReplyData.messageId));
        compositeEncoder.D(serialDescriptor, 1, ChannelId$$serializer.INSTANCE, ChannelId.m1059boximpl(initiateReplyData.channelId));
        if (compositeEncoder.z(serialDescriptor, 2) || !Intrinsics.areEqual(initiateReplyData.triggerHaptic, Boolean.FALSE)) {
            compositeEncoder.s(serialDescriptor, 2, h.f20942a, initiateReplyData.triggerHaptic);
        }
        compositeEncoder.s(serialDescriptor, 3, n2.f20978a, initiateReplyData.location);
    }
