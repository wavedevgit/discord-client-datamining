...
public final class InitiateReplyData implements ReactEvent {
    ...
    public static final /* synthetic */ void write$Self$chat_release(InitiateReplyData initiateReplyData, CompositeEncoder compositeEncoder, SerialDescriptor serialDescriptor) {
        compositeEncoder.j(serialDescriptor, 0, MessageId$$serializer.INSTANCE, MessageId.m1084boximpl(initiateReplyData.messageId));
        compositeEncoder.j(serialDescriptor, 1, ChannelId$$serializer.INSTANCE, ChannelId.m1058boximpl(initiateReplyData.channelId));
        if (compositeEncoder.A(serialDescriptor, 2) || !Intrinsics.areEqual(initiateReplyData.triggerHaptic, Boolean.FALSE)) {
            compositeEncoder.z(serialDescriptor, 2, h.f6812a, initiateReplyData.triggerHaptic);
        }
        compositeEncoder.z(serialDescriptor, 3, n2.f6848a, initiateReplyData.location);
    }
