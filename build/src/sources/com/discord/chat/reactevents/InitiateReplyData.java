...
public final class InitiateReplyData implements ReactEvent {
    ...
    public static final /* synthetic */ void write$Self$chat_release(InitiateReplyData initiateReplyData, CompositeEncoder compositeEncoder, SerialDescriptor serialDescriptor) {
        compositeEncoder.m(serialDescriptor, 0, MessageId$$serializer.INSTANCE, MessageId.m1086boximpl(initiateReplyData.messageId));
        compositeEncoder.m(serialDescriptor, 1, ChannelId$$serializer.INSTANCE, ChannelId.m1060boximpl(initiateReplyData.channelId));
        if (compositeEncoder.y(serialDescriptor, 2) || !Intrinsics.areEqual(initiateReplyData.triggerHaptic, Boolean.FALSE)) {
            compositeEncoder.B(serialDescriptor, 2, h.f7626a, initiateReplyData.triggerHaptic);
        }
        compositeEncoder.B(serialDescriptor, 3, n2.f7662a, initiateReplyData.location);
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof InitiateReplyData) {
            ...
            return MessageId.m1090equalsimpl0(this.messageId, initiateReplyData.messageId) && ChannelId.m1064equalsimpl0(this.channelId, initiateReplyData.channelId) && Intrinsics.areEqual(this.triggerHaptic, initiateReplyData.triggerHaptic) && Intrinsics.areEqual(this.location, initiateReplyData.location);
        }
        return false;
    }
    ...
    public int hashCode() {
        ...
        int hashCode = (m1091hashCodeimpl + (bool == null ? 0 : bool.hashCode())) * 31;
    ...
    public String toString() {
        ...
        Boolean bool = this.triggerHaptic;
        String str = this.location;
        return "InitiateReplyData(messageId=" + m1093toStringimpl + ", channelId=" + m1067toStringimpl + ", triggerHaptic=" + bool + ", location=" + str + ")";
    }
