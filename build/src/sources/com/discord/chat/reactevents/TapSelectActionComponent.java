...
public final class TapSelectActionComponent implements ReactEvent {
    ...
    public static /* synthetic */ TapSelectActionComponent m834copyntcYbpo$default(TapSelectActionComponent tapSelectActionComponent, String str, String str2, int i10, Object obj) {
        if ((i10 & 1) != 0) {
        ...
        return tapSelectActionComponent.m836copyntcYbpo(str, str2);
    }
    ...
    public static final /* synthetic */ void write$Self$chat_release(TapSelectActionComponent tapSelectActionComponent, CompositeEncoder compositeEncoder, SerialDescriptor serialDescriptor) {
        compositeEncoder.s(serialDescriptor, 0, MessageId$$serializer.INSTANCE, MessageId.m1083boximpl(tapSelectActionComponent.messageId));
        compositeEncoder.z(serialDescriptor, 1, tapSelectActionComponent.componentId);
    }

    @NotNull
    /* renamed from: component1-3Eiw7ao  reason: not valid java name */
    public final String m835component13Eiw7ao() {
    ...
    public final TapSelectActionComponent m836copyntcYbpo(@NotNull String messageId, @NotNull String componentId) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof TapSelectActionComponent) {
            ...
            return MessageId.m1087equalsimpl0(this.messageId, tapSelectActionComponent.messageId) && Intrinsics.areEqual(this.componentId, tapSelectActionComponent.componentId);
        }
        return false;
    }
    ...
    public final String m837getMessageId3Eiw7ao() {
        return this.messageId;
    }

    public int hashCode() {
        return (MessageId.m1088hashCodeimpl(this.messageId) * 31) + this.componentId.hashCode();
    }
    ...
    public String toString() {
        ...
        return "TapSelectActionComponent(messageId=" + m1090toStringimpl + ", componentId=" + str + ")";
    }
