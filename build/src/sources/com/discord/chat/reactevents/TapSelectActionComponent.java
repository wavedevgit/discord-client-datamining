...
public final class TapSelectActionComponent implements ReactEvent {
    ...
    public static final /* synthetic */ void write$Self$chat_release(TapSelectActionComponent tapSelectActionComponent, CompositeEncoder compositeEncoder, SerialDescriptor serialDescriptor) {
        compositeEncoder.m(serialDescriptor, 0, MessageId$$serializer.INSTANCE, MessageId.m1086boximpl(tapSelectActionComponent.messageId));
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof TapSelectActionComponent) {
            ...
            return MessageId.m1090equalsimpl0(this.messageId, tapSelectActionComponent.messageId) && Intrinsics.areEqual(this.componentId, tapSelectActionComponent.componentId);
        }
        return false;
    }
    ...
    public int hashCode() {
        return (MessageId.m1091hashCodeimpl(this.messageId) * 31) + this.componentId.hashCode();
    }
    ...
    public String toString() {
        ...
        return "TapSelectActionComponent(messageId=" + m1093toStringimpl + ", componentId=" + str + ")";
    }
