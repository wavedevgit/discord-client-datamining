...
public final class TapLinkData implements ReactEvent {
    ...
    public static /* synthetic */ TapLinkData m815copyEfbKrI$default(TapLinkData tapLinkData, String str, String str2, LinkContextData linkContextData, String str3, int i10, Object obj) {
        if ((i10 & 1) != 0) {
        ...
        return tapLinkData.m817copyEfbKrI(str, str2, linkContextData, str3);
    }
    ...
    private final WritableNativeMap toMap(LinkContextData linkContextData) {
        ...
        if (linkContextData2 instanceof LinkContextData.LinkUrl) {
            ...
            NativeMapExtensionsKt.put(nativeMapOf, "threadId", ChannelId.m1065toStringimpl(((LinkContextData.BindOpenThreadChannel) this.target).m335getThreadIdo4g7jtM()));
            return nativeMapOf;
        } else {
            if (linkContextData2 instanceof LinkContextData.BindUserMenu) {
                ...
                NativeMapExtensionsKt.put(nativeMapOf, "userId", UserId.m1143toStringimpl(((LinkContextData.BindUserMenu) this.target).m363getUserIdre6GcUE()));
                ChannelId m362getMessageChannelIdqMVnFVQ = ((LinkContextData.BindUserMenu) this.target).m362getMessageChannelIdqMVnFVQ();
                if (m362getMessageChannelIdqMVnFVQ != null) {
                    NativeMapExtensionsKt.put(nativeMapOf, "messageChannelId", ChannelId.m1065toStringimpl(m362getMessageChannelIdqMVnFVQ.m1067unboximpl()));
                    return nativeMapOf;
                }
                ...
                NativeMapExtensionsKt.put(nativeMapOf, "userId", UserId.m1143toStringimpl(((LinkContextData.BindTapCommandName) this.target).m351getUserIdre6GcUE()));
                ...
                NativeMapExtensionsKt.put(nativeMapOf, "messageId", MessageId.m1091toStringimpl(((LinkContextData.BindTapCommandName) this.target).m350getMessageId3Eiw7ao()));
                NativeMapExtensionsKt.put(nativeMapOf, "applicationUserId", UserId.m1143toStringimpl(((LinkContextData.BindTapCommandName) this.target).m348getApplicationUserIdre6GcUE()));
                NativeMapExtensionsKt.put(nativeMapOf, "messageChannelId", ChannelId.m1065toStringimpl(((LinkContextData.BindTapCommandName) this.target).m349getMessageChannelIdo4g7jtM()));
                return nativeMapOf;
                ...
                NativeMapExtensionsKt.put(nativeMapOf, "messageChannelId", ChannelId.m1065toStringimpl(((LinkContextData.BindOpenPins) this.target).m331getMessageChannelIdo4g7jtM()));
                return nativeMapOf;
                ...
                if (messageReference != null) {
                    ...
                    NativeMapExtensionsKt.put(nativeMapOf2, "channel_id", ChannelId.m1065toStringimpl(messageReference.m314getChannelIdo4g7jtM()));
                    GuildId m315getGuildIdqOKuAAo = messageReference.m315getGuildIdqOKuAAo();
                    if (m315getGuildIdqOKuAAo != null) {
                        m315getGuildIdqOKuAAo.m1080unboximpl();
    ...
    public final String m816component1N_6c4I0() {
    ...
    public final TapLinkData m817copyEfbKrI(String str, String str2, LinkContextData linkContextData, @NotNull String content) {
    ...
    public final String m818getMessageIdN_6c4I0() {
        return this.messageId;
    }
