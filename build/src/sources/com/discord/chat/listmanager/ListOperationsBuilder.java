...
public final class ListOperationsBuilder {
    ...
    private final void addChange(ListOperation.Change change) {
        ListOperation listOperation = (ListOperation) CollectionsKt.z0(this.listOperations);
        if (listOperation instanceof ListOperation.Change) {
            ...
            if (index == change.getIndex() - 1) {
                ...
                list.set(CollectionsKt.n(list), new ListOperation.ChangeRange(new IntRange(change2.getIndex(), change.getIndex())));
            } else if (index == change.getIndex() + 1) {
                List<ListOperation> list2 = this.listOperations;
                list2.set(CollectionsKt.n(list2), new ListOperation.ChangeRange(new IntRange(change.getIndex(), change2.getIndex())));
            } else {
            ...
            if (changeRange.getLast() == change.getIndex() - 1) {
                ...
                list3.set(CollectionsKt.n(list3), new ListOperation.ChangeRange(new IntRange(changeRange.getFirst(), change.getIndex())));
            } else if (changeRange.getFirst() == change.getIndex() + 1) {
                List<ListOperation> list4 = this.listOperations;
                list4.set(CollectionsKt.n(list4), new ListOperation.ChangeRange(new IntRange(change.getIndex(), changeRange.getLast())));
            } else {
                this.listOperations.add(change);
            }
        } else {
    ...
    private final void addInsert(ListOperation.Insert insert) {
        ...
        if (listOperation instanceof ListOperation.Insert) {
            ...
            if (index == insert.getIndex() - 1) {
                List<ListOperation> list = this.listOperations;
                list.set(CollectionsKt.n(list), new ListOperation.InsertRange(new IntRange(insert2.getIndex(), insert.getIndex())));
            } else if (index == insert.getIndex() + 1) {
                List<ListOperation> list2 = this.listOperations;
                list2.set(CollectionsKt.n(list2), new ListOperation.InsertRange(new IntRange(insert.getIndex(), insert2.getIndex())));
            } else {
            ...
            if (insertRange.getLast() == insert.getIndex() - 1) {
                List<ListOperation> list3 = this.listOperations;
                list3.set(CollectionsKt.n(list3), new ListOperation.InsertRange(new IntRange(insertRange.getFirst(), insert.getIndex())));
            } else if (insertRange.getFirst() == insert.getIndex() + 1) {
                List<ListOperation> list4 = this.listOperations;
                list4.set(CollectionsKt.n(list4), new ListOperation.InsertRange(new IntRange(insert.getIndex(), insertRange.getLast())));
            } else {
                this.listOperations.add(insert);
            }
        } else {
    ...
    private final void addRemove(ListOperation.Remove remove) {
        ...
        if (listOperation instanceof ListOperation.Remove) {
            ...
            if (index == remove.getIndex() - 1) {
                List<ListOperation> list = this.listOperations;
                list.set(CollectionsKt.n(list), new ListOperation.RemoveRange(new IntRange(remove2.getIndex(), remove.getIndex())));
            } else if (index == remove.getIndex() + 1) {
                List<ListOperation> list2 = this.listOperations;
                list2.set(CollectionsKt.n(list2), new ListOperation.RemoveRange(new IntRange(remove.getIndex(), remove2.getIndex())));
            } else {
            ...
            if (removeRange.getLast() == remove.getIndex() - 1) {
                List<ListOperation> list3 = this.listOperations;
                list3.set(CollectionsKt.n(list3), new ListOperation.RemoveRange(new IntRange(removeRange.getFirst(), remove.getIndex())));
            } else if (removeRange.getFirst() == remove.getIndex() + 1) {
                List<ListOperation> list4 = this.listOperations;
                list4.set(CollectionsKt.n(list4), new ListOperation.RemoveRange(new IntRange(remove.getIndex(), removeRange.getLast())));
            } else {
                this.listOperations.add(remove);
            }
        } else {
