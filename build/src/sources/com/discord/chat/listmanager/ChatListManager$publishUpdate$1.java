...
@e(c = "com.discord.chat.listmanager.ChatListManager$publishUpdate$1", f = "ChatListManager.kt", l = {234}, m = "invokeSuspend")
...
public final class ChatListManager$publishUpdate$1 extends k implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        if (i10 != 0) {
            ...
            this.label = 1;
            if (mutableSharedFlow.emit(chatListUpdate, this) == f10) {
                return f10;
            }
        }
        return Unit.f32008a;
    ...
    public final Object invoke(CoroutineScope coroutineScope, Continuation<? super Unit> continuation) {
        return ((ChatListManager$publishUpdate$1) create(coroutineScope, continuation)).invokeSuspend(Unit.f32008a);
    }
}
