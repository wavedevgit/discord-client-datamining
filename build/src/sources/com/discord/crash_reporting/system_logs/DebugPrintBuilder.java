...
final class DebugPrintBuilder {
    ...
    private final StringBuilder f10301sb;
    ...
    public final void appendKeyValue(@NotNull String key, Object obj) {
        ...
        for (int i11 = 0; i11 < i10; i11++) {
            this.f10301sb.append("  ");
        }
        this.f10301sb.append(" - ");
        this.f10301sb.append(key);
        this.f10301sb.append(": ");
        this.f10301sb.append((obj == null || (r6 = obj.toString()) == null) ? "{null}" : "{null}");
        this.f10301sb.append('\n');
    }

    public final void appendLine(String str) {
        StringBuilder sb2 = this.f10301sb;
        sb2.append(str);
        sb2.append('\n');
    }
