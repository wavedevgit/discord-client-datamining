...
public final class SystemLogUtils {
    ...
    @NotNull
    private static final Regex regexExtractTombstone = new Regex("(?:^(?:[^\\s]+\\s+){4}F\\s+DEBUG\\s+:\\s(.+))|(^.+(\\[" + Regex.f35387e.c(LIBDISCORD_VERSION_CATEGORY) + "\\].+))");
    ...
    */
    ...
    private final void fetch(final Regex regex, final Function1<? super LinkedList<String>, Unit> function1) {
        ...
        pr.a.b(false, false, null, null, 0, new Function0() { // from class: com.discord.crash_reporting.system_logs.d
