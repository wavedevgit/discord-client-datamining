...
public final class CrashReporting {
    ...
    @NotNull
    private static final Lazy maxEventSizeBytes$delegate = rr.l.a(new Function0() { // from class: com.discord.crash_reporting.a
    ...
    */
    ...
    public static final void init$lambda$3(String str, String str2, final Context context, double d10, final SentryAndroidOptions options) {
        ...
        options.setProguardUuid("cb4e4b54-f0ac-4e10-a97c-7850dcd0c719");
    ...
    public final void captureException(@NotNull Throwable throwable, boolean z10) {
        ...
        Log.e$default(Log.INSTANCE, "SentryBreadcrumb", rr.e.b(throwable), (Throwable) null, 4, (Object) null);
        if (!z10) {
            b5.l(throwable);
