...
public final class CrashReporting {
    ...
    @NotNull
    private static final Lazy maxEventSizeBytes$delegate = as.l.b(new Function0() { // from class: com.discord.crash_reporting.a
    ...
    */
    ...
    public static final void init$lambda$3(String str, String str2, final Context context, double d10, final SentryAndroidOptions options) {
        ...
        options.setProguardUuid("e384c046-51d9-4b60-ac3a-787a90fc2e2b");
    ...
    public final void captureException(@NotNull Throwable throwable, boolean z10) {
        ...
        Log.e$default(Log.INSTANCE, "SentryBreadcrumb", as.e.b(throwable), (Throwable) null, 4, (Object) null);
        if (!z10) {
            b5.l(throwable);
