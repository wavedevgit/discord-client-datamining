...
public final class MediaResolver {
    ...
    private final Uri createMP4FastStartUri(Uri uri, Uri uri2, long j10) {
        ...
        boolean z10 = false;
        try {
            z10 = ku.a.a(openFileDescriptor.getFileDescriptor(), createTempFile$default);
            if (z10) {
    ...
    */
    ...
    public static final Unit handleImage$lambda$7(int i10, boolean z10, MediaResolver mediaResolver, Uri uri, Compression compress) {
        ...
        rr.g.a(compress, Bitmap.CompressFormat.JPEG);
        rr.e.a(compress, ContentResolverUtils.createTempFile$default(ContentResolverUtils.INSTANCE, mediaResolver.getResolver(), uri, null, "jpeg", 2, null));
        return Unit.f31988a;
    }
