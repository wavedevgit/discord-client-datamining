...
public final class FirstFrameCallbackEvent implements ReactEvent {
    ...
    public static final /* synthetic */ void write$Self$media_engine_release(FirstFrameCallbackEvent firstFrameCallbackEvent, CompositeEncoder compositeEncoder, SerialDescriptor serialDescriptor) {
        compositeEncoder.w(serialDescriptor, 0, firstFrameCallbackEvent.connectionId);
        compositeEncoder.y(serialDescriptor, 1, firstFrameCallbackEvent.userId);
        compositeEncoder.D(serialDescriptor, 2, firstFrameCallbackEvent.ssrc);
        compositeEncoder.y(serialDescriptor, 3, firstFrameCallbackEvent.streamId);
    }
