...
public final class UserSpeakingEvent implements ReactEvent {
    ...
    public static final /* synthetic */ void write$Self$media_engine_release(UserSpeakingEvent userSpeakingEvent, CompositeEncoder compositeEncoder, SerialDescriptor serialDescriptor) {
        compositeEncoder.w(serialDescriptor, 0, userSpeakingEvent.connectionId);
        compositeEncoder.y(serialDescriptor, 1, userSpeakingEvent.userId);
        compositeEncoder.w(serialDescriptor, 2, userSpeakingEvent.isSpeaking);
        compositeEncoder.s(serialDescriptor, 3, userSpeakingEvent.voiceDb);
    }
