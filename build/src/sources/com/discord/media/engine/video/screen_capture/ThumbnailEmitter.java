...
public final class ThumbnailEmitter {
    ...
    private final Bitmap createThumbnail(VideoFrame videoFrame) {
        ...
        if (rotatedWidth / rotatedHeight < i10 / i11) {
            ...
            this.frameDrawer.drawFrame(videoFrame, this.rectDrawer, renderMatrix, ps.a.c((i10 - f10) / 2.0f), 0, ps.a.c(f10), this.height);
        } else {
            float f11 = rotatedHeight * (i10 / rotatedWidth);
            this.frameDrawer.drawFrame(videoFrame, this.rectDrawer, renderMatrix, 0, ps.a.c((i11 - f11) / 2.0f), this.width, ps.a.c(f11));
        }
