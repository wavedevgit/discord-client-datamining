...
public final class PingTimeoutCallbackEvent implements ReactEvent {
    ...
    public static final /* synthetic */ void write$Self$media_engine_release(PingTimeoutCallbackEvent pingTimeoutCallbackEvent, CompositeEncoder compositeEncoder, SerialDescriptor serialDescriptor) {
        compositeEncoder.x(serialDescriptor, 0, pingTimeoutCallbackEvent.connectionId);
        compositeEncoder.z(serialDescriptor, 1, pingTimeoutCallbackEvent.server);
        compositeEncoder.x(serialDescriptor, 2, pingTimeoutCallbackEvent.port);
        compositeEncoder.x(serialDescriptor, 3, pingTimeoutCallbackEvent.seq);
        compositeEncoder.x(serialDescriptor, 4, pingTimeoutCallbackEvent.timeout);
    }
