...
public final class PingTimeoutCallbackEvent implements ReactEvent {
    ...
    public static final /* synthetic */ void write$Self$media_engine_release(PingTimeoutCallbackEvent pingTimeoutCallbackEvent, CompositeEncoder compositeEncoder, SerialDescriptor serialDescriptor) {
        compositeEncoder.v(serialDescriptor, 0, pingTimeoutCallbackEvent.connectionId);
        compositeEncoder.x(serialDescriptor, 1, pingTimeoutCallbackEvent.server);
        compositeEncoder.v(serialDescriptor, 2, pingTimeoutCallbackEvent.port);
        compositeEncoder.v(serialDescriptor, 3, pingTimeoutCallbackEvent.seq);
        compositeEncoder.v(serialDescriptor, 4, pingTimeoutCallbackEvent.timeout);
    }
