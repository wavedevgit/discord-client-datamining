...
public final class MediaEngineModule$addConnectionCallbacks$1 extends kotlin.coroutines.jvm.internal.k implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
    ...
    public static final Unit invokeSuspend$lambda$1(MediaEngineModule mediaEngineModule, int i10, int i11, String str, int i12, int i13) {
        ...
        try {
            ...
            CrashReporting.addBreadcrumb$default(crashReporting, "setOnPingCallback failed with: " + message, kotlin.collections.o0.f(or.v.a("stackTrace", or.e.b(e10))), "MediaEngineModule", null, false, 24, null);
            throw e10;
        }
    }
    ...
    public final Object invoke(CoroutineScope coroutineScope, Continuation<? super Unit> continuation) {
        return ((MediaEngineModule$addConnectionCallbacks$1) create(coroutineScope, continuation)).invokeSuspend(Unit.f31988a);
    }
}
