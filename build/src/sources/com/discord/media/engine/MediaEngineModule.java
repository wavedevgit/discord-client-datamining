...
public final class MediaEngineModule extends NativeMediaEngineModuleSpec {
    ...
    static final class AnonymousClass1 extends kotlin.coroutines.jvm.internal.k implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
        ...
        public final Object invokeSuspend(Object obj) {
            ...
            if (this.label == 0) {
                ...
                System.nanoTime();
                MediaEngineModule.this.mediaEngineDeferred.K0(mediaEngine);
                return Unit.f31988a;
            }
    ...
    public MediaEngineModule(@NotNull ReactApplicationContext reactContext) {
        ...
        this.mediaEngineDeferred = ms.q.b(null, 1, null);
        ms.i.d(a10, null, null, new AnonymousClass1(null), 3, null);
        Debug.INSTANCE.logDebugLoggingConfig();
        this.reactEvents = new ReactEvents(or.v.a("no-input-callback", Reflection.getOrCreateKotlinClass(NoInputCallbackEvent.class)), or.v.a("on-voice", Reflection.getOrCreateKotlinClass(OnVoiceEvent.class)), or.v.a("device-changed", Reflection.getOrCreateKotlinClass(DeviceChangedEvent.class)), or.v.a("audio-input-initialized", Reflection.getOrCreateKotlinClass(AudioInputInitializedEvent.class)), or.v.a("on-broadcast-requested", Reflection.getOrCreateKotlinClass(OnBroadcastRequestedEvent.class)), or.v.a("on-broadcast-thumbnail", Reflection.getOrCreateKotlinClass(OnBroadcastThumbnailEvent.class)), or.v.a("user-speaking", Reflection.getOrCreateKotlinClass(UserSpeakingEvent.class)), or.v.a("ping-callback", Reflection.getOrCreateKotlinClass(PingCallbackEvent.class)), or.v.a("ping-timeout-callback", Reflection.getOrCreateKotlinClass(PingTimeoutCallbackEvent.class)), or.v.a("on-video-callback", Reflection.getOrCreateKotlinClass(OnVideoCallbackEvent.class)), or.v.a("active-sinks-change", Reflection.getOrCreateKotlinClass(ActiveSinksChangeEvent.class)), or.v.a("on-first-frame-callback", Reflection.getOrCreateKotlinClass(FirstFrameCallbackEvent.class)), or.v.a("mls-failure-callback", Reflection.getOrCreateKotlinClass(MlsFailureCallbackEvent.class)), or.v.a("secure-frames-state-update-callback", Reflection.getOrCreateKotlinClass(SecureFramesStateUpdateCallbackEvent.class)));
    ...
    public final void addConnectionCallbacks(int i10) {
        ms.i.d(this.appScope, null, null, new MediaEngineModule$addConnectionCallbacks$1(this, i10, null), 3, null);
    }
    ...
    public final void createConnection(int i10, String str, ReadableMap readableMap, Function2<? super String, ? super Map<String, ? extends Object>, Unit> function2) {
        ms.i.d(this.appScope, null, null, new MediaEngineModule$createConnection$1(this, i10, str, readableMap, function2, null), 3, null);
    }
    ...
    public void connectionInstanceConfigureConnectionRetries(double d10, double d11, double d12, double d13) {
        ms.i.d(this.appScope, null, null, new MediaEngineModule$connectionInstanceConfigureConnectionRetries$1(this, d10, d11, d12, d13, null), 3, null);
    }

    @Override // com.discord.codegen.NativeMediaEngineModuleSpec
    public void connectionInstanceDestroy(double d10) {
        ms.i.d(this.appScope, null, null, new MediaEngineModule$connectionInstanceDestroy$1(this, d10, null), 3, null);
    }

    @Override // com.discord.codegen.NativeMediaEngineModuleSpec
    public void connectionInstanceDestroyUser(double d10, @NotNull String userId) {
        Intrinsics.checkNotNullParameter(userId, "userId");
        ms.i.d(this.appScope, null, null, new MediaEngineModule$connectionInstanceDestroyUser$1(this, d10, userId, null), 3, null);
    }

    @Override // com.discord.codegen.NativeMediaEngineModuleSpec
    public void connectionInstanceExecuteSecureFramesTransition(double d10, double d11) {
        ms.i.d(this.appScope, null, null, new MediaEngineModule$connectionInstanceExecuteSecureFramesTransition$1(this, d10, d11, null), 3, null);
    }

    @Override // com.discord.codegen.NativeMediaEngineModuleSpec
    public void connectionInstanceFastUdpReconnect(double d10) {
        ms.i.d(this.appScope, null, null, new MediaEngineModule$connectionInstanceFastUdpReconnect$1(this, d10, null), 3, null);
    }

    @Override // com.discord.codegen.NativeMediaEngineModuleSpec
    public void connectionInstanceGetEncryptionModes(double d10, @NotNull Callback callback) {
        Intrinsics.checkNotNullParameter(callback, "callback");
        ms.i.d(this.appScope, null, null, new MediaEngineModule$connectionInstanceGetEncryptionModes$1(this, d10, callback, null), 3, null);
    }

    @Override // com.discord.codegen.NativeMediaEngineModuleSpec
    public void connectionInstanceGetFilteredStats(double d10, double d11, @NotNull Callback callback) {
        Intrinsics.checkNotNullParameter(callback, "callback");
        ms.i.d(this.appScope, null, null, new MediaEngineModule$connectionInstanceGetFilteredStats$1(this, d10, d11, callback, null), 3, null);
    }

    @Override // com.discord.codegen.NativeMediaEngineModuleSpec
    public void connectionInstanceGetMLSKeyPackageB64(double d10, @NotNull Callback callback) {
        Intrinsics.checkNotNullParameter(callback, "callback");
        ms.i.d(this.appScope, null, null, new MediaEngineModule$connectionInstanceGetMLSKeyPackageB64$1(this, d10, callback, null), 3, null);
    }
    ...
    public void connectionInstanceGetMLSPairwiseFingerprintB64(double d10, double d11, @NotNull String userId, @NotNull Callback callback) {
        Intrinsics.checkNotNullParameter(userId, "userId");
        Intrinsics.checkNotNullParameter(callback, "callback");
        ms.i.d(this.appScope, null, null, new MediaEngineModule$connectionInstanceGetMLSPairwiseFingerprintB64$1(this, d10, d11, userId, callback, null), 3, null);
    }

    @Override // com.discord.codegen.NativeMediaEngineModuleSpec
    public void connectionInstanceGetStats(double d10, @NotNull Callback callback) {
        Intrinsics.checkNotNullParameter(callback, "callback");
        ms.i.d(this.appScope, null, null, new MediaEngineModule$connectionInstanceGetStats$1(this, d10, callback, null), 3, null);
    }

    @Override // com.discord.codegen.NativeMediaEngineModuleSpec
    public void connectionInstanceMergeUsers(double d10, @NotNull ReadableArray users) {
        Intrinsics.checkNotNullParameter(users, "users");
        ms.i.d(this.appScope, null, null, new MediaEngineModule$connectionInstanceMergeUsers$1(this, d10, users, null), 3, null);
    }
    ...
    public void connectionInstancePrepareMLSCommitTransitionB64(double d10, double d11, @NotNull String commit, @NotNull Callback callback) {
        ...
        Intrinsics.checkNotNullParameter(callback, "callback");
        ms.i.d(this.appScope, null, null, new MediaEngineModule$connectionInstancePrepareMLSCommitTransitionB64$1(this, d10, d11, commit, callback, null), 3, null);
    }
    ...
    public void connectionInstancePrepareSecureFramesEpoch(double d10, @NotNull String epoch, double d11, @NotNull String groupId) {
        ...
        ms.i.d(this.appScope, null, null, new MediaEngineModule$connectionInstancePrepareSecureFramesEpoch$1(this, d10, epoch, d11, groupId, null), 3, null);
    }

    @Override // com.discord.codegen.NativeMediaEngineModuleSpec
    public void connectionInstancePrepareSecureFramesTransition(double d10, double d11, double d12, @NotNull Callback callback) {
        Intrinsics.checkNotNullParameter(callback, "callback");
        ms.i.d(this.appScope, null, null, new MediaEngineModule$connectionInstancePrepareSecureFramesTransition$1(this, d10, d11, d12, callback, null), 3, null);
    }
    ...
    public void connectionInstanceProcessMLSProposalsB64(double d10, @NotNull String proposals, @NotNull Callback callback) {
        ...
        Intrinsics.checkNotNullParameter(callback, "callback");
        ms.i.d(this.appScope, null, null, new MediaEngineModule$connectionInstanceProcessMLSProposalsB64$1(this, d10, proposals, callback, null), 3, null);
    }
    ...
    public void connectionInstanceProcessMLSWelcomeB64(double d10, double d11, @NotNull String welcome, @NotNull Callback callback) {
        ...
        Intrinsics.checkNotNullParameter(callback, "callback");
        ms.i.d(this.appScope, null, null, new MediaEngineModule$connectionInstanceProcessMLSWelcomeB64$1(this, d10, d11, welcome, callback, null), 3, null);
    }
    ...
    public void connectionInstanceSetLocalMute(double d10, @NotNull String userId, boolean z10) {
        Intrinsics.checkNotNullParameter(userId, "userId");
        ms.i.d(this.appScope, null, null, new MediaEngineModule$connectionInstanceSetLocalMute$1(this, d10, userId, z10, null), 3, null);
    }

    @Override // com.discord.codegen.NativeMediaEngineModuleSpec
    public void connectionInstanceSetLocalPan(double d10, @NotNull String userId, double d11, double d12) {
        Intrinsics.checkNotNullParameter(userId, "userId");
        ms.i.d(this.appScope, null, null, new MediaEngineModule$connectionInstanceSetLocalPan$1(this, d10, userId, d11, d12, null), 3, null);
    }

    @Override // com.discord.codegen.NativeMediaEngineModuleSpec
    public void connectionInstanceSetLocalVolume(double d10, @NotNull String userId, double d11) {
        Intrinsics.checkNotNullParameter(userId, "userId");
        ms.i.d(this.appScope, null, null, new MediaEngineModule$connectionInstanceSetLocalVolume$1(this, d10, userId, d11, null), 3, null);
    }

    @Override // com.discord.codegen.NativeMediaEngineModuleSpec
    public void connectionInstanceSetMinimumOutputDelay(double d10, double d11) {
        ms.i.d(this.appScope, null, null, new MediaEngineModule$connectionInstanceSetMinimumOutputDelay$1(this, d10, d11, null), 3, null);
    }

    @Override // com.discord.codegen.NativeMediaEngineModuleSpec
    public void connectionInstanceSetNoInputThreshold(double d10, double d11) {
        ms.i.d(this.appScope, null, null, new MediaEngineModule$connectionInstanceSetNoInputThreshold$1(this, d10, d11, null), 3, null);
    }

    @Override // com.discord.codegen.NativeMediaEngineModuleSpec
    public void connectionInstanceSetPTTActive(double d10, boolean z10, boolean z11, boolean z12) {
        ms.i.d(this.appScope, null, null, new MediaEngineModule$connectionInstanceSetPTTActive$1(this, d10, z10, z11, z12, null), 3, null);
    }

    @Override // com.discord.codegen.NativeMediaEngineModuleSpec
    public void connectionInstanceSetPingInterval(double d10, double d11) {
        ms.i.d(this.appScope, null, null, new MediaEngineModule$connectionInstanceSetPingInterval$1(this, d10, d11, null), 3, null);
    }

    @Override // com.discord.codegen.NativeMediaEngineModuleSpec
    public void connectionInstanceSetSelfDeafen(double d10, boolean z10) {
        ms.i.d(this.appScope, null, null, new MediaEngineModule$connectionInstanceSetSelfDeafen$1(this, d10, z10, null), 3, null);
    }

    @Override // com.discord.codegen.NativeMediaEngineModuleSpec
    public void connectionInstanceSetSelfMute(double d10, boolean z10) {
        ms.i.d(this.appScope, null, null, new MediaEngineModule$connectionInstanceSetSelfMute$1(this, d10, z10, null), 3, null);
    }

    @Override // com.discord.codegen.NativeMediaEngineModuleSpec
    public void connectionInstanceSetTransportOptions(double d10, @NotNull ReadableMap options) {
        Intrinsics.checkNotNullParameter(options, "options");
        ms.i.d(this.appScope, null, null, new MediaEngineModule$connectionInstanceSetTransportOptions$1(this, d10, options, null), 3, null);
    }

    @Override // com.discord.codegen.NativeMediaEngineModuleSpec
    public void connectionInstanceSetVideoBroadcast(double d10, boolean z10) {
        ms.i.d(this.appScope, null, null, new MediaEngineModule$connectionInstanceSetVideoBroadcast$1(this, d10, z10, null), 3, null);
    }

    @Override // com.discord.codegen.NativeMediaEngineModuleSpec
    public void connectionInstanceTriggerOnSpeakingCallback(double d10) {
        ms.i.d(this.appScope, null, null, new MediaEngineModule$connectionInstanceTriggerOnSpeakingCallback$1(this, d10, null), 3, null);
    }

    @Override // com.discord.codegen.NativeMediaEngineModuleSpec
    public void connectionInstanceTriggerOnVideoCallback(double d10) {
        ms.i.d(this.appScope, null, null, new MediaEngineModule$connectionInstanceTriggerOnVideoCallback$1(this, d10, null), 3, null);
    }
    ...
    public void connectionInstanceUpdateMLSExternalSenderB64(double d10, @NotNull String externalSenderB64) {
        ...
        ms.i.d(this.appScope, null, null, new MediaEngineModule$connectionInstanceUpdateMLSExternalSenderB64$1(this, d10, externalSenderB64, null), 3, null);
    }
    ...
    public void createOwnStreamConnectionWithOptions(double d10, @NotNull String userId, @NotNull ReadableMap connectionOptions, @NotNull Callback callback) {
        ...
        Intrinsics.checkNotNullParameter(callback, "callback");
        ms.i.d(this.appScope, null, null, new MediaEngineModule$createOwnStreamConnectionWithOptions$1(this, d10, userId, connectionOptions, callback, null), 3, null);
    }
    ...
    public void getAudioSubsystem(@NotNull Callback callback) {
        Intrinsics.checkNotNullParameter(callback, "callback");
        ms.i.d(this.appScope, null, null, new MediaEngineModule$getAudioSubsystem$1(this, callback, null), 3, null);
    }

    @Override // com.discord.codegen.NativeMediaEngineModuleSpec
    public void getCodecCapabilities(@NotNull Callback callback) {
        Intrinsics.checkNotNullParameter(callback, "callback");
        ms.i.d(this.appScope, null, null, new MediaEngineModule$getCodecCapabilities$1(this, callback, null), 3, null);
    }

    @Override // com.discord.codegen.NativeMediaEngineModuleSpec
    public void getCodecSurvey(@NotNull Callback callback) {
        Intrinsics.checkNotNullParameter(callback, "callback");
        ms.i.d(this.appScope, null, null, new MediaEngineModule$getCodecSurvey$1(this, callback, null), 3, null);
    }

    @Override // com.discord.codegen.NativeMediaEngineModuleSpec
    public void getInputDevices(@NotNull Callback callback) {
        Intrinsics.checkNotNullParameter(callback, "callback");
        ms.i.d(this.appScope, null, null, new MediaEngineModule$getInputDevices$1(this, callback, null), 3, null);
    }
    ...
    public void getMLSSigningKeyB64(@NotNull String sessionId, double d10, @NotNull Callback callback) {
        ...
        Intrinsics.checkNotNullParameter(callback, "callback");
        ms.i.d(this.appScope, null, null, new MediaEngineModule$getMLSSigningKeyB64$1(this, sessionId, d10, callback, null), 3, null);
    }
    ...
    public void getOutputDevices(@NotNull Callback callback) {
        Intrinsics.checkNotNullParameter(callback, "callback");
        ms.i.d(this.appScope, null, null, new MediaEngineModule$getOutputDevices$1(this, callback, null), 3, null);
    }
    ...
    protected Map<String, Object> getTypedExportedConstants() {
        return kotlin.collections.o0.n(or.v.a("DegradationPreference", kotlin.collections.o0.m(or.v.a("MAINTAIN_RESOLUTION", 0), or.v.a("MAINTAIN_FRAMERATE", 1), or.v.a("BALANCED", 2))), or.v.a("AVAudioSessionMode", kotlin.collections.o0.m(or.v.a("VOICE", "AVAudioSessionModeVoiceChat"), or.v.a("VIDEO", "AVAudioSessionModeVideoChat"), or.v.a("LISTEN", "AVAudioSessionModeSpokenAudio"), or.v.a("DEFAULT", "AVAudioSessionModeDefault"))), or.v.a("SupportedSecureFramesProtocolVersion", Integer.valueOf((int) MediaEngine.MAX_SUPPORTED_PROTOCOL_VERSION)), or.v.a("supportedFeatures", CollectionsKt.o("voice_sound_stop_loop", "voice_relative_sounds", "voice_legacy_subsystem", "voice_experimental_subsystem", "elevated_hook", "soundshare", "soundshare_loopback", "set_audio_device_by_id", "set_video_device_by_id", "loopback", "wumpus_video", "hybrid_video", "experimental_encoders", "experiment_config", "remote_locus_network_control", "screen_previews", "window_previews", "audio_debug_state", "connection_replay", "simulcast_bugfix", "RTC_REGION_RANKING", "video_effects", "direct_video", "electron_video", "mediapipe", "fixed_keyframe_interval", "clips", "first_frame_callback", "remote_user_multi_stream", "mls_pairwise_fingerprints", "offload_adm_controls")));
    }

    @Override // com.discord.codegen.NativeMediaEngineModuleSpec
    public void getVideoInputDevices(@NotNull Callback callback) {
        Intrinsics.checkNotNullParameter(callback, "callback");
        ms.i.d(this.appScope, null, null, new MediaEngineModule$getVideoInputDevices$1(this, callback, null), 3, null);
    }

    @Override // com.discord.codegen.NativeMediaEngineModuleSpec
    public void initializeEngine() {
        ms.i.d(this.appScope, null, null, new MediaEngineModule$initializeEngine$1(this, null), 3, null);
    }
    ...
    public void invalidate() {
        ...
        ms.i.d(this.appScope, null, null, new MediaEngineModule$invalidate$1(this, null), 3, null);
    }
    ...
    public void rankRtcRegions(@NotNull ReadableArray regionsWithIps, @NotNull Callback callback) {
        ...
        Intrinsics.checkNotNullParameter(callback, "callback");
        ms.i.d(this.appScope, null, null, new MediaEngineModule$rankRtcRegions$1(this, regionsWithIps, callback, null), 3, null);
    }
    ...
    public void setAudioInputEnabled(boolean z10) {
        ms.i.d(this.appScope, null, null, new MediaEngineModule$setAudioInputEnabled$1(this, z10, null), 3, null);
    }

    @Override // com.discord.codegen.NativeMediaEngineModuleSpec
    public void setBroadcastThumbnailParams(double d10, double d11, double d12) {
        ms.i.d(this.appScope, null, null, new MediaEngineModule$setBroadcastThumbnailParams$1(this, d10, d11, d12, null), 3, null);
    }

    @Override // com.discord.codegen.NativeMediaEngineModuleSpec
    public void setEmitVADLevel2(boolean z10) {
        ms.i.d(this.appScope, null, null, new MediaEngineModule$setEmitVADLevel2$1(this, z10, null), 3, null);
    }

    @Override // com.discord.codegen.NativeMediaEngineModuleSpec
    public void setHasFullbandPerformance(boolean z10) {
        ms.i.d(this.appScope, null, null, new MediaEngineModule$setHasFullbandPerformance$1(this, z10, null), 3, null);
    }

    @Override // com.discord.codegen.NativeMediaEngineModuleSpec
    public void setInputDevice(double d10) {
        ms.i.d(this.appScope, null, null, new MediaEngineModule$setInputDevice$1(this, d10, null), 3, null);
    }

    @Override // com.discord.codegen.NativeMediaEngineModuleSpec
    public void setInputDeviceById(@NotNull String deviceName) {
        Intrinsics.checkNotNullParameter(deviceName, "deviceName");
        ms.i.d(this.appScope, null, null, new MediaEngineModule$setInputDeviceById$1(this, deviceName, null), 3, null);
    }

    @Override // com.discord.codegen.NativeMediaEngineModuleSpec
    public void setInputVolume(double d10) {
        ms.i.d(this.appScope, null, null, new MediaEngineModule$setInputVolume$1(this, d10, null), 3, null);
    }
    ...
    public void setNoInputThreshold(double d10) {
        ms.i.d(this.appScope, null, null, new MediaEngineModule$setNoInputThreshold$1(this, d10, null), 3, null);
    }
    ...
    public void setOutputDevice(double d10) {
        ms.i.d(this.appScope, null, null, new MediaEngineModule$setOutputDevice$1(this, d10, null), 3, null);
    }

    @Override // com.discord.codegen.NativeMediaEngineModuleSpec
    public void setOutputDeviceById(@NotNull String deviceName) {
        Intrinsics.checkNotNullParameter(deviceName, "deviceName");
        ms.i.d(this.appScope, null, null, new MediaEngineModule$setOutputDeviceById$1(this, deviceName, null), 3, null);
    }

    @Override // com.discord.codegen.NativeMediaEngineModuleSpec
    public void setOutputVolume(double d10) {
        ms.i.d(this.appScope, null, null, new MediaEngineModule$setOutputVolume$1(this, d10, null), 3, null);
    }

    @Override // com.discord.codegen.NativeMediaEngineModuleSpec
    public void setSidechainCompression(boolean z10) {
        ms.i.d(this.appScope, null, null, new MediaEngineModule$setSidechainCompression$1(this, z10, null), 3, null);
    }

    @Override // com.discord.codegen.NativeMediaEngineModuleSpec
    public void setTransportOptions(@NotNull ReadableMap options) {
        Intrinsics.checkNotNullParameter(options, "options");
        ms.i.d(this.appScope, null, null, new MediaEngineModule$setTransportOptions$1(this, options, null), 3, null);
    }

    @Override // com.discord.codegen.NativeMediaEngineModuleSpec
    public void setVideoInputDevice(double d10) {
        ms.i.d(this.appScope, null, null, new MediaEngineModule$setVideoInputDevice$1(this, d10, null), 3, null);
    }

    @Override // com.discord.codegen.NativeMediaEngineModuleSpec
    public void setVideoInputDeviceById(@NotNull String deviceName) {
        Intrinsics.checkNotNullParameter(deviceName, "deviceName");
        ms.i.d(this.appScope, null, null, new MediaEngineModule$setVideoInputDeviceById$1(this, deviceName, null), 3, null);
    }
    ...
    public void startLocalAudioRecording(@NotNull ReadableMap options, @NotNull Callback callback) {
        Intrinsics.checkNotNullParameter(options, "options");
        Intrinsics.checkNotNullParameter(callback, "callback");
        ms.i.d(this.appScope, null, null, new MediaEngineModule$startLocalAudioRecording$1(this, options, callback, null), 3, null);
    }

    @Override // com.discord.codegen.NativeMediaEngineModuleSpec
    public void stopBroadcast() {
        ms.i.d(this.appScope, null, null, new MediaEngineModule$stopBroadcast$1(this, null), 3, null);
    }

    @Override // com.discord.codegen.NativeMediaEngineModuleSpec
    public void stopBroadcastWithError(double d10, @NotNull String errorMessage) {
        Intrinsics.checkNotNullParameter(errorMessage, "errorMessage");
        ms.i.d(this.appScope, null, null, new MediaEngineModule$stopBroadcastWithError$1(this, d10, errorMessage, null), 3, null);
    }

    @Override // com.discord.codegen.NativeMediaEngineModuleSpec
    public void stopLocalAudioRecording(@NotNull Callback callback) {
        Intrinsics.checkNotNullParameter(callback, "callback");
        ms.i.d(this.appScope, null, null, new MediaEngineModule$stopLocalAudioRecording$1(this, callback, null), 3, null);
    }
    ...
    public void updateFieldTrial(@NotNull String key, @NotNull String value) {
        ...
        ms.i.d(this.appScope, null, null, new MediaEngineModule$updateFieldTrial$1(this, key, value, null), 3, null);
    }
}
