...
public final class ApplicationId implements SnowflakePrimitive {
    ...
    public static final class Creator implements Parcelable.Creator<ApplicationId> {
        ...
        public /* bridge */ /* synthetic */ ApplicationId createFromParcel(Parcel parcel) {
            return ApplicationId.m1047boximpl(m1059createFromParcelUV2lyTI(parcel));
        }

        /* renamed from: createFromParcel-UV2lyTI  reason: not valid java name */
        public final long m1059createFromParcelUV2lyTI(Parcel parcel) {
            Intrinsics.checkNotNullParameter(parcel, "parcel");
            return ApplicationId.m1048constructorimpl(parcel.readLong());
        }
    ...
    public static final /* synthetic */ ApplicationId m1047boximpl(long j10) {
        return new ApplicationId(j10);
    }

    /* renamed from: constructor-impl  reason: not valid java name */
    public static long m1048constructorimpl(long j10) {
        return j10;
    }

    /* renamed from: describeContents-impl  reason: not valid java name */
    public static final int m1049describeContentsimpl(long j10) {
        return 0;
    }

    /* renamed from: equals-impl  reason: not valid java name */
    public static boolean m1050equalsimpl(long j10, Object obj) {
        return (obj instanceof ApplicationId) && j10 == ((ApplicationId) obj).m1056unboximpl();
    }

    /* renamed from: equals-impl0  reason: not valid java name */
    public static final boolean m1051equalsimpl0(long j10, long j11) {
        return j10 == j11;
    }

    /* renamed from: hashCode-impl  reason: not valid java name */
    public static int m1052hashCodeimpl(long j10) {
        return Long.hashCode(j10);
    }

    /* renamed from: isValid-impl  reason: not valid java name */
    public static boolean m1053isValidimpl(long j10) {
        return j10 > 0;
    }

    @NotNull
    /* renamed from: toString-impl  reason: not valid java name */
    public static String m1054toStringimpl(long j10) {
        return String.valueOf(j10);
    }

    /* renamed from: writeToParcel-impl  reason: not valid java name */
    public static final void m1055writeToParcelimpl(long j10, @NotNull Parcel dest, int i10) {
    ...
    public final int describeContents() {
        return m1049describeContentsimpl(this.snowflake);
    }

    public boolean equals(Object obj) {
        return m1050equalsimpl(this.snowflake, obj);
    }
    ...
    public int hashCode() {
        return m1052hashCodeimpl(this.snowflake);
    }

    @Override // com.discord.snowflake.SnowflakePrimitive
    public boolean isValid() {
        return m1053isValidimpl(this.snowflake);
    }

    @NotNull
    public String toString() {
        return m1054toStringimpl(this.snowflake);
    }

    /* renamed from: unbox-impl  reason: not valid java name */
    public final /* synthetic */ long m1056unboximpl() {
        return this.snowflake;
    }
    ...
    public final void writeToParcel(@NotNull Parcel dest, int i10) {
        Intrinsics.checkNotNullParameter(dest, "dest");
        m1055writeToParcelimpl(this.snowflake, dest, i10);
    }
}
