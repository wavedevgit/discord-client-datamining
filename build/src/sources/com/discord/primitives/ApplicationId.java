...
public final class ApplicationId implements SnowflakePrimitive {
    ...
    public static final class Creator implements Parcelable.Creator<ApplicationId> {
        ...
        public /* bridge */ /* synthetic */ ApplicationId createFromParcel(Parcel parcel) {
            return ApplicationId.m1045boximpl(m1057createFromParcelUV2lyTI(parcel));
        }

        /* renamed from: createFromParcel-UV2lyTI  reason: not valid java name */
        public final long m1057createFromParcelUV2lyTI(Parcel parcel) {
            Intrinsics.checkNotNullParameter(parcel, "parcel");
            return ApplicationId.m1046constructorimpl(parcel.readLong());
        }
    ...
    public static final /* synthetic */ ApplicationId m1045boximpl(long j10) {
        return new ApplicationId(j10);
    }

    /* renamed from: constructor-impl  reason: not valid java name */
    public static long m1046constructorimpl(long j10) {
        return j10;
    }

    /* renamed from: describeContents-impl  reason: not valid java name */
    public static final int m1047describeContentsimpl(long j10) {
        return 0;
    }

    /* renamed from: equals-impl  reason: not valid java name */
    public static boolean m1048equalsimpl(long j10, Object obj) {
        return (obj instanceof ApplicationId) && j10 == ((ApplicationId) obj).m1054unboximpl();
    }

    /* renamed from: equals-impl0  reason: not valid java name */
    public static final boolean m1049equalsimpl0(long j10, long j11) {
        return j10 == j11;
    }

    /* renamed from: hashCode-impl  reason: not valid java name */
    public static int m1050hashCodeimpl(long j10) {
        return Long.hashCode(j10);
    }

    /* renamed from: isValid-impl  reason: not valid java name */
    public static boolean m1051isValidimpl(long j10) {
        return j10 > 0;
    }

    @NotNull
    /* renamed from: toString-impl  reason: not valid java name */
    public static String m1052toStringimpl(long j10) {
        return String.valueOf(j10);
    }

    /* renamed from: writeToParcel-impl  reason: not valid java name */
    public static final void m1053writeToParcelimpl(long j10, @NotNull Parcel dest, int i10) {
    ...
    public final int describeContents() {
        return m1047describeContentsimpl(this.snowflake);
    }

    public boolean equals(Object obj) {
        return m1048equalsimpl(this.snowflake, obj);
    }
    ...
    public int hashCode() {
        return m1050hashCodeimpl(this.snowflake);
    }

    @Override // com.discord.snowflake.SnowflakePrimitive
    public boolean isValid() {
        return m1051isValidimpl(this.snowflake);
    }

    @NotNull
    public String toString() {
        return m1052toStringimpl(this.snowflake);
    }

    /* renamed from: unbox-impl  reason: not valid java name */
    public final /* synthetic */ long m1054unboximpl() {
        return this.snowflake;
    }
    ...
    public final void writeToParcel(@NotNull Parcel dest, int i10) {
        Intrinsics.checkNotNullParameter(dest, "dest");
        m1053writeToParcelimpl(this.snowflake, dest, i10);
    }
}
