...
public final class ApplicationId implements SnowflakePrimitive {
    ...
    public static final class Creator implements Parcelable.Creator<ApplicationId> {
        ...
        public /* bridge */ /* synthetic */ ApplicationId createFromParcel(Parcel parcel) {
            return ApplicationId.m1046boximpl(m1058createFromParcelUV2lyTI(parcel));
        }

        /* renamed from: createFromParcel-UV2lyTI  reason: not valid java name */
        public final long m1058createFromParcelUV2lyTI(Parcel parcel) {
            Intrinsics.checkNotNullParameter(parcel, "parcel");
            return ApplicationId.m1047constructorimpl(parcel.readLong());
        }
    ...
    public static final /* synthetic */ ApplicationId m1046boximpl(long j10) {
        return new ApplicationId(j10);
    }

    /* renamed from: constructor-impl  reason: not valid java name */
    public static long m1047constructorimpl(long j10) {
        return j10;
    }

    /* renamed from: describeContents-impl  reason: not valid java name */
    public static final int m1048describeContentsimpl(long j10) {
        return 0;
    }

    /* renamed from: equals-impl  reason: not valid java name */
    public static boolean m1049equalsimpl(long j10, Object obj) {
        return (obj instanceof ApplicationId) && j10 == ((ApplicationId) obj).m1055unboximpl();
    }

    /* renamed from: equals-impl0  reason: not valid java name */
    public static final boolean m1050equalsimpl0(long j10, long j11) {
        return j10 == j11;
    }

    /* renamed from: hashCode-impl  reason: not valid java name */
    public static int m1051hashCodeimpl(long j10) {
        return Long.hashCode(j10);
    }

    /* renamed from: isValid-impl  reason: not valid java name */
    public static boolean m1052isValidimpl(long j10) {
        return j10 > 0;
    }

    @NotNull
    /* renamed from: toString-impl  reason: not valid java name */
    public static String m1053toStringimpl(long j10) {
        return String.valueOf(j10);
    }

    /* renamed from: writeToParcel-impl  reason: not valid java name */
    public static final void m1054writeToParcelimpl(long j10, @NotNull Parcel dest, int i10) {
    ...
    public final int describeContents() {
        return m1048describeContentsimpl(this.snowflake);
    }

    public boolean equals(Object obj) {
        return m1049equalsimpl(this.snowflake, obj);
    }
    ...
    public int hashCode() {
        return m1051hashCodeimpl(this.snowflake);
    }

    @Override // com.discord.snowflake.SnowflakePrimitive
    public boolean isValid() {
        return m1052isValidimpl(this.snowflake);
    }

    @NotNull
    public String toString() {
        return m1053toStringimpl(this.snowflake);
    }

    /* renamed from: unbox-impl  reason: not valid java name */
    public final /* synthetic */ long m1055unboximpl() {
        return this.snowflake;
    }
    ...
    public final void writeToParcel(@NotNull Parcel dest, int i10) {
        Intrinsics.checkNotNullParameter(dest, "dest");
        m1054writeToParcelimpl(this.snowflake, dest, i10);
    }
}
