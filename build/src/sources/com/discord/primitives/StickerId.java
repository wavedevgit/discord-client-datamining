...
public final class StickerId implements SnowflakePrimitive {
    ...
    public static final class Creator implements Parcelable.Creator<StickerId> {
        ...
        public /* bridge */ /* synthetic */ StickerId createFromParcel(Parcel parcel) {
            return StickerId.m1124boximpl(m1136createFromParcelaEuejx8(parcel));
        }

        /* renamed from: createFromParcel-aEuejx8  reason: not valid java name */
        public final long m1136createFromParcelaEuejx8(Parcel parcel) {
            Intrinsics.checkNotNullParameter(parcel, "parcel");
            return StickerId.m1125constructorimpl(parcel.readLong());
        }
    ...
    public static final /* synthetic */ StickerId m1124boximpl(long j10) {
        return new StickerId(j10);
    }

    /* renamed from: constructor-impl  reason: not valid java name */
    public static long m1125constructorimpl(long j10) {
        return j10;
    }

    /* renamed from: describeContents-impl  reason: not valid java name */
    public static final int m1126describeContentsimpl(long j10) {
        return 0;
    }

    /* renamed from: equals-impl  reason: not valid java name */
    public static boolean m1127equalsimpl(long j10, Object obj) {
        return (obj instanceof StickerId) && j10 == ((StickerId) obj).m1133unboximpl();
    }

    /* renamed from: equals-impl0  reason: not valid java name */
    public static final boolean m1128equalsimpl0(long j10, long j11) {
        return j10 == j11;
    }

    /* renamed from: hashCode-impl  reason: not valid java name */
    public static int m1129hashCodeimpl(long j10) {
        return Long.hashCode(j10);
    }

    /* renamed from: isValid-impl  reason: not valid java name */
    public static boolean m1130isValidimpl(long j10) {
        return j10 > 0;
    }

    @NotNull
    /* renamed from: toString-impl  reason: not valid java name */
    public static String m1131toStringimpl(long j10) {
        return String.valueOf(j10);
    }

    /* renamed from: writeToParcel-impl  reason: not valid java name */
    public static final void m1132writeToParcelimpl(long j10, @NotNull Parcel dest, int i10) {
    ...
    public final int describeContents() {
        return m1126describeContentsimpl(this.snowflake);
    }

    public boolean equals(Object obj) {
        return m1127equalsimpl(this.snowflake, obj);
    }
    ...
    public int hashCode() {
        return m1129hashCodeimpl(this.snowflake);
    }

    @Override // com.discord.snowflake.SnowflakePrimitive
    public boolean isValid() {
        return m1130isValidimpl(this.snowflake);
    }

    @NotNull
    public String toString() {
        return m1131toStringimpl(this.snowflake);
    }
    ...
    public final void writeToParcel(@NotNull Parcel dest, int i10) {
        Intrinsics.checkNotNullParameter(dest, "dest");
        m1132writeToParcelimpl(this.snowflake, dest, i10);
    }
}
