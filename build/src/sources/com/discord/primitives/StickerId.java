...
public final class StickerId implements SnowflakePrimitive {
    ...
    public static final class Creator implements Parcelable.Creator<StickerId> {
        ...
        public /* bridge */ /* synthetic */ StickerId createFromParcel(Parcel parcel) {
            return StickerId.m1125boximpl(m1137createFromParcelaEuejx8(parcel));
        }

        /* renamed from: createFromParcel-aEuejx8  reason: not valid java name */
        public final long m1137createFromParcelaEuejx8(Parcel parcel) {
            Intrinsics.checkNotNullParameter(parcel, "parcel");
            return StickerId.m1126constructorimpl(parcel.readLong());
        }
    ...
    public static final /* synthetic */ StickerId m1125boximpl(long j10) {
        return new StickerId(j10);
    }

    /* renamed from: constructor-impl  reason: not valid java name */
    public static long m1126constructorimpl(long j10) {
        return j10;
    }

    /* renamed from: describeContents-impl  reason: not valid java name */
    public static final int m1127describeContentsimpl(long j10) {
        return 0;
    }

    /* renamed from: equals-impl  reason: not valid java name */
    public static boolean m1128equalsimpl(long j10, Object obj) {
        return (obj instanceof StickerId) && j10 == ((StickerId) obj).m1134unboximpl();
    }

    /* renamed from: equals-impl0  reason: not valid java name */
    public static final boolean m1129equalsimpl0(long j10, long j11) {
        return j10 == j11;
    }

    /* renamed from: hashCode-impl  reason: not valid java name */
    public static int m1130hashCodeimpl(long j10) {
        return Long.hashCode(j10);
    }

    /* renamed from: isValid-impl  reason: not valid java name */
    public static boolean m1131isValidimpl(long j10) {
        return j10 > 0;
    }

    @NotNull
    /* renamed from: toString-impl  reason: not valid java name */
    public static String m1132toStringimpl(long j10) {
        return String.valueOf(j10);
    }

    /* renamed from: writeToParcel-impl  reason: not valid java name */
    public static final void m1133writeToParcelimpl(long j10, @NotNull Parcel dest, int i10) {
    ...
    public final int describeContents() {
        return m1127describeContentsimpl(this.snowflake);
    }

    public boolean equals(Object obj) {
        return m1128equalsimpl(this.snowflake, obj);
    }
    ...
    public int hashCode() {
        return m1130hashCodeimpl(this.snowflake);
    }

    @Override // com.discord.snowflake.SnowflakePrimitive
    public boolean isValid() {
        return m1131isValidimpl(this.snowflake);
    }

    @NotNull
    public String toString() {
        return m1132toStringimpl(this.snowflake);
    }

    /* renamed from: unbox-impl  reason: not valid java name */
    public final /* synthetic */ long m1134unboximpl() {
        return this.snowflake;
    }
    ...
    public final void writeToParcel(@NotNull Parcel dest, int i10) {
        Intrinsics.checkNotNullParameter(dest, "dest");
        m1133writeToParcelimpl(this.snowflake, dest, i10);
    }
}
