...
public final class ChannelId implements SnowflakePrimitive {
    ...
    public static final class Creator implements Parcelable.Creator<ChannelId> {
        ...
        public /* bridge */ /* synthetic */ ChannelId createFromParcel(Parcel parcel) {
            return ChannelId.m1057boximpl(m1069createFromParcel18flms(parcel));
        }

        /* renamed from: createFromParcel-18-flms  reason: not valid java name */
        public final long m1069createFromParcel18flms(Parcel parcel) {
            Intrinsics.checkNotNullParameter(parcel, "parcel");
            return ChannelId.m1058constructorimpl(parcel.readLong());
        }
    ...
    public static final /* synthetic */ ChannelId m1057boximpl(long j10) {
        return new ChannelId(j10);
    }

    /* renamed from: constructor-impl  reason: not valid java name */
    public static long m1058constructorimpl(long j10) {
        return j10;
    }

    /* renamed from: describeContents-impl  reason: not valid java name */
    public static final int m1059describeContentsimpl(long j10) {
        return 0;
    }

    /* renamed from: equals-impl  reason: not valid java name */
    public static boolean m1060equalsimpl(long j10, Object obj) {
        return (obj instanceof ChannelId) && j10 == ((ChannelId) obj).m1066unboximpl();
    }

    /* renamed from: equals-impl0  reason: not valid java name */
    public static final boolean m1061equalsimpl0(long j10, long j11) {
        return j10 == j11;
    }

    /* renamed from: hashCode-impl  reason: not valid java name */
    public static int m1062hashCodeimpl(long j10) {
        return Long.hashCode(j10);
    }

    /* renamed from: isValid-impl  reason: not valid java name */
    public static boolean m1063isValidimpl(long j10) {
        return j10 > 0;
    }

    @NotNull
    /* renamed from: toString-impl  reason: not valid java name */
    public static String m1064toStringimpl(long j10) {
        return String.valueOf(j10);
    }

    /* renamed from: writeToParcel-impl  reason: not valid java name */
    public static final void m1065writeToParcelimpl(long j10, @NotNull Parcel dest, int i10) {
    ...
    public final int describeContents() {
        return m1059describeContentsimpl(this.snowflake);
    }

    public boolean equals(Object obj) {
        return m1060equalsimpl(this.snowflake, obj);
    }
    ...
    public int hashCode() {
        return m1062hashCodeimpl(this.snowflake);
    }

    @Override // com.discord.snowflake.SnowflakePrimitive
    public boolean isValid() {
        return m1063isValidimpl(this.snowflake);
    }

    @NotNull
    public String toString() {
        return m1064toStringimpl(this.snowflake);
    }

    /* renamed from: unbox-impl  reason: not valid java name */
    public final /* synthetic */ long m1066unboximpl() {
        return this.snowflake;
    }
    ...
    public final void writeToParcel(@NotNull Parcel dest, int i10) {
        Intrinsics.checkNotNullParameter(dest, "dest");
        m1065writeToParcelimpl(this.snowflake, dest, i10);
    }
}
