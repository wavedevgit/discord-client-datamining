...
public /* synthetic */ class MessageId$$serializer implements h0 {
    ...
    public /* bridge */ /* synthetic */ Object deserialize(Decoder decoder) {
        return MessageId.m1083boximpl(m1093deserializeMpY7Jxs(decoder));
    }

    @NotNull
    /* renamed from: deserialize-MpY7Jxs  reason: not valid java name */
    public final String m1093deserializeMpY7Jxs(@NotNull Decoder decoder) {
        Intrinsics.checkNotNullParameter(decoder, "decoder");
        return MessageId.m1084constructorimpl(decoder.q(descriptor).z());
    }
    ...
    public /* bridge */ /* synthetic */ void serialize(Encoder encoder, Object obj) {
        m1094serializeAyv7vGE(encoder, ((MessageId) obj).m1092unboximpl());
    }

    /* renamed from: serialize-Ayv7vGE  reason: not valid java name */
    public final void m1094serializeAyv7vGE(@NotNull Encoder encoder, @NotNull String value) {
        Intrinsics.checkNotNullParameter(encoder, "encoder");
        Intrinsics.checkNotNullParameter(value, "value");
        Encoder j10 = encoder.j(descriptor);
        if (j10 == null) {
            return;
        }
        j10.F(value);
