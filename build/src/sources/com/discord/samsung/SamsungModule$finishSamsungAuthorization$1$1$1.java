...
final class SamsungModule$finishSamsungAuthorization$1$1$1 extends k implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        if (this.label == 0) {
            ...
            if (handleSamsungCallback != null && (queryParameter = handleSamsungCallback.getQueryParameter("redirect_uri")) != null) {
                ...
                this.this$0.handleSamsungCallback(this.$client.a(new Request.Builder().h(RequestBody.Companion.b(CollectionsKt.x0(arrayList, "&", null, null, 0, null, null, 62, null), MediaType.f42920e.b("application/x-www-form-urlencoded"))).l(queryParameter).b()).execute());
    ...
    public final Object invoke(CoroutineScope coroutineScope, Continuation<? super Unit> continuation) {
        return ((SamsungModule$finishSamsungAuthorization$1$1$1) create(coroutineScope, continuation)).invokeSuspend(Unit.f32056a);
    }
}
