...
public final class Cache {
    ...
    public Cache(@NotNull final Context reactContext) {
        ...
        this.sharedPrefs$delegate = l.b(new Function0() { // from class: j6.a
        ...
        this.fastCacheSharedPrefs$delegate = l.b(new Function0() { // from class: j6.b
            @Override // kotlin.jvm.functions.Function0
            public final Object invoke() {
                SharedPreferences sharedPreferences;
        ...
        a.b(false, false, null, null, 0, new Function0() { // from class: j6.c
            @Override // kotlin.jvm.functions.Function0
            public final Object invoke() {
