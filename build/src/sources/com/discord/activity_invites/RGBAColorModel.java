...
public final class RGBAColorModel {
    ...
    public static /* synthetic */ RGBAColorModel copy$default(RGBAColorModel rGBAColorModel, float f10, float f11, float f12, float f13, int i10, Object obj) {
        if ((i10 & 1) != 0) {
            f10 = rGBAColorModel.f8139r;
        }
        if ((i10 & 2) != 0) {
            f11 = rGBAColorModel.f8138g;
        }
        if ((i10 & 4) != 0) {
            f12 = rGBAColorModel.f8137b;
        }
        if ((i10 & 8) != 0) {
            f13 = rGBAColorModel.f8136a;
        }
    ...
    public static final /* synthetic */ void write$Self$activity_invites_release(RGBAColorModel rGBAColorModel, CompositeEncoder compositeEncoder, SerialDescriptor serialDescriptor) {
        compositeEncoder.r(serialDescriptor, 0, rGBAColorModel.f8139r);
        compositeEncoder.r(serialDescriptor, 1, rGBAColorModel.f8138g);
        compositeEncoder.r(serialDescriptor, 2, rGBAColorModel.f8137b);
        compositeEncoder.r(serialDescriptor, 3, rGBAColorModel.f8136a);
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof RGBAColorModel) {
            ...
            return Float.compare(this.f8139r, rGBAColorModel.f8139r) == 0 && Float.compare(this.f8138g, rGBAColorModel.f8138g) == 0 && Float.compare(this.f8137b, rGBAColorModel.f8137b) == 0 && Float.compare(this.f8136a, rGBAColorModel.f8136a) == 0;
        }
        return false;
    }
    ...
    public int hashCode() {
        return (((((Float.hashCode(this.f8139r) * 31) + Float.hashCode(this.f8138g)) * 31) + Float.hashCode(this.f8137b)) * 31) + Float.hashCode(this.f8136a);
    }

    @NotNull
    public String toString() {
        float f10 = this.f8139r;
        float f11 = this.f8138g;
        float f12 = this.f8137b;
        float f13 = this.f8136a;
