...
public final class RGBAColorModel {
    ...
    private final float f8523g;

    /* renamed from: r  reason: collision with root package name */
    private final float f8524r;
    ...
    public static /* synthetic */ RGBAColorModel copy$default(RGBAColorModel rGBAColorModel, float f10, float f11, float f12, float f13, int i10, Object obj) {
        if ((i10 & 1) != 0) {
            f10 = rGBAColorModel.f8524r;
        }
        if ((i10 & 2) != 0) {
            f11 = rGBAColorModel.f8523g;
        }
        if ((i10 & 4) != 0) {
            f12 = rGBAColorModel.f8522b;
        }
        if ((i10 & 8) != 0) {
            f13 = rGBAColorModel.f8521a;
        }
    ...
    public static final /* synthetic */ void write$Self$activity_invites_release(RGBAColorModel rGBAColorModel, CompositeEncoder compositeEncoder, SerialDescriptor serialDescriptor) {
        compositeEncoder.r(serialDescriptor, 0, rGBAColorModel.f8524r);
        compositeEncoder.r(serialDescriptor, 1, rGBAColorModel.f8523g);
        compositeEncoder.r(serialDescriptor, 2, rGBAColorModel.f8522b);
        compositeEncoder.r(serialDescriptor, 3, rGBAColorModel.f8521a);
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof RGBAColorModel) {
            ...
            return Float.compare(this.f8524r, rGBAColorModel.f8524r) == 0 && Float.compare(this.f8523g, rGBAColorModel.f8523g) == 0 && Float.compare(this.f8522b, rGBAColorModel.f8522b) == 0 && Float.compare(this.f8521a, rGBAColorModel.f8521a) == 0;
        }
        return false;
    }
    ...
    public int hashCode() {
        return (((((Float.hashCode(this.f8524r) * 31) + Float.hashCode(this.f8523g)) * 31) + Float.hashCode(this.f8522b)) * 31) + Float.hashCode(this.f8521a);
    }

    @NotNull
    public String toString() {
        float f10 = this.f8524r;
        float f11 = this.f8523g;
        float f12 = this.f8522b;
        float f13 = this.f8521a;
