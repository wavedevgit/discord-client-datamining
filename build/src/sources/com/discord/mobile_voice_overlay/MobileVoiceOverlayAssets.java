...
public final class MobileVoiceOverlayAssets {
    ...
    public static final /* synthetic */ void write$Self$mobile_voice_overlay_release(MobileVoiceOverlayAssets mobileVoiceOverlayAssets, CompositeEncoder compositeEncoder, SerialDescriptor serialDescriptor) {
        compositeEncoder.y(serialDescriptor, 0, mobileVoiceOverlayAssets.useSpeaker);
        compositeEncoder.y(serialDescriptor, 1, mobileVoiceOverlayAssets.mute);
        compositeEncoder.y(serialDescriptor, 2, mobileVoiceOverlayAssets.disconnectFromVoice);
        compositeEncoder.y(serialDescriptor, 3, mobileVoiceOverlayAssets.getInvite);
        compositeEncoder.y(serialDescriptor, 4, mobileVoiceOverlayAssets.switchChannels);
        compositeEncoder.y(serialDescriptor, 5, mobileVoiceOverlayAssets.openDiscord);
        compositeEncoder.y(serialDescriptor, 6, mobileVoiceOverlayAssets.inviteLinkCopied);
        compositeEncoder.y(serialDescriptor, 7, mobileVoiceOverlayAssets.channelSelect);
        compositeEncoder.y(serialDescriptor, 8, mobileVoiceOverlayAssets.closeWindow);
        compositeEncoder.y(serialDescriptor, 9, mobileVoiceOverlayAssets.searchChannels);
        compositeEncoder.y(serialDescriptor, 10, mobileVoiceOverlayAssets.noResults);
    }
