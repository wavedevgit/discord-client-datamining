...
public final class MobileVoiceOverlaySelectorResult {
    ...
    public static final /* synthetic */ void write$Self$mobile_voice_overlay_release(MobileVoiceOverlaySelectorResult mobileVoiceOverlaySelectorResult, CompositeEncoder compositeEncoder, SerialDescriptor serialDescriptor) {
        compositeEncoder.F(serialDescriptor, 0, GuildId$$serializer.INSTANCE, GuildId.m1070boximpl(mobileVoiceOverlaySelectorResult.guildId));
        compositeEncoder.F(serialDescriptor, 1, ChannelId$$serializer.INSTANCE, ChannelId.m1057boximpl(mobileVoiceOverlaySelectorResult.channelId));
