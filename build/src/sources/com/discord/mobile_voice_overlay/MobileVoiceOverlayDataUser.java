...
public final class MobileVoiceOverlayDataUser {
    ...
    public static /* synthetic */ MobileVoiceOverlayDataUser m962copyASSxI_0$default(MobileVoiceOverlayDataUser mobileVoiceOverlayDataUser, long j10, String str, boolean z10, int i10, int i11, Object obj) {
        if ((i11 & 1) != 0) {
        ...
        return mobileVoiceOverlayDataUser.m964copyASSxI_0(j11, str2, z11, i10);
    }
    ...
    public static final /* synthetic */ void write$Self$mobile_voice_overlay_release(MobileVoiceOverlayDataUser mobileVoiceOverlayDataUser, CompositeEncoder compositeEncoder, SerialDescriptor serialDescriptor) {
        compositeEncoder.s(serialDescriptor, 0, UserId$$serializer.INSTANCE, UserId.m1135boximpl(mobileVoiceOverlayDataUser.userId));
        compositeEncoder.l(serialDescriptor, 1, n2.f31041a, mobileVoiceOverlayDataUser.avatar);
        compositeEncoder.y(serialDescriptor, 2, mobileVoiceOverlayDataUser.speaking);
        compositeEncoder.x(serialDescriptor, 3, mobileVoiceOverlayDataUser.discriminator);
    }

    /* renamed from: component1-re6GcUE  reason: not valid java name */
    public final long m963component1re6GcUE() {
        return this.userId;
    }
    ...
    public final MobileVoiceOverlayDataUser m964copyASSxI_0(long j10, String str, boolean z10, int i10) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof MobileVoiceOverlayDataUser) {
            ...
            return UserId.m1139equalsimpl0(this.userId, mobileVoiceOverlayDataUser.userId) && Intrinsics.areEqual(this.avatar, mobileVoiceOverlayDataUser.avatar) && this.speaking == mobileVoiceOverlayDataUser.speaking && this.discriminator == mobileVoiceOverlayDataUser.discriminator;
        }
        return false;
    }
    ...
    public final long m965getUserIdre6GcUE() {
        return this.userId;
    }
    ...
    public int hashCode() {
        ...
        return ((((m1140hashCodeimpl + (str == null ? 0 : str.hashCode())) * 31) + Boolean.hashCode(this.speaking)) * 31) + Integer.hashCode(this.discriminator);
    }
    ...
    public String toString() {
        ...
        return "MobileVoiceOverlayDataUser(userId=" + m1142toStringimpl + ", avatar=" + str + ", speaking=" + z10 + ", discriminator=" + i10 + ")";
    }
