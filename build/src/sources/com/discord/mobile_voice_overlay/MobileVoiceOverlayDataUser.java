...
public final class MobileVoiceOverlayDataUser {
    ...
    public static final /* synthetic */ void write$Self$mobile_voice_overlay_release(MobileVoiceOverlayDataUser mobileVoiceOverlayDataUser, CompositeEncoder compositeEncoder, SerialDescriptor serialDescriptor) {
        compositeEncoder.j(serialDescriptor, 0, UserId$$serializer.INSTANCE, UserId.m1136boximpl(mobileVoiceOverlayDataUser.userId));
        compositeEncoder.z(serialDescriptor, 1, n2.f6848a, mobileVoiceOverlayDataUser.avatar);
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof MobileVoiceOverlayDataUser) {
            ...
            return UserId.m1140equalsimpl0(this.userId, mobileVoiceOverlayDataUser.userId) && Intrinsics.areEqual(this.avatar, mobileVoiceOverlayDataUser.avatar) && this.speaking == mobileVoiceOverlayDataUser.speaking && this.discriminator == mobileVoiceOverlayDataUser.discriminator;
        }
        return false;
    }
    ...
    public int hashCode() {
        ...
        return ((((m1141hashCodeimpl + (str == null ? 0 : str.hashCode())) * 31) + Boolean.hashCode(this.speaking)) * 31) + Integer.hashCode(this.discriminator);
    }
    ...
    public String toString() {
        ...
        return "MobileVoiceOverlayDataUser(userId=" + m1143toStringimpl + ", avatar=" + str + ", speaking=" + z10 + ", discriminator=" + i10 + ")";
    }
