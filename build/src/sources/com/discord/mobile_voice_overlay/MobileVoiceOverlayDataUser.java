...
public final class MobileVoiceOverlayDataUser {
    ...
    public static final /* synthetic */ void write$Self$mobile_voice_overlay_release(MobileVoiceOverlayDataUser mobileVoiceOverlayDataUser, CompositeEncoder compositeEncoder, SerialDescriptor serialDescriptor) {
        compositeEncoder.m(serialDescriptor, 0, UserId$$serializer.INSTANCE, UserId.m1138boximpl(mobileVoiceOverlayDataUser.userId));
        compositeEncoder.B(serialDescriptor, 1, n2.f7662a, mobileVoiceOverlayDataUser.avatar);
        compositeEncoder.w(serialDescriptor, 2, mobileVoiceOverlayDataUser.speaking);
        compositeEncoder.v(serialDescriptor, 3, mobileVoiceOverlayDataUser.discriminator);
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof MobileVoiceOverlayDataUser) {
            ...
            return UserId.m1142equalsimpl0(this.userId, mobileVoiceOverlayDataUser.userId) && Intrinsics.areEqual(this.avatar, mobileVoiceOverlayDataUser.avatar) && this.speaking == mobileVoiceOverlayDataUser.speaking && this.discriminator == mobileVoiceOverlayDataUser.discriminator;
        }
        return false;
    }
    ...
    public int hashCode() {
        ...
        return ((((m1143hashCodeimpl + (str == null ? 0 : str.hashCode())) * 31) + Boolean.hashCode(this.speaking)) * 31) + Integer.hashCode(this.discriminator);
    }
    ...
    public String toString() {
        ...
        return "MobileVoiceOverlayDataUser(userId=" + m1145toStringimpl + ", avatar=" + str + ", speaking=" + z10 + ", discriminator=" + i10 + ")";
    }
