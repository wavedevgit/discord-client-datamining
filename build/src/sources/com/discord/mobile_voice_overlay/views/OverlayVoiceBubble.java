...
public final class OverlayVoiceBubble extends OverlayBubbleWrap {
    ...
    public final void configureUI(@NotNull MobileVoiceOverlayDataUser user) {
        ...
        simpleDraweeView.setImageURI(IconUrlUtils.m915getForUser_fRzTXg$default(iconUrlUtils, context, UserId.m1136boximpl(user.m965getUserIdre6GcUE()), user.getAvatar(), Integer.valueOf(user.getDiscriminator()), false, null, 48, null));
        if (user.getSpeaking()) {
            fadeActive();
        } else {
            fadeDormant();
