...
public final class MobileVoiceOverlayData {
    ...
    public int hashCode() {
        ...
        return ((((((((((((((((hashCode + (guildId == null ? 0 : GuildId.m1077hashCodeimpl(guildId.m1081unboximpl()))) * 31) + ChannelId.m1064hashCodeimpl(this.channelId)) * 31) + this.channelName.hashCode()) * 31) + this.guildName.hashCode()) * 31) + Boolean.hashCode(this.deafened)) * 31) + Boolean.hashCode(this.muted)) * 31) + this.connectionQuality.hashCode()) * 31) + Boolean.hashCode(this.canGenerateInvite)) * 31) + this.channelSelectorResults.hashCode();
    }
    ...
    public String toString() {
        ...
        return "MobileVoiceOverlayData(users=" + list + ", extraUsers=" + i10 + ", guildId=" + guildId + ", channelId=" + m1066toStringimpl + ", channelName=" + str + ", guildName=" + str2 + ", deafened=" + z10 + ", muted=" + z11 + ", connectionQuality=" + connectionQuality + ", canGenerateInvite=" + z12 + ", channelSelectorResults=" + list2 + ")";
    }
