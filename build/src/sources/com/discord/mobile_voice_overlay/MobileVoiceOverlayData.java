...
public final class MobileVoiceOverlayData {
    ...
    static {
        ...
        $childSerializers = new Lazy[]{jr.l.a(oVar, new Function0() { // from class: com.discord.mobile_voice_overlay.s
        ...
        }), null, null, null, null, null, null, null, jr.l.a(oVar, new Function0() { // from class: com.discord.mobile_voice_overlay.t
            @Override // kotlin.jvm.functions.Function0
            public final Object invoke() {
        ...
        }), null, jr.l.a(oVar, new Function0() { // from class: com.discord.mobile_voice_overlay.u
            @Override // kotlin.jvm.functions.Function0
            public final Object invoke() {
    ...
    public static final /* synthetic */ KSerializer _childSerializers$_anonymous_() {
        return new bt.f(MobileVoiceOverlayDataUser$$serializer.INSTANCE);
    }
    ...
    public static final /* synthetic */ KSerializer _childSerializers$_anonymous_$1() {
        return new bt.f(MobileVoiceOverlaySelectorResult$$serializer.INSTANCE);
    }

    /* renamed from: copy-HeAh3Ug$default  reason: not valid java name */
    public static /* synthetic */ MobileVoiceOverlayData m958copyHeAh3Ug$default(MobileVoiceOverlayData mobileVoiceOverlayData, List list, int i10, GuildId guildId, long j10, String str, String str2, boolean z10, boolean z11, ConnectionQuality connectionQuality, boolean z12, List list2, int i11, Object obj) {
        ...
        return mobileVoiceOverlayData.m961copyHeAh3Ug(list3, i10, guildId2, j11, str3, str2, z14, z11, connectionQuality2, z13, list5);
    }
    ...
    public static final /* synthetic */ void write$Self$mobile_voice_overlay_release(MobileVoiceOverlayData mobileVoiceOverlayData, CompositeEncoder compositeEncoder, SerialDescriptor serialDescriptor) {
        ...
        compositeEncoder.m(serialDescriptor, 0, (ys.o) lazyArr[0].getValue(), mobileVoiceOverlayData.users);
        compositeEncoder.v(serialDescriptor, 1, mobileVoiceOverlayData.extraUsers);
        compositeEncoder.B(serialDescriptor, 2, GuildId$$serializer.INSTANCE, mobileVoiceOverlayData.guildId);
        compositeEncoder.m(serialDescriptor, 3, ChannelId$$serializer.INSTANCE, ChannelId.m1060boximpl(mobileVoiceOverlayData.channelId));
        ...
        compositeEncoder.m(serialDescriptor, 8, (ys.o) lazyArr[8].getValue(), mobileVoiceOverlayData.connectionQuality);
        compositeEncoder.w(serialDescriptor, 9, mobileVoiceOverlayData.canGenerateInvite);
        compositeEncoder.m(serialDescriptor, 10, (ys.o) lazyArr[10].getValue(), mobileVoiceOverlayData.channelSelectorResults);
    }
    ...
    public final GuildId m959component3qOKuAAo() {
        return this.guildId;
    }

    /* renamed from: component4-o4g7jtM  reason: not valid java name */
    public final long m960component4o4g7jtM() {
    ...
    public final MobileVoiceOverlayData m961copyHeAh3Ug(@NotNull List<MobileVoiceOverlayDataUser> users, int i10, GuildId guildId, long j10, @NotNull String channelName, @NotNull String guildName, boolean z10, boolean z11, @NotNull ConnectionQuality connectionQuality, boolean z12, @NotNull List<MobileVoiceOverlaySelectorResult> channelSelectorResults) {
    ...
    public final long m962getChannelIdo4g7jtM() {
        return this.channelId;
    }
    ...
    public final GuildId m963getGuildIdqOKuAAo() {
        return this.guildId;
    }
    ...
    public int hashCode() {
        ...
        return ((((((((((((((((hashCode + (guildId == null ? 0 : GuildId.m1078hashCodeimpl(guildId.m1082unboximpl()))) * 31) + ChannelId.m1065hashCodeimpl(this.channelId)) * 31) + this.channelName.hashCode()) * 31) + this.guildName.hashCode()) * 31) + Boolean.hashCode(this.deafened)) * 31) + Boolean.hashCode(this.muted)) * 31) + this.connectionQuality.hashCode()) * 31) + Boolean.hashCode(this.canGenerateInvite)) * 31) + this.channelSelectorResults.hashCode();
    }
    ...
    public String toString() {
        ...
        return "MobileVoiceOverlayData(users=" + list + ", extraUsers=" + i10 + ", guildId=" + guildId + ", channelId=" + m1067toStringimpl + ", channelName=" + str + ", guildName=" + str2 + ", deafened=" + z10 + ", muted=" + z11 + ", connectionQuality=" + connectionQuality + ", canGenerateInvite=" + z12 + ", channelSelectorResults=" + list2 + ")";
    }
