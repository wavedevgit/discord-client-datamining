...
public final class MobileVoiceOverlayData {
    ...
    static {
        ...
        $childSerializers = new Lazy[]{rr.l.b(oVar, new Function0() { // from class: com.discord.mobile_voice_overlay.s
        ...
        }), null, null, null, null, null, null, null, rr.l.b(oVar, new Function0() { // from class: com.discord.mobile_voice_overlay.t
            @Override // kotlin.jvm.functions.Function0
            public final Object invoke() {
        ...
        }), null, rr.l.b(oVar, new Function0() { // from class: com.discord.mobile_voice_overlay.u
            @Override // kotlin.jvm.functions.Function0
            public final Object invoke() {
    ...
    public static final /* synthetic */ KSerializer _childSerializers$_anonymous_() {
        return new kt.f(MobileVoiceOverlayDataUser$$serializer.INSTANCE);
    }
    ...
    public static final /* synthetic */ KSerializer _childSerializers$_anonymous_$1() {
        return new kt.f(MobileVoiceOverlaySelectorResult$$serializer.INSTANCE);
    }
    ...
    public static final /* synthetic */ void write$Self$mobile_voice_overlay_release(MobileVoiceOverlayData mobileVoiceOverlayData, CompositeEncoder compositeEncoder, SerialDescriptor serialDescriptor) {
        ...
        compositeEncoder.F(serialDescriptor, 0, (gt.o) lazyArr[0].getValue(), mobileVoiceOverlayData.users);
        compositeEncoder.w(serialDescriptor, 1, mobileVoiceOverlayData.extraUsers);
        compositeEncoder.i(serialDescriptor, 2, GuildId$$serializer.INSTANCE, mobileVoiceOverlayData.guildId);
        compositeEncoder.F(serialDescriptor, 3, ChannelId$$serializer.INSTANCE, ChannelId.m1057boximpl(mobileVoiceOverlayData.channelId));
        ...
        compositeEncoder.F(serialDescriptor, 8, (gt.o) lazyArr[8].getValue(), mobileVoiceOverlayData.connectionQuality);
        compositeEncoder.x(serialDescriptor, 9, mobileVoiceOverlayData.canGenerateInvite);
        compositeEncoder.F(serialDescriptor, 10, (gt.o) lazyArr[10].getValue(), mobileVoiceOverlayData.channelSelectorResults);
    }
