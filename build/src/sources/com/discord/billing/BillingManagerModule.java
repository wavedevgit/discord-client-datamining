...
public final class BillingManagerModule extends ReactContextBaseJavaModule {
    ...
    public BillingManagerModule(@NotNull ReactApplicationContext reactContext) {
        ...
        this.reactEvents = new ReactEvents(as.v.a("billing-manager-connection-state-updated", Reflection.getOrCreateKotlinClass(BillingManagerConnectionStateUpdated.class)), as.v.a("billing-manager-purchase-updated", Reflection.getOrCreateKotlinClass(BillingManagerPurchaseUpdated.class)), as.v.a("billing-manager-purchase-state-updated", Reflection.getOrCreateKotlinClass(BillingManagerPurchaseStateUpdated.class)));
