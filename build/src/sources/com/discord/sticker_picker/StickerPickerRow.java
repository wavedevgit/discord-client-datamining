    ...
    public static final class Sticker {
        ...
        public boolean equals(Object obj) {
            ...
            if (obj instanceof Sticker) {
                ...
                return Intrinsics.areEqual(this.f10826id, sticker.f10826id) && Intrinsics.areEqual(this.name, sticker.name) && this.type == sticker.type && this.animated == sticker.animated && Intrinsics.areEqual(this.url, sticker.url) && this.disabled == sticker.disabled && this.opaque == sticker.opaque;
            }
            return false;
        }
        ...
        public int hashCode() {
            return (((((((((((this.f10826id.hashCode() * 31) + this.name.hashCode()) * 31) + this.type.hashCode()) * 31) + Boolean.hashCode(this.animated)) * 31) + this.url.hashCode()) * 31) + Boolean.hashCode(this.disabled)) * 31) + Boolean.hashCode(this.opaque);
        }
