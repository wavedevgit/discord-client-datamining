...
public final class StickerPickerRowView extends LinearLayout {
    ...
    public StickerPickerRowView(@NotNull Context context) {
        ...
        this.onPressSticker = new Function1() { // from class: g8.c
        ...
        this.onLongPressSticker = new Function1() { // from class: g8.d
            @Override // kotlin.jvm.functions.Function1
            public final Object invoke(Object obj) {
    ...
    private final void configureRowStickerViews(StickerPickerRow stickerPickerRow) {
        ...
        for (Object obj : stickerPickerRow.getItems()) {
            ...
            if (sticker == null) {
                ...
                NestedScrollOnTouchUtilsKt.setOnClickListenerNested$default(stickerView, false, new View.OnClickListener() { // from class: g8.a
                    @Override // android.view.View.OnClickListener
                    public final void onClick(View view) {
                        StickerPickerRowView.configureRowStickerViews$lambda$5$lambda$3(StickerPickerRowView.this, sticker, view);
                    }
                }, 1, null);
                NestedScrollOnTouchUtilsKt.setOnLongClickListenerNested$default(stickerView, false, new View.OnLongClickListener() { // from class: g8.b
