...
public final class BackgroundStyle {
    ...
    public static final /* synthetic */ void write$Self$span_utilities_release(BackgroundStyle backgroundStyle, CompositeEncoder compositeEncoder, SerialDescriptor serialDescriptor) {
        compositeEncoder.w(serialDescriptor, 0, backgroundStyle.backgroundColor);
        if (compositeEncoder.z(serialDescriptor, 1) || backgroundStyle.cornerRadius != 0) {
            compositeEncoder.w(serialDescriptor, 1, backgroundStyle.cornerRadius);
        }
        if (compositeEncoder.z(serialDescriptor, 2) || backgroundStyle.marginVertical != 0) {
            compositeEncoder.w(serialDescriptor, 2, backgroundStyle.marginVertical);
        }
    }
