...
public final class BackgroundStyle {
    ...
    public static final /* synthetic */ void write$Self$span_utilities_release(BackgroundStyle backgroundStyle, CompositeEncoder compositeEncoder, SerialDescriptor serialDescriptor) {
        compositeEncoder.x(serialDescriptor, 0, backgroundStyle.backgroundColor);
        if (compositeEncoder.A(serialDescriptor, 1) || backgroundStyle.cornerRadius != 0) {
            compositeEncoder.x(serialDescriptor, 1, backgroundStyle.cornerRadius);
        }
        if (compositeEncoder.A(serialDescriptor, 2) || backgroundStyle.marginVertical != 0) {
            compositeEncoder.x(serialDescriptor, 2, backgroundStyle.marginVertical);
        }
    }
