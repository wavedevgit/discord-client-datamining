...
public final class GGSansBoldSpan extends StyleSpan {
    ...
    private final void apply(Paint paint, Function0<Unit> function0) {
        ...
        if (fromTypeface != null) {
            discordFont = companion.findByStyle(DiscordFont.PrimaryBold.getWeight(), fromTypeface.getItalic(), fromTypeface.getMonospace());
        } else {
            discordFont = null;
        }
        if (discordFont != null) {
    ...
    public void updateDrawState(@NotNull final TextPaint ds2) {
        ...
        apply(ds2, new Function0() { // from class: d8.a
            @Override // kotlin.jvm.functions.Function0
            public final Object invoke() {
                Unit updateDrawState$lambda$0;
                updateDrawState$lambda$0 = GGSansBoldSpan.updateDrawState$lambda$0(GGSansBoldSpan.this, ds2);
    ...
    public void updateMeasureState(@NotNull final TextPaint paint) {
        ...
        apply(paint, new Function0() { // from class: d8.b
            @Override // kotlin.jvm.functions.Function0
            public final Object invoke() {
                Unit updateMeasureState$lambda$1;
                updateMeasureState$lambda$1 = GGSansBoldSpan.updateMeasureState$lambda$1(GGSansBoldSpan.this, paint);
