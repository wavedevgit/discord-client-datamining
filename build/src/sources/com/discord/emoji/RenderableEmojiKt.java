...
public final class RenderableEmojiKt {
    ...
    public static final void renderEmojiInto(DraweeSpanStringBuilder draweeSpanStringBuilder, String str, String str2, Context context, int i10, boolean z10, int i11, Function1<? super GenericDraweeHierarchyBuilder, Unit> function1) {
        ...
        com.facebook.drawee.controller.a build = ((PipelineDraweeControllerBuilder) ((PipelineDraweeControllerBuilder) ((PipelineDraweeControllerBuilder) f9.d.g().A(z10)).E(ImageRequestBuilder.x(Uri.parse(str)).N(new ResizeOptions(i10, i10, 0.0f, 0.0f, 12, null)).I(ImageRequest.RequestLevel.FULL_FETCH).a())).C(str2)).build();
        GenericDraweeHierarchyBuilder w10 = GenericDraweeHierarchyBuilder.u(context.getResources()).w(ScalingUtils$ScaleType.f10058e);
