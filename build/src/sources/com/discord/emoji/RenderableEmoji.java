...
public abstract class RenderableEmoji {
    ...
    public static final class Companion {
        ...
        public final Unicode unicode(@NotNull String surrogates) {
            ...
            return new Unicode(Surrogates.m866constructorimpl(surrogates), null);
        }
    ...
    public static final class Unicode extends RenderableEmoji {
        ...
        public static /* synthetic */ Unicode m861copyhLBmEAo$default(Unicode unicode, String str, int i10, Object obj) {
            if ((i10 & 1) != 0) {
                str = unicode.surrogates;
            }
            return unicode.m863copyhLBmEAo(str);
        }

        @NotNull
        /* renamed from: component1-Mny0UXI  reason: not valid java name */
        public final String m862component1Mny0UXI() {
            return this.surrogates;
        }

        @NotNull
        /* renamed from: copy-hLBmEAo  reason: not valid java name */
        public final Unicode m863copyhLBmEAo(@NotNull String surrogates) {
            Intrinsics.checkNotNullParameter(surrogates, "surrogates");
        ...
        public boolean equals(Object obj) {
            ...
            return (obj instanceof Unicode) && Surrogates.m868equalsimpl0(this.surrogates, ((Unicode) obj).surrogates);
        }
        ...
        public final String m864getSurrogatesMny0UXI() {
            return this.surrogates;
        }
        ...
        @NotNull
        public String getUrl(boolean z10, int i10) {
            return Surrogates.m870toAssetUrlimpl(this.surrogates);
        }

        public int hashCode() {
            return Surrogates.m869hashCodeimpl(this.surrogates);
        }

        @NotNull
        public String toString() {
            String m872toStringimpl = Surrogates.m872toStringimpl(this.surrogates);
            return "Unicode(surrogates=" + m872toStringimpl + ")";
        }
        ...
        private Unicode(String surrogates) {
            ...
            String m873withoutDiversityimpl = Surrogates.m873withoutDiversityimpl(surrogates);
            this.exception = RenderableEmoji.exceptions.contains(m873withoutDiversityimpl) ? m873withoutDiversityimpl : null;
        }
    }
