...
public final class ProcfsStats {
    ...
    @NotNull
    private static final Lazy statFile$delegate = l.a(new Function0() { // from class: b8.a
    ...
    static {
        final Supplier supplier = new Supplier() { // from class: b8.b
        ...
        readBuffer = new ThreadLocal() { // from class: b8.c
