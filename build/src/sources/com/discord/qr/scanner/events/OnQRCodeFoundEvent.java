...
public final class OnQRCodeFoundEvent implements ReactEvent {
    ...
    public /* synthetic */ OnQRCodeFoundEvent(int i10, String str, String str2, SerializationConstructorMarker serializationConstructorMarker) {
        if (1 != (i10 & 1)) {
            v1.b(i10, 1, OnQRCodeFoundEvent$$serializer.INSTANCE.getDescriptor());
        }
        this.status = str;
        if ((i10 & 2) == 0) {
            this.result = null;
    ...
    public static final /* synthetic */ void write$Self$qr_scanner_release(OnQRCodeFoundEvent onQRCodeFoundEvent, CompositeEncoder compositeEncoder, SerialDescriptor serialDescriptor) {
        compositeEncoder.y(serialDescriptor, 0, onQRCodeFoundEvent.status);
        if (compositeEncoder.z(serialDescriptor, 1) || onQRCodeFoundEvent.result != null) {
            compositeEncoder.s(serialDescriptor, 1, n2.f20978a, onQRCodeFoundEvent.result);
        }
    }
    ...
    @NotNull
    public final OnQRCodeFoundEvent copy(@NotNull String status, String str) {
