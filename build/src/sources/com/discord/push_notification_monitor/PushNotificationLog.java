...
public final class PushNotificationLog {
    ...
    @NotNull
    private static final Lazy[] $childSerializers = {l.b(o.f44232e, new Function0() { // from class: w7.a
    ...
    public static final /* synthetic */ void write$Self$push_notification_monitor_release(PushNotificationLog pushNotificationLog, CompositeEncoder compositeEncoder, SerialDescriptor serialDescriptor) {
        ...
        if (compositeEncoder.z(serialDescriptor, 0) || !Intrinsics.areEqual(pushNotificationLog.pushNotifications, CollectionsKt.l())) {
            compositeEncoder.l(serialDescriptor, 0, (dt.o) lazyArr[0].getValue(), pushNotificationLog.pushNotifications);
        }
    }
