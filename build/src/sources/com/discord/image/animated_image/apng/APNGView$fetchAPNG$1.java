...
public final class APNGView$fetchAPNG$1 extends k implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
    ...
    public final Object invoke(CoroutineScope coroutineScope, Continuation<? super Unit> continuation) {
        return ((APNGView$fetchAPNG$1) create(coroutineScope, continuation)).invokeSuspend(Unit.f31988a);
    }
    ...
    public static final class AnonymousClass1<T> implements FlowCollector {
        ...
        public static final class C01471 extends k implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
            ...
            /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
            C01471(APNGView aPNGView, ApngDrawable apngDrawable, APNGView.Config config, Continuation<? super C01471> continuation) {
                super(2, continuation);
                this.this$0 = aPNGView;
            ...
            @Override // kotlin.coroutines.jvm.internal.a
            public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
                return new C01471(this.this$0, this.$drawable, this.$config, continuation);
            }
            ...
            @Override // kotlin.jvm.functions.Function2
            public final Object invoke(CoroutineScope coroutineScope, Continuation<? super Unit> continuation) {
                return ((C01471) create(coroutineScope, continuation)).invokeSuspend(Unit.f31988a);
            }
        }
        ...
        /* JADX WARN: Code restructure failed: missing block: B:22:0x006a, code lost:
            if (ms.g.g(r15, r2, r0) == r1) goto L28;
         */
        /* JADX WARN: Code restructure failed: missing block: B:25:0x007e, code lost:
            if (ms.g.g(r14, r15, r0) != r1) goto L19;
         */
        /* JADX WARN: Code restructure failed: missing block: B:30:0x0096, code lost:
            if (ms.g.g(r14, r15, r0) == r1) goto L28;
         */
        ...
        */
        public final java.lang.Object emit(com.discord.file_downloader.DownloadState r14, kotlin.coroutines.Continuation<? super kotlin.Unit> r15) {
            ...
            L40:
                ...
                ms.c1 r15 = ms.m0.c()     // Catch: java.lang.Exception -> L6d
                ...
                java.lang.Object r14 = ms.g.g(r15, r2, r0)     // Catch: java.lang.Exception -> L6d
                if (r14 != r1) goto L9c
                goto L98
            L6d:
                ms.c1 r14 = ms.m0.c()
                ...
                r15.<init>(r2, r6)
                r0.label = r4
                java.lang.Object r14 = ms.g.g(r14, r15, r0)
                if (r14 != r1) goto L9c
                goto L98
            L81:
