...
public final class APNGView$fetchAPNG$1 extends k implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
    ...
    public final Object invoke(CoroutineScope coroutineScope, Continuation<? super Unit> continuation) {
        return ((APNGView$fetchAPNG$1) create(coroutineScope, continuation)).invokeSuspend(Unit.f32556a);
    }
    ...
    public static final class AnonymousClass1<T> implements FlowCollector {
        ...
        public static final class C01441 extends k implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
            ...
            @Override // kotlin.jvm.functions.Function2
            public final Object invoke(CoroutineScope coroutineScope, Continuation<? super Unit> continuation) {
                return ((C01441) create(coroutineScope, continuation)).invokeSuspend(Unit.f32556a);
            }
        }
