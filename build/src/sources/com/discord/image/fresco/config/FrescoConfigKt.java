...
public final class FrescoConfigKt {
    ...
    public static final ImagePipelineConfig frescoConfig(@NotNull Context context) {
        ...
        w.a n10 = w.n();
        z a10 = j.a();
        ImagePipelineConfig.Builder T = W.X(new y(n10.n(new z(a10.f52466b, a10.f52465a * 2, a10.f52467c)).m())).S(new DefaultCacheKeyFactory() { // from class: com.discord.image.fresco.config.FrescoConfigKt$frescoConfig$2
