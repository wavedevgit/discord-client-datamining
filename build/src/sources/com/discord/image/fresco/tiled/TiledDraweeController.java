...
public final class TiledDraweeController implements DraweeController {
    ...
    public TiledDraweeController(@NotNull Resources resources, @NotNull String url, @NotNull Shader.TileMode tileMode) {
        ...
        this.job = b10;
        this.scope = i.a(b10.O0(m0.c().P1()));
    }

    private final void load() {
        ys.i.d(this.scope, null, null, new TiledDraweeController$load$1(this, null), 3, null);
    }
    ...
    public boolean isSameImageRequest(DraweeController draweeController) {
        ...
        if (Intrinsics.areEqual(str, this.url) && (closeableReference = this.myImageReference) != null && closeableReference.z0()) {
            return true;
        }
        return false;
    }
