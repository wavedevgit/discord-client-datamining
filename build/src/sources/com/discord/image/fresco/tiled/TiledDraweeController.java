...
public final class TiledDraweeController implements DraweeController {
    ...
    private final void load() {
        ms.i.d(this.scope, null, null, new TiledDraweeController$load$1(this, null), 3, null);
    }
    ...
    public boolean isSameImageRequest(DraweeController draweeController) {
        ...
        if (Intrinsics.areEqual(str, this.url) && (closeableReference = this.myImageReference) != null && closeableReference.I0()) {
            return true;
        }
        return false;
    }
