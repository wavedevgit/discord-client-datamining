...
public final class GradientPostprocessor extends BasePostprocessor {
    ...
    public static final class Companion {
        ...
        private static final class Point {
            ...
            private final float f10457x;

            /* renamed from: y  reason: collision with root package name */
            private final float f10458y;
            ...
            public boolean equals(Object obj) {
                ...
                if (obj instanceof Point) {
                    ...
                    return Float.compare(this.f10457x, point.f10457x) == 0 && Float.compare(this.f10458y, point.f10458y) == 0;
                }
                return false;
            }
            ...
            public int hashCode() {
                return (Float.hashCode(this.f10457x) * 31) + Float.hashCode(this.f10458y);
            }

            @NotNull
            public String toString() {
                float f10 = this.f10457x;
                float f11 = this.f10458y;
