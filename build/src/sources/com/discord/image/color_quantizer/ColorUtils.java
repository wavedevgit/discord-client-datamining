...
public final class ColorUtils {
    ...
    public static final int HSLtoRGB(@NotNull float[] hsl) {
        ...
        switch (((int) f10) / 60) {
            case 0:
                c10 = xr.a.c((abs + f13) * 255.0f);
                c11 = xr.a.c((abs2 + f13) * 255.0f);
                c12 = xr.a.c(f13 * 255.0f);
                break;
            case 1:
                c10 = xr.a.c((abs2 + f13) * 255.0f);
                c11 = xr.a.c((abs + f13) * 255.0f);
                c12 = xr.a.c(f13 * 255.0f);
                break;
            case 2:
                c10 = xr.a.c(f13 * 255.0f);
                c11 = xr.a.c((abs + f13) * 255.0f);
                c12 = xr.a.c((abs2 + f13) * 255.0f);
                break;
            case 3:
                c10 = xr.a.c(f13 * 255.0f);
                c13 = xr.a.c((abs2 + f13) * 255.0f);
                c12 = xr.a.c((abs + f13) * 255.0f);
                c11 = c13;
                break;
            case 4:
                c10 = xr.a.c((abs2 + f13) * 255.0f);
                c13 = xr.a.c(f13 * 255.0f);
                c12 = xr.a.c((abs + f13) * 255.0f);
                c11 = c13;
                break;
            case 5:
