...
public final class j implements Interceptor {
    ...
    private final OkHttpClient f48343a;
    ...
    private final Request a(Response response, String str) {
        ...
        if (!this.f48343a.w() || (Z = Response.Z(response, "Location", null, 2, null)) == null || (r10 = response.O0().n().r(Z)) == null) {
            return null;
        }
        if (!Intrinsics.areEqual(r10.s(), response.O0().n().s()) && !this.f48343a.x()) {
            return null;
        }
    ...
    private final Request b(Response response, qu.c cVar) {
        ...
        if (z10 != 307 && z10 != 308) {
            if (z10 != 401) {
                    ...
                    if (z10 != 503) {
                        if (z10 != 407) {
                            ...
                            if (kVar.b().type() == Proxy.Type.HTTP) {
                                return this.f48343a.J().a(kVar, response);
                            }
                ...
                return this.f48343a.h().a(kVar, response);
            }
        }
