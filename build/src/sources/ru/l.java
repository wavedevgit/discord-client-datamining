...
public class l extends Timeout {
    ...
    private Timeout f49411f;

    public l(Timeout delegate) {
        Intrinsics.checkNotNullParameter(delegate, "delegate");
        this.f49411f = delegate;
    }
    ...
    @Override // okio.Timeout
    public long c() {
        return this.f49411f.c();
    }

    @Override // okio.Timeout
    public Timeout d(long j10) {
        return this.f49411f.d(j10);
    }

    @Override // okio.Timeout
    public boolean e() {
        return this.f49411f.e();
    }
    ...
    public Timeout g(long j10, TimeUnit unit) {
        ...
        return this.f49411f.g(j10, unit);
    }

    @Override // okio.Timeout
    public long h() {
        return this.f49411f.h();
    }
