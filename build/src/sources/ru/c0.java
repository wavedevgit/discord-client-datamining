...
public final class c0 implements Comparable {
    ...
    /* renamed from: i */
    public static final String f49355i;

    /* renamed from: d */
    private final ByteString f49356d;
    ...
    */
    public final ru.c0 k(ru.c0 r9) {
        ...
        L3e:
            ...
            int r6 = r6.G()
            if (r3 != r6) goto L5d
            ru.c0$a r9 = ru.c0.f49354e
            java.lang.String r0 = "."
            r1 = 0
            r2 = 1
            ru.c0 r9 = ru.c0.a.e(r9, r0, r4, r2, r1)
            return r9
        L5d:
            int r3 = r2.size()
            java.util.List r3 = r2.subList(r5, r3)
            okio.ByteString r6 = su.d.c()
            int r3 = r3.indexOf(r6)
            r6 = -1
            if (r3 != r6) goto Lb5
            okio.Buffer r1 = new okio.Buffer
            r1.<init>()
            okio.ByteString r9 = su.d.f(r9)
            if (r9 != 0) goto L87
            okio.ByteString r9 = su.d.f(r8)
            if (r9 != 0) goto L87
            java.lang.String r9 = ru.c0.f49355i
            okio.ByteString r9 = su.d.i(r9)
        L87:
            int r2 = r2.size()
            r3 = r5
        L8c:
        ...
        Ld6:
            ...
            throw r0
        */
        throw new UnsupportedOperationException("Method not decompiled: ru.c0.k(ru.c0):ru.c0");
    }

    public final c0 l(String child) {
        Intrinsics.checkNotNullParameter(child, "child");
        return su.d.j(this, su.d.q(new Buffer().q0(child), false), false);
    }

    public final c0 m(c0 child, boolean z10) {
        Intrinsics.checkNotNullParameter(child, "child");
        return su.d.j(this, child, z10);
    }
