...
public abstract class g5 {
    public static final TextView b(e5 e5Var, m5 uiComponentHelper, final Text config) {
        ...
        final dq.w c10 = dq.w.c(uiComponentHelper.b());
        Text.Attributes attributes = config.getAttributes();
        if (attributes != null) {
            TextView textView = c10.f20836b;
            Intrinsics.checkNotNullExpressionValue(textView, "textView");
            bq.f.d(textView, attributes.getText());
            uiComponentHelper.d(new Function0() { // from class: aq.f5
    ...
    public static final Unit c(Text text, dq.w wVar) {
        TextBasedComponentStyle styles = text.getStyles();
        if (styles != null) {
            TextView textView = wVar.f20836b;
            Intrinsics.checkNotNullExpressionValue(textView, "textView");
