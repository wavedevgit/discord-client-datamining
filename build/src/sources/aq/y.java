...
public final class y implements k5, l5 {
    ...
    private final List f6098e;

    /* renamed from: i  reason: collision with root package name */
    private final Integer f6099i;
    ...
    public boolean equals(Object obj) {
        ...
        y yVar = (y) obj;
        if (Intrinsics.areEqual(this.f6097d, yVar.f6097d) && Intrinsics.areEqual(this.f6098e, yVar.f6098e) && Intrinsics.areEqual(this.f6099i, yVar.f6099i)) {
            return true;
        }
        return false;
    }
    ...
    public int hashCode() {
        int hashCode;
        int hashCode2 = ((this.f6097d.hashCode() * 31) + this.f6098e.hashCode()) * 31;
        Integer num = this.f6099i;
        if (num == null) {
            hashCode = 0;
        } else {
    ...
    public final void writeToParcel(Parcel dest, int i10) {
        ...
        dest.writeString(this.f6097d);
        List<Parcelable> list = this.f6098e;
    ...
    */
    public y(com.withpersona.sdk2.inquiry.network.dto.ui.components.Footer r5) {
        ...
        L40:
            ...
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: aq.y.<init>(com.withpersona.sdk2.inquiry.network.dto.ui.components.Footer):void");
    }
}
