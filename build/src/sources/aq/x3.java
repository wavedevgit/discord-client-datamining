...
abstract class x3 {
    ...
    public static final d f6087a = new d(null);
    ...
    public static final class e extends x3 {
        ...
        public boolean equals(Object obj) {
            ...
            if ((obj instanceof e) && this.f6091b == ((e) obj).f6091b) {
                return true;
            }
            return false;
        }
        ...
        public int hashCode() {
            return Character.hashCode(this.f6091b);
        }

        public String toString() {
            char c10 = this.f6091b;
