...
public abstract class o1 {
    public static final void d(final TextInputLayout textInputLayout, y3 newState) {
        ...
        Object tag = textInputLayout.getTag(yp.e.f55166b0);
        ...
        textInputLayout.setTag(yp.e.f55166b0, newState);
        ...
        if (c10 != null) {
            ...
            wp.o.a(textInputLayout);
        }
        if (Intrinsics.areEqual(newState.e(), Boolean.TRUE) && (b10 = newState.b()) != null) {
            textInputLayout.setEndIconMode(-1);
            textInputLayout.setEndIconDrawable(androidx.core.content.a.e(textInputLayout.getContext(), yp.d.f55161d));
            textInputLayout.setEndIconContentDescription(textInputLayout.getContext().getString(ep.e.R));
            EditText editText3 = textInputLayout.getEditText();
            if (editText3 != null) {
                editText3.setTransformationMethod(new s4(b10));
            }
            textInputLayout.setEndIconOnClickListener(new View.OnClickListener() { // from class: aq.n1
        ...
        Object tag2 = textInputLayout.getTag(yp.e.f55180i0);
        ...
        if (b11 != null && !StringsKt.k0(b11)) {
            ...
            textInputLayout.setTag(yp.e.f55180i0, z3Var);
        }
    }
    ...
    public static final TextInputLayout g(InputMaskedTextComponent inputMaskedTextComponent, m5 uiComponentHelper, final InputMaskedText config) {
        ...
        final dq.u c10 = dq.u.c(uiComponentHelper.b());
        ...
        if (editText != null) {
            ym.u.b(inputMaskedTextComponent.b(), editText);
        }
        uiComponentHelper.d(new Function0() { // from class: aq.m1
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public static final Unit h(InputMaskedText inputMaskedText, dq.u uVar) {
