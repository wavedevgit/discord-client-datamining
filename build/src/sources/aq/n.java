...
public final class n implements ViewBinding {
    ...
    private final TextInputLayout f6671a;

    /* renamed from: b  reason: collision with root package name */
    public final TextInputEditText f6672b;

    /* renamed from: c  reason: collision with root package name */
    public final TextInputLayout f6673c;

    private n(TextInputLayout textInputLayout, TextInputEditText textInputEditText, TextInputLayout textInputLayout2) {
        this.f6671a = textInputLayout;
        this.f6672b = textInputEditText;
        this.f6673c = textInputLayout2;
    }
    ...
    public static n d(LayoutInflater layoutInflater, ViewGroup viewGroup, boolean z10) {
        View inflate = layoutInflater.inflate(vp.f.f51852p, viewGroup, false);
        if (z10) {
