...
final class s4 extends PasswordTransformationMethod {
    ...
    private static final class a implements CharSequence {
        ...
        private final CharSequence f6041e;
        ...
        public char a(int i10) {
            if (i10 < this.f6040d.length()) {
                x3 a10 = x3.f6087a.a(this.f6040d.charAt(i10));
        ...
        public CharSequence subSequence(int i10, int i11) {
            return this.f6041e.subSequence(i10, i11);
        }
    }
    ...
    public CharSequence getTransformation(CharSequence charSequence, View view) {
        ...
        return new a(this.f6039d, charSequence);
    }
}
