...
public final class a implements h {
    ...
    private final JsonLogicBoolean f5814e;

    /* renamed from: i  reason: collision with root package name */
    private final JsonLogicBoolean f5815i;
    ...
    public a(String name, JsonLogicBoolean jsonLogicBoolean, JsonLogicBoolean jsonLogicBoolean2, String str, Integer num) {
        ...
        this.f5813d = name;
        this.f5814e = jsonLogicBoolean;
        this.f5815i = jsonLogicBoolean2;
        this.f5816o = str;
        this.f5817p = num;
    ...
    public boolean equals(Object obj) {
        ...
        a aVar = (a) obj;
        if (Intrinsics.areEqual(this.f5813d, aVar.f5813d) && Intrinsics.areEqual(this.f5814e, aVar.f5814e) && Intrinsics.areEqual(this.f5815i, aVar.f5815i) && Intrinsics.areEqual(this.f5816o, aVar.f5816o) && Intrinsics.areEqual(this.f5817p, aVar.f5817p)) {
            return true;
        }
        return false;
    }
    ...
    public int hashCode() {
        ...
        int hashCode2;
        int hashCode3;
        int hashCode4 = this.f5813d.hashCode() * 31;
        JsonLogicBoolean jsonLogicBoolean = this.f5814e;
        int i10 = 0;
        ...
        JsonLogicBoolean jsonLogicBoolean2 = this.f5815i;
    ...
    public final void writeToParcel(Parcel dest, int i10) {
        ...
        dest.writeParcelable(this.f5814e, i10);
        dest.writeParcelable(this.f5815i, i10);
        dest.writeString(this.f5816o);
        Integer num = this.f5817p;
        if (num == null) {
            dest.writeInt(0);
            return;
    ...
    */
    public a(com.withpersona.sdk2.inquiry.network.dto.ui.components.ActionButton r8) {
        ...
        L3b:
            ...
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: aq.a.<init>(com.withpersona.sdk2.inquiry.network.dto.ui.components.ActionButton):void");
    }
}
