...
public final class b4 implements Parcelable {
    ...
    public boolean equals(Object obj) {
        ...
        b4 b4Var = (b4) obj;
        if (Intrinsics.areEqual(this.f5835d, b4Var.f5835d) && Intrinsics.areEqual(this.f5836e, b4Var.f5836e)) {
            return true;
        }
        return false;
    }
    ...
    public int hashCode() {
        return (this.f5835d.hashCode() * 31) + this.f5836e.hashCode();
    }
    ...
    public final void writeToParcel(Parcel dest, int i10) {
        ...
        dest.writeString(this.f5835d);
        dest.writeString(this.f5836e);
    }
}
