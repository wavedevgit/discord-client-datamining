...
public final class r implements yp.b {
    @NotNull
    public static final Parcelable.Creator<r> CREATOR = new a();

    /* renamed from: d  reason: collision with root package name */
    private final List f6023d;

    /* renamed from: e  reason: collision with root package name */
    private final List f6024e;

    /* renamed from: i  reason: collision with root package name */
    private final StepStyles.UiStepStyle f6025i;
    ...
    public r(List list, List componentConfigs, StepStyles.UiStepStyle uiStepStyle) {
        ...
        this.f6023d = list;
        this.f6024e = componentConfigs;
        this.f6025i = uiStepStyle;
    }
    ...
    public boolean equals(Object obj) {
        ...
        r rVar = (r) obj;
        if (Intrinsics.areEqual(this.f6023d, rVar.f6023d) && Intrinsics.areEqual(this.f6024e, rVar.f6024e) && Intrinsics.areEqual(this.f6025i, rVar.f6025i)) {
            return true;
        }
        return false;
    }
    ...
    public int hashCode() {
        ...
        int hashCode2 = ((hashCode * 31) + this.f6024e.hashCode()) * 31;
        StepStyles.UiStepStyle uiStepStyle = this.f6025i;
        if (uiStepStyle != null) {
    ...
    public final void writeToParcel(Parcel dest, int i10) {
        ...
        List<Parcelable> list = this.f6023d;
        if (list == null) {
            dest.writeInt(0);
        } else {
            dest.writeInt(1);
        ...
        List<Parcelable> list2 = this.f6024e;
        dest.writeInt(list2.size());
        for (Parcelable parcelable2 : list2) {
            dest.writeParcelable(parcelable2, i10);
        }
        dest.writeParcelable(this.f6025i, i10);
    }
}
