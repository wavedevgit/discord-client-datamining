...
public abstract class e4 {
    public static final TextView b(c4 c4Var, m5 uiComponentHelper, final PrivacyPolicy config) {
        ...
        final dq.t c10 = dq.t.c(uiComponentHelper.b());
        PrivacyPolicy.Attributes attributes = config.getAttributes();
        if (attributes != null) {
            TextView textView = c10.f20825b;
            Intrinsics.checkNotNullExpressionValue(textView, "textView");
            bq.f.d(textView, attributes.getText());
            uiComponentHelper.d(new Function0() { // from class: aq.d4
    ...
    public static final Unit c(PrivacyPolicy privacyPolicy, dq.t tVar) {
        TextBasedComponentStyle styles = privacyPolicy.getStyles();
        if (styles != null) {
            TextView textView = tVar.f20825b;
            Intrinsics.checkNotNullExpressionValue(textView, "textView");
            fq.f0.n(textView, styles, null, 2, null);
        }
        return Unit.f32464a;
    }
}
