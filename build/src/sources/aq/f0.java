...
public final class f0 implements k5, l5, e0 {
    ...
    private final List f5875e;

    /* renamed from: i  reason: collision with root package name */
    private final JsonLogicBoolean f5876i;

    /* renamed from: o  reason: collision with root package name */
    private final List f5877o;
    ...
    public f0(String name, List children, JsonLogicBoolean jsonLogicBoolean) {
        ...
        this.f5874d = name;
        this.f5875e = children;
        this.f5876i = jsonLogicBoolean;
        this.f5877o = new ArrayList();
    }
    ...
    public boolean equals(Object obj) {
        ...
        f0 f0Var = (f0) obj;
        if (Intrinsics.areEqual(this.f5874d, f0Var.f5874d) && Intrinsics.areEqual(this.f5875e, f0Var.f5875e) && Intrinsics.areEqual(this.f5876i, f0Var.f5876i)) {
            return true;
        }
        return false;
    }
    ...
    public int hashCode() {
        int hashCode;
        int hashCode2 = ((this.f5874d.hashCode() * 31) + this.f5875e.hashCode()) * 31;
        JsonLogicBoolean jsonLogicBoolean = this.f5876i;
    ...
    public final void writeToParcel(Parcel dest, int i10) {
        ...
        dest.writeString(this.f5874d);
        List<Parcelable> list = this.f5875e;
        dest.writeInt(list.size());
        for (Parcelable parcelable : list) {
            dest.writeParcelable(parcelable, i10);
        }
        dest.writeParcelable(this.f5876i, i10);
    }
    ...
    */
    public f0(com.withpersona.sdk2.inquiry.network.dto.ui.components.HorizontalStack r5) {
        ...
        L40:
            ...
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: aq.f0.<init>(com.withpersona.sdk2.inquiry.network.dto.ui.components.HorizontalStack):void");
    }
}
