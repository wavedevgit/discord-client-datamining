...
public final class e implements k5 {
    ...
    public boolean equals(Object obj) {
        ...
        e eVar = (e) obj;
        if (Intrinsics.areEqual(this.f5866d, eVar.f5866d) && this.f5867e == eVar.f5867e) {
            return true;
        }
        return false;
    }
    ...
    public int hashCode() {
        return (this.f5866d.hashCode() * 31) + Boolean.hashCode(this.f5867e);
    }
    ...
    public final void writeToParcel(Parcel dest, int i10) {
        ...
        dest.writeString(this.f5866d);
        dest.writeInt(this.f5867e ? 1 : 0);
    }
    ...
    */
    public e(com.withpersona.sdk2.inquiry.network.dto.ui.components.Branding r3) {
        ...
        L1b:
            ...
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: aq.e.<init>(com.withpersona.sdk2.inquiry.network.dto.ui.components.Branding):void");
    }
}
