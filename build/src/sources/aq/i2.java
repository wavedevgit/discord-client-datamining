...
public abstract class i2 {
    ...
    public static final TextInputLayout b(InputTextComponent inputTextComponent, m5 uiComponentHelper, final InputText config, ym.t textController) {
        String str;
        ...
        final dq.o c10 = dq.o.c(uiComponentHelper.b());
        TextInputEditText editText = c10.f20805b;
        Intrinsics.checkNotNullExpressionValue(editText, "editText");
        ym.u.b(textController, editText);
        InputText.Attributes attributes = config.getAttributes();
        if (attributes != null) {
            String label = attributes.getLabel();
            if (label != null) {
                c10.f20806c.setHint(label);
            }
            String placeholder = attributes.getPlaceholder();
            if (placeholder != null) {
                c10.f20806c.setPlaceholderText(placeholder);
                TextInputLayout inputLayout = c10.f20806c;
                Intrinsics.checkNotNullExpressionValue(inputLayout, "inputLayout");
                wp.o.a(inputLayout);
            }
            c10.f20805b.setInputType(e(attributes.getInputType()));
            if (Build.VERSION.SDK_INT >= 26) {
                ...
                c10.f20806c.setAutofillHints(new String[]{str});
            }
        }
        uiComponentHelper.d(new Function0() { // from class: aq.h2
    ...
    public static /* synthetic */ TextInputLayout c(InputTextComponent inputTextComponent, m5 m5Var, InputText inputText, ym.t tVar, int i10, Object obj) {
        if ((i10 & 4) != 0) {
    ...
    public static final Unit d(InputText inputText, dq.o oVar) {
        InputTextBasedComponentStyle styles = inputText.getStyles();
        if (styles != null) {
            TextInputLayout inputLayout = oVar.f20806c;
            Intrinsics.checkNotNullExpressionValue(inputLayout, "inputLayout");
    ...
    private static final int e(InputText.InputType inputType) {
        int i10 = a.f5913a[inputType.ordinal()];
        if (i10 == 1) {
            return 1;
        }
        if (i10 != 2) {
    ...
    private static final String f(InputText.AutofillHint autofillHint) {
        switch (a.f5914b[autofillHint.ordinal()]) {
            case 1:
                return "personName";
            case 2:
