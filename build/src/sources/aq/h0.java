...
public abstract class h0 {
    public static final ConstraintLayout b(f0 f0Var, m5 uiComponentHelper, List componentViews, List children, HorizontalStack config) {
        ...
        final dq.h c10 = dq.h.c(uiComponentHelper.b());
        ...
        if (styles != null) {
            uiComponentHelper.d(new Function0() { // from class: aq.g0
                @Override // kotlin.jvm.functions.Function0
                public final Object invoke() {
                    Unit c11;
                    c11 = h0.c(dq.h.this, styles);
                    return c11;
                }
            });
        }
    ...
    public static final Unit c(dq.h hVar, HorizontalStack.HorizontalStackComponentStyle horizontalStackComponentStyle) {
        ConstraintLayout root = hVar.getRoot();
        Intrinsics.checkNotNullExpressionValue(root, "getRoot(...)");
        fq.q.c(root, horizontalStackComponentStyle);
        return Unit.f32464a;
    }
}
