...
public final class f4 implements k5, e0 {
    ...
    private final JsonLogicBoolean f5885e;

    /* renamed from: i  reason: collision with root package name */
    private final int f5886i;

    /* renamed from: o  reason: collision with root package name */
    private final List f5887o;
    ...
    public boolean equals(Object obj) {
        ...
        f4 f4Var = (f4) obj;
        if (Intrinsics.areEqual(this.f5884d, f4Var.f5884d) && Intrinsics.areEqual(this.f5885e, f4Var.f5885e) && this.f5886i == f4Var.f5886i) {
            return true;
        }
        return false;
    }
    ...
    public int hashCode() {
        int hashCode;
        int hashCode2 = this.f5884d.hashCode() * 31;
        JsonLogicBoolean jsonLogicBoolean = this.f5885e;
        if (jsonLogicBoolean == null) {
            hashCode = 0;
        } else {
            hashCode = jsonLogicBoolean.hashCode();
        }
        return ((hashCode2 + hashCode) * 31) + Integer.hashCode(this.f5886i);
    }
    ...
    public final void writeToParcel(Parcel dest, int i10) {
        ...
        dest.writeString(this.f5884d);
        dest.writeParcelable(this.f5885e, i10);
        dest.writeInt(this.f5886i);
    }
    ...
    */
    public f4(com.withpersona.sdk2.inquiry.network.dto.ui.components.QRCode r5) {
        ...
        L4e:
            ...
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: aq.f4.<init>(com.withpersona.sdk2.inquiry.network.dto.ui.components.QRCode):void");
    }
}
