...
public final class c implements View.OnAttachStateChangeListener {
    ...
    private final CompletableJob f21776e;

    /* renamed from: i  reason: collision with root package name */
    private final CoroutineScope f21777i;
    ...
    public c(CoroutineScope parentCoroutineScope) {
        ...
        a10.Q(new a());
        this.f21776e = a10;
        this.f21777i = kotlinx.coroutines.i.j(parentCoroutineScope, a10);
    }
    ...
    public final void c(Function0 block) {
        ...
        if (kotlinx.coroutines.i.i(this.f21777i)) {
            this.f21775d.add(block);
            return;
        }
    ...
    public void onViewAttachedToWindow(View v10) {
        ...
        List<Function0> list = this.f21775d;
    ...
    public void onViewDetachedFromWindow(View v10) {
        Intrinsics.checkNotNullParameter(v10, "v");
        kotlinx.coroutines.i.e(this.f21777i, "View detached", null, 2, null);
