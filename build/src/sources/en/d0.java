...
public abstract class d0 {
    ...
    public static final class a extends Lambda implements Function0 {
        ...
        final /* synthetic */ CoroutineContext f21786e;

        /* renamed from: i  reason: collision with root package name */
        final /* synthetic */ Function2 f21787i;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        a(c cVar, CoroutineContext coroutineContext, Function2 function2) {
            super(0);
            this.f21785d = cVar;
            this.f21786e = coroutineContext;
            this.f21787i = function2;
        }
        ...
        public final void m1170invoke() {
            ps.g.c(this.f21785d.b(), this.f21786e, ps.c0.f44499o, this.f21787i);
        }
    }

    private static final c a(View view) {
        c cVar;
        Object tag = view.getTag(q.f21848b);
        c cVar2 = null;
        if (tag instanceof c) {
            cVar = (c) tag;
        } else {
        ...
        if (cVar2 == null) {
            LifecycleOwner a10 = fn.c.f22750a.a(view);
            if (a10 != null) {
                ...
                c cVar3 = new c(kotlinx.coroutines.i.j(a11, new ps.b0(sb4)));
                view.setTag(q.f21848b, cVar3);
