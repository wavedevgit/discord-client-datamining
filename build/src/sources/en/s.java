...
public final class s {
    ...
    private final kotlin.reflect.b f23017a;

    /* renamed from: b  reason: collision with root package name */
    private final s f23018b;

    /* renamed from: c  reason: collision with root package name */
    private final Function0 f23019c;

    /* renamed from: d  reason: collision with root package name */
    private final Lazy f23020d;

    /* renamed from: e  reason: collision with root package name */
    private final Sequence f23021e;
    ...
    static final class b extends Lambda implements Function1 {
        ...
        /* renamed from: d  reason: collision with root package name */
        public static final b f23022d = new b();
    ...
    static final class c extends Lambda implements Function1 {
        ...
        /* renamed from: d  reason: collision with root package name */
        public static final c f23023d = new c();
    ...
    static final class d extends Lambda implements Function0 {
        ...
        public final String invoke() {
            return s.this.f23017a instanceof KClass ? ns.a.b((KClass) s.this.f23017a).getName() : s.this.f23017a.toString();
        }
    }
    ...
    public s(kotlin.reflect.b type, s sVar, Function0 function0) {
        ...
        this.f23020d = as.l.a(as.o.f6082e, new d());
        this.f23021e = kotlin.sequences.k.q(this, b.f23022d);
    }

    /* JADX INFO: Access modifiers changed from: private */
    public final String d() {
        Object value = this.f23020d.getValue();
    ...
    public final ByteString e() {
        ...
        if (!(this.f23017a instanceof KClass)) {
            return null;
        }
        s sVar = this.f23018b;
        if (sVar != null) {
    ...
    public boolean equals(Object obj) {
        ...
        s sVar = (s) obj;
        if (Intrinsics.areEqual(this.f23017a, sVar.f23017a) && Intrinsics.areEqual(this.f23018b, sVar.f23018b)) {
            return true;
        }
        return false;
    }
    ...
    public int hashCode() {
        int hashCode;
        int hashCode2 = this.f23017a.hashCode() * 31;
        s sVar = this.f23018b;
        if (sVar == null) {
            hashCode = 0;
        } else {
    ...
    public String toString() {
        String str;
        Function0 function0 = this.f23019c;
        if (function0 == null) {
            str = null;
        } else {
        ...
        if (str == null) {
            String P = kotlin.sequences.k.P(this.f23021e, null, null, null, 0, null, c.f23023d, 31, null);
