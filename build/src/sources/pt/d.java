...
public abstract class d {
    ...
    private static final boolean f45708a;

    /* renamed from: b  reason: collision with root package name */
    private static final d f45709b;

    /* renamed from: c  reason: collision with root package name */
    private static final boolean f45710c;
    ...
    static {
        ...
        try {
            f45709b = (d) Class.forName(property).newInstance();
        } catch (Exception e10) {
