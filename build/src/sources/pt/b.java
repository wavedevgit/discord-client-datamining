...
public class b implements s {
    ...
    public q f(q qVar, net.time4j.history.d dVar, jt.d dVar2) {
        ...
        if (qVar.o(dVar.i())) {
        ...
        } else if (((kt.g) dVar2.b(kt.a.f36549f, kt.g.SMART)).a()) {
            jVar2 = j.AD;
        } else {
            jVar = null;
            if (jVar == null && qVar.o(dVar.M())) {
                ...
                if (qVar.o(dVar.C()) && qVar.o(dVar.g())) {
                    ...
                    return qVar.E(f0.f40589z, (f0) dVar.d(dVar.m(jVar, q10)).C(dVar.h(), q11));
                } else {
                    return qVar;
                }
            }
