...
public class c implements ControllerListener {
    ...
    private final List f30868d = new ArrayList(2);
    ...
    public synchronized void a(ControllerListener controllerListener) {
        this.f30868d.add(controllerListener);
    }
    ...
    public synchronized void onFailure(String str, Throwable th2) {
        int size = this.f30868d.size();
        for (int i10 = 0; i10 < size; i10++) {
            try {
                ControllerListener controllerListener = (ControllerListener) this.f30868d.get(i10);
