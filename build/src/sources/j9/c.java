...
public class c implements ControllerListener {
    ...
    private final List f30068d = new ArrayList(2);
    ...
    public synchronized void a(ControllerListener controllerListener) {
        this.f30068d.add(controllerListener);
    }
    ...
    public synchronized void onFailure(String str, Throwable th2) {
        int size = this.f30068d.size();
        for (int i10 = 0; i10 < size; i10++) {
            try {
                ControllerListener controllerListener = (ControllerListener) this.f30068d.get(i10);
