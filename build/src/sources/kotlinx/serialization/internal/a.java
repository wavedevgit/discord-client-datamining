...
public final class a extends f2 implements KSerializer {
    ...
    private a() {
        super(et.a.w(BooleanCompanionObject.INSTANCE));
    }
    ...
    @Override // gt.s, gt.a
    /* renamed from: x */
    public void h(kotlinx.serialization.encoding.c decoder, int i10, gt.g builder, boolean z10) {
    ...
    @Override // gt.a
    /* renamed from: y */
    public gt.g k(boolean[] zArr) {
        Intrinsics.checkNotNullParameter(zArr, "<this>");
        return new gt.g(zArr);
    }
