...
public final class JsonObject extends JsonElement implements Map<String, JsonElement>, KMappedMarker {
    ...
    public boolean c(String key) {
        ...
        return this.f34900d.containsKey(key);
    }
    ...
    public boolean d(JsonElement value) {
        ...
        return this.f34900d.containsValue(value);
    }

    public JsonElement e(String key) {
        Intrinsics.checkNotNullParameter(key, "key");
        return (JsonElement) this.f34900d.get(key);
    }
    ...
    public boolean equals(Object obj) {
        return Intrinsics.areEqual(this.f34900d, obj);
    }

    public Set f() {
        return this.f34900d.entrySet();
    }

    public Set g() {
        return this.f34900d.keySet();
    }
    ...
    @Override // java.util.Map
    public int hashCode() {
        return this.f34900d.hashCode();
    }

    public Collection i() {
        return this.f34900d.values();
    }

    @Override // java.util.Map
    public boolean isEmpty() {
        return this.f34900d.isEmpty();
    }
    ...
    public String toString() {
        return CollectionsKt.x0(this.f34900d.entrySet(), ",", "{", "}", 0, null, new Function1() { // from class: lt.w
