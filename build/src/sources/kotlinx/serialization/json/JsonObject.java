...
import vt.c1;
@m(with = y.class)
@Metadata(d1 = {"\u0000>\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\u0010$\n\u0002\u0010\u000e\n\u0002\b\u0003\n\u0002\u0010\u0000\n\u0000\n\u0002\u0010\u000b\n\u0002\b\u0002\n\u0002\u0010\b\n\u0002\b\u000f\n\u0002\u0010\"\n\u0002\u0010&\n\u0002\b\u0007\n\u0002\u0010\u001e\n\u0002\b\u0005\b\u0007\u0018\u0000 )2\u00020\u00012\u000e\u0012\u0004\u0012\u00020\u0003\u0012\u0004\u0012\u00020\u00010\u0002:\u0001)B\u001b\u0012\u0012\u0010\u0004\u001a\u000e\u0012\u0004\u0012\u00020\u0003\u0012\u0004\u0012\u00020\u00010\u0002¢\u0006\u0004\b\u0005\u0010\u0006J\u001a\u0010\n\u001a\u00020\t2\b\u0010\b\u001a\u0004\u0018\u00010\u0007H\u0096\u0002¢\u0006\u0004\b\n\u0010\u000bJ\u000f\u0010\r\u001a\u00020\fH\u0016¢\u0006\u0004\b\r\u0010\u000eJ\u000f\u0010\u000f\u001a\u00020\u0003H\u0016¢\u0006\u0004\b\u000f\u0010\u0010J\u0018\u0010\u0012\u001a\u00020\t2\u0006\u0010\u0011\u001a\u00020\u0003H\u0096\u0001¢\u0006\u0004\b\u0012\u0010\u0013J\u0018\u0010\u0015\u001a\u00020\t2\u0006\u0010\u0014\u001a\u00020\u0001H\u0096\u0001¢\u0006\u0004\b\u0015\u0010\u0016J\u001a\u0010\u0017\u001a\u0004\u0018\u00010\u00012\u0006\u0010\u0011\u001a\u00020\u0003H\u0096\u0003¢\u0006\u0004\b\u0017\u0010\u0018J\u0010\u0010\u0019\u001a\u00020\tH\u0096\u0001¢\u0006\u0004\b\u0019\u0010\u001aR \u0010\u0004\u001a\u000e\u0012\u0004\u0012\u00020\u0003\u0012\u0004\u0012\u00020\u00010\u00028\u0002X\u0082\u0004¢\u0006\u0006\n\u0004\b\u0015\u0010\u001bR&\u0010 \u001a\u0014\u0012\u0010\u0012\u000e\u0012\u0004\u0012\u00020\u0003\u0012\u0004\u0012\u00020\u00010\u001d0\u001c8\u0016X\u0096\u0005¢\u0006\u0006\u001a\u0004\b\u001e\u0010\u001fR\u001a\u0010\"\u001a\b\u0012\u0004\u0012\u00020\u00030\u001c8\u0016X\u0096\u0005¢\u0006\u0006\u001a\u0004\b!\u0010\u001fR\u0014\u0010$\u001a\u00020\f8\u0016X\u0096\u0005¢\u0006\u0006\u001a\u0004\b#\u0010\u000eR\u001a\u0010(\u001a\b\u0012\u0004\u0012\u00020\u00010%8\u0016X\u0096\u0005¢\u0006\u0006\u001a\u0004\b&\u0010'¨\u0006*"}, d2 = {"Lkotlinx/serialization/json/JsonObject;", "Lkotlinx/serialization/json/JsonElement;", "", "", "content", "<init>", "(Ljava/util/Map;)V", "", "other", "", "equals", "(Ljava/lang/Object;)Z", "", "hashCode", "()I", "toString", "()Ljava/lang/String;", "key", "c", "(Ljava/lang/String;)Z", "value", "d", "(Lkotlinx/serialization/json/JsonElement;)Z", "e", "(Ljava/lang/String;)Lkotlinx/serialization/json/JsonElement;", "isEmpty", "()Z", "Ljava/util/Map;", "", "", "f", "()Ljava/util/Set;", "entries", "g", "keys", "i", "size", "", "j", "()Ljava/util/Collection;", "values", "Companion", "kotlinx-serialization-json"}, k = 1, mv = {2, 0, 0}, xi = 48)
...
public final class JsonObject extends JsonElement implements Map<String, JsonElement>, KMappedMarker {
    ...
    public boolean c(String key) {
        ...
        return this.f35122d.containsKey(key);
    }
    ...
    public boolean d(JsonElement value) {
        ...
        return this.f35122d.containsValue(value);
    }

    public JsonElement e(String key) {
        Intrinsics.checkNotNullParameter(key, "key");
        return (JsonElement) this.f35122d.get(key);
    }
    ...
    public boolean equals(Object obj) {
        return Intrinsics.areEqual(this.f35122d, obj);
    }

    public Set f() {
        return this.f35122d.entrySet();
    }

    public Set g() {
        return this.f35122d.keySet();
    }
    ...
    @Override // java.util.Map
    public int hashCode() {
        return this.f35122d.hashCode();
    }

    public int i() {
        return this.f35122d.size();
    }

    @Override // java.util.Map
    public boolean isEmpty() {
        return this.f35122d.isEmpty();
    }

    public Collection j() {
        return this.f35122d.values();
    }
    ...
    public String toString() {
        return CollectionsKt.x0(this.f35122d.entrySet(), ",", "{", "}", 0, null, new Function1() { // from class: ut.w
            @Override // kotlin.jvm.functions.Function1
            public final Object invoke(Object obj) {
                CharSequence l10;
                l10 = JsonObject.l((Map.Entry) obj);
                return l10;
            }
        }, 24, null);
    }
