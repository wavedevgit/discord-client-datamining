...
public final class JsonArray extends JsonElement implements List<JsonElement>, KMappedMarker {
    ...
    public boolean b(JsonElement element) {
        ...
        return this.f35104d.contains(element);
    }

    @Override // java.util.List
    /* renamed from: c */
    public JsonElement get(int i10) {
        return (JsonElement) this.f35104d.get(i10);
    }
    ...
    public boolean containsAll(Collection elements) {
        ...
        return this.f35104d.containsAll(elements);
    }

    public int d() {
        return this.f35104d.size();
    }

    public int e(JsonElement element) {
        Intrinsics.checkNotNullParameter(element, "element");
        return this.f35104d.indexOf(element);
    }

    @Override // java.util.List, java.util.Collection
    public boolean equals(Object obj) {
        return Intrinsics.areEqual(this.f35104d, obj);
    }

    public int f(JsonElement element) {
        Intrinsics.checkNotNullParameter(element, "element");
        return this.f35104d.lastIndexOf(element);
    }

    @Override // java.util.List, java.util.Collection
    public int hashCode() {
        return this.f35104d.hashCode();
    }
    ...
    public boolean isEmpty() {
        return this.f35104d.isEmpty();
    }

    @Override // java.util.List, java.util.Collection, java.lang.Iterable
    public Iterator iterator() {
        return this.f35104d.iterator();
    }
    ...
    public ListIterator<JsonElement> listIterator() {
        return this.f35104d.listIterator();
    }
    ...
    public List<JsonElement> subList(int i10, int i11) {
        return this.f35104d.subList(i10, i11);
    }
    ...
    public String toString() {
        return CollectionsKt.x0(this.f35104d, ",", "[", "]", 0, null, null, 56, null);
    }
    ...
    public ListIterator<JsonElement> listIterator(int i10) {
        return this.f35104d.listIterator(i10);
    }
