...
public class e extends m implements CancellableContinuation, CoroutineStackFrame, w1 {
    ...
    private static final /* synthetic */ AtomicIntegerFieldUpdater f35595q = AtomicIntegerFieldUpdater.newUpdater(e.class, "_decisionAndIndex$volatile");

    /* renamed from: r  reason: collision with root package name */
    private static final /* synthetic */ AtomicReferenceFieldUpdater f35596r = AtomicReferenceFieldUpdater.newUpdater(e.class, Object.class, "_state$volatile");

    /* renamed from: s  reason: collision with root package name */
    private static final /* synthetic */ AtomicReferenceFieldUpdater f35597s = AtomicReferenceFieldUpdater.newUpdater(e.class, Object.class, "_parentHandle$volatile");
    private volatile /* synthetic */ int _decisionAndIndex$volatile;
    private volatile /* synthetic */ Object _parentHandle$volatile;
    private volatile /* synthetic */ Object _state$volatile;

    /* renamed from: o  reason: collision with root package name */
    private final Continuation f35598o;

    /* renamed from: p  reason: collision with root package name */
    private final CoroutineContext f35599p;

    public e(Continuation continuation, int i10) {
        super(i10);
        this.f35598o = continuation;
        this.f35599p = continuation.getContext();
        this._decisionAndIndex$volatile = 536870911;
        this._state$volatile = b.f35568d;
    }
    ...
    private final n0 I() {
        Job job = (Job) getContext().m(Job.f35565k);
        if (job == null) {
            return null;
        }
        n0 o10 = z.o(job, false, new f(this), 1, null);
        androidx.concurrent.futures.b.a(f35597s, this, null, o10);
        return o10;
    }

    private final void J(Object obj) {
        AtomicReferenceFieldUpdater atomicReferenceFieldUpdater = f35596r;
        while (true) {
            Object obj2 = atomicReferenceFieldUpdater.get(this);
            if (obj2 instanceof b) {
                if (androidx.concurrent.futures.b.a(f35596r, this, obj2, obj)) {
                    return;
                }
                ...
                if (obj2 instanceof ys.r) {
                    ...
                    if (androidx.concurrent.futures.b.a(f35596r, this, obj2, h.b(hVar, null, dVar, null, null, null, 29, null))) {
                        return;
                    }
                    ...
                    Intrinsics.checkNotNull(obj, "null cannot be cast to non-null type kotlinx.coroutines.CancelHandler");
                    if (androidx.concurrent.futures.b.a(f35596r, this, obj2, new h(obj2, (d) obj, null, null, null, 28, null))) {
                        return;
                    }
                }
            } else {
    ...
    private final boolean L() {
        if (k0.c(this.f35617i)) {
            Continuation continuation = this.f35598o;
    ...
    private final boolean W() {
        int i10;
        AtomicIntegerFieldUpdater atomicIntegerFieldUpdater = f35595q;
        do {
        ...
        } while (!f35595q.compareAndSet(this, i10, 1073741824 + (536870911 & i10)));
        return true;
    }
    ...
    private final dt.e0 X(Object obj, Object obj2, Function3 function3) {
        ...
        while (true) {
            ...
            if (obj3 instanceof f1) {
                ...
                if (androidx.concurrent.futures.b.a(f35596r, this, obj3, V((f1) obj3, obj4, this.f35617i, function32, obj5))) {
                    v();
                    return ys.k.f56366a;
                }
                obj = obj4;
                ...
                Object obj6 = obj2;
                if (!(obj3 instanceof h) || obj6 == null || ((h) obj3).f35609d != obj6) {
                    return null;
                }
                return ys.k.f56366a;
            }
    ...
    private final boolean Y() {
        ...
        } while (!f35595q.compareAndSet(this, i10, 536870912 + (536870911 & i10)));
        return true;
    }
    ...
    private final void q(dt.b0 b0Var, Throwable th2) {
        int i10 = f35595q.get(this) & 536870911;
        if (i10 != 536870911) {
            try {
    ...
    public final Object B() {
        ...
        if (!(C instanceof ys.r)) {
            if (k0.b(this.f35617i) && (job = (Job) getContext().m(Job.f35565k)) != null && !job.a()) {
        ...
        throw ((ys.r) C).f56385a;
    }

    public final Object C() {
        return f35596r.get(this);
    }
    ...
    public final boolean Q() {
        Object obj = f35596r.get(this);
        if ((obj instanceof h) && ((h) obj).f35609d != null) {
            u();
            return false;
        }
        f35595q.set(this, 536870911);
        f35596r.set(this, b.f35568d);
        return true;
    }

    public void R(Object obj, final Function1 function1) {
        Function3 function3;
        int i10 = this.f35617i;
        if (function1 != null) {
    ...
    public final void T(Object obj, int i10, Function3 function3) {
        ...
        while (true) {
            ...
            if (obj2 instanceof f1) {
                ...
                int i11 = i10;
                Function3 function32 = function3;
                if (androidx.concurrent.futures.b.a(f35596r, this, obj2, V((f1) obj2, obj3, i11, function32, null))) {
                    v();
                    x(i11);
                    return;
                }
                ...
                if (obj2 instanceof ys.m) {
                    ...
                    if (mVar.e()) {
                        if (function33 != null) {
                            p(function33, mVar.f56385a, obj4);
                            return;
                        }
                        return;
                    }
                ...
                if (!(obj2 instanceof ys.r)) {
                    if (obj2 instanceof h) {
                        ...
                        if (!hVar.c()) {
                            Throwable th4 = th2;
                            th3 = th4;
                            if (androidx.concurrent.futures.b.a(f35596r, this, obj2, h.b(hVar, null, null, null, null, th4, 15, null))) {
                                hVar.d(this, th3);
                                return;
                            }
                        } else {
                        ...
                        th3 = th2;
                        if (androidx.concurrent.futures.b.a(f35596r, this, obj2, new h(obj2, null, null, null, th3, 14, null))) {
                            return;
                        }
                    }
                    th2 = th3;
    ...
    public boolean g(Throwable th2) {
        ...
        } while (!androidx.concurrent.futures.b.a(f35596r, this, obj, new ys.m(this, th2, z10)));
        f1 f1Var = (f1) obj;
        if (f1Var instanceof d) {
            o((d) obj, th2);
    ...
    public void r(Object obj, Function3 function3) {
        T(obj, this.f35617i, function3);
    }

    @Override // kotlin.coroutines.Continuation
    public void resumeWith(Object obj) {
        U(this, ys.t.c(obj, this), this.f35617i, null, 4, null);
    }
    ...
    public String toString() {
        return N() + '(' + ys.e0.c(this.f35598o) + "){" + D() + "}@" + ys.e0.b(this);
    }
