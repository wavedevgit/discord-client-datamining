...
public final class j extends q implements Runnable {
    ...
    public static final j f35614t;

    /* renamed from: u  reason: collision with root package name */
    private static final long f35615u;

    static {
        Long l10;
        j jVar = new j();
        f35614t = jVar;
        p0.l2(jVar, false, 1, null);
        ...
        f35615u = timeUnit.toNanos(l10.longValue());
    }
    ...
    private final synchronized Thread R2() {
        ...
        if (thread == null) {
            ...
            _thread = thread;
            thread.setContextClassLoader(f35614t.getClass().getClassLoader());
    ...
    @Override // kotlinx.coroutines.q, ys.p0
