...
public class b0 implements Job, ys.o, g1 {
    ...
    private static final /* synthetic */ AtomicReferenceFieldUpdater f35569d = AtomicReferenceFieldUpdater.newUpdater(b0.class, Object.class, "_state$volatile");

    /* renamed from: e  reason: collision with root package name */
    private static final /* synthetic */ AtomicReferenceFieldUpdater f35570e = AtomicReferenceFieldUpdater.newUpdater(b0.class, Object.class, "_parentHandle$volatile");
    ...
    public static final class b extends z0 {
        ...
        private final b0 f35572p;

        /* renamed from: q  reason: collision with root package name */
        private final c f35573q;

        /* renamed from: r  reason: collision with root package name */
        private final g f35574r;
        ...
        public void w(Throwable th2) {
            this.f35572p.T(this.f35573q, this.f35574r, this.f35575s);
        }
    }
    ...
    public static final class c implements w0 {
        ...
        /* renamed from: e  reason: collision with root package name */
        private static final /* synthetic */ AtomicIntegerFieldUpdater f35576e = AtomicIntegerFieldUpdater.newUpdater(c.class, "_isCompleting$volatile");

        /* renamed from: i  reason: collision with root package name */
        private static final /* synthetic */ AtomicReferenceFieldUpdater f35577i = AtomicReferenceFieldUpdater.newUpdater(c.class, Object.class, "_rootCause$volatile");

        /* renamed from: o  reason: collision with root package name */
        private static final /* synthetic */ AtomicReferenceFieldUpdater f35578o = AtomicReferenceFieldUpdater.newUpdater(c.class, Object.class, "_exceptionsHolder$volatile");
        ...
        private final Object e() {
            return f35578o.get(this);
        }

        private final void o(Object obj) {
            f35578o.set(this, obj);
        }
        ...
        public final Throwable f() {
            return (Throwable) f35577i.get(this);
        }
        ...
        public final void n(boolean z10) {
            f35576e.set(this, z10 ? 1 : 0);
        }

        public final void p(Throwable th2) {
            f35577i.set(this, th2);
        }
    ...
    static final class d extends kotlin.coroutines.jvm.internal.j implements Function2 {
        ...
        /* renamed from: o  reason: collision with root package name */
        private /* synthetic */ Object f35583o;
        ...
        */
        public final java.lang.Object invokeSuspend(java.lang.Object r6) {
            /*
                ...
                if (r1 == r3) goto L26
                if (r1 != r2) goto L1e
                java.lang.Object r1 = r5.f35581e
                dt.p r1 = (dt.p) r1
                java.lang.Object r3 = r5.f35580d
                dt.o r3 = (dt.o) r3
                java.lang.Object r4 = r5.f35583o
            ...
            L2a:
                kotlin.c.b(r6)
                java.lang.Object r6 = r5.f35583o
        ...
        public final Object invoke(kotlin.sequences.j jVar, Continuation continuation) {
            return ((d) create(jVar, continuation)).invokeSuspend(Unit.f32556a);
        }
    }

    public b0(boolean z10) {
        this._state$volatile = z10 ? c0.f35592g : c0.f35591f;
    }
    ...
    private final void A0(p pVar) {
        ...
        androidx.concurrent.futures.b.a(f35569d, this, pVar, d1Var);
    }

    private final void B0(z0 z0Var) {
        z0Var.f(new d1());
        androidx.concurrent.futures.b.a(f35569d, this, z0Var, z0Var.l());
    }
    ...
    private final int E0(Object obj) {
        ...
        if (obj instanceof p) {
            if (!((p) obj).a()) {
                AtomicReferenceFieldUpdater atomicReferenceFieldUpdater = f35569d;
                pVar = c0.f35592g;
            ...
            if (!androidx.concurrent.futures.b.a(f35569d, this, obj, ((u) obj).b())) {
                return -1;
            }
            y0();
            return 1;
    ...
    private final boolean P0(w0 w0Var, Object obj) {
        if (!androidx.concurrent.futures.b.a(f35569d, this, w0Var, c0.g(obj))) {
            return false;
        }
        w0(null);
        x0(obj);
    ...
    private final boolean Q0(w0 w0Var, Throwable th2) {
        ...
        if (!androidx.concurrent.futures.b.a(f35569d, this, w0Var, new c(c02, false, th2))) {
            return false;
        }
        u0(c02, th2);
        return true;
    ...
    private final Object T0(w0 w0Var, Object obj) {
        ...
        synchronized (cVar) {
            ...
            cVar.n(true);
            if (cVar != w0Var && !androidx.concurrent.futures.b.a(f35569d, this, w0Var, cVar)) {
                e0Var = c0.f35588c;
                return e0Var;
            }
            boolean j10 = cVar.j();
    ...
    private final boolean U0(c cVar, g gVar, Object obj) {
        while (z.n(gVar.f35603p, false, new b(this, cVar, gVar, obj)) == e1.f56360d) {
            gVar = t0(gVar);
            if (gVar == null) {
                return false;
            }
    ...
    private final Object V(c cVar, Object obj) {
        ...
        x0(obj);
        androidx.concurrent.futures.b.a(f35569d, this, cVar, c0.g(obj));
        S(cVar, obj);
        return obj;
    }
    ...
    public final void C0(z0 z0Var) {
        ...
        do {
            ...
            if (f02 instanceof z0) {
                if (f02 == z0Var) {
                    atomicReferenceFieldUpdater = f35569d;
                    pVar = c0.f35592g;
                } else {
                    return;
                }
    ...
    public final CancellationException I() {
        ...
        if (f02 instanceof c) {
            ...
            if (f02 instanceof ys.r) {
                return K0(this, ((ys.r) f02).f56385a, null, 1, null);
            }
    ...
    public final boolean L(Object obj) {
        ...
        dt.e0 e0Var3;
        obj2 = c0.f35586a;
        if (!b0() || (obj2 = N(obj)) != c0.f35587b) {
            e0Var = c0.f35586a;
            if (obj2 == e0Var) {
                obj2 = p0(obj);
            }
            e0Var2 = c0.f35586a;
            if (obj2 != e0Var2 && obj2 != c0.f35587b) {
                e0Var3 = c0.f35589d;
                if (obj2 == e0Var3) {
                    return false;
                }
    ...
    public final ys.n e0() {
        return (ys.n) f35570e.get(this);
    }

    public final Object f0() {
        return f35569d.get(this);
    }
    ...
    public final n0 l0(boolean z10, z0 z0Var) {
        ...
        while (true) {
            ...
            if (f02 instanceof p) {
                p pVar = (p) f02;
                if (pVar.a()) {
                    if (androidx.concurrent.futures.b.a(f35569d, this, f02, z0Var)) {
                        break;
                    }
                } else {
                    A0(pVar);
    ...
    public final ys.n y(ys.o oVar) {
        ...
        while (true) {
            ...
            if (f02 instanceof p) {
                p pVar = (p) f02;
                if (pVar.a()) {
                    if (androidx.concurrent.futures.b.a(f35569d, this, f02, gVar)) {
                        return gVar;
                    }
                } else {
                    A0(pVar);
