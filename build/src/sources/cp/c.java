...
public final class c extends FrameLayout {
    ...
    public static final a f20115i = new a(null);

    /* renamed from: d  reason: collision with root package name */
    private final xo.b f20116d;
    ...
    public static final class a implements c0 {
        ...
        private final /* synthetic */ f f20118a;

        /* JADX INFO: Access modifiers changed from: package-private */
        /* renamed from: cp.c$a$a  reason: collision with other inner class name */
        /* loaded from: /home/runner/work/discord-client-datamining/discord-client-datamining/build/classes4.dex */
        public /* synthetic */ class C0289a extends FunctionReferenceImpl implements Function2 {
            C0289a(Object obj) {
        ...
        public static final View c(d initialRendering, a0 initialEnv, Context context, ViewGroup viewGroup) {
            ...
            cVar.setId(f2.f52827h);
            cVar.setLayoutParams(new ViewGroup.LayoutParams(-1, -1));
            g0.a(cVar, initialRendering, initialEnv, new C0289a(cVar));
            return cVar;
        }
        ...
        public View a(d initialRendering, a0 initialViewEnvironment, Context contextForNewView, ViewGroup viewGroup) {
            ...
            return this.f20118a.a(initialRendering, initialViewEnvironment, contextForNewView, viewGroup);
        }

        @Override // en.c0
        public KClass getType() {
            return this.f20118a.getType();
        }

        private a() {
            this.f20118a = new f(Reflection.getOrCreateKotlinClass(d.class), new Function4() { // from class: cp.b
    ...
    private final View b(d dVar, a0 a0Var) {
        ...
        if (currentView != null) {
            ...
            if (view != null) {
                this.f20117e.d(CollectionsKt.e(nVar));
        ...
        View c11 = f0.c((e0) a0Var.a(e0.f21788a), nVar, a0Var, context, this, new h0() { // from class: cp.a
            @Override // en.h0
        ...
        g0.h(c11);
        this.f20117e.h(CollectionsKt.l(), currentView, c11);
        this.f20116d.f55257c.removeView(currentView);
        this.f20116d.f55257c.addView(c11);
    ...
    private final View getCurrentView() {
        if (this.f20116d.f55257c.getChildCount() > 0) {
            return this.f20116d.f55257c.getChildAt(0);
        }
        return null;
    }
    ...
    public final void d(d newRendering, a0 newViewEnvironment) {
        ...
        if (!isEnabled()) {
            b10.setAlpha(0.5f);
            this.f20116d.f55256b.setVisibility(0);
            return;
        }
        b10.setAlpha(1.0f);
        this.f20116d.f55256b.setVisibility(8);
    }
    ...
    protected void onAttachedToWindow() {
        ...
        this.f20117e.a(g.a.b(aVar, c10, null, 2, null), c11);
    }
    ...
    protected Parcelable onSaveInstanceState() {
        ...
        if (onSaveInstanceState != null) {
            return new b(onSaveInstanceState, this.f20117e.g());
        }
        return null;
    }
    ...
    public static final class b extends View.BaseSavedState {
        ...
        public void writeToParcel(Parcel out, int i10) {
            ...
            out.writeParcelable(this.f20119d, i10);
        }
        ...
        public b(Parcel source) {
            ...
            this.f20119d = (e.a) readParcelable;
        }
    }
    ...
    public c(Context context, AttributeSet attributeSet, int i10, int i11) {
        ...
        Intrinsics.checkNotNullParameter(context, "context");
        xo.b b10 = xo.b.b(LayoutInflater.from(context), this);
