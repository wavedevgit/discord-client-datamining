...
public interface y {
    ...
    public static final class a {
        ...
        private final Handler f42711a;

        /* renamed from: b  reason: collision with root package name */
        private final y f42712b;
        ...
        public static /* synthetic */ void c(a aVar, DecoderCounters decoderCounters) {
            aVar.getClass();
            decoderCounters.c();
            ((y) w0.j(aVar.f42712b)).k(decoderCounters);
        }

        public static /* synthetic */ void i(a aVar, Format format, DecoderReuseEvaluation decoderReuseEvaluation) {
            ((y) w0.j(aVar.f42712b)).x(format);
            ((y) w0.j(aVar.f42712b)).h(format, decoderReuseEvaluation);
        }

        public void k(final String str, final long j10, final long j11) {
            Handler handler = this.f42711a;
            if (handler != null) {
                handler.post(new Runnable() { // from class: oe.u
                    @Override // java.lang.Runnable
                    public final void run() {
                        ((y) w0.j(y.a.this.f42712b)).d(str, j10, j11);
                    }
                });
            }
        }
        ...
        public void n(final int i10, final long j10) {
            ...
            if (handler != null) {
                handler.post(new Runnable() { // from class: oe.p
                    @Override // java.lang.Runnable
                    public final void run() {
                        ((y) w0.j(y.a.this.f42712b)).m(i10, j10);
                    }
                });
            }
        }
        ...
        public void o(final DecoderCounters decoderCounters) {
            ...
            if (handler != null) {
                handler.post(new Runnable() { // from class: oe.v
                    @Override // java.lang.Runnable
                    public final void run() {
                        ((y) w0.j(y.a.this.f42712b)).p(decoderCounters);
                    }
                });
            }
        }
        ...
        public void q(final Object obj) {
            if (this.f42711a != null) {
                ...
                this.f42711a.post(new Runnable() { // from class: oe.q
                    @Override // java.lang.Runnable
                    public final void run() {
                        ((y) w0.j(y.a.this.f42712b)).o(obj, elapsedRealtime);
                    }
                });
            }
        }
        ...
        public void r(final long j10, final int i10) {
            ...
            if (handler != null) {
                handler.post(new Runnable() { // from class: oe.x
                    @Override // java.lang.Runnable
                    public final void run() {
                        ((y) w0.j(y.a.this.f42712b)).s(j10, i10);
                    }
                });
            }
        }
        ...
        public void t(final VideoSize videoSize) {
            ...
            if (handler != null) {
                handler.post(new Runnable() { // from class: oe.o
                    @Override // java.lang.Runnable
                    public final void run() {
                        ((y) w0.j(y.a.this.f42712b)).onVideoSizeChanged(videoSize);
                    }
                });
            }
        }
