...
public abstract class f {
    ...
    private static final byte[] f38933a = {0, 0, 0, 1};

    /* renamed from: b  reason: collision with root package name */
    private static final String[] f38934b = {"", "A", "B", "C"};
    ...
    private static int e(byte[] bArr, int i10) {
        int length = bArr.length - f38933a.length;
        while (i10 <= length) {
            if (f(bArr, i10)) {
                return i10;
            }
    ...
    private static boolean f(byte[] bArr, int i10) {
        if (bArr.length - i10 <= f38933a.length) {
            return false;
        }
        int i11 = 0;
        while (true) {
