...
public abstract class e0 {
    ...
    static final Type[] f44578a = new Type[0];

    /* renamed from: b  reason: collision with root package name */
    private static boolean f44579b = true;
    ...
    public static final class a implements GenericArrayType {
        ...
        public int hashCode() {
            return this.f44580d.hashCode();
        }

        public String toString() {
            return e0.u(this.f44580d) + "[]";
        }
    }
    ...
    public static final class b implements ParameterizedType {
        ...
        /* renamed from: d  reason: collision with root package name */
        private final Type f44581d;

        /* renamed from: e  reason: collision with root package name */
        private final Type f44582e;

        /* renamed from: i  reason: collision with root package name */
        private final Type[] f44583i;
        ...
        public b(Type type, Type type2, Type... typeArr) {
            ...
            this.f44581d = type;
            this.f44582e = type2;
            this.f44583i = (Type[]) typeArr.clone();
        }
        ...
        public Type[] getActualTypeArguments() {
            return (Type[]) this.f44583i.clone();
        }
        ...
        public int hashCode() {
            int i10;
            int hashCode = Arrays.hashCode(this.f44583i) ^ this.f44582e.hashCode();
            Type type = this.f44581d;
            if (type != null) {
                i10 = type.hashCode();
            } else {
                i10 = 0;
        ...
        public String toString() {
            Type[] typeArr = this.f44583i;
            if (typeArr.length == 0) {
                return e0.u(this.f44582e);
            }
            StringBuilder sb2 = new StringBuilder((typeArr.length + 1) * 30);
            sb2.append(e0.u(this.f44582e));
            sb2.append("<");
            sb2.append(e0.u(this.f44583i[0]));
            for (int i10 = 1; i10 < this.f44583i.length; i10++) {
                sb2.append(", ");
                sb2.append(e0.u(this.f44583i[i10]));
            }
            sb2.append(">");
            return sb2.toString();
        }
    ...
    public static final class c implements WildcardType {
        ...
        /* renamed from: d  reason: collision with root package name */
        private final Type f44584d;

        /* renamed from: e  reason: collision with root package name */
        private final Type f44585e;
                ...
                if (typeArr.length == 1) {
                    if (typeArr2.length == 1) {
                        ...
                        if (typeArr[0] == Object.class) {
                            this.f44585e = typeArr2[0];
                            this.f44584d = Object.class;
                            return;
                        }
                        throw new IllegalArgumentException();
                    }
        ...
        public Type[] getLowerBounds() {
            Type type = this.f44585e;
            return type != null ? new Type[]{type} : e0.f44578a;
        }

        @Override // java.lang.reflect.WildcardType
        public Type[] getUpperBounds() {
            return new Type[]{this.f44584d};
        }
        ...
        public int hashCode() {
            ...
            return i10 ^ (this.f44584d.hashCode() + 31);
        }

        public String toString() {
            if (this.f44585e != null) {
                return "? super " + e0.u(this.f44585e);
            } else if (this.f44584d == Object.class) {
                return "?";
            } else {
                return "? extends " + e0.u(this.f44584d);
            }
        }
    }
    ...
    public static RuntimeException p(Method method, int i10, String str, Object... objArr) {
        String a10 = v.f44700b.a(method, i10);
    ...
    */
    static java.lang.reflect.Type r(java.lang.reflect.Type r8, java.lang.Class r9, java.lang.reflect.Type r10) {
        ...
        Lb1:
            ...
            java.lang.reflect.Type[] r10 = new java.lang.reflect.Type[r1]
            r10[r2] = r8
            java.lang.reflect.Type[] r8 = ov.e0.f44578a
            r9.<init>(r10, r8)
            return r9
        Lca:
            return r10
        */
        throw new UnsupportedOperationException("Method not decompiled: ov.e0.r(java.lang.reflect.Type, java.lang.Class, java.lang.reflect.Type):java.lang.reflect.Type");
    }
