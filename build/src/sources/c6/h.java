...
public class h extends c6.a {
    ...
    private final SSLSocketFactory f8150a;
    ...
    public static class a extends FilterInputStream {
        ...
        private final HttpURLConnection f8151d;

        a(HttpURLConnection httpURLConnection) {
            super(h.j(httpURLConnection));
            this.f8151d = httpURLConnection;
        }
    ...
    private HttpURLConnection k(URL url, n nVar) {
        ...
        f10.setDoInput(true);
        if ("https".equals(url.getProtocol()) && (sSLSocketFactory = this.f8150a) != null) {
