...
public final class p {
    ...
    public static final p f54403c = new a().b(0).a();

    /* renamed from: d  reason: collision with root package name */
    public static final p f54404d = new a().b(1).a();

    /* renamed from: a  reason: collision with root package name */
    private final LinkedHashSet f54405a;
    ...
    public static final class a {
        ...
        /* renamed from: a  reason: collision with root package name */
        private final LinkedHashSet f54407a = new LinkedHashSet();

        /* renamed from: b  reason: collision with root package name */
        private String f54408b;

        public p a() {
            return new p(this.f54407a, this.f54408b);
        }
        ...
        public a b(int i10) {
            ...
            this.f54407a.add(new a0.l1(i10));
            return this;
        }
    }

    p(LinkedHashSet linkedHashSet, String str) {
        this.f54405a = linkedHashSet;
        this.f54406b = str;
    }
    ...
    public List b(List list) {
        ...
        Iterator it = this.f54405a.iterator();
        while (it.hasNext()) {
