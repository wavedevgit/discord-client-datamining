...
public class h implements Supplier {
    ...
    public boolean equals(Object obj) {
        ...
        return o8.h.a(this.f54079a, ((h) obj).f54079a);
    }
    ...
    public String toString() {
        return o8.h.b(this).b("list", this.f54079a).toString();
    }
    ...
    public class a extends y8.a {
        ...
        private AtomicInteger f54084k;

        /* renamed from: l  reason: collision with root package name */
        private Throwable f54085l;
        ...
        private synchronized DataSource A(int i10) {
            ...
            ArrayList arrayList = this.f54081h;
            if (arrayList != null && i10 < arrayList.size()) {
                dataSource = (DataSource) this.f54081h.get(i10);
            } else {
                dataSource = null;
            }
            return dataSource;
        ...
        private synchronized DataSource B() {
            return A(this.f54082i);
        }

        private void C() {
            Throwable th2;
            if (this.f54084k.incrementAndGet() == this.f54083j && (th2 = this.f54085l) != null) {
                o(th2, this.f54086m);
            }
        }
        ...
        */
        private void D(int r3, com.facebook.datasource.DataSource r4, boolean r5) {
            /*
                r2 = this;
                monitor-enter(r2)
                int r0 = r2.f54082i     // Catch: java.lang.Throwable -> L1b
                com.facebook.datasource.DataSource r1 = r2.A(r3)     // Catch: java.lang.Throwable -> L1b
                if (r4 != r1) goto L2f
                int r4 = r2.f54082i     // Catch: java.lang.Throwable -> L1b
                if (r3 != r4) goto Le
                goto L2f
            Le:
            ...
            L1d:
                ...
                goto L21
            L1f:
                r2.f54082i = r3     // Catch: java.lang.Throwable -> L1b
            L21:
        ...
        public void E(int i10, DataSource dataSource) {
            x(G(i10, dataSource));
            if (i10 == 0) {
                this.f54085l = dataSource.b();
                this.f54086m = dataSource.getExtras();
            }
            C();
        }
        ...
        private void y() {
            if (this.f54084k != null) {
                return;
            }
            synchronized (this) {
                try {
                    if (this.f54084k == null) {
                        this.f54084k = new AtomicInteger(0);
                        int size = h.this.f54079a.size();
                        this.f54083j = size;
                        this.f54082i = size;
                        this.f54081h = new ArrayList(size);
                        for (int i10 = 0; i10 < size; i10++) {
                            DataSource dataSource = (DataSource) ((Supplier) h.this.f54079a.get(i10)).get();
                            this.f54081h.add(dataSource);
                            dataSource.c(new C0755a(i10), m8.a.a());
                            if (!dataSource.a()) {
                            }
                        }
                    }
        ...
        private synchronized DataSource z(int i10) {
            ...
            dataSource = null;
            if (arrayList != null && i10 < arrayList.size()) {
                dataSource = (DataSource) this.f54081h.set(i10, null);
            }
            return dataSource;
        }
        ...
        /* loaded from: /home/runner/work/discord-client-datamining/discord-client-datamining/build/classes3.dex */
        public class C0755a implements e {
            ...
            public void onFailure(DataSource dataSource) {
                a.this.E(this.f54088a, dataSource);
            }

            @Override // y8.e
            public void onNewResult(DataSource dataSource) {
                if (dataSource.a()) {
                    a.this.F(this.f54088a, dataSource);
