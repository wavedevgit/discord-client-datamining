...
public class f implements Supplier {
    ...
    public class a extends y8.a {
        ...
        private int f54065h = 0;

        /* renamed from: i  reason: collision with root package name */
        private DataSource f54066i = null;

        /* renamed from: j  reason: collision with root package name */
        private DataSource f54067j = null;

        /* JADX INFO: Access modifiers changed from: private */
        /* renamed from: y8.f$a$a  reason: collision with other inner class name */
        /* loaded from: /home/runner/work/discord-client-datamining/discord-client-datamining/build/classes3.dex */
        public class C0763a implements e {
            @Override // y8.e
        ...
        private synchronized Supplier A() {
            if (!i() && this.f54065h < f.this.f54064a.size()) {
                List list = f.this.f54064a;
                int i10 = this.f54065h;
                this.f54065h = i10 + 1;
        ...
        private void B(DataSource dataSource, boolean z10) {
            ...
            synchronized (this) {
                if (dataSource == this.f54066i && dataSource != (dataSource2 = this.f54067j)) {
                    if (dataSource2 != null && !z10) {
                        dataSource2 = null;
                        y(dataSource2);
                    }
                    this.f54067j = dataSource;
                    y(dataSource2);
                }
            }
        }
        ...
        private boolean F() {
            ...
            if (E(dataSource) && dataSource != null) {
                dataSource.c(new C0763a(), m8.a.a());
                return true;
            }
            y(dataSource);
            return false;
        ...
        public boolean close() {
            synchronized (this) {
                try {
                    ...
                    DataSource dataSource = this.f54066i;
                    this.f54066i = null;
                    DataSource dataSource2 = this.f54067j;
                    this.f54067j = null;
                    y(dataSource2);
                    y(dataSource);
                    return true;
    ...
    public boolean equals(Object obj) {
        ...
        return o8.h.a(this.f54064a, ((f) obj).f54064a);
    }
    ...
    public String toString() {
        return o8.h.b(this).b("list", this.f54064a).toString();
    }
}
