...
public class f implements Supplier {
    ...
    public class a extends y8.a {
        ...
        private int f55108h = 0;

        /* renamed from: i  reason: collision with root package name */
        private DataSource f55109i = null;

        /* renamed from: j  reason: collision with root package name */
        private DataSource f55110j = null;
        ...
        private synchronized Supplier A() {
            if (!i() && this.f55108h < f.this.f55107a.size()) {
                List list = f.this.f55107a;
                int i10 = this.f55108h;
                this.f55108h = i10 + 1;
        ...
        private void B(DataSource dataSource, boolean z10) {
            ...
            synchronized (this) {
                if (dataSource == this.f55109i && dataSource != (dataSource2 = this.f55110j)) {
                    if (dataSource2 != null && !z10) {
                        dataSource2 = null;
                        y(dataSource2);
                    }
                    this.f55110j = dataSource;
                    y(dataSource2);
                }
            }
        }
        ...
        public boolean close() {
            synchronized (this) {
                try {
                    ...
                    DataSource dataSource = this.f55109i;
                    this.f55109i = null;
                    DataSource dataSource2 = this.f55110j;
                    this.f55110j = null;
                    y(dataSource2);
                    y(dataSource);
                    return true;
    ...
    public boolean equals(Object obj) {
        ...
        return o8.h.a(this.f55107a, ((f) obj).f55107a);
    }
    ...
    public String toString() {
        return o8.h.b(this).b("list", this.f55107a).toString();
    }
}
