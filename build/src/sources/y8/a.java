...
public abstract class a implements DataSource {
    ...
    private Object f55040d = null;

    /* renamed from: e  reason: collision with root package name */
    private Throwable f55041e = null;

    /* renamed from: f  reason: collision with root package name */
    private float f55042f = 0.0f;

    /* renamed from: c  reason: collision with root package name */
    private boolean f55039c = false;

    /* renamed from: b  reason: collision with root package name */
    private d f55038b = d.IN_PROGRESS;

    /* renamed from: g  reason: collision with root package name */
    private final ConcurrentLinkedQueue f55043g = new ConcurrentLinkedQueue();
    ...
    public class RunnableC0741a implements Runnable {
        ...
        /* renamed from: d  reason: collision with root package name */
        final /* synthetic */ boolean f55044d;

        /* renamed from: e  reason: collision with root package name */
        final /* synthetic */ e f55045e;

        /* renamed from: i  reason: collision with root package name */
        final /* synthetic */ boolean f55046i;
        ...
        public void run() {
            if (this.f55044d) {
                this.f55045e.onFailure(a.this);
            } else if (this.f55046i) {
                this.f55045e.onCancellation(a.this);
            } else {
                this.f55045e.onNewResult(a.this);
            }
        }
    }
    ...
    public class b implements Runnable {
        ...
        @Override // java.lang.Runnable
        public void run() {
            this.f55048d.onProgressUpdate(a.this);
        }
    }
    ...
    private void k() {
        boolean h10 = h();
        boolean u10 = u();
        Iterator it = this.f55043g.iterator();
        while (it.hasNext()) {
    ...
    private synchronized boolean p(Throwable th2, Map map) {
        if (!this.f55039c && this.f55038b == d.IN_PROGRESS) {
            this.f55038b = d.FAILURE;
            this.f55041e = th2;
            this.f55037a = map;
            return true;
        }
            ...
            synchronized (this) {
                try {
                    try {
                        if (!this.f55039c && this.f55038b == d.IN_PROGRESS) {
                            if (z10) {
                                this.f55038b = d.SUCCESS;
                                this.f55042f = 1.0f;
                            }
                            Object obj4 = this.f55040d;
                            if (obj4 != obj) {
                                try {
                                    this.f55040d = obj;
                                    obj2 = obj4;
    ...
    */
    public void c(y8.e r3, java.util.concurrent.Executor r4) {
        /*
            ...
            o8.j.g(r4)
            monitor-enter(r2)
            boolean r0 = r2.f55039c     // Catch: java.lang.Throwable -> Ld
            if (r0 == 0) goto Lf
        ...
        Ld:
            ...
            goto L43
        Lf:
            y8.a$d r0 = r2.f55038b     // Catch: java.lang.Throwable -> Ld
            y8.a$d r1 = y8.a.d.IN_PROGRESS     // Catch: java.lang.Throwable -> Ld
            if (r0 != r1) goto L1e
            java.util.concurrent.ConcurrentLinkedQueue r0 = r2.f55043g     // Catch: java.lang.Throwable -> Ld
