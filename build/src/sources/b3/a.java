...
public abstract class a {
    ...
    public static final class C0128a extends c {
        ...
        final /* synthetic */ Function0 f6313b;

        /* renamed from: c  reason: collision with root package name */
        final /* synthetic */ Function1 f6314c;

        C0128a(Function0 function0, Function1 function1) {
            this.f6313b = function0;
            this.f6314c = function1;
        }

        @Override // b3.c
        public float a() {
            return ((Number) this.f6313b.invoke()).floatValue();
        }

        @Override // b3.c
        public void b(float f10) {
            this.f6314c.invoke(Float.valueOf(f10));
        }
    }

    private static final c a(Function1 function1, Function0 function0) {
        return new C0128a(function0, function1);
    }
