...
public final class v extends kotlin.coroutines.jvm.internal.d implements FlowCollector, CoroutineStackFrame {
    ...
    public final FlowCollector f48078d;

    /* renamed from: e  reason: collision with root package name */
    public final CoroutineContext f48079e;

    /* renamed from: i  reason: collision with root package name */
    public final int f48080i;

    /* renamed from: o  reason: collision with root package name */
    private CoroutineContext f48081o;

    /* renamed from: p  reason: collision with root package name */
    private Continuation f48082p;

    public v(FlowCollector flowCollector, CoroutineContext coroutineContext) {
        super(r.f48072d, kotlin.coroutines.e.f32062d);
        this.f48078d = flowCollector;
        this.f48079e = coroutineContext;
        this.f48080i = ((Number) coroutineContext.A1(0, new Function2() { // from class: qs.u
    ...
    private final Object m(Continuation continuation, Object obj) {
        ...
        CoroutineContext coroutineContext = this.f48081o;
        if (coroutineContext != context) {
            k(context, coroutineContext, obj);
            this.f48081o = context;
        }
        this.f48082p = continuation;
        Function3 a10 = w.a();
        FlowCollector flowCollector = this.f48078d;
        ...
        if (!Intrinsics.areEqual(invoke, ur.b.f())) {
            this.f48082p = null;
        }
        return invoke;
    }
    ...
    private final void n(m mVar, Object obj) {
        throw new IllegalStateException(StringsKt.j("\n            Flow exception transparency is violated:\n                Previous 'emit' call has thrown exception " + mVar.f48066e + ", but then emission attempt of value '" + obj + "' has been detected.\n                Emissions from 'catch' blocks are prohibited in order to avoid unspecified behaviour, 'Flow.catch' operator can be used instead.\n                For a more detailed explanation, please refer to Flow documentation.\n            ").toString());
    }
    ...
    public Object emit(Object obj, Continuation continuation) {
        try {
            ...
            this.f48081o = new m(th2, continuation.getContext());
            throw th2;
        }
    }
    ...
    public CoroutineStackFrame getCallerFrame() {
        Continuation continuation = this.f48082p;
    ...
    protected Object invokeSuspend(Object obj) {
        ...
        if (e10 != null) {
            this.f48081o = new m(e10, getContext());
        }
        Continuation continuation = this.f48082p;
