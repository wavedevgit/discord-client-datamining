...
public final class i implements KSerializer {
    ...
    public static final i f52763a = new i();

    /* renamed from: b  reason: collision with root package name */
    private static final Lazy f52764b = l.a(o.f31103e, a.f52765d);

    /* loaded from: /home/runner/work/discord-client-datamining/discord-client-datamining/build/classes5.dex */
    static final class a extends Lambda implements Function0 {

        /* renamed from: d  reason: collision with root package name */
        public static final a f52765d = new a();
        ...
        public static final class C0727a extends Lambda implements Function1 {
            ...
            /* renamed from: d  reason: collision with root package name */
            public static final C0727a f52766d = new C0727a();
        ...
        public final SerialDescriptor invoke() {
            return zs.j.c("kotlinx.datetime.TimeBased", new SerialDescriptor[0], C0727a.f52766d);
        }
    }
    ...
    public c.e deserialize(Decoder decoder) {
        ...
        boolean z10 = true;
        if (b10.p()) {
            j10 = b10.f(f52763a.getDescriptor(), 0);
        } else {
            long j11 = 0;
            boolean z11 = false;
            while (true) {
    ...
    public void serialize(Encoder encoder, c.e value) {
        ...
        b10.E(f52763a.getDescriptor(), 0, value.d());
        b10.c(descriptor);
    }

    @Override // kotlinx.serialization.KSerializer, xs.o, kotlinx.serialization.DeserializationStrategy
    public SerialDescriptor getDescriptor() {
        return (SerialDescriptor) f52764b.getValue();
    }
}
