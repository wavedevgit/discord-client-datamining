...
public final class a implements m {
    ...
    private static final p[] f49841b = new p[0];

    /* renamed from: a  reason: collision with root package name */
    private final c f49842a = new c();
    ...
    public Result a(ik.c cVar, Map map) {
        e b10 = this.f49842a.b(b(cVar.a()), map);
        Result result = new Result(b10.k(), b10.g(), f49841b, ik.a.MAXICODE);
