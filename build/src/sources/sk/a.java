...
final class a {
    ...
    private final ok.b f48135a;

    /* renamed from: b  reason: collision with root package name */
    private final ok.b f48136b;
    ...
    public a(ok.b bVar) {
        ...
        if (h10 >= 8 && h10 <= 144 && (h10 & 1) == 0) {
            ...
            ok.b a10 = a(bVar);
            this.f48135a = a10;
            this.f48136b = new ok.b(a10.l(), a10.h());
            return;
        }
        throw g.a();
    }
    ...
    private ok.b a(ok.b bVar) {
        int f10 = this.f48137c.f();
        int e10 = this.f48137c.e();
        if (bVar.h() == f10) {
            int c10 = this.f48137c.c();
            int b10 = this.f48137c.b();
            int i10 = f10 / c10;
            int i11 = e10 / b10;
    ...
    private boolean h(int i10, int i11, int i12, int i13) {
        ...
        this.f48136b.q(i11, i10);
        return this.f48135a.e(i11, i10);
    }
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    public byte[] c() {
        byte[] bArr = new byte[this.f48137c.g()];
        int h10 = this.f48135a.h();
        int l10 = this.f48135a.l();
        int i10 = 0;
        boolean z10 = false;
        int i11 = 0;
        boolean z11 = false;
        ...
        while (true) {
            if (i12 == h10 && i10 == 0 && !z10) {
                ...
                if (i12 == i13 && i10 == 0 && (l10 & 3) != 0 && !z11) {
                    ...
                    while (true) {
                        if (i12 < h10 && i10 >= 0 && !this.f48136b.e(i10, i12)) {
                    ...
                    int i17 = i10 + 5;
                    while (true) {
                        if (i16 >= 0 && i17 < l10 && !this.f48136b.e(i17, i16)) {
