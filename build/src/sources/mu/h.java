...
public class h {
    ...
    private static volatile h f37656b;

    /* renamed from: c  reason: collision with root package name */
    private static final Logger f37657c;
    ...
    public static final class a {
        ...
        private final h e() {
            ...
            c a11;
            d b10;
            if (j() && (b10 = d.f37637e.b()) != null) {
                return b10;
            }
            if (i() && (a11 = c.f37634e.a()) != null) {
                return a11;
            }
            if (k() && (a10 = g.f37652e.a()) != null) {
                return a10;
            }
            f a12 = f.f37650d.a();
            if (a12 != null) {
    ...
    static {
        ...
        f37655a = aVar;
        f37656b = aVar.f();
        f37657c = Logger.getLogger(OkHttpClient.class.getName());
    }
    ...
    public pu.c c(X509TrustManager trustManager) {
        ...
        return new pu.a(d(trustManager));
    }
    ...
    public pu.e d(X509TrustManager trustManager) {
        ...
        return new pu.b((X509Certificate[]) Arrays.copyOf(acceptedIssuers, acceptedIssuers.length));
    }
    ...
    public Object i(String closer) {
        ...
        if (f37657c.isLoggable(Level.FINE)) {
