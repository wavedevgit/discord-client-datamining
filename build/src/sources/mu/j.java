...
public abstract class j {
    ...
    public static final class a implements Comparator {
        ...
        public final int compare(Object obj, Object obj2) {
            return or.a.d(((i) obj).b(), ((i) obj2).b());
        }
    }
    ...
    public static final class b extends Lambda implements Function2 {
        ...
        final /* synthetic */ Ref.BooleanRef f39487d;

        /* renamed from: e  reason: collision with root package name */
        final /* synthetic */ long f39488e;

        /* renamed from: i  reason: collision with root package name */
        final /* synthetic */ Ref.LongRef f39489i;

        /* renamed from: o  reason: collision with root package name */
        final /* synthetic */ BufferedSource f39490o;

        /* renamed from: p  reason: collision with root package name */
        final /* synthetic */ Ref.LongRef f39491p;

        /* renamed from: q  reason: collision with root package name */
        final /* synthetic */ Ref.LongRef f39492q;

        /* renamed from: r  reason: collision with root package name */
        final /* synthetic */ Ref.ObjectRef f39493r;

        /* renamed from: s  reason: collision with root package name */
        final /* synthetic */ Ref.ObjectRef f39494s;

        /* renamed from: t  reason: collision with root package name */
        final /* synthetic */ Ref.ObjectRef f39495t;
        ...
        public static final class a extends Lambda implements Function2 {
            ...
            /* renamed from: d  reason: collision with root package name */
            final /* synthetic */ Ref.ObjectRef f39496d;

            /* renamed from: e  reason: collision with root package name */
            final /* synthetic */ BufferedSource f39497e;

            /* renamed from: i  reason: collision with root package name */
            final /* synthetic */ Ref.ObjectRef f39498i;

            /* renamed from: o  reason: collision with root package name */
            final /* synthetic */ Ref.ObjectRef f39499o;

            /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
            a(Ref.ObjectRef objectRef, BufferedSource bufferedSource, Ref.ObjectRef objectRef2, Ref.ObjectRef objectRef3) {
                super(2);
                this.f39496d = objectRef;
                this.f39497e = bufferedSource;
                this.f39498i = objectRef2;
                this.f39499o = objectRef3;
            }
            ...
            public final void a(int i10, long j10) {
                if (i10 == 1) {
                    Ref.ObjectRef objectRef = this.f39496d;
                    if (objectRef.element == 0) {
                        if (j10 == 24) {
                            objectRef.element = Long.valueOf(this.f39497e.O0());
                            this.f39498i.element = Long.valueOf(this.f39497e.O0());
                            this.f39499o.element = Long.valueOf(this.f39497e.O0());
                            return;
                        }
        ...
        b(Ref.BooleanRef booleanRef, long j10, Ref.LongRef longRef, BufferedSource bufferedSource, Ref.LongRef longRef2, Ref.LongRef longRef3, Ref.ObjectRef objectRef, Ref.ObjectRef objectRef2, Ref.ObjectRef objectRef3) {
            super(2);
            this.f39487d = booleanRef;
            this.f39488e = j10;
            this.f39489i = longRef;
            this.f39490o = bufferedSource;
            this.f39491p = longRef2;
            this.f39492q = longRef3;
            this.f39493r = objectRef;
            this.f39494s = objectRef2;
            this.f39495t = objectRef3;
        }
        ...
        public final void a(int i10, long j10) {
            ...
            if (i10 != 1) {
                ...
                if (j10 >= 4) {
                    this.f39490o.skip(4L);
                    BufferedSource bufferedSource = this.f39490o;
                    j.i(bufferedSource, (int) (j10 - 4), new a(this.f39493r, bufferedSource, this.f39494s, this.f39495t));
                    return;
                }
                throw new IOException("bad zip: NTFS extra too short");
            }
            Ref.BooleanRef booleanRef = this.f39487d;
            if (!booleanRef.element) {
                booleanRef.element = true;
                if (j10 >= this.f39488e) {
                    Ref.LongRef longRef = this.f39489i;
                    long j12 = longRef.element;
                    if (j12 == 4294967295L) {
                        j12 = this.f39490o.O0();
                    }
                    longRef.element = j12;
                    Ref.LongRef longRef2 = this.f39491p;
                    long j13 = 0;
                    ...
                    Ref.LongRef longRef3 = this.f39492q;
    ...
    public static final class c extends Lambda implements Function2 {
        ...
        /* renamed from: d  reason: collision with root package name */
        final /* synthetic */ BufferedSource f39500d;

        /* renamed from: e  reason: collision with root package name */
        final /* synthetic */ Ref.ObjectRef f39501e;

        /* renamed from: i  reason: collision with root package name */
        final /* synthetic */ Ref.ObjectRef f39502i;

        /* renamed from: o  reason: collision with root package name */
        final /* synthetic */ Ref.ObjectRef f39503o;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        c(BufferedSource bufferedSource, Ref.ObjectRef objectRef, Ref.ObjectRef objectRef2, Ref.ObjectRef objectRef3) {
            super(2);
            this.f39500d = bufferedSource;
            this.f39501e = objectRef;
            this.f39502i = objectRef2;
            this.f39503o = objectRef3;
        }
        ...
        public final void a(int i10, long j10) {
            ...
            if (i10 == 21589) {
                long j11 = 1;
                if (j10 >= 1) {
                    byte readByte = this.f39500d.readByte();
                    boolean z12 = false;
                    if ((readByte & 1) == 1) {
                        z10 = true;
                    } else {
                    ...
                    BufferedSource bufferedSource = this.f39500d;
                    if (z10) {
                        j11 = 5;
                    }
                    if (z11) {
                    ...
                    if (j10 >= j11) {
                        if (z10) {
                            this.f39501e.element = Integer.valueOf(bufferedSource.Q1());
                        }
                        if (z11) {
                            this.f39502i.element = Integer.valueOf(this.f39500d.Q1());
                        }
                        if (z12) {
                            this.f39503o.element = Integer.valueOf(this.f39500d.Q1());
                            return;
                        }
                        return;
                    }
    ...
    private static final Map b(List list) {
        c0 e10 = c0.a.e(c0.f37264e, "/", false, 1, null);
    ...
    */
    public static final lu.l0 f(lu.c0 r18, lu.h r19, kotlin.jvm.functions.Function1 r20) {
        /*
            Method dump skipped, instructions count: 440
            To view this dump add '--comments-level debug' option
        */
        throw new UnsupportedOperationException("Method not decompiled: mu.j.f(lu.c0, lu.h, kotlin.jvm.functions.Function1):lu.l0");
    }
    ...
    public static final i g(BufferedSource bufferedSource) {
        ...
        if (bufferedSource.Q1() == 33639248) {
            ...
            if ((N0 & 1) == 0) {
                ...
                String c12 = bufferedSource.c1(bufferedSource.N0() & 65535);
                if (!StringsKt.U(c12, (char) 0, false, 2, null)) {
                    ...
                    return new i(c0.a.e(c0.f37264e, "/", false, 1, null).k(c12), StringsKt.z(c12, "/", false, 2, null), bufferedSource.c1(N06), Q12, longRef.element, longRef2.element, N02, longRef3.element, N04, N03, (Long) objectRef.element, (Long) objectRef2.element, (Long) objectRef3.element, null, null, null, 57344, null);
                }
