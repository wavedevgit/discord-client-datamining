    ...
    */
    private static final java.net.InetAddress c(java.lang.String r16, int r17, int r18) {
        ...
        La2:
            ...
            return r0
        */
        throw new UnsupportedOperationException("Method not decompiled: mu.a.c(java.lang.String, int, int):java.net.InetAddress");
    }
    ...
    private static final String d(byte[] bArr) {
        ...
        while (i11 < bArr.length) {
            if (i11 == i10) {
                ...
                buffer.L1((e.d(bArr[i11], SetSpanOperation.SPAN_MAX_PRIORITY) << 8) | e.d(bArr[i11 + 1], SetSpanOperation.SPAN_MAX_PRIORITY));
                i11 += 2;
            }
        }
        return buffer.X1();
