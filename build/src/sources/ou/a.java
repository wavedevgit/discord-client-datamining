...
public final class a implements Interceptor {
    ...
    public static final C0579a f41252b = new C0579a(null);

    /* renamed from: a  reason: collision with root package name */
    private final okhttp3.b f41253a;
    ...
    public static final class b implements Source {
        ...
        final /* synthetic */ BufferedSource f41255e;

        /* renamed from: i  reason: collision with root package name */
        final /* synthetic */ ou.b f41256i;

        /* renamed from: o  reason: collision with root package name */
        final /* synthetic */ BufferedSink f41257o;

        b(BufferedSource bufferedSource, ou.b bVar, BufferedSink bufferedSink) {
            this.f41255e = bufferedSource;
            this.f41256i = bVar;
            this.f41257o = bufferedSink;
        }

        @Override // okio.Source, java.io.Closeable, java.lang.AutoCloseable
        public void close() {
            if (!this.f41254d && !mu.e.s(this, 100, TimeUnit.MILLISECONDS)) {
                this.f41254d = true;
                this.f41256i.a();
            }
            this.f41255e.close();
        ...
        public long read(Buffer sink, long j10) {
            ...
            try {
                long read = this.f41255e.read(sink, j10);
                if (read == -1) {
                    if (!this.f41254d) {
                        this.f41254d = true;
                        this.f41257o.close();
                ...
                sink.z(this.f41257o.f(), sink.size() - read, read);
                this.f41257o.h0();
                return read;
    ...
    public Response intercept(Interceptor.Chain chain) {
        ...
        if (eVar2 == null || (eVar = eVar2.m()) == null) {
            eVar = okhttp3.e.f40548b;
        }
        if (response != null && a10 == null && (n11 = response.n()) != null) {
            mu.e.m(n11);
        }
        if (b11 == null && a10 == null) {
            Response c10 = new Response.a().r(chain.i()).p(j.HTTP_1_1).g(504).m("Unsatisfiable Request (only-if-cached)").b(mu.e.f36658c).s(-1L).q(System.currentTimeMillis()).c();
            eVar.A(call, c10);
            return c10;
        } else if (b11 == null) {
            Intrinsics.checkNotNull(a10);
            Response c11 = a10.G0().d(f41252b.f(a10)).c();
            eVar.b(call, c11);
            return c11;
        } else {
            if (a10 != null) {
                eVar.a(call, a10);
            } else if (this.f41253a != null) {
                eVar.c(call);
            }
            try {
                ...
                C0579a c0579a2 = f41252b;
                Response c13 = G02.d(c0579a2.f(a10)).n(c0579a2.f(a11)).c();
                if (this.f41253a != null) {
                    if (ru.e.b(c13) && c.f41258c.a(c13, b11)) {
                        Response a12 = a(this.f41253a.n(c13), c13);
                        if (a10 != null) {
                            eVar.c(call);
                        }
                        return a12;
                    } else if (f.f47759a.a(b11.j())) {
                        try {
                            this.f41253a.p(b11);
