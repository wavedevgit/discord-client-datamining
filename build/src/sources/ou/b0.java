...
public final class b0 implements Sink {
    ...
    private final OutputStream f44469d;

    /* renamed from: e  reason: collision with root package name */
    private final Timeout f44470e;

    public b0(OutputStream out, Timeout timeout) {
        Intrinsics.checkNotNullParameter(out, "out");
        Intrinsics.checkNotNullParameter(timeout, "timeout");
        this.f44469d = out;
        this.f44470e = timeout;
    }
    ...
    public void u0(Buffer source, long j10) {
        ...
        while (j10 > 0) {
            ...
            this.f44469d.write(g0Var.f44508a, g0Var.f44509b, min);
            g0Var.f44509b += min;
            long j11 = min;
            j10 -= j11;
