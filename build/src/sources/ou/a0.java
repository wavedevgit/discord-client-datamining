...
public final class a0 extends kotlin.collections.d implements RandomAccess {
    ...
    public static final a f44464o = new a(null);

    /* renamed from: e  reason: collision with root package name */
    private final ByteString[] f44465e;
    ...
    public static final class a {
        ...
        private final void a(long j10, Buffer buffer, int i10, List list, int i11, int i12, List list2) {
            ...
            if (i11 < i12) {
                ...
                if (byteString.k(i16) != byteString2.k(i16)) {
                    int i19 = 1;
                    for (int i20 = i13 + 1; i20 < i12; i20++) {
                        if (((ByteString) list.get(i20 - 1)).k(i16) != ((ByteString) list.get(i20)).k(i16)) {
                            i19++;
                        }
                    }
                    ...
                    for (int i21 = i13; i21 < i12; i21++) {
                        byte k10 = ((ByteString) list.get(i21)).k(i16);
                        if (i21 == i13 || k10 != ((ByteString) list.get(i21 - 1)).k(i16)) {
                            buffer.writeInt(k10 & 255);
                        }
                    }
                    Buffer buffer2 = new Buffer();
                    while (i13 < i12) {
                        byte k11 = ((ByteString) list.get(i13)).k(i16);
                        int i22 = i13 + 1;
                        int i23 = i22;
                        while (true) {
                            if (i23 < i12) {
                                if (k11 != ((ByteString) list.get(i23)).k(i16)) {
                                    i15 = i23;
                                    break;
                                }
                                i23++;
                ...
                int i24 = 0;
                for (int i25 = i16; i25 < min && byteString.k(i25) == byteString2.k(i25); i25++) {
                    i24++;
                }
                ...
                int i26 = i16 + i24;
                while (i16 < i26) {
                    buffer.writeInt(byteString.k(i16) & 255);
                    i16++;
                }
                if (i13 + 1 == i12) {
        ...
        */
        public final ou.a0 d(okio.ByteString... r17) {
            /*
                Method dump skipped, instructions count: 264
                To view this dump add '--comments-level debug' option
            */
            throw new UnsupportedOperationException("Method not decompiled: ou.a0.a.d(okio.ByteString[]):ou.a0");
        }
    ...
    public static final a0 l(ByteString... byteStringArr) {
        return f44464o.d(byteStringArr);
    }

    @Override // kotlin.collections.b
    public int c() {
        return this.f44465e.length;
    }
