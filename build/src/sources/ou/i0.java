...
public final class i0 extends ByteString {
    ...
    private final transient byte[][] f44525q;

    /* renamed from: r  reason: collision with root package name */
    private final transient int[] f44526r;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public i0(byte[][] segments, int[] directory) {
        super(ByteString.f44061p.l());
        Intrinsics.checkNotNullParameter(segments, "segments");
        Intrinsics.checkNotNullParameter(directory, "directory");
        this.f44525q = segments;
        this.f44526r = directory;
    }
    ...
    public void O(Buffer buffer, int i10, int i11) {
        ...
        while (i10 < i13) {
            ...
            if (g0Var2 == null) {
                g0Var.f44514g = g0Var;
                g0Var.f44513f = g0Var;
                buffer.f44049d = g0Var;
            } else {
                Intrinsics.checkNotNull(g0Var2);
                g0 g0Var3 = g0Var2.f44514g;
