...
public final class l0 extends h {
    ...
    private static final a f44530i = new a(null);

    /* renamed from: j  reason: collision with root package name */
    private static final c0 f44531j = c0.a.e(c0.f44472e, "/", false, 1, null);

    /* renamed from: e  reason: collision with root package name */
    private final c0 f44532e;

    /* renamed from: f  reason: collision with root package name */
    private final h f44533f;

    /* renamed from: g  reason: collision with root package name */
    private final Map f44534g;
    ...
    public l0(c0 zipPath, h fileSystem, Map entries, String str) {
        ...
        this.f44532e = zipPath;
        this.f44533f = fileSystem;
        this.f44534g = entries;
        this.f44535h = str;
    }

    private final c0 r(c0 c0Var) {
        return f44531j.m(c0Var, true);
    }

    private final List s(c0 c0Var, boolean z10) {
        pu.i iVar = (pu.i) this.f44534g.get(r(c0Var));
        if (iVar == null) {
            if (!z10) {
                return null;
            }
    ...
    public g m(c0 path) {
        Throwable th2;
        Intrinsics.checkNotNullParameter(path, "path");
        pu.i iVar = (pu.i) this.f44534g.get(r(path));
        Long l10 = null;
        if (iVar == null) {
            return null;
        }
        if (iVar.i() != -1) {
            f n10 = this.f44533f.n(this.f44532e);
            try {
                BufferedSource d10 = x.d(n10.N(iVar.i()));
                iVar = pu.j.j(d10, iVar);
                if (d10 != null) {
                    try {
                        d10.close();
                    } catch (Throwable th3) {
    ...
    public Source q(c0 file) {
        Intrinsics.checkNotNullParameter(file, "file");
        pu.i iVar = (pu.i) this.f44534g.get(r(file));
        if (iVar != null) {
            f n10 = this.f44533f.n(this.f44532e);
            ...
            if (th == 0) {
                pu.j.m(th2);
                if (iVar.e() == 0) {
                    return new pu.g(th2, iVar.j(), true);
                }
                return new pu.g(new o(new pu.g(th2, iVar.d(), true), new Inflater(true)), iVar.j(), false);
            }
            throw th;
        }
