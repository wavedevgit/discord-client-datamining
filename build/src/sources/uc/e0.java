...
public abstract class e0 {
    ...
    public static Metadata c(List list) {
        ...
        for (int i10 = 0; i10 < list.size(); i10++) {
            ...
            if (e12.length != 2) {
                oe.y.i("VorbisUtil", "Failed to parse Vorbis comment: " + str);
            } else if (e12[0].equals("METADATA_BLOCK_PICTURE")) {
                try {
                    arrayList.add(kd.a.a(new h0(Base64.decode(e12[1], 0))));
                } catch (RuntimeException e10) {
                    oe.y.j("VorbisUtil", "Failed to parse vorbis picture", e10);
                }
            } else {
                arrayList.add(new pd.a(e12[0], e12[1]));
            }
        }
    ...
    private static void e(int i10, d0 d0Var) {
        ...
        for (int i12 = 0; i12 < d10; i12++) {
            int d11 = d0Var.d(16);
            if (d11 != 0) {
                oe.y.c("VorbisUtil", "mapping type other than 0 not supported: " + d11);
            } else {
                if (d0Var.c()) {
                    i11 = d0Var.d(4) + 1;
                } else {
