...
public final class p implements ViewBinding {
    ...
    private final ConstraintLayout f30385a;

    /* renamed from: b  reason: collision with root package name */
    public final ConstraintLayout f30386b;

    /* renamed from: c  reason: collision with root package name */
    public final TextInputLayout f30387c;

    /* renamed from: d  reason: collision with root package name */
    public final AutoCompleteTextView f30388d;

    /* renamed from: e  reason: collision with root package name */
    public final TextView f30389e;

    /* renamed from: f  reason: collision with root package name */
    public final TextInputLayout f30390f;

    /* renamed from: g  reason: collision with root package name */
    public final AutoCompleteTextView f30391g;

    /* renamed from: h  reason: collision with root package name */
    public final TextView f30392h;

    /* renamed from: i  reason: collision with root package name */
    public final TextInputLayout f30393i;

    /* renamed from: j  reason: collision with root package name */
    public final TextInputEditText f30394j;
    ...
    private p(ConstraintLayout constraintLayout, ConstraintLayout constraintLayout2, TextInputLayout textInputLayout, AutoCompleteTextView autoCompleteTextView, TextView textView, TextInputLayout textInputLayout2, AutoCompleteTextView autoCompleteTextView2, TextView textView2, TextInputLayout textInputLayout3, TextInputEditText textInputEditText) {
        this.f30385a = constraintLayout;
        this.f30386b = constraintLayout2;
        this.f30387c = textInputLayout;
        this.f30388d = autoCompleteTextView;
        this.f30389e = textView;
        this.f30390f = textInputLayout2;
        this.f30391g = autoCompleteTextView2;
        this.f30392h = textView2;
        this.f30393i = textInputLayout3;
        this.f30394j = textInputEditText;
    }
    ...
    public static p d(LayoutInflater layoutInflater, ViewGroup viewGroup, boolean z10) {
        View inflate = layoutInflater.inflate(eq.f.f22040q, viewGroup, false);
        if (z10) {
