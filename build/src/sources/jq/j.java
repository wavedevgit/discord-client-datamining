...
public final class j implements ViewBinding {
    ...
    private final LinearLayout f30366a;
    ...
    private j(LinearLayout linearLayout, LinearLayout linearLayout2, TextView textView, TextView textView2) {
        ...
        this.f30367b = linearLayout2;
        this.f30368c = textView;
        this.f30369d = textView2;
    }

    public static j a(View view) {
        int i10 = eq.e.f22006r;
    ...
    public static j d(LayoutInflater layoutInflater, ViewGroup viewGroup, boolean z10) {
        View inflate = layoutInflater.inflate(eq.f.f22034k, viewGroup, false);
        if (z10) {
