...
public class a implements q, Closeable {
    ...
    private SharedMemory f52282d;

    /* renamed from: e  reason: collision with root package name */
    private ByteBuffer f52283e;

    /* renamed from: i  reason: collision with root package name */
    private final long f52284i;
    ...
    public a(int i10) {
        ...
        try {
            ...
            this.f52282d = create;
            this.f52283e = create.mapReadWrite();
            this.f52284i = System.identityHashCode(this);
    ...
    private void m(int i10, q qVar, int i11, int i12) {
        if (qVar instanceof a) {
            ...
            this.f52283e.position(i10);
            qVar.r().position(i11);
            byte[] bArr = new byte[i12];
            this.f52283e.get(bArr, 0, i12);
    ...
    public synchronized void close() {
        try {
            if (!isClosed()) {
                SharedMemory sharedMemory = this.f52282d;
                if (sharedMemory != null) {
                    sharedMemory.close();
                }
                ByteBuffer byteBuffer = this.f52283e;
                if (byteBuffer != null) {
