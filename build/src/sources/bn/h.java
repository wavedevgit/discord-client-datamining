...
public final class h {
    ...
    private ReanimatedModule f7546a;
    ...
    public final void a(Event event, ReactContext reactApplicationContext) {
        ...
        if (this.f7546a == null) {
            this.f7546a = (ReanimatedModule) reactApplicationContext.getNativeModule(ReanimatedModule.class);
        }
        ReanimatedModule reanimatedModule = this.f7546a;
