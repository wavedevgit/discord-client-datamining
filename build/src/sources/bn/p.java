...
public final class p extends k implements c {
    ...
    public static final class a extends kotlin.coroutines.jvm.internal.k implements Function2 {
        ...
        final /* synthetic */ o f6924e;

        /* renamed from: i  reason: collision with root package name */
        final /* synthetic */ p f6925i;

        /* renamed from: o  reason: collision with root package name */
        final /* synthetic */ k.a f6926o;
        ...
        public final Continuation create(Object obj, Continuation continuation) {
            return new a(this.f6924e, this.f6925i, this.f6926o, continuation);
        }
    ...
    public p(KType workerType, String key) {
        ...
        this.f6920a = workerType;
        this.f6921b = key;
        this.f6922c = w.n(workerType);
    }

    @Override // bn.c
    public String a() {
        return Intrinsics.stringPlus("worker ", this.f6920a);
    }
