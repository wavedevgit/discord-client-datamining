...
public final class c implements View.OnAttachStateChangeListener {
    ...
    private final CompletableJob f6532e;

    /* renamed from: i  reason: collision with root package name */
    private final CoroutineScope f6533i;
    ...
    public c(CoroutineScope parentCoroutineScope) {
        ...
        a10.C0(new a());
        this.f6532e = a10;
        this.f6533i = kotlinx.coroutines.i.j(parentCoroutineScope, a10);
    }
    ...
    public final void c(Function0 block) {
        ...
        if (kotlinx.coroutines.i.i(this.f6533i)) {
            this.f6531d.add(block);
            return;
        }
    ...
    public void onViewAttachedToWindow(View v10) {
        ...
        List<Function0> list = this.f6531d;
    ...
    public void onViewDetachedFromWindow(View v10) {
        Intrinsics.checkNotNullParameter(v10, "v");
        kotlinx.coroutines.i.e(this.f6533i, "View detached", null, 2, null);
