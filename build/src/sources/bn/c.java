...
public abstract class c {
    ...
    public static final Set f7150a;

    /* renamed from: b  reason: collision with root package name */
    public static final Type[] f7151b;

    /* renamed from: c  reason: collision with root package name */
    public static final Class f7152c;

    /* renamed from: d  reason: collision with root package name */
    private static final Class f7153d;

    /* renamed from: e  reason: collision with root package name */
    private static final Map f7154e;

    /* loaded from: /home/runner/work/discord-client-datamining/discord-client-datamining/build/classes4.dex */
    public static final class a implements GenericArrayType {

        /* renamed from: d  reason: collision with root package name */
        private final Type f7155d;

        public a(Type type) {
            this.f7155d = c.a(type);
        }
        ...
        public int hashCode() {
            return this.f7155d.hashCode();
        }

        public String toString() {
            return c.v(this.f7155d) + "[]";
        }
    }
    ...
    public static final class b implements ParameterizedType {
        ...
        /* renamed from: d  reason: collision with root package name */
        private final Type f7156d;

        /* renamed from: e  reason: collision with root package name */
        private final Type f7157e;

        /* renamed from: i  reason: collision with root package name */
        public final Type[] f7158i;
        ...
        public b(Type type, Type type2, Type... typeArr) {
            ...
            this.f7156d = a10;
            this.f7157e = c.a(type2);
            this.f7158i = (Type[]) typeArr.clone();
            int i10 = 0;
            while (true) {
                Type[] typeArr2 = this.f7158i;
                if (i10 < typeArr2.length) {
                    typeArr2[i10].getClass();
                    c.b(this.f7158i[i10]);
                    Type[] typeArr3 = this.f7158i;
        ...
        public int hashCode() {
            return (Arrays.hashCode(this.f7158i) ^ this.f7157e.hashCode()) ^ c.g(this.f7156d);
        }

        public String toString() {
            StringBuilder sb2 = new StringBuilder((this.f7158i.length + 1) * 30);
            sb2.append(c.v(this.f7157e));
            if (this.f7158i.length == 0) {
                return sb2.toString();
            }
            sb2.append("<");
            sb2.append(c.v(this.f7158i[0]));
            for (int i10 = 1; i10 < this.f7158i.length; i10++) {
                sb2.append(", ");
                sb2.append(c.v(this.f7158i[i10]));
            }
            sb2.append(">");
            return sb2.toString();
        }
    ...
    /* loaded from: /home/runner/work/discord-client-datamining/discord-client-datamining/build/classes4.dex */
    public static final class C0137c implements WildcardType {

        /* renamed from: d  reason: collision with root package name */
        private final Type f7159d;

        /* renamed from: e  reason: collision with root package name */
        private final Type f7160e;

        public C0137c(Type[] typeArr, Type[] typeArr2) {
                ...
                if (typeArr.length == 1) {
                    if (typeArr2.length == 1) {
                        ...
                        if (typeArr[0] == Object.class) {
                            this.f7160e = c.a(typeArr2[0]);
                            this.f7159d = Object.class;
                            return;
                        }
        ...
        public Type[] getLowerBounds() {
            Type type = this.f7160e;
            return type != null ? new Type[]{type} : c.f7151b;
        }

        @Override // java.lang.reflect.WildcardType
        public Type[] getUpperBounds() {
            return new Type[]{this.f7159d};
        }
        ...
        public int hashCode() {
            ...
            return i10 ^ (this.f7159d.hashCode() + 31);
        }

        public String toString() {
            if (this.f7160e != null) {
                return "? super " + c.v(this.f7160e);
            } else if (this.f7159d == Object.class) {
                return "?";
            } else {
                return "? extends " + c.v(this.f7159d);
            }
        }
    }
    ...
    static {
        ...
        L18:
            ...
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: bn.c.<clinit>():void");
    }
    ...
    public static Type a(Type type) {
        if (type instanceof Class) {
            ...
            if (type instanceof C0137c) {
                return type;
            }
            WildcardType wildcardType = (WildcardType) type;
            return new C0137c(wildcardType.getUpperBounds(), wildcardType.getLowerBounds());
        } else {
            return type;
        }
    }
    ...
    public static boolean i(Class cls) {
        Class<? extends Annotation> cls2 = f7153d;
    ...
    public static j o(String str, String str2, m mVar) {
        ...
        String t10 = mVar.t();
        if (str2.equals(str)) {
            format = String.format("Required value '%s' missing at %s", str, t10);
        } else {
            format = String.format("Required value '%s' (JSON name '%s') missing at %s", str, str2, t10);
        }
        return new j(format);
    }
    ...
    */
    private static java.lang.reflect.Type r(java.lang.reflect.Type r8, java.lang.Class r9, java.lang.reflect.Type r10, java.util.Collection r11) {
        ...
        Lbf:
            return r10
        */
        throw new UnsupportedOperationException("Method not decompiled: bn.c.r(java.lang.reflect.Type, java.lang.Class, java.lang.reflect.Type, java.util.Collection):java.lang.reflect.Type");
    }
    ...
    public static j x(String str, String str2, m mVar) {
        ...
        String t10 = mVar.t();
        if (str2.equals(str)) {
            format = String.format("Non-null value '%s' was null at %s", str, t10);
        } else {
            format = String.format("Non-null value '%s' (JSON name '%s') was null at %s", str, str2, t10);
        }
        return new j(format);
    }
}
