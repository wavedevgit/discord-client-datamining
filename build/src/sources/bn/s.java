...
public final class s {
    ...
    public static final a f6933f = new a(null);

    /* renamed from: a  reason: collision with root package name */
    private final kotlin.reflect.b f6934a;

    /* renamed from: b  reason: collision with root package name */
    private final s f6935b;

    /* renamed from: c  reason: collision with root package name */
    private final Function0 f6936c;

    /* renamed from: d  reason: collision with root package name */
    private final Lazy f6937d;

    /* renamed from: e  reason: collision with root package name */
    private final Sequence f6938e;
        ...
        public final s a(ByteString bytes) {
            ...
            try {
                ...
                if (readByte == 0) {
                    ...
                    a10 = s.f6933f.a(buffer.K1());
                } else {
                    throw new IllegalArgumentException("Invalid WorkflowIdentifier");
                }
                return new s(ds.a.e(Class.forName(b10)), a10, null, 4, null);
    ...
    static final class d extends Lambda implements Function0 {
        ...
        public final String invoke() {
            return s.this.f6934a instanceof KClass ? ds.a.b((KClass) s.this.f6934a).getName() : s.this.f6934a.toString();
        }
    }
    ...
    public final String d() {
        Object value = this.f6937d.getValue();
    ...
    public final ByteString e() {
        ...
        if (!(this.f6934a instanceof KClass)) {
            return null;
        }
        s sVar = this.f6935b;
        if (sVar != null) {
    ...
    public boolean equals(Object obj) {
        ...
        s sVar = (s) obj;
        if (Intrinsics.areEqual(this.f6934a, sVar.f6934a) && Intrinsics.areEqual(this.f6935b, sVar.f6935b)) {
            return true;
        }
        return false;
    }
    ...
    public int hashCode() {
        int hashCode;
        int hashCode2 = this.f6934a.hashCode() * 31;
        s sVar = this.f6935b;
        if (sVar == null) {
            hashCode = 0;
        } else {
    ...
    public String toString() {
        String str;
        Function0 function0 = this.f6936c;
        if (function0 == null) {
            str = null;
        } else {
        ...
        if (str == null) {
            String P = kotlin.sequences.k.P(this.f6938e, null, null, null, 0, null, c.f6940d, 31, null);
