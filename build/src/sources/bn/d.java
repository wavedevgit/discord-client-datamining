...
public final class d extends BaseReactPackage implements ViewManagerOnDemandReactPackage {
    ...
    private final Lazy f7544a = l.b(new Function0() { // from class: bn.a
    ...
    private final Map d() {
        return (Map) this.f7544a.getValue();
    }

    /* JADX INFO: Access modifiers changed from: private */
    public static final Map e() {
        return o0.f(v.a(RNGestureHandlerButtonViewManager.REACT_CLASS, ModuleSpec.Companion.viewManagerSpec(new Provider() { // from class: bn.c
    ...
    public ReactModuleInfoProvider getReactModuleInfoProvider() {
        try {
            ...
            return new ReactModuleInfoProvider() { // from class: bn.b
