...
public final class g extends i {
    ...
    private final transient i f26832o;
    ...
    public final int indexOf(Object obj) {
        int lastIndexOf = this.f26832o.lastIndexOf(obj);
        if (lastIndexOf >= 0) {
    ...
    public final int lastIndexOf(Object obj) {
        int indexOf = this.f26832o.indexOf(obj);
        if (indexOf >= 0) {
            return q(indexOf);
        }
        return -1;
