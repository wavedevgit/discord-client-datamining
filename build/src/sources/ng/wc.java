...
public final class wc extends oc {
    ...
    static final oc f41205q = new wc(null, new Object[0], 0);

    /* renamed from: o  reason: collision with root package name */
    final transient Object[] f41206o;

    /* renamed from: p  reason: collision with root package name */
    private final transient int f41207p;
    ...
    @Override // ng.oc
    final la a() {
        return new vc(this.f41206o, 1, this.f41207p);
    }

    @Override // ng.oc
    final pc d() {
        return new tc(this, this.f41206o, 0, this.f41207p);
    }

    @Override // ng.oc
    final pc e() {
        return new uc(this, new vc(this.f41206o, 0, this.f41207p));
    }
    ...
    */
    public final java.lang.Object get(java.lang.Object r5) {
        /*
            r4 = this;
            java.lang.Object[] r0 = r4.f41206o
            int r1 = r4.f41207p
            r2 = 0
            if (r5 != 0) goto L9
        L7:
