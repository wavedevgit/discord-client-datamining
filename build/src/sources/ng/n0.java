...
public final class n0 implements b0 {
    ...
    private ij.b f38442a;

    /* renamed from: b  reason: collision with root package name */
    private final ij.b f38443b;

    /* renamed from: c  reason: collision with root package name */
    private final e0 f38444c;
    ...
    public n0(Context context, e0 e0Var) {
        ...
        if (aVar.a().contains(yb.c.b("json"))) {
            this.f38442a = new xi.w(new ij.b() { // from class: ng.k0
                @Override // ij.b
        ...
        this.f38443b = new xi.w(new ij.b() { // from class: ng.l0
            @Override // ij.b
            public final Object get() {
