...
public final class n0 implements b0 {
    ...
    private ij.b f37873a;

    /* renamed from: b  reason: collision with root package name */
    private final ij.b f37874b;

    /* renamed from: c  reason: collision with root package name */
    private final e0 f37875c;
    ...
    public n0(Context context, e0 e0Var) {
        ...
        if (aVar.a().contains(yb.c.b("json"))) {
            this.f37873a = new xi.w(new ij.b() { // from class: ng.k0
                @Override // ij.b
        ...
        this.f37874b = new xi.w(new ij.b() { // from class: ng.l0
            @Override // ij.b
            public final Object get() {
