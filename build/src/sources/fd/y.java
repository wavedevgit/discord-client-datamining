...
public abstract class y {
    ...
    private static final Pattern f23162a = Pattern.compile("^\\D?(\\d+)$");

    /* renamed from: b  reason: collision with root package name */
    private static final HashMap f23163b = new HashMap();

    /* renamed from: c  reason: collision with root package name */
    private static int f23164c = -1;
    ...
    public static final class b {
        ...
        public boolean equals(Object obj) {
            ...
            if (obj != null && obj.getClass() == b.class) {
                b bVar = (b) obj;
                if (TextUtils.equals(this.f23165a, bVar.f23165a) && this.f23166b == bVar.f23166b && this.f23167c == bVar.f23167c) {
                    return true;
                }
            }
            return false;
        ...
        public int hashCode() {
            int i10;
            int hashCode = (this.f23165a.hashCode() + 31) * 31;
            int i11 = 1237;
            if (this.f23166b) {
                i10 = 1231;
            } else {
    ...
    public static final class f implements d {
        ...
        /* renamed from: b  reason: collision with root package name */
        private MediaCodecInfo[] f23169b;
        ...
        private void f() {
            if (this.f23169b == null) {
                this.f23169b = new MediaCodecList(this.f23168a).getCodecInfos();
            }
        }
    ...
    private static boolean C(MediaCodecInfo mediaCodecInfo) {
        if (w0.f39060a >= 29 && D(mediaCodecInfo)) {
            return true;
        }
        return false;
    }
    ...
    private static boolean E(MediaCodecInfo mediaCodecInfo, String str, boolean z10, String str2) {
        ...
        if (i10 < 18 && "OMX.MTK.AUDIO.DECODER.AAC".equals(str)) {
            ...
            if ("a70".equals(str3) || ("Xiaomi".equals(w0.f39062c) && str3.startsWith("HM"))) {
                return false;
            }
        }
        if (i10 == 16 && "OMX.qcom.audio.decoder.mp3".equals(str)) {
            String str4 = w0.f39061b;
            if ("dlxu".equals(str4) || "protou".equals(str4) || "ville".equals(str4) || "villeplus".equals(str4) || "villec2".equals(str4) || str4.startsWith("gee") || "C6602".equals(str4) || "C6603".equals(str4) || "C6606".equals(str4) || "C6616".equals(str4) || "L36h".equals(str4) || "SO-02E".equals(str4)) {
                return false;
            }
        }
        if (i10 == 16 && "OMX.qcom.audio.decoder.aac".equals(str)) {
            String str5 = w0.f39061b;
            if ("C1504".equals(str5) || "C1505".equals(str5) || "C1604".equals(str5) || "C1605".equals(str5)) {
                return false;
            }
        }
        if (i10 < 24 && (("OMX.SEC.aac.dec".equals(str) || "OMX.Exynos.AAC.Decoder".equals(str)) && "samsung".equals(w0.f39062c))) {
            String str6 = w0.f39061b;
            if (str6.startsWith("zeroflte") || str6.startsWith("zerolte") || str6.startsWith("zenlte") || "SC-05G".equals(str6) || "marinelteatt".equals(str6) || "404SC".equals(str6) || "SC-04G".equals(str6) || "SCV31".equals(str6)) {
                return false;
            }
        }
        if (i10 <= 19 && "OMX.SEC.vp8.dec".equals(str) && "samsung".equals(w0.f39062c)) {
            String str7 = w0.f39061b;
            if (str7.startsWith("d2") || str7.startsWith("serrano") || str7.startsWith("jflte") || str7.startsWith("santos") || str7.startsWith("t0")) {
                return false;
            }
        }
        if (i10 <= 19 && w0.f39061b.startsWith("jflte") && "OMX.qcom.video.decoder.vp8".equals(str)) {
            return false;
        }
    ...
    private static boolean H(MediaCodecInfo mediaCodecInfo, String str) {
        ...
        String e10 = mi.b.e(mediaCodecInfo.getName());
    ...
    public static /* synthetic */ int b(q qVar) {
        ...
        if (!str.startsWith("OMX.google") && !str.startsWith("c2.android")) {
            if (w0.f39060a < 26 && str.equals("OMX.MTK.AUDIO.DECODER.RAW")) {
                return -1;
            }
            return 0;
        }
    ...
    public static /* synthetic */ int c(q qVar) {
        return qVar.f23112a.startsWith("OMX.google") ? 1 : 0;
    }
    ...
    private static void e(String str, List list) {
        if ("audio/raw".equals(str)) {
            if (w0.f39060a < 26 && w0.f39061b.equals("R9") && list.size() == 1 && ((q) list.get(0)).f23112a.equals("OMX.MTK.AUDIO.DECODER.RAW")) {
        ...
        if (i10 < 21 && list.size() > 1) {
            String str2 = ((q) list.get(0)).f23112a;
        ...
        if (i10 < 32 && list.size() > 1 && "OMX.qti.audio.decoder.flac".equals(((q) list.get(0)).f23112a)) {
    ...
    public static String m(Format format) {
        Pair r10;
        if ("audio/eac3-joc".equals(format.f11587w)) {
            return "audio/eac3";
        }
        if ("video/dolby-vision".equals(format.f11587w) && (r10 = r(format)) != null) {
    ...
    private static Pair o(String str, String[] strArr, oe.c cVar) {
        ...
        try {
            ...
            if (parseInt != 0) {
                ...
                if (parseInt3 != 8) {
                    if (cVar != null && (cVar.f41649o != null || (i10 = cVar.f41648i) == 7 || i10 == 6)) {
    ...
    */
    public static android.util.Pair r(com.google.android.exoplayer2.Format r6) {
        /*
            java.lang.String r0 = r6.f11584t
            r1 = 0
            if (r0 != 0) goto L6
            return r1
        L6:
            ...
            java.lang.String r3 = r6.f11587w
            boolean r2 = r2.equals(r3)
            if (r2 == 0) goto L1d
            java.lang.String r6 = r6.f11584t
        ...
        L83:
            ...
            return r6
        L8a:
            java.lang.String r1 = r6.f11584t
            oe.c r6 = r6.I
        ...
        synchronized (y.class) {
            try {
                ...
                if (z10 && u10.isEmpty() && 21 <= i10 && i10 <= 23) {
                    u10 = u(bVar, new e());
                    if (!u10.isEmpty()) {
                        ne.y.i("MediaCodecUtil", "MediaCodecList API didn't list secure decoder for: " + str + ". Assuming: " + ((q) u10.get(0)).f23112a);
                    }
                }
                e(str, u10);
                ni.s o10 = ni.s.o(u10);
    ...
    /* JADX WARN: Code restructure failed: missing block: B:33:0x0088, code lost:
        if (r1.f23166b != r12) goto L61;
     */
    /* JADX WARN: Code restructure failed: missing block: B:41:0x009b, code lost:
        if (r1.f23166b == false) goto L40;
     */
    ...
    */
    ...
    public static List v(t tVar, Format format, boolean z10, boolean z11) {
        List a10 = tVar.a(format.f11587w, z10, z11);
        return ni.s.j().j(a10).j(n(tVar, format, z10, z11)).k();
    }
    ...
    private static Pair y(String str, String[] strArr) {
        ...
        Matcher matcher = f23162a.matcher(strArr[1]);
        if (!matcher.matches()) {
            ne.y.i("MediaCodecUtil", "Ignoring malformed Dolby Vision codec string: " + str);
            return null;
        }
