...
public final class q {
    ...
    private static boolean A(String str) {
        if (w0.f39015d.startsWith("SM-T230") && "OMX.MARVELL.VIDEO.HW.CODA7542DECODER".equals(str)) {
            return true;
        }
        return false;
    }
    ...
    private static boolean E(String str) {
        if ("OMX.MTK.VIDEO.DECODER.HEVC".equals(str) && "mcv5a".equals(w0.f39013b)) {
            return false;
        }
        return true;
    }
    ...
    private static int b(String str, String str2, int i10) {
        int i11;
        if (i10 <= 1 && ((w0.f39012a < 26 || i10 <= 0) && !"audio/mpeg".equals(str2) && !"audio/3gpp".equals(str2) && !"audio/amr-wb".equals(str2) && !"audio/mp4a-latm".equals(str2) && !"audio/vorbis".equals(str2) && !"audio/opus".equals(str2) && !"audio/raw".equals(str2) && !"audio/flac".equals(str2) && !"audio/g711-alaw".equals(str2) && !"audio/g711-mlaw".equals(str2) && !"audio/gsm".equals(str2))) {
    ...
    private static boolean i(MediaCodecInfo.CodecCapabilities codecCapabilities) {
        if (w0.f39012a >= 19 && j(codecCapabilities)) {
            return true;
        }
        return false;
    }
    ...
    private boolean m(Format format, boolean z10) {
        ...
        if (w0.f39012a <= 23 && "video/x-vnd.on2.vp9".equals(this.f23113b) && h10.length == 0) {
            h10 = g(this.f23115d);
        }
    ...
    private static boolean s(MediaCodecInfo.CodecCapabilities codecCapabilities) {
        if (w0.f39012a >= 21 && t(codecCapabilities)) {
            return true;
        }
        return false;
    }
    ...
    private static boolean u(MediaCodecInfo.CodecCapabilities codecCapabilities) {
        if (w0.f39012a >= 21 && v(codecCapabilities)) {
            return true;
        }
        return false;
    }
    ...
    private void x(String str) {
        ne.y.b("MediaCodecInfo", "AssumedSupport [" + str + "] [" + this.f23112a + ", " + this.f23113b + "] [" + w0.f39016e + "]");
    }

    private void y(String str) {
        ne.y.b("MediaCodecInfo", "NoSupport [" + str + "] [" + this.f23112a + ", " + this.f23113b + "] [" + w0.f39016e + "]");
    }
    ...
    public boolean o(Format format) {
        ...
        if (this.f23122k) {
            ...
            return z10;
        } else if (w0.f39012a >= 21 && (((i10 = format.K) != -1 && !l(i10)) || ((i11 = format.J) != -1 && !k(i11)))) {
            return false;
        } else {
            return true;
        }
    ...
    public boolean p() {
        if (w0.f39012a >= 29 && "video/x-vnd.on2.vp9".equals(this.f23113b)) {
