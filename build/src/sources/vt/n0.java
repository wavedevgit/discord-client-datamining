...
public class n0 extends c {
    ...
    private final JsonObject f51926g;

    /* renamed from: h  reason: collision with root package name */
    private final SerialDescriptor f51927h;

    /* renamed from: i  reason: collision with root package name */
    private int f51928i;

    /* renamed from: j  reason: collision with root package name */
    private boolean f51929j;
    ...
    private final boolean H0(SerialDescriptor serialDescriptor, int i10, String str) {
        ...
        if (!Intrinsics.areEqual(g10.getKind(), k.b.f48378a) || (g10.b() && (o0(str) instanceof JsonNull))) {
            return false;
        }
    ...
    @Override // vt.c, tt.q2, kotlinx.serialization.encoding.Decoder
    public boolean D() {
        if (!this.f51929j && super.D()) {
            return true;
        }
        return false;
    }
    ...
    @Override // vt.c, kotlinx.serialization.encoding.Decoder
    public kotlinx.serialization.encoding.c b(SerialDescriptor descriptor) {
        Intrinsics.checkNotNullParameter(descriptor, "descriptor");
        if (descriptor == this.f51927h) {
            Json d10 = d();
            JsonElement p02 = p0();
            String h10 = this.f51927h.h();
            if (p02 instanceof JsonObject) {
                return new n0(d10, (JsonObject) p02, C0(), this.f51927h);
            }
    ...
    @Override // vt.c, tt.q2, kotlinx.serialization.encoding.c
    public void c(SerialDescriptor descriptor) {
        Set set;
        Set l10;
        Intrinsics.checkNotNullParameter(descriptor, "descriptor");
        if (!this.f51880f.k() && !(descriptor.getKind() instanceof st.d)) {
            i0.m(descriptor, d());
            if (!this.f51880f.o()) {
                l10 = tt.q0.a(descriptor);
            } else {
                Set a10 = tt.q0.a(descriptor);
                Map map = (Map) ut.a0.a(d()).a(descriptor, i0.g());
                if (map != null) {
                    set = map.keySet();
                } else {
                    set = null;
    ...
    protected String i0(SerialDescriptor descriptor, int i10) {
        ...
        if (!this.f51880f.o() || D0().keySet().contains(e10)) {
            return e10;
        }
    ...
    public int o(SerialDescriptor descriptor) {
        Intrinsics.checkNotNullParameter(descriptor, "descriptor");
        while (this.f51928i < descriptor.d()) {
            int i10 = this.f51928i;
            this.f51928i = i10 + 1;
            String c02 = c0(descriptor, i10);
            int i11 = this.f51928i - 1;
            this.f51929j = false;
            if (D0().containsKey(c02) || G0(descriptor, i11)) {
                if (!this.f51880f.g() || !H0(descriptor, i11, c02)) {
                    return i11;
                }
            }
        }
