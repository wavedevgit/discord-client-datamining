...
public final class h implements r {
    ...
    public static /* synthetic */ class a {
        ...
        static {
            ...
            try {
                f52418a[v.ABBREVIATED.ordinal()] = 2;
            } catch (NoSuchFieldError unused2) {
            }
            try {
                f52418a[v.SHORT.ordinal()] = 3;
            } catch (NoSuchFieldError unused3) {
            }
            try {
                f52418a[v.NARROW.ordinal()] = 4;
    ...
    private static String F(char c10, v vVar, n nVar) {
        ...
        sb2.append(c10);
        int i10 = a.f52418a[vVar.ordinal()];
        if (i10 != 1) {
            if (i10 != 2 && i10 != 3) {
                if (i10 == 4) {
                    sb2.append('n');
    ...
    @Override // qt.r
    public String C(y0 y0Var, Locale locale) {
    ...
    @Override // qt.r
    public String n(y0 y0Var, Locale locale) {
        return I(locale, y0Var.name().substring(0, 3).toLowerCase() + "-");
    }
    ...
    @Override // qt.x
    public String r(Locale locale, v vVar, int i10) {
        String str;
        int i11;
        if (i10 >= 2) {
