...
public abstract class g0 {
    ...
    public static final Void g(a aVar, String entity) {
        ...
        aVar.w("Trailing comma before the end of JSON " + entity, aVar.f51871a - 1, "Trailing commas are non-complaint JSON and not allowed by default. Use 'allowTrailingCommas = true' in 'Json {}' builder to support them.");
        throw new as.h();
    }
