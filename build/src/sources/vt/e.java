...
public final class e {
    ...
    private static final ConcurrentMap f52403e = new ConcurrentHashMap(32);

    /* renamed from: f  reason: collision with root package name */
    private static final ReferenceQueue f52404f = new ReferenceQueue();

    /* renamed from: a  reason: collision with root package name */
    private final e f52405a;
    ...
    private static class b {
        ...
        public boolean equals(Object obj) {
            ...
            if (obj instanceof b) {
                b bVar = (b) obj;
                if (this.f52410a.equals(bVar.f52410a) && this.f52411b.equals(bVar.f52411b)) {
                    return true;
                }
            }
            return false;
        ...
        public int hashCode() {
            return (this.f52410a.hashCode() << 3) ^ this.f52411b.hashCode();
        }

        public String toString() {
            return this.f52410a + "/" + this.f52411b;
        }
    }
    ...
    private e(g gVar, String str, Locale locale) {
        ...
        while (true) {
            ...
            if (h10 != null) {
                ...
                this.f52406b = Collections.unmodifiableMap(hashMap);
                return;
            }
        }
    }
    ...
    public static e h(String str, Locale locale) {
        ...
        if (!str.isEmpty()) {
            if (locale != null) {
                ...
                a aVar = (a) f52403e.get(bVar);
                if (aVar != null && (eVar = (e) aVar.get()) != null) {
                    return eVar;
                }
                while (true) {
                    Reference poll = f52404f.poll();
                    if (poll == null) {
                        break;
                    }
                    f52403e.remove(((a) poll).f52409a);
                }
                ...
                if (!arrayList.isEmpty()) {
                    ...
                    f52403e.putIfAbsent(bVar, new a(eVar2, bVar));
                    return eVar2;
                }
    ...
    private static e i(String str, Locale locale) {
        ...
        InputStream e10 = nt.d.c().e(nt.d.c().f(substring, e.class, j10), true);
        g gVar = null;
        if (e10 == null) {
            try {
                e10 = nt.d.c().d(e.class, j10, true);
    ...
    public boolean b(String str) {
        if (str != null) {
            e eVar = this;
            while (((String) eVar.f52406b.get(str)) == null) {
                eVar = eVar.f52405a;
                if (eVar == null) {
                    return false;
                }
    ...
    public String f(String str) {
        if (str != null) {
            e eVar = this;
            do {
                String str2 = (String) eVar.f52406b.get(str);
                if (str2 != null) {
                    return str2;
                }
                eVar = eVar.f52405a;
            } while (eVar != null);
            throw new MissingResourceException("Cannot find property resource for: " + j(this.f52407c, this.f52408d) + "=>" + str, e.class.getName(), str);
        }
        throw new NullPointerException("Missing resource key.");
    }

    public Set g() {
        HashSet hashSet = new HashSet(this.f52406b.keySet());
        e eVar = this;
        while (true) {
            eVar = eVar.f52405a;
            if (eVar != null) {
                hashSet.addAll(eVar.f52406b.keySet());
            } else {
    ...
    private e(e eVar, e eVar2) {
        this.f52405a = eVar2;
        this.f52407c = eVar.f52407c;
        this.f52408d = eVar.f52408d;
        this.f52406b = eVar.f52406b;
    }
}
