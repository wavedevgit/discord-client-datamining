...
public final class m0 implements z {
    ...
    private char[] f51923a = h.f51899c.d();
    ...
    private final void d(int i10, int i11, String str) {
        ...
        while (i10 < length) {
            ...
            if (charAt < c1.a().length) {
                ...
                if (b10 == 0) {
                    i12 = f10 + 1;
                    this.f51923a[f10] = charAt;
                } else {
                    if (b10 == 1) {
                        String str2 = c1.b()[charAt];
                        Intrinsics.checkNotNull(str2);
                        int f11 = f(f10, str2.length());
                        str2.getChars(0, str2.length(), this.f51923a, f11);
                        i11 = f11 + str2.length();
                        this.f51924b = i11;
                    } else {
                        char[] cArr = this.f51923a;
                        cArr[f10] = '\\';
                        cArr[f10 + 1] = (char) b10;
                        i11 = f10 + 2;
                        this.f51924b = i11;
    ...
    public void c(String text) {
        ...
        e(length);
        text.getChars(0, text.length(), this.f51923a, this.f51924b);
        this.f51924b += length;
    }

    public void g() {
        h.f51899c.c(this.f51923a);
    }

    public String toString() {
        return new String(this.f51923a, 0, this.f51924b);
    }
