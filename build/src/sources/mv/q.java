...
public final class q implements lu.b, o {

    /* renamed from: a  reason: collision with root package name */
    public static final q f39465a = new q();
    ...
    private final String a(r rVar) {
        s b10 = rVar.b();
        if (Intrinsics.areEqual(b10, s.c.f39471a)) {
            return StringsKt.n1(rVar.c(), rVar.a());
        }
        if (Intrinsics.areEqual(b10, s.b.f39470a)) {
            return StringsKt.m1(rVar.c(), rVar.a());
        }
        if (Intrinsics.areEqual(b10, s.a.f39469a)) {
