...
public final class f {
    ...
    public static final Response c(c cVar, Interceptor.Chain chain) {
        ...
        if ((Intrinsics.areEqual(CollectionsKt.z0(g10.n().n()), "transition") || Intrinsics.areEqual(CollectionsKt.z0(g10.n().n()), "government-id-classification")) && c10 != null && cVar.c()) {
            String a10 = c.f35150d.a(cVar.a());
            ...
            if (Intrinsics.areEqual(str, "form-data")) {
                ...
                return chain.a(g10.k().g(g10.j(), e10.a("meta[workflowInitialVariables][debugForcedStatus]", a10).d()).b());
            } else if (Intrinsics.areEqual(str, "json")) {
                Buffer buffer = new Buffer();
                c10.writeTo(buffer);
                JSONObject jSONObject = new JSONObject(buffer.S1());
                ...
                return chain.a(g10.k().g(g10.j(), companion.b(jSONObject2, c10.contentType())).b());
            } else {
                return chain.a(g10);
            }
        }
    ...
    public final Interceptor b(final c flags) {
        ...
        return new Interceptor() { // from class: kp.e
