...
public final class PublicSuffixDatabase {
    ...
    private static final byte[] f42323f = {42};

    /* renamed from: g  reason: collision with root package name */
    private static final List f42324g = CollectionsKt.e("*");

    /* renamed from: h  reason: collision with root package name */
    private static final PublicSuffixDatabase f42325h = new PublicSuffixDatabase();

    /* renamed from: a  reason: collision with root package name */
    private final AtomicBoolean f42326a = new AtomicBoolean(false);

    /* renamed from: b  reason: collision with root package name */
    private final CountDownLatch f42327b = new CountDownLatch(1);

    /* renamed from: c  reason: collision with root package name */
    private byte[] f42328c;
    ...
    public static final class a {
        ...
        public final PublicSuffixDatabase c() {
            return PublicSuffixDatabase.f42325h;
        }
    ...
    private final List b(List list) {
        ...
        List l10;
        List l11;
        if (!this.f42326a.get() && this.f42326a.compareAndSet(false, true)) {
            e();
        } else {
            try {
                this.f42327b.await();
    ...
    private final void d() {
        try {
            ...
            if (resourceAsStream != null) {
                ...
                objectRef.element = d10.I0(d10.readInt());
                objectRef2.element = d10.I0(d10.readInt());
                Unit unit = Unit.f31765a;
                c.a(d10, null);
                synchronized (this) {
                    T t10 = objectRef.element;
                    Intrinsics.checkNotNull(t10);
                    this.f42328c = (byte[]) t10;
                    T t11 = objectRef2.element;
                    Intrinsics.checkNotNull(t11);
                    this.f42329d = (byte[]) t11;
                }
            }
        } finally {
            this.f42327b.countDown();
        }
    }
        ...
        while (true) {
            try {
                try {
                    ...
                    h.f37655a.g().k("Failed to read public suffix list", 5, e10);
                    if (!z10) {
                        return;
                    }
                }
