...
public final class PublicSuffixDatabase {
    ...
    public static final a f44488e = new a(null);

    /* renamed from: f  reason: collision with root package name */
    private static final byte[] f44489f = {42};

    /* renamed from: g  reason: collision with root package name */
    private static final List f44490g = CollectionsKt.e("*");

    /* renamed from: h  reason: collision with root package name */
    private static final PublicSuffixDatabase f44491h = new PublicSuffixDatabase();

    /* renamed from: a  reason: collision with root package name */
    private final AtomicBoolean f44492a = new AtomicBoolean(false);

    /* renamed from: b  reason: collision with root package name */
    private final CountDownLatch f44493b = new CountDownLatch(1);

    /* renamed from: c  reason: collision with root package name */
    private byte[] f44494c;

    /* renamed from: d  reason: collision with root package name */
    private byte[] f44495d;
    ...
    public static final class a {
        ...
        public final PublicSuffixDatabase c() {
            return PublicSuffixDatabase.f44491h;
        }
    ...
    private final List b(List list) {
        ...
        List l10;
        List l11;
        if (!this.f44492a.get() && this.f44492a.compareAndSet(false, true)) {
            e();
        } else {
            try {
                this.f44493b.await();
        ...
        try {
            ...
            if (resourceAsStream != null) {
                ...
                synchronized (this) {
                    ...
                    this.f44494c = (byte[]) t10;
                    T t11 = objectRef2.element;
                    Intrinsics.checkNotNull(t11);
                    this.f44495d = (byte[]) t11;
                }
            }
        } finally {
            this.f44493b.countDown();
        }
    }
        ...
        while (true) {
            try {
                try {
                    ...
                    h.f23247a.g().k("Failed to read public suffix list", 5, e10);
                    if (!z10) {
                        return;
                    }
                }
