    ...
    public static final class a {
        ...
        private final List c(Certificate[] certificateArr) {
            if (certificateArr != null) {
                return ut.e.w(Arrays.copyOf(certificateArr, certificateArr.length));
            }
        ...
        public final g b(h tlsVersion, c cipherSuite, List peerCertificates, List localCertificates) {
            ...
            return new g(tlsVersion, cipherSuite, ut.e.V(localCertificates), new C0540a(ut.e.V(peerCertificates)));
        }
