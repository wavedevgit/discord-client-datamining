...
public final class h0 {
    ...
    private static final char[] f40112d = {'\r', '\n'};

    /* renamed from: e  reason: collision with root package name */
    private static final char[] f40113e = {'\n'};

    /* renamed from: f  reason: collision with root package name */
    private static final ji.u f40114f = ji.u.v(ii.d.f28405a, ii.d.f28407c, ii.d.f28410f, ii.d.f28408d, ii.d.f28409e);

    /* renamed from: a  reason: collision with root package name */
    private byte[] f40115a;
    ...
    public h0() {
        this.f40115a = w0.f40202f;
    }

    private void W(Charset charset) {
        if (m(charset, f40112d) == '\r') {
            m(charset, f40113e);
        }
    }
    ...
    private int d(Charset charset) {
        int i10;
        if (!charset.equals(ii.d.f28407c) && !charset.equals(ii.d.f28405a)) {
            if (!charset.equals(ii.d.f28410f) && !charset.equals(ii.d.f28409e) && !charset.equals(ii.d.f28408d)) {
        ...
        while (true) {
            ...
            if (i11 < i12 - (i10 - 1)) {
                if ((charset.equals(ii.d.f28407c) || charset.equals(ii.d.f28405a)) && w0.F0(this.f40115a[i11])) {
                    break;
                }
                if (charset.equals(ii.d.f28410f) || charset.equals(ii.d.f28408d)) {
                    byte[] bArr = this.f40115a;
                    if (bArr[i11] == 0 && w0.F0(bArr[i11 + 1])) {
                        break;
                    }
                }
                if (charset.equals(ii.d.f28409e)) {
                    byte[] bArr2 = this.f40115a;
    ...
    private int i(Charset charset) {
        ...
        char c10;
        int i10 = 1;
        if ((charset.equals(ii.d.f28407c) || charset.equals(ii.d.f28405a)) && a() >= 1) {
            a10 = (byte) li.b.a(li.h.b(this.f40115a[this.f40116b]));
        } else {
            if ((charset.equals(ii.d.f28410f) || charset.equals(ii.d.f28408d)) && a() >= 2) {
                byte[] bArr = this.f40115a;
                int i11 = this.f40116b;
                c10 = li.b.c(bArr[i11], bArr[i11 + 1]);
            } else if (charset.equals(ii.d.f28409e) && a() >= 2) {
                byte[] bArr2 = this.f40115a;
                int i12 = this.f40116b;
    ...
    public String C(int i10) {
        ...
        int i12 = this.f40116b;
        int i13 = (i12 + i10) - 1;
        if (i13 < this.f40117c && this.f40115a[i13] == 0) {
            i11 = i10 - 1;
        } else {
            i11 = i10;
        }
        String F = w0.F(this.f40115a, i12, i11);
        this.f40116b += i10;
        return F;
    }
    ...
    public String E(int i10) {
        return F(i10, ii.d.f28407c);
    }

    public String F(int i10, Charset charset) {
        String str = new String(this.f40115a, this.f40116b, i10, charset);
        this.f40116b += i10;
        return str;
    }
    ...
    public long O() {
        ...
        byte b10;
        int i12;
        long j10 = this.f40115a[this.f40116b];
        int i13 = 7;
        while (true) {
            if (i13 < 0) {
                break;
        ...
        if (i11 != 0) {
            for (i10 = 1; i10 < i11; i10++) {
                if ((this.f40115a[this.f40116b + i10] & 192) == 128) {
                    j10 = (j10 << 6) | (b10 & 63);
                } else {
    ...
    public void T(int i10) {
        boolean z10;
        if (i10 >= 0 && i10 <= this.f40115a.length) {
            z10 = true;
        } else {
            z10 = false;
        }
    ...
    public int a() {
        return this.f40117c - this.f40116b;
    }
    ...
    public void c(int i10) {
        if (i10 > b()) {
            this.f40115a = Arrays.copyOf(this.f40115a, i10);
        }
    }
    ...
    public char h(Charset charset) {
        boolean contains = f40114f.contains(charset);
        a.b(contains, "Unsupported charset: " + charset);
        return (char) (i(charset) >> 16);
    }

    public int j() {
        return this.f40115a[this.f40116b] & 255;
    }

    public void k(g0 g0Var, int i10) {
        l(g0Var.f40106a, 0, i10);
        g0Var.p(0);
    }

    public void l(byte[] bArr, int i10, int i11) {
        System.arraycopy(this.f40115a, this.f40116b, bArr, i10, i11);
        this.f40116b += i11;
    }
    ...
    public String n(char c10) {
        ...
        int i10 = this.f40116b;
        while (i10 < this.f40117c && this.f40115a[i10] != c10) {
            i10++;
        }
        byte[] bArr = this.f40115a;
        int i11 = this.f40116b;
    ...
    public String t(Charset charset) {
        ...
        if (!charset.equals(ii.d.f28405a)) {
            P();
        }
        String F = F(d(charset) - this.f40116b, charset);
        if (this.f40116b == this.f40117c) {
            return F;
        }
        W(charset);
        return F;
    ...
    public h0(int i10) {
        this.f40115a = new byte[i10];
        this.f40117c = i10;
    }

    public h0(byte[] bArr) {
        this.f40115a = bArr;
        this.f40117c = bArr.length;
    }
