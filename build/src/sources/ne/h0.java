...
public final class h0 {
    ...
    private static final char[] f40194d = {'\r', '\n'};

    /* renamed from: e  reason: collision with root package name */
    private static final char[] f40195e = {'\n'};

    /* renamed from: f  reason: collision with root package name */
    private static final ji.u f40196f = ji.u.v(ii.d.f28519a, ii.d.f28521c, ii.d.f28524f, ii.d.f28522d, ii.d.f28523e);

    /* renamed from: a  reason: collision with root package name */
    private byte[] f40197a;
    ...
    public h0() {
        this.f40197a = w0.f40284f;
    }

    private void W(Charset charset) {
        if (m(charset, f40194d) == '\r') {
            m(charset, f40195e);
        }
    }
    ...
    private int d(Charset charset) {
        int i10;
        if (!charset.equals(ii.d.f28521c) && !charset.equals(ii.d.f28519a)) {
            if (!charset.equals(ii.d.f28524f) && !charset.equals(ii.d.f28523e) && !charset.equals(ii.d.f28522d)) {
        ...
        while (true) {
            ...
            if (i11 < i12 - (i10 - 1)) {
                if ((charset.equals(ii.d.f28521c) || charset.equals(ii.d.f28519a)) && w0.F0(this.f40197a[i11])) {
                    break;
                }
                if (charset.equals(ii.d.f28524f) || charset.equals(ii.d.f28522d)) {
                    byte[] bArr = this.f40197a;
                    if (bArr[i11] == 0 && w0.F0(bArr[i11 + 1])) {
                        break;
                    }
                }
                if (charset.equals(ii.d.f28523e)) {
    ...
    private int i(Charset charset) {
        ...
        char c10;
        int i10 = 1;
        if ((charset.equals(ii.d.f28521c) || charset.equals(ii.d.f28519a)) && a() >= 1) {
            a10 = (byte) li.b.a(li.h.b(this.f40197a[this.f40198b]));
        } else {
            if ((charset.equals(ii.d.f28524f) || charset.equals(ii.d.f28522d)) && a() >= 2) {
                byte[] bArr = this.f40197a;
                int i11 = this.f40198b;
                c10 = li.b.c(bArr[i11], bArr[i11 + 1]);
            } else if (charset.equals(ii.d.f28523e) && a() >= 2) {
                byte[] bArr2 = this.f40197a;
    ...
    public String C(int i10) {
        ...
        int i12 = this.f40198b;
        int i13 = (i12 + i10) - 1;
        if (i13 < this.f40199c && this.f40197a[i13] == 0) {
            i11 = i10 - 1;
        } else {
            i11 = i10;
        }
        String F = w0.F(this.f40197a, i12, i11);
        this.f40198b += i10;
        return F;
    }
    ...
    public String E(int i10) {
        return F(i10, ii.d.f28521c);
    }

    public String F(int i10, Charset charset) {
        String str = new String(this.f40197a, this.f40198b, i10, charset);
        this.f40198b += i10;
        return str;
    }
    ...
    public long O() {
        ...
        byte b10;
        int i12;
        long j10 = this.f40197a[this.f40198b];
        int i13 = 7;
        while (true) {
            if (i13 < 0) {
                break;
        ...
        if (i11 != 0) {
            for (i10 = 1; i10 < i11; i10++) {
                if ((this.f40197a[this.f40198b + i10] & 192) == 128) {
                    j10 = (j10 << 6) | (b10 & 63);
                } else {
    ...
    public void T(int i10) {
        boolean z10;
        if (i10 >= 0 && i10 <= this.f40197a.length) {
            z10 = true;
        } else {
            z10 = false;
        }
    ...
    public int a() {
        return this.f40199c - this.f40198b;
    }

    public int b() {
        return this.f40197a.length;
    }

    public void c(int i10) {
        if (i10 > b()) {
            this.f40197a = Arrays.copyOf(this.f40197a, i10);
        }
    }
    ...
    public char h(Charset charset) {
        boolean contains = f40196f.contains(charset);
        a.b(contains, "Unsupported charset: " + charset);
        return (char) (i(charset) >> 16);
    }

    public int j() {
        return this.f40197a[this.f40198b] & 255;
    }

    public void k(g0 g0Var, int i10) {
        l(g0Var.f40188a, 0, i10);
        g0Var.p(0);
    }

    public void l(byte[] bArr, int i10, int i11) {
        System.arraycopy(this.f40197a, this.f40198b, bArr, i10, i11);
        this.f40198b += i11;
    }
    ...
    public String n(char c10) {
        ...
        int i10 = this.f40198b;
        while (i10 < this.f40199c && this.f40197a[i10] != c10) {
            i10++;
        }
        byte[] bArr = this.f40197a;
        int i11 = this.f40198b;
    ...
    public String t(Charset charset) {
        ...
        if (!charset.equals(ii.d.f28519a)) {
            P();
        }
        String F = F(d(charset) - this.f40198b, charset);
        if (this.f40198b == this.f40199c) {
            return F;
        }
        W(charset);
        return F;
