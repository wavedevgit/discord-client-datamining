...
public final class h0 {
    ...
    private static final char[] f40210d = {'\r', '\n'};

    /* renamed from: e  reason: collision with root package name */
    private static final char[] f40211e = {'\n'};

    /* renamed from: f  reason: collision with root package name */
    private static final ji.u f40212f = ji.u.v(ii.d.f28535a, ii.d.f28537c, ii.d.f28540f, ii.d.f28538d, ii.d.f28539e);

    /* renamed from: a  reason: collision with root package name */
    private byte[] f40213a;
    ...
    public h0() {
        this.f40213a = w0.f40300f;
    }

    private void W(Charset charset) {
        if (m(charset, f40210d) == '\r') {
            m(charset, f40211e);
        }
    }
    ...
    private int d(Charset charset) {
        int i10;
        if (!charset.equals(ii.d.f28537c) && !charset.equals(ii.d.f28535a)) {
            if (!charset.equals(ii.d.f28540f) && !charset.equals(ii.d.f28539e) && !charset.equals(ii.d.f28538d)) {
        ...
        int i11 = this.f40214b;
        while (true) {
            int i12 = this.f40215c;
            if (i11 < i12 - (i10 - 1)) {
                if ((charset.equals(ii.d.f28537c) || charset.equals(ii.d.f28535a)) && w0.F0(this.f40213a[i11])) {
                    break;
                }
                if (charset.equals(ii.d.f28540f) || charset.equals(ii.d.f28538d)) {
                    byte[] bArr = this.f40213a;
                    if (bArr[i11] == 0 && w0.F0(bArr[i11 + 1])) {
                        break;
                    }
                }
                if (charset.equals(ii.d.f28539e)) {
                    byte[] bArr2 = this.f40213a;
    ...
    private int i(Charset charset) {
        ...
        char c10;
        int i10 = 1;
        if ((charset.equals(ii.d.f28537c) || charset.equals(ii.d.f28535a)) && a() >= 1) {
            a10 = (byte) li.b.a(li.h.b(this.f40213a[this.f40214b]));
        } else {
            if ((charset.equals(ii.d.f28540f) || charset.equals(ii.d.f28538d)) && a() >= 2) {
                byte[] bArr = this.f40213a;
                int i11 = this.f40214b;
                c10 = li.b.c(bArr[i11], bArr[i11 + 1]);
            } else if (charset.equals(ii.d.f28539e) && a() >= 2) {
                byte[] bArr2 = this.f40213a;
                int i12 = this.f40214b;
    ...
    public String C(int i10) {
        ...
        int i12 = this.f40214b;
        int i13 = (i12 + i10) - 1;
        if (i13 < this.f40215c && this.f40213a[i13] == 0) {
            i11 = i10 - 1;
        } else {
            i11 = i10;
        }
        String F = w0.F(this.f40213a, i12, i11);
        this.f40214b += i10;
        return F;
    }
    ...
    public String E(int i10) {
        return F(i10, ii.d.f28537c);
    }

    public String F(int i10, Charset charset) {
        String str = new String(this.f40213a, this.f40214b, i10, charset);
        this.f40214b += i10;
        return str;
    }
    ...
    public long O() {
        ...
        byte b10;
        int i12;
        long j10 = this.f40213a[this.f40214b];
        int i13 = 7;
        while (true) {
            if (i13 < 0) {
                break;
        ...
        if (i11 != 0) {
            for (i10 = 1; i10 < i11; i10++) {
                if ((this.f40213a[this.f40214b + i10] & 192) == 128) {
                    j10 = (j10 << 6) | (b10 & 63);
                } else {
    ...
    public void T(int i10) {
        boolean z10;
        if (i10 >= 0 && i10 <= this.f40213a.length) {
            z10 = true;
        } else {
            z10 = false;
        }
    ...
    public int a() {
        return this.f40215c - this.f40214b;
    }

    public int b() {
        return this.f40213a.length;
    }

    public void c(int i10) {
        if (i10 > b()) {
            this.f40213a = Arrays.copyOf(this.f40213a, i10);
        }
    }
    ...
    public char h(Charset charset) {
        boolean contains = f40212f.contains(charset);
        a.b(contains, "Unsupported charset: " + charset);
        return (char) (i(charset) >> 16);
    }

    public int j() {
        return this.f40213a[this.f40214b] & 255;
    }

    public void k(g0 g0Var, int i10) {
        l(g0Var.f40204a, 0, i10);
        g0Var.p(0);
    }

    public void l(byte[] bArr, int i10, int i11) {
        System.arraycopy(this.f40213a, this.f40214b, bArr, i10, i11);
        this.f40214b += i11;
    }
    ...
    public String n(char c10) {
        ...
        int i10 = this.f40214b;
        while (i10 < this.f40215c && this.f40213a[i10] != c10) {
            i10++;
        }
        byte[] bArr = this.f40213a;
        int i11 = this.f40214b;
    ...
    public String t(Charset charset) {
        ...
        if (!charset.equals(ii.d.f28535a)) {
            P();
        }
        String F = F(d(charset) - this.f40214b, charset);
        if (this.f40214b == this.f40215c) {
            return F;
        }
        W(charset);
        return F;
    ...
    public h0(int i10) {
        this.f40213a = new byte[i10];
        this.f40215c = i10;
    }

    public h0(byte[] bArr) {
        this.f40213a = bArr;
        this.f40215c = bArr.length;
    }
