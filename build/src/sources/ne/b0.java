...
public abstract class b0 {
    ...
    public static void b(MediaFormat mediaFormat, oe.c cVar) {
        if (cVar != null) {
            d(mediaFormat, "color-transfer", cVar.f41648i);
            d(mediaFormat, "color-standard", cVar.f41646d);
            d(mediaFormat, "color-range", cVar.f41647e);
            a(mediaFormat, "hdr-static-info", cVar.f41649o);
        }
    }
