...
public abstract class x {
    ...
    private static final CoroutineContext d(CoroutineContext coroutineContext, CoroutineContext coroutineContext2, final boolean z10) {
        ...
        if (!h10 && !h11) {
            return coroutineContext.Z0(coroutineContext2);
        }
        final Ref.ObjectRef objectRef = new Ref.ObjectRef();
        objectRef.element = coroutineContext2;
        kotlin.coroutines.e eVar = kotlin.coroutines.e.f33148d;
        CoroutineContext coroutineContext3 = (CoroutineContext) coroutineContext.A1(eVar, new Function2() { // from class: hs.v
        ...
        if (h11) {
            objectRef.element = ((CoroutineContext) objectRef.element).A1(eVar, new Function2() { // from class: hs.w
                @Override // kotlin.jvm.functions.Function2
                public final Object invoke(Object obj, Object obj2) {
        ...
        return coroutineContext3.Z0((CoroutineContext) objectRef.element);
    }
    ...
    public static final CoroutineContext e(Ref.ObjectRef objectRef, boolean z10, CoroutineContext coroutineContext, CoroutineContext.Element element) {
        return coroutineContext.Z0(element);
    }
    ...
    private static final boolean h(CoroutineContext coroutineContext) {
        return ((Boolean) coroutineContext.A1(Boolean.FALSE, new Function2() { // from class: hs.u
            @Override // kotlin.jvm.functions.Function2
            public final Object invoke(Object obj, Object obj2) {
                boolean i10;
    ...
    public static final CoroutineContext k(CoroutineScope coroutineScope, CoroutineContext coroutineContext) {
        ...
        if (d10 != m0.a() && d10.l(kotlin.coroutines.d.f33146h) == null) {
            return d10.Z0(m0.a());
        }
        return d10;
    }
    ...
    public static final u1 m(Continuation continuation, CoroutineContext coroutineContext, Object obj) {
        if (!(continuation instanceof CoroutineStackFrame) || coroutineContext.l(v1.f27955d) == null) {
            return null;
        }
