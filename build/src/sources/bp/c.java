...
public final class c extends FrameLayout {
    ...
    private final wo.b f6961d;

    /* renamed from: e  reason: collision with root package name */
    private final e f6962e;

    /* loaded from: /home/runner/work/discord-client-datamining/discord-client-datamining/build/classes4.dex */
    public static final class a implements c0 {

        /* renamed from: a  reason: collision with root package name */
        private final /* synthetic */ f f6963a;

        /* JADX INFO: Access modifiers changed from: package-private */
        /* renamed from: bp.c$a$a  reason: collision with other inner class name */
        /* loaded from: /home/runner/work/discord-client-datamining/discord-client-datamining/build/classes4.dex */
        public /* synthetic */ class C0111a extends FunctionReferenceImpl implements Function2 {
            C0111a(Object obj) {
        ...
        public View a(d initialRendering, a0 initialViewEnvironment, Context contextForNewView, ViewGroup viewGroup) {
            ...
            return this.f6963a.a(initialRendering, initialViewEnvironment, contextForNewView, viewGroup);
        }

        @Override // dn.c0
        public KClass getType() {
            return this.f6963a.getType();
        }

        private a() {
            this.f6963a = new f(Reflection.getOrCreateKotlinClass(d.class), new Function4() { // from class: bp.b
    ...
    private final View b(d dVar, a0 a0Var) {
        ...
        if (currentView != null) {
            ...
            if (view != null) {
                this.f6962e.d(CollectionsKt.e(nVar));
        ...
        View c11 = f0.c((e0) a0Var.a(e0.f20867a), nVar, a0Var, context, this, new h0() { // from class: bp.a
            @Override // dn.h0
    ...
    public static final void c(View view, Function0 doStart) {
        ...
        d.a.e(en.d.f21675f, view, null, 2, null);
        doStart.invoke();
    }
    ...
    protected void onAttachedToWindow() {
        ...
        this.f6962e.a(g.a.b(aVar, c10, null, 2, null), c11);
    }
    ...
    protected Parcelable onSaveInstanceState() {
        ...
        if (onSaveInstanceState != null) {
            return new b(onSaveInstanceState, this.f6962e.g());
        }
        return null;
    }
    ...
    public static final class b extends View.BaseSavedState {
        ...
        public void writeToParcel(Parcel out, int i10) {
            ...
            out.writeParcelable(this.f6964d, i10);
        }
        ...
        public b(Parcel source) {
            ...
            this.f6964d = (e.a) readParcelable;
        }
    }
    ...
    public c(Context context, AttributeSet attributeSet, int i10, int i11) {
        ...
        Intrinsics.checkNotNullParameter(context, "context");
        wo.b b10 = wo.b.b(LayoutInflater.from(context), this);
