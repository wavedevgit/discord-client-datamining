...
abstract class d {
    ...
    private static final char[] f53638a = "0123456789ABCDEFGHIJKLMNOPQRSTUVWXYZ $%*+-./:".toCharArray();
    ...
    static /* synthetic */ class a {
        ...
        static {
            ...
            try {
                f53639a[h.ALPHANUMERIC.ordinal()] = 2;
            } catch (NoSuchFieldError unused2) {
            }
            try {
                f53639a[h.BYTE.ordinal()] = 3;
            } catch (NoSuchFieldError unused3) {
            }
            try {
                f53639a[h.KANJI.ordinal()] = 4;
            } catch (NoSuchFieldError unused4) {
            }
            try {
                f53639a[h.TERMINATOR.ordinal()] = 5;
            } catch (NoSuchFieldError unused5) {
            }
            try {
                f53639a[h.FNC1_FIRST_POSITION.ordinal()] = 6;
            } catch (NoSuchFieldError unused6) {
            }
            try {
                f53639a[h.FNC1_SECOND_POSITION.ordinal()] = 7;
            } catch (NoSuchFieldError unused7) {
            }
            try {
                f53639a[h.STRUCTURED_APPEND.ordinal()] = 8;
            } catch (NoSuchFieldError unused8) {
            }
            try {
                f53639a[h.ECI.ordinal()] = 9;
            } catch (NoSuchFieldError unused9) {
            }
            try {
                f53639a[h.HANZI.ordinal()] = 10;
    ...
    private static void d(gk.c cVar, StringBuilder sb2, int i10) {
        ...
        if (n.f27130c != null) {
            if (i10 * 13 <= cVar.a()) {
                ...
                sb2.append(new String(bArr, n.f27130c));
                return;
            }
            throw ck.g.a();
        }
    ...
    private static void e(gk.c cVar, StringBuilder sb2, int i10) {
        ...
        if (n.f27129b != null) {
            if (i10 * 13 <= cVar.a()) {
                ...
                sb2.append(new String(bArr, n.f27129b));
                return;
            }
            throw ck.g.a();
        }
