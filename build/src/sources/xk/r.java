...
abstract class r {
    ...
    private static final Map f55065a;

    /* renamed from: b  reason: collision with root package name */
    private static final Map f55066b;

    /* renamed from: c  reason: collision with root package name */
    private static final Map f55067c;
    ...
    static {
        ...
        for (int i10 = 90; i10 <= 99; i10++) {
            f55065a.put(String.valueOf(i10), a.b(30));
        }
        ...
        for (int i11 = 310; i11 <= 316; i11++) {
            f55067c.put(String.valueOf(i11), a.a(6));
        }
        for (int i12 = 320; i12 <= 337; i12++) {
            f55067c.put(String.valueOf(i12), a.a(6));
        }
        for (int i13 = 340; i13 <= 357; i13++) {
            f55067c.put(String.valueOf(i13), a.a(6));
        }
        for (int i14 = 360; i14 <= 369; i14++) {
            f55067c.put(String.valueOf(i14), a.a(6));
        }
        Map map = f55067c;
        map.put("390", a.b(15));
        map.put("391", a.b(18));
    ...
    public static String a(String str) {
        ...
        if (str.length() >= 2) {
            a aVar = (a) f55065a.get(str.substring(0, 2));
            if (aVar != null) {
                if (aVar.f55069a) {
                    return c(2, aVar.f55070b, str);
                }
                return b(2, aVar.f55070b, str);
            } else if (str.length() >= 3) {
                String substring = str.substring(0, 3);
                a aVar2 = (a) f55066b.get(substring);
                if (aVar2 != null) {
                    if (aVar2.f55069a) {
                        return c(3, aVar2.f55070b, str);
                    }
                    return b(3, aVar2.f55070b, str);
                } else if (str.length() >= 4) {
                    a aVar3 = (a) f55067c.get(substring);
                    if (aVar3 != null) {
                        if (aVar3.f55069a) {
                            return c(4, aVar3.f55070b, str);
                        }
                        return b(4, aVar3.f55070b, str);
                    }
                    a aVar4 = (a) f55068d.get(str.substring(0, 4));
                    if (aVar4 != null) {
                        if (aVar4.f55069a) {
                            return c(4, aVar4.f55070b, str);
                        }
                        return b(4, aVar4.f55070b, str);
                    }
                    throw ik.k.a();
                } else {
                    throw ik.k.a();
