...
public final class h {
    ...
    private static final List f40191c = new ArrayList();

    /* renamed from: a  reason: collision with root package name */
    private final CharsetEncoder[] f40192a;
    ...
    static {
        ...
        for (int i10 = 0; i10 < 20; i10++) {
            ...
            if (d.d(str) != null) {
                try {
                    f40191c.add(Charset.forName(str).newEncoder());
    ...
    */
    public h(java.lang.String r10, java.nio.charset.Charset r11, int r12) {
        ...
        L4a:
            if (r5 != 0) goto L6c
            java.util.List r6 = ok.h.f40191c
        ...
        L96:
            ...
            java.nio.charset.CharsetEncoder[] r3 = r9.f40192a
            int r4 = r12 + 1
            r3[r12] = r0
            r12 = r4
            goto L96
        Laa:
            java.nio.charset.CharsetEncoder[] r10 = r9.f40192a
        ...
        Lc1:
            ...
            java.nio.charset.CharsetEncoder[] r12 = r9.f40192a
            r12 = r12[r1]
        ...
        Le5:
            ...
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: ok.h.<init>(java.lang.String, java.nio.charset.Charset, int):void");
    }

    public boolean a(char c10, int i10) {
        CharsetEncoder charsetEncoder = this.f40192a[i10];
        return charsetEncoder.canEncode("" + c10);
    }

    public byte[] b(String str, int i10) {
        return str.getBytes(this.f40192a[i10].charset());
    }

    public Charset c(int i10) {
        return this.f40192a[i10].charset();
    }

    public int d(int i10) {
        return d.a(this.f40192a[i10].charset()).g();
    }
