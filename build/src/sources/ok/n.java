...
public final class n {
    ...
    private static final int[] f43971c = {24, 20, 18, 17, 12, 6, 3, 10, 9, 5};

    /* renamed from: a  reason: collision with root package name */
    private final int[] f43972a = new int[4];

    /* renamed from: b  reason: collision with root package name */
    private final StringBuilder f43973b = new StringBuilder();

    private int a(gk.a aVar, int[] iArr, StringBuilder sb2) {
        int[] iArr2 = this.f43972a;
        iArr2[0] = 0;
        iArr2[1] = 0;
        iArr2[2] = 0;
        iArr2[3] = 0;
    ...
    */
    private static java.lang.String e(java.lang.String r5) {
        ...
        L79:
            ...
            return r5
        */
        throw new UnsupportedOperationException("Method not decompiled: ok.n.e(java.lang.String):java.lang.String");
    }
    ...
    private static Map f(String str) {
        ...
        enumMap.put((EnumMap) ck.o.SUGGESTED_PRICE, (ck.o) e10);
        return enumMap;
    }

    /* JADX INFO: Access modifiers changed from: package-private */
    public Result b(int i10, gk.a aVar, int[] iArr) {
        StringBuilder sb2 = this.f43973b;
        sb2.setLength(0);
        int a10 = a(aVar, iArr, sb2);
        String sb3 = sb2.toString();
        Map f10 = f(sb3);
        float f11 = i10;
        Result result = new Result(sb3, null, new ck.p[]{new ck.p((iArr[0] + iArr[1]) / 2.0f, f11), new ck.p(a10, f11)}, ck.a.UPC_EAN_EXTENSION);
        if (f10 != null) {
            result.g(f10);
        }
        return result;
