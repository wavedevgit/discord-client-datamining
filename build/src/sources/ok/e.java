...
public final class e extends p {
    ...
    static final int[] f43898j = {0, 11, 13, 14, 19, 25, 28, 21, 22, 26};

    /* renamed from: i  reason: collision with root package name */
    private final int[] f43899i = new int[4];
    ...
    public int k(gk.a aVar, int[] iArr, StringBuilder sb2) {
        ...
        r(sb2, i11);
        int i15 = p.m(aVar, i10, true, p.f43922e)[1];
        for (int i16 = 0; i16 < 6 && i15 < l10; i16++) {
            sb2.append((char) (p.i(aVar, iArr2, i15, p.f43924g) + 48));
            for (int i17 : iArr2) {
                i15 += i17;
            }
        }
