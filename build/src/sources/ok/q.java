...
public final class q extends p {
    ...
    private static final int[] f44001j = {1, 1, 1, 1, 1, 1};

    /* renamed from: k  reason: collision with root package name */
    static final int[][] f44002k = {new int[]{56, 52, 50, 49, 44, 38, 35, 42, 41, 37}, new int[]{7, 11, 13, 14, 19, 25, 28, 21, 22, 26}};

    /* renamed from: i  reason: collision with root package name */
    private final int[] f44003i = new int[4];
    ...
    protected int[] j(gk.a aVar, int i10) {
        return p.m(aVar, i10, true, f44001j);
    }

    /* JADX INFO: Access modifiers changed from: protected */
    @Override // ok.p
    public int k(gk.a aVar, int[] iArr, StringBuilder sb2) {
        int[] iArr2 = this.f44003i;
        iArr2[0] = 0;
        iArr2[1] = 0;
        iArr2[2] = 0;
        iArr2[3] = 0;
