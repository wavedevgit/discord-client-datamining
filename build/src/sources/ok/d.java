...
public final class d extends k {
    ...
    private static final char[] f43965c = "0123456789ABCDEFGHIJKLMNOPQRSTUVWXYZ-. $/+%abcd*".toCharArray();

    /* renamed from: d  reason: collision with root package name */
    static final int[] f43966d;

    /* renamed from: e  reason: collision with root package name */
    static final int f43967e;

    /* renamed from: a  reason: collision with root package name */
    private final StringBuilder f43968a = new StringBuilder(20);

    /* renamed from: b  reason: collision with root package name */
    private final int[] f43969b = new int[6];
    ...
    private static void h(CharSequence charSequence, int i10, int i11) {
        ...
        if (charSequence.charAt(i10) == f43965c[i12 % 47]) {
            return;
        }
        throw ck.d.a();
    }
    ...
    private int[] j(gk.a aVar) {
        int l10 = aVar.l();
        int j10 = aVar.j(0);
        Arrays.fill(this.f43969b, 0);
        int[] iArr = this.f43969b;
    ...
    public Result b(int i10, gk.a aVar, Map map) {
        ...
        int[] iArr = this.f43969b;
        Arrays.fill(iArr, 0);
        StringBuilder sb2 = this.f43968a;
        sb2.setLength(0);
        while (true) {
            k.e(aVar, j11, iArr);
            int l11 = l(iArr);
                ...
                if (k10 == '*') {
                    ...
                    if (j12 != l10 && aVar.g(j12)) {
                        if (sb2.length() >= 2) {
                            ...
                            float f10 = i10;
                            Result result = new Result(i(sb2), null, new ck.p[]{new ck.p((j10[1] + j10[0]) / 2.0f, f10), new ck.p(j11 + (i13 / 2.0f), f10)}, ck.a.CODE_93);
                            result.h(ck.o.SYMBOLOGY_IDENTIFIER, "]G0");
                            return result;
                        }
                        throw ck.k.a();
                    }
