    ...
    public void b(int[] iArr, int i10) {
        if (i10 != 0) {
            ...
            if (length > 0) {
                ...
                int[] e10 = new b(this.f41964a, iArr2).j(i10, 1).b(a10)[1].e();
