...
public final class d extends k {
    ...
    private static final char[] f43949c = "0123456789ABCDEFGHIJKLMNOPQRSTUVWXYZ-. $/+%abcd*".toCharArray();

    /* renamed from: d  reason: collision with root package name */
    static final int[] f43950d;

    /* renamed from: e  reason: collision with root package name */
    static final int f43951e;

    /* renamed from: a  reason: collision with root package name */
    private final StringBuilder f43952a = new StringBuilder(20);

    /* renamed from: b  reason: collision with root package name */
    private final int[] f43953b = new int[6];
    ...
    private static void h(CharSequence charSequence, int i10, int i11) {
        ...
        if (charSequence.charAt(i10) == f43949c[i12 % 47]) {
            return;
        }
        throw ck.d.a();
    }
    ...
    private int[] j(gk.a aVar) {
        int l10 = aVar.l();
        int j10 = aVar.j(0);
        Arrays.fill(this.f43953b, 0);
        int[] iArr = this.f43953b;
    ...
    public Result b(int i10, gk.a aVar, Map map) {
        ...
        int[] iArr = this.f43953b;
        Arrays.fill(iArr, 0);
        StringBuilder sb2 = this.f43952a;
        sb2.setLength(0);
        while (true) {
            k.e(aVar, j11, iArr);
            int l11 = l(iArr);
