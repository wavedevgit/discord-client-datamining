...
public abstract class p extends k {
    ...
    static final int[] f43921d = {1, 1, 1};

    /* renamed from: e  reason: collision with root package name */
    static final int[] f43922e = {1, 1, 1, 1, 1};

    /* renamed from: f  reason: collision with root package name */
    static final int[] f43923f = {1, 1, 1, 1, 1, 1};

    /* renamed from: g  reason: collision with root package name */
    static final int[][] f43924g;

    /* renamed from: h  reason: collision with root package name */
    static final int[][] f43925h;

    /* renamed from: a  reason: collision with root package name */
    private final StringBuilder f43926a = new StringBuilder(20);

    /* renamed from: b  reason: collision with root package name */
    private final o f43927b = new o();

    /* renamed from: c  reason: collision with root package name */
    private final g f43928c = new g();
    ...
    public static int[] o(gk.a aVar) {
        int[] iArr = new int[f43921d.length];
        int[] iArr2 = null;
        boolean z10 = false;
        int i10 = 0;
        while (!z10) {
    ...
    int[] j(gk.a aVar, int i10) {
        return m(aVar, i10, false, f43921d);
    }
    ...
    public Result l(int i10, gk.a aVar, int[] iArr, Map map) {
        ...
        StringBuilder sb2 = this.f43926a;
        int i12 = 0;
        sb2.setLength(0);
        ...
        if (i14 < aVar.l() && aVar.o(i13, i14, false)) {
            ...
            if (sb3.length() >= 8) {
                if (g(sb3)) {
                    ...
                    try {
                        Result a10 = this.f43927b.a(i10, aVar, j10[1]);
                    ...
                    if ((p10 == ck.a.EAN_13 || p10 == ck.a.UPC_A) && (c10 = this.f43928c.c(sb3)) != null) {
