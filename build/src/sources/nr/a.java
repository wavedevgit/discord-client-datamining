...
public final class a implements h {
    ...
    private final b f38355a;

    public a(b operations) {
        Intrinsics.checkNotNullParameter(operations, "operations");
        this.f38355a = operations;
    }
    ...
    private final Object c(Map map, Object obj) {
        ...
        if (CollectionsKt.d0(this.f38355a.a().keySet(), p02)) {
            cv.a aVar = (cv.a) this.f38355a.a().get(p02);
            if (aVar != null) {
                return aVar.e(obj2, obj, this);
            }
            return null;
        }
        cv.b d10 = d(this.f38355a.b(), p02);
    ...
    private final cv.b d(Map map, Object obj) {
        cv.b bVar = (cv.b) map.get(obj);
        if (bVar != null) {
            return bVar;
        }
