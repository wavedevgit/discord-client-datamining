...
public abstract class c {
    ...
    private static final String f25550a = File.separator;
    ...
    public static final File d(Context context, Uri srcFileUri) {
        ...
        try {
            bs.b.b(autoCloseInputStream, fileOutputStream, 0, 2, null);
            bs.c.a(fileOutputStream, null);
            bs.c.a(autoCloseInputStream, null);
            return file;
        } catch (Throwable th2) {
            try {
                throw th2;
            } catch (Throwable th3) {
                bs.c.a(autoCloseInputStream, th2);
                throw th3;
            }
        }
    }
    ...
    public static final String g(Bitmap.CompressFormat extension) {
        ...
        int i10 = b.f25549a[extension.ordinal()];
        if (i10 != 1) {
            if (i10 != 2) {
                return "jpg";
            }
    ...
    */
    public static final java.lang.String h(android.content.Context r8, android.net.Uri r9) {
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: gr.c.h(android.content.Context, android.net.Uri):java.lang.String");
    }
