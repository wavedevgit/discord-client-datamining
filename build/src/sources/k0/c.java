...
public final class c extends x {
    ...
    private int f32906o = -1;

    /* renamed from: p  reason: collision with root package name */
    private final x0 f32907p;

    /* renamed from: q  reason: collision with root package name */
    private final x0 f32908q;
    ...
    public void v(long j10, Surface surface, l1 l1Var, SurfaceTexture surfaceTexture, SurfaceTexture surfaceTexture2) {
        ...
        w(gVar, l1Var, surfaceTexture, this.f32907p, this.f32905n, true);
        w(gVar, l1Var, surfaceTexture2, this.f32908q, this.f32906o, true);
        EGLExt.eglPresentationTimeANDROID(this.f31818d, gVar.a(), j10);
        if (!EGL14.eglSwapBuffers(this.f31818d, gVar.a())) {
