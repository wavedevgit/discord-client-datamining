...
public final class c extends x {
    ...
    private int f31356n = -1;

    /* renamed from: o  reason: collision with root package name */
    private int f31357o = -1;

    /* renamed from: p  reason: collision with root package name */
    private final x0 f31358p;

    /* renamed from: q  reason: collision with root package name */
    private final x0 f31359q;
    ...
    public void v(long j10, Surface surface, l1 l1Var, SurfaceTexture surfaceTexture, SurfaceTexture surfaceTexture2) {
        ...
        w(gVar, l1Var, surfaceTexture, this.f31358p, this.f31356n, true);
        w(gVar, l1Var, surfaceTexture2, this.f31359q, this.f31357o, true);
        EGLExt.eglPresentationTimeANDROID(this.f29674d, gVar.a(), j10);
        if (!EGL14.eglSwapBuffers(this.f29674d, gVar.a())) {
