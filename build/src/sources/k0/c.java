...
public final class c extends x {
    ...
    private int f32889n = -1;

    /* renamed from: o  reason: collision with root package name */
    private int f32890o = -1;

    /* renamed from: p  reason: collision with root package name */
    private final x0 f32891p;

    /* renamed from: q  reason: collision with root package name */
    private final x0 f32892q;
    ...
    public void v(long j10, Surface surface, l1 l1Var, SurfaceTexture surfaceTexture, SurfaceTexture surfaceTexture2) {
        ...
        w(gVar, l1Var, surfaceTexture, this.f32891p, this.f32889n, true);
        w(gVar, l1Var, surfaceTexture2, this.f32892q, this.f32890o, true);
        EGLExt.eglPresentationTimeANDROID(this.f31802d, gVar.a(), j10);
        if (!EGL14.eglSwapBuffers(this.f31802d, gVar.a())) {
