...
public class r {
    ...
    public class a implements d0.c {
        ...
        public void onSuccess(l1 l1Var) {
            b2.e.g(l1Var);
            r.this.f32931a.a(l1Var);
        }

        @Override // d0.c
        public void onFailure(Throwable th2) {
            if (this.f32936a.s() == 2 && (th2 instanceof CancellationException)) {
                y0.a("DualSurfaceProcessorNode", "Downstream VideoCapture failed to provide Surface.");
                return;
            }
            y0.m("DualSurfaceProcessorNode", "Downstream node failed to provide Surface. Target: " + u0.a(this.f32936a.s()), th2);
        }
    }
    ...
    private void f(e0 e0Var, l0 l0Var, Map map, boolean z10) {
        this.f32931a.b(l0Var.l(e0Var, z10));
    }
    ...
    public c g(b bVar) {
        ...
        this.f32935e = bVar;
        this.f32934d = new c();
        l0 b10 = this.f32935e.b();
        l0 c10 = this.f32935e.c();
        for (d dVar : this.f32935e.a()) {
            this.f32934d.put(dVar, h(b10, dVar.a()));
        }
        f(this.f32932b, b10, this.f32934d, true);
        f(this.f32933c, c10, this.f32934d, false);
        e(this.f32932b, this.f32933c, b10, c10, this.f32934d);
        return this.f32934d;
    }
}
