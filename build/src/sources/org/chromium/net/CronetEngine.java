    ...
    public static class Builder {
        ...
        public class a implements Comparator {
            ...
            public int compare(CronetProvider.a aVar, CronetProvider.a aVar2) {
                if (CronetProvider.PROVIDER_NAME_FALLBACK.equals(aVar.f41660a.getName())) {
                    return 1;
                }
                if (CronetProvider.PROVIDER_NAME_FALLBACK.equals(aVar2.f41660a.getName())) {
                    return -1;
                }
                return -Builder.compareVersions(aVar.f41660a.getVersion(), aVar2.f41660a.getVersion());
            }
        }
        ...
        private static ICronetEngineBuilder createBuilderDelegate(Context context) {
            ...
            try {
                ...
                uv.a a11 = uv.d.a(context, aVar.f41661b);
                a.C0706a c0706a = new a.C0706a();
                c0706a.f51844e = Boolean.FALSE;
                c0706a.f51841b = a.C0706a.EnumC0707a.API;
                c0706a.f51843d = aVar.f41661b;
                c0706a.f51847h = Process.myUid();
                c0706a.f51845f = new a.c(ApiVersion.getCronetVersion());
                if (Log.isLoggable(TAG, 3)) {
                    Log.d(TAG, String.format("Using '%s' provider for creating CronetEngine.Builder.", aVar.f41660a));
                }
                ICronetEngineBuilder iCronetEngineBuilder = aVar.f41660a.createBuilder().mBuilderDelegate;
                String implCronetVersion = getImplCronetVersion(iCronetEngineBuilder);
                if (implCronetVersion != null) {
                    c0706a.f51846g = new a.c(implCronetVersion);
                }
                c0706a.f51840a = iCronetEngineBuilder.getLogCronetInitializationRef();
                c0706a.f51844e = Boolean.TRUE;
                c0706a.f51842c = (int) (SystemClock.uptimeMillis() - uptimeMillis);
                a11.a(c0706a);
                if (a10 != null) {
                    a10.close();
                }
