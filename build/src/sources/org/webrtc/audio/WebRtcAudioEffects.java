...
class WebRtcAudioEffects {
    ...
    private NoiseSuppressor f41117ns;
    ...
    public void release() {
        ...
        NoiseSuppressor noiseSuppressor = this.f41117ns;
    ...
    public boolean setNS(boolean z10) {
        ...
        if (!isNoiseSuppressorSupported()) {
            ...
            return false;
        } else if (this.f41117ns != null && z10 != this.shouldEnableNs) {
    ...
    public boolean toggleNS(boolean z10) {
        ...
        if (this.f41117ns.setEnabled(z10) != 0) {
            return false;
        }
        return true;
    }
