...
public class PeerConnection {
    ...
    public enum AdapterType {
        ...
        ADAPTER_TYPE_ANY(32),
        CELLULAR_2G(64),
        CELLULAR_3G(Integer.valueOf((int) IntBufferBatchMountItem.INSTRUCTION_UPDATE_LAYOUT)),
        CELLULAR_4G(Integer.valueOf((int) IntBufferBatchMountItem.INSTRUCTION_UPDATE_EVENT_EMITTER)),
        CELLULAR_5G(Integer.valueOf((int) IntBufferBatchMountItem.INSTRUCTION_UPDATE_PADDING));
    ...
    public static class RTCConfiguration {
        ...
        public int audioJitterBufferMaxPackets = androidx.recyclerview.widget.h.DEFAULT_DRAG_ANIMATION_DURATION;
