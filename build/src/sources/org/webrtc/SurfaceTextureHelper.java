...
public class SurfaceTextureHelper {
    ...
    public void dispose() {
        ...
        ThreadUtils.invokeAtFrontUninterruptibly(this.handler, new Runnable() { // from class: org.webrtc.u0
            @Override // java.lang.Runnable
            public final void run() {
    ...
    public void setFrameRotation(final int i10) {
        this.handler.post(new Runnable() { // from class: org.webrtc.x0
            @Override // java.lang.Runnable
            public final void run() {
                SurfaceTextureHelper.this.lambda$setFrameRotation$4(i10);
            }
        });
    }
    ...
    private SurfaceTextureHelper(EglBase.Context context, Handler handler, boolean z10, YuvConverter yuvConverter, FrameRefMonitor frameRefMonitor) {
        ...
        if (handler.getLooper().getThread() == Thread.currentThread()) {
            ...
            try {
                ...
                surfaceTexture.setOnFrameAvailableListener(new SurfaceTexture.OnFrameAvailableListener() { // from class: org.webrtc.w0
