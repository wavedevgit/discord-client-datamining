...
public abstract class c {
    ...
    private static final String f56055a = File.separator;
    ...
    public static final File d(Context context, Uri srcFileUri) {
        ...
        try {
            ur.b.b(autoCloseInputStream, fileOutputStream, 0, 2, null);
            ur.c.a(fileOutputStream, null);
            ur.c.a(autoCloseInputStream, null);
            return file;
        } catch (Throwable th2) {
            try {
                throw th2;
            } catch (Throwable th3) {
                ur.c.a(autoCloseInputStream, th2);
                throw th3;
            }
        }
    }
    ...
    public static final String g(Bitmap.CompressFormat extension) {
        ...
        int i10 = b.f56054a[extension.ordinal()];
        if (i10 != 1) {
            if (i10 != 2) {
                return "jpg";
            }
    ...
    */
    public static final java.lang.String h(android.content.Context r8, android.net.Uri r9) {
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: zq.c.h(android.content.Context, android.net.Uri):java.lang.String");
    }
