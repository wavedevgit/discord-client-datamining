...
public final class o1 {
    ...
    private final ViewGroup f56836a;

    /* renamed from: b  reason: collision with root package name */
    private final Lazy f56837b;

    /* renamed from: c  reason: collision with root package name */
    private boolean f56838c;

    /* renamed from: d  reason: collision with root package name */
    private Function2 f56839d;

    public o1(ViewGroup contentView) {
        Intrinsics.checkNotNullParameter(contentView, "contentView");
        this.f56836a = contentView;
        this.f56837b = as.l.b(new Function0() { // from class: zq.i1
    ...
    private final ar.b i() {
        return (ar.b) this.f56837b.getValue();
    }

    /* JADX INFO: Access modifiers changed from: private */
    public static final ar.b j(o1 o1Var) {
        return ar.b.c(LayoutInflater.from(o1Var.f56836a.getContext()), o1Var.f56836a, true);
    }
    ...
    public static final Unit l(o1 o1Var) {
        Function2 function2 = o1Var.f56839d;
        if (function2 != null) {
