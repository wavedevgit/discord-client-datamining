...
public final class e4 implements Parcelable {
    ...
    public e4(String countryName, String countryCode, List ids) {
        ...
        this.f26087d = countryName;
        this.f26088e = countryCode;
        this.f26089i = ids;
    }
    ...
    public boolean equals(Object obj) {
        ...
        e4 e4Var = (e4) obj;
        if (Intrinsics.areEqual(this.f26087d, e4Var.f26087d) && Intrinsics.areEqual(this.f26088e, e4Var.f26088e) && Intrinsics.areEqual(this.f26089i, e4Var.f26089i)) {
            return true;
        }
        return false;
    }
    ...
    public int hashCode() {
        return (((this.f26087d.hashCode() * 31) + this.f26088e.hashCode()) * 31) + this.f26089i.hashCode();
    }

    public String toString() {
        String str = this.f26087d;
        String str2 = this.f26088e;
        List list = this.f26089i;
    ...
    public final void writeToParcel(Parcel dest, int i10) {
        ...
        dest.writeString(this.f26087d);
        dest.writeString(this.f26088e);
        List<c4> list = this.f26089i;
