...
public interface b {
    ...
    @yv.b("/api/internal/verify/v1/document-files/{fileId}")
    ...
    Object e(@NotNull @i("Authorization") String str, @s("inquiryId") @NotNull String str2, @NotNull @yv.a SubmitDocumentRequest submitDocumentRequest, @NotNull Continuation<? super z<?>> continuation);
}
