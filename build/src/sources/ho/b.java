...
public final class b implements Parcelable {
    ...
    private final e f27803d;

    /* renamed from: e  reason: collision with root package name */
    private final String f27804e;

    /* renamed from: i  reason: collision with root package name */
    private final Map f27805i;
    ...
    public b(e idType, String minAge, Map elementToStoreLength) {
        ...
        this.f27803d = idType;
        this.f27804e = minAge;
        this.f27805i = elementToStoreLength;
    }
    ...
    public final void writeToParcel(Parcel dest, int i10) {
        ...
        dest.writeString(this.f27803d.name());
        dest.writeString(this.f27804e);
        Map map = this.f27805i;
