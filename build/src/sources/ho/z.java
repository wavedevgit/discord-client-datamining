...
public abstract class z {
    ...
    public /* synthetic */ class a {
        ...
        public static final /* synthetic */ int[] f26754c;

        /* renamed from: d  reason: collision with root package name */
        public static final /* synthetic */ int[] f26755d;
        ...
        static {
            ...
            try {
                iArr4[c4.e.f26026o.ordinal()] = 1;
            } catch (NoSuchFieldError unused16) {
            }
            try {
                iArr4[c4.e.f26027p.ordinal()] = 2;
            } catch (NoSuchFieldError unused17) {
            }
            try {
                iArr4[c4.e.f26029r.ordinal()] = 3;
            } catch (NoSuchFieldError unused18) {
            }
            try {
                iArr4[c4.e.f26028q.ordinal()] = 4;
            } catch (NoSuchFieldError unused19) {
            }
            try {
                iArr4[c4.e.f26030s.ordinal()] = 5;
    ...
    private static final c4.a a(c4.e eVar) {
        int i10 = a.f26755d[eVar.ordinal()];
        if (i10 != 1) {
            if (i10 != 2) {
                if (i10 != 3) {
                    if (i10 != 4) {
                    ...
                    return new c4.a(new sn.f(CollectionsKt.e(new e.b(false, 1, null))));
                }
                return new c4.a(new sn.f(CollectionsKt.e(new e.a(false, 1, null))));
            }
            return new c4.a(new sn.f(CollectionsKt.e(new e.a(false, 1, null))));
        }
        return new c4.a(new sn.f(CollectionsKt.e(new e.c(false, 1, null))));
    }
    ...
    private static final f5.d c(oo.e eVar, c4.e eVar2, String str) {
        if (eVar2 == c4.e.f26029r) {
            return f5.d.a.f26174d;
        }
        if (eVar2 == c4.e.f26030s) {
            return f5.d.f.f26180d;
        }
        oo.e eVar3 = oo.e.f44103i;
        if (eVar == eVar3 && eVar2 == c4.e.f26027p && Intrinsics.areEqual(str, "US")) {
            return f5.d.a.f26174d;
        }
        if (eVar == oo.e.f44110u) {
            return f5.d.e.f26179d;
        }
        if (eVar == oo.e.D) {
            return f5.d.e.f26179d;
        }
        if (eVar == eVar3) {
            return f5.d.C0359d.f26178d;
        }
        if (eVar == oo.e.f44104o) {
            return f5.d.C0359d.f26178d;
        }
        if (eVar == oo.e.f44112w) {
            return f5.d.C0359d.f26178d;
        }
        return f5.d.f.f26180d;
    }
    ...
    public static final c4.c f(CapturePageConfig capturePageConfig, c4.e side, oo.e type, String countryCode, long j10) {
        c4.a a10;
        c4.d b10;
        f5.d c10;
    ...
    private static final f5.d h(CapturePageConfig.OverlayConfig overlayConfig) {
        ...
        if (overlayFallback == null) {
            ...
            i10 = a.f26753b[overlayFallback.ordinal()];
        }
        switch (i10) {
            case -1:
                return f5.d.f.f26180d;
            ...
            case 4:
                return f5.d.a.f26174d;
            case 5:
                return f5.d.b.f26175d;
            case 6:
                return f5.d.f.f26180d;
        }
    }

    public static final io.a i(NextStep.GovernmentId.AutoClassificationConfig autoClassificationConfig, long j10) {
        Boolean bool;
        Boolean bool2;
        CapturePageConfig capturePageConfig;
        a.C0387a c0387a = io.a.f27651o;
        c4.c cVar = null;
        ...
        if (autoClassificationConfig != null && (capturePageConfig = autoClassificationConfig.getCapturePageConfig()) != null) {
            cVar = f(capturePageConfig, c4.e.f26026o, oo.e.M, "", j10);
        }
        return c0387a.b(bool, bool2, cVar);
    }

    private static final sn.e j(CapturePageConfig.Rule rule) {
        int i10;
        CapturePageConfig.RuleType type = rule.getType();
        if (type == null) {
            i10 = -1;
        } else {
            i10 = a.f26752a[type.ordinal()];
        }
        if (i10 != -1) {
            if (i10 != 1) {
                if (i10 != 2) {
                    if (i10 != 3) {
                        if (i10 != 4) {
                            if (i10 == 5) {
                                return new e.C0638e(Intrinsics.areEqual(rule.isRequired(), Boolean.TRUE));
                            }
                            throw new or.p();
                        }
    ...
    private static final sn.f k(CapturePageConfig.RuleSet ruleSet) {
        List l10;
        List<CapturePageConfig.Rule> rules = ruleSet.getRules();
        if (rules != null) {
            l10 = new ArrayList();
    ...
    public static final k0 l(sn.g gVar) {
        Date date;
    ...
    public static final k0 m(sn.d0 d0Var) {
    ...
    private static final g4 n(Id.IdLocalIcon idLocalIcon) {
        ...
        if (idLocalIcon == null) {
            ...
            i10 = a.f26754c[idLocalIcon.ordinal()];
        }
        if (i10 != -1) {
            if (i10 != 1) {
                if (i10 != 2) {
    ...
    public static final c4 o(Id id2, String countryCode, long j10) {
        ...
        Intrinsics.checkNotNullParameter(countryCode, "countryCode");
        oo.e a10 = oo.e.f44101d.a(id2.getClass());
        Id.IdLocalIcon idLocalIcon = null;
        if (a10 == oo.e.M && !id2.isDynamicGovId()) {
            return null;
        }
