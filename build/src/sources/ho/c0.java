...
public final class c0 implements Parcelable {
    ...
    public c0(String absoluteFilePath, String mimeType) {
        ...
        this.f26003d = absoluteFilePath;
        this.f26004e = mimeType;
    }
    ...
    public boolean equals(Object obj) {
        ...
        c0 c0Var = (c0) obj;
        if (Intrinsics.areEqual(this.f26003d, c0Var.f26003d) && Intrinsics.areEqual(this.f26004e, c0Var.f26004e)) {
            return true;
        }
        return false;
    }
    ...
    public int hashCode() {
        return (this.f26003d.hashCode() * 31) + this.f26004e.hashCode();
    }

    public String toString() {
        String str = this.f26003d;
        String str2 = this.f26004e;
    ...
    public final void writeToParcel(Parcel dest, int i10) {
        ...
        dest.writeString(this.f26003d);
        dest.writeString(this.f26004e);
    }
    ...
    */
    public /* synthetic */ c0(java.lang.String r1, java.lang.String r2, int r3, kotlin.jvm.internal.DefaultConstructorMarker r4) {
        ...
        L17:
            ...
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: ho.c0.<init>(java.lang.String, java.lang.String, int, kotlin.jvm.internal.DefaultConstructorMarker):void");
    }
}
