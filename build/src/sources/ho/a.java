...
public final class a implements Parcelable {
    ...
    public a(String merchantId, String nonce, String fieldKeyMobileDriversLicense, List digitalIdRequests) {
        ...
        this.f27799d = merchantId;
        this.f27800e = nonce;
        this.f27801i = fieldKeyMobileDriversLicense;
        this.f27802o = digitalIdRequests;
    }
    ...
    public final void writeToParcel(Parcel dest, int i10) {
        ...
        dest.writeString(this.f27799d);
        dest.writeString(this.f27800e);
        dest.writeString(this.f27801i);
        List<b> list = this.f27802o;
