...
public abstract class w {
    ...
    private static final Object f42132d = new Object();

    /* renamed from: a  reason: collision with root package name */
    private final Class f42133a;
    ...
    public static class c extends b {
        ...
        @Override // nt.w.b
        b b(int i10) {
            return new c(i10, this.f42137b, this.f42138c);
        }
    ...
    public static class e extends b {
        ...
        @Override // nt.w.b
        b b(int i10) {
            return new e(i10, this.f42140b, this.f42141c, this.f42142d);
        }
    ...
    public static class f extends b {
        ...
        @Override // nt.w.b
        b b(int i10) {
            ArrayList arrayList = new ArrayList(this.f42143b);
        ...
        private f(List list) {
            ...
            if (!list.isEmpty()) {
                ...
                if (obj != gVar && list.get(list.size() - 1) != gVar) {
                    this.f42143b = Collections.unmodifiableList(list);
                    return;
                }
    ...
    public static class h extends b {
        ...
        /* renamed from: b  reason: collision with root package name */
        private final e f42145b;

        /* renamed from: c  reason: collision with root package name */
        private final b f42146c;

        /* renamed from: d  reason: collision with root package name */
        private final p f42147d;

        /* renamed from: e  reason: collision with root package name */
        private final Map f42148e;

        /* renamed from: f  reason: collision with root package name */
        private final int f42149f;
        ...
        @Override // nt.w.b
        b b(int i10) {
            return new h(i10, this.f42145b, this.f42146c, this.f42147d, this.f42148e, this.f42149f);
        }

        private h(Object obj, String str, p pVar, Map map) {
            super(0);
            this.f42145b = new e(0, 1, 18, obj);
            this.f42146c = new d(str, true);
            this.f42147d = pVar;
            this.f42148e = map;
    ...
    private static class i extends b {
        ...
        /* renamed from: b  reason: collision with root package name */
        private final char f42150b;

        /* renamed from: c  reason: collision with root package name */
        private final char f42151c;
        ...
        @Override // nt.w.b
        b b(int i10) {
            return new i(i10, this.f42150b, this.f42151c);
        }
    ...
    private static class j extends b {
        ...
        @Override // nt.w.b
        int a() {
            return this.f42152b ? 1 : 0;
        }

        @Override // nt.w.b
        b b(int i10) {
            return new j(i10, this.f42152b);
        }
                ...
                if (!arrayList.isEmpty()) {
                    ...
                    if (!list.isEmpty()) {
                        ...
                        if (obj != gVar && list.get(list.size() - 1) != gVar) {
                            ...
                            this.f42133a = cls;
                            this.f42134b = Collections.unmodifiableList(list);
                            this.f42135c = str;
                            return;
                        }
