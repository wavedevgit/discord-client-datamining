...
public final class s {
    ...
    private final List f42126a;

    /* JADX INFO: Access modifiers changed from: package-private */
    public s(String[] strArr) {
        this.f42126a = Collections.unmodifiableList(Arrays.asList(strArr));
    }
        ...
        while (i12 < enumArr.length) {
            ...
            if (isEmpty) {
                if (i12 >= size) {
                    ...
                    str3 = (String) this.f42126a.get(i12);
                }
            }
    ...
    public Enum c(CharSequence charSequence, ParsePosition parsePosition, Class cls, mt.d dVar) {
        mt.c cVar = a.f42034i;
        Boolean bool = Boolean.TRUE;
        return e(charSequence, parsePosition, cls, ((Boolean) dVar.b(cVar, bool)).booleanValue(), ((Boolean) dVar.b(a.f42035j, Boolean.FALSE)).booleanValue(), ((Boolean) dVar.b(a.f42036k, bool)).booleanValue());
    }
    ...
    public String f(Enum r32) {
        ...
        if (this.f42126a.size() <= ordinal) {
            return r32.name();
        }
        return (String) this.f42126a.get(ordinal);
    }
    ...
    public String toString() {
        ...
        for (int i10 = 0; i10 < size; i10++) {
            ...
            sb2.append((String) this.f42126a.get(i10));
        }
        sb2.append('}');
        return sb2.toString();
    }
