...
public abstract class d {
    ...
    private static final boolean f41972a;

    /* renamed from: b  reason: collision with root package name */
    private static final d f41973b;

    /* renamed from: c  reason: collision with root package name */
    private static final boolean f41974c;
    ...
    static {
        ...
        try {
            f41973b = (d) Class.forName(property).newInstance();
        } catch (Exception e10) {
