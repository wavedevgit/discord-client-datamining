...
public final class i0 extends ByteString {
    ...
    private final transient byte[][] f37317q;

    /* renamed from: r  reason: collision with root package name */
    private final transient int[] f37318r;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public i0(byte[][] segments, int[] directory) {
        super(ByteString.f44308p.k());
        Intrinsics.checkNotNullParameter(segments, "segments");
        Intrinsics.checkNotNullParameter(directory, "directory");
        this.f37317q = segments;
        this.f37318r = directory;
    }
    ...
    public void O(Buffer buffer, int i10, int i11) {
        ...
        while (i10 < i13) {
            ...
            if (g0Var2 == null) {
                g0Var.f37306g = g0Var;
                g0Var.f37305f = g0Var;
                buffer.f44296d = g0Var;
            } else {
                Intrinsics.checkNotNull(g0Var2);
                g0 g0Var3 = g0Var2.f37306g;
