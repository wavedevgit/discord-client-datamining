...
public final class i implements CookieJar {
    ...
    private final CookieHandler f36062c;

    public i(CookieHandler cookieHandler) {
        Intrinsics.checkNotNullParameter(cookieHandler, "cookieHandler");
        this.f36062c = cookieHandler;
    }
    ...
    private final List a(HttpUrl httpUrl, String str) {
        ...
        int i10 = 0;
        while (i10 < length) {
            int q10 = mu.e.q(str, ";,", i10, length);
            int p10 = mu.e.p(str, '=', i10, q10);
            String Z = mu.e.Z(str, i10, p10);
            if (!StringsKt.P(Z, "$", false, 2, null)) {
                if (p10 < q10) {
                    str2 = mu.e.Z(str, p10 + 1, q10);
                } else {
                    str2 = "";
                }
    ...
    public List loadForRequest(HttpUrl url) {
        ...
        try {
            Map<String, List<String>> cookieHeaders = this.f36062c.get(url.t(), o0.i());
    ...
    public void saveFromResponse(HttpUrl url, List cookies) {
        ...
        try {
            this.f36062c.put(url.t(), o0.f(v.a("Set-Cookie", arrayList)));
        } catch (IOException e10) {
            vu.h g10 = vu.h.f52015a.g();
            StringBuilder sb2 = new StringBuilder();
