...
public class h {
    ...
    public static final a f36777a;

    /* renamed from: b  reason: collision with root package name */
    private static volatile h f36778b;

    /* renamed from: c  reason: collision with root package name */
    private static final Logger f36779c;
    ...
    public static final class a {
        ...
        private final h e() {
            ...
            c a11;
            d b10;
            if (j() && (b10 = d.f36759e.b()) != null) {
                return b10;
            }
            if (i() && (a11 = c.f36756e.a()) != null) {
                return a11;
            }
            if (k() && (a10 = g.f36774e.a()) != null) {
                return a10;
            }
            f a12 = f.f36772d.a();
            if (a12 != null) {
    ...
    static {
        ...
        f36777a = aVar;
        f36778b = aVar.f();
        f36779c = Logger.getLogger(OkHttpClient.class.getName());
    }
    ...
    public ou.c c(X509TrustManager trustManager) {
        ...
        return new ou.a(d(trustManager));
    }
    ...
    public ou.e d(X509TrustManager trustManager) {
        ...
        return new ou.b((X509Certificate[]) Arrays.copyOf(acceptedIssuers, acceptedIssuers.length));
    }
    ...
    public Object i(String closer) {
        ...
        if (f36779c.isLoggable(Level.FINE)) {
