...
public final class q extends ln.d {
    ...
    private static final class c implements e {
        ...
        private final q f36124d;

        /* renamed from: e  reason: collision with root package name */
        private final ReactEditText f36125e;

        /* renamed from: i  reason: collision with root package name */
        private float f36126i;

        /* renamed from: o  reason: collision with root package name */
        private float f36127o;
        ...
        public c(q handler, ReactEditText editText) {
            ...
            this.f36124d = handler;
            this.f36125e = editText;
            ViewConfiguration viewConfiguration = ViewConfiguration.get(editText.getContext());
            this.f36128p = viewConfiguration.getScaledTouchSlop() * viewConfiguration.getScaledTouchSlop();
        }
        ...
        public void g(MotionEvent event) {
            ...
            this.f36124d.k();
            this.f36125e.onTouchEvent(event);
            this.f36126i = event.getX();
            this.f36127o = event.getY();
        }

        @Override // ln.q.e
        public void h(MotionEvent event) {
            Intrinsics.checkNotNullParameter(event, "event");
            if (((event.getX() - this.f36126i) * (event.getX() - this.f36126i)) + ((event.getY() - this.f36127o) * (event.getY() - this.f36127o)) < this.f36128p) {
                this.f36125e.requestFocusFromJS();
            }
        }
    }
    ...
    public static final class d extends d.c {
        ...
        private final Class f36130b = q.class;

        /* renamed from: c  reason: collision with root package name */
        private final String f36131c = "NativeViewGestureHandler";
        ...
        @Override // ln.d.c
        /* renamed from: h */
        public mn.f c(q handler) {
            Intrinsics.checkNotNullParameter(handler, "handler");
            return new mn.f(handler);
        }
    ...
    public interface e {
        ...
        public static final class a {
            ...
            public static Boolean g(e eVar, ln.d handler) {
                Intrinsics.checkNotNullParameter(handler, "handler");
                return null;
            }
    ...
    private static final class h implements e {
        ...
        /* renamed from: d  reason: collision with root package name */
        private final q f36132d;

        /* renamed from: e  reason: collision with root package name */
        private final ReactSwipeRefreshLayout f36133e;

        public h(q handler, ReactSwipeRefreshLayout swipeRefreshLayout) {
            Intrinsics.checkNotNullParameter(handler, "handler");
            Intrinsics.checkNotNullParameter(swipeRefreshLayout, "swipeRefreshLayout");
            this.f36132d = handler;
            this.f36133e = swipeRefreshLayout;
        }
        ...
        public void g(MotionEvent event) {
            ...
            ArrayList<ln.d> s10;
            Intrinsics.checkNotNullParameter(event, "event");
            View childAt = this.f36133e.getChildAt(0);
            r1 = null;
    ...
    @Override // ln.d
    public boolean K0(ln.d handler) {
        Intrinsics.checkNotNullParameter(handler, "handler");
        return !this.P;
    }

    @Override // ln.d
    public boolean L0(ln.d handler) {
        Intrinsics.checkNotNullParameter(handler, "handler");
