...
public final class m extends d {
    ...
    private Handler O;
    private Runnable P = new Runnable() { // from class: ln.l
    ...
    public static final class b extends d.c {
        ...
        private final Class f36116b = m.class;

        /* renamed from: c  reason: collision with root package name */
        private final String f36117c = "HoverGestureHandler";
        ...
        @Override // ln.d.c
        /* renamed from: h */
        public mn.c c(m handler) {
            Intrinsics.checkNotNullParameter(handler, "handler");
            return new mn.c(handler);
        }
    }
