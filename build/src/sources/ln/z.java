...
public final class z {
    ...
    private final double f36205b;

    /* renamed from: c  reason: collision with root package name */
    private final double f36206c;

    /* renamed from: d  reason: collision with root package name */
    private final double f36207d;

    /* renamed from: e  reason: collision with root package name */
    private final double f36208e;
    ...
    public final ReadableMap b() {
        ...
        createMap.putDouble("tiltX", this.f36204a);
        createMap.putDouble("tiltY", this.f36205b);
        createMap.putDouble("altitudeAngle", this.f36206c);
        createMap.putDouble("azimuthAngle", this.f36207d);
        createMap.putDouble("pressure", this.f36208e);
    ...
    public boolean equals(Object obj) {
        ...
        z zVar = (z) obj;
        if (Double.compare(this.f36204a, zVar.f36204a) == 0 && Double.compare(this.f36205b, zVar.f36205b) == 0 && Double.compare(this.f36206c, zVar.f36206c) == 0 && Double.compare(this.f36207d, zVar.f36207d) == 0 && Double.compare(this.f36208e, zVar.f36208e) == 0) {
            return true;
        }
        return false;
    }
    ...
    public int hashCode() {
        return (((((((Double.hashCode(this.f36204a) * 31) + Double.hashCode(this.f36205b)) * 31) + Double.hashCode(this.f36206c)) * 31) + Double.hashCode(this.f36207d)) * 31) + Double.hashCode(this.f36208e);
    }

    public String toString() {
        double d10 = this.f36204a;
        double d11 = this.f36205b;
        double d12 = this.f36206c;
        double d13 = this.f36207d;
        double d14 = this.f36208e;
