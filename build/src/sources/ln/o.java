...
public final class o extends d {
    ...
    public static final class b extends d.c {
        ...
        private final Class f36120b = o.class;

        /* renamed from: c  reason: collision with root package name */
        private final String f36121c = "LongPressGestureHandler";
        ...
        @Override // ln.d.c
        /* renamed from: h */
        public mn.d c(o handler) {
            Intrinsics.checkNotNullParameter(handler, "handler");
            return new mn.d(handler);
        }
        ...
        if (J0(sourceEvent)) {
            ...
            if (S() == 2 && this.X == this.R && (sourceEvent.getActionMasked() == 0 || sourceEvent.getActionMasked() == 5)) {
                ...
                if (j10 > 0) {
                    ...
                    handler.postDelayed(new Runnable() { // from class: ln.n
