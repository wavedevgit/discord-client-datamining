...
public final class h implements Executor {
    ...
    final Deque f8066d = new ArrayDeque();

    /* renamed from: i  reason: collision with root package name */
    private final b f8068i = new b();
    ...
    class a implements Runnable {
        ...
        /* renamed from: d  reason: collision with root package name */
        final /* synthetic */ Runnable f8071d;
        ...
        */
        private void a() {
            ...
            L2:
                ...
                java.util.Deque r2 = r2.f8066d     // Catch: java.lang.Throwable -> L49
                monitor-enter(r2)     // Catch: java.lang.Throwable -> L49
                if (r0 != 0) goto L28
                c0.h r0 = c0.h.this     // Catch: java.lang.Throwable -> L1c
                c0.h$c r3 = r0.f8069o     // Catch: java.lang.Throwable -> L1c
            ...
            L1c:
                ...
                goto L63
            L1e:
                long r5 = r0.f8070p     // Catch: java.lang.Throwable -> L1c
                r7 = 1
                long r5 = r5 + r7
                r0.f8070p = r5     // Catch: java.lang.Throwable -> L1c
                r0.f8069o = r4     // Catch: java.lang.Throwable -> L1c
                r0 = 1
            L28:
                c0.h r3 = c0.h.this     // Catch: java.lang.Throwable -> L1c
                java.util.Deque r3 = r3.f8066d     // Catch: java.lang.Throwable -> L1c
                ...
                r0.f8069o = r3     // Catch: java.lang.Throwable -> L1c
                monitor-exit(r2)     // Catch: java.lang.Throwable -> L1c
                if (r1 == 0) goto L3e
                goto L14
            L3e:
        ...
        public void run() {
            try {
                ...
                synchronized (h.this.f8066d) {
                    h.this.f8069o = c.IDLE;
                    throw e10;
                }
            }
        }
    ...
    public h(Executor executor) {
        this.f8067e = (Executor) b2.e.g(executor);
    }
    ...
    */
    public void execute(java.lang.Runnable r8) {
        /*
            r7 = this;
            b2.e.g(r8)
            java.util.Deque r0 = r7.f8066d
            monitor-enter(r0)
            c0.h$c r1 = r7.f8069o     // Catch: java.lang.Throwable -> L6d
            ...
            goto L6f
        L11:
            long r3 = r7.f8070p     // Catch: java.lang.Throwable -> L6d
            c0.h$a r1 = new c0.h$a     // Catch: java.lang.Throwable -> L6d
            r1.<init>(r8)     // Catch: java.lang.Throwable -> L6d
            java.util.Deque r8 = r7.f8066d     // Catch: java.lang.Throwable -> L6d
            r8.add(r1)     // Catch: java.lang.Throwable -> L6d
            c0.h$c r8 = c0.h.c.QUEUING     // Catch: java.lang.Throwable -> L6d
            r7.f8069o = r8     // Catch: java.lang.Throwable -> L6d
            monitor-exit(r0)     // Catch: java.lang.Throwable -> L6d
            java.util.concurrent.Executor r0 = r7.f8067e     // Catch: java.lang.Error -> L44 java.lang.RuntimeException -> L46
            c0.h$b r5 = r7.f8068i     // Catch: java.lang.Error -> L44 java.lang.RuntimeException -> L46
        ...
        L2e:
            java.util.Deque r0 = r7.f8066d
            monitor-enter(r0)
            long r5 = r7.f8070p     // Catch: java.lang.Throwable -> L3e
            int r1 = (r5 > r3 ? 1 : (r5 == r3 ? 0 : -1))
            if (r1 != 0) goto L40
            c0.h$c r1 = r7.f8069o     // Catch: java.lang.Throwable -> L3e
            if (r1 != r8) goto L40
            r7.f8069o = r2     // Catch: java.lang.Throwable -> L3e
            goto L40
        L3e:
            r8 = move-exception
            goto L42
        ...
        L46:
            r8 = move-exception
        L47:
            java.util.Deque r2 = r7.f8066d
            monitor-enter(r2)
            c0.h$c r0 = r7.f8069o     // Catch: java.lang.Throwable -> L55
        ...
        L55:
            ...
            goto L6b
        L57:
            java.util.Deque r0 = r7.f8066d     // Catch: java.lang.Throwable -> L55
        ...
        L6d:
            ...
            goto L76
        L6f:
            java.util.Deque r1 = r7.f8066d     // Catch: java.lang.Throwable -> L6d
